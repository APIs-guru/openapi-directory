...
class InvoiceSectionListWithCreateSubPermissionResult(BaseModel):
    """
    ...
    value: Optional[List[InvoiceSectionWithCreateSubPermission]] = Field(default=None, description="The list of invoice section properties with create subscription permission.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [InvoiceSectionWithCreateSubPermission.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
