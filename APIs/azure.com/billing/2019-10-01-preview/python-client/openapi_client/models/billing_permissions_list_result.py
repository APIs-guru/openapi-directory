...
class BillingPermissionsListResult(BaseModel):
    """
    Result of list billingPermissions a caller has on a billing account.
    """ # noqa: E501
    value: Optional[List[BillingPermissionsProperties]] = Field(default=None, description="The list of billingPermissions a caller has on a billing account.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [BillingPermissionsProperties.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
