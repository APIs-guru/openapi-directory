...
class BillingPeriodsApi:
    ...
    def billing_periods_get(
        ...
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2017-04-24-preview.")],
        billing_period_name: Annotated[StrictStr, Field(description="The name of a BillingPeriod resource.")],
        ...
        :param api_version: Version of the API to be used with the client request. The current version is 2017-04-24-preview. (required)
    ...
    def _billing_periods_get_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.Billing/billingPeriods/{billingPeriodName}',
    ...
    @validate_call
    def billing_periods_list(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure Subscription ID.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2017-04-24-preview.")],
        filter: Annotated[Optional[StrictStr], Field(description="May be used to filter billing periods by billingPeriodEndDate. The filter supports 'eq', 'lt', 'gt', 'le', 'ge', and 'and'. It does not currently support 'ne', 'or', or 'not'.")] = None,
        ...
        top: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=1)]], Field(description="May be used to limit the number of results to the most recent N billing periods.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._billing_periods_list_serialize(
            subscription_id=subscription_id,
            api_version=api_version,
            filter=filter,
            skiptoken=skiptoken,
    ...
    @validate_call
    def billing_periods_list_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure Subscription ID.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2017-04-24-preview.")],
        filter: Annotated[Optional[StrictStr], Field(description="May be used to filter billing periods by billingPeriodEndDate. The filter supports 'eq', 'lt', 'gt', 'le', 'ge', and 'and'. It does not currently support 'ne', 'or', or 'not'.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[BillingPeriodsListResult]:
        """billing_periods_list
    ...
    @validate_call
    def billing_periods_list_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Azure Subscription ID.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2017-04-24-preview.")],
        filter: Annotated[Optional[StrictStr], Field(description="May be used to filter billing periods by billingPeriodEndDate. The filter supports 'eq', 'lt', 'gt', 'le', 'ge', and 'and'. It does not currently support 'ne', 'or', or 'not'.")] = None,
    ...
    def _billing_periods_list_serialize(
        self,
        subscription_id,
        api_version,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.Billing/billingPeriods',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
