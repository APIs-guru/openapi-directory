...
class BillingPeriodsListResult(BaseModel):
    """
    ...
    value: Optional[List[BillingPeriod]] = Field(default=None, description="The list of billing periods.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [BillingPeriod.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
