...
class DownloadUrl(BaseModel):
    ...
    """ # noqa: E501
    expiry_time: Optional[datetime] = Field(default=None, description="The time in UTC at which this download URL will expire.", alias="expiryTime")
    url: Optional[StrictStr] = Field(default=None, description="The URL to the PDF file.")
    __properties: ClassVar[List[str]] = ["expiryTime", "url"]
