...
class ValidateAddressApi:
    ...
    def addresses_validate(
        ...
        _param = self._addresses_validate_serialize(
    ...
    @validate_call
    def addresses_validate_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-11-01-preview.")],
        address: Address,
        _request_timeout: Union[
    ...
    @validate_call
    def addresses_validate_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-11-01-preview.")],
        address: Address,
        _request_timeout: Union[
    ...
    def _addresses_validate_serialize(
        self,
        api_version,
        address,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/providers/Microsoft.Billing/validateAddress',
