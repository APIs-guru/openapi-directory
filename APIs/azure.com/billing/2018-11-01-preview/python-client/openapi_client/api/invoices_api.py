...
class InvoicesApi:
    ...
    @validate_call
    def invoices_list_by_billing_account_name(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-11-01-preview.")],
        billing_account_name: Annotated[StrictStr, Field(description="Billing Account Id.")],
        ...
        _param = self._invoices_list_by_billing_account_name_serialize(
            api_version=api_version,
            billing_account_name=billing_account_name,
    ...
    @validate_call
    def invoices_list_by_billing_account_name_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-11-01-preview.")],
        billing_account_name: Annotated[StrictStr, Field(description="Billing Account Id.")],
        period_start_date: Annotated[StrictStr, Field(description="Invoice period start date.")],
    ...
    @validate_call
    def invoices_list_by_billing_account_name_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-11-01-preview.")],
        billing_account_name: Annotated[StrictStr, Field(description="Billing Account Id.")],
        period_start_date: Annotated[StrictStr, Field(description="Invoice period start date.")],
    ...
    def _invoices_list_by_billing_account_name_serialize(
        self,
        api_version,
        billing_account_name,
        period_start_date,
