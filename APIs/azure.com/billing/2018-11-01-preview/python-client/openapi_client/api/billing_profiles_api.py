...
class BillingProfilesApi:
    ...
    def billing_profiles_create(
        ...
        parameters: Annotated[BillingProfileCreationParameters, Field(description="Parameters supplied to the Create BillingProfile operation.")],
        ...
        :type parameters: BillingProfileCreationParameters
    ...
    @validate_call
    def billing_profiles_list_by_billing_account_name(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-11-01-preview.")],
        billing_account_name: Annotated[StrictStr, Field(description="Billing Account Id.")],
        expand: Annotated[Optional[StrictStr], Field(description="May be used to expand the invoiceSections.")] = None,
        ...
        _param = self._billing_profiles_list_by_billing_account_name_serialize(
            api_version=api_version,
            billing_account_name=billing_account_name,
            expand=expand,
            _request_auth=_request_auth,
    ...
    @validate_call
    def billing_profiles_list_by_billing_account_name_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-11-01-preview.")],
        billing_account_name: Annotated[StrictStr, Field(description="Billing Account Id.")],
        expand: Annotated[Optional[StrictStr], Field(description="May be used to expand the invoiceSections.")] = None,
    ...
    @validate_call
    def billing_profiles_list_by_billing_account_name_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-11-01-preview.")],
        billing_account_name: Annotated[StrictStr, Field(description="Billing Account Id.")],
        expand: Annotated[Optional[StrictStr], Field(description="May be used to expand the invoiceSections.")] = None,
    ...
    def _billing_profiles_list_by_billing_account_name_serialize(
        self,
        api_version,
        billing_account_name,
        expand,
    ...
    def billing_profiles_update(
        ...
        billing_account_name: Annotated[StrictStr, Field(description="Billing Account Id.")],
        billing_profile_name: Annotated[StrictStr, Field(description="Billing Profile Id.")],
        parameters: Annotated[BillingProfile, Field(description="Parameters supplied to the update billing profile operation.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
