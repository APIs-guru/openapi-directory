...
class PoliciesApi:
    ...
    @validate_call
    def policies_get_by_billing_profile_name(
        self,
        ...
        _param = self._policies_get_by_billing_profile_name_serialize(
    ...
    @validate_call
    def policies_get_by_billing_profile_name_with_http_info(
        self,
        billing_account_name: Annotated[StrictStr, Field(description="Billing Account Id.")],
        billing_profile_name: Annotated[StrictStr, Field(description="Billing Profile Id.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-11-01-preview.")],
    ...
    @validate_call
    def policies_get_by_billing_profile_name_without_preload_content(
        self,
        billing_account_name: Annotated[StrictStr, Field(description="Billing Account Id.")],
        billing_profile_name: Annotated[StrictStr, Field(description="Billing Profile Id.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-11-01-preview.")],
    ...
    def _policies_get_by_billing_profile_name_serialize(
        self,
