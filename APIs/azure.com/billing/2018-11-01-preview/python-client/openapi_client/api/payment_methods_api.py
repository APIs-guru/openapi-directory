...
class PaymentMethodsApi:
    ...
    @validate_call
    def payment_methods_list_by_billing_account_name(
        self,
        ...
        _param = self._payment_methods_list_by_billing_account_name_serialize(
    ...
    @validate_call
    def payment_methods_list_by_billing_account_name_with_http_info(
        self,
        billing_account_name: Annotated[StrictStr, Field(description="Billing Account Id.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-11-01-preview.")],
        _request_timeout: Union[
    ...
    @validate_call
    def payment_methods_list_by_billing_account_name_without_preload_content(
        self,
        billing_account_name: Annotated[StrictStr, Field(description="Billing Account Id.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-11-01-preview.")],
        _request_timeout: Union[
    ...
    def _payment_methods_list_by_billing_account_name_serialize(
        self,
    ...
    @validate_call
    def payment_methods_list_by_billing_profile_name(
        self,
        billing_account_name: Annotated[StrictStr, Field(description="Billing Account Id.")],
        ...
        _param = self._payment_methods_list_by_billing_profile_name_serialize(
            billing_account_name=billing_account_name,
    ...
    @validate_call
    def payment_methods_list_by_billing_profile_name_with_http_info(
        self,
        billing_account_name: Annotated[StrictStr, Field(description="Billing Account Id.")],
        billing_profile_name: Annotated[StrictStr, Field(description="Billing Profile Id.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-11-01-preview.")],
    ...
    @validate_call
    def payment_methods_list_by_billing_profile_name_without_preload_content(
        self,
        billing_account_name: Annotated[StrictStr, Field(description="Billing Account Id.")],
        billing_profile_name: Annotated[StrictStr, Field(description="Billing Profile Id.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-11-01-preview.")],
    ...
    def _payment_methods_list_by_billing_profile_name_serialize(
        self,
        billing_account_name,
