...
class AvailableBalancesApi:
    ...
    @validate_call
    def available_balances_get_by_billing_profile(
        self,
        ...
        _param = self._available_balances_get_by_billing_profile_serialize(
    ...
    @validate_call
    def available_balances_get_by_billing_profile_with_http_info(
        self,
        billing_account_name: Annotated[StrictStr, Field(description="Billing Account Id.")],
        billing_profile_name: Annotated[StrictStr, Field(description="Billing Profile Id.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-11-01-preview.")],
    ...
    @validate_call
    def available_balances_get_by_billing_profile_without_preload_content(
        self,
        billing_account_name: Annotated[StrictStr, Field(description="Billing Account Id.")],
        billing_profile_name: Annotated[StrictStr, Field(description="Billing Profile Id.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-11-01-preview.")],
    ...
    def _available_balances_get_by_billing_profile_serialize(
        self,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/availableBalance/default',
