...
class RecipientTransferDetailsListResult(BaseModel):
    """
    ...
    value: Optional[List[RecipientTransferDetails]] = Field(default=None, description="The list of transfers received by caller.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [RecipientTransferDetails.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
