...
class BillingRoleDefinitionListResult(BaseModel):
    """
    list the role definitions.
    """ # noqa: E501
    value: Optional[List[BillingRoleDefinition]] = Field(default=None, description="The list of role definitions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [BillingRoleDefinition.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
