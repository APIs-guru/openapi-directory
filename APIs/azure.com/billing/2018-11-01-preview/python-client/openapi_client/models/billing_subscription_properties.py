...
class BillingSubscriptionProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["billingProfileId", "billingProfileName", "customerDisplayName", "customerId", "displayName", "invoiceSectionId", "invoiceSectionName", "lastMonthCharges", "monthToDateCharges", "reseller", "skuDescription", "skuId", "subscriptionBillingStatus", "subscriptionId"]
