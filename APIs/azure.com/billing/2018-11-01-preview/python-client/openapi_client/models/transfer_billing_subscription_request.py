...
class TransferBillingSubscriptionRequest(BaseModel):
    """
    Request parameters to transfer billing subscription.
    """ # noqa: E501
    properties: Optional[TransferBillingSubscriptionRequestProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": TransferBillingSubscriptionRequestProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
