...
class UpdateAutoRenewOperationSummaryProperties(BaseModel):
    """
    update auto renew operation summary properties
    """ # noqa: E501
    end_date: Optional[datetime] = Field(default=None, description="The end date of this asset", alias="endDate")
    __properties: ClassVar[List[str]] = ["endDate"]
