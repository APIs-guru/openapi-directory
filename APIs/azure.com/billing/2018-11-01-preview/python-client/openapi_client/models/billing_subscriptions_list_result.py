...
class BillingSubscriptionsListResult(BaseModel):
    """
    ...
    value: Optional[List[BillingSubscriptionSummary]] = Field(default=None, description="The list of billing subscriptions summary.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [BillingSubscriptionSummary.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
