...
class UpdateAutoRenewOperationSummary(BaseModel):
    """
    Summary of cancel product operation
    """ # noqa: E501
    properties: Optional[UpdateAutoRenewOperationSummaryProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": UpdateAutoRenewOperationSummaryProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
