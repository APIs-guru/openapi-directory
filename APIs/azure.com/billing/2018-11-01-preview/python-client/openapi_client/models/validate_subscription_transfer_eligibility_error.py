...
class ValidateSubscriptionTransferEligibilityError(BaseModel):
    """
    Error details of the transfer eligibility validation
    """ # noqa: E501
    code: Optional[SubscriptionTransferValidationErrorCode] = None
    details: Optional[StrictStr] = Field(default=None, description="Detailed error message explaining the error.")
