...
class ProductDetails(BaseModel):
    ...
    """ # noqa: E501
    product_id: Optional[StrictStr] = Field(default=None, description="Id of product to be transferred.", alias="productId")
    product_type: Optional[ProductType] = Field(default=None, alias="productType")
    __properties: ClassVar[List[str]] = ["productId", "productType"]
