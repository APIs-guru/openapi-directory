...
class BillingAccountUpdateProperties(BaseModel):
    """
    The properties of the billing account that can be updated.
    """ # noqa: E501
    properties: Optional[BillingAccountProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": BillingAccountProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
