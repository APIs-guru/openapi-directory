...
------------- | ------------- | -------------
[**price_sheet_download**](PriceSheetApi.md#price_sheet_download) | **POST** /providers/Microsoft.Billing/billingAccounts/{billingAccountName}/invoices/{invoiceName}/pricesheet/default/download | 


# **price_sheet_download**
> DownloadUrl price_sheet_download(api_version, billing_account_name, invoice_name)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    billing_account_name = 'billing_account_name_example' # str | Azure Billing Account ID.
    invoice_name = 'invoice_name_example' # str | The name of an invoice resource.

    try:
        api_response = api_instance.price_sheet_download(api_version, billing_account_name, invoice_name)
 ...
 **billing_account_name** | **str**| Azure Billing Account ID. | 
