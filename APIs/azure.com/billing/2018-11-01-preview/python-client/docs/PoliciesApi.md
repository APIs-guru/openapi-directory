...
------------- | ------------- | -------------
[**policies_get_by_billing_profile_name**](PoliciesApi.md#policies_get_by_billing_profile_name) | **GET** /providers/Microsoft.Billing/billingAccounts/{billingAccountName}/billingProfiles/{billingProfileName}/policies/default | 
...
> Policy policies_get_by_billing_profile_name(billing_account_name, billing_profile_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.policies_get_by_billing_profile_name(billing_account_name, billing_profile_name, api_version)
        print("The response of PoliciesApi->policies_get_by_billing_profile_name:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PoliciesApi->policies_get_by_billing_profile_name: %s\n" % e)
```
