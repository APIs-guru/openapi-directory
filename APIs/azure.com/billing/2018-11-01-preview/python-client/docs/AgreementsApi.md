...
[**agreements_list_by_billing_account_name**](AgreementsApi.md#agreements_list_by_billing_account_name) | **GET** /providers/Microsoft.Billing/billingAccounts/{billingAccountName}/agreements | 
...
> AgreementListResult agreements_list_by_billing_account_name(api_version, billing_account_name, expand=expand)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.agreements_list_by_billing_account_name(api_version, billing_account_name, expand=expand)
        print("The response of AgreementsApi->agreements_list_by_billing_account_name:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AgreementsApi->agreements_list_by_billing_account_name: %s\n" % e)
```
