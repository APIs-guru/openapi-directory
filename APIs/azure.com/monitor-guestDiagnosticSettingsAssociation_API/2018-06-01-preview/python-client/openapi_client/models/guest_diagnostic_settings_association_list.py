...
class GuestDiagnosticSettingsAssociationList(BaseModel):
    """
    ...
    value: Optional[List[GuestDiagnosticSettingsAssociationResource]] = Field(default=None, description="The list of guest diagnostic settings association.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [GuestDiagnosticSettingsAssociationResource.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
