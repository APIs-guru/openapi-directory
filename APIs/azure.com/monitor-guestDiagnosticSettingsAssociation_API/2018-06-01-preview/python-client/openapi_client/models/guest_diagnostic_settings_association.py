...
class GuestDiagnosticSettingsAssociation(BaseModel):
    """
    A guest diagnostic settings association.
    """ # noqa: E501
    guest_diagnostic_settings_name: StrictStr = Field(description="The guest diagnostic settings name.", alias="guestDiagnosticSettingsName")
    __properties: ClassVar[List[str]] = ["guestDiagnosticSettingsName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "guestDiagnosticSettingsName": obj.get("guestDiagnosticSettingsName")
        })
        return _obj
