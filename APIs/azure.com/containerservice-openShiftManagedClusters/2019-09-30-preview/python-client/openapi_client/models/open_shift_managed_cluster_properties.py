...
class OpenShiftManagedClusterProperties(BaseModel):
    ...
    monitor_profile: Optional[OpenShiftManagedClusterMonitorProfile] = Field(default=None, alias="monitorProfile")
    ...
    __properties: ClassVar[List[str]] = ["agentPoolProfiles", "authProfile", "clusterVersion", "fqdn", "masterPoolProfile", "monitorProfile", "networkProfile", "openShiftVersion", "provisioningState", "publicHostname", "routerProfiles"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of monitor_profile
        if self.monitor_profile:
            _dict['monitorProfile'] = self.monitor_profile.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "monitorProfile": OpenShiftManagedClusterMonitorProfile.from_dict(obj["monitorProfile"]) if obj.get("monitorProfile") is not None else None,
