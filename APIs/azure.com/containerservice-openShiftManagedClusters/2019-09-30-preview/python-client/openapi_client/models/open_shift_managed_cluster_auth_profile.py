...
class OpenShiftManagedClusterAuthProfile(BaseModel):
    """
    Defines all possible authentication profiles for the OpenShift cluster.
    """ # noqa: E501
    identity_providers: Optional[List[OpenShiftManagedClusterIdentityProvider]] = Field(default=None, description="Type of authentication profile to use.", alias="identityProviders")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "identityProviders": [OpenShiftManagedClusterIdentityProvider.from_dict(_item) for _item in obj["identityProviders"]] if obj.get("identityProviders") is not None else None
        })
        return _obj
