...
class OpenShiftManagedClusterIdentityProvider(BaseModel):
    """
    Defines the configuration of the identity providers to be used in the OpenShift cluster.
    """ # noqa: E501
    name: Optional[StrictStr] = Field(default=None, description="Name of the provider.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "provider": OpenShiftManagedClusterBaseIdentityProvider.from_dict(obj["provider"]) if obj.get("provider") is not None else None
        })
        return _obj
