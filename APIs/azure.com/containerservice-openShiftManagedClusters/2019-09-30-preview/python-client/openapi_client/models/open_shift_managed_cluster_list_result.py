...
class OpenShiftManagedClusterListResult(BaseModel):
    """
    The response from the List OpenShift Managed Clusters operation.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The URL to get the next set of OpenShift managed cluster results.", alias="nextLink")
    value: Optional[List[OpenShiftManagedCluster]] = Field(default=None, description="The list of OpenShift managed clusters.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [OpenShiftManagedCluster.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
