...
class OpenShiftManagedCluster(BaseModel):
    """
    ...
    properties: Optional[OpenShiftManagedClusterProperties] = None
    __properties: ClassVar[List[str]] = ["id", "location", "name", "tags", "type", "plan", "properties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": OpenShiftManagedClusterProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
