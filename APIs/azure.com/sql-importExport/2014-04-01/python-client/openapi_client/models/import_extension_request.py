...
class ImportExtensionRequest(BaseModel):
    ...
    properties: Optional[ImportExtensionProperties] = None
    type: Optional[StrictStr] = Field(default=None, description="The type of the extension.")
    __properties: ClassVar[List[str]] = ["name", "properties", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "properties": ImportExtensionProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "type": obj.get("type")
        })
        return _obj
