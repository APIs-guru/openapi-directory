...
class SubscriptionName(BaseModel):
    ...
    """ # noqa: E501
    subscription_name: Optional[StrictStr] = Field(default=None, description="New subscription name", alias="subscriptionName")
    __properties: ClassVar[List[str]] = ["subscriptionName"]
