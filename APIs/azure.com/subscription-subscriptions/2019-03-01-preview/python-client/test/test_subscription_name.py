...
class TestSubscriptionName(unittest.TestCase):
    """SubscriptionName unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SubscriptionName:
        """Test SubscriptionName
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SubscriptionName`
        """
