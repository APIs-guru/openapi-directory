...
class ModernSubscriptionCreationParameters(BaseModel):
    ...
    """ # noqa: E501
    additional_parameters: Optional[Dict[str, Dict[str, Any]]] = Field(default=None, description="Additional, untyped parameters to support custom subscription creation scenarios.", alias="additionalParameters")
    billing_profile_id: StrictStr = Field(description="The ARM ID of the billing profile for which you want to create the subscription.", alias="billingProfileId")
    ...
    __properties: ClassVar[List[str]] = ["additionalParameters", "billingProfileId", "costCenter", "displayName", "managementGroupId", "owner", "skuId"]
