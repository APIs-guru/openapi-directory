...
**display_name** | **str** | The friendly name of the subscription. | [optional] 
...
**sku_id** | **str** | The SKU ID of the Azure plan. Azure plan determines the pricing and service-level agreement of the subscription.  Use 001 for Microsoft Azure Plan and 002 for Microsoft Azure Plan for DevTest. | [optional] 
