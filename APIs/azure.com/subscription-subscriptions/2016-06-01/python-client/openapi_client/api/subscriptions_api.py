...
class SubscriptionsApi:
    ...
    @validate_call
    def subscriptions_list_locations(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The ID of the target subscription.")],
        api_version: Annotated[StrictStr, Field(description="The API version to use for the operation.")],
        _request_timeout: Union[
        ...
        _param = self._subscriptions_list_locations_serialize(
            subscription_id=subscription_id,
            api_version=api_version,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def subscriptions_list_locations_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The ID of the target subscription.")],
        api_version: Annotated[StrictStr, Field(description="The API version to use for the operation.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[LocationListResult]:
        """Gets all available geo-locations.
    ...
    @validate_call
    def subscriptions_list_locations_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The ID of the target subscription.")],
        api_version: Annotated[StrictStr, Field(description="The API version to use for the operation.")],
        _request_timeout: Union[
    ...
    def _subscriptions_list_locations_serialize(
        self,
        subscription_id,
        api_version,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/locations',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
