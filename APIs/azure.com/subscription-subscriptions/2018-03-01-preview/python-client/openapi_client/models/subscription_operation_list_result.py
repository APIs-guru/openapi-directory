...
class SubscriptionOperationListResult(BaseModel):
    """
    A list of pending subscription operations.
    """ # noqa: E501
    value: Optional[List[SubscriptionOperation]] = Field(default=None, description="A list of pending SubscriptionOperations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [SubscriptionOperation.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
