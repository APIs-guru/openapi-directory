...
class GatewayParametersProperties(BaseModel):
    ...
    """ # noqa: E501
    upgrade_mode: Optional[StrictStr] = Field(default=None, description="The upgradeMode property gives the flexibility to gateway to auto upgrade itself. If properties value not specified, then we assume upgradeMode = Automatic.", alias="upgradeMode")
    __properties: ClassVar[List[str]] = ["upgradeMode"]
