...
class PowerShellCommandParameters(BaseModel):
    """
    The parameters to a PowerShell script execution command.
    """ # noqa: E501
    properties: Optional[PowerShellCommandParametersProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": PowerShellCommandParametersProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
