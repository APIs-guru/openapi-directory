...
class PowerShellCommandResults(BaseModel):
    """
    A collection of results from a PowerShell command.
    """ # noqa: E501
    command: Optional[StrictStr] = None
    completed: Optional[StrictBool] = None
    pssession: Optional[StrictStr] = None
    results: Optional[List[PowerShellCommandResult]] = None
    __properties: ClassVar[List[str]] = ["command", "completed", "pssession", "results"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pssession": obj.get("pssession"),
            "results": [PowerShellCommandResult.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None
        })
        return _obj
