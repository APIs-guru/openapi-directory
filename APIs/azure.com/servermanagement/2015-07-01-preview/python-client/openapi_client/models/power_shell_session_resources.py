...
class PowerShellSessionResources(BaseModel):
    """
    A collection of PowerShell session resources.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The URL to the next set of resources.", alias="nextLink")
    value: Optional[List[PowerShellSessionResource]] = Field(default=None, description="Collection of PowerShell session resources.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [PowerShellSessionResource.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
