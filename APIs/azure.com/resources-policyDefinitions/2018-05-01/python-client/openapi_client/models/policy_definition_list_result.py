...
class PolicyDefinitionListResult(BaseModel):
    """
    ...
    value: Optional[List[PolicyDefinition]] = Field(default=None, description="An array of policy definitions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [PolicyDefinition.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
