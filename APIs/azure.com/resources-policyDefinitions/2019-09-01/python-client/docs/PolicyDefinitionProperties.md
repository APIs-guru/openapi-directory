...
**metadata** | **object** | The policy definition metadata.  Metadata is an open ended object and is typically a collection of key value pairs. | [optional] 
**mode** | **str** | The policy definition mode. Some examples are All, Indexed, Microsoft.KeyVault.Data. | [optional] 
**parameters** | [**Dict[str, ParameterDefinitionsValue]**](ParameterDefinitionsValue.md) | The parameter definitions for parameters used in the policy. The keys are the parameter names. | [optional] 
