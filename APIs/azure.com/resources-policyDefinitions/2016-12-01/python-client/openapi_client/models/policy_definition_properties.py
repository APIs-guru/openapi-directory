...
class PolicyDefinitionProperties(BaseModel):
    ...
    mode: Optional[StrictStr] = Field(default=None, description="The policy definition mode. Possible values are NotSpecified, Indexed, and All.")
    ...
    def mode_validate_enum(cls, value):
        ...
        if value not in set(['NotSpecified', 'Indexed', 'All']):
            raise ValueError("must be one of enum values ('NotSpecified', 'Indexed', 'All')")
        return value
