...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    scope = 'scope_example' # str | The scope of the usage details. The scope can be '/subscriptions/{subscriptionId}' for a subscription, or '/subscriptions/{subscriptionId}/providers/Microsoft.Billing/billingPeriods/{billingPeriodName}' for a billing period.
...
------------- | ------------- | ------------- | -------------
 **scope** | **str**| The scope of the usage details. The scope can be &#39;/subscriptions/{subscriptionId}&#39; for a subscription, or &#39;/subscriptions/{subscriptionId}/providers/Microsoft.Billing/billingPeriods/{billingPeriodName}&#39; for a billing period. | 
