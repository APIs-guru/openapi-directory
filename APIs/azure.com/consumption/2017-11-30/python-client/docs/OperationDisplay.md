...
------------ | ------------- | ------------- | -------------
**operation** | **str** | Operation type: Read, write, delete, etc. | [optional] [readonly] 
**provider** | **str** | Service provider: Microsoft.Consumption. | [optional] [readonly] 
**resource** | **str** | Resource on which the operation is performed: UsageDetail, etc. | [optional] [readonly] 
