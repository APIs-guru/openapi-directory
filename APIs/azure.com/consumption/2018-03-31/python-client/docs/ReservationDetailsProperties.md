...
json = "{}"
# create an instance of ReservationDetailsProperties from a JSON string
reservation_details_properties_instance = ReservationDetailsProperties.from_json(json)
# print the JSON string representation of the object
print(ReservationDetailsProperties.to_json())

# convert the object into a dict
reservation_details_properties_dict = reservation_details_properties_instance.to_dict()
# create an instance of ReservationDetailsProperties from a dict
reservation_details_properties_from_dict = ReservationDetailsProperties.from_dict(reservation_details_properties_dict)
```
