...
class UsageDetailsApi:
    ...
    @validate_call
    def usage_details_by_billing_account_list(
        self,
        ...
        _param = self._usage_details_by_billing_account_list_serialize(
    ...
    @validate_call
    def usage_details_by_billing_account_list_with_http_info(
        self,
        billing_account_id: Annotated[StrictStr, Field(description="BillingAccount ID")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-03-31.")],
        expand: Annotated[Optional[StrictStr], Field(description="May be used to expand the properties/additionalProperties or properties/meterDetails within a list of usage details. By default, these fields are not included when listing usage details.")] = None,
    ...
    @validate_call
    def usage_details_by_billing_account_list_without_preload_content(
        self,
        billing_account_id: Annotated[StrictStr, Field(description="BillingAccount ID")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-03-31.")],
        expand: Annotated[Optional[StrictStr], Field(description="May be used to expand the properties/additionalProperties or properties/meterDetails within a list of usage details. By default, these fields are not included when listing usage details.")] = None,
    ...
    def _usage_details_by_billing_account_list_serialize(
        self,
        billing_account_id,
        api_version,
        expand,
    ...
    @validate_call
    def usage_details_by_billing_account_list_by_billing_period(
        self,
        billing_account_id: Annotated[StrictStr, Field(description="BillingAccount ID")],
        ...
        _param = self._usage_details_by_billing_account_list_by_billing_period_serialize(
            billing_account_id=billing_account_id,
    ...
    @validate_call
    def usage_details_by_billing_account_list_by_billing_period_with_http_info(
        self,
        billing_account_id: Annotated[StrictStr, Field(description="BillingAccount ID")],
        billing_period_name: Annotated[StrictStr, Field(description="Billing Period Name.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-03-31.")],
    ...
    @validate_call
    def usage_details_by_billing_account_list_by_billing_period_without_preload_content(
        self,
        billing_account_id: Annotated[StrictStr, Field(description="BillingAccount ID")],
        billing_period_name: Annotated[StrictStr, Field(description="Billing Period Name.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-03-31.")],
    ...
    def _usage_details_by_billing_account_list_by_billing_period_serialize(
        self,
        billing_account_id,
        billing_period_name,
        api_version,
    ...
    @validate_call
    def usage_details_by_department_list(
        self,
        ...
        _param = self._usage_details_by_department_list_serialize(
    ...
    @validate_call
    def usage_details_by_department_list_with_http_info(
        self,
        department_id: Annotated[StrictStr, Field(description="Department ID")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-03-31.")],
        expand: Annotated[Optional[StrictStr], Field(description="May be used to expand the properties/additionalProperties or properties/meterDetails within a list of usage details. By default, these fields are not included when listing usage details.")] = None,
    ...
    @validate_call
    def usage_details_by_department_list_without_preload_content(
        self,
        department_id: Annotated[StrictStr, Field(description="Department ID")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-03-31.")],
        expand: Annotated[Optional[StrictStr], Field(description="May be used to expand the properties/additionalProperties or properties/meterDetails within a list of usage details. By default, these fields are not included when listing usage details.")] = None,
    ...
    def _usage_details_by_department_list_serialize(
        self,
        department_id,
        api_version,
        expand,
    ...
    @validate_call
    def usage_details_by_department_list_by_billing_period(
        self,
        department_id: Annotated[StrictStr, Field(description="Department ID")],
        billing_period_name: Annotated[StrictStr, Field(description="Billing Period Name.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-03-31.")],
        ...
        _param = self._usage_details_by_department_list_by_billing_period_serialize(
            department_id=department_id,
            billing_period_name=billing_period_name,
            api_version=api_version,
            expand=expand,
    ...
    @validate_call
    def usage_details_by_department_list_by_billing_period_with_http_info(
        self,
        department_id: Annotated[StrictStr, Field(description="Department ID")],
        billing_period_name: Annotated[StrictStr, Field(description="Billing Period Name.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-03-31.")],
    ...
    @validate_call
    def usage_details_by_department_list_by_billing_period_without_preload_content(
        self,
        department_id: Annotated[StrictStr, Field(description="Department ID")],
        billing_period_name: Annotated[StrictStr, Field(description="Billing Period Name.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-03-31.")],
    ...
    def _usage_details_by_department_list_by_billing_period_serialize(
        self,
        department_id,
        billing_period_name,
        api_version,
    ...
    @validate_call
    def usage_details_by_enrollment_account_list(
        self,
        ...
        _param = self._usage_details_by_enrollment_account_list_serialize(
    ...
    @validate_call
    def usage_details_by_enrollment_account_list_with_http_info(
        self,
        enrollment_account_id: Annotated[StrictStr, Field(description="EnrollmentAccount ID")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-03-31.")],
        expand: Annotated[Optional[StrictStr], Field(description="May be used to expand the properties/additionalProperties or properties/meterDetails within a list of usage details. By default, these fields are not included when listing usage details.")] = None,
    ...
    @validate_call
    def usage_details_by_enrollment_account_list_without_preload_content(
        self,
        enrollment_account_id: Annotated[StrictStr, Field(description="EnrollmentAccount ID")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-03-31.")],
        expand: Annotated[Optional[StrictStr], Field(description="May be used to expand the properties/additionalProperties or properties/meterDetails within a list of usage details. By default, these fields are not included when listing usage details.")] = None,
    ...
    def _usage_details_by_enrollment_account_list_serialize(
        self,
    ...
    @validate_call
    def usage_details_by_enrollment_account_list_by_billing_period(
        self,
        enrollment_account_id: Annotated[StrictStr, Field(description="EnrollmentAccount ID")],
        billing_period_name: Annotated[StrictStr, Field(description="Billing Period Name.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-03-31.")],
        ...
        _param = self._usage_details_by_enrollment_account_list_by_billing_period_serialize(
            enrollment_account_id=enrollment_account_id,
            billing_period_name=billing_period_name,
            api_version=api_version,
            expand=expand,
    ...
    @validate_call
    def usage_details_by_enrollment_account_list_by_billing_period_with_http_info(
        self,
        enrollment_account_id: Annotated[StrictStr, Field(description="EnrollmentAccount ID")],
        billing_period_name: Annotated[StrictStr, Field(description="Billing Period Name.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-03-31.")],
    ...
    @validate_call
    def usage_details_by_enrollment_account_list_by_billing_period_without_preload_content(
        self,
        enrollment_account_id: Annotated[StrictStr, Field(description="EnrollmentAccount ID")],
        billing_period_name: Annotated[StrictStr, Field(description="Billing Period Name.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-03-31.")],
    ...
    def _usage_details_by_enrollment_account_list_by_billing_period_serialize(
        self,
        enrollment_account_id,
        billing_period_name,
        api_version,
