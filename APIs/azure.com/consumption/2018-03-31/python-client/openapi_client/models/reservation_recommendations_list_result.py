...
class ReservationRecommendationsListResult(BaseModel):
    ...
    value: Optional[List[ReservationRecommendations]] = Field(default=None, description="The list of reservation recommendations.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ReservationRecommendations.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
