...
class CostTagProperties(BaseModel):
    ...
    """ # noqa: E501
    cost_tags: Optional[List[CostTag]] = Field(default=None, description="Cost tags.", alias="costTags")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "costTags": [CostTag.from_dict(_item) for _item in obj["costTags"]] if obj.get("costTags") is not None else None
        })
        return _obj
