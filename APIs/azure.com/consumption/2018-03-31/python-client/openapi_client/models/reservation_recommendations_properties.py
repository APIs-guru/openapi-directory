...
class ReservationRecommendationsProperties(BaseModel):
    """
    ...
    look_back_period: Optional[StrictStr] = Field(default=None, description="The number of days of usage to look back for recommendations.", alias="lookBackPeriod")
