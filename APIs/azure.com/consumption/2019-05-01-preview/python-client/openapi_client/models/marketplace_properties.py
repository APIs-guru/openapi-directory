...
class MarketplaceProperties(BaseModel):
    ...
    is_recurring_charge: Optional[StrictBool] = Field(default=None, description="Flag indicating whether this is a recurring charge or not.", alias="isRecurringCharge")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "isRecurringCharge": obj.get("isRecurringCharge"),
