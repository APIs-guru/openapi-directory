...
class ForecastsListResult(BaseModel):
    """
    Result of listing forecasts. It contains a list of available forecasts.
    """ # noqa: E501
    value: Optional[List[Forecast]] = Field(default=None, description="The list of forecasts.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [Forecast.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
