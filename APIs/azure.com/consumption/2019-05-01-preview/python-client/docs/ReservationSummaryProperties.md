...
reservation_summary_properties_instance = ReservationSummaryProperties.from_json(json)
# print the JSON string representation of the object
print(ReservationSummaryProperties.to_json())

# convert the object into a dict
reservation_summary_properties_dict = reservation_summary_properties_instance.to_dict()
# create an instance of ReservationSummaryProperties from a dict
reservation_summary_properties_from_dict = ReservationSummaryProperties.from_dict(reservation_summary_properties_dict)
```
