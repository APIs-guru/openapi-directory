...
> UsageDetailsDownloadResponse usage_details_download(scope, api_version, metric=metric, filter=filter)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.usage_details_download(scope, api_version, metric=metric, filter=filter)
