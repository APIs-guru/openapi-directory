...
class ReservationRecommendationProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["costWithNoReservedInstances", "firstUsageDate", "instanceFlexibilityGroup", "instanceFlexibilityRatio", "lookBackPeriod", "meterId", "netSavings", "normalizedSize", "recommendedQuantity", "recommendedQuantityNormalized", "scope", "term", "totalCostWithReservedInstances"]
