...
class ReservationDetailProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["instanceFlexibilityGroup", "instanceFlexibilityRatio", "instanceId", "reservationId", "reservationOrderId", "reservedHours", "skuName", "totalReservedQuantity", "usageDate", "usedHours"]
