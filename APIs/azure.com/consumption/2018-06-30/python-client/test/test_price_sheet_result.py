...
class TestPriceSheetResult(unittest.TestCase):
    """PriceSheetResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PriceSheetResult:
        """Test PriceSheetResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PriceSheetResult`
        """
        model = PriceSheetResult()
        if include_optional:
            return PriceSheetResult(
                properties = openapi_client.models.price_sheet_model.PriceSheetModel(
                    next_link = '', 
                    pricesheets = [
