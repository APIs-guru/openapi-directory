...
[**marketplaces_list_by_billing_account**](MarketplacesApi.md#marketplaces_list_by_billing_account) | **GET** /providers/Microsoft.Billing/billingAccounts/{billingAccountId}/providers/Microsoft.Consumption/marketplaces | 
...
[**marketplaces_list_by_department**](MarketplacesApi.md#marketplaces_list_by_department) | **GET** /providers/Microsoft.Billing/departments/{departmentId}/providers/Microsoft.Consumption/marketplaces | 
[**marketplaces_list_by_enrollment_account**](MarketplacesApi.md#marketplaces_list_by_enrollment_account) | **GET** /providers/Microsoft.Billing/enrollmentAccounts/{enrollmentAccountId}/providers/Microsoft.Consumption/marketplaces | 
[**marketplaces_list_for_billing_period_by_billing_account**](MarketplacesApi.md#marketplaces_list_for_billing_period_by_billing_account) | **GET** /providers/Microsoft.Billing/billingAccounts/{billingAccountId}/providers/Microsoft.Billing/billingPeriods/{billingPeriodName}/providers/Microsoft.Consumption/marketplaces | 
[**marketplaces_list_for_billing_period_by_department**](MarketplacesApi.md#marketplaces_list_for_billing_period_by_department) | **GET** /providers/Microsoft.Billing/departments/{departmentId}/providers/Microsoft.Billing/billingPeriods/{billingPeriodName}/providers/Microsoft.Consumption/marketplaces | 
[**marketplaces_list_for_billing_period_by_enrollment_account**](MarketplacesApi.md#marketplaces_list_for_billing_period_by_enrollment_account) | **GET** /providers/Microsoft.Billing/enrollmentAccounts/{enrollmentAccountId}/providers/Microsoft.Billing/billingPeriods/{billingPeriodName}/providers/Microsoft.Consumption/marketplaces | 
...
> MarketplacesListResult marketplaces_list_by_billing_account(api_version, billing_account_id, filter=filter, top=top, skiptoken=skiptoken)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.marketplaces_list_by_billing_account(api_version, billing_account_id, filter=filter, top=top, skiptoken=skiptoken)
        print("The response of MarketplacesApi->marketplaces_list_by_billing_account:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MarketplacesApi->marketplaces_list_by_billing_account: %s\n" % e)
```
...
> MarketplacesListResult marketplaces_list_by_department(api_version, department_id, filter=filter, top=top, skiptoken=skiptoken)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.marketplaces_list_by_department(api_version, department_id, filter=filter, top=top, skiptoken=skiptoken)
        print("The response of MarketplacesApi->marketplaces_list_by_department:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MarketplacesApi->marketplaces_list_by_department: %s\n" % e)
```
...
> MarketplacesListResult marketplaces_list_by_enrollment_account(api_version, enrollment_account_id, filter=filter, top=top, skiptoken=skiptoken)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.marketplaces_list_by_enrollment_account(api_version, enrollment_account_id, filter=filter, top=top, skiptoken=skiptoken)
        print("The response of MarketplacesApi->marketplaces_list_by_enrollment_account:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MarketplacesApi->marketplaces_list_by_enrollment_account: %s\n" % e)
```
...
> MarketplacesListResult marketplaces_list_for_billing_period_by_billing_account(api_version, billing_account_id, billing_period_name, filter=filter, top=top, skiptoken=skiptoken)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.marketplaces_list_for_billing_period_by_billing_account(api_version, billing_account_id, billing_period_name, filter=filter, top=top, skiptoken=skiptoken)
        print("The response of MarketplacesApi->marketplaces_list_for_billing_period_by_billing_account:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MarketplacesApi->marketplaces_list_for_billing_period_by_billing_account: %s\n" % e)
```
...
> MarketplacesListResult marketplaces_list_for_billing_period_by_department(api_version, department_id, billing_period_name, filter=filter, top=top, skiptoken=skiptoken)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.marketplaces_list_for_billing_period_by_department(api_version, department_id, billing_period_name, filter=filter, top=top, skiptoken=skiptoken)
        print("The response of MarketplacesApi->marketplaces_list_for_billing_period_by_department:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MarketplacesApi->marketplaces_list_for_billing_period_by_department: %s\n" % e)
```
...
> MarketplacesListResult marketplaces_list_for_billing_period_by_enrollment_account(api_version, enrollment_account_id, billing_period_name, filter=filter, top=top, skiptoken=skiptoken)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.marketplaces_list_for_billing_period_by_enrollment_account(api_version, enrollment_account_id, billing_period_name, filter=filter, top=top, skiptoken=skiptoken)
        print("The response of MarketplacesApi->marketplaces_list_for_billing_period_by_enrollment_account:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MarketplacesApi->marketplaces_list_for_billing_period_by_enrollment_account: %s\n" % e)
```
