...
> CostTag cost_tags_create_or_update(api_version, billing_account_id, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    parameters = openapi_client.CostTag() # CostTag | Parameters supplied to the Create cost tags operation.
 ...
 **parameters** | [**CostTag**](CostTag.md)| Parameters supplied to the Create cost tags operation. | 
...
# **cost_tags_get**
> CostTag cost_tags_get(api_version, billing_account_id)
