...
> ManagementGroupAggregatedCostResult aggregated_cost_get_by_management_group(management_group_id, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.aggregated_cost_get_by_management_group(management_group_id, api_version)
