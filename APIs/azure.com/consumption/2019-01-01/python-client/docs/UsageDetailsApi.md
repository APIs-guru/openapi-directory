...
# **usage_details_list**
> UsageDetailsListResult usage_details_list(scope, api_version, expand=expand, filter=filter, skiptoken=skiptoken, top=top, apply=apply)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.usage_details_list(scope, api_version, expand=expand, filter=filter, skiptoken=skiptoken, top=top, apply=apply)
