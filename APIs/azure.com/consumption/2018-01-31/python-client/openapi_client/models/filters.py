...
class Filters(BaseModel):
    ...
    """ # noqa: E501
    meters: Optional[Annotated[List[StrictStr], Field(min_length=0, max_length=10)]] = Field(default=None, description="The list of filters on meters, mandatory for budgets of usage category. ")
    ...
    __properties: ClassVar[List[str]] = ["meters", "resourceGroups", "resources"]
