...
class UsageDetailProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["accountName", "additionalProperties", "billableQuantity", "billingPeriodId", "consumedService", "costCenter", "currency", "departmentName", "instanceId", "instanceLocation", "instanceName", "invoiceId", "isEstimated", "meterDetails", "meterId", "pretaxCost", "product", "subscriptionGuid", "subscriptionName", "usageEnd", "usageQuantity", "usageStart"]
