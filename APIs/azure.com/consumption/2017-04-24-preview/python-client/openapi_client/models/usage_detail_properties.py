...
class UsageDetailProperties(BaseModel):
    ...
    """ # noqa: E501
    additional_properties: Optional[Dict[str, StrictStr]] = Field(default=None, description="The list of key/value pairs for the additional properties, in the format 'key':'value' where key = the field name, and value = the field value. By default this is not populated, unless it's specified in $expand.", alias="additionalProperties")
    ...
    meter_id: Optional[StrictStr] = Field(default=None, description="The meter id.", alias="meterId")
    ...
    __properties: ClassVar[List[str]] = ["additionalProperties", "billableQuantity", "billingPeriodId", "currency", "instanceId", "instanceLocation", "instanceName", "invoiceId", "isEstimated", "meterDetails", "meterId", "pretaxCost", "usageEnd", "usageQuantity", "usageStart"]
