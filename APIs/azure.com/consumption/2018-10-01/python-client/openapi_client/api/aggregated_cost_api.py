...
class AggregatedCostApi:
    ...
    @validate_call
    def aggregated_cost_get_by_management_group(
        self,
        ...
        filter: Annotated[Optional[StrictStr], Field(description="May be used to filter aggregated cost by properties/usageStart (Utc time), properties/usageEnd (Utc time). The filter supports 'eq', 'lt', 'gt', 'le', 'ge', and 'and'. It does not currently support 'ne', 'or', or 'not'. Tag filter is a key value pair string where key and value is separated by a colon (:).")] = None,
        ...
        _param = self._aggregated_cost_get_by_management_group_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ManagementGroupAggregatedCostResult",
        }
    ...
    @validate_call
    def aggregated_cost_get_by_management_group_with_http_info(
        self,
        management_group_id: Annotated[StrictStr, Field(description="Azure Management Group ID.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-10-01.")],
        filter: Annotated[Optional[StrictStr], Field(description="May be used to filter aggregated cost by properties/usageStart (Utc time), properties/usageEnd (Utc time). The filter supports 'eq', 'lt', 'gt', 'le', 'ge', and 'and'. It does not currently support 'ne', 'or', or 'not'. Tag filter is a key value pair string where key and value is separated by a colon (:).")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ManagementGroupAggregatedCostResult]:
        """aggregated_cost_get_by_management_group
    ...
    @validate_call
    def aggregated_cost_get_by_management_group_without_preload_content(
        self,
        management_group_id: Annotated[StrictStr, Field(description="Azure Management Group ID.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-10-01.")],
        filter: Annotated[Optional[StrictStr], Field(description="May be used to filter aggregated cost by properties/usageStart (Utc time), properties/usageEnd (Utc time). The filter supports 'eq', 'lt', 'gt', 'le', 'ge', and 'and'. It does not currently support 'ne', 'or', or 'not'. Tag filter is a key value pair string where key and value is separated by a colon (:).")] = None,
    ...
    def _aggregated_cost_get_by_management_group_serialize(
        self,
        management_group_id,
        api_version,
        filter,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Consumption/aggregatedcost',
    ...
    @validate_call
    def aggregated_cost_get_for_billing_period_by_management_group(
        self,
        management_group_id: Annotated[StrictStr, Field(description="Azure Management Group ID.")],
        ...
        _param = self._aggregated_cost_get_for_billing_period_by_management_group_serialize(
            management_group_id=management_group_id,
    ...
    @validate_call
    def aggregated_cost_get_for_billing_period_by_management_group_with_http_info(
        self,
        management_group_id: Annotated[StrictStr, Field(description="Azure Management Group ID.")],
        billing_period_name: Annotated[StrictStr, Field(description="Billing Period Name.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-10-01.")],
    ...
    @validate_call
    def aggregated_cost_get_for_billing_period_by_management_group_without_preload_content(
        self,
        management_group_id: Annotated[StrictStr, Field(description="Azure Management Group ID.")],
        billing_period_name: Annotated[StrictStr, Field(description="Billing Period Name.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-10-01.")],
    ...
    def _aggregated_cost_get_for_billing_period_by_management_group_serialize(
        self,
        management_group_id,
        billing_period_name,
        api_version,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Billing/billingPeriods/{billingPeriodName}/Microsoft.Consumption/aggregatedcost',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
