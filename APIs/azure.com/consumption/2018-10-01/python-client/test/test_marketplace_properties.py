...
class TestMarketplaceProperties(unittest.TestCase):
    """MarketplaceProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarketplaceProperties:
        """Test MarketplaceProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarketplaceProperties`
        """
    ...
    def testMarketplaceProperties(self):
        """Test MarketplaceProperties"""
