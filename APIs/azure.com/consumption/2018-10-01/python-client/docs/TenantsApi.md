...
------------- | ------------- | -------------
[**tenants_get**](TenantsApi.md#tenants_get) | **GET** /providers/Microsoft.Billing/billingAccounts/{billingAccountId}/billingProfiles/{billingProfileId}/providers/Microsoft.Consumption/tenants | 


# **tenants_get**
> TenantListResult tenants_get(billing_account_id, billing_profile_id, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.tenants_get(billing_account_id, billing_profile_id, api_version)
        print("The response of TenantsApi->tenants_get:\n")
        pprint(api_response)
