...
[**marketplaces_list_by_management_group**](MarketplacesApi.md#marketplaces_list_by_management_group) | **GET** /providers/Microsoft.Management/managementGroups/{managementGroupId}/providers/Microsoft.Consumption/marketplaces | 
...
> MarketplacesListResult marketplaces_list_by_management_group(api_version, management_group_id, filter=filter, top=top, skiptoken=skiptoken)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.marketplaces_list_by_management_group(api_version, management_group_id, filter=filter, top=top, skiptoken=skiptoken)
        print("The response of MarketplacesApi->marketplaces_list_by_management_group:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MarketplacesApi->marketplaces_list_by_management_group: %s\n" % e)
```
...
# **marketplaces_list_for_billing_period_by_management_group**
> MarketplacesListResult marketplaces_list_for_billing_period_by_management_group(api_version, management_group_id, billing_period_name, filter=filter, top=top, skiptoken=skiptoken)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.marketplaces_list_for_billing_period_by_management_group(api_version, management_group_id, billing_period_name, filter=filter, top=top, skiptoken=skiptoken)
        print("The response of MarketplacesApi->marketplaces_list_for_billing_period_by_management_group:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling MarketplacesApi->marketplaces_list_for_billing_period_by_management_group: %s\n" % e)
```
