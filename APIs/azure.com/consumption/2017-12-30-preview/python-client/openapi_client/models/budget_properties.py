...
class BudgetProperties(BaseModel):
    ...
    category: StrictStr = Field(description="The category of the budget, whether the budget tracks cost or something else.")
    ...
    __properties: ClassVar[List[str]] = ["amount", "category", "currentSpend", "notifications", "timeGrain", "timePeriod"]

    @field_validator('category')
    def category_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Cost']):
            raise ValueError("must be one of enum values ('Cost')")
        return value
