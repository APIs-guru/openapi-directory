...
class ReservationRecommendationsListResult(BaseModel):
    """
    ...
    value: Optional[List[ReservationRecommendation]] = Field(default=None, description="The list of reservation recommendations.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ReservationRecommendation.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
