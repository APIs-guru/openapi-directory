...
------------- | ------------- | -------------
[**budgets_create_or_update**](BudgetsApi.md#budgets_create_or_update) | **PUT** /{scope}/providers/Microsoft.Consumption/budgets/{budgetName} | 
[**budgets_delete**](BudgetsApi.md#budgets_delete) | **DELETE** /{scope}/providers/Microsoft.Consumption/budgets/{budgetName} | 
[**budgets_get**](BudgetsApi.md#budgets_get) | **GET** /{scope}/providers/Microsoft.Consumption/budgets/{budgetName} | 
[**budgets_list**](BudgetsApi.md#budgets_list) | **GET** /{scope}/providers/Microsoft.Consumption/budgets | 


# **budgets_create_or_update**
> Budget budgets_create_or_update(scope, api_version, budget_name, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.budgets_create_or_update(scope, api_version, budget_name, parameters)
...
# **budgets_delete**
> budgets_delete(scope, api_version, budget_name)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.budgets_delete(scope, api_version, budget_name)
    except Exception as e:
...
# **budgets_get**
> Budget budgets_get(scope, api_version, budget_name)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.budgets_get(scope, api_version, budget_name)
