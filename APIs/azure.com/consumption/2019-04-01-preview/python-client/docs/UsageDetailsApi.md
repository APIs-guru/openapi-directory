...
------------- | ------------- | -------------
[**usage_details_download**](UsageDetailsApi.md#usage_details_download) | **POST** /{scope}/providers/Microsoft.Consumption/usageDetails/download | 
[**usage_details_list**](UsageDetailsApi.md#usage_details_list) | **GET** /{scope}/providers/Microsoft.Consumption/usageDetails | 


# **usage_details_download**
> UsageDetailsDownloadResponse usage_details_download(scope, api_version, metric=metric)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.usage_details_download(scope, api_version, metric=metric)
        print("The response of UsageDetailsApi->usage_details_download:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling UsageDetailsApi->usage_details_download: %s\n" % e)
```
