...
class EventsApi:
    ...
    @validate_call
    def events_by_billing_profile_list(
        self,
        ...
        _param = self._events_by_billing_profile_list_serialize(
    ...
    @validate_call
    def events_by_billing_profile_list_with_http_info(
        self,
        billing_account_id: Annotated[StrictStr, Field(description="BillingAccount ID")],
        billing_profile_id: Annotated[StrictStr, Field(description="Billing Profile Id.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-11-01-preview.")],
    ...
    @validate_call
    def events_by_billing_profile_list_without_preload_content(
        self,
        billing_account_id: Annotated[StrictStr, Field(description="BillingAccount ID")],
        billing_profile_id: Annotated[StrictStr, Field(description="Billing Profile Id.")],
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request. The current version is 2018-11-01-preview.")],
    ...
    def _events_by_billing_profile_list_serialize(
        self,
        billing_account_id,
        billing_profile_id,
        api_version,
