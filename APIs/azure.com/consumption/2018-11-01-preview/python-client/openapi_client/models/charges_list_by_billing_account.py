...
class ChargesListByBillingAccount(BaseModel):
    """
    ...
    """ # noqa: E501
    value: Optional[List[ChargeSummaryByBillingAccount]] = Field(default=None, description="The list of charge summary by billing account.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ChargeSummaryByBillingAccount.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
