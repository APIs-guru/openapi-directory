...
class ChargeSummaryProperties(BaseModel):
    ...
    billing_account_id: Optional[StrictStr] = Field(default=None, description="The id of the billing account resource that the charge belongs to.", alias="billingAccountId")
    ...
    billing_profile_id: Optional[StrictStr] = Field(default=None, description="The id of the billing profile resource that the charge belongs to.", alias="billingProfileId")
    charges_billed_separately: Optional[Amount] = Field(default=None, alias="chargesBilledSeparately")
    invoice_section_id: Optional[StrictStr] = Field(default=None, description="The id of the invoice section resource that the charge belongs to.", alias="invoiceSectionId")
    marketplace_charges: Optional[Amount] = Field(default=None, alias="marketplaceCharges")
    usage_end: Optional[StrictStr] = Field(default=None, description="Billing period end date.", alias="usageEnd")
    usage_start: Optional[StrictStr] = Field(default=None, description="Billing period start date.", alias="usageStart")
    __properties: ClassVar[List[str]] = ["azureCharges", "billingAccountId", "billingPeriodId", "billingProfileId", "chargesBilledSeparately", "invoiceSectionId", "marketplaceCharges", "usageEnd", "usageStart"]
