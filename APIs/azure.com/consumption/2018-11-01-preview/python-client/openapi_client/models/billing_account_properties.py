...
class BillingAccountProperties(BaseModel):
    ...
    agreements: Optional[StrictStr] = Field(default=None, description="Agreements associated with billing account")
    ...
    company: Optional[StrictStr] = Field(default=None, description="The Company this billing account belongs to.")
    country: Optional[StrictStr] = Field(default=None, description="The country associated with billing account.")
    default_currency: Optional[StrictStr] = Field(default=None, description="The ISO currency, for example, USD.", alias="defaultCurrency")
    ...
    invoice_sections: Optional[List[InvoiceSection]] = Field(default=None, description="The invoiceSections associated to the billing account.", alias="invoiceSections")
    __properties: ClassVar[List[str]] = ["accountType", "address", "agreements", "billingProfiles", "company", "country", "defaultCurrency", "departments", "enrollmentAccounts", "enrollmentDetails", "invoiceSections"]
    ...
    def account_type_validate_enum(cls, value):
        ...
        if value not in set(['CommerceRoot', 'Enrollment']):
            raise ValueError("must be one of enum values ('CommerceRoot', 'Enrollment')")
        return value
