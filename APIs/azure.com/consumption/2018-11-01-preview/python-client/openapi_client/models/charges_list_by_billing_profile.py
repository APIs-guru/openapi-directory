...
class ChargesListByBillingProfile(BaseModel):
    """
    ...
    """ # noqa: E501
    value: Optional[List[ChargeSummaryByBillingProfile]] = Field(default=None, description="The list of charge summary by billing profile.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ChargeSummaryByBillingProfile.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
