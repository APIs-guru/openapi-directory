...
------------- | ------------- | -------------
[**credit_summary_by_billing_profile_get**](CreditsApi.md#credit_summary_by_billing_profile_get) | **GET** /providers/Microsoft.Billing/billingAccounts/{billingAccountId}/billingProfiles/{billingProfileId}/providers/Microsoft.Consumption/credits/balanceSummary | 


# **credit_summary_by_billing_profile_get**
> CreditSummary credit_summary_by_billing_profile_get(billing_account_id, billing_profile_id, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.credit_summary_by_billing_profile_get(billing_account_id, billing_profile_id, api_version)
        print("The response of CreditsApi->credit_summary_by_billing_profile_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling CreditsApi->credit_summary_by_billing_profile_get: %s\n" % e)
```
