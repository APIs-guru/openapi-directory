...
class ManagementGroupAggregatedCostProperties(BaseModel):
    ...
    excluded_subscriptions: Optional[List[StrictStr]] = Field(default=None, description="List of subscription Guids excluded from the calculation of aggregated cost", alias="excludedSubscriptions")
    included_subscriptions: Optional[List[StrictStr]] = Field(default=None, description="List of subscription Guids included in the calculation of aggregated cost", alias="includedSubscriptions")
    ...
    __properties: ClassVar[List[str]] = ["azureCharges", "billingPeriodId", "chargesBilledSeparately", "children", "currency", "excludedSubscriptions", "includedSubscriptions", "marketplaceCharges", "usageEnd", "usageStart"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "excludedSubscriptions": obj.get("excludedSubscriptions"),
            "includedSubscriptions": obj.get("includedSubscriptions"),
