...
class ManagementGroupAggregatedCostResult(BaseModel):
    """
    A management group aggregated cost resource.
    """ # noqa: E501
    properties: Optional[ManagementGroupAggregatedCostProperties] = None
...
ManagementGroupAggregatedCostResult.model_rebuild(raise_errors=False)
