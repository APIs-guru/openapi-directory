...
class ChargesListResult(BaseModel):
    """
    Result of listing charge summary.
    """ # noqa: E501
    value: Optional[List[ChargeSummary]] = Field(default=None, description="The list of charge summary")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ChargeSummary.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
