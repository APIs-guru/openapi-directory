...
------------- | ------------- | -------------
[**events_list**](EventsApi.md#events_list) | **GET** /providers/Microsoft.Billing/billingAccounts/{billingAccountId}/billingProfiles/{billingProfileId}/providers/Microsoft.Consumption/events | 


# **events_list**
> Events events_list(billing_account_id, billing_profile_id, api_version, start_date, end_date)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.events_list(billing_account_id, billing_profile_id, api_version, start_date, end_date)
