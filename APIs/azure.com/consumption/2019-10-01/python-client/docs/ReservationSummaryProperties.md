...
**kind** | **str** | The reservation kind. | [optional] [readonly] 
...
**purchased_quantity** | **float** | This is the purchased quantity for the reservationId. | [optional] [readonly] 
**remaining_quantity** | **float** | This is the remaining quantity for the reservationId. | [optional] [readonly] 
...
**used_quantity** | **float** | This is the used quantity for the reservationId. | [optional] [readonly] 
**utilized_percentage** | **float** | This is the utilized percentage for the reservation Id. | [optional] [readonly] 
