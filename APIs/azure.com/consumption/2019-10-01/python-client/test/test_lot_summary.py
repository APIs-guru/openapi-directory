...
class TestLotSummary(unittest.TestCase):
    """LotSummary unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LotSummary:
        """Test LotSummary
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LotSummary`
        """
        model = LotSummary()
        if include_optional:
            return LotSummary(
