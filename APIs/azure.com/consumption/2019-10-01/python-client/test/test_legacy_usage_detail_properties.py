...
class TestLegacyUsageDetailProperties(unittest.TestCase):
    """LegacyUsageDetailProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> LegacyUsageDetailProperties:
        """Test LegacyUsageDetailProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `LegacyUsageDetailProperties`
        """
        model = LegacyUsageDetailProperties()
        if include_optional:
            return LegacyUsageDetailProperties(
                account_name = '',
                account_owner_id = '',
                additional_info = '',
                billing_account_id = '',
    ...
    def testLegacyUsageDetailProperties(self):
        """Test LegacyUsageDetailProperties"""
