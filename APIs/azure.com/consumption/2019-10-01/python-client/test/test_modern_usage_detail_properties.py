...
class TestModernUsageDetailProperties(unittest.TestCase):
    """ModernUsageDetailProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModernUsageDetailProperties:
        """Test ModernUsageDetailProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModernUsageDetailProperties`
        """
        model = ModernUsageDetailProperties()
        if include_optional:
            return ModernUsageDetailProperties(
                additional_info = '',
                billing_account_id = '',
    ...
    def testModernUsageDetailProperties(self):
        """Test ModernUsageDetailProperties"""
