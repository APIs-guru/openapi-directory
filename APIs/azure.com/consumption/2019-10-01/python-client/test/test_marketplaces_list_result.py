...
class TestMarketplacesListResult(unittest.TestCase):
    """MarketplacesListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MarketplacesListResult:
        """Test MarketplacesListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MarketplacesListResult`
        """
        ...
        if include_optional:
            return MarketplacesListResult(
                next_link = '',
                value = [
                    openapi_client.models.marketplace.Marketplace(
    ...
    def testMarketplacesListResult(self):
        """Test MarketplacesListResult"""
