...
class ReservationDetailProperties(BaseModel):
    ...
    instance_flexibility_ratio: Optional[StrictStr] = Field(default=None, description="The instance Flexibility Ratio.", alias="instanceFlexibilityRatio")
    ...
    __properties: ClassVar[List[str]] = ["instanceFlexibilityGroup", "instanceFlexibilityRatio", "instanceId", "kind", "reservationId", "reservationOrderId", "reservedHours", "skuName", "totalReservedQuantity", "usageDate", "usedHours"]
