...
class Lots(BaseModel):
    ...
    value: Optional[List[LotSummary]] = Field(default=None, description="The list of lot summary.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [LotSummary.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
