...
class ReservationTransactionProperties(BaseModel):
    ...
    billing_frequency: Optional[StrictStr] = Field(default=None, description="The billing frequency, which can be either one-time or recurring.", alias="billingFrequency")
    ...
    __properties: ClassVar[List[str]] = ["accountName", "accountOwnerEmail", "amount", "armSkuName", "billingFrequency", "costCenter", "currency", "currentEnrollment", "departmentName", "description", "eventDate", "eventType", "purchasingEnrollment", "purchasingSubscriptionGuid", "purchasingSubscriptionName", "quantity", "region", "reservationOrderId", "reservationOrderName", "term"]
