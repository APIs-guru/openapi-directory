...
class Amount(BaseModel):
    ...
    """ # noqa: E501
    currency: Optional[StrictStr] = Field(default=None, description="Amount currency.")
    value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="Amount.")
