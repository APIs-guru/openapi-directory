...
class BudgetProperties(BaseModel):
    ...
    def time_grain_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Monthly', 'Quarterly', 'Annually', 'BillingMonth', 'BillingQuarter', 'BillingAnnual']):
            raise ValueError("must be one of enum values ('Monthly', 'Quarterly', 'Annually', 'BillingMonth', 'BillingQuarter', 'BillingAnnual')")
        return value
