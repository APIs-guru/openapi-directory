...
class EventProperties(BaseModel):
    ...
    def event_type_validate_enum(cls, value):
        ...
        if value not in set(['SettledCharges', 'PendingCharges', 'PendingAdjustments', 'PendingNewCredit', 'PendingExpiredCredit', 'UnKnown', 'NewCredit']):
            raise ValueError("must be one of enum values ('SettledCharges', 'PendingCharges', 'PendingAdjustments', 'PendingNewCredit', 'PendingExpiredCredit', 'UnKnown', 'NewCredit')")
        return value
