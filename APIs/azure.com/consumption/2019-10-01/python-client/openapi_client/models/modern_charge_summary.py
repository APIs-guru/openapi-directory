...
class ModernChargeSummary(BaseModel):
    """
    Modern charge summary.
    """ # noqa: E501
    properties: ModernChargeSummaryProperties
    kind: StrictStr = Field(description="Specifies the kind of charge summary.")
    ...
    __properties: ClassVar[List[str]] = ["kind", "id", "name", "tags", "type"]
