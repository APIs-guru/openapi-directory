...
class EnterpriseKnowledgeGraphResponseList(BaseModel):
    """
    The list of  EnterpriseKnowledgeGraph service operation response.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The link used to get the next page of EnterpriseKnowledgeGraph service resources.", alias="nextLink")
    value: Optional[List[EnterpriseKnowledgeGraph]] = Field(default=None, description="Gets the list of EnterpriseKnowledgeGraph service results and their properties.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [EnterpriseKnowledgeGraph.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
