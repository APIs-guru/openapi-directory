...
------------ | ------------- | ------------- | -------------
**managed_identities** | [**List[ApplicationUserAssignedIdentity]**](ApplicationUserAssignedIdentity.md) | List of user assigned identities for the application, each mapped to a friendly name. | [optional] 
