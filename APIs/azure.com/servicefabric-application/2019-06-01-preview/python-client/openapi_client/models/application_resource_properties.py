...
class ApplicationResourceProperties(BaseModel):
    ...
    managed_identities: Optional[List[ApplicationUserAssignedIdentity]] = Field(default=None, description="List of user assigned identities for the application, each mapped to a friendly name.", alias="managedIdentities")
    ...
    __properties: ClassVar[List[str]] = ["managedIdentities", "maximumNodes", "metrics", "minimumNodes", "parameters", "removeApplicationCapacity", "typeVersion", "upgradePolicy"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "managedIdentities": [ApplicationUserAssignedIdentity.from_dict(_item) for _item in obj["managedIdentities"]] if obj.get("managedIdentities") is not None else None,
