...
class StatefulServiceUpdateProperties(BaseModel):
    """
    The properties of a stateful service resource for patch operations.
    """ # noqa: E501
    min_replica_set_size: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="The minimum replica set size as a number.", alias="minReplicaSetSize")
    quorum_loss_wait_duration: Optional[datetime] = Field(default=None, description="The maximum duration for which a partition is allowed to be in a state of quorum loss, represented in ISO 8601 format (hh:mm:ss.s).", alias="quorumLossWaitDuration")
    replica_restart_wait_duration: Optional[datetime] = Field(default=None, description="The duration between when a replica goes down and when a new replica is created, represented in ISO 8601 format (hh:mm:ss.s).", alias="replicaRestartWaitDuration")
    stand_by_replica_keep_duration: Optional[datetime] = Field(default=None, description="The definition on how long StandBy replicas should be maintained before being removed, represented in ISO 8601 format (hh:mm:ss.s).", alias="standByReplicaKeepDuration")
    target_replica_set_size: Optional[Annotated[int, Field(strict=True, ge=1)]] = Field(default=None, description="The target replica set size as a number.", alias="targetReplicaSetSize")
    ...
    __properties: ClassVar[List[str]] = ["serviceKind", "correlationScheme", "defaultMoveCost", "placementConstraints", "serviceLoadMetrics", "servicePlacementPolicies"]
