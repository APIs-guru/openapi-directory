...
class TestApplicationResourceUpdateProperties(unittest.TestCase):
    """ApplicationResourceUpdateProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationResourceUpdateProperties:
        """Test ApplicationResourceUpdateProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationResourceUpdateProperties`
        """
        model = ApplicationResourceUpdateProperties()
        if include_optional:
            return ApplicationResourceUpdateProperties(
                maximum_nodes = 0,
                metrics = [
    ...
    def testApplicationResourceUpdateProperties(self):
        """Test ApplicationResourceUpdateProperties"""
