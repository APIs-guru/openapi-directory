...
class TestApplicationUpgradePolicy(unittest.TestCase):
    """ApplicationUpgradePolicy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ApplicationUpgradePolicy:
        """Test ApplicationUpgradePolicy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ApplicationUpgradePolicy`
        """
    ...
    def testApplicationUpgradePolicy(self):
        """Test ApplicationUpgradePolicy"""
