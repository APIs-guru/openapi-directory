...
------------- | ------------- | -------------
[**services_create_or_update**](ServiceApi.md#services_create_or_update) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/clusters/{clusterName}/applications/{applicationName}/services/{serviceName} | Creates or updates a Service Fabric service resource.
...
> ServiceResource services_create_or_update(subscription_id, resource_group_name, cluster_name, application_name, service_name, api_version, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates or updates a Service Fabric service resource.
        api_response = api_instance.services_create_or_update(subscription_id, resource_group_name, cluster_name, application_name, service_name, api_version, parameters)
        print("The response of ServiceApi->services_create_or_update:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ServiceApi->services_create_or_update: %s\n" % e)
```
