...
------------- | ------------- | -------------
[**applications_create_or_update**](ApplicationApi.md#applications_create_or_update) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabric/clusters/{clusterName}/applications/{applicationName} | Creates or updates a Service Fabric application resource.
...
> ApplicationResource applications_create_or_update(subscription_id, resource_group_name, cluster_name, application_name, api_version, parameters)
