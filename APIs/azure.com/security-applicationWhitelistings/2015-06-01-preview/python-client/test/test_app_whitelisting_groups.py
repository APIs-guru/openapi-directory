...
class TestAppWhitelistingGroups(unittest.TestCase):
    """AppWhitelistingGroups unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AppWhitelistingGroups:
        """Test AppWhitelistingGroups
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AppWhitelistingGroups`
        """
        model = AppWhitelistingGroups()
        if include_optional:
            return AppWhitelistingGroups(
                value = [
                    openapi_client.models.app_whitelisting_group.AppWhitelistingGroup(
    ...
    def testAppWhitelistingGroups(self):
        """Test AppWhitelistingGroups"""
