...
class ProtectionMode(BaseModel):
    ...
    """ # noqa: E501
    exe: Optional[EnforcementMode] = None
    executable: Optional[EnforcementMode] = None
    msi: Optional[EnforcementMode] = None
    script: Optional[EnforcementMode] = None
    __properties: ClassVar[List[str]] = ["exe", "executable", "msi", "script"]
