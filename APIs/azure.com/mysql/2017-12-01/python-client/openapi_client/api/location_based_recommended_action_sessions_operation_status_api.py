...
class LocationBasedRecommendedActionSessionsOperationStatusApi:
    ...
    def _location_based_recommended_action_sessions_operation_status_get_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.DBforMySQL/locations/{locationName}/recommendedActionSessionsAzureAsyncOperation/{operationId}',
