...
class ServerUpdateParameters(BaseModel):
    """
    Parameters allowed to update for a server.
    """ # noqa: E501
    properties: Optional[ServerUpdateParametersProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": ServerUpdateParametersProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
