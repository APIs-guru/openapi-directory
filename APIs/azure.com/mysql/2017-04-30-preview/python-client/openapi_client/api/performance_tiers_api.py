...
class PerformanceTiersApi:
    ...
    def performance_tiers_list(
        ...
        _param = self._performance_tiers_list_serialize(
    ...
    @validate_call
    def performance_tiers_list_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="The API version to use for the request.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription ID that identifies an Azure subscription.")],
        _request_timeout: Union[
    ...
    @validate_call
    def performance_tiers_list_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="The API version to use for the request.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription ID that identifies an Azure subscription.")],
        _request_timeout: Union[
    ...
    def _performance_tiers_list_serialize(
        self,
        api_version,
        subscription_id,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.DBforMySQL/performanceTiers',
