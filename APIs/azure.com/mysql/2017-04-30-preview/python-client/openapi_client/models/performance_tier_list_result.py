...
class PerformanceTierListResult(BaseModel):
    """
    A list of performance tiers.
    """ # noqa: E501
    value: Optional[List[PerformanceTierProperties]] = Field(default=None, description="The list of performance tiers")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [PerformanceTierProperties.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
