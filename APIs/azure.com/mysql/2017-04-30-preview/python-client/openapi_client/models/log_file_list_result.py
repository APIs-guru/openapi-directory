...
class LogFileListResult(BaseModel):
    """
    A list of log files.
    """ # noqa: E501
    value: Optional[List[LogFile]] = Field(default=None, description="The list of log files.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [LogFile.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
