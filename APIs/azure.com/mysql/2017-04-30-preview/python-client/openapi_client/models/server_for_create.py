...
class ServerForCreate(BaseModel):
    """
    Represents a server to be created.
    """ # noqa: E501
    location: StrictStr = Field(description="The location the resource resides in.")
    ...
    __properties: ClassVar[List[str]] = ["location", "properties", "sku", "tags"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": ServerPropertiesForCreate.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
