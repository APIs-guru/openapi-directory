...
class ServerUpdateParametersProperties(BaseModel):
    ...
    storage_mb: Optional[Annotated[int, Field(strict=True, ge=1024)]] = Field(default=None, description="The max storage allowed for a server.", alias="storageMB")
    version: Optional[ServerVersion] = None
    __properties: ClassVar[List[str]] = ["administratorLoginPassword", "sslEnforcement", "storageMB", "version"]
