...
class ServerPropertiesForRestore(ServerPropertiesForCreate):
    ...
    """ # noqa: E501
    restore_point_in_time: datetime = Field(description="Restore point creation time (ISO8601 format), specifying the time to restore from.", alias="restorePointInTime")
