...
class ServerAdministratorResourceListResult(BaseModel):
    """
    The response to a list Active Directory Administrators request.
    """ # noqa: E501
    value: Optional[List[ServerAdministratorResource]] = Field(default=None, description="The list of server Active Directory Administrators for the server.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ServerAdministratorResource.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
