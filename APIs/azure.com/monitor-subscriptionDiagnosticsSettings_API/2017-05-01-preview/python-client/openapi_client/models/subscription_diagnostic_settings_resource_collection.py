...
class SubscriptionDiagnosticSettingsResourceCollection(BaseModel):
    """
    Represents a collection of subscription diagnostic settings resources.
    """ # noqa: E501
    value: Optional[List[SubscriptionDiagnosticSettingsResource]] = Field(default=None, description="The collection of subscription diagnostic settings resources.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [SubscriptionDiagnosticSettingsResource.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
