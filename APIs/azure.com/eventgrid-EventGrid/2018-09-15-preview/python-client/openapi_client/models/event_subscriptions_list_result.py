...
class EventSubscriptionsListResult(BaseModel):
    """
    Result of the List EventSubscriptions operation
    """ # noqa: E501
    value: Optional[List[EventSubscription]] = Field(default=None, description="A collection of EventSubscriptions")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [EventSubscription.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
