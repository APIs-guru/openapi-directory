...
class TopicTypesListResult(BaseModel):
    """
    Result of the List Topic Types operation
    """ # noqa: E501
    value: Optional[List[TopicTypeInfo]] = Field(default=None, description="A collection of topic types")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [TopicTypeInfo.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
