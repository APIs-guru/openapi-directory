...
class AdvancedFilter(BaseModel):
    ...
    """ # noqa: E501
    key: Optional[StrictStr] = Field(default=None, description="The filter key. Represents an event property with up to two levels of nesting.")
    operator_type: StrictStr = Field(description="Represents the filter operator", alias="operatorType")
