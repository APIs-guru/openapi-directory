...
# **event_subscriptions_list_by_domain_topic**
> EventSubscriptionsListResult event_subscriptions_list_by_domain_topic(subscription_id, resource_group_name, domain_name, topic_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List all event subscriptions for a specific domain topic
        api_response = api_instance.event_subscriptions_list_by_domain_topic(subscription_id, resource_group_name, domain_name, topic_name, api_version)
