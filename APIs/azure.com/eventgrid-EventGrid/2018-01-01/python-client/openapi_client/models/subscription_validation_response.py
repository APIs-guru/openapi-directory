...
class SubscriptionValidationResponse(BaseModel):
    ...
    """ # noqa: E501
    validation_response: Optional[StrictStr] = Field(default=None, description="The validation response sent by the subscriber to Azure Event Grid to complete the validation of an event subscription.", alias="validationResponse")
    __properties: ClassVar[List[str]] = ["validationResponse"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "validationResponse": obj.get("validationResponse")
        })
        return _obj
