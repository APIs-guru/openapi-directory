...
class EventSubscriptionDestination(BaseModel):
    ...
    """ # noqa: E501
    endpoint_type: Optional[StrictStr] = Field(default=None, description="Type of the endpoint for the event subscription destination", alias="endpointType")
    properties: Optional[EventSubscriptionDestinationProperties] = None
    __properties: ClassVar[List[str]] = ["endpointType", "properties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": EventSubscriptionDestinationProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
