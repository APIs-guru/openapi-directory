...
> TopicsListResult topics_list_by_resource_group(subscription_id, resource_group_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List topics under a resource group
        api_response = api_instance.topics_list_by_resource_group(subscription_id, resource_group_name, api_version)
...
> TopicsListResult topics_list_by_subscription(subscription_id, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # List topics under an Azure subscription
        api_response = api_instance.topics_list_by_subscription(subscription_id, api_version)
