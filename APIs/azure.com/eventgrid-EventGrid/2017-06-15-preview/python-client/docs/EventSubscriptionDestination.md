...
------------ | ------------- | ------------- | -------------
**endpoint_type** | **str** | Type of the endpoint for the event subscription destination | [optional] 
**properties** | [**EventSubscriptionDestinationProperties**](EventSubscriptionDestinationProperties.md) |  | [optional] 
