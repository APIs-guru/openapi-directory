...
class EventSubscriptionProperties(BaseModel):
    """
    ...
    event_delivery_schema: Optional[StrictStr] = Field(default='InputEventSchema', description="The event delivery schema for the event subscription.", alias="eventDeliverySchema")
    ...
    provisioning_state: Optional[StrictStr] = Field(default=None, description="Provisioning state of the event subscription.", alias="provisioningState")
    retry_policy: Optional[RetryPolicy] = Field(default=None, alias="retryPolicy")
    topic: Optional[StrictStr] = Field(default=None, description="Name of the topic of the event subscription.")
    __properties: ClassVar[List[str]] = ["deadLetterDestination", "destination", "eventDeliverySchema", "filter", "labels", "provisioningState", "retryPolicy", "topic"]
    ...
    def event_delivery_schema_validate_enum(cls, value):
        ...
        if value not in set(['EventGridSchema', 'InputEventSchema', 'CloudEventV01Schema']):
            raise ValueError("must be one of enum values ('EventGridSchema', 'InputEventSchema', 'CloudEventV01Schema')")
        return value
    ...
    def provisioning_state_validate_enum(cls, value):
        ...
        if value not in set(['Creating', 'Updating', 'Deleting', 'Succeeded', 'Canceled', 'Failed', 'AwaitingManualAction']):
            raise ValueError("must be one of enum values ('Creating', 'Updating', 'Deleting', 'Succeeded', 'Canceled', 'Failed', 'AwaitingManualAction')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "eventDeliverySchema": obj.get("eventDeliverySchema") if obj.get("eventDeliverySchema") is not None else 'InputEventSchema',
