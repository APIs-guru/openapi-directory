...
class ServiceBusQueueEventSubscriptionDestinationProperties(BaseModel):
    """
    The properties that represent the Service Bus destination of an event subscription.
    """ # noqa: E501
    resource_id: Optional[StrictStr] = Field(default=None, description="The Azure Resource Id that represents the endpoint of the Service Bus destination of an event subscription.", alias="resourceId")
