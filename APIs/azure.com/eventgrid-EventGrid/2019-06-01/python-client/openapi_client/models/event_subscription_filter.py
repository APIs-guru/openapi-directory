...
class EventSubscriptionFilter(BaseModel):
    ...
    """ # noqa: E501
    advanced_filters: Optional[List[AdvancedFilter]] = Field(default=None, description="An array of advanced filters that are used for filtering event subscriptions.", alias="advancedFilters")
    included_event_types: Optional[List[StrictStr]] = Field(default=None, description="A list of applicable event types that need to be part of the event subscription. If it is desired to subscribe to all default event types, set the IncludedEventTypes to null.", alias="includedEventTypes")
