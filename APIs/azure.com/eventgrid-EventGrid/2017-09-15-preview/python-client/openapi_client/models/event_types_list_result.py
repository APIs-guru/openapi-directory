...
class EventTypesListResult(BaseModel):
    """
    Result of the List Event Types operation
    """ # noqa: E501
    value: Optional[List[EventType]] = Field(default=None, description="A collection of event types")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [EventType.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
