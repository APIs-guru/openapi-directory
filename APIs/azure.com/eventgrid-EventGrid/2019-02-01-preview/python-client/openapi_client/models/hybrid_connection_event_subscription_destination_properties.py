...
class HybridConnectionEventSubscriptionDestinationProperties(BaseModel):
    """
    The properties for a hybrid connection destination.
    """ # noqa: E501
    resource_id: Optional[StrictStr] = Field(default=None, description="The Azure Resource ID of an hybrid connection that is the destination of an event subscription.", alias="resourceId")
