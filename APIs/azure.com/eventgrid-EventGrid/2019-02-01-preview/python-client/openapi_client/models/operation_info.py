...
class OperationInfo(BaseModel):
    ...
    provider: Optional[StrictStr] = Field(default=None, description="Name of the provider")
    resource: Optional[StrictStr] = Field(default=None, description="Name of the resource type")
