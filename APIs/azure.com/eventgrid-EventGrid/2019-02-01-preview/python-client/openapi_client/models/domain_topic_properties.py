...
class DomainTopicProperties(BaseModel):
    """
    Properties of the Domain Topic
    """ # noqa: E501
    provisioning_state: Optional[StrictStr] = Field(default=None, description="Provisioning state of the domain topic.", alias="provisioningState")
