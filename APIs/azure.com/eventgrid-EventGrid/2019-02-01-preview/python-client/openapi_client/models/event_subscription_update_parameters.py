...
class EventSubscriptionUpdateParameters(BaseModel):
    ...
    def event_delivery_schema_validate_enum(cls, value):
        ...
        if value not in set(['EventGridSchema', 'CloudEventV01Schema', 'CustomInputSchema']):
            raise ValueError("must be one of enum values ('EventGridSchema', 'CloudEventV01Schema', 'CustomInputSchema')")
        return value
