...
class TopicsListResult(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="A link for the next page of topics", alias="nextLink")
    value: Optional[List[Topic]] = Field(default=None, description="A collection of Topics")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Topic.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
