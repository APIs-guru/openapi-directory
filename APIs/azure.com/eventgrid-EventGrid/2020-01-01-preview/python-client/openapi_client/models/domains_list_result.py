...
class DomainsListResult(BaseModel):
    """
    Result of the List Domains operation
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="A link for the next page of domains", alias="nextLink")
    value: Optional[List[Domain]] = Field(default=None, description="A collection of Domains")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Domain.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
