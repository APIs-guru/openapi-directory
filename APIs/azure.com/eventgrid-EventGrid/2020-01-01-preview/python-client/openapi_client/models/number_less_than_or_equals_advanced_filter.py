...
class NumberLessThanOrEqualsAdvancedFilter(AdvancedFilter):
    ...
    """ # noqa: E501
    value: Optional[Union[StrictFloat, StrictInt]] = Field(default=None, description="The filter value.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NumberLessThanOrEqualsAdvancedFilter from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of NumberLessThanOrEqualsAdvancedFilter from a dict"""
        if obj is None:
            return None
