...
class EventSubscriptionProperties(BaseModel):
    ...
    expiration_time_utc: Optional[datetime] = Field(default=None, description="Expiration time of the event subscription.", alias="expirationTimeUtc")
    ...
    __properties: ClassVar[List[str]] = ["deadLetterDestination", "destination", "eventDeliverySchema", "expirationTimeUtc", "filter", "labels", "provisioningState", "retryPolicy", "topic"]
