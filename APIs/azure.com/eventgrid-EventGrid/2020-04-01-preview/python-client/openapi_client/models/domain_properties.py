...
class DomainProperties(BaseModel):
    ...
    input_schema: Optional[StrictStr] = Field(default='EventGridSchema', description="This determines the format that Event Grid should expect for incoming events published to the domain.", alias="inputSchema")
    input_schema_mapping: Optional[InputSchemaMapping] = Field(default=None, alias="inputSchemaMapping")
    metric_resource_id: Optional[StrictStr] = Field(default=None, description="Metric resource id for the domain.", alias="metricResourceId")
