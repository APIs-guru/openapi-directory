...
class AzureFunctionEventSubscriptionDestinationProperties(BaseModel):
    """
    ...
    resource_id: Optional[StrictStr] = Field(default=None, description="The Azure Resource Id that represents the endpoint of the Azure Function destination of an event subscription.", alias="resourceId")
    __properties: ClassVar[List[str]] = ["maxEventsPerBatch", "preferredBatchSizeInKilobytes", "resourceId"]
