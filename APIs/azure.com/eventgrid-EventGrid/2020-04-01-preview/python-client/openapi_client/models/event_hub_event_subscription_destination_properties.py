...
class EventHubEventSubscriptionDestinationProperties(BaseModel):
    """
    The properties for a event hub destination.
    """ # noqa: E501
    resource_id: Optional[StrictStr] = Field(default=None, description="The Azure Resource Id that represents the endpoint of an Event Hub destination of an event subscription.", alias="resourceId")
