...
class DomainTopicsListResult(BaseModel):
    """
    Result of the List Domain Topics operation
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="A link for the next page of domain topics", alias="nextLink")
    value: Optional[List[DomainTopic]] = Field(default=None, description="A collection of Domain Topics")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [DomainTopic.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
