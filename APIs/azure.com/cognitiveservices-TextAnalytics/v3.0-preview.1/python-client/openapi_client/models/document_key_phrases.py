...
class DocumentKeyPhrases(BaseModel):
    """
    DocumentKeyPhrases
    """ # noqa: E501
    id: StrictStr = Field(description="Unique, non-empty document identifier.")
    key_phrases: List[StrictStr] = Field(description="A list of representative words or phrases. The number of key phrases returned is proportional to the number of words in the input document.", alias="keyPhrases")
