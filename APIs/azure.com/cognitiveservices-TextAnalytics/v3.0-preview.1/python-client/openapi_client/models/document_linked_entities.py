...
class DocumentLinkedEntities(BaseModel):
    """
    DocumentLinkedEntities
    """ # noqa: E501
    entities: List[LinkedEntity] = Field(description="Recognized well-known entities in the document.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "entities": [LinkedEntity.from_dict(_item) for _item in obj["entities"]] if obj.get("entities") is not None else None,
            "id": obj.get("id"),
