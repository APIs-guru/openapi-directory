...
class DocumentLanguage(BaseModel):
    ...
    DocumentLanguage
    """ # noqa: E501
    detected_languages: List[DetectedLanguage] = Field(description="A list of extracted languages.", alias="detectedLanguages")
    id: StrictStr = Field(description="Unique, non-empty document identifier.")
    statistics: Optional[DocumentStatistics] = None
    __properties: ClassVar[List[str]] = ["detectedLanguages", "id", "statistics"]
