...
class TextAnalyticsError(BaseModel):
    """
    TextAnalyticsError
    """ # noqa: E501
    code: StrictStr = Field(description="Error code.")
    details: Optional[List[TextAnalyticsError]] = Field(default=None, description="Details about specific errors that led to this reported error.")
    ...
    def code_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['invalidRequest', 'invalidArgument', 'internalServerError', 'serviceUnavailable']):
            raise ValueError("must be one of enum values ('invalidRequest', 'invalidArgument', 'internalServerError', 'serviceUnavailable')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": obj.get("code"),
            "details": [TextAnalyticsError.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None,
...
TextAnalyticsError.model_rebuild(raise_errors=False)
