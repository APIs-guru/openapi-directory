...
class EntitiesBatchResultV2dot1(BaseModel):
    """
    EntitiesBatchResultV2dot1
    """ # noqa: E501
    documents: Optional[List[EntitiesBatchResultItemV2dot1]] = None
    errors: Optional[List[ErrorRecord]] = None
    __properties: ClassVar[List[str]] = ["documents", "errors"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "documents": [EntitiesBatchResultItemV2dot1.from_dict(_item) for _item in obj["documents"]] if obj.get("documents") is not None else None,
