...
class EntityRecordV2dot1(BaseModel):
    """
    EntityRecordV2dot1
    """ # noqa: E501
    ...
    matches: Optional[List[MatchRecordV2dot1]] = Field(default=None, description="List of instances this entity appears in the text.")
    name: Optional[StrictStr] = Field(default=None, description="Entity formal name.")
    sub_type: Optional[StrictStr] = Field(default=None, description="Entity sub type from Named Entity Recognition model", alias="subType")
    type: Optional[StrictStr] = Field(default=None, description="Entity type from Named Entity Recognition model")
    ...
    __properties: ClassVar[List[str]] = ["bingId", "matches", "name", "subType", "type", "wikipediaId", "wikipediaLanguage", "wikipediaUrl"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "matches": [MatchRecordV2dot1.from_dict(_item) for _item in obj["matches"]] if obj.get("matches") is not None else None,
            "name": obj.get("name"),
