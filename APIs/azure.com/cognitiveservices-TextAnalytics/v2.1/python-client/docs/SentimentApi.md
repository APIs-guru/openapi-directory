...
# **sentiment**
> SentimentBatchResult sentiment(show_stats=show_stats, multi_language_batch_input=multi_language_batch_input)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # The API returns a numeric score between 0 and 1.
        api_response = api_instance.sentiment(show_stats=show_stats, multi_language_batch_input=multi_language_batch_input)
