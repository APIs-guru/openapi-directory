...
**matches** | [**List[MatchRecord]**](MatchRecord.md) | List of instances this entity appears in the text. | [optional] 
...
**wikipedia_url** | **str** | URL for the entity&#39;s Wikipedia page. | [optional] [readonly] 
