...
class SentimentApi:
    ...
    def sentiment(
        ...
        multi_language_batch_input: Annotated[Optional[MultiLanguageBatchInput], Field(description="Collection of documents to analyze.")] = None,
        ...
        :type multi_language_batch_input: MultiLanguageBatchInput
        ...
        _param = self._sentiment_serialize(
            ...
            multi_language_batch_input=multi_language_batch_input,
    ...
    def sentiment_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[SentimentBatchResult]:
        """The API returns a numeric score between 0 and 1.
    ...
    def _sentiment_serialize(
        ...
        if multi_language_batch_input is not None:
            _body_params = multi_language_batch_input
