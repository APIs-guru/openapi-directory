...
class LanguageBatchResultItem(BaseModel):
    """
    LanguageBatchResultItem
    """ # noqa: E501
    detected_languages: Optional[List[DetectedLanguage]] = Field(default=None, description="A list of extracted languages.", alias="detectedLanguages")
    id: Optional[StrictStr] = Field(default=None, description="Unique document identifier.")
    __properties: ClassVar[List[str]] = ["detectedLanguages", "id"]
