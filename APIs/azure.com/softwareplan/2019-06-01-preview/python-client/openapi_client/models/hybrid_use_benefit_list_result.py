...
class HybridUseBenefitListResult(BaseModel):
    """
    List of hybrid use benefits
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Url to get the next page of items.", alias="nextLink")
    value: Optional[List[HybridUseBenefitModel]] = Field(default=None, description="List of hybrid use benefits")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [HybridUseBenefitModel.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
