...
class Error(BaseModel):
    ...
    message: Optional[StrictStr] = Field(default=None, description="A user readable error message. Localized based on x-ms-effective-locale header in the request")
