...
class OperationList(BaseModel):
    ...
    value: Optional[List[OperationResponse]] = Field(default=None, description="List of all operations")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [OperationResponse.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
