...
class HybridUseBenefitProperties(BaseModel):
    """
    Hybrid use benefit properties
    """ # noqa: E501
    created_date: Optional[datetime] = Field(default=None, description="Created date", alias="createdDate")
    last_updated_date: Optional[datetime] = Field(default=None, description="Last updated date", alias="lastUpdatedDate")
    provisioning_state: Optional[ProvisioningState] = Field(default=None, alias="provisioningState")
    __properties: ClassVar[List[str]] = ["createdDate", "lastUpdatedDate", "provisioningState"]
