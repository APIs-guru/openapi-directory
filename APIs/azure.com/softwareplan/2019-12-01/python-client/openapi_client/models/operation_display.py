...
class OperationDisplay(BaseModel):
    ...
    operation: Optional[StrictStr] = Field(default=None, description="Operation to be performed")
    provider: Optional[StrictStr] = Field(default=None, description="Resource Provider name")
    resource: Optional[StrictStr] = Field(default=None, description="Resource that is acted upon")
