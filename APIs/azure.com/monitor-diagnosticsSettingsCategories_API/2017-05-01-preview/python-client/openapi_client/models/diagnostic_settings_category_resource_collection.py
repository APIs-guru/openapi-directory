...
class DiagnosticSettingsCategoryResourceCollection(BaseModel):
    """
    Represents a collection of diagnostic setting category resources.
    """ # noqa: E501
    value: Optional[List[DiagnosticSettingsCategoryResource]] = Field(default=None, description="The collection of diagnostic settings category resources.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [DiagnosticSettingsCategoryResource.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
