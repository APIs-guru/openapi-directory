...
class ServerKeysApi:
    ...
    def server_keys_create_or_update(
        ...
        key_name: Annotated[StrictStr, Field(description="The name of the MySQL Server key to be operated on (updated or created).")],
        ...
        parameters: Annotated[ServerKey, Field(description="The requested MySQL Server key resource state.")],
        ...
        :param key_name: The name of the MySQL Server key to be operated on (updated or created). (required)
        :type key_name: str
    ...
    def _server_keys_create_or_update_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/servers/{serverName}/keys/{keyName}',
    ...
    def server_keys_delete(
        ...
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        key_name: Annotated[StrictStr, Field(description="The name of the MySQL Server key to be deleted.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription ID that identifies an Azure subscription.")],
        api_version: Annotated[StrictStr, Field(description="The API version to use for the request.")],
        _request_timeout: Union[
            None,
    ...
    def server_keys_get(
        ...
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        key_name: Annotated[StrictStr, Field(description="The name of the MySQL Server key to be retrieved.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription ID that identifies an Azure subscription.")],
        api_version: Annotated[StrictStr, Field(description="The API version to use for the request.")],
        _request_timeout: Union[
            None,
    ...
    def _server_keys_list_by_instance_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.DBforMySQL/servers/{serverName}/keys',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
