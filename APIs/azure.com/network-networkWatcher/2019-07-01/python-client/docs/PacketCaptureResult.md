...
------------ | ------------- | ------------- | -------------
**etag** | **str** | A unique read-only string that changes whenever the resource is updated. | [optional] [default to 'A unique read-only string that changes whenever the resource is updated.']
