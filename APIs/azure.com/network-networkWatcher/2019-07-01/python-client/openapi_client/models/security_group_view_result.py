...
class SecurityGroupViewResult(BaseModel):
    """
    The information about security rules applied to the specified VM.
    """ # noqa: E501
    network_interfaces: Optional[List[SecurityGroupNetworkInterface]] = Field(default=None, description="List of network interfaces on the specified VM.", alias="networkInterfaces")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "networkInterfaces": [SecurityGroupNetworkInterface.from_dict(_item) for _item in obj["networkInterfaces"]] if obj.get("networkInterfaces") is not None else None
        })
        return _obj
