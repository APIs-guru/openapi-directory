...
class TrafficAnalyticsApi:
    ...
    @validate_call
    def network_watchers_get_flow_log_status_0(
        self,
        ...
        _param = self._network_watchers_get_flow_log_status_0_serialize(
    ...
    @validate_call
    def network_watchers_get_flow_log_status_0_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the network watcher resource group.")],
        network_watcher_name: Annotated[StrictStr, Field(description="The name of the network watcher resource.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
    ...
    @validate_call
    def network_watchers_get_flow_log_status_0_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the network watcher resource group.")],
        network_watcher_name: Annotated[StrictStr, Field(description="The name of the network watcher resource.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
    ...
    def _network_watchers_get_flow_log_status_0_serialize(
        self,
        resource_group_name,
    ...
    @validate_call
    def network_watchers_set_flow_log_configuration_0(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the network watcher resource group.")],
        network_watcher_name: Annotated[StrictStr, Field(description="The name of the network watcher resource.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        ...
        _param = self._network_watchers_set_flow_log_configuration_0_serialize(
            resource_group_name=resource_group_name,
            network_watcher_name=network_watcher_name,
            api_version=api_version,
            subscription_id=subscription_id,
    ...
    @validate_call
    def network_watchers_set_flow_log_configuration_0_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the network watcher resource group.")],
        network_watcher_name: Annotated[StrictStr, Field(description="The name of the network watcher resource.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
    ...
    @validate_call
    def network_watchers_set_flow_log_configuration_0_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the network watcher resource group.")],
        network_watcher_name: Annotated[StrictStr, Field(description="The name of the network watcher resource.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
    ...
    def _network_watchers_set_flow_log_configuration_0_serialize(
        self,
        resource_group_name,
        network_watcher_name,
        api_version,
