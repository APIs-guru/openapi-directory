...
class NetworkInterfaceAssociation(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Network interface ID.")
    security_rules: Optional[List[NetworkInterfaceAssociationSecurityRulesInner]] = Field(default=None, description="Collection of custom security rules.", alias="securityRules")
    __properties: ClassVar[List[str]] = ["id", "securityRules"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "securityRules": [NetworkInterfaceAssociationSecurityRulesInner.from_dict(_item) for _item in obj["securityRules"]] if obj.get("securityRules") is not None else None
        })
        return _obj
