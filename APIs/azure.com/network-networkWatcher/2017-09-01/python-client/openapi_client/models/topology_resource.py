...
class TopologyResource(BaseModel):
    ...
    """ # noqa: E501
    associations: Optional[List[TopologyAssociation]] = Field(default=None, description="Holds the associations the resource has with other resources in the resource group.")
    ...
    __properties: ClassVar[List[str]] = ["associations", "id", "location", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "associations": [TopologyAssociation.from_dict(_item) for _item in obj["associations"]] if obj.get("associations") is not None else None,
            "id": obj.get("id"),
