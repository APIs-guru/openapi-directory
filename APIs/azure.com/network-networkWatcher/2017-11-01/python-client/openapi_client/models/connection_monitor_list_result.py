...
class ConnectionMonitorListResult(BaseModel):
    """
    List of connection monitors.
    """ # noqa: E501
    value: Optional[List[ConnectionMonitorResult]] = Field(default=None, description="Information about connection monitors.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ConnectionMonitorResult.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
