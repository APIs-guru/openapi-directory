...
class FlowLogsApi:
    ...
    @validate_call
    def flow_logs_create_or_update(
        self,
        ...
        flow_log_name: Annotated[StrictStr, Field(description="The name of the flow log.")],
        ...
        parameters: Annotated[FlowLog, Field(description="Parameters that define the create or update flow log resource.")],
        ...
        _param = self._flow_logs_create_or_update_serialize(
    ...
    @validate_call
    def flow_logs_create_or_update_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        network_watcher_name: Annotated[StrictStr, Field(description="The name of the network watcher.")],
        flow_log_name: Annotated[StrictStr, Field(description="The name of the flow log.")],
    ...
    @validate_call
    def flow_logs_create_or_update_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        network_watcher_name: Annotated[StrictStr, Field(description="The name of the network watcher.")],
        flow_log_name: Annotated[StrictStr, Field(description="The name of the flow log.")],
    ...
    def _flow_logs_create_or_update_serialize(
        self,
        resource_group_name,
        ...
        if flow_log_name is not None:
            _path_params['flowLogName'] = flow_log_name
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkWatchers/{networkWatcherName}/flowLogs/{flowLogName}',
    ...
    @validate_call
    def flow_logs_delete(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        network_watcher_name: Annotated[StrictStr, Field(description="The name of the network watcher.")],
        flow_log_name: Annotated[StrictStr, Field(description="The name of the flow log resource.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        _request_timeout: Union[
            None,
        ...
        _param = self._flow_logs_delete_serialize(
            resource_group_name=resource_group_name,
            network_watcher_name=network_watcher_name,
            flow_log_name=flow_log_name,
            api_version=api_version,
    ...
    @validate_call
    def flow_logs_delete_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        network_watcher_name: Annotated[StrictStr, Field(description="The name of the network watcher.")],
        flow_log_name: Annotated[StrictStr, Field(description="The name of the flow log resource.")],
    ...
    @validate_call
    def flow_logs_delete_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        network_watcher_name: Annotated[StrictStr, Field(description="The name of the network watcher.")],
        flow_log_name: Annotated[StrictStr, Field(description="The name of the flow log resource.")],
    ...
    def _flow_logs_delete_serialize(
        self,
        resource_group_name,
        network_watcher_name,
        flow_log_name,
    ...
    def flow_logs_get(
        ...
        _param = self._flow_logs_get_serialize(
            resource_group_name=resource_group_name,
            network_watcher_name=network_watcher_name,
            flow_log_name=flow_log_name,
            api_version=api_version,
    ...
    @validate_call
    def flow_logs_get_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        network_watcher_name: Annotated[StrictStr, Field(description="The name of the network watcher.")],
        flow_log_name: Annotated[StrictStr, Field(description="The name of the flow log resource.")],
    ...
    @validate_call
    def flow_logs_get_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        network_watcher_name: Annotated[StrictStr, Field(description="The name of the network watcher.")],
        flow_log_name: Annotated[StrictStr, Field(description="The name of the flow log resource.")],
    ...
    def flow_logs_list(
        ...
        _param = self._flow_logs_list_serialize(
            resource_group_name=resource_group_name,
            network_watcher_name=network_watcher_name,
            api_version=api_version,
            subscription_id=subscription_id,
    ...
    @validate_call
    def flow_logs_list_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group containing Network Watcher.")],
        network_watcher_name: Annotated[StrictStr, Field(description="The name of the Network Watcher resource.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
    ...
    @validate_call
    def flow_logs_list_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group containing Network Watcher.")],
        network_watcher_name: Annotated[StrictStr, Field(description="The name of the Network Watcher resource.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
    ...
    def _flow_logs_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkWatchers/{networkWatcherName}/flowLogs',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
