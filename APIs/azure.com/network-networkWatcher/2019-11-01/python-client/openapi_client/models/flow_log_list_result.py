...
class FlowLogListResult(BaseModel):
    ...
    value: Optional[List[FlowLog]] = Field(default=None, description="Information about flow log resource.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [FlowLog.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
