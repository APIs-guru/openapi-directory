...
class AvailableProvidersList(BaseModel):
    """
    List of available countries with details.
    """ # noqa: E501
    countries: List[AvailableProvidersListCountry] = Field(description="List of available countries.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "countries": [AvailableProvidersListCountry.from_dict(_item) for _item in obj["countries"]] if obj.get("countries") is not None else None
        })
        return _obj
