...
class ConnectionMonitorResultProperties(BaseModel):
    ...
    provisioning_state: Optional[StrictStr] = Field(default=None, description="The provisioning state of the connection monitor.", alias="provisioningState")
    ...
    __properties: ClassVar[List[str]] = ["autoStart", "destination", "monitoringIntervalInSeconds", "source"]
