...
class NetworkWatcherListResult(BaseModel):
    """
    Response for ListNetworkWatchers API service call.
    """ # noqa: E501
    value: Optional[List[NetworkWatcher]] = Field(default=None, description="List of network watcher resources.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [NetworkWatcher.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
