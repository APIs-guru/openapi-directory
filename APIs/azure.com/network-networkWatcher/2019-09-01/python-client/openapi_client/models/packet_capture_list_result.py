...
class PacketCaptureListResult(BaseModel):
    """
    List of packet capture sessions.
    """ # noqa: E501
    value: Optional[List[PacketCaptureResult]] = Field(default=None, description="Information about packet capture sessions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [PacketCaptureResult.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
