...
class SecurityRuleAssociationsEffectiveSecurityRulesInner(BaseModel):
    ...
    """ # noqa: E501
    access: Optional[StrictStr] = Field(default=None, description="Whether network traffic is allowed or denied.")
    ...
    direction: Optional[StrictStr] = Field(default=None, description="The direction of the rule. The direction specifies if rule will be evaluated on incoming or outgoing traffic.")
    ...
    protocol: Optional[StrictStr] = Field(default=None, description="The network protocol this rule applies to.")
