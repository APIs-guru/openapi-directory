...
class FlowLogFormatParameters(BaseModel):
    """
    Parameters that define the flow log format.
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default=None, description="The file type of flow log.")
    version: Optional[StrictInt] = Field(default=None, description="The version (revision) of the flow log.")
