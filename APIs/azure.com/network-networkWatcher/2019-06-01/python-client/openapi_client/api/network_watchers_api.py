...
class NetworkWatchersApi:
    ...
    @validate_call
    def network_watchers_get_network_configuration_diagnostic(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        network_watcher_name: Annotated[StrictStr, Field(description="The name of the network watcher.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        parameters: Annotated[NetworkConfigurationDiagnosticParameters, Field(description="Parameters to get network configuration diagnostic.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type parameters: NetworkConfigurationDiagnosticParameters
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._network_watchers_get_network_configuration_diagnostic_serialize(
            resource_group_name=resource_group_name,
            network_watcher_name=network_watcher_name,
            api_version=api_version,
            subscription_id=subscription_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "NetworkConfigurationDiagnosticResponse",
            '202': "NetworkConfigurationDiagnosticResponse",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def network_watchers_get_network_configuration_diagnostic_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        network_watcher_name: Annotated[StrictStr, Field(description="The name of the network watcher.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[NetworkConfigurationDiagnosticResponse]:
        """network_watchers_get_network_configuration_diagnostic
    ...
    @validate_call
    def network_watchers_get_network_configuration_diagnostic_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        network_watcher_name: Annotated[StrictStr, Field(description="The name of the network watcher.")],
        api_version: Annotated[StrictStr, Field(description="Client API version.")],
    ...
    def _network_watchers_get_network_configuration_diagnostic_serialize(
        self,
        resource_group_name,
        network_watcher_name,
        api_version,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkWatchers/{networkWatcherName}/networkConfigurationDiagnostic',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
