...
class HTTPConfiguration(BaseModel):
    ...
    """ # noqa: E501
    headers: Optional[List[HTTPHeader]] = Field(default=None, description="List of HTTP headers.")
    method: Optional[StrictStr] = Field(default=None, description="HTTP method.")
    valid_status_codes: Optional[List[StrictInt]] = Field(default=None, description="Valid status codes.", alias="validStatusCodes")
    __properties: ClassVar[List[str]] = ["headers", "method", "validStatusCodes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "validStatusCodes": obj.get("validStatusCodes")
        })
        return _obj
