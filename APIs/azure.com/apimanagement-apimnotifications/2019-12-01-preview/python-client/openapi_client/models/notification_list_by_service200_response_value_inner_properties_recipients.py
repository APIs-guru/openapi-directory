...
class NotificationListByService200ResponseValueInnerPropertiesRecipients(BaseModel):
    """
    Notification Parameter contract.
    """ # noqa: E501
    emails: Optional[List[StrictStr]] = Field(default=None, description="List of Emails subscribed for the notification.")
    users: Optional[List[StrictStr]] = Field(default=None, description="List of Users subscribed for the notification.")
    __properties: ClassVar[List[str]] = ["emails", "users"]
