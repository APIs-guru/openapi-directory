...
class NotificationListByServiceDefaultResponse(BaseModel):
    """
    Error Response.
    """ # noqa: E501
    error: Optional[NotificationListByServiceDefaultResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": NotificationListByServiceDefaultResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
