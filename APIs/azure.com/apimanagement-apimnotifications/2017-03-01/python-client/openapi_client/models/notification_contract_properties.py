...
class NotificationContractProperties(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "recipients": RecipientsContractProperties.from_dict(obj["recipients"]) if obj.get("recipients") is not None else None,
            "title": obj.get("title")
        })
        return _obj
