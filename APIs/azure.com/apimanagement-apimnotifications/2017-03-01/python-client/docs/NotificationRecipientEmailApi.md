...
[**notification_recipient_email_get**](NotificationRecipientEmailApi.md#notification_recipient_email_get) | **HEAD** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/notifications/{notificationName}/recipientEmails/{email} | 
...
> notification_recipient_email_get(resource_group_name, service_name, notification_name, email, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.notification_recipient_email_get(resource_group_name, service_name, notification_name, email, api_version, subscription_id)
    except Exception as e:
        print("Exception when calling NotificationRecipientEmailApi->notification_recipient_email_get: %s\n" % e)
```
