...
class ProjectResourceUpdateParameters(BaseModel):
    ...
    """ # noqa: E501
    properties: Optional[ProjectResourceUpdateParametersProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": ProjectResourceUpdateParametersProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "tags": obj.get("tags")
        })
        return _obj
