...
class ApplicationTarget(BaseModel):
    ...
    """ # noqa: E501
    resources: List[TargetResource] = Field(description="List of target resources.")
    target_type: StrictStr = Field(description="Type of target.", alias="targetType")
    __properties: ClassVar[List[str]] = ["resources", "targetType"]

    @field_validator('target_type')
    def target_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['WindowsAppService']):
            raise ValueError("must be one of enum values ('WindowsAppService')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resources": [TargetResource.from_dict(_item) for _item in obj["resources"]] if obj.get("resources") is not None else None,
