...
class ProjectResourceUpdateParametersProperties(BaseModel):
    """
    Custom properties of project resource.
    """ # noqa: E501
    pipeline_bootstrap_configurations: Optional[List[PipelineBootstrapConfiguration]] = Field(default=None, description="Bootstrap configurations for pipelines in Team Project.", alias="pipelineBootstrapConfigurations")
    __properties: ClassVar[List[str]] = ["pipelineBootstrapConfigurations"]
