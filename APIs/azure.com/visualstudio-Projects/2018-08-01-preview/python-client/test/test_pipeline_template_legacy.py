...
class TestPipelineTemplateLegacy(unittest.TestCase):
    """PipelineTemplateLegacy unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PipelineTemplateLegacy:
        """Test PipelineTemplateLegacy
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PipelineTemplateLegacy`
        """
        model = PipelineTemplateLegacy()
        if include_optional:
            return PipelineTemplateLegacy(
    ...
    def testPipelineTemplateLegacy(self):
        """Test PipelineTemplateLegacy"""
