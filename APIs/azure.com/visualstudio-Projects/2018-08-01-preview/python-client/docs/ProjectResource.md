...
------------ | ------------- | ------------- | -------------
**kind** | **str** | Kind of project resource. A bootStrappedProject is a project which has additional bootstrap information to create a CI/CD pipeline in the project. | [optional] 
