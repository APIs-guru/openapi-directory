...
------------- | ------------- | -------------
[**projects_create_or_update**](ProjectsApi.md#projects_create_or_update) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/microsoft.visualstudio/account/{rootResourceName}/project/{resourceName} | Projects_CreateOrUpdate
...
[**projects_list_by_account_resource**](ProjectsApi.md#projects_list_by_account_resource) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/microsoft.visualstudio/account/{rootResourceName}/project | Projects_ListByAccountResource
...
> ProjectResource projects_create_or_update(resource_group_name, subscription_id, api_version, root_resource_name, resource_name, body, validating=validating)
...
**202** | The operation succeeded. A job to create/update the team project resource has been queued. The URI to monitor the status of the job is provided in the &#39;location&#39; header. |  -  |
...
# **projects_list_by_account_resource**
> ProjectResourceListResult projects_list_by_account_resource(resource_group_name, subscription_id, api_version, root_resource_name)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Projects_ListByAccountResource
        api_response = api_instance.projects_list_by_account_resource(resource_group_name, subscription_id, api_version, root_resource_name)
        print("The response of ProjectsApi->projects_list_by_account_resource:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ProjectsApi->projects_list_by_account_resource: %s\n" % e)
```
