...
class LocationBasedRecommendedActionSessionsResultApi:
    ...
    def _location_based_recommended_action_sessions_result_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.DBforMariaDB/locations/{locationName}/recommendedActionSessionsOperationResults/{operationId}',
