...
class ConfigurationStoreUpdateParameters(BaseModel):
    """
    The parameters for updating a configuration store.
    """ # noqa: E501
    identity: Optional[ResourceIdentity] = None
    properties: Optional[ConfigurationStorePropertiesUpdateParameters] = None
    sku: Optional[Sku] = None
    tags: Optional[Dict[str, StrictStr]] = Field(default=None, description="The ARM resource tags.")
    __properties: ClassVar[List[str]] = ["identity", "properties", "sku", "tags"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "identity": ResourceIdentity.from_dict(obj["identity"]) if obj.get("identity") is not None else None,
            "properties": ConfigurationStorePropertiesUpdateParameters.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
