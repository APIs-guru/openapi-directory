...
class ListKeyValueParameters(BaseModel):
    """
    The parameters used to list a configuration store key-value
    """ # noqa: E501
    key: StrictStr = Field(description="The key to retrieve.")
    label: Optional[StrictStr] = Field(default=None, description="The label of the key.")
