...
class ConfigurationStore(BaseModel):
    ...
    """ # noqa: E501
    properties: Optional[ConfigurationStoreProperties] = None
    id: Optional[StrictStr] = Field(default=None, description="The resource ID.")
    location: StrictStr = Field(description="The location of the resource. This cannot be changed after the resource is created.")
