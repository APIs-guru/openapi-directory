...
class LabelsApi:
    ...
    def check_labels(
        ...
        name: Annotated[Optional[StrictStr], Field(description="A filter for the name of the returned labels.")] = None,
        ...
        _param = self._check_labels_serialize(
    ...
    @validate_call
    def check_labels_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="The API version to be used with the HTTP request.")],
        name: Annotated[Optional[StrictStr], Field(description="A filter for the name of the returned labels.")] = None,
        sync_token: Annotated[Optional[StrictStr], Field(description="Used to guarantee real-time consistency between requests.")] = None,
    ...
    @validate_call
    def check_labels_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="The API version to be used with the HTTP request.")],
        name: Annotated[Optional[StrictStr], Field(description="A filter for the name of the returned labels.")] = None,
        sync_token: Annotated[Optional[StrictStr], Field(description="Used to guarantee real-time consistency between requests.")] = None,
