...
class ServicesApi:
    ...
    def services_get(
        self,
        service_name: Annotated[StrictStr, Field(description="Name of Azure service")],
        ...
        :param service_name: Name of Azure service (required)
    ...
    def _services_get_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/providers/Microsoft.Support/services/{serviceName}',
    ...
    def services_list_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ServicesListResult]:
        """services_list
    ...
    def _services_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/providers/Microsoft.Support/services',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
