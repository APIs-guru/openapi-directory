...
class ProblemClassificationProperties(BaseModel):
    """
    Details about a problem classification available for an Azure service
    """ # noqa: E501
    display_name: Optional[StrictStr] = Field(default=None, description="Localized name of problem classification.", alias="displayName")
