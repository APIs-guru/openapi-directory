...
class ContactProfile(BaseModel):
    ...
    """ # noqa: E501
    additional_email_addresses: Optional[List[StrictStr]] = Field(default=None, description="Additional email addresses listed will be copied on any correspondence about the support ticket.", alias="additionalEmailAddresses")
    country: StrictStr = Field(description="Country of the user. This is the ISO 3166-1 alpha-3 code.")
    ...
    preferred_contact_method: StrictStr = Field(description="Preferred contact method.", alias="preferredContactMethod")
    preferred_support_language: StrictStr = Field(description="Preferred language of support from Azure. Support languages vary based on the severity you choose for your support ticket. Learn more at <a  target='_blank' href='https://azure.microsoft.com/support/plans/response/'>Azure Severity and responsiveness</a>. Use the standard language-country code. Valid values are 'en-us' for English, 'zh-hans' for Chinese, 'es-es' for Spanish, 'fr-fr' for French, 'ja-jp' for Japanese, 'ko-kr' for Korean, 'ru-ru' for Russian, 'pt-br' for Portuguese, 'it-it' for Italian, 'zh-tw' for Chinese and 'de-de' for German.", alias="preferredSupportLanguage")
    preferred_time_zone: StrictStr = Field(description="Time zone of the user. This is the name of the time zone from <a  target='_blank' href='https://support.microsoft.com/en-us/help/973627/microsoft-time-zone-index-values'>Microsoft Time Zone Index Values</a>.", alias="preferredTimeZone")
    primary_email_address: StrictStr = Field(description="Primary email address.", alias="primaryEmailAddress")
