...
class UpdateSupportTicket(BaseModel):
    ...
    """ # noqa: E501
    contact_details: Optional[UpdateContactProfile] = Field(default=None, alias="contactDetails")
    severity: Optional[StrictStr] = Field(default=None, description="Severity level")
    __properties: ClassVar[List[str]] = ["contactDetails", "severity"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "contactDetails": UpdateContactProfile.from_dict(obj["contactDetails"]) if obj.get("contactDetails") is not None else None,
