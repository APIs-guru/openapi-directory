...
class SupportTicketsListResult(BaseModel):
    """
    Object that represents a collection of SupportTicket resources.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The URI to fetch the next page of SupportTicket resources.", alias="nextLink")
    value: Optional[List[SupportTicketDetails]] = Field(default=None, description="List of SupportTicket resources.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [SupportTicketDetails.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
