...
class ProblemClassificationsListResult(BaseModel):
    """
    Collection of ProblemClassification resources
    """ # noqa: E501
    value: Optional[List[ProblemClassification]] = Field(default=None, description="List of ProblemClassification resources")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ProblemClassification.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
