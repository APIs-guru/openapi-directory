...
class ServicesListResult(BaseModel):
    """
    Collection of Service resources.
    """ # noqa: E501
    value: Optional[List[Service]] = Field(default=None, description="List of Service resources")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [Service.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
