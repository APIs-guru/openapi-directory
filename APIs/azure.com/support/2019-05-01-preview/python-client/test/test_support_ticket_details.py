...
class TestSupportTicketDetails(unittest.TestCase):
    """SupportTicketDetails unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupportTicketDetails:
        """Test SupportTicketDetails
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupportTicketDetails`
        """
    ...
    def testSupportTicketDetails(self):
        """Test SupportTicketDetails"""
