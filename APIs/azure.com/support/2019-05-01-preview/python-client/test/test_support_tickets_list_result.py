...
class TestSupportTicketsListResult(unittest.TestCase):
    """SupportTicketsListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SupportTicketsListResult:
        """Test SupportTicketsListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SupportTicketsListResult`
        """
        ...
        if include_optional:
            return SupportTicketsListResult(
                next_link = '',
                value = [
                    openapi_client.models.support_ticket_details.SupportTicketDetails(
                        id = '', 
                        name = '', 
                        properties = openapi_client.models.support_ticket_details_properties.SupportTicketDetailsProperties(
    ...
    def testSupportTicketsListResult(self):
        """Test SupportTicketsListResult"""
