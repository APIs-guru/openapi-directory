...
class FirewallPolicyRuleGroupListResult(BaseModel):
    """
    ...
    value: Optional[List[FirewallPolicyRuleGroup]] = Field(default=None, description="List of FirewallPolicyRuleGroups in a FirewallPolicy.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [FirewallPolicyRuleGroup.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
