...
class FirewallPolicyRuleGroup(BaseModel):
    """
    Rule Group resource
    """ # noqa: E501
    ...
    properties: Optional[FirewallPolicyRuleGroupProperties] = None
    type: Optional[StrictStr] = Field(default=None, description="Rule Group type.")
