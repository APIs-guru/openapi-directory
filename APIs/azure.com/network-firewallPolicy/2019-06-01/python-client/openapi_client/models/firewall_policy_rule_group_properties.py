...
class FirewallPolicyRuleGroupProperties(BaseModel):
    """
    Properties of the rule group.
    """ # noqa: E501
    priority: Optional[Annotated[int, Field(le=65000, strict=True, ge=100)]] = Field(default=None, description="Priority of the Firewall Policy Rule Group resource.")
    ...
    rules: Optional[List[FirewallPolicyRule]] = Field(default=None, description="Group of Firewall Policy rules.")
    __properties: ClassVar[List[str]] = ["priority", "provisioningState", "rules"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rules": [FirewallPolicyRule.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None
        })
        return _obj
