...
class FirewallPolicyListResult(BaseModel):
    """
    ...
    value: Optional[List[FirewallPolicy]] = Field(default=None, description="List of Firewall Policies in a resource group.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [FirewallPolicy.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
