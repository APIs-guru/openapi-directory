...
class FirewallPolicyFilterRule(FirewallPolicyRule):
    ...
    rule_conditions: Optional[List[FirewallPolicyRuleCondition]] = Field(default=None, description="Collection of rule conditions used by a rule.", alias="ruleConditions")
