...
class ModelErrorResponse(BaseModel):
    ...
    details: Optional[List[ErrorDetails]] = Field(default=None, description="An array of error detail objects.")
    message: Optional[StrictStr] = Field(default=None, description="The error message.")
    status_code: Optional[StrictInt] = Field(default=None, description="The HTTP status code.", alias="statusCode")
    __properties: ClassVar[List[str]] = ["code", "details", "message", "statusCode"]
