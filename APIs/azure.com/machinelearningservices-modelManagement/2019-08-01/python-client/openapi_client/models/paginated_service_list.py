...
class PaginatedServiceList(BaseModel):
    ...
    value: Optional[List[ServiceResponseBase]] = Field(default=None, description="An array of objects of type Service.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ServiceResponseBase.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
