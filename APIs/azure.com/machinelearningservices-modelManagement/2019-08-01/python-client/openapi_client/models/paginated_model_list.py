...
class PaginatedModelList(BaseModel):
    ...
    value: Optional[List[Model]] = Field(default=None, description="An array of objects of type Model.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Model.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
