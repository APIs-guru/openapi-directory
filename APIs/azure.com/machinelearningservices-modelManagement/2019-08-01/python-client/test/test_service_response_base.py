...
class TestServiceResponseBase(unittest.TestCase):
    """ServiceResponseBase unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceResponseBase:
        """Test ServiceResponseBase
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceResponseBase`
        """
        model = ServiceResponseBase()
        if include_optional:
    ...
    def testServiceResponseBase(self):
        """Test ServiceResponseBase"""
