...
class TestPaginatedModelList(unittest.TestCase):
    """PaginatedModelList unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PaginatedModelList:
        """Test PaginatedModelList
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PaginatedModelList`
        """
        model = PaginatedModelList()
        if include_optional:
    ...
    def testPaginatedModelList(self):
        """Test PaginatedModelList"""
