...
class TestIotServiceResponse(unittest.TestCase):
    """IotServiceResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IotServiceResponse:
        """Test IotServiceResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IotServiceResponse`
        """
        model = IotServiceResponse()
        if include_optional:
            return IotServiceResponse(
                auth_enabled = True,
                compute_name = '',
    ...
    def testIotServiceResponse(self):
        """Test IotServiceResponse"""
