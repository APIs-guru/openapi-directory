...
class TestModelEnvironmentDefinition(unittest.TestCase):
    """ModelEnvironmentDefinition unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ModelEnvironmentDefinition:
        """Test ModelEnvironmentDefinition
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ModelEnvironmentDefinition`
        """
        model = ModelEnvironmentDefinition()
        if include_optional:
            return ModelEnvironmentDefinition(
...
RUN echo "Hello world!"', 
    ...
    def testModelEnvironmentDefinition(self):
        """Test ModelEnvironmentDefinition"""
