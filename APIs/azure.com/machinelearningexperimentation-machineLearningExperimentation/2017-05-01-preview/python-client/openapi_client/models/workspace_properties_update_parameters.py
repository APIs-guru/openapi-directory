...
class WorkspacePropertiesUpdateParameters(BaseModel):
    ...
    """ # noqa: E501
    description: Optional[StrictStr] = Field(default=None, description="Description for this workspace.")
    friendly_name: Optional[StrictStr] = Field(default=None, description="Friendly name of this workspace.", alias="friendlyName")
