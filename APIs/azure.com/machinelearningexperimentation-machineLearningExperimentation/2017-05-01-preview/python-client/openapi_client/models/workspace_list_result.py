...
class WorkspaceListResult(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The URI that can be used to request the next list of machine learning workspaces.", alias="nextLink")
    value: Optional[List[Workspace]] = Field(default=None, description="The list of machine learning team account workspaces. Since this list may be incomplete, the nextLink field should be used to request the next list of machine learning team accounts.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Workspace.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
