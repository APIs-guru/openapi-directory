...
class ProjectUpdateParameters(BaseModel):
    """
    The parameters for updating a machine learning project.
    """ # noqa: E501
    properties: Optional[ProjectPropertiesUpdateParameters] = None
    tags: Optional[Dict[str, StrictStr]] = Field(default=None, description="The resource tags for the machine learning project.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": ProjectPropertiesUpdateParameters.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "tags": obj.get("tags")
        })
        return _obj
