...
class AccountUpdateParameters(BaseModel):
    ...
    """ # noqa: E501
    properties: Optional[AccountPropertiesUpdateParameters] = None
    tags: Optional[Dict[str, StrictStr]] = Field(default=None, description="The resource tags for the machine learning team account.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": AccountPropertiesUpdateParameters.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "tags": obj.get("tags")
        })
        return _obj
