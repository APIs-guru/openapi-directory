...
class AccountListResult(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The URI that can be used to request the next list of machine learning team accounts.", alias="nextLink")
    value: Optional[List[Account]] = Field(default=None, description="The list of machine learning team accounts. Since this list may be incomplete, the nextLink field should be used to request the next list of machine learning team accounts.")
