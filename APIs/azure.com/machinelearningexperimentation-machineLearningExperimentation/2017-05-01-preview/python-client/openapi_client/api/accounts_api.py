...
class AccountsApi:
    ...
    def accounts_create_or_update(
        ...
        parameters: Annotated[Account, Field(description="The parameters for creating or updating a machine learning team account.")],
    ...
    def _accounts_create_or_update_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningExperimentation/accounts/{accountName}',
    ...
    def _accounts_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/providers/Microsoft.MachineLearningExperimentation/accounts',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _accounts_list_by_resource_group_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.MachineLearningExperimentation/accounts',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def accounts_update(
        ...
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group to which the machine learning team account belongs.")],
        account_name: Annotated[str, Field(min_length=5, strict=True, max_length=50, description="The name of the machine learning team account.")],
        parameters: Annotated[AccountUpdateParameters, Field(description="The parameters for updating a machine learning team account.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type parameters: AccountUpdateParameters
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
