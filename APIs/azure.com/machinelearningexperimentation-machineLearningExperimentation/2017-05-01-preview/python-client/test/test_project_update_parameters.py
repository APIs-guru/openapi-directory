...
class TestProjectUpdateParameters(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ProjectUpdateParameters:
        """Test ProjectUpdateParameters
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProjectUpdateParameters`
        """
        model = ProjectUpdateParameters()
        if include_optional:
            return ProjectUpdateParameters(
                properties = openapi_client.models.project_properties_update_parameters.ProjectPropertiesUpdateParameters(
                    description = '', 
                    friendly_name = '', 
                    gitrepo = '', ),
                tags = {
