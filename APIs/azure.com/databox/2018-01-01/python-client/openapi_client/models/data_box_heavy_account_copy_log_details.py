...
class DataBoxHeavyAccountCopyLogDetails(CopyLogDetails):
    ...
    """ # noqa: E501
    account_name: Optional[StrictStr] = Field(default=None, description="Destination account name.", alias="accountName")
    copy_log_link: Optional[List[StrictStr]] = Field(default=None, description="Link for copy logs.", alias="copyLogLink")
