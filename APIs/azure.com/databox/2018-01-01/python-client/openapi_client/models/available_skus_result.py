...
class AvailableSkusResult(BaseModel):
    """
    The available skus operation response.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Link for the next set of skus.", alias="nextLink")
    value: Optional[List[SkuInformation]] = Field(default=None, description="List of available skus.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [SkuInformation.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
