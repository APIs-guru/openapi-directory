...
class JobProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["cancellationReason", "details", "error", "isCancellable", "isDeletable", "isShippingAddressEditable", "startTime", "status"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['DeviceOrdered', 'DevicePrepared', 'Dispatched', 'Delivered', 'PickedUp', 'AtAzureDC', 'DataCopy', 'Completed', 'CompletedWithErrors', 'Cancelled', 'Failed_IssueReportedAtCustomer', 'Failed_IssueDetectedAtAzureDC', 'Aborted']):
            raise ValueError("must be one of enum values ('DeviceOrdered', 'DevicePrepared', 'Dispatched', 'Delivered', 'PickedUp', 'AtAzureDC', 'DataCopy', 'Completed', 'CompletedWithErrors', 'Cancelled', 'Failed_IssueReportedAtCustomer', 'Failed_IssueDetectedAtAzureDC', 'Aborted')")
        return value
