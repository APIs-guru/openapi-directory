...
class DataBoxHeavyJobSecrets(JobSecrets):
    ...
    """ # noqa: E501
    cabinet_pod_secrets: Optional[List[DataBoxHeavySecret]] = Field(default=None, description="Contains the list of secret objects for a DataBoxHeavy job.", alias="cabinetPodSecrets")
