...
class Sku(BaseModel):
    ...
    The Sku.
    """ # noqa: E501
    display_name: Optional[StrictStr] = Field(default=None, description="The display name of the sku.", alias="displayName")
    family: Optional[StrictStr] = Field(default=None, description="The sku family.")
    name: StrictStr = Field(description="The sku name.")
    __properties: ClassVar[List[str]] = ["displayName", "family", "name"]
