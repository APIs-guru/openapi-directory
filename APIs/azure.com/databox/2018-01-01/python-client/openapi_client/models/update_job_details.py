...
class UpdateJobDetails(BaseModel):
    """
    Job details for update.
    """ # noqa: E501
    contact_details: Optional[ContactDetails] = Field(default=None, alias="contactDetails")
    shipping_address: Optional[ShippingAddress] = Field(default=None, alias="shippingAddress")
    __properties: ClassVar[List[str]] = ["contactDetails", "shippingAddress"]
