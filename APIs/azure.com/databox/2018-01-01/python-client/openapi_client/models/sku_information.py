...
class SkuInformation(BaseModel):
    """
    Information of the sku.
    """ # noqa: E501
    enabled: Optional[StrictBool] = Field(default=None, description="The sku is enabled or not.")
    properties: Optional[SkuProperties] = None
    sku: Optional[Sku] = None
    __properties: ClassVar[List[str]] = ["enabled", "properties", "sku"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "properties": SkuProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
