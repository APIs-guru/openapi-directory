...
class DataDestinationDetailsValidationRequest(ValidationInputRequest):
    ...
    """ # noqa: E501
    destination_account_details: List[DestinationAccountDetails] = Field(description="Destination account details list.", alias="destinationAccountDetails")
    location: StrictStr = Field(description="Location of stamp or geo.")
