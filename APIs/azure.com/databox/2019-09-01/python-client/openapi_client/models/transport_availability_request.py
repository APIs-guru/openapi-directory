...
class TransportAvailabilityRequest(BaseModel):
    """
    Request body to get the transport availability for given sku.
    """ # noqa: E501
    sku_name: Optional[StrictStr] = Field(default=None, description="Type of the device.", alias="skuName")
    __properties: ClassVar[List[str]] = ["skuName"]

    @field_validator('sku_name')
    def sku_name_validate_enum(cls, value):
        """Validates the enum"""
        if value is None:
            return value
