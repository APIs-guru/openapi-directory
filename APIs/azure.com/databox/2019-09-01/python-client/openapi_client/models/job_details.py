...
class JobDetails(BaseModel):
    ...
    expected_data_size_in_terabytes: Optional[StrictInt] = Field(default=None, description="The expected size of the data, which needs to be transferred in this job, in terabytes.", alias="expectedDataSizeInTerabytes")
