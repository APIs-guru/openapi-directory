...
class JobResourceUpdateParameter(BaseModel):
    """
    The JobResourceUpdateParameter.
    """ # noqa: E501
    properties: Optional[UpdateJobProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": UpdateJobProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "tags": obj.get("tags")
        })
        return _obj
