...
class ScheduleAvailabilityResponse(BaseModel):
    ...
    """ # noqa: E501
    available_dates: Optional[List[datetime]] = Field(default=None, description="List of dates available to schedule", alias="availableDates")
    __properties: ClassVar[List[str]] = ["availableDates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "availableDates": obj.get("availableDates")
        })
        return _obj
