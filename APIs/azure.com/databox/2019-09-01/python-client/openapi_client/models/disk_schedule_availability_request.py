...
class DiskScheduleAvailabilityRequest(ScheduleAvailabilityRequest):
    ...
    """ # noqa: E501
    expected_data_size_in_terabytes: StrictInt = Field(description="The expected size of the data, which needs to be transferred in this job, in terabytes.", alias="expectedDataSizeInTerabytes")
    __properties: ClassVar[List[str]] = ["skuName", "storageLocation"]
