...
class DataBoxJobDetails(JobDetails):
    ...
    Databox Job Details
    """ # noqa: E501
    copy_progress: Optional[List[CopyProgress]] = Field(default=None, description="Copy progress per storage account.", alias="copyProgress")
    device_password: Optional[StrictStr] = Field(default=None, description="Set Device password for unlocking Databox", alias="devicePassword")
