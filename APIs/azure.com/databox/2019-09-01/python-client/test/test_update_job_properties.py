...
class TestUpdateJobProperties(unittest.TestCase):
    """UpdateJobProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateJobProperties:
        """Test UpdateJobProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateJobProperties`
        """
        model = UpdateJobProperties()
        if include_optional:
            return UpdateJobProperties(
                ...
                details = openapi_client.models.update_job_details.UpdateJobDetails(
    ...
    def testUpdateJobProperties(self):
        """Test UpdateJobProperties"""
