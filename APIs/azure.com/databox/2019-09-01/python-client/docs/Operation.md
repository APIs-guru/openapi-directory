...
**name** | **str** | Name of the operation. Format: {resourceProviderNamespace}/{resourceType}/{read|write|delete|action} | [optional] [readonly] 
**origin** | **str** | Origin of the operation. Can be : user|system|user,system | [optional] [readonly] 
