...
------------ | ------------- | ------------- | -------------
**description** | **str** | Localized description of the operation for display purpose. | [optional] 
**operation** | **str** | Localized name of the operation for display purpose. | [optional] 
