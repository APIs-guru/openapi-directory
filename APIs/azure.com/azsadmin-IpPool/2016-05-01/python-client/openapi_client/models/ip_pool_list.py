...
class IpPoolList(BaseModel):
    ...
    value: Optional[List[IpPool]] = Field(default=None, description="List of IP pools.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [IpPool.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
