...
**operation** | **str** | The name of the operation. | [optional] [readonly] 
**provider** | **str** | The name of the resource provider. | [optional] [readonly] 
**resource** | **str** | The type of the resource. | [optional] [readonly] 
