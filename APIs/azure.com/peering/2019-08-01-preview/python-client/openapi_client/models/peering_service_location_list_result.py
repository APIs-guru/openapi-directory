...
class PeeringServiceLocationListResult(BaseModel):
    """
    The paginated list of peering service locations.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The link to fetch the next page of peering service locations.", alias="nextLink")
    value: Optional[List[PeeringServiceLocation]] = Field(default=None, description="The list of peering service locations.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [PeeringServiceLocation.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
