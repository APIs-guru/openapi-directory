...
class PeeringServicePrefixListResult(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The link to fetch the next page of [T].", alias="nextLink")
    value: Optional[List[PeeringServicePrefix]] = Field(default=None, description="The list of [T].")
