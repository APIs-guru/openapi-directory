...
------------ | ------------- | ------------- | -------------
**next_link** | **str** | The link to fetch the next page of peering API operations. | [optional] 
**value** | [**List[Operation]**](Operation.md) | The list of peering API operations. | [optional] 
