...
class BgpSession(BaseModel):
    ...
    def session_state_v4_validate_enum(cls, value):
        ...
        if value not in set(['None', 'Idle', 'Connect', 'Active', 'OpenSent', 'OpenConfirm', 'Established', 'PendingAdd', 'PendingUpdate', 'PendingRemove']):
            raise ValueError("must be one of enum values ('None', 'Idle', 'Connect', 'Active', 'OpenSent', 'OpenConfirm', 'Established', 'PendingAdd', 'PendingUpdate', 'PendingRemove')")
        return value
