...
class PeerAsnListResult(BaseModel):
    """
    The paginated list of peer ASNs.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The link to fetch the next page of peer ASNs.", alias="nextLink")
    value: Optional[List[PeerAsn]] = Field(default=None, description="The list of peer ASNs.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [PeerAsn.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
