...
class TestPeeringLocationPropertiesExchange(unittest.TestCase):
    """PeeringLocationPropertiesExchange unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PeeringLocationPropertiesExchange:
        """Test PeeringLocationPropertiesExchange
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PeeringLocationPropertiesExchange`
        """
        model = PeeringLocationPropertiesExchange()
        if include_optional:
            return PeeringLocationPropertiesExchange(
                peering_facilities = [
    ...
    def testPeeringLocationPropertiesExchange(self):
        """Test PeeringLocationPropertiesExchange"""
