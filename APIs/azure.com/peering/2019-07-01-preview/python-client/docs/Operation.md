...
**is_data_action** | **bool** | The flag that indicates whether the operation applies to data plane. | [optional] [readonly] 
**name** | **str** | The name of the operation. | [optional] [readonly] 
