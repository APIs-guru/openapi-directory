...
class PeeringServiceListResult(BaseModel):
    """
    The paginated list of peering services.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The link to fetch the next page of peering services.", alias="nextLink")
    value: Optional[List[PeeringService]] = Field(default=None, description="The list of peering services.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [PeeringService.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
