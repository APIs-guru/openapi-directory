...
class PeeringServiceProviderListResult(BaseModel):
    """
    The paginated list of peering service providers.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The link to fetch the next page of peering service providers.", alias="nextLink")
    value: Optional[List[PeeringServiceProvider]] = Field(default=None, description="The list of peering service providers.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [PeeringServiceProvider.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
