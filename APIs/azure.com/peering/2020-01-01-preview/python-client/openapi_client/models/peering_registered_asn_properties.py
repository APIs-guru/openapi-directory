...
class PeeringRegisteredAsnProperties(BaseModel):
    """
    The properties that define a registered ASN.
    """ # noqa: E501
    asn: Optional[StrictInt] = Field(default=None, description="The customer's ASN from which traffic originates.")
    ...
    __properties: ClassVar[List[str]] = ["asn", "peeringServicePrefixKey", "provisioningState"]
