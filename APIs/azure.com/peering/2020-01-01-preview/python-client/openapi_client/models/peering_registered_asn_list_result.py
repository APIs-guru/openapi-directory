...
class PeeringRegisteredAsnListResult(BaseModel):
    """
    The paginated list of peering registered ASNs.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The link to fetch the next page of peering registered ASNs.", alias="nextLink")
    value: Optional[List[PeeringRegisteredAsn]] = Field(default=None, description="The list of peering registered ASNs.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [PeeringRegisteredAsn.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
