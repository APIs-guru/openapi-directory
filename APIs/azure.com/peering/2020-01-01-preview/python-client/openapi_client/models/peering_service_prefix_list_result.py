...
class PeeringServicePrefixListResult(BaseModel):
    """
    The paginated list of peering service prefixes.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The link to fetch the next page of peering service prefixes.", alias="nextLink")
    value: Optional[List[PeeringServicePrefix]] = Field(default=None, description="The list of peering service prefixes.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [PeeringServicePrefix.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
