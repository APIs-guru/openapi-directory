...
class PeeringListResult(BaseModel):
    """
    The paginated list of peerings.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The link to fetch the next page of peerings.", alias="nextLink")
    value: Optional[List[Peering]] = Field(default=None, description="The list of peerings.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Peering.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
