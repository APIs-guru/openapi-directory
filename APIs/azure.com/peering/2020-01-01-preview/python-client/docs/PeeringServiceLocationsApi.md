...
> PeeringServiceLocationListResult peering_service_locations_list(subscription_id, api_version, country=country)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    country = 'country_example' # str | The country of interest, in which the locations are to be present. (optional)

    try:
        api_response = api_instance.peering_service_locations_list(subscription_id, api_version, country=country)
 ...
 **country** | **str**| The country of interest, in which the locations are to be present. | [optional] 
