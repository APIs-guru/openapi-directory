...
> PeeringListResult legacy_peerings_list(peering_location, kind, subscription_id, api_version, asn=asn)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    asn = 56 # int | The ASN number associated with a legacy peering. (optional)

    try:
        api_response = api_instance.legacy_peerings_list(peering_location, kind, subscription_id, api_version, asn=asn)
 ...
 **asn** | **int**| The ASN number associated with a legacy peering. | [optional] 
