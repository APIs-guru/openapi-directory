...
------------ | ------------- | ------------- | -------------
**error_message** | **str** | The error message for the validation state | [optional] [readonly] 
**peer_asn** | **int** | The Autonomous System Number (ASN) of the peer. | [optional] 
**peer_contact_detail** | [**List[ContactDetail]**](ContactDetail.md) | The contact details of the peer. | [optional] 
