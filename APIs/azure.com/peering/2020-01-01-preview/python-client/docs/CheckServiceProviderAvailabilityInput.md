...
------------ | ------------- | ------------- | -------------
**peering_service_location** | **str** | Gets or sets the peering service location. | [optional] 
**peering_service_provider** | **str** | Gets or sets the peering service provider. | [optional] 
