...
class BackendReconnectApi:
    ...
    def backend_reconnect(
        ...
        parameters: Annotated[Optional[BackendReconnectRequest], Field(description="Reconnect request parameters.")] = None,
        ...
        :type parameters: BackendReconnectRequest
        ...
        _param = self._backend_reconnect_serialize(
    ...
    @validate_call
    def backend_reconnect_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        backend_id: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Identifier of the Backend entity. Must be unique in the current API Management service instance.")],
    ...
    @validate_call
    def backend_reconnect_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        backend_id: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Identifier of the Backend entity. Must be unique in the current API Management service instance.")],
    ...
    def _backend_reconnect_serialize(
        self,
        resource_group_name,
        service_name,
        backend_id,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/backends/{backendId}/reconnect',
