...
class BackendListByService200ResponseValueInner(BaseModel):
    """
    Backend details.
    """ # noqa: E501
    properties: Optional[BackendListByService200ResponseValueInnerProperties] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BackendListByService200ResponseValueInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BackendListByService200ResponseValueInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "properties": BackendListByService200ResponseValueInnerProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
