...
class BackendUpdateRequestProperties(BaseModel):
    """
    Parameters supplied to the Update Backend operation.
    """ # noqa: E501
    protocol: Optional[StrictStr] = Field(default=None, description="Backend communication protocol.")
    url: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=2000)]] = Field(default=None, description="Runtime Url of the Backend.")
