...
class BackendReconnectRequestProperties(BaseModel):
    """
    Properties to control reconnect requests.
    """ # noqa: E501
    after: Optional[StrictStr] = Field(default=None, description="Duration in ISO8601 format after which reconnect will be initiated. Minimum duration of the Reconnect is PT2M.")
    __properties: ClassVar[List[str]] = ["after"]
