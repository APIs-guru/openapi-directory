...
class PlansListMetrics200Response(BaseModel):
    """
    List of metrics.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Continuation token", alias="nextLink")
    value: Optional[List[PlansListMetrics200ResponseValueInner]] = Field(default=None, description="List of metrics.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [PlansListMetrics200ResponseValueInner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
