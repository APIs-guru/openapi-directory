...
class PlanList(BaseModel):
    ...
    value: Optional[List[Plan]] = Field(default=None, description="Array of plans.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [Plan.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
