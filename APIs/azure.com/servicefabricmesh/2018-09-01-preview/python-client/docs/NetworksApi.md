...
------------- | ------------- | -------------
[**network_create**](NetworksApi.md#network_create) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabricMesh/networks/{networkResourceName} | Creates or updates a network resource.
[**network_delete**](NetworksApi.md#network_delete) | **DELETE** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabricMesh/networks/{networkResourceName} | Deletes the network resource.
[**network_get**](NetworksApi.md#network_get) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabricMesh/networks/{networkResourceName} | Gets the network resource with the given name.
...
# **network_create**
> NetworkResourceDescription network_create(subscription_id, api_version, resource_group_name, network_resource_name, network_resource_description)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Creates or updates a network resource.
        api_response = api_instance.network_create(subscription_id, api_version, resource_group_name, network_resource_name, network_resource_description)
...
# **network_delete**
> network_delete(subscription_id, api_version, resource_group_name, network_resource_name)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Deletes the network resource.
        api_instance.network_delete(subscription_id, api_version, resource_group_name, network_resource_name)
    except Exception as e:
...
# **network_get**
> NetworkResourceDescription network_get(subscription_id, api_version, resource_group_name, network_resource_name)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Gets the network resource with the given name.
        api_response = api_instance.network_get(subscription_id, api_version, resource_group_name, network_resource_name)
