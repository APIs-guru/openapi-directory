...
class CodePackagesApi:
    ...
    @validate_call
    def code_package_get_container_logs(
        self,
        ...
        _param = self._code_package_get_container_logs_serialize(
    ...
    @validate_call
    def code_package_get_container_logs_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The customer subscription identifier")],
        resource_group_name: Annotated[StrictStr, Field(description="Azure resource group name")],
        api_version: Annotated[StrictStr, Field(description="The version of the API. This parameter is required and its value must be `2018-09-01-preview`.")],
    ...
    @validate_call
    def code_package_get_container_logs_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The customer subscription identifier")],
        resource_group_name: Annotated[StrictStr, Field(description="Azure resource group name")],
        api_version: Annotated[StrictStr, Field(description="The version of the API. This parameter is required and its value must be `2018-09-01-preview`.")],
    ...
    def _code_package_get_container_logs_serialize(
        self,
        subscription_id,
        resource_group_name,
        api_version,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabricMesh/applications/{applicationResourceName}/services/{serviceResourceName}/replicas/{replicaName}/codePackages/{codePackageName}/logs',
