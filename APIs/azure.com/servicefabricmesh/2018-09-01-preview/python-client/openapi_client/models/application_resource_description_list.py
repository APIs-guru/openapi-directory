...
class ApplicationResourceDescriptionList(BaseModel):
    """
    A pageable list of application resources.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="URI to fetch the next page of the list.", alias="nextLink")
    value: Optional[List[ApplicationResourceDescription]] = Field(default=None, description="One page of the list.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ApplicationResourceDescription.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
