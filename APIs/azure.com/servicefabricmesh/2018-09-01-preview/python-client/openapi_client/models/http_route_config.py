...
class HttpRouteConfig(BaseModel):
    ...
    name: StrictStr = Field(description="http route name.")
    __properties: ClassVar[List[str]] = ["destination", "match", "name"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "destination": GatewayDestination.from_dict(obj["destination"]) if obj.get("destination") is not None else None,
            "match": HttpRouteMatchRule.from_dict(obj["match"]) if obj.get("match") is not None else None,
            "name": obj.get("name")
        })
        return _obj
