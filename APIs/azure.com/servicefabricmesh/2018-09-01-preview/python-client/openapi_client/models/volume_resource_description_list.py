...
class VolumeResourceDescriptionList(BaseModel):
    """
    ...
    value: Optional[List[VolumeResourceDescription]] = Field(default=None, description="One page of the list.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [VolumeResourceDescription.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
