...
class InlinedValueSecretResourceProperties(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["contentType", "description", "status", "statusDetails", "kind", "provisioningState"]
