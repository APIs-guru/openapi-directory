...
class ServiceResourceProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["provisioningState", "codePackages", "diagnostics", "networkRefs", "osType", "autoScalingPolicies", "description", "healthState", "replicaCount", "status", "statusDetails", "unhealthyEvaluation"]
