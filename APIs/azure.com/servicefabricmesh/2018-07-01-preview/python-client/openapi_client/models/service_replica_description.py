...
class ServiceReplicaDescription(BaseModel):
    ...
    replica_name: Optional[StrictStr] = Field(default=None, description="Name of the replica.", alias="replicaName")
    __properties: ClassVar[List[str]] = ["codePackages", "diagnostics", "networkRefs", "osType", "replicaName"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "replicaName": obj.get("replicaName")
        })
        return _obj
