...
class ContainerCodePackageProperties(BaseModel):
    ...
    volume_refs: Optional[List[ContainerVolume]] = Field(default=None, description="The volumes to be attached to the container.", alias="volumeRefs")
    __properties: ClassVar[List[str]] = ["commands", "diagnostics", "endpoints", "entrypoint", "environmentVariables", "image", "imageRegistryCredential", "instanceView", "labels", "name", "resources", "settings", "volumeRefs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "volumeRefs": [ContainerVolume.from_dict(_item) for _item in obj["volumeRefs"]] if obj.get("volumeRefs") is not None else None
        })
        return _obj
