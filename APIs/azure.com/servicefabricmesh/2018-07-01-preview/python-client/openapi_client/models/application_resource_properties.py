...
class ApplicationResourceProperties(BaseModel):
    ...
    debug_params: Optional[StrictStr] = Field(default=None, description="Internal use.", alias="debugParams")
    ...
    services: Optional[List[ServiceResourceDescription]] = Field(default=None, description="describes the services in the application.")
    status: Optional[StrictStr] = Field(default=None, description="Status of the application resource.")
    status_details: Optional[StrictStr] = Field(default=None, description="Gives additional information about the current status of the application deployment.", alias="statusDetails")
    ...
    __properties: ClassVar[List[str]] = ["provisioningState", "debugParams", "description", "diagnostics", "healthState", "serviceNames", "services", "status", "statusDetails", "unhealthyEvaluation"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['Invalid', 'Ready', 'Upgrading', 'Creating', 'Deleting', 'Failed']):
            raise ValueError("must be one of enum values ('Invalid', 'Ready', 'Upgrading', 'Creating', 'Deleting', 'Failed')")
        return value
