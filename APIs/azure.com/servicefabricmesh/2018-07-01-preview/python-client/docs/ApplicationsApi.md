...
------------- | ------------- | -------------
[**application_create**](ApplicationsApi.md#application_create) | **PUT** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabricMesh/applications/{applicationName} | Creates or updates an application resource.
[**application_delete**](ApplicationsApi.md#application_delete) | **DELETE** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabricMesh/applications/{applicationName} | Deletes the application resource.
[**application_get**](ApplicationsApi.md#application_get) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ServiceFabricMesh/applications/{applicationName} | Gets the application resource.
...
# **application_create**
> ApplicationResourceDescription application_create(subscription_id, api_version, resource_group_name, application_name, application_resource_description)
...
# **application_delete**
> application_delete(subscription_id, api_version, resource_group_name, application_name)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Deletes the application resource.
        api_instance.application_delete(subscription_id, api_version, resource_group_name, application_name)
    except Exception as e:
...
# **application_get**
> ApplicationResourceDescription application_get(subscription_id, api_version, resource_group_name, application_name)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Gets the application resource.
        api_response = api_instance.application_get(subscription_id, api_version, resource_group_name, application_name)
