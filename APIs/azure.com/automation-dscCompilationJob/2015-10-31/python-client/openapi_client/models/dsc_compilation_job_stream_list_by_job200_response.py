...
class DscCompilationJobStreamListByJob200Response(BaseModel):
    """
    The response model for the list job stream operation.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="Gets or sets the next link.", alias="nextLink")
    value: Optional[List[DscCompilationJobStreamListByJob200ResponseValueInner]] = Field(default=None, description="A list of job streams.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [DscCompilationJobStreamListByJob200ResponseValueInner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
