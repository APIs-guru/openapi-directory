...
class PublicIPAddressesListVirtualMachineScaleSetPublicIPAddresses200ResponseValueInner(BaseModel):
    """
    ...
    sku: Optional[PublicIPAddressesListVirtualMachineScaleSetPublicIPAddresses200ResponseValueInnerSku] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sku": PublicIPAddressesListVirtualMachineScaleSetPublicIPAddresses200ResponseValueInnerSku.from_dict(obj["sku"]) if obj.get("sku") is not None else None,
            "zones": obj.get("zones")
        })
        return _obj
