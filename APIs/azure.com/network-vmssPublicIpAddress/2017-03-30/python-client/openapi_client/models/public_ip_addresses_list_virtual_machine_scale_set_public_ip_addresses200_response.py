...
class PublicIPAddressesListVirtualMachineScaleSetPublicIPAddresses200Response(BaseModel):
    """
    ...
    value: Optional[List[PublicIPAddressesListVirtualMachineScaleSetPublicIPAddresses200ResponseValueInner]] = Field(default=None, description="A list of public IP addresses that exists in a resource group.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [PublicIPAddressesListVirtualMachineScaleSetPublicIPAddresses200ResponseValueInner.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
