...
class Usage(BaseModel):
    ...
    """ # noqa: E501
    current_value: StrictInt = Field(description="The current value of the usage.", alias="currentValue")
    id: Optional[StrictStr] = Field(default=None, description="Resource identifier.")
    limit: StrictInt = Field(description="The limit of usage.")
    name: UsageName
    unit: StrictStr = Field(description="An enum describing the unit of measurement.")
