...
class TestClusterGetProperties(unittest.TestCase):
    """ClusterGetProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ClusterGetProperties:
        """Test ClusterGetProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ClusterGetProperties`
        """
    ...
    def testClusterGetProperties(self):
        """Test ClusterGetProperties"""
