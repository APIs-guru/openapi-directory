...
class RoleScriptActionsInner(BaseModel):
    """
    Describes a script action on role on the cluster.
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the script action.")
    parameters: StrictStr = Field(description="The parameters for the script provided.")
    uri: StrictStr = Field(description="The URI to the script.")
    __properties: ClassVar[List[str]] = ["name", "parameters", "uri"]
