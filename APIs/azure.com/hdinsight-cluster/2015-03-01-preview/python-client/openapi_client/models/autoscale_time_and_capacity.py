...
class AutoscaleTimeAndCapacity(BaseModel):
    """
    ...
    time: Optional[StrictStr] = Field(default=None, description="24-hour time in the form xx:xx")
    __properties: ClassVar[List[str]] = ["maxInstanceCount", "minInstanceCount", "time"]
