...
class ClusterListPersistedScriptActionsResult(BaseModel):
    """
    ...
    value: Optional[List[RuntimeScriptAction]] = Field(default=None, description="The list of Persisted Script Actions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [RuntimeScriptAction.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
