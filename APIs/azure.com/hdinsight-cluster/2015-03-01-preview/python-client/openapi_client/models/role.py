...
class Role(BaseModel):
    ...
    data_disks_groups: Optional[List[DataDisksGroups]] = Field(default=None, description="The data disks groups for the role.", alias="dataDisksGroups")
    ...
    script_actions: Optional[List[RoleScriptActionsInner]] = Field(default=None, description="The list of script actions on the role.", alias="scriptActions")
    ...
    virtual_network_profile: Optional[VirtualNetworkProfile] = Field(default=None, alias="virtualNetworkProfile")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dataDisksGroups": [DataDisksGroups.from_dict(_item) for _item in obj["dataDisksGroups"]] if obj.get("dataDisksGroups") is not None else None,
            ...
            "scriptActions": [RoleScriptActionsInner.from_dict(_item) for _item in obj["scriptActions"]] if obj.get("scriptActions") is not None else None,
            "targetInstanceCount": obj.get("targetInstanceCount"),
            "virtualNetworkProfile": VirtualNetworkProfile.from_dict(obj["virtualNetworkProfile"]) if obj.get("virtualNetworkProfile") is not None else None
        })
        return _obj
