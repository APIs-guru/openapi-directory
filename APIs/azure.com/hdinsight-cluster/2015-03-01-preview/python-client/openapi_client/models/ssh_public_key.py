...
class SshPublicKey(BaseModel):
    ...
    """ # noqa: E501
    certificate_data: Optional[StrictStr] = Field(default=None, description="The certificate for SSH.", alias="certificateData")
    __properties: ClassVar[List[str]] = ["certificateData"]
