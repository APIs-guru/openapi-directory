...
class AutoscaleSchedule(BaseModel):
    """
    ...
    time_and_capacity: Optional[AutoscaleTimeAndCapacity] = Field(default=None, alias="timeAndCapacity")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "days": obj.get("days"),
            "timeAndCapacity": AutoscaleTimeAndCapacity.from_dict(obj["timeAndCapacity"]) if obj.get("timeAndCapacity") is not None else None
        })
        return _obj
