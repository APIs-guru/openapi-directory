...
class RuntimeScriptActionDetail(BaseModel):
    """
    ...
    execution_summary: Optional[List[ScriptActionExecutionSummary]] = Field(default=None, description="The summary of script action execution result.", alias="executionSummary")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "executionSummary": [ScriptActionExecutionSummary.from_dict(_item) for _item in obj["executionSummary"]] if obj.get("executionSummary") is not None else None,
