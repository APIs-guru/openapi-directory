...
class Autoscale(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["capacity", "recurrence"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "capacity": AutoscaleCapacity.from_dict(obj["capacity"]) if obj.get("capacity") is not None else None,
            "recurrence": AutoscaleRecurrence.from_dict(obj["recurrence"]) if obj.get("recurrence") is not None else None
        })
        return _obj
