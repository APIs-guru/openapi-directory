...
[**role_definitions_get_by_id**](RoleDefinitionsApi.md#role_definitions_get_by_id) | **GET** /{roleDefinitionId} | 
...
> RoleDefinition role_definitions_get_by_id(role_definition_id, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = openapi_client.RoleDefinitionsApi(api_client)
    role_definition_id = 'role_definition_id_example' # str | The fully qualified role definition ID. Use the format, /subscriptions/{guid}/providers/Microsoft.Authorization/roleDefinitions/{roleDefinitionId} for subscription level role definitions, or /providers/Microsoft.Authorization/roleDefinitions/{roleDefinitionId} for tenant level role definitions.
    api_version = 'api_version_example' # str | The API version to use for this operation.

    try:
        api_response = api_instance.role_definitions_get_by_id(role_definition_id, api_version)
        print("The response of RoleDefinitionsApi->role_definitions_get_by_id:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling RoleDefinitionsApi->role_definitions_get_by_id: %s\n" % e)
```
