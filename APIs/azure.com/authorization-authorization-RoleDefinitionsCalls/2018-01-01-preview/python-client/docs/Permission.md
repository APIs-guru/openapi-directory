...
------------ | ------------- | ------------- | -------------
**actions** | **List[str]** | Allowed actions. | [optional] 
**data_actions** | **List[str]** | Allowed Data actions. | [optional] 
**not_actions** | **List[str]** | Denied actions. | [optional] 
**not_data_actions** | **List[str]** | Denied Data actions. | [optional] 
