...
class RegenerateKeyInput(BaseModel):
    """
    The request body for a RegenerateKey API.
    """ # noqa: E501
    key_type: StrictStr = Field(description="The keyType indicating which key you want to regenerate, Primary or Secondary.", alias="keyType")
