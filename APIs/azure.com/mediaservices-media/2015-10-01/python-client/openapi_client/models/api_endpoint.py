...
class ApiEndpoint(BaseModel):
    ...
    """ # noqa: E501
    endpoint: Optional[StrictStr] = Field(default=None, description="The Media Services REST endpoint.")
    major_version: Optional[StrictStr] = Field(default=None, description="The version of Media Services REST API.", alias="majorVersion")
    __properties: ClassVar[List[str]] = ["endpoint", "majorVersion"]
