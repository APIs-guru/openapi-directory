...
class CheckNameAvailabilityInput(BaseModel):
    ...
    """ # noqa: E501
    name: Annotated[str, Field(min_length=3, strict=True, max_length=24)] = Field(description="The name of the resource. A name must be globally unique.")
    type: ResourceType
    ...
    def name_validate_regular_expression(cls, value):
        ...
        if not re.match(r"^[a-z0-9]{3,24}$", value):
            raise ValueError(r"must validate the regular expression /^[a-z0-9]{3,24}$/")
        return value
