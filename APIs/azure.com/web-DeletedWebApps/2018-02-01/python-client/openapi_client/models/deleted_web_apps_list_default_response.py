...
class DeletedWebAppsListDefaultResponse(BaseModel):
    """
    App Service error response.
    """ # noqa: E501
    error: Optional[DeletedWebAppsListDefaultResponseError] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": DeletedWebAppsListDefaultResponseError.from_dict(obj["error"]) if obj.get("error") is not None else None
        })
        return _obj
