...
class DeletedWebAppCollectionValueInner(BaseModel):
    """
    A deleted app.
    """ # noqa: E501
    properties: Optional[DeletedWebAppsGetDeletedWebAppByLocation200ResponseProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": DeletedWebAppsGetDeletedWebAppByLocation200ResponseProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
