...
class TestDiagnosticGet200Response(unittest.TestCase):
    """DiagnosticGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DiagnosticGet200Response:
        """Test DiagnosticGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DiagnosticGet200Response`
        """
        model = DiagnosticGet200Response()
        if include_optional:
    ...
    def testDiagnosticGet200Response(self):
        """Test DiagnosticGet200Response"""
