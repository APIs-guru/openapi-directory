...
class DiagnosticApi:
    ...
    def diagnostic_create_or_update(
        ...
        parameters: Annotated[DiagnosticGet200Response, Field(description="Create parameters.")],
        ...
        :type parameters: DiagnosticGet200Response
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DiagnosticGet200Response",
            '201': "DiagnosticGet200Response",
        }
    ...
    def diagnostic_create_or_update_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DiagnosticGet200Response]:
        """diagnostic_create_or_update
    ...
    def diagnostic_get_entity_tag(
        ...
        _param = self._diagnostic_get_entity_tag_serialize(
            resource_group_name=resource_group_name,
            service_name=service_name,
            diagnostic_id=diagnostic_id,
            api_version=api_version,
    ...
    @validate_call
    def diagnostic_get_entity_tag_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        diagnostic_id: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Diagnostic identifier. Must be unique in the current API Management service instance.")],
    ...
    @validate_call
    def diagnostic_get_entity_tag_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group.")],
        service_name: Annotated[str, Field(min_length=1, strict=True, max_length=50, description="The name of the API Management service.")],
        diagnostic_id: Annotated[str, Field(min_length=1, strict=True, max_length=80, description="Diagnostic identifier. Must be unique in the current API Management service instance.")],
    ...
    def _diagnostic_get_entity_tag_serialize(
        self,
        resource_group_name,
        service_name,
        diagnostic_id,
    ...
    def diagnostic_list_by_service(
        ...
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        filter: Annotated[Optional[StrictStr], Field(description="| Field       | Supported operators    | Supported functions               | |-------------|------------------------|-----------------------------------|   |name | ge, le, eq, ne, gt, lt | substringof, contains, startswith, endswith| ")] = None,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "DiagnosticListByService200Response",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def diagnostic_list_by_service_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DiagnosticListByService200Response]:
        """diagnostic_list_by_service
    ...
    def diagnostic_update(
        ...
        api_version: Annotated[StrictStr, Field(description="Version of the API to be used with the client request.")],
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        parameters: Annotated[DiagnosticGet200Response, Field(description="Diagnostic Update parameters.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
