...
class DiagnosticListByService200ResponseValueInnerPropertiesBackend(BaseModel):
    """
    Diagnostic settings for incoming/outgoing HTTP messages to the Gateway.
    """ # noqa: E501
    request: Optional[DiagnosticListByService200ResponseValueInnerPropertiesBackendRequest] = None
    response: Optional[DiagnosticListByService200ResponseValueInnerPropertiesBackendRequest] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "request": DiagnosticListByService200ResponseValueInnerPropertiesBackendRequest.from_dict(obj["request"]) if obj.get("request") is not None else None,
            "response": DiagnosticListByService200ResponseValueInnerPropertiesBackendRequest.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
