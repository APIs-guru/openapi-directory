...
class TestDiagnosticListByService200ResponseValueInner(unittest.TestCase):
    """DiagnosticListByService200ResponseValueInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DiagnosticListByService200ResponseValueInner:
        """Test DiagnosticListByService200ResponseValueInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DiagnosticListByService200ResponseValueInner`
        """
        model = DiagnosticListByService200ResponseValueInner()
        if include_optional:
            return DiagnosticListByService200ResponseValueInner(
    ...
    def testDiagnosticListByService200ResponseValueInner(self):
        """Test DiagnosticListByService200ResponseValueInner"""
