...
class DiagnosticLoggerListByService200ResponseValueInnerProperties(BaseModel):
    ...
    sampling: Optional[DiagnosticLoggerListByService200ResponseValueInnerPropertiesSampling] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sampling": DiagnosticLoggerListByService200ResponseValueInnerPropertiesSampling.from_dict(obj["sampling"]) if obj.get("sampling") is not None else None
        })
        return _obj
