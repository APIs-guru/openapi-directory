...
class DiagnosticLoggerListByService200ResponseValueInnerPropertiesSampling(BaseModel):
    """
    Sampling settings contract.
    """ # noqa: E501
    properties: Optional[DiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": DiagnosticLoggerListByService200ResponseValueInnerPropertiesSamplingProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
