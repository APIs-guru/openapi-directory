...
[**diagnostic_head**](DiagnosticsApi.md#diagnostic_head) | **HEAD** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.ApiManagement/service/{serviceName}/diagnostics/{diagnosticId} | 
...
# **diagnostic_head**
> diagnostic_head(resource_group_name, service_name, diagnostic_id, api_version, subscription_id)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.diagnostic_head(resource_group_name, service_name, diagnostic_id, api_version, subscription_id)
    except Exception as e:
        print("Exception when calling DiagnosticsApi->diagnostic_head: %s\n" % e)
```
