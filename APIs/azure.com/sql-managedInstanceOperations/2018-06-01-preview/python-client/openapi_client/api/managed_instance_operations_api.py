...
class ManagedInstanceOperationsApi:
    ...
    @validate_call
    def managed_instance_operations_list_by_managed_instance(
        self,
        ...
        _param = self._managed_instance_operations_list_by_managed_instance_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ManagedInstanceOperationListResult",
        }
    ...
    @validate_call
    def managed_instance_operations_list_by_managed_instance_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        managed_instance_name: Annotated[StrictStr, Field(description="The name of the managed instance.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription ID that identifies an Azure subscription.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ManagedInstanceOperationListResult]:
        """managed_instance_operations_list_by_managed_instance
    ...
    @validate_call
    def managed_instance_operations_list_by_managed_instance_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        managed_instance_name: Annotated[StrictStr, Field(description="The name of the managed instance.")],
        subscription_id: Annotated[StrictStr, Field(description="The subscription ID that identifies an Azure subscription.")],
    ...
    def _managed_instance_operations_list_by_managed_instance_serialize(
        self,
        resource_group_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/operations',
