...
class ServerTableAuditingPolicyListResult(BaseModel):
    """
    Represents the response to a list server table auditing policies request.
    """ # noqa: E501
    value: List[ServerTableAuditingPolicy] = Field(description="The list of server table auditing policies.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ServerTableAuditingPolicy.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
