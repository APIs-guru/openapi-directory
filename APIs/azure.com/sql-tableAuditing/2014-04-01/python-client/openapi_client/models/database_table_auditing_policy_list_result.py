...
class DatabaseTableAuditingPolicyListResult(BaseModel):
    """
    Represents the response to a list database table auditing policies request.
    """ # noqa: E501
    value: List[DatabaseTableAuditingPolicy] = Field(description="The list of database table auditing policies.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [DatabaseTableAuditingPolicy.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
