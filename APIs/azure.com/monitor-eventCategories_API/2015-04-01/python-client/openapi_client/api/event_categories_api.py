...
class EventCategoriesApi:
    ...
    def event_categories_list(
        ...
        _param = self._event_categories_list_serialize(
    ...
    @validate_call
    def event_categories_list_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[EventCategoryCollection]:
        """event_categories_list
    ...
    @validate_call
    def event_categories_list_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="Client Api Version.")],
        _request_timeout: Union[
            None,
    ...
    def _event_categories_list_serialize(
        self,
        api_version,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/providers/microsoft.insights/eventcategories',
