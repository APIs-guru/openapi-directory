...
class AsyncOperationResult(BaseModel):
    ...
    status: Optional[StrictStr] = Field(default=None, description="current status of a long running operation.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "error": ErrorMesssage.from_dict(obj["error"]) if obj.get("error") is not None else None,
