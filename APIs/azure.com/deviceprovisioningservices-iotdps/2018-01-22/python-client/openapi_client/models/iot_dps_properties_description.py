...
class IotDpsPropertiesDescription(BaseModel):
    ...
    iot_hubs: Optional[List[IotHubDefinitionDescription]] = Field(default=None, description="List of IoT hubs associated with this provisioning service.", alias="iotHubs")
