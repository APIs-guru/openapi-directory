...
class SharedAccessSignatureAuthorizationRuleListResult(BaseModel):
    """
    List of shared access keys.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The next link.", alias="nextLink")
    value: Optional[List[SharedAccessSignatureAuthorizationRuleAccessRightsDescription]] = Field(default=None, description="The list of shared access policies.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [SharedAccessSignatureAuthorizationRuleAccessRightsDescription.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
