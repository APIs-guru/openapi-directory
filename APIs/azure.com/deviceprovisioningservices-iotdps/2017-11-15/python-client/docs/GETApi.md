...
[**dps_certificate_list**](GETApi.md#dps_certificate_list) | **GET** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Devices/provisioningServices/{provisioningServiceName}/certificates | 
...
> CertificateListDescription dps_certificate_list(subscription_id, resource_group_name, provisioning_service_name, api_version)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.dps_certificate_list(subscription_id, resource_group_name, provisioning_service_name, api_version)
        print("The response of GETApi->dps_certificate_list:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling GETApi->dps_certificate_list: %s\n" % e)
```
