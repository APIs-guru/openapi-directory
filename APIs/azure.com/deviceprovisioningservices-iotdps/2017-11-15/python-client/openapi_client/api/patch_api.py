...
class PATCHApi:
    ...
    def iot_dps_resource_update(
        ...
        provisioning_service_tags: Annotated[TagsResource, Field(description="Updated tag information to set into the provisioning service instance.")],
        ...
        :param provisioning_service_tags: Updated tag information to set into the provisioning service instance. (required)
        :type provisioning_service_tags: TagsResource
        ...
        _param = self._iot_dps_resource_update_serialize(
    ...
    @validate_call
    def iot_dps_resource_update_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription identifier.")],
        resource_group_name: Annotated[StrictStr, Field(description="Resource group identifier.")],
        provisioning_service_name: Annotated[StrictStr, Field(description="Name of provisioning service to create or update.")],
    ...
    @validate_call
    def iot_dps_resource_update_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="The subscription identifier.")],
        resource_group_name: Annotated[StrictStr, Field(description="Resource group identifier.")],
        provisioning_service_name: Annotated[StrictStr, Field(description="Name of provisioning service to create or update.")],
    ...
    def _iot_dps_resource_update_serialize(
        self,
        subscription_id,
        resource_group_name,
        ...
        if provisioning_service_tags is not None:
            _body_params = provisioning_service_tags
