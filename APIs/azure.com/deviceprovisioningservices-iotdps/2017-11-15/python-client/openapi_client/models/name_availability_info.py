...
class NameAvailabilityInfo(BaseModel):
    ...
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="message containing a detailed reason name is unavailable")
    name_available: Optional[StrictBool] = Field(default=None, description="specifies if a name is available or not", alias="nameAvailable")
    reason: Optional[StrictStr] = Field(default=None, description="specifies the reason a name is unavailable")
