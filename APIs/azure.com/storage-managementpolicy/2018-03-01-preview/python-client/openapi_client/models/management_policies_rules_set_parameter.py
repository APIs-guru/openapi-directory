...
class ManagementPoliciesRulesSetParameter(BaseModel):
    """
    ...
    """ # noqa: E501
    properties: Optional[ManagementPoliciesRules] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": ManagementPoliciesRules.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
