# openapi_client.ManagementPoliciesApi
...
> StorageAccountManagementPolicies management_policies_create_or_update(resource_group_name, account_name, api_version, subscription_id, management_policy_name, properties)
 ...
 **management_policy_name** | **str**| The name of the Storage Account Management Policy. It should always be &#39;default&#39; | 
...
> management_policies_delete(resource_group_name, account_name, api_version, subscription_id, management_policy_name)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_instance.management_policies_delete(resource_group_name, account_name, api_version, subscription_id, management_policy_name)
    except Exception as e:
        print("Exception when calling ManagementPoliciesApi->management_policies_delete: %s\n" % e)
```
...
> StorageAccountManagementPolicies management_policies_get(resource_group_name, account_name, api_version, subscription_id, management_policy_name)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.management_policies_get(resource_group_name, account_name, api_version, subscription_id, management_policy_name)
        print("The response of ManagementPoliciesApi->management_policies_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling ManagementPoliciesApi->management_policies_get: %s\n" % e)
```
