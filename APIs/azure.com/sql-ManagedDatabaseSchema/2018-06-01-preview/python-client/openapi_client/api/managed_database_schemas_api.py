...
class ManagedDatabaseSchemasApi:
    ...
    @validate_call
    def managed_database_schemas_get(
        self,
        ...
        _param = self._managed_database_schemas_get_serialize(
    ...
    @validate_call
    def managed_database_schemas_get_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        managed_instance_name: Annotated[StrictStr, Field(description="The name of the managed instance.")],
        database_name: Annotated[StrictStr, Field(description="The name of the database.")],
    ...
    @validate_call
    def managed_database_schemas_get_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        managed_instance_name: Annotated[StrictStr, Field(description="The name of the managed instance.")],
        database_name: Annotated[StrictStr, Field(description="The name of the database.")],
    ...
    def _managed_database_schemas_get_serialize(
        self,
        resource_group_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}/schemas/{schemaName}',
    ...
    @validate_call
    def managed_database_schemas_list_by_database(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        managed_instance_name: Annotated[StrictStr, Field(description="The name of the managed instance.")],
        database_name: Annotated[StrictStr, Field(description="The name of the database.")],
        ...
        _param = self._managed_database_schemas_list_by_database_serialize(
            resource_group_name=resource_group_name,
            managed_instance_name=managed_instance_name,
            database_name=database_name,
            subscription_id=subscription_id,
    ...
    @validate_call
    def managed_database_schemas_list_by_database_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        managed_instance_name: Annotated[StrictStr, Field(description="The name of the managed instance.")],
        database_name: Annotated[StrictStr, Field(description="The name of the database.")],
    ...
    @validate_call
    def managed_database_schemas_list_by_database_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        managed_instance_name: Annotated[StrictStr, Field(description="The name of the managed instance.")],
        database_name: Annotated[StrictStr, Field(description="The name of the database.")],
    ...
    def _managed_database_schemas_list_by_database_serialize(
        self,
        resource_group_name,
        managed_instance_name,
        database_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}/schemas',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
