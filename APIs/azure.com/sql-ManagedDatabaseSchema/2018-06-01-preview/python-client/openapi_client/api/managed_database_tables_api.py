...
class ManagedDatabaseTablesApi:
    ...
    @validate_call
    def managed_database_tables_get(
        self,
        ...
        _param = self._managed_database_tables_get_serialize(
    ...
    @validate_call
    def managed_database_tables_get_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        managed_instance_name: Annotated[StrictStr, Field(description="The name of the managed instance.")],
        database_name: Annotated[StrictStr, Field(description="The name of the database.")],
    ...
    @validate_call
    def managed_database_tables_get_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        managed_instance_name: Annotated[StrictStr, Field(description="The name of the managed instance.")],
        database_name: Annotated[StrictStr, Field(description="The name of the database.")],
    ...
    def _managed_database_tables_get_serialize(
        self,
        resource_group_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}/schemas/{schemaName}/tables/{tableName}',
    ...
    @validate_call
    def managed_database_tables_list_by_schema(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        managed_instance_name: Annotated[StrictStr, Field(description="The name of the managed instance.")],
        database_name: Annotated[StrictStr, Field(description="The name of the database.")],
        ...
        _param = self._managed_database_tables_list_by_schema_serialize(
            resource_group_name=resource_group_name,
            managed_instance_name=managed_instance_name,
            database_name=database_name,
            schema_name=schema_name,
    ...
    @validate_call
    def managed_database_tables_list_by_schema_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        managed_instance_name: Annotated[StrictStr, Field(description="The name of the managed instance.")],
        database_name: Annotated[StrictStr, Field(description="The name of the database.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DatabaseTableListResult]:
        """managed_database_tables_list_by_schema
    ...
    @validate_call
    def managed_database_tables_list_by_schema_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        managed_instance_name: Annotated[StrictStr, Field(description="The name of the managed instance.")],
        database_name: Annotated[StrictStr, Field(description="The name of the database.")],
    ...
    def _managed_database_tables_list_by_schema_serialize(
        self,
        resource_group_name,
        managed_instance_name,
        database_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/managedInstances/{managedInstanceName}/databases/{databaseName}/schemas/{schemaName}/tables',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
