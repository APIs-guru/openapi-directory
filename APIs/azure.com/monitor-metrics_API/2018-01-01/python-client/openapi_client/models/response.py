...
class Response(BaseModel):
    ...
    resourceregion: Optional[StrictStr] = Field(default=None, description="The region of the resource been queried for metrics.")
    ...
    __properties: ClassVar[List[str]] = ["cost", "interval", "namespace", "resourceregion", "timespan", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "resourceregion": obj.get("resourceregion"),
