...
# **metrics_list**
> Response metrics_list(resource_uri, api_version, timespan=timespan, interval=interval, metric=metric, aggregation=aggregation, top=top, orderby=orderby, filter=filter, result_type=result_type)
 ...
 **metric** | **str**| The name of the metric to retrieve. | [optional] 
 **aggregation** | **str**| The list of aggregation types (comma separated) to retrieve. | [optional] 
 **top** | **float**| The maximum number of records to retrieve. Valid only if $filter is specified. Defaults to 10. | [optional] 
