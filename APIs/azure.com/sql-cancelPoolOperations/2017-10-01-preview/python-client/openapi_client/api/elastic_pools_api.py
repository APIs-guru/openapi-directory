...
class ElasticPoolsApi:
    ...
    @validate_call
    def elastic_pool_operations_cancel(
        self,
        ...
        :param elastic_pool_name: (required)
        ...
        _param = self._elastic_pool_operations_cancel_serialize(
    ...
    @validate_call
    def elastic_pool_operations_cancel_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        elastic_pool_name: StrictStr,
    ...
    @validate_call
    def elastic_pool_operations_cancel_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        elastic_pool_name: StrictStr,
    ...
    def _elastic_pool_operations_cancel_serialize(
        self,
        resource_group_name,
        server_name,
        elastic_pool_name,
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/elasticPools/{elasticPoolName}/operations/{operationId}/cancel',
    ...
    @validate_call
    def elastic_pool_operations_list_by_elastic_pool(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        elastic_pool_name: StrictStr,
        ...
        _param = self._elastic_pool_operations_list_by_elastic_pool_serialize(
            resource_group_name=resource_group_name,
            server_name=server_name,
            elastic_pool_name=elastic_pool_name,
            subscription_id=subscription_id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ElasticPoolOperationListResult",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    @validate_call
    def elastic_pool_operations_list_by_elastic_pool_with_http_info(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        elastic_pool_name: StrictStr,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ElasticPoolOperationListResult]:
        """elastic_pool_operations_list_by_elastic_pool
    ...
    @validate_call
    def elastic_pool_operations_list_by_elastic_pool_without_preload_content(
        self,
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the resource. You can obtain this value from the Azure Resource Manager API or the portal.")],
        server_name: Annotated[StrictStr, Field(description="The name of the server.")],
        elastic_pool_name: StrictStr,
    ...
    def _elastic_pool_operations_list_by_elastic_pool_serialize(
        self,
        resource_group_name,
        server_name,
        elastic_pool_name,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Sql/servers/{serverName}/elasticPools/{elasticPoolName}/operations',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
