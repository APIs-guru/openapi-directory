...
class AvailableDelegationsResult(BaseModel):
    """
    An array of available delegations.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The URL to get the next set of results.", alias="nextLink")
    value: Optional[List[AvailableDelegation]] = Field(default=None, description="An array of available delegations.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [AvailableDelegation.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
