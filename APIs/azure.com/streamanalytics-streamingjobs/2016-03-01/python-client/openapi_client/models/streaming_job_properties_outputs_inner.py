...
class StreamingJobPropertiesOutputsInner(BaseModel):
    """
    An output object, containing all information associated with the named output. All outputs are contained under a streaming job.
    """ # noqa: E501
    properties: Optional[StreamingJobPropertiesOutputsInnerProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": StreamingJobPropertiesOutputsInnerProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
