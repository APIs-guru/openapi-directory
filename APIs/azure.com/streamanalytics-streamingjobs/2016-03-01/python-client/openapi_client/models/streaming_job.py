...
class StreamingJob(BaseModel):
    ...
    """ # noqa: E501
    properties: Optional[StreamingJobProperties] = None
    id: Optional[StrictStr] = Field(default=None, description="Resource Id")
    location: Optional[StrictStr] = Field(default=None, description="Resource location. Required on PUT (CreateOrReplace) requests.")
