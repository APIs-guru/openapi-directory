...
class StreamingJobPropertiesOutputsInnerProperties(BaseModel):
    """
    The properties that are associated with an output.
    """ # noqa: E501
    datasource: Optional[StreamingJobPropertiesOutputsInnerPropertiesDatasource] = None
    diagnostics: Optional[StreamingJobPropertiesInputsInnerPropertiesDiagnostics] = None
    ...
    serialization: Optional[StreamingJobPropertiesInputsInnerPropertiesSerialization] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "datasource": StreamingJobPropertiesOutputsInnerPropertiesDatasource.from_dict(obj["datasource"]) if obj.get("datasource") is not None else None,
            "diagnostics": StreamingJobPropertiesInputsInnerPropertiesDiagnostics.from_dict(obj["diagnostics"]) if obj.get("diagnostics") is not None else None,
            "etag": obj.get("etag"),
            "serialization": StreamingJobPropertiesInputsInnerPropertiesSerialization.from_dict(obj["serialization"]) if obj.get("serialization") is not None else None
        })
        return _obj
