...
class StreamingJobPropertiesFunctionsInner(BaseModel):
    """
    A function object, containing all information associated with the named function. All functions are contained under a streaming job.
    """ # noqa: E501
    properties: Optional[StreamingJobPropertiesFunctionsInnerProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": StreamingJobPropertiesFunctionsInnerProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
