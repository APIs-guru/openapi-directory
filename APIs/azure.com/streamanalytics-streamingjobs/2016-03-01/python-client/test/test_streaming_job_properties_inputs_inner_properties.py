...
class TestStreamingJobPropertiesInputsInnerProperties(unittest.TestCase):
    """StreamingJobPropertiesInputsInnerProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StreamingJobPropertiesInputsInnerProperties:
        """Test StreamingJobPropertiesInputsInnerProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StreamingJobPropertiesInputsInnerProperties`
        """
        model = StreamingJobPropertiesInputsInnerProperties()
        if include_optional:
            return StreamingJobPropertiesInputsInnerProperties(
    ...
    def testStreamingJobPropertiesInputsInnerProperties(self):
        """Test StreamingJobPropertiesInputsInnerProperties"""
