...
class TestStreamingJobListResult(unittest.TestCase):
    """StreamingJobListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> StreamingJobListResult:
        """Test StreamingJobListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `StreamingJobListResult`
        """
        model = StreamingJobListResult()
        if include_optional:
            return StreamingJobListResult(
                next_link = '',
                value = [
                    openapi_client.models.streaming_job.StreamingJob(
    ...
    def testStreamingJobListResult(self):
        """Test StreamingJobListResult"""
