...
class Compute(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["azEnvironment", "location", "name", "offer", "osType", "placementGroupId", "plan", "platformFaultDomain", "platformUpdateDomain", "provider", "publicKeys", "publisher", "resourceGroupName", "sku", "subscriptionId", "tags", "version", "vmId", "vmScaleSetName", "vmSize", "zone"]
