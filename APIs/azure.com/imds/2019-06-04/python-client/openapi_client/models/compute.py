...
class Compute(BaseModel):
    ...
    tags_list: Optional[List[TagsProperties]] = Field(default=None, description="This is the list of tags for your VM formatted as a JSON array for easier programmatic parsing.", alias="tagsList")
    ...
    __properties: ClassVar[List[str]] = ["azEnvironment", "location", "name", "offer", "osType", "placementGroupId", "plan", "platformFaultDomain", "platformUpdateDomain", "provider", "publicKeys", "publisher", "resourceGroupName", "resourceId", "sku", "storageProfile", "subscriptionId", "tags", "tagsList", "version", "vmId", "vmScaleSetName", "vmSize", "zone"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in tags_list (list)
        _items = []
        if self.tags_list:
            for _item_tags_list in self.tags_list:
                if _item_tags_list:
                    _items.append(_item_tags_list.to_dict())
            _dict['tagsList'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tags": obj.get("tags"),
            "tagsList": [TagsProperties.from_dict(_item) for _item in obj["tagsList"]] if obj.get("tagsList") is not None else None,
