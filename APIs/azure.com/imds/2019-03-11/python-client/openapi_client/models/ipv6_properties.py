...
class Ipv6Properties(BaseModel):
    """
    This contains the IPv6 properties.
    """ # noqa: E501
    private_ip_address: Optional[StrictStr] = Field(default=None, description="This is the private IPv6 address assigned to the interface.", alias="privateIpAddress")
    __properties: ClassVar[List[str]] = ["privateIpAddress"]
