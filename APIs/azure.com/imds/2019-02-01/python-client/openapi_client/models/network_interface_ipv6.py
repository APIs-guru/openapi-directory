...
class NetworkInterfaceIpv6(BaseModel):
    """
    This contains the IPv6 address.
    """ # noqa: E501
    ip_address: Optional[List[Ipv6Properties]] = Field(default=None, description="This is the IP address", alias="ipAddress")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ipAddress": [Ipv6Properties.from_dict(_item) for _item in obj["ipAddress"]] if obj.get("ipAddress") is not None else None
        })
        return _obj
