...
class IdentityInfoResponse(BaseModel):
    """
    This is the response from the Identity_GetInfo operation.
    """ # noqa: E501
    tenant_id: Optional[StrictStr] = Field(default=None, description="This is the AAD tenantId of the identity of the system assigned managed identity.", alias="tenantId")
