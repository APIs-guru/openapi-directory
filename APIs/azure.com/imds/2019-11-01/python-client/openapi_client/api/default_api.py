...
class DefaultApi:
    ...
    def attested_get_document(
        ...
        nonce: Annotated[Optional[StrictStr], Field(description="This is a string of up to 32 random alphanumeric characters.")] = None,
        ...
        _param = self._attested_get_document_serialize(
    ...
    @validate_call
    def attested_get_document_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="This is the API version to use.")],
        metadata: Annotated[StrictStr, Field(description="This must be set to 'true'.")],
        nonce: Annotated[Optional[StrictStr], Field(description="This is a string of up to 32 random alphanumeric characters.")] = None,
    ...
    @validate_call
    def attested_get_document_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="This is the API version to use.")],
        metadata: Annotated[StrictStr, Field(description="This must be set to 'true'.")],
        nonce: Annotated[Optional[StrictStr], Field(description="This is a string of up to 32 random alphanumeric characters.")] = None,
    ...
    def _attested_get_document_serialize(
        self,
        api_version,
        metadata,
        nonce,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/attested/document',
    ...
    def instances_get_metadata(
        ...
        _param = self._instances_get_metadata_serialize(
            api_version=api_version,
            metadata=metadata,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def instances_get_metadata_with_http_info(
        self,
        api_version: Annotated[StrictStr, Field(description="This is the API version to use.")],
        metadata: Annotated[StrictStr, Field(description="This must be set to 'true'.")],
        _request_timeout: Union[
    ...
    @validate_call
    def instances_get_metadata_without_preload_content(
        self,
        api_version: Annotated[StrictStr, Field(description="This is the API version to use.")],
        metadata: Annotated[StrictStr, Field(description="This must be set to 'true'.")],
        _request_timeout: Union[
    ...
    def _instances_get_metadata_serialize(
        self,
        api_version,
        metadata,
        _request_auth,
