...
class GetMetadataInformationApi:
    ...
    def identity_get_info(
        ...
        _param = self._identity_get_info_serialize(
            metadata=metadata,
    ...
    @validate_call
    def identity_get_info_with_http_info(
        self,
        metadata: Annotated[StrictStr, Field(description="This must be set to 'true'.")],
        api_version: Annotated[StrictStr, Field(description="This is the API version to use.")],
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[IdentityInfoResponse]:
        """identity_get_info
    ...
    @validate_call
    def identity_get_info_without_preload_content(
        self,
        metadata: Annotated[StrictStr, Field(description="This must be set to 'true'.")],
        api_version: Annotated[StrictStr, Field(description="This is the API version to use.")],
        _request_timeout: Union[
    ...
    def _identity_get_info_serialize(
        self,
        metadata,
        api_version,
        _request_auth,
