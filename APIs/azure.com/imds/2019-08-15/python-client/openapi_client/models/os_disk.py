...
class OsDisk(BaseModel):
    ...
    os_type: Optional[StrictStr] = Field(default=None, description="This is the type of OS included in the disk.", alias="osType")
    ...
    __properties: ClassVar[List[str]] = ["caching", "createOption", "diffDiskSettings", "diskSizeGB", "encryptionSettings", "image", "managedDisk", "name", "osType", "vhd", "writeAcceleratorEnabled"]
