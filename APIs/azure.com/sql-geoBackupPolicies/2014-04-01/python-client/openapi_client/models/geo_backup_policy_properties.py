...
class GeoBackupPolicyProperties(BaseModel):
    """
    The properties of the geo backup policy.
    """ # noqa: E501
    state: StrictStr = Field(description="The state of the geo backup policy.")
    storage_type: Optional[StrictStr] = Field(default=None, description="The storage type of the geo backup policy.", alias="storageType")
    __properties: ClassVar[List[str]] = ["state", "storageType"]
