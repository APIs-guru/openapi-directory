...
class GeoBackupPolicy(BaseModel):
    """
    A database geo backup policy.
    """ # noqa: E501
    kind: Optional[StrictStr] = Field(default=None, description="Kind of geo backup policy.  This is metadata used for the Azure portal experience.")
    location: Optional[StrictStr] = Field(default=None, description="Backup policy location.")
