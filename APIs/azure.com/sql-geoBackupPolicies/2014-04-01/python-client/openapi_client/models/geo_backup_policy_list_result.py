...
class GeoBackupPolicyListResult(BaseModel):
    """
    The response to a list geo backup policies request.
    """ # noqa: E501
    value: Optional[List[GeoBackupPolicy]] = Field(default=None, description="The list of geo backup policies.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [GeoBackupPolicy.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
