...
class ApplicationInsightsWebTestLocationsListResult(BaseModel):
    """
    Describes the list of web test locations available to an Application Insights Component.
    """ # noqa: E501
    value: List[ApplicationInsightsComponentWebTestLocation] = Field(description="List of web test locations.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ApplicationInsightsComponentWebTestLocation.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
