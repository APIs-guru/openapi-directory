...
class BastionHostPropertiesFormat(BaseModel):
    """
    Properties of the Bastion Host.
    """ # noqa: E501
    dns_name: Optional[StrictStr] = Field(default=None, description="FQDN for the endpoint on which bastion host is accessible.", alias="dnsName")
    ip_configurations: Optional[List[BastionHostIPConfiguration]] = Field(default=None, description="IP configuration of the Bastion Host resource.", alias="ipConfigurations")
    ...
    __properties: ClassVar[List[str]] = ["dnsName", "ipConfigurations", "provisioningState"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ipConfigurations": [BastionHostIPConfiguration.from_dict(_item) for _item in obj["ipConfigurations"]] if obj.get("ipConfigurations") is not None else None,
