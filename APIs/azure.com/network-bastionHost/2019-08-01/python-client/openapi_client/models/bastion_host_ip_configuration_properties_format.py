...
class BastionHostIPConfigurationPropertiesFormat(BaseModel):
    """
    ...
    public_ip_address: BastionHostIPConfigurationPropertiesFormatPublicIPAddress = Field(alias="publicIPAddress")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "publicIPAddress": BastionHostIPConfigurationPropertiesFormatPublicIPAddress.from_dict(obj["publicIPAddress"]) if obj.get("publicIPAddress") is not None else None,
            "subnet": BastionHostIPConfigurationPropertiesFormatPublicIPAddress.from_dict(obj["subnet"]) if obj.get("subnet") is not None else None
        })
        return _obj
