...
[**bastion_hosts_update_tags**](BastionHostsApi.md#bastion_hosts_update_tags) | **PATCH** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/bastionHosts/{bastionHostName} | 
...
> BastionHost bastion_hosts_update_tags(subscription_id, resource_group_name, bastion_host_name, api_version, bastion_host_parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.BastionHostsApi(api_client)
    subscription_id = 'subscription_id_example' # str | The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    resource_group_name = 'resource_group_name_example' # str | The resource group name of the BastionHost.
    bastion_host_name = 'bastion_host_name_example' # str | The name of the bastionHost.
    api_version = 'api_version_example' # str | Client API version.
    bastion_host_parameters = openapi_client.BastionHostsUpdateTagsRequest() # BastionHostsUpdateTagsRequest | Parameters supplied to update a bastion host tags.

    try:
        api_response = api_instance.bastion_hosts_update_tags(subscription_id, resource_group_name, bastion_host_name, api_version, bastion_host_parameters)
        print("The response of BastionHostsApi->bastion_hosts_update_tags:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BastionHostsApi->bastion_hosts_update_tags: %s\n" % e)
```
...
------------- | ------------- | ------------- | -------------
 **subscription_id** | **str**| The subscription credentials which uniquely identify the Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. | 
 **resource_group_name** | **str**| The resource group name of the BastionHost. | 
 **bastion_host_name** | **str**| The name of the bastionHost. | 
 **api_version** | **str**| Client API version. | 
 **bastion_host_parameters** | [**BastionHostsUpdateTagsRequest**](BastionHostsUpdateTagsRequest.md)| Parameters supplied to update a bastion host tags. | 
