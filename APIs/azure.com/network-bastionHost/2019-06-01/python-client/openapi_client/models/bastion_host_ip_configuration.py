...
class BastionHostIPConfiguration(BaseModel):
    """
    ...
    properties: Optional[BastionHostIPConfigurationPropertiesFormat] = None
    type: Optional[StrictStr] = Field(default=None, description="Ip configuration type.")
