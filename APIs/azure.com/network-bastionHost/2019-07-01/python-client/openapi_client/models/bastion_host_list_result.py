...
class BastionHostListResult(BaseModel):
    """
    ...
    value: Optional[List[BastionHost]] = Field(default=None, description="List of Bastion Hosts in a resource group.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [BastionHost.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
