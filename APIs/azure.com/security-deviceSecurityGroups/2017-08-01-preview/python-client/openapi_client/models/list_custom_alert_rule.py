...
class ListCustomAlertRule(BaseModel):
    """
    ...
    is_enabled: StrictBool = Field(description="Whether the custom alert is enabled.", alias="isEnabled")
    rule_type: StrictStr = Field(description="The type of the custom alert rule.", alias="ruleType")
    __properties: ClassVar[List[str]] = ["description", "displayName", "isEnabled", "ruleType"]
