...
class DeviceSecurityGroupList(BaseModel):
    """
    ...
    value: Optional[List[DeviceSecurityGroup]] = Field(default=None, description="List of device security group objects")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [DeviceSecurityGroup.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
