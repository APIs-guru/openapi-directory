...
------------ | ------------- | ------------- | -------------
**allowlist_rules** | [**List[AllowlistCustomAlertRule]**](AllowlistCustomAlertRule.md) | A list of allow-list custom alert rules. | [optional] 
**denylist_rules** | [**List[DenylistCustomAlertRule]**](DenylistCustomAlertRule.md) | A list of deny-list custom alert rules. | [optional] 
**threshold_rules** | [**List[ThresholdCustomAlertRule]**](ThresholdCustomAlertRule.md) | A list of threshold custom alert rules. | [optional] 
**time_window_rules** | [**List[TimeWindowCustomAlertRule]**](TimeWindowCustomAlertRule.md) | A list of time window custom alert rules. | [optional] 
