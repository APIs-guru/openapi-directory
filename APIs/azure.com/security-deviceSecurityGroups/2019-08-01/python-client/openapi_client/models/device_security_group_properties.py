...
class DeviceSecurityGroupProperties(BaseModel):
    ...
    """ # noqa: E501
    allowlist_rules: Optional[List[AllowlistCustomAlertRule]] = Field(default=None, description="The allow-list custom alert rules.", alias="allowlistRules")
    denylist_rules: Optional[List[DenylistCustomAlertRule]] = Field(default=None, description="The deny-list custom alert rules.", alias="denylistRules")
    threshold_rules: Optional[List[ThresholdCustomAlertRule]] = Field(default=None, description="The list of custom alert threshold rules.", alias="thresholdRules")
    time_window_rules: Optional[List[TimeWindowCustomAlertRule]] = Field(default=None, description="The list of custom alert time-window rules.", alias="timeWindowRules")
