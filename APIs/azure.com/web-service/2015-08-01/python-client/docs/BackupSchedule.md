...
------------ | ------------- | ------------- | -------------
**frequency_interval** | **int** | How often should be the backup executed (e.g. for weekly backup, this should be set to 7 and FrequencyUnit should be set to Day) | [optional] 
...
**keep_at_least_one_backup** | **bool** | True if the retention policy should always keep at least one backup in the storage account, regardless how old it is; false otherwise. | [optional] 
**last_execution_time** | **datetime** | The last time when this schedule was triggered | [optional] 
**retention_period_in_days** | **int** | After how many days backups should be deleted | [optional] 
