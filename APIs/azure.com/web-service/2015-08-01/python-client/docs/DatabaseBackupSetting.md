...
------------ | ------------- | ------------- | -------------
**connection_string** | **str** | Contains a connection string to a database which is being backed up/restored. If the restore should happen to a new database, the database name inside is the new one. | [optional] 
...
**database_type** | **str** | SqlAzure / MySql | [optional] 
**name** | **str** |  | [optional] 
