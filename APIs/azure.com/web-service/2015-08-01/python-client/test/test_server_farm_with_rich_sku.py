...
class TestServerFarmWithRichSku(unittest.TestCase):
    """ServerFarmWithRichSku unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServerFarmWithRichSku:
        """Test ServerFarmWithRichSku
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServerFarmWithRichSku`
        """
        model = ServerFarmWithRichSku()
        if include_optional:
    ...
    def testServerFarmWithRichSku(self):
        """Test ServerFarmWithRichSku"""
