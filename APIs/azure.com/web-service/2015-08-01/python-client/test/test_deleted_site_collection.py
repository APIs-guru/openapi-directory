...
class TestDeletedSiteCollection(unittest.TestCase):
    """DeletedSiteCollection unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DeletedSiteCollection:
        """Test DeletedSiteCollection
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DeletedSiteCollection`
        """
        model = DeletedSiteCollection()
        if include_optional:
                ...
                value = [
                    openapi_client.models.deleted_site.DeletedSite(
                        properties = openapi_client.models.properties.properties(
                            ...
                            container_size = 56, 
                            default_host_name = '', 
                            deleted_timestamp = datetime.datetime.strptime('2013-10-20 19:20:30.00', '%Y-%m-%d %H:%M:%S.%f'), 
                            enabled = True, 
                            enabled_host_names = [
                                ''
                                ], 
    ...
    def testDeletedSiteCollection(self):
        """Test DeletedSiteCollection"""
