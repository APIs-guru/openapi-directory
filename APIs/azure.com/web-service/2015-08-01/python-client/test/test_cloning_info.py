...
class TestCloningInfo(unittest.TestCase):
    """CloningInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CloningInfo:
        """Test CloningInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CloningInfo`
        """
        model = CloningInfo()
        if include_optional:
            return CloningInfo(
