...
class EmailTemplateCreateOrUpdateRequest(BaseModel):
    """
    Email Template update Parameters.
    """ # noqa: E501
    properties: Optional[EmailTemplateCreateOrUpdateRequestProperties] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": EmailTemplateCreateOrUpdateRequestProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
