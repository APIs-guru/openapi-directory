...
class PolicyMetadataCollection(BaseModel):
    """
    ...
    value: Optional[List[SlimPolicyMetadata]] = Field(default=None, description="Array of policy metadata definitions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [SlimPolicyMetadata.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
