...
------------- | ------------- | -------------
[**public_ip_addresses_list**](PublicIpAddressesApi.md#public_ip_addresses_list) | **GET** /subscriptions/{subscriptionId}/providers/Microsoft.Network.Admin/adminPublicIpAddresses | 


# **public_ip_addresses_list**
> PublicIpAddressList public_ip_addresses_list(subscription_id, api_version, filter=filter, order_by=order_by, top=top, skip=skip, inline_count=inline_count)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.public_ip_addresses_list(subscription_id, api_version, filter=filter, order_by=order_by, top=top, skip=skip, inline_count=inline_count)
