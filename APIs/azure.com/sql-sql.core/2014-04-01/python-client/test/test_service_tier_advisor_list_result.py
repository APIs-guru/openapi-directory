...
class TestServiceTierAdvisorListResult(unittest.TestCase):
    """ServiceTierAdvisorListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceTierAdvisorListResult:
        """Test ServiceTierAdvisorListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceTierAdvisorListResult`
        """
        model = ServiceTierAdvisorListResult()
        if include_optional:
            return ServiceTierAdvisorListResult(
                value = [
                    openapi_client.models.service_tier_advisor.ServiceTierAdvisor(
                        properties = openapi_client.models.service_tier_advisor_properties.ServiceTierAdvisorProperties(
    ...
    def testServiceTierAdvisorListResult(self):
        """Test ServiceTierAdvisorListResult"""
