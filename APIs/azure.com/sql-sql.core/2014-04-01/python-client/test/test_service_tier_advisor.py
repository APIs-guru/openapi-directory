...
class TestServiceTierAdvisor(unittest.TestCase):
    """ServiceTierAdvisor unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServiceTierAdvisor:
        """Test ServiceTierAdvisor
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ServiceTierAdvisor`
        """
        model = ServiceTierAdvisor()
        if include_optional:
    ...
    def testServiceTierAdvisor(self):
        """Test ServiceTierAdvisor"""
