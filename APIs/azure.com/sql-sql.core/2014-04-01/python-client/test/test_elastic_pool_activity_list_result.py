...
class TestElasticPoolActivityListResult(unittest.TestCase):
    """ElasticPoolActivityListResult unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ElasticPoolActivityListResult:
        """Test ElasticPoolActivityListResult
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ElasticPoolActivityListResult`
        """
        model = ElasticPoolActivityListResult()
        if include_optional:
            return ElasticPoolActivityListResult(
                value = [
                    openapi_client.models.elastic_pool_activity.ElasticPoolActivity(
                        location = '', 
    ...
    def testElasticPoolActivityListResult(self):
        """Test ElasticPoolActivityListResult"""
