...
class TestElasticPoolActivityProperties(unittest.TestCase):
    """ElasticPoolActivityProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ElasticPoolActivityProperties:
        """Test ElasticPoolActivityProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ElasticPoolActivityProperties`
        """
        model = ElasticPoolActivityProperties()
        if include_optional:
            return ElasticPoolActivityProperties(
                elastic_pool_name = '',
    ...
    def testElasticPoolActivityProperties(self):
        """Test ElasticPoolActivityProperties"""
