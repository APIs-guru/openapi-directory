...
class ElasticPoolActivityListResult(BaseModel):
    """
    Represents the response to a list elastic pool activity request.
    """ # noqa: E501
    value: List[ElasticPoolActivity] = Field(description="The list of elastic pool activities.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ElasticPoolActivity.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
