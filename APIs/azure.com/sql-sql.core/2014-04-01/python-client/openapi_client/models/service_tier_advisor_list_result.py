...
class ServiceTierAdvisorListResult(BaseModel):
    """
    Represents the response to a list service tier advisor request.
    """ # noqa: E501
    value: List[ServiceTierAdvisor] = Field(description="The list of service tier advisors for specified database.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ServiceTierAdvisor.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
