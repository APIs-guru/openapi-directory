...
class RecommendedIndexProperties(BaseModel):
    """
    ...
    estimated_impact: Optional[List[OperationImpact]] = Field(default=None, description="The estimated impact of doing recommended index action.", alias="estimatedImpact")
    ...
    reported_impact: Optional[List[OperationImpact]] = Field(default=None, description="The values reported after index action is complete.", alias="reportedImpact")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "estimatedImpact": [OperationImpact.from_dict(_item) for _item in obj["estimatedImpact"]] if obj.get("estimatedImpact") is not None else None,
            "includedColumns": obj.get("includedColumns"),
            "indexScript": obj.get("indexScript"),
            "indexType": obj.get("indexType"),
            "lastModified": obj.get("lastModified"),
            "reportedImpact": [OperationImpact.from_dict(_item) for _item in obj["reportedImpact"]] if obj.get("reportedImpact") is not None else None,
