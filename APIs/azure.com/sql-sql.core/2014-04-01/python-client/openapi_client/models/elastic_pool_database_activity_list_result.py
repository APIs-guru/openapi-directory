...
class ElasticPoolDatabaseActivityListResult(BaseModel):
    """
    Represents the response to a list elastic pool database activity request.
    """ # noqa: E501
    value: List[ElasticPoolDatabaseActivity] = Field(description="The list of elastic pool database activities.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [ElasticPoolDatabaseActivity.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
