...
class TransparentDataEncryptionActivityListResult(BaseModel):
    """
    Represents the response to a list database transparent data encryption activity request.
    """ # noqa: E501
    value: List[TransparentDataEncryptionActivity] = Field(description="The list of database transparent data encryption activities.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [TransparentDataEncryptionActivity.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
