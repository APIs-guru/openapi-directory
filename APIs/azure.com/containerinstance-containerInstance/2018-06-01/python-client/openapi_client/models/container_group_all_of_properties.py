...
class ContainerGroupAllOfProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["containers", "diagnostics", "imageRegistryCredentials", "instanceView", "ipAddress", "osType", "provisioningState", "restartPolicy", "volumes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "diagnostics": ContainerGroupDiagnostics.from_dict(obj["diagnostics"]) if obj.get("diagnostics") is not None else None,
