...
class ContainerExecRequestTerminalSize(BaseModel):
    """
    The size of the terminal.
    """ # noqa: E501
    cols: Optional[StrictInt] = Field(default=None, description="The column size of the terminal")
    rows: Optional[StrictInt] = Field(default=None, description="The row size of the terminal")
