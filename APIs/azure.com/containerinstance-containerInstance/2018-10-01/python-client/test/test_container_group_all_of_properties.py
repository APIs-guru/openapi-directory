    ...
    def make_instance(self, include_optional) -> ContainerGroupAllOfProperties:
        ...
        if include_optional:
            return ContainerGroupAllOfProperties(
                ...
                diagnostics = openapi_client.models.container_group_diagnostics.ContainerGroupDiagnostics(
                    log_analytics = openapi_client.models.log_analytics.LogAnalytics(
                        ...
                        workspace_id = '', 
                        workspace_key = '', ), ),
                dns_config = openapi_client.models.dns_configuration.DnsConfiguration(
                    name_servers = [
                        ''
                        ], 
                    options = '', 
                ...
                ip_address = openapi_client.models.ip_address.IpAddress(
                    ...
                    type = 'Public', ),
                network_profile = openapi_client.models.container_group_network_profile.ContainerGroupNetworkProfile(
                    id = '', ),
                os_type = 'Windows',
                provisioning_state = '',
