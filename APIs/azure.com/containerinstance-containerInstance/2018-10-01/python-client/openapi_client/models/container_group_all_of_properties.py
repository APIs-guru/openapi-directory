...
class ContainerGroupAllOfProperties(BaseModel):
    ...
    dns_config: Optional[DnsConfiguration] = Field(default=None, alias="dnsConfig")
    ...
    __properties: ClassVar[List[str]] = ["containers", "diagnostics", "dnsConfig", "imageRegistryCredentials", "instanceView", "ipAddress", "networkProfile", "osType", "provisioningState", "restartPolicy", "volumes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "dnsConfig": DnsConfiguration.from_dict(obj["dnsConfig"]) if obj.get("dnsConfig") is not None else None,
