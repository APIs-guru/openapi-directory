...
class CachedImagesListResult(BaseModel):
    """
    The response containing cached images.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The URI to fetch the next page of cached images.", alias="nextLink")
    value: Optional[List[CachedImages]] = Field(default=None, description="The list of cached images.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [CachedImages.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
