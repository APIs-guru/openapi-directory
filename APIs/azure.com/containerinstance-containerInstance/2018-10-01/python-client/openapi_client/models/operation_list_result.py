...
class OperationListResult(BaseModel):
    ...
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The URI to fetch the next page of operations.", alias="nextLink")
    value: Optional[List[Operation]] = Field(default=None, description="The list of operations.")
