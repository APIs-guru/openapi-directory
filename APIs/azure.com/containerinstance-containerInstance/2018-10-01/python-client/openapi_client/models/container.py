...
class Container(BaseModel):
    ...
    """ # noqa: E501
    name: StrictStr = Field(description="The user-provided name of the container instance.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "properties": ContainerProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
