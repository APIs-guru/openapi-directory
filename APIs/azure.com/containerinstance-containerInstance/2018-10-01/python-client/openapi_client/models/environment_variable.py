...
class EnvironmentVariable(BaseModel):
    ...
    secure_value: Optional[StrictStr] = Field(default=None, description="The value of the secure environment variable.", alias="secureValue")
    value: Optional[StrictStr] = Field(default=None, description="The value of the environment variable.")
    __properties: ClassVar[List[str]] = ["name", "secureValue", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "name": obj.get("name"),
            "secureValue": obj.get("secureValue"),
            "value": obj.get("value")
        })
        return _obj
