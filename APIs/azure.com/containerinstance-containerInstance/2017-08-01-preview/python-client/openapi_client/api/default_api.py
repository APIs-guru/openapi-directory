...
class DefaultApi:
    ...
    def container_groups_create_or_update(
        ...
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group to contain the container group to be created or updated.")],
        container_group_name: Annotated[StrictStr, Field(description="The name of the container group to be created or updated.")],
        ...
        :param resource_group_name: The name of the resource group to contain the container group to be created or updated. (required)
        :type resource_group_name: str
        :param container_group_name: The name of the container group to be created or updated. (required)
    ...
    def container_groups_delete(
        ...
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        api_version: Annotated[StrictStr, Field(description="Client API version")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the container group.")],
        container_group_name: Annotated[StrictStr, Field(description="The name of the container group to be deleted.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param api_version: Client API version (required)
        :type api_version: str
        :param resource_group_name: The name of the resource group that contains the container group. (required)
        :type resource_group_name: str
        :param container_group_name: The name of the container group to be deleted. (required)
        :type container_group_name: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    @validate_call
    def container_logs_list(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        api_version: Annotated[StrictStr, Field(description="Client API version")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the container instance.")],
        container_name: Annotated[StrictStr, Field(description="The name of the container instance.")],
        container_group_name: Annotated[StrictStr, Field(description="The name of the container group the container instance belongs to.")],
        ...
        :param api_version: Client API version (required)
        :type api_version: str
        :param resource_group_name: The name of the resource group that contains the container instance. (required)
        :type resource_group_name: str
        :param container_name: The name of the container instance. (required)
        :type container_name: str
        :param container_group_name: The name of the container group the container instance belongs to. (required)
        :type container_group_name: str
        ...
        _param = self._container_logs_list_serialize(
            subscription_id=subscription_id,
            api_version=api_version,
            resource_group_name=resource_group_name,
    ...
    @validate_call
    def container_logs_list_with_http_info(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        api_version: Annotated[StrictStr, Field(description="Client API version")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the container instance.")],
    ...
    @validate_call
    def container_logs_list_without_preload_content(
        self,
        subscription_id: Annotated[StrictStr, Field(description="Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.")],
        api_version: Annotated[StrictStr, Field(description="Client API version")],
        resource_group_name: Annotated[StrictStr, Field(description="The name of the resource group that contains the container instance.")],
    ...
    def _container_logs_list_serialize(
        self,
        subscription_id,
        api_version,
        resource_group_name,
