...
class ContainerGroupListResult(BaseModel):
    """
    The container group list response that contains the container group properties.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The URI to fetch the next page of container groups.", alias="nextLink")
    value: Optional[List[ContainerGroup]] = Field(default=None, description="The list of container groups.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ContainerGroup.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
