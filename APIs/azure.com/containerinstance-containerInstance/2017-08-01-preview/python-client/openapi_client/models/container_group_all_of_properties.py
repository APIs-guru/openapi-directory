...
class ContainerGroupAllOfProperties(BaseModel):
    ...
    restart_policy: Optional[StrictStr] = Field(default=None, description="Restart policy for all containers within the container group. Currently the only available option is `always`.", alias="restartPolicy")
    state: Optional[StrictStr] = Field(default=None, description="The current state of the container group. This is only valid for the response.")
    ...
    __properties: ClassVar[List[str]] = ["containers", "imageRegistryCredentials", "ipAddress", "osType", "provisioningState", "restartPolicy", "state", "volumes"]
