 ...
 **resource_group_name** | **str**| The name of the resource group to contain the container group to be created or updated. | 
 **container_group_name** | **str**| The name of the container group to be created or updated. | 
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    subscription_id = 'subscription_id_example' # str | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    api_version = 'api_version_example' # str | Client API version
    resource_group_name = 'resource_group_name_example' # str | The name of the resource group that contains the container group.
    container_group_name = 'container_group_name_example' # str | The name of the container group to be deleted.
 ...
 **subscription_id** | **str**| Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. | 
 **api_version** | **str**| Client API version | 
 **resource_group_name** | **str**| The name of the resource group that contains the container group. | 
 **container_group_name** | **str**| The name of the container group to be deleted. | 
...
# **container_logs_list**
> Logs container_logs_list(subscription_id, api_version, resource_group_name, container_name, container_group_name, tail=tail)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    subscription_id = 'subscription_id_example' # str | Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call.
    api_version = 'api_version_example' # str | Client API version
    resource_group_name = 'resource_group_name_example' # str | The name of the resource group that contains the container instance.
    container_name = 'container_name_example' # str | The name of the container instance.
    container_group_name = 'container_group_name_example' # str | The name of the container group the container instance belongs to.
    ...
    try:
        # Get the logs for a specified container instance.
        api_response = api_instance.container_logs_list(subscription_id, api_version, resource_group_name, container_name, container_group_name, tail=tail)
 ...
 **subscription_id** | **str**| Subscription credentials which uniquely identify Microsoft Azure subscription. The subscription ID forms part of the URI for every service call. | 
 **api_version** | **str**| Client API version | 
 **resource_group_name** | **str**| The name of the resource group that contains the container instance. | 
 **container_name** | **str**| The name of the container instance. | 
 **container_group_name** | **str**| The name of the container group the container instance belongs to. | 
