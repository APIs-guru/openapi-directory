...
**operation** | **str** | The friendly name of the operation. | [optional] [readonly] 
**provider** | **str** | The name of the provider of the operation. | [optional] [readonly] 
**resource** | **str** | The name of the resource type of the operation. | [optional] [readonly] 
