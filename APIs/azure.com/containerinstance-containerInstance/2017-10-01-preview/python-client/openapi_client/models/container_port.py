...
class ContainerPort(BaseModel):
    ...
    """ # noqa: E501
    port: StrictInt = Field(description="The port number exposed within the container group.")
    protocol: Optional[StrictStr] = Field(default=None, description="The protocol associated with the port.")
