...
class ContainerGroupAllOfPropertiesInstanceView(BaseModel):
    """
    The instance view of the container group. Only valid in response.
    """ # noqa: E501
    events: Optional[List[Event]] = Field(default=None, description="The events of this container group.")
    state: Optional[StrictStr] = Field(default=None, description="The state of the container group. Only valid in response.")
    __properties: ClassVar[List[str]] = ["events", "state"]
