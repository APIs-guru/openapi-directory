...
class ContainerGroupAllOfProperties(BaseModel):
    ...
    network_profile: Optional[ContainerGroupNetworkProfile] = Field(default=None, alias="networkProfile")
    ...
    __properties: ClassVar[List[str]] = ["containers", "diagnostics", "imageRegistryCredentials", "instanceView", "ipAddress", "networkProfile", "osType", "provisioningState", "restartPolicy", "volumes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "networkProfile": ContainerGroupNetworkProfile.from_dict(obj["networkProfile"]) if obj.get("networkProfile") is not None else None,
