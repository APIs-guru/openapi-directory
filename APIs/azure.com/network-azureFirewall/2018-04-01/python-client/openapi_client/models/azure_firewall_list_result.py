...
class AzureFirewallListResult(BaseModel):
    """
    ...
    value: Optional[List[AzureFirewall]] = Field(default=None, description="List of a Azure Firewalls in a resource group.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [AzureFirewall.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
