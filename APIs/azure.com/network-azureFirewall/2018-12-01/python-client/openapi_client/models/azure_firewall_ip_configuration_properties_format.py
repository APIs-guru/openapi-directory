...
class AzureFirewallIPConfigurationPropertiesFormat(BaseModel):
    ...
    public_ip_address: Optional[AzureFirewallIPConfigurationPropertiesFormatPublicIPAddress] = Field(default=None, alias="publicIPAddress")
    subnet: Optional[AzureFirewallIPConfigurationPropertiesFormatPublicIPAddress] = None
    __properties: ClassVar[List[str]] = ["privateIPAddress", "provisioningState", "publicIPAddress", "subnet"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "publicIPAddress": AzureFirewallIPConfigurationPropertiesFormatPublicIPAddress.from_dict(obj["publicIPAddress"]) if obj.get("publicIPAddress") is not None else None,
            "subnet": AzureFirewallIPConfigurationPropertiesFormatPublicIPAddress.from_dict(obj["subnet"]) if obj.get("subnet") is not None else None
        })
        return _obj
