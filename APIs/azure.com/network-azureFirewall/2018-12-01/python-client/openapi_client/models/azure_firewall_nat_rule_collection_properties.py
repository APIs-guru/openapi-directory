...
class AzureFirewallNatRuleCollectionProperties(BaseModel):
    """
    Properties of the NAT rule collection.
    """ # noqa: E501
    action: Optional[AzureFirewallNatRCAction] = None
    priority: Optional[Annotated[int, Field(le=65000, strict=True, ge=100)]] = Field(default=None, description="Priority of the NAT rule collection resource.")
    ...
    rules: Optional[List[AzureFirewallNatRule]] = Field(default=None, description="Collection of rules used by a NAT rule collection.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "action": AzureFirewallNatRCAction.from_dict(obj["action"]) if obj.get("action") is not None else None,
            "priority": obj.get("priority"),
            "provisioningState": obj.get("provisioningState"),
            "rules": [AzureFirewallNatRule.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None
        })
        return _obj
