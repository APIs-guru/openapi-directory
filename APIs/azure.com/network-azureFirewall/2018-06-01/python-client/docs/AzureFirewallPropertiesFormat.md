...
------------ | ------------- | ------------- | -------------
**application_rule_collections** | [**List[AzureFirewallApplicationRuleCollection]**](AzureFirewallApplicationRuleCollection.md) | Collection of application rule collections used by a Azure Firewall. | [optional] 
...
**network_rule_collections** | [**List[AzureFirewallNetworkRuleCollection]**](AzureFirewallNetworkRuleCollection.md) | Collection of network rule collections used by a Azure Firewall. | [optional] 
