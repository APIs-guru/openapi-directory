...
class AzureFirewallApplicationRuleCollectionPropertiesFormat(BaseModel):
    """
    Properties of the application rule collection.
    """ # noqa: E501
    action: Optional[AzureFirewallRCAction] = None
    priority: Optional[Annotated[int, Field(le=65000, strict=True, ge=100)]] = Field(default=None, description="Priority of the application rule collection resource.")
    ...
    rules: Optional[List[AzureFirewallApplicationRule]] = Field(default=None, description="Collection of rules used by a application rule collection.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rules": [AzureFirewallApplicationRule.from_dict(_item) for _item in obj["rules"]] if obj.get("rules") is not None else None
        })
        return _obj
