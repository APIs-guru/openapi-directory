...
class AzureFirewallNetworkRuleCollection(BaseModel):
    """
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of the resource that is unique within the Azure firewall. This name can be used to access the resource.")
    properties: Optional[AzureFirewallNetworkRuleCollectionPropertiesFormat] = None
