...
class AzureFirewallPropertiesFormat(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["applicationRuleCollections", "firewallPolicy", "hubIpAddresses", "ipConfigurations", "natRuleCollections", "networkRuleCollections", "provisioningState", "sku", "threatIntelMode", "virtualHub"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "sku": AzureFirewallSku.from_dict(obj["sku"]) if obj.get("sku") is not None else None,
