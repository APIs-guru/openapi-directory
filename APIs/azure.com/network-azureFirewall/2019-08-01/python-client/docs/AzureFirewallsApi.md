...
[**azure_firewalls_update_tags**](AzureFirewallsApi.md#azure_firewalls_update_tags) | **PATCH** /subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/azureFirewalls/{azureFirewallName} | 
...
> AzureFirewall azure_firewalls_update_tags(resource_group_name, azure_firewall_name, api_version, subscription_id, parameters)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.azure_firewalls_update_tags(resource_group_name, azure_firewall_name, api_version, subscription_id, parameters)
        print("The response of AzureFirewallsApi->azure_firewalls_update_tags:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling AzureFirewallsApi->azure_firewalls_update_tags: %s\n" % e)
```
