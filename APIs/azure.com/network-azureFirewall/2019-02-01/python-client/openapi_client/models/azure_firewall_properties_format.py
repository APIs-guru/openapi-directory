...
class AzureFirewallPropertiesFormat(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["applicationRuleCollections", "ipConfigurations", "natRuleCollections", "networkRuleCollections", "provisioningState", "threatIntelMode"]
