...
class CustomerSubscriptionList(BaseModel):
    ...
    value: Optional[List[CustomerSubscription]] = Field(default=None, description="List of customer subscriptions.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [CustomerSubscription.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
