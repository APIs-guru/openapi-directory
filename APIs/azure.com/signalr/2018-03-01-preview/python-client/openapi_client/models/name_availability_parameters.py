...
class NameAvailabilityParameters(BaseModel):
    """
    Data POST-ed to the nameAvailability action
    """ # noqa: E501
    name: StrictStr = Field(description="The SignalR service name to validate. e.g.\"my-signalR-name-here\"")
    type: StrictStr = Field(description="The resource type. Should be always \"Microsoft.SignalRService/SignalR\".")
