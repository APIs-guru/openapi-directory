...
class RegenerateKeyParameters(BaseModel):
    ...
    """ # noqa: E501
    key_type: Optional[StrictStr] = Field(default=None, description="The keyType to regenerate. Must be either 'primary' or 'secondary'(case-insensitive).", alias="keyType")
    __properties: ClassVar[List[str]] = ["keyType"]
