...
class SignalRUsageList(BaseModel):
    """
    Object that includes an array of SignalR resource usages and a possible link for next set.
    """ # noqa: E501
    next_link: Optional[StrictStr] = Field(default=None, description="The URL the client should use to fetch the next page (per server side paging).  It's null for now, added for future use.", alias="nextLink")
    value: Optional[List[SignalRUsage]] = Field(default=None, description="List of SignalR usages")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [SignalRUsage.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
