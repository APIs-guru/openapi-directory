...
class SignalRResourceList(BaseModel):
    """
    ...
    value: Optional[List[SignalRResource]] = Field(default=None, description="List of SignalR services")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [SignalRResource.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
