...
class IncidentListResult(BaseModel):
    ...
    """ # noqa: E501
    value: Optional[List[Incident]] = Field(default=None, description="the incident collection.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [Incident.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
