...
class ProductDeploymentsUnlockRequest(BaseModel):
    """
    Parameters for bootstrap action
    """ # noqa: E501
    duration: Optional[StrictStr] = Field(default=None, description="Duration in TimeSpan format(Define which ISO format)")
