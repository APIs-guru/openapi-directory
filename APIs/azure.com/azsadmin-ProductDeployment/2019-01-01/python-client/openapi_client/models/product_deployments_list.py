...
class ProductDeploymentsList(BaseModel):
    """
    ...
    value: Optional[List[ProductDeploymentResourceEntity]] = Field(default=None, description="List of Product Deployments.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "value": [ProductDeploymentResourceEntity.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
