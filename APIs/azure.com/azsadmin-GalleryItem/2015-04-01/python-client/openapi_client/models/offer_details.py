...
class OfferDetails(BaseModel):
    ...
    """ # noqa: E501
    offer_id: Optional[StrictStr] = Field(default=None, description="Offer identifier.", alias="offerId")
    plans: Optional[List[Plan]] = Field(default=None, description="List of plans available for the offer.")
    publisher_id: Optional[StrictStr] = Field(default=None, description="Publisher identifier.", alias="publisherId")
    __properties: ClassVar[List[str]] = ["offerId", "plans", "publisherId"]
