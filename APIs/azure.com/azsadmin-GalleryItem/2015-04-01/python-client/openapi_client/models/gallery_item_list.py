...
class GalleryItemList(BaseModel):
    ...
    """ # noqa: E501
    value: Optional[List[GalleryItem]] = Field(default=None, description="List of gallery items.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "value": [GalleryItem.from_dict(_item) for _item in obj["value"]] if obj.get("value") is not None else None
        })
        return _obj
