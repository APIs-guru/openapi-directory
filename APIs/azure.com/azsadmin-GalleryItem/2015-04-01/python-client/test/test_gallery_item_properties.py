...
class TestGalleryItemProperties(unittest.TestCase):
    """GalleryItemProperties unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GalleryItemProperties:
        """Test GalleryItemProperties
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GalleryItemProperties`
        """
        model = GalleryItemProperties()
        if include_optional:
            return GalleryItemProperties(
    ...
    def testGalleryItemProperties(self):
        """Test GalleryItemProperties"""
