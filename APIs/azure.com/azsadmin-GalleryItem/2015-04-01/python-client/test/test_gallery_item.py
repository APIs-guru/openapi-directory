...
class TestGalleryItem(unittest.TestCase):
    """GalleryItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GalleryItem:
        """Test GalleryItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GalleryItem`
        """
        model = GalleryItem()
        if include_optional:
            return GalleryItem(
