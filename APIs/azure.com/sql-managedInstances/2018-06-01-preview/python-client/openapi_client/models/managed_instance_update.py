...
class ManagedInstanceUpdate(BaseModel):
    """
    An update request for an Azure SQL Database managed instance.
    """ # noqa: E501
    properties: Optional[ManagedInstanceProperties] = None
    sku: Optional[ManagedInstanceUpdateSku] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "properties": ManagedInstanceProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None,
            "sku": ManagedInstanceUpdateSku.from_dict(obj["sku"]) if obj.get("sku") is not None else None,
            "tags": obj.get("tags")
        })
        return _obj
