...
class ManagedClusterAccessProfile(BaseModel):
    """
    ...
    properties: Optional[AccessProfile] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tags": obj.get("tags"),
            "type": obj.get("type"),
            "properties": AccessProfile.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
