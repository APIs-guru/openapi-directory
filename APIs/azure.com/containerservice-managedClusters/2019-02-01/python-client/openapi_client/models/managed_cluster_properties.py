...
class ManagedClusterProperties(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["aadProfile", "addonProfiles", "agentPoolProfiles", "apiServerAuthorizedIPRanges", "dnsPrefix", "enablePodSecurityPolicy", "enableRBAC", "fqdn", "kubernetesVersion", "linuxProfile", "networkProfile", "nodeResourceGroup", "provisioningState", "servicePrincipalProfile"]
