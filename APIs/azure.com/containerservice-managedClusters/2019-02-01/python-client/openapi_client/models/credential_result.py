...
class CredentialResult(BaseModel):
    ...
    value: Optional[Union[Annotated[bytes, Field(strict=True)], Annotated[str, Field(strict=True)]]] = Field(default=None, description="Base64-encoded Kubernetes configuration file.")
