...
class ManagedClusterProperties(BaseModel):
    ...
    api_server_authorized_ip_ranges: Optional[List[StrictStr]] = Field(default=None, description="(PREVIEW) Authorized IP Ranges to kubernetes API server.", alias="apiServerAuthorizedIPRanges")
    ...
    __properties: ClassVar[List[str]] = ["aadProfile", "addonProfiles", "agentPoolProfiles", "apiServerAuthorizedIPRanges", "dnsPrefix", "enablePodSecurityPolicy", "enableRBAC", "fqdn", "kubernetesVersion", "linuxProfile", "maxAgentPools", "networkProfile", "nodeResourceGroup", "provisioningState", "servicePrincipalProfile", "windowsProfile"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "apiServerAuthorizedIPRanges": obj.get("apiServerAuthorizedIPRanges"),
