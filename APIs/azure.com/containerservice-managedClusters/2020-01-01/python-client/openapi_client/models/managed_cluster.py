...
class ManagedCluster(BaseModel):
    ...
    properties: Optional[ManagedClusterProperties] = None
    __properties: ClassVar[List[str]] = ["id", "location", "name", "tags", "type", "identity", "properties"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "tags": obj.get("tags"),
            "type": obj.get("type"),
            "identity": ManagedClusterIdentity.from_dict(obj["identity"]) if obj.get("identity") is not None else None,
            "properties": ManagedClusterProperties.from_dict(obj["properties"]) if obj.get("properties") is not None else None
        })
        return _obj
