...
------------ | ------------- | ------------- | -------------
**client_id** | **str** | The client id of the user assigned identity. | [optional] 
**object_id** | **str** | The object id of the user assigned identity. | [optional] 
**resource_id** | **str** | The resource id of the user assigned identity. | [optional] 
