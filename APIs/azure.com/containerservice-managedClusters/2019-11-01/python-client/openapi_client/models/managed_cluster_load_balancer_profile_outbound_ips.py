...
class ManagedClusterLoadBalancerProfileOutboundIPs(BaseModel):
    """
    Desired outbound IP resources for the cluster load balancer.
    """ # noqa: E501
    public_ips: Optional[List[ResourceReference]] = Field(default=None, description="A list of public IP resources.", alias="publicIPs")
    __properties: ClassVar[List[str]] = ["publicIPs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "publicIPs": [ResourceReference.from_dict(_item) for _item in obj["publicIPs"]] if obj.get("publicIPs") is not None else None
        })
        return _obj
