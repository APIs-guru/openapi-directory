...
class ManagedClusterProperties(BaseModel):
    ...
    identity_profile: Optional[Dict[str, Any]] = Field(default=None, description="Identities associated with the cluster.", alias="identityProfile")
    ...
    __properties: ClassVar[List[str]] = ["aadProfile", "addonProfiles", "agentPoolProfiles", "apiServerAccessProfile", "dnsPrefix", "enablePodSecurityPolicy", "enableRBAC", "fqdn", "identityProfile", "kubernetesVersion", "linuxProfile", "maxAgentPools", "networkProfile", "nodeResourceGroup", "privateFQDN", "provisioningState", "servicePrincipalProfile", "windowsProfile"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fqdn": obj.get("fqdn"),
            "identityProfile": obj.get("identityProfile"),
