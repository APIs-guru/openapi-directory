...
class ContainerServiceSshConfiguration(BaseModel):
    """
    SSH configuration for Linux-based VMs running on Azure.
    """ # noqa: E501
    public_keys: List[ContainerServiceSshPublicKey] = Field(description="The list of SSH public keys used to authenticate with Linux-based VMs. Only expect one key specified.", alias="publicKeys")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "publicKeys": [ContainerServiceSshPublicKey.from_dict(_item) for _item in obj["publicKeys"]] if obj.get("publicKeys") is not None else None
        })
        return _obj
