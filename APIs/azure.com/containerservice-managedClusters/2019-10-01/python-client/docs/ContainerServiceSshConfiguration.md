...
------------ | ------------- | ------------- | -------------
**public_keys** | [**List[ContainerServiceSshPublicKey]**](ContainerServiceSshPublicKey.md) | The list of SSH public keys used to authenticate with Linux-based VMs. Only expect one key specified. | 
