...
class ManagedClusterProperties(BaseModel):
    ...
    private_fqdn: Optional[StrictStr] = Field(default=None, description="FQDN of private cluster.", alias="privateFQDN")
    ...
    __properties: ClassVar[List[str]] = ["aadProfile", "addonProfiles", "agentPoolProfiles", "apiServerAccessProfile", "dnsPrefix", "enablePodSecurityPolicy", "enableRBAC", "fqdn", "kubernetesVersion", "linuxProfile", "maxAgentPools", "networkProfile", "nodeResourceGroup", "privateFQDN", "provisioningState", "servicePrincipalProfile", "windowsProfile"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "privateFQDN": obj.get("privateFQDN"),
