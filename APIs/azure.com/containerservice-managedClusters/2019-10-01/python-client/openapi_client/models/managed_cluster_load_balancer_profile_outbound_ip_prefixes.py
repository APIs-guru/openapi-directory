...
class ManagedClusterLoadBalancerProfileOutboundIPPrefixes(BaseModel):
    """
    Desired outbound IP Prefix resources for the cluster load balancer.
    """ # noqa: E501
    public_ip_prefixes: Optional[List[ResourceReference]] = Field(default=None, description="A list of public IP prefix resources.", alias="publicIPPrefixes")
    __properties: ClassVar[List[str]] = ["publicIPPrefixes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "publicIPPrefixes": [ResourceReference.from_dict(_item) for _item in obj["publicIPPrefixes"]] if obj.get("publicIPPrefixes") is not None else None
        })
        return _obj
