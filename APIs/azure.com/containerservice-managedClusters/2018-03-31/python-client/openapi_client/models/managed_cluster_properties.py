...
class ManagedClusterProperties(BaseModel):
    ...
    agent_pool_profiles: Optional[List[ManagedClusterAgentPoolProfile]] = Field(default=None, description="Properties of the agent pool. Currently only one agent pool can exist.", alias="agentPoolProfiles")
    ...
    __properties: ClassVar[List[str]] = ["aadProfile", "addonProfiles", "agentPoolProfiles", "dnsPrefix", "enableRBAC", "fqdn", "kubernetesVersion", "linuxProfile", "networkProfile", "nodeResourceGroup", "provisioningState", "servicePrincipalProfile"]
