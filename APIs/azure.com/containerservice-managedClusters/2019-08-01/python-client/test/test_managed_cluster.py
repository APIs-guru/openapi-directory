    ...
    def make_instance(self, include_optional) -> ManagedCluster:
        ...
        if include_optional:
            return ManagedCluster(
                ...
                type = '',
                identity = openapi_client.models.managed_cluster_identity.ManagedClusterIdentity(
                    principal_id = '', 
                    tenant_id = '', 
                    type = 'SystemAssigned', ),
                properties = openapi_client.models.managed_cluster_properties.ManagedClusterProperties(
                    ...
                    api_server_access_profile = openapi_client.models.managed_cluster_api_server_access_profile.ManagedClusterAPIServerAccessProfile(
