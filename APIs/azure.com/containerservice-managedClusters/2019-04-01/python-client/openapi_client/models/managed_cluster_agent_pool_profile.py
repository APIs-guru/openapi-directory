...
class ManagedClusterAgentPoolProfile(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["availabilityZones", "count", "enableAutoScaling", "maxCount", "maxPods", "minCount", "orchestratorVersion", "osDiskSizeGB", "osType", "provisioningState", "type", "vmSize", "vnetSubnetID", "name"]
