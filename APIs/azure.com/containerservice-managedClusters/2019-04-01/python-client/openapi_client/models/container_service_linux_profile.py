...
class ContainerServiceLinuxProfile(BaseModel):
    """
    Profile for Linux VMs in the container service cluster.
    """ # noqa: E501
    admin_username: Annotated[str, Field(strict=True)] = Field(description="The administrator username to use for Linux VMs.", alias="adminUsername")
    ssh: ContainerServiceSshConfiguration
    __properties: ClassVar[List[str]] = ["adminUsername", "ssh"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ssh": ContainerServiceSshConfiguration.from_dict(obj["ssh"]) if obj.get("ssh") is not None else None
        })
        return _obj
