...
class ManagedClusterPoolUpgradeProfile(BaseModel):
    ...
    upgrades: Optional[List[ManagedClusterPoolUpgradeProfileUpgradesInner]] = Field(default=None, description="List of orchestrator types and versions available for upgrade.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "upgrades": [ManagedClusterPoolUpgradeProfileUpgradesInner.from_dict(_item) for _item in obj["upgrades"]] if obj.get("upgrades") is not None else None
        })
        return _obj
