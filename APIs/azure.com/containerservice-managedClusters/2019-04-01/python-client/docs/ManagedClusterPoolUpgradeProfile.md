...
**upgrades** | [**List[ManagedClusterPoolUpgradeProfileUpgradesInner]**](ManagedClusterPoolUpgradeProfileUpgradesInner.md) | List of orchestrator types and versions available for upgrade. | [optional] 
