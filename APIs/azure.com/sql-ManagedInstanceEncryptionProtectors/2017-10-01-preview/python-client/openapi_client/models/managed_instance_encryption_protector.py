...
class ManagedInstanceEncryptionProtector(BaseModel):
    """
    The managed instance encryption protector.
    """ # noqa: E501
    kind: Optional[StrictStr] = Field(default=None, description="Kind of encryption protector. This is metadata used for the Azure portal experience.")
    properties: Optional[ManagedInstanceEncryptionProtectorProperties] = None
