...
class SpatialAnchorsAccountsGetKeys200Response(BaseModel):
    """
    Developer Keys of account
    """ # noqa: E501
    primary_key: Optional[StrictStr] = Field(default=None, description="value of primary key.", alias="primaryKey")
    secondary_key: Optional[StrictStr] = Field(default=None, description="value of secondary key.", alias="secondaryKey")
