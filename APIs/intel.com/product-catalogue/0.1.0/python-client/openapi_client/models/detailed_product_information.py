...
class DetailedProductInformation(BaseModel):
    """
    DetailedProductInformation
    """ # noqa: E501
    result: Optional[List[DetailedProductInformationResultInner]] = Field(default=None, description="Product info for a locale.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": [DetailedProductInformationResultInner.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
