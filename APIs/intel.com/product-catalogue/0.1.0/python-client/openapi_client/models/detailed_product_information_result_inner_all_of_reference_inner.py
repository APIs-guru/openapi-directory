...
class DetailedProductInformationResultInnerAllOfReferenceInner(BaseModel):
    """
    DetailedProductInformationResultInnerAllOfReferenceInner
    """ # noqa: E501
    category_id: Optional[List[StrictStr]] = Field(default=None, description="Array of category id's to which the product belong to.")
    reference_id: Optional[StrictStr] = None
    reference_type: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["category_id", "reference_id", "reference_type"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DetailedProductInformationResultInnerAllOfReferenceInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DetailedProductInformationResultInnerAllOfReferenceInner from a dict"""
        if obj is None:
            return None
