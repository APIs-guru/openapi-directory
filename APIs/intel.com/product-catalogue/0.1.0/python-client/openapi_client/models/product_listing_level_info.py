...
class ProductListingLevelInfo(BaseModel):
    """
    ProductListingLevelInfo
    """ # noqa: E501
    page_no: StrictStr
    per_page: StrictInt
    result: List[ProductListingLevelInfoResultInner] = Field(description="Multiple objects with product data.")
    status: StrictStr
    total_count: StrictInt
    __properties: ClassVar[List[str]] = ["page_no", "per_page", "result", "status", "total_count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "result": [ProductListingLevelInfoResultInner.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
