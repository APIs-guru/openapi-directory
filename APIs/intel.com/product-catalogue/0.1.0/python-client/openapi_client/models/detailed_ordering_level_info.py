...
class DetailedOrderingLevelInfo(BaseModel):
    """
    DetailedOrderingLevelInfo
    """ # noqa: E501
    result: Optional[List[DetailedOrderingLevelInfoResultInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "result": [DetailedOrderingLevelInfoResultInner.from_dict(_item) for _item in obj["result"]] if obj.get("result") is not None else None,
