...
class TestDetailedProductInformation(unittest.TestCase):
    """DetailedProductInformation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DetailedProductInformation:
        """Test DetailedProductInformation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `DetailedProductInformation`
        """
        model = DetailedProductInformation()
        if include_optional:
            return DetailedProductInformation(
                result = [
                    openapi_client.models.detailed_product_information_result_inner.Detailed_product_information_result_inner()
                    ],
                status = 'success',
                total_count = 10
            )
    ...
    def testDetailedProductInformation(self):
        """Test DetailedProductInformation"""
