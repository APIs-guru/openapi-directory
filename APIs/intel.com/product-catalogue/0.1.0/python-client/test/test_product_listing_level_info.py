...
class TestProductListingLevelInfo(unittest.TestCase):
    """ProductListingLevelInfo unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ProductListingLevelInfo:
        """Test ProductListingLevelInfo
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ProductListingLevelInfo`
        """
        model = ProductListingLevelInfo()
        if include_optional:
            return ProductListingLevelInfo(
                page_no = '1',
                per_page = 10,
                result = [
                    openapi_client.models.product_listing_level_info_result_inner.Product_listing_level_info_result_inner(
    ...
    def testProductListingLevelInfo(self):
        """Test ProductListingLevelInfo"""
