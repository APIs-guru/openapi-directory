...
------------- | ------------- | -------------
[**get_a_batch_of_consumer_transaction_classification_results_1**](BatchApi.md#get_a_batch_of_consumer_transaction_classification_results_1) | **GET** /classifier/consumer/batch/{id} | Get a batch of consumer transaction classification results.


# **get_a_batch_of_consumer_transaction_classification_results_1**
> GetABatchOfConsumerTransactionClassificationResults200Response get_a_batch_of_consumer_transaction_classification_results_1(id)
