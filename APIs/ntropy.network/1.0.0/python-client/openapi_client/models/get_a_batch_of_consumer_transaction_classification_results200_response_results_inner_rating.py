...
class GetABatchOfConsumerTransactionClassificationResults200ResponseResultsInnerRating(BaseModel):
    """
    GetABatchOfConsumerTransactionClassificationResults200ResponseResultsInnerRating
    """ # noqa: E501
    reviews: Optional[Union[StrictFloat, StrictInt]] = None
    value: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["reviews", "value"]
