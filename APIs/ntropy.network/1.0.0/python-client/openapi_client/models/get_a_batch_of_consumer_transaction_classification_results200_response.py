...
class GetABatchOfConsumerTransactionClassificationResults200Response(BaseModel):
    """
    GetABatchOfConsumerTransactionClassificationResults200Response
    """ # noqa: E501
    id: Optional[StrictStr] = None
    progress: Optional[Union[StrictFloat, StrictInt]] = None
    results: Optional[List[GetABatchOfConsumerTransactionClassificationResults200ResponseResultsInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "results": [GetABatchOfConsumerTransactionClassificationResults200ResponseResultsInner.from_dict(_item) for _item in obj["results"]] if obj.get("results") is not None else None,
