...
class OBWriteDomesticStandingOrder3DataInitiationCreditorAccount(BaseModel):
    """
    ...
    name: Annotated[str, Field(min_length=1, strict=True, max_length=350)] = Field(description="The account name is the name or names of the account owner(s) represented at an account level. Note, the account name is not the product name or the nickname of the account. OB: ASPSPs may carry out name validation for Confirmation of Payee, but it is not mandatory.", alias="Name")
