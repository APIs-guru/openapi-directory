...
class OBWriteInternationalStandingOrderResponse7Data(BaseModel):
    """
    ...
    initiation: OBWriteInternationalStandingOrderConsentResponse7DataInitiation = Field(alias="Initiation")
    international_standing_order_id: Annotated[str, Field(min_length=1, strict=True, max_length=40)] = Field(description="OB: Unique identification as assigned by the ASPSP to uniquely identify the international standing order resource.", alias="InternationalStandingOrderId")
    multi_authorisation: Optional[OBWriteDomesticResponse5DataMultiAuthorisation] = Field(default=None, alias="MultiAuthorisation")
    refund: Optional[OBWriteInternationalStandingOrderResponse7DataRefund] = Field(default=None, alias="Refund")
    status: StrictStr = Field(description="Specifies the status of resource in code form.", alias="Status")
    ...
    __properties: ClassVar[List[str]] = ["Charges", "ConsentId", "CreationDateTime", "Debtor", "Initiation", "InternationalStandingOrderId", "MultiAuthorisation", "Refund", "Status", "StatusUpdateDateTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Initiation": OBWriteInternationalStandingOrderConsentResponse7DataInitiation.from_dict(obj["Initiation"]) if obj.get("Initiation") is not None else None,
            "InternationalStandingOrderId": obj.get("InternationalStandingOrderId"),
            ...
            "Refund": OBWriteInternationalStandingOrderResponse7DataRefund.from_dict(obj["Refund"]) if obj.get("Refund") is not None else None,
