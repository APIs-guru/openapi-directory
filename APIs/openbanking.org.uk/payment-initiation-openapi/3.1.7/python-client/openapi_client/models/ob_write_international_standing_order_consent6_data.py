...
class OBWriteInternationalStandingOrderConsent6Data(BaseModel):
    """
    ...
    initiation: OBWriteInternationalStandingOrder4DataInitiation = Field(alias="Initiation")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Initiation": OBWriteInternationalStandingOrder4DataInitiation.from_dict(obj["Initiation"]) if obj.get("Initiation") is not None else None,
