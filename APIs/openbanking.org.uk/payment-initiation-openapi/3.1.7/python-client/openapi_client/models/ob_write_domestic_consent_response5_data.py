...
class OBWriteDomesticConsentResponse5Data(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["Authorisation", "Charges", "ConsentId", "CreationDateTime", "CutOffDateTime", "Debtor", "ExpectedExecutionDateTime", "ExpectedSettlementDateTime", "Initiation", "ReadRefundAccount", "SCASupportData", "Status", "StatusUpdateDateTime"]
