...
class OBWriteInternational3DataInitiation(BaseModel):
    """
    ...
    end_to_end_identification: Annotated[str, Field(min_length=1, strict=True, max_length=35)] = Field(description="Unique identification assigned by the initiating party to unambiguously identify the transaction. This identification is passed on, unchanged, throughout the entire end-to-end chain. Usage: The end-to-end identification can be used for reconciliation or to link tasks relating to the transaction. It can be included in several messages related to the transaction. OB: The Faster Payments Scheme can only access 31 characters for the EndToEndIdentification field.", alias="EndToEndIdentification")
    ...
    __properties: ClassVar[List[str]] = ["ChargeBearer", "Creditor", "CreditorAccount", "CreditorAgent", "CurrencyOfTransfer", "DebtorAccount", "DestinationCountryCode", "EndToEndIdentification", "ExchangeRateInformation", "ExtendedPurpose", "InstructedAmount", "InstructionIdentification", "InstructionPriority", "LocalInstrument", "Purpose", "RemittanceInformation", "SupplementaryData"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OBWriteInternational3DataInitiation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OBWriteInternational3DataInitiation from a dict"""
        if obj is None:
            return None
