...
class OBWriteInternationalResponse5DataRefund(BaseModel):
    """
    ...
    creditor: Optional[OBWriteInternationalResponse5DataRefundCreditor] = Field(default=None, alias="Creditor")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Creditor": OBWriteInternationalResponse5DataRefundCreditor.from_dict(obj["Creditor"]) if obj.get("Creditor") is not None else None
        })
        return _obj
