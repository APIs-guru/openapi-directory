...
class OBWriteDomesticConsentResponse5(BaseModel):
    ...
    """ # noqa: E501
    data: OBWriteDomesticConsentResponse5Data = Field(alias="Data")
    ...
    __properties: ClassVar[List[str]] = ["Data", "Links", "Meta", "Risk"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Data": OBWriteDomesticConsentResponse5Data.from_dict(obj["Data"]) if obj.get("Data") is not None else None,
