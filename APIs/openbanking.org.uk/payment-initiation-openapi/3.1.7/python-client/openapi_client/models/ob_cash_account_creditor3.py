...
class OBCashAccountCreditor3(BaseModel):
    ...
    """ # noqa: E501
    identification: Annotated[str, Field(strict=True, max_length=256)] = Field(description="Identification assigned by an institution to identify an account. This identification is known by the account owner.", alias="Identification")
    name: StrictStr = Field(description="Name of the account, as assigned by the account servicing institution.  Usage The account name is the name or names of the account owner(s) represented at an account level. The account name is not the product name or the nickname of the account.", alias="Name")
