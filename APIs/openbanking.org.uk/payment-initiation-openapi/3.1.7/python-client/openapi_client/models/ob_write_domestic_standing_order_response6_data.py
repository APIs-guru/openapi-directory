...
class OBWriteDomesticStandingOrderResponse6Data(BaseModel):
    """
    ...
    domestic_standing_order_id: Annotated[str, Field(min_length=1, strict=True, max_length=40)] = Field(description="OB: Unique identification as assigned by the ASPSP to uniquely identify the domestic standing order resource.", alias="DomesticStandingOrderId")
    initiation: OBWriteDomesticStandingOrderConsentResponse6DataInitiation = Field(alias="Initiation")
    multi_authorisation: Optional[OBWriteDomesticResponse5DataMultiAuthorisation] = Field(default=None, alias="MultiAuthorisation")
    refund: Optional[OBWriteDomesticResponse5DataRefund] = Field(default=None, alias="Refund")
    ...
    __properties: ClassVar[List[str]] = ["Charges", "ConsentId", "CreationDateTime", "Debtor", "DomesticStandingOrderId", "Initiation", "MultiAuthorisation", "Refund", "Status", "StatusUpdateDateTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "DomesticStandingOrderId": obj.get("DomesticStandingOrderId"),
            "Initiation": OBWriteDomesticStandingOrderConsentResponse6DataInitiation.from_dict(obj["Initiation"]) if obj.get("Initiation") is not None else None,
            ...
            "Refund": OBWriteDomesticResponse5DataRefund.from_dict(obj["Refund"]) if obj.get("Refund") is not None else None,
