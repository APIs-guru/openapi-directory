...
class OBWriteDomesticScheduledResponse5Data(BaseModel):
    """
    ...
    domestic_scheduled_payment_id: Annotated[str, Field(min_length=1, strict=True, max_length=40)] = Field(description="OB: Unique identification as assigned by the ASPSP to uniquely identify the domestic schedule payment resource.", alias="DomesticScheduledPaymentId")
    ...
    __properties: ClassVar[List[str]] = ["Charges", "ConsentId", "CreationDateTime", "Debtor", "DomesticScheduledPaymentId", "ExpectedExecutionDateTime", "ExpectedSettlementDateTime", "Initiation", "MultiAuthorisation", "Refund", "Status", "StatusUpdateDateTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "DomesticScheduledPaymentId": obj.get("DomesticScheduledPaymentId"),
