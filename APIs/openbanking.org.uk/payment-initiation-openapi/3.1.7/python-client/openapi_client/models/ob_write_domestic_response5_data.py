...
class OBWriteDomesticResponse5Data(BaseModel):
    """
    ...
    domestic_payment_id: Annotated[str, Field(min_length=1, strict=True, max_length=40)] = Field(description="OB: Unique identification as assigned by the ASPSP to uniquely identify the domestic payment resource.", alias="DomesticPaymentId")
    ...
    __properties: ClassVar[List[str]] = ["Charges", "ConsentId", "CreationDateTime", "Debtor", "DomesticPaymentId", "ExpectedExecutionDateTime", "ExpectedSettlementDateTime", "Initiation", "MultiAuthorisation", "Refund", "Status", "StatusUpdateDateTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "DomesticPaymentId": obj.get("DomesticPaymentId"),
