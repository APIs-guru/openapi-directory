...
class OBWriteDomesticStandingOrder3Data(BaseModel):
    """
    ...
    initiation: OBWriteDomesticStandingOrder3DataInitiation = Field(alias="Initiation")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Initiation": OBWriteDomesticStandingOrder3DataInitiation.from_dict(obj["Initiation"]) if obj.get("Initiation") is not None else None
        })
        return _obj
