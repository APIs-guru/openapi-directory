...
class OBWriteInternational3DataInitiationCreditor(BaseModel):
    """
    Party to which an amount of money is due.
    """ # noqa: E501
    name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=140)]] = Field(default=None, description="Name by which a party is known and which is usually used to identify that party.", alias="Name")
