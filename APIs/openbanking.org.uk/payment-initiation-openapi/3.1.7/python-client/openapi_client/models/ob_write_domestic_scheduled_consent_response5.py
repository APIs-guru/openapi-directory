...
class OBWriteDomesticScheduledConsentResponse5(BaseModel):
    ...
    """ # noqa: E501
    data: OBWriteDomesticScheduledConsentResponse5Data = Field(alias="Data")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Data": OBWriteDomesticScheduledConsentResponse5Data.from_dict(obj["Data"]) if obj.get("Data") is not None else None,
