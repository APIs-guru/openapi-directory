...
class OBWriteInternationalStandingOrder4DataInitiation(BaseModel):
    """
    ...
    debtor_account: Optional[OBWriteDomesticStandingOrder3DataInitiationDebtorAccount] = Field(default=None, alias="DebtorAccount")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OBWriteInternationalStandingOrder4DataInitiation from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OBWriteInternationalStandingOrder4DataInitiation from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "DebtorAccount": OBWriteDomesticStandingOrder3DataInitiationDebtorAccount.from_dict(obj["DebtorAccount"]) if obj.get("DebtorAccount") is not None else None,
