...
class OBWriteDomesticScheduledResponse5(BaseModel):
    ...
    """ # noqa: E501
    data: OBWriteDomesticScheduledResponse5Data = Field(alias="Data")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OBWriteDomesticScheduledResponse5 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OBWriteDomesticScheduledResponse5 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "Data": OBWriteDomesticScheduledResponse5Data.from_dict(obj["Data"]) if obj.get("Data") is not None else None,
