...
class OBWriteDomesticStandingOrderConsentResponse6Data(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["Authorisation", "Charges", "ConsentId", "CreationDateTime", "CutOffDateTime", "Debtor", "Initiation", "Permission", "ReadRefundAccount", "SCASupportData", "Status", "StatusUpdateDateTime"]
