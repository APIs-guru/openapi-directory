...
class OBWriteDomesticStandingOrderResponse6(BaseModel):
    ...
    """ # noqa: E501
    data: OBWriteDomesticStandingOrderResponse6Data = Field(alias="Data")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OBWriteDomesticStandingOrderResponse6 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OBWriteDomesticStandingOrderResponse6 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "Data": OBWriteDomesticStandingOrderResponse6Data.from_dict(obj["Data"]) if obj.get("Data") is not None else None,
