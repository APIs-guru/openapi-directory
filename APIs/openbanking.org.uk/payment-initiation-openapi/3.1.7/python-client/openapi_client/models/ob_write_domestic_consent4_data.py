...
class OBWriteDomesticConsent4Data(BaseModel):
    """
    ...
    initiation: OBWriteDomestic2DataInitiation = Field(alias="Initiation")
    ...
    __properties: ClassVar[List[str]] = ["Authorisation", "Initiation", "ReadRefundAccount", "SCASupportData"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Initiation": OBWriteDomestic2DataInitiation.from_dict(obj["Initiation"]) if obj.get("Initiation") is not None else None,
