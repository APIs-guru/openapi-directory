...
class OBRisk1DeliveryAddress(BaseModel):
    """
    Information that locates and identifies a specific address, as defined by postal services or in free format text.
    """ # noqa: E501
    address_line: Optional[Annotated[List[Annotated[str, Field(min_length=1, strict=True, max_length=70)]], Field(min_length=0, max_length=2)]] = Field(default=None, alias="AddressLine")
    ...
    town_name: Annotated[str, Field(min_length=1, strict=True, max_length=35)] = Field(description="Name of a built-up area, with defined boundaries, and a local government.", alias="TownName")
    __properties: ClassVar[List[str]] = ["AddressLine", "BuildingNumber", "Country", "CountrySubDivision", "PostCode", "StreetName", "TownName"]
