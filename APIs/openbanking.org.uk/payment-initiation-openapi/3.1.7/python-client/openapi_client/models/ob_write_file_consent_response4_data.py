...
class OBWriteFileConsentResponse4Data(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["Authorisation", "Charges", "ConsentId", "CreationDateTime", "CutOffDateTime", "Debtor", "Initiation", "SCASupportData", "Status", "StatusUpdateDateTime"]

    @field_validator('status')
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Authorised', 'AwaitingAuthorisation', 'AwaitingUpload', 'Consumed', 'Rejected']):
            raise ValueError("must be one of enum values ('Authorised', 'AwaitingAuthorisation', 'AwaitingUpload', 'Consumed', 'Rejected')")
        return value
