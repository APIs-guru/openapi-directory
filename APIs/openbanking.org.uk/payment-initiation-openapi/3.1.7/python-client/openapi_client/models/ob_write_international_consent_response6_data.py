...
class OBWriteInternationalConsentResponse6Data(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["Authorisation", "Charges", "ConsentId", "CreationDateTime", "CutOffDateTime", "Debtor", "ExchangeRateInformation", "ExpectedExecutionDateTime", "ExpectedSettlementDateTime", "Initiation", "ReadRefundAccount", "SCASupportData", "Status", "StatusUpdateDateTime"]
