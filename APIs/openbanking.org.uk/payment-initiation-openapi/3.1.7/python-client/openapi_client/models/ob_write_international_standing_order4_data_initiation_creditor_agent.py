...
class OBWriteInternationalStandingOrder4DataInitiationCreditorAgent(BaseModel):
    """
    Party that manages the account on behalf of the account owner, that is manages the registration and booking of entries on the account, calculates balances on the account and provides information about the account. This is the servicer of the beneficiary account.
    """ # noqa: E501
    identification: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=35)]] = Field(default=None, description="Unique and unambiguous identification of the servicing institution.", alias="Identification")
