...
class OBWriteInternationalScheduledConsentResponse6Data(BaseModel):
    """
    ...
    initiation: OBWriteInternationalScheduledConsentResponse6DataInitiation = Field(alias="Initiation")
    ...
    __properties: ClassVar[List[str]] = ["Authorisation", "Charges", "ConsentId", "CreationDateTime", "CutOffDateTime", "Debtor", "ExchangeRateInformation", "ExpectedExecutionDateTime", "ExpectedSettlementDateTime", "Initiation", "Permission", "ReadRefundAccount", "SCASupportData", "Status", "StatusUpdateDateTime"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Initiation": OBWriteInternationalScheduledConsentResponse6DataInitiation.from_dict(obj["Initiation"]) if obj.get("Initiation") is not None else None,
