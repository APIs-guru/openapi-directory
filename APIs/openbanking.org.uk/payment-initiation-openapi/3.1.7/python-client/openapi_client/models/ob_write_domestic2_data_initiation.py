...
class OBWriteDomestic2DataInitiation(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["CreditorAccount", "CreditorPostalAddress", "DebtorAccount", "EndToEndIdentification", "InstructedAmount", "InstructionIdentification", "LocalInstrument", "RemittanceInformation", "SupplementaryData"]
