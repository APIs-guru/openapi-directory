...
class OBWriteInternationalScheduledResponse6Data(BaseModel):
    """
    ...
    exchange_rate_information: Optional[OBWriteInternationalConsentResponse6DataExchangeRateInformation] = Field(default=None, alias="ExchangeRateInformation")
    ...
    international_scheduled_payment_id: Annotated[str, Field(min_length=1, strict=True, max_length=40)] = Field(description="OB: Unique identification as assigned by the ASPSP to uniquely identify the international scheduled payment resource.", alias="InternationalScheduledPaymentId")
    multi_authorisation: Optional[OBWriteDomesticResponse5DataMultiAuthorisation] = Field(default=None, alias="MultiAuthorisation")
    refund: Optional[OBWriteInternationalResponse5DataRefund] = Field(default=None, alias="Refund")
    ...
    __properties: ClassVar[List[str]] = ["Charges", "ConsentId", "CreationDateTime", "Debtor", "ExchangeRateInformation", "ExpectedExecutionDateTime", "ExpectedSettlementDateTime", "Initiation", "InternationalScheduledPaymentId", "MultiAuthorisation", "Refund", "Status", "StatusUpdateDateTime"]

    @field_validator('status')
    def status_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Cancelled', 'InitiationCompleted', 'InitiationFailed', 'InitiationPending']):
            raise ValueError("must be one of enum values ('Cancelled', 'InitiationCompleted', 'InitiationFailed', 'InitiationPending')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "ExchangeRateInformation": OBWriteInternationalConsentResponse6DataExchangeRateInformation.from_dict(obj["ExchangeRateInformation"]) if obj.get("ExchangeRateInformation") is not None else None,
            ...
            "InternationalScheduledPaymentId": obj.get("InternationalScheduledPaymentId"),
            ...
            "Refund": OBWriteInternationalResponse5DataRefund.from_dict(obj["Refund"]) if obj.get("Refund") is not None else None,
