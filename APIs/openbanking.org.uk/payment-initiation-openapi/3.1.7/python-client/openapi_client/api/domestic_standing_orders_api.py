...
class DomesticStandingOrdersApi:
    ...
    def create_domestic_standing_order_consents(
        ...
        ob_write_domestic_standing_order_consent5: Annotated[OBWriteDomesticStandingOrderConsent5, Field(description="Default")],
        ...
        :param ob_write_domestic_standing_order_consent5: Default (required)
        :type ob_write_domestic_standing_order_consent5: OBWriteDomesticStandingOrderConsent5
        ...
        _param = self._create_domestic_standing_order_consents_serialize(
            authorization=authorization,
            x_idempotency_key=x_idempotency_key,
            x_jws_signature=x_jws_signature,
            ob_write_domestic_standing_order_consent5=ob_write_domestic_standing_order_consent5,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "OBWriteDomesticStandingOrderConsentResponse6",
    ...
    @validate_call
    def create_domestic_standing_order_consents_with_http_info(
        self,
        authorization: Annotated[StrictStr, Field(description="An Authorisation Token as per https://tools.ietf.org/html/rfc6750")],
        x_idempotency_key: Annotated[str, Field(strict=True, max_length=40, description="Every request will be processed only once per x-idempotency-key.  The Idempotency Key will be valid for 24 hours. ")],
        x_jws_signature: Annotated[StrictStr, Field(description="A detached JWS signature of the body of the payload.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OBWriteDomesticStandingOrderConsentResponse6]:
        """Create Domestic Standing Order Consents
    ...
    @validate_call
    def create_domestic_standing_order_consents_without_preload_content(
        self,
        authorization: Annotated[StrictStr, Field(description="An Authorisation Token as per https://tools.ietf.org/html/rfc6750")],
        x_idempotency_key: Annotated[str, Field(strict=True, max_length=40, description="Every request will be processed only once per x-idempotency-key.  The Idempotency Key will be valid for 24 hours. ")],
        x_jws_signature: Annotated[StrictStr, Field(description="A detached JWS signature of the body of the payload.")],
    ...
    def _create_domestic_standing_order_consents_serialize(
        self,
        authorization,
        x_idempotency_key,
        x_jws_signature,
        ob_write_domestic_standing_order_consent5,
        x_fapi_auth_date,
        ...
        if ob_write_domestic_standing_order_consent5 is not None:
            _body_params = ob_write_domestic_standing_order_consent5
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/domestic-standing-order-consents',
    ...
    def create_domestic_standing_orders(
        ...
        x_idempotency_key: Annotated[str, Field(strict=True, max_length=40, description="Every request will be processed only once per x-idempotency-key.  The Idempotency Key will be valid for 24 hours. ")],
        x_jws_signature: Annotated[StrictStr, Field(description="A detached JWS signature of the body of the payload.")],
        ob_write_domestic_standing_order3: Annotated[OBWriteDomesticStandingOrder3, Field(description="Default")],
        x_fapi_auth_date: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
        x_fapi_customer_ip_address: Annotated[Optional[StrictStr], Field(description="The PSU's IP address if the PSU is currently logged in with the TPP.")] = None,
        x_fapi_interaction_id: Annotated[Optional[StrictStr], Field(description="An RFC4122 UID used as a correlation id.")] = None,
        x_customer_user_agent: Annotated[Optional[StrictStr], Field(description="Indicates the user-agent that the PSU is using.")] = None,
        ...
        :param x_jws_signature: A detached JWS signature of the body of the payload. (required)
        :type x_jws_signature: str
        :param ob_write_domestic_standing_order3: Default (required)
        :type ob_write_domestic_standing_order3: OBWriteDomesticStandingOrder3
        :param x_fapi_auth_date: The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC
        :type x_fapi_auth_date: str
        :param x_fapi_customer_ip_address: The PSU's IP address if the PSU is currently logged in with the TPP.
        :type x_fapi_customer_ip_address: str
        ...
        _param = self._create_domestic_standing_orders_serialize(
            authorization=authorization,
            x_idempotency_key=x_idempotency_key,
            x_jws_signature=x_jws_signature,
            ob_write_domestic_standing_order3=ob_write_domestic_standing_order3,
            x_fapi_auth_date=x_fapi_auth_date,
            x_fapi_customer_ip_address=x_fapi_customer_ip_address,
            x_fapi_interaction_id=x_fapi_interaction_id,
            x_customer_user_agent=x_customer_user_agent,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '201': "OBWriteDomesticStandingOrderResponse6",
            '400': "OBErrorResponse1",
            '401': None,
            '403': "OBErrorResponse1",
            '404': None,
    ...
    @validate_call
    def create_domestic_standing_orders_with_http_info(
        self,
        authorization: Annotated[StrictStr, Field(description="An Authorisation Token as per https://tools.ietf.org/html/rfc6750")],
        x_idempotency_key: Annotated[str, Field(strict=True, max_length=40, description="Every request will be processed only once per x-idempotency-key.  The Idempotency Key will be valid for 24 hours. ")],
        x_jws_signature: Annotated[StrictStr, Field(description="A detached JWS signature of the body of the payload.")],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[OBWriteDomesticStandingOrderResponse6]:
        """Create Domestic Standing Orders
    ...
    @validate_call
    def create_domestic_standing_orders_without_preload_content(
        self,
        authorization: Annotated[StrictStr, Field(description="An Authorisation Token as per https://tools.ietf.org/html/rfc6750")],
        x_idempotency_key: Annotated[str, Field(strict=True, max_length=40, description="Every request will be processed only once per x-idempotency-key.  The Idempotency Key will be valid for 24 hours. ")],
        x_jws_signature: Annotated[StrictStr, Field(description="A detached JWS signature of the body of the payload.")],
    ...
    def _create_domestic_standing_orders_serialize(
        self,
        authorization,
        x_idempotency_key,
        x_jws_signature,
        ob_write_domestic_standing_order3,
        x_fapi_auth_date,
        x_fapi_customer_ip_address,
        x_fapi_interaction_id,
        x_customer_user_agent,
        ...
        # process the form parameters
        # process the body parameter
        if ob_write_domestic_standing_order3 is not None:
            _body_params = ob_write_domestic_standing_order3
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/domestic-standing-orders',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_domestic_standing_order_consents_consent_id(
        ...
        _param = self._get_domestic_standing_order_consents_consent_id_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OBWriteDomesticStandingOrderConsentResponse6",
            '400': "OBErrorResponse1",
            '401': None,
            '403': "OBErrorResponse1",
            '404': None,
    ...
    @validate_call
    def get_domestic_standing_order_consents_consent_id_with_http_info(
        self,
        consent_id: Annotated[StrictStr, Field(description="ConsentId")],
        authorization: Annotated[StrictStr, Field(description="An Authorisation Token as per https://tools.ietf.org/html/rfc6750")],
        x_fapi_auth_date: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
    ...
    @validate_call
    def get_domestic_standing_order_consents_consent_id_without_preload_content(
        self,
        consent_id: Annotated[StrictStr, Field(description="ConsentId")],
        authorization: Annotated[StrictStr, Field(description="An Authorisation Token as per https://tools.ietf.org/html/rfc6750")],
        x_fapi_auth_date: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
    ...
    def _get_domestic_standing_order_consents_consent_id_serialize(
        self,
        consent_id,
        authorization,
        x_fapi_auth_date,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/domestic-standing-order-consents/{ConsentId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_domestic_standing_orders_domestic_standing_order_id(
        ...
        _param = self._get_domestic_standing_orders_domestic_standing_order_id_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "OBWriteDomesticStandingOrderResponse6",
            '400': "OBErrorResponse1",
            '401': None,
            '403': "OBErrorResponse1",
            '404': None,
    ...
    @validate_call
    def get_domestic_standing_orders_domestic_standing_order_id_with_http_info(
        self,
        domestic_standing_order_id: Annotated[StrictStr, Field(description="DomesticStandingOrderId")],
        authorization: Annotated[StrictStr, Field(description="An Authorisation Token as per https://tools.ietf.org/html/rfc6750")],
        x_fapi_auth_date: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
    ...
    @validate_call
    def get_domestic_standing_orders_domestic_standing_order_id_without_preload_content(
        self,
        domestic_standing_order_id: Annotated[StrictStr, Field(description="DomesticStandingOrderId")],
        authorization: Annotated[StrictStr, Field(description="An Authorisation Token as per https://tools.ietf.org/html/rfc6750")],
        x_fapi_auth_date: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
    ...
    def _get_domestic_standing_orders_domestic_standing_order_id_serialize(
        self,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/domestic-standing-orders/{DomesticStandingOrderId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
