...
class TestOBWriteInternationalScheduled3DataInitiation(unittest.TestCase):
    """OBWriteInternationalScheduled3DataInitiation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OBWriteInternationalScheduled3DataInitiation:
        """Test OBWriteInternationalScheduled3DataInitiation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBWriteInternationalScheduled3DataInitiation`
        """
        model = OBWriteInternationalScheduled3DataInitiation()
        if include_optional:
    ...
    def testOBWriteInternationalScheduled3DataInitiation(self):
        """Test OBWriteInternationalScheduled3DataInitiation"""
