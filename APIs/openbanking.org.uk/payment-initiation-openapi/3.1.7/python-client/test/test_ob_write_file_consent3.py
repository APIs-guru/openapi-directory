...
class TestOBWriteFileConsent3(unittest.TestCase):
    """OBWriteFileConsent3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OBWriteFileConsent3:
        """Test OBWriteFileConsent3
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBWriteFileConsent3`
        """
        model = OBWriteFileConsent3()
        if include_optional:
            return OBWriteFileConsent3(
                data = openapi_client.models.ob_write_file_consent3_data.OBWriteFileConsent3_Data(
    ...
    def testOBWriteFileConsent3(self):
        """Test OBWriteFileConsent3"""
