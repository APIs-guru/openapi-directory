...
class TestOBWriteDomesticConsent4(unittest.TestCase):
    """OBWriteDomesticConsent4 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OBWriteDomesticConsent4:
        """Test OBWriteDomesticConsent4
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBWriteDomesticConsent4`
        """
        model = OBWriteDomesticConsent4()
        if include_optional:
            return OBWriteDomesticConsent4(
                data = openapi_client.models.ob_write_domestic_consent4_data.OBWriteDomesticConsent4_Data(
    ...
    def testOBWriteDomesticConsent4(self):
        """Test OBWriteDomesticConsent4"""
