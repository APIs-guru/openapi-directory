...
class TestOBWriteDomesticScheduled2(unittest.TestCase):
    """OBWriteDomesticScheduled2 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OBWriteDomesticScheduled2:
        """Test OBWriteDomesticScheduled2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBWriteDomesticScheduled2`
        """
        model = OBWriteDomesticScheduled2()
        if include_optional:
            return OBWriteDomesticScheduled2(
                data = openapi_client.models.ob_write_domestic_scheduled2_data.OBWriteDomesticScheduled2_Data(
                    consent_id = '0', 
    ...
    def testOBWriteDomesticScheduled2(self):
        """Test OBWriteDomesticScheduled2"""
