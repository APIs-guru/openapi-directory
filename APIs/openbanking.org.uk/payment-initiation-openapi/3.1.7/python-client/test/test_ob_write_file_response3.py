...
class TestOBWriteFileResponse3(unittest.TestCase):
    """OBWriteFileResponse3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OBWriteFileResponse3:
        """Test OBWriteFileResponse3
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBWriteFileResponse3`
        """
        model = OBWriteFileResponse3()
        if include_optional:
            return OBWriteFileResponse3(
                data = openapi_client.models.ob_write_file_response3_data.OBWriteFileResponse3_Data(
                    charges = [
    ...
    def testOBWriteFileResponse3(self):
        """Test OBWriteFileResponse3"""
