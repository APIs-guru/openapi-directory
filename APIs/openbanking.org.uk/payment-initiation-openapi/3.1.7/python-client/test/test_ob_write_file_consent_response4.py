...
class TestOBWriteFileConsentResponse4(unittest.TestCase):
    """OBWriteFileConsentResponse4 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OBWriteFileConsentResponse4:
        """Test OBWriteFileConsentResponse4
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBWriteFileConsentResponse4`
        """
        model = OBWriteFileConsentResponse4()
        if include_optional:
            return OBWriteFileConsentResponse4(
                data = openapi_client.models.ob_write_file_consent_response4_data.OBWriteFileConsentResponse4_Data(
    ...
    def testOBWriteFileConsentResponse4(self):
        """Test OBWriteFileConsentResponse4"""
