...
class TestOBWriteFile2Data(unittest.TestCase):
    """OBWriteFile2Data unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OBWriteFile2Data:
        """Test OBWriteFile2Data
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBWriteFile2Data`
        """
        model = OBWriteFile2Data()
        if include_optional:
