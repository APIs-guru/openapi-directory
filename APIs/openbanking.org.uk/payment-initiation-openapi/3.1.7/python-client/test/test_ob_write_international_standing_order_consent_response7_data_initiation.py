...
class TestOBWriteInternationalStandingOrderConsentResponse7DataInitiation(unittest.TestCase):
    """OBWriteInternationalStandingOrderConsentResponse7DataInitiation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OBWriteInternationalStandingOrderConsentResponse7DataInitiation:
        """Test OBWriteInternationalStandingOrderConsentResponse7DataInitiation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBWriteInternationalStandingOrderConsentResponse7DataInitiation`
        """
        model = OBWriteInternationalStandingOrderConsentResponse7DataInitiation()
        if include_optional:
    ...
    def testOBWriteInternationalStandingOrderConsentResponse7DataInitiation(self):
        """Test OBWriteInternationalStandingOrderConsentResponse7DataInitiation"""
