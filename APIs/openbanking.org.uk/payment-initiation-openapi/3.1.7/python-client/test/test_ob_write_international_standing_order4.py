...
class TestOBWriteInternationalStandingOrder4(unittest.TestCase):
    """OBWriteInternationalStandingOrder4 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OBWriteInternationalStandingOrder4:
        """Test OBWriteInternationalStandingOrder4
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBWriteInternationalStandingOrder4`
        """
        model = OBWriteInternationalStandingOrder4()
        if include_optional:
            return OBWriteInternationalStandingOrder4(
                data = openapi_client.models.ob_write_international_standing_order4_data.OBWriteInternationalStandingOrder4_Data(
                    consent_id = '0', 
    ...
    def testOBWriteInternationalStandingOrder4(self):
        """Test OBWriteInternationalStandingOrder4"""
