...
class TestOBWriteDomesticScheduledResponse5(unittest.TestCase):
    """OBWriteDomesticScheduledResponse5 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OBWriteDomesticScheduledResponse5:
        """Test OBWriteDomesticScheduledResponse5
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBWriteDomesticScheduledResponse5`
        """
        model = OBWriteDomesticScheduledResponse5()
        if include_optional:
            return OBWriteDomesticScheduledResponse5(
                data = openapi_client.models.ob_write_domestic_scheduled_response5_data.OBWriteDomesticScheduledResponse5_Data(
                    charges = [
    ...
    def testOBWriteDomesticScheduledResponse5(self):
        """Test OBWriteDomesticScheduledResponse5"""
