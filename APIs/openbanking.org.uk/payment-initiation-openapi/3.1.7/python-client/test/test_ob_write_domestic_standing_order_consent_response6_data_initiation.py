...
class TestOBWriteDomesticStandingOrderConsentResponse6DataInitiation(unittest.TestCase):
    """OBWriteDomesticStandingOrderConsentResponse6DataInitiation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OBWriteDomesticStandingOrderConsentResponse6DataInitiation:
        """Test OBWriteDomesticStandingOrderConsentResponse6DataInitiation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBWriteDomesticStandingOrderConsentResponse6DataInitiation`
        """
        model = OBWriteDomesticStandingOrderConsentResponse6DataInitiation()
        if include_optional:
    ...
    def testOBWriteDomesticStandingOrderConsentResponse6DataInitiation(self):
        """Test OBWriteDomesticStandingOrderConsentResponse6DataInitiation"""
