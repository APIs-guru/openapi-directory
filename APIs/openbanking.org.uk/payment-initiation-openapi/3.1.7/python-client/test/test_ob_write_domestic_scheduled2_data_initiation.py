...
class TestOBWriteDomesticScheduled2DataInitiation(unittest.TestCase):
    """OBWriteDomesticScheduled2DataInitiation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OBWriteDomesticScheduled2DataInitiation:
        """Test OBWriteDomesticScheduled2DataInitiation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBWriteDomesticScheduled2DataInitiation`
        """
        model = OBWriteDomesticScheduled2DataInitiation()
        if include_optional:
    ...
    def testOBWriteDomesticScheduled2DataInitiation(self):
        """Test OBWriteDomesticScheduled2DataInitiation"""
