...
class TestOBWriteInternationalScheduled3(unittest.TestCase):
    """OBWriteInternationalScheduled3 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OBWriteInternationalScheduled3:
        """Test OBWriteInternationalScheduled3
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBWriteInternationalScheduled3`
        """
        model = OBWriteInternationalScheduled3()
        if include_optional:
            return OBWriteInternationalScheduled3(
                data = openapi_client.models.ob_write_international_scheduled3_data.OBWriteInternationalScheduled3_Data(
                    consent_id = '0', 
    ...
    def testOBWriteInternationalScheduled3(self):
        """Test OBWriteInternationalScheduled3"""
