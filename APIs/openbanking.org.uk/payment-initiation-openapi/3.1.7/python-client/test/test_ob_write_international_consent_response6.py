...
class TestOBWriteInternationalConsentResponse6(unittest.TestCase):
    """OBWriteInternationalConsentResponse6 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OBWriteInternationalConsentResponse6:
        """Test OBWriteInternationalConsentResponse6
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBWriteInternationalConsentResponse6`
        """
        model = OBWriteInternationalConsentResponse6()
        if include_optional:
            return OBWriteInternationalConsentResponse6(
                data = openapi_client.models.ob_write_international_consent_response6_data.OBWriteInternationalConsentResponse6_Data(
    ...
    def testOBWriteInternationalConsentResponse6(self):
        """Test OBWriteInternationalConsentResponse6"""
