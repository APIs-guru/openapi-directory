...
class TestOBWriteFile2DataInitiation(unittest.TestCase):
    """OBWriteFile2DataInitiation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OBWriteFile2DataInitiation:
        """Test OBWriteFile2DataInitiation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBWriteFile2DataInitiation`
        """
        model = OBWriteFile2DataInitiation()
        if include_optional:
    ...
    def testOBWriteFile2DataInitiation(self):
        """Test OBWriteFile2DataInitiation"""
