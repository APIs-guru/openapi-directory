...
class TestOBWriteDomestic2DataInitiation(unittest.TestCase):
    """OBWriteDomestic2DataInitiation unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OBWriteDomestic2DataInitiation:
        """Test OBWriteDomestic2DataInitiation
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBWriteDomestic2DataInitiation`
        """
        model = OBWriteDomestic2DataInitiation()
        if include_optional:
    ...
    def testOBWriteDomestic2DataInitiation(self):
        """Test OBWriteDomestic2DataInitiation"""
