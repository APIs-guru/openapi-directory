...
class TestOBWriteInternationalStandingOrderResponse7(unittest.TestCase):
    """OBWriteInternationalStandingOrderResponse7 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OBWriteInternationalStandingOrderResponse7:
        """Test OBWriteInternationalStandingOrderResponse7
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBWriteInternationalStandingOrderResponse7`
        """
        model = OBWriteInternationalStandingOrderResponse7()
        if include_optional:
            return OBWriteInternationalStandingOrderResponse7(
                data = openapi_client.models.ob_write_international_standing_order_response7_data.OBWriteInternationalStandingOrderResponse7_Data(
                    charges = [
    ...
    def testOBWriteInternationalStandingOrderResponse7(self):
        """Test OBWriteInternationalStandingOrderResponse7"""
