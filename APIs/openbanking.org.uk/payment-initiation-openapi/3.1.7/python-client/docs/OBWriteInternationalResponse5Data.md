...
**international_payment_id** | **str** | OB: Unique identification as assigned by the ASPSP to uniquely identify the international payment resource. | 
...
**status** | **str** | Specifies the status of the payment information group. | 
...
json = "{}"
# create an instance of OBWriteInternationalResponse5Data from a JSON string
ob_write_international_response5_data_instance = OBWriteInternationalResponse5Data.from_json(json)
# print the JSON string representation of the object
print(OBWriteInternationalResponse5Data.to_json())

# convert the object into a dict
ob_write_international_response5_data_dict = ob_write_international_response5_data_instance.to_dict()
# create an instance of OBWriteInternationalResponse5Data from a dict
ob_write_international_response5_data_from_dict = OBWriteInternationalResponse5Data.from_dict(ob_write_international_response5_data_dict)
```
