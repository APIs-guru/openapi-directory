...
ob_write_domestic_scheduled_consent_response5_data_instance = OBWriteDomesticScheduledConsentResponse5Data.from_json(json)
# print the JSON string representation of the object
print(OBWriteDomesticScheduledConsentResponse5Data.to_json())

# convert the object into a dict
ob_write_domestic_scheduled_consent_response5_data_dict = ob_write_domestic_scheduled_consent_response5_data_instance.to_dict()
# create an instance of OBWriteDomesticScheduledConsentResponse5Data from a dict
ob_write_domestic_scheduled_consent_response5_data_from_dict = OBWriteDomesticScheduledConsentResponse5Data.from_dict(ob_write_domestic_scheduled_consent_response5_data_dict)
```
