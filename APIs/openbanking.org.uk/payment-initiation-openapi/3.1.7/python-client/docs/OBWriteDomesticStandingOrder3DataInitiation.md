...
**debtor_account** | [**OBWriteDomesticStandingOrder3DataInitiationDebtorAccount**](OBWriteDomesticStandingOrder3DataInitiationDebtorAccount.md) |  | [optional] 
...
json = "{}"
# create an instance of OBWriteDomesticStandingOrder3DataInitiation from a JSON string
ob_write_domestic_standing_order3_data_initiation_instance = OBWriteDomesticStandingOrder3DataInitiation.from_json(json)
# print the JSON string representation of the object
print(OBWriteDomesticStandingOrder3DataInitiation.to_json())

# convert the object into a dict
ob_write_domestic_standing_order3_data_initiation_dict = ob_write_domestic_standing_order3_data_initiation_instance.to_dict()
# create an instance of OBWriteDomesticStandingOrder3DataInitiation from a dict
ob_write_domestic_standing_order3_data_initiation_from_dict = OBWriteDomesticStandingOrder3DataInitiation.from_dict(ob_write_domestic_standing_order3_data_initiation_dict)
```
