...
**domestic_payment_id** | **str** | OB: Unique identification as assigned by the ASPSP to uniquely identify the domestic payment resource. | 
...
json = "{}"
# create an instance of OBWriteDomesticResponse5Data from a JSON string
ob_write_domestic_response5_data_instance = OBWriteDomesticResponse5Data.from_json(json)
# print the JSON string representation of the object
print(OBWriteDomesticResponse5Data.to_json())

# convert the object into a dict
ob_write_domestic_response5_data_dict = ob_write_domestic_response5_data_instance.to_dict()
# create an instance of OBWriteDomesticResponse5Data from a dict
ob_write_domestic_response5_data_from_dict = OBWriteDomesticResponse5Data.from_dict(ob_write_domestic_response5_data_dict)
```
