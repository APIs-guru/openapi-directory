...
json = "{}"
# create an instance of OBWriteInternationalScheduledConsentResponse6Data from a JSON string
ob_write_international_scheduled_consent_response6_data_instance = OBWriteInternationalScheduledConsentResponse6Data.from_json(json)
# print the JSON string representation of the object
print(OBWriteInternationalScheduledConsentResponse6Data.to_json())

# convert the object into a dict
ob_write_international_scheduled_consent_response6_data_dict = ob_write_international_scheduled_consent_response6_data_instance.to_dict()
# create an instance of OBWriteInternationalScheduledConsentResponse6Data from a dict
ob_write_international_scheduled_consent_response6_data_from_dict = OBWriteInternationalScheduledConsentResponse6Data.from_dict(ob_write_international_scheduled_consent_response6_data_dict)
```
