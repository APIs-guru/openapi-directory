...
**creditor_account** | [**OBWriteInternationalStandingOrder4DataInitiationCreditorAccount**](OBWriteInternationalStandingOrder4DataInitiationCreditorAccount.md) |  | 
**creditor_agent** | [**OBWriteInternationalStandingOrder4DataInitiationCreditorAgent**](OBWriteInternationalStandingOrder4DataInitiationCreditorAgent.md) |  | [optional] 
...
ob_write_international_standing_order_consent_response7_data_initiation_instance = OBWriteInternationalStandingOrderConsentResponse7DataInitiation.from_json(json)
# print the JSON string representation of the object
print(OBWriteInternationalStandingOrderConsentResponse7DataInitiation.to_json())

# convert the object into a dict
ob_write_international_standing_order_consent_response7_data_initiation_dict = ob_write_international_standing_order_consent_response7_data_initiation_instance.to_dict()
# create an instance of OBWriteInternationalStandingOrderConsentResponse7DataInitiation from a dict
ob_write_international_standing_order_consent_response7_data_initiation_from_dict = OBWriteInternationalStandingOrderConsentResponse7DataInitiation.from_dict(ob_write_international_standing_order_consent_response7_data_initiation_dict)
```
