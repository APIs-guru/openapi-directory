...
ob_write_international3_data_initiation_instance = OBWriteInternational3DataInitiation.from_json(json)
# print the JSON string representation of the object
print(OBWriteInternational3DataInitiation.to_json())

# convert the object into a dict
ob_write_international3_data_initiation_dict = ob_write_international3_data_initiation_instance.to_dict()
# create an instance of OBWriteInternational3DataInitiation from a dict
ob_write_international3_data_initiation_from_dict = OBWriteInternational3DataInitiation.from_dict(ob_write_international3_data_initiation_dict)
```
