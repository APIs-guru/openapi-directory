...
ob_write_international_standing_order4_data_initiation_instance = OBWriteInternationalStandingOrder4DataInitiation.from_json(json)
# print the JSON string representation of the object
print(OBWriteInternationalStandingOrder4DataInitiation.to_json())

# convert the object into a dict
ob_write_international_standing_order4_data_initiation_dict = ob_write_international_standing_order4_data_initiation_instance.to_dict()
# create an instance of OBWriteInternationalStandingOrder4DataInitiation from a dict
ob_write_international_standing_order4_data_initiation_from_dict = OBWriteInternationalStandingOrder4DataInitiation.from_dict(ob_write_international_standing_order4_data_initiation_dict)
```
