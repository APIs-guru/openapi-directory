...
json = "{}"
# create an instance of OBWriteInternationalStandingOrderConsentResponse7Data from a JSON string
ob_write_international_standing_order_consent_response7_data_instance = OBWriteInternationalStandingOrderConsentResponse7Data.from_json(json)
# print the JSON string representation of the object
print(OBWriteInternationalStandingOrderConsentResponse7Data.to_json())

# convert the object into a dict
ob_write_international_standing_order_consent_response7_data_dict = ob_write_international_standing_order_consent_response7_data_instance.to_dict()
# create an instance of OBWriteInternationalStandingOrderConsentResponse7Data from a dict
ob_write_international_standing_order_consent_response7_data_from_dict = OBWriteInternationalStandingOrderConsentResponse7Data.from_dict(ob_write_international_standing_order_consent_response7_data_dict)
```
