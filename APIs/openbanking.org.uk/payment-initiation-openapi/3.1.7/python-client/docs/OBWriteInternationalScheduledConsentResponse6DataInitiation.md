...
json = "{}"
# create an instance of OBWriteInternationalScheduledConsentResponse6DataInitiation from a JSON string
ob_write_international_scheduled_consent_response6_data_initiation_instance = OBWriteInternationalScheduledConsentResponse6DataInitiation.from_json(json)
# print the JSON string representation of the object
print(OBWriteInternationalScheduledConsentResponse6DataInitiation.to_json())

# convert the object into a dict
ob_write_international_scheduled_consent_response6_data_initiation_dict = ob_write_international_scheduled_consent_response6_data_initiation_instance.to_dict()
# create an instance of OBWriteInternationalScheduledConsentResponse6DataInitiation from a dict
ob_write_international_scheduled_consent_response6_data_initiation_from_dict = OBWriteInternationalScheduledConsentResponse6DataInitiation.from_dict(ob_write_international_scheduled_consent_response6_data_initiation_dict)
```
