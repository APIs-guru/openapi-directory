...
class OBEventLink1(BaseModel):
    ...
    """ # noqa: E501
    link: StrictStr = Field(description="Resource link.")
    version: Annotated[str, Field(min_length=1, strict=True, max_length=10)] = Field(description="Resource version.")
    __properties: ClassVar[List[str]] = ["link", "version"]
