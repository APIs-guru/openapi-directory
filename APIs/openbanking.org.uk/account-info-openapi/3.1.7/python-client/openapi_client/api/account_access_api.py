...
class AccountAccessApi:
    ...
    def create_account_access_consents(
        ...
        ob_read_consent1: Annotated[OBReadConsent1, Field(description="Default")],
        ...
        :param ob_read_consent1: Default (required)
        ...
        _param = self._create_account_access_consents_serialize(
    ...
    @validate_call
    def create_account_access_consents_with_http_info(
        self,
        authorization: Annotated[StrictStr, Field(description="An Authorisation Token as per https://tools.ietf.org/html/rfc6750")],
        ob_read_consent1: Annotated[OBReadConsent1, Field(description="Default")],
        x_fapi_auth_date: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
    ...
    @validate_call
    def create_account_access_consents_without_preload_content(
        self,
        authorization: Annotated[StrictStr, Field(description="An Authorisation Token as per https://tools.ietf.org/html/rfc6750")],
        ob_read_consent1: Annotated[OBReadConsent1, Field(description="Default")],
        x_fapi_auth_date: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
    ...
    def _create_account_access_consents_serialize(
        self,
        authorization,
        ob_read_consent1,
        x_fapi_auth_date,
    ...
    def delete_account_access_consents_consent_id(
        ...
        _param = self._delete_account_access_consents_consent_id_serialize(
    ...
    @validate_call
    def delete_account_access_consents_consent_id_with_http_info(
        self,
        consent_id: Annotated[StrictStr, Field(description="ConsentId")],
        authorization: Annotated[StrictStr, Field(description="An Authorisation Token as per https://tools.ietf.org/html/rfc6750")],
        x_fapi_auth_date: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
    ...
    @validate_call
    def delete_account_access_consents_consent_id_without_preload_content(
        self,
        consent_id: Annotated[StrictStr, Field(description="ConsentId")],
        authorization: Annotated[StrictStr, Field(description="An Authorisation Token as per https://tools.ietf.org/html/rfc6750")],
        x_fapi_auth_date: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
    ...
    def _delete_account_access_consents_consent_id_serialize(
        self,
        consent_id,
        authorization,
        x_fapi_auth_date,
    ...
    def get_account_access_consents_consent_id(
        ...
        _param = self._get_account_access_consents_consent_id_serialize(
            consent_id=consent_id,
            authorization=authorization,
            x_fapi_auth_date=x_fapi_auth_date,
            x_fapi_customer_ip_address=x_fapi_customer_ip_address,
    ...
    @validate_call
    def get_account_access_consents_consent_id_with_http_info(
        self,
        consent_id: Annotated[StrictStr, Field(description="ConsentId")],
        authorization: Annotated[StrictStr, Field(description="An Authorisation Token as per https://tools.ietf.org/html/rfc6750")],
        x_fapi_auth_date: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
    ...
    @validate_call
    def get_account_access_consents_consent_id_without_preload_content(
        self,
        consent_id: Annotated[StrictStr, Field(description="ConsentId")],
        authorization: Annotated[StrictStr, Field(description="An Authorisation Token as per https://tools.ietf.org/html/rfc6750")],
        x_fapi_auth_date: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
    ...
    def _get_account_access_consents_consent_id_serialize(
        self,
        consent_id,
        authorization,
        x_fapi_auth_date,
