...
class StatementsApi:
    ...
    def get_accounts_account_id_statements(
        ...
        _param = self._get_accounts_account_id_statements_serialize(
    ...
    @validate_call
    def get_accounts_account_id_statements_with_http_info(
        self,
        account_id: Annotated[StrictStr, Field(description="AccountId")],
        authorization: Annotated[StrictStr, Field(description="An Authorisation Token as per https://tools.ietf.org/html/rfc6750")],
        x_fapi_auth_date: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
    ...
    @validate_call
    def get_accounts_account_id_statements_without_preload_content(
        self,
        account_id: Annotated[StrictStr, Field(description="AccountId")],
        authorization: Annotated[StrictStr, Field(description="An Authorisation Token as per https://tools.ietf.org/html/rfc6750")],
        x_fapi_auth_date: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
    ...
    def _get_accounts_account_id_statements_serialize(
        self,
        account_id,
        authorization,
        x_fapi_auth_date,
    ...
    def get_accounts_account_id_statements_statement_id(
        ...
        _param = self._get_accounts_account_id_statements_statement_id_serialize(
    ...
    @validate_call
    def get_accounts_account_id_statements_statement_id_with_http_info(
        self,
        statement_id: Annotated[StrictStr, Field(description="StatementId")],
        account_id: Annotated[StrictStr, Field(description="AccountId")],
        authorization: Annotated[StrictStr, Field(description="An Authorisation Token as per https://tools.ietf.org/html/rfc6750")],
    ...
    @validate_call
    def get_accounts_account_id_statements_statement_id_without_preload_content(
        self,
        statement_id: Annotated[StrictStr, Field(description="StatementId")],
        account_id: Annotated[StrictStr, Field(description="AccountId")],
        authorization: Annotated[StrictStr, Field(description="An Authorisation Token as per https://tools.ietf.org/html/rfc6750")],
    ...
    def _get_accounts_account_id_statements_statement_id_serialize(
        self,
        statement_id,
        account_id,
        authorization,
    ...
    def get_accounts_account_id_statements_statement_id_file(
        ...
        _param = self._get_accounts_account_id_statements_statement_id_file_serialize(
            statement_id=statement_id,
            account_id=account_id,
            authorization=authorization,
            x_fapi_auth_date=x_fapi_auth_date,
    ...
    @validate_call
    def get_accounts_account_id_statements_statement_id_file_with_http_info(
        self,
        statement_id: Annotated[StrictStr, Field(description="StatementId")],
        account_id: Annotated[StrictStr, Field(description="AccountId")],
        authorization: Annotated[StrictStr, Field(description="An Authorisation Token as per https://tools.ietf.org/html/rfc6750")],
    ...
    @validate_call
    def get_accounts_account_id_statements_statement_id_file_without_preload_content(
        self,
        statement_id: Annotated[StrictStr, Field(description="StatementId")],
        account_id: Annotated[StrictStr, Field(description="AccountId")],
        authorization: Annotated[StrictStr, Field(description="An Authorisation Token as per https://tools.ietf.org/html/rfc6750")],
    ...
    def _get_accounts_account_id_statements_statement_id_file_serialize(
        self,
        statement_id,
        account_id,
        authorization,
    ...
    @validate_call
    def get_statements_with_http_info(
        self,
        authorization: Annotated[StrictStr, Field(description="An Authorisation Token as per https://tools.ietf.org/html/rfc6750")],
        x_fapi_auth_date: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
        x_fapi_customer_ip_address: Annotated[Optional[StrictStr], Field(description="The PSU's IP address if the PSU is currently logged in with the TPP.")] = None,
    ...
    @validate_call
    def get_statements_without_preload_content(
        self,
        authorization: Annotated[StrictStr, Field(description="An Authorisation Token as per https://tools.ietf.org/html/rfc6750")],
        x_fapi_auth_date: Annotated[Optional[Annotated[str, Field(strict=True)]], Field(description="The time when the PSU last logged in with the TPP.  All dates in the HTTP headers are represented as RFC 7231 Full Dates. An example is below:  Sun, 10 Sep 2017 19:43:31 UTC")] = None,
        x_fapi_customer_ip_address: Annotated[Optional[StrictStr], Field(description="The PSU's IP address if the PSU is currently logged in with the TPP.")] = None,
