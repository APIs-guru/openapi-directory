...
class OBStatement2Detail(BaseModel):
    ...
    statement_amount: Optional[List[OBStatement2StatementAmountInner]] = Field(default=None, alias="StatementAmount")
    ...
    __properties: ClassVar[List[str]] = ["AccountId", "CreationDateTime", "EndDateTime", "StartDateTime", "StatementAmount", "StatementBenefit", "StatementDateTime", "StatementDescription", "StatementFee", "StatementId", "StatementInterest", "StatementRate", "StatementReference", "StatementValue", "Type"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in statement_amount (list)
        _items = []
        if self.statement_amount:
            for _item_statement_amount in self.statement_amount:
                if _item_statement_amount:
                    _items.append(_item_statement_amount.to_dict())
            _dict['StatementAmount'] = _items
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "StatementAmount": [OBStatement2StatementAmountInner.from_dict(_item) for _item in obj["StatementAmount"]] if obj.get("StatementAmount") is not None else None,
