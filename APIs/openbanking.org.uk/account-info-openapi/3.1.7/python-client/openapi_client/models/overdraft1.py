...
class Overdraft1(BaseModel):
    ...
    overdraft_tier_band_set: Annotated[List[OverdraftTierBandSetInner1], Field(min_length=1)] = Field(description="Tier band set details", alias="OverdraftTierBandSet")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Notes": obj.get("Notes"),
            "OverdraftTierBandSet": [OverdraftTierBandSetInner1.from_dict(_item) for _item in obj["OverdraftTierBandSet"]] if obj.get("OverdraftTierBandSet") is not None else None
        })
        return _obj
