...
class OtherFeesChargesInner(BaseModel):
    ...
    other_tariff_type: Optional[OtherTariffType] = Field(default=None, alias="OtherTariffType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "OtherTariffType": OtherTariffType.from_dict(obj["OtherTariffType"]) if obj.get("OtherTariffType") is not None else None,
