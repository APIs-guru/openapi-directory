...
class OBCashAccount61(BaseModel):
    ...
    """ # noqa: E501
    identification: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=256)]] = Field(default=None, description="Identification assigned by an institution to identify an account. This identification is known by the account owner.", alias="Identification")
    name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=350)]] = Field(default=None, description="The account name is the name or names of the account owner(s) represented at an account level, as displayed by the ASPSP's online channels. Note, the account name is not the product name or the nickname of the account.", alias="Name")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OBCashAccount61 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OBCashAccount61 from a dict"""
        if obj is None:
            return None
