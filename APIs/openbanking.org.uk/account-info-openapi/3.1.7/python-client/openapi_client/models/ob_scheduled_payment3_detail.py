...
class OBScheduledPayment3Detail(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["AccountId", "CreditorAccount", "CreditorAgent", "DebtorReference", "InstructedAmount", "Reference", "ScheduledPaymentDateTime", "ScheduledPaymentId", "ScheduledType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OBScheduledPayment3Detail from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OBScheduledPayment3Detail from a dict"""
        if obj is None:
            return None
