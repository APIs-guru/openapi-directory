...
class OBReadProduct2Data(BaseModel):
    ...
    """ # noqa: E501
    product: Optional[List[OBReadProduct2DataProductInner]] = Field(default=None, alias="Product")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Product": [OBReadProduct2DataProductInner.from_dict(_item) for _item in obj["Product"]] if obj.get("Product") is not None else None
        })
        return _obj
