...
class OBReadAccount6(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OBReadAccount6 from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OBReadAccount6 from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "Data": OBReadAccount6Data.from_dict(obj["Data"]) if obj.get("Data") is not None else None,
