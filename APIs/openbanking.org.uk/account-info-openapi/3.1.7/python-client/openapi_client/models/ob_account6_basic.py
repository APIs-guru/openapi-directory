...
class OBAccount6Basic(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["AccountId", "AccountSubType", "AccountType", "Currency", "Description", "MaturityDate", "Nickname", "OpeningDate", "Status", "StatusUpdateDateTime", "SwitchStatus"]
