...
class OBAccount6(BaseModel):
    ...
    account_sub_type: Optional[OBExternalAccountSubType1Code] = Field(default=None, alias="AccountSubType")
    account_type: Optional[OBExternalAccountType1Code] = Field(default=None, alias="AccountType")
