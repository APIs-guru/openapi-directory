...
class OBStatement2StatementRateInner(BaseModel):
    """
    Set of elements used to provide details of a generic rate related to the statement resource.
    """ # noqa: E501
    rate: Annotated[str, Field(strict=True)] = Field(description="Rate associated with the statement rate type.", alias="Rate")
    type: StrictStr = Field(description="Statement rate type, in a coded form.", alias="Type")
