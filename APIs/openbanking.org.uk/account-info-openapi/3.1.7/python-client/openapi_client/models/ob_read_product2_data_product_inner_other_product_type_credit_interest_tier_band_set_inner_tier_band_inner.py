...
class OBReadProduct2DataProductInnerOtherProductTypeCreditInterestTierBandSetInnerTierBandInner(BaseModel):
    """
    Tier Band Details
    """ # noqa: E501
    ...
    application_frequency: StrictStr = Field(description="How often is interest applied to the Product for this tier/band i.e. how often the financial institution pays accumulated interest to the customer's account.", alias="ApplicationFrequency")
    bank_interest_rate: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, description="Bank Interest for the product", alias="BankInterestRate")
    bank_interest_rate_type: Optional[StrictStr] = Field(default=None, description="Interest rate types, other than AER, which financial institutions may use to describe the annual interest rate payable to the account holder's account.", alias="BankInterestRateType")
    ...
    identification: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=35)]] = Field(default=None, description="Unique and unambiguous identification of a  Tier Band for the Product.", alias="Identification")
    ...
    other_bank_interest_type: Optional[OBReadProduct2DataProductInnerOtherProductTypeCreditInterestTierBandSetInnerTierBandInnerOtherBankInterestType] = Field(default=None, alias="OtherBankInterestType")
    ...
    def application_frequency_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['FQAT', 'FQDY', 'FQHY', 'FQMY', 'FQOT', 'FQQY', 'FQSD', 'FQWY', 'FQYY']):
            raise ValueError("must be one of enum values ('FQAT', 'FQDY', 'FQHY', 'FQMY', 'FQOT', 'FQQY', 'FQSD', 'FQWY', 'FQYY')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "OtherBankInterestType": OBReadProduct2DataProductInnerOtherProductTypeCreditInterestTierBandSetInnerTierBandInnerOtherBankInterestType.from_dict(obj["OtherBankInterestType"]) if obj.get("OtherBankInterestType") is not None else None,
