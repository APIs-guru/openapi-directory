...
class OverdraftFeeChargeCapInner(BaseModel):
    """
    ...
    def fee_type_validate_enum(cls, value):
        """Validates the enum"""
        for i in value:
            if i not in set(['ArrangedOverdraft', 'AnnualReview', 'EmergencyBorrowing', 'BorrowingItem', 'OverdraftRenewal', 'OverdraftSetup', 'Surcharge', 'TempOverdraft', 'UnauthorisedBorrowing', 'UnauthorisedPaidTrans', 'Other', 'UnauthorisedUnpaidTrans']):
                raise ValueError("each list item must be one of ('ArrangedOverdraft', 'AnnualReview', 'EmergencyBorrowing', 'BorrowingItem', 'OverdraftRenewal', 'OverdraftSetup', 'Surcharge', 'TempOverdraft', 'UnauthorisedBorrowing', 'UnauthorisedPaidTrans', 'Other', 'UnauthorisedUnpaidTrans')")
        return value
