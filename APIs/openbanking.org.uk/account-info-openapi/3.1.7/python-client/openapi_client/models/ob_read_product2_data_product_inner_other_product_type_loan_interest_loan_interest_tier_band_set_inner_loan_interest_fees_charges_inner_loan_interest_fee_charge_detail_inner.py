...
class OBReadProduct2DataProductInnerOtherProductTypeLoanInterestLoanInterestTierBandSetInnerLoanInterestFeesChargesInnerLoanInterestFeeChargeDetailInner(BaseModel):
    """
    ...
    other_fee_rate_type: Optional[OBOtherCodeType15] = Field(default=None, alias="OtherFeeRateType")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "OtherFeeRateType": OBOtherCodeType15.from_dict(obj["OtherFeeRateType"]) if obj.get("OtherFeeRateType") is not None else None,
