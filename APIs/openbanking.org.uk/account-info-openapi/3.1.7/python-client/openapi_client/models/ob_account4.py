...
class OBAccount4(BaseModel):
    ...
    """ # noqa: E501
    account: Optional[List[OBAccount4AccountInner]] = Field(default=None, alias="Account")
    ...
    __properties: ClassVar[List[str]] = ["Account", "AccountId", "AccountSubType", "AccountType", "Currency", "Description", "Nickname", "Servicer", "Status", "StatusUpdateDateTime"]
