...
class TierBandSetInner1(BaseModel):
    """
    ...
    destination: Optional[StrictStr] = Field(default=None, description="Describes whether accrued interest is payable only to the PCA or to another bank account", alias="Destination")
    ...
    tier_band: Annotated[List[TierBandInner1], Field(min_length=1)] = Field(description="Tier Band Details", alias="TierBand")
    tier_band_method: StrictStr = Field(description="The methodology of how credit interest is charged. It can be:-  1. Banded Interest rates are banded. i.e. Increasing rate on whole balance as balance increases.  2. Tiered Interest rates are tiered. i.e. increasing rate for each tier as balance increases, but interest paid on tier fixed for that tier and not on whole balance.  3. Whole The same interest rate is applied irrespective of the PCA balance", alias="TierBandMethod")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "Notes": obj.get("Notes"),
            "TierBand": [TierBandInner1.from_dict(_item) for _item in obj["TierBand"]] if obj.get("TierBand") is not None else None,
