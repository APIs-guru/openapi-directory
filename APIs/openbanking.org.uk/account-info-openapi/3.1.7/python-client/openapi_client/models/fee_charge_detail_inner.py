...
class FeeChargeDetailInner(BaseModel):
    ...
    fee_charge_cap: Optional[List[FeeChargeCapInner]] = Field(default=None, description="Details about any caps (maximum charges) that apply to a particular or group of fee/charge", alias="FeeChargeCap")
    ...
    def fee_type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['Other', 'ServiceCAccountFee', 'ServiceCAccountFeeMonthly', 'ServiceCAccountFeeQuarterly', 'ServiceCFixedTariff', 'ServiceCBusiDepAccBreakage', 'ServiceCMinimumMonthlyFee', 'ServiceCOther']):
            raise ValueError("must be one of enum values ('Other', 'ServiceCAccountFee', 'ServiceCAccountFeeMonthly', 'ServiceCAccountFeeQuarterly', 'ServiceCFixedTariff', 'ServiceCBusiDepAccBreakage', 'ServiceCMinimumMonthlyFee', 'ServiceCOther')")
        return value
