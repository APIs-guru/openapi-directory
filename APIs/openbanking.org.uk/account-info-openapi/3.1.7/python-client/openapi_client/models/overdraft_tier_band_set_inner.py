...
class OverdraftTierBandSetInner(BaseModel):
    """
    ...
    overdraft_fees_charges: Optional[List[OverdraftFeesChargesInner]] = Field(default=None, description="Overdraft fees and charges details", alias="OverdraftFeesCharges")
    overdraft_tier_band: Annotated[List[OverdraftTierBandInner], Field(min_length=1)] = Field(description="Provides overdraft details for a specific tier or band", alias="OverdraftTierBand")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OverdraftTierBandSetInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OverdraftTierBandSetInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "Notes": obj.get("Notes"),
            "OverdraftFeesCharges": [OverdraftFeesChargesInner.from_dict(_item) for _item in obj["OverdraftFeesCharges"]] if obj.get("OverdraftFeesCharges") is not None else None,
            "OverdraftTierBand": [OverdraftTierBandInner.from_dict(_item) for _item in obj["OverdraftTierBand"]] if obj.get("OverdraftTierBand") is not None else None,
