...
class OBReadProduct2DataProductInnerOtherProductTypeOtherFeesChargesInnerFeeChargeDetailInner(BaseModel):
    """
    Other fees/charges details
    """ # noqa: E501
    application_frequency: OBFeeFrequency1Code2 = Field(alias="ApplicationFrequency")
    calculation_frequency: Optional[OBFeeFrequency1Code3] = Field(default=None, alias="CalculationFrequency")
    ...
    fee_applicable_range: Optional[OBReadProduct2DataProductInnerOtherProductTypeOtherFeesChargesInnerFeeChargeDetailInnerFeeApplicableRange] = Field(default=None, alias="FeeApplicableRange")
    ...
    other_fee_category_type: Optional[OBOtherCodeType10] = Field(default=None, alias="OtherFeeCategoryType")
    ...
    __properties: ClassVar[List[str]] = ["ApplicationFrequency", "CalculationFrequency", "FeeAmount", "FeeApplicableRange", "FeeCategory", "FeeChargeCap", "FeeRate", "FeeRateType", "FeeType", "NegotiableIndicator", "Notes", "OtherApplicationFrequency", "OtherCalculationFrequency", "OtherFeeCategoryType", "OtherFeeRateType", "OtherFeeType"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "FeeApplicableRange": OBReadProduct2DataProductInnerOtherProductTypeOtherFeesChargesInnerFeeChargeDetailInnerFeeApplicableRange.from_dict(obj["FeeApplicableRange"]) if obj.get("FeeApplicableRange") is not None else None,
            ...
            "OtherFeeCategoryType": OBOtherCodeType10.from_dict(obj["OtherFeeCategoryType"]) if obj.get("OtherFeeCategoryType") is not None else None,
