...
class OBStatement2StatementAmountInner(BaseModel):
    """
    ...
    type: StrictStr = Field(description="Amount type, in a coded form.", alias="Type")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Amount": OBActiveOrHistoricCurrencyAndAmount8.from_dict(obj["Amount"]) if obj.get("Amount") is not None else None,
