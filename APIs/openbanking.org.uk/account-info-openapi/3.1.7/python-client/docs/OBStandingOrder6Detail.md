...
ob_standing_order6_detail_instance = OBStandingOrder6Detail.from_json(json)
# print the JSON string representation of the object
print(OBStandingOrder6Detail.to_json())

# convert the object into a dict
ob_standing_order6_detail_dict = ob_standing_order6_detail_instance.to_dict()
# create an instance of OBStandingOrder6Detail from a dict
ob_standing_order6_detail_from_dict = OBStandingOrder6Detail.from_dict(ob_standing_order6_detail_dict)
```
