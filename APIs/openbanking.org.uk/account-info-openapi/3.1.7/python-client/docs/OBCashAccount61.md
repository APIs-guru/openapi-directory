...
ob_cash_account61_instance = OBCashAccount61.from_json(json)
# print the JSON string representation of the object
print(OBCashAccount61.to_json())

# convert the object into a dict
ob_cash_account61_dict = ob_cash_account61_instance.to_dict()
# create an instance of OBCashAccount61 from a dict
ob_cash_account61_from_dict = OBCashAccount61.from_dict(ob_cash_account61_dict)
```
