...
ob_beneficiary5_basic_instance = OBBeneficiary5Basic.from_json(json)
# print the JSON string representation of the object
print(OBBeneficiary5Basic.to_json())

# convert the object into a dict
ob_beneficiary5_basic_dict = ob_beneficiary5_basic_instance.to_dict()
# create an instance of OBBeneficiary5Basic from a dict
ob_beneficiary5_basic_from_dict = OBBeneficiary5Basic.from_dict(ob_beneficiary5_basic_dict)
```
