...
------------- | ------------- | -------------
[**get_accounts_account_id_parties**](PartiesApi.md#get_accounts_account_id_parties) | **GET** /accounts/{AccountId}/parties | Get Parties
[**get_accounts_account_id_party**](PartiesApi.md#get_accounts_account_id_party) | **GET** /accounts/{AccountId}/party | Get Parties
[**get_party**](PartiesApi.md#get_party) | **GET** /party | Get Parties


# **get_accounts_account_id_parties**
> OBReadParty3 get_accounts_account_id_parties(account_id, authorization, x_fapi_auth_date=x_fapi_auth_date, x_fapi_customer_ip_address=x_fapi_customer_ip_address, x_fapi_interaction_id=x_fapi_interaction_id, x_customer_user_agent=x_customer_user_agent)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Parties
        api_response = api_instance.get_accounts_account_id_parties(account_id, authorization, x_fapi_auth_date=x_fapi_auth_date, x_fapi_customer_ip_address=x_fapi_customer_ip_address, x_fapi_interaction_id=x_fapi_interaction_id, x_customer_user_agent=x_customer_user_agent)
        print("The response of PartiesApi->get_accounts_account_id_parties:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PartiesApi->get_accounts_account_id_parties: %s\n" % e)
```
...
# **get_accounts_account_id_party**
> OBReadParty2 get_accounts_account_id_party(account_id, authorization, x_fapi_auth_date=x_fapi_auth_date, x_fapi_customer_ip_address=x_fapi_customer_ip_address, x_fapi_interaction_id=x_fapi_interaction_id, x_customer_user_agent=x_customer_user_agent)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Parties
        api_response = api_instance.get_accounts_account_id_party(account_id, authorization, x_fapi_auth_date=x_fapi_auth_date, x_fapi_customer_ip_address=x_fapi_customer_ip_address, x_fapi_interaction_id=x_fapi_interaction_id, x_customer_user_agent=x_customer_user_agent)
        print("The response of PartiesApi->get_accounts_account_id_party:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling PartiesApi->get_accounts_account_id_party: %s\n" % e)
```
...
# **get_party**
> OBReadParty2 get_party(authorization, x_fapi_auth_date=x_fapi_auth_date, x_fapi_customer_ip_address=x_fapi_customer_ip_address, x_fapi_interaction_id=x_fapi_interaction_id, x_customer_user_agent=x_customer_user_agent)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Parties
        api_response = api_instance.get_party(authorization, x_fapi_auth_date=x_fapi_auth_date, x_fapi_customer_ip_address=x_fapi_customer_ip_address, x_fapi_interaction_id=x_fapi_interaction_id, x_customer_user_agent=x_customer_user_agent)
