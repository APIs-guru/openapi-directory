...
json = "{}"
# create an instance of OBCashAccount60 from a JSON string
ob_cash_account60_instance = OBCashAccount60.from_json(json)
# print the JSON string representation of the object
print(OBCashAccount60.to_json())

# convert the object into a dict
ob_cash_account60_dict = ob_cash_account60_instance.to_dict()
# create an instance of OBCashAccount60 from a dict
ob_cash_account60_from_dict = OBCashAccount60.from_dict(ob_cash_account60_dict)
```
