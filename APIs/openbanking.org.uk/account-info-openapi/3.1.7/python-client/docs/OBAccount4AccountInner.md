...
json = "{}"
# create an instance of OBAccount4AccountInner from a JSON string
ob_account4_account_inner_instance = OBAccount4AccountInner.from_json(json)
# print the JSON string representation of the object
print(OBAccount4AccountInner.to_json())

# convert the object into a dict
ob_account4_account_inner_dict = ob_account4_account_inner_instance.to_dict()
# create an instance of OBAccount4AccountInner from a dict
ob_account4_account_inner_from_dict = OBAccount4AccountInner.from_dict(ob_account4_account_inner_dict)
```
