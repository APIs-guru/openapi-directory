...
json = "{}"
# create an instance of OBStatement2Detail from a JSON string
ob_statement2_detail_instance = OBStatement2Detail.from_json(json)
# print the JSON string representation of the object
print(OBStatement2Detail.to_json())

# convert the object into a dict
ob_statement2_detail_dict = ob_statement2_detail_instance.to_dict()
# create an instance of OBStatement2Detail from a dict
ob_statement2_detail_from_dict = OBStatement2Detail.from_dict(ob_statement2_detail_dict)
```
