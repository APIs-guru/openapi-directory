...
json = "{}"
# create an instance of OBAccount6Basic from a JSON string
ob_account6_basic_instance = OBAccount6Basic.from_json(json)
# print the JSON string representation of the object
print(OBAccount6Basic.to_json())

# convert the object into a dict
ob_account6_basic_dict = ob_account6_basic_instance.to_dict()
# create an instance of OBAccount6Basic from a dict
ob_account6_basic_from_dict = OBAccount6Basic.from_dict(ob_account6_basic_dict)
```
