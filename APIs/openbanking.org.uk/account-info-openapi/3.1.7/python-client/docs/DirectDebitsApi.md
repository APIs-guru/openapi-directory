# openapi_client.DirectDebitsApi

All URIs are relative to *https://openbanking.org.uk*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_accounts_account_id_direct_debits**](DirectDebitsApi.md#get_accounts_account_id_direct_debits) | **GET** /accounts/{AccountId}/direct-debits | Get Direct Debits
[**get_direct_debits**](DirectDebitsApi.md#get_direct_debits) | **GET** /direct-debits | Get Direct Debits


# **get_accounts_account_id_direct_debits**
> OBReadDirectDebit2 get_accounts_account_id_direct_debits(account_id, authorization, x_fapi_auth_date=x_fapi_auth_date, x_fapi_customer_ip_address=x_fapi_customer_ip_address, x_fapi_interaction_id=x_fapi_interaction_id, x_customer_user_agent=x_customer_user_agent)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.DirectDebitsApi(api_client)
    ...
    try:
        # Get Direct Debits
        api_response = api_instance.get_accounts_account_id_direct_debits(account_id, authorization, x_fapi_auth_date=x_fapi_auth_date, x_fapi_customer_ip_address=x_fapi_customer_ip_address, x_fapi_interaction_id=x_fapi_interaction_id, x_customer_user_agent=x_customer_user_agent)
        print("The response of DirectDebitsApi->get_accounts_account_id_direct_debits:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DirectDebitsApi->get_accounts_account_id_direct_debits: %s\n" % e)
```
...
|-------------|-------------|------------------|
**200** | Direct Debits Read |  * x-fapi-interaction-id - An RFC4122 UID used as a correlation id. <br>  |
...
# **get_direct_debits**
> OBReadDirectDebit2 get_direct_debits(authorization, x_fapi_auth_date=x_fapi_auth_date, x_fapi_customer_ip_address=x_fapi_customer_ip_address, x_fapi_interaction_id=x_fapi_interaction_id, x_customer_user_agent=x_customer_user_agent)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Direct Debits
        api_response = api_instance.get_direct_debits(authorization, x_fapi_auth_date=x_fapi_auth_date, x_fapi_customer_ip_address=x_fapi_customer_ip_address, x_fapi_interaction_id=x_fapi_interaction_id, x_customer_user_agent=x_customer_user_agent)
        print("The response of DirectDebitsApi->get_direct_debits:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling DirectDebitsApi->get_direct_debits: %s\n" % e)
```
