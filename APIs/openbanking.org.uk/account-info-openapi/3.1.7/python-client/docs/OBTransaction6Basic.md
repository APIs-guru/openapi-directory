...
ob_transaction6_basic_instance = OBTransaction6Basic.from_json(json)
# print the JSON string representation of the object
print(OBTransaction6Basic.to_json())

# convert the object into a dict
ob_transaction6_basic_dict = ob_transaction6_basic_instance.to_dict()
# create an instance of OBTransaction6Basic from a dict
ob_transaction6_basic_from_dict = OBTransaction6Basic.from_dict(ob_transaction6_basic_dict)
```
