...
**overdraft_fees_charges** | [**List[OverdraftFeesChargesInner]**](OverdraftFeesChargesInner.md) | Overdraft fees and charges details | [optional] 
**overdraft_tier_band** | [**List[OverdraftTierBandInner]**](OverdraftTierBandInner.md) | Provides overdraft details for a specific tier or band | 
...
overdraft_tier_band_set_inner_instance = OverdraftTierBandSetInner.from_json(json)
# print the JSON string representation of the object
print(OverdraftTierBandSetInner.to_json())

# convert the object into a dict
overdraft_tier_band_set_inner_dict = overdraft_tier_band_set_inner_instance.to_dict()
# create an instance of OverdraftTierBandSetInner from a dict
overdraft_tier_band_set_inner_from_dict = OverdraftTierBandSetInner.from_dict(overdraft_tier_band_set_inner_dict)
```
