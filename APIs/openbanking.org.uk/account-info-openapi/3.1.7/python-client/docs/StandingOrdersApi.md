# openapi_client.StandingOrdersApi

All URIs are relative to *https://openbanking.org.uk*

Method | HTTP request | Description
------------- | ------------- | -------------
[**get_accounts_account_id_standing_orders**](StandingOrdersApi.md#get_accounts_account_id_standing_orders) | **GET** /accounts/{AccountId}/standing-orders | Get Standing Orders
[**get_standing_orders**](StandingOrdersApi.md#get_standing_orders) | **GET** /standing-orders | Get Standing Orders


# **get_accounts_account_id_standing_orders**
> OBReadStandingOrder6 get_accounts_account_id_standing_orders(account_id, authorization, x_fapi_auth_date=x_fapi_auth_date, x_fapi_customer_ip_address=x_fapi_customer_ip_address, x_fapi_interaction_id=x_fapi_interaction_id, x_customer_user_agent=x_customer_user_agent)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.StandingOrdersApi(api_client)
    ...
    try:
        # Get Standing Orders
        api_response = api_instance.get_accounts_account_id_standing_orders(account_id, authorization, x_fapi_auth_date=x_fapi_auth_date, x_fapi_customer_ip_address=x_fapi_customer_ip_address, x_fapi_interaction_id=x_fapi_interaction_id, x_customer_user_agent=x_customer_user_agent)
        print("The response of StandingOrdersApi->get_accounts_account_id_standing_orders:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StandingOrdersApi->get_accounts_account_id_standing_orders: %s\n" % e)
```
...
|-------------|-------------|------------------|
**200** | Standing Orders Read |  * x-fapi-interaction-id - An RFC4122 UID used as a correlation id. <br>  |
...
# **get_standing_orders**
> OBReadStandingOrder6 get_standing_orders(authorization, x_fapi_auth_date=x_fapi_auth_date, x_fapi_customer_ip_address=x_fapi_customer_ip_address, x_fapi_interaction_id=x_fapi_interaction_id, x_customer_user_agent=x_customer_user_agent)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        # Get Standing Orders
        api_response = api_instance.get_standing_orders(authorization, x_fapi_auth_date=x_fapi_auth_date, x_fapi_customer_ip_address=x_fapi_customer_ip_address, x_fapi_interaction_id=x_fapi_interaction_id, x_customer_user_agent=x_customer_user_agent)
        print("The response of StandingOrdersApi->get_standing_orders:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling StandingOrdersApi->get_standing_orders: %s\n" % e)
```
