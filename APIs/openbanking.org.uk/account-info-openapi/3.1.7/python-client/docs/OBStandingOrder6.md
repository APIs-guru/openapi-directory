...
ob_standing_order6_instance = OBStandingOrder6.from_json(json)
# print the JSON string representation of the object
print(OBStandingOrder6.to_json())

# convert the object into a dict
ob_standing_order6_dict = ob_standing_order6_instance.to_dict()
# create an instance of OBStandingOrder6 from a dict
ob_standing_order6_from_dict = OBStandingOrder6.from_dict(ob_standing_order6_dict)
```
