...
json = "{}"
# create an instance of OBAccount4Detail from a JSON string
ob_account4_detail_instance = OBAccount4Detail.from_json(json)
# print the JSON string representation of the object
print(OBAccount4Detail.to_json())

# convert the object into a dict
ob_account4_detail_dict = ob_account4_detail_instance.to_dict()
# create an instance of OBAccount4Detail from a dict
ob_account4_detail_from_dict = OBAccount4Detail.from_dict(ob_account4_detail_dict)
```
