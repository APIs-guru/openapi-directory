...
class TestOverdraftTierBandSetInner1(unittest.TestCase):
    """OverdraftTierBandSetInner1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OverdraftTierBandSetInner1:
        """Test OverdraftTierBandSetInner1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OverdraftTierBandSetInner1`
        """
        model = OverdraftTierBandSetInner1()
        if include_optional:
            return OverdraftTierBandSetInner1(
    ...
    def testOverdraftTierBandSetInner1(self):
        """Test OverdraftTierBandSetInner1"""
