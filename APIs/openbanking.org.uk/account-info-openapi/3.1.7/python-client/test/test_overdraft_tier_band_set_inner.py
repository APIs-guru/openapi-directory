...
class TestOverdraftTierBandSetInner(unittest.TestCase):
    """OverdraftTierBandSetInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OverdraftTierBandSetInner:
        """Test OverdraftTierBandSetInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OverdraftTierBandSetInner`
        """
        model = OverdraftTierBandSetInner()
        if include_optional:
            return OverdraftTierBandSetInner(
    ...
    def testOverdraftTierBandSetInner(self):
        """Test OverdraftTierBandSetInner"""
