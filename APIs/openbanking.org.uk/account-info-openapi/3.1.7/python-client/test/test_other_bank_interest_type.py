...
class TestOtherBankInterestType(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OtherBankInterestType:
        """Test OtherBankInterestType
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OtherBankInterestType`
        """
        model = OtherBankInterestType()
        if include_optional:
