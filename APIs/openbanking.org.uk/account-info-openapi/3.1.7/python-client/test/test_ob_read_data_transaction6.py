...
class TestOBReadDataTransaction6(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OBReadDataTransaction6:
        """Test OBReadDataTransaction6
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBReadDataTransaction6`
        """
        model = OBReadDataTransaction6()
        if include_optional:
    ...
    def testOBReadDataTransaction6(self):
        """Test OBReadDataTransaction6"""
