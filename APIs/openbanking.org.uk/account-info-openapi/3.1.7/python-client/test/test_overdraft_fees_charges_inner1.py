...
class TestOverdraftFeesChargesInner1(unittest.TestCase):
    """OverdraftFeesChargesInner1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OverdraftFeesChargesInner1:
        """Test OverdraftFeesChargesInner1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OverdraftFeesChargesInner1`
        """
        model = OverdraftFeesChargesInner1()
        if include_optional:
            return OverdraftFeesChargesInner1(
    ...
    def testOverdraftFeesChargesInner1(self):
        """Test OverdraftFeesChargesInner1"""
