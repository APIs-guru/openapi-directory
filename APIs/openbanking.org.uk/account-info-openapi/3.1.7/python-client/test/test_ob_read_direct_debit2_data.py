...
class TestOBReadDirectDebit2Data(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OBReadDirectDebit2Data:
        """Test OBReadDirectDebit2Data
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBReadDirectDebit2Data`
        """
        model = OBReadDirectDebit2Data()
        if include_optional:
    ...
    def testOBReadDirectDebit2Data(self):
        """Test OBReadDirectDebit2Data"""
