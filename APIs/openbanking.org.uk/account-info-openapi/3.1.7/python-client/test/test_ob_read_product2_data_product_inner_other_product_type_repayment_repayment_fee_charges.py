...
class TestOBReadProduct2DataProductInnerOtherProductTypeRepaymentRepaymentFeeCharges(unittest.TestCase):
    """OBReadProduct2DataProductInnerOtherProductTypeRepaymentRepaymentFeeCharges unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OBReadProduct2DataProductInnerOtherProductTypeRepaymentRepaymentFeeCharges:
        """Test OBReadProduct2DataProductInnerOtherProductTypeRepaymentRepaymentFeeCharges
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBReadProduct2DataProductInnerOtherProductTypeRepaymentRepaymentFeeCharges`
        """
        model = OBReadProduct2DataProductInnerOtherProductTypeRepaymentRepaymentFeeCharges()
        if include_optional:
            return OBReadProduct2DataProductInnerOtherProductTypeRepaymentRepaymentFeeCharges(
    ...
    def testOBReadProduct2DataProductInnerOtherProductTypeRepaymentRepaymentFeeCharges(self):
        """Test OBReadProduct2DataProductInnerOtherProductTypeRepaymentRepaymentFeeCharges"""
