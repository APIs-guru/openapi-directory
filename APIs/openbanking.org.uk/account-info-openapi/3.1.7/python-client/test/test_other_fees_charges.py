...
class TestOtherFeesCharges(unittest.TestCase):
    """OtherFeesCharges unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OtherFeesCharges:
        """Test OtherFeesCharges
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OtherFeesCharges`
        """
        model = OtherFeesCharges()
        if include_optional:
