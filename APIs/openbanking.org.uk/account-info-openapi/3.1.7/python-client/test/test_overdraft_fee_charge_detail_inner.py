...
class TestOverdraftFeeChargeDetailInner(unittest.TestCase):
    """OverdraftFeeChargeDetailInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OverdraftFeeChargeDetailInner:
        """Test OverdraftFeeChargeDetailInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OverdraftFeeChargeDetailInner`
        """
        model = OverdraftFeeChargeDetailInner()
        if include_optional:
            return OverdraftFeeChargeDetailInner(
    ...
    def testOverdraftFeeChargeDetailInner(self):
        """Test OverdraftFeeChargeDetailInner"""
