...
class TestOBReadDataStatement2(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OBReadDataStatement2:
        """Test OBReadDataStatement2
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBReadDataStatement2`
        """
        model = OBReadDataStatement2()
        if include_optional:
    ...
    def testOBReadDataStatement2(self):
        """Test OBReadDataStatement2"""
