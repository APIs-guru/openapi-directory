...
class TestOBScheduledPayment3Detail(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OBScheduledPayment3Detail:
        """Test OBScheduledPayment3Detail
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBScheduledPayment3Detail`
        """
        model = OBScheduledPayment3Detail()
        if include_optional:
    ...
    def testOBScheduledPayment3Detail(self):
        """Test OBScheduledPayment3Detail"""
