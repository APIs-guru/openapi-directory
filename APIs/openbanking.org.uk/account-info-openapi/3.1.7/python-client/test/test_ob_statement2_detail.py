...
class TestOBStatement2Detail(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OBStatement2Detail:
        """Test OBStatement2Detail
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBStatement2Detail`
        """
        model = OBStatement2Detail()
        if include_optional:
    ...
    def testOBStatement2Detail(self):
        """Test OBStatement2Detail"""
