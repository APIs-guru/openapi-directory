...
class TestOBTransaction6Detail(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OBTransaction6Detail:
        """Test OBTransaction6Detail
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBTransaction6Detail`
        """
        model = OBTransaction6Detail()
        if include_optional:
    ...
    def testOBTransaction6Detail(self):
        """Test OBTransaction6Detail"""
