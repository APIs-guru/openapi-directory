...
class TestTierBandSetInner1(unittest.TestCase):
    """TierBandSetInner1 unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TierBandSetInner1:
        """Test TierBandSetInner1
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TierBandSetInner1`
        """
        model = TierBandSetInner1()
        if include_optional:
            return TierBandSetInner1(
    ...
    def testTierBandSetInner1(self):
        """Test TierBandSetInner1"""
