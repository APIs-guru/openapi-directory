...
class TestOBReadProduct2DataProductInnerOtherProductTypeCreditInterestTierBandSetInner(unittest.TestCase):
    """OBReadProduct2DataProductInnerOtherProductTypeCreditInterestTierBandSetInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OBReadProduct2DataProductInnerOtherProductTypeCreditInterestTierBandSetInner:
        """Test OBReadProduct2DataProductInnerOtherProductTypeCreditInterestTierBandSetInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBReadProduct2DataProductInnerOtherProductTypeCreditInterestTierBandSetInner`
        """
        model = OBReadProduct2DataProductInnerOtherProductTypeCreditInterestTierBandSetInner()
        if include_optional:
            return OBReadProduct2DataProductInnerOtherProductTypeCreditInterestTierBandSetInner(
    ...
    def testOBReadProduct2DataProductInnerOtherProductTypeCreditInterestTierBandSetInner(self):
        """Test OBReadProduct2DataProductInnerOtherProductTypeCreditInterestTierBandSetInner"""
