...
class TestOBStandingOrder6Basic(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OBStandingOrder6Basic:
        """Test OBStandingOrder6Basic
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBStandingOrder6Basic`
        """
        model = OBStandingOrder6Basic()
        if include_optional:
    ...
    def testOBStandingOrder6Basic(self):
        """Test OBStandingOrder6Basic"""
