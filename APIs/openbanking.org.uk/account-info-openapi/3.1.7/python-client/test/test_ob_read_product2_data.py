...
class TestOBReadProduct2Data(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OBReadProduct2Data:
        """Test OBReadProduct2Data
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBReadProduct2Data`
        """
        model = OBReadProduct2Data()
        if include_optional:
    ...
    def testOBReadProduct2Data(self):
        """Test OBReadProduct2Data"""
