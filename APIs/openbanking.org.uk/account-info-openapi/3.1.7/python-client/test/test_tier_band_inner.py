...
class TestTierBandInner(unittest.TestCase):
    """TierBandInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TierBandInner:
        """Test TierBandInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TierBandInner`
        """
        model = TierBandInner()
        if include_optional:
            return TierBandInner(
                aer = '-807',
