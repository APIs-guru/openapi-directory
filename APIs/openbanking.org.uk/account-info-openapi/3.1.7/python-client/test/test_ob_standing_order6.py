...
class TestOBStandingOrder6(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> OBStandingOrder6:
        """Test OBStandingOrder6
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBStandingOrder6`
        """
        model = OBStandingOrder6()
        if include_optional:
