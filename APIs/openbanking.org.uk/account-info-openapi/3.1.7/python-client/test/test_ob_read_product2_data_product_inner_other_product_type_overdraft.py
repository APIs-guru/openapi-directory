...
class TestOBReadProduct2DataProductInnerOtherProductTypeOverdraft(unittest.TestCase):
    """OBReadProduct2DataProductInnerOtherProductTypeOverdraft unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OBReadProduct2DataProductInnerOtherProductTypeOverdraft:
        """Test OBReadProduct2DataProductInnerOtherProductTypeOverdraft
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OBReadProduct2DataProductInnerOtherProductTypeOverdraft`
        """
        model = OBReadProduct2DataProductInnerOtherProductTypeOverdraft()
        if include_optional:
            return OBReadProduct2DataProductInnerOtherProductTypeOverdraft(
                notes = [
                    '0'
                    ],
    ...
    def testOBReadProduct2DataProductInnerOtherProductTypeOverdraft(self):
        """Test OBReadProduct2DataProductInnerOtherProductTypeOverdraft"""
