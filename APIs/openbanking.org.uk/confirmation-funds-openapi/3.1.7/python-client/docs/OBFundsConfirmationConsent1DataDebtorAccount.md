...
ob_funds_confirmation_consent1_data_debtor_account_instance = OBFundsConfirmationConsent1DataDebtorAccount.from_json(json)
# print the JSON string representation of the object
print(OBFundsConfirmationConsent1DataDebtorAccount.to_json())

# convert the object into a dict
ob_funds_confirmation_consent1_data_debtor_account_dict = ob_funds_confirmation_consent1_data_debtor_account_instance.to_dict()
# create an instance of OBFundsConfirmationConsent1DataDebtorAccount from a dict
ob_funds_confirmation_consent1_data_debtor_account_from_dict = OBFundsConfirmationConsent1DataDebtorAccount.from_dict(ob_funds_confirmation_consent1_data_debtor_account_dict)
```
