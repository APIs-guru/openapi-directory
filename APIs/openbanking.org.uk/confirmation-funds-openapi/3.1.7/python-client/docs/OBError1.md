...
------------ | ------------- | ------------- | -------------
**error_code** | **str** | Low level textual error code, e.g., UK.OBIE.Field.Missing | 
...
**url** | **str** | URL to help remediate the problem, or provide more information, or to API Reference, or help etc | [optional] 
