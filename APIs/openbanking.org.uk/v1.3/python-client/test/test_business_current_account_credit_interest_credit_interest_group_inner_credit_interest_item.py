...
class TestBusinessCurrentAccountCreditInterestCreditInterestGroupInnerCreditInterestItem(unittest.TestCase):
    """BusinessCurrentAccountCreditInterestCreditInterestGroupInnerCreditInterestItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BusinessCurrentAccountCreditInterestCreditInterestGroupInnerCreditInterestItem:
        """Test BusinessCurrentAccountCreditInterestCreditInterestGroupInnerCreditInterestItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BusinessCurrentAccountCreditInterestCreditInterestGroupInnerCreditInterestItem`
        """
        model = BusinessCurrentAccountCreditInterestCreditInterestGroupInnerCreditInterestItem()
        if include_optional:
            return BusinessCurrentAccountCreditInterestCreditInterestGroupInnerCreditInterestItem(
    ...
    def testBusinessCurrentAccountCreditInterestCreditInterestGroupInnerCreditInterestItem(self):
        """Test BusinessCurrentAccountCreditInterestCreditInterestGroupInnerCreditInterestItem"""
