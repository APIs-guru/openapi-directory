...
class TestBusinessCurrentAccountCreditInterest(unittest.TestCase):
    """BusinessCurrentAccountCreditInterest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BusinessCurrentAccountCreditInterest:
        """Test BusinessCurrentAccountCreditInterest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BusinessCurrentAccountCreditInterest`
        """
        model = BusinessCurrentAccountCreditInterest()
        if include_optional:
            return BusinessCurrentAccountCreditInterest(
                credit_charged = True,
    ...
    def testBusinessCurrentAccountCreditInterest(self):
        """Test BusinessCurrentAccountCreditInterest"""
