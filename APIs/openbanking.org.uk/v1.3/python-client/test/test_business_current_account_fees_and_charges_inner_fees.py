...
class TestBusinessCurrentAccountFeesAndChargesInnerFees(unittest.TestCase):
    """BusinessCurrentAccountFeesAndChargesInnerFees unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BusinessCurrentAccountFeesAndChargesInnerFees:
        """Test BusinessCurrentAccountFeesAndChargesInnerFees
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BusinessCurrentAccountFeesAndChargesInnerFees`
        """
        model = BusinessCurrentAccountFeesAndChargesInnerFees()
        if include_optional:
            return BusinessCurrentAccountFeesAndChargesInnerFees(
    ...
    def testBusinessCurrentAccountFeesAndChargesInnerFees(self):
        """Test BusinessCurrentAccountFeesAndChargesInnerFees"""
