...
class TestPersonalCurrentAccountsGet200ResponseDataInner(unittest.TestCase):
    """PersonalCurrentAccountsGet200ResponseDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PersonalCurrentAccountsGet200ResponseDataInner:
        """Test PersonalCurrentAccountsGet200ResponseDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PersonalCurrentAccountsGet200ResponseDataInner`
        """
        model = PersonalCurrentAccountsGet200ResponseDataInner()
        if include_optional:
            return PersonalCurrentAccountsGet200ResponseDataInner(
                access_channels = [
                    'ATM'
                    ],
    ...
    def testPersonalCurrentAccountsGet200ResponseDataInner(self):
        """Test PersonalCurrentAccountsGet200ResponseDataInner"""
