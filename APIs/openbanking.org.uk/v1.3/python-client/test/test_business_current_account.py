...
class TestBusinessCurrentAccount(unittest.TestCase):
    """BusinessCurrentAccount unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BusinessCurrentAccount:
        """Test BusinessCurrentAccount
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BusinessCurrentAccount`
        """
        model = BusinessCurrentAccount()
        if include_optional:
            return BusinessCurrentAccount(
                access_channels = [
                    'ATM'
                    ],
    ...
    def testBusinessCurrentAccount(self):
        """Test BusinessCurrentAccount"""
