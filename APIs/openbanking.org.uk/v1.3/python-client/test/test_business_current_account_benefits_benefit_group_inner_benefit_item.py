...
class TestBusinessCurrentAccountBenefitsBenefitGroupInnerBenefitItem(unittest.TestCase):
    """BusinessCurrentAccountBenefitsBenefitGroupInnerBenefitItem unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BusinessCurrentAccountBenefitsBenefitGroupInnerBenefitItem:
        """Test BusinessCurrentAccountBenefitsBenefitGroupInnerBenefitItem
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BusinessCurrentAccountBenefitsBenefitGroupInnerBenefitItem`
        """
        model = BusinessCurrentAccountBenefitsBenefitGroupInnerBenefitItem()
        if include_optional:
            return BusinessCurrentAccountBenefitsBenefitGroupInnerBenefitItem(
                benefit_detail = [
    ...
    def testBusinessCurrentAccountBenefitsBenefitGroupInnerBenefitItem(self):
        """Test BusinessCurrentAccountBenefitsBenefitGroupInnerBenefitItem"""
