...
class TestBusinessCurrentAccountBenefits(unittest.TestCase):
    """BusinessCurrentAccountBenefits unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BusinessCurrentAccountBenefits:
        """Test BusinessCurrentAccountBenefits
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BusinessCurrentAccountBenefits`
        """
        model = BusinessCurrentAccountBenefits()
        if include_optional:
            return BusinessCurrentAccountBenefits(
                benefit = True,
                benefit_group = [
    ...
    def testBusinessCurrentAccountBenefits(self):
        """Test BusinessCurrentAccountBenefits"""
