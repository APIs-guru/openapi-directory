...
class BusinessCurrentAccountsGet200Response(BaseModel):
    """
    BusinessCurrentAccountsGet200Response
    """ # noqa: E501
    data: List[BusinessCurrentAccount]
    meta: MetaData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [BusinessCurrentAccount.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
