...
class BusinessCurrentAccountCAPricingInner(BaseModel):
    """
    Card Price
    """ # noqa: E501
    ca_pricing_item: BusinessCurrentAccountCAPricingInnerCAPricingItem = Field(alias="CAPricingItem")
    ...
    __properties: ClassVar[List[str]] = ["CAPricingItem", "ProductState"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of ca_pricing_item
        if self.ca_pricing_item:
            _dict['CAPricingItem'] = self.ca_pricing_item.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "CAPricingItem": BusinessCurrentAccountCAPricingInnerCAPricingItem.from_dict(obj["CAPricingItem"]) if obj.get("CAPricingItem") is not None else None,
