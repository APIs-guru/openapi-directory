...
class UnsecuredSmeLoansGet200Response(BaseModel):
    """
    UnsecuredSmeLoansGet200Response
    """ # noqa: E501
    data: List[UnsecuredSmeLoansGet200ResponseDataInner]
    meta: MetaData
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [UnsecuredSmeLoansGet200ResponseDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
