...
class BusinessCurrentAccountFeesAndChargesInner(BaseModel):
    """
    Fees And Charges
    """ # noqa: E501
    fees: BusinessCurrentAccountFeesAndChargesInnerFees = Field(alias="Fees")
    ...
    __properties: ClassVar[List[str]] = ["Fees", "ProductState"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "Fees": BusinessCurrentAccountFeesAndChargesInnerFees.from_dict(obj["Fees"]) if obj.get("Fees") is not None else None,
