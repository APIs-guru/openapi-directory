# openapi_client.BranchApi

All URIs are relative to *https://developer.openbanking.org.uk/reference-implementation/open-banking/v1.3*

Method | HTTP request | Description
------------- | ------------- | -------------
[**branches_get**](BranchApi.md#branches_get) | **GET** /branches | 
[**branches_head**](BranchApi.md#branches_head) | **HEAD** /branches | 


# **branches_get**
> BranchesGet200Response branches_get(if_modified_since=if_modified_since, if_none_match=if_none_match)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.BranchApi(api_client)
    ...
    try:
        api_response = api_instance.branches_get(if_modified_since=if_modified_since, if_none_match=if_none_match)
        print("The response of BranchApi->branches_get:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BranchApi->branches_get: %s\n" % e)
```
...
[**BranchesGet200Response**](BranchesGet200Response.md)
...
# **branches_head**
> object branches_head(if_modified_since=if_modified_since, if_none_match=if_none_match)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    try:
        api_response = api_instance.branches_head(if_modified_since=if_modified_since, if_none_match=if_none_match)
        print("The response of BranchApi->branches_head:\n")
        pprint(api_response)
    except Exception as e:
        print("Exception when calling BranchApi->branches_head: %s\n" % e)
```
