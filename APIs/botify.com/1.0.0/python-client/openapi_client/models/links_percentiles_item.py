...
class LinksPercentilesItem(BaseModel):
    ...
    id: StrictInt
    max: StrictInt
    metric_total: StrictInt
    min: StrictInt
    url_total: StrictInt
    __properties: ClassVar[List[str]] = ["avg", "id", "max", "metric_total", "min", "url_total"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "max": obj.get("max"),
            "metric_total": obj.get("metric_total"),
            "min": obj.get("min"),
            "url_total": obj.get("url_total")
        })
        return _obj
