...
class Participation(BaseModel):
    ...
    id: Optional[StrictInt] = Field(default=None, description="Unique identifier representing this participation. Id numbers are never reused")
    ...
    project_id: Optional[StrictInt] = Field(default=None, description="The id of the project this participation belongs to", alias="projectId")
    user_id: Optional[StrictStr] = Field(default=None, description="The id of the user this participation belongs to", alias="userId")
    __properties: ClassVar[List[str]] = ["accessLink", "activated", "activitiesCompleted", "activitiesTotal", "errorMessage", "expiration", "externalId", "firstAccess", "firstActivation", "firstMail", "id", "inError", "lastAccess", "lastActivation", "lastMail", "projectId", "userId"]
