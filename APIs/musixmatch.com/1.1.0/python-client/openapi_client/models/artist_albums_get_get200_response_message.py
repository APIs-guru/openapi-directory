...
class ArtistAlbumsGetGet200ResponseMessage(BaseModel):
    """
    ArtistAlbumsGetGet200ResponseMessage
    """ # noqa: E501
    body: Optional[ArtistAlbumsGetGet200ResponseMessageBody] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "body": ArtistAlbumsGetGet200ResponseMessageBody.from_dict(obj["body"]) if obj.get("body") is not None else None,
