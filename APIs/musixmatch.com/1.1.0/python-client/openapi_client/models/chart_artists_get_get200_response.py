...
class ChartArtistsGetGet200Response(BaseModel):
    """
    ChartArtistsGetGet200Response
    """ # noqa: E501
    message: Optional[ChartArtistsGetGet200ResponseMessage] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "message": ChartArtistsGetGet200ResponseMessage.from_dict(obj["message"]) if obj.get("message") is not None else None
        })
        return _obj
