...
class AlbumTracksGetGet200ResponseMessageHeader(BaseModel):
    """
    AlbumTracksGetGet200ResponseMessageHeader
    """ # noqa: E501
    available: Optional[Union[StrictFloat, StrictInt]] = None
    execute_time: Optional[Union[StrictFloat, StrictInt]] = None
    status_code: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["available", "execute_time", "status_code"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AlbumTracksGetGet200ResponseMessageHeader from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AlbumTracksGetGet200ResponseMessageHeader from a dict"""
        if obj is None:
            return None
