...
class ArtistGetGet200ResponseMessage(BaseModel):
    """
    ArtistGetGet200ResponseMessage
    """ # noqa: E501
    body: Optional[ArtistGetGet200ResponseMessageBody] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "body": ArtistGetGet200ResponseMessageBody.from_dict(obj["body"]) if obj.get("body") is not None else None,
