...
class AlbumPrimaryGenresMusicGenreListInner(BaseModel):
    """
    AlbumPrimaryGenresMusicGenreListInner
    """ # noqa: E501
    music_genre: Optional[AlbumPrimaryGenresMusicGenreListInnerMusicGenre] = None
    __properties: ClassVar[List[str]] = ["music_genre"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AlbumPrimaryGenresMusicGenreListInner from a JSON string"""
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of music_genre
        if self.music_genre:
            _dict['music_genre'] = self.music_genre.to_dict()
        return _dict

    @classmethod
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AlbumPrimaryGenresMusicGenreListInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "music_genre": AlbumPrimaryGenresMusicGenreListInnerMusicGenre.from_dict(obj["music_genre"]) if obj.get("music_genre") is not None else None
        })
        return _obj
