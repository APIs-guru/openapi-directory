...
class MatcherLyricsGetGet200ResponseMessageBody(BaseModel):
    """
    MatcherLyricsGetGet200ResponseMessageBody
    """ # noqa: E501
    lyrics: Optional[Lyrics] = None
    __properties: ClassVar[List[str]] = ["lyrics"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MatcherLyricsGetGet200ResponseMessageBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MatcherLyricsGetGet200ResponseMessageBody from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "lyrics": Lyrics.from_dict(obj["lyrics"]) if obj.get("lyrics") is not None else None
        })
        return _obj
