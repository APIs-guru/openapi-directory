...
class ArtistArtistAliasListInner(BaseModel):
    """
    ArtistArtistAliasListInner
    """ # noqa: E501
    artist_alias: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["artist_alias"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ArtistArtistAliasListInner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ArtistArtistAliasListInner from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "artist_alias": obj.get("artist_alias")
        })
        return _obj
