...
class AlbumGetGet200Response(BaseModel):
    """
    AlbumGetGet200Response
    """ # noqa: E501
    message: Optional[AlbumGetGet200ResponseMessage] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AlbumGetGet200Response from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AlbumGetGet200Response from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "message": AlbumGetGet200ResponseMessage.from_dict(obj["message"]) if obj.get("message") is not None else None
        })
        return _obj
