...
from openapi_client.models.album_get_get200_response_message_body import AlbumGetGet200ResponseMessageBody
from openapi_client.models.album_get_get200_response_message_header import AlbumGetGet200ResponseMessageHeader
from typing import Optional, Set
from typing_extensions import Self

class AlbumGetGet200ResponseMessage(BaseModel):
    """
    AlbumGetGet200ResponseMessage
    """ # noqa: E501
    body: Optional[AlbumGetGet200ResponseMessageBody] = None
    header: Optional[AlbumGetGet200ResponseMessageHeader] = None
    __properties: ClassVar[List[str]] = ["body", "header"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "body": AlbumGetGet200ResponseMessageBody.from_dict(obj["body"]) if obj.get("body") is not None else None,
            "header": AlbumGetGet200ResponseMessageHeader.from_dict(obj["header"]) if obj.get("header") is not None else None
        })
        return _obj
