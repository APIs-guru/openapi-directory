...
from openapi_client.models.chart_artists_get_get200_response_message_header import ChartArtistsGetGet200ResponseMessageHeader
...
class ChartTracksGetGet200ResponseMessage(BaseModel):
    """
    ChartTracksGetGet200ResponseMessage
    """ # noqa: E501
    body: Optional[ChartTracksGetGet200ResponseMessageBody] = None
    header: Optional[ChartArtistsGetGet200ResponseMessageHeader] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "body": ChartTracksGetGet200ResponseMessageBody.from_dict(obj["body"]) if obj.get("body") is not None else None,
            "header": ChartArtistsGetGet200ResponseMessageHeader.from_dict(obj["header"]) if obj.get("header") is not None else None
        })
        return _obj
