...
class AlbumSecondaryGenres(BaseModel):
    """
    AlbumSecondaryGenres
    """ # noqa: E501
    music_genre_list: Optional[List[StrictStr]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AlbumSecondaryGenres from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AlbumSecondaryGenres from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "music_genre_list": obj.get("music_genre_list")
        })
        return _obj
