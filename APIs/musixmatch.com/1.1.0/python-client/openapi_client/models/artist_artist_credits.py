...
class ArtistArtistCredits(BaseModel):
    """
    ArtistArtistCredits
    """ # noqa: E501
    artist_list: Optional[List[StrictStr]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ArtistArtistCredits from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ArtistArtistCredits from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "artist_list": obj.get("artist_list")
        })
        return _obj
