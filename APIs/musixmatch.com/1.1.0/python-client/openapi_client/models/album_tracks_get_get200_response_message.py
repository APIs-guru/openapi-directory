...
class AlbumTracksGetGet200ResponseMessage(BaseModel):
    """
    AlbumTracksGetGet200ResponseMessage
    """ # noqa: E501
    body: Optional[AlbumTracksGetGet200ResponseMessageBody] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "body": AlbumTracksGetGet200ResponseMessageBody.from_dict(obj["body"]) if obj.get("body") is not None else None,
