...
from openapi_client.models.album_tracks_get_get200_response_message_header import AlbumTracksGetGet200ResponseMessageHeader
...
class ArtistRelatedGetGet200ResponseMessage(BaseModel):
    """
    ArtistRelatedGetGet200ResponseMessage
    """ # noqa: E501
    body: Optional[ArtistRelatedGetGet200ResponseMessageBody] = None
    header: Optional[AlbumTracksGetGet200ResponseMessageHeader] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "body": ArtistRelatedGetGet200ResponseMessageBody.from_dict(obj["body"]) if obj.get("body") is not None else None,
            "header": AlbumTracksGetGet200ResponseMessageHeader.from_dict(obj["header"]) if obj.get("header") is not None else None
        })
        return _obj
