...
class MatcherSubtitleGetGet200ResponseMessageBody(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MatcherSubtitleGetGet200ResponseMessageBody from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MatcherSubtitleGetGet200ResponseMessageBody from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "subtitle": Subtitle.from_dict(obj["subtitle"]) if obj.get("subtitle") is not None else None
        })
        return _obj
