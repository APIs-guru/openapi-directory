...
class Snippet(BaseModel):
    ...
    snippet_body: Optional[StrictStr] = None
    snippet_id: Optional[Union[StrictFloat, StrictInt]] = None
    snippet_language: Optional[StrictStr] = None
    updated_time: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["html_tracking_url", "instrumental", "pixel_tracking_url", "restricted", "script_tracking_url", "snippet_body", "snippet_id", "snippet_language", "updated_time"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "snippet_body": obj.get("snippet_body"),
            "snippet_id": obj.get("snippet_id"),
            "snippet_language": obj.get("snippet_language"),
