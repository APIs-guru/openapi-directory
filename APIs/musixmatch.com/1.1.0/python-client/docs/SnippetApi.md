...
> TrackSnippetGetGet200Response track_snippet_get_get(track_id, format=format, param_callback=param_callback)
...
with openapi_client.ApiClient(configuration) as api_client:
    ...
    api_instance = openapi_client.SnippetApi(api_client)
    ...
    try:
        api_response = api_instance.track_snippet_get_get(track_id, format=format, param_callback=param_callback)
        print("The response of SnippetApi->track_snippet_get_get:\n")
        pprint(api_response)
