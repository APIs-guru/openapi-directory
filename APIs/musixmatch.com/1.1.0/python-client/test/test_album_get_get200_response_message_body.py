...
class TestAlbumGetGet200ResponseMessageBody(unittest.TestCase):
    """AlbumGetGet200ResponseMessageBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlbumGetGet200ResponseMessageBody:
        """Test AlbumGetGet200ResponseMessageBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlbumGetGet200ResponseMessageBody`
        """
        model = AlbumGetGet200ResponseMessageBody()
        if include_optional:
            return AlbumGetGet200ResponseMessageBody(
    ...
    def testAlbumGetGet200ResponseMessageBody(self):
        """Test AlbumGetGet200ResponseMessageBody"""
