...
class TestArtistRelatedGetGet200ResponseMessageBody(unittest.TestCase):
    """ArtistRelatedGetGet200ResponseMessageBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArtistRelatedGetGet200ResponseMessageBody:
        """Test ArtistRelatedGetGet200ResponseMessageBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArtistRelatedGetGet200ResponseMessageBody`
        """
        model = ArtistRelatedGetGet200ResponseMessageBody()
        if include_optional:
            return ArtistRelatedGetGet200ResponseMessageBody(
                artist_list = [
    ...
    def testArtistRelatedGetGet200ResponseMessageBody(self):
        """Test ArtistRelatedGetGet200ResponseMessageBody"""
