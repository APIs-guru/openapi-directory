...
class TestAlbumGetGet200Response(unittest.TestCase):
    """AlbumGetGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlbumGetGet200Response:
        """Test AlbumGetGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlbumGetGet200Response`
        """
        model = AlbumGetGet200Response()
        if include_optional:
            return AlbumGetGet200Response(
                message = openapi_client.models._album_get_get_200_response_message._album_get_get_200_response_message(
                    body = openapi_client.models._album_get_get_200_response_message_body._album_get_get_200_response_message_body(
    ...
    def testAlbumGetGet200Response(self):
        """Test AlbumGetGet200Response"""
