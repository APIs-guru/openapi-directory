...
class TestChartTracksGetGet200ResponseMessageBody(unittest.TestCase):
    """ChartTracksGetGet200ResponseMessageBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChartTracksGetGet200ResponseMessageBody:
        """Test ChartTracksGetGet200ResponseMessageBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChartTracksGetGet200ResponseMessageBody`
        """
        model = ChartTracksGetGet200ResponseMessageBody()
        if include_optional:
            return ChartTracksGetGet200ResponseMessageBody(
                track_list = [
    ...
    def testChartTracksGetGet200ResponseMessageBody(self):
        """Test ChartTracksGetGet200ResponseMessageBody"""
