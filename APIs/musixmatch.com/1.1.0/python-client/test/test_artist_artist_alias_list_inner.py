...
class TestArtistArtistAliasListInner(unittest.TestCase):
    """ArtistArtistAliasListInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArtistArtistAliasListInner:
        """Test ArtistArtistAliasListInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArtistArtistAliasListInner`
        """
        model = ArtistArtistAliasListInner()
        if include_optional:
            return ArtistArtistAliasListInner(
                artist_alias = ''
            )
        else:
            return ArtistArtistAliasListInner(
    ...
    def testArtistArtistAliasListInner(self):
        """Test ArtistArtistAliasListInner"""
