...
class TestAlbumTracksGetGet200ResponseMessage(unittest.TestCase):
    """AlbumTracksGetGet200ResponseMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlbumTracksGetGet200ResponseMessage:
        """Test AlbumTracksGetGet200ResponseMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlbumTracksGetGet200ResponseMessage`
        """
        model = AlbumTracksGetGet200ResponseMessage()
        if include_optional:
            return AlbumTracksGetGet200ResponseMessage(
    ...
    def testAlbumTracksGetGet200ResponseMessage(self):
        """Test AlbumTracksGetGet200ResponseMessage"""
