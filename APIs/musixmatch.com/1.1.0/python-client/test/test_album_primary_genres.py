...
class TestAlbumPrimaryGenres(unittest.TestCase):
    """AlbumPrimaryGenres unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlbumPrimaryGenres:
        """Test AlbumPrimaryGenres
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlbumPrimaryGenres`
        """
        model = AlbumPrimaryGenres()
        if include_optional:
            return AlbumPrimaryGenres(
                music_genre_list = [
    ...
    def testAlbumPrimaryGenres(self):
        """Test AlbumPrimaryGenres"""
