...
class TestArtistRelatedGetGet200Response(unittest.TestCase):
    """ArtistRelatedGetGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArtistRelatedGetGet200Response:
        """Test ArtistRelatedGetGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArtistRelatedGetGet200Response`
        """
        model = ArtistRelatedGetGet200Response()
        if include_optional:
            return ArtistRelatedGetGet200Response(
                message = openapi_client.models._artist_related_get_get_200_response_message._artist_related_get_get_200_response_message(
                    body = openapi_client.models._artist_related_get_get_200_response_message_body._artist_related_get_get_200_response_message_body(
                        artist_list = [
                            openapi_client.models._artist_get_get_200_response_message_body._artist_get_get_200_response_message_body(
    ...
    def testArtistRelatedGetGet200Response(self):
        """Test ArtistRelatedGetGet200Response"""
