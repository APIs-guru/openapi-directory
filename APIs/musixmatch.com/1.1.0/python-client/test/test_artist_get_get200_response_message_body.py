...
class TestArtistGetGet200ResponseMessageBody(unittest.TestCase):
    """ArtistGetGet200ResponseMessageBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArtistGetGet200ResponseMessageBody:
        """Test ArtistGetGet200ResponseMessageBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArtistGetGet200ResponseMessageBody`
        """
        model = ArtistGetGet200ResponseMessageBody()
        if include_optional:
            return ArtistGetGet200ResponseMessageBody(
    ...
    def testArtistGetGet200ResponseMessageBody(self):
        """Test ArtistGetGet200ResponseMessageBody"""
