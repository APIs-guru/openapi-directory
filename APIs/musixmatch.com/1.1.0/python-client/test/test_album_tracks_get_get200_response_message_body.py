...
class TestAlbumTracksGetGet200ResponseMessageBody(unittest.TestCase):
    """AlbumTracksGetGet200ResponseMessageBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlbumTracksGetGet200ResponseMessageBody:
        """Test AlbumTracksGetGet200ResponseMessageBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlbumTracksGetGet200ResponseMessageBody`
        """
        model = AlbumTracksGetGet200ResponseMessageBody()
        if include_optional:
            return AlbumTracksGetGet200ResponseMessageBody(
                track_list = [
                    openapi_client.models.a_track_object.a Track object(
    ...
    def testAlbumTracksGetGet200ResponseMessageBody(self):
        """Test AlbumTracksGetGet200ResponseMessageBody"""
