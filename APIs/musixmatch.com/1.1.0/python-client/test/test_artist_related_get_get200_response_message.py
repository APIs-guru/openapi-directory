...
class TestArtistRelatedGetGet200ResponseMessage(unittest.TestCase):
    """ArtistRelatedGetGet200ResponseMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArtistRelatedGetGet200ResponseMessage:
        """Test ArtistRelatedGetGet200ResponseMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArtistRelatedGetGet200ResponseMessage`
        """
        model = ArtistRelatedGetGet200ResponseMessage()
        if include_optional:
            return ArtistRelatedGetGet200ResponseMessage(
    ...
    def testArtistRelatedGetGet200ResponseMessage(self):
        """Test ArtistRelatedGetGet200ResponseMessage"""
