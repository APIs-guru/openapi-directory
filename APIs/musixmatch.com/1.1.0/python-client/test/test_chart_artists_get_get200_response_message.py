...
class TestChartArtistsGetGet200ResponseMessage(unittest.TestCase):
    """ChartArtistsGetGet200ResponseMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChartArtistsGetGet200ResponseMessage:
        """Test ChartArtistsGetGet200ResponseMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChartArtistsGetGet200ResponseMessage`
        """
        model = ChartArtistsGetGet200ResponseMessage()
        if include_optional:
            return ChartArtistsGetGet200ResponseMessage(
    ...
    def testChartArtistsGetGet200ResponseMessage(self):
        """Test ChartArtistsGetGet200ResponseMessage"""
