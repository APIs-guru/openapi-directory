...
class TestArtistApi(unittest.TestCase):
    ...
    def test_artist_get_get(self) -> None:
        """Test case for artist_get_get

        """
        pass

    def test_artist_related_get_get(self) -> None:
        """Test case for artist_related_get_get

        """
        pass

    def test_artist_search_get(self) -> None:
        """Test case for artist_search_get

        """
        pass

    def test_chart_artists_get_get(self) -> None:
