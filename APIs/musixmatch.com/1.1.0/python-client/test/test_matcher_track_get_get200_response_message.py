...
class TestMatcherTrackGetGet200ResponseMessage(unittest.TestCase):
    """MatcherTrackGetGet200ResponseMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> MatcherTrackGetGet200ResponseMessage:
        """Test MatcherTrackGetGet200ResponseMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `MatcherTrackGetGet200ResponseMessage`
        """
        model = MatcherTrackGetGet200ResponseMessage()
        if include_optional:
            return MatcherTrackGetGet200ResponseMessage(
                body = openapi_client.models._chart_tracks_get_get_200_response_message_body_track_list_inner._chart_tracks_get_get_200_response_message_body_track_list_inner(
    ...
    def testMatcherTrackGetGet200ResponseMessage(self):
        """Test MatcherTrackGetGet200ResponseMessage"""
