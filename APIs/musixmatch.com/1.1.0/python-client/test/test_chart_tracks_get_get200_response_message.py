...
class TestChartTracksGetGet200ResponseMessage(unittest.TestCase):
    """ChartTracksGetGet200ResponseMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChartTracksGetGet200ResponseMessage:
        """Test ChartTracksGetGet200ResponseMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChartTracksGetGet200ResponseMessage`
        """
        model = ChartTracksGetGet200ResponseMessage()
        if include_optional:
            return ChartTracksGetGet200ResponseMessage(
                body = openapi_client.models._chart_tracks_get_get_200_response_message_body._chart_tracks_get_get_200_response_message_body(
                    track_list = [
                        openapi_client.models._chart_tracks_get_get_200_response_message_body_track_list_inner._chart_tracks_get_get_200_response_message_body_track_list_inner(
                            track = openapi_client.models.a_track_object.a Track object(
                                ...
                                restricted = 1.337, 
                                secondary_genres = openapi_client.models.album_primary_genres.Album_primary_genres(), 
                                subtitle_id = 1.337, 
                                track_edit_url = '', 
                                track_id = 1.337, 
                                track_isrc = '', 
                                ...
                                track_rating = 1.337, 
                                track_share_url = '', 
                                track_soundcloud_id = 1.337, 
                                track_spotify_id = '', 
                                track_xboxmusic_id = '', 
                                updated_time = '', ), )
                        ], ),
                header = openapi_client.models._chart_artists_get_get_200_response_message_header._chart_artists_get_get_200_response_message_header(
                    available = 1.337, 
                    execute_time = 1.337, 
                    status_code = 1.337, )
            )
    ...
    def testChartTracksGetGet200ResponseMessage(self):
        """Test ChartTracksGetGet200ResponseMessage"""
