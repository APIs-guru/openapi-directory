...
class TestAlbumPrimaryGenresMusicGenreListInnerMusicGenre(unittest.TestCase):
    """AlbumPrimaryGenresMusicGenreListInnerMusicGenre unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlbumPrimaryGenresMusicGenreListInnerMusicGenre:
        """Test AlbumPrimaryGenresMusicGenreListInnerMusicGenre
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlbumPrimaryGenresMusicGenreListInnerMusicGenre`
        """
        model = AlbumPrimaryGenresMusicGenreListInnerMusicGenre()
        if include_optional:
            return AlbumPrimaryGenresMusicGenreListInnerMusicGenre(
    ...
    def testAlbumPrimaryGenresMusicGenreListInnerMusicGenre(self):
        """Test AlbumPrimaryGenresMusicGenreListInnerMusicGenre"""
