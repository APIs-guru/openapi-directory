...
class TestAlbumTracksGetGet200Response(unittest.TestCase):
    """AlbumTracksGetGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlbumTracksGetGet200Response:
        """Test AlbumTracksGetGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlbumTracksGetGet200Response`
        """
        model = AlbumTracksGetGet200Response()
        if include_optional:
            return AlbumTracksGetGet200Response(
                message = openapi_client.models._album_tracks_get_get_200_response_message._album_tracks_get_get_200_response_message(
                    body = openapi_client.models._album_tracks_get_get_200_response_message_body._album_tracks_get_get_200_response_message_body(
                        track_list = [
    ...
    def testAlbumTracksGetGet200Response(self):
        """Test AlbumTracksGetGet200Response"""
