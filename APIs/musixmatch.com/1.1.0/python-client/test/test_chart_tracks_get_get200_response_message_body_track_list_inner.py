...
class TestChartTracksGetGet200ResponseMessageBodyTrackListInner(unittest.TestCase):
    """ChartTracksGetGet200ResponseMessageBodyTrackListInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ChartTracksGetGet200ResponseMessageBodyTrackListInner:
        """Test ChartTracksGetGet200ResponseMessageBodyTrackListInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ChartTracksGetGet200ResponseMessageBodyTrackListInner`
        """
        model = ChartTracksGetGet200ResponseMessageBodyTrackListInner()
        if include_optional:
            return ChartTracksGetGet200ResponseMessageBodyTrackListInner(
    ...
    def testChartTracksGetGet200ResponseMessageBodyTrackListInner(self):
        """Test ChartTracksGetGet200ResponseMessageBodyTrackListInner"""
