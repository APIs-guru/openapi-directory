...
class TestArtistAlbumsGetGet200ResponseMessage(unittest.TestCase):
    """ArtistAlbumsGetGet200ResponseMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArtistAlbumsGetGet200ResponseMessage:
        """Test ArtistAlbumsGetGet200ResponseMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArtistAlbumsGetGet200ResponseMessage`
        """
        model = ArtistAlbumsGetGet200ResponseMessage()
        if include_optional:
            return ArtistAlbumsGetGet200ResponseMessage(
                body = openapi_client.models._artist_albums_get_get_200_response_message_body._artist_albums_get_get_200_response_message_body(
                    album_list = [
                        openapi_client.models._album_get_get_200_response_message_body._album_get_get_200_response_message_body(
                            album = openapi_client.models.a_album_object.a Album object(
                                album_copyright = '', 
                ...
                header = openapi_client.models._album_tracks_get_get_200_response_message_header._album_tracks_get_get_200_response_message_header(
                    available = 1.337, 
                    execute_time = 1.337, 
                    status_code = 1.337, )
            )
    ...
    def testArtistAlbumsGetGet200ResponseMessage(self):
        """Test ArtistAlbumsGetGet200ResponseMessage"""
