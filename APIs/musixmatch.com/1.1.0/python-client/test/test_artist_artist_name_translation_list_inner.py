...
class TestArtistArtistNameTranslationListInner(unittest.TestCase):
    """ArtistArtistNameTranslationListInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArtistArtistNameTranslationListInner:
        """Test ArtistArtistNameTranslationListInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArtistArtistNameTranslationListInner`
        """
        model = ArtistArtistNameTranslationListInner()
        if include_optional:
            return ArtistArtistNameTranslationListInner(
    ...
    def testArtistArtistNameTranslationListInner(self):
        """Test ArtistArtistNameTranslationListInner"""
