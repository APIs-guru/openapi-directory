...
class TestAlbumGetGet200ResponseMessage(unittest.TestCase):
    """AlbumGetGet200ResponseMessage unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlbumGetGet200ResponseMessage:
        """Test AlbumGetGet200ResponseMessage
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlbumGetGet200ResponseMessage`
        """
        model = AlbumGetGet200ResponseMessage()
        if include_optional:
            return AlbumGetGet200ResponseMessage(
    ...
    def testAlbumGetGet200ResponseMessage(self):
        """Test AlbumGetGet200ResponseMessage"""
