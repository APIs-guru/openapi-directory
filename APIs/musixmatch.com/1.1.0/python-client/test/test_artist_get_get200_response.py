...
class TestArtistGetGet200Response(unittest.TestCase):
    """ArtistGetGet200Response unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArtistGetGet200Response:
        """Test ArtistGetGet200Response
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArtistGetGet200Response`
        """
        model = ArtistGetGet200Response()
        if include_optional:
            return ArtistGetGet200Response(
                message = openapi_client.models._artist_get_get_200_response_message._artist_get_get_200_response_message(
    ...
    def testArtistGetGet200Response(self):
        """Test ArtistGetGet200Response"""
