...
class TestAlbumPrimaryGenresMusicGenreListInner(unittest.TestCase):
    """AlbumPrimaryGenresMusicGenreListInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlbumPrimaryGenresMusicGenreListInner:
        """Test AlbumPrimaryGenresMusicGenreListInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlbumPrimaryGenresMusicGenreListInner`
        """
        model = AlbumPrimaryGenresMusicGenreListInner()
        if include_optional:
            return AlbumPrimaryGenresMusicGenreListInner(
    ...
    def testAlbumPrimaryGenresMusicGenreListInner(self):
        """Test AlbumPrimaryGenresMusicGenreListInner"""
