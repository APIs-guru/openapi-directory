...
class TestAlbumSecondaryGenres(unittest.TestCase):
    """AlbumSecondaryGenres unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AlbumSecondaryGenres:
        """Test AlbumSecondaryGenres
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AlbumSecondaryGenres`
        """
        model = AlbumSecondaryGenres()
        if include_optional:
            return AlbumSecondaryGenres(
                music_genre_list = [
                    ''
                    ]
            )
    ...
    def testAlbumSecondaryGenres(self):
        """Test AlbumSecondaryGenres"""
