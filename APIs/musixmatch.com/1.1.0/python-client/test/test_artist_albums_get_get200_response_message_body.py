...
class TestArtistAlbumsGetGet200ResponseMessageBody(unittest.TestCase):
    """ArtistAlbumsGetGet200ResponseMessageBody unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArtistAlbumsGetGet200ResponseMessageBody:
        """Test ArtistAlbumsGetGet200ResponseMessageBody
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArtistAlbumsGetGet200ResponseMessageBody`
        """
        model = ArtistAlbumsGetGet200ResponseMessageBody()
        if include_optional:
            return ArtistAlbumsGetGet200ResponseMessageBody(
                album_list = [
    ...
    def testArtistAlbumsGetGet200ResponseMessageBody(self):
        """Test ArtistAlbumsGetGet200ResponseMessageBody"""
