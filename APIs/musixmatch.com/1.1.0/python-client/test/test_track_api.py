...
from openapi_client.api.track_api import TrackApi
...
class TestTrackApi(unittest.TestCase):
    ...
    def test_album_tracks_get_get(self) -> None:
        """Test case for album_tracks_get_get

        """
        pass

    def test_chart_tracks_get_get(self) -> None:
        """Test case for chart_tracks_get_get

        """
        pass

    def test_matcher_track_get_get(self) -> None:
        """Test case for matcher_track_get_get

        """
        pass

    def test_track_get_get(self) -> None:
        """Test case for track_get_get

        """
        pass

    def test_track_search_get(self) -> None:
