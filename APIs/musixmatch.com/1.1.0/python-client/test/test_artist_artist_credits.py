...
class TestArtistArtistCredits(unittest.TestCase):
    """ArtistArtistCredits unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ArtistArtistCredits:
        """Test ArtistArtistCredits
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ArtistArtistCredits`
        """
        model = ArtistArtistCredits()
        if include_optional:
            return ArtistArtistCredits(
                artist_list = [
                    ''
                    ]
            )
    ...
    def testArtistArtistCredits(self):
        """Test ArtistArtistCredits"""
