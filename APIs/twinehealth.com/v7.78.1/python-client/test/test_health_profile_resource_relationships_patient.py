...
class TestHealthProfileResourceRelationshipsPatient(unittest.TestCase):
    """HealthProfileResourceRelationshipsPatient unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HealthProfileResourceRelationshipsPatient:
        """Test HealthProfileResourceRelationshipsPatient
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HealthProfileResourceRelationshipsPatient`
        """
        model = HealthProfileResourceRelationshipsPatient()
        if include_optional:
            return HealthProfileResourceRelationshipsPatient(
                data = openapi_client.models.action_resource_relationships_plan_data.ActionResource_relationships_plan_data(
                    id = '', 
                    type = '', ),
                links = openapi_client.models.health_profile_resource_relationships_patient_links.HealthProfileResource_relationships_patient_links(
    ...
    def testHealthProfileResourceRelationshipsPatient(self):
        """Test HealthProfileResourceRelationshipsPatient"""
