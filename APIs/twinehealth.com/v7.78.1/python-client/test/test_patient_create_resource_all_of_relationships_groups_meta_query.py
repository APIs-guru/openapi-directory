...
class TestPatientCreateResourceAllOfRelationshipsGroupsMetaQuery(unittest.TestCase):
    """PatientCreateResourceAllOfRelationshipsGroupsMetaQuery unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatientCreateResourceAllOfRelationshipsGroupsMetaQuery:
        """Test PatientCreateResourceAllOfRelationshipsGroupsMetaQuery
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatientCreateResourceAllOfRelationshipsGroupsMetaQuery`
        """
        model = PatientCreateResourceAllOfRelationshipsGroupsMetaQuery()
        if include_optional:
            return PatientCreateResourceAllOfRelationshipsGroupsMetaQuery(
                name = '',
                organization = ''
            )
        else:
    ...
    def testPatientCreateResourceAllOfRelationshipsGroupsMetaQuery(self):
        """Test PatientCreateResourceAllOfRelationshipsGroupsMetaQuery"""
