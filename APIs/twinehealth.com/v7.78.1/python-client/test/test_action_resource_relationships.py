...
class TestActionResourceRelationships(unittest.TestCase):
    """ActionResourceRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActionResourceRelationships:
        """Test ActionResourceRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionResourceRelationships`
        """
        model = ActionResourceRelationships()
        if include_optional:
    ...
    def testActionResourceRelationships(self):
        """Test ActionResourceRelationships"""
