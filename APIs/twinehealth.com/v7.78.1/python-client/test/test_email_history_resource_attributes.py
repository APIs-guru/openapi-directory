...
class TestEmailHistoryResourceAttributes(unittest.TestCase):
    """EmailHistoryResourceAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailHistoryResourceAttributes:
        """Test EmailHistoryResourceAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailHistoryResourceAttributes`
        """
        model = EmailHistoryResourceAttributes()
        if include_optional:
    ...
    def testEmailHistoryResourceAttributes(self):
        """Test EmailHistoryResourceAttributes"""
