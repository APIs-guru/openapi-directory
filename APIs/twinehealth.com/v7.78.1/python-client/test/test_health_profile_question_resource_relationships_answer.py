...
class TestHealthProfileQuestionResourceRelationshipsAnswer(unittest.TestCase):
    """HealthProfileQuestionResourceRelationshipsAnswer unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HealthProfileQuestionResourceRelationshipsAnswer:
        """Test HealthProfileQuestionResourceRelationshipsAnswer
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HealthProfileQuestionResourceRelationshipsAnswer`
        """
        model = HealthProfileQuestionResourceRelationshipsAnswer()
        if include_optional:
    ...
    def testHealthProfileQuestionResourceRelationshipsAnswer(self):
        """Test HealthProfileQuestionResourceRelationshipsAnswer"""
