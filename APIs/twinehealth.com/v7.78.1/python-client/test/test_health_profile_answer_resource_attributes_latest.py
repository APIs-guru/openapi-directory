...
class TestHealthProfileAnswerResourceAttributesLatest(unittest.TestCase):
    """HealthProfileAnswerResourceAttributesLatest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HealthProfileAnswerResourceAttributesLatest:
        """Test HealthProfileAnswerResourceAttributesLatest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HealthProfileAnswerResourceAttributesLatest`
        """
        model = HealthProfileAnswerResourceAttributesLatest()
        if include_optional:
    ...
    def testHealthProfileAnswerResourceAttributesLatest(self):
        """Test HealthProfileAnswerResourceAttributesLatest"""
