...
class TestActionMetricValidations(unittest.TestCase):
    """ActionMetricValidations unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActionMetricValidations:
        """Test ActionMetricValidations
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionMetricValidations`
        """
        model = ActionMetricValidations()
        if include_optional:
    ...
    def testActionMetricValidations(self):
        """Test ActionMetricValidations"""
