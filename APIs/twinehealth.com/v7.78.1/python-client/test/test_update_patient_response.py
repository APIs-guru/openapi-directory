...
class TestUpdatePatientResponse(unittest.TestCase):
    """UpdatePatientResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePatientResponse:
        """Test UpdatePatientResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePatientResponse`
        """
        model = UpdatePatientResponse()
        if include_optional:
    ...
    def testUpdatePatientResponse(self):
        """Test UpdatePatientResponse"""
