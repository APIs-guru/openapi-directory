...
class TestPatientIdentifier(unittest.TestCase):
    """PatientIdentifier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatientIdentifier:
        """Test PatientIdentifier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatientIdentifier`
        """
    ...
    def testPatientIdentifier(self):
        """Test PatientIdentifier"""
