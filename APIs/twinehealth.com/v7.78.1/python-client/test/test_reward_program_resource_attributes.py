...
class TestRewardProgramResourceAttributes(unittest.TestCase):
    """RewardProgramResourceAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RewardProgramResourceAttributes:
        """Test RewardProgramResourceAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RewardProgramResourceAttributes`
        """
        model = RewardProgramResourceAttributes()
        if include_optional:
    ...
    def testRewardProgramResourceAttributes(self):
        """Test RewardProgramResourceAttributes"""
