...
class TestFetchOrganizationResponse(unittest.TestCase):
    """FetchOrganizationResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FetchOrganizationResponse:
        """Test FetchOrganizationResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FetchOrganizationResponse`
        """
        model = FetchOrganizationResponse()
        if include_optional:
            return FetchOrganizationResponse(
                data = openapi_client.models.organization_resource.OrganizationResource(
                    attributes = openapi_client.models.organization_resource_attributes.OrganizationResource_attributes(
                        name = 'Health Activation Partners', ), 
                    id = '57b36e3c04ad8c2224f2af38', 
                    links = openapi_client.models.organization_resource_links.OrganizationResource_links(
                        self = '/organization/57b36e3c04ad8c2224f2af38', ), 
                    type = 'organization', ),
    ...
    def testFetchOrganizationResponse(self):
        """Test FetchOrganizationResponse"""
