...
class TestHealthProfileResourceAttributesStatsInner(unittest.TestCase):
    """HealthProfileResourceAttributesStatsInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HealthProfileResourceAttributesStatsInner:
        """Test HealthProfileResourceAttributesStatsInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HealthProfileResourceAttributesStatsInner`
        """
        model = HealthProfileResourceAttributesStatsInner()
        if include_optional:
            return HealthProfileResourceAttributesStatsInner(
                answered = 1.337,
    ...
    def testHealthProfileResourceAttributesStatsInner(self):
        """Test HealthProfileResourceAttributesStatsInner"""
