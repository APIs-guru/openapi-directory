...
class TestUpsertPatientRequestMetaQueryIdentifier(unittest.TestCase):
    """UpsertPatientRequestMetaQueryIdentifier unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertPatientRequestMetaQueryIdentifier:
        """Test UpsertPatientRequestMetaQueryIdentifier
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertPatientRequestMetaQueryIdentifier`
        """
        model = UpsertPatientRequestMetaQueryIdentifier()
        if include_optional:
    ...
    def testUpsertPatientRequestMetaQueryIdentifier(self):
        """Test UpsertPatientRequestMetaQueryIdentifier"""
