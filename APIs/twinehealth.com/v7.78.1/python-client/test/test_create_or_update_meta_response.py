...
class TestCreateOrUpdateMetaResponse(unittest.TestCase):
    """CreateOrUpdateMetaResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateOrUpdateMetaResponse:
        """Test CreateOrUpdateMetaResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateOrUpdateMetaResponse`
        """
        model = CreateOrUpdateMetaResponse()
        if include_optional:
    ...
    def testCreateOrUpdateMetaResponse(self):
        """Test CreateOrUpdateMetaResponse"""
