...
class TestCreateCalendarEventResponse(unittest.TestCase):
    """CreateCalendarEventResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateCalendarEventResponse:
        """Test CreateCalendarEventResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateCalendarEventResponse`
        """
        model = CreateCalendarEventResponse()
        if include_optional:
    ...
    def testCreateCalendarEventResponse(self):
        """Test CreateCalendarEventResponse"""
