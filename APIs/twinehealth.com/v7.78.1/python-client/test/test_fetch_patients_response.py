...
class TestFetchPatientsResponse(unittest.TestCase):
    """FetchPatientsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FetchPatientsResponse:
        """Test FetchPatientsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FetchPatientsResponse`
        """
        model = FetchPatientsResponse()
        if include_optional:
            return FetchPatientsResponse(
                data = [
                    openapi_client.models.patient_resource.PatientResource(
    ...
    def testFetchPatientsResponse(self):
        """Test FetchPatientsResponse"""
