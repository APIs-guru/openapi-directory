...
class TestFetchCoachesResponse(unittest.TestCase):
    """FetchCoachesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FetchCoachesResponse:
        """Test FetchCoachesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FetchCoachesResponse`
        """
        model = FetchCoachesResponse()
        if include_optional:
            return FetchCoachesResponse(
                data = [
                    openapi_client.models.coach_resource.CoachResource(
                        attributes = openapi_client.models.coach_resource_attributes.CoachResource_attributes(
                            first_name = 'Clarisa', 
                            last_name = 'Rivera', ), 
                        id = '57b36e3c04ad8c2224f2af38', 
                        links = openapi_client.models.coach_resource_links.CoachResource_links(
                            self = '/coach/57b36e3c04ad8c2224f2af38', ), 
                        type = 'coach', )
                    ],
    ...
    def testFetchCoachesResponse(self):
        """Test FetchCoachesResponse"""
