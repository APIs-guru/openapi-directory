...
class TestHealthProfileResourceAttributes(unittest.TestCase):
    """HealthProfileResourceAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HealthProfileResourceAttributes:
        """Test HealthProfileResourceAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HealthProfileResourceAttributes`
        """
        model = HealthProfileResourceAttributes()
        if include_optional:
            return HealthProfileResourceAttributes(
                stats = [
                    openapi_client.models.health_profile_resource_attributes_stats_inner.HealthProfileResource_attributes_stats_inner(
                        answered = 1.337, 
    ...
    def testHealthProfileResourceAttributes(self):
        """Test HealthProfileResourceAttributes"""
