...
class TestCreatePatientHealthMetricRequestMeta(unittest.TestCase):
    """CreatePatientHealthMetricRequestMeta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreatePatientHealthMetricRequestMeta:
        """Test CreatePatientHealthMetricRequestMeta
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreatePatientHealthMetricRequestMeta`
        """
        model = CreatePatientHealthMetricRequestMeta()
        if include_optional:
    ...
    def testCreatePatientHealthMetricRequestMeta(self):
        """Test CreatePatientHealthMetricRequestMeta"""
