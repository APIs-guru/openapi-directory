...
class TestFetchMetaResponse(unittest.TestCase):
    """FetchMetaResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FetchMetaResponse:
        """Test FetchMetaResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FetchMetaResponse`
        """
        model = FetchMetaResponse()
        if include_optional:
    ...
    def testFetchMetaResponse(self):
        """Test FetchMetaResponse"""
