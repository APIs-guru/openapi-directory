...
class TestUpdatePatientPlanSummaryRequest(unittest.TestCase):
    """UpdatePatientPlanSummaryRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdatePatientPlanSummaryRequest:
        """Test UpdatePatientPlanSummaryRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdatePatientPlanSummaryRequest`
        """
        model = UpdatePatientPlanSummaryRequest()
        if include_optional:
    ...
    def testUpdatePatientPlanSummaryRequest(self):
        """Test UpdatePatientPlanSummaryRequest"""
