...
class TestEmailHistoryApi(unittest.TestCase):
    """EmailHistoryApi unit test stubs"""

    def setUp(self) -> None:
        self.api = EmailHistoryApi()

    def tearDown(self) -> None:
        pass

    def test_fetch_email_histories(self) -> None:
    ...
    def test_fetch_email_history(self) -> None:
