...
class TestFetchErrorResponse(unittest.TestCase):
    """FetchErrorResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FetchErrorResponse:
        """Test FetchErrorResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FetchErrorResponse`
        """
    ...
    def testFetchErrorResponse(self):
        """Test FetchErrorResponse"""
