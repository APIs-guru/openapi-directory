...
class TestGroupResourceLinks(unittest.TestCase):
    """GroupResourceLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupResourceLinks:
        """Test GroupResourceLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupResourceLinks`
        """
        model = GroupResourceLinks()
        if include_optional:
            return GroupResourceLinks(
                var_self = '/group/57b36e3c04ad8c2224f2af38'
            )
        else:
            return GroupResourceLinks(
                var_self = '/group/57b36e3c04ad8c2224f2af38',
    ...
    def testGroupResourceLinks(self):
        """Test GroupResourceLinks"""
