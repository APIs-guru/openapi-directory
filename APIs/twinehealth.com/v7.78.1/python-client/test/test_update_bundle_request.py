...
class TestUpdateBundleRequest(unittest.TestCase):
    """UpdateBundleRequest unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateBundleRequest:
        """Test UpdateBundleRequest
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateBundleRequest`
        """
        model = UpdateBundleRequest()
        if include_optional:
    ...
    def testUpdateBundleRequest(self):
        """Test UpdateBundleRequest"""
