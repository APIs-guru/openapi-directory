...
class TestRewardProgramActivationResourceAttributes(unittest.TestCase):
    """RewardProgramActivationResourceAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RewardProgramActivationResourceAttributes:
        """Test RewardProgramActivationResourceAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RewardProgramActivationResourceAttributes`
        """
        model = RewardProgramActivationResourceAttributes()
        if include_optional:
    ...
    def testRewardProgramActivationResourceAttributes(self):
        """Test RewardProgramActivationResourceAttributes"""
