...
class TestFetchHealthProfilesResponse(unittest.TestCase):
    """FetchHealthProfilesResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FetchHealthProfilesResponse:
        """Test FetchHealthProfilesResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FetchHealthProfilesResponse`
        """
        model = FetchHealthProfilesResponse()
        if include_optional:
    ...
    def testFetchHealthProfilesResponse(self):
        """Test FetchHealthProfilesResponse"""
