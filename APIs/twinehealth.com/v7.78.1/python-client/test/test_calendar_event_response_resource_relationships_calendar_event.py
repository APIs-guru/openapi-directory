...
class TestCalendarEventResponseResourceRelationshipsCalendarEvent(unittest.TestCase):
    """CalendarEventResponseResourceRelationshipsCalendarEvent unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarEventResponseResourceRelationshipsCalendarEvent:
        """Test CalendarEventResponseResourceRelationshipsCalendarEvent
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarEventResponseResourceRelationshipsCalendarEvent`
        """
        model = CalendarEventResponseResourceRelationshipsCalendarEvent()
        if include_optional:
            return CalendarEventResponseResourceRelationshipsCalendarEvent(
    ...
    def testCalendarEventResponseResourceRelationshipsCalendarEvent(self):
        """Test CalendarEventResponseResourceRelationshipsCalendarEvent"""
