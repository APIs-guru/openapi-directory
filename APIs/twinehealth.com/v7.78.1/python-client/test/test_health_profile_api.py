...
class TestHealthProfileApi(unittest.TestCase):
    """HealthProfileApi unit test stubs"""

    def setUp(self) -> None:
        self.api = HealthProfileApi()

    def tearDown(self) -> None:
        pass

    def test_fetch_health_profile(self) -> None:
    ...
    def test_fetch_health_profiles(self) -> None:
