...
class TestFetchCalendarEventResponse(unittest.TestCase):
    """FetchCalendarEventResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FetchCalendarEventResponse:
        """Test FetchCalendarEventResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FetchCalendarEventResponse`
        """
        model = FetchCalendarEventResponse()
        if include_optional:
    ...
    def testFetchCalendarEventResponse(self):
        """Test FetchCalendarEventResponse"""
