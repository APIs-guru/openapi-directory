...
class TestCreatePatientRequestMeta(unittest.TestCase):
    """CreatePatientRequestMeta unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreatePatientRequestMeta:
        """Test CreatePatientRequestMeta
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreatePatientRequestMeta`
        """
        model = CreatePatientRequestMeta()
        if include_optional:
            return CreatePatientRequestMeta(
    ...
    def testCreatePatientRequestMeta(self):
        """Test CreatePatientRequestMeta"""
