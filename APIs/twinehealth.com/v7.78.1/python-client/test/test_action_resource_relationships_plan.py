...
class TestActionResourceRelationshipsPlan(unittest.TestCase):
    """ActionResourceRelationshipsPlan unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActionResourceRelationshipsPlan:
        """Test ActionResourceRelationshipsPlan
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionResourceRelationshipsPlan`
        """
        model = ActionResourceRelationshipsPlan()
        if include_optional:
    ...
    def testActionResourceRelationshipsPlan(self):
        """Test ActionResourceRelationshipsPlan"""
