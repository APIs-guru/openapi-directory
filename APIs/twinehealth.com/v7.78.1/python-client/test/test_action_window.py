...
class TestActionWindow(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ActionWindow:
        """Test ActionWindow
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionWindow`
        """
        model = ActionWindow()
        if include_optional:
            return ActionWindow(
