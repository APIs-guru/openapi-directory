...
class TestPatientPlanSummaryResourceRelationshipsPatient(unittest.TestCase):
    """PatientPlanSummaryResourceRelationshipsPatient unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatientPlanSummaryResourceRelationshipsPatient:
        """Test PatientPlanSummaryResourceRelationshipsPatient
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatientPlanSummaryResourceRelationshipsPatient`
        """
        model = PatientPlanSummaryResourceRelationshipsPatient()
        if include_optional:
    ...
    def testPatientPlanSummaryResourceRelationshipsPatient(self):
        """Test PatientPlanSummaryResourceRelationshipsPatient"""
