...
class TestBundleResourceRelationships(unittest.TestCase):
    """BundleResourceRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BundleResourceRelationships:
        """Test BundleResourceRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BundleResourceRelationships`
        """
        model = BundleResourceRelationships()
        if include_optional:
    ...
    def testBundleResourceRelationships(self):
        """Test BundleResourceRelationships"""
