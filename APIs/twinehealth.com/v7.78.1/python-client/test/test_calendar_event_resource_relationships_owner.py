...
class TestCalendarEventResourceRelationshipsOwner(unittest.TestCase):
    """CalendarEventResourceRelationshipsOwner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarEventResourceRelationshipsOwner:
        """Test CalendarEventResourceRelationshipsOwner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarEventResourceRelationshipsOwner`
        """
        model = CalendarEventResourceRelationshipsOwner()
        if include_optional:
    ...
    def testCalendarEventResourceRelationshipsOwner(self):
        """Test CalendarEventResourceRelationshipsOwner"""
