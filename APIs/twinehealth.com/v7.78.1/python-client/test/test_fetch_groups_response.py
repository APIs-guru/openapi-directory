...
class TestFetchGroupsResponse(unittest.TestCase):
    """FetchGroupsResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FetchGroupsResponse:
        """Test FetchGroupsResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FetchGroupsResponse`
        """
        model = FetchGroupsResponse()
        if include_optional:
            return FetchGroupsResponse(
                data = [
                    openapi_client.models.group_resource.GroupResource(
                        attributes = openapi_client.models.group_resource_attributes.GroupResource_attributes(
                            bio = 'Team Health is all about the patient experience.', 
                            name = 'Team Health', ), 
                        id = '57b36e3c04ad8c2224f2af38', 
                        links = openapi_client.models.group_resource_links.GroupResource_links(
                            self = '/group/57b36e3c04ad8c2224f2af38', ), 
                        type = 'group', )
                    ],
    ...
    def testFetchGroupsResponse(self):
        """Test FetchGroupsResponse"""
