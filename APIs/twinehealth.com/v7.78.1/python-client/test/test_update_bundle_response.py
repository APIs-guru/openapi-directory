...
class TestUpdateBundleResponse(unittest.TestCase):
    """UpdateBundleResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpdateBundleResponse:
        """Test UpdateBundleResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpdateBundleResponse`
        """
        model = UpdateBundleResponse()
        if include_optional:
    ...
    def testUpdateBundleResponse(self):
        """Test UpdateBundleResponse"""
