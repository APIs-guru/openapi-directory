...
class TestCreateTokenRequestData(unittest.TestCase):
    """CreateTokenRequestData unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateTokenRequestData:
        """Test CreateTokenRequestData
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateTokenRequestData`
        """
        model = CreateTokenRequestData()
        if include_optional:
            return CreateTokenRequestData(
                attributes = openapi_client.models.create_token_request_data_attributes.CreateTokenRequest_data_attributes(
    ...
    def testCreateTokenRequestData(self):
        """Test CreateTokenRequestData"""
