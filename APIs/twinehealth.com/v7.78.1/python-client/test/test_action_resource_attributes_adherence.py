...
class TestActionResourceAttributesAdherence(unittest.TestCase):
    """ActionResourceAttributesAdherence unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActionResourceAttributesAdherence:
        """Test ActionResourceAttributesAdherence
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionResourceAttributesAdherence`
        """
        model = ActionResourceAttributesAdherence()
        if include_optional:
    ...
    def testActionResourceAttributesAdherence(self):
        """Test ActionResourceAttributesAdherence"""
