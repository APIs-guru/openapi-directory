...
class TestCoachResourceLinks(unittest.TestCase):
    """CoachResourceLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoachResourceLinks:
        """Test CoachResourceLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CoachResourceLinks`
        """
        model = CoachResourceLinks()
        if include_optional:
            return CoachResourceLinks(
                var_self = '/coach/57b36e3c04ad8c2224f2af38'
            )
        else:
            return CoachResourceLinks(
                var_self = '/coach/57b36e3c04ad8c2224f2af38',
    ...
    def testCoachResourceLinks(self):
        """Test CoachResourceLinks"""
