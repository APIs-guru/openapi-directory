...
class TestCollectionResponseLinks(unittest.TestCase):
    """CollectionResponseLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CollectionResponseLinks:
        """Test CollectionResponseLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CollectionResponseLinks`
        """
        model = CollectionResponseLinks()
        if include_optional:
            return CollectionResponseLinks(
                last = '',
                next = '',
                prev = '',
                var_self = ''
    ...
    def testCollectionResponseLinks(self):
        """Test CollectionResponseLinks"""
