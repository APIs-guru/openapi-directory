...
class TestActionMetric(unittest.TestCase):
    """ActionMetric unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ActionMetric:
        """Test ActionMetric
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ActionMetric`
        """
        model = ActionMetric()
        if include_optional:
            return ActionMetric(
