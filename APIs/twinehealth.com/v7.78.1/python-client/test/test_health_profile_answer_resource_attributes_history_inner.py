...
class TestHealthProfileAnswerResourceAttributesHistoryInner(unittest.TestCase):
    """HealthProfileAnswerResourceAttributesHistoryInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HealthProfileAnswerResourceAttributesHistoryInner:
        """Test HealthProfileAnswerResourceAttributesHistoryInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HealthProfileAnswerResourceAttributesHistoryInner`
        """
        model = HealthProfileAnswerResourceAttributesHistoryInner()
        if include_optional:
            return HealthProfileAnswerResourceAttributesHistoryInner(
                created_by = '',
                answered_at = '',
                value = ''
            )
    ...
    def testHealthProfileAnswerResourceAttributesHistoryInner(self):
        """Test HealthProfileAnswerResourceAttributesHistoryInner"""
