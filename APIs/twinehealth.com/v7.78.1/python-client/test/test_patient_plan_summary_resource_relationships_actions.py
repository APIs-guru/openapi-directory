...
class TestPatientPlanSummaryResourceRelationshipsActions(unittest.TestCase):
    """PatientPlanSummaryResourceRelationshipsActions unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatientPlanSummaryResourceRelationshipsActions:
        """Test PatientPlanSummaryResourceRelationshipsActions
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatientPlanSummaryResourceRelationshipsActions`
        """
        model = PatientPlanSummaryResourceRelationshipsActions()
        if include_optional:
    ...
    def testPatientPlanSummaryResourceRelationshipsActions(self):
        """Test PatientPlanSummaryResourceRelationshipsActions"""
