...
class TestPatientResourceRelationshipsGroups(unittest.TestCase):
    """PatientResourceRelationshipsGroups unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatientResourceRelationshipsGroups:
        """Test PatientResourceRelationshipsGroups
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatientResourceRelationshipsGroups`
        """
        model = PatientResourceRelationshipsGroups()
        if include_optional:
    ...
    def testPatientResourceRelationshipsGroups(self):
        """Test PatientResourceRelationshipsGroups"""
