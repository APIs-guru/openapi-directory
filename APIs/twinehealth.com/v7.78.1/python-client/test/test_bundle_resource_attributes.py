...
class TestBundleResourceAttributes(unittest.TestCase):
    """BundleResourceAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> BundleResourceAttributes:
        """Test BundleResourceAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `BundleResourceAttributes`
        """
        model = BundleResourceAttributes()
        if include_optional:
    ...
    def testBundleResourceAttributes(self):
        """Test BundleResourceAttributes"""
