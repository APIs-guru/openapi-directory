...
class TestFetchGroupResponse(unittest.TestCase):
    """FetchGroupResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FetchGroupResponse:
        """Test FetchGroupResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FetchGroupResponse`
        """
        model = FetchGroupResponse()
        if include_optional:
            return FetchGroupResponse(
                data = openapi_client.models.group_resource.GroupResource(
    ...
    def testFetchGroupResponse(self):
        """Test FetchGroupResponse"""
