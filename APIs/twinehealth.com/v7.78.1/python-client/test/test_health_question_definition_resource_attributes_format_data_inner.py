...
class TestHealthQuestionDefinitionResourceAttributesFormatDataInner(unittest.TestCase):
    """HealthQuestionDefinitionResourceAttributesFormatDataInner unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HealthQuestionDefinitionResourceAttributesFormatDataInner:
        """Test HealthQuestionDefinitionResourceAttributesFormatDataInner
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HealthQuestionDefinitionResourceAttributesFormatDataInner`
        """
        model = HealthQuestionDefinitionResourceAttributesFormatDataInner()
        if include_optional:
            return HealthQuestionDefinitionResourceAttributesFormatDataInner(
                icon = '',
                label = '',
                value = ''
            )
    ...
    def testHealthQuestionDefinitionResourceAttributesFormatDataInner(self):
        """Test HealthQuestionDefinitionResourceAttributesFormatDataInner"""
