...
class TestFetchCoachResponse(unittest.TestCase):
    """FetchCoachResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FetchCoachResponse:
        """Test FetchCoachResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FetchCoachResponse`
        """
        model = FetchCoachResponse()
        if include_optional:
            return FetchCoachResponse(
                data = openapi_client.models.coach_resource.CoachResource(
    ...
    def testFetchCoachResponse(self):
        """Test FetchCoachResponse"""
