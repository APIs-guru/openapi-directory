...
class TestHealthProfileQuestionApi(unittest.TestCase):
    """HealthProfileQuestionApi unit test stubs"""

    def setUp(self) -> None:
        self.api = HealthProfileQuestionApi()

    def tearDown(self) -> None:
        pass

    def test_fetch_health_profile_question(self) -> None:
    ...
    def test_fetch_health_profile_questions(self) -> None:
