...
class TestUpsertPatientRequestMetaQuery(unittest.TestCase):
    """UpsertPatientRequestMetaQuery unit test stubs"""
    ...
    def make_instance(self, include_optional) -> UpsertPatientRequestMetaQuery:
        """Test UpsertPatientRequestMetaQuery
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `UpsertPatientRequestMetaQuery`
        """
        model = UpsertPatientRequestMetaQuery()
        if include_optional:
    ...
    def testUpsertPatientRequestMetaQuery(self):
        """Test UpsertPatientRequestMetaQuery"""
