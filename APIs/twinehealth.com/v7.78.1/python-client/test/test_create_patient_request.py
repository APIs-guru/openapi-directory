    ...
    def make_instance(self, include_optional) -> CreatePatientRequest:
        ...
        if include_optional:
            return CreatePatientRequest(
                data = openapi_client.models.patient_create_resource.PatientCreateResource(),
                meta = openapi_client.models.create_patient_request_meta.CreatePatientRequest_meta(
