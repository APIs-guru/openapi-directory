...
class TestCoachResourceAttributes(unittest.TestCase):
    """CoachResourceAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoachResourceAttributes:
        """Test CoachResourceAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CoachResourceAttributes`
        """
        model = CoachResourceAttributes()
        if include_optional:
    ...
    def testCoachResourceAttributes(self):
        """Test CoachResourceAttributes"""
