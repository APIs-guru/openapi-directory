...
class TestFetchPatientResponse(unittest.TestCase):
    """FetchPatientResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FetchPatientResponse:
        """Test FetchPatientResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FetchPatientResponse`
        """
        model = FetchPatientResponse()
        if include_optional:
    ...
    def testFetchPatientResponse(self):
        """Test FetchPatientResponse"""
