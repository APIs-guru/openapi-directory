...
class TestGroupResourceAttributes(unittest.TestCase):
    """GroupResourceAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> GroupResourceAttributes:
        """Test GroupResourceAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `GroupResourceAttributes`
        """
        model = GroupResourceAttributes()
        if include_optional:
    ...
    def testGroupResourceAttributes(self):
        """Test GroupResourceAttributes"""
