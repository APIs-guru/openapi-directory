...
class TestPatientHealthMetricResourceAttributes(unittest.TestCase):
    """PatientHealthMetricResourceAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatientHealthMetricResourceAttributes:
        """Test PatientHealthMetricResourceAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatientHealthMetricResourceAttributes`
        """
        model = PatientHealthMetricResourceAttributes()
        if include_optional:
    ...
    def testPatientHealthMetricResourceAttributes(self):
        """Test PatientHealthMetricResourceAttributes"""
