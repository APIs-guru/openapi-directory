...
class TestPatientPlanSummaryResource(unittest.TestCase):
    """PatientPlanSummaryResource unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatientPlanSummaryResource:
        """Test PatientPlanSummaryResource
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatientPlanSummaryResource`
        """
        model = PatientPlanSummaryResource()
        if include_optional:
    ...
    def testPatientPlanSummaryResource(self):
        """Test PatientPlanSummaryResource"""
