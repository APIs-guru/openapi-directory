...
class TestCalendarEventResponseResourceAttributes(unittest.TestCase):
    """CalendarEventResponseResourceAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarEventResponseResourceAttributes:
        """Test CalendarEventResponseResourceAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarEventResponseResourceAttributes`
        """
        model = CalendarEventResponseResourceAttributes()
        if include_optional:
            return CalendarEventResponseResourceAttributes(
    ...
    def testCalendarEventResponseResourceAttributes(self):
        """Test CalendarEventResponseResourceAttributes"""
