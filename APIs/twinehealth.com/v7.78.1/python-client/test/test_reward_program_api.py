...
class TestRewardProgramApi(unittest.TestCase):
    """RewardProgramApi unit test stubs"""

    def setUp(self) -> None:
        self.api = RewardProgramApi()

    def tearDown(self) -> None:
        pass

    def test_create_reward_program(self) -> None:
    ...
    def test_fetch_reward_program(self) -> None:
    ...
    def test_fetch_reward_program_group(self) -> None:
    ...
    def test_fetch_reward_programs(self) -> None:
