...
class TestRewardEarningFulfillmentResourceAttributes(unittest.TestCase):
    """RewardEarningFulfillmentResourceAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RewardEarningFulfillmentResourceAttributes:
        """Test RewardEarningFulfillmentResourceAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RewardEarningFulfillmentResourceAttributes`
        """
        model = RewardEarningFulfillmentResourceAttributes()
        if include_optional:
    ...
    def testRewardEarningFulfillmentResourceAttributes(self):
        """Test RewardEarningFulfillmentResourceAttributes"""
