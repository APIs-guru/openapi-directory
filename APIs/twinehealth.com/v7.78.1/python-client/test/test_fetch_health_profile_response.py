...
class TestFetchHealthProfileResponse(unittest.TestCase):
    """FetchHealthProfileResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FetchHealthProfileResponse:
        """Test FetchHealthProfileResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FetchHealthProfileResponse`
        """
        model = FetchHealthProfileResponse()
        if include_optional:
    ...
    def testFetchHealthProfileResponse(self):
        """Test FetchHealthProfileResponse"""
