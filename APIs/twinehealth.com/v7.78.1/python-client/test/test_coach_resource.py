...
class TestCoachResource(unittest.TestCase):
    """CoachResource unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CoachResource:
        """Test CoachResource
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CoachResource`
        """
        model = CoachResource()
        if include_optional:
