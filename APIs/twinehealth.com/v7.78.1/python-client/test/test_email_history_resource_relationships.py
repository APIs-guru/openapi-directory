...
class TestEmailHistoryResourceRelationships(unittest.TestCase):
    """EmailHistoryResourceRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailHistoryResourceRelationships:
        """Test EmailHistoryResourceRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailHistoryResourceRelationships`
        """
        model = EmailHistoryResourceRelationships()
        if include_optional:
    ...
    def testEmailHistoryResourceRelationships(self):
        """Test EmailHistoryResourceRelationships"""
