...
class TestCalendarEventResourceAttributes(unittest.TestCase):
    """CalendarEventResourceAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarEventResourceAttributes:
        """Test CalendarEventResourceAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarEventResourceAttributes`
        """
        model = CalendarEventResourceAttributes()
        if include_optional:
    ...
    def testCalendarEventResourceAttributes(self):
        """Test CalendarEventResourceAttributes"""
