...
class TestCalendarEventResourceRelationships(unittest.TestCase):
    """CalendarEventResourceRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CalendarEventResourceRelationships:
        """Test CalendarEventResourceRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CalendarEventResourceRelationships`
        """
        model = CalendarEventResourceRelationships()
        if include_optional:
    ...
    def testCalendarEventResourceRelationships(self):
        """Test CalendarEventResourceRelationships"""
