...
class TestCreateOrUpdateErrorResponse(unittest.TestCase):
    """CreateOrUpdateErrorResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> CreateOrUpdateErrorResponse:
        """Test CreateOrUpdateErrorResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `CreateOrUpdateErrorResponse`
        """
        model = CreateOrUpdateErrorResponse()
        if include_optional:
            return CreateOrUpdateErrorResponse(
                errors = openapi_client.models.error.Error(
                    code = 'Forbidden', 
                    detail = '', 
    ...
    def testCreateOrUpdateErrorResponse(self):
        """Test CreateOrUpdateErrorResponse"""
