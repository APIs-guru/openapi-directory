...
class TestEmailHistoryResourceAttributesStatusTimes(unittest.TestCase):
    """EmailHistoryResourceAttributesStatusTimes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EmailHistoryResourceAttributesStatusTimes:
        """Test EmailHistoryResourceAttributesStatusTimes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EmailHistoryResourceAttributesStatusTimes`
        """
        model = EmailHistoryResourceAttributesStatusTimes()
        if include_optional:
    ...
    def testEmailHistoryResourceAttributesStatusTimes(self):
        """Test EmailHistoryResourceAttributesStatusTimes"""
