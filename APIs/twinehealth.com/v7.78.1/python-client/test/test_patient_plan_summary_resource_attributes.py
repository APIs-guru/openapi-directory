...
class TestPatientPlanSummaryResourceAttributes(unittest.TestCase):
    """PatientPlanSummaryResourceAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatientPlanSummaryResourceAttributes:
        """Test PatientPlanSummaryResourceAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatientPlanSummaryResourceAttributes`
        """
        model = PatientPlanSummaryResourceAttributes()
        if include_optional:
    ...
    def testPatientPlanSummaryResourceAttributes(self):
        """Test PatientPlanSummaryResourceAttributes"""
