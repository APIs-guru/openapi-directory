...
class TestRewardResourceRelationships(unittest.TestCase):
    """RewardResourceRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RewardResourceRelationships:
        """Test RewardResourceRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RewardResourceRelationships`
        """
        model = RewardResourceRelationships()
        if include_optional:
    ...
    def testRewardResourceRelationships(self):
        """Test RewardResourceRelationships"""
