...
class TestPatientResourceLinks(unittest.TestCase):
    """PatientResourceLinks unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatientResourceLinks:
        """Test PatientResourceLinks
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatientResourceLinks`
        """
        model = PatientResourceLinks()
        if include_optional:
            return PatientResourceLinks(
                var_self = '/patient/57b36ef304ad8c2224f2af3a',
    ...
    def testPatientResourceLinks(self):
        """Test PatientResourceLinks"""
