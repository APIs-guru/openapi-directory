...
class TestTokenResourceAttributes(unittest.TestCase):
    """TokenResourceAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> TokenResourceAttributes:
        """Test TokenResourceAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `TokenResourceAttributes`
        """
        model = TokenResourceAttributes()
        if include_optional:
            return TokenResourceAttributes(
                access_token = 'a01fe2bb-1977-48d9-b722-ac7f9135143f',
                expires_in = 3600,
                refresh_token = 'b452cb17-72e2-4e90-b9c6-d77a0b66cf7c',
                token_type = 'bearer'
            )
        else:
            return TokenResourceAttributes(
    ...
    def testTokenResourceAttributes(self):
        """Test TokenResourceAttributes"""
