...
class TestRewardResourceAttributes(unittest.TestCase):
    """RewardResourceAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RewardResourceAttributes:
        """Test RewardResourceAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RewardResourceAttributes`
        """
        model = RewardResourceAttributes()
        if include_optional:
    ...
    def testRewardResourceAttributes(self):
        """Test RewardResourceAttributes"""
