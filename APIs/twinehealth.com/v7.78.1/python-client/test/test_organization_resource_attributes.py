...
class TestOrganizationResourceAttributes(unittest.TestCase):
    """OrganizationResourceAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> OrganizationResourceAttributes:
        """Test OrganizationResourceAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `OrganizationResourceAttributes`
        """
        model = OrganizationResourceAttributes()
        if include_optional:
    ...
    def testOrganizationResourceAttributes(self):
        """Test OrganizationResourceAttributes"""
