...
class TestRewardEarningResourceAttributes(unittest.TestCase):
    """RewardEarningResourceAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> RewardEarningResourceAttributes:
        """Test RewardEarningResourceAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `RewardEarningResourceAttributes`
        """
        model = RewardEarningResourceAttributes()
        if include_optional:
    ...
    def testRewardEarningResourceAttributes(self):
        """Test RewardEarningResourceAttributes"""
