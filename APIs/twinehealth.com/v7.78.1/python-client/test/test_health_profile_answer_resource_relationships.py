...
class TestHealthProfileAnswerResourceRelationships(unittest.TestCase):
    """HealthProfileAnswerResourceRelationships unit test stubs"""
    ...
    def make_instance(self, include_optional) -> HealthProfileAnswerResourceRelationships:
        """Test HealthProfileAnswerResourceRelationships
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `HealthProfileAnswerResourceRelationships`
        """
        model = HealthProfileAnswerResourceRelationships()
        if include_optional:
            return HealthProfileAnswerResourceRelationships(
                patient = openapi_client.models.health_profile_answer_resource_relationships_patient.HealthProfileAnswerResource_relationships_patient(
                    data = openapi_client.models.action_resource_relationships_plan_data.ActionResource_relationships_plan_data(
                        id = '', 
                        type = '', ), 
                    links = openapi_client.models.health_profile_answer_resource_relationships_patient_links.HealthProfileAnswerResource_relationships_patient_links(
    ...
    def testHealthProfileAnswerResourceRelationships(self):
        """Test HealthProfileAnswerResourceRelationships"""
