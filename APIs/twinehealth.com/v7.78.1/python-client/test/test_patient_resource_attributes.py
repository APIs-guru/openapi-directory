...
class TestPatientResourceAttributes(unittest.TestCase):
    """PatientResourceAttributes unit test stubs"""
    ...
    def make_instance(self, include_optional) -> PatientResourceAttributes:
        """Test PatientResourceAttributes
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `PatientResourceAttributes`
        """
        model = PatientResourceAttributes()
        if include_optional:
    ...
    def testPatientResourceAttributes(self):
        """Test PatientResourceAttributes"""
