...
json = "{}"
# create an instance of FetchPatientPlanSummaryResponse from a JSON string
fetch_patient_plan_summary_response_instance = FetchPatientPlanSummaryResponse.from_json(json)
# print the JSON string representation of the object
print(FetchPatientPlanSummaryResponse.to_json())

# convert the object into a dict
fetch_patient_plan_summary_response_dict = fetch_patient_plan_summary_response_instance.to_dict()
# create an instance of FetchPatientPlanSummaryResponse from a dict
fetch_patient_plan_summary_response_from_dict = FetchPatientPlanSummaryResponse.from_dict(fetch_patient_plan_summary_response_dict)
```
