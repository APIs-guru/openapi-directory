...
class MetricApi:
    ...
    @validate_call
    def create_patient_health_metric(
        self,
        create_patient_health_metric_request: CreatePatientHealthMetricRequest,
        ...
        :param create_patient_health_metric_request: (required)
        :type create_patient_health_metric_request: CreatePatientHealthMetricRequest
        ...
        _param = self._create_patient_health_metric_serialize(
            create_patient_health_metric_request=create_patient_health_metric_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CreatePatientHealthMetricResponse",
    ...
    @validate_call
    def create_patient_health_metric_with_http_info(
        self,
        create_patient_health_metric_request: CreatePatientHealthMetricRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreatePatientHealthMetricResponse]:
        """Create patient health metrics
    ...
    @validate_call
    def create_patient_health_metric_without_preload_content(
        self,
        create_patient_health_metric_request: CreatePatientHealthMetricRequest,
        _request_timeout: Union[
            None,
    ...
    def _create_patient_health_metric_serialize(
        self,
        create_patient_health_metric_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if create_patient_health_metric_request is not None:
            _body_params = create_patient_health_metric_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/patient_health_metric',
    ...
    @validate_call
    def fetch_patient_health_metric(
        self,
        id: Annotated[StrictStr, Field(description="Patient health metric identifier")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: Patient health metric identifier (required)
        :type id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._fetch_patient_health_metric_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "FetchPatientHealthMetricResponse",
    ...
    @validate_call
    def fetch_patient_health_metric_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Patient health metric identifier")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FetchPatientHealthMetricResponse]:
        """Get a patient health metric
    ...
    @validate_call
    def fetch_patient_health_metric_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Patient health metric identifier")],
        _request_timeout: Union[
            None,
    ...
    def _fetch_patient_health_metric_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/patient_health_metric/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def fetch_patient_health_metrics(
        self,
        filter_patient: Annotated[Optional[StrictStr], Field(description="Filter the patient health metrics for a specified patient. Note that one of the following filters must be specified: `filter[patient]`, `filter[groups]`, `filter[organization]`. ")] = None,
        ...
        _param = self._fetch_patient_health_metrics_serialize(
    ...
    @validate_call
    def fetch_patient_health_metrics_with_http_info(
        self,
        filter_patient: Annotated[Optional[StrictStr], Field(description="Filter the patient health metrics for a specified patient. Note that one of the following filters must be specified: `filter[patient]`, `filter[groups]`, `filter[organization]`. ")] = None,
        filter_groups: Annotated[Optional[StrictStr], Field(description="Comma-separated list of group ids. Note that one of the following filters must be specified: `filter[patient]`, `filter[groups]`, `filter[organization]`. ")] = None,
        filter_organization: Annotated[Optional[StrictStr], Field(description="Fitbit Plus organization id. Note that one of the following filters must be specified: `filter[patient]`, `filter[groups]`, `filter[organization]`. ")] = None,
    ...
    @validate_call
    def fetch_patient_health_metrics_without_preload_content(
        self,
        filter_patient: Annotated[Optional[StrictStr], Field(description="Filter the patient health metrics for a specified patient. Note that one of the following filters must be specified: `filter[patient]`, `filter[groups]`, `filter[organization]`. ")] = None,
        filter_groups: Annotated[Optional[StrictStr], Field(description="Comma-separated list of group ids. Note that one of the following filters must be specified: `filter[patient]`, `filter[groups]`, `filter[organization]`. ")] = None,
        filter_organization: Annotated[Optional[StrictStr], Field(description="Fitbit Plus organization id. Note that one of the following filters must be specified: `filter[patient]`, `filter[groups]`, `filter[organization]`. ")] = None,
    ...
    def _fetch_patient_health_metrics_serialize(
        self,
        filter_patient,
        filter_groups,
        filter_organization,
