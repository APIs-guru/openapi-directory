...
class HealthQuestionDefinitionApi:
    ...
    @validate_call
    def fetch_health_question_definition(
        self,
        id: Annotated[StrictStr, Field(description="Health question definition identifier")],
        ...
        :param id: Health question definition identifier (required)
        :type id: str
        ...
        _param = self._fetch_health_question_definition_serialize(
            id=id,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "FetchHealthQuestionDefinitionResponse",
    ...
    @validate_call
    def fetch_health_question_definition_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Health question definition identifier")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FetchHealthQuestionDefinitionResponse]:
        """Get a health question definition
    ...
    @validate_call
    def fetch_health_question_definition_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Health question definition identifier")],
        _request_timeout: Union[
            None,
    ...
    def _fetch_health_question_definition_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/health_question_definition/{id}',
    ...
    def fetch_health_question_definitions(
        ...
        _param = self._fetch_health_question_definitions_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "FetchHealthQuestionDefinitionsResponse",
            '401': "FetchErrorResponse",
            '403': "FetchErrorResponse",
    ...
    @validate_call
    def fetch_health_question_definitions_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FetchHealthQuestionDefinitionsResponse]:
        """List health question definitions
    ...
    @validate_call
    def fetch_health_question_definitions_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _fetch_health_question_definitions_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/health_question_definition',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
