...
class OauthApi:
    ...
    def fetch_token_groups(
        ...
        _param = self._fetch_token_groups_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def fetch_token_groups_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Token identifier")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def fetch_token_groups_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Token identifier")],
        _request_timeout: Union[
            None,
    ...
    def _fetch_token_groups_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/oauth/token/{id}/groups',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def fetch_token_organization(
        ...
        _param = self._fetch_token_organization_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def fetch_token_organization_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Token identifier")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def fetch_token_organization_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Token identifier")],
        _request_timeout: Union[
            None,
    ...
    def _fetch_token_organization_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/oauth/token/{id}/organization',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
