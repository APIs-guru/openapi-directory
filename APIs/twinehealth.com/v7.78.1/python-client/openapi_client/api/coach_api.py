...
class CoachApi:
    ...
    def fetch_coach(
        self,
        id: Annotated[StrictStr, Field(description="Coach identifier")],
        ...
        _param = self._fetch_coach_serialize(
            id=id,
    ...
    @validate_call
    def fetch_coach_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Coach identifier")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FetchCoachResponse]:
        """Get a coach
    ...
    @validate_call
    def fetch_coach_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Coach identifier")],
        _request_timeout: Union[
            None,
    ...
    def fetch_coaches(
        self,
        filter_groups: Annotated[Optional[StrictStr], Field(description="Comma-separated list of group ids. Note that one of the following filters must be specified: `filter[groups]`, `filter[organization]`. ")] = None,
        ...
        _param = self._fetch_coaches_serialize(
    ...
    @validate_call
    def fetch_coaches_with_http_info(
        self,
        filter_groups: Annotated[Optional[StrictStr], Field(description="Comma-separated list of group ids. Note that one of the following filters must be specified: `filter[groups]`, `filter[organization]`. ")] = None,
        filter_organization: Annotated[Optional[StrictStr], Field(description="Fitbit Plus organization id. Note that one of the following filters must be specified: `filter[groups]`, `filter[organization]`. ")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def fetch_coaches_without_preload_content(
        self,
        filter_groups: Annotated[Optional[StrictStr], Field(description="Comma-separated list of group ids. Note that one of the following filters must be specified: `filter[groups]`, `filter[organization]`. ")] = None,
        filter_organization: Annotated[Optional[StrictStr], Field(description="Fitbit Plus organization id. Note that one of the following filters must be specified: `filter[groups]`, `filter[organization]`. ")] = None,
        _request_timeout: Union[
