...
class GroupApi:
    ...
    def fetch_group(
        self,
        id: Annotated[StrictStr, Field(description="Group identifier")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
    ...
    def fetch_group_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FetchGroupResponse]:
        """Get a group
    ...
    def fetch_groups(
        self,
        filter_organization: Annotated[StrictStr, Field(description="Organization identifier")],
        filter_name: Annotated[Optional[StrictStr], Field(description="Group name")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param filter_organization: Organization identifier (required)
