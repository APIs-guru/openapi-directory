...
class ActionApi:
    ...
    def create_action(
        ...
        :param create_action_request: (required)
        :type create_action_request: CreateActionRequest
    ...
    def _create_action_serialize(
        ...
        if create_action_request is not None:
            _body_params = create_action_request
    ...
    def fetch_action(
        self,
        id: Annotated[StrictStr, Field(description="Action identifier")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._fetch_action_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def fetch_action_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Action identifier")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FetchActionResponse]:
        """Get an action
    ...
    @validate_call
    def fetch_action_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Action identifier")],
        _request_timeout: Union[
            None,
    ...
    def update_action(
        ...
        :param id: Action identifier (required)
        :type id: str
        :param update_action_request: (required)
        :type update_action_request: UpdateActionRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def update_action_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpdateActionResponse]:
        """Update an action
    ...
    def _update_action_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if update_action_request is not None:
            _body_params = update_action_request
