...
class RewardProgramApi:
    ...
    def create_reward_program(
        self,
        create_reward_program_request: CreateRewardProgramRequest,
        ...
        :param create_reward_program_request: (required)
        :type create_reward_program_request: CreateRewardProgramRequest
        ...
        _param = self._create_reward_program_serialize(
            create_reward_program_request=create_reward_program_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CreateRewardProgramResponse",
    ...
    @validate_call
    def create_reward_program_with_http_info(
        self,
        create_reward_program_request: CreateRewardProgramRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateRewardProgramResponse]:
        """Create a reward program
    ...
    @validate_call
    def create_reward_program_without_preload_content(
        self,
        create_reward_program_request: CreateRewardProgramRequest,
        _request_timeout: Union[
            None,
    ...
    def _create_reward_program_serialize(
        self,
        create_reward_program_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if create_reward_program_request is not None:
            _body_params = create_reward_program_request
    ...
    @validate_call
    def fetch_reward_program(
        self,
        id: Annotated[StrictStr, Field(description="Reward program identifier")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._fetch_reward_program_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "FetchRewardProgramResponse",
    ...
    @validate_call
    def fetch_reward_program_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Reward program identifier")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FetchRewardProgramResponse]:
        """Get a reward program
    ...
    @validate_call
    def fetch_reward_program_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Reward program identifier")],
        _request_timeout: Union[
            None,
    ...
    def _fetch_reward_program_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/reward_program/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def fetch_reward_program_group(
        self,
        id: Annotated[StrictStr, Field(description="Reward program identifier")],
        _request_timeout: Union[
            None,
        ...
        _param = self._fetch_reward_program_group_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def fetch_reward_program_group_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Reward program identifier")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def fetch_reward_program_group_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Reward program identifier")],
        _request_timeout: Union[
            None,
    ...
    def _fetch_reward_program_group_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/reward_program/{id}/group',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def fetch_reward_programs(
        self,
        filter_groups: Annotated[Optional[StrictStr], Field(description="Comma-separated list of group identifiers. Note that one of the following filters must be specified: `filter[groups]`, `filter[organization]`. ")] = None,
        filter_organization: Annotated[Optional[StrictStr], Field(description="Fitbit Plus organization id. Note that one of the following filters must be specified: `filter[groups]`, `filter[organization]`. ")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._fetch_reward_programs_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "FetchRewardProgramsResponse",
            '401': "FetchErrorResponse",
            '403': "FetchErrorResponse",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def fetch_reward_programs_with_http_info(
        self,
        filter_groups: Annotated[Optional[StrictStr], Field(description="Comma-separated list of group identifiers. Note that one of the following filters must be specified: `filter[groups]`, `filter[organization]`. ")] = None,
        filter_organization: Annotated[Optional[StrictStr], Field(description="Fitbit Plus organization id. Note that one of the following filters must be specified: `filter[groups]`, `filter[organization]`. ")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FetchRewardProgramsResponse]:
        """List reward programs
    ...
    @validate_call
    def fetch_reward_programs_without_preload_content(
        self,
        filter_groups: Annotated[Optional[StrictStr], Field(description="Comma-separated list of group identifiers. Note that one of the following filters must be specified: `filter[groups]`, `filter[organization]`. ")] = None,
        filter_organization: Annotated[Optional[StrictStr], Field(description="Fitbit Plus organization id. Note that one of the following filters must be specified: `filter[groups]`, `filter[organization]`. ")] = None,
        _request_timeout: Union[
    ...
    def _fetch_reward_programs_serialize(
        self,
        filter_groups,
        filter_organization,
        _request_auth,
