...
class HealthProfileApi:
    ...
    @validate_call
    def fetch_health_profile(
        self,
        id: Annotated[StrictStr, Field(description="Health profile identifier")],
        ...
        :param id: Health profile identifier (required)
        :type id: str
        ...
        _param = self._fetch_health_profile_serialize(
            id=id,
            include=include,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "FetchHealthProfileResponse",
    ...
    @validate_call
    def fetch_health_profile_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Health profile identifier")],
        include: Annotated[Optional[StrictStr], Field(description="List of related resources to include in the response")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FetchHealthProfileResponse]:
        """Get a health profile
    ...
    @validate_call
    def fetch_health_profile_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Health profile identifier")],
        include: Annotated[Optional[StrictStr], Field(description="List of related resources to include in the response")] = None,
        _request_timeout: Union[
    ...
    def _fetch_health_profile_serialize(
        self,
        id,
        include,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/health_profile/{id}',
    ...
    def fetch_health_profiles(
        self,
        filter_patient: Annotated[Optional[StrictStr], Field(description="Patient id to fetch health profile. Note that one of the following filters must be specified: `filter[patient]`, `filter[group]`, or `filter[organization]`. ")] = None,
        ...
        _param = self._fetch_health_profiles_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "FetchHealthProfilesResponse",
            '401': "FetchErrorResponse",
            '403': "FetchErrorResponse",
    ...
    @validate_call
    def fetch_health_profiles_with_http_info(
        self,
        filter_patient: Annotated[Optional[StrictStr], Field(description="Patient id to fetch health profile. Note that one of the following filters must be specified: `filter[patient]`, `filter[group]`, or `filter[organization]`. ")] = None,
        filter_groups: Annotated[Optional[StrictStr], Field(description="Comma-separated list of group ids. Note that one of the following filters must be specified: `filter[patient]`, `filter[group]`, or `filter[organization]`. ")] = None,
        filter_organization: Annotated[Optional[StrictStr], Field(description="Fitbit Plus organization id. Note that one of the following filters must be specified: `filter[patient]`, `filter[group]`, or `filter[organization]`. ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FetchHealthProfilesResponse]:
        """List health profiles
    ...
    @validate_call
    def fetch_health_profiles_without_preload_content(
        self,
        filter_patient: Annotated[Optional[StrictStr], Field(description="Patient id to fetch health profile. Note that one of the following filters must be specified: `filter[patient]`, `filter[group]`, or `filter[organization]`. ")] = None,
        filter_groups: Annotated[Optional[StrictStr], Field(description="Comma-separated list of group ids. Note that one of the following filters must be specified: `filter[patient]`, `filter[group]`, or `filter[organization]`. ")] = None,
        filter_organization: Annotated[Optional[StrictStr], Field(description="Fitbit Plus organization id. Note that one of the following filters must be specified: `filter[patient]`, `filter[group]`, or `filter[organization]`. ")] = None,
    ...
    def _fetch_health_profiles_serialize(
        self,
        filter_patient,
        filter_groups,
        filter_organization,
