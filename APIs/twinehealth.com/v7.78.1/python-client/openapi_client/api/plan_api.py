...
class PlanApi:
    ...
    def fetch_patient_plan_summaries(
        self,
        filter_patient: Annotated[Optional[StrictStr], Field(description="Patient id to fetch plan summary for. Note that one of the following filters must be specified: `filter[patient]`, `filter[groups]`, `filter[organization]`. ")] = None,
        ...
        _param = self._fetch_patient_plan_summaries_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "FetchPatientPlanSummariesResponse",
    ...
    @validate_call
    def fetch_patient_plan_summaries_with_http_info(
        self,
        filter_patient: Annotated[Optional[StrictStr], Field(description="Patient id to fetch plan summary for. Note that one of the following filters must be specified: `filter[patient]`, `filter[groups]`, `filter[organization]`. ")] = None,
        filter_groups: Annotated[Optional[StrictStr], Field(description="Comma-separated list of group ids. Note that one of the following filters must be specified: `filter[patient]`, `filter[groups]`, `filter[organization]`. ")] = None,
        filter_organization: Annotated[Optional[StrictStr], Field(description="Fitbit Plus organization id. Note that one of the following filters must be specified: `filter[patient]`, `filter[groups]`, `filter[organization]`. ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FetchPatientPlanSummariesResponse]:
        """List patient plan summaries
    ...
    @validate_call
    def fetch_patient_plan_summaries_without_preload_content(
        self,
        filter_patient: Annotated[Optional[StrictStr], Field(description="Patient id to fetch plan summary for. Note that one of the following filters must be specified: `filter[patient]`, `filter[groups]`, `filter[organization]`. ")] = None,
        filter_groups: Annotated[Optional[StrictStr], Field(description="Comma-separated list of group ids. Note that one of the following filters must be specified: `filter[patient]`, `filter[groups]`, `filter[organization]`. ")] = None,
        filter_organization: Annotated[Optional[StrictStr], Field(description="Fitbit Plus organization id. Note that one of the following filters must be specified: `filter[patient]`, `filter[groups]`, `filter[organization]`. ")] = None,
    ...
    def _fetch_patient_plan_summaries_serialize(
        self,
        filter_patient,
        filter_groups,
        filter_organization,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/patient_plan_summary',
    ...
    @validate_call
    def fetch_patient_plan_summary(
        self,
        id: Annotated[StrictStr, Field(description="Plan summary identifier")],
        include: Annotated[Optional[StrictStr], Field(description="List of related resources to include in the response")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._fetch_patient_plan_summary_serialize(
            id=id,
            include=include,
            _request_auth=_request_auth,
            _content_type=_content_type,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "FetchPatientPlanSummaryResponse",
            '401': "FetchErrorResponse",
            '403': "FetchErrorResponse",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def fetch_patient_plan_summary_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Plan summary identifier")],
        include: Annotated[Optional[StrictStr], Field(description="List of related resources to include in the response")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FetchPatientPlanSummaryResponse]:
        """Get the plan summary for a patient
    ...
    @validate_call
    def fetch_patient_plan_summary_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Plan summary identifier")],
        include: Annotated[Optional[StrictStr], Field(description="List of related resources to include in the response")] = None,
        _request_timeout: Union[
    ...
    def _fetch_patient_plan_summary_serialize(
        self,
        id,
        include,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/patient_plan_summary/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    @validate_call
    def update_patient_plan_summary(
        self,
        id: Annotated[StrictStr, Field(description="Plan summary identifier")],
        update_patient_plan_summary_request: UpdatePatientPlanSummaryRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: Plan summary identifier (required)
        :type id: str
        :param update_patient_plan_summary_request: (required)
        :type update_patient_plan_summary_request: UpdatePatientPlanSummaryRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._update_patient_plan_summary_serialize(
            id=id,
            update_patient_plan_summary_request=update_patient_plan_summary_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "UpdatePatientPlanSummaryResponse",
    ...
    @validate_call
    def update_patient_plan_summary_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Plan summary identifier")],
        update_patient_plan_summary_request: UpdatePatientPlanSummaryRequest,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[UpdatePatientPlanSummaryResponse]:
        """Update a plan summary
    ...
    @validate_call
    def update_patient_plan_summary_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Plan summary identifier")],
        update_patient_plan_summary_request: UpdatePatientPlanSummaryRequest,
        _request_timeout: Union[
    ...
    def _update_patient_plan_summary_serialize(
        self,
        id,
        update_patient_plan_summary_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if update_patient_plan_summary_request is not None:
            _body_params = update_patient_plan_summary_request
