...
class RewardProgramActivationApi:
    ...
    @validate_call
    def create_reward_program_activation(
        self,
        create_reward_program_activation_request: CreateRewardProgramActivationRequest,
        ...
        :param create_reward_program_activation_request: (required)
        :type create_reward_program_activation_request: CreateRewardProgramActivationRequest
        ...
        _param = self._create_reward_program_activation_serialize(
            create_reward_program_activation_request=create_reward_program_activation_request,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "CreateRewardProgramActivationResponse",
    ...
    @validate_call
    def create_reward_program_activation_with_http_info(
        self,
        create_reward_program_activation_request: CreateRewardProgramActivationRequest,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[CreateRewardProgramActivationResponse]:
        """Create a reward program activation
    ...
    @validate_call
    def create_reward_program_activation_without_preload_content(
        self,
        create_reward_program_activation_request: CreateRewardProgramActivationRequest,
        _request_timeout: Union[
            None,
    ...
    def _create_reward_program_activation_serialize(
        self,
        create_reward_program_activation_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        if create_reward_program_activation_request is not None:
            _body_params = create_reward_program_activation_request
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/reward_program_activation',
    ...
    @validate_call
    def fetch_reward_program_activation(
        self,
        id: Annotated[StrictStr, Field(description="Reward program activation identifier")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._fetch_reward_program_activation_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "FetchRewardProgramActivationResponse",
    ...
    @validate_call
    def fetch_reward_program_activation_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Reward program activation identifier")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FetchRewardProgramActivationResponse]:
        """Get a reward program activation
    ...
    @validate_call
    def fetch_reward_program_activation_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Reward program activation identifier")],
        _request_timeout: Union[
            None,
    ...
    def _fetch_reward_program_activation_serialize(
        self,
        id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/reward_program_activation/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def fetch_reward_program_activations(
        self,
        filter_patient: Annotated[Optional[StrictStr], Field(description="Patient identifier. Note that one of the following filters must be specified: `filter[patient]`, `filter[groups]`, `filter[organization]`. ")] = None,
        filter_groups: Annotated[Optional[StrictStr], Field(description="Comma-separated list of group ids. Note that one of the following filters must be specified: `filter[patient]`, `filter[groups]`, `filter[organization]`. ")] = None,
        filter_organization: Annotated[Optional[StrictStr], Field(description="Fitbit Plus organization id. Note that one of the following filters must be specified: `filter[patient]`, `filter[groups]`, `filter[organization]`. ")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._fetch_reward_program_activations_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "FetchRewardProgramActivationsResponse",
            '401': "FetchErrorResponse",
            '403': "FetchErrorResponse",
        }
        response_data = self.api_client.call_api(
    ...
    @validate_call
    def fetch_reward_program_activations_with_http_info(
        self,
        filter_patient: Annotated[Optional[StrictStr], Field(description="Patient identifier. Note that one of the following filters must be specified: `filter[patient]`, `filter[groups]`, `filter[organization]`. ")] = None,
        filter_groups: Annotated[Optional[StrictStr], Field(description="Comma-separated list of group ids. Note that one of the following filters must be specified: `filter[patient]`, `filter[groups]`, `filter[organization]`. ")] = None,
        filter_organization: Annotated[Optional[StrictStr], Field(description="Fitbit Plus organization id. Note that one of the following filters must be specified: `filter[patient]`, `filter[groups]`, `filter[organization]`. ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FetchRewardProgramActivationsResponse]:
        """List reward program activations
    ...
    @validate_call
    def fetch_reward_program_activations_without_preload_content(
        self,
        filter_patient: Annotated[Optional[StrictStr], Field(description="Patient identifier. Note that one of the following filters must be specified: `filter[patient]`, `filter[groups]`, `filter[organization]`. ")] = None,
        filter_groups: Annotated[Optional[StrictStr], Field(description="Comma-separated list of group ids. Note that one of the following filters must be specified: `filter[patient]`, `filter[groups]`, `filter[organization]`. ")] = None,
        filter_organization: Annotated[Optional[StrictStr], Field(description="Fitbit Plus organization id. Note that one of the following filters must be specified: `filter[patient]`, `filter[groups]`, `filter[organization]`. ")] = None,
    ...
    def _fetch_reward_program_activations_serialize(
        self,
        filter_patient,
        filter_groups,
        filter_organization,
