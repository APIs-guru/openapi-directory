...
class RewardApi:
    ...
    def create_reward(
        self,
        create_reward_request: CreateRewardRequest,
        ...
        :param create_reward_request: (required)
        :type create_reward_request: CreateRewardRequest
    ...
    def _create_reward_serialize(
        ...
        if create_reward_request is not None:
            _body_params = create_reward_request
    ...
    def fetch_reward(
        self,
        id: Annotated[StrictStr, Field(description="Reward identifier")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._fetch_reward_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def fetch_reward_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Reward identifier")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FetchRewardResponse]:
        """Get a reward
    ...
    @validate_call
    def fetch_reward_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Reward identifier")],
        _request_timeout: Union[
            None,
    ...
    def fetch_rewards(
        ...
        filter_reward_program_activation: Annotated[Optional[StrictStr], Field(description="Reward program activation identifier")] = None,
        filter_thread: Annotated[Optional[StrictStr], Field(description="Thread identifier")] = None,
        ...
        _param = self._fetch_rewards_serialize(
            filter_patient=filter_patient,
            filter_reward_program_activation=filter_reward_program_activation,
    ...
    @validate_call
    def fetch_rewards_with_http_info(
        self,
        filter_patient: Annotated[Optional[StrictStr], Field(description="Patient identifier. Note that one of the following filters must be specified: `filter[patient]`, `filter[groups]`, `filter[organization]`. ")] = None,
        filter_reward_program_activation: Annotated[Optional[StrictStr], Field(description="Reward program activation identifier")] = None,
        filter_thread: Annotated[Optional[StrictStr], Field(description="Thread identifier")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FetchRewardsResponse]:
        """List rewards
    ...
    @validate_call
    def fetch_rewards_without_preload_content(
        self,
        filter_patient: Annotated[Optional[StrictStr], Field(description="Patient identifier. Note that one of the following filters must be specified: `filter[patient]`, `filter[groups]`, `filter[organization]`. ")] = None,
        filter_reward_program_activation: Annotated[Optional[StrictStr], Field(description="Reward program activation identifier")] = None,
        filter_thread: Annotated[Optional[StrictStr], Field(description="Thread identifier")] = None,
    ...
    def _fetch_rewards_serialize(
        self,
        filter_patient,
        filter_reward_program_activation,
        filter_thread,
        filter_groups,
        filter_organization,
        _request_auth,
        ...
        if filter_reward_program_activation is not None:
            
            _query_params.append(('filter[reward_program_activation]', filter_reward_program_activation))
            
        if filter_thread is not None:
            
            _query_params.append(('filter[thread]', filter_thread))
