...
class HealthProfileAnswerApi:
    ...
    @validate_call
    def fetch_health_profile_answer(
        self,
        id: Annotated[StrictStr, Field(description="Health profile answer identifier")],
        ...
        _param = self._fetch_health_profile_answer_serialize(
            id=id,
            include=include,
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "FetchHealthProfileAnswerResponse",
    ...
    @validate_call
    def fetch_health_profile_answer_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Health profile answer identifier")],
        include: Annotated[Optional[StrictStr], Field(description="List of related resources to include in the response")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FetchHealthProfileAnswerResponse]:
        """Get a health profile answer
    ...
    @validate_call
    def fetch_health_profile_answer_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Health profile answer identifier")],
        include: Annotated[Optional[StrictStr], Field(description="List of related resources to include in the response")] = None,
        _request_timeout: Union[
    ...
    def _fetch_health_profile_answer_serialize(
        self,
        id,
        include,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/health_profile_answer/{id}',
    ...
    def fetch_health_profile_answers(
        self,
        filter_patient: Annotated[Optional[StrictStr], Field(description="Patient id to fetch healt profile answers. Note that one of the following filters must be specified: `filter[patient]`, `filter[group]`, or `filter[organization]`. ")] = None,
        ...
        page_size: Annotated[Optional[Annotated[int, Field(le=100, strict=True, ge=0)]], Field(description="Page size")] = None,
        ...
        _param = self._fetch_health_profile_answers_serialize(
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "FetchHealthProfileAnswersResponse",
            '401': "FetchErrorResponse",
            '403': "FetchErrorResponse",
    ...
    @validate_call
    def fetch_health_profile_answers_with_http_info(
        self,
        filter_patient: Annotated[Optional[StrictStr], Field(description="Patient id to fetch healt profile answers. Note that one of the following filters must be specified: `filter[patient]`, `filter[group]`, or `filter[organization]`. ")] = None,
        filter_groups: Annotated[Optional[StrictStr], Field(description="Comma-separated list of group ids. Note that one of the following filters must be specified: `filter[patient]`, `filter[group]`, or `filter[organization]`. ")] = None,
        filter_organization: Annotated[Optional[StrictStr], Field(description="Fitbit Plus organization id. Note that one of the following filters must be specified: `filter[patient]`, `filter[group]`, or `filter[organization]`. ")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FetchHealthProfileAnswersResponse]:
        """List health profile answers
    ...
    @validate_call
    def fetch_health_profile_answers_without_preload_content(
        self,
        filter_patient: Annotated[Optional[StrictStr], Field(description="Patient id to fetch healt profile answers. Note that one of the following filters must be specified: `filter[patient]`, `filter[group]`, or `filter[organization]`. ")] = None,
        filter_groups: Annotated[Optional[StrictStr], Field(description="Comma-separated list of group ids. Note that one of the following filters must be specified: `filter[patient]`, `filter[group]`, or `filter[organization]`. ")] = None,
        filter_organization: Annotated[Optional[StrictStr], Field(description="Fitbit Plus organization id. Note that one of the following filters must be specified: `filter[patient]`, `filter[group]`, or `filter[organization]`. ")] = None,
    ...
    def _fetch_health_profile_answers_serialize(
        self,
        filter_patient,
        filter_groups,
        filter_organization,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/health_profile_answer',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
