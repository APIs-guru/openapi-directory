...
class BundleApi:
    ...
    def create_bundle(
        self,
        create_bundle_request: CreateBundleRequest,
        ...
        :param create_bundle_request: (required)
        :type create_bundle_request: CreateBundleRequest
    ...
    def _create_bundle_serialize(
        ...
        if create_bundle_request is not None:
            _body_params = create_bundle_request
    ...
    def fetch_bundle(
        self,
        id: Annotated[StrictStr, Field(description="Bundle identifier")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._fetch_bundle_serialize(
            id=id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def fetch_bundle_with_http_info(
        self,
        id: Annotated[StrictStr, Field(description="Bundle identifier")],
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[FetchBundleResponse]:
        """Get a bundle
    ...
    @validate_call
    def fetch_bundle_without_preload_content(
        self,
        id: Annotated[StrictStr, Field(description="Bundle identifier")],
        _request_timeout: Union[
            None,
    ...
    def update_bundle(
        self,
        id: Annotated[StrictStr, Field(description="Bundle identifier")],
        update_bundle_request: UpdateBundleRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param id: Bundle identifier (required)
        :type id: str
        :param update_bundle_request: (required)
        :type update_bundle_request: UpdateBundleRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
    ...
    def _update_bundle_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if update_bundle_request is not None:
            _body_params = update_bundle_request
