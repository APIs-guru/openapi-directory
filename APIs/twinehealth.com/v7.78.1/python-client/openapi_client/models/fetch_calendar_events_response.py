...
class FetchCalendarEventsResponse(BaseModel):
    ...
    included: Optional[List[Resource]] = Field(default=None, description="Related resources which are included in the response based on the `include` param. Attributes of each resource will vary depending on the type. See [patient](#operation/fetchPatient) ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [CalendarEventResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
