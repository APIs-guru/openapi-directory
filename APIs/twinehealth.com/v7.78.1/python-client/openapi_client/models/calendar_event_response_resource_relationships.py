...
class CalendarEventResponseResourceRelationships(BaseModel):
    """
    CalendarEventResponseResourceRelationships
    """ # noqa: E501
    calendar_event: Optional[CalendarEventResponseResourceRelationshipsCalendarEvent] = None
    user: Optional[CalendarEventResponseResourceRelationshipsUser] = None
    __properties: ClassVar[List[str]] = ["calendar_event", "user"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "calendar_event": CalendarEventResponseResourceRelationshipsCalendarEvent.from_dict(obj["calendar_event"]) if obj.get("calendar_event") is not None else None,
            "user": CalendarEventResponseResourceRelationshipsUser.from_dict(obj["user"]) if obj.get("user") is not None else None
        })
        return _obj
