...
class CalendarEventResponseResourceRelationshipsUser(BaseModel):
    """
    ...
    links: Optional[CalendarEventResponseResourceRelationshipsUserLinks] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "links": CalendarEventResponseResourceRelationshipsUserLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
