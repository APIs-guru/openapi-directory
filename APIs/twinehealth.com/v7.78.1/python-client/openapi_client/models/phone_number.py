...
class PhoneNumber(BaseModel):
    ...
    type: StrictStr
    value: StrictStr
    __properties: ClassVar[List[str]] = ["primary", "type", "value"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['home', 'work', 'mobile', 'home-fax', 'work-fax', 'other']):
            raise ValueError("must be one of enum values ('home', 'work', 'mobile', 'home-fax', 'work-fax', 'other')")
        return value
