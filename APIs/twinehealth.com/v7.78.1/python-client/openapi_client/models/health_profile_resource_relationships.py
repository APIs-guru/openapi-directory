...
class HealthProfileResourceRelationships(BaseModel):
    """
    HealthProfileResourceRelationships
    """ # noqa: E501
    patient: Optional[HealthProfileResourceRelationshipsPatient] = None
    questions: Optional[HealthProfileResourceRelationshipsQuestions] = None
    __properties: ClassVar[List[str]] = ["patient", "questions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "patient": HealthProfileResourceRelationshipsPatient.from_dict(obj["patient"]) if obj.get("patient") is not None else None,
            "questions": HealthProfileResourceRelationshipsQuestions.from_dict(obj["questions"]) if obj.get("questions") is not None else None
        })
        return _obj
