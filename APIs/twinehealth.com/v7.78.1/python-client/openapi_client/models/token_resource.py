...
class TokenResource(BaseModel):
    ...
    TokenResource
    """ # noqa: E501
    attributes: Optional[TokenResourceAttributes] = None
    id: StrictStr
    relationships: Optional[TokenResourceRelationships] = None
    type: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": TokenResourceAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "relationships": TokenResourceRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
            "type": obj.get("type")
        })
        return _obj
