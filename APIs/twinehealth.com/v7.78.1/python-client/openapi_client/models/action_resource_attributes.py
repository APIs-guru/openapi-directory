...
class ActionResourceAttributes(BaseModel):
    """
    ActionResourceAttributes
    """ # noqa: E501
    thread: Optional[StrictStr] = Field(default=None, alias="_thread")
    adherence: Optional[ActionResourceAttributesAdherence] = None
    details: Optional[Dict[str, Any]] = None
    effective_from: StrictStr
    effective_to: Optional[StrictStr] = None
    frequency_goal: Optional[ActionResourceAttributesFrequencyGoal] = None
    identifiers: Optional[List[Identifier]] = None
    intake: Optional[Dict[str, Any]] = None
    metric_required: Optional[StrictBool] = None
    metrics: Optional[List[ActionMetric]] = None
    static_title: Optional[StrictStr] = None
    title: StrictStr
    tracking: Optional[StrictBool] = None
    type: StrictStr
    windows: Optional[List[ActionWindow]] = None
    __properties: ClassVar[List[str]] = ["_thread", "adherence", "details", "effective_from", "effective_to", "frequency_goal", "identifiers", "intake", "metric_required", "metrics", "static_title", "title", "tracking", "type", "windows"]

    @field_validator('type')
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['other_lifestyle']):
            raise ValueError("must be one of enum values ('other_lifestyle')")
        return value
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of adherence
        if self.adherence:
            _dict['adherence'] = self.adherence.to_dict()
        # override the default output from pydantic by calling `to_dict()` of frequency_goal
        if self.frequency_goal:
            _dict['frequency_goal'] = self.frequency_goal.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "adherence": ActionResourceAttributesAdherence.from_dict(obj["adherence"]) if obj.get("adherence") is not None else None,
            "details": obj.get("details"),
            "effective_from": obj.get("effective_from"),
            "effective_to": obj.get("effective_to"),
            "frequency_goal": ActionResourceAttributesFrequencyGoal.from_dict(obj["frequency_goal"]) if obj.get("frequency_goal") is not None else None,
            ...
            "metric_required": obj.get("metric_required"),
            "metrics": [ActionMetric.from_dict(_item) for _item in obj["metrics"]] if obj.get("metrics") is not None else None,
            "static_title": obj.get("static_title"),
            "title": obj.get("title"),
            "tracking": obj.get("tracking"),
            "type": obj.get("type"),
            "windows": [ActionWindow.from_dict(_item) for _item in obj["windows"]] if obj.get("windows") is not None else None
        })
        return _obj
