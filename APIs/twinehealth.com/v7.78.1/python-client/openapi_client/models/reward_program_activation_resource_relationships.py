...
class RewardProgramActivationResourceRelationships(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["patient", "reward_program"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of reward_program
        if self.reward_program:
            _dict['reward_program'] = self.reward_program.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "patient": EmailHistoryResourceRelationshipsReceiver.from_dict(obj["patient"]) if obj.get("patient") is not None else None,
            "reward_program": EmailHistoryResourceRelationshipsReceiver.from_dict(obj["reward_program"]) if obj.get("reward_program") is not None else None
        })
        return _obj
