...
class Error(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["code", "detail", "source", "status", "title"]
    ...
    def code_validate_enum(cls, value):
        ...
        if value not in set(['Forbidden', 'InvalidParameter', 'InvalidBodyParameter', 'ResourceNotFound', 'Unauthorized', 'InvalidCredentials', 'InvalidGrantType']):
            raise ValueError("must be one of enum values ('Forbidden', 'InvalidParameter', 'InvalidBodyParameter', 'ResourceNotFound', 'Unauthorized', 'InvalidCredentials', 'InvalidGrantType')")
        return value
