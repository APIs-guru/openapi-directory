...
class PatientHealthMetricResourceRelationshipsPatientDataMetaQuery(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["groups", "identifier", "organization"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "identifier": PatientHealthMetricResourceAttributesCode.from_dict(obj["identifier"]) if obj.get("identifier") is not None else None,
