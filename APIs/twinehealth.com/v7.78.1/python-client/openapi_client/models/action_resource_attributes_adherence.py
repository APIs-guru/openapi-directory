...
class ActionResourceAttributesAdherence(BaseModel):
    """
    ActionResourceAttributesAdherence
    """ # noqa: E501
    complete: Optional[StrictInt] = None
    due: Optional[StrictInt] = None
    streak: Optional[ActionResourceAttributesAdherenceStreak] = None
    __properties: ClassVar[List[str]] = ["complete", "due", "streak"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "due": obj.get("due"),
            "streak": ActionResourceAttributesAdherenceStreak.from_dict(obj["streak"]) if obj.get("streak") is not None else None
        })
        return _obj
