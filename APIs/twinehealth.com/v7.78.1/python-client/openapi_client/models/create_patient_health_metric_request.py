...
class CreatePatientHealthMetricRequest(BaseModel):
    ...
    meta: Optional[CreatePatientHealthMetricRequestMeta] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": PatientHealthMetricCreateResource.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "meta": CreatePatientHealthMetricRequestMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None
        })
        return _obj
