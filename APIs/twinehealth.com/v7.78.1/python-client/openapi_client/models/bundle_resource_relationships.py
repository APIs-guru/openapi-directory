...
class BundleResourceRelationships(BaseModel):
    """
    BundleResourceRelationships
    """ # noqa: E501
    actions: Optional[ActionResourceRelationshipsPlan] = None
    plan: Optional[ActionResourceRelationshipsPlan] = None
    __properties: ClassVar[List[str]] = ["actions", "plan"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "actions": ActionResourceRelationshipsPlan.from_dict(obj["actions"]) if obj.get("actions") is not None else None,
            "plan": ActionResourceRelationshipsPlan.from_dict(obj["plan"]) if obj.get("plan") is not None else None
        })
        return _obj
