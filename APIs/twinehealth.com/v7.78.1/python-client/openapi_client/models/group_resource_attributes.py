...
class GroupResourceAttributes(BaseModel):
    """
    GroupResourceAttributes
    """ # noqa: E501
    bio: Optional[StrictStr] = Field(default=None, description="A description of the group")
    name: StrictStr = Field(description="The name of the group")
    __properties: ClassVar[List[str]] = ["bio", "name"]
