...
class PatientHealthMetricResourceRelationships(BaseModel):
    """
    PatientHealthMetricResourceRelationships
    """ # noqa: E501
    patient: Optional[PatientHealthMetricResourceRelationshipsPatient] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "patient": PatientHealthMetricResourceRelationshipsPatient.from_dict(obj["patient"]) if obj.get("patient") is not None else None
        })
        return _obj
