...
class HealthProfileAnswerResourceRelationships(BaseModel):
    """
    HealthProfileAnswerResourceRelationships
    """ # noqa: E501
    patient: Optional[HealthProfileAnswerResourceRelationshipsPatient] = None
    __properties: ClassVar[List[str]] = ["patient"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "patient": HealthProfileAnswerResourceRelationshipsPatient.from_dict(obj["patient"]) if obj.get("patient") is not None else None
        })
        return _obj
