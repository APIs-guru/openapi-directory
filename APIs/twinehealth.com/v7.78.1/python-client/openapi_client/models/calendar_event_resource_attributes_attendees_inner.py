...
class CalendarEventResourceAttributesAttendeesInner(BaseModel):
    """
    CalendarEventResourceAttributesAttendeesInner
    """ # noqa: E501
    response_status: Optional[StrictStr] = Field(default=None, description="Status of responses from attendees")
    user: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["response_status", "user"]
    ...
    def response_status_validate_enum(cls, value):
        ...
        if value not in set(['needsAction', 'declined', 'tentative', 'accepted']):
            raise ValueError("must be one of enum values ('needsAction', 'declined', 'tentative', 'accepted')")
        return value
