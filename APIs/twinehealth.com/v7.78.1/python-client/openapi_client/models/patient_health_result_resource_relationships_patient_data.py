...
class PatientHealthResultResourceRelationshipsPatientData(BaseModel):
    """
    ...
    meta: Optional[PatientHealthMetricResourceRelationshipsPatientDataMeta] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "meta": PatientHealthMetricResourceRelationshipsPatientDataMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "type": obj.get("type")
        })
        return _obj
