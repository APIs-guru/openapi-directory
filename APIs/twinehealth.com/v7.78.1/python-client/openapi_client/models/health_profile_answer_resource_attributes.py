...
class HealthProfileAnswerResourceAttributes(BaseModel):
    """
    HealthProfileAnswerResourceAttributes
    """ # noqa: E501
    history: Optional[List[HealthProfileAnswerResourceAttributesHistoryInner]] = Field(default=None, description="List of details of previous answers for a health profile question")
    latest: Optional[HealthProfileAnswerResourceAttributesLatest] = None
    question_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["history", "latest", "question_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "history": [HealthProfileAnswerResourceAttributesHistoryInner.from_dict(_item) for _item in obj["history"]] if obj.get("history") is not None else None,
            "latest": HealthProfileAnswerResourceAttributesLatest.from_dict(obj["latest"]) if obj.get("latest") is not None else None,
