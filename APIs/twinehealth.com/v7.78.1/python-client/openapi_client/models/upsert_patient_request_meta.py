...
class UpsertPatientRequestMeta(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UpsertPatientRequestMeta from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UpsertPatientRequestMeta from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "query": UpsertPatientRequestMetaQuery.from_dict(obj["query"]) if obj.get("query") is not None else None
        })
        return _obj
