...
class RewardProgramResourceRelationships(BaseModel):
    """
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of RewardProgramResourceRelationships from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of RewardProgramResourceRelationships from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "group": RewardProgramResourceRelationshipsGroup.from_dict(obj["group"]) if obj.get("group") is not None else None
        })
        return _obj
