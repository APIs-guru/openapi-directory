...
class HealthQuestionDefinitionResourceLinks(BaseModel):
    """
    ...
    def var_self_validate_regular_expression(cls, value):
        ...
        if not re.match(r"health_question_definition", value):
            raise ValueError(r"must validate the regular expression /health_question_definition/[0-9]+")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of HealthQuestionDefinitionResourceLinks from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of HealthQuestionDefinitionResourceLinks from a dict"""
        if obj is None:
            return None
