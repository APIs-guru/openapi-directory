...
class HealthProfileResource(BaseModel):
    ...
    """ # noqa: E501
    attributes: Optional[HealthProfileResourceAttributes] = None
    id: Optional[StrictStr] = None
    links: Optional[HealthProfileResourceLinks] = None
    relationships: Optional[HealthProfileResourceRelationships] = None
    type: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": HealthProfileResourceAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "links": HealthProfileResourceLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
            "relationships": HealthProfileResourceRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
            "type": obj.get("type")
        })
        return _obj
