...
class PatientPlanSummaryResourceLinks(BaseModel):
    """
    PatientPlanSummaryResourceLinks
    """ # noqa: E501
    var_self: Annotated[str, Field(strict=True)] = Field(alias="self")
    __properties: ClassVar[List[str]] = ["self"]

    @field_validator('var_self')
    def var_self_validate_regular_expression(cls, value):
        """Validates the regular expression"""
        if not re.match(r"patient_plan_summary", value):
            raise ValueError(r"must validate the regular expression /patient_plan_summary/[0-9a-z]+")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatientPlanSummaryResourceLinks from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatientPlanSummaryResourceLinks from a dict"""
        if obj is None:
            return None
