...
class FetchPatientPlanSummariesResponse(BaseModel):
    ...
    included: Optional[List[Resource]] = Field(default=None, description="Related resources which are included in the response based on the `include` param. Attributes of each resource will vary depending on the type. See [action](#operation/fetchAction), [bundle](#operation/fetchBundle) and [patient](#operation/fetchPatient) ")
    meta: Optional[FetchMetaResponse] = None
    __properties: ClassVar[List[str]] = ["data", "included", "meta"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [PatientPlanSummaryResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
