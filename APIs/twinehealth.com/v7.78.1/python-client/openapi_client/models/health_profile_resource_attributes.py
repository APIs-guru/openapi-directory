...
class HealthProfileResourceAttributes(BaseModel):
    """
    HealthProfileResourceAttributes
    """ # noqa: E501
    stats: Optional[List[HealthProfileResourceAttributesStatsInner]] = Field(default=None, description="List of category, answered and total counts for questions in the health profile")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "stats": [HealthProfileResourceAttributesStatsInner.from_dict(_item) for _item in obj["stats"]] if obj.get("stats") is not None else None
        })
        return _obj
