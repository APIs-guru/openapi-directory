...
class BundleResource(BaseModel):
    ...
    BundleResource
    """ # noqa: E501
    attributes: Optional[BundleResourceAttributes] = None
    id: StrictStr
    relationships: Optional[BundleResourceRelationships] = None
    type: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": BundleResourceAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "relationships": BundleResourceRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
            "type": obj.get("type")
        })
        return _obj
