...
class PatientHealthResultResourceRelationships(BaseModel):
    """
    PatientHealthResultResourceRelationships
    """ # noqa: E501
    action: Optional[ActionResourceRelationshipsPlan] = None
    metric: Optional[ActionResourceRelationshipsPlan] = None
    patient: Optional[PatientHealthResultResourceRelationshipsPatient] = None
    __properties: ClassVar[List[str]] = ["action", "metric", "patient"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "action": ActionResourceRelationshipsPlan.from_dict(obj["action"]) if obj.get("action") is not None else None,
            "metric": ActionResourceRelationshipsPlan.from_dict(obj["metric"]) if obj.get("metric") is not None else None,
            "patient": PatientHealthResultResourceRelationshipsPatient.from_dict(obj["patient"]) if obj.get("patient") is not None else None
        })
        return _obj
