...
class PatientIdentifier(BaseModel):
    ...
    system: StrictStr
    unique: Optional[StrictBool] = Field(default=True, description="If `true`, the combination of system and value must be global unique among all patients and coaches in Fitbit Plus.")
    value: StrictStr
    __properties: ClassVar[List[str]] = ["label", "system", "unique", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unique": obj.get("unique") if obj.get("unique") is not None else True,
            "value": obj.get("value")
        })
        return _obj
