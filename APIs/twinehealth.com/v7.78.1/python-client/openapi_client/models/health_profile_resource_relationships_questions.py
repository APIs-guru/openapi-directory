...
class HealthProfileResourceRelationshipsQuestions(BaseModel):
    """
    HealthProfileResourceRelationshipsQuestions
    """ # noqa: E501
    data: Optional[List[ActionResourceRelationshipsPlanData]] = None
    links: Optional[HealthProfileResourceRelationshipsQuestionsLinks] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [ActionResourceRelationshipsPlanData.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "links": HealthProfileResourceRelationshipsQuestionsLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
