...
class CalendarEventResponseResource(BaseModel):
    ...
    """ # noqa: E501
    attributes: Optional[CalendarEventResponseResourceAttributes] = None
    id: Optional[StrictStr] = None
    links: Optional[CalendarEventResponseResourceLinks] = None
    relationships: Optional[CalendarEventResponseResourceRelationships] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "links": CalendarEventResponseResourceLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
            "relationships": CalendarEventResponseResourceRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
            "type": obj.get("type")
        })
        return _obj
