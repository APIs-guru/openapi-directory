...
class PatientCreateResourceAllOfRelationshipsCoachesLinks(BaseModel):
    """
    ...
    def related_validate_regular_expression(cls, value):
        ...
        if not re.match(r"patient/[0-9a-z]+", value ,re.DOTALL):
            raise ValueError(r"must validate the regular expression /patient/[0-9a-z]+/coaches")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatientCreateResourceAllOfRelationshipsCoachesLinks from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatientCreateResourceAllOfRelationshipsCoachesLinks from a dict"""
        if obj is None:
            return None
