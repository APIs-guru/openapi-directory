...
class PatientHealthMetricResourceAttributes(BaseModel):
    """
    PatientHealthMetricResourceAttributes
    """ # noqa: E501
    code: Optional[PatientHealthMetricResourceAttributesCode] = None
    diastolic: Optional[Union[StrictFloat, StrictInt]] = None
    occurred_at: Optional[StrictStr] = None
    systolic: Optional[Union[StrictFloat, StrictInt]] = None
    type: Optional[StrictStr] = None
    unit: Optional[StrictStr] = None
    value: Optional[Any] = Field(default=None, description="Can be any value (number, boolean, string, object) depending on the metric type. Most values are of type number.")
    __properties: ClassVar[List[str]] = ["code", "diastolic", "occurred_at", "systolic", "type", "unit", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "code": PatientHealthMetricResourceAttributesCode.from_dict(obj["code"]) if obj.get("code") is not None else None,
