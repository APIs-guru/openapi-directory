...
class RewardProgramActivationResource(BaseModel):
    ...
    """ # noqa: E501
    attributes: Optional[RewardProgramActivationResourceAttributes] = None
    id: Optional[StrictStr] = None
    relationships: Optional[RewardProgramActivationResourceRelationships] = None
    type: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": RewardProgramActivationResourceAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "relationships": RewardProgramActivationResourceRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
            "type": obj.get("type")
        })
        return _obj
