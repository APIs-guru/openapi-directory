...
class HealthProfileAnswerResource(BaseModel):
    ...
    """ # noqa: E501
    attributes: Optional[HealthProfileAnswerResourceAttributes] = None
    id: StrictStr
    links: Optional[HealthProfileAnswerResourceLinks] = None
    relationships: Optional[HealthProfileAnswerResourceRelationships] = None
    type: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": HealthProfileAnswerResourceAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "links": HealthProfileAnswerResourceLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
            "relationships": HealthProfileAnswerResourceRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
            "type": obj.get("type")
        })
        return _obj
