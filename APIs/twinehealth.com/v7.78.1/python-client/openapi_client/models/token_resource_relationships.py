...
class TokenResourceRelationships(BaseModel):
    """
    TokenResourceRelationships
    """ # noqa: E501
    groups: Optional[TokenResourceRelationshipsGroups] = None
    organization: Optional[TokenResourceRelationshipsOrganization] = None
    __properties: ClassVar[List[str]] = ["groups", "organization"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": TokenResourceRelationshipsGroups.from_dict(obj["groups"]) if obj.get("groups") is not None else None,
            "organization": TokenResourceRelationshipsOrganization.from_dict(obj["organization"]) if obj.get("organization") is not None else None
        })
        return _obj
