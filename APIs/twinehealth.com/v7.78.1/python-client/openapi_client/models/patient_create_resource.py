...
class PatientCreateResource(BaseModel):
    """
    PatientCreateResource
    """ # noqa: E501
    attributes: PatientResourceAttributes
    id: Optional[StrictStr] = None
    links: Optional[PatientResourceLinks] = None
    relationships: Optional[PatientCreateResourceAllOfRelationships] = None
    type: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": PatientResourceAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "links": PatientResourceLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
            "relationships": PatientCreateResourceAllOfRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
            "type": obj.get("type")
        })
        return _obj
