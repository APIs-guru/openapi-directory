...
class HealthQuestionDefinitionResourceAttributesFormat(BaseModel):
    """
    The list of formats for the health profile definition
    """ # noqa: E501
    data: Optional[List[HealthQuestionDefinitionResourceAttributesFormatDataInner]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [HealthQuestionDefinitionResourceAttributesFormatDataInner.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "type": obj.get("type")
        })
        return _obj
