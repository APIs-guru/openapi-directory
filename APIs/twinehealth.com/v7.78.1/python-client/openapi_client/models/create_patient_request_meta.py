...
class CreatePatientRequestMeta(BaseModel):
    """
    CreatePatientRequestMeta
    """ # noqa: E501
    ignore_duplicates: Optional[StrictBool] = Field(default=False, description="If `true`, patients with any conflicting identifiers (same `system` and `value`) will be ignored. Useful for gracefully skipping duplicates after errors occur during bulk create. ")
    __properties: ClassVar[List[str]] = ["ignore_duplicates"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ignore_duplicates": obj.get("ignore_duplicates") if obj.get("ignore_duplicates") is not None else False
        })
        return _obj
