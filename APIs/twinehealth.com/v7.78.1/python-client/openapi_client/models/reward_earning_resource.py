...
class RewardEarningResource(BaseModel):
    ...
    """ # noqa: E501
    attributes: Optional[RewardEarningResourceAttributes] = None
    id: Optional[StrictStr] = None
    relationships: Optional[RewardEarningResourceRelationships] = None
    type: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": RewardEarningResourceAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "relationships": RewardEarningResourceRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
            "type": obj.get("type")
        })
        return _obj
