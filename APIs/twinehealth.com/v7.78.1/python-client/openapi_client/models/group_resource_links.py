...
class GroupResourceLinks(BaseModel):
    """
    GroupResourceLinks
    """ # noqa: E501
    ...
    def var_self_validate_regular_expression(cls, value):
        ...
        if not re.match(r"group", value):
            raise ValueError(r"must validate the regular expression /group/[0-9a-z]+")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of GroupResourceLinks from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of GroupResourceLinks from a dict"""
        if obj is None:
            return None
