...
class FetchHealthProfileQuestionsResponse(BaseModel):
    ...
    included: Optional[List[Resource]] = Field(default=None, description="Related resources which are included in the response based on the `include` param. Attributes of each resource will vary depending on the type. See [question_definition](#operation/fetchHealthQuestionDefinition), [answer](#operation/fetchHealthProfileAnswer) ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": [HealthProfileQuestionResource.from_dict(_item) for _item in obj["data"]] if obj.get("data") is not None else None,
            "included": [Resource.from_dict(_item) for _item in obj["included"]] if obj.get("included") is not None else None,
            "links": CollectionResponseLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
