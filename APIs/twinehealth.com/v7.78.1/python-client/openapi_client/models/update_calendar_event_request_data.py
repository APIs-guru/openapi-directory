...
class UpdateCalendarEventRequestData(BaseModel):
    """
    UpdateCalendarEventRequestData
    """ # noqa: E501
    attributes: Optional[CalendarEventResourceAttributes] = None
    id: StrictStr
    relationships: Optional[UpdateCalendarEventRequestDataRelationships] = None
    type: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "relationships": UpdateCalendarEventRequestDataRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
            "type": obj.get("type")
        })
        return _obj
