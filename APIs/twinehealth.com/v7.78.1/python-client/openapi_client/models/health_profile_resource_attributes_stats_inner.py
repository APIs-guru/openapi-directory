...
class HealthProfileResourceAttributesStatsInner(BaseModel):
    """
    The category, answered and total counts for questions in the health profile
    """ # noqa: E501
    answered: Optional[Union[StrictFloat, StrictInt]] = None
    category: Optional[StrictStr] = None
    total: Optional[Union[StrictFloat, StrictInt]] = None
    __properties: ClassVar[List[str]] = ["answered", "category", "total"]
    ...
    def category_validate_enum(cls, value):
        ...
        if value not in set(['lifestyle_behaviors', 'mental_wellbeing', 'preventative_care', 'overall']):
            raise ValueError("must be one of enum values ('lifestyle_behaviors', 'mental_wellbeing', 'preventative_care', 'overall')")
        return value
