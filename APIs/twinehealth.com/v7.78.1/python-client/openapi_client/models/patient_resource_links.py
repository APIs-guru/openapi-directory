...
class PatientResourceLinks(BaseModel):
    """
    PatientResourceLinks
    """ # noqa: E501
    var_self: Optional[Annotated[str, Field(strict=True)]] = Field(default=None, alias="self")
    twine_web_app: Optional[StrictStr] = Field(default=None, description="A link to the patient record in the Fitbit Plus web application.")
    __properties: ClassVar[List[str]] = ["self", "twine_web_app"]
    ...
    def var_self_validate_regular_expression(cls, value):
        ...
        if not re.match(r"patient", value):
            raise ValueError(r"must validate the regular expression /patient/[0-9a-z]+")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "self": obj.get("self"),
            "twine_web_app": obj.get("twine_web_app")
        })
        return _obj
