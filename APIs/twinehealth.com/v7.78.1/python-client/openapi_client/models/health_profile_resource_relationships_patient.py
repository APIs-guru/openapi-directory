...
class HealthProfileResourceRelationshipsPatient(BaseModel):
    """
    HealthProfileResourceRelationshipsPatient
    """ # noqa: E501
    data: Optional[ActionResourceRelationshipsPlanData] = None
    links: Optional[HealthProfileResourceRelationshipsPatientLinks] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "links": HealthProfileResourceRelationshipsPatientLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
