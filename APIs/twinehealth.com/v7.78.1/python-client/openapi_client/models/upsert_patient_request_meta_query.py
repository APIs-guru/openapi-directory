...
class UpsertPatientRequestMetaQuery(BaseModel):
    """
    UpsertPatientRequestMetaQuery
    """ # noqa: E501
    groups: List[StrictStr] = Field(description="Group to create/update patient in.")
    identifier: UpsertPatientRequestMetaQueryIdentifier
    __properties: ClassVar[List[str]] = ["groups", "identifier"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "identifier": UpsertPatientRequestMetaQueryIdentifier.from_dict(obj["identifier"]) if obj.get("identifier") is not None else None
        })
        return _obj
