...
class UpsertPatientRequestMetaQueryIdentifier(BaseModel):
    """
    Identifier to match patient
    """ # noqa: E501
    system: Optional[StrictStr] = Field(default=None, description="Name of system")
    value: Optional[StrictStr] = Field(default=None, description="Value in system")
    __properties: ClassVar[List[str]] = ["system", "value"]
