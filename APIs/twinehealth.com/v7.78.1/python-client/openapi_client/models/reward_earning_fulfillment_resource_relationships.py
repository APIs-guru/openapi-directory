...
class RewardEarningFulfillmentResourceRelationships(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["patient", "reward_earning"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of reward_earning
        if self.reward_earning:
            _dict['reward_earning'] = self.reward_earning.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reward_earning": EmailHistoryResourceRelationshipsReceiver.from_dict(obj["reward_earning"]) if obj.get("reward_earning") is not None else None
        })
        return _obj
