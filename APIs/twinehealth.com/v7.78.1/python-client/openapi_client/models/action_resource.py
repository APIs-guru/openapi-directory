...
class ActionResource(BaseModel):
    ...
    ActionResource
    """ # noqa: E501
    attributes: Optional[ActionResourceAttributes] = None
    id: StrictStr
    relationships: Optional[ActionResourceRelationships] = None
    type: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": ActionResourceAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "relationships": ActionResourceRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
            "type": obj.get("type")
        })
        return _obj
