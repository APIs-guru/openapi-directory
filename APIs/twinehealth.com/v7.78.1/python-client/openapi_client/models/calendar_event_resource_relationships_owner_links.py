...
class CalendarEventResourceRelationshipsOwnerLinks(BaseModel):
    """
    ...
    def related_validate_regular_expression(cls, value):
        ...
        if not re.match(r"pub/calendar_event", value):
            raise ValueError(r"must validate the regular expression /pub/calendar_event/[0-9a-z]+")
        return value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CalendarEventResourceRelationshipsOwnerLinks from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CalendarEventResourceRelationshipsOwnerLinks from a dict"""
        if obj is None:
            return None
