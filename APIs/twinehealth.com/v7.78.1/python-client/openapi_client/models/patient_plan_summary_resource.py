...
class PatientPlanSummaryResource(BaseModel):
    ...
    """ # noqa: E501
    attributes: Optional[PatientPlanSummaryResourceAttributes] = None
    id: StrictStr
    links: Optional[PatientPlanSummaryResourceLinks] = None
    relationships: Optional[PatientPlanSummaryResourceRelationships] = None
    type: StrictStr
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['patient_plan_summary']):
            raise ValueError("must be one of enum values ('patient_plan_summary')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": PatientPlanSummaryResourceAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "links": PatientPlanSummaryResourceLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
            "relationships": PatientPlanSummaryResourceRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
            "type": obj.get("type")
        })
        return _obj
