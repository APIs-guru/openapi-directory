...
class PatientHealthMetricResourceRelationshipsPatient(BaseModel):
    """
    PatientHealthMetricResourceRelationshipsPatient
    """ # noqa: E501
    data: Optional[PatientHealthMetricResourceRelationshipsPatientData] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PatientHealthMetricResourceRelationshipsPatient from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PatientHealthMetricResourceRelationshipsPatient from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "data": PatientHealthMetricResourceRelationshipsPatientData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "links": obj.get("links")
        })
        return _obj
