...
class PatientPlanSummaryResourceRelationships(BaseModel):
    """
    ...
    current_results: Optional[PatientPlanSummaryResourceRelationshipsActions] = None
    patient: PatientPlanSummaryResourceRelationshipsPatient
    __properties: ClassVar[List[str]] = ["actions", "bundles", "current_results", "patient"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of bundles
        if self.bundles:
            _dict['bundles'] = self.bundles.to_dict()
        # override the default output from pydantic by calling `to_dict()` of current_results
        if self.current_results:
            _dict['current_results'] = self.current_results.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "actions": PatientPlanSummaryResourceRelationshipsActions.from_dict(obj["actions"]) if obj.get("actions") is not None else None,
            "bundles": PatientPlanSummaryResourceRelationshipsActions.from_dict(obj["bundles"]) if obj.get("bundles") is not None else None,
            "current_results": PatientPlanSummaryResourceRelationshipsActions.from_dict(obj["current_results"]) if obj.get("current_results") is not None else None,
            "patient": PatientPlanSummaryResourceRelationshipsPatient.from_dict(obj["patient"]) if obj.get("patient") is not None else None
        })
        return _obj
