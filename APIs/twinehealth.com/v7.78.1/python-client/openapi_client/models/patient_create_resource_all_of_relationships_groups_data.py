...
class PatientCreateResourceAllOfRelationshipsGroupsData(BaseModel):
    """
    PatientCreateResourceAllOfRelationshipsGroupsData
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Required if the `meta.query` is not defined.")
    meta: Optional[PatientCreateResourceAllOfRelationshipsGroupsMeta] = None
    type: StrictStr
    __properties: ClassVar[List[str]] = ["id", "meta", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "meta": PatientCreateResourceAllOfRelationshipsGroupsMeta.from_dict(obj["meta"]) if obj.get("meta") is not None else None,
            "type": obj.get("type")
        })
        return _obj
