...
class HealthQuestionDefinitionResourceAttributes(BaseModel):
    """
    HealthQuestionDefinitionResourceAttributes
    """ # noqa: E501
    category: Optional[StrictStr] = Field(default=None, description="The category for the health profile definition")
    format: Optional[HealthQuestionDefinitionResourceAttributesFormat] = None
    requirements: Optional[List[HealthQuestionDefinitionResourceAttributesRequirementsInner]] = Field(default=None, description="The lsit of age and gender requirements for the question to be included")
    text: Optional[StrictStr] = Field(default=None, description="The question text which corresponds to the answer choices")
    __properties: ClassVar[List[str]] = ["category", "format", "requirements", "text"]
    ...
    def category_validate_enum(cls, value):
        ...
        if value not in set(['lifestyle_behaviors', 'mental_wellbeing', 'preventative_care']):
            raise ValueError("must be one of enum values ('lifestyle_behaviors', 'mental_wellbeing', 'preventative_care')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "format": HealthQuestionDefinitionResourceAttributesFormat.from_dict(obj["format"]) if obj.get("format") is not None else None,
            "requirements": [HealthQuestionDefinitionResourceAttributesRequirementsInner.from_dict(_item) for _item in obj["requirements"]] if obj.get("requirements") is not None else None,
            "text": obj.get("text")
        })
        return _obj
