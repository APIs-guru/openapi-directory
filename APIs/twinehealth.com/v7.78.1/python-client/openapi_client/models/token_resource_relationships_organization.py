...
class TokenResourceRelationshipsOrganization(BaseModel):
    """
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": TokenResourceRelationshipsOrganizationData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "links": TokenResourceRelationshipsOrganizationLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
