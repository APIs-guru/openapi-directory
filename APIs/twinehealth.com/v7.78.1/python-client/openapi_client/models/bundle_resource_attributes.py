...
class BundleResourceAttributes(BaseModel):
    """
    BundleResourceAttributes
    """ # noqa: E501
    thread: Optional[StrictStr] = Field(default=None, alias="_thread")
    effective_from: StrictStr
    effective_to: Optional[StrictStr] = None
    title: StrictStr
    type: StrictStr
    __properties: ClassVar[List[str]] = ["_thread", "effective_from", "effective_to", "title", "type"]
