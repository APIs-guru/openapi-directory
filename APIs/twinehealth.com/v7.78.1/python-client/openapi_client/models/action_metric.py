...
class ActionMetric(BaseModel):
    ...
    validations: Optional[ActionMetricValidations] = None
    __properties: ClassVar[List[str]] = ["goal", "metric_type", "unit", "validations"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "unit": obj.get("unit"),
            "validations": ActionMetricValidations.from_dict(obj["validations"]) if obj.get("validations") is not None else None
        })
        return _obj
