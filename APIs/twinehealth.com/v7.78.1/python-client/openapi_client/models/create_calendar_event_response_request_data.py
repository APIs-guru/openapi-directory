...
class CreateCalendarEventResponseRequestData(BaseModel):
    """
    ...
    def type_validate_enum(cls, value):
        """Validates the enum"""
        if value not in set(['calendar_event_response']):
            raise ValueError("must be one of enum values ('calendar_event_response')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": CalendarEventResponseResourceAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "relationships": CreateCalendarEventResponseRequestDataRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
            "type": obj.get("type")
        })
        return _obj
