...
class PatientHealthResultResourceAttributesSource(BaseModel):
    """
    PatientHealthResultResourceAttributesSource
    """ # noqa: E501
    metadata: Optional[Any] = Field(default=None, description="Can be any value")
    name: Optional[StrictStr] = None
    source_id: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["metadata", "name", "source_id"]
