...
class CalendarEventResource(BaseModel):
    ...
    """ # noqa: E501
    attributes: Optional[CalendarEventResourceAttributes] = None
    id: Optional[StrictStr] = None
    links: Optional[CalendarEventResourceLinks] = None
    relationships: Optional[CalendarEventResourceRelationships] = None
    ...
    def type_validate_enum(cls, value):
        ...
        if value not in set(['calendar_event']):
            raise ValueError("must be one of enum values ('calendar_event')")
        return value
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": CalendarEventResourceAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "links": CalendarEventResourceLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
            "relationships": CalendarEventResourceRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
            "type": obj.get("type")
        })
        return _obj
