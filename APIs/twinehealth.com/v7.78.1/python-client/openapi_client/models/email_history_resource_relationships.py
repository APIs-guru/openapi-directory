...
class EmailHistoryResourceRelationships(BaseModel):
    """
    EmailHistoryResourceRelationships
    """ # noqa: E501
    receiver: Optional[EmailHistoryResourceRelationshipsReceiver] = None
    sender: Optional[EmailHistoryResourceRelationshipsReceiver] = None
    __properties: ClassVar[List[str]] = ["receiver", "sender"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "receiver": EmailHistoryResourceRelationshipsReceiver.from_dict(obj["receiver"]) if obj.get("receiver") is not None else None,
            "sender": EmailHistoryResourceRelationshipsReceiver.from_dict(obj["sender"]) if obj.get("sender") is not None else None
        })
        return _obj
