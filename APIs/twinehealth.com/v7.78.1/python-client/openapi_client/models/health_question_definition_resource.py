...
class HealthQuestionDefinitionResource(BaseModel):
    ...
    """ # noqa: E501
    attributes: Optional[HealthQuestionDefinitionResourceAttributes] = None
    id: StrictStr
    links: Optional[HealthQuestionDefinitionResourceLinks] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": HealthQuestionDefinitionResourceAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "links": HealthQuestionDefinitionResourceLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
