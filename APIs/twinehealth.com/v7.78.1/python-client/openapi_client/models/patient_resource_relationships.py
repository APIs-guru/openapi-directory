...
class PatientResourceRelationships(BaseModel):
    """
    PatientResourceRelationships
    """ # noqa: E501
    coaches: Optional[PatientResourceRelationshipsCoaches] = None
    groups: PatientResourceRelationshipsGroups
    __properties: ClassVar[List[str]] = ["coaches", "groups"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of coaches
        if self.coaches:
            _dict['coaches'] = self.coaches.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "coaches": PatientResourceRelationshipsCoaches.from_dict(obj["coaches"]) if obj.get("coaches") is not None else None,
            "groups": PatientResourceRelationshipsGroups.from_dict(obj["groups"]) if obj.get("groups") is not None else None
        })
        return _obj
