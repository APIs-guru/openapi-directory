...
class HealthProfileQuestionResourceRelationshipsQuestionDefinition(BaseModel):
    """
    HealthProfileQuestionResourceRelationshipsQuestionDefinition
    """ # noqa: E501
    data: Optional[ActionResourceRelationshipsPlanData] = None
    links: Optional[HealthProfileQuestionResourceRelationshipsQuestionDefinitionLinks] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "links": HealthProfileQuestionResourceRelationshipsQuestionDefinitionLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
