...
class PatientResourceRelationshipsCoaches(BaseModel):
    """
    PatientResourceRelationshipsCoaches
    """ # noqa: E501
    data: List[PatientCreateResourceAllOfRelationshipsCoachesData]
    links: Optional[PatientResourceRelationshipsCoachesLinks] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "links": PatientResourceRelationshipsCoachesLinks.from_dict(obj["links"]) if obj.get("links") is not None else None
        })
        return _obj
