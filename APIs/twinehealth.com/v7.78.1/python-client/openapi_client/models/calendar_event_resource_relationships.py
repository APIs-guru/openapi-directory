...
class CalendarEventResourceRelationships(BaseModel):
    """
    CalendarEventResourceRelationships
    """ # noqa: E501
    owner: Optional[CalendarEventResourceRelationshipsOwner] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "owner": CalendarEventResourceRelationshipsOwner.from_dict(obj["owner"]) if obj.get("owner") is not None else None
        })
        return _obj
