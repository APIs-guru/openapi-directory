...
class ActionMetricValidations(BaseModel):
    """
    ActionMetricValidations
    """ # noqa: E501
    maximum: Optional[ActionMetricValidationsMaximum] = None
    minimum: Optional[ActionMetricValidationsMaximum] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "maximum": ActionMetricValidationsMaximum.from_dict(obj["maximum"]) if obj.get("maximum") is not None else None,
            "minimum": ActionMetricValidationsMaximum.from_dict(obj["minimum"]) if obj.get("minimum") is not None else None
        })
        return _obj
