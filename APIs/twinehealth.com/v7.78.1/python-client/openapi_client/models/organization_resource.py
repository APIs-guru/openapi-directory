...
class OrganizationResource(BaseModel):
    ...
    id: StrictStr
    links: Optional[OrganizationResourceLinks] = None
    type: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "attributes": OrganizationResourceAttributes.from_dict(obj["attributes"]) if obj.get("attributes") is not None else None,
            "id": obj.get("id"),
            "links": OrganizationResourceLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
            "type": obj.get("type")
        })
        return _obj
