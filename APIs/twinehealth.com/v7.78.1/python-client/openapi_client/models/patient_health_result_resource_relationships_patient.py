...
class PatientHealthResultResourceRelationshipsPatient(BaseModel):
    """
    PatientHealthResultResourceRelationshipsPatient
    """ # noqa: E501
    data: Optional[PatientHealthResultResourceRelationshipsPatientData] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "data": PatientHealthResultResourceRelationshipsPatientData.from_dict(obj["data"]) if obj.get("data") is not None else None,
            "links": obj.get("links")
        })
        return _obj
