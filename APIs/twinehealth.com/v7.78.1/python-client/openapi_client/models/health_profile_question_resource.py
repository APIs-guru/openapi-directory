...
class HealthProfileQuestionResource(BaseModel):
    ...
    """ # noqa: E501
    attributes: Optional[Dict[str, Any]] = Field(default=None, description="A health profile question does not have any attribute since it only relates an answer to the corresponding question definition. ")
    id: StrictStr
    links: Optional[HealthProfileQuestionResourceLinks] = None
    relationships: Optional[HealthProfileQuestionResourceRelationships] = None
    type: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "links": HealthProfileQuestionResourceLinks.from_dict(obj["links"]) if obj.get("links") is not None else None,
            "relationships": HealthProfileQuestionResourceRelationships.from_dict(obj["relationships"]) if obj.get("relationships") is not None else None,
            "type": obj.get("type")
        })
        return _obj
