...
class CreatePatientHealthMetricRequestMeta(BaseModel):
    """
    CreatePatientHealthMetricRequestMeta
    """ # noqa: E501
    ignore_duplicates: Optional[StrictBool] = Field(default=None, description="If `true`, the patient health metric will be ignored if there is an existing patient health metric for the same patient, with the same `type` and same `occurred_at`. ")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "ignore_duplicates": obj.get("ignore_duplicates")
        })
        return _obj
