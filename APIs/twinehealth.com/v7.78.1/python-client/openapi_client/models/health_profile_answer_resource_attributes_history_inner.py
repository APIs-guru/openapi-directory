...
class HealthProfileAnswerResourceAttributesHistoryInner(BaseModel):
    """
    The details of a previous answer for a health profile question
    """ # noqa: E501
    created_by: Optional[StrictStr] = Field(default=None, description="The id of the patient or coach who answered the health profile question", alias="_created_by")
    answered_at: Optional[StrictStr] = Field(default=None, description="The date when the health profile question is answered")
    value: Optional[StrictStr] = Field(default=None, description="The value of the answer entered for the health profile question")
    __properties: ClassVar[List[str]] = ["_created_by", "answered_at", "value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "_created_by": obj.get("_created_by"),
