...
class CalendarEventResponseResourceAttributes(BaseModel):
    """
    CalendarEventResponseResourceAttributes
    """ # noqa: E501
    attendee: Optional[Dict[str, Any]] = Field(default=None, description="The attendee in the attendees list of the calendar event.")
    response_status: Optional[StrictStr] = Field(default=None, description="The response status for the attendee.")
    __properties: ClassVar[List[str]] = ["attendee", "response_status"]
    ...
    def response_status_validate_enum(cls, value):
        ...
        if value not in set(['accepted', 'declined', 'tentative']):
            raise ValueError("must be one of enum values ('accepted', 'declined', 'tentative')")
        return value
