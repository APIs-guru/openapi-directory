...
class RewardEarningFulfillmentResourceAttributes(BaseModel):
    """
    RewardEarningFulfillmentResourceAttributes
    """ # noqa: E501
    fulfilled_at: StrictStr = Field(description="Date at which the reward earning was fulfilled. (Must be at the same time or after the reward was earned)")
    fulfilled_unit: Optional[StrictStr] = Field(default=None, description="Unit of the earned reward that has been fulfilled. (Read-only property)")
    fulfilled_value: Union[StrictFloat, StrictInt] = Field(description="Value of the earned reward that has been fulfilled. (Must be greater than or equal to 0)")
    __properties: ClassVar[List[str]] = ["fulfilled_at", "fulfilled_unit", "fulfilled_value"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "fulfilled_unit": obj.get("fulfilled_unit"),
