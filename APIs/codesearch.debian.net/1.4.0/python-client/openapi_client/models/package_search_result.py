...
class PackageSearchResult(BaseModel):
    ...
    PackageSearchResult
    """ # noqa: E501
    package: StrictStr = Field(description="The Debian source package for which up to 2 search results have been aggregated in `results`.")
    results: List[SearchResult]
    __properties: ClassVar[List[str]] = ["package", "results"]
