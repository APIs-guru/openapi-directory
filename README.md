...
<BR> We are migrating our URLs to `APIs.guru` domain. Old URLs will work untill ~~22th Jun~~ ~~29th Jun~~ 8th Jul, for details, please see [this issue](https://github.com/APIs-guru/api-models/issues/85).
<BR><BR><BR><BR>
