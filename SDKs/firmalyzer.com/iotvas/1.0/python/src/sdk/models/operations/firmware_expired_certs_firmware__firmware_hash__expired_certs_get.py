...
class FirmwareExpiredCertsFirmwareFirmwareHashExpiredCertsGetRequest:
    path_params: FirmwareExpiredCertsFirmwareFirmwareHashExpiredCertsGetPathParams = field(default=None)
    security: FirmwareExpiredCertsFirmwareFirmwareHashExpiredCertsGetSecurity = field(default=None)
