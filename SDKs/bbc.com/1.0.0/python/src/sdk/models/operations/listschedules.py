...
class ListSchedulesSortEnum(str, Enum):
    START_DATE = "start_date"

class ListSchedulesSortDirectionEnum(str, Enum):
    ASCENDING = "ascending"
    DESCENDING = "descending"


@dataclass
class ListSchedulesQueryParams:
    ...
    id_type: Optional[List[str]] = field(default=None, metadata={'query_param': { 'field_name': 'id_type', 'style': 'form', 'explode': True }})
    item: Optional[List[str]] = field(default=None, metadata={'query_param': { 'field_name': 'item', 'style': 'form', 'explode': True }})
    mixin: Optional[List[ListSchedulesMixinEnum]] = field(default=None, metadata={'query_param': { 'field_name': 'mixin', 'style': 'form', 'explode': True }})
    ...
    sort_direction: Optional[ListSchedulesSortDirectionEnum] = field(default=None, metadata={'query_param': { 'field_name': 'sort_direction', 'style': 'form', 'explode': True }})
