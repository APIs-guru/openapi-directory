...
var SDK = /** @class */ (function () {
     ...
     * Get raw ancestors
    **/
    SDK.prototype.GetRawAncestors = function (req, config) {
     ...
     * Get raw brand
    **/
    SDK.prototype.GetRawBrand = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.GetRawBrandFranchises = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Get raw episode
    **/
    SDK.prototype.GetRawEpisode = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Get raw formats
    **/
    SDK.prototype.GetRawFormats = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.GetRawGenreGroups = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Get raw image
    **/
    SDK.prototype.GetRawImage = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Get raw masterbrand
    **/
    SDK.prototype.GetRawMasterbrand = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Get raw promotion
    **/
    SDK.prototype.GetRawPromotion = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Get API definition
    **/
    SDK.prototype.GetApi = function (config) {
        var baseURL = this.serverURL;
    ...
    **/
    SDK.prototype.GetXsd = function (config) {
        var baseURL = this.serverURL;
    ...
    **/
    SDK.prototype.ListAvailability = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ListAvailabilityRequest(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/availabilities";
        var client = this.securityClient;
    ...
    **/
    SDK.prototype.ListBroadcasts = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ListBroadcastsRequest(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/broadcasts";
        var client = this.securityClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    SDK.prototype.ListMasterbrands = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ListMasterbrandsRequest(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/master_brands";
        var client = this.securityClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    SDK.prototype.ListPeople = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.ListPips = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ListPipsRequest(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/pips";
        var client = this.securityClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    SDK.prototype.ListProgrammeDetails = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ListProgrammeDetailsRequest(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/programme_details";
        var client = this.securityClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    SDK.prototype.ListProgrammes = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ListProgrammesRequest(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/programmes";
        var client = this.securityClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    SDK.prototype.ListPromotions = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ListPromotionsRequest(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/promotions";
        var client = this.securityClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    SDK.prototype.ListVersions = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
