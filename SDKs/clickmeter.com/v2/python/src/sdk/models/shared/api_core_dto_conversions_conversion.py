...
class APICoreDtoConversionsConversion:
    ...
    protocol: Optional[APICoreDtoConversionsConversionProtocolEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'protocol' }, 'form': { 'field_name': 'protocol' }})
    value: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'value' }, 'form': { 'field_name': 'value' }})
