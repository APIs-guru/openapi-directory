...
class ConversionsGetStatisticsSingleQueryParams:
    ...
    time_frame: ConversionsGetStatisticsSingleTimeFrameEnum = field(default=None, metadata={'query_param': { 'field_name': 'timeFrame', 'style': 'form', 'explode': True }})
...
class ConversionsGetStatisticsSingleRequest:
    path_params: ConversionsGetStatisticsSinglePathParams = field(default=None)
    query_params: ConversionsGetStatisticsSingleQueryParams = field(default=None)
