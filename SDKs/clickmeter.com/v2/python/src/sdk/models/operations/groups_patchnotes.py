...
@dataclass
class GroupsPatchNotesPathParams:
    id: int = field(default=None, metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclass
class GroupsPatchNotesRequests:
...
@dataclass
class GroupsPatchNotesRequest:
    path_params: GroupsPatchNotesPathParams = field(default=None)
    request: GroupsPatchNotesRequests = field(default=None)
    

@dataclass
class GroupsPatchNotesResponse:
