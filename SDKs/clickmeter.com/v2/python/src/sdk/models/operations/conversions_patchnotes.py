...
@dataclass
class ConversionsPatchNotesRequest:
    path_params: ConversionsPatchNotesPathParams = field(default=None)
    request: ConversionsPatchNotesRequests = field(default=None)
    

@dataclass
class ConversionsPatchNotesResponse:
