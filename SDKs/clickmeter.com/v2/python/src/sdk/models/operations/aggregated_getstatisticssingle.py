...
class AggregatedGetStatisticsSingleQueryParams:
    ...
    time_frame: AggregatedGetStatisticsSingleTimeFrameEnum = field(default=None, metadata={'query_param': { 'field_name': 'timeFrame', 'style': 'form', 'explode': True }})
...
class AggregatedGetStatisticsSingleRequest:
    query_params: AggregatedGetStatisticsSingleQueryParams = field(default=None)
