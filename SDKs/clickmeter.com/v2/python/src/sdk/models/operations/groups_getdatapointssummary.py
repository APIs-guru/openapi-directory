...
class GroupsGetDatapointsSummaryQueryParams:
    ...
    time_frame: GroupsGetDatapointsSummaryTimeFrameEnum = field(default=None, metadata={'query_param': { 'field_name': 'timeFrame', 'style': 'form', 'explode': True }})
...
class GroupsGetDatapointsSummaryRequest:
    path_params: GroupsGetDatapointsSummaryPathParams = field(default=None)
    query_params: GroupsGetDatapointsSummaryQueryParams = field(default=None)
