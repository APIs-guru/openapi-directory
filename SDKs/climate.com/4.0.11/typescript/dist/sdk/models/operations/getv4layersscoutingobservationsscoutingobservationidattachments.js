...
var GetV4LayersScoutingObservationsScoutingObservationIdAttachmentsSecurityOption1 = /** @class */ (function (_super) {
    __extends(GetV4LayersScoutingObservationsScoutingObservationIdAttachmentsSecurityOption1, _super);
    function GetV4LayersScoutingObservationsScoutingObservationIdAttachmentsSecurityOption1() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "security, scheme=true;type=apiKey;subtype=header" }),
        __metadata("design:type", shared.SchemeApiKey)
    ], GetV4LayersScoutingObservationsScoutingObservationIdAttachmentsSecurityOption1.prototype, "apiKey", void 0);
    return GetV4LayersScoutingObservationsScoutingObservationIdAttachmentsSecurityOption1;
}(SpeakeasyBase));
export { GetV4LayersScoutingObservationsScoutingObservationIdAttachmentsSecurityOption1 };
var GetV4LayersScoutingObservationsScoutingObservationIdAttachmentsSecurityOption2 = /** @class */ (function (_super) {
    __extends(GetV4LayersScoutingObservationsScoutingObservationIdAttachmentsSecurityOption2, _super);
    function GetV4LayersScoutingObservationsScoutingObservationIdAttachmentsSecurityOption2() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "security, scheme=true;type=oauth2" }),
        __metadata("design:type", shared.SchemeOauth2AuthorizationCode)
    ], GetV4LayersScoutingObservationsScoutingObservationIdAttachmentsSecurityOption2.prototype, "oauth2AuthorizationCode", void 0);
    return GetV4LayersScoutingObservationsScoutingObservationIdAttachmentsSecurityOption2;
}(SpeakeasyBase));
export { GetV4LayersScoutingObservationsScoutingObservationIdAttachmentsSecurityOption2 };
var GetV4LayersScoutingObservationsScoutingObservationIdAttachmentsSecurity = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", GetV4LayersScoutingObservationsScoutingObservationIdAttachmentsSecurityOption1)
    ], GetV4LayersScoutingObservationsScoutingObservationIdAttachmentsSecurity.prototype, "option1", void 0);
    __decorate([
        Metadata({ data: "security, option=true" }),
        __metadata("design:type", GetV4LayersScoutingObservationsScoutingObservationIdAttachmentsSecurityOption2)
    ], GetV4LayersScoutingObservationsScoutingObservationIdAttachmentsSecurity.prototype, "option2", void 0);
