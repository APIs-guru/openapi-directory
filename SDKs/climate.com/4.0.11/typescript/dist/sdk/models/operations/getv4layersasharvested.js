...
var GetV4LayersAsHarvestedSecurityOption1 = /** @class */ (function (_super) {
    __extends(GetV4LayersAsHarvestedSecurityOption1, _super);
    function GetV4LayersAsHarvestedSecurityOption1() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "security, scheme=true;type=apiKey;subtype=header" }),
        __metadata("design:type", shared.SchemeApiKey)
    ], GetV4LayersAsHarvestedSecurityOption1.prototype, "apiKey", void 0);
    return GetV4LayersAsHarvestedSecurityOption1;
}(SpeakeasyBase));
export { GetV4LayersAsHarvestedSecurityOption1 };
var GetV4LayersAsHarvestedSecurityOption2 = /** @class */ (function (_super) {
    __extends(GetV4LayersAsHarvestedSecurityOption2, _super);
    function GetV4LayersAsHarvestedSecurityOption2() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "security, scheme=true;type=oauth2" }),
        __metadata("design:type", shared.SchemeOauth2AuthorizationCode)
    ], GetV4LayersAsHarvestedSecurityOption2.prototype, "oauth2AuthorizationCode", void 0);
    return GetV4LayersAsHarvestedSecurityOption2;
}(SpeakeasyBase));
export { GetV4LayersAsHarvestedSecurityOption2 };
var GetV4LayersAsHarvestedSecurity = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", GetV4LayersAsHarvestedSecurityOption1)
    ], GetV4LayersAsHarvestedSecurity.prototype, "option1", void 0);
    __decorate([
        Metadata({ data: "security, option=true" }),
        __metadata("design:type", GetV4LayersAsHarvestedSecurityOption2)
    ], GetV4LayersAsHarvestedSecurity.prototype, "option2", void 0);
