...
var GetV4LayersAsPlantedSecurityOption1 = /** @class */ (function (_super) {
    __extends(GetV4LayersAsPlantedSecurityOption1, _super);
    function GetV4LayersAsPlantedSecurityOption1() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "security, scheme=true;type=apiKey;subtype=header" }),
        __metadata("design:type", shared.SchemeApiKey)
    ], GetV4LayersAsPlantedSecurityOption1.prototype, "apiKey", void 0);
    return GetV4LayersAsPlantedSecurityOption1;
}(SpeakeasyBase));
export { GetV4LayersAsPlantedSecurityOption1 };
var GetV4LayersAsPlantedSecurityOption2 = /** @class */ (function (_super) {
    __extends(GetV4LayersAsPlantedSecurityOption2, _super);
    function GetV4LayersAsPlantedSecurityOption2() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "security, scheme=true;type=oauth2" }),
        __metadata("design:type", shared.SchemeOauth2AuthorizationCode)
    ], GetV4LayersAsPlantedSecurityOption2.prototype, "oauth2AuthorizationCode", void 0);
    return GetV4LayersAsPlantedSecurityOption2;
}(SpeakeasyBase));
export { GetV4LayersAsPlantedSecurityOption2 };
var GetV4LayersAsPlantedSecurity = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", GetV4LayersAsPlantedSecurityOption1)
    ], GetV4LayersAsPlantedSecurity.prototype, "option1", void 0);
    __decorate([
        Metadata({ data: "security, option=true" }),
        __metadata("design:type", GetV4LayersAsPlantedSecurityOption2)
    ], GetV4LayersAsPlantedSecurity.prototype, "option2", void 0);
