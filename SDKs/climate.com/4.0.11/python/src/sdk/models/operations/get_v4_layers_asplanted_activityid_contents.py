...
class GetV4LayersAsPlantedActivityIDContentsRequest:
    headers: GetV4LayersAsPlantedActivityIDContentsHeaders = field()
    path_params: GetV4LayersAsPlantedActivityIDContentsPathParams = field()
    security: GetV4LayersAsPlantedActivityIDContentsSecurity = field()
