...
@dataclass
class GetAccountsAccountIDBeneficiariesPathParams:
    account_id: str = field(default=None, metadata={'path_param': { 'field_name': 'accountId', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetAccountsAccountIDBeneficiariesHeaders:
...
class GetAccountsAccountIDBeneficiariesRequest:
    path_params: GetAccountsAccountIDBeneficiariesPathParams = field(default=None)
    headers: GetAccountsAccountIDBeneficiariesHeaders = field(default=None)
    security: GetAccountsAccountIDBeneficiariesSecurity = field(default=None)
...
class GetAccountsAccountIDBeneficiariesResponse:
    ...
    ob_read_beneficiary5: Optional[shared.ObReadBeneficiary5] = field(default=None)
