...
class GetAccountsAccountIDStatementsStatementIDTransactionsRequest:
    headers: GetAccountsAccountIDStatementsStatementIDTransactionsHeaders = field()
    path_params: GetAccountsAccountIDStatementsStatementIDTransactionsPathParams = field()
    security: GetAccountsAccountIDStatementsStatementIDTransactionsSecurity = field()
