...
class GetAccountsAccountIDBalancesRequest:
    headers: GetAccountsAccountIDBalancesHeaders = field()
    path_params: GetAccountsAccountIDBalancesPathParams = field()
    security: GetAccountsAccountIDBalancesSecurity = field()
