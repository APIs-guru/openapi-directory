...
class GetSigningBasketStatusRequest:
    path_params: GetSigningBasketStatusPathParams = field(default=None)
    headers: GetSigningBasketStatusHeaders = field(default=None)
    security: GetSigningBasketStatusSecurity = field(default=None)
