...
class InitiatePaymentHeaders:
    ...
    tpp_rejection_no_funds_preferred: Optional[bool] = field(default=None, metadata={'header': { 'field_name': 'TPP-Rejection-NoFunds-Preferred', 'style': 'simple', 'explode': False }})
...
class InitiatePaymentRequest:
    headers: InitiatePaymentHeaders = field()
    path_params: InitiatePaymentPathParams = field()
    request: InitiatePaymentRequests = field()
    security: InitiatePaymentSecurity = field()
