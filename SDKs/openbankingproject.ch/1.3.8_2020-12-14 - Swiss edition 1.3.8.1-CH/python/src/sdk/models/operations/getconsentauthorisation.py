...
class GetConsentAuthorisationRequest:
    path_params: GetConsentAuthorisationPathParams = field(default=None)
    headers: GetConsentAuthorisationHeaders = field(default=None)
    security: GetConsentAuthorisationSecurity = field(default=None)
