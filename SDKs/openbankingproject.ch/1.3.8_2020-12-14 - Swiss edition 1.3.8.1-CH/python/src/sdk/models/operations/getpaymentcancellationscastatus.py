...
class GetPaymentCancellationScaStatusRequest:
    path_params: GetPaymentCancellationScaStatusPathParams = field(default=None)
    headers: GetPaymentCancellationScaStatusHeaders = field(default=None)
    security: GetPaymentCancellationScaStatusSecurity = field(default=None)
