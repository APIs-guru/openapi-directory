...
class GetPaymentCancellationScaStatusRequest:
    headers: GetPaymentCancellationScaStatusHeaders = field()
    path_params: GetPaymentCancellationScaStatusPathParams = field()
    security: GetPaymentCancellationScaStatusSecurity = field()
