...
class GetConsentInformationRequest:
    path_params: GetConsentInformationPathParams = field(default=None)
    headers: GetConsentInformationHeaders = field(default=None)
    security: GetConsentInformationSecurity = field(default=None)
...
class GetConsentInformationResponse:
    ...
    consent_information_response_200_json: Optional[shared.ConsentInformationResponse200JSON] = field(default=None)
