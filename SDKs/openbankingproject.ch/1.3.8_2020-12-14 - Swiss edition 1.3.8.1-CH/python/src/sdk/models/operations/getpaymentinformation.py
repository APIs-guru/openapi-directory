...
class GetPaymentInformationRequest:
    path_params: GetPaymentInformationPathParams = field(default=None)
    headers: GetPaymentInformationHeaders = field(default=None)
    security: GetPaymentInformationSecurity = field(default=None)
...
class GetPaymentInformationResponse:
    ...
    get_payment_information_200_application_json_one_of: Optional[Any] = field(default=None)
