...
class CreateConsentHeaders:
    ...
    tpp_brand_logging_information: Optional[str] = field(default=None, metadata={'header': { 'field_name': 'TPP-Brand-Logging-Information', 'style': 'simple', 'explode': False }})
    tpp_explicit_authorisation_preferred: Optional[bool] = field(default=None, metadata={'header': { 'field_name': 'TPP-Explicit-Authorisation-Preferred', 'style': 'simple', 'explode': False }})
