...
class StartPaymentAuthorisationRequest:
    path_params: StartPaymentAuthorisationPathParams = field(default=None)
    headers: StartPaymentAuthorisationHeaders = field(default=None)
    request: Optional[Any] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: StartPaymentAuthorisationSecurity = field(default=None)
