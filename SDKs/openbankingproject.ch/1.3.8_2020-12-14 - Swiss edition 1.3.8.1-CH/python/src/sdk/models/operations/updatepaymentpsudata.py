...
class UpdatePaymentPsuDataRequest:
    path_params: UpdatePaymentPsuDataPathParams = field(default=None)
    headers: UpdatePaymentPsuDataHeaders = field(default=None)
    request: Optional[Any] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: UpdatePaymentPsuDataSecurity = field(default=None)
