...
class GetPaymentInitiationAuthorisationRequest:
    headers: GetPaymentInitiationAuthorisationHeaders = field()
    path_params: GetPaymentInitiationAuthorisationPathParams = field()
    security: GetPaymentInitiationAuthorisationSecurity = field()
