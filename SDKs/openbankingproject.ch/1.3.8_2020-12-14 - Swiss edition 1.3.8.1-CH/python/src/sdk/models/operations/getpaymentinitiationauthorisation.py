...
class GetPaymentInitiationAuthorisationRequest:
    path_params: GetPaymentInitiationAuthorisationPathParams = field(default=None)
    headers: GetPaymentInitiationAuthorisationHeaders = field(default=None)
    security: GetPaymentInitiationAuthorisationSecurity = field(default=None)
