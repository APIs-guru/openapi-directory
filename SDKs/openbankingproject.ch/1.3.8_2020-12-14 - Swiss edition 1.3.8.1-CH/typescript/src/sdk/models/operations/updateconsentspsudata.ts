...
export class UpdateConsentsPsuDataPathParams extends SpeakeasyBase {
...
export class UpdateConsentsPsuDataHeaders extends SpeakeasyBase {
...
export class UpdateConsentsPsuDataSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "security, scheme=true;type=http;subtype=bearer" })
  bearerAuthOAuth?: shared.SchemeBearerAuthOAuth;
}


export class UpdateConsentsPsuDataRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class UpdateConsentsPsuDataResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
