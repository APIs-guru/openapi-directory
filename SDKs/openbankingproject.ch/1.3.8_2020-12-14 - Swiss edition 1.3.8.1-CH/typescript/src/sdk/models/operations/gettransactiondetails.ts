...
export class GetTransactionDetailsPathParams extends SpeakeasyBase {
...
export class GetTransactionDetailsHeaders extends SpeakeasyBase {
...
export class GetTransactionDetails200ApplicationJson extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=transactionsDetails" })
