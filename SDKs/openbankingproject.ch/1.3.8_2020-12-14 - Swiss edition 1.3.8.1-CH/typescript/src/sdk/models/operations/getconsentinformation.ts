...
export class GetConsentInformationPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=consentId" })
  consentId: string;
}


export class GetConsentInformationHeaders extends SpeakeasyBase {
...
export class GetConsentInformationSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "security, scheme=true;type=http;subtype=bearer" })
  bearerAuthOAuth?: shared.SchemeBearerAuthOAuth;
}


export class GetConsentInformationRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetConsentInformationResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
