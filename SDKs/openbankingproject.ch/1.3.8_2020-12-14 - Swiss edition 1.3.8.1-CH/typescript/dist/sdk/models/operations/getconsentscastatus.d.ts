...
export declare class GetConsentScaStatusPathParams extends SpeakeasyBase {
    authorisationId: string;
    consentId: string;
}
export declare class GetConsentScaStatusHeaders extends SpeakeasyBase {
    digest?: string;
    psuAccept?: string;
...
export declare class GetConsentScaStatusSecurity extends SpeakeasyBase {
    bearerAuthOAuth?: shared.SchemeBearerAuthOAuth;
}
export declare class GetConsentScaStatusRequest extends SpeakeasyBase {
    pathParams: GetConsentScaStatusPathParams;
    headers: GetConsentScaStatusHeaders;
    security: GetConsentScaStatusSecurity;
}
export declare class GetConsentScaStatusResponse extends SpeakeasyBase {
    contentType: string;
