...
export declare class StartConsentAuthorisationPathParams extends SpeakeasyBase {
    consentId: string;
}
export declare class StartConsentAuthorisationHeaders extends SpeakeasyBase {
    digest?: string;
    psuAccept?: string;
...
export declare class StartConsentAuthorisationSecurity extends SpeakeasyBase {
    bearerAuthOAuth?: shared.SchemeBearerAuthOAuth;
}
export declare class StartConsentAuthorisationRequest extends SpeakeasyBase {
...
export declare class StartConsentAuthorisationResponse extends SpeakeasyBase {
    contentType: string;
