 ...
 *
**/
var SigningBasket = /** @class */ (function (_super) {
    __extends(SigningBasket, _super);
    ...
    ], SigningBasket.prototype, "consentIds", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=paymentIds" }),
        __metadata("design:type", Array)
    ], SigningBasket.prototype, "paymentIds", void 0);
    return SigningBasket;
}(SpeakeasyBase));
export { SigningBasket };
