...
type GetPaymentInitiationCancellationAuthorisationInformationPathParams struct {
...
type GetPaymentInitiationCancellationAuthorisationInformationHeaders struct {
...
type GetPaymentInitiationCancellationAuthorisationInformationSecurity struct {
	BearerAuthOAuth *shared.SchemeBearerAuthOAuth `security:"scheme,type=http,subtype=bearer"`
}

type GetPaymentInitiationCancellationAuthorisationInformationRequest struct {
...
type GetPaymentInitiationCancellationAuthorisationInformationResponse struct {
	ContentType    string
