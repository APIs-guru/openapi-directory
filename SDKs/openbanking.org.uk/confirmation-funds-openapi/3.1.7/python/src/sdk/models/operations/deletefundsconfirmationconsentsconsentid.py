...
class DeleteFundsConfirmationConsentsConsentIDRequest:
    headers: DeleteFundsConfirmationConsentsConsentIDHeaders = field()
    path_params: DeleteFundsConfirmationConsentsConsentIDPathParams = field()
    security: DeleteFundsConfirmationConsentsConsentIDSecurity = field()
