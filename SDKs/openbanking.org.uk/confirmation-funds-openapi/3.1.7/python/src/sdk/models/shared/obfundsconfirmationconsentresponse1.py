...
class ObFundsConfirmationConsentResponse1Data:
    ...
    debtor_account: ObFundsConfirmationConsentResponse1DataDebtorAccount = field(default=None, metadata={'dataclasses_json': { 'field_name': 'DebtorAccount' }})
    ...
    status: ObFundsConfirmationConsentResponse1DataStatusEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Status' }})
...
class ObFundsConfirmationConsentResponse1:
    data: ObFundsConfirmationConsentResponse1Data = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Data' }})
