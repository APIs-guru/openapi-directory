...
class ObFundsConfirmationConsent1Data:
    debtor_account: ObFundsConfirmationConsent1DataDebtorAccount = field(default=None, metadata={'dataclasses_json': { 'field_name': 'DebtorAccount' }})
...
class ObFundsConfirmationConsent1:
    data: ObFundsConfirmationConsent1Data = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Data' }})
