...
class CreateFundsConfirmationConsentsRequest:
    headers: CreateFundsConfirmationConsentsHeaders = field(default=None)
    request: shared.ObFundsConfirmationConsent1 = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: CreateFundsConfirmationConsentsSecurity = field(default=None)
