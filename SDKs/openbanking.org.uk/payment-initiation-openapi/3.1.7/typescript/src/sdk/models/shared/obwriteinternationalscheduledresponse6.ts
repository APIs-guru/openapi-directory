...
export class ObWriteInternationalScheduledResponse6Data extends SpeakeasyBase {
  @Metadata({ data: "json, name=Charges", elemType: shared.ObWriteInternationalScheduledResponse6DataCharges })
  ...
  @Metadata({ data: "json, name=InternationalScheduledPaymentId" })
