...
class GetInternationalPaymentConsentsConsentIDFundsConfirmationRequest:
    path_params: GetInternationalPaymentConsentsConsentIDFundsConfirmationPathParams = field(default=None)
    headers: GetInternationalPaymentConsentsConsentIDFundsConfirmationHeaders = field(default=None)
    security: GetInternationalPaymentConsentsConsentIDFundsConfirmationSecurity = field(default=None)
