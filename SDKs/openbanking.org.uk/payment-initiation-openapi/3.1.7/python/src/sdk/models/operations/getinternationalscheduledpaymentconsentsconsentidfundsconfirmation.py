...
class GetInternationalScheduledPaymentConsentsConsentIDFundsConfirmationRequest:
    headers: GetInternationalScheduledPaymentConsentsConsentIDFundsConfirmationHeaders = field()
    path_params: GetInternationalScheduledPaymentConsentsConsentIDFundsConfirmationPathParams = field()
    security: GetInternationalScheduledPaymentConsentsConsentIDFundsConfirmationSecurity = field()
