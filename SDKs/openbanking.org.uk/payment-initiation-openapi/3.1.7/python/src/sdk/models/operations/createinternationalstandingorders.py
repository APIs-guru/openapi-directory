...
class CreateInternationalStandingOrdersRequest:
    headers: CreateInternationalStandingOrdersHeaders = field()
    request: CreateInternationalStandingOrdersRequests = field()
    security: CreateInternationalStandingOrdersSecurity = field()
