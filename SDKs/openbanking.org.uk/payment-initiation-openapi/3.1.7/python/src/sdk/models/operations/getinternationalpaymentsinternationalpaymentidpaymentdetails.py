...
class GetInternationalPaymentsInternationalPaymentIDPaymentDetailsRequest:
    path_params: GetInternationalPaymentsInternationalPaymentIDPaymentDetailsPathParams = field(default=None)
    headers: GetInternationalPaymentsInternationalPaymentIDPaymentDetailsHeaders = field(default=None)
    security: GetInternationalPaymentsInternationalPaymentIDPaymentDetailsSecurity = field(default=None)
