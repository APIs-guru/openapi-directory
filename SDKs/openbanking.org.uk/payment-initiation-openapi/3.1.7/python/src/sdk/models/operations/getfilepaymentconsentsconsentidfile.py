...
class GetFilePaymentConsentsConsentIDFileRequest:
    path_params: GetFilePaymentConsentsConsentIDFilePathParams = field(default=None)
    headers: GetFilePaymentConsentsConsentIDFileHeaders = field(default=None)
    security: GetFilePaymentConsentsConsentIDFileSecurity = field(default=None)
