...
class GetDomesticStandingOrdersDomesticStandingOrderIDRequest:
    path_params: GetDomesticStandingOrdersDomesticStandingOrderIDPathParams = field(default=None)
    headers: GetDomesticStandingOrdersDomesticStandingOrderIDHeaders = field(default=None)
    security: GetDomesticStandingOrdersDomesticStandingOrderIDSecurity = field(default=None)
