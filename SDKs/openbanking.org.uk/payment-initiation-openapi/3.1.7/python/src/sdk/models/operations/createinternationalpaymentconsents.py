...
class CreateInternationalPaymentConsentsRequest:
    headers: CreateInternationalPaymentConsentsHeaders = field()
    request: CreateInternationalPaymentConsentsRequests = field()
    security: CreateInternationalPaymentConsentsSecurity = field()
