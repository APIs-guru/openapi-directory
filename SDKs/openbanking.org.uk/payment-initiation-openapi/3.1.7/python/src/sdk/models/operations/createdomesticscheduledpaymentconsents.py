...
class CreateDomesticScheduledPaymentConsentsRequest:
    headers: CreateDomesticScheduledPaymentConsentsHeaders = field()
    request: CreateDomesticScheduledPaymentConsentsRequests = field()
    security: CreateDomesticScheduledPaymentConsentsSecurity = field()
