...
class GetInternationalStandingOrderConsentsConsentIDRequest:
    headers: GetInternationalStandingOrderConsentsConsentIDHeaders = field()
    path_params: GetInternationalStandingOrderConsentsConsentIDPathParams = field()
    security: GetInternationalStandingOrderConsentsConsentIDSecurity = field()
