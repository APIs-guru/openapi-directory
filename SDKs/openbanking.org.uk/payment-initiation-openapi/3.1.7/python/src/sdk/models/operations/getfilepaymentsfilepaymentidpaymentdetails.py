...
class GetFilePaymentsFilePaymentIDPaymentDetailsRequest:
    headers: GetFilePaymentsFilePaymentIDPaymentDetailsHeaders = field()
    path_params: GetFilePaymentsFilePaymentIDPaymentDetailsPathParams = field()
    security: GetFilePaymentsFilePaymentIDPaymentDetailsSecurity = field()
