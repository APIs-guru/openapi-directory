...
class GetFilePaymentsFilePaymentIDPaymentDetailsRequest:
    path_params: GetFilePaymentsFilePaymentIDPaymentDetailsPathParams = field(default=None)
    headers: GetFilePaymentsFilePaymentIDPaymentDetailsHeaders = field(default=None)
    security: GetFilePaymentsFilePaymentIDPaymentDetailsSecurity = field(default=None)
