...
class CreateInternationalStandingOrderConsentsRequest:
    headers: CreateInternationalStandingOrderConsentsHeaders = field()
    request: CreateInternationalStandingOrderConsentsRequests = field()
    security: CreateInternationalStandingOrderConsentsSecurity = field()
