...
class GetFilePaymentsFilePaymentIDPathParams:
    file_payment_id: str = field(default=None, metadata={'path_param': { 'field_name': 'FilePaymentId', 'style': 'simple', 'explode': False }})
...
class GetFilePaymentsFilePaymentIDRequest:
    path_params: GetFilePaymentsFilePaymentIDPathParams = field(default=None)
    headers: GetFilePaymentsFilePaymentIDHeaders = field(default=None)
    security: GetFilePaymentsFilePaymentIDSecurity = field(default=None)
