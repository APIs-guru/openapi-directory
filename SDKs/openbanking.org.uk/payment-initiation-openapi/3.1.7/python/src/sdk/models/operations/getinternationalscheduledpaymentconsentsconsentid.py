...
class GetInternationalScheduledPaymentConsentsConsentIDRequest:
    headers: GetInternationalScheduledPaymentConsentsConsentIDHeaders = field()
    path_params: GetInternationalScheduledPaymentConsentsConsentIDPathParams = field()
    security: GetInternationalScheduledPaymentConsentsConsentIDSecurity = field()
