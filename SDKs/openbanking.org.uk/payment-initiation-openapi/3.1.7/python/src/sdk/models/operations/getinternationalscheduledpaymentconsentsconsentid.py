...
class GetInternationalScheduledPaymentConsentsConsentIDRequest:
    path_params: GetInternationalScheduledPaymentConsentsConsentIDPathParams = field(default=None)
    headers: GetInternationalScheduledPaymentConsentsConsentIDHeaders = field(default=None)
    security: GetInternationalScheduledPaymentConsentsConsentIDSecurity = field(default=None)
