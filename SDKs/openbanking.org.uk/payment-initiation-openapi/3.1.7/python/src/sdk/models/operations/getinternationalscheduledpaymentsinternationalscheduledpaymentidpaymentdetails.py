...
class GetInternationalScheduledPaymentsInternationalScheduledPaymentIDPaymentDetailsRequest:
    headers: GetInternationalScheduledPaymentsInternationalScheduledPaymentIDPaymentDetailsHeaders = field()
    path_params: GetInternationalScheduledPaymentsInternationalScheduledPaymentIDPaymentDetailsPathParams = field()
    security: GetInternationalScheduledPaymentsInternationalScheduledPaymentIDPaymentDetailsSecurity = field()
