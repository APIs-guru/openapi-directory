...
class GetDomesticPaymentsDomesticPaymentIDPaymentDetailsRequest:
    path_params: GetDomesticPaymentsDomesticPaymentIDPaymentDetailsPathParams = field(default=None)
    headers: GetDomesticPaymentsDomesticPaymentIDPaymentDetailsHeaders = field(default=None)
    security: GetDomesticPaymentsDomesticPaymentIDPaymentDetailsSecurity = field(default=None)
