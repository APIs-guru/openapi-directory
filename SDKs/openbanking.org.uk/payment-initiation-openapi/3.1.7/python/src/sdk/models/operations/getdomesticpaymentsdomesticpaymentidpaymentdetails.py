...
class GetDomesticPaymentsDomesticPaymentIDPaymentDetailsRequest:
    headers: GetDomesticPaymentsDomesticPaymentIDPaymentDetailsHeaders = field()
    path_params: GetDomesticPaymentsDomesticPaymentIDPaymentDetailsPathParams = field()
    security: GetDomesticPaymentsDomesticPaymentIDPaymentDetailsSecurity = field()
