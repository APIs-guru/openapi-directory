...
class GetDomesticPaymentConsentsConsentIDFundsConfirmationRequest:
    path_params: GetDomesticPaymentConsentsConsentIDFundsConfirmationPathParams = field(default=None)
    headers: GetDomesticPaymentConsentsConsentIDFundsConfirmationHeaders = field(default=None)
    security: GetDomesticPaymentConsentsConsentIDFundsConfirmationSecurity = field(default=None)
