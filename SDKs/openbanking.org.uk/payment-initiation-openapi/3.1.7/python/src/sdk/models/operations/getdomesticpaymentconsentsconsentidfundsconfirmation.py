...
class GetDomesticPaymentConsentsConsentIDFundsConfirmationRequest:
    headers: GetDomesticPaymentConsentsConsentIDFundsConfirmationHeaders = field()
    path_params: GetDomesticPaymentConsentsConsentIDFundsConfirmationPathParams = field()
    security: GetDomesticPaymentConsentsConsentIDFundsConfirmationSecurity = field()
