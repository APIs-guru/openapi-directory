...
class CreateDomesticPaymentConsentsRequest:
    headers: CreateDomesticPaymentConsentsHeaders = field()
    request: CreateDomesticPaymentConsentsRequests = field()
    security: CreateDomesticPaymentConsentsSecurity = field()
