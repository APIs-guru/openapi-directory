...
class CreateDomesticPaymentConsentsRequests:
    ...
    ob_write_domestic_consent4: Optional[shared.ObWriteDomesticConsent4] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    ob_write_domestic_consent5: Optional[shared.ObWriteDomesticConsent4] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class CreateDomesticPaymentConsentsRequest:
    headers: CreateDomesticPaymentConsentsHeaders = field(default=None)
    request: CreateDomesticPaymentConsentsRequests = field(default=None)
    security: CreateDomesticPaymentConsentsSecurity = field(default=None)
