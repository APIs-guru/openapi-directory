...
class GetDomesticPaymentConsentsConsentIDRequest:
    headers: GetDomesticPaymentConsentsConsentIDHeaders = field()
    path_params: GetDomesticPaymentConsentsConsentIDPathParams = field()
    security: GetDomesticPaymentConsentsConsentIDSecurity = field()
