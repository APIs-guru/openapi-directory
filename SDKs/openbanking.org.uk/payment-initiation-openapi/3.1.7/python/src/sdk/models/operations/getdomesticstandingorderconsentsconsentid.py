...
class GetDomesticStandingOrderConsentsConsentIDRequest:
    headers: GetDomesticStandingOrderConsentsConsentIDHeaders = field()
    path_params: GetDomesticStandingOrderConsentsConsentIDPathParams = field()
    security: GetDomesticStandingOrderConsentsConsentIDSecurity = field()
