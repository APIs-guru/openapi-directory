...
class GetDomesticScheduledPaymentConsentsConsentIDRequest:
    headers: GetDomesticScheduledPaymentConsentsConsentIDHeaders = field()
    path_params: GetDomesticScheduledPaymentConsentsConsentIDPathParams = field()
    security: GetDomesticScheduledPaymentConsentsConsentIDSecurity = field()
