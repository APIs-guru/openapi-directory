...
class GetDomesticScheduledPaymentConsentsConsentIDRequest:
    path_params: GetDomesticScheduledPaymentConsentsConsentIDPathParams = field(default=None)
    headers: GetDomesticScheduledPaymentConsentsConsentIDHeaders = field(default=None)
    security: GetDomesticScheduledPaymentConsentsConsentIDSecurity = field(default=None)
