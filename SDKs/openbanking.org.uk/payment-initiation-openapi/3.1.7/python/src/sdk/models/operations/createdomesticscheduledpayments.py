...
class CreateDomesticScheduledPaymentsRequest:
    headers: CreateDomesticScheduledPaymentsHeaders = field()
    request: CreateDomesticScheduledPaymentsRequests = field()
    security: CreateDomesticScheduledPaymentsSecurity = field()
