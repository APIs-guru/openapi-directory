...
class CreateDomesticScheduledPaymentsRequests:
    ...
    ob_write_domestic_scheduled2: Optional[shared.ObWriteDomesticScheduled2] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    ob_write_domestic_scheduled3: Optional[shared.ObWriteDomesticScheduled2] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class CreateDomesticScheduledPaymentsRequest:
    headers: CreateDomesticScheduledPaymentsHeaders = field(default=None)
    request: CreateDomesticScheduledPaymentsRequests = field(default=None)
    security: CreateDomesticScheduledPaymentsSecurity = field(default=None)
...
class CreateDomesticScheduledPaymentsResponse:
    ...
    ob_write_domestic_scheduled_response5: Optional[shared.ObWriteDomesticScheduledResponse5] = field(default=None)
