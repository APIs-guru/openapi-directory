...
class GetInternationalStandingOrdersInternationalStandingOrderPaymentIDPaymentDetailsPathParams:
    international_standing_order_payment_id: str = field(default=None, metadata={'path_param': { 'field_name': 'InternationalStandingOrderPaymentId', 'style': 'simple', 'explode': False }})
...
class GetInternationalStandingOrdersInternationalStandingOrderPaymentIDPaymentDetailsRequest:
    path_params: GetInternationalStandingOrdersInternationalStandingOrderPaymentIDPaymentDetailsPathParams = field(default=None)
    headers: GetInternationalStandingOrdersInternationalStandingOrderPaymentIDPaymentDetailsHeaders = field(default=None)
    security: GetInternationalStandingOrdersInternationalStandingOrderPaymentIDPaymentDetailsSecurity = field(default=None)
