...
class GetInternationalStandingOrdersInternationalStandingOrderPaymentIDPaymentDetailsPathParams:
    international_standing_order_payment_id: str = field(metadata={'path_param': { 'field_name': 'InternationalStandingOrderPaymentId', 'style': 'simple', 'explode': False }})
...
class GetInternationalStandingOrdersInternationalStandingOrderPaymentIDPaymentDetailsRequest:
    headers: GetInternationalStandingOrdersInternationalStandingOrderPaymentIDPaymentDetailsHeaders = field()
    path_params: GetInternationalStandingOrdersInternationalStandingOrderPaymentIDPaymentDetailsPathParams = field()
    security: GetInternationalStandingOrdersInternationalStandingOrderPaymentIDPaymentDetailsSecurity = field()
