...
class GetDomesticPaymentsDomesticPaymentIDPathParams:
    domestic_payment_id: str = field(metadata={'path_param': { 'field_name': 'DomesticPaymentId', 'style': 'simple', 'explode': False }})
...
class GetDomesticPaymentsDomesticPaymentIDRequest:
    headers: GetDomesticPaymentsDomesticPaymentIDHeaders = field()
    path_params: GetDomesticPaymentsDomesticPaymentIDPathParams = field()
    security: GetDomesticPaymentsDomesticPaymentIDSecurity = field()
