...
class GetInternationalScheduledPaymentsInternationalScheduledPaymentIDPathParams:
    international_scheduled_payment_id: str = field(default=None, metadata={'path_param': { 'field_name': 'InternationalScheduledPaymentId', 'style': 'simple', 'explode': False }})
...
class GetInternationalScheduledPaymentsInternationalScheduledPaymentIDRequest:
    path_params: GetInternationalScheduledPaymentsInternationalScheduledPaymentIDPathParams = field(default=None)
    headers: GetInternationalScheduledPaymentsInternationalScheduledPaymentIDHeaders = field(default=None)
    security: GetInternationalScheduledPaymentsInternationalScheduledPaymentIDSecurity = field(default=None)
