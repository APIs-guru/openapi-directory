...
class GetFilePaymentsFilePaymentIDReportFileRequest:
    path_params: GetFilePaymentsFilePaymentIDReportFilePathParams = field(default=None)
    headers: GetFilePaymentsFilePaymentIDReportFileHeaders = field(default=None)
    security: GetFilePaymentsFilePaymentIDReportFileSecurity = field(default=None)
