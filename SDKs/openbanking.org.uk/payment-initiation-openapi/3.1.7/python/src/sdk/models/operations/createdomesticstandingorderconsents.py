...
class CreateDomesticStandingOrderConsentsRequest:
    headers: CreateDomesticStandingOrderConsentsHeaders = field()
    request: CreateDomesticStandingOrderConsentsRequests = field()
    security: CreateDomesticStandingOrderConsentsSecurity = field()
