...
class GetDomesticStandingOrdersDomesticStandingOrderIDPaymentDetailsPathParams:
    domestic_standing_order_id: str = field(default=None, metadata={'path_param': { 'field_name': 'DomesticStandingOrderId', 'style': 'simple', 'explode': False }})
...
class GetDomesticStandingOrdersDomesticStandingOrderIDPaymentDetailsRequest:
    path_params: GetDomesticStandingOrdersDomesticStandingOrderIDPaymentDetailsPathParams = field(default=None)
    headers: GetDomesticStandingOrdersDomesticStandingOrderIDPaymentDetailsHeaders = field(default=None)
    security: GetDomesticStandingOrdersDomesticStandingOrderIDPaymentDetailsSecurity = field(default=None)
