...
class GetFilePaymentConsentsConsentIDRequest:
    path_params: GetFilePaymentConsentsConsentIDPathParams = field(default=None)
    headers: GetFilePaymentConsentsConsentIDHeaders = field(default=None)
    security: GetFilePaymentConsentsConsentIDSecurity = field(default=None)
