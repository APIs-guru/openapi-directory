...
class GetFilePaymentConsentsConsentIDRequest:
    headers: GetFilePaymentConsentsConsentIDHeaders = field()
    path_params: GetFilePaymentConsentsConsentIDPathParams = field()
    security: GetFilePaymentConsentsConsentIDSecurity = field()
