...
class GetInternationalPaymentConsentsConsentIDRequest:
    path_params: GetInternationalPaymentConsentsConsentIDPathParams = field(default=None)
    headers: GetInternationalPaymentConsentsConsentIDHeaders = field(default=None)
    security: GetInternationalPaymentConsentsConsentIDSecurity = field(default=None)
