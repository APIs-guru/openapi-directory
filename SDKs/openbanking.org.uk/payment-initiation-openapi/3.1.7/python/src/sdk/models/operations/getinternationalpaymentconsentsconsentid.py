...
class GetInternationalPaymentConsentsConsentIDRequest:
    headers: GetInternationalPaymentConsentsConsentIDHeaders = field()
    path_params: GetInternationalPaymentConsentsConsentIDPathParams = field()
    security: GetInternationalPaymentConsentsConsentIDSecurity = field()
