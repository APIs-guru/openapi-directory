...
class ObStandingOrder6:
    ...
    final_payment_amount: Optional[ObActiveOrHistoricCurrencyAndAmount4] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('FinalPaymentAmount') }})
    ...
    first_payment_amount: Optional[ObActiveOrHistoricCurrencyAndAmount2] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('FirstPaymentAmount') }})
    ...
    last_payment_amount: Optional[ObActiveOrHistoricCurrencyAndAmount11] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('LastPaymentAmount') }})
    ...
    next_payment_amount: Optional[ObActiveOrHistoricCurrencyAndAmount3] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('NextPaymentAmount') }})
