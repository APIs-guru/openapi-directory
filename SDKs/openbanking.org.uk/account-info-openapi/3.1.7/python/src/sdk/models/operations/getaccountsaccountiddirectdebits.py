...
class GetAccountsAccountIDDirectDebitsRequest:
    headers: GetAccountsAccountIDDirectDebitsHeaders = field()
    path_params: GetAccountsAccountIDDirectDebitsPathParams = field()
    security: GetAccountsAccountIDDirectDebitsSecurity = field()
