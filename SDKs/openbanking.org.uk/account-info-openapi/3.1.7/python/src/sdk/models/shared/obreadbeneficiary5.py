...
class ObReadBeneficiary5Data:
    beneficiary: Optional[List[ObBeneficiary5]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Beneficiary') }})
    

@dataclass_json
@dataclass
class ObReadBeneficiary5:
    data: ObReadBeneficiary5Data = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Data') }})
