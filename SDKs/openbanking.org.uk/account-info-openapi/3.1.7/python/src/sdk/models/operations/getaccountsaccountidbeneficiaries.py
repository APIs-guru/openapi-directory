...
class GetAccountsAccountIDBeneficiariesRequest:
    headers: GetAccountsAccountIDBeneficiariesHeaders = field()
    path_params: GetAccountsAccountIDBeneficiariesPathParams = field()
    security: GetAccountsAccountIDBeneficiariesSecurity = field()
