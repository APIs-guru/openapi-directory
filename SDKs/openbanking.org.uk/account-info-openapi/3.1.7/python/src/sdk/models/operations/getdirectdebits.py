...
@dataclass
class GetDirectDebitsSecurity:
    psuo_auth2_security: shared.SchemePsuoAuth2Security = field(default=None, metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclass
class GetDirectDebitsRequest:
    headers: GetDirectDebitsHeaders = field(default=None)
    security: GetDirectDebitsSecurity = field(default=None)
    

@dataclass
class GetDirectDebitsResponse:
