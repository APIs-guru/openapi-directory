...
class GetAccountsAccountIDOffersRequest:
    headers: GetAccountsAccountIDOffersHeaders = field()
    path_params: GetAccountsAccountIDOffersPathParams = field()
    security: GetAccountsAccountIDOffersSecurity = field()
