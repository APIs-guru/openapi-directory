...
@dataclass
class GetStandingOrdersHeaders:
...
@dataclass
class GetStandingOrdersSecurity:
...
class GetStandingOrdersRequest:
    headers: GetStandingOrdersHeaders = field(default=None)
    security: GetStandingOrdersSecurity = field(default=None)
