...
class GetAccountsAccountIDPartiesRequest:
    headers: GetAccountsAccountIDPartiesHeaders = field()
    path_params: GetAccountsAccountIDPartiesPathParams = field()
    security: GetAccountsAccountIDPartiesSecurity = field()
