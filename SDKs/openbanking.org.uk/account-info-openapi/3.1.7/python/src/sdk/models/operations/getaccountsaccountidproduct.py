...
class GetAccountsAccountIDProductRequest:
    headers: GetAccountsAccountIDProductHeaders = field()
    path_params: GetAccountsAccountIDProductPathParams = field()
    security: GetAccountsAccountIDProductSecurity = field()
