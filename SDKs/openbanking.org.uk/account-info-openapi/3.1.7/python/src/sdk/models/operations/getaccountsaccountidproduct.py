...
@dataclass
class GetAccountsAccountIDProductPathParams:
    account_id: str = field(default=None, metadata={'path_param': { 'field_name': 'AccountId', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetAccountsAccountIDProductHeaders:
...
@dataclass
class GetAccountsAccountIDProductSecurity:
    psuo_auth2_security: shared.SchemePsuoAuth2Security = field(default=None, metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclass
class GetAccountsAccountIDProductRequest:
    path_params: GetAccountsAccountIDProductPathParams = field(default=None)
    headers: GetAccountsAccountIDProductHeaders = field(default=None)
    security: GetAccountsAccountIDProductSecurity = field(default=None)
    

@dataclass
class GetAccountsAccountIDProductResponse:
