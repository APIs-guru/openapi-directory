...
@dataclass
class GetBeneficiariesSecurity:
...
class GetBeneficiariesRequest:
    headers: GetBeneficiariesHeaders = field(default=None)
    security: GetBeneficiariesSecurity = field(default=None)
