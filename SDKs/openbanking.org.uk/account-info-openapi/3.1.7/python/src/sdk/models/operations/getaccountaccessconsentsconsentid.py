...
class GetAccountAccessConsentsConsentIDRequest:
    headers: GetAccountAccessConsentsConsentIDHeaders = field()
    path_params: GetAccountAccessConsentsConsentIDPathParams = field()
    security: GetAccountAccessConsentsConsentIDSecurity = field()
