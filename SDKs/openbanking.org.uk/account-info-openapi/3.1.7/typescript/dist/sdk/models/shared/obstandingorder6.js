...
var ObStandingOrder6 = /** @class */ (function (_super) {
    __extends(ObStandingOrder6, _super);
    function ObStandingOrder6() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=AccountId" }),
        __metadata("design:type", String)
    ], ObStandingOrder6.prototype, "accountId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=CreditorAccount" }),
        __metadata("design:type", ObCashAccount51)
    ], ObStandingOrder6.prototype, "creditorAccount", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=CreditorAgent" }),
        __metadata("design:type", ObBranchAndFinancialInstitutionIdentification51)
    ], ObStandingOrder6.prototype, "creditorAgent", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=FinalPaymentAmount" }),
        __metadata("design:type", ObActiveOrHistoricCurrencyAndAmount4)
    ], ObStandingOrder6.prototype, "finalPaymentAmount", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=FinalPaymentDateTime" }),
        __metadata("design:type", Date)
    ], ObStandingOrder6.prototype, "finalPaymentDateTime", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=FirstPaymentAmount" }),
        __metadata("design:type", ObActiveOrHistoricCurrencyAndAmount2)
    ], ObStandingOrder6.prototype, "firstPaymentAmount", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=FirstPaymentDateTime" }),
        __metadata("design:type", Date)
    ], ObStandingOrder6.prototype, "firstPaymentDateTime", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Frequency" }),
        __metadata("design:type", String)
    ], ObStandingOrder6.prototype, "frequency", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=LastPaymentAmount" }),
        __metadata("design:type", ObActiveOrHistoricCurrencyAndAmount11)
    ], ObStandingOrder6.prototype, "lastPaymentAmount", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=LastPaymentDateTime" }),
        __metadata("design:type", Date)
    ], ObStandingOrder6.prototype, "lastPaymentDateTime", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=NextPaymentAmount" }),
        __metadata("design:type", ObActiveOrHistoricCurrencyAndAmount3)
    ], ObStandingOrder6.prototype, "nextPaymentAmount", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=NextPaymentDateTime" }),
        __metadata("design:type", Date)
    ], ObStandingOrder6.prototype, "nextPaymentDateTime", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=NumberOfPayments" }),
        __metadata("design:type", String)
    ], ObStandingOrder6.prototype, "numberOfPayments", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Reference" }),
        __metadata("design:type", String)
    ], ObStandingOrder6.prototype, "reference", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=StandingOrderId" }),
        __metadata("design:type", String)
    ], ObStandingOrder6.prototype, "standingOrderId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=StandingOrderStatusCode" }),
        __metadata("design:type", String)
    ], ObStandingOrder6.prototype, "standingOrderStatusCode", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=SupplementaryData" }),
        __metadata("design:type", Map)
    ], ObStandingOrder6.prototype, "supplementaryData", void 0);
    return ObStandingOrder6;
}(SpeakeasyBase));
export { ObStandingOrder6 };
