...
func (s *Branch) GetBranches(ctx context.Context, request operations.GetBranchesRequest) (*operations.GetBranchesResponse, error) {
...
func (s *Branch) HeadBranches(ctx context.Context, request operations.HeadBranchesRequest) (*operations.HeadBranchesResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/branches"
