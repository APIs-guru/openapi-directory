...
var Pca = /** @class */ (function () {
    function Pca(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Pca.prototype.getPersonalCurrentAccounts = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetPersonalCurrentAccountsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/personal-current-accounts";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/prs.openbanking.opendata.v1.3+json")) {
                        res.getPersonalCurrentAccounts200ApplicationPrsOpenbankingOpendataV13PlusJsonObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
    ...
    **/
    Pca.prototype.headPersonalCurrentAccounts = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
