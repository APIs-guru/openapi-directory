...
var Atm = /** @class */ (function () {
    function Atm(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Atm.prototype.getAtms = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetAtmsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/atms";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/prs.openbanking.opendata.v1.3+json")) {
                        res.getAtms200ApplicationPrsOpenbankingOpendataV13PlusJsonObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
    ...
    **/
    Atm.prototype.headAtms = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
