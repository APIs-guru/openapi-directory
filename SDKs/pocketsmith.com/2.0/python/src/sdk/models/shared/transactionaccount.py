...
class TransactionAccount:
    ...
    institution: Optional[institution.Institution] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'institution' }})
    ...
    type: Optional[TransactionAccountTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'type' }})
