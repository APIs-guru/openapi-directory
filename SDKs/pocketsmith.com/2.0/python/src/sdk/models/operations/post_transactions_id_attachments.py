...
class PostTransactionsIDAttachmentsRequestBody:
    attachment_id: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('attachment_id') }})
    

@dataclass
class PostTransactionsIDAttachmentsRequest:
    path_params: PostTransactionsIDAttachmentsPathParams = field()
