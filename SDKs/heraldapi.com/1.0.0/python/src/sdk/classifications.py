    ...
    def get_classifications(self, request: operations.GetClassificationsRequest) -> operations.GetClassificationsResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.GetClassifications200ApplicationJSON])
                res.get_classifications_200_application_json_object = out
        elif r.status_code == 400:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.GetClassifications400ApplicationJSON])
