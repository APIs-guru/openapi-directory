...
var LogOutPathParams = /** @class */ (function (_super) {
    __extends(LogOutPathParams, _super);
    function LogOutPathParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=token" }),
        __metadata("design:type", String)
    ], LogOutPathParams.prototype, "token", void 0);
    return LogOutPathParams;
}(SpeakeasyBase));
export { LogOutPathParams };
var LogOutRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", LogOutPathParams)
    ], LogOutRequest.prototype, "pathParams", void 0);
