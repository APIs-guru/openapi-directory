...
var ObservationController = /** @class */ (function () {
    function ObservationController(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    ObservationController.prototype.getObservationsByCode = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetObservationsByCodeRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/user/{userId}/observations/{code}", req.pathParams);
    ...
    **/
    ObservationController.prototype.getObservationsByCodes = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetObservationsByCodesRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/user/{userId}/observations", req.pathParams);
        var client = this._defaultClient;
    ...
    **/
    ObservationController.prototype.getPatientEnteredObservationsByCode = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetPatientEnteredObservationsByCodeRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/user/{userId}/observations/{code}/patiententered", req.pathParams);
        var client = this._defaultClient;
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
