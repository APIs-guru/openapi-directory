...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.GetFrontendSettings = function (config) {
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/frontend/settings";
    ...
    SDK.prototype.GetLanguages = function (config) {
        var baseURL = this.serverURL;
    ...
    SDK.prototype.PostDetect = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostDetectRequest(req);
        }
        var baseURL = this.serverURL;
    ...
    SDK.prototype.PostLanguages = function (config) {
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/languages";
        var client = this.defaultClient;
        return client
    ...
    SDK.prototype.PostTranslate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostTranslateRequest(req);
        }
        var baseURL = this.serverURL;
