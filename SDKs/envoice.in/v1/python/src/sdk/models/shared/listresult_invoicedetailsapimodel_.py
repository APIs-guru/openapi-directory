...
from . import invoicedetailsapimodel
...
class ListResultInvoiceDetailsAPIModel:
    ...
    result: Optional[List[invoicedetailsapimodel.InvoiceDetailsAPIModel]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Result' }})
