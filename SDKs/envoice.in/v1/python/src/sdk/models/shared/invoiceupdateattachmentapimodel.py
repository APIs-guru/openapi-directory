...
class InvoiceUpdateAttachmentAPIModelTypeEnum(str, Enum):
    EXTERNAL = "External"
    UPLOADED = "Uploaded"
...
@dataclass_json
@dataclass
class InvoiceUpdateAttachmentAPIModel:
    ...
    type: Optional[InvoiceUpdateAttachmentAPIModelTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Type') }})
