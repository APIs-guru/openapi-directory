...
class EstimationCreateAPIModel:
    attachments: Optional[List[EstimationCreateAttachmentAPIModel]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Attachments') }})
    ...
    items: Optional[List[EstimationCreateItemAPIModel]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Items') }})
    ...
    status: Optional[EstimationCreateAPIModelStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Status') }})
