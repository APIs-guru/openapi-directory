...
from . import invoicecategoryapimodel
...
class ListResultInvoiceCategoryAPIModel:
    ...
    result: Optional[List[invoicecategoryapimodel.InvoiceCategoryAPIModel]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Result' }})
