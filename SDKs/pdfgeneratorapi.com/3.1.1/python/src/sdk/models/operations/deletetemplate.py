...
class DeleteTemplateRequest:
    query_params: DeleteTemplateQueryParams = field(default=None)
...
class DeleteTemplate200ApplicationJSON:
    response: Optional[DeleteTemplate200ApplicationJSONResponse] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'response' }})
...
class DeleteTemplate401ApplicationJSON:
    error: Optional[DeleteTemplate401ApplicationJSONErrorEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'error' }})
...
class DeleteTemplate403ApplicationJSON:
    error: Optional[DeleteTemplate403ApplicationJSONErrorEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'error' }})
    status: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
...
class DeleteTemplate404ApplicationJSON:
    error: Optional[DeleteTemplate404ApplicationJSONErrorEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'error' }})
    status: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
...
class DeleteTemplate422ApplicationJSON:
    error: Optional[DeleteTemplate422ApplicationJSONErrorEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'error' }})
    status: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
