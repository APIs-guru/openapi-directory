...
class MergeTemplateRequest:
    query_params: MergeTemplateQueryParams = field(default=None)
    request: shared.Data = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class MergeTemplate200ApplicationJSON:
    meta: Optional[MergeTemplate200ApplicationJSONMeta] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'meta' }})
...
class MergeTemplate401ApplicationJSON:
    error: Optional[MergeTemplate401ApplicationJSONErrorEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'error' }})
...
class MergeTemplate403ApplicationJSON:
    error: Optional[MergeTemplate403ApplicationJSONErrorEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'error' }})
    status: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
...
class MergeTemplate404ApplicationJSON:
    error: Optional[MergeTemplate404ApplicationJSONErrorEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'error' }})
    status: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
...
class MergeTemplate422ApplicationJSON:
    error: Optional[MergeTemplate422ApplicationJSONErrorEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'error' }})
    status: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
