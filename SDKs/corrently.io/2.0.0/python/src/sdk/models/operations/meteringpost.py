...
class MeteringPostRequestBody:
    ...
    energy: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'energy' }})
...
class MeteringPostRequest:
    request: MeteringPostRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
