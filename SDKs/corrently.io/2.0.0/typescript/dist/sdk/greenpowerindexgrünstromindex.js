...
var GreenPowerIndexGrünstromIndex = /** @class */ (function () {
    function GreenPowerIndexGrünstromIndex(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
    **/
    GreenPowerIndexGrünstromIndex.prototype.gsiBesthour = function (req, config) {
     ...
     *
    **/
    GreenPowerIndexGrünstromIndex.prototype.gsiDispatch = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    GreenPowerIndexGrünstromIndex.prototype.gsiMarketdata = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.gsiMarketdata200ApplicationJsonObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
     ...
     *
    **/
    GreenPowerIndexGrünstromIndex.prototype.gsiPrediction = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.gsiPrediction200ApplicationJsonObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
...
export { GreenPowerIndexGrünstromIndex };
