...
var Administrations = /** @class */ (function () {
    function Administrations(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Administrations.prototype.createAdministration = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreateAdministrationRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/legal_entities/{legal_entity_id}/administrations", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.administration = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
    ...
    **/
    Administrations.prototype.deleteAdministration = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteAdministrationRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/legal_entities/{legal_entity_id}/administrations/{id}", req.pathParams);
        var client = this._securityClient;
        return client
    ...
    **/
    Administrations.prototype.getAdministration = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Administrations.prototype.updateAdministration = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
