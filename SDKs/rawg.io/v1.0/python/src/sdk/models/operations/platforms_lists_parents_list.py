...
class PlatformsListsParentsList200ApplicationJSON:
    ...
    results: List[shared.PlatformParentSingle] = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
...
class PlatformsListsParentsListRequest:
    query_params: PlatformsListsParentsListQueryParams = field()
