...
class GamesDevelopmentTeamListRequest:
    path_params: GamesDevelopmentTeamListPathParams = field(default=None)
    query_params: GamesDevelopmentTeamListQueryParams = field(default=None)
...
class GamesDevelopmentTeamList200ApplicationJSON:
    ...
    results: List[shared.GamePersonList] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'results' }})
