...
var Developers = /** @class */ (function () {
    function Developers(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
    **/
    Developers.prototype.getEvents = function (req, config) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.eventRecords = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
