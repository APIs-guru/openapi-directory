...
var NetworkActions = /** @class */ (function () {
    ...
    **/
    NetworkActions.prototype.getNetworksIdActions = function (req, config) {
        ...
        var url = utils.GenerateURL(baseURL, "/networks/{id}/actions", req.pathParams);
    ...
    **/
    NetworkActions.prototype.getNetworksIdActionsActionId = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/networks/{id}/actions/{action_id}", req.pathParams);
        var client = this._defaultClient;
        return client
    ...
    **/
    NetworkActions.prototype.postNetworksIdActionsAddRoute = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/networks/{id}/actions/add_route", req.pathParams);
    ...
    **/
    NetworkActions.prototype.postNetworksIdActionsAddSubnet = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/networks/{id}/actions/add_subnet", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    NetworkActions.prototype.postNetworksIdActionsChangeIpRange = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/networks/{id}/actions/change_ip_range", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    NetworkActions.prototype.postNetworksIdActionsChangeProtection = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/networks/{id}/actions/change_protection", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    NetworkActions.prototype.postNetworksIdActionsDeleteRoute = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/networks/{id}/actions/delete_route", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    NetworkActions.prototype.postNetworksIdActionsDeleteSubnet = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/networks/{id}/actions/delete_subnet", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
