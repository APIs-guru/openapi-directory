...
export class GetVolumesIdActionsActionsResponseAction extends SpeakeasyBase {
  ...
  @Metadata({ data: "json, name=resources", elemType: operations.GetVolumesIdActionsActionsResponseActionResources })
...
export class GetVolumesIdActionsActionsResponse extends SpeakeasyBase {
  @Metadata({ data: "json, name=actions", elemType: operations.GetVolumesIdActionsActionsResponseAction })
