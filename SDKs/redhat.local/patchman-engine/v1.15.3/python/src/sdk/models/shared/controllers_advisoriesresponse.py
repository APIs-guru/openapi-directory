...
from . import controllers_advisoryitem
...
class ControllersAdvisoriesResponse:
    data: Optional[List[controllers_advisoryitem.ControllersAdvisoryItem]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'data' }})
