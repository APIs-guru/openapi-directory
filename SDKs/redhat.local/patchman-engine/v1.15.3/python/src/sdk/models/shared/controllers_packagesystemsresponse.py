...
from . import controllers_packagesystemitem
...
class ControllersPackageSystemsResponse:
    data: Optional[List[controllers_packagesystemitem.ControllersPackageSystemItem]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'data' }})
