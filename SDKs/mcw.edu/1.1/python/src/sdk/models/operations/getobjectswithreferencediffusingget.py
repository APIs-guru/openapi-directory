...
@dataclass
class GetObjectsWithReferenceDiffUsingGetPathParams:
...
@dataclass
class GetObjectsWithReferenceDiffUsingGetRequest:
    path_params: GetObjectsWithReferenceDiffUsingGetPathParams = field(default=None)
    

@dataclass
class GetObjectsWithReferenceDiffUsingGetResponse:
