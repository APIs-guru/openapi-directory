...
var BaseConversion = /** @class */ (function () {
    function BaseConversion(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    BaseConversion.prototype.getNumbersBase = function (req, config) {
    ...
    **/
    BaseConversion.prototype.getNumbersBaseBinary = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    BaseConversion.prototype.getNumbersBaseHex = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    BaseConversion.prototype.getNumbersBaseOctal = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
