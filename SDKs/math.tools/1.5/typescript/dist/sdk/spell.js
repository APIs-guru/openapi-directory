...
var Spell = /** @class */ (function () {
    function Spell(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Spell.prototype.getNumbersCardinal = function (req, config) {
    ...
    **/
    Spell.prototype.getNumbersCurrency = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Spell.prototype.getNumbersOrdinal = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
