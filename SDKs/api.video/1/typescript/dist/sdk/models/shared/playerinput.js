...
var Playerinput = /** @class */ (function (_super) {
    ...
    ], Playerinput.prototype, "backgroundBottom", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=backgroundText" }),
        __metadata("design:type", String)
    ], Playerinput.prototype, "backgroundText", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=backgroundTop" }),
        __metadata("design:type", String)
    ], Playerinput.prototype, "backgroundTop", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=enableApi" }),
        __metadata("design:type", Boolean)
    ], Playerinput.prototype, "enableApi", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=enableControls" }),
        __metadata("design:type", Boolean)
    ], Playerinput.prototype, "enableControls", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=forceAutoplay" }),
        __metadata("design:type", Boolean)
    ], Playerinput.prototype, "forceAutoplay", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=forceLoop" }),
        __metadata("design:type", Boolean)
    ], Playerinput.prototype, "forceLoop", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=hideTitle" }),
        __metadata("design:type", Boolean)
    ], Playerinput.prototype, "hideTitle", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=link" }),
        __metadata("design:type", String)
    ], Playerinput.prototype, "link", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=linkHover" }),
        __metadata("design:type", String)
    ], Playerinput.prototype, "linkHover", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=text" }),
        __metadata("design:type", String)
    ], Playerinput.prototype, "text", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=trackBackground" }),
        __metadata("design:type", String)
    ], Playerinput.prototype, "trackBackground", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=trackPlayed" }),
        __metadata("design:type", String)
    ], Playerinput.prototype, "trackPlayed", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=trackUnplayed" }),
        __metadata("design:type", String)
    ], Playerinput.prototype, "trackUnplayed", void 0);
    return Playerinput;
}(SpeakeasyBase));
export { Playerinput };
