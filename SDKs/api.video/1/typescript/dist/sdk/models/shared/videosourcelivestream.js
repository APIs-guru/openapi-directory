...
**/
var VideoSourceLiveStream = /** @class */ (function (_super) {
    __extends(VideoSourceLiveStream, _super);
    function VideoSourceLiveStream() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=links", elemType: VideoSourceLiveStreamLink }),
        __metadata("design:type", Array)
    ], VideoSourceLiveStream.prototype, "links", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=liveStreamId" }),
        __metadata("design:type", String)
    ], VideoSourceLiveStream.prototype, "liveStreamId", void 0);
    return VideoSourceLiveStream;
}(SpeakeasyBase));
export { VideoSourceLiveStream };
