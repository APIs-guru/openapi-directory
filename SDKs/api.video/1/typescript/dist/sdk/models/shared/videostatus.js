...
var Videostatus = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", VideostatusEncoding)
    ], Videostatus.prototype, "encoding", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ingest" }),
        __metadata("design:type", VideostatusIngest)
    ], Videostatus.prototype, "ingest", void 0);
    return Videostatus;
}(SpeakeasyBase));
export { Videostatus };
