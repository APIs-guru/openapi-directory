...
var AccountQuota = /** @class */ (function (_super) {
    ...
    ], AccountQuota.prototype, "quotaRemaining", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=quotaTotal" }),
        __metadata("design:type", Number)
    ], AccountQuota.prototype, "quotaTotal", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=quotaUsed" }),
        __metadata("design:type", Number)
    ], AccountQuota.prototype, "quotaUsed", void 0);
    return AccountQuota;
}(SpeakeasyBase));
export { AccountQuota };
var Account = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", AccountQuota)
