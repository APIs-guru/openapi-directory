...
var LiveStream = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", LiveStreamAssets)
    ], LiveStream.prototype, "assets", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=broadcasting" }),
        __metadata("design:type", Boolean)
    ], LiveStream.prototype, "broadcasting", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=liveStreamId" }),
        __metadata("design:type", String)
    ], LiveStream.prototype, "liveStreamId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=name" }),
        __metadata("design:type", String)
    ], LiveStream.prototype, "name", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=playerId" }),
        __metadata("design:type", String)
    ], LiveStream.prototype, "playerId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=public" }),
        __metadata("design:type", Boolean)
    ], LiveStream.prototype, "public", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=record" }),
        __metadata("design:type", Boolean)
    ], LiveStream.prototype, "record", void 0);
    __decorate([
