...
export declare const ServerList: readonly ["https://ws.api.video"];
...
export declare class SDK {
    ...
    **/
    deleteLiveStreamsLiveStreamId(req: operations.DeleteLiveStreamsLiveStreamIdRequest, config?: AxiosRequestConfig): Promise<operations.DeleteLiveStreamsLiveStreamIdResponse>;
    /**
     * deleteLiveStreamsLiveStreamIdThumbnail - Delete a thumbnail
     *
     * Send the unique identifier for a live stream to delete it from the system.
    **/
    deleteLiveStreamsLiveStreamIdThumbnail(req: operations.DeleteLiveStreamsLiveStreamIdThumbnailRequest, config?: AxiosRequestConfig): Promise<operations.DeleteLiveStreamsLiveStreamIdThumbnailResponse>;
    /**
     * deletePlayersPlayerId - Delete a player
     *
     * Delete a player if you no longer need it. You can delete any player that you have the player ID for.
    **/
    deletePlayersPlayerId(req: operations.DeletePlayersPlayerIdRequest, config?: AxiosRequestConfig): Promise<operations.DeletePlayersPlayerIdResponse>;
    /**
     * deletePlayersPlayerIdLogo - Delete logo
    **/
    deletePlayersPlayerIdLogo(req: operations.DeletePlayersPlayerIdLogoRequest, config?: AxiosRequestConfig): Promise<operations.DeletePlayersPlayerIdLogoResponse>;
    /**
     * deleteUploadTokensUploadToken - Delete an upload token
     *
     * Delete an existing upload token. This is especially useful for tokens you may have created that do not expire.
    **/
    deleteUploadTokensUploadToken(req: operations.DeleteUploadTokensUploadTokenRequest, config?: AxiosRequestConfig): Promise<operations.DeleteUploadTokensUploadTokenResponse>;
    /**
     * deleteVideosVideoIdCaptionsLanguage - Delete a caption
     *
     * Delete a caption in a specific language by providing the video ID for the video you want to delete the caption from and the language the caption is in.
    **/
    deleteVideosVideoIdCaptionsLanguage(req: operations.DeleteVideosVideoIdCaptionsLanguageRequest, config?: AxiosRequestConfig): Promise<operations.DeleteVideosVideoIdCaptionsLanguageResponse>;
    /**
     * deleteVideosVideoIdChaptersLanguage - Delete a chapter
    **/
    deleteVideosVideoIdChaptersLanguage(req: operations.DeleteVideosVideoIdChaptersLanguageRequest, config?: AxiosRequestConfig): Promise<operations.DeleteVideosVideoIdChaptersLanguageResponse>;
    /**
    ...
    **/
    getVideoStatus(req: operations.GetVideoStatusRequest, config?: AxiosRequestConfig): Promise<operations.GetVideoStatusResponse>;
    /**
    ...
    **/
    getAnalyticsLiveStreamsLiveStreamId(req: operations.GetAnalyticsLiveStreamsLiveStreamIdRequest, config?: AxiosRequestConfig): Promise<operations.GetAnalyticsLiveStreamsLiveStreamIdResponse>;
    /**
     * getAnalyticsSessionsSessionIdEvents - List player session events
     *
     * Useful to track and measure video's engagement.
    **/
    getAnalyticsSessionsSessionIdEvents(req: operations.GetAnalyticsSessionsSessionIdEventsRequest, config?: AxiosRequestConfig): Promise<operations.GetAnalyticsSessionsSessionIdEventsResponse>;
    /**
     * getAnalyticsVideosVideoId - List video player sessions
     *
     * Retrieve all available user sessions for a specific video. Tutorials that use the [analytics endpoint](https://api.video/blog/endpoints/analytics).
    **/
    getAnalyticsVideosVideoId(req: operations.GetAnalyticsVideosVideoIdRequest, config?: AxiosRequestConfig): Promise<operations.GetAnalyticsVideosVideoIdResponse>;
    /**
     * getLiveStreams - List all live streams
     *
     * With no parameters added to the url, this will return all livestreams. Query by name or key to limit the list.
    **/
    getLiveStreams(req: operations.GetLiveStreamsRequest, config?: AxiosRequestConfig): Promise<operations.GetLiveStreamsResponse>;
    /**
     * getLiveStreamsLiveStreamId - Show live stream
     *
     * Supply a LivestreamId, and you'll get all the details for streaming into, and watching the livestream. Tutorials that use the [show livestream endpoint](https://api.video/blog/endpoints/live-stream-status).
    **/
    getLiveStreamsLiveStreamId(req: operations.GetLiveStreamsLiveStreamIdRequest, config?: AxiosRequestConfig): Promise<operations.GetLiveStreamsLiveStreamIdResponse>;
    /**
    ...
    **/
    getPlayers(req: operations.GetPlayersRequest, config?: AxiosRequestConfig): Promise<operations.GetPlayersResponse>;
    /**
     * getPlayersPlayerId - Show a player
     *
     * Use a player ID to retrieve details about the player and display it for viewers.
    **/
    getPlayersPlayerId(req: operations.GetPlayersPlayerIdRequest, config?: AxiosRequestConfig): Promise<operations.GetPlayersPlayerIdResponse>;
    /**
    ...
    **/
    getUploadTokens(req: operations.GetUploadTokensRequest, config?: AxiosRequestConfig): Promise<operations.GetUploadTokensResponse>;
    /**
     * getUploadTokensUploadToken - Show upload token
     *
     * You can retrieve details about a specific upload token if you have the unique identifier for the upload token. Add it in the path of the endpoint. Details include time-to-live (ttl), when the token was created, and when it will expire.
    **/
    getUploadTokensUploadToken(req: operations.GetUploadTokensUploadTokenRequest, config?: AxiosRequestConfig): Promise<operations.GetUploadTokensUploadTokenResponse>;
    /**
     * getVideosVideoIdCaptions - List video captions
     *
     * Retrieve a list of available captions for the videoId you provide.
    **/
    getVideosVideoIdCaptions(req: operations.GetVideosVideoIdCaptionsRequest, config?: AxiosRequestConfig): Promise<operations.GetVideosVideoIdCaptionsResponse>;
    /**
    ...
    **/
    getVideosVideoIdCaptionsLanguage(req: operations.GetVideosVideoIdCaptionsLanguageRequest, config?: AxiosRequestConfig): Promise<operations.GetVideosVideoIdCaptionsLanguageResponse>;
    /**
     * getVideosVideoIdChapters - List video chapters
     *
     * Retrieve a list of all chapters for a specified video.
    **/
    getVideosVideoIdChapters(req: operations.GetVideosVideoIdChaptersRequest, config?: AxiosRequestConfig): Promise<operations.GetVideosVideoIdChaptersResponse>;
    /**
     * getVideosVideoIdChaptersLanguage - Show a chapter
     *
     * Chapters help your viewers find the sections of the video they are most interested in viewing. Tutorials that use the [chapters endpoint](https://api.video/blog/endpoints/chapters).
    **/
    getVideosVideoIdChaptersLanguage(req: operations.GetVideosVideoIdChaptersLanguageRequest, config?: AxiosRequestConfig): Promise<operations.GetVideosVideoIdChaptersLanguageResponse>;
    /**
    ...
    **/
    listVideos(req: operations.ListVideosRequest, config?: AxiosRequestConfig): Promise<operations.ListVideosResponse>;
    /**
    ...
    **/
    patchVideo(req: operations.PatchVideoRequest, config?: AxiosRequestConfig): Promise<operations.PatchVideoResponse>;
    /**
     * patchLiveStreamsLiveStreamId - Update a live stream
     *
     * Use this endpoint to update the player, or to turn recording on/off (saving a copy of the livestream). NOTE: If the livestream is actively streaming, changing the recording status will only affect the NEXT stream.    The public=false 'private livestream' is available as a BETA feature, and should be limited to livestreams of 3,000 viewers or fewer.
    **/
    patchLiveStreamsLiveStreamId(req: operations.PatchLiveStreamsLiveStreamIdRequest, config?: AxiosRequestConfig): Promise<operations.PatchLiveStreamsLiveStreamIdResponse>;
    /**
     * patchPlayersPlayerId - Update a player
     *
     * Use a player ID to update specific details for a player. NOTE: It may take up to 10 min before the new player configuration is available from our CDN.
    **/
    patchPlayersPlayerId(req: operations.PatchPlayersPlayerIdRequest, config?: AxiosRequestConfig): Promise<operations.PatchPlayersPlayerIdResponse>;
    /**
     * patchVideosVideoIdCaptionsLanguage - Update caption
     *
     * To have the captions on automatically, use this PATCH to set default: true.
    **/
    patchVideosVideoIdCaptionsLanguage(req: operations.PatchVideosVideoIdCaptionsLanguageRequest, config?: AxiosRequestConfig): Promise<operations.PatchVideosVideoIdCaptionsLanguageResponse>;
    /**
    ...
    **/
    patchVideosVideoIdThumbnail(req: operations.PatchVideosVideoIdThumbnailRequest, config?: AxiosRequestConfig): Promise<operations.PatchVideosVideoIdThumbnailResponse>;
    /**
     ...
     *
    **/
    postVideo(req: operations.PostVideoRequest, config?: AxiosRequestConfig): Promise<operations.PostVideoResponse>;
    /**
    ...
    **/
    postAuthApiKey(req: operations.PostAuthApiKeyRequest, config?: AxiosRequestConfig): Promise<operations.PostAuthApiKeyResponse>;
    /**
    ...
    **/
    postLiveStreams(req: operations.PostLiveStreamsRequest, config?: AxiosRequestConfig): Promise<operations.PostLiveStreamsResponse>;
    /**
     * postLiveStreamsLiveStreamIdThumbnail - Upload a thumbnail
     *
     * Upload an image to use as a backdrop for your livestream. Tutorials that [update live stream thumbnails](https://api.video/blog/endpoints/live-upload-a-thumbnail).
    **/
    postLiveStreamsLiveStreamIdThumbnail(req: operations.PostLiveStreamsLiveStreamIdThumbnailRequest, config?: AxiosRequestConfig): Promise<operations.PostLiveStreamsLiveStreamIdThumbnailResponse>;
    /**
     * postPlayers - Create a player
     *
     * Create a player for your video, and customise it.
    **/
    postPlayers(req: operations.PostPlayersRequest, config?: AxiosRequestConfig): Promise<operations.PostPlayersResponse>;
    /**
     * postPlayersPlayerIdLogo - Upload a logo
     *
     * The uploaded image maximum size should be 200x100 and its weight should be 200KB.  It will be scaled down to 30px height and converted to PNG to be displayed in the player.
    **/
    postPlayersPlayerIdLogo(req: operations.PostPlayersPlayerIdLogoRequest, config?: AxiosRequestConfig): Promise<operations.PostPlayersPlayerIdLogoResponse>;
    /**
    ...
    **/
    postUploadTokens(req: operations.PostUploadTokensRequest, config?: AxiosRequestConfig): Promise<operations.PostUploadTokensResponse>;
    /**
    ...
    **/
    postVideosVideoIdCaptionsLanguage(req: operations.PostVideosVideoIdCaptionsLanguageRequest, config?: AxiosRequestConfig): Promise<operations.PostVideosVideoIdCaptionsLanguageResponse>;
    /**
     * postVideosVideoIdChaptersLanguage - Upload a chapter
     *
     * Chapters help break the video into sections. Read our [tutorial](https://api.video/blog/tutorials/adding-chapters-to-your-videos) for more details.
    **/
    postVideosVideoIdChaptersLanguage(req: operations.PostVideosVideoIdChaptersLanguageRequest, config?: AxiosRequestConfig): Promise<operations.PostVideosVideoIdChaptersLanguageResponse>;
    /**
    ...
    **/
    postVideosVideoIdSource(req: operations.PostVideosVideoIdSourceRequest, config?: AxiosRequestConfig): Promise<operations.PostVideosVideoIdSourceResponse>;
    /**
    ...
    **/
    postVideosVideoIdThumbnail(req: operations.PostVideosVideoIdThumbnailRequest, config?: AxiosRequestConfig): Promise<operations.PostVideosVideoIdThumbnailResponse>;
}
export {};
