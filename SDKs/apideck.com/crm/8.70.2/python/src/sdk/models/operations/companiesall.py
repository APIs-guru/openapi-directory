...
class CompaniesAllQueryParams:
    ...
    filter: Optional[shared.CompaniesFilter] = field(default=None, metadata={'query_param': { 'field_name': 'filter', 'style': 'deepObject', 'explode': True }})
    limit: Optional[int] = field(default=None, metadata={'query_param': { 'field_name': 'limit', 'style': 'form', 'explode': True }})
    raw: Optional[bool] = field(default=None, metadata={'query_param': { 'field_name': 'raw', 'style': 'form', 'explode': True }})
    sort: Optional[shared.CompaniesSort] = field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'deepObject', 'explode': True }})
...
class CompaniesAllRequest:
    query_params: CompaniesAllQueryParams = field(default=None)
    headers: CompaniesAllHeaders = field(default=None)
    security: CompaniesAllSecurity = field(default=None)
...
class CompaniesAllResponse:
    ...
    get_companies_response: Optional[shared.GetCompaniesResponse] = field(default=None)
