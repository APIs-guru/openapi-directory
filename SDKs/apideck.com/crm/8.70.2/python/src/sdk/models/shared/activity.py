...
class Activity:
    ...
    attendees: Optional[List[activityattendee.ActivityAttendee]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'attendees' }})
    ...
    location_address: Optional[address.Address] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'location_address' }})
