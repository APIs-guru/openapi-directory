...
class NotesAllRequest:
    query_params: NotesAllQueryParams = field(default=None)
    headers: NotesAllHeaders = field(default=None)
    security: NotesAllSecurity = field(default=None)
...
class NotesAllResponse:
    ...
    get_notes_response: Optional[shared.GetNotesResponse] = field(default=None)
