...
class UsersOneRequest:
    path_params: UsersOnePathParams = field(default=None)
    query_params: UsersOneQueryParams = field(default=None)
    headers: UsersOneHeaders = field(default=None)
    security: UsersOneSecurity = field(default=None)
...
class UsersOneResponse:
    ...
    get_user_response: Optional[shared.GetUserResponse] = field(default=None)
