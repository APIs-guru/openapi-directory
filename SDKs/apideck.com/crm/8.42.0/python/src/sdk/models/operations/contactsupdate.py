...
class ContactsUpdateRequest:
    ...
    query_params: ContactsUpdateQueryParams = field(default=None)
    headers: ContactsUpdateHeaders = field(default=None)
    request: Any = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: ContactsUpdateSecurity = field(default=None)
    

@dataclass
class ContactsUpdateResponses:
...
class ContactsUpdateResponse:
    ...
    responses: dict[int, dict[str, ContactsUpdateResponses]] = field(default=None)
