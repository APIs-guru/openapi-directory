...
class PipelinesOneRequest:
    headers: PipelinesOneHeaders = field()
    path_params: PipelinesOnePathParams = field()
    query_params: PipelinesOneQueryParams = field()
    security: PipelinesOneSecurity = field()
