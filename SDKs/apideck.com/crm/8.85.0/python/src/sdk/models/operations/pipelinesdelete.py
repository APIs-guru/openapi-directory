...
class PipelinesDeleteRequest:
    headers: PipelinesDeleteHeaders = field()
    path_params: PipelinesDeletePathParams = field()
    query_params: PipelinesDeleteQueryParams = field()
    security: PipelinesDeleteSecurity = field()
