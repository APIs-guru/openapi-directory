...
class UsersAllRequest:
    headers: UsersAllHeaders = field()
    query_params: UsersAllQueryParams = field()
    security: UsersAllSecurity = field()
...
class UsersAllResponseOutput:
    ...
    get_users_response: Optional[shared.GetUsersResponseOutput] = field(default=None)
