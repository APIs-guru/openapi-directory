...
class NotesUpdateRequest:
    headers: NotesUpdateHeaders = field()
    path_params: NotesUpdatePathParams = field()
    query_params: NotesUpdateQueryParams = field()
    request: shared.NoteInput = field(metadata={'request': { 'media_type': 'application/json' }})
    security: NotesUpdateSecurity = field()
