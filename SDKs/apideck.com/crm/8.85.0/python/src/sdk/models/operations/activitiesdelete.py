...
class ActivitiesDeleteRequest:
    headers: ActivitiesDeleteHeaders = field()
    path_params: ActivitiesDeletePathParams = field()
    query_params: ActivitiesDeleteQueryParams = field()
    security: ActivitiesDeleteSecurity = field()
