...
class PipelinesAllRequest:
    headers: PipelinesAllHeaders = field()
    query_params: PipelinesAllQueryParams = field()
    security: PipelinesAllSecurity = field()
    

@dataclass
class PipelinesAllResponse:
    content_type: str = field()
    status_code: int = field()
    bad_request_response: Optional[shared.BadRequestResponse] = field(default=None)
    get_pipelines_response: Optional[shared.GetPipelinesResponse] = field(default=None)
