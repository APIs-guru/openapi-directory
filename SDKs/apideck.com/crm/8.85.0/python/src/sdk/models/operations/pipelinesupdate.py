...
class PipelinesUpdateRequest:
    headers: PipelinesUpdateHeaders = field()
    path_params: PipelinesUpdatePathParams = field()
    query_params: PipelinesUpdateQueryParams = field()
    request: shared.PipelineInput = field(metadata={'request': { 'media_type': 'application/json' }})
    security: PipelinesUpdateSecurity = field()
