...
class UsersOneRequest:
    headers: UsersOneHeaders = field()
    path_params: UsersOnePathParams = field()
    query_params: UsersOneQueryParams = field()
    security: UsersOneSecurity = field()
...
class UsersOneResponseOutput:
    ...
    get_user_response: Optional[shared.GetUserResponseOutput] = field(default=None)
