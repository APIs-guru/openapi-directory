...
class ActivitiesUpdateRequest:
    headers: ActivitiesUpdateHeaders = field()
    path_params: ActivitiesUpdatePathParams = field()
    query_params: ActivitiesUpdateQueryParams = field()
    request: shared.ActivityInput = field(metadata={'request': { 'media_type': 'application/json' }})
    security: ActivitiesUpdateSecurity = field()
