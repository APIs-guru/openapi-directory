...
class OpportunitiesAddRequest:
    headers: OpportunitiesAddHeaders = field()
    query_params: OpportunitiesAddQueryParams = field()
    request: shared.OpportunityInput = field(metadata={'request': { 'media_type': 'application/json' }})
    security: OpportunitiesAddSecurity = field()
