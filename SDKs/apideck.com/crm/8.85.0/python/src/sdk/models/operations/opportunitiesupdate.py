...
class OpportunitiesUpdateRequest:
    headers: OpportunitiesUpdateHeaders = field()
    path_params: OpportunitiesUpdatePathParams = field()
    query_params: OpportunitiesUpdateQueryParams = field()
    request: shared.OpportunityInput = field(metadata={'request': { 'media_type': 'application/json' }})
    security: OpportunitiesUpdateSecurity = field()
