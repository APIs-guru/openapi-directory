...
class OpportunitiesOneRequest:
    headers: OpportunitiesOneHeaders = field()
    path_params: OpportunitiesOnePathParams = field()
    query_params: OpportunitiesOneQueryParams = field()
    security: OpportunitiesOneSecurity = field()
