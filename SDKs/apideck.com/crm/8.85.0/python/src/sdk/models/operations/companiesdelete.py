...
class CompaniesDeleteRequest:
    headers: CompaniesDeleteHeaders = field()
    path_params: CompaniesDeletePathParams = field()
    query_params: CompaniesDeleteQueryParams = field()
    security: CompaniesDeleteSecurity = field()
...
class CompaniesDeleteResponse:
    ...
    delete_company_response: Optional[shared.DeleteCompanyResponse] = field(default=None)
