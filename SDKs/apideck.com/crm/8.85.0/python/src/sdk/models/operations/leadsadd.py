...
class LeadsAddRequest:
    headers: LeadsAddHeaders = field()
    query_params: LeadsAddQueryParams = field()
    request: shared.LeadInput = field(metadata={'request': { 'media_type': 'application/json' }})
    security: LeadsAddSecurity = field()
