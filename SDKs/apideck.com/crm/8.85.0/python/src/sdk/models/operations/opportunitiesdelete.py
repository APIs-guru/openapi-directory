...
class OpportunitiesDeleteRequest:
    headers: OpportunitiesDeleteHeaders = field()
    path_params: OpportunitiesDeletePathParams = field()
    query_params: OpportunitiesDeleteQueryParams = field()
    security: OpportunitiesDeleteSecurity = field()
