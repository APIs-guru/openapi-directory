...
class ActivitiesOneRequest:
    headers: ActivitiesOneHeaders = field()
    path_params: ActivitiesOnePathParams = field()
    query_params: ActivitiesOneQueryParams = field()
    security: ActivitiesOneSecurity = field()
