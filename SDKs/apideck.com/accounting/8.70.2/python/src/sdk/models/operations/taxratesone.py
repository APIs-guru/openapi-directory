...
@dataclass
class TaxRatesOnePathParams:
    id: str = field(default=None, metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclass
class TaxRatesOneQueryParams:
    raw: Optional[bool] = field(default=None, metadata={'query_param': { 'field_name': 'raw', 'style': 'form', 'explode': True }})
    

@dataclass
class TaxRatesOneHeaders:
...
class TaxRatesOneRequest:
    path_params: TaxRatesOnePathParams = field(default=None)
    query_params: TaxRatesOneQueryParams = field(default=None)
    headers: TaxRatesOneHeaders = field(default=None)
    security: TaxRatesOneSecurity = field(default=None)
...
class TaxRatesOneResponse:
    ...
    get_tax_rate_response: Optional[shared.GetTaxRateResponse] = field(default=None)
