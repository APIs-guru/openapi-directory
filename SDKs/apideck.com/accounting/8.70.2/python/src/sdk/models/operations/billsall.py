...
class BillsAllRequest:
    query_params: BillsAllQueryParams = field(default=None)
    headers: BillsAllHeaders = field(default=None)
    security: BillsAllSecurity = field(default=None)
...
class BillsAllResponse:
    ...
    get_bills_response: Optional[shared.GetBillsResponse] = field(default=None)
