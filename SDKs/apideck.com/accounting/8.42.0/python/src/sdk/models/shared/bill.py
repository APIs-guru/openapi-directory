...
class Bill:
    ...
    line_items: Optional[List[shared.BillLineItem]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'line_items' }})
    ...
    supplier: Optional[shared.LinkedSupplier] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'supplier' }})
