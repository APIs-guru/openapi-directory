...
class InvoiceItem:
    ...
    asset_account: Optional[shared.LinkedLedgerAccount] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'asset_account' }})
    ...
    expense_account: Optional[shared.LinkedLedgerAccount] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'expense_account' }})
    id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'id' }})
    income_account: Optional[shared.LinkedLedgerAccount] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'income_account' }})
