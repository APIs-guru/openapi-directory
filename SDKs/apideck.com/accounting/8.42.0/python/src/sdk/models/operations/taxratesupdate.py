...
class TaxRatesUpdateRequest:
    path_params: TaxRatesUpdatePathParams = field(default=None)
    query_params: TaxRatesUpdateQueryParams = field(default=None)
    headers: TaxRatesUpdateHeaders = field(default=None)
    request: shared.TaxRate = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: TaxRatesUpdateSecurity = field(default=None)
    

@dataclass
class TaxRatesUpdateResponses:
...
class TaxRatesUpdateResponse:
    ...
    responses: dict[int, dict[str, TaxRatesUpdateResponses]] = field(default=None)
