...
@dataclass
class InvoicesDeletePathParams:
    id: str = field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclass
class InvoicesDeleteQueryParams:
    raw: Optional[bool] = field(default=None, metadata={'query_param': { 'field_name': 'raw', 'style': 'form', 'explode': True }})
    

@dataclass
class InvoicesDeleteHeaders:
...
@dataclass
class InvoicesDeleteSecurity:
    api_key: shared.SchemeAPIKey = field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclass
class InvoicesDeleteRequest:
    headers: InvoicesDeleteHeaders = field()
    path_params: InvoicesDeletePathParams = field()
    query_params: InvoicesDeleteQueryParams = field()
    security: InvoicesDeleteSecurity = field()
    

@dataclass
class InvoicesDeleteResponse:
