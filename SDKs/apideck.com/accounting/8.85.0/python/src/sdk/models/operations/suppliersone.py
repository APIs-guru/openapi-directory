...
class SuppliersOneRequest:
    headers: SuppliersOneHeaders = field()
    path_params: SuppliersOnePathParams = field()
    query_params: SuppliersOneQueryParams = field()
    security: SuppliersOneSecurity = field()
