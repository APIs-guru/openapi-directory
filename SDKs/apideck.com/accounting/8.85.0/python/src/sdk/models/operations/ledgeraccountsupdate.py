...
class LedgerAccountsUpdateRequest:
    headers: LedgerAccountsUpdateHeaders = field()
    path_params: LedgerAccountsUpdatePathParams = field()
    query_params: LedgerAccountsUpdateQueryParams = field()
    request: dict[str, Any] = field(metadata={'request': { 'media_type': 'application/json' }})
    security: LedgerAccountsUpdateSecurity = field()
