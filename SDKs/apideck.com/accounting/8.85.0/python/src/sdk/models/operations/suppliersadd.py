...
class SuppliersAddRequest:
    headers: SuppliersAddHeaders = field()
    query_params: SuppliersAddQueryParams = field()
    request: shared.SupplierInput = field(metadata={'request': { 'media_type': 'application/json' }})
    security: SuppliersAddSecurity = field()
