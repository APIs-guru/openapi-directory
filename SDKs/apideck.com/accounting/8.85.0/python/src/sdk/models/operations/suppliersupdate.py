...
class SuppliersUpdateRequest:
    headers: SuppliersUpdateHeaders = field()
    path_params: SuppliersUpdatePathParams = field()
    query_params: SuppliersUpdateQueryParams = field()
    request: shared.SupplierInput = field(metadata={'request': { 'media_type': 'application/json' }})
    security: SuppliersUpdateSecurity = field()
