...
class InvoiceItemsDeleteRequest:
    headers: InvoiceItemsDeleteHeaders = field()
    path_params: InvoiceItemsDeletePathParams = field()
    query_params: InvoiceItemsDeleteQueryParams = field()
    security: InvoiceItemsDeleteSecurity = field()
