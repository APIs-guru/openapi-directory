...
class InvoicesAddRequest:
    headers: InvoicesAddHeaders = field()
    query_params: InvoicesAddQueryParams = field()
    request: shared.InvoiceInput = field(metadata={'request': { 'media_type': 'application/json' }})
    security: InvoicesAddSecurity = field()
