...
class CreditNotesOneRequest:
    headers: CreditNotesOneHeaders = field()
    path_params: CreditNotesOnePathParams = field()
    query_params: CreditNotesOneQueryParams = field()
    security: CreditNotesOneSecurity = field()
