...
class InvoicesUpdateRequest:
    headers: InvoicesUpdateHeaders = field()
    path_params: InvoicesUpdatePathParams = field()
    query_params: InvoicesUpdateQueryParams = field()
    request: shared.InvoiceInput = field(metadata={'request': { 'media_type': 'application/json' }})
    security: InvoicesUpdateSecurity = field()
