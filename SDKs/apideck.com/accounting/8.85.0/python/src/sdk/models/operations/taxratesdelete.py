...
class TaxRatesDeleteRequest:
    headers: TaxRatesDeleteHeaders = field()
    path_params: TaxRatesDeletePathParams = field()
    query_params: TaxRatesDeleteQueryParams = field()
    security: TaxRatesDeleteSecurity = field()
