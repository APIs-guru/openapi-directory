...
class CreditNotesDeleteRequest:
    headers: CreditNotesDeleteHeaders = field()
    path_params: CreditNotesDeletePathParams = field()
    query_params: CreditNotesDeleteQueryParams = field()
    security: CreditNotesDeleteSecurity = field()
