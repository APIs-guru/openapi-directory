...
class PutProxyRequest:
    headers: PutProxyHeaders = field()
    security: PutProxySecurity = field()
...
class PutProxyResponse:
    ...
    put_proxy_401_application_json_object: Optional[PutProxy401ApplicationJSON] = field(default=None)
