...
class PutProxyRequest:
    headers: PutProxyHeaders = field(default=None)
    request: Optional[bytes] = field(default=None, metadata={'request': { 'media_type': '*/*' }})
    security: PutProxySecurity = field(default=None)
    

@dataclass
class PutProxyResponses:
    put_proxy_200_application_json_any: Optional[Any] = field(default=None)
    put_proxy_401_application_json_any: Optional[Any] = field(default=None)
    put_proxy_default_application_json_any: Optional[Any] = field(default=None)
...
class PutProxyResponse:
    ...
    responses: dict[int, dict[str, PutProxyResponses]] = field(default=None)
