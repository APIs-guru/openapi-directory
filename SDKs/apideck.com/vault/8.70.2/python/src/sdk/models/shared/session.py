...
class SessionSettings:
    ...
    show_sidebar: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'show_sidebar' }})
    show_suggestions: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'show_suggestions' }})
    unified_apis: Optional[List[unifiedapiid_enum.UnifiedAPIIDEnum]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'unified_apis' }})
...
@dataclass
class Session:
    consumer_metadata: Optional[consumermetadata.ConsumerMetadata] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'consumer_metadata' }})
