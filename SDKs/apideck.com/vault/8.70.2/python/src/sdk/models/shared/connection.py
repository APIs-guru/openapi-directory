...
from . import simpleformfieldoption
from . import formfieldoptiongroup
...
class Connection:
    ...
    form_fields: Optional[List[formfield.FormField]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'form_fields' }})
    ...
    oauth_grant_type: Optional[oauthgranttype_enum.OAuthGrantTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'oauth_grant_type' }})
    ...
    state: Optional[connectionstate_enum.ConnectionStateEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'state' }})
