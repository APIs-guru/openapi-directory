...
class ConnectionsImportRequest:
    headers: ConnectionsImportHeaders = field()
    path_params: ConnectionsImportPathParams = field()
    request: shared.ConnectionImportData = field(metadata={'request': { 'media_type': 'application/json' }})
    security: ConnectionsImportSecurity = field()
