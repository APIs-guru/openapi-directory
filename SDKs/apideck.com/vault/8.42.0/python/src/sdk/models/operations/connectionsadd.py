...
class ConnectionsAddRequest:
    path_params: ConnectionsAddPathParams = field(default=None)
    headers: ConnectionsAddHeaders = field(default=None)
    request: shared.Connection = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: ConnectionsAddSecurity = field(default=None)
    

@dataclass
class ConnectionsAddResponses:
...
class ConnectionsAddResponse:
    ...
    responses: dict[int, dict[str, ConnectionsAddResponses]] = field(default=None)
