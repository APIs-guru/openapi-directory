...
from . import connectordoc
from . import connectorsetting
...
class ConnectorUnifiedApis:
    id: Optional[unifiedapiid_enum.UnifiedAPIIDEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'id' }})
...
class Connector:
    ...
    blind_mapped: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'blind_mapped' }})
    configurable_resources: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'configurable_resources' }})
    description: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'description' }})
    docs: Optional[List[connectordoc.ConnectorDoc]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'docs' }})
    ...
    settings: Optional[List[connectorsetting.ConnectorSetting]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'settings' }})
    ...
    tls_support: Optional[ConnectorTLSSupport] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'tls_support' }})
