...
class APIResourceCoverageCoverage:
    ...
    supported_fields: Optional[List[APIResourceCoverageCoverageSupportedFields]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'supported_fields' }})
    supported_filters: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'supported_filters' }})
    supported_list_fields: Optional[List[APIResourceCoverageCoverageSupportedListFields]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'supported_list_fields' }})
