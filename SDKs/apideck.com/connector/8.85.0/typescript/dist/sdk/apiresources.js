...
var ApiResources = /** @class */ (function () {
    ...
    **/
    ApiResources.prototype.apiResourceCoverageOne = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ApiResourceCoverageOneRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/connector/apis/{id}/resources/{resource_id}/coverage", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.getApiResourceCoverageResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
     ...
     * Get API Resource
    **/
    ApiResources.prototype.apiResourcesOne = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ApiResourcesOneRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/connector/apis/{id}/resources/{resource_id}", req.pathParams);
        var client = this._securityClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "get", headers: headers }, config)).then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.getApiResourceResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 401:
                    if (utils.MatchContentType(contentType, "application/json")) {
