...
var ApIs = /** @class */ (function () {
     ...
     * List APIs
    **/
    ApIs.prototype.apisAll = function (req, config) {
     ...
     * Get API
    **/
    ApIs.prototype.apisOne = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ApisOneRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/connector/apis/{id}", req.pathParams);
        var client = this._securityClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
