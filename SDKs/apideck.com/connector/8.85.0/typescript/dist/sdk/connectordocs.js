...
var ConnectorDocs = /** @class */ (function () {
    function ConnectorDocs(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    ConnectorDocs.prototype.connectorDocsOne = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ConnectorDocsOneRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/connector/connectors/{id}/docs/{doc_id}", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "text/markdown")) {
                        res.connectorDocsOne200TextMarkdownMarkdownString = JSON.stringify(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data);
                    }
                    break;
