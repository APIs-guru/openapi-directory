...
var GetConnectorsResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata({ data: "json, name=data", elemType: Connector }),
        __metadata("design:type", Array)
    ], GetConnectorsResponse.prototype, "data", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=links" }),
        __metadata("design:type", Links)
    ], GetConnectorsResponse.prototype, "links", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=meta" }),
        __metadata("design:type", Meta)
    ], GetConnectorsResponse.prototype, "meta", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=status" }),
        __metadata("design:type", String)
    ], GetConnectorsResponse.prototype, "status", void 0);
    __decorate([
