...
var Connectors = /** @class */ (function () {
     ...
     * List Connectors
    **/
    Connectors.prototype.connectorsAll = function (req, config) {
     ...
     * Get Connector
    **/
    Connectors.prototype.connectorsOne = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ConnectorsOneRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/connector/connectors/{id}", req.pathParams);
        var client = this._securityClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.getConnectorResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 401:
                    if (utils.MatchContentType(contentType, "application/json")) {
