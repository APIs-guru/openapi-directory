...
class ConnectorResource:
    custom_fields_supported: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('custom_fields_supported') }})
    ...
    downstream_unsupported_operations: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('downstream_unsupported_operations') }})
