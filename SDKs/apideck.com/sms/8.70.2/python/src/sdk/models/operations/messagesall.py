...
@dataclass
class MessagesAllSecurity:
    api_key: shared.SchemeAPIKey = field(default=None, metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclass
class MessagesAllRequest:
    query_params: MessagesAllQueryParams = field(default=None)
    headers: MessagesAllHeaders = field(default=None)
    security: MessagesAllSecurity = field(default=None)
...
class MessagesAllResponse:
    ...
    get_messages_response: Optional[shared.GetMessagesResponse] = field(default=None)
