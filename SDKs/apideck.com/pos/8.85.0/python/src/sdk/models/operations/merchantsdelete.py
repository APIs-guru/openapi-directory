...
class MerchantsDeleteRequest:
    headers: MerchantsDeleteHeaders = field()
    path_params: MerchantsDeletePathParams = field()
    query_params: MerchantsDeleteQueryParams = field()
    security: MerchantsDeleteSecurity = field()
