...
class LocationsOneRequest:
    headers: LocationsOneHeaders = field()
    path_params: LocationsOnePathParams = field()
    query_params: LocationsOneQueryParams = field()
    security: LocationsOneSecurity = field()
