...
class PaymentsAddRequest:
    headers: PaymentsAddHeaders = field()
    query_params: PaymentsAddQueryParams = field()
    request: shared.PosPaymentInput = field(metadata={'request': { 'media_type': 'application/json' }})
    security: PaymentsAddSecurity = field()
