...
class LocationsUpdateRequest:
    headers: LocationsUpdateHeaders = field()
    path_params: LocationsUpdatePathParams = field()
    query_params: LocationsUpdateQueryParams = field()
    request: shared.LocationInput = field(metadata={'request': { 'media_type': 'application/json' }})
    security: LocationsUpdateSecurity = field()
