...
class TendersUpdateRequest:
    headers: TendersUpdateHeaders = field()
    path_params: TendersUpdatePathParams = field()
    query_params: TendersUpdateQueryParams = field()
    request: shared.TenderInput = field(metadata={'request': { 'media_type': 'application/json' }})
    security: TendersUpdateSecurity = field()
