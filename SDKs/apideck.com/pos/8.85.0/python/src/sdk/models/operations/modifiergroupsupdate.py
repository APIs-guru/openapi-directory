...
class ModifierGroupsUpdateRequest:
    headers: ModifierGroupsUpdateHeaders = field()
    path_params: ModifierGroupsUpdatePathParams = field()
    query_params: ModifierGroupsUpdateQueryParams = field()
    request: shared.ModifierGroupInput = field(metadata={'request': { 'media_type': 'application/json' }})
    security: ModifierGroupsUpdateSecurity = field()
