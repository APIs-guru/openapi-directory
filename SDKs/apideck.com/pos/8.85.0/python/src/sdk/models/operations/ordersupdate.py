...
class OrdersUpdateRequest:
    headers: OrdersUpdateHeaders = field()
    path_params: OrdersUpdatePathParams = field()
    query_params: OrdersUpdateQueryParams = field()
    request: shared.OrderInput = field(metadata={'request': { 'media_type': 'application/json' }})
    security: OrdersUpdateSecurity = field()
