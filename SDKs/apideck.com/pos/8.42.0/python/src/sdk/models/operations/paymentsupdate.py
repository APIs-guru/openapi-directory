...
class PaymentsUpdateRequest:
    ...
    request: shared.PosPayment = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class PaymentsUpdateResponses:
    ...
    update_pos_payment_response: Optional[shared.UpdatePosPaymentResponse] = field(default=None)
