...
class OrderFulfillmentsPickupDetailsRecipient:
    ...
    email: Optional[shared.Email] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'email' }})
    phone_number: Optional[shared.PhoneNumber] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'phone_number' }})
