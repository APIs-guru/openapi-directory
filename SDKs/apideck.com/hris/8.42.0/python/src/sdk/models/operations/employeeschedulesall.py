...
class EmployeeSchedulesAllRequest:
    path_params: EmployeeSchedulesAllPathParams = field(default=None)
    query_params: EmployeeSchedulesAllQueryParams = field(default=None)
    headers: EmployeeSchedulesAllHeaders = field(default=None)
    security: EmployeeSchedulesAllSecurity = field(default=None)
    

@dataclass
class EmployeeSchedulesAllResponses:
...
class EmployeeSchedulesAllResponse:
    ...
    responses: dict[int, dict[str, EmployeeSchedulesAllResponses]] = field(default=None)
