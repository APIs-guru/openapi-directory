...
class EmployeeCompensations:
    ...
    payment_unit: Optional[shared.PaymentUnitEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'payment_unit' }})
...
class EmployeeJobs:
    ...
    location: Optional[shared.Address] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'location' }})
    payment_unit: Optional[shared.PaymentUnitEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'payment_unit' }})
...
class EmployeePartner:
    ...
    first_name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'first_name' }})
    gender: Optional[shared.GenderEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'gender' }})
    id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'id' }})
