...
class Payroll:
    ...
    compensations: Optional[List[compensation.Compensation]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'compensations' }})
    ...
    totals: Optional[payrolltotals.PayrollTotals] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'totals' }})
