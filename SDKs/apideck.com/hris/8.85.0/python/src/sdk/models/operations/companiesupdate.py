...
class CompaniesUpdateRequest:
    headers: CompaniesUpdateHeaders = field()
    path_params: CompaniesUpdatePathParams = field()
    query_params: CompaniesUpdateQueryParams = field()
    request: shared.HrisCompanyInput = field(metadata={'request': { 'media_type': 'application/json' }})
    security: CompaniesUpdateSecurity = field()
