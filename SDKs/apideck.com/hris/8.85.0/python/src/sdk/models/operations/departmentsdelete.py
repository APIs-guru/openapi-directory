...
class DepartmentsDeleteRequest:
    headers: DepartmentsDeleteHeaders = field()
    path_params: DepartmentsDeletePathParams = field()
    query_params: DepartmentsDeleteQueryParams = field()
    security: DepartmentsDeleteSecurity = field()
