...
class CompaniesOneRequest:
    headers: CompaniesOneHeaders = field()
    path_params: CompaniesOnePathParams = field()
    query_params: CompaniesOneQueryParams = field()
    security: CompaniesOneSecurity = field()
