...
class DepartmentsOneRequest:
    headers: DepartmentsOneHeaders = field()
    path_params: DepartmentsOnePathParams = field()
    query_params: DepartmentsOneQueryParams = field()
    security: DepartmentsOneSecurity = field()
