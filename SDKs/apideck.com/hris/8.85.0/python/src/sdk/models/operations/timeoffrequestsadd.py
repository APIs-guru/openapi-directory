...
class TimeOffRequestsAddRequest:
    headers: TimeOffRequestsAddHeaders = field()
    query_params: TimeOffRequestsAddQueryParams = field()
    request: shared.TimeOffRequestInput = field(metadata={'request': { 'media_type': 'application/json' }})
    security: TimeOffRequestsAddSecurity = field()
