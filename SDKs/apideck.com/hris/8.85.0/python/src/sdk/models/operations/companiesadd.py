...
class CompaniesAddRequest:
    headers: CompaniesAddHeaders = field()
    query_params: CompaniesAddQueryParams = field()
    request: shared.HrisCompanyInput = field(metadata={'request': { 'media_type': 'application/json' }})
    security: CompaniesAddSecurity = field()
...
class CompaniesAddResponse:
    ...
    create_hris_company_response: Optional[shared.CreateHrisCompanyResponse] = field(default=None)
