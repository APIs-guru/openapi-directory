...
class EmployeePayrollsOnePathParams:
    ...
    payroll_id: str = field(metadata={'path_param': { 'field_name': 'payroll_id', 'style': 'simple', 'explode': False }})
...
class EmployeePayrollsOneRequest:
    headers: EmployeePayrollsOneHeaders = field()
    path_params: EmployeePayrollsOnePathParams = field()
    query_params: EmployeePayrollsOneQueryParams = field()
    security: EmployeePayrollsOneSecurity = field()
