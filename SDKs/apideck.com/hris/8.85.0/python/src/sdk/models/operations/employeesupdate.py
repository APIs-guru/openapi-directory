...
class EmployeesUpdateRequest:
    headers: EmployeesUpdateHeaders = field()
    path_params: EmployeesUpdatePathParams = field()
    query_params: EmployeesUpdateQueryParams = field()
    request: shared.EmployeeInput = field(metadata={'request': { 'media_type': 'application/json' }})
    security: EmployeesUpdateSecurity = field()
