...
class EmployeePayrollsAllRequest:
    headers: EmployeePayrollsAllHeaders = field()
    path_params: EmployeePayrollsAllPathParams = field()
    query_params: EmployeePayrollsAllQueryParams = field()
    security: EmployeePayrollsAllSecurity = field()
