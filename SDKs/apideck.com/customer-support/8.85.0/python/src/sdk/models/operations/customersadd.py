...
class CustomersAddRequest:
    headers: CustomersAddHeaders = field()
    query_params: CustomersAddQueryParams = field()
    request: shared.CustomerSupportCustomerInput = field(metadata={'request': { 'media_type': 'application/json' }})
    security: CustomersAddSecurity = field()
