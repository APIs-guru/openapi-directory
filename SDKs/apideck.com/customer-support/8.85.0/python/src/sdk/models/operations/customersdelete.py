...
class CustomersDeleteResponse:
    ...
    delete_customer_support_customer_response: Optional[shared.DeleteCustomerSupportCustomerResponse] = field(default=None)
