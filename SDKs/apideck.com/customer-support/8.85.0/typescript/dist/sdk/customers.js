...
var Customers = /** @class */ (function () {
    ...
    **/
    Customers.prototype.customersAdd = function (req, config) {
        var _a;
    ...
    **/
    Customers.prototype.customersAll = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Customers.prototype.customersOne = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Customers.prototype.customersUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
