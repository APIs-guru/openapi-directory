...
var Applicants = /** @class */ (function () {
    function Applicants(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Create applicant
    **/
    Applicants.prototype.applicantsAdd = function (req, config) {
        var _a;
     ...
     * List applicants
    **/
    Applicants.prototype.applicantsAll = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Get applicant
    **/
    Applicants.prototype.applicantsOne = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
