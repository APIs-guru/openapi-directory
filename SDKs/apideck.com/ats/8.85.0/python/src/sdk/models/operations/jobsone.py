...
class JobsOneRequest:
    headers: JobsOneHeaders = field()
    path_params: JobsOnePathParams = field()
    query_params: JobsOneQueryParams = field()
    security: JobsOneSecurity = field()
...
class JobsOneResponse:
    ...
    get_job_response: Optional[shared.GetJobResponse] = field(default=None)
