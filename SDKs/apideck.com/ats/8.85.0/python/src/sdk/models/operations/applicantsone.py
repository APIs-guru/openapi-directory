...
class ApplicantsOneRequest:
    headers: ApplicantsOneHeaders = field()
    path_params: ApplicantsOnePathParams = field()
    query_params: ApplicantsOneQueryParams = field()
    security: ApplicantsOneSecurity = field()
