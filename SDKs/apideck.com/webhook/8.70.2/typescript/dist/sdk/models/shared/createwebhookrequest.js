...
var CreateWebhookRequest = /** @class */ (function (_super) {
    ...
    ], CreateWebhookRequest.prototype, "deliveryUrl", void 0);
    __decorate([
        Metadata({ data: "json, name=description" }),
        __metadata("design:type", String)
    ], CreateWebhookRequest.prototype, "description", void 0);
    __decorate([
        Metadata({ data: "json, name=events" }),
        __metadata("design:type", Array)
    ], CreateWebhookRequest.prototype, "events", void 0);
    __decorate([
        Metadata({ data: "json, name=status" }),
        __metadata("design:type", String)
    ], CreateWebhookRequest.prototype, "status", void 0);
    __decorate([
        Metadata({ data: "json, name=unified_api" }),
        __metadata("design:type", String)
    ], CreateWebhookRequest.prototype, "unifiedApi", void 0);
