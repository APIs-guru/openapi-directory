...
**/
var ResumePointObject = /** @class */ (function (_super) {
    __extends(ResumePointObject, _super);
    function ResumePointObject() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=fully_played" }),
        __metadata("design:type", Boolean)
    ], ResumePointObject.prototype, "fullyPlayed", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=resume_position_ms" }),
        __metadata("design:type", Number)
    ], ResumePointObject.prototype, "resumePositionMs", void 0);
    return ResumePointObject;
}(SpeakeasyBase));
export { ResumePointObject };
