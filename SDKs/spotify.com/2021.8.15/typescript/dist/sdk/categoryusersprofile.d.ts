...
export declare class CategoryUsersProfile {
    ...
    **/
    endpointGetCurrentUsersProfile(req: operations.EndpointGetCurrentUsersProfileRequest, config?: AxiosRequestConfig): Promise<operations.EndpointGetCurrentUsersProfileResponse>;
    /**
    ...
    **/
    endpointGetUsersProfile(req: operations.EndpointGetUsersProfileRequest, config?: AxiosRequestConfig): Promise<operations.EndpointGetUsersProfileResponse>;
}
