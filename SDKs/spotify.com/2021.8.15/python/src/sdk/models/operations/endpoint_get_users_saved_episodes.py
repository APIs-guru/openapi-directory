...
class EndpointGetUsersSavedEpisodes200ApplicationJSON:
    ...
    items: Optional[List[shared.SavedEpisodeObject]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('items') }})
...
class EndpointGetUsersSavedEpisodesRequest:
    headers: EndpointGetUsersSavedEpisodesHeaders = field()
    query_params: EndpointGetUsersSavedEpisodesQueryParams = field()
    security: EndpointGetUsersSavedEpisodesSecurity = field()
