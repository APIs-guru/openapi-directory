...
class EndpointGetUsersSavedShows200ApplicationJSON:
    ...
    items: Optional[List[shared.SavedShowObject]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('items') }})
...
class EndpointGetUsersSavedShowsRequest:
    headers: EndpointGetUsersSavedShowsHeaders = field()
    query_params: EndpointGetUsersSavedShowsQueryParams = field()
    security: EndpointGetUsersSavedShowsSecurity = field()
