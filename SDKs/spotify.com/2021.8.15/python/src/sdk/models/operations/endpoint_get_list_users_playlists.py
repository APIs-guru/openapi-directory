...
class EndpointGetListUsersPlaylistsRequest:
    headers: EndpointGetListUsersPlaylistsHeaders = field()
    path_params: EndpointGetListUsersPlaylistsPathParams = field()
    query_params: EndpointGetListUsersPlaylistsQueryParams = field()
    security: EndpointGetListUsersPlaylistsSecurity = field()
