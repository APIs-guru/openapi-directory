...
class EndpointGetUsersSavedAlbumsRequest:
    query_params: EndpointGetUsersSavedAlbumsQueryParams = field(default=None)
    headers: EndpointGetUsersSavedAlbumsHeaders = field(default=None)
    security: EndpointGetUsersSavedAlbumsSecurity = field(default=None)
...
class EndpointGetUsersSavedAlbums200ApplicationJSON:
    ...
    items: Optional[List[shared.SavedAlbumObject]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'items' }})
