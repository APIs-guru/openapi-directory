...
class EndpointRemoveEpisodesUserRequest:
    headers: EndpointRemoveEpisodesUserHeaders = field()
    query_params: EndpointRemoveEpisodesUserQueryParams = field()
    security: EndpointRemoveEpisodesUserSecurity = field()
