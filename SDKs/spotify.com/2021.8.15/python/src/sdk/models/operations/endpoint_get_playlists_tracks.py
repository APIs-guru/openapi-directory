...
class EndpointGetPlaylistsTracksRequest:
    path_params: EndpointGetPlaylistsTracksPathParams = field(default=None)
    query_params: EndpointGetPlaylistsTracksQueryParams = field(default=None)
    headers: EndpointGetPlaylistsTracksHeaders = field(default=None)
    security: EndpointGetPlaylistsTracksSecurity = field(default=None)
...
class EndpointGetPlaylistsTracks200ApplicationJSON:
    ...
    items: Optional[List[shared.PlaylistTrackObject]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'items' }})
...
class EndpointGetPlaylistsTracksResponse:
    ...
    endpoint_get_playlists_tracks_200_application_json_object: Optional[EndpointGetPlaylistsTracks200ApplicationJSON] = field(default=None)
