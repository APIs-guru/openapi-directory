...
class EndpointGetPlaylistsTracks200ApplicationJSON:
    ...
    items: Optional[List[shared.PlaylistTrackObject]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('items') }})
...
class EndpointGetPlaylistsTracksRequest:
    headers: EndpointGetPlaylistsTracksHeaders = field()
    path_params: EndpointGetPlaylistsTracksPathParams = field()
    query_params: EndpointGetPlaylistsTracksQueryParams = field()
    security: EndpointGetPlaylistsTracksSecurity = field()
