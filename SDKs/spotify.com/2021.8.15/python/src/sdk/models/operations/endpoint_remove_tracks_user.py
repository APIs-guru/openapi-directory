...
class EndpointRemoveTracksUserRequest:
    query_params: EndpointRemoveTracksUserQueryParams = field(default=None)
    headers: EndpointRemoveTracksUserHeaders = field(default=None)
    request: Optional[EndpointRemoveTracksUserRequestBody] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: EndpointRemoveTracksUserSecurity = field(default=None)
