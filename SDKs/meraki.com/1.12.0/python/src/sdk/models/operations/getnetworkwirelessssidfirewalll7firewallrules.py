...
class GetNetworkWirelessSsidFirewallL7FirewallRulesRequest:
    path_params: GetNetworkWirelessSsidFirewallL7FirewallRulesPathParams = field(default=None)
...
class GetNetworkWirelessSsidFirewallL7FirewallRulesResponse:
    ...
    get_network_wireless_ssid_firewall_l7_firewall_rules_200_application_json_object: Optional[dict[str, Any]] = field(default=None)
