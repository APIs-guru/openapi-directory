...
class GetNetworkApplianceStaticRouteRequest:
    path_params: GetNetworkApplianceStaticRoutePathParams = field(default=None)
...
class GetNetworkApplianceStaticRouteResponse:
    ...
    get_network_appliance_static_route_200_application_json_object: Optional[dict[str, Any]] = field(default=None)
