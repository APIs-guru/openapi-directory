...
class UpdateOrganizationAdminRequestBodyNetworks:
    access: UpdateOrganizationAdminRequestBodyNetworksAccessEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'access' }})
...
class UpdateOrganizationAdminRequestBodyTags:
    access: UpdateOrganizationAdminRequestBodyTagsAccessEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'access' }})
...
class UpdateOrganizationAdminRequestBody:
    ...
    networks: Optional[List[UpdateOrganizationAdminRequestBodyNetworks]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'networks' }})
    org_access: Optional[UpdateOrganizationAdminRequestBodyOrgAccessEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'orgAccess' }})
    tags: Optional[List[UpdateOrganizationAdminRequestBodyTags]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'tags' }})
    

@dataclass
class UpdateOrganizationAdminRequest:
    path_params: UpdateOrganizationAdminPathParams = field(default=None)
