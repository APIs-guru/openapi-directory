...
class GetNetworkWebhooksWebhookTestPathParams:
    ...
    webhook_test_id: str = field(default=None, metadata={'path_param': { 'field_name': 'webhookTestId', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetNetworkWebhooksWebhookTestRequest:
    path_params: GetNetworkWebhooksWebhookTestPathParams = field(default=None)
