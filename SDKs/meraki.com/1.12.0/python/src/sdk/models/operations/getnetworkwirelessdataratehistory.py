...
class GetNetworkWirelessDataRateHistoryRequest:
    path_params: GetNetworkWirelessDataRateHistoryPathParams = field(default=None)
    query_params: GetNetworkWirelessDataRateHistoryQueryParams = field(default=None)
