...
class UpdateDeviceSwitchPortRequestBody:
    ...
    access_policy_type: Optional[UpdateDeviceSwitchPortRequestBodyAccessPolicyTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('accessPolicyType') }})
    ...
    stp_guard: Optional[UpdateDeviceSwitchPortRequestBodyStpGuardEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('stpGuard') }})
    tags: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tags') }})
    type: Optional[UpdateDeviceSwitchPortRequestBodyTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
    udld: Optional[UpdateDeviceSwitchPortRequestBodyUdldEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('udld') }})
...
class UpdateDeviceSwitchPortRequest:
    path_params: UpdateDeviceSwitchPortPathParams = field()
