...
class GetOrganizationApplianceVpnStatusesRequest:
    path_params: GetOrganizationApplianceVpnStatusesPathParams = field(default=None)
    query_params: GetOrganizationApplianceVpnStatusesQueryParams = field(default=None)
