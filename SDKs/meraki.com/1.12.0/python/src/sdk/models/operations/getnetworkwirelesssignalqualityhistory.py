...
class GetNetworkWirelessSignalQualityHistoryRequest:
    path_params: GetNetworkWirelessSignalQualityHistoryPathParams = field(default=None)
    query_params: GetNetworkWirelessSignalQualityHistoryQueryParams = field(default=None)
