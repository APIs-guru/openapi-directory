...
class GetNetworkSmBypassActivationLockAttemptPathParams:
    attempt_id: str = field(default=None, metadata={'path_param': { 'field_name': 'attemptId', 'style': 'simple', 'explode': False }})
    network_id: str = field(default=None, metadata={'path_param': { 'field_name': 'networkId', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetNetworkSmBypassActivationLockAttemptRequest:
    path_params: GetNetworkSmBypassActivationLockAttemptPathParams = field(default=None)
