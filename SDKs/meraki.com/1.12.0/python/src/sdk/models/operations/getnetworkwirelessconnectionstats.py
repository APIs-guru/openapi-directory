...
class GetNetworkWirelessConnectionStatsRequest:
    path_params: GetNetworkWirelessConnectionStatsPathParams = field(default=None)
    query_params: GetNetworkWirelessConnectionStatsQueryParams = field(default=None)
