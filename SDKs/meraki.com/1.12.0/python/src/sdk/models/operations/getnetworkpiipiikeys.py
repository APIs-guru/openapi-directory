...
class GetNetworkPiiPiiKeysRequest:
    path_params: GetNetworkPiiPiiKeysPathParams = field(default=None)
    query_params: GetNetworkPiiPiiKeysQueryParams = field(default=None)
...
class GetNetworkPiiPiiKeysResponse:
    ...
    get_network_pii_pii_keys_200_application_json_object: Optional[dict[str, Any]] = field(default=None)
