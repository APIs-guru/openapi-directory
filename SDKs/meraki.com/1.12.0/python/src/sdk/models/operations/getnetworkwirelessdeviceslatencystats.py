...
class GetNetworkWirelessDevicesLatencyStatsRequest:
    path_params: GetNetworkWirelessDevicesLatencyStatsPathParams = field(default=None)
    query_params: GetNetworkWirelessDevicesLatencyStatsQueryParams = field(default=None)
