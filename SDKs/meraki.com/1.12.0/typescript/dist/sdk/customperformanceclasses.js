...
var CustomPerformanceClasses = /** @class */ (function () {
    function CustomPerformanceClasses(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    CustomPerformanceClasses.prototype.createNetworkApplianceTrafficShapingCustomPerformanceClass = function (req, config) {
        var _a;
    ...
    **/
    CustomPerformanceClasses.prototype.deleteNetworkApplianceTrafficShapingCustomPerformanceClass = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    CustomPerformanceClasses.prototype.getNetworkApplianceTrafficShapingCustomPerformanceClass = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    CustomPerformanceClasses.prototype.getNetworkApplianceTrafficShapingCustomPerformanceClasses = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    CustomPerformanceClasses.prototype.updateNetworkApplianceTrafficShapingCustomPerformanceClass = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
export { CustomPerformanceClasses };
