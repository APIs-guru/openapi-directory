...
var UserAccessDevices = /** @class */ (function () {
    function UserAccessDevices(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    UserAccessDevices.prototype.deleteNetworkSmUserAccessDevice = function (req, config) {
    ...
    **/
    UserAccessDevices.prototype.getNetworkSmUserAccessDevices = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
