...
var Radio = /** @class */ (function () {
    function Radio(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Radio.prototype.getDeviceWirelessRadioSettings = function (req, config) {
    ...
    **/
    Radio.prototype.updateDeviceWirelessRadioSettings = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
