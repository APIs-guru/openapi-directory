...
var SingleLan = /** @class */ (function () {
    function SingleLan(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    SingleLan.prototype.getNetworkApplianceSingleLan = function (req, config) {
    ...
    **/
    SingleLan.prototype.updateNetworkApplianceSingleLan = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
