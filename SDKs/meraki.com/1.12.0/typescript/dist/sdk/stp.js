...
var Stp = /** @class */ (function () {
    function Stp(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Stp.prototype.getNetworkSwitchStp = function (req, config) {
    ...
    **/
    Stp.prototype.updateNetworkSwitchStp = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
