...
var StormControl = /** @class */ (function () {
    function StormControl(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    StormControl.prototype.getNetworkSwitchStormControl = function (req, config) {
    ...
    **/
    StormControl.prototype.updateNetworkSwitchStormControl = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
