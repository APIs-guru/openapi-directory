...
var DhcpServerPolicy = /** @class */ (function () {
    function DhcpServerPolicy(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    DhcpServerPolicy.prototype.getNetworkSwitchDhcpServerPolicy = function (req, config) {
    ...
    **/
    DhcpServerPolicy.prototype.updateNetworkSwitchDhcpServerPolicy = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
