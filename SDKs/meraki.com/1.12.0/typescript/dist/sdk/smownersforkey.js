...
var SmOwnersForKey = /** @class */ (function () {
    function SmOwnersForKey(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * ```
    **/
    SmOwnersForKey.prototype.getNetworkPiiSmOwnersForKey = function (req, config) {
