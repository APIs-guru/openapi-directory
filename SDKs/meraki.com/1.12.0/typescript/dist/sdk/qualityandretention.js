...
var QualityAndRetention = /** @class */ (function () {
    function QualityAndRetention(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    QualityAndRetention.prototype.getDeviceCameraQualityAndRetention = function (req, config) {
    ...
    **/
    QualityAndRetention.prototype.updateDeviceCameraQualityAndRetention = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
