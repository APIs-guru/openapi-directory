...
var ConnectivityMonitoringDestinations = /** @class */ (function () {
    function ConnectivityMonitoringDestinations(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    ConnectivityMonitoringDestinations.prototype.getNetworkApplianceConnectivityMonitoringDestinations = function (req, config) {
    ...
    **/
    ConnectivityMonitoringDestinations.prototype.getNetworkCellularGatewayConnectivityMonitoringDestinations = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ConnectivityMonitoringDestinations.prototype.updateNetworkApplianceConnectivityMonitoringDestinations = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ConnectivityMonitoringDestinations.prototype.updateNetworkCellularGatewayConnectivityMonitoringDestinations = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
export { ConnectivityMonitoringDestinations };
