...
var Bluetooth = /** @class */ (function () {
    ...
    **/
    Bluetooth.prototype.getDeviceWirelessBluetoothSettings = function (req, config) {
    ...
    **/
    Bluetooth.prototype.getNetworkWirelessBluetoothSettings = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Bluetooth.prototype.updateDeviceWirelessBluetoothSettings = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Bluetooth.prototype.updateNetworkWirelessBluetoothSettings = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
