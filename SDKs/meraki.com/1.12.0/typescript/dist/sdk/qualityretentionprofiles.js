...
var QualityRetentionProfiles = /** @class */ (function () {
    function QualityRetentionProfiles(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    QualityRetentionProfiles.prototype.createNetworkCameraQualityRetentionProfile = function (req, config) {
        var _a;
    ...
    **/
    QualityRetentionProfiles.prototype.deleteNetworkCameraQualityRetentionProfile = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    QualityRetentionProfiles.prototype.getNetworkCameraQualityRetentionProfile = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    QualityRetentionProfiles.prototype.getNetworkCameraQualityRetentionProfiles = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    QualityRetentionProfiles.prototype.updateNetworkCameraQualityRetentionProfile = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
export { QualityRetentionProfiles };
