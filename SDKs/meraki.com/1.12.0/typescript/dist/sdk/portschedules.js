...
var PortSchedules = /** @class */ (function () {
    function PortSchedules(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    PortSchedules.prototype.createNetworkSwitchPortSchedule = function (req, config) {
        var _a;
    ...
    **/
    PortSchedules.prototype.deleteNetworkSwitchPortSchedule = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    PortSchedules.prototype.getNetworkSwitchPortSchedules = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    PortSchedules.prototype.updateNetworkSwitchPortSchedule = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
