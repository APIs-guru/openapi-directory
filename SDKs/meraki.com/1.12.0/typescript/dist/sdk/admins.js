...
var Admins = /** @class */ (function () {
    function Admins(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Admins.prototype.createOrganizationAdmin = function (req, config) {
        var _a;
    ...
    **/
    Admins.prototype.deleteOrganizationAdmin = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Admins.prototype.getOrganizationAdmins = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Admins.prototype.updateOrganizationAdmin = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
