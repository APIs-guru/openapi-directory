...
var DscpToCosMappings = /** @class */ (function () {
    function DscpToCosMappings(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    DscpToCosMappings.prototype.getNetworkSwitchDscpToCosMappings = function (req, config) {
    ...
    **/
    DscpToCosMappings.prototype.updateNetworkSwitchDscpToCosMappings = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
