...
var UplinkSelection = /** @class */ (function () {
    function UplinkSelection(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    UplinkSelection.prototype.getNetworkApplianceTrafficShapingUplinkSelection = function (req, config) {
    ...
    **/
    UplinkSelection.prototype.updateNetworkApplianceTrafficShapingUplinkSelection = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
