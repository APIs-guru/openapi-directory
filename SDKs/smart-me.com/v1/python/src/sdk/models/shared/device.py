...
class Device:
    ...
    active_power: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ActivePower') }})
    active_power_l1: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ActivePowerL1') }})
    active_power_l2: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ActivePowerL2') }})
    active_power_l3: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ActivePowerL3') }})
    active_power_unit: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ActivePowerUnit') }})
    active_tariff: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ActiveTariff') }})
    ...
    analog_output1: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('AnalogOutput1') }})
    analog_output2: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('AnalogOutput2') }})
    charging_station_state: Optional[DeviceChargingStationStateEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ChargingStationState') }})
    ...
    current: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Current') }})
    current_l1: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('CurrentL1') }})
    current_l2: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('CurrentL2') }})
    current_l3: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('CurrentL3') }})
    device_energy_type: Optional[DeviceDeviceEnergyTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('DeviceEnergyType') }})
    digital_input1: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('DigitalInput1') }})
    digital_input2: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('DigitalInput2') }})
    digital_output1: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('DigitalOutput1') }})
    digital_output2: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('DigitalOutput2') }})
    family_type: Optional[DeviceFamilyTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('FamilyType') }})
    flow_rate: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('FlowRate') }})
    id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Id') }})
    meter_sub_type: Optional[DeviceMeterSubTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('MeterSubType') }})
    name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Name') }})
    power_factor: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('PowerFactor') }})
    power_factor_l1: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('PowerFactorL1') }})
    power_factor_l2: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('PowerFactorL2') }})
    power_factor_l3: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('PowerFactorL3') }})
    serial: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Serial') }})
    switch_on: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('SwitchOn') }})
    switch_phase_l1_on: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('SwitchPhaseL1On') }})
    switch_phase_l2_on: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('SwitchPhaseL2On') }})
    switch_phase_l3_on: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('SwitchPhaseL3On') }})
    ...
    voltage: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Voltage') }})
    voltage_l1: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('VoltageL1') }})
    voltage_l2: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('VoltageL2') }})
    voltage_l3: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('VoltageL3') }})
