...
var SDK = /** @class */ (function () {
    ...
    **/
    SDK.prototype.accessTokenPut = function (req, config) {
        var _a;
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.accessTokenPut200ApplicationJsonString = JSON.stringify(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data);
                    }
                    if (utils.MatchContentType(contentType, "application/xml")) {
                        res.accessTokenPut200ApplicationXmlString = JSON.stringify(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data);
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.accessTokenPut200TextJsonString = JSON.stringify(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data);
                    }
                    if (utils.MatchContentType(contentType, "text/xml")) {
                        res.accessTokenPut200TextXmlString = JSON.stringify(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data);
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.accountLogin = function (config) {
        var baseURL = this._serverURL;
    ...
    **/
    SDK.prototype.actionsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ActionsGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/Actions/{id}", req.pathParams);
        var client = this._defaultClient;
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.actionInformations = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.actionInformations = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.additionalDeviceInformationGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AdditionalDeviceInformationGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/AdditionalDeviceInformation/{id}", req.pathParams);
        var client = this._defaultClient;
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.additionalDeviceInformation = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.additionalDeviceInformation = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
     ...
     * Gets all Devices
    **/
    SDK.prototype.customDeviceGet = function (config) {
        var baseURL = this._serverURL;
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.customDeviceToPosts = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.customDeviceToPosts = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.deviceBySerialGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.devicesByEnergyGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DevicesByEnergyGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/api/DevicesByEnergy";
        var client = this._defaultClient;
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    SDK.prototype.devicesBySubTypeGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DevicesBySubTypeGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/api/DevicesBySubType";
        var client = this._defaultClient;
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
     ...
     * Gets all Devices
    **/
    SDK.prototype.devicesGet = function (config) {
        var baseURL = this._serverURL;
    ...
    **/
    SDK.prototype.devicesPost = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.deviceToPost = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.deviceToPost = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
     ...
     *             For new implementations please use the "actions" command
    **/
    SDK.prototype.devicesPut = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DevicesPutRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/Devices/{id}", req.pathParams);
        var client = this._defaultClient;
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    SDK.prototype.fastSendDeviceValuesGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.FastSendDeviceValuesGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/FastSendDeviceValues/{id}", req.pathParams);
        var client = this._defaultClient;
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
    ...
    **/
    SDK.prototype.folderAssignPost = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.folderMenuGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.folderMenuConfiguration = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.folderMenuConfiguration = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.folderSettingsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.FolderSettingsDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/folder/settings/{id}", req.pathParams);
        var client = this._defaultClient;
        return client
    ...
    **/
    SDK.prototype.folderSettingsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.folderSettings = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.folderSettings = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.folderSettingsPost = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.folderMenuItem = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.folderMenuItem = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.folderGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.FolderGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/Folder/{id}", req.pathParams);
        var client = this._defaultClient;
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.folderData = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.folderData = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.getApiCustomDeviceId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetApiCustomDeviceIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/CustomDevice/{id}", req.pathParams);
        var client = this._defaultClient;
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.customDeviceToPost = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.customDeviceToPost = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
     ...
     * Gets a Device by it's ID
    **/
    SDK.prototype.getApiDevicesId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.getApiVirtualTariffId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetApiVirtualTariffIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/VirtualTariff/{id}", req.pathParams);
        var client = this._defaultClient;
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.virtualTariffsOfFolder = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.virtualTariffsOfFolder = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.getApiPicoLoadmanagementgroup = function (config) {
        var baseURL = this._serverURL;
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.picoLoadmanagementGroupDtos = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.picoLoadmanagementGroupDtos = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.healthGet = function (config) {
        var baseURL = this._serverURL;
     ...
     *             Just send us the M-BUS Telegram (RSP_UD) and we will do the Rest.
    **/
    SDK.prototype.mBusPost = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.MBusPostRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/api/MBus";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    SDK.prototype.meterFolderInformationGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.MeterFolderInformationGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/MeterFolderInformation/{id}", req.pathParams);
        var client = this._defaultClient;
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.meterFolderInformation = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.meterFolderInformation = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.meterFolderInformationPost = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.meterValuesGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.MeterValuesGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/MeterValues/{id}", req.pathParams);
        var client = this._defaultClient;
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.deviceInPast = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.deviceInPast = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    SDK.prototype.oAuthAuthorize = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.postApiAccountLogin = function (config) {
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/api/Account/login";
        var client = this._defaultClient;
        return client
    ...
    SDK.prototype.postApiOauthAuthorize = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.picoChargingHistoryGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PicoChargingHistoryGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/pico/history/{id}", req.pathParams);
        var client = this._defaultClient;
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.picoChargingHistoryData = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.picoChargingHistoryData = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.picoChargingGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PicoChargingGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/pico/charging/{id}", req.pathParams);
        var client = this._defaultClient;
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.picoChargingData = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.picoChargingData = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.picoLoadmanagementGroupGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PicoLoadmanagementGroupGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/pico/loadmanagementgroup/{id}", req.pathParams);
        var client = this._defaultClient;
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.picoLoadmanagementGroupDto = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.picoLoadmanagementGroupDto = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.picoLoadmanagementSetDynamicCurrentPost = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PicoLoadmanagementSetDynamicCurrentPostRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/pico/loadmanagementgroup/current/{serial}", req.pathParams);
        var client = this._defaultClient;
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    SDK.prototype.picoSettingsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PicoSettingsGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/pico/settings/{id}", req.pathParams);
        var client = this._defaultClient;
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.picoSettingsDto = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.picoSettingsDto = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.registerForRealtimeApiDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RegisterForRealtimeApiDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/RegisterForRealtimeApi/{id}", req.pathParams);
        var client = this._defaultClient;
        return client
            .request(__assign({ url: url, method: "delete" }, config)).then(function (httpRes) {
            var _a, _b;
    ...
    **/
    SDK.prototype.registerForRealtimeApiGet = function (config) {
        var baseURL = this._serverURL;
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.registerRealtimeApiData = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.registerRealtimeApiData = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.registerForRealtimeApiPost = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.smartMeDeviceConfigurationGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.SmartMeDeviceConfigurationGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/SmartMeDeviceConfiguration/{id}", req.pathParams);
        var client = this._defaultClient;
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.smartMeDeviceConfigurationContainer = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.smartMeDeviceConfigurationContainer = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.subUserDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.SubUserDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/SubUser/{id}", req.pathParams);
        var client = this._defaultClient;
        return client
            .request(__assign({ url: url, method: "delete" }, config)).then(function (httpRes) {
            var _a, _b;
    ...
    **/
    SDK.prototype.subUserGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.subUserData = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.subUserData = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.subUserPost = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.SubUserPostRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/api/SubUser";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    SDK.prototype.userToFolderAssignDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.userToFolderAssignPost = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.valuesInPastMultipleGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ValuesInPastMultipleGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/ValuesInPastMultiple/{id}", req.pathParams);
        var client = this._defaultClient;
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.valuesData = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.valuesData = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.valuesInPastGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ValuesInPastGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/ValuesInPast/{id}", req.pathParams);
        var client = this._defaultClient;
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    SDK.prototype.valuesGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ValuesGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/Values/{id}", req.pathParams);
        var client = this._defaultClient;
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
    ...
    **/
    SDK.prototype.virtualBillingMeterActiveGet = function (config) {
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/api/VirtualBillingMeterActive";
        var client = this._defaultClient;
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
    ...
    **/
    SDK.prototype.virtualBillingMeterActivePost = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.virtualBillingMeterDeactivatePost = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.virtualBillingMetersGet = function (config) {
        var baseURL = this._serverURL;
    ...
    **/
    SDK.prototype.virtualMeterCalculateFormulaGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.virtualTariffConsumptionGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.virtualTariffConsumptionData = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.virtualTariffConsumptionData = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.virtualTariffGet = function (config) {
        var baseURL = this._serverURL;
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.virtualTariffsOfFolders = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.virtualTariffsOfFolders = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.virtualTariffsForPropertyGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.VirtualTariffsForPropertyGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/VirtualTariffsForProperty/{id}", req.pathParams);
        var client = this._defaultClient;
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
