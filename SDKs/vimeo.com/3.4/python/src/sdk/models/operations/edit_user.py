...
class EditUserRequestBodyVideosPrivacy:
    ...
    comments: Optional[EditUserRequestBodyVideosPrivacyCommentsEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'comments' }})
    download: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'download' }})
    embed: Optional[EditUserRequestBodyVideosPrivacyEmbedEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'embed' }})
    view: Optional[EditUserRequestBodyVideosPrivacyViewEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'view' }})
    

@dataclass_json
@dataclass
class EditUserRequestBodyVideos:
    privacy: Optional[EditUserRequestBodyVideosPrivacy] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'privacy' }})
...
class EditUserRequestBody:
    ...
    videos: Optional[EditUserRequestBodyVideos] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'videos' }})
    

@dataclass
class EditUserRequest:
    path_params: EditUserPathParams = field(default=None)
