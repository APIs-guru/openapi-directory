...
class UploadVideoRequestBodyEmbedLogos:
    custom: Optional[UploadVideoRequestBodyEmbedLogosCustom] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'custom' }})
...
class UploadVideoRequestBodyEmbedTitle:
    name: Optional[UploadVideoRequestBodyEmbedTitleNameEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'name' }})
    owner: Optional[UploadVideoRequestBodyEmbedTitleOwnerEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'owner' }})
    portrait: Optional[UploadVideoRequestBodyEmbedTitlePortraitEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'portrait' }})
    

@dataclass_json
@dataclass
class UploadVideoRequestBodyEmbed:
    buttons: Optional[UploadVideoRequestBodyEmbedButtons] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'buttons' }})
    color: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'color' }})
    logos: Optional[UploadVideoRequestBodyEmbedLogos] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'logos' }})
    playbar: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'playbar' }})
    title: Optional[UploadVideoRequestBodyEmbedTitle] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'title' }})
...
class UploadVideoRequestBodyPrivacy:
    ...
    comments: Optional[UploadVideoRequestBodyPrivacyCommentsEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'comments' }})
    download: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'download' }})
    embed: Optional[UploadVideoRequestBodyPrivacyEmbedEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'embed' }})
    view: Optional[UploadVideoRequestBodyPrivacyViewEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'view' }})
...
class UploadVideoRequestBodyRatingsMpaa:
    reason: Optional[UploadVideoRequestBodyRatingsMpaaReasonEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'reason' }})
...
class UploadVideoRequestBodyRatingsTv:
    reason: Optional[UploadVideoRequestBodyRatingsTvReasonEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'reason' }})
    

@dataclass_json
@dataclass
class UploadVideoRequestBodyRatings:
    mpaa: Optional[UploadVideoRequestBodyRatingsMpaa] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'mpaa' }})
    tv: Optional[UploadVideoRequestBodyRatingsTv] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'tv' }})
...
class UploadVideoRequestBodySpatial:
    director_timeline: Optional[List[UploadVideoRequestBodySpatialDirectorTimeline]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'director_timeline' }})
    field_of_view: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'field_of_view' }})
    projection: Optional[UploadVideoRequestBodySpatialProjectionEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'projection' }})
    stereo_format: Optional[UploadVideoRequestBodySpatialStereoFormatEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'stereo_format' }})
...
class UploadVideoRequestBodyUpload:
    approach: UploadVideoRequestBodyUploadApproachEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'approach' }})
    link: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'link' }})
...
class UploadVideoRequestBody:
    ...
    embed: Optional[UploadVideoRequestBodyEmbed] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'embed' }})
    license: Optional[UploadVideoRequestBodyLicenseEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'license' }})
    locale: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'locale' }})
    name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'name' }})
    password: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'password' }})
    privacy: Optional[UploadVideoRequestBodyPrivacy] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'privacy' }})
    ratings: Optional[UploadVideoRequestBodyRatings] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ratings' }})
    review_page: Optional[UploadVideoRequestBodyReviewPage] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'review_page' }})
    spatial: Optional[UploadVideoRequestBodySpatial] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'spatial' }})
    upload: UploadVideoRequestBodyUpload = field(default=None, metadata={'dataclasses_json': { 'field_name': 'upload' }})
    

@dataclass
class UploadVideoRequest:
    path_params: UploadVideoPathParams = field(default=None)
    request: UploadVideoRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/vnd.vimeo.video+json' }})
