...
class EditVideoRequestBodyEmbedLogos:
    custom: Optional[EditVideoRequestBodyEmbedLogosCustom] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('custom') }})
...
class EditVideoRequestBodyEmbedTitle:
    name: Optional[EditVideoRequestBodyEmbedTitleNameEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('name') }})
    owner: Optional[EditVideoRequestBodyEmbedTitleOwnerEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('owner') }})
    portrait: Optional[EditVideoRequestBodyEmbedTitlePortraitEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('portrait') }})
    

@dataclass_json
@dataclass
class EditVideoRequestBodyEmbed:
    buttons: Optional[EditVideoRequestBodyEmbedButtons] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('buttons') }})
    color: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('color') }})
    logos: Optional[EditVideoRequestBodyEmbedLogos] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('logos') }})
    playbar: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('playbar') }})
    title: Optional[EditVideoRequestBodyEmbedTitle] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('title') }})
...
class EditVideoRequestBodyPrivacy:
    ...
    comments: Optional[EditVideoRequestBodyPrivacyCommentsEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('comments') }})
    download: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('download') }})
    embed: Optional[EditVideoRequestBodyPrivacyEmbedEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('embed') }})
    view: Optional[EditVideoRequestBodyPrivacyViewEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('view') }})
...
class EditVideoRequestBodyRatingsMpaa:
    reason: Optional[EditVideoRequestBodyRatingsMpaaReasonEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('reason') }})
...
class EditVideoRequestBodyRatingsTv:
    reason: Optional[EditVideoRequestBodyRatingsTvReasonEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('reason') }})
    

@dataclass_json
@dataclass
class EditVideoRequestBodyRatings:
    mpaa: Optional[EditVideoRequestBodyRatingsMpaa] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('mpaa') }})
    tv: Optional[EditVideoRequestBodyRatingsTv] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tv') }})
...
class EditVideoRequestBodySpatial:
    director_timeline: Optional[List[EditVideoRequestBodySpatialDirectorTimeline]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('director_timeline') }})
    field_of_view: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('field_of_view') }})
    projection: Optional[EditVideoRequestBodySpatialProjectionEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('projection') }})
    stereo_format: Optional[EditVideoRequestBodySpatialStereoFormatEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('stereo_format') }})
...
class EditVideoRequestBody:
    ...
    embed: Optional[EditVideoRequestBodyEmbed] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('embed') }})
    license: Optional[EditVideoRequestBodyLicenseEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('license') }})
    ...
    privacy: Optional[EditVideoRequestBodyPrivacy] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('privacy') }})
    ratings: Optional[EditVideoRequestBodyRatings] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ratings') }})
    review_page: Optional[EditVideoRequestBodyReviewPage] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('review_page') }})
    spatial: Optional[EditVideoRequestBodySpatial] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('spatial') }})
...
class EditVideoRequest:
    path_params: EditVideoPathParams = field()
    request: EditVideoRequestBody = field(metadata={'request': { 'media_type': 'application/vnd.vimeo.video+json' }})
    security: EditVideoSecurity = field()
