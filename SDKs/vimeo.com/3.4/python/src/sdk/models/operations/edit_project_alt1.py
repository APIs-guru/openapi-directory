...
class EditProjectAlt1Request:
    path_params: EditProjectAlt1PathParams = field()
    request: EditProjectAlt1RequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
    security: EditProjectAlt1Security = field()
