...
func NewAlbumsEssentials(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *AlbumsEssentials {
...
func (s *AlbumsEssentials) GetAlbumsAlt1(ctx context.Context, request operations.GetAlbumsAlt1Request) (*operations.GetAlbumsAlt1Response, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/me/albums"
