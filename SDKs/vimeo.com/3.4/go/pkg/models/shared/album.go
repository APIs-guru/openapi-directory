...
type AlbumCustomLogoTypeEnum string

const (
	AlbumCustomLogoTypeEnumCaution AlbumCustomLogoTypeEnum = "caution"
	AlbumCustomLogoTypeEnumCustom  AlbumCustomLogoTypeEnum = "custom"
	AlbumCustomLogoTypeEnumDefault AlbumCustomLogoTypeEnum = "default"
)
...
type Album struct {
	...
	CustomLogo          AlbumCustomLogoPicture `json:"custom_logo"`
