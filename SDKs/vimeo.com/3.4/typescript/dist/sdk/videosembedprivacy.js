...
var VideosEmbedPrivacy = /** @class */ (function () {
    function VideosEmbedPrivacy(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    VideosEmbedPrivacy.prototype.addVideoPrivacyDomain = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AddVideoPrivacyDomainRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/videos/{video_id}/privacy/domains/{domain}", req.pathParams);
    ...
    **/
    VideosEmbedPrivacy.prototype.deleteVideoPrivacyDomain = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    VideosEmbedPrivacy.prototype.getVideoPrivacyDomains = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetVideoPrivacyDomainsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/videos/{video_id}/privacy/domains", req.pathParams);
        var client = this._securityClient;
