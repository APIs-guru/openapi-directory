...
var ProjectsVideos = /** @class */ (function () {
    ...
    **/
    ProjectsVideos.prototype.addVideoToProject = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AddVideoToProjectRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/users/{user_id}/projects/{project_id}/videos/{video_id}", req.pathParams);
     ...
     * This method adds a single video to the specified project.
    **/
    ProjectsVideos.prototype.addVideoToProjectAlt1 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AddVideoToProjectAlt1Request(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/me/projects/{project_id}/videos/{video_id}", req.pathParams);
        var client = this._securityClient;
        return client
            .request(__assign({ url: url, method: "put" }, config)).then(function (httpRes) {
            var _a, _b;
    ...
    **/
    ProjectsVideos.prototype.addVideosToProject = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AddVideosToProjectRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/users/{user_id}/projects/{project_id}/videos", req.pathParams);
        var client = this._securityClient;
     ...
     * This method adds multiple videos to the specified project.
    **/
    ProjectsVideos.prototype.addVideosToProjectAlt1 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AddVideosToProjectAlt1Request(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/me/projects/{project_id}/videos", req.pathParams);
        var client = this._securityClient;
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    ProjectsVideos.prototype.getProjectVideos = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * This method gets all the videos that belong to the specified project.
    **/
    ProjectsVideos.prototype.getProjectVideosAlt1 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ProjectsVideos.prototype.removeVideoFromProject = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * This method removes a single video from the specified project.
    **/
    ProjectsVideos.prototype.removeVideoFromProjectAlt1 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ProjectsVideos.prototype.removeVideosFromProject = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * This method removed multiple videos from the specified project.
    **/
    ProjectsVideos.prototype.removeVideosFromProjectAlt1 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
