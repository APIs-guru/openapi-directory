...
var ChannelsTags = /** @class */ (function () {
    ...
    **/
    ChannelsTags.prototype.addChannelTag = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AddChannelTagRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/channels/{channel_id}/tags/{word}", req.pathParams);
    ...
    **/
    ChannelsTags.prototype.addTagsToChannel = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AddTagsToChannelRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/channels/{channel_id}/tags", req.pathParams);
    ...
    **/
    ChannelsTags.prototype.deleteTagFromChannel = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
