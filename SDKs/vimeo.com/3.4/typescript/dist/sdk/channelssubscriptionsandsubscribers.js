...
var ChannelsSubscriptionsAndSubscribers = /** @class */ (function () {
    function ChannelsSubscriptionsAndSubscribers(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    ChannelsSubscriptionsAndSubscribers.prototype.checkIfUserSubscribedToChannel = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CheckIfUserSubscribedToChannelRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/users/{user_id}/channels/{channel_id}", req.pathParams);
    ...
    **/
    ChannelsSubscriptionsAndSubscribers.prototype.checkIfUserSubscribedToChannelAlt1 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CheckIfUserSubscribedToChannelAlt1Request(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/me/channels/{channel_id}", req.pathParams);
        var client = this._securityClient;
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
    ...
    **/
    ChannelsSubscriptionsAndSubscribers.prototype.getChannelSubscribers = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetChannelSubscribersRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/channels/{channel_id}/users", req.pathParams);
        var client = this._securityClient;
    ...
    **/
    ChannelsSubscriptionsAndSubscribers.prototype.subscribeToChannel = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ChannelsSubscriptionsAndSubscribers.prototype.subscribeToChannelAlt1 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ChannelsSubscriptionsAndSubscribers.prototype.unsubscribeFromChannel = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ChannelsSubscriptionsAndSubscribers.prototype.unsubscribeFromChannelAlt1 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
...
export { ChannelsSubscriptionsAndSubscribers };
