...
var PortfoliosVideos = /** @class */ (function () {
    function PortfoliosVideos(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    PortfoliosVideos.prototype.addVideoToPortfolio = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AddVideoToPortfolioRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/users/{user_id}/portfolios/{portfolio_id}/videos/{video_id}", req.pathParams);
    ...
    **/
    PortfoliosVideos.prototype.addVideoToPortfolioAlt1 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AddVideoToPortfolioAlt1Request(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/me/portfolios/{portfolio_id}/videos/{video_id}", req.pathParams);
        var client = this._securityClient;
        return client
            .request(__assign({ url: url, method: "put" }, config)).then(function (httpRes) {
            var _a, _b;
    ...
    **/
    PortfoliosVideos.prototype.deleteVideoFromPortfolio = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    PortfoliosVideos.prototype.deleteVideoFromPortfolioAlt1 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    PortfoliosVideos.prototype.getPortfolioVideo = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    PortfoliosVideos.prototype.getPortfolioVideoAlt1 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    PortfoliosVideos.prototype.getPortfolioVideos = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetPortfolioVideosRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/users/{user_id}/portfolios/{portfolio_id}/videos", req.pathParams);
        var client = this._securityClient;
    ...
    **/
    PortfoliosVideos.prototype.getPortfolioVideosAlt1 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetPortfolioVideosAlt1Request(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/me/portfolios/{portfolio_id}/videos", req.pathParams);
        var client = this._securityClient;
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
