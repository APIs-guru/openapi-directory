...
var VideosTextTracks = /** @class */ (function () {
    ...
    **/
    VideosTextTracks.prototype.createTextTrack = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreateTextTrackRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/videos/{video_id}/texttracks", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.MatchContentType(contentType, "application/vnd.vimeo.video.texttrack+json")) {
                        res.textTrack = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
     ...
     * For additional information, see our [text track upload guide](https://developer.vimeo.com/api/upload/texttracks).
    **/
    VideosTextTracks.prototype.createTextTrackAlt1 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreateTextTrackAlt1Request(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/channels/{channel_id}/videos/{video_id}/texttracks", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    VideosTextTracks.prototype.deleteTextTrack = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteTextTrackRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/videos/{video_id}/texttracks/{texttrack_id}", req.pathParams);
        var client = this._securityClient;
        return client
    ...
    **/
    VideosTextTracks.prototype.editTextTrack = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    VideosTextTracks.prototype.getTextTracks = function (req, config) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/vnd.vimeo.video.texttrack+json")) {
                        res.textTracks = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 404:
                    if (utils.MatchContentType(contentType, "application/vnd.vimeo.video.texttrack+json")) {
