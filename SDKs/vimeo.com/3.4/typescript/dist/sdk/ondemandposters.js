...
var OnDemandPosters = /** @class */ (function () {
    ...
    **/
    OnDemandPosters.prototype.addVodPoster = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AddVodPosterRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/ondemand/pages/{ondemand_id}/pictures", req.pathParams);
    ...
    **/
    OnDemandPosters.prototype.editVodPoster = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.EditVodPosterRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/ondemand/pages/{ondemand_id}/pictures/{poster_id}", req.pathParams);
