...
var ProjectsEssentials = /** @class */ (function () {
    ...
    **/
    ProjectsEssentials.prototype.createProject = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreateProjectRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/users/{user_id}/projects", req.pathParams);
     ...
     * This method creates a new project for the specified user.
    **/
    ProjectsEssentials.prototype.createProjectAlt1 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ProjectsEssentials.prototype.deleteProject = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteProjectRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/users/{user_id}/projects/{project_id}", req.pathParams);
        var client = this._securityClient;
     ...
     * This method deletes a project and optionally also the videos that it contains.
    **/
    ProjectsEssentials.prototype.deleteProjectAlt1 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteProjectAlt1Request(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/me/projects/{project_id}", req.pathParams);
        var client = this._securityClient;
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    ProjectsEssentials.prototype.editProject = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * This method edits an existing project.
    **/
    ProjectsEssentials.prototype.editProjectAlt1 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ProjectsEssentials.prototype.getProject = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * This method gets a single project that belongs to the specified user.
    **/
    ProjectsEssentials.prototype.getProjectAlt1 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ProjectsEssentials.prototype.getProjects = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * This method gets all the projects that belong to the specified user.
    **/
    ProjectsEssentials.prototype.getProjectsAlt1 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
