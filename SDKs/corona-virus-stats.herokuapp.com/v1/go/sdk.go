...
func (s *SDK) CasesGeneralStatsList(ctx context.Context) (*operations.CasesGeneralStatsListResponse, error) {
...
func (s *SDK) CasesSearch(ctx context.Context, request operations.CasesSearchRequest) (*operations.CasesSearchResponse, error) {
	baseURL := s._serverURL
...
func (s *SDK) DocsList(ctx context.Context) (*operations.DocsListResponse, error) {
	baseURL := s._serverURL
