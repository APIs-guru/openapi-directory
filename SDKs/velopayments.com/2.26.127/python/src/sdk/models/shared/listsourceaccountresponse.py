...
from . import sourceaccountresponse


@dataclass_json
@dataclass
class ListSourceAccountResponse:
    content: Optional[List[sourceaccountresponse.SourceAccountResponse]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'content' }})
