...
@dataclass
class FailedPayee2:
    address: Optional[createpayeeaddress_2.CreatePayeeAddress2] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'address' }})
    ...
    type: Optional[payeetype_enum.PayeeTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'type' }})
