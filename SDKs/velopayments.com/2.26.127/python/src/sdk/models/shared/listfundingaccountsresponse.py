...
from . import fundingaccountresponse


@dataclass_json
@dataclass
class ListFundingAccountsResponse:
    content: Optional[List[fundingaccountresponse.FundingAccountResponse]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'content' }})
