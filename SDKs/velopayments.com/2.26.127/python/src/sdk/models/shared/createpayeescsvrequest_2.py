...
class CreatePayeesCsvRequest2:
    ...
    address_country: CreatePayeesCsvRequest2AddressCountryEnum = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('addressCountry') }})
    ...
    payment_channel_country_code: Optional[CreatePayeesCsvRequest2PaymentChannelCountryCodeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('paymentChannelCountryCode') }})
    payment_channel_currency: Optional[CreatePayeesCsvRequest2PaymentChannelCurrencyEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('paymentChannelCurrency') }})
