...
class PayorV1:
    ...
    address: Optional[PayorAddress] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('address') }})
    ...
    funding_account_account_name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('fundingAccountAccountName') }})
    funding_account_account_number: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('fundingAccountAccountNumber') }})
    funding_account_routing_number: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('fundingAccountRoutingNumber') }})
    ...
    language: Optional[PayorV1LanguageEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('language') }})
    ...
    transmission_types: Optional[TransmissionTypes] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('transmissionTypes') }})
