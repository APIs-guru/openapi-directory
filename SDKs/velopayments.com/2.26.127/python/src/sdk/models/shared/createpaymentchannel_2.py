...
class CreatePaymentChannel2:
    ...
    country_code: CreatePaymentChannel2CountryCodeEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'countryCode' }})
    currency: CreatePaymentChannel2CurrencyEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'currency' }})
