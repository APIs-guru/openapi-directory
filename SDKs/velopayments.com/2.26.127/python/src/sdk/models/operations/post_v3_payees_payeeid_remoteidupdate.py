...
class PostV3PayeesPayeeIDRemoteIDUpdateRequest:
    path_params: PostV3PayeesPayeeIDRemoteIDUpdatePathParams = field(default=None)
    request: shared.UpdateRemoteIDRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
