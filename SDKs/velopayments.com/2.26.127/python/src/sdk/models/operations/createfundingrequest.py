...
class CreateFundingRequestRequest:
    path_params: CreateFundingRequestPathParams = field(default=None)
    request: shared.FundingRequestV2 = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
