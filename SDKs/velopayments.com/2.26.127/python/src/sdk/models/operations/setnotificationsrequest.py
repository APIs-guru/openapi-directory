...
class SetNotificationsRequestRequest:
    path_params: SetNotificationsRequestPathParams = field(default=None)
    request: shared.SetNotificationsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
