...
class PayeeDetailsUpdateV4Request:
    path_params: PayeeDetailsUpdateV4PathParams = field(default=None)
    request: shared.UpdatePayeeDetailsRequest2 = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
