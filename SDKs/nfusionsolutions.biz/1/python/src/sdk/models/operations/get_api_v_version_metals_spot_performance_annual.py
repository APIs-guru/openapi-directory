...
class GetAPIVVersionMetalsSpotPerformanceAnnualRequest:
    path_params: GetAPIVVersionMetalsSpotPerformanceAnnualPathParams = field(default=None)
    query_params: GetAPIVVersionMetalsSpotPerformanceAnnualQueryParams = field(default=None)
