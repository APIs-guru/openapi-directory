...
class UserStatisticsAccumulatedValueV1StatisticsIndividualRequest:
    query_params: UserStatisticsAccumulatedValueV1StatisticsIndividualQueryParams = field(default=None)
...
class UserStatisticsAccumulatedValueV1StatisticsIndividual200ApplicationJSON:
    ...
    result: Optional[UserStatisticsAccumulatedValueV1StatisticsIndividual200ApplicationJSONResult] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Result' }})
