...
class OnetrackGetResponses200ContentApplication1jsonSchemaPropertiesOrigin:
    ...
    geometry: OnetrackGetResponses200ContentApplication1jsonSchemaPropertiesOriginGeometry = field(default=None, metadata={'dataclasses_json': { 'field_name': 'geometry' }})
