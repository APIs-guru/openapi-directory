...
class OneordersPostResponses201ContentApplication1jsonSchemaPropertiesOriginalConsignee:
    ...
    iso: Optional[OneordersPostResponses201ContentApplication1jsonSchemaPropertiesOriginalConsigneeIsoCountryV2] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'iso' }})
