...
class OneordersPostResponses201ContentApplication1jsonSchemaPropertiesOriginalConsignee:
    ...
    iso: Optional[OneordersPostResponses201ContentApplication1jsonSchemaPropertiesOriginalConsigneeIsoCountryV2] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('iso') }})
