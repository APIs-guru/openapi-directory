...
class GetReturnsReturnsArrayV2ReturnV2RmaItemV2:
    ...
    id: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'id' }})
    item: Optional[GetReturnsReturnsArrayV2ReturnV2RmaItemV2Item] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'item' }})
    non_restocked_reason: Optional[GetReturnsReturnsArrayV2ReturnV2RmaItemV2NonRestockedReason] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'nonRestockedReason' }})
...
class GetReturnsReturnsArrayV2ReturnV2:
    ...
    id: int = field(default=None, metadata={'dataclasses_json': { 'field_name': 'id' }})
    order: Optional[GetReturnsReturnsArrayV2ReturnV2Order] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'order' }})
    reason: GetReturnsReturnsArrayV2ReturnV2Reason = field(default=None, metadata={'dataclasses_json': { 'field_name': 'reason' }})
    returned_by: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'returnedBy' }})
    rma_items: Optional[List[GetReturnsReturnsArrayV2ReturnV2RmaItemV2]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'rmaItems' }})
    rma_number: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'rmaNumber' }})
    status: GetReturnsReturnsArrayV2ReturnV2Status = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
    ...
    updated_by: GetReturnsReturnsArrayV2ReturnV2UserV2 = field(default=None, metadata={'dataclasses_json': { 'field_name': 'updatedBy' }})
...
class GetReturnsReturnsArrayV2Meta:
    pagination: Optional[GetReturnsReturnsArrayV2MetaPaginationV2] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'pagination' }})
    

@dataclass_json
@dataclass
class GetReturnsReturnsArrayV2:
    data: Optional[List[GetReturnsReturnsArrayV2ReturnV2]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'data' }})
    meta: Optional[GetReturnsReturnsArrayV2Meta] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'meta' }})
