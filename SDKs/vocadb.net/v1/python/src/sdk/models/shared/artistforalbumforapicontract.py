...
class ArtistForAlbumForAPIContract:
    ...
    categories: Optional[ArtistForAlbumForAPIContractCategoriesEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'categories' }})
    effective_roles: Optional[ArtistForAlbumForAPIContractEffectiveRolesEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'effectiveRoles' }})
    is_support: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'isSupport' }})
    name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'name' }})
    roles: Optional[ArtistForAlbumForAPIContractRolesEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'roles' }})
