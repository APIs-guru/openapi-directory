...
from . import albumforuserforapicontract


@dataclass_json
@dataclass
class PartialFindResultAlbumForUserForAPIContract:
    items: Optional[List[albumforuserforapicontract.AlbumForUserForAPIContract]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'items' }})
