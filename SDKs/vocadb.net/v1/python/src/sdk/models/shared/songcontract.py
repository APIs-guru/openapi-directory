...
class SongContract:
    ...
    nico_id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'nicoId' }})
    ...
    pv_services: Optional[SongContractPvServicesEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'pvServices' }})
    rating_score: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ratingScore' }})
    song_type: Optional[SongContractSongTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'songType' }})
    status: Optional[SongContractStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
