...
class PvForSongContract:
    ...
    pv_type: Optional[PvForSongContractPvTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'pvType' }})
    service: Optional[PvForSongContractServiceEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'service' }})
    song: Optional[songcontract.SongContract] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'song' }})
