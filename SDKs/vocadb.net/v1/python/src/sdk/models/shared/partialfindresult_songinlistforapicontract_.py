...
from . import songinlistforapicontract


@dataclass_json
@dataclass
class PartialFindResultSongInListForAPIContract:
    items: Optional[List[songinlistforapicontract.SongInListForAPIContract]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'items' }})
