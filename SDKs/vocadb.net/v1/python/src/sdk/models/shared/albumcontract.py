...
class AlbumContract:
    ...
    cover_picture_mime: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'coverPictureMime' }})
    ...
    disc_type: Optional[AlbumContractDiscTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'discType' }})
    ...
    status: Optional[AlbumContractStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
