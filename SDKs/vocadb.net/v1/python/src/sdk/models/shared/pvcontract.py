...
class PvContract:
    ...
    pv_type: Optional[PvContractPvTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('pvType') }})
    service: Optional[PvContractServiceEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('service') }})
