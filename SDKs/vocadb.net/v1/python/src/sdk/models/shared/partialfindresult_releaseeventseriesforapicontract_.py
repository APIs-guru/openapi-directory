...
from . import releaseeventseriesforapicontract


@dataclass_json
@dataclass
class PartialFindResultReleaseEventSeriesForAPIContract:
    items: Optional[List[releaseeventseriesforapicontract.ReleaseEventSeriesForAPIContract]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'items' }})
