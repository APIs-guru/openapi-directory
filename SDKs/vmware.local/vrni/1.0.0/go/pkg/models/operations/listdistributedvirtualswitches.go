...
type ListDistributedVirtualSwitchesQueryParams struct {
...
type ListDistributedVirtualSwitchesSecurity struct {
	APIKeyAuth shared.SchemeAPIKeyAuth `security:"scheme,type=apiKey,subtype=header"`
}

type ListDistributedVirtualSwitchesRequest struct {
	QueryParams ListDistributedVirtualSwitchesQueryParams
	Security    ListDistributedVirtualSwitchesSecurity
}

type ListDistributedVirtualSwitchesResponse struct {
