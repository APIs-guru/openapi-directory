...
class GetServiceGroupRequest:
    path_params: GetServiceGroupPathParams = field(default=None)
    query_params: GetServiceGroupQueryParams = field(default=None)
    security: GetServiceGroupSecurity = field(default=None)
