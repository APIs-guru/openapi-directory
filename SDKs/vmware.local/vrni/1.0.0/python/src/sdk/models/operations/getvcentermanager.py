...
class GetVcenterManagerRequest:
    path_params: GetVcenterManagerPathParams = field(default=None)
    query_params: GetVcenterManagerQueryParams = field(default=None)
    security: GetVcenterManagerSecurity = field(default=None)
