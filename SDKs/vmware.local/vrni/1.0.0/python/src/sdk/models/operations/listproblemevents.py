...
@dataclass
class ListProblemEventsQueryParams:
...
@dataclass
class ListProblemEventsRequest:
    query_params: ListProblemEventsQueryParams = field(default=None)
    security: ListProblemEventsSecurity = field(default=None)
