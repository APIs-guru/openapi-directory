...
from . import ciscoswitchtype_enum
...
class CiscoSwitchDataSource:
    ...
    switch_type: Optional[ciscoswitchtype_enum.CiscoSwitchTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'switch_type' }})
