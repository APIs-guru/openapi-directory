...
var GetServicePathParams = /** @class */ (function (_super) {
    ...
    ], GetServicePathParams.prototype, "id", void 0);
    return GetServicePathParams;
}(SpeakeasyBase));
export { GetServicePathParams };
var GetServiceQueryParams = /** @class */ (function (_super) {
    __extends(GetServiceQueryParams, _super);
    ...
    ], GetServiceQueryParams.prototype, "time", void 0);
    return GetServiceQueryParams;
}(SpeakeasyBase));
export { GetServiceQueryParams };
var GetServiceSecurity = /** @class */ (function (_super) {
    ...
    ], GetServiceSecurity.prototype, "apiKeyAuth", void 0);
...
var GetServiceRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", GetServiceQueryParams)
    ], GetServiceRequest.prototype, "queryParams", void 0);
    __decorate([
        SpeakeasyMetadata(),
...
var GetServiceResponse = /** @class */ (function (_super) {
    ...
    ], GetServiceResponse.prototype, "apiError", void 0);
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", shared.BaseService)
    ], GetServiceResponse.prototype, "baseService", void 0);
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", String)
