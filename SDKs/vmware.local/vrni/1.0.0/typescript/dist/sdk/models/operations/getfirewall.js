...
var GetFirewallPathParams = /** @class */ (function (_super) {
    ...
    ], GetFirewallPathParams.prototype, "id", void 0);
    return GetFirewallPathParams;
}(SpeakeasyBase));
export { GetFirewallPathParams };
var GetFirewallQueryParams = /** @class */ (function (_super) {
    __extends(GetFirewallQueryParams, _super);
    function GetFirewallQueryParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=time" }),
        __metadata("design:type", Number)
    ], GetFirewallQueryParams.prototype, "time", void 0);
    return GetFirewallQueryParams;
}(SpeakeasyBase));
export { GetFirewallQueryParams };
var GetFirewallSecurity = /** @class */ (function (_super) {
    ...
    ], GetFirewallSecurity.prototype, "apiKeyAuth", void 0);
...
var GetFirewallRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", GetFirewallQueryParams)
    ], GetFirewallRequest.prototype, "queryParams", void 0);
    __decorate([
        SpeakeasyMetadata(),
...
var GetFirewallResponse = /** @class */ (function (_super) {
    ...
    ], GetFirewallResponse.prototype, "apiError", void 0);
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", shared.BaseFirewallRule)
    ], GetFirewallResponse.prototype, "baseFirewallRule", void 0);
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", String)
