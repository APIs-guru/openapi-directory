...
export class PostTaskForProjectPathParams extends SpeakeasyBase {
...
export class PostTaskForProjectRequests extends SpeakeasyBase {
...
export class PostTaskForProjectRequest extends SpeakeasyBase {
  @Metadata()
...
export class PostTaskForProjectResponse extends SpeakeasyBase {
  @Metadata()
  body?: Uint8Array;
