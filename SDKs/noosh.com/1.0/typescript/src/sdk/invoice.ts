...
export class Invoice {
  ...
  **/
  getInvoice(
    ...
    const url: string = utils.GenerateURL(baseURL, "/v1/workgroups/{workgroup_id}/projects/{project_id}/invoices/{invoice_id}", req.pathParams);
        ...
        switch (true) {
          case httpRes?.status == 200:
            ...
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.invoiceExpandVo = httpRes?.data;
            }
  ...
  **/
  getInvoiceFiles(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/workgroups/{workgroup_id}/projects/{project_id}/invoices/{invoice_id}/files", req.pathParams);
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetInvoiceFilesResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `*/*`)) {
                const resBody: string = JSON.stringify(httpRes?.data, null, 0);
            ...
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.fileListResponseVo = httpRes?.data;
            }
            if (utils.MatchContentType(contentType, `application/x-json-smile`)) {
                res.fileListResponseVo = httpRes?.data;
            }
  ...
  **/
  getInvoices(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/workgroups/{workgroup_id}/projects/{project_id}/invoices/orders/{order_id}", req.pathParams);
      ...
      .request({
        ...
        switch (true) {
          case httpRes?.status == 200:
            ...
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.invoiceDetailListExpandVo = httpRes?.data;
            }
            if (utils.MatchContentType(contentType, `application/x-json-smile`)) {
                res.invoiceDetailListExpandVo = httpRes?.data;
            }
