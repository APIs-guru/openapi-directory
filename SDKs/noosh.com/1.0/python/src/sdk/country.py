...
class Country:
    ...
    def get_country_list(self) -> operations.GetCountryListResponse:
        r"""List all countries
        List all countries
        """
        ...
        res = operations.GetCountryListResponse(status_code=r.status_code, content_type=content_type)
