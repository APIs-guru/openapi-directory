...
func (s *SDK) Facets(ctx context.Context, request operations.FacetsRequest) (*operations.FacetsResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) ID(ctx context.Context, request operations.IDRequest) (*operations.IDResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) OpenSearch(ctx context.Context, request operations.OpenSearchRequest) (*operations.OpenSearchResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) OpensearchDescription(ctx context.Context) (*operations.OpensearchDescriptionResponse, error) {
	baseURL := s.serverURL
