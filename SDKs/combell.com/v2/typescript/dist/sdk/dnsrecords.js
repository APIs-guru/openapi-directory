...
var DnsRecords = /** @class */ (function () {
    ...
    **/
    DnsRecords.prototype.deleteDnsDomainNameRecordsRecordId = function (req, config) {
        ...
        var url = utils.GenerateURL(baseURL, "/dns/{domainName}/records/{recordId}", req.pathParams);
    ...
    **/
    DnsRecords.prototype.getDnsDomainNameRecords = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/dns/{domainName}/records", req.pathParams);
        var client = this._defaultClient;
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.dnsRecords = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    DnsRecords.prototype.getDnsDomainNameRecordsRecordId = function (req, config) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.dnsRecord = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
