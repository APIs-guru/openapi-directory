...
var GetAccountsQueryParams = /** @class */ (function (_super) {
    ...
    ], GetAccountsQueryParams.prototype, "assetType", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=identifier" }),
        __metadata("design:type", String)
    ], GetAccountsQueryParams.prototype, "identifier", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=skip" }),
        __metadata("design:type", Number)
    ], GetAccountsQueryParams.prototype, "skip", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=take" }),
        __metadata("design:type", Number)
    ], GetAccountsQueryParams.prototype, "take", void 0);
