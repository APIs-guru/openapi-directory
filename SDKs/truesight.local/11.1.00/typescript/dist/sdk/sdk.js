...
var SDK = /** @class */ (function () {
    ...
    **/
    SDK.prototype.CollectNow = function (req, config) {
    ...
    **/
    SDK.prototype.GetAgentDevices = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.GetApplications = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetApplicationsRequest(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/hardware/applications";
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    SDK.prototype.GetDeviceAgent = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.GetDeviceEnergyUsage = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * You need to provide a <b>Device ID</b>:<br>- use the <b>hardware/devices</b> service to get all available device IDs.
    **/
    SDK.prototype.GetDeviceMonitors = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.GetDeviceParameterHistory = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.GetDevicesSummary = function (config) {
        var baseURL = this.serverURL;
    ...
    **/
    SDK.prototype.GetGroups = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/hardware/groups";
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    SDK.prototype.GetHeatingMarginCoverage = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.GetHistory = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.GetOneApplication = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetOneApplicationRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/hardware/applications/{applicationId}", req.pathParams);
        var client = this.defaultClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    **/
    SDK.prototype.GetOneGroup = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetOneGroupRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/hardware/groups/{groupId}", req.pathParams);
        var client = this.defaultClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    **/
    SDK.prototype.GetOneService = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.Rediscover = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.Reinitialize = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.Reset = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.UpdateEnergyCost = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
