...
export declare enum SmsUniqueRequestGmtZoneEnum {
...
export declare enum SmsUniqueRequestNumAzurEnum {
    One = "1"
}
export declare class SmsUniqueRequest extends SpeakeasyBase {
    dateEnvoi?: string;
    emetteur?: string;
