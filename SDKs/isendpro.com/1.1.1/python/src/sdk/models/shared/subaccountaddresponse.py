...
class SubaccountAddResponseEtatEtat:
    ...
    sub_account_login: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'subAccountLogin' }})
    

@dataclass_json
@dataclass
class SubaccountAddResponseEtat:
    etat: Optional[List[SubaccountAddResponseEtatEtat]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'etat' }})
    

@dataclass_json
@dataclass
class SubaccountAddResponse:
    etat: Optional[SubaccountAddResponseEtat] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'etat' }})
