...
var Anything = /** @class */ (function () {
    function Anything(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Anything.prototype.deleteAnything = function (config) {
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/anything";
    ...
    **/
    Anything.prototype.deleteAnythingAnything = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteAnythingAnythingRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/anything/{anything}", req.pathParams);
        var client = this._defaultClient;
        return client
            .request(__assign({ url: url, method: "delete" }, config)).then(function (httpRes) {
            var _a, _b;
    ...
    **/
    Anything.prototype.getAnything = function (config) {
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/anything";
        var client = this._defaultClient;
        return client
    ...
    **/
    Anything.prototype.getAnythingAnything = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Anything.prototype.patchAnything = function (config) {
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/anything";
        var client = this._defaultClient;
        return client
    ...
    **/
    Anything.prototype.patchAnythingAnything = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Anything.prototype.postAnything = function (config) {
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/anything";
        var client = this._defaultClient;
        return client
    ...
    **/
    Anything.prototype.postAnythingAnything = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Anything.prototype.putAnything = function (config) {
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/anything";
        var client = this._defaultClient;
        return client
    ...
    **/
    Anything.prototype.putAnythingAnything = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Anything.prototype.traceAnything = function (config) {
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/anything";
        var client = this._defaultClient;
        return client
    ...
    **/
    Anything.prototype.traceAnythingAnything = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
