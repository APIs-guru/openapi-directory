...
var ResponseInspection = /** @class */ (function () {
    function ResponseInspection(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    ResponseInspection.prototype.getCache = function (req, config) {
    ...
    **/
    ResponseInspection.prototype.getCacheValue = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetCacheValueRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/cache/{value}", req.pathParams);
        var client = this._defaultClient;
        return client
    ...
    **/
    ResponseInspection.prototype.getEtagEtag = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetEtagEtagRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/etag/{etag}", req.pathParams);
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "get", headers: headers }, config)).then(function (httpRes) {
    ...
    **/
    ResponseInspection.prototype.getResponseHeaders = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetResponseHeadersRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/response-headers";
        var client = this._defaultClient;
    ...
    **/
    ResponseInspection.prototype.postResponseHeaders = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
