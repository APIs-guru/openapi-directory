...
var DynamicData = /** @class */ (function () {
    function DynamicData(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    DynamicData.prototype.deleteDelayDelay = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteDelayDelayRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/delay/{delay}", req.pathParams);
    ...
    **/
    DynamicData.prototype.getBase64Value = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetBase64ValueRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/base64/{value}", req.pathParams);
        var client = this._defaultClient;
        return client
    ...
    **/
    DynamicData.prototype.getBytesN = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetBytesNRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/bytes/{n}", req.pathParams);
        var client = this._defaultClient;
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
    ...
    **/
    DynamicData.prototype.getDelayDelay = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    DynamicData.prototype.getDrip = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetDripRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/drip";
        var client = this._defaultClient;
    ...
    **/
    DynamicData.prototype.getLinksNOffset = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetLinksNOffsetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/links/{n}/{offset}", req.pathParams);
        var client = this._defaultClient;
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
    ...
    **/
    DynamicData.prototype.getRangeNumbytes = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetRangeNumbytesRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/range/{numbytes}", req.pathParams);
        var client = this._defaultClient;
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
    ...
    **/
    DynamicData.prototype.getStreamBytesN = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetStreamBytesNRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/stream-bytes/{n}", req.pathParams);
        var client = this._defaultClient;
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
    ...
    **/
    DynamicData.prototype.getStreamN = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetStreamNRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/stream/{n}", req.pathParams);
        var client = this._defaultClient;
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
    ...
    **/
    DynamicData.prototype.getUuid = function (config) {
        var baseURL = this._serverURL;
    ...
    **/
    DynamicData.prototype.patchDelayDelay = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    DynamicData.prototype.postDelayDelay = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    DynamicData.prototype.putDelayDelay = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    DynamicData.prototype.traceDelayDelay = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
