...
var HttpMethods = /** @class */ (function () {
    function HttpMethods(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    HttpMethods.prototype.deleteDelete = function (config) {
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/delete";
    ...
    **/
    HttpMethods.prototype.getGet = function (config) {
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/get";
        var client = this._defaultClient;
        return client
    ...
    **/
    HttpMethods.prototype.patchPatch = function (config) {
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/patch";
        var client = this._defaultClient;
        return client
    ...
    **/
    HttpMethods.prototype.postPost = function (config) {
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/post";
        var client = this._defaultClient;
        return client
    ...
    **/
    HttpMethods.prototype.putPut = function (config) {
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/put";
        var client = this._defaultClient;
        return client
