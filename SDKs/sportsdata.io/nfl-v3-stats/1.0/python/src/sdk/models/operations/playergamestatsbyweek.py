...
class PlayerGameStatsByWeekPathParams:
    format: PlayerGameStatsByWeekFormatEnum = field(default=None, metadata={'path_param': { 'field_name': 'format', 'style': 'simple', 'explode': False }})
...
class PlayerGameStatsByWeekRequest:
    path_params: PlayerGameStatsByWeekPathParams = field(default=None)
