...
var SDK = /** @class */ (function () {
    ...
    **/
    SDK.prototype.conferenceHierarchyWithTeams = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.currentSeason = function (req, config) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.currentSeason200ApplicationJsonInteger = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    SDK.prototype.currentSeasonDetails = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CurrentSeasonDetailsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/{format}/CurrentSeasonDetails", req.pathParams);
        var client = this._securityClient;
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
    ...
    **/
    SDK.prototype.currentSeasontype = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CurrentSeasontypeRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/{format}/CurrentSeasonType", req.pathParams);
        var client = this._securityClient;
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.currentSeasontype200ApplicationJsonString = JSON.stringify(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data);
                    }
                    break;
            }
            return res;
    ...
    **/
    SDK.prototype.currentWeek = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.currentWeek200ApplicationJsonInteger = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    SDK.prototype.gamesByWeek = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GamesByWeekRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/{format}/GamesByWeek/{season}/{week}", req.pathParams);
        var client = this._securityClient;
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
    ...
    **/
    SDK.prototype.teamGameStatsByWeek = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.TeamGameStatsByWeekRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/{format}/TeamGameStatsByWeek/{season}/{week}", req.pathParams);
        var client = this._securityClient;
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
    ...
    **/
    SDK.prototype.teamSeasonStatsStandings = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
