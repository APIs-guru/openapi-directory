...
class SDK:
    ...
    def line_combinations_by_season(self, request: operations.LineCombinationsBySeasonRequest) -> operations.LineCombinationsBySeasonResponse:
        ...
        base_url = self.server_url
        url = utils.generate_url(base_url, "/{format}/LinesBySeason/{season}", request.path_params)
        ...
        res = operations.LineCombinationsBySeasonResponse(status_code=r.status_code, content_type=content_type)
