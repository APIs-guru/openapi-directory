...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.BoxScoresByDateByCompetition = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.BoxScoresByDateByCompetitionRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/{format}/BoxScoresByCompetition/{competition}/{date}", req.pathParams);
        var client = this.securityClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.BoxScoresDeltaByDateByCompetition = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.BoxScoresDeltaByDateByCompetitionRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/{format}/BoxScoresDeltaByCompetition/{competition}/{date}/{minutes}", req.pathParams);
        var client = this.securityClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.CompetitionFixturesLeagueDetails = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/{format}/CompetitionDetails/{competition}", req.pathParams);
        var client = this.securityClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.CompetitionHierarchyLeagueHierarchy = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/{format}/CompetitionHierarchy", req.pathParams);
        var client = this.securityClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.MembershipsByCompetitionActive = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/{format}/MembershipsByCompetition/{competition}", req.pathParams);
        var client = this.securityClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.MembershipsByCompetitionHistorical = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/{format}/HistoricalMembershipsByCompetition/{competition}", req.pathParams);
        var client = this.securityClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.MembershipsRecentlyChanged = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/{format}/RecentlyChangedMemberships/{days}", req.pathParams);
        var client = this.securityClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.PlayerSeasonStats = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/{format}/PlayerSeasonStats/{roundid}", req.pathParams);
        var client = this.securityClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.PlayerSeasonStatsByPlayer = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/{format}/PlayerSeasonStatsByPlayer/{roundid}/{playerid}", req.pathParams);
        var client = this.securityClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.PlayerSeasonStatsByTeam = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/{format}/PlayerSeasonStatsByTeam/{roundid}/{team}", req.pathParams);
        var client = this.securityClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.TeamSeasonStats = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/{format}/TeamSeasonStats/{roundid}", req.pathParams);
        var client = this.securityClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.UpcomingDfsSlatesByCompetition = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.UpcomingDfsSlatesByCompetitionRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/{format}/UpcomingDfsSlatesByCompetition/{competitionId}", req.pathParams);
        var client = this.securityClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.UpcomingScheduleByPlayer = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/{format}/UpcomingScheduleByPlayer/{playerid}", req.pathParams);
        var client = this.securityClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
