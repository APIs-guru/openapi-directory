...
class GetAPIV2ListMarketsRequest:
    headers: GetAPIV2ListMarketsHeaders = field(default=None)
...
class GetAPIV2ListMarkets200ApplicationJSONData:
    ...
    allowed_for_your_subscription: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'allowed_for_your_subscription' }})
    

@dataclass_json
@dataclass
class GetAPIV2ListMarkets200ApplicationJSON:
    data: Optional[GetAPIV2ListMarkets200ApplicationJSONData] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'data' }})
