...
class PhoneCodeGeoFeedbackLoopPathParams:
    ...
    phone_number_e164: str = field(metadata={'path_param': { 'field_name': 'phoneNumberE164', 'style': 'simple', 'explode': False }})
...
class PhoneCodeGeoFeedbackLoopRequest:
    path_params: PhoneCodeGeoFeedbackLoopPathParams = field()
    security: PhoneCodeGeoFeedbackLoopSecurity = field()
