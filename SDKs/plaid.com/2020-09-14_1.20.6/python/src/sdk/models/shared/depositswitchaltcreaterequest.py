...
class DepositSwitchAltCreateRequestCountryCodeCountryCodeEnum(str, Enum):
    US = "US"
    CA = "CA"
...
class DepositSwitchAltCreateRequest:
    ...
    country_code: Optional[DepositSwitchAltCreateRequestCountryCodeCountryCodeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'country_code' }})
