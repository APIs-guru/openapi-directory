...
from . import investmentstransactionsgetrequestoptions
...
class InvestmentsTransactionsGetRequest:
    ...
    options: Optional[investmentstransactionsgetrequestoptions.InvestmentsTransactionsGetRequestOptions] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'options' }})
