...
from . import servicecredentialtype
...
class ServiceCredentialTypesCollection:
    data: Optional[List[servicecredentialtype.ServiceCredentialType]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'data' }})
