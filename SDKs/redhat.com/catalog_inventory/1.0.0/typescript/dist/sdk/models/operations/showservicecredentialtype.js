...
var ShowServiceCredentialTypePathParams = /** @class */ (function (_super) {
    ...
    function ShowServiceCredentialTypePathParams() {
...
export { ShowServiceCredentialTypePathParams };
var ShowServiceCredentialTypeRequest = /** @class */ (function (_super) {
    __extends(ShowServiceCredentialTypeRequest, _super);
    function ShowServiceCredentialTypeRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata(),
...
export { ShowServiceCredentialTypeRequest };
var ShowServiceCredentialTypeResponse = /** @class */ (function (_super) {
    __extends(ShowServiceCredentialTypeResponse, _super);
    function ShowServiceCredentialTypeResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata(),
...
export { ShowServiceCredentialTypeResponse };
