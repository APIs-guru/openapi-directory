...
class RetrieveABlock200ApplicationJSONParagraphText:
    annotations: Optional[RetrieveABlock200ApplicationJSONParagraphTextAnnotations] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('annotations') }})
    ...
    text: Optional[RetrieveABlock200ApplicationJSONParagraphTextText] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('text') }})
...
class RetrieveABlock200ApplicationJSONParagraph:
    text: Optional[List[RetrieveABlock200ApplicationJSONParagraphText]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('text') }})
...
class RetrieveABlock200ApplicationJSON:
    ...
    paragraph: Optional[RetrieveABlock200ApplicationJSONParagraph] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('paragraph') }})
    type: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
    

@dataclass
class RetrieveABlockRequest:
    path_params: RetrieveABlockPathParams = field()
