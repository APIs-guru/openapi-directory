...
type CreateArtifactHeaders struct {
	XRegistryArtifactID   *string                                  `header:"name=X-Registry-ArtifactId"`
	XRegistryArtifactType *CreateArtifactXRegistryArtifactTypeEnum `header:"name=X-Registry-ArtifactType"`
}
