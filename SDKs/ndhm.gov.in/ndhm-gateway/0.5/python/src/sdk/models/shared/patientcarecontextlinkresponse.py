...
class PatientCareContextLinkResponseAcknowledgement:
    status: PatientCareContextLinkResponseAcknowledgementStatusEnum = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
...
class PatientCareContextLinkResponse:
    ...
    acknowledgement: Optional[PatientCareContextLinkResponseAcknowledgement] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('acknowledgement') }})
