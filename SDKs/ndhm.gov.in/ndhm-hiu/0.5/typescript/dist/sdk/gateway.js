...
var Gateway = /** @class */ (function () {
    ...
    **/
    Gateway.prototype.postV05ConsentRequestsInit = function (req, config) {
        var _a;
    ...
    **/
    Gateway.prototype.postV05ConsentRequestsStatus = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Gateway.prototype.postV05ConsentsFetch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Gateway.prototype.postV05ConsentsHiuOnNotify = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Gateway.prototype.postV05HealthInformationCmRequest = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostV05HealthInformationCmRequestRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v0.5/health-information/cm/request";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
     ...
     *
    **/
    Gateway.prototype.postV05PatientsFind = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Gateway.prototype.postV05SubscriptionRequestsCmInit = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Gateway.prototype.postV05SubscriptionRequestsHiuOnNotify = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Gateway.prototype.postV05SubscriptionsHiuOnNotify = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
