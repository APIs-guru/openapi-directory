...
class HiuSubscriptionNotificationAcknowledgmentAcknowledgement:
    ...
    status: HiuSubscriptionNotificationAcknowledgmentAcknowledgementStatusEnum = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
...
class HiuSubscriptionNotificationAcknowledgment:
    ...
    acknowledgement: Optional[HiuSubscriptionNotificationAcknowledgmentAcknowledgement] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('acknowledgement') }})
