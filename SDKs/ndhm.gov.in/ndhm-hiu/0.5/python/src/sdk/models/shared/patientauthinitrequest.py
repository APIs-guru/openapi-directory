...
class PatientAuthInitRequestQueryRequester:
    ...
    type: PatientAuthInitRequestQueryRequesterTypeEnum = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
...
class PatientAuthInitRequestQuery:
    ...
    requester: PatientAuthInitRequestQueryRequester = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('requester') }})
