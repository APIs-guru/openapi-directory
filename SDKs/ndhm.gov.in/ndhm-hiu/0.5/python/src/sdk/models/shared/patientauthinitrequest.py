...
class PatientAuthInitRequestQueryRequester:
    ...
    type: PatientAuthInitRequestQueryRequesterTypeEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'type' }})
...
class PatientAuthInitRequestQuery:
    ...
    requester: PatientAuthInitRequestQueryRequester = field(default=None, metadata={'dataclasses_json': { 'field_name': 'requester' }})
