...
from . import shareprofileacknowledgement
from . import error
...
class ShareProfileResult:
    acknowledgement: shareprofileacknowledgement.ShareProfileAcknowledgement = field(default=None, metadata={'dataclasses_json': { 'field_name': 'acknowledgement' }})
