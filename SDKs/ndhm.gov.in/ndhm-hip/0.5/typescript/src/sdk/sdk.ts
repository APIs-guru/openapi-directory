...
export class SDK {
  ...
  postV05HealthInformationHipOnRequest(
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostV05HealthInformationHipOnRequestResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 202:
            break;
          case httpRes?.status == 400:
  ...
  **/
  postV05HealthInformationHipRequest(
    ...
    let baseURL: string = operations.PostV05HealthInformationHipRequestServerList[0];
    if (req.serverUrl) {
      baseURL = req.serverUrl;
    }
  ...
  **/
  postV05UsersAuthOnConfirm(
    ...
    let baseURL: string = operations.PostV05UsersAuthOnConfirmServerList[0];
    if (req.serverUrl) {
      baseURL = req.serverUrl;
    }
  ...
  **/
  postV05UsersAuthOnInit(
    ...
    let baseURL: string = operations.PostV05UsersAuthOnInitServerList[0];
    if (req.serverUrl) {
      baseURL = req.serverUrl;
    }
