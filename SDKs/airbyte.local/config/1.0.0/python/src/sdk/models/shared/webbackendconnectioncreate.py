...
class WebBackendConnectionCreate:
    ...
    operations: Optional[List[operationcreate.OperationCreate]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'operations' }})
