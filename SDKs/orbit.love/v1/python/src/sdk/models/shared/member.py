...
class Member:
    ...
    devto: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('devto') }})
    email: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('email') }})
    github: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('github') }})
    ...
    tag_list: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tag_list') }})
    tags: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tags') }})
    tags_to_add: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tags_to_add') }})
    teammate: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('teammate') }})
    title: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('title') }})
    tshirt: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tshirt') }})
