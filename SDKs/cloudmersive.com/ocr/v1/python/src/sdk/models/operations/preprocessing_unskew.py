...
class PreprocessingUnskewRequestBody:
    image_file: PreprocessingUnskewRequestBodyImageFile = field(default=None, metadata={'multipart_form': { 'file': True }})
...
class PreprocessingUnskewRequest:
    request: PreprocessingUnskewRequestBody = field(default=None, metadata={'request': { 'media_type': 'multipart/form-data' }})
    security: PreprocessingUnskewSecurity = field(default=None)
