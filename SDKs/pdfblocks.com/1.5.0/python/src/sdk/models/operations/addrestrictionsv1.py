...
class AddRestrictionsV1RequestBody:
    ...
    file: AddRestrictionsV1RequestBodyFile = field(default=None, metadata={'multipart_form': { 'file': True }})
    owner_password: str = field(default=None, metadata={'multipart_form': { 'field_name': 'owner_password' }})
...
class AddRestrictionsV1Request:
    request: AddRestrictionsV1RequestBody = field(default=None, metadata={'request': { 'media_type': 'multipart/form-data' }})
