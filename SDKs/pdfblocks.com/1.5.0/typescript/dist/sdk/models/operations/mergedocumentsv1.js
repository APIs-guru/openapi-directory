...
var MergeDocumentsV1RequestBodyFile = /** @class */ (function (_super) {
    __extends(MergeDocumentsV1RequestBodyFile, _super);
    function MergeDocumentsV1RequestBodyFile() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "multipart_form, content=true" }),
        __metadata("design:type", Uint8Array)
    ], MergeDocumentsV1RequestBodyFile.prototype, "content", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "multipart_form, name=file" }),
        __metadata("design:type", String)
    ], MergeDocumentsV1RequestBodyFile.prototype, "file", void 0);
    return MergeDocumentsV1RequestBodyFile;
}(SpeakeasyBase));
export { MergeDocumentsV1RequestBodyFile };
...
export { MergeDocumentsV1RequestBody };
...
export { MergeDocumentsV14XxApplicationProblemPlusJson };
...
export { MergeDocumentsV1Request };
...
export { MergeDocumentsV1Response };
