...
func (s *SDK) ClearAddress(ctx context.Context, request operations.ClearAddressRequest) (*operations.ClearAddressResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) ExportAddress(ctx context.Context, request operations.ExportAddressRequest) (*operations.ExportAddressResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) GetEthereumBalance(ctx context.Context, request operations.GetEthereumBalanceRequest) (*operations.GetEthereumBalanceResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) GetExchangeRate(ctx context.Context, request operations.GetExchangeRateRequest) (*operations.GetExchangeRateResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) GetGasPrice(ctx context.Context, request operations.GetGasPriceRequest) (*operations.GetGasPriceResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) GetLastBlockNumber(ctx context.Context, request operations.GetLastBlockNumberRequest) (*operations.GetLastBlockNumberResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) GetTokenBalance(ctx context.Context, request operations.GetTokenBalanceRequest) (*operations.GetTokenBalanceResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) ImportAddress(ctx context.Context, request operations.ImportAddressRequest) (*operations.ImportAddressResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) ListAddresses(ctx context.Context, request operations.ListAddressesRequest) (*operations.ListAddressesResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) ListFailedIPNs(ctx context.Context, request operations.ListFailedIPNsRequest) (*operations.ListFailedIPNsResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) ListSubscribedAddresses(ctx context.Context, request operations.ListSubscribedAddressesRequest) (*operations.ListSubscribedAddressesResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) NewAddress(ctx context.Context, request operations.NewAddressRequest) (*operations.NewAddressResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) ResendFailedIpn(ctx context.Context, request operations.ResendFailedIpnRequest) (*operations.ResendFailedIpnResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) SendEthereum(ctx context.Context, request operations.SendEthereumRequest) (*operations.SendEthereumResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) SubscribeAddress(ctx context.Context, request operations.SubscribeAddressRequest) (*operations.SubscribeAddressResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) UnsubscribeAddress(ctx context.Context, request operations.UnsubscribeAddressRequest) (*operations.UnsubscribeAddressResponse, error) {
	baseURL := s.serverURL
