...
class PostRouteOutputFormatPathParams:
    output_format: PostRouteOutputFormatOutputFormatEnum = field(default=None, metadata={'path_param': { 'field_name': 'outputFormat', 'style': 'simple', 'explode': False }})
...
class PostRouteOutputFormatRequest:
    path_params: PostRouteOutputFormatPathParams = field(default=None)
    query_params: PostRouteOutputFormatQueryParams = field(default=None)
