...
class GetTruckOptimalRouteOutputFormatPathParams:
    output_format: GetTruckOptimalRouteOutputFormatOutputFormatEnum = field(metadata={'path_param': { 'field_name': 'outputFormat', 'style': 'simple', 'explode': False }})
...
class GetTruckOptimalRouteOutputFormatRequest:
    path_params: GetTruckOptimalRouteOutputFormatPathParams = field()
    query_params: GetTruckOptimalRouteOutputFormatQueryParams = field()
