...
class PostOptimalRouteOutputFormatPathParams:
    output_format: PostOptimalRouteOutputFormatOutputFormatEnum = field(metadata={'path_param': { 'field_name': 'outputFormat', 'style': 'simple', 'explode': False }})
...
class PostOptimalRouteOutputFormatRequest:
    path_params: PostOptimalRouteOutputFormatPathParams = field()
    query_params: PostOptimalRouteOutputFormatQueryParams = field()
