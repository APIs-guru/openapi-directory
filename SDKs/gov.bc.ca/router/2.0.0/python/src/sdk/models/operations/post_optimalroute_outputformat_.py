...
class PostOptimalRouteOutputFormatPathParams:
    output_format: PostOptimalRouteOutputFormatOutputFormatEnum = field(default=None, metadata={'path_param': { 'field_name': 'outputFormat', 'style': 'simple', 'explode': False }})
...
class PostOptimalRouteOutputFormatQueryParams:
    ...
    criteria: Optional[PostOptimalRouteOutputFormatCriteriaEnum] = field(default=None, metadata={'query_param': { 'field_name': 'criteria', 'style': 'form', 'explode': True }})
    ...
    distance_unit: Optional[PostOptimalRouteOutputFormatDistanceUnitEnum] = field(default=None, metadata={'query_param': { 'field_name': 'distanceUnit', 'style': 'form', 'explode': True }})
...
class PostOptimalRouteOutputFormatRequest:
    path_params: PostOptimalRouteOutputFormatPathParams = field(default=None)
    query_params: PostOptimalRouteOutputFormatQueryParams = field(default=None)
