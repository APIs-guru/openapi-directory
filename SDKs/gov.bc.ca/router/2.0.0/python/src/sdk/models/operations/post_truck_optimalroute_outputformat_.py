...
class PostTruckOptimalRouteOutputFormatPathParams:
    output_format: PostTruckOptimalRouteOutputFormatOutputFormatEnum = field(default=None, metadata={'path_param': { 'field_name': 'outputFormat', 'style': 'simple', 'explode': False }})
...
class PostTruckOptimalRouteOutputFormatRequest:
    path_params: PostTruckOptimalRouteOutputFormatPathParams = field(default=None)
    query_params: PostTruckOptimalRouteOutputFormatQueryParams = field(default=None)
