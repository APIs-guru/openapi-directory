...
class GetTruckOptimalDirectionsOutputFormatPathParams:
    output_format: GetTruckOptimalDirectionsOutputFormatOutputFormatEnum = field(metadata={'path_param': { 'field_name': 'outputFormat', 'style': 'simple', 'explode': False }})
...
class GetTruckOptimalDirectionsOutputFormatRequest:
    path_params: GetTruckOptimalDirectionsOutputFormatPathParams = field()
    query_params: GetTruckOptimalDirectionsOutputFormatQueryParams = field()
