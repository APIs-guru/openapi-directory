...
class PostOptimalDirectionsOutputFormatPathParams:
    output_format: PostOptimalDirectionsOutputFormatOutputFormatEnum = field(metadata={'path_param': { 'field_name': 'outputFormat', 'style': 'simple', 'explode': False }})
...
class PostOptimalDirectionsOutputFormatRequest:
    path_params: PostOptimalDirectionsOutputFormatPathParams = field()
    query_params: PostOptimalDirectionsOutputFormatQueryParams = field()
