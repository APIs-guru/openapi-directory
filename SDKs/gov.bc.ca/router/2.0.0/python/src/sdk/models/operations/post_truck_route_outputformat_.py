...
class PostTruckRouteOutputFormatPathParams:
    output_format: PostTruckRouteOutputFormatOutputFormatEnum = field(metadata={'path_param': { 'field_name': 'outputFormat', 'style': 'simple', 'explode': False }})
...
class PostTruckRouteOutputFormatRequest:
    path_params: PostTruckRouteOutputFormatPathParams = field()
    query_params: PostTruckRouteOutputFormatQueryParams = field()
