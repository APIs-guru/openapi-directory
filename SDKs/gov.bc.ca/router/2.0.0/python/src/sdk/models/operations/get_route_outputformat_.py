...
class GetRouteOutputFormatPathParams:
    output_format: GetRouteOutputFormatOutputFormatEnum = field(default=None, metadata={'path_param': { 'field_name': 'outputFormat', 'style': 'simple', 'explode': False }})
...
class GetRouteOutputFormatRequest:
    path_params: GetRouteOutputFormatPathParams = field(default=None)
    query_params: GetRouteOutputFormatQueryParams = field(default=None)
