...
class GetTruckDistanceOutputFormatPathParams:
    output_format: GetTruckDistanceOutputFormatOutputFormatEnum = field(default=None, metadata={'path_param': { 'field_name': 'outputFormat', 'style': 'simple', 'explode': False }})
...
class GetTruckDistanceOutputFormatRequest:
    path_params: GetTruckDistanceOutputFormatPathParams = field(default=None)
    query_params: GetTruckDistanceOutputFormatQueryParams = field(default=None)
