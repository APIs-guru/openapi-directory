...
class GetDistanceOutputFormatPathParams:
    output_format: GetDistanceOutputFormatOutputFormatEnum = field(default=None, metadata={'path_param': { 'field_name': 'outputFormat', 'style': 'simple', 'explode': False }})
...
class GetDistanceOutputFormatRequest:
    path_params: GetDistanceOutputFormatPathParams = field(default=None)
    query_params: GetDistanceOutputFormatQueryParams = field(default=None)
