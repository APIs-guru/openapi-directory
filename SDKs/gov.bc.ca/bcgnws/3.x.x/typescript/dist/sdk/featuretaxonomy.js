...
var FeatureTaxonomy = /** @class */ (function () {
    function FeatureTaxonomy(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    FeatureTaxonomy.prototype.getFeatureCategories = function (req, config) {
    ...
    **/
    FeatureTaxonomy.prototype.getFeatureClasses = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    FeatureTaxonomy.prototype.getFeatureTypes = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
