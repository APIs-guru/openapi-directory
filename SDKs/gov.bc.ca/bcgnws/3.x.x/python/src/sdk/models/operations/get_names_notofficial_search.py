...
class GetNamesNotOfficialSearchQueryParams:
    ...
    output_format: GetNamesNotOfficialSearchOutputFormatEnum = field(default=None, metadata={'query_param': { 'field_name': 'outputFormat', 'style': 'form', 'explode': True }})
...
class GetNamesNotOfficialSearchRequest:
    query_params: GetNamesNotOfficialSearchQueryParams = field(default=None)
