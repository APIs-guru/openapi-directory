...
class GetNamesNearQueryParams:
    distance: str = field(metadata={'query_param': { 'field_name': 'distance', 'style': 'form', 'explode': True }})
    feature_point: str = field(metadata={'query_param': { 'field_name': 'featurePoint', 'style': 'form', 'explode': True }})
    output_format: GetNamesNearOutputFormatEnum = field(metadata={'query_param': { 'field_name': 'outputFormat', 'style': 'form', 'explode': True }})
...
class GetNamesNearRequest:
    query_params: GetNamesNearQueryParams = field()
