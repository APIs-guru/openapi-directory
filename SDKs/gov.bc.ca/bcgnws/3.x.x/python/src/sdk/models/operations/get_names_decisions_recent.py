...
class GetNamesDecisionsRecentQueryParams:
    days: int = field(default=None, metadata={'query_param': { 'field_name': 'days', 'style': 'form', 'explode': True }})
    ...
    output_format: GetNamesDecisionsRecentOutputFormatEnum = field(default=None, metadata={'query_param': { 'field_name': 'outputFormat', 'style': 'form', 'explode': True }})
...
class GetNamesDecisionsRecentRequest:
    query_params: GetNamesDecisionsRecentQueryParams = field(default=None)
