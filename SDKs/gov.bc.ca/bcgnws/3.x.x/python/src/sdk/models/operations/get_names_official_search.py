...
class GetNamesOfficialSearchQueryParams:
    ...
    output_format: GetNamesOfficialSearchOutputFormatEnum = field(metadata={'query_param': { 'field_name': 'outputFormat', 'style': 'form', 'explode': True }})
...
class GetNamesOfficialSearchRequest:
    query_params: GetNamesOfficialSearchQueryParams = field()
