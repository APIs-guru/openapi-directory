...
class SurveySurveyPagePageEnum(str, Enum):
    W = "w"
    R = "r"
    S = "s"
    A = "a"
...
class Survey:
    ...
    survey_page: Optional[SurveySurveyPagePageEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'survey_page' }})
