...
class AquiferCodesDemandListRequest:
    query_params: AquiferCodesDemandListQueryParams = field(default=None)
...
class AquiferCodesDemandList200ApplicationJSON:
    ...
    results: List[shared.AquiferDemand] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'results' }})
