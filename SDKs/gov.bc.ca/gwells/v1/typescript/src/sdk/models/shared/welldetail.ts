...
export class WellDetail extends SpeakeasyBase {
  ...
  @Metadata({ data: "json, name=casing_set", elemType: shared.Casing })
  casingSet: Casing[];
  ...
  @Metadata({ data: "json, name=company_of_person_responsible" })
  ...
  @Metadata({ data: "json, name=decommission_description_set", elemType: shared.DecommissionDescription })
  ...
  @Metadata({ data: "json, name=linerperforation_set", elemType: shared.LinerPerforation })
  linerperforationSet: LinerPerforation[];

  @Metadata({ data: "json, name=lithologydescription_set", elemType: shared.LithologyDescription })
  ...
  @Metadata({ data: "json, name=person_responsible" })
  ...
  @Metadata({ data: "json, name=screen_set", elemType: shared.Screen })
  screenSet: Screen[];
