...
export declare class MatrixApi {
     ...
     *
    **/
    calculateMatrix(req: operations.CalculateMatrixRequest, config?: AxiosRequestConfig): Promise<operations.CalculateMatrixResponse>;
    /**
    ...
    **/
     ...
     *
    **/
    postMatrix(req: operations.PostMatrixRequest, config?: AxiosRequestConfig): Promise<operations.PostMatrixResponse>;
}
