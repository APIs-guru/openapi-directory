...
})(GetApiGlossaryMediaTypeExtensionMediaTypeExtensionEnum || (GetApiGlossaryMediaTypeExtensionMediaTypeExtensionEnum = {}));
var GetApiGlossaryMediaTypeExtensionPathParams = /** @class */ (function (_super) {
    __extends(GetApiGlossaryMediaTypeExtensionPathParams, _super);
    function GetApiGlossaryMediaTypeExtensionPathParams() {
...
export { GetApiGlossaryMediaTypeExtensionPathParams };
var GetApiGlossaryMediaTypeExtensionRequest = /** @class */ (function (_super) {
    __extends(GetApiGlossaryMediaTypeExtensionRequest, _super);
    function GetApiGlossaryMediaTypeExtensionRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata(),
...
export { GetApiGlossaryMediaTypeExtensionRequest };
var GetApiGlossaryMediaTypeExtensionResponse = /** @class */ (function (_super) {
    __extends(GetApiGlossaryMediaTypeExtensionResponse, _super);
    function GetApiGlossaryMediaTypeExtensionResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata(),
...
export { GetApiGlossaryMediaTypeExtensionResponse };
