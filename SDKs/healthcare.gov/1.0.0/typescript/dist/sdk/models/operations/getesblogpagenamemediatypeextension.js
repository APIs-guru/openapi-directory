...
})(GetEsBlogPageNameMediaTypeExtensionMediaTypeExtensionEnum || (GetEsBlogPageNameMediaTypeExtensionMediaTypeExtensionEnum = {}));
var GetEsBlogPageNameMediaTypeExtensionPathParams = /** @class */ (function (_super) {
    __extends(GetEsBlogPageNameMediaTypeExtensionPathParams, _super);
    function GetEsBlogPageNameMediaTypeExtensionPathParams() {
...
export { GetEsBlogPageNameMediaTypeExtensionPathParams };
var GetEsBlogPageNameMediaTypeExtensionRequest = /** @class */ (function (_super) {
    __extends(GetEsBlogPageNameMediaTypeExtensionRequest, _super);
    function GetEsBlogPageNameMediaTypeExtensionRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata(),
...
export { GetEsBlogPageNameMediaTypeExtensionRequest };
var GetEsBlogPageNameMediaTypeExtensionResponse = /** @class */ (function (_super) {
    __extends(GetEsBlogPageNameMediaTypeExtensionResponse, _super);
    function GetEsBlogPageNameMediaTypeExtensionResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata(),
...
export { GetEsBlogPageNameMediaTypeExtensionResponse };
