...
func (s *SDK) Getfullnameparsedmatch(ctx context.Context, request operations.GetfullnameparsedmatchRequest) (*operations.GetfullnameparsedmatchResponse, error) {
