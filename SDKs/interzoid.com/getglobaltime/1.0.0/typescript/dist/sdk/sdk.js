...
var SDK = /** @class */ (function () {
    ...
    **/
    SDK.prototype.Getglobaltime = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetglobaltimeRequest(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/getglobaltime";
            ...
            switch (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) {
                case 200:
                    if (MatchContentType(contentType, "application/json")) {
                        res.getglobaltime200ApplicationJsonObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case 400:
                    break;
