...
export { Security };
var SchemeOauthAuthentication = /** @class */ (function (_super) {
    __extends(SchemeOauthAuthentication, _super);
    function SchemeOauthAuthentication() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "security, name=Authorization" }),
        __metadata("design:type", String)
    ], SchemeOauthAuthentication.prototype, "authorization", void 0);
    return SchemeOauthAuthentication;
}(SpeakeasyBase));
export { SchemeOauthAuthentication };
