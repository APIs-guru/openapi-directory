...
func (s *SDK) DeleteWebhooks(ctx context.Context, request operations.DeleteWebhooksRequest) (*operations.DeleteWebhooksResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v1/integrations/webhooks/:id"
...
func (s *SDK) GetWebhooks(ctx context.Context, request operations.GetWebhooksRequest) (*operations.GetWebhooksResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/v1/integrations/webhooks"
