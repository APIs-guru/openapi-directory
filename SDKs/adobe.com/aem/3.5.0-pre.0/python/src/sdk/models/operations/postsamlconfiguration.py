...
class PostSamlConfigurationQueryParams:
    dollar_location: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': '$location', 'style': 'form', 'explode': True }})
    ...
    apply: Optional[bool] = field(default=None, metadata={'query_param': { 'field_name': 'apply', 'style': 'form', 'explode': True }})
    ...
    delete: Optional[bool] = field(default=None, metadata={'query_param': { 'field_name': 'delete', 'style': 'form', 'explode': True }})
    ...
    post: Optional[bool] = field(default=None, metadata={'query_param': { 'field_name': 'post', 'style': 'form', 'explode': True }})
    propertylist: Optional[List[str]] = field(default=None, metadata={'query_param': { 'field_name': 'propertylist', 'style': 'form', 'explode': False }})
