...
var Templates = /** @class */ (function () {
     ...
     * The `offset` parameter must be an integer (positive number) greater than 0.
    **/
    Templates.prototype.listAvailableContentBlocks = function (req, config) {
     ...
     *   ```
    **/
    Templates.prototype.listAvailableEmailTemplates = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Templates.prototype.seeContentBlockInformation = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Templates.prototype.seeEmailTemplateInformation = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
