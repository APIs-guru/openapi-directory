...
func (s *Campaign) CampaignAnalytics(ctx context.Context, request operations.CampaignAnalyticsRequest) (*operations.CampaignAnalyticsResponse, error) {
...
//
// ```
func (s *Campaign) CampaignDetails(ctx context.Context, request operations.CampaignDetailsRequest) (*operations.CampaignDetailsResponse, error) {
	baseURL := s._serverURL
...
//
// ```
func (s *Campaign) CampaignList(ctx context.Context, request operations.CampaignListRequest) (*operations.CampaignListResponse, error) {
	baseURL := s._serverURL
...
//
// ```
func (s *Campaign) SendAnalytics(ctx context.Context, request operations.SendAnalyticsRequest) (*operations.SendAnalyticsResponse, error) {
	baseURL := s._serverURL
