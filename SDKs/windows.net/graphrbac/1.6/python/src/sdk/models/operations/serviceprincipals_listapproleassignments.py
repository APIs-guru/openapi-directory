...
class ServicePrincipalsListAppRoleAssignmentsRequest:
    path_params: ServicePrincipalsListAppRoleAssignmentsPathParams = field(default=None)
    query_params: ServicePrincipalsListAppRoleAssignmentsQueryParams = field(default=None)
