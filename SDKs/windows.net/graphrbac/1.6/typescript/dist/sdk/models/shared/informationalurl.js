...
**/
var InformationalUrl = /** @class */ (function (_super) {
    __extends(InformationalUrl, _super);
    function InformationalUrl() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=marketing" }),
        __metadata("design:type", String)
    ], InformationalUrl.prototype, "marketing", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=privacy" }),
        __metadata("design:type", String)
    ], InformationalUrl.prototype, "privacy", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=support" }),
        __metadata("design:type", String)
    ], InformationalUrl.prototype, "support", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=termsOfService" }),
        __metadata("design:type", String)
    ], InformationalUrl.prototype, "termsOfService", void 0);
    return InformationalUrl;
}(SpeakeasyBase));
export { InformationalUrl };
