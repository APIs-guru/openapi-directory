...
type JobSchedulePatchPathParams struct {
	JobScheduleID string `pathParam:"style=simple,explode=false,name=jobScheduleId"`
}

type JobSchedulePatchQueryParams struct {
	APIVersion string `queryParam:"style=form,explode=true,name=api-version"`
	Timeout    *int32 `queryParam:"style=form,explode=true,name=timeout"`
}

type JobSchedulePatchHeaders struct {
...
type JobSchedulePatchRequest struct {
...
type JobSchedulePatchResponse struct {
