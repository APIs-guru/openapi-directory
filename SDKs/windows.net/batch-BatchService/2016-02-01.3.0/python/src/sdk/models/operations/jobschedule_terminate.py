...
class JobScheduleTerminateRequest:
    path_params: JobScheduleTerminatePathParams = field(default=None)
    query_params: JobScheduleTerminateQueryParams = field(default=None)
    headers: JobScheduleTerminateHeaders = field(default=None)
