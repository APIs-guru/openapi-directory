...
class TaskAddCollectionRequest:
    path_params: TaskAddCollectionPathParams = field(default=None)
    query_params: TaskAddCollectionQueryParams = field(default=None)
    headers: TaskAddCollectionHeaders = field(default=None)
