...
class ComputeNodeRebootRequest:
    path_params: ComputeNodeRebootPathParams = field(default=None)
    query_params: ComputeNodeRebootQueryParams = field(default=None)
    headers: ComputeNodeRebootHeaders = field(default=None)
