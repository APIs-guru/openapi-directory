...
class PoolEvaluateAutoScaleRequest:
    path_params: PoolEvaluateAutoScalePathParams = field(default=None)
    query_params: PoolEvaluateAutoScaleQueryParams = field(default=None)
    headers: PoolEvaluateAutoScaleHeaders = field(default=None)
    request: Any = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class PoolEvaluateAutoScaleResponse:
    auto_scale_run: Optional[Any] = field(default=None)
