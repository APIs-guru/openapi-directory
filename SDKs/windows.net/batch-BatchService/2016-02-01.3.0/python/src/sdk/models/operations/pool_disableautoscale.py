...
class PoolDisableAutoScaleRequest:
    path_params: PoolDisableAutoScalePathParams = field(default=None)
    query_params: PoolDisableAutoScaleQueryParams = field(default=None)
    headers: PoolDisableAutoScaleHeaders = field(default=None)
