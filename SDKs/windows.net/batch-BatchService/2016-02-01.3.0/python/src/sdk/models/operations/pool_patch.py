...
class PoolPatchRequest:
    path_params: PoolPatchPathParams = field(default=None)
    query_params: PoolPatchQueryParams = field(default=None)
    headers: PoolPatchHeaders = field(default=None)
