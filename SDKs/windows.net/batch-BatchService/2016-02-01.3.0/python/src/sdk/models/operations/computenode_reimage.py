...
class ComputeNodeReimageRequest:
    path_params: ComputeNodeReimagePathParams = field(default=None)
    query_params: ComputeNodeReimageQueryParams = field(default=None)
    headers: ComputeNodeReimageHeaders = field(default=None)
