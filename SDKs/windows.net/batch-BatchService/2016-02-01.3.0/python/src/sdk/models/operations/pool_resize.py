...
class PoolResizeRequest:
    path_params: PoolResizePathParams = field(default=None)
    query_params: PoolResizeQueryParams = field(default=None)
    headers: PoolResizeHeaders = field(default=None)
