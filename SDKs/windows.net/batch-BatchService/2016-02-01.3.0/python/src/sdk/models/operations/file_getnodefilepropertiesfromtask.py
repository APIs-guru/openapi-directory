...
class FileGetNodeFilePropertiesFromTaskRequest:
    headers: FileGetNodeFilePropertiesFromTaskHeaders = field()
    path_params: FileGetNodeFilePropertiesFromTaskPathParams = field()
    query_params: FileGetNodeFilePropertiesFromTaskQueryParams = field()
