...
class PoolUpgradeOsRequest:
    path_params: PoolUpgradeOsPathParams = field(default=None)
    query_params: PoolUpgradeOsQueryParams = field(default=None)
    headers: PoolUpgradeOsHeaders = field(default=None)
