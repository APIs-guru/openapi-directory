...
class ComputeNodeGetRemoteDesktopRequest:
    headers: ComputeNodeGetRemoteDesktopHeaders = field()
    path_params: ComputeNodeGetRemoteDesktopPathParams = field()
    query_params: ComputeNodeGetRemoteDesktopQueryParams = field()
