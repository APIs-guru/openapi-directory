...
class TaskTerminateRequest:
    path_params: TaskTerminatePathParams = field(default=None)
    query_params: TaskTerminateQueryParams = field(default=None)
    headers: TaskTerminateHeaders = field(default=None)
