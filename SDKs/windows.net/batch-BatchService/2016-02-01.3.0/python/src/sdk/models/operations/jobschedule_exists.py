...
class JobScheduleExistsRequest:
    path_params: JobScheduleExistsPathParams = field(default=None)
    query_params: JobScheduleExistsQueryParams = field(default=None)
    headers: JobScheduleExistsHeaders = field(default=None)
