...
class JobScheduleUpdateRequest:
    path_params: JobScheduleUpdatePathParams = field(default=None)
    query_params: JobScheduleUpdateQueryParams = field(default=None)
    headers: JobScheduleUpdateHeaders = field(default=None)
