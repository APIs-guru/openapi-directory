...
class JobListFromJobScheduleRequest:
    path_params: JobListFromJobSchedulePathParams = field(default=None)
    query_params: JobListFromJobScheduleQueryParams = field(default=None)
    headers: JobListFromJobScheduleHeaders = field(default=None)
