...
@dataclass
class JobEnablePathParams:
    job_id: str = field(default=None, metadata={'path_param': { 'field_name': 'jobId', 'style': 'simple', 'explode': False }})
    

@dataclass
class JobEnableQueryParams:
    api_version: str = field(default=None, metadata={'query_param': { 'field_name': 'api-version', 'style': 'form', 'explode': True }})
    timeout: Optional[int] = field(default=None, metadata={'query_param': { 'field_name': 'timeout', 'style': 'form', 'explode': True }})
    

@dataclass
class JobEnableHeaders:
...
class JobEnableRequest:
    path_params: JobEnablePathParams = field(default=None)
    query_params: JobEnableQueryParams = field(default=None)
    headers: JobEnableHeaders = field(default=None)
