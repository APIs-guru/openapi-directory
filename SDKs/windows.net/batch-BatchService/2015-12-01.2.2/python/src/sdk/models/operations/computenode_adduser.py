...
class ComputeNodeAddUserRequest:
    path_params: ComputeNodeAddUserPathParams = field(default=None)
    query_params: ComputeNodeAddUserQueryParams = field(default=None)
    headers: ComputeNodeAddUserHeaders = field(default=None)
