...
class ComputeNodeDisableSchedulingRequest:
    headers: ComputeNodeDisableSchedulingHeaders = field()
    path_params: ComputeNodeDisableSchedulingPathParams = field()
    query_params: ComputeNodeDisableSchedulingQueryParams = field()
