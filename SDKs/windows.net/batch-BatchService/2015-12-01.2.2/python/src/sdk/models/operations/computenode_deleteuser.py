...
class ComputeNodeDeleteUserRequest:
    path_params: ComputeNodeDeleteUserPathParams = field(default=None)
    query_params: ComputeNodeDeleteUserQueryParams = field(default=None)
    headers: ComputeNodeDeleteUserHeaders = field(default=None)
