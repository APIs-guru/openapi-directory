...
class JobScheduleEnableRequest:
    path_params: JobScheduleEnablePathParams = field(default=None)
    query_params: JobScheduleEnableQueryParams = field(default=None)
    headers: JobScheduleEnableHeaders = field(default=None)
