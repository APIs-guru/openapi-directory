...
class PoolRemoveNodesRequest:
    path_params: PoolRemoveNodesPathParams = field(default=None)
    query_params: PoolRemoveNodesQueryParams = field(default=None)
    headers: PoolRemoveNodesHeaders = field(default=None)
