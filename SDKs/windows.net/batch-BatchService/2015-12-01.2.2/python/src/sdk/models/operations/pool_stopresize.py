...
class PoolStopResizeRequest:
    path_params: PoolStopResizePathParams = field(default=None)
    query_params: PoolStopResizeQueryParams = field(default=None)
    headers: PoolStopResizeHeaders = field(default=None)
