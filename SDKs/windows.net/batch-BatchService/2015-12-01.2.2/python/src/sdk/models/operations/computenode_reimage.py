...
@dataclass
class ComputeNodeReimagePathParams:
...
@dataclass
class ComputeNodeReimageQueryParams:
    api_version: str = field(metadata={'query_param': { 'field_name': 'api-version', 'style': 'form', 'explode': True }})
    timeout: Optional[int] = field(default=None, metadata={'query_param': { 'field_name': 'timeout', 'style': 'form', 'explode': True }})
    

@dataclass
class ComputeNodeReimageHeaders:
...
@dataclass
class ComputeNodeReimageRequest:
    headers: ComputeNodeReimageHeaders = field()
    path_params: ComputeNodeReimagePathParams = field()
    query_params: ComputeNodeReimageQueryParams = field()
    request: Optional[Any] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class ComputeNodeReimageResponse:
