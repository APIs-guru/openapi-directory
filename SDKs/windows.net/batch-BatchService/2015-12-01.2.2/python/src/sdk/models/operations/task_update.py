...
class TaskUpdateRequest:
    path_params: TaskUpdatePathParams = field(default=None)
    query_params: TaskUpdateQueryParams = field(default=None)
    headers: TaskUpdateHeaders = field(default=None)
