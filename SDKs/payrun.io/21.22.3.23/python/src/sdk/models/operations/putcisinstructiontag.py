...
@dataclass
class PutCisInstructionTagPathParams:
...
@dataclass
class PutCisInstructionTagHeaders:
    api_version: str = field(default=None, metadata={'header': { 'field_name': 'Api-Version' }})
    authorization: str = field(default=None, metadata={'header': { 'field_name': 'Authorization' }})
    

@dataclass
class PutCisInstructionTagRequest:
    path_params: PutCisInstructionTagPathParams = field(default=None)
    headers: PutCisInstructionTagHeaders = field(default=None)
    

@dataclass
class PutCisInstructionTagResponse:
