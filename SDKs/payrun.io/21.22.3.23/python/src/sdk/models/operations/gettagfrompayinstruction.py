...
@dataclass
class GetTagFromPayInstructionPathParams:
...
@dataclass
class GetTagFromPayInstructionHeaders:
    api_version: str = field(default=None, metadata={'header': { 'field_name': 'Api-Version' }})
    authorization: str = field(default=None, metadata={'header': { 'field_name': 'Authorization' }})
    

@dataclass
class GetTagFromPayInstructionRequest:
    path_params: GetTagFromPayInstructionPathParams = field(default=None)
    headers: GetTagFromPayInstructionHeaders = field(default=None)
    

@dataclass
class GetTagFromPayInstructionResponse:
