...
@dataclass
class GetTagFromSubContractorRevisionPathParams:
...
@dataclass
class GetTagFromSubContractorRevisionHeaders:
...
class GetTagFromSubContractorRevisionRequest:
    path_params: GetTagFromSubContractorRevisionPathParams = field(default=None)
    headers: GetTagFromSubContractorRevisionHeaders = field(default=None)
