...
class BatchJobInstructionBatchJobInstruction:
    ...
    instructions: Optional[BatchJobInstructionBatchJobInstructionDelete] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Instructions' }})
...
class BatchJobInstruction:
    batch_job_instruction: Optional[BatchJobInstructionBatchJobInstruction] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'BatchJobInstruction' }})
