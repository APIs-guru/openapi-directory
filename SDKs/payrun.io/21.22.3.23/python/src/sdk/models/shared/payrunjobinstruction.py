...
class PayRunJobInstructionPayRunJobInstruction:
    employees: Optional[PayRunJobInstructionPayRunJobInstructionEmployee] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Employees' }})
    ...
    pay_schedule: Optional[PayRunJobInstructionPayRunJobInstructionPaySchedule] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'PaySchedule' }})
...
class PayRunJobInstruction:
    pay_run_job_instruction: Optional[PayRunJobInstructionPayRunJobInstruction] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'PayRunJobInstruction' }})
