...
class DpsMessageDpsMessage:
    ...
    message_status: Optional[DpsMessageDpsMessageMessageStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'MessageStatus' }})
...
@dataclass
class DpsMessage:
    dps_message: Optional[DpsMessageDpsMessage] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'DpsMessage' }})
