...
class JobInfoJobInfo:
    ...
    errors: Optional[JobInfoJobInfoErrors] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Errors' }})
    ...
    job_status: Optional[JobInfoJobInfoJobStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'JobStatus' }})
...
@dataclass
class JobInfo:
    job_info: Optional[JobInfoJobInfo] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'JobInfo' }})
