...
class CisLineCisLinePayFrequencyPayFrequencyEnum(str, Enum):
    MONTHLY = "Monthly"
    WEEKLY = "Weekly"

class CisLineCisLineTaxTreatmentTaxTreatmentEnum(str, Enum):
    TAXABLE = "Taxable"
    NON_TAXABLE = "NonTaxable"
    NOTIONAL = "Notional"
    MATERIALS = "Materials"

class CisLineCisLineUomUomEnum(str, Enum):
    NOT_SET = "NotSet"
    MINUTE = "Minute"
    HOUR = "Hour"
    DAY = "Day"
...
class CisLineCisLineCisLine:
    ...
    pay_frequency: Optional[CisLineCisLinePayFrequencyPayFrequencyEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'PayFrequency' }})
    ...
    tax_treatment: Optional[CisLineCisLineTaxTreatmentTaxTreatmentEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'TaxTreatment' }})
    tax_year: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'TaxYear' }})
    uom: Optional[CisLineCisLineUomUomEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'UOM' }})
...
@dataclass
class CisLine:
    cis_line: Optional[CisLineCisLineCisLine] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'CisLine' }})
