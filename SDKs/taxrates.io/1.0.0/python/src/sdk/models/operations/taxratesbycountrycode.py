...
class TaxRatesByCountryCodeQueryParams:
    ...
    province: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'province ', 'style': 'form', 'explode': True }})
...
class TaxRatesByCountryCode200ApplicationJSON:
    ...
    taxes: Optional[List[TaxRatesByCountryCode200ApplicationJSONTaxes]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('taxes') }})
...
class TaxRatesByCountryCodeRequest:
    query_params: TaxRatesByCountryCodeQueryParams = field()
