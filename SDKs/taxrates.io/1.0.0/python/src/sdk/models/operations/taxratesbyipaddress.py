...
class TaxRatesByIPAddressRequest:
    query_params: TaxRatesByIPAddressQueryParams = field(default=None)
...
class TaxRatesByIPAddress200ApplicationJSON:
    ...
    taxes: Optional[List[TaxRatesByIPAddress200ApplicationJSONTaxes]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'taxes' }})
