...
class ConfigSyslog:
    ...
    localport: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'localport' }})
    ...
    serverport: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'serverport' }})
