...
class ProtocolSnmptcpSetTraceRequest:
    path_params: ProtocolSnmptcpSetTracePathParams = field(default=None)
...
class ProtocolSnmptcpSetTraceResponse:
    ...
    protocol_snmptcp_set_trace_200_application_json_string: Optional[str] = field(default=None)
