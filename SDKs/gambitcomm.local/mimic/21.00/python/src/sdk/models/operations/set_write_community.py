...
class SetWriteCommunityPathParams:
    ...
    write: str = field(default=None, metadata={'path_param': { 'field_name': 'write', 'style': 'simple', 'explode': False }})
    

@dataclass
class SetWriteCommunityRequest:
    path_params: SetWriteCommunityPathParams = field(default=None)
