...
var PutCategoriesIdJsonQueryParams = /** @class */ (function (_super) {
    __extends(PutCategoriesIdJsonQueryParams, _super);
    function PutCategoriesIdJsonQueryParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=authtoken" }),
        __metadata("design:type", String)
    ], PutCategoriesIdJsonQueryParams.prototype, "authtoken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=login" }),
        __metadata("design:type", String)
    ], PutCategoriesIdJsonQueryParams.prototype, "login", void 0);
    return PutCategoriesIdJsonQueryParams;
}(SpeakeasyBase));
export { PutCategoriesIdJsonQueryParams };
var PutCategoriesIdJsonRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", PutCategoriesIdJsonQueryParams)
    ], PutCategoriesIdJsonRequest.prototype, "queryParams", void 0);
    __decorate([
