...
class PutProductsIDOptionsOptionIDValuesValueIDJSONRequest:
    path_params: PutProductsIDOptionsOptionIDValuesValueIDJSONPathParams = field(default=None)
    query_params: PutProductsIDOptionsOptionIDValuesValueIDJSONQueryParams = field(default=None)
