...
class DeleteProductsIDAttachmentsAttachmentIDJSONRequest:
    path_params: DeleteProductsIDAttachmentsAttachmentIDJSONPathParams = field(default=None)
    query_params: DeleteProductsIDAttachmentsAttachmentIDJSONQueryParams = field(default=None)
