...
class DeleteProductsIDImagesImageIDJSONRequest:
    path_params: DeleteProductsIDImagesImageIDJSONPathParams = field(default=None)
    query_params: DeleteProductsIDImagesImageIDJSONQueryParams = field(default=None)
