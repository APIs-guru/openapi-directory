...
class GetStoreCheckStatusJSONQueryParams:
    ...
    store_code: str = field(default=None, metadata={'query_param': { 'field_name': 'store_code', 'style': 'form', 'explode': True }})
    

@dataclass
class GetStoreCheckStatusJSONRequest:
    query_params: GetStoreCheckStatusJSONQueryParams = field(default=None)
