...
class GetCustomFieldsIDSelectOptionsCustomFieldSelectOptionIDJSONRequest:
    path_params: GetCustomFieldsIDSelectOptionsCustomFieldSelectOptionIDJSONPathParams = field()
    query_params: GetCustomFieldsIDSelectOptionsCustomFieldSelectOptionIDJSONQueryParams = field()
