...
class PutCustomFieldsIDSelectOptionsCustomFieldSelectOptionIDJSONRequest:
    path_params: PutCustomFieldsIDSelectOptionsCustomFieldSelectOptionIDJSONPathParams = field(default=None)
    query_params: PutCustomFieldsIDSelectOptionsCustomFieldSelectOptionIDJSONQueryParams = field(default=None)
