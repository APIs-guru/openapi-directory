...
class DeleteProductsIDOptionsOptionIDJSONRequest:
    path_params: DeleteProductsIDOptionsOptionIDJSONPathParams = field(default=None)
    query_params: DeleteProductsIDOptionsOptionIDJSONQueryParams = field(default=None)
