...
class PageModifyFields:
    ...
    image: Optional[PageModifyFieldsImage] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('image') }})
    ...
    status: Optional[PageModifyFieldsStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
