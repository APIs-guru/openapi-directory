...
class CustomerFields:
    ...
    customer_additional_fields: Optional[List[CustomerAdditionalField]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('customer_additional_fields') }})
    customer_categories: Optional[List[CustomerCategory]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('customer_categories') }})
    ...
    status: Optional[CustomerFieldsStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
