...
**/
var GoogleCloudDatalabelingV1beta1VideoClassificationAnnotation = /** @class */ (function (_super) {
    __extends(GoogleCloudDatalabelingV1beta1VideoClassificationAnnotation, _super);
    function GoogleCloudDatalabelingV1beta1VideoClassificationAnnotation() {
    ...
    ], GoogleCloudDatalabelingV1beta1VideoClassificationAnnotation.prototype, "annotationSpec", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=timeSegment" }),
        __metadata("design:type", GoogleCloudDatalabelingV1beta1TimeSegment)
    ], GoogleCloudDatalabelingV1beta1VideoClassificationAnnotation.prototype, "timeSegment", void 0);
    return GoogleCloudDatalabelingV1beta1VideoClassificationAnnotation;
}(SpeakeasyBase));
export { GoogleCloudDatalabelingV1beta1VideoClassificationAnnotation };
