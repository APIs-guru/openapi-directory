...
class GoogleCloudDatalabelingV1beta1Example:
    ...
    annotations: Optional[List[GoogleCloudDatalabelingV1beta1Annotation]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('annotations') }})
