...
class GoogleCloudDatalabelingV1beta1ConfidenceMetricsEntry:
    ...
    f1_score_at5: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'f1ScoreAt5' }})
    ...
    precision_at5: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'precisionAt5' }})
    ...
    recall_at5: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'recallAt5' }})
