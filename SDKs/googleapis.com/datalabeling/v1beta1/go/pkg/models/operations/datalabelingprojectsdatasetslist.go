...
type DatalabelingProjectsDatasetsListPathParams struct {
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type DatalabelingProjectsDatasetsListQueryParams struct {
...
type DatalabelingProjectsDatasetsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DatalabelingProjectsDatasetsListRequest struct {
...
type DatalabelingProjectsDatasetsListResponse struct {
	ContentType                                        string
