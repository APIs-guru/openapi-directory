...
func (s *SDK) IndexingURLNotificationsGetMetadata(ctx context.Context, request operations.IndexingURLNotificationsGetMetadataRequest) (*operations.IndexingURLNotificationsGetMetadataResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) IndexingURLNotificationsPublish(ctx context.Context, request operations.IndexingURLNotificationsPublishRequest) (*operations.IndexingURLNotificationsPublishResponse, error) {
	baseURL := s.serverURL
