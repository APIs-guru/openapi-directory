...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.AlertcenterAlertsBatchDelete = function (req, config) {
        var _a;
    ...
    SDK.prototype.AlertcenterAlertsBatchUndelete = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.AlertcenterAlertsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.AlertcenterAlertsFeedbackCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.AlertcenterAlertsFeedbackList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.AlertcenterAlertsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.AlertcenterAlertsGetMetadata = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.AlertcenterAlertsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.AlertcenterAlertsUndelete = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.AlertcenterGetSettings = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AlertcenterGetSettingsRequest(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v1beta1/settings";
        var client = CreateSecurityClient(this.defaultClient, req.security);
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.AlertcenterUpdateSettings = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
