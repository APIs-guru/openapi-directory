...
class BackfillAllStrategy:
    ...
    postgresql_excluded_objects: Optional[postgresqlrdbms.PostgresqlRdbms] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'postgresqlExcludedObjects' }})
