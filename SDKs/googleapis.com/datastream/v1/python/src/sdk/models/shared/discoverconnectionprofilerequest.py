...
class DiscoverConnectionProfileRequestInput:
    ...
    full_hierarchy: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('fullHierarchy') }})
    hierarchy_depth: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('hierarchyDepth') }})
