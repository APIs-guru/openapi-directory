...
class DatastreamProjectsLocationsConnectionProfilesCreateRequest:
    path_params: DatastreamProjectsLocationsConnectionProfilesCreatePathParams = field()
    query_params: DatastreamProjectsLocationsConnectionProfilesCreateQueryParams = field()
    security: DatastreamProjectsLocationsConnectionProfilesCreateSecurity = field()
