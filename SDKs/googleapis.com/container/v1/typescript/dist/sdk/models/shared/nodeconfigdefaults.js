...
**/
var NodeConfigDefaults = /** @class */ (function (_super) {
    __extends(NodeConfigDefaults, _super);
    function NodeConfigDefaults() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=gcfsConfig" }),
        __metadata("design:type", GcfsConfig)
    ], NodeConfigDefaults.prototype, "gcfsConfig", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=loggingConfig" }),
        __metadata("design:type", NodePoolLoggingConfig)
    ], NodeConfigDefaults.prototype, "loggingConfig", void 0);
    return NodeConfigDefaults;
}(SpeakeasyBase));
export { NodeConfigDefaults };
