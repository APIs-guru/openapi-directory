...
@dataclass
class ContainerProjectsLocationsClustersNodePoolsDeleteQueryParams:
    ...
    node_pool_id: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'nodePoolId', 'style': 'form', 'explode': True }})
    ...
    zone: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'zone', 'style': 'form', 'explode': True }})
