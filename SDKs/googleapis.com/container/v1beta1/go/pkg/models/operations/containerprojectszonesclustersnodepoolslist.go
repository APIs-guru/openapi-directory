...
type ContainerProjectsZonesClustersNodePoolsListPathParams struct {
...
type ContainerProjectsZonesClustersNodePoolsListQueryParams struct {
...
type ContainerProjectsZonesClustersNodePoolsListSecurity struct {
    Oauth2 shared.SchemeOauth2 `security:"scheme,type=oauth2"`
    Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
    
}

type ContainerProjectsZonesClustersNodePoolsListRequest struct {
...
type ContainerProjectsZonesClustersNodePoolsListResponse struct {
    ContentType string 
