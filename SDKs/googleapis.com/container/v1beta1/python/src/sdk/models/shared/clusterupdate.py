...
class ClusterUpdate:
    ...
    desired_cluster_telemetry: Optional[ClusterTelemetry] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('desiredClusterTelemetry') }})
    ...
    desired_master: Optional[dict[str, Any]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('desiredMaster') }})
    ...
    desired_pod_security_policy_config: Optional[PodSecurityPolicyConfig] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('desiredPodSecurityPolicyConfig') }})
    ...
    desired_protect_config: Optional[ProtectConfig] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('desiredProtectConfig') }})
    ...
    desired_tpu_config: Optional[TpuConfig] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('desiredTpuConfig') }})
    ...
    desired_workload_alts_config: Optional[WorkloadAltsConfig] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('desiredWorkloadAltsConfig') }})
    desired_workload_certificates: Optional[WorkloadCertificates] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('desiredWorkloadCertificates') }})
