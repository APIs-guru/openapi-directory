...
class NodePool:
    ...
    placement_policy: Optional[placementpolicy.PlacementPolicy] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'placementPolicy' }})
