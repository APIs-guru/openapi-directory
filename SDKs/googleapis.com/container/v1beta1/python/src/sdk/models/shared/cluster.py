...
class Cluster:
    ...
    cluster_telemetry: Optional[clustertelemetry.ClusterTelemetry] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'clusterTelemetry' }})
    ...
    master: Optional[dict[str, Any]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'master' }})
    ...
    pod_security_policy_config: Optional[podsecuritypolicyconfig.PodSecurityPolicyConfig] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'podSecurityPolicyConfig' }})
    private_cluster: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'privateCluster' }})
    ...
    protect_config: Optional[protectconfig.ProtectConfig] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'protectConfig' }})
    ...
    tpu_config: Optional[tpuconfig.TpuConfig] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'tpuConfig' }})
    ...
    workload_alts_config: Optional[workloadaltsconfig.WorkloadAltsConfig] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'workloadAltsConfig' }})
    workload_certificates: Optional[workloadcertificates.WorkloadCertificates] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'workloadCertificates' }})
