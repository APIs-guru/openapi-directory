...
export var DnsConfigClusterDnsEnum;
(function (DnsConfigClusterDnsEnum) {
...
})(DnsConfigClusterDnsEnum || (DnsConfigClusterDnsEnum = {}));
export var DnsConfigClusterDnsScopeEnum;
(function (DnsConfigClusterDnsScopeEnum) {
...
})(DnsConfigClusterDnsScopeEnum || (DnsConfigClusterDnsScopeEnum = {}));
// DnsConfig
/**
 * DNSConfig contains the desired set of options for configuring clusterDNS.
**/
var DnsConfig = /** @class */ (function (_super) {
    __extends(DnsConfig, _super);
    function DnsConfig() {
    ...
    ], DnsConfig.prototype, "clusterDns", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=clusterDnsDomain" }),
        __metadata("design:type", String)
    ], DnsConfig.prototype, "clusterDnsDomain", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=clusterDnsScope" }),
        __metadata("design:type", String)
    ], DnsConfig.prototype, "clusterDnsScope", void 0);
    return DnsConfig;
}(SpeakeasyBase));
export { DnsConfig };
