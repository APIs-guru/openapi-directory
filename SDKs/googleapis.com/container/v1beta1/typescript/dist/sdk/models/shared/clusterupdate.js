...
var ClusterUpdate = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata({ data: "json, name=desiredClusterTelemetry" }),
        __metadata("design:type", ClusterTelemetry)
    ...
    __decorate([
        SpeakeasyMetadata({ data: "json, name=desiredMaster" }),
    ...
    __decorate([
        SpeakeasyMetadata({ data: "json, name=desiredPodSecurityPolicyConfig" }),
        __metadata("design:type", PodSecurityPolicyConfig)
    ...
    __decorate([
        SpeakeasyMetadata({ data: "json, name=desiredProtectConfig" }),
        __metadata("design:type", ProtectConfig)
    ...
    __decorate([
        SpeakeasyMetadata({ data: "json, name=desiredTpuConfig" }),
        __metadata("design:type", TpuConfig)
    ...
    __decorate([
        SpeakeasyMetadata({ data: "json, name=desiredWorkloadAltsConfig" }),
        __metadata("design:type", WorkloadAltsConfig)
    ], ClusterUpdate.prototype, "desiredWorkloadAltsConfig", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=desiredWorkloadCertificates" }),
        __metadata("design:type", WorkloadCertificates)
