...
var BillingAccounts = /** @class */ (function () {
    ...
    **/
    BillingAccounts.prototype.cloudbillingBillingAccountsEstimateCostScenario = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CloudbillingBillingAccountsEstimateCostScenarioRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta/{billingAccount}:estimateCostScenario", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.estimateCostScenarioForBillingAccountResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
