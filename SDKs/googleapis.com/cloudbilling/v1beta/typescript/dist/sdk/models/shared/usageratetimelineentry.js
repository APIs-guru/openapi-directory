...
**/
var UsageRateTimelineEntry = /** @class */ (function (_super) {
    __extends(UsageRateTimelineEntry, _super);
    function UsageRateTimelineEntry() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=effectiveTime" }),
        __metadata("design:type", EstimationTimePoint)
    ], UsageRateTimelineEntry.prototype, "effectiveTime", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=usageRate" }),
        __metadata("design:type", Number)
    ], UsageRateTimelineEntry.prototype, "usageRate", void 0);
    return UsageRateTimelineEntry;
}(SpeakeasyBase));
export { UsageRateTimelineEntry };
