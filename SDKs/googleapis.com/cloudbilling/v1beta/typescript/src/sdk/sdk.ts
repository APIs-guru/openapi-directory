  ...
  CloudbillingBillingAccountsEstimateCostScenario(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        let res: operations.CloudbillingBillingAccountsEstimateCostScenarioResponse = {statusCode: httpRes.status, contentType: contentType};
  ...
  CloudbillingEstimateCostScenario(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.CloudbillingEstimateCostScenarioResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
