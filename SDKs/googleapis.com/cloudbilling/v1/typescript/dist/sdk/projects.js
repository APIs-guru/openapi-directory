...
var Projects = /** @class */ (function () {
    ...
    **/
    Projects.prototype.cloudbillingProjectsGetBillingInfo = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CloudbillingProjectsGetBillingInfoRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{name}/billingInfo", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.projectBillingInfo = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Projects.prototype.cloudbillingProjectsUpdateBillingInfo = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
