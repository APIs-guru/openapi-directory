...
var MemInfo = /** @class */ (function (_super) {
    ...
    ], MemInfo.prototype, "currentLimitBytes", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=currentOoms" }),
        __metadata("design:type", String)
    ], MemInfo.prototype, "currentOoms", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=currentRssBytes" }),
        __metadata("design:type", String)
    ], MemInfo.prototype, "currentRssBytes", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=timestamp" }),
        __metadata("design:type", String)
    ], MemInfo.prototype, "timestamp", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=totalGbMs" }),
        __metadata("design:type", String)
    ], MemInfo.prototype, "totalGbMs", void 0);
    return MemInfo;
}(SpeakeasyBase));
export { MemInfo };
