...
@dataclass
class DataflowProjectsJobsDebugSendCaptureQueryParams:
...
class DataflowProjectsJobsDebugSendCaptureSecurity:
    option1: Optional[DataflowProjectsJobsDebugSendCaptureSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DataflowProjectsJobsDebugSendCaptureSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[DataflowProjectsJobsDebugSendCaptureSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
    option4: Optional[DataflowProjectsJobsDebugSendCaptureSecurityOption4] = field(default=None, metadata={'security': { 'option': True }})
