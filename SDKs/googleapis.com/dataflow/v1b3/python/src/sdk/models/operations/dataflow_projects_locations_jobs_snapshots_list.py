...
class DataflowProjectsLocationsJobsSnapshotsListRequest:
    path_params: DataflowProjectsLocationsJobsSnapshotsListPathParams = field()
    query_params: DataflowProjectsLocationsJobsSnapshotsListQueryParams = field()
    security: DataflowProjectsLocationsJobsSnapshotsListSecurity = field()
