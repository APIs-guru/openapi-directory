...
class DataflowProjectsJobsMessagesListRequest:
    path_params: DataflowProjectsJobsMessagesListPathParams = field()
    query_params: DataflowProjectsJobsMessagesListQueryParams = field()
    security: DataflowProjectsJobsMessagesListSecurity = field()
