...
class DataflowProjectsJobsCreateRequest:
    path_params: DataflowProjectsJobsCreatePathParams = field()
    query_params: DataflowProjectsJobsCreateQueryParams = field()
    security: DataflowProjectsJobsCreateSecurity = field()
