...
class DataflowProjectsLocationsSnapshotsListRequest:
    path_params: DataflowProjectsLocationsSnapshotsListPathParams = field(default=None)
    query_params: DataflowProjectsLocationsSnapshotsListQueryParams = field(default=None)
    security: DataflowProjectsLocationsSnapshotsListSecurity = field(default=None)
