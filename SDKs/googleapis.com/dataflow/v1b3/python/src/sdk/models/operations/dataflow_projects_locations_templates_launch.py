...
class DataflowProjectsLocationsTemplatesLaunchRequest:
    path_params: DataflowProjectsLocationsTemplatesLaunchPathParams = field(default=None)
    query_params: DataflowProjectsLocationsTemplatesLaunchQueryParams = field(default=None)
    request: Optional[shared.LaunchTemplateParameters] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: DataflowProjectsLocationsTemplatesLaunchSecurity = field(default=None)
