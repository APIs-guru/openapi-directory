...
@dataclass
class DataflowProjectsDeleteSnapshotsQueryParams:
...
class DataflowProjectsDeleteSnapshotsSecurity:
    option1: Optional[DataflowProjectsDeleteSnapshotsSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DataflowProjectsDeleteSnapshotsSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[DataflowProjectsDeleteSnapshotsSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
    option4: Optional[DataflowProjectsDeleteSnapshotsSecurityOption4] = field(default=None, metadata={'security': { 'option': True }})
