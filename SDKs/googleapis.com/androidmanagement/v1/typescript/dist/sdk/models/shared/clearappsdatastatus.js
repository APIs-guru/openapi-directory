...
**/
var ClearAppsDataStatus = /** @class */ (function (_super) {
    __extends(ClearAppsDataStatus, _super);
    function ClearAppsDataStatus() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=results", elemType: PerAppResult }),
        __metadata("design:type", Map)
    ], ClearAppsDataStatus.prototype, "results", void 0);
    return ClearAppsDataStatus;
}(SpeakeasyBase));
export { ClearAppsDataStatus };
