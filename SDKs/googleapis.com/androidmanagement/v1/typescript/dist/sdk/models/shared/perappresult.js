...
export var PerAppResultClearingResultEnum;
(function (PerAppResultClearingResultEnum) {
...
})(PerAppResultClearingResultEnum || (PerAppResultClearingResultEnum = {}));
// PerAppResult
/**
 * The result of an attempt to clear the data of a single app.
**/
var PerAppResult = /** @class */ (function (_super) {
    __extends(PerAppResult, _super);
    function PerAppResult() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=clearingResult" }),
        __metadata("design:type", String)
    ], PerAppResult.prototype, "clearingResult", void 0);
    return PerAppResult;
}(SpeakeasyBase));
export { PerAppResult };
