...
export var MemoryEventEventTypeEnum;
(function (MemoryEventEventTypeEnum) {
...
})(MemoryEventEventTypeEnum || (MemoryEventEventTypeEnum = {}));
// MemoryEvent
/**
 * An event related to memory and storage measurements.
**/
var MemoryEvent = /** @class */ (function (_super) {
    __extends(MemoryEvent, _super);
    ...
    ], MemoryEvent.prototype, "byteCount", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=createTime" }),
        __metadata("design:type", String)
    ], MemoryEvent.prototype, "createTime", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=eventType" }),
        __metadata("design:type", String)
    ], MemoryEvent.prototype, "eventType", void 0);
    return MemoryEvent;
}(SpeakeasyBase));
export { MemoryEvent };
