...
**/
var ChoosePrivateKeyRule = /** @class */ (function (_super) {
    __extends(ChoosePrivateKeyRule, _super);
    function ChoosePrivateKeyRule() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=packageNames" }),
        __metadata("design:type", Array)
    ], ChoosePrivateKeyRule.prototype, "packageNames", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=privateKeyAlias" }),
        __metadata("design:type", String)
    ], ChoosePrivateKeyRule.prototype, "privateKeyAlias", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=urlPattern" }),
        __metadata("design:type", String)
    ], ChoosePrivateKeyRule.prototype, "urlPattern", void 0);
    return ChoosePrivateKeyRule;
}(SpeakeasyBase));
export { ChoosePrivateKeyRule };
