...
@dataclass
class AndroidmanagementEnterprisesCreateQueryParams:
    dollar_xgafv: Optional[shared.XgafvEnum] = field(default=None, metadata={'query_param': { 'field_name': '$.xgafv', 'style': 'form', 'explode': True }})
    access_token: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'access_token', 'style': 'form', 'explode': True }})
    agreement_accepted: Optional[bool] = field(default=None, metadata={'query_param': { 'field_name': 'agreementAccepted', 'style': 'form', 'explode': True }})
    ...
    signup_url_name: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'signupUrlName', 'style': 'form', 'explode': True }})
