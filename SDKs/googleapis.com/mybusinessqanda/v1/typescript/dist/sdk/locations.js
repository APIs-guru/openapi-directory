...
var Locations = /** @class */ (function () {
    ...
    **/
    Locations.prototype.mybusinessqandaLocationsQuestionsAnswersDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.MybusinessqandaLocationsQuestionsAnswersDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{name}/answers:delete", req.pathParams);
    ...
    **/
    Locations.prototype.mybusinessqandaLocationsQuestionsAnswersList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.MybusinessqandaLocationsQuestionsAnswersListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{parent}/answers", req.pathParams);
        var client = this._defaultClient;
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    Locations.prototype.mybusinessqandaLocationsQuestionsAnswersUpsert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.MybusinessqandaLocationsQuestionsAnswersUpsertRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{parent}/answers:upsert", req.pathParams);
    ...
    **/
    Locations.prototype.mybusinessqandaLocationsQuestionsCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Locations.prototype.mybusinessqandaLocationsQuestionsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Locations.prototype.mybusinessqandaLocationsQuestionsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Locations.prototype.mybusinessqandaLocationsQuestionsPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
