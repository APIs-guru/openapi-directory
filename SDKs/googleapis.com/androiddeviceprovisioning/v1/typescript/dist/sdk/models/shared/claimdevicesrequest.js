...
**/
var ClaimDevicesRequest = /** @class */ (function (_super) {
    __extends(ClaimDevicesRequest, _super);
    function ClaimDevicesRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "json, name=claims", elemType: shared.PartnerClaim }),
        __metadata("design:type", Array)
    ], ClaimDevicesRequest.prototype, "claims", void 0);
    return ClaimDevicesRequest;
}(SpeakeasyBase));
export { ClaimDevicesRequest };
