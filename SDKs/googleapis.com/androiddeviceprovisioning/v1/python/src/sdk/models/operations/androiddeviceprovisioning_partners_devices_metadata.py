...
class AndroiddeviceprovisioningPartnersDevicesMetadataPathParams:
    ...
    metadata_owner_id: str = field(default=None, metadata={'path_param': { 'field_name': 'metadataOwnerId', 'style': 'simple', 'explode': False }})
...
class AndroiddeviceprovisioningPartnersDevicesMetadataRequest:
    path_params: AndroiddeviceprovisioningPartnersDevicesMetadataPathParams = field(default=None)
    query_params: AndroiddeviceprovisioningPartnersDevicesMetadataQueryParams = field(default=None)
