...
var AgentUsers = /** @class */ (function () {
    function AgentUsers(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    AgentUsers.prototype.homegraphAgentUsersDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.HomegraphAgentUsersDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{agentUserId}", req.pathParams);
