...
class DomainsProjectsLocationsRegistrationsImportRequest:
    path_params: DomainsProjectsLocationsRegistrationsImportPathParams = field()
    query_params: DomainsProjectsLocationsRegistrationsImportQueryParams = field()
    security: DomainsProjectsLocationsRegistrationsImportSecurity = field()
