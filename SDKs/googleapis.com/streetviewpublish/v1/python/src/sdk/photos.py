...
class Photos:
    ...
    def streetviewpublish_photos_batch_delete(self, request: operations.StreetviewpublishPhotosBatchDeleteRequest) -> operations.StreetviewpublishPhotosBatchDeleteResponse:
        r"""Deletes a list of Photos and their metadata. Note that if BatchDeletePhotos fails, either critical fields are missing or there is an authentication error. Even if BatchDeletePhotos succeeds, individual photos in the batch may have failures. These failures are specified in each PhotoResponse.status in BatchDeletePhotosResponse.results. See DeletePhoto for specific failures that can occur per photo.
        """
    ...
    def streetviewpublish_photos_batch_get(self, request: operations.StreetviewpublishPhotosBatchGetRequest) -> operations.StreetviewpublishPhotosBatchGetResponse:
        r"""Gets the metadata of the specified Photo batch. Note that if BatchGetPhotos fails, either critical fields are missing or there is an authentication error. Even if BatchGetPhotos succeeds, individual photos in the batch may have failures. These failures are specified in each PhotoResponse.status in BatchGetPhotosResponse.results. See GetPhoto for specific failures that can occur per photo.
        """
    ...
    def streetviewpublish_photos_list(self, request: operations.StreetviewpublishPhotosListRequest) -> operations.StreetviewpublishPhotosListResponse:
        r"""Lists all the Photos that belong to the user. > Note: Recently created photos that are still being indexed are not returned in the response.
        """
