...
class StreetviewpublishPhotoSequenceCreateRequest:
    query_params: StreetviewpublishPhotoSequenceCreateQueryParams = field()
    security: StreetviewpublishPhotoSequenceCreateSecurity = field()
    request: Optional[shared.PhotoSequenceInput] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
