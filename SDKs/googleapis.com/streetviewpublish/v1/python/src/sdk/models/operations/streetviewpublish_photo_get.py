...
@dataclass
class StreetviewpublishPhotoGetQueryParams:
    ...
    view: Optional[StreetviewpublishPhotoGetViewEnum] = field(default=None, metadata={'query_param': { 'field_name': 'view', 'style': 'form', 'explode': True }})
