...
func NewPhoto(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *Photo {
	return &Photo{
...
func (s *Photo) StreetviewpublishPhotoCreate(ctx context.Context, request operations.StreetviewpublishPhotoCreateRequest) (*operations.StreetviewpublishPhotoCreateResponse, error) {
...
func (s *Photo) StreetviewpublishPhotoDelete(ctx context.Context, request operations.StreetviewpublishPhotoDeleteRequest) (*operations.StreetviewpublishPhotoDeleteResponse, error) {
	baseURL := s._serverURL
...
func (s *Photo) StreetviewpublishPhotoGet(ctx context.Context, request operations.StreetviewpublishPhotoGetRequest) (*operations.StreetviewpublishPhotoGetResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/photo/{photoId}", request.PathParams)
...
func (s *Photo) StreetviewpublishPhotoStartUpload(ctx context.Context, request operations.StreetviewpublishPhotoStartUploadRequest) (*operations.StreetviewpublishPhotoStartUploadResponse, error) {
	baseURL := s._serverURL
...
func (s *Photo) StreetviewpublishPhotoUpdate(ctx context.Context, request operations.StreetviewpublishPhotoUpdateRequest) (*operations.StreetviewpublishPhotoUpdateResponse, error) {
	baseURL := s._serverURL
