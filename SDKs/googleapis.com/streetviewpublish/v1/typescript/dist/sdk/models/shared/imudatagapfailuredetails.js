...
**/
var ImuDataGapFailureDetails = /** @class */ (function (_super) {
    __extends(ImuDataGapFailureDetails, _super);
    function ImuDataGapFailureDetails() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=gapDuration" }),
        __metadata("design:type", String)
    ], ImuDataGapFailureDetails.prototype, "gapDuration", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=gapStartTime" }),
        __metadata("design:type", String)
    ], ImuDataGapFailureDetails.prototype, "gapStartTime", void 0);
    return ImuDataGapFailureDetails;
}(SpeakeasyBase));
export { ImuDataGapFailureDetails };
