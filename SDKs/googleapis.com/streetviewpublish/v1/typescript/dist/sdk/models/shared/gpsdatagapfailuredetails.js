...
**/
var GpsDataGapFailureDetails = /** @class */ (function (_super) {
    __extends(GpsDataGapFailureDetails, _super);
    function GpsDataGapFailureDetails() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=gapDuration" }),
        __metadata("design:type", String)
    ], GpsDataGapFailureDetails.prototype, "gapDuration", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=gapStartTime" }),
        __metadata("design:type", String)
    ], GpsDataGapFailureDetails.prototype, "gapStartTime", void 0);
    return GpsDataGapFailureDetails;
}(SpeakeasyBase));
export { GpsDataGapFailureDetails };
