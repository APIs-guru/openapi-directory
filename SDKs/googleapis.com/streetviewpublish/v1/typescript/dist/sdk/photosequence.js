...
var PhotoSequence = /** @class */ (function () {
    function PhotoSequence(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    PhotoSequence.prototype.streetviewpublishPhotoSequenceCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.StreetviewpublishPhotoSequenceCreateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v1/photoSequence";
    ...
    **/
    PhotoSequence.prototype.streetviewpublishPhotoSequenceDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.StreetviewpublishPhotoSequenceDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/photoSequence/{sequenceId}", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    PhotoSequence.prototype.streetviewpublishPhotoSequenceGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    PhotoSequence.prototype.streetviewpublishPhotoSequenceStartUpload = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.StreetviewpublishPhotoSequenceStartUploadRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v1/photoSequence:startUpload";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
