...
class ReportsUserUsageReportGetRequest:
    path_params: ReportsUserUsageReportGetPathParams = field()
    query_params: ReportsUserUsageReportGetQueryParams = field()
    security: ReportsUserUsageReportGetSecurity = field()
