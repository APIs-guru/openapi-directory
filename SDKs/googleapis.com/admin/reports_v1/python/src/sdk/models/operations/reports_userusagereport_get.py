...
class ReportsUserUsageReportGetRequest:
    path_params: ReportsUserUsageReportGetPathParams = field(default=None)
    query_params: ReportsUserUsageReportGetQueryParams = field(default=None)
    security: ReportsUserUsageReportGetSecurity = field(default=None)
