...
var Activities = /** @class */ (function () {
    ...
    **/
    Activities.prototype.reportsActivitiesList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ReportsActivitiesListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/admin/reports/v1/activity/users/{userKey}/applications/{applicationName}", req.pathParams);
    ...
    **/
    Activities.prototype.reportsActivitiesWatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ReportsActivitiesWatchRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/admin/reports/v1/activity/users/{userKey}/applications/{applicationName}/watch", req.pathParams);
