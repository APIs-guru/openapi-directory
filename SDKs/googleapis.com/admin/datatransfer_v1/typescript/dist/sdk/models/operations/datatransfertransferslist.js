...
var DatatransferTransfersListQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=newOwnerUserId" }),
        __metadata("design:type", String)
    ...
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=oldOwnerUserId" }),
        __metadata("design:type", String)
