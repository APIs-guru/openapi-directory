...
var Transfers = /** @class */ (function () {
    ...
    **/
    Transfers.prototype.datatransferTransfersGet = function (req, config) {
    ...
    **/
    Transfers.prototype.datatransferTransfersInsert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Transfers.prototype.datatransferTransfersList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
