...
var Tokens = /** @class */ (function () {
    ...
    **/
    Tokens.prototype.directoryTokensDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DirectoryTokensDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/admin/directory/v1/users/{userKey}/tokens/{clientId}", req.pathParams);
    ...
    **/
    Tokens.prototype.directoryTokensGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Tokens.prototype.directoryTokensList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DirectoryTokensListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/admin/directory/v1/users/{userKey}/tokens", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.tokens = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
