...
var Schema = /** @class */ (function (_super) {
    ...
    ], Schema.prototype, "displayName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=etag" }),
        __metadata("design:type", String)
    ], Schema.prototype, "etag", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], Schema.prototype, "kind", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=schemaId" }),
        __metadata("design:type", String)
    ], Schema.prototype, "schemaId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=schemaName" }),
        __metadata("design:type", String)
    ], Schema.prototype, "schemaName", void 0);
    return Schema;
}(SpeakeasyBase));
export { Schema };
