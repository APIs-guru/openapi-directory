...
class AdminCustomerDevicesChromeosCommandsGetPathParams:
    command_id: str = field(default=None, metadata={'path_param': { 'field_name': 'commandId', 'style': 'simple', 'explode': False }})
...
class AdminCustomerDevicesChromeosCommandsGetRequest:
    path_params: AdminCustomerDevicesChromeosCommandsGetPathParams = field(default=None)
    query_params: AdminCustomerDevicesChromeosCommandsGetQueryParams = field(default=None)
    security: AdminCustomerDevicesChromeosCommandsGetSecurity = field(default=None)
