...
@dataclass
class DirectoryRoleAssignmentsListQueryParams:
    ...
    role_id: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'roleId', 'style': 'form', 'explode': True }})
...
class DirectoryRoleAssignmentsListSecurity:
    option1: Optional[DirectoryRoleAssignmentsListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DirectoryRoleAssignmentsListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
