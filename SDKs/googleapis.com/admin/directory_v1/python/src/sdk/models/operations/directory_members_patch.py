...
class DirectoryMembersPatchRequest:
    path_params: DirectoryMembersPatchPathParams = field(default=None)
    query_params: DirectoryMembersPatchQueryParams = field(default=None)
    request: Optional[shared.Member] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: DirectoryMembersPatchSecurity = field(default=None)
