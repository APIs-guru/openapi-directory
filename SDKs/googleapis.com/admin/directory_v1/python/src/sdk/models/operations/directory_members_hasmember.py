...
class DirectoryMembersHasMemberRequest:
    path_params: DirectoryMembersHasMemberPathParams = field()
    query_params: DirectoryMembersHasMemberQueryParams = field()
    security: DirectoryMembersHasMemberSecurity = field()
