...
@dataclass
class DirectoryResourcesCalendarsGetQueryParams:
...
@dataclass
class DirectoryResourcesCalendarsGetSecurity:
    option1: Optional[DirectoryResourcesCalendarsGetSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DirectoryResourcesCalendarsGetSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
