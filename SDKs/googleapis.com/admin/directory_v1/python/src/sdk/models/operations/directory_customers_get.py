...
@dataclass
class DirectoryCustomersGetQueryParams:
...
class DirectoryCustomersGetSecurity:
    option1: Optional[DirectoryCustomersGetSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DirectoryCustomersGetSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
