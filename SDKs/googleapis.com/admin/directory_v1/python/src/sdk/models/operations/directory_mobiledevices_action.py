...
class DirectoryMobiledevicesActionRequest:
    path_params: DirectoryMobiledevicesActionPathParams = field(default=None)
    query_params: DirectoryMobiledevicesActionQueryParams = field(default=None)
    request: Optional[shared.MobileDeviceAction] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: DirectoryMobiledevicesActionSecurity = field(default=None)
