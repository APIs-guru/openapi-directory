...
@dataclass
class DirectoryResourcesCalendarsListQueryParams:
...
class DirectoryResourcesCalendarsListSecurity:
    option1: Optional[DirectoryResourcesCalendarsListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DirectoryResourcesCalendarsListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
