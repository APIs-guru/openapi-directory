...
class DirectoryChromeosdevicesUpdateRequest:
    path_params: DirectoryChromeosdevicesUpdatePathParams = field()
    query_params: DirectoryChromeosdevicesUpdateQueryParams = field()
    security: DirectoryChromeosdevicesUpdateSecurity = field()
