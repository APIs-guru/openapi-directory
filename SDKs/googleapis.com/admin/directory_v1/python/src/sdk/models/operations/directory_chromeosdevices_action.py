...
class DirectoryChromeosdevicesActionRequest:
    path_params: DirectoryChromeosdevicesActionPathParams = field()
    query_params: DirectoryChromeosdevicesActionQueryParams = field()
    security: DirectoryChromeosdevicesActionSecurity = field()
