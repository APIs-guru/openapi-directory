...
class DirectoryOrgunitsUpdateRequest:
    path_params: DirectoryOrgunitsUpdatePathParams = field()
    query_params: DirectoryOrgunitsUpdateQueryParams = field()
    security: DirectoryOrgunitsUpdateSecurity = field()
