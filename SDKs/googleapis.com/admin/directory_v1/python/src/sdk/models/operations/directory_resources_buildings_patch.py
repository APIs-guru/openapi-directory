...
class DirectoryResourcesBuildingsPatchRequest:
    path_params: DirectoryResourcesBuildingsPatchPathParams = field(default=None)
    query_params: DirectoryResourcesBuildingsPatchQueryParams = field(default=None)
    request: Optional[shared.Building] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: DirectoryResourcesBuildingsPatchSecurity = field(default=None)
