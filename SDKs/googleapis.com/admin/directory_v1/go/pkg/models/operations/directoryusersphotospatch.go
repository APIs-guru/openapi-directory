...
type DirectoryUsersPhotosPatchPathParams struct {
	UserKey string `pathParam:"style=simple,explode=false,name=userKey"`
}

type DirectoryUsersPhotosPatchQueryParams struct {
...
type DirectoryUsersPhotosPatchSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DirectoryUsersPhotosPatchRequest struct {
...
type DirectoryUsersPhotosPatchResponse struct {
	ContentType string
	StatusCode  int64
