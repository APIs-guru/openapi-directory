...
func (s *SDK) BusinessprofileperformanceLocationsGetDailyMetricsTimeSeries(ctx context.Context, request operations.BusinessprofileperformanceLocationsGetDailyMetricsTimeSeriesRequest) (*operations.BusinessprofileperformanceLocationsGetDailyMetricsTimeSeriesResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) BusinessprofileperformanceLocationsSearchkeywordsImpressionsMonthlyList(ctx context.Context, request operations.BusinessprofileperformanceLocationsSearchkeywordsImpressionsMonthlyListRequest) (*operations.BusinessprofileperformanceLocationsSearchkeywordsImpressionsMonthlyListResponse, error) {
	baseURL := s.serverURL
