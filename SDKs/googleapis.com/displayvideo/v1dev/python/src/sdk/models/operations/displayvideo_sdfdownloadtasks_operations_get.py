...
class DisplayvideoSdfdownloadtasksOperationsGetRequest:
    path_params: DisplayvideoSdfdownloadtasksOperationsGetPathParams = field()
    query_params: DisplayvideoSdfdownloadtasksOperationsGetQueryParams = field()
    security: DisplayvideoSdfdownloadtasksOperationsGetSecurity = field()
