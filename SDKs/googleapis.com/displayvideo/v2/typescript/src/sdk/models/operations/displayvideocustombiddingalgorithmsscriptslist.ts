...
export class DisplayvideoCustomBiddingAlgorithmsScriptsListPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=customBiddingAlgorithmId" })
  customBiddingAlgorithmId: string;
}


export class DisplayvideoCustomBiddingAlgorithmsScriptsListQueryParams extends SpeakeasyBase {
