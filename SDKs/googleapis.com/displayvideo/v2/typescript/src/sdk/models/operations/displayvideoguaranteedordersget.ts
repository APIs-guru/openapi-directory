...
export class DisplayvideoGuaranteedOrdersGetPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=guaranteedOrderId" })
  guaranteedOrderId: string;
}


export class DisplayvideoGuaranteedOrdersGetQueryParams extends SpeakeasyBase {
...
export class DisplayvideoGuaranteedOrdersGetSecurity extends SpeakeasyBase {
...
export class DisplayvideoGuaranteedOrdersGetRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class DisplayvideoGuaranteedOrdersGetResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
