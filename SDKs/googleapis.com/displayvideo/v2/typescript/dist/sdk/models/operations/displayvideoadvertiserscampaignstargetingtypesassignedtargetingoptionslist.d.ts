...
export declare class DisplayvideoAdvertisersCampaignsTargetingTypesAssignedTargetingOptionsListPathParams extends SpeakeasyBase {
    advertiserId: string;
    campaignId: string;
    targetingType: DisplayvideoAdvertisersCampaignsTargetingTypesAssignedTargetingOptionsListTargetingTypeEnum;
}
export declare class DisplayvideoAdvertisersCampaignsTargetingTypesAssignedTargetingOptionsListQueryParams extends SpeakeasyBase {
