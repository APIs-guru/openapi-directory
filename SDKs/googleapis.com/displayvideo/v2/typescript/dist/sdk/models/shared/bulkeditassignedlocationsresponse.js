...
**/
var BulkEditAssignedLocationsResponse = /** @class */ (function (_super) {
    __extends(BulkEditAssignedLocationsResponse, _super);
    function BulkEditAssignedLocationsResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=assignedLocations", elemType: AssignedLocation }),
        __metadata("design:type", Array)
    ], BulkEditAssignedLocationsResponse.prototype, "assignedLocations", void 0);
    return BulkEditAssignedLocationsResponse;
}(SpeakeasyBase));
export { BulkEditAssignedLocationsResponse };
