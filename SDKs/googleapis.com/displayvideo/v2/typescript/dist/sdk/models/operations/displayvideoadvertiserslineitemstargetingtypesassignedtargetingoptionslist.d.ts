...
export declare class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsListPathParams extends SpeakeasyBase {
    advertiserId: string;
    lineItemId: string;
    targetingType: DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsListTargetingTypeEnum;
}
export declare class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsListQueryParams extends SpeakeasyBase {
