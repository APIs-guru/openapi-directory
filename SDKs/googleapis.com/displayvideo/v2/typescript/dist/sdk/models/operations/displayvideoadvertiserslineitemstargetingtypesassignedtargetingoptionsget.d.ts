...
export declare class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsGetPathParams extends SpeakeasyBase {
    advertiserId: string;
    assignedTargetingOptionId: string;
    lineItemId: string;
    targetingType: DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsGetTargetingTypeEnum;
}
export declare class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsGetQueryParams extends SpeakeasyBase {
