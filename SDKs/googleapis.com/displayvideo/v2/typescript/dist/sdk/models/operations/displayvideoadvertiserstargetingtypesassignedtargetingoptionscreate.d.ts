...
export declare class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsCreatePathParams extends SpeakeasyBase {
    advertiserId: string;
    targetingType: DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsCreateTargetingTypeEnum;
}
export declare class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsCreateQueryParams extends SpeakeasyBase {
