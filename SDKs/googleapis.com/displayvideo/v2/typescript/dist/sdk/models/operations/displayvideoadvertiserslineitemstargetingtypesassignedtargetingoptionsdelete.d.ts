...
export declare enum DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsDeleteTargetingTypeEnum {
...
export declare class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsDeletePathParams extends SpeakeasyBase {
    advertiserId: string;
    assignedTargetingOptionId: string;
    lineItemId: string;
    targetingType: DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsDeleteTargetingTypeEnum;
}
export declare class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsDeleteQueryParams extends SpeakeasyBase {
...
export declare class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsDeleteSecurity extends SpeakeasyBase {
    oauth2: shared.SchemeOauth2;
    oauth2c: shared.SchemeOauth2c;
}
export declare class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsDeleteRequest extends SpeakeasyBase {
...
export declare class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsDeleteResponse extends SpeakeasyBase {
    contentType: string;
