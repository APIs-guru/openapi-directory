...
export declare class DisplayvideoAdvertisersCampaignsTargetingTypesAssignedTargetingOptionsGetPathParams extends SpeakeasyBase {
    advertiserId: string;
    assignedTargetingOptionId: string;
    campaignId: string;
    targetingType: DisplayvideoAdvertisersCampaignsTargetingTypesAssignedTargetingOptionsGetTargetingTypeEnum;
}
export declare class DisplayvideoAdvertisersCampaignsTargetingTypesAssignedTargetingOptionsGetQueryParams extends SpeakeasyBase {
