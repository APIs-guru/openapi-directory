...
**/
var GoogleAudienceGroup = /** @class */ (function (_super) {
    __extends(GoogleAudienceGroup, _super);
    function GoogleAudienceGroup() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=settings", elemType: GoogleAudienceTargetingSetting }),
        __metadata("design:type", Array)
    ], GoogleAudienceGroup.prototype, "settings", void 0);
    return GoogleAudienceGroup;
}(SpeakeasyBase));
export { GoogleAudienceGroup };
