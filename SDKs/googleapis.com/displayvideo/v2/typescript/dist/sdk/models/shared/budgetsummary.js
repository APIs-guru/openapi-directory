...
var BudgetSummary = /** @class */ (function (_super) {
    ...
    ], BudgetSummary.prototype, "externalBudgetId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=preTaxAmountMicros" }),
        __metadata("design:type", String)
    ], BudgetSummary.prototype, "preTaxAmountMicros", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=prismaCpeCode" }),
        __metadata("design:type", PrismaCpeCode)
    ], BudgetSummary.prototype, "prismaCpeCode", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=taxAmountMicros" }),
        __metadata("design:type", String)
    ], BudgetSummary.prototype, "taxAmountMicros", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=totalAmountMicros" }),
        __metadata("design:type", String)
    ], BudgetSummary.prototype, "totalAmountMicros", void 0);
