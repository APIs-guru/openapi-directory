...
export var DoubleVerifyAppStarRatingAvoidedStarRatingEnum;
(function (DoubleVerifyAppStarRatingAvoidedStarRatingEnum) {
...
})(DoubleVerifyAppStarRatingAvoidedStarRatingEnum || (DoubleVerifyAppStarRatingAvoidedStarRatingEnum = {}));
// DoubleVerifyAppStarRating
/**
 * Details of DoubleVerify star ratings settings.
**/
var DoubleVerifyAppStarRating = /** @class */ (function (_super) {
    __extends(DoubleVerifyAppStarRating, _super);
    function DoubleVerifyAppStarRating() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=avoidInsufficientStarRating" }),
        __metadata("design:type", Boolean)
    ], DoubleVerifyAppStarRating.prototype, "avoidInsufficientStarRating", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=avoidedStarRating" }),
        __metadata("design:type", String)
    ], DoubleVerifyAppStarRating.prototype, "avoidedStarRating", void 0);
    return DoubleVerifyAppStarRating;
}(SpeakeasyBase));
export { DoubleVerifyAppStarRating };
