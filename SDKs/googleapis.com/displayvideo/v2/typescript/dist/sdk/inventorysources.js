...
var InventorySources = /** @class */ (function () {
    ...
    **/
    InventorySources.prototype.displayvideoInventorySourcesEditInventorySourceReadWriteAccessors = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v2/inventorySources/{inventorySourceId}:editInventorySourceReadWriteAccessors", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    InventorySources.prototype.displayvideoInventorySourcesGet = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v2/inventorySources/{inventorySourceId}", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
