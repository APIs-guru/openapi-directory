...
var CustomBiddingAlgorithms = /** @class */ (function () {
    ...
    **/
    CustomBiddingAlgorithms.prototype.displayvideoCustomBiddingAlgorithmsCreate = function (req, config) {
        ...
        var url = baseURL.replace(/\/$/, "") + "/v2/customBiddingAlgorithms";
    ...
    **/
    CustomBiddingAlgorithms.prototype.displayvideoCustomBiddingAlgorithmsGet = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v2/customBiddingAlgorithms/{customBiddingAlgorithmId}", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    CustomBiddingAlgorithms.prototype.displayvideoCustomBiddingAlgorithmsScriptsCreate = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v2/customBiddingAlgorithms/{customBiddingAlgorithmId}/scripts", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    CustomBiddingAlgorithms.prototype.displayvideoCustomBiddingAlgorithmsScriptsGet = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v2/customBiddingAlgorithms/{customBiddingAlgorithmId}/scripts/{customBiddingScriptId}", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    CustomBiddingAlgorithms.prototype.displayvideoCustomBiddingAlgorithmsUploadScript = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v2/customBiddingAlgorithms/{customBiddingAlgorithmId}:uploadScript", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
