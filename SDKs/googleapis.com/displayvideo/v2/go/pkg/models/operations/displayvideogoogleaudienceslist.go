...
type DisplayvideoGoogleAudiencesListQueryParams struct {
...
type DisplayvideoGoogleAudiencesListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DisplayvideoGoogleAudiencesListRequest struct {
	QueryParams DisplayvideoGoogleAudiencesListQueryParams
	Security    DisplayvideoGoogleAudiencesListSecurity
}

type DisplayvideoGoogleAudiencesListResponse struct {
	ContentType                 string
