...
type DisplayvideoAdvertisersInsertionOrdersListAssignedTargetingOptionsPathParams struct {
	AdvertiserID     string `pathParam:"style=simple,explode=false,name=advertiserId"`
	InsertionOrderID string `pathParam:"style=simple,explode=false,name=insertionOrderId"`
}

type DisplayvideoAdvertisersInsertionOrdersListAssignedTargetingOptionsQueryParams struct {
...
type DisplayvideoAdvertisersInsertionOrdersListAssignedTargetingOptionsSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DisplayvideoAdvertisersInsertionOrdersListAssignedTargetingOptionsRequest struct {
...
type DisplayvideoAdvertisersInsertionOrdersListAssignedTargetingOptionsResponse struct {
