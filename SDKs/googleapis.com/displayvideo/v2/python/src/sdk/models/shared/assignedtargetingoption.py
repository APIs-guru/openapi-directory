...
class AssignedTargetingOptionInput:
    ...
    device_type_details: Optional[DeviceTypeAssignedTargetingOptionDetailsInput] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('deviceTypeDetails') }})
