...
class VideoPlayerSizeTargetingOptionDetails:
    video_player_size: Optional[VideoPlayerSizeTargetingOptionDetailsVideoPlayerSizeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'videoPlayerSize' }})
