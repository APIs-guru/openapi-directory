...
class DisplayvideoPartnersEditAssignedTargetingOptionsRequest:
    path_params: DisplayvideoPartnersEditAssignedTargetingOptionsPathParams = field()
    query_params: DisplayvideoPartnersEditAssignedTargetingOptionsQueryParams = field()
    security: DisplayvideoPartnersEditAssignedTargetingOptionsSecurity = field()
