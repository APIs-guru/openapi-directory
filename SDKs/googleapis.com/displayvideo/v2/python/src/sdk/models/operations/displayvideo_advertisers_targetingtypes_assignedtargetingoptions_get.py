...
class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetTargetingTypeEnum(str, Enum):
...
@dataclass
class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetPathParams:
    ...
    targeting_type: DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetTargetingTypeEnum = field(metadata={'path_param': { 'field_name': 'targetingType', 'style': 'simple', 'explode': False }})
    

@dataclass
class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetQueryParams:
...
@dataclass
class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetSecurity:
    oauth2: shared.SchemeOauth2 = field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    oauth2c: shared.SchemeOauth2c = field(metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclass
class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetRequest:
    path_params: DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetPathParams = field()
    query_params: DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetQueryParams = field()
    security: DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetSecurity = field()
