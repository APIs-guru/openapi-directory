...
class ViewabilityTargetingOptionDetails:
    ...
    viewability: Optional[ViewabilityTargetingOptionDetailsViewabilityEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('viewability') }})
