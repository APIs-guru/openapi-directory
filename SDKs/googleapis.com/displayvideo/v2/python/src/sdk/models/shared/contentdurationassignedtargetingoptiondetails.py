...
class ContentDurationAssignedTargetingOptionDetails:
    content_duration: Optional[ContentDurationAssignedTargetingOptionDetailsContentDurationEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'contentDuration' }})
