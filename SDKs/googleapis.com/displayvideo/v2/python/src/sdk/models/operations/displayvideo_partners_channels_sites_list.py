...
class DisplayvideoPartnersChannelsSitesListRequest:
    path_params: DisplayvideoPartnersChannelsSitesListPathParams = field()
    query_params: DisplayvideoPartnersChannelsSitesListQueryParams = field()
    security: DisplayvideoPartnersChannelsSitesListSecurity = field()
