...
class DisplayvideoAdvertisersInvoicesLookupInvoiceCurrencyRequest:
    path_params: DisplayvideoAdvertisersInvoicesLookupInvoiceCurrencyPathParams = field(default=None)
    query_params: DisplayvideoAdvertisersInvoicesLookupInvoiceCurrencyQueryParams = field(default=None)
    security: DisplayvideoAdvertisersInvoicesLookupInvoiceCurrencySecurity = field(default=None)
