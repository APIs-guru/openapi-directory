...
class DisplayvideoAdvertisersInsertionOrdersListAssignedTargetingOptionsRequest:
    path_params: DisplayvideoAdvertisersInsertionOrdersListAssignedTargetingOptionsPathParams = field()
    query_params: DisplayvideoAdvertisersInsertionOrdersListAssignedTargetingOptionsQueryParams = field()
    security: DisplayvideoAdvertisersInsertionOrdersListAssignedTargetingOptionsSecurity = field()
