...
class DisplayvideoAdvertisersInsertionOrdersListAssignedTargetingOptionsRequest:
    path_params: DisplayvideoAdvertisersInsertionOrdersListAssignedTargetingOptionsPathParams = field(default=None)
    query_params: DisplayvideoAdvertisersInsertionOrdersListAssignedTargetingOptionsQueryParams = field(default=None)
    security: DisplayvideoAdvertisersInsertionOrdersListAssignedTargetingOptionsSecurity = field(default=None)
    

@dataclass
class DisplayvideoAdvertisersInsertionOrdersListAssignedTargetingOptionsResponse:
    bulk_list_insertion_order_assigned_targeting_options_response: Optional[shared.BulkListInsertionOrderAssignedTargetingOptionsResponse] = field(default=None)
