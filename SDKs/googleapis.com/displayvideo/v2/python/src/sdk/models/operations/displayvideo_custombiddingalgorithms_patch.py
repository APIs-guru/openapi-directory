...
class DisplayvideoCustomBiddingAlgorithmsPatchRequest:
    path_params: DisplayvideoCustomBiddingAlgorithmsPatchPathParams = field(default=None)
    query_params: DisplayvideoCustomBiddingAlgorithmsPatchQueryParams = field(default=None)
    request: Optional[shared.CustomBiddingAlgorithm] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: DisplayvideoCustomBiddingAlgorithmsPatchSecurity = field(default=None)
