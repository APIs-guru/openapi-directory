...
@dataclass
class DisplayvideoPartnersChannelsPatchPathParams:
...
@dataclass
class DisplayvideoPartnersChannelsPatchQueryParams:
...
class DisplayvideoPartnersChannelsPatchRequest:
    path_params: DisplayvideoPartnersChannelsPatchPathParams = field(default=None)
    query_params: DisplayvideoPartnersChannelsPatchQueryParams = field(default=None)
    request: Optional[shared.Channel] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: DisplayvideoPartnersChannelsPatchSecurity = field(default=None)
