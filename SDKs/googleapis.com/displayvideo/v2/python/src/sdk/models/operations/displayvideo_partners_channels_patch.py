...
class DisplayvideoPartnersChannelsPatchRequest:
    path_params: DisplayvideoPartnersChannelsPatchPathParams = field()
    query_params: DisplayvideoPartnersChannelsPatchQueryParams = field()
    security: DisplayvideoPartnersChannelsPatchSecurity = field()
