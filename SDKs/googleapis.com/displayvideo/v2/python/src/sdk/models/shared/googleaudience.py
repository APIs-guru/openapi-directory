...
class GoogleAudience:
    ...
    google_audience_id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'googleAudienceId' }})
    google_audience_type: Optional[GoogleAudienceGoogleAudienceTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'googleAudienceType' }})
