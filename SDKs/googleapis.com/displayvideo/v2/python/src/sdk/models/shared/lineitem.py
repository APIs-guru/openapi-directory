...
class LineItem:
    ...
    youtube_and_partners_settings: Optional[YoutubeAndPartnersSettings] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('youtubeAndPartnersSettings') }})
