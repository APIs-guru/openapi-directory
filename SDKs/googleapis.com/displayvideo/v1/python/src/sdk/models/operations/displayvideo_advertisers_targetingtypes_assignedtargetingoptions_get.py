...
class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetPathParams:
    ...
    targeting_type: DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetTargetingTypeEnum = field(default=None, metadata={'path_param': { 'field_name': 'targetingType', 'style': 'simple', 'explode': False }})
...
class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetRequest:
    path_params: DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetPathParams = field(default=None)
    query_params: DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetQueryParams = field(default=None)
    security: DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsGetSecurity = field(default=None)
