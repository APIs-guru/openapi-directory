...
class DisplayvideoPartnersBulkEditPartnerAssignedTargetingOptionsRequest:
    path_params: DisplayvideoPartnersBulkEditPartnerAssignedTargetingOptionsPathParams = field(default=None)
    query_params: DisplayvideoPartnersBulkEditPartnerAssignedTargetingOptionsQueryParams = field(default=None)
    ...
    security: DisplayvideoPartnersBulkEditPartnerAssignedTargetingOptionsSecurity = field(default=None)
