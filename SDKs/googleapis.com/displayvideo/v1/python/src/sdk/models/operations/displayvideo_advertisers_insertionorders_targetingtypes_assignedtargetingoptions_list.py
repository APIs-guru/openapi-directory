...
class DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsListPathParams:
    ...
    targeting_type: DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsListTargetingTypeEnum = field(default=None, metadata={'path_param': { 'field_name': 'targetingType', 'style': 'simple', 'explode': False }})
...
class DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsListRequest:
    path_params: DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsListPathParams = field(default=None)
    query_params: DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsListQueryParams = field(default=None)
    security: DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsListSecurity = field(default=None)
    

@dataclass
class DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsListResponse:
    content_type: str = field(default=None)
    list_insertion_order_assigned_targeting_options_response: Optional[shared.ListInsertionOrderAssignedTargetingOptionsResponse] = field(default=None)
