...
class DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsListPathParams:
    ...
    targeting_type: DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsListTargetingTypeEnum = field(metadata={'path_param': { 'field_name': 'targetingType', 'style': 'simple', 'explode': False }})
...
class DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsListRequest:
    path_params: DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsListPathParams = field()
    query_params: DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsListQueryParams = field()
    security: DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsListSecurity = field()
