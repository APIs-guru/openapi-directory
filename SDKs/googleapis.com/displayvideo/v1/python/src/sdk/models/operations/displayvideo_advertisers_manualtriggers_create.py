...
class DisplayvideoAdvertisersManualTriggersCreateRequest:
    path_params: DisplayvideoAdvertisersManualTriggersCreatePathParams = field()
    query_params: DisplayvideoAdvertisersManualTriggersCreateQueryParams = field()
    security: DisplayvideoAdvertisersManualTriggersCreateSecurity = field()
    request: Optional[shared.ManualTriggerInput] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
