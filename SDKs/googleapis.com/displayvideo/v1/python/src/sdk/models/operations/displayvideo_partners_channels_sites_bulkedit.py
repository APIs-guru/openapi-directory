...
class DisplayvideoPartnersChannelsSitesBulkEditRequest:
    path_params: DisplayvideoPartnersChannelsSitesBulkEditPathParams = field(default=None)
    query_params: DisplayvideoPartnersChannelsSitesBulkEditQueryParams = field(default=None)
    request: Optional[shared.BulkEditSitesRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: DisplayvideoPartnersChannelsSitesBulkEditSecurity = field(default=None)
