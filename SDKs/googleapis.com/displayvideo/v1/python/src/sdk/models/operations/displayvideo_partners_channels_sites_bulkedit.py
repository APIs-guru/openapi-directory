...
class DisplayvideoPartnersChannelsSitesBulkEditRequest:
    path_params: DisplayvideoPartnersChannelsSitesBulkEditPathParams = field()
    query_params: DisplayvideoPartnersChannelsSitesBulkEditQueryParams = field()
    security: DisplayvideoPartnersChannelsSitesBulkEditSecurity = field()
