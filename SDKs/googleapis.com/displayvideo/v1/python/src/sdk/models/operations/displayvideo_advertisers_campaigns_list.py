...
class DisplayvideoAdvertisersCampaignsListSecurity:
    option1: Optional[DisplayvideoAdvertisersCampaignsListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DisplayvideoAdvertisersCampaignsListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class DisplayvideoAdvertisersCampaignsListRequest:
    path_params: DisplayvideoAdvertisersCampaignsListPathParams = field()
    query_params: DisplayvideoAdvertisersCampaignsListQueryParams = field()
    security: DisplayvideoAdvertisersCampaignsListSecurity = field()
