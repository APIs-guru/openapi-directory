...
class PerformanceGoalBidStrategy:
    ...
    performance_goal_type: Optional[PerformanceGoalBidStrategyPerformanceGoalTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'performanceGoalType' }})
