...
class DisplayvideoAdvertisersLineItemsBulkListLineItemAssignedTargetingOptionsRequest:
    path_params: DisplayvideoAdvertisersLineItemsBulkListLineItemAssignedTargetingOptionsPathParams = field(default=None)
    query_params: DisplayvideoAdvertisersLineItemsBulkListLineItemAssignedTargetingOptionsQueryParams = field(default=None)
    security: DisplayvideoAdvertisersLineItemsBulkListLineItemAssignedTargetingOptionsSecurity = field(default=None)
    

@dataclass
class DisplayvideoAdvertisersLineItemsBulkListLineItemAssignedTargetingOptionsResponse:
    bulk_list_line_item_assigned_targeting_options_response: Optional[shared.BulkListLineItemAssignedTargetingOptionsResponse] = field(default=None)
