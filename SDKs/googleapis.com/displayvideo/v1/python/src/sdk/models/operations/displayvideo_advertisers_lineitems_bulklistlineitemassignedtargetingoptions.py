...
class DisplayvideoAdvertisersLineItemsBulkListLineItemAssignedTargetingOptionsRequest:
    path_params: DisplayvideoAdvertisersLineItemsBulkListLineItemAssignedTargetingOptionsPathParams = field()
    query_params: DisplayvideoAdvertisersLineItemsBulkListLineItemAssignedTargetingOptionsQueryParams = field()
    security: DisplayvideoAdvertisersLineItemsBulkListLineItemAssignedTargetingOptionsSecurity = field()
