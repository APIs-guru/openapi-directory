...
class DisplayvideoCustomBiddingAlgorithmsScriptsListRequest:
    path_params: DisplayvideoCustomBiddingAlgorithmsScriptsListPathParams = field(default=None)
    query_params: DisplayvideoCustomBiddingAlgorithmsScriptsListQueryParams = field(default=None)
    security: DisplayvideoCustomBiddingAlgorithmsScriptsListSecurity = field(default=None)
