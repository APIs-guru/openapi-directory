...
class DisplayvideoAdvertisersChannelsPatchRequest:
    path_params: DisplayvideoAdvertisersChannelsPatchPathParams = field()
    query_params: DisplayvideoAdvertisersChannelsPatchQueryParams = field()
    security: DisplayvideoAdvertisersChannelsPatchSecurity = field()
