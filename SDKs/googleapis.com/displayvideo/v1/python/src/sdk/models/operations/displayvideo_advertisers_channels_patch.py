...
@dataclass
class DisplayvideoAdvertisersChannelsPatchPathParams:
...
@dataclass
class DisplayvideoAdvertisersChannelsPatchQueryParams:
...
@dataclass
class DisplayvideoAdvertisersChannelsPatchSecurity:
...
class DisplayvideoAdvertisersChannelsPatchRequest:
    path_params: DisplayvideoAdvertisersChannelsPatchPathParams = field(default=None)
    query_params: DisplayvideoAdvertisersChannelsPatchQueryParams = field(default=None)
    request: Optional[shared.Channel] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: DisplayvideoAdvertisersChannelsPatchSecurity = field(default=None)
