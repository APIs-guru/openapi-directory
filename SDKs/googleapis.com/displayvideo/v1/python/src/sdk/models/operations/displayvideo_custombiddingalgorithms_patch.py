...
class DisplayvideoCustomBiddingAlgorithmsPatchRequest:
    path_params: DisplayvideoCustomBiddingAlgorithmsPatchPathParams = field()
    query_params: DisplayvideoCustomBiddingAlgorithmsPatchQueryParams = field()
    security: DisplayvideoCustomBiddingAlgorithmsPatchSecurity = field()
    request: Optional[shared.CustomBiddingAlgorithmInput] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
