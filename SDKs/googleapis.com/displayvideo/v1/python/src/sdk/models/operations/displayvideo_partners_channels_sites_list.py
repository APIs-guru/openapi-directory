...
class DisplayvideoPartnersChannelsSitesListRequest:
    path_params: DisplayvideoPartnersChannelsSitesListPathParams = field(default=None)
    query_params: DisplayvideoPartnersChannelsSitesListQueryParams = field(default=None)
    security: DisplayvideoPartnersChannelsSitesListSecurity = field(default=None)
