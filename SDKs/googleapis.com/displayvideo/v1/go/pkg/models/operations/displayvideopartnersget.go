...
type DisplayvideoPartnersGetPathParams struct {
    PartnerID string `pathParam:"style=simple,explode=false,name=partnerId"`
    
}

type DisplayvideoPartnersGetQueryParams struct {
...
type DisplayvideoPartnersGetSecurity struct {
    Oauth2 shared.SchemeOauth2 `security:"scheme,type=oauth2"`
    Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
    
}

type DisplayvideoPartnersGetRequest struct {
...
type DisplayvideoPartnersGetResponse struct {
    ContentType string 
