...
type DisplayvideoFirstAndThirdPartyAudiencesListQueryParams struct {
...
type DisplayvideoFirstAndThirdPartyAudiencesListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DisplayvideoFirstAndThirdPartyAudiencesListRequest struct {
...
type DisplayvideoFirstAndThirdPartyAudiencesListResponse struct {
	ContentType                             string
