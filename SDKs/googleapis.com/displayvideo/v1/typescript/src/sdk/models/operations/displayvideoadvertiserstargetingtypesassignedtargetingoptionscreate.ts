...
export enum DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsCreateTargetingTypeEnum {
...
export class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsCreatePathParams extends SpeakeasyBase {
...
export class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsCreateQueryParams extends SpeakeasyBase {
...
export class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsCreateSecurity extends SpeakeasyBase {
...
export class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsCreateRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsCreateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
