...
export class DisplayvideoInventorySourceGroupsAssignedInventorySourcesListPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=inventorySourceGroupId" })
  inventorySourceGroupId: string;
}


export class DisplayvideoInventorySourceGroupsAssignedInventorySourcesListQueryParams extends SpeakeasyBase {
