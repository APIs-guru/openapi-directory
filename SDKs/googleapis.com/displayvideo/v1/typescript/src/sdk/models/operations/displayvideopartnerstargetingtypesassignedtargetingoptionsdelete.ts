...
export enum DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsDeleteTargetingTypeEnum {
...
export class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsDeletePathParams extends SpeakeasyBase {
  ...
  targetingType: DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsDeleteTargetingTypeEnum;
}


export class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsDeleteQueryParams extends SpeakeasyBase {
...
export class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsDeleteSecurity extends SpeakeasyBase {
...
export class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsDeleteRequest extends SpeakeasyBase {
  @Metadata()
...
export class DisplayvideoPartnersTargetingTypesAssignedTargetingOptionsDeleteResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
