...
export enum DisplayvideoTargetingTypesTargetingOptionsListTargetingTypeEnum {
...
export class DisplayvideoTargetingTypesTargetingOptionsListPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=targetingType" })
  targetingType: DisplayvideoTargetingTypesTargetingOptionsListTargetingTypeEnum;
}


export class DisplayvideoTargetingTypesTargetingOptionsListQueryParams extends SpeakeasyBase {
...
export class DisplayvideoTargetingTypesTargetingOptionsListSecurity extends SpeakeasyBase {
...
export class DisplayvideoTargetingTypesTargetingOptionsListRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class DisplayvideoTargetingTypesTargetingOptionsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
