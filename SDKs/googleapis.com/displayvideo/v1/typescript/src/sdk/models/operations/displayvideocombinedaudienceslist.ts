...
export class DisplayvideoCombinedAudiencesListQueryParams extends SpeakeasyBase {
...
export class DisplayvideoCombinedAudiencesListSecurity extends SpeakeasyBase {
...
export class DisplayvideoCombinedAudiencesListRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class DisplayvideoCombinedAudiencesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
