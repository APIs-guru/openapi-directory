...
export class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsDeletePathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=advertiserId" })
  advertiserId: string;

  @Metadata({ data: "pathParam, style=simple;explode=false;name=assignedTargetingOptionId" })
...
export class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsDeleteQueryParams extends SpeakeasyBase {
