...
export class DisplayvideoTargetingTypesTargetingOptionsGetPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=targetingOptionId" })
...
export class DisplayvideoTargetingTypesTargetingOptionsGetQueryParams extends SpeakeasyBase {
