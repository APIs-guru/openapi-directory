...
export declare class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsCreatePathParams extends SpeakeasyBase {
    advertiserId: string;
    lineItemId: string;
    targetingType: DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsCreateTargetingTypeEnum;
}
export declare class DisplayvideoAdvertisersLineItemsTargetingTypesAssignedTargetingOptionsCreateQueryParams extends SpeakeasyBase {
