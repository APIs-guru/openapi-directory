...
**/
var ConversionCountingConfig = /** @class */ (function (_super) {
    __extends(ConversionCountingConfig, _super);
    function ConversionCountingConfig() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=floodlightActivityConfigs", elemType: TrackingFloodlightActivityConfig }),
        __metadata("design:type", Array)
    ], ConversionCountingConfig.prototype, "floodlightActivityConfigs", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=postViewCountPercentageMillis" }),
        __metadata("design:type", String)
    ], ConversionCountingConfig.prototype, "postViewCountPercentageMillis", void 0);
    return ConversionCountingConfig;
}(SpeakeasyBase));
export { ConversionCountingConfig };
