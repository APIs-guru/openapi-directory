...
export declare class DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsGetPathParams extends SpeakeasyBase {
    advertiserId: string;
    assignedTargetingOptionId: string;
    insertionOrderId: string;
    targetingType: DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsGetTargetingTypeEnum;
}
export declare class DisplayvideoAdvertisersInsertionOrdersTargetingTypesAssignedTargetingOptionsGetQueryParams extends SpeakeasyBase {
