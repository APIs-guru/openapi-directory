...
**/
var CombinedAudienceGroup = /** @class */ (function (_super) {
    __extends(CombinedAudienceGroup, _super);
    function CombinedAudienceGroup() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=settings", elemType: CombinedAudienceTargetingSetting }),
        __metadata("design:type", Array)
    ], CombinedAudienceGroup.prototype, "settings", void 0);
    return CombinedAudienceGroup;
}(SpeakeasyBase));
export { CombinedAudienceGroup };
