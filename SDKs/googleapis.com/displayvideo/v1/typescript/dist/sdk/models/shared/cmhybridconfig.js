...
**/
var CmHybridConfig = /** @class */ (function (_super) {
    __extends(CmHybridConfig, _super);
    function CmHybridConfig() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=cmAccountId" }),
        __metadata("design:type", String)
    ], CmHybridConfig.prototype, "cmAccountId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=cmFloodlightConfigId" }),
        __metadata("design:type", String)
    ], CmHybridConfig.prototype, "cmFloodlightConfigId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=cmFloodlightLinkingAuthorized" }),
        __metadata("design:type", Boolean)
    ], CmHybridConfig.prototype, "cmFloodlightLinkingAuthorized", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=cmSyncableSiteIds" }),
        __metadata("design:type", Array)
    ], CmHybridConfig.prototype, "cmSyncableSiteIds", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=dv360ToCmCostReportingEnabled" }),
        __metadata("design:type", Boolean)
    ], CmHybridConfig.prototype, "dv360ToCmCostReportingEnabled", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=dv360ToCmDataSharingEnabled" }),
        __metadata("design:type", Boolean)
    ], CmHybridConfig.prototype, "dv360ToCmDataSharingEnabled", void 0);
    return CmHybridConfig;
}(SpeakeasyBase));
export { CmHybridConfig };
