...
export var ExitEventTypeEnum;
(function (ExitEventTypeEnum) {
...
})(ExitEventTypeEnum || (ExitEventTypeEnum = {}));
// ExitEvent
/**
...
var ExitEvent = /** @class */ (function (_super) {
    ...
    ], ExitEvent.prototype, "name", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=reportingName" }),
        __metadata("design:type", String)
    ], ExitEvent.prototype, "reportingName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=type" }),
        __metadata("design:type", String)
    ], ExitEvent.prototype, "type", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=url" }),
        __metadata("design:type", String)
    ], ExitEvent.prototype, "url", void 0);
    return ExitEvent;
}(SpeakeasyBase));
export { ExitEvent };
