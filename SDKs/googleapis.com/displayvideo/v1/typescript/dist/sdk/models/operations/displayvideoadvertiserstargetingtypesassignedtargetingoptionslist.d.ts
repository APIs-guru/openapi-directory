...
export declare class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsListPathParams extends SpeakeasyBase {
    advertiserId: string;
    targetingType: DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsListTargetingTypeEnum;
}
export declare class DisplayvideoAdvertisersTargetingTypesAssignedTargetingOptionsListQueryParams extends SpeakeasyBase {
