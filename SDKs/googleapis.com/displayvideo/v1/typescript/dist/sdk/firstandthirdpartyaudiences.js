...
var FirstAndThirdPartyAudiences = /** @class */ (function () {
    ...
    **/
    FirstAndThirdPartyAudiences.prototype.displayvideoFirstAndThirdPartyAudiencesCreate = function (req, config) {
        ...
        var url = baseURL.replace(/\/$/, "") + "/v1/firstAndThirdPartyAudiences";
    ...
    **/
    FirstAndThirdPartyAudiences.prototype.displayvideoFirstAndThirdPartyAudiencesEditCustomerMatchMembers = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/firstAndThirdPartyAudiences/{firstAndThirdPartyAudienceId}:editCustomerMatchMembers", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    FirstAndThirdPartyAudiences.prototype.displayvideoFirstAndThirdPartyAudiencesGet = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/firstAndThirdPartyAudiences/{firstAndThirdPartyAudienceId}", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
