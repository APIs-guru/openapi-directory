...
class DoubleclicksearchConversionGetPathParams:
    ...
    engine_account_id: str = field(default=None, metadata={'path_param': { 'field_name': 'engineAccountId', 'style': 'simple', 'explode': False }})
...
class DoubleclicksearchConversionGetQueryParams:
    ...
    end_date: int = field(default=None, metadata={'query_param': { 'field_name': 'endDate', 'style': 'form', 'explode': True }})
    fields: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'fields', 'style': 'form', 'explode': True }})
    key: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'key', 'style': 'form', 'explode': True }})
    oauth_token: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'oauth_token', 'style': 'form', 'explode': True }})
    pretty_print: Optional[bool] = field(default=None, metadata={'query_param': { 'field_name': 'prettyPrint', 'style': 'form', 'explode': True }})
    quota_user: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'quotaUser', 'style': 'form', 'explode': True }})
    row_count: int = field(default=None, metadata={'query_param': { 'field_name': 'rowCount', 'style': 'form', 'explode': True }})
    start_date: int = field(default=None, metadata={'query_param': { 'field_name': 'startDate', 'style': 'form', 'explode': True }})
    start_row: int = field(default=None, metadata={'query_param': { 'field_name': 'startRow', 'style': 'form', 'explode': True }})
...
class DoubleclicksearchConversionGetRequest:
    path_params: DoubleclicksearchConversionGetPathParams = field(default=None)
    query_params: DoubleclicksearchConversionGetQueryParams = field(default=None)
    security: DoubleclicksearchConversionGetSecurity = field(default=None)
