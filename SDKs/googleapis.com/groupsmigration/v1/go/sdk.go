...
func (s *SDK) GroupsmigrationArchiveInsert(ctx context.Context, request operations.GroupsmigrationArchiveInsertRequest) (*operations.GroupsmigrationArchiveInsertResponse, error) {
	baseURL := s.serverURL
