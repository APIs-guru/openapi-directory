...
export class ClouddeployProjectsLocationsTargetsDeletePathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=name" })
  name: string;
}


export class ClouddeployProjectsLocationsTargetsDeleteQueryParams extends SpeakeasyBase {
