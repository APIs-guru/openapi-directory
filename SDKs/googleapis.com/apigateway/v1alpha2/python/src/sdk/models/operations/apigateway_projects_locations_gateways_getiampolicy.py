...
class ApigatewayProjectsLocationsGatewaysGetIamPolicyRequest:
    path_params: ApigatewayProjectsLocationsGatewaysGetIamPolicyPathParams = field()
    query_params: ApigatewayProjectsLocationsGatewaysGetIamPolicyQueryParams = field()
    security: ApigatewayProjectsLocationsGatewaysGetIamPolicySecurity = field()
