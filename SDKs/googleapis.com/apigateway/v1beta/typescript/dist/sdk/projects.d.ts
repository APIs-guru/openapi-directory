...
export declare class Projects {
    ...
    **/
    apigatewayProjectsLocationsApisConfigsCreate(req: operations.ApigatewayProjectsLocationsApisConfigsCreateRequest, config?: AxiosRequestConfig): Promise<operations.ApigatewayProjectsLocationsApisConfigsCreateResponse>;
    /**
     * apigatewayProjectsLocationsApisConfigsList - Lists ApiConfigs in a given project and location.
    **/
    apigatewayProjectsLocationsApisConfigsList(req: operations.ApigatewayProjectsLocationsApisConfigsListRequest, config?: AxiosRequestConfig): Promise<operations.ApigatewayProjectsLocationsApisConfigsListResponse>;
    /**
     * apigatewayProjectsLocationsApisCreate - Creates a new Api in a given project and location.
    **/
    apigatewayProjectsLocationsApisCreate(req: operations.ApigatewayProjectsLocationsApisCreateRequest, config?: AxiosRequestConfig): Promise<operations.ApigatewayProjectsLocationsApisCreateResponse>;
    /**
     * apigatewayProjectsLocationsApisList - Lists Apis in a given project and location.
    **/
    apigatewayProjectsLocationsApisList(req: operations.ApigatewayProjectsLocationsApisListRequest, config?: AxiosRequestConfig): Promise<operations.ApigatewayProjectsLocationsApisListResponse>;
    /**
     * apigatewayProjectsLocationsGatewaysCreate - Creates a new Gateway in a given project and location.
    **/
    apigatewayProjectsLocationsGatewaysCreate(req: operations.ApigatewayProjectsLocationsGatewaysCreateRequest, config?: AxiosRequestConfig): Promise<operations.ApigatewayProjectsLocationsGatewaysCreateResponse>;
    /**
    ...
    **/
    apigatewayProjectsLocationsGatewaysList(req: operations.ApigatewayProjectsLocationsGatewaysListRequest, config?: AxiosRequestConfig): Promise<operations.ApigatewayProjectsLocationsGatewaysListResponse>;
    /**
     * apigatewayProjectsLocationsGatewaysPatch - Updates the parameters of a single Gateway.
    **/
    apigatewayProjectsLocationsGatewaysPatch(req: operations.ApigatewayProjectsLocationsGatewaysPatchRequest, config?: AxiosRequestConfig): Promise<operations.ApigatewayProjectsLocationsGatewaysPatchResponse>;
    /**
