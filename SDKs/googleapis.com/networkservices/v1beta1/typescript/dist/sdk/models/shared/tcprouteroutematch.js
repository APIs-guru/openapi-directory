...
**/
var TcpRouteRouteMatch = /** @class */ (function (_super) {
    __extends(TcpRouteRouteMatch, _super);
    function TcpRouteRouteMatch() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=address" }),
        __metadata("design:type", String)
    ], TcpRouteRouteMatch.prototype, "address", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=port" }),
        __metadata("design:type", String)
    ], TcpRouteRouteMatch.prototype, "port", void 0);
    return TcpRouteRouteMatch;
}(SpeakeasyBase));
export { TcpRouteRouteMatch };
