...
type ResellerResellernotifyRegisterQueryParams struct {
...
type ResellerResellernotifyRegisterSecurity struct {
    Oauth2 shared.SchemeOauth2 `security:"scheme,type=oauth2"`
    Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
    
}

type ResellerResellernotifyRegisterRequest struct {
    QueryParams ResellerResellernotifyRegisterQueryParams 
    Security ResellerResellernotifyRegisterSecurity 
    
}

type ResellerResellernotifyRegisterResponse struct {
    ContentType string 
