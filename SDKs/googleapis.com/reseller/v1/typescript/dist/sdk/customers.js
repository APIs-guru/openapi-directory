...
var Customers = /** @class */ (function () {
    ...
    **/
    Customers.prototype.resellerCustomersGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ResellerCustomersGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/apps/reseller/v1/customers/{customerId}", req.pathParams);
    ...
    **/
    Customers.prototype.resellerCustomersInsert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ResellerCustomersInsertRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/apps/reseller/v1/customers";
    ...
    **/
    Customers.prototype.resellerCustomersPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Customers.prototype.resellerCustomersUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
