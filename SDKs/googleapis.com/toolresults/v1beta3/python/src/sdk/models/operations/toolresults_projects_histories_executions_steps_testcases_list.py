...
class ToolresultsProjectsHistoriesExecutionsStepsTestCasesListRequest:
    path_params: ToolresultsProjectsHistoriesExecutionsStepsTestCasesListPathParams = field()
    query_params: ToolresultsProjectsHistoriesExecutionsStepsTestCasesListQueryParams = field()
    security: ToolresultsProjectsHistoriesExecutionsStepsTestCasesListSecurity = field()
