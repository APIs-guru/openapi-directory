...
type ToolresultsProjectsHistoriesExecutionsEnvironmentsGetPathParams struct {
...
type ToolresultsProjectsHistoriesExecutionsEnvironmentsGetQueryParams struct {
...
type ToolresultsProjectsHistoriesExecutionsEnvironmentsGetSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ToolresultsProjectsHistoriesExecutionsEnvironmentsGetRequest struct {
...
type ToolresultsProjectsHistoriesExecutionsEnvironmentsGetResponse struct {
	ContentType string
