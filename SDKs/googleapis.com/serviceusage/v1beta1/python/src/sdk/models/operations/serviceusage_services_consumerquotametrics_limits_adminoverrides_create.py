...
@dataclass
class ServiceusageServicesConsumerQuotaMetricsLimitsAdminOverridesCreateQueryParams:
    ...
    force_only: Optional[List[ServiceusageServicesConsumerQuotaMetricsLimitsAdminOverridesCreateForceOnlyEnum]] = field(default=None, metadata={'query_param': { 'field_name': 'forceOnly', 'style': 'form', 'explode': True }})
...
class ServiceusageServicesConsumerQuotaMetricsLimitsAdminOverridesCreateSecurity:
    option1: Optional[ServiceusageServicesConsumerQuotaMetricsLimitsAdminOverridesCreateSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[ServiceusageServicesConsumerQuotaMetricsLimitsAdminOverridesCreateSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
