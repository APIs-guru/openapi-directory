...
class ConnectorsProjectsLocationsProvidersTestIamPermissionsRequest:
    path_params: ConnectorsProjectsLocationsProvidersTestIamPermissionsPathParams = field()
    query_params: ConnectorsProjectsLocationsProvidersTestIamPermissionsQueryParams = field()
    security: ConnectorsProjectsLocationsProvidersTestIamPermissionsSecurity = field()
