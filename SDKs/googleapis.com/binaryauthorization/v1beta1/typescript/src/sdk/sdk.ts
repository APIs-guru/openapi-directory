...
export class SDK {
  ...
  BinaryauthorizationProjectsAttestorsCreate(
    ...
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{parent}/attestors", req.pathParams);
  ...
  BinaryauthorizationProjectsAttestorsValidateAttestationOccurrence(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{attestor}:validateAttestationOccurrence", req.pathParams);
