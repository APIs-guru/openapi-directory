...
var Projects = /** @class */ (function () {
    ...
    **/
    Projects.prototype.binaryauthorizationProjectsAttestorsCreate = function (req, config) {
        ...
        var url = utils.GenerateURL(baseURL, "/v1beta1/{parent}/attestors", req.pathParams);
    ...
    **/
    Projects.prototype.binaryauthorizationProjectsAttestorsValidateAttestationOccurrence = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta1/{attestor}:validateAttestationOccurrence", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
