...
class BinaryauthorizationProjectsAttestorsValidateAttestationOccurrencePathParams:
    attestor: str = field(default=None, metadata={'path_param': { 'field_name': 'attestor', 'style': 'simple', 'explode': False }})
...
class BinaryauthorizationProjectsAttestorsValidateAttestationOccurrenceRequest:
    path_params: BinaryauthorizationProjectsAttestorsValidateAttestationOccurrencePathParams = field(default=None)
    query_params: BinaryauthorizationProjectsAttestorsValidateAttestationOccurrenceQueryParams = field(default=None)
    ...
    security: BinaryauthorizationProjectsAttestorsValidateAttestationOccurrenceSecurity = field(default=None)
