...
**/
var UserOwnedGrafeasNoteInput = /** @class */ (function (_super) {
    __extends(UserOwnedGrafeasNoteInput, _super);
    function UserOwnedGrafeasNoteInput() {
 ...
 * An user owned Grafeas note references a Grafeas Attestation.Authority Note created by the user.
**/
var UserOwnedGrafeasNote = /** @class */ (function (_super) {
    __extends(UserOwnedGrafeasNote, _super);
    function UserOwnedGrafeasNote() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
