...
func main() {
    ...
    req := operations.SpannerProjectsInstanceConfigOperationsListRequest{
        ...
        PathParams: operations.SpannerProjectsInstanceConfigOperationsListPathParams{
            Parent: "ea",
        },
        QueryParams: operations.SpannerProjectsInstanceConfigOperationsListQueryParams{
            DollarXgafv: "1",
            AccessToken: "vitae",
            Alt: "proto",
            Callback: "omnis",
    ...
    res, err := s.Projects.SpannerProjectsInstanceConfigOperationsList(ctx, req)
    if err != nil {
        log.Fatal(err)
    }

    if res.ListInstanceConfigOperationsResponse != nil {
        // handle response
    }
```
