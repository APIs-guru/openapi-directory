...
class SpannerProjectsInstancesDatabasesSessionsBatchCreateRequest:
    path_params: SpannerProjectsInstancesDatabasesSessionsBatchCreatePathParams = field(default=None)
    query_params: SpannerProjectsInstancesDatabasesSessionsBatchCreateQueryParams = field(default=None)
    request: Optional[shared.BatchCreateSessionsRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: SpannerProjectsInstancesDatabasesSessionsBatchCreateSecurity = field(default=None)
