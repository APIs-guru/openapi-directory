...
@dataclass
class SpannerProjectsInstancesDatabasesGetDdlQueryParams:
...
@dataclass
class SpannerProjectsInstancesDatabasesGetDdlSecurity:
    option1: Optional[SpannerProjectsInstancesDatabasesGetDdlSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[SpannerProjectsInstancesDatabasesGetDdlSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
