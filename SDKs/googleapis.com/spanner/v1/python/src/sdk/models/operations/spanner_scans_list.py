...
class SpannerScansListRequest:
    path_params: SpannerScansListPathParams = field(default=None)
    query_params: SpannerScansListQueryParams = field(default=None)
    security: SpannerScansListSecurity = field(default=None)
