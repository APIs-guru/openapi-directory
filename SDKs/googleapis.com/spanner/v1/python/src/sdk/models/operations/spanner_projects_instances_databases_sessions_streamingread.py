...
class SpannerProjectsInstancesDatabasesSessionsStreamingReadRequest:
    path_params: SpannerProjectsInstancesDatabasesSessionsStreamingReadPathParams = field(default=None)
    query_params: SpannerProjectsInstancesDatabasesSessionsStreamingReadQueryParams = field(default=None)
    request: Optional[shared.ReadRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: SpannerProjectsInstancesDatabasesSessionsStreamingReadSecurity = field(default=None)
