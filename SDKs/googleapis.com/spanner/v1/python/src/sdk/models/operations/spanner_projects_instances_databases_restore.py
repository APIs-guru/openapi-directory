...
class SpannerProjectsInstancesDatabasesRestoreRequest:
    path_params: SpannerProjectsInstancesDatabasesRestorePathParams = field()
    query_params: SpannerProjectsInstancesDatabasesRestoreQueryParams = field()
    security: SpannerProjectsInstancesDatabasesRestoreSecurity = field()
