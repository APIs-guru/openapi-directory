...
@dataclass
class SpannerProjectsInstancesDatabasesSessionsRollbackQueryParams:
...
@dataclass
class SpannerProjectsInstancesDatabasesSessionsRollbackSecurity:
    option1: Optional[SpannerProjectsInstancesDatabasesSessionsRollbackSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[SpannerProjectsInstancesDatabasesSessionsRollbackSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
