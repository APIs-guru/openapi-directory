...
class RestoreDatabaseRequest:
    ...
    encryption_config: Optional[RestoreDatabaseEncryptionConfig] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('encryptionConfig') }})
