...
class SpannerProjectsInstancesDatabasesGetIamPolicyRequest:
    path_params: SpannerProjectsInstancesDatabasesGetIamPolicyPathParams = field(default=None)
    query_params: SpannerProjectsInstancesDatabasesGetIamPolicyQueryParams = field(default=None)
    request: Optional[shared.GetIamPolicyRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: SpannerProjectsInstancesDatabasesGetIamPolicySecurity = field(default=None)
