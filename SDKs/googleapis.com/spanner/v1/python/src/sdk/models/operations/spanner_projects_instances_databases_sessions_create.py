...
class SpannerProjectsInstancesDatabasesSessionsCreateRequest:
    path_params: SpannerProjectsInstancesDatabasesSessionsCreatePathParams = field(default=None)
    query_params: SpannerProjectsInstancesDatabasesSessionsCreateQueryParams = field(default=None)
    request: Optional[shared.CreateSessionRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: SpannerProjectsInstancesDatabasesSessionsCreateSecurity = field(default=None)
