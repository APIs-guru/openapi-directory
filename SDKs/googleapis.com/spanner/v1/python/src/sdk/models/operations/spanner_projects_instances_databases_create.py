...
@dataclass
class SpannerProjectsInstancesDatabasesCreateQueryParams:
...
@dataclass
class SpannerProjectsInstancesDatabasesCreateSecurity:
    option1: Optional[SpannerProjectsInstancesDatabasesCreateSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[SpannerProjectsInstancesDatabasesCreateSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
