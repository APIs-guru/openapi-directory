...
@dataclass
class SpannerProjectsInstancesDatabasesSessionsBeginTransactionQueryParams:
...
@dataclass
class SpannerProjectsInstancesDatabasesSessionsBeginTransactionSecurity:
    option1: Optional[SpannerProjectsInstancesDatabasesSessionsBeginTransactionSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[SpannerProjectsInstancesDatabasesSessionsBeginTransactionSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
