...
import { SpannerProjectsInstanceConfigOperationsListRequest, SpannerProjectsInstanceConfigOperationsListResponse } from "openapi/src/sdk/models/operations";
import { AxiosError } from "axios";


const sdk = new SDK();
    
const req: SpannerProjectsInstanceConfigOperationsListRequest = {
  security: {
    option1: {
      oauth2: {
...
sdk.projects.spannerProjectsInstanceConfigOperationsList(req).then((res: SpannerProjectsInstanceConfigOperationsListResponse | AxiosError) => {
   // handle response
});
```
