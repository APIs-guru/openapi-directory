...
export var CreateDatabaseRequestDatabaseDialectEnum;
(function (CreateDatabaseRequestDatabaseDialectEnum) {
...
})(CreateDatabaseRequestDatabaseDialectEnum || (CreateDatabaseRequestDatabaseDialectEnum = {}));
...
var CreateDatabaseRequest = /** @class */ (function (_super) {
    ...
    ], CreateDatabaseRequest.prototype, "createStatement", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=databaseDialect" }),
        __metadata("design:type", String)
    ], CreateDatabaseRequest.prototype, "databaseDialect", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=encryptionConfig" }),
        __metadata("design:type", EncryptionConfig)
    ], CreateDatabaseRequest.prototype, "encryptionConfig", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=extraStatements" }),
        __metadata("design:type", Array)
    ], CreateDatabaseRequest.prototype, "extraStatements", void 0);
