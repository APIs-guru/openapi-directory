...
export var ContextValueSeverityEnum;
(function (ContextValueSeverityEnum) {
...
})(ContextValueSeverityEnum || (ContextValueSeverityEnum = {}));
// ContextValue
/**
 * A message representing context for a KeyRangeInfo, including a label, value, unit, and severity.
**/
var ContextValue = /** @class */ (function (_super) {
    __extends(ContextValue, _super);
    ...
    ], ContextValue.prototype, "label", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=severity" }),
        __metadata("design:type", String)
    ], ContextValue.prototype, "severity", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=unit" }),
        __metadata("design:type", String)
    ], ContextValue.prototype, "unit", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=value" }),
        __metadata("design:type", Number)
    ], ContextValue.prototype, "value", void 0);
    return ContextValue;
}(SpeakeasyBase));
export { ContextValue };
