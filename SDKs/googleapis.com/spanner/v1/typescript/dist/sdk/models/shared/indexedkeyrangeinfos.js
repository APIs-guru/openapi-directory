...
**/
var IndexedKeyRangeInfos = /** @class */ (function (_super) {
    __extends(IndexedKeyRangeInfos, _super);
    function IndexedKeyRangeInfos() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=keyRangeInfos", elemType: KeyRangeInfos }),
        __metadata("design:type", Map)
    ], IndexedKeyRangeInfos.prototype, "keyRangeInfos", void 0);
    return IndexedKeyRangeInfos;
}(SpeakeasyBase));
export { IndexedKeyRangeInfos };
