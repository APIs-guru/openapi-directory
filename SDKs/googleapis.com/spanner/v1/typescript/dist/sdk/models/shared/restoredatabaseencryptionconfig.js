...
export var RestoreDatabaseEncryptionConfigEncryptionTypeEnum;
(function (RestoreDatabaseEncryptionConfigEncryptionTypeEnum) {
...
})(RestoreDatabaseEncryptionConfigEncryptionTypeEnum || (RestoreDatabaseEncryptionConfigEncryptionTypeEnum = {}));
// RestoreDatabaseEncryptionConfig
/**
 * Encryption configuration for the restored database.
**/
var RestoreDatabaseEncryptionConfig = /** @class */ (function (_super) {
    __extends(RestoreDatabaseEncryptionConfig, _super);
    function RestoreDatabaseEncryptionConfig() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=encryptionType" }),
        __metadata("design:type", String)
    ], RestoreDatabaseEncryptionConfig.prototype, "encryptionType", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=kmsKeyName" }),
        __metadata("design:type", String)
    ], RestoreDatabaseEncryptionConfig.prototype, "kmsKeyName", void 0);
    return RestoreDatabaseEncryptionConfig;
}(SpeakeasyBase));
export { RestoreDatabaseEncryptionConfig };
