...
class CloudkmsProjectsLocationsKeyRingsCryptoKeysEncryptRequest:
    path_params: CloudkmsProjectsLocationsKeyRingsCryptoKeysEncryptPathParams = field(default=None)
    query_params: CloudkmsProjectsLocationsKeyRingsCryptoKeysEncryptQueryParams = field(default=None)
    request: Optional[shared.EncryptRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: CloudkmsProjectsLocationsKeyRingsCryptoKeysEncryptSecurity = field(default=None)
