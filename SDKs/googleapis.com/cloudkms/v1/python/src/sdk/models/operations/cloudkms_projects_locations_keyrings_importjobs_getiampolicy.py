...
class CloudkmsProjectsLocationsKeyRingsImportJobsGetIamPolicySecurity:
    option1: Optional[CloudkmsProjectsLocationsKeyRingsImportJobsGetIamPolicySecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[CloudkmsProjectsLocationsKeyRingsImportJobsGetIamPolicySecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
