...
class CloudkmsProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersionsImportRequest:
    path_params: CloudkmsProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersionsImportPathParams = field()
    query_params: CloudkmsProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersionsImportQueryParams = field()
    security: CloudkmsProjectsLocationsKeyRingsCryptoKeysCryptoKeyVersionsImportSecurity = field()
