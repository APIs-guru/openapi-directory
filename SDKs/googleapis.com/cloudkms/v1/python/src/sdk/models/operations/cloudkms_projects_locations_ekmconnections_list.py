...
class CloudkmsProjectsLocationsEkmConnectionsListSecurity:
    option1: Optional[CloudkmsProjectsLocationsEkmConnectionsListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[CloudkmsProjectsLocationsEkmConnectionsListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
