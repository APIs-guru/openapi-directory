...
class CloudkmsProjectsLocationsKeyRingsCryptoKeysUpdatePrimaryVersionRequest:
    path_params: CloudkmsProjectsLocationsKeyRingsCryptoKeysUpdatePrimaryVersionPathParams = field(default=None)
    query_params: CloudkmsProjectsLocationsKeyRingsCryptoKeysUpdatePrimaryVersionQueryParams = field(default=None)
    ...
    security: CloudkmsProjectsLocationsKeyRingsCryptoKeysUpdatePrimaryVersionSecurity = field(default=None)
