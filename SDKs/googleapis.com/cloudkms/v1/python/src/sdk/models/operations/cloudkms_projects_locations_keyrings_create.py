...
class CloudkmsProjectsLocationsKeyRingsCreateRequest:
    path_params: CloudkmsProjectsLocationsKeyRingsCreatePathParams = field(default=None)
    query_params: CloudkmsProjectsLocationsKeyRingsCreateQueryParams = field(default=None)
    request: Optional[shared.KeyRing] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: CloudkmsProjectsLocationsKeyRingsCreateSecurity = field(default=None)
