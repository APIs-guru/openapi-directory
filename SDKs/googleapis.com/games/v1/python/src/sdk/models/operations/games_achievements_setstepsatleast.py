...
class GamesAchievementsSetStepsAtLeastQueryParams:
    steps: int = field(metadata={'query_param': { 'field_name': 'steps', 'style': 'form', 'explode': True }})
...
class GamesAchievementsSetStepsAtLeastRequest:
    path_params: GamesAchievementsSetStepsAtLeastPathParams = field()
    query_params: GamesAchievementsSetStepsAtLeastQueryParams = field()
    security: GamesAchievementsSetStepsAtLeastSecurity = field()
