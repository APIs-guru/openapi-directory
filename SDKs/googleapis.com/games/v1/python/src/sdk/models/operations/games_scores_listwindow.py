...
class GamesScoresListWindowPathParams:
    collection: GamesScoresListWindowCollectionEnum = field(default=None, metadata={'path_param': { 'field_name': 'collection', 'style': 'simple', 'explode': False }})
...
class GamesScoresListWindowQueryParams:
    ...
    time_span: GamesScoresListWindowTimeSpanEnum = field(default=None, metadata={'query_param': { 'field_name': 'timeSpan', 'style': 'form', 'explode': True }})
...
class GamesScoresListWindowRequest:
    path_params: GamesScoresListWindowPathParams = field(default=None)
    query_params: GamesScoresListWindowQueryParams = field(default=None)
    security: GamesScoresListWindowSecurity = field(default=None)
