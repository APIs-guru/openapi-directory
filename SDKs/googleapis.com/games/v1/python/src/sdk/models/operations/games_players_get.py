...
@dataclass
class GamesPlayersGetQueryParams:
    ...
    player_id_consistency_token: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'playerIdConsistencyToken', 'style': 'form', 'explode': True }})
