...
class GamesAchievementsIncrementQueryParams:
    ...
    steps_to_increment: int = field(default=None, metadata={'query_param': { 'field_name': 'stepsToIncrement', 'style': 'form', 'explode': True }})
...
class GamesAchievementsIncrementRequest:
    path_params: GamesAchievementsIncrementPathParams = field(default=None)
    query_params: GamesAchievementsIncrementQueryParams = field(default=None)
    security: GamesAchievementsIncrementSecurity = field(default=None)
