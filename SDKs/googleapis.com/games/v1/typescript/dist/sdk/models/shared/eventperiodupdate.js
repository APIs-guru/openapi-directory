...
**/
var EventPeriodUpdate = /** @class */ (function (_super) {
    __extends(EventPeriodUpdate, _super);
    function EventPeriodUpdate() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=kind" }),
        __metadata("design:type", String)
    ], EventPeriodUpdate.prototype, "kind", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=timePeriod" }),
        __metadata("design:type", EventPeriodRange)
    ], EventPeriodUpdate.prototype, "timePeriod", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=updates", elemType: EventUpdateRequest }),
        __metadata("design:type", Array)
    ], EventPeriodUpdate.prototype, "updates", void 0);
    return EventPeriodUpdate;
}(SpeakeasyBase));
export { EventPeriodUpdate };
