...
type GamesAchievementsRevealPathParams struct {
    AchievementID string `pathParam:"style=simple,explode=false,name=achievementId"`
    
}

type GamesAchievementsRevealQueryParams struct {
...
type GamesAchievementsRevealSecurity struct {
    Oauth2 shared.SchemeOauth2 `security:"scheme,type=oauth2"`
    Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
    
}

type GamesAchievementsRevealRequest struct {
...
type GamesAchievementsRevealResponse struct {
