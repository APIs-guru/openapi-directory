...
func (s *Policies) IamPoliciesCreatePolicy(ctx context.Context, request operations.IamPoliciesCreatePolicyRequest) (*operations.IamPoliciesCreatePolicyResponse, error) {
...
func (s *Policies) IamPoliciesDelete(ctx context.Context, request operations.IamPoliciesDeleteRequest) (*operations.IamPoliciesDeleteResponse, error) {
	baseURL := s._serverURL
...
func (s *Policies) IamPoliciesListPolicies(ctx context.Context, request operations.IamPoliciesListPoliciesRequest) (*operations.IamPoliciesListPoliciesResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v2beta/{parent}", request.PathParams)
...
func (s *Policies) IamPoliciesOperationsGet(ctx context.Context, request operations.IamPoliciesOperationsGetRequest) (*operations.IamPoliciesOperationsGetResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v2beta/{name}", request.PathParams)
...
func (s *Policies) IamPoliciesUpdate(ctx context.Context, request operations.IamPoliciesUpdateRequest) (*operations.IamPoliciesUpdateResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v2beta/{name}", request.PathParams)
