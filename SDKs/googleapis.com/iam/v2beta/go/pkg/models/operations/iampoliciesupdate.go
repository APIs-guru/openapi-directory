...
type IamPoliciesUpdatePathParams struct {
    Name string `pathParam:"style=simple,explode=false,name=name"`
    
}

type IamPoliciesUpdateQueryParams struct {
...
type IamPoliciesUpdateSecurity struct {
...
type IamPoliciesUpdateResponse struct {
    ContentType string 
