...
type IamPoliciesCreatePolicyPathParams struct {
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type IamPoliciesCreatePolicyQueryParams struct {
...
type IamPoliciesCreatePolicySecurity struct {
...
type IamPoliciesCreatePolicyResponse struct {
	ContentType                string
