...
var Policies = /** @class */ (function () {
    ...
    **/
    Policies.prototype.iamPoliciesCreatePolicy = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.IamPoliciesCreatePolicyRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v2beta/{parent}", req.pathParams);
    ...
    **/
    Policies.prototype.iamPoliciesDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.IamPoliciesDeleteRequest(req);
        }
        var baseURL = this._serverURL;
    ...
    **/
    Policies.prototype.iamPoliciesListPolicies = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.IamPoliciesListPoliciesRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v2beta/{parent}", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.googleIamV2betaListPoliciesResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Policies.prototype.iamPoliciesOperationsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.IamPoliciesOperationsGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v2beta/{name}", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
    ...
    **/
    Policies.prototype.iamPoliciesUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.IamPoliciesUpdateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v2beta/{name}", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
