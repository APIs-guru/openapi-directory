...
export enum IamRolesListViewEnum {
    Basic = "BASIC"
,    Full = "FULL"
}


export class IamRolesListQueryParams extends SpeakeasyBase {
...
export class IamRolesListSecurity extends SpeakeasyBase {
...
export class IamRolesListRequest extends SpeakeasyBase {
  @Metadata()
...
export class IamRolesListResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
