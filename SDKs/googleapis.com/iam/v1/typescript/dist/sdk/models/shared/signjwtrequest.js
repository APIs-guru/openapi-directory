...
**/
var SignJwtRequest = /** @class */ (function (_super) {
    __extends(SignJwtRequest, _super);
    function SignJwtRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "json, name=payload" }),
        __metadata("design:type", String)
    ], SignJwtRequest.prototype, "payload", void 0);
    return SignJwtRequest;
}(SpeakeasyBase));
export { SignJwtRequest };
