...
type BaremetalsolutionProjectsLocationsVolumesPatchPathParams struct {
	Name string `pathParam:"style=simple,explode=false,name=name"`
}

type BaremetalsolutionProjectsLocationsVolumesPatchQueryParams struct {
...
type BaremetalsolutionProjectsLocationsVolumesPatchSecurity struct {
...
type BaremetalsolutionProjectsLocationsVolumesPatchResponse struct {
	ContentType string
