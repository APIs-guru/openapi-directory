...
func (s *SDK) BaremetalsolutionProjectsLocationsSubmitProvisioningConfig(ctx context.Context, request operations.BaremetalsolutionProjectsLocationsSubmitProvisioningConfigRequest) (*operations.BaremetalsolutionProjectsLocationsSubmitProvisioningConfigResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) BaremetalsolutionProjectsProvisioningQuotasList(ctx context.Context, request operations.BaremetalsolutionProjectsProvisioningQuotasListRequest) (*operations.BaremetalsolutionProjectsProvisioningQuotasListResponse, error) {
	baseURL := s.serverURL
