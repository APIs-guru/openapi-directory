...
class BaremetalsolutionProjectsLocationsSubmitProvisioningConfigRequest:
    path_params: BaremetalsolutionProjectsLocationsSubmitProvisioningConfigPathParams = field()
    query_params: BaremetalsolutionProjectsLocationsSubmitProvisioningConfigQueryParams = field()
    security: BaremetalsolutionProjectsLocationsSubmitProvisioningConfigSecurity = field()
