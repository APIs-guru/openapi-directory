...
class EssentialcontactsProjectsContactsComputeRequest:
    path_params: EssentialcontactsProjectsContactsComputePathParams = field()
    query_params: EssentialcontactsProjectsContactsComputeQueryParams = field()
    security: EssentialcontactsProjectsContactsComputeSecurity = field()
