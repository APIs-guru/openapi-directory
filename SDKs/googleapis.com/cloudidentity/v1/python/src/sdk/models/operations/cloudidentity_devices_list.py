...
class CloudidentityDevicesListQueryParams:
    ...
    view: Optional[CloudidentityDevicesListViewEnum] = field(default=None, metadata={'query_param': { 'field_name': 'view', 'style': 'form', 'explode': True }})
...
class CloudidentityDevicesListSecurity:
    option1: Optional[CloudidentityDevicesListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[CloudidentityDevicesListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
