...
func (s *SDK) CloudidentityDevicesDeviceUsersClientStatesList(ctx context.Context, request operations.CloudidentityDevicesDeviceUsersClientStatesListRequest) (*operations.CloudidentityDevicesDeviceUsersClientStatesListResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) CloudidentityGroupsMembershipsDelete(ctx context.Context, request operations.CloudidentityGroupsMembershipsDeleteRequest) (*operations.CloudidentityGroupsMembershipsDeleteResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) CloudidentityGroupsMembershipsGet(ctx context.Context, request operations.CloudidentityGroupsMembershipsGetRequest) (*operations.CloudidentityGroupsMembershipsGetResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/{name}", request.PathParams)
...
func (s *SDK) CloudidentityGroupsMembershipsList(ctx context.Context, request operations.CloudidentityGroupsMembershipsListRequest) (*operations.CloudidentityGroupsMembershipsListResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/{parent}/memberships", request.PathParams)
...
func (s *SDK) CloudidentityGroupsUpdateSecuritySettings(ctx context.Context, request operations.CloudidentityGroupsUpdateSecuritySettingsRequest) (*operations.CloudidentityGroupsUpdateSecuritySettingsResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/{name}", request.PathParams)
