...
class CloudidentityInboundSsoAssignmentsGetSecurity:
    option1: Optional[CloudidentityInboundSsoAssignmentsGetSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[CloudidentityInboundSsoAssignmentsGetSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[CloudidentityInboundSsoAssignmentsGetSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
