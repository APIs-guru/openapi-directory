...
class AndroidAttributes:
    ...
    ownership_privilege: Optional[AndroidAttributesOwnershipPrivilegeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ownershipPrivilege') }})
