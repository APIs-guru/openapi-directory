...
class CloudidentityOrgUnitsMembershipsListSecurity:
    option1: Optional[CloudidentityOrgUnitsMembershipsListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[CloudidentityOrgUnitsMembershipsListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[CloudidentityOrgUnitsMembershipsListSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
