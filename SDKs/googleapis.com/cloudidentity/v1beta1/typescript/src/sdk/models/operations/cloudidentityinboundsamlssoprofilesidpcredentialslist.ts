...
export class CloudidentityInboundSamlSsoProfilesIdpCredentialsListPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=parent" })
  parent: string;
}


export class CloudidentityInboundSamlSsoProfilesIdpCredentialsListQueryParams extends SpeakeasyBase {
