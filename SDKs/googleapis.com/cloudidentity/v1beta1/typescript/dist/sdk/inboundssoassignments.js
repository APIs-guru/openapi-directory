...
var InboundSsoAssignments = /** @class */ (function () {
    ...
    **/
    InboundSsoAssignments.prototype.cloudidentityInboundSsoAssignmentsCreate = function (req, config) {
        var _a;
    ...
    **/
    InboundSsoAssignments.prototype.cloudidentityInboundSsoAssignmentsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    InboundSsoAssignments.prototype.cloudidentityInboundSsoAssignmentsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.inboundSsoAssignment = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    InboundSsoAssignments.prototype.cloudidentityInboundSsoAssignmentsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.listInboundSsoAssignmentsResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    InboundSsoAssignments.prototype.cloudidentityInboundSsoAssignmentsPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
