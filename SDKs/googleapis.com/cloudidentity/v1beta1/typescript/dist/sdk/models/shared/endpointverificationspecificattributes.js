...
**/
var EndpointVerificationSpecificAttributes = /** @class */ (function (_super) {
    __extends(EndpointVerificationSpecificAttributes, _super);
    function EndpointVerificationSpecificAttributes() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=certificateAttributes", elemType: CertificateAttributes }),
        __metadata("design:type", Array)
    ], EndpointVerificationSpecificAttributes.prototype, "certificateAttributes", void 0);
    return EndpointVerificationSpecificAttributes;
}(SpeakeasyBase));
export { EndpointVerificationSpecificAttributes };
