...
var SDK = /** @class */ (function () {
    function SDK() {
        ...
        this.inboundSamlSsoProfiles = new InboundSamlSsoProfiles(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        this.inboundSsoAssignments = new InboundSsoAssignments(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
