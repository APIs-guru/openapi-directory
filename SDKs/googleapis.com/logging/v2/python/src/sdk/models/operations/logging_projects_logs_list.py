...
class LoggingProjectsLogsListRequest:
    path_params: LoggingProjectsLogsListPathParams = field(default=None)
    query_params: LoggingProjectsLogsListQueryParams = field(default=None)
    security: LoggingProjectsLogsListSecurity = field(default=None)
