...
@dataclass
class LoggingProjectsLocationsBucketsCreateQueryParams:
    dollar_xgafv: Optional[shared.XgafvEnum] = field(default=None, metadata={'query_param': { 'field_name': '$.xgafv', 'style': 'form', 'explode': True }})
    access_token: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'access_token', 'style': 'form', 'explode': True }})
    alt: Optional[shared.AltEnum] = field(default=None, metadata={'query_param': { 'field_name': 'alt', 'style': 'form', 'explode': True }})
    bucket_id: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'bucketId', 'style': 'form', 'explode': True }})
...
@dataclass
class LoggingProjectsLocationsBucketsCreateSecurity:
    option1: Optional[LoggingProjectsLocationsBucketsCreateSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[LoggingProjectsLocationsBucketsCreateSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
