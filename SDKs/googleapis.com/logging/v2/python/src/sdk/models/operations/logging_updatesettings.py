...
@dataclass
class LoggingUpdateSettingsQueryParams:
...
@dataclass
class LoggingUpdateSettingsSecurity:
    option1: Optional[LoggingUpdateSettingsSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[LoggingUpdateSettingsSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
