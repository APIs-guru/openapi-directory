...
@dataclass
class LoggingSinksDeleteQueryParams:
...
@dataclass
class LoggingSinksDeleteSecurity:
    option1: Optional[LoggingSinksDeleteSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[LoggingSinksDeleteSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
