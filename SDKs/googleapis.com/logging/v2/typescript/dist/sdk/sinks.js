...
var Sinks = /** @class */ (function () {
    function Sinks(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Sinks.prototype.loggingSinksCreate = function (req, config) {
        var _a;
    ...
    **/
    Sinks.prototype.loggingSinksDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Sinks.prototype.loggingSinksGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Sinks.prototype.loggingSinksList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Sinks.prototype.loggingSinksUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
