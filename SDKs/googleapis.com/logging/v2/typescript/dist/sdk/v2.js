...
var V2 = /** @class */ (function () {
    ...
    **/
    V2.prototype.loggingGetCmekSettings = function (req, config) {
    ...
    **/
    V2.prototype.loggingGetSettings = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    V2.prototype.loggingUpdateCmekSettings = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    V2.prototype.loggingUpdateSettings = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
