...
class WebmastersSitesListSecurity:
    option1: Optional[WebmastersSitesListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[WebmastersSitesListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
