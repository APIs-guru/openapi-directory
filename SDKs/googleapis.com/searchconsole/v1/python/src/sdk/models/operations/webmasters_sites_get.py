...
class WebmastersSitesGetRequest:
    path_params: WebmastersSitesGetPathParams = field(default=None)
    query_params: WebmastersSitesGetQueryParams = field(default=None)
    security: WebmastersSitesGetSecurity = field(default=None)
