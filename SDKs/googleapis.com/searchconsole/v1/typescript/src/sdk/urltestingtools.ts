  ...
  searchconsoleUrlTestingToolsMobileFriendlyTestRun(
    ...
    return client
      .request({
        ...
        const res: operations.SearchconsoleUrlTestingToolsMobileFriendlyTestRunResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
