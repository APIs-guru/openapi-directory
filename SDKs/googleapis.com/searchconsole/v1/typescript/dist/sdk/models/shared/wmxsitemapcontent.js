...
export var WmxSitemapContentTypeEnum;
(function (WmxSitemapContentTypeEnum) {
...
})(WmxSitemapContentTypeEnum || (WmxSitemapContentTypeEnum = {}));
// WmxSitemapContent
/**
 * Information about the various content types in the sitemap.
**/
var WmxSitemapContent = /** @class */ (function (_super) {
    __extends(WmxSitemapContent, _super);
    function WmxSitemapContent() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "json, name=indexed" }),
        __metadata("design:type", String)
    ], WmxSitemapContent.prototype, "indexed", void 0);
    __decorate([
        Metadata({ data: "json, name=submitted" }),
        __metadata("design:type", String)
    ], WmxSitemapContent.prototype, "submitted", void 0);
    __decorate([
        Metadata({ data: "json, name=type" }),
        __metadata("design:type", String)
    ], WmxSitemapContent.prototype, "type", void 0);
    return WmxSitemapContent;
}(SpeakeasyBase));
export { WmxSitemapContent };
