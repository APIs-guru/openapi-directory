...
class DocsDocumentsBatchUpdateRequest:
    path_params: DocsDocumentsBatchUpdatePathParams = field(default=None)
    query_params: DocsDocumentsBatchUpdateQueryParams = field(default=None)
    request: Optional[shared.BatchUpdateDocumentRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: DocsDocumentsBatchUpdateSecurity = field(default=None)
