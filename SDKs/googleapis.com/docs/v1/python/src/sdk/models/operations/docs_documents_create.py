...
@dataclass
class DocsDocumentsCreateQueryParams:
...
class DocsDocumentsCreateSecurity:
    option1: Optional[DocsDocumentsCreateSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DocsDocumentsCreateSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[DocsDocumentsCreateSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
