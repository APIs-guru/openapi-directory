...
class Person:
    ...
    person_properties: Optional[personproperties.PersonProperties] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'personProperties' }})
