...
**/
var ShadingSuggestionState = /** @class */ (function (_super) {
    __extends(ShadingSuggestionState, _super);
    function ShadingSuggestionState() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=backgroundColorSuggested" }),
        __metadata("design:type", Boolean)
    ], ShadingSuggestionState.prototype, "backgroundColorSuggested", void 0);
    return ShadingSuggestionState;
}(SpeakeasyBase));
export { ShadingSuggestionState };
