...
**/
var BulletSuggestionState = /** @class */ (function (_super) {
    __extends(BulletSuggestionState, _super);
    function BulletSuggestionState() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=listIdSuggested" }),
        __metadata("design:type", Boolean)
    ], BulletSuggestionState.prototype, "listIdSuggested", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=nestingLevelSuggested" }),
        __metadata("design:type", Boolean)
    ], BulletSuggestionState.prototype, "nestingLevelSuggested", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=textStyleSuggestionState" }),
        __metadata("design:type", TextStyleSuggestionState)
    ], BulletSuggestionState.prototype, "textStyleSuggestionState", void 0);
    return BulletSuggestionState;
}(SpeakeasyBase));
export { BulletSuggestionState };
