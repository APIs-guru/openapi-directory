...
export var CreateFooterRequestTypeEnum;
(function (CreateFooterRequestTypeEnum) {
...
})(CreateFooterRequestTypeEnum || (CreateFooterRequestTypeEnum = {}));
// CreateFooterRequest
/**
...
**/
var CreateFooterRequest = /** @class */ (function (_super) {
    __extends(CreateFooterRequest, _super);
    function CreateFooterRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=sectionBreakLocation" }),
        __metadata("design:type", Location)
    ], CreateFooterRequest.prototype, "sectionBreakLocation", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=type" }),
        __metadata("design:type", String)
    ], CreateFooterRequest.prototype, "type", void 0);
    return CreateFooterRequest;
}(SpeakeasyBase));
export { CreateFooterRequest };
