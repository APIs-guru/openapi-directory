...
var CropProperties = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", Number)
    ], CropProperties.prototype, "offsetBottom", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=offsetLeft" }),
        __metadata("design:type", Number)
    ], CropProperties.prototype, "offsetLeft", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=offsetRight" }),
        __metadata("design:type", Number)
    ], CropProperties.prototype, "offsetRight", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=offsetTop" }),
        __metadata("design:type", Number)
    ], CropProperties.prototype, "offsetTop", void 0);
