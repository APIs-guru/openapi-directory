...
**/
var ListPropertiesSuggestionState = /** @class */ (function (_super) {
    __extends(ListPropertiesSuggestionState, _super);
    function ListPropertiesSuggestionState() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=nestingLevelsSuggestionStates", elemType: NestingLevelSuggestionState }),
        __metadata("design:type", Array)
    ], ListPropertiesSuggestionState.prototype, "nestingLevelsSuggestionStates", void 0);
    return ListPropertiesSuggestionState;
}(SpeakeasyBase));
export { ListPropertiesSuggestionState };
