...
**/
var InlineObjectPropertiesSuggestionState = /** @class */ (function (_super) {
    __extends(InlineObjectPropertiesSuggestionState, _super);
    function InlineObjectPropertiesSuggestionState() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=embeddedObjectSuggestionState" }),
        __metadata("design:type", EmbeddedObjectSuggestionState)
    ], InlineObjectPropertiesSuggestionState.prototype, "embeddedObjectSuggestionState", void 0);
    return InlineObjectPropertiesSuggestionState;
}(SpeakeasyBase));
export { InlineObjectPropertiesSuggestionState };
