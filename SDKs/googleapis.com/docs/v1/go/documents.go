...
func (s *Documents) DocsDocumentsBatchUpdate(ctx context.Context, request operations.DocsDocumentsBatchUpdateRequest) (*operations.DocsDocumentsBatchUpdateResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/documents/{documentId}:batchUpdate", request.PathParams)
...
func (s *Documents) DocsDocumentsCreate(ctx context.Context, request operations.DocsDocumentsCreateRequest) (*operations.DocsDocumentsCreateResponse, error) {
	baseURL := s._serverURL
...
func (s *Documents) DocsDocumentsGet(ctx context.Context, request operations.DocsDocumentsGetRequest) (*operations.DocsDocumentsGetResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/documents/{documentId}", request.PathParams)
