...
class SasportalNodesNodesMoveRequest:
    path_params: SasportalNodesNodesMovePathParams = field()
    query_params: SasportalNodesNodesMoveQueryParams = field()
    security: SasportalNodesNodesMoveSecurity = field()
