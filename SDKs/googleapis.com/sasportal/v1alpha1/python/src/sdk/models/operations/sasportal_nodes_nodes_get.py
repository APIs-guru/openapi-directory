...
@dataclass
class SasportalNodesNodesGetQueryParams:
...
@dataclass
class SasportalNodesNodesGetSecurityOption1:
    oauth2: shared.SchemeOauth2 = field(default=None, metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    oauth2c: shared.SchemeOauth2c = field(default=None, metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclass
class SasportalNodesNodesGetSecurityOption2:
    oauth2: shared.SchemeOauth2 = field(default=None, metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    oauth2c: shared.SchemeOauth2c = field(default=None, metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
...
class SasportalNodesNodesGetSecurity:
    option1: Optional[SasportalNodesNodesGetSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[SasportalNodesNodesGetSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
