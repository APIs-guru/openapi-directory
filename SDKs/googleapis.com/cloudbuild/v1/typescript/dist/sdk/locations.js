...
var Locations = /** @class */ (function () {
    ...
    **/
    Locations.prototype.cloudbuildLocationsRegionalWebhook = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CloudbuildLocationsRegionalWebhookRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{location}/regionalWebhook", req.pathParams);
