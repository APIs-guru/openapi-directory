...
**/
var Artifacts = /** @class */ (function (_super) {
    __extends(Artifacts, _super);
    function Artifacts() {
    ...
    ], Artifacts.prototype, "images", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=mavenArtifacts", elemType: MavenArtifact }),
        __metadata("design:type", Array)
    ], Artifacts.prototype, "mavenArtifacts", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=objects" }),
        __metadata("design:type", ArtifactObjects)
    ], Artifacts.prototype, "objects", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=pythonPackages", elemType: PythonPackage }),
        __metadata("design:type", Array)
    ], Artifacts.prototype, "pythonPackages", void 0);
    return Artifacts;
}(SpeakeasyBase));
export { Artifacts };
