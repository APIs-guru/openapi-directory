...
type CloudbuildProjectsTriggersListPathParams struct {
	ProjectID string `pathParam:"style=simple,explode=false,name=projectId"`
}

type CloudbuildProjectsTriggersListQueryParams struct {
...
type CloudbuildProjectsTriggersListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type CloudbuildProjectsTriggersListRequest struct {
...
type CloudbuildProjectsTriggersListResponse struct {
	ContentType               string
