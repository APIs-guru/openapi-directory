...
type CloudbuildProjectsTriggersCreatePathParams struct {
    ProjectID string `pathParam:"style=simple,explode=false,name=projectId"`
    
}

type CloudbuildProjectsTriggersCreateQueryParams struct {
...
type CloudbuildProjectsTriggersCreateSecurity struct {
    Oauth2 shared.SchemeOauth2 `security:"scheme,type=oauth2"`
    Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
    
}

type CloudbuildProjectsTriggersCreateRequest struct {
...
type CloudbuildProjectsTriggersCreateResponse struct {
