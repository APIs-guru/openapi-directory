...
type CloudbuildProjectsLocationsGitLabConfigsConnectedRepositoriesBatchCreatePathParams struct {
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type CloudbuildProjectsLocationsGitLabConfigsConnectedRepositoriesBatchCreateQueryParams struct {
...
type CloudbuildProjectsLocationsGitLabConfigsConnectedRepositoriesBatchCreateSecurity struct {
...
type CloudbuildProjectsLocationsGitLabConfigsConnectedRepositoriesBatchCreateResponse struct {
	ContentType string
