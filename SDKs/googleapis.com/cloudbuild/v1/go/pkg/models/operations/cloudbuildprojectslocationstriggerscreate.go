...
type CloudbuildProjectsLocationsTriggersCreatePathParams struct {
    Parent string `pathParam:"style=simple,explode=false,name=parent"`
    
}

type CloudbuildProjectsLocationsTriggersCreateQueryParams struct {
...
type CloudbuildProjectsLocationsTriggersCreateSecurity struct {
...
type CloudbuildProjectsLocationsTriggersCreateResponse struct {
