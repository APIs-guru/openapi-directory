...
type CloudbuildProjectsTriggersPatchPathParams struct {
	ProjectID string `pathParam:"style=simple,explode=false,name=projectId"`
	TriggerID string `pathParam:"style=simple,explode=false,name=triggerId"`
}

type CloudbuildProjectsTriggersPatchQueryParams struct {
...
type CloudbuildProjectsTriggersPatchSecurity struct {
...
type CloudbuildProjectsTriggersPatchResponse struct {
