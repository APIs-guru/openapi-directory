...
type CloudbuildProjectsBuildsCreatePathParams struct {
	ProjectID string `pathParam:"style=simple,explode=false,name=projectId"`
}

type CloudbuildProjectsBuildsCreateQueryParams struct {
...
type CloudbuildProjectsBuildsCreateSecurity struct {
...
type CloudbuildProjectsBuildsCreateResponse struct {
	ContentType string
