...
**/
var FeatureDescription = /** @class */ (function (_super) {
    __extends(FeatureDescription, _super);
    ...
    ], FeatureDescription.prototype, "headline", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=image" }),
        __metadata("design:type", Image)
    ], FeatureDescription.prototype, "image", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=text" }),
        __metadata("design:type", String)
    ], FeatureDescription.prototype, "text", void 0);
