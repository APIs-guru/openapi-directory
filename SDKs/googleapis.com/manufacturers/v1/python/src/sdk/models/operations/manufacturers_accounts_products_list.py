...
class ManufacturersAccountsProductsListRequest:
    path_params: ManufacturersAccountsProductsListPathParams = field(default=None)
    query_params: ManufacturersAccountsProductsListQueryParams = field(default=None)
    security: ManufacturersAccountsProductsListSecurity = field(default=None)
