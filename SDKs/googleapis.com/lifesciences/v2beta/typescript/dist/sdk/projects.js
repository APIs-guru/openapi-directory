...
var Projects = /** @class */ (function () {
    ...
    **/
    Projects.prototype.lifesciencesProjectsLocationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.LifesciencesProjectsLocationsListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v2beta/{name}/locations", req.pathParams);
    ...
    **/
    Projects.prototype.lifesciencesProjectsLocationsOperationsCancel = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.LifesciencesProjectsLocationsOperationsCancelRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v2beta/{name}:cancel", req.pathParams);
    ...
    **/
    Projects.prototype.lifesciencesProjectsLocationsOperationsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.LifesciencesProjectsLocationsOperationsGetRequest(req);
        }
        var baseURL = this._serverURL;
    ...
    **/
    Projects.prototype.lifesciencesProjectsLocationsOperationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.LifesciencesProjectsLocationsOperationsListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v2beta/{name}/operations", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    Projects.prototype.lifesciencesProjectsLocationsPipelinesRun = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.LifesciencesProjectsLocationsPipelinesRunRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v2beta/{parent}/pipelines:run", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
