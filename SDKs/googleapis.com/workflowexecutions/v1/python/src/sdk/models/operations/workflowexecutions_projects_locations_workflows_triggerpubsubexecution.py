...
class WorkflowexecutionsProjectsLocationsWorkflowsTriggerPubsubExecutionPathParams:
    workflow: str = field(default=None, metadata={'path_param': { 'field_name': 'workflow', 'style': 'simple', 'explode': False }})
...
class WorkflowexecutionsProjectsLocationsWorkflowsTriggerPubsubExecutionRequest:
    path_params: WorkflowexecutionsProjectsLocationsWorkflowsTriggerPubsubExecutionPathParams = field(default=None)
    query_params: WorkflowexecutionsProjectsLocationsWorkflowsTriggerPubsubExecutionQueryParams = field(default=None)
    request: Optional[shared.TriggerPubsubExecutionRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: WorkflowexecutionsProjectsLocationsWorkflowsTriggerPubsubExecutionSecurity = field(default=None)
