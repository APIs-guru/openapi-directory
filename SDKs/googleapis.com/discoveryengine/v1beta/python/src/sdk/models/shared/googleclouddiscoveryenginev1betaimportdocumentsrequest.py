...
class GoogleCloudDiscoveryengineV1betaImportDocumentsRequest:
    ...
    inline_source: Optional[GoogleCloudDiscoveryengineV1betaImportDocumentsRequestInlineSource] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('inlineSource') }})
    reconciliation_mode: Optional[GoogleCloudDiscoveryengineV1betaImportDocumentsRequestReconciliationModeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('reconciliationMode') }})
