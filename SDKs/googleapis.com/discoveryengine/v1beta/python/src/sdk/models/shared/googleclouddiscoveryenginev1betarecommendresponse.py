...
class GoogleCloudDiscoveryengineV1betaRecommendResponse:
    ...
    results: Optional[List[GoogleCloudDiscoveryengineV1betaRecommendResponseRecommendationResult]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
