...
class DiscoveryengineProjectsLocationsDataStoresServingConfigsRecommendRequest:
    ...
    request: Optional[shared.GoogleCloudDiscoveryengineV1alphaRecommendRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class DiscoveryengineProjectsLocationsDataStoresServingConfigsRecommendResponse:
    ...
    google_cloud_discoveryengine_v1alpha_recommend_response: Optional[shared.GoogleCloudDiscoveryengineV1alphaRecommendResponse] = field(default=None)
