  ...
  MybusinessbusinesscallsLocationsBusinesscallsinsightsList(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        let res: operations.MybusinessbusinesscallsLocationsBusinesscallsinsightsListResponse = {statusCode: httpRes.status, contentType: contentType};
  ...
  MybusinessbusinesscallsLocationsGetBusinesscallssettings(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.MybusinessbusinesscallsLocationsGetBusinesscallssettingsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  MybusinessbusinesscallsLocationsUpdateBusinesscallssettings(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.MybusinessbusinesscallsLocationsUpdateBusinesscallssettingsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.businessCallsSettings = httpRes?.data;
