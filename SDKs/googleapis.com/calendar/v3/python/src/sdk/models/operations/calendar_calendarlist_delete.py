...
class CalendarCalendarListDeleteRequest:
    path_params: CalendarCalendarListDeletePathParams = field()
    query_params: CalendarCalendarListDeleteQueryParams = field()
    security: CalendarCalendarListDeleteSecurity = field()
