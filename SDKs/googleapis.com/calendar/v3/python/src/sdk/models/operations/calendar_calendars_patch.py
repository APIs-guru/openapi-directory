...
class CalendarCalendarsPatchRequest:
    path_params: CalendarCalendarsPatchPathParams = field(default=None)
    query_params: CalendarCalendarsPatchQueryParams = field(default=None)
    request: Optional[shared.Calendar] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: CalendarCalendarsPatchSecurity = field(default=None)
