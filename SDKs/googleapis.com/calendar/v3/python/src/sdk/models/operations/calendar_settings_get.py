...
class CalendarSettingsGetPathParams:
    setting: str = field(metadata={'path_param': { 'field_name': 'setting', 'style': 'simple', 'explode': False }})
...
class CalendarSettingsGetRequest:
    path_params: CalendarSettingsGetPathParams = field()
    query_params: CalendarSettingsGetQueryParams = field()
    security: CalendarSettingsGetSecurity = field()
