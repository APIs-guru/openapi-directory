...
class CalendarEventsGetRequest:
    path_params: CalendarEventsGetPathParams = field(default=None)
    query_params: CalendarEventsGetQueryParams = field(default=None)
    security: CalendarEventsGetSecurity = field(default=None)
