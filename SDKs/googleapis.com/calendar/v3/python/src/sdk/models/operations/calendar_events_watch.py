...
class CalendarEventsWatchQueryParams:
    ...
    order_by: Optional[CalendarEventsWatchOrderByEnum] = field(default=None, metadata={'query_param': { 'field_name': 'orderBy', 'style': 'form', 'explode': True }})
...
class CalendarEventsWatchSecurity:
    option1: Optional[CalendarEventsWatchSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[CalendarEventsWatchSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[CalendarEventsWatchSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
    option4: Optional[CalendarEventsWatchSecurityOption4] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class CalendarEventsWatchRequest:
    path_params: CalendarEventsWatchPathParams = field(default=None)
    query_params: CalendarEventsWatchQueryParams = field(default=None)
    request: Optional[shared.Channel] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: CalendarEventsWatchSecurity = field(default=None)
