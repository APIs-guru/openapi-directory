...
class CalendarCalendarListUpdateRequest:
    path_params: CalendarCalendarListUpdatePathParams = field(default=None)
    query_params: CalendarCalendarListUpdateQueryParams = field(default=None)
    request: Optional[shared.CalendarListEntry] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: CalendarCalendarListUpdateSecurity = field(default=None)
