...
class CalendarACLDeleteRequest:
    path_params: CalendarACLDeletePathParams = field(default=None)
    query_params: CalendarACLDeleteQueryParams = field(default=None)
    security: CalendarACLDeleteSecurity = field(default=None)
