...
class CalendarCalendarListGetSecurity:
    option1: Optional[CalendarCalendarListGetSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[CalendarCalendarListGetSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
