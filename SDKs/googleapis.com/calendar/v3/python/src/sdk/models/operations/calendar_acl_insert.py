...
class CalendarACLInsertRequest:
    path_params: CalendarACLInsertPathParams = field(default=None)
    query_params: CalendarACLInsertQueryParams = field(default=None)
    request: Optional[shared.ACLRule] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: CalendarACLInsertSecurity = field(default=None)
