...
export class ResponsePolicyRules {
  ...
  **/
  dnsResponsePolicyRulesCreate(
    ...
    const url: string = utils.GenerateURL(baseURL, "/dns/v1/projects/{project}/responsePolicies/{responsePolicy}/rules", req.pathParams);
  ...
  **/
  dnsResponsePolicyRulesDelete(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/dns/v1/projects/{project}/responsePolicies/{responsePolicy}/rules/{responsePolicyRule}", req.pathParams);
