...
export class SDK {
  ...
  DnsDnsKeysGet(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/dns/v1/projects/{project}/managedZones/{managedZone}/dnsKeys/{dnsKeyId}", req.pathParams);
  ...
  DnsDnsKeysList(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/dns/v1/projects/{project}/managedZones/{managedZone}/dnsKeys", req.pathParams);
  ...
  DnsPoliciesCreate(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/dns/v1/projects/{project}/policies", req.pathParams);
  ...
  DnsPoliciesDelete(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/dns/v1/projects/{project}/policies/{policy}", req.pathParams);
  ...
  DnsProjectsGet(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/dns/v1/projects/{project}", req.pathParams);
