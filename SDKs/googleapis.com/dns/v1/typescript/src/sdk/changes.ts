...
export class Changes {
  ...
  **/
  dnsChangesCreate(
    ...
    const url: string = utils.GenerateURL(baseURL, "/dns/v1/projects/{project}/managedZones/{managedZone}/changes", req.pathParams);
  ...
  **/
  dnsChangesGet(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/dns/v1/projects/{project}/managedZones/{managedZone}/changes/{changeId}", req.pathParams);
