...
var ResponsePolicyRules = /** @class */ (function () {
    ...
    **/
    ResponsePolicyRules.prototype.dnsResponsePolicyRulesCreate = function (req, config) {
        ...
        var url = utils.GenerateURL(baseURL, "/dns/v1/projects/{project}/responsePolicies/{responsePolicy}/rules", req.pathParams);
    ...
    **/
    ResponsePolicyRules.prototype.dnsResponsePolicyRulesDelete = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/dns/v1/projects/{project}/responsePolicies/{responsePolicy}/rules/{responsePolicyRule}", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
