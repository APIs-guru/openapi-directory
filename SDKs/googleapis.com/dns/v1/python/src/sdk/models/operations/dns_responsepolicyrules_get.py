...
@dataclass
class DNSResponsePolicyRulesGetQueryParams:
...
@dataclass
class DNSResponsePolicyRulesGetSecurity:
    option1: Optional[DNSResponsePolicyRulesGetSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DNSResponsePolicyRulesGetSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[DNSResponsePolicyRulesGetSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
    option4: Optional[DNSResponsePolicyRulesGetSecurityOption4] = field(default=None, metadata={'security': { 'option': True }})
