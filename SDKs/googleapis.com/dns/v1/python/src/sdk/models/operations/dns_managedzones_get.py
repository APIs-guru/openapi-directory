...
class DNSManagedZonesGetRequest:
    path_params: DNSManagedZonesGetPathParams = field(default=None)
    query_params: DNSManagedZonesGetQueryParams = field(default=None)
    security: DNSManagedZonesGetSecurity = field(default=None)
