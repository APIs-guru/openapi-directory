...
class SDK:
    ...
    def dns_dns_keys_get(self, request: operations.DNSDNSKeysGetRequest) -> operations.DNSDNSKeysGetResponse:
        ...
        base_url = self.server_url
        url = utils.generate_url(base_url, "/dns/v1/projects/{project}/managedZones/{managedZone}/dnsKeys/{dnsKeyId}", request.path_params)
    ...
    def dns_dns_keys_list(self, request: operations.DNSDNSKeysListRequest) -> operations.DNSDNSKeysListResponse:
        ...
        base_url = self.server_url
        url = utils.generate_url(base_url, "/dns/v1/projects/{project}/managedZones/{managedZone}/dnsKeys", request.path_params)
    ...
    def dns_projects_get(self, request: operations.DNSProjectsGetRequest) -> operations.DNSProjectsGetResponse:
        ...
        base_url = self.server_url
        url = utils.generate_url(base_url, "/dns/v1/projects/{project}", request.path_params)
