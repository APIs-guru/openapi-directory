...
class DNSResourceRecordSetsPatchSecurity:
    option1: Optional[DNSResourceRecordSetsPatchSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DNSResourceRecordSetsPatchSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
