...
class DNSManagedZonesTestIamPermissionsSecurity:
    option1: Optional[DNSManagedZonesTestIamPermissionsSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DNSManagedZonesTestIamPermissionsSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[DNSManagedZonesTestIamPermissionsSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
    option4: Optional[DNSManagedZonesTestIamPermissionsSecurityOption4] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class DNSManagedZonesTestIamPermissionsRequest:
    path_params: DNSManagedZonesTestIamPermissionsPathParams = field(default=None)
    query_params: DNSManagedZonesTestIamPermissionsQueryParams = field(default=None)
    ...
    security: DNSManagedZonesTestIamPermissionsSecurity = field(default=None)
