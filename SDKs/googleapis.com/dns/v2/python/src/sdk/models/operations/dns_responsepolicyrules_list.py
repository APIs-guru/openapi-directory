...
class DNSResponsePolicyRulesListRequest:
    path_params: DNSResponsePolicyRulesListPathParams = field()
    query_params: DNSResponsePolicyRulesListQueryParams = field()
    security: DNSResponsePolicyRulesListSecurity = field()
