...
class DNSResponsePoliciesCreateSecurity:
    option1: Optional[DNSResponsePoliciesCreateSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DNSResponsePoliciesCreateSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
