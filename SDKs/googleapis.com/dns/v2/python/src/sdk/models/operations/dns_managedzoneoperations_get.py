...
class DNSManagedZoneOperationsGetSecurity:
    option1: Optional[DNSManagedZoneOperationsGetSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DNSManagedZoneOperationsGetSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[DNSManagedZoneOperationsGetSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
    option4: Optional[DNSManagedZoneOperationsGetSecurityOption4] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class DNSManagedZoneOperationsGetRequest:
    path_params: DNSManagedZoneOperationsGetPathParams = field(default=None)
    query_params: DNSManagedZoneOperationsGetQueryParams = field(default=None)
    security: DNSManagedZoneOperationsGetSecurity = field(default=None)
