...
class DNSPoliciesPatchSecurity:
    option1: Optional[DNSPoliciesPatchSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DNSPoliciesPatchSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class DNSPoliciesPatchRequest:
    path_params: DNSPoliciesPatchPathParams = field(default=None)
    query_params: DNSPoliciesPatchQueryParams = field(default=None)
    request: Optional[shared.Policy] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: DNSPoliciesPatchSecurity = field(default=None)
    

@dataclass
class DNSPoliciesPatchResponse:
    content_type: str = field(default=None)
    policies_patch_response: Optional[shared.PoliciesPatchResponse] = field(default=None)
