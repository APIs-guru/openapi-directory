...
class DNSPoliciesGetRequest:
    path_params: DNSPoliciesGetPathParams = field(default=None)
    query_params: DNSPoliciesGetQueryParams = field(default=None)
    security: DNSPoliciesGetSecurity = field(default=None)
