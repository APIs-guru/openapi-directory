...
class DNSResponsePoliciesPatchRequest:
    path_params: DNSResponsePoliciesPatchPathParams = field(default=None)
    query_params: DNSResponsePoliciesPatchQueryParams = field(default=None)
    request: Optional[shared.ResponsePolicy] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: DNSResponsePoliciesPatchSecurity = field(default=None)
