...
func (s *SDK) DNSChangesCreate(ctx context.Context, request operations.DNSChangesCreateRequest) (*operations.DNSChangesCreateResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}/changes", request.PathParams)
...
func (s *SDK) DNSChangesGet(ctx context.Context, request operations.DNSChangesGetRequest) (*operations.DNSChangesGetResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}/changes/{changeId}", request.PathParams)
...
func (s *SDK) DNSDNSKeysGet(ctx context.Context, request operations.DNSDNSKeysGetRequest) (*operations.DNSDNSKeysGetResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}/dnsKeys/{dnsKeyId}", request.PathParams)
...
func (s *SDK) DNSDNSKeysList(ctx context.Context, request operations.DNSDNSKeysListRequest) (*operations.DNSDNSKeysListResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}/dnsKeys", request.PathParams)
...
func (s *SDK) DNSResourceRecordSetsCreate(ctx context.Context, request operations.DNSResourceRecordSetsCreateRequest) (*operations.DNSResourceRecordSetsCreateResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}/rrsets", request.PathParams)
...
func (s *SDK) DNSResourceRecordSetsDelete(ctx context.Context, request operations.DNSResourceRecordSetsDeleteRequest) (*operations.DNSResourceRecordSetsDeleteResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}/rrsets/{name}/{type}", request.PathParams)
