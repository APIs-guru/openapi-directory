...
var Policies = /** @class */ (function () {
    ...
    **/
    Policies.prototype.dnsPoliciesCreate = function (req, config) {
        ...
        var url = utils.GenerateURL(baseURL, "/dns/v2/projects/{project}/locations/{location}/policies", req.pathParams);
    ...
    **/
    Policies.prototype.dnsPoliciesDelete = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/dns/v2/projects/{project}/locations/{location}/policies/{policy}", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
