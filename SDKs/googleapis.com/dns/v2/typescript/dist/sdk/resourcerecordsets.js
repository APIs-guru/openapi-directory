...
var ResourceRecordSets = /** @class */ (function () {
    ...
    **/
    ResourceRecordSets.prototype.dnsResourceRecordSetsCreate = function (req, config) {
        ...
        var url = utils.GenerateURL(baseURL, "/dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}/rrsets", req.pathParams);
    ...
    **/
    ResourceRecordSets.prototype.dnsResourceRecordSetsDelete = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}/rrsets/{name}/{type}", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
