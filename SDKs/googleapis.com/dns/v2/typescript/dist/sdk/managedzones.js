...
var ManagedZones = /** @class */ (function () {
    ...
    **/
    ManagedZones.prototype.dnsManagedZonesCreate = function (req, config) {
        ...
        var url = utils.GenerateURL(baseURL, "/dns/v2/projects/{project}/locations/{location}/managedZones", req.pathParams);
    ...
    **/
    ManagedZones.prototype.dnsManagedZonesDelete = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    ManagedZones.prototype.dnsManagedZonesGetIamPolicy = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/dns/v2/{resource}:getIamPolicy", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    ManagedZones.prototype.dnsManagedZonesSetIamPolicy = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/dns/v2/{resource}:setIamPolicy", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    ManagedZones.prototype.dnsManagedZonesTestIamPermissions = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/dns/v2/{resource}:testIamPermissions", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
