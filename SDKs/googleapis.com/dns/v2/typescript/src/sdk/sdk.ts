...
export class SDK {
  ...
  DnsChangesCreate(
    ...
    const url: string = utils.GenerateURL(baseURL, "/dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}/changes", req.pathParams);
  ...
  DnsChangesGet(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}/changes/{changeId}", req.pathParams);
  ...
  DnsManagedZoneOperationsGet(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}/operations/{operation}", req.pathParams);
  ...
  DnsManagedZoneOperationsList(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}/operations", req.pathParams);
  ...
  DnsManagedZonesCreate(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/dns/v2/projects/{project}/locations/{location}/managedZones", req.pathParams);
  ...
  DnsManagedZonesDelete(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}", req.pathParams);
  ...
  DnsManagedZonesGetIamPolicy(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/dns/v2/{resource}:getIamPolicy", req.pathParams);
  ...
  DnsManagedZonesSetIamPolicy(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/dns/v2/{resource}:setIamPolicy", req.pathParams);
  ...
  DnsManagedZonesTestIamPermissions(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/dns/v2/{resource}:testIamPermissions", req.pathParams);
  ...
  DnsPoliciesCreate(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/dns/v2/projects/{project}/locations/{location}/policies", req.pathParams);
  ...
  DnsPoliciesDelete(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/dns/v2/projects/{project}/locations/{location}/policies/{policy}", req.pathParams);
  ...
  DnsProjectsGet(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/dns/v2/projects/{project}/locations/{location}", req.pathParams);
  ...
  DnsResourceRecordSetsCreate(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}/rrsets", req.pathParams);
  ...
  DnsResourceRecordSetsDelete(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/dns/v2/projects/{project}/locations/{location}/managedZones/{managedZone}/rrsets/{name}/{type}", req.pathParams);
  ...
  DnsResponsePoliciesCreate(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/dns/v2/projects/{project}/locations/{location}/responsePolicies", req.pathParams);
  ...
  DnsResponsePoliciesDelete(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/dns/v2/projects/{project}/locations/{location}/responsePolicies/{responsePolicy}", req.pathParams);
  ...
  DnsResponsePolicyRulesCreate(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/dns/v2/projects/{project}/locations/{location}/responsePolicies/{responsePolicy}/rules", req.pathParams);
  ...
  DnsResponsePolicyRulesDelete(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/dns/v2/projects/{project}/locations/{location}/responsePolicies/{responsePolicy}/rules/{responsePolicyRule}", req.pathParams);
