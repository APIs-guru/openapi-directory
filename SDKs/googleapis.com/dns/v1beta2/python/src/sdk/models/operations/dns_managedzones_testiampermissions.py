...
class DNSManagedZonesTestIamPermissionsRequest:
    path_params: DNSManagedZonesTestIamPermissionsPathParams = field()
    query_params: DNSManagedZonesTestIamPermissionsQueryParams = field()
    security: DNSManagedZonesTestIamPermissionsSecurity = field()
