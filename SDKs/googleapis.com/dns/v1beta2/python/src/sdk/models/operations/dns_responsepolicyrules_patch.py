...
class DNSResponsePolicyRulesPatchSecurity:
    option1: Optional[DNSResponsePolicyRulesPatchSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DNSResponsePolicyRulesPatchSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
