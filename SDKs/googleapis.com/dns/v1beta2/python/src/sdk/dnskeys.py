...
class DNSKeys:
    ...
    def dns_dns_keys_get(self, request: operations.DNSDNSKeysGetRequest) -> operations.DNSDNSKeysGetResponse:
        ...
        url = utils.generate_url(base_url, "/dns/v1beta2/projects/{project}/managedZones/{managedZone}/dnsKeys/{dnsKeyId}", request.path_params)
    ...
    def dns_dns_keys_list(self, request: operations.DNSDNSKeysListRequest) -> operations.DNSDNSKeysListResponse:
        ...
        url = utils.generate_url(base_url, "/dns/v1beta2/projects/{project}/managedZones/{managedZone}/dnsKeys", request.path_params)
