...
type DatacatalogProjectsLocationsTaxonomiesImportRequest struct {
    ...
    Request *shared.GoogleCloudDatacatalogV1beta1ImportTaxonomiesRequest `request:"mediaType=application/json"`
...
type DatacatalogProjectsLocationsTaxonomiesImportResponse struct {
    ContentType string 
    GoogleCloudDatacatalogV1beta1ImportTaxonomiesResponse *shared.GoogleCloudDatacatalogV1beta1ImportTaxonomiesResponse 
    StatusCode int64 
