...
class GoogleCloudDatacatalogV1beta1SearchCatalogRequest:
    r"""GoogleCloudDatacatalogV1beta1SearchCatalogRequest
    ...
    scope: Optional[GoogleCloudDatacatalogV1beta1SearchCatalogRequestScope] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('scope') }})
