...
class GoogleCloudDatacatalogV1SearchCatalogRequest:
    r"""GoogleCloudDatacatalogV1SearchCatalogRequest
    ...
    scope: Optional[GoogleCloudDatacatalogV1SearchCatalogRequestScope] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('scope') }})
