...
from . import googleclouddatacatalogv1tagfieldenumvalue
...
class GoogleCloudDatacatalogV1TagField:
    ...
    enum_value: Optional[googleclouddatacatalogv1tagfieldenumvalue.GoogleCloudDatacatalogV1TagFieldEnumValue] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'enumValue' }})
    order: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'order' }})
    richtext_value: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'richtextValue' }})
