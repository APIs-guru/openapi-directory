...
class GoogleCloudDatacatalogV1SearchCatalogRequestScope:
    r"""GoogleCloudDatacatalogV1SearchCatalogRequestScope
    ...
    include_public_tag_templates: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('includePublicTagTemplates') }})
    ...
    starred_only: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('starredOnly') }})
