...
from . import googleclouddatacatalogv1fieldtype
...
class GoogleCloudDatacatalogV1TagTemplateField:
    ...
    type: Optional[googleclouddatacatalogv1fieldtype.GoogleCloudDatacatalogV1FieldType] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'type' }})
