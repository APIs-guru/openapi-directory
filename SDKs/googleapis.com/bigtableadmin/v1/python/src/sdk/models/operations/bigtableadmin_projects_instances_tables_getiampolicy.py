...
class BigtableadminProjectsInstancesTablesGetIamPolicyRequest:
    path_params: BigtableadminProjectsInstancesTablesGetIamPolicyPathParams = field()
    query_params: BigtableadminProjectsInstancesTablesGetIamPolicyQueryParams = field()
    security: BigtableadminProjectsInstancesTablesGetIamPolicySecurity = field()
