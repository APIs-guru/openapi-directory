...
class BigtableadminProjectsInstancesClustersBackupsPatchRequest:
    path_params: BigtableadminProjectsInstancesClustersBackupsPatchPathParams = field()
    query_params: BigtableadminProjectsInstancesClustersBackupsPatchQueryParams = field()
    security: BigtableadminProjectsInstancesClustersBackupsPatchSecurity = field()
