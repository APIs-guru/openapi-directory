...
class BigtableadminProjectsInstancesListRequest:
    path_params: BigtableadminProjectsInstancesListPathParams = field()
    query_params: BigtableadminProjectsInstancesListQueryParams = field()
    security: BigtableadminProjectsInstancesListSecurity = field()
