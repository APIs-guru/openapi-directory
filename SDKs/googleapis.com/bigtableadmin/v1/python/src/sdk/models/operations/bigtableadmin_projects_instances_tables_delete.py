...
class BigtableadminProjectsInstancesTablesDeleteRequest:
    path_params: BigtableadminProjectsInstancesTablesDeletePathParams = field(default=None)
    query_params: BigtableadminProjectsInstancesTablesDeleteQueryParams = field(default=None)
    security: BigtableadminProjectsInstancesTablesDeleteSecurity = field(default=None)
