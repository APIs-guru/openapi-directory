...
class Projects:
    ...
    def bigtableadmin_projects_instances_clusters_backups_copy(self, request: operations.BigtableadminProjectsInstancesClustersBackupsCopyRequest) -> operations.BigtableadminProjectsInstancesClustersBackupsCopyResponse:
        ...
        url = utils.generate_url(base_url, "/v2/{parent}/backups:copy", request.path_params)
        ...
        res = operations.BigtableadminProjectsInstancesClustersBackupsCopyResponse(status_code=r.status_code, content_type=content_type)
    ...
    def bigtableadmin_projects_instances_tables_patch(self, request: operations.BigtableadminProjectsInstancesTablesPatchRequest) -> operations.BigtableadminProjectsInstancesTablesPatchResponse:
        ...
        res = operations.BigtableadminProjectsInstancesTablesPatchResponse(status_code=r.status_code, content_type=content_type)
