...
class BigtableadminProjectsInstancesTablesUndeleteRequest:
    path_params: BigtableadminProjectsInstancesTablesUndeletePathParams = field(default=None)
    query_params: BigtableadminProjectsInstancesTablesUndeleteQueryParams = field(default=None)
    request: Optional[dict[str, Any]] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: BigtableadminProjectsInstancesTablesUndeleteSecurity = field(default=None)
