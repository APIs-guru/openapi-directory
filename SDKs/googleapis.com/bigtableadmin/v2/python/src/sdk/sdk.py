...
class SDK:
    ...
    def bigtableadmin_projects_instances_clusters_hot_tablets_list(self, request: operations.BigtableadminProjectsInstancesClustersHotTabletsListRequest) -> operations.BigtableadminProjectsInstancesClustersHotTabletsListResponse:
        warnings.simplefilter("ignore")

        base_url = self.server_url
        url = utils.generate_url(base_url, "/v2/{parent}/hotTablets", request.path_params)
        ...
        res = operations.BigtableadminProjectsInstancesClustersHotTabletsListResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListHotTabletsResponse])
    ...
    def bigtableadmin_projects_instances_tables_undelete(self, request: operations.BigtableadminProjectsInstancesTablesUndeleteRequest) -> operations.BigtableadminProjectsInstancesTablesUndeleteResponse:
        warnings.simplefilter("ignore")
        ...
        res = operations.BigtableadminProjectsInstancesTablesUndeleteResponse(status_code=r.status_code, content_type=content_type)
