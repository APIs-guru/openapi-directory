...
var Schedule = /** @class */ (function (_super) {
    ...
    ], Schedule.prototype, "endTimeOfDay", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=repeatInterval" }),
        __metadata("design:type", String)
    ], Schedule.prototype, "repeatInterval", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=scheduleEndDate" }),
        __metadata("design:type", Date)
    ], Schedule.prototype, "scheduleEndDate", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=scheduleStartDate" }),
        __metadata("design:type", Date)
    ], Schedule.prototype, "scheduleStartDate", void 0);
    __decorate([
