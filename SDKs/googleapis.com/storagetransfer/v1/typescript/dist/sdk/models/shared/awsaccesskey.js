...
**/
var AwsAccessKey = /** @class */ (function (_super) {
    __extends(AwsAccessKey, _super);
    ...
    ], AwsAccessKey.prototype, "accessKeyId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=secretAccessKey" }),
        __metadata("design:type", String)
    ], AwsAccessKey.prototype, "secretAccessKey", void 0);
    return AwsAccessKey;
}(SpeakeasyBase));
export { AwsAccessKey };
