...
var TransferOperations = /** @class */ (function () {
    function TransferOperations(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    TransferOperations.prototype.storagetransferTransferOperationsCancel = function (req, config) {
        var _a;
    ...
    **/
    TransferOperations.prototype.storagetransferTransferOperationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    TransferOperations.prototype.storagetransferTransferOperationsPause = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    TransferOperations.prototype.storagetransferTransferOperationsResume = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
