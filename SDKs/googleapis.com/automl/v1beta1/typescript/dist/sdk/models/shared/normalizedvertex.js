...
**/
var NormalizedVertex = /** @class */ (function (_super) {
    __extends(NormalizedVertex, _super);
    ...
    ], NormalizedVertex.prototype, "x", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=y" }),
        __metadata("design:type", Number)
    ], NormalizedVertex.prototype, "y", void 0);
    return NormalizedVertex;
}(SpeakeasyBase));
export { NormalizedVertex };
