...
type RunProjectsLocationsRevisionsListPathParams struct {
    Parent string `pathParam:"style=simple,explode=false,name=parent"`
    
}

type RunProjectsLocationsRevisionsListQueryParams struct {
...
type RunProjectsLocationsRevisionsListSecurity struct {
    Oauth2 shared.SchemeOauth2 `security:"scheme,type=oauth2"`
    Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
    
}

type RunProjectsLocationsRevisionsListRequest struct {
...
type RunProjectsLocationsRevisionsListResponse struct {
    ContentType string 
