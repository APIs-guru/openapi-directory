...
type RunNamespacesDomainmappingsListPathParams struct {
    Parent string `pathParam:"style=simple,explode=false,name=parent"`
    
}

type RunNamespacesDomainmappingsListQueryParams struct {
...
type RunNamespacesDomainmappingsListSecurity struct {
    Oauth2 shared.SchemeOauth2 `security:"scheme,type=oauth2"`
    Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
    
}

type RunNamespacesDomainmappingsListRequest struct {
...
type RunNamespacesDomainmappingsListResponse struct {
    ContentType string 
