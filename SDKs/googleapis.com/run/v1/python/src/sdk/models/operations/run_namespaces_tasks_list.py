...
class RunNamespacesTasksListRequest:
    path_params: RunNamespacesTasksListPathParams = field(default=None)
    query_params: RunNamespacesTasksListQueryParams = field(default=None)
    security: RunNamespacesTasksListSecurity = field(default=None)
