...
class RunNamespacesServicesListRequest:
    path_params: RunNamespacesServicesListPathParams = field()
    query_params: RunNamespacesServicesListQueryParams = field()
    security: RunNamespacesServicesListSecurity = field()
