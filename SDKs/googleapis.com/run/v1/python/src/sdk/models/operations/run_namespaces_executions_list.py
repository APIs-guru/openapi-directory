...
class RunNamespacesExecutionsListRequest:
    path_params: RunNamespacesExecutionsListPathParams = field()
    query_params: RunNamespacesExecutionsListQueryParams = field()
    security: RunNamespacesExecutionsListSecurity = field()
