...
class RunProjectsLocationsServicesCreateRequest:
    path_params: RunProjectsLocationsServicesCreatePathParams = field(default=None)
    query_params: RunProjectsLocationsServicesCreateQueryParams = field(default=None)
    request: Optional[shared.Service] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: RunProjectsLocationsServicesCreateSecurity = field(default=None)
