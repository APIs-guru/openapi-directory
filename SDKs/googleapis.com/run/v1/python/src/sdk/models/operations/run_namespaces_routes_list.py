...
class RunNamespacesRoutesListRequest:
    path_params: RunNamespacesRoutesListPathParams = field()
    query_params: RunNamespacesRoutesListQueryParams = field()
    security: RunNamespacesRoutesListSecurity = field()
