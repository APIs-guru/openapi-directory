...
@dataclass
class RunNamespacesRoutesListPathParams:
    parent: str = field(default=None, metadata={'path_param': { 'field_name': 'parent', 'style': 'simple', 'explode': False }})
    

@dataclass
class RunNamespacesRoutesListQueryParams:
...
@dataclass
class RunNamespacesRoutesListRequest:
    path_params: RunNamespacesRoutesListPathParams = field(default=None)
    query_params: RunNamespacesRoutesListQueryParams = field(default=None)
    security: RunNamespacesRoutesListSecurity = field(default=None)
