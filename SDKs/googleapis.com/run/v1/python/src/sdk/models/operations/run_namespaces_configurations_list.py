...
class RunNamespacesConfigurationsListRequest:
    path_params: RunNamespacesConfigurationsListPathParams = field()
    query_params: RunNamespacesConfigurationsListQueryParams = field()
    security: RunNamespacesConfigurationsListSecurity = field()
