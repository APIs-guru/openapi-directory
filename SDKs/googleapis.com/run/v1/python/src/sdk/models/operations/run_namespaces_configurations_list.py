...
class RunNamespacesConfigurationsListRequest:
    path_params: RunNamespacesConfigurationsListPathParams = field(default=None)
    query_params: RunNamespacesConfigurationsListQueryParams = field(default=None)
    security: RunNamespacesConfigurationsListSecurity = field(default=None)
