...
export class RunProjectsLocationsRevisionsListPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=parent" })
  parent: string;
}


export class RunProjectsLocationsRevisionsListQueryParams extends SpeakeasyBase {
...
export class RunProjectsLocationsRevisionsListSecurity extends SpeakeasyBase {
...
export class RunProjectsLocationsRevisionsListRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class RunProjectsLocationsRevisionsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
