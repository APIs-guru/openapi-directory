...
export class RunNamespacesDomainmappingsListPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=parent" })
  parent: string;
}


export class RunNamespacesDomainmappingsListQueryParams extends SpeakeasyBase {
