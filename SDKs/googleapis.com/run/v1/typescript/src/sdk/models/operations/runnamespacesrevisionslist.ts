...
export class RunNamespacesRevisionsListPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=parent" })
  parent: string;
}


export class RunNamespacesRevisionsListQueryParams extends SpeakeasyBase {
...
export class RunNamespacesRevisionsListSecurity extends SpeakeasyBase {
...
export class RunNamespacesRevisionsListRequest extends SpeakeasyBase {
  @Metadata()
...
export class RunNamespacesRevisionsListResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
