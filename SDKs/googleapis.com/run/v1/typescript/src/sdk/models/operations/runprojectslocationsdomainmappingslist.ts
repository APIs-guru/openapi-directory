...
export class RunProjectsLocationsDomainmappingsListPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=parent" })
  parent: string;
}


export class RunProjectsLocationsDomainmappingsListQueryParams extends SpeakeasyBase {
