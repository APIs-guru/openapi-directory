...
export class RunProjectsLocationsConfigurationsListPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=parent" })
  parent: string;
}


export class RunProjectsLocationsConfigurationsListQueryParams extends SpeakeasyBase {
