...
var Projects = /** @class */ (function () {
    ...
    **/
    Projects.prototype.runProjectsLocationsAuthorizeddomainsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RunProjectsLocationsAuthorizeddomainsListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{parent}/authorizeddomains", req.pathParams);
    ...
    **/
    Projects.prototype.runProjectsLocationsConfigurationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Projects.prototype.runProjectsLocationsDomainmappingsCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RunProjectsLocationsDomainmappingsCreateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{parent}/domainmappings", req.pathParams);
    ...
    **/
    Projects.prototype.runProjectsLocationsDomainmappingsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Projects.prototype.runProjectsLocationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Projects.prototype.runProjectsLocationsRevisionsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RunProjectsLocationsRevisionsListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{parent}/revisions", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    Projects.prototype.runProjectsLocationsRoutesList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Projects.prototype.runProjectsLocationsServicesDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Projects.prototype.runProjectsLocationsServicesGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Projects.prototype.runProjectsLocationsServicesReplaceService = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
