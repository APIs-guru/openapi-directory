...
var TaskSpec = /** @class */ (function (_super) {
    ...
    ], TaskSpec.prototype, "containers", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=maxRetries" }),
        __metadata("design:type", Number)
    ], TaskSpec.prototype, "maxRetries", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=serviceAccountName" }),
        __metadata("design:type", String)
    ], TaskSpec.prototype, "serviceAccountName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=timeoutSeconds" }),
        __metadata("design:type", String)
    ], TaskSpec.prototype, "timeoutSeconds", void 0);
    __decorate([
