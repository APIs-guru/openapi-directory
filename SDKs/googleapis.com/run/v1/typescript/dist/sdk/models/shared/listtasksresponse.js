...
var ListTasksResponse = /** @class */ (function (_super) {
    ...
    ], ListTasksResponse.prototype, "apiVersion", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=items", elemType: Task }),
        __metadata("design:type", Array)
    ], ListTasksResponse.prototype, "items", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=kind" }),
        __metadata("design:type", String)
    ], ListTasksResponse.prototype, "kind", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=metadata" }),
        __metadata("design:type", ListMeta)
    ], ListTasksResponse.prototype, "metadata", void 0);
    __decorate([
