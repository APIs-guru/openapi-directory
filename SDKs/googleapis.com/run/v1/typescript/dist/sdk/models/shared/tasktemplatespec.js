...
**/
var TaskTemplateSpec = /** @class */ (function (_super) {
    __extends(TaskTemplateSpec, _super);
    function TaskTemplateSpec() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=spec" }),
        __metadata("design:type", TaskSpec)
    ], TaskTemplateSpec.prototype, "spec", void 0);
    return TaskTemplateSpec;
}(SpeakeasyBase));
export { TaskTemplateSpec };
