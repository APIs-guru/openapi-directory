...
@dataclass
class RunNamespacesJobsListPathParams:
    parent: str = field(default=None, metadata={'path_param': { 'field_name': 'parent', 'style': 'simple', 'explode': False }})
    

@dataclass
class RunNamespacesJobsListQueryParams:
...
class RunNamespacesJobsListRequest:
    path_params: RunNamespacesJobsListPathParams = field(default=None)
    query_params: RunNamespacesJobsListQueryParams = field(default=None)
    security: RunNamespacesJobsListSecurity = field(default=None)
