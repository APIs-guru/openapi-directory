...
var Namespaces = /** @class */ (function () {
    ...
    **/
    Namespaces.prototype.runNamespacesJobsCreate = function (req, config) {
        ...
        var url = utils.GenerateURL(baseURL, "/apis/run.googleapis.com/v1alpha1/{parent}/jobs", req.pathParams);
    ...
    **/
    Namespaces.prototype.runNamespacesJobsDelete = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/apis/run.googleapis.com/v1alpha1/{name}", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    Namespaces.prototype.runNamespacesJobsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
