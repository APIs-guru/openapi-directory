...
class RunProjectsLocationsServicesListRequest:
    path_params: RunProjectsLocationsServicesListPathParams = field(default=None)
    query_params: RunProjectsLocationsServicesListQueryParams = field(default=None)
    security: RunProjectsLocationsServicesListSecurity = field(default=None)
    

@dataclass
class RunProjectsLocationsServicesListResponse:
    content_type: str = field(default=None)
    google_cloud_run_v2_list_services_response: Optional[shared.GoogleCloudRunV2ListServicesResponse] = field(default=None)
