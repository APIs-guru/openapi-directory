...
class ChromepolicyCustomersPoliciesGroupsListGroupPriorityOrderingRequest:
    path_params: ChromepolicyCustomersPoliciesGroupsListGroupPriorityOrderingPathParams = field()
    query_params: ChromepolicyCustomersPoliciesGroupsListGroupPriorityOrderingQueryParams = field()
    security: ChromepolicyCustomersPoliciesGroupsListGroupPriorityOrderingSecurity = field()
