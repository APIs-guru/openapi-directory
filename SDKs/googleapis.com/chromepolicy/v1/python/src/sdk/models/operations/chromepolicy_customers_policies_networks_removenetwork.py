...
class ChromepolicyCustomersPoliciesNetworksRemoveNetworkRequest:
    path_params: ChromepolicyCustomersPoliciesNetworksRemoveNetworkPathParams = field()
    query_params: ChromepolicyCustomersPoliciesNetworksRemoveNetworkQueryParams = field()
    security: ChromepolicyCustomersPoliciesNetworksRemoveNetworkSecurity = field()
