...
**/
var GoogleChromePolicyVersionsV1InheritOrgUnitPolicyRequest = /** @class */ (function (_super) {
    __extends(GoogleChromePolicyVersionsV1InheritOrgUnitPolicyRequest, _super);
    function GoogleChromePolicyVersionsV1InheritOrgUnitPolicyRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=policySchema" }),
        __metadata("design:type", String)
    ], GoogleChromePolicyVersionsV1InheritOrgUnitPolicyRequest.prototype, "policySchema", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=policyTargetKey" }),
        __metadata("design:type", GoogleChromePolicyVersionsV1PolicyTargetKey)
    ], GoogleChromePolicyVersionsV1InheritOrgUnitPolicyRequest.prototype, "policyTargetKey", void 0);
    return GoogleChromePolicyVersionsV1InheritOrgUnitPolicyRequest;
}(SpeakeasyBase));
export { GoogleChromePolicyVersionsV1InheritOrgUnitPolicyRequest };
