...
**/
var GoogleChromePolicyVersionsV1ModifyOrgUnitPolicyRequest = /** @class */ (function (_super) {
    __extends(GoogleChromePolicyVersionsV1ModifyOrgUnitPolicyRequest, _super);
    function GoogleChromePolicyVersionsV1ModifyOrgUnitPolicyRequest() {
    ...
    ], GoogleChromePolicyVersionsV1ModifyOrgUnitPolicyRequest.prototype, "policyTargetKey", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=policyValue" }),
        __metadata("design:type", GoogleChromePolicyVersionsV1PolicyValue)
    ], GoogleChromePolicyVersionsV1ModifyOrgUnitPolicyRequest.prototype, "policyValue", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=updateMask" }),
        __metadata("design:type", String)
    ], GoogleChromePolicyVersionsV1ModifyOrgUnitPolicyRequest.prototype, "updateMask", void 0);
    return GoogleChromePolicyVersionsV1ModifyOrgUnitPolicyRequest;
}(SpeakeasyBase));
export { GoogleChromePolicyVersionsV1ModifyOrgUnitPolicyRequest };
