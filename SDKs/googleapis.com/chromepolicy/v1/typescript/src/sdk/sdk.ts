...
export class SDK {
  ...
  ChromepolicyCustomersPoliciesGroupsBatchDelete(
    ...
    const url: string = utils.GenerateURL(baseURL, "/v1/{customer}/policies/groups:batchDelete", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        let res: operations.ChromepolicyCustomersPoliciesGroupsBatchDeleteResponse = {statusCode: httpRes.status, contentType: contentType};
  ...
  ChromepolicyCustomersPoliciesGroupsBatchModify(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{customer}/policies/groups:batchModify", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ChromepolicyCustomersPoliciesGroupsBatchModifyResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleProtobufEmpty = httpRes?.data;
  ...
  ChromepolicyCustomersPoliciesGroupsListGroupPriorityOrdering(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{customer}/policies/groups:listGroupPriorityOrdering", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ChromepolicyCustomersPoliciesGroupsListGroupPriorityOrderingResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleChromePolicyVersionsV1ListGroupPriorityOrderingResponse = httpRes?.data;
            }
            break;
        }
  ...
  ChromepolicyCustomersPoliciesGroupsUpdateGroupPriorityOrdering(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{customer}/policies/groups:updateGroupPriorityOrdering", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ChromepolicyCustomersPoliciesGroupsUpdateGroupPriorityOrderingResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleProtobufEmpty = httpRes?.data;
  ...
  ChromepolicyCustomersPoliciesNetworksDefineCertificate(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{customer}/policies/networks:defineCertificate", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ChromepolicyCustomersPoliciesNetworksDefineCertificateResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleChromePolicyVersionsV1DefineCertificateResponse = httpRes?.data;
            }
            break;
        }
  ...
  ChromepolicyCustomersPoliciesNetworksDefineNetwork(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{customer}/policies/networks:defineNetwork", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ChromepolicyCustomersPoliciesNetworksDefineNetworkResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleChromePolicyVersionsV1DefineNetworkResponse = httpRes?.data;
            }
            break;
        }
  ...
  ChromepolicyCustomersPoliciesNetworksRemoveCertificate(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{customer}/policies/networks:removeCertificate", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ChromepolicyCustomersPoliciesNetworksRemoveCertificateResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleChromePolicyVersionsV1RemoveCertificateResponse = httpRes?.data;
            }
            break;
        }
  ...
  ChromepolicyCustomersPoliciesNetworksRemoveNetwork(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{customer}/policies/networks:removeNetwork", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ChromepolicyCustomersPoliciesNetworksRemoveNetworkResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleChromePolicyVersionsV1RemoveNetworkResponse = httpRes?.data;
            }
            break;
        }
  ...
  ChromepolicyCustomersPoliciesOrgunitsBatchInherit(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{customer}/policies/orgunits:batchInherit", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ChromepolicyCustomersPoliciesOrgunitsBatchInheritResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleProtobufEmpty = httpRes?.data;
  ...
  ChromepolicyCustomersPoliciesOrgunitsBatchModify(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{customer}/policies/orgunits:batchModify", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ChromepolicyCustomersPoliciesOrgunitsBatchModifyResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleProtobufEmpty = httpRes?.data;
  ...
  ChromepolicyCustomersPoliciesResolve(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{customer}/policies:resolve", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ChromepolicyCustomersPoliciesResolveResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleChromePolicyVersionsV1ResolveResponse = httpRes?.data;
            }
            break;
        }
  ...
  ChromepolicyCustomersPolicySchemasGet(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ChromepolicyCustomersPolicySchemasGetResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleChromePolicyVersionsV1PolicySchema = httpRes?.data;
            }
            break;
        }
  ...
  ChromepolicyCustomersPolicySchemasList(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{parent}/policySchemas", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ChromepolicyCustomersPolicySchemasListResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleChromePolicyVersionsV1ListPolicySchemasResponse = httpRes?.data;
            }
            break;
        }
  ...
  ChromepolicyMediaUpload(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ChromepolicyMediaUploadResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
