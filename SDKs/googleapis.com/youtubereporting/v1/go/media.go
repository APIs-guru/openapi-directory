...
func (s *Media) YoutubereportingMediaDownload(ctx context.Context, request operations.YoutubereportingMediaDownloadRequest) (*operations.YoutubereportingMediaDownloadResponse, error) {
