...
class YoutubereportingJobsGetSecurity:
    option1: Optional[YoutubereportingJobsGetSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[YoutubereportingJobsGetSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
