...
class YoutubereportingJobsReportsGetRequest:
    path_params: YoutubereportingJobsReportsGetPathParams = field()
    query_params: YoutubereportingJobsReportsGetQueryParams = field()
    security: YoutubereportingJobsReportsGetSecurity = field()
