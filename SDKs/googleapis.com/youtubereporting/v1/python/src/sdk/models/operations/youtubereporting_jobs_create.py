...
class YoutubereportingJobsCreateSecurity:
    option1: Optional[YoutubereportingJobsCreateSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[YoutubereportingJobsCreateSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
