...
@dataclass
class YoutubereportingMediaDownloadQueryParams:
...
@dataclass
class YoutubereportingMediaDownloadSecurity:
    option1: Optional[YoutubereportingMediaDownloadSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[YoutubereportingMediaDownloadSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
