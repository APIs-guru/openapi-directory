...
@dataclass
class DrivelabelsLabelsRevisionsUpdatePermissionsPathParams:
    parent: str = field(metadata={'path_param': { 'field_name': 'parent', 'style': 'simple', 'explode': False }})
    

@dataclass
class DrivelabelsLabelsRevisionsUpdatePermissionsQueryParams:
...
class DrivelabelsLabelsRevisionsUpdatePermissionsRequest:
    path_params: DrivelabelsLabelsRevisionsUpdatePermissionsPathParams = field()
    query_params: DrivelabelsLabelsRevisionsUpdatePermissionsQueryParams = field()
