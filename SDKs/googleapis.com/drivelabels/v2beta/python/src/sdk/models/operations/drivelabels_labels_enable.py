...
class DrivelabelsLabelsEnableRequest:
    path_params: DrivelabelsLabelsEnablePathParams = field()
    query_params: DrivelabelsLabelsEnableQueryParams = field()
    request: Optional[shared.GoogleAppsDriveLabelsV2betaEnableLabelRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
