...
export class DrivelabelsLabelsRevisionsPermissionsCreatePathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=parent" })
  parent: string;
}


export class DrivelabelsLabelsRevisionsPermissionsCreateQueryParams extends SpeakeasyBase {
