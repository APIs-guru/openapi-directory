...
export class DrivelabelsLabelsRevisionsPermissionsPatchPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=parent" })
  parent: string;
}


export class DrivelabelsLabelsRevisionsPermissionsPatchQueryParams extends SpeakeasyBase {
...
export class DrivelabelsLabelsRevisionsPermissionsPatchRequest extends SpeakeasyBase {
  @Metadata()
...
export class DrivelabelsLabelsRevisionsPermissionsPatchResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
