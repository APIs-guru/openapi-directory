...
export class DrivelabelsLabelsRevisionsUpdatePermissionsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=parent" })
  parent: string;
}


export class DrivelabelsLabelsRevisionsUpdatePermissionsQueryParams extends SpeakeasyBase {
