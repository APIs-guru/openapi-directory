...
@dataclass
class DrivelabelsLabelsGetQueryParams:
    ...
    view: Optional[DrivelabelsLabelsGetViewEnum] = field(default=None, metadata={'query_param': { 'field_name': 'view', 'style': 'form', 'explode': True }})
