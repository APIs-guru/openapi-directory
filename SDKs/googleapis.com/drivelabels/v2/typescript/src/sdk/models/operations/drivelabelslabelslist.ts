...
export class DrivelabelsLabelsListQueryParams extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=minimumRole" })
  ...
  @SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=publishedOnly" })
