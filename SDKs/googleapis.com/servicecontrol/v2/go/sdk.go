...
func (s *SDK) ServicecontrolServicesCheck(ctx context.Context, request operations.ServicecontrolServicesCheckRequest) (*operations.ServicecontrolServicesCheckResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) ServicecontrolServicesReport(ctx context.Context, request operations.ServicecontrolServicesReportRequest) (*operations.ServicecontrolServicesReportResponse, error) {
	baseURL := s.serverURL
