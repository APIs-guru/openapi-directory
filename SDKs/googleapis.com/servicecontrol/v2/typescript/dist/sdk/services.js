...
var Services = /** @class */ (function () {
    ...
    **/
    Services.prototype.servicecontrolServicesCheck = function (req, config) {
        ...
        var url = utils.GenerateURL(baseURL, "/v2/services/{serviceName}:check", req.pathParams);
    ...
    **/
    Services.prototype.servicecontrolServicesReport = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v2/services/{serviceName}:report", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
