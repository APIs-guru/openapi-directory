...
func (s *SDK) VerifiedaccessChallengeGenerate(ctx context.Context, request operations.VerifiedaccessChallengeGenerateRequest) (*operations.VerifiedaccessChallengeGenerateResponse, error) {
	baseURL := s.serverURL
