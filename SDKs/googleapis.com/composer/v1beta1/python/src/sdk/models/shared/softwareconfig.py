...
class SoftwareConfig:
    ...
    cloud_data_lineage_integration: Optional[CloudDataLineageIntegration] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('cloudDataLineageIntegration') }})
