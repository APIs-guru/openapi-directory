...
export class Projects {
  ...
  **/
  composerProjectsLocationsEnvironmentsCheckUpgrade(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ComposerProjectsLocationsEnvironmentsCheckUpgradeRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{environment}:checkUpgrade", req.pathParams);
    ...
    return client
      .request({
        ...
        const res: operations.ComposerProjectsLocationsEnvironmentsCheckUpgradeResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  composerProjectsLocationsEnvironmentsCreate(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{parent}/environments", req.pathParams);
  ...
  **/
  composerProjectsLocationsEnvironmentsLoadSnapshot(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{environment}:loadSnapshot", req.pathParams);
  ...
  **/
  composerProjectsLocationsEnvironmentsRestartWebServer(
    req: operations.ComposerProjectsLocationsEnvironmentsRestartWebServerRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.ComposerProjectsLocationsEnvironmentsRestartWebServerResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ComposerProjectsLocationsEnvironmentsRestartWebServerRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{name}:restartWebServer", req.pathParams);
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.ComposerProjectsLocationsEnvironmentsRestartWebServerResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.operation = httpRes?.data;
  ...
  **/
  composerProjectsLocationsEnvironmentsSaveSnapshot(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{environment}:saveSnapshot", req.pathParams);
  ...
  **/
  composerProjectsLocationsImageVersionsList(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{parent}/imageVersions", req.pathParams);
