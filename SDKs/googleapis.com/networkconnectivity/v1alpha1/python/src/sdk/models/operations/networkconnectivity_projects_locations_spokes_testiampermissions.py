...
class NetworkconnectivityProjectsLocationsSpokesTestIamPermissionsRequest:
    path_params: NetworkconnectivityProjectsLocationsSpokesTestIamPermissionsPathParams = field()
    query_params: NetworkconnectivityProjectsLocationsSpokesTestIamPermissionsQueryParams = field()
    security: NetworkconnectivityProjectsLocationsSpokesTestIamPermissionsSecurity = field()
