...
class NetworkconnectivityProjectsLocationsSpokesTestIamPermissionsRequest:
    path_params: NetworkconnectivityProjectsLocationsSpokesTestIamPermissionsPathParams = field(default=None)
    query_params: NetworkconnectivityProjectsLocationsSpokesTestIamPermissionsQueryParams = field(default=None)
    request: Optional[shared.TestIamPermissionsRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: NetworkconnectivityProjectsLocationsSpokesTestIamPermissionsSecurity = field(default=None)
