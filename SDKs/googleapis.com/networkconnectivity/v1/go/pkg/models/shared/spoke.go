...
type Spoke struct {
	...
	LinkedInterconnectAttachments  *LinkedInterconnectAttachments  `json:"linkedInterconnectAttachments"`
	LinkedRouterApplianceInstances *LinkedRouterApplianceInstances `json:"linkedRouterApplianceInstances"`
	LinkedVpnTunnels               *LinkedVpnTunnels               `json:"linkedVpnTunnels"`
