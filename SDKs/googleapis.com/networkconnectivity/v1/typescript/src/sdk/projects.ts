...
export class Projects {
  ...
  **/
  networkconnectivityProjectsLocationsGlobalHubsCreate(
    ...
    const url: string = utils.GenerateURL(baseURL, "/v1/{parent}/hubs", req.pathParams);
  ...
  **/
  networkconnectivityProjectsLocationsInternalRangesCreate(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{parent}/internalRanges", req.pathParams);
  ...
  **/
  networkconnectivityProjectsLocationsSpokesCreate(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{parent}/spokes", req.pathParams);
