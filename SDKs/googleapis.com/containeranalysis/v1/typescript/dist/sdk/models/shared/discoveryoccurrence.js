 ...
 * Provides information about the analysis status of a discovered resource.
**/
var DiscoveryOccurrenceInput = /** @class */ (function (_super) {
    __extends(DiscoveryOccurrenceInput, _super);
    function DiscoveryOccurrenceInput() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=analysisCompleted" }),
        __metadata("design:type", AnalysisCompleted)
    ], DiscoveryOccurrenceInput.prototype, "analysisCompleted", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=analysisError", elemType: Status }),
        __metadata("design:type", Array)
    ], DiscoveryOccurrenceInput.prototype, "analysisError", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=analysisStatus" }),
        __metadata("design:type", String)
    ], DiscoveryOccurrenceInput.prototype, "analysisStatus", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=analysisStatusError" }),
        __metadata("design:type", Status)
    ], DiscoveryOccurrenceInput.prototype, "analysisStatusError", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=continuousAnalysis" }),
        __metadata("design:type", String)
    ], DiscoveryOccurrenceInput.prototype, "continuousAnalysis", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=cpe" }),
        __metadata("design:type", String)
    ], DiscoveryOccurrenceInput.prototype, "cpe", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=lastScanTime" }),
        __metadata("design:type", String)
    ], DiscoveryOccurrenceInput.prototype, "lastScanTime", void 0);
    return DiscoveryOccurrenceInput;
}(SpeakeasyBase));
export { DiscoveryOccurrenceInput };
