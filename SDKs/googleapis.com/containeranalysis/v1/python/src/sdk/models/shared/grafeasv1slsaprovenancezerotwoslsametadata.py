...
class GrafeasV1SlsaProvenanceZeroTwoSlsaMetadata:
    ...
    completeness: Optional[GrafeasV1SlsaProvenanceZeroTwoSlsaCompleteness] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('completeness') }})
