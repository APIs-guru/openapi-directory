...
func (s *SDK) ContaineranalysisProjectsScanConfigsGet(ctx context.Context, request operations.ContaineranalysisProjectsScanConfigsGetRequest) (*operations.ContaineranalysisProjectsScanConfigsGetResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1beta1/{name}", request.PathParams)
	...
	res := &operations.ContaineranalysisProjectsScanConfigsGetResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *SDK) ContaineranalysisProjectsScanConfigsList(ctx context.Context, request operations.ContaineranalysisProjectsScanConfigsListRequest) (*operations.ContaineranalysisProjectsScanConfigsListResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1beta1/{parent}/scanConfigs", request.PathParams)
...
func (s *SDK) ContaineranalysisProjectsScanConfigsUpdate(ctx context.Context, request operations.ContaineranalysisProjectsScanConfigsUpdateRequest) (*operations.ContaineranalysisProjectsScanConfigsUpdateResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1beta1/{name}", request.PathParams)
	...
	res := &operations.ContaineranalysisProjectsScanConfigsUpdateResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
