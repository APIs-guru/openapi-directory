...
**/
var GrafeasV1beta1IntotoDetails = /** @class */ (function (_super) {
    __extends(GrafeasV1beta1IntotoDetails, _super);
    function GrafeasV1beta1IntotoDetails() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=signatures", elemType: GrafeasV1beta1IntotoSignature }),
        __metadata("design:type", Array)
    ], GrafeasV1beta1IntotoDetails.prototype, "signatures", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=signed" }),
        __metadata("design:type", Link)
    ], GrafeasV1beta1IntotoDetails.prototype, "signed", void 0);
    return GrafeasV1beta1IntotoDetails;
}(SpeakeasyBase));
export { GrafeasV1beta1IntotoDetails };
