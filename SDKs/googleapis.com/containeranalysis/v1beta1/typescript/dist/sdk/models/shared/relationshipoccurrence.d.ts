...
export declare enum RelationshipOccurrenceTypeEnum {
...
**/
export declare class RelationshipOccurrenceInput extends SpeakeasyBase {
    comment?: string;
    source?: string;
    target?: string;
}
 ...
 * RelationshipOccurrence represents an SPDX Relationship section: https://spdx.github.io/spdx-spec/7-relationships-between-SPDX-elements/
**/
export declare class RelationshipOccurrence extends SpeakeasyBase {
    comment?: string;
    source?: string;
    target?: string;
