...
var Attestation = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", GenericSignedAttestation)
    ], Attestation.prototype, "genericSignedAttestation", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=pgpSignedAttestation" }),
        __metadata("design:type", PgpSignedAttestation)
    ], Attestation.prototype, "pgpSignedAttestation", void 0);
    return Attestation;
}(SpeakeasyBase));
export { Attestation };
