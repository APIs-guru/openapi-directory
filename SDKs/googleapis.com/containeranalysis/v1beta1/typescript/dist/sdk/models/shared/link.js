...
var Link = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", ByProducts)
    ], Link.prototype, "byproducts", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=command" }),
        __metadata("design:type", Array)
    ], Link.prototype, "command", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=environment" }),
        __metadata("design:type", Environment)
    ], Link.prototype, "environment", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=materials", elemType: GrafeasV1beta1IntotoArtifact }),
        __metadata("design:type", Array)
    ], Link.prototype, "materials", void 0);
    __decorate([
