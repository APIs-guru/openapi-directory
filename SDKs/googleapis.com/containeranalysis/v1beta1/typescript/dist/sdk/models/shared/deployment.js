...
export var DeploymentPlatformEnum;
(function (DeploymentPlatformEnum) {
...
})(DeploymentPlatformEnum || (DeploymentPlatformEnum = {}));
// Deployment
/**
...
var Deployment = /** @class */ (function (_super) {
    ...
    ], Deployment.prototype, "address", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=config" }),
        __metadata("design:type", String)
    ], Deployment.prototype, "config", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=deployTime" }),
        __metadata("design:type", String)
    ], Deployment.prototype, "deployTime", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=platform" }),
        __metadata("design:type", String)
    ], Deployment.prototype, "platform", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=resourceUri" }),
        __metadata("design:type", Array)
    ], Deployment.prototype, "resourceUri", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=undeployTime" }),
        __metadata("design:type", String)
    ], Deployment.prototype, "undeployTime", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=userEmail" }),
        __metadata("design:type", String)
    ], Deployment.prototype, "userEmail", void 0);
    return Deployment;
}(SpeakeasyBase));
export { Deployment };
