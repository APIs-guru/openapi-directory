...
export class SDK {
  ...
  // ContaineranalysisProjectsScanConfigsGet - Gets the specified scan configuration.
  ContaineranalysisProjectsScanConfigsGet(
    req: operations.ContaineranalysisProjectsScanConfigsGetRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.ContaineranalysisProjectsScanConfigsGetResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ContaineranalysisProjectsScanConfigsGetRequest(req);
    }
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ContaineranalysisProjectsScanConfigsGetResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  // ContaineranalysisProjectsScanConfigsList - Lists scan configurations for the specified project.
  ContaineranalysisProjectsScanConfigsList(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{parent}/scanConfigs", req.pathParams);
  ...
  // ContaineranalysisProjectsScanConfigsUpdate - Updates the specified scan configuration.
  ContaineranalysisProjectsScanConfigsUpdate(
    req: operations.ContaineranalysisProjectsScanConfigsUpdateRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.ContaineranalysisProjectsScanConfigsUpdateResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ContaineranalysisProjectsScanConfigsUpdateRequest(req);
    }
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ContaineranalysisProjectsScanConfigsUpdateResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.scanConfig = httpRes?.data;
