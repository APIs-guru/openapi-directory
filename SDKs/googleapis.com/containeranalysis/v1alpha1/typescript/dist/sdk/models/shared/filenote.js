...
export var FileNoteFileTypeEnum;
(function (FileNoteFileTypeEnum) {
...
})(FileNoteFileTypeEnum || (FileNoteFileTypeEnum = {}));
// FileNote
/**
 * FileNote represents an SPDX File Information section: https://spdx.github.io/spdx-spec/4-file-information/
**/
var FileNote = /** @class */ (function (_super) {
    __extends(FileNote, _super);
    function FileNote() {
    ...
    ], FileNote.prototype, "checksum", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=fileType" }),
        __metadata("design:type", String)
    ], FileNote.prototype, "fileType", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=title" }),
        __metadata("design:type", String)
    ], FileNote.prototype, "title", void 0);
    return FileNote;
}(SpeakeasyBase));
export { FileNote };
