...
**/
var UpgradeNote = /** @class */ (function (_super) {
    __extends(UpgradeNote, _super);
    ...
    ], UpgradeNote.prototype, "distributions", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=package" }),
        __metadata("design:type", String)
    ], UpgradeNote.prototype, "package", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=version" }),
        __metadata("design:type", Version)
    ], UpgradeNote.prototype, "version", void 0);
    return UpgradeNote;
}(SpeakeasyBase));
export { UpgradeNote };
