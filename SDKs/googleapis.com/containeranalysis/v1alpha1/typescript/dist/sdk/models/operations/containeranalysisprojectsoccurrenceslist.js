...
export var ContaineranalysisProjectsOccurrencesListKindEnum;
(function (ContaineranalysisProjectsOccurrencesListKindEnum) {
    ContaineranalysisProjectsOccurrencesListKindEnum["KindUnspecified"] = "KIND_UNSPECIFIED";
    ContaineranalysisProjectsOccurrencesListKindEnum["PackageVulnerability"] = "PACKAGE_VULNERABILITY";
    ContaineranalysisProjectsOccurrencesListKindEnum["BuildDetails"] = "BUILD_DETAILS";
    ContaineranalysisProjectsOccurrencesListKindEnum["ImageBasis"] = "IMAGE_BASIS";
    ContaineranalysisProjectsOccurrencesListKindEnum["PackageManager"] = "PACKAGE_MANAGER";
    ContaineranalysisProjectsOccurrencesListKindEnum["Deployable"] = "DEPLOYABLE";
    ContaineranalysisProjectsOccurrencesListKindEnum["Discovery"] = "DISCOVERY";
    ContaineranalysisProjectsOccurrencesListKindEnum["AttestationAuthority"] = "ATTESTATION_AUTHORITY";
    ContaineranalysisProjectsOccurrencesListKindEnum["Upgrade"] = "UPGRADE";
    ContaineranalysisProjectsOccurrencesListKindEnum["Compliance"] = "COMPLIANCE";
    ContaineranalysisProjectsOccurrencesListKindEnum["Sbom"] = "SBOM";
    ContaineranalysisProjectsOccurrencesListKindEnum["SpdxPackage"] = "SPDX_PACKAGE";
    ContaineranalysisProjectsOccurrencesListKindEnum["SpdxFile"] = "SPDX_FILE";
    ContaineranalysisProjectsOccurrencesListKindEnum["SpdxRelationship"] = "SPDX_RELATIONSHIP";
    ContaineranalysisProjectsOccurrencesListKindEnum["DsseAttestation"] = "DSSE_ATTESTATION";
})(ContaineranalysisProjectsOccurrencesListKindEnum || (ContaineranalysisProjectsOccurrencesListKindEnum = {}));
var ContaineranalysisProjectsOccurrencesListQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ContaineranalysisProjectsOccurrencesListQueryParams.prototype, "kind", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=name" }),
        __metadata("design:type", String)
    ], ContaineranalysisProjectsOccurrencesListQueryParams.prototype, "name", void 0);
    __decorate([
