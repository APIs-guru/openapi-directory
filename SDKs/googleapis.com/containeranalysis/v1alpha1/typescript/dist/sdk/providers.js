...
var Providers = /** @class */ (function () {
    ...
    **/
    Providers.prototype.containeranalysisProvidersNotesCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ContaineranalysisProvidersNotesCreateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1alpha1/{name}/notes", req.pathParams);
    ...
    **/
    Providers.prototype.containeranalysisProvidersNotesDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Providers.prototype.containeranalysisProvidersNotesGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Providers.prototype.containeranalysisProvidersNotesGetIamPolicy = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Providers.prototype.containeranalysisProvidersNotesList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Providers.prototype.containeranalysisProvidersNotesOccurrencesList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ContaineranalysisProvidersNotesOccurrencesListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1alpha1/{name}/occurrences", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    Providers.prototype.containeranalysisProvidersNotesPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Providers.prototype.containeranalysisProvidersNotesSetIamPolicy = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Providers.prototype.containeranalysisProvidersNotesTestIamPermissions = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
