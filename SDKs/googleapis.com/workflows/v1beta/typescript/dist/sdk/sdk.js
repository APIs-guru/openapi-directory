...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.WorkflowsProjectsLocationsList = function (req, config) {
    ...
    SDK.prototype.WorkflowsProjectsLocationsOperationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.WorkflowsProjectsLocationsWorkflowsCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.WorkflowsProjectsLocationsWorkflowsCreateRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta/{parent}/workflows", req.pathParams);
    ...
    SDK.prototype.WorkflowsProjectsLocationsWorkflowsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.WorkflowsProjectsLocationsWorkflowsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.WorkflowsProjectsLocationsWorkflowsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.WorkflowsProjectsLocationsWorkflowsPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
