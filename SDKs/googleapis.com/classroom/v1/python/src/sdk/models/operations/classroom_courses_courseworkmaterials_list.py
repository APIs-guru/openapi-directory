...
class ClassroomCoursesCourseWorkMaterialsListRequest:
    path_params: ClassroomCoursesCourseWorkMaterialsListPathParams = field()
    query_params: ClassroomCoursesCourseWorkMaterialsListQueryParams = field()
    security: ClassroomCoursesCourseWorkMaterialsListSecurity = field()
