...
class ClassroomCoursesCourseWorkMaterialsPatchRequest:
    path_params: ClassroomCoursesCourseWorkMaterialsPatchPathParams = field()
    query_params: ClassroomCoursesCourseWorkMaterialsPatchQueryParams = field()
    security: ClassroomCoursesCourseWorkMaterialsPatchSecurity = field()
