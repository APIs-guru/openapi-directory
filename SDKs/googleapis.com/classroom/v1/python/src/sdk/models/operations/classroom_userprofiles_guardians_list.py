...
class ClassroomUserProfilesGuardiansListSecurity:
    option1: Optional[ClassroomUserProfilesGuardiansListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[ClassroomUserProfilesGuardiansListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[ClassroomUserProfilesGuardiansListSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
