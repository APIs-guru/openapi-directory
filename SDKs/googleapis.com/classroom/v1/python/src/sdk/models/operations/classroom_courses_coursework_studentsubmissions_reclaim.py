...
class ClassroomCoursesCourseWorkStudentSubmissionsReclaimRequest:
    path_params: ClassroomCoursesCourseWorkStudentSubmissionsReclaimPathParams = field(default=None)
    query_params: ClassroomCoursesCourseWorkStudentSubmissionsReclaimQueryParams = field(default=None)
    request: Optional[dict[str, Any]] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: ClassroomCoursesCourseWorkStudentSubmissionsReclaimSecurity = field(default=None)
