...
class ClassroomCoursesCourseWorkModifyAssigneesRequest:
    path_params: ClassroomCoursesCourseWorkModifyAssigneesPathParams = field()
    query_params: ClassroomCoursesCourseWorkModifyAssigneesQueryParams = field()
    security: ClassroomCoursesCourseWorkModifyAssigneesSecurity = field()
