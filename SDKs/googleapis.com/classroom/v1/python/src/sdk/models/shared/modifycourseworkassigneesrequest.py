...
class ModifyCourseWorkAssigneesRequest:
    ...
    assignee_mode: Optional[ModifyCourseWorkAssigneesRequestAssigneeModeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('assigneeMode') }})
