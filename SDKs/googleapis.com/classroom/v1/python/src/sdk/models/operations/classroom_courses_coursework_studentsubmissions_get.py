...
class ClassroomCoursesCourseWorkStudentSubmissionsGetRequest:
    path_params: ClassroomCoursesCourseWorkStudentSubmissionsGetPathParams = field(default=None)
    query_params: ClassroomCoursesCourseWorkStudentSubmissionsGetQueryParams = field(default=None)
    security: ClassroomCoursesCourseWorkStudentSubmissionsGetSecurity = field(default=None)
