...
class ClassroomCoursesCourseWorkStudentSubmissionsModifyAttachmentsSecurity:
    option1: Optional[ClassroomCoursesCourseWorkStudentSubmissionsModifyAttachmentsSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[ClassroomCoursesCourseWorkStudentSubmissionsModifyAttachmentsSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
