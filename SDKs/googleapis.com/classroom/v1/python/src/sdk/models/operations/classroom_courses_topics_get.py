...
class ClassroomCoursesTopicsGetRequest:
    path_params: ClassroomCoursesTopicsGetPathParams = field()
    query_params: ClassroomCoursesTopicsGetQueryParams = field()
    security: ClassroomCoursesTopicsGetSecurity = field()
