...
class ClassroomCoursesAliasesListRequest:
    path_params: ClassroomCoursesAliasesListPathParams = field(default=None)
    query_params: ClassroomCoursesAliasesListQueryParams = field(default=None)
    security: ClassroomCoursesAliasesListSecurity = field(default=None)
