...
type ScriptProjectsDeploymentsDeletePathParams struct {
...
type ScriptProjectsDeploymentsDeleteQueryParams struct {
...
type ScriptProjectsDeploymentsDeleteSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ScriptProjectsDeploymentsDeleteRequest struct {
...
type ScriptProjectsDeploymentsDeleteResponse struct {
	ContentType string
