...
**/
var ExecutionRequest = /** @class */ (function (_super) {
    __extends(ExecutionRequest, _super);
    ...
    ], ExecutionRequest.prototype, "devMode", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=function" }),
        __metadata("design:type", String)
    ], ExecutionRequest.prototype, "function", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=parameters" }),
        __metadata("design:type", Array)
    ], ExecutionRequest.prototype, "parameters", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=sessionState" }),
        __metadata("design:type", String)
    ], ExecutionRequest.prototype, "sessionState", void 0);
    return ExecutionRequest;
}(SpeakeasyBase));
export { ExecutionRequest };
