...
@dataclass
class ScriptProjectsDeploymentsListQueryParams:
...
class ScriptProjectsDeploymentsListSecurity:
    option1: Optional[ScriptProjectsDeploymentsListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[ScriptProjectsDeploymentsListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
