...
class Projects:
    ...
    def gkehub_projects_locations_global_memberships_initialize_hub(self, request: operations.GkehubProjectsLocationsGlobalMembershipsInitializeHubRequest) -> operations.GkehubProjectsLocationsGlobalMembershipsInitializeHubResponse:
        ...
        url = utils.generate_url(base_url, "/v1alpha2/{project}:initializeHub", request.path_params)
        ...
        res = operations.GkehubProjectsLocationsGlobalMembershipsInitializeHubResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.InitializeHubResponse])
    ...
    def gkehub_projects_locations_memberships_create(self, request: operations.GkehubProjectsLocationsMembershipsCreateRequest) -> operations.GkehubProjectsLocationsMembershipsCreateResponse:
        ...
        url = utils.generate_url(base_url, "/v1alpha2/{parent}/memberships", request.path_params)
    ...
    def gkehub_projects_locations_memberships_generate_connect_manifest(self, request: operations.GkehubProjectsLocationsMembershipsGenerateConnectManifestRequest) -> operations.GkehubProjectsLocationsMembershipsGenerateConnectManifestResponse:
        ...
        url = utils.generate_url(base_url, "/v1alpha2/{name}:generateConnectManifest", request.path_params)
