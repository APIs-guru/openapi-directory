...
**/
var AnthosVmMembershipState = /** @class */ (function (_super) {
    __extends(AnthosVmMembershipState, _super);
    function AnthosVmMembershipState() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "json, name=localControllerState" }),
        __metadata("design:type", LocalControllerState)
    ], AnthosVmMembershipState.prototype, "localControllerState", void 0);
    __decorate([
        Metadata({ data: "json, name=subfeatureState", elemType: shared.AnthosVmSubFeatureState }),
        __metadata("design:type", Array)
    ], AnthosVmMembershipState.prototype, "subfeatureState", void 0);
    return AnthosVmMembershipState;
}(SpeakeasyBase));
export { AnthosVmMembershipState };
