...
**/
var AnthosVmMembershipSpec = /** @class */ (function (_super) {
    __extends(AnthosVmMembershipSpec, _super);
    function AnthosVmMembershipSpec() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "json, name=subfeaturesSpec", elemType: shared.AnthosVmSubFeatureSpec }),
        __metadata("design:type", Array)
    ], AnthosVmMembershipSpec.prototype, "subfeaturesSpec", void 0);
    return AnthosVmMembershipSpec;
}(SpeakeasyBase));
export { AnthosVmMembershipSpec };
