...
type GkehubProjectsLocationsFeaturesPatchPathParams struct {
	Name string `pathParam:"style=simple,explode=false,name=name"`
}

type GkehubProjectsLocationsFeaturesPatchQueryParams struct {
...
type GkehubProjectsLocationsFeaturesPatchSecurity struct {
...
type GkehubProjectsLocationsFeaturesPatchResponse struct {
	ContentType string
