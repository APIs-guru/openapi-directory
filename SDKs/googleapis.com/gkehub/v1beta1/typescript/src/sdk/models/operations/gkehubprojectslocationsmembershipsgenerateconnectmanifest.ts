...
export class GkehubProjectsLocationsMembershipsGenerateConnectManifestQueryParams extends SpeakeasyBase {
  ...
  @Metadata({ data: "queryParam, style=form;explode=true;name=connectAgent.name" })
  connectAgentName?: string;

  @Metadata({ data: "queryParam, style=form;explode=true;name=connectAgent.namespace" })
  connectAgentNamespace?: string;

  @Metadata({ data: "queryParam, style=form;explode=true;name=connectAgent.proxy" })
