...
export declare class Projects {
    ...
    **/
    gkehubProjectsLocationsFleetsCreate(req: operations.GkehubProjectsLocationsFleetsCreateRequest, config?: AxiosRequestConfig): Promise<operations.GkehubProjectsLocationsFleetsCreateResponse>;
    /**
     * gkehubProjectsLocationsFleetsList - Returns all fleets within an organization or a project that the caller has access to.
    **/
    gkehubProjectsLocationsFleetsList(req: operations.GkehubProjectsLocationsFleetsListRequest, config?: AxiosRequestConfig): Promise<operations.GkehubProjectsLocationsFleetsListResponse>;
    /**
    ...
    **/
    gkehubProjectsLocationsMembershipsListAdmin(req: operations.GkehubProjectsLocationsMembershipsListAdminRequest, config?: AxiosRequestConfig): Promise<operations.GkehubProjectsLocationsMembershipsListAdminResponse>;
    /**
    ...
    **/
    gkehubProjectsLocationsMembershipsValidateCreate(req: operations.GkehubProjectsLocationsMembershipsValidateCreateRequest, config?: AxiosRequestConfig): Promise<operations.GkehubProjectsLocationsMembershipsValidateCreateResponse>;
    /**
