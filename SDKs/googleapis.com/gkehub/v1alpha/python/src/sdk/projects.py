...
class Projects:
    ...
    def gkehub_projects_locations_features_create(self, request: operations.GkehubProjectsLocationsFeaturesCreateRequest) -> operations.GkehubProjectsLocationsFeaturesCreateResponse:
        ...
        url = utils.generate_url(base_url, "/v1alpha/{parent}/features", request.path_params)
    ...
    def gkehub_projects_locations_fleets_create(self, request: operations.GkehubProjectsLocationsFleetsCreateRequest) -> operations.GkehubProjectsLocationsFleetsCreateResponse:
        r"""Creates a fleet.
        """
        
        base_url = self._server_url
        
        url = utils.generate_url(base_url, "/v1alpha/{parent}/fleets", request.path_params)
        ...
        res = operations.GkehubProjectsLocationsFleetsCreateResponse(status_code=r.status_code, content_type=content_type)
    ...
    def gkehub_projects_locations_fleets_list(self, request: operations.GkehubProjectsLocationsFleetsListRequest) -> operations.GkehubProjectsLocationsFleetsListResponse:
        ...
        res = operations.GkehubProjectsLocationsFleetsListResponse(status_code=r.status_code, content_type=content_type)
    ...
    def gkehub_projects_locations_memberships_create(self, request: operations.GkehubProjectsLocationsMembershipsCreateRequest) -> operations.GkehubProjectsLocationsMembershipsCreateResponse:
        ...
        url = utils.generate_url(base_url, "/v1alpha/{parent}/memberships", request.path_params)
    ...
    def gkehub_projects_locations_memberships_generate_connect_manifest(self, request: operations.GkehubProjectsLocationsMembershipsGenerateConnectManifestRequest) -> operations.GkehubProjectsLocationsMembershipsGenerateConnectManifestResponse:
        ...
        url = utils.generate_url(base_url, "/v1alpha/{name}:generateConnectManifest", request.path_params)
    ...
    def gkehub_projects_locations_memberships_list_admin(self, request: operations.GkehubProjectsLocationsMembershipsListAdminRequest) -> operations.GkehubProjectsLocationsMembershipsListAdminResponse:
        r"""Lists Memberships of admin clusters in a given project and location. **This method is only used internally**.
        """
        
        base_url = self._server_url
        
        url = utils.generate_url(base_url, "/v1alpha/{parent}/memberships:listAdmin", request.path_params)
        ...
        res = operations.GkehubProjectsLocationsMembershipsListAdminResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListAdminClusterMembershipsResponse])
    ...
    def gkehub_projects_locations_memberships_validate_create(self, request: operations.GkehubProjectsLocationsMembershipsValidateCreateRequest) -> operations.GkehubProjectsLocationsMembershipsValidateCreateResponse:
        ...
        url = utils.generate_url(base_url, "/v1alpha/{parent}/memberships:validateCreate", request.path_params)
        ...
        res = operations.GkehubProjectsLocationsMembershipsValidateCreateResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ValidateCreateMembershipResponse])
