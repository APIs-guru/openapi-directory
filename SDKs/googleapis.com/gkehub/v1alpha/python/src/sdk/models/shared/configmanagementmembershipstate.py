...
from . import configmanagementbinauthzstate
...
class ConfigManagementMembershipState:
    binauthz_state: Optional[configmanagementbinauthzstate.ConfigManagementBinauthzState] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'binauthzState' }})
