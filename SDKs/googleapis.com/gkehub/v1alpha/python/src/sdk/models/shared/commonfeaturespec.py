...
class CommonFeatureSpec:
    ...
    cloudauditlogging: Optional[CloudAuditLoggingFeatureSpec] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('cloudauditlogging') }})
    ...
    workloadcertificate: Optional[FeatureSpec] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('workloadcertificate') }})
