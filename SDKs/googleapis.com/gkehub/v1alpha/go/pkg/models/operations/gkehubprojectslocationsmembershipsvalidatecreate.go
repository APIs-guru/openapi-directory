...
type GkehubProjectsLocationsMembershipsValidateCreatePathParams struct {
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type GkehubProjectsLocationsMembershipsValidateCreateQueryParams struct {
...
type GkehubProjectsLocationsMembershipsValidateCreateSecurity struct {
...
type GkehubProjectsLocationsMembershipsValidateCreateResponse struct {
	ContentType                      string
	StatusCode                       int64
