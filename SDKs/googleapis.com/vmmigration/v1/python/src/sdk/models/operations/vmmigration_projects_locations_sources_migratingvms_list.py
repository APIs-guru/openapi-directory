...
class VmmigrationProjectsLocationsSourcesMigratingVmsListRequest:
    path_params: VmmigrationProjectsLocationsSourcesMigratingVmsListPathParams = field()
    query_params: VmmigrationProjectsLocationsSourcesMigratingVmsListQueryParams = field()
    security: VmmigrationProjectsLocationsSourcesMigratingVmsListSecurity = field()
