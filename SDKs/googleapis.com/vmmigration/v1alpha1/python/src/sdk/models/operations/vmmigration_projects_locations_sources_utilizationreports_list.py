...
@dataclass
class VmmigrationProjectsLocationsSourcesUtilizationReportsListQueryParams:
    ...
    view: Optional[VmmigrationProjectsLocationsSourcesUtilizationReportsListViewEnum] = field(default=None, metadata={'query_param': { 'field_name': 'view', 'style': 'form', 'explode': True }})
