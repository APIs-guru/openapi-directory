...
class MigratingVM:
    ...
    aws_source_vm_details: Optional[AwsSourceVMDetails] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('awsSourceVmDetails') }})
    ...
    compute_engine_vm_defaults: Optional[TargetVMDetails] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('computeEngineVmDefaults') }})
    ...
    target_defaults: Optional[TargetVMDetails] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('targetDefaults') }})
...
class MigratingVMInput:
    ...
    compute_engine_vm_defaults: Optional[TargetVMDetailsInput] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('computeEngineVmDefaults') }})
    current_sync_info: Optional[ReplicationCycle] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('currentSyncInfo') }})
    description: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('description') }})
    display_name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('displayName') }})
    error: Optional[Status] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('error') }})
    ...
    policy: Optional[SchedulePolicy] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('policy') }})
    source_vm_id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sourceVmId') }})
    target_defaults: Optional[TargetVMDetailsInput] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('targetDefaults') }})
