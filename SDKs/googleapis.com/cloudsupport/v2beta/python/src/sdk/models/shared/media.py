...
from . import contenttypeinfo
from . import diffchecksumsresponse
from . import diffdownloadresponse
from . import diffuploadrequest
from . import diffuploadresponse
from . import diffversionresponse
from . import downloadparameters
...
class Media:
    ...
    composite_media: Optional[List[compositemedia.CompositeMedia]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'compositeMedia' }})
    content_type: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'contentType' }})
    content_type_info: Optional[contenttypeinfo.ContentTypeInfo] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'contentTypeInfo' }})
    ...
    diff_checksums_response: Optional[diffchecksumsresponse.DiffChecksumsResponse] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'diffChecksumsResponse' }})
    diff_download_response: Optional[diffdownloadresponse.DiffDownloadResponse] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'diffDownloadResponse' }})
    diff_upload_request: Optional[diffuploadrequest.DiffUploadRequest] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'diffUploadRequest' }})
    diff_upload_response: Optional[diffuploadresponse.DiffUploadResponse] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'diffUploadResponse' }})
    diff_version_response: Optional[diffversionresponse.DiffVersionResponse] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'diffVersionResponse' }})
    download_parameters: Optional[downloadparameters.DownloadParameters] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'downloadParameters' }})
    ...
    reference_type: Optional[MediaReferenceTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'referenceType' }})
