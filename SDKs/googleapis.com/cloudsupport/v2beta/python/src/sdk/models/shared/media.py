...
class Media:
    ...
    composite_media: Optional[List[CompositeMedia]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('compositeMedia') }})
    content_type: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('contentType') }})
    content_type_info: Optional[ContentTypeInfo] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('contentTypeInfo') }})
    ...
    diff_checksums_response: Optional[DiffChecksumsResponse] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('diffChecksumsResponse') }})
    diff_download_response: Optional[DiffDownloadResponse] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('diffDownloadResponse') }})
    diff_upload_request: Optional[DiffUploadRequest] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('diffUploadRequest') }})
    diff_upload_response: Optional[DiffUploadResponse] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('diffUploadResponse') }})
    diff_version_response: Optional[DiffVersionResponse] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('diffVersionResponse') }})
    download_parameters: Optional[DownloadParameters] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('downloadParameters') }})
    ...
    reference_type: Optional[MediaReferenceTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('referenceType') }})
