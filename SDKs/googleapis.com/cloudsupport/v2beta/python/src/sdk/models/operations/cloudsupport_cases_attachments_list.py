...
class CloudsupportCasesAttachmentsListRequest:
    path_params: CloudsupportCasesAttachmentsListPathParams = field()
    query_params: CloudsupportCasesAttachmentsListQueryParams = field()
    security: CloudsupportCasesAttachmentsListSecurity = field()
