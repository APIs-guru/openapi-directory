...
var Documents = /** @class */ (function () {
    ...
    **/
    Documents.prototype.languageDocumentsAnalyzeEntities = function (req, config) {
        ...
        var url = baseURL.replace(/\/$/, "") + "/v1beta1/documents:analyzeEntities";
    ...
    **/
    Documents.prototype.languageDocumentsAnalyzeSentiment = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v1beta1/documents:analyzeSentiment";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    Documents.prototype.languageDocumentsAnalyzeSyntax = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v1beta1/documents:analyzeSyntax";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    Documents.prototype.languageDocumentsAnnotateText = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v1beta1/documents:annotateText";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
