...
export class Documents {
  ...
  **/
  languageDocumentsAnalyzeEntities(
    ...
    const url: string = baseURL.replace(/\/$/, "") + "/v1/documents:analyzeEntities";
  ...
  **/
  languageDocumentsAnalyzeEntitySentiment(
    ...
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/v1/documents:analyzeEntitySentiment";
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.LanguageDocumentsAnalyzeEntitySentimentResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
  ...
  **/
  languageDocumentsAnalyzeSentiment(
    ...
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/v1/documents:analyzeSentiment";
  ...
  **/
  languageDocumentsAnalyzeSyntax(
    ...
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/v1/documents:analyzeSyntax";
  ...
  **/
  languageDocumentsAnnotateText(
    ...
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/v1/documents:annotateText";
  ...
  **/
  languageDocumentsClassifyText(
    ...
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/v1/documents:classifyText";
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.LanguageDocumentsClassifyTextResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
