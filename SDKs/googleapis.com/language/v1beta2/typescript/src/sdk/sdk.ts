...
export class SDK {
  ...
  LanguageDocumentsAnalyzeEntities(
    ...
    const url: string = baseURL.replace(/\/$/, "") + "/v1beta2/documents:analyzeEntities";
  ...
  LanguageDocumentsAnalyzeEntitySentiment(
    ...
    let baseURL: string = this.serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/v1beta2/documents:analyzeEntitySentiment";
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.LanguageDocumentsAnalyzeEntitySentimentResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.analyzeEntitySentimentResponse = httpRes?.data;
            }
            break;
        }
  ...
  LanguageDocumentsAnalyzeSentiment(
    ...
    let baseURL: string = this.serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/v1beta2/documents:analyzeSentiment";
  ...
  LanguageDocumentsAnalyzeSyntax(
    ...
    let baseURL: string = this.serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/v1beta2/documents:analyzeSyntax";
  ...
  LanguageDocumentsAnnotateText(
    ...
    let baseURL: string = this.serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/v1beta2/documents:annotateText";
  ...
  LanguageDocumentsClassifyText(
    ...
    let baseURL: string = this.serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/v1beta2/documents:classifyText";
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.LanguageDocumentsClassifyTextResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.classifyTextResponse = httpRes?.data;
            }
            break;
        }
