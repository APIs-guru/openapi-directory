...
class ConnectivityTest:
    ...
    probing_details: Optional[probingdetails.ProbingDetails] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'probingDetails' }})
