...
export class Projects {
  ...
  **/
  networkmanagementProjectsLocationsGlobalConnectivityTestsCreate(
    ...
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{parent}/connectivityTests", req.pathParams);
  ...
  **/
  networkmanagementProjectsLocationsGlobalConnectivityTestsRerun(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{name}:rerun", req.pathParams);
