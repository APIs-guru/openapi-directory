...
export class Projects {
  ...
  **/
  networkmanagementProjectsLocationsGlobalConnectivityTestsCreate(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.NetworkmanagementProjectsLocationsGlobalConnectivityTestsCreateRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{parent}/connectivityTests", req.pathParams);
    ...
    return client
      .request({
        ...
        const res: operations.NetworkmanagementProjectsLocationsGlobalConnectivityTestsCreateResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  networkmanagementProjectsLocationsGlobalConnectivityTestsGetIamPolicy(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.NetworkmanagementProjectsLocationsGlobalConnectivityTestsGetIamPolicyRequest(req);
    }
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.NetworkmanagementProjectsLocationsGlobalConnectivityTestsGetIamPolicyResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
  ...
  **/
  networkmanagementProjectsLocationsGlobalConnectivityTestsList(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.NetworkmanagementProjectsLocationsGlobalConnectivityTestsListRequest(req);
    }
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.NetworkmanagementProjectsLocationsGlobalConnectivityTestsListResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.listConnectivityTestsResponse = httpRes?.data;
            }
            break;
        }
  ...
  **/
  networkmanagementProjectsLocationsGlobalConnectivityTestsPatch(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.NetworkmanagementProjectsLocationsGlobalConnectivityTestsPatchRequest(req);
    }
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.NetworkmanagementProjectsLocationsGlobalConnectivityTestsPatchResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.operation = httpRes?.data;
  ...
  **/
  networkmanagementProjectsLocationsGlobalConnectivityTestsRerun(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.NetworkmanagementProjectsLocationsGlobalConnectivityTestsRerunRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{name}:rerun", req.pathParams);
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.NetworkmanagementProjectsLocationsGlobalConnectivityTestsRerunResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.operation = httpRes?.data;
  ...
  **/
  networkmanagementProjectsLocationsGlobalConnectivityTestsSetIamPolicy(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.NetworkmanagementProjectsLocationsGlobalConnectivityTestsSetIamPolicyRequest(req);
    }
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.NetworkmanagementProjectsLocationsGlobalConnectivityTestsSetIamPolicyResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.policy = httpRes?.data;
  ...
  **/
  networkmanagementProjectsLocationsGlobalConnectivityTestsTestIamPermissions(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.NetworkmanagementProjectsLocationsGlobalConnectivityTestsTestIamPermissionsRequest(req);
    }
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.NetworkmanagementProjectsLocationsGlobalConnectivityTestsTestIamPermissionsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
  ...
  **/
  networkmanagementProjectsLocationsGlobalOperationsCancel(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.NetworkmanagementProjectsLocationsGlobalOperationsCancelRequest(req);
    }
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.NetworkmanagementProjectsLocationsGlobalOperationsCancelResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
  ...
  **/
  networkmanagementProjectsLocationsGlobalOperationsDelete(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.NetworkmanagementProjectsLocationsGlobalOperationsDeleteRequest(req);
    }
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.NetworkmanagementProjectsLocationsGlobalOperationsDeleteResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.empty = httpRes?.data;
  ...
  **/
  networkmanagementProjectsLocationsGlobalOperationsGet(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.NetworkmanagementProjectsLocationsGlobalOperationsGetRequest(req);
    }
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.NetworkmanagementProjectsLocationsGlobalOperationsGetResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.operation = httpRes?.data;
  ...
  **/
  networkmanagementProjectsLocationsGlobalOperationsList(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.NetworkmanagementProjectsLocationsGlobalOperationsListRequest(req);
    }
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.NetworkmanagementProjectsLocationsGlobalOperationsListResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
  ...
  networkmanagementProjectsLocationsList(
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.NetworkmanagementProjectsLocationsListResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
