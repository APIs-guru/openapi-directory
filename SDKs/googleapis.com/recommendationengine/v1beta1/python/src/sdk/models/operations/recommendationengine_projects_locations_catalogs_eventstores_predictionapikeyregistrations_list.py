...
class RecommendationengineProjectsLocationsCatalogsEventStoresPredictionAPIKeyRegistrationsListRequest:
    path_params: RecommendationengineProjectsLocationsCatalogsEventStoresPredictionAPIKeyRegistrationsListPathParams = field(default=None)
    query_params: RecommendationengineProjectsLocationsCatalogsEventStoresPredictionAPIKeyRegistrationsListQueryParams = field(default=None)
    security: RecommendationengineProjectsLocationsCatalogsEventStoresPredictionAPIKeyRegistrationsListSecurity = field(default=None)
