...
class RecommendationengineProjectsLocationsCatalogsEventStoresUserEventsCollectRequest:
    path_params: RecommendationengineProjectsLocationsCatalogsEventStoresUserEventsCollectPathParams = field()
    query_params: RecommendationengineProjectsLocationsCatalogsEventStoresUserEventsCollectQueryParams = field()
    security: RecommendationengineProjectsLocationsCatalogsEventStoresUserEventsCollectSecurity = field()
