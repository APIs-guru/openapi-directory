...
class RecommendationengineProjectsLocationsCatalogsEventStoresUserEventsCollectRequest:
    path_params: RecommendationengineProjectsLocationsCatalogsEventStoresUserEventsCollectPathParams = field(default=None)
    query_params: RecommendationengineProjectsLocationsCatalogsEventStoresUserEventsCollectQueryParams = field(default=None)
    security: RecommendationengineProjectsLocationsCatalogsEventStoresUserEventsCollectSecurity = field(default=None)
