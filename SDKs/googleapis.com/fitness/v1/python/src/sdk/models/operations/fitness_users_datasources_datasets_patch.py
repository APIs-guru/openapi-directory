...
class FitnessUsersDataSourcesDatasetsPatchRequest:
    path_params: FitnessUsersDataSourcesDatasetsPatchPathParams = field(default=None)
    query_params: FitnessUsersDataSourcesDatasetsPatchQueryParams = field(default=None)
    request: Optional[shared.Dataset] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: FitnessUsersDataSourcesDatasetsPatchSecurity = field(default=None)
