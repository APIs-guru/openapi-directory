...
class FitnessUsersDataSourcesDeleteRequest:
    path_params: FitnessUsersDataSourcesDeletePathParams = field(default=None)
    query_params: FitnessUsersDataSourcesDeleteQueryParams = field(default=None)
    security: FitnessUsersDataSourcesDeleteSecurity = field(default=None)
