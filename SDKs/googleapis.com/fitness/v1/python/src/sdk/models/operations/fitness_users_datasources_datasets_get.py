...
class FitnessUsersDataSourcesDatasetsGetRequest:
    path_params: FitnessUsersDataSourcesDatasetsGetPathParams = field(default=None)
    query_params: FitnessUsersDataSourcesDatasetsGetQueryParams = field(default=None)
    security: FitnessUsersDataSourcesDatasetsGetSecurity = field(default=None)
