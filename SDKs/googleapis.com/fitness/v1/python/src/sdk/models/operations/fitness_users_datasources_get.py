...
class FitnessUsersDataSourcesGetRequest:
    path_params: FitnessUsersDataSourcesGetPathParams = field()
    query_params: FitnessUsersDataSourcesGetQueryParams = field()
    security: FitnessUsersDataSourcesGetSecurity = field()
