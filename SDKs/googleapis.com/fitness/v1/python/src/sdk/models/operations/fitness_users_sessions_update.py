...
class FitnessUsersSessionsUpdateRequest:
    path_params: FitnessUsersSessionsUpdatePathParams = field()
    query_params: FitnessUsersSessionsUpdateQueryParams = field()
    security: FitnessUsersSessionsUpdateSecurity = field()
