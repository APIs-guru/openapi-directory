...
class FitnessUsersDataSourcesDataPointChangesListRequest:
    path_params: FitnessUsersDataSourcesDataPointChangesListPathParams = field(default=None)
    query_params: FitnessUsersDataSourcesDataPointChangesListQueryParams = field(default=None)
    security: FitnessUsersDataSourcesDataPointChangesListSecurity = field(default=None)
