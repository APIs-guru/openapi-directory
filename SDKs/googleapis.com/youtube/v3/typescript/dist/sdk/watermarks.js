...
var Watermarks = /** @class */ (function () {
    function Watermarks(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Watermarks.prototype.youtubeWatermarksSet = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.YoutubeWatermarksSetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/youtube/v3/watermarks/set";
    ...
    **/
    Watermarks.prototype.youtubeWatermarksUnset = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.YoutubeWatermarksUnsetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/youtube/v3/watermarks/unset";
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
