...
var ThirdPartyLinks = /** @class */ (function () {
    function ThirdPartyLinks(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    ThirdPartyLinks.prototype.youtubeThirdPartyLinksDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.YoutubeThirdPartyLinksDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/youtube/v3/thirdPartyLinks";
    ...
    **/
    ThirdPartyLinks.prototype.youtubeThirdPartyLinksInsert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.thirdPartyLink = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    ThirdPartyLinks.prototype.youtubeThirdPartyLinksList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.thirdPartyLinkListResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    ThirdPartyLinks.prototype.youtubeThirdPartyLinksUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
