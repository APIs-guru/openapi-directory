...
class YoutubeLiveStreamsListSecurity:
    option1: Optional[YoutubeLiveStreamsListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[YoutubeLiveStreamsListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[YoutubeLiveStreamsListSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class YoutubeLiveStreamsListRequest:
    query_params: YoutubeLiveStreamsListQueryParams = field(default=None)
    security: YoutubeLiveStreamsListSecurity = field(default=None)
