...
@dataclass
class YoutubeYoutubeV3UpdateCommentThreadsQueryParams:
    ...
    part: Optional[List[str]] = field(default=None, metadata={'query_param': { 'field_name': 'part', 'style': 'form', 'explode': True }})
