...
class YoutubeLiveBroadcastsTransitionSecurity:
    option1: Optional[YoutubeLiveBroadcastsTransitionSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[YoutubeLiveBroadcastsTransitionSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
