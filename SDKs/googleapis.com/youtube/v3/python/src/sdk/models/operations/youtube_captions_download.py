...
class YoutubeCaptionsDownloadRequest:
    path_params: YoutubeCaptionsDownloadPathParams = field(default=None)
    query_params: YoutubeCaptionsDownloadQueryParams = field(default=None)
    security: YoutubeCaptionsDownloadSecurity = field(default=None)
