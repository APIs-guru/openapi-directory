...
class YoutubeThirdPartyLinksDeleteQueryParams:
    linking_token: str = field(metadata={'query_param': { 'field_name': 'linkingToken', 'style': 'form', 'explode': True }})
    type: YoutubeThirdPartyLinksDeleteTypeEnum = field(metadata={'query_param': { 'field_name': 'type', 'style': 'form', 'explode': True }})
...
class YoutubeThirdPartyLinksDeleteRequest:
    query_params: YoutubeThirdPartyLinksDeleteQueryParams = field()
