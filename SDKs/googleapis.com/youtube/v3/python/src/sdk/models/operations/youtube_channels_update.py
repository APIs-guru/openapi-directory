...
class YoutubeChannelsUpdateSecurity:
    option1: Optional[YoutubeChannelsUpdateSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[YoutubeChannelsUpdateSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[YoutubeChannelsUpdateSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class YoutubeChannelsUpdateRequest:
    query_params: YoutubeChannelsUpdateQueryParams = field(default=None)
    request: Optional[shared.Channel] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: YoutubeChannelsUpdateSecurity = field(default=None)
