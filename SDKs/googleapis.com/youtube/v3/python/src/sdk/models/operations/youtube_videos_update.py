...
class YoutubeVideosUpdateSecurity:
    option1: Optional[YoutubeVideosUpdateSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[YoutubeVideosUpdateSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[YoutubeVideosUpdateSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class YoutubeVideosUpdateRequest:
    query_params: YoutubeVideosUpdateQueryParams = field(default=None)
    request: Optional[shared.Video] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: YoutubeVideosUpdateSecurity = field(default=None)
