...
type ContentRating struct {
	AcbRating              *ContentRatingAcbRatingEnum              `json:"acbRating"`
	AgcomRating            *ContentRatingAgcomRatingEnum            `json:"agcomRating"`
	AnatelRating           *ContentRatingAnatelRatingEnum           `json:"anatelRating"`
	BbfcRating             *ContentRatingBbfcRatingEnum             `json:"bbfcRating"`
	BfvcRating             *ContentRatingBfvcRatingEnum             `json:"bfvcRating"`
	BmukkRating            *ContentRatingBmukkRatingEnum            `json:"bmukkRating"`
	CatvRating             *ContentRatingCatvRatingEnum             `json:"catvRating"`
	CatvfrRating           *ContentRatingCatvfrRatingEnum           `json:"catvfrRating"`
	CbfcRating             *ContentRatingCbfcRatingEnum             `json:"cbfcRating"`
	CccRating              *ContentRatingCccRatingEnum              `json:"cccRating"`
	CceRating              *ContentRatingCceRatingEnum              `json:"cceRating"`
	ChfilmRating           *ContentRatingChfilmRatingEnum           `json:"chfilmRating"`
	ChvrsRating            *ContentRatingChvrsRatingEnum            `json:"chvrsRating"`
	CicfRating             *ContentRatingCicfRatingEnum             `json:"cicfRating"`
	CnaRating              *ContentRatingCnaRatingEnum              `json:"cnaRating"`
	CncRating              *ContentRatingCncRatingEnum              `json:"cncRating"`
	CsaRating              *ContentRatingCsaRatingEnum              `json:"csaRating"`
	CscfRating             *ContentRatingCscfRatingEnum             `json:"cscfRating"`
	CzfilmRating           *ContentRatingCzfilmRatingEnum           `json:"czfilmRating"`
	DjctqRating            *ContentRatingDjctqRatingEnum            `json:"djctqRating"`
	DjctqRatingReasons     []ContentRatingDjctqRatingReasonsEnum    `json:"djctqRatingReasons"`
	EcbmctRating           *ContentRatingEcbmctRatingEnum           `json:"ecbmctRating"`
	EefilmRating           *ContentRatingEefilmRatingEnum           `json:"eefilmRating"`
	EgfilmRating           *ContentRatingEgfilmRatingEnum           `json:"egfilmRating"`
	EirinRating            *ContentRatingEirinRatingEnum            `json:"eirinRating"`
	FcbmRating             *ContentRatingFcbmRatingEnum             `json:"fcbmRating"`
	FcoRating              *ContentRatingFcoRatingEnum              `json:"fcoRating"`
	FmocRating             *ContentRatingFmocRatingEnum             `json:"fmocRating"`
	FpbRating              *ContentRatingFpbRatingEnum              `json:"fpbRating"`
	FpbRatingReasons       []ContentRatingFpbRatingReasonsEnum      `json:"fpbRatingReasons"`
	FskRating              *ContentRatingFskRatingEnum              `json:"fskRating"`
	GrfilmRating           *ContentRatingGrfilmRatingEnum           `json:"grfilmRating"`
	IcaaRating             *ContentRatingIcaaRatingEnum             `json:"icaaRating"`
	IfcoRating             *ContentRatingIfcoRatingEnum             `json:"ifcoRating"`
	IlfilmRating           *ContentRatingIlfilmRatingEnum           `json:"ilfilmRating"`
	IncaaRating            *ContentRatingIncaaRatingEnum            `json:"incaaRating"`
	KfcbRating             *ContentRatingKfcbRatingEnum             `json:"kfcbRating"`
	KijkwijzerRating       *ContentRatingKijkwijzerRatingEnum       `json:"kijkwijzerRating"`
	KmrbRating             *ContentRatingKmrbRatingEnum             `json:"kmrbRating"`
	LsfRating              *ContentRatingLsfRatingEnum              `json:"lsfRating"`
	MccaaRating            *ContentRatingMccaaRatingEnum            `json:"mccaaRating"`
	MccypRating            *ContentRatingMccypRatingEnum            `json:"mccypRating"`
	McstRating             *ContentRatingMcstRatingEnum             `json:"mcstRating"`
	MdaRating              *ContentRatingMdaRatingEnum              `json:"mdaRating"`
	MedietilsynetRating    *ContentRatingMedietilsynetRatingEnum    `json:"medietilsynetRating"`
	MekuRating             *ContentRatingMekuRatingEnum             `json:"mekuRating"`
	MenaMpaaRating         *ContentRatingMenaMpaaRatingEnum         `json:"menaMpaaRating"`
	MibacRating            *ContentRatingMibacRatingEnum            `json:"mibacRating"`
	MocRating              *ContentRatingMocRatingEnum              `json:"mocRating"`
	MoctwRating            *ContentRatingMoctwRatingEnum            `json:"moctwRating"`
	MpaaRating             *ContentRatingMpaaRatingEnum             `json:"mpaaRating"`
	MpaatRating            *ContentRatingMpaatRatingEnum            `json:"mpaatRating"`
	MtrcbRating            *ContentRatingMtrcbRatingEnum            `json:"mtrcbRating"`
	NbcRating              *ContentRatingNbcRatingEnum              `json:"nbcRating"`
	NbcplRating            *ContentRatingNbcplRatingEnum            `json:"nbcplRating"`
	NfrcRating             *ContentRatingNfrcRatingEnum             `json:"nfrcRating"`
	NfvcbRating            *ContentRatingNfvcbRatingEnum            `json:"nfvcbRating"`
	NkclvRating            *ContentRatingNkclvRatingEnum            `json:"nkclvRating"`
	NmcRating              *ContentRatingNmcRatingEnum              `json:"nmcRating"`
	OflcRating             *ContentRatingOflcRatingEnum             `json:"oflcRating"`
	PefilmRating           *ContentRatingPefilmRatingEnum           `json:"pefilmRating"`
	RcnofRating            *ContentRatingRcnofRatingEnum            `json:"rcnofRating"`
	ResorteviolenciaRating *ContentRatingResorteviolenciaRatingEnum `json:"resorteviolenciaRating"`
	RtcRating              *ContentRatingRtcRatingEnum              `json:"rtcRating"`
	RteRating              *ContentRatingRteRatingEnum              `json:"rteRating"`
	RussiaRating           *ContentRatingRussiaRatingEnum           `json:"russiaRating"`
	SkfilmRating           *ContentRatingSkfilmRatingEnum           `json:"skfilmRating"`
	SmaisRating            *ContentRatingSmaisRatingEnum            `json:"smaisRating"`
	SmsaRating             *ContentRatingSmsaRatingEnum             `json:"smsaRating"`
	TvpgRating             *ContentRatingTvpgRatingEnum             `json:"tvpgRating"`
	YtRating               *ContentRatingYtRatingEnum               `json:"ytRating"`
}
