...
type YoutubeCommentsInsertQueryParams struct {
...
type YoutubeCommentsInsertSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type YoutubeCommentsInsertRequest struct {
...
type YoutubeCommentsInsertResponse struct {
