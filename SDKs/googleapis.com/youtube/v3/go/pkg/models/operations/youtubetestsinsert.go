...
type YoutubeTestsInsertQueryParams struct {
...
type YoutubeTestsInsertSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type YoutubeTestsInsertRequest struct {
	QueryParams YoutubeTestsInsertQueryParams
	Request     *shared.TestItem `request:"mediaType=application/json"`
	Security    YoutubeTestsInsertSecurity
}

type YoutubeTestsInsertResponse struct {
	ContentType string
	StatusCode  int64
