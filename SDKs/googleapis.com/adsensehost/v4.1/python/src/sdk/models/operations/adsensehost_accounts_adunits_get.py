...
class AdsensehostAccountsAdunitsGetRequest:
    path_params: AdsensehostAccountsAdunitsGetPathParams = field(default=None)
    query_params: AdsensehostAccountsAdunitsGetQueryParams = field(default=None)
    security: AdsensehostAccountsAdunitsGetSecurity = field(default=None)
