...
class AdsensehostAccountsAdunitsGetRequest:
    path_params: AdsensehostAccountsAdunitsGetPathParams = field()
    query_params: AdsensehostAccountsAdunitsGetQueryParams = field()
    security: AdsensehostAccountsAdunitsGetSecurity = field()
