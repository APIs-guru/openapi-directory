...
class AdsensehostAccountsAdunitsListRequest:
    path_params: AdsensehostAccountsAdunitsListPathParams = field(default=None)
    query_params: AdsensehostAccountsAdunitsListQueryParams = field(default=None)
    security: AdsensehostAccountsAdunitsListSecurity = field(default=None)
