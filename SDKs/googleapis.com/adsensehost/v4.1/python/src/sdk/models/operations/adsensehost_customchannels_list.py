...
class AdsensehostCustomchannelsListRequest:
    path_params: AdsensehostCustomchannelsListPathParams = field(default=None)
    query_params: AdsensehostCustomchannelsListQueryParams = field(default=None)
    security: AdsensehostCustomchannelsListSecurity = field(default=None)
