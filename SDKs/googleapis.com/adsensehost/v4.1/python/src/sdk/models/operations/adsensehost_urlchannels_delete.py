...
class AdsensehostUrlchannelsDeletePathParams:
    ...
    url_channel_id: str = field(default=None, metadata={'path_param': { 'field_name': 'urlChannelId', 'style': 'simple', 'explode': False }})
...
class AdsensehostUrlchannelsDeleteRequest:
    path_params: AdsensehostUrlchannelsDeletePathParams = field(default=None)
    query_params: AdsensehostUrlchannelsDeleteQueryParams = field(default=None)
    security: AdsensehostUrlchannelsDeleteSecurity = field(default=None)
