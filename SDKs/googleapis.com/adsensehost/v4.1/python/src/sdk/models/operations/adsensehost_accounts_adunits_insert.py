...
class AdsensehostAccountsAdunitsInsertRequest:
    path_params: AdsensehostAccountsAdunitsInsertPathParams = field(default=None)
    query_params: AdsensehostAccountsAdunitsInsertQueryParams = field(default=None)
    request: Optional[shared.AdUnit] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: AdsensehostAccountsAdunitsInsertSecurity = field(default=None)
