...
class AdsensehostAccountsAdunitsPatchQueryParams:
    ad_unit_id: str = field(default=None, metadata={'query_param': { 'field_name': 'adUnitId', 'style': 'form', 'explode': True }})
...
class AdsensehostAccountsAdunitsPatchRequest:
    path_params: AdsensehostAccountsAdunitsPatchPathParams = field(default=None)
    query_params: AdsensehostAccountsAdunitsPatchQueryParams = field(default=None)
    request: Optional[shared.AdUnit] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: AdsensehostAccountsAdunitsPatchSecurity = field(default=None)
