...
class AdsensehostAccountsAdclientsListRequest:
    path_params: AdsensehostAccountsAdclientsListPathParams = field(default=None)
    query_params: AdsensehostAccountsAdclientsListQueryParams = field(default=None)
    security: AdsensehostAccountsAdclientsListSecurity = field(default=None)
