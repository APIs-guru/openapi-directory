...
class AdsensehostAccountsReportsGenerateRequest:
    path_params: AdsensehostAccountsReportsGeneratePathParams = field()
    query_params: AdsensehostAccountsReportsGenerateQueryParams = field()
    security: AdsensehostAccountsReportsGenerateSecurity = field()
