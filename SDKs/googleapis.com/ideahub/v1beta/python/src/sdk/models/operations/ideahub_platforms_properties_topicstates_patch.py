...
class IdeahubPlatformsPropertiesTopicStatesPatchRequest:
    ...
    request: Optional[shared.GoogleSearchIdeahubV1betaTopicState] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class IdeahubPlatformsPropertiesTopicStatesPatchResponse:
    content_type: str = field(default=None)
    google_search_ideahub_v1beta_topic_state: Optional[shared.GoogleSearchIdeahubV1betaTopicState] = field(default=None)
