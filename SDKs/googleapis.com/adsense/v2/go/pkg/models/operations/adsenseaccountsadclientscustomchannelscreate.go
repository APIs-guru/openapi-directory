...
type AdsenseAccountsAdclientsCustomchannelsCreatePathParams struct {
    Parent string `pathParam:"style=simple,explode=false,name=parent"`
    
}

type AdsenseAccountsAdclientsCustomchannelsCreateQueryParams struct {
...
type AdsenseAccountsAdclientsCustomchannelsCreateSecurity struct {
...
type AdsenseAccountsAdclientsCustomchannelsCreateResponse struct {
    ContentType string 
