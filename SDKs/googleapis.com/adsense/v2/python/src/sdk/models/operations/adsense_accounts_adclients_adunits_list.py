...
class AdsenseAccountsAdclientsAdunitsListSecurity:
    option1: Optional[AdsenseAccountsAdclientsAdunitsListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AdsenseAccountsAdclientsAdunitsListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
