...
class AdsenseAccountsReportsSavedGenerateCsvRequest:
    path_params: AdsenseAccountsReportsSavedGenerateCsvPathParams = field(default=None)
    query_params: AdsenseAccountsReportsSavedGenerateCsvQueryParams = field(default=None)
    security: AdsenseAccountsReportsSavedGenerateCsvSecurity = field(default=None)
