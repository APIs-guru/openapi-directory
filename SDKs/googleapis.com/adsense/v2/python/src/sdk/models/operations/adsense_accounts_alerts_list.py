...
class AdsenseAccountsAlertsListSecurity:
    option1: Optional[AdsenseAccountsAlertsListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AdsenseAccountsAlertsListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
