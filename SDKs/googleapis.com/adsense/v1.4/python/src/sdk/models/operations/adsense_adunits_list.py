...
@dataclass
class AdsenseAdunitsListQueryParams:
...
class AdsenseAdunitsListSecurity:
    option1: Optional[AdsenseAdunitsListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AdsenseAdunitsListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
