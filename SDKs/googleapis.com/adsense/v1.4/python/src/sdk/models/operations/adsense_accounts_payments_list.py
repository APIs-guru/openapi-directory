...
class AdsenseAccountsPaymentsListRequest:
    path_params: AdsenseAccountsPaymentsListPathParams = field()
    query_params: AdsenseAccountsPaymentsListQueryParams = field()
    security: AdsenseAccountsPaymentsListSecurity = field()
