...
class AdsenseCustomchannelsGetRequest:
    path_params: AdsenseCustomchannelsGetPathParams = field(default=None)
    query_params: AdsenseCustomchannelsGetQueryParams = field(default=None)
    security: AdsenseCustomchannelsGetSecurity = field(default=None)
