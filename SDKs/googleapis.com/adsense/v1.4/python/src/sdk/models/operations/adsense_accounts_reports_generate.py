...
class AdsenseAccountsReportsGenerateRequest:
    path_params: AdsenseAccountsReportsGeneratePathParams = field(default=None)
    query_params: AdsenseAccountsReportsGenerateQueryParams = field(default=None)
    security: AdsenseAccountsReportsGenerateSecurity = field(default=None)
