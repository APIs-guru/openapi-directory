...
class AdsenseAccountsAdunitsListRequest:
    path_params: AdsenseAccountsAdunitsListPathParams = field(default=None)
    query_params: AdsenseAccountsAdunitsListQueryParams = field(default=None)
    security: AdsenseAccountsAdunitsListSecurity = field(default=None)
