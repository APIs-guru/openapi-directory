...
@dataclass
class AdsenseSavedadstylesGetQueryParams:
...
@dataclass
class AdsenseSavedadstylesGetSecurity:
    option1: Optional[AdsenseSavedadstylesGetSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AdsenseSavedadstylesGetSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
