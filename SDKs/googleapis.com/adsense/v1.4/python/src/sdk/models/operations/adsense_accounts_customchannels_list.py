...
class AdsenseAccountsCustomchannelsListRequest:
    path_params: AdsenseAccountsCustomchannelsListPathParams = field()
    query_params: AdsenseAccountsCustomchannelsListQueryParams = field()
    security: AdsenseAccountsCustomchannelsListSecurity = field()
