...
class AdsenseAccountsAlertsDeleteRequest:
    path_params: AdsenseAccountsAlertsDeletePathParams = field(default=None)
    query_params: AdsenseAccountsAlertsDeleteQueryParams = field(default=None)
    security: AdsenseAccountsAlertsDeleteSecurity = field(default=None)
