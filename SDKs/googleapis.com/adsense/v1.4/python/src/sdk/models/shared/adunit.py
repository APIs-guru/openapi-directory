...
class AdUnitFeedAdsSettings:
    r"""AdUnitFeedAdsSettings
    Settings specific to feed ads (AFF) - deprecated.
    """
    
    ad_position: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('adPosition') }})
    frequency: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('frequency') }})
    minimum_word_count: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('minimumWordCount') }})
    type: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
...
class AdUnit:
    ...
    feed_ads_settings: Optional[AdUnitFeedAdsSettings] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('feedAdsSettings') }})
    ...
    saved_style_id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('savedStyleId') }})
