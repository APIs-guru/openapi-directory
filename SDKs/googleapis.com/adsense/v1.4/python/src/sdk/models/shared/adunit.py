...
class AdUnitFeedAdsSettings:
    ad_position: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'adPosition' }})
    frequency: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'frequency' }})
    minimum_word_count: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'minimumWordCount' }})
    type: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'type' }})
...
class AdUnit:
    ...
    feed_ads_settings: Optional[AdUnitFeedAdsSettings] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'feedAdsSettings' }})
    ...
    saved_style_id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'savedStyleId' }})
