...
@dataclass
class AdsenseAlertsListQueryParams:
...
class AdsenseAlertsListSecurity:
    option1: Optional[AdsenseAlertsListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AdsenseAlertsListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
