...
export class AdUnitFeedAdsSettings extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=adPosition" })
  adPosition?: string;

  @SpeakeasyMetadata({ data: "json, name=frequency" })
  frequency?: number;

  @SpeakeasyMetadata({ data: "json, name=minimumWordCount" })
...
export class AdUnit extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ data: "json, name=feedAdsSettings" })
  ...
  @SpeakeasyMetadata({ data: "json, name=savedStyleId" })
  savedStyleId?: string;
