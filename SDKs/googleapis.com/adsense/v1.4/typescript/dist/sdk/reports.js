...
var Reports = /** @class */ (function () {
    ...
    **/
    Reports.prototype.adsenseReportsGenerate = function (req, config) {
    ...
    **/
    Reports.prototype.adsenseReportsSavedGenerate = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AdsenseReportsSavedGenerateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/reports/{savedReportId}", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    Reports.prototype.adsenseReportsSavedList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
