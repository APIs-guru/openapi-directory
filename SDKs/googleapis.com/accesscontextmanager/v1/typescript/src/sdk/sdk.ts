...
export class SDK {
  ...
  AccesscontextmanagerAccessPoliciesAccessLevelsCreate(
    ...
    const url: string = utils.GenerateURL(baseURL, "/v1/{parent}/accessLevels", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        let res: operations.AccesscontextmanagerAccessPoliciesAccessLevelsCreateResponse = {statusCode: httpRes.status, contentType: contentType};
  ...
  AccesscontextmanagerAccessPoliciesAccessLevelsList(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.AccesscontextmanagerAccessPoliciesAccessLevelsListResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  AccesscontextmanagerAccessPoliciesAccessLevelsReplaceAll(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.AccesscontextmanagerAccessPoliciesAccessLevelsReplaceAllRequest(req);
    }
    
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{parent}/accessLevels:replaceAll", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.AccesscontextmanagerAccessPoliciesAccessLevelsReplaceAllResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.operation = httpRes?.data;
  ...
  AccesscontextmanagerAccessPoliciesCreate(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.AccesscontextmanagerAccessPoliciesCreateResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.operation = httpRes?.data;
  ...
  AccesscontextmanagerAccessPoliciesGetIamPolicy(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.AccesscontextmanagerAccessPoliciesGetIamPolicyRequest(req);
    }
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.AccesscontextmanagerAccessPoliciesGetIamPolicyResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  AccesscontextmanagerAccessPoliciesList(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.AccesscontextmanagerAccessPoliciesListResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  AccesscontextmanagerAccessPoliciesServicePerimetersCommit(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.AccesscontextmanagerAccessPoliciesServicePerimetersCommitRequest(req);
    }
    
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{parent}/servicePerimeters:commit", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.AccesscontextmanagerAccessPoliciesServicePerimetersCommitResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.operation = httpRes?.data;
  ...
  AccesscontextmanagerAccessPoliciesServicePerimetersCreate(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{parent}/servicePerimeters", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.AccesscontextmanagerAccessPoliciesServicePerimetersCreateResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.operation = httpRes?.data;
  ...
  AccesscontextmanagerAccessPoliciesServicePerimetersList(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.AccesscontextmanagerAccessPoliciesServicePerimetersListResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  AccesscontextmanagerAccessPoliciesServicePerimetersReplaceAll(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.AccesscontextmanagerAccessPoliciesServicePerimetersReplaceAllRequest(req);
    }
    
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{parent}/servicePerimeters:replaceAll", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.AccesscontextmanagerAccessPoliciesServicePerimetersReplaceAllResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.operation = httpRes?.data;
  ...
  AccesscontextmanagerAccessPoliciesServicePerimetersTestIamPermissions(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.AccesscontextmanagerAccessPoliciesServicePerimetersTestIamPermissionsRequest(req);
    }
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.AccesscontextmanagerAccessPoliciesServicePerimetersTestIamPermissionsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  AccesscontextmanagerAccessPoliciesSetIamPolicy(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.AccesscontextmanagerAccessPoliciesSetIamPolicyRequest(req);
    }
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.AccesscontextmanagerAccessPoliciesSetIamPolicyResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.policy = httpRes?.data;
  ...
  AccesscontextmanagerOperationsCancel(
    req: operations.AccesscontextmanagerOperationsCancelRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.AccesscontextmanagerOperationsCancelResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.AccesscontextmanagerOperationsCancelResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  AccesscontextmanagerOrganizationsGcpUserAccessBindingsCreate(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.AccesscontextmanagerOrganizationsGcpUserAccessBindingsCreateResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.operation = httpRes?.data;
  ...
  AccesscontextmanagerOrganizationsGcpUserAccessBindingsDelete(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.AccesscontextmanagerOrganizationsGcpUserAccessBindingsDeleteResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.operation = httpRes?.data;
  ...
  AccesscontextmanagerOrganizationsGcpUserAccessBindingsGet(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.AccesscontextmanagerOrganizationsGcpUserAccessBindingsGetResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  AccesscontextmanagerOrganizationsGcpUserAccessBindingsList(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.AccesscontextmanagerOrganizationsGcpUserAccessBindingsListResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  AccesscontextmanagerOrganizationsGcpUserAccessBindingsPatch(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.AccesscontextmanagerOrganizationsGcpUserAccessBindingsPatchResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.operation = httpRes?.data;
