...
var Organizations = /** @class */ (function () {
    ...
    **/
    Organizations.prototype.accesscontextmanagerOrganizationsGcpUserAccessBindingsCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AccesscontextmanagerOrganizationsGcpUserAccessBindingsCreateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{parent}/gcpUserAccessBindings", req.pathParams);
    ...
    **/
    Organizations.prototype.accesscontextmanagerOrganizationsGcpUserAccessBindingsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Organizations.prototype.accesscontextmanagerOrganizationsGcpUserAccessBindingsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.gcpUserAccessBinding = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Organizations.prototype.accesscontextmanagerOrganizationsGcpUserAccessBindingsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.listGcpUserAccessBindingsResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Organizations.prototype.accesscontextmanagerOrganizationsGcpUserAccessBindingsPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
