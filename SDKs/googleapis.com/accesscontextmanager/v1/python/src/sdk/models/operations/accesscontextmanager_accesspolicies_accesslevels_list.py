...
class AccesscontextmanagerAccessPoliciesAccessLevelsListRequest:
    path_params: AccesscontextmanagerAccessPoliciesAccessLevelsListPathParams = field(default=None)
    query_params: AccesscontextmanagerAccessPoliciesAccessLevelsListQueryParams = field(default=None)
    security: AccesscontextmanagerAccessPoliciesAccessLevelsListSecurity = field(default=None)
