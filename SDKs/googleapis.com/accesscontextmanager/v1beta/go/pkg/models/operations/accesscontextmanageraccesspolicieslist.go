...
type AccesscontextmanagerAccessPoliciesListQueryParams struct {
...
type AccesscontextmanagerAccessPoliciesListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AccesscontextmanagerAccessPoliciesListRequest struct {
	QueryParams AccesscontextmanagerAccessPoliciesListQueryParams
	Security    AccesscontextmanagerAccessPoliciesListSecurity
}

type AccesscontextmanagerAccessPoliciesListResponse struct {
	ContentType                string
