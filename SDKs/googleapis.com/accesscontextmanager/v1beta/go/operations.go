...
func (s *Operations) AccesscontextmanagerOperationsGet(ctx context.Context, request operations.AccesscontextmanagerOperationsGetRequest) (*operations.AccesscontextmanagerOperationsGetResponse, error) {
