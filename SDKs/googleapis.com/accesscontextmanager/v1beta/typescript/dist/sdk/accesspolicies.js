...
var AccessPolicies = /** @class */ (function () {
    ...
    **/
    AccessPolicies.prototype.accesscontextmanagerAccessPoliciesAccessLevelsCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AccesscontextmanagerAccessPoliciesAccessLevelsCreateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta/{parent}/accessLevels", req.pathParams);
    ...
    **/
    AccessPolicies.prototype.accesscontextmanagerAccessPoliciesAccessLevelsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.listAccessLevelsResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    AccessPolicies.prototype.accesscontextmanagerAccessPoliciesCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    AccessPolicies.prototype.accesscontextmanagerAccessPoliciesList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    AccessPolicies.prototype.accesscontextmanagerAccessPoliciesServicePerimetersCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AccesscontextmanagerAccessPoliciesServicePerimetersCreateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta/{parent}/servicePerimeters", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    AccessPolicies.prototype.accesscontextmanagerAccessPoliciesServicePerimetersDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    AccessPolicies.prototype.accesscontextmanagerAccessPoliciesServicePerimetersList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.listServicePerimetersResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    AccessPolicies.prototype.accesscontextmanagerAccessPoliciesServicePerimetersPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
