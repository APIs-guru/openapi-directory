...
class SiteVerificationWebResourcePatchRequest:
    path_params: SiteVerificationWebResourcePatchPathParams = field(default=None)
    query_params: SiteVerificationWebResourcePatchQueryParams = field(default=None)
    ...
    security: SiteVerificationWebResourcePatchSecurity = field(default=None)
