...
var Accounts = /** @class */ (function () {
    ...
    **/
    Accounts.prototype.admobAccountsAdSourcesList = function (req, config) {
        ...
        var url = utils.GenerateURL(baseURL, "/v1beta/{parent}/adSources", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.listAdSourcesResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Accounts.prototype.admobAccountsAdUnitsList = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta/{parent}/adUnits", req.pathParams);
    ...
    **/
    Accounts.prototype.admobAccountsAppsList = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta/{parent}/apps", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    Accounts.prototype.admobAccountsMediationReportGenerate = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta/{parent}/mediationReport:generate", req.pathParams);
    ...
    **/
    Accounts.prototype.admobAccountsNetworkReportGenerate = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta/{parent}/networkReport:generate", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
