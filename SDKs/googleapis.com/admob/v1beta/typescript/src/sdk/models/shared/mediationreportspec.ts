...
export class MediationReportSpec extends SpeakeasyBase {
  ...
  @Metadata({ data: "json, name=dimensionFilters", elemType: shared.MediationReportSpecDimensionFilter })
  ...
  @Metadata({ data: "json, name=sortConditions", elemType: shared.MediationReportSpecSortCondition })
