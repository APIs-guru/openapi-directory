...
class AdmobAccountsNetworkReportGenerateSecurity:
    option1: Optional[AdmobAccountsNetworkReportGenerateSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AdmobAccountsNetworkReportGenerateSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
