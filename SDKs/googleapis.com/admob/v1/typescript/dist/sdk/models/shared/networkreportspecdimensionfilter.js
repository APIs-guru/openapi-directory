...
export var NetworkReportSpecDimensionFilterDimensionEnum;
(function (NetworkReportSpecDimensionFilterDimensionEnum) {
...
})(NetworkReportSpecDimensionFilterDimensionEnum || (NetworkReportSpecDimensionFilterDimensionEnum = {}));
// NetworkReportSpecDimensionFilter
/**
 * Describes which report rows to match based on their dimension values.
**/
var NetworkReportSpecDimensionFilter = /** @class */ (function (_super) {
    __extends(NetworkReportSpecDimensionFilter, _super);
    function NetworkReportSpecDimensionFilter() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=dimension" }),
        __metadata("design:type", String)
    ], NetworkReportSpecDimensionFilter.prototype, "dimension", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=matchesAny" }),
        __metadata("design:type", StringList)
    ], NetworkReportSpecDimensionFilter.prototype, "matchesAny", void 0);
    return NetworkReportSpecDimensionFilter;
}(SpeakeasyBase));
export { NetworkReportSpecDimensionFilter };
