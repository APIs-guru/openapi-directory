...
class AdexchangebuyerCreativesAddDealRequest:
    path_params: AdexchangebuyerCreativesAddDealPathParams = field(default=None)
    query_params: AdexchangebuyerCreativesAddDealQueryParams = field(default=None)
    security: AdexchangebuyerCreativesAddDealSecurity = field(default=None)
