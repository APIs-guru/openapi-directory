...
class AdexchangebuyerPretargetingConfigUpdateRequest:
    path_params: AdexchangebuyerPretargetingConfigUpdatePathParams = field()
    query_params: AdexchangebuyerPretargetingConfigUpdateQueryParams = field()
    security: AdexchangebuyerPretargetingConfigUpdateSecurity = field()
