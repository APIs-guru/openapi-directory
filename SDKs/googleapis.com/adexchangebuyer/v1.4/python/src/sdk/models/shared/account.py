...
class AccountBidderLocation:
    bid_protocol: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('bidProtocol') }})
...
class Account:
    ...
    apply_pretargeting_to_non_guaranteed_deals: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('applyPretargetingToNonGuaranteedDeals') }})
