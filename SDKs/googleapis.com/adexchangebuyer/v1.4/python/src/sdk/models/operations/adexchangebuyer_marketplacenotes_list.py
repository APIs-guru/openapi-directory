...
class AdexchangebuyerMarketplacenotesListRequest:
    path_params: AdexchangebuyerMarketplacenotesListPathParams = field(default=None)
    query_params: AdexchangebuyerMarketplacenotesListQueryParams = field(default=None)
    security: AdexchangebuyerMarketplacenotesListSecurity = field(default=None)
    

@dataclass
class AdexchangebuyerMarketplacenotesListResponse:
    content_type: str = field(default=None)
    get_order_notes_response: Optional[shared.GetOrderNotesResponse] = field(default=None)
