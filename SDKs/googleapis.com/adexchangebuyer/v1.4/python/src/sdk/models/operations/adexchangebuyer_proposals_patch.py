...
class AdexchangebuyerProposalsPatchPathParams:
    ...
    update_action: AdexchangebuyerProposalsPatchUpdateActionEnum = field(default=None, metadata={'path_param': { 'field_name': 'updateAction', 'style': 'simple', 'explode': False }})
...
class AdexchangebuyerProposalsPatchRequest:
    path_params: AdexchangebuyerProposalsPatchPathParams = field(default=None)
    query_params: AdexchangebuyerProposalsPatchQueryParams = field(default=None)
    request: Optional[shared.Proposal] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: AdexchangebuyerProposalsPatchSecurity = field(default=None)
