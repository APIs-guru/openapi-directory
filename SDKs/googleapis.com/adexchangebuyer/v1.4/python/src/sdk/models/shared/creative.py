...
class CreativeCorrectionsContexts:
    auction_type: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'auctionType' }})
    context_type: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'contextType' }})
    geo_criteria_id: Optional[List[int]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'geoCriteriaId' }})
    platform: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'platform' }})
    

@dataclass_json
@dataclass
class CreativeCorrections:
    contexts: Optional[List[CreativeCorrectionsContexts]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'contexts' }})
...
class CreativeServingRestrictions:
    contexts: Optional[List[CreativeServingRestrictionsContexts]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'contexts' }})
    disapproval_reasons: Optional[List[CreativeServingRestrictionsDisapprovalReasons]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'disapprovalReasons' }})
    reason: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'reason' }})
...
class Creative:
    ...
    creative_status_identity_type: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'creativeStatusIdentityType' }})
    deals_status: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'dealsStatus' }})
    ...
    open_auction_status: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'openAuctionStatus' }})
    ...
    serving_restrictions: Optional[List[CreativeServingRestrictions]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'servingRestrictions' }})
