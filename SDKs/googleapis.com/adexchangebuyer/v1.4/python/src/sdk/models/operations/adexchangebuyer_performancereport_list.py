...
class AdexchangebuyerPerformanceReportListQueryParams:
    ...
    end_date_time: str = field(metadata={'query_param': { 'field_name': 'endDateTime', 'style': 'form', 'explode': True }})
    start_date_time: str = field(metadata={'query_param': { 'field_name': 'startDateTime', 'style': 'form', 'explode': True }})
...
class AdexchangebuyerPerformanceReportListRequest:
    query_params: AdexchangebuyerPerformanceReportListQueryParams = field()
    security: AdexchangebuyerPerformanceReportListSecurity = field()
