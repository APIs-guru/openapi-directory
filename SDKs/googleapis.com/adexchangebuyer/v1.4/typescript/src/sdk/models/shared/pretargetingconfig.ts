...
export class PretargetingConfigVideoPlayerSizes extends SpeakeasyBase {
  ...
  @Metadata({ data: "json, name=minHeight" })
  minHeight?: string;
...
export class PretargetingConfig extends SpeakeasyBase {
  ...
  @Metadata({ data: "json, name=userIdentifierDataRequired" })
  ...
  @Metadata({ data: "json, name=videoPlayerSizes", elemType: shared.PretargetingConfigVideoPlayerSizes })
