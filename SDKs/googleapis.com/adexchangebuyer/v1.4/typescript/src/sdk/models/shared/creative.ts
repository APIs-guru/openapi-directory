...
export class CreativeCorrectionsContexts extends SpeakeasyBase {
  ...
  @Metadata({ data: "json, name=geoCriteriaId" })
...
export class CreativeCorrections extends SpeakeasyBase {
  @Metadata({ data: "json, name=contexts", elemType: shared.CreativeCorrectionsContexts })
...
export class CreativeServingRestrictions extends SpeakeasyBase {
  @Metadata({ data: "json, name=contexts", elemType: shared.CreativeServingRestrictionsContexts })
  contexts?: CreativeServingRestrictionsContexts[];

  @Metadata({ data: "json, name=disapprovalReasons", elemType: shared.CreativeServingRestrictionsDisapprovalReasons })
...
export class Creative extends SpeakeasyBase {
  ...
  @Metadata({ data: "json, name=creativeStatusIdentityType" })
  ...
  @Metadata({ data: "json, name=servingRestrictions", elemType: shared.CreativeServingRestrictions })
