...
var Accounts = /** @class */ (function () {
    ...
    **/
    Accounts.prototype.adexchangebuyerAccountsGet = function (req, config) {
    ...
    **/
    Accounts.prototype.adexchangebuyerAccountsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.accountsList = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Accounts.prototype.adexchangebuyerAccountsPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Accounts.prototype.adexchangebuyerAccountsUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
