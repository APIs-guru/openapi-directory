...
class Creative:
    ...
    disapproval_reasons: Optional[List[CreativeDisapprovalReasons]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('disapprovalReasons') }})
