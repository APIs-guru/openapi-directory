...
var AdexchangebuyerBudgetGetPathParams = /** @class */ (function (_super) {
    ...
    function AdexchangebuyerBudgetGetPathParams() {
...
export { AdexchangebuyerBudgetGetPathParams };
var AdexchangebuyerBudgetGetQueryParams = /** @class */ (function (_super) {
    __extends(AdexchangebuyerBudgetGetQueryParams, _super);
    function AdexchangebuyerBudgetGetQueryParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
...
export { AdexchangebuyerBudgetGetQueryParams };
var AdexchangebuyerBudgetGetSecurity = /** @class */ (function (_super) {
    __extends(AdexchangebuyerBudgetGetSecurity, _super);
    function AdexchangebuyerBudgetGetSecurity() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
...
export { AdexchangebuyerBudgetGetSecurity };
var AdexchangebuyerBudgetGetRequest = /** @class */ (function (_super) {
    __extends(AdexchangebuyerBudgetGetRequest, _super);
    function AdexchangebuyerBudgetGetRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata(),
...
export { AdexchangebuyerBudgetGetRequest };
var AdexchangebuyerBudgetGetResponse = /** @class */ (function (_super) {
    __extends(AdexchangebuyerBudgetGetResponse, _super);
    function AdexchangebuyerBudgetGetResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata(),
...
export { AdexchangebuyerBudgetGetResponse };
