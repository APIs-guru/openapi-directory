...
class AdexchangebuyerCreativesListQueryParams:
    ...
    status_filter: Optional[AdexchangebuyerCreativesListStatusFilterEnum] = field(default=None, metadata={'query_param': { 'field_name': 'statusFilter', 'style': 'form', 'explode': True }})
