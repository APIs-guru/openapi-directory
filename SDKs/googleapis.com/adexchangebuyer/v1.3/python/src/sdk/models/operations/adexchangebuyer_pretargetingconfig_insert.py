...
class AdexchangebuyerPretargetingConfigInsertRequest:
    path_params: AdexchangebuyerPretargetingConfigInsertPathParams = field(default=None)
    query_params: AdexchangebuyerPretargetingConfigInsertQueryParams = field(default=None)
    request: Optional[shared.PretargetingConfig] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: AdexchangebuyerPretargetingConfigInsertSecurity = field(default=None)
