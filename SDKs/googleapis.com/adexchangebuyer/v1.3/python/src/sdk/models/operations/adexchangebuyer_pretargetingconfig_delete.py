...
class AdexchangebuyerPretargetingConfigDeleteRequest:
    path_params: AdexchangebuyerPretargetingConfigDeletePathParams = field()
    query_params: AdexchangebuyerPretargetingConfigDeleteQueryParams = field()
    security: AdexchangebuyerPretargetingConfigDeleteSecurity = field()
