...
type TagmanagerAccountsContainersTriggersUpdatePathParams struct {
...
type TagmanagerAccountsContainersTriggersUpdateQueryParams struct {
...
type TagmanagerAccountsContainersTriggersUpdateSecurity struct {
    Oauth2 shared.SchemeOauth2 `security:"scheme,type=oauth2"`
    Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
    
}

type TagmanagerAccountsContainersTriggersUpdateRequest struct {
...
type TagmanagerAccountsContainersTriggersUpdateResponse struct {
    ContentType string 
    StatusCode int64 
