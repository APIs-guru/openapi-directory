...
class TagmanagerAccountsContainersFoldersGetRequest:
    path_params: TagmanagerAccountsContainersFoldersGetPathParams = field()
    query_params: TagmanagerAccountsContainersFoldersGetQueryParams = field()
    security: TagmanagerAccountsContainersFoldersGetSecurity = field()
