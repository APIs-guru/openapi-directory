...
class TagmanagerAccountsContainersTriggersListRequest:
    path_params: TagmanagerAccountsContainersTriggersListPathParams = field()
    query_params: TagmanagerAccountsContainersTriggersListQueryParams = field()
    security: TagmanagerAccountsContainersTriggersListSecurity = field()
