...
@dataclass
class TagmanagerAccountsContainersVersionsGetQueryParams:
...
class TagmanagerAccountsContainersVersionsGetSecurity:
    option1: Optional[TagmanagerAccountsContainersVersionsGetSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[TagmanagerAccountsContainersVersionsGetSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[TagmanagerAccountsContainersVersionsGetSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
