...
export class TagmanagerAccountsContainersTriggersUpdatePathParams extends SpeakeasyBase {
...
export class TagmanagerAccountsContainersTriggersUpdateQueryParams extends SpeakeasyBase {
...
export class TagmanagerAccountsContainersTriggersUpdateSecurity extends SpeakeasyBase {
...
export class TagmanagerAccountsContainersTriggersUpdateRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class TagmanagerAccountsContainersTriggersUpdateResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
