...
export declare class TagmanagerAccountsUserPermissionsDeletePathParams extends SpeakeasyBase {
    path: string;
}
...
export declare class TagmanagerAccountsUserPermissionsDeleteQueryParams extends SpeakeasyBase {
