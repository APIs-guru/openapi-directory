...
var Zone = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], Zone.prototype, "notes", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=path" }),
        __metadata("design:type", String)
    ], Zone.prototype, "path", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=tagManagerUrl" }),
        __metadata("design:type", String)
    ], Zone.prototype, "tagManagerUrl", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=typeRestriction" }),
        __metadata("design:type", ZoneTypeRestriction)
    ], Zone.prototype, "typeRestriction", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=workspaceId" }),
        __metadata("design:type", String)
    ], Zone.prototype, "workspaceId", void 0);
    __decorate([
