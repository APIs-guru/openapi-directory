...
export declare class TagmanagerAccountsContainersWorkspacesBuiltInVariablesCreatePathParams extends SpeakeasyBase {
    parent: string;
}
...
export declare class TagmanagerAccountsContainersWorkspacesBuiltInVariablesCreateQueryParams extends SpeakeasyBase {
