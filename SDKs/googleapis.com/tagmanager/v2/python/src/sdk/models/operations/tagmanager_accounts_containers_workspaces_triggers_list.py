...
@dataclass
class TagmanagerAccountsContainersWorkspacesTriggersListQueryParams:
...
class TagmanagerAccountsContainersWorkspacesTriggersListSecurity:
    option1: Optional[TagmanagerAccountsContainersWorkspacesTriggersListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[TagmanagerAccountsContainersWorkspacesTriggersListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
