...
class TagmanagerAccountsContainersWorkspacesBuiltInVariablesRevertRequest:
    path_params: TagmanagerAccountsContainersWorkspacesBuiltInVariablesRevertPathParams = field()
    query_params: TagmanagerAccountsContainersWorkspacesBuiltInVariablesRevertQueryParams = field()
    security: TagmanagerAccountsContainersWorkspacesBuiltInVariablesRevertSecurity = field()
