...
@dataclass
class TagmanagerAccountsContainersWorkspacesBuiltInVariablesRevertPathParams:
    path: str = field(default=None, metadata={'path_param': { 'field_name': 'path', 'style': 'simple', 'explode': False }})
    
class TagmanagerAccountsContainersWorkspacesBuiltInVariablesRevertTypeEnum(str, Enum):
...
@dataclass
class TagmanagerAccountsContainersWorkspacesBuiltInVariablesRevertQueryParams:
    ...
    type: Optional[TagmanagerAccountsContainersWorkspacesBuiltInVariablesRevertTypeEnum] = field(default=None, metadata={'query_param': { 'field_name': 'type', 'style': 'form', 'explode': True }})
    upload_type: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'uploadType', 'style': 'form', 'explode': True }})
    upload_protocol: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'upload_protocol', 'style': 'form', 'explode': True }})
    

@dataclass
class TagmanagerAccountsContainersWorkspacesBuiltInVariablesRevertSecurity:
...
class TagmanagerAccountsContainersWorkspacesBuiltInVariablesRevertRequest:
    path_params: TagmanagerAccountsContainersWorkspacesBuiltInVariablesRevertPathParams = field(default=None)
    query_params: TagmanagerAccountsContainersWorkspacesBuiltInVariablesRevertQueryParams = field(default=None)
    security: TagmanagerAccountsContainersWorkspacesBuiltInVariablesRevertSecurity = field(default=None)
    

@dataclass
class TagmanagerAccountsContainersWorkspacesBuiltInVariablesRevertResponse:
    content_type: str = field(default=None)
    revert_built_in_variable_response: Optional[shared.RevertBuiltInVariableResponse] = field(default=None)
