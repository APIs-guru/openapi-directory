...
from . import variableformatvalue
...
class Variable:
    ...
    format_value: Optional[variableformatvalue.VariableFormatValue] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'formatValue' }})
