...
@dataclass
class TagmanagerAccountsContainersWorkspacesBuiltInVariablesCreatePathParams:
...
@dataclass
class TagmanagerAccountsContainersWorkspacesBuiltInVariablesCreateQueryParams:
    ...
    type: Optional[List[TagmanagerAccountsContainersWorkspacesBuiltInVariablesCreateTypeEnum]] = field(default=None, metadata={'query_param': { 'field_name': 'type', 'style': 'form', 'explode': True }})
...
class TagmanagerAccountsContainersWorkspacesBuiltInVariablesCreateRequest:
    path_params: TagmanagerAccountsContainersWorkspacesBuiltInVariablesCreatePathParams = field(default=None)
    query_params: TagmanagerAccountsContainersWorkspacesBuiltInVariablesCreateQueryParams = field(default=None)
    security: TagmanagerAccountsContainersWorkspacesBuiltInVariablesCreateSecurity = field(default=None)
    

@dataclass
class TagmanagerAccountsContainersWorkspacesBuiltInVariablesCreateResponse:
    content_type: str = field(default=None)
    create_built_in_variable_response: Optional[shared.CreateBuiltInVariableResponse] = field(default=None)
