...
class TagmanagerAccountsContainersWorkspacesBuiltInVariablesCreateRequest:
    path_params: TagmanagerAccountsContainersWorkspacesBuiltInVariablesCreatePathParams = field()
    query_params: TagmanagerAccountsContainersWorkspacesBuiltInVariablesCreateQueryParams = field()
    security: TagmanagerAccountsContainersWorkspacesBuiltInVariablesCreateSecurity = field()
