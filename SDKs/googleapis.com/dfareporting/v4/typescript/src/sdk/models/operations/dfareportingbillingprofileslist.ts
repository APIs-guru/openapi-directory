...
export class DfareportingBillingProfilesListQueryParams extends SpeakeasyBase {
  ...
  @Metadata({ data: "queryParam, style=form;explode=true;name=currency_code" })
  currencyCode?: string;
  ...
  @Metadata({ data: "queryParam, style=form;explode=true;name=onlySuggestion" })
  ...
  @Metadata({ data: "queryParam, style=form;explode=true;name=subaccountIds" })
