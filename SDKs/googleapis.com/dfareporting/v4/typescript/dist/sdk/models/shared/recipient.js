...
export var RecipientDeliveryTypeEnum;
(function (RecipientDeliveryTypeEnum) {
    RecipientDeliveryTypeEnum["Link"] = "LINK";
    RecipientDeliveryTypeEnum["Attachment"] = "ATTACHMENT";
})(RecipientDeliveryTypeEnum || (RecipientDeliveryTypeEnum = {}));
// Recipient
/**
...
var Recipient = /** @class */ (function (_super) {
    ...
    ], Recipient.prototype, "deliveryType", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], Recipient.prototype, "kind", void 0);
    return Recipient;
}(SpeakeasyBase));
export { Recipient };
