...
var Creatives = /** @class */ (function () {
    ...
    **/
    Creatives.prototype.dfareportingCreativesGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DfareportingCreativesGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/userprofiles/{profileId}/creatives/{id}", req.pathParams);
    ...
    **/
    Creatives.prototype.dfareportingCreativesInsert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DfareportingCreativesInsertRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/userprofiles/{profileId}/creatives", req.pathParams);
    ...
    **/
    Creatives.prototype.dfareportingCreativesList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.creativesListResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Creatives.prototype.dfareportingCreativesPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Creatives.prototype.dfareportingCreativesUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
