...
var AdvertiserGroups = /** @class */ (function () {
    function AdvertiserGroups(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    AdvertiserGroups.prototype.dfareportingAdvertiserGroupsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DfareportingAdvertiserGroupsDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/userprofiles/{profileId}/advertiserGroups/{id}", req.pathParams);
    ...
    **/
    AdvertiserGroups.prototype.dfareportingAdvertiserGroupsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.advertiserGroup = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    AdvertiserGroups.prototype.dfareportingAdvertiserGroupsInsert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DfareportingAdvertiserGroupsInsertRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/userprofiles/{profileId}/advertiserGroups", req.pathParams);
    ...
    **/
    AdvertiserGroups.prototype.dfareportingAdvertiserGroupsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.advertiserGroupsListResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    AdvertiserGroups.prototype.dfareportingAdvertiserGroupsPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    AdvertiserGroups.prototype.dfareportingAdvertiserGroupsUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
