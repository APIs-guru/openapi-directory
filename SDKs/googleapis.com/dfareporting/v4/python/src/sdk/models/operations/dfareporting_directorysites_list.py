...
class DfareportingDirectorySitesListRequest:
    path_params: DfareportingDirectorySitesListPathParams = field(default=None)
    query_params: DfareportingDirectorySitesListQueryParams = field(default=None)
    security: DfareportingDirectorySitesListSecurity = field(default=None)
