...
@dataclass
class DfareportingCreativeFieldValuesListQueryParams:
    ...
    sort_field: Optional[DfareportingCreativeFieldValuesListSortFieldEnum] = field(default=None, metadata={'query_param': { 'field_name': 'sortField', 'style': 'form', 'explode': True }})
    sort_order: Optional[DfareportingCreativeFieldValuesListSortOrderEnum] = field(default=None, metadata={'query_param': { 'field_name': 'sortOrder', 'style': 'form', 'explode': True }})
