...
class DfareportingFloodlightActivityGroupsListQueryParams:
    ...
    sort_field: Optional[DfareportingFloodlightActivityGroupsListSortFieldEnum] = field(default=None, metadata={'query_param': { 'field_name': 'sortField', 'style': 'form', 'explode': True }})
    sort_order: Optional[DfareportingFloodlightActivityGroupsListSortOrderEnum] = field(default=None, metadata={'query_param': { 'field_name': 'sortOrder', 'style': 'form', 'explode': True }})
    type: Optional[DfareportingFloodlightActivityGroupsListTypeEnum] = field(default=None, metadata={'query_param': { 'field_name': 'type', 'style': 'form', 'explode': True }})
