...
from . import dimensionvalue
from . import measurementpartneradvertiserlink
...
class Advertiser:
    ...
    measurement_partner_link: Optional[measurementpartneradvertiserlink.MeasurementPartnerAdvertiserLink] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'measurementPartnerLink' }})
