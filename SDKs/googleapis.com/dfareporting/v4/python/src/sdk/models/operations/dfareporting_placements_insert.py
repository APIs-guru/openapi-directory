...
class DfareportingPlacementsInsertRequest:
    path_params: DfareportingPlacementsInsertPathParams = field()
    query_params: DfareportingPlacementsInsertQueryParams = field()
    security: DfareportingPlacementsInsertSecurity = field()
