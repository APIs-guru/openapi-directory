...
class DfareportingAdvertiserLandingPagesListRequest:
    path_params: DfareportingAdvertiserLandingPagesListPathParams = field()
    query_params: DfareportingAdvertiserLandingPagesListQueryParams = field()
    security: DfareportingAdvertiserLandingPagesListSecurity = field()
