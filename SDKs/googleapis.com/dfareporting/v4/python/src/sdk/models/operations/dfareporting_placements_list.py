...
class DfareportingPlacementsListQueryParams:
    ...
    active_status: Optional[List[DfareportingPlacementsListActiveStatusEnum]] = field(default=None, metadata={'query_param': { 'field_name': 'activeStatus', 'style': 'form', 'explode': True }})
