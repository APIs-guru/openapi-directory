...
type ReportPathAttributionCriteria struct {
	...
	CustomChannelGrouping *ChannelGrouping  `json:"customChannelGrouping"`
	DateRange             *DateRange        `json:"dateRange"`
	Dimensions            []SortedDimension `json:"dimensions"`
	FloodlightConfigID    *DimensionValue   `json:"floodlightConfigId"`
	MetricNames           []string          `json:"metricNames"`
...
type Report struct {
	...
	PathAttributionCriteria     *ReportPathAttributionCriteria     `json:"pathAttributionCriteria"`
	PathCriteria                *ReportPathCriteria                `json:"pathCriteria"`
