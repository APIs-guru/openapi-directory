...
func (s *SDK) DfareportingAdvertiserInvoicesList(ctx context.Context, request operations.DfareportingAdvertiserInvoicesListRequest) (*operations.DfareportingAdvertiserInvoicesListResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) DfareportingBillingAssignmentsInsert(ctx context.Context, request operations.DfareportingBillingAssignmentsInsertRequest) (*operations.DfareportingBillingAssignmentsInsertResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) DfareportingBillingAssignmentsList(ctx context.Context, request operations.DfareportingBillingAssignmentsListRequest) (*operations.DfareportingBillingAssignmentsListResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/userprofiles/{profileId}/billingProfiles/{billingProfileId}/billingAssignments", request.PathParams)
...
func (s *SDK) DfareportingBillingProfilesGet(ctx context.Context, request operations.DfareportingBillingProfilesGetRequest) (*operations.DfareportingBillingProfilesGetResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) DfareportingBillingProfilesList(ctx context.Context, request operations.DfareportingBillingProfilesListRequest) (*operations.DfareportingBillingProfilesListResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) DfareportingBillingProfilesUpdate(ctx context.Context, request operations.DfareportingBillingProfilesUpdateRequest) (*operations.DfareportingBillingProfilesUpdateResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/userprofiles/{profileId}/billingProfiles", request.PathParams)
...
func (s *SDK) DfareportingBillingRatesList(ctx context.Context, request operations.DfareportingBillingRatesListRequest) (*operations.DfareportingBillingRatesListResponse, error) {
	baseURL := s.serverURL
