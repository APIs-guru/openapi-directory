...
var Browser = /** @class */ (function (_super) {
    ...
    ], Browser.prototype, "browserVersionId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=dartId" }),
        __metadata("design:type", String)
    ], Browser.prototype, "dartId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=kind" }),
        __metadata("design:type", String)
    ], Browser.prototype, "kind", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=majorVersion" }),
        __metadata("design:type", String)
    ], Browser.prototype, "majorVersion", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=minorVersion" }),
        __metadata("design:type", String)
    ], Browser.prototype, "minorVersion", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=name" }),
        __metadata("design:type", String)
    ], Browser.prototype, "name", void 0);
    return Browser;
}(SpeakeasyBase));
export { Browser };
