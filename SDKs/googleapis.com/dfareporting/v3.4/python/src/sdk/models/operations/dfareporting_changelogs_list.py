...
class DfareportingChangeLogsListRequest:
    path_params: DfareportingChangeLogsListPathParams = field()
    query_params: DfareportingChangeLogsListQueryParams = field()
    security: DfareportingChangeLogsListSecurity = field()
