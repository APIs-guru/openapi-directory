...
class DfareportingFloodlightActivitiesListRequest:
    path_params: DfareportingFloodlightActivitiesListPathParams = field(default=None)
    query_params: DfareportingFloodlightActivitiesListQueryParams = field(default=None)
    security: DfareportingFloodlightActivitiesListSecurity = field(default=None)
