...
class DfareportingAdvertiserGroupsListRequest:
    path_params: DfareportingAdvertiserGroupsListPathParams = field()
    query_params: DfareportingAdvertiserGroupsListQueryParams = field()
    security: DfareportingAdvertiserGroupsListSecurity = field()
