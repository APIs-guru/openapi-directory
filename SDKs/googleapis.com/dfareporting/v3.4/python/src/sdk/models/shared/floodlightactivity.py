...
class FloodlightActivity:
    ...
    attribution_enabled: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'attributionEnabled' }})
    ...
    status: Optional[FloodlightActivityStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
