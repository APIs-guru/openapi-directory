...
class DfareportingFloodlightActivitiesGeneratetagRequest:
    path_params: DfareportingFloodlightActivitiesGeneratetagPathParams = field(default=None)
    query_params: DfareportingFloodlightActivitiesGeneratetagQueryParams = field(default=None)
    security: DfareportingFloodlightActivitiesGeneratetagSecurity = field(default=None)
