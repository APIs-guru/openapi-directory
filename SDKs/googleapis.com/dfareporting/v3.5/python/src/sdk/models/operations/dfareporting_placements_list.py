...
class DfareportingPlacementsListRequest:
    path_params: DfareportingPlacementsListPathParams = field(default=None)
    query_params: DfareportingPlacementsListQueryParams = field(default=None)
    security: DfareportingPlacementsListSecurity = field(default=None)
