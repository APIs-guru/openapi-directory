...
class DfareportingSubaccountsPatchRequest:
    path_params: DfareportingSubaccountsPatchPathParams = field()
    query_params: DfareportingSubaccountsPatchQueryParams = field()
    security: DfareportingSubaccountsPatchSecurity = field()
