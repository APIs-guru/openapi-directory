...
class DfareportingAdvertiserLandingPagesPatchRequest:
    path_params: DfareportingAdvertiserLandingPagesPatchPathParams = field()
    query_params: DfareportingAdvertiserLandingPagesPatchQueryParams = field()
    security: DfareportingAdvertiserLandingPagesPatchSecurity = field()
