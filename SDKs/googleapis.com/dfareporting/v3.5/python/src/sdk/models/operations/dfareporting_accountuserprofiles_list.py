...
@dataclass
class DfareportingAccountUserProfilesListQueryParams:
    ...
    sort_field: Optional[DfareportingAccountUserProfilesListSortFieldEnum] = field(default=None, metadata={'query_param': { 'field_name': 'sortField', 'style': 'form', 'explode': True }})
    sort_order: Optional[DfareportingAccountUserProfilesListSortOrderEnum] = field(default=None, metadata={'query_param': { 'field_name': 'sortOrder', 'style': 'form', 'explode': True }})
    ...
    user_role_id: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'userRoleId', 'style': 'form', 'explode': True }})
