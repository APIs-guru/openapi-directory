...
class DfareportingTargetingTemplatesListQueryParams:
    ...
    sort_field: Optional[DfareportingTargetingTemplatesListSortFieldEnum] = field(default=None, metadata={'query_param': { 'field_name': 'sortField', 'style': 'form', 'explode': True }})
    sort_order: Optional[DfareportingTargetingTemplatesListSortOrderEnum] = field(default=None, metadata={'query_param': { 'field_name': 'sortOrder', 'style': 'form', 'explode': True }})
