...
var Sites = /** @class */ (function () {
    ...
    **/
    Sites.prototype.dfareportingSitesGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DfareportingSitesGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/userprofiles/{profileId}/sites/{id}", req.pathParams);
    ...
    **/
    Sites.prototype.dfareportingSitesInsert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DfareportingSitesInsertRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/userprofiles/{profileId}/sites", req.pathParams);
    ...
    **/
    Sites.prototype.dfareportingSitesList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Sites.prototype.dfareportingSitesPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Sites.prototype.dfareportingSitesUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
