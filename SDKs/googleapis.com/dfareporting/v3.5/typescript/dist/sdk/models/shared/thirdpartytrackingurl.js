...
export var ThirdPartyTrackingUrlThirdPartyUrlTypeEnum;
(function (ThirdPartyTrackingUrlThirdPartyUrlTypeEnum) {
...
})(ThirdPartyTrackingUrlThirdPartyUrlTypeEnum || (ThirdPartyTrackingUrlThirdPartyUrlTypeEnum = {}));
// ThirdPartyTrackingUrl
/**
 * Third-party Tracking URL.
**/
var ThirdPartyTrackingUrl = /** @class */ (function (_super) {
    __extends(ThirdPartyTrackingUrl, _super);
    function ThirdPartyTrackingUrl() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=thirdPartyUrlType" }),
        __metadata("design:type", String)
    ], ThirdPartyTrackingUrl.prototype, "thirdPartyUrlType", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=url" }),
        __metadata("design:type", String)
    ], ThirdPartyTrackingUrl.prototype, "url", void 0);
    return ThirdPartyTrackingUrl;
}(SpeakeasyBase));
export { ThirdPartyTrackingUrl };
