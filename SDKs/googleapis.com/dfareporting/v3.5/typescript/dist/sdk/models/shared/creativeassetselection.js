...
**/
var CreativeAssetSelection = /** @class */ (function (_super) {
    __extends(CreativeAssetSelection, _super);
    function CreativeAssetSelection() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=defaultAssetId" }),
        __metadata("design:type", String)
    ], CreativeAssetSelection.prototype, "defaultAssetId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=rules", elemType: Rule }),
        __metadata("design:type", Array)
    ], CreativeAssetSelection.prototype, "rules", void 0);
    return CreativeAssetSelection;
}(SpeakeasyBase));
export { CreativeAssetSelection };
