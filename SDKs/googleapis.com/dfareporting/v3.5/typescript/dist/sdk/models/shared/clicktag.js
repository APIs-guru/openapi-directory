 ...
 * Creative Click Tag.
**/
var ClickTag = /** @class */ (function (_super) {
    __extends(ClickTag, _super);
    function ClickTag() {
    ...
    ], ClickTag.prototype, "clickThroughUrl", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=eventName" }),
        __metadata("design:type", String)
    ], ClickTag.prototype, "eventName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=name" }),
        __metadata("design:type", String)
    ], ClickTag.prototype, "name", void 0);
    return ClickTag;
}(SpeakeasyBase));
export { ClickTag };
