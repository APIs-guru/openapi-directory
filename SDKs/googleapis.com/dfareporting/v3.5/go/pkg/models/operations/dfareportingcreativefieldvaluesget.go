...
type DfareportingCreativeFieldValuesGetPathParams struct {
...
type DfareportingCreativeFieldValuesGetQueryParams struct {
...
type DfareportingCreativeFieldValuesGetSecurity struct {
    Oauth2 shared.SchemeOauth2 `security:"scheme,type=oauth2"`
    Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
    
}

type DfareportingCreativeFieldValuesGetRequest struct {
...
type DfareportingCreativeFieldValuesGetResponse struct {
    ContentType string 
