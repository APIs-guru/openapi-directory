...
var CreativeFieldValues = /** @class */ (function () {
    ...
    **/
    CreativeFieldValues.prototype.dfareportingCreativeFieldValuesDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DfareportingCreativeFieldValuesDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/userprofiles/{profileId}/creativeFields/{creativeFieldId}/creativeFieldValues/{id}", req.pathParams);
    ...
    **/
    CreativeFieldValues.prototype.dfareportingCreativeFieldValuesGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.creativeFieldValue = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    CreativeFieldValues.prototype.dfareportingCreativeFieldValuesInsert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DfareportingCreativeFieldValuesInsertRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/userprofiles/{profileId}/creativeFields/{creativeFieldId}/creativeFieldValues", req.pathParams);
    ...
    **/
    CreativeFieldValues.prototype.dfareportingCreativeFieldValuesList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.creativeFieldValuesListResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    CreativeFieldValues.prototype.dfareportingCreativeFieldValuesPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    CreativeFieldValues.prototype.dfareportingCreativeFieldValuesUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
