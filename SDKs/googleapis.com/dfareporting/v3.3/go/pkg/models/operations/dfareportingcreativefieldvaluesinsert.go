...
type DfareportingCreativeFieldValuesInsertPathParams struct {
	CreativeFieldID string `pathParam:"style=simple,explode=false,name=creativeFieldId"`
	ProfileID       string `pathParam:"style=simple,explode=false,name=profileId"`
}

type DfareportingCreativeFieldValuesInsertQueryParams struct {
...
type DfareportingCreativeFieldValuesInsertSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DfareportingCreativeFieldValuesInsertRequest struct {
...
type DfareportingCreativeFieldValuesInsertResponse struct {
	ContentType        string
