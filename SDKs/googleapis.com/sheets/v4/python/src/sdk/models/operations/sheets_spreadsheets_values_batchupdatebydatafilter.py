...
class SheetsSpreadsheetsValuesBatchUpdateByDataFilterRequest:
    path_params: SheetsSpreadsheetsValuesBatchUpdateByDataFilterPathParams = field()
    query_params: SheetsSpreadsheetsValuesBatchUpdateByDataFilterQueryParams = field()
    security: SheetsSpreadsheetsValuesBatchUpdateByDataFilterSecurity = field()
