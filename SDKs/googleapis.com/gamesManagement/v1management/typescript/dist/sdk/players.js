...
var Players = /** @class */ (function () {
    ...
    **/
    Players.prototype.gamesManagementPlayersHide = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GamesManagementPlayersHideRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/games/v1management/applications/{applicationId}/players/hidden/{playerId}", req.pathParams);
    ...
    **/
    Players.prototype.gamesManagementPlayersUnhide = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
