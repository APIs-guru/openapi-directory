...
type GamesManagementScoresResetPathParams struct {
    LeaderboardID string `pathParam:"style=simple,explode=false,name=leaderboardId"`
    
}

type GamesManagementScoresResetQueryParams struct {
...
type GamesManagementScoresResetSecurity struct {
    Oauth2 shared.SchemeOauth2 `security:"scheme,type=oauth2"`
    Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
    
}

type GamesManagementScoresResetRequest struct {
...
type GamesManagementScoresResetResponse struct {
    ContentType string 
