...
var V1beta1 = /** @class */ (function () {
    ...
    **/
    V1beta1.prototype.iapGetIamPolicy = function (req, config) {
        var _a;
    ...
    **/
    V1beta1.prototype.iapSetIamPolicy = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    V1beta1.prototype.iapTestIamPermissions = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
