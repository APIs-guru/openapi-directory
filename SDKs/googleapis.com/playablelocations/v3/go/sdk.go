...
func (s *SDK) PlayablelocationsLogImpressions(ctx context.Context, request operations.PlayablelocationsLogImpressionsRequest) (*operations.PlayablelocationsLogImpressionsResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) PlayablelocationsLogPlayerReports(ctx context.Context, request operations.PlayablelocationsLogPlayerReportsRequest) (*operations.PlayablelocationsLogPlayerReportsResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) PlayablelocationsSamplePlayableLocations(ctx context.Context, request operations.PlayablelocationsSamplePlayableLocationsRequest) (*operations.PlayablelocationsSamplePlayableLocationsResponse, error) {
	baseURL := s.serverURL
