...
class AnalyticshubProjectsLocationsDataExchangesCreateRequest:
    path_params: AnalyticshubProjectsLocationsDataExchangesCreatePathParams = field()
    query_params: AnalyticshubProjectsLocationsDataExchangesCreateQueryParams = field()
    security: AnalyticshubProjectsLocationsDataExchangesCreateSecurity = field()
    request: Optional[shared.DataExchangeInput] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
