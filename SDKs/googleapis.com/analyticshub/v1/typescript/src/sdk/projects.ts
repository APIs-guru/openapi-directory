...
export class Projects {
  ...
  **/
  analyticshubProjectsLocationsDataExchangesCreate(
    ...
    const url: string = utils.GenerateURL(baseURL, "/v1/{parent}/dataExchanges", req.pathParams);
  ...
  **/
  analyticshubProjectsLocationsDataExchangesListingsCreate(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{parent}/listings", req.pathParams);
