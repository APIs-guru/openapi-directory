...
var Projects = /** @class */ (function () {
    ...
    **/
    Projects.prototype.analyticshubProjectsLocationsDataExchangesCreate = function (req, config) {
        ...
        var url = utils.GenerateURL(baseURL, "/v1beta1/{parent}/dataExchanges", req.pathParams);
    ...
    **/
    Projects.prototype.analyticshubProjectsLocationsDataExchangesListingsCreate = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta1/{parent}/listings", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    Projects.prototype.analyticshubProjectsLocationsDataExchangesListingsSubscribe = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta1/{name}:subscribe", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
