...
@dataclass
class AnalyticshubProjectsLocationsDataExchangesListingsGetIamPolicyQueryParams:
...
@dataclass
class AnalyticshubProjectsLocationsDataExchangesListingsGetIamPolicySecurity:
    option1: Optional[AnalyticshubProjectsLocationsDataExchangesListingsGetIamPolicySecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AnalyticshubProjectsLocationsDataExchangesListingsGetIamPolicySecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
