...
class GoogleCloudApigeeV1DeveloperAppKey:
    api_products: Optional[List[Any]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('apiProducts') }})
    ...
    expires_in_seconds: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('expiresInSeconds') }})
