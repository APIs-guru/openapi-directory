...
class ApigeeOrganizationsDevelopersBalanceCreditRequest:
    path_params: ApigeeOrganizationsDevelopersBalanceCreditPathParams = field()
    query_params: ApigeeOrganizationsDevelopersBalanceCreditQueryParams = field()
    security: ApigeeOrganizationsDevelopersBalanceCreditSecurity = field()
