...
class ApigeeOrganizationsDevelopersBalanceAdjustRequest:
    path_params: ApigeeOrganizationsDevelopersBalanceAdjustPathParams = field(default=None)
    query_params: ApigeeOrganizationsDevelopersBalanceAdjustQueryParams = field(default=None)
    ...
    security: ApigeeOrganizationsDevelopersBalanceAdjustSecurity = field(default=None)
