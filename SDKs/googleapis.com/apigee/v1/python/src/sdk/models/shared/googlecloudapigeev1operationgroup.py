...
class GoogleCloudApigeeV1OperationGroup:
    r"""GoogleCloudApigeeV1OperationGroup
    ...
    operation_configs: Optional[List[GoogleCloudApigeeV1OperationConfig]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('operationConfigs') }})
