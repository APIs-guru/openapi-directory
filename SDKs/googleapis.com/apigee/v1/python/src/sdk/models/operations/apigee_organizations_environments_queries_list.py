...
class ApigeeOrganizationsEnvironmentsQueriesListRequest:
    path_params: ApigeeOrganizationsEnvironmentsQueriesListPathParams = field()
    query_params: ApigeeOrganizationsEnvironmentsQueriesListQueryParams = field()
    security: ApigeeOrganizationsEnvironmentsQueriesListSecurity = field()
