...
class GoogleCloudApigeeV1SecurityReport:
    r"""GoogleCloudApigeeV1SecurityReport
    ...
    query_params: Optional[GoogleCloudApigeeV1SecurityReportMetadata] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('queryParams') }})
    ...
    result: Optional[GoogleCloudApigeeV1SecurityReportResultMetadata] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('result') }})
