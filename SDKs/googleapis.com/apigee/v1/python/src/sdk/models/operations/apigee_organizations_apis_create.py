...
class ApigeeOrganizationsApisCreateRequest:
    path_params: ApigeeOrganizationsApisCreatePathParams = field()
    query_params: ApigeeOrganizationsApisCreateQueryParams = field()
    security: ApigeeOrganizationsApisCreateSecurity = field()
