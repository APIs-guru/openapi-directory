...
from . import googlecloudapigeev1operation
...
class GoogleCloudApigeeV1OperationConfig:
    ...
    operations: Optional[List[googlecloudapigeev1operation.GoogleCloudApigeeV1Operation]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'operations' }})
