...
class ApigeeOrganizationsHostSecurityReportsListRequest:
    path_params: ApigeeOrganizationsHostSecurityReportsListPathParams = field()
    query_params: ApigeeOrganizationsHostSecurityReportsListQueryParams = field()
    security: ApigeeOrganizationsHostSecurityReportsListSecurity = field()
