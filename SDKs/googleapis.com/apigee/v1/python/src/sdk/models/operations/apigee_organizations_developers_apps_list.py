...
class ApigeeOrganizationsDevelopersAppsListRequest:
    path_params: ApigeeOrganizationsDevelopersAppsListPathParams = field()
    query_params: ApigeeOrganizationsDevelopersAppsListQueryParams = field()
    security: ApigeeOrganizationsDevelopersAppsListSecurity = field()
