...
class ApigeeOrganizationsHostQueriesListRequest:
    path_params: ApigeeOrganizationsHostQueriesListPathParams = field(default=None)
    query_params: ApigeeOrganizationsHostQueriesListQueryParams = field(default=None)
    security: ApigeeOrganizationsHostQueriesListSecurity = field(default=None)
