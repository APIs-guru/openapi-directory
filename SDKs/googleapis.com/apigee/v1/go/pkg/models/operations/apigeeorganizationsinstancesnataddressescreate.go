...
type ApigeeOrganizationsInstancesNatAddressesCreatePathParams struct {
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type ApigeeOrganizationsInstancesNatAddressesCreateQueryParams struct {
...
type ApigeeOrganizationsInstancesNatAddressesCreateSecurity struct {
...
type ApigeeOrganizationsInstancesNatAddressesCreateResponse struct {
	ContentType                string
