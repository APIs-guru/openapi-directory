...
type ApigeeOrganizationsInstancesCanaryevaluationsCreatePathParams struct {
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type ApigeeOrganizationsInstancesCanaryevaluationsCreateQueryParams struct {
...
type ApigeeOrganizationsInstancesCanaryevaluationsCreateSecurity struct {
...
type ApigeeOrganizationsInstancesCanaryevaluationsCreateResponse struct {
	ContentType                string
