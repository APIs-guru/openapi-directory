...
type ApigeeOrganizationsEnvironmentsGetIamPolicyPathParams struct {
    Resource string `pathParam:"style=simple,explode=false,name=resource"`
    
}

type ApigeeOrganizationsEnvironmentsGetIamPolicyQueryParams struct {
...
type ApigeeOrganizationsEnvironmentsGetIamPolicySecurity struct {
    Oauth2 shared.SchemeOauth2 `security:"scheme,type=oauth2"`
    Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
    
}

type ApigeeOrganizationsEnvironmentsGetIamPolicyRequest struct {
...
type ApigeeOrganizationsEnvironmentsGetIamPolicyResponse struct {
    ContentType string 
