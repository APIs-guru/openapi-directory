...
type ApigeeOrganizationsEnvironmentsTestIamPermissionsPathParams struct {
    Resource string `pathParam:"style=simple,explode=false,name=resource"`
    
}

type ApigeeOrganizationsEnvironmentsTestIamPermissionsQueryParams struct {
...
type ApigeeOrganizationsEnvironmentsTestIamPermissionsSecurity struct {
    Oauth2 shared.SchemeOauth2 `security:"scheme,type=oauth2"`
    Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
    
}

type ApigeeOrganizationsEnvironmentsTestIamPermissionsRequest struct {
...
type ApigeeOrganizationsEnvironmentsTestIamPermissionsResponse struct {
    ContentType string 
