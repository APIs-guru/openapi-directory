...
type ApigeeOrganizationsListPathParams struct {
    Parent string `pathParam:"style=simple,explode=false,name=parent"`
    
}

type ApigeeOrganizationsListQueryParams struct {
...
type ApigeeOrganizationsListSecurity struct {
    Oauth2 shared.SchemeOauth2 `security:"scheme,type=oauth2"`
    Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
    
}

type ApigeeOrganizationsListRequest struct {
...
type ApigeeOrganizationsListResponse struct {
    ContentType string 
