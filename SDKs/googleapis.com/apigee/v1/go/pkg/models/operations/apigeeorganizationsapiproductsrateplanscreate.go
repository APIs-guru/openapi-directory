...
type ApigeeOrganizationsApiproductsRateplansCreatePathParams struct {
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type ApigeeOrganizationsApiproductsRateplansCreateQueryParams struct {
...
type ApigeeOrganizationsApiproductsRateplansCreateSecurity struct {
...
type ApigeeOrganizationsApiproductsRateplansCreateResponse struct {
	ContentType                 string
