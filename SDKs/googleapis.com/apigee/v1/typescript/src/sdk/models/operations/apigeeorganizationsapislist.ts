...
export class ApigeeOrganizationsApisListPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=parent" })
  parent: string;
}


export class ApigeeOrganizationsApisListQueryParams extends SpeakeasyBase {
...
export class ApigeeOrganizationsApisListSecurity extends SpeakeasyBase {
...
export class ApigeeOrganizationsApisListRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class ApigeeOrganizationsApisListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
