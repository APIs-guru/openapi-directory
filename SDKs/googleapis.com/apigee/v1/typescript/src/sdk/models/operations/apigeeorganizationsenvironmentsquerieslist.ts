...
export class ApigeeOrganizationsEnvironmentsQueriesListPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=parent" })
  parent: string;
}


export class ApigeeOrganizationsEnvironmentsQueriesListQueryParams extends SpeakeasyBase {
...
export class ApigeeOrganizationsEnvironmentsQueriesListSecurity extends SpeakeasyBase {
...
export class ApigeeOrganizationsEnvironmentsQueriesListRequest extends SpeakeasyBase {
  @Metadata()
...
export class ApigeeOrganizationsEnvironmentsQueriesListResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
