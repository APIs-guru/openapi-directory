...
export class GoogleCloudApigeeV1DeploymentChangeReport extends SpeakeasyBase {
  @Metadata({ data: "json, name=routingChanges", elemType: shared.GoogleCloudApigeeV1DeploymentChangeReportRoutingChange })
  routingChanges?: GoogleCloudApigeeV1DeploymentChangeReportRoutingChange[];

  @Metadata({ data: "json, name=routingConflicts", elemType: shared.GoogleCloudApigeeV1DeploymentChangeReportRoutingConflict })
