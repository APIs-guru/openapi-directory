...
**/
var GoogleRpcPreconditionFailure = /** @class */ (function (_super) {
    __extends(GoogleRpcPreconditionFailure, _super);
    function GoogleRpcPreconditionFailure() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=violations", elemType: GoogleRpcPreconditionFailureViolation }),
        __metadata("design:type", Array)
    ], GoogleRpcPreconditionFailure.prototype, "violations", void 0);
    return GoogleRpcPreconditionFailure;
}(SpeakeasyBase));
export { GoogleRpcPreconditionFailure };
