...
**/
var GoogleCloudApigeeV1OperationGroup = /** @class */ (function (_super) {
    __extends(GoogleCloudApigeeV1OperationGroup, _super);
    function GoogleCloudApigeeV1OperationGroup() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=operationConfigType" }),
        __metadata("design:type", String)
    ], GoogleCloudApigeeV1OperationGroup.prototype, "operationConfigType", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=operationConfigs", elemType: GoogleCloudApigeeV1OperationConfig }),
        __metadata("design:type", Array)
    ], GoogleCloudApigeeV1OperationGroup.prototype, "operationConfigs", void 0);
    return GoogleCloudApigeeV1OperationGroup;
}(SpeakeasyBase));
export { GoogleCloudApigeeV1OperationGroup };
