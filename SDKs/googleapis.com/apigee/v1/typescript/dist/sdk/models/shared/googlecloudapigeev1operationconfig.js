...
**/
var GoogleCloudApigeeV1OperationConfig = /** @class */ (function (_super) {
    __extends(GoogleCloudApigeeV1OperationConfig, _super);
    function GoogleCloudApigeeV1OperationConfig() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=apiSource" }),
        __metadata("design:type", String)
    ], GoogleCloudApigeeV1OperationConfig.prototype, "apiSource", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=attributes", elemType: GoogleCloudApigeeV1Attribute }),
        __metadata("design:type", Array)
    ], GoogleCloudApigeeV1OperationConfig.prototype, "attributes", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=operations", elemType: GoogleCloudApigeeV1Operation }),
        __metadata("design:type", Array)
    ], GoogleCloudApigeeV1OperationConfig.prototype, "operations", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=quota" }),
        __metadata("design:type", GoogleCloudApigeeV1Quota)
    ], GoogleCloudApigeeV1OperationConfig.prototype, "quota", void 0);
    return GoogleCloudApigeeV1OperationConfig;
}(SpeakeasyBase));
export { GoogleCloudApigeeV1OperationConfig };
