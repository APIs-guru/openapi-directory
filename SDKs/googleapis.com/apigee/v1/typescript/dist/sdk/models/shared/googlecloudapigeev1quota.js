...
**/
var GoogleCloudApigeeV1Quota = /** @class */ (function (_super) {
    __extends(GoogleCloudApigeeV1Quota, _super);
    function GoogleCloudApigeeV1Quota() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=interval" }),
        __metadata("design:type", String)
    ], GoogleCloudApigeeV1Quota.prototype, "interval", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=limit" }),
        __metadata("design:type", String)
    ], GoogleCloudApigeeV1Quota.prototype, "limit", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=timeUnit" }),
        __metadata("design:type", String)
    ], GoogleCloudApigeeV1Quota.prototype, "timeUnit", void 0);
    return GoogleCloudApigeeV1Quota;
}(SpeakeasyBase));
export { GoogleCloudApigeeV1Quota };
