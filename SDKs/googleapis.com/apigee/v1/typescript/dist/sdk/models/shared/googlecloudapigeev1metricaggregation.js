...
export var GoogleCloudApigeeV1MetricAggregationAggregationEnum;
(function (GoogleCloudApigeeV1MetricAggregationAggregationEnum) {
...
})(GoogleCloudApigeeV1MetricAggregationAggregationEnum || (GoogleCloudApigeeV1MetricAggregationAggregationEnum = {}));
export var GoogleCloudApigeeV1MetricAggregationOrderEnum;
(function (GoogleCloudApigeeV1MetricAggregationOrderEnum) {
...
})(GoogleCloudApigeeV1MetricAggregationOrderEnum || (GoogleCloudApigeeV1MetricAggregationOrderEnum = {}));
// GoogleCloudApigeeV1MetricAggregation
/**
 * The optionally aggregated metric to query with its ordering.
**/
var GoogleCloudApigeeV1MetricAggregation = /** @class */ (function (_super) {
    __extends(GoogleCloudApigeeV1MetricAggregation, _super);
    function GoogleCloudApigeeV1MetricAggregation() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=aggregation" }),
        __metadata("design:type", String)
    ], GoogleCloudApigeeV1MetricAggregation.prototype, "aggregation", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=name" }),
        __metadata("design:type", String)
    ], GoogleCloudApigeeV1MetricAggregation.prototype, "name", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=order" }),
        __metadata("design:type", String)
    ], GoogleCloudApigeeV1MetricAggregation.prototype, "order", void 0);
    return GoogleCloudApigeeV1MetricAggregation;
}(SpeakeasyBase));
export { GoogleCloudApigeeV1MetricAggregation };
