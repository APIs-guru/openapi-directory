...
export var GoogleCloudApigeeV1UpdateErrorCodeEnum;
(function (GoogleCloudApigeeV1UpdateErrorCodeEnum) {
...
})(GoogleCloudApigeeV1UpdateErrorCodeEnum || (GoogleCloudApigeeV1UpdateErrorCodeEnum = {}));
// GoogleCloudApigeeV1UpdateError
/**
 * Details on why a resource update failed in the runtime.
**/
var GoogleCloudApigeeV1UpdateError = /** @class */ (function (_super) {
    __extends(GoogleCloudApigeeV1UpdateError, _super);
    function GoogleCloudApigeeV1UpdateError() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=code" }),
        __metadata("design:type", String)
    ], GoogleCloudApigeeV1UpdateError.prototype, "code", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=message" }),
        __metadata("design:type", String)
    ], GoogleCloudApigeeV1UpdateError.prototype, "message", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=resource" }),
        __metadata("design:type", String)
    ], GoogleCloudApigeeV1UpdateError.prototype, "resource", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=type" }),
        __metadata("design:type", String)
    ], GoogleCloudApigeeV1UpdateError.prototype, "type", void 0);
    return GoogleCloudApigeeV1UpdateError;
}(SpeakeasyBase));
export { GoogleCloudApigeeV1UpdateError };
