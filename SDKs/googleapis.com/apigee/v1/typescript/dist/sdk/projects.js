...
var Projects = /** @class */ (function () {
    ...
    **/
    Projects.prototype.apigeeProjectsProvisionOrganization = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ApigeeProjectsProvisionOrganizationRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{project}:provisionOrganization", req.pathParams);
