...
class DataprocProjectsRegionsClustersCreateQueryParams:
    ...
    action_on_failed_primary_workers: Optional[DataprocProjectsRegionsClustersCreateActionOnFailedPrimaryWorkersEnum] = field(default=None, metadata={'query_param': { 'field_name': 'actionOnFailedPrimaryWorkers', 'style': 'form', 'explode': True }})
