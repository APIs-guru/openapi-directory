 ...
 * Dataproc job config.
**/
var JobPlacement = /** @class */ (function (_super) {
    __extends(JobPlacement, _super);
 ...
 * Dataproc job config.
**/
var JobPlacementInput = /** @class */ (function (_super) {
    __extends(JobPlacementInput, _super);
    function JobPlacementInput() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=clusterLabels" }),
