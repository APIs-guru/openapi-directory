...
export var NodePoolRepairActionEnum;
(function (NodePoolRepairActionEnum) {
    NodePoolRepairActionEnum["RepairActionUnspecified"] = "REPAIR_ACTION_UNSPECIFIED";
    NodePoolRepairActionEnum["Delete"] = "DELETE";
})(NodePoolRepairActionEnum || (NodePoolRepairActionEnum = {}));
// NodePool
/**
...
var NodePool = /** @class */ (function (_super) {
    ...
    ], NodePool.prototype, "id", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=instanceNames" }),
        __metadata("design:type", Array)
    ], NodePool.prototype, "instanceNames", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=repairAction" }),
        __metadata("design:type", String)
    ], NodePool.prototype, "repairAction", void 0);
    return NodePool;
}(SpeakeasyBase));
export { NodePool };
