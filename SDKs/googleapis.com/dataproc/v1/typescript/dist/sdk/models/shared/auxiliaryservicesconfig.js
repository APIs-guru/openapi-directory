...
**/
var AuxiliaryServicesConfig = /** @class */ (function (_super) {
    __extends(AuxiliaryServicesConfig, _super);
    function AuxiliaryServicesConfig() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=metastoreConfig" }),
        __metadata("design:type", MetastoreConfig)
    ], AuxiliaryServicesConfig.prototype, "metastoreConfig", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=sparkHistoryServerConfig" }),
        __metadata("design:type", SparkHistoryServerConfig)
    ], AuxiliaryServicesConfig.prototype, "sparkHistoryServerConfig", void 0);
    return AuxiliaryServicesConfig;
}(SpeakeasyBase));
export { AuxiliaryServicesConfig };
