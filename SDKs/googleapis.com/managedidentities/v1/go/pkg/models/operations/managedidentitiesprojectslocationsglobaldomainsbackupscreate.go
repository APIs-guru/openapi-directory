...
type ManagedidentitiesProjectsLocationsGlobalDomainsBackupsCreatePathParams struct {
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type ManagedidentitiesProjectsLocationsGlobalDomainsBackupsCreateQueryParams struct {
...
type ManagedidentitiesProjectsLocationsGlobalDomainsBackupsCreateSecurity struct {
...
type ManagedidentitiesProjectsLocationsGlobalDomainsBackupsCreateResponse struct {
	ContentType string
