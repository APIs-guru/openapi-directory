...
export class SDK {
  ...
  ManagedidentitiesProjectsLocationsGlobalDomainsAttachTrust(
    ...
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{name}:attachTrust", req.pathParams);
  ...
  ManagedidentitiesProjectsLocationsGlobalDomainsBackupsCreate(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{parent}/backups", req.pathParams);
  ...
  ManagedidentitiesProjectsLocationsGlobalDomainsCheckMigrationPermission(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{domain}:checkMigrationPermission", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ManagedidentitiesProjectsLocationsGlobalDomainsCheckMigrationPermissionResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  ManagedidentitiesProjectsLocationsGlobalDomainsDetachTrust(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{name}:detachTrust", req.pathParams);
  ...
  ManagedidentitiesProjectsLocationsGlobalDomainsDisableMigration(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{domain}:disableMigration", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ManagedidentitiesProjectsLocationsGlobalDomainsDisableMigrationResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.operation = httpRes?.data;
  ...
  ManagedidentitiesProjectsLocationsGlobalDomainsEnableMigration(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{domain}:enableMigration", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ManagedidentitiesProjectsLocationsGlobalDomainsEnableMigrationResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.operation = httpRes?.data;
  ...
  ManagedidentitiesProjectsLocationsGlobalDomainsExtendSchema(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{domain}:extendSchema", req.pathParams);
  ...
  ManagedidentitiesProjectsLocationsGlobalDomainsGetLdapssettings(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{name}/ldapssettings", req.pathParams);
  ...
  ManagedidentitiesProjectsLocationsGlobalDomainsReconfigureTrust(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{name}:reconfigureTrust", req.pathParams);
  ...
  ManagedidentitiesProjectsLocationsGlobalDomainsResetAdminPassword(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{name}:resetAdminPassword", req.pathParams);
  ...
  ManagedidentitiesProjectsLocationsGlobalDomainsSqlIntegrationsList(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{parent}/sqlIntegrations", req.pathParams);
  ...
  ManagedidentitiesProjectsLocationsGlobalDomainsValidateTrust(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{name}:validateTrust", req.pathParams);
  ...
  ManagedidentitiesProjectsLocationsGlobalPeeringsCreate(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{parent}/peerings", req.pathParams);
