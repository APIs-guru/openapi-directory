...
export declare class ManagedidentitiesProjectsLocationsGlobalPeeringsPatchPathParams extends SpeakeasyBase {
    name: string;
}
export declare class ManagedidentitiesProjectsLocationsGlobalPeeringsPatchQueryParams extends SpeakeasyBase {
