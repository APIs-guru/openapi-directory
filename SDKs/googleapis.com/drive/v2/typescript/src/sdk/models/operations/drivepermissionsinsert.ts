...
export class DrivePermissionsInsertQueryParams extends SpeakeasyBase {
  ...
  @Metadata({ data: "queryParam, style=form;explode=true;name=emailMessage" })
  emailMessage?: string;
  ...
  @Metadata({ data: "queryParam, style=form;explode=true;name=moveToNewOwnersRoot" })
  ...
  @Metadata({ data: "queryParam, style=form;explode=true;name=sendNotificationEmails" })
