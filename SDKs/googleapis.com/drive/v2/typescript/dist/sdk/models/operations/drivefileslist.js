...
(function (DriveFilesListCorpusEnum) {
    DriveFilesListCorpusEnum["Default"] = "DEFAULT";
    DriveFilesListCorpusEnum["Domain"] = "DOMAIN";
})(DriveFilesListCorpusEnum || (DriveFilesListCorpusEnum = {}));
export var DriveFilesListProjectionEnum;
(function (DriveFilesListProjectionEnum) {
    DriveFilesListProjectionEnum["Basic"] = "BASIC";
    DriveFilesListProjectionEnum["Full"] = "FULL";
})(DriveFilesListProjectionEnum || (DriveFilesListProjectionEnum = {}));
var DriveFilesListQueryParams = /** @class */ (function (_super) {
    ...
    ], DriveFilesListQueryParams.prototype, "maxResults", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], DriveFilesListQueryParams.prototype, "projection", void 0);
    __decorate([
...
var DriveFilesListSecurityOption8 = /** @class */ (function (_super) {
    __extends(DriveFilesListSecurityOption8, _super);
    function DriveFilesListSecurityOption8() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "security, scheme=true;type=oauth2" }),
        __metadata("design:type", shared.SchemeOauth2)
    ], DriveFilesListSecurityOption8.prototype, "oauth2", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "security, scheme=true;type=oauth2" }),
        __metadata("design:type", shared.SchemeOauth2c)
    ], DriveFilesListSecurityOption8.prototype, "oauth2c", void 0);
    return DriveFilesListSecurityOption8;
}(SpeakeasyBase));
export { DriveFilesListSecurityOption8 };
var DriveFilesListSecurity = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata({ data: "security, option=true" }),
        __metadata("design:type", DriveFilesListSecurityOption8)
    ], DriveFilesListSecurity.prototype, "option8", void 0);
