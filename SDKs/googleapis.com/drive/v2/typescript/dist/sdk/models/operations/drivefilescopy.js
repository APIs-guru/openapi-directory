...
export var DriveFilesCopyVisibilityEnum;
(function (DriveFilesCopyVisibilityEnum) {
    DriveFilesCopyVisibilityEnum["Default"] = "DEFAULT";
    DriveFilesCopyVisibilityEnum["Private"] = "PRIVATE";
})(DriveFilesCopyVisibilityEnum || (DriveFilesCopyVisibilityEnum = {}));
var DriveFilesCopyQueryParams = /** @class */ (function (_super) {
    ...
    ], DriveFilesCopyQueryParams.prototype, "convert", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", Boolean)
    ], DriveFilesCopyQueryParams.prototype, "ocr", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", Boolean)
    ], DriveFilesCopyQueryParams.prototype, "pinned", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], DriveFilesCopyQueryParams.prototype, "timedTextLanguage", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=timedTextTrackName" }),
        __metadata("design:type", String)
    ], DriveFilesCopyQueryParams.prototype, "timedTextTrackName", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], DriveFilesCopyQueryParams.prototype, "visibility", void 0);
...
var DriveFilesCopySecurityOption5 = /** @class */ (function (_super) {
    __extends(DriveFilesCopySecurityOption5, _super);
    function DriveFilesCopySecurityOption5() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "security, scheme=true;type=oauth2" }),
        __metadata("design:type", shared.SchemeOauth2)
    ], DriveFilesCopySecurityOption5.prototype, "oauth2", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "security, scheme=true;type=oauth2" }),
        __metadata("design:type", shared.SchemeOauth2c)
    ], DriveFilesCopySecurityOption5.prototype, "oauth2c", void 0);
    return DriveFilesCopySecurityOption5;
}(SpeakeasyBase));
export { DriveFilesCopySecurityOption5 };
var DriveFilesCopySecurity = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata({ data: "security, option=true" }),
        __metadata("design:type", DriveFilesCopySecurityOption5)
    ], DriveFilesCopySecurity.prototype, "option5", void 0);
