...
class DriveRevisionsUpdateRequest:
    path_params: DriveRevisionsUpdatePathParams = field(default=None)
    query_params: DriveRevisionsUpdateQueryParams = field(default=None)
    request: Optional[shared.Revision] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: DriveRevisionsUpdateSecurity = field(default=None)
