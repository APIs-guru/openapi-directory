...
class DriveChangesGetStartPageTokenSecurity:
    ...
    option8: Optional[DriveChangesGetStartPageTokenSecurityOption8] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class DriveChangesGetStartPageTokenRequest:
    query_params: DriveChangesGetStartPageTokenQueryParams = field()
    security: DriveChangesGetStartPageTokenSecurity = field()
