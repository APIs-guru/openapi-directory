...
class DriveChildrenDeleteRequest:
    path_params: DriveChildrenDeletePathParams = field(default=None)
    query_params: DriveChildrenDeleteQueryParams = field(default=None)
    security: DriveChildrenDeleteSecurity = field(default=None)
