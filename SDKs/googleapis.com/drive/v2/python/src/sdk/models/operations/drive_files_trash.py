...
class DriveFilesTrashSecurity:
    option1: Optional[DriveFilesTrashSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DriveFilesTrashSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[DriveFilesTrashSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
    option4: Optional[DriveFilesTrashSecurityOption4] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class DriveFilesTrashRequest:
    path_params: DriveFilesTrashPathParams = field(default=None)
    query_params: DriveFilesTrashQueryParams = field(default=None)
    security: DriveFilesTrashSecurity = field(default=None)
