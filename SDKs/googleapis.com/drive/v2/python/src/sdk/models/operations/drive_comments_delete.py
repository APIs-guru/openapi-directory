...
class DriveCommentsDeleteRequest:
    path_params: DriveCommentsDeletePathParams = field(default=None)
    query_params: DriveCommentsDeleteQueryParams = field(default=None)
    security: DriveCommentsDeleteSecurity = field(default=None)
