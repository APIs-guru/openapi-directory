...
class DriveFilesTouchRequest:
    path_params: DriveFilesTouchPathParams = field(default=None)
    query_params: DriveFilesTouchQueryParams = field(default=None)
    security: DriveFilesTouchSecurity = field(default=None)
