...
class DriveFilesListLabelsRequest:
    path_params: DriveFilesListLabelsPathParams = field(default=None)
    query_params: DriveFilesListLabelsQueryParams = field(default=None)
    security: DriveFilesListLabelsSecurity = field(default=None)
