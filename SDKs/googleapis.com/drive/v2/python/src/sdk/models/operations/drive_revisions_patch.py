...
class DriveRevisionsPatchSecurity:
    option1: Optional[DriveRevisionsPatchSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DriveRevisionsPatchSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[DriveRevisionsPatchSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class DriveRevisionsPatchRequest:
    path_params: DriveRevisionsPatchPathParams = field(default=None)
    query_params: DriveRevisionsPatchQueryParams = field(default=None)
    request: Optional[shared.Revision] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: DriveRevisionsPatchSecurity = field(default=None)
