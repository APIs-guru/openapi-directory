...
class DrivePermissionsPatchSecurity:
    option1: Optional[DrivePermissionsPatchSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DrivePermissionsPatchSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class DrivePermissionsPatchRequest:
    path_params: DrivePermissionsPatchPathParams = field(default=None)
    query_params: DrivePermissionsPatchQueryParams = field(default=None)
    request: Optional[shared.Permission] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: DrivePermissionsPatchSecurity = field(default=None)
