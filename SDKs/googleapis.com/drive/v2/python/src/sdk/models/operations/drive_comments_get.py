...
class DriveCommentsGetRequest:
    path_params: DriveCommentsGetPathParams = field(default=None)
    query_params: DriveCommentsGetQueryParams = field(default=None)
    security: DriveCommentsGetSecurity = field(default=None)
