...
class DriveChangesWatchSecurity:
    ...
    option8: Optional[DriveChangesWatchSecurityOption8] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class DriveChangesWatchRequest:
    query_params: DriveChangesWatchQueryParams = field()
    security: DriveChangesWatchSecurity = field()
