...
class DrivePropertiesPatchRequest:
    path_params: DrivePropertiesPatchPathParams = field(default=None)
    query_params: DrivePropertiesPatchQueryParams = field(default=None)
    request: Optional[shared.Property] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: DrivePropertiesPatchSecurity = field(default=None)
