...
class DriveTeamdrivesInsertQueryParams:
    request_id: str = field(metadata={'query_param': { 'field_name': 'requestId', 'style': 'form', 'explode': True }})
...
class DriveTeamdrivesInsertRequest:
    query_params: DriveTeamdrivesInsertQueryParams = field()
    security: DriveTeamdrivesInsertSecurity = field()
