...
class DriveChangesGetRequest:
    path_params: DriveChangesGetPathParams = field(default=None)
    query_params: DriveChangesGetQueryParams = field(default=None)
    security: DriveChangesGetSecurity = field(default=None)
