...
class DriveCommentsCreateRequest:
    path_params: DriveCommentsCreatePathParams = field(default=None)
    query_params: DriveCommentsCreateQueryParams = field(default=None)
    request: Optional[shared.Comment] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: DriveCommentsCreateSecurity = field(default=None)
