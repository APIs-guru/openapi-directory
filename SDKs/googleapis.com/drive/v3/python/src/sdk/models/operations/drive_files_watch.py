...
class DriveFilesWatchRequest:
    path_params: DriveFilesWatchPathParams = field(default=None)
    query_params: DriveFilesWatchQueryParams = field(default=None)
    request: Optional[shared.Channel] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: DriveFilesWatchSecurity = field(default=None)
