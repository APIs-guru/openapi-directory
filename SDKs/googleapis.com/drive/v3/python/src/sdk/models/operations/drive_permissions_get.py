...
class DrivePermissionsGetSecurity:
    option1: Optional[DrivePermissionsGetSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DrivePermissionsGetSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[DrivePermissionsGetSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
    option4: Optional[DrivePermissionsGetSecurityOption4] = field(default=None, metadata={'security': { 'option': True }})
    option5: Optional[DrivePermissionsGetSecurityOption5] = field(default=None, metadata={'security': { 'option': True }})
    option6: Optional[DrivePermissionsGetSecurityOption6] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class DrivePermissionsGetRequest:
    path_params: DrivePermissionsGetPathParams = field(default=None)
    query_params: DrivePermissionsGetQueryParams = field(default=None)
    security: DrivePermissionsGetSecurity = field(default=None)
