...
class DriveCommentsUpdateSecurity:
    option1: Optional[DriveCommentsUpdateSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DriveCommentsUpdateSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class DriveCommentsUpdateRequest:
    path_params: DriveCommentsUpdatePathParams = field(default=None)
    query_params: DriveCommentsUpdateQueryParams = field(default=None)
    request: Optional[shared.Comment] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: DriveCommentsUpdateSecurity = field(default=None)
