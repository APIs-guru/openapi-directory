...
class DrivePermissionsDeleteSecurity:
    option1: Optional[DrivePermissionsDeleteSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DrivePermissionsDeleteSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class DrivePermissionsDeleteRequest:
    path_params: DrivePermissionsDeletePathParams = field(default=None)
    query_params: DrivePermissionsDeleteQueryParams = field(default=None)
    security: DrivePermissionsDeleteSecurity = field(default=None)
