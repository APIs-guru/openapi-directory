...
class DriveCommentsListQueryParams:
    ...
    start_modified_time: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'startModifiedTime', 'style': 'form', 'explode': True }})
...
class DriveCommentsListRequest:
    path_params: DriveCommentsListPathParams = field(default=None)
    query_params: DriveCommentsListQueryParams = field(default=None)
    security: DriveCommentsListSecurity = field(default=None)
