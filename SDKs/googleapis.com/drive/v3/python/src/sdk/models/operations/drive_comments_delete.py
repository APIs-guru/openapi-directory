...
class DriveCommentsDeleteSecurity:
    option1: Optional[DriveCommentsDeleteSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DriveCommentsDeleteSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class DriveCommentsDeleteRequest:
    path_params: DriveCommentsDeletePathParams = field()
    query_params: DriveCommentsDeleteQueryParams = field()
    security: DriveCommentsDeleteSecurity = field()
