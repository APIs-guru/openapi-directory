...
@dataclass
class BeyondcorpProjectsLocationsAppConnectorsListQueryParams:
...
class BeyondcorpProjectsLocationsAppConnectorsListResponse:
    ...
    google_cloud_beyondcorp_appconnectors_v1alpha_list_app_connectors_response: Optional[shared.GoogleCloudBeyondcorpAppconnectorsV1alphaListAppConnectorsResponse] = field(default=None)
