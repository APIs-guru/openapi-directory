...
type BeyondcorpOrganizationsLocationsSubscriptionsListPathParams struct {
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type BeyondcorpOrganizationsLocationsSubscriptionsListQueryParams struct {
...
type BeyondcorpOrganizationsLocationsSubscriptionsListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type BeyondcorpOrganizationsLocationsSubscriptionsListRequest struct {
...
type BeyondcorpOrganizationsLocationsSubscriptionsListResponse struct {
	ContentType                                                                    string
