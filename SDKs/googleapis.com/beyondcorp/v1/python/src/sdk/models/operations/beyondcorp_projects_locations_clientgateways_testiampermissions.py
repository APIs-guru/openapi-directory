...
class BeyondcorpProjectsLocationsClientGatewaysTestIamPermissionsRequest:
    path_params: BeyondcorpProjectsLocationsClientGatewaysTestIamPermissionsPathParams = field(default=None)
    query_params: BeyondcorpProjectsLocationsClientGatewaysTestIamPermissionsQueryParams = field(default=None)
    ...
    security: BeyondcorpProjectsLocationsClientGatewaysTestIamPermissionsSecurity = field(default=None)
