...
type TpuProjectsLocationsNodesPatchPathParams struct {
    Name string `pathParam:"style=simple,explode=false,name=name"`
    
}

type TpuProjectsLocationsNodesPatchQueryParams struct {
...
type TpuProjectsLocationsNodesPatchSecurity struct {
...
type TpuProjectsLocationsNodesPatchResponse struct {
    ContentType string 
