...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.TpuProjectsLocationsAcceleratorTypesList = function (req, config) {
        ...
        var url = utils.GenerateURL(baseURL, "/v1/{parent}/acceleratorTypes", req.pathParams);
    ...
    SDK.prototype.TpuProjectsLocationsNodesCreate = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{parent}/nodes", req.pathParams);
    ...
    SDK.prototype.TpuProjectsLocationsNodesReimage = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{name}:reimage", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.TpuProjectsLocationsTensorflowVersionsList = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{parent}/tensorflowVersions", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
