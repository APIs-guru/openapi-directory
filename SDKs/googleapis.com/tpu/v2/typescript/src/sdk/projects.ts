...
export class Projects {
  ...
  **/
  tpuProjectsLocationsAcceleratorTypesList(
    ...
    const url: string = utils.GenerateURL(baseURL, "/v2/{parent}/acceleratorTypes", req.pathParams);
  ...
  **/
  tpuProjectsLocationsGenerateServiceIdentity(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{parent}:generateServiceIdentity", req.pathParams);
  ...
  **/
  tpuProjectsLocationsNodesCreate(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{parent}/nodes", req.pathParams);
  ...
  **/
  tpuProjectsLocationsNodesGetGuestAttributes(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{name}:getGuestAttributes", req.pathParams);
  ...
  **/
  tpuProjectsLocationsRuntimeVersionsList(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{parent}/runtimeVersions", req.pathParams);
