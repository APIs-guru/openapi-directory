...
var Projects = /** @class */ (function () {
    ...
    **/
    Projects.prototype.tpuProjectsLocationsAcceleratorTypesList = function (req, config) {
        ...
        var url = utils.GenerateURL(baseURL, "/v2/{parent}/acceleratorTypes", req.pathParams);
    ...
    **/
    Projects.prototype.tpuProjectsLocationsGenerateServiceIdentity = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v2/{parent}:generateServiceIdentity", req.pathParams);
    ...
    **/
    Projects.prototype.tpuProjectsLocationsNodesCreate = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v2/{parent}/nodes", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    Projects.prototype.tpuProjectsLocationsNodesGetGuestAttributes = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v2/{name}:getGuestAttributes", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    Projects.prototype.tpuProjectsLocationsRuntimeVersionsList = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v2/{parent}/runtimeVersions", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
