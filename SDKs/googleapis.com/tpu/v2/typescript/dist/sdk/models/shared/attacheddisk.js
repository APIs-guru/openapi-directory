...
export var AttachedDiskModeEnum;
(function (AttachedDiskModeEnum) {
    AttachedDiskModeEnum["DiskModeUnspecified"] = "DISK_MODE_UNSPECIFIED";
    AttachedDiskModeEnum["ReadWrite"] = "READ_WRITE";
    AttachedDiskModeEnum["ReadOnly"] = "READ_ONLY";
})(AttachedDiskModeEnum || (AttachedDiskModeEnum = {}));
// AttachedDisk
/**
...
var AttachedDisk = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], AttachedDisk.prototype, "sourceDisk", void 0);
    return AttachedDisk;
}(SpeakeasyBase));
export { AttachedDisk };
