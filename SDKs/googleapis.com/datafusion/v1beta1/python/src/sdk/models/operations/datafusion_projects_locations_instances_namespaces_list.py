...
@dataclass
class DatafusionProjectsLocationsInstancesNamespacesListQueryParams:
    ...
    view: Optional[DatafusionProjectsLocationsInstancesNamespacesListViewEnum] = field(default=None, metadata={'query_param': { 'field_name': 'view', 'style': 'form', 'explode': True }})
