...
class DatafusionProjectsLocationsInstancesDNSPeeringsCreateRequest:
    path_params: DatafusionProjectsLocationsInstancesDNSPeeringsCreatePathParams = field(default=None)
    query_params: DatafusionProjectsLocationsInstancesDNSPeeringsCreateQueryParams = field(default=None)
    request: Optional[shared.DNSPeering] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: DatafusionProjectsLocationsInstancesDNSPeeringsCreateSecurity = field(default=None)
