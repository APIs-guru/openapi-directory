...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.DatafusionProjectsLocationsInstancesDnsPeeringsCreate = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta1/{parent}/dnsPeerings", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.DatafusionProjectsLocationsInstancesNamespacesGetIamPolicy = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.DatafusionProjectsLocationsInstancesNamespacesList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.DatafusionProjectsLocationsInstancesNamespacesSetIamPolicy = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.DatafusionProjectsLocationsInstancesNamespacesTestIamPermissions = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.DatafusionProjectsLocationsInstancesUpgrade = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.DatafusionProjectsLocationsRemoveIamPolicy = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DatafusionProjectsLocationsRemoveIamPolicyRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta1/{resource}:removeIamPolicy", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
