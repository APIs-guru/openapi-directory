...
class LocalservicesDetailedLeadReportsSearchRequest:
    query_params: LocalservicesDetailedLeadReportsSearchQueryParams = field(default=None)
    security: LocalservicesDetailedLeadReportsSearchSecurity = field(default=None)
    

@dataclass
class LocalservicesDetailedLeadReportsSearchResponse:
    content_type: str = field(default=None)
    google_ads_homeservices_localservices_v1_search_detailed_lead_reports_response: Optional[shared.GoogleAdsHomeservicesLocalservicesV1SearchDetailedLeadReportsResponse] = field(default=None)
