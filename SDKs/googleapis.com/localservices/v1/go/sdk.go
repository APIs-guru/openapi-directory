...
func (s *SDK) LocalservicesAccountReportsSearch(ctx context.Context, request operations.LocalservicesAccountReportsSearchRequest) (*operations.LocalservicesAccountReportsSearchResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) LocalservicesDetailedLeadReportsSearch(ctx context.Context, request operations.LocalservicesDetailedLeadReportsSearchRequest) (*operations.LocalservicesDetailedLeadReportsSearchResponse, error) {
	baseURL := s.serverURL
