...
class BooksVolumesRecommendedRateQueryParams:
    rating: BooksVolumesRecommendedRateRatingEnum = field(metadata={'query_param': { 'field_name': 'rating', 'style': 'form', 'explode': True }})
...
class BooksVolumesRecommendedRateRequest:
    query_params: BooksVolumesRecommendedRateQueryParams = field()
    security: BooksVolumesRecommendedRateSecurity = field()
