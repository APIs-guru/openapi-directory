...
@dataclass
class BooksPromoofferAcceptQueryParams:
...
@dataclass
class BooksPromoofferAcceptRequest:
    query_params: BooksPromoofferAcceptQueryParams = field(default=None)
    security: BooksPromoofferAcceptSecurity = field(default=None)
    

@dataclass
class BooksPromoofferAcceptResponse:
