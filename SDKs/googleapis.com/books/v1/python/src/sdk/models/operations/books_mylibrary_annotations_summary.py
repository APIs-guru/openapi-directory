...
class BooksMylibraryAnnotationsSummaryQueryParams:
    layer_ids: List[str] = field(metadata={'query_param': { 'field_name': 'layerIds', 'style': 'form', 'explode': True }})
...
class BooksMylibraryAnnotationsSummaryRequest:
    query_params: BooksMylibraryAnnotationsSummaryQueryParams = field()
    security: BooksMylibraryAnnotationsSummarySecurity = field()
