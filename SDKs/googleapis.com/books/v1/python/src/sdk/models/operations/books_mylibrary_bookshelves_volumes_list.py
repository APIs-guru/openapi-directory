...
@dataclass
class BooksMylibraryBookshelvesVolumesListQueryParams:
    ...
    projection: Optional[BooksMylibraryBookshelvesVolumesListProjectionEnum] = field(default=None, metadata={'query_param': { 'field_name': 'projection', 'style': 'form', 'explode': True }})
