...
class BooksPersonalizedstreamGetQueryParams:
    ...
    max_allowed_maturity_rating: Optional[BooksPersonalizedstreamGetMaxAllowedMaturityRatingEnum] = field(default=None, metadata={'query_param': { 'field_name': 'maxAllowedMaturityRating', 'style': 'form', 'explode': True }})
