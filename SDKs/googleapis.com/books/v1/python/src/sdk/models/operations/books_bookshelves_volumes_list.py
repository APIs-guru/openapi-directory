...
class BooksBookshelvesVolumesListRequest:
    path_params: BooksBookshelvesVolumesListPathParams = field()
    query_params: BooksBookshelvesVolumesListQueryParams = field()
    security: BooksBookshelvesVolumesListSecurity = field()
