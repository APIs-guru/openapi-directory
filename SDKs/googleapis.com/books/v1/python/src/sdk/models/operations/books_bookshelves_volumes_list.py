...
class BooksBookshelvesVolumesListRequest:
    path_params: BooksBookshelvesVolumesListPathParams = field(default=None)
    query_params: BooksBookshelvesVolumesListQueryParams = field(default=None)
    security: BooksBookshelvesVolumesListSecurity = field(default=None)
