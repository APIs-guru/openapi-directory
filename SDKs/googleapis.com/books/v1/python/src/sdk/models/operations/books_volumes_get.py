...
class BooksVolumesGetRequest:
    path_params: BooksVolumesGetPathParams = field(default=None)
    query_params: BooksVolumesGetQueryParams = field(default=None)
    security: BooksVolumesGetSecurity = field(default=None)
