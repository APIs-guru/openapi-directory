...
var Myconfig = /** @class */ (function () {
    function Myconfig(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Myconfig.prototype.booksMyconfigGetUserSettings = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.BooksMyconfigGetUserSettingsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/books/v1/myconfig/getUserSettings";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.usersettings = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Myconfig.prototype.booksMyconfigReleaseDownloadAccess = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.BooksMyconfigReleaseDownloadAccessRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/books/v1/myconfig/releaseDownloadAccess";
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.downloadAccesses = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Myconfig.prototype.booksMyconfigRequestAccess = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.BooksMyconfigRequestAccessRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/books/v1/myconfig/requestAccess";
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.requestAccessData = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Myconfig.prototype.booksMyconfigSyncVolumeLicenses = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.BooksMyconfigSyncVolumeLicensesRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/books/v1/myconfig/syncVolumeLicenses";
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    Myconfig.prototype.booksMyconfigUpdateUserSettings = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.BooksMyconfigUpdateUserSettingsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/books/v1/myconfig/updateUserSettings";
