...
var Volumes = /** @class */ (function () {
    ...
    **/
    Volumes.prototype.booksVolumesAssociatedList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.BooksVolumesAssociatedListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/books/v1/volumes/{volumeId}/associated", req.pathParams);
    ...
    **/
    Volumes.prototype.booksVolumesGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.BooksVolumesGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/books/v1/volumes/{volumeId}", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    Volumes.prototype.booksVolumesList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Volumes.prototype.booksVolumesMybooksList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Volumes.prototype.booksVolumesRecommendedList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Volumes.prototype.booksVolumesRecommendedRate = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.booksVolumesRecommendedRateResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Volumes.prototype.booksVolumesUseruploadedList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
