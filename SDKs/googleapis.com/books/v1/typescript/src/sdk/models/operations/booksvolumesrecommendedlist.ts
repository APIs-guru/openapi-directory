...
export enum BooksVolumesRecommendedListMaxAllowedMaturityRatingEnum {
...
export class BooksVolumesRecommendedListQueryParams extends SpeakeasyBase {
...
export class BooksVolumesRecommendedListSecurity extends SpeakeasyBase {
...
export class BooksVolumesRecommendedListRequest extends SpeakeasyBase {
  @Metadata()
...
export class BooksVolumesRecommendedListResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
