...
export class BooksPromoofferAcceptQueryParams extends SpeakeasyBase {
...
export class BooksPromoofferAcceptSecurity extends SpeakeasyBase {
...
export class BooksPromoofferAcceptRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class BooksPromoofferAcceptResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
