...
export class BooksCloudloadingAddBookQueryParams extends SpeakeasyBase {
  ...
  @Metadata({ data: "queryParam, style=form;explode=true;name=drive_document_id" })
  ...
  @Metadata({ data: "queryParam, style=form;explode=true;name=mime_type" })
  mimeType?: string;
  ...
  @Metadata({ data: "queryParam, style=form;explode=true;name=upload_client_token" })
