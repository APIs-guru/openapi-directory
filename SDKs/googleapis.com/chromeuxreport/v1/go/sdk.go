...
func (s *SDK) ChromeuxreportRecordsQueryRecord(ctx context.Context, request operations.ChromeuxreportRecordsQueryRecordRequest) (*operations.ChromeuxreportRecordsQueryRecordResponse, error) {
	baseURL := s.serverURL
