...
var Datasets = /** @class */ (function () {
    ...
    **/
    Datasets.prototype.bigqueryDatasetsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.BigqueryDatasetsDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/projects/{projectId}/datasets/{datasetId}", req.pathParams);
    ...
    **/
    Datasets.prototype.bigqueryDatasetsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Datasets.prototype.bigqueryDatasetsInsert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.BigqueryDatasetsInsertRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/projects/{projectId}/datasets", req.pathParams);
    ...
    **/
    Datasets.prototype.bigqueryDatasetsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Datasets.prototype.bigqueryDatasetsPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Datasets.prototype.bigqueryDatasetsUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
