...
var MlStatistics = /** @class */ (function (_super) {
    __extends(MlStatistics, _super);
    ...
    ], MlStatistics.prototype, "iterationResults", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=maxIterations" }),
        __metadata("design:type", String)
    ], MlStatistics.prototype, "maxIterations", void 0);
    return MlStatistics;
}(SpeakeasyBase));
export { MlStatistics };
