...
var MaterializedViewDefinition = /** @class */ (function (_super) {
    ...
    ], MaterializedViewDefinition.prototype, "enableRefresh", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=lastRefreshTime" }),
        __metadata("design:type", String)
    ], MaterializedViewDefinition.prototype, "lastRefreshTime", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=maxStaleness" }),
        __metadata("design:type", String)
    ], MaterializedViewDefinition.prototype, "maxStaleness", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=query" }),
        __metadata("design:type", String)
    ], MaterializedViewDefinition.prototype, "query", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=refreshIntervalMs" }),
        __metadata("design:type", String)
    ], MaterializedViewDefinition.prototype, "refreshIntervalMs", void 0);
    return MaterializedViewDefinition;
}(SpeakeasyBase));
export { MaterializedViewDefinition };
