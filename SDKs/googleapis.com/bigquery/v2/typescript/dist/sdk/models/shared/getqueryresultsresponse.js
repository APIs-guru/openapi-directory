...
var GetQueryResultsResponse = /** @class */ (function (_super) {
    ...
    ], GetQueryResultsResponse.prototype, "cacheHit", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=errors", elemType: ErrorProto }),
        __metadata("design:type", Array)
    ], GetQueryResultsResponse.prototype, "errors", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=etag" }),
        __metadata("design:type", String)
    ], GetQueryResultsResponse.prototype, "etag", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=jobComplete" }),
        __metadata("design:type", Boolean)
    ], GetQueryResultsResponse.prototype, "jobComplete", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=jobReference" }),
        __metadata("design:type", JobReference)
    ], GetQueryResultsResponse.prototype, "jobReference", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=kind" }),
        __metadata("design:type", String)
    ], GetQueryResultsResponse.prototype, "kind", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=numDmlAffectedRows" }),
        __metadata("design:type", String)
    ], GetQueryResultsResponse.prototype, "numDmlAffectedRows", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=pageToken" }),
        __metadata("design:type", String)
    ], GetQueryResultsResponse.prototype, "pageToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=rows", elemType: TableRow }),
        __metadata("design:type", Array)
    ], GetQueryResultsResponse.prototype, "rows", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=schema" }),
        __metadata("design:type", TableSchema)
    ], GetQueryResultsResponse.prototype, "schema", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=totalBytesProcessed" }),
        __metadata("design:type", String)
    ], GetQueryResultsResponse.prototype, "totalBytesProcessed", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=totalRows" }),
        __metadata("design:type", String)
    ], GetQueryResultsResponse.prototype, "totalRows", void 0);
