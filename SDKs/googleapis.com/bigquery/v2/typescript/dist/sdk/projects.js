...
var Projects = /** @class */ (function () {
    ...
    **/
    Projects.prototype.bigqueryProjectsGetServiceAccount = function (req, config) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.getServiceAccountResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Projects.prototype.bigqueryProjectsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
