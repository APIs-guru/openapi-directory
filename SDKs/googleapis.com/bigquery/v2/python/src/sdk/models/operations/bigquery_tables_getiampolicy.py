...
class BigqueryTablesGetIamPolicyRequest:
    path_params: BigqueryTablesGetIamPolicyPathParams = field(default=None)
    query_params: BigqueryTablesGetIamPolicyQueryParams = field(default=None)
    request: Optional[shared.GetIamPolicyRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: BigqueryTablesGetIamPolicySecurity = field(default=None)
