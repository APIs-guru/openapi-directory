...
@dataclass
class BigqueryDatasetsPatchQueryParams:
...
class BigqueryDatasetsPatchSecurity:
    option1: Optional[BigqueryDatasetsPatchSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[BigqueryDatasetsPatchSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
