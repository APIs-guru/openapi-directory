...
class BigqueryTablesTestIamPermissionsRequest:
    path_params: BigqueryTablesTestIamPermissionsPathParams = field()
    query_params: BigqueryTablesTestIamPermissionsQueryParams = field()
    security: BigqueryTablesTestIamPermissionsSecurity = field()
