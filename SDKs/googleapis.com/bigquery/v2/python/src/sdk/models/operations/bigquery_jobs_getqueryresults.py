...
class BigqueryJobsGetQueryResultsRequest:
    path_params: BigqueryJobsGetQueryResultsPathParams = field(default=None)
    query_params: BigqueryJobsGetQueryResultsQueryParams = field(default=None)
    security: BigqueryJobsGetQueryResultsSecurity = field(default=None)
