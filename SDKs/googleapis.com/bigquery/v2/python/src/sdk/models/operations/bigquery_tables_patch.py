...
class BigqueryTablesPatchRequest:
    path_params: BigqueryTablesPatchPathParams = field(default=None)
    query_params: BigqueryTablesPatchQueryParams = field(default=None)
    request: Optional[shared.Table] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: BigqueryTablesPatchSecurity = field(default=None)
