...
class BigqueryJobsQueryRequest:
    path_params: BigqueryJobsQueryPathParams = field(default=None)
    query_params: BigqueryJobsQueryQueryParams = field(default=None)
    request: Optional[shared.QueryRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: BigqueryJobsQuerySecurity = field(default=None)
