...
class BigqueryTablesDeleteRequest:
    path_params: BigqueryTablesDeletePathParams = field(default=None)
    query_params: BigqueryTablesDeleteQueryParams = field(default=None)
    security: BigqueryTablesDeleteSecurity = field(default=None)
