...
class GoogleCloudDocumentaiV1beta3DocumentStyle:
    r"""GoogleCloudDocumentaiV1beta3DocumentStyle
    ...
    font_size: Optional[GoogleCloudDocumentaiV1beta3DocumentStyleFontSize] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('fontSize') }})
