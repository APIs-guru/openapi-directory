...
from . import googleclouddocumentaiv1beta3documentrevisionhumanreview
...
class GoogleCloudDocumentaiV1beta3DocumentRevision:
    ...
    human_review: Optional[googleclouddocumentaiv1beta3documentrevisionhumanreview.GoogleCloudDocumentaiV1beta3DocumentRevisionHumanReview] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'humanReview' }})
