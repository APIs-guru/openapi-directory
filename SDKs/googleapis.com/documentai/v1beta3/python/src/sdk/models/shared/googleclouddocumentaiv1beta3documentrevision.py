...
class GoogleCloudDocumentaiV1beta3DocumentRevision:
    r"""GoogleCloudDocumentaiV1beta3DocumentRevision
    ...
    human_review: Optional[GoogleCloudDocumentaiV1beta3DocumentRevisionHumanReview] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('humanReview') }})
