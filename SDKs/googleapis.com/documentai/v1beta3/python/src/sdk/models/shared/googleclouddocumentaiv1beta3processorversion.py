...
class GoogleCloudDocumentaiV1beta3ProcessorVersion:
    r"""GoogleCloudDocumentaiV1beta3ProcessorVersion
    ...
    deprecation_info: Optional[GoogleCloudDocumentaiV1beta3ProcessorVersionDeprecationInfo] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('deprecationInfo') }})
    ...
    state: Optional[GoogleCloudDocumentaiV1beta3ProcessorVersionStateEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('state') }})
