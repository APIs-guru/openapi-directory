...
**/
var GoogleCloudDocumentaiV1beta3DocumentPageParagraph = /** @class */ (function (_super) {
    __extends(GoogleCloudDocumentaiV1beta3DocumentPageParagraph, _super);
    function GoogleCloudDocumentaiV1beta3DocumentPageParagraph() {
    ...
    ], GoogleCloudDocumentaiV1beta3DocumentPageParagraph.prototype, "detectedLanguages", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=layout" }),
        __metadata("design:type", GoogleCloudDocumentaiV1beta3DocumentPageLayout)
    ], GoogleCloudDocumentaiV1beta3DocumentPageParagraph.prototype, "layout", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=provenance" }),
        __metadata("design:type", GoogleCloudDocumentaiV1beta3DocumentProvenance)
    ], GoogleCloudDocumentaiV1beta3DocumentPageParagraph.prototype, "provenance", void 0);
    return GoogleCloudDocumentaiV1beta3DocumentPageParagraph;
}(SpeakeasyBase));
export { GoogleCloudDocumentaiV1beta3DocumentPageParagraph };
