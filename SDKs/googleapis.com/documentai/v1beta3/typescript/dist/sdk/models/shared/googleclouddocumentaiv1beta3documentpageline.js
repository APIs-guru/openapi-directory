...
**/
var GoogleCloudDocumentaiV1beta3DocumentPageLine = /** @class */ (function (_super) {
    __extends(GoogleCloudDocumentaiV1beta3DocumentPageLine, _super);
    function GoogleCloudDocumentaiV1beta3DocumentPageLine() {
    ...
    ], GoogleCloudDocumentaiV1beta3DocumentPageLine.prototype, "detectedLanguages", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=layout" }),
        __metadata("design:type", GoogleCloudDocumentaiV1beta3DocumentPageLayout)
    ], GoogleCloudDocumentaiV1beta3DocumentPageLine.prototype, "layout", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=provenance" }),
        __metadata("design:type", GoogleCloudDocumentaiV1beta3DocumentProvenance)
    ], GoogleCloudDocumentaiV1beta3DocumentPageLine.prototype, "provenance", void 0);
    return GoogleCloudDocumentaiV1beta3DocumentPageLine;
}(SpeakeasyBase));
export { GoogleCloudDocumentaiV1beta3DocumentPageLine };
