 ...
 * A detected symbol.
**/
var GoogleCloudDocumentaiV1beta2DocumentPageSymbol = /** @class */ (function (_super) {
    __extends(GoogleCloudDocumentaiV1beta2DocumentPageSymbol, _super);
    function GoogleCloudDocumentaiV1beta2DocumentPageSymbol() {
    ...
    ], GoogleCloudDocumentaiV1beta2DocumentPageSymbol.prototype, "detectedLanguages", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=layout" }),
        __metadata("design:type", GoogleCloudDocumentaiV1beta2DocumentPageLayout)
    ], GoogleCloudDocumentaiV1beta2DocumentPageSymbol.prototype, "layout", void 0);
    return GoogleCloudDocumentaiV1beta2DocumentPageSymbol;
}(SpeakeasyBase));
export { GoogleCloudDocumentaiV1beta2DocumentPageSymbol };
