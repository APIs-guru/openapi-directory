...
var Projects = /** @class */ (function () {
    ...
    **/
    Projects.prototype.documentaiProjectsLocationsDocumentsBatchProcess = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DocumentaiProjectsLocationsDocumentsBatchProcessRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta2/{parent}/documents:batchProcess", req.pathParams);
    ...
    **/
    Projects.prototype.documentaiProjectsLocationsDocumentsProcess = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DocumentaiProjectsLocationsDocumentsProcessRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta2/{parent}/documents:process", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.googleCloudDocumentaiV1beta2Document = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Projects.prototype.documentaiProjectsOperationsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
