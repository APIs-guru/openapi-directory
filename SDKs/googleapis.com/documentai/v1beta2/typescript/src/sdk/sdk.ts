  ...
  DocumentaiProjectsLocationsDocumentsBatchProcess(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        let res: operations.DocumentaiProjectsLocationsDocumentsBatchProcessResponse = {statusCode: httpRes.status, contentType: contentType};
  ...
  DocumentaiProjectsLocationsDocumentsProcess(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.DocumentaiProjectsLocationsDocumentsProcessResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
