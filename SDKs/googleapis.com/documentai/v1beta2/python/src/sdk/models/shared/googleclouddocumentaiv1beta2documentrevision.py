...
from . import googleclouddocumentaiv1beta2documentrevisionhumanreview
...
class GoogleCloudDocumentaiV1beta2DocumentRevision:
    ...
    human_review: Optional[googleclouddocumentaiv1beta2documentrevisionhumanreview.GoogleCloudDocumentaiV1beta2DocumentRevisionHumanReview] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'humanReview' }})
