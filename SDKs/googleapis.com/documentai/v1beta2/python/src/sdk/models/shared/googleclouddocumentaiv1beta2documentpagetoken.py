...
from . import googleclouddocumentaiv1beta2documentpagetokendetectedbreak
...
class GoogleCloudDocumentaiV1beta2DocumentPageToken:
    detected_break: Optional[googleclouddocumentaiv1beta2documentpagetokendetectedbreak.GoogleCloudDocumentaiV1beta2DocumentPageTokenDetectedBreak] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'detectedBreak' }})
