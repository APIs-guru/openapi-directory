...
class GoogleCloudDocumentaiV1beta2DocumentPageAnchorPageRef:
    r"""GoogleCloudDocumentaiV1beta2DocumentPageAnchorPageRef
    ...
    layout_type: Optional[GoogleCloudDocumentaiV1beta2DocumentPageAnchorPageRefLayoutTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('layoutType') }})
