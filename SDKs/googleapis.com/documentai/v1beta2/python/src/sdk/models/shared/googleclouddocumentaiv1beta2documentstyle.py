...
class GoogleCloudDocumentaiV1beta2DocumentStyle:
    r"""GoogleCloudDocumentaiV1beta2DocumentStyle
    ...
    font_size: Optional[GoogleCloudDocumentaiV1beta2DocumentStyleFontSize] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('fontSize') }})
