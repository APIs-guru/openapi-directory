...
from . import googletypecolor
from . import googleclouddocumentaiv1beta2documentstylefontsize
...
class GoogleCloudDocumentaiV1beta2DocumentStyle:
    ...
    font_size: Optional[googleclouddocumentaiv1beta2documentstylefontsize.GoogleCloudDocumentaiV1beta2DocumentStyleFontSize] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'fontSize' }})
