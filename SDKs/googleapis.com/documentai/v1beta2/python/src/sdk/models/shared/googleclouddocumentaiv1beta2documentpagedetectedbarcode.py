...
class GoogleCloudDocumentaiV1beta2DocumentPageDetectedBarcode:
    r"""GoogleCloudDocumentaiV1beta2DocumentPageDetectedBarcode
    A detected barcode.
    """
    
    barcode: Optional[GoogleCloudDocumentaiV1beta2Barcode] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('barcode') }})
