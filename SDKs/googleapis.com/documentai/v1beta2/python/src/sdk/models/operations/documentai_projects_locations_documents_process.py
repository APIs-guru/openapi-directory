...
class DocumentaiProjectsLocationsDocumentsProcessRequest:
    path_params: DocumentaiProjectsLocationsDocumentsProcessPathParams = field(default=None)
    query_params: DocumentaiProjectsLocationsDocumentsProcessQueryParams = field(default=None)
    ...
    security: DocumentaiProjectsLocationsDocumentsProcessSecurity = field(default=None)
