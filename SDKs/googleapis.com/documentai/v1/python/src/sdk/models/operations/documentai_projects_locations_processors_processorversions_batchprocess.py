...
@dataclass
class DocumentaiProjectsLocationsProcessorsProcessorVersionsBatchProcessQueryParams:
...
class DocumentaiProjectsLocationsProcessorsProcessorVersionsBatchProcessRequest:
    ...
    request: Optional[shared.GoogleCloudDocumentaiV1BatchProcessRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
