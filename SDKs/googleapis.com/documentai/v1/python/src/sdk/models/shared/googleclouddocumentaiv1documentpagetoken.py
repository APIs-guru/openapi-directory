...
from . import googleclouddocumentaiv1documentpagetokendetectedbreak
...
class GoogleCloudDocumentaiV1DocumentPageToken:
    detected_break: Optional[googleclouddocumentaiv1documentpagetokendetectedbreak.GoogleCloudDocumentaiV1DocumentPageTokenDetectedBreak] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'detectedBreak' }})
