...
class GoogleCloudDocumentaiV1DocumentPageAnchorPageRef:
    r"""GoogleCloudDocumentaiV1DocumentPageAnchorPageRef
    ...
    layout_type: Optional[GoogleCloudDocumentaiV1DocumentPageAnchorPageRefLayoutTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('layoutType') }})
