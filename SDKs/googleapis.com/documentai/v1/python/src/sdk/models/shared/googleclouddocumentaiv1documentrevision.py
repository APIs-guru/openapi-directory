...
class GoogleCloudDocumentaiV1DocumentRevision:
    r"""GoogleCloudDocumentaiV1DocumentRevision
    ...
    human_review: Optional[GoogleCloudDocumentaiV1DocumentRevisionHumanReview] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('humanReview') }})
