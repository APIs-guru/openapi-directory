...
@dataclass
class DocumentaiProjectsLocationsProcessorsProcessorVersionsProcessQueryParams:
...
class DocumentaiProjectsLocationsProcessorsProcessorVersionsProcessRequest:
    ...
    request: Optional[shared.GoogleCloudDocumentaiV1ProcessRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class DocumentaiProjectsLocationsProcessorsProcessorVersionsProcessResponse:
    ...
    google_cloud_documentai_v1_process_response: Optional[shared.GoogleCloudDocumentaiV1ProcessResponse] = field(default=None)
