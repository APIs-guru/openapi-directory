...
**/
var GoogleCloudDocumentaiV1DocumentPageVisualElement = /** @class */ (function (_super) {
    __extends(GoogleCloudDocumentaiV1DocumentPageVisualElement, _super);
    function GoogleCloudDocumentaiV1DocumentPageVisualElement() {
    ...
    ], GoogleCloudDocumentaiV1DocumentPageVisualElement.prototype, "detectedLanguages", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=layout" }),
        __metadata("design:type", GoogleCloudDocumentaiV1DocumentPageLayout)
    ], GoogleCloudDocumentaiV1DocumentPageVisualElement.prototype, "layout", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=type" }),
        __metadata("design:type", String)
    ], GoogleCloudDocumentaiV1DocumentPageVisualElement.prototype, "type", void 0);
    return GoogleCloudDocumentaiV1DocumentPageVisualElement;
}(SpeakeasyBase));
export { GoogleCloudDocumentaiV1DocumentPageVisualElement };
