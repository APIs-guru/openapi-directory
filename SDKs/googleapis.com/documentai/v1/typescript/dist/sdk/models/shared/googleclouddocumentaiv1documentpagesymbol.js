 ...
 * A detected symbol.
**/
var GoogleCloudDocumentaiV1DocumentPageSymbol = /** @class */ (function (_super) {
    __extends(GoogleCloudDocumentaiV1DocumentPageSymbol, _super);
    function GoogleCloudDocumentaiV1DocumentPageSymbol() {
    ...
    ], GoogleCloudDocumentaiV1DocumentPageSymbol.prototype, "detectedLanguages", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=layout" }),
        __metadata("design:type", GoogleCloudDocumentaiV1DocumentPageLayout)
    ], GoogleCloudDocumentaiV1DocumentPageSymbol.prototype, "layout", void 0);
    return GoogleCloudDocumentaiV1DocumentPageSymbol;
}(SpeakeasyBase));
export { GoogleCloudDocumentaiV1DocumentPageSymbol };
