...
class CloudiotProjectsLocationsRegistriesListSecurity:
    option1: Optional[CloudiotProjectsLocationsRegistriesListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[CloudiotProjectsLocationsRegistriesListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
