...
class CloudiotProjectsLocationsRegistriesBindDeviceToGatewayRequest:
    path_params: CloudiotProjectsLocationsRegistriesBindDeviceToGatewayPathParams = field(default=None)
    query_params: CloudiotProjectsLocationsRegistriesBindDeviceToGatewayQueryParams = field(default=None)
    request: Optional[shared.BindDeviceToGatewayRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: CloudiotProjectsLocationsRegistriesBindDeviceToGatewaySecurity = field(default=None)
