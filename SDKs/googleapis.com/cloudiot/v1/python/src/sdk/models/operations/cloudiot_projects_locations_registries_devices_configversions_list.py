...
class CloudiotProjectsLocationsRegistriesDevicesConfigVersionsListRequest:
    path_params: CloudiotProjectsLocationsRegistriesDevicesConfigVersionsListPathParams = field(default=None)
    query_params: CloudiotProjectsLocationsRegistriesDevicesConfigVersionsListQueryParams = field(default=None)
    security: CloudiotProjectsLocationsRegistriesDevicesConfigVersionsListSecurity = field(default=None)
