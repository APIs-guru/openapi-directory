...
class CloudiotProjectsLocationsRegistriesGroupsDevicesListRequest:
    path_params: CloudiotProjectsLocationsRegistriesGroupsDevicesListPathParams = field()
    query_params: CloudiotProjectsLocationsRegistriesGroupsDevicesListQueryParams = field()
    security: CloudiotProjectsLocationsRegistriesGroupsDevicesListSecurity = field()
