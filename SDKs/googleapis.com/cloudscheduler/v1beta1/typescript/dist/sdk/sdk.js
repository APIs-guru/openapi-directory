...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.CloudschedulerProjectsLocationsJobsCreate = function (req, config) {
        var _a;
    ...
    SDK.prototype.CloudschedulerProjectsLocationsJobsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.CloudschedulerProjectsLocationsJobsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.CloudschedulerProjectsLocationsJobsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.CloudschedulerProjectsLocationsJobsPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.CloudschedulerProjectsLocationsJobsPause = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.CloudschedulerProjectsLocationsJobsResume = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.CloudschedulerProjectsLocationsJobsRun = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CloudschedulerProjectsLocationsJobsRunRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta1/{name}:run", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.CloudschedulerProjectsLocationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
