...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.SecuritycenterProjectsLocationsClustersGetContainerThreatDetectionSettings = function (req, config) {
            ...
            switch (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) {
                case 200:
                    if (MatchContentType(contentType, "application/json")) {
                        res.containerThreatDetectionSettings = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.SecuritycenterProjectsLocationsClustersUpdateContainerThreatDetectionSettings = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.SecuritycenterProjectsWebSecurityScannerSettingsCalculate = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.SecuritycenterProjectsWebSecurityScannerSettingsCalculateRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta2/{name}:calculate", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
            ...
            switch (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) {
                case 200:
                    if (MatchContentType(contentType, "application/json")) {
                        res.webSecurityScannerSettings = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
