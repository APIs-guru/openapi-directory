...
var Organizations = /** @class */ (function () {
    ...
    **/
    Organizations.prototype.securitycenterOrganizationsOperationsCancel = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.SecuritycenterOrganizationsOperationsCancelRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1p1alpha1/{name}:cancel", req.pathParams);
    ...
    **/
    Organizations.prototype.securitycenterOrganizationsOperationsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.SecuritycenterOrganizationsOperationsDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1p1alpha1/{name}", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    Organizations.prototype.securitycenterOrganizationsOperationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
