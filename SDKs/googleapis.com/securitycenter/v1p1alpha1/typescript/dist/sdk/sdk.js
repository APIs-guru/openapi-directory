...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.SecuritycenterOrganizationsOperationsCancel = function (req, config) {
    ...
    SDK.prototype.SecuritycenterOrganizationsOperationsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.SecuritycenterOrganizationsOperationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
