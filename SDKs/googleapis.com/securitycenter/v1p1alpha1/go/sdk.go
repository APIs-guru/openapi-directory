...
func (s *SDK) SecuritycenterOrganizationsOperationsList(ctx context.Context, request operations.SecuritycenterOrganizationsOperationsListRequest) (*operations.SecuritycenterOrganizationsOperationsListResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1p1alpha1/{name}", request.PathParams)
