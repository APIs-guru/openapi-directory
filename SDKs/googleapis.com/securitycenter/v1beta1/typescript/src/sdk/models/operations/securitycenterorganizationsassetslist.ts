...
export class SecuritycenterOrganizationsAssetsListPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=parent" })
  parent: string;
}


export class SecuritycenterOrganizationsAssetsListQueryParams extends SpeakeasyBase {
