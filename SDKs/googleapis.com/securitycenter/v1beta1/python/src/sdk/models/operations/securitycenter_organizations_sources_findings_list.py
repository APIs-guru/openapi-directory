...
class SecuritycenterOrganizationsSourcesFindingsListRequest:
    path_params: SecuritycenterOrganizationsSourcesFindingsListPathParams = field()
    query_params: SecuritycenterOrganizationsSourcesFindingsListQueryParams = field()
    security: SecuritycenterOrganizationsSourcesFindingsListSecurity = field()
