...
class SecuritycenterOrganizationsSourcesFindingsListRequest:
    path_params: SecuritycenterOrganizationsSourcesFindingsListPathParams = field(default=None)
    query_params: SecuritycenterOrganizationsSourcesFindingsListQueryParams = field(default=None)
    security: SecuritycenterOrganizationsSourcesFindingsListSecurity = field(default=None)
