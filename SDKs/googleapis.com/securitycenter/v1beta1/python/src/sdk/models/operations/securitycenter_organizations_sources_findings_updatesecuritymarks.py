...
class SecuritycenterOrganizationsSourcesFindingsUpdateSecurityMarksRequest:
    path_params: SecuritycenterOrganizationsSourcesFindingsUpdateSecurityMarksPathParams = field(default=None)
    query_params: SecuritycenterOrganizationsSourcesFindingsUpdateSecurityMarksQueryParams = field(default=None)
    request: Optional[shared.GoogleCloudSecuritycenterV1beta1SecurityMarks] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: SecuritycenterOrganizationsSourcesFindingsUpdateSecurityMarksSecurity = field(default=None)
    

@dataclass
class SecuritycenterOrganizationsSourcesFindingsUpdateSecurityMarksResponse:
    content_type: str = field(default=None)
    google_cloud_securitycenter_v1beta1_security_marks: Optional[shared.GoogleCloudSecuritycenterV1beta1SecurityMarks] = field(default=None)
