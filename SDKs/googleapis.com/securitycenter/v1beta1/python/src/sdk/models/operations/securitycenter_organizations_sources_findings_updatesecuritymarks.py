...
class SecuritycenterOrganizationsSourcesFindingsUpdateSecurityMarksRequest:
    path_params: SecuritycenterOrganizationsSourcesFindingsUpdateSecurityMarksPathParams = field()
    query_params: SecuritycenterOrganizationsSourcesFindingsUpdateSecurityMarksQueryParams = field()
    security: SecuritycenterOrganizationsSourcesFindingsUpdateSecurityMarksSecurity = field()
