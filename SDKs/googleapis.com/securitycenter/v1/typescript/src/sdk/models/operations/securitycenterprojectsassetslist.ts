...
export class SecuritycenterProjectsAssetsListPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=parent" })
  parent: string;
}


export class SecuritycenterProjectsAssetsListQueryParams extends SpeakeasyBase {
