...
export class SecuritycenterProjectsSourcesFindingsListPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=parent" })
  parent: string;
}


export class SecuritycenterProjectsSourcesFindingsListQueryParams extends SpeakeasyBase {
