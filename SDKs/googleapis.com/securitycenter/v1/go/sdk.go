...
func (s *SDK) SecuritycenterOrganizationsNotificationConfigsCreate(ctx context.Context, request operations.SecuritycenterOrganizationsNotificationConfigsCreateRequest) (*operations.SecuritycenterOrganizationsNotificationConfigsCreateResponse, error) {
	baseURL := s.serverURL
	...
	res := &operations.SecuritycenterOrganizationsNotificationConfigsCreateResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *SDK) SecuritycenterOrganizationsNotificationConfigsList(ctx context.Context, request operations.SecuritycenterOrganizationsNotificationConfigsListRequest) (*operations.SecuritycenterOrganizationsNotificationConfigsListResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/{parent}/notificationConfigs", request.PathParams)
	...
	res := &operations.SecuritycenterOrganizationsNotificationConfigsListResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *SDK) SecuritycenterProjectsAssetsGroup(ctx context.Context, request operations.SecuritycenterProjectsAssetsGroupRequest) (*operations.SecuritycenterProjectsAssetsGroupResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) SecuritycenterProjectsAssetsList(ctx context.Context, request operations.SecuritycenterProjectsAssetsListRequest) (*operations.SecuritycenterProjectsAssetsListResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) SecuritycenterProjectsBigQueryExportsCreate(ctx context.Context, request operations.SecuritycenterProjectsBigQueryExportsCreateRequest) (*operations.SecuritycenterProjectsBigQueryExportsCreateResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) SecuritycenterProjectsBigQueryExportsList(ctx context.Context, request operations.SecuritycenterProjectsBigQueryExportsListRequest) (*operations.SecuritycenterProjectsBigQueryExportsListResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/{parent}/bigQueryExports", request.PathParams)
...
func (s *SDK) SecuritycenterProjectsFindingsBulkMute(ctx context.Context, request operations.SecuritycenterProjectsFindingsBulkMuteRequest) (*operations.SecuritycenterProjectsFindingsBulkMuteResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) SecuritycenterProjectsMuteConfigsCreate(ctx context.Context, request operations.SecuritycenterProjectsMuteConfigsCreateRequest) (*operations.SecuritycenterProjectsMuteConfigsCreateResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) SecuritycenterProjectsMuteConfigsDelete(ctx context.Context, request operations.SecuritycenterProjectsMuteConfigsDeleteRequest) (*operations.SecuritycenterProjectsMuteConfigsDeleteResponse, error) {
	baseURL := s.serverURL
	...
	res := &operations.SecuritycenterProjectsMuteConfigsDeleteResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *SDK) SecuritycenterProjectsMuteConfigsGet(ctx context.Context, request operations.SecuritycenterProjectsMuteConfigsGetRequest) (*operations.SecuritycenterProjectsMuteConfigsGetResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/{name}", request.PathParams)
	...
	res := &operations.SecuritycenterProjectsMuteConfigsGetResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *SDK) SecuritycenterProjectsMuteConfigsList(ctx context.Context, request operations.SecuritycenterProjectsMuteConfigsListRequest) (*operations.SecuritycenterProjectsMuteConfigsListResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/{parent}/muteConfigs", request.PathParams)
...
func (s *SDK) SecuritycenterProjectsSourcesFindingsExternalSystemsPatch(ctx context.Context, request operations.SecuritycenterProjectsSourcesFindingsExternalSystemsPatchRequest) (*operations.SecuritycenterProjectsSourcesFindingsExternalSystemsPatchResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/{name}", request.PathParams)
...
func (s *SDK) SecuritycenterProjectsSourcesFindingsGroup(ctx context.Context, request operations.SecuritycenterProjectsSourcesFindingsGroupRequest) (*operations.SecuritycenterProjectsSourcesFindingsGroupResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) SecuritycenterProjectsSourcesFindingsList(ctx context.Context, request operations.SecuritycenterProjectsSourcesFindingsListRequest) (*operations.SecuritycenterProjectsSourcesFindingsListResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/{parent}/findings", request.PathParams)
...
func (s *SDK) SecuritycenterProjectsSourcesFindingsSetMute(ctx context.Context, request operations.SecuritycenterProjectsSourcesFindingsSetMuteRequest) (*operations.SecuritycenterProjectsSourcesFindingsSetMuteResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) SecuritycenterProjectsSourcesFindingsSetState(ctx context.Context, request operations.SecuritycenterProjectsSourcesFindingsSetStateRequest) (*operations.SecuritycenterProjectsSourcesFindingsSetStateResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) SecuritycenterProjectsSourcesList(ctx context.Context, request operations.SecuritycenterProjectsSourcesListRequest) (*operations.SecuritycenterProjectsSourcesListResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/{parent}/sources", request.PathParams)
