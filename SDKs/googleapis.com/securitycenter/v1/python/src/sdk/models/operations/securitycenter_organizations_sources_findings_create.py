...
@dataclass
class SecuritycenterOrganizationsSourcesFindingsCreateQueryParams:
...
class SecuritycenterOrganizationsSourcesFindingsCreateRequest:
    ...
    request: Optional[shared.FindingInput] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
