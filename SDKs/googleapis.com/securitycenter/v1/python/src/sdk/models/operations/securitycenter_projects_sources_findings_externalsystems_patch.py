...
class SecuritycenterProjectsSourcesFindingsExternalSystemsPatchRequest:
    path_params: SecuritycenterProjectsSourcesFindingsExternalSystemsPatchPathParams = field()
    query_params: SecuritycenterProjectsSourcesFindingsExternalSystemsPatchQueryParams = field()
    security: SecuritycenterProjectsSourcesFindingsExternalSystemsPatchSecurity = field()
