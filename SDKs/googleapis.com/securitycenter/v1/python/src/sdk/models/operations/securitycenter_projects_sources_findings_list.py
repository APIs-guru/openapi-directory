...
class SecuritycenterProjectsSourcesFindingsListRequest:
    path_params: SecuritycenterProjectsSourcesFindingsListPathParams = field(default=None)
    query_params: SecuritycenterProjectsSourcesFindingsListQueryParams = field(default=None)
    security: SecuritycenterProjectsSourcesFindingsListSecurity = field(default=None)
