...
class SecuritycenterProjectsSourcesFindingsListRequest:
    path_params: SecuritycenterProjectsSourcesFindingsListPathParams = field()
    query_params: SecuritycenterProjectsSourcesFindingsListQueryParams = field()
    security: SecuritycenterProjectsSourcesFindingsListSecurity = field()
