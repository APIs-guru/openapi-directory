...
export class Projects {
  ...
  **/
  speechProjectsLocationsCustomClassesCreate(
    ...
    const url: string = utils.GenerateURL(baseURL, "/v1/{parent}/customClasses", req.pathParams);
  ...
  **/
  speechProjectsLocationsPhraseSetsCreate(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{parent}/phraseSets", req.pathParams);
