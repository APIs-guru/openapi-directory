...
class Area120tablesTablesRowsPatchRequest:
    path_params: Area120tablesTablesRowsPatchPathParams = field(default=None)
    query_params: Area120tablesTablesRowsPatchQueryParams = field(default=None)
    request: Optional[shared.Row] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: Area120tablesTablesRowsPatchSecurity = field(default=None)
