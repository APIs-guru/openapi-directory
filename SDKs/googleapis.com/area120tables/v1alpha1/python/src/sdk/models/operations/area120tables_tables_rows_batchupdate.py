...
class Area120tablesTablesRowsBatchUpdateRequest:
    path_params: Area120tablesTablesRowsBatchUpdatePathParams = field()
    query_params: Area120tablesTablesRowsBatchUpdateQueryParams = field()
    security: Area120tablesTablesRowsBatchUpdateSecurity = field()
