...
class Area120tablesWorkspacesGetRequest:
    path_params: Area120tablesWorkspacesGetPathParams = field()
    query_params: Area120tablesWorkspacesGetQueryParams = field()
    security: Area120tablesWorkspacesGetSecurity = field()
