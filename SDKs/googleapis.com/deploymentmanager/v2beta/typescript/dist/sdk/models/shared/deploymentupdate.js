...
var DeploymentUpdate = /** @class */ (function (_super) {
    __extends(DeploymentUpdate, _super);
    ...
    ], DeploymentUpdate.prototype, "description", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=labels", elemType: DeploymentUpdateLabelEntry }),
        __metadata("design:type", Array)
    ], DeploymentUpdate.prototype, "labels", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=manifest" }),
        __metadata("design:type", String)
    ], DeploymentUpdate.prototype, "manifest", void 0);
    return DeploymentUpdate;
}(SpeakeasyBase));
export { DeploymentUpdate };
