...
@dataclass
class DeploymentmanagerDeploymentsStopQueryParams:
...
class DeploymentmanagerDeploymentsStopSecurity:
    option1: Optional[DeploymentmanagerDeploymentsStopSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DeploymentmanagerDeploymentsStopSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
