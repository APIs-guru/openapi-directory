...
class DeploymentmanagerDeploymentsUpdateQueryParams:
    ...
    create_policy: Optional[DeploymentmanagerDeploymentsUpdateCreatePolicyEnum] = field(default=None, metadata={'query_param': { 'field_name': 'createPolicy', 'style': 'form', 'explode': True }})
    delete_policy: Optional[DeploymentmanagerDeploymentsUpdateDeletePolicyEnum] = field(default=None, metadata={'query_param': { 'field_name': 'deletePolicy', 'style': 'form', 'explode': True }})
...
class DeploymentmanagerDeploymentsUpdateSecurity:
    option1: Optional[DeploymentmanagerDeploymentsUpdateSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DeploymentmanagerDeploymentsUpdateSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
