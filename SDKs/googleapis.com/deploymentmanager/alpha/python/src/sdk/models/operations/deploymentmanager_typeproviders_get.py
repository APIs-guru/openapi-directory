...
class DeploymentmanagerTypeProvidersGetRequest:
    path_params: DeploymentmanagerTypeProvidersGetPathParams = field()
    query_params: DeploymentmanagerTypeProvidersGetQueryParams = field()
    security: DeploymentmanagerTypeProvidersGetSecurity = field()
