...
class Resource:
    ...
    last_used_credential: Optional[credential.Credential] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'lastUsedCredential' }})
    ...
    runtime_policies: Optional[List[ResourceRuntimePoliciesEnum]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'runtimePolicies' }})
