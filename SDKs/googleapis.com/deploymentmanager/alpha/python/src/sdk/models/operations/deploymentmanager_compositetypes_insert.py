...
class DeploymentmanagerCompositeTypesInsertSecurity:
    option1: Optional[DeploymentmanagerCompositeTypesInsertSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DeploymentmanagerCompositeTypesInsertSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
