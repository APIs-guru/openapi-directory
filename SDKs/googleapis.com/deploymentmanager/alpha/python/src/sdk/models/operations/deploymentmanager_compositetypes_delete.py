...
class DeploymentmanagerCompositeTypesDeleteSecurity:
    option1: Optional[DeploymentmanagerCompositeTypesDeleteSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DeploymentmanagerCompositeTypesDeleteSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
