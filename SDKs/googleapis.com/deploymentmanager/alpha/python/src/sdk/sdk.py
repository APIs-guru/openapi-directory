...
class SDK:
    ...
    def deploymentmanager_manifests_get(self, request: operations.DeploymentmanagerManifestsGetRequest) -> operations.DeploymentmanagerManifestsGetResponse:
        ...
        base_url = self.server_url
        url = utils.generate_url(base_url, "/deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}/manifests/{manifest}", request.path_params)
    ...
    def deploymentmanager_manifests_list(self, request: operations.DeploymentmanagerManifestsListRequest) -> operations.DeploymentmanagerManifestsListResponse:
        ...
        base_url = self.server_url
        url = utils.generate_url(base_url, "/deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}/manifests", request.path_params)
    ...
    def deploymentmanager_operations_get(self, request: operations.DeploymentmanagerOperationsGetRequest) -> operations.DeploymentmanagerOperationsGetResponse:
        ...
        base_url = self.server_url
        url = utils.generate_url(base_url, "/deploymentmanager/alpha/projects/{project}/global/operations/{operation}", request.path_params)
    ...
    def deploymentmanager_operations_list(self, request: operations.DeploymentmanagerOperationsListRequest) -> operations.DeploymentmanagerOperationsListResponse:
        ...
        base_url = self.server_url
        url = utils.generate_url(base_url, "/deploymentmanager/alpha/projects/{project}/global/operations", request.path_params)
    ...
    def deploymentmanager_resources_get(self, request: operations.DeploymentmanagerResourcesGetRequest) -> operations.DeploymentmanagerResourcesGetResponse:
        ...
        base_url = self.server_url
        url = utils.generate_url(base_url, "/deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}/resources/{resource}", request.path_params)
    ...
    def deploymentmanager_resources_list(self, request: operations.DeploymentmanagerResourcesListRequest) -> operations.DeploymentmanagerResourcesListResponse:
        ...
        base_url = self.server_url
        url = utils.generate_url(base_url, "/deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}/resources", request.path_params)
    ...
    def deploymentmanager_types_get(self, request: operations.DeploymentmanagerTypesGetRequest) -> operations.DeploymentmanagerTypesGetResponse:
        warnings.simplefilter("ignore")

        base_url = self.server_url
        url = utils.generate_url(base_url, "/deploymentmanager/alpha/projects/{project}/global/types/{type}", request.path_params)
        ...
        res = operations.DeploymentmanagerTypesGetResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.Type])
                res.type = out
    ...
    def deploymentmanager_types_list(self, request: operations.DeploymentmanagerTypesListRequest) -> operations.DeploymentmanagerTypesListResponse:
        ...
        base_url = self.server_url
        url = utils.generate_url(base_url, "/deploymentmanager/alpha/projects/{project}/global/types", request.path_params)
