...
var CompositeTypes = /** @class */ (function () {
    ...
    **/
    CompositeTypes.prototype.deploymentmanagerCompositeTypesDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeploymentmanagerCompositeTypesDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/deploymentmanager/alpha/projects/{project}/global/compositeTypes/{compositeType}", req.pathParams);
    ...
    **/
    CompositeTypes.prototype.deploymentmanagerCompositeTypesGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.compositeType = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    CompositeTypes.prototype.deploymentmanagerCompositeTypesInsert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeploymentmanagerCompositeTypesInsertRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/deploymentmanager/alpha/projects/{project}/global/compositeTypes", req.pathParams);
    ...
    **/
    CompositeTypes.prototype.deploymentmanagerCompositeTypesList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.compositeTypesListResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    CompositeTypes.prototype.deploymentmanagerCompositeTypesPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    CompositeTypes.prototype.deploymentmanagerCompositeTypesUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
