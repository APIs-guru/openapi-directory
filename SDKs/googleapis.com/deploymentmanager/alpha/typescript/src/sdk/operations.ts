...
export class Operations {
  ...
  **/
  deploymentmanagerOperationsGet(
    ...
    const url: string = utils.GenerateURL(baseURL, "/deploymentmanager/alpha/projects/{project}/global/operations/{operation}", req.pathParams);
  ...
  **/
  deploymentmanagerOperationsList(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/deploymentmanager/alpha/projects/{project}/global/operations", req.pathParams);
