...
export class SDK {
  ...
  DeploymentmanagerCompositeTypesDelete(
    ...
    const url: string = utils.GenerateURL(baseURL, "/deploymentmanager/alpha/projects/{project}/global/compositeTypes/{compositeType}", req.pathParams);
  ...
  DeploymentmanagerCompositeTypesInsert(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/deploymentmanager/alpha/projects/{project}/global/compositeTypes", req.pathParams);
  ...
  DeploymentmanagerDeploymentsCancelPreview(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}/cancelPreview", req.pathParams);
  ...
  DeploymentmanagerDeploymentsDelete(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}", req.pathParams);
  ...
  DeploymentmanagerDeploymentsGetIamPolicy(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/deploymentmanager/alpha/projects/{project}/global/deployments/{resource}/getIamPolicy", req.pathParams);
  ...
  DeploymentmanagerDeploymentsInsert(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/deploymentmanager/alpha/projects/{project}/global/deployments", req.pathParams);
  ...
  DeploymentmanagerDeploymentsSetIamPolicy(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/deploymentmanager/alpha/projects/{project}/global/deployments/{resource}/setIamPolicy", req.pathParams);
  ...
  DeploymentmanagerDeploymentsStop(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}/stop", req.pathParams);
  ...
  DeploymentmanagerDeploymentsTestIamPermissions(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/deploymentmanager/alpha/projects/{project}/global/deployments/{resource}/testIamPermissions", req.pathParams);
  ...
  DeploymentmanagerManifestsGet(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}/manifests/{manifest}", req.pathParams);
  ...
  DeploymentmanagerManifestsList(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}/manifests", req.pathParams);
  ...
  DeploymentmanagerResourcesGet(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}/resources/{resource}", req.pathParams);
  ...
  DeploymentmanagerResourcesList(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/deploymentmanager/alpha/projects/{project}/global/deployments/{deployment}/resources", req.pathParams);
  ...
  DeploymentmanagerTypesGet(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.DeploymentmanagerTypesGetResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
