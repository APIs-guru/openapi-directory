...
@dataclass
class DeploymentmanagerTypesListQueryParams:
...
class DeploymentmanagerTypesListSecurity:
    option1: Optional[DeploymentmanagerTypesListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DeploymentmanagerTypesListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[DeploymentmanagerTypesListSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
    option4: Optional[DeploymentmanagerTypesListSecurityOption4] = field(default=None, metadata={'security': { 'option': True }})
