...
class ServicemanagementServicesConfigsCreateRequest:
    path_params: ServicemanagementServicesConfigsCreatePathParams = field()
    query_params: ServicemanagementServicesConfigsCreateQueryParams = field()
    security: ServicemanagementServicesConfigsCreateSecurity = field()
