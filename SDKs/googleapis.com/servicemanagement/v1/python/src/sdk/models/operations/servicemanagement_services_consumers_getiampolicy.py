...
@dataclass
class ServicemanagementServicesConsumersGetIamPolicyQueryParams:
...
class ServicemanagementServicesConsumersGetIamPolicySecurity:
    option1: Optional[ServicemanagementServicesConsumersGetIamPolicySecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[ServicemanagementServicesConsumersGetIamPolicySecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[ServicemanagementServicesConsumersGetIamPolicySecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
    option4: Optional[ServicemanagementServicesConsumersGetIamPolicySecurityOption4] = field(default=None, metadata={'security': { 'option': True }})
