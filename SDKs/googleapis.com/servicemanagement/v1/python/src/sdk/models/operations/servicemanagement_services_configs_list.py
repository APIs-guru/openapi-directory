...
@dataclass
class ServicemanagementServicesConfigsListQueryParams:
...
class ServicemanagementServicesConfigsListSecurity:
    option1: Optional[ServicemanagementServicesConfigsListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[ServicemanagementServicesConfigsListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[ServicemanagementServicesConfigsListSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
    option4: Optional[ServicemanagementServicesConfigsListSecurityOption4] = field(default=None, metadata={'security': { 'option': True }})
