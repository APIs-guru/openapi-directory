...
class ServicemanagementServicesGetRequest:
    path_params: ServicemanagementServicesGetPathParams = field()
    query_params: ServicemanagementServicesGetQueryParams = field()
    security: ServicemanagementServicesGetSecurity = field()
