...
class ServicemanagementServicesRolloutsListRequest:
    path_params: ServicemanagementServicesRolloutsListPathParams = field(default=None)
    query_params: ServicemanagementServicesRolloutsListQueryParams = field(default=None)
    security: ServicemanagementServicesRolloutsListSecurity = field(default=None)
