...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.FirebasehostingOperationsCancel = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.FirebasehostingOperationsCancelRequest(req);
        }
    ...
    SDK.prototype.FirebasehostingOperationsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.FirebasehostingOperationsDeleteRequest(req);
        }
        var baseURL = this.serverURL;
    ...
    SDK.prototype.FirebasehostingOperationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.FirebasehostingOperationsListRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{name}", req.pathParams);
        var client = this.defaultClient;
