...
class FirebasehostingSitesVersionsFilesListRequest:
    path_params: FirebasehostingSitesVersionsFilesListPathParams = field(default=None)
    query_params: FirebasehostingSitesVersionsFilesListQueryParams = field(default=None)
    security: FirebasehostingSitesVersionsFilesListSecurity = field(default=None)
