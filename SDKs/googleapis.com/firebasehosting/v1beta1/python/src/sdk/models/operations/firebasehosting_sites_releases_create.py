...
class FirebasehostingSitesReleasesCreateRequest:
    path_params: FirebasehostingSitesReleasesCreatePathParams = field(default=None)
    query_params: FirebasehostingSitesReleasesCreateQueryParams = field(default=None)
    request: Optional[shared.Release] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: FirebasehostingSitesReleasesCreateSecurity = field(default=None)
