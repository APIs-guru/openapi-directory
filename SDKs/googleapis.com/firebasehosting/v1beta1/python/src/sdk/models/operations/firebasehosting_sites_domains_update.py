...
class FirebasehostingSitesDomainsUpdateRequest:
    path_params: FirebasehostingSitesDomainsUpdatePathParams = field()
    query_params: FirebasehostingSitesDomainsUpdateQueryParams = field()
    security: FirebasehostingSitesDomainsUpdateSecurity = field()
