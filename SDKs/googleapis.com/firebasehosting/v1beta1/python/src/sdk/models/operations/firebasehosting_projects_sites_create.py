...
class FirebasehostingProjectsSitesCreateRequest:
    path_params: FirebasehostingProjectsSitesCreatePathParams = field()
    query_params: FirebasehostingProjectsSitesCreateQueryParams = field()
    security: FirebasehostingProjectsSitesCreateSecurity = field()
    request: Optional[shared.SiteInput] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
