...
class CloudtraceProjectsTraceSinksCreateRequest:
    path_params: CloudtraceProjectsTraceSinksCreatePathParams = field()
    query_params: CloudtraceProjectsTraceSinksCreateQueryParams = field()
    security: CloudtraceProjectsTraceSinksCreateSecurity = field()
