...
export class SDK {
  ...
  CloudtraceProjectsPatchTraces(
    ...
    const url: string = utils.GenerateURL(baseURL, "/v1/projects/{projectId}/traces", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        let res: operations.CloudtraceProjectsPatchTracesResponse = {statusCode: httpRes.status, contentType: contentType};
  ...
  CloudtraceProjectsTracesGet(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/projects/{projectId}/traces/{traceId}", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.CloudtraceProjectsTracesGetResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.trace = httpRes?.data;
            }
            break;
        }
  ...
  CloudtraceProjectsTracesList(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.CloudtraceProjectsTracesListResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.listTracesResponse = httpRes?.data;
            }
            break;
        }
