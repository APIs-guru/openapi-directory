...
class CloudtraceProjectsTracesGetSecurity:
    option1: Optional[CloudtraceProjectsTracesGetSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[CloudtraceProjectsTracesGetSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
