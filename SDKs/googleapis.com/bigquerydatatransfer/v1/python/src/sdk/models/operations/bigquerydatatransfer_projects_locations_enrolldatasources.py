...
@dataclass
class BigquerydatatransferProjectsLocationsEnrollDataSourcesQueryParams:
...
class BigquerydatatransferProjectsLocationsEnrollDataSourcesSecurity:
    option1: Optional[BigquerydatatransferProjectsLocationsEnrollDataSourcesSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[BigquerydatatransferProjectsLocationsEnrollDataSourcesSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
