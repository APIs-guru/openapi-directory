...
class BigquerydatatransferProjectsTransferConfigsCreateRequest:
    path_params: BigquerydatatransferProjectsTransferConfigsCreatePathParams = field()
    query_params: BigquerydatatransferProjectsTransferConfigsCreateQueryParams = field()
    security: BigquerydatatransferProjectsTransferConfigsCreateSecurity = field()
    request: Optional[shared.TransferConfigInput] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
