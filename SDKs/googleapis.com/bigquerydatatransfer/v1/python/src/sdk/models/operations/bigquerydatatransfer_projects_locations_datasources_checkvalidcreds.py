...
@dataclass
class BigquerydatatransferProjectsLocationsDataSourcesCheckValidCredsQueryParams:
...
class BigquerydatatransferProjectsLocationsDataSourcesCheckValidCredsSecurity:
    option1: Optional[BigquerydatatransferProjectsLocationsDataSourcesCheckValidCredsSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[BigquerydatatransferProjectsLocationsDataSourcesCheckValidCredsSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[BigquerydatatransferProjectsLocationsDataSourcesCheckValidCredsSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
