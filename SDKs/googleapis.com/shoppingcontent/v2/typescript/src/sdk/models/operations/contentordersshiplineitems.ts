...
export class ContentOrdersShiplineitemsPathParams extends SpeakeasyBase {
...
export class ContentOrdersShiplineitemsQueryParams extends SpeakeasyBase {
...
export class ContentOrdersShiplineitemsSecurity extends SpeakeasyBase {
...
export class ContentOrdersShiplineitemsRequest extends SpeakeasyBase {
  @Metadata()
...
export class ContentOrdersShiplineitemsResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
