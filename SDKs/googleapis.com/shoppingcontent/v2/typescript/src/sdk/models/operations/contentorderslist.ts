...
export class ContentOrdersListQueryParams extends SpeakeasyBase {
  ...
  @Metadata({ data: "queryParam, style=form;explode=true;name=placedDateEnd" })
  placedDateEnd?: string;

  @Metadata({ data: "queryParam, style=form;explode=true;name=placedDateStart" })
  ...
  @Metadata({ data: "queryParam, style=form;explode=true;name=statuses" })
