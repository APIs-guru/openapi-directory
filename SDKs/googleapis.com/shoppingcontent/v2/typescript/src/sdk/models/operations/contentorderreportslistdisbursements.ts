...
export class ContentOrderreportsListdisbursementsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=merchantId" })
  merchantId: string;
}


export class ContentOrderreportsListdisbursementsQueryParams extends SpeakeasyBase {
...
export class ContentOrderreportsListdisbursementsSecurity extends SpeakeasyBase {
...
export class ContentOrderreportsListdisbursementsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class ContentOrderreportsListdisbursementsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
