...
class ContentOrdersReturnlineitemRequest:
    path_params: ContentOrdersReturnlineitemPathParams = field()
    query_params: ContentOrdersReturnlineitemQueryParams = field()
    security: ContentOrdersReturnlineitemSecurity = field()
