...
class ProductStatus:
    ...
    data_quality_issues: Optional[List[ProductStatusDataQualityIssue]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('dataQualityIssues') }})
