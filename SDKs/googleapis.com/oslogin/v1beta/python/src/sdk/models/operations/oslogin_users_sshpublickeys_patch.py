...
class OsloginUsersSSHPublicKeysPatchRequest:
    path_params: OsloginUsersSSHPublicKeysPatchPathParams = field()
    query_params: OsloginUsersSSHPublicKeysPatchQueryParams = field()
    security: OsloginUsersSSHPublicKeysPatchSecurity = field()
