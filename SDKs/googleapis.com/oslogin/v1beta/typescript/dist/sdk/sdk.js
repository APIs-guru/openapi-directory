...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.OsloginUsersGetLoginProfile = function (req, config) {
        ...
        var url = utils.GenerateURL(baseURL, "/v1beta/{name}/loginProfile", req.pathParams);
    ...
    SDK.prototype.OsloginUsersImportSshPublicKey = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta/{parent}:importSshPublicKey", req.pathParams);
    ...
    SDK.prototype.OsloginUsersSshPublicKeysCreate = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta/{parent}/sshPublicKeys", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
