...
export class Users {
  ...
  **/
  osloginUsersGetLoginProfile(
    ...
    const url: string = utils.GenerateURL(baseURL, "/v1beta/{name}/loginProfile", req.pathParams);
  ...
  **/
  osloginUsersImportSshPublicKey(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta/{parent}:importSshPublicKey", req.pathParams);
  ...
  **/
  osloginUsersSshPublicKeysCreate(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta/{parent}/sshPublicKeys", req.pathParams);
