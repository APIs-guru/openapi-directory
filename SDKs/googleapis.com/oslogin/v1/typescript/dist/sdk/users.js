...
var Users = /** @class */ (function () {
    ...
    **/
    Users.prototype.osloginUsersGetLoginProfile = function (req, config) {
        ...
        var url = utils.GenerateURL(baseURL, "/v1/{name}/loginProfile", req.pathParams);
    ...
    **/
    Users.prototype.osloginUsersImportSshPublicKey = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{parent}:importSshPublicKey", req.pathParams);
    ...
    **/
    Users.prototype.osloginUsersSshPublicKeysCreate = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{parent}/sshPublicKeys", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
