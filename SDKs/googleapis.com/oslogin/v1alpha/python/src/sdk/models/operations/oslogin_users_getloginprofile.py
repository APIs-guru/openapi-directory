...
class OsloginUsersGetLoginProfileQueryParams:
    ...
    operating_system_type: Optional[OsloginUsersGetLoginProfileOperatingSystemTypeEnum] = field(default=None, metadata={'query_param': { 'field_name': 'operatingSystemType', 'style': 'form', 'explode': True }})
...
class OsloginUsersGetLoginProfileRequest:
    path_params: OsloginUsersGetLoginProfilePathParams = field()
    query_params: OsloginUsersGetLoginProfileQueryParams = field()
    security: OsloginUsersGetLoginProfileSecurity = field()
