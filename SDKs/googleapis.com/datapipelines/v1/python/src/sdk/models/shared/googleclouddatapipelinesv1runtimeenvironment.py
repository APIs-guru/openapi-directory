...
class GoogleCloudDatapipelinesV1RuntimeEnvironment:
    ...
    ip_configuration: Optional[GoogleCloudDatapipelinesV1RuntimeEnvironmentIPConfigurationEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ipConfiguration' }})
