...
from . import googleclouddatapipelinesv1flextemplateruntimeenvironment
...
class GoogleCloudDatapipelinesV1LaunchFlexTemplateParameter:
    ...
    environment: Optional[googleclouddatapipelinesv1flextemplateruntimeenvironment.GoogleCloudDatapipelinesV1FlexTemplateRuntimeEnvironment] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'environment' }})
