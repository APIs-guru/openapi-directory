...
type GamesConfigurationAchievementConfigurationsUpdatePathParams struct {
    AchievementID string `pathParam:"style=simple,explode=false,name=achievementId"`
    
}

type GamesConfigurationAchievementConfigurationsUpdateQueryParams struct {
...
type GamesConfigurationAchievementConfigurationsUpdateSecurity struct {
    Oauth2 shared.SchemeOauth2 `security:"scheme,type=oauth2"`
    Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
    
}

type GamesConfigurationAchievementConfigurationsUpdateRequest struct {
...
type GamesConfigurationAchievementConfigurationsUpdateResponse struct {
