...
export class ImageConfigurations {
  ...
  gamesConfigurationImageConfigurationsUpload(
    ...
    return client
      .request({
        ...
        const res: operations.GamesConfigurationImageConfigurationsUploadResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
