...
var AchievementConfigurations = /** @class */ (function () {
    function AchievementConfigurations(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    AchievementConfigurations.prototype.gamesConfigurationAchievementConfigurationsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GamesConfigurationAchievementConfigurationsDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/games/v1configuration/achievements/{achievementId}", req.pathParams);
    ...
    **/
    AchievementConfigurations.prototype.gamesConfigurationAchievementConfigurationsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.achievementConfiguration = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    AchievementConfigurations.prototype.gamesConfigurationAchievementConfigurationsInsert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GamesConfigurationAchievementConfigurationsInsertRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/games/v1configuration/applications/{applicationId}/achievements", req.pathParams);
    ...
    **/
    AchievementConfigurations.prototype.gamesConfigurationAchievementConfigurationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.achievementConfigurationListResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    AchievementConfigurations.prototype.gamesConfigurationAchievementConfigurationsUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
export { AchievementConfigurations };
