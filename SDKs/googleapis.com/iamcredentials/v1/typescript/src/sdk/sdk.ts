  ...
  IamcredentialsProjectsServiceAccountsGenerateAccessToken(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        let res: operations.IamcredentialsProjectsServiceAccountsGenerateAccessTokenResponse = {statusCode: httpRes.status, contentType: contentType};
  ...
  IamcredentialsProjectsServiceAccountsGenerateIdToken(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.IamcredentialsProjectsServiceAccountsGenerateIdTokenResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  IamcredentialsProjectsServiceAccountsSignBlob(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.IamcredentialsProjectsServiceAccountsSignBlobResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  IamcredentialsProjectsServiceAccountsSignJwt(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.IamcredentialsProjectsServiceAccountsSignJwtResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
