...
class FirebaseProjectsRemoveAnalyticsSecurity:
    option1: Optional[FirebaseProjectsRemoveAnalyticsSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[FirebaseProjectsRemoveAnalyticsSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
