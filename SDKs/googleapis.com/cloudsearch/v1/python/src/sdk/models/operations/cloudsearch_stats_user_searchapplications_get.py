...
@dataclass
class CloudsearchStatsUserSearchapplicationsGetQueryParams:
...
class CloudsearchStatsUserSearchapplicationsGetSecurity:
    option1: Optional[CloudsearchStatsUserSearchapplicationsGetSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[CloudsearchStatsUserSearchapplicationsGetSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[CloudsearchStatsUserSearchapplicationsGetSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
