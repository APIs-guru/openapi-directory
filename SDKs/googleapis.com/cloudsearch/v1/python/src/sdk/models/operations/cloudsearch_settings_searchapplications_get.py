...
class CloudsearchSettingsSearchapplicationsGetRequest:
    path_params: CloudsearchSettingsSearchapplicationsGetPathParams = field(default=None)
    query_params: CloudsearchSettingsSearchapplicationsGetQueryParams = field(default=None)
    security: CloudsearchSettingsSearchapplicationsGetSecurity = field(default=None)
