...
from . import htmloperatoroptions
...
class HTMLPropertyOptions:
    operator_options: Optional[htmloperatoroptions.HTMLOperatorOptions] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'operatorOptions' }})
