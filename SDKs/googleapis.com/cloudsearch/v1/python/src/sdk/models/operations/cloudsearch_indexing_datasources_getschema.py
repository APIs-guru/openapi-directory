...
@dataclass
class CloudsearchIndexingDatasourcesGetSchemaQueryParams:
...
class CloudsearchIndexingDatasourcesGetSchemaSecurity:
    option1: Optional[CloudsearchIndexingDatasourcesGetSchemaSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[CloudsearchIndexingDatasourcesGetSchemaSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[CloudsearchIndexingDatasourcesGetSchemaSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
