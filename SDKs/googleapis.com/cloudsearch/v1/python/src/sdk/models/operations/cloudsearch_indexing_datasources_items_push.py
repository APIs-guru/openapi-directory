...
class CloudsearchIndexingDatasourcesItemsPushRequest:
    path_params: CloudsearchIndexingDatasourcesItemsPushPathParams = field(default=None)
    query_params: CloudsearchIndexingDatasourcesItemsPushQueryParams = field(default=None)
    request: Optional[shared.PushItemRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: CloudsearchIndexingDatasourcesItemsPushSecurity = field(default=None)
