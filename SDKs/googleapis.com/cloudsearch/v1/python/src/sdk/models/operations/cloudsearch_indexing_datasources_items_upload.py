...
class CloudsearchIndexingDatasourcesItemsUploadRequest:
    path_params: CloudsearchIndexingDatasourcesItemsUploadPathParams = field()
    query_params: CloudsearchIndexingDatasourcesItemsUploadQueryParams = field()
    security: CloudsearchIndexingDatasourcesItemsUploadSecurity = field()
