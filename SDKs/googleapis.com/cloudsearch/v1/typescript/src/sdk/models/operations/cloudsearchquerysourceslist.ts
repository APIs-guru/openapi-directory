...
export class CloudsearchQuerySourcesListQueryParams extends SpeakeasyBase {
  ...
  @Metadata({ data: "queryParam, style=form;explode=true;name=requestOptions.debugOptions.enableDebugging" })
  requestOptionsDebugOptionsEnableDebugging?: boolean;

  @Metadata({ data: "queryParam, style=form;explode=true;name=requestOptions.languageCode" })
  requestOptionsLanguageCode?: string;

  @Metadata({ data: "queryParam, style=form;explode=true;name=requestOptions.searchApplicationId" })
  requestOptionsSearchApplicationId?: string;

  @Metadata({ data: "queryParam, style=form;explode=true;name=requestOptions.timeZone" })
