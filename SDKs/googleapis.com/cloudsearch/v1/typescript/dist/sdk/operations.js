...
var Operations = /** @class */ (function () {
    ...
    **/
    Operations.prototype.cloudsearchOperationsGet = function (req, config) {
    ...
    **/
    Operations.prototype.cloudsearchOperationsLroList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CloudsearchOperationsLroListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{name}/lro", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
