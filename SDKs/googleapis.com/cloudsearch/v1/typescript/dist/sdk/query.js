...
var Query = /** @class */ (function () {
    ...
    **/
    Query.prototype.cloudsearchQuerySearch = function (req, config) {
        var _a;
    ...
    **/
    Query.prototype.cloudsearchQuerySourcesList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.listQuerySourcesResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Query.prototype.cloudsearchQuerySuggest = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
