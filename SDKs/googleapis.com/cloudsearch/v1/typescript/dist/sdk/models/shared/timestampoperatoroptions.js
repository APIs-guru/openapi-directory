...
**/
var TimestampOperatorOptions = /** @class */ (function (_super) {
    __extends(TimestampOperatorOptions, _super);
    function TimestampOperatorOptions() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=greaterThanOperatorName" }),
        __metadata("design:type", String)
    ], TimestampOperatorOptions.prototype, "greaterThanOperatorName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=lessThanOperatorName" }),
        __metadata("design:type", String)
    ], TimestampOperatorOptions.prototype, "lessThanOperatorName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=operatorName" }),
        __metadata("design:type", String)
    ], TimestampOperatorOptions.prototype, "operatorName", void 0);
    return TimestampOperatorOptions;
}(SpeakeasyBase));
export { TimestampOperatorOptions };
