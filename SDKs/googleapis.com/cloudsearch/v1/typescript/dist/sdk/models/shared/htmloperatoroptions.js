...
**/
var HtmlOperatorOptions = /** @class */ (function (_super) {
    __extends(HtmlOperatorOptions, _super);
    function HtmlOperatorOptions() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=operatorName" }),
        __metadata("design:type", String)
    ], HtmlOperatorOptions.prototype, "operatorName", void 0);
    return HtmlOperatorOptions;
}(SpeakeasyBase));
export { HtmlOperatorOptions };
