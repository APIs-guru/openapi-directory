...
var Principal = /** @class */ (function (_super) {
    ...
    ], Principal.prototype, "groupResourceName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=gsuitePrincipal" }),
        __metadata("design:type", GSuitePrincipal)
    ], Principal.prototype, "gsuitePrincipal", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=userResourceName" }),
        __metadata("design:type", String)
    ], Principal.prototype, "userResourceName", void 0);
    return Principal;
}(SpeakeasyBase));
export { Principal };
