...
var SearchResult = /** @class */ (function (_super) {
    ...
    ], SearchResult.prototype, "clusteredResults", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=debugInfo" }),
        __metadata("design:type", ResultDebugInfo)
    ], SearchResult.prototype, "debugInfo", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], SearchResult.prototype, "url", void 0);
    return SearchResult;
}(SpeakeasyBase));
export { SearchResult };
