...
**/
var BooleanOperatorOptions = /** @class */ (function (_super) {
    __extends(BooleanOperatorOptions, _super);
    function BooleanOperatorOptions() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=operatorName" }),
        __metadata("design:type", String)
    ], BooleanOperatorOptions.prototype, "operatorName", void 0);
    return BooleanOperatorOptions;
}(SpeakeasyBase));
export { BooleanOperatorOptions };
