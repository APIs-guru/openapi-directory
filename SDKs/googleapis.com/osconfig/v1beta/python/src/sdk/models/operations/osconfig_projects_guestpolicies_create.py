...
class OsconfigProjectsGuestPoliciesCreateRequest:
    path_params: OsconfigProjectsGuestPoliciesCreatePathParams = field(default=None)
    query_params: OsconfigProjectsGuestPoliciesCreateQueryParams = field(default=None)
    request: Optional[shared.GuestPolicy] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: OsconfigProjectsGuestPoliciesCreateSecurity = field(default=None)
