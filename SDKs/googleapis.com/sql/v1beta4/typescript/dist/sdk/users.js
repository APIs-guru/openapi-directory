...
var Users = /** @class */ (function () {
    ...
    **/
    Users.prototype.sqlUsersDelete = function (req, config) {
        ...
        var url = utils.GenerateURL(baseURL, "/sql/v1beta4/projects/{project}/instances/{instance}/users", req.pathParams);
    ...
    **/
    Users.prototype.sqlUsersGet = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/sql/v1beta4/projects/{project}/instances/{instance}/users/{name}", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
