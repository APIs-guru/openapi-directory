...
var Projects = /** @class */ (function () {
    ...
    **/
    Projects.prototype.sqlProjectsInstancesRescheduleMaintenance = function (req, config) {
        ...
        var url = utils.GenerateURL(baseURL, "/sql/v1beta4/projects/{project}/instances/{instance}/rescheduleMaintenance", req.pathParams);
    ...
    **/
    Projects.prototype.sqlProjectsInstancesStartExternalSync = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/sql/v1beta4/projects/{project}/instances/{instance}/startExternalSync", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    Projects.prototype.sqlProjectsInstancesVerifyExternalSyncSettings = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/sql/v1beta4/projects/{project}/instances/{instance}/verifyExternalSyncSettings", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
