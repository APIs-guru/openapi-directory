...
class SQLProjectsInstancesVerifyExternalSyncSettingsRequest:
    path_params: SQLProjectsInstancesVerifyExternalSyncSettingsPathParams = field(default=None)
    query_params: SQLProjectsInstancesVerifyExternalSyncSettingsQueryParams = field(default=None)
    ...
    security: SQLProjectsInstancesVerifyExternalSyncSettingsSecurity = field(default=None)
