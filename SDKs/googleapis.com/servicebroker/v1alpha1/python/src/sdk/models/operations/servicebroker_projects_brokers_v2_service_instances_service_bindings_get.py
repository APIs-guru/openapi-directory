...
class ServicebrokerProjectsBrokersV2ServiceInstancesServiceBindingsGetRequest:
    path_params: ServicebrokerProjectsBrokersV2ServiceInstancesServiceBindingsGetPathParams = field(default=None)
    query_params: ServicebrokerProjectsBrokersV2ServiceInstancesServiceBindingsGetQueryParams = field(default=None)
    security: ServicebrokerProjectsBrokersV2ServiceInstancesServiceBindingsGetSecurity = field(default=None)
