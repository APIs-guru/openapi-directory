...
func NewV1alpha1(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *V1alpha1 {
	return &V1alpha1{
...
// set.
func (s *V1alpha1) ServicebrokerGetIamPolicy(ctx context.Context, request operations.ServicebrokerGetIamPolicyRequest) (*operations.ServicebrokerGetIamPolicyResponse, error) {
...
func (s *V1alpha1) ServicebrokerSetIamPolicy(ctx context.Context, request operations.ServicebrokerSetIamPolicyRequest) (*operations.ServicebrokerSetIamPolicyResponse, error) {
	baseURL := s._serverURL
...
func (s *V1alpha1) ServicebrokerTestIamPermissions(ctx context.Context, request operations.ServicebrokerTestIamPermissionsRequest) (*operations.ServicebrokerTestIamPermissionsResponse, error) {
	baseURL := s._serverURL
