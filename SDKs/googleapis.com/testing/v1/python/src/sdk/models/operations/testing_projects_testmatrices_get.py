...
class TestingProjectsTestMatricesGetSecurity:
    option1: Optional[TestingProjectsTestMatricesGetSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[TestingProjectsTestMatricesGetSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
