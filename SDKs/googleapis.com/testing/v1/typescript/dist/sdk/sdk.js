...
var SDK = /** @class */ (function () {
    function SDK() {
        ...
        this.applicationDetailService = new ApplicationDetailService(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
        ...
        this.testEnvironmentCatalog = new TestEnvironmentCatalog(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
    }
    return SDK;
}());
export { SDK };
