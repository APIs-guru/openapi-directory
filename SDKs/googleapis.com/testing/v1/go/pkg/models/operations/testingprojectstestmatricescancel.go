...
type TestingProjectsTestMatricesCancelPathParams struct {
	ProjectID    string `pathParam:"style=simple,explode=false,name=projectId"`
	TestMatrixID string `pathParam:"style=simple,explode=false,name=testMatrixId"`
}

type TestingProjectsTestMatricesCancelQueryParams struct {
...
type TestingProjectsTestMatricesCancelSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type TestingProjectsTestMatricesCancelRequest struct {
...
type TestingProjectsTestMatricesCancelResponse struct {
