...
**/
var AnalyzePackagesRequestV1 = /** @class */ (function (_super) {
    __extends(AnalyzePackagesRequestV1, _super);
    function AnalyzePackagesRequestV1() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=includeOsvData" }),
        __metadata("design:type", Boolean)
    ], AnalyzePackagesRequestV1.prototype, "includeOsvData", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=packages", elemType: PackageData }),
        __metadata("design:type", Array)
    ], AnalyzePackagesRequestV1.prototype, "packages", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=resourceUri" }),
        __metadata("design:type", String)
    ], AnalyzePackagesRequestV1.prototype, "resourceUri", void 0);
    return AnalyzePackagesRequestV1;
}(SpeakeasyBase));
export { AnalyzePackagesRequestV1 };
