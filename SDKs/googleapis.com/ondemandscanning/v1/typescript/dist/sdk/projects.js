...
var Projects = /** @class */ (function () {
    ...
    **/
    Projects.prototype.ondemandscanningProjectsLocationsOperationsCancel = function (req, config) {
    ...
    **/
    Projects.prototype.ondemandscanningProjectsLocationsOperationsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Projects.prototype.ondemandscanningProjectsLocationsOperationsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Projects.prototype.ondemandscanningProjectsLocationsOperationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Projects.prototype.ondemandscanningProjectsLocationsOperationsWait = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.OndemandscanningProjectsLocationsOperationsWaitRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{name}:wait", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    Projects.prototype.ondemandscanningProjectsLocationsScansAnalyzePackages = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.OndemandscanningProjectsLocationsScansAnalyzePackagesRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{parent}/scans:analyzePackages", req.pathParams);
    ...
    **/
    Projects.prototype.ondemandscanningProjectsLocationsScansVulnerabilitiesList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.OndemandscanningProjectsLocationsScansVulnerabilitiesListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{parent}/vulnerabilities", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.listVulnerabilitiesResponseV1 = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
