...
class FirebaseappcheckProjectsAppsGeneratePlayIntegrityChallengeSecurity:
    option1: Optional[FirebaseappcheckProjectsAppsGeneratePlayIntegrityChallengeSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[FirebaseappcheckProjectsAppsGeneratePlayIntegrityChallengeSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
...
class FirebaseappcheckProjectsAppsGeneratePlayIntegrityChallengeResponse:
    ...
    google_firebase_appcheck_v1beta_generate_play_integrity_challenge_response: Optional[shared.GoogleFirebaseAppcheckV1betaGeneratePlayIntegrityChallengeResponse] = field(default=None)
