...
class FirebaseappcheckProjectsServicesBatchUpdateRequest:
    ...
    request: Optional[shared.GoogleFirebaseAppcheckV1betaBatchUpdateServicesRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class FirebaseappcheckProjectsServicesBatchUpdateResponse:
    ...
    google_firebase_appcheck_v1beta_batch_update_services_response: Optional[shared.GoogleFirebaseAppcheckV1betaBatchUpdateServicesResponse] = field(default=None)
