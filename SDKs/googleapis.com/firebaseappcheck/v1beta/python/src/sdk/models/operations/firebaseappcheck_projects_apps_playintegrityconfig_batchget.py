...
class FirebaseappcheckProjectsAppsPlayIntegrityConfigBatchGetResponse:
    ...
    google_firebase_appcheck_v1beta_batch_get_play_integrity_configs_response: Optional[shared.GoogleFirebaseAppcheckV1betaBatchGetPlayIntegrityConfigsResponse] = field(default=None)
