...
class GoogleFirebaseAppcheckV1betaBatchGetRecaptchaEnterpriseConfigsResponse:
    ...
    configs: Optional[List[GoogleFirebaseAppcheckV1betaRecaptchaEnterpriseConfig]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('configs') }})
