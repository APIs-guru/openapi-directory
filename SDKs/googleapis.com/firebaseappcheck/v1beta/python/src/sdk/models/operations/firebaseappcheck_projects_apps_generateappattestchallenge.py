...
class FirebaseappcheckProjectsAppsGenerateAppAttestChallengeRequest:
    path_params: FirebaseappcheckProjectsAppsGenerateAppAttestChallengePathParams = field()
    query_params: FirebaseappcheckProjectsAppsGenerateAppAttestChallengeQueryParams = field()
    security: FirebaseappcheckProjectsAppsGenerateAppAttestChallengeSecurity = field()
