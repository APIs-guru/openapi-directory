...
class FirebaseappcheckProjectsAppsExchangeRecaptchaTokenRequest:
    path_params: FirebaseappcheckProjectsAppsExchangeRecaptchaTokenPathParams = field()
    query_params: FirebaseappcheckProjectsAppsExchangeRecaptchaTokenQueryParams = field()
    security: FirebaseappcheckProjectsAppsExchangeRecaptchaTokenSecurity = field()
