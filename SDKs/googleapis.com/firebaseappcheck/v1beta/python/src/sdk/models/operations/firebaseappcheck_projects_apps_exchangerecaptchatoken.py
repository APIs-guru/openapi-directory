...
class FirebaseappcheckProjectsAppsExchangeRecaptchaTokenSecurity:
    option1: Optional[FirebaseappcheckProjectsAppsExchangeRecaptchaTokenSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[FirebaseappcheckProjectsAppsExchangeRecaptchaTokenSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class FirebaseappcheckProjectsAppsExchangeRecaptchaTokenRequest:
    path_params: FirebaseappcheckProjectsAppsExchangeRecaptchaTokenPathParams = field(default=None)
    query_params: FirebaseappcheckProjectsAppsExchangeRecaptchaTokenQueryParams = field(default=None)
    request: Optional[shared.GoogleFirebaseAppcheckV1betaExchangeRecaptchaTokenRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: FirebaseappcheckProjectsAppsExchangeRecaptchaTokenSecurity = field(default=None)
