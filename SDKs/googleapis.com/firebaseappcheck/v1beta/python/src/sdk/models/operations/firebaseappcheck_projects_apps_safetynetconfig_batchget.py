...
class FirebaseappcheckProjectsAppsSafetyNetConfigBatchGetRequest:
    path_params: FirebaseappcheckProjectsAppsSafetyNetConfigBatchGetPathParams = field(default=None)
    query_params: FirebaseappcheckProjectsAppsSafetyNetConfigBatchGetQueryParams = field(default=None)
    security: FirebaseappcheckProjectsAppsSafetyNetConfigBatchGetSecurity = field(default=None)
    

@dataclass
class FirebaseappcheckProjectsAppsSafetyNetConfigBatchGetResponse:
    content_type: str = field(default=None)
    google_firebase_appcheck_v1beta_batch_get_safety_net_configs_response: Optional[shared.GoogleFirebaseAppcheckV1betaBatchGetSafetyNetConfigsResponse] = field(default=None)
