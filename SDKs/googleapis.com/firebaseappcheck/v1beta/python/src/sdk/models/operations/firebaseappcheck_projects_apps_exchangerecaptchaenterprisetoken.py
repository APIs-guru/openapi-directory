...
class FirebaseappcheckProjectsAppsExchangeRecaptchaEnterpriseTokenRequest:
    path_params: FirebaseappcheckProjectsAppsExchangeRecaptchaEnterpriseTokenPathParams = field()
    query_params: FirebaseappcheckProjectsAppsExchangeRecaptchaEnterpriseTokenQueryParams = field()
    security: FirebaseappcheckProjectsAppsExchangeRecaptchaEnterpriseTokenSecurity = field()
