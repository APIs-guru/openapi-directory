...
class FirebaseappcheckProjectsAppsExchangeRecaptchaEnterpriseTokenSecurity:
    option1: Optional[FirebaseappcheckProjectsAppsExchangeRecaptchaEnterpriseTokenSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[FirebaseappcheckProjectsAppsExchangeRecaptchaEnterpriseTokenSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class FirebaseappcheckProjectsAppsExchangeRecaptchaEnterpriseTokenRequest:
    path_params: FirebaseappcheckProjectsAppsExchangeRecaptchaEnterpriseTokenPathParams = field(default=None)
    query_params: FirebaseappcheckProjectsAppsExchangeRecaptchaEnterpriseTokenQueryParams = field(default=None)
    request: Optional[shared.GoogleFirebaseAppcheckV1betaExchangeRecaptchaEnterpriseTokenRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: FirebaseappcheckProjectsAppsExchangeRecaptchaEnterpriseTokenSecurity = field(default=None)
