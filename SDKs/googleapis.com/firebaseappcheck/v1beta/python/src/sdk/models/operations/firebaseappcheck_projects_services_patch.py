...
class FirebaseappcheckProjectsServicesPatchRequest:
    path_params: FirebaseappcheckProjectsServicesPatchPathParams = field()
    query_params: FirebaseappcheckProjectsServicesPatchQueryParams = field()
    security: FirebaseappcheckProjectsServicesPatchSecurity = field()
    request: Optional[shared.GoogleFirebaseAppcheckV1betaService] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class FirebaseappcheckProjectsServicesPatchResponse:
    ...
    google_firebase_appcheck_v1beta_service: Optional[shared.GoogleFirebaseAppcheckV1betaService] = field(default=None)
