...
**/
var GoogleFirebaseAppcheckV1PlayIntegrityConfig = /** @class */ (function (_super) {
    __extends(GoogleFirebaseAppcheckV1PlayIntegrityConfig, _super);
    function GoogleFirebaseAppcheckV1PlayIntegrityConfig() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=name" }),
        __metadata("design:type", String)
    ], GoogleFirebaseAppcheckV1PlayIntegrityConfig.prototype, "name", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=tokenTtl" }),
        __metadata("design:type", String)
    ], GoogleFirebaseAppcheckV1PlayIntegrityConfig.prototype, "tokenTtl", void 0);
    return GoogleFirebaseAppcheckV1PlayIntegrityConfig;
}(SpeakeasyBase));
export { GoogleFirebaseAppcheckV1PlayIntegrityConfig };
