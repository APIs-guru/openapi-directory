...
export class SDK {
  ...
  FirebaseappcheckProjectsAppsAppAttestConfigBatchGet(
    ...
    const url: string = utils.GenerateURL(baseURL, "/v1/{parent}/apps/-/appAttestConfig:batchGet", req.pathParams);
        ...
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleFirebaseAppcheckV1BatchGetAppAttestConfigsResponse = httpRes?.data;
            }
            break;
        }
  ...
  FirebaseappcheckProjectsAppsDebugTokensCreate(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{parent}/debugTokens", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleFirebaseAppcheckV1DebugToken = httpRes?.data;
            }
            break;
        }
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleFirebaseAppcheckV1ListDebugTokensResponse = httpRes?.data;
            }
            break;
        }
  ...
  FirebaseappcheckProjectsAppsDeviceCheckConfigBatchGet(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{parent}/apps/-/deviceCheckConfig:batchGet", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleFirebaseAppcheckV1BatchGetDeviceCheckConfigsResponse = httpRes?.data;
            }
            break;
        }
  ...
  FirebaseappcheckProjectsAppsExchangeAppAttestAssertion(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{app}:exchangeAppAttestAssertion", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleFirebaseAppcheckV1AppCheckToken = httpRes?.data;
            }
            break;
        }
  ...
  FirebaseappcheckProjectsAppsExchangeAppAttestAttestation(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{app}:exchangeAppAttestAttestation", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleFirebaseAppcheckV1ExchangeAppAttestAttestationResponse = httpRes?.data;
            }
            break;
        }
  ...
  FirebaseappcheckProjectsAppsExchangeCustomToken(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{app}:exchangeCustomToken", req.pathParams);
  ...
  FirebaseappcheckProjectsAppsExchangeDebugToken(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{app}:exchangeDebugToken", req.pathParams);
  ...
  FirebaseappcheckProjectsAppsExchangeDeviceCheckToken(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{app}:exchangeDeviceCheckToken", req.pathParams);
  ...
  FirebaseappcheckProjectsAppsExchangePlayIntegrityToken(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{app}:exchangePlayIntegrityToken", req.pathParams);
  ...
  FirebaseappcheckProjectsAppsExchangeRecaptchaEnterpriseToken(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{app}:exchangeRecaptchaEnterpriseToken", req.pathParams);
  ...
  FirebaseappcheckProjectsAppsExchangeRecaptchaV3Token(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{app}:exchangeRecaptchaV3Token", req.pathParams);
  ...
  FirebaseappcheckProjectsAppsExchangeSafetyNetToken(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{app}:exchangeSafetyNetToken", req.pathParams);
  ...
  FirebaseappcheckProjectsAppsGenerateAppAttestChallenge(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{app}:generateAppAttestChallenge", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleFirebaseAppcheckV1GenerateAppAttestChallengeResponse = httpRes?.data;
            }
            break;
        }
  ...
  FirebaseappcheckProjectsAppsGeneratePlayIntegrityChallenge(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{app}:generatePlayIntegrityChallenge", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleFirebaseAppcheckV1GeneratePlayIntegrityChallengeResponse = httpRes?.data;
            }
            break;
        }
  ...
  FirebaseappcheckProjectsAppsPlayIntegrityConfigBatchGet(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{parent}/apps/-/playIntegrityConfig:batchGet", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleFirebaseAppcheckV1BatchGetPlayIntegrityConfigsResponse = httpRes?.data;
            }
            break;
        }
  ...
  FirebaseappcheckProjectsAppsRecaptchaEnterpriseConfigBatchGet(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{parent}/apps/-/recaptchaEnterpriseConfig:batchGet", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleFirebaseAppcheckV1BatchGetRecaptchaEnterpriseConfigsResponse = httpRes?.data;
            }
            break;
        }
  ...
  FirebaseappcheckProjectsAppsRecaptchaV3ConfigBatchGet(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{parent}/apps/-/recaptchaV3Config:batchGet", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleFirebaseAppcheckV1BatchGetRecaptchaV3ConfigsResponse = httpRes?.data;
            }
            break;
        }
  ...
  FirebaseappcheckProjectsAppsSafetyNetConfigBatchGet(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{parent}/apps/-/safetyNetConfig:batchGet", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleFirebaseAppcheckV1BatchGetSafetyNetConfigsResponse = httpRes?.data;
            }
            break;
        }
  ...
  FirebaseappcheckProjectsServicesBatchUpdate(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{parent}/services:batchUpdate", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleFirebaseAppcheckV1BatchUpdateServicesResponse = httpRes?.data;
            }
            break;
        }
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleFirebaseAppcheckV1Service = httpRes?.data;
            }
            break;
        }
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleFirebaseAppcheckV1ListServicesResponse = httpRes?.data;
            }
            break;
        }
