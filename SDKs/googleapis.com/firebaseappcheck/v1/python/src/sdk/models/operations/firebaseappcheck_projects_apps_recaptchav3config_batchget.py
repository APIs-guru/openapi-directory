...
class FirebaseappcheckProjectsAppsRecaptchaV3ConfigBatchGetSecurity:
    option1: Optional[FirebaseappcheckProjectsAppsRecaptchaV3ConfigBatchGetSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[FirebaseappcheckProjectsAppsRecaptchaV3ConfigBatchGetSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
...
class FirebaseappcheckProjectsAppsRecaptchaV3ConfigBatchGetResponse:
    ...
    google_firebase_appcheck_v1_batch_get_recaptcha_v3_configs_response: Optional[shared.GoogleFirebaseAppcheckV1BatchGetRecaptchaV3ConfigsResponse] = field(default=None)
