...
class FirebaseappcheckProjectsServicesBatchUpdateSecurity:
    option1: Optional[FirebaseappcheckProjectsServicesBatchUpdateSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[FirebaseappcheckProjectsServicesBatchUpdateSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
