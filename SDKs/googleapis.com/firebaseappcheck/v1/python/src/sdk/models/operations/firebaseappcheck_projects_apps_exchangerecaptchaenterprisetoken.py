...
class FirebaseappcheckProjectsAppsExchangeRecaptchaEnterpriseTokenRequest:
    ...
    request: Optional[shared.GoogleFirebaseAppcheckV1ExchangeRecaptchaEnterpriseTokenRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
