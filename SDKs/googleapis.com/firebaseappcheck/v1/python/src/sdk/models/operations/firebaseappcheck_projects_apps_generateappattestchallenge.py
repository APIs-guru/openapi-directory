...
class FirebaseappcheckProjectsAppsGenerateAppAttestChallengeResponse:
    ...
    google_firebase_appcheck_v1_generate_app_attest_challenge_response: Optional[shared.GoogleFirebaseAppcheckV1GenerateAppAttestChallengeResponse] = field(default=None)
