...
@dataclass
class DlpProjectsLocationsJobTriggersListQueryParams:
    ...
    type: Optional[DlpProjectsLocationsJobTriggersListTypeEnum] = field(default=None, metadata={'query_param': { 'field_name': 'type', 'style': 'form', 'explode': True }})
