...
type DlpProjectsLocationsDeidentifyTemplatesListPathParams struct {
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type DlpProjectsLocationsDeidentifyTemplatesListQueryParams struct {
...
type DlpProjectsLocationsDeidentifyTemplatesListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type DlpProjectsLocationsDeidentifyTemplatesListRequest struct {
...
type DlpProjectsLocationsDeidentifyTemplatesListResponse struct {
	ContentType                                       string
