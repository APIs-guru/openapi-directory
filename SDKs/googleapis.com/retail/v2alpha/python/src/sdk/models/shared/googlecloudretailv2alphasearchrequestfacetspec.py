...
from . import googlecloudretailv2alphasearchrequestfacetspecfacetkey
...
class GoogleCloudRetailV2alphaSearchRequestFacetSpec:
    ...
    facet_key: Optional[googlecloudretailv2alphasearchrequestfacetspecfacetkey.GoogleCloudRetailV2alphaSearchRequestFacetSpecFacetKey] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'facetKey' }})
