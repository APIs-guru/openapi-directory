...
@dataclass
class RetailProjectsLocationsCatalogsUserEventsPurgeQueryParams:
...
class RetailProjectsLocationsCatalogsUserEventsPurgeRequest:
    ...
    request: Optional[shared.GoogleCloudRetailV2alphaPurgeUserEventsRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
