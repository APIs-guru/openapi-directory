...
class GoogleCloudRetailV2alphaMerchantCenterLink:
    r"""GoogleCloudRetailV2alphaMerchantCenterLink
    ...
    feeds: Optional[List[GoogleCloudRetailV2alphaMerchantCenterFeedFilter]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('feeds') }})
