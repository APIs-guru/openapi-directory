...
class GoogleCloudRetailV2alphaSetInventoryRequestInput:
    r"""GoogleCloudRetailV2alphaSetInventoryRequestInput
    ...
    inventory: Optional[GoogleCloudRetailV2alphaProductInput] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('inventory') }})
