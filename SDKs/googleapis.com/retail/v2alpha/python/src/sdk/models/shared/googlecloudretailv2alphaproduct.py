...
@dataclass_json
@dataclass
class GoogleCloudRetailV2alphaProductInput:
    r"""GoogleCloudRetailV2alphaProductInput
    ...
    audience: Optional[GoogleCloudRetailV2alphaAudience] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('audience') }})
    availability: Optional[GoogleCloudRetailV2alphaProductAvailabilityEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('availability') }})
    ...
    color_info: Optional[GoogleCloudRetailV2alphaColorInfo] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('colorInfo') }})
    ...
    fulfillment_info: Optional[List[GoogleCloudRetailV2alphaFulfillmentInfo]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('fulfillmentInfo') }})
    gtin: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('gtin') }})
    id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('id') }})
    images: Optional[List[GoogleCloudRetailV2alphaImage]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('images') }})
    ...
    promotions: Optional[List[GoogleCloudRetailV2alphaPromotion]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('promotions') }})
    publish_time: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('publishTime') }})
    rating: Optional[GoogleCloudRetailV2alphaRating] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('rating') }})
    ...
    type: Optional[GoogleCloudRetailV2alphaProductTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
...
class GoogleCloudRetailV2alphaProduct:
    r"""GoogleCloudRetailV2alphaProduct
    Product captures all metadata information of items to be recommended or searched.
    """
    ...
    images: Optional[List[GoogleCloudRetailV2alphaImage]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('images') }})
    language_code: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('languageCode') }})
    local_inventories: Optional[List[GoogleCloudRetailV2alphaLocalInventory]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('localInventories') }})
    materials: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('materials') }})
    name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('name') }})
    patterns: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('patterns') }})
    price_info: Optional[GoogleCloudRetailV2alphaPriceInfo] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('priceInfo') }})
    ...
    type: Optional[GoogleCloudRetailV2alphaProductTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
    uri: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('uri') }})
    variants: Optional[List[GoogleCloudRetailV2alphaProduct]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('variants') }})
