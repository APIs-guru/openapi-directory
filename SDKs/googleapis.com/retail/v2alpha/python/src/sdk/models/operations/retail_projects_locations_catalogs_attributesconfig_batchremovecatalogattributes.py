...
class RetailProjectsLocationsCatalogsAttributesConfigBatchRemoveCatalogAttributesRequest:
    ...
    request: Optional[shared.GoogleCloudRetailV2alphaBatchRemoveCatalogAttributesRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class RetailProjectsLocationsCatalogsAttributesConfigBatchRemoveCatalogAttributesResponse:
    ...
    google_cloud_retail_v2alpha_batch_remove_catalog_attributes_response: Optional[shared.GoogleCloudRetailV2alphaBatchRemoveCatalogAttributesResponse] = field(default=None)
