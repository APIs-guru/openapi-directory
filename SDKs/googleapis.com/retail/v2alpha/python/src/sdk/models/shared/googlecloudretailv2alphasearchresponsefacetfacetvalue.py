...
class GoogleCloudRetailV2alphaSearchResponseFacetFacetValue:
    r"""GoogleCloudRetailV2alphaSearchResponseFacetFacetValue
    A facet value which contains value names and their count.
    """
    
    count: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('count') }})
    interval: Optional[GoogleCloudRetailV2alphaInterval] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('interval') }})
