...
class GoogleCloudRetailV2alphaPredictResponse:
    r"""GoogleCloudRetailV2alphaPredictResponse
    ...
    results: Optional[List[GoogleCloudRetailV2alphaPredictResponsePredictionResult]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
