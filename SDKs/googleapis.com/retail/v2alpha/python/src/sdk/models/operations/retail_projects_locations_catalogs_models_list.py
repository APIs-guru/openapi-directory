...
@dataclass
class RetailProjectsLocationsCatalogsModelsListQueryParams:
...
class RetailProjectsLocationsCatalogsModelsListResponse:
    ...
    google_cloud_retail_v2alpha_list_models_response: Optional[shared.GoogleCloudRetailV2alphaListModelsResponse] = field(default=None)
