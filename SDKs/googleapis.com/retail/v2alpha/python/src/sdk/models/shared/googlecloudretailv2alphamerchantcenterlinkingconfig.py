...
class GoogleCloudRetailV2alphaMerchantCenterLinkingConfig:
    r"""GoogleCloudRetailV2alphaMerchantCenterLinkingConfig
    ...
    links: Optional[List[GoogleCloudRetailV2alphaMerchantCenterLink]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('links') }})
