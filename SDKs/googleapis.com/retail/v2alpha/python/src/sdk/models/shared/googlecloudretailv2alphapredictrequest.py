...
@dataclass_json
@dataclass
class GoogleCloudRetailV2alphaPredictRequestInput:
    r"""GoogleCloudRetailV2alphaPredictRequestInput
    ...
    user_event: Optional[GoogleCloudRetailV2alphaUserEventInput] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('userEvent') }})
