...
class GoogleCloudRetailV2SetInventoryRequestInput:
    r"""GoogleCloudRetailV2SetInventoryRequestInput
    ...
    inventory: Optional[GoogleCloudRetailV2ProductInput] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('inventory') }})
