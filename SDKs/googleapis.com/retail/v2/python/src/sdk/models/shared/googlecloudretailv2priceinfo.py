...
class GoogleCloudRetailV2PriceInfo:
    r"""GoogleCloudRetailV2PriceInfo
    ...
    price_range: Optional[GoogleCloudRetailV2PriceInfoPriceRange] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('priceRange') }})
