...
class GoogleCloudRetailV2SearchRequestFacetSpecFacetKey:
    r"""GoogleCloudRetailV2SearchRequestFacetSpecFacetKey
    ...
    intervals: Optional[List[GoogleCloudRetailV2Interval]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('intervals') }})
