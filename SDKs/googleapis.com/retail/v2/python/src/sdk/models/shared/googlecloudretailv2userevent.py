...
class GoogleCloudRetailV2UserEvent:
    r"""GoogleCloudRetailV2UserEvent
    ...
    completion_detail: Optional[GoogleCloudRetailV2CompletionDetail] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('completionDetail') }})
    ...
    product_details: Optional[List[GoogleCloudRetailV2ProductDetail]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('productDetails') }})
    purchase_transaction: Optional[GoogleCloudRetailV2PurchaseTransaction] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('purchaseTransaction') }})
...
class GoogleCloudRetailV2UserEventInput:
    r"""GoogleCloudRetailV2UserEventInput
    UserEvent captures all metadata information Retail API needs to know about how end users interact with customers' website.
    """
    ...
    page_categories: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('pageCategories') }})
    page_view_id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('pageViewId') }})
    product_details: Optional[List[GoogleCloudRetailV2ProductDetailInput]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('productDetails') }})
    purchase_transaction: Optional[GoogleCloudRetailV2PurchaseTransaction] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('purchaseTransaction') }})
    referrer_uri: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('referrerUri') }})
    search_query: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('searchQuery') }})
    session_id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sessionId') }})
