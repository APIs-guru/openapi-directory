...
class GoogleCloudRetailV2PredictResponse:
    r"""GoogleCloudRetailV2PredictResponse
    ...
    results: Optional[List[GoogleCloudRetailV2PredictResponsePredictionResult]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
