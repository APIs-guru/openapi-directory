...
class GoogleCloudRetailV2SearchRequestFacetSpec:
    r"""GoogleCloudRetailV2SearchRequestFacetSpec
    ...
    facet_key: Optional[GoogleCloudRetailV2SearchRequestFacetSpecFacetKey] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('facetKey') }})
