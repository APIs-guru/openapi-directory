...
class GoogleCloudRetailV2ProductInputConfigInput:
    r"""GoogleCloudRetailV2ProductInputConfigInput
    ...
    product_inline_source: Optional[GoogleCloudRetailV2ProductInlineSourceInput] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('productInlineSource') }})
