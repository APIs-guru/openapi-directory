...
export class SDK {
  ...
  RetailProjectsLocationsCatalogsAttributesConfigAddCatalogAttribute(
    ...
    const url: string = utils.GenerateURL(baseURL, "/v2/{attributesConfig}:addCatalogAttribute", req.pathParams);
        ...
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleCloudRetailV2AttributesConfig = httpRes?.data;
            }
            break;
        }
  ...
  RetailProjectsLocationsCatalogsAttributesConfigRemoveCatalogAttribute(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{attributesConfig}:removeCatalogAttribute", req.pathParams);
  ...
  RetailProjectsLocationsCatalogsAttributesConfigReplaceCatalogAttribute(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{attributesConfig}:replaceCatalogAttribute", req.pathParams);
  ...
  RetailProjectsLocationsCatalogsBranchesProductsAddFulfillmentPlaces(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{product}:addFulfillmentPlaces", req.pathParams);
  ...
  RetailProjectsLocationsCatalogsBranchesProductsAddLocalInventories(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{product}:addLocalInventories", req.pathParams);
  ...
  RetailProjectsLocationsCatalogsBranchesProductsCreate(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{parent}/products", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleCloudRetailV2Product = httpRes?.data;
            }
            break;
        }
  ...
  RetailProjectsLocationsCatalogsBranchesProductsImport(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{parent}/products:import", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleCloudRetailV2ListProductsResponse = httpRes?.data;
            }
            break;
        }
  ...
  RetailProjectsLocationsCatalogsBranchesProductsRemoveFulfillmentPlaces(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{product}:removeFulfillmentPlaces", req.pathParams);
  ...
  RetailProjectsLocationsCatalogsBranchesProductsRemoveLocalInventories(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{product}:removeLocalInventories", req.pathParams);
  ...
  RetailProjectsLocationsCatalogsBranchesProductsSetInventory(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{name}:setInventory", req.pathParams);
  ...
  RetailProjectsLocationsCatalogsCompleteQuery(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{catalog}:completeQuery", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleCloudRetailV2CompleteQueryResponse = httpRes?.data;
            }
            break;
        }
  ...
  RetailProjectsLocationsCatalogsCompletionDataImport(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{parent}/completionData:import", req.pathParams);
  ...
  RetailProjectsLocationsCatalogsControlsCreate(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{parent}/controls", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleCloudRetailV2Control = httpRes?.data;
            }
            break;
        }
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleCloudRetailV2ListControlsResponse = httpRes?.data;
            }
            break;
        }
  ...
  RetailProjectsLocationsCatalogsGetDefaultBranch(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{catalog}:getDefaultBranch", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleCloudRetailV2GetDefaultBranchResponse = httpRes?.data;
            }
            break;
        }
  ...
  RetailProjectsLocationsCatalogsList(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{parent}/catalogs", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleCloudRetailV2ListCatalogsResponse = httpRes?.data;
            }
            break;
        }
  ...
  RetailProjectsLocationsCatalogsServingConfigsAddControl(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{servingConfig}:addControl", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleCloudRetailV2ServingConfig = httpRes?.data;
            }
            break;
        }
  ...
  RetailProjectsLocationsCatalogsServingConfigsCreate(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{parent}/servingConfigs", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleCloudRetailV2ListServingConfigsResponse = httpRes?.data;
            }
            break;
        }
  ...
  RetailProjectsLocationsCatalogsServingConfigsPredict(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{placement}:predict", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleCloudRetailV2PredictResponse = httpRes?.data;
            }
            break;
        }
  ...
  RetailProjectsLocationsCatalogsServingConfigsRemoveControl(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{servingConfig}:removeControl", req.pathParams);
  ...
  RetailProjectsLocationsCatalogsServingConfigsSearch(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{placement}:search", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleCloudRetailV2SearchResponse = httpRes?.data;
            }
            break;
        }
  ...
  RetailProjectsLocationsCatalogsSetDefaultBranch(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{catalog}:setDefaultBranch", req.pathParams);
  ...
  RetailProjectsLocationsCatalogsUserEventsCollect(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{parent}/userEvents:collect", req.pathParams);
  ...
  RetailProjectsLocationsCatalogsUserEventsImport(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{parent}/userEvents:import", req.pathParams);
  ...
  RetailProjectsLocationsCatalogsUserEventsPurge(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{parent}/userEvents:purge", req.pathParams);
  ...
  RetailProjectsLocationsCatalogsUserEventsRejoin(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{parent}/userEvents:rejoin", req.pathParams);
  ...
  RetailProjectsLocationsCatalogsUserEventsWrite(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{parent}/userEvents:write", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleCloudRetailV2UserEvent = httpRes?.data;
            }
            break;
        }
