...
**/
var GoogleCloudRetailV2CompleteQueryResponse = /** @class */ (function (_super) {
    __extends(GoogleCloudRetailV2CompleteQueryResponse, _super);
    function GoogleCloudRetailV2CompleteQueryResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=attributionToken" }),
        __metadata("design:type", String)
    ], GoogleCloudRetailV2CompleteQueryResponse.prototype, "attributionToken", void 0);
    __decorate([
    ...
    ], GoogleCloudRetailV2CompleteQueryResponse.prototype, "completionResults", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=recentSearchResults", elemType: GoogleCloudRetailV2CompleteQueryResponseRecentSearchResult }),
        __metadata("design:type", Array)
    ], GoogleCloudRetailV2CompleteQueryResponse.prototype, "recentSearchResults", void 0);
    return GoogleCloudRetailV2CompleteQueryResponse;
}(SpeakeasyBase));
export { GoogleCloudRetailV2CompleteQueryResponse };
