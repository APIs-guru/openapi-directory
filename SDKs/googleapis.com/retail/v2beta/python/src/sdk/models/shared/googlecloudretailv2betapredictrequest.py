...
class GoogleCloudRetailV2betaPredictRequestInput:
    r"""GoogleCloudRetailV2betaPredictRequestInput
    ...
    user_event: Optional[GoogleCloudRetailV2betaUserEventInput] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('userEvent') }})
