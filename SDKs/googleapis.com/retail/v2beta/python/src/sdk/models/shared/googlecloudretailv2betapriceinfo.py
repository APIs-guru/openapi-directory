...
class GoogleCloudRetailV2betaPriceInfo:
    r"""GoogleCloudRetailV2betaPriceInfo
    ...
    price_range: Optional[GoogleCloudRetailV2betaPriceInfoPriceRange] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('priceRange') }})
