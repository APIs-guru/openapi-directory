...
class RetailProjectsLocationsCatalogsAttributesConfigRemoveCatalogAttributeRequest:
    ...
    request: Optional[shared.GoogleCloudRetailV2betaRemoveCatalogAttributeRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class RetailProjectsLocationsCatalogsAttributesConfigRemoveCatalogAttributeResponse:
    ...
    google_cloud_retail_v2beta_attributes_config: Optional[shared.GoogleCloudRetailV2betaAttributesConfig] = field(default=None)
