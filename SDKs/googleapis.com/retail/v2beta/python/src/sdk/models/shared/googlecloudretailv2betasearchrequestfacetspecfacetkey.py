...
class GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey:
    r"""GoogleCloudRetailV2betaSearchRequestFacetSpecFacetKey
    ...
    intervals: Optional[List[GoogleCloudRetailV2betaInterval]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('intervals') }})
