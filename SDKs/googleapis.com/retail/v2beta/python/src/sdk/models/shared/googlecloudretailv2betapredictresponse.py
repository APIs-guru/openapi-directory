...
from . import googlecloudretailv2betapredictresponsepredictionresult
...
class GoogleCloudRetailV2betaPredictResponse:
    ...
    results: Optional[List[googlecloudretailv2betapredictresponsepredictionresult.GoogleCloudRetailV2betaPredictResponsePredictionResult]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'results' }})
