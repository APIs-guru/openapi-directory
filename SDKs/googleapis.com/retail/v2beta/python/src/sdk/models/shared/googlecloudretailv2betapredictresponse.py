...
class GoogleCloudRetailV2betaPredictResponse:
    r"""GoogleCloudRetailV2betaPredictResponse
    ...
    results: Optional[List[GoogleCloudRetailV2betaPredictResponsePredictionResult]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
