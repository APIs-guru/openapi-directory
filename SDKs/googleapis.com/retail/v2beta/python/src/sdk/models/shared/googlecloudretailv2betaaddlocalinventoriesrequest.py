...
class GoogleCloudRetailV2betaAddLocalInventoriesRequest:
    r"""GoogleCloudRetailV2betaAddLocalInventoriesRequest
    ...
    local_inventories: Optional[List[GoogleCloudRetailV2betaLocalInventory]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('localInventories') }})
