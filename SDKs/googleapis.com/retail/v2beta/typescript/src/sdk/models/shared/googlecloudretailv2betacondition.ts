...
export class GoogleCloudRetailV2betaCondition extends SpeakeasyBase {
  @Metadata({ data: "json, name=activeTimeRange", elemType: shared.GoogleCloudRetailV2betaConditionTimeRange })
  activeTimeRange?: GoogleCloudRetailV2betaConditionTimeRange[];

  @Metadata({ data: "json, name=queryTerms", elemType: shared.GoogleCloudRetailV2betaConditionQueryTerm })
