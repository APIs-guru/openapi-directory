...
class TasksTasksPatchRequest:
    path_params: TasksTasksPatchPathParams = field(default=None)
    query_params: TasksTasksPatchQueryParams = field(default=None)
    request: Optional[shared.Task] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: TasksTasksPatchSecurity = field(default=None)
