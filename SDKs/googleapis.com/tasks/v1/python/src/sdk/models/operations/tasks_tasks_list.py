...
class TasksTasksListRequest:
    path_params: TasksTasksListPathParams = field(default=None)
    query_params: TasksTasksListQueryParams = field(default=None)
    security: TasksTasksListSecurity = field(default=None)
