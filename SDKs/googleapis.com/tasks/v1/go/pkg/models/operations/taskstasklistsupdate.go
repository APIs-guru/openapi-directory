...
type TasksTasklistsUpdatePathParams struct {
    Tasklist string `pathParam:"style=simple,explode=false,name=tasklist"`
    
}

type TasksTasklistsUpdateQueryParams struct {
...
type TasksTasklistsUpdateSecurity struct {
    Oauth2 shared.SchemeOauth2 `security:"scheme,type=oauth2"`
    Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
    
}

type TasksTasklistsUpdateRequest struct {
...
type TasksTasklistsUpdateResponse struct {
    ContentType string 
    StatusCode int64 
