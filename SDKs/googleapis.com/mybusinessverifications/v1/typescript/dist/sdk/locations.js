...
var Locations = /** @class */ (function () {
    ...
    **/
    Locations.prototype.mybusinessverificationsLocationsFetchVerificationOptions = function (req, config) {
        ...
        var url = utils.GenerateURL(baseURL, "/v1/{location}:fetchVerificationOptions", req.pathParams);
    ...
    **/
    Locations.prototype.mybusinessverificationsLocationsGetVoiceOfMerchantState = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{name}/VoiceOfMerchantState", req.pathParams);
        var client = this._defaultClient;
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.voiceOfMerchantState = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Locations.prototype.mybusinessverificationsLocationsVerificationsList = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{parent}/verifications", req.pathParams);
        var client = this._defaultClient;
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
