...
class SDK:
    ...
    def cloudshell_operations_cancel(self, request: operations.CloudshellOperationsCancelRequest) -> operations.CloudshellOperationsCancelResponse:
        ...
        res = operations.CloudshellOperationsCancelResponse(status_code=r.status_code, content_type=content_type)
    ...
    def cloudshell_operations_delete(self, request: operations.CloudshellOperationsDeleteRequest) -> operations.CloudshellOperationsDeleteResponse:
        warnings.simplefilter("ignore")
        ...
        res = operations.CloudshellOperationsDeleteResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
                res.empty = out
