...
func (s *Operations) CloudshellOperationsCancel(ctx context.Context, request operations.CloudshellOperationsCancelRequest) (*operations.CloudshellOperationsCancelResponse, error) {
	...
	res := &operations.CloudshellOperationsCancelResponse{
...
func (s *Operations) CloudshellOperationsDelete(ctx context.Context, request operations.CloudshellOperationsDeleteRequest) (*operations.CloudshellOperationsDeleteResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.CloudshellOperationsDeleteResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
