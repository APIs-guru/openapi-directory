...
export declare class AnalyticsdataPropertiesGetMetadataPathParams extends SpeakeasyBase {
    name: string;
}
export declare class AnalyticsdataPropertiesGetMetadataQueryParams extends SpeakeasyBase {
