...
**/
var DimensionExpression = /** @class */ (function (_super) {
    __extends(DimensionExpression, _super);
    function DimensionExpression() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=concatenate" }),
        __metadata("design:type", ConcatenateExpression)
    ], DimensionExpression.prototype, "concatenate", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=lowerCase" }),
        __metadata("design:type", CaseExpression)
    ], DimensionExpression.prototype, "lowerCase", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=upperCase" }),
        __metadata("design:type", CaseExpression)
    ], DimensionExpression.prototype, "upperCase", void 0);
    return DimensionExpression;
}(SpeakeasyBase));
export { DimensionExpression };
