...
@dataclass
class AnalyticsdataPropertiesBatchRunReportsQueryParams:
...
class AnalyticsdataPropertiesBatchRunReportsSecurity:
    option1: Optional[AnalyticsdataPropertiesBatchRunReportsSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AnalyticsdataPropertiesBatchRunReportsSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
