...
@dataclass
class AnalyticsdataPropertiesRunRealtimeReportQueryParams:
...
class AnalyticsdataPropertiesRunRealtimeReportSecurity:
    option1: Optional[AnalyticsdataPropertiesRunRealtimeReportSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AnalyticsdataPropertiesRunRealtimeReportSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
