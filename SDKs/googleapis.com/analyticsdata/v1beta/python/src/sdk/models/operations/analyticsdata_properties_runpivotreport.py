...
class AnalyticsdataPropertiesRunPivotReportRequest:
    path_params: AnalyticsdataPropertiesRunPivotReportPathParams = field()
    query_params: AnalyticsdataPropertiesRunPivotReportQueryParams = field()
    security: AnalyticsdataPropertiesRunPivotReportSecurity = field()
