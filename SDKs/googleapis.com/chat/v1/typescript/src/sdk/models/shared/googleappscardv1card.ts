...
export class GoogleAppsCardV1Card extends SpeakeasyBase {
  @Metadata({ data: "json, name=cardActions", elemType: shared.GoogleAppsCardV1CardAction })
  cardActions?: GoogleAppsCardV1CardAction[];

  @Metadata({ data: "json, name=displayStyle" })
  displayStyle?: GoogleAppsCardV1CardDisplayStyleEnum;

  @Metadata({ data: "json, name=fixedFooter" })
  ...
  @Metadata({ data: "json, name=peekCardHeader" })
  peekCardHeader?: GoogleAppsCardV1CardHeader;

  @Metadata({ data: "json, name=sections", elemType: shared.GoogleAppsCardV1Section })
