...
**/
var GoogleAppsCardV1CardAction = /** @class */ (function (_super) {
    __extends(GoogleAppsCardV1CardAction, _super);
    function GoogleAppsCardV1CardAction() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=actionLabel" }),
        __metadata("design:type", String)
    ], GoogleAppsCardV1CardAction.prototype, "actionLabel", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=onClick" }),
        __metadata("design:type", GoogleAppsCardV1OnClick)
    ], GoogleAppsCardV1CardAction.prototype, "onClick", void 0);
    return GoogleAppsCardV1CardAction;
}(SpeakeasyBase));
export { GoogleAppsCardV1CardAction };
