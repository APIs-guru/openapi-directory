...
class FactchecktoolsClaimsSearchQueryParams:
    ...
    max_age_days: Optional[int] = field(default=None, metadata={'query_param': { 'field_name': 'maxAgeDays', 'style': 'form', 'explode': True }})
    ...
    review_publisher_site_filter: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'reviewPublisherSiteFilter', 'style': 'form', 'explode': True }})
