...
class AndroidenterpriseManagedconfigurationsfordeviceGetRequest:
    path_params: AndroidenterpriseManagedconfigurationsfordeviceGetPathParams = field(default=None)
    query_params: AndroidenterpriseManagedconfigurationsfordeviceGetQueryParams = field(default=None)
    security: AndroidenterpriseManagedconfigurationsfordeviceGetSecurity = field(default=None)
