...
class AndroidenterpriseServiceaccountkeysDeleteRequest:
    path_params: AndroidenterpriseServiceaccountkeysDeletePathParams = field()
    query_params: AndroidenterpriseServiceaccountkeysDeleteQueryParams = field()
    security: AndroidenterpriseServiceaccountkeysDeleteSecurity = field()
