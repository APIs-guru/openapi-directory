...
class AndroidenterpriseEnterprisesSetAccountRequest:
    path_params: AndroidenterpriseEnterprisesSetAccountPathParams = field()
    query_params: AndroidenterpriseEnterprisesSetAccountQueryParams = field()
    security: AndroidenterpriseEnterprisesSetAccountSecurity = field()
