...
class AndroidenterpriseProductsGetPermissionsRequest:
    path_params: AndroidenterpriseProductsGetPermissionsPathParams = field(default=None)
    query_params: AndroidenterpriseProductsGetPermissionsQueryParams = field(default=None)
    security: AndroidenterpriseProductsGetPermissionsSecurity = field(default=None)
