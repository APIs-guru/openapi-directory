...
type AndroidenterpriseServiceaccountkeysListPathParams struct {
	EnterpriseID string `pathParam:"style=simple,explode=false,name=enterpriseId"`
}

type AndroidenterpriseServiceaccountkeysListQueryParams struct {
...
type AndroidenterpriseServiceaccountkeysListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AndroidenterpriseServiceaccountkeysListRequest struct {
...
type AndroidenterpriseServiceaccountkeysListResponse struct {
	ContentType                    string
