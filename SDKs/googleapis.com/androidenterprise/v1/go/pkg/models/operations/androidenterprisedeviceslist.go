...
type AndroidenterpriseDevicesListPathParams struct {
	EnterpriseID string `pathParam:"style=simple,explode=false,name=enterpriseId"`
	UserID       string `pathParam:"style=simple,explode=false,name=userId"`
}

type AndroidenterpriseDevicesListQueryParams struct {
...
type AndroidenterpriseDevicesListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AndroidenterpriseDevicesListRequest struct {
...
type AndroidenterpriseDevicesListResponse struct {
	ContentType         string
