...
type AndroidenterpriseGrouplicensesListPathParams struct {
	EnterpriseID string `pathParam:"style=simple,explode=false,name=enterpriseId"`
}

type AndroidenterpriseGrouplicensesListQueryParams struct {
...
type AndroidenterpriseGrouplicensesListSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AndroidenterpriseGrouplicensesListRequest struct {
...
type AndroidenterpriseGrouplicensesListResponse struct {
	ContentType               string
