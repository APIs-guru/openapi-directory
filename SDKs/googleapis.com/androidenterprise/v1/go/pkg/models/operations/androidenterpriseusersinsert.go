...
type AndroidenterpriseUsersInsertPathParams struct {
    EnterpriseID string `pathParam:"style=simple,explode=false,name=enterpriseId"`
    
}

type AndroidenterpriseUsersInsertQueryParams struct {
...
type AndroidenterpriseUsersInsertSecurity struct {
    Oauth2 shared.SchemeOauth2 `security:"scheme,type=oauth2"`
    Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
    
}

type AndroidenterpriseUsersInsertRequest struct {
...
type AndroidenterpriseUsersInsertResponse struct {
    ContentType string 
    StatusCode int64 
    User *shared.User 
