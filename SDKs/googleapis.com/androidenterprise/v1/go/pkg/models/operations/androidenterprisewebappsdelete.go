...
type AndroidenterpriseWebappsDeletePathParams struct {
...
type AndroidenterpriseWebappsDeleteQueryParams struct {
...
type AndroidenterpriseWebappsDeleteSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AndroidenterpriseWebappsDeleteRequest struct {
...
type AndroidenterpriseWebappsDeleteResponse struct {
	ContentType string
	StatusCode  int64
}
