...
type AndroidenterpriseStorelayoutpagesDeletePathParams struct {
...
type AndroidenterpriseStorelayoutpagesDeleteQueryParams struct {
...
type AndroidenterpriseStorelayoutpagesDeleteSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type AndroidenterpriseStorelayoutpagesDeleteRequest struct {
...
type AndroidenterpriseStorelayoutpagesDeleteResponse struct {
	ContentType string
	StatusCode  int64
}
