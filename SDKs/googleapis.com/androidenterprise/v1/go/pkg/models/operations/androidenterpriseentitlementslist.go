...
type AndroidenterpriseEntitlementsListPathParams struct {
    EnterpriseID string `pathParam:"style=simple,explode=false,name=enterpriseId"`
    UserID string `pathParam:"style=simple,explode=false,name=userId"`
    
}

type AndroidenterpriseEntitlementsListQueryParams struct {
...
type AndroidenterpriseEntitlementsListSecurity struct {
    Oauth2 shared.SchemeOauth2 `security:"scheme,type=oauth2"`
    Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
    
}

type AndroidenterpriseEntitlementsListRequest struct {
...
type AndroidenterpriseEntitlementsListResponse struct {
    ContentType string 
