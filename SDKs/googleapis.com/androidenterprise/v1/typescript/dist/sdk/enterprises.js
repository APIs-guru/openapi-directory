...
var Enterprises = /** @class */ (function () {
    ...
    **/
    Enterprises.prototype.androidenterpriseEnterprisesAcknowledgeNotificationSet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AndroidenterpriseEnterprisesAcknowledgeNotificationSetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/androidenterprise/v1/enterprises/acknowledgeNotificationSet";
    ...
    **/
    Enterprises.prototype.androidenterpriseEnterprisesCompleteSignup = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AndroidenterpriseEnterprisesCompleteSignupRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/androidenterprise/v1/enterprises/completeSignup";
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    Enterprises.prototype.androidenterpriseEnterprisesCreateWebToken = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AndroidenterpriseEnterprisesCreateWebTokenRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/androidenterprise/v1/enterprises/{enterpriseId}/createWebToken", req.pathParams);
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.administratorWebToken = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Enterprises.prototype.androidenterpriseEnterprisesEnroll = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Enterprises.prototype.androidenterpriseEnterprisesGenerateSignupUrl = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AndroidenterpriseEnterprisesGenerateSignupUrlRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/androidenterprise/v1/enterprises/signupUrl";
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.signupInfo = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Enterprises.prototype.androidenterpriseEnterprisesGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AndroidenterpriseEnterprisesGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/androidenterprise/v1/enterprises/{enterpriseId}", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    Enterprises.prototype.androidenterpriseEnterprisesGetServiceAccount = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AndroidenterpriseEnterprisesGetServiceAccountRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/androidenterprise/v1/enterprises/{enterpriseId}/serviceAccount", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    Enterprises.prototype.androidenterpriseEnterprisesGetStoreLayout = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AndroidenterpriseEnterprisesGetStoreLayoutRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/androidenterprise/v1/enterprises/{enterpriseId}/storeLayout", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.storeLayout = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Enterprises.prototype.androidenterpriseEnterprisesList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.enterprisesListResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Enterprises.prototype.androidenterpriseEnterprisesPullNotificationSet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AndroidenterpriseEnterprisesPullNotificationSetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/androidenterprise/v1/enterprises/pullNotificationSet";
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.notificationSet = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Enterprises.prototype.androidenterpriseEnterprisesSendTestPushNotification = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AndroidenterpriseEnterprisesSendTestPushNotificationRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/androidenterprise/v1/enterprises/{enterpriseId}/sendTestPushNotification", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.enterprisesSendTestPushNotificationResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Enterprises.prototype.androidenterpriseEnterprisesSetAccount = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AndroidenterpriseEnterprisesSetAccountRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/androidenterprise/v1/enterprises/{enterpriseId}/account", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.enterpriseAccount = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Enterprises.prototype.androidenterpriseEnterprisesSetStoreLayout = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Enterprises.prototype.androidenterpriseEnterprisesUnenroll = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AndroidenterpriseEnterprisesUnenrollRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/androidenterprise/v1/enterprises/{enterpriseId}/unenroll", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
