...
var Permissions = /** @class */ (function () {
    ...
    **/
    Permissions.prototype.androidenterprisePermissionsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AndroidenterprisePermissionsGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/androidenterprise/v1/permissions/{permissionId}", req.pathParams);
