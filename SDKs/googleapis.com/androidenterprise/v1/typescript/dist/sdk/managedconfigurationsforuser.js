...
var Managedconfigurationsforuser = /** @class */ (function () {
    ...
    **/
    Managedconfigurationsforuser.prototype.androidenterpriseManagedconfigurationsforuserDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AndroidenterpriseManagedconfigurationsforuserDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/androidenterprise/v1/enterprises/{enterpriseId}/users/{userId}/managedConfigurationsForUser/{managedConfigurationForUserId}", req.pathParams);
    ...
    **/
    Managedconfigurationsforuser.prototype.androidenterpriseManagedconfigurationsforuserGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.managedConfiguration = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Managedconfigurationsforuser.prototype.androidenterpriseManagedconfigurationsforuserList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AndroidenterpriseManagedconfigurationsforuserListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/androidenterprise/v1/enterprises/{enterpriseId}/users/{userId}/managedConfigurationsForUser", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.managedConfigurationsForUserListResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Managedconfigurationsforuser.prototype.androidenterpriseManagedconfigurationsforuserUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
export { Managedconfigurationsforuser };
