...
export class Managedconfigurationssettings {
  ...
  androidenterpriseManagedconfigurationssettingsList(
    ...
    return client
      .request({
        ...
        const res: operations.AndroidenterpriseManagedconfigurationssettingsListResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
