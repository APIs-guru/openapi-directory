...
func (s *SDK) CommentanalyzerCommentsAnalyze(ctx context.Context, request operations.CommentanalyzerCommentsAnalyzeRequest) (*operations.CommentanalyzerCommentsAnalyzeResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) CommentanalyzerCommentsSuggestscore(ctx context.Context, request operations.CommentanalyzerCommentsSuggestscoreRequest) (*operations.CommentanalyzerCommentsSuggestscoreResponse, error) {
	baseURL := s.serverURL
