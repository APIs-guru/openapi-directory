...
export class Projects {
  ...
  **/
  jobsProjectsClientEventsCreate(
    ...
    const url: string = utils.GenerateURL(baseURL, "/v3/{parent}/clientEvents", req.pathParams);
  ...
  **/
  jobsProjectsCompaniesCreate(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v3/{parent}/companies", req.pathParams);
  ...
  **/
  jobsProjectsComplete(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v3/{name}:complete", req.pathParams);
  ...
  **/
  jobsProjectsJobsBatchDelete(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v3/{parent}/jobs:batchDelete", req.pathParams);
  ...
  **/
  jobsProjectsJobsCreate(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v3/{parent}/jobs", req.pathParams);
  ...
  jobsProjectsJobsGet(
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.JobsProjectsJobsGetResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.job = httpRes?.data;
  ...
  **/
  jobsProjectsJobsSearch(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v3/{parent}/jobs:search", req.pathParams);
  ...
  **/
  jobsProjectsJobsSearchForAlert(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v3/{parent}/jobs:searchForAlert", req.pathParams);
