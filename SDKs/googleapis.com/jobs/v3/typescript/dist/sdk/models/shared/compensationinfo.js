...
**/
var CompensationInfo = /** @class */ (function (_super) {
    __extends(CompensationInfo, _super);
    ...
    ], CompensationInfo.prototype, "annualizedBaseCompensationRange", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=annualizedTotalCompensationRange" }),
        __metadata("design:type", CompensationRange)
    ], CompensationInfo.prototype, "annualizedTotalCompensationRange", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=entries", elemType: CompensationEntry }),
        __metadata("design:type", Array)
    ], CompensationInfo.prototype, "entries", void 0);
    return CompensationInfo;
}(SpeakeasyBase));
export { CompensationInfo };
