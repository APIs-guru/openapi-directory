...
@dataclass
class JobsProjectsJobsBatchDeleteQueryParams:
...
class JobsProjectsJobsBatchDeleteSecurity:
    option1: Optional[JobsProjectsJobsBatchDeleteSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[JobsProjectsJobsBatchDeleteSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
