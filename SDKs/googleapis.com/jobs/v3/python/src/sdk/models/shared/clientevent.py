...
class ClientEvent:
    ...
    extra_info: Optional[dict[str, str]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'extraInfo' }})
    job_event: Optional[jobevent.JobEvent] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'jobEvent' }})
    parent_event_id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'parentEventId' }})
