...
@dataclass
class JobsProjectsJobsGetQueryParams:
...
class JobsProjectsJobsGetSecurity:
    option1: Optional[JobsProjectsJobsGetSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[JobsProjectsJobsGetSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
