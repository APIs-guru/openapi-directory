...
class JobsProjectsJobsSearchForAlertSecurity:
    option1: Optional[JobsProjectsJobsSearchForAlertSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[JobsProjectsJobsSearchForAlertSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class JobsProjectsJobsSearchForAlertRequest:
    path_params: JobsProjectsJobsSearchForAlertPathParams = field(default=None)
    query_params: JobsProjectsJobsSearchForAlertQueryParams = field(default=None)
    request: Optional[shared.SearchJobsRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: JobsProjectsJobsSearchForAlertSecurity = field(default=None)
