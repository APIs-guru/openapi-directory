...
class JobsProjectsJobsSearchForAlertRequest:
    path_params: JobsProjectsJobsSearchForAlertPathParams = field()
    query_params: JobsProjectsJobsSearchForAlertQueryParams = field()
    security: JobsProjectsJobsSearchForAlertSecurity = field()
