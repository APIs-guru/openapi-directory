...
class JobsProjectsClientEventsCreateSecurity:
    option1: Optional[JobsProjectsClientEventsCreateSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[JobsProjectsClientEventsCreateSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
