...
class JobsProjectsTenantsCompaniesListSecurity:
    option1: Optional[JobsProjectsTenantsCompaniesListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[JobsProjectsTenantsCompaniesListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
