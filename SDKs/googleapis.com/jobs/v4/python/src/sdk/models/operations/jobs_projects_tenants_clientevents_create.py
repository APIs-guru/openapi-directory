...
class JobsProjectsTenantsClientEventsCreateRequest:
    path_params: JobsProjectsTenantsClientEventsCreatePathParams = field()
    query_params: JobsProjectsTenantsClientEventsCreateQueryParams = field()
    security: JobsProjectsTenantsClientEventsCreateSecurity = field()
