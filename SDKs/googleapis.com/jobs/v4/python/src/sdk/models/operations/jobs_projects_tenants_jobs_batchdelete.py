...
class JobsProjectsTenantsJobsBatchDeleteRequest:
    path_params: JobsProjectsTenantsJobsBatchDeletePathParams = field(default=None)
    query_params: JobsProjectsTenantsJobsBatchDeleteQueryParams = field(default=None)
    request: Optional[shared.BatchDeleteJobsRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: JobsProjectsTenantsJobsBatchDeleteSecurity = field(default=None)
