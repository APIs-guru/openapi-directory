...
class JobsProjectsTenantsJobsSearchForAlertRequest:
    path_params: JobsProjectsTenantsJobsSearchForAlertPathParams = field()
    query_params: JobsProjectsTenantsJobsSearchForAlertQueryParams = field()
    security: JobsProjectsTenantsJobsSearchForAlertSecurity = field()
