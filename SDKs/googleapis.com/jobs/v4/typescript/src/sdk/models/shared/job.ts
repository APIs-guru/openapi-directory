...
export class Job extends SpeakeasyBase {
  ...
  @Metadata({ data: "json, name=companyDisplayName" })
  companyDisplayName?: string;

  @Metadata({ data: "json, name=compensationInfo" })
  ...
  @Metadata({ data: "json, name=degreeTypes" })
  ...
  @Metadata({ data: "json, name=incentives" })
  incentives?: string;

  @Metadata({ data: "json, name=jobBenefits" })
  jobBenefits?: JobJobBenefitsEnum[];

  @Metadata({ data: "json, name=jobEndTime" })
  jobEndTime?: string;

  @Metadata({ data: "json, name=jobLevel" })
  jobLevel?: JobJobLevelEnum;

  @Metadata({ data: "json, name=jobStartTime" })
  jobStartTime?: string;
  ...
  @Metadata({ data: "json, name=postingCreateTime" })
  postingCreateTime?: string;

  @Metadata({ data: "json, name=postingExpireTime" })
  postingExpireTime?: string;

  @Metadata({ data: "json, name=postingPublishTime" })
  postingPublishTime?: string;

  @Metadata({ data: "json, name=postingRegion" })
  postingRegion?: JobPostingRegionEnum;

  @Metadata({ data: "json, name=postingUpdateTime" })
  postingUpdateTime?: string;

  @Metadata({ data: "json, name=processingOptions" })
  processingOptions?: ProcessingOptions;

  @Metadata({ data: "json, name=promotionValue" })
  promotionValue?: number;

  @Metadata({ data: "json, name=qualifications" })
  qualifications?: string;

  @Metadata({ data: "json, name=requisitionId" })
  requisitionId?: string;

  @Metadata({ data: "json, name=responsibilities" })
