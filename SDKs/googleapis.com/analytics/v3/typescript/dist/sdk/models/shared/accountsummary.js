...
var AccountSummary = /** @class */ (function (_super) {
    ...
    ], AccountSummary.prototype, "id", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=kind" }),
        __metadata("design:type", String)
    ], AccountSummary.prototype, "kind", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=name" }),
        __metadata("design:type", String)
    ], AccountSummary.prototype, "name", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=starred" }),
        __metadata("design:type", Boolean)
    ], AccountSummary.prototype, "starred", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=webProperties", elemType: WebPropertySummary }),
        __metadata("design:type", Array)
    ], AccountSummary.prototype, "webProperties", void 0);
