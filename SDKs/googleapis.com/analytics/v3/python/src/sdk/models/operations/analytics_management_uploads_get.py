...
class AnalyticsManagementUploadsGetRequest:
    path_params: AnalyticsManagementUploadsGetPathParams = field()
    query_params: AnalyticsManagementUploadsGetQueryParams = field()
    security: AnalyticsManagementUploadsGetSecurity = field()
