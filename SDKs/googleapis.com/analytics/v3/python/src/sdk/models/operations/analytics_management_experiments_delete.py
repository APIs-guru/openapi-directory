...
class AnalyticsManagementExperimentsDeleteRequest:
    path_params: AnalyticsManagementExperimentsDeletePathParams = field(default=None)
    query_params: AnalyticsManagementExperimentsDeleteQueryParams = field(default=None)
    security: AnalyticsManagementExperimentsDeleteSecurity = field(default=None)
