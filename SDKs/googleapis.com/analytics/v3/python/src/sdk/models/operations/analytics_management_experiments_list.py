...
class AnalyticsManagementExperimentsListRequest:
    path_params: AnalyticsManagementExperimentsListPathParams = field()
    query_params: AnalyticsManagementExperimentsListQueryParams = field()
    security: AnalyticsManagementExperimentsListSecurity = field()
