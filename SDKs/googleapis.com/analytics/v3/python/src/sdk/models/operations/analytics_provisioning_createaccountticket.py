...
class AnalyticsProvisioningCreateAccountTicketRequest:
    query_params: AnalyticsProvisioningCreateAccountTicketQueryParams = field(default=None)
    request: Optional[shared.AccountTicket] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: AnalyticsProvisioningCreateAccountTicketSecurity = field(default=None)
