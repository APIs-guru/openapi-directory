...
class GaDataDataTableRowsC:
    v: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('v') }})
    

@dataclass_json
@dataclass
class GaDataDataTableRows:
    c: Optional[List[GaDataDataTableRowsC]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('c') }})
    

@dataclass_json
@dataclass
class GaDataDataTable:
    cols: Optional[List[GaDataDataTableCols]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('cols') }})
    rows: Optional[List[GaDataDataTableRows]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('rows') }})
...
class GaData:
    ...
    column_headers: Optional[List[GaDataColumnHeaders]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('columnHeaders') }})
    ...
    data_table: Optional[GaDataDataTable] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('dataTable') }})
    id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('id') }})
    ...
    profile_info: Optional[GaDataProfileInfo] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('profileInfo') }})
    query: Optional[GaDataQuery] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('query') }})
