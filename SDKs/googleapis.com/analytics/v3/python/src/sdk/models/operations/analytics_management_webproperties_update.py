...
class AnalyticsManagementWebpropertiesUpdateRequest:
    path_params: AnalyticsManagementWebpropertiesUpdatePathParams = field()
    query_params: AnalyticsManagementWebpropertiesUpdateQueryParams = field()
    security: AnalyticsManagementWebpropertiesUpdateSecurity = field()
