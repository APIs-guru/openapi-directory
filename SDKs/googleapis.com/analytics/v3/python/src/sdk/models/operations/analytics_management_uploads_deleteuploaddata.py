...
class AnalyticsManagementUploadsDeleteUploadDataRequest:
    path_params: AnalyticsManagementUploadsDeleteUploadDataPathParams = field(default=None)
    query_params: AnalyticsManagementUploadsDeleteUploadDataQueryParams = field(default=None)
    ...
    security: AnalyticsManagementUploadsDeleteUploadDataSecurity = field(default=None)
