...
class AnalyticsManagementWebPropertyAdWordsLinksInsertRequest:
    path_params: AnalyticsManagementWebPropertyAdWordsLinksInsertPathParams = field(default=None)
    query_params: AnalyticsManagementWebPropertyAdWordsLinksInsertQueryParams = field(default=None)
    request: Optional[shared.EntityAdWordsLink] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: AnalyticsManagementWebPropertyAdWordsLinksInsertSecurity = field(default=None)
