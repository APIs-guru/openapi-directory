...
@dataclass
class AnalyticsManagementAccountUserLinksListQueryParams:
...
@dataclass
class AnalyticsManagementAccountUserLinksListSecurity:
    option1: Optional[AnalyticsManagementAccountUserLinksListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AnalyticsManagementAccountUserLinksListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
