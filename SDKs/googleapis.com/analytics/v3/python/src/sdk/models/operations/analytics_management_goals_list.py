...
class AnalyticsManagementGoalsListRequest:
    path_params: AnalyticsManagementGoalsListPathParams = field(default=None)
    query_params: AnalyticsManagementGoalsListQueryParams = field(default=None)
    security: AnalyticsManagementGoalsListSecurity = field(default=None)
