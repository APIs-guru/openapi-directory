...
class AnalyticsManagementProfileUserLinksListRequest:
    path_params: AnalyticsManagementProfileUserLinksListPathParams = field()
    query_params: AnalyticsManagementProfileUserLinksListQueryParams = field()
    security: AnalyticsManagementProfileUserLinksListSecurity = field()
