...
class AnalyticsManagementProfileUserLinksListSecurity:
    option1: Optional[AnalyticsManagementProfileUserLinksListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AnalyticsManagementProfileUserLinksListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class AnalyticsManagementProfileUserLinksListRequest:
    path_params: AnalyticsManagementProfileUserLinksListPathParams = field(default=None)
    query_params: AnalyticsManagementProfileUserLinksListQueryParams = field(default=None)
    security: AnalyticsManagementProfileUserLinksListSecurity = field(default=None)
