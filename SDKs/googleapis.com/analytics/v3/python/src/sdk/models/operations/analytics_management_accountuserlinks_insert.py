...
class AnalyticsManagementAccountUserLinksInsertRequest:
    path_params: AnalyticsManagementAccountUserLinksInsertPathParams = field(default=None)
    query_params: AnalyticsManagementAccountUserLinksInsertQueryParams = field(default=None)
    request: Optional[shared.EntityUserLink] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: AnalyticsManagementAccountUserLinksInsertSecurity = field(default=None)
