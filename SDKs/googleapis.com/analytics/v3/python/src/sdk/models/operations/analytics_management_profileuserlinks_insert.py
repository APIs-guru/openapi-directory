...
class AnalyticsManagementProfileUserLinksInsertRequest:
    path_params: AnalyticsManagementProfileUserLinksInsertPathParams = field(default=None)
    query_params: AnalyticsManagementProfileUserLinksInsertQueryParams = field(default=None)
    request: Optional[shared.EntityUserLink] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: AnalyticsManagementProfileUserLinksInsertSecurity = field(default=None)
