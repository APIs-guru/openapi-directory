...
class AnalyticsManagementWebPropertyAdWordsLinksListSecurity:
    option1: Optional[AnalyticsManagementWebPropertyAdWordsLinksListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AnalyticsManagementWebPropertyAdWordsLinksListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class AnalyticsManagementWebPropertyAdWordsLinksListRequest:
    path_params: AnalyticsManagementWebPropertyAdWordsLinksListPathParams = field(default=None)
    query_params: AnalyticsManagementWebPropertyAdWordsLinksListQueryParams = field(default=None)
    security: AnalyticsManagementWebPropertyAdWordsLinksListSecurity = field(default=None)
    

@dataclass
class AnalyticsManagementWebPropertyAdWordsLinksListResponse:
    content_type: str = field(default=None)
    entity_ad_words_links: Optional[shared.EntityAdWordsLinks] = field(default=None)
