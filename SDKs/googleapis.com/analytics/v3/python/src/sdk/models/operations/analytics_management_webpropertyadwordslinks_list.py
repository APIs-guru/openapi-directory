...
class AnalyticsManagementWebPropertyAdWordsLinksListRequest:
    path_params: AnalyticsManagementWebPropertyAdWordsLinksListPathParams = field()
    query_params: AnalyticsManagementWebPropertyAdWordsLinksListQueryParams = field()
    security: AnalyticsManagementWebPropertyAdWordsLinksListSecurity = field()
