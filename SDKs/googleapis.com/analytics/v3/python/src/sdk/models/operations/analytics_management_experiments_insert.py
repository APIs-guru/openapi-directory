...
class AnalyticsManagementExperimentsInsertSecurity:
    option1: Optional[AnalyticsManagementExperimentsInsertSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AnalyticsManagementExperimentsInsertSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
