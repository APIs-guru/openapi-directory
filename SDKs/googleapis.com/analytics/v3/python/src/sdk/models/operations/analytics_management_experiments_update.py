...
class AnalyticsManagementExperimentsUpdateSecurity:
    option1: Optional[AnalyticsManagementExperimentsUpdateSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AnalyticsManagementExperimentsUpdateSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
