...
class AnalyticsManagementUploadsUploadDataRequest:
    path_params: AnalyticsManagementUploadsUploadDataPathParams = field(default=None)
    query_params: AnalyticsManagementUploadsUploadDataQueryParams = field(default=None)
    security: AnalyticsManagementUploadsUploadDataSecurity = field(default=None)
