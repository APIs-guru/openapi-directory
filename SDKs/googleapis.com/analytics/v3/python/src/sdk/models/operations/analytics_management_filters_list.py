...
class AnalyticsManagementFiltersListRequest:
    path_params: AnalyticsManagementFiltersListPathParams = field()
    query_params: AnalyticsManagementFiltersListQueryParams = field()
    security: AnalyticsManagementFiltersListSecurity = field()
