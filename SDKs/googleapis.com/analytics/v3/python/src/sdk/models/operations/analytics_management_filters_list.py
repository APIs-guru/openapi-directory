...
class AnalyticsManagementFiltersListSecurity:
    option1: Optional[AnalyticsManagementFiltersListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AnalyticsManagementFiltersListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class AnalyticsManagementFiltersListRequest:
    path_params: AnalyticsManagementFiltersListPathParams = field(default=None)
    query_params: AnalyticsManagementFiltersListQueryParams = field(default=None)
    security: AnalyticsManagementFiltersListSecurity = field(default=None)
    

@dataclass
class AnalyticsManagementFiltersListResponse:
    content_type: str = field(default=None)
    filters: Optional[shared.Filters] = field(default=None)
