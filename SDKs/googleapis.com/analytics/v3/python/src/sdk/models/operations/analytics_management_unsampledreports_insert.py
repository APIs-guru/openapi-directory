...
class AnalyticsManagementUnsampledReportsInsertRequest:
    path_params: AnalyticsManagementUnsampledReportsInsertPathParams = field(default=None)
    query_params: AnalyticsManagementUnsampledReportsInsertQueryParams = field(default=None)
    request: Optional[shared.UnsampledReport] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: AnalyticsManagementUnsampledReportsInsertSecurity = field(default=None)
