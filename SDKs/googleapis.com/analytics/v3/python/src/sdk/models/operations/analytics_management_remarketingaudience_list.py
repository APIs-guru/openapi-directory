...
class AnalyticsManagementRemarketingAudienceListRequest:
    path_params: AnalyticsManagementRemarketingAudienceListPathParams = field(default=None)
    query_params: AnalyticsManagementRemarketingAudienceListQueryParams = field(default=None)
    security: AnalyticsManagementRemarketingAudienceListSecurity = field(default=None)
