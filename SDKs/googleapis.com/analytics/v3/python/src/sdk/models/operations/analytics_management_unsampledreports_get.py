...
class AnalyticsManagementUnsampledReportsGetRequest:
    path_params: AnalyticsManagementUnsampledReportsGetPathParams = field(default=None)
    query_params: AnalyticsManagementUnsampledReportsGetQueryParams = field(default=None)
    security: AnalyticsManagementUnsampledReportsGetSecurity = field(default=None)
