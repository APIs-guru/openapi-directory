...
class AnalyticsManagementWebpropertiesGetRequest:
    path_params: AnalyticsManagementWebpropertiesGetPathParams = field()
    query_params: AnalyticsManagementWebpropertiesGetQueryParams = field()
    security: AnalyticsManagementWebpropertiesGetSecurity = field()
