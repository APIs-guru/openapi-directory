...
class AnalyticsManagementProfileUserLinksDeleteRequest:
    path_params: AnalyticsManagementProfileUserLinksDeletePathParams = field(default=None)
    query_params: AnalyticsManagementProfileUserLinksDeleteQueryParams = field(default=None)
    security: AnalyticsManagementProfileUserLinksDeleteSecurity = field(default=None)
