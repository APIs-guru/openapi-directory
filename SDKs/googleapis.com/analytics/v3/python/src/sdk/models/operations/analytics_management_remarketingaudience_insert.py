...
class AnalyticsManagementRemarketingAudienceInsertRequest:
    path_params: AnalyticsManagementRemarketingAudienceInsertPathParams = field()
    query_params: AnalyticsManagementRemarketingAudienceInsertQueryParams = field()
    security: AnalyticsManagementRemarketingAudienceInsertSecurity = field()
