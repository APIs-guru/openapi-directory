...
class AnalyticsManagementRemarketingAudienceInsertRequest:
    path_params: AnalyticsManagementRemarketingAudienceInsertPathParams = field(default=None)
    query_params: AnalyticsManagementRemarketingAudienceInsertQueryParams = field(default=None)
    request: Optional[shared.RemarketingAudience] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: AnalyticsManagementRemarketingAudienceInsertSecurity = field(default=None)
