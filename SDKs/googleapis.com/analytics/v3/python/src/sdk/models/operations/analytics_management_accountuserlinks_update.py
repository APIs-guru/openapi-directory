...
class AnalyticsManagementAccountUserLinksUpdateRequest:
    path_params: AnalyticsManagementAccountUserLinksUpdatePathParams = field()
    query_params: AnalyticsManagementAccountUserLinksUpdateQueryParams = field()
    security: AnalyticsManagementAccountUserLinksUpdateSecurity = field()
