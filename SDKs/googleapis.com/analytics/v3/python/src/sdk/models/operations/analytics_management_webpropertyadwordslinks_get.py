...
class AnalyticsManagementWebPropertyAdWordsLinksGetRequest:
    path_params: AnalyticsManagementWebPropertyAdWordsLinksGetPathParams = field(default=None)
    query_params: AnalyticsManagementWebPropertyAdWordsLinksGetQueryParams = field(default=None)
    security: AnalyticsManagementWebPropertyAdWordsLinksGetSecurity = field(default=None)
