...
class AnalyticsManagementRemarketingAudienceGetRequest:
    path_params: AnalyticsManagementRemarketingAudienceGetPathParams = field()
    query_params: AnalyticsManagementRemarketingAudienceGetQueryParams = field()
    security: AnalyticsManagementRemarketingAudienceGetSecurity = field()
