...
class AnalyticsManagementWebPropertyAdWordsLinksUpdateRequest:
    path_params: AnalyticsManagementWebPropertyAdWordsLinksUpdatePathParams = field(default=None)
    query_params: AnalyticsManagementWebPropertyAdWordsLinksUpdateQueryParams = field(default=None)
    request: Optional[shared.EntityAdWordsLink] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: AnalyticsManagementWebPropertyAdWordsLinksUpdateSecurity = field(default=None)
