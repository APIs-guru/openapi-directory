...
func (s *SDK) AnalyticsDataGet(ctx context.Context, request operations.AnalyticsDataGetRequest) (*operations.AnalyticsDataGetResponse, error) {
	baseURL := s.serverURL
	...
	res := &operations.AnalyticsDataGetResponse{
