...
export class Projects {
  ...
  **/
  recommenderProjectsLocationsInsightTypesInsightsList(
    ...
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{parent}/insights", req.pathParams);
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.googleCloudRecommenderV1beta1ListInsightsResponse = httpRes?.data;
            }
            break;
        }
  ...
  **/
  recommenderProjectsLocationsInsightTypesInsightsMarkAccepted(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{name}:markAccepted", req.pathParams);
    ...
    return client
      .request({
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.googleCloudRecommenderV1beta1Insight = httpRes?.data;
            }
            break;
        }
    ...
    return client
      .request({
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.googleCloudRecommenderV1beta1Recommendation = httpRes?.data;
            }
            break;
        }
  ...
  **/
  recommenderProjectsLocationsRecommendersRecommendationsList(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{parent}/recommendations", req.pathParams);
    ...
    return client
      .request({
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.googleCloudRecommenderV1beta1ListRecommendationsResponse = httpRes?.data;
            }
            break;
        }
  ...
  **/
  recommenderProjectsLocationsRecommendersRecommendationsMarkClaimed(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{name}:markClaimed", req.pathParams);
  ...
  **/
  recommenderProjectsLocationsRecommendersRecommendationsMarkFailed(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{name}:markFailed", req.pathParams);
  ...
  **/
  recommenderProjectsLocationsRecommendersRecommendationsMarkSucceeded(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{name}:markSucceeded", req.pathParams);
    ...
    return client
      .request({
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.googleCloudRecommenderV1beta1RecommenderConfig = httpRes?.data;
            }
            break;
        }
