...
class GoogleCloudRecommenderV1beta1Insight:
    ...
    associated_recommendations: Optional[List[GoogleCloudRecommenderV1beta1InsightRecommendationReference]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('associatedRecommendations') }})
    category: Optional[GoogleCloudRecommenderV1beta1InsightCategoryEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('category') }})
    ...
    severity: Optional[GoogleCloudRecommenderV1beta1InsightSeverityEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('severity') }})
    state_info: Optional[GoogleCloudRecommenderV1beta1InsightStateInfo] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('stateInfo') }})
