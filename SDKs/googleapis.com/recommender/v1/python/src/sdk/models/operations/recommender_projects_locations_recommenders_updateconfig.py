...
class RecommenderProjectsLocationsRecommendersUpdateConfigRequest:
    ...
    request: Optional[shared.GoogleCloudRecommenderV1RecommenderConfigInput] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class RecommenderProjectsLocationsRecommendersUpdateConfigResponse:
    ...
    google_cloud_recommender_v1_recommender_config: Optional[shared.GoogleCloudRecommenderV1RecommenderConfig] = field(default=None)
