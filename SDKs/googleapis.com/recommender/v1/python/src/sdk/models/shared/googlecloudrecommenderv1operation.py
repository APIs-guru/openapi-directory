...
class GoogleCloudRecommenderV1Operation:
    ...
    path_value_matchers: Optional[dict[str, GoogleCloudRecommenderV1ValueMatcher]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('pathValueMatchers') }})
    ...
    value_matcher: Optional[GoogleCloudRecommenderV1ValueMatcher] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('valueMatcher') }})
