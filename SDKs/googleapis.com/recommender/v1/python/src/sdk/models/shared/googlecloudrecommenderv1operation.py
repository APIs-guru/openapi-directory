...
from . import googlecloudrecommenderv1valuematcher
from . import googlecloudrecommenderv1valuematcher
...
class GoogleCloudRecommenderV1Operation:
    ...
    path_value_matchers: Optional[dict[str, googlecloudrecommenderv1valuematcher.GoogleCloudRecommenderV1ValueMatcher]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'pathValueMatchers' }})
    ...
    value_matcher: Optional[googlecloudrecommenderv1valuematcher.GoogleCloudRecommenderV1ValueMatcher] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'valueMatcher' }})
