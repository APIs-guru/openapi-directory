...
// SDK Documentation: https://cloud.google.com/recommender/docs/
export class SDK {
  ...
  RecommenderProjectsLocationsInsightTypesInsightsList(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        let res: operations.RecommenderProjectsLocationsInsightTypesInsightsListResponse = {statusCode: httpRes.status, contentType: contentType};
  ...
  RecommenderProjectsLocationsInsightTypesInsightsMarkAccepted(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.RecommenderProjectsLocationsInsightTypesInsightsMarkAcceptedResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  RecommenderProjectsLocationsRecommendersRecommendationsGet(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.RecommenderProjectsLocationsRecommendersRecommendationsGetResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  RecommenderProjectsLocationsRecommendersRecommendationsList(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.RecommenderProjectsLocationsRecommendersRecommendationsListResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  RecommenderProjectsLocationsRecommendersRecommendationsMarkClaimed(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.RecommenderProjectsLocationsRecommendersRecommendationsMarkClaimedResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleCloudRecommenderV1Recommendation = httpRes?.data;
  ...
  RecommenderProjectsLocationsRecommendersRecommendationsMarkFailed(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.RecommenderProjectsLocationsRecommendersRecommendationsMarkFailedResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleCloudRecommenderV1Recommendation = httpRes?.data;
  ...
  RecommenderProjectsLocationsRecommendersRecommendationsMarkSucceeded(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.RecommenderProjectsLocationsRecommendersRecommendationsMarkSucceededResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.googleCloudRecommenderV1Recommendation = httpRes?.data;
  ...
  RecommenderProjectsLocationsRecommendersUpdateConfig(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.RecommenderProjectsLocationsRecommendersUpdateConfigResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
