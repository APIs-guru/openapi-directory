...
export class StorageDefaultObjectAccessControlsInsertSecurityOption1 extends SpeakeasyBase {
...
export class StorageDefaultObjectAccessControlsInsertSecurityOption2 extends SpeakeasyBase {
  @Metadata({ data: "security, scheme=true;type=oauth2" })
  oauth2: shared.SchemeOauth2;
