...
export class StorageObjectAccessControlsListSecurityOption1 extends SpeakeasyBase {
...
export class StorageObjectAccessControlsListSecurityOption2 extends SpeakeasyBase {
  @Metadata({ data: "security, scheme=true;type=oauth2" })
  oauth2: shared.SchemeOauth2;
