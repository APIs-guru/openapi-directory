...
var StorageObjectAccessControlsUpdateQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], StorageObjectAccessControlsUpdateQueryParams.prototype, "uploadType", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], StorageObjectAccessControlsUpdateQueryParams.prototype, "userProject", void 0);
    return StorageObjectAccessControlsUpdateQueryParams;
}(SpeakeasyBase));
export { StorageObjectAccessControlsUpdateQueryParams };
var StorageObjectAccessControlsUpdateSecurityOption1 = /** @class */ (function (_super) {
    __extends(StorageObjectAccessControlsUpdateSecurityOption1, _super);
    function StorageObjectAccessControlsUpdateSecurityOption1() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "security, scheme=true;type=oauth2" }),
        __metadata("design:type", shared.SchemeOauth2)
    ], StorageObjectAccessControlsUpdateSecurityOption1.prototype, "oauth2", void 0);
    __decorate([
        Metadata({ data: "security, scheme=true;type=oauth2" }),
        __metadata("design:type", shared.SchemeOauth2c)
    ], StorageObjectAccessControlsUpdateSecurityOption1.prototype, "oauth2c", void 0);
    return StorageObjectAccessControlsUpdateSecurityOption1;
}(SpeakeasyBase));
export { StorageObjectAccessControlsUpdateSecurityOption1 };
var StorageObjectAccessControlsUpdateSecurityOption2 = /** @class */ (function (_super) {
    __extends(StorageObjectAccessControlsUpdateSecurityOption2, _super);
    function StorageObjectAccessControlsUpdateSecurityOption2() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "security, scheme=true;type=oauth2" }),
        __metadata("design:type", shared.SchemeOauth2)
    ], StorageObjectAccessControlsUpdateSecurityOption2.prototype, "oauth2", void 0);
    __decorate([
        Metadata({ data: "security, scheme=true;type=oauth2" }),
        __metadata("design:type", shared.SchemeOauth2c)
    ], StorageObjectAccessControlsUpdateSecurityOption2.prototype, "oauth2c", void 0);
    return StorageObjectAccessControlsUpdateSecurityOption2;
}(SpeakeasyBase));
export { StorageObjectAccessControlsUpdateSecurityOption2 };
var StorageObjectAccessControlsUpdateSecurity = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", StorageObjectAccessControlsUpdateSecurityOption1)
    ], StorageObjectAccessControlsUpdateSecurity.prototype, "option1", void 0);
    __decorate([
        Metadata({ data: "security, option=true" }),
        __metadata("design:type", StorageObjectAccessControlsUpdateSecurityOption2)
    ], StorageObjectAccessControlsUpdateSecurity.prototype, "option2", void 0);
