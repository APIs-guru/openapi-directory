...
class StorageProjectsHmacKeysGetRequest:
    path_params: StorageProjectsHmacKeysGetPathParams = field()
    query_params: StorageProjectsHmacKeysGetQueryParams = field()
    security: StorageProjectsHmacKeysGetSecurity = field()
