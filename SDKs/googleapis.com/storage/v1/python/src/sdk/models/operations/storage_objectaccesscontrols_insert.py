...
class StorageObjectAccessControlsInsertSecurity:
    option1: Optional[StorageObjectAccessControlsInsertSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[StorageObjectAccessControlsInsertSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
