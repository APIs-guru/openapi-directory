...
class StorageNotificationsDeleteSecurity:
    option1: Optional[StorageNotificationsDeleteSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[StorageNotificationsDeleteSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[StorageNotificationsDeleteSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class StorageNotificationsDeleteRequest:
    path_params: StorageNotificationsDeletePathParams = field()
    query_params: StorageNotificationsDeleteQueryParams = field()
    security: StorageNotificationsDeleteSecurity = field()
