...
class StorageBucketAccessControlsPatchSecurity:
    option1: Optional[StorageBucketAccessControlsPatchSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[StorageBucketAccessControlsPatchSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
