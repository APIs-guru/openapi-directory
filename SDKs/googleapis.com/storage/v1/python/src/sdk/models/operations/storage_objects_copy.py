...
class StorageObjectsCopyQueryParams:
    ...
    destination_predefined_acl: Optional[StorageObjectsCopyDestinationPredefinedACLEnum] = field(default=None, metadata={'query_param': { 'field_name': 'destinationPredefinedAcl', 'style': 'form', 'explode': True }})
...
class StorageObjectsCopySecurity:
    ...
    option3: Optional[StorageObjectsCopySecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
