...
class StorageBucketsGetIamPolicyRequest:
    path_params: StorageBucketsGetIamPolicyPathParams = field()
    query_params: StorageBucketsGetIamPolicyQueryParams = field()
    security: StorageBucketsGetIamPolicySecurity = field()
