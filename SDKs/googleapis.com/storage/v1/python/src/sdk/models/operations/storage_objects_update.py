...
class StorageObjectsUpdateQueryParams:
    ...
    predefined_acl: Optional[StorageObjectsUpdatePredefinedACLEnum] = field(default=None, metadata={'query_param': { 'field_name': 'predefinedAcl', 'style': 'form', 'explode': True }})
    pretty_print: Optional[bool] = field(default=None, metadata={'query_param': { 'field_name': 'prettyPrint', 'style': 'form', 'explode': True }})
    projection: Optional[StorageObjectsUpdateProjectionEnum] = field(default=None, metadata={'query_param': { 'field_name': 'projection', 'style': 'form', 'explode': True }})
...
class StorageObjectsUpdateSecurity:
    option1: Optional[StorageObjectsUpdateSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[StorageObjectsUpdateSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class StorageObjectsUpdateRequest:
    path_params: StorageObjectsUpdatePathParams = field(default=None)
    query_params: StorageObjectsUpdateQueryParams = field(default=None)
    request: Optional[shared.Object] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: StorageObjectsUpdateSecurity = field(default=None)
