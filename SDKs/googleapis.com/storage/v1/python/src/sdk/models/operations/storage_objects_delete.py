...
class StorageObjectsDeleteSecurity:
    option1: Optional[StorageObjectsDeleteSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[StorageObjectsDeleteSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[StorageObjectsDeleteSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class StorageObjectsDeleteRequest:
    path_params: StorageObjectsDeletePathParams = field(default=None)
    query_params: StorageObjectsDeleteQueryParams = field(default=None)
    security: StorageObjectsDeleteSecurity = field(default=None)
