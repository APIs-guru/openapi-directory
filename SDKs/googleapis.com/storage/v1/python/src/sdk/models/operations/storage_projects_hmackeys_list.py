...
class StorageProjectsHmacKeysListRequest:
    path_params: StorageProjectsHmacKeysListPathParams = field(default=None)
    query_params: StorageProjectsHmacKeysListQueryParams = field(default=None)
    security: StorageProjectsHmacKeysListSecurity = field(default=None)
