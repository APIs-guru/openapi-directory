...
class StorageObjectsGetIamPolicyRequest:
    path_params: StorageObjectsGetIamPolicyPathParams = field()
    query_params: StorageObjectsGetIamPolicyQueryParams = field()
    security: StorageObjectsGetIamPolicySecurity = field()
