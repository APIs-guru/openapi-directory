...
class StorageObjectsGetIamPolicySecurity:
    option1: Optional[StorageObjectsGetIamPolicySecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[StorageObjectsGetIamPolicySecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[StorageObjectsGetIamPolicySecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
    option4: Optional[StorageObjectsGetIamPolicySecurityOption4] = field(default=None, metadata={'security': { 'option': True }})
    option5: Optional[StorageObjectsGetIamPolicySecurityOption5] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class StorageObjectsGetIamPolicyRequest:
    path_params: StorageObjectsGetIamPolicyPathParams = field(default=None)
    query_params: StorageObjectsGetIamPolicyQueryParams = field(default=None)
    security: StorageObjectsGetIamPolicySecurity = field(default=None)
