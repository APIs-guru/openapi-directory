...
class StorageDefaultObjectAccessControlsInsertSecurity:
    option1: Optional[StorageDefaultObjectAccessControlsInsertSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[StorageDefaultObjectAccessControlsInsertSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
