...
class StorageBucketsGetSecurity:
    ...
    option4: Optional[StorageBucketsGetSecurityOption4] = field(default=None, metadata={'security': { 'option': True }})
    option5: Optional[StorageBucketsGetSecurityOption5] = field(default=None, metadata={'security': { 'option': True }})
