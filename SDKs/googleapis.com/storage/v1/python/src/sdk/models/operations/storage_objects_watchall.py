...
class StorageObjectsWatchAllSecurity:
    ...
    option4: Optional[StorageObjectsWatchAllSecurityOption4] = field(default=None, metadata={'security': { 'option': True }})
    option5: Optional[StorageObjectsWatchAllSecurityOption5] = field(default=None, metadata={'security': { 'option': True }})
