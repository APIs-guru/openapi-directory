...
class StorageObjectAccessControlsPatchSecurity:
    option1: Optional[StorageObjectAccessControlsPatchSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[StorageObjectAccessControlsPatchSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class StorageObjectAccessControlsPatchRequest:
    path_params: StorageObjectAccessControlsPatchPathParams = field()
    query_params: StorageObjectAccessControlsPatchQueryParams = field()
    security: StorageObjectAccessControlsPatchSecurity = field()
