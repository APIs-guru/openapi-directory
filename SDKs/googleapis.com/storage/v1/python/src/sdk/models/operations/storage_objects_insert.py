...
class StorageObjectsInsertQueryParams:
    ...
    content_encoding: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'contentEncoding', 'style': 'form', 'explode': True }})
    ...
    predefined_acl: Optional[StorageObjectsInsertPredefinedACLEnum] = field(default=None, metadata={'query_param': { 'field_name': 'predefinedAcl', 'style': 'form', 'explode': True }})
...
class StorageObjectsInsertSecurity:
    ...
    option3: Optional[StorageObjectsInsertSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class StorageObjectsInsertRequest:
    path_params: StorageObjectsInsertPathParams = field(default=None)
    query_params: StorageObjectsInsertQueryParams = field(default=None)
    request: Optional[bytes] = field(default=None, metadata={'request': { 'media_type': 'application/octet-stream' }})
    security: StorageObjectsInsertSecurity = field(default=None)
