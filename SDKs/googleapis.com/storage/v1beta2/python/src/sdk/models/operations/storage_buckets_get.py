...
class StorageBucketsGetQueryParams:
    ...
    projection: Optional[StorageBucketsGetProjectionEnum] = field(default=None, metadata={'query_param': { 'field_name': 'projection', 'style': 'form', 'explode': True }})
...
class StorageBucketsGetSecurity:
    option1: Optional[StorageBucketsGetSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[StorageBucketsGetSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[StorageBucketsGetSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class StorageBucketsGetRequest:
    path_params: StorageBucketsGetPathParams = field(default=None)
    query_params: StorageBucketsGetQueryParams = field(default=None)
    security: StorageBucketsGetSecurity = field(default=None)
