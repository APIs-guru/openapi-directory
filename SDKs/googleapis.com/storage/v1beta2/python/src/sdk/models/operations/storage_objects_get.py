...
class StorageObjectsGetRequest:
    path_params: StorageObjectsGetPathParams = field(default=None)
    query_params: StorageObjectsGetQueryParams = field(default=None)
    security: StorageObjectsGetSecurity = field(default=None)
