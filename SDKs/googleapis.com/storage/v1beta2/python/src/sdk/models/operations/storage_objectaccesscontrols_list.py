...
class StorageObjectAccessControlsListRequest:
    path_params: StorageObjectAccessControlsListPathParams = field(default=None)
    query_params: StorageObjectAccessControlsListQueryParams = field(default=None)
    security: StorageObjectAccessControlsListSecurity = field(default=None)
