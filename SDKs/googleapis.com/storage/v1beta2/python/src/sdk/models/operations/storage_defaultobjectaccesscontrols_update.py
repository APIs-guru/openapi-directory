...
class StorageDefaultObjectAccessControlsUpdateRequest:
    path_params: StorageDefaultObjectAccessControlsUpdatePathParams = field(default=None)
    query_params: StorageDefaultObjectAccessControlsUpdateQueryParams = field(default=None)
    request: Optional[shared.ObjectAccessControl] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: StorageDefaultObjectAccessControlsUpdateSecurity = field(default=None)
