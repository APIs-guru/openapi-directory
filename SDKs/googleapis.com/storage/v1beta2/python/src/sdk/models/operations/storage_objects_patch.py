...
class StorageObjectsPatchRequest:
    path_params: StorageObjectsPatchPathParams = field(default=None)
    query_params: StorageObjectsPatchQueryParams = field(default=None)
    request: Optional[shared.Object] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: StorageObjectsPatchSecurity = field(default=None)
