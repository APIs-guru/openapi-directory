...
**/
var RtbMetrics = /** @class */ (function (_super) {
    __extends(RtbMetrics, _super);
    function RtbMetrics() {
    ...
    ], RtbMetrics.prototype, "adImpressions7Days", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=bidRate7Days" }),
        __metadata("design:type", Number)
    ], RtbMetrics.prototype, "bidRate7Days", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=bidRequests7Days" }),
        __metadata("design:type", String)
    ], RtbMetrics.prototype, "bidRequests7Days", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=bids7Days" }),
        __metadata("design:type", String)
    ], RtbMetrics.prototype, "bids7Days", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=filteredBidRate7Days" }),
        __metadata("design:type", Number)
    ], RtbMetrics.prototype, "filteredBidRate7Days", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=mustBidRateCurrentMonth" }),
        __metadata("design:type", Number)
    ], RtbMetrics.prototype, "mustBidRateCurrentMonth", void 0);
    return RtbMetrics;
}(SpeakeasyBase));
export { RtbMetrics };
