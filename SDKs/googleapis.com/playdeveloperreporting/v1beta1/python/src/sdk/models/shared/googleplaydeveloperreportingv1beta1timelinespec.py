...
class GooglePlayDeveloperReportingV1beta1TimelineSpec:
    ...
    aggregation_period: Optional[GooglePlayDeveloperReportingV1beta1TimelineSpecAggregationPeriodEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('aggregationPeriod') }})
