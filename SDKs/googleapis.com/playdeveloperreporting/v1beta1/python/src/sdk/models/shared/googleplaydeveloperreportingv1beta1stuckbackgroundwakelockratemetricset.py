...
class GooglePlayDeveloperReportingV1beta1StuckBackgroundWakelockRateMetricSet:
    r"""GooglePlayDeveloperReportingV1beta1StuckBackgroundWakelockRateMetricSet
    ...
    freshness_info: Optional[GooglePlayDeveloperReportingV1beta1FreshnessInfo] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('freshnessInfo') }})
