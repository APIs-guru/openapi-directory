...
class GooglePlayDeveloperReportingV1beta1FreshnessInfo:
    ...
    freshnesses: Optional[List[GooglePlayDeveloperReportingV1beta1FreshnessInfoFreshness]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('freshnesses') }})
