...
class GooglePlayDeveloperReportingV1beta1ListAnomaliesResponse:
    ...
    anomalies: Optional[List[GooglePlayDeveloperReportingV1beta1Anomaly]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('anomalies') }})
