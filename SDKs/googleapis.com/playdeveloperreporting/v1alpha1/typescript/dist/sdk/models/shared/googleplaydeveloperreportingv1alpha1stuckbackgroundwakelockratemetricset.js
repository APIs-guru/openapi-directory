...
**/
var GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet = /** @class */ (function (_super) {
    __extends(GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet, _super);
    function GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=freshnessInfo" }),
        __metadata("design:type", GooglePlayDeveloperReportingV1alpha1FreshnessInfo)
    ], GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet.prototype, "freshnessInfo", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=name" }),
        __metadata("design:type", String)
    ], GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet.prototype, "name", void 0);
    return GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet;
}(SpeakeasyBase));
export { GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet };
