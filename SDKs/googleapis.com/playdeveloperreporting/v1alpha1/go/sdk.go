...
func (s *SDK) PlaydeveloperreportingVitalsErrorsIssuesSearch(ctx context.Context, request operations.PlaydeveloperreportingVitalsErrorsIssuesSearchRequest) (*operations.PlaydeveloperreportingVitalsErrorsIssuesSearchResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) PlaydeveloperreportingVitalsErrorsReportsSearch(ctx context.Context, request operations.PlaydeveloperreportingVitalsErrorsReportsSearchRequest) (*operations.PlaydeveloperreportingVitalsErrorsReportsSearchResponse, error) {
	baseURL := s.serverURL
