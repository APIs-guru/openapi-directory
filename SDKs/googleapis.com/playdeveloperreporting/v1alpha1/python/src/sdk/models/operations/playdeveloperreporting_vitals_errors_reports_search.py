...
class PlaydeveloperreportingVitalsErrorsReportsSearchRequest:
    path_params: PlaydeveloperreportingVitalsErrorsReportsSearchPathParams = field()
    query_params: PlaydeveloperreportingVitalsErrorsReportsSearchQueryParams = field()
