...
class GooglePlayDeveloperReportingV1alpha1Anomaly:
    ...
    metric: Optional[GooglePlayDeveloperReportingV1alpha1MetricValue] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('metric') }})
    ...
    timeline_spec: Optional[GooglePlayDeveloperReportingV1alpha1TimelineSpec] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('timelineSpec') }})
