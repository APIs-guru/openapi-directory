...
class GooglePlayDeveloperReportingV1alpha1TimelineSpec:
    aggregation_period: Optional[GooglePlayDeveloperReportingV1alpha1TimelineSpecAggregationPeriodEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'aggregationPeriod' }})
