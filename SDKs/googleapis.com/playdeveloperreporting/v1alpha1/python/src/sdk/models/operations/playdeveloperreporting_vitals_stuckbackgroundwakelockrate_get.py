...
class PlaydeveloperreportingVitalsStuckbackgroundwakelockrateGetResponse:
    ...
    google_play_developer_reporting_v1alpha1_stuck_background_wakelock_rate_metric_set: Optional[shared.GooglePlayDeveloperReportingV1alpha1StuckBackgroundWakelockRateMetricSet] = field(default=None)
