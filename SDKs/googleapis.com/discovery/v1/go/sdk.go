...
func (s *SDK) DiscoveryApisGetRest(ctx context.Context, request operations.DiscoveryApisGetRestRequest) (*operations.DiscoveryApisGetRestResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) DiscoveryApisList(ctx context.Context, request operations.DiscoveryApisListRequest) (*operations.DiscoveryApisListResponse, error) {
	baseURL := s.serverURL
