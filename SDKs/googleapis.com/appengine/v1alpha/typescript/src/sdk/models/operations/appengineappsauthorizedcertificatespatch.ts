...
export class AppengineAppsAuthorizedCertificatesPatchPathParams extends SpeakeasyBase {
...
export class AppengineAppsAuthorizedCertificatesPatchQueryParams extends SpeakeasyBase {
...
export class AppengineAppsAuthorizedCertificatesPatchSecurity extends SpeakeasyBase {
...
export class AppengineAppsAuthorizedCertificatesPatchRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class AppengineAppsAuthorizedCertificatesPatchResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
