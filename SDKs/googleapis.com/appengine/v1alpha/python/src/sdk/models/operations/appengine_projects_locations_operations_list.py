...
class AppengineProjectsLocationsOperationsListSecurity:
    option1: Optional[AppengineProjectsLocationsOperationsListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AppengineProjectsLocationsOperationsListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[AppengineProjectsLocationsOperationsListSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class AppengineProjectsLocationsOperationsListRequest:
    path_params: AppengineProjectsLocationsOperationsListPathParams = field(default=None)
    query_params: AppengineProjectsLocationsOperationsListQueryParams = field(default=None)
    security: AppengineProjectsLocationsOperationsListSecurity = field(default=None)
