...
class AppengineAppsDomainMappingsPatchRequest:
    path_params: AppengineAppsDomainMappingsPatchPathParams = field(default=None)
    query_params: AppengineAppsDomainMappingsPatchQueryParams = field(default=None)
    request: Optional[shared.DomainMapping] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: AppengineAppsDomainMappingsPatchSecurity = field(default=None)
