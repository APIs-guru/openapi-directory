...
class AppengineAppsDomainMappingsPatchRequest:
    path_params: AppengineAppsDomainMappingsPatchPathParams = field()
    query_params: AppengineAppsDomainMappingsPatchQueryParams = field()
    security: AppengineAppsDomainMappingsPatchSecurity = field()
