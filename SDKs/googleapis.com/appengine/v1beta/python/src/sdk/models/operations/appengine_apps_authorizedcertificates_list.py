...
class AppengineAppsAuthorizedCertificatesListRequest:
    path_params: AppengineAppsAuthorizedCertificatesListPathParams = field()
    query_params: AppengineAppsAuthorizedCertificatesListQueryParams = field()
    security: AppengineAppsAuthorizedCertificatesListSecurity = field()
