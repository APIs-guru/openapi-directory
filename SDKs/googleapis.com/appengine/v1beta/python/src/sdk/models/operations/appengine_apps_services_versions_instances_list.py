...
class AppengineAppsServicesVersionsInstancesListRequest:
    path_params: AppengineAppsServicesVersionsInstancesListPathParams = field()
    query_params: AppengineAppsServicesVersionsInstancesListQueryParams = field()
    security: AppengineAppsServicesVersionsInstancesListSecurity = field()
