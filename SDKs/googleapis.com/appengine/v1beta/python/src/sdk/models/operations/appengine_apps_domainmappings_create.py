...
class AppengineAppsDomainMappingsCreateRequest:
    path_params: AppengineAppsDomainMappingsCreatePathParams = field(default=None)
    query_params: AppengineAppsDomainMappingsCreateQueryParams = field(default=None)
    request: Optional[shared.DomainMapping] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: AppengineAppsDomainMappingsCreateSecurity = field(default=None)
