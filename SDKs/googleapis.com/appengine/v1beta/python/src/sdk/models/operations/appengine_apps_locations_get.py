...
class AppengineAppsLocationsGetSecurity:
    option1: Optional[AppengineAppsLocationsGetSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AppengineAppsLocationsGetSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[AppengineAppsLocationsGetSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class AppengineAppsLocationsGetRequest:
    path_params: AppengineAppsLocationsGetPathParams = field()
    query_params: AppengineAppsLocationsGetQueryParams = field()
    security: AppengineAppsLocationsGetSecurity = field()
