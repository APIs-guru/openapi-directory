...
export class AppengineAppsServicesVersionsInstancesDebugPathParams extends SpeakeasyBase {
...
export class AppengineAppsServicesVersionsInstancesDebugQueryParams extends SpeakeasyBase {
...
export class AppengineAppsServicesVersionsInstancesDebugSecurity extends SpeakeasyBase {
...
export class AppengineAppsServicesVersionsInstancesDebugRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class AppengineAppsServicesVersionsInstancesDebugResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
