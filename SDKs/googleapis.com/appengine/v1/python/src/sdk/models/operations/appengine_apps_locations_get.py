...
class AppengineAppsLocationsGetRequest:
    path_params: AppengineAppsLocationsGetPathParams = field(default=None)
    query_params: AppengineAppsLocationsGetQueryParams = field(default=None)
    security: AppengineAppsLocationsGetSecurity = field(default=None)
