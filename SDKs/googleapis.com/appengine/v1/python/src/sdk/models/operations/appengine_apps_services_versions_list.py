...
class AppengineAppsServicesVersionsListRequest:
    path_params: AppengineAppsServicesVersionsListPathParams = field(default=None)
    query_params: AppengineAppsServicesVersionsListQueryParams = field(default=None)
    security: AppengineAppsServicesVersionsListSecurity = field(default=None)
