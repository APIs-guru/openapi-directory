...
class AppengineAppsServicesGetRequest:
    path_params: AppengineAppsServicesGetPathParams = field()
    query_params: AppengineAppsServicesGetQueryParams = field()
    security: AppengineAppsServicesGetSecurity = field()
