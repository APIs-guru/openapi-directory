...
class RuntimeconfigProjectsConfigsWaitersDeleteSecurity:
    option1: Optional[RuntimeconfigProjectsConfigsWaitersDeleteSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[RuntimeconfigProjectsConfigsWaitersDeleteSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
