...
class RuntimeconfigProjectsConfigsWaitersGetSecurity:
    option1: Optional[RuntimeconfigProjectsConfigsWaitersGetSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[RuntimeconfigProjectsConfigsWaitersGetSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
