...
class RuntimeconfigProjectsConfigsWaitersTestIamPermissionsRequest:
    path_params: RuntimeconfigProjectsConfigsWaitersTestIamPermissionsPathParams = field()
    query_params: RuntimeconfigProjectsConfigsWaitersTestIamPermissionsQueryParams = field()
    security: RuntimeconfigProjectsConfigsWaitersTestIamPermissionsSecurity = field()
