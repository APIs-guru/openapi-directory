...
class RuntimeconfigProjectsConfigsWaitersTestIamPermissionsSecurity:
    option1: Optional[RuntimeconfigProjectsConfigsWaitersTestIamPermissionsSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[RuntimeconfigProjectsConfigsWaitersTestIamPermissionsSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class RuntimeconfigProjectsConfigsWaitersTestIamPermissionsRequest:
    path_params: RuntimeconfigProjectsConfigsWaitersTestIamPermissionsPathParams = field(default=None)
    query_params: RuntimeconfigProjectsConfigsWaitersTestIamPermissionsQueryParams = field(default=None)
    request: Optional[shared.TestIamPermissionsRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: RuntimeconfigProjectsConfigsWaitersTestIamPermissionsSecurity = field(default=None)
