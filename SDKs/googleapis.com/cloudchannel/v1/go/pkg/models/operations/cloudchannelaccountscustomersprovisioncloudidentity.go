...
type CloudchannelAccountsCustomersProvisionCloudIdentityPathParams struct {
	Customer string `pathParam:"style=simple,explode=false,name=customer"`
}

type CloudchannelAccountsCustomersProvisionCloudIdentityQueryParams struct {
...
type CloudchannelAccountsCustomersProvisionCloudIdentitySecurity struct {
...
type CloudchannelAccountsCustomersProvisionCloudIdentityResponse struct {
	ContentType                string
