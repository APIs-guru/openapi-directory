...
func (s *Operations) CloudchannelOperationsCancel(ctx context.Context, request operations.CloudchannelOperationsCancelRequest) (*operations.CloudchannelOperationsCancelResponse, error) {
...
func (s *Operations) CloudchannelOperationsDelete(ctx context.Context, request operations.CloudchannelOperationsDeleteRequest) (*operations.CloudchannelOperationsDeleteResponse, error) {
	baseURL := s._serverURL
...
func (s *Operations) CloudchannelOperationsList(ctx context.Context, request operations.CloudchannelOperationsListRequest) (*operations.CloudchannelOperationsListResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1/{name}", request.PathParams)
