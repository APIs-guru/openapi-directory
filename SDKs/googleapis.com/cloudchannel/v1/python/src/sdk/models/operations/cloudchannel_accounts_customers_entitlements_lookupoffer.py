...
class CloudchannelAccountsCustomersEntitlementsLookupOfferPathParams:
    entitlement: str = field(metadata={'path_param': { 'field_name': 'entitlement', 'style': 'simple', 'explode': False }})
...
class CloudchannelAccountsCustomersEntitlementsLookupOfferRequest:
    path_params: CloudchannelAccountsCustomersEntitlementsLookupOfferPathParams = field()
    query_params: CloudchannelAccountsCustomersEntitlementsLookupOfferQueryParams = field()
    security: CloudchannelAccountsCustomersEntitlementsLookupOfferSecurity = field()
