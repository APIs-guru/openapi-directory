...
class CloudchannelAccountsCustomersListPurchasableOffersRequest:
    path_params: CloudchannelAccountsCustomersListPurchasableOffersPathParams = field()
    query_params: CloudchannelAccountsCustomersListPurchasableOffersQueryParams = field()
    security: CloudchannelAccountsCustomersListPurchasableOffersSecurity = field()
