...
class CloudchannelAccountsChannelPartnerLinksListRequest:
    path_params: CloudchannelAccountsChannelPartnerLinksListPathParams = field(default=None)
    query_params: CloudchannelAccountsChannelPartnerLinksListQueryParams = field(default=None)
    security: CloudchannelAccountsChannelPartnerLinksListSecurity = field(default=None)
