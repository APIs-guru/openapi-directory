...
export class CloudchannelAccountsUnregisterPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=account" })
  account: string;
}


export class CloudchannelAccountsUnregisterQueryParams extends SpeakeasyBase {
