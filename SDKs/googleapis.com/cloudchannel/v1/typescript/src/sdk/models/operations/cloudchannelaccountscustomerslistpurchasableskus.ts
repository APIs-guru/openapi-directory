...
export class CloudchannelAccountsCustomersListPurchasableSkusQueryParams extends SpeakeasyBase {
  ...
  @Metadata({ data: "queryParam, style=form;explode=true;name=changeOfferPurchase.changeType" })
  ...
  @Metadata({ data: "queryParam, style=form;explode=true;name=createEntitlementPurchase.product" })
