...
class FcmProjectsMessagesSendRequest:
    path_params: FcmProjectsMessagesSendPathParams = field()
    query_params: FcmProjectsMessagesSendQueryParams = field()
    security: FcmProjectsMessagesSendSecurity = field()
