...
class GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionTriggerSettings:
    r"""GoogleCloudDialogflowV2HumanAgentAssistantConfigSuggestionTriggerSettings
    Settings of suggestion trigger.
    """
    
    no_smalltalk: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('noSmalltalk') }})
