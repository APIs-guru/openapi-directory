...
class GoogleCloudDialogflowV2InputAudioConfig:
    r"""GoogleCloudDialogflowV2InputAudioConfig
    Instructs the speech recognizer how to process the audio content.
    """
    
    audio_encoding: Optional[GoogleCloudDialogflowV2InputAudioConfigAudioEncodingEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('audioEncoding') }})
    ...
    model_variant: Optional[GoogleCloudDialogflowV2InputAudioConfigModelVariantEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('modelVariant') }})
    ...
    speech_contexts: Optional[List[GoogleCloudDialogflowV2SpeechContext]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('speechContexts') }})
