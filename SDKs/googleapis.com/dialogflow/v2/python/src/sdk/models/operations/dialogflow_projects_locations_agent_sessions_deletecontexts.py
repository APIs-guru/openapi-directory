...
@dataclass
class DialogflowProjectsLocationsAgentSessionsDeleteContextsQueryParams:
...
class DialogflowProjectsLocationsAgentSessionsDeleteContextsSecurity:
    option1: Optional[DialogflowProjectsLocationsAgentSessionsDeleteContextsSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DialogflowProjectsLocationsAgentSessionsDeleteContextsSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
