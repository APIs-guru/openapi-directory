...
class DialogflowProjectsLocationsKnowledgeBasesCreateRequest:
    path_params: DialogflowProjectsLocationsKnowledgeBasesCreatePathParams = field(default=None)
    query_params: DialogflowProjectsLocationsKnowledgeBasesCreateQueryParams = field(default=None)
    ...
    security: DialogflowProjectsLocationsKnowledgeBasesCreateSecurity = field(default=None)
