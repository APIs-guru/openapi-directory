...
class DialogflowProjectsLocationsAgentEntityTypesEntitiesBatchCreateRequest:
    path_params: DialogflowProjectsLocationsAgentEntityTypesEntitiesBatchCreatePathParams = field()
    query_params: DialogflowProjectsLocationsAgentEntityTypesEntitiesBatchCreateQueryParams = field()
    security: DialogflowProjectsLocationsAgentEntityTypesEntitiesBatchCreateSecurity = field()
