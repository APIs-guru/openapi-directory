...
@dataclass
class DialogflowProjectsLocationsConversationModelsUndeployQueryParams:
...
class DialogflowProjectsLocationsConversationModelsUndeploySecurity:
    option1: Optional[DialogflowProjectsLocationsConversationModelsUndeploySecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DialogflowProjectsLocationsConversationModelsUndeploySecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
