...
class DialogflowProjectsLocationsConversationsParticipantsCreateRequest:
    path_params: DialogflowProjectsLocationsConversationsParticipantsCreatePathParams = field()
    query_params: DialogflowProjectsLocationsConversationsParticipantsCreateQueryParams = field()
    security: DialogflowProjectsLocationsConversationsParticipantsCreateSecurity = field()
