...
class GoogleCloudDialogflowV2SuggestSmartRepliesResponse:
    r"""GoogleCloudDialogflowV2SuggestSmartRepliesResponse
    ...
    smart_reply_answers: Optional[List[GoogleCloudDialogflowV2SmartReplyAnswer]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('smartReplyAnswers') }})
