...
class GoogleCloudDialogflowV2DetectIntentRequest:
    r"""GoogleCloudDialogflowV2DetectIntentRequest
    ...
    query_input: Optional[GoogleCloudDialogflowV2QueryInput] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('queryInput') }})
