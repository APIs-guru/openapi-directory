...
@dataclass
class DialogflowProjectsLocationsConversationsListQueryParams:
...
class DialogflowProjectsLocationsConversationsListSecurity:
    option1: Optional[DialogflowProjectsLocationsConversationsListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DialogflowProjectsLocationsConversationsListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
...
class DialogflowProjectsLocationsConversationsListResponse:
    ...
    google_cloud_dialogflow_v2_list_conversations_response: Optional[shared.GoogleCloudDialogflowV2ListConversationsResponse] = field(default=None)
