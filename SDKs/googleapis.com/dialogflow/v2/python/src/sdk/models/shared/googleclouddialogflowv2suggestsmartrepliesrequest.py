...
class GoogleCloudDialogflowV2SuggestSmartRepliesRequest:
    ...
    current_text_input: Optional[googleclouddialogflowv2textinput.GoogleCloudDialogflowV2TextInput] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'currentTextInput' }})
