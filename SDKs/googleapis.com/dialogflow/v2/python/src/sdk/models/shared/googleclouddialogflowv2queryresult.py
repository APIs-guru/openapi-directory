...
class GoogleCloudDialogflowV2QueryResult:
    r"""GoogleCloudDialogflowV2QueryResult
    ...
    fulfillment_messages: Optional[List[GoogleCloudDialogflowV2IntentMessage]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('fulfillmentMessages') }})
    fulfillment_text: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('fulfillmentText') }})
    intent: Optional[GoogleCloudDialogflowV2Intent] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('intent') }})
    ...
    sentiment_analysis_result: Optional[GoogleCloudDialogflowV2SentimentAnalysisResult] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sentimentAnalysisResult') }})
