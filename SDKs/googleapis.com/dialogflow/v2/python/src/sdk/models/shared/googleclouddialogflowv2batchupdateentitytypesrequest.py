...
class GoogleCloudDialogflowV2BatchUpdateEntityTypesRequest:
    r"""GoogleCloudDialogflowV2BatchUpdateEntityTypesRequest
    The request message for EntityTypes.BatchUpdateEntityTypes.
    """
    
    entity_type_batch_inline: Optional[GoogleCloudDialogflowV2EntityTypeBatch] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('entityTypeBatchInline') }})
