...
from . import googleclouddialogflowv2entitytypebatch


@dataclass_json
@dataclass
class GoogleCloudDialogflowV2BatchUpdateEntityTypesRequest:
    entity_type_batch_inline: Optional[googleclouddialogflowv2entitytypebatch.GoogleCloudDialogflowV2EntityTypeBatch] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'entityTypeBatchInline' }})
