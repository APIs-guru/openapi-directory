...
class DialogflowProjectsLocationsAgentSessionsDetectIntentRequest:
    path_params: DialogflowProjectsLocationsAgentSessionsDetectIntentPathParams = field()
    query_params: DialogflowProjectsLocationsAgentSessionsDetectIntentQueryParams = field()
    security: DialogflowProjectsLocationsAgentSessionsDetectIntentSecurity = field()
