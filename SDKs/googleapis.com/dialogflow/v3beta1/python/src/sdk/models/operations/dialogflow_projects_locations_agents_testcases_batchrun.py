...
@dataclass
class DialogflowProjectsLocationsAgentsTestCasesBatchRunQueryParams:
...
class DialogflowProjectsLocationsAgentsTestCasesBatchRunSecurity:
    option1: Optional[DialogflowProjectsLocationsAgentsTestCasesBatchRunSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DialogflowProjectsLocationsAgentsTestCasesBatchRunSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
