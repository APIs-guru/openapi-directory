...
class DialogflowProjectsLocationsAgentsTestCasesCreateRequest:
    ...
    request: Optional[shared.GoogleCloudDialogflowCxV3beta1TestCaseInput] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class DialogflowProjectsLocationsAgentsTestCasesCreateResponse:
    ...
    google_cloud_dialogflow_cx_v3beta1_test_case: Optional[shared.GoogleCloudDialogflowCxV3beta1TestCase] = field(default=None)
