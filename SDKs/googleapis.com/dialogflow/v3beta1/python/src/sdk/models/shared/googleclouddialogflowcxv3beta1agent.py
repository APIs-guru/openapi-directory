...
class GoogleCloudDialogflowCxV3beta1Agent:
    r"""GoogleCloudDialogflowCxV3beta1Agent
    ...
    advanced_settings: Optional[GoogleCloudDialogflowCxV3beta1AdvancedSettings] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('advancedSettings') }})
    ...
    speech_to_text_settings: Optional[GoogleCloudDialogflowCxV3beta1SpeechToTextSettings] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('speechToTextSettings') }})
