...
class GoogleCloudDialogflowCxV3beta1QueryParameters:
    r"""GoogleCloudDialogflowCxV3beta1QueryParameters
    ...
    session_entity_types: Optional[List[GoogleCloudDialogflowCxV3beta1SessionEntityType]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sessionEntityTypes') }})
