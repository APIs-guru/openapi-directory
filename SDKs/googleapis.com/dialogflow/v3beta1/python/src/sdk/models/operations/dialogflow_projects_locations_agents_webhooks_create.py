...
class DialogflowProjectsLocationsAgentsWebhooksCreateRequest:
    ...
    request: Optional[shared.GoogleCloudDialogflowCxV3beta1Webhook] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class DialogflowProjectsLocationsAgentsWebhooksCreateResponse:
    ...
    google_cloud_dialogflow_cx_v3beta1_webhook: Optional[shared.GoogleCloudDialogflowCxV3beta1Webhook] = field(default=None)
