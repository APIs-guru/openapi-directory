...
from . import googleclouddialogflowcxv3beta1formparameterfillbehavior
...
class GoogleCloudDialogflowCxV3beta1FormParameter:
    ...
    fill_behavior: Optional[googleclouddialogflowcxv3beta1formparameterfillbehavior.GoogleCloudDialogflowCxV3beta1FormParameterFillBehavior] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'fillBehavior' }})
