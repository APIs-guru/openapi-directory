...
class GoogleCloudDialogflowCxV3beta1FormParameter:
    r"""GoogleCloudDialogflowCxV3beta1FormParameter
    ...
    fill_behavior: Optional[GoogleCloudDialogflowCxV3beta1FormParameterFillBehavior] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('fillBehavior') }})
...
class GoogleCloudDialogflowCxV3beta1FormParameterInput:
    r"""GoogleCloudDialogflowCxV3beta1FormParameterInput
    Represents a form parameter.
    """
    ...
    display_name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('displayName') }})
    entity_type: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('entityType') }})
    fill_behavior: Optional[GoogleCloudDialogflowCxV3beta1FormParameterFillBehaviorInput] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('fillBehavior') }})
    is_list: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('isList') }})
    redact: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('redact') }})
    required: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('required') }})
