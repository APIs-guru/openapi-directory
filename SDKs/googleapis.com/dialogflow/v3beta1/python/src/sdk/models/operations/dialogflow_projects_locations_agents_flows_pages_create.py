...
class DialogflowProjectsLocationsAgentsFlowsPagesCreateRequest:
    ...
    request: Optional[shared.GoogleCloudDialogflowCxV3beta1PageInput] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class DialogflowProjectsLocationsAgentsFlowsPagesCreateResponse:
    ...
    google_cloud_dialogflow_cx_v3beta1_page: Optional[shared.GoogleCloudDialogflowCxV3beta1Page] = field(default=None)
