...
class GoogleCloudDialogflowCxV3beta1ContinuousTestResult:
    r"""GoogleCloudDialogflowCxV3beta1ContinuousTestResult
    Represents a result from running a test case in an agent environment.
    """
    
    name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('name') }})
    result: Optional[GoogleCloudDialogflowCxV3beta1ContinuousTestResultResultEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('result') }})
