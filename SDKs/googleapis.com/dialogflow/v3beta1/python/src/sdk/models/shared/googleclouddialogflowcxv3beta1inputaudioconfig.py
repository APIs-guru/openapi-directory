...
class GoogleCloudDialogflowCxV3beta1InputAudioConfig:
    r"""GoogleCloudDialogflowCxV3beta1InputAudioConfig
    Instructs the speech recognizer on how to process the audio content.
    """
    
    audio_encoding: Optional[GoogleCloudDialogflowCxV3beta1InputAudioConfigAudioEncodingEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('audioEncoding') }})
    ...
    model_variant: Optional[GoogleCloudDialogflowCxV3beta1InputAudioConfigModelVariantEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('modelVariant') }})
