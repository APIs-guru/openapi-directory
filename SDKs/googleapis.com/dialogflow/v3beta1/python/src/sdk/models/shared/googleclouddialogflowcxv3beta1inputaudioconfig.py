...
class GoogleCloudDialogflowCxV3beta1InputAudioConfig:
    audio_encoding: Optional[GoogleCloudDialogflowCxV3beta1InputAudioConfigAudioEncodingEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'audioEncoding' }})
    ...
    model_variant: Optional[GoogleCloudDialogflowCxV3beta1InputAudioConfigModelVariantEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'modelVariant' }})
