...
class GoogleCloudDialogflowCxV3beta1SynthesizeSpeechConfig:
    r"""GoogleCloudDialogflowCxV3beta1SynthesizeSpeechConfig
    ...
    voice: Optional[GoogleCloudDialogflowCxV3beta1VoiceSelectionParams] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('voice') }})
