...
class DialogflowProjectsLocationsAgentsFlowsImportRequest:
    path_params: DialogflowProjectsLocationsAgentsFlowsImportPathParams = field(default=None)
    query_params: DialogflowProjectsLocationsAgentsFlowsImportQueryParams = field(default=None)
    ...
    security: DialogflowProjectsLocationsAgentsFlowsImportSecurity = field(default=None)
