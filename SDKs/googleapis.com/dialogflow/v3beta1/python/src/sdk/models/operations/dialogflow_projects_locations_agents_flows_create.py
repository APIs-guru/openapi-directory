...
class DialogflowProjectsLocationsAgentsFlowsCreateRequest:
    path_params: DialogflowProjectsLocationsAgentsFlowsCreatePathParams = field(default=None)
    query_params: DialogflowProjectsLocationsAgentsFlowsCreateQueryParams = field(default=None)
    request: Optional[shared.GoogleCloudDialogflowCxV3beta1Flow] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: DialogflowProjectsLocationsAgentsFlowsCreateSecurity = field(default=None)
    

@dataclass
class DialogflowProjectsLocationsAgentsFlowsCreateResponse:
    content_type: str = field(default=None)
    google_cloud_dialogflow_cx_v3beta1_flow: Optional[shared.GoogleCloudDialogflowCxV3beta1Flow] = field(default=None)
