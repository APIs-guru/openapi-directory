...
**/
var GoogleCloudDialogflowCxV3beta1MatchIntentRequest = /** @class */ (function (_super) {
    __extends(GoogleCloudDialogflowCxV3beta1MatchIntentRequest, _super);
    function GoogleCloudDialogflowCxV3beta1MatchIntentRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=queryInput" }),
        __metadata("design:type", GoogleCloudDialogflowCxV3beta1QueryInput)
    ], GoogleCloudDialogflowCxV3beta1MatchIntentRequest.prototype, "queryInput", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=queryParams" }),
        __metadata("design:type", GoogleCloudDialogflowCxV3beta1QueryParameters)
    ], GoogleCloudDialogflowCxV3beta1MatchIntentRequest.prototype, "queryParams", void 0);
    return GoogleCloudDialogflowCxV3beta1MatchIntentRequest;
}(SpeakeasyBase));
export { GoogleCloudDialogflowCxV3beta1MatchIntentRequest };
