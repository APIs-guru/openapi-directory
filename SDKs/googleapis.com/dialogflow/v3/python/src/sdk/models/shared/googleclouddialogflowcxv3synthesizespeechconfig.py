...
class GoogleCloudDialogflowCxV3SynthesizeSpeechConfig:
    r"""GoogleCloudDialogflowCxV3SynthesizeSpeechConfig
    ...
    voice: Optional[GoogleCloudDialogflowCxV3VoiceSelectionParams] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('voice') }})
