...
class DialogflowProjectsLocationsAgentsWebhooksCreateRequest:
    path_params: DialogflowProjectsLocationsAgentsWebhooksCreatePathParams = field(default=None)
    query_params: DialogflowProjectsLocationsAgentsWebhooksCreateQueryParams = field(default=None)
    request: Optional[shared.GoogleCloudDialogflowCxV3Webhook] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: DialogflowProjectsLocationsAgentsWebhooksCreateSecurity = field(default=None)
