...
class DialogflowProjectsLocationsAgentsFlowsTrainRequest:
    path_params: DialogflowProjectsLocationsAgentsFlowsTrainPathParams = field()
    query_params: DialogflowProjectsLocationsAgentsFlowsTrainQueryParams = field()
    security: DialogflowProjectsLocationsAgentsFlowsTrainSecurity = field()
