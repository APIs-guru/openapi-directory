...
class GoogleCloudDialogflowCxV3ConversationTurnUserInput:
    r"""GoogleCloudDialogflowCxV3ConversationTurnUserInput
    ...
    input: Optional[GoogleCloudDialogflowCxV3QueryInput] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('input') }})
