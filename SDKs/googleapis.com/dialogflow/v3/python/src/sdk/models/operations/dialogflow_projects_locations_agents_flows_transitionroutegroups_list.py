...
@dataclass
class DialogflowProjectsLocationsAgentsFlowsTransitionRouteGroupsListQueryParams:
...
class DialogflowProjectsLocationsAgentsFlowsTransitionRouteGroupsListSecurity:
    option1: Optional[DialogflowProjectsLocationsAgentsFlowsTransitionRouteGroupsListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DialogflowProjectsLocationsAgentsFlowsTransitionRouteGroupsListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
...
class DialogflowProjectsLocationsAgentsFlowsTransitionRouteGroupsListResponse:
    ...
    google_cloud_dialogflow_cx_v3_list_transition_route_groups_response: Optional[shared.GoogleCloudDialogflowCxV3ListTransitionRouteGroupsResponse] = field(default=None)
