...
class GoogleCloudDialogflowCxV3OutputAudioConfig:
    r"""GoogleCloudDialogflowCxV3OutputAudioConfig
    Instructs the speech synthesizer how to generate the output audio content.
    """
    
    audio_encoding: Optional[GoogleCloudDialogflowCxV3OutputAudioConfigAudioEncodingEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('audioEncoding') }})
    sample_rate_hertz: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sampleRateHertz') }})
    synthesize_speech_config: Optional[GoogleCloudDialogflowCxV3SynthesizeSpeechConfig] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('synthesizeSpeechConfig') }})
