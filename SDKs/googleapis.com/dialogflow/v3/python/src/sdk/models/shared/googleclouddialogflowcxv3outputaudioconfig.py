...
from . import googleclouddialogflowcxv3synthesizespeechconfig

class GoogleCloudDialogflowCxV3OutputAudioConfigAudioEncodingEnum(str, Enum):
...
class GoogleCloudDialogflowCxV3OutputAudioConfig:
    audio_encoding: Optional[GoogleCloudDialogflowCxV3OutputAudioConfigAudioEncodingEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'audioEncoding' }})
    sample_rate_hertz: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'sampleRateHertz' }})
    synthesize_speech_config: Optional[googleclouddialogflowcxv3synthesizespeechconfig.GoogleCloudDialogflowCxV3SynthesizeSpeechConfig] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'synthesizeSpeechConfig' }})
