...
class DialogflowProjectsLocationsAgentsIntentsListRequest:
    path_params: DialogflowProjectsLocationsAgentsIntentsListPathParams = field(default=None)
    query_params: DialogflowProjectsLocationsAgentsIntentsListQueryParams = field(default=None)
    security: DialogflowProjectsLocationsAgentsIntentsListSecurity = field(default=None)
    

@dataclass
class DialogflowProjectsLocationsAgentsIntentsListResponse:
    content_type: str = field(default=None)
    google_cloud_dialogflow_cx_v3_list_intents_response: Optional[shared.GoogleCloudDialogflowCxV3ListIntentsResponse] = field(default=None)
