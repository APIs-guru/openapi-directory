...
class GoogleCloudDialogflowCxV3Webhook:
    r"""GoogleCloudDialogflowCxV3Webhook
    ...
    service_directory: Optional[GoogleCloudDialogflowCxV3WebhookServiceDirectoryConfig] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('serviceDirectory') }})
