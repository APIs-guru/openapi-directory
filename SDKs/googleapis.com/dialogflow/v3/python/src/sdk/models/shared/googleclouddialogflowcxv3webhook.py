...
from . import googleclouddialogflowcxv3webhookservicedirectoryconfig
...
class GoogleCloudDialogflowCxV3Webhook:
    ...
    service_directory: Optional[googleclouddialogflowcxv3webhookservicedirectoryconfig.GoogleCloudDialogflowCxV3WebhookServiceDirectoryConfig] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'serviceDirectory' }})
