...
class GoogleCloudDialogflowCxV3TransitionRouteGroupCoverage:
    r"""GoogleCloudDialogflowCxV3TransitionRouteGroupCoverage
    ...
    coverages: Optional[List[GoogleCloudDialogflowCxV3TransitionRouteGroupCoverageCoverage]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('coverages') }})
