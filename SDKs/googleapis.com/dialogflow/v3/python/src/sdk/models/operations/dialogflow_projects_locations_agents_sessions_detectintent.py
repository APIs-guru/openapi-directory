...
class DialogflowProjectsLocationsAgentsSessionsDetectIntentRequest:
    path_params: DialogflowProjectsLocationsAgentsSessionsDetectIntentPathParams = field()
    query_params: DialogflowProjectsLocationsAgentsSessionsDetectIntentQueryParams = field()
    security: DialogflowProjectsLocationsAgentsSessionsDetectIntentSecurity = field()
    request: Optional[shared.GoogleCloudDialogflowCxV3DetectIntentRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class DialogflowProjectsLocationsAgentsSessionsDetectIntentResponse:
    ...
    google_cloud_dialogflow_cx_v3_detect_intent_response: Optional[shared.GoogleCloudDialogflowCxV3DetectIntentResponse] = field(default=None)
