...
class GoogleCloudDialogflowCxV3QueryResult:
    r"""GoogleCloudDialogflowCxV3QueryResult
    ...
    response_messages: Optional[List[GoogleCloudDialogflowCxV3ResponseMessage]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('responseMessages') }})
    sentiment_analysis_result: Optional[GoogleCloudDialogflowCxV3SentimentAnalysisResult] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sentimentAnalysisResult') }})
