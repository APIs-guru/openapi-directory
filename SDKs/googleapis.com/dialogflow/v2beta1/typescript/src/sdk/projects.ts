  ...
  dialogflowProjectsConversationsParticipantsSuggestionsCompile(
    ...
    return client
      .request({
        ...
        const res: operations.DialogflowProjectsConversationsParticipantsSuggestionsCompileResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  dialogflowProjectsConversationsParticipantsSuggestionsList(
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.DialogflowProjectsConversationsParticipantsSuggestionsListResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
  ...
  dialogflowProjectsLocationsConversationsMessagesBatchCreate(
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.DialogflowProjectsLocationsConversationsMessagesBatchCreateResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
  ...
  dialogflowProjectsLocationsConversationsSuggestionsSuggestConversationSummary(
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.DialogflowProjectsLocationsConversationsSuggestionsSuggestConversationSummaryResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
