...
**/
var GoogleCloudDialogflowV2beta1IntentMessageTableCard = /** @class */ (function (_super) {
    __extends(GoogleCloudDialogflowV2beta1IntentMessageTableCard, _super);
    function GoogleCloudDialogflowV2beta1IntentMessageTableCard() {
    ...
    ], GoogleCloudDialogflowV2beta1IntentMessageTableCard.prototype, "buttons", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=columnProperties", elemType: GoogleCloudDialogflowV2beta1IntentMessageColumnProperties }),
        __metadata("design:type", Array)
    ], GoogleCloudDialogflowV2beta1IntentMessageTableCard.prototype, "columnProperties", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=image" }),
        __metadata("design:type", GoogleCloudDialogflowV2beta1IntentMessageImage)
    ], GoogleCloudDialogflowV2beta1IntentMessageTableCard.prototype, "image", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=rows", elemType: GoogleCloudDialogflowV2beta1IntentMessageTableCardRow }),
        __metadata("design:type", Array)
    ], GoogleCloudDialogflowV2beta1IntentMessageTableCard.prototype, "rows", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=subtitle" }),
        __metadata("design:type", String)
    ], GoogleCloudDialogflowV2beta1IntentMessageTableCard.prototype, "subtitle", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=title" }),
        __metadata("design:type", String)
    ], GoogleCloudDialogflowV2beta1IntentMessageTableCard.prototype, "title", void 0);
    return GoogleCloudDialogflowV2beta1IntentMessageTableCard;
}(SpeakeasyBase));
export { GoogleCloudDialogflowV2beta1IntentMessageTableCard };
