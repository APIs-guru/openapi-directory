...
**/
var GoogleCloudDialogflowV2beta1ResponseMessageLiveAgentHandoff = /** @class */ (function (_super) {
    __extends(GoogleCloudDialogflowV2beta1ResponseMessageLiveAgentHandoff, _super);
    function GoogleCloudDialogflowV2beta1ResponseMessageLiveAgentHandoff() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=metadata" }),
        __metadata("design:type", Map)
    ], GoogleCloudDialogflowV2beta1ResponseMessageLiveAgentHandoff.prototype, "metadata", void 0);
    return GoogleCloudDialogflowV2beta1ResponseMessageLiveAgentHandoff;
}(SpeakeasyBase));
export { GoogleCloudDialogflowV2beta1ResponseMessageLiveAgentHandoff };
