...
class GoogleCloudDialogflowV2beta1IntentMessageCard:
    r"""GoogleCloudDialogflowV2beta1IntentMessageCard
    The card response message.
    """
    
    buttons: Optional[List[GoogleCloudDialogflowV2beta1IntentMessageCardButton]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('buttons') }})
