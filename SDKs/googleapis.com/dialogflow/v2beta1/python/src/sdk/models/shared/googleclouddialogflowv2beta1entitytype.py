...
class GoogleCloudDialogflowV2beta1EntityType:
    r"""GoogleCloudDialogflowV2beta1EntityType
    ...
    auto_expansion_mode: Optional[GoogleCloudDialogflowV2beta1EntityTypeAutoExpansionModeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('autoExpansionMode') }})
    ...
    kind: Optional[GoogleCloudDialogflowV2beta1EntityTypeKindEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('kind') }})
