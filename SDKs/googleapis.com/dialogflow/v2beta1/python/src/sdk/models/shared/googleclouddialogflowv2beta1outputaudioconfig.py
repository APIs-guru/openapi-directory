...
class GoogleCloudDialogflowV2beta1OutputAudioConfig:
    r"""GoogleCloudDialogflowV2beta1OutputAudioConfig
    ...
    audio_encoding: Optional[GoogleCloudDialogflowV2beta1OutputAudioConfigAudioEncodingEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('audioEncoding') }})
    sample_rate_hertz: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sampleRateHertz') }})
    synthesize_speech_config: Optional[GoogleCloudDialogflowV2beta1SynthesizeSpeechConfig] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('synthesizeSpeechConfig') }})
