...
class DialogflowProjectsLocationsKnowledgeBasesCreateRequest:
    ...
    request: Optional[shared.GoogleCloudDialogflowV2beta1KnowledgeBase] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class DialogflowProjectsLocationsKnowledgeBasesCreateResponse:
    ...
    google_cloud_dialogflow_v2beta1_knowledge_base: Optional[shared.GoogleCloudDialogflowV2beta1KnowledgeBase] = field(default=None)
