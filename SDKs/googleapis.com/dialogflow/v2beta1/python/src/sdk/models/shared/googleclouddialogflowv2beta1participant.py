...
class GoogleCloudDialogflowV2beta1Participant:
    r"""GoogleCloudDialogflowV2beta1Participant
    ...
    role: Optional[GoogleCloudDialogflowV2beta1ParticipantRoleEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('role') }})
