...
class DialogflowProjectsLocationsAgentIntentsCreateRequest:
    path_params: DialogflowProjectsLocationsAgentIntentsCreatePathParams = field(default=None)
    query_params: DialogflowProjectsLocationsAgentIntentsCreateQueryParams = field(default=None)
    request: Optional[shared.GoogleCloudDialogflowV2beta1Intent] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: DialogflowProjectsLocationsAgentIntentsCreateSecurity = field(default=None)
    

@dataclass
class DialogflowProjectsLocationsAgentIntentsCreateResponse:
    content_type: str = field(default=None)
    google_cloud_dialogflow_v2beta1_intent: Optional[shared.GoogleCloudDialogflowV2beta1Intent] = field(default=None)
