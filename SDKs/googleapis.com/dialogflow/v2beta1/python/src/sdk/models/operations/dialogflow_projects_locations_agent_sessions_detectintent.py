...
class DialogflowProjectsLocationsAgentSessionsDetectIntentRequest:
    ...
    request: Optional[shared.GoogleCloudDialogflowV2beta1DetectIntentRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class DialogflowProjectsLocationsAgentSessionsDetectIntentResponse:
    ...
    google_cloud_dialogflow_v2beta1_detect_intent_response: Optional[shared.GoogleCloudDialogflowV2beta1DetectIntentResponse] = field(default=None)
