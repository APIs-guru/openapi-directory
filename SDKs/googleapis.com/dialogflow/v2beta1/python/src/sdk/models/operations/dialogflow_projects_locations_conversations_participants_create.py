...
class DialogflowProjectsLocationsConversationsParticipantsCreateRequest:
    ...
    request: Optional[shared.GoogleCloudDialogflowV2beta1Participant] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class DialogflowProjectsLocationsConversationsParticipantsCreateResponse:
    ...
    google_cloud_dialogflow_v2beta1_participant: Optional[shared.GoogleCloudDialogflowV2beta1Participant] = field(default=None)
