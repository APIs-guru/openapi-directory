...
class GoogleCloudDialogflowV2beta1AnswerRecord:
    r"""GoogleCloudDialogflowV2beta1AnswerRecord
    ...
    agent_assistant_record: Optional[GoogleCloudDialogflowV2beta1AgentAssistantRecord] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('agentAssistantRecord') }})
    answer_feedback: Optional[GoogleCloudDialogflowV2beta1AnswerFeedback] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('answerFeedback') }})
