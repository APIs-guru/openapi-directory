...
class GoogleCloudDialogflowV2beta1SuggestConversationSummaryResponse:
    r"""GoogleCloudDialogflowV2beta1SuggestConversationSummaryResponse
    ...
    summary: Optional[GoogleCloudDialogflowV2beta1SuggestConversationSummaryResponseSummary] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('summary') }})
