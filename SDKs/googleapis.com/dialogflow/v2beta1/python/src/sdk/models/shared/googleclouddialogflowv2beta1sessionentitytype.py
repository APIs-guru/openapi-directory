...
class GoogleCloudDialogflowV2beta1SessionEntityType:
    ...
    entity_override_mode: Optional[GoogleCloudDialogflowV2beta1SessionEntityTypeEntityOverrideModeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'entityOverrideMode' }})
