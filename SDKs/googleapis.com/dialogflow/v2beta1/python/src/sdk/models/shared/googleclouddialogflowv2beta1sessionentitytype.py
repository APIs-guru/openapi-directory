...
class GoogleCloudDialogflowV2beta1SessionEntityType:
    r"""GoogleCloudDialogflowV2beta1SessionEntityType
    ...
    entity_override_mode: Optional[GoogleCloudDialogflowV2beta1SessionEntityTypeEntityOverrideModeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('entityOverrideMode') }})
