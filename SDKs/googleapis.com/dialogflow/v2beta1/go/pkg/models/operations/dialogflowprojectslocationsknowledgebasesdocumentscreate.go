...
type DialogflowProjectsLocationsKnowledgeBasesDocumentsCreateQueryParams struct {
	...
	ImportGcsCustomMetadata *bool             `queryParam:"style=form,explode=true,name=importGcsCustomMetadata"`
...
type DialogflowProjectsLocationsKnowledgeBasesDocumentsCreateRequest struct {
	...
	Request     *shared.GoogleCloudDialogflowV2beta1Document `request:"mediaType=application/json"`
