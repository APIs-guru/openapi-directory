...
var Topic = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", PartitionConfig)
    ], Topic.prototype, "partitionConfig", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=reservationConfig" }),
        __metadata("design:type", ReservationConfig)
    ], Topic.prototype, "reservationConfig", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=retentionConfig" }),
        __metadata("design:type", RetentionConfig)
    ], Topic.prototype, "retentionConfig", void 0);
    return Topic;
}(SpeakeasyBase));
export { Topic };
