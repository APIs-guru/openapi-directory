...
type PubsubliteAdminProjectsLocationsReservationsCreatePathParams struct {
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type PubsubliteAdminProjectsLocationsReservationsCreateQueryParams struct {
...
type PubsubliteAdminProjectsLocationsReservationsCreateSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type PubsubliteAdminProjectsLocationsReservationsCreateRequest struct {
...
type PubsubliteAdminProjectsLocationsReservationsCreateResponse struct {
	ContentType string
