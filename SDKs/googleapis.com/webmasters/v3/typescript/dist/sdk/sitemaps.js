...
var Sitemaps = /** @class */ (function () {
    ...
    **/
    Sitemaps.prototype.webmastersSitemapsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.WebmastersSitemapsDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/sites/{siteUrl}/sitemaps/{feedpath}", req.pathParams);
    ...
    **/
    Sitemaps.prototype.webmastersSitemapsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.wmxSitemap = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Sitemaps.prototype.webmastersSitemapsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.WebmastersSitemapsListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/sites/{siteUrl}/sitemaps", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.sitemapsListResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Sitemaps.prototype.webmastersSitemapsSubmit = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
