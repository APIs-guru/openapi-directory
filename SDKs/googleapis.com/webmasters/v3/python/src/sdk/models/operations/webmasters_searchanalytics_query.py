...
class WebmastersSearchanalyticsQueryRequest:
    path_params: WebmastersSearchanalyticsQueryPathParams = field()
    query_params: WebmastersSearchanalyticsQueryQueryParams = field()
    security: WebmastersSearchanalyticsQuerySecurity = field()
