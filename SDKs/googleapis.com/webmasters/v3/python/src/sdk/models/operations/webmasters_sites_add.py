...
class WebmastersSitesAddRequest:
    path_params: WebmastersSitesAddPathParams = field(default=None)
    query_params: WebmastersSitesAddQueryParams = field(default=None)
    security: WebmastersSitesAddSecurity = field(default=None)
