...
var V1 = /** @class */ (function () {
    ...
    **/
    V1.prototype.firebasedynamiclinksGetLinkStats = function (req, config) {
    ...
    **/
    V1.prototype.firebasedynamiclinksInstallAttribution = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    V1.prototype.firebasedynamiclinksReopenAttribution = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
