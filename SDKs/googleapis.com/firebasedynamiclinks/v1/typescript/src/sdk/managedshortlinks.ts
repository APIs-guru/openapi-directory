...
export class ManagedShortLinks {
  ...
  firebasedynamiclinksManagedShortLinksCreate(
    ...
    return client
      .request({
        ...
        const res: operations.FirebasedynamiclinksManagedShortLinksCreateResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
