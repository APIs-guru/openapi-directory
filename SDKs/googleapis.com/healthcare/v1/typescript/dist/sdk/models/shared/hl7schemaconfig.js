...
**/
var Hl7SchemaConfig = /** @class */ (function (_super) {
    __extends(Hl7SchemaConfig, _super);
    function Hl7SchemaConfig() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=messageSchemaConfigs", elemType: SchemaGroup }),
        __metadata("design:type", Map)
    ], Hl7SchemaConfig.prototype, "messageSchemaConfigs", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=version", elemType: VersionSource }),
        __metadata("design:type", Array)
    ], Hl7SchemaConfig.prototype, "version", void 0);
    return Hl7SchemaConfig;
}(SpeakeasyBase));
export { Hl7SchemaConfig };
