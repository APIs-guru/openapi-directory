...
**/
var QueryAccessibleDataRequest = /** @class */ (function (_super) {
    __extends(QueryAccessibleDataRequest, _super);
    function QueryAccessibleDataRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=gcsDestination" }),
        __metadata("design:type", GoogleCloudHealthcareV1ConsentGcsDestination)
    ], QueryAccessibleDataRequest.prototype, "gcsDestination", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=requestAttributes" }),
        __metadata("design:type", Map)
    ], QueryAccessibleDataRequest.prototype, "requestAttributes", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=resourceAttributes" }),
        __metadata("design:type", Map)
    ], QueryAccessibleDataRequest.prototype, "resourceAttributes", void 0);
    return QueryAccessibleDataRequest;
}(SpeakeasyBase));
export { QueryAccessibleDataRequest };
