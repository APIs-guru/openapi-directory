...
var EntityMention = /** @class */ (function (_super) {
    ...
    ], EntityMention.prototype, "certaintyAssessment", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=confidence" }),
        __metadata("design:type", Number)
    ], EntityMention.prototype, "confidence", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=linkedEntities", elemType: LinkedEntity }),
        __metadata("design:type", Array)
    ], EntityMention.prototype, "linkedEntities", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=mentionId" }),
        __metadata("design:type", String)
    ], EntityMention.prototype, "mentionId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=subject" }),
        __metadata("design:type", Feature)
    ], EntityMention.prototype, "subject", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=temporalAssessment" }),
        __metadata("design:type", Feature)
    ], EntityMention.prototype, "temporalAssessment", void 0);
    __decorate([
