...
class HealthcareProjectsLocationsDatasetsFhirStoresFhirPatientEverythingRequest:
    path_params: HealthcareProjectsLocationsDatasetsFhirStoresFhirPatientEverythingPathParams = field()
    query_params: HealthcareProjectsLocationsDatasetsFhirStoresFhirPatientEverythingQueryParams = field()
    security: HealthcareProjectsLocationsDatasetsFhirStoresFhirPatientEverythingSecurity = field()
