...
from . import googlecloudhealthcarev1consentpolicy
...
class Consent:
    ...
    policies: Optional[List[googlecloudhealthcarev1consentpolicy.GoogleCloudHealthcareV1ConsentPolicy]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'policies' }})
