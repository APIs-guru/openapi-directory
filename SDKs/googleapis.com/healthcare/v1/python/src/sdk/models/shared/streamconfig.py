...
class StreamConfig:
    ...
    bigquery_destination: Optional[GoogleCloudHealthcareV1FhirBigQueryDestination] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('bigqueryDestination') }})
