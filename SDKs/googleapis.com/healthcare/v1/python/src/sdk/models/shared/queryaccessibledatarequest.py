...
class QueryAccessibleDataRequest:
    ...
    gcs_destination: Optional[GoogleCloudHealthcareV1ConsentGcsDestination] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('gcsDestination') }})
