...
class HealthcareProjectsLocationsDatasetsFhirStoresFhirConceptMapTranslateRequest:
    path_params: HealthcareProjectsLocationsDatasetsFhirStoresFhirConceptMapTranslatePathParams = field()
    query_params: HealthcareProjectsLocationsDatasetsFhirStoresFhirConceptMapTranslateQueryParams = field()
    security: HealthcareProjectsLocationsDatasetsFhirStoresFhirConceptMapTranslateSecurity = field()
