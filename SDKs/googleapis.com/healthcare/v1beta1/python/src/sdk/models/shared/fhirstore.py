...
class FhirStore:
    ...
    notification_configs: Optional[List[FhirNotificationConfig]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('notificationConfigs') }})
    search_config: Optional[SearchConfig] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('searchConfig') }})
