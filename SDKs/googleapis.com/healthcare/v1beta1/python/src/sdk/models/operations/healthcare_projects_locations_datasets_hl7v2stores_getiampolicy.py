...
class HealthcareProjectsLocationsDatasetsHl7V2StoresGetIamPolicyRequest:
    path_params: HealthcareProjectsLocationsDatasetsHl7V2StoresGetIamPolicyPathParams = field(default=None)
    query_params: HealthcareProjectsLocationsDatasetsHl7V2StoresGetIamPolicyQueryParams = field(default=None)
    security: HealthcareProjectsLocationsDatasetsHl7V2StoresGetIamPolicySecurity = field(default=None)
