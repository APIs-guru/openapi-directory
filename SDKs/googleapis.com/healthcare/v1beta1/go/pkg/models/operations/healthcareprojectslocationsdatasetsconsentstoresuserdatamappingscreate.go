...
type HealthcareProjectsLocationsDatasetsConsentStoresUserDataMappingsCreatePathParams struct {
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type HealthcareProjectsLocationsDatasetsConsentStoresUserDataMappingsCreateQueryParams struct {
...
type HealthcareProjectsLocationsDatasetsConsentStoresUserDataMappingsCreateSecurity struct {
...
type HealthcareProjectsLocationsDatasetsConsentStoresUserDataMappingsCreateResponse struct {
	ContentType     string
	StatusCode      int64
