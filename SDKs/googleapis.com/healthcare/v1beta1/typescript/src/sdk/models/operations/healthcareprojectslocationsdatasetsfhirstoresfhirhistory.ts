...
export class HealthcareProjectsLocationsDatasetsFhirStoresFhirHistoryQueryParams extends SpeakeasyBase {
  ...
  @Metadata({ data: "queryParam, style=form;explode=true;name=_at" })
  at?: string;

  @Metadata({ data: "queryParam, style=form;explode=true;name=_count" })
  count?: number;

  @Metadata({ data: "queryParam, style=form;explode=true;name=_page_token" })
  pageToken?: string;

  @Metadata({ data: "queryParam, style=form;explode=true;name=_since" })
  since?: string;
