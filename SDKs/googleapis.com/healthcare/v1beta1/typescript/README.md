...
import { HealthcareProjectsLocationsDatasetsAnnotationStoresAnnotationsCreateRequest, HealthcareProjectsLocationsDatasetsAnnotationStoresAnnotationsCreateResponse } from "openapi/src/sdk/models/operations";
import { AxiosError } from "axios";


const sdk = new SDK();
    
const req: HealthcareProjectsLocationsDatasetsAnnotationStoresAnnotationsCreateRequest = {
  security: {
    oauth2: {
  ...
  request: {
    ...
    imageAnnotation: {
      ...
      frameIndex: 5132551596305807487,
    },
    name: "amet",
    resourceAnnotation: {
      label: "nulla",
...
sdk.projects.healthcareProjectsLocationsDatasetsAnnotationStoresAnnotationsCreate(req).then((res: HealthcareProjectsLocationsDatasetsAnnotationStoresAnnotationsCreateResponse | AxiosError) => {
   // handle response
});
```
