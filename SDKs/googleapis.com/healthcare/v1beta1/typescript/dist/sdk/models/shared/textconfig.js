...
export var TextConfigProfileTypeEnum;
(function (TextConfigProfileTypeEnum) {
...
})(TextConfigProfileTypeEnum || (TextConfigProfileTypeEnum = {}));
// TextConfig
/**
...
var TextConfig = /** @class */ (function (_super) {
    ...
    ], TextConfig.prototype, "additionalTransformations", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=excludeInfoTypes" }),
        __metadata("design:type", Array)
    ], TextConfig.prototype, "excludeInfoTypes", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=profileType" }),
        __metadata("design:type", String)
    ], TextConfig.prototype, "profileType", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=transformations", elemType: InfoTypeTransformation }),
        __metadata("design:type", Array)
    ], TextConfig.prototype, "transformations", void 0);
    return TextConfig;
}(SpeakeasyBase));
export { TextConfig };
