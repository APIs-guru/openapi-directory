...
export var FhirFieldConfigProfileTypeEnum;
(function (FhirFieldConfigProfileTypeEnum) {
...
})(FhirFieldConfigProfileTypeEnum || (FhirFieldConfigProfileTypeEnum = {}));
// FhirFieldConfig
/**
 * Specifies how to handle the de-identification of a FHIR store.
**/
var FhirFieldConfig = /** @class */ (function (_super) {
    __extends(FhirFieldConfig, _super);
    function FhirFieldConfig() {
    ...
    ], FhirFieldConfig.prototype, "fieldMetadataList", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=options" }),
        __metadata("design:type", GoogleCloudHealthcareV1beta1DeidentifyOptions)
    ], FhirFieldConfig.prototype, "options", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=profileType" }),
        __metadata("design:type", String)
    ], FhirFieldConfig.prototype, "profileType", void 0);
    return FhirFieldConfig;
}(SpeakeasyBase));
export { FhirFieldConfig };
