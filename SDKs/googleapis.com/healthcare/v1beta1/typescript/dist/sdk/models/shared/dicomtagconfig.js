...
export var DicomTagConfigProfileTypeEnum;
(function (DicomTagConfigProfileTypeEnum) {
...
})(DicomTagConfigProfileTypeEnum || (DicomTagConfigProfileTypeEnum = {}));
// DicomTagConfig
/**
 * Specifies the parameters needed for the de-identification of DICOM stores.
**/
var DicomTagConfig = /** @class */ (function (_super) {
    __extends(DicomTagConfig, _super);
    function DicomTagConfig() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=actions", elemType: Action }),
        __metadata("design:type", Array)
    ], DicomTagConfig.prototype, "actions", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=options" }),
        __metadata("design:type", Options)
    ], DicomTagConfig.prototype, "options", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=profileType" }),
        __metadata("design:type", String)
    ], DicomTagConfig.prototype, "profileType", void 0);
    return DicomTagConfig;
}(SpeakeasyBase));
export { DicomTagConfig };
