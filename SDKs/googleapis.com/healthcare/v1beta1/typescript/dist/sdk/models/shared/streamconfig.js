...
**/
var StreamConfig = /** @class */ (function (_super) {
    __extends(StreamConfig, _super);
    function StreamConfig() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=bigqueryDestination" }),
        __metadata("design:type", GoogleCloudHealthcareV1beta1FhirBigQueryDestination)
    ], StreamConfig.prototype, "bigqueryDestination", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=deidentifiedStoreDestination" }),
        __metadata("design:type", DeidentifiedStoreDestination)
    ], StreamConfig.prototype, "deidentifiedStoreDestination", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=resourceTypes" }),
        __metadata("design:type", Array)
    ], StreamConfig.prototype, "resourceTypes", void 0);
    return StreamConfig;
}(SpeakeasyBase));
export { StreamConfig };
