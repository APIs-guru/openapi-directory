...
type RemotebuildexecutionProjectsInstancesListPathParams struct {
    Parent string `pathParam:"style=simple,explode=false,name=parent"`
    
}

type RemotebuildexecutionProjectsInstancesListQueryParams struct {
...
type RemotebuildexecutionProjectsInstancesListSecurity struct {
    Oauth2 shared.SchemeOauth2 `security:"scheme,type=oauth2"`
    Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
    
}

type RemotebuildexecutionProjectsInstancesListRequest struct {
...
type RemotebuildexecutionProjectsInstancesListResponse struct {
    ContentType string 
