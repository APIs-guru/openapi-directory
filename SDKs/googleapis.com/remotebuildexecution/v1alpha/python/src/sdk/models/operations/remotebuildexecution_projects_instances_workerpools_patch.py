...
class RemotebuildexecutionProjectsInstancesWorkerpoolsPatchQueryParams:
    ...
    logging_enabled: Optional[bool] = field(default=None, metadata={'query_param': { 'field_name': 'loggingEnabled', 'style': 'form', 'explode': True }})
    name1: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'name1', 'style': 'form', 'explode': True }})
