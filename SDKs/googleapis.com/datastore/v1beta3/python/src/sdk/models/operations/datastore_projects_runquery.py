...
@dataclass
class DatastoreProjectsRunQueryQueryParams:
...
class DatastoreProjectsRunQuerySecurity:
    option1: Optional[DatastoreProjectsRunQuerySecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[DatastoreProjectsRunQuerySecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
