...
var Projects = /** @class */ (function () {
    ...
    **/
    Projects.prototype.datastoreProjectsExport = function (req, config) {
        ...
        var url = utils.GenerateURL(baseURL, "/v1beta1/projects/{projectId}:export", req.pathParams);
    ...
    **/
    Projects.prototype.datastoreProjectsImport = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta1/projects/{projectId}:import", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
