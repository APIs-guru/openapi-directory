...
func (s *SDK) PlaycustomappAccountsCustomAppsCreate(ctx context.Context, request operations.PlaycustomappAccountsCustomAppsCreateRequest) (*operations.PlaycustomappAccountsCustomAppsCreateResponse, error) {
	baseURL := s.serverURL
