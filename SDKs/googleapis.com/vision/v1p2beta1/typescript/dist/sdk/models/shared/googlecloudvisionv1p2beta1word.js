...
**/
var GoogleCloudVisionV1p2beta1Word = /** @class */ (function (_super) {
    __extends(GoogleCloudVisionV1p2beta1Word, _super);
    function GoogleCloudVisionV1p2beta1Word() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=boundingBox" }),
        __metadata("design:type", GoogleCloudVisionV1p2beta1BoundingPoly)
    ], GoogleCloudVisionV1p2beta1Word.prototype, "boundingBox", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=confidence" }),
        __metadata("design:type", Number)
    ], GoogleCloudVisionV1p2beta1Word.prototype, "confidence", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=property" }),
        __metadata("design:type", GoogleCloudVisionV1p2beta1TextAnnotationTextProperty)
    ], GoogleCloudVisionV1p2beta1Word.prototype, "property", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=symbols", elemType: GoogleCloudVisionV1p2beta1Symbol }),
        __metadata("design:type", Array)
    ], GoogleCloudVisionV1p2beta1Word.prototype, "symbols", void 0);
    return GoogleCloudVisionV1p2beta1Word;
}(SpeakeasyBase));
export { GoogleCloudVisionV1p2beta1Word };
