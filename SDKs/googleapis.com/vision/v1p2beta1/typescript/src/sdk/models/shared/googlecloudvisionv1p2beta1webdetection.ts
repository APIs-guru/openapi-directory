...
export class GoogleCloudVisionV1p2beta1WebDetection extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=bestGuessLabels", elemType: GoogleCloudVisionV1p2beta1WebDetectionWebLabel })
  ...
  @SpeakeasyMetadata({ data: "json, name=pagesWithMatchingImages", elemType: GoogleCloudVisionV1p2beta1WebDetectionWebPage })
  ...
  @SpeakeasyMetadata({ data: "json, name=visuallySimilarImages", elemType: GoogleCloudVisionV1p2beta1WebDetectionWebImage })
  visuallySimilarImages?: GoogleCloudVisionV1p2beta1WebDetectionWebImage[];

  @SpeakeasyMetadata({ data: "json, name=webEntities", elemType: GoogleCloudVisionV1p2beta1WebDetectionWebEntity })
