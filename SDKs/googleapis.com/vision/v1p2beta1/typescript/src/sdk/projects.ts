...
export class Projects {
  ...
  **/
  visionProjectsLocationsFilesAnnotate(
    ...
    const url: string = utils.GenerateURL(baseURL, "/v1p2beta1/{parent}/files:annotate", req.pathParams);
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.googleCloudVisionV1p2beta1BatchAnnotateFilesResponse = httpRes?.data;
            }
            break;
        }
  ...
  **/
  visionProjectsLocationsFilesAsyncBatchAnnotate(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1p2beta1/{parent}/files:asyncBatchAnnotate", req.pathParams);
  ...
  **/
  visionProjectsLocationsImagesAnnotate(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1p2beta1/{parent}/images:annotate", req.pathParams);
  ...
  **/
  visionProjectsLocationsImagesAsyncBatchAnnotate(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1p2beta1/{parent}/images:asyncBatchAnnotate", req.pathParams);
