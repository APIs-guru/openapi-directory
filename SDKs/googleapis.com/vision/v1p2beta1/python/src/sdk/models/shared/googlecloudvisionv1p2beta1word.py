...
from . import googlecloudvisionv1p2beta1symbol
...
class GoogleCloudVisionV1p2beta1Word:
    ...
    symbols: Optional[List[googlecloudvisionv1p2beta1symbol.GoogleCloudVisionV1p2beta1Symbol]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'symbols' }})
