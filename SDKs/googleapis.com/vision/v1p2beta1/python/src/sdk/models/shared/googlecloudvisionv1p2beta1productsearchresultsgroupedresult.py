...
class GoogleCloudVisionV1p2beta1ProductSearchResultsGroupedResult:
    ...
    object_annotations: Optional[List[GoogleCloudVisionV1p2beta1ProductSearchResultsObjectAnnotation]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('objectAnnotations') }})
