...
from . import googlecloudvisionv1p2beta1position
...
class GoogleCloudVisionV1p2beta1FaceAnnotationLandmark:
    position: Optional[googlecloudvisionv1p2beta1position.GoogleCloudVisionV1p2beta1Position] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'position' }})
    type: Optional[GoogleCloudVisionV1p2beta1FaceAnnotationLandmarkTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'type' }})
