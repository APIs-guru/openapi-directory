...
class GoogleCloudVisionV1p2beta1OutputConfig:
    ...
    gcs_destination: Optional[GoogleCloudVisionV1p2beta1GcsDestination] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('gcsDestination') }})
