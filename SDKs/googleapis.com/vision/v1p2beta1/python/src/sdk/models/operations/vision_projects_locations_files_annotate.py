...
class VisionProjectsLocationsFilesAnnotateRequest:
    path_params: VisionProjectsLocationsFilesAnnotatePathParams = field(default=None)
    query_params: VisionProjectsLocationsFilesAnnotateQueryParams = field(default=None)
    ...
    security: VisionProjectsLocationsFilesAnnotateSecurity = field(default=None)
