...
class GoogleCloudVisionV1p2beta1ProductSearchResultsResult:
    r"""GoogleCloudVisionV1p2beta1ProductSearchResultsResult
    Information about a product.
    """
    
    image: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('image') }})
    product: Optional[GoogleCloudVisionV1p2beta1Product] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('product') }})
