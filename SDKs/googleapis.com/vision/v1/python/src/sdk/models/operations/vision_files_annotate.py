...
class VisionFilesAnnotateSecurity:
    option1: Optional[VisionFilesAnnotateSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[VisionFilesAnnotateSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
