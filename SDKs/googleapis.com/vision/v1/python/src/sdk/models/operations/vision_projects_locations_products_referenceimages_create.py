...
class VisionProjectsLocationsProductsReferenceImagesCreateRequest:
    path_params: VisionProjectsLocationsProductsReferenceImagesCreatePathParams = field()
    query_params: VisionProjectsLocationsProductsReferenceImagesCreateQueryParams = field()
    security: VisionProjectsLocationsProductsReferenceImagesCreateSecurity = field()
