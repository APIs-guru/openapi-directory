...
export var DetectedBreakTypeEnum;
(function (DetectedBreakTypeEnum) {
...
})(DetectedBreakTypeEnum || (DetectedBreakTypeEnum = {}));
// DetectedBreak
/**
 * Detected start or end of a structural component.
**/
var DetectedBreak = /** @class */ (function (_super) {
    __extends(DetectedBreak, _super);
    function DetectedBreak() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=isPrefix" }),
        __metadata("design:type", Boolean)
    ], DetectedBreak.prototype, "isPrefix", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=type" }),
        __metadata("design:type", String)
    ], DetectedBreak.prototype, "type", void 0);
    return DetectedBreak;
}(SpeakeasyBase));
export { DetectedBreak };
