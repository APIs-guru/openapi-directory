...
**/
var ProductSearchResults = /** @class */ (function (_super) {
    __extends(ProductSearchResults, _super);
    ...
    ], ProductSearchResults.prototype, "indexTime", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=productGroupedResults", elemType: GroupedResult }),
        __metadata("design:type", Array)
    ], ProductSearchResults.prototype, "productGroupedResults", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=results", elemType: Result }),
        __metadata("design:type", Array)
    ], ProductSearchResults.prototype, "results", void 0);
