...
var ImageContext = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", CropHintsParams)
    ], ImageContext.prototype, "cropHintsParams", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=languageHints" }),
        __metadata("design:type", Array)
    ], ImageContext.prototype, "languageHints", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=latLongRect" }),
        __metadata("design:type", LatLongRect)
    ], ImageContext.prototype, "latLongRect", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=productSearchParams" }),
        __metadata("design:type", ProductSearchParams)
    ], ImageContext.prototype, "productSearchParams", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=textDetectionParams" }),
        __metadata("design:type", TextDetectionParams)
    ], ImageContext.prototype, "textDetectionParams", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=webDetectionParams" }),
        __metadata("design:type", WebDetectionParams)
    ], ImageContext.prototype, "webDetectionParams", void 0);
    return ImageContext;
}(SpeakeasyBase));
export { ImageContext };
