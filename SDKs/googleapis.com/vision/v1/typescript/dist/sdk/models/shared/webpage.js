...
var WebPage = /** @class */ (function (_super) {
    ...
    ], WebPage.prototype, "fullMatchingImages", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=pageTitle" }),
        __metadata("design:type", String)
    ], WebPage.prototype, "pageTitle", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=partialMatchingImages", elemType: WebImage }),
        __metadata("design:type", Array)
    ], WebPage.prototype, "partialMatchingImages", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=score" }),
        __metadata("design:type", Number)
    ], WebPage.prototype, "score", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=url" }),
        __metadata("design:type", String)
    ], WebPage.prototype, "url", void 0);
    return WebPage;
}(SpeakeasyBase));
export { WebPage };
