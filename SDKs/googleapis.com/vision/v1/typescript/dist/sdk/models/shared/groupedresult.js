...
**/
var GroupedResult = /** @class */ (function (_super) {
    __extends(GroupedResult, _super);
    ...
    ], GroupedResult.prototype, "boundingPoly", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=objectAnnotations", elemType: ObjectAnnotation }),
        __metadata("design:type", Array)
    ], GroupedResult.prototype, "objectAnnotations", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=results", elemType: Result }),
        __metadata("design:type", Array)
    ], GroupedResult.prototype, "results", void 0);
    return GroupedResult;
}(SpeakeasyBase));
export { GroupedResult };
