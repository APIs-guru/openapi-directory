...
func (s *Operations) VisionOperationsCancel(ctx context.Context, request operations.VisionOperationsCancelRequest) (*operations.VisionOperationsCancelResponse, error) {
	...
	res := &operations.VisionOperationsCancelResponse{
