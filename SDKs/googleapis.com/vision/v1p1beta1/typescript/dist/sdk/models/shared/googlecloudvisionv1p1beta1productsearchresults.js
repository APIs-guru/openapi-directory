...
**/
var GoogleCloudVisionV1p1beta1ProductSearchResults = /** @class */ (function (_super) {
    __extends(GoogleCloudVisionV1p1beta1ProductSearchResults, _super);
    function GoogleCloudVisionV1p1beta1ProductSearchResults() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=indexTime" }),
        __metadata("design:type", String)
    ], GoogleCloudVisionV1p1beta1ProductSearchResults.prototype, "indexTime", void 0);
    __decorate([
    ...
    ], GoogleCloudVisionV1p1beta1ProductSearchResults.prototype, "productGroupedResults", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=results", elemType: GoogleCloudVisionV1p1beta1ProductSearchResultsResult }),
        __metadata("design:type", Array)
    ], GoogleCloudVisionV1p1beta1ProductSearchResults.prototype, "results", void 0);
    return GoogleCloudVisionV1p1beta1ProductSearchResults;
}(SpeakeasyBase));
export { GoogleCloudVisionV1p1beta1ProductSearchResults };
