...
export class Projects {
  ...
  **/
  visionProjectsLocationsFilesAnnotate(
    ...
    const url: string = utils.GenerateURL(baseURL, "/v1p1beta1/{parent}/files:annotate", req.pathParams);
    ...
    return client
      .request({
        ...
        const res: operations.VisionProjectsLocationsFilesAnnotateResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.googleCloudVisionV1p1beta1BatchAnnotateFilesResponse = httpRes?.data;
            }
            break;
        }
  ...
  **/
  visionProjectsLocationsFilesAsyncBatchAnnotate(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1p1beta1/{parent}/files:asyncBatchAnnotate", req.pathParams);
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.VisionProjectsLocationsFilesAsyncBatchAnnotateResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
  ...
  **/
  visionProjectsLocationsImagesAnnotate(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1p1beta1/{parent}/images:annotate", req.pathParams);
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.VisionProjectsLocationsImagesAnnotateResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.googleCloudVisionV1p1beta1BatchAnnotateImagesResponse = httpRes?.data;
            }
            break;
        }
  ...
  **/
  visionProjectsLocationsImagesAsyncBatchAnnotate(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1p1beta1/{parent}/images:asyncBatchAnnotate", req.pathParams);
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.VisionProjectsLocationsImagesAsyncBatchAnnotateResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.operation = httpRes?.data;
