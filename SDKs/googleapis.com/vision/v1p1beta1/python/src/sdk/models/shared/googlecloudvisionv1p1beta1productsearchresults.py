...
class GoogleCloudVisionV1p1beta1ProductSearchResults:
    ...
    product_grouped_results: Optional[List[GoogleCloudVisionV1p1beta1ProductSearchResultsGroupedResult]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('productGroupedResults') }})
