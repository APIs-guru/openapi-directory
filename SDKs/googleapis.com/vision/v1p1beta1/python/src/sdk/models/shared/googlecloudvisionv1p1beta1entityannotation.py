...
from . import googlecloudvisionv1p1beta1locationinfo
from . import googlecloudvisionv1p1beta1property
...
class GoogleCloudVisionV1p1beta1EntityAnnotation:
    ...
    locations: Optional[List[googlecloudvisionv1p1beta1locationinfo.GoogleCloudVisionV1p1beta1LocationInfo]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'locations' }})
    mid: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'mid' }})
    properties: Optional[List[googlecloudvisionv1p1beta1property.GoogleCloudVisionV1p1beta1Property]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'properties' }})
