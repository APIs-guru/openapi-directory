...
@dataclass
class FirebasestorageProjectsBucketsRemoveFirebaseQueryParams:
...
class FirebasestorageProjectsBucketsRemoveFirebaseSecurity:
    option1: Optional[FirebasestorageProjectsBucketsRemoveFirebaseSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[FirebasestorageProjectsBucketsRemoveFirebaseSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
