...
@dataclass
class FirebasestorageProjectsBucketsAddFirebaseQueryParams:
...
class FirebasestorageProjectsBucketsAddFirebaseSecurity:
    option1: Optional[FirebasestorageProjectsBucketsAddFirebaseSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[FirebasestorageProjectsBucketsAddFirebaseSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
