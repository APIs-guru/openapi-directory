...
**/
var FileUploadAnswers = /** @class */ (function (_super) {
    __extends(FileUploadAnswers, _super);
    function FileUploadAnswers() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=answers", elemType: FileUploadAnswer }),
        __metadata("design:type", Array)
    ], FileUploadAnswers.prototype, "answers", void 0);
    return FileUploadAnswers;
}(SpeakeasyBase));
export { FileUploadAnswers };
