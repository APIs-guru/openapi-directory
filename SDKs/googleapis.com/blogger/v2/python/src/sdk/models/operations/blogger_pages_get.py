...
class BloggerPagesGetRequest:
    path_params: BloggerPagesGetPathParams = field(default=None)
    query_params: BloggerPagesGetQueryParams = field(default=None)
    security: BloggerPagesGetSecurity = field(default=None)
