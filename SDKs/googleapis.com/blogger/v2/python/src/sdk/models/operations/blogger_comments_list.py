...
class BloggerCommentsListRequest:
    path_params: BloggerCommentsListPathParams = field(default=None)
    query_params: BloggerCommentsListQueryParams = field(default=None)
    security: BloggerCommentsListSecurity = field(default=None)
