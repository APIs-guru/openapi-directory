...
var BloggerUsersGetSecurityOption1 = /** @class */ (function (_super) {
    __extends(BloggerUsersGetSecurityOption1, _super);
    function BloggerUsersGetSecurityOption1() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "security, scheme=true;type=oauth2" }),
        __metadata("design:type", shared.SchemeOauth2)
    ], BloggerUsersGetSecurityOption1.prototype, "oauth2", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "security, scheme=true;type=oauth2" }),
        __metadata("design:type", shared.SchemeOauth2c)
    ], BloggerUsersGetSecurityOption1.prototype, "oauth2c", void 0);
    return BloggerUsersGetSecurityOption1;
}(SpeakeasyBase));
export { BloggerUsersGetSecurityOption1 };
var BloggerUsersGetSecurityOption2 = /** @class */ (function (_super) {
    __extends(BloggerUsersGetSecurityOption2, _super);
    function BloggerUsersGetSecurityOption2() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "security, scheme=true;type=oauth2" }),
        __metadata("design:type", shared.SchemeOauth2)
    ], BloggerUsersGetSecurityOption2.prototype, "oauth2", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "security, scheme=true;type=oauth2" }),
        __metadata("design:type", shared.SchemeOauth2c)
    ], BloggerUsersGetSecurityOption2.prototype, "oauth2c", void 0);
    return BloggerUsersGetSecurityOption2;
}(SpeakeasyBase));
export { BloggerUsersGetSecurityOption2 };
var BloggerUsersGetSecurity = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", BloggerUsersGetSecurityOption1)
    ], BloggerUsersGetSecurity.prototype, "option1", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "security, option=true" }),
        __metadata("design:type", BloggerUsersGetSecurityOption2)
    ], BloggerUsersGetSecurity.prototype, "option2", void 0);
