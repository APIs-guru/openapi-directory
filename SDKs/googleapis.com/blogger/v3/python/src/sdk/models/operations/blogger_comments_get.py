...
class BloggerCommentsGetQueryParams:
    ...
    view: Optional[BloggerCommentsGetViewEnum] = field(default=None, metadata={'query_param': { 'field_name': 'view', 'style': 'form', 'explode': True }})
...
class BloggerCommentsGetSecurity:
    option1: Optional[BloggerCommentsGetSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[BloggerCommentsGetSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
