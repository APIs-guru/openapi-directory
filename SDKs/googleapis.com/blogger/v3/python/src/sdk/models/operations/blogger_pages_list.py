...
class BloggerPagesListViewEnum(str, Enum):
...
@dataclass
class BloggerPagesListQueryParams:
    ...
    status: Optional[List[BloggerPagesListStatusEnum]] = field(default=None, metadata={'query_param': { 'field_name': 'status', 'style': 'form', 'explode': True }})
    upload_type: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'uploadType', 'style': 'form', 'explode': True }})
    upload_protocol: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'upload_protocol', 'style': 'form', 'explode': True }})
    view: Optional[BloggerPagesListViewEnum] = field(default=None, metadata={'query_param': { 'field_name': 'view', 'style': 'form', 'explode': True }})
...
class BloggerPagesListSecurity:
    option1: Optional[BloggerPagesListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[BloggerPagesListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
