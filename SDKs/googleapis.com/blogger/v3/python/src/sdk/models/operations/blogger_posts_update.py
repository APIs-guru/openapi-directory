...
@dataclass
class BloggerPostsUpdatePathParams:
...
@dataclass
class BloggerPostsUpdateQueryParams:
...
@dataclass
class BloggerPostsUpdateSecurity:
...
class BloggerPostsUpdateRequest:
    path_params: BloggerPostsUpdatePathParams = field(default=None)
    query_params: BloggerPostsUpdateQueryParams = field(default=None)
    request: Optional[shared.Post] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: BloggerPostsUpdateSecurity = field(default=None)
    

@dataclass
class BloggerPostsUpdateResponse:
