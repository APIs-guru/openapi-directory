...
@dataclass
class BloggerPagesPatchPathParams:
...
@dataclass
class BloggerPagesPatchQueryParams:
...
@dataclass
class BloggerPagesPatchSecurity:
    oauth2: shared.SchemeOauth2 = field(default=None, metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    oauth2c: shared.SchemeOauth2c = field(default=None, metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclass
class BloggerPagesPatchRequest:
    path_params: BloggerPagesPatchPathParams = field(default=None)
    query_params: BloggerPagesPatchQueryParams = field(default=None)
    request: Optional[shared.Page] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: BloggerPagesPatchSecurity = field(default=None)
    

@dataclass
class BloggerPagesPatchResponse:
