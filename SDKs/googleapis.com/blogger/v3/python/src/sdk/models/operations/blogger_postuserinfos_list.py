...
class BloggerPostUserInfosListRequest:
    path_params: BloggerPostUserInfosListPathParams = field()
    query_params: BloggerPostUserInfosListQueryParams = field()
    security: BloggerPostUserInfosListSecurity = field()
