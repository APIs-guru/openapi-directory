...
class GenomicsWorkersCheckInSecurity:
    option1: Optional[GenomicsWorkersCheckInSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[GenomicsWorkersCheckInSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
