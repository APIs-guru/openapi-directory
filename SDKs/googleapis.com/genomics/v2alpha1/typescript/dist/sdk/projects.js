...
var Projects = /** @class */ (function () {
    ...
    **/
    Projects.prototype.genomicsProjectsOperationsCancel = function (req, config) {
        var _a;
    ...
    **/
    Projects.prototype.genomicsProjectsOperationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Projects.prototype.genomicsProjectsWorkersCheckIn = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GenomicsProjectsWorkersCheckInRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v2alpha1/{id}:checkIn", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
