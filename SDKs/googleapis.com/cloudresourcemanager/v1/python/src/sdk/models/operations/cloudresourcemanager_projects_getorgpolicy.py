...
class CloudresourcemanagerProjectsGetOrgPolicyRequest:
    path_params: CloudresourcemanagerProjectsGetOrgPolicyPathParams = field(default=None)
    query_params: CloudresourcemanagerProjectsGetOrgPolicyQueryParams = field(default=None)
    request: Optional[shared.GetOrgPolicyRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: CloudresourcemanagerProjectsGetOrgPolicySecurity = field(default=None)
