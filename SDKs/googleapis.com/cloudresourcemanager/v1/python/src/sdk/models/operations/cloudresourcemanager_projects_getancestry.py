...
class CloudresourcemanagerProjectsGetAncestrySecurity:
    option1: Optional[CloudresourcemanagerProjectsGetAncestrySecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[CloudresourcemanagerProjectsGetAncestrySecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
