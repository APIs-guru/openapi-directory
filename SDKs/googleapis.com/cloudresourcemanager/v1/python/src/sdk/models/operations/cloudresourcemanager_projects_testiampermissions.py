...
class CloudresourcemanagerProjectsTestIamPermissionsSecurity:
    option1: Optional[CloudresourcemanagerProjectsTestIamPermissionsSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[CloudresourcemanagerProjectsTestIamPermissionsSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class CloudresourcemanagerProjectsTestIamPermissionsRequest:
    path_params: CloudresourcemanagerProjectsTestIamPermissionsPathParams = field(default=None)
    query_params: CloudresourcemanagerProjectsTestIamPermissionsQueryParams = field(default=None)
    request: Optional[shared.TestIamPermissionsRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: CloudresourcemanagerProjectsTestIamPermissionsSecurity = field(default=None)
