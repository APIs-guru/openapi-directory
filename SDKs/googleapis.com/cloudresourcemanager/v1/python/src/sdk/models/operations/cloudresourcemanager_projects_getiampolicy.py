...
class CloudresourcemanagerProjectsGetIamPolicyRequest:
    path_params: CloudresourcemanagerProjectsGetIamPolicyPathParams = field()
    query_params: CloudresourcemanagerProjectsGetIamPolicyQueryParams = field()
    security: CloudresourcemanagerProjectsGetIamPolicySecurity = field()
