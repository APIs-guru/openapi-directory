...
var Organizations = /** @class */ (function () {
    ...
    **/
    Organizations.prototype.cloudresourcemanagerOrganizationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Organizations.prototype.cloudresourcemanagerOrganizationsUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
