...
class CloudresourcemanagerProjectsTestIamPermissionsRequest:
    path_params: CloudresourcemanagerProjectsTestIamPermissionsPathParams = field()
    query_params: CloudresourcemanagerProjectsTestIamPermissionsQueryParams = field()
    security: CloudresourcemanagerProjectsTestIamPermissionsSecurity = field()
