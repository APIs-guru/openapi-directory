...
class CloudresourcemanagerFoldersSearchSecurity:
    option1: Optional[CloudresourcemanagerFoldersSearchSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[CloudresourcemanagerFoldersSearchSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
