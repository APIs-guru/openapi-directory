...
@dataclass
class CloudresourcemanagerTagValuesGetQueryParams:
...
class CloudresourcemanagerTagValuesGetSecurity:
    option1: Optional[CloudresourcemanagerTagValuesGetSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[CloudresourcemanagerTagValuesGetSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
