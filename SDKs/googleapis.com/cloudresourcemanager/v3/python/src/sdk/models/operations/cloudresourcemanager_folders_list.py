...
class CloudresourcemanagerFoldersListSecurity:
    option1: Optional[CloudresourcemanagerFoldersListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[CloudresourcemanagerFoldersListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
