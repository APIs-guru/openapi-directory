...
class CloudresourcemanagerTagKeysListSecurity:
    option1: Optional[CloudresourcemanagerTagKeysListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[CloudresourcemanagerTagKeysListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
