...
class CloudresourcemanagerEffectiveTagsListSecurity:
    option1: Optional[CloudresourcemanagerEffectiveTagsListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[CloudresourcemanagerEffectiveTagsListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
