...
class CloudresourcemanagerTagValuesTestIamPermissionsSecurity:
    option1: Optional[CloudresourcemanagerTagValuesTestIamPermissionsSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[CloudresourcemanagerTagValuesTestIamPermissionsSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
