...
var TagKeys = /** @class */ (function () {
    function TagKeys(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    TagKeys.prototype.cloudresourcemanagerTagKeysCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CloudresourcemanagerTagKeysCreateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v3/tagKeys";
    ...
    **/
    TagKeys.prototype.cloudresourcemanagerTagKeysList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.listTagKeysResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
