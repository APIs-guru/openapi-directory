...
var Liens = /** @class */ (function () {
    function Liens(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Liens.prototype.cloudresourcemanagerLiensCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CloudresourcemanagerLiensCreateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v3/liens";
    ...
    **/
    Liens.prototype.cloudresourcemanagerLiensList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
