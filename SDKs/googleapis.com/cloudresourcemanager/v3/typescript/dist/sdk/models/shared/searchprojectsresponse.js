...
**/
var SearchProjectsResponse = /** @class */ (function (_super) {
    __extends(SearchProjectsResponse, _super);
    ...
    ], SearchProjectsResponse.prototype, "nextPageToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=projects", elemType: Project }),
        __metadata("design:type", Array)
    ], SearchProjectsResponse.prototype, "projects", void 0);
    return SearchProjectsResponse;
}(SpeakeasyBase));
export { SearchProjectsResponse };
