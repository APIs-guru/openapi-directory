...
export class Projects {
  ...
  **/
  bigqueryconnectionProjectsLocationsConnectionsCreate(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.BigqueryconnectionProjectsLocationsConnectionsCreateRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta1/{parent}/connections", req.pathParams);
    ...
    return client
      .request({
        ...
        const res: operations.BigqueryconnectionProjectsLocationsConnectionsCreateResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  bigqueryconnectionProjectsLocationsConnectionsDelete(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.BigqueryconnectionProjectsLocationsConnectionsDeleteRequest(req);
    }
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.BigqueryconnectionProjectsLocationsConnectionsDeleteResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
  ...
  **/
  bigqueryconnectionProjectsLocationsConnectionsGet(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.BigqueryconnectionProjectsLocationsConnectionsGetRequest(req);
    }
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.BigqueryconnectionProjectsLocationsConnectionsGetResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.connection = httpRes?.data;
  ...
  **/
  bigqueryconnectionProjectsLocationsConnectionsGetIamPolicy(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.BigqueryconnectionProjectsLocationsConnectionsGetIamPolicyRequest(req);
    }
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.BigqueryconnectionProjectsLocationsConnectionsGetIamPolicyResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
  ...
  **/
  bigqueryconnectionProjectsLocationsConnectionsList(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.BigqueryconnectionProjectsLocationsConnectionsListRequest(req);
    }
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.BigqueryconnectionProjectsLocationsConnectionsListResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
  ...
  **/
  bigqueryconnectionProjectsLocationsConnectionsSetIamPolicy(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.BigqueryconnectionProjectsLocationsConnectionsSetIamPolicyRequest(req);
    }
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.BigqueryconnectionProjectsLocationsConnectionsSetIamPolicyResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.policy = httpRes?.data;
  ...
  **/
  bigqueryconnectionProjectsLocationsConnectionsTestIamPermissions(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.BigqueryconnectionProjectsLocationsConnectionsTestIamPermissionsRequest(req);
    }
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.BigqueryconnectionProjectsLocationsConnectionsTestIamPermissionsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
  ...
  **/
  bigqueryconnectionProjectsLocationsConnectionsUpdateCredential(
    ...
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.BigqueryconnectionProjectsLocationsConnectionsUpdateCredentialRequest(req);
    }
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.BigqueryconnectionProjectsLocationsConnectionsUpdateCredentialResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.empty = httpRes?.data;
