...
class BigqueryconnectionProjectsLocationsConnectionsTestIamPermissionsRequest:
    path_params: BigqueryconnectionProjectsLocationsConnectionsTestIamPermissionsPathParams = field(default=None)
    query_params: BigqueryconnectionProjectsLocationsConnectionsTestIamPermissionsQueryParams = field(default=None)
    request: Optional[shared.TestIamPermissionsRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: BigqueryconnectionProjectsLocationsConnectionsTestIamPermissionsSecurity = field(default=None)
