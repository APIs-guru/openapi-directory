...
class BigqueryconnectionProjectsLocationsConnectionsSetIamPolicyRequest:
    path_params: BigqueryconnectionProjectsLocationsConnectionsSetIamPolicyPathParams = field(default=None)
    query_params: BigqueryconnectionProjectsLocationsConnectionsSetIamPolicyQueryParams = field(default=None)
    request: Optional[shared.SetIamPolicyRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: BigqueryconnectionProjectsLocationsConnectionsSetIamPolicySecurity = field(default=None)
