...
class BigqueryconnectionProjectsLocationsConnectionsCreateSecurity:
    option1: Optional[BigqueryconnectionProjectsLocationsConnectionsCreateSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[BigqueryconnectionProjectsLocationsConnectionsCreateSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
