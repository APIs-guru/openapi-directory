...
class MybusinessAccountsInvitationsListRequest:
    path_params: MybusinessAccountsInvitationsListPathParams = field(default=None)
    query_params: MybusinessAccountsInvitationsListQueryParams = field(default=None)
