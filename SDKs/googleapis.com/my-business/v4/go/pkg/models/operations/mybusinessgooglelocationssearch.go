...
type MybusinessGoogleLocationsSearchQueryParams struct {
...
type MybusinessGoogleLocationsSearchRequest struct {
...
type MybusinessGoogleLocationsSearchResponse struct {
	ContentType                   string
