...
type Services struct {
	...
	BaggageStorageException          *ServicesBaggageStorageExceptionEnum          `json:"baggageStorageException"`
	Concierge                        *bool                                         `json:"concierge"`
	ConciergeException               *ServicesConciergeExceptionEnum               `json:"conciergeException"`
	ConvenienceStore                 *bool                                         `json:"convenienceStore"`
	ConvenienceStoreException        *ServicesConvenienceStoreExceptionEnum        `json:"convenienceStoreException"`
	CurrencyExchange                 *bool                                         `json:"currencyExchange"`
	CurrencyExchangeException        *ServicesCurrencyExchangeExceptionEnum        `json:"currencyExchangeException"`
	Elevator                         *bool                                         `json:"elevator"`
	ElevatorException                *ServicesElevatorExceptionEnum                `json:"elevatorException"`
	FrontDesk                        *bool                                         `json:"frontDesk"`
	FrontDeskException               *ServicesFrontDeskExceptionEnum               `json:"frontDeskException"`
	FullServiceLaundry               *bool                                         `json:"fullServiceLaundry"`
	FullServiceLaundryException      *ServicesFullServiceLaundryExceptionEnum      `json:"fullServiceLaundryException"`
	GiftShop                         *bool                                         `json:"giftShop"`
	GiftShopException                *ServicesGiftShopExceptionEnum                `json:"giftShopException"`
	LanguagesSpoken                  *LanguagesSpoken                              `json:"languagesSpoken"`
	SelfServiceLaundry               *bool                                         `json:"selfServiceLaundry"`
	SelfServiceLaundryException      *ServicesSelfServiceLaundryExceptionEnum      `json:"selfServiceLaundryException"`
	SocialHour                       *bool                                         `json:"socialHour"`
	SocialHourException              *ServicesSocialHourExceptionEnum              `json:"socialHourException"`
	TwentyFourHourFrontDesk          *bool                                         `json:"twentyFourHourFrontDesk"`
	TwentyFourHourFrontDeskException *ServicesTwentyFourHourFrontDeskExceptionEnum `json:"twentyFourHourFrontDeskException"`
	WakeUpCalls                      *bool                                         `json:"wakeUpCalls"`
	WakeUpCallsException             *ServicesWakeUpCallsExceptionEnum             `json:"wakeUpCallsException"`
}
