...
var Queries = /** @class */ (function () {
    ...
    **/
    Queries.prototype.doubleclickbidmanagerQueriesCreatequery = function (req, config) {
        var _a;
    ...
    **/
    Queries.prototype.doubleclickbidmanagerQueriesDeletequery = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Queries.prototype.doubleclickbidmanagerQueriesGetquery = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Queries.prototype.doubleclickbidmanagerQueriesListqueries = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Queries.prototype.doubleclickbidmanagerQueriesRunquery = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
