...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.AssuredworkloadsOrganizationsLocationsOperationsList = function (req, config) {
    ...
    SDK.prototype.AssuredworkloadsOrganizationsLocationsWorkloadsCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.AssuredworkloadsOrganizationsLocationsWorkloadsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.AssuredworkloadsOrganizationsLocationsWorkloadsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.AssuredworkloadsOrganizationsLocationsWorkloadsOrganizationsLocationsWorkloadsAnalyzeWorkloadMove = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.AssuredworkloadsOrganizationsLocationsWorkloadsPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.AssuredworkloadsOrganizationsLocationsWorkloadsRestrictAllowedResources = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.AssuredworkloadsOrganizationsLocationsWorkloadsViolationsAcknowledge = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.AssuredworkloadsOrganizationsLocationsWorkloadsViolationsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.AssuredworkloadsOrganizationsLocationsWorkloadsViolationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.AssuredworkloadsProjectsOrganizationsLocationsWorkloadsAnalyzeWorkloadMove = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AssuredworkloadsProjectsOrganizationsLocationsWorkloadsAnalyzeWorkloadMoveRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta1/{project}/{target}:analyzeWorkloadMove", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
