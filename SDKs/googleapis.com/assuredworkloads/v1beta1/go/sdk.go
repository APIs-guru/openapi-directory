...
func (s *SDK) AssuredworkloadsOrganizationsLocationsOperationsList(ctx context.Context, request operations.AssuredworkloadsOrganizationsLocationsOperationsListRequest) (*operations.AssuredworkloadsOrganizationsLocationsOperationsListResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) AssuredworkloadsOrganizationsLocationsWorkloadsCreate(ctx context.Context, request operations.AssuredworkloadsOrganizationsLocationsWorkloadsCreateRequest) (*operations.AssuredworkloadsOrganizationsLocationsWorkloadsCreateResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) AssuredworkloadsOrganizationsLocationsWorkloadsDelete(ctx context.Context, request operations.AssuredworkloadsOrganizationsLocationsWorkloadsDeleteRequest) (*operations.AssuredworkloadsOrganizationsLocationsWorkloadsDeleteResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) AssuredworkloadsOrganizationsLocationsWorkloadsList(ctx context.Context, request operations.AssuredworkloadsOrganizationsLocationsWorkloadsListRequest) (*operations.AssuredworkloadsOrganizationsLocationsWorkloadsListResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1beta1/{parent}/workloads", request.PathParams)
...
func (s *SDK) AssuredworkloadsOrganizationsLocationsWorkloadsOrganizationsLocationsWorkloadsAnalyzeWorkloadMove(ctx context.Context, request operations.AssuredworkloadsOrganizationsLocationsWorkloadsOrganizationsLocationsWorkloadsAnalyzeWorkloadMoveRequest) (*operations.AssuredworkloadsOrganizationsLocationsWorkloadsOrganizationsLocationsWorkloadsAnalyzeWorkloadMoveResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) AssuredworkloadsOrganizationsLocationsWorkloadsPatch(ctx context.Context, request operations.AssuredworkloadsOrganizationsLocationsWorkloadsPatchRequest) (*operations.AssuredworkloadsOrganizationsLocationsWorkloadsPatchResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1beta1/{name}", request.PathParams)
...
func (s *SDK) AssuredworkloadsOrganizationsLocationsWorkloadsRestrictAllowedResources(ctx context.Context, request operations.AssuredworkloadsOrganizationsLocationsWorkloadsRestrictAllowedResourcesRequest) (*operations.AssuredworkloadsOrganizationsLocationsWorkloadsRestrictAllowedResourcesResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) AssuredworkloadsOrganizationsLocationsWorkloadsViolationsAcknowledge(ctx context.Context, request operations.AssuredworkloadsOrganizationsLocationsWorkloadsViolationsAcknowledgeRequest) (*operations.AssuredworkloadsOrganizationsLocationsWorkloadsViolationsAcknowledgeResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) AssuredworkloadsOrganizationsLocationsWorkloadsViolationsGet(ctx context.Context, request operations.AssuredworkloadsOrganizationsLocationsWorkloadsViolationsGetRequest) (*operations.AssuredworkloadsOrganizationsLocationsWorkloadsViolationsGetResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1beta1/{name}", request.PathParams)
...
func (s *SDK) AssuredworkloadsOrganizationsLocationsWorkloadsViolationsList(ctx context.Context, request operations.AssuredworkloadsOrganizationsLocationsWorkloadsViolationsListRequest) (*operations.AssuredworkloadsOrganizationsLocationsWorkloadsViolationsListResponse, error) {
	baseURL := s.serverURL
