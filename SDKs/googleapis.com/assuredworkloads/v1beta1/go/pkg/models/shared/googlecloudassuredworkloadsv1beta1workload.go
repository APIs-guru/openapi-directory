...
const (
	...
	GoogleCloudAssuredworkloadsV1beta1WorkloadComplianceRegimeEnumAuRegionsAndUsSupport       GoogleCloudAssuredworkloadsV1beta1WorkloadComplianceRegimeEnum = "AU_REGIONS_AND_US_SUPPORT"
	...
	GoogleCloudAssuredworkloadsV1beta1WorkloadComplianceRegimeEnumIsrRegions                  GoogleCloudAssuredworkloadsV1beta1WorkloadComplianceRegimeEnum = "ISR_REGIONS"
)
...
const (
	...
	GoogleCloudAssuredworkloadsV1beta1WorkloadPartnerEnumSovereignControlsByTSystems GoogleCloudAssuredworkloadsV1beta1WorkloadPartnerEnum = "SOVEREIGN_CONTROLS_BY_T_SYSTEMS"
)
...
// A Workload object for managing highly regulated workloads of cloud customers.
type GoogleCloudAssuredworkloadsV1beta1WorkloadInput struct {
	BillingAccount             *string                                                            `json:"billingAccount,omitempty"`
	CjisSettings               *GoogleCloudAssuredworkloadsV1beta1WorkloadCjisSettings            `json:"cjisSettings,omitempty"`
	ComplianceRegime           *GoogleCloudAssuredworkloadsV1beta1WorkloadComplianceRegimeEnum    `json:"complianceRegime,omitempty"`
	ComplianceStatus           *GoogleCloudAssuredworkloadsV1beta1WorkloadComplianceStatus        `json:"complianceStatus,omitempty"`
