...
type AssuredworkloadsOrganizationsLocationsWorkloadsViolationsAcknowledgeRequest struct {
    ...
    Request *shared.GoogleCloudAssuredworkloadsV1beta1AcknowledgeViolationRequest `request:"mediaType=application/json"`
...
type AssuredworkloadsOrganizationsLocationsWorkloadsViolationsAcknowledgeResponse struct {
    ContentType string 
    GoogleCloudAssuredworkloadsV1beta1AcknowledgeViolationResponse map[string]interface{} 
    StatusCode int64 
