...
@dataclass
class AssuredworkloadsOrganizationsLocationsWorkloadsViolationsGetQueryParams:
...
class AssuredworkloadsOrganizationsLocationsWorkloadsViolationsGetResponse:
    ...
    google_cloud_assuredworkloads_v1beta1_violation: Optional[shared.GoogleCloudAssuredworkloadsV1beta1Violation] = field(default=None)
