...
class GoogleCloudAssuredworkloadsV1beta1Violation:
    r"""GoogleCloudAssuredworkloadsV1beta1Violation
    ...
    remediation: Optional[GoogleCloudAssuredworkloadsV1beta1ViolationRemediation] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('remediation') }})
    resolve_time: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('resolveTime') }})
    state: Optional[GoogleCloudAssuredworkloadsV1beta1ViolationStateEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('state') }})
