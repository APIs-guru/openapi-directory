...
class GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettings:
    r"""GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettings
    ...
    resource_type: Optional[GoogleCloudAssuredworkloadsV1beta1WorkloadResourceSettingsResourceTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('resourceType') }})
