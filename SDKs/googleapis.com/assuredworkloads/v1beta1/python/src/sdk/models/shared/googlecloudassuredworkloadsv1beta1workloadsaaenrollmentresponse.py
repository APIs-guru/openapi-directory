...
class GoogleCloudAssuredworkloadsV1beta1WorkloadSaaEnrollmentResponse:
    setup_errors: Optional[List[GoogleCloudAssuredworkloadsV1beta1WorkloadSaaEnrollmentResponseSetupErrorsEnum]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'setupErrors' }})
    setup_status: Optional[GoogleCloudAssuredworkloadsV1beta1WorkloadSaaEnrollmentResponseSetupStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'setupStatus' }})
