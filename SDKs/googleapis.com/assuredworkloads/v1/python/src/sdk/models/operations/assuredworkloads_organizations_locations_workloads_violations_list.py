...
class AssuredworkloadsOrganizationsLocationsWorkloadsViolationsListRequest:
    path_params: AssuredworkloadsOrganizationsLocationsWorkloadsViolationsListPathParams = field()
    query_params: AssuredworkloadsOrganizationsLocationsWorkloadsViolationsListQueryParams = field()
    security: AssuredworkloadsOrganizationsLocationsWorkloadsViolationsListSecurity = field()
...
class AssuredworkloadsOrganizationsLocationsWorkloadsViolationsListResponse:
    ...
    google_cloud_assuredworkloads_v1_list_violations_response: Optional[shared.GoogleCloudAssuredworkloadsV1ListViolationsResponse] = field(default=None)
