...
from . import googlecloudassuredworkloadsv1violationremediationinstructions
...
class GoogleCloudAssuredworkloadsV1ViolationRemediation:
    ...
    instructions: Optional[googlecloudassuredworkloadsv1violationremediationinstructions.GoogleCloudAssuredworkloadsV1ViolationRemediationInstructions] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'instructions' }})
    remediation_type: Optional[GoogleCloudAssuredworkloadsV1ViolationRemediationRemediationTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'remediationType' }})
