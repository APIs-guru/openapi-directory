...
class ApikeysProjectsLocationsKeysListSecurity:
    option1: Optional[ApikeysProjectsLocationsKeysListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[ApikeysProjectsLocationsKeysListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
