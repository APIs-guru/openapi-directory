...
**/
var SourcePosition = /** @class */ (function (_super) {
    __extends(SourcePosition, _super);
    ...
    ], SourcePosition.prototype, "column", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=currentOffset" }),
        __metadata("design:type", Number)
    ], SourcePosition.prototype, "currentOffset", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=endOffset" }),
        __metadata("design:type", Number)
    ], SourcePosition.prototype, "endOffset", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=fileName" }),
        __metadata("design:type", String)
    ], SourcePosition.prototype, "fileName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=line" }),
        __metadata("design:type", Number)
    ], SourcePosition.prototype, "line", void 0);
