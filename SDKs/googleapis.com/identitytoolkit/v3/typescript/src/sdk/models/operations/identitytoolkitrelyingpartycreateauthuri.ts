...
export class IdentitytoolkitRelyingpartyCreateAuthUriQueryParams extends SpeakeasyBase {
...
export class IdentitytoolkitRelyingpartyCreateAuthUriSecurity extends SpeakeasyBase {
...
export class IdentitytoolkitRelyingpartyCreateAuthUriResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
