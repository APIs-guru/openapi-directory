...
export class IdentitytoolkitRelyingpartyVerifyAssertionQueryParams extends SpeakeasyBase {
...
export class IdentitytoolkitRelyingpartyVerifyAssertionSecurity extends SpeakeasyBase {
...
export class IdentitytoolkitRelyingpartyVerifyAssertionResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
