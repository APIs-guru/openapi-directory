...
export class IdentitytoolkitRelyingpartyGetProjectConfigQueryParams extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=delegatedProjectNumber" })
  ...
  @SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=projectNumber" })
