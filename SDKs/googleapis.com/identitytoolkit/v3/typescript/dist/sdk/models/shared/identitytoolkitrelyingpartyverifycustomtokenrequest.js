...
var IdentitytoolkitRelyingpartyVerifyCustomTokenRequest = /** @class */ (function (_super) {
    ...
    ], IdentitytoolkitRelyingpartyVerifyCustomTokenRequest.prototype, "delegatedProjectNumber", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=instanceId" }),
        __metadata("design:type", String)
    ], IdentitytoolkitRelyingpartyVerifyCustomTokenRequest.prototype, "instanceId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=returnSecureToken" }),
        __metadata("design:type", Boolean)
    ], IdentitytoolkitRelyingpartyVerifyCustomTokenRequest.prototype, "returnSecureToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=token" }),
        __metadata("design:type", String)
    ], IdentitytoolkitRelyingpartyVerifyCustomTokenRequest.prototype, "token", void 0);
