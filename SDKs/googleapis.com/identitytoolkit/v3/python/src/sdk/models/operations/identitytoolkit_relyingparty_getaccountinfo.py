...
class IdentitytoolkitRelyingpartyGetAccountInfoRequest:
    query_params: IdentitytoolkitRelyingpartyGetAccountInfoQueryParams = field(default=None)
    ...
    security: IdentitytoolkitRelyingpartyGetAccountInfoSecurity = field(default=None)
