...
class IdentitytoolkitRelyingpartyVerifyPhoneNumberResponse:
    ...
    temporary_proof_expires_in: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('temporaryProofExpiresIn') }})
    ...
    verification_proof_expires_in: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('verificationProofExpiresIn') }})
