...
class IdentitytoolkitRelyingpartyGetOobConfirmationCodeRequest:
    query_params: IdentitytoolkitRelyingpartyGetOobConfirmationCodeQueryParams = field()
    security: IdentitytoolkitRelyingpartyGetOobConfirmationCodeSecurity = field()
