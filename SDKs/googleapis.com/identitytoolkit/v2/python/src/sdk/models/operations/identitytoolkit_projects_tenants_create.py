...
class IdentitytoolkitProjectsTenantsCreateSecurity:
    option1: Optional[IdentitytoolkitProjectsTenantsCreateSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[IdentitytoolkitProjectsTenantsCreateSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
