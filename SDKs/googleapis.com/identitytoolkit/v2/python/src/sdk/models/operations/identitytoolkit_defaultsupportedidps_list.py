...
class IdentitytoolkitDefaultSupportedIdpsListSecurity:
    option1: Optional[IdentitytoolkitDefaultSupportedIdpsListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[IdentitytoolkitDefaultSupportedIdpsListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
