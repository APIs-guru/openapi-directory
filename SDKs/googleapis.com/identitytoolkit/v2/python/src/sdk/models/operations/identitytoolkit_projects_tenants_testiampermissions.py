...
class IdentitytoolkitProjectsTenantsTestIamPermissionsSecurity:
    option1: Optional[IdentitytoolkitProjectsTenantsTestIamPermissionsSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[IdentitytoolkitProjectsTenantsTestIamPermissionsSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class IdentitytoolkitProjectsTenantsTestIamPermissionsRequest:
    path_params: IdentitytoolkitProjectsTenantsTestIamPermissionsPathParams = field(default=None)
    query_params: IdentitytoolkitProjectsTenantsTestIamPermissionsQueryParams = field(default=None)
    ...
    security: IdentitytoolkitProjectsTenantsTestIamPermissionsSecurity = field(default=None)
