...
class IdentitytoolkitProjectsTenantsTestIamPermissionsRequest:
    path_params: IdentitytoolkitProjectsTenantsTestIamPermissionsPathParams = field()
    query_params: IdentitytoolkitProjectsTenantsTestIamPermissionsQueryParams = field()
    security: IdentitytoolkitProjectsTenantsTestIamPermissionsSecurity = field()
