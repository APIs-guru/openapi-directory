...
@dataclass
class IdentitytoolkitProjectsTenantsGetIamPolicyQueryParams:
...
class IdentitytoolkitProjectsTenantsGetIamPolicySecurity:
    option1: Optional[IdentitytoolkitProjectsTenantsGetIamPolicySecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[IdentitytoolkitProjectsTenantsGetIamPolicySecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
