...
class IdentitytoolkitProjectsTenantsOauthIdpConfigsGetRequest:
    path_params: IdentitytoolkitProjectsTenantsOauthIdpConfigsGetPathParams = field()
    query_params: IdentitytoolkitProjectsTenantsOauthIdpConfigsGetQueryParams = field()
    security: IdentitytoolkitProjectsTenantsOauthIdpConfigsGetSecurity = field()
