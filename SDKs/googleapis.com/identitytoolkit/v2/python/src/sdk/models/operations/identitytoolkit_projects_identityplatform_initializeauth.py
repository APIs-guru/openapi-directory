...
class IdentitytoolkitProjectsIdentityPlatformInitializeAuthRequest:
    path_params: IdentitytoolkitProjectsIdentityPlatformInitializeAuthPathParams = field(default=None)
    query_params: IdentitytoolkitProjectsIdentityPlatformInitializeAuthQueryParams = field(default=None)
    request: Optional[dict[str, Any]] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: IdentitytoolkitProjectsIdentityPlatformInitializeAuthSecurity = field(default=None)
