...
var SDK = /** @class */ (function () {
    function SDK() {
        ...
        this.defaultSupportedIdps = new DefaultSupportedIdps(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
