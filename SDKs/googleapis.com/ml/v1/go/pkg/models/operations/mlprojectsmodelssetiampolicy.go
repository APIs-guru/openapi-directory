...
type MlProjectsModelsSetIamPolicyPathParams struct {
	Resource string `pathParam:"style=simple,explode=false,name=resource"`
}

type MlProjectsModelsSetIamPolicyQueryParams struct {
...
type MlProjectsModelsSetIamPolicySecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type MlProjectsModelsSetIamPolicyRequest struct {
...
type MlProjectsModelsSetIamPolicyResponse struct {
	ContentType       string
