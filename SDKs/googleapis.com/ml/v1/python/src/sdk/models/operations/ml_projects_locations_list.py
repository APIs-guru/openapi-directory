...
@dataclass
class MlProjectsLocationsListQueryParams:
...
class MlProjectsLocationsListSecurity:
    option1: Optional[MlProjectsLocationsListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[MlProjectsLocationsListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
