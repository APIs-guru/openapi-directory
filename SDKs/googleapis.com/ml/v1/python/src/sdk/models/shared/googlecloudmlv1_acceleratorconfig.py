...
class GoogleCloudMlV1AcceleratorConfig:
    r"""GoogleCloudMlV1AcceleratorConfig
    ...
    type: Optional[GoogleCloudMlV1AcceleratorConfigTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
