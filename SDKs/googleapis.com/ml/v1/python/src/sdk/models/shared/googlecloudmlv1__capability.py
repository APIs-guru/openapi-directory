...
class GoogleCloudMlV1Capability:
    available_accelerators: Optional[List[GoogleCloudMlV1CapabilityAvailableAcceleratorsEnum]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'availableAccelerators' }})
    type: Optional[GoogleCloudMlV1CapabilityTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'type' }})
