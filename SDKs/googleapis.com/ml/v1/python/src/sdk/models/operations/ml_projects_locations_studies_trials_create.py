...
class MlProjectsLocationsStudiesTrialsCreateRequest:
    path_params: MlProjectsLocationsStudiesTrialsCreatePathParams = field()
    query_params: MlProjectsLocationsStudiesTrialsCreateQueryParams = field()
    security: MlProjectsLocationsStudiesTrialsCreateSecurity = field()
    request: Optional[shared.GoogleCloudMlV1TrialInput] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
