...
class MlProjectsModelsTestIamPermissionsRequest:
    path_params: MlProjectsModelsTestIamPermissionsPathParams = field()
    query_params: MlProjectsModelsTestIamPermissionsQueryParams = field()
    security: MlProjectsModelsTestIamPermissionsSecurity = field()
