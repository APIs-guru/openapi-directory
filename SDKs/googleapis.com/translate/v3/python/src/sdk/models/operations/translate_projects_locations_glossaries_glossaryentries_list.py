...
class TranslateProjectsLocationsGlossariesGlossaryEntriesListSecurity:
    option1: Optional[TranslateProjectsLocationsGlossariesGlossaryEntriesListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[TranslateProjectsLocationsGlossariesGlossaryEntriesListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
