...
class TranslateProjectsLocationsGlossariesGlossaryEntriesPatchRequest:
    path_params: TranslateProjectsLocationsGlossariesGlossaryEntriesPatchPathParams = field()
    query_params: TranslateProjectsLocationsGlossariesGlossaryEntriesPatchQueryParams = field()
    security: TranslateProjectsLocationsGlossariesGlossaryEntriesPatchSecurity = field()
