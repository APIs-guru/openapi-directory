...
class TranslateProjectsLocationsListSecurity:
    option1: Optional[TranslateProjectsLocationsListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[TranslateProjectsLocationsListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
