...
@dataclass
class TranslateProjectsLocationsGetSupportedLanguagesQueryParams:
    dollar_xgafv: Optional[shared.XgafvEnum] = field(default=None, metadata={'query_param': { 'field_name': '$.xgafv', 'style': 'form', 'explode': True }})
    access_token: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'access_token', 'style': 'form', 'explode': True }})
    alt: Optional[shared.AltEnum] = field(default=None, metadata={'query_param': { 'field_name': 'alt', 'style': 'form', 'explode': True }})
    callback: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'callback', 'style': 'form', 'explode': True }})
    display_language_code: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'displayLanguageCode', 'style': 'form', 'explode': True }})
...
class TranslateProjectsLocationsGetSupportedLanguagesSecurity:
    option1: Optional[TranslateProjectsLocationsGetSupportedLanguagesSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[TranslateProjectsLocationsGetSupportedLanguagesSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
