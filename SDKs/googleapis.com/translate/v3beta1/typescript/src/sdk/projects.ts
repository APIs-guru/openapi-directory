...
export class Projects {
  ...
  **/
  translateProjectsLocationsBatchTranslateDocument(
    ...
    const url: string = utils.GenerateURL(baseURL, "/v3beta1/{parent}:batchTranslateDocument", req.pathParams);
  ...
  **/
  translateProjectsLocationsBatchTranslateText(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v3beta1/{parent}:batchTranslateText", req.pathParams);
  ...
  **/
  translateProjectsLocationsDetectLanguage(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v3beta1/{parent}:detectLanguage", req.pathParams);
  ...
  **/
  translateProjectsLocationsGetSupportedLanguages(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v3beta1/{parent}/supportedLanguages", req.pathParams);
  ...
  **/
  translateProjectsLocationsGlossariesCreate(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v3beta1/{parent}/glossaries", req.pathParams);
  ...
  **/
  translateProjectsLocationsOperationsWait(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v3beta1/{name}:wait", req.pathParams);
  ...
  **/
  translateProjectsLocationsTranslateDocument(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v3beta1/{parent}:translateDocument", req.pathParams);
  ...
  **/
  translateProjectsLocationsTranslateText(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v3beta1/{parent}:translateText", req.pathParams);
