...
class LanguageDetectionsDetectSecurity:
    option1: Optional[LanguageDetectionsDetectSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[LanguageDetectionsDetectSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
