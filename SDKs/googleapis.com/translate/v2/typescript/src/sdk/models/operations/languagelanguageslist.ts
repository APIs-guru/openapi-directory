...
export class LanguageLanguagesListQueryParams extends SpeakeasyBase {
...
export class LanguageLanguagesListSecurityOption1 extends SpeakeasyBase {
...
export class LanguageLanguagesListSecurityOption2 extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "security, scheme=true;type=oauth2" })
  oauth2: shared.SchemeOauth2;
...
export class LanguageLanguagesListSecurity extends SpeakeasyBase {
...
export class LanguageLanguagesListRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class LanguageLanguagesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
