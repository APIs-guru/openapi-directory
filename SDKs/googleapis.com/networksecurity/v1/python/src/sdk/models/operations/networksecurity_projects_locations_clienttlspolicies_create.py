...
class NetworksecurityProjectsLocationsClientTLSPoliciesCreateRequest:
    path_params: NetworksecurityProjectsLocationsClientTLSPoliciesCreatePathParams = field(default=None)
    query_params: NetworksecurityProjectsLocationsClientTLSPoliciesCreateQueryParams = field(default=None)
    request: Optional[shared.ClientTLSPolicy] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: NetworksecurityProjectsLocationsClientTLSPoliciesCreateSecurity = field(default=None)
