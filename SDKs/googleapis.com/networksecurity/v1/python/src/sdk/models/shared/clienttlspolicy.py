...
class ClientTLSPolicy:
    client_certificate: Optional[googlecloudnetworksecurityv1certificateprovider.GoogleCloudNetworksecurityV1CertificateProvider] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'clientCertificate' }})
