...
class NetworksecurityProjectsLocationsServerTLSPoliciesSetIamPolicyRequest:
    path_params: NetworksecurityProjectsLocationsServerTLSPoliciesSetIamPolicyPathParams = field()
    query_params: NetworksecurityProjectsLocationsServerTLSPoliciesSetIamPolicyQueryParams = field()
    security: NetworksecurityProjectsLocationsServerTLSPoliciesSetIamPolicySecurity = field()
