...
export class SDK {
  ...
  NetworksecurityProjectsLocationsAuthorizationPoliciesCreate(
    ...
    const url: string = utils.GenerateURL(baseURL, "/v1/{parent}/authorizationPolicies", req.pathParams);
  ...
  NetworksecurityProjectsLocationsClientTlsPoliciesCreate(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{parent}/clientTlsPolicies", req.pathParams);
  ...
  NetworksecurityProjectsLocationsServerTlsPoliciesCreate(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{parent}/serverTlsPolicies", req.pathParams);
