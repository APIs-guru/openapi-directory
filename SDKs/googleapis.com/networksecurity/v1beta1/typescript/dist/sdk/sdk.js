...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.NetworksecurityProjectsLocationsAuthorizationPoliciesCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.NetworksecurityProjectsLocationsAuthorizationPoliciesCreateRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta1/{parent}/authorizationPolicies", req.pathParams);
    ...
    SDK.prototype.NetworksecurityProjectsLocationsAuthorizationPoliciesList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.NetworksecurityProjectsLocationsClientTlsPoliciesCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.NetworksecurityProjectsLocationsClientTlsPoliciesCreateRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta1/{parent}/clientTlsPolicies", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.NetworksecurityProjectsLocationsClientTlsPoliciesList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.NetworksecurityProjectsLocationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.NetworksecurityProjectsLocationsOperationsCancel = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.NetworksecurityProjectsLocationsOperationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.NetworksecurityProjectsLocationsServerTlsPoliciesCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.NetworksecurityProjectsLocationsServerTlsPoliciesCreateRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta1/{parent}/serverTlsPolicies", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.NetworksecurityProjectsLocationsServerTlsPoliciesDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.NetworksecurityProjectsLocationsServerTlsPoliciesGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.NetworksecurityProjectsLocationsServerTlsPoliciesGetIamPolicy = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.NetworksecurityProjectsLocationsServerTlsPoliciesList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.NetworksecurityProjectsLocationsServerTlsPoliciesPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.NetworksecurityProjectsLocationsServerTlsPoliciesSetIamPolicy = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.NetworksecurityProjectsLocationsServerTlsPoliciesTestIamPermissions = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
