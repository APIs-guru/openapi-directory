...
class ServerTLSPolicyInput:
    ...
    server_certificate: Optional[GoogleCloudNetworksecurityV1beta1CertificateProvider] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('serverCertificate') }})
