...
class NetworksecurityProjectsLocationsServerTLSPoliciesSetIamPolicyRequest:
    path_params: NetworksecurityProjectsLocationsServerTLSPoliciesSetIamPolicyPathParams = field(default=None)
    query_params: NetworksecurityProjectsLocationsServerTLSPoliciesSetIamPolicyQueryParams = field(default=None)
    request: Optional[shared.GoogleIamV1SetIamPolicyRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: NetworksecurityProjectsLocationsServerTLSPoliciesSetIamPolicySecurity = field(default=None)
