...
export class SDK {
  ...
  WebsecurityscannerProjectsScanConfigsCreate(
    ...
    const url: string = utils.GenerateURL(baseURL, "/v1beta/{parent}/scanConfigs", req.pathParams);
  ...
  WebsecurityscannerProjectsScanConfigsScanRunsCrawledUrlsList(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta/{parent}/crawledUrls", req.pathParams);
  ...
  WebsecurityscannerProjectsScanConfigsScanRunsFindingTypeStatsList(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta/{parent}/findingTypeStats", req.pathParams);
  ...
  WebsecurityscannerProjectsScanConfigsScanRunsFindingsList(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta/{parent}/findings", req.pathParams);
  ...
  WebsecurityscannerProjectsScanConfigsScanRunsList(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta/{parent}/scanRuns", req.pathParams);
  ...
  WebsecurityscannerProjectsScanConfigsScanRunsStop(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta/{name}:stop", req.pathParams);
  ...
  WebsecurityscannerProjectsScanConfigsStart(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta/{name}:start", req.pathParams);
