...
var Projects = /** @class */ (function () {
    ...
    **/
    Projects.prototype.policyanalyzerProjectsLocationsActivityTypesActivitiesQuery = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PolicyanalyzerProjectsLocationsActivityTypesActivitiesQueryRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{parent}/activities:query", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.googleCloudPolicyanalyzerV1QueryActivityResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
