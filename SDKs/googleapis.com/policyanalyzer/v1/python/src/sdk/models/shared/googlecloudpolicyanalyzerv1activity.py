...
class GoogleCloudPolicyanalyzerV1Activity:
    ...
    observation_period: Optional[GoogleCloudPolicyanalyzerV1ObservationPeriod] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('observationPeriod') }})
