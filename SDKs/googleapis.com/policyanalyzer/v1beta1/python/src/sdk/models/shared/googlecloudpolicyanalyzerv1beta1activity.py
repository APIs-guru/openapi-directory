...
from . import googlecloudpolicyanalyzerv1beta1observationperiod
...
class GoogleCloudPolicyanalyzerV1beta1Activity:
    ...
    observation_period: Optional[googlecloudpolicyanalyzerv1beta1observationperiod.GoogleCloudPolicyanalyzerV1beta1ObservationPeriod] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'observationPeriod' }})
