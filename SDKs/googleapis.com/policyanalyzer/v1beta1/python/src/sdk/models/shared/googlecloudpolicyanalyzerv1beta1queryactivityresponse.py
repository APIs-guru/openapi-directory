...
class GoogleCloudPolicyanalyzerV1beta1QueryActivityResponse:
    ...
    activities: Optional[List[GoogleCloudPolicyanalyzerV1beta1Activity]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('activities') }})
