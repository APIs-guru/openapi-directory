...
func (s *SDK) PolicyanalyzerProjectsLocationsActivityTypesActivitiesQuery(ctx context.Context, request operations.PolicyanalyzerProjectsLocationsActivityTypesActivitiesQueryRequest) (*operations.PolicyanalyzerProjectsLocationsActivityTypesActivitiesQueryResponse, error) {
	baseURL := s.serverURL
