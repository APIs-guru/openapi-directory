...
func (s *SDK) StsIntrospect(ctx context.Context, request operations.StsIntrospectRequest) (*operations.StsIntrospectResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) StsToken(ctx context.Context, request operations.StsTokenRequest) (*operations.StsTokenResponse, error) {
	baseURL := s.serverURL
