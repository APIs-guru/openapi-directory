...
**/
var ListPeeredDnsDomainsResponse = /** @class */ (function (_super) {
    __extends(ListPeeredDnsDomainsResponse, _super);
    function ListPeeredDnsDomainsResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=peeredDnsDomains", elemType: PeeredDnsDomain }),
        __metadata("design:type", Array)
    ], ListPeeredDnsDomainsResponse.prototype, "peeredDnsDomains", void 0);
    return ListPeeredDnsDomainsResponse;
}(SpeakeasyBase));
export { ListPeeredDnsDomainsResponse };
