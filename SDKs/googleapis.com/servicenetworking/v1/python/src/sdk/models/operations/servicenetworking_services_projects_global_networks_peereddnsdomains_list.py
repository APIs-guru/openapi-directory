...
@dataclass
class ServicenetworkingServicesProjectsGlobalNetworksPeeredDNSDomainsListQueryParams:
...
class ServicenetworkingServicesProjectsGlobalNetworksPeeredDNSDomainsListSecurity:
    option1: Optional[ServicenetworkingServicesProjectsGlobalNetworksPeeredDNSDomainsListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[ServicenetworkingServicesProjectsGlobalNetworksPeeredDNSDomainsListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
