...
@dataclass
class ServicenetworkingServicesDNSRecordSetsRemoveQueryParams:
...
class ServicenetworkingServicesDNSRecordSetsRemoveSecurity:
    option1: Optional[ServicenetworkingServicesDNSRecordSetsRemoveSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[ServicenetworkingServicesDNSRecordSetsRemoveSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
