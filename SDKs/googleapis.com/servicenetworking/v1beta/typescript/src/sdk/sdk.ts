...
export class SDK {
  ...
  ServicenetworkingOperationsGet(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        let res: operations.ServicenetworkingOperationsGetResponse = {statusCode: httpRes.status, contentType: contentType};
  ...
  ServicenetworkingServicesAddSubnetwork(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta/{parent}:addSubnetwork", req.pathParams);
  ...
  ServicenetworkingServicesConnectionsCreate(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta/{parent}/connections", req.pathParams);
  ...
  ServicenetworkingServicesSearchRange(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta/{parent}:searchRange", req.pathParams);
  ...
  ServicenetworkingServicesUpdateConnections(
    req: operations.ServicenetworkingServicesUpdateConnectionsRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.ServicenetworkingServicesUpdateConnectionsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ServicenetworkingServicesUpdateConnectionsRequest(req);
    }
    
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1beta/{name}/connections", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ServicenetworkingServicesUpdateConnectionsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.operation = httpRes?.data;
