...
@dataclass
class ServicenetworkingServicesUpdateConnectionsQueryParams:
...
@dataclass
class ServicenetworkingServicesUpdateConnectionsSecurity:
    option1: Optional[ServicenetworkingServicesUpdateConnectionsSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[ServicenetworkingServicesUpdateConnectionsSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
