...
export { ApigeeregistryProjectsLocationsApisDeploymentsCreatePathParams };
var ApigeeregistryProjectsLocationsApisDeploymentsCreateQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=apiDeploymentId" }),
        __metadata("design:type", String)
...
export { ApigeeregistryProjectsLocationsApisDeploymentsCreateQueryParams };
...
export { ApigeeregistryProjectsLocationsApisDeploymentsCreateSecurity };
...
export { ApigeeregistryProjectsLocationsApisDeploymentsCreateRequest };
...
export { ApigeeregistryProjectsLocationsApisDeploymentsCreateResponse };
