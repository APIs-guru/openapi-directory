...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.GmailpostmastertoolsDomainsList = function (req, config) {
    ...
    SDK.prototype.GmailpostmastertoolsDomainsTrafficStatsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.GmailpostmastertoolsDomainsTrafficStatsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
