...
class GmailpostmastertoolsDomainsTrafficStatsListRequest:
    path_params: GmailpostmastertoolsDomainsTrafficStatsListPathParams = field()
    query_params: GmailpostmastertoolsDomainsTrafficStatsListQueryParams = field()
    security: GmailpostmastertoolsDomainsTrafficStatsListSecurity = field()
