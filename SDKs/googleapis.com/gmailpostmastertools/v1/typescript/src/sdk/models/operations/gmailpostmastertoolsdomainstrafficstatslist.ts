...
export class GmailpostmastertoolsDomainsTrafficStatsListPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=parent" })
  parent: string;
}


export class GmailpostmastertoolsDomainsTrafficStatsListQueryParams extends SpeakeasyBase {
