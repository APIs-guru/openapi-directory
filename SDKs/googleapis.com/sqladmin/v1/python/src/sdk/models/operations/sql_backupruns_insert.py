...
class SQLBackupRunsInsertSecurity:
    option1: Optional[SQLBackupRunsInsertSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[SQLBackupRunsInsertSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
