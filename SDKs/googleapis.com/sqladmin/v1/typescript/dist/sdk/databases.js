...
var Databases = /** @class */ (function () {
    ...
    **/
    Databases.prototype.sqlDatabasesDelete = function (req, config) {
        ...
        var url = utils.GenerateURL(baseURL, "/v1/projects/{project}/instances/{instance}/databases/{database}", req.pathParams);
    ...
    **/
    Databases.prototype.sqlDatabasesInsert = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/projects/{project}/instances/{instance}/databases", req.pathParams);
