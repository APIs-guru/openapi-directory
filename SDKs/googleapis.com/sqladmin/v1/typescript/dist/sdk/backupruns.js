...
var BackupRuns = /** @class */ (function () {
    function BackupRuns(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    BackupRuns.prototype.sqlBackupRunsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.SqlBackupRunsDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/projects/{project}/instances/{instance}/backupRuns/{id}", req.pathParams);
    ...
    **/
    BackupRuns.prototype.sqlBackupRunsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.backupRun = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    BackupRuns.prototype.sqlBackupRunsInsert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.SqlBackupRunsInsertRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/projects/{project}/instances/{instance}/backupRuns", req.pathParams);
    ...
    **/
    BackupRuns.prototype.sqlBackupRunsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.backupRunsListResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
