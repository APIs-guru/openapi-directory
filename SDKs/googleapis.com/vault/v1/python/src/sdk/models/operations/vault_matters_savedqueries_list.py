...
class VaultMattersSavedQueriesListSecurity:
    option1: Optional[VaultMattersSavedQueriesListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[VaultMattersSavedQueriesListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
