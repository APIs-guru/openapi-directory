...
class GoogleCloudPolicysimulatorV1ReplayResult:
    ...
    access_tuple: Optional[GoogleCloudPolicysimulatorV1AccessTuple] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('accessTuple') }})
    diff: Optional[GoogleCloudPolicysimulatorV1ReplayDiff] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('diff') }})
