...
class GoogleCloudPolicysimulatorV1BindingExplanation:
    ...
    access: Optional[GoogleCloudPolicysimulatorV1BindingExplanationAccessEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('access') }})
    condition: Optional[GoogleTypeExpr] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('condition') }})
    memberships: Optional[dict[str, GoogleCloudPolicysimulatorV1BindingExplanationAnnotatedMembership]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('memberships') }})
    relevance: Optional[GoogleCloudPolicysimulatorV1BindingExplanationRelevanceEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('relevance') }})
    role: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('role') }})
    role_permission: Optional[GoogleCloudPolicysimulatorV1BindingExplanationRolePermissionEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('rolePermission') }})
    role_permission_relevance: Optional[GoogleCloudPolicysimulatorV1BindingExplanationRolePermissionRelevanceEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('rolePermissionRelevance') }})
