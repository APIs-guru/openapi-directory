...
class ArtifactregistryProjectsLocationsRepositoriesPackagesVersionsGetQueryParams:
    ...
    view: Optional[ArtifactregistryProjectsLocationsRepositoriesPackagesVersionsGetViewEnum] = field(default=None, metadata={'query_param': { 'field_name': 'view', 'style': 'form', 'explode': True }})
...
class ArtifactregistryProjectsLocationsRepositoriesPackagesVersionsGetSecurity:
    option1: Optional[ArtifactregistryProjectsLocationsRepositoriesPackagesVersionsGetSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[ArtifactregistryProjectsLocationsRepositoriesPackagesVersionsGetSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
