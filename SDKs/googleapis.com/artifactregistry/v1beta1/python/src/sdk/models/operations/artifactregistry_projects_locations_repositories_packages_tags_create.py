...
class ArtifactregistryProjectsLocationsRepositoriesPackagesTagsCreateRequest:
    path_params: ArtifactregistryProjectsLocationsRepositoriesPackagesTagsCreatePathParams = field()
    query_params: ArtifactregistryProjectsLocationsRepositoriesPackagesTagsCreateQueryParams = field()
    security: ArtifactregistryProjectsLocationsRepositoriesPackagesTagsCreateSecurity = field()
