...
class ArtifactregistryProjectsLocationsRepositoriesPackagesVersionsListRequest:
    path_params: ArtifactregistryProjectsLocationsRepositoriesPackagesVersionsListPathParams = field(default=None)
    query_params: ArtifactregistryProjectsLocationsRepositoriesPackagesVersionsListQueryParams = field(default=None)
    security: ArtifactregistryProjectsLocationsRepositoriesPackagesVersionsListSecurity = field(default=None)
