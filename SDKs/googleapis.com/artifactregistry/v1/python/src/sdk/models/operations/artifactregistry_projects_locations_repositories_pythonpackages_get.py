...
class ArtifactregistryProjectsLocationsRepositoriesPythonPackagesGetQueryParams:
    ...
    view: Optional[ArtifactregistryProjectsLocationsRepositoriesPythonPackagesGetViewEnum] = field(default=None, metadata={'query_param': { 'field_name': 'view', 'style': 'form', 'explode': True }})
...
class ArtifactregistryProjectsLocationsRepositoriesPythonPackagesGetSecurity:
    option1: Optional[ArtifactregistryProjectsLocationsRepositoriesPythonPackagesGetSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[ArtifactregistryProjectsLocationsRepositoriesPythonPackagesGetSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
