...
**/
var AbsoluteDateRange = /** @class */ (function (_super) {
    __extends(AbsoluteDateRange, _super);
    function AbsoluteDateRange() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=endDate" }),
        __metadata("design:type", Date)
    ], AbsoluteDateRange.prototype, "endDate", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=startDate" }),
        __metadata("design:type", Date)
    ], AbsoluteDateRange.prototype, "startDate", void 0);
    return AbsoluteDateRange;
}(SpeakeasyBase));
export { AbsoluteDateRange };
