...
**/
var FilteredBidCreativeRow = /** @class */ (function (_super) {
    __extends(FilteredBidCreativeRow, _super);
    function FilteredBidCreativeRow() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=bidCount" }),
        __metadata("design:type", MetricValue)
    ], FilteredBidCreativeRow.prototype, "bidCount", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=creativeId" }),
        __metadata("design:type", String)
    ], FilteredBidCreativeRow.prototype, "creativeId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=rowDimensions" }),
        __metadata("design:type", RowDimensions)
    ], FilteredBidCreativeRow.prototype, "rowDimensions", void 0);
    return FilteredBidCreativeRow;
}(SpeakeasyBase));
export { FilteredBidCreativeRow };
