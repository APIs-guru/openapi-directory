...
class Adexchangebuyer2AccountsCreativesUpdateRequest:
    path_params: Adexchangebuyer2AccountsCreativesUpdatePathParams = field()
    query_params: Adexchangebuyer2AccountsCreativesUpdateQueryParams = field()
    security: Adexchangebuyer2AccountsCreativesUpdateSecurity = field()
