...
class Adexchangebuyer2AccountsCreativesUpdateRequest:
    path_params: Adexchangebuyer2AccountsCreativesUpdatePathParams = field(default=None)
    query_params: Adexchangebuyer2AccountsCreativesUpdateQueryParams = field(default=None)
    request: Optional[shared.Creative] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: Adexchangebuyer2AccountsCreativesUpdateSecurity = field(default=None)
