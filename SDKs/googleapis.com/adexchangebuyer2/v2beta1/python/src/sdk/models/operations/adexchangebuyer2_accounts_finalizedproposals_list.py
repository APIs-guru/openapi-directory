...
@dataclass
class Adexchangebuyer2AccountsFinalizedProposalsListQueryParams:
    ...
    filter_syntax: Optional[Adexchangebuyer2AccountsFinalizedProposalsListFilterSyntaxEnum] = field(default=None, metadata={'query_param': { 'field_name': 'filterSyntax', 'style': 'form', 'explode': True }})
