...
class Adexchangebuyer2AccountsCreativesCreateQueryParams:
    ...
    duplicate_id_mode: Optional[Adexchangebuyer2AccountsCreativesCreateDuplicateIDModeEnum] = field(default=None, metadata={'query_param': { 'field_name': 'duplicateIdMode', 'style': 'form', 'explode': True }})
