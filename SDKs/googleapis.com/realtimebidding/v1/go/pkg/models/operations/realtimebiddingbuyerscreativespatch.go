...
type RealtimebiddingBuyersCreativesPatchPathParams struct {
    Name string `pathParam:"style=simple,explode=false,name=name"`
    
}

type RealtimebiddingBuyersCreativesPatchQueryParams struct {
...
type RealtimebiddingBuyersCreativesPatchSecurity struct {
...
type RealtimebiddingBuyersCreativesPatchResponse struct {
    ContentType string 
