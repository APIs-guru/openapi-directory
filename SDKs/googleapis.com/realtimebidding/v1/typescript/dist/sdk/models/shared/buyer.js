...
var Buyer = /** @class */ (function (_super) {
    ...
    ], Buyer.prototype, "activeCreativeCount", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=bidder" }),
        __metadata("design:type", String)
    ], Buyer.prototype, "bidder", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=billingIds" }),
        __metadata("design:type", Array)
    ], Buyer.prototype, "billingIds", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=displayName" }),
        __metadata("design:type", String)
    ], Buyer.prototype, "displayName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=maximumActiveCreativeCount" }),
        __metadata("design:type", String)
    ], Buyer.prototype, "maximumActiveCreativeCount", void 0);
    __decorate([
