...
**/
var NumericTargetingDimension = /** @class */ (function (_super) {
    __extends(NumericTargetingDimension, _super);
    function NumericTargetingDimension() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=excludedIds" }),
        __metadata("design:type", Array)
    ], NumericTargetingDimension.prototype, "excludedIds", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=includedIds" }),
        __metadata("design:type", Array)
    ], NumericTargetingDimension.prototype, "includedIds", void 0);
    return NumericTargetingDimension;
}(SpeakeasyBase));
export { NumericTargetingDimension };
