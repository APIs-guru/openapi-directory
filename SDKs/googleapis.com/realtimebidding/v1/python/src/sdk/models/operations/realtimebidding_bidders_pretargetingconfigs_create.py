...
class RealtimebiddingBiddersPretargetingConfigsCreateRequest:
    path_params: RealtimebiddingBiddersPretargetingConfigsCreatePathParams = field()
    query_params: RealtimebiddingBiddersPretargetingConfigsCreateQueryParams = field()
    security: RealtimebiddingBiddersPretargetingConfigsCreateSecurity = field()
    request: Optional[shared.PretargetingConfigInput] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
