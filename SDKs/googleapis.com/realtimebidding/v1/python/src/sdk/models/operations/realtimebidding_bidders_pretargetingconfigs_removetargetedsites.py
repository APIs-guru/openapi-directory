...
class RealtimebiddingBiddersPretargetingConfigsRemoveTargetedSitesRequest:
    path_params: RealtimebiddingBiddersPretargetingConfigsRemoveTargetedSitesPathParams = field(default=None)
    query_params: RealtimebiddingBiddersPretargetingConfigsRemoveTargetedSitesQueryParams = field(default=None)
    request: Optional[shared.RemoveTargetedSitesRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: RealtimebiddingBiddersPretargetingConfigsRemoveTargetedSitesSecurity = field(default=None)
