...
class RealtimebiddingBiddersCreativesWatchRequest:
    path_params: RealtimebiddingBiddersCreativesWatchPathParams = field(default=None)
    query_params: RealtimebiddingBiddersCreativesWatchQueryParams = field(default=None)
    request: Optional[dict[str, Any]] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: RealtimebiddingBiddersCreativesWatchSecurity = field(default=None)
