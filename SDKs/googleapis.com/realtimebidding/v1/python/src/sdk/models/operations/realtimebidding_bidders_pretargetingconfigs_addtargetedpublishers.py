...
class RealtimebiddingBiddersPretargetingConfigsAddTargetedPublishersRequest:
    path_params: RealtimebiddingBiddersPretargetingConfigsAddTargetedPublishersPathParams = field()
    query_params: RealtimebiddingBiddersPretargetingConfigsAddTargetedPublishersQueryParams = field()
    security: RealtimebiddingBiddersPretargetingConfigsAddTargetedPublishersSecurity = field()
