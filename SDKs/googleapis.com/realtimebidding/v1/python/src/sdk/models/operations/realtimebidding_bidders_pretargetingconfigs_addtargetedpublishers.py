...
class RealtimebiddingBiddersPretargetingConfigsAddTargetedPublishersRequest:
    path_params: RealtimebiddingBiddersPretargetingConfigsAddTargetedPublishersPathParams = field(default=None)
    query_params: RealtimebiddingBiddersPretargetingConfigsAddTargetedPublishersQueryParams = field(default=None)
    request: Optional[shared.AddTargetedPublishersRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: RealtimebiddingBiddersPretargetingConfigsAddTargetedPublishersSecurity = field(default=None)
