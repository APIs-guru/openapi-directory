...
type AndroidpublisherEditsApklistingsDeletePathParams struct {
...
type AndroidpublisherEditsApklistingsDeleteQueryParams struct {
...
type AndroidpublisherEditsApklistingsDeleteSecurity struct {
    Oauth2 shared.SchemeOauth2 `security:"scheme,type=oauth2"`
    Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
    
}

type AndroidpublisherEditsApklistingsDeleteRequest struct {
...
type AndroidpublisherEditsApklistingsDeleteResponse struct {
    ContentType string 
    StatusCode int64 
