...
type AndroidpublisherEditsApklistingsListPathParams struct {
...
type AndroidpublisherEditsApklistingsListQueryParams struct {
...
type AndroidpublisherEditsApklistingsListSecurity struct {
    Oauth2 shared.SchemeOauth2 `security:"scheme,type=oauth2"`
    Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
    
}

type AndroidpublisherEditsApklistingsListRequest struct {
...
type AndroidpublisherEditsApklistingsListResponse struct {
    Body []byte 
    ContentType string 
    StatusCode int64 
