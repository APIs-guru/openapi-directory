...
export class AndroidpublisherEditsApklistingsPatchPathParams extends SpeakeasyBase {
...
export class AndroidpublisherEditsApklistingsPatchQueryParams extends SpeakeasyBase {
...
export class AndroidpublisherEditsApklistingsPatchSecurity extends SpeakeasyBase {
...
export class AndroidpublisherEditsApklistingsPatchRequest extends SpeakeasyBase {
  @Metadata()
...
export class AndroidpublisherEditsApklistingsPatchResponse extends SpeakeasyBase {
  @Metadata()
  body?: Uint8Array;
