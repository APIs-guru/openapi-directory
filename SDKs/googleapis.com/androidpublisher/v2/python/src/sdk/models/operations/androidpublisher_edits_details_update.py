...
class AndroidpublisherEditsDetailsUpdateRequest:
    path_params: AndroidpublisherEditsDetailsUpdatePathParams = field()
    query_params: AndroidpublisherEditsDetailsUpdateQueryParams = field()
    security: AndroidpublisherEditsDetailsUpdateSecurity = field()
