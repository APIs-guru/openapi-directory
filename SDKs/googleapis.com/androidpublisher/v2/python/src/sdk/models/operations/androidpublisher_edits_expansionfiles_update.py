...
class AndroidpublisherEditsExpansionfilesUpdatePathParams:
    ...
    expansion_file_type: AndroidpublisherEditsExpansionfilesUpdateExpansionFileTypeEnum = field(default=None, metadata={'path_param': { 'field_name': 'expansionFileType', 'style': 'simple', 'explode': False }})
...
class AndroidpublisherEditsExpansionfilesUpdateRequest:
    path_params: AndroidpublisherEditsExpansionfilesUpdatePathParams = field(default=None)
    query_params: AndroidpublisherEditsExpansionfilesUpdateQueryParams = field(default=None)
    request: Optional[shared.ExpansionFile] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: AndroidpublisherEditsExpansionfilesUpdateSecurity = field(default=None)
