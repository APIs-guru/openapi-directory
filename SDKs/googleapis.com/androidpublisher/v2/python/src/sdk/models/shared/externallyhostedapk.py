...
class ExternallyHostedApk:
    ...
    uses_permissions: Optional[List[ExternallyHostedApkUsesPermission]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('usesPermissions') }})
