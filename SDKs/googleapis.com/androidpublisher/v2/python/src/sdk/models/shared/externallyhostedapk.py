...
from . import externallyhostedapkusespermission
...
class ExternallyHostedApk:
    ...
    uses_permissions: Optional[List[externallyhostedapkusespermission.ExternallyHostedApkUsesPermission]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'usesPermissions' }})
