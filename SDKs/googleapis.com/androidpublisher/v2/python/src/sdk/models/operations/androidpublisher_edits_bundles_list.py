...
class AndroidpublisherEditsBundlesListRequest:
    path_params: AndroidpublisherEditsBundlesListPathParams = field()
    query_params: AndroidpublisherEditsBundlesListQueryParams = field()
    security: AndroidpublisherEditsBundlesListSecurity = field()
