...
class AndroidpublisherEditsListingsListRequest:
    path_params: AndroidpublisherEditsListingsListPathParams = field()
    query_params: AndroidpublisherEditsListingsListQueryParams = field()
    security: AndroidpublisherEditsListingsListSecurity = field()
