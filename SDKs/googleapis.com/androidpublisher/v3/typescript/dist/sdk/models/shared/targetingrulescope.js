...
**/
var TargetingRuleScope = /** @class */ (function (_super) {
    __extends(TargetingRuleScope, _super);
    function TargetingRuleScope() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=specificSubscriptionInApp" }),
        __metadata("design:type", String)
    ], TargetingRuleScope.prototype, "specificSubscriptionInApp", void 0);
    return TargetingRuleScope;
}(SpeakeasyBase));
export { TargetingRuleScope };
