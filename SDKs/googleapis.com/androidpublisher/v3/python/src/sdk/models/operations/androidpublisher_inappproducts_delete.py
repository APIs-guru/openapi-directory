...
class AndroidpublisherInappproductsDeleteRequest:
    path_params: AndroidpublisherInappproductsDeletePathParams = field()
    query_params: AndroidpublisherInappproductsDeleteQueryParams = field()
    security: AndroidpublisherInappproductsDeleteSecurity = field()
