...
class AndroidpublisherEditsBundlesUploadQueryParams:
    ...
    ack_bundle_installation_warning: Optional[bool] = field(default=None, metadata={'query_param': { 'field_name': 'ackBundleInstallationWarning', 'style': 'form', 'explode': True }})
    alt: Optional[shared.AltEnum] = field(default=None, metadata={'query_param': { 'field_name': 'alt', 'style': 'form', 'explode': True }})
    callback: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'callback', 'style': 'form', 'explode': True }})
    device_tier_config_id: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'deviceTierConfigId', 'style': 'form', 'explode': True }})
