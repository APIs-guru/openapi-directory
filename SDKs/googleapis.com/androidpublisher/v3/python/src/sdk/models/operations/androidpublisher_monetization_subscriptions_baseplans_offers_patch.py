...
class AndroidpublisherMonetizationSubscriptionsBasePlansOffersPatchRequest:
    path_params: AndroidpublisherMonetizationSubscriptionsBasePlansOffersPatchPathParams = field(default=None)
    query_params: AndroidpublisherMonetizationSubscriptionsBasePlansOffersPatchQueryParams = field(default=None)
    request: Optional[shared.SubscriptionOffer] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: AndroidpublisherMonetizationSubscriptionsBasePlansOffersPatchSecurity = field(default=None)
