...
class AndroidpublisherPurchasesProductsGetRequest:
    path_params: AndroidpublisherPurchasesProductsGetPathParams = field()
    query_params: AndroidpublisherPurchasesProductsGetQueryParams = field()
    security: AndroidpublisherPurchasesProductsGetSecurity = field()
