...
class AndroidpublisherPurchasesProductsGetRequest:
    path_params: AndroidpublisherPurchasesProductsGetPathParams = field(default=None)
    query_params: AndroidpublisherPurchasesProductsGetQueryParams = field(default=None)
    security: AndroidpublisherPurchasesProductsGetSecurity = field(default=None)
    

@dataclass
class AndroidpublisherPurchasesProductsGetResponse:
    content_type: str = field(default=None)
    product_purchase: Optional[shared.ProductPurchase] = field(default=None)
