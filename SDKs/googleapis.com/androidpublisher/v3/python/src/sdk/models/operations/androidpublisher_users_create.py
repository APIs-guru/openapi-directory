...
class AndroidpublisherUsersCreateRequest:
    path_params: AndroidpublisherUsersCreatePathParams = field(default=None)
    query_params: AndroidpublisherUsersCreateQueryParams = field(default=None)
    request: Optional[shared.User] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: AndroidpublisherUsersCreateSecurity = field(default=None)
