...
class AndroidpublisherUsersCreateRequest:
    path_params: AndroidpublisherUsersCreatePathParams = field()
    query_params: AndroidpublisherUsersCreateQueryParams = field()
    security: AndroidpublisherUsersCreateSecurity = field()
