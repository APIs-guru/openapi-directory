...
class AndroidpublisherEditsListingsPatchRequest:
    path_params: AndroidpublisherEditsListingsPatchPathParams = field()
    query_params: AndroidpublisherEditsListingsPatchQueryParams = field()
    security: AndroidpublisherEditsListingsPatchSecurity = field()
