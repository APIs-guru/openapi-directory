...
class AndroidpublisherEditsListingsPatchRequest:
    path_params: AndroidpublisherEditsListingsPatchPathParams = field(default=None)
    query_params: AndroidpublisherEditsListingsPatchQueryParams = field(default=None)
    request: Optional[shared.Listing] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: AndroidpublisherEditsListingsPatchSecurity = field(default=None)
