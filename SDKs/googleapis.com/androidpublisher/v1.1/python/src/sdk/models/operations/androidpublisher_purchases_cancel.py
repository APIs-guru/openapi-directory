...
class AndroidpublisherPurchasesCancelRequest:
    path_params: AndroidpublisherPurchasesCancelPathParams = field(default=None)
    query_params: AndroidpublisherPurchasesCancelQueryParams = field(default=None)
    security: AndroidpublisherPurchasesCancelSecurity = field(default=None)
