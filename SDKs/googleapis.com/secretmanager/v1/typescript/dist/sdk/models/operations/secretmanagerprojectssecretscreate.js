...
export { SecretmanagerProjectsSecretsCreatePathParams };
var SecretmanagerProjectsSecretsCreateQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=secretId" }),
        __metadata("design:type", String)
...
export { SecretmanagerProjectsSecretsCreateQueryParams };
...
export { SecretmanagerProjectsSecretsCreateSecurity };
...
export { SecretmanagerProjectsSecretsCreateRequest };
...
export { SecretmanagerProjectsSecretsCreateResponse };
