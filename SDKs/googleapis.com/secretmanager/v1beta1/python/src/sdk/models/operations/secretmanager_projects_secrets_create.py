...
@dataclass
class SecretmanagerProjectsSecretsCreateQueryParams:
    ...
    secret_id: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'secretId', 'style': 'form', 'explode': True }})
