...
type OrgpolicyProjectsPoliciesCreatePathParams struct {
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type OrgpolicyProjectsPoliciesCreateQueryParams struct {
...
type OrgpolicyProjectsPoliciesCreateSecurity struct {
...
type OrgpolicyProjectsPoliciesCreateResponse struct {
	ContentType                  string
