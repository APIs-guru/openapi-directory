...
var Shoppingadsprogram = /** @class */ (function () {
    function Shoppingadsprogram(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Shoppingadsprogram.prototype.contentShoppingadsprogramGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ContentShoppingadsprogramGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/{merchantId}/shoppingadsprogram", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.shoppingAdsProgramStatus = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Shoppingadsprogram.prototype.contentShoppingadsprogramRequestreview = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ContentShoppingadsprogramRequestreviewRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/{merchantId}/shoppingadsprogram/requestreview", req.pathParams);
