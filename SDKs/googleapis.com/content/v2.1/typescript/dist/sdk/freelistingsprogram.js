...
var Freelistingsprogram = /** @class */ (function () {
    ...
    **/
    Freelistingsprogram.prototype.contentFreelistingsprogramGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ContentFreelistingsprogramGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/{merchantId}/freelistingsprogram", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.freeListingsProgramStatus = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Freelistingsprogram.prototype.contentFreelistingsprogramRequestreview = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ContentFreelistingsprogramRequestreviewRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/{merchantId}/freelistingsprogram/requestreview", req.pathParams);
