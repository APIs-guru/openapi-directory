...
var Productdeliverytime = /** @class */ (function () {
    function Productdeliverytime(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Productdeliverytime.prototype.contentProductdeliverytimeCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ContentProductdeliverytimeCreateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/{merchantId}/productdeliverytime", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.productDeliveryTime = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Productdeliverytime.prototype.contentProductdeliverytimeDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ContentProductdeliverytimeDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/{merchantId}/productdeliverytime/{productId}", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    Productdeliverytime.prototype.contentProductdeliverytimeGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
