...
var Collections = /** @class */ (function () {
    ...
    **/
    Collections.prototype.contentCollectionsCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ContentCollectionsCreateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/{merchantId}/collections", req.pathParams);
    ...
    **/
    Collections.prototype.contentCollectionsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ContentCollectionsDeleteRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/{merchantId}/collections/{collectionId}", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    Collections.prototype.contentCollectionsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Collections.prototype.contentCollectionsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
