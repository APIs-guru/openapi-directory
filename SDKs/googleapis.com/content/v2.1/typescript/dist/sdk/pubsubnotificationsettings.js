...
var Pubsubnotificationsettings = /** @class */ (function () {
    function Pubsubnotificationsettings(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Pubsubnotificationsettings.prototype.contentPubsubnotificationsettingsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ContentPubsubnotificationsettingsGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/{merchantId}/pubsubnotificationsettings", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.pubsubNotificationSettings = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Pubsubnotificationsettings.prototype.contentPubsubnotificationsettingsUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
export { Pubsubnotificationsettings };
