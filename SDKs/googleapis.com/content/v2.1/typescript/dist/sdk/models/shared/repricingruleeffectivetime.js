...
var RepricingRuleEffectiveTime = /** @class */ (function (_super) {
    __extends(RepricingRuleEffectiveTime, _super);
    function RepricingRuleEffectiveTime() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=fixedTimePeriods", elemType: RepricingRuleEffectiveTimeFixedTimePeriod }),
        __metadata("design:type", Array)
    ], RepricingRuleEffectiveTime.prototype, "fixedTimePeriods", void 0);
    return RepricingRuleEffectiveTime;
}(SpeakeasyBase));
export { RepricingRuleEffectiveTime };
