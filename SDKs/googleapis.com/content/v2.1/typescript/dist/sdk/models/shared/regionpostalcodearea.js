...
**/
var RegionPostalCodeArea = /** @class */ (function (_super) {
    __extends(RegionPostalCodeArea, _super);
    function RegionPostalCodeArea() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=postalCodes", elemType: RegionPostalCodeAreaPostalCodeRange }),
        __metadata("design:type", Array)
    ], RegionPostalCodeArea.prototype, "postalCodes", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=regionCode" }),
        __metadata("design:type", String)
    ], RegionPostalCodeArea.prototype, "regionCode", void 0);
    return RegionPostalCodeArea;
}(SpeakeasyBase));
export { RegionPostalCodeArea };
