...
export class ContentOrdersSetlineitemmetadataPathParams extends SpeakeasyBase {
...
export class ContentOrdersSetlineitemmetadataQueryParams extends SpeakeasyBase {
...
export class ContentOrdersSetlineitemmetadataSecurity extends SpeakeasyBase {
...
export class ContentOrdersSetlineitemmetadataRequest extends SpeakeasyBase {
  @Metadata()
...
export class ContentOrdersSetlineitemmetadataResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
