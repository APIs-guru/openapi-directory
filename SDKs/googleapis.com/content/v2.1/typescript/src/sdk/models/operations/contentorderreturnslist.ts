...
export class ContentOrderreturnsListQueryParams extends SpeakeasyBase {
  ...
  @Metadata({ data: "queryParam, style=form;explode=true;name=acknowledged" })
  ...
  @Metadata({ data: "queryParam, style=form;explode=true;name=googleOrderIds" })
  ...
  @Metadata({ data: "queryParam, style=form;explode=true;name=shipmentStates" })
  shipmentStates?: ContentOrderreturnsListShipmentStatesEnum[];

  @Metadata({ data: "queryParam, style=form;explode=true;name=shipmentStatus" })
  shipmentStatus?: ContentOrderreturnsListShipmentStatusEnum[];

  @Metadata({ data: "queryParam, style=form;explode=true;name=shipmentTrackingNumbers" })
  shipmentTrackingNumbers?: string[];

  @Metadata({ data: "queryParam, style=form;explode=true;name=shipmentTypes" })
