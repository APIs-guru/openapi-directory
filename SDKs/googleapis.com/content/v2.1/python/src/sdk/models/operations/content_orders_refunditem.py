...
class ContentOrdersRefunditemRequest:
    path_params: ContentOrdersRefunditemPathParams = field()
    query_params: ContentOrdersRefunditemQueryParams = field()
    security: ContentOrdersRefunditemSecurity = field()
