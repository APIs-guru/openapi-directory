...
class ContentOrderinvoicesCreatechargeinvoiceRequest:
    path_params: ContentOrderinvoicesCreatechargeinvoicePathParams = field(default=None)
    query_params: ContentOrderinvoicesCreatechargeinvoiceQueryParams = field(default=None)
    ...
    security: ContentOrderinvoicesCreatechargeinvoiceSecurity = field(default=None)
