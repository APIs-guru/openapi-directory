...
class ContentProductstatusesRepricingreportsListRequest:
    path_params: ContentProductstatusesRepricingreportsListPathParams = field()
    query_params: ContentProductstatusesRepricingreportsListQueryParams = field()
    security: ContentProductstatusesRepricingreportsListSecurity = field()
