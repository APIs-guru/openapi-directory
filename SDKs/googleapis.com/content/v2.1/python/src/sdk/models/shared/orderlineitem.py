...
@dataclass
class OrderLineItem:
    adjustments: Optional[List[OrderLineItemAdjustment]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('adjustments') }})
    ...
    quantity_undeliverable: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('quantityUndeliverable') }})
