...
class ContentOrdersShiplineitemsRequest:
    path_params: ContentOrdersShiplineitemsPathParams = field()
    query_params: ContentOrdersShiplineitemsQueryParams = field()
    security: ContentOrdersShiplineitemsSecurity = field()
    request: Optional[shared.OrdersShipLineItemsRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class ContentOrdersShiplineitemsResponse:
    ...
    orders_ship_line_items_response: Optional[shared.OrdersShipLineItemsResponse] = field(default=None)
