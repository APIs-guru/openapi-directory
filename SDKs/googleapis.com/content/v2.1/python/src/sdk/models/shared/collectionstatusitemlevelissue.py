...
class CollectionStatusItemLevelIssue:
    r"""CollectionStatusItemLevelIssue
    Issue associated with the collection.
    """
    
    applicable_countries: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('applicableCountries') }})
