...
class ProductShipping:
    ...
    max_transit_time: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'maxTransitTime' }})
    min_handling_time: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'minHandlingTime' }})
    min_transit_time: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'minTransitTime' }})
