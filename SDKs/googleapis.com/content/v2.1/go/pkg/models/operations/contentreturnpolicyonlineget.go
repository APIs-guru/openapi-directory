...
type ContentReturnpolicyonlineGetPathParams struct {
	MerchantID     string `pathParam:"style=simple,explode=false,name=merchantId"`
	ReturnPolicyID string `pathParam:"style=simple,explode=false,name=returnPolicyId"`
}

type ContentReturnpolicyonlineGetQueryParams struct {
...
type ContentReturnpolicyonlineGetSecurity struct {
	Oauth2  shared.SchemeOauth2  `security:"scheme,type=oauth2"`
	Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
}

type ContentReturnpolicyonlineGetRequest struct {
...
type ContentReturnpolicyonlineGetResponse struct {
	ContentType        string
