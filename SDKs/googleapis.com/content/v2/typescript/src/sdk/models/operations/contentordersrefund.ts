...
export class ContentOrdersRefundPathParams extends SpeakeasyBase {
...
export class ContentOrdersRefundQueryParams extends SpeakeasyBase {
...
export class ContentOrdersRefundSecurity extends SpeakeasyBase {
...
export class ContentOrdersRefundRequest extends SpeakeasyBase {
  @Metadata()
...
export class ContentOrdersRefundResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
