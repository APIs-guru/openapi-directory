...
var TransitTable = /** @class */ (function (_super) {
    __extends(TransitTable, _super);
    ...
    ], TransitTable.prototype, "postalCodeGroupNames", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=rows", elemType: TransitTableTransitTimeRow }),
        __metadata("design:type", Array)
    ], TransitTable.prototype, "rows", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=transitTimeLabels" }),
        __metadata("design:type", Array)
    ], TransitTable.prototype, "transitTimeLabels", void 0);
    return TransitTable;
}(SpeakeasyBase));
export { TransitTable };
