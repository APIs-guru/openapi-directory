...
class ContentLiasettingsUpdateRequest:
    path_params: ContentLiasettingsUpdatePathParams = field()
    query_params: ContentLiasettingsUpdateQueryParams = field()
    security: ContentLiasettingsUpdateSecurity = field()
