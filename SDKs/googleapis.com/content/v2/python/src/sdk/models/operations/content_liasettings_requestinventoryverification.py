...
class ContentLiasettingsRequestinventoryverificationRequest:
    path_params: ContentLiasettingsRequestinventoryverificationPathParams = field()
    query_params: ContentLiasettingsRequestinventoryverificationQueryParams = field()
    security: ContentLiasettingsRequestinventoryverificationSecurity = field()
