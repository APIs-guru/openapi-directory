...
class ContentShippingsettingsGetsupportedpickupservicesRequest:
    path_params: ContentShippingsettingsGetsupportedpickupservicesPathParams = field(default=None)
    query_params: ContentShippingsettingsGetsupportedpickupservicesQueryParams = field(default=None)
    security: ContentShippingsettingsGetsupportedpickupservicesSecurity = field(default=None)
