...
class OrderReportTransaction:
    ...
    product_amount: Optional[amount.Amount] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'productAmount' }})
    product_amount_with_remitted_tax: Optional[productamount.ProductAmount] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'productAmountWithRemittedTax' }})
