...
class OrderReportTransaction:
    ...
    product_amount: Optional[Amount] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('productAmount') }})
    product_amount_with_remitted_tax: Optional[ProductAmount] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('productAmountWithRemittedTax') }})
