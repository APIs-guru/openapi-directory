...
export enum MybusinessbusinessinformationCategoriesListViewEnum {
...
export class MybusinessbusinessinformationCategoriesListQueryParams extends SpeakeasyBase {
...
export class MybusinessbusinessinformationCategoriesListRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  queryParams: MybusinessbusinessinformationCategoriesListQueryParams;
}


export class MybusinessbusinessinformationCategoriesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
