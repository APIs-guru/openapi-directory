...
export class MybusinessbusinessinformationAttributesListQueryParams extends SpeakeasyBase {
  ...
  @Metadata({ data: "queryParam, style=form;explode=true;name=showAll" })
  showAll?: boolean;
