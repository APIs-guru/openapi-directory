...
class PrivatecaProjectsLocationsCertificateTemplatesCreateRequest:
    path_params: PrivatecaProjectsLocationsCertificateTemplatesCreatePathParams = field()
    query_params: PrivatecaProjectsLocationsCertificateTemplatesCreateQueryParams = field()
    security: PrivatecaProjectsLocationsCertificateTemplatesCreateSecurity = field()
    request: Optional[shared.CertificateTemplateInput] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
