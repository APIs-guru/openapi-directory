...
**/
var SubordinateConfig = /** @class */ (function (_super) {
    __extends(SubordinateConfig, _super);
    function SubordinateConfig() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=certificateAuthority" }),
        __metadata("design:type", String)
    ], SubordinateConfig.prototype, "certificateAuthority", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=pemIssuerChain" }),
        __metadata("design:type", SubordinateConfigChain)
    ], SubordinateConfig.prototype, "pemIssuerChain", void 0);
    return SubordinateConfig;
}(SpeakeasyBase));
export { SubordinateConfig };
