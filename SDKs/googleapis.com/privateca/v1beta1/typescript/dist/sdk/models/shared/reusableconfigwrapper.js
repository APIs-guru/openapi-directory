...
**/
var ReusableConfigWrapper = /** @class */ (function (_super) {
    __extends(ReusableConfigWrapper, _super);
    function ReusableConfigWrapper() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=reusableConfig" }),
        __metadata("design:type", String)
    ], ReusableConfigWrapper.prototype, "reusableConfig", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=reusableConfigValues" }),
        __metadata("design:type", ReusableConfigValues)
    ], ReusableConfigWrapper.prototype, "reusableConfigValues", void 0);
    return ReusableConfigWrapper;
}(SpeakeasyBase));
export { ReusableConfigWrapper };
