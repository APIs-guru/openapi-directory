...
**/
var ReusableConfigValues = /** @class */ (function (_super) {
    __extends(ReusableConfigValues, _super);
    function ReusableConfigValues() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=additionalExtensions", elemType: X509Extension }),
        __metadata("design:type", Array)
    ], ReusableConfigValues.prototype, "additionalExtensions", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=aiaOcspServers" }),
        __metadata("design:type", Array)
    ], ReusableConfigValues.prototype, "aiaOcspServers", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=caOptions" }),
        __metadata("design:type", CaOptions)
    ], ReusableConfigValues.prototype, "caOptions", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=keyUsage" }),
        __metadata("design:type", KeyUsage)
    ], ReusableConfigValues.prototype, "keyUsage", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=policyIds", elemType: ObjectId }),
        __metadata("design:type", Array)
    ], ReusableConfigValues.prototype, "policyIds", void 0);
    return ReusableConfigValues;
}(SpeakeasyBase));
export { ReusableConfigValues };
