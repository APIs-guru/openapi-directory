...
class PrivatecaProjectsLocationsReusableConfigsTestIamPermissionsRequest:
    path_params: PrivatecaProjectsLocationsReusableConfigsTestIamPermissionsPathParams = field(default=None)
    query_params: PrivatecaProjectsLocationsReusableConfigsTestIamPermissionsQueryParams = field(default=None)
    request: Optional[shared.TestIamPermissionsRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: PrivatecaProjectsLocationsReusableConfigsTestIamPermissionsSecurity = field(default=None)
