...
export class GoogleAnalyticsAdminV1alphaAudienceSequenceFilter extends SpeakeasyBase {
  ...
  @Metadata({ data: "json, name=sequenceMaximumDuration" })
  sequenceMaximumDuration?: string;

  @Metadata({ data: "json, name=sequenceSteps", elemType: shared.GoogleAnalyticsAdminV1alphaAudienceSequenceFilterAudienceSequenceStep })
