...
type AnalyticsadminPropertiesConversionEventsCreatePathParams struct {
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type AnalyticsadminPropertiesConversionEventsCreateQueryParams struct {
...
type AnalyticsadminPropertiesConversionEventsCreateSecurity struct {
...
type AnalyticsadminPropertiesConversionEventsCreateResponse struct {
	ContentType                                string
