...
type AnalyticsadminPropertiesCreateQueryParams struct {
...
type AnalyticsadminPropertiesCreateSecurity struct {
...
type AnalyticsadminPropertiesCreateResponse struct {
	ContentType                         string
