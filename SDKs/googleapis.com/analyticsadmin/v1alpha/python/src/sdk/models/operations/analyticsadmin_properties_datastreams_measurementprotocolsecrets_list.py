...
class AnalyticsadminPropertiesDataStreamsMeasurementProtocolSecretsListSecurity:
    option1: Optional[AnalyticsadminPropertiesDataStreamsMeasurementProtocolSecretsListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AnalyticsadminPropertiesDataStreamsMeasurementProtocolSecretsListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
