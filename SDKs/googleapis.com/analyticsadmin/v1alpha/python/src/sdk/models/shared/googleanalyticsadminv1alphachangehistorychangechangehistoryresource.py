...
from . import googleanalyticsadminv1alphaexpandeddataset
...
class GoogleAnalyticsAdminV1alphaChangeHistoryChangeChangeHistoryResource:
    ...
    expanded_data_set: Optional[googleanalyticsadminv1alphaexpandeddataset.GoogleAnalyticsAdminV1alphaExpandedDataSet] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'expandedDataSet' }})
