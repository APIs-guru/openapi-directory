...
class AnalyticsadminPropertiesDisplayVideo360AdvertiserLinksCreateRequest:
    path_params: AnalyticsadminPropertiesDisplayVideo360AdvertiserLinksCreatePathParams = field()
    query_params: AnalyticsadminPropertiesDisplayVideo360AdvertiserLinksCreateQueryParams = field()
    security: AnalyticsadminPropertiesDisplayVideo360AdvertiserLinksCreateSecurity = field()
    request: Optional[shared.GoogleAnalyticsAdminV1alphaDisplayVideo360AdvertiserLinkInput] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
