...
class AnalyticsadminAccountsListSecurity:
    option1: Optional[AnalyticsadminAccountsListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AnalyticsadminAccountsListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
