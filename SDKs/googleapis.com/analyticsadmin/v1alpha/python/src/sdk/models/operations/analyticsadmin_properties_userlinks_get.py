...
@dataclass
class AnalyticsadminPropertiesUserLinksGetQueryParams:
...
class AnalyticsadminPropertiesUserLinksGetSecurity:
    option1: Optional[AnalyticsadminPropertiesUserLinksGetSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AnalyticsadminPropertiesUserLinksGetSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
