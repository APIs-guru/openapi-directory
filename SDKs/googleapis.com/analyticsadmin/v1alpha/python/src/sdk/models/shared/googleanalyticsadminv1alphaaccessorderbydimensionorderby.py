...
class GoogleAnalyticsAdminV1alphaAccessOrderByDimensionOrderBy:
    ...
    order_type: Optional[GoogleAnalyticsAdminV1alphaAccessOrderByDimensionOrderByOrderTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'orderType' }})
