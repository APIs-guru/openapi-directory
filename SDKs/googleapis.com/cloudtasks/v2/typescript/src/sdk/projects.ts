...
export class Projects {
  ...
  **/
  cloudtasksProjectsLocationsQueuesCreate(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{parent}/queues", req.pathParams);
  ...
  **/
  cloudtasksProjectsLocationsQueuesPause(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{name}:pause", req.pathParams);
  ...
  **/
  cloudtasksProjectsLocationsQueuesPurge(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{name}:purge", req.pathParams);
  ...
  **/
  cloudtasksProjectsLocationsQueuesResume(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{name}:resume", req.pathParams);
