...
export class CloudtasksProjectsLocationsQueuesPatchPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=name" })
  name: string;
}


export class CloudtasksProjectsLocationsQueuesPatchQueryParams extends SpeakeasyBase {
