...
export class CloudtasksProjectsLocationsQueuesListPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=parent" })
  parent: string;
}


export class CloudtasksProjectsLocationsQueuesListQueryParams extends SpeakeasyBase {
