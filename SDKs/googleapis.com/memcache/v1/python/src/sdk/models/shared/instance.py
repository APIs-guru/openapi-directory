...
from . import googlecloudmemcachev1maintenancepolicy
...
class Instance:
    ...
    maintenance_policy: Optional[googlecloudmemcachev1maintenancepolicy.GoogleCloudMemcacheV1MaintenancePolicy] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'maintenancePolicy' }})
