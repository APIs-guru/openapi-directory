...
class InstanceInput:
    ...
    maintenance_policy: Optional[GoogleCloudMemcacheV1beta2MaintenancePolicyInput] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('maintenancePolicy') }})
...
class Instance:
    ...
    instance_messages: Optional[List[InstanceMessage]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('instanceMessages') }})
    labels: Optional[dict[str, str]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('labels') }})
    maintenance_policy: Optional[GoogleCloudMemcacheV1beta2MaintenancePolicy] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('maintenancePolicy') }})
