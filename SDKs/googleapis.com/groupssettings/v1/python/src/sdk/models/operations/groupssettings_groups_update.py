...
class GroupsSettingsGroupsUpdateRequest:
    path_params: GroupsSettingsGroupsUpdatePathParams = field()
    query_params: GroupsSettingsGroupsUpdateQueryParams = field()
    security: GroupsSettingsGroupsUpdateSecurity = field()
