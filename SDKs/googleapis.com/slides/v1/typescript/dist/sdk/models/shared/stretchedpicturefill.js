...
**/
var StretchedPictureFill = /** @class */ (function (_super) {
    __extends(StretchedPictureFill, _super);
    function StretchedPictureFill() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=contentUrl" }),
        __metadata("design:type", String)
    ], StretchedPictureFill.prototype, "contentUrl", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=size" }),
        __metadata("design:type", Size)
    ], StretchedPictureFill.prototype, "size", void 0);
    return StretchedPictureFill;
}(SpeakeasyBase));
export { StretchedPictureFill };
