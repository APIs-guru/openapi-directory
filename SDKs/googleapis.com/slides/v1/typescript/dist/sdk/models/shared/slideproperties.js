...
**/
var SlideProperties = /** @class */ (function (_super) {
    __extends(SlideProperties, _super);
    ...
    ], SlideProperties.prototype, "isSkipped", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=layoutObjectId" }),
        __metadata("design:type", String)
    ], SlideProperties.prototype, "layoutObjectId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=masterObjectId" }),
        __metadata("design:type", String)
    ], SlideProperties.prototype, "masterObjectId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=notesPage" }),
        __metadata("design:type", Page)
    ], SlideProperties.prototype, "notesPage", void 0);
