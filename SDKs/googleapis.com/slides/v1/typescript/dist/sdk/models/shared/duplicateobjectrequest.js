...
**/
var DuplicateObjectRequest = /** @class */ (function (_super) {
    __extends(DuplicateObjectRequest, _super);
    function DuplicateObjectRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=objectId" }),
        __metadata("design:type", String)
    ], DuplicateObjectRequest.prototype, "objectId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=objectIds" }),
        __metadata("design:type", Map)
    ], DuplicateObjectRequest.prototype, "objectIds", void 0);
    return DuplicateObjectRequest;
}(SpeakeasyBase));
export { DuplicateObjectRequest };
