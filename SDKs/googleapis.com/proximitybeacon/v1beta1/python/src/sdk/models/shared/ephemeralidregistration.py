...
class EphemeralIDRegistration:
    ...
    beacon_ecdh_public_key: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('beaconEcdhPublicKey') }})
    beacon_identity_key: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('beaconIdentityKey') }})
    initial_clock_value: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('initialClockValue') }})
    initial_eid: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('initialEid') }})
    rotation_period_exponent: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('rotationPeriodExponent') }})
