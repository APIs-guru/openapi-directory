...
export class ProximitybeaconBeaconsAttachmentsListPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=beaconName" })
  beaconName: string;
}


export class ProximitybeaconBeaconsAttachmentsListQueryParams extends SpeakeasyBase {
...
export class ProximitybeaconBeaconsAttachmentsListSecurity extends SpeakeasyBase {
...
export class ProximitybeaconBeaconsAttachmentsListRequest extends SpeakeasyBase {
  @Metadata()
...
export class ProximitybeaconBeaconsAttachmentsListResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
