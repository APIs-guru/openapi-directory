...
export class EphemeralIdRegistration extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=beaconEcdhPublicKey" })
  beaconEcdhPublicKey?: string;

  @SpeakeasyMetadata({ data: "json, name=beaconIdentityKey" })
  beaconIdentityKey?: string;

  @SpeakeasyMetadata({ data: "json, name=initialClockValue" })
  initialClockValue?: string;

  @SpeakeasyMetadata({ data: "json, name=initialEid" })
  initialEid?: string;

  @SpeakeasyMetadata({ data: "json, name=rotationPeriodExponent" })
