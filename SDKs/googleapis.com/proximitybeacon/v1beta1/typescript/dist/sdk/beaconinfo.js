...
var Beaconinfo = /** @class */ (function () {
    function Beaconinfo(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Beaconinfo.prototype.proximitybeaconBeaconinfoGetforobserved = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ProximitybeaconBeaconinfoGetforobservedRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v1beta1/beaconinfo:getforobserved";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.getInfoForObservedBeaconsResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
