...
func NewBeacons(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *Beacons {
	return &Beacons{
...
func (s *Beacons) ProximitybeaconBeaconsActivate(ctx context.Context, request operations.ProximitybeaconBeaconsActivateRequest) (*operations.ProximitybeaconBeaconsActivateResponse, error) {
...
func (s *Beacons) ProximitybeaconBeaconsAttachmentsBatchDelete(ctx context.Context, request operations.ProximitybeaconBeaconsAttachmentsBatchDeleteRequest) (*operations.ProximitybeaconBeaconsAttachmentsBatchDeleteResponse, error) {
	baseURL := s._serverURL
...
func (s *Beacons) ProximitybeaconBeaconsAttachmentsCreate(ctx context.Context, request operations.ProximitybeaconBeaconsAttachmentsCreateRequest) (*operations.ProximitybeaconBeaconsAttachmentsCreateResponse, error) {
	baseURL := s._serverURL
...
func (s *Beacons) ProximitybeaconBeaconsAttachmentsDelete(ctx context.Context, request operations.ProximitybeaconBeaconsAttachmentsDeleteRequest) (*operations.ProximitybeaconBeaconsAttachmentsDeleteResponse, error) {
	baseURL := s._serverURL
...
func (s *Beacons) ProximitybeaconBeaconsAttachmentsList(ctx context.Context, request operations.ProximitybeaconBeaconsAttachmentsListRequest) (*operations.ProximitybeaconBeaconsAttachmentsListResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1beta1/{beaconName}/attachments", request.PathParams)
...
func (s *Beacons) ProximitybeaconBeaconsDeactivate(ctx context.Context, request operations.ProximitybeaconBeaconsDeactivateRequest) (*operations.ProximitybeaconBeaconsDeactivateResponse, error) {
	baseURL := s._serverURL
...
func (s *Beacons) ProximitybeaconBeaconsDecommission(ctx context.Context, request operations.ProximitybeaconBeaconsDecommissionRequest) (*operations.ProximitybeaconBeaconsDecommissionResponse, error) {
	baseURL := s._serverURL
...
func (s *Beacons) ProximitybeaconBeaconsDelete(ctx context.Context, request operations.ProximitybeaconBeaconsDeleteRequest) (*operations.ProximitybeaconBeaconsDeleteResponse, error) {
	baseURL := s._serverURL
...
func (s *Beacons) ProximitybeaconBeaconsDiagnosticsList(ctx context.Context, request operations.ProximitybeaconBeaconsDiagnosticsListRequest) (*operations.ProximitybeaconBeaconsDiagnosticsListResponse, error) {
	baseURL := s._serverURL
...
func (s *Beacons) ProximitybeaconBeaconsGet(ctx context.Context, request operations.ProximitybeaconBeaconsGetRequest) (*operations.ProximitybeaconBeaconsGetResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1beta1/{beaconName}", request.PathParams)
...
func (s *Beacons) ProximitybeaconBeaconsList(ctx context.Context, request operations.ProximitybeaconBeaconsListRequest) (*operations.ProximitybeaconBeaconsListResponse, error) {
	baseURL := s._serverURL
...
func (s *Beacons) ProximitybeaconBeaconsRegister(ctx context.Context, request operations.ProximitybeaconBeaconsRegisterRequest) (*operations.ProximitybeaconBeaconsRegisterResponse, error) {
	baseURL := s._serverURL
...
func (s *Beacons) ProximitybeaconBeaconsUpdate(ctx context.Context, request operations.ProximitybeaconBeaconsUpdateRequest) (*operations.ProximitybeaconBeaconsUpdateResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1beta1/{beaconName}", request.PathParams)
