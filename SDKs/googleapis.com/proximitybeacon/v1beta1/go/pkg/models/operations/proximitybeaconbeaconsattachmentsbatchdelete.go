...
type ProximitybeaconBeaconsAttachmentsBatchDeletePathParams struct {
    BeaconName string `pathParam:"style=simple,explode=false,name=beaconName"`
    
}

type ProximitybeaconBeaconsAttachmentsBatchDeleteQueryParams struct {
...
type ProximitybeaconBeaconsAttachmentsBatchDeleteSecurity struct {
    Oauth2 shared.SchemeOauth2 `security:"scheme,type=oauth2"`
    Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
    
}

type ProximitybeaconBeaconsAttachmentsBatchDeleteRequest struct {
...
type ProximitybeaconBeaconsAttachmentsBatchDeleteResponse struct {
    ContentType string 
