...
var Locations = /** @class */ (function () {
    ...
    **/
    Locations.prototype.mybusinesslodgingLocationsGetLodging = function (req, config) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.lodging = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Locations.prototype.mybusinesslodgingLocationsLodgingGetGoogleUpdated = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Locations.prototype.mybusinesslodgingLocationsUpdateLodging = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
