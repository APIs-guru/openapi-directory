...
export var LanguageSpokenSpokenExceptionEnum;
(function (LanguageSpokenSpokenExceptionEnum) {
...
})(LanguageSpokenSpokenExceptionEnum || (LanguageSpokenSpokenExceptionEnum = {}));
// LanguageSpoken
/**
 * Language spoken by at least one staff member.
**/
var LanguageSpoken = /** @class */ (function (_super) {
    __extends(LanguageSpoken, _super);
    ...
    ], LanguageSpoken.prototype, "languageCode", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=spoken" }),
        __metadata("design:type", Boolean)
    ], LanguageSpoken.prototype, "spoken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=spokenException" }),
        __metadata("design:type", String)
    ], LanguageSpoken.prototype, "spokenException", void 0);
    return LanguageSpoken;
}(SpeakeasyBase));
export { LanguageSpoken };
