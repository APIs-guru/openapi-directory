...
class MybusinesslodgingLocationsLodgingGetGoogleUpdatedRequest:
    path_params: MybusinesslodgingLocationsLodgingGetGoogleUpdatedPathParams = field()
    query_params: MybusinesslodgingLocationsLodgingGetGoogleUpdatedQueryParams = field()
