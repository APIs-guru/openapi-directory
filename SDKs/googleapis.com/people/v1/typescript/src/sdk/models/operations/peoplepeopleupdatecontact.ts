...
export class PeoplePeopleUpdateContactPathParams extends SpeakeasyBase {
...
export class PeoplePeopleUpdateContactQueryParams extends SpeakeasyBase {
  ...
  @Metadata({ data: "queryParam, style=form;explode=true;name=updatePersonFields" })
