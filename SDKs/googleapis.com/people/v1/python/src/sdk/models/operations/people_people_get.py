...
class PeoplePeopleGetRequest:
    path_params: PeoplePeopleGetPathParams = field(default=None)
    query_params: PeoplePeopleGetQueryParams = field(default=None)
    security: PeoplePeopleGetSecurity = field(default=None)
