...
class PeopleContactGroupsListSecurity:
    option1: Optional[PeopleContactGroupsListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[PeopleContactGroupsListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
