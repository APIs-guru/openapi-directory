...
class PeoplePeopleSearchContactsQueryParams:
    ...
    sources: Optional[List[PeoplePeopleSearchContactsSourcesEnum]] = field(default=None, metadata={'query_param': { 'field_name': 'sources', 'style': 'form', 'explode': True }})
...
class PeoplePeopleSearchContactsSecurity:
    option1: Optional[PeoplePeopleSearchContactsSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[PeoplePeopleSearchContactsSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class PeoplePeopleSearchContactsRequest:
    query_params: PeoplePeopleSearchContactsQueryParams = field(default=None)
    security: PeoplePeopleSearchContactsSecurity = field(default=None)
