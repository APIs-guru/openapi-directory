...
class PeopleOtherContactsListQueryParams:
    ...
    sources: Optional[List[PeopleOtherContactsListSourcesEnum]] = field(default=None, metadata={'query_param': { 'field_name': 'sources', 'style': 'form', 'explode': True }})
...
class PeopleOtherContactsListRequest:
    query_params: PeopleOtherContactsListQueryParams = field(default=None)
    security: PeopleOtherContactsListSecurity = field(default=None)
    

@dataclass
class PeopleOtherContactsListResponse:
    content_type: str = field(default=None)
    list_other_contacts_response: Optional[shared.ListOtherContactsResponse] = field(default=None)
