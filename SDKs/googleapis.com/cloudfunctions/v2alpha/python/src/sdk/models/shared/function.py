...
from . import googlecloudfunctionsv2alphastatemessage
...
class Function:
    ...
    state_messages: Optional[List[googlecloudfunctionsv2alphastatemessage.GoogleCloudFunctionsV2alphaStateMessage]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'stateMessages' }})
