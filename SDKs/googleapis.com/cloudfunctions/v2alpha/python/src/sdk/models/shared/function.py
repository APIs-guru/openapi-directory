...
class Function:
    ...
    state_messages: Optional[List[GoogleCloudFunctionsV2alphaStateMessage]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('stateMessages') }})
