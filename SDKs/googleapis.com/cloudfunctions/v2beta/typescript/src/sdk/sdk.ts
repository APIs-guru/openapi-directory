...
export class SDK {
  ...
  CloudfunctionsProjectsLocationsFunctionsCreate(
    ...
    const url: string = utils.GenerateURL(baseURL, "/v2beta/{parent}/functions", req.pathParams);
  ...
  CloudfunctionsProjectsLocationsFunctionsGenerateDownloadUrl(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2beta/{name}:generateDownloadUrl", req.pathParams);
  ...
  CloudfunctionsProjectsLocationsFunctionsGenerateUploadUrl(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2beta/{parent}/functions:generateUploadUrl", req.pathParams);
  ...
  CloudfunctionsProjectsLocationsFunctionsGetIamPolicy(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2beta/{resource}:getIamPolicy", req.pathParams);
  ...
  CloudfunctionsProjectsLocationsFunctionsSetIamPolicy(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2beta/{resource}:setIamPolicy", req.pathParams);
  ...
  CloudfunctionsProjectsLocationsFunctionsTestIamPermissions(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2beta/{resource}:testIamPermissions", req.pathParams);
  ...
  CloudfunctionsProjectsLocationsRuntimesList(
    ...
    let baseURL: string = this.serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2beta/{parent}/runtimes", req.pathParams);
