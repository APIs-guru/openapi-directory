...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.CloudfunctionsProjectsLocationsFunctionsCreate = function (req, config) {
        ...
        var url = utils.GenerateURL(baseURL, "/v2beta/{parent}/functions", req.pathParams);
    ...
    SDK.prototype.CloudfunctionsProjectsLocationsFunctionsGenerateDownloadUrl = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v2beta/{name}:generateDownloadUrl", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.CloudfunctionsProjectsLocationsFunctionsGenerateUploadUrl = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v2beta/{parent}/functions:generateUploadUrl", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.CloudfunctionsProjectsLocationsFunctionsGetIamPolicy = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v2beta/{resource}:getIamPolicy", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.CloudfunctionsProjectsLocationsFunctionsSetIamPolicy = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v2beta/{resource}:setIamPolicy", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.CloudfunctionsProjectsLocationsFunctionsTestIamPermissions = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v2beta/{resource}:testIamPermissions", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.CloudfunctionsProjectsLocationsRuntimesList = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v2beta/{parent}/runtimes", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
