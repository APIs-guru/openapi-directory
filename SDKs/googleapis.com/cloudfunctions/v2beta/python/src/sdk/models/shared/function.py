...
class Function:
    ...
    state_messages: Optional[List[GoogleCloudFunctionsV2betaStateMessage]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('stateMessages') }})
