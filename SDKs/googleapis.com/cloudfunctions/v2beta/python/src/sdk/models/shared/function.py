...
from . import googlecloudfunctionsv2betastatemessage
...
class Function:
    ...
    state_messages: Optional[List[googlecloudfunctionsv2betastatemessage.GoogleCloudFunctionsV2betaStateMessage]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'stateMessages' }})
