...
export class Projects {
  ...
  **/
  cloudfunctionsProjectsLocationsFunctionsCall(
    req: operations.CloudfunctionsProjectsLocationsFunctionsCallRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.CloudfunctionsProjectsLocationsFunctionsCallResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.CloudfunctionsProjectsLocationsFunctionsCallRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{name}:call", req.pathParams);
    ...
    return client
      .request({
        ...
        const res: operations.CloudfunctionsProjectsLocationsFunctionsCallResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.callFunctionResponse = httpRes?.data;
            }
            break;
        }
  ...
  **/
  cloudfunctionsProjectsLocationsFunctionsCreate(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{location}/functions", req.pathParams);
  ...
  **/
  cloudfunctionsProjectsLocationsFunctionsGenerateUploadUrl(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{parent}/functions:generateUploadUrl", req.pathParams);
  ...
  **/
  cloudfunctionsProjectsLocationsFunctionsGet(
    req: operations.CloudfunctionsProjectsLocationsFunctionsGetRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.CloudfunctionsProjectsLocationsFunctionsGetResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.CloudfunctionsProjectsLocationsFunctionsGetResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.cloudFunction = httpRes?.data;
            }
            break;
        }
  ...
  **/
  cloudfunctionsProjectsLocationsFunctionsList(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v1/{parent}/functions", req.pathParams);
