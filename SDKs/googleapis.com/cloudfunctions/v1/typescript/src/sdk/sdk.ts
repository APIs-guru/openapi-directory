...
export class SDK {
  ...
  CloudfunctionsOperationsList(
  ...
  ): Promise<operations.CloudfunctionsOperationsListResponse> {
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        let res: operations.CloudfunctionsOperationsListResponse = {statusCode: httpRes.status, contentType: contentType};
  ...
  CloudfunctionsProjectsLocationsFunctionsCall(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.CloudfunctionsProjectsLocationsFunctionsCallResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  CloudfunctionsProjectsLocationsFunctionsGet(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.CloudfunctionsProjectsLocationsFunctionsGetResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
