...
class Projects:
    ...
    def servicedirectory_projects_locations_namespaces_services_endpoints_create(self, request: operations.ServicedirectoryProjectsLocationsNamespacesServicesEndpointsCreateRequest) -> operations.ServicedirectoryProjectsLocationsNamespacesServicesEndpointsCreateResponse:
        ...
        url = utils.generate_url(base_url, "/v1beta1/{parent}/endpoints", request.path_params)
    ...
    def servicedirectory_projects_locations_namespaces_services_resolve(self, request: operations.ServicedirectoryProjectsLocationsNamespacesServicesResolveRequest) -> operations.ServicedirectoryProjectsLocationsNamespacesServicesResolveResponse:
        ...
        url = utils.generate_url(base_url, "/v1beta1/{name}:resolve", request.path_params)
    ...
    def servicedirectory_projects_locations_registration_policies_get_iam_policy(self, request: operations.ServicedirectoryProjectsLocationsRegistrationPoliciesGetIamPolicyRequest) -> operations.ServicedirectoryProjectsLocationsRegistrationPoliciesGetIamPolicyResponse:
        ...
        res = operations.ServicedirectoryProjectsLocationsRegistrationPoliciesGetIamPolicyResponse(status_code=r.status_code, content_type=content_type)
    ...
    def servicedirectory_projects_locations_registration_policies_set_iam_policy(self, request: operations.ServicedirectoryProjectsLocationsRegistrationPoliciesSetIamPolicyRequest) -> operations.ServicedirectoryProjectsLocationsRegistrationPoliciesSetIamPolicyResponse:
        ...
        res = operations.ServicedirectoryProjectsLocationsRegistrationPoliciesSetIamPolicyResponse(status_code=r.status_code, content_type=content_type)
    ...
    def servicedirectory_projects_locations_registration_policies_test_iam_permissions(self, request: operations.ServicedirectoryProjectsLocationsRegistrationPoliciesTestIamPermissionsRequest) -> operations.ServicedirectoryProjectsLocationsRegistrationPoliciesTestIamPermissionsResponse:
        ...
        res = operations.ServicedirectoryProjectsLocationsRegistrationPoliciesTestIamPermissionsResponse(status_code=r.status_code, content_type=content_type)
