...
func (s *SDK) ServicedirectoryProjectsLocationsRegistrationPoliciesGetIamPolicy(ctx context.Context, request operations.ServicedirectoryProjectsLocationsRegistrationPoliciesGetIamPolicyRequest) (*operations.ServicedirectoryProjectsLocationsRegistrationPoliciesGetIamPolicyResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) ServicedirectoryProjectsLocationsRegistrationPoliciesSetIamPolicy(ctx context.Context, request operations.ServicedirectoryProjectsLocationsRegistrationPoliciesSetIamPolicyRequest) (*operations.ServicedirectoryProjectsLocationsRegistrationPoliciesSetIamPolicyResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) ServicedirectoryProjectsLocationsRegistrationPoliciesTestIamPermissions(ctx context.Context, request operations.ServicedirectoryProjectsLocationsRegistrationPoliciesTestIamPermissionsRequest) (*operations.ServicedirectoryProjectsLocationsRegistrationPoliciesTestIamPermissionsResponse, error) {
	baseURL := s.serverURL
