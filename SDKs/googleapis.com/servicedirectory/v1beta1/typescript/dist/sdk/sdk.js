...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.ServicedirectoryProjectsLocationsList = function (req, config) {
    ...
    SDK.prototype.ServicedirectoryProjectsLocationsNamespacesCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ServicedirectoryProjectsLocationsNamespacesCreateRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta1/{parent}/namespaces", req.pathParams);
    ...
    SDK.prototype.ServicedirectoryProjectsLocationsNamespacesList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.ServicedirectoryProjectsLocationsNamespacesServicesCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ServicedirectoryProjectsLocationsNamespacesServicesCreateRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta1/{parent}/services", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.ServicedirectoryProjectsLocationsNamespacesServicesEndpointsCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ServicedirectoryProjectsLocationsNamespacesServicesEndpointsCreateRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta1/{parent}/endpoints", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.ServicedirectoryProjectsLocationsNamespacesServicesEndpointsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.ServicedirectoryProjectsLocationsNamespacesServicesEndpointsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.ServicedirectoryProjectsLocationsNamespacesServicesEndpointsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.ServicedirectoryProjectsLocationsNamespacesServicesEndpointsPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.ServicedirectoryProjectsLocationsNamespacesServicesList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.ServicedirectoryProjectsLocationsNamespacesServicesResolve = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ServicedirectoryProjectsLocationsNamespacesServicesResolveRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta1/{name}:resolve", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.ServicedirectoryProjectsLocationsRegistrationPoliciesGetIamPolicy = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.ServicedirectoryProjectsLocationsRegistrationPoliciesSetIamPolicy = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.ServicedirectoryProjectsLocationsRegistrationPoliciesTestIamPermissions = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
