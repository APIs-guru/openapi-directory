...
class AnalyticsreportingUserActivitySearchSecurity:
    option1: Optional[AnalyticsreportingUserActivitySearchSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AnalyticsreportingUserActivitySearchSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
