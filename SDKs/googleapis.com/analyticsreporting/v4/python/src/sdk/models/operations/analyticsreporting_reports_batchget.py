...
class AnalyticsreportingReportsBatchGetSecurity:
    option1: Optional[AnalyticsreportingReportsBatchGetSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[AnalyticsreportingReportsBatchGetSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
