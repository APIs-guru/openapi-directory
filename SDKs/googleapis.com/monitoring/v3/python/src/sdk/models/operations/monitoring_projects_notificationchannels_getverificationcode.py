...
class MonitoringProjectsNotificationChannelsGetVerificationCodeSecurity:
    option1: Optional[MonitoringProjectsNotificationChannelsGetVerificationCodeSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[MonitoringProjectsNotificationChannelsGetVerificationCodeSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
