...
class MonitoringProjectsAlertPoliciesListSecurity:
    option1: Optional[MonitoringProjectsAlertPoliciesListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[MonitoringProjectsAlertPoliciesListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[MonitoringProjectsAlertPoliciesListSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
