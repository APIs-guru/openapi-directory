...
class MonitoringProjectsGroupsUpdateSecurity:
    option1: Optional[MonitoringProjectsGroupsUpdateSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[MonitoringProjectsGroupsUpdateSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
