...
class MonitoringProjectsUptimeCheckConfigsCreateRequest:
    path_params: MonitoringProjectsUptimeCheckConfigsCreatePathParams = field()
    query_params: MonitoringProjectsUptimeCheckConfigsCreateQueryParams = field()
    security: MonitoringProjectsUptimeCheckConfigsCreateSecurity = field()
