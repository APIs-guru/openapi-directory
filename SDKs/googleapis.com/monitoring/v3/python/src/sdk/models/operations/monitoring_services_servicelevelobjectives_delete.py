...
@dataclass
class MonitoringServicesServiceLevelObjectivesDeleteQueryParams:
...
@dataclass
class MonitoringServicesServiceLevelObjectivesDeleteSecurity:
    option1: Optional[MonitoringServicesServiceLevelObjectivesDeleteSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[MonitoringServicesServiceLevelObjectivesDeleteSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
