...
export var JsonPathMatcherJsonMatcherEnum;
(function (JsonPathMatcherJsonMatcherEnum) {
...
})(JsonPathMatcherJsonMatcherEnum || (JsonPathMatcherJsonMatcherEnum = {}));
// JsonPathMatcher
/**
 * Information needed to perform a JSONPath content match. Used for ContentMatcherOption::MATCHES_JSON_PATH and ContentMatcherOption::NOT_MATCHES_JSON_PATH.
**/
var JsonPathMatcher = /** @class */ (function (_super) {
    __extends(JsonPathMatcher, _super);
    ...
    ], JsonPathMatcher.prototype, "jsonMatcher", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=jsonPath" }),
        __metadata("design:type", String)
    ], JsonPathMatcher.prototype, "jsonPath", void 0);
    return JsonPathMatcher;
}(SpeakeasyBase));
export { JsonPathMatcher };
