...
**/
var BasicService = /** @class */ (function (_super) {
    __extends(BasicService, _super);
    ...
    ], BasicService.prototype, "serviceLabels", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=serviceType" }),
        __metadata("design:type", String)
    ], BasicService.prototype, "serviceType", void 0);
    return BasicService;
}(SpeakeasyBase));
export { BasicService };
