...
export class Aggregation extends SpeakeasyBase {
  @Metadata({ data: "json, name=alignmentPeriod" })
  alignmentPeriod?: string;

  @Metadata({ data: "json, name=crossSeriesReducer" })
  crossSeriesReducer?: AggregationCrossSeriesReducerEnum;

  @Metadata({ data: "json, name=groupByFields" })
  groupByFields?: string[];

  @Metadata({ data: "json, name=perSeriesAligner" })
