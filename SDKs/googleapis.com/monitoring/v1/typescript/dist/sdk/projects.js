...
var Projects = /** @class */ (function () {
    ...
    **/
    Projects.prototype.monitoringProjectsDashboardsCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.MonitoringProjectsDashboardsCreateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{parent}/dashboards", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.dashboard = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Projects.prototype.monitoringProjectsDashboardsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Projects.prototype.monitoringProjectsDashboardsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Projects.prototype.monitoringProjectsDashboardsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Projects.prototype.monitoringProjectsDashboardsPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Projects.prototype.monitoringProjectsLocationPrometheusApiV1LabelValues = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.MonitoringProjectsLocationPrometheusApiV1LabelValuesRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{name}/location/{location}/prometheus/api/v1/label/{label}/values", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    Projects.prototype.monitoringProjectsLocationPrometheusApiV1Labels = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.MonitoringProjectsLocationPrometheusApiV1LabelsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{name}/location/{location}/prometheus/api/v1/labels", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    Projects.prototype.monitoringProjectsLocationPrometheusApiV1LabelsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Projects.prototype.monitoringProjectsLocationPrometheusApiV1MetadataList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.MonitoringProjectsLocationPrometheusApiV1MetadataListRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{name}/location/{location}/prometheus/api/v1/metadata", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    Projects.prototype.monitoringProjectsLocationPrometheusApiV1Query = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.MonitoringProjectsLocationPrometheusApiV1QueryRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{name}/location/{location}/prometheus/api/v1/query", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    Projects.prototype.monitoringProjectsLocationPrometheusApiV1QueryRange = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.MonitoringProjectsLocationPrometheusApiV1QueryRangeRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{name}/location/{location}/prometheus/api/v1/query_range", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    Projects.prototype.monitoringProjectsLocationPrometheusApiV1Series = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.MonitoringProjectsLocationPrometheusApiV1SeriesRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{name}/location/{location}/prometheus/api/v1/series", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
