...
export declare class MonitoringProjectsDashboardsDeletePathParams extends SpeakeasyBase {
    name: string;
}
export declare class MonitoringProjectsDashboardsDeleteQueryParams extends SpeakeasyBase {
