...
var Locations = /** @class */ (function () {
    ...
    **/
    Locations.prototype.monitoringLocationsGlobalMetricsScopesListMetricsScopesByMonitoredProject = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.MonitoringLocationsGlobalMetricsScopesListMetricsScopesByMonitoredProjectRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v1/locations/global/metricsScopes:listMetricsScopesByMonitoredProject";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.listMetricsScopesByMonitoredProjectResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Locations.prototype.monitoringLocationsGlobalMetricsScopesProjectsCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.MonitoringLocationsGlobalMetricsScopesProjectsCreateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{parent}/projects", req.pathParams);
