...
class MonitoringLocationsGlobalMetricsScopesListMetricsScopesByMonitoredProjectRequest:
    query_params: MonitoringLocationsGlobalMetricsScopesListMetricsScopesByMonitoredProjectQueryParams = field(default=None)
    security: MonitoringLocationsGlobalMetricsScopesListMetricsScopesByMonitoredProjectSecurity = field(default=None)
