...
class MonitoringProjectsLocationPrometheusAPIV1LabelValuesSecurity:
    option1: Optional[MonitoringProjectsLocationPrometheusAPIV1LabelValuesSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[MonitoringProjectsLocationPrometheusAPIV1LabelValuesSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[MonitoringProjectsLocationPrometheusAPIV1LabelValuesSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
