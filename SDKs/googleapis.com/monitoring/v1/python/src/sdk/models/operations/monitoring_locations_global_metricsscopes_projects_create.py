...
class MonitoringLocationsGlobalMetricsScopesProjectsCreateRequest:
    path_params: MonitoringLocationsGlobalMetricsScopesProjectsCreatePathParams = field()
    query_params: MonitoringLocationsGlobalMetricsScopesProjectsCreateQueryParams = field()
    security: MonitoringLocationsGlobalMetricsScopesProjectsCreateSecurity = field()
    request: Optional[shared.MonitoredProjectInput] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
