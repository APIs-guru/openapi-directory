...
class MonitoringProjectsLocationPrometheusAPIV1QueryRequest:
    path_params: MonitoringProjectsLocationPrometheusAPIV1QueryPathParams = field(default=None)
    query_params: MonitoringProjectsLocationPrometheusAPIV1QueryQueryParams = field(default=None)
    request: Optional[shared.QueryInstantRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: MonitoringProjectsLocationPrometheusAPIV1QuerySecurity = field(default=None)
