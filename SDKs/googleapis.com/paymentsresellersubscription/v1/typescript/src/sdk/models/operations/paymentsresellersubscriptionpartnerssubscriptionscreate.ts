...
export class PaymentsresellersubscriptionPartnersSubscriptionsCreatePathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=parent" })
  parent: string;
}


export class PaymentsresellersubscriptionPartnersSubscriptionsCreateQueryParams extends SpeakeasyBase {
...
export class PaymentsresellersubscriptionPartnersSubscriptionsCreateRequest extends SpeakeasyBase {
  @Metadata()
...
export class PaymentsresellersubscriptionPartnersSubscriptionsCreateResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
