...
class PaymentsresellersubscriptionPartnersSubscriptionsProvisionRequest:
    path_params: PaymentsresellersubscriptionPartnersSubscriptionsProvisionPathParams = field()
    query_params: PaymentsresellersubscriptionPartnersSubscriptionsProvisionQueryParams = field()
