...
export declare class SDK {
    ...
    FileProjectsLocationsInstancesRevert(req: operations.FileProjectsLocationsInstancesRevertRequest, config?: AxiosRequestConfig): Promise<operations.FileProjectsLocationsInstancesRevertResponse>;
    FileProjectsLocationsInstancesSharesCreate(req: operations.FileProjectsLocationsInstancesSharesCreateRequest, config?: AxiosRequestConfig): Promise<operations.FileProjectsLocationsInstancesSharesCreateResponse>;
    FileProjectsLocationsInstancesSharesList(req: operations.FileProjectsLocationsInstancesSharesListRequest, config?: AxiosRequestConfig): Promise<operations.FileProjectsLocationsInstancesSharesListResponse>;
