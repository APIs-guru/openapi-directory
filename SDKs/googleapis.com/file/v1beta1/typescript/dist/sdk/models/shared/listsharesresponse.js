...
var ListSharesResponse = /** @class */ (function (_super) {
    ...
    ], ListSharesResponse.prototype, "nextPageToken", void 0);
    __decorate([
        Metadata({ data: "json, name=shares", elemType: shared.Share }),
        __metadata("design:type", Array)
    ], ListSharesResponse.prototype, "shares", void 0);
    __decorate([
        Metadata({ data: "json, name=unreachable" }),
        __metadata("design:type", Array)
    ], ListSharesResponse.prototype, "unreachable", void 0);
    return ListSharesResponse;
}(SpeakeasyBase));
export { ListSharesResponse };
