...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.FileProjectsLocationsBackupsCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.FileProjectsLocationsBackupsCreateRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta1/{parent}/backups", req.pathParams);
    ...
    SDK.prototype.FileProjectsLocationsBackupsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.FileProjectsLocationsInstancesCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.FileProjectsLocationsInstancesList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.FileProjectsLocationsInstancesRestore = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.FileProjectsLocationsInstancesRestoreRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta1/{name}:restore", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.FileProjectsLocationsInstancesRevert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.FileProjectsLocationsInstancesRevertRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta1/{name}:revert", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.FileProjectsLocationsInstancesSharesCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.FileProjectsLocationsInstancesSharesCreateRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta1/{parent}/shares", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.FileProjectsLocationsInstancesSharesList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) {
                case 200:
                    if (MatchContentType(contentType, "application/json")) {
                        res.listSharesResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.FileProjectsLocationsInstancesSnapshotsCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.FileProjectsLocationsInstancesSnapshotsCreateRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta1/{parent}/snapshots", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.FileProjectsLocationsInstancesSnapshotsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.FileProjectsLocationsInstancesSnapshotsPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.FileProjectsLocationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.FileProjectsLocationsOperationsCancel = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.FileProjectsLocationsOperationsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.FileProjectsLocationsOperationsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.FileProjectsLocationsOperationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
