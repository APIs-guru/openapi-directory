...
* `file_projects_locations_instances_revert` - Revert an existing instance's file system to a specified snapshot.
* `file_projects_locations_instances_shares_create` - Creates a share.
* `file_projects_locations_instances_shares_list` - Lists all shares for a specified instance.
