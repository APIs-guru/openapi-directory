...
func (s *SDK) FirestoreProjectsDatabasesIndexesCreate(ctx context.Context, request operations.FirestoreProjectsDatabasesIndexesCreateRequest) (*operations.FirestoreProjectsDatabasesIndexesCreateResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) FirestoreProjectsDatabasesIndexesDelete(ctx context.Context, request operations.FirestoreProjectsDatabasesIndexesDeleteRequest) (*operations.FirestoreProjectsDatabasesIndexesDeleteResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1beta1/{name}", request.PathParams)
...
func (s *SDK) FirestoreProjectsDatabasesIndexesGet(ctx context.Context, request operations.FirestoreProjectsDatabasesIndexesGetRequest) (*operations.FirestoreProjectsDatabasesIndexesGetResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1beta1/{name}", request.PathParams)
...
func (s *SDK) FirestoreProjectsDatabasesIndexesList(ctx context.Context, request operations.FirestoreProjectsDatabasesIndexesListRequest) (*operations.FirestoreProjectsDatabasesIndexesListResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/v1beta1/{parent}/indexes", request.PathParams)
