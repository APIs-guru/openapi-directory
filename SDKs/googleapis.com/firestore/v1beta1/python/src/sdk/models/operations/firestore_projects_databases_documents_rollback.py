...
@dataclass
class FirestoreProjectsDatabasesDocumentsRollbackQueryParams:
...
class FirestoreProjectsDatabasesDocumentsRollbackSecurity:
    option1: Optional[FirestoreProjectsDatabasesDocumentsRollbackSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[FirestoreProjectsDatabasesDocumentsRollbackSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
