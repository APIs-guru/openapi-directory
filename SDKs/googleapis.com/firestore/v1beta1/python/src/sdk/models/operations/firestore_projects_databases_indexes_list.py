...
@dataclass
class FirestoreProjectsDatabasesIndexesListQueryParams:
...
class FirestoreProjectsDatabasesIndexesListSecurity:
    option1: Optional[FirestoreProjectsDatabasesIndexesListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[FirestoreProjectsDatabasesIndexesListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
