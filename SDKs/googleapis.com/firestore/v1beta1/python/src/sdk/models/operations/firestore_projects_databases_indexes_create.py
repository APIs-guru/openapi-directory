...
@dataclass
class FirestoreProjectsDatabasesIndexesCreateQueryParams:
...
@dataclass
class FirestoreProjectsDatabasesIndexesCreateSecurity:
    option1: Optional[FirestoreProjectsDatabasesIndexesCreateSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[FirestoreProjectsDatabasesIndexesCreateSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
