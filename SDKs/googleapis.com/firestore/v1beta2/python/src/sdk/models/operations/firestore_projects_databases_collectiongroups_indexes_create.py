...
class FirestoreProjectsDatabasesCollectionGroupsIndexesCreateRequest:
    path_params: FirestoreProjectsDatabasesCollectionGroupsIndexesCreatePathParams = field(default=None)
    query_params: FirestoreProjectsDatabasesCollectionGroupsIndexesCreateQueryParams = field(default=None)
    request: Optional[shared.GoogleFirestoreAdminV1beta2Index] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: FirestoreProjectsDatabasesCollectionGroupsIndexesCreateSecurity = field(default=None)
