...
var RunQueryRequest = /** @class */ (function (_super) {
    ...
    ], RunQueryRequest.prototype, "newTransaction", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=readTime" }),
        __metadata("design:type", String)
    ], RunQueryRequest.prototype, "readTime", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=structuredQuery" }),
        __metadata("design:type", StructuredQuery)
    ], RunQueryRequest.prototype, "structuredQuery", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=transaction" }),
        __metadata("design:type", String)
    ], RunQueryRequest.prototype, "transaction", void 0);
