...
@dataclass
class FirestoreProjectsDatabasesDocumentsRunAggregationQueryQueryParams:
...
class FirestoreProjectsDatabasesDocumentsRunAggregationQuerySecurity:
    option1: Optional[FirestoreProjectsDatabasesDocumentsRunAggregationQuerySecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[FirestoreProjectsDatabasesDocumentsRunAggregationQuerySecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
