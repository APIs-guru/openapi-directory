...
class FirestoreProjectsDatabasesDocumentsPartitionQueryRequest:
    path_params: FirestoreProjectsDatabasesDocumentsPartitionQueryPathParams = field(default=None)
    query_params: FirestoreProjectsDatabasesDocumentsPartitionQueryQueryParams = field(default=None)
    request: Optional[shared.PartitionQueryRequest] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: FirestoreProjectsDatabasesDocumentsPartitionQuerySecurity = field(default=None)
