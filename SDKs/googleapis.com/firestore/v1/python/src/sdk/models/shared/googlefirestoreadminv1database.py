...
class GoogleFirestoreAdminV1Database:
    app_engine_integration_mode: Optional[GoogleFirestoreAdminV1DatabaseAppEngineIntegrationModeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'appEngineIntegrationMode' }})
    concurrency_mode: Optional[GoogleFirestoreAdminV1DatabaseConcurrencyModeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'concurrencyMode' }})
    ...
    type: Optional[GoogleFirestoreAdminV1DatabaseTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'type' }})
