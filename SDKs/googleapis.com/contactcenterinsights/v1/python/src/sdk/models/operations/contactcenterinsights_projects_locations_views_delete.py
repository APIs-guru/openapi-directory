...
class ContactcenterinsightsProjectsLocationsViewsDeleteRequest:
    path_params: ContactcenterinsightsProjectsLocationsViewsDeletePathParams = field()
    query_params: ContactcenterinsightsProjectsLocationsViewsDeleteQueryParams = field()
    security: ContactcenterinsightsProjectsLocationsViewsDeleteSecurity = field()
