...
class ContactcenterinsightsProjectsLocationsIssueModelsCalculateIssueModelStatsPathParams:
    issue_model: str = field(metadata={'path_param': { 'field_name': 'issueModel', 'style': 'simple', 'explode': False }})
...
class ContactcenterinsightsProjectsLocationsIssueModelsCalculateIssueModelStatsRequest:
    path_params: ContactcenterinsightsProjectsLocationsIssueModelsCalculateIssueModelStatsPathParams = field()
    query_params: ContactcenterinsightsProjectsLocationsIssueModelsCalculateIssueModelStatsQueryParams = field()
    security: ContactcenterinsightsProjectsLocationsIssueModelsCalculateIssueModelStatsSecurity = field()
