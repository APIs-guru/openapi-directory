...
type ContactcenterinsightsProjectsLocationsPhraseMatchersCreatePathParams struct {
	Parent string `pathParam:"style=simple,explode=false,name=parent"`
}

type ContactcenterinsightsProjectsLocationsPhraseMatchersCreateQueryParams struct {
...
type ContactcenterinsightsProjectsLocationsPhraseMatchersCreateSecurity struct {
...
type ContactcenterinsightsProjectsLocationsPhraseMatchersCreateResponse struct {
	ContentType                                     string
