...
class GoogleCloudVideointelligenceV1p3beta1LabelDetectionConfig:
    ...
    label_detection_mode: Optional[GoogleCloudVideointelligenceV1p3beta1LabelDetectionConfigLabelDetectionModeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'labelDetectionMode' }})
