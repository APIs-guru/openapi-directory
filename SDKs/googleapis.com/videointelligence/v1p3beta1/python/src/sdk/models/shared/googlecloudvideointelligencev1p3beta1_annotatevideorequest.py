...
from . import googlecloudvideointelligencev1p3beta1_videocontext
...
class GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest:
    features: Optional[List[GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequestFeaturesEnum]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'features' }})
    ...
    video_context: Optional[googlecloudvideointelligencev1p3beta1_videocontext.GoogleCloudVideointelligenceV1p3beta1VideoContext] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'videoContext' }})
