...
class GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequest:
    ...
    features: Optional[List[GoogleCloudVideointelligenceV1p3beta1AnnotateVideoRequestFeaturesEnum]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('features') }})
    ...
    video_context: Optional[GoogleCloudVideointelligenceV1p3beta1VideoContext] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('videoContext') }})
