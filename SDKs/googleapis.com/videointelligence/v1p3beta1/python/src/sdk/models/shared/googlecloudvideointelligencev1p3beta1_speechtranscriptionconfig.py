...
from . import googlecloudvideointelligencev1p3beta1_speechcontext
...
class GoogleCloudVideointelligenceV1p3beta1SpeechTranscriptionConfig:
    ...
    speech_contexts: Optional[List[googlecloudvideointelligencev1p3beta1_speechcontext.GoogleCloudVideointelligenceV1p3beta1SpeechContext]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'speechContexts' }})
