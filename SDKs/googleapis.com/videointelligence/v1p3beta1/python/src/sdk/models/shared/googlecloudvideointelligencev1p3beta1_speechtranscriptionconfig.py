...
class GoogleCloudVideointelligenceV1p3beta1SpeechTranscriptionConfig:
    ...
    speech_contexts: Optional[List[GoogleCloudVideointelligenceV1p3beta1SpeechContext]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('speechContexts') }})
