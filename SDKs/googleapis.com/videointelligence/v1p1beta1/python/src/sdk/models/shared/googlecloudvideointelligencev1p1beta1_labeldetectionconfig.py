...
class GoogleCloudVideointelligenceV1p1beta1LabelDetectionConfig:
    ...
    label_detection_mode: Optional[GoogleCloudVideointelligenceV1p1beta1LabelDetectionConfigLabelDetectionModeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'labelDetectionMode' }})
