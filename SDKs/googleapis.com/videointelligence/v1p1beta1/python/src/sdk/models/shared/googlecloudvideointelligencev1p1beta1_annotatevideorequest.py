...
from . import googlecloudvideointelligencev1p1beta1_videocontext
...
class GoogleCloudVideointelligenceV1p1beta1AnnotateVideoRequest:
    features: Optional[List[GoogleCloudVideointelligenceV1p1beta1AnnotateVideoRequestFeaturesEnum]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'features' }})
    ...
    video_context: Optional[googlecloudvideointelligencev1p1beta1_videocontext.GoogleCloudVideointelligenceV1p1beta1VideoContext] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'videoContext' }})
