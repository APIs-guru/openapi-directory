...
from . import googlecloudvideointelligencev1p1beta1_speechcontext
...
class GoogleCloudVideointelligenceV1p1beta1SpeechTranscriptionConfig:
    ...
    speech_contexts: Optional[List[googlecloudvideointelligencev1p1beta1_speechcontext.GoogleCloudVideointelligenceV1p1beta1SpeechContext]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'speechContexts' }})
