...
class GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig:
    ...
    speech_contexts: Optional[List[GoogleCloudVideointelligenceV1beta2SpeechContext]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('speechContexts') }})
