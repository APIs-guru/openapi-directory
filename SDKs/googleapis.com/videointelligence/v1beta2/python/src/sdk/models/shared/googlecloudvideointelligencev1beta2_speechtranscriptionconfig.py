...
from . import googlecloudvideointelligencev1beta2_speechcontext
...
class GoogleCloudVideointelligenceV1beta2SpeechTranscriptionConfig:
    ...
    speech_contexts: Optional[List[googlecloudvideointelligencev1beta2_speechcontext.GoogleCloudVideointelligenceV1beta2SpeechContext]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'speechContexts' }})
