...
class GoogleCloudVideointelligenceV1beta2LabelDetectionConfig:
    ...
    label_detection_mode: Optional[GoogleCloudVideointelligenceV1beta2LabelDetectionConfigLabelDetectionModeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'labelDetectionMode' }})
