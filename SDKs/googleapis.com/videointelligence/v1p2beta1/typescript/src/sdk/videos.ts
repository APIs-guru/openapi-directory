...
export class Videos {
  ...
  **/
  videointelligenceVideosAnnotate(
    ...
    const url: string = baseURL.replace(/\/$/, "") + "/v1p2beta1/videos:annotate";
    ...
    return client
      .request({
        ...
        const res: operations.VideointelligenceVideosAnnotateResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
