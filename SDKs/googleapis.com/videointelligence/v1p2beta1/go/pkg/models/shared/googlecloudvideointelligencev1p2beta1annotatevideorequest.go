...
type GoogleCloudVideointelligenceV1p2beta1AnnotateVideoRequest struct {
	Features     []GoogleCloudVideointelligenceV1p2beta1AnnotateVideoRequestFeaturesEnum `json:"features"`
	InputContent *string                                                                 `json:"inputContent"`
	InputURI     *string                                                                 `json:"inputUri"`
	LocationID   *string                                                                 `json:"locationId"`
	OutputURI    *string                                                                 `json:"outputUri"`
	VideoContext *GoogleCloudVideointelligenceV1p2beta1VideoContext                      `json:"videoContext"`
}
