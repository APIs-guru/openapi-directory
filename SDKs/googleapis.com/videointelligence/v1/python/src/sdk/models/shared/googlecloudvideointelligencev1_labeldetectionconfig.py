...
class GoogleCloudVideointelligenceV1LabelDetectionConfig:
    ...
    label_detection_mode: Optional[GoogleCloudVideointelligenceV1LabelDetectionConfigLabelDetectionModeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('labelDetectionMode') }})
