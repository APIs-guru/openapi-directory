...
class GoogleCloudVideointelligenceV1SpeechTranscriptionConfig:
    r"""GoogleCloudVideointelligenceV1SpeechTranscriptionConfig
    ...
    speech_contexts: Optional[List[GoogleCloudVideointelligenceV1SpeechContext]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('speechContexts') }})
