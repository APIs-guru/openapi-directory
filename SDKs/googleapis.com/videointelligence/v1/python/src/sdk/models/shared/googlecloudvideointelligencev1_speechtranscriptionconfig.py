...
from . import googlecloudvideointelligencev1_speechcontext
...
class GoogleCloudVideointelligenceV1SpeechTranscriptionConfig:
    ...
    speech_contexts: Optional[List[googlecloudvideointelligencev1_speechcontext.GoogleCloudVideointelligenceV1SpeechContext]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'speechContexts' }})
