...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.VideointelligenceOperationsProjectsLocationsOperationsCancel = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.VideointelligenceOperationsProjectsLocationsOperationsCancelRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/operations/{name}:cancel", req.pathParams);
    ...
    SDK.prototype.VideointelligenceOperationsProjectsLocationsOperationsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.VideointelligenceOperationsProjectsLocationsOperationsDeleteRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/operations/{name}", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.VideointelligenceOperationsProjectsLocationsOperationsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.VideointelligenceOperationsProjectsLocationsOperationsGetRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/operations/{name}", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
    ...
    SDK.prototype.VideointelligenceProjectsLocationsOperationsCancel = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.VideointelligenceProjectsLocationsOperationsCancelRequest(req);
        }
        var baseURL = this.serverURL;
    ...
    SDK.prototype.VideointelligenceProjectsLocationsOperationsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.VideointelligenceProjectsLocationsOperationsDeleteRequest(req);
        }
        var baseURL = this.serverURL;
    ...
    SDK.prototype.VideointelligenceProjectsLocationsOperationsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.VideointelligenceProjectsLocationsOperationsGetRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{name}", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
    ...
    SDK.prototype.VideointelligenceProjectsLocationsOperationsList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.VideointelligenceProjectsLocationsOperationsListRequest(req);
        }
        var baseURL = this.serverURL;
    ...
    SDK.prototype.VideointelligenceVideosAnnotate = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v1/videos:annotate";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
