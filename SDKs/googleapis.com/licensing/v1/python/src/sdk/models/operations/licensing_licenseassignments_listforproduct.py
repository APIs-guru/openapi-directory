...
class LicensingLicenseAssignmentsListForProductRequest:
    path_params: LicensingLicenseAssignmentsListForProductPathParams = field()
    query_params: LicensingLicenseAssignmentsListForProductQueryParams = field()
    security: LicensingLicenseAssignmentsListForProductSecurity = field()
