...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.LicensingLicenseAssignmentsDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.LicensingLicenseAssignmentsDeleteRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/apps/licensing/v1/product/{productId}/sku/{skuId}/user/{userId}", req.pathParams);
    ...
    SDK.prototype.LicensingLicenseAssignmentsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) {
                case 200:
                    if (MatchContentType(contentType, "application/json")) {
                        res.licenseAssignment = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.LicensingLicenseAssignmentsInsert = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.LicensingLicenseAssignmentsInsertRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/apps/licensing/v1/product/{productId}/sku/{skuId}/user", req.pathParams);
    ...
    SDK.prototype.LicensingLicenseAssignmentsListForProduct = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.LicensingLicenseAssignmentsListForProductRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/apps/licensing/v1/product/{productId}/users", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
            ...
            switch (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) {
                case 200:
                    if (MatchContentType(contentType, "application/json")) {
                        res.licenseAssignmentList = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.LicensingLicenseAssignmentsListForProductAndSku = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.LicensingLicenseAssignmentsListForProductAndSkuRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/apps/licensing/v1/product/{productId}/sku/{skuId}/users", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.LicensingLicenseAssignmentsPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.LicensingLicenseAssignmentsUpdate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
