...
@dataclass
class FirebasedatabaseProjectsLocationsInstancesDeleteQueryParams:
...
@dataclass
class FirebasedatabaseProjectsLocationsInstancesDeleteSecurity:
    option1: Optional[FirebasedatabaseProjectsLocationsInstancesDeleteSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[FirebasedatabaseProjectsLocationsInstancesDeleteSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
