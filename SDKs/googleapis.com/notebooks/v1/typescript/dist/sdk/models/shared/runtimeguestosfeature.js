...
**/
var RuntimeGuestOsFeature = /** @class */ (function (_super) {
    __extends(RuntimeGuestOsFeature, _super);
    function RuntimeGuestOsFeature() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "json, name=type" }),
        __metadata("design:type", String)
    ], RuntimeGuestOsFeature.prototype, "type", void 0);
    return RuntimeGuestOsFeature;
}(SpeakeasyBase));
export { RuntimeGuestOsFeature };
