...
**/
var UpgradeRuntimeRequest = /** @class */ (function (_super) {
    __extends(UpgradeRuntimeRequest, _super);
    function UpgradeRuntimeRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=requestId" }),
        __metadata("design:type", String)
    ], UpgradeRuntimeRequest.prototype, "requestId", void 0);
    return UpgradeRuntimeRequest;
}(SpeakeasyBase));
export { UpgradeRuntimeRequest };
