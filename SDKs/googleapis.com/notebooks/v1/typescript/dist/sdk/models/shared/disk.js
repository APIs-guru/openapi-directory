...
var Disk = /** @class */ (function (_super) {
    ...
    ], Disk.prototype, "autoDelete", void 0);
    __decorate([
        Metadata({ data: "json, name=boot" }),
        __metadata("design:type", Boolean)
    ], Disk.prototype, "boot", void 0);
    __decorate([
        Metadata({ data: "json, name=deviceName" }),
        __metadata("design:type", String)
    ], Disk.prototype, "deviceName", void 0);
    __decorate([
        Metadata({ data: "json, name=diskSizeGb" }),
        __metadata("design:type", String)
    ], Disk.prototype, "diskSizeGb", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], Disk.prototype, "mode", void 0);
    __decorate([
        Metadata({ data: "json, name=source" }),
        __metadata("design:type", String)
    ], Disk.prototype, "source", void 0);
    __decorate([
