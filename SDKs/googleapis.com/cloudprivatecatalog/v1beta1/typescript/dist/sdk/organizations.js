...
var Organizations = /** @class */ (function () {
    ...
    **/
    Organizations.prototype.cloudprivatecatalogOrganizationsCatalogsSearch = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CloudprivatecatalogOrganizationsCatalogsSearchRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta1/{resource}/catalogs:search", req.pathParams);
     ...
     * scope of the consumer cloud resource hierarchy context.
    **/
    Organizations.prototype.cloudprivatecatalogOrganizationsProductsSearch = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CloudprivatecatalogOrganizationsProductsSearchRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta1/{resource}/products:search", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
     ...
     * scope of the consumer cloud resource hierarchy context.
    **/
    Organizations.prototype.cloudprivatecatalogOrganizationsVersionsSearch = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CloudprivatecatalogOrganizationsVersionsSearchRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta1/{resource}/versions:search", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
