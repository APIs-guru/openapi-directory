...
**/
var EnterpriseCrmCardsTemplatesAplosSeriesListData = /** @class */ (function (_super) {
    __extends(EnterpriseCrmCardsTemplatesAplosSeriesListData, _super);
    function EnterpriseCrmCardsTemplatesAplosSeriesListData() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=series", elemType: EnterpriseCrmCardsTemplatesAplosSeriesListDataSeries }),
        __metadata("design:type", Array)
    ], EnterpriseCrmCardsTemplatesAplosSeriesListData.prototype, "series", void 0);
    return EnterpriseCrmCardsTemplatesAplosSeriesListData;
}(SpeakeasyBase));
export { EnterpriseCrmCardsTemplatesAplosSeriesListData };
