...
**/
var GoogleCloudIntegrationsV1alphaListTaskEntitiesResponse = /** @class */ (function (_super) {
    __extends(GoogleCloudIntegrationsV1alphaListTaskEntitiesResponse, _super);
    function GoogleCloudIntegrationsV1alphaListTaskEntitiesResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=taskEntities", elemType: EnterpriseCrmFrontendsEventbusProtoTaskEntity }),
        __metadata("design:type", Array)
    ], GoogleCloudIntegrationsV1alphaListTaskEntitiesResponse.prototype, "taskEntities", void 0);
    return GoogleCloudIntegrationsV1alphaListTaskEntitiesResponse;
}(SpeakeasyBase));
export { GoogleCloudIntegrationsV1alphaListTaskEntitiesResponse };
