...
**/
var EnterpriseCrmFrontendsEventbusProtoEventParameters = /** @class */ (function (_super) {
    __extends(EnterpriseCrmFrontendsEventbusProtoEventParameters, _super);
    function EnterpriseCrmFrontendsEventbusProtoEventParameters() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=parameters", elemType: EnterpriseCrmFrontendsEventbusProtoParameterEntry }),
        __metadata("design:type", Array)
    ], EnterpriseCrmFrontendsEventbusProtoEventParameters.prototype, "parameters", void 0);
    return EnterpriseCrmFrontendsEventbusProtoEventParameters;
}(SpeakeasyBase));
export { EnterpriseCrmFrontendsEventbusProtoEventParameters };
