...
**/
var EnterpriseCrmCardsTemplatesAplosSeriesData = /** @class */ (function (_super) {
    __extends(EnterpriseCrmCardsTemplatesAplosSeriesData, _super);
    function EnterpriseCrmCardsTemplatesAplosSeriesData() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=rows", elemType: EnterpriseCrmCardsTemplatesAplosSeriesDataRow }),
        __metadata("design:type", Array)
    ], EnterpriseCrmCardsTemplatesAplosSeriesData.prototype, "rows", void 0);
    return EnterpriseCrmCardsTemplatesAplosSeriesData;
}(SpeakeasyBase));
export { EnterpriseCrmCardsTemplatesAplosSeriesData };
