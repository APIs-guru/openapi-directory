...
var Callback = /** @class */ (function () {
    ...
    **/
    Callback.prototype.integrationsCallbackGenerateToken = function (req, config) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.googleCloudIntegrationsV1alphaGenerateTokenResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
