...
class GoogleCloudIntegrationsV1alphaOAuth2ClientCredentials:
    ...
    request_type: Optional[GoogleCloudIntegrationsV1alphaOAuth2ClientCredentialsRequestTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'requestType' }})
