...
@dataclass
class IntegrationsCallbackGenerateTokenQueryParams:
    ...
    gcp_project_id: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'gcpProjectId', 'style': 'form', 'explode': True }})
    key: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'key', 'style': 'form', 'explode': True }})
    oauth_token: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'oauth_token', 'style': 'form', 'explode': True }})
    pretty_print: Optional[bool] = field(default=None, metadata={'query_param': { 'field_name': 'prettyPrint', 'style': 'form', 'explode': True }})
    product: Optional[IntegrationsCallbackGenerateTokenProductEnum] = field(default=None, metadata={'query_param': { 'field_name': 'product', 'style': 'form', 'explode': True }})
    quota_user: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'quotaUser', 'style': 'form', 'explode': True }})
    redirect_uri: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'redirectUri', 'style': 'form', 'explode': True }})
