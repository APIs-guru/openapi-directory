...
class IntegrationsProjectsLocationsProductsIntegrationsExecuteRequest:
    path_params: IntegrationsProjectsLocationsProductsIntegrationsExecutePathParams = field()
    query_params: IntegrationsProjectsLocationsProductsIntegrationsExecuteQueryParams = field()
    security: IntegrationsProjectsLocationsProductsIntegrationsExecuteSecurity = field()
