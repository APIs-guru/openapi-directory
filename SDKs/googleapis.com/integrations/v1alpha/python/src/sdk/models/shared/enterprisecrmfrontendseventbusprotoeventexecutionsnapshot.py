...
class EnterpriseCrmFrontendsEventbusProtoEventExecutionSnapshot:
    ...
    diff_params: Optional[enterprisecrmfrontendseventbusprotoeventparameters.EnterpriseCrmFrontendsEventbusProtoEventParameters] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'diffParams' }})
    ...
    event_params: Optional[enterprisecrmfrontendseventbusprotoeventparameters.EnterpriseCrmFrontendsEventbusProtoEventParameters] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'eventParams' }})
