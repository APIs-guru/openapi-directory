...
class EnterpriseCrmFrontendsEventbusProtoEventExecutionDetails:
    r"""EnterpriseCrmFrontendsEventbusProtoEventExecutionDetails
    ...
    event_execution_snapshot: Optional[List[EnterpriseCrmFrontendsEventbusProtoEventExecutionSnapshot]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('eventExecutionSnapshot') }})
    event_execution_state: Optional[EnterpriseCrmFrontendsEventbusProtoEventExecutionDetailsEventExecutionStateEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('eventExecutionState') }})
