...
class EnterpriseCrmEventbusProtoEventExecutionSnapshot:
    r"""EnterpriseCrmEventbusProtoEventExecutionSnapshot
    ...
    diff_params: Optional[EnterpriseCrmEventbusProtoEventParameters] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('diffParams') }})
    ...
    event_params: Optional[EnterpriseCrmEventbusProtoEventParameters] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('eventParams') }})
    exceed_max_size: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('exceedMaxSize') }})
