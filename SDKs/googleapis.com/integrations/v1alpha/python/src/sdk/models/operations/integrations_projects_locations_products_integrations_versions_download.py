...
class IntegrationsProjectsLocationsProductsIntegrationsVersionsDownloadRequest:
    path_params: IntegrationsProjectsLocationsProductsIntegrationsVersionsDownloadPathParams = field()
    query_params: IntegrationsProjectsLocationsProductsIntegrationsVersionsDownloadQueryParams = field()
    security: IntegrationsProjectsLocationsProductsIntegrationsVersionsDownloadSecurity = field()
