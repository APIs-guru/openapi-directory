...
class IntegrationsProjectsLocationsProductsCreateBundleRequest:
    path_params: IntegrationsProjectsLocationsProductsCreateBundlePathParams = field()
    query_params: IntegrationsProjectsLocationsProductsCreateBundleQueryParams = field()
    security: IntegrationsProjectsLocationsProductsCreateBundleSecurity = field()
