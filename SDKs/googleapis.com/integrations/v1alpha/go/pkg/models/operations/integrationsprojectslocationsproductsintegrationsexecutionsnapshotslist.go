...
type IntegrationsProjectsLocationsProductsIntegrationsExecutionsnapshotsListPathParams struct {
    Parent string `pathParam:"style=simple,explode=false,name=parent"`
    
}

type IntegrationsProjectsLocationsProductsIntegrationsExecutionsnapshotsListQueryParams struct {
...
type IntegrationsProjectsLocationsProductsIntegrationsExecutionsnapshotsListSecurity struct {
    Oauth2 shared.SchemeOauth2 `security:"scheme,type=oauth2"`
    Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
    
}

type IntegrationsProjectsLocationsProductsIntegrationsExecutionsnapshotsListRequest struct {
...
type IntegrationsProjectsLocationsProductsIntegrationsExecutionsnapshotsListResponse struct {
    ContentType string 
