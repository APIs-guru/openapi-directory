...
func (s *SDK) AcceleratedmobilepageurlAmpUrlsBatchGet(ctx context.Context, request operations.AcceleratedmobilepageurlAmpUrlsBatchGetRequest) (*operations.AcceleratedmobilepageurlAmpUrlsBatchGetResponse, error) {
	baseURL := s.serverURL
