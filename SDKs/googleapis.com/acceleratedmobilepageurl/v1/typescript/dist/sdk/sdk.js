...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.AcceleratedmobilepageurlAmpUrlsBatchGet = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AcceleratedmobilepageurlAmpUrlsBatchGetRequest(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v1/ampUrls:batchGet";
            ...
            switch (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) {
                case 200:
                    if (MatchContentType(contentType, "application/json")) {
                        res.batchGetAmpUrlsResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
