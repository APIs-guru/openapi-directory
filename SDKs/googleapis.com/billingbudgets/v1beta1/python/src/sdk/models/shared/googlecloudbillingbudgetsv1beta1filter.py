...
from . import googlecloudbillingbudgetsv1beta1customperiod
...
class GoogleCloudBillingBudgetsV1beta1Filter:
    calendar_period: Optional[GoogleCloudBillingBudgetsV1beta1FilterCalendarPeriodEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'calendarPeriod' }})
    credit_types: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'creditTypes' }})
    credit_types_treatment: Optional[GoogleCloudBillingBudgetsV1beta1FilterCreditTypesTreatmentEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'creditTypesTreatment' }})
    custom_period: Optional[googlecloudbillingbudgetsv1beta1customperiod.GoogleCloudBillingBudgetsV1beta1CustomPeriod] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'customPeriod' }})
