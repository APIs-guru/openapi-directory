...
var BillingAccounts = /** @class */ (function () {
    ...
    **/
    BillingAccounts.prototype.billingbudgetsBillingAccountsBudgetsCreate = function (req, config) {
        ...
        var url = utils.GenerateURL(baseURL, "/v1beta1/{parent}/budgets", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.googleCloudBillingBudgetsV1beta1Budget = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    BillingAccounts.prototype.billingbudgetsBillingAccountsBudgetsList = function (req, config) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.googleCloudBillingBudgetsV1beta1ListBudgetsResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
