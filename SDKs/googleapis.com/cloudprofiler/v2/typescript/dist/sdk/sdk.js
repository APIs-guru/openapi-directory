...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.CloudprofilerProjectsProfilesCreate = function (req, config) {
        var _a;
    ...
    SDK.prototype.CloudprofilerProjectsProfilesCreateOffline = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.CloudprofilerProjectsProfilesPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
