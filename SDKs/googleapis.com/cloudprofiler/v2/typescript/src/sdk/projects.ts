...
export class Projects {
  ...
  **/
  cloudprofilerProjectsProfilesCreate(
  ...
  ): Promise<operations.CloudprofilerProjectsProfilesCreateResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.CloudprofilerProjectsProfilesCreateRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{parent}/profiles", req.pathParams);
    ...
    return client
      .request({
        ...
        const res: operations.CloudprofilerProjectsProfilesCreateResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  **/
  cloudprofilerProjectsProfilesCreateOffline(
    req: operations.CloudprofilerProjectsProfilesCreateOfflineRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.CloudprofilerProjectsProfilesCreateOfflineResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.CloudprofilerProjectsProfilesCreateOfflineRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/v2/{parent}/profiles:createOffline", req.pathParams);
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.CloudprofilerProjectsProfilesCreateOfflineResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.profile = httpRes?.data;
  ...
  **/
  cloudprofilerProjectsProfilesPatch(
    req: operations.CloudprofilerProjectsProfilesPatchRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.CloudprofilerProjectsProfilesPatchResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.CloudprofilerProjectsProfilesPatchResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.profile = httpRes?.data;
