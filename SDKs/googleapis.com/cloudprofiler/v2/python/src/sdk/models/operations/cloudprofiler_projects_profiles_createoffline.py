...
class CloudprofilerProjectsProfilesCreateOfflineSecurity:
    option1: Optional[CloudprofilerProjectsProfilesCreateOfflineSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[CloudprofilerProjectsProfilesCreateOfflineSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[CloudprofilerProjectsProfilesCreateOfflineSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
