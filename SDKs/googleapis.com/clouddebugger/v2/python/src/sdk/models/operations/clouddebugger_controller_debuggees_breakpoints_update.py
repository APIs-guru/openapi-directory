...
@dataclass
class ClouddebuggerControllerDebuggeesBreakpointsUpdateQueryParams:
...
class ClouddebuggerControllerDebuggeesBreakpointsUpdateSecurity:
    option1: Optional[ClouddebuggerControllerDebuggeesBreakpointsUpdateSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[ClouddebuggerControllerDebuggeesBreakpointsUpdateSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
