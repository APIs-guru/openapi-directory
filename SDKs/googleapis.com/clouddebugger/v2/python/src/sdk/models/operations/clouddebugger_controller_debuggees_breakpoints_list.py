...
@dataclass
class ClouddebuggerControllerDebuggeesBreakpointsListQueryParams:
    dollar_xgafv: Optional[shared.XgafvEnum] = field(default=None, metadata={'query_param': { 'field_name': '$.xgafv', 'style': 'form', 'explode': True }})
    access_token: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'access_token', 'style': 'form', 'explode': True }})
    agent_id: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'agentId', 'style': 'form', 'explode': True }})
    ...
    success_on_timeout: Optional[bool] = field(default=None, metadata={'query_param': { 'field_name': 'successOnTimeout', 'style': 'form', 'explode': True }})
...
class ClouddebuggerControllerDebuggeesBreakpointsListSecurity:
    option1: Optional[ClouddebuggerControllerDebuggeesBreakpointsListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[ClouddebuggerControllerDebuggeesBreakpointsListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
