...
@dataclass
class GmailUsersSettingsSendAsSmimeInfoInsertQueryParams:
...
@dataclass
class GmailUsersSettingsSendAsSmimeInfoInsertSecurity:
    option1: Optional[GmailUsersSettingsSendAsSmimeInfoInsertSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[GmailUsersSettingsSendAsSmimeInfoInsertSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
