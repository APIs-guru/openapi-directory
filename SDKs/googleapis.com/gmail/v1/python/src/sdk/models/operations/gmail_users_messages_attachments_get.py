...
class GmailUsersMessagesAttachmentsGetRequest:
    path_params: GmailUsersMessagesAttachmentsGetPathParams = field()
    query_params: GmailUsersMessagesAttachmentsGetQueryParams = field()
    security: GmailUsersMessagesAttachmentsGetSecurity = field()
