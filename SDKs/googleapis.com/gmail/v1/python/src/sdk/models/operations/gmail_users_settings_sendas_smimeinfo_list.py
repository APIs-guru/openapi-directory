...
@dataclass
class GmailUsersSettingsSendAsSmimeInfoListQueryParams:
...
@dataclass
class GmailUsersSettingsSendAsSmimeInfoListSecurity:
    option1: Optional[GmailUsersSettingsSendAsSmimeInfoListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[GmailUsersSettingsSendAsSmimeInfoListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[GmailUsersSettingsSendAsSmimeInfoListSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
    option4: Optional[GmailUsersSettingsSendAsSmimeInfoListSecurityOption4] = field(default=None, metadata={'security': { 'option': True }})
    option5: Optional[GmailUsersSettingsSendAsSmimeInfoListSecurityOption5] = field(default=None, metadata={'security': { 'option': True }})
