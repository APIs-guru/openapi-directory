...
@dataclass
class GmailUsersMessagesModifyQueryParams:
...
@dataclass
class GmailUsersMessagesModifySecurity:
    option1: Optional[GmailUsersMessagesModifySecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[GmailUsersMessagesModifySecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
