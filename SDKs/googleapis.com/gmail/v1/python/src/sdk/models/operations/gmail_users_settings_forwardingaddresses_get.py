...
@dataclass
class GmailUsersSettingsForwardingAddressesGetQueryParams:
...
@dataclass
class GmailUsersSettingsForwardingAddressesGetSecurity:
    option1: Optional[GmailUsersSettingsForwardingAddressesGetSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[GmailUsersSettingsForwardingAddressesGetSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[GmailUsersSettingsForwardingAddressesGetSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
    option4: Optional[GmailUsersSettingsForwardingAddressesGetSecurityOption4] = field(default=None, metadata={'security': { 'option': True }})
