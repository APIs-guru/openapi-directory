...
class GmailUsersSettingsFiltersGetRequest:
    path_params: GmailUsersSettingsFiltersGetPathParams = field()
    query_params: GmailUsersSettingsFiltersGetQueryParams = field()
    security: GmailUsersSettingsFiltersGetSecurity = field()
