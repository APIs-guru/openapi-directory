...
class GmailUsersDraftsGetRequest:
    path_params: GmailUsersDraftsGetPathParams = field(default=None)
    query_params: GmailUsersDraftsGetQueryParams = field(default=None)
    security: GmailUsersDraftsGetSecurity = field(default=None)
