...
class GmailUsersSettingsForwardingAddressesListRequest:
    path_params: GmailUsersSettingsForwardingAddressesListPathParams = field(default=None)
    query_params: GmailUsersSettingsForwardingAddressesListQueryParams = field(default=None)
    security: GmailUsersSettingsForwardingAddressesListSecurity = field(default=None)
