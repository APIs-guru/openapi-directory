...
class GmailUsersMessagesImportRequest:
    path_params: GmailUsersMessagesImportPathParams = field(default=None)
    query_params: GmailUsersMessagesImportQueryParams = field(default=None)
    request: Optional[GmailUsersMessagesImportRequests] = field(default=None)
    security: GmailUsersMessagesImportSecurity = field(default=None)
