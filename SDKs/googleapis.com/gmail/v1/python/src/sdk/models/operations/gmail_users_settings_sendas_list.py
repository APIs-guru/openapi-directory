...
class GmailUsersSettingsSendAsListRequest:
    path_params: GmailUsersSettingsSendAsListPathParams = field()
    query_params: GmailUsersSettingsSendAsListQueryParams = field()
    security: GmailUsersSettingsSendAsListSecurity = field()
