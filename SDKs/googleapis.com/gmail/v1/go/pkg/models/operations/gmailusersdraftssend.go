...
type GmailUsersDraftsSendPathParams struct {
    UserID string `pathParam:"style=simple,explode=false,name=userId"`
    
}

type GmailUsersDraftsSendQueryParams struct {
...
type GmailUsersDraftsSendRequests struct {
...
type GmailUsersDraftsSendSecurityOption1 struct {
    Oauth2 shared.SchemeOauth2 `security:"scheme,type=oauth2"`
    Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
    
}

type GmailUsersDraftsSendSecurityOption2 struct {
    Oauth2 shared.SchemeOauth2 `security:"scheme,type=oauth2"`
    Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
    
}

type GmailUsersDraftsSendSecurityOption3 struct {
    Oauth2 shared.SchemeOauth2 `security:"scheme,type=oauth2"`
    Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
    
}

type GmailUsersDraftsSendSecurityOption4 struct {
    Oauth2 shared.SchemeOauth2 `security:"scheme,type=oauth2"`
    Oauth2c shared.SchemeOauth2c `security:"scheme,type=oauth2"`
    
}

type GmailUsersDraftsSendSecurity struct {
    Option1 *GmailUsersDraftsSendSecurityOption1 `security:"option"`
    Option2 *GmailUsersDraftsSendSecurityOption2 `security:"option"`
    Option3 *GmailUsersDraftsSendSecurityOption3 `security:"option"`
    Option4 *GmailUsersDraftsSendSecurityOption4 `security:"option"`
    
}

type GmailUsersDraftsSendRequest struct {
...
type GmailUsersDraftsSendResponse struct {
    ContentType string 
