...
export var DelegateVerificationStatusEnum;
(function (DelegateVerificationStatusEnum) {
...
})(DelegateVerificationStatusEnum || (DelegateVerificationStatusEnum = {}));
// Delegate
/**
...
var Delegate = /** @class */ (function (_super) {
    ...
    ], Delegate.prototype, "delegateEmail", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=verificationStatus" }),
        __metadata("design:type", String)
    ], Delegate.prototype, "verificationStatus", void 0);
    return Delegate;
}(SpeakeasyBase));
export { Delegate };
