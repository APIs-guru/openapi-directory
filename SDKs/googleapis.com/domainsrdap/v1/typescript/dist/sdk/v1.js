...
var V1 = /** @class */ (function () {
    ...
    **/
    V1.prototype.domainsrdapGetDomains = function (req, config) {
    ...
    **/
    V1.prototype.domainsrdapGetEntities = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    V1.prototype.domainsrdapGetHelp = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DomainsrdapGetHelpRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v1/help";
        var client = this._defaultClient;
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    V1.prototype.domainsrdapGetIp = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DomainsrdapGetIpRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v1/ip";
        var client = this._defaultClient;
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    **/
    V1.prototype.domainsrdapGetNameservers = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DomainsrdapGetNameserversRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v1/nameservers";
        var client = this._defaultClient;
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
