...
class PubsubTopicsPublishSecurity:
    option1: Optional[PubsubTopicsPublishSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[PubsubTopicsPublishSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
