...
class PubsubSubscriptionsPullBatchSecurity:
    option1: Optional[PubsubSubscriptionsPullBatchSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[PubsubSubscriptionsPullBatchSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
