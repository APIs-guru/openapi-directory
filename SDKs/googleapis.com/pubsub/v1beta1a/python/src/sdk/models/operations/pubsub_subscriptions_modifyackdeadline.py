...
class PubsubSubscriptionsModifyAckDeadlineSecurity:
    option1: Optional[PubsubSubscriptionsModifyAckDeadlineSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[PubsubSubscriptionsModifyAckDeadlineSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
