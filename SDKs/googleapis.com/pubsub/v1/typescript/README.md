...
import { PubsubProjectsSchemasCreateRequest, PubsubProjectsSchemasCreateResponse } from "openapi/src/sdk/models/operations";
import { AxiosError } from "axios";


const sdk = new SDK();
    
const req: PubsubProjectsSchemasCreateRequest = {
  security: {
    option1: {
      oauth2: {
...
sdk.projects.pubsubProjectsSchemasCreate(req).then((res: PubsubProjectsSchemasCreateResponse | AxiosError) => {
   // handle response
});
```
