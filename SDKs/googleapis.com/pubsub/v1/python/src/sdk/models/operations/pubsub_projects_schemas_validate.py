...
@dataclass
class PubsubProjectsSchemasValidateQueryParams:
...
@dataclass
class PubsubProjectsSchemasValidateSecurity:
    option1: Optional[PubsubProjectsSchemasValidateSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[PubsubProjectsSchemasValidateSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
