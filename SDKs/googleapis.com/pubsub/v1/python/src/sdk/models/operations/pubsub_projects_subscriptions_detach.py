...
@dataclass
class PubsubProjectsSubscriptionsDetachQueryParams:
...
@dataclass
class PubsubProjectsSubscriptionsDetachSecurity:
    option1: Optional[PubsubProjectsSubscriptionsDetachSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[PubsubProjectsSubscriptionsDetachSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
