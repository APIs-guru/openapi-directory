...
@dataclass
class PubsubProjectsSchemasDeleteQueryParams:
...
@dataclass
class PubsubProjectsSchemasDeleteSecurity:
    option1: Optional[PubsubProjectsSchemasDeleteSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[PubsubProjectsSchemasDeleteSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
