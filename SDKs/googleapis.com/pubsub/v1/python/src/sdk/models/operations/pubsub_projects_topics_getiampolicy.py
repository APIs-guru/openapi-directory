...
class PubsubProjectsTopicsGetIamPolicyRequest:
    path_params: PubsubProjectsTopicsGetIamPolicyPathParams = field()
    query_params: PubsubProjectsTopicsGetIamPolicyQueryParams = field()
    security: PubsubProjectsTopicsGetIamPolicySecurity = field()
