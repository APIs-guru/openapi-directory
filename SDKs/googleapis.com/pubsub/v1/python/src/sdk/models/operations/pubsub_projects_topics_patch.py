...
@dataclass
class PubsubProjectsTopicsPatchQueryParams:
...
@dataclass
class PubsubProjectsTopicsPatchSecurity:
    option1: Optional[PubsubProjectsTopicsPatchSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[PubsubProjectsTopicsPatchSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
