...
@dataclass
class PubsubProjectsSubscriptionsListQueryParams:
...
@dataclass
class PubsubProjectsSubscriptionsListSecurity:
    option1: Optional[PubsubProjectsSubscriptionsListSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[PubsubProjectsSubscriptionsListSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
