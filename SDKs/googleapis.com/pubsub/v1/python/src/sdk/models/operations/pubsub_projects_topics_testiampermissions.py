...
@dataclass
class PubsubProjectsTopicsTestIamPermissionsQueryParams:
...
@dataclass
class PubsubProjectsTopicsTestIamPermissionsSecurity:
    option1: Optional[PubsubProjectsTopicsTestIamPermissionsSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[PubsubProjectsTopicsTestIamPermissionsSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
