...
@dataclass
class PubsubProjectsSubscriptionsModifyPushConfigQueryParams:
...
@dataclass
class PubsubProjectsSubscriptionsModifyPushConfigSecurity:
    option1: Optional[PubsubProjectsSubscriptionsModifyPushConfigSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[PubsubProjectsSubscriptionsModifyPushConfigSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
