...
func main() {
    ...
    req := operations.PubsubProjectsSubscriptionsAcknowledgeRequest{
        ...
        PathParams: operations.PubsubProjectsSubscriptionsAcknowledgePathParams{
            Subscription: "cupiditate",
        },
        QueryParams: operations.PubsubProjectsSubscriptionsAcknowledgeQueryParams{
            DollarXgafv: "2",
    ...
    res, err := s.Projects.PubsubProjectsSubscriptionsAcknowledge(ctx, req)
    if err != nil {
        log.Fatal(err)
    }
