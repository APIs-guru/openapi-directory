...
class BigqueryreservationProjectsLocationsReservationsAssignmentsMoveRequest:
    path_params: BigqueryreservationProjectsLocationsReservationsAssignmentsMovePathParams = field()
    query_params: BigqueryreservationProjectsLocationsReservationsAssignmentsMoveQueryParams = field()
    security: BigqueryreservationProjectsLocationsReservationsAssignmentsMoveSecurity = field()
