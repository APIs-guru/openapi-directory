...
func (s *Projects) BigqueryreservationProjectsLocationsSearchAllAssignments(ctx context.Context, request operations.BigqueryreservationProjectsLocationsSearchAllAssignmentsRequest) (*operations.BigqueryreservationProjectsLocationsSearchAllAssignmentsResponse, error) {
	baseURL := s._serverURL
