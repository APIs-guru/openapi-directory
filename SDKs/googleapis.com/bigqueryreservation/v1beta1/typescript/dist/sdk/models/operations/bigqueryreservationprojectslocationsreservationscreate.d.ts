...
export declare class BigqueryreservationProjectsLocationsReservationsCreatePathParams extends SpeakeasyBase {
    parent: string;
}
export declare class BigqueryreservationProjectsLocationsReservationsCreateQueryParams extends SpeakeasyBase {
