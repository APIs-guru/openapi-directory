...
class BigqueryreservationProjectsLocationsReservationsCreateRequest:
    path_params: BigqueryreservationProjectsLocationsReservationsCreatePathParams = field(default=None)
    query_params: BigqueryreservationProjectsLocationsReservationsCreateQueryParams = field(default=None)
    request: Optional[shared.Reservation] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: BigqueryreservationProjectsLocationsReservationsCreateSecurity = field(default=None)
