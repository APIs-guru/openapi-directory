...
class BigqueryreservationProjectsLocationsSearchAssignmentsSecurity:
    option1: Optional[BigqueryreservationProjectsLocationsSearchAssignmentsSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[BigqueryreservationProjectsLocationsSearchAssignmentsSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
