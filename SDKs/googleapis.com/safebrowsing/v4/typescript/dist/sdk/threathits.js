...
var ThreatHits = /** @class */ (function () {
    function ThreatHits(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    ThreatHits.prototype.safebrowsingThreatHitsCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.SafebrowsingThreatHitsCreateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v4/threatHits";
