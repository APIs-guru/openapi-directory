...
var V1p4beta1 = /** @class */ (function () {
    ...
    **/
    V1p4beta1.prototype.cloudassetAnalyzeIamPolicy = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CloudassetAnalyzeIamPolicyRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1p4beta1/{parent}:analyzeIamPolicy", req.pathParams);
    ...
    **/
    V1p4beta1.prototype.cloudassetExportIamPolicyAnalysis = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CloudassetExportIamPolicyAnalysisRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1p4beta1/{parent}:exportIamPolicyAnalysis", req.pathParams);
