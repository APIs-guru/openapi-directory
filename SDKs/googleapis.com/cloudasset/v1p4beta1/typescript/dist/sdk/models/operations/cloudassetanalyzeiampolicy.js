...
var CloudassetAnalyzeIamPolicyPathParams = /** @class */ (function (_super) {
    ...
    ], CloudassetAnalyzeIamPolicyPathParams.prototype, "parent", void 0);
...
var CloudassetAnalyzeIamPolicyQueryParams = /** @class */ (function (_super) {
    ...
    ], CloudassetAnalyzeIamPolicyQueryParams.prototype, "optionsAnalyzeServiceAccountImpersonation", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=options.executionTimeout" }),
        __metadata("design:type", String)
    ], CloudassetAnalyzeIamPolicyQueryParams.prototype, "optionsExecutionTimeout", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=options.expandGroups" }),
        __metadata("design:type", Boolean)
    ], CloudassetAnalyzeIamPolicyQueryParams.prototype, "optionsExpandGroups", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=options.expandResources" }),
        __metadata("design:type", Boolean)
    ], CloudassetAnalyzeIamPolicyQueryParams.prototype, "optionsExpandResources", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=options.expandRoles" }),
        __metadata("design:type", Boolean)
    ], CloudassetAnalyzeIamPolicyQueryParams.prototype, "optionsExpandRoles", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=options.outputGroupEdges" }),
        __metadata("design:type", Boolean)
    ], CloudassetAnalyzeIamPolicyQueryParams.prototype, "optionsOutputGroupEdges", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=options.outputResourceEdges" }),
        __metadata("design:type", Boolean)
    ], CloudassetAnalyzeIamPolicyQueryParams.prototype, "optionsOutputResourceEdges", void 0);
    __decorate([
