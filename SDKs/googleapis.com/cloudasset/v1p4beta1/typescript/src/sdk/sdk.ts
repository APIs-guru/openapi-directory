  ...
  CloudassetAnalyzeIamPolicy(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        let res: operations.CloudassetAnalyzeIamPolicyResponse = {statusCode: httpRes.status, contentType: contentType};
  ...
  CloudassetExportIamPolicyAnalysis(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.CloudassetExportIamPolicyAnalysisResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
