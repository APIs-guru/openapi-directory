...
export class CloudassetAnalyzeIamPolicyQueryParams extends SpeakeasyBase {
  ...
  @Metadata({ data: "queryParam, style=form;explode=true;name=options.analyzeServiceAccountImpersonation" })
  optionsAnalyzeServiceAccountImpersonation?: boolean;

  @Metadata({ data: "queryParam, style=form;explode=true;name=options.executionTimeout" })
  optionsExecutionTimeout?: string;

  @Metadata({ data: "queryParam, style=form;explode=true;name=options.expandGroups" })
  optionsExpandGroups?: boolean;

  @Metadata({ data: "queryParam, style=form;explode=true;name=options.expandResources" })
  optionsExpandResources?: boolean;

  @Metadata({ data: "queryParam, style=form;explode=true;name=options.expandRoles" })
  optionsExpandRoles?: boolean;

  @Metadata({ data: "queryParam, style=form;explode=true;name=options.outputGroupEdges" })
  optionsOutputGroupEdges?: boolean;

  @Metadata({ data: "queryParam, style=form;explode=true;name=options.outputResourceEdges" })
