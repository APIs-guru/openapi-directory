...
class CloudassetProjectsBatchGetAssetsHistoryRequest:
    path_params: CloudassetProjectsBatchGetAssetsHistoryPathParams = field()
    query_params: CloudassetProjectsBatchGetAssetsHistoryQueryParams = field()
    security: CloudassetProjectsBatchGetAssetsHistorySecurity = field()
