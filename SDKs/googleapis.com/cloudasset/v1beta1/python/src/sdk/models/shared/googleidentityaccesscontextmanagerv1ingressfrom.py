...
class GoogleIdentityAccesscontextmanagerV1IngressFrom:
    ...
    identity_type: Optional[GoogleIdentityAccesscontextmanagerV1IngressFromIdentityTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('identityType') }})
    sources: Optional[List[GoogleIdentityAccesscontextmanagerV1IngressSource]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sources') }})
