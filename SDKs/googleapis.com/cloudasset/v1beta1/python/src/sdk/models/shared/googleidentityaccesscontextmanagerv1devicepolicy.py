...
class GoogleIdentityAccesscontextmanagerV1DevicePolicy:
    ...
    allowed_device_management_levels: Optional[List[GoogleIdentityAccesscontextmanagerV1DevicePolicyAllowedDeviceManagementLevelsEnum]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('allowedDeviceManagementLevels') }})
    allowed_encryption_statuses: Optional[List[GoogleIdentityAccesscontextmanagerV1DevicePolicyAllowedEncryptionStatusesEnum]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('allowedEncryptionStatuses') }})
    os_constraints: Optional[List[GoogleIdentityAccesscontextmanagerV1OsConstraint]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('osConstraints') }})
