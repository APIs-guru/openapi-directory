...
var Projects = /** @class */ (function () {
    ...
    **/
    Projects.prototype.cloudassetProjectsBatchGetAssetsHistory = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CloudassetProjectsBatchGetAssetsHistoryRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta1/{parent}:batchGetAssetsHistory", req.pathParams);
    ...
    **/
    Projects.prototype.cloudassetProjectsExportAssets = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CloudassetProjectsExportAssetsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1beta1/{parent}:exportAssets", req.pathParams);
    ...
    **/
    Projects.prototype.cloudassetProjectsOperationsGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
