...
func (s *SDK) CloudassetOperationsGet(ctx context.Context, request operations.CloudassetOperationsGetRequest) (*operations.CloudassetOperationsGetResponse, error) {
	baseURL := s.serverURL
