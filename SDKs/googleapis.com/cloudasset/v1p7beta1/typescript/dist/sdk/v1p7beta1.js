...
var V1p7beta1 = /** @class */ (function () {
    function V1p7beta1(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    V1p7beta1.prototype.cloudassetExportAssets = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CloudassetExportAssetsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1p7beta1/{parent}:exportAssets", req.pathParams);
