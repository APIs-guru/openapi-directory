...
class GoogleCloudOrgpolicyV1ListPolicy:
    r"""GoogleCloudOrgpolicyV1ListPolicy
    ...
    all_values: Optional[GoogleCloudOrgpolicyV1ListPolicyAllValuesEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('allValues') }})
