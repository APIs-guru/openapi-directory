...
**/
var RelatedAssets = /** @class */ (function (_super) {
    __extends(RelatedAssets, _super);
    ...
    ], RelatedAssets.prototype, "assets", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=relationshipAttributes" }),
        __metadata("design:type", RelationshipAttributes)
    ], RelatedAssets.prototype, "relationshipAttributes", void 0);
    return RelatedAssets;
}(SpeakeasyBase));
export { RelatedAssets };
