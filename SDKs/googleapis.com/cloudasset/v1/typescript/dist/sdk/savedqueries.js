...
var SavedQueries = /** @class */ (function () {
    function SavedQueries(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    SavedQueries.prototype.cloudassetSavedQueriesCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CloudassetSavedQueriesCreateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/{parent}/savedQueries", req.pathParams);
    ...
    **/
    SavedQueries.prototype.cloudassetSavedQueriesDelete = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SavedQueries.prototype.cloudassetSavedQueriesGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SavedQueries.prototype.cloudassetSavedQueriesList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SavedQueries.prototype.cloudassetSavedQueriesPatch = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
