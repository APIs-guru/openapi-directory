...
from . import windowsupdatecategory


@dataclass_json
@dataclass
class WindowsUpdatePackage:
    categories: Optional[List[windowsupdatecategory.WindowsUpdateCategory]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'categories' }})
