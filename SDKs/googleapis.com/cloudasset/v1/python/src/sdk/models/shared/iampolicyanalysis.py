...
class IamPolicyAnalysis:
    ...
    non_critical_errors: Optional[List[iampolicyanalysisstate.IamPolicyAnalysisState]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'nonCriticalErrors' }})
