...
@dataclass
class CloudassetBatchGetAssetsHistoryQueryParams:
    ...
    content_type: Optional[CloudassetBatchGetAssetsHistoryContentTypeEnum] = field(default=None, metadata={'query_param': { 'field_name': 'contentType', 'style': 'form', 'explode': True }})
