...
class IamPolicyAnalysisResult:
    ...
    access_control_lists: Optional[List[GoogleCloudAssetV1AccessControlList]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('accessControlLists') }})
    ...
    identity_list: Optional[GoogleCloudAssetV1IdentityList] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('identityList') }})
