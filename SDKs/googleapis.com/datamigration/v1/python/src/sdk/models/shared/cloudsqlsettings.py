...
class CloudSQLSettingsInput:
    ...
    availability_type: Optional[CloudSQLSettingsAvailabilityTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('availabilityType') }})
