...
**/
var AlloyDbConnectionProfile = /** @class */ (function (_super) {
    __extends(AlloyDbConnectionProfile, _super);
    function AlloyDbConnectionProfile() {
 ...
 * Specifies required connection parameters, and the parameters required to create an AlloyDB destination cluster.
**/
var AlloyDbConnectionProfileInput = /** @class */ (function (_super) {
    __extends(AlloyDbConnectionProfileInput, _super);
    function AlloyDbConnectionProfileInput() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=clusterId" }),
