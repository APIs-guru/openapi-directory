  ...
  GetV1VerificationResult(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        let res: operations.GetV1VerificationResultResponse = {statusCode: httpRes.status, contentType: contentType};
  ...
  PostV1VerificationSend(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.PostV1VerificationSendResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json; charset=utf-8`)) {
