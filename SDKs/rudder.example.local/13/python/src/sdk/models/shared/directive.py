...
class Directive:
    ...
    policy_mode: Optional[DirectivePolicyModeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'policyMode' }})
    ...
    tags: Optional[List[DirectiveTags]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'tags' }})
