...
export var ChartDataFilterOpEnum;
(function (ChartDataFilterOpEnum) {
    ChartDataFilterOpEnum["EqualEqual"] = "==";
    ChartDataFilterOpEnum["NotEqual"] = "!=";
    ChartDataFilterOpEnum["GreaterThan"] = ">";
    ChartDataFilterOpEnum["LessThan"] = "<";
    ChartDataFilterOpEnum["GreaterThanEqual"] = ">=";
    ChartDataFilterOpEnum["LessThanEqual"] = "<=";
...
})(ChartDataFilterOpEnum || (ChartDataFilterOpEnum = {}));
var ChartDataFilter = /** @class */ (function (_super) {
    __extends(ChartDataFilter, _super);
    ...
    ], ChartDataFilter.prototype, "col", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=op" }),
        __metadata("design:type", String)
    ], ChartDataFilter.prototype, "op", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=val" }),
        __metadata("design:type", Object)
    ], ChartDataFilter.prototype, "val", void 0);
    return ChartDataFilter;
}(SpeakeasyBase));
export { ChartDataFilter };
