...
class GetQueryRelatedColumnNameRequest:
    path_params: GetQueryRelatedColumnNamePathParams = field(default=None)
    query_params: GetQueryRelatedColumnNameQueryParams = field(default=None)
    security: GetQueryRelatedColumnNameSecurity = field(default=None)
