...
class GetDatasetInfoRequest:
    query_params: GetDatasetInfoQueryParams = field(default=None)
    security: GetDatasetInfoSecurity = field(default=None)
...
class GetDatasetInfo200ApplicationJSONFilters:
    column_name: Optional[List[GetDatasetInfo200ApplicationJSONFiltersColumnName]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'column_name' }})
...
class GetDatasetInfo200ApplicationJSON:
    ...
    filters: Optional[GetDatasetInfo200ApplicationJSONFilters] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'filters' }})
