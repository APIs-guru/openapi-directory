...
class GetAnnotationLayerInfo200ApplicationJSONFilters:
    column_name: Optional[List[GetAnnotationLayerInfo200ApplicationJSONFiltersColumnName]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('column_name') }})
...
class GetAnnotationLayerInfo200ApplicationJSON:
    ...
    filters: Optional[GetAnnotationLayerInfo200ApplicationJSONFilters] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('filters') }})
...
class GetAnnotationLayerInfoRequest:
    query_params: GetAnnotationLayerInfoQueryParams = field()
    security: GetAnnotationLayerInfoSecurity = field()
