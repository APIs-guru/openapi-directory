...
class GetDashboardInfo200ApplicationJSONFilters:
    column_name: Optional[List[GetDashboardInfo200ApplicationJSONFiltersColumnName]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('column_name') }})
...
class GetDashboardInfo200ApplicationJSON:
    ...
    filters: Optional[GetDashboardInfo200ApplicationJSONFilters] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('filters') }})
...
class GetDashboardInfoRequest:
    query_params: GetDashboardInfoQueryParams = field()
    security: GetDashboardInfoSecurity = field()
