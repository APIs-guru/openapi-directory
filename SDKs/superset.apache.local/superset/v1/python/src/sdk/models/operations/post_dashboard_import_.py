...
class PostDashboardImportRequest:
    request: PostDashboardImportRequestBody = field(default=None, metadata={'request': { 'media_type': 'multipart/form-data' }})
    security: PostDashboardImportSecurity = field(default=None)
