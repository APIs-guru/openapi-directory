...
class PutDatabasePkRequest:
    path_params: PutDatabasePkPathParams = field(default=None)
    request: shared.DatabaseRestAPIPut = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    security: PutDatabasePkSecurity = field(default=None)
...
class PutDatabasePk200ApplicationJSON:
    ...
    result: Optional[shared.DatabaseRestAPIPut] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'result' }})
