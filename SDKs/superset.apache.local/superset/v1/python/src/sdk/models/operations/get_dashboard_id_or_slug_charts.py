...
class GetDashboardIDOrSlugCharts200ApplicationJSON:
    result: Optional[List[shared.ChartEntityResponseSchema]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('result') }})
...
class GetDashboardIDOrSlugChartsRequest:
    path_params: GetDashboardIDOrSlugChartsPathParams = field()
    security: GetDashboardIDOrSlugChartsSecurity = field()
