...
class GetDatasetPkRequest:
    path_params: GetDatasetPkPathParams = field(default=None)
    query_params: GetDatasetPkQueryParams = field(default=None)
    security: GetDatasetPkSecurity = field(default=None)
...
class GetDatasetPk200ApplicationJSON:
    description_columns: Optional[GetDatasetPk200ApplicationJSONDescriptionColumns] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'description_columns' }})
    id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'id' }})
    label_columns: Optional[GetDatasetPk200ApplicationJSONLabelColumns] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'label_columns' }})
    result: Optional[shared.DatasetRestAPIGet] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'result' }})
