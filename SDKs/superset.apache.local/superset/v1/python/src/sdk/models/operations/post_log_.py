...
class PostLog201ApplicationJSON:
    ...
    result: Optional[shared.LogRestAPIPost] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('result') }})
...
class PostLogRequest:
    request: shared.LogRestAPIPost = field(metadata={'request': { 'media_type': 'application/json' }})
    security: PostLogSecurity = field()
