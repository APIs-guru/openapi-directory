...
class GetChartInfo200ApplicationJSONFilters:
    column_name: Optional[List[GetChartInfo200ApplicationJSONFiltersColumnName]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('column_name') }})
...
class GetChartInfo200ApplicationJSON:
    ...
    filters: Optional[GetChartInfo200ApplicationJSONFilters] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('filters') }})
...
class GetChartInfoRequest:
    query_params: GetChartInfoQueryParams = field()
    security: GetChartInfoSecurity = field()
