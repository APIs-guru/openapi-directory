...
class GetReportRelatedColumnNameRequest:
    path_params: GetReportRelatedColumnNamePathParams = field(default=None)
    query_params: GetReportRelatedColumnNameQueryParams = field(default=None)
    security: GetReportRelatedColumnNameSecurity = field(default=None)
