...
class GetSavedQuery200ApplicationJSON:
    ...
    description_columns: Optional[GetSavedQuery200ApplicationJSONDescriptionColumns] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('description_columns') }})
    ids: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ids') }})
    label_columns: Optional[GetSavedQuery200ApplicationJSONLabelColumns] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('label_columns') }})
    ...
    result: Optional[List[shared.SavedQueryRestAPIGetList]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('result') }})
...
class GetSavedQueryRequest:
    query_params: GetSavedQueryQueryParams = field()
    security: GetSavedQuerySecurity = field()
