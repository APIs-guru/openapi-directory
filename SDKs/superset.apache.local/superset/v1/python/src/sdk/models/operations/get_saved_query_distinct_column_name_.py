...
class GetSavedQueryDistinctColumnNameRequest:
    path_params: GetSavedQueryDistinctColumnNamePathParams = field(default=None)
    query_params: GetSavedQueryDistinctColumnNameQueryParams = field(default=None)
    security: GetSavedQueryDistinctColumnNameSecurity = field(default=None)
