...
class GetCSSTemplateInfoRequest:
    query_params: GetCSSTemplateInfoQueryParams = field(default=None)
    security: GetCSSTemplateInfoSecurity = field(default=None)
...
class GetCSSTemplateInfo200ApplicationJSONFilters:
    column_name: Optional[List[GetCSSTemplateInfo200ApplicationJSONFiltersColumnName]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'column_name' }})
...
class GetCSSTemplateInfo200ApplicationJSON:
    ...
    filters: Optional[GetCSSTemplateInfo200ApplicationJSONFilters] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'filters' }})
