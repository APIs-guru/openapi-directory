...
class GetChartRequest:
    query_params: GetChartQueryParams = field(default=None)
    security: GetChartSecurity = field(default=None)
...
class GetChart200ApplicationJSON:
    ...
    description_columns: Optional[GetChart200ApplicationJSONDescriptionColumns] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'description_columns' }})
    ids: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ids' }})
    label_columns: Optional[GetChart200ApplicationJSONLabelColumns] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'label_columns' }})
    ...
    result: Optional[List[shared.ChartRestAPIGetList]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'result' }})
