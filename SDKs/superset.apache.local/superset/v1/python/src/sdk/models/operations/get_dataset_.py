...
class GetDatasetRequest:
    query_params: GetDatasetQueryParams = field(default=None)
...
class GetDataset200ApplicationJSON:
    ...
    description_columns: Optional[GetDataset200ApplicationJSONDescriptionColumns] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'description_columns' }})
    ids: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ids' }})
    label_columns: Optional[GetDataset200ApplicationJSONLabelColumns] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'label_columns' }})
    ...
    result: Optional[List[shared.DatasetRestAPIGetList]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'result' }})
