...
class GetDashboardIDOrSlug200ApplicationJSON:
    result: Optional[shared.DashboardGetResponseSchema] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('result') }})
...
class GetDashboardIDOrSlugRequest:
    path_params: GetDashboardIDOrSlugPathParams = field()
    security: GetDashboardIDOrSlugSecurity = field()
