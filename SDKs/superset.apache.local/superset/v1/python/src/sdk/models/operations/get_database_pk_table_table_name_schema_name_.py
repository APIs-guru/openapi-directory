...
class GetDatabasePkTableTableNameSchemaNameRequest:
    path_params: GetDatabasePkTableTableNameSchemaNamePathParams = field(default=None)
    security: GetDatabasePkTableTableNameSchemaNameSecurity = field(default=None)
