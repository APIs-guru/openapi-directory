...
class GetSavedQueryInfoRequest:
    query_params: GetSavedQueryInfoQueryParams = field(default=None)
    security: GetSavedQueryInfoSecurity = field(default=None)
...
class GetSavedQueryInfo200ApplicationJSONFilters:
    column_name: Optional[List[GetSavedQueryInfo200ApplicationJSONFiltersColumnName]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'column_name' }})
...
class GetSavedQueryInfo200ApplicationJSON:
    ...
    filters: Optional[GetSavedQueryInfo200ApplicationJSONFilters] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'filters' }})
