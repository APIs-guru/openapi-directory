...
class DashboardDatasetSchema:
    ...
    column_formats: Optional[dict[str, Any]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'column_formats' }})
    column_types: Optional[List[int]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'column_types' }})
    columns: Optional[List[dict[str, Any]]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'columns' }})
    ...
    edit_url: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'edit_url' }})
    fetch_values_predicate: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'fetch_values_predicate' }})
    filter_select: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'filter_select' }})
    filter_select_enabled: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'filter_select_enabled' }})
    granularity_sqla: Optional[List[List[str]]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'granularity_sqla' }})
    health_check_message: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'health_check_message' }})
    ...
    metrics: Optional[List[dict[str, Any]]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'metrics' }})
    name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'name' }})
    offset: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'offset' }})
    order_by_choices: Optional[List[List[str]]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'order_by_choices' }})
    ...
    perm: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'perm' }})
    schema: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'schema' }})
    select_star: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'select_star' }})
    ...
    time_grain_sqla: Optional[List[List[str]]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'time_grain_sqla' }})
    type: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'type' }})
    uid: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'uid' }})
    verbose_map: Optional[dict[str, str]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'verbose_map' }})
