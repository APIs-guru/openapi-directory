...
class GetDashboardPkThumbnailDigestRequest:
    path_params: GetDashboardPkThumbnailDigestPathParams = field(default=None)
    query_params: GetDashboardPkThumbnailDigestQueryParams = field(default=None)
    security: GetDashboardPkThumbnailDigestSecurity = field(default=None)
