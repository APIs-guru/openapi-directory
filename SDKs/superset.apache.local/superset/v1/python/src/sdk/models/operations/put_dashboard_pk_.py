...
class PutDashboardPk200ApplicationJSON:
    ...
    result: Optional[shared.DashboardRestAPIPut] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('result') }})
...
class PutDashboardPkRequest:
    path_params: PutDashboardPkPathParams = field()
    request: shared.DashboardRestAPIPut = field(metadata={'request': { 'media_type': 'application/json' }})
    security: PutDashboardPkSecurity = field()
