...
class DatabaseRestAPIGet:
    ...
    sqlalchemy_uri: str = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('sqlalchemy_uri') }})
    ...
    configuration_method: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('configuration_method') }})
    ...
    parameters: Optional[Any] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('parameters') }})
