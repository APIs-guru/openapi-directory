...
class PutChartPk200ApplicationJSON:
    ...
    result: Optional[shared.ChartRestAPIPut] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('result') }})
...
class PutChartPkRequest:
    path_params: PutChartPkPathParams = field()
    request: shared.ChartRestAPIPut = field(metadata={'request': { 'media_type': 'application/json' }})
    security: PutChartPkSecurity = field()
