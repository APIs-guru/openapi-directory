...
class PostSavedQuery201ApplicationJSON:
    ...
    result: Optional[shared.SavedQueryRestAPIPost] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('result') }})
...
class PostSavedQueryRequest:
    request: shared.SavedQueryRestAPIPost = field(metadata={'request': { 'media_type': 'application/json' }})
    security: PostSavedQuerySecurity = field()
