...
class GetReportPk200ApplicationJSON:
    description_columns: Optional[GetReportPk200ApplicationJSONDescriptionColumns] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('description_columns') }})
    id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('id') }})
    label_columns: Optional[GetReportPk200ApplicationJSONLabelColumns] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('label_columns') }})
    result: Optional[shared.ReportScheduleRestAPIGet] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('result') }})
...
class GetReportPkRequest:
    path_params: GetReportPkPathParams = field()
    query_params: GetReportPkQueryParams = field()
    security: GetReportPkSecurity = field()
