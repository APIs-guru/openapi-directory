...
class GetCSSTemplateRequest:
    query_params: GetCSSTemplateQueryParams = field(default=None)
    security: GetCSSTemplateSecurity = field(default=None)
...
class GetCSSTemplate200ApplicationJSON:
    ...
    description_columns: Optional[GetCSSTemplate200ApplicationJSONDescriptionColumns] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'description_columns' }})
    ids: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ids' }})
    label_columns: Optional[GetCSSTemplate200ApplicationJSONLabelColumns] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'label_columns' }})
    ...
    result: Optional[List[shared.CSSTemplateRestAPIGetList]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'result' }})
