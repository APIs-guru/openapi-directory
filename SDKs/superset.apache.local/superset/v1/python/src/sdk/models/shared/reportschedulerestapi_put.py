...
class ReportScheduleRestAPIPut:
    ...
    crontab: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('crontab') }})
    ...
    report_format: Optional[ReportScheduleRestAPIPutReportFormatEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('report_format') }})
    ...
    type: Optional[ReportScheduleRestAPIPutTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
    ...
    validator_type: Optional[ReportScheduleRestAPIPutValidatorTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('validator_type') }})
