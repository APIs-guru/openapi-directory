...
class ChartRestAPIGetList:
    ...
    changed_by: Optional[Meta8] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('changed_by') }})
    ...
    created_by: Optional[Meta5] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('created_by') }})
    datasource_id: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('datasource_id') }})
    datasource_name_text: Optional[Any] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('datasource_name_text') }})
    datasource_type: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('datasource_type') }})
    datasource_url: Optional[Any] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('datasource_url') }})
    description: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('description') }})
    description_markeddown: Optional[Any] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('description_markeddown') }})
    edit_url: Optional[Any] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('edit_url') }})
    id: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('id') }})
    owners: Optional[Meta7] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('owners') }})
    ...
    table: Optional[Meta6] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('table') }})
