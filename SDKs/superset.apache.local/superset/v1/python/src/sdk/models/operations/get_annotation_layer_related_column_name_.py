...
class GetAnnotationLayerRelatedColumnNameRequest:
    path_params: GetAnnotationLayerRelatedColumnNamePathParams = field()
    query_params: GetAnnotationLayerRelatedColumnNameQueryParams = field()
    security: GetAnnotationLayerRelatedColumnNameSecurity = field()
