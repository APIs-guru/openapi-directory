...
class GetChartRelatedColumnNameRequest:
    path_params: GetChartRelatedColumnNamePathParams = field()
    query_params: GetChartRelatedColumnNameQueryParams = field()
    security: GetChartRelatedColumnNameSecurity = field()
