...
var GetPredictedPointsQueryParams = /** @class */ (function (_super) {
    ...
    function GetPredictedPointsQueryParams() {
...
export { GetPredictedPointsQueryParams };
var GetPredictedPointsRequest = /** @class */ (function (_super) {
    __extends(GetPredictedPointsRequest, _super);
    function GetPredictedPointsRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata(),
...
export { GetPredictedPointsRequest };
var GetPredictedPointsResponse = /** @class */ (function (_super) {
    __extends(GetPredictedPointsResponse, _super);
    function GetPredictedPointsResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata(),
...
export { GetPredictedPointsResponse };
