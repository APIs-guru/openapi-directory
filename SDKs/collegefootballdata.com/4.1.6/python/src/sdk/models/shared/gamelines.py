...
class GameLinesLines:
    away_moneyline: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'awayMoneyline' }})
    formatted_spread: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'formattedSpread' }})
    home_moneyline: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'homeMoneyline' }})
    over_under: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'overUnder' }})
    over_under_open: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'overUnderOpen' }})
    ...
    spread_open: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'spreadOpen' }})
...
class GameLines:
    ...
    lines: Optional[List[GameLinesLines]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'lines' }})
