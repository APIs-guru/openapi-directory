...
@dataclass
class TeamRecord:
    away_games: Optional[TeamRecordAwayGames] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'awayGames' }})
    conference: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'conference' }})
    conference_games: Optional[TeamRecordConferenceGames] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'conferenceGames' }})
    division: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'division' }})
    home_games: Optional[TeamRecordHomeGames] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'homeGames' }})
    team: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'team' }})
    total: Optional[TeamRecordTotal] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'total' }})
