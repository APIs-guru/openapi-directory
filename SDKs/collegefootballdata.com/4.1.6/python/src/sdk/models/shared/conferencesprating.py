...
class ConferenceSpRatingDefense:
    ...
    havoc: Optional[ConferenceSpRatingDefenseHavoc] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('havoc') }})
...
class ConferenceSpRating:
    ...
    defense: Optional[ConferenceSpRatingDefense] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('defense') }})
    offense: Optional[ConferenceSpRatingOffense] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('offense') }})
    rating: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('rating') }})
    ...
    special_teams: Optional[ConferenceSpRatingSpecialTeams] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('specialTeams') }})
