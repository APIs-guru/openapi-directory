...
class RecruitHometownInfo:
    county_fips: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('countyFips') }})
...
class Recruit:
    ...
    committed_to: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('committedTo') }})
    ...
    hometown_info: Optional[RecruitHometownInfo] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('hometownInfo') }})
    ...
    ranking: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ranking') }})
    rating: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('rating') }})
    recruit_type: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('recruitType') }})
    school: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('school') }})
    stars: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('stars') }})
    state_province: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('stateProvince') }})
