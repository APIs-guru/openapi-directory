...
class TeamSpRatingDefense:
    ...
    havoc: Optional[TeamSpRatingDefenseHavoc] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'havoc' }})
...
class TeamSpRating:
    ...
    defense: Optional[TeamSpRatingDefense] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'defense' }})
    offense: Optional[TeamSpRatingOffense] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'offense' }})
    ranking: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ranking' }})
    rating: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'rating' }})
    ...
    special_teams: Optional[TeamSpRatingSpecialTeams] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'specialTeams' }})
