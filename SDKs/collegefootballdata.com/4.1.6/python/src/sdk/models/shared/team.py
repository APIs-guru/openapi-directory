...
@dataclass
class TeamLocation:
    capacity: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('capacity') }})
    ...
    year_constructed: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('year_constructed') }})
...
class Team:
    ...
    alt_color: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('alt_color') }})
    alt_name_1: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('alt_name_1') }})
    alt_name_2: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('alt_name_2') }})
    alt_name_3: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('alt_name_3') }})
    ...
    location: Optional[TeamLocation] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('location') }})
    logos: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('logos') }})
    mascot: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('mascot') }})
