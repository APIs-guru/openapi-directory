...
class PlayerSeasonPpa:
    average_ppa: Optional[PlayerSeasonPpaAveragePpa] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('averagePPA') }})
    ...
    total_ppa: Optional[PlayerSeasonPpaTotalPpa] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('totalPPA') }})
