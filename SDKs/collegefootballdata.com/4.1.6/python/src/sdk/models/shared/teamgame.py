...
class TeamGameTeams:
    ...
    stats: Optional[List[TeamGameTeamsStats]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'stats' }})
...
class TeamGame:
    ...
    teams: Optional[List[TeamGameTeams]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'teams' }})
