...
var PersonalityQueryParams = /** @class */ (function (_super) {
    ...
    function PersonalityQueryParams() {
...
export { PersonalityQueryParams };
var PersonalityRequest = /** @class */ (function (_super) {
    __extends(PersonalityRequest, _super);
...
export { PersonalityRequest };
var PersonalityResponse = /** @class */ (function (_super) {
    __extends(PersonalityResponse, _super);
    function PersonalityResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata(),
