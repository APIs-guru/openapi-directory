...
// NodesCreateNodeAttributes
/** 
 * The properties of the node entity.
**/
export class NodesCreateNodeAttributes extends SpeakeasyBase {
...
// NodesCreateNodeLinks
/** 
 * URLs to alternative representations of the node entity.
**/
export class NodesCreateNodeLinks extends SpeakeasyBase {
...
// NodesCreateNodeRelationships
/** 
 * URLs to other entities or entity collections that have a relationship to the node entity.
**/
export class NodesCreateNodeRelationships extends SpeakeasyBase {
...
export class NodesCreateNode extends SpeakeasyBase {
  @Metadata({ data: "json, name=attributes" })
  attributes: NodesCreateNodeAttributes;

  @Metadata({ data: "json, name=id" })
  id?: string;

  @Metadata({ data: "json, name=links" })
  links?: NodesCreateNodeLinks;

  @Metadata({ data: "json, name=relationships" })
  relationships?: NodesCreateNodeRelationships;
