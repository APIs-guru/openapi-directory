...
type PostRoutingVersionNumberCalculateRouteLocationsContentTypePathParams struct {
...
type PostRoutingVersionNumberCalculateRouteLocationsContentTypeQueryParams struct {
...
type PostRoutingVersionNumberCalculateRouteLocationsContentTypeRequests struct {
    ApplicationXML []byte `request:"mediaType=application/xml"`
    CalculateRoutePostDataParameters *shared.CalculateRoutePostDataParameters `request:"mediaType=application/json"`
    
}

type PostRoutingVersionNumberCalculateRouteLocationsContentTypeRequest struct {
...
type PostRoutingVersionNumberCalculateRouteLocationsContentTypeResponse struct {
    ContentType string 
    StatusCode int64 
