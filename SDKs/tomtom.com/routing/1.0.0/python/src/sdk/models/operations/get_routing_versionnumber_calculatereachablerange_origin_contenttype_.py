...
class GetRoutingVersionNumberCalculateReachableRangeOriginContentTypeQueryParams:
    ...
    vehicle_engine_type: Optional[GetRoutingVersionNumberCalculateReachableRangeOriginContentTypeVehicleEngineTypeEnum] = field(default=None, metadata={'query_param': { 'field_name': 'vehicleEngineType', 'style': 'form', 'explode': True }})
