...
export class GetSearchVersionNumberPoiSearchQueryExtPathParams extends SpeakeasyBase {
...
export class GetSearchVersionNumberPoiSearchQueryExtQueryParams extends SpeakeasyBase {
...
export class GetSearchVersionNumberPoiSearchQueryExtRequest extends SpeakeasyBase {
  @Metadata()
...
export class GetSearchVersionNumberPoiSearchQueryExtResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
