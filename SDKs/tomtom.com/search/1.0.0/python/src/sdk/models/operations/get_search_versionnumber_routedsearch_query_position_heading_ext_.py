...
class GetSearchVersionNumberRoutedSearchQueryPositionHeadingExtRequest:
    path_params: GetSearchVersionNumberRoutedSearchQueryPositionHeadingExtPathParams = field(default=None)
    query_params: GetSearchVersionNumberRoutedSearchQueryPositionHeadingExtQueryParams = field(default=None)
