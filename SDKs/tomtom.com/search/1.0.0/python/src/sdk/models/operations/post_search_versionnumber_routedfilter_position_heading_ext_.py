...
class PostSearchVersionNumberRoutedFilterPositionHeadingExtRequestBodyPoiList:
    address: Optional[PostSearchVersionNumberRoutedFilterPositionHeadingExtRequestBodyPoiListAddress] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'address' }})
    poi: Optional[PostSearchVersionNumberRoutedFilterPositionHeadingExtRequestBodyPoiListPoi] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'poi' }})
    position: Optional[PostSearchVersionNumberRoutedFilterPositionHeadingExtRequestBodyPoiListPosition] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'position' }})
    

@dataclass_json
@dataclass
class PostSearchVersionNumberRoutedFilterPositionHeadingExtRequestBody:
    poi_list: Optional[List[PostSearchVersionNumberRoutedFilterPositionHeadingExtRequestBodyPoiList]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'poiList' }})
    

@dataclass
class PostSearchVersionNumberRoutedFilterPositionHeadingExtRequest:
    path_params: PostSearchVersionNumberRoutedFilterPositionHeadingExtPathParams = field(default=None)
    query_params: PostSearchVersionNumberRoutedFilterPositionHeadingExtQueryParams = field(default=None)
