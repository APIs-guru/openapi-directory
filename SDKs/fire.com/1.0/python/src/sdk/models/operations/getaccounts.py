...
class GetAccountsAccountsAccountCurrency:
    code: Optional[GetAccountsAccountsAccountCurrencyCodeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'code' }})
...
class GetAccountsAccountsAccount:
    ...
    currency: Optional[GetAccountsAccountsAccountCurrency] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'currency' }})
    ...
    status: Optional[GetAccountsAccountsAccountStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
    

@dataclass_json
@dataclass
class GetAccountsAccounts:
    accounts: Optional[List[GetAccountsAccountsAccount]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'accounts' }})
