...
class OnebatchesGetResponses200ContentApplication1jsonSchemaPropertiesItemsItems:
    ...
    result: Optional[OnebatchesGetResponses200ContentApplication1jsonSchemaPropertiesItemsItemsResult] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'result' }})
    status: Optional[OnebatchesGetResponses200ContentApplication1jsonSchemaPropertiesItemsItemsStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
