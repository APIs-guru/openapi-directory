...
class OnedirectdebitsGetResponses200ContentApplication1jsonSchemaPropertiesDirectdebitsItems:
    ...
    scheme_reject_reason_code: Optional[OnedirectdebitsGetResponses200ContentApplication1jsonSchemaPropertiesDirectdebitsItemsSchemeRejectReasonCodeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'schemeRejectReasonCode' }})
    status: Optional[OnedirectdebitsGetResponses200ContentApplication1jsonSchemaPropertiesDirectdebitsItemsStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
    ...
    type: Optional[OnedirectdebitsGetResponses200ContentApplication1jsonSchemaPropertiesDirectdebitsItemsTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'type' }})
