...
class OnemandatesGetResponses200ContentApplication1jsonSchemaPropertiesMandatesItems:
    ...
    fire_rejection_reason: Optional[OnemandatesGetResponses200ContentApplication1jsonSchemaPropertiesMandatesItemsFireRejectionReasonEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'fireRejectionReason' }})
    ...
    status: Optional[OnemandatesGetResponses200ContentApplication1jsonSchemaPropertiesMandatesItemsStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
