...
@dataclass_json
@dataclass
class OnebatchesGetResponses200ContentApplication1jsonSchemaItemsResult:
    code: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'code' }})
    message: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'message' }})
    
class OnebatchesGetResponses200ContentApplication1jsonSchemaItemsStatusEnum(str, Enum):
    SUBMITTED = "SUBMITTED"
    REMOVED = "REMOVED"
    SUCCEEDED = "SUCCEEDED"
    FAILED = "FAILED"
...
@dataclass_json
@dataclass
class OnebatchesGetResponses200ContentApplication1jsonSchemaItemsBatchItem:
    ...
    result: Optional[OnebatchesGetResponses200ContentApplication1jsonSchemaItemsResult] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'result' }})
    status: Optional[OnebatchesGetResponses200ContentApplication1jsonSchemaItemsStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
...
class OnebatchesGetResponses200ContentApplication1jsonSchema:
    items: Optional[List[OnebatchesGetResponses200ContentApplication1jsonSchemaItemsBatchItem]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'items' }})
