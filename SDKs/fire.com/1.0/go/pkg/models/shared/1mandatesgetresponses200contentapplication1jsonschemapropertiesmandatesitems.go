...
type OnemandatesGetResponses200ContentApplication1jsonSchemaPropertiesMandatesItems struct {
	...
	FireRejectionReason          *OnemandatesGetResponses200ContentApplication1jsonSchemaPropertiesMandatesItemsFireRejectionReasonEnum `json:"fireRejectionReason"`
	...
	Status                       *OnemandatesGetResponses200ContentApplication1jsonSchemaPropertiesMandatesItemsStatusEnum              `json:"status"`
