...
export declare enum OnemandatesGetResponses200ContentApplication1jsonSchemaPropertiesMandatesItemsFireRejectionReasonEnum {
...
export declare enum OnemandatesGetResponses200ContentApplication1jsonSchemaPropertiesMandatesItemsStatusEnum {
    Created = "CREATED",
    Live = "LIVE",
...
export declare class OnemandatesGetResponses200ContentApplication1jsonSchemaPropertiesMandatesItems extends SpeakeasyBase {
    alias?: string;
