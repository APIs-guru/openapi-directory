...
class ImageSearchItemEditorial:
    ...
    editorial_source: Optional[EditorialSource] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('editorial_source') }})
    ...
    people: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('people') }})
