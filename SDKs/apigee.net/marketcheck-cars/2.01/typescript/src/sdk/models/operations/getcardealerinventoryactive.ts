...
export class GetCarDealerInventoryActiveQueryParams extends SpeakeasyBase {
...
export class GetCarDealerInventoryActiveRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  queryParams: GetCarDealerInventoryActiveQueryParams;
}


export class GetCarDealerInventoryActiveResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
