...
export class GetSearchCarAuctionActiveQueryParams extends SpeakeasyBase {
...
export class GetSearchCarAuctionActiveRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  queryParams: GetSearchCarAuctionActiveQueryParams;
}


export class GetSearchCarAuctionActiveResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
