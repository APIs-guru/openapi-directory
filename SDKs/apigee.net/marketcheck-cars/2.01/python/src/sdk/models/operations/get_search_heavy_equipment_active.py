...
class GetSearchHeavyEquipmentActiveQueryParams:
    ...
    hours_used_range: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'hours_used_range', 'style': 'form', 'explode': True }})
    ...
    sub_category: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'sub_category', 'style': 'form', 'explode': True }})
