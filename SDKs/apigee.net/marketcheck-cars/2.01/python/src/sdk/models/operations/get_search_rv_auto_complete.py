...
class GetSearchRvAutoCompleteQueryParams:
    field: GetSearchRvAutoCompleteFieldEnum = field(metadata={'query_param': { 'field_name': 'field', 'style': 'form', 'explode': True }})
...
class GetSearchRvAutoCompleteRequest:
    query_params: GetSearchRvAutoCompleteQueryParams = field()
