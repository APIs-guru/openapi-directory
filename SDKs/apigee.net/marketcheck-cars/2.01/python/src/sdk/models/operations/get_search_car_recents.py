...
@dataclass
class GetSearchCarRecentsQueryParams:
    ...
    expired: Optional[shared.ExpiredEnum] = field(default=None, metadata={'query_param': { 'field_name': 'expired', 'style': 'form', 'explode': True }})
    ...
    sold: Optional[bool] = field(default=None, metadata={'query_param': { 'field_name': 'sold', 'style': 'form', 'explode': True }})
