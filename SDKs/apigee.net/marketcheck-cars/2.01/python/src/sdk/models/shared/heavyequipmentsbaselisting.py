...
from . import heavyequipmentsbuild
...
class HeavyEquipmentsBaseListing:
    build: Optional[heavyequipmentsbuild.HeavyEquipmentsBuild] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'build' }})
