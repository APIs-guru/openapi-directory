...
class GetSearchMotorcycleAutoCompleteQueryParams:
    ...
    field: GetSearchMotorcycleAutoCompleteFieldEnum = field(default=None, metadata={'query_param': { 'field_name': 'field', 'style': 'form', 'explode': True }})
...
class GetSearchMotorcycleAutoCompleteRequest:
    query_params: GetSearchMotorcycleAutoCompleteQueryParams = field(default=None)
