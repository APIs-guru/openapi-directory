...
from . import motorcyclebaselisting
...
class MotorcycleSearchResponse:
    ...
    listings: Optional[List[motorcyclebaselisting.MotorcycleBaseListing]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'listings' }})
