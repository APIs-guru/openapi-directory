...
class Listing:
    ...
    carfax_1_owner: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('carfax_1_owner') }})
    carfax_clean_title: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('carfax_clean_title') }})
    ...
    dom: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('dom') }})
    dom_180: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('dom_180') }})
    dom_active: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('dom_active') }})
    ...
    financing_options: Optional[List[ListingFinance]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('financing_options') }})
    ...
    first_seen_at_mc: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('first_seen_at_mc') }})
    first_seen_at_mc_date: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('first_seen_at_mc_date') }})
    first_seen_at_source: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('first_seen_at_source') }})
    first_seen_at_source_date: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('first_seen_at_source_date') }})
    ...
    is_certified: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('is_certified') }})
    ...
    leasing_options: Optional[List[ListingLease]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('leasing_options') }})
    ...
    ref_miles: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ref_miles') }})
    ref_miles_dt: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ref_miles_dt') }})
    ref_price: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ref_price') }})
    ref_price_dt: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ref_price_dt') }})
    score: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('score') }})
    scraped_at: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('scraped_at') }})
    ...
    vdp_url: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('vdp_url') }})
