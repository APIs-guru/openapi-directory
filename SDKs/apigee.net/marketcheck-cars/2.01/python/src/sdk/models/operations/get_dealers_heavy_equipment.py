...
@dataclass
class GetDealersHeavyEquipmentQueryParams:
...
@dataclass
class GetDealersHeavyEquipmentRequest:
    query_params: GetDealersHeavyEquipmentQueryParams = field(default=None)
    

@dataclass
class GetDealersHeavyEquipmentResponse:
