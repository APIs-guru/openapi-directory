...
class BestPodcastsResponse:
    ...
    listennotes_url: str = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('listennotes_url') }})
    ...
    parent_id: int = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('parent_id') }})
