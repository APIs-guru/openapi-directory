...
var GetProgrammesAtoZSearchPathParams = /** @class */ (function (_super) {
    ...
    function GetProgrammesAtoZSearchPathParams() {
...
export { GetProgrammesAtoZSearchPathParams };
export var GetProgrammesAtoZSearchSortEnum;
(function (GetProgrammesAtoZSearchSortEnum) {
    GetProgrammesAtoZSearchSortEnum["Title"] = "title";
})(GetProgrammesAtoZSearchSortEnum || (GetProgrammesAtoZSearchSortEnum = {}));
var GetProgrammesAtoZSearchQueryParams = /** @class */ (function (_super) {
    __extends(GetProgrammesAtoZSearchQueryParams, _super);
    function GetProgrammesAtoZSearchQueryParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
...
export { GetProgrammesAtoZSearchQueryParams };
var GetProgrammesAtoZSearchRequest = /** @class */ (function (_super) {
    __extends(GetProgrammesAtoZSearchRequest, _super);
    function GetProgrammesAtoZSearchRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata(),
...
export { GetProgrammesAtoZSearchRequest };
var GetProgrammesAtoZSearchResponse = /** @class */ (function (_super) {
    __extends(GetProgrammesAtoZSearchResponse, _super);
    function GetProgrammesAtoZSearchResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata(),
...
export { GetProgrammesAtoZSearchResponse };
