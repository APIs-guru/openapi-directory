...
export class GetProgrammesPopularQueryParams extends SpeakeasyBase {
...
export class GetProgrammesPopularRequest extends SpeakeasyBase {
  @Metadata()
  queryParams: GetProgrammesPopularQueryParams;
}


export class GetProgrammesPopularResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
