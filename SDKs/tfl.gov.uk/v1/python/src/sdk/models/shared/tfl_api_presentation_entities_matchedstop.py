...
class TflAPIPresentationEntitiesMatchedStop:
    ...
    has_disruption: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('hasDisruption') }})
    ics_id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('icsId') }})
    ...
    station_id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('stationId') }})
    ...
    top_most_parent_id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('topMostParentId') }})
