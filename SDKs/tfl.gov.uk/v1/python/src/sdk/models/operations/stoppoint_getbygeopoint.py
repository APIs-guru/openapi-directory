...
class StopPointGetByGeoPointQueryParams:
    ...
    location_lat: float = field(default=None, metadata={'query_param': { 'field_name': 'location.lat', 'style': 'form', 'explode': True }})
    location_lon: float = field(default=None, metadata={'query_param': { 'field_name': 'location.lon', 'style': 'form', 'explode': True }})
    ...
    stop_types: List[str] = field(default=None, metadata={'query_param': { 'field_name': 'stopTypes', 'style': 'form', 'explode': True }})
...
class StopPointGetByGeoPointRequest:
    query_params: StopPointGetByGeoPointQueryParams = field(default=None)
