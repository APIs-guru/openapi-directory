...
class TravelTimeGetCompareOverlayQueryParams:
    compare_type: str = field(metadata={'query_param': { 'field_name': 'compareType', 'style': 'form', 'explode': True }})
    compare_value: str = field(metadata={'query_param': { 'field_name': 'compareValue', 'style': 'form', 'explode': True }})
    direction: TravelTimeGetCompareOverlayDirectionEnum = field(metadata={'query_param': { 'field_name': 'direction', 'style': 'form', 'explode': True }})
...
class TravelTimeGetCompareOverlayRequest:
    path_params: TravelTimeGetCompareOverlayPathParams = field()
    query_params: TravelTimeGetCompareOverlayQueryParams = field()
