...
export class DictionaryComponentResponseOfint64AndDestinyItemTalentGridComponent extends SpeakeasyBase {
  @SpeakeasyMetadata({ elemType: DestinyEntitiesItemsDestinyItemTalentGridComponent })
