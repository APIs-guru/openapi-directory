...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.AppGetApplicationApiUsage = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AppGetApplicationApiUsageRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/App/ApiUsage/{applicationId}/", req.pathParams);
    ...
    SDK.prototype.AppGetBungieApplications = function (config) {
        var baseURL = this.serverURL;
    ...
    SDK.prototype.CommunityContentGetCommunityContent = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CommunityContentGetCommunityContentRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/CommunityContent/Get/{sort}/{mediaFilter}/{page}/", req.pathParams);
        var client = this.defaultClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.ContentGetContentById = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ContentGetContentByIdRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Content/GetContentById/{id}/{locale}/", req.pathParams);
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.ContentGetContentByTagAndType = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ContentGetContentByTagAndTypeRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Content/GetContentByTagAndType/{tag}/{type}/{locale}/", req.pathParams);
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.ContentGetContentType = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ContentGetContentTypeRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Content/GetContentType/{type}/", req.pathParams);
        var client = this.defaultClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.ContentSearchContentByTagAndType = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ContentSearchContentByTagAndTypeRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Content/SearchContentByTagAndType/{tag}/{type}/{locale}/", req.pathParams);
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.ContentSearchContentWithText = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ContentSearchContentWithTextRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Content/Search/{locale}/", req.pathParams);
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.ContentSearchHelpArticles = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ContentSearchHelpArticlesRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Content/SearchHelpArticles/{searchtext}/{size}/", req.pathParams);
        var client = this.defaultClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.Destiny2AwaGetActionToken = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.Destiny2AwaGetActionTokenRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Destiny2/Awa/GetActionToken/{correlationId}/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.Destiny2AwaInitializeRequest = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.Destiny2AwaProvideAuthorizationResult = function (config) {
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/Destiny2/Awa/AwaProvideAuthorizationResult/";
        var client = this.defaultClient;
        return client
            .post(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.Destiny2EquipItem = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.Destiny2EquipItems = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.Destiny2GetActivityHistory = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.Destiny2GetActivityHistoryRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Destiny2/{membershipType}/Account/{destinyMembershipId}/Character/{characterId}/Stats/Activities/", req.pathParams);
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.Destiny2GetCharacter = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.Destiny2GetCharacterRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Destiny2/{membershipType}/Profile/{destinyMembershipId}/Character/{characterId}/", req.pathParams);
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.Destiny2GetClanAggregateStats = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.Destiny2GetClanAggregateStatsRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Destiny2/Stats/AggregateClanStats/{groupId}/", req.pathParams);
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.Destiny2GetClanLeaderboards = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.Destiny2GetClanLeaderboardsRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Destiny2/Stats/Leaderboards/Clans/{groupId}/", req.pathParams);
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.Destiny2GetClanWeeklyRewardState = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.Destiny2GetClanWeeklyRewardStateRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Destiny2/Clan/{groupId}/WeeklyRewardState/", req.pathParams);
        var client = this.defaultClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.Destiny2GetCollectibleNodeDetails = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.Destiny2GetCollectibleNodeDetailsRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Destiny2/{membershipType}/Profile/{destinyMembershipId}/Character/{characterId}/Collectibles/{collectiblePresentationNodeHash}/", req.pathParams);
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.Destiny2GetDestinyAggregateActivityStats = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.Destiny2GetDestinyAggregateActivityStatsRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Destiny2/{membershipType}/Account/{destinyMembershipId}/Character/{characterId}/Stats/AggregateActivityStats/", req.pathParams);
        var client = this.defaultClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.Destiny2GetDestinyEntityDefinition = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.Destiny2GetDestinyEntityDefinitionRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Destiny2/Manifest/{entityType}/{hashIdentifier}/", req.pathParams);
        var client = this.defaultClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.Destiny2GetDestinyManifest = function (config) {
        var baseURL = this.serverURL;
    ...
    SDK.prototype.Destiny2GetHistoricalStats = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.Destiny2GetHistoricalStatsRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Destiny2/{membershipType}/Account/{destinyMembershipId}/Character/{characterId}/Stats/", req.pathParams);
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.Destiny2GetHistoricalStatsDefinition = function (config) {
        var baseURL = this.serverURL;
    ...
    SDK.prototype.Destiny2GetHistoricalStatsForAccount = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.Destiny2GetHistoricalStatsForAccountRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Destiny2/{membershipType}/Account/{destinyMembershipId}/Stats/", req.pathParams);
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.Destiny2GetItem = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.Destiny2GetItemRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Destiny2/{membershipType}/Profile/{destinyMembershipId}/Item/{itemInstanceId}/", req.pathParams);
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.Destiny2GetLeaderboards = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.Destiny2GetLeaderboardsRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Destiny2/{membershipType}/Account/{destinyMembershipId}/Stats/Leaderboards/", req.pathParams);
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.Destiny2GetLeaderboardsForCharacter = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.Destiny2GetLeaderboardsForCharacterRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Destiny2/Stats/Leaderboards/{membershipType}/{destinyMembershipId}/{characterId}/", req.pathParams);
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.Destiny2GetLinkedProfiles = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.Destiny2GetLinkedProfilesRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Destiny2/{membershipType}/Profile/{membershipId}/LinkedProfiles/", req.pathParams);
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.Destiny2GetPostGameCarnageReport = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.Destiny2GetPostGameCarnageReportRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Destiny2/Stats/PostGameCarnageReport/{activityId}/", req.pathParams);
        var client = this.defaultClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.Destiny2GetProfile = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.Destiny2GetProfileRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Destiny2/{membershipType}/Profile/{destinyMembershipId}/", req.pathParams);
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.Destiny2GetPublicMilestoneContent = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.Destiny2GetPublicMilestoneContentRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Destiny2/Milestones/{milestoneHash}/Content/", req.pathParams);
        var client = this.defaultClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.Destiny2GetPublicMilestones = function (config) {
        var baseURL = this.serverURL;
    ...
    SDK.prototype.Destiny2GetPublicVendors = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.Destiny2GetUniqueWeaponHistory = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.Destiny2GetUniqueWeaponHistoryRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Destiny2/{membershipType}/Account/{destinyMembershipId}/Character/{characterId}/Stats/UniqueWeapons/", req.pathParams);
        var client = this.defaultClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.Destiny2GetVendor = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.Destiny2GetVendorRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Destiny2/{membershipType}/Profile/{destinyMembershipId}/Character/{characterId}/Vendors/{vendorHash}/", req.pathParams);
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.Destiny2GetVendors = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.Destiny2GetVendorsRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Destiny2/{membershipType}/Profile/{destinyMembershipId}/Character/{characterId}/Vendors/", req.pathParams);
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.Destiny2InsertSocketPlug = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.Destiny2PullFromPostmaster = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.Destiny2PullFromPostmasterRequest(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/Destiny2/Actions/Items/PullFromPostmaster/";
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .post(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.Destiny2ReportOffensivePostGameCarnageReportPlayer = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.Destiny2ReportOffensivePostGameCarnageReportPlayerRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Destiny2/Stats/PostGameCarnageReport/{activityId}/Report/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .post(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.Destiny2SearchDestinyEntities = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.Destiny2SearchDestinyEntitiesRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Destiny2/Armory/Search/{type}/{searchTerm}/", req.pathParams);
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.Destiny2SearchDestinyPlayer = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.Destiny2SearchDestinyPlayerRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Destiny2/SearchDestinyPlayer/{membershipType}/{displayName}/", req.pathParams);
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.Destiny2SetItemLockState = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.Destiny2SetQuestTrackedState = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.Destiny2TransferItem = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.FireteamGetActivePrivateClanFireteamCount = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.FireteamGetActivePrivateClanFireteamCountRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Fireteam/Clan/{groupId}/ActiveCount/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.FireteamGetAvailableClanFireteams = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.FireteamGetAvailableClanFireteamsRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Fireteam/Clan/{groupId}/Available/{platform}/{activityType}/{dateRange}/{slotFilter}/{publicOnly}/{page}/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.FireteamGetClanFireteam = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.FireteamGetClanFireteamRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Fireteam/Clan/{groupId}/Summary/{fireteamId}/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.FireteamGetMyClanFireteams = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.FireteamGetMyClanFireteamsRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Fireteam/Clan/{groupId}/My/{platform}/{includeClosed}/{page}/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.FireteamSearchPublicAvailableClanFireteams = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.FireteamSearchPublicAvailableClanFireteamsRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Fireteam/Search/Available/{platform}/{activityType}/{dateRange}/{slotFilter}/{page}/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.ForumGetCoreTopicsPaged = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ForumGetCoreTopicsPagedRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Forum/GetCoreTopicsPaged/{page}/{sort}/{quickDate}/{categoryFilter}/", req.pathParams);
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.ForumGetForumTagSuggestions = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.ForumGetPoll = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ForumGetPollRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Forum/Poll/{topicId}/", req.pathParams);
        var client = this.defaultClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.ForumGetPostAndParent = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ForumGetPostAndParentRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Forum/GetPostAndParent/{childPostId}/", req.pathParams);
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.ForumGetPostAndParentAwaitingApproval = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ForumGetPostAndParentAwaitingApprovalRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Forum/GetPostAndParentAwaitingApproval/{childPostId}/", req.pathParams);
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.ForumGetPostsThreadedPaged = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ForumGetPostsThreadedPagedRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Forum/GetPostsThreadedPaged/{parentPostId}/{page}/{pageSize}/{replySize}/{getParentPost}/{rootThreadMode}/{sortMode}/", req.pathParams);
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.ForumGetPostsThreadedPagedFromChild = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ForumGetPostsThreadedPagedFromChildRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Forum/GetPostsThreadedPagedFromChild/{childPostId}/{page}/{pageSize}/{replySize}/{rootThreadMode}/{sortMode}/", req.pathParams);
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.ForumGetRecruitmentThreadSummaries = function (config) {
        var baseURL = this.serverURL;
    ...
    SDK.prototype.ForumGetTopicForContent = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ForumGetTopicForContentRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Forum/GetTopicForContent/{contentId}/", req.pathParams);
        var client = this.defaultClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.ForumGetTopicsPaged = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ForumGetTopicsPagedRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Forum/GetTopicsPaged/{page}/{pageSize}/{group}/{sort}/{quickDate}/{categoryFilter}/", req.pathParams);
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.GroupV2AbdicateFoundership = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2AbdicateFoundershipRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/{groupId}/Admin/AbdicateFoundership/{membershipType}/{founderIdNew}/", req.pathParams);
        var client = this.defaultClient;
        return client
            .post(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.GroupV2AddOptionalConversation = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2AddOptionalConversationRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/{groupId}/OptionalConversations/Add/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .post(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.GroupV2ApproveAllPending = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2ApproveAllPendingRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/{groupId}/Members/ApproveAll/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .post(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.GroupV2ApprovePending = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2ApprovePendingRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/{groupId}/Members/Approve/{membershipType}/{membershipId}/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .post(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.GroupV2ApprovePendingForList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2ApprovePendingForListRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/{groupId}/Members/ApproveList/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .post(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.GroupV2BanMember = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2BanMemberRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/{groupId}/Members/{membershipType}/{membershipId}/Ban/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .post(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.GroupV2DenyAllPending = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2DenyAllPendingRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/{groupId}/Members/DenyAll/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .post(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.GroupV2DenyPendingForList = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2DenyPendingForListRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/{groupId}/Members/DenyList/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .post(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.GroupV2EditClanBanner = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2EditClanBannerRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/{groupId}/EditClanBanner/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .post(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.GroupV2EditFounderOptions = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2EditFounderOptionsRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/{groupId}/EditFounderOptions/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .post(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.GroupV2EditGroup = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2EditGroupRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/{groupId}/Edit/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .post(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.GroupV2EditGroupMembership = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2EditGroupMembershipRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/{groupId}/Members/{membershipType}/{membershipId}/SetMembershipType/{memberType}/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .post(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.GroupV2EditOptionalConversation = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2EditOptionalConversationRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/{groupId}/OptionalConversations/Edit/{conversationId}/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .post(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.GroupV2GetAdminsAndFounderOfGroup = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2GetAdminsAndFounderOfGroupRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/{groupId}/AdminsAndFounder/", req.pathParams);
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.GroupV2GetAvailableAvatars = function (config) {
        var baseURL = this.serverURL;
    ...
    SDK.prototype.GroupV2GetAvailableThemes = function (config) {
        var baseURL = this.serverURL;
    ...
    SDK.prototype.GroupV2GetBannedMembersOfGroup = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2GetBannedMembersOfGroupRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/{groupId}/Banned/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.GroupV2GetGroup = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2GetGroupRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/{groupId}/", req.pathParams);
        var client = this.defaultClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.GroupV2GetGroupByName = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2GetGroupByNameRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/Name/{groupName}/{groupType}/", req.pathParams);
        var client = this.defaultClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.GroupV2GetGroupByNameV2 = function (config) {
        var baseURL = this.serverURL;
    ...
    SDK.prototype.GroupV2GetGroupOptionalConversations = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2GetGroupOptionalConversationsRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/{groupId}/OptionalConversations/", req.pathParams);
        var client = this.defaultClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.GroupV2GetGroupsForMember = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2GetGroupsForMemberRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/User/{membershipType}/{membershipId}/{filter}/{groupType}/", req.pathParams);
        var client = this.defaultClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.GroupV2GetInvitedIndividuals = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2GetInvitedIndividualsRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/{groupId}/Members/InvitedIndividuals/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.GroupV2GetMembersOfGroup = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2GetMembersOfGroupRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/{groupId}/Members/", req.pathParams);
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.GroupV2GetPendingMemberships = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2GetPendingMembershipsRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/{groupId}/Members/Pending/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.GroupV2GetPotentialGroupsForMember = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2GetPotentialGroupsForMemberRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/User/Potential/{membershipType}/{membershipId}/{filter}/{groupType}/", req.pathParams);
        var client = this.defaultClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.GroupV2GetRecommendedGroups = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2GetRecommendedGroupsRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/Recommended/{groupType}/{createDateRange}/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .post(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.GroupV2GetUserClanInviteSetting = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2GetUserClanInviteSettingRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/GetUserClanInviteSetting/{mType}/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.GroupV2GroupSearch = function (config) {
        var baseURL = this.serverURL;
    ...
    SDK.prototype.GroupV2IndividualGroupInvite = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2IndividualGroupInviteRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/{groupId}/Members/IndividualInvite/{membershipType}/{membershipId}/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .post(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.GroupV2IndividualGroupInviteCancel = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2IndividualGroupInviteCancelRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/{groupId}/Members/IndividualInviteCancel/{membershipType}/{membershipId}/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .post(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.GroupV2KickMember = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2KickMemberRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/{groupId}/Members/{membershipType}/{membershipId}/Kick/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .post(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.GroupV2RecoverGroupForFounder = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2RecoverGroupForFounderRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/Recover/{membershipType}/{membershipId}/{groupType}/", req.pathParams);
        var client = this.defaultClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.GroupV2UnbanMember = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GroupV2UnbanMemberRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/GroupV2/{groupId}/Members/{membershipType}/{membershipId}/Unban/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .post(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.TokensApplyMissingPartnerOffersWithoutClaim = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.TokensApplyMissingPartnerOffersWithoutClaimRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Tokens/Partner/ApplyMissingOffers/{partnerApplicationId}/{targetBnetMembershipId}/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .post(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.TokensClaimPartnerOffer = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.TokensGetPartnerOfferSkuHistory = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.TokensGetPartnerOfferSkuHistoryRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Tokens/Partner/History/{partnerApplicationId}/{targetBnetMembershipId}/", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.TrendingGetTrendingCategories = function (config) {
        var baseURL = this.serverURL;
    ...
    SDK.prototype.TrendingGetTrendingCategory = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.TrendingGetTrendingCategoryRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Trending/Categories/{categoryId}/{pageNumber}/", req.pathParams);
        var client = this.defaultClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.TrendingGetTrendingEntryDetail = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.TrendingGetTrendingEntryDetailRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/Trending/Details/{trendingEntryType}/{identifier}/", req.pathParams);
        var client = this.defaultClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.UserGetAvailableThemes = function (config) {
        var baseURL = this.serverURL;
    ...
    SDK.prototype.UserGetBungieNetUserById = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.UserGetBungieNetUserByIdRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/User/GetBungieNetUserById/{id}/", req.pathParams);
        var client = this.defaultClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.UserGetCredentialTypesForTargetAccount = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.UserGetCredentialTypesForTargetAccountRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/User/GetCredentialTypesForTargetAccount/{membershipId}/", req.pathParams);
        var client = this.defaultClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.UserGetMembershipDataById = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.UserGetMembershipDataByIdRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/User/GetMembershipsById/{membershipId}/{membershipType}/", req.pathParams);
        var client = this.defaultClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.UserGetMembershipDataForCurrentUser = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.UserGetMembershipFromHardLinkedCredential = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.UserGetMembershipFromHardLinkedCredentialRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/User/GetMembershipFromHardLinkedCredential/{crType}/{credential}/", req.pathParams);
        var client = this.defaultClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.UserSearchUsers = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.UserSearchUsersRequest(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/User/SearchUsers/";
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
