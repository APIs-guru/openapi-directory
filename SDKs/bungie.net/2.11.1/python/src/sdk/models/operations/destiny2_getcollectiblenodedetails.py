...
class Destiny2GetCollectibleNodeDetailsPathParams:
    ...
    collectible_presentation_node_hash: int = field(default=None, metadata={'path_param': { 'field_name': 'collectiblePresentationNodeHash', 'style': 'simple', 'explode': False }})
...
class Destiny2GetCollectibleNodeDetailsRequest:
    path_params: Destiny2GetCollectibleNodeDetailsPathParams = field(default=None)
    query_params: Destiny2GetCollectibleNodeDetailsQueryParams = field(default=None)
