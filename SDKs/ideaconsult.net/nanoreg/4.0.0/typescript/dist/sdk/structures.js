...
var Structures = /** @class */ (function () {
    function Structures(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Structures.prototype.getSubstanceComposition = function (req, config) {
     ...
     * Returns substance composition
    **/
    Structures.prototype.getSubstanceStructures = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Structures.prototype.searchByIdentifier = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * http://ambit.sf.net - Learn more about operations provided by this API.
    **/
    Structures.prototype.searchBySimilarity = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * http://ambit.sf.net - Learn more about operations provided by this API.
    **/
    Structures.prototype.searchBySmarts = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
