...
var Substances = /** @class */ (function () {
    function Substances(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Substances.prototype.getSubstanceByUuid = function (req, config) {
    ...
    **/
    Substances.prototype.getSubstanceComposition = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Returns substance composition
    **/
    Substances.prototype.getSubstanceStructures = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Substances.prototype.getSubstanceStudy = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Study summary
    **/
    Substances.prototype.getSubstanceStudySummary = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Substances.prototype.getSubstances = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
