...
var Studies = /** @class */ (function () {
    function Studies(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Studies.prototype.getEndpointSummary = function (req, config) {
    ...
    **/
    Studies.prototype.getInvestigationResults = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Studies.prototype.getSubstanceStudy = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Study summary
    **/
    Studies.prototype.getSubstanceStudySummary = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
