...
class PaymentQueryDto:
    ...
    transfer_bank_code: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'transferBankCode' }})
    transfer_bank_id: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'transferBankId' }})
