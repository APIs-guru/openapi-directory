...
class SalesInvoiceCreditNoteDto:
    ...
    product_trans: Optional[List[producttrandto.ProductTranDto]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'productTrans' }})
