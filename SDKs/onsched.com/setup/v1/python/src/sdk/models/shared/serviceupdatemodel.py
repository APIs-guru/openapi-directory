...
from . import servicefeesupdatemodel
from . import serviceoptionsupdatemodel
from . import servicesettingsupdatemodel
...
class ServiceUpdateModel:
    ...
    fees: Optional[servicefeesupdatemodel.ServiceFeesUpdateModel] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'fees' }})
    ...
    options: Optional[serviceoptionsupdatemodel.ServiceOptionsUpdateModel] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'options' }})
    ...
    settings: Optional[servicesettingsupdatemodel.ServiceSettingsUpdateModel] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'settings' }})
