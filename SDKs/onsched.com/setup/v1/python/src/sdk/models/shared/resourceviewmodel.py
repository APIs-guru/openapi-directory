...
class ResourceViewModel:
    ...
    google_calendar_auth_url: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'googleCalendarAuthUrl' }})
    google_calendar_authorized: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'googleCalendarAuthorized' }})
    ...
    outlook_calendar_auth_url: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'outlookCalendarAuthUrl' }})
    outlook_calendar_authorized: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'outlookCalendarAuthorized' }})
    outlook_calendar_id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'outlookCalendarId' }})
    skype_name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'skypeName' }})
