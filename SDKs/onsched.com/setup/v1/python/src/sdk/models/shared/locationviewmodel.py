...
class LocationViewModel:
    ...
    primary_business: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'primaryBusiness' }})
    primary_calendar_id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'primaryCalendarId' }})
