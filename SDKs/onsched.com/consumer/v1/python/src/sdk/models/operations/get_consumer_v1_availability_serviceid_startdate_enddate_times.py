...
class GetConsumerV1AvailabilityServiceIDStartDateEndDateTimesRequest:
    path_params: GetConsumerV1AvailabilityServiceIDStartDateEndDateTimesPathParams = field()
    query_params: GetConsumerV1AvailabilityServiceIDStartDateEndDateTimesQueryParams = field()
