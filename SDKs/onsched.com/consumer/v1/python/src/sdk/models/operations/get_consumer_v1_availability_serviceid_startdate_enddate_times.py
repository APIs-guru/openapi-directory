...
class GetConsumerV1AvailabilityServiceIDStartDateEndDateTimesRequest:
    path_params: GetConsumerV1AvailabilityServiceIDStartDateEndDateTimesPathParams = field(default=None)
    query_params: GetConsumerV1AvailabilityServiceIDStartDateEndDateTimesQueryParams = field(default=None)
    

@dataclass
class GetConsumerV1AvailabilityServiceIDStartDateEndDateTimesResponse:
    availability3_view_model: Optional[shared.Availability3ViewModel] = field(default=None)
