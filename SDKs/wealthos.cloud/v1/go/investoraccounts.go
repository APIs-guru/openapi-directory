...
func (s *InvestorAccounts) GetAllinvestorAccounts(ctx context.Context, request operations.GetAllinvestorAccountsRequest) (*operations.GetAllinvestorAccountsResponse, error) {
	...
	case httpRes.StatusCode == 400:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetAllinvestorAccounts400ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 401:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetAllinvestorAccounts401ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 403:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetAllinvestorAccounts403ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 404:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetAllinvestorAccounts404ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 409:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetAllinvestorAccounts409ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 429:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetAllinvestorAccounts429ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 500:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetAllinvestorAccounts500ApplicationJSONAny = out
		}
	}
...
func (s *InvestorAccounts) GetinvestorAccount(ctx context.Context, request operations.GetinvestorAccountRequest) (*operations.GetinvestorAccountResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/tenant/investor-accounts/v1/{account_id}", request.PathParams)
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetinvestorAccount200ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 400:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetinvestorAccount400ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 401:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetinvestorAccount401ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 403:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetinvestorAccount403ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 404:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetinvestorAccount404ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 409:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetinvestorAccount409ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 429:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetinvestorAccount429ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 500:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetinvestorAccount500ApplicationJSONAny = out
		}
	}
