...
func (s *SwitchInstruction) ExecuteSwitchTrasaction(ctx context.Context, request operations.ExecuteSwitchTrasactionRequest) (*operations.ExecuteSwitchTrasactionResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.ExecuteSwitchTrasaction200ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 400:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.ExecuteSwitchTrasaction400ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 401:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.ExecuteSwitchTrasaction401ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 403:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.ExecuteSwitchTrasaction403ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 404:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.ExecuteSwitchTrasaction404ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 409:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.ExecuteSwitchTrasaction409ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 429:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.ExecuteSwitchTrasaction429ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 500:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.ExecuteSwitchTrasaction500ApplicationJSONAny = out
		}
	}
...
func (s *SwitchInstruction) GetSwitch(ctx context.Context, request operations.GetSwitchRequest) (*operations.GetSwitchResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/tenant/transactions/v1/switch/{switch_transaction_id}", request.PathParams)
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetSwitch200ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 400:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetSwitch400ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 401:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetSwitch401ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 403:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetSwitch403ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 404:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetSwitch404ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 409:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetSwitch409ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 429:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetSwitch429ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 500:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.GetSwitch500ApplicationJSONAny = out
		}
	}
