...
func (s *InvestmentProductTransactions) ExecuteBuyTrasaction(ctx context.Context, request operations.ExecuteBuyTrasactionRequest) (*operations.ExecuteBuyTrasactionResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.ExecuteBuyTrasaction200ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 400:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.ExecuteBuyTrasaction400ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 401:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.ExecuteBuyTrasaction401ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 403:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.ExecuteBuyTrasaction403ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 404:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.ExecuteBuyTrasaction404ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 409:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.ExecuteBuyTrasaction409ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 429:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.ExecuteBuyTrasaction429ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 500:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.ExecuteBuyTrasaction500ApplicationJSONAny = out
		}
	}
...
func (s *InvestmentProductTransactions) ExecuteSellTrasaction(ctx context.Context, request operations.ExecuteSellTrasactionRequest) (*operations.ExecuteSellTrasactionResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.ExecuteSellTrasaction200ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 400:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.ExecuteSellTrasaction400ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 401:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.ExecuteSellTrasaction401ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 403:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.ExecuteSellTrasaction403ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 404:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.ExecuteSellTrasaction404ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 409:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.ExecuteSellTrasaction409ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 429:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.ExecuteSellTrasaction429ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 500:
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.ExecuteSellTrasaction500ApplicationJSONAny = out
		}
	}
