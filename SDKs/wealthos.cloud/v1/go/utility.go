...
func (s *Utility) CopyFileToS3(ctx context.Context, request operations.CopyFileToS3Request) (*operations.CopyFileToS3Response, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.CopyFileToS3200ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 400:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.CopyFileToS3400ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 401:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.CopyFileToS3401ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 403:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.CopyFileToS3403ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 404:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.CopyFileToS3404ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 429:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.CopyFileToS3429ApplicationJSONAny = out
		}
	case httpRes.StatusCode == 500:
		...
		case utils.MatchContentType(contentType, `application/json`):
			...
			res.CopyFileToS3500ApplicationJSONAny = out
		}
	}
