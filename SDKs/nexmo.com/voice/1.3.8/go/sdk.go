...
func (s *SDK) GetCall(ctx context.Context, request operations.GetCallRequest) (*operations.GetCallResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/{uuid}", request.PathParams)
...
func (s *SDK) StartDtmf(ctx context.Context, request operations.StartDtmfRequest) (*operations.StartDtmfResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) StartStream(ctx context.Context, request operations.StartStreamRequest) (*operations.StartStreamResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) StartTalk(ctx context.Context, request operations.StartTalkRequest) (*operations.StartTalkResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) StopTalk(ctx context.Context, request operations.StopTalkRequest) (*operations.StopTalkResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/{uuid}/talk", request.PathParams)
