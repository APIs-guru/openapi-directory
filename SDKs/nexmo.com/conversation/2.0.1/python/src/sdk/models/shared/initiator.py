...
class InitiatorJoined:
    is_system: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('isSystem') }})
...
@dataclass
class Initiator:
    joined: Optional[InitiatorJoined] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('joined') }})
