...
func (s *SDK) CreateEvent(ctx context.Context, request operations.CreateEventRequest) (*operations.CreateEventResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) DeleteEvent(ctx context.Context, request operations.DeleteEventRequest) (*operations.DeleteEventResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) DeleteLeg(ctx context.Context, request operations.DeleteLegRequest) (*operations.DeleteLegResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) GetuserConversations(ctx context.Context, request operations.GetuserConversationsRequest) (*operations.GetuserConversationsResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/users/{user_id}/conversations", request.PathParams)
...
func (s *SDK) ListConversations(ctx context.Context, request operations.ListConversationsRequest) (*operations.ListConversationsResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/conversations"
...
func (s *SDK) ListLegs(ctx context.Context) (*operations.ListLegsResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) RecordConversation(ctx context.Context, request operations.RecordConversationRequest) (*operations.RecordConversationResponse, error) {
	baseURL := operations.RecordConversationServers[0]
...
func (s *SDK) ReplaceConversation(ctx context.Context, request operations.ReplaceConversationRequest) (*operations.ReplaceConversationResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/conversations/{conversation_id}", request.PathParams)
...
func (s *SDK) RetrieveConversation(ctx context.Context, request operations.RetrieveConversationRequest) (*operations.RetrieveConversationResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/conversations/{conversation_id}", request.PathParams)
