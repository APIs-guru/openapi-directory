...
var GetMembersQueryParams = /** @class */ (function (_super) {
    __extends(GetMembersQueryParams, _super);
    function GetMembersQueryParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=cursor" }),
        __metadata("design:type", String)
    ], GetMembersQueryParams.prototype, "cursor", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=order" }),
        __metadata("design:type", String)
    ], GetMembersQueryParams.prototype, "order", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=page_size" }),
        __metadata("design:type", Number)
    ], GetMembersQueryParams.prototype, "pageSize", void 0);
    return GetMembersQueryParams;
}(SpeakeasyBase));
export { GetMembersQueryParams };
var GetMembersRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", GetMembersQueryParams)
    ], GetMembersRequest.prototype, "queryParams", void 0);
...
var GetMembersResponse = /** @class */ (function (_super) {
    ...
    ], GetMembersResponse.prototype, "getMembers200ApplicationJsonAny", void 0);
