...
func (s *SDK) NetworkUnblock(ctx context.Context, request operations.NetworkUnblockRequest) (*operations.NetworkUnblockResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) VerifyRequest(ctx context.Context, request operations.VerifyRequestRequest) (*operations.VerifyRequestResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/{format}", request.PathParams)
