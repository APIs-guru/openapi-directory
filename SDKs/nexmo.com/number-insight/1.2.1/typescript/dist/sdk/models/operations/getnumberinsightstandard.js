...
var GetNumberInsightStandardPathParams = /** @class */ (function (_super) {
    ...
    function GetNumberInsightStandardPathParams() {
...
export { GetNumberInsightStandardPathParams };
var GetNumberInsightStandardQueryParams = /** @class */ (function (_super) {
    __extends(GetNumberInsightStandardQueryParams, _super);
    function GetNumberInsightStandardQueryParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
...
export { GetNumberInsightStandardQueryParams };
var GetNumberInsightStandardRequest = /** @class */ (function (_super) {
    __extends(GetNumberInsightStandardRequest, _super);
    function GetNumberInsightStandardRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata(),
...
export { GetNumberInsightStandardRequest };
var GetNumberInsightStandardResponse = /** @class */ (function (_super) {
    __extends(GetNumberInsightStandardResponse, _super);
    function GetNumberInsightStandardResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata(),
...
export { GetNumberInsightStandardResponse };
