...
type NiResponseJSONAdvancedSync struct {
	...
	Ported                    *NiResponseJSONAdvancedSyncPortedEnum      `json:"ported,omitempty"`
	Reachable                 *NiResponseJSONAdvancedSyncReachableEnum   `json:"reachable,omitempty"`
	RealTimeData              *NiRealtimeData                            `json:"real_time_data,omitempty"`
	...
	ValidNumber               *NiResponseJSONAdvancedSyncValidNumberEnum `json:"valid_number,omitempty"`
}
