...
class DcimRackReservationsListQueryParams:
    ...
    created_gt: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'created__gt', 'style': 'form', 'explode': True }})
    created_gte: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'created__gte', 'style': 'form', 'explode': True }})
    created_lt: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'created__lt', 'style': 'form', 'explode': True }})
    created_lte: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'created__lte', 'style': 'form', 'explode': True }})
    created_n: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'created__n', 'style': 'form', 'explode': True }})
    ...
    user_id_n: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'user_id__n', 'style': 'form', 'explode': True }})
    

@dataclass
class DcimRackReservationsListRequest:
    query_params: DcimRackReservationsListQueryParams = field(default=None)
...
class DcimRackReservationsList200ApplicationJSON:
    ...
    results: List[shared.RackReservation] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'results' }})
