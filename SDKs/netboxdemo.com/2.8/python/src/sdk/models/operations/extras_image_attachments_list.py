...
class ExtrasImageAttachmentsList200ApplicationJSON:
    ...
    results: List[shared.ImageAttachment] = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
...
class ExtrasImageAttachmentsListRequest:
    query_params: ExtrasImageAttachmentsListQueryParams = field()
