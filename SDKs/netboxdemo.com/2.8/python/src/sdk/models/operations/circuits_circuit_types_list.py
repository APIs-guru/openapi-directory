...
class CircuitsCircuitTypesList200ApplicationJSON:
    ...
    results: List[shared.CircuitType] = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
...
class CircuitsCircuitTypesListRequest:
    query_params: CircuitsCircuitTypesListQueryParams = field()
