...
class CircuitsCircuitTypesListRequest:
    query_params: CircuitsCircuitTypesListQueryParams = field(default=None)
...
class CircuitsCircuitTypesList200ApplicationJSON:
    ...
    results: List[shared.CircuitType] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'results' }})
...
class CircuitsCircuitTypesListResponse:
    ...
    circuits_circuit_types_list_200_application_json_object: Optional[CircuitsCircuitTypesList200ApplicationJSON] = field(default=None)
