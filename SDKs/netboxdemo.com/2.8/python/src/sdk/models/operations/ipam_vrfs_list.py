...
class IpamVrfsListQueryParams:
    ...
    rd_ic: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'rd__ic', 'style': 'form', 'explode': True }})
    rd_ie: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'rd__ie', 'style': 'form', 'explode': True }})
    rd_iew: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'rd__iew', 'style': 'form', 'explode': True }})
    rd_isw: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'rd__isw', 'style': 'form', 'explode': True }})
    rd_n: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'rd__n', 'style': 'form', 'explode': True }})
    rd_nic: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'rd__nic', 'style': 'form', 'explode': True }})
    rd_nie: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'rd__nie', 'style': 'form', 'explode': True }})
    rd_niew: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'rd__niew', 'style': 'form', 'explode': True }})
    rd_nisw: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'rd__nisw', 'style': 'form', 'explode': True }})
