...
class DcimFrontPortTemplatesListQueryParams:
    ...
    devicetype_id_n: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'devicetype_id__n', 'style': 'form', 'explode': True }})
...
class DcimFrontPortTemplatesListRequest:
    query_params: DcimFrontPortTemplatesListQueryParams = field(default=None)
...
class DcimFrontPortTemplatesList200ApplicationJSON:
    ...
    results: List[shared.FrontPortTemplate] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'results' }})
...
class DcimFrontPortTemplatesListResponse:
    ...
    dcim_front_port_templates_list_200_application_json_object: Optional[DcimFrontPortTemplatesList200ApplicationJSON] = field(default=None)
