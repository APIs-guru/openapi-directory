...
class DcimPowerOutletTemplatesListQueryParams:
    ...
    feed_leg: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'feed_leg', 'style': 'form', 'explode': True }})
    feed_leg_n: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'feed_leg__n', 'style': 'form', 'explode': True }})
