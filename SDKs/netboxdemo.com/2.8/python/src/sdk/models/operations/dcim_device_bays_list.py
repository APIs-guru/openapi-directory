...
class DcimDeviceBaysListRequest:
    query_params: DcimDeviceBaysListQueryParams = field(default=None)
...
class DcimDeviceBaysList200ApplicationJSON:
    ...
    results: List[shared.DeviceBay] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'results' }})
...
class DcimDeviceBaysListResponse:
    ...
    dcim_device_bays_list_200_application_json_object: Optional[DcimDeviceBaysList200ApplicationJSON] = field(default=None)
