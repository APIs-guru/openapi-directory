...
class SecretsSecretRolesList200ApplicationJSON:
    ...
    results: List[shared.SecretRole] = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
...
class SecretsSecretRolesListRequest:
    query_params: SecretsSecretRolesListQueryParams = field()
