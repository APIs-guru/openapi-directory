...
class DcimConsoleServerPortTemplatesListRequest:
    query_params: DcimConsoleServerPortTemplatesListQueryParams = field(default=None)
...
class DcimConsoleServerPortTemplatesList200ApplicationJSON:
    ...
    results: List[shared.ConsoleServerPortTemplate] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'results' }})
