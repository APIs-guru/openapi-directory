...
class DcimPlatformsListQueryParams:
    ...
    napalm_driver: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'napalm_driver', 'style': 'form', 'explode': True }})
    napalm_driver_ic: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'napalm_driver__ic', 'style': 'form', 'explode': True }})
    napalm_driver_ie: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'napalm_driver__ie', 'style': 'form', 'explode': True }})
    napalm_driver_iew: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'napalm_driver__iew', 'style': 'form', 'explode': True }})
    napalm_driver_isw: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'napalm_driver__isw', 'style': 'form', 'explode': True }})
    napalm_driver_n: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'napalm_driver__n', 'style': 'form', 'explode': True }})
    napalm_driver_nic: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'napalm_driver__nic', 'style': 'form', 'explode': True }})
    napalm_driver_nie: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'napalm_driver__nie', 'style': 'form', 'explode': True }})
    napalm_driver_niew: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'napalm_driver__niew', 'style': 'form', 'explode': True }})
    napalm_driver_nisw: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'napalm_driver__nisw', 'style': 'form', 'explode': True }})
...
class DcimPlatformsListRequest:
    query_params: DcimPlatformsListQueryParams = field()
