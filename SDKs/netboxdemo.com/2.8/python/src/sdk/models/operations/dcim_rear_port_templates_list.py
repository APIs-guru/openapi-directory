...
class DcimRearPortTemplatesListRequest:
    query_params: DcimRearPortTemplatesListQueryParams = field(default=None)
...
class DcimRearPortTemplatesList200ApplicationJSON:
    ...
    results: List[shared.RearPortTemplate] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'results' }})
...
class DcimRearPortTemplatesListResponse:
    ...
    dcim_rear_port_templates_list_200_application_json_object: Optional[DcimRearPortTemplatesList200ApplicationJSON] = field(default=None)
