...
class CircuitsCircuitsListQueryParams:
    ...
    cid_ic: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'cid__ic', 'style': 'form', 'explode': True }})
    cid_ie: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'cid__ie', 'style': 'form', 'explode': True }})
    cid_iew: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'cid__iew', 'style': 'form', 'explode': True }})
    cid_isw: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'cid__isw', 'style': 'form', 'explode': True }})
    cid_n: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'cid__n', 'style': 'form', 'explode': True }})
    cid_nic: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'cid__nic', 'style': 'form', 'explode': True }})
    cid_nie: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'cid__nie', 'style': 'form', 'explode': True }})
    cid_niew: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'cid__niew', 'style': 'form', 'explode': True }})
    cid_nisw: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'cid__nisw', 'style': 'form', 'explode': True }})
    commit_rate: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'commit_rate', 'style': 'form', 'explode': True }})
    commit_rate_gt: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'commit_rate__gt', 'style': 'form', 'explode': True }})
    commit_rate_gte: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'commit_rate__gte', 'style': 'form', 'explode': True }})
    commit_rate_lt: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'commit_rate__lt', 'style': 'form', 'explode': True }})
    commit_rate_lte: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'commit_rate__lte', 'style': 'form', 'explode': True }})
    commit_rate_n: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'commit_rate__n', 'style': 'form', 'explode': True }})
    ...
    install_date_gt: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'install_date__gt', 'style': 'form', 'explode': True }})
    install_date_gte: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'install_date__gte', 'style': 'form', 'explode': True }})
    install_date_lt: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'install_date__lt', 'style': 'form', 'explode': True }})
    install_date_lte: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'install_date__lte', 'style': 'form', 'explode': True }})
    install_date_n: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'install_date__n', 'style': 'form', 'explode': True }})
    ...
    provider_n: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'provider__n', 'style': 'form', 'explode': True }})
    provider_id: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'provider_id', 'style': 'form', 'explode': True }})
    provider_id_n: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'provider_id__n', 'style': 'form', 'explode': True }})
