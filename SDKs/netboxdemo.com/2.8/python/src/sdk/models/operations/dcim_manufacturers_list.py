...
class DcimManufacturersListRequest:
    query_params: DcimManufacturersListQueryParams = field(default=None)
...
class DcimManufacturersList200ApplicationJSON:
    ...
    results: List[shared.Manufacturer] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'results' }})
...
class DcimManufacturersListResponse:
    ...
    dcim_manufacturers_list_200_application_json_object: Optional[DcimManufacturersList200ApplicationJSON] = field(default=None)
