...
class DcimManufacturersList200ApplicationJSON:
    ...
    results: List[shared.Manufacturer] = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
...
class DcimManufacturersListRequest:
    query_params: DcimManufacturersListQueryParams = field()
