...
class ExtrasExportTemplatesList200ApplicationJSON:
    ...
    results: List[shared.ExportTemplate] = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
...
class ExtrasExportTemplatesListRequest:
    query_params: ExtrasExportTemplatesListQueryParams = field()
