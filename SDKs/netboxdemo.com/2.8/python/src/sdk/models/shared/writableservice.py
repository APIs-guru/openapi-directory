...
class WritableServiceProtocolProtocolEnum(str, Enum):
    TCP = "tcp"
    UDP = "udp"
...
class WritableService:
    ...
    protocol: WritableServiceProtocolProtocolEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'protocol' }})
