...
@dataclass_json
@dataclass
class VirtualMachineInterfaceModeMode:
...
@dataclass_json
@dataclass
class VirtualMachineInterfaceTypeType:
...
class VirtualMachineInterface:
    ...
    mode: Optional[VirtualMachineInterfaceModeMode] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'mode' }})
    ...
    type: Optional[VirtualMachineInterfaceTypeType] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'type' }})
