...
class WritableDeviceWithConfigContextFaceRackFaceEnum(str, Enum):
    FRONT = "front"
    REAR = "rear"

class WritableDeviceWithConfigContextStatusStatusEnum(str, Enum):
    OFFLINE = "offline"
    ACTIVE = "active"
    PLANNED = "planned"
    STAGED = "staged"
...
class WritableDeviceWithConfigContext:
    ...
    face: Optional[WritableDeviceWithConfigContextFaceRackFaceEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'face' }})
    ...
    status: Optional[WritableDeviceWithConfigContextStatusStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
