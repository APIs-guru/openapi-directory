...
class WritableVrf:
    ...
    enforce_unique: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'enforce_unique' }})
    ...
    rd: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'rd' }})
