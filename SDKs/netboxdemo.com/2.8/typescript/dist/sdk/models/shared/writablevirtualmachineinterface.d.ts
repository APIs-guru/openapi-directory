...
export declare enum WritableVirtualMachineInterfaceModeEnum {
    Access = "access",
    Tagged = "tagged",
    TaggedAll = "tagged-all"
}
export declare enum WritableVirtualMachineInterfaceTypeEnum {
    Virtual = "virtual",
    Lag = "lag",
...
export declare class WritableVirtualMachineInterfaceInput extends SpeakeasyBase {
    description?: string;
    enabled?: boolean;
    macAddress?: string;
    mode?: WritableVirtualMachineInterfaceModeEnum;
    mtu?: number;
    name: string;
    taggedVlans?: number[];
    tags?: string[];
    type: WritableVirtualMachineInterfaceTypeEnum;
    untaggedVlan?: number;
