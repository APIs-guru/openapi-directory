...
export class DcimFrontPortsListQueryParams extends SpeakeasyBase {
...
export class DcimFrontPortsList200ApplicationJson extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ data: "json, name=results", elemType: shared.FrontPort })
  results: shared.FrontPort[];
}


export class DcimFrontPortsListRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  queryParams: DcimFrontPortsListQueryParams;
}


export class DcimFrontPortsListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
