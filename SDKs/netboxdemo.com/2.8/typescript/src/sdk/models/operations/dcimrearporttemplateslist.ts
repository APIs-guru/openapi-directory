...
export class DcimRearPortTemplatesListQueryParams extends SpeakeasyBase {
  ...
  @Metadata({ data: "queryParam, style=form;explode=true;name=positions" })
  positions?: string;

  @Metadata({ data: "queryParam, style=form;explode=true;name=positions__gt" })
  positionsGt?: string;

  @Metadata({ data: "queryParam, style=form;explode=true;name=positions__gte" })
  positionsGte?: string;

  @Metadata({ data: "queryParam, style=form;explode=true;name=positions__lt" })
  positionsLt?: string;

  @Metadata({ data: "queryParam, style=form;explode=true;name=positions__lte" })
  positionsLte?: string;

  @Metadata({ data: "queryParam, style=form;explode=true;name=positions__n" })
  positionsN?: string;
...
export class DcimRearPortTemplatesList200ApplicationJson extends SpeakeasyBase {
  ...
  @Metadata({ data: "json, name=results", elemType: shared.RearPortTemplate })
