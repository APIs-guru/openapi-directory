...
export class DcimPlatformsListQueryParams extends SpeakeasyBase {
  ...
  @Metadata({ data: "queryParam, style=form;explode=true;name=napalm_driver" })
  napalmDriver?: string;

  @Metadata({ data: "queryParam, style=form;explode=true;name=napalm_driver__ic" })
  napalmDriverIc?: string;

  @Metadata({ data: "queryParam, style=form;explode=true;name=napalm_driver__ie" })
  napalmDriverIe?: string;

  @Metadata({ data: "queryParam, style=form;explode=true;name=napalm_driver__iew" })
  napalmDriverIew?: string;

  @Metadata({ data: "queryParam, style=form;explode=true;name=napalm_driver__isw" })
  napalmDriverIsw?: string;

  @Metadata({ data: "queryParam, style=form;explode=true;name=napalm_driver__n" })
  napalmDriverN?: string;

  @Metadata({ data: "queryParam, style=form;explode=true;name=napalm_driver__nic" })
  napalmDriverNic?: string;

  @Metadata({ data: "queryParam, style=form;explode=true;name=napalm_driver__nie" })
  napalmDriverNie?: string;

  @Metadata({ data: "queryParam, style=form;explode=true;name=napalm_driver__niew" })
  napalmDriverNiew?: string;

  @Metadata({ data: "queryParam, style=form;explode=true;name=napalm_driver__nisw" })
