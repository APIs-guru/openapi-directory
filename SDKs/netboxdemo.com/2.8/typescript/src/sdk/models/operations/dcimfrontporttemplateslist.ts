...
export class DcimFrontPortTemplatesListQueryParams extends SpeakeasyBase {
...
export class DcimFrontPortTemplatesList200ApplicationJson extends SpeakeasyBase {
...
export class DcimFrontPortTemplatesListRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  queryParams: DcimFrontPortTemplatesListQueryParams;
}


export class DcimFrontPortTemplatesListResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
