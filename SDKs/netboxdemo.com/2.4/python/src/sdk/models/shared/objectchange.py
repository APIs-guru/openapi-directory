...
@dataclass
class ObjectChange:
    action: int = field(default=None, metadata={'dataclasses_json': { 'field_name': 'action' }})
    changed_object: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'changed_object' }})
