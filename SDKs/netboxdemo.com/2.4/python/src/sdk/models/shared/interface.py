...
@dataclass_json
@dataclass
class InterfaceFormFactorFormFactor:
...
class Interface:
    ...
    form_factor: Optional[InterfaceFormFactorFormFactor] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'form_factor' }})
    ...
    mode: Optional[InterfaceModeMode] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'mode' }})
