...
class Site:
    ...
    count_circuits: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('count_circuits') }})
    count_devices: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('count_devices') }})
    count_prefixes: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('count_prefixes') }})
    count_racks: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('count_racks') }})
    count_vlans: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('count_vlans') }})
