...
class DeviceWithConfigContext:
    ...
    face: Optional[DeviceWithConfigContextFace] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'face' }})
    ...
    status: Optional[DeviceWithConfigContextStatus] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
