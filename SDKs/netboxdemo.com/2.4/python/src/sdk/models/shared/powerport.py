...
class PowerPort:
    ...
    power_outlet: Optional[nestedpoweroutlet.NestedPowerOutlet] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'power_outlet' }})
