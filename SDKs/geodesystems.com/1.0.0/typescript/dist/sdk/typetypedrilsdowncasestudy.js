...
var TypeTypeDrilsdownCasestudy = /** @class */ (function () {
    function TypeTypeDrilsdownCasestudy(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    TypeTypeDrilsdownCasestudy.prototype.searchTypeDrilsdownCasestudy = function (req, config) {
...
export { TypeTypeDrilsdownCasestudy };
