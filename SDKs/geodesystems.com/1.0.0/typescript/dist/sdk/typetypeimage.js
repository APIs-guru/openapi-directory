...
var TypeTypeImage = /** @class */ (function () {
    function TypeTypeImage(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    TypeTypeImage.prototype.searchTypeImage = function (req, config) {
