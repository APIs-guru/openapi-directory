...
var SearchBiblioQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        Metadata({ data: "queryParam, style=form;explode=true;name=search.biblio.institution" }),
        __metadata("design:type", String)
    ], SearchBiblioQueryParams.prototype, "searchBiblioInstitution", void 0);
    __decorate([
        Metadata({ data: "queryParam, style=form;explode=true;name=search.biblio.other_authors" }),
        __metadata("design:type", String)
    ], SearchBiblioQueryParams.prototype, "searchBiblioOtherAuthors", void 0);
    __decorate([
        Metadata({ data: "queryParam, style=form;explode=true;name=search.biblio.primary_author" }),
        __metadata("design:type", String)
    ], SearchBiblioQueryParams.prototype, "searchBiblioPrimaryAuthor", void 0);
    __decorate([
        Metadata({ data: "queryParam, style=form;explode=true;name=search.biblio.publication" }),
        __metadata("design:type", String)
    ], SearchBiblioQueryParams.prototype, "searchBiblioPublication", void 0);
    __decorate([
        Metadata({ data: "queryParam, style=form;explode=true;name=search.biblio.type" }),
        __metadata("design:type", String)
