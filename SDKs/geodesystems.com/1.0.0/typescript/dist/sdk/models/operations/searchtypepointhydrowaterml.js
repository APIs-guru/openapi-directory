...
var SearchTypePointHydroWatermlQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=search.type_point_hydro_waterml.site_code" }),
        __metadata("design:type", String)
    ], SearchTypePointHydroWatermlQueryParams.prototype, "searchTypePointHydroWatermlSiteCode", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=search.type_point_hydro_waterml.site_name" }),
        __metadata("design:type", String)
