...
var SearchProjectDatasetQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=search.project_dataset.data_level" }),
        __metadata("design:type", String)
    ], SearchProjectDatasetQueryParams.prototype, "searchProjectDatasetDataLevel", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=search.project_dataset.data_type" }),
        __metadata("design:type", String)
    ], SearchProjectDatasetQueryParams.prototype, "searchProjectDatasetDataType", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=search.project_dataset.dataset_id" }),
        __metadata("design:type", String)
