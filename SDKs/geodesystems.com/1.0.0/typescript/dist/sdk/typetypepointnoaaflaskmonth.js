...
var TypeTypePointNoaaFlaskMonth = /** @class */ (function () {
    function TypeTypePointNoaaFlaskMonth(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    TypeTypePointNoaaFlaskMonth.prototype.searchTypePointNoaaFlaskMonth = function (req, config) {
...
export { TypeTypePointNoaaFlaskMonth };
