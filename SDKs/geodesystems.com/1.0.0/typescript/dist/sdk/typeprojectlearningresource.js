...
var TypeProjectLearningResource = /** @class */ (function () {
    function TypeProjectLearningResource(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    TypeProjectLearningResource.prototype.searchProjectLearningResource = function (req, config) {
...
export { TypeProjectLearningResource };
