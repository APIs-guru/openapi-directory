...
var TypeTypeMb = /** @class */ (function () {
    function TypeTypeMb(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    TypeTypeMb.prototype.searchTypeMb = function (req, config) {
