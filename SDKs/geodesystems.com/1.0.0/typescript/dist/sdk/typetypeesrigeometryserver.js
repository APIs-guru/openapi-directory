...
var TypeTypeEsriGeometryserver = /** @class */ (function () {
    function TypeTypeEsriGeometryserver(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    TypeTypeEsriGeometryserver.prototype.searchTypeEsriGeometryserver = function (req, config) {
...
export { TypeTypeEsriGeometryserver };
