...
var TypeTasks = /** @class */ (function () {
    function TypeTasks(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    TypeTasks.prototype.searchTasks = function (req, config) {
