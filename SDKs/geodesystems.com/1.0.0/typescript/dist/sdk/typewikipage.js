...
var TypeWikipage = /** @class */ (function () {
    function TypeWikipage(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    TypeWikipage.prototype.searchWikipage = function (req, config) {
