...
var TypeBioSam = /** @class */ (function () {
    function TypeBioSam(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    TypeBioSam.prototype.searchBioSam = function (req, config) {
