...
var TypeTmdbmovies = /** @class */ (function () {
    function TypeTmdbmovies(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    TypeTmdbmovies.prototype.searchTmdbmovies = function (req, config) {
