...
var TypeTypePointNoaaFlaskEvent = /** @class */ (function () {
    function TypeTypePointNoaaFlaskEvent(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    TypeTypePointNoaaFlaskEvent.prototype.searchTypePointNoaaFlaskEvent = function (req, config) {
...
export { TypeTypePointNoaaFlaskEvent };
