...
var TypeFtp = /** @class */ (function () {
    function TypeFtp(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    TypeFtp.prototype.searchFtp = function (req, config) {
