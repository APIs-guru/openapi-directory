...
var TypeChatroom = /** @class */ (function () {
    function TypeChatroom(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    TypeChatroom.prototype.searchChatroom = function (req, config) {
