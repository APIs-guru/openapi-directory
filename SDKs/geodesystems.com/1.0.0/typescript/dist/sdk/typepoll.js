...
var TypePoll = /** @class */ (function () {
    function TypePoll(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    TypePoll.prototype.searchPoll = function (req, config) {
