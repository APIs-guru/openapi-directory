...
export class TypeBoulderConsultingServices {
  ...
  searchBoulderConsultingServices(
    ...
    return client
      .request({
        ...
        const res: operations.SearchBoulderConsultingServicesResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
