...
export class SearchTypeCensusAcsQueryParams extends SpeakeasyBase {
  ...
  @Metadata({ data: "queryParam, style=form;explode=true;name=search.type_census_acs.fields" })
  searchTypeCensusAcsFields?: string;

  @Metadata({ data: "queryParam, style=form;explode=true;name=search.type_census_acs.for_type" })
  searchTypeCensusAcsForType?: string;

  @Metadata({ data: "queryParam, style=form;explode=true;name=search.type_census_acs.in_type1" })
  searchTypeCensusAcsInType1?: string;

  @Metadata({ data: "queryParam, style=form;explode=true;name=search.type_census_acs.in_type2" })
