...
export class SearchTypePointOpenaqQueryParams extends SpeakeasyBase {
  ...
  @Metadata({ data: "queryParam, style=form;explode=true;name=search.type_point_openaq.city" })
  searchTypePointOpenaqCity?: string;

  @Metadata({ data: "queryParam, style=form;explode=true;name=search.type_point_openaq.country" })
  searchTypePointOpenaqCountry?: string;

  @Metadata({ data: "queryParam, style=form;explode=true;name=search.type_point_openaq.hours_offset" })
  searchTypePointOpenaqHoursOffset?: number;

  @Metadata({ data: "queryParam, style=form;explode=true;name=search.type_point_openaq.location" })
