...
export class SearchFitsDataQueryParams extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=search.fits_data.instrument" })
  searchFitsDataInstrument?: string;

  @SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=search.fits_data.origin" })
  searchFitsDataOrigin?: string;

  @SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=search.fits_data.telescope" })
