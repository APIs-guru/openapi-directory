...
export class TypeTypePointOceanCsvSadoTts {
  ...
  searchTypePointOceanCsvSadoTts(
    ...
    return client
      .request({
        ...
        const res: operations.SearchTypePointOceanCsvSadoTtsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
