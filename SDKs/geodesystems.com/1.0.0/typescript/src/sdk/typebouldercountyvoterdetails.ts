...
export class TypeBoulderCountyVoterDetails {
  ...
  searchBoulderCountyVoterDetails(
    ...
    return client
      .request({
        ...
        const res: operations.SearchBoulderCountyVoterDetailsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
