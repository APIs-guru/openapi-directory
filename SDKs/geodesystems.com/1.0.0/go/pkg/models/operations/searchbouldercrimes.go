...
type SearchBoulderCrimesQueryParams struct {
    ...
    SearchDbBoulderCrimesBlockadd *string `queryParam:"style=form,explode=true,name=search.db_boulder_crimes.blockadd"`
    SearchDbBoulderCrimesLocation *string `queryParam:"style=form,explode=true,name=search.db_boulder_crimes.location"`
    SearchDbBoulderCrimesOffense *string `queryParam:"style=form,explode=true,name=search.db_boulder_crimes.offense"`
    SearchDbBoulderCrimesReportdate *string `queryParam:"style=form,explode=true,name=search.db_boulder_crimes.reportdate"`
...
type SearchBoulderCrimesRequest struct {
    QueryParams SearchBoulderCrimesQueryParams 
    
}

type SearchBoulderCrimesResponse struct {
    ContentType string 
    StatusCode int64 
