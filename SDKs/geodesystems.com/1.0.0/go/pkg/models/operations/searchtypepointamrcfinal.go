...
type SearchTypePointAmrcFinalQueryParams struct {
    ...
    SearchTypePointAmrcFinalArgosID *string `queryParam:"style=form,explode=true,name=search.type_point_amrc_final.argos_id"`
    SearchTypePointAmrcFinalSiteID *string `queryParam:"style=form,explode=true,name=search.type_point_amrc_final.site_id"`
    SearchTypePointAmrcFinalSiteName *string `queryParam:"style=form,explode=true,name=search.type_point_amrc_final.site_name"`
...
type SearchTypePointAmrcFinalRequest struct {
    QueryParams SearchTypePointAmrcFinalQueryParams 
    
}

type SearchTypePointAmrcFinalResponse struct {
    ContentType string 
    StatusCode int64 
