...
type SearchTypePointOceanCsvSadoPositionQueryParams struct {
...
type SearchTypePointOceanCsvSadoPositionRequest struct {
	QueryParams SearchTypePointOceanCsvSadoPositionQueryParams
}

type SearchTypePointOceanCsvSadoPositionResponse struct {
	ContentType string
	StatusCode  int64
}
