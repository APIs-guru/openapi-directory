...
type SearchBookmarksQueryParams struct {
	...
	SearchDbBookmarksCategory *string    `queryParam:"style=form,explode=true,name=search.db_bookmarks.category"`
	SearchDbBookmarksDate     *string    `queryParam:"style=form,explode=true,name=search.db_bookmarks.date"`
	SearchDbBookmarksTitle    *string    `queryParam:"style=form,explode=true,name=search.db_bookmarks.title"`
	SearchDbBookmarksURL      *string    `queryParam:"style=form,explode=true,name=search.db_bookmarks.url"`
