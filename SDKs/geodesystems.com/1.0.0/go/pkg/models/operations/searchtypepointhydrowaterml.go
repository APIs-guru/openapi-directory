...
type SearchTypePointHydroWatermlQueryParams struct {
    ...
    SearchTypePointHydroWatermlSiteCode *string `queryParam:"style=form,explode=true,name=search.type_point_hydro_waterml.site_code"`
    SearchTypePointHydroWatermlSiteName *string `queryParam:"style=form,explode=true,name=search.type_point_hydro_waterml.site_name"`
...
type SearchTypePointHydroWatermlRequest struct {
    QueryParams SearchTypePointHydroWatermlQueryParams 
    
}

type SearchTypePointHydroWatermlResponse struct {
    ContentType string 
    StatusCode int64 
