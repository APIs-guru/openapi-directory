...
type SearchProjectMeetingQueryParams struct {
	...
	SearchProjectMeetingLocation     *string    `queryParam:"style=form,explode=true,name=search.project_meeting.location"`
	SearchProjectMeetingParticipants *string    `queryParam:"style=form,explode=true,name=search.project_meeting.participants"`
	SearchProjectMeetingTopic        *string    `queryParam:"style=form,explode=true,name=search.project_meeting.topic"`
	Skip                             *int64     `queryParam:"style=form,explode=true,name=skip"`
	Text                             *string    `queryParam:"style=form,explode=true,name=text"`
	Todate                           *time.Time `queryParam:"style=form,explode=true,name=todate"`
}

type SearchProjectMeetingRequest struct {
	QueryParams SearchProjectMeetingQueryParams
}

type SearchProjectMeetingResponse struct {
	ContentType string
	StatusCode  int64
}
