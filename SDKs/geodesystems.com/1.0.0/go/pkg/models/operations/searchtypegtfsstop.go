...
type SearchTypeGtfsStopQueryParams struct {
    ...
    SearchTypeGtfsStopLocationType *string `queryParam:"style=form,explode=true,name=search.type_gtfs_stop.location_type"`
    SearchTypeGtfsStopStopCode *string `queryParam:"style=form,explode=true,name=search.type_gtfs_stop.stop_code"`
    SearchTypeGtfsStopStopID *string `queryParam:"style=form,explode=true,name=search.type_gtfs_stop.stop_id"`
    SearchTypeGtfsStopWheelchairBoarding *string `queryParam:"style=form,explode=true,name=search.type_gtfs_stop.wheelchair_boarding"`
    SearchTypeGtfsStopZoneID *string `queryParam:"style=form,explode=true,name=search.type_gtfs_stop.zone_id"`
...
type SearchTypeGtfsStopRequest struct {
    QueryParams SearchTypeGtfsStopQueryParams 
    
}

type SearchTypeGtfsStopResponse struct {
    ContentType string 
    StatusCode int64 
