...
type SearchTypeEsriGpserverQueryParams struct {
...
type SearchTypeEsriGpserverRequest struct {
    QueryParams SearchTypeEsriGpserverQueryParams 
    
}

type SearchTypeEsriGpserverResponse struct {
    ContentType string 
    StatusCode int64 
