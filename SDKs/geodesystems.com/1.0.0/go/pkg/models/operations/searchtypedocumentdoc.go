...
type SearchTypeDocumentDocQueryParams struct {
...
type SearchTypeDocumentDocRequest struct {
	QueryParams SearchTypeDocumentDocQueryParams
}

type SearchTypeDocumentDocResponse struct {
	ContentType string
	StatusCode  int64
}
