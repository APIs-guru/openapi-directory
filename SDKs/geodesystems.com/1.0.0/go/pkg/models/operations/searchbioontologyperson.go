...
type SearchBioOntologyPersonQueryParams struct {
	...
	SearchBioOntologyPersonGender *string    `queryParam:"style=form,explode=true,name=search.bio_ontology_person.gender"`
	Skip                          *int64     `queryParam:"style=form,explode=true,name=skip"`
	Text                          *string    `queryParam:"style=form,explode=true,name=text"`
	Todate                        *time.Time `queryParam:"style=form,explode=true,name=todate"`
}

type SearchBioOntologyPersonRequest struct {
	QueryParams SearchBioOntologyPersonQueryParams
}

type SearchBioOntologyPersonResponse struct {
	ContentType string
	StatusCode  int64
}
