...
type SearchStatusboardQueryParams struct {
    ...
    SearchDbStatusboardStatus *string `queryParam:"style=form,explode=true,name=search.db_statusboard.status"`
    SearchDbStatusboardWhat *string `queryParam:"style=form,explode=true,name=search.db_statusboard.what"`
...
type SearchStatusboardRequest struct {
    QueryParams SearchStatusboardQueryParams 
    
}

type SearchStatusboardResponse struct {
    ContentType string 
    StatusCode int64 
