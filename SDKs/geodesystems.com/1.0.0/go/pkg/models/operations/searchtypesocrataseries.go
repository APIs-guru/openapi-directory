...
type SearchTypeSocrataSeriesQueryParams struct {
...
type SearchTypeSocrataSeriesRequest struct {
    QueryParams SearchTypeSocrataSeriesQueryParams 
    
}

type SearchTypeSocrataSeriesResponse struct {
    ContentType string 
    StatusCode int64 
