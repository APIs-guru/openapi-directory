...
type SearchTypePointWsbbGgpQueryParams struct {
    ...
    SearchTypePointWsbbGgpAuthor *string `queryParam:"style=form,explode=true,name=search.type_point_wsbb_ggp.author"`
    SearchTypePointWsbbGgpInstrument *string `queryParam:"style=form,explode=true,name=search.type_point_wsbb_ggp.instrument"`
    SearchTypePointWsbbGgpStation *string `queryParam:"style=form,explode=true,name=search.type_point_wsbb_ggp.station"`
...
type SearchTypePointWsbbGgpRequest struct {
    QueryParams SearchTypePointWsbbGgpQueryParams 
    
}

type SearchTypePointWsbbGgpResponse struct {
    ContentType string 
    StatusCode int64 
