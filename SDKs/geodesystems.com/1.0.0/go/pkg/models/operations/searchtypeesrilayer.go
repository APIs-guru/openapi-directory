...
type SearchTypeEsriLayerQueryParams struct {
    ...
    SearchTypeEsriLayerLayerType *string `queryParam:"style=form,explode=true,name=search.type_esri_layer.layer_type"`
...
type SearchTypeEsriLayerRequest struct {
    QueryParams SearchTypeEsriLayerQueryParams 
    
}

type SearchTypeEsriLayerResponse struct {
    ContentType string 
    StatusCode int64 
