...
class SearchTypePointPboPositionTimeSeriesQueryParams:
    ...
    search_type_point_pbo_position_time_series_format_version: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_pbo_position_time_series.format_version', 'style': 'form', 'explode': True }})
    search_type_point_pbo_position_time_series_four_char_id: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_pbo_position_time_series.four_char_id', 'style': 'form', 'explode': True }})
    search_type_point_pbo_position_time_series_processing_center: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_pbo_position_time_series.processing_center', 'style': 'form', 'explode': True }})
    search_type_point_pbo_position_time_series_reference_frame: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_pbo_position_time_series.reference_frame', 'style': 'form', 'explode': True }})
    search_type_point_pbo_position_time_series_station_name: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_pbo_position_time_series.station_name', 'style': 'form', 'explode': True }})
...
class SearchTypePointPboPositionTimeSeriesRequest:
    query_params: SearchTypePointPboPositionTimeSeriesQueryParams = field(default=None)
