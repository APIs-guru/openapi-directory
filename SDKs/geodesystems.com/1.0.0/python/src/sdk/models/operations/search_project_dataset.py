...
class SearchProjectDatasetQueryParams:
    ...
    search_project_dataset_data_level: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.project_dataset.data_level', 'style': 'form', 'explode': True }})
    search_project_dataset_data_type: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.project_dataset.data_type', 'style': 'form', 'explode': True }})
    search_project_dataset_dataset_id: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.project_dataset.dataset_id', 'style': 'form', 'explode': True }})
...
class SearchProjectDatasetRequest:
    query_params: SearchProjectDatasetQueryParams = field(default=None)
