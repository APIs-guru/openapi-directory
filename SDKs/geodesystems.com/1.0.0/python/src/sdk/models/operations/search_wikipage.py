...
class SearchWikipageQueryParams:
    ...
    search_wikipage_category: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.wikipage.category', 'style': 'form', 'explode': True }})
    search_wikipage_wikitext: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.wikipage.wikitext', 'style': 'form', 'explode': True }})
