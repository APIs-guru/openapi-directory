...
@dataclass
class SearchEarthSatelliteLandsatQueryParams:
    ...
    search_earth_satellite_landsat_archive_version_number: Optional[int] = field(default=None, metadata={'query_param': { 'field_name': 'search.earth_satellite_landsat.archive_version_number', 'style': 'form', 'explode': True }})
    search_earth_satellite_landsat_ground_station: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.earth_satellite_landsat.ground_station', 'style': 'form', 'explode': True }})
    search_earth_satellite_landsat_satellite: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.earth_satellite_landsat.satellite', 'style': 'form', 'explode': True }})
    search_earth_satellite_landsat_sensor: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.earth_satellite_landsat.sensor', 'style': 'form', 'explode': True }})
    search_earth_satellite_landsat_wrs_path_number: Optional[int] = field(default=None, metadata={'query_param': { 'field_name': 'search.earth_satellite_landsat.wrs_path_number', 'style': 'form', 'explode': True }})
    search_earth_satellite_landsat_wrs_row_number: Optional[int] = field(default=None, metadata={'query_param': { 'field_name': 'search.earth_satellite_landsat.wrs_row_number', 'style': 'form', 'explode': True }})
