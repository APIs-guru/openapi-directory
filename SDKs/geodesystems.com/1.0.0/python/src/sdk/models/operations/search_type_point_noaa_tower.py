...
@dataclass
class SearchTypePointNoaaTowerQueryParams:
    ...
    search_type_point_noaa_tower_site_id: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_noaa_tower.site_id', 'style': 'form', 'explode': True }})
...
@dataclass
class SearchTypePointNoaaTowerRequest:
    query_params: SearchTypePointNoaaTowerQueryParams = field(default=None)
    

@dataclass
class SearchTypePointNoaaTowerResponse:
