...
@dataclass
class SearchCataloglinkQueryParams:
...
@dataclass
class SearchCataloglinkRequest:
    query_params: SearchCataloglinkQueryParams = field(default=None)
    

@dataclass
class SearchCataloglinkResponse:
