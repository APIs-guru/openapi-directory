...
@dataclass
class SearchTypeWmsLayerQueryParams:
...
@dataclass
class SearchTypeWmsLayerRequest:
    query_params: SearchTypeWmsLayerQueryParams = field(default=None)
    

@dataclass
class SearchTypeWmsLayerResponse:
