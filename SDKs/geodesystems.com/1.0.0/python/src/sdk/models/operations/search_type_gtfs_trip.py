...
class SearchTypeGtfsTripQueryParams:
    ...
    search_type_gtfs_trip_bikes_allowed: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_gtfs_trip.bikes_allowed', 'style': 'form', 'explode': True }})
    search_type_gtfs_trip_stop_ids: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_gtfs_trip.stop_ids', 'style': 'form', 'explode': True }})
    search_type_gtfs_trip_trip_id: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_gtfs_trip.trip_id', 'style': 'form', 'explode': True }})
    search_type_gtfs_trip_wheelchair_accessible: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_gtfs_trip.wheelchair_accessible', 'style': 'form', 'explode': True }})
