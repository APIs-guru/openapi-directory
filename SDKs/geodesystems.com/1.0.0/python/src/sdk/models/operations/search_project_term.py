...
class SearchProjectTermQueryParams:
    ...
    search_project_term_value: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.project_term.value', 'style': 'form', 'explode': True }})
...
class SearchProjectTermRequest:
    query_params: SearchProjectTermQueryParams = field(default=None)
