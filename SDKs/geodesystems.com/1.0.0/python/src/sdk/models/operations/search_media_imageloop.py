...
@dataclass
class SearchMediaImageloopQueryParams:
...
@dataclass
class SearchMediaImageloopRequest:
    query_params: SearchMediaImageloopQueryParams = field(default=None)
    

@dataclass
class SearchMediaImageloopResponse:
