...
@dataclass
class SearchTypePointOceanNetcdfTrackQueryParams:
    ...
    search_type_point_ocean_netcdf_track_platform: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_ocean_netcdf_track.platform', 'style': 'form', 'explode': True }})
...
@dataclass
class SearchTypePointOceanNetcdfTrackRequest:
    query_params: SearchTypePointOceanNetcdfTrackQueryParams = field(default=None)
