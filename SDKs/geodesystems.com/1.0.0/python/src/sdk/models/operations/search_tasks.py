...
class SearchTasksQueryParams:
    ...
    search_db_tasks_assignedto: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.db_tasks.assignedto', 'style': 'form', 'explode': True }})
    search_db_tasks_complete: Optional[float] = field(default=None, metadata={'query_param': { 'field_name': 'search.db_tasks.complete', 'style': 'form', 'explode': True }})
    search_db_tasks_enddate: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.db_tasks.enddate', 'style': 'form', 'explode': True }})
    search_db_tasks_priority: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.db_tasks.priority', 'style': 'form', 'explode': True }})
    search_db_tasks_startdate: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.db_tasks.startdate', 'style': 'form', 'explode': True }})
    search_db_tasks_status: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.db_tasks.status', 'style': 'form', 'explode': True }})
    search_db_tasks_title: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.db_tasks.title', 'style': 'form', 'explode': True }})
...
class SearchTasksRequest:
    query_params: SearchTasksQueryParams = field(default=None)
