...
class SearchCommunityResourceQueryParams:
    ...
    search_community_resource_address: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.community_resource.address', 'style': 'form', 'explode': True }})
    search_community_resource_city: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.community_resource.city', 'style': 'form', 'explode': True }})
    search_community_resource_resource_type: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.community_resource.resource_type', 'style': 'form', 'explode': True }})
    search_community_resource_state: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.community_resource.state', 'style': 'form', 'explode': True }})
    search_community_resource_zipcode: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.community_resource.zipcode', 'style': 'form', 'explode': True }})
...
class SearchCommunityResourceRequest:
    query_params: SearchCommunityResourceQueryParams = field(default=None)
