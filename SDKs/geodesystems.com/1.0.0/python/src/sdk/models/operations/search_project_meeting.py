...
class SearchProjectMeetingQueryParams:
    ...
    search_project_meeting_location: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.project_meeting.location', 'style': 'form', 'explode': True }})
    search_project_meeting_participants: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.project_meeting.participants', 'style': 'form', 'explode': True }})
    search_project_meeting_topic: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.project_meeting.topic', 'style': 'form', 'explode': True }})
...
class SearchProjectMeetingRequest:
    query_params: SearchProjectMeetingQueryParams = field(default=None)
