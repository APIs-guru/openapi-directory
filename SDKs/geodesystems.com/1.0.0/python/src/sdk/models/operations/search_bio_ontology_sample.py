...
@dataclass
class SearchBioOntologySampleQueryParams:
...
@dataclass
class SearchBioOntologySampleRequest:
    query_params: SearchBioOntologySampleQueryParams = field(default=None)
    

@dataclass
class SearchBioOntologySampleResponse:
