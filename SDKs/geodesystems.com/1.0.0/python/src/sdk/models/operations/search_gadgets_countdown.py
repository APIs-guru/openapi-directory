...
@dataclass
class SearchGadgetsCountdownQueryParams:
...
@dataclass
class SearchGadgetsCountdownRequest:
    query_params: SearchGadgetsCountdownQueryParams = field(default=None)
    

@dataclass
class SearchGadgetsCountdownResponse:
