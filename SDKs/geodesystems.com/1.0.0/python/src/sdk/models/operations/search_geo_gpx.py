...
class SearchGeoGpxQueryParams:
    ...
    search_geo_gpx_distance: Optional[float] = field(default=None, metadata={'query_param': { 'field_name': 'search.geo_gpx.distance', 'style': 'form', 'explode': True }})
    search_geo_gpx_elevation_gain: Optional[float] = field(default=None, metadata={'query_param': { 'field_name': 'search.geo_gpx.elevation_gain', 'style': 'form', 'explode': True }})
    search_geo_gpx_elevation_loss: Optional[float] = field(default=None, metadata={'query_param': { 'field_name': 'search.geo_gpx.elevation_loss', 'style': 'form', 'explode': True }})
    search_geo_gpx_moving_time: Optional[float] = field(default=None, metadata={'query_param': { 'field_name': 'search.geo_gpx.moving_time', 'style': 'form', 'explode': True }})
    search_geo_gpx_speed: Optional[float] = field(default=None, metadata={'query_param': { 'field_name': 'search.geo_gpx.speed', 'style': 'form', 'explode': True }})
    search_geo_gpx_total_time: Optional[float] = field(default=None, metadata={'query_param': { 'field_name': 'search.geo_gpx.total_time', 'style': 'form', 'explode': True }})
...
class SearchGeoGpxRequest:
    query_params: SearchGeoGpxQueryParams = field(default=None)
