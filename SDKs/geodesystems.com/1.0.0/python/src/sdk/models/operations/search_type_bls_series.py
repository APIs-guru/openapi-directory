...
class SearchTypeBlsSeriesQueryParams:
    ...
    search_type_bls_series_area: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_bls_series.area', 'style': 'form', 'explode': True }})
    search_type_bls_series_industry: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_bls_series.industry', 'style': 'form', 'explode': True }})
    search_type_bls_series_item: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_bls_series.item', 'style': 'form', 'explode': True }})
    search_type_bls_series_measure_data_type: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_bls_series.measure_data_type', 'style': 'form', 'explode': True }})
    search_type_bls_series_seasonality: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_bls_series.seasonality', 'style': 'form', 'explode': True }})
    search_type_bls_series_sector: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_bls_series.sector', 'style': 'form', 'explode': True }})
    search_type_bls_series_survey_name: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_bls_series.survey_name', 'style': 'form', 'explode': True }})
...
class SearchTypeBlsSeriesRequest:
    query_params: SearchTypeBlsSeriesQueryParams = field(default=None)
