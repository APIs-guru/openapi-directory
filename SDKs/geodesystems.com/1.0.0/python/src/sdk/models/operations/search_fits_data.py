...
class SearchFitsDataQueryParams:
    ...
    search_fits_data_instrument: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.fits_data.instrument', 'style': 'form', 'explode': True }})
    search_fits_data_origin: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.fits_data.origin', 'style': 'form', 'explode': True }})
    search_fits_data_telescope: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.fits_data.telescope', 'style': 'form', 'explode': True }})
...
class SearchFitsDataRequest:
    query_params: SearchFitsDataQueryParams = field(default=None)
