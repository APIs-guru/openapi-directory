...
@dataclass
class SearchTypePointIcebridgeAtmQfitQueryParams:
...
class SearchTypePointIcebridgeAtmQfitRequest:
    query_params: SearchTypePointIcebridgeAtmQfitQueryParams = field(default=None)
    

@dataclass
class SearchTypePointIcebridgeAtmQfitResponse:
