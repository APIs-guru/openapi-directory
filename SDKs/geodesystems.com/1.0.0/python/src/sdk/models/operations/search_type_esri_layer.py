...
class SearchTypeEsriLayerQueryParams:
    ...
    search_type_esri_layer_layer_type: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_esri_layer.layer_type', 'style': 'form', 'explode': True }})
...
class SearchTypeEsriLayerRequest:
    query_params: SearchTypeEsriLayerQueryParams = field(default=None)
