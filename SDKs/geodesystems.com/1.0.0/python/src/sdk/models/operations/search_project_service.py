...
class SearchProjectServiceQueryParams:
    ...
    search_project_service_provider: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.project_service.provider', 'style': 'form', 'explode': True }})
    search_project_service_service_type: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.project_service.service_type', 'style': 'form', 'explode': True }})
...
class SearchProjectServiceRequest:
    query_params: SearchProjectServiceQueryParams = field(default=None)
