...
class SearchTypePointGeomagIaga2002QueryParams:
    ...
    search_type_point_geomag_iaga2002_data_interval: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_geomag_iaga2002.data_interval', 'style': 'form', 'explode': True }})
    search_type_point_geomag_iaga2002_data_type: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_geomag_iaga2002.data_type', 'style': 'form', 'explode': True }})
    search_type_point_geomag_iaga2002_digital_sampling: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_geomag_iaga2002.digital_sampling', 'style': 'form', 'explode': True }})
    search_type_point_geomag_iaga2002_iaga_code: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_geomag_iaga2002.iaga_code', 'style': 'form', 'explode': True }})
    search_type_point_geomag_iaga2002_source_of_data: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_geomag_iaga2002.source_of_data', 'style': 'form', 'explode': True }})
    search_type_point_geomag_iaga2002_station_name: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_geomag_iaga2002.station_name', 'style': 'form', 'explode': True }})
