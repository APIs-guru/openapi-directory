...
@dataclass
class SearchTypePointOpenaqQueryParams:
    ...
    search_type_point_openaq_city: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_openaq.city', 'style': 'form', 'explode': True }})
    search_type_point_openaq_country: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_openaq.country', 'style': 'form', 'explode': True }})
    search_type_point_openaq_hours_offset: Optional[int] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_openaq.hours_offset', 'style': 'form', 'explode': True }})
    search_type_point_openaq_location: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.type_point_openaq.location', 'style': 'form', 'explode': True }})
...
class SearchTypePointOpenaqRequest:
    query_params: SearchTypePointOpenaqQueryParams = field(default=None)
    

@dataclass
class SearchTypePointOpenaqResponse:
