...
class SearchBiblioQueryParams:
    ...
    search_biblio_institution: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.biblio.institution', 'style': 'form', 'explode': True }})
    search_biblio_other_authors: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.biblio.other_authors', 'style': 'form', 'explode': True }})
    search_biblio_primary_author: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.biblio.primary_author', 'style': 'form', 'explode': True }})
    search_biblio_publication: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.biblio.publication', 'style': 'form', 'explode': True }})
    search_biblio_type: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.biblio.type', 'style': 'form', 'explode': True }})
...
class SearchBiblioRequest:
    query_params: SearchBiblioQueryParams = field(default=None)
