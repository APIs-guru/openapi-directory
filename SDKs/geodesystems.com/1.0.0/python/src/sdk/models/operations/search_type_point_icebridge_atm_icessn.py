...
@dataclass
class SearchTypePointIcebridgeAtmIcessnQueryParams:
...
@dataclass
class SearchTypePointIcebridgeAtmIcessnRequest:
    query_params: SearchTypePointIcebridgeAtmIcessnQueryParams = field(default=None)
