...
@dataclass
class SearchContactQueryParams:
    ...
    search_db_contact_email: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.db_contact.email', 'style': 'form', 'explode': True }})
    search_db_contact_institution: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.db_contact.institution', 'style': 'form', 'explode': True }})
    search_db_contact_name: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.db_contact.name', 'style': 'form', 'explode': True }})
