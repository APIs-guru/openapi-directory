...
@dataclass
class SearchTypeEiaCategoryQueryParams:
...
@dataclass
class SearchTypeEiaCategoryRequest:
    query_params: SearchTypeEiaCategoryQueryParams = field(default=None)
    

@dataclass
class SearchTypeEiaCategoryResponse:
