...
class SearchNotesQueryParams:
    ...
    search_db_notes_note: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.db_notes.note', 'style': 'form', 'explode': True }})
...
class SearchNotesRequest:
    query_params: SearchNotesQueryParams = field(default=None)
