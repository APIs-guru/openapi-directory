...
@dataclass
class SearchTypePointIcebridgeParisQueryParams:
...
@dataclass
class SearchTypePointIcebridgeParisRequest:
    query_params: SearchTypePointIcebridgeParisQueryParams = field(default=None)
