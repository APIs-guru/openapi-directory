...
class SearchProjectLearningResourceQueryParams:
    ...
    search_project_learning_resource_grade_level: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.project_learning_resource.grade_level', 'style': 'form', 'explode': True }})
    search_project_learning_resource_topic: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'search.project_learning_resource.topic', 'style': 'form', 'explode': True }})
...
class SearchProjectLearningResourceRequest:
    query_params: SearchProjectLearningResourceQueryParams = field(default=None)
