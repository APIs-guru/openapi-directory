...
from . import userembeddedobject
from . import links
...
class UserHalResponse:
    embedded: Optional[userembeddedobject.UserEmbeddedObject] = field(default=None, metadata={'dataclasses_json': { 'field_name': '_embedded' }})
