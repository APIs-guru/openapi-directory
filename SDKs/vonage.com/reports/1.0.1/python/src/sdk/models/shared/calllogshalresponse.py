...
from . import calllogsembeddedobject
from . import links
...
class CallLogsHalResponse:
    embedded: Optional[calllogsembeddedobject.CallLogsEmbeddedObject] = field(default=None, metadata={'dataclasses_json': { 'field_name': '_embedded' }})
    ...
    total_page: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'total_page' }})
