...
from . import enduserrouteembeddedobject
from . import links
...
class EndUserRouteHalResponse:
    embedded: Optional[enduserrouteembeddedobject.EndUserRouteEmbeddedObject] = field(default=None, metadata={'dataclasses_json': { 'field_name': '_embedded' }})
