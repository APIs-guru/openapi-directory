...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.CallAnswer = function (req, config) {
    ...
    SDK.prototype.CallHold = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.CallTransfer = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    // CallUnold - Unhold
    SDK.prototype.CallUnold = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.CallVmTransfer = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.CreateWebhook = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/self/webhooks";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.DestroyCall = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.DestroyWebhook = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DestroyWebhookRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/self/webhooks/{id}", req.pathParams);
        var client = this.defaultClient;
        return client
            .delete(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.GetAccount = function (config) {
        var baseURL = this.serverURL;
    ...
    SDK.prototype.GetCallsCount = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.GetEvent = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/self/events/{id}", req.pathParams);
        var client = this.defaultClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.GetEventsCount = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetEventsCountRequest(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/self/events/count";
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    // GetRoles - Get a call
    SDK.prototype.GetRoles = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    // GetUser - User info
    SDK.prototype.GetUser = function (config) {
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/self";
        var client = this.defaultClient;
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    **/
    SDK.prototype.ListCalls = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    SDK.prototype.ListEvents = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/self/events";
        var client = this.defaultClient;
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
    ...
    SDK.prototype.ListWebhooks = function (config) {
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/self/webhooks";
        var client = this.defaultClient;
        return client
    ...
    SDK.prototype.RenewWebhook = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RenewWebhookRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/self/webhooks/{id}/renew", req.pathParams);
        var client = this.defaultClient;
        return client
            .put(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    SDK.prototype.ViewWebhook = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
