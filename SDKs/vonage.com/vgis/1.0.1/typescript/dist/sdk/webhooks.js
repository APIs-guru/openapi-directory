...
var Webhooks = /** @class */ (function () {
    ...
    **/
    Webhooks.prototype.destroyWebhook = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Webhooks.prototype.renewWebhook = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Webhooks.prototype.viewWebhook = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
