...
from . import accountembeddedobject
from . import links
...
class AccountHalResponse:
    embedded: Optional[accountembeddedobject.AccountEmbeddedObject] = field(default=None, metadata={'dataclasses_json': { 'field_name': '_embedded' }})
