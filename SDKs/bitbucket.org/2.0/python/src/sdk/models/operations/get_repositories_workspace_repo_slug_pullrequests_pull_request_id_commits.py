...
class GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDCommitsRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDCommitsPathParams = field()
    security: GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDCommitsSecurity = field()
