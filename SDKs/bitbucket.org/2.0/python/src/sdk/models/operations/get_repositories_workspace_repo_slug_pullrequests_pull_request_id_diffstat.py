...
class GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDDiffstatRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDDiffstatPathParams = field()
    security: GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDDiffstatSecurity = field()
