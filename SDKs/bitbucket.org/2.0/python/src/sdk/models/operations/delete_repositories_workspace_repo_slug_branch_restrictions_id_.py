...
class DeleteRepositoriesWorkspaceRepoSlugBranchRestrictionsIDRequest:
    path_params: DeleteRepositoriesWorkspaceRepoSlugBranchRestrictionsIDPathParams = field()
    security: DeleteRepositoriesWorkspaceRepoSlugBranchRestrictionsIDSecurity = field()
