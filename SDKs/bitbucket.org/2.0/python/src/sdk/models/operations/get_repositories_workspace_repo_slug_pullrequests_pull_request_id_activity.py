...
class GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDActivityRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDActivityPathParams = field()
    security: GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDActivitySecurity = field()
