...
class GetRepositoriesWorkspaceRepoSlugDefaultReviewersTargetUsernameRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugDefaultReviewersTargetUsernamePathParams = field()
    security: GetRepositoriesWorkspaceRepoSlugDefaultReviewersTargetUsernameSecurity = field()
