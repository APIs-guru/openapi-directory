...
class GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDCommentsRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDCommentsPathParams = field()
    security: GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDCommentsSecurity = field()
...
class GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDCommentsResponse:
    ...
    paginated_pullrequest_comments: Optional[shared.PaginatedPullrequestComments] = field(default=None)
