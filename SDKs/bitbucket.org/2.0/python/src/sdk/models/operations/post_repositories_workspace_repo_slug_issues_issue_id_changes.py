...
class PostRepositoriesWorkspaceRepoSlugIssuesIssueIDChangesRequest:
    path_params: PostRepositoriesWorkspaceRepoSlugIssuesIssueIDChangesPathParams = field()
    request: dict[str, Any] = field(metadata={'request': { 'media_type': 'application/json' }})
    security: PostRepositoriesWorkspaceRepoSlugIssuesIssueIDChangesSecurity = field()
