...
class GetRepositoriesWorkspaceRepoSlugIssuesIssueIDCommentsCommentIDRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugIssuesIssueIDCommentsCommentIDPathParams = field()
    security: GetRepositoriesWorkspaceRepoSlugIssuesIssueIDCommentsCommentIDSecurity = field()
