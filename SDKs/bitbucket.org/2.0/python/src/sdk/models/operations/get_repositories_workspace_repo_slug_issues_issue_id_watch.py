...
class GetRepositoriesWorkspaceRepoSlugIssuesIssueIDWatchRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugIssuesIssueIDWatchPathParams = field()
    security: GetRepositoriesWorkspaceRepoSlugIssuesIssueIDWatchSecurity = field()
