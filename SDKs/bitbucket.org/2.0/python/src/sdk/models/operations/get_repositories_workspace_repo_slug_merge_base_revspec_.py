...
class GetRepositoriesWorkspaceRepoSlugMergeBaseRevspecPathParams:
    ...
    revspec: str = field(metadata={'path_param': { 'field_name': 'revspec', 'style': 'simple', 'explode': False }})
...
class GetRepositoriesWorkspaceRepoSlugMergeBaseRevspecRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugMergeBaseRevspecPathParams = field()
    security: GetRepositoriesWorkspaceRepoSlugMergeBaseRevspecSecurity = field()
