...
class GetRepositoriesWorkspaceRepoSlugIssuesIssueIDChangesChangeIDPathParams:
    change_id: str = field(metadata={'path_param': { 'field_name': 'change_id', 'style': 'simple', 'explode': False }})
...
class GetRepositoriesWorkspaceRepoSlugIssuesIssueIDChangesChangeIDRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugIssuesIssueIDChangesChangeIDPathParams = field()
    security: GetRepositoriesWorkspaceRepoSlugIssuesIssueIDChangesChangeIDSecurity = field()
