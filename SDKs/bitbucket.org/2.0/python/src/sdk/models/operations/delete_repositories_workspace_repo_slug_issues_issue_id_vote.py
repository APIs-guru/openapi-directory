...
class DeleteRepositoriesWorkspaceRepoSlugIssuesIssueIDVoteRequest:
    path_params: DeleteRepositoriesWorkspaceRepoSlugIssuesIssueIDVotePathParams = field()
    security: DeleteRepositoriesWorkspaceRepoSlugIssuesIssueIDVoteSecurity = field()
