...
class DeleteRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDApproveRequest:
    path_params: DeleteRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDApprovePathParams = field()
    security: DeleteRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDApproveSecurity = field()
