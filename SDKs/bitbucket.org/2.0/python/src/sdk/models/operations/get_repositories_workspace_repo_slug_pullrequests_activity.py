...
class GetRepositoriesWorkspaceRepoSlugPullrequestsActivityRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugPullrequestsActivityPathParams = field()
    security: GetRepositoriesWorkspaceRepoSlugPullrequestsActivitySecurity = field()
