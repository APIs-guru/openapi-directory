...
class DeleteRepositoriesWorkspaceRepoSlugDownloadsFilenameRequest:
    path_params: DeleteRepositoriesWorkspaceRepoSlugDownloadsFilenamePathParams = field()
    security: DeleteRepositoriesWorkspaceRepoSlugDownloadsFilenameSecurity = field()
