...
class PutRepositoriesWorkspaceRepoSlugDefaultReviewersTargetUsernameRequest:
    path_params: PutRepositoriesWorkspaceRepoSlugDefaultReviewersTargetUsernamePathParams = field()
    security: PutRepositoriesWorkspaceRepoSlugDefaultReviewersTargetUsernameSecurity = field()
