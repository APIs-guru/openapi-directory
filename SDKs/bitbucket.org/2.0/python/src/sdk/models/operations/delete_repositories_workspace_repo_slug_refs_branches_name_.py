...
class DeleteRepositoriesWorkspaceRepoSlugRefsBranchesNameRequest:
    path_params: DeleteRepositoriesWorkspaceRepoSlugRefsBranchesNamePathParams = field()
    security: DeleteRepositoriesWorkspaceRepoSlugRefsBranchesNameSecurity = field()
