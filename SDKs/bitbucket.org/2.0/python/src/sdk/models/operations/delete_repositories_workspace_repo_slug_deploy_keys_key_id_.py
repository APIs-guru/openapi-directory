...
class DeleteRepositoriesWorkspaceRepoSlugDeployKeysKeyIDRequest:
    path_params: DeleteRepositoriesWorkspaceRepoSlugDeployKeysKeyIDPathParams = field()
    security: DeleteRepositoriesWorkspaceRepoSlugDeployKeysKeyIDSecurity = field()
