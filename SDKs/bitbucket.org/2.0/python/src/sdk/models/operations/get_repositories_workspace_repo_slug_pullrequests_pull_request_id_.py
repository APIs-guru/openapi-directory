...
class GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDRequest:
    path_params: GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDPathParams = field()
    security: GetRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIDSecurity = field()
