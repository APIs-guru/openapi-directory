...
class PostRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildRequest:
    path_params: PostRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildPathParams = field()
    security: PostRepositoriesWorkspaceRepoSlugCommitCommitStatusesBuildSecurity = field()
