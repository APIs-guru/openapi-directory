...
class DeleteRepositoriesWorkspaceRepoSlugCommitCommitApproveRequest:
    path_params: DeleteRepositoriesWorkspaceRepoSlugCommitCommitApprovePathParams = field()
    security: DeleteRepositoriesWorkspaceRepoSlugCommitCommitApproveSecurity = field()
