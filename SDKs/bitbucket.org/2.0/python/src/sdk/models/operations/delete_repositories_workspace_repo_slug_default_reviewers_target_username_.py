...
class DeleteRepositoriesWorkspaceRepoSlugDefaultReviewersTargetUsernamePathParams:
    ...
    target_username: str = field(metadata={'path_param': { 'field_name': 'target_username', 'style': 'simple', 'explode': False }})
...
class DeleteRepositoriesWorkspaceRepoSlugDefaultReviewersTargetUsernameRequest:
    path_params: DeleteRepositoriesWorkspaceRepoSlugDefaultReviewersTargetUsernamePathParams = field()
    security: DeleteRepositoriesWorkspaceRepoSlugDefaultReviewersTargetUsernameSecurity = field()
