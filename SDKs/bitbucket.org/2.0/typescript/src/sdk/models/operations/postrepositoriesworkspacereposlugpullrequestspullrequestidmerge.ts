...
export class PostRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIdMergeQueryParams extends SpeakeasyBase {
  @Metadata({ data: "queryParam, style=form;explode=true;name=async" })
  async?: boolean;
}


export class PostRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIdMergeSecurityOption1 extends SpeakeasyBase {
  @Metadata({ data: "security, scheme=true;type=oauth2" })
  oauth2: shared.SchemeOauth2;
}


export class PostRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIdMergeSecurityOption2 extends SpeakeasyBase {
  @Metadata({ data: "security, scheme=true;type=http;subtype=basic" })
  basic: shared.SchemeBasic;
}


export class PostRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIdMergeSecurityOption3 extends SpeakeasyBase {
...
export class PostRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIdMergeSecurity extends SpeakeasyBase {
  ...
  option1?: PostRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIdMergeSecurityOption1;

  @Metadata({ data: "security, option=true" })
  option2?: PostRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIdMergeSecurityOption2;

  @Metadata({ data: "security, option=true" })
  option3?: PostRepositoriesWorkspaceRepoSlugPullrequestsPullRequestIdMergeSecurityOption3;
}
