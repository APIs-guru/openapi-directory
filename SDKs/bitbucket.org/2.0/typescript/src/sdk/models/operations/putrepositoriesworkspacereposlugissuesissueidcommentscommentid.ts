...
export class PutRepositoriesWorkspaceRepoSlugIssuesIssueIdCommentsCommentIdSecurityOption1 extends SpeakeasyBase {
  @Metadata({ data: "security, scheme=true;type=oauth2" })
  oauth2: shared.SchemeOauth2;
}


export class PutRepositoriesWorkspaceRepoSlugIssuesIssueIdCommentsCommentIdSecurityOption2 extends SpeakeasyBase {
  @Metadata({ data: "security, scheme=true;type=http;subtype=basic" })
  basic: shared.SchemeBasic;
}


export class PutRepositoriesWorkspaceRepoSlugIssuesIssueIdCommentsCommentIdSecurityOption3 extends SpeakeasyBase {
...
export class PutRepositoriesWorkspaceRepoSlugIssuesIssueIdCommentsCommentIdSecurity extends SpeakeasyBase {
  ...
  option1?: PutRepositoriesWorkspaceRepoSlugIssuesIssueIdCommentsCommentIdSecurityOption1;

  @Metadata({ data: "security, option=true" })
  option2?: PutRepositoriesWorkspaceRepoSlugIssuesIssueIdCommentsCommentIdSecurityOption2;

  @Metadata({ data: "security, option=true" })
  option3?: PutRepositoriesWorkspaceRepoSlugIssuesIssueIdCommentsCommentIdSecurityOption3;
}
