...
class OoxmlDocument:
    ...
    delete_target_on_story_delete: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'delete_target_on_story_delete' }})
    id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'id' }})
    ooxml_automation_id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ooxml_automation_id' }})
