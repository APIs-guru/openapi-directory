...
class ListSessionsOfAuthorUsingPost200ApplicationJSONData:
    sessions: Optional[List[ListSessionsOfAuthorUsingPost200ApplicationJSONDataSessions]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sessions') }})
...
class ListSessionsOfAuthorUsingPost200ApplicationJSON:
    ...
    data: Optional[ListSessionsOfAuthorUsingPost200ApplicationJSONData] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class ListSessionsOfAuthorUsingPostRequest:
    query_params: ListSessionsOfAuthorUsingPostQueryParams = field()
