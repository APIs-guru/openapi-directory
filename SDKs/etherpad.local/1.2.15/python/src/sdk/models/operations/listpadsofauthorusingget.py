...
class ListPadsOfAuthorUsingGet200ApplicationJSON:
    ...
    data: Optional[ListPadsOfAuthorUsingGet200ApplicationJSONData] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class ListPadsOfAuthorUsingGetRequest:
    query_params: ListPadsOfAuthorUsingGetQueryParams = field()
