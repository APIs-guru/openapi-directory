...
class ListAuthorsOfPadUsingGet200ApplicationJSON:
    ...
    data: Optional[ListAuthorsOfPadUsingGet200ApplicationJSONData] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class ListAuthorsOfPadUsingGetRequest:
    query_params: ListAuthorsOfPadUsingGetQueryParams = field()
