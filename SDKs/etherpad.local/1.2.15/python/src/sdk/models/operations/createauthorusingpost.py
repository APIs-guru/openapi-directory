...
class CreateAuthorUsingPostRequest:
    query_params: CreateAuthorUsingPostQueryParams = field(default=None)
...
class CreateAuthorUsingPost200ApplicationJSON:
    ...
    data: Optional[CreateAuthorUsingPost200ApplicationJSONData] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'data' }})
