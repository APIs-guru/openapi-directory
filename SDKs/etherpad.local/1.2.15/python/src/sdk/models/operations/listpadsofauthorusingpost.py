...
class ListPadsOfAuthorUsingPost200ApplicationJSON:
    ...
    data: Optional[ListPadsOfAuthorUsingPost200ApplicationJSONData] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class ListPadsOfAuthorUsingPostRequest:
    query_params: ListPadsOfAuthorUsingPostQueryParams = field()
