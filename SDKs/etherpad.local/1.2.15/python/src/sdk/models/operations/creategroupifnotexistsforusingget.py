...
class CreateGroupIfNotExistsForUsingGet200ApplicationJSON:
    ...
    data: Optional[CreateGroupIfNotExistsForUsingGet200ApplicationJSONData] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class CreateGroupIfNotExistsForUsingGetRequest:
    query_params: CreateGroupIfNotExistsForUsingGetQueryParams = field()
