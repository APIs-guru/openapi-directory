...
class ListAuthorsOfPadUsingPostRequest:
    query_params: ListAuthorsOfPadUsingPostQueryParams = field(default=None)
...
class ListAuthorsOfPadUsingPost200ApplicationJSON:
    ...
    data: Optional[ListAuthorsOfPadUsingPost200ApplicationJSONData] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'data' }})
