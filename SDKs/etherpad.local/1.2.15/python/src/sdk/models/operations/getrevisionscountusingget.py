...
class GetRevisionsCountUsingGetRequest:
    query_params: GetRevisionsCountUsingGetQueryParams = field(default=None)
...
class GetRevisionsCountUsingGet200ApplicationJSON:
    ...
    data: Optional[GetRevisionsCountUsingGet200ApplicationJSONData] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'data' }})
