...
class CreateGroupIfNotExistsForUsingPost200ApplicationJSON:
    ...
    data: Optional[CreateGroupIfNotExistsForUsingPost200ApplicationJSONData] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class CreateGroupIfNotExistsForUsingPostRequest:
    query_params: CreateGroupIfNotExistsForUsingPostQueryParams = field()
