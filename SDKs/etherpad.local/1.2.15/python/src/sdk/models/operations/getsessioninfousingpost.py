...
class GetSessionInfoUsingPost200ApplicationJSONData:
    info: Optional[GetSessionInfoUsingPost200ApplicationJSONDataInfo] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('info') }})
...
class GetSessionInfoUsingPost200ApplicationJSON:
    ...
    data: Optional[GetSessionInfoUsingPost200ApplicationJSONData] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class GetSessionInfoUsingPostRequest:
    query_params: GetSessionInfoUsingPostQueryParams = field()
