...
class ListSessionsOfAuthorUsingGetRequest:
    query_params: ListSessionsOfAuthorUsingGetQueryParams = field(default=None)
...
class ListSessionsOfAuthorUsingGet200ApplicationJSONData:
    sessions: Optional[List[ListSessionsOfAuthorUsingGet200ApplicationJSONDataSessions]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'sessions' }})
...
class ListSessionsOfAuthorUsingGet200ApplicationJSON:
    ...
    data: Optional[ListSessionsOfAuthorUsingGet200ApplicationJSONData] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'data' }})
