...
class GetChatHeadUsingPost200ApplicationJSONData:
    chat_head: Optional[GetChatHeadUsingPost200ApplicationJSONDataChatHead] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('chatHead') }})
...
class GetChatHeadUsingPost200ApplicationJSON:
    ...
    data: Optional[GetChatHeadUsingPost200ApplicationJSONData] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class GetChatHeadUsingPostRequest:
    query_params: GetChatHeadUsingPostQueryParams = field()
