...
class PadUsersUsingPostRequest:
    query_params: PadUsersUsingPostQueryParams = field(default=None)
...
class PadUsersUsingPost200ApplicationJSONData:
    pad_users: Optional[List[PadUsersUsingPost200ApplicationJSONDataPadUsers]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'padUsers' }})
...
class PadUsersUsingPost200ApplicationJSON:
    ...
    data: Optional[PadUsersUsingPost200ApplicationJSONData] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'data' }})
