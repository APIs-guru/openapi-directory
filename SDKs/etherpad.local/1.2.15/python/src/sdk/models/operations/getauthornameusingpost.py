...
class GetAuthorNameUsingPost200ApplicationJSONData:
    info: Optional[GetAuthorNameUsingPost200ApplicationJSONDataInfo] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('info') }})
...
class GetAuthorNameUsingPost200ApplicationJSON:
    ...
    data: Optional[GetAuthorNameUsingPost200ApplicationJSONData] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class GetAuthorNameUsingPostRequest:
    query_params: GetAuthorNameUsingPostQueryParams = field()
