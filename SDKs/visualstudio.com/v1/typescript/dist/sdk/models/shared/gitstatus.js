...
var GitStatus = /** @class */ (function (_super) {
    __extends(GitStatus, _super);
    function GitStatus() {
    ...
    ], GitStatus.prototype, "branch", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=commit" }),
        __metadata("design:type", String)
    ], GitStatus.prototype, "commit", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=hasUncommittedChanges" }),
        __metadata("design:type", Boolean)
    ], GitStatus.prototype, "hasUncommittedChanges", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=hasUnpushedChanges" }),
        __metadata("design:type", Boolean)
    ], GitStatus.prototype, "hasUnpushedChanges", void 0);
    return GitStatus;
}(SpeakeasyBase));
export { GitStatus };
