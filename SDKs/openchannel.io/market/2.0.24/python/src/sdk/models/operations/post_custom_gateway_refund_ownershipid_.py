...
class PostCustomGatewayRefundOwnershipIDRequest:
    path_params: PostCustomGatewayRefundOwnershipIDPathParams = field(default=None)
    query_params: PostCustomGatewayRefundOwnershipIDQueryParams = field(default=None)
