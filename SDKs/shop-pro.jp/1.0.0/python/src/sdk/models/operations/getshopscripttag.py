...
class GetShopScriptTagRequest:
    path_params: GetShopScriptTagPathParams = field(default=None)
    security: GetShopScriptTagSecurity = field(default=None)
...
class GetShopScriptTag200ApplicationJSONScriptTag:
    ...
    display_scope: Optional[GetShopScriptTag200ApplicationJSONScriptTagDisplayScopeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'display_scope' }})
...
class GetShopScriptTag200ApplicationJSON:
    script_tag: Optional[GetShopScriptTag200ApplicationJSONScriptTag] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'script_tag' }})
