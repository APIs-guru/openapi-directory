...
class RunsForRouteAndRouteTypeQueryParams:
    ...
    expand: List[RunsForRouteAndRouteTypeExpandEnum] = field(default=None, metadata={'query_param': { 'field_name': 'expand', 'style': 'form', 'explode': True }})
...
class RunsForRouteAndRouteTypeRequest:
    path_params: RunsForRouteAndRouteTypePathParams = field(default=None)
    query_params: RunsForRouteAndRouteTypeQueryParams = field(default=None)
