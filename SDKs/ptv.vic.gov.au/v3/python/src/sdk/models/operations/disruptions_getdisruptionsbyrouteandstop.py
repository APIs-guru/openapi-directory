...
class DisruptionsGetDisruptionsByRouteAndStopRequest:
    path_params: DisruptionsGetDisruptionsByRouteAndStopPathParams = field(default=None)
    query_params: DisruptionsGetDisruptionsByRouteAndStopQueryParams = field(default=None)
