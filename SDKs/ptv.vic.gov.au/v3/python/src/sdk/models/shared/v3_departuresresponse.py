...
class V3DeparturesResponse:
    departures: Optional[List[V3Departure]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('departures') }})
    ...
    stops: Optional[dict[str, V3StopModel]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('stops') }})
