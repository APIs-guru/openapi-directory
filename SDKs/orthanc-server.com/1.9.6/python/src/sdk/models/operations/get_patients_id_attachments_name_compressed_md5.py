...
class GetPatientsIDAttachmentsNameCompressedMd5Request:
    path_params: GetPatientsIDAttachmentsNameCompressedMd5PathParams = field(default=None)
    headers: GetPatientsIDAttachmentsNameCompressedMd5Headers = field(default=None)
