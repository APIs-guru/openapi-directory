...
class ListSyncListItemListSyncListItemResponse:
    items: Optional[List[shared.SyncV1ServiceSyncListSyncListItem]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('items') }})
    meta: Optional[ListSyncListItemListSyncListItemResponseMeta] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    

@dataclass
class ListSyncListItemRequest:
    path_params: ListSyncListItemPathParams = field()
    query_params: ListSyncListItemQueryParams = field()
    security: ListSyncListItemSecurity = field()
...
class ListSyncListItemResponse:
    ...
    list_sync_list_item_response: Optional[ListSyncListItemListSyncListItemResponse] = field(default=None)
