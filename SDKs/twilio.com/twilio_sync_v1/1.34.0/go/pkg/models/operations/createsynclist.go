...
type CreateSyncListRequestBodyCreateSyncListRequest struct {
...
type CreateSyncListRequest struct {
	...
	Request    *CreateSyncListRequestBodyCreateSyncListRequest `request:"mediaType=application/x-www-form-urlencoded"`
