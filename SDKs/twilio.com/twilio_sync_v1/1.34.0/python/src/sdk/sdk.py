...
class SDK:
    ...
    def create_document(self, request: operations.CreateDocumentRequest) -> operations.CreateDocumentResponse:
        ...
        res = operations.CreateDocumentResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SyncV1ServiceDocument])
                res.responses[r.status_code][content_type] = operations.CreateDocumentResponses(sync_v1_service_document=out)
    ...
    def create_service(self, request: operations.CreateServiceRequest) -> operations.CreateServiceResponse:
        ...
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.CreateServiceResponses(sync_v1_service=out)
    ...
    def create_stream_message(self, request: operations.CreateStreamMessageRequest) -> operations.CreateStreamMessageResponse:
        ...
        res = operations.CreateStreamMessageResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SyncV1ServiceSyncStreamStreamMessage])
                res.responses[r.status_code][content_type] = operations.CreateStreamMessageResponses(sync_v1_service_sync_stream_stream_message=out)
    ...
    def create_sync_list(self, request: operations.CreateSyncListRequest) -> operations.CreateSyncListResponse:
        ...
        res = operations.CreateSyncListResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SyncV1ServiceSyncList])
                res.responses[r.status_code][content_type] = operations.CreateSyncListResponses(sync_v1_service_sync_list=out)
    ...
    def create_sync_list_item(self, request: operations.CreateSyncListItemRequest) -> operations.CreateSyncListItemResponse:
        ...
        res = operations.CreateSyncListItemResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SyncV1ServiceSyncListSyncListItem])
                res.responses[r.status_code][content_type] = operations.CreateSyncListItemResponses(sync_v1_service_sync_list_sync_list_item=out)
    ...
    def create_sync_map(self, request: operations.CreateSyncMapRequest) -> operations.CreateSyncMapResponse:
        ...
        res = operations.CreateSyncMapResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SyncV1ServiceSyncMap])
                res.responses[r.status_code][content_type] = operations.CreateSyncMapResponses(sync_v1_service_sync_map=out)
    ...
    def create_sync_map_item(self, request: operations.CreateSyncMapItemRequest) -> operations.CreateSyncMapItemResponse:
        ...
        res = operations.CreateSyncMapItemResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SyncV1ServiceSyncMapSyncMapItem])
                res.responses[r.status_code][content_type] = operations.CreateSyncMapItemResponses(sync_v1_service_sync_map_sync_map_item=out)
    ...
    def create_sync_stream(self, request: operations.CreateSyncStreamRequest) -> operations.CreateSyncStreamResponse:
        ...
        res = operations.CreateSyncStreamResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SyncV1ServiceSyncStream])
                res.responses[r.status_code][content_type] = operations.CreateSyncStreamResponses(sync_v1_service_sync_stream=out)
    ...
    def fetch_document(self, request: operations.FetchDocumentRequest) -> operations.FetchDocumentResponse:
        ...
        res = operations.FetchDocumentResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SyncV1ServiceDocument])
                res.responses[r.status_code][content_type] = operations.FetchDocumentResponses(sync_v1_service_document=out)
    ...
    def fetch_document_permission(self, request: operations.FetchDocumentPermissionRequest) -> operations.FetchDocumentPermissionResponse:
        ...
        res = operations.FetchDocumentPermissionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SyncV1ServiceDocumentDocumentPermission])
                res.responses[r.status_code][content_type] = operations.FetchDocumentPermissionResponses(sync_v1_service_document_document_permission=out)
    ...
    def fetch_service(self, request: operations.FetchServiceRequest) -> operations.FetchServiceResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SyncV1Service])
                res.responses[r.status_code][content_type] = operations.FetchServiceResponses(sync_v1_service=out)
    ...
    def fetch_sync_list(self, request: operations.FetchSyncListRequest) -> operations.FetchSyncListResponse:
        ...
        res = operations.FetchSyncListResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SyncV1ServiceSyncList])
                res.responses[r.status_code][content_type] = operations.FetchSyncListResponses(sync_v1_service_sync_list=out)
    ...
    def fetch_sync_list_item(self, request: operations.FetchSyncListItemRequest) -> operations.FetchSyncListItemResponse:
        ...
        res = operations.FetchSyncListItemResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SyncV1ServiceSyncListSyncListItem])
                res.responses[r.status_code][content_type] = operations.FetchSyncListItemResponses(sync_v1_service_sync_list_sync_list_item=out)
    ...
    def fetch_sync_list_permission(self, request: operations.FetchSyncListPermissionRequest) -> operations.FetchSyncListPermissionResponse:
        ...
        res = operations.FetchSyncListPermissionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SyncV1ServiceSyncListSyncListPermission])
                res.responses[r.status_code][content_type] = operations.FetchSyncListPermissionResponses(sync_v1_service_sync_list_sync_list_permission=out)
    ...
    def fetch_sync_map(self, request: operations.FetchSyncMapRequest) -> operations.FetchSyncMapResponse:
        ...
        res = operations.FetchSyncMapResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SyncV1ServiceSyncMap])
                res.responses[r.status_code][content_type] = operations.FetchSyncMapResponses(sync_v1_service_sync_map=out)
    ...
    def fetch_sync_map_item(self, request: operations.FetchSyncMapItemRequest) -> operations.FetchSyncMapItemResponse:
        ...
        res = operations.FetchSyncMapItemResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SyncV1ServiceSyncMapSyncMapItem])
                res.responses[r.status_code][content_type] = operations.FetchSyncMapItemResponses(sync_v1_service_sync_map_sync_map_item=out)
    ...
    def fetch_sync_map_permission(self, request: operations.FetchSyncMapPermissionRequest) -> operations.FetchSyncMapPermissionResponse:
        ...
        res = operations.FetchSyncMapPermissionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SyncV1ServiceSyncMapSyncMapPermission])
                res.responses[r.status_code][content_type] = operations.FetchSyncMapPermissionResponses(sync_v1_service_sync_map_sync_map_permission=out)
    ...
    def fetch_sync_stream(self, request: operations.FetchSyncStreamRequest) -> operations.FetchSyncStreamResponse:
        ...
        res = operations.FetchSyncStreamResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SyncV1ServiceSyncStream])
                res.responses[r.status_code][content_type] = operations.FetchSyncStreamResponses(sync_v1_service_sync_stream=out)
    ...
    def list_document(self, request: operations.ListDocumentRequest) -> operations.ListDocumentResponse:
        ...
        res = operations.ListDocumentResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListDocument200ApplicationJSONListDocumentResponse])
                res.responses[r.status_code][content_type] = operations.ListDocumentResponses(list_document_response=out)
    ...
    def list_document_permission(self, request: operations.ListDocumentPermissionRequest) -> operations.ListDocumentPermissionResponse:
        ...
        res = operations.ListDocumentPermissionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListDocumentPermissionResponses(list_document_permission_response=out)
    ...
    def list_sync_list(self, request: operations.ListSyncListRequest) -> operations.ListSyncListResponse:
        ...
        res = operations.ListSyncListResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListSyncList200ApplicationJSONListSyncListResponse])
                res.responses[r.status_code][content_type] = operations.ListSyncListResponses(list_sync_list_response=out)
    ...
    def list_sync_list_item(self, request: operations.ListSyncListItemRequest) -> operations.ListSyncListItemResponse:
        ...
        res = operations.ListSyncListItemResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListSyncListItem200ApplicationJSONListSyncListItemResponse])
                res.responses[r.status_code][content_type] = operations.ListSyncListItemResponses(list_sync_list_item_response=out)
    ...
    def list_sync_list_permission(self, request: operations.ListSyncListPermissionRequest) -> operations.ListSyncListPermissionResponse:
        ...
        res = operations.ListSyncListPermissionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListSyncListPermissionResponses(list_sync_list_permission_response=out)
    ...
    def list_sync_map(self, request: operations.ListSyncMapRequest) -> operations.ListSyncMapResponse:
        ...
        res = operations.ListSyncMapResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListSyncMap200ApplicationJSONListSyncMapResponse])
                res.responses[r.status_code][content_type] = operations.ListSyncMapResponses(list_sync_map_response=out)
    ...
    def list_sync_map_item(self, request: operations.ListSyncMapItemRequest) -> operations.ListSyncMapItemResponse:
        ...
        res = operations.ListSyncMapItemResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListSyncMapItem200ApplicationJSONListSyncMapItemResponse])
                res.responses[r.status_code][content_type] = operations.ListSyncMapItemResponses(list_sync_map_item_response=out)
    ...
    def list_sync_map_permission(self, request: operations.ListSyncMapPermissionRequest) -> operations.ListSyncMapPermissionResponse:
        ...
        res = operations.ListSyncMapPermissionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListSyncMapPermission200ApplicationJSONListSyncMapPermissionResponse])
                res.responses[r.status_code][content_type] = operations.ListSyncMapPermissionResponses(list_sync_map_permission_response=out)
    ...
    def list_sync_stream(self, request: operations.ListSyncStreamRequest) -> operations.ListSyncStreamResponse:
        ...
        res = operations.ListSyncStreamResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListSyncStream200ApplicationJSONListSyncStreamResponse])
                res.responses[r.status_code][content_type] = operations.ListSyncStreamResponses(list_sync_stream_response=out)
    ...
    def update_document(self, request: operations.UpdateDocumentRequest) -> operations.UpdateDocumentResponse:
        ...
        res = operations.UpdateDocumentResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SyncV1ServiceDocument])
                res.responses[r.status_code][content_type] = operations.UpdateDocumentResponses(sync_v1_service_document=out)
    ...
    def update_document_permission(self, request: operations.UpdateDocumentPermissionRequest) -> operations.UpdateDocumentPermissionResponse:
        ...
        res = operations.UpdateDocumentPermissionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SyncV1ServiceDocumentDocumentPermission])
                res.responses[r.status_code][content_type] = operations.UpdateDocumentPermissionResponses(sync_v1_service_document_document_permission=out)
    ...
    def update_service(self, request: operations.UpdateServiceRequest) -> operations.UpdateServiceResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SyncV1Service])
                res.responses[r.status_code][content_type] = operations.UpdateServiceResponses(sync_v1_service=out)
    ...
    def update_sync_list(self, request: operations.UpdateSyncListRequest) -> operations.UpdateSyncListResponse:
        ...
        res = operations.UpdateSyncListResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SyncV1ServiceSyncList])
                res.responses[r.status_code][content_type] = operations.UpdateSyncListResponses(sync_v1_service_sync_list=out)
    ...
    def update_sync_list_item(self, request: operations.UpdateSyncListItemRequest) -> operations.UpdateSyncListItemResponse:
        ...
        res = operations.UpdateSyncListItemResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SyncV1ServiceSyncListSyncListItem])
                res.responses[r.status_code][content_type] = operations.UpdateSyncListItemResponses(sync_v1_service_sync_list_sync_list_item=out)
    ...
    def update_sync_list_permission(self, request: operations.UpdateSyncListPermissionRequest) -> operations.UpdateSyncListPermissionResponse:
        ...
        res = operations.UpdateSyncListPermissionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SyncV1ServiceSyncListSyncListPermission])
                res.responses[r.status_code][content_type] = operations.UpdateSyncListPermissionResponses(sync_v1_service_sync_list_sync_list_permission=out)
    ...
    def update_sync_map(self, request: operations.UpdateSyncMapRequest) -> operations.UpdateSyncMapResponse:
        ...
        res = operations.UpdateSyncMapResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SyncV1ServiceSyncMap])
                res.responses[r.status_code][content_type] = operations.UpdateSyncMapResponses(sync_v1_service_sync_map=out)
    ...
    def update_sync_map_item(self, request: operations.UpdateSyncMapItemRequest) -> operations.UpdateSyncMapItemResponse:
        ...
        res = operations.UpdateSyncMapItemResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SyncV1ServiceSyncMapSyncMapItem])
                res.responses[r.status_code][content_type] = operations.UpdateSyncMapItemResponses(sync_v1_service_sync_map_sync_map_item=out)
    ...
    def update_sync_map_permission(self, request: operations.UpdateSyncMapPermissionRequest) -> operations.UpdateSyncMapPermissionResponse:
        ...
        res = operations.UpdateSyncMapPermissionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SyncV1ServiceSyncMapSyncMapPermission])
                res.responses[r.status_code][content_type] = operations.UpdateSyncMapPermissionResponses(sync_v1_service_sync_map_sync_map_permission=out)
    ...
    def update_sync_stream(self, request: operations.UpdateSyncStreamRequest) -> operations.UpdateSyncStreamResponse:
        ...
        res = operations.UpdateSyncStreamResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SyncV1ServiceSyncStream])
                res.responses[r.status_code][content_type] = operations.UpdateSyncStreamResponses(sync_v1_service_sync_stream=out)
