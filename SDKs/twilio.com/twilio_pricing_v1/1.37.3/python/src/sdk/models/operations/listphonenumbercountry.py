...
class ListPhoneNumberCountryListPhoneNumberCountryResponse:
    countries: Optional[List[shared.PricingV1PhoneNumberPhoneNumberCountry]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('countries') }})
    meta: Optional[ListPhoneNumberCountryListPhoneNumberCountryResponseMeta] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    

@dataclass
class ListPhoneNumberCountryRequest:
    query_params: ListPhoneNumberCountryQueryParams = field()
    security: ListPhoneNumberCountrySecurity = field()
