...
@dataclass
class FetchExecutionStepContextResponses:
    studio_v1_flow_execution_execution_step_execution_step_context: Optional[shared.StudioV1FlowExecutionExecutionStepExecutionStepContext] = field(default=None)
    

@dataclass
class FetchExecutionStepContextResponse:
    content_type: str = field(default=None)
    responses: dict[int, dict[str, FetchExecutionStepContextResponses]] = field(default=None)
