...
class SDK:
    ...
    def create_engagement(self, request: operations.CreateEngagementRequest) -> operations.CreateEngagementResponse:
        ...
        res = operations.CreateEngagementResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.StudioV1FlowEngagement])
                res.responses[r.status_code][content_type] = operations.CreateEngagementResponses(studio_v1_flow_engagement=out)
    ...
    def create_execution(self, request: operations.CreateExecutionRequest) -> operations.CreateExecutionResponse:
        ...
        res = operations.CreateExecutionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.StudioV1FlowExecution])
                res.responses[r.status_code][content_type] = operations.CreateExecutionResponses(studio_v1_flow_execution=out)
    ...
    def fetch_engagement(self, request: operations.FetchEngagementRequest) -> operations.FetchEngagementResponse:
        ...
        res = operations.FetchEngagementResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.StudioV1FlowEngagement])
                res.responses[r.status_code][content_type] = operations.FetchEngagementResponses(studio_v1_flow_engagement=out)
    ...
    def fetch_engagement_context(self, request: operations.FetchEngagementContextRequest) -> operations.FetchEngagementContextResponse:
        ...
        res = operations.FetchEngagementContextResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.StudioV1FlowEngagementEngagementContext])
                res.responses[r.status_code][content_type] = operations.FetchEngagementContextResponses(studio_v1_flow_engagement_engagement_context=out)
    ...
    def fetch_execution(self, request: operations.FetchExecutionRequest) -> operations.FetchExecutionResponse:
        ...
        res = operations.FetchExecutionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.StudioV1FlowExecution])
                res.responses[r.status_code][content_type] = operations.FetchExecutionResponses(studio_v1_flow_execution=out)
    ...
    def fetch_execution_context(self, request: operations.FetchExecutionContextRequest) -> operations.FetchExecutionContextResponse:
        ...
        res = operations.FetchExecutionContextResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.StudioV1FlowExecutionExecutionContext])
                res.responses[r.status_code][content_type] = operations.FetchExecutionContextResponses(studio_v1_flow_execution_execution_context=out)
    ...
    def fetch_execution_step(self, request: operations.FetchExecutionStepRequest) -> operations.FetchExecutionStepResponse:
        ...
        res = operations.FetchExecutionStepResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.StudioV1FlowExecutionExecutionStep])
                res.responses[r.status_code][content_type] = operations.FetchExecutionStepResponses(studio_v1_flow_execution_execution_step=out)
    ...
    def fetch_execution_step_context(self, request: operations.FetchExecutionStepContextRequest) -> operations.FetchExecutionStepContextResponse:
        ...
        res = operations.FetchExecutionStepContextResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.StudioV1FlowExecutionExecutionStepExecutionStepContext])
                res.responses[r.status_code][content_type] = operations.FetchExecutionStepContextResponses(studio_v1_flow_execution_execution_step_execution_step_context=out)
    ...
    def fetch_flow(self, request: operations.FetchFlowRequest) -> operations.FetchFlowResponse:
        ...
        res = operations.FetchFlowResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.StudioV1Flow])
                res.responses[r.status_code][content_type] = operations.FetchFlowResponses(studio_v1_flow=out)
    ...
    def fetch_step(self, request: operations.FetchStepRequest) -> operations.FetchStepResponse:
        ...
        res = operations.FetchStepResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.StudioV1FlowEngagementStep])
                res.responses[r.status_code][content_type] = operations.FetchStepResponses(studio_v1_flow_engagement_step=out)
    ...
    def fetch_step_context(self, request: operations.FetchStepContextRequest) -> operations.FetchStepContextResponse:
        ...
        res = operations.FetchStepContextResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.StudioV1FlowEngagementStepStepContext])
                res.responses[r.status_code][content_type] = operations.FetchStepContextResponses(studio_v1_flow_engagement_step_step_context=out)
    ...
    def list_engagement(self, request: operations.ListEngagementRequest) -> operations.ListEngagementResponse:
        ...
        res = operations.ListEngagementResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListEngagement200ApplicationJSONListEngagementResponse])
                res.responses[r.status_code][content_type] = operations.ListEngagementResponses(list_engagement_response=out)
    ...
    def list_execution(self, request: operations.ListExecutionRequest) -> operations.ListExecutionResponse:
        ...
        res = operations.ListExecutionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListExecution200ApplicationJSONListExecutionResponse])
                res.responses[r.status_code][content_type] = operations.ListExecutionResponses(list_execution_response=out)
    ...
    def list_execution_step(self, request: operations.ListExecutionStepRequest) -> operations.ListExecutionStepResponse:
        ...
        res = operations.ListExecutionStepResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListExecutionStep200ApplicationJSONListExecutionStepResponse])
                res.responses[r.status_code][content_type] = operations.ListExecutionStepResponses(list_execution_step_response=out)
    ...
    def list_flow(self, request: operations.ListFlowRequest) -> operations.ListFlowResponse:
        ...
        res = operations.ListFlowResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListFlow200ApplicationJSONListFlowResponse])
                res.responses[r.status_code][content_type] = operations.ListFlowResponses(list_flow_response=out)
    ...
    def list_step(self, request: operations.ListStepRequest) -> operations.ListStepResponse:
        ...
        res = operations.ListStepResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListStep200ApplicationJSONListStepResponse])
                res.responses[r.status_code][content_type] = operations.ListStepResponses(list_step_response=out)
    ...
    def update_execution(self, request: operations.UpdateExecutionRequest) -> operations.UpdateExecutionResponse:
        ...
        res = operations.UpdateExecutionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.StudioV1FlowExecution])
                res.responses[r.status_code][content_type] = operations.UpdateExecutionResponses(studio_v1_flow_execution=out)
