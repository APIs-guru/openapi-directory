...
from . import execution_enum_status_enum
...
class StudioV1FlowExecution:
    ...
    status: Optional[execution_enum_status_enum.ExecutionEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
