...
from . import engagement_enum_status_enum
...
class StudioV1FlowEngagement:
    ...
    status: Optional[engagement_enum_status_enum.EngagementEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
