...
class SDK:
    ...
    def create_channel(self, request: operations.CreateChannelRequest) -> operations.CreateChannelResponse:
        ...
        res = operations.CreateChannelResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.FlexV1Channel])
                res.responses[r.status_code][content_type] = operations.CreateChannelResponses(flex_v1_channel=out)
    ...
    def create_flex_flow(self, request: operations.CreateFlexFlowRequest) -> operations.CreateFlexFlowResponse:
        ...
        res = operations.CreateFlexFlowResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.FlexV1FlexFlow])
                res.responses[r.status_code][content_type] = operations.CreateFlexFlowResponses(flex_v1_flex_flow=out)
    ...
    def create_interaction(self, request: operations.CreateInteractionRequest) -> operations.CreateInteractionResponse:
        ...
        res = operations.CreateInteractionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.FlexV1Interaction])
                res.responses[r.status_code][content_type] = operations.CreateInteractionResponses(flex_v1_interaction=out)
    ...
    def create_interaction_channel_invite(self, request: operations.CreateInteractionChannelInviteRequest) -> operations.CreateInteractionChannelInviteResponse:
        ...
        res = operations.CreateInteractionChannelInviteResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.FlexV1InteractionInteractionChannelInteractionChannelInvite])
                res.responses[r.status_code][content_type] = operations.CreateInteractionChannelInviteResponses(flex_v1_interaction_interaction_channel_interaction_channel_invite=out)
    ...
    def create_interaction_channel_participant(self, request: operations.CreateInteractionChannelParticipantRequest) -> operations.CreateInteractionChannelParticipantResponse:
        ...
        res = operations.CreateInteractionChannelParticipantResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.FlexV1InteractionInteractionChannelInteractionChannelParticipant])
                res.responses[r.status_code][content_type] = operations.CreateInteractionChannelParticipantResponses(flex_v1_interaction_interaction_channel_interaction_channel_participant=out)
    ...
    def create_web_channel(self, request: operations.CreateWebChannelRequest) -> operations.CreateWebChannelResponse:
        ...
        res = operations.CreateWebChannelResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.FlexV1WebChannel])
                res.responses[r.status_code][content_type] = operations.CreateWebChannelResponses(flex_v1_web_channel=out)
    ...
    def fetch_channel(self, request: operations.FetchChannelRequest) -> operations.FetchChannelResponse:
        ...
        res = operations.FetchChannelResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.FlexV1Channel])
                res.responses[r.status_code][content_type] = operations.FetchChannelResponses(flex_v1_channel=out)
    ...
    def fetch_configuration(self, request: operations.FetchConfigurationRequest) -> operations.FetchConfigurationResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.FetchConfigurationResponses(flex_v1_configuration=out)
    ...
    def fetch_flex_flow(self, request: operations.FetchFlexFlowRequest) -> operations.FetchFlexFlowResponse:
        ...
        res = operations.FetchFlexFlowResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.FlexV1FlexFlow])
                res.responses[r.status_code][content_type] = operations.FetchFlexFlowResponses(flex_v1_flex_flow=out)
    ...
    def fetch_interaction(self, request: operations.FetchInteractionRequest) -> operations.FetchInteractionResponse:
        ...
        res = operations.FetchInteractionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.FlexV1Interaction])
                res.responses[r.status_code][content_type] = operations.FetchInteractionResponses(flex_v1_interaction=out)
    ...
    def fetch_interaction_channel(self, request: operations.FetchInteractionChannelRequest) -> operations.FetchInteractionChannelResponse:
        ...
        res = operations.FetchInteractionChannelResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.FlexV1InteractionInteractionChannel])
                res.responses[r.status_code][content_type] = operations.FetchInteractionChannelResponses(flex_v1_interaction_interaction_channel=out)
    ...
    def fetch_web_channel(self, request: operations.FetchWebChannelRequest) -> operations.FetchWebChannelResponse:
        ...
        res = operations.FetchWebChannelResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.FlexV1WebChannel])
                res.responses[r.status_code][content_type] = operations.FetchWebChannelResponses(flex_v1_web_channel=out)
    ...
    def list_channel(self, request: operations.ListChannelRequest) -> operations.ListChannelResponse:
        ...
        res = operations.ListChannelResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListChannel200ApplicationJSONListChannelResponse])
                res.responses[r.status_code][content_type] = operations.ListChannelResponses(list_channel_response=out)
    ...
    def list_flex_flow(self, request: operations.ListFlexFlowRequest) -> operations.ListFlexFlowResponse:
        ...
        res = operations.ListFlexFlowResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListFlexFlow200ApplicationJSONListFlexFlowResponse])
                res.responses[r.status_code][content_type] = operations.ListFlexFlowResponses(list_flex_flow_response=out)
    ...
    def list_interaction_channel(self, request: operations.ListInteractionChannelRequest) -> operations.ListInteractionChannelResponse:
        ...
        res = operations.ListInteractionChannelResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListInteractionChannelResponses(list_interaction_channel_response=out)
    ...
    def list_interaction_channel_invite(self, request: operations.ListInteractionChannelInviteRequest) -> operations.ListInteractionChannelInviteResponse:
        ...
        res = operations.ListInteractionChannelInviteResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListInteractionChannelInviteResponses(list_interaction_channel_invite_response=out)
    ...
    def list_interaction_channel_participant(self, request: operations.ListInteractionChannelParticipantRequest) -> operations.ListInteractionChannelParticipantResponse:
        ...
        res = operations.ListInteractionChannelParticipantResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListInteractionChannelParticipantResponses(list_interaction_channel_participant_response=out)
    ...
    def list_web_channel(self, request: operations.ListWebChannelRequest) -> operations.ListWebChannelResponse:
        ...
        res = operations.ListWebChannelResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListWebChannel200ApplicationJSONListWebChannelResponse])
                res.responses[r.status_code][content_type] = operations.ListWebChannelResponses(list_web_channel_response=out)
    ...
    def update_flex_flow(self, request: operations.UpdateFlexFlowRequest) -> operations.UpdateFlexFlowResponse:
        ...
        res = operations.UpdateFlexFlowResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.FlexV1FlexFlow])
                res.responses[r.status_code][content_type] = operations.UpdateFlexFlowResponses(flex_v1_flex_flow=out)
    ...
    def update_interaction_channel(self, request: operations.UpdateInteractionChannelRequest) -> operations.UpdateInteractionChannelResponse:
        ...
        res = operations.UpdateInteractionChannelResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.FlexV1InteractionInteractionChannel])
                res.responses[r.status_code][content_type] = operations.UpdateInteractionChannelResponses(flex_v1_interaction_interaction_channel=out)
    ...
    def update_interaction_channel_participant(self, request: operations.UpdateInteractionChannelParticipantRequest) -> operations.UpdateInteractionChannelParticipantResponse:
        ...
        res = operations.UpdateInteractionChannelParticipantResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.FlexV1InteractionInteractionChannelInteractionChannelParticipant])
                res.responses[r.status_code][content_type] = operations.UpdateInteractionChannelParticipantResponses(flex_v1_interaction_interaction_channel_interaction_channel_participant=out)
    ...
    def update_web_channel(self, request: operations.UpdateWebChannelRequest) -> operations.UpdateWebChannelResponse:
        ...
        res = operations.UpdateWebChannelResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.FlexV1WebChannel])
                res.responses[r.status_code][content_type] = operations.UpdateWebChannelResponses(flex_v1_web_channel=out)
