...
from . import configuration_enum_status_enum
...
class FlexV1Configuration:
    ...
    debugger_integration: Optional[Any] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'debugger_integration' }})
    ...
    flex_ui_status_report: Optional[Any] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'flex_ui_status_report' }})
    ...
    status: Optional[configuration_enum_status_enum.ConfigurationEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
