...
class VideoV1Composition:
    ...
    format: Optional[shared.CompositionEnumFormatEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'format' }})
    ...
    status: Optional[shared.CompositionEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
