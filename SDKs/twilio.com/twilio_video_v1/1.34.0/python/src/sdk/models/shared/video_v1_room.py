...
class VideoV1Room:
    ...
    status: Optional[shared.RoomEnumRoomStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
    ...
    type: Optional[shared.RoomEnumRoomTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'type' }})
    ...
    video_codecs: Optional[List[shared.RoomEnumVideoCodecEnum]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'video_codecs' }})
