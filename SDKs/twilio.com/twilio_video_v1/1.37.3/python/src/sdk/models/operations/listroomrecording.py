...
class ListRoomRecordingListRoomRecordingResponse:
    meta: Optional[ListRoomRecordingListRoomRecordingResponseMeta] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    recordings: Optional[List[shared.VideoV1RoomRoomRecording]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('recordings') }})
    

@dataclass
class ListRoomRecordingRequest:
    path_params: ListRoomRecordingPathParams = field()
    query_params: ListRoomRecordingQueryParams = field()
    security: ListRoomRecordingSecurity = field()
