...
class ListCompositionHookListCompositionHookResponse:
    composition_hooks: Optional[List[shared.VideoV1CompositionHook]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('composition_hooks') }})
    meta: Optional[ListCompositionHookListCompositionHookResponseMeta] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    

@dataclass
class ListCompositionHookRequest:
    query_params: ListCompositionHookQueryParams = field()
    security: ListCompositionHookSecurity = field()
