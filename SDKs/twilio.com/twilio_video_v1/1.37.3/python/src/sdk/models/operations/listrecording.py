...
class ListRecordingListRecordingResponse:
    meta: Optional[ListRecordingListRecordingResponseMeta] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    recordings: Optional[List[shared.VideoV1Recording]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('recordings') }})
