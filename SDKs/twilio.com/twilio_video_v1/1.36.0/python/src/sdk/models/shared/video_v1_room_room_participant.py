...
from . import room_participant_enum_status_enum
...
class VideoV1RoomRoomParticipant:
    ...
    status: Optional[room_participant_enum_status_enum.RoomParticipantEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
