...
from . import composition_hook_enum_format_enum
...
class VideoV1CompositionHook:
    ...
    format: Optional[composition_hook_enum_format_enum.CompositionHookEnumFormatEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'format' }})
