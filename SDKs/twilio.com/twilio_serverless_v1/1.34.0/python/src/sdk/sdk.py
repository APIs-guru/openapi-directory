...
class SDK:
    ...
    def create_asset(self, request: operations.CreateAssetRequest) -> operations.CreateAssetResponse:
        ...
        res = operations.CreateAssetResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ServerlessV1ServiceAsset])
                res.responses[r.status_code][content_type] = operations.CreateAssetResponses(serverless_v1_service_asset=out)
    ...
    def create_build(self, request: operations.CreateBuildRequest) -> operations.CreateBuildResponse:
        ...
        res = operations.CreateBuildResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ServerlessV1ServiceBuild])
                res.responses[r.status_code][content_type] = operations.CreateBuildResponses(serverless_v1_service_build=out)
    ...
    def create_deployment(self, request: operations.CreateDeploymentRequest) -> operations.CreateDeploymentResponse:
        ...
        res = operations.CreateDeploymentResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ServerlessV1ServiceEnvironmentDeployment])
                res.responses[r.status_code][content_type] = operations.CreateDeploymentResponses(serverless_v1_service_environment_deployment=out)
    ...
    def create_environment(self, request: operations.CreateEnvironmentRequest) -> operations.CreateEnvironmentResponse:
        ...
        res = operations.CreateEnvironmentResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ServerlessV1ServiceEnvironment])
                res.responses[r.status_code][content_type] = operations.CreateEnvironmentResponses(serverless_v1_service_environment=out)
    ...
    def create_function(self, request: operations.CreateFunctionRequest) -> operations.CreateFunctionResponse:
        ...
        res = operations.CreateFunctionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ServerlessV1ServiceFunction])
                res.responses[r.status_code][content_type] = operations.CreateFunctionResponses(serverless_v1_service_function=out)
    ...
    def create_service(self, request: operations.CreateServiceRequest) -> operations.CreateServiceResponse:
        ...
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.CreateServiceResponses(serverless_v1_service=out)
    ...
    def create_variable(self, request: operations.CreateVariableRequest) -> operations.CreateVariableResponse:
        ...
        res = operations.CreateVariableResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ServerlessV1ServiceEnvironmentVariable])
                res.responses[r.status_code][content_type] = operations.CreateVariableResponses(serverless_v1_service_environment_variable=out)
    ...
    def fetch_asset(self, request: operations.FetchAssetRequest) -> operations.FetchAssetResponse:
        ...
        res = operations.FetchAssetResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ServerlessV1ServiceAsset])
                res.responses[r.status_code][content_type] = operations.FetchAssetResponses(serverless_v1_service_asset=out)
    ...
    def fetch_asset_version(self, request: operations.FetchAssetVersionRequest) -> operations.FetchAssetVersionResponse:
        ...
        res = operations.FetchAssetVersionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ServerlessV1ServiceAssetAssetVersion])
                res.responses[r.status_code][content_type] = operations.FetchAssetVersionResponses(serverless_v1_service_asset_asset_version=out)
    ...
    def fetch_build(self, request: operations.FetchBuildRequest) -> operations.FetchBuildResponse:
        ...
        res = operations.FetchBuildResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ServerlessV1ServiceBuild])
                res.responses[r.status_code][content_type] = operations.FetchBuildResponses(serverless_v1_service_build=out)
    ...
    def fetch_build_status(self, request: operations.FetchBuildStatusRequest) -> operations.FetchBuildStatusResponse:
        ...
        res = operations.FetchBuildStatusResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ServerlessV1ServiceBuildBuildStatus])
                res.responses[r.status_code][content_type] = operations.FetchBuildStatusResponses(serverless_v1_service_build_build_status=out)
    ...
    def fetch_deployment(self, request: operations.FetchDeploymentRequest) -> operations.FetchDeploymentResponse:
        ...
        res = operations.FetchDeploymentResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ServerlessV1ServiceEnvironmentDeployment])
                res.responses[r.status_code][content_type] = operations.FetchDeploymentResponses(serverless_v1_service_environment_deployment=out)
    ...
    def fetch_environment(self, request: operations.FetchEnvironmentRequest) -> operations.FetchEnvironmentResponse:
        ...
        res = operations.FetchEnvironmentResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ServerlessV1ServiceEnvironment])
                res.responses[r.status_code][content_type] = operations.FetchEnvironmentResponses(serverless_v1_service_environment=out)
    ...
    def fetch_function(self, request: operations.FetchFunctionRequest) -> operations.FetchFunctionResponse:
        ...
        res = operations.FetchFunctionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ServerlessV1ServiceFunction])
                res.responses[r.status_code][content_type] = operations.FetchFunctionResponses(serverless_v1_service_function=out)
    ...
    def fetch_function_version(self, request: operations.FetchFunctionVersionRequest) -> operations.FetchFunctionVersionResponse:
        ...
        res = operations.FetchFunctionVersionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ServerlessV1ServiceFunctionFunctionVersion])
                res.responses[r.status_code][content_type] = operations.FetchFunctionVersionResponses(serverless_v1_service_function_function_version=out)
    ...
    def fetch_function_version_content(self, request: operations.FetchFunctionVersionContentRequest) -> operations.FetchFunctionVersionContentResponse:
        ...
        res = operations.FetchFunctionVersionContentResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ServerlessV1ServiceFunctionFunctionVersionFunctionVersionContent])
                res.responses[r.status_code][content_type] = operations.FetchFunctionVersionContentResponses(serverless_v1_service_function_function_version_function_version_content=out)
    ...
    def fetch_log(self, request: operations.FetchLogRequest) -> operations.FetchLogResponse:
        ...
        res = operations.FetchLogResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ServerlessV1ServiceEnvironmentLog])
                res.responses[r.status_code][content_type] = operations.FetchLogResponses(serverless_v1_service_environment_log=out)
    ...
    def fetch_service(self, request: operations.FetchServiceRequest) -> operations.FetchServiceResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ServerlessV1Service])
                res.responses[r.status_code][content_type] = operations.FetchServiceResponses(serverless_v1_service=out)
    ...
    def fetch_variable(self, request: operations.FetchVariableRequest) -> operations.FetchVariableResponse:
        ...
        res = operations.FetchVariableResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ServerlessV1ServiceEnvironmentVariable])
                res.responses[r.status_code][content_type] = operations.FetchVariableResponses(serverless_v1_service_environment_variable=out)
    ...
    def list_asset(self, request: operations.ListAssetRequest) -> operations.ListAssetResponse:
        ...
        res = operations.ListAssetResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListAsset200ApplicationJSONListAssetResponse])
                res.responses[r.status_code][content_type] = operations.ListAssetResponses(list_asset_response=out)
    ...
    def list_asset_version(self, request: operations.ListAssetVersionRequest) -> operations.ListAssetVersionResponse:
        ...
        res = operations.ListAssetVersionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListAssetVersion200ApplicationJSONListAssetVersionResponse])
                res.responses[r.status_code][content_type] = operations.ListAssetVersionResponses(list_asset_version_response=out)
    ...
    def list_build(self, request: operations.ListBuildRequest) -> operations.ListBuildResponse:
        ...
        res = operations.ListBuildResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListBuild200ApplicationJSONListBuildResponse])
                res.responses[r.status_code][content_type] = operations.ListBuildResponses(list_build_response=out)
    ...
    def list_deployment(self, request: operations.ListDeploymentRequest) -> operations.ListDeploymentResponse:
        ...
        res = operations.ListDeploymentResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListDeployment200ApplicationJSONListDeploymentResponse])
                res.responses[r.status_code][content_type] = operations.ListDeploymentResponses(list_deployment_response=out)
    ...
    def list_environment(self, request: operations.ListEnvironmentRequest) -> operations.ListEnvironmentResponse:
        ...
        res = operations.ListEnvironmentResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListEnvironment200ApplicationJSONListEnvironmentResponse])
                res.responses[r.status_code][content_type] = operations.ListEnvironmentResponses(list_environment_response=out)
    ...
    def list_function(self, request: operations.ListFunctionRequest) -> operations.ListFunctionResponse:
        ...
        res = operations.ListFunctionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListFunction200ApplicationJSONListFunctionResponse])
                res.responses[r.status_code][content_type] = operations.ListFunctionResponses(list_function_response=out)
    ...
    def list_function_version(self, request: operations.ListFunctionVersionRequest) -> operations.ListFunctionVersionResponse:
        ...
        res = operations.ListFunctionVersionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListFunctionVersion200ApplicationJSONListFunctionVersionResponse])
                res.responses[r.status_code][content_type] = operations.ListFunctionVersionResponses(list_function_version_response=out)
    ...
    def list_log(self, request: operations.ListLogRequest) -> operations.ListLogResponse:
        ...
        res = operations.ListLogResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListLog200ApplicationJSONListLogResponse])
                res.responses[r.status_code][content_type] = operations.ListLogResponses(list_log_response=out)
    ...
    def list_variable(self, request: operations.ListVariableRequest) -> operations.ListVariableResponse:
        ...
        res = operations.ListVariableResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListVariable200ApplicationJSONListVariableResponse])
                res.responses[r.status_code][content_type] = operations.ListVariableResponses(list_variable_response=out)
    ...
    def update_asset(self, request: operations.UpdateAssetRequest) -> operations.UpdateAssetResponse:
        ...
        res = operations.UpdateAssetResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ServerlessV1ServiceAsset])
                res.responses[r.status_code][content_type] = operations.UpdateAssetResponses(serverless_v1_service_asset=out)
    ...
    def update_function(self, request: operations.UpdateFunctionRequest) -> operations.UpdateFunctionResponse:
        ...
        res = operations.UpdateFunctionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ServerlessV1ServiceFunction])
                res.responses[r.status_code][content_type] = operations.UpdateFunctionResponses(serverless_v1_service_function=out)
    ...
    def update_service(self, request: operations.UpdateServiceRequest) -> operations.UpdateServiceResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ServerlessV1Service])
                res.responses[r.status_code][content_type] = operations.UpdateServiceResponses(serverless_v1_service=out)
    ...
    def update_variable(self, request: operations.UpdateVariableRequest) -> operations.UpdateVariableResponse:
        ...
        res = operations.UpdateVariableResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ServerlessV1ServiceEnvironmentVariable])
                res.responses[r.status_code][content_type] = operations.UpdateVariableResponses(serverless_v1_service_environment_variable=out)
