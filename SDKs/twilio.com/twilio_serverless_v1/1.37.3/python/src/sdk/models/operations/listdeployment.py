...
class ListDeploymentListDeploymentResponse:
    deployments: Optional[List[shared.ServerlessV1ServiceEnvironmentDeployment]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('deployments') }})
    meta: Optional[ListDeploymentListDeploymentResponseMeta] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    

@dataclass
class ListDeploymentRequest:
    path_params: ListDeploymentPathParams = field()
    query_params: ListDeploymentQueryParams = field()
    security: ListDeploymentSecurity = field()
