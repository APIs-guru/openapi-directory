...
class ListAssetVersionListAssetVersionResponse:
    asset_versions: Optional[List[shared.ServerlessV1ServiceAssetAssetVersion]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('asset_versions') }})
    meta: Optional[ListAssetVersionListAssetVersionResponseMeta] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    

@dataclass
class ListAssetVersionRequest:
    path_params: ListAssetVersionPathParams = field()
    query_params: ListAssetVersionQueryParams = field()
    security: ListAssetVersionSecurity = field()
