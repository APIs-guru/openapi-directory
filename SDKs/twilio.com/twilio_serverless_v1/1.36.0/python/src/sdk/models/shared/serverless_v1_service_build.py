...
from . import build_enum_runtime_enum
from . import build_enum_status_enum
...
class ServerlessV1ServiceBuild:
    ...
    runtime: Optional[build_enum_runtime_enum.BuildEnumRuntimeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'runtime' }})
    service_sid: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'service_sid' }})
    sid: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'sid' }})
    status: Optional[build_enum_status_enum.BuildEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
