...
export class SDK {
  ...
  CreateAsset(
    ...
    let baseURL: string = operations.CREATEASSET_SERVERS[0];
  ...
  CreateBuild(
    ...
    let baseURL: string = operations.CREATEBUILD_SERVERS[0];
  ...
  CreateDeployment(
    ...
    let baseURL: string = operations.CREATEDEPLOYMENT_SERVERS[0];
  ...
  CreateEnvironment(
    ...
    let baseURL: string = operations.CREATEENVIRONMENT_SERVERS[0];
  ...
  CreateFunction(
    ...
    let baseURL: string = operations.CREATEFUNCTION_SERVERS[0];
  ...
  CreateVariable(
    ...
    let baseURL: string = operations.CREATEVARIABLE_SERVERS[0];
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.CreateVariableResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 201:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  DeleteAsset(
    ...
    let baseURL: string = operations.DELETEASSET_SERVERS[0];
  ...
  DeleteBuild(
    ...
    let baseURL: string = operations.DELETEBUILD_SERVERS[0];
  ...
  DeleteEnvironment(
    ...
    let baseURL: string = operations.DELETEENVIRONMENT_SERVERS[0];
  ...
  DeleteFunction(
    ...
    let baseURL: string = operations.DELETEFUNCTION_SERVERS[0];
  ...
  DeleteVariable(
    ...
    let baseURL: string = operations.DELETEVARIABLE_SERVERS[0];
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.DeleteVariableResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 204:
            break;
        }
  ...
  FetchAsset(
    ...
    let baseURL: string = operations.FETCHASSET_SERVERS[0];
    const url: string = utils.GenerateURL(baseURL, "/v1/Services/{ServiceSid}/Assets/{Sid}", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.FetchAssetResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.serverlessV1ServiceAsset = httpRes?.data;
  ...
  FetchAssetVersion(
    ...
    let baseURL: string = operations.FETCHASSETVERSION_SERVERS[0];
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.FetchAssetVersionResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  FetchBuild(
    ...
    let baseURL: string = operations.FETCHBUILD_SERVERS[0];
    const url: string = utils.GenerateURL(baseURL, "/v1/Services/{ServiceSid}/Builds/{Sid}", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.FetchBuildResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.serverlessV1ServiceBuild = httpRes?.data;
  ...
  FetchBuildStatus(
    ...
    let baseURL: string = operations.FETCHBUILDSTATUS_SERVERS[0];
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.FetchBuildStatusResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  FetchDeployment(
    ...
    let baseURL: string = operations.FETCHDEPLOYMENT_SERVERS[0];
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.FetchDeploymentResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.serverlessV1ServiceEnvironmentDeployment = httpRes?.data;
  ...
  FetchEnvironment(
    ...
    let baseURL: string = operations.FETCHENVIRONMENT_SERVERS[0];
    const url: string = utils.GenerateURL(baseURL, "/v1/Services/{ServiceSid}/Environments/{Sid}", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.FetchEnvironmentResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.serverlessV1ServiceEnvironment = httpRes?.data;
  ...
  FetchFunction(
    ...
    let baseURL: string = operations.FETCHFUNCTION_SERVERS[0];
    const url: string = utils.GenerateURL(baseURL, "/v1/Services/{ServiceSid}/Functions/{Sid}", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.FetchFunctionResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.serverlessV1ServiceFunction = httpRes?.data;
  ...
  FetchFunctionVersion(
    ...
    let baseURL: string = operations.FETCHFUNCTIONVERSION_SERVERS[0];
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.FetchFunctionVersionResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  FetchFunctionVersionContent(
    ...
    let baseURL: string = operations.FETCHFUNCTIONVERSIONCONTENT_SERVERS[0];
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.FetchFunctionVersionContentResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  FetchLog(
    ...
    let baseURL: string = operations.FETCHLOG_SERVERS[0];
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.FetchLogResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  FetchVariable(
    ...
    let baseURL: string = operations.FETCHVARIABLE_SERVERS[0];
    const url: string = utils.GenerateURL(baseURL, "/v1/Services/{ServiceSid}/Environments/{EnvironmentSid}/Variables/{Sid}", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.FetchVariableResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.serverlessV1ServiceEnvironmentVariable = httpRes?.data;
  ...
  ListAsset(
    ...
    let baseURL: string = operations.LISTASSET_SERVERS[0];
    const url: string = utils.GenerateURL(baseURL, "/v1/Services/{ServiceSid}/Assets", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ListAssetResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  ListAssetVersion(
    ...
    let baseURL: string = operations.LISTASSETVERSION_SERVERS[0];
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ListAssetVersionResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  ListBuild(
    ...
    let baseURL: string = operations.LISTBUILD_SERVERS[0];
    const url: string = utils.GenerateURL(baseURL, "/v1/Services/{ServiceSid}/Builds", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ListBuildResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  ListDeployment(
    ...
    let baseURL: string = operations.LISTDEPLOYMENT_SERVERS[0];
    const url: string = utils.GenerateURL(baseURL, "/v1/Services/{ServiceSid}/Environments/{EnvironmentSid}/Deployments", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ListDeploymentResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  ListEnvironment(
    ...
    let baseURL: string = operations.LISTENVIRONMENT_SERVERS[0];
    const url: string = utils.GenerateURL(baseURL, "/v1/Services/{ServiceSid}/Environments", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ListEnvironmentResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  ListFunction(
    ...
    let baseURL: string = operations.LISTFUNCTION_SERVERS[0];
    const url: string = utils.GenerateURL(baseURL, "/v1/Services/{ServiceSid}/Functions", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ListFunctionResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  ListFunctionVersion(
    ...
    let baseURL: string = operations.LISTFUNCTIONVERSION_SERVERS[0];
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ListFunctionVersionResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  ListLog(
    ...
    let baseURL: string = operations.LISTLOG_SERVERS[0];
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ListLogResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  ListVariable(
    ...
    let baseURL: string = operations.LISTVARIABLE_SERVERS[0];
    const url: string = utils.GenerateURL(baseURL, "/v1/Services/{ServiceSid}/Environments/{EnvironmentSid}/Variables", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ListVariableResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  UpdateAsset(
    ...
    let baseURL: string = operations.UPDATEASSET_SERVERS[0];
    const url: string = utils.GenerateURL(baseURL, "/v1/Services/{ServiceSid}/Assets/{Sid}", req.pathParams);
  ...
  UpdateFunction(
    ...
    let baseURL: string = operations.UPDATEFUNCTION_SERVERS[0];
    const url: string = utils.GenerateURL(baseURL, "/v1/Services/{ServiceSid}/Functions/{Sid}", req.pathParams);
  ...
  UpdateVariable(
    ...
    let baseURL: string = operations.UPDATEVARIABLE_SERVERS[0];
    const url: string = utils.GenerateURL(baseURL, "/v1/Services/{ServiceSid}/Environments/{EnvironmentSid}/Variables/{Sid}", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.UpdateVariableResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.serverlessV1ServiceEnvironmentVariable = httpRes?.data;
