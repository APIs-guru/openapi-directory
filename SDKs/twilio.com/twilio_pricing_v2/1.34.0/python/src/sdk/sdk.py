...
class SDK:
    ...
    def fetch_trunking_country(self, request: operations.FetchTrunkingCountryRequest) -> operations.FetchTrunkingCountryResponse:
        ...
        res = operations.FetchTrunkingCountryResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PricingV2TrunkingCountryInstance])
                res.responses[r.status_code][content_type] = operations.FetchTrunkingCountryResponses(pricing_v2_trunking_country_instance=out)
    ...
    def fetch_trunking_number(self, request: operations.FetchTrunkingNumberRequest) -> operations.FetchTrunkingNumberResponse:
        ...
        res = operations.FetchTrunkingNumberResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PricingV2TrunkingNumber])
                res.responses[r.status_code][content_type] = operations.FetchTrunkingNumberResponses(pricing_v2_trunking_number=out)
    ...
    def fetch_voice_country(self, request: operations.FetchVoiceCountryRequest) -> operations.FetchVoiceCountryResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.FetchVoiceCountryResponses(pricing_v2_voice_voice_country_instance=out)
    ...
    def fetch_voice_number(self, request: operations.FetchVoiceNumberRequest) -> operations.FetchVoiceNumberResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.FetchVoiceNumberResponses(pricing_v2_voice_voice_number=out)
    ...
    def list_trunking_country(self, request: operations.ListTrunkingCountryRequest) -> operations.ListTrunkingCountryResponse:
        ...
        res = operations.ListTrunkingCountryResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListTrunkingCountry200ApplicationJSONListTrunkingCountryResponse])
                res.responses[r.status_code][content_type] = operations.ListTrunkingCountryResponses(list_trunking_country_response=out)
