...
class PricingV2VoiceVoiceNumber:
    ...
    inbound_call_price: Optional[PricingV2VoiceVoiceNumberInboundCallPrice] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('inbound_call_price') }})
    ...
    outbound_call_prices: Optional[List[PricingV2VoiceVoiceNumberOutboundCallPrices]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('outbound_call_prices') }})
