...
class PricingV2TrunkingCountryInstance:
    ...
    originating_call_prices: Optional[List[PricingV2TrunkingCountryInstanceOriginatingCallPrices]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'originating_call_prices' }})
    price_unit: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'price_unit' }})
    terminating_prefix_prices: Optional[List[PricingV2TrunkingCountryInstanceTerminatingPrefixPrices]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'terminating_prefix_prices' }})
