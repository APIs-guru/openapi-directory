...
type FetchTrustedCommsCurrentCallHeaders struct {
	XXcnamSensitivePhoneNumberFrom *string `header:"name=X-Xcnam-Sensitive-Phone-Number-From"`
	XXcnamSensitivePhoneNumberTo   *string `header:"name=X-Xcnam-Sensitive-Phone-Number-To"`
}
