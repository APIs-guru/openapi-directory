...
from . import authorization_document_enum_status_enum
...
class PreviewHostedNumbersAuthorizationDocument:
    ...
    status: Optional[authorization_document_enum_status_enum.AuthorizationDocumentEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
