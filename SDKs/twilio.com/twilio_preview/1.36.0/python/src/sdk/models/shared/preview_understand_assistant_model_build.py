...
from . import model_build_enum_status_enum
...
class PreviewUnderstandAssistantModelBuild:
    ...
    status: Optional[model_build_enum_status_enum.ModelBuildEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
