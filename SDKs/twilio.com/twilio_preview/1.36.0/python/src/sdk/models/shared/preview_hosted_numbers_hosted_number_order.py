...
from . import hosted_number_order_enum_status_enum
from . import hosted_number_order_enum_verification_type_enum
...
class PreviewHostedNumbersHostedNumberOrder:
    ...
    status: Optional[hosted_number_order_enum_status_enum.HostedNumberOrderEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
    ...
    verification_type: Optional[hosted_number_order_enum_verification_type_enum.HostedNumberOrderEnumVerificationTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'verification_type' }})
