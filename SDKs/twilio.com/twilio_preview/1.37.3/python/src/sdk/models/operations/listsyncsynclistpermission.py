...
class ListSyncSyncListPermissionListSyncSyncListPermissionResponse:
    meta: Optional[ListSyncSyncListPermissionListSyncSyncListPermissionResponseMeta] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    permissions: Optional[List[shared.PreviewSyncServiceSyncListSyncListPermission]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('permissions') }})
    

@dataclass
class ListSyncSyncListPermissionRequest:
    path_params: ListSyncSyncListPermissionPathParams = field()
    query_params: ListSyncSyncListPermissionQueryParams = field()
    security: ListSyncSyncListPermissionSecurity = field()
