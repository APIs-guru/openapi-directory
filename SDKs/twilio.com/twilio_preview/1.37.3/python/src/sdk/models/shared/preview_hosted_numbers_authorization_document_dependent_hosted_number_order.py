...
class PreviewHostedNumbersAuthorizationDocumentDependentHostedNumberOrderCapabilities:
    r"""PreviewHostedNumbersAuthorizationDocumentDependentHostedNumberOrderCapabilities
...
class PreviewHostedNumbersAuthorizationDocumentDependentHostedNumberOrder:
    ...
    capabilities: Optional[PreviewHostedNumbersAuthorizationDocumentDependentHostedNumberOrderCapabilities] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('capabilities') }})
    ...
    status: Optional[DependentHostedNumberOrderEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
    ...
    verification_type: Optional[DependentHostedNumberOrderEnumVerificationTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('verification_type') }})
