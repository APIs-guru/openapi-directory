...
class ListUnderstandModelBuildListUnderstandModelBuildResponse:
    meta: Optional[ListUnderstandModelBuildListUnderstandModelBuildResponseMeta] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    model_builds: Optional[List[shared.PreviewUnderstandAssistantModelBuild]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('model_builds') }})
    

@dataclass
class ListUnderstandModelBuildRequest:
    path_params: ListUnderstandModelBuildPathParams = field()
    query_params: ListUnderstandModelBuildQueryParams = field()
    security: ListUnderstandModelBuildSecurity = field()
