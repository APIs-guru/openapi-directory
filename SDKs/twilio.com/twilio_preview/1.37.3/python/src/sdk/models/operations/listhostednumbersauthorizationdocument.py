...
class ListHostedNumbersAuthorizationDocumentListHostedNumbersAuthorizationDocumentResponse:
    items: Optional[List[shared.PreviewHostedNumbersAuthorizationDocument]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('items') }})
    meta: Optional[ListHostedNumbersAuthorizationDocumentListHostedNumbersAuthorizationDocumentResponseMeta] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    

@dataclass
class ListHostedNumbersAuthorizationDocumentRequest:
    query_params: ListHostedNumbersAuthorizationDocumentQueryParams = field()
    security: ListHostedNumbersAuthorizationDocumentSecurity = field()
