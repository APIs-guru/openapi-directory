...
@dataclass
class UpdateMarketplaceInstalledAddOnExtensionResponses:
...
class UpdateMarketplaceInstalledAddOnExtensionResponse:
    ...
    responses: dict[int, dict[str, UpdateMarketplaceInstalledAddOnExtensionResponses]] = field(default=None)
