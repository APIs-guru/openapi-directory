...
class PreviewHostedNumbersHostedNumberOrder:
    ...
    capabilities: Optional[PreviewHostedNumbersHostedNumberOrderCapabilities] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'capabilities' }})
    ...
    status: Optional[shared.HostedNumberOrderEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
    ...
    verification_type: Optional[shared.HostedNumberOrderEnumVerificationTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'verification_type' }})
