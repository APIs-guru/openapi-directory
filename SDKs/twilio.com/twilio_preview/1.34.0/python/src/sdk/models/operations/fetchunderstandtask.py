...
class FetchUnderstandTaskRequest:
    ...
    path_params: FetchUnderstandTaskPathParams = field(default=None)
    security: FetchUnderstandTaskSecurity = field(default=None)
    

@dataclass
class FetchUnderstandTaskResponses:
...
class FetchUnderstandTaskResponse:
    ...
    responses: dict[int, dict[str, FetchUnderstandTaskResponses]] = field(default=None)
