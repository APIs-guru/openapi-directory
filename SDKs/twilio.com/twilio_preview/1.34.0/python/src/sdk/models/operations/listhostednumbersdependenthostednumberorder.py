...
@dataclass
class ListHostedNumbersDependentHostedNumberOrderResponses:
...
class ListHostedNumbersDependentHostedNumberOrderResponse:
    ...
    responses: dict[int, dict[str, ListHostedNumbersDependentHostedNumberOrderResponses]] = field(default=None)
