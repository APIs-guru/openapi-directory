...
class PreviewHostedNumbersAuthorizationDocumentDependentHostedNumberOrder:
    ...
    status: Optional[shared.DependentHostedNumberOrderEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
    ...
    verification_type: Optional[shared.DependentHostedNumberOrderEnumVerificationTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'verification_type' }})
