...
class FetchTrustedCommsBrandedChannelRequest:
    ...
    path_params: FetchTrustedCommsBrandedChannelPathParams = field(default=None)
    security: FetchTrustedCommsBrandedChannelSecurity = field(default=None)
    

@dataclass
class FetchTrustedCommsBrandedChannelResponses:
...
class FetchTrustedCommsBrandedChannelResponse:
    ...
    responses: dict[int, dict[str, FetchTrustedCommsBrandedChannelResponses]] = field(default=None)
