...
@dataclass_json
@dataclass
class ListUnderstandFieldValue200ApplicationJSONMeta:
...
@dataclass_json
@dataclass
class ListUnderstandFieldValue200ApplicationJSONListUnderstandFieldValueResponse:
    ...
    meta: Optional[ListUnderstandFieldValue200ApplicationJSONMeta] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'meta' }})
    

@dataclass
class ListUnderstandFieldValueResponses:
    list_understand_field_value_response: Optional[ListUnderstandFieldValue200ApplicationJSONListUnderstandFieldValueResponse] = field(default=None)
    

@dataclass
class ListUnderstandFieldValueResponse:
    content_type: str = field(default=None)
    responses: dict[int, dict[str, ListUnderstandFieldValueResponses]] = field(default=None)
