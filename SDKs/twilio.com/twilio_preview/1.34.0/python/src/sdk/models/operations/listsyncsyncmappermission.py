...
@dataclass_json
@dataclass
class ListSyncSyncMapPermission200ApplicationJSONMeta:
...
@dataclass_json
@dataclass
class ListSyncSyncMapPermission200ApplicationJSONListSyncSyncMapPermissionResponse:
    meta: Optional[ListSyncSyncMapPermission200ApplicationJSONMeta] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'meta' }})
...
@dataclass
class ListSyncSyncMapPermissionResponses:
    list_sync_sync_map_permission_response: Optional[ListSyncSyncMapPermission200ApplicationJSONListSyncSyncMapPermissionResponse] = field(default=None)
    

@dataclass
class ListSyncSyncMapPermissionResponse:
    content_type: str = field(default=None)
    responses: dict[int, dict[str, ListSyncSyncMapPermissionResponses]] = field(default=None)
