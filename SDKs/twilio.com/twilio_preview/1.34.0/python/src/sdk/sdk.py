...
class SDK:
    ...
    def create_deployed_devices_certificate(self, request: operations.CreateDeployedDevicesCertificateRequest) -> operations.CreateDeployedDevicesCertificateResponse:
        ...
        res = operations.CreateDeployedDevicesCertificateResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewDeployedDevicesFleetCertificate])
                res.responses[r.status_code][content_type] = operations.CreateDeployedDevicesCertificateResponses(preview_deployed_devices_fleet_certificate=out)
    ...
    def create_deployed_devices_deployment(self, request: operations.CreateDeployedDevicesDeploymentRequest) -> operations.CreateDeployedDevicesDeploymentResponse:
        ...
        res = operations.CreateDeployedDevicesDeploymentResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewDeployedDevicesFleetDeployment])
                res.responses[r.status_code][content_type] = operations.CreateDeployedDevicesDeploymentResponses(preview_deployed_devices_fleet_deployment=out)
    ...
    def create_deployed_devices_device(self, request: operations.CreateDeployedDevicesDeviceRequest) -> operations.CreateDeployedDevicesDeviceResponse:
        ...
        res = operations.CreateDeployedDevicesDeviceResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewDeployedDevicesFleetDevice])
                res.responses[r.status_code][content_type] = operations.CreateDeployedDevicesDeviceResponses(preview_deployed_devices_fleet_device=out)
    ...
    def create_deployed_devices_fleet(self, request: operations.CreateDeployedDevicesFleetRequest) -> operations.CreateDeployedDevicesFleetResponse:
        ...
        res = operations.CreateDeployedDevicesFleetResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewDeployedDevicesFleet])
                res.responses[r.status_code][content_type] = operations.CreateDeployedDevicesFleetResponses(preview_deployed_devices_fleet=out)
    ...
    def create_deployed_devices_key(self, request: operations.CreateDeployedDevicesKeyRequest) -> operations.CreateDeployedDevicesKeyResponse:
        ...
        res = operations.CreateDeployedDevicesKeyResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewDeployedDevicesFleetKey])
                res.responses[r.status_code][content_type] = operations.CreateDeployedDevicesKeyResponses(preview_deployed_devices_fleet_key=out)
    ...
    def create_hosted_numbers_authorization_document(self, request: operations.CreateHostedNumbersAuthorizationDocumentRequest) -> operations.CreateHostedNumbersAuthorizationDocumentResponse:
        ...
        res = operations.CreateHostedNumbersAuthorizationDocumentResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewHostedNumbersAuthorizationDocument])
                res.responses[r.status_code][content_type] = operations.CreateHostedNumbersAuthorizationDocumentResponses(preview_hosted_numbers_authorization_document=out)
    ...
    def create_hosted_numbers_hosted_number_order(self, request: operations.CreateHostedNumbersHostedNumberOrderRequest) -> operations.CreateHostedNumbersHostedNumberOrderResponse:
        ...
        res = operations.CreateHostedNumbersHostedNumberOrderResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewHostedNumbersHostedNumberOrder])
                res.responses[r.status_code][content_type] = operations.CreateHostedNumbersHostedNumberOrderResponses(preview_hosted_numbers_hosted_number_order=out)
    ...
    def create_marketplace_installed_add_on(self, request: operations.CreateMarketplaceInstalledAddOnRequest) -> operations.CreateMarketplaceInstalledAddOnResponse:
        ...
        res = operations.CreateMarketplaceInstalledAddOnResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewMarketplaceInstalledAddOn])
                res.responses[r.status_code][content_type] = operations.CreateMarketplaceInstalledAddOnResponses(preview_marketplace_installed_add_on=out)
    ...
    def create_sync_document(self, request: operations.CreateSyncDocumentRequest) -> operations.CreateSyncDocumentResponse:
        ...
        res = operations.CreateSyncDocumentResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewSyncServiceDocument])
                res.responses[r.status_code][content_type] = operations.CreateSyncDocumentResponses(preview_sync_service_document=out)
    ...
    def create_sync_service(self, request: operations.CreateSyncServiceRequest) -> operations.CreateSyncServiceResponse:
        ...
        res = operations.CreateSyncServiceResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewSyncService])
                res.responses[r.status_code][content_type] = operations.CreateSyncServiceResponses(preview_sync_service=out)
    ...
    def create_sync_sync_list(self, request: operations.CreateSyncSyncListRequest) -> operations.CreateSyncSyncListResponse:
        ...
        res = operations.CreateSyncSyncListResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewSyncServiceSyncList])
                res.responses[r.status_code][content_type] = operations.CreateSyncSyncListResponses(preview_sync_service_sync_list=out)
    ...
    def create_sync_sync_list_item(self, request: operations.CreateSyncSyncListItemRequest) -> operations.CreateSyncSyncListItemResponse:
        ...
        res = operations.CreateSyncSyncListItemResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewSyncServiceSyncListSyncListItem])
                res.responses[r.status_code][content_type] = operations.CreateSyncSyncListItemResponses(preview_sync_service_sync_list_sync_list_item=out)
    ...
    def create_sync_sync_map(self, request: operations.CreateSyncSyncMapRequest) -> operations.CreateSyncSyncMapResponse:
        ...
        res = operations.CreateSyncSyncMapResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewSyncServiceSyncMap])
                res.responses[r.status_code][content_type] = operations.CreateSyncSyncMapResponses(preview_sync_service_sync_map=out)
    ...
    def create_sync_sync_map_item(self, request: operations.CreateSyncSyncMapItemRequest) -> operations.CreateSyncSyncMapItemResponse:
        ...
        res = operations.CreateSyncSyncMapItemResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewSyncServiceSyncMapSyncMapItem])
                res.responses[r.status_code][content_type] = operations.CreateSyncSyncMapItemResponses(preview_sync_service_sync_map_sync_map_item=out)
    ...
    def create_trusted_comms_channel(self, request: operations.CreateTrustedCommsChannelRequest) -> operations.CreateTrustedCommsChannelResponse:
        ...
        res = operations.CreateTrustedCommsChannelResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewTrustedCommsBrandedChannelChannel])
                res.responses[r.status_code][content_type] = operations.CreateTrustedCommsChannelResponses(preview_trusted_comms_branded_channel_channel=out)
    ...
    def create_understand_assistant(self, request: operations.CreateUnderstandAssistantRequest) -> operations.CreateUnderstandAssistantResponse:
        ...
        res = operations.CreateUnderstandAssistantResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistant])
                res.responses[r.status_code][content_type] = operations.CreateUnderstandAssistantResponses(preview_understand_assistant=out)
    ...
    def create_understand_field(self, request: operations.CreateUnderstandFieldRequest) -> operations.CreateUnderstandFieldResponse:
        ...
        res = operations.CreateUnderstandFieldResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantTaskField])
                res.responses[r.status_code][content_type] = operations.CreateUnderstandFieldResponses(preview_understand_assistant_task_field=out)
    ...
    def create_understand_field_type(self, request: operations.CreateUnderstandFieldTypeRequest) -> operations.CreateUnderstandFieldTypeResponse:
        ...
        res = operations.CreateUnderstandFieldTypeResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantFieldType])
                res.responses[r.status_code][content_type] = operations.CreateUnderstandFieldTypeResponses(preview_understand_assistant_field_type=out)
    ...
    def create_understand_field_value(self, request: operations.CreateUnderstandFieldValueRequest) -> operations.CreateUnderstandFieldValueResponse:
        ...
        res = operations.CreateUnderstandFieldValueResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantFieldTypeFieldValue])
                res.responses[r.status_code][content_type] = operations.CreateUnderstandFieldValueResponses(preview_understand_assistant_field_type_field_value=out)
    ...
    def create_understand_model_build(self, request: operations.CreateUnderstandModelBuildRequest) -> operations.CreateUnderstandModelBuildResponse:
        ...
        res = operations.CreateUnderstandModelBuildResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantModelBuild])
                res.responses[r.status_code][content_type] = operations.CreateUnderstandModelBuildResponses(preview_understand_assistant_model_build=out)
    ...
    def create_understand_query(self, request: operations.CreateUnderstandQueryRequest) -> operations.CreateUnderstandQueryResponse:
        ...
        res = operations.CreateUnderstandQueryResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantQuery])
                res.responses[r.status_code][content_type] = operations.CreateUnderstandQueryResponses(preview_understand_assistant_query=out)
    ...
    def create_understand_sample(self, request: operations.CreateUnderstandSampleRequest) -> operations.CreateUnderstandSampleResponse:
        ...
        res = operations.CreateUnderstandSampleResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantTaskSample])
                res.responses[r.status_code][content_type] = operations.CreateUnderstandSampleResponses(preview_understand_assistant_task_sample=out)
    ...
    def create_understand_task(self, request: operations.CreateUnderstandTaskRequest) -> operations.CreateUnderstandTaskResponse:
        ...
        res = operations.CreateUnderstandTaskResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantTask])
                res.responses[r.status_code][content_type] = operations.CreateUnderstandTaskResponses(preview_understand_assistant_task=out)
    ...
    def create_wireless_command(self, request: operations.CreateWirelessCommandRequest) -> operations.CreateWirelessCommandResponse:
        ...
        res = operations.CreateWirelessCommandResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewWirelessCommand])
                res.responses[r.status_code][content_type] = operations.CreateWirelessCommandResponses(preview_wireless_command=out)
    ...
    def create_wireless_rate_plan(self, request: operations.CreateWirelessRatePlanRequest) -> operations.CreateWirelessRatePlanResponse:
        ...
        res = operations.CreateWirelessRatePlanResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewWirelessRatePlan])
                res.responses[r.status_code][content_type] = operations.CreateWirelessRatePlanResponses(preview_wireless_rate_plan=out)
    ...
    def fetch_deployed_devices_certificate(self, request: operations.FetchDeployedDevicesCertificateRequest) -> operations.FetchDeployedDevicesCertificateResponse:
        ...
        res = operations.FetchDeployedDevicesCertificateResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewDeployedDevicesFleetCertificate])
                res.responses[r.status_code][content_type] = operations.FetchDeployedDevicesCertificateResponses(preview_deployed_devices_fleet_certificate=out)
    ...
    def fetch_deployed_devices_deployment(self, request: operations.FetchDeployedDevicesDeploymentRequest) -> operations.FetchDeployedDevicesDeploymentResponse:
        ...
        res = operations.FetchDeployedDevicesDeploymentResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewDeployedDevicesFleetDeployment])
                res.responses[r.status_code][content_type] = operations.FetchDeployedDevicesDeploymentResponses(preview_deployed_devices_fleet_deployment=out)
    ...
    def fetch_deployed_devices_device(self, request: operations.FetchDeployedDevicesDeviceRequest) -> operations.FetchDeployedDevicesDeviceResponse:
        ...
        res = operations.FetchDeployedDevicesDeviceResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewDeployedDevicesFleetDevice])
                res.responses[r.status_code][content_type] = operations.FetchDeployedDevicesDeviceResponses(preview_deployed_devices_fleet_device=out)
    ...
    def fetch_deployed_devices_fleet(self, request: operations.FetchDeployedDevicesFleetRequest) -> operations.FetchDeployedDevicesFleetResponse:
        ...
        res = operations.FetchDeployedDevicesFleetResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewDeployedDevicesFleet])
                res.responses[r.status_code][content_type] = operations.FetchDeployedDevicesFleetResponses(preview_deployed_devices_fleet=out)
    ...
    def fetch_deployed_devices_key(self, request: operations.FetchDeployedDevicesKeyRequest) -> operations.FetchDeployedDevicesKeyResponse:
        ...
        res = operations.FetchDeployedDevicesKeyResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewDeployedDevicesFleetKey])
                res.responses[r.status_code][content_type] = operations.FetchDeployedDevicesKeyResponses(preview_deployed_devices_fleet_key=out)
    ...
    def fetch_hosted_numbers_authorization_document(self, request: operations.FetchHostedNumbersAuthorizationDocumentRequest) -> operations.FetchHostedNumbersAuthorizationDocumentResponse:
        ...
        res = operations.FetchHostedNumbersAuthorizationDocumentResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewHostedNumbersAuthorizationDocument])
                res.responses[r.status_code][content_type] = operations.FetchHostedNumbersAuthorizationDocumentResponses(preview_hosted_numbers_authorization_document=out)
    ...
    def fetch_hosted_numbers_hosted_number_order(self, request: operations.FetchHostedNumbersHostedNumberOrderRequest) -> operations.FetchHostedNumbersHostedNumberOrderResponse:
        ...
        res = operations.FetchHostedNumbersHostedNumberOrderResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewHostedNumbersHostedNumberOrder])
                res.responses[r.status_code][content_type] = operations.FetchHostedNumbersHostedNumberOrderResponses(preview_hosted_numbers_hosted_number_order=out)
    ...
    def fetch_marketplace_available_add_on(self, request: operations.FetchMarketplaceAvailableAddOnRequest) -> operations.FetchMarketplaceAvailableAddOnResponse:
        ...
        res = operations.FetchMarketplaceAvailableAddOnResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewMarketplaceAvailableAddOn])
                res.responses[r.status_code][content_type] = operations.FetchMarketplaceAvailableAddOnResponses(preview_marketplace_available_add_on=out)
    ...
    def fetch_marketplace_available_add_on_extension(self, request: operations.FetchMarketplaceAvailableAddOnExtensionRequest) -> operations.FetchMarketplaceAvailableAddOnExtensionResponse:
        ...
        res = operations.FetchMarketplaceAvailableAddOnExtensionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewMarketplaceAvailableAddOnAvailableAddOnExtension])
                res.responses[r.status_code][content_type] = operations.FetchMarketplaceAvailableAddOnExtensionResponses(preview_marketplace_available_add_on_available_add_on_extension=out)
    ...
    def fetch_marketplace_installed_add_on(self, request: operations.FetchMarketplaceInstalledAddOnRequest) -> operations.FetchMarketplaceInstalledAddOnResponse:
        ...
        res = operations.FetchMarketplaceInstalledAddOnResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewMarketplaceInstalledAddOn])
                res.responses[r.status_code][content_type] = operations.FetchMarketplaceInstalledAddOnResponses(preview_marketplace_installed_add_on=out)
    ...
    def fetch_marketplace_installed_add_on_extension(self, request: operations.FetchMarketplaceInstalledAddOnExtensionRequest) -> operations.FetchMarketplaceInstalledAddOnExtensionResponse:
        ...
        res = operations.FetchMarketplaceInstalledAddOnExtensionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewMarketplaceInstalledAddOnInstalledAddOnExtension])
                res.responses[r.status_code][content_type] = operations.FetchMarketplaceInstalledAddOnExtensionResponses(preview_marketplace_installed_add_on_installed_add_on_extension=out)
    ...
    def fetch_sync_document(self, request: operations.FetchSyncDocumentRequest) -> operations.FetchSyncDocumentResponse:
        ...
        res = operations.FetchSyncDocumentResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewSyncServiceDocument])
                res.responses[r.status_code][content_type] = operations.FetchSyncDocumentResponses(preview_sync_service_document=out)
    ...
    def fetch_sync_document_permission(self, request: operations.FetchSyncDocumentPermissionRequest) -> operations.FetchSyncDocumentPermissionResponse:
        ...
        res = operations.FetchSyncDocumentPermissionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewSyncServiceDocumentDocumentPermission])
                res.responses[r.status_code][content_type] = operations.FetchSyncDocumentPermissionResponses(preview_sync_service_document_document_permission=out)
    ...
    def fetch_sync_service(self, request: operations.FetchSyncServiceRequest) -> operations.FetchSyncServiceResponse:
        ...
        res = operations.FetchSyncServiceResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewSyncService])
                res.responses[r.status_code][content_type] = operations.FetchSyncServiceResponses(preview_sync_service=out)
    ...
    def fetch_sync_sync_list(self, request: operations.FetchSyncSyncListRequest) -> operations.FetchSyncSyncListResponse:
        ...
        res = operations.FetchSyncSyncListResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewSyncServiceSyncList])
                res.responses[r.status_code][content_type] = operations.FetchSyncSyncListResponses(preview_sync_service_sync_list=out)
    ...
    def fetch_sync_sync_list_item(self, request: operations.FetchSyncSyncListItemRequest) -> operations.FetchSyncSyncListItemResponse:
        ...
        res = operations.FetchSyncSyncListItemResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewSyncServiceSyncListSyncListItem])
                res.responses[r.status_code][content_type] = operations.FetchSyncSyncListItemResponses(preview_sync_service_sync_list_sync_list_item=out)
    ...
    def fetch_sync_sync_list_permission(self, request: operations.FetchSyncSyncListPermissionRequest) -> operations.FetchSyncSyncListPermissionResponse:
        ...
        res = operations.FetchSyncSyncListPermissionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewSyncServiceSyncListSyncListPermission])
                res.responses[r.status_code][content_type] = operations.FetchSyncSyncListPermissionResponses(preview_sync_service_sync_list_sync_list_permission=out)
    ...
    def fetch_sync_sync_map(self, request: operations.FetchSyncSyncMapRequest) -> operations.FetchSyncSyncMapResponse:
        ...
        res = operations.FetchSyncSyncMapResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewSyncServiceSyncMap])
                res.responses[r.status_code][content_type] = operations.FetchSyncSyncMapResponses(preview_sync_service_sync_map=out)
    ...
    def fetch_sync_sync_map_item(self, request: operations.FetchSyncSyncMapItemRequest) -> operations.FetchSyncSyncMapItemResponse:
        ...
        res = operations.FetchSyncSyncMapItemResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewSyncServiceSyncMapSyncMapItem])
                res.responses[r.status_code][content_type] = operations.FetchSyncSyncMapItemResponses(preview_sync_service_sync_map_sync_map_item=out)
    ...
    def fetch_sync_sync_map_permission(self, request: operations.FetchSyncSyncMapPermissionRequest) -> operations.FetchSyncSyncMapPermissionResponse:
        ...
        res = operations.FetchSyncSyncMapPermissionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewSyncServiceSyncMapSyncMapPermission])
                res.responses[r.status_code][content_type] = operations.FetchSyncSyncMapPermissionResponses(preview_sync_service_sync_map_sync_map_permission=out)
    ...
    def fetch_trusted_comms_branded_channel(self, request: operations.FetchTrustedCommsBrandedChannelRequest) -> operations.FetchTrustedCommsBrandedChannelResponse:
        ...
        res = operations.FetchTrustedCommsBrandedChannelResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewTrustedCommsBrandedChannel])
                res.responses[r.status_code][content_type] = operations.FetchTrustedCommsBrandedChannelResponses(preview_trusted_comms_branded_channel=out)
    ...
    def fetch_trusted_comms_brands_information(self, request: operations.FetchTrustedCommsBrandsInformationRequest) -> operations.FetchTrustedCommsBrandsInformationResponse:
        ...
        res = operations.FetchTrustedCommsBrandsInformationResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewTrustedCommsBrandsInformation])
                res.responses[r.status_code][content_type] = operations.FetchTrustedCommsBrandsInformationResponses(preview_trusted_comms_brands_information=out)
    ...
    def fetch_trusted_comms_cps(self, request: operations.FetchTrustedCommsCpsRequest) -> operations.FetchTrustedCommsCpsResponse:
        ...
        res = operations.FetchTrustedCommsCpsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewTrustedCommsCps])
                res.responses[r.status_code][content_type] = operations.FetchTrustedCommsCpsResponses(preview_trusted_comms_cps=out)
    ...
    def fetch_trusted_comms_current_call(self, request: operations.FetchTrustedCommsCurrentCallRequest) -> operations.FetchTrustedCommsCurrentCallResponse:
        ...
        res = operations.FetchTrustedCommsCurrentCallResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewTrustedCommsCurrentCall])
                res.responses[r.status_code][content_type] = operations.FetchTrustedCommsCurrentCallResponses(preview_trusted_comms_current_call=out)
    ...
    def fetch_understand_assistant(self, request: operations.FetchUnderstandAssistantRequest) -> operations.FetchUnderstandAssistantResponse:
        ...
        res = operations.FetchUnderstandAssistantResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistant])
                res.responses[r.status_code][content_type] = operations.FetchUnderstandAssistantResponses(preview_understand_assistant=out)
    ...
    def fetch_understand_assistant_fallback_actions(self, request: operations.FetchUnderstandAssistantFallbackActionsRequest) -> operations.FetchUnderstandAssistantFallbackActionsResponse:
        ...
        res = operations.FetchUnderstandAssistantFallbackActionsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantAssistantFallbackActions])
                res.responses[r.status_code][content_type] = operations.FetchUnderstandAssistantFallbackActionsResponses(preview_understand_assistant_assistant_fallback_actions=out)
    ...
    def fetch_understand_assistant_initiation_actions(self, request: operations.FetchUnderstandAssistantInitiationActionsRequest) -> operations.FetchUnderstandAssistantInitiationActionsResponse:
        ...
        res = operations.FetchUnderstandAssistantInitiationActionsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantAssistantInitiationActions])
                res.responses[r.status_code][content_type] = operations.FetchUnderstandAssistantInitiationActionsResponses(preview_understand_assistant_assistant_initiation_actions=out)
    ...
    def fetch_understand_dialogue(self, request: operations.FetchUnderstandDialogueRequest) -> operations.FetchUnderstandDialogueResponse:
        ...
        res = operations.FetchUnderstandDialogueResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantDialogue])
                res.responses[r.status_code][content_type] = operations.FetchUnderstandDialogueResponses(preview_understand_assistant_dialogue=out)
    ...
    def fetch_understand_field(self, request: operations.FetchUnderstandFieldRequest) -> operations.FetchUnderstandFieldResponse:
        ...
        res = operations.FetchUnderstandFieldResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantTaskField])
                res.responses[r.status_code][content_type] = operations.FetchUnderstandFieldResponses(preview_understand_assistant_task_field=out)
    ...
    def fetch_understand_field_type(self, request: operations.FetchUnderstandFieldTypeRequest) -> operations.FetchUnderstandFieldTypeResponse:
        ...
        res = operations.FetchUnderstandFieldTypeResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantFieldType])
                res.responses[r.status_code][content_type] = operations.FetchUnderstandFieldTypeResponses(preview_understand_assistant_field_type=out)
    ...
    def fetch_understand_field_value(self, request: operations.FetchUnderstandFieldValueRequest) -> operations.FetchUnderstandFieldValueResponse:
        ...
        res = operations.FetchUnderstandFieldValueResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantFieldTypeFieldValue])
                res.responses[r.status_code][content_type] = operations.FetchUnderstandFieldValueResponses(preview_understand_assistant_field_type_field_value=out)
    ...
    def fetch_understand_model_build(self, request: operations.FetchUnderstandModelBuildRequest) -> operations.FetchUnderstandModelBuildResponse:
        ...
        res = operations.FetchUnderstandModelBuildResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantModelBuild])
                res.responses[r.status_code][content_type] = operations.FetchUnderstandModelBuildResponses(preview_understand_assistant_model_build=out)
    ...
    def fetch_understand_query(self, request: operations.FetchUnderstandQueryRequest) -> operations.FetchUnderstandQueryResponse:
        ...
        res = operations.FetchUnderstandQueryResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantQuery])
                res.responses[r.status_code][content_type] = operations.FetchUnderstandQueryResponses(preview_understand_assistant_query=out)
    ...
    def fetch_understand_sample(self, request: operations.FetchUnderstandSampleRequest) -> operations.FetchUnderstandSampleResponse:
        ...
        res = operations.FetchUnderstandSampleResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantTaskSample])
                res.responses[r.status_code][content_type] = operations.FetchUnderstandSampleResponses(preview_understand_assistant_task_sample=out)
    ...
    def fetch_understand_style_sheet(self, request: operations.FetchUnderstandStyleSheetRequest) -> operations.FetchUnderstandStyleSheetResponse:
        ...
        res = operations.FetchUnderstandStyleSheetResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantStyleSheet])
                res.responses[r.status_code][content_type] = operations.FetchUnderstandStyleSheetResponses(preview_understand_assistant_style_sheet=out)
    ...
    def fetch_understand_task(self, request: operations.FetchUnderstandTaskRequest) -> operations.FetchUnderstandTaskResponse:
        ...
        res = operations.FetchUnderstandTaskResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantTask])
                res.responses[r.status_code][content_type] = operations.FetchUnderstandTaskResponses(preview_understand_assistant_task=out)
    ...
    def fetch_understand_task_actions(self, request: operations.FetchUnderstandTaskActionsRequest) -> operations.FetchUnderstandTaskActionsResponse:
        ...
        res = operations.FetchUnderstandTaskActionsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantTaskTaskActions])
                res.responses[r.status_code][content_type] = operations.FetchUnderstandTaskActionsResponses(preview_understand_assistant_task_task_actions=out)
    ...
    def fetch_understand_task_statistics(self, request: operations.FetchUnderstandTaskStatisticsRequest) -> operations.FetchUnderstandTaskStatisticsResponse:
        ...
        res = operations.FetchUnderstandTaskStatisticsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantTaskTaskStatistics])
                res.responses[r.status_code][content_type] = operations.FetchUnderstandTaskStatisticsResponses(preview_understand_assistant_task_task_statistics=out)
    ...
    def fetch_wireless_command(self, request: operations.FetchWirelessCommandRequest) -> operations.FetchWirelessCommandResponse:
        ...
        res = operations.FetchWirelessCommandResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewWirelessCommand])
                res.responses[r.status_code][content_type] = operations.FetchWirelessCommandResponses(preview_wireless_command=out)
    ...
    def fetch_wireless_rate_plan(self, request: operations.FetchWirelessRatePlanRequest) -> operations.FetchWirelessRatePlanResponse:
        ...
        res = operations.FetchWirelessRatePlanResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewWirelessRatePlan])
                res.responses[r.status_code][content_type] = operations.FetchWirelessRatePlanResponses(preview_wireless_rate_plan=out)
    ...
    def fetch_wireless_sim(self, request: operations.FetchWirelessSimRequest) -> operations.FetchWirelessSimResponse:
        ...
        res = operations.FetchWirelessSimResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewWirelessSim])
                res.responses[r.status_code][content_type] = operations.FetchWirelessSimResponses(preview_wireless_sim=out)
    ...
    def fetch_wireless_usage(self, request: operations.FetchWirelessUsageRequest) -> operations.FetchWirelessUsageResponse:
        ...
        res = operations.FetchWirelessUsageResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewWirelessSimUsage])
                res.responses[r.status_code][content_type] = operations.FetchWirelessUsageResponses(preview_wireless_sim_usage=out)
    ...
    def list_deployed_devices_certificate(self, request: operations.ListDeployedDevicesCertificateRequest) -> operations.ListDeployedDevicesCertificateResponse:
        ...
        res = operations.ListDeployedDevicesCertificateResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListDeployedDevicesCertificate200ApplicationJSONListDeployedDevicesCertificateResponse])
                res.responses[r.status_code][content_type] = operations.ListDeployedDevicesCertificateResponses(list_deployed_devices_certificate_response=out)
    ...
    def list_deployed_devices_deployment(self, request: operations.ListDeployedDevicesDeploymentRequest) -> operations.ListDeployedDevicesDeploymentResponse:
        ...
        res = operations.ListDeployedDevicesDeploymentResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListDeployedDevicesDeployment200ApplicationJSONListDeployedDevicesDeploymentResponse])
                res.responses[r.status_code][content_type] = operations.ListDeployedDevicesDeploymentResponses(list_deployed_devices_deployment_response=out)
    ...
    def list_deployed_devices_device(self, request: operations.ListDeployedDevicesDeviceRequest) -> operations.ListDeployedDevicesDeviceResponse:
        ...
        res = operations.ListDeployedDevicesDeviceResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListDeployedDevicesDevice200ApplicationJSONListDeployedDevicesDeviceResponse])
                res.responses[r.status_code][content_type] = operations.ListDeployedDevicesDeviceResponses(list_deployed_devices_device_response=out)
    ...
    def list_deployed_devices_fleet(self, request: operations.ListDeployedDevicesFleetRequest) -> operations.ListDeployedDevicesFleetResponse:
        ...
        res = operations.ListDeployedDevicesFleetResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListDeployedDevicesFleet200ApplicationJSONListDeployedDevicesFleetResponse])
                res.responses[r.status_code][content_type] = operations.ListDeployedDevicesFleetResponses(list_deployed_devices_fleet_response=out)
    ...
    def list_deployed_devices_key(self, request: operations.ListDeployedDevicesKeyRequest) -> operations.ListDeployedDevicesKeyResponse:
        ...
        res = operations.ListDeployedDevicesKeyResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListDeployedDevicesKey200ApplicationJSONListDeployedDevicesKeyResponse])
                res.responses[r.status_code][content_type] = operations.ListDeployedDevicesKeyResponses(list_deployed_devices_key_response=out)
    ...
    def list_hosted_numbers_authorization_document(self, request: operations.ListHostedNumbersAuthorizationDocumentRequest) -> operations.ListHostedNumbersAuthorizationDocumentResponse:
        ...
        res = operations.ListHostedNumbersAuthorizationDocumentResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListHostedNumbersAuthorizationDocument200ApplicationJSONListHostedNumbersAuthorizationDocumentResponse])
                res.responses[r.status_code][content_type] = operations.ListHostedNumbersAuthorizationDocumentResponses(list_hosted_numbers_authorization_document_response=out)
    ...
    def list_hosted_numbers_dependent_hosted_number_order(self, request: operations.ListHostedNumbersDependentHostedNumberOrderRequest) -> operations.ListHostedNumbersDependentHostedNumberOrderResponse:
        ...
        res = operations.ListHostedNumbersDependentHostedNumberOrderResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListHostedNumbersDependentHostedNumberOrder200ApplicationJSONListHostedNumbersDependentHostedNumberOrderResponse])
                res.responses[r.status_code][content_type] = operations.ListHostedNumbersDependentHostedNumberOrderResponses(list_hosted_numbers_dependent_hosted_number_order_response=out)
    ...
    def list_hosted_numbers_hosted_number_order(self, request: operations.ListHostedNumbersHostedNumberOrderRequest) -> operations.ListHostedNumbersHostedNumberOrderResponse:
        ...
        res = operations.ListHostedNumbersHostedNumberOrderResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListHostedNumbersHostedNumberOrder200ApplicationJSONListHostedNumbersHostedNumberOrderResponse])
                res.responses[r.status_code][content_type] = operations.ListHostedNumbersHostedNumberOrderResponses(list_hosted_numbers_hosted_number_order_response=out)
    ...
    def list_marketplace_available_add_on(self, request: operations.ListMarketplaceAvailableAddOnRequest) -> operations.ListMarketplaceAvailableAddOnResponse:
        ...
        res = operations.ListMarketplaceAvailableAddOnResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListMarketplaceAvailableAddOn200ApplicationJSONListMarketplaceAvailableAddOnResponse])
                res.responses[r.status_code][content_type] = operations.ListMarketplaceAvailableAddOnResponses(list_marketplace_available_add_on_response=out)
    ...
    def list_marketplace_available_add_on_extension(self, request: operations.ListMarketplaceAvailableAddOnExtensionRequest) -> operations.ListMarketplaceAvailableAddOnExtensionResponse:
        ...
        res = operations.ListMarketplaceAvailableAddOnExtensionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListMarketplaceAvailableAddOnExtension200ApplicationJSONListMarketplaceAvailableAddOnExtensionResponse])
                res.responses[r.status_code][content_type] = operations.ListMarketplaceAvailableAddOnExtensionResponses(list_marketplace_available_add_on_extension_response=out)
    ...
    def list_marketplace_installed_add_on(self, request: operations.ListMarketplaceInstalledAddOnRequest) -> operations.ListMarketplaceInstalledAddOnResponse:
        ...
        res = operations.ListMarketplaceInstalledAddOnResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListMarketplaceInstalledAddOn200ApplicationJSONListMarketplaceInstalledAddOnResponse])
                res.responses[r.status_code][content_type] = operations.ListMarketplaceInstalledAddOnResponses(list_marketplace_installed_add_on_response=out)
    ...
    def list_marketplace_installed_add_on_extension(self, request: operations.ListMarketplaceInstalledAddOnExtensionRequest) -> operations.ListMarketplaceInstalledAddOnExtensionResponse:
        ...
        res = operations.ListMarketplaceInstalledAddOnExtensionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListMarketplaceInstalledAddOnExtension200ApplicationJSONListMarketplaceInstalledAddOnExtensionResponse])
                res.responses[r.status_code][content_type] = operations.ListMarketplaceInstalledAddOnExtensionResponses(list_marketplace_installed_add_on_extension_response=out)
    ...
    def list_sync_document(self, request: operations.ListSyncDocumentRequest) -> operations.ListSyncDocumentResponse:
        ...
        res = operations.ListSyncDocumentResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListSyncDocument200ApplicationJSONListSyncDocumentResponse])
                res.responses[r.status_code][content_type] = operations.ListSyncDocumentResponses(list_sync_document_response=out)
    ...
    def list_sync_document_permission(self, request: operations.ListSyncDocumentPermissionRequest) -> operations.ListSyncDocumentPermissionResponse:
        ...
        res = operations.ListSyncDocumentPermissionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListSyncDocumentPermission200ApplicationJSONListSyncDocumentPermissionResponse])
                res.responses[r.status_code][content_type] = operations.ListSyncDocumentPermissionResponses(list_sync_document_permission_response=out)
    ...
    def list_sync_service(self, request: operations.ListSyncServiceRequest) -> operations.ListSyncServiceResponse:
        ...
        res = operations.ListSyncServiceResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListSyncService200ApplicationJSONListSyncServiceResponse])
                res.responses[r.status_code][content_type] = operations.ListSyncServiceResponses(list_sync_service_response=out)
    ...
    def list_sync_sync_list(self, request: operations.ListSyncSyncListRequest) -> operations.ListSyncSyncListResponse:
        ...
        res = operations.ListSyncSyncListResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListSyncSyncList200ApplicationJSONListSyncSyncListResponse])
                res.responses[r.status_code][content_type] = operations.ListSyncSyncListResponses(list_sync_sync_list_response=out)
    ...
    def list_sync_sync_list_item(self, request: operations.ListSyncSyncListItemRequest) -> operations.ListSyncSyncListItemResponse:
        ...
        res = operations.ListSyncSyncListItemResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListSyncSyncListItem200ApplicationJSONListSyncSyncListItemResponse])
                res.responses[r.status_code][content_type] = operations.ListSyncSyncListItemResponses(list_sync_sync_list_item_response=out)
    ...
    def list_sync_sync_list_permission(self, request: operations.ListSyncSyncListPermissionRequest) -> operations.ListSyncSyncListPermissionResponse:
        ...
        res = operations.ListSyncSyncListPermissionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListSyncSyncListPermission200ApplicationJSONListSyncSyncListPermissionResponse])
                res.responses[r.status_code][content_type] = operations.ListSyncSyncListPermissionResponses(list_sync_sync_list_permission_response=out)
    ...
    def list_sync_sync_map(self, request: operations.ListSyncSyncMapRequest) -> operations.ListSyncSyncMapResponse:
        ...
        res = operations.ListSyncSyncMapResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListSyncSyncMap200ApplicationJSONListSyncSyncMapResponse])
                res.responses[r.status_code][content_type] = operations.ListSyncSyncMapResponses(list_sync_sync_map_response=out)
    ...
    def list_sync_sync_map_item(self, request: operations.ListSyncSyncMapItemRequest) -> operations.ListSyncSyncMapItemResponse:
        ...
        res = operations.ListSyncSyncMapItemResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListSyncSyncMapItem200ApplicationJSONListSyncSyncMapItemResponse])
                res.responses[r.status_code][content_type] = operations.ListSyncSyncMapItemResponses(list_sync_sync_map_item_response=out)
    ...
    def list_sync_sync_map_permission(self, request: operations.ListSyncSyncMapPermissionRequest) -> operations.ListSyncSyncMapPermissionResponse:
        ...
        res = operations.ListSyncSyncMapPermissionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListSyncSyncMapPermission200ApplicationJSONListSyncSyncMapPermissionResponse])
                res.responses[r.status_code][content_type] = operations.ListSyncSyncMapPermissionResponses(list_sync_sync_map_permission_response=out)
    ...
    def list_understand_assistant(self, request: operations.ListUnderstandAssistantRequest) -> operations.ListUnderstandAssistantResponse:
        ...
        res = operations.ListUnderstandAssistantResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListUnderstandAssistant200ApplicationJSONListUnderstandAssistantResponse])
                res.responses[r.status_code][content_type] = operations.ListUnderstandAssistantResponses(list_understand_assistant_response=out)
    ...
    def list_understand_field(self, request: operations.ListUnderstandFieldRequest) -> operations.ListUnderstandFieldResponse:
        ...
        res = operations.ListUnderstandFieldResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListUnderstandField200ApplicationJSONListUnderstandFieldResponse])
                res.responses[r.status_code][content_type] = operations.ListUnderstandFieldResponses(list_understand_field_response=out)
    ...
    def list_understand_field_type(self, request: operations.ListUnderstandFieldTypeRequest) -> operations.ListUnderstandFieldTypeResponse:
        ...
        res = operations.ListUnderstandFieldTypeResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListUnderstandFieldType200ApplicationJSONListUnderstandFieldTypeResponse])
                res.responses[r.status_code][content_type] = operations.ListUnderstandFieldTypeResponses(list_understand_field_type_response=out)
    ...
    def list_understand_field_value(self, request: operations.ListUnderstandFieldValueRequest) -> operations.ListUnderstandFieldValueResponse:
        ...
        res = operations.ListUnderstandFieldValueResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListUnderstandFieldValue200ApplicationJSONListUnderstandFieldValueResponse])
                res.responses[r.status_code][content_type] = operations.ListUnderstandFieldValueResponses(list_understand_field_value_response=out)
    ...
    def list_understand_model_build(self, request: operations.ListUnderstandModelBuildRequest) -> operations.ListUnderstandModelBuildResponse:
        ...
        res = operations.ListUnderstandModelBuildResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListUnderstandModelBuild200ApplicationJSONListUnderstandModelBuildResponse])
                res.responses[r.status_code][content_type] = operations.ListUnderstandModelBuildResponses(list_understand_model_build_response=out)
    ...
    def list_understand_query(self, request: operations.ListUnderstandQueryRequest) -> operations.ListUnderstandQueryResponse:
        ...
        res = operations.ListUnderstandQueryResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListUnderstandQuery200ApplicationJSONListUnderstandQueryResponse])
                res.responses[r.status_code][content_type] = operations.ListUnderstandQueryResponses(list_understand_query_response=out)
    ...
    def list_understand_sample(self, request: operations.ListUnderstandSampleRequest) -> operations.ListUnderstandSampleResponse:
        ...
        res = operations.ListUnderstandSampleResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListUnderstandSample200ApplicationJSONListUnderstandSampleResponse])
                res.responses[r.status_code][content_type] = operations.ListUnderstandSampleResponses(list_understand_sample_response=out)
    ...
    def list_understand_task(self, request: operations.ListUnderstandTaskRequest) -> operations.ListUnderstandTaskResponse:
        ...
        res = operations.ListUnderstandTaskResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListUnderstandTask200ApplicationJSONListUnderstandTaskResponse])
                res.responses[r.status_code][content_type] = operations.ListUnderstandTaskResponses(list_understand_task_response=out)
    ...
    def list_wireless_command(self, request: operations.ListWirelessCommandRequest) -> operations.ListWirelessCommandResponse:
        ...
        res = operations.ListWirelessCommandResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListWirelessCommand200ApplicationJSONListWirelessCommandResponse])
                res.responses[r.status_code][content_type] = operations.ListWirelessCommandResponses(list_wireless_command_response=out)
    ...
    def list_wireless_rate_plan(self, request: operations.ListWirelessRatePlanRequest) -> operations.ListWirelessRatePlanResponse:
        ...
        res = operations.ListWirelessRatePlanResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListWirelessRatePlan200ApplicationJSONListWirelessRatePlanResponse])
                res.responses[r.status_code][content_type] = operations.ListWirelessRatePlanResponses(list_wireless_rate_plan_response=out)
    ...
    def list_wireless_sim(self, request: operations.ListWirelessSimRequest) -> operations.ListWirelessSimResponse:
        ...
        res = operations.ListWirelessSimResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListWirelessSim200ApplicationJSONListWirelessSimResponse])
                res.responses[r.status_code][content_type] = operations.ListWirelessSimResponses(list_wireless_sim_response=out)
    ...
    def update_deployed_devices_certificate(self, request: operations.UpdateDeployedDevicesCertificateRequest) -> operations.UpdateDeployedDevicesCertificateResponse:
        ...
        res = operations.UpdateDeployedDevicesCertificateResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewDeployedDevicesFleetCertificate])
                res.responses[r.status_code][content_type] = operations.UpdateDeployedDevicesCertificateResponses(preview_deployed_devices_fleet_certificate=out)
    ...
    def update_deployed_devices_deployment(self, request: operations.UpdateDeployedDevicesDeploymentRequest) -> operations.UpdateDeployedDevicesDeploymentResponse:
        ...
        res = operations.UpdateDeployedDevicesDeploymentResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewDeployedDevicesFleetDeployment])
                res.responses[r.status_code][content_type] = operations.UpdateDeployedDevicesDeploymentResponses(preview_deployed_devices_fleet_deployment=out)
    ...
    def update_deployed_devices_device(self, request: operations.UpdateDeployedDevicesDeviceRequest) -> operations.UpdateDeployedDevicesDeviceResponse:
        ...
        res = operations.UpdateDeployedDevicesDeviceResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewDeployedDevicesFleetDevice])
                res.responses[r.status_code][content_type] = operations.UpdateDeployedDevicesDeviceResponses(preview_deployed_devices_fleet_device=out)
    ...
    def update_deployed_devices_fleet(self, request: operations.UpdateDeployedDevicesFleetRequest) -> operations.UpdateDeployedDevicesFleetResponse:
        ...
        res = operations.UpdateDeployedDevicesFleetResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewDeployedDevicesFleet])
                res.responses[r.status_code][content_type] = operations.UpdateDeployedDevicesFleetResponses(preview_deployed_devices_fleet=out)
    ...
    def update_deployed_devices_key(self, request: operations.UpdateDeployedDevicesKeyRequest) -> operations.UpdateDeployedDevicesKeyResponse:
        ...
        res = operations.UpdateDeployedDevicesKeyResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewDeployedDevicesFleetKey])
                res.responses[r.status_code][content_type] = operations.UpdateDeployedDevicesKeyResponses(preview_deployed_devices_fleet_key=out)
    ...
    def update_hosted_numbers_authorization_document(self, request: operations.UpdateHostedNumbersAuthorizationDocumentRequest) -> operations.UpdateHostedNumbersAuthorizationDocumentResponse:
        ...
        res = operations.UpdateHostedNumbersAuthorizationDocumentResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewHostedNumbersAuthorizationDocument])
                res.responses[r.status_code][content_type] = operations.UpdateHostedNumbersAuthorizationDocumentResponses(preview_hosted_numbers_authorization_document=out)
    ...
    def update_hosted_numbers_hosted_number_order(self, request: operations.UpdateHostedNumbersHostedNumberOrderRequest) -> operations.UpdateHostedNumbersHostedNumberOrderResponse:
        ...
        res = operations.UpdateHostedNumbersHostedNumberOrderResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewHostedNumbersHostedNumberOrder])
                res.responses[r.status_code][content_type] = operations.UpdateHostedNumbersHostedNumberOrderResponses(preview_hosted_numbers_hosted_number_order=out)
    ...
    def update_marketplace_installed_add_on(self, request: operations.UpdateMarketplaceInstalledAddOnRequest) -> operations.UpdateMarketplaceInstalledAddOnResponse:
        ...
        res = operations.UpdateMarketplaceInstalledAddOnResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewMarketplaceInstalledAddOn])
                res.responses[r.status_code][content_type] = operations.UpdateMarketplaceInstalledAddOnResponses(preview_marketplace_installed_add_on=out)
    ...
    def update_marketplace_installed_add_on_extension(self, request: operations.UpdateMarketplaceInstalledAddOnExtensionRequest) -> operations.UpdateMarketplaceInstalledAddOnExtensionResponse:
        ...
        res = operations.UpdateMarketplaceInstalledAddOnExtensionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewMarketplaceInstalledAddOnInstalledAddOnExtension])
                res.responses[r.status_code][content_type] = operations.UpdateMarketplaceInstalledAddOnExtensionResponses(preview_marketplace_installed_add_on_installed_add_on_extension=out)
    ...
    def update_sync_document(self, request: operations.UpdateSyncDocumentRequest) -> operations.UpdateSyncDocumentResponse:
        ...
        res = operations.UpdateSyncDocumentResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewSyncServiceDocument])
                res.responses[r.status_code][content_type] = operations.UpdateSyncDocumentResponses(preview_sync_service_document=out)
    ...
    def update_sync_document_permission(self, request: operations.UpdateSyncDocumentPermissionRequest) -> operations.UpdateSyncDocumentPermissionResponse:
        ...
        res = operations.UpdateSyncDocumentPermissionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewSyncServiceDocumentDocumentPermission])
                res.responses[r.status_code][content_type] = operations.UpdateSyncDocumentPermissionResponses(preview_sync_service_document_document_permission=out)
    ...
    def update_sync_service(self, request: operations.UpdateSyncServiceRequest) -> operations.UpdateSyncServiceResponse:
        ...
        res = operations.UpdateSyncServiceResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewSyncService])
                res.responses[r.status_code][content_type] = operations.UpdateSyncServiceResponses(preview_sync_service=out)
    ...
    def update_sync_sync_list_item(self, request: operations.UpdateSyncSyncListItemRequest) -> operations.UpdateSyncSyncListItemResponse:
        ...
        res = operations.UpdateSyncSyncListItemResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewSyncServiceSyncListSyncListItem])
                res.responses[r.status_code][content_type] = operations.UpdateSyncSyncListItemResponses(preview_sync_service_sync_list_sync_list_item=out)
    ...
    def update_sync_sync_list_permission(self, request: operations.UpdateSyncSyncListPermissionRequest) -> operations.UpdateSyncSyncListPermissionResponse:
        ...
        res = operations.UpdateSyncSyncListPermissionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewSyncServiceSyncListSyncListPermission])
                res.responses[r.status_code][content_type] = operations.UpdateSyncSyncListPermissionResponses(preview_sync_service_sync_list_sync_list_permission=out)
    ...
    def update_sync_sync_map_item(self, request: operations.UpdateSyncSyncMapItemRequest) -> operations.UpdateSyncSyncMapItemResponse:
        ...
        res = operations.UpdateSyncSyncMapItemResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewSyncServiceSyncMapSyncMapItem])
                res.responses[r.status_code][content_type] = operations.UpdateSyncSyncMapItemResponses(preview_sync_service_sync_map_sync_map_item=out)
    ...
    def update_sync_sync_map_permission(self, request: operations.UpdateSyncSyncMapPermissionRequest) -> operations.UpdateSyncSyncMapPermissionResponse:
        ...
        res = operations.UpdateSyncSyncMapPermissionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewSyncServiceSyncMapSyncMapPermission])
                res.responses[r.status_code][content_type] = operations.UpdateSyncSyncMapPermissionResponses(preview_sync_service_sync_map_sync_map_permission=out)
    ...
    def update_understand_assistant(self, request: operations.UpdateUnderstandAssistantRequest) -> operations.UpdateUnderstandAssistantResponse:
        ...
        res = operations.UpdateUnderstandAssistantResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistant])
                res.responses[r.status_code][content_type] = operations.UpdateUnderstandAssistantResponses(preview_understand_assistant=out)
    ...
    def update_understand_assistant_fallback_actions(self, request: operations.UpdateUnderstandAssistantFallbackActionsRequest) -> operations.UpdateUnderstandAssistantFallbackActionsResponse:
        ...
        res = operations.UpdateUnderstandAssistantFallbackActionsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantAssistantFallbackActions])
                res.responses[r.status_code][content_type] = operations.UpdateUnderstandAssistantFallbackActionsResponses(preview_understand_assistant_assistant_fallback_actions=out)
    ...
    def update_understand_assistant_initiation_actions(self, request: operations.UpdateUnderstandAssistantInitiationActionsRequest) -> operations.UpdateUnderstandAssistantInitiationActionsResponse:
        ...
        res = operations.UpdateUnderstandAssistantInitiationActionsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantAssistantInitiationActions])
                res.responses[r.status_code][content_type] = operations.UpdateUnderstandAssistantInitiationActionsResponses(preview_understand_assistant_assistant_initiation_actions=out)
    ...
    def update_understand_field_type(self, request: operations.UpdateUnderstandFieldTypeRequest) -> operations.UpdateUnderstandFieldTypeResponse:
        ...
        res = operations.UpdateUnderstandFieldTypeResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantFieldType])
                res.responses[r.status_code][content_type] = operations.UpdateUnderstandFieldTypeResponses(preview_understand_assistant_field_type=out)
    ...
    def update_understand_model_build(self, request: operations.UpdateUnderstandModelBuildRequest) -> operations.UpdateUnderstandModelBuildResponse:
        ...
        res = operations.UpdateUnderstandModelBuildResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantModelBuild])
                res.responses[r.status_code][content_type] = operations.UpdateUnderstandModelBuildResponses(preview_understand_assistant_model_build=out)
    ...
    def update_understand_query(self, request: operations.UpdateUnderstandQueryRequest) -> operations.UpdateUnderstandQueryResponse:
        ...
        res = operations.UpdateUnderstandQueryResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantQuery])
                res.responses[r.status_code][content_type] = operations.UpdateUnderstandQueryResponses(preview_understand_assistant_query=out)
    ...
    def update_understand_sample(self, request: operations.UpdateUnderstandSampleRequest) -> operations.UpdateUnderstandSampleResponse:
        ...
        res = operations.UpdateUnderstandSampleResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantTaskSample])
                res.responses[r.status_code][content_type] = operations.UpdateUnderstandSampleResponses(preview_understand_assistant_task_sample=out)
    ...
    def update_understand_style_sheet(self, request: operations.UpdateUnderstandStyleSheetRequest) -> operations.UpdateUnderstandStyleSheetResponse:
        ...
        res = operations.UpdateUnderstandStyleSheetResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantStyleSheet])
                res.responses[r.status_code][content_type] = operations.UpdateUnderstandStyleSheetResponses(preview_understand_assistant_style_sheet=out)
    ...
    def update_understand_task(self, request: operations.UpdateUnderstandTaskRequest) -> operations.UpdateUnderstandTaskResponse:
        ...
        res = operations.UpdateUnderstandTaskResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantTask])
                res.responses[r.status_code][content_type] = operations.UpdateUnderstandTaskResponses(preview_understand_assistant_task=out)
    ...
    def update_understand_task_actions(self, request: operations.UpdateUnderstandTaskActionsRequest) -> operations.UpdateUnderstandTaskActionsResponse:
        ...
        res = operations.UpdateUnderstandTaskActionsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewUnderstandAssistantTaskTaskActions])
                res.responses[r.status_code][content_type] = operations.UpdateUnderstandTaskActionsResponses(preview_understand_assistant_task_task_actions=out)
    ...
    def update_wireless_rate_plan(self, request: operations.UpdateWirelessRatePlanRequest) -> operations.UpdateWirelessRatePlanResponse:
        ...
        res = operations.UpdateWirelessRatePlanResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewWirelessRatePlan])
                res.responses[r.status_code][content_type] = operations.UpdateWirelessRatePlanResponses(preview_wireless_rate_plan=out)
    ...
    def update_wireless_sim(self, request: operations.UpdateWirelessSimRequest) -> operations.UpdateWirelessSimResponse:
        ...
        res = operations.UpdateWirelessSimResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PreviewWirelessSim])
                res.responses[r.status_code][content_type] = operations.UpdateWirelessSimResponses(preview_wireless_sim=out)
