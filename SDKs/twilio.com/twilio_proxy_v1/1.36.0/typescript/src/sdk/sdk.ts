...
export class SDK {
  ...
  CreateMessageInteraction(
    ...
    let baseURL: string = operations.CREATEMESSAGEINTERACTION_SERVERS[0];
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        let res: operations.CreateMessageInteractionResponse = {statusCode: httpRes.status, contentType: contentType};
  ...
  CreateSession(
    ...
    let baseURL: string = operations.CREATESESSION_SERVERS[0];
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.CreateSessionResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 201:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  DeleteInteraction(
    ...
    let baseURL: string = operations.DELETEINTERACTION_SERVERS[0];
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.DeleteInteractionResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 204:
            break;
        }
  ...
  DeleteSession(
    ...
    let baseURL: string = operations.DELETESESSION_SERVERS[0];
  ...
  FetchMessageInteraction(
    ...
    let baseURL: string = operations.FETCHMESSAGEINTERACTION_SERVERS[0];
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.FetchMessageInteractionResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.proxyV1ServiceSessionParticipantMessageInteraction = httpRes?.data;
  ...
  FetchSession(
    ...
    let baseURL: string = operations.FETCHSESSION_SERVERS[0];
    const url: string = utils.GenerateURL(baseURL, "/v1/Services/{ServiceSid}/Sessions/{Sid}", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.FetchSessionResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.proxyV1ServiceSession = httpRes?.data;
  ...
  ListInteraction(
    ...
    let baseURL: string = operations.LISTINTERACTION_SERVERS[0];
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ListInteractionResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  ListMessageInteraction(
    ...
    let baseURL: string = operations.LISTMESSAGEINTERACTION_SERVERS[0];
    const url: string = utils.GenerateURL(baseURL, "/v1/Services/{ServiceSid}/Sessions/{SessionSid}/Participants/{ParticipantSid}/MessageInteractions", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ListMessageInteractionResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  ListSession(
    ...
    let baseURL: string = operations.LISTSESSION_SERVERS[0];
    const url: string = utils.GenerateURL(baseURL, "/v1/Services/{ServiceSid}/Sessions", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ListSessionResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  UpdateSession(
    ...
    let baseURL: string = operations.UPDATESESSION_SERVERS[0];
    const url: string = utils.GenerateURL(baseURL, "/v1/Services/{ServiceSid}/Sessions/{Sid}", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.UpdateSessionResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.proxyV1ServiceSession = httpRes?.data;
