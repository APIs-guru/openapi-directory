...
from . import message_interaction_enum_resource_status_enum
from . import message_interaction_enum_resource_status_enum
from . import message_interaction_enum_type_enum
...
class ProxyV1ServiceSessionParticipantMessageInteraction:
    ...
    inbound_resource_status: Optional[message_interaction_enum_resource_status_enum.MessageInteractionEnumResourceStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'inbound_resource_status' }})
    ...
    outbound_resource_status: Optional[message_interaction_enum_resource_status_enum.MessageInteractionEnumResourceStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'outbound_resource_status' }})
    ...
    type: Optional[message_interaction_enum_type_enum.MessageInteractionEnumTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'type' }})
