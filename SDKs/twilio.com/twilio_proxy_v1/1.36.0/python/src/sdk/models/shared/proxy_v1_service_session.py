...
from . import session_enum_mode_enum
from . import session_enum_status_enum
...
class ProxyV1ServiceSession:
    ...
    mode: Optional[session_enum_mode_enum.SessionEnumModeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'mode' }})
    service_sid: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'service_sid' }})
    sid: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'sid' }})
    status: Optional[session_enum_status_enum.SessionEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
