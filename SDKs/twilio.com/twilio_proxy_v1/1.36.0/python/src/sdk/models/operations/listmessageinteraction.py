...
class ListMessageInteractionRequest:
    ...
    path_params: ListMessageInteractionPathParams = field(default=None)
    query_params: ListMessageInteractionQueryParams = field(default=None)
    security: ListMessageInteractionSecurity = field(default=None)
