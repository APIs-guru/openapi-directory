...
class ProxyV1ServiceSessionInteraction:
    ...
    inbound_resource_status: Optional[InteractionEnumResourceStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('inbound_resource_status') }})
    ...
    outbound_resource_status: Optional[InteractionEnumResourceStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('outbound_resource_status') }})
    ...
    type: Optional[InteractionEnumTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
