...
class ListPhoneNumber200ApplicationJSONListPhoneNumberResponse:
    ...
    phone_numbers: Optional[List[shared.ProxyV1ServicePhoneNumber]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'phone_numbers' }})
    

@dataclass
class ListPhoneNumberResponses:
...
class ListPhoneNumberResponse:
    ...
    responses: dict[int, dict[str, ListPhoneNumberResponses]] = field(default=None)
