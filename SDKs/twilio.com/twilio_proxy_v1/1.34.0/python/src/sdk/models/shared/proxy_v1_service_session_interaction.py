...
class ProxyV1ServiceSessionInteraction:
    ...
    inbound_resource_status: Optional[shared.InteractionEnumResourceStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'inbound_resource_status' }})
    ...
    outbound_resource_status: Optional[shared.InteractionEnumResourceStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'outbound_resource_status' }})
    ...
    type: Optional[shared.InteractionEnumTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'type' }})
