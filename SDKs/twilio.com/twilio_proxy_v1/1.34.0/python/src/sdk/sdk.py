...
class SDK:
    ...
    def create_message_interaction(self, request: operations.CreateMessageInteractionRequest) -> operations.CreateMessageInteractionResponse:
        ...
        res = operations.CreateMessageInteractionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ProxyV1ServiceSessionParticipantMessageInteraction])
                res.responses[r.status_code][content_type] = operations.CreateMessageInteractionResponses(proxy_v1_service_session_participant_message_interaction=out)
    ...
    def create_participant(self, request: operations.CreateParticipantRequest) -> operations.CreateParticipantResponse:
        ...
        res = operations.CreateParticipantResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ProxyV1ServiceSessionParticipant])
                res.responses[r.status_code][content_type] = operations.CreateParticipantResponses(proxy_v1_service_session_participant=out)
    ...
    def create_phone_number(self, request: operations.CreatePhoneNumberRequest) -> operations.CreatePhoneNumberResponse:
        ...
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.CreatePhoneNumberResponses(proxy_v1_service_phone_number=out)
    ...
    def create_service(self, request: operations.CreateServiceRequest) -> operations.CreateServiceResponse:
        ...
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.CreateServiceResponses(proxy_v1_service=out)
    ...
    def create_session(self, request: operations.CreateSessionRequest) -> operations.CreateSessionResponse:
        ...
        res = operations.CreateSessionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ProxyV1ServiceSession])
                res.responses[r.status_code][content_type] = operations.CreateSessionResponses(proxy_v1_service_session=out)
    ...
    def create_short_code(self, request: operations.CreateShortCodeRequest) -> operations.CreateShortCodeResponse:
        ...
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.CreateShortCodeResponses(proxy_v1_service_short_code=out)
    ...
    def fetch_interaction(self, request: operations.FetchInteractionRequest) -> operations.FetchInteractionResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.FetchInteractionResponses(proxy_v1_service_session_interaction=out)
    ...
    def fetch_message_interaction(self, request: operations.FetchMessageInteractionRequest) -> operations.FetchMessageInteractionResponse:
        ...
        res = operations.FetchMessageInteractionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ProxyV1ServiceSessionParticipantMessageInteraction])
                res.responses[r.status_code][content_type] = operations.FetchMessageInteractionResponses(proxy_v1_service_session_participant_message_interaction=out)
    ...
    def fetch_participant(self, request: operations.FetchParticipantRequest) -> operations.FetchParticipantResponse:
        ...
        res = operations.FetchParticipantResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ProxyV1ServiceSessionParticipant])
                res.responses[r.status_code][content_type] = operations.FetchParticipantResponses(proxy_v1_service_session_participant=out)
    ...
    def fetch_phone_number(self, request: operations.FetchPhoneNumberRequest) -> operations.FetchPhoneNumberResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ProxyV1ServicePhoneNumber])
                res.responses[r.status_code][content_type] = operations.FetchPhoneNumberResponses(proxy_v1_service_phone_number=out)
    ...
    def fetch_service(self, request: operations.FetchServiceRequest) -> operations.FetchServiceResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ProxyV1Service])
                res.responses[r.status_code][content_type] = operations.FetchServiceResponses(proxy_v1_service=out)
    ...
    def fetch_session(self, request: operations.FetchSessionRequest) -> operations.FetchSessionResponse:
        ...
        res = operations.FetchSessionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ProxyV1ServiceSession])
                res.responses[r.status_code][content_type] = operations.FetchSessionResponses(proxy_v1_service_session=out)
    ...
    def fetch_short_code(self, request: operations.FetchShortCodeRequest) -> operations.FetchShortCodeResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ProxyV1ServiceShortCode])
                res.responses[r.status_code][content_type] = operations.FetchShortCodeResponses(proxy_v1_service_short_code=out)
    ...
    def list_interaction(self, request: operations.ListInteractionRequest) -> operations.ListInteractionResponse:
        ...
        res = operations.ListInteractionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListInteraction200ApplicationJSONListInteractionResponse])
                res.responses[r.status_code][content_type] = operations.ListInteractionResponses(list_interaction_response=out)
    ...
    def list_message_interaction(self, request: operations.ListMessageInteractionRequest) -> operations.ListMessageInteractionResponse:
        ...
        res = operations.ListMessageInteractionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListMessageInteraction200ApplicationJSONListMessageInteractionResponse])
                res.responses[r.status_code][content_type] = operations.ListMessageInteractionResponses(list_message_interaction_response=out)
    ...
    def list_participant(self, request: operations.ListParticipantRequest) -> operations.ListParticipantResponse:
        ...
        res = operations.ListParticipantResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListParticipant200ApplicationJSONListParticipantResponse])
                res.responses[r.status_code][content_type] = operations.ListParticipantResponses(list_participant_response=out)
    ...
    def list_session(self, request: operations.ListSessionRequest) -> operations.ListSessionResponse:
        ...
        res = operations.ListSessionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListSession200ApplicationJSONListSessionResponse])
                res.responses[r.status_code][content_type] = operations.ListSessionResponses(list_session_response=out)
    ...
    def update_phone_number(self, request: operations.UpdatePhoneNumberRequest) -> operations.UpdatePhoneNumberResponse:
        ...
        res = operations.UpdatePhoneNumberResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ProxyV1ServicePhoneNumber])
                res.responses[r.status_code][content_type] = operations.UpdatePhoneNumberResponses(proxy_v1_service_phone_number=out)
    ...
    def update_service(self, request: operations.UpdateServiceRequest) -> operations.UpdateServiceResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ProxyV1Service])
                res.responses[r.status_code][content_type] = operations.UpdateServiceResponses(proxy_v1_service=out)
    ...
    def update_session(self, request: operations.UpdateSessionRequest) -> operations.UpdateSessionResponse:
        ...
        res = operations.UpdateSessionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ProxyV1ServiceSession])
                res.responses[r.status_code][content_type] = operations.UpdateSessionResponses(proxy_v1_service_session=out)
    ...
    def update_short_code(self, request: operations.UpdateShortCodeRequest) -> operations.UpdateShortCodeResponse:
        ...
        res = operations.UpdateShortCodeResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ProxyV1ServiceShortCode])
                res.responses[r.status_code][content_type] = operations.UpdateShortCodeResponses(proxy_v1_service_short_code=out)
