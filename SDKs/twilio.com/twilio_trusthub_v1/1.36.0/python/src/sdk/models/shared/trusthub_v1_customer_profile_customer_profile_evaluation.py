...
from . import customer_profile_evaluation_enum_status_enum
...
class TrusthubV1CustomerProfileCustomerProfileEvaluation:
    ...
    status: Optional[customer_profile_evaluation_enum_status_enum.CustomerProfileEvaluationEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
