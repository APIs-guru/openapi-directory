...
from . import trust_product_enum_status_enum
...
class TrusthubV1TrustProduct:
    ...
    status: Optional[trust_product_enum_status_enum.TrustProductEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
