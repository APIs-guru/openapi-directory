...
@dataclass_json
@dataclass
class ListSupportingDocumentType200ApplicationJSONMeta:
...
@dataclass_json
@dataclass
class ListSupportingDocumentType200ApplicationJSONListSupportingDocumentTypeResponse:
    meta: Optional[ListSupportingDocumentType200ApplicationJSONMeta] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'meta' }})
...
class ListSupportingDocumentTypeResponse:
    ...
    list_supporting_document_type_response: Optional[ListSupportingDocumentType200ApplicationJSONListSupportingDocumentTypeResponse] = field(default=None)
