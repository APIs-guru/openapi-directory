...
export const LISTTRUSTPRODUCTENTITYASSIGNMENT_SERVERS = [
...
export class ListTrustProductEntityAssignmentListTrustProductEntityAssignmentResponse extends SpeakeasyBase {
  ...
  @Metadata({ data: "json, name=results", elemType: shared.TrusthubV1TrustProductTrustProductEntityAssignment })
