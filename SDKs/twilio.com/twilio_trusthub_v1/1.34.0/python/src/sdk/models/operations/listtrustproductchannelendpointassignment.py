...
@dataclass
class ListTrustProductChannelEndpointAssignmentResponses:
...
class ListTrustProductChannelEndpointAssignmentResponse:
    ...
    responses: dict[int, dict[str, ListTrustProductChannelEndpointAssignmentResponses]] = field(default=None)
