...
@dataclass
class FetchCustomerProfileChannelEndpointAssignmentResponses:
...
class FetchCustomerProfileChannelEndpointAssignmentResponse:
    ...
    responses: dict[int, dict[str, FetchCustomerProfileChannelEndpointAssignmentResponses]] = field(default=None)
