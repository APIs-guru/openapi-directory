...
class FetchCustomerProfileEvaluationRequest:
    ...
    path_params: FetchCustomerProfileEvaluationPathParams = field(default=None)
    security: FetchCustomerProfileEvaluationSecurity = field(default=None)
    

@dataclass
class FetchCustomerProfileEvaluationResponses:
...
class FetchCustomerProfileEvaluationResponse:
    ...
    responses: dict[int, dict[str, FetchCustomerProfileEvaluationResponses]] = field(default=None)
