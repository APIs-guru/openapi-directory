...
@dataclass
class CreateCustomerProfileChannelEndpointAssignmentResponses:
...
class CreateCustomerProfileChannelEndpointAssignmentResponse:
    ...
    responses: dict[int, dict[str, CreateCustomerProfileChannelEndpointAssignmentResponses]] = field(default=None)
