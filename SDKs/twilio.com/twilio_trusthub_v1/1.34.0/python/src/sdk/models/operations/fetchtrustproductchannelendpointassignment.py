...
@dataclass
class FetchTrustProductChannelEndpointAssignmentResponses:
...
class FetchTrustProductChannelEndpointAssignmentResponse:
    ...
    responses: dict[int, dict[str, FetchTrustProductChannelEndpointAssignmentResponses]] = field(default=None)
