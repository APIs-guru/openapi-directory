...
class ListCustomerProfileEvaluationListCustomerProfileEvaluationResponse:
    meta: Optional[ListCustomerProfileEvaluationListCustomerProfileEvaluationResponseMeta] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    results: Optional[List[shared.TrusthubV1CustomerProfileCustomerProfileEvaluation]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
    

@dataclass
class ListCustomerProfileEvaluationRequest:
    path_params: ListCustomerProfileEvaluationPathParams = field()
    query_params: ListCustomerProfileEvaluationQueryParams = field()
    security: ListCustomerProfileEvaluationSecurity = field()
