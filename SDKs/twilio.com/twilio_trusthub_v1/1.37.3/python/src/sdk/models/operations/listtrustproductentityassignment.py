...
class ListTrustProductEntityAssignmentListTrustProductEntityAssignmentResponse:
    meta: Optional[ListTrustProductEntityAssignmentListTrustProductEntityAssignmentResponseMeta] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    results: Optional[List[shared.TrusthubV1TrustProductTrustProductEntityAssignment]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
    

@dataclass
class ListTrustProductEntityAssignmentRequest:
    path_params: ListTrustProductEntityAssignmentPathParams = field()
    query_params: ListTrustProductEntityAssignmentQueryParams = field()
    security: ListTrustProductEntityAssignmentSecurity = field()
