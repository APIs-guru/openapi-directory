...
class ListSupportingDocumentTypeListSupportingDocumentTypeResponse:
    ...
    supporting_document_types: Optional[List[shared.TrusthubV1SupportingDocumentType]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('supporting_document_types') }})
