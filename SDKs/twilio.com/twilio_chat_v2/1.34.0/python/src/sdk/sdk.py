...
class SDK:
    ...
    def create_channel(self, request: operations.CreateChannelRequest) -> operations.CreateChannelResponse:
        ...
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.CreateChannelResponses(chat_v2_service_channel=out)
    ...
    def create_channel_webhook(self, request: operations.CreateChannelWebhookRequest) -> operations.CreateChannelWebhookResponse:
        ...
        res = operations.CreateChannelWebhookResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ChatV2ServiceChannelChannelWebhook])
                res.responses[r.status_code][content_type] = operations.CreateChannelWebhookResponses(chat_v2_service_channel_channel_webhook=out)
    ...
    def create_credential(self, request: operations.CreateCredentialRequest) -> operations.CreateCredentialResponse:
        ...
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.CreateCredentialResponses(chat_v2_credential=out)
    ...
    def create_invite(self, request: operations.CreateInviteRequest) -> operations.CreateInviteResponse:
        ...
        res = operations.CreateInviteResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ChatV2ServiceChannelInvite])
                res.responses[r.status_code][content_type] = operations.CreateInviteResponses(chat_v2_service_channel_invite=out)
    ...
    def create_member(self, request: operations.CreateMemberRequest) -> operations.CreateMemberResponse:
        ...
        res = operations.CreateMemberResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ChatV2ServiceChannelMember])
                res.responses[r.status_code][content_type] = operations.CreateMemberResponses(chat_v2_service_channel_member=out)
    ...
    def create_message(self, request: operations.CreateMessageRequest) -> operations.CreateMessageResponse:
        ...
        res = operations.CreateMessageResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ChatV2ServiceChannelMessage])
                res.responses[r.status_code][content_type] = operations.CreateMessageResponses(chat_v2_service_channel_message=out)
    ...
    def create_role(self, request: operations.CreateRoleRequest) -> operations.CreateRoleResponse:
        ...
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.CreateRoleResponses(chat_v2_service_role=out)
    ...
    def create_service(self, request: operations.CreateServiceRequest) -> operations.CreateServiceResponse:
        ...
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.CreateServiceResponses(chat_v2_service=out)
    ...
    def create_user(self, request: operations.CreateUserRequest) -> operations.CreateUserResponse:
        ...
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.CreateUserResponses(chat_v2_service_user=out)
    ...
    def fetch_binding(self, request: operations.FetchBindingRequest) -> operations.FetchBindingResponse:
        ...
        res = operations.FetchBindingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ChatV2ServiceBinding])
                res.responses[r.status_code][content_type] = operations.FetchBindingResponses(chat_v2_service_binding=out)
    ...
    def fetch_channel(self, request: operations.FetchChannelRequest) -> operations.FetchChannelResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ChatV2ServiceChannel])
                res.responses[r.status_code][content_type] = operations.FetchChannelResponses(chat_v2_service_channel=out)
    ...
    def fetch_channel_webhook(self, request: operations.FetchChannelWebhookRequest) -> operations.FetchChannelWebhookResponse:
        ...
        res = operations.FetchChannelWebhookResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ChatV2ServiceChannelChannelWebhook])
                res.responses[r.status_code][content_type] = operations.FetchChannelWebhookResponses(chat_v2_service_channel_channel_webhook=out)
    ...
    def fetch_credential(self, request: operations.FetchCredentialRequest) -> operations.FetchCredentialResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ChatV2Credential])
                res.responses[r.status_code][content_type] = operations.FetchCredentialResponses(chat_v2_credential=out)
    ...
    def fetch_invite(self, request: operations.FetchInviteRequest) -> operations.FetchInviteResponse:
        ...
        res = operations.FetchInviteResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ChatV2ServiceChannelInvite])
                res.responses[r.status_code][content_type] = operations.FetchInviteResponses(chat_v2_service_channel_invite=out)
    ...
    def fetch_member(self, request: operations.FetchMemberRequest) -> operations.FetchMemberResponse:
        ...
        res = operations.FetchMemberResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ChatV2ServiceChannelMember])
                res.responses[r.status_code][content_type] = operations.FetchMemberResponses(chat_v2_service_channel_member=out)
    ...
    def fetch_message(self, request: operations.FetchMessageRequest) -> operations.FetchMessageResponse:
        ...
        res = operations.FetchMessageResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ChatV2ServiceChannelMessage])
                res.responses[r.status_code][content_type] = operations.FetchMessageResponses(chat_v2_service_channel_message=out)
    ...
    def fetch_role(self, request: operations.FetchRoleRequest) -> operations.FetchRoleResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ChatV2ServiceRole])
                res.responses[r.status_code][content_type] = operations.FetchRoleResponses(chat_v2_service_role=out)
    ...
    def fetch_service(self, request: operations.FetchServiceRequest) -> operations.FetchServiceResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ChatV2Service])
                res.responses[r.status_code][content_type] = operations.FetchServiceResponses(chat_v2_service=out)
    ...
    def fetch_user(self, request: operations.FetchUserRequest) -> operations.FetchUserResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ChatV2ServiceUser])
                res.responses[r.status_code][content_type] = operations.FetchUserResponses(chat_v2_service_user=out)
    ...
    def fetch_user_binding(self, request: operations.FetchUserBindingRequest) -> operations.FetchUserBindingResponse:
        ...
        res = operations.FetchUserBindingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ChatV2ServiceUserUserBinding])
                res.responses[r.status_code][content_type] = operations.FetchUserBindingResponses(chat_v2_service_user_user_binding=out)
    ...
    def fetch_user_channel(self, request: operations.FetchUserChannelRequest) -> operations.FetchUserChannelResponse:
        ...
        res = operations.FetchUserChannelResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ChatV2ServiceUserUserChannel])
                res.responses[r.status_code][content_type] = operations.FetchUserChannelResponses(chat_v2_service_user_user_channel=out)
    ...
    def list_binding(self, request: operations.ListBindingRequest) -> operations.ListBindingResponse:
        ...
        res = operations.ListBindingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListBinding200ApplicationJSONListBindingResponse])
                res.responses[r.status_code][content_type] = operations.ListBindingResponses(list_binding_response=out)
    ...
    def list_channel_webhook(self, request: operations.ListChannelWebhookRequest) -> operations.ListChannelWebhookResponse:
        ...
        res = operations.ListChannelWebhookResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListChannelWebhook200ApplicationJSONListChannelWebhookResponse])
                res.responses[r.status_code][content_type] = operations.ListChannelWebhookResponses(list_channel_webhook_response=out)
    ...
    def list_invite(self, request: operations.ListInviteRequest) -> operations.ListInviteResponse:
        ...
        res = operations.ListInviteResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListInvite200ApplicationJSONListInviteResponse])
                res.responses[r.status_code][content_type] = operations.ListInviteResponses(list_invite_response=out)
    ...
    def list_member(self, request: operations.ListMemberRequest) -> operations.ListMemberResponse:
        ...
        res = operations.ListMemberResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListMember200ApplicationJSONListMemberResponse])
                res.responses[r.status_code][content_type] = operations.ListMemberResponses(list_member_response=out)
    ...
    def list_message(self, request: operations.ListMessageRequest) -> operations.ListMessageResponse:
        ...
        res = operations.ListMessageResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListMessage200ApplicationJSONListMessageResponse])
                res.responses[r.status_code][content_type] = operations.ListMessageResponses(list_message_response=out)
    ...
    def list_user_binding(self, request: operations.ListUserBindingRequest) -> operations.ListUserBindingResponse:
        ...
        res = operations.ListUserBindingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListUserBinding200ApplicationJSONListUserBindingResponse])
                res.responses[r.status_code][content_type] = operations.ListUserBindingResponses(list_user_binding_response=out)
    ...
    def list_user_channel(self, request: operations.ListUserChannelRequest) -> operations.ListUserChannelResponse:
        ...
        res = operations.ListUserChannelResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListUserChannel200ApplicationJSONListUserChannelResponse])
                res.responses[r.status_code][content_type] = operations.ListUserChannelResponses(list_user_channel_response=out)
    ...
    def update_channel(self, request: operations.UpdateChannelRequest) -> operations.UpdateChannelResponse:
        ...
        res = operations.UpdateChannelResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ChatV2ServiceChannel])
                res.responses[r.status_code][content_type] = operations.UpdateChannelResponses(chat_v2_service_channel=out)
    ...
    def update_channel_webhook(self, request: operations.UpdateChannelWebhookRequest) -> operations.UpdateChannelWebhookResponse:
        ...
        res = operations.UpdateChannelWebhookResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ChatV2ServiceChannelChannelWebhook])
                res.responses[r.status_code][content_type] = operations.UpdateChannelWebhookResponses(chat_v2_service_channel_channel_webhook=out)
    ...
    def update_credential(self, request: operations.UpdateCredentialRequest) -> operations.UpdateCredentialResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ChatV2Credential])
                res.responses[r.status_code][content_type] = operations.UpdateCredentialResponses(chat_v2_credential=out)
    ...
    def update_member(self, request: operations.UpdateMemberRequest) -> operations.UpdateMemberResponse:
        ...
        res = operations.UpdateMemberResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ChatV2ServiceChannelMember])
                res.responses[r.status_code][content_type] = operations.UpdateMemberResponses(chat_v2_service_channel_member=out)
    ...
    def update_message(self, request: operations.UpdateMessageRequest) -> operations.UpdateMessageResponse:
        ...
        res = operations.UpdateMessageResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ChatV2ServiceChannelMessage])
                res.responses[r.status_code][content_type] = operations.UpdateMessageResponses(chat_v2_service_channel_message=out)
    ...
    def update_role(self, request: operations.UpdateRoleRequest) -> operations.UpdateRoleResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ChatV2ServiceRole])
                res.responses[r.status_code][content_type] = operations.UpdateRoleResponses(chat_v2_service_role=out)
    ...
    def update_service(self, request: operations.UpdateServiceRequest) -> operations.UpdateServiceResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ChatV2Service])
                res.responses[r.status_code][content_type] = operations.UpdateServiceResponses(chat_v2_service=out)
    ...
    def update_user(self, request: operations.UpdateUserRequest) -> operations.UpdateUserResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ChatV2ServiceUser])
                res.responses[r.status_code][content_type] = operations.UpdateUserResponses(chat_v2_service_user=out)
    ...
    def update_user_channel(self, request: operations.UpdateUserChannelRequest) -> operations.UpdateUserChannelResponse:
        ...
        res = operations.UpdateUserChannelResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ChatV2ServiceUserUserChannel])
                res.responses[r.status_code][content_type] = operations.UpdateUserChannelResponses(chat_v2_service_user_user_channel=out)
