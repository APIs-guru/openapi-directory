...
class ListChannelWebhook200ApplicationJSONListChannelWebhookResponse:
    ...
    webhooks: Optional[List[shared.ChatV2ServiceChannelChannelWebhook]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'webhooks' }})
    

@dataclass
class ListChannelWebhookResponses:
...
class ListChannelWebhookResponse:
    ...
    responses: dict[int, dict[str, ListChannelWebhookResponses]] = field(default=None)
