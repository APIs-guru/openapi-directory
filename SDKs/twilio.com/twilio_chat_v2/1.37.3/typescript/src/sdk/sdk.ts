        ...
        switch (true) {
          case httpRes?.status == 201:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.chatV2ServiceChannel = httpRes?.data;
            }
            break;
        }
    ...
    return client
      .request({
        ...
        switch (true) {
          case httpRes?.status == 201:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.chatV2ServiceChannelChannelWebhook = httpRes?.data;
            }
            break;
        }
    ...
    return client
      .request({
        ...
        switch (true) {
          case httpRes?.status == 201:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.chatV2Credential = httpRes?.data;
            }
            break;
        }
    ...
    return client
      .request({
        ...
        switch (true) {
          case httpRes?.status == 201:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.chatV2ServiceChannelInvite = httpRes?.data;
            }
            break;
        }
    ...
    return client
      .request({
        ...
        switch (true) {
          case httpRes?.status == 201:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.chatV2ServiceChannelMember = httpRes?.data;
            }
            break;
        }
    ...
    return client
      .request({
        ...
        switch (true) {
          case httpRes?.status == 201:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.chatV2ServiceChannelMessage = httpRes?.data;
            }
            break;
        }
    ...
    return client
      .request({
        ...
        switch (true) {
          case httpRes?.status == 201:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.chatV2ServiceRole = httpRes?.data;
            }
            break;
        }
    ...
    return client
      .request({
        ...
        switch (true) {
          case httpRes?.status == 201:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.chatV2Service = httpRes?.data;
            }
            break;
        }
    ...
    return client
      .request({
        ...
        switch (true) {
          case httpRes?.status == 201:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.chatV2ServiceUser = httpRes?.data;
            }
            break;
        }
      ...
      .request({
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.chatV2ServiceBinding = httpRes?.data;
            }
            break;
        }
    ...
    return client
      .request({
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.chatV2ServiceUserUserBinding = httpRes?.data;
            }
            break;
        }
    ...
    return client
      .request({
        ...
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.chatV2ServiceUserUserChannel = httpRes?.data;
            }
            break;
        }
