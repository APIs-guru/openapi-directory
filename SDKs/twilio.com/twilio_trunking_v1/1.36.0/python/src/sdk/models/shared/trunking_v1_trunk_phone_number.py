...
from . import phone_number_enum_address_requirement_enum
...
class TrunkingV1TrunkPhoneNumber:
    ...
    address_requirements: Optional[phone_number_enum_address_requirement_enum.PhoneNumberEnumAddressRequirementEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'address_requirements' }})
