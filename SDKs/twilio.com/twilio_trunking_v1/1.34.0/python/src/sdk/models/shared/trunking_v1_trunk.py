...
class TrunkingV1Trunk:
    ...
    transfer_caller_id: Optional[shared.TrunkEnumTransferCallerIDEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'transfer_caller_id' }})
    transfer_mode: Optional[shared.TrunkEnumTransferSettingEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'transfer_mode' }})
