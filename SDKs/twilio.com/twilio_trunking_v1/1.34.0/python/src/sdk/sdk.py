...
class SDK:
    ...
    def create_credential_list(self, request: operations.CreateCredentialListRequest) -> operations.CreateCredentialListResponse:
        ...
        res = operations.CreateCredentialListResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TrunkingV1TrunkCredentialList])
                res.responses[r.status_code][content_type] = operations.CreateCredentialListResponses(trunking_v1_trunk_credential_list=out)
    ...
    def create_ip_access_control_list(self, request: operations.CreateIPAccessControlListRequest) -> operations.CreateIPAccessControlListResponse:
        ...
        res = operations.CreateIPAccessControlListResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TrunkingV1TrunkIPAccessControlList])
                res.responses[r.status_code][content_type] = operations.CreateIPAccessControlListResponses(trunking_v1_trunk_ip_access_control_list=out)
    ...
    def create_origination_url(self, request: operations.CreateOriginationURLRequest) -> operations.CreateOriginationURLResponse:
        ...
        res = operations.CreateOriginationURLResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TrunkingV1TrunkOriginationURL])
                res.responses[r.status_code][content_type] = operations.CreateOriginationURLResponses(trunking_v1_trunk_origination_url=out)
    ...
    def create_phone_number(self, request: operations.CreatePhoneNumberRequest) -> operations.CreatePhoneNumberResponse:
        ...
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.CreatePhoneNumberResponses(trunking_v1_trunk_phone_number=out)
    ...
    def create_trunk(self, request: operations.CreateTrunkRequest) -> operations.CreateTrunkResponse:
        ...
        res = operations.CreateTrunkResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TrunkingV1Trunk])
                res.responses[r.status_code][content_type] = operations.CreateTrunkResponses(trunking_v1_trunk=out)
    ...
    def fetch_credential_list(self, request: operations.FetchCredentialListRequest) -> operations.FetchCredentialListResponse:
        ...
        res = operations.FetchCredentialListResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TrunkingV1TrunkCredentialList])
                res.responses[r.status_code][content_type] = operations.FetchCredentialListResponses(trunking_v1_trunk_credential_list=out)
    ...
    def fetch_ip_access_control_list(self, request: operations.FetchIPAccessControlListRequest) -> operations.FetchIPAccessControlListResponse:
        ...
        res = operations.FetchIPAccessControlListResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TrunkingV1TrunkIPAccessControlList])
                res.responses[r.status_code][content_type] = operations.FetchIPAccessControlListResponses(trunking_v1_trunk_ip_access_control_list=out)
    ...
    def fetch_origination_url(self, request: operations.FetchOriginationURLRequest) -> operations.FetchOriginationURLResponse:
        ...
        res = operations.FetchOriginationURLResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TrunkingV1TrunkOriginationURL])
                res.responses[r.status_code][content_type] = operations.FetchOriginationURLResponses(trunking_v1_trunk_origination_url=out)
    ...
    def fetch_phone_number(self, request: operations.FetchPhoneNumberRequest) -> operations.FetchPhoneNumberResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TrunkingV1TrunkPhoneNumber])
                res.responses[r.status_code][content_type] = operations.FetchPhoneNumberResponses(trunking_v1_trunk_phone_number=out)
    ...
    def fetch_recording(self, request: operations.FetchRecordingRequest) -> operations.FetchRecordingResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.FetchRecordingResponses(trunking_v1_trunk_recording=out)
    ...
    def fetch_trunk(self, request: operations.FetchTrunkRequest) -> operations.FetchTrunkResponse:
        ...
        res = operations.FetchTrunkResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TrunkingV1Trunk])
                res.responses[r.status_code][content_type] = operations.FetchTrunkResponses(trunking_v1_trunk=out)
    ...
    def list_credential_list(self, request: operations.ListCredentialListRequest) -> operations.ListCredentialListResponse:
        ...
        res = operations.ListCredentialListResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListCredentialList200ApplicationJSONListCredentialListResponse])
                res.responses[r.status_code][content_type] = operations.ListCredentialListResponses(list_credential_list_response=out)
    ...
    def list_ip_access_control_list(self, request: operations.ListIPAccessControlListRequest) -> operations.ListIPAccessControlListResponse:
        ...
        res = operations.ListIPAccessControlListResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListIPAccessControlListResponses(list_ip_access_control_list_response=out)
    ...
    def list_origination_url(self, request: operations.ListOriginationURLRequest) -> operations.ListOriginationURLResponse:
        ...
        res = operations.ListOriginationURLResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListOriginationURL200ApplicationJSONListOriginationURLResponse])
                res.responses[r.status_code][content_type] = operations.ListOriginationURLResponses(list_origination_url_response=out)
    ...
    def list_trunk(self, request: operations.ListTrunkRequest) -> operations.ListTrunkResponse:
        ...
        res = operations.ListTrunkResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListTrunk200ApplicationJSONListTrunkResponse])
                res.responses[r.status_code][content_type] = operations.ListTrunkResponses(list_trunk_response=out)
    ...
    def update_origination_url(self, request: operations.UpdateOriginationURLRequest) -> operations.UpdateOriginationURLResponse:
        ...
        res = operations.UpdateOriginationURLResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TrunkingV1TrunkOriginationURL])
                res.responses[r.status_code][content_type] = operations.UpdateOriginationURLResponses(trunking_v1_trunk_origination_url=out)
    ...
    def update_recording(self, request: operations.UpdateRecordingRequest) -> operations.UpdateRecordingResponse:
        ...
        res = operations.UpdateRecordingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 202:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TrunkingV1TrunkRecording])
                res.responses[r.status_code][content_type] = operations.UpdateRecordingResponses(trunking_v1_trunk_recording=out)
    ...
    def update_trunk(self, request: operations.UpdateTrunkRequest) -> operations.UpdateTrunkResponse:
        ...
        res = operations.UpdateTrunkResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TrunkingV1Trunk])
                res.responses[r.status_code][content_type] = operations.UpdateTrunkResponses(trunking_v1_trunk=out)
