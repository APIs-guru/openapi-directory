...
class ListEventTypeListEventTypeResponse:
    meta: Optional[ListEventTypeListEventTypeResponseMeta] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    types: Optional[List[shared.EventsV1EventType]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('types') }})
    

@dataclass
class ListEventTypeRequest:
    query_params: ListEventTypeQueryParams = field()
    security: ListEventTypeSecurity = field()
