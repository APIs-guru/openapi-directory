...
class SDK:
    ...
    def create_sink(self, request: operations.CreateSinkRequest) -> operations.CreateSinkResponse:
        ...
        res = operations.CreateSinkResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.EventsV1Sink])
                res.responses[r.status_code][content_type] = operations.CreateSinkResponses(events_v1_sink=out)
    ...
    def create_sink_test(self, request: operations.CreateSinkTestRequest) -> operations.CreateSinkTestResponse:
        ...
        res = operations.CreateSinkTestResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.EventsV1SinkSinkTest])
                res.responses[r.status_code][content_type] = operations.CreateSinkTestResponses(events_v1_sink_sink_test=out)
    ...
    def create_sink_validate(self, request: operations.CreateSinkValidateRequest) -> operations.CreateSinkValidateResponse:
        ...
        res = operations.CreateSinkValidateResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.EventsV1SinkSinkValidate])
                res.responses[r.status_code][content_type] = operations.CreateSinkValidateResponses(events_v1_sink_sink_validate=out)
    ...
    def create_subscribed_event(self, request: operations.CreateSubscribedEventRequest) -> operations.CreateSubscribedEventResponse:
        ...
        res = operations.CreateSubscribedEventResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.EventsV1SubscriptionSubscribedEvent])
                res.responses[r.status_code][content_type] = operations.CreateSubscribedEventResponses(events_v1_subscription_subscribed_event=out)
    ...
    def create_subscription(self, request: operations.CreateSubscriptionRequest) -> operations.CreateSubscriptionResponse:
        ...
        res = operations.CreateSubscriptionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.EventsV1Subscription])
                res.responses[r.status_code][content_type] = operations.CreateSubscriptionResponses(events_v1_subscription=out)
    ...
    def fetch_event_type(self, request: operations.FetchEventTypeRequest) -> operations.FetchEventTypeResponse:
        ...
        res = operations.FetchEventTypeResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.EventsV1EventType])
                res.responses[r.status_code][content_type] = operations.FetchEventTypeResponses(events_v1_event_type=out)
    ...
    def fetch_schema(self, request: operations.FetchSchemaRequest) -> operations.FetchSchemaResponse:
        ...
        res = operations.FetchSchemaResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.EventsV1Schema])
                res.responses[r.status_code][content_type] = operations.FetchSchemaResponses(events_v1_schema=out)
    ...
    def fetch_schema_version(self, request: operations.FetchSchemaVersionRequest) -> operations.FetchSchemaVersionResponse:
        ...
        res = operations.FetchSchemaVersionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.EventsV1SchemaSchemaVersion])
                res.responses[r.status_code][content_type] = operations.FetchSchemaVersionResponses(events_v1_schema_schema_version=out)
    ...
    def fetch_sink(self, request: operations.FetchSinkRequest) -> operations.FetchSinkResponse:
        ...
        res = operations.FetchSinkResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.EventsV1Sink])
                res.responses[r.status_code][content_type] = operations.FetchSinkResponses(events_v1_sink=out)
    ...
    def fetch_subscribed_event(self, request: operations.FetchSubscribedEventRequest) -> operations.FetchSubscribedEventResponse:
        ...
        res = operations.FetchSubscribedEventResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.EventsV1SubscriptionSubscribedEvent])
                res.responses[r.status_code][content_type] = operations.FetchSubscribedEventResponses(events_v1_subscription_subscribed_event=out)
    ...
    def fetch_subscription(self, request: operations.FetchSubscriptionRequest) -> operations.FetchSubscriptionResponse:
        ...
        res = operations.FetchSubscriptionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.EventsV1Subscription])
                res.responses[r.status_code][content_type] = operations.FetchSubscriptionResponses(events_v1_subscription=out)
    ...
    def list_event_type(self, request: operations.ListEventTypeRequest) -> operations.ListEventTypeResponse:
        ...
        res = operations.ListEventTypeResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListEventType200ApplicationJSONListEventTypeResponse])
                res.responses[r.status_code][content_type] = operations.ListEventTypeResponses(list_event_type_response=out)
    ...
    def list_schema_version(self, request: operations.ListSchemaVersionRequest) -> operations.ListSchemaVersionResponse:
        ...
        res = operations.ListSchemaVersionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListSchemaVersion200ApplicationJSONListSchemaVersionResponse])
                res.responses[r.status_code][content_type] = operations.ListSchemaVersionResponses(list_schema_version_response=out)
    ...
    def list_sink(self, request: operations.ListSinkRequest) -> operations.ListSinkResponse:
        ...
        res = operations.ListSinkResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListSink200ApplicationJSONListSinkResponse])
                res.responses[r.status_code][content_type] = operations.ListSinkResponses(list_sink_response=out)
    ...
    def list_subscribed_event(self, request: operations.ListSubscribedEventRequest) -> operations.ListSubscribedEventResponse:
        ...
        res = operations.ListSubscribedEventResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListSubscribedEvent200ApplicationJSONListSubscribedEventResponse])
                res.responses[r.status_code][content_type] = operations.ListSubscribedEventResponses(list_subscribed_event_response=out)
    ...
    def list_subscription(self, request: operations.ListSubscriptionRequest) -> operations.ListSubscriptionResponse:
        ...
        res = operations.ListSubscriptionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListSubscription200ApplicationJSONListSubscriptionResponse])
                res.responses[r.status_code][content_type] = operations.ListSubscriptionResponses(list_subscription_response=out)
    ...
    def update_sink(self, request: operations.UpdateSinkRequest) -> operations.UpdateSinkResponse:
        ...
        res = operations.UpdateSinkResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.EventsV1Sink])
                res.responses[r.status_code][content_type] = operations.UpdateSinkResponses(events_v1_sink=out)
    ...
    def update_subscribed_event(self, request: operations.UpdateSubscribedEventRequest) -> operations.UpdateSubscribedEventResponse:
        ...
        res = operations.UpdateSubscribedEventResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.EventsV1SubscriptionSubscribedEvent])
                res.responses[r.status_code][content_type] = operations.UpdateSubscribedEventResponses(events_v1_subscription_subscribed_event=out)
    ...
    def update_subscription(self, request: operations.UpdateSubscriptionRequest) -> operations.UpdateSubscriptionResponse:
        ...
        res = operations.UpdateSubscriptionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.EventsV1Subscription])
                res.responses[r.status_code][content_type] = operations.UpdateSubscriptionResponses(events_v1_subscription=out)
