...
class WirelessV1Sim:
    ...
    reset_status: Optional[shared.SimEnumResetStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'reset_status' }})
    ...
    status: Optional[shared.SimEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
