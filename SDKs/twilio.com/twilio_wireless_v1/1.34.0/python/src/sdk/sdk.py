...
class SDK:
    ...
    def create_command(self, request: operations.CreateCommandRequest) -> operations.CreateCommandResponse:
        ...
        res = operations.CreateCommandResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.WirelessV1Command])
                res.responses[r.status_code][content_type] = operations.CreateCommandResponses(wireless_v1_command=out)
    ...
    def create_rate_plan(self, request: operations.CreateRatePlanRequest) -> operations.CreateRatePlanResponse:
        ...
        res = operations.CreateRatePlanResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.WirelessV1RatePlan])
                res.responses[r.status_code][content_type] = operations.CreateRatePlanResponses(wireless_v1_rate_plan=out)
    ...
    def fetch_command(self, request: operations.FetchCommandRequest) -> operations.FetchCommandResponse:
        ...
        res = operations.FetchCommandResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.WirelessV1Command])
                res.responses[r.status_code][content_type] = operations.FetchCommandResponses(wireless_v1_command=out)
    ...
    def fetch_rate_plan(self, request: operations.FetchRatePlanRequest) -> operations.FetchRatePlanResponse:
        ...
        res = operations.FetchRatePlanResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.WirelessV1RatePlan])
                res.responses[r.status_code][content_type] = operations.FetchRatePlanResponses(wireless_v1_rate_plan=out)
    ...
    def fetch_sim(self, request: operations.FetchSimRequest) -> operations.FetchSimResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.FetchSimResponses(wireless_v1_sim=out)
    ...
    def list_account_usage_record(self, request: operations.ListAccountUsageRecordRequest) -> operations.ListAccountUsageRecordResponse:
        ...
        res = operations.ListAccountUsageRecordResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListAccountUsageRecordResponses(list_account_usage_record_response=out)
    ...
    def list_command(self, request: operations.ListCommandRequest) -> operations.ListCommandResponse:
        ...
        res = operations.ListCommandResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListCommand200ApplicationJSONListCommandResponse])
                res.responses[r.status_code][content_type] = operations.ListCommandResponses(list_command_response=out)
    ...
    def list_data_session(self, request: operations.ListDataSessionRequest) -> operations.ListDataSessionResponse:
        ...
        res = operations.ListDataSessionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListDataSession200ApplicationJSONListDataSessionResponse])
                res.responses[r.status_code][content_type] = operations.ListDataSessionResponses(list_data_session_response=out)
    ...
    def list_rate_plan(self, request: operations.ListRatePlanRequest) -> operations.ListRatePlanResponse:
        ...
        res = operations.ListRatePlanResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListRatePlan200ApplicationJSONListRatePlanResponse])
                res.responses[r.status_code][content_type] = operations.ListRatePlanResponses(list_rate_plan_response=out)
    ...
    def update_rate_plan(self, request: operations.UpdateRatePlanRequest) -> operations.UpdateRatePlanResponse:
        ...
        res = operations.UpdateRatePlanResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.WirelessV1RatePlan])
                res.responses[r.status_code][content_type] = operations.UpdateRatePlanResponses(wireless_v1_rate_plan=out)
    ...
    def update_sim(self, request: operations.UpdateSimRequest) -> operations.UpdateSimResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.WirelessV1Sim])
                res.responses[r.status_code][content_type] = operations.UpdateSimResponses(wireless_v1_sim=out)
