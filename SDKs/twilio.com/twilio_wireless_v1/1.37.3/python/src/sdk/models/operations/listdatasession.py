...
class ListDataSessionListDataSessionResponse:
    data_sessions: Optional[List[shared.WirelessV1SimDataSession]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data_sessions') }})
    meta: Optional[ListDataSessionListDataSessionResponseMeta] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    

@dataclass
class ListDataSessionRequest:
    path_params: ListDataSessionPathParams = field()
    query_params: ListDataSessionQueryParams = field()
    security: ListDataSessionSecurity = field()
