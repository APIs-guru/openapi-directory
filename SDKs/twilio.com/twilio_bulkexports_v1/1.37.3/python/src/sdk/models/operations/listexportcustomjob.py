...
class ListExportCustomJobListExportCustomJobResponse:
    jobs: Optional[List[shared.BulkexportsV1ExportExportCustomJob]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('jobs') }})
    meta: Optional[ListExportCustomJobListExportCustomJobResponseMeta] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    

@dataclass
class ListExportCustomJobRequest:
    path_params: ListExportCustomJobPathParams = field()
    query_params: ListExportCustomJobQueryParams = field()
    security: ListExportCustomJobSecurity = field()
