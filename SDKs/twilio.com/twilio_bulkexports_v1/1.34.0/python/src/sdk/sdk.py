...
class SDK:
    ...
    def create_export_custom_job(self, request: operations.CreateExportCustomJobRequest) -> operations.CreateExportCustomJobResponse:
        ...
        res = operations.CreateExportCustomJobResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.BulkexportsV1ExportExportCustomJob])
                res.responses[r.status_code][content_type] = operations.CreateExportCustomJobResponses(bulkexports_v1_export_export_custom_job=out)
    ...
    def fetch_day(self, request: operations.FetchDayRequest) -> operations.FetchDayResponse:
        ...
        res = operations.FetchDayResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 307:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.BulkexportsV1ExportDayInstance])
                res.responses[r.status_code][content_type] = operations.FetchDayResponses(bulkexports_v1_export_day_instance=out)
    ...
    def fetch_export(self, request: operations.FetchExportRequest) -> operations.FetchExportResponse:
        ...
        res = operations.FetchExportResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.BulkexportsV1Export])
                res.responses[r.status_code][content_type] = operations.FetchExportResponses(bulkexports_v1_export=out)
    ...
    def fetch_export_configuration(self, request: operations.FetchExportConfigurationRequest) -> operations.FetchExportConfigurationResponse:
        ...
        res = operations.FetchExportConfigurationResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.BulkexportsV1ExportConfiguration])
                res.responses[r.status_code][content_type] = operations.FetchExportConfigurationResponses(bulkexports_v1_export_configuration=out)
    ...
    def fetch_job(self, request: operations.FetchJobRequest) -> operations.FetchJobResponse:
        ...
        res = operations.FetchJobResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.BulkexportsV1ExportJob])
                res.responses[r.status_code][content_type] = operations.FetchJobResponses(bulkexports_v1_export_job=out)
    ...
    def list_day(self, request: operations.ListDayRequest) -> operations.ListDayResponse:
        ...
        res = operations.ListDayResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListDay200ApplicationJSONListDayResponse])
                res.responses[r.status_code][content_type] = operations.ListDayResponses(list_day_response=out)
    ...
    def list_export_custom_job(self, request: operations.ListExportCustomJobRequest) -> operations.ListExportCustomJobResponse:
        ...
        res = operations.ListExportCustomJobResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListExportCustomJob200ApplicationJSONListExportCustomJobResponse])
                res.responses[r.status_code][content_type] = operations.ListExportCustomJobResponses(list_export_custom_job_response=out)
    ...
    def update_export_configuration(self, request: operations.UpdateExportConfigurationRequest) -> operations.UpdateExportConfigurationResponse:
        ...
        res = operations.UpdateExportConfigurationResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.BulkexportsV1ExportConfiguration])
                res.responses[r.status_code][content_type] = operations.UpdateExportConfigurationResponses(bulkexports_v1_export_configuration=out)
