...
class FetchDayPathParams:
    day: str = field(default=None, metadata={'path_param': { 'field_name': 'Day', 'style': 'simple', 'explode': False }})
...
class FetchDayRequest:
    ...
    path_params: FetchDayPathParams = field(default=None)
    security: FetchDaySecurity = field(default=None)
    

@dataclass
class FetchDayResponses:
...
class FetchDayResponse:
    ...
    responses: dict[int, dict[str, FetchDayResponses]] = field(default=None)
