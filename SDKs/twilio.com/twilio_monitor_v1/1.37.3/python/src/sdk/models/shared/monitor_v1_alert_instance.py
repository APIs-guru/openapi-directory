...
class MonitorV1AlertInstance:
    ...
    request_method: Optional[MonitorV1AlertInstanceRequestMethodEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('request_method') }})
