...
@dataclass
class CreateDialingPermissionsCountryBulkUpdateResponses:
...
class CreateDialingPermissionsCountryBulkUpdateResponse:
    ...
    responses: dict[int, dict[str, CreateDialingPermissionsCountryBulkUpdateResponses]] = field(default=None)
