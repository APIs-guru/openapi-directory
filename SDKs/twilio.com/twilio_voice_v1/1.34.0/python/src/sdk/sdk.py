...
class SDK:
    ...
    def create_byoc_trunk(self, request: operations.CreateByocTrunkRequest) -> operations.CreateByocTrunkResponse:
        ...
        res = operations.CreateByocTrunkResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.VoiceV1ByocTrunk])
                res.responses[r.status_code][content_type] = operations.CreateByocTrunkResponses(voice_v1_byoc_trunk=out)
    ...
    def create_connection_policy(self, request: operations.CreateConnectionPolicyRequest) -> operations.CreateConnectionPolicyResponse:
        ...
        res = operations.CreateConnectionPolicyResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.VoiceV1ConnectionPolicy])
                res.responses[r.status_code][content_type] = operations.CreateConnectionPolicyResponses(voice_v1_connection_policy=out)
    ...
    def create_connection_policy_target(self, request: operations.CreateConnectionPolicyTargetRequest) -> operations.CreateConnectionPolicyTargetResponse:
        ...
        res = operations.CreateConnectionPolicyTargetResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.VoiceV1ConnectionPolicyConnectionPolicyTarget])
                res.responses[r.status_code][content_type] = operations.CreateConnectionPolicyTargetResponses(voice_v1_connection_policy_connection_policy_target=out)
    ...
    def create_dialing_permissions_country_bulk_update(self, request: operations.CreateDialingPermissionsCountryBulkUpdateRequest) -> operations.CreateDialingPermissionsCountryBulkUpdateResponse:
        ...
        res = operations.CreateDialingPermissionsCountryBulkUpdateResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.VoiceV1DialingPermissionsDialingPermissionsCountryBulkUpdate])
                res.responses[r.status_code][content_type] = operations.CreateDialingPermissionsCountryBulkUpdateResponses(voice_v1_dialing_permissions_dialing_permissions_country_bulk_update=out)
    ...
    def create_ip_record(self, request: operations.CreateIPRecordRequest) -> operations.CreateIPRecordResponse:
        ...
        res = operations.CreateIPRecordResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.VoiceV1IPRecord])
                res.responses[r.status_code][content_type] = operations.CreateIPRecordResponses(voice_v1_ip_record=out)
    ...
    def create_source_ip_mapping(self, request: operations.CreateSourceIPMappingRequest) -> operations.CreateSourceIPMappingResponse:
        ...
        res = operations.CreateSourceIPMappingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.VoiceV1SourceIPMapping])
                res.responses[r.status_code][content_type] = operations.CreateSourceIPMappingResponses(voice_v1_source_ip_mapping=out)
    ...
    def fetch_byoc_trunk(self, request: operations.FetchByocTrunkRequest) -> operations.FetchByocTrunkResponse:
        ...
        res = operations.FetchByocTrunkResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.VoiceV1ByocTrunk])
                res.responses[r.status_code][content_type] = operations.FetchByocTrunkResponses(voice_v1_byoc_trunk=out)
    ...
    def fetch_connection_policy(self, request: operations.FetchConnectionPolicyRequest) -> operations.FetchConnectionPolicyResponse:
        ...
        res = operations.FetchConnectionPolicyResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.VoiceV1ConnectionPolicy])
                res.responses[r.status_code][content_type] = operations.FetchConnectionPolicyResponses(voice_v1_connection_policy=out)
    ...
    def fetch_connection_policy_target(self, request: operations.FetchConnectionPolicyTargetRequest) -> operations.FetchConnectionPolicyTargetResponse:
        ...
        res = operations.FetchConnectionPolicyTargetResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.VoiceV1ConnectionPolicyConnectionPolicyTarget])
                res.responses[r.status_code][content_type] = operations.FetchConnectionPolicyTargetResponses(voice_v1_connection_policy_connection_policy_target=out)
    ...
    def fetch_dialing_permissions_country(self, request: operations.FetchDialingPermissionsCountryRequest) -> operations.FetchDialingPermissionsCountryResponse:
        ...
        res = operations.FetchDialingPermissionsCountryResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.VoiceV1DialingPermissionsDialingPermissionsCountryInstance])
                res.responses[r.status_code][content_type] = operations.FetchDialingPermissionsCountryResponses(voice_v1_dialing_permissions_dialing_permissions_country_instance=out)
    ...
    def fetch_dialing_permissions_settings(self, request: operations.FetchDialingPermissionsSettingsRequest) -> operations.FetchDialingPermissionsSettingsResponse:
        ...
        res = operations.FetchDialingPermissionsSettingsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.VoiceV1DialingPermissionsDialingPermissionsSettings])
                res.responses[r.status_code][content_type] = operations.FetchDialingPermissionsSettingsResponses(voice_v1_dialing_permissions_dialing_permissions_settings=out)
    ...
    def fetch_ip_record(self, request: operations.FetchIPRecordRequest) -> operations.FetchIPRecordResponse:
        ...
        res = operations.FetchIPRecordResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.VoiceV1IPRecord])
                res.responses[r.status_code][content_type] = operations.FetchIPRecordResponses(voice_v1_ip_record=out)
    ...
    def fetch_source_ip_mapping(self, request: operations.FetchSourceIPMappingRequest) -> operations.FetchSourceIPMappingResponse:
        ...
        res = operations.FetchSourceIPMappingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.VoiceV1SourceIPMapping])
                res.responses[r.status_code][content_type] = operations.FetchSourceIPMappingResponses(voice_v1_source_ip_mapping=out)
    ...
    def list_byoc_trunk(self, request: operations.ListByocTrunkRequest) -> operations.ListByocTrunkResponse:
        ...
        res = operations.ListByocTrunkResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListByocTrunk200ApplicationJSONListByocTrunkResponse])
                res.responses[r.status_code][content_type] = operations.ListByocTrunkResponses(list_byoc_trunk_response=out)
    ...
    def list_connection_policy(self, request: operations.ListConnectionPolicyRequest) -> operations.ListConnectionPolicyResponse:
        ...
        res = operations.ListConnectionPolicyResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListConnectionPolicy200ApplicationJSONListConnectionPolicyResponse])
                res.responses[r.status_code][content_type] = operations.ListConnectionPolicyResponses(list_connection_policy_response=out)
    ...
    def list_connection_policy_target(self, request: operations.ListConnectionPolicyTargetRequest) -> operations.ListConnectionPolicyTargetResponse:
        ...
        res = operations.ListConnectionPolicyTargetResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListConnectionPolicyTargetResponses(list_connection_policy_target_response=out)
    ...
    def list_dialing_permissions_country(self, request: operations.ListDialingPermissionsCountryRequest) -> operations.ListDialingPermissionsCountryResponse:
        ...
        res = operations.ListDialingPermissionsCountryResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListDialingPermissionsCountryResponses(list_dialing_permissions_country_response=out)
    ...
    def list_dialing_permissions_hrs_prefixes(self, request: operations.ListDialingPermissionsHrsPrefixesRequest) -> operations.ListDialingPermissionsHrsPrefixesResponse:
        ...
        res = operations.ListDialingPermissionsHrsPrefixesResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListDialingPermissionsHrsPrefixesResponses(list_dialing_permissions_hrs_prefixes_response=out)
    ...
    def list_ip_record(self, request: operations.ListIPRecordRequest) -> operations.ListIPRecordResponse:
        ...
        res = operations.ListIPRecordResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListIPRecord200ApplicationJSONListIPRecordResponse])
                res.responses[r.status_code][content_type] = operations.ListIPRecordResponses(list_ip_record_response=out)
    ...
    def list_source_ip_mapping(self, request: operations.ListSourceIPMappingRequest) -> operations.ListSourceIPMappingResponse:
        ...
        res = operations.ListSourceIPMappingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListSourceIPMapping200ApplicationJSONListSourceIPMappingResponse])
                res.responses[r.status_code][content_type] = operations.ListSourceIPMappingResponses(list_source_ip_mapping_response=out)
    ...
    def update_byoc_trunk(self, request: operations.UpdateByocTrunkRequest) -> operations.UpdateByocTrunkResponse:
        ...
        res = operations.UpdateByocTrunkResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.VoiceV1ByocTrunk])
                res.responses[r.status_code][content_type] = operations.UpdateByocTrunkResponses(voice_v1_byoc_trunk=out)
    ...
    def update_connection_policy(self, request: operations.UpdateConnectionPolicyRequest) -> operations.UpdateConnectionPolicyResponse:
        ...
        res = operations.UpdateConnectionPolicyResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.VoiceV1ConnectionPolicy])
                res.responses[r.status_code][content_type] = operations.UpdateConnectionPolicyResponses(voice_v1_connection_policy=out)
    ...
    def update_connection_policy_target(self, request: operations.UpdateConnectionPolicyTargetRequest) -> operations.UpdateConnectionPolicyTargetResponse:
        ...
        res = operations.UpdateConnectionPolicyTargetResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.VoiceV1ConnectionPolicyConnectionPolicyTarget])
                res.responses[r.status_code][content_type] = operations.UpdateConnectionPolicyTargetResponses(voice_v1_connection_policy_connection_policy_target=out)
    ...
    def update_dialing_permissions_settings(self, request: operations.UpdateDialingPermissionsSettingsRequest) -> operations.UpdateDialingPermissionsSettingsResponse:
        ...
        res = operations.UpdateDialingPermissionsSettingsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 202:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.VoiceV1DialingPermissionsDialingPermissionsSettings])
                res.responses[r.status_code][content_type] = operations.UpdateDialingPermissionsSettingsResponses(voice_v1_dialing_permissions_dialing_permissions_settings=out)
    ...
    def update_ip_record(self, request: operations.UpdateIPRecordRequest) -> operations.UpdateIPRecordResponse:
        ...
        res = operations.UpdateIPRecordResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.VoiceV1IPRecord])
                res.responses[r.status_code][content_type] = operations.UpdateIPRecordResponses(voice_v1_ip_record=out)
    ...
    def update_source_ip_mapping(self, request: operations.UpdateSourceIPMappingRequest) -> operations.UpdateSourceIPMappingResponse:
        ...
        res = operations.UpdateSourceIPMappingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.VoiceV1SourceIPMapping])
                res.responses[r.status_code][content_type] = operations.UpdateSourceIPMappingResponses(voice_v1_source_ip_mapping=out)
