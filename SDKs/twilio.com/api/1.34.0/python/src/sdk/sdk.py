...
class SDK:
    ...
    def create_account(self, request: operations.CreateAccountRequest) -> operations.CreateAccountResponse:
        ...
        res = operations.CreateAccountResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010Account])
                res.responses[r.status_code][content_type] = operations.CreateAccountResponses(api_v2010_account=out)
    ...
    def create_address(self, request: operations.CreateAddressRequest) -> operations.CreateAddressResponse:
        ...
        res = operations.CreateAddressResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountAddress])
                res.responses[r.status_code][content_type] = operations.CreateAddressResponses(api_v2010_account_address=out)
    ...
    def create_application(self, request: operations.CreateApplicationRequest) -> operations.CreateApplicationResponse:
        ...
        res = operations.CreateApplicationResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountApplication])
                res.responses[r.status_code][content_type] = operations.CreateApplicationResponses(api_v2010_account_application=out)
    ...
    def create_call(self, request: operations.CreateCallRequest) -> operations.CreateCallResponse:
        ...
        res = operations.CreateCallResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountCall])
                res.responses[r.status_code][content_type] = operations.CreateCallResponses(api_v2010_account_call=out)
    ...
    def create_call_feedback_summary(self, request: operations.CreateCallFeedbackSummaryRequest) -> operations.CreateCallFeedbackSummaryResponse:
        ...
        res = operations.CreateCallFeedbackSummaryResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountCallCallFeedbackSummary])
                res.responses[r.status_code][content_type] = operations.CreateCallFeedbackSummaryResponses(api_v2010_account_call_call_feedback_summary=out)
    ...
    def create_call_recording(self, request: operations.CreateCallRecordingRequest) -> operations.CreateCallRecordingResponse:
        ...
        res = operations.CreateCallRecordingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountCallCallRecording])
                res.responses[r.status_code][content_type] = operations.CreateCallRecordingResponses(api_v2010_account_call_call_recording=out)
    ...
    def create_incoming_phone_number(self, request: operations.CreateIncomingPhoneNumberRequest) -> operations.CreateIncomingPhoneNumberResponse:
        ...
        res = operations.CreateIncomingPhoneNumberResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountIncomingPhoneNumber])
                res.responses[r.status_code][content_type] = operations.CreateIncomingPhoneNumberResponses(api_v2010_account_incoming_phone_number=out)
    ...
    def create_incoming_phone_number_assigned_add_on(self, request: operations.CreateIncomingPhoneNumberAssignedAddOnRequest) -> operations.CreateIncomingPhoneNumberAssignedAddOnResponse:
        ...
        res = operations.CreateIncomingPhoneNumberAssignedAddOnResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberAssignedAddOn])
                res.responses[r.status_code][content_type] = operations.CreateIncomingPhoneNumberAssignedAddOnResponses(api_v2010_account_incoming_phone_number_incoming_phone_number_assigned_add_on=out)
    ...
    def create_incoming_phone_number_local(self, request: operations.CreateIncomingPhoneNumberLocalRequest) -> operations.CreateIncomingPhoneNumberLocalResponse:
        ...
        res = operations.CreateIncomingPhoneNumberLocalResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal])
                res.responses[r.status_code][content_type] = operations.CreateIncomingPhoneNumberLocalResponses(api_v2010_account_incoming_phone_number_incoming_phone_number_local=out)
    ...
    def create_incoming_phone_number_mobile(self, request: operations.CreateIncomingPhoneNumberMobileRequest) -> operations.CreateIncomingPhoneNumberMobileResponse:
        ...
        res = operations.CreateIncomingPhoneNumberMobileResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile])
                res.responses[r.status_code][content_type] = operations.CreateIncomingPhoneNumberMobileResponses(api_v2010_account_incoming_phone_number_incoming_phone_number_mobile=out)
    ...
    def create_incoming_phone_number_toll_free(self, request: operations.CreateIncomingPhoneNumberTollFreeRequest) -> operations.CreateIncomingPhoneNumberTollFreeResponse:
        ...
        res = operations.CreateIncomingPhoneNumberTollFreeResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree])
                res.responses[r.status_code][content_type] = operations.CreateIncomingPhoneNumberTollFreeResponses(api_v2010_account_incoming_phone_number_incoming_phone_number_toll_free=out)
    ...
    def create_message(self, request: operations.CreateMessageRequest) -> operations.CreateMessageResponse:
        ...
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.CreateMessageResponses(api_v2010_account_message=out)
    ...
    def create_message_feedback(self, request: operations.CreateMessageFeedbackRequest) -> operations.CreateMessageFeedbackResponse:
        ...
        res = operations.CreateMessageFeedbackResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountMessageMessageFeedback])
                res.responses[r.status_code][content_type] = operations.CreateMessageFeedbackResponses(api_v2010_account_message_message_feedback=out)
    ...
    def create_new_key(self, request: operations.CreateNewKeyRequest) -> operations.CreateNewKeyResponse:
        ...
        res = operations.CreateNewKeyResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountNewKey])
                res.responses[r.status_code][content_type] = operations.CreateNewKeyResponses(api_v2010_account_new_key=out)
    ...
    def create_new_signing_key(self, request: operations.CreateNewSigningKeyRequest) -> operations.CreateNewSigningKeyResponse:
        ...
        res = operations.CreateNewSigningKeyResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountNewSigningKey])
                res.responses[r.status_code][content_type] = operations.CreateNewSigningKeyResponses(api_v2010_account_new_signing_key=out)
    ...
    def create_participant(self, request: operations.CreateParticipantRequest) -> operations.CreateParticipantResponse:
        ...
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.CreateParticipantResponses(api_v2010_account_conference_participant=out)
    ...
    def create_payments(self, request: operations.CreatePaymentsRequest) -> operations.CreatePaymentsResponse:
        ...
        res = operations.CreatePaymentsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountCallPayments])
                res.responses[r.status_code][content_type] = operations.CreatePaymentsResponses(api_v2010_account_call_payments=out)
    ...
    def create_queue(self, request: operations.CreateQueueRequest) -> operations.CreateQueueResponse:
        ...
        res = operations.CreateQueueResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountQueue])
                res.responses[r.status_code][content_type] = operations.CreateQueueResponses(api_v2010_account_queue=out)
    ...
    def create_sip_auth_calls_credential_list_mapping(self, request: operations.CreateSipAuthCallsCredentialListMappingRequest) -> operations.CreateSipAuthCallsCredentialListMappingResponse:
        ...
        res = operations.CreateSipAuthCallsCredentialListMappingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.CreateSipAuthCallsCredentialListMappingResponses(api_v2010_account_sip_sip_domain_sip_auth_sip_auth_calls_sip_auth_calls_credential_list_mapping=out)
    ...
    def create_sip_auth_calls_ip_access_control_list_mapping(self, request: operations.CreateSipAuthCallsIPAccessControlListMappingRequest) -> operations.CreateSipAuthCallsIPAccessControlListMappingResponse:
        ...
        res = operations.CreateSipAuthCallsIPAccessControlListMappingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.CreateSipAuthCallsIPAccessControlListMappingResponses(api_v2010_account_sip_sip_domain_sip_auth_sip_auth_calls_sip_auth_calls_ip_access_control_list_mapping=out)
    ...
    def create_sip_auth_registrations_credential_list_mapping(self, request: operations.CreateSipAuthRegistrationsCredentialListMappingRequest) -> operations.CreateSipAuthRegistrationsCredentialListMappingResponse:
        ...
        res = operations.CreateSipAuthRegistrationsCredentialListMappingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.CreateSipAuthRegistrationsCredentialListMappingResponses(api_v2010_account_sip_sip_domain_sip_auth_sip_auth_registrations_sip_auth_registrations_credential_list_mapping=out)
    ...
    def create_sip_credential(self, request: operations.CreateSipCredentialRequest) -> operations.CreateSipCredentialResponse:
        ...
        res = operations.CreateSipCredentialResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountSipSipCredentialListSipCredential])
                res.responses[r.status_code][content_type] = operations.CreateSipCredentialResponses(api_v2010_account_sip_sip_credential_list_sip_credential=out)
    ...
    def create_sip_credential_list(self, request: operations.CreateSipCredentialListRequest) -> operations.CreateSipCredentialListResponse:
        ...
        res = operations.CreateSipCredentialListResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountSipSipCredentialList])
                res.responses[r.status_code][content_type] = operations.CreateSipCredentialListResponses(api_v2010_account_sip_sip_credential_list=out)
    ...
    def create_sip_credential_list_mapping(self, request: operations.CreateSipCredentialListMappingRequest) -> operations.CreateSipCredentialListMappingResponse:
        ...
        res = operations.CreateSipCredentialListMappingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountSipSipDomainSipCredentialListMapping])
                res.responses[r.status_code][content_type] = operations.CreateSipCredentialListMappingResponses(api_v2010_account_sip_sip_domain_sip_credential_list_mapping=out)
    ...
    def create_sip_domain(self, request: operations.CreateSipDomainRequest) -> operations.CreateSipDomainResponse:
        ...
        res = operations.CreateSipDomainResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountSipSipDomain])
                res.responses[r.status_code][content_type] = operations.CreateSipDomainResponses(api_v2010_account_sip_sip_domain=out)
    ...
    def create_sip_ip_access_control_list(self, request: operations.CreateSipIPAccessControlListRequest) -> operations.CreateSipIPAccessControlListResponse:
        ...
        res = operations.CreateSipIPAccessControlListResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountSipSipIPAccessControlList])
                res.responses[r.status_code][content_type] = operations.CreateSipIPAccessControlListResponses(api_v2010_account_sip_sip_ip_access_control_list=out)
    ...
    def create_sip_ip_access_control_list_mapping(self, request: operations.CreateSipIPAccessControlListMappingRequest) -> operations.CreateSipIPAccessControlListMappingResponse:
        ...
        res = operations.CreateSipIPAccessControlListMappingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountSipSipDomainSipIPAccessControlListMapping])
                res.responses[r.status_code][content_type] = operations.CreateSipIPAccessControlListMappingResponses(api_v2010_account_sip_sip_domain_sip_ip_access_control_list_mapping=out)
    ...
    def create_sip_ip_address(self, request: operations.CreateSipIPAddressRequest) -> operations.CreateSipIPAddressResponse:
        ...
        res = operations.CreateSipIPAddressResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountSipSipIPAccessControlListSipIPAddress])
                res.responses[r.status_code][content_type] = operations.CreateSipIPAddressResponses(api_v2010_account_sip_sip_ip_access_control_list_sip_ip_address=out)
    ...
    def create_siprec(self, request: operations.CreateSiprecRequest) -> operations.CreateSiprecResponse:
        ...
        res = operations.CreateSiprecResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountCallSiprec])
                res.responses[r.status_code][content_type] = operations.CreateSiprecResponses(api_v2010_account_call_siprec=out)
    ...
    def create_stream(self, request: operations.CreateStreamRequest) -> operations.CreateStreamResponse:
        ...
        res = operations.CreateStreamResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountCallStream])
                res.responses[r.status_code][content_type] = operations.CreateStreamResponses(api_v2010_account_call_stream=out)
    ...
    def create_token(self, request: operations.CreateTokenRequest) -> operations.CreateTokenResponse:
        ...
        res = operations.CreateTokenResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountToken])
                res.responses[r.status_code][content_type] = operations.CreateTokenResponses(api_v2010_account_token=out)
    ...
    def create_usage_trigger(self, request: operations.CreateUsageTriggerRequest) -> operations.CreateUsageTriggerResponse:
        ...
        res = operations.CreateUsageTriggerResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountUsageUsageTrigger])
                res.responses[r.status_code][content_type] = operations.CreateUsageTriggerResponses(api_v2010_account_usage_usage_trigger=out)
    ...
    def create_validation_request(self, request: operations.CreateValidationRequestRequest) -> operations.CreateValidationRequestResponse:
        ...
        res = operations.CreateValidationRequestResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountValidationRequest])
                res.responses[r.status_code][content_type] = operations.CreateValidationRequestResponses(api_v2010_account_validation_request=out)
    ...
    def fetch_account(self, request: operations.FetchAccountRequest) -> operations.FetchAccountResponse:
        ...
        res = operations.FetchAccountResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010Account])
                res.responses[r.status_code][content_type] = operations.FetchAccountResponses(api_v2010_account=out)
    ...
    def fetch_address(self, request: operations.FetchAddressRequest) -> operations.FetchAddressResponse:
        ...
        res = operations.FetchAddressResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountAddress])
                res.responses[r.status_code][content_type] = operations.FetchAddressResponses(api_v2010_account_address=out)
    ...
    def fetch_application(self, request: operations.FetchApplicationRequest) -> operations.FetchApplicationResponse:
        ...
        res = operations.FetchApplicationResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountApplication])
                res.responses[r.status_code][content_type] = operations.FetchApplicationResponses(api_v2010_account_application=out)
    ...
    def fetch_authorized_connect_app(self, request: operations.FetchAuthorizedConnectAppRequest) -> operations.FetchAuthorizedConnectAppResponse:
        ...
        res = operations.FetchAuthorizedConnectAppResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountAuthorizedConnectApp])
                res.responses[r.status_code][content_type] = operations.FetchAuthorizedConnectAppResponses(api_v2010_account_authorized_connect_app=out)
    ...
    def fetch_available_phone_number_country(self, request: operations.FetchAvailablePhoneNumberCountryRequest) -> operations.FetchAvailablePhoneNumberCountryResponse:
        ...
        res = operations.FetchAvailablePhoneNumberCountryResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountAvailablePhoneNumberCountry])
                res.responses[r.status_code][content_type] = operations.FetchAvailablePhoneNumberCountryResponses(api_v2010_account_available_phone_number_country=out)
    ...
    def fetch_balance(self, request: operations.FetchBalanceRequest) -> operations.FetchBalanceResponse:
        ...
        res = operations.FetchBalanceResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountBalance])
                res.responses[r.status_code][content_type] = operations.FetchBalanceResponses(api_v2010_account_balance=out)
    ...
    def fetch_call(self, request: operations.FetchCallRequest) -> operations.FetchCallResponse:
        ...
        res = operations.FetchCallResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountCall])
                res.responses[r.status_code][content_type] = operations.FetchCallResponses(api_v2010_account_call=out)
    ...
    def fetch_call_feedback(self, request: operations.FetchCallFeedbackRequest) -> operations.FetchCallFeedbackResponse:
        ...
        res = operations.FetchCallFeedbackResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountCallCallFeedback])
                res.responses[r.status_code][content_type] = operations.FetchCallFeedbackResponses(api_v2010_account_call_call_feedback=out)
    ...
    def fetch_call_feedback_summary(self, request: operations.FetchCallFeedbackSummaryRequest) -> operations.FetchCallFeedbackSummaryResponse:
        ...
        res = operations.FetchCallFeedbackSummaryResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountCallCallFeedbackSummary])
                res.responses[r.status_code][content_type] = operations.FetchCallFeedbackSummaryResponses(api_v2010_account_call_call_feedback_summary=out)
    ...
    def fetch_call_notification(self, request: operations.FetchCallNotificationRequest) -> operations.FetchCallNotificationResponse:
        ...
        res = operations.FetchCallNotificationResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountCallCallNotificationInstance])
                res.responses[r.status_code][content_type] = operations.FetchCallNotificationResponses(api_v2010_account_call_call_notification_instance=out)
    ...
    def fetch_call_recording(self, request: operations.FetchCallRecordingRequest) -> operations.FetchCallRecordingResponse:
        ...
        res = operations.FetchCallRecordingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountCallCallRecording])
                res.responses[r.status_code][content_type] = operations.FetchCallRecordingResponses(api_v2010_account_call_call_recording=out)
    ...
    def fetch_conference(self, request: operations.FetchConferenceRequest) -> operations.FetchConferenceResponse:
        ...
        res = operations.FetchConferenceResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountConference])
                res.responses[r.status_code][content_type] = operations.FetchConferenceResponses(api_v2010_account_conference=out)
    ...
    def fetch_conference_recording(self, request: operations.FetchConferenceRecordingRequest) -> operations.FetchConferenceRecordingResponse:
        ...
        res = operations.FetchConferenceRecordingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountConferenceConferenceRecording])
                res.responses[r.status_code][content_type] = operations.FetchConferenceRecordingResponses(api_v2010_account_conference_conference_recording=out)
    ...
    def fetch_connect_app(self, request: operations.FetchConnectAppRequest) -> operations.FetchConnectAppResponse:
        ...
        res = operations.FetchConnectAppResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountConnectApp])
                res.responses[r.status_code][content_type] = operations.FetchConnectAppResponses(api_v2010_account_connect_app=out)
    ...
    def fetch_incoming_phone_number(self, request: operations.FetchIncomingPhoneNumberRequest) -> operations.FetchIncomingPhoneNumberResponse:
        ...
        res = operations.FetchIncomingPhoneNumberResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountIncomingPhoneNumber])
                res.responses[r.status_code][content_type] = operations.FetchIncomingPhoneNumberResponses(api_v2010_account_incoming_phone_number=out)
    ...
    def fetch_incoming_phone_number_assigned_add_on(self, request: operations.FetchIncomingPhoneNumberAssignedAddOnRequest) -> operations.FetchIncomingPhoneNumberAssignedAddOnResponse:
        ...
        res = operations.FetchIncomingPhoneNumberAssignedAddOnResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberAssignedAddOn])
                res.responses[r.status_code][content_type] = operations.FetchIncomingPhoneNumberAssignedAddOnResponses(api_v2010_account_incoming_phone_number_incoming_phone_number_assigned_add_on=out)
    ...
    def fetch_incoming_phone_number_assigned_add_on_extension(self, request: operations.FetchIncomingPhoneNumberAssignedAddOnExtensionRequest) -> operations.FetchIncomingPhoneNumberAssignedAddOnExtensionResponse:
        ...
        res = operations.FetchIncomingPhoneNumberAssignedAddOnExtensionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.FetchIncomingPhoneNumberAssignedAddOnExtensionResponses(api_v2010_account_incoming_phone_number_incoming_phone_number_assigned_add_on_incoming_phone_number_assigned_add_on_extension=out)
    ...
    def fetch_key(self, request: operations.FetchKeyRequest) -> operations.FetchKeyResponse:
        ...
        res = operations.FetchKeyResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountKey])
                res.responses[r.status_code][content_type] = operations.FetchKeyResponses(api_v2010_account_key=out)
    ...
    def fetch_media(self, request: operations.FetchMediaRequest) -> operations.FetchMediaResponse:
        ...
        res = operations.FetchMediaResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountMessageMedia])
                res.responses[r.status_code][content_type] = operations.FetchMediaResponses(api_v2010_account_message_media=out)
    ...
    def fetch_member(self, request: operations.FetchMemberRequest) -> operations.FetchMemberResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.FetchMemberResponses(api_v2010_account_queue_member=out)
    ...
    def fetch_message(self, request: operations.FetchMessageRequest) -> operations.FetchMessageResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountMessage])
                res.responses[r.status_code][content_type] = operations.FetchMessageResponses(api_v2010_account_message=out)
    ...
    def fetch_notification(self, request: operations.FetchNotificationRequest) -> operations.FetchNotificationResponse:
        ...
        res = operations.FetchNotificationResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountNotificationInstance])
                res.responses[r.status_code][content_type] = operations.FetchNotificationResponses(api_v2010_account_notification_instance=out)
    ...
    def fetch_outgoing_caller_id(self, request: operations.FetchOutgoingCallerIDRequest) -> operations.FetchOutgoingCallerIDResponse:
        ...
        res = operations.FetchOutgoingCallerIDResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountOutgoingCallerID])
                res.responses[r.status_code][content_type] = operations.FetchOutgoingCallerIDResponses(api_v2010_account_outgoing_caller_id=out)
    ...
    def fetch_participant(self, request: operations.FetchParticipantRequest) -> operations.FetchParticipantResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountConferenceParticipant])
                res.responses[r.status_code][content_type] = operations.FetchParticipantResponses(api_v2010_account_conference_participant=out)
    ...
    def fetch_queue(self, request: operations.FetchQueueRequest) -> operations.FetchQueueResponse:
        ...
        res = operations.FetchQueueResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountQueue])
                res.responses[r.status_code][content_type] = operations.FetchQueueResponses(api_v2010_account_queue=out)
    ...
    def fetch_recording(self, request: operations.FetchRecordingRequest) -> operations.FetchRecordingResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.FetchRecordingResponses(api_v2010_account_recording=out)
    ...
    def fetch_recording_add_on_result(self, request: operations.FetchRecordingAddOnResultRequest) -> operations.FetchRecordingAddOnResultResponse:
        ...
        res = operations.FetchRecordingAddOnResultResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountRecordingRecordingAddOnResult])
                res.responses[r.status_code][content_type] = operations.FetchRecordingAddOnResultResponses(api_v2010_account_recording_recording_add_on_result=out)
    ...
    def fetch_recording_add_on_result_payload(self, request: operations.FetchRecordingAddOnResultPayloadRequest) -> operations.FetchRecordingAddOnResultPayloadResponse:
        ...
        res = operations.FetchRecordingAddOnResultPayloadResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountRecordingRecordingAddOnResultRecordingAddOnResultPayload])
                res.responses[r.status_code][content_type] = operations.FetchRecordingAddOnResultPayloadResponses(api_v2010_account_recording_recording_add_on_result_recording_add_on_result_payload=out)
    ...
    def fetch_recording_transcription(self, request: operations.FetchRecordingTranscriptionRequest) -> operations.FetchRecordingTranscriptionResponse:
        ...
        res = operations.FetchRecordingTranscriptionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountRecordingRecordingTranscription])
                res.responses[r.status_code][content_type] = operations.FetchRecordingTranscriptionResponses(api_v2010_account_recording_recording_transcription=out)
    ...
    def fetch_short_code(self, request: operations.FetchShortCodeRequest) -> operations.FetchShortCodeResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.FetchShortCodeResponses(api_v2010_account_short_code=out)
    ...
    def fetch_signing_key(self, request: operations.FetchSigningKeyRequest) -> operations.FetchSigningKeyResponse:
        ...
        res = operations.FetchSigningKeyResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountSigningKey])
                res.responses[r.status_code][content_type] = operations.FetchSigningKeyResponses(api_v2010_account_signing_key=out)
    ...
    def fetch_sip_auth_calls_credential_list_mapping(self, request: operations.FetchSipAuthCallsCredentialListMappingRequest) -> operations.FetchSipAuthCallsCredentialListMappingResponse:
        ...
        res = operations.FetchSipAuthCallsCredentialListMappingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountSipSipDomainSipAuthSipAuthCallsSipAuthCallsCredentialListMapping])
                res.responses[r.status_code][content_type] = operations.FetchSipAuthCallsCredentialListMappingResponses(api_v2010_account_sip_sip_domain_sip_auth_sip_auth_calls_sip_auth_calls_credential_list_mapping=out)
    ...
    def fetch_sip_auth_calls_ip_access_control_list_mapping(self, request: operations.FetchSipAuthCallsIPAccessControlListMappingRequest) -> operations.FetchSipAuthCallsIPAccessControlListMappingResponse:
        ...
        res = operations.FetchSipAuthCallsIPAccessControlListMappingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountSipSipDomainSipAuthSipAuthCallsSipAuthCallsIPAccessControlListMapping])
                res.responses[r.status_code][content_type] = operations.FetchSipAuthCallsIPAccessControlListMappingResponses(api_v2010_account_sip_sip_domain_sip_auth_sip_auth_calls_sip_auth_calls_ip_access_control_list_mapping=out)
    ...
    def fetch_sip_auth_registrations_credential_list_mapping(self, request: operations.FetchSipAuthRegistrationsCredentialListMappingRequest) -> operations.FetchSipAuthRegistrationsCredentialListMappingResponse:
        ...
        res = operations.FetchSipAuthRegistrationsCredentialListMappingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountSipSipDomainSipAuthSipAuthRegistrationsSipAuthRegistrationsCredentialListMapping])
                res.responses[r.status_code][content_type] = operations.FetchSipAuthRegistrationsCredentialListMappingResponses(api_v2010_account_sip_sip_domain_sip_auth_sip_auth_registrations_sip_auth_registrations_credential_list_mapping=out)
    ...
    def fetch_sip_credential(self, request: operations.FetchSipCredentialRequest) -> operations.FetchSipCredentialResponse:
        ...
        res = operations.FetchSipCredentialResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountSipSipCredentialListSipCredential])
                res.responses[r.status_code][content_type] = operations.FetchSipCredentialResponses(api_v2010_account_sip_sip_credential_list_sip_credential=out)
    ...
    def fetch_sip_credential_list(self, request: operations.FetchSipCredentialListRequest) -> operations.FetchSipCredentialListResponse:
        ...
        res = operations.FetchSipCredentialListResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountSipSipCredentialList])
                res.responses[r.status_code][content_type] = operations.FetchSipCredentialListResponses(api_v2010_account_sip_sip_credential_list=out)
    ...
    def fetch_sip_credential_list_mapping(self, request: operations.FetchSipCredentialListMappingRequest) -> operations.FetchSipCredentialListMappingResponse:
        ...
        res = operations.FetchSipCredentialListMappingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountSipSipDomainSipCredentialListMapping])
                res.responses[r.status_code][content_type] = operations.FetchSipCredentialListMappingResponses(api_v2010_account_sip_sip_domain_sip_credential_list_mapping=out)
    ...
    def fetch_sip_domain(self, request: operations.FetchSipDomainRequest) -> operations.FetchSipDomainResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountSipSipDomain])
                res.responses[r.status_code][content_type] = operations.FetchSipDomainResponses(api_v2010_account_sip_sip_domain=out)
    ...
    def fetch_sip_ip_access_control_list(self, request: operations.FetchSipIPAccessControlListRequest) -> operations.FetchSipIPAccessControlListResponse:
        ...
        res = operations.FetchSipIPAccessControlListResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountSipSipIPAccessControlList])
                res.responses[r.status_code][content_type] = operations.FetchSipIPAccessControlListResponses(api_v2010_account_sip_sip_ip_access_control_list=out)
    ...
    def fetch_sip_ip_access_control_list_mapping(self, request: operations.FetchSipIPAccessControlListMappingRequest) -> operations.FetchSipIPAccessControlListMappingResponse:
        ...
        res = operations.FetchSipIPAccessControlListMappingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountSipSipDomainSipIPAccessControlListMapping])
                res.responses[r.status_code][content_type] = operations.FetchSipIPAccessControlListMappingResponses(api_v2010_account_sip_sip_domain_sip_ip_access_control_list_mapping=out)
    ...
    def fetch_sip_ip_address(self, request: operations.FetchSipIPAddressRequest) -> operations.FetchSipIPAddressResponse:
        ...
        res = operations.FetchSipIPAddressResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountSipSipIPAccessControlListSipIPAddress])
                res.responses[r.status_code][content_type] = operations.FetchSipIPAddressResponses(api_v2010_account_sip_sip_ip_access_control_list_sip_ip_address=out)
    ...
    def fetch_transcription(self, request: operations.FetchTranscriptionRequest) -> operations.FetchTranscriptionResponse:
        ...
        res = operations.FetchTranscriptionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountTranscription])
                res.responses[r.status_code][content_type] = operations.FetchTranscriptionResponses(api_v2010_account_transcription=out)
    ...
    def fetch_usage_trigger(self, request: operations.FetchUsageTriggerRequest) -> operations.FetchUsageTriggerResponse:
        ...
        res = operations.FetchUsageTriggerResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountUsageUsageTrigger])
                res.responses[r.status_code][content_type] = operations.FetchUsageTriggerResponses(api_v2010_account_usage_usage_trigger=out)
    ...
    def list_account(self, request: operations.ListAccountRequest) -> operations.ListAccountResponse:
        ...
        res = operations.ListAccountResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListAccount200ApplicationJSONListAccountResponse])
                res.responses[r.status_code][content_type] = operations.ListAccountResponses(list_account_response=out)
    ...
    def list_address(self, request: operations.ListAddressRequest) -> operations.ListAddressResponse:
        ...
        res = operations.ListAddressResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListAddress200ApplicationJSONListAddressResponse])
                res.responses[r.status_code][content_type] = operations.ListAddressResponses(list_address_response=out)
    ...
    def list_application(self, request: operations.ListApplicationRequest) -> operations.ListApplicationResponse:
        ...
        res = operations.ListApplicationResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListApplication200ApplicationJSONListApplicationResponse])
                res.responses[r.status_code][content_type] = operations.ListApplicationResponses(list_application_response=out)
    ...
    def list_authorized_connect_app(self, request: operations.ListAuthorizedConnectAppRequest) -> operations.ListAuthorizedConnectAppResponse:
        ...
        res = operations.ListAuthorizedConnectAppResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListAuthorizedConnectAppResponses(list_authorized_connect_app_response=out)
    ...
    def list_available_phone_number_country(self, request: operations.ListAvailablePhoneNumberCountryRequest) -> operations.ListAvailablePhoneNumberCountryResponse:
        ...
        res = operations.ListAvailablePhoneNumberCountryResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListAvailablePhoneNumberCountryResponses(list_available_phone_number_country_response=out)
    ...
    def list_available_phone_number_local(self, request: operations.ListAvailablePhoneNumberLocalRequest) -> operations.ListAvailablePhoneNumberLocalResponse:
        ...
        res = operations.ListAvailablePhoneNumberLocalResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListAvailablePhoneNumberLocalResponses(list_available_phone_number_local_response=out)
    ...
    def list_available_phone_number_machine_to_machine(self, request: operations.ListAvailablePhoneNumberMachineToMachineRequest) -> operations.ListAvailablePhoneNumberMachineToMachineResponse:
        ...
        res = operations.ListAvailablePhoneNumberMachineToMachineResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListAvailablePhoneNumberMachineToMachineResponses(list_available_phone_number_machine_to_machine_response=out)
    ...
    def list_available_phone_number_mobile(self, request: operations.ListAvailablePhoneNumberMobileRequest) -> operations.ListAvailablePhoneNumberMobileResponse:
        ...
        res = operations.ListAvailablePhoneNumberMobileResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListAvailablePhoneNumberMobileResponses(list_available_phone_number_mobile_response=out)
    ...
    def list_available_phone_number_national(self, request: operations.ListAvailablePhoneNumberNationalRequest) -> operations.ListAvailablePhoneNumberNationalResponse:
        ...
        res = operations.ListAvailablePhoneNumberNationalResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListAvailablePhoneNumberNationalResponses(list_available_phone_number_national_response=out)
    ...
    def list_available_phone_number_shared_cost(self, request: operations.ListAvailablePhoneNumberSharedCostRequest) -> operations.ListAvailablePhoneNumberSharedCostResponse:
        ...
        res = operations.ListAvailablePhoneNumberSharedCostResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListAvailablePhoneNumberSharedCostResponses(list_available_phone_number_shared_cost_response=out)
    ...
    def list_available_phone_number_toll_free(self, request: operations.ListAvailablePhoneNumberTollFreeRequest) -> operations.ListAvailablePhoneNumberTollFreeResponse:
        ...
        res = operations.ListAvailablePhoneNumberTollFreeResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListAvailablePhoneNumberTollFreeResponses(list_available_phone_number_toll_free_response=out)
    ...
    def list_available_phone_number_voip(self, request: operations.ListAvailablePhoneNumberVoipRequest) -> operations.ListAvailablePhoneNumberVoipResponse:
        ...
        res = operations.ListAvailablePhoneNumberVoipResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListAvailablePhoneNumberVoipResponses(list_available_phone_number_voip_response=out)
    ...
    def list_call(self, request: operations.ListCallRequest) -> operations.ListCallResponse:
        ...
        res = operations.ListCallResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListCall200ApplicationJSONListCallResponse])
                res.responses[r.status_code][content_type] = operations.ListCallResponses(list_call_response=out)
    ...
    def list_call_event(self, request: operations.ListCallEventRequest) -> operations.ListCallEventResponse:
        ...
        res = operations.ListCallEventResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListCallEvent200ApplicationJSONListCallEventResponse])
                res.responses[r.status_code][content_type] = operations.ListCallEventResponses(list_call_event_response=out)
    ...
    def list_call_notification(self, request: operations.ListCallNotificationRequest) -> operations.ListCallNotificationResponse:
        ...
        res = operations.ListCallNotificationResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListCallNotification200ApplicationJSONListCallNotificationResponse])
                res.responses[r.status_code][content_type] = operations.ListCallNotificationResponses(list_call_notification_response=out)
    ...
    def list_call_recording(self, request: operations.ListCallRecordingRequest) -> operations.ListCallRecordingResponse:
        ...
        res = operations.ListCallRecordingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListCallRecording200ApplicationJSONListCallRecordingResponse])
                res.responses[r.status_code][content_type] = operations.ListCallRecordingResponses(list_call_recording_response=out)
    ...
    def list_conference(self, request: operations.ListConferenceRequest) -> operations.ListConferenceResponse:
        ...
        res = operations.ListConferenceResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListConference200ApplicationJSONListConferenceResponse])
                res.responses[r.status_code][content_type] = operations.ListConferenceResponses(list_conference_response=out)
    ...
    def list_conference_recording(self, request: operations.ListConferenceRecordingRequest) -> operations.ListConferenceRecordingResponse:
        ...
        res = operations.ListConferenceRecordingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListConferenceRecordingResponses(list_conference_recording_response=out)
    ...
    def list_connect_app(self, request: operations.ListConnectAppRequest) -> operations.ListConnectAppResponse:
        ...
        res = operations.ListConnectAppResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListConnectApp200ApplicationJSONListConnectAppResponse])
                res.responses[r.status_code][content_type] = operations.ListConnectAppResponses(list_connect_app_response=out)
    ...
    def list_dependent_phone_number(self, request: operations.ListDependentPhoneNumberRequest) -> operations.ListDependentPhoneNumberResponse:
        ...
        res = operations.ListDependentPhoneNumberResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListDependentPhoneNumberResponses(list_dependent_phone_number_response=out)
    ...
    def list_incoming_phone_number(self, request: operations.ListIncomingPhoneNumberRequest) -> operations.ListIncomingPhoneNumberResponse:
        ...
        res = operations.ListIncomingPhoneNumberResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListIncomingPhoneNumberResponses(list_incoming_phone_number_response=out)
    ...
    def list_incoming_phone_number_assigned_add_on(self, request: operations.ListIncomingPhoneNumberAssignedAddOnRequest) -> operations.ListIncomingPhoneNumberAssignedAddOnResponse:
        ...
        res = operations.ListIncomingPhoneNumberAssignedAddOnResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListIncomingPhoneNumberAssignedAddOnResponses(list_incoming_phone_number_assigned_add_on_response=out)
    ...
    def list_incoming_phone_number_assigned_add_on_extension(self, request: operations.ListIncomingPhoneNumberAssignedAddOnExtensionRequest) -> operations.ListIncomingPhoneNumberAssignedAddOnExtensionResponse:
        ...
        res = operations.ListIncomingPhoneNumberAssignedAddOnExtensionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListIncomingPhoneNumberAssignedAddOnExtensionResponses(list_incoming_phone_number_assigned_add_on_extension_response=out)
    ...
    def list_incoming_phone_number_local(self, request: operations.ListIncomingPhoneNumberLocalRequest) -> operations.ListIncomingPhoneNumberLocalResponse:
        ...
        res = operations.ListIncomingPhoneNumberLocalResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListIncomingPhoneNumberLocalResponses(list_incoming_phone_number_local_response=out)
    ...
    def list_incoming_phone_number_mobile(self, request: operations.ListIncomingPhoneNumberMobileRequest) -> operations.ListIncomingPhoneNumberMobileResponse:
        ...
        res = operations.ListIncomingPhoneNumberMobileResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListIncomingPhoneNumberMobileResponses(list_incoming_phone_number_mobile_response=out)
    ...
    def list_incoming_phone_number_toll_free(self, request: operations.ListIncomingPhoneNumberTollFreeRequest) -> operations.ListIncomingPhoneNumberTollFreeResponse:
        ...
        res = operations.ListIncomingPhoneNumberTollFreeResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListIncomingPhoneNumberTollFreeResponses(list_incoming_phone_number_toll_free_response=out)
    ...
    def list_key(self, request: operations.ListKeyRequest) -> operations.ListKeyResponse:
        ...
        res = operations.ListKeyResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListKey200ApplicationJSONListKeyResponse])
                res.responses[r.status_code][content_type] = operations.ListKeyResponses(list_key_response=out)
    ...
    def list_media(self, request: operations.ListMediaRequest) -> operations.ListMediaResponse:
        ...
        res = operations.ListMediaResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListMedia200ApplicationJSONListMediaResponse])
                res.responses[r.status_code][content_type] = operations.ListMediaResponses(list_media_response=out)
    ...
    def list_notification(self, request: operations.ListNotificationRequest) -> operations.ListNotificationResponse:
        ...
        res = operations.ListNotificationResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListNotification200ApplicationJSONListNotificationResponse])
                res.responses[r.status_code][content_type] = operations.ListNotificationResponses(list_notification_response=out)
    ...
    def list_outgoing_caller_id(self, request: operations.ListOutgoingCallerIDRequest) -> operations.ListOutgoingCallerIDResponse:
        ...
        res = operations.ListOutgoingCallerIDResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListOutgoingCallerID200ApplicationJSONListOutgoingCallerIDResponse])
                res.responses[r.status_code][content_type] = operations.ListOutgoingCallerIDResponses(list_outgoing_caller_id_response=out)
    ...
    def list_queue(self, request: operations.ListQueueRequest) -> operations.ListQueueResponse:
        ...
        res = operations.ListQueueResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListQueue200ApplicationJSONListQueueResponse])
                res.responses[r.status_code][content_type] = operations.ListQueueResponses(list_queue_response=out)
    ...
    def list_recording_add_on_result(self, request: operations.ListRecordingAddOnResultRequest) -> operations.ListRecordingAddOnResultResponse:
        ...
        res = operations.ListRecordingAddOnResultResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListRecordingAddOnResultResponses(list_recording_add_on_result_response=out)
    ...
    def list_recording_add_on_result_payload(self, request: operations.ListRecordingAddOnResultPayloadRequest) -> operations.ListRecordingAddOnResultPayloadResponse:
        ...
        res = operations.ListRecordingAddOnResultPayloadResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListRecordingAddOnResultPayloadResponses(list_recording_add_on_result_payload_response=out)
    ...
    def list_recording_transcription(self, request: operations.ListRecordingTranscriptionRequest) -> operations.ListRecordingTranscriptionResponse:
        ...
        res = operations.ListRecordingTranscriptionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListRecordingTranscriptionResponses(list_recording_transcription_response=out)
    ...
    def list_signing_key(self, request: operations.ListSigningKeyRequest) -> operations.ListSigningKeyResponse:
        ...
        res = operations.ListSigningKeyResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListSigningKey200ApplicationJSONListSigningKeyResponse])
                res.responses[r.status_code][content_type] = operations.ListSigningKeyResponses(list_signing_key_response=out)
    ...
    def list_sip_auth_calls_credential_list_mapping(self, request: operations.ListSipAuthCallsCredentialListMappingRequest) -> operations.ListSipAuthCallsCredentialListMappingResponse:
        ...
        res = operations.ListSipAuthCallsCredentialListMappingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListSipAuthCallsCredentialListMappingResponses(list_sip_auth_calls_credential_list_mapping_response=out)
    ...
    def list_sip_auth_calls_ip_access_control_list_mapping(self, request: operations.ListSipAuthCallsIPAccessControlListMappingRequest) -> operations.ListSipAuthCallsIPAccessControlListMappingResponse:
        ...
        res = operations.ListSipAuthCallsIPAccessControlListMappingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListSipAuthCallsIPAccessControlListMappingResponses(list_sip_auth_calls_ip_access_control_list_mapping_response=out)
    ...
    def list_sip_auth_registrations_credential_list_mapping(self, request: operations.ListSipAuthRegistrationsCredentialListMappingRequest) -> operations.ListSipAuthRegistrationsCredentialListMappingResponse:
        ...
        res = operations.ListSipAuthRegistrationsCredentialListMappingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListSipAuthRegistrationsCredentialListMappingResponses(list_sip_auth_registrations_credential_list_mapping_response=out)
    ...
    def list_sip_credential(self, request: operations.ListSipCredentialRequest) -> operations.ListSipCredentialResponse:
        ...
        res = operations.ListSipCredentialResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListSipCredential200ApplicationJSONListSipCredentialResponse])
                res.responses[r.status_code][content_type] = operations.ListSipCredentialResponses(list_sip_credential_response=out)
    ...
    def list_sip_credential_list(self, request: operations.ListSipCredentialListRequest) -> operations.ListSipCredentialListResponse:
        ...
        res = operations.ListSipCredentialListResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListSipCredentialList200ApplicationJSONListSipCredentialListResponse])
                res.responses[r.status_code][content_type] = operations.ListSipCredentialListResponses(list_sip_credential_list_response=out)
    ...
    def list_sip_credential_list_mapping(self, request: operations.ListSipCredentialListMappingRequest) -> operations.ListSipCredentialListMappingResponse:
        ...
        res = operations.ListSipCredentialListMappingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListSipCredentialListMappingResponses(list_sip_credential_list_mapping_response=out)
    ...
    def list_sip_domain(self, request: operations.ListSipDomainRequest) -> operations.ListSipDomainResponse:
        ...
        res = operations.ListSipDomainResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListSipDomain200ApplicationJSONListSipDomainResponse])
                res.responses[r.status_code][content_type] = operations.ListSipDomainResponses(list_sip_domain_response=out)
    ...
    def list_sip_ip_access_control_list(self, request: operations.ListSipIPAccessControlListRequest) -> operations.ListSipIPAccessControlListResponse:
        ...
        res = operations.ListSipIPAccessControlListResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListSipIPAccessControlListResponses(list_sip_ip_access_control_list_response=out)
    ...
    def list_sip_ip_access_control_list_mapping(self, request: operations.ListSipIPAccessControlListMappingRequest) -> operations.ListSipIPAccessControlListMappingResponse:
        ...
        res = operations.ListSipIPAccessControlListMappingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListSipIPAccessControlListMappingResponses(list_sip_ip_access_control_list_mapping_response=out)
    ...
    def list_sip_ip_address(self, request: operations.ListSipIPAddressRequest) -> operations.ListSipIPAddressResponse:
        ...
        res = operations.ListSipIPAddressResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListSipIPAddress200ApplicationJSONListSipIPAddressResponse])
                res.responses[r.status_code][content_type] = operations.ListSipIPAddressResponses(list_sip_ip_address_response=out)
    ...
    def list_transcription(self, request: operations.ListTranscriptionRequest) -> operations.ListTranscriptionResponse:
        ...
        res = operations.ListTranscriptionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListTranscription200ApplicationJSONListTranscriptionResponse])
                res.responses[r.status_code][content_type] = operations.ListTranscriptionResponses(list_transcription_response=out)
    ...
    def list_usage_record_all_time(self, request: operations.ListUsageRecordAllTimeRequest) -> operations.ListUsageRecordAllTimeResponse:
        ...
        res = operations.ListUsageRecordAllTimeResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListUsageRecordAllTimeResponses(list_usage_record_all_time_response=out)
    ...
    def list_usage_record_daily(self, request: operations.ListUsageRecordDailyRequest) -> operations.ListUsageRecordDailyResponse:
        ...
        res = operations.ListUsageRecordDailyResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListUsageRecordDaily200ApplicationJSONListUsageRecordDailyResponse])
                res.responses[r.status_code][content_type] = operations.ListUsageRecordDailyResponses(list_usage_record_daily_response=out)
    ...
    def list_usage_record_last_month(self, request: operations.ListUsageRecordLastMonthRequest) -> operations.ListUsageRecordLastMonthResponse:
        ...
        res = operations.ListUsageRecordLastMonthResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListUsageRecordLastMonthResponses(list_usage_record_last_month_response=out)
    ...
    def list_usage_record_monthly(self, request: operations.ListUsageRecordMonthlyRequest) -> operations.ListUsageRecordMonthlyResponse:
        ...
        res = operations.ListUsageRecordMonthlyResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListUsageRecordMonthlyResponses(list_usage_record_monthly_response=out)
    ...
    def list_usage_record_this_month(self, request: operations.ListUsageRecordThisMonthRequest) -> operations.ListUsageRecordThisMonthResponse:
        ...
        res = operations.ListUsageRecordThisMonthResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListUsageRecordThisMonthResponses(list_usage_record_this_month_response=out)
    ...
    def list_usage_record_today(self, request: operations.ListUsageRecordTodayRequest) -> operations.ListUsageRecordTodayResponse:
        ...
        res = operations.ListUsageRecordTodayResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListUsageRecordToday200ApplicationJSONListUsageRecordTodayResponse])
                res.responses[r.status_code][content_type] = operations.ListUsageRecordTodayResponses(list_usage_record_today_response=out)
    ...
    def list_usage_record_yearly(self, request: operations.ListUsageRecordYearlyRequest) -> operations.ListUsageRecordYearlyResponse:
        ...
        res = operations.ListUsageRecordYearlyResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListUsageRecordYearly200ApplicationJSONListUsageRecordYearlyResponse])
                res.responses[r.status_code][content_type] = operations.ListUsageRecordYearlyResponses(list_usage_record_yearly_response=out)
    ...
    def list_usage_record_yesterday(self, request: operations.ListUsageRecordYesterdayRequest) -> operations.ListUsageRecordYesterdayResponse:
        ...
        res = operations.ListUsageRecordYesterdayResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListUsageRecordYesterdayResponses(list_usage_record_yesterday_response=out)
    ...
    def list_usage_trigger(self, request: operations.ListUsageTriggerRequest) -> operations.ListUsageTriggerResponse:
        ...
        res = operations.ListUsageTriggerResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListUsageTrigger200ApplicationJSONListUsageTriggerResponse])
                res.responses[r.status_code][content_type] = operations.ListUsageTriggerResponses(list_usage_trigger_response=out)
    ...
    def update_account(self, request: operations.UpdateAccountRequest) -> operations.UpdateAccountResponse:
        ...
        res = operations.UpdateAccountResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010Account])
                res.responses[r.status_code][content_type] = operations.UpdateAccountResponses(api_v2010_account=out)
    ...
    def update_address(self, request: operations.UpdateAddressRequest) -> operations.UpdateAddressResponse:
        ...
        res = operations.UpdateAddressResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountAddress])
                res.responses[r.status_code][content_type] = operations.UpdateAddressResponses(api_v2010_account_address=out)
    ...
    def update_application(self, request: operations.UpdateApplicationRequest) -> operations.UpdateApplicationResponse:
        ...
        res = operations.UpdateApplicationResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountApplication])
                res.responses[r.status_code][content_type] = operations.UpdateApplicationResponses(api_v2010_account_application=out)
    ...
    def update_call(self, request: operations.UpdateCallRequest) -> operations.UpdateCallResponse:
        ...
        res = operations.UpdateCallResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountCall])
                res.responses[r.status_code][content_type] = operations.UpdateCallResponses(api_v2010_account_call=out)
    ...
    def update_call_feedback(self, request: operations.UpdateCallFeedbackRequest) -> operations.UpdateCallFeedbackResponse:
        ...
        res = operations.UpdateCallFeedbackResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountCallCallFeedback])
                res.responses[r.status_code][content_type] = operations.UpdateCallFeedbackResponses(api_v2010_account_call_call_feedback=out)
    ...
    def update_call_recording(self, request: operations.UpdateCallRecordingRequest) -> operations.UpdateCallRecordingResponse:
        ...
        res = operations.UpdateCallRecordingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountCallCallRecording])
                res.responses[r.status_code][content_type] = operations.UpdateCallRecordingResponses(api_v2010_account_call_call_recording=out)
    ...
    def update_conference(self, request: operations.UpdateConferenceRequest) -> operations.UpdateConferenceResponse:
        ...
        res = operations.UpdateConferenceResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountConference])
                res.responses[r.status_code][content_type] = operations.UpdateConferenceResponses(api_v2010_account_conference=out)
    ...
    def update_conference_recording(self, request: operations.UpdateConferenceRecordingRequest) -> operations.UpdateConferenceRecordingResponse:
        ...
        res = operations.UpdateConferenceRecordingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountConferenceConferenceRecording])
                res.responses[r.status_code][content_type] = operations.UpdateConferenceRecordingResponses(api_v2010_account_conference_conference_recording=out)
    ...
    def update_connect_app(self, request: operations.UpdateConnectAppRequest) -> operations.UpdateConnectAppResponse:
        ...
        res = operations.UpdateConnectAppResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountConnectApp])
                res.responses[r.status_code][content_type] = operations.UpdateConnectAppResponses(api_v2010_account_connect_app=out)
    ...
    def update_incoming_phone_number(self, request: operations.UpdateIncomingPhoneNumberRequest) -> operations.UpdateIncomingPhoneNumberResponse:
        ...
        res = operations.UpdateIncomingPhoneNumberResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountIncomingPhoneNumber])
                res.responses[r.status_code][content_type] = operations.UpdateIncomingPhoneNumberResponses(api_v2010_account_incoming_phone_number=out)
    ...
    def update_key(self, request: operations.UpdateKeyRequest) -> operations.UpdateKeyResponse:
        ...
        res = operations.UpdateKeyResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountKey])
                res.responses[r.status_code][content_type] = operations.UpdateKeyResponses(api_v2010_account_key=out)
    ...
    def update_member(self, request: operations.UpdateMemberRequest) -> operations.UpdateMemberResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountQueueMember])
                res.responses[r.status_code][content_type] = operations.UpdateMemberResponses(api_v2010_account_queue_member=out)
    ...
    def update_message(self, request: operations.UpdateMessageRequest) -> operations.UpdateMessageResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountMessage])
                res.responses[r.status_code][content_type] = operations.UpdateMessageResponses(api_v2010_account_message=out)
    ...
    def update_outgoing_caller_id(self, request: operations.UpdateOutgoingCallerIDRequest) -> operations.UpdateOutgoingCallerIDResponse:
        ...
        res = operations.UpdateOutgoingCallerIDResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountOutgoingCallerID])
                res.responses[r.status_code][content_type] = operations.UpdateOutgoingCallerIDResponses(api_v2010_account_outgoing_caller_id=out)
    ...
    def update_participant(self, request: operations.UpdateParticipantRequest) -> operations.UpdateParticipantResponse:
        ...
        res = operations.UpdateParticipantResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountConferenceParticipant])
                res.responses[r.status_code][content_type] = operations.UpdateParticipantResponses(api_v2010_account_conference_participant=out)
    ...
    def update_payments(self, request: operations.UpdatePaymentsRequest) -> operations.UpdatePaymentsResponse:
        ...
        res = operations.UpdatePaymentsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 202:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountCallPayments])
                res.responses[r.status_code][content_type] = operations.UpdatePaymentsResponses(api_v2010_account_call_payments=out)
    ...
    def update_queue(self, request: operations.UpdateQueueRequest) -> operations.UpdateQueueResponse:
        ...
        res = operations.UpdateQueueResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountQueue])
                res.responses[r.status_code][content_type] = operations.UpdateQueueResponses(api_v2010_account_queue=out)
    ...
    def update_short_code(self, request: operations.UpdateShortCodeRequest) -> operations.UpdateShortCodeResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountShortCode])
                res.responses[r.status_code][content_type] = operations.UpdateShortCodeResponses(api_v2010_account_short_code=out)
    ...
    def update_signing_key(self, request: operations.UpdateSigningKeyRequest) -> operations.UpdateSigningKeyResponse:
        ...
        res = operations.UpdateSigningKeyResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountSigningKey])
                res.responses[r.status_code][content_type] = operations.UpdateSigningKeyResponses(api_v2010_account_signing_key=out)
    ...
    def update_sip_credential(self, request: operations.UpdateSipCredentialRequest) -> operations.UpdateSipCredentialResponse:
        ...
        res = operations.UpdateSipCredentialResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountSipSipCredentialListSipCredential])
                res.responses[r.status_code][content_type] = operations.UpdateSipCredentialResponses(api_v2010_account_sip_sip_credential_list_sip_credential=out)
    ...
    def update_sip_credential_list(self, request: operations.UpdateSipCredentialListRequest) -> operations.UpdateSipCredentialListResponse:
        ...
        res = operations.UpdateSipCredentialListResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountSipSipCredentialList])
                res.responses[r.status_code][content_type] = operations.UpdateSipCredentialListResponses(api_v2010_account_sip_sip_credential_list=out)
    ...
    def update_sip_domain(self, request: operations.UpdateSipDomainRequest) -> operations.UpdateSipDomainResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountSipSipDomain])
                res.responses[r.status_code][content_type] = operations.UpdateSipDomainResponses(api_v2010_account_sip_sip_domain=out)
    ...
    def update_sip_ip_access_control_list(self, request: operations.UpdateSipIPAccessControlListRequest) -> operations.UpdateSipIPAccessControlListResponse:
        ...
        res = operations.UpdateSipIPAccessControlListResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountSipSipIPAccessControlList])
                res.responses[r.status_code][content_type] = operations.UpdateSipIPAccessControlListResponses(api_v2010_account_sip_sip_ip_access_control_list=out)
    ...
    def update_sip_ip_address(self, request: operations.UpdateSipIPAddressRequest) -> operations.UpdateSipIPAddressResponse:
        ...
        res = operations.UpdateSipIPAddressResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountSipSipIPAccessControlListSipIPAddress])
                res.responses[r.status_code][content_type] = operations.UpdateSipIPAddressResponses(api_v2010_account_sip_sip_ip_access_control_list_sip_ip_address=out)
    ...
    def update_siprec(self, request: operations.UpdateSiprecRequest) -> operations.UpdateSiprecResponse:
        ...
        res = operations.UpdateSiprecResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountCallSiprec])
                res.responses[r.status_code][content_type] = operations.UpdateSiprecResponses(api_v2010_account_call_siprec=out)
    ...
    def update_stream(self, request: operations.UpdateStreamRequest) -> operations.UpdateStreamResponse:
        ...
        res = operations.UpdateStreamResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountCallStream])
                res.responses[r.status_code][content_type] = operations.UpdateStreamResponses(api_v2010_account_call_stream=out)
    ...
    def update_usage_trigger(self, request: operations.UpdateUsageTriggerRequest) -> operations.UpdateUsageTriggerResponse:
        ...
        res = operations.UpdateUsageTriggerResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.APIV2010AccountUsageUsageTrigger])
                res.responses[r.status_code][content_type] = operations.UpdateUsageTriggerResponses(api_v2010_account_usage_usage_trigger=out)
