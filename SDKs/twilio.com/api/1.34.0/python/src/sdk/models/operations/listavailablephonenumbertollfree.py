...
class ListAvailablePhoneNumberTollFreeRequest:
    ...
    path_params: ListAvailablePhoneNumberTollFreePathParams = field(default=None)
    query_params: ListAvailablePhoneNumberTollFreeQueryParams = field(default=None)
    security: ListAvailablePhoneNumberTollFreeSecurity = field(default=None)
...
@dataclass
class ListAvailablePhoneNumberTollFreeResponses:
...
class ListAvailablePhoneNumberTollFreeResponse:
    ...
    responses: dict[int, dict[str, ListAvailablePhoneNumberTollFreeResponses]] = field(default=None)
