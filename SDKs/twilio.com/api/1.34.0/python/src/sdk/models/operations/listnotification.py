...
class ListNotificationRequest:
    ...
    path_params: ListNotificationPathParams = field(default=None)
    query_params: ListNotificationQueryParams = field(default=None)
    security: ListNotificationSecurity = field(default=None)
    

@dataclass_json
@dataclass
class ListNotification200ApplicationJSONListNotificationResponse:
    ...
    notifications: Optional[List[shared.APIV2010AccountNotification]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'notifications' }})
...
class ListNotificationResponses:
    list_notification_response: Optional[ListNotification200ApplicationJSONListNotificationResponse] = field(default=None)
    

@dataclass
class ListNotificationResponse:
    content_type: str = field(default=None)
    responses: dict[int, dict[str, ListNotificationResponses]] = field(default=None)
