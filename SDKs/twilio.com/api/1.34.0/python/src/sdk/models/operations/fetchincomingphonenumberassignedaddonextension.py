...
@dataclass
class FetchIncomingPhoneNumberAssignedAddOnExtensionResponses:
...
class FetchIncomingPhoneNumberAssignedAddOnExtensionResponse:
    ...
    responses: dict[int, dict[str, FetchIncomingPhoneNumberAssignedAddOnExtensionResponses]] = field(default=None)
