...
class APIV2010AccountConferenceConferenceRecording:
    ...
    source: Optional[shared.ConferenceRecordingEnumSourceEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'source' }})
    start_time: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'start_time' }})
    status: Optional[shared.ConferenceRecordingEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
