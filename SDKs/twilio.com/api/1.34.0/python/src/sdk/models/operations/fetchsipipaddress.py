...
class FetchSipIPAddressRequest:
    ...
    path_params: FetchSipIPAddressPathParams = field(default=None)
    security: FetchSipIPAddressSecurity = field(default=None)
    

@dataclass
class FetchSipIPAddressResponses:
...
class FetchSipIPAddressResponse:
    ...
    responses: dict[int, dict[str, FetchSipIPAddressResponses]] = field(default=None)
