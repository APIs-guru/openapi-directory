...
class APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal:
    ...
    address_requirements: Optional[shared.IncomingPhoneNumberLocalEnumAddressRequirementEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'address_requirements' }})
    ...
    emergency_address_status: Optional[shared.IncomingPhoneNumberLocalEnumEmergencyAddressStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'emergency_address_status' }})
    emergency_status: Optional[shared.IncomingPhoneNumberLocalEnumEmergencyStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'emergency_status' }})
    ...
    voice_receive_mode: Optional[shared.IncomingPhoneNumberLocalEnumVoiceReceiveModeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'voice_receive_mode' }})
