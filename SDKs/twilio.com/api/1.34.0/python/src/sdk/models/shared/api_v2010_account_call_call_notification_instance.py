...
class APIV2010AccountCallCallNotificationInstance:
    ...
    request_method: Optional[APIV2010AccountCallCallNotificationInstanceRequestMethodEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'request_method' }})
