...
class APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile:
    ...
    address_requirements: Optional[shared.IncomingPhoneNumberMobileEnumAddressRequirementEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'address_requirements' }})
    ...
    emergency_address_status: Optional[shared.IncomingPhoneNumberMobileEnumEmergencyAddressStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'emergency_address_status' }})
    emergency_status: Optional[shared.IncomingPhoneNumberMobileEnumEmergencyStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'emergency_status' }})
    ...
    voice_receive_mode: Optional[shared.IncomingPhoneNumberMobileEnumVoiceReceiveModeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'voice_receive_mode' }})
