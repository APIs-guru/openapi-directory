...
class ListAuthorizedConnectAppRequest:
    ...
    path_params: ListAuthorizedConnectAppPathParams = field(default=None)
    query_params: ListAuthorizedConnectAppQueryParams = field(default=None)
    security: ListAuthorizedConnectAppSecurity = field(default=None)
...
@dataclass
class ListAuthorizedConnectAppResponses:
...
class ListAuthorizedConnectAppResponse:
    ...
    responses: dict[int, dict[str, ListAuthorizedConnectAppResponses]] = field(default=None)
