...
class ListIncomingPhoneNumberRequest:
    ...
    path_params: ListIncomingPhoneNumberPathParams = field(default=None)
    query_params: ListIncomingPhoneNumberQueryParams = field(default=None)
    security: ListIncomingPhoneNumberSecurity = field(default=None)
...
@dataclass
class ListIncomingPhoneNumberResponses:
...
class ListIncomingPhoneNumberResponse:
    ...
    responses: dict[int, dict[str, ListIncomingPhoneNumberResponses]] = field(default=None)
