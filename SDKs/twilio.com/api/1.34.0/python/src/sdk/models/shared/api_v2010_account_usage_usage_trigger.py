...
class APIV2010AccountUsageUsageTrigger:
    ...
    recurring: Optional[shared.UsageTriggerEnumRecurringEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'recurring' }})
    sid: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'sid' }})
    trigger_by: Optional[shared.UsageTriggerEnumTriggerFieldEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'trigger_by' }})
    trigger_value: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'trigger_value' }})
    uri: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'uri' }})
    usage_category: Optional[shared.UsageTriggerEnumUsageCategoryEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'usage_category' }})
