...
@dataclass
class CreateSipAuthRegistrationsCredentialListMappingResponses:
...
class CreateSipAuthRegistrationsCredentialListMappingResponse:
    ...
    responses: dict[int, dict[str, CreateSipAuthRegistrationsCredentialListMappingResponses]] = field(default=None)
