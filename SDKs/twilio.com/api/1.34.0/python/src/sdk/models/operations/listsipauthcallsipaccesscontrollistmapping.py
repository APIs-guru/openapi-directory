...
@dataclass
class ListSipAuthCallsIPAccessControlListMappingResponses:
...
class ListSipAuthCallsIPAccessControlListMappingResponse:
    ...
    responses: dict[int, dict[str, ListSipAuthCallsIPAccessControlListMappingResponses]] = field(default=None)
