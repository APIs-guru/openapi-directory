...
@dataclass
class ListSipAuthRegistrationsCredentialListMappingResponses:
...
class ListSipAuthRegistrationsCredentialListMappingResponse:
    ...
    responses: dict[int, dict[str, ListSipAuthRegistrationsCredentialListMappingResponses]] = field(default=None)
