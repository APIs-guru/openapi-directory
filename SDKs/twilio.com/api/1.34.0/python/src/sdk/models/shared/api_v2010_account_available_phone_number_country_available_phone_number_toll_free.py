...
class APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberTollFree:
    ...
    capabilities: Optional[APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberTollFreeCapabilities] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'capabilities' }})
