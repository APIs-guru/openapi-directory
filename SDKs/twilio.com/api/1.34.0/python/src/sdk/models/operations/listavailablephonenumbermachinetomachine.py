...
class ListAvailablePhoneNumberMachineToMachineRequest:
    ...
    path_params: ListAvailablePhoneNumberMachineToMachinePathParams = field(default=None)
    query_params: ListAvailablePhoneNumberMachineToMachineQueryParams = field(default=None)
    security: ListAvailablePhoneNumberMachineToMachineSecurity = field(default=None)
...
@dataclass
class ListAvailablePhoneNumberMachineToMachineResponses:
...
class ListAvailablePhoneNumberMachineToMachineResponse:
    ...
    responses: dict[int, dict[str, ListAvailablePhoneNumberMachineToMachineResponses]] = field(default=None)
