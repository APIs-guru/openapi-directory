...
@dataclass_json
@dataclass
class ListUsageRecordAllTime200ApplicationJSONListUsageRecordAllTimeResponse:
...
@dataclass
class ListUsageRecordAllTimeResponses:
    list_usage_record_all_time_response: Optional[ListUsageRecordAllTime200ApplicationJSONListUsageRecordAllTimeResponse] = field(default=None)
    

@dataclass
class ListUsageRecordAllTimeResponse:
    content_type: str = field(default=None)
    responses: dict[int, dict[str, ListUsageRecordAllTimeResponses]] = field(default=None)
