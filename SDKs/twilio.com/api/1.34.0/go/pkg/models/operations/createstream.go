...
type CreateStreamRequestBodyStatusCallbackMethodEnum string

const (
	CreateStreamRequestBodyStatusCallbackMethodEnumHead   CreateStreamRequestBodyStatusCallbackMethodEnum = "HEAD"
	CreateStreamRequestBodyStatusCallbackMethodEnumGet    CreateStreamRequestBodyStatusCallbackMethodEnum = "GET"
	CreateStreamRequestBodyStatusCallbackMethodEnumPost   CreateStreamRequestBodyStatusCallbackMethodEnum = "POST"
	CreateStreamRequestBodyStatusCallbackMethodEnumPatch  CreateStreamRequestBodyStatusCallbackMethodEnum = "PATCH"
	CreateStreamRequestBodyStatusCallbackMethodEnumPut    CreateStreamRequestBodyStatusCallbackMethodEnum = "PUT"
	CreateStreamRequestBodyStatusCallbackMethodEnumDelete CreateStreamRequestBodyStatusCallbackMethodEnum = "DELETE"
)

type CreateStreamRequestBodyCreateStreamRequest struct {
	...
	StatusCallbackMethod *CreateStreamRequestBodyStatusCallbackMethodEnum `form:"name=StatusCallbackMethod"`
...
type CreateStreamRequest struct {
	...
	Request    *CreateStreamRequestBodyCreateStreamRequest `request:"mediaType=application/x-www-form-urlencoded"`
