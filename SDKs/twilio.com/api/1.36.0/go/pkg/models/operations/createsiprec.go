...
type CreateSiprecRequestBodyStatusCallbackMethodEnum string

const (
	CreateSiprecRequestBodyStatusCallbackMethodEnumHead   CreateSiprecRequestBodyStatusCallbackMethodEnum = "HEAD"
	CreateSiprecRequestBodyStatusCallbackMethodEnumGet    CreateSiprecRequestBodyStatusCallbackMethodEnum = "GET"
	CreateSiprecRequestBodyStatusCallbackMethodEnumPost   CreateSiprecRequestBodyStatusCallbackMethodEnum = "POST"
	CreateSiprecRequestBodyStatusCallbackMethodEnumPatch  CreateSiprecRequestBodyStatusCallbackMethodEnum = "PATCH"
	CreateSiprecRequestBodyStatusCallbackMethodEnumPut    CreateSiprecRequestBodyStatusCallbackMethodEnum = "PUT"
	CreateSiprecRequestBodyStatusCallbackMethodEnumDelete CreateSiprecRequestBodyStatusCallbackMethodEnum = "DELETE"
)

type CreateSiprecRequestBodyCreateSiprecRequest struct {
	...
	StatusCallbackMethod *CreateSiprecRequestBodyStatusCallbackMethodEnum `form:"name=StatusCallbackMethod"`
...
type CreateSiprecRequest struct {
	...
	Request    *CreateSiprecRequestBodyCreateSiprecRequest `request:"mediaType=application/x-www-form-urlencoded"`
