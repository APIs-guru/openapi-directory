...
var FetchRecordingPathParams = /** @class */ (function (_super) {
    ...
    ], FetchRecordingPathParams.prototype, "accountSid", void 0);
    __decorate([
...
var FetchRecordingQueryParams = /** @class */ (function (_super) {
    __extends(FetchRecordingQueryParams, _super);
    function FetchRecordingQueryParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "queryParam, style=form;explode=true;name=IncludeSoftDeleted" }),
        __metadata("design:type", Boolean)
    ], FetchRecordingQueryParams.prototype, "includeSoftDeleted", void 0);
    return FetchRecordingQueryParams;
}(SpeakeasyBase));
export { FetchRecordingQueryParams };
...
var FetchRecordingRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        Metadata(),
        __metadata("design:type", FetchRecordingQueryParams)
    ], FetchRecordingRequest.prototype, "queryParams", void 0);
    __decorate([
        Metadata(),
