...
export const LISTAVAILABLEPHONENUMBERMACHINETOMACHINE_SERVERS = [
...
export class ListAvailablePhoneNumberMachineToMachineListAvailablePhoneNumberMachineToMachineResponse extends SpeakeasyBase {
  @Metadata({ data: "json, name=available_phone_numbers", elemType: shared.ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachine })
