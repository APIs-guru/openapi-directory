...
export const LISTAVAILABLEPHONENUMBERNATIONAL_SERVERS = [
...
export class ListAvailablePhoneNumberNationalListAvailablePhoneNumberNationalResponse extends SpeakeasyBase {
  @Metadata({ data: "json, name=available_phone_numbers", elemType: shared.ApiV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberNational })
