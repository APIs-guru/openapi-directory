...
class ListUsageRecordTodayRequest:
    ...
    path_params: ListUsageRecordTodayPathParams = field(default=None)
    query_params: ListUsageRecordTodayQueryParams = field(default=None)
    security: ListUsageRecordTodaySecurity = field(default=None)
    

@dataclass_json
@dataclass
class ListUsageRecordToday200ApplicationJSONListUsageRecordTodayResponse:
    ...
    usage_records: Optional[List[shared.APIV2010AccountUsageUsageRecordUsageRecordToday]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'usage_records' }})
    

@dataclass
class ListUsageRecordTodayResponse:
    content_type: str = field(default=None)
    list_usage_record_today_response: Optional[ListUsageRecordToday200ApplicationJSONListUsageRecordTodayResponse] = field(default=None)
