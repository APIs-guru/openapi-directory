...
from . import usage_record_all_time_enum_category_enum
...
class APIV2010AccountUsageUsageRecordUsageRecordAllTime:
    ...
    category: Optional[usage_record_all_time_enum_category_enum.UsageRecordAllTimeEnumCategoryEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'category' }})
