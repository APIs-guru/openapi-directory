...
class UpdateParticipantRequestBodyAnnounceMethodEnum(str, Enum):
    HEAD = "HEAD"
    GET = "GET"
    POST = "POST"
    PATCH = "PATCH"
...
class UpdateParticipantRequestBodyHoldMethodEnum(str, Enum):
    HEAD = "HEAD"
    GET = "GET"
    POST = "POST"
    PATCH = "PATCH"
...
class UpdateParticipantRequestBodyWaitMethodEnum(str, Enum):
    HEAD = "HEAD"
    GET = "GET"
    POST = "POST"
    PATCH = "PATCH"
...
@dataclass
class UpdateParticipantRequestBodyUpdateParticipantRequest:
    announce_method: Optional[UpdateParticipantRequestBodyAnnounceMethodEnum] = field(default=None, metadata={'form': { 'field_name': 'AnnounceMethod' }})
    ...
    hold_method: Optional[UpdateParticipantRequestBodyHoldMethodEnum] = field(default=None, metadata={'form': { 'field_name': 'HoldMethod' }})
    ...
    wait_method: Optional[UpdateParticipantRequestBodyWaitMethodEnum] = field(default=None, metadata={'form': { 'field_name': 'WaitMethod' }})
...
class UpdateParticipantRequest:
    ...
    request: Optional[UpdateParticipantRequestBodyUpdateParticipantRequest] = field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})
