...
from . import participant_enum_status_enum
...
class APIV2010AccountConferenceParticipant:
    ...
    status: Optional[participant_enum_status_enum.ParticipantEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
