...
class APIV2010AccountNotificationInstance:
    ...
    message_date: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'message_date' }})
    message_text: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'message_text' }})
    more_info: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'more_info' }})
    request_method: Optional[APIV2010AccountNotificationInstanceRequestMethodEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'request_method' }})
