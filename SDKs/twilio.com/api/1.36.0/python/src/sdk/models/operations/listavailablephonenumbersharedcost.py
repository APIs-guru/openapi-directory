...
class ListAvailablePhoneNumberSharedCostRequest:
    ...
    path_params: ListAvailablePhoneNumberSharedCostPathParams = field(default=None)
    query_params: ListAvailablePhoneNumberSharedCostQueryParams = field(default=None)
    security: ListAvailablePhoneNumberSharedCostSecurity = field(default=None)
