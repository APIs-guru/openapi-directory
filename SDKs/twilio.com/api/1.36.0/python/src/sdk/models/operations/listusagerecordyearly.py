...
class ListUsageRecordYearlyRequest:
    ...
    path_params: ListUsageRecordYearlyPathParams = field(default=None)
    query_params: ListUsageRecordYearlyQueryParams = field(default=None)
    security: ListUsageRecordYearlySecurity = field(default=None)
    

@dataclass_json
@dataclass
class ListUsageRecordYearly200ApplicationJSONListUsageRecordYearlyResponse:
    ...
    usage_records: Optional[List[shared.APIV2010AccountUsageUsageRecordUsageRecordYearly]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'usage_records' }})
    

@dataclass
class ListUsageRecordYearlyResponse:
    content_type: str = field(default=None)
    list_usage_record_yearly_response: Optional[ListUsageRecordYearly200ApplicationJSONListUsageRecordYearlyResponse] = field(default=None)
