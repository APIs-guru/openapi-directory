...
from . import authorized_connect_app_enum_permission_enum
...
class APIV2010AccountAuthorizedConnectApp:
    ...
    permissions: Optional[List[authorized_connect_app_enum_permission_enum.AuthorizedConnectAppEnumPermissionEnum]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'permissions' }})
