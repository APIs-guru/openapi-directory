...
from . import message_enum_direction_enum
from . import message_enum_status_enum
...
class APIV2010AccountMessage:
    ...
    direction: Optional[message_enum_direction_enum.MessageEnumDirectionEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'direction' }})
    ...
    status: Optional[message_enum_status_enum.MessageEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
