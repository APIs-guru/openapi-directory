...
from . import usage_record_yesterday_enum_category_enum
...
class APIV2010AccountUsageUsageRecordUsageRecordYesterday:
    ...
    category: Optional[usage_record_yesterday_enum_category_enum.UsageRecordYesterdayEnumCategoryEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'category' }})
