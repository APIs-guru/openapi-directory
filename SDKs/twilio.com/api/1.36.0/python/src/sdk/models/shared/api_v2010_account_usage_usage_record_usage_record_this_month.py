...
from . import usage_record_this_month_enum_category_enum
...
class APIV2010AccountUsageUsageRecordUsageRecordThisMonth:
    ...
    category: Optional[usage_record_this_month_enum_category_enum.UsageRecordThisMonthEnumCategoryEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'category' }})
