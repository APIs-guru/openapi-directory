...
from . import transcription_enum_status_enum
...
class APIV2010AccountTranscription:
    ...
    status: Optional[transcription_enum_status_enum.TranscriptionEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
