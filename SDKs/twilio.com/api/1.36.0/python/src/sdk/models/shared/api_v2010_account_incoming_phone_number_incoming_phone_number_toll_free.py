...
from . import incoming_phone_number_toll_free_enum_address_requirement_enum
from . import incoming_phone_number_toll_free_enum_emergency_address_status_enum
from . import incoming_phone_number_toll_free_enum_emergency_status_enum
from . import incoming_phone_number_toll_free_enum_voice_receive_mode_enum
...
class APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberTollFree:
    ...
    address_requirements: Optional[incoming_phone_number_toll_free_enum_address_requirement_enum.IncomingPhoneNumberTollFreeEnumAddressRequirementEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'address_requirements' }})
    ...
    emergency_address_status: Optional[incoming_phone_number_toll_free_enum_emergency_address_status_enum.IncomingPhoneNumberTollFreeEnumEmergencyAddressStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'emergency_address_status' }})
    emergency_status: Optional[incoming_phone_number_toll_free_enum_emergency_status_enum.IncomingPhoneNumberTollFreeEnumEmergencyStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'emergency_status' }})
    ...
    voice_receive_mode: Optional[incoming_phone_number_toll_free_enum_voice_receive_mode_enum.IncomingPhoneNumberTollFreeEnumVoiceReceiveModeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'voice_receive_mode' }})
