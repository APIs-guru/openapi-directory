...
from . import call_feedback_summary_enum_status_enum
...
class APIV2010AccountCallCallFeedbackSummary:
    ...
    status: Optional[call_feedback_summary_enum_status_enum.CallFeedbackSummaryEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
