...
from . import usage_record_enum_category_enum
...
class APIV2010AccountUsageUsageRecord:
    ...
    category: Optional[usage_record_enum_category_enum.UsageRecordEnumCategoryEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'category' }})
