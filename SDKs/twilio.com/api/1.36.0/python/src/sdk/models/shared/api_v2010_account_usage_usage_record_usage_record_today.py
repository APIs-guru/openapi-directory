...
from . import usage_record_today_enum_category_enum
...
class APIV2010AccountUsageUsageRecordUsageRecordToday:
    ...
    category: Optional[usage_record_today_enum_category_enum.UsageRecordTodayEnumCategoryEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'category' }})
