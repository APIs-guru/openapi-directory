...
from . import call_recording_enum_source_enum
from . import call_recording_enum_status_enum
...
class APIV2010AccountCallCallRecording:
    ...
    source: Optional[call_recording_enum_source_enum.CallRecordingEnumSourceEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'source' }})
    start_time: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'start_time' }})
    status: Optional[call_recording_enum_status_enum.CallRecordingEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
