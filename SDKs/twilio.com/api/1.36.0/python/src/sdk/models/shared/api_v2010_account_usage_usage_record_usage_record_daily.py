...
from . import usage_record_daily_enum_category_enum
...
class APIV2010AccountUsageUsageRecordUsageRecordDaily:
    ...
    category: Optional[usage_record_daily_enum_category_enum.UsageRecordDailyEnumCategoryEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'category' }})
