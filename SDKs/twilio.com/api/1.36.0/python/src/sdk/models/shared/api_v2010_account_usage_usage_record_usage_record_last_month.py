...
from . import usage_record_last_month_enum_category_enum
...
class APIV2010AccountUsageUsageRecordUsageRecordLastMonth:
    ...
    category: Optional[usage_record_last_month_enum_category_enum.UsageRecordLastMonthEnumCategoryEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'category' }})
