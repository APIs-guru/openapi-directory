...
from . import dependent_phone_number_enum_address_requirement_enum
from . import dependent_phone_number_enum_emergency_status_enum
...
class APIV2010AccountAddressDependentPhoneNumber:
    ...
    address_requirements: Optional[dependent_phone_number_enum_address_requirement_enum.DependentPhoneNumberEnumAddressRequirementEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'address_requirements' }})
    ...
    emergency_status: Optional[dependent_phone_number_enum_emergency_status_enum.DependentPhoneNumberEnumEmergencyStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'emergency_status' }})
