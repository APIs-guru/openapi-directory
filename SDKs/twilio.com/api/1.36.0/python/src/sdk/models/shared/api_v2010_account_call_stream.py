...
from . import stream_enum_status_enum
...
class APIV2010AccountCallStream:
    ...
    status: Optional[stream_enum_status_enum.StreamEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
