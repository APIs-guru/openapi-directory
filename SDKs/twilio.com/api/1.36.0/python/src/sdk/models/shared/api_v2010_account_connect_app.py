...
from . import connect_app_enum_permission_enum
...
class APIV2010AccountConnectApp:
    ...
    permissions: Optional[List[connect_app_enum_permission_enum.ConnectAppEnumPermissionEnum]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'permissions' }})
