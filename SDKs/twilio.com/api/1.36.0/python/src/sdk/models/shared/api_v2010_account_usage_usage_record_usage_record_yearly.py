...
from . import usage_record_yearly_enum_category_enum
...
class APIV2010AccountUsageUsageRecordUsageRecordYearly:
    ...
    category: Optional[usage_record_yearly_enum_category_enum.UsageRecordYearlyEnumCategoryEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'category' }})
