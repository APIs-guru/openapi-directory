...
class ListUsageRecordYesterdayListUsageRecordYesterdayResponse:
    ...
    usage_records: Optional[List[shared.APIV2010AccountUsageUsageRecordUsageRecordYesterday]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('usage_records') }})
    

@dataclass
class ListUsageRecordYesterdayRequest:
    path_params: ListUsageRecordYesterdayPathParams = field()
    query_params: ListUsageRecordYesterdayQueryParams = field()
    security: ListUsageRecordYesterdaySecurity = field()
