...
class ListUsageRecordLastMonthListUsageRecordLastMonthResponse:
    ...
    usage_records: Optional[List[shared.APIV2010AccountUsageUsageRecordUsageRecordLastMonth]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('usage_records') }})
    

@dataclass
class ListUsageRecordLastMonthRequest:
    path_params: ListUsageRecordLastMonthPathParams = field()
    query_params: ListUsageRecordLastMonthQueryParams = field()
    security: ListUsageRecordLastMonthSecurity = field()
