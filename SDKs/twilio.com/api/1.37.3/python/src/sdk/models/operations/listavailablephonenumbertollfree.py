...
class ListAvailablePhoneNumberTollFreeListAvailablePhoneNumberTollFreeResponse:
    available_phone_numbers: Optional[List[shared.APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberTollFree]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('available_phone_numbers') }})
...
class ListAvailablePhoneNumberTollFreeRequest:
    path_params: ListAvailablePhoneNumberTollFreePathParams = field()
    query_params: ListAvailablePhoneNumberTollFreeQueryParams = field()
    security: ListAvailablePhoneNumberTollFreeSecurity = field()
