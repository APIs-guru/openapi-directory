...
class ListAvailablePhoneNumberNationalListAvailablePhoneNumberNationalResponse:
    available_phone_numbers: Optional[List[shared.APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberNational]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('available_phone_numbers') }})
...
class ListAvailablePhoneNumberNationalRequest:
    path_params: ListAvailablePhoneNumberNationalPathParams = field()
    query_params: ListAvailablePhoneNumberNationalQueryParams = field()
    security: ListAvailablePhoneNumberNationalSecurity = field()
