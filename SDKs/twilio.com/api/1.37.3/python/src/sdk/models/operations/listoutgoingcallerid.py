...
class ListOutgoingCallerIDListOutgoingCallerIDResponse:
    ...
    outgoing_caller_ids: Optional[List[shared.APIV2010AccountOutgoingCallerID]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('outgoing_caller_ids') }})
...
class ListOutgoingCallerIDRequest:
    path_params: ListOutgoingCallerIDPathParams = field()
    query_params: ListOutgoingCallerIDQueryParams = field()
    security: ListOutgoingCallerIDSecurity = field()
