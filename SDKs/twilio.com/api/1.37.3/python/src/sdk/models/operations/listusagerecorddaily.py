...
class ListUsageRecordDailyListUsageRecordDailyResponse:
    ...
    usage_records: Optional[List[shared.APIV2010AccountUsageUsageRecordUsageRecordDaily]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('usage_records') }})
    

@dataclass
class ListUsageRecordDailyRequest:
    path_params: ListUsageRecordDailyPathParams = field()
    query_params: ListUsageRecordDailyQueryParams = field()
    security: ListUsageRecordDailySecurity = field()
...
class ListUsageRecordDailyResponse:
    ...
    list_usage_record_daily_response: Optional[ListUsageRecordDailyListUsageRecordDailyResponse] = field(default=None)
