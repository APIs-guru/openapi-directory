...
class ListAccountListAccountResponse:
    accounts: Optional[List[shared.APIV2010Account]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('accounts') }})
...
class ListAccountRequest:
    query_params: ListAccountQueryParams = field()
    security: ListAccountSecurity = field()
