...
class APIV2010AccountCallCallNotification:
    ...
    request_method: Optional[APIV2010AccountCallCallNotificationRequestMethodEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('request_method') }})
