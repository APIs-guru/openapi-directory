...
class ListAvailablePhoneNumberSharedCostListAvailablePhoneNumberSharedCostResponse:
    available_phone_numbers: Optional[List[shared.APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberSharedCost]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('available_phone_numbers') }})
...
class ListAvailablePhoneNumberSharedCostRequest:
    path_params: ListAvailablePhoneNumberSharedCostPathParams = field()
    query_params: ListAvailablePhoneNumberSharedCostQueryParams = field()
    security: ListAvailablePhoneNumberSharedCostSecurity = field()
