...
class ListQueueListQueueResponse:
    ...
    queues: Optional[List[shared.APIV2010AccountQueue]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('queues') }})
...
class ListQueueRequest:
    path_params: ListQueuePathParams = field()
    query_params: ListQueueQueryParams = field()
    security: ListQueueSecurity = field()
