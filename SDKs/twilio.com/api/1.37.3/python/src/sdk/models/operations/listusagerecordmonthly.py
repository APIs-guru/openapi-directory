...
class ListUsageRecordMonthlyListUsageRecordMonthlyResponse:
    ...
    usage_records: Optional[List[shared.APIV2010AccountUsageUsageRecordUsageRecordMonthly]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('usage_records') }})
    

@dataclass
class ListUsageRecordMonthlyRequest:
    path_params: ListUsageRecordMonthlyPathParams = field()
    query_params: ListUsageRecordMonthlyQueryParams = field()
    security: ListUsageRecordMonthlySecurity = field()
...
class ListUsageRecordMonthlyResponse:
    ...
    list_usage_record_monthly_response: Optional[ListUsageRecordMonthlyListUsageRecordMonthlyResponse] = field(default=None)
