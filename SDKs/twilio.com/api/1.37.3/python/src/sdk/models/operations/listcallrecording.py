...
class ListCallRecordingListCallRecordingResponse:
    ...
    recordings: Optional[List[shared.APIV2010AccountCallCallRecording]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('recordings') }})
...
class ListCallRecordingRequest:
    path_params: ListCallRecordingPathParams = field()
    query_params: ListCallRecordingQueryParams = field()
    security: ListCallRecordingSecurity = field()
