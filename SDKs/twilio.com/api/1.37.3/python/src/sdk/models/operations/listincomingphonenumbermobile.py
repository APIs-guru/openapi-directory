...
class ListIncomingPhoneNumberMobileListIncomingPhoneNumberMobileResponse:
    ...
    incoming_phone_numbers: Optional[List[shared.APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberMobile]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('incoming_phone_numbers') }})
...
class ListIncomingPhoneNumberMobileRequest:
    path_params: ListIncomingPhoneNumberMobilePathParams = field()
    query_params: ListIncomingPhoneNumberMobileQueryParams = field()
    security: ListIncomingPhoneNumberMobileSecurity = field()
