...
class ListUsageRecordThisMonthListUsageRecordThisMonthResponse:
    ...
    usage_records: Optional[List[shared.APIV2010AccountUsageUsageRecordUsageRecordThisMonth]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('usage_records') }})
    

@dataclass
class ListUsageRecordThisMonthRequest:
    path_params: ListUsageRecordThisMonthPathParams = field()
    query_params: ListUsageRecordThisMonthQueryParams = field()
    security: ListUsageRecordThisMonthSecurity = field()
