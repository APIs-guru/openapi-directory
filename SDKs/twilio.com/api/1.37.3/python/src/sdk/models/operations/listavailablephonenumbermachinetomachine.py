...
class ListAvailablePhoneNumberMachineToMachineListAvailablePhoneNumberMachineToMachineResponse:
    available_phone_numbers: Optional[List[shared.APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberMachineToMachine]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('available_phone_numbers') }})
...
class ListAvailablePhoneNumberMachineToMachineRequest:
    path_params: ListAvailablePhoneNumberMachineToMachinePathParams = field()
    query_params: ListAvailablePhoneNumberMachineToMachineQueryParams = field()
    security: ListAvailablePhoneNumberMachineToMachineSecurity = field()
