...
class ListUsageRecordTodayQueryParams:
    category: Optional[shared.UsageRecordTodayEnumCategoryEnum] = field(default=None, metadata={'query_param': { 'field_name': 'Category', 'style': 'form', 'explode': True }})
...
class ListUsageRecordTodayListUsageRecordTodayResponse:
    ...
    usage_records: Optional[List[shared.APIV2010AccountUsageUsageRecordUsageRecordToday]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('usage_records') }})
    

@dataclass
class ListUsageRecordTodayRequest:
    path_params: ListUsageRecordTodayPathParams = field()
    query_params: ListUsageRecordTodayQueryParams = field()
    security: ListUsageRecordTodaySecurity = field()
...
class ListUsageRecordTodayResponse:
    ...
    list_usage_record_today_response: Optional[ListUsageRecordTodayListUsageRecordTodayResponse] = field(default=None)
