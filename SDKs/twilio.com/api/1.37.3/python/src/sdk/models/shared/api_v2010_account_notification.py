...
class APIV2010AccountNotification:
    ...
    request_method: Optional[APIV2010AccountNotificationRequestMethodEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('request_method') }})
