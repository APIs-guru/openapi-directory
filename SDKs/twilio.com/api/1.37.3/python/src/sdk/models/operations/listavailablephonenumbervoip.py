...
class ListAvailablePhoneNumberVoipListAvailablePhoneNumberVoipResponse:
    available_phone_numbers: Optional[List[shared.APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberVoip]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('available_phone_numbers') }})
...
class ListAvailablePhoneNumberVoipRequest:
    path_params: ListAvailablePhoneNumberVoipPathParams = field()
    query_params: ListAvailablePhoneNumberVoipQueryParams = field()
    security: ListAvailablePhoneNumberVoipSecurity = field()
...
class ListAvailablePhoneNumberVoipResponse:
    ...
    list_available_phone_number_voip_response: Optional[ListAvailablePhoneNumberVoipListAvailablePhoneNumberVoipResponse] = field(default=None)
