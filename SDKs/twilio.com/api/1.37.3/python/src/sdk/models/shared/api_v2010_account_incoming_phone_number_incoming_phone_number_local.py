...
class APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocalCapabilities:
    r"""APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocalCapabilities
...
class APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocal:
    ...
    address_requirements: Optional[IncomingPhoneNumberLocalEnumAddressRequirementEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('address_requirements') }})
    ...
    capabilities: Optional[APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocalCapabilities] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('capabilities') }})
    ...
    emergency_address_status: Optional[IncomingPhoneNumberLocalEnumEmergencyAddressStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('emergency_address_status') }})
    emergency_status: Optional[IncomingPhoneNumberLocalEnumEmergencyStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('emergency_status') }})
    ...
    sms_fallback_method: Optional[APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocalSmsFallbackMethodEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sms_fallback_method') }})
    sms_fallback_url: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sms_fallback_url') }})
    sms_method: Optional[APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocalSmsMethodEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sms_method') }})
    ...
    status_callback_method: Optional[APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocalStatusCallbackMethodEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status_callback_method') }})
    ...
    voice_fallback_method: Optional[APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocalVoiceFallbackMethodEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('voice_fallback_method') }})
    ...
    voice_method: Optional[APIV2010AccountIncomingPhoneNumberIncomingPhoneNumberLocalVoiceMethodEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('voice_method') }})
    voice_receive_mode: Optional[IncomingPhoneNumberLocalEnumVoiceReceiveModeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('voice_receive_mode') }})
