...
class ListIncomingPhoneNumberListIncomingPhoneNumberResponse:
    ...
    incoming_phone_numbers: Optional[List[shared.APIV2010AccountIncomingPhoneNumber]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('incoming_phone_numbers') }})
...
class ListIncomingPhoneNumberRequest:
    path_params: ListIncomingPhoneNumberPathParams = field()
    query_params: ListIncomingPhoneNumberQueryParams = field()
    security: ListIncomingPhoneNumberSecurity = field()
