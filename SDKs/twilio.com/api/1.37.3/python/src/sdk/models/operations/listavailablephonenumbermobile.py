...
class ListAvailablePhoneNumberMobileListAvailablePhoneNumberMobileResponse:
    available_phone_numbers: Optional[List[shared.APIV2010AccountAvailablePhoneNumberCountryAvailablePhoneNumberMobile]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('available_phone_numbers') }})
...
class ListAvailablePhoneNumberMobileRequest:
    path_params: ListAvailablePhoneNumberMobilePathParams = field()
    query_params: ListAvailablePhoneNumberMobileQueryParams = field()
    security: ListAvailablePhoneNumberMobileSecurity = field()
