...
class ListUsageRecordQueryParams:
    category: Optional[shared.UsageRecordEnumCategoryEnum] = field(default=None, metadata={'query_param': { 'field_name': 'Category', 'style': 'form', 'explode': True }})
...
class ListUsageRecordListUsageRecordResponse:
    ...
    usage_records: Optional[List[shared.APIV2010AccountUsageUsageRecord]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('usage_records') }})
