...
from . import flow_revision_enum_status_enum
...
class StudioV2FlowFlowRevision:
    ...
    status: Optional[flow_revision_enum_status_enum.FlowRevisionEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
