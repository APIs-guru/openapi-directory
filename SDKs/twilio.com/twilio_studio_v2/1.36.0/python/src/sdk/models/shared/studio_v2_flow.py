...
from . import flow_enum_status_enum
...
class StudioV2Flow:
    ...
    status: Optional[flow_enum_status_enum.FlowEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
