...
class SDK:
    ...
    def create_execution(self, request: operations.CreateExecutionRequest) -> operations.CreateExecutionResponse:
        ...
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.CreateExecutionResponses(studio_v2_flow_execution=out)
    ...
    def create_flow(self, request: operations.CreateFlowRequest) -> operations.CreateFlowResponse:
        ...
        res = operations.CreateFlowResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.StudioV2Flow])
                res.responses[r.status_code][content_type] = operations.CreateFlowResponses(studio_v2_flow=out)
    ...
    def fetch_execution(self, request: operations.FetchExecutionRequest) -> operations.FetchExecutionResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.StudioV2FlowExecution])
                res.responses[r.status_code][content_type] = operations.FetchExecutionResponses(studio_v2_flow_execution=out)
    ...
    def fetch_execution_context(self, request: operations.FetchExecutionContextRequest) -> operations.FetchExecutionContextResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.FetchExecutionContextResponses(studio_v2_flow_execution_execution_context=out)
    ...
    def fetch_execution_step(self, request: operations.FetchExecutionStepRequest) -> operations.FetchExecutionStepResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.FetchExecutionStepResponses(studio_v2_flow_execution_execution_step=out)
    ...
    def fetch_execution_step_context(self, request: operations.FetchExecutionStepContextRequest) -> operations.FetchExecutionStepContextResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.FetchExecutionStepContextResponses(studio_v2_flow_execution_execution_step_execution_step_context=out)
    ...
    def fetch_flow(self, request: operations.FetchFlowRequest) -> operations.FetchFlowResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.StudioV2Flow])
                res.responses[r.status_code][content_type] = operations.FetchFlowResponses(studio_v2_flow=out)
    ...
    def fetch_flow_revision(self, request: operations.FetchFlowRevisionRequest) -> operations.FetchFlowRevisionResponse:
        ...
        res = operations.FetchFlowRevisionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.StudioV2FlowFlowRevision])
                res.responses[r.status_code][content_type] = operations.FetchFlowRevisionResponses(studio_v2_flow_flow_revision=out)
    ...
    def fetch_test_user(self, request: operations.FetchTestUserRequest) -> operations.FetchTestUserResponse:
        ...
        res = operations.FetchTestUserResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.StudioV2FlowTestUser])
                res.responses[r.status_code][content_type] = operations.FetchTestUserResponses(studio_v2_flow_test_user=out)
    ...
    def list_flow_revision(self, request: operations.ListFlowRevisionRequest) -> operations.ListFlowRevisionResponse:
        ...
        res = operations.ListFlowRevisionResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListFlowRevision200ApplicationJSONListFlowRevisionResponse])
                res.responses[r.status_code][content_type] = operations.ListFlowRevisionResponses(list_flow_revision_response=out)
    ...
    def update_execution(self, request: operations.UpdateExecutionRequest) -> operations.UpdateExecutionResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.StudioV2FlowExecution])
                res.responses[r.status_code][content_type] = operations.UpdateExecutionResponses(studio_v2_flow_execution=out)
    ...
    def update_flow(self, request: operations.UpdateFlowRequest) -> operations.UpdateFlowResponse:
        ...
        res = operations.UpdateFlowResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.StudioV2Flow])
                res.responses[r.status_code][content_type] = operations.UpdateFlowResponses(studio_v2_flow=out)
    ...
    def update_flow_validate(self, request: operations.UpdateFlowValidateRequest) -> operations.UpdateFlowValidateResponse:
        ...
        res = operations.UpdateFlowValidateResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.StudioV2FlowValidate])
                res.responses[r.status_code][content_type] = operations.UpdateFlowValidateResponses(studio_v2_flow_validate=out)
    ...
    def update_test_user(self, request: operations.UpdateTestUserRequest) -> operations.UpdateTestUserResponse:
        ...
        res = operations.UpdateTestUserResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.StudioV2FlowTestUser])
                res.responses[r.status_code][content_type] = operations.UpdateTestUserResponses(studio_v2_flow_test_user=out)
