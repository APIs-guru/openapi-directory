...
class ListChannelWebhookListChannelWebhookResponse:
    ...
    webhooks: Optional[List[shared.IPMessagingV2ServiceChannelChannelWebhook]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('webhooks') }})
