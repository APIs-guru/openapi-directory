...
export class IpMessagingV2Service extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ data: "json, name=post_webhook_retry_count" })
  postWebhookRetryCount?: number;

  @SpeakeasyMetadata({ data: "json, name=post_webhook_url" })
  postWebhookUrl?: string;

  @SpeakeasyMetadata({ data: "json, name=pre_webhook_retry_count" })
