...
from . import user_binding_enum_binding_type_enum
...
class IPMessagingV2ServiceUserUserBinding:
    ...
    binding_type: Optional[user_binding_enum_binding_type_enum.UserBindingEnumBindingTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'binding_type' }})
