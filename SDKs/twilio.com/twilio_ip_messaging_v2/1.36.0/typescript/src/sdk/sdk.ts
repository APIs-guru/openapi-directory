...
export class SDK {
  ...
  CreateChannelWebhook(
    ...
    let baseURL: string = operations.CREATECHANNELWEBHOOK_SERVERS[0];
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.CreateChannelWebhookResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 201:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  DeleteChannelWebhook(
    ...
    let baseURL: string = operations.DELETECHANNELWEBHOOK_SERVERS[0];
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.DeleteChannelWebhookResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 204:
            break;
        }
  ...
  DeleteUserBinding(
    ...
    let baseURL: string = operations.DELETEUSERBINDING_SERVERS[0];
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.DeleteUserBindingResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 204:
            break;
        }
  ...
  DeleteUserChannel(
    ...
    let baseURL: string = operations.DELETEUSERCHANNEL_SERVERS[0];
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.DeleteUserChannelResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 204:
            break;
        }
  ...
  FetchChannelWebhook(
    ...
    let baseURL: string = operations.FETCHCHANNELWEBHOOK_SERVERS[0];
    const url: string = utils.GenerateURL(baseURL, "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Webhooks/{Sid}", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.FetchChannelWebhookResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.ipMessagingV2ServiceChannelChannelWebhook = httpRes?.data;
  ...
  FetchUserBinding(
    ...
    let baseURL: string = operations.FETCHUSERBINDING_SERVERS[0];
    const url: string = utils.GenerateURL(baseURL, "/v2/Services/{ServiceSid}/Users/{UserSid}/Bindings/{Sid}", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.FetchUserBindingResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  FetchUserChannel(
    ...
    let baseURL: string = operations.FETCHUSERCHANNEL_SERVERS[0];
    const url: string = utils.GenerateURL(baseURL, "/v2/Services/{ServiceSid}/Users/{UserSid}/Channels/{ChannelSid}", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.FetchUserChannelResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  ListChannelWebhook(
    ...
    let baseURL: string = operations.LISTCHANNELWEBHOOK_SERVERS[0];
    const url: string = utils.GenerateURL(baseURL, "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Webhooks", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ListChannelWebhookResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  ListUserBinding(
    ...
    let baseURL: string = operations.LISTUSERBINDING_SERVERS[0];
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ListUserBindingResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  UpdateChannelWebhook(
    ...
    let baseURL: string = operations.UPDATECHANNELWEBHOOK_SERVERS[0];
    const url: string = utils.GenerateURL(baseURL, "/v2/Services/{ServiceSid}/Channels/{ChannelSid}/Webhooks/{Sid}", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.UpdateChannelWebhookResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.ipMessagingV2ServiceChannelChannelWebhook = httpRes?.data;
  ...
  UpdateUserChannel(
    ...
    let baseURL: string = operations.UPDATEUSERCHANNEL_SERVERS[0];
    const url: string = utils.GenerateURL(baseURL, "/v2/Services/{ServiceSid}/Users/{UserSid}/Channels/{ChannelSid}", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.UpdateUserChannelResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.ipMessagingV2ServiceUserUserChannel = httpRes?.data;
