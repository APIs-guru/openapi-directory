...
class ListChannel200ApplicationJSONListChannelResponse:
    channels: Optional[List[shared.IPMessagingV2ServiceChannel]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'channels' }})
    meta: Optional[ListChannel200ApplicationJSONMeta] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'meta' }})
    

@dataclass
class ListChannelResponses:
...
class ListChannelResponse:
    ...
    responses: dict[int, dict[str, ListChannelResponses]] = field(default=None)
