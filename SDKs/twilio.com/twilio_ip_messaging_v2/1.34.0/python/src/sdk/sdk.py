...
class SDK:
    ...
    def create_channel(self, request: operations.CreateChannelRequest) -> operations.CreateChannelResponse:
        ...
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.CreateChannelResponses(ip_messaging_v2_service_channel=out)
    ...
    def create_channel_webhook(self, request: operations.CreateChannelWebhookRequest) -> operations.CreateChannelWebhookResponse:
        ...
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.CreateChannelWebhookResponses(ip_messaging_v2_service_channel_channel_webhook=out)
    ...
    def create_credential(self, request: operations.CreateCredentialRequest) -> operations.CreateCredentialResponse:
        ...
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.CreateCredentialResponses(ip_messaging_v2_credential=out)
    ...
    def create_invite(self, request: operations.CreateInviteRequest) -> operations.CreateInviteResponse:
        ...
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.CreateInviteResponses(ip_messaging_v2_service_channel_invite=out)
    ...
    def create_member(self, request: operations.CreateMemberRequest) -> operations.CreateMemberResponse:
        ...
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.CreateMemberResponses(ip_messaging_v2_service_channel_member=out)
    ...
    def create_message(self, request: operations.CreateMessageRequest) -> operations.CreateMessageResponse:
        ...
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.CreateMessageResponses(ip_messaging_v2_service_channel_message=out)
    ...
    def create_role(self, request: operations.CreateRoleRequest) -> operations.CreateRoleResponse:
        ...
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.CreateRoleResponses(ip_messaging_v2_service_role=out)
    ...
    def create_service(self, request: operations.CreateServiceRequest) -> operations.CreateServiceResponse:
        ...
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.CreateServiceResponses(ip_messaging_v2_service=out)
    ...
    def create_user(self, request: operations.CreateUserRequest) -> operations.CreateUserResponse:
        ...
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.CreateUserResponses(ip_messaging_v2_service_user=out)
    ...
    def fetch_binding(self, request: operations.FetchBindingRequest) -> operations.FetchBindingResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.FetchBindingResponses(ip_messaging_v2_service_binding=out)
    ...
    def fetch_channel(self, request: operations.FetchChannelRequest) -> operations.FetchChannelResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.IPMessagingV2ServiceChannel])
                res.responses[r.status_code][content_type] = operations.FetchChannelResponses(ip_messaging_v2_service_channel=out)
    ...
    def fetch_channel_webhook(self, request: operations.FetchChannelWebhookRequest) -> operations.FetchChannelWebhookResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.IPMessagingV2ServiceChannelChannelWebhook])
                res.responses[r.status_code][content_type] = operations.FetchChannelWebhookResponses(ip_messaging_v2_service_channel_channel_webhook=out)
    ...
    def fetch_credential(self, request: operations.FetchCredentialRequest) -> operations.FetchCredentialResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.IPMessagingV2Credential])
                res.responses[r.status_code][content_type] = operations.FetchCredentialResponses(ip_messaging_v2_credential=out)
    ...
    def fetch_invite(self, request: operations.FetchInviteRequest) -> operations.FetchInviteResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.IPMessagingV2ServiceChannelInvite])
                res.responses[r.status_code][content_type] = operations.FetchInviteResponses(ip_messaging_v2_service_channel_invite=out)
    ...
    def fetch_member(self, request: operations.FetchMemberRequest) -> operations.FetchMemberResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.IPMessagingV2ServiceChannelMember])
                res.responses[r.status_code][content_type] = operations.FetchMemberResponses(ip_messaging_v2_service_channel_member=out)
    ...
    def fetch_message(self, request: operations.FetchMessageRequest) -> operations.FetchMessageResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.IPMessagingV2ServiceChannelMessage])
                res.responses[r.status_code][content_type] = operations.FetchMessageResponses(ip_messaging_v2_service_channel_message=out)
    ...
    def fetch_role(self, request: operations.FetchRoleRequest) -> operations.FetchRoleResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.IPMessagingV2ServiceRole])
                res.responses[r.status_code][content_type] = operations.FetchRoleResponses(ip_messaging_v2_service_role=out)
    ...
    def fetch_service(self, request: operations.FetchServiceRequest) -> operations.FetchServiceResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.IPMessagingV2Service])
                res.responses[r.status_code][content_type] = operations.FetchServiceResponses(ip_messaging_v2_service=out)
    ...
    def fetch_user(self, request: operations.FetchUserRequest) -> operations.FetchUserResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.IPMessagingV2ServiceUser])
                res.responses[r.status_code][content_type] = operations.FetchUserResponses(ip_messaging_v2_service_user=out)
    ...
    def fetch_user_binding(self, request: operations.FetchUserBindingRequest) -> operations.FetchUserBindingResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.FetchUserBindingResponses(ip_messaging_v2_service_user_user_binding=out)
    ...
    def fetch_user_channel(self, request: operations.FetchUserChannelRequest) -> operations.FetchUserChannelResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.FetchUserChannelResponses(ip_messaging_v2_service_user_user_channel=out)
    ...
    def update_channel(self, request: operations.UpdateChannelRequest) -> operations.UpdateChannelResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.IPMessagingV2ServiceChannel])
                res.responses[r.status_code][content_type] = operations.UpdateChannelResponses(ip_messaging_v2_service_channel=out)
    ...
    def update_channel_webhook(self, request: operations.UpdateChannelWebhookRequest) -> operations.UpdateChannelWebhookResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.IPMessagingV2ServiceChannelChannelWebhook])
                res.responses[r.status_code][content_type] = operations.UpdateChannelWebhookResponses(ip_messaging_v2_service_channel_channel_webhook=out)
    ...
    def update_credential(self, request: operations.UpdateCredentialRequest) -> operations.UpdateCredentialResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.IPMessagingV2Credential])
                res.responses[r.status_code][content_type] = operations.UpdateCredentialResponses(ip_messaging_v2_credential=out)
    ...
    def update_member(self, request: operations.UpdateMemberRequest) -> operations.UpdateMemberResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.IPMessagingV2ServiceChannelMember])
                res.responses[r.status_code][content_type] = operations.UpdateMemberResponses(ip_messaging_v2_service_channel_member=out)
    ...
    def update_message(self, request: operations.UpdateMessageRequest) -> operations.UpdateMessageResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.IPMessagingV2ServiceChannelMessage])
                res.responses[r.status_code][content_type] = operations.UpdateMessageResponses(ip_messaging_v2_service_channel_message=out)
    ...
    def update_role(self, request: operations.UpdateRoleRequest) -> operations.UpdateRoleResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.IPMessagingV2ServiceRole])
                res.responses[r.status_code][content_type] = operations.UpdateRoleResponses(ip_messaging_v2_service_role=out)
    ...
    def update_service(self, request: operations.UpdateServiceRequest) -> operations.UpdateServiceResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.IPMessagingV2Service])
                res.responses[r.status_code][content_type] = operations.UpdateServiceResponses(ip_messaging_v2_service=out)
    ...
    def update_user(self, request: operations.UpdateUserRequest) -> operations.UpdateUserResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.IPMessagingV2ServiceUser])
                res.responses[r.status_code][content_type] = operations.UpdateUserResponses(ip_messaging_v2_service_user=out)
    ...
    def update_user_channel(self, request: operations.UpdateUserChannelRequest) -> operations.UpdateUserChannelResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.IPMessagingV2ServiceUserUserChannel])
                res.responses[r.status_code][content_type] = operations.UpdateUserChannelResponses(ip_messaging_v2_service_user_user_channel=out)
