...
class ListMediaProcessorListMediaProcessorResponse:
    media_processors: Optional[List[shared.MediaV1MediaProcessor]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('media_processors') }})
    meta: Optional[ListMediaProcessorListMediaProcessorResponseMeta] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    

@dataclass
class ListMediaProcessorRequest:
    query_params: ListMediaProcessorQueryParams = field()
    security: ListMediaProcessorSecurity = field()
