...
from . import media_processor_enum_status_enum
...
class MediaV1MediaProcessor:
    ...
    status: Optional[media_processor_enum_status_enum.MediaProcessorEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
