...
class SDK:
    ...
    def create_media_processor(self, request: operations.CreateMediaProcessorRequest) -> operations.CreateMediaProcessorResponse:
        ...
        res = operations.CreateMediaProcessorResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.MediaV1MediaProcessor])
                res.responses[r.status_code][content_type] = operations.CreateMediaProcessorResponses(media_v1_media_processor=out)
    ...
    def create_player_streamer(self, request: operations.CreatePlayerStreamerRequest) -> operations.CreatePlayerStreamerResponse:
        ...
        res = operations.CreatePlayerStreamerResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.MediaV1PlayerStreamer])
                res.responses[r.status_code][content_type] = operations.CreatePlayerStreamerResponses(media_v1_player_streamer=out)
    ...
    def create_player_streamer_playback_grant(self, request: operations.CreatePlayerStreamerPlaybackGrantRequest) -> operations.CreatePlayerStreamerPlaybackGrantResponse:
        ...
        res = operations.CreatePlayerStreamerPlaybackGrantResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.MediaV1PlayerStreamerPlayerStreamerPlaybackGrant])
                res.responses[r.status_code][content_type] = operations.CreatePlayerStreamerPlaybackGrantResponses(media_v1_player_streamer_player_streamer_playback_grant=out)
    ...
    def fetch_media_processor(self, request: operations.FetchMediaProcessorRequest) -> operations.FetchMediaProcessorResponse:
        ...
        res = operations.FetchMediaProcessorResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.MediaV1MediaProcessor])
                res.responses[r.status_code][content_type] = operations.FetchMediaProcessorResponses(media_v1_media_processor=out)
    ...
    def fetch_media_recording(self, request: operations.FetchMediaRecordingRequest) -> operations.FetchMediaRecordingResponse:
        ...
        res = operations.FetchMediaRecordingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.MediaV1MediaRecording])
                res.responses[r.status_code][content_type] = operations.FetchMediaRecordingResponses(media_v1_media_recording=out)
    ...
    def fetch_player_streamer(self, request: operations.FetchPlayerStreamerRequest) -> operations.FetchPlayerStreamerResponse:
        ...
        res = operations.FetchPlayerStreamerResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.MediaV1PlayerStreamer])
                res.responses[r.status_code][content_type] = operations.FetchPlayerStreamerResponses(media_v1_player_streamer=out)
    ...
    def fetch_player_streamer_playback_grant(self, request: operations.FetchPlayerStreamerPlaybackGrantRequest) -> operations.FetchPlayerStreamerPlaybackGrantResponse:
        ...
        res = operations.FetchPlayerStreamerPlaybackGrantResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.MediaV1PlayerStreamerPlayerStreamerPlaybackGrant])
                res.responses[r.status_code][content_type] = operations.FetchPlayerStreamerPlaybackGrantResponses(media_v1_player_streamer_player_streamer_playback_grant=out)
    ...
    def list_media_processor(self, request: operations.ListMediaProcessorRequest) -> operations.ListMediaProcessorResponse:
        ...
        res = operations.ListMediaProcessorResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListMediaProcessor200ApplicationJSONListMediaProcessorResponse])
                res.responses[r.status_code][content_type] = operations.ListMediaProcessorResponses(list_media_processor_response=out)
    ...
    def list_media_recording(self, request: operations.ListMediaRecordingRequest) -> operations.ListMediaRecordingResponse:
        ...
        res = operations.ListMediaRecordingResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListMediaRecording200ApplicationJSONListMediaRecordingResponse])
                res.responses[r.status_code][content_type] = operations.ListMediaRecordingResponses(list_media_recording_response=out)
    ...
    def list_player_streamer(self, request: operations.ListPlayerStreamerRequest) -> operations.ListPlayerStreamerResponse:
        ...
        res = operations.ListPlayerStreamerResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListPlayerStreamer200ApplicationJSONListPlayerStreamerResponse])
                res.responses[r.status_code][content_type] = operations.ListPlayerStreamerResponses(list_player_streamer_response=out)
    ...
    def update_media_processor(self, request: operations.UpdateMediaProcessorRequest) -> operations.UpdateMediaProcessorResponse:
        ...
        res = operations.UpdateMediaProcessorResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.MediaV1MediaProcessor])
                res.responses[r.status_code][content_type] = operations.UpdateMediaProcessorResponses(media_v1_media_processor=out)
    ...
    def update_player_streamer(self, request: operations.UpdatePlayerStreamerRequest) -> operations.UpdatePlayerStreamerResponse:
        ...
        res = operations.UpdatePlayerStreamerResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.MediaV1PlayerStreamer])
                res.responses[r.status_code][content_type] = operations.UpdatePlayerStreamerResponses(media_v1_player_streamer=out)
