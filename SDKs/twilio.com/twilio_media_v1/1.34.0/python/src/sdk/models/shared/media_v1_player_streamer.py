...
class MediaV1PlayerStreamer:
    ...
    ended_reason: Optional[shared.PlayerStreamerEnumEndedReasonEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ended_reason' }})
    ...
    status: Optional[shared.PlayerStreamerEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
