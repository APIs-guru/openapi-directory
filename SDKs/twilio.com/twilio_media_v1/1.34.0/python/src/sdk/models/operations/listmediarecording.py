...
class ListMediaRecordingRequest:
    ...
    query_params: ListMediaRecordingQueryParams = field(default=None)
    security: ListMediaRecordingSecurity = field(default=None)
...
@dataclass
class ListMediaRecordingResponses:
...
class ListMediaRecordingResponse:
    ...
    responses: dict[int, dict[str, ListMediaRecordingResponses]] = field(default=None)
