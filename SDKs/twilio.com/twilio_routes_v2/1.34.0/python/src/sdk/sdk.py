...
class SDK:
    ...
    def fetch_phone_number(self, request: operations.FetchPhoneNumberRequest) -> operations.FetchPhoneNumberResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.FetchPhoneNumberResponses(routes_v2_phone_number=out)
    ...
    def fetch_sip_domain(self, request: operations.FetchSipDomainRequest) -> operations.FetchSipDomainResponse:
        ...
        res = operations.FetchSipDomainResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.RoutesV2SipDomain])
                res.responses[r.status_code][content_type] = operations.FetchSipDomainResponses(routes_v2_sip_domain=out)
    ...
    def fetch_trunks(self, request: operations.FetchTrunksRequest) -> operations.FetchTrunksResponse:
        ...
        res = operations.FetchTrunksResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.RoutesV2Trunks])
                res.responses[r.status_code][content_type] = operations.FetchTrunksResponses(routes_v2_trunks=out)
    ...
    def update_phone_number(self, request: operations.UpdatePhoneNumberRequest) -> operations.UpdatePhoneNumberResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.RoutesV2PhoneNumber])
                res.responses[r.status_code][content_type] = operations.UpdatePhoneNumberResponses(routes_v2_phone_number=out)
    ...
    def update_sip_domain(self, request: operations.UpdateSipDomainRequest) -> operations.UpdateSipDomainResponse:
        ...
        res = operations.UpdateSipDomainResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.RoutesV2SipDomain])
                res.responses[r.status_code][content_type] = operations.UpdateSipDomainResponses(routes_v2_sip_domain=out)
    ...
    def update_trunks(self, request: operations.UpdateTrunksRequest) -> operations.UpdateTrunksResponse:
        ...
        res = operations.UpdateTrunksResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.RoutesV2Trunks])
                res.responses[r.status_code][content_type] = operations.UpdateTrunksResponses(routes_v2_trunks=out)
