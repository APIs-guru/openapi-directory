...
class VerifyV2ServiceEntityChallenge:
    ...
    factor_type: Optional[shared.ChallengeEnumFactorTypesEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'factor_type' }})
    ...
    responded_reason: Optional[shared.ChallengeEnumChallengeReasonsEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'responded_reason' }})
    service_sid: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'service_sid' }})
    sid: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'sid' }})
    status: Optional[shared.ChallengeEnumChallengeStatusesEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
