...
class VerifyV2ServiceEntityFactor:
    ...
    factor_type: Optional[shared.FactorEnumFactorTypesEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'factor_type' }})
    ...
    status: Optional[shared.FactorEnumFactorStatusesEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
