...
class VerifyV2ServiceEntityNewFactor:
    ...
    factor_type: Optional[shared.NewFactorEnumFactorTypesEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'factor_type' }})
    ...
    status: Optional[shared.NewFactorEnumFactorStatusesEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
