...
from . import verification_enum_channel_enum
...
class VerifyV2ServiceVerification:
    ...
    channel: Optional[verification_enum_channel_enum.VerificationEnumChannelEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'channel' }})
