...
from . import access_token_enum_factor_types_enum
...
class VerifyV2ServiceAccessToken:
    ...
    factor_type: Optional[access_token_enum_factor_types_enum.AccessTokenEnumFactorTypesEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'factor_type' }})
