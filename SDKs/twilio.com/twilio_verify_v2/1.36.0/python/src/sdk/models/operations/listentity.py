...
class ListEntityRequest:
    ...
    path_params: ListEntityPathParams = field(default=None)
    query_params: ListEntityQueryParams = field(default=None)
    security: ListEntitySecurity = field(default=None)
