...
class VerifyV2ServiceEntityNewFactor:
    ...
    binding: Optional[Any] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('binding') }})
    ...
    factor_type: Optional[NewFactorEnumFactorTypesEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('factor_type') }})
    ...
    status: Optional[NewFactorEnumFactorStatusesEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
