...
from . import task_queue_enum_task_order_enum
...
class TaskrouterV1WorkspaceTaskQueue:
    ...
    task_order: Optional[task_queue_enum_task_order_enum.TaskQueueEnumTaskOrderEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'task_order' }})
