...
class FetchWorkflowRealTimeStatisticsRequest:
    ...
    path_params: FetchWorkflowRealTimeStatisticsPathParams = field(default=None)
    query_params: FetchWorkflowRealTimeStatisticsQueryParams = field(default=None)
    security: FetchWorkflowRealTimeStatisticsSecurity = field(default=None)
