...
class TaskrouterV1WorkspaceEvent:
    ...
    actor_url: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'actor_url' }})
    ...
    event_date_ms: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'event_date_ms' }})
