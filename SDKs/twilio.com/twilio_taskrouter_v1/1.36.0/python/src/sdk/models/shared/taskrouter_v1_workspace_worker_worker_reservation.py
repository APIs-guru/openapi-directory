...
from . import worker_reservation_enum_status_enum
...
class TaskrouterV1WorkspaceWorkerWorkerReservation:
    ...
    reservation_status: Optional[worker_reservation_enum_status_enum.WorkerReservationEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'reservation_status' }})
