...
from . import workspace_enum_queue_order_enum
...
class TaskrouterV1Workspace:
    ...
    prioritize_queue_order: Optional[workspace_enum_queue_order_enum.WorkspaceEnumQueueOrderEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'prioritize_queue_order' }})
