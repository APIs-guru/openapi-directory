...
class SDK:
    ...
    def create_activity(self, request: operations.CreateActivityRequest) -> operations.CreateActivityResponse:
        ...
        res = operations.CreateActivityResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceActivity])
                res.responses[r.status_code][content_type] = operations.CreateActivityResponses(taskrouter_v1_workspace_activity=out)
    ...
    def create_task(self, request: operations.CreateTaskRequest) -> operations.CreateTaskResponse:
        ...
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.CreateTaskResponses(taskrouter_v1_workspace_task=out)
    ...
    def create_task_channel(self, request: operations.CreateTaskChannelRequest) -> operations.CreateTaskChannelResponse:
        ...
        res = operations.CreateTaskChannelResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceTaskChannel])
                res.responses[r.status_code][content_type] = operations.CreateTaskChannelResponses(taskrouter_v1_workspace_task_channel=out)
    ...
    def create_task_queue(self, request: operations.CreateTaskQueueRequest) -> operations.CreateTaskQueueResponse:
        ...
        res = operations.CreateTaskQueueResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceTaskQueue])
                res.responses[r.status_code][content_type] = operations.CreateTaskQueueResponses(taskrouter_v1_workspace_task_queue=out)
    ...
    def create_worker(self, request: operations.CreateWorkerRequest) -> operations.CreateWorkerResponse:
        ...
        res = operations.CreateWorkerResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceWorker])
                res.responses[r.status_code][content_type] = operations.CreateWorkerResponses(taskrouter_v1_workspace_worker=out)
    ...
    def create_workflow(self, request: operations.CreateWorkflowRequest) -> operations.CreateWorkflowResponse:
        ...
        res = operations.CreateWorkflowResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceWorkflow])
                res.responses[r.status_code][content_type] = operations.CreateWorkflowResponses(taskrouter_v1_workspace_workflow=out)
    ...
    def create_workspace(self, request: operations.CreateWorkspaceRequest) -> operations.CreateWorkspaceResponse:
        ...
        res = operations.CreateWorkspaceResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1Workspace])
                res.responses[r.status_code][content_type] = operations.CreateWorkspaceResponses(taskrouter_v1_workspace=out)
    ...
    def fetch_activity(self, request: operations.FetchActivityRequest) -> operations.FetchActivityResponse:
        ...
        res = operations.FetchActivityResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceActivity])
                res.responses[r.status_code][content_type] = operations.FetchActivityResponses(taskrouter_v1_workspace_activity=out)
    ...
    def fetch_event(self, request: operations.FetchEventRequest) -> operations.FetchEventResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.FetchEventResponses(taskrouter_v1_workspace_event=out)
    ...
    def fetch_task(self, request: operations.FetchTaskRequest) -> operations.FetchTaskResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceTask])
                res.responses[r.status_code][content_type] = operations.FetchTaskResponses(taskrouter_v1_workspace_task=out)
    ...
    def fetch_task_channel(self, request: operations.FetchTaskChannelRequest) -> operations.FetchTaskChannelResponse:
        ...
        res = operations.FetchTaskChannelResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceTaskChannel])
                res.responses[r.status_code][content_type] = operations.FetchTaskChannelResponses(taskrouter_v1_workspace_task_channel=out)
    ...
    def fetch_task_queue(self, request: operations.FetchTaskQueueRequest) -> operations.FetchTaskQueueResponse:
        ...
        res = operations.FetchTaskQueueResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceTaskQueue])
                res.responses[r.status_code][content_type] = operations.FetchTaskQueueResponses(taskrouter_v1_workspace_task_queue=out)
    ...
    def fetch_task_queue_cumulative_statistics(self, request: operations.FetchTaskQueueCumulativeStatisticsRequest) -> operations.FetchTaskQueueCumulativeStatisticsResponse:
        ...
        res = operations.FetchTaskQueueCumulativeStatisticsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceTaskQueueTaskQueueCumulativeStatistics])
                res.responses[r.status_code][content_type] = operations.FetchTaskQueueCumulativeStatisticsResponses(taskrouter_v1_workspace_task_queue_task_queue_cumulative_statistics=out)
    ...
    def fetch_task_queue_real_time_statistics(self, request: operations.FetchTaskQueueRealTimeStatisticsRequest) -> operations.FetchTaskQueueRealTimeStatisticsResponse:
        ...
        res = operations.FetchTaskQueueRealTimeStatisticsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceTaskQueueTaskQueueRealTimeStatistics])
                res.responses[r.status_code][content_type] = operations.FetchTaskQueueRealTimeStatisticsResponses(taskrouter_v1_workspace_task_queue_task_queue_real_time_statistics=out)
    ...
    def fetch_task_queue_statistics(self, request: operations.FetchTaskQueueStatisticsRequest) -> operations.FetchTaskQueueStatisticsResponse:
        ...
        res = operations.FetchTaskQueueStatisticsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceTaskQueueTaskQueueStatistics])
                res.responses[r.status_code][content_type] = operations.FetchTaskQueueStatisticsResponses(taskrouter_v1_workspace_task_queue_task_queue_statistics=out)
    ...
    def fetch_task_reservation(self, request: operations.FetchTaskReservationRequest) -> operations.FetchTaskReservationResponse:
        ...
        res = operations.FetchTaskReservationResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceTaskTaskReservation])
                res.responses[r.status_code][content_type] = operations.FetchTaskReservationResponses(taskrouter_v1_workspace_task_task_reservation=out)
    ...
    def fetch_worker(self, request: operations.FetchWorkerRequest) -> operations.FetchWorkerResponse:
        ...
        res = operations.FetchWorkerResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceWorker])
                res.responses[r.status_code][content_type] = operations.FetchWorkerResponses(taskrouter_v1_workspace_worker=out)
    ...
    def fetch_worker_channel(self, request: operations.FetchWorkerChannelRequest) -> operations.FetchWorkerChannelResponse:
        ...
        res = operations.FetchWorkerChannelResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceWorkerWorkerChannel])
                res.responses[r.status_code][content_type] = operations.FetchWorkerChannelResponses(taskrouter_v1_workspace_worker_worker_channel=out)
    ...
    def fetch_worker_instance_statistics(self, request: operations.FetchWorkerInstanceStatisticsRequest) -> operations.FetchWorkerInstanceStatisticsResponse:
        ...
        res = operations.FetchWorkerInstanceStatisticsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceWorkerWorkerInstanceStatistics])
                res.responses[r.status_code][content_type] = operations.FetchWorkerInstanceStatisticsResponses(taskrouter_v1_workspace_worker_worker_instance_statistics=out)
    ...
    def fetch_worker_reservation(self, request: operations.FetchWorkerReservationRequest) -> operations.FetchWorkerReservationResponse:
        ...
        res = operations.FetchWorkerReservationResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceWorkerWorkerReservation])
                res.responses[r.status_code][content_type] = operations.FetchWorkerReservationResponses(taskrouter_v1_workspace_worker_worker_reservation=out)
    ...
    def fetch_worker_statistics(self, request: operations.FetchWorkerStatisticsRequest) -> operations.FetchWorkerStatisticsResponse:
        ...
        res = operations.FetchWorkerStatisticsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceWorkerWorkerStatistics])
                res.responses[r.status_code][content_type] = operations.FetchWorkerStatisticsResponses(taskrouter_v1_workspace_worker_worker_statistics=out)
    ...
    def fetch_workers_cumulative_statistics(self, request: operations.FetchWorkersCumulativeStatisticsRequest) -> operations.FetchWorkersCumulativeStatisticsResponse:
        ...
        res = operations.FetchWorkersCumulativeStatisticsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceWorkerWorkersCumulativeStatistics])
                res.responses[r.status_code][content_type] = operations.FetchWorkersCumulativeStatisticsResponses(taskrouter_v1_workspace_worker_workers_cumulative_statistics=out)
    ...
    def fetch_workers_real_time_statistics(self, request: operations.FetchWorkersRealTimeStatisticsRequest) -> operations.FetchWorkersRealTimeStatisticsResponse:
        ...
        res = operations.FetchWorkersRealTimeStatisticsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceWorkerWorkersRealTimeStatistics])
                res.responses[r.status_code][content_type] = operations.FetchWorkersRealTimeStatisticsResponses(taskrouter_v1_workspace_worker_workers_real_time_statistics=out)
    ...
    def fetch_workflow(self, request: operations.FetchWorkflowRequest) -> operations.FetchWorkflowResponse:
        ...
        res = operations.FetchWorkflowResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceWorkflow])
                res.responses[r.status_code][content_type] = operations.FetchWorkflowResponses(taskrouter_v1_workspace_workflow=out)
    ...
    def fetch_workflow_cumulative_statistics(self, request: operations.FetchWorkflowCumulativeStatisticsRequest) -> operations.FetchWorkflowCumulativeStatisticsResponse:
        ...
        res = operations.FetchWorkflowCumulativeStatisticsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceWorkflowWorkflowCumulativeStatistics])
                res.responses[r.status_code][content_type] = operations.FetchWorkflowCumulativeStatisticsResponses(taskrouter_v1_workspace_workflow_workflow_cumulative_statistics=out)
    ...
    def fetch_workflow_real_time_statistics(self, request: operations.FetchWorkflowRealTimeStatisticsRequest) -> operations.FetchWorkflowRealTimeStatisticsResponse:
        ...
        res = operations.FetchWorkflowRealTimeStatisticsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceWorkflowWorkflowRealTimeStatistics])
                res.responses[r.status_code][content_type] = operations.FetchWorkflowRealTimeStatisticsResponses(taskrouter_v1_workspace_workflow_workflow_real_time_statistics=out)
    ...
    def fetch_workflow_statistics(self, request: operations.FetchWorkflowStatisticsRequest) -> operations.FetchWorkflowStatisticsResponse:
        ...
        res = operations.FetchWorkflowStatisticsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceWorkflowWorkflowStatistics])
                res.responses[r.status_code][content_type] = operations.FetchWorkflowStatisticsResponses(taskrouter_v1_workspace_workflow_workflow_statistics=out)
    ...
    def fetch_workspace(self, request: operations.FetchWorkspaceRequest) -> operations.FetchWorkspaceResponse:
        ...
        res = operations.FetchWorkspaceResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1Workspace])
                res.responses[r.status_code][content_type] = operations.FetchWorkspaceResponses(taskrouter_v1_workspace=out)
    ...
    def fetch_workspace_cumulative_statistics(self, request: operations.FetchWorkspaceCumulativeStatisticsRequest) -> operations.FetchWorkspaceCumulativeStatisticsResponse:
        ...
        res = operations.FetchWorkspaceCumulativeStatisticsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceWorkspaceCumulativeStatistics])
                res.responses[r.status_code][content_type] = operations.FetchWorkspaceCumulativeStatisticsResponses(taskrouter_v1_workspace_workspace_cumulative_statistics=out)
    ...
    def fetch_workspace_real_time_statistics(self, request: operations.FetchWorkspaceRealTimeStatisticsRequest) -> operations.FetchWorkspaceRealTimeStatisticsResponse:
        ...
        res = operations.FetchWorkspaceRealTimeStatisticsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceWorkspaceRealTimeStatistics])
                res.responses[r.status_code][content_type] = operations.FetchWorkspaceRealTimeStatisticsResponses(taskrouter_v1_workspace_workspace_real_time_statistics=out)
    ...
    def fetch_workspace_statistics(self, request: operations.FetchWorkspaceStatisticsRequest) -> operations.FetchWorkspaceStatisticsResponse:
        ...
        res = operations.FetchWorkspaceStatisticsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceWorkspaceStatistics])
                res.responses[r.status_code][content_type] = operations.FetchWorkspaceStatisticsResponses(taskrouter_v1_workspace_workspace_statistics=out)
    ...
    def list_activity(self, request: operations.ListActivityRequest) -> operations.ListActivityResponse:
        ...
        res = operations.ListActivityResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListActivity200ApplicationJSONListActivityResponse])
                res.responses[r.status_code][content_type] = operations.ListActivityResponses(list_activity_response=out)
    ...
    def list_task_channel(self, request: operations.ListTaskChannelRequest) -> operations.ListTaskChannelResponse:
        ...
        res = operations.ListTaskChannelResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListTaskChannel200ApplicationJSONListTaskChannelResponse])
                res.responses[r.status_code][content_type] = operations.ListTaskChannelResponses(list_task_channel_response=out)
    ...
    def list_task_queue(self, request: operations.ListTaskQueueRequest) -> operations.ListTaskQueueResponse:
        ...
        res = operations.ListTaskQueueResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListTaskQueue200ApplicationJSONListTaskQueueResponse])
                res.responses[r.status_code][content_type] = operations.ListTaskQueueResponses(list_task_queue_response=out)
    ...
    def list_task_queues_statistics(self, request: operations.ListTaskQueuesStatisticsRequest) -> operations.ListTaskQueuesStatisticsResponse:
        ...
        res = operations.ListTaskQueuesStatisticsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListTaskQueuesStatisticsResponses(list_task_queues_statistics_response=out)
    ...
    def list_task_reservation(self, request: operations.ListTaskReservationRequest) -> operations.ListTaskReservationResponse:
        ...
        res = operations.ListTaskReservationResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListTaskReservation200ApplicationJSONListTaskReservationResponse])
                res.responses[r.status_code][content_type] = operations.ListTaskReservationResponses(list_task_reservation_response=out)
    ...
    def list_worker(self, request: operations.ListWorkerRequest) -> operations.ListWorkerResponse:
        ...
        res = operations.ListWorkerResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListWorker200ApplicationJSONListWorkerResponse])
                res.responses[r.status_code][content_type] = operations.ListWorkerResponses(list_worker_response=out)
    ...
    def list_worker_channel(self, request: operations.ListWorkerChannelRequest) -> operations.ListWorkerChannelResponse:
        ...
        res = operations.ListWorkerChannelResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListWorkerChannel200ApplicationJSONListWorkerChannelResponse])
                res.responses[r.status_code][content_type] = operations.ListWorkerChannelResponses(list_worker_channel_response=out)
    ...
    def list_worker_reservation(self, request: operations.ListWorkerReservationRequest) -> operations.ListWorkerReservationResponse:
        ...
        res = operations.ListWorkerReservationResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListWorkerReservation200ApplicationJSONListWorkerReservationResponse])
                res.responses[r.status_code][content_type] = operations.ListWorkerReservationResponses(list_worker_reservation_response=out)
    ...
    def list_workflow(self, request: operations.ListWorkflowRequest) -> operations.ListWorkflowResponse:
        ...
        res = operations.ListWorkflowResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListWorkflow200ApplicationJSONListWorkflowResponse])
                res.responses[r.status_code][content_type] = operations.ListWorkflowResponses(list_workflow_response=out)
    ...
    def list_workspace(self, request: operations.ListWorkspaceRequest) -> operations.ListWorkspaceResponse:
        ...
        res = operations.ListWorkspaceResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListWorkspace200ApplicationJSONListWorkspaceResponse])
                res.responses[r.status_code][content_type] = operations.ListWorkspaceResponses(list_workspace_response=out)
    ...
    def update_activity(self, request: operations.UpdateActivityRequest) -> operations.UpdateActivityResponse:
        ...
        res = operations.UpdateActivityResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceActivity])
                res.responses[r.status_code][content_type] = operations.UpdateActivityResponses(taskrouter_v1_workspace_activity=out)
    ...
    def update_task(self, request: operations.UpdateTaskRequest) -> operations.UpdateTaskResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceTask])
                res.responses[r.status_code][content_type] = operations.UpdateTaskResponses(taskrouter_v1_workspace_task=out)
    ...
    def update_task_channel(self, request: operations.UpdateTaskChannelRequest) -> operations.UpdateTaskChannelResponse:
        ...
        res = operations.UpdateTaskChannelResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceTaskChannel])
                res.responses[r.status_code][content_type] = operations.UpdateTaskChannelResponses(taskrouter_v1_workspace_task_channel=out)
    ...
    def update_task_queue(self, request: operations.UpdateTaskQueueRequest) -> operations.UpdateTaskQueueResponse:
        ...
        res = operations.UpdateTaskQueueResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceTaskQueue])
                res.responses[r.status_code][content_type] = operations.UpdateTaskQueueResponses(taskrouter_v1_workspace_task_queue=out)
    ...
    def update_task_reservation(self, request: operations.UpdateTaskReservationRequest) -> operations.UpdateTaskReservationResponse:
        ...
        res = operations.UpdateTaskReservationResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceTaskTaskReservation])
                res.responses[r.status_code][content_type] = operations.UpdateTaskReservationResponses(taskrouter_v1_workspace_task_task_reservation=out)
    ...
    def update_worker(self, request: operations.UpdateWorkerRequest) -> operations.UpdateWorkerResponse:
        ...
        res = operations.UpdateWorkerResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceWorker])
                res.responses[r.status_code][content_type] = operations.UpdateWorkerResponses(taskrouter_v1_workspace_worker=out)
    ...
    def update_worker_channel(self, request: operations.UpdateWorkerChannelRequest) -> operations.UpdateWorkerChannelResponse:
        ...
        res = operations.UpdateWorkerChannelResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceWorkerWorkerChannel])
                res.responses[r.status_code][content_type] = operations.UpdateWorkerChannelResponses(taskrouter_v1_workspace_worker_worker_channel=out)
    ...
    def update_worker_reservation(self, request: operations.UpdateWorkerReservationRequest) -> operations.UpdateWorkerReservationResponse:
        ...
        res = operations.UpdateWorkerReservationResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceWorkerWorkerReservation])
                res.responses[r.status_code][content_type] = operations.UpdateWorkerReservationResponses(taskrouter_v1_workspace_worker_worker_reservation=out)
    ...
    def update_workflow(self, request: operations.UpdateWorkflowRequest) -> operations.UpdateWorkflowResponse:
        ...
        res = operations.UpdateWorkflowResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1WorkspaceWorkflow])
                res.responses[r.status_code][content_type] = operations.UpdateWorkflowResponses(taskrouter_v1_workspace_workflow=out)
    ...
    def update_workspace(self, request: operations.UpdateWorkspaceRequest) -> operations.UpdateWorkspaceResponse:
        ...
        res = operations.UpdateWorkspaceResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TaskrouterV1Workspace])
                res.responses[r.status_code][content_type] = operations.UpdateWorkspaceResponses(taskrouter_v1_workspace=out)
