...
class TaskrouterV1WorkspaceTaskQueueTaskQueueRealTimeStatistics:
    ...
    longest_relative_task_age_in_queue: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'longest_relative_task_age_in_queue' }})
    longest_relative_task_sid_in_queue: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'longest_relative_task_sid_in_queue' }})
    ...
    total_available_workers: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'total_available_workers' }})
    total_eligible_workers: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'total_eligible_workers' }})
