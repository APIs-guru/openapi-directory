...
class FetchTaskQueueRealTimeStatisticsRequest:
    ...
    path_params: FetchTaskQueueRealTimeStatisticsPathParams = field(default=None)
    query_params: FetchTaskQueueRealTimeStatisticsQueryParams = field(default=None)
    security: FetchTaskQueueRealTimeStatisticsSecurity = field(default=None)
    

@dataclass
class FetchTaskQueueRealTimeStatisticsResponses:
...
class FetchTaskQueueRealTimeStatisticsResponse:
    ...
    responses: dict[int, dict[str, FetchTaskQueueRealTimeStatisticsResponses]] = field(default=None)
