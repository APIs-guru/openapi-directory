...
class TaskrouterV1WorkspaceTaskTaskReservation:
    ...
    reservation_status: Optional[TaskReservationEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('reservation_status') }})
