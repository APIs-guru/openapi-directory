...
class FetchTaskQueueStatisticsRequest:
    path_params: FetchTaskQueueStatisticsPathParams = field()
    query_params: FetchTaskQueueStatisticsQueryParams = field()
    security: FetchTaskQueueStatisticsSecurity = field()
