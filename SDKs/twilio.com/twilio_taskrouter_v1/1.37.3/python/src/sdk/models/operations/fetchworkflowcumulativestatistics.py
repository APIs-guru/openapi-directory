...
class FetchWorkflowCumulativeStatisticsRequest:
    path_params: FetchWorkflowCumulativeStatisticsPathParams = field()
    query_params: FetchWorkflowCumulativeStatisticsQueryParams = field()
    security: FetchWorkflowCumulativeStatisticsSecurity = field()
