...
class FetchWorkerInstanceStatisticsRequest:
    path_params: FetchWorkerInstanceStatisticsPathParams = field()
    query_params: FetchWorkerInstanceStatisticsQueryParams = field()
    security: FetchWorkerInstanceStatisticsSecurity = field()
