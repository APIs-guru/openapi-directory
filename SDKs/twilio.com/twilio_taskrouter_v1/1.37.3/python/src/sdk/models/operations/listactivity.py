...
class ListActivityListActivityResponse:
    activities: Optional[List[shared.TaskrouterV1WorkspaceActivity]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('activities') }})
    meta: Optional[ListActivityListActivityResponseMeta] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    

@dataclass
class ListActivityRequest:
    path_params: ListActivityPathParams = field()
    query_params: ListActivityQueryParams = field()
    security: ListActivitySecurity = field()
