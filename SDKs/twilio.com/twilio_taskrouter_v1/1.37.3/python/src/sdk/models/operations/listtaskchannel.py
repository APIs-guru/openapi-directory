...
class ListTaskChannelListTaskChannelResponse:
    channels: Optional[List[shared.TaskrouterV1WorkspaceTaskChannel]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('channels') }})
    meta: Optional[ListTaskChannelListTaskChannelResponseMeta] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    

@dataclass
class ListTaskChannelRequest:
    path_params: ListTaskChannelPathParams = field()
    query_params: ListTaskChannelQueryParams = field()
    security: ListTaskChannelSecurity = field()
