...
class ListBundleRequest:
    ...
    query_params: ListBundleQueryParams = field(default=None)
    security: ListBundleSecurity = field(default=None)
...
class ListBundleResponse:
    ...
    responses: dict[int, dict[str, ListBundleResponses]] = field(default=None)
