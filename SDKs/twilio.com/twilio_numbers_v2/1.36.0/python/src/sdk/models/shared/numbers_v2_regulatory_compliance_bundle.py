...
from . import bundle_enum_status_enum
...
class NumbersV2RegulatoryComplianceBundle:
    ...
    status: Optional[bundle_enum_status_enum.BundleEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
