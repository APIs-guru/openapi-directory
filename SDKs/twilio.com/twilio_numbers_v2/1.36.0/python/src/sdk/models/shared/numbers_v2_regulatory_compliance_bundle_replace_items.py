...
from . import replace_items_enum_status_enum
...
class NumbersV2RegulatoryComplianceBundleReplaceItems:
    ...
    status: Optional[replace_items_enum_status_enum.ReplaceItemsEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
