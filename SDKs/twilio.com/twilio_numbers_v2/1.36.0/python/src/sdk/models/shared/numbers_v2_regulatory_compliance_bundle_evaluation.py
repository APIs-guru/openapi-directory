...
from . import evaluation_enum_status_enum
...
class NumbersV2RegulatoryComplianceBundleEvaluation:
    ...
    status: Optional[evaluation_enum_status_enum.EvaluationEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
