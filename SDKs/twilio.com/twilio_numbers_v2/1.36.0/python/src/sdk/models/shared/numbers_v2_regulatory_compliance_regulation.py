...
from . import regulation_enum_end_user_type_enum


@dataclass_json
@dataclass
class NumbersV2RegulatoryComplianceRegulation:
    end_user_type: Optional[regulation_enum_end_user_type_enum.RegulationEnumEndUserTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'end_user_type' }})
