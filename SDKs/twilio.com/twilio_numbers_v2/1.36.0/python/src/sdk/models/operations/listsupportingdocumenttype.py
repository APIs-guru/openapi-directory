...
class ListSupportingDocumentTypeListSupportingDocumentTypeResponse:
    ...
    supporting_document_types: Optional[List[shared.NumbersV2RegulatoryComplianceSupportingDocumentType]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'supporting_document_types' }})
