...
class ListEvaluationListEvaluationResponse:
    meta: Optional[ListEvaluationListEvaluationResponseMeta] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    results: Optional[List[shared.NumbersV2RegulatoryComplianceBundleEvaluation]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
    

@dataclass
class ListEvaluationRequest:
    path_params: ListEvaluationPathParams = field()
    query_params: ListEvaluationQueryParams = field()
    security: ListEvaluationSecurity = field()
