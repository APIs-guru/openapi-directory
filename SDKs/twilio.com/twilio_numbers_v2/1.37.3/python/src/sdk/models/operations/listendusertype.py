...
class ListEndUserTypeListEndUserTypeResponse:
    end_user_types: Optional[List[shared.NumbersV2RegulatoryComplianceEndUserType]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('end_user_types') }})
