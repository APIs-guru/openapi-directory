...
class ListSupportingDocumentListSupportingDocumentResponse:
    meta: Optional[ListSupportingDocumentListSupportingDocumentResponseMeta] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    results: Optional[List[shared.NumbersV2RegulatoryComplianceSupportingDocument]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
    

@dataclass
class ListSupportingDocumentRequest:
    query_params: ListSupportingDocumentQueryParams = field()
    security: ListSupportingDocumentSecurity = field()
