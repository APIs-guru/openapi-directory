...
class MessagingV1BrandRegistrations:
    ...
    brand_feedback: Optional[List[shared.BrandRegistrationsEnumBrandFeedbackEnum]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'brand_feedback' }})
    ...
    identity_status: Optional[shared.BrandRegistrationsEnumIdentityStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'identity_status' }})
    ...
    status: Optional[shared.BrandRegistrationsEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
