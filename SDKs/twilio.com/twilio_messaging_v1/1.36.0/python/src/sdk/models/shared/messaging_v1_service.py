...
from . import service_enum_scan_message_content_enum
...
class MessagingV1Service:
    ...
    scan_message_content: Optional[service_enum_scan_message_content_enum.ServiceEnumScanMessageContentEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'scan_message_content' }})
