...
from . import brand_vetting_enum_vetting_provider_enum
...
class MessagingV1BrandRegistrationsBrandVetting:
    ...
    vetting_provider: Optional[brand_vetting_enum_vetting_provider_enum.BrandVettingEnumVettingProviderEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'vetting_provider' }})
