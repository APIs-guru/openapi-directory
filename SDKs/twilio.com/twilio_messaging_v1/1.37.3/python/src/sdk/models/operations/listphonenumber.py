...
class ListPhoneNumberListPhoneNumberResponse:
    ...
    phone_numbers: Optional[List[shared.MessagingV1ServicePhoneNumber]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('phone_numbers') }})
