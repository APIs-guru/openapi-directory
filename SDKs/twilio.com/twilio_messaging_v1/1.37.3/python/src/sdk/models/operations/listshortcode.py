...
class ListShortCodeListShortCodeResponse:
    meta: Optional[ListShortCodeListShortCodeResponseMeta] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    short_codes: Optional[List[shared.MessagingV1ServiceShortCode]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('short_codes') }})
