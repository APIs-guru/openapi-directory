...
class ListUsAppToPersonListUsAppToPersonResponse:
    compliance: Optional[List[shared.MessagingV1ServiceUsAppToPerson]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('compliance') }})
    meta: Optional[ListUsAppToPersonListUsAppToPersonResponseMeta] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    

@dataclass
class ListUsAppToPersonRequest:
    path_params: ListUsAppToPersonPathParams = field()
    query_params: ListUsAppToPersonQueryParams = field()
    security: ListUsAppToPersonSecurity = field()
