...
class ListInvite200ApplicationJSONListInviteResponse:
    invites: Optional[List[shared.IPMessagingV1ServiceChannelInvite]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'invites' }})
    meta: Optional[ListInvite200ApplicationJSONMeta] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'meta' }})
    

@dataclass
class ListInviteResponses:
...
class ListInviteResponse:
    ...
    responses: dict[int, dict[str, ListInviteResponses]] = field(default=None)
