...
class ListUserChannel200ApplicationJSONListUserChannelResponse:
    channels: Optional[List[shared.IPMessagingV1ServiceUserUserChannel]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'channels' }})
    meta: Optional[ListUserChannel200ApplicationJSONMeta] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'meta' }})
    

@dataclass
class ListUserChannelResponses:
...
class ListUserChannelResponse:
    ...
    responses: dict[int, dict[str, ListUserChannelResponses]] = field(default=None)
