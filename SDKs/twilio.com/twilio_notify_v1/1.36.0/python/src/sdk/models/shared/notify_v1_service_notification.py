...
from . import notification_enum_priority_enum
...
class NotifyV1ServiceNotification:
    ...
    priority: Optional[notification_enum_priority_enum.NotificationEnumPriorityEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'priority' }})
