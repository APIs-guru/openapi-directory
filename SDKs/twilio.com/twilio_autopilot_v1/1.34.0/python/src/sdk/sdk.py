...
class SDK:
    ...
    def create_assistant(self, request: operations.CreateAssistantRequest) -> operations.CreateAssistantResponse:
        ...
        res = operations.CreateAssistantResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1Assistant])
                res.responses[r.status_code][content_type] = operations.CreateAssistantResponses(autopilot_v1_assistant=out)
    ...
    def create_field(self, request: operations.CreateFieldRequest) -> operations.CreateFieldResponse:
        ...
        res = operations.CreateFieldResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantTaskField])
                res.responses[r.status_code][content_type] = operations.CreateFieldResponses(autopilot_v1_assistant_task_field=out)
    ...
    def create_field_type(self, request: operations.CreateFieldTypeRequest) -> operations.CreateFieldTypeResponse:
        ...
        res = operations.CreateFieldTypeResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantFieldType])
                res.responses[r.status_code][content_type] = operations.CreateFieldTypeResponses(autopilot_v1_assistant_field_type=out)
    ...
    def create_field_value(self, request: operations.CreateFieldValueRequest) -> operations.CreateFieldValueResponse:
        ...
        res = operations.CreateFieldValueResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantFieldTypeFieldValue])
                res.responses[r.status_code][content_type] = operations.CreateFieldValueResponses(autopilot_v1_assistant_field_type_field_value=out)
    ...
    def create_model_build(self, request: operations.CreateModelBuildRequest) -> operations.CreateModelBuildResponse:
        ...
        res = operations.CreateModelBuildResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantModelBuild])
                res.responses[r.status_code][content_type] = operations.CreateModelBuildResponses(autopilot_v1_assistant_model_build=out)
    ...
    def create_query(self, request: operations.CreateQueryRequest) -> operations.CreateQueryResponse:
        ...
        res = operations.CreateQueryResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantQuery])
                res.responses[r.status_code][content_type] = operations.CreateQueryResponses(autopilot_v1_assistant_query=out)
    ...
    def create_sample(self, request: operations.CreateSampleRequest) -> operations.CreateSampleResponse:
        ...
        res = operations.CreateSampleResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantTaskSample])
                res.responses[r.status_code][content_type] = operations.CreateSampleResponses(autopilot_v1_assistant_task_sample=out)
    ...
    def create_task(self, request: operations.CreateTaskRequest) -> operations.CreateTaskResponse:
        ...
        res = operations.CreateTaskResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantTask])
                res.responses[r.status_code][content_type] = operations.CreateTaskResponses(autopilot_v1_assistant_task=out)
    ...
    def create_webhook(self, request: operations.CreateWebhookRequest) -> operations.CreateWebhookResponse:
        ...
        if r.status_code == 201:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.CreateWebhookResponses(autopilot_v1_assistant_webhook=out)
    ...
    def fetch_assistant(self, request: operations.FetchAssistantRequest) -> operations.FetchAssistantResponse:
        ...
        res = operations.FetchAssistantResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1Assistant])
                res.responses[r.status_code][content_type] = operations.FetchAssistantResponses(autopilot_v1_assistant=out)
    ...
    def fetch_defaults(self, request: operations.FetchDefaultsRequest) -> operations.FetchDefaultsResponse:
        ...
        res = operations.FetchDefaultsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantDefaults])
                res.responses[r.status_code][content_type] = operations.FetchDefaultsResponses(autopilot_v1_assistant_defaults=out)
    ...
    def fetch_dialogue(self, request: operations.FetchDialogueRequest) -> operations.FetchDialogueResponse:
        ...
        res = operations.FetchDialogueResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantDialogue])
                res.responses[r.status_code][content_type] = operations.FetchDialogueResponses(autopilot_v1_assistant_dialogue=out)
    ...
    def fetch_field(self, request: operations.FetchFieldRequest) -> operations.FetchFieldResponse:
        ...
        res = operations.FetchFieldResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantTaskField])
                res.responses[r.status_code][content_type] = operations.FetchFieldResponses(autopilot_v1_assistant_task_field=out)
    ...
    def fetch_field_type(self, request: operations.FetchFieldTypeRequest) -> operations.FetchFieldTypeResponse:
        ...
        res = operations.FetchFieldTypeResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantFieldType])
                res.responses[r.status_code][content_type] = operations.FetchFieldTypeResponses(autopilot_v1_assistant_field_type=out)
    ...
    def fetch_field_value(self, request: operations.FetchFieldValueRequest) -> operations.FetchFieldValueResponse:
        ...
        res = operations.FetchFieldValueResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantFieldTypeFieldValue])
                res.responses[r.status_code][content_type] = operations.FetchFieldValueResponses(autopilot_v1_assistant_field_type_field_value=out)
    ...
    def fetch_model_build(self, request: operations.FetchModelBuildRequest) -> operations.FetchModelBuildResponse:
        ...
        res = operations.FetchModelBuildResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantModelBuild])
                res.responses[r.status_code][content_type] = operations.FetchModelBuildResponses(autopilot_v1_assistant_model_build=out)
    ...
    def fetch_query(self, request: operations.FetchQueryRequest) -> operations.FetchQueryResponse:
        ...
        res = operations.FetchQueryResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantQuery])
                res.responses[r.status_code][content_type] = operations.FetchQueryResponses(autopilot_v1_assistant_query=out)
    ...
    def fetch_sample(self, request: operations.FetchSampleRequest) -> operations.FetchSampleResponse:
        ...
        res = operations.FetchSampleResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantTaskSample])
                res.responses[r.status_code][content_type] = operations.FetchSampleResponses(autopilot_v1_assistant_task_sample=out)
    ...
    def fetch_style_sheet(self, request: operations.FetchStyleSheetRequest) -> operations.FetchStyleSheetResponse:
        ...
        res = operations.FetchStyleSheetResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantStyleSheet])
                res.responses[r.status_code][content_type] = operations.FetchStyleSheetResponses(autopilot_v1_assistant_style_sheet=out)
    ...
    def fetch_task(self, request: operations.FetchTaskRequest) -> operations.FetchTaskResponse:
        ...
        res = operations.FetchTaskResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantTask])
                res.responses[r.status_code][content_type] = operations.FetchTaskResponses(autopilot_v1_assistant_task=out)
    ...
    def fetch_task_actions(self, request: operations.FetchTaskActionsRequest) -> operations.FetchTaskActionsResponse:
        ...
        res = operations.FetchTaskActionsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantTaskTaskActions])
                res.responses[r.status_code][content_type] = operations.FetchTaskActionsResponses(autopilot_v1_assistant_task_task_actions=out)
    ...
    def fetch_task_statistics(self, request: operations.FetchTaskStatisticsRequest) -> operations.FetchTaskStatisticsResponse:
        ...
        res = operations.FetchTaskStatisticsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantTaskTaskStatistics])
                res.responses[r.status_code][content_type] = operations.FetchTaskStatisticsResponses(autopilot_v1_assistant_task_task_statistics=out)
    ...
    def fetch_webhook(self, request: operations.FetchWebhookRequest) -> operations.FetchWebhookResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantWebhook])
                res.responses[r.status_code][content_type] = operations.FetchWebhookResponses(autopilot_v1_assistant_webhook=out)
    ...
    def list_assistant(self, request: operations.ListAssistantRequest) -> operations.ListAssistantResponse:
        ...
        res = operations.ListAssistantResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListAssistant200ApplicationJSONListAssistantResponse])
                res.responses[r.status_code][content_type] = operations.ListAssistantResponses(list_assistant_response=out)
    ...
    def list_field(self, request: operations.ListFieldRequest) -> operations.ListFieldResponse:
        ...
        res = operations.ListFieldResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListField200ApplicationJSONListFieldResponse])
                res.responses[r.status_code][content_type] = operations.ListFieldResponses(list_field_response=out)
    ...
    def list_field_type(self, request: operations.ListFieldTypeRequest) -> operations.ListFieldTypeResponse:
        ...
        res = operations.ListFieldTypeResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListFieldType200ApplicationJSONListFieldTypeResponse])
                res.responses[r.status_code][content_type] = operations.ListFieldTypeResponses(list_field_type_response=out)
    ...
    def list_field_value(self, request: operations.ListFieldValueRequest) -> operations.ListFieldValueResponse:
        ...
        res = operations.ListFieldValueResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListFieldValue200ApplicationJSONListFieldValueResponse])
                res.responses[r.status_code][content_type] = operations.ListFieldValueResponses(list_field_value_response=out)
    ...
    def list_model_build(self, request: operations.ListModelBuildRequest) -> operations.ListModelBuildResponse:
        ...
        res = operations.ListModelBuildResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListModelBuild200ApplicationJSONListModelBuildResponse])
                res.responses[r.status_code][content_type] = operations.ListModelBuildResponses(list_model_build_response=out)
    ...
    def list_query(self, request: operations.ListQueryRequest) -> operations.ListQueryResponse:
        ...
        res = operations.ListQueryResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListQuery200ApplicationJSONListQueryResponse])
                res.responses[r.status_code][content_type] = operations.ListQueryResponses(list_query_response=out)
    ...
    def list_sample(self, request: operations.ListSampleRequest) -> operations.ListSampleResponse:
        ...
        res = operations.ListSampleResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListSample200ApplicationJSONListSampleResponse])
                res.responses[r.status_code][content_type] = operations.ListSampleResponses(list_sample_response=out)
    ...
    def list_task(self, request: operations.ListTaskRequest) -> operations.ListTaskResponse:
        ...
        res = operations.ListTaskResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListTask200ApplicationJSONListTaskResponse])
                res.responses[r.status_code][content_type] = operations.ListTaskResponses(list_task_response=out)
    ...
    def update_assistant(self, request: operations.UpdateAssistantRequest) -> operations.UpdateAssistantResponse:
        ...
        res = operations.UpdateAssistantResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1Assistant])
                res.responses[r.status_code][content_type] = operations.UpdateAssistantResponses(autopilot_v1_assistant=out)
    ...
    def update_defaults(self, request: operations.UpdateDefaultsRequest) -> operations.UpdateDefaultsResponse:
        ...
        res = operations.UpdateDefaultsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantDefaults])
                res.responses[r.status_code][content_type] = operations.UpdateDefaultsResponses(autopilot_v1_assistant_defaults=out)
    ...
    def update_field_type(self, request: operations.UpdateFieldTypeRequest) -> operations.UpdateFieldTypeResponse:
        ...
        res = operations.UpdateFieldTypeResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantFieldType])
                res.responses[r.status_code][content_type] = operations.UpdateFieldTypeResponses(autopilot_v1_assistant_field_type=out)
    ...
    def update_model_build(self, request: operations.UpdateModelBuildRequest) -> operations.UpdateModelBuildResponse:
        ...
        res = operations.UpdateModelBuildResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantModelBuild])
                res.responses[r.status_code][content_type] = operations.UpdateModelBuildResponses(autopilot_v1_assistant_model_build=out)
    ...
    def update_query(self, request: operations.UpdateQueryRequest) -> operations.UpdateQueryResponse:
        ...
        res = operations.UpdateQueryResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantQuery])
                res.responses[r.status_code][content_type] = operations.UpdateQueryResponses(autopilot_v1_assistant_query=out)
    ...
    def update_restore_assistant(self, request: operations.UpdateRestoreAssistantRequest) -> operations.UpdateRestoreAssistantResponse:
        ...
        res = operations.UpdateRestoreAssistantResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1RestoreAssistant])
                res.responses[r.status_code][content_type] = operations.UpdateRestoreAssistantResponses(autopilot_v1_restore_assistant=out)
    ...
    def update_sample(self, request: operations.UpdateSampleRequest) -> operations.UpdateSampleResponse:
        ...
        res = operations.UpdateSampleResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantTaskSample])
                res.responses[r.status_code][content_type] = operations.UpdateSampleResponses(autopilot_v1_assistant_task_sample=out)
    ...
    def update_style_sheet(self, request: operations.UpdateStyleSheetRequest) -> operations.UpdateStyleSheetResponse:
        ...
        res = operations.UpdateStyleSheetResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantStyleSheet])
                res.responses[r.status_code][content_type] = operations.UpdateStyleSheetResponses(autopilot_v1_assistant_style_sheet=out)
    ...
    def update_task(self, request: operations.UpdateTaskRequest) -> operations.UpdateTaskResponse:
        ...
        res = operations.UpdateTaskResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantTask])
                res.responses[r.status_code][content_type] = operations.UpdateTaskResponses(autopilot_v1_assistant_task=out)
    ...
    def update_task_actions(self, request: operations.UpdateTaskActionsRequest) -> operations.UpdateTaskActionsResponse:
        ...
        res = operations.UpdateTaskActionsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantTaskTaskActions])
                res.responses[r.status_code][content_type] = operations.UpdateTaskActionsResponses(autopilot_v1_assistant_task_task_actions=out)
    ...
    def update_webhook(self, request: operations.UpdateWebhookRequest) -> operations.UpdateWebhookResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AutopilotV1AssistantWebhook])
                res.responses[r.status_code][content_type] = operations.UpdateWebhookResponses(autopilot_v1_assistant_webhook=out)
