...
class ListSampleListSampleResponse:
    meta: Optional[ListSampleListSampleResponseMeta] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    samples: Optional[List[shared.AutopilotV1AssistantTaskSample]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('samples') }})
    

@dataclass
class ListSampleRequest:
    path_params: ListSamplePathParams = field()
    query_params: ListSampleQueryParams = field()
    security: ListSampleSecurity = field()
