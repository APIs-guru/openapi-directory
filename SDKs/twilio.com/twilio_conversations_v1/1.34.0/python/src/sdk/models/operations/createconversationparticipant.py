...
class CreateConversationParticipantRequest:
    ...
    path_params: CreateConversationParticipantPathParams = field(default=None)
    headers: CreateConversationParticipantHeaders = field(default=None)
    request: Optional[bytes] = field(default=None, metadata={'request': { 'media_type': 'application/x-www-form-urlencoded' }})
    security: CreateConversationParticipantSecurity = field(default=None)
    

@dataclass
class CreateConversationParticipantResponses:
...
class CreateConversationParticipantResponse:
    ...
    responses: dict[int, dict[str, CreateConversationParticipantResponses]] = field(default=None)
