...
class ConversationsV1ServiceServiceUserServiceUserConversation:
    ...
    conversation_state: Optional[shared.ServiceUserConversationEnumStateEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'conversation_state' }})
    ...
    notification_level: Optional[shared.ServiceUserConversationEnumNotificationLevelEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'notification_level' }})
