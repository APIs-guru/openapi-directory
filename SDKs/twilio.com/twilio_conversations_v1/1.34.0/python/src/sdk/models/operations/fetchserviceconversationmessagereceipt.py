...
class FetchServiceConversationMessageReceiptRequest:
    ...
    path_params: FetchServiceConversationMessageReceiptPathParams = field(default=None)
    security: FetchServiceConversationMessageReceiptSecurity = field(default=None)
    

@dataclass
class FetchServiceConversationMessageReceiptResponses:
...
class FetchServiceConversationMessageReceiptResponse:
    ...
    responses: dict[int, dict[str, FetchServiceConversationMessageReceiptResponses]] = field(default=None)
