...
class ConversationsV1ServiceServiceParticipantConversation:
    ...
    conversation_state: Optional[shared.ServiceParticipantConversationEnumStateEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'conversation_state' }})
