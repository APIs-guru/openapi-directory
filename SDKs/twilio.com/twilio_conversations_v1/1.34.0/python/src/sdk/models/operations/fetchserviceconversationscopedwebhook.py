...
class FetchServiceConversationScopedWebhookRequest:
    ...
    path_params: FetchServiceConversationScopedWebhookPathParams = field(default=None)
    security: FetchServiceConversationScopedWebhookSecurity = field(default=None)
    

@dataclass
class FetchServiceConversationScopedWebhookResponses:
...
class FetchServiceConversationScopedWebhookResponse:
    ...
    responses: dict[int, dict[str, FetchServiceConversationScopedWebhookResponses]] = field(default=None)
