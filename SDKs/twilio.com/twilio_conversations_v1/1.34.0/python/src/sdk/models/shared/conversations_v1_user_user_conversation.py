...
class ConversationsV1UserUserConversation:
    ...
    conversation_state: Optional[shared.UserConversationEnumStateEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'conversation_state' }})
    ...
    notification_level: Optional[shared.UserConversationEnumNotificationLevelEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'notification_level' }})
