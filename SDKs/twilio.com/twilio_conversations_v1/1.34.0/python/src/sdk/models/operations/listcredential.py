...
class ListCredential200ApplicationJSONListCredentialResponse:
    credentials: Optional[List[shared.ConversationsV1Credential]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'credentials' }})
    meta: Optional[ListCredential200ApplicationJSONMeta] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'meta' }})
    

@dataclass
class ListCredentialResponses:
...
class ListCredentialResponse:
    ...
    responses: dict[int, dict[str, ListCredentialResponses]] = field(default=None)
