...
class ConversationsV1ConversationConversationParticipant:
    ...
    last_read_timestamp: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'last_read_timestamp' }})
    messaging_binding: Optional[Any] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'messaging_binding' }})
