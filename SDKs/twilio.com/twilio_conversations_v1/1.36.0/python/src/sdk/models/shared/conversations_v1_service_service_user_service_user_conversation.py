...
from . import service_user_conversation_enum_state_enum
from . import service_user_conversation_enum_notification_level_enum
...
class ConversationsV1ServiceServiceUserServiceUserConversation:
    ...
    conversation_state: Optional[service_user_conversation_enum_state_enum.ServiceUserConversationEnumStateEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'conversation_state' }})
    ...
    notification_level: Optional[service_user_conversation_enum_notification_level_enum.ServiceUserConversationEnumNotificationLevelEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'notification_level' }})
