...
from . import conversation_enum_state_enum
...
class ConversationsV1Conversation:
    ...
    state: Optional[conversation_enum_state_enum.ConversationEnumStateEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'state' }})
