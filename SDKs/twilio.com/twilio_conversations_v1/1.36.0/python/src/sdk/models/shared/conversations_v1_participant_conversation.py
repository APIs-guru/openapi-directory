...
from . import participant_conversation_enum_state_enum
...
class ConversationsV1ParticipantConversation:
    ...
    conversation_state: Optional[participant_conversation_enum_state_enum.ParticipantConversationEnumStateEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'conversation_state' }})
