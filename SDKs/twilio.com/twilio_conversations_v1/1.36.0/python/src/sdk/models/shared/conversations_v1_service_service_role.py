...
from . import service_role_enum_role_type_enum
...
class ConversationsV1ServiceServiceRole:
    ...
    type: Optional[service_role_enum_role_type_enum.ServiceRoleEnumRoleTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'type' }})
