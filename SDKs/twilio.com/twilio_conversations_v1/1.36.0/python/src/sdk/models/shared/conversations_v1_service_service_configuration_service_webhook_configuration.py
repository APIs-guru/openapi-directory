...
from . import service_webhook_configuration_enum_method_enum
...
class ConversationsV1ServiceServiceConfigurationServiceWebhookConfiguration:
    ...
    method: Optional[service_webhook_configuration_enum_method_enum.ServiceWebhookConfigurationEnumMethodEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'method' }})
