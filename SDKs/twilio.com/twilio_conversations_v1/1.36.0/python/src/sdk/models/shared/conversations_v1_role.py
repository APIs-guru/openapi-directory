...
from . import role_enum_role_type_enum
...
class ConversationsV1Role:
    ...
    type: Optional[role_enum_role_type_enum.RoleEnumRoleTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'type' }})
