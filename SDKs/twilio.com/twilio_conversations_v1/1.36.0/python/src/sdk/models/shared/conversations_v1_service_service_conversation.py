...
from . import service_conversation_enum_state_enum
...
class ConversationsV1ServiceServiceConversation:
    ...
    state: Optional[service_conversation_enum_state_enum.ServiceConversationEnumStateEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'state' }})
