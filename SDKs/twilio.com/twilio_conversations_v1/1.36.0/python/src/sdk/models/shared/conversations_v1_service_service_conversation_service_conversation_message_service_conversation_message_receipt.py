...
from . import service_conversation_message_receipt_enum_delivery_status_enum
...
class ConversationsV1ServiceServiceConversationServiceConversationMessageServiceConversationMessageReceipt:
    ...
    status: Optional[service_conversation_message_receipt_enum_delivery_status_enum.ServiceConversationMessageReceiptEnumDeliveryStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
