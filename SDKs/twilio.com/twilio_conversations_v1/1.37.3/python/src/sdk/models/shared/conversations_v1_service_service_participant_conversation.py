...
class ConversationsV1ServiceServiceParticipantConversation:
    ...
    conversation_state: Optional[ServiceParticipantConversationEnumStateEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('conversation_state') }})
