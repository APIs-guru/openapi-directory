...
class ConversationsV1Conversation:
    ...
    bindings: Optional[Any] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('bindings') }})
    ...
    state: Optional[ConversationEnumStateEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('state') }})
