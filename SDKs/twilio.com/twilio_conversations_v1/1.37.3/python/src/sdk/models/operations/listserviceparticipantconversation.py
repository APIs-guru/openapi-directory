...
class ListServiceParticipantConversationListServiceParticipantConversationResponse:
    conversations: Optional[List[shared.ConversationsV1ServiceServiceParticipantConversation]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('conversations') }})
    meta: Optional[ListServiceParticipantConversationListServiceParticipantConversationResponseMeta] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    

@dataclass
class ListServiceParticipantConversationRequest:
    path_params: ListServiceParticipantConversationPathParams = field()
    query_params: ListServiceParticipantConversationQueryParams = field()
    security: ListServiceParticipantConversationSecurity = field()
