...
class ListServiceUserListServiceUserResponse:
    meta: Optional[ListServiceUserListServiceUserResponseMeta] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    users: Optional[List[shared.ConversationsV1ServiceServiceUser]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('users') }})
    

@dataclass
class ListServiceUserRequest:
    path_params: ListServiceUserPathParams = field()
    query_params: ListServiceUserQueryParams = field()
    security: ListServiceUserSecurity = field()
