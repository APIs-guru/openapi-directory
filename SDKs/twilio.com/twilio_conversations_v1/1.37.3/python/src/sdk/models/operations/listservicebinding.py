...
class ListServiceBindingListServiceBindingResponse:
    bindings: Optional[List[shared.ConversationsV1ServiceServiceBinding]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('bindings') }})
    meta: Optional[ListServiceBindingListServiceBindingResponseMeta] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    

@dataclass
class ListServiceBindingRequest:
    path_params: ListServiceBindingPathParams = field()
    query_params: ListServiceBindingQueryParams = field()
    security: ListServiceBindingSecurity = field()
