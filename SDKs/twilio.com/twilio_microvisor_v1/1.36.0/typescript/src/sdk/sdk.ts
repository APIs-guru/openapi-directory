...
export class SDK {
  ...
  DeleteApp(
    ...
    let baseURL: string = operations.DELETEAPP_SERVERS[0];
  ...
  FetchApp(
    ...
    let baseURL: string = operations.FETCHAPP_SERVERS[0];
    const url: string = utils.GenerateURL(baseURL, "/v1/Apps/{Sid}", req.pathParams);
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.FetchAppResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
  ...
  FetchDevice(
    ...
    let baseURL: string = operations.FETCHDEVICE_SERVERS[0];
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.FetchDeviceResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  ListApp(
    ...
    let baseURL: string = operations.LISTAPP_SERVERS[0];
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ListAppResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  ListDevice(
    ...
    let baseURL: string = operations.LISTDEVICE_SERVERS[0];
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.ListDeviceResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  UpdateDevice(
    ...
    let baseURL: string = operations.UPDATEDEVICE_SERVERS[0];
    const url: string = utils.GenerateURL(baseURL, "/v1/Devices/{Sid}", req.pathParams);
