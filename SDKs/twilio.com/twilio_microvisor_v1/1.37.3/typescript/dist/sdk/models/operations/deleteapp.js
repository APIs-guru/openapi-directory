...
export var DeleteAppServerList = [
...
var DeleteAppPathParams = /** @class */ (function (_super) {
    ...
    ], DeleteAppPathParams.prototype, "sid", void 0);
    return DeleteAppPathParams;
}(SpeakeasyBase));
export { DeleteAppPathParams };
var DeleteAppSecurity = /** @class */ (function (_super) {
    ...
    ], DeleteAppSecurity.prototype, "accountSidAuthToken", void 0);
    return DeleteAppSecurity;
}(SpeakeasyBase));
export { DeleteAppSecurity };
var DeleteAppRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", String)
    ], DeleteAppRequest.prototype, "serverUrl", void 0);
    __decorate([
        SpeakeasyMetadata(),
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", DeleteAppSecurity)
    ], DeleteAppRequest.prototype, "security", void 0);
