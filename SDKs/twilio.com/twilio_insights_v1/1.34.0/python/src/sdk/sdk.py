...
class SDK:
    ...
    def fetch_account_settings(self, request: operations.FetchAccountSettingsRequest) -> operations.FetchAccountSettingsResponse:
        ...
        res = operations.FetchAccountSettingsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.InsightsV1AccountSettings])
                res.responses[r.status_code][content_type] = operations.FetchAccountSettingsResponses(insights_v1_account_settings=out)
    ...
    def fetch_annotation(self, request: operations.FetchAnnotationRequest) -> operations.FetchAnnotationResponse:
        ...
        res = operations.FetchAnnotationResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.InsightsV1CallAnnotation])
                res.responses[r.status_code][content_type] = operations.FetchAnnotationResponses(insights_v1_call_annotation=out)
    ...
    def fetch_call(self, request: operations.FetchCallRequest) -> operations.FetchCallResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.FetchCallResponses(insights_v1_call=out)
    ...
    def fetch_conference(self, request: operations.FetchConferenceRequest) -> operations.FetchConferenceResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.FetchConferenceResponses(insights_v1_conference=out)
    ...
    def fetch_conference_participant(self, request: operations.FetchConferenceParticipantRequest) -> operations.FetchConferenceParticipantResponse:
        ...
        res = operations.FetchConferenceParticipantResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.InsightsV1ConferenceConferenceParticipant])
                res.responses[r.status_code][content_type] = operations.FetchConferenceParticipantResponses(insights_v1_conference_conference_participant=out)
    ...
    def fetch_summary(self, request: operations.FetchSummaryRequest) -> operations.FetchSummaryResponse:
        ...
        res = operations.FetchSummaryResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.InsightsV1CallSummary])
                res.responses[r.status_code][content_type] = operations.FetchSummaryResponses(insights_v1_call_summary=out)
    ...
    def fetch_video_participant_summary(self, request: operations.FetchVideoParticipantSummaryRequest) -> operations.FetchVideoParticipantSummaryResponse:
        ...
        res = operations.FetchVideoParticipantSummaryResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.InsightsV1VideoRoomSummaryVideoParticipantSummary])
                res.responses[r.status_code][content_type] = operations.FetchVideoParticipantSummaryResponses(insights_v1_video_room_summary_video_participant_summary=out)
    ...
    def fetch_video_room_summary(self, request: operations.FetchVideoRoomSummaryRequest) -> operations.FetchVideoRoomSummaryResponse:
        ...
        res = operations.FetchVideoRoomSummaryResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.InsightsV1VideoRoomSummary])
                res.responses[r.status_code][content_type] = operations.FetchVideoRoomSummaryResponses(insights_v1_video_room_summary=out)
    ...
    def list_call_summaries(self, request: operations.ListCallSummariesRequest) -> operations.ListCallSummariesResponse:
        ...
        res = operations.ListCallSummariesResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListCallSummaries200ApplicationJSONListCallSummariesResponse])
                res.responses[r.status_code][content_type] = operations.ListCallSummariesResponses(list_call_summaries_response=out)
    ...
    def list_conference_participant(self, request: operations.ListConferenceParticipantRequest) -> operations.ListConferenceParticipantResponse:
        ...
        res = operations.ListConferenceParticipantResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListConferenceParticipantResponses(list_conference_participant_response=out)
    ...
    def list_metric(self, request: operations.ListMetricRequest) -> operations.ListMetricResponse:
        ...
        res = operations.ListMetricResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListMetric200ApplicationJSONListMetricResponse])
                res.responses[r.status_code][content_type] = operations.ListMetricResponses(list_metric_response=out)
    ...
    def list_video_participant_summary(self, request: operations.ListVideoParticipantSummaryRequest) -> operations.ListVideoParticipantSummaryResponse:
        ...
        res = operations.ListVideoParticipantSummaryResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                ...
                res.responses[r.status_code][content_type] = operations.ListVideoParticipantSummaryResponses(list_video_participant_summary_response=out)
    ...
    def list_video_room_summary(self, request: operations.ListVideoRoomSummaryRequest) -> operations.ListVideoRoomSummaryResponse:
        ...
        res = operations.ListVideoRoomSummaryResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.ListVideoRoomSummary200ApplicationJSONListVideoRoomSummaryResponse])
                res.responses[r.status_code][content_type] = operations.ListVideoRoomSummaryResponses(list_video_room_summary_response=out)
    ...
    def update_account_settings(self, request: operations.UpdateAccountSettingsRequest) -> operations.UpdateAccountSettingsResponse:
        ...
        res = operations.UpdateAccountSettingsResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.InsightsV1AccountSettings])
                res.responses[r.status_code][content_type] = operations.UpdateAccountSettingsResponses(insights_v1_account_settings=out)
    ...
    def update_annotation(self, request: operations.UpdateAnnotationRequest) -> operations.UpdateAnnotationResponse:
        ...
        res = operations.UpdateAnnotationResponse(status_code=r.status_code, content_type=content_type, responses={r.status_code: {content_type: {}}})
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.InsightsV1CallAnnotation])
                res.responses[r.status_code][content_type] = operations.UpdateAnnotationResponses(insights_v1_call_annotation=out)
