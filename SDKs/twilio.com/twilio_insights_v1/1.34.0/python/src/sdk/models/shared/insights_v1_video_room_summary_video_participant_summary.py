...
class InsightsV1VideoRoomSummaryVideoParticipantSummary:
    ...
    codecs: Optional[List[shared.VideoParticipantSummaryEnumCodecEnum]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'codecs' }})
    duration_sec: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'duration_sec' }})
    edge_location: Optional[shared.VideoParticipantSummaryEnumEdgeLocationEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'edge_location' }})
    ...
    media_region: Optional[shared.VideoParticipantSummaryEnumTwilioRealmEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'media_region' }})
    ...
    status: Optional[shared.VideoParticipantSummaryEnumRoomStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
