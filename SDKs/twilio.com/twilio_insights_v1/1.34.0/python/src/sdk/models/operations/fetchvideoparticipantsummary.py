...
class FetchVideoParticipantSummaryRequest:
    ...
    path_params: FetchVideoParticipantSummaryPathParams = field(default=None)
    security: FetchVideoParticipantSummarySecurity = field(default=None)
    

@dataclass
class FetchVideoParticipantSummaryResponses:
...
class FetchVideoParticipantSummaryResponse:
    ...
    responses: dict[int, dict[str, FetchVideoParticipantSummaryResponses]] = field(default=None)
