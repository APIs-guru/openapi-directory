...
class InsightsV1CallSummaries:
    ...
    call_state: Optional[shared.CallSummariesEnumCallStateEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'call_state' }})
    call_type: Optional[shared.CallSummariesEnumCallTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'call_type' }})
    ...
    processing_state: Optional[shared.CallSummariesEnumProcessingStateEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'processing_state' }})
