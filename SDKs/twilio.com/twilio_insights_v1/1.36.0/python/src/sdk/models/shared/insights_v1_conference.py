...
from . import conference_enum_conference_end_reason_enum
from . import conference_enum_region_enum
from . import conference_enum_region_enum
from . import conference_enum_processing_state_enum
from . import conference_enum_conference_status_enum
from . import conference_enum_tag_enum
...
class InsightsV1Conference:
    ...
    end_reason: Optional[conference_enum_conference_end_reason_enum.ConferenceEnumConferenceEndReasonEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'end_reason' }})
    ...
    mixer_region: Optional[conference_enum_region_enum.ConferenceEnumRegionEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'mixer_region' }})
    mixer_region_requested: Optional[conference_enum_region_enum.ConferenceEnumRegionEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'mixer_region_requested' }})
    processing_state: Optional[conference_enum_processing_state_enum.ConferenceEnumProcessingStateEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'processing_state' }})
    ...
    status: Optional[conference_enum_conference_status_enum.ConferenceEnumConferenceStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
    tag_info: Optional[Any] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'tag_info' }})
    tags: Optional[List[conference_enum_tag_enum.ConferenceEnumTagEnum]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'tags' }})
