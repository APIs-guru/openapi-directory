...
class ListNetworkAccessProfileNetworkListNetworkAccessProfileNetworkResponse:
    meta: Optional[ListNetworkAccessProfileNetworkListNetworkAccessProfileNetworkResponseMeta] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    networks: Optional[List[shared.SupersimV1NetworkAccessProfileNetworkAccessProfileNetwork]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('networks') }})
    

@dataclass
class ListNetworkAccessProfileNetworkRequest:
    path_params: ListNetworkAccessProfileNetworkPathParams = field()
    query_params: ListNetworkAccessProfileNetworkQueryParams = field()
    security: ListNetworkAccessProfileNetworkSecurity = field()
