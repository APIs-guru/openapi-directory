...
from . import esim_profile_enum_status_enum
...
class SupersimV1EsimProfile:
    ...
    status: Optional[esim_profile_enum_status_enum.EsimProfileEnumStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
