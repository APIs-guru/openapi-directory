...
class PostContainersGroupsNameOrIDUnmaprouteRequest:
    path_params: PostContainersGroupsNameOrIDUnmaproutePathParams = field(default=None)
    headers: PostContainersGroupsNameOrIDUnmaprouteHeaders = field(default=None)
