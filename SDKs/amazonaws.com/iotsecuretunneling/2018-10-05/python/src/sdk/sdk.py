...
class SDK:
    ...
    def close_tunnel(self, request: operations.CloseTunnelRequest) -> operations.CloseTunnelResponse:
        r"""Closes a tunnel identified by the unique tunnel id. When a <code>CloseTunnel</code> request is received, we close the WebSocket connections between the client and proxy server so no data can be transmitted.
        """
    ...
    def describe_tunnel(self, request: operations.DescribeTunnelRequest) -> operations.DescribeTunnelResponse:
        r"""Gets information about a tunnel identified by the unique tunnel id.
        """
    ...
    def list_tunnels(self, request: operations.ListTunnelsRequest) -> operations.ListTunnelsResponse:
        r"""List all tunnels for an AWS account. Tunnels are listed by creation time in descending order, newer tunnels will be listed before older tunnels.
        """
    ...
    def open_tunnel(self, request: operations.OpenTunnelRequest) -> operations.OpenTunnelResponse:
        r"""Creates a new tunnel, and returns two client access tokens for clients to use to connect to the AWS IoT Secure Tunneling proxy server.
        """
