...
class SDK:
    ...
    def close_tunnel(self, request: operations.CloseTunnelRequest) -> operations.CloseTunnelResponse:
        ...
        res = operations.CloseTunnelResponse(status_code=r.status_code, content_type=content_type)
    ...
    def describe_tunnel(self, request: operations.DescribeTunnelRequest) -> operations.DescribeTunnelResponse:
        ...
        res = operations.DescribeTunnelResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribeTunnelResponse])
    ...
    def list_tunnels(self, request: operations.ListTunnelsRequest) -> operations.ListTunnelsResponse:
        ...
        res = operations.ListTunnelsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListTunnelsResponse])
    ...
    def open_tunnel(self, request: operations.OpenTunnelRequest) -> operations.OpenTunnelResponse:
        ...
        res = operations.OpenTunnelResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.OpenTunnelResponse])
