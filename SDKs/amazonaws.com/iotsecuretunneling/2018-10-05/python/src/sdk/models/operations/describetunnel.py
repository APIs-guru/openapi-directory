...
class DescribeTunnelHeaders:
    x_amz_target: DescribeTunnelXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeTunnelRequest:
    headers: DescribeTunnelHeaders = field()
    request: shared.DescribeTunnelRequest = field(metadata={'request': { 'media_type': 'application/json' }})
