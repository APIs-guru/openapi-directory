...
import { AssociateFirewallRuleGroupRequest, AssociateFirewallRuleGroupResponse } from "openapi/src/sdk/models/operations";
...
sdk.sdk.associateFirewallRuleGroup(req).then((res: AssociateFirewallRuleGroupResponse | AxiosError) => {
   // handle response
});
```
