...
class SDK:
    ...
    def associate_firewall_rule_group(self, request: operations.AssociateFirewallRuleGroupRequest) -> operations.AssociateFirewallRuleGroupResponse:
        ...
        res = operations.AssociateFirewallRuleGroupResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AssociateFirewallRuleGroupResponse])
                res.associate_firewall_rule_group_response = out
    ...
    def associate_resolver_endpoint_ip_address(self, request: operations.AssociateResolverEndpointIPAddressRequest) -> operations.AssociateResolverEndpointIPAddressResponse:
        ...
        res = operations.AssociateResolverEndpointIPAddressResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AssociateResolverEndpointIPAddressResponse])
                res.associate_resolver_endpoint_ip_address_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def associate_resolver_query_log_config(self, request: operations.AssociateResolverQueryLogConfigRequest) -> operations.AssociateResolverQueryLogConfigResponse:
        ...
        res = operations.AssociateResolverQueryLogConfigResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AssociateResolverQueryLogConfigResponse])
                res.associate_resolver_query_log_config_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.invalid_parameter_exception = out
    ...
    def associate_resolver_rule(self, request: operations.AssociateResolverRuleRequest) -> operations.AssociateResolverRuleResponse:
        ...
        res = operations.AssociateResolverRuleResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AssociateResolverRuleResponse])
                res.associate_resolver_rule_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def create_firewall_domain_list(self, request: operations.CreateFirewallDomainListRequest) -> operations.CreateFirewallDomainListResponse:
        ...
        res = operations.CreateFirewallDomainListResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateFirewallDomainListResponse])
                res.create_firewall_domain_list_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.limit_exceeded_exception = out
    ...
    def create_firewall_rule(self, request: operations.CreateFirewallRuleRequest) -> operations.CreateFirewallRuleResponse:
        ...
        res = operations.CreateFirewallRuleResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateFirewallRuleResponse])
                res.create_firewall_rule_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def create_firewall_rule_group(self, request: operations.CreateFirewallRuleGroupRequest) -> operations.CreateFirewallRuleGroupResponse:
        ...
        res = operations.CreateFirewallRuleGroupResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateFirewallRuleGroupResponse])
                res.create_firewall_rule_group_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.limit_exceeded_exception = out
    ...
    def create_resolver_endpoint(self, request: operations.CreateResolverEndpointRequest) -> operations.CreateResolverEndpointResponse:
        ...
        res = operations.CreateResolverEndpointResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateResolverEndpointResponse])
                res.create_resolver_endpoint_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.invalid_parameter_exception = out
    ...
    def create_resolver_query_log_config(self, request: operations.CreateResolverQueryLogConfigRequest) -> operations.CreateResolverQueryLogConfigResponse:
        ...
        res = operations.CreateResolverQueryLogConfigResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateResolverQueryLogConfigResponse])
                res.create_resolver_query_log_config_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.invalid_parameter_exception = out
    ...
    def create_resolver_rule(self, request: operations.CreateResolverRuleRequest) -> operations.CreateResolverRuleResponse:
        ...
        res = operations.CreateResolverRuleResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateResolverRuleResponse])
                res.create_resolver_rule_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.invalid_parameter_exception = out
    ...
    def delete_firewall_domain_list(self, request: operations.DeleteFirewallDomainListRequest) -> operations.DeleteFirewallDomainListResponse:
        ...
        res = operations.DeleteFirewallDomainListResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DeleteFirewallDomainListResponse])
                res.delete_firewall_domain_list_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def delete_firewall_rule(self, request: operations.DeleteFirewallRuleRequest) -> operations.DeleteFirewallRuleResponse:
        ...
        res = operations.DeleteFirewallRuleResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DeleteFirewallRuleResponse])
                res.delete_firewall_rule_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def delete_firewall_rule_group(self, request: operations.DeleteFirewallRuleGroupRequest) -> operations.DeleteFirewallRuleGroupResponse:
        ...
        res = operations.DeleteFirewallRuleGroupResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DeleteFirewallRuleGroupResponse])
                res.delete_firewall_rule_group_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def delete_resolver_endpoint(self, request: operations.DeleteResolverEndpointRequest) -> operations.DeleteResolverEndpointResponse:
        ...
        res = operations.DeleteResolverEndpointResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DeleteResolverEndpointResponse])
                res.delete_resolver_endpoint_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def delete_resolver_query_log_config(self, request: operations.DeleteResolverQueryLogConfigRequest) -> operations.DeleteResolverQueryLogConfigResponse:
        ...
        res = operations.DeleteResolverQueryLogConfigResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DeleteResolverQueryLogConfigResponse])
                res.delete_resolver_query_log_config_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def delete_resolver_rule(self, request: operations.DeleteResolverRuleRequest) -> operations.DeleteResolverRuleResponse:
        ...
        res = operations.DeleteResolverRuleResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DeleteResolverRuleResponse])
                res.delete_resolver_rule_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.invalid_parameter_exception = out
    ...
    def disassociate_firewall_rule_group(self, request: operations.DisassociateFirewallRuleGroupRequest) -> operations.DisassociateFirewallRuleGroupResponse:
        ...
        res = operations.DisassociateFirewallRuleGroupResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DisassociateFirewallRuleGroupResponse])
                res.disassociate_firewall_rule_group_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def disassociate_resolver_endpoint_ip_address(self, request: operations.DisassociateResolverEndpointIPAddressRequest) -> operations.DisassociateResolverEndpointIPAddressResponse:
        ...
        res = operations.DisassociateResolverEndpointIPAddressResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DisassociateResolverEndpointIPAddressResponse])
                res.disassociate_resolver_endpoint_ip_address_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def disassociate_resolver_query_log_config(self, request: operations.DisassociateResolverQueryLogConfigRequest) -> operations.DisassociateResolverQueryLogConfigResponse:
        ...
        res = operations.DisassociateResolverQueryLogConfigResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DisassociateResolverQueryLogConfigResponse])
                res.disassociate_resolver_query_log_config_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def disassociate_resolver_rule(self, request: operations.DisassociateResolverRuleRequest) -> operations.DisassociateResolverRuleResponse:
        ...
        res = operations.DisassociateResolverRuleResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DisassociateResolverRuleResponse])
                res.disassociate_resolver_rule_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def get_firewall_config(self, request: operations.GetFirewallConfigRequest) -> operations.GetFirewallConfigResponse:
        ...
        res = operations.GetFirewallConfigResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetFirewallConfigResponse])
                res.get_firewall_config_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def get_firewall_domain_list(self, request: operations.GetFirewallDomainListRequest) -> operations.GetFirewallDomainListResponse:
        ...
        res = operations.GetFirewallDomainListResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetFirewallDomainListResponse])
                res.get_firewall_domain_list_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def get_firewall_rule_group(self, request: operations.GetFirewallRuleGroupRequest) -> operations.GetFirewallRuleGroupResponse:
        ...
        res = operations.GetFirewallRuleGroupResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetFirewallRuleGroupResponse])
                res.get_firewall_rule_group_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def get_firewall_rule_group_association(self, request: operations.GetFirewallRuleGroupAssociationRequest) -> operations.GetFirewallRuleGroupAssociationResponse:
        ...
        res = operations.GetFirewallRuleGroupAssociationResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetFirewallRuleGroupAssociationResponse])
                res.get_firewall_rule_group_association_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def get_firewall_rule_group_policy(self, request: operations.GetFirewallRuleGroupPolicyRequest) -> operations.GetFirewallRuleGroupPolicyResponse:
        ...
        res = operations.GetFirewallRuleGroupPolicyResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetFirewallRuleGroupPolicyResponse])
                res.get_firewall_rule_group_policy_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.validation_exception = out
    ...
    def get_resolver_dnssec_config(self, request: operations.GetResolverDnssecConfigRequest) -> operations.GetResolverDnssecConfigResponse:
        ...
        res = operations.GetResolverDnssecConfigResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetResolverDnssecConfigResponse])
                res.get_resolver_dnssec_config_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.invalid_parameter_exception = out
    ...
    def get_resolver_endpoint(self, request: operations.GetResolverEndpointRequest) -> operations.GetResolverEndpointResponse:
        ...
        res = operations.GetResolverEndpointResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetResolverEndpointResponse])
                res.get_resolver_endpoint_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def get_resolver_query_log_config(self, request: operations.GetResolverQueryLogConfigRequest) -> operations.GetResolverQueryLogConfigResponse:
        ...
        res = operations.GetResolverQueryLogConfigResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetResolverQueryLogConfigResponse])
                res.get_resolver_query_log_config_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def get_resolver_query_log_config_association(self, request: operations.GetResolverQueryLogConfigAssociationRequest) -> operations.GetResolverQueryLogConfigAssociationResponse:
        ...
        res = operations.GetResolverQueryLogConfigAssociationResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetResolverQueryLogConfigAssociationResponse])
                res.get_resolver_query_log_config_association_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def get_resolver_query_log_config_policy(self, request: operations.GetResolverQueryLogConfigPolicyRequest) -> operations.GetResolverQueryLogConfigPolicyResponse:
        ...
        res = operations.GetResolverQueryLogConfigPolicyResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetResolverQueryLogConfigPolicyResponse])
                res.get_resolver_query_log_config_policy_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.invalid_parameter_exception = out
    ...
    def get_resolver_rule(self, request: operations.GetResolverRuleRequest) -> operations.GetResolverRuleResponse:
        ...
        res = operations.GetResolverRuleResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetResolverRuleResponse])
                res.get_resolver_rule_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def get_resolver_rule_association(self, request: operations.GetResolverRuleAssociationRequest) -> operations.GetResolverRuleAssociationResponse:
        ...
        res = operations.GetResolverRuleAssociationResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetResolverRuleAssociationResponse])
                res.get_resolver_rule_association_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def get_resolver_rule_policy(self, request: operations.GetResolverRulePolicyRequest) -> operations.GetResolverRulePolicyResponse:
        ...
        res = operations.GetResolverRulePolicyResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetResolverRulePolicyResponse])
                res.get_resolver_rule_policy_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.invalid_parameter_exception = out
    ...
    def import_firewall_domains(self, request: operations.ImportFirewallDomainsRequest) -> operations.ImportFirewallDomainsResponse:
        ...
        res = operations.ImportFirewallDomainsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ImportFirewallDomainsResponse])
                res.import_firewall_domains_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.validation_exception = out
    ...
    def list_firewall_configs(self, request: operations.ListFirewallConfigsRequest) -> operations.ListFirewallConfigsResponse:
        ...
        res = operations.ListFirewallConfigsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListFirewallConfigsResponse])
                res.list_firewall_configs_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.validation_exception = out
    ...
    def list_firewall_domain_lists(self, request: operations.ListFirewallDomainListsRequest) -> operations.ListFirewallDomainListsResponse:
        ...
        res = operations.ListFirewallDomainListsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListFirewallDomainListsResponse])
                res.list_firewall_domain_lists_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.validation_exception = out
    ...
    def list_firewall_domains(self, request: operations.ListFirewallDomainsRequest) -> operations.ListFirewallDomainsResponse:
        ...
        res = operations.ListFirewallDomainsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListFirewallDomainsResponse])
                res.list_firewall_domains_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def list_firewall_rule_group_associations(self, request: operations.ListFirewallRuleGroupAssociationsRequest) -> operations.ListFirewallRuleGroupAssociationsResponse:
        ...
        res = operations.ListFirewallRuleGroupAssociationsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListFirewallRuleGroupAssociationsResponse])
                res.list_firewall_rule_group_associations_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.validation_exception = out
    ...
    def list_firewall_rule_groups(self, request: operations.ListFirewallRuleGroupsRequest) -> operations.ListFirewallRuleGroupsResponse:
        ...
        res = operations.ListFirewallRuleGroupsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListFirewallRuleGroupsResponse])
                res.list_firewall_rule_groups_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.validation_exception = out
    ...
    def list_firewall_rules(self, request: operations.ListFirewallRulesRequest) -> operations.ListFirewallRulesResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListFirewallRulesResponse])
                res.list_firewall_rules_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def list_resolver_dnssec_configs(self, request: operations.ListResolverDnssecConfigsRequest) -> operations.ListResolverDnssecConfigsResponse:
        ...
        res = operations.ListResolverDnssecConfigsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListResolverDnssecConfigsResponse])
                res.list_resolver_dnssec_configs_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
    ...
    def list_resolver_endpoint_ip_addresses(self, request: operations.ListResolverEndpointIPAddressesRequest) -> operations.ListResolverEndpointIPAddressesResponse:
        ...
        res = operations.ListResolverEndpointIPAddressesResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListResolverEndpointIPAddressesResponse])
                res.list_resolver_endpoint_ip_addresses_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def list_resolver_endpoints(self, request: operations.ListResolverEndpointsRequest) -> operations.ListResolverEndpointsResponse:
        ...
        res = operations.ListResolverEndpointsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListResolverEndpointsResponse])
                res.list_resolver_endpoints_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.invalid_next_token_exception = out
    ...
    def list_resolver_query_log_config_associations(self, request: operations.ListResolverQueryLogConfigAssociationsRequest) -> operations.ListResolverQueryLogConfigAssociationsResponse:
        ...
        res = operations.ListResolverQueryLogConfigAssociationsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListResolverQueryLogConfigAssociationsResponse])
                res.list_resolver_query_log_config_associations_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.invalid_parameter_exception = out
    ...
    def list_resolver_query_log_configs(self, request: operations.ListResolverQueryLogConfigsRequest) -> operations.ListResolverQueryLogConfigsResponse:
        ...
        res = operations.ListResolverQueryLogConfigsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListResolverQueryLogConfigsResponse])
                res.list_resolver_query_log_configs_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.invalid_next_token_exception = out
    ...
    def list_resolver_rule_associations(self, request: operations.ListResolverRuleAssociationsRequest) -> operations.ListResolverRuleAssociationsResponse:
        ...
        res = operations.ListResolverRuleAssociationsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListResolverRuleAssociationsResponse])
                res.list_resolver_rule_associations_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.invalid_next_token_exception = out
    ...
    def list_resolver_rules(self, request: operations.ListResolverRulesRequest) -> operations.ListResolverRulesResponse:
        ...
        res = operations.ListResolverRulesResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListResolverRulesResponse])
                res.list_resolver_rules_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.invalid_next_token_exception = out
    ...
    def put_firewall_rule_group_policy(self, request: operations.PutFirewallRuleGroupPolicyRequest) -> operations.PutFirewallRuleGroupPolicyResponse:
        ...
        res = operations.PutFirewallRuleGroupPolicyResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PutFirewallRuleGroupPolicyResponse])
                res.put_firewall_rule_group_policy_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.validation_exception = out
    ...
    def put_resolver_query_log_config_policy(self, request: operations.PutResolverQueryLogConfigPolicyRequest) -> operations.PutResolverQueryLogConfigPolicyResponse:
        ...
        res = operations.PutResolverQueryLogConfigPolicyResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PutResolverQueryLogConfigPolicyResponse])
                res.put_resolver_query_log_config_policy_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.invalid_policy_document = out
        elif r.status_code == 481:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.invalid_parameter_exception = out
    ...
    def put_resolver_rule_policy(self, request: operations.PutResolverRulePolicyRequest) -> operations.PutResolverRulePolicyResponse:
        ...
        res = operations.PutResolverRulePolicyResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PutResolverRulePolicyResponse])
                res.put_resolver_rule_policy_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.invalid_policy_document = out
    ...
    def update_firewall_config(self, request: operations.UpdateFirewallConfigRequest) -> operations.UpdateFirewallConfigResponse:
        ...
        res = operations.UpdateFirewallConfigResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.UpdateFirewallConfigResponse])
                res.update_firewall_config_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.validation_exception = out
    ...
    def update_firewall_domains(self, request: operations.UpdateFirewallDomainsRequest) -> operations.UpdateFirewallDomainsResponse:
        ...
        res = operations.UpdateFirewallDomainsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.UpdateFirewallDomainsResponse])
                res.update_firewall_domains_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.validation_exception = out
    ...
    def update_firewall_rule(self, request: operations.UpdateFirewallRuleRequest) -> operations.UpdateFirewallRuleResponse:
        ...
        res = operations.UpdateFirewallRuleResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.UpdateFirewallRuleResponse])
                res.update_firewall_rule_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def update_firewall_rule_group_association(self, request: operations.UpdateFirewallRuleGroupAssociationRequest) -> operations.UpdateFirewallRuleGroupAssociationResponse:
        ...
        res = operations.UpdateFirewallRuleGroupAssociationResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.UpdateFirewallRuleGroupAssociationResponse])
                res.update_firewall_rule_group_association_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def update_resolver_dnssec_config(self, request: operations.UpdateResolverDnssecConfigRequest) -> operations.UpdateResolverDnssecConfigResponse:
        ...
        res = operations.UpdateResolverDnssecConfigResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.UpdateResolverDnssecConfigResponse])
                res.update_resolver_dnssec_config_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.invalid_parameter_exception = out
    ...
    def update_resolver_endpoint(self, request: operations.UpdateResolverEndpointRequest) -> operations.UpdateResolverEndpointResponse:
        ...
        res = operations.UpdateResolverEndpointResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.UpdateResolverEndpointResponse])
                res.update_resolver_endpoint_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.resource_not_found_exception = out
    ...
    def update_resolver_rule(self, request: operations.UpdateResolverRuleRequest) -> operations.UpdateResolverRuleResponse:
        ...
        res = operations.UpdateResolverRuleResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.UpdateResolverRuleResponse])
                res.update_resolver_rule_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.invalid_request_exception = out
