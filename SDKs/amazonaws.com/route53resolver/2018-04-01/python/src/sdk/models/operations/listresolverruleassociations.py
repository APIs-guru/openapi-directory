...
class ListResolverRuleAssociationsHeaders:
    ...
    x_amz_target: ListResolverRuleAssociationsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ListResolverRuleAssociationsRequest:
    query_params: ListResolverRuleAssociationsQueryParams = field(default=None)
    headers: ListResolverRuleAssociationsHeaders = field(default=None)
    request: shared.ListResolverRuleAssociationsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
