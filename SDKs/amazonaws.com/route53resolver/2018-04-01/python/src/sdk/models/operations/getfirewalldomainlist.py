...
class GetFirewallDomainListHeaders:
    x_amz_target: GetFirewallDomainListXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetFirewallDomainListRequest:
    headers: GetFirewallDomainListHeaders = field()
    request: shared.GetFirewallDomainListRequest = field(metadata={'request': { 'media_type': 'application/json' }})
