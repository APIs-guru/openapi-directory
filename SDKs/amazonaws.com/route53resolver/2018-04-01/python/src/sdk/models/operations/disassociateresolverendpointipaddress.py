...
class DisassociateResolverEndpointIPAddressHeaders:
    x_amz_target: DisassociateResolverEndpointIPAddressXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DisassociateResolverEndpointIPAddressRequest:
    headers: DisassociateResolverEndpointIPAddressHeaders = field()
    request: shared.DisassociateResolverEndpointIPAddressRequest = field(metadata={'request': { 'media_type': 'application/json' }})
