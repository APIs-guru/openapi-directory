...
class DeleteFirewallRuleGroupHeaders:
    ...
    x_amz_target: DeleteFirewallRuleGroupXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeleteFirewallRuleGroupRequest:
    headers: DeleteFirewallRuleGroupHeaders = field(default=None)
    request: shared.DeleteFirewallRuleGroupRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
