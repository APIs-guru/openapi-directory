...
class ListFirewallConfigsHeaders:
    x_amz_target: ListFirewallConfigsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListFirewallConfigsRequest:
    headers: ListFirewallConfigsHeaders = field()
    query_params: ListFirewallConfigsQueryParams = field()
    request: shared.ListFirewallConfigsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
