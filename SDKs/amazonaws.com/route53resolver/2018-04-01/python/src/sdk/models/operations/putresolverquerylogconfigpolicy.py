...
class PutResolverQueryLogConfigPolicyHeaders:
    x_amz_target: PutResolverQueryLogConfigPolicyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutResolverQueryLogConfigPolicyRequest:
    headers: PutResolverQueryLogConfigPolicyHeaders = field()
    request: shared.PutResolverQueryLogConfigPolicyRequest = field(metadata={'request': { 'media_type': 'application/json' }})
