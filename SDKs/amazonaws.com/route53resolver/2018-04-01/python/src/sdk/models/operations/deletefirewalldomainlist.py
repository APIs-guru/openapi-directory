...
class DeleteFirewallDomainListHeaders:
    x_amz_target: DeleteFirewallDomainListXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteFirewallDomainListRequest:
    headers: DeleteFirewallDomainListHeaders = field()
    request: shared.DeleteFirewallDomainListRequest = field(metadata={'request': { 'media_type': 'application/json' }})
