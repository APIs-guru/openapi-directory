...
class CreateResolverRuleHeaders:
    x_amz_target: CreateResolverRuleXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateResolverRuleRequest:
    headers: CreateResolverRuleHeaders = field()
    request: shared.CreateResolverRuleRequest = field(metadata={'request': { 'media_type': 'application/json' }})
