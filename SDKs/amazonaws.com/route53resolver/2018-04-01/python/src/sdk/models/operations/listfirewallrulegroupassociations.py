...
class ListFirewallRuleGroupAssociationsHeaders:
    x_amz_target: ListFirewallRuleGroupAssociationsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListFirewallRuleGroupAssociationsRequest:
    headers: ListFirewallRuleGroupAssociationsHeaders = field()
    query_params: ListFirewallRuleGroupAssociationsQueryParams = field()
    request: shared.ListFirewallRuleGroupAssociationsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
