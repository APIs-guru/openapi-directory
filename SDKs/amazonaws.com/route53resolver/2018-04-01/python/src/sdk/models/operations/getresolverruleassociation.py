...
class GetResolverRuleAssociationHeaders:
    x_amz_target: GetResolverRuleAssociationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetResolverRuleAssociationRequest:
    headers: GetResolverRuleAssociationHeaders = field()
    request: shared.GetResolverRuleAssociationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
