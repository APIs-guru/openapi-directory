...
class AssociateResolverRuleHeaders:
    ...
    x_amz_target: AssociateResolverRuleXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class AssociateResolverRuleRequest:
    headers: AssociateResolverRuleHeaders = field(default=None)
    request: shared.AssociateResolverRuleRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
