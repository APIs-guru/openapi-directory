...
class UpdateFirewallRuleHeaders:
    x_amz_target: UpdateFirewallRuleXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateFirewallRuleRequest:
    headers: UpdateFirewallRuleHeaders = field()
    request: shared.UpdateFirewallRuleRequest = field(metadata={'request': { 'media_type': 'application/json' }})
