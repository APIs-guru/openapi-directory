...
class ListResolverEndpointIPAddressesHeaders:
    x_amz_target: ListResolverEndpointIPAddressesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListResolverEndpointIPAddressesRequest:
    headers: ListResolverEndpointIPAddressesHeaders = field()
    query_params: ListResolverEndpointIPAddressesQueryParams = field()
    request: shared.ListResolverEndpointIPAddressesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
