...
class ListResolverEndpointsHeaders:
    x_amz_target: ListResolverEndpointsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListResolverEndpointsRequest:
    headers: ListResolverEndpointsHeaders = field()
    query_params: ListResolverEndpointsQueryParams = field()
    request: shared.ListResolverEndpointsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
