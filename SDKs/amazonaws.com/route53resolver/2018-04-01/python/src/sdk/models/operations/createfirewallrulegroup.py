...
class CreateFirewallRuleGroupHeaders:
    x_amz_target: CreateFirewallRuleGroupXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateFirewallRuleGroupRequest:
    headers: CreateFirewallRuleGroupHeaders = field()
    request: shared.CreateFirewallRuleGroupRequest = field(metadata={'request': { 'media_type': 'application/json' }})
