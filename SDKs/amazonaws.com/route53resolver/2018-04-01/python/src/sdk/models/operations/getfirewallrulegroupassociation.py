...
class GetFirewallRuleGroupAssociationHeaders:
    x_amz_target: GetFirewallRuleGroupAssociationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetFirewallRuleGroupAssociationRequest:
    headers: GetFirewallRuleGroupAssociationHeaders = field()
    request: shared.GetFirewallRuleGroupAssociationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
