...
class GetFirewallConfigHeaders:
    x_amz_target: GetFirewallConfigXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetFirewallConfigRequest:
    headers: GetFirewallConfigHeaders = field()
    request: shared.GetFirewallConfigRequest = field(metadata={'request': { 'media_type': 'application/json' }})
