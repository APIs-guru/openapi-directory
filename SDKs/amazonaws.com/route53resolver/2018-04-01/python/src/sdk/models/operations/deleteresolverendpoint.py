...
class DeleteResolverEndpointHeaders:
    x_amz_target: DeleteResolverEndpointXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteResolverEndpointRequest:
    headers: DeleteResolverEndpointHeaders = field()
    request: shared.DeleteResolverEndpointRequest = field(metadata={'request': { 'media_type': 'application/json' }})
