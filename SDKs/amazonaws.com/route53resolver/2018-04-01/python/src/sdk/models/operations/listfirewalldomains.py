...
class ListFirewallDomainsHeaders:
    x_amz_target: ListFirewallDomainsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListFirewallDomainsRequest:
    headers: ListFirewallDomainsHeaders = field()
    query_params: ListFirewallDomainsQueryParams = field()
    request: shared.ListFirewallDomainsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
