...
class ListResolverQueryLogConfigsHeaders:
    x_amz_target: ListResolverQueryLogConfigsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListResolverQueryLogConfigsRequest:
    headers: ListResolverQueryLogConfigsHeaders = field()
    query_params: ListResolverQueryLogConfigsQueryParams = field()
    request: shared.ListResolverQueryLogConfigsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
