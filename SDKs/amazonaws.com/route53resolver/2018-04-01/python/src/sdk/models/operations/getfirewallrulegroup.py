...
class GetFirewallRuleGroupHeaders:
    x_amz_target: GetFirewallRuleGroupXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetFirewallRuleGroupRequest:
    headers: GetFirewallRuleGroupHeaders = field()
    request: shared.GetFirewallRuleGroupRequest = field(metadata={'request': { 'media_type': 'application/json' }})
