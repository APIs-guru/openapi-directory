...
class ListFirewallRuleGroupsHeaders:
    x_amz_target: ListFirewallRuleGroupsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListFirewallRuleGroupsRequest:
    headers: ListFirewallRuleGroupsHeaders = field()
    query_params: ListFirewallRuleGroupsQueryParams = field()
    request: shared.ListFirewallRuleGroupsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
