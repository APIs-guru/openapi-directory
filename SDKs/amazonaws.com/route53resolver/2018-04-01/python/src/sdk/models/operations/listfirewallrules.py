...
class ListFirewallRulesHeaders:
    x_amz_target: ListFirewallRulesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListFirewallRulesRequest:
    headers: ListFirewallRulesHeaders = field()
    query_params: ListFirewallRulesQueryParams = field()
    request: shared.ListFirewallRulesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
