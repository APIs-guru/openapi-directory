...
class GetResolverQueryLogConfigAssociationHeaders:
    x_amz_target: GetResolverQueryLogConfigAssociationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetResolverQueryLogConfigAssociationRequest:
    headers: GetResolverQueryLogConfigAssociationHeaders = field()
    request: shared.GetResolverQueryLogConfigAssociationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
