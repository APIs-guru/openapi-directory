...
class DeleteFirewallRuleHeaders:
    x_amz_target: DeleteFirewallRuleXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteFirewallRuleRequest:
    headers: DeleteFirewallRuleHeaders = field()
    request: shared.DeleteFirewallRuleRequest = field(metadata={'request': { 'media_type': 'application/json' }})
