...
class GetResolverRulePolicyHeaders:
    x_amz_target: GetResolverRulePolicyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetResolverRulePolicyRequest:
    headers: GetResolverRulePolicyHeaders = field()
    request: shared.GetResolverRulePolicyRequest = field(metadata={'request': { 'media_type': 'application/json' }})
