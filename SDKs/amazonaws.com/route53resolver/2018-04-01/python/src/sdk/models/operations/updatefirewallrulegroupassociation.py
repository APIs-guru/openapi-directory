...
class UpdateFirewallRuleGroupAssociationHeaders:
    x_amz_target: UpdateFirewallRuleGroupAssociationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateFirewallRuleGroupAssociationRequest:
    headers: UpdateFirewallRuleGroupAssociationHeaders = field()
    request: shared.UpdateFirewallRuleGroupAssociationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
