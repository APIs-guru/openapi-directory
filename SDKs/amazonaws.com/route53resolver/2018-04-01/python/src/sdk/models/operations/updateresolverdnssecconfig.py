...
class UpdateResolverDnssecConfigHeaders:
    x_amz_target: UpdateResolverDnssecConfigXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateResolverDnssecConfigRequest:
    headers: UpdateResolverDnssecConfigHeaders = field()
    request: shared.UpdateResolverDnssecConfigRequest = field(metadata={'request': { 'media_type': 'application/json' }})
