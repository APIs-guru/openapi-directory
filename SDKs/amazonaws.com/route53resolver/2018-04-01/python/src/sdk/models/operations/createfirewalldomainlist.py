...
class CreateFirewallDomainListHeaders:
    x_amz_target: CreateFirewallDomainListXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateFirewallDomainListRequest:
    headers: CreateFirewallDomainListHeaders = field()
    request: shared.CreateFirewallDomainListRequest = field(metadata={'request': { 'media_type': 'application/json' }})
