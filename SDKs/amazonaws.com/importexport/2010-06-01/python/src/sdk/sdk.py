...
class SDK:
    ...
    def get_cancel_job(self, request: operations.GetCancelJobRequest) -> operations.GetCancelJobResponse:
        ...
        res = operations.GetCancelJobResponse(status_code=r.status_code, content_type=content_type)
    ...
    def get_create_job(self, request: operations.GetCreateJobRequest) -> operations.GetCreateJobResponse:
        ...
        res = operations.GetCreateJobResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "text/xml"):
                res.body = r.content
        elif r.status_code == 480:
    ...
    def get_get_shipping_label(self, request: operations.GetGetShippingLabelRequest) -> operations.GetGetShippingLabelResponse:
        ...
        res = operations.GetGetShippingLabelResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "text/xml"):
                res.body = r.content
        elif r.status_code == 480:
    ...
    def get_get_status(self, request: operations.GetGetStatusRequest) -> operations.GetGetStatusResponse:
        ...
        res = operations.GetGetStatusResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "text/xml"):
                res.body = r.content
        elif r.status_code == 480:
    ...
    def get_list_jobs(self, request: operations.GetListJobsRequest) -> operations.GetListJobsResponse:
        ...
        res = operations.GetListJobsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "text/xml"):
                res.body = r.content
        elif r.status_code == 480:
    ...
    def get_update_job(self, request: operations.GetUpdateJobRequest) -> operations.GetUpdateJobResponse:
        ...
        res = operations.GetUpdateJobResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "text/xml"):
                res.body = r.content
        elif r.status_code == 480:
    ...
    def post_cancel_job(self, request: operations.PostCancelJobRequest) -> operations.PostCancelJobResponse:
        ...
        res = operations.PostCancelJobResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "text/xml"):
                res.body = r.content
        elif r.status_code == 480:
    ...
    def post_create_job(self, request: operations.PostCreateJobRequest) -> operations.PostCreateJobResponse:
        ...
        res = operations.PostCreateJobResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "text/xml"):
                res.body = r.content
        elif r.status_code == 480:
    ...
    def post_get_shipping_label(self, request: operations.PostGetShippingLabelRequest) -> operations.PostGetShippingLabelResponse:
        ...
        res = operations.PostGetShippingLabelResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "text/xml"):
                res.body = r.content
        elif r.status_code == 480:
    ...
    def post_get_status(self, request: operations.PostGetStatusRequest) -> operations.PostGetStatusResponse:
        ...
        res = operations.PostGetStatusResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "text/xml"):
                res.body = r.content
        elif r.status_code == 480:
    ...
    def post_list_jobs(self, request: operations.PostListJobsRequest) -> operations.PostListJobsResponse:
        ...
        res = operations.PostListJobsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "text/xml"):
                res.body = r.content
        elif r.status_code == 480:
    ...
    def post_update_job(self, request: operations.PostUpdateJobRequest) -> operations.PostUpdateJobResponse:
        ...
        res = operations.PostUpdateJobResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "text/xml"):
                res.body = r.content
        elif r.status_code == 480:
