...
class GetGetShippingLabelQueryParams:
    ...
    action: GetGetShippingLabelActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    operation: GetGetShippingLabelOperationEnum = field(default=None, metadata={'query_param': { 'field_name': 'Operation', 'style': 'form', 'explode': True }})
    ...
    version: GetGetShippingLabelVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
    ...
    job_ids: List[str] = field(default=None, metadata={'query_param': { 'field_name': 'jobIds', 'style': 'form', 'explode': True }})
...
class GetGetShippingLabelRequest:
    query_params: GetGetShippingLabelQueryParams = field(default=None)
