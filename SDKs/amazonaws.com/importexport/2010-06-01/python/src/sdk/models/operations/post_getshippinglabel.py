...
class PostGetShippingLabelQueryParams:
    ...
    action: PostGetShippingLabelActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    operation: PostGetShippingLabelOperationEnum = field(metadata={'query_param': { 'field_name': 'Operation', 'style': 'form', 'explode': True }})
    ...
    version: PostGetShippingLabelVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
    

@dataclass
class PostGetShippingLabelRequest:
    query_params: PostGetShippingLabelQueryParams = field()
