...
class PostCancelJobQueryParams:
    ...
    action: PostCancelJobActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    operation: PostCancelJobOperationEnum = field(default=None, metadata={'query_param': { 'field_name': 'Operation', 'style': 'form', 'explode': True }})
    ...
    version: PostCancelJobVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
    

@dataclass
class PostCancelJobRequest:
    query_params: PostCancelJobQueryParams = field(default=None)
