...
class PostListJobsQueryParams:
    ...
    action: PostListJobsActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    operation: PostListJobsOperationEnum = field(default=None, metadata={'query_param': { 'field_name': 'Operation', 'style': 'form', 'explode': True }})
    ...
    version: PostListJobsVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
    

@dataclass
class PostListJobsRequest:
    query_params: PostListJobsQueryParams = field(default=None)
