...
var DeleteFhirDatastoreResponse = /** @class */ (function (_super) {
    ...
    ], DeleteFhirDatastoreResponse.prototype, "datastoreArn", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=DatastoreEndpoint" }),
        __metadata("design:type", String)
    ], DeleteFhirDatastoreResponse.prototype, "datastoreEndpoint", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=DatastoreId" }),
        __metadata("design:type", String)
    ], DeleteFhirDatastoreResponse.prototype, "datastoreId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=DatastoreStatus" }),
        __metadata("design:type", String)
    ], DeleteFhirDatastoreResponse.prototype, "datastoreStatus", void 0);
