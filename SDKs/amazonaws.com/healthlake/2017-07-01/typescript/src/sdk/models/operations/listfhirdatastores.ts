...
export class ListFhirDatastoresQueryParams extends SpeakeasyBase {
...
export enum ListFhirDatastoresXAmzTargetEnum {
    HealthLakeListFhirDatastores = "HealthLake.ListFHIRDatastores"
}


export class ListFhirDatastoresHeaders extends SpeakeasyBase {
