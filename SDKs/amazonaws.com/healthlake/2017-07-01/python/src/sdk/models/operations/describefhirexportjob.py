...
class DescribeFhirExportJobHeaders:
    ...
    x_amz_target: DescribeFhirExportJobXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
    

@dataclass
class DescribeFhirExportJobRequest:
    headers: DescribeFhirExportJobHeaders = field(default=None)
    request: shared.DescribeFhirExportJobRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
