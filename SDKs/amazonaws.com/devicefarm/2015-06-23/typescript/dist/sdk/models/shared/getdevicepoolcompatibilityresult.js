...
**/
var GetDevicePoolCompatibilityResult = /** @class */ (function (_super) {
    __extends(GetDevicePoolCompatibilityResult, _super);
    ...
    ], GetDevicePoolCompatibilityResult.prototype, "compatibleDevices", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=incompatibleDevices", elemType: DevicePoolCompatibilityResult }),
        __metadata("design:type", Array)
    ], GetDevicePoolCompatibilityResult.prototype, "incompatibleDevices", void 0);
    return GetDevicePoolCompatibilityResult;
}(SpeakeasyBase));
export { GetDevicePoolCompatibilityResult };
