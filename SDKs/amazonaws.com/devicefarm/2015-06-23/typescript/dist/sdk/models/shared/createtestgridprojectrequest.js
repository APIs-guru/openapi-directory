...
var CreateTestGridProjectRequest = /** @class */ (function (_super) {
    ...
    ], CreateTestGridProjectRequest.prototype, "description", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=name" }),
        __metadata("design:type", String)
    ], CreateTestGridProjectRequest.prototype, "name", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=vpcConfig" }),
        __metadata("design:type", TestGridVpcConfig)
    ], CreateTestGridProjectRequest.prototype, "vpcConfig", void 0);
