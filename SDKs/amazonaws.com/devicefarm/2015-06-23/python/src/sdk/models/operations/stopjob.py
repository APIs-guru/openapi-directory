...
class StopJobHeaders:
    x_amz_target: StopJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StopJobRequest:
    ...
    request: shared.StopJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
