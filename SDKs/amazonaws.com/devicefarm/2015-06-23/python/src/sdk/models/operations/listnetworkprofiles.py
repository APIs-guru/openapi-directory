...
class ListNetworkProfilesHeaders:
    ...
    x_amz_target: ListNetworkProfilesXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ListNetworkProfilesRequest:
    headers: ListNetworkProfilesHeaders = field(default=None)
    request: shared.ListNetworkProfilesRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
