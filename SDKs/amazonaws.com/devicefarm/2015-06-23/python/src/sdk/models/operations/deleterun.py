...
class DeleteRunHeaders:
    x_amz_target: DeleteRunXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteRunRequest:
    headers: DeleteRunHeaders = field()
    request: shared.DeleteRunRequest = field(metadata={'request': { 'media_type': 'application/json' }})
