...
class CreateInstanceProfileHeaders:
    x_amz_target: CreateInstanceProfileXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateInstanceProfileRequest:
    headers: CreateInstanceProfileHeaders = field()
    request: shared.CreateInstanceProfileRequest = field(metadata={'request': { 'media_type': 'application/json' }})
