...
class GetDevicePoolHeaders:
    x_amz_target: GetDevicePoolXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetDevicePoolRequest:
    headers: GetDevicePoolHeaders = field()
    request: shared.GetDevicePoolRequest = field(metadata={'request': { 'media_type': 'application/json' }})
