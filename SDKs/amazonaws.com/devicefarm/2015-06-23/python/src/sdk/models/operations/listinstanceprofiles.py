...
class ListInstanceProfilesHeaders:
    x_amz_target: ListInstanceProfilesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListInstanceProfilesRequest:
    headers: ListInstanceProfilesHeaders = field()
    request: shared.ListInstanceProfilesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
