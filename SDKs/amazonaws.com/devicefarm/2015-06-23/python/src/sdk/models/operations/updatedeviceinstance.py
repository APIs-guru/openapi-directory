...
class UpdateDeviceInstanceHeaders:
    x_amz_target: UpdateDeviceInstanceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateDeviceInstanceRequest:
    headers: UpdateDeviceInstanceHeaders = field()
    request: shared.UpdateDeviceInstanceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
