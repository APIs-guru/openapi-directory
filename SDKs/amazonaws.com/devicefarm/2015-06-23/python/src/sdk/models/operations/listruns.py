...
class ListRunsHeaders:
    x_amz_target: ListRunsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListRunsRequest:
    headers: ListRunsHeaders = field()
    query_params: ListRunsQueryParams = field()
    request: shared.ListRunsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
