...
class ListVpceConfigurationsHeaders:
    x_amz_target: ListVpceConfigurationsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListVpceConfigurationsRequest:
    headers: ListVpceConfigurationsHeaders = field()
    request: shared.ListVpceConfigurationsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
