...
class ListOfferingsHeaders:
    x_amz_target: ListOfferingsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListOfferingsRequest:
    headers: ListOfferingsHeaders = field()
    query_params: ListOfferingsQueryParams = field()
    request: shared.ListOfferingsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
