...
class GetOfferingStatusHeaders:
    ...
    x_amz_target: GetOfferingStatusXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetOfferingStatusRequest:
    query_params: GetOfferingStatusQueryParams = field(default=None)
    headers: GetOfferingStatusHeaders = field(default=None)
    request: shared.GetOfferingStatusRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
