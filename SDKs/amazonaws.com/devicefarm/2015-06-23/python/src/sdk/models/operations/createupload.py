...
class CreateUploadHeaders:
    ...
    x_amz_target: CreateUploadXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
    

@dataclass
class CreateUploadRequest:
    headers: CreateUploadHeaders = field(default=None)
    request: shared.CreateUploadRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
