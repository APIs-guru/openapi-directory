...
class GetSuiteHeaders:
    x_amz_target: GetSuiteXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetSuiteRequest:
    headers: GetSuiteHeaders = field()
    request: shared.GetSuiteRequest = field(metadata={'request': { 'media_type': 'application/json' }})
