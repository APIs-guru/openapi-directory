...
class StopRemoteAccessSessionHeaders:
    x_amz_target: StopRemoteAccessSessionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StopRemoteAccessSessionRequest:
    headers: StopRemoteAccessSessionHeaders = field()
    request: shared.StopRemoteAccessSessionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
