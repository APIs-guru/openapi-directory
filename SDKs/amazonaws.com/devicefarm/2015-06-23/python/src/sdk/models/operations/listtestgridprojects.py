...
class ListTestGridProjectsHeaders:
    x_amz_target: ListTestGridProjectsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListTestGridProjectsRequest:
    headers: ListTestGridProjectsHeaders = field()
    query_params: ListTestGridProjectsQueryParams = field()
    request: shared.ListTestGridProjectsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
