...
class UpdateProjectHeaders:
    ...
    x_amz_target: UpdateProjectXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateProjectRequest:
    headers: UpdateProjectHeaders = field(default=None)
    request: shared.UpdateProjectRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
