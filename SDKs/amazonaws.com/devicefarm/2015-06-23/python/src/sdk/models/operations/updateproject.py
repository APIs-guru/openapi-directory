...
class UpdateProjectHeaders:
    x_amz_target: UpdateProjectXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateProjectRequest:
    ...
    request: shared.UpdateProjectRequest = field(metadata={'request': { 'media_type': 'application/json' }})
