...
class UpdateVpceConfigurationHeaders:
    ...
    x_amz_target: UpdateVpceConfigurationXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateVpceConfigurationRequest:
    headers: UpdateVpceConfigurationHeaders = field(default=None)
    request: shared.UpdateVpceConfigurationRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
