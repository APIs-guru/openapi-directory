...
class CreateTestGridProjectHeaders:
    x_amz_target: CreateTestGridProjectXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateTestGridProjectRequest:
    headers: CreateTestGridProjectHeaders = field()
    request: shared.CreateTestGridProjectRequest = field(metadata={'request': { 'media_type': 'application/json' }})
