...
class GetInstanceProfileHeaders:
    x_amz_target: GetInstanceProfileXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetInstanceProfileRequest:
    headers: GetInstanceProfileHeaders = field()
    request: shared.GetInstanceProfileRequest = field(metadata={'request': { 'media_type': 'application/json' }})
