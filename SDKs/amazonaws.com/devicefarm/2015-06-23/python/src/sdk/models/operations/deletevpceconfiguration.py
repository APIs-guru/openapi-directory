...
class DeleteVpceConfigurationHeaders:
    x_amz_target: DeleteVpceConfigurationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteVpceConfigurationRequest:
    headers: DeleteVpceConfigurationHeaders = field()
    request: shared.DeleteVpceConfigurationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
