...
class ListTestGridSessionActionsHeaders:
    x_amz_target: ListTestGridSessionActionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListTestGridSessionActionsRequest:
    headers: ListTestGridSessionActionsHeaders = field()
    query_params: ListTestGridSessionActionsQueryParams = field()
    request: shared.ListTestGridSessionActionsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
