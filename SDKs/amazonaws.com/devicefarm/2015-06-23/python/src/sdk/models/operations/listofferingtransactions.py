...
class ListOfferingTransactionsHeaders:
    x_amz_target: ListOfferingTransactionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListOfferingTransactionsRequest:
    headers: ListOfferingTransactionsHeaders = field()
    query_params: ListOfferingTransactionsQueryParams = field()
    request: shared.ListOfferingTransactionsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
