...
class ListTestGridSessionArtifactsHeaders:
    ...
    x_amz_target: ListTestGridSessionArtifactsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ListTestGridSessionArtifactsRequest:
    query_params: ListTestGridSessionArtifactsQueryParams = field(default=None)
    headers: ListTestGridSessionArtifactsHeaders = field(default=None)
    request: shared.ListTestGridSessionArtifactsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
