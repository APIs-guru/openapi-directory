...
class GetNetworkProfileHeaders:
    ...
    x_amz_target: GetNetworkProfileXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
    

@dataclass
class GetNetworkProfileRequest:
    headers: GetNetworkProfileHeaders = field(default=None)
    request: shared.GetNetworkProfileRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
