...
class ListArtifactsHeaders:
    ...
    x_amz_target: ListArtifactsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListArtifactsRequest:
    ...
    request: shared.ListArtifactsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
