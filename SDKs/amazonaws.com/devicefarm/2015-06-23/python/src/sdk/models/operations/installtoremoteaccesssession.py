...
class InstallToRemoteAccessSessionHeaders:
    x_amz_target: InstallToRemoteAccessSessionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class InstallToRemoteAccessSessionRequest:
    headers: InstallToRemoteAccessSessionHeaders = field()
    request: shared.InstallToRemoteAccessSessionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
