...
class CreateTestGridURLHeaders:
    x_amz_target: CreateTestGridURLXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateTestGridURLRequest:
    headers: CreateTestGridURLHeaders = field()
    request: shared.CreateTestGridURLRequest = field(metadata={'request': { 'media_type': 'application/json' }})
