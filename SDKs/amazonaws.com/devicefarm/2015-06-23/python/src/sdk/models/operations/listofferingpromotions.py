...
class ListOfferingPromotionsHeaders:
    x_amz_target: ListOfferingPromotionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListOfferingPromotionsRequest:
    headers: ListOfferingPromotionsHeaders = field()
    request: shared.ListOfferingPromotionsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
