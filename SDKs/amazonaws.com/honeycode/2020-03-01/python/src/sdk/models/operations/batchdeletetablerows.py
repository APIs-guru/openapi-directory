...
class BatchDeleteTableRowsRequest:
    headers: BatchDeleteTableRowsHeaders = field()
    path_params: BatchDeleteTableRowsPathParams = field()
    request: BatchDeleteTableRowsRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
