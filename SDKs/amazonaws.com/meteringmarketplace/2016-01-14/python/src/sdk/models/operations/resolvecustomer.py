...
class ResolveCustomerHeaders:
    x_amz_target: ResolveCustomerXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ResolveCustomerRequest:
    headers: ResolveCustomerHeaders = field()
    request: shared.ResolveCustomerRequest = field(metadata={'request': { 'media_type': 'application/json' }})
