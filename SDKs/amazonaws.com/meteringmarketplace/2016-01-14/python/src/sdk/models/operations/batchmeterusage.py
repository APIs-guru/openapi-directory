...
class BatchMeterUsageHeaders:
    x_amz_target: BatchMeterUsageXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class BatchMeterUsageRequest:
    headers: BatchMeterUsageHeaders = field()
    request: shared.BatchMeterUsageRequest = field(metadata={'request': { 'media_type': 'application/json' }})
