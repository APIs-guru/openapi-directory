...
class MeterUsageHeaders:
    ...
    x_amz_target: MeterUsageXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class MeterUsageRequest:
    headers: MeterUsageHeaders = field(default=None)
    request: shared.MeterUsageRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class MeterUsageResponse:
    ...
    invalid_endpoint_region_exception: Optional[Any] = field(default=None)
    ...
    meter_usage_result: Optional[shared.MeterUsageResult] = field(default=None)
