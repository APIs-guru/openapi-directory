...
class GetProductsHeaders:
    x_amz_target: GetProductsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetProductsRequest:
    headers: GetProductsHeaders = field()
    query_params: GetProductsQueryParams = field()
    request: shared.GetProductsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
