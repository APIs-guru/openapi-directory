...
var DescribeServicesQueryParams = /** @class */ (function (_super) {
    __extends(DescribeServicesQueryParams, _super);
    function DescribeServicesQueryParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=MaxResults" }),
        __metadata("design:type", String)
    ], DescribeServicesQueryParams.prototype, "maxResults", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=NextToken" }),
        __metadata("design:type", String)
    ], DescribeServicesQueryParams.prototype, "nextToken", void 0);
    return DescribeServicesQueryParams;
}(SpeakeasyBase));
export { DescribeServicesQueryParams };
export var DescribeServicesXAmzTargetEnum;
(function (DescribeServicesXAmzTargetEnum) {
    DescribeServicesXAmzTargetEnum["AwsPriceListServiceDescribeServices"] = "AWSPriceListService.DescribeServices";
...
var DescribeServicesRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", DescribeServicesQueryParams)
    ], DescribeServicesRequest.prototype, "queryParams", void 0);
    __decorate([
        SpeakeasyMetadata(),
...
var DescribeServicesResponse = /** @class */ (function (_super) {
    ...
    ], DescribeServicesResponse.prototype, "expiredNextTokenException", void 0);
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", Object)
    ], DescribeServicesResponse.prototype, "internalErrorException", void 0);
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", Object)
    ], DescribeServicesResponse.prototype, "invalidNextTokenException", void 0);
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", Object)
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", Object)
    ], DescribeServicesResponse.prototype, "notFoundException", void 0);
    __decorate([
        SpeakeasyMetadata(),
