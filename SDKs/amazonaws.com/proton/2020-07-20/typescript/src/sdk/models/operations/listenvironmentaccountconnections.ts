...
export class ListEnvironmentAccountConnectionsQueryParams extends SpeakeasyBase {
...
export enum ListEnvironmentAccountConnectionsXAmzTargetEnum {
    AwsProton20200720ListEnvironmentAccountConnections = "AwsProton20200720.ListEnvironmentAccountConnections"
}


export class ListEnvironmentAccountConnectionsHeaders extends SpeakeasyBase {
...
export class ListEnvironmentAccountConnectionsRequest extends SpeakeasyBase {
  @Metadata()
...
export class ListEnvironmentAccountConnectionsResponse extends SpeakeasyBase {
  @Metadata()
