...
class ListServiceTemplateVersionsHeaders:
    x_amz_target: ListServiceTemplateVersionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListServiceTemplateVersionsRequest:
    headers: ListServiceTemplateVersionsHeaders = field()
    query_params: ListServiceTemplateVersionsQueryParams = field()
    request: shared.ListServiceTemplateVersionsInput = field(metadata={'request': { 'media_type': 'application/json' }})
