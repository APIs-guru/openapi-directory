...
class CreateEnvironmentTemplateHeaders:
    x_amz_target: CreateEnvironmentTemplateXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateEnvironmentTemplateRequest:
    headers: CreateEnvironmentTemplateHeaders = field()
    request: shared.CreateEnvironmentTemplateInput = field(metadata={'request': { 'media_type': 'application/json' }})
