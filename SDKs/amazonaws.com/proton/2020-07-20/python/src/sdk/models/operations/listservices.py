...
class ListServicesRequest:
    ...
    request: shared.ListServicesInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class ListServicesResponse:
    ...
    list_services_output: Optional[shared.ListServicesOutput] = field(default=None)
