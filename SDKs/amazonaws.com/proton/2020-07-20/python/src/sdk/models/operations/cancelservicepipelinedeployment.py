...
class CancelServicePipelineDeploymentHeaders:
    x_amz_target: CancelServicePipelineDeploymentXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CancelServicePipelineDeploymentRequest:
    headers: CancelServicePipelineDeploymentHeaders = field()
    request: shared.CancelServicePipelineDeploymentInput = field(metadata={'request': { 'media_type': 'application/json' }})
