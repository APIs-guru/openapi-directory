...
class CreateServiceRequest:
    ...
    request: shared.CreateServiceInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class CreateServiceResponse:
    ...
    create_service_output: Optional[shared.CreateServiceOutput] = field(default=None)
