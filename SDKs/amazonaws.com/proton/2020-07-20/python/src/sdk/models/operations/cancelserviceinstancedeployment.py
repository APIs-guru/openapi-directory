...
class CancelServiceInstanceDeploymentHeaders:
    x_amz_target: CancelServiceInstanceDeploymentXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CancelServiceInstanceDeploymentRequest:
    headers: CancelServiceInstanceDeploymentHeaders = field()
    request: shared.CancelServiceInstanceDeploymentInput = field(metadata={'request': { 'media_type': 'application/json' }})
