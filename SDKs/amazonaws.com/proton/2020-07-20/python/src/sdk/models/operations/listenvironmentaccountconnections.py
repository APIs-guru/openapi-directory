...
class ListEnvironmentAccountConnectionsHeaders:
    x_amz_target: ListEnvironmentAccountConnectionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListEnvironmentAccountConnectionsRequest:
    headers: ListEnvironmentAccountConnectionsHeaders = field()
    query_params: ListEnvironmentAccountConnectionsQueryParams = field()
    request: shared.ListEnvironmentAccountConnectionsInput = field(metadata={'request': { 'media_type': 'application/json' }})
