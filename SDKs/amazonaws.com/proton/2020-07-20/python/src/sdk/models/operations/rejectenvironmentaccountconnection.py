...
class RejectEnvironmentAccountConnectionHeaders:
    x_amz_target: RejectEnvironmentAccountConnectionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RejectEnvironmentAccountConnectionRequest:
    headers: RejectEnvironmentAccountConnectionHeaders = field()
    request: shared.RejectEnvironmentAccountConnectionInput = field(metadata={'request': { 'media_type': 'application/json' }})
