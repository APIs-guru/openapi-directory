...
class CreateEnvironmentAccountConnectionHeaders:
    x_amz_target: CreateEnvironmentAccountConnectionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateEnvironmentAccountConnectionRequest:
    headers: CreateEnvironmentAccountConnectionHeaders = field()
    request: shared.CreateEnvironmentAccountConnectionInput = field(metadata={'request': { 'media_type': 'application/json' }})
