...
class ListServiceInstancesHeaders:
    x_amz_target: ListServiceInstancesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListServiceInstancesRequest:
    headers: ListServiceInstancesHeaders = field()
    query_params: ListServiceInstancesQueryParams = field()
    request: shared.ListServiceInstancesInput = field(metadata={'request': { 'media_type': 'application/json' }})
