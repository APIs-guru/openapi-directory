...
class CancelReplayHeaders:
    x_amz_target: CancelReplayXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CancelReplayRequest:
    headers: CancelReplayHeaders = field()
    request: shared.CancelReplayRequest = field(metadata={'request': { 'media_type': 'application/json' }})
