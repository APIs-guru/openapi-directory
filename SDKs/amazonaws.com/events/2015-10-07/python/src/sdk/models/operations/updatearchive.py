...
class UpdateArchiveHeaders:
    ...
    x_amz_target: UpdateArchiveXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateArchiveRequest:
    headers: UpdateArchiveHeaders = field(default=None)
    request: shared.UpdateArchiveRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
