...
class DescribeConnectionHeaders:
    x_amz_target: DescribeConnectionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeConnectionRequest:
    headers: DescribeConnectionHeaders = field()
    request: shared.DescribeConnectionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
