...
class CreateAPIDestinationHeaders:
    x_amz_target: CreateAPIDestinationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateAPIDestinationRequest:
    headers: CreateAPIDestinationHeaders = field()
    request: shared.CreateAPIDestinationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
