...
class CreateEventBusHeaders:
    x_amz_target: CreateEventBusXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateEventBusRequest:
    headers: CreateEventBusHeaders = field()
    request: shared.CreateEventBusRequest = field(metadata={'request': { 'media_type': 'application/json' }})
