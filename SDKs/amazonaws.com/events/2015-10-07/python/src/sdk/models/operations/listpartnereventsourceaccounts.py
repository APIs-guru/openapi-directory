...
class ListPartnerEventSourceAccountsHeaders:
    x_amz_target: ListPartnerEventSourceAccountsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListPartnerEventSourceAccountsRequest:
    headers: ListPartnerEventSourceAccountsHeaders = field()
    request: shared.ListPartnerEventSourceAccountsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
