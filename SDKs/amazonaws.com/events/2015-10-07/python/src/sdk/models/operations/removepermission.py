...
class RemovePermissionHeaders:
    x_amz_target: RemovePermissionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RemovePermissionRequest:
    ...
    request: shared.RemovePermissionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
