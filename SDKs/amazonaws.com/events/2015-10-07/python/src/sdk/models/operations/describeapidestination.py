...
class DescribeAPIDestinationHeaders:
    ...
    x_amz_target: DescribeAPIDestinationXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeAPIDestinationRequest:
    headers: DescribeAPIDestinationHeaders = field(default=None)
    request: shared.DescribeAPIDestinationRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
