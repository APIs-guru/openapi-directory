...
class ActivateEventSourceHeaders:
    ...
    x_amz_target: ActivateEventSourceXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ActivateEventSourceRequest:
    headers: ActivateEventSourceHeaders = field(default=None)
    request: shared.ActivateEventSourceRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
