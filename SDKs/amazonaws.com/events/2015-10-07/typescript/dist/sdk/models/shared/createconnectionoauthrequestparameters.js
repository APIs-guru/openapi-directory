...
**/
var CreateConnectionOAuthRequestParameters = /** @class */ (function (_super) {
    __extends(CreateConnectionOAuthRequestParameters, _super);
    ...
    ], CreateConnectionOAuthRequestParameters.prototype, "authorizationEndpoint", void 0);
    __decorate([
        Metadata({ data: "json, name=ClientParameters" }),
        __metadata("design:type", CreateConnectionOAuthClientRequestParameters)
    ], CreateConnectionOAuthRequestParameters.prototype, "clientParameters", void 0);
    __decorate([
        Metadata({ data: "json, name=HttpMethod" }),
        __metadata("design:type", String)
    ], CreateConnectionOAuthRequestParameters.prototype, "httpMethod", void 0);
    __decorate([
        Metadata({ data: "json, name=OAuthHttpParameters" }),
        __metadata("design:type", ConnectionHttpParameters)
    ], CreateConnectionOAuthRequestParameters.prototype, "oAuthHttpParameters", void 0);
    return CreateConnectionOAuthRequestParameters;
}(SpeakeasyBase));
export { CreateConnectionOAuthRequestParameters };
