...
**/
var KinesisParameters = /** @class */ (function (_super) {
    __extends(KinesisParameters, _super);
    function KinesisParameters() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=PartitionKeyPath" }),
        __metadata("design:type", String)
    ], KinesisParameters.prototype, "partitionKeyPath", void 0);
    return KinesisParameters;
}(SpeakeasyBase));
export { KinesisParameters };
