...
class CreateApplicationSnapshotHeaders:
    ...
    x_amz_target: CreateApplicationSnapshotXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateApplicationSnapshotRequest:
    headers: CreateApplicationSnapshotHeaders = field(default=None)
    request: shared.CreateApplicationSnapshotRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
