...
class DescribeApplicationVersionHeaders:
    ...
    x_amz_target: DescribeApplicationVersionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
    

@dataclass
class DescribeApplicationVersionRequest:
    headers: DescribeApplicationVersionHeaders = field(default=None)
    request: shared.DescribeApplicationVersionRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
