...
class ListApplicationVersionsHeaders:
    x_amz_target: ListApplicationVersionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListApplicationVersionsRequest:
    headers: ListApplicationVersionsHeaders = field()
    request: shared.ListApplicationVersionsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
