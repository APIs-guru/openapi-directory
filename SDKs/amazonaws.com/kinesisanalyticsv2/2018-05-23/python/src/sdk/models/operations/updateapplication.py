...
class UpdateApplicationHeaders:
    ...
    x_amz_target: UpdateApplicationXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
    

@dataclass
class UpdateApplicationRequest:
    headers: UpdateApplicationHeaders = field(default=None)
    request: shared.UpdateApplicationRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateApplicationResponse:
    ...
    update_application_response: Optional[shared.UpdateApplicationResponse] = field(default=None)
