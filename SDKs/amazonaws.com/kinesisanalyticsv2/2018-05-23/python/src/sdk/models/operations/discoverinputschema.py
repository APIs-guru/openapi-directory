...
class DiscoverInputSchemaHeaders:
    ...
    x_amz_target: DiscoverInputSchemaXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DiscoverInputSchemaRequest:
    headers: DiscoverInputSchemaHeaders = field(default=None)
    request: shared.DiscoverInputSchemaRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
