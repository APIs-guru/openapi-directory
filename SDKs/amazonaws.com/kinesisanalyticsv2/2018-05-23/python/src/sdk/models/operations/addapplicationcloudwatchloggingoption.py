...
class AddApplicationCloudWatchLoggingOptionHeaders:
    ...
    x_amz_target: AddApplicationCloudWatchLoggingOptionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
