...
class UpdateApplicationMaintenanceConfigurationHeaders:
    ...
    x_amz_target: UpdateApplicationMaintenanceConfigurationXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
