...
class UpdateApplicationMaintenanceConfigurationHeaders:
    x_amz_target: UpdateApplicationMaintenanceConfigurationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateApplicationMaintenanceConfigurationRequest:
    headers: UpdateApplicationMaintenanceConfigurationHeaders = field()
    request: shared.UpdateApplicationMaintenanceConfigurationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
