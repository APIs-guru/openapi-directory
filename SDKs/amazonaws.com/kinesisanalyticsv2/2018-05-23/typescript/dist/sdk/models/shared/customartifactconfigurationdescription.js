...
**/
var CustomArtifactConfigurationDescription = /** @class */ (function (_super) {
    __extends(CustomArtifactConfigurationDescription, _super);
    ...
    ], CustomArtifactConfigurationDescription.prototype, "artifactType", void 0);
    __decorate([
        Metadata({ data: "json, name=MavenReferenceDescription" }),
        __metadata("design:type", MavenReference)
    ], CustomArtifactConfigurationDescription.prototype, "mavenReferenceDescription", void 0);
    __decorate([
        Metadata({ data: "json, name=S3ContentLocationDescription" }),
        __metadata("design:type", S3ContentLocation)
    ], CustomArtifactConfigurationDescription.prototype, "s3ContentLocationDescription", void 0);
    return CustomArtifactConfigurationDescription;
}(SpeakeasyBase));
export { CustomArtifactConfigurationDescription };
