...
export class UpdateMethodPathParams extends SpeakeasyBase {
...
export class UpdateMethodHeaders extends SpeakeasyBase {
...
export class UpdateMethodRequestBody extends SpeakeasyBase {
  @Metadata({ data: "json, name=patchOperations", elemType: shared.PatchOperation })
  patchOperations?: shared.PatchOperation[];
}


export class UpdateMethodRequest extends SpeakeasyBase {
  @Metadata()
...
export class UpdateMethodResponse extends SpeakeasyBase {
  @Metadata()
