...
export enum DeleteGatewayResponseResponseTypeEnum {
...
export class DeleteGatewayResponsePathParams extends SpeakeasyBase {
...
export class DeleteGatewayResponseHeaders extends SpeakeasyBase {
...
export class DeleteGatewayResponseRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class DeleteGatewayResponseResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
