...
**/
var UsagePlanKeys = /** @class */ (function (_super) {
    __extends(UsagePlanKeys, _super);
    function UsagePlanKeys() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=items", elemType: UsagePlanKey }),
        __metadata("design:type", Array)
    ], UsagePlanKeys.prototype, "items", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=position" }),
        __metadata("design:type", String)
    ], UsagePlanKeys.prototype, "position", void 0);
    return UsagePlanKeys;
}(SpeakeasyBase));
export { UsagePlanKeys };
