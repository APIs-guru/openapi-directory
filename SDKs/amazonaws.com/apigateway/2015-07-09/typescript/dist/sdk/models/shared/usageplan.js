...
**/
var UsagePlan = /** @class */ (function (_super) {
    __extends(UsagePlan, _super);
    function UsagePlan() {
    ...
    ], UsagePlan.prototype, "apiStages", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=description" }),
        __metadata("design:type", String)
    ], UsagePlan.prototype, "description", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=id" }),
        __metadata("design:type", String)
    ], UsagePlan.prototype, "id", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=name" }),
        __metadata("design:type", String)
    ], UsagePlan.prototype, "name", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=productCode" }),
        __metadata("design:type", String)
    ], UsagePlan.prototype, "productCode", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=quota" }),
        __metadata("design:type", QuotaSettings)
    ], UsagePlan.prototype, "quota", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=tags" }),
        __metadata("design:type", Map)
    ], UsagePlan.prototype, "tags", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=throttle" }),
        __metadata("design:type", ThrottleSettings)
    ], UsagePlan.prototype, "throttle", void 0);
    return UsagePlan;
}(SpeakeasyBase));
export { UsagePlan };
