...
**/
var BasePathMappings = /** @class */ (function (_super) {
    __extends(BasePathMappings, _super);
    ...
    ], BasePathMappings.prototype, "items", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=position" }),
        __metadata("design:type", String)
    ], BasePathMappings.prototype, "position", void 0);
    return BasePathMappings;
}(SpeakeasyBase));
export { BasePathMappings };
