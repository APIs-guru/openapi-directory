...
var Method = /** @class */ (function (_super) {
    ...
    ], Method.prototype, "apiKeyRequired", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=authorizationScopes" }),
        __metadata("design:type", Array)
    ], Method.prototype, "authorizationScopes", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=authorizationType" }),
        __metadata("design:type", String)
    ], Method.prototype, "authorizationType", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=authorizerId" }),
        __metadata("design:type", String)
    ], Method.prototype, "authorizerId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=httpMethod" }),
        __metadata("design:type", String)
    ], Method.prototype, "httpMethod", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=methodIntegration" }),
        __metadata("design:type", Integration)
    ], Method.prototype, "methodIntegration", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=methodResponses", elemType: MethodResponse }),
        __metadata("design:type", Map)
    ], Method.prototype, "methodResponses", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=operationName" }),
        __metadata("design:type", String)
    ], Method.prototype, "operationName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=requestModels" }),
        __metadata("design:type", Map)
    ], Method.prototype, "requestModels", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=requestParameters" }),
        __metadata("design:type", Map)
    ], Method.prototype, "requestParameters", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=requestValidatorId" }),
        __metadata("design:type", String)
    ], Method.prototype, "requestValidatorId", void 0);
    return Method;
}(SpeakeasyBase));
export { Method };
