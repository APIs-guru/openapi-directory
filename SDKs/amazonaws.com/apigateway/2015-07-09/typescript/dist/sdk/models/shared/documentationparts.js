...
**/
var DocumentationParts = /** @class */ (function (_super) {
    __extends(DocumentationParts, _super);
    ...
    ], DocumentationParts.prototype, "items", void 0);
    __decorate([
        Metadata({ data: "json, name=position" }),
        __metadata("design:type", String)
    ], DocumentationParts.prototype, "position", void 0);
    return DocumentationParts;
}(SpeakeasyBase));
export { DocumentationParts };
