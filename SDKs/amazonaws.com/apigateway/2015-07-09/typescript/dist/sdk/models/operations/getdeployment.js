...
var GetDeploymentPathParams = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], GetDeploymentPathParams.prototype, "restapiId", void 0);
    return GetDeploymentPathParams;
}(SpeakeasyBase));
export { GetDeploymentPathParams };
var GetDeploymentQueryParams = /** @class */ (function (_super) {
    __extends(GetDeploymentQueryParams, _super);
    function GetDeploymentQueryParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=embed" }),
        __metadata("design:type", Array)
    ], GetDeploymentQueryParams.prototype, "embed", void 0);
    return GetDeploymentQueryParams;
}(SpeakeasyBase));
export { GetDeploymentQueryParams };
...
var GetDeploymentRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", GetDeploymentQueryParams)
    ], GetDeploymentRequest.prototype, "queryParams", void 0);
    __decorate([
        SpeakeasyMetadata(),
...
var GetDeploymentResponse = /** @class */ (function (_super) {
    ...
    ], GetDeploymentResponse.prototype, "badRequestException", void 0);
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", String)
    ...
    ], GetDeploymentResponse.prototype, "deployment", void 0);
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", Object)
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", Object)
    ], GetDeploymentResponse.prototype, "serviceUnavailableException", void 0);
    __decorate([
        SpeakeasyMetadata(),
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", Object)
    ], GetDeploymentResponse.prototype, "unauthorizedException", void 0);
