...
class CreateRequestValidatorRequest:
    headers: CreateRequestValidatorHeaders = field()
    path_params: CreateRequestValidatorPathParams = field()
    request: CreateRequestValidatorRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
