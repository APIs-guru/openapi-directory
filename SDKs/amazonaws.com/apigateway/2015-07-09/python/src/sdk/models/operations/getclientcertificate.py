...
@dataclass
class GetClientCertificatePathParams:
...
@dataclass
class GetClientCertificateHeaders:
...
class GetClientCertificateRequest:
    path_params: GetClientCertificatePathParams = field(default=None)
    headers: GetClientCertificateHeaders = field(default=None)
