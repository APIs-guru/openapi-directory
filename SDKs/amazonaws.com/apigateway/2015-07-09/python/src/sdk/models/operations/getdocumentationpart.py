...
@dataclass
class GetDocumentationPartPathParams:
...
@dataclass
class GetDocumentationPartHeaders:
...
class GetDocumentationPartRequest:
    path_params: GetDocumentationPartPathParams = field(default=None)
    headers: GetDocumentationPartHeaders = field(default=None)
