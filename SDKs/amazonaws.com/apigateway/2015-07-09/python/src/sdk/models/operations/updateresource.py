...
@dataclass
class UpdateResourcePathParams:
...
class UpdateResourceRequest:
    path_params: UpdateResourcePathParams = field(default=None)
    headers: UpdateResourceHeaders = field(default=None)
    request: UpdateResourceRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
