...
@dataclass
class DeleteMethodResponsePathParams:
...
@dataclass
class DeleteMethodResponseHeaders:
...
class DeleteMethodResponseRequest:
    path_params: DeleteMethodResponsePathParams = field(default=None)
    headers: DeleteMethodResponseHeaders = field(default=None)
