...
@dataclass
class DeleteBasePathMappingPathParams:
...
@dataclass
class DeleteBasePathMappingHeaders:
...
class DeleteBasePathMappingRequest:
    path_params: DeleteBasePathMappingPathParams = field(default=None)
    headers: DeleteBasePathMappingHeaders = field(default=None)
