...
@dataclass
class DeleteUsagePlanKeyPathParams:
...
@dataclass
class DeleteUsagePlanKeyHeaders:
...
class DeleteUsagePlanKeyRequest:
    path_params: DeleteUsagePlanKeyPathParams = field(default=None)
    headers: DeleteUsagePlanKeyHeaders = field(default=None)
