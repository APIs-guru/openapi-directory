...
class GetStagesQueryParams:
    deployment_id: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'deploymentId', 'style': 'form', 'explode': True }})
...
class GetStagesResponse:
    ...
    stages: Optional[shared.Stages] = field(default=None)
