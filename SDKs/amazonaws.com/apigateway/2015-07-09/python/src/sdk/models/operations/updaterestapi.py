...
@dataclass_json
@dataclass
class UpdateRestAPIRequestBody:
...
class UpdateRestAPIRequest:
    path_params: UpdateRestAPIPathParams = field(default=None)
    headers: UpdateRestAPIHeaders = field(default=None)
    request: UpdateRestAPIRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
