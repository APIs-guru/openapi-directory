...
class UpdateRestAPIRequest:
    headers: UpdateRestAPIHeaders = field()
    path_params: UpdateRestAPIPathParams = field()
    request: UpdateRestAPIRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
