...
@dataclass
class UpdateDocumentationVersionPathParams:
...
@dataclass
class UpdateDocumentationVersionHeaders:
...
@dataclass_json
@dataclass
class UpdateDocumentationVersionRequestBody:
...
class UpdateDocumentationVersionRequest:
    path_params: UpdateDocumentationVersionPathParams = field(default=None)
    headers: UpdateDocumentationVersionHeaders = field(default=None)
    request: UpdateDocumentationVersionRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
