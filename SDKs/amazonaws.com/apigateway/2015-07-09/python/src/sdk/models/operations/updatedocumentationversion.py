...
class UpdateDocumentationVersionRequest:
    headers: UpdateDocumentationVersionHeaders = field()
    path_params: UpdateDocumentationVersionPathParams = field()
    request: UpdateDocumentationVersionRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
