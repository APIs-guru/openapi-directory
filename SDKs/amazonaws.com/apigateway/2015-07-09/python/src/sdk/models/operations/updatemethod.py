...
class UpdateMethodRequest:
    path_params: UpdateMethodPathParams = field(default=None)
    headers: UpdateMethodHeaders = field(default=None)
    request: UpdateMethodRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
