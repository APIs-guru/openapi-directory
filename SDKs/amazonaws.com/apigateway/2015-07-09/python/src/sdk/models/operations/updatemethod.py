...
class UpdateMethodRequest:
    headers: UpdateMethodHeaders = field()
    path_params: UpdateMethodPathParams = field()
    request: UpdateMethodRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
