...
class UpdateBasePathMappingRequest:
    headers: UpdateBasePathMappingHeaders = field()
    path_params: UpdateBasePathMappingPathParams = field()
    request: UpdateBasePathMappingRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
