...
@dataclass
class UpdateBasePathMappingPathParams:
...
@dataclass
class UpdateBasePathMappingHeaders:
...
@dataclass_json
@dataclass
class UpdateBasePathMappingRequestBody:
...
class UpdateBasePathMappingRequest:
    path_params: UpdateBasePathMappingPathParams = field(default=None)
    headers: UpdateBasePathMappingHeaders = field(default=None)
    request: UpdateBasePathMappingRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
