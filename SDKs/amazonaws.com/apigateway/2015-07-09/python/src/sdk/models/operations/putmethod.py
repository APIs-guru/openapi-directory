...
@dataclass_json
@dataclass
class PutMethodRequestBody:
    authorization_type: str = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('authorizationType') }})
    ...
    request_parameters: Optional[dict[str, bool]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('requestParameters') }})
    request_validator_id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('requestValidatorId') }})
    

@dataclass
class PutMethodRequest:
    headers: PutMethodHeaders = field()
    path_params: PutMethodPathParams = field()
    request: PutMethodRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
