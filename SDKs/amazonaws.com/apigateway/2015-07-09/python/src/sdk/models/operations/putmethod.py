...
class PutMethodRequestBody:
    ...
    authorization_type: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'authorizationType' }})
...
class PutMethodRequest:
    path_params: PutMethodPathParams = field(default=None)
    headers: PutMethodHeaders = field(default=None)
    request: PutMethodRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
