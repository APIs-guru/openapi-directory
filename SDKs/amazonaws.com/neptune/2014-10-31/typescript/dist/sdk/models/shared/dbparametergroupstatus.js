...
**/
var DbParameterGroupStatus = /** @class */ (function (_super) {
    __extends(DbParameterGroupStatus, _super);
    ...
    ], DbParameterGroupStatus.prototype, "dbParameterGroupName", void 0);
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", String)
    ], DbParameterGroupStatus.prototype, "parameterApplyStatus", void 0);
    return DbParameterGroupStatus;
}(SpeakeasyBase));
export { DbParameterGroupStatus };
