...
class PostDescribeDbClusterEndpointsQueryParams:
    action: PostDescribeDbClusterEndpointsActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeDbClusterEndpointsVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeDbClusterEndpointsRequest:
    headers: PostDescribeDbClusterEndpointsHeaders = field()
    query_params: PostDescribeDbClusterEndpointsQueryParams = field()
