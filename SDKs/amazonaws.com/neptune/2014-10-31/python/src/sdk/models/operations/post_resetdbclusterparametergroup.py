...
class PostResetDbClusterParameterGroupQueryParams:
    action: PostResetDbClusterParameterGroupActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostResetDbClusterParameterGroupVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostResetDbClusterParameterGroupRequest:
    headers: PostResetDbClusterParameterGroupHeaders = field()
    query_params: PostResetDbClusterParameterGroupQueryParams = field()
