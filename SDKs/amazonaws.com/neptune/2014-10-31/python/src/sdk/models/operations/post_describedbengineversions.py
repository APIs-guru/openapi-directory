...
class PostDescribeDbEngineVersionsQueryParams:
    action: PostDescribeDbEngineVersionsActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: PostDescribeDbEngineVersionsVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeDbEngineVersionsRequest:
    query_params: PostDescribeDbEngineVersionsQueryParams = field(default=None)
    headers: PostDescribeDbEngineVersionsHeaders = field(default=None)
