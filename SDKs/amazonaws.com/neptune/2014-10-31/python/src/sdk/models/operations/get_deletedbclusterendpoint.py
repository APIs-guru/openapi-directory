...
class GetDeleteDbClusterEndpointQueryParams:
    action: GetDeleteDbClusterEndpointActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetDeleteDbClusterEndpointVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteDbClusterEndpointRequest:
    headers: GetDeleteDbClusterEndpointHeaders = field()
    query_params: GetDeleteDbClusterEndpointQueryParams = field()
