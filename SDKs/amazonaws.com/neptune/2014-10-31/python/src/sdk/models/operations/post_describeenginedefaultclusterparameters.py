...
class PostDescribeEngineDefaultClusterParametersQueryParams:
    action: PostDescribeEngineDefaultClusterParametersActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeEngineDefaultClusterParametersVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeEngineDefaultClusterParametersRequest:
    headers: PostDescribeEngineDefaultClusterParametersHeaders = field()
    query_params: PostDescribeEngineDefaultClusterParametersQueryParams = field()
