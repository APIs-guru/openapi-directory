...
class ListImageBuildVersionsRequest:
    query_params: ListImageBuildVersionsQueryParams = field(default=None)
    headers: ListImageBuildVersionsHeaders = field(default=None)
    request: ListImageBuildVersionsRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
