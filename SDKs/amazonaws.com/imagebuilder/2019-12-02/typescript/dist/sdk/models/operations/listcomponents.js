...
export var ListComponentsRequestBodyOwnerEnum;
(function (ListComponentsRequestBodyOwnerEnum) {
    ListComponentsRequestBodyOwnerEnum["Self"] = "Self";
    ListComponentsRequestBodyOwnerEnum["Shared"] = "Shared";
    ListComponentsRequestBodyOwnerEnum["Amazon"] = "Amazon";
})(ListComponentsRequestBodyOwnerEnum || (ListComponentsRequestBodyOwnerEnum = {}));
var ListComponentsRequestBody = /** @class */ (function (_super) {
    __extends(ListComponentsRequestBody, _super);
    function ListComponentsRequestBody() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=byName" }),
        __metadata("design:type", Boolean)
    ], ListComponentsRequestBody.prototype, "byName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=filters", elemType: shared.Filter }),
        __metadata("design:type", Array)
    ], ListComponentsRequestBody.prototype, "filters", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=maxResults" }),
        __metadata("design:type", Number)
    ], ListComponentsRequestBody.prototype, "maxResults", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=nextToken" }),
        __metadata("design:type", String)
    ], ListComponentsRequestBody.prototype, "nextToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=owner" }),
        __metadata("design:type", String)
    ], ListComponentsRequestBody.prototype, "owner", void 0);
    return ListComponentsRequestBody;
}(SpeakeasyBase));
export { ListComponentsRequestBody };
var ListComponentsRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", ListComponentsRequestBody)
...
var ListComponentsResponse = /** @class */ (function (_super) {
    ...
    ], ListComponentsResponse.prototype, "callRateLimitExceededException", void 0);
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", Object)
    ], ListComponentsResponse.prototype, "clientException", void 0);
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", String)
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", Object)
    ], ListComponentsResponse.prototype, "forbiddenException", void 0);
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", Object)
    ], ListComponentsResponse.prototype, "invalidPaginationTokenException", void 0);
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", Object)
    ], ListComponentsResponse.prototype, "invalidRequestException", void 0);
    __decorate([
        SpeakeasyMetadata(),
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", Object)
    ], ListComponentsResponse.prototype, "serviceException", void 0);
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", Object)
    ], ListComponentsResponse.prototype, "serviceUnavailableException", void 0);
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", Number)
