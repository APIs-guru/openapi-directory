...
**/
var TagInfoForResource = /** @class */ (function (_super) {
    __extends(TagInfoForResource, _super);
    ...
    ], TagInfoForResource.prototype, "resourceArn", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=TagList", elemType: Tag }),
        __metadata("design:type", Array)
    ], TagInfoForResource.prototype, "tagList", void 0);
    return TagInfoForResource;
}(SpeakeasyBase));
export { TagInfoForResource };
