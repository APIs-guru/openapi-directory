...
var HttpRequest = /** @class */ (function (_super) {
    ...
    ], HttpRequest.prototype, "clientIp", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Country" }),
        __metadata("design:type", String)
    ], HttpRequest.prototype, "country", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=HTTPVersion" }),
        __metadata("design:type", String)
    ], HttpRequest.prototype, "httpVersion", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], HttpRequest.prototype, "method", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=URI" }),
        __metadata("design:type", String)
    ], HttpRequest.prototype, "uri", void 0);
    return HttpRequest;
}(SpeakeasyBase));
export { HttpRequest };
