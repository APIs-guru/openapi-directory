...
class SQLInjectionMatchSetUpdate:
    ...
    sql_injection_match_tuple: SQLInjectionMatchTuple = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('SqlInjectionMatchTuple') }})
