...
class GetByteMatchSetHeaders:
    x_amz_target: GetByteMatchSetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetByteMatchSetRequest:
    headers: GetByteMatchSetHeaders = field()
    request: shared.GetByteMatchSetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
