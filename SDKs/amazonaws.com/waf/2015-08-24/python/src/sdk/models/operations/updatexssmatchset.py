...
class UpdateXSSMatchSetHeaders:
    x_amz_target: UpdateXSSMatchSetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateXSSMatchSetRequest:
    headers: UpdateXSSMatchSetHeaders = field()
    request: shared.UpdateXSSMatchSetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
