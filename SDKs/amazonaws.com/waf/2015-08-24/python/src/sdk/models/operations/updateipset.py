...
class UpdateIPSetHeaders:
    ...
    x_amz_target: UpdateIPSetXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateIPSetRequest:
    headers: UpdateIPSetHeaders = field(default=None)
    request: shared.UpdateIPSetRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateIPSetResponse:
    ...
    update_ip_set_response: Optional[shared.UpdateIPSetResponse] = field(default=None)
