...
class UpdateIPSetHeaders:
    x_amz_target: UpdateIPSetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateIPSetRequest:
    headers: UpdateIPSetHeaders = field()
    request: shared.UpdateIPSetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
