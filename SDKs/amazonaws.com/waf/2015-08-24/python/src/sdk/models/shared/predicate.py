...
class Predicate:
    ...
    data_id: str = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('DataId') }})
    negated: bool = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Negated') }})
    type: PredicateTypeEnum = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Type') }})
