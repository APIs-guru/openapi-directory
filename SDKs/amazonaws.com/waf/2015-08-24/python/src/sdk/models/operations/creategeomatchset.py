...
class CreateGeoMatchSetHeaders:
    x_amz_target: CreateGeoMatchSetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateGeoMatchSetRequest:
    headers: CreateGeoMatchSetHeaders = field()
    request: shared.CreateGeoMatchSetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
