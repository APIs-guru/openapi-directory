...
class GetSampledRequestsHeaders:
    ...
    x_amz_target: GetSampledRequestsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetSampledRequestsRequest:
    headers: GetSampledRequestsHeaders = field(default=None)
    request: shared.GetSampledRequestsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
