...
class UpdateRegexMatchSetHeaders:
    x_amz_target: UpdateRegexMatchSetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateRegexMatchSetRequest:
    headers: UpdateRegexMatchSetHeaders = field()
    request: shared.UpdateRegexMatchSetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
