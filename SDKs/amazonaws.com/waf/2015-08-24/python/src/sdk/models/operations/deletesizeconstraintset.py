...
class DeleteSizeConstraintSetHeaders:
    x_amz_target: DeleteSizeConstraintSetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteSizeConstraintSetRequest:
    headers: DeleteSizeConstraintSetHeaders = field()
    request: shared.DeleteSizeConstraintSetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
