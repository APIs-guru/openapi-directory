...
class DeleteSizeConstraintSetHeaders:
    ...
    x_amz_target: DeleteSizeConstraintSetXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeleteSizeConstraintSetRequest:
    headers: DeleteSizeConstraintSetHeaders = field(default=None)
    request: shared.DeleteSizeConstraintSetRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class DeleteSizeConstraintSetResponse:
    content_type: str = field(default=None)
    delete_size_constraint_set_response: Optional[shared.DeleteSizeConstraintSetResponse] = field(default=None)
