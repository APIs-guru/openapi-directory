...
class UpdateWebACLHeaders:
    x_amz_target: UpdateWebAclxAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateWebACLRequest:
    headers: UpdateWebACLHeaders = field()
    request: shared.UpdateWebACLRequest = field(metadata={'request': { 'media_type': 'application/json' }})
