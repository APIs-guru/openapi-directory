...
class DeleteGeoMatchSetHeaders:
    x_amz_target: DeleteGeoMatchSetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteGeoMatchSetRequest:
    headers: DeleteGeoMatchSetHeaders = field()
    request: shared.DeleteGeoMatchSetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
