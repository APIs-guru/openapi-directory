...
class CreateSQLInjectionMatchSetHeaders:
    x_amz_target: CreateSQLInjectionMatchSetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateSQLInjectionMatchSetRequest:
    headers: CreateSQLInjectionMatchSetHeaders = field()
    request: shared.CreateSQLInjectionMatchSetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
