...
class ListRulesHeaders:
    x_amz_target: ListRulesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListRulesRequest:
    headers: ListRulesHeaders = field()
    request: shared.ListRulesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
