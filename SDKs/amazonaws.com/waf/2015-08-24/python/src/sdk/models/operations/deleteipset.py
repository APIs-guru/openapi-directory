...
class DeleteIPSetHeaders:
    x_amz_target: DeleteIPSetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteIPSetRequest:
    headers: DeleteIPSetHeaders = field()
    request: shared.DeleteIPSetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
