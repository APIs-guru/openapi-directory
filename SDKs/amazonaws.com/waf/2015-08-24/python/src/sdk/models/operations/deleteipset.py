...
class DeleteIPSetHeaders:
    ...
    x_amz_target: DeleteIPSetXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeleteIPSetRequest:
    headers: DeleteIPSetHeaders = field(default=None)
    request: shared.DeleteIPSetRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class DeleteIPSetResponse:
    content_type: str = field(default=None)
    delete_ip_set_response: Optional[shared.DeleteIPSetResponse] = field(default=None)
