...
class DeleteRuleGroupHeaders:
    x_amz_target: DeleteRuleGroupXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteRuleGroupRequest:
    headers: DeleteRuleGroupHeaders = field()
    request: shared.DeleteRuleGroupRequest = field(metadata={'request': { 'media_type': 'application/json' }})
