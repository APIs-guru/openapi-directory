...
class CreateRateBasedRuleHeaders:
    x_amz_target: CreateRateBasedRuleXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateRateBasedRuleRequest:
    headers: CreateRateBasedRuleHeaders = field()
    request: shared.CreateRateBasedRuleRequest = field(metadata={'request': { 'media_type': 'application/json' }})
