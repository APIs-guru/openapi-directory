...
class CreateRateBasedRuleXAmzTargetEnum(str, Enum):
    AWSWAF_20150824_CREATE_RATE_BASED_RULE = "AWSWAF_20150824.CreateRateBasedRule"
...
class CreateRateBasedRuleHeaders:
    ...
    x_amz_target: CreateRateBasedRuleXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateRateBasedRuleRequest:
    headers: CreateRateBasedRuleHeaders = field(default=None)
    request: shared.CreateRateBasedRuleRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class CreateRateBasedRuleResponse:
    content_type: str = field(default=None)
    create_rate_based_rule_response: Optional[shared.CreateRateBasedRuleResponse] = field(default=None)
