...
class GetSQLInjectionMatchSetHeaders:
    x_amz_target: GetSQLInjectionMatchSetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetSQLInjectionMatchSetRequest:
    headers: GetSQLInjectionMatchSetHeaders = field()
    request: shared.GetSQLInjectionMatchSetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
