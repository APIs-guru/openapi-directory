...
class CreateIPSetHeaders:
    x_amz_target: CreateIPSetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateIPSetRequest:
    headers: CreateIPSetHeaders = field()
    request: shared.CreateIPSetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
