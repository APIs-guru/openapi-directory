...
class GetLoggingConfigurationHeaders:
    x_amz_target: GetLoggingConfigurationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetLoggingConfigurationRequest:
    headers: GetLoggingConfigurationHeaders = field()
    request: shared.GetLoggingConfigurationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
