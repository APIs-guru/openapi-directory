...
class UpdateRuleHeaders:
    x_amz_target: UpdateRuleXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateRuleRequest:
    headers: UpdateRuleHeaders = field()
    request: shared.UpdateRuleRequest = field(metadata={'request': { 'media_type': 'application/json' }})
