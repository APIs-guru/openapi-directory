...
class UpdateRuleHeaders:
    ...
    x_amz_target: UpdateRuleXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateRuleRequest:
    headers: UpdateRuleHeaders = field(default=None)
    request: shared.UpdateRuleRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateRuleResponse:
    ...
    update_rule_response: Optional[shared.UpdateRuleResponse] = field(default=None)
