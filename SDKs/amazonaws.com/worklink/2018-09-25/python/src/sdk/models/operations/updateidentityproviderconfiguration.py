...
class UpdateIdentityProviderConfigurationRequestBody:
    ...
    identity_provider_type: UpdateIdentityProviderConfigurationRequestBodyIdentityProviderTypeEnum = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('IdentityProviderType') }})
...
class UpdateIdentityProviderConfigurationRequest:
    headers: UpdateIdentityProviderConfigurationHeaders = field()
    request: UpdateIdentityProviderConfigurationRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
