...
class UpdateIdentityProviderConfigurationRequestBody:
    ...
    identity_provider_type: UpdateIdentityProviderConfigurationRequestBodyIdentityProviderTypeEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'IdentityProviderType' }})
    

@dataclass
class UpdateIdentityProviderConfigurationRequest:
    headers: UpdateIdentityProviderConfigurationHeaders = field(default=None)
    request: UpdateIdentityProviderConfigurationRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateIdentityProviderConfigurationResponse:
    ...
    update_identity_provider_configuration_response: Optional[dict[str, Any]] = field(default=None)
