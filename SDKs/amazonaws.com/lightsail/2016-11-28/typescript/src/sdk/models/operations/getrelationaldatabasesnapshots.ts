...
export enum GetRelationalDatabaseSnapshotsXAmzTargetEnum {
    Lightsail20161128GetRelationalDatabaseSnapshots = "Lightsail_20161128.GetRelationalDatabaseSnapshots"
}


export class GetRelationalDatabaseSnapshotsHeaders extends SpeakeasyBase {
...
export class GetRelationalDatabaseSnapshotsResponse extends SpeakeasyBase {
  @Metadata()
