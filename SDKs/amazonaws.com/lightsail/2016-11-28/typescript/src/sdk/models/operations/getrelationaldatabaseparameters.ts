...
export enum GetRelationalDatabaseParametersXAmzTargetEnum {
    Lightsail20161128GetRelationalDatabaseParameters = "Lightsail_20161128.GetRelationalDatabaseParameters"
}


export class GetRelationalDatabaseParametersHeaders extends SpeakeasyBase {
...
export class GetRelationalDatabaseParametersResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
