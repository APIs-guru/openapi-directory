...
export enum DeleteKeyPairXAmzTargetEnum {
    Lightsail20161128DeleteKeyPair = "Lightsail_20161128.DeleteKeyPair"
}


export class DeleteKeyPairHeaders extends SpeakeasyBase {
...
export class DeleteKeyPairResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
