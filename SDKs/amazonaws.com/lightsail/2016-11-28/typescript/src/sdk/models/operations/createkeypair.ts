...
export enum CreateKeyPairXAmzTargetEnum {
    Lightsail20161128CreateKeyPair = "Lightsail_20161128.CreateKeyPair"
}


export class CreateKeyPairHeaders extends SpeakeasyBase {
...
export class CreateKeyPairResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
