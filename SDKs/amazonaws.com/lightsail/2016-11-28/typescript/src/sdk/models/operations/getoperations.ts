...
export enum GetOperationsXAmzTargetEnum {
    Lightsail20161128GetOperations = "Lightsail_20161128.GetOperations"
}


export class GetOperationsHeaders extends SpeakeasyBase {
...
export class GetOperationsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
