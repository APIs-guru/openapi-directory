...
export enum CreateLoadBalancerTlsCertificateXAmzTargetEnum {
    Lightsail20161128CreateLoadBalancerTlsCertificate = "Lightsail_20161128.CreateLoadBalancerTlsCertificate"
}


export class CreateLoadBalancerTlsCertificateHeaders extends SpeakeasyBase {
...
export class CreateLoadBalancerTlsCertificateResponse extends SpeakeasyBase {
  @Metadata()
