...
export enum GetRelationalDatabaseMetricDataXAmzTargetEnum {
    Lightsail20161128GetRelationalDatabaseMetricData = "Lightsail_20161128.GetRelationalDatabaseMetricData"
}


export class GetRelationalDatabaseMetricDataHeaders extends SpeakeasyBase {
...
export class GetRelationalDatabaseMetricDataResponse extends SpeakeasyBase {
  @Metadata()
