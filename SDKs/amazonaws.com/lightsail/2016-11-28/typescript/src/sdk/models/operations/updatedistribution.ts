...
export enum UpdateDistributionXAmzTargetEnum {
    Lightsail20161128UpdateDistribution = "Lightsail_20161128.UpdateDistribution"
}


export class UpdateDistributionHeaders extends SpeakeasyBase {
...
export class UpdateDistributionResponse extends SpeakeasyBase {
  @Metadata()
