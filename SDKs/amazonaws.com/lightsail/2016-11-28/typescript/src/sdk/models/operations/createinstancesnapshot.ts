...
export enum CreateInstanceSnapshotXAmzTargetEnum {
    Lightsail20161128CreateInstanceSnapshot = "Lightsail_20161128.CreateInstanceSnapshot"
}


export class CreateInstanceSnapshotHeaders extends SpeakeasyBase {
...
export class CreateInstanceSnapshotResponse extends SpeakeasyBase {
  @Metadata()
