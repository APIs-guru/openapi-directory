...
export enum DeleteInstanceSnapshotXAmzTargetEnum {
    Lightsail20161128DeleteInstanceSnapshot = "Lightsail_20161128.DeleteInstanceSnapshot"
}


export class DeleteInstanceSnapshotHeaders extends SpeakeasyBase {
...
export class DeleteInstanceSnapshotResponse extends SpeakeasyBase {
  @Metadata()
