...
var RegisterContainerImageRequest = /** @class */ (function (_super) {
    ...
    ], RegisterContainerImageRequest.prototype, "digest", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=label" }),
        __metadata("design:type", String)
    ], RegisterContainerImageRequest.prototype, "label", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=serviceName" }),
        __metadata("design:type", String)
    ], RegisterContainerImageRequest.prototype, "serviceName", void 0);
