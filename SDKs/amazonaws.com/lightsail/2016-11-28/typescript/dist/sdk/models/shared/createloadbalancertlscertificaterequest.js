...
var CreateLoadBalancerTlsCertificateRequest = /** @class */ (function (_super) {
    ...
    ], CreateLoadBalancerTlsCertificateRequest.prototype, "certificateAlternativeNames", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=certificateDomainName" }),
        __metadata("design:type", String)
    ], CreateLoadBalancerTlsCertificateRequest.prototype, "certificateDomainName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=certificateName" }),
        __metadata("design:type", String)
    ], CreateLoadBalancerTlsCertificateRequest.prototype, "certificateName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=loadBalancerName" }),
        __metadata("design:type", String)
    ], CreateLoadBalancerTlsCertificateRequest.prototype, "loadBalancerName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=tags", elemType: Tag }),
        __metadata("design:type", Array)
    ], CreateLoadBalancerTlsCertificateRequest.prototype, "tags", void 0);
