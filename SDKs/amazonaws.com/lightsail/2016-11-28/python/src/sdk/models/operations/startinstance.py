...
class StartInstanceHeaders:
    x_amz_target: StartInstanceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartInstanceRequest:
    headers: StartInstanceHeaders = field()
    request: shared.StartInstanceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
