...
class UpdateBucketHeaders:
    x_amz_target: UpdateBucketXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateBucketRequest:
    headers: UpdateBucketHeaders = field()
    request: shared.UpdateBucketRequest = field(metadata={'request': { 'media_type': 'application/json' }})
