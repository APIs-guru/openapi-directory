...
class CopySnapshotHeaders:
    x_amz_target: CopySnapshotXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CopySnapshotRequest:
    headers: CopySnapshotHeaders = field()
    request: shared.CopySnapshotRequest = field(metadata={'request': { 'media_type': 'application/json' }})
