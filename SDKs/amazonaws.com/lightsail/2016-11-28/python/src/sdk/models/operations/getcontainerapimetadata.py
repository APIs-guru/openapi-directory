...
class GetContainerAPIMetadataHeaders:
    x_amz_target: GetContainerAPIMetadataXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetContainerAPIMetadataRequest:
    headers: GetContainerAPIMetadataHeaders = field()
