...
class CreateContactMethodHeaders:
    ...
    x_amz_target: CreateContactMethodXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateContactMethodRequest:
    headers: CreateContactMethodHeaders = field(default=None)
    request: shared.CreateContactMethodRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
