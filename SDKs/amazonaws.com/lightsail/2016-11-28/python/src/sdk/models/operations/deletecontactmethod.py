...
class DeleteContactMethodHeaders:
    x_amz_target: DeleteContactMethodXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteContactMethodRequest:
    headers: DeleteContactMethodHeaders = field()
    request: shared.DeleteContactMethodRequest = field(metadata={'request': { 'media_type': 'application/json' }})
