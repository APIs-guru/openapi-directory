...
class GetDiskSnapshotsHeaders:
    ...
    x_amz_target: GetDiskSnapshotsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetDiskSnapshotsRequest:
    headers: GetDiskSnapshotsHeaders = field(default=None)
    request: shared.GetDiskSnapshotsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class GetDiskSnapshotsResponse:
    ...
    get_disk_snapshots_result: Optional[shared.GetDiskSnapshotsResult] = field(default=None)
