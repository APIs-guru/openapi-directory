...
class GetDiskSnapshotsHeaders:
    x_amz_target: GetDiskSnapshotsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetDiskSnapshotsRequest:
    headers: GetDiskSnapshotsHeaders = field()
    request: shared.GetDiskSnapshotsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
