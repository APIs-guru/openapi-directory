...
class GetContainerServiceMetricDataHeaders:
    x_amz_target: GetContainerServiceMetricDataXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetContainerServiceMetricDataRequest:
    headers: GetContainerServiceMetricDataHeaders = field()
    request: shared.GetContainerServiceMetricDataRequest = field(metadata={'request': { 'media_type': 'application/json' }})
