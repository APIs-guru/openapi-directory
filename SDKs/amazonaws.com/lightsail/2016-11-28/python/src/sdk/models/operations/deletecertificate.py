...
class DeleteCertificateHeaders:
    ...
    x_amz_target: DeleteCertificateXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeleteCertificateRequest:
    headers: DeleteCertificateHeaders = field(default=None)
    request: shared.DeleteCertificateRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
