...
class GetRelationalDatabaseEventsHeaders:
    x_amz_target: GetRelationalDatabaseEventsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetRelationalDatabaseEventsRequest:
    headers: GetRelationalDatabaseEventsHeaders = field()
    request: shared.GetRelationalDatabaseEventsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
