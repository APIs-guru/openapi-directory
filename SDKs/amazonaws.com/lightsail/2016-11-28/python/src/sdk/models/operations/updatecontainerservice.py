...
class UpdateContainerServiceHeaders:
    x_amz_target: UpdateContainerServiceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateContainerServiceRequest:
    headers: UpdateContainerServiceHeaders = field()
    request: shared.UpdateContainerServiceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
