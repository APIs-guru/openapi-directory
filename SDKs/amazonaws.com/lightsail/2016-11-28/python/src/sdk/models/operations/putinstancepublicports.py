...
class PutInstancePublicPortsHeaders:
    ...
    x_amz_target: PutInstancePublicPortsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class PutInstancePublicPortsRequest:
    headers: PutInstancePublicPortsHeaders = field(default=None)
    request: shared.PutInstancePublicPortsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
