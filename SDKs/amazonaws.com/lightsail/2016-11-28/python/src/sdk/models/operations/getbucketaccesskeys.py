...
class GetBucketAccessKeysHeaders:
    x_amz_target: GetBucketAccessKeysXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetBucketAccessKeysRequest:
    headers: GetBucketAccessKeysHeaders = field()
    request: shared.GetBucketAccessKeysRequest = field(metadata={'request': { 'media_type': 'application/json' }})
