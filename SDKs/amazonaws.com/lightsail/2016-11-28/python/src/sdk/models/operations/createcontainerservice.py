...
class CreateContainerServiceHeaders:
    x_amz_target: CreateContainerServiceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateContainerServiceRequest:
    headers: CreateContainerServiceHeaders = field()
    request: shared.CreateContainerServiceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
