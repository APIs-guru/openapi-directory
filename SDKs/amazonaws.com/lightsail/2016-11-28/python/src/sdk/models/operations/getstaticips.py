...
class GetStaticIpsHeaders:
    x_amz_target: GetStaticIpsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetStaticIpsRequest:
    headers: GetStaticIpsHeaders = field()
    request: shared.GetStaticIpsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
