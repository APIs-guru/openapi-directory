...
class DetachStaticIPHeaders:
    x_amz_target: DetachStaticIPXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DetachStaticIPRequest:
    headers: DetachStaticIPHeaders = field()
    request: shared.DetachStaticIPRequest = field(metadata={'request': { 'media_type': 'application/json' }})
