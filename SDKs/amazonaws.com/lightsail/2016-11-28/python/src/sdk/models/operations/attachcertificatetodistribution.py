...
class AttachCertificateToDistributionHeaders:
    x_amz_target: AttachCertificateToDistributionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AttachCertificateToDistributionRequest:
    headers: AttachCertificateToDistributionHeaders = field()
    request: shared.AttachCertificateToDistributionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
