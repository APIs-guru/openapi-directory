...
class DeleteDomainHeaders:
    x_amz_target: DeleteDomainXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteDomainRequest:
    ...
    request: shared.DeleteDomainRequest = field(metadata={'request': { 'media_type': 'application/json' }})
