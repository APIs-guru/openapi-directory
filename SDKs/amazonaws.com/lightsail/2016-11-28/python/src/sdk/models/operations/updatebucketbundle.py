...
class UpdateBucketBundleHeaders:
    x_amz_target: UpdateBucketBundleXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateBucketBundleRequest:
    headers: UpdateBucketBundleHeaders = field()
    request: shared.UpdateBucketBundleRequest = field(metadata={'request': { 'media_type': 'application/json' }})
