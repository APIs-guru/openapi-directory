...
class CreateLoadBalancerTLSCertificateHeaders:
    x_amz_target: CreateLoadBalancerTLSCertificateXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateLoadBalancerTLSCertificateRequest:
    headers: CreateLoadBalancerTLSCertificateHeaders = field()
    request: shared.CreateLoadBalancerTLSCertificateRequest = field(metadata={'request': { 'media_type': 'application/json' }})
