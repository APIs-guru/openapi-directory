...
class DeleteLoadBalancerHeaders:
    x_amz_target: DeleteLoadBalancerXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteLoadBalancerRequest:
    headers: DeleteLoadBalancerHeaders = field()
    request: shared.DeleteLoadBalancerRequest = field(metadata={'request': { 'media_type': 'application/json' }})
