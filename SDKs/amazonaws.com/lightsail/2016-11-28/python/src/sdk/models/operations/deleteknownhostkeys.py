...
class DeleteKnownHostKeysHeaders:
    x_amz_target: DeleteKnownHostKeysXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteKnownHostKeysRequest:
    headers: DeleteKnownHostKeysHeaders = field()
    request: shared.DeleteKnownHostKeysRequest = field(metadata={'request': { 'media_type': 'application/json' }})
