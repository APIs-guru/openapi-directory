...
class GetLoadBalancerTLSCertificatesHeaders:
    x_amz_target: GetLoadBalancerTLSCertificatesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetLoadBalancerTLSCertificatesRequest:
    headers: GetLoadBalancerTLSCertificatesHeaders = field()
    request: shared.GetLoadBalancerTLSCertificatesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
