...
class GetLoadBalancerTLSCertificatesHeaders:
    ...
    x_amz_target: GetLoadBalancerTLSCertificatesXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetLoadBalancerTLSCertificatesRequest:
    headers: GetLoadBalancerTLSCertificatesHeaders = field(default=None)
    request: shared.GetLoadBalancerTLSCertificatesRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class GetLoadBalancerTLSCertificatesResponse:
    ...
    get_load_balancer_tls_certificates_result: Optional[shared.GetLoadBalancerTLSCertificatesResult] = field(default=None)
