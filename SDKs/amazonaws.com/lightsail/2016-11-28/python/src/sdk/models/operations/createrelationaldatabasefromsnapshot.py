...
class CreateRelationalDatabaseFromSnapshotHeaders:
    x_amz_target: CreateRelationalDatabaseFromSnapshotXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateRelationalDatabaseFromSnapshotRequest:
    headers: CreateRelationalDatabaseFromSnapshotHeaders = field()
    request: shared.CreateRelationalDatabaseFromSnapshotRequest = field(metadata={'request': { 'media_type': 'application/json' }})
