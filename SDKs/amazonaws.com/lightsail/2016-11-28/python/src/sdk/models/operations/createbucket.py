...
class CreateBucketHeaders:
    x_amz_target: CreateBucketXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateBucketRequest:
    headers: CreateBucketHeaders = field()
    request: shared.CreateBucketRequest = field(metadata={'request': { 'media_type': 'application/json' }})
