...
class GetContainerServicesHeaders:
    x_amz_target: GetContainerServicesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetContainerServicesRequest:
    headers: GetContainerServicesHeaders = field()
    request: shared.GetContainerServicesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
