...
class GetRelationalDatabaseMetricDataHeaders:
    x_amz_target: GetRelationalDatabaseMetricDataXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetRelationalDatabaseMetricDataRequest:
    headers: GetRelationalDatabaseMetricDataHeaders = field()
    request: shared.GetRelationalDatabaseMetricDataRequest = field(metadata={'request': { 'media_type': 'application/json' }})
