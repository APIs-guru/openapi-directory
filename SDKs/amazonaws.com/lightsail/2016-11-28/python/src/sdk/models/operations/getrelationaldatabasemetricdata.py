...
class GetRelationalDatabaseMetricDataHeaders:
    ...
    x_amz_target: GetRelationalDatabaseMetricDataXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetRelationalDatabaseMetricDataRequest:
    headers: GetRelationalDatabaseMetricDataHeaders = field(default=None)
    request: shared.GetRelationalDatabaseMetricDataRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class GetRelationalDatabaseMetricDataResponse:
    ...
    get_relational_database_metric_data_result: Optional[shared.GetRelationalDatabaseMetricDataResult] = field(default=None)
