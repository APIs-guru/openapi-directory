...
class GetOperationsForResourceHeaders:
    x_amz_target: GetOperationsForResourceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetOperationsForResourceRequest:
    headers: GetOperationsForResourceHeaders = field()
    request: shared.GetOperationsForResourceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
