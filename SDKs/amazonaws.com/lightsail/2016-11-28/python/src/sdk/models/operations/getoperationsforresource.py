...
class GetOperationsForResourceHeaders:
    ...
    x_amz_target: GetOperationsForResourceXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetOperationsForResourceRequest:
    headers: GetOperationsForResourceHeaders = field(default=None)
    request: shared.GetOperationsForResourceRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class GetOperationsForResourceResponse:
    ...
    get_operations_for_resource_result: Optional[shared.GetOperationsForResourceResult] = field(default=None)
