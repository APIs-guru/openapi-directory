...
class GetCertificatesHeaders:
    x_amz_target: GetCertificatesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetCertificatesRequest:
    headers: GetCertificatesHeaders = field()
    request: shared.GetCertificatesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
