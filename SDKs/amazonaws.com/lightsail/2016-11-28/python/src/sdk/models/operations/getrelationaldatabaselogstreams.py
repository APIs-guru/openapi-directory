...
class GetRelationalDatabaseLogStreamsHeaders:
    ...
    x_amz_target: GetRelationalDatabaseLogStreamsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetRelationalDatabaseLogStreamsRequest:
    headers: GetRelationalDatabaseLogStreamsHeaders = field(default=None)
    request: shared.GetRelationalDatabaseLogStreamsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class GetRelationalDatabaseLogStreamsResponse:
    ...
    get_relational_database_log_streams_result: Optional[shared.GetRelationalDatabaseLogStreamsResult] = field(default=None)
