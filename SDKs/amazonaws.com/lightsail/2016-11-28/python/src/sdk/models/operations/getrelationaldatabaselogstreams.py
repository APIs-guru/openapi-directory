...
class GetRelationalDatabaseLogStreamsHeaders:
    x_amz_target: GetRelationalDatabaseLogStreamsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetRelationalDatabaseLogStreamsRequest:
    headers: GetRelationalDatabaseLogStreamsHeaders = field()
    request: shared.GetRelationalDatabaseLogStreamsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
