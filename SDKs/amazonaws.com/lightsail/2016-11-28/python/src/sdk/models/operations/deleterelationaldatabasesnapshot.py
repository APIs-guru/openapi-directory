...
class DeleteRelationalDatabaseSnapshotHeaders:
    x_amz_target: DeleteRelationalDatabaseSnapshotXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteRelationalDatabaseSnapshotRequest:
    headers: DeleteRelationalDatabaseSnapshotHeaders = field()
    request: shared.DeleteRelationalDatabaseSnapshotRequest = field(metadata={'request': { 'media_type': 'application/json' }})
