...
class GetRelationalDatabasesHeaders:
    ...
    x_amz_target: GetRelationalDatabasesXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetRelationalDatabasesRequest:
    headers: GetRelationalDatabasesHeaders = field(default=None)
    request: shared.GetRelationalDatabasesRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
