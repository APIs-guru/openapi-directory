...
class UpdateDistributionBundleHeaders:
    x_amz_target: UpdateDistributionBundleXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateDistributionBundleRequest:
    headers: UpdateDistributionBundleHeaders = field()
    request: shared.UpdateDistributionBundleRequest = field(metadata={'request': { 'media_type': 'application/json' }})
