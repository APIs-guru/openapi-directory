...
class DeleteInstanceSnapshotHeaders:
    x_amz_target: DeleteInstanceSnapshotXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteInstanceSnapshotRequest:
    headers: DeleteInstanceSnapshotHeaders = field()
    request: shared.DeleteInstanceSnapshotRequest = field(metadata={'request': { 'media_type': 'application/json' }})
