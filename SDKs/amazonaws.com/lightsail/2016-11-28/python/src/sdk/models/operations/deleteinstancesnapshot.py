...
class DeleteInstanceSnapshotHeaders:
    ...
    x_amz_target: DeleteInstanceSnapshotXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeleteInstanceSnapshotRequest:
    headers: DeleteInstanceSnapshotHeaders = field(default=None)
    request: shared.DeleteInstanceSnapshotRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class DeleteInstanceSnapshotResponse:
    ...
    delete_instance_snapshot_result: Optional[shared.DeleteInstanceSnapshotResult] = field(default=None)
