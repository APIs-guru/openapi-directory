...
class GetOperationsHeaders:
    x_amz_target: GetOperationsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetOperationsRequest:
    headers: GetOperationsHeaders = field()
    request: shared.GetOperationsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
