...
class GetOperationsHeaders:
    ...
    x_amz_target: GetOperationsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetOperationsRequest:
    headers: GetOperationsHeaders = field(default=None)
    request: shared.GetOperationsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class GetOperationsResponse:
    ...
    get_operations_result: Optional[shared.GetOperationsResult] = field(default=None)
