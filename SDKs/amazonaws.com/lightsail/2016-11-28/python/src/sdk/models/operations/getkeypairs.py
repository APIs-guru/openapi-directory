...
class GetKeyPairsHeaders:
    x_amz_target: GetKeyPairsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetKeyPairsRequest:
    headers: GetKeyPairsHeaders = field()
    request: shared.GetKeyPairsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
