...
class GetKeyPairsHeaders:
    ...
    x_amz_target: GetKeyPairsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetKeyPairsRequest:
    headers: GetKeyPairsHeaders = field(default=None)
    request: shared.GetKeyPairsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class GetKeyPairsResponse:
    ...
    get_key_pairs_result: Optional[shared.GetKeyPairsResult] = field(default=None)
