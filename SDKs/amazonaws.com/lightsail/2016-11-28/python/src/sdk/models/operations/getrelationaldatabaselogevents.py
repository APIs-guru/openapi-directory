...
class GetRelationalDatabaseLogEventsHeaders:
    x_amz_target: GetRelationalDatabaseLogEventsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetRelationalDatabaseLogEventsRequest:
    headers: GetRelationalDatabaseLogEventsHeaders = field()
    request: shared.GetRelationalDatabaseLogEventsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
