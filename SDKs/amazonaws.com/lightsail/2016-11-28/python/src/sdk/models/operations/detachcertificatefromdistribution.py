...
class DetachCertificateFromDistributionHeaders:
    x_amz_target: DetachCertificateFromDistributionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DetachCertificateFromDistributionRequest:
    headers: DetachCertificateFromDistributionHeaders = field()
    request: shared.DetachCertificateFromDistributionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
