...
class GetCloudFormationStackRecordsHeaders:
    x_amz_target: GetCloudFormationStackRecordsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetCloudFormationStackRecordsRequest:
    headers: GetCloudFormationStackRecordsHeaders = field()
    request: shared.GetCloudFormationStackRecordsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
