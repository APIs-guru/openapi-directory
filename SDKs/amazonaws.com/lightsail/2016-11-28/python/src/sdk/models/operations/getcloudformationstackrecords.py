...
class GetCloudFormationStackRecordsHeaders:
    ...
    x_amz_target: GetCloudFormationStackRecordsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetCloudFormationStackRecordsRequest:
    headers: GetCloudFormationStackRecordsHeaders = field(default=None)
    request: shared.GetCloudFormationStackRecordsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class GetCloudFormationStackRecordsResponse:
    ...
    get_cloud_formation_stack_records_result: Optional[shared.GetCloudFormationStackRecordsResult] = field(default=None)
