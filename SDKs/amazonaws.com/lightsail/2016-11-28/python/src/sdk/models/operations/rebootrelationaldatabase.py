...
class RebootRelationalDatabaseHeaders:
    x_amz_target: RebootRelationalDatabaseXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RebootRelationalDatabaseRequest:
    headers: RebootRelationalDatabaseHeaders = field()
    request: shared.RebootRelationalDatabaseRequest = field(metadata={'request': { 'media_type': 'application/json' }})
