...
class RebootRelationalDatabaseHeaders:
    ...
    x_amz_target: RebootRelationalDatabaseXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class RebootRelationalDatabaseRequest:
    headers: RebootRelationalDatabaseHeaders = field(default=None)
    request: shared.RebootRelationalDatabaseRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class RebootRelationalDatabaseResponse:
    ...
    reboot_relational_database_result: Optional[shared.RebootRelationalDatabaseResult] = field(default=None)
