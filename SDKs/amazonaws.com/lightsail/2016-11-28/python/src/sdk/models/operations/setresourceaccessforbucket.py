...
class SetResourceAccessForBucketHeaders:
    x_amz_target: SetResourceAccessForBucketXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class SetResourceAccessForBucketRequest:
    headers: SetResourceAccessForBucketHeaders = field()
    request: shared.SetResourceAccessForBucketRequest = field(metadata={'request': { 'media_type': 'application/json' }})
