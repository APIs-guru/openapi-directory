...
class PutAlarmHeaders:
    x_amz_target: PutAlarmXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutAlarmRequest:
    headers: PutAlarmHeaders = field()
    request: shared.PutAlarmRequest = field(metadata={'request': { 'media_type': 'application/json' }})
