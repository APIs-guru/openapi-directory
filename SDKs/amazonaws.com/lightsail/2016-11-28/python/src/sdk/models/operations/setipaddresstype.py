...
class SetIPAddressTypeHeaders:
    x_amz_target: SetIPAddressTypeXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class SetIPAddressTypeRequest:
    headers: SetIPAddressTypeHeaders = field()
    request: shared.SetIPAddressTypeRequest = field(metadata={'request': { 'media_type': 'application/json' }})
