...
class GetDistributionLatestCacheResetHeaders:
    ...
    x_amz_target: GetDistributionLatestCacheResetXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetDistributionLatestCacheResetRequest:
    headers: GetDistributionLatestCacheResetHeaders = field(default=None)
    request: shared.GetDistributionLatestCacheResetRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
