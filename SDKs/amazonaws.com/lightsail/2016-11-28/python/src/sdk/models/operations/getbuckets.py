...
class GetBucketsHeaders:
    x_amz_target: GetBucketsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetBucketsRequest:
    headers: GetBucketsHeaders = field()
    request: shared.GetBucketsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
