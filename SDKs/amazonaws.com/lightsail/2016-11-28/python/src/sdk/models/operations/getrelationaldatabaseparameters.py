...
class GetRelationalDatabaseParametersHeaders:
    x_amz_target: GetRelationalDatabaseParametersXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetRelationalDatabaseParametersRequest:
    headers: GetRelationalDatabaseParametersHeaders = field()
    request: shared.GetRelationalDatabaseParametersRequest = field(metadata={'request': { 'media_type': 'application/json' }})
