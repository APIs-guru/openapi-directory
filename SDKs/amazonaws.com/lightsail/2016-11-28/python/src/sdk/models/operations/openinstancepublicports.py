...
class OpenInstancePublicPortsHeaders:
    ...
    x_amz_target: OpenInstancePublicPortsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
    

@dataclass
class OpenInstancePublicPortsRequest:
    headers: OpenInstancePublicPortsHeaders = field(default=None)
    request: shared.OpenInstancePublicPortsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class OpenInstancePublicPortsResponse:
    ...
    open_instance_public_ports_result: Optional[shared.OpenInstancePublicPortsResult] = field(default=None)
