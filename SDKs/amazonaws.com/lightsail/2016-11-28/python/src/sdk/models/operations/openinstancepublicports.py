...
class OpenInstancePublicPortsHeaders:
    x_amz_target: OpenInstancePublicPortsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class OpenInstancePublicPortsRequest:
    headers: OpenInstancePublicPortsHeaders = field()
    request: shared.OpenInstancePublicPortsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
