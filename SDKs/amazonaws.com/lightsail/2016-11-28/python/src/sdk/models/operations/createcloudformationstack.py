...
class CreateCloudFormationStackHeaders:
    x_amz_target: CreateCloudFormationStackXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateCloudFormationStackRequest:
    headers: CreateCloudFormationStackHeaders = field()
    request: shared.CreateCloudFormationStackRequest = field(metadata={'request': { 'media_type': 'application/json' }})
