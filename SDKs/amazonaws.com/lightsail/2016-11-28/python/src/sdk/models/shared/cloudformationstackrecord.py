...
from . import cloudformationstackrecordsourceinfo
...
class CloudFormationStackRecord:
    ...
    source_info: Optional[List[cloudformationstackrecordsourceinfo.CloudFormationStackRecordSourceInfo]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'sourceInfo' }})
