...
class GetInstanceAccessDetailsHeaders:
    x_amz_target: GetInstanceAccessDetailsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetInstanceAccessDetailsRequest:
    headers: GetInstanceAccessDetailsHeaders = field()
    request: shared.GetInstanceAccessDetailsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
