...
var GetTerminateEnvironmentQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=ForceTerminate" }),
        __metadata("design:type", Boolean)
    ], GetTerminateEnvironmentQueryParams.prototype, "forceTerminate", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=TerminateResources" }),
        __metadata("design:type", Boolean)
