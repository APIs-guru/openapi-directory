...
class GetDescribeEnvironmentResourcesQueryParams:
    action: GetDescribeEnvironmentResourcesActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetDescribeEnvironmentResourcesVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDescribeEnvironmentResourcesRequest:
    headers: GetDescribeEnvironmentResourcesHeaders = field()
    query_params: GetDescribeEnvironmentResourcesQueryParams = field()
