...
class PostCreateConfigurationTemplateQueryParams:
    action: PostCreateConfigurationTemplateActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostCreateConfigurationTemplateVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostCreateConfigurationTemplateRequest:
    headers: PostCreateConfigurationTemplateHeaders = field()
    query_params: PostCreateConfigurationTemplateQueryParams = field()
