...
class PostValidateConfigurationSettingsQueryParams:
    action: PostValidateConfigurationSettingsActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostValidateConfigurationSettingsVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostValidateConfigurationSettingsRequest:
    headers: PostValidateConfigurationSettingsHeaders = field()
    query_params: PostValidateConfigurationSettingsQueryParams = field()
