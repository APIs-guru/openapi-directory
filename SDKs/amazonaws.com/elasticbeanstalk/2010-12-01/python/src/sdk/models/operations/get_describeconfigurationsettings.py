...
class GetDescribeConfigurationSettingsQueryParams:
    action: GetDescribeConfigurationSettingsActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    application_name: str = field(metadata={'query_param': { 'field_name': 'ApplicationName', 'style': 'form', 'explode': True }})
    version: GetDescribeConfigurationSettingsVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDescribeConfigurationSettingsRequest:
    headers: GetDescribeConfigurationSettingsHeaders = field()
    query_params: GetDescribeConfigurationSettingsQueryParams = field()
