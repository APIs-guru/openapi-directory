...
class SubscribeToDatasetRequest:
    path_params: SubscribeToDatasetPathParams = field(default=None)
    headers: SubscribeToDatasetHeaders = field(default=None)
...
class SubscribeToDatasetResponse:
    ...
    subscribe_to_dataset_response: Optional[dict[str, Any]] = field(default=None)
