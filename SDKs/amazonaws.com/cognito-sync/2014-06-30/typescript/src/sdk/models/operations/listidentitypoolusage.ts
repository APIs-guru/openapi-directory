...
export class ListIdentityPoolUsageQueryParams extends SpeakeasyBase {
...
export class ListIdentityPoolUsageHeaders extends SpeakeasyBase {
...
export class ListIdentityPoolUsageRequest extends SpeakeasyBase {
  @Metadata()
