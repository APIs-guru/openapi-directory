...
class CreateSystemInstanceHeaders:
    x_amz_target: CreateSystemInstanceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateSystemInstanceRequest:
    headers: CreateSystemInstanceHeaders = field()
    request: shared.CreateSystemInstanceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
