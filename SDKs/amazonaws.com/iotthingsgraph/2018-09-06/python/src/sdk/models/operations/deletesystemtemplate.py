...
class DeleteSystemTemplateHeaders:
    x_amz_target: DeleteSystemTemplateXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteSystemTemplateRequest:
    headers: DeleteSystemTemplateHeaders = field()
    request: shared.DeleteSystemTemplateRequest = field(metadata={'request': { 'media_type': 'application/json' }})
