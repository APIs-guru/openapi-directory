...
class GetFlowTemplateRevisionsHeaders:
    x_amz_target: GetFlowTemplateRevisionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetFlowTemplateRevisionsRequest:
    headers: GetFlowTemplateRevisionsHeaders = field()
    query_params: GetFlowTemplateRevisionsQueryParams = field()
    request: shared.GetFlowTemplateRevisionsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
