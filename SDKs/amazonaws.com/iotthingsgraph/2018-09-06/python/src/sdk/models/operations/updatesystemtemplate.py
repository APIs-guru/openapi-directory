...
class UpdateSystemTemplateHeaders:
    x_amz_target: UpdateSystemTemplateXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateSystemTemplateRequest:
    headers: UpdateSystemTemplateHeaders = field()
    request: shared.UpdateSystemTemplateRequest = field(metadata={'request': { 'media_type': 'application/json' }})
