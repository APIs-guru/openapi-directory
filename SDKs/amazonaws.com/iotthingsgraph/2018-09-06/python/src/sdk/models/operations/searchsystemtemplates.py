...
class SearchSystemTemplatesHeaders:
    ...
    x_amz_target: SearchSystemTemplatesXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
    

@dataclass
class SearchSystemTemplatesRequest:
    query_params: SearchSystemTemplatesQueryParams = field(default=None)
    headers: SearchSystemTemplatesHeaders = field(default=None)
    request: shared.SearchSystemTemplatesRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
