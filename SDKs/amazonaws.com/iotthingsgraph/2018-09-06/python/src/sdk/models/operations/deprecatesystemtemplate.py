...
class DeprecateSystemTemplateHeaders:
    x_amz_target: DeprecateSystemTemplateXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeprecateSystemTemplateRequest:
    headers: DeprecateSystemTemplateHeaders = field()
    request: shared.DeprecateSystemTemplateRequest = field(metadata={'request': { 'media_type': 'application/json' }})
