...
var SearchThingsRequest = /** @class */ (function (_super) {
    ...
    ], SearchThingsRequest.prototype, "entityId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=maxResults" }),
        __metadata("design:type", Number)
    ], SearchThingsRequest.prototype, "maxResults", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=namespaceVersion" }),
        __metadata("design:type", Number)
    ], SearchThingsRequest.prototype, "namespaceVersion", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=nextToken" }),
        __metadata("design:type", String)
    ], SearchThingsRequest.prototype, "nextToken", void 0);
