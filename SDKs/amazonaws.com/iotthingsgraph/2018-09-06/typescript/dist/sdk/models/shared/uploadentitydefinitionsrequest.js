...
var UploadEntityDefinitionsRequest = /** @class */ (function (_super) {
    ...
    ], UploadEntityDefinitionsRequest.prototype, "deprecateExistingEntities", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=document" }),
        __metadata("design:type", DefinitionDocument)
    ], UploadEntityDefinitionsRequest.prototype, "document", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=syncWithPublicNamespace" }),
        __metadata("design:type", Boolean)
    ], UploadEntityDefinitionsRequest.prototype, "syncWithPublicNamespace", void 0);
