...
var EntityDescription = /** @class */ (function (_super) {
    ...
    ], EntityDescription.prototype, "arn", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=createdAt" }),
        __metadata("design:type", Date)
    ], EntityDescription.prototype, "createdAt", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=definition" }),
        __metadata("design:type", DefinitionDocument)
    ], EntityDescription.prototype, "definition", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=id" }),
        __metadata("design:type", String)
    ], EntityDescription.prototype, "id", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=type" }),
        __metadata("design:type", String)
    ], EntityDescription.prototype, "type", void 0);
