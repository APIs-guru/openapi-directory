...
export class GetEventStreamPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=application-id" })
  applicationId: string;
}


export class GetEventStreamHeaders extends SpeakeasyBase {
...
export class GetEventStreamRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
