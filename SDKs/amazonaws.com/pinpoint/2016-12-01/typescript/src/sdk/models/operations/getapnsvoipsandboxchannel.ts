...
export class GetApnsVoipSandboxChannelPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=application-id" })
  applicationId: string;
}


export class GetApnsVoipSandboxChannelHeaders extends SpeakeasyBase {
...
export class GetApnsVoipSandboxChannelRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
