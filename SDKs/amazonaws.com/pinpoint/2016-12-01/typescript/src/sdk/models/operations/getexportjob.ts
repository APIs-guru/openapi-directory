...
export class GetExportJobPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=application-id" })
  applicationId: string;

  @Metadata({ data: "pathParam, style=simple;explode=false;name=job-id" })
  jobId: string;
}


export class GetExportJobHeaders extends SpeakeasyBase {
...
export class GetExportJobRequest extends SpeakeasyBase {
  @Metadata()
