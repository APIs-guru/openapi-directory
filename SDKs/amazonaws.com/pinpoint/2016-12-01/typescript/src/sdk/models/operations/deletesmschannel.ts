...
export class DeleteSmsChannelPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=application-id" })
  applicationId: string;
}


export class DeleteSmsChannelHeaders extends SpeakeasyBase {
...
export class DeleteSmsChannelRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
