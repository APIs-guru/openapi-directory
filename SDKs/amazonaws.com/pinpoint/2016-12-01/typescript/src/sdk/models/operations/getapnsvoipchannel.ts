...
export class GetApnsVoipChannelPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=application-id" })
  applicationId: string;
}


export class GetApnsVoipChannelHeaders extends SpeakeasyBase {
...
export class GetApnsVoipChannelRequest extends SpeakeasyBase {
  @Metadata()
