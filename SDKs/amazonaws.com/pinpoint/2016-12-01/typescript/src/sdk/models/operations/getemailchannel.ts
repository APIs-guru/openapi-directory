...
export class GetEmailChannelPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=application-id" })
  applicationId: string;
}


export class GetEmailChannelHeaders extends SpeakeasyBase {
...
export class GetEmailChannelRequest extends SpeakeasyBase {
  @Metadata()
