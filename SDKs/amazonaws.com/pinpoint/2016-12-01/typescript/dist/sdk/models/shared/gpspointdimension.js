...
**/
var GpsPointDimension = /** @class */ (function (_super) {
    __extends(GpsPointDimension, _super);
    ...
    ], GpsPointDimension.prototype, "coordinates", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=RangeInKilometers" }),
        __metadata("design:type", Number)
    ], GpsPointDimension.prototype, "rangeInKilometers", void 0);
    return GpsPointDimension;
}(SpeakeasyBase));
export { GpsPointDimension };
