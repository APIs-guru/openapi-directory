...
**/
var PushMessageActivity = /** @class */ (function (_super) {
    __extends(PushMessageActivity, _super);
    function PushMessageActivity() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=MessageConfig" }),
        __metadata("design:type", JourneyPushMessage)
    ], PushMessageActivity.prototype, "messageConfig", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=NextActivity" }),
        __metadata("design:type", String)
    ], PushMessageActivity.prototype, "nextActivity", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=TemplateName" }),
        __metadata("design:type", String)
    ], PushMessageActivity.prototype, "templateName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=TemplateVersion" }),
        __metadata("design:type", String)
    ], PushMessageActivity.prototype, "templateVersion", void 0);
