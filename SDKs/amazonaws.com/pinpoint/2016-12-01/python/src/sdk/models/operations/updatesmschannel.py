...
class UpdateSmsChannelRequestBody:
    sms_channel_request: UpdateSmsChannelRequestBodySmsChannelRequest = field(default=None, metadata={'dataclasses_json': { 'field_name': 'SMSChannelRequest' }})
    

@dataclass
class UpdateSmsChannelRequest:
    path_params: UpdateSmsChannelPathParams = field(default=None)
    headers: UpdateSmsChannelHeaders = field(default=None)
    request: UpdateSmsChannelRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
