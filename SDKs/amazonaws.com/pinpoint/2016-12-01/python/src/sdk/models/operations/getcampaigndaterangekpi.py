...
class GetCampaignDateRangeKpiRequest:
    path_params: GetCampaignDateRangeKpiPathParams = field(default=None)
    query_params: GetCampaignDateRangeKpiQueryParams = field(default=None)
    headers: GetCampaignDateRangeKpiHeaders = field(default=None)
...
class GetCampaignDateRangeKpiResponse:
    ...
    get_campaign_date_range_kpi_response: Optional[shared.GetCampaignDateRangeKpiResponse] = field(default=None)
