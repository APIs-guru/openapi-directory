...
class DeleteInAppTemplateRequest:
    path_params: DeleteInAppTemplatePathParams = field(default=None)
    query_params: DeleteInAppTemplateQueryParams = field(default=None)
    headers: DeleteInAppTemplateHeaders = field(default=None)
...
class DeleteInAppTemplateResponse:
    ...
    delete_in_app_template_response: Optional[shared.DeleteInAppTemplateResponse] = field(default=None)
