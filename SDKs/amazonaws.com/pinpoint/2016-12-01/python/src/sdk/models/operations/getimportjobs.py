...
class GetImportJobsRequest:
    path_params: GetImportJobsPathParams = field(default=None)
    query_params: GetImportJobsQueryParams = field(default=None)
    headers: GetImportJobsHeaders = field(default=None)
...
class GetImportJobsResponse:
    ...
    get_import_jobs_response: Optional[shared.GetImportJobsResponse] = field(default=None)
