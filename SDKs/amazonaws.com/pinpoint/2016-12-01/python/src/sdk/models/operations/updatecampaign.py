...
class UpdateCampaignRequestBody:
    write_campaign_request: UpdateCampaignRequestBodyWriteCampaignRequest = field(default=None, metadata={'dataclasses_json': { 'field_name': 'WriteCampaignRequest' }})
    

@dataclass
class UpdateCampaignRequest:
    path_params: UpdateCampaignPathParams = field(default=None)
    headers: UpdateCampaignHeaders = field(default=None)
    request: UpdateCampaignRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
