...
class UpdateVoiceTemplateRequestBody:
    voice_template_request: UpdateVoiceTemplateRequestBodyVoiceTemplateRequest = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('VoiceTemplateRequest') }})
    

@dataclass
class UpdateVoiceTemplateRequest:
    headers: UpdateVoiceTemplateHeaders = field()
    path_params: UpdateVoiceTemplatePathParams = field()
    query_params: UpdateVoiceTemplateQueryParams = field()
    request: UpdateVoiceTemplateRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
