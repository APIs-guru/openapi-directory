...
class GetSmsTemplateRequest:
    path_params: GetSmsTemplatePathParams = field(default=None)
    query_params: GetSmsTemplateQueryParams = field(default=None)
    headers: GetSmsTemplateHeaders = field(default=None)
...
class GetSmsTemplateResponse:
    ...
    get_sms_template_response: Optional[shared.GetSmsTemplateResponse] = field(default=None)
