...
class GetSegmentsRequest:
    path_params: GetSegmentsPathParams = field(default=None)
    query_params: GetSegmentsQueryParams = field(default=None)
    headers: GetSegmentsHeaders = field(default=None)
...
class GetSegmentsResponse:
    ...
    get_segments_response: Optional[shared.GetSegmentsResponse] = field(default=None)
