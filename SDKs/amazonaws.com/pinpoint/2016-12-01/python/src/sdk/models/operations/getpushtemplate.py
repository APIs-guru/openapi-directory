...
class GetPushTemplateRequest:
    path_params: GetPushTemplatePathParams = field(default=None)
    query_params: GetPushTemplateQueryParams = field(default=None)
    headers: GetPushTemplateHeaders = field(default=None)
...
class GetPushTemplateResponse:
    ...
    get_push_template_response: Optional[shared.GetPushTemplateResponse] = field(default=None)
