...
class GetChannelsRequest:
    path_params: GetChannelsPathParams = field(default=None)
    headers: GetChannelsHeaders = field(default=None)
...
class GetChannelsResponse:
    ...
    get_channels_response: Optional[shared.GetChannelsResponse] = field(default=None)
