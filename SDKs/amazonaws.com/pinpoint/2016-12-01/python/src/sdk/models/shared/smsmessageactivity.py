...
from . import journeysmsmessage


@dataclass_json
@dataclass
class SmsMessageActivity:
    message_config: Optional[journeysmsmessage.JourneySmsMessage] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'MessageConfig' }})
