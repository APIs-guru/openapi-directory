...
class GetJourneyRequest:
    path_params: GetJourneyPathParams = field(default=None)
    headers: GetJourneyHeaders = field(default=None)
...
class GetJourneyResponse:
    ...
    get_journey_response: Optional[shared.GetJourneyResponse] = field(default=None)
