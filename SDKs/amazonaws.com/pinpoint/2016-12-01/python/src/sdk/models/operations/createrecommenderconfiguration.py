...
class CreateRecommenderConfigurationRequestBodyCreateRecommenderConfiguration:
    ...
    recommendation_provider_role_arn: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('RecommendationProviderRoleArn') }})
    recommendation_provider_uri: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('RecommendationProviderUri') }})
...
class CreateRecommenderConfigurationRequestBody:
    create_recommender_configuration: CreateRecommenderConfigurationRequestBodyCreateRecommenderConfiguration = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('CreateRecommenderConfiguration') }})
    

@dataclass
class CreateRecommenderConfigurationRequest:
    headers: CreateRecommenderConfigurationHeaders = field()
    request: CreateRecommenderConfigurationRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
