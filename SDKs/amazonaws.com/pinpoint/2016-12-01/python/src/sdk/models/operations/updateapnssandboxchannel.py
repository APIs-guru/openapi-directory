...
class UpdateApnsSandboxChannelRequestBody:
    apns_sandbox_channel_request: UpdateApnsSandboxChannelRequestBodyApnsSandboxChannelRequest = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('APNSSandboxChannelRequest') }})
    

@dataclass
class UpdateApnsSandboxChannelRequest:
    headers: UpdateApnsSandboxChannelHeaders = field()
    path_params: UpdateApnsSandboxChannelPathParams = field()
    request: UpdateApnsSandboxChannelRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
