...
class UpdateApnsSandboxChannelRequestBody:
    apns_sandbox_channel_request: UpdateApnsSandboxChannelRequestBodyApnsSandboxChannelRequest = field(default=None, metadata={'dataclasses_json': { 'field_name': 'APNSSandboxChannelRequest' }})
    

@dataclass
class UpdateApnsSandboxChannelRequest:
    path_params: UpdateApnsSandboxChannelPathParams = field(default=None)
    headers: UpdateApnsSandboxChannelHeaders = field(default=None)
    request: UpdateApnsSandboxChannelRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateApnsSandboxChannelResponse:
    ...
    update_apns_sandbox_channel_response: Optional[shared.UpdateApnsSandboxChannelResponse] = field(default=None)
