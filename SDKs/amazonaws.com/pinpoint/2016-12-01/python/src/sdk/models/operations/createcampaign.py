...
class CreateCampaignRequestBody:
    write_campaign_request: CreateCampaignRequestBodyWriteCampaignRequest = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('WriteCampaignRequest') }})
    

@dataclass
class CreateCampaignRequest:
    headers: CreateCampaignHeaders = field()
    path_params: CreateCampaignPathParams = field()
    request: CreateCampaignRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
