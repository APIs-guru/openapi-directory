...
class DeleteVoiceChannelRequest:
    path_params: DeleteVoiceChannelPathParams = field(default=None)
    headers: DeleteVoiceChannelHeaders = field(default=None)
...
class DeleteVoiceChannelResponse:
    ...
    delete_voice_channel_response: Optional[shared.DeleteVoiceChannelResponse] = field(default=None)
