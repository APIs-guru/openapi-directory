...
class GetExportJobsRequest:
    path_params: GetExportJobsPathParams = field(default=None)
    query_params: GetExportJobsQueryParams = field(default=None)
    headers: GetExportJobsHeaders = field(default=None)
...
class GetExportJobsResponse:
    ...
    get_export_jobs_response: Optional[shared.GetExportJobsResponse] = field(default=None)
