...
class UpdateEndpointsBatchRequestBodyEndpointBatchRequest:
    ...
    item: Optional[List[shared.EndpointBatchItem]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Item') }})
    

@dataclass_json
@dataclass
class UpdateEndpointsBatchRequestBody:
    endpoint_batch_request: UpdateEndpointsBatchRequestBodyEndpointBatchRequest = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('EndpointBatchRequest') }})
    

@dataclass
class UpdateEndpointsBatchRequest:
    headers: UpdateEndpointsBatchHeaders = field()
    path_params: UpdateEndpointsBatchPathParams = field()
    request: UpdateEndpointsBatchRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
