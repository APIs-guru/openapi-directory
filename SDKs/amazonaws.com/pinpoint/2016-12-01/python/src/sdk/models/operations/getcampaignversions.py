...
class GetCampaignVersionsRequest:
    path_params: GetCampaignVersionsPathParams = field(default=None)
    query_params: GetCampaignVersionsQueryParams = field(default=None)
    headers: GetCampaignVersionsHeaders = field(default=None)
...
class GetCampaignVersionsResponse:
    ...
    get_campaign_versions_response: Optional[shared.GetCampaignVersionsResponse] = field(default=None)
