...
class GetEndpointRequest:
    path_params: GetEndpointPathParams = field(default=None)
    headers: GetEndpointHeaders = field(default=None)
...
class GetEndpointResponse:
    ...
    get_endpoint_response: Optional[shared.GetEndpointResponse] = field(default=None)
