...
class GetSegmentVersionsRequest:
    path_params: GetSegmentVersionsPathParams = field(default=None)
    query_params: GetSegmentVersionsQueryParams = field(default=None)
    headers: GetSegmentVersionsHeaders = field(default=None)
...
class GetSegmentVersionsResponse:
    ...
    get_segment_versions_response: Optional[shared.GetSegmentVersionsResponse] = field(default=None)
