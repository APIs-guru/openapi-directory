...
class DeleteSegmentRequest:
    path_params: DeleteSegmentPathParams = field(default=None)
    headers: DeleteSegmentHeaders = field(default=None)
...
class DeleteSegmentResponse:
    ...
    delete_segment_response: Optional[shared.DeleteSegmentResponse] = field(default=None)
