...
class GetCampaignsRequest:
    path_params: GetCampaignsPathParams = field(default=None)
    query_params: GetCampaignsQueryParams = field(default=None)
    headers: GetCampaignsHeaders = field(default=None)
...
class GetCampaignsResponse:
    ...
    get_campaigns_response: Optional[shared.GetCampaignsResponse] = field(default=None)
