...
class GetSegmentExportJobsRequest:
    path_params: GetSegmentExportJobsPathParams = field(default=None)
    query_params: GetSegmentExportJobsQueryParams = field(default=None)
    headers: GetSegmentExportJobsHeaders = field(default=None)
...
class GetSegmentExportJobsResponse:
    ...
    get_segment_export_jobs_response: Optional[shared.GetSegmentExportJobsResponse] = field(default=None)
