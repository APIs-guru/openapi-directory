...
class GetInAppMessagesRequest:
    path_params: GetInAppMessagesPathParams = field(default=None)
    headers: GetInAppMessagesHeaders = field(default=None)
...
class GetInAppMessagesResponse:
    ...
    get_in_app_messages_response: Optional[shared.GetInAppMessagesResponse] = field(default=None)
