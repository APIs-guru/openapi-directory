...
class UpdatePushTemplateRequestBody:
    push_notification_template_request: UpdatePushTemplateRequestBodyPushNotificationTemplateRequest = field(default=None, metadata={'dataclasses_json': { 'field_name': 'PushNotificationTemplateRequest' }})
    

@dataclass
class UpdatePushTemplateRequest:
    path_params: UpdatePushTemplatePathParams = field(default=None)
    query_params: UpdatePushTemplateQueryParams = field(default=None)
    headers: UpdatePushTemplateHeaders = field(default=None)
    request: UpdatePushTemplateRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
