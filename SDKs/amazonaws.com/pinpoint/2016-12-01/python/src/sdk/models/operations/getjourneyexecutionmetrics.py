...
class GetJourneyExecutionMetricsRequest:
    path_params: GetJourneyExecutionMetricsPathParams = field(default=None)
    query_params: GetJourneyExecutionMetricsQueryParams = field(default=None)
    headers: GetJourneyExecutionMetricsHeaders = field(default=None)
...
class GetJourneyExecutionMetricsResponse:
    ...
    get_journey_execution_metrics_response: Optional[shared.GetJourneyExecutionMetricsResponse] = field(default=None)
