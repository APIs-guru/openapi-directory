...
class GetJourneyExecutionMetricsRequest:
    headers: GetJourneyExecutionMetricsHeaders = field()
    path_params: GetJourneyExecutionMetricsPathParams = field()
    query_params: GetJourneyExecutionMetricsQueryParams = field()
