...
class UpdateJourneyStateRequestBody:
    journey_state_request: UpdateJourneyStateRequestBodyJourneyStateRequest = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('JourneyStateRequest') }})
    

@dataclass
class UpdateJourneyStateRequest:
    headers: UpdateJourneyStateHeaders = field()
    path_params: UpdateJourneyStatePathParams = field()
    request: UpdateJourneyStateRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
