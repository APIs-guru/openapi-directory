...
class ListTemplatesQueryParams:
    ...
    template_type: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'template-type', 'style': 'form', 'explode': True }})
...
class ListTemplatesRequest:
    ...
    headers: ListTemplatesHeaders = field(default=None)
