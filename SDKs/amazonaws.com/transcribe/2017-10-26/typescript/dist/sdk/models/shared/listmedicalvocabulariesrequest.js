...
var ListMedicalVocabulariesRequest = /** @class */ (function (_super) {
    ...
    ], ListMedicalVocabulariesRequest.prototype, "maxResults", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=NameContains" }),
        __metadata("design:type", String)
    ], ListMedicalVocabulariesRequest.prototype, "nameContains", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=NextToken" }),
        __metadata("design:type", String)
    ], ListMedicalVocabulariesRequest.prototype, "nextToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=StateEquals" }),
        __metadata("design:type", String)
    ], ListMedicalVocabulariesRequest.prototype, "stateEquals", void 0);
