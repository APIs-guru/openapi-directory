...
var CreateLanguageModelResponse = /** @class */ (function (_super) {
    ...
    ], CreateLanguageModelResponse.prototype, "baseModelName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=InputDataConfig" }),
        __metadata("design:type", InputDataConfig)
    ], CreateLanguageModelResponse.prototype, "inputDataConfig", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=LanguageCode" }),
        __metadata("design:type", String)
    ], CreateLanguageModelResponse.prototype, "languageCode", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ModelName" }),
        __metadata("design:type", String)
    ], CreateLanguageModelResponse.prototype, "modelName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ModelStatus" }),
        __metadata("design:type", String)
    ], CreateLanguageModelResponse.prototype, "modelStatus", void 0);
