...
var ListTranscriptionJobsResponse = /** @class */ (function (_super) {
    ...
    ], ListTranscriptionJobsResponse.prototype, "nextToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Status" }),
        __metadata("design:type", String)
    ], ListTranscriptionJobsResponse.prototype, "status", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=TranscriptionJobSummaries", elemType: TranscriptionJobSummary }),
        __metadata("design:type", Array)
    ], ListTranscriptionJobsResponse.prototype, "transcriptionJobSummaries", void 0);
