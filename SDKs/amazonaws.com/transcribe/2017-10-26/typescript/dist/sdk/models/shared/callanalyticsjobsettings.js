...
**/
var CallAnalyticsJobSettings = /** @class */ (function (_super) {
    __extends(CallAnalyticsJobSettings, _super);
    ...
    ], CallAnalyticsJobSettings.prototype, "contentRedaction", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=LanguageModelName" }),
        __metadata("design:type", String)
    ], CallAnalyticsJobSettings.prototype, "languageModelName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=LanguageOptions" }),
        __metadata("design:type", Array)
    ], CallAnalyticsJobSettings.prototype, "languageOptions", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=VocabularyFilterMethod" }),
        __metadata("design:type", String)
    ], CallAnalyticsJobSettings.prototype, "vocabularyFilterMethod", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=VocabularyFilterName" }),
        __metadata("design:type", String)
    ], CallAnalyticsJobSettings.prototype, "vocabularyFilterName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=VocabularyName" }),
        __metadata("design:type", String)
    ], CallAnalyticsJobSettings.prototype, "vocabularyName", void 0);
    return CallAnalyticsJobSettings;
}(SpeakeasyBase));
export { CallAnalyticsJobSettings };
