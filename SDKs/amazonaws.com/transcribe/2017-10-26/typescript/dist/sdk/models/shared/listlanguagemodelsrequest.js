...
var ListLanguageModelsRequest = /** @class */ (function (_super) {
    ...
    ], ListLanguageModelsRequest.prototype, "maxResults", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=NameContains" }),
        __metadata("design:type", String)
    ], ListLanguageModelsRequest.prototype, "nameContains", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=NextToken" }),
        __metadata("design:type", String)
    ], ListLanguageModelsRequest.prototype, "nextToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=StatusEquals" }),
        __metadata("design:type", String)
    ], ListLanguageModelsRequest.prototype, "statusEquals", void 0);
