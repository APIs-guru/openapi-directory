...
class UpdateMedicalVocabularyHeaders:
    x_amz_target: UpdateMedicalVocabularyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateMedicalVocabularyRequest:
    headers: UpdateMedicalVocabularyHeaders = field()
    request: shared.UpdateMedicalVocabularyRequest = field(metadata={'request': { 'media_type': 'application/json' }})
