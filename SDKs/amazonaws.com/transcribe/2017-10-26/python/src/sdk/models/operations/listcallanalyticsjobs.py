...
class ListCallAnalyticsJobsHeaders:
    x_amz_target: ListCallAnalyticsJobsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListCallAnalyticsJobsRequest:
    headers: ListCallAnalyticsJobsHeaders = field()
    query_params: ListCallAnalyticsJobsQueryParams = field()
    request: shared.ListCallAnalyticsJobsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
