...
class GetCallAnalyticsJobHeaders:
    x_amz_target: GetCallAnalyticsJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetCallAnalyticsJobRequest:
    headers: GetCallAnalyticsJobHeaders = field()
    request: shared.GetCallAnalyticsJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
