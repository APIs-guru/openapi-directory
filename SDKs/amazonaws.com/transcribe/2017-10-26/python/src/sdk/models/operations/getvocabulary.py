...
class GetVocabularyHeaders:
    x_amz_target: GetVocabularyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetVocabularyRequest:
    headers: GetVocabularyHeaders = field()
    request: shared.GetVocabularyRequest = field(metadata={'request': { 'media_type': 'application/json' }})
