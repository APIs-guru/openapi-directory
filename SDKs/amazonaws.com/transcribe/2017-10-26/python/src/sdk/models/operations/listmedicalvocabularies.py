...
class ListMedicalVocabulariesHeaders:
    x_amz_target: ListMedicalVocabulariesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListMedicalVocabulariesRequest:
    headers: ListMedicalVocabulariesHeaders = field()
    query_params: ListMedicalVocabulariesQueryParams = field()
    request: shared.ListMedicalVocabulariesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
