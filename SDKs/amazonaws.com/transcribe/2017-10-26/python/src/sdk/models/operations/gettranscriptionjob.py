...
class GetTranscriptionJobHeaders:
    x_amz_target: GetTranscriptionJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetTranscriptionJobRequest:
    headers: GetTranscriptionJobHeaders = field()
    request: shared.GetTranscriptionJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
