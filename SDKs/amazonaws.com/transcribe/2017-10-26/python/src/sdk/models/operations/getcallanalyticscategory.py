...
class GetCallAnalyticsCategoryHeaders:
    x_amz_target: GetCallAnalyticsCategoryXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetCallAnalyticsCategoryRequest:
    headers: GetCallAnalyticsCategoryHeaders = field()
    request: shared.GetCallAnalyticsCategoryRequest = field(metadata={'request': { 'media_type': 'application/json' }})
