...
class StartCallAnalyticsJobHeaders:
    ...
    x_amz_target: StartCallAnalyticsJobXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class StartCallAnalyticsJobRequest:
    headers: StartCallAnalyticsJobHeaders = field(default=None)
    request: shared.StartCallAnalyticsJobRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
