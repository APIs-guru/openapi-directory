...
class ListMedicalTranscriptionJobsHeaders:
    x_amz_target: ListMedicalTranscriptionJobsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListMedicalTranscriptionJobsRequest:
    headers: ListMedicalTranscriptionJobsHeaders = field()
    query_params: ListMedicalTranscriptionJobsQueryParams = field()
    request: shared.ListMedicalTranscriptionJobsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
