...
class DeleteCallAnalyticsCategoryHeaders:
    x_amz_target: DeleteCallAnalyticsCategoryXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteCallAnalyticsCategoryRequest:
    headers: DeleteCallAnalyticsCategoryHeaders = field()
    request: shared.DeleteCallAnalyticsCategoryRequest = field(metadata={'request': { 'media_type': 'application/json' }})
