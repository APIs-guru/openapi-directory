...
class ListS3ResourcesHeaders:
    x_amz_target: ListS3ResourcesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListS3ResourcesRequest:
    headers: ListS3ResourcesHeaders = field()
    query_params: ListS3ResourcesQueryParams = field()
    request: shared.ListS3ResourcesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
