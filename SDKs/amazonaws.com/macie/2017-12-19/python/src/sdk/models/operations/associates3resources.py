...
class AssociateS3ResourcesHeaders:
    x_amz_target: AssociateS3ResourcesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AssociateS3ResourcesRequest:
    headers: AssociateS3ResourcesHeaders = field()
    request: shared.AssociateS3ResourcesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
