...
class UpdateS3ResourcesHeaders:
    x_amz_target: UpdateS3ResourcesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateS3ResourcesRequest:
    headers: UpdateS3ResourcesHeaders = field()
    request: shared.UpdateS3ResourcesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
