...
class DisassociateS3ResourcesHeaders:
    x_amz_target: DisassociateS3ResourcesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DisassociateS3ResourcesRequest:
    headers: DisassociateS3ResourcesHeaders = field()
    request: shared.DisassociateS3ResourcesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
