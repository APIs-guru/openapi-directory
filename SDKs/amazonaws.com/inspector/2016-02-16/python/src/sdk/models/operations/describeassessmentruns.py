...
class DescribeAssessmentRunsHeaders:
    ...
    x_amz_target: DescribeAssessmentRunsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeAssessmentRunsRequest:
    headers: DescribeAssessmentRunsHeaders = field(default=None)
    request: shared.DescribeAssessmentRunsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
