...
class CreateAssessmentTemplateHeaders:
    x_amz_target: CreateAssessmentTemplateXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateAssessmentTemplateRequest:
    headers: CreateAssessmentTemplateHeaders = field()
    request: shared.CreateAssessmentTemplateRequest = field(metadata={'request': { 'media_type': 'application/json' }})
