...
class GetAssessmentReportHeaders:
    x_amz_target: GetAssessmentReportXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetAssessmentReportRequest:
    headers: GetAssessmentReportHeaders = field()
    request: shared.GetAssessmentReportRequest = field(metadata={'request': { 'media_type': 'application/json' }})
