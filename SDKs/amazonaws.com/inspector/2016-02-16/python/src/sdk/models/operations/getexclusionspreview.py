...
class GetExclusionsPreviewHeaders:
    ...
    x_amz_target: GetExclusionsPreviewXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetExclusionsPreviewRequest:
    query_params: GetExclusionsPreviewQueryParams = field(default=None)
    headers: GetExclusionsPreviewHeaders = field(default=None)
    request: shared.GetExclusionsPreviewRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
