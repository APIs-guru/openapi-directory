...
class CreateExclusionsPreviewHeaders:
    ...
    x_amz_target: CreateExclusionsPreviewXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateExclusionsPreviewRequest:
    headers: CreateExclusionsPreviewHeaders = field(default=None)
    request: shared.CreateExclusionsPreviewRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
