...
class AddAttributesToFindingsHeaders:
    x_amz_target: AddAttributesToFindingsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AddAttributesToFindingsRequest:
    headers: AddAttributesToFindingsHeaders = field()
    request: shared.AddAttributesToFindingsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
