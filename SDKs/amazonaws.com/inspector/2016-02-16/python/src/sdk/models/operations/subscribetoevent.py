...
class SubscribeToEventHeaders:
    ...
    x_amz_target: SubscribeToEventXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class SubscribeToEventRequest:
    headers: SubscribeToEventHeaders = field(default=None)
    request: shared.SubscribeToEventRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
