...
class SubscribeToEventHeaders:
    x_amz_target: SubscribeToEventXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class SubscribeToEventRequest:
    headers: SubscribeToEventHeaders = field()
    request: shared.SubscribeToEventRequest = field(metadata={'request': { 'media_type': 'application/json' }})
