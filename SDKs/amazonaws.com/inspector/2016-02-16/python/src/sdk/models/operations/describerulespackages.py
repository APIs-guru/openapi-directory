...
class DescribeRulesPackagesHeaders:
    x_amz_target: DescribeRulesPackagesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeRulesPackagesRequest:
    headers: DescribeRulesPackagesHeaders = field()
    request: shared.DescribeRulesPackagesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
