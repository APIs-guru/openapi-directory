...
class CreateAssessmentTargetHeaders:
    x_amz_target: CreateAssessmentTargetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateAssessmentTargetRequest:
    headers: CreateAssessmentTargetHeaders = field()
    request: shared.CreateAssessmentTargetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
