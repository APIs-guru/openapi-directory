...
class UnsubscribeFromEventHeaders:
    ...
    x_amz_target: UnsubscribeFromEventXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UnsubscribeFromEventRequest:
    headers: UnsubscribeFromEventHeaders = field(default=None)
    request: shared.UnsubscribeFromEventRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
