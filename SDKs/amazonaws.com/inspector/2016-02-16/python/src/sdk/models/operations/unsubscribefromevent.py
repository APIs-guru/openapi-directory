...
class UnsubscribeFromEventHeaders:
    x_amz_target: UnsubscribeFromEventXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UnsubscribeFromEventRequest:
    headers: UnsubscribeFromEventHeaders = field()
    request: shared.UnsubscribeFromEventRequest = field(metadata={'request': { 'media_type': 'application/json' }})
