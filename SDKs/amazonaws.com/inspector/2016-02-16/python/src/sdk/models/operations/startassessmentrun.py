...
class StartAssessmentRunHeaders:
    x_amz_target: StartAssessmentRunXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartAssessmentRunRequest:
    headers: StartAssessmentRunHeaders = field()
    request: shared.StartAssessmentRunRequest = field(metadata={'request': { 'media_type': 'application/json' }})
