...
class UpdateAssessmentTargetHeaders:
    x_amz_target: UpdateAssessmentTargetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateAssessmentTargetRequest:
    headers: UpdateAssessmentTargetHeaders = field()
    request: shared.UpdateAssessmentTargetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
