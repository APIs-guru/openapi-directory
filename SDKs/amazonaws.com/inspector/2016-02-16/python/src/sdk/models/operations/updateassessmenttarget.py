...
class UpdateAssessmentTargetHeaders:
    ...
    x_amz_target: UpdateAssessmentTargetXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateAssessmentTargetRequest:
    headers: UpdateAssessmentTargetHeaders = field(default=None)
    request: shared.UpdateAssessmentTargetRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
