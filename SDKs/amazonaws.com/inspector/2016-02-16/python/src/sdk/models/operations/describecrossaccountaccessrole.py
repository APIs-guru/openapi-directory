...
class DescribeCrossAccountAccessRoleHeaders:
    x_amz_target: DescribeCrossAccountAccessRoleXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeCrossAccountAccessRoleRequest:
    headers: DescribeCrossAccountAccessRoleHeaders = field()
