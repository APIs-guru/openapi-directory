...
class ListFindingsHeaders:
    x_amz_target: ListFindingsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListFindingsRequest:
    ...
    request: shared.ListFindingsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
