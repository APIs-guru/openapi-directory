...
class DeleteAssessmentRunHeaders:
    x_amz_target: DeleteAssessmentRunXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteAssessmentRunRequest:
    headers: DeleteAssessmentRunHeaders = field()
    request: shared.DeleteAssessmentRunRequest = field(metadata={'request': { 'media_type': 'application/json' }})
