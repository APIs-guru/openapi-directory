...
export class FeaturizationConfig extends SpeakeasyBase {
  @Metadata({ data: "json, name=Featurizations", elemType: shared.Featurization })
  featurizations?: Featurization[];

  @Metadata({ data: "json, name=ForecastDimensions" })
  forecastDimensions?: string[];

  @Metadata({ data: "json, name=ForecastFrequency" })
