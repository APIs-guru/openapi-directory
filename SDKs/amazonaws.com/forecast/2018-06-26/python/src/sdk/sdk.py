...
__doc__ = """ SDK Documentation: https://docs.aws.amazon.com/forecast/ - Amazon Web Services documentation"""
import requests
...
class SDK:
    r"""SDK Documentation: https://docs.aws.amazon.com/forecast/ - Amazon Web Services documentation"""
    ...
    def create_forecast(self, request: operations.CreateForecastRequest) -> operations.CreateForecastResponse:
        ...
        res = operations.CreateForecastResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateForecastResponse])
    ...
    def create_forecast_export_job(self, request: operations.CreateForecastExportJobRequest) -> operations.CreateForecastExportJobResponse:
        ...
        res = operations.CreateForecastExportJobResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateForecastExportJobResponse])
    ...
    def create_predictor(self, request: operations.CreatePredictorRequest) -> operations.CreatePredictorResponse:
        ...
        res = operations.CreatePredictorResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreatePredictorResponse])
    ...
    def create_predictor_backtest_export_job(self, request: operations.CreatePredictorBacktestExportJobRequest) -> operations.CreatePredictorBacktestExportJobResponse:
        ...
        res = operations.CreatePredictorBacktestExportJobResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreatePredictorBacktestExportJobResponse])
    ...
    def delete_dataset(self, request: operations.DeleteDatasetRequest) -> operations.DeleteDatasetResponse:
        r"""<p>Deletes an Amazon Forecast dataset that was created using the <a>CreateDataset</a> operation. You can only delete datasets that have a status of <code>ACTIVE</code> or <code>CREATE_FAILED</code>. To get the status use the <a>DescribeDataset</a> operation.</p> <note> <p>Forecast does not automatically update any dataset groups that contain the deleted dataset. In order to update the dataset group, use the operation, omitting the deleted dataset's ARN.</p> </note>
        """
    ...
    def delete_dataset_import_job(self, request: operations.DeleteDatasetImportJobRequest) -> operations.DeleteDatasetImportJobResponse:
        r"""Deletes a dataset import job created using the <a>CreateDatasetImportJob</a> operation. You can delete only dataset import jobs that have a status of <code>ACTIVE</code> or <code>CREATE_FAILED</code>. To get the status, use the <a>DescribeDatasetImportJob</a> operation.
        """
        ...
        res = operations.DeleteDatasetImportJobResponse(status_code=r.status_code, content_type=content_type)
    ...
    def delete_forecast(self, request: operations.DeleteForecastRequest) -> operations.DeleteForecastResponse:
        ...
        res = operations.DeleteForecastResponse(status_code=r.status_code, content_type=content_type)
    ...
    def delete_forecast_export_job(self, request: operations.DeleteForecastExportJobRequest) -> operations.DeleteForecastExportJobResponse:
        ...
        res = operations.DeleteForecastExportJobResponse(status_code=r.status_code, content_type=content_type)
    ...
    def delete_predictor(self, request: operations.DeletePredictorRequest) -> operations.DeletePredictorResponse:
        r"""Deletes a predictor created using the <a>CreatePredictor</a> operation. You can delete only predictor that have a status of <code>ACTIVE</code> or <code>CREATE_FAILED</code>. To get the status, use the <a>DescribePredictor</a> operation.
        """
        ...
        res = operations.DeletePredictorResponse(status_code=r.status_code, content_type=content_type)
    ...
    def delete_predictor_backtest_export_job(self, request: operations.DeletePredictorBacktestExportJobRequest) -> operations.DeletePredictorBacktestExportJobResponse:
        ...
        res = operations.DeletePredictorBacktestExportJobResponse(status_code=r.status_code, content_type=content_type)
    ...
    def delete_resource_tree(self, request: operations.DeleteResourceTreeRequest) -> operations.DeleteResourceTreeResponse:
        ...
        res = operations.DeleteResourceTreeResponse(status_code=r.status_code, content_type=content_type)
    ...
    def describe_forecast(self, request: operations.DescribeForecastRequest) -> operations.DescribeForecastResponse:
        ...
        res = operations.DescribeForecastResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribeForecastResponse])
    ...
    def describe_forecast_export_job(self, request: operations.DescribeForecastExportJobRequest) -> operations.DescribeForecastExportJobResponse:
        ...
        res = operations.DescribeForecastExportJobResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribeForecastExportJobResponse])
    ...
    def describe_predictor(self, request: operations.DescribePredictorRequest) -> operations.DescribePredictorResponse:
        ...
        res = operations.DescribePredictorResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribePredictorResponse])
    ...
    def describe_predictor_backtest_export_job(self, request: operations.DescribePredictorBacktestExportJobRequest) -> operations.DescribePredictorBacktestExportJobResponse:
        ...
        res = operations.DescribePredictorBacktestExportJobResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribePredictorBacktestExportJobResponse])
    ...
    def get_accuracy_metrics(self, request: operations.GetAccuracyMetricsRequest) -> operations.GetAccuracyMetricsResponse:
        ...
        res = operations.GetAccuracyMetricsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetAccuracyMetricsResponse])
    ...
    def list_datasets(self, request: operations.ListDatasetsRequest) -> operations.ListDatasetsResponse:
        r"""Returns a list of datasets created using the <a>CreateDataset</a> operation. For each dataset, a summary of its properties, including its Amazon Resource Name (ARN), is returned. To retrieve the complete set of properties, use the ARN with the <a>DescribeDataset</a> operation.
        """
    ...
    def list_forecast_export_jobs(self, request: operations.ListForecastExportJobsRequest) -> operations.ListForecastExportJobsResponse:
        ...
        res = operations.ListForecastExportJobsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListForecastExportJobsResponse])
    ...
    def list_forecasts(self, request: operations.ListForecastsRequest) -> operations.ListForecastsResponse:
        ...
        res = operations.ListForecastsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListForecastsResponse])
    ...
    def list_predictor_backtest_export_jobs(self, request: operations.ListPredictorBacktestExportJobsRequest) -> operations.ListPredictorBacktestExportJobsResponse:
        ...
        res = operations.ListPredictorBacktestExportJobsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListPredictorBacktestExportJobsResponse])
    ...
    def list_predictors(self, request: operations.ListPredictorsRequest) -> operations.ListPredictorsResponse:
        ...
        res = operations.ListPredictorsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListPredictorsResponse])
    ...
    def stop_resource(self, request: operations.StopResourceRequest) -> operations.StopResourceResponse:
        ...
        res = operations.StopResourceResponse(status_code=r.status_code, content_type=content_type)
    ...
    def update_dataset_group(self, request: operations.UpdateDatasetGroupRequest) -> operations.UpdateDatasetGroupResponse:
        r"""<p>Replaces the datasets in a dataset group with the specified datasets.</p> <note> <p>The <code>Status</code> of the dataset group must be <code>ACTIVE</code> before you can use the dataset group to create a predictor. Use the <a>DescribeDatasetGroup</a> operation to get the status.</p> </note>
        """
        ...
        res = operations.UpdateDatasetGroupResponse(status_code=r.status_code, content_type=content_type)
