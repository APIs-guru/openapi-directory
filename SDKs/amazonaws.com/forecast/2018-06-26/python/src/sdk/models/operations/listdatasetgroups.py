...
class ListDatasetGroupsHeaders:
    x_amz_target: ListDatasetGroupsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListDatasetGroupsRequest:
    headers: ListDatasetGroupsHeaders = field()
    query_params: ListDatasetGroupsQueryParams = field()
    request: shared.ListDatasetGroupsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
