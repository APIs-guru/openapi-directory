...
class DescribeForecastHeaders:
    x_amz_target: DescribeForecastXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeForecastRequest:
    headers: DescribeForecastHeaders = field()
    request: shared.DescribeForecastRequest = field(metadata={'request': { 'media_type': 'application/json' }})
