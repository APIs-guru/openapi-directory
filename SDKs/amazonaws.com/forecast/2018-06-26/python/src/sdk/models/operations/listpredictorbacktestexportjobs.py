...
class ListPredictorBacktestExportJobsHeaders:
    ...
    x_amz_target: ListPredictorBacktestExportJobsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ListPredictorBacktestExportJobsRequest:
    query_params: ListPredictorBacktestExportJobsQueryParams = field(default=None)
    headers: ListPredictorBacktestExportJobsHeaders = field(default=None)
    request: shared.ListPredictorBacktestExportJobsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
