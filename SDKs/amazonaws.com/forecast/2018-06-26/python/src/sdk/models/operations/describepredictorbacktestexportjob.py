...
class DescribePredictorBacktestExportJobHeaders:
    x_amz_target: DescribePredictorBacktestExportJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribePredictorBacktestExportJobRequest:
    headers: DescribePredictorBacktestExportJobHeaders = field()
    request: shared.DescribePredictorBacktestExportJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
