...
class IntegerParameterRange:
    max_value: int = field(default=None, metadata={'dataclasses_json': { 'field_name': 'MaxValue' }})
    min_value: int = field(default=None, metadata={'dataclasses_json': { 'field_name': 'MinValue' }})
