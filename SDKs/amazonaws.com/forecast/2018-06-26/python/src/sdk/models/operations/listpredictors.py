...
class ListPredictorsHeaders:
    x_amz_target: ListPredictorsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListPredictorsRequest:
    headers: ListPredictorsHeaders = field()
    query_params: ListPredictorsQueryParams = field()
    request: shared.ListPredictorsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
