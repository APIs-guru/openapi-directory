...
var StopJobPathParams = /** @class */ (function (_super) {
    __extends(StopJobPathParams, _super);
    function StopJobPathParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=appId" }),
        __metadata("design:type", String)
    ], StopJobPathParams.prototype, "appId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=branchName" }),
        __metadata("design:type", String)
    ], StopJobPathParams.prototype, "branchName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=jobId" }),
        __metadata("design:type", String)
    ], StopJobPathParams.prototype, "jobId", void 0);
    return StopJobPathParams;
}(SpeakeasyBase));
export { StopJobPathParams };
...
var StopJobRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", StopJobPathParams)
    ], StopJobRequest.prototype, "pathParams", void 0);
    __decorate([
        SpeakeasyMetadata(),
