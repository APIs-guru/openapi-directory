...
class CreateBranchRequestBody:
    ...
    stage: Optional[CreateBranchRequestBodyStageEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('stage') }})
...
class CreateBranchRequest:
    ...
    path_params: CreateBranchPathParams = field()
    request: CreateBranchRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
