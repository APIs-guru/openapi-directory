...
class GetBranchRequest:
    headers: GetBranchHeaders = field()
    path_params: GetBranchPathParams = field()
...
class GetBranchResponse:
    ...
    get_branch_result: Optional[shared.GetBranchResult] = field(default=None)
