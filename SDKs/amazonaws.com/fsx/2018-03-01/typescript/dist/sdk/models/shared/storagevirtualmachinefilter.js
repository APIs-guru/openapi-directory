...
**/
var StorageVirtualMachineFilter = /** @class */ (function (_super) {
    __extends(StorageVirtualMachineFilter, _super);
    ...
    ], StorageVirtualMachineFilter.prototype, "name", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Values" }),
        __metadata("design:type", Array)
    ], StorageVirtualMachineFilter.prototype, "values", void 0);
    return StorageVirtualMachineFilter;
}(SpeakeasyBase));
export { StorageVirtualMachineFilter };
