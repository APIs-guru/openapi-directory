...
**/
var DeleteFileSystemLustreResponse = /** @class */ (function (_super) {
    __extends(DeleteFileSystemLustreResponse, _super);
    ...
    ], DeleteFileSystemLustreResponse.prototype, "finalBackupId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=FinalBackupTags", elemType: Tag }),
        __metadata("design:type", Array)
    ], DeleteFileSystemLustreResponse.prototype, "finalBackupTags", void 0);
    return DeleteFileSystemLustreResponse;
}(SpeakeasyBase));
export { DeleteFileSystemLustreResponse };
