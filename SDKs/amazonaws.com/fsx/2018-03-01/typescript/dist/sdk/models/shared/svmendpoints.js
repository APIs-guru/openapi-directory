...
**/
var SvmEndpoints = /** @class */ (function (_super) {
    __extends(SvmEndpoints, _super);
    function SvmEndpoints() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Iscsi" }),
        __metadata("design:type", SvmEndpoint)
    ], SvmEndpoints.prototype, "iscsi", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Management" }),
        __metadata("design:type", SvmEndpoint)
    ], SvmEndpoints.prototype, "management", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Nfs" }),
        __metadata("design:type", SvmEndpoint)
    ], SvmEndpoints.prototype, "nfs", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Smb" }),
        __metadata("design:type", SvmEndpoint)
    ], SvmEndpoints.prototype, "smb", void 0);
    return SvmEndpoints;
}(SpeakeasyBase));
export { SvmEndpoints };
