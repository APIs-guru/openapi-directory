...
**/
var DeleteVolumeOntapResponse = /** @class */ (function (_super) {
    __extends(DeleteVolumeOntapResponse, _super);
    ...
    ], DeleteVolumeOntapResponse.prototype, "finalBackupId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=FinalBackupTags", elemType: Tag }),
        __metadata("design:type", Array)
    ], DeleteVolumeOntapResponse.prototype, "finalBackupTags", void 0);
    return DeleteVolumeOntapResponse;
}(SpeakeasyBase));
export { DeleteVolumeOntapResponse };
