...
class DeleteStorageVirtualMachineHeaders:
    x_amz_target: DeleteStorageVirtualMachineXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteStorageVirtualMachineRequest:
    headers: DeleteStorageVirtualMachineHeaders = field()
    request: shared.DeleteStorageVirtualMachineRequest = field(metadata={'request': { 'media_type': 'application/json' }})
