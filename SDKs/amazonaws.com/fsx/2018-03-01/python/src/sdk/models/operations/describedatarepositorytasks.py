...
class DescribeDataRepositoryTasksHeaders:
    ...
    x_amz_target: DescribeDataRepositoryTasksXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeDataRepositoryTasksRequest:
    query_params: DescribeDataRepositoryTasksQueryParams = field(default=None)
    headers: DescribeDataRepositoryTasksHeaders = field(default=None)
    request: shared.DescribeDataRepositoryTasksRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
