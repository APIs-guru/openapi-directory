...
class UpdateVolumeHeaders:
    x_amz_target: UpdateVolumeXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateVolumeRequest:
    headers: UpdateVolumeHeaders = field()
    request: shared.UpdateVolumeRequest = field(metadata={'request': { 'media_type': 'application/json' }})
