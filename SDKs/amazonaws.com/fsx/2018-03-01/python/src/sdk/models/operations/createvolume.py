...
class CreateVolumeHeaders:
    x_amz_target: CreateVolumeXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateVolumeRequest:
    headers: CreateVolumeHeaders = field()
    request: shared.CreateVolumeRequest = field(metadata={'request': { 'media_type': 'application/json' }})
