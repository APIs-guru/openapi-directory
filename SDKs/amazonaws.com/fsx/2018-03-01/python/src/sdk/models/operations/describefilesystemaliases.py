...
class DescribeFileSystemAliasesHeaders:
    x_amz_target: DescribeFileSystemAliasesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeFileSystemAliasesRequest:
    headers: DescribeFileSystemAliasesHeaders = field()
    query_params: DescribeFileSystemAliasesQueryParams = field()
    request: shared.DescribeFileSystemAliasesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
