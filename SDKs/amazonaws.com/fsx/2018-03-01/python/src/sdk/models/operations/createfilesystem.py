...
class CreateFileSystemHeaders:
    x_amz_target: CreateFileSystemXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateFileSystemRequest:
    ...
    request: shared.CreateFileSystemRequest = field(metadata={'request': { 'media_type': 'application/json' }})
