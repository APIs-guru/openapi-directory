...
class DeleteVolumeHeaders:
    x_amz_target: DeleteVolumeXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteVolumeRequest:
    headers: DeleteVolumeHeaders = field()
    request: shared.DeleteVolumeRequest = field(metadata={'request': { 'media_type': 'application/json' }})
