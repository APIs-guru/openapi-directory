...
class DescribeFileSystemsHeaders:
    x_amz_target: DescribeFileSystemsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeFileSystemsRequest:
    ...
    request: shared.DescribeFileSystemsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
