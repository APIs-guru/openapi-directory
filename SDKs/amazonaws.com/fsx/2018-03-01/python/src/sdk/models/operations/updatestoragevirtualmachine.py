...
class UpdateStorageVirtualMachineHeaders:
    ...
    x_amz_target: UpdateStorageVirtualMachineXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateStorageVirtualMachineRequest:
    headers: UpdateStorageVirtualMachineHeaders = field(default=None)
    request: shared.UpdateStorageVirtualMachineRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
