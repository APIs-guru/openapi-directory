...
class DescribeStorageVirtualMachinesHeaders:
    x_amz_target: DescribeStorageVirtualMachinesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeStorageVirtualMachinesRequest:
    headers: DescribeStorageVirtualMachinesHeaders = field()
    query_params: DescribeStorageVirtualMachinesQueryParams = field()
    request: shared.DescribeStorageVirtualMachinesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
