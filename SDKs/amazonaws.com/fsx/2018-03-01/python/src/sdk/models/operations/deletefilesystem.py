...
class DeleteFileSystemHeaders:
    x_amz_target: DeleteFileSystemXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteFileSystemRequest:
    ...
    request: shared.DeleteFileSystemRequest = field(metadata={'request': { 'media_type': 'application/json' }})
