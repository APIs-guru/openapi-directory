...
class AssociateFileSystemAliasesHeaders:
    x_amz_target: AssociateFileSystemAliasesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AssociateFileSystemAliasesRequest:
    headers: AssociateFileSystemAliasesHeaders = field()
    request: shared.AssociateFileSystemAliasesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
