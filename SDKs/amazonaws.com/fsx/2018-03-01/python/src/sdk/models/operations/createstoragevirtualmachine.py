...
class CreateStorageVirtualMachineHeaders:
    x_amz_target: CreateStorageVirtualMachineXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateStorageVirtualMachineRequest:
    headers: CreateStorageVirtualMachineHeaders = field()
    request: shared.CreateStorageVirtualMachineRequest = field(metadata={'request': { 'media_type': 'application/json' }})
