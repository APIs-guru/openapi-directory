...
class CreateLagHeaders:
    x_amz_target: CreateLagXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateLagRequest:
    headers: CreateLagHeaders = field()
    request: shared.CreateLagRequest = field(metadata={'request': { 'media_type': 'application/json' }})
