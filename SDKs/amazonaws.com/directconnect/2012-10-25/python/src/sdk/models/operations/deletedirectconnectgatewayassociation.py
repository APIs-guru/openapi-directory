...
class DeleteDirectConnectGatewayAssociationHeaders:
    x_amz_target: DeleteDirectConnectGatewayAssociationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteDirectConnectGatewayAssociationRequest:
    headers: DeleteDirectConnectGatewayAssociationHeaders = field()
    request: shared.DeleteDirectConnectGatewayAssociationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
