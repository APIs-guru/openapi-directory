...
class AssociateMacSecKeyHeaders:
    x_amz_target: AssociateMacSecKeyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AssociateMacSecKeyRequest:
    headers: AssociateMacSecKeyHeaders = field()
    request: shared.AssociateMacSecKeyRequest = field(metadata={'request': { 'media_type': 'application/json' }})
