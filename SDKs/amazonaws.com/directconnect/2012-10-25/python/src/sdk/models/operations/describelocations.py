...
class DescribeLocationsHeaders:
    x_amz_target: DescribeLocationsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeLocationsRequest:
    headers: DescribeLocationsHeaders = field()
