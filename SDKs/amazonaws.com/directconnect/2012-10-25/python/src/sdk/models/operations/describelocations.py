...
class DescribeLocationsHeaders:
    ...
    x_amz_target: DescribeLocationsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeLocationsRequest:
    headers: DescribeLocationsHeaders = field(default=None)
