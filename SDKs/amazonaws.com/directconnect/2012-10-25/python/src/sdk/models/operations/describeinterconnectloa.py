...
class DescribeInterconnectLoaHeaders:
    x_amz_target: DescribeInterconnectLoaXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeInterconnectLoaRequest:
    headers: DescribeInterconnectLoaHeaders = field()
    request: shared.DescribeInterconnectLoaRequest = field(metadata={'request': { 'media_type': 'application/json' }})
