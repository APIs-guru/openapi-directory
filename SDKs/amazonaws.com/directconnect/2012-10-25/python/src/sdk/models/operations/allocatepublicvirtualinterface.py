...
class AllocatePublicVirtualInterfaceHeaders:
    ...
    x_amz_target: AllocatePublicVirtualInterfaceXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class AllocatePublicVirtualInterfaceRequest:
    headers: AllocatePublicVirtualInterfaceHeaders = field(default=None)
    request: shared.AllocatePublicVirtualInterfaceRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
