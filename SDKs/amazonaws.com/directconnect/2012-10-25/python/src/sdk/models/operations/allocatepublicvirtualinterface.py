...
class AllocatePublicVirtualInterfaceHeaders:
    x_amz_target: AllocatePublicVirtualInterfaceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AllocatePublicVirtualInterfaceRequest:
    headers: AllocatePublicVirtualInterfaceHeaders = field()
    request: shared.AllocatePublicVirtualInterfaceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
