...
class DeleteVirtualInterfaceHeaders:
    x_amz_target: DeleteVirtualInterfaceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteVirtualInterfaceRequest:
    headers: DeleteVirtualInterfaceHeaders = field()
    request: shared.DeleteVirtualInterfaceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
