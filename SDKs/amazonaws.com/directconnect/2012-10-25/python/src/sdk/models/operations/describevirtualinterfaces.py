...
class DescribeVirtualInterfacesHeaders:
    x_amz_target: DescribeVirtualInterfacesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeVirtualInterfacesRequest:
    headers: DescribeVirtualInterfacesHeaders = field()
    request: shared.DescribeVirtualInterfacesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
