...
class AcceptDirectConnectGatewayAssociationProposalHeaders:
    x_amz_target: AcceptDirectConnectGatewayAssociationProposalXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AcceptDirectConnectGatewayAssociationProposalRequest:
    headers: AcceptDirectConnectGatewayAssociationProposalHeaders = field()
    request: shared.AcceptDirectConnectGatewayAssociationProposalRequest = field(metadata={'request': { 'media_type': 'application/json' }})
