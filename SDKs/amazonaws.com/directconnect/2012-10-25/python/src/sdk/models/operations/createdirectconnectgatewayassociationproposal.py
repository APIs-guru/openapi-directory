...
class CreateDirectConnectGatewayAssociationProposalHeaders:
    ...
    x_amz_target: CreateDirectConnectGatewayAssociationProposalXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateDirectConnectGatewayAssociationProposalRequest:
    headers: CreateDirectConnectGatewayAssociationProposalHeaders = field(default=None)
    request: shared.CreateDirectConnectGatewayAssociationProposalRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
