...
class DescribeDirectConnectGatewayAttachmentsHeaders:
    x_amz_target: DescribeDirectConnectGatewayAttachmentsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeDirectConnectGatewayAttachmentsRequest:
    headers: DescribeDirectConnectGatewayAttachmentsHeaders = field()
    request: shared.DescribeDirectConnectGatewayAttachmentsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
