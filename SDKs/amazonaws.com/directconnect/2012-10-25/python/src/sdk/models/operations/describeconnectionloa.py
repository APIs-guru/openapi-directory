...
class DescribeConnectionLoaHeaders:
    x_amz_target: DescribeConnectionLoaXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeConnectionLoaRequest:
    headers: DescribeConnectionLoaHeaders = field()
    request: shared.DescribeConnectionLoaRequest = field(metadata={'request': { 'media_type': 'application/json' }})
