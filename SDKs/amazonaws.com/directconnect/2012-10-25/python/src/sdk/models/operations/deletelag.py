...
class DeleteLagHeaders:
    x_amz_target: DeleteLagXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteLagRequest:
    headers: DeleteLagHeaders = field()
    request: shared.DeleteLagRequest = field(metadata={'request': { 'media_type': 'application/json' }})
