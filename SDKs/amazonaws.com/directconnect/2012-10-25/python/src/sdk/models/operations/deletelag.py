...
class DeleteLagHeaders:
    ...
    x_amz_target: DeleteLagXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeleteLagRequest:
    headers: DeleteLagHeaders = field(default=None)
    request: shared.DeleteLagRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
