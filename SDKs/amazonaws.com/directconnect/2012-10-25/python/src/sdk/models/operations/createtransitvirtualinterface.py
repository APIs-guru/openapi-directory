...
class CreateTransitVirtualInterfaceHeaders:
    x_amz_target: CreateTransitVirtualInterfaceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateTransitVirtualInterfaceRequest:
    headers: CreateTransitVirtualInterfaceHeaders = field()
    request: shared.CreateTransitVirtualInterfaceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
