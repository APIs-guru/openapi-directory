...
class CreateTransitVirtualInterfaceHeaders:
    ...
    x_amz_target: CreateTransitVirtualInterfaceXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateTransitVirtualInterfaceRequest:
    headers: CreateTransitVirtualInterfaceHeaders = field(default=None)
    request: shared.CreateTransitVirtualInterfaceRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class CreateTransitVirtualInterfaceResponse:
    content_type: str = field(default=None)
    create_transit_virtual_interface_result: Optional[shared.CreateTransitVirtualInterfaceResult] = field(default=None)
