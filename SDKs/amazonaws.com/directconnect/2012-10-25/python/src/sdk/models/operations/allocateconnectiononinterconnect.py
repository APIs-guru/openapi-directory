...
class AllocateConnectionOnInterconnectHeaders:
    ...
    x_amz_target: AllocateConnectionOnInterconnectXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class AllocateConnectionOnInterconnectRequest:
    headers: AllocateConnectionOnInterconnectHeaders = field(default=None)
    request: shared.AllocateConnectionOnInterconnectRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
