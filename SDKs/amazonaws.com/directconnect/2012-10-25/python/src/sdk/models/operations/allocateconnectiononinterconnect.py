...
class AllocateConnectionOnInterconnectHeaders:
    x_amz_target: AllocateConnectionOnInterconnectXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AllocateConnectionOnInterconnectRequest:
    headers: AllocateConnectionOnInterconnectHeaders = field()
    request: shared.AllocateConnectionOnInterconnectRequest = field(metadata={'request': { 'media_type': 'application/json' }})
