...
class CreatePublicVirtualInterfaceHeaders:
    ...
    x_amz_target: CreatePublicVirtualInterfaceXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreatePublicVirtualInterfaceRequest:
    headers: CreatePublicVirtualInterfaceHeaders = field(default=None)
    request: shared.CreatePublicVirtualInterfaceRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
