...
class CreatePublicVirtualInterfaceHeaders:
    x_amz_target: CreatePublicVirtualInterfaceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreatePublicVirtualInterfaceRequest:
    headers: CreatePublicVirtualInterfaceHeaders = field()
    request: shared.CreatePublicVirtualInterfaceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
