...
class ConfirmTransitVirtualInterfaceHeaders:
    x_amz_target: ConfirmTransitVirtualInterfaceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ConfirmTransitVirtualInterfaceRequest:
    headers: ConfirmTransitVirtualInterfaceHeaders = field()
    request: shared.ConfirmTransitVirtualInterfaceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
