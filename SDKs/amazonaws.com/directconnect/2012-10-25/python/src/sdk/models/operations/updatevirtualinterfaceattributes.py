...
class UpdateVirtualInterfaceAttributesHeaders:
    x_amz_target: UpdateVirtualInterfaceAttributesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateVirtualInterfaceAttributesRequest:
    headers: UpdateVirtualInterfaceAttributesHeaders = field()
    request: shared.UpdateVirtualInterfaceAttributesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
