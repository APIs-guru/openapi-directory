...
class DeleteDirectConnectGatewayAssociationProposalHeaders:
    x_amz_target: DeleteDirectConnectGatewayAssociationProposalXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteDirectConnectGatewayAssociationProposalRequest:
    headers: DeleteDirectConnectGatewayAssociationProposalHeaders = field()
    request: shared.DeleteDirectConnectGatewayAssociationProposalRequest = field(metadata={'request': { 'media_type': 'application/json' }})
