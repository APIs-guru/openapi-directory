...
class DeleteDirectConnectGatewayAssociationProposalHeaders:
    ...
    x_amz_target: DeleteDirectConnectGatewayAssociationProposalXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
