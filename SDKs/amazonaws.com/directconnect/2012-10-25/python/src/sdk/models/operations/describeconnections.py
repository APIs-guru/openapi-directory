...
class DescribeConnectionsHeaders:
    ...
    x_amz_target: DescribeConnectionsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
    

@dataclass
class DescribeConnectionsRequest:
    headers: DescribeConnectionsHeaders = field(default=None)
    request: shared.DescribeConnectionsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class DescribeConnectionsResponse:
    connections: Optional[shared.Connections] = field(default=None)
