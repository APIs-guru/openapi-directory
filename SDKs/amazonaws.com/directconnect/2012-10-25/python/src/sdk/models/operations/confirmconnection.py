...
class ConfirmConnectionHeaders:
    x_amz_target: ConfirmConnectionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ConfirmConnectionRequest:
    headers: ConfirmConnectionHeaders = field()
    request: shared.ConfirmConnectionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
