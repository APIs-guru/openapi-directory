...
class DescribeDirectConnectGatewayAssociationProposalsHeaders:
    x_amz_target: DescribeDirectConnectGatewayAssociationProposalsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeDirectConnectGatewayAssociationProposalsRequest:
    headers: DescribeDirectConnectGatewayAssociationProposalsHeaders = field()
    request: shared.DescribeDirectConnectGatewayAssociationProposalsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
