...
class AssociateVirtualInterfaceHeaders:
    ...
    x_amz_target: AssociateVirtualInterfaceXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class AssociateVirtualInterfaceRequest:
    headers: AssociateVirtualInterfaceHeaders = field(default=None)
    request: shared.AssociateVirtualInterfaceRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
