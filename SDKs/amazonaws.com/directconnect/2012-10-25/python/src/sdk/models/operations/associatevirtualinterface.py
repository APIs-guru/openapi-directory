...
class AssociateVirtualInterfaceHeaders:
    x_amz_target: AssociateVirtualInterfaceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AssociateVirtualInterfaceRequest:
    headers: AssociateVirtualInterfaceHeaders = field()
    request: shared.AssociateVirtualInterfaceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
