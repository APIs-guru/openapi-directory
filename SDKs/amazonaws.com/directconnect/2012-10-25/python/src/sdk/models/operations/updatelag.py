...
class UpdateLagHeaders:
    x_amz_target: UpdateLagXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateLagRequest:
    headers: UpdateLagHeaders = field()
    request: shared.UpdateLagRequest = field(metadata={'request': { 'media_type': 'application/json' }})
