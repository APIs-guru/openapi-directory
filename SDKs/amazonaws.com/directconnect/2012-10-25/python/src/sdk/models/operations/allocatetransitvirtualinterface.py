...
class AllocateTransitVirtualInterfaceHeaders:
    x_amz_target: AllocateTransitVirtualInterfaceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AllocateTransitVirtualInterfaceRequest:
    headers: AllocateTransitVirtualInterfaceHeaders = field()
    request: shared.AllocateTransitVirtualInterfaceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
