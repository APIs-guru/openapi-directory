...
class AllocateTransitVirtualInterfaceHeaders:
    ...
    x_amz_target: AllocateTransitVirtualInterfaceXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class AllocateTransitVirtualInterfaceRequest:
    headers: AllocateTransitVirtualInterfaceHeaders = field(default=None)
    request: shared.AllocateTransitVirtualInterfaceRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class AllocateTransitVirtualInterfaceResponse:
    allocate_transit_virtual_interface_result: Optional[shared.AllocateTransitVirtualInterfaceResult] = field(default=None)
