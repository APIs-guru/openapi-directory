...
class DescribeHostedConnectionsHeaders:
    x_amz_target: DescribeHostedConnectionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeHostedConnectionsRequest:
    headers: DescribeHostedConnectionsHeaders = field()
    request: shared.DescribeHostedConnectionsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
