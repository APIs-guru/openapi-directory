...
class DescribeHostedConnectionsHeaders:
    ...
    x_amz_target: DescribeHostedConnectionsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeHostedConnectionsRequest:
    headers: DescribeHostedConnectionsHeaders = field(default=None)
    request: shared.DescribeHostedConnectionsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
