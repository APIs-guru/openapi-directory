...
class DescribeLagsHeaders:
    x_amz_target: DescribeLagsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeLagsRequest:
    headers: DescribeLagsHeaders = field()
    request: shared.DescribeLagsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
