...
class CreateDirectConnectGatewayHeaders:
    x_amz_target: CreateDirectConnectGatewayXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateDirectConnectGatewayRequest:
    headers: CreateDirectConnectGatewayHeaders = field()
    request: shared.CreateDirectConnectGatewayRequest = field(metadata={'request': { 'media_type': 'application/json' }})
