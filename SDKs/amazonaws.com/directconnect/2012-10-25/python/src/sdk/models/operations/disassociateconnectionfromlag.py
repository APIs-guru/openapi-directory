...
class DisassociateConnectionFromLagHeaders:
    ...
    x_amz_target: DisassociateConnectionFromLagXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DisassociateConnectionFromLagRequest:
    headers: DisassociateConnectionFromLagHeaders = field(default=None)
    request: shared.DisassociateConnectionFromLagRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
