...
class UntagResource20190326QueryParams:
    operation: UntagResource20190326OperationEnum = field(default=None, metadata={'query_param': { 'field_name': 'Operation', 'style': 'form', 'explode': True }})
...
class UntagResource20190326Request:
    query_params: UntagResource20190326QueryParams = field(default=None)
    headers: UntagResource20190326Headers = field(default=None)
