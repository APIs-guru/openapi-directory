...
class ListDistributionsByWebACLId20190326Request:
    headers: ListDistributionsByWebACLId20190326Headers = field()
    path_params: ListDistributionsByWebACLId20190326PathParams = field()
    query_params: ListDistributionsByWebACLId20190326QueryParams = field()
