...
class TagResource20170325QueryParams:
    operation: TagResource20170325OperationEnum = field(metadata={'query_param': { 'field_name': 'Operation', 'style': 'form', 'explode': True }})
...
class TagResource20170325Request:
    headers: TagResource20170325Headers = field()
    query_params: TagResource20170325QueryParams = field()
