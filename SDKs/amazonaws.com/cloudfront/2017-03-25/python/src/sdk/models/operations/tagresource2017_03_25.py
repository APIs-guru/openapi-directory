...
class TagResource20170325QueryParams:
    operation: TagResource20170325OperationEnum = field(default=None, metadata={'query_param': { 'field_name': 'Operation', 'style': 'form', 'explode': True }})
...
class TagResource20170325Request:
    query_params: TagResource20170325QueryParams = field(default=None)
    headers: TagResource20170325Headers = field(default=None)
