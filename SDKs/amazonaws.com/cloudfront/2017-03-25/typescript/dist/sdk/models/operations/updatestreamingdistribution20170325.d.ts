...
export declare class UpdateStreamingDistribution20170325PathParams extends SpeakeasyBase {
    id: string;
}
export declare class UpdateStreamingDistribution20170325Headers extends SpeakeasyBase {
    ifMatch?: string;
