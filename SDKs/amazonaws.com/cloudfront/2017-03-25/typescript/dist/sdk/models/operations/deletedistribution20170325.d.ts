...
export declare class DeleteDistribution20170325PathParams extends SpeakeasyBase {
    id: string;
}
export declare class DeleteDistribution20170325Headers extends SpeakeasyBase {
    ifMatch?: string;
