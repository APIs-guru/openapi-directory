...
export declare class DeleteCloudFrontOriginAccessIdentity20161125PathParams extends SpeakeasyBase {
    id: string;
}
export declare class DeleteCloudFrontOriginAccessIdentity20161125Headers extends SpeakeasyBase {
    ifMatch?: string;
