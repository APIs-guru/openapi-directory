...
class CreateStreamingDistributionWithTags20161125Request:
    query_params: CreateStreamingDistributionWithTags20161125QueryParams = field(default=None)
    headers: CreateStreamingDistributionWithTags20161125Headers = field(default=None)
