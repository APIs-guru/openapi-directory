...
class GetCloudFrontOriginAccessIdentity20181105Request:
    path_params: GetCloudFrontOriginAccessIdentity20181105PathParams = field(default=None)
    headers: GetCloudFrontOriginAccessIdentity20181105Headers = field(default=None)
