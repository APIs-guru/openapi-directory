...
export declare class UpdateFieldLevelEncryptionConfig20181105PathParams extends SpeakeasyBase {
    id: string;
}
export declare class UpdateFieldLevelEncryptionConfig20181105Headers extends SpeakeasyBase {
    ifMatch?: string;
