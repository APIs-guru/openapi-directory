...
class UntagResource20200531QueryParams:
    operation: UntagResource20200531OperationEnum = field(default=None, metadata={'query_param': { 'field_name': 'Operation', 'style': 'form', 'explode': True }})
...
class UntagResource20200531Request:
    query_params: UntagResource20200531QueryParams = field(default=None)
    headers: UntagResource20200531Headers = field(default=None)
