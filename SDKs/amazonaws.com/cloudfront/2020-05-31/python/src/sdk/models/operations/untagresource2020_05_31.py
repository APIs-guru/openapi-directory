...
class UntagResource20200531QueryParams:
    operation: UntagResource20200531OperationEnum = field(metadata={'query_param': { 'field_name': 'Operation', 'style': 'form', 'explode': True }})
...
class UntagResource20200531Request:
    headers: UntagResource20200531Headers = field()
    query_params: UntagResource20200531QueryParams = field()
