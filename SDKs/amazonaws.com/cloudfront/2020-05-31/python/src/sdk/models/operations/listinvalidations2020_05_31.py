...
class ListInvalidations20200531Request:
    headers: ListInvalidations20200531Headers = field()
    path_params: ListInvalidations20200531PathParams = field()
    query_params: ListInvalidations20200531QueryParams = field()
