...
export declare class UpdateOriginRequestPolicy20200531PathParams extends SpeakeasyBase {
    id: string;
}
export declare class UpdateOriginRequestPolicy20200531Headers extends SpeakeasyBase {
    ifMatch?: string;
