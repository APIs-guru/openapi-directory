...
class DeleteFieldLevelEncryptionProfile20180618Request:
    path_params: DeleteFieldLevelEncryptionProfile20180618PathParams = field(default=None)
    headers: DeleteFieldLevelEncryptionProfile20180618Headers = field(default=None)
