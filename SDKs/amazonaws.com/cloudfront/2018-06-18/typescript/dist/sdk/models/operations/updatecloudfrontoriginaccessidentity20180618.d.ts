...
export declare class UpdateCloudFrontOriginAccessIdentity20180618PathParams extends SpeakeasyBase {
    id: string;
}
export declare class UpdateCloudFrontOriginAccessIdentity20180618Headers extends SpeakeasyBase {
    ifMatch?: string;
