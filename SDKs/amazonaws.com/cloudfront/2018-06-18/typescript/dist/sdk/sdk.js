...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.CreateCloudFrontOriginAccessIdentity20180618 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreateCloudFrontOriginAccessIdentity20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2018-06-18/origin-access-identity/cloudfront";
    ...
    SDK.prototype.CreateDistribution20180618 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreateDistribution20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2018-06-18/distribution";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.CreateDistributionWithTags20180618 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreateDistributionWithTags20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2018-06-18/distribution#WithTags";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.CreateFieldLevelEncryptionConfig20180618 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreateFieldLevelEncryptionConfig20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2018-06-18/field-level-encryption";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.CreateFieldLevelEncryptionProfile20180618 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreateFieldLevelEncryptionProfile20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2018-06-18/field-level-encryption-profile";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.CreateInvalidation20180618 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreateInvalidation20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/2018-06-18/distribution/{DistributionId}/invalidation", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.CreatePublicKey20180618 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreatePublicKey20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2018-06-18/public-key";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.CreateStreamingDistribution20180618 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreateStreamingDistribution20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2018-06-18/streaming-distribution";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.CreateStreamingDistributionWithTags20180618 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CreateStreamingDistributionWithTags20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2018-06-18/streaming-distribution#WithTags";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.DeleteCloudFrontOriginAccessIdentity20180618 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteCloudFrontOriginAccessIdentity20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/2018-06-18/origin-access-identity/cloudfront/{Id}", req.pathParams);
        var client = this.securityClient;
    ...
    SDK.prototype.DeleteDistribution20180618 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteDistribution20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/2018-06-18/distribution/{Id}", req.pathParams);
        var client = this.securityClient;
        var headers = __assign(__assign({}, GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .delete(url, __assign({}, config))
    ...
    SDK.prototype.DeleteFieldLevelEncryptionConfig20180618 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteFieldLevelEncryptionConfig20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/2018-06-18/field-level-encryption/{Id}", req.pathParams);
        var client = this.securityClient;
        var headers = __assign(__assign({}, GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .delete(url, __assign({}, config))
    ...
    SDK.prototype.DeleteFieldLevelEncryptionProfile20180618 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteFieldLevelEncryptionProfile20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/2018-06-18/field-level-encryption-profile/{Id}", req.pathParams);
        var client = this.securityClient;
        var headers = __assign(__assign({}, GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .delete(url, __assign({}, config))
    ...
    SDK.prototype.DeletePublicKey20180618 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeletePublicKey20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/2018-06-18/public-key/{Id}", req.pathParams);
        var client = this.securityClient;
        var headers = __assign(__assign({}, GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .delete(url, __assign({}, config))
    ...
    SDK.prototype.DeleteStreamingDistribution20180618 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteStreamingDistribution20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/2018-06-18/streaming-distribution/{Id}", req.pathParams);
        var client = this.securityClient;
        var headers = __assign(__assign({}, GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .delete(url, __assign({}, config))
    ...
    SDK.prototype.GetCloudFrontOriginAccessIdentity20180618 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetCloudFrontOriginAccessIdentity20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/2018-06-18/origin-access-identity/cloudfront/{Id}", req.pathParams);
        var client = this.securityClient;
    ...
    SDK.prototype.GetCloudFrontOriginAccessIdentityConfig20180618 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetCloudFrontOriginAccessIdentityConfig20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/2018-06-18/origin-access-identity/cloudfront/{Id}/config", req.pathParams);
        var client = this.securityClient;
        var headers = __assign(__assign({}, GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .get(url, __assign({}, config))
    ...
    SDK.prototype.GetDistribution20180618 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetDistribution20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/2018-06-18/distribution/{Id}", req.pathParams);
        var client = this.securityClient;
    ...
    SDK.prototype.GetDistributionConfig20180618 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetDistributionConfig20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/2018-06-18/distribution/{Id}/config", req.pathParams);
        var client = this.securityClient;
        var headers = __assign(__assign({}, GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .get(url, __assign({}, config))
    ...
    SDK.prototype.GetFieldLevelEncryption20180618 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetFieldLevelEncryption20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/2018-06-18/field-level-encryption/{Id}", req.pathParams);
        var client = this.securityClient;
    ...
    SDK.prototype.GetFieldLevelEncryptionConfig20180618 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetFieldLevelEncryptionConfig20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/2018-06-18/field-level-encryption/{Id}/config", req.pathParams);
        var client = this.securityClient;
        var headers = __assign(__assign({}, GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .get(url, __assign({}, config))
    ...
    SDK.prototype.GetFieldLevelEncryptionProfile20180618 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetFieldLevelEncryptionProfile20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/2018-06-18/field-level-encryption-profile/{Id}", req.pathParams);
        var client = this.securityClient;
    ...
    SDK.prototype.GetFieldLevelEncryptionProfileConfig20180618 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetFieldLevelEncryptionProfileConfig20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/2018-06-18/field-level-encryption-profile/{Id}/config", req.pathParams);
        var client = this.securityClient;
        var headers = __assign(__assign({}, GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .get(url, __assign({}, config))
    ...
    SDK.prototype.GetInvalidation20180618 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetInvalidation20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/2018-06-18/distribution/{DistributionId}/invalidation/{Id}", req.pathParams);
        var client = this.securityClient;
        var headers = __assign(__assign({}, GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .get(url, __assign({}, config))
    ...
    SDK.prototype.GetPublicKey20180618 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetPublicKey20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/2018-06-18/public-key/{Id}", req.pathParams);
        var client = this.securityClient;
    ...
    SDK.prototype.GetPublicKeyConfig20180618 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetPublicKeyConfig20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/2018-06-18/public-key/{Id}/config", req.pathParams);
        var client = this.securityClient;
        var headers = __assign(__assign({}, GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .get(url, __assign({}, config))
    ...
    SDK.prototype.GetStreamingDistribution20180618 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetStreamingDistribution20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/2018-06-18/streaming-distribution/{Id}", req.pathParams);
        var client = this.securityClient;
    ...
    SDK.prototype.GetStreamingDistributionConfig20180618 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetStreamingDistributionConfig20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/2018-06-18/streaming-distribution/{Id}/config", req.pathParams);
        var client = this.securityClient;
        var headers = __assign(__assign({}, GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .get(url, __assign({}, config))
    ...
    SDK.prototype.ListCloudFrontOriginAccessIdentities20180618 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ListCloudFrontOriginAccessIdentities20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2018-06-18/origin-access-identity/cloudfront";
        var client = this.securityClient;
    ...
    SDK.prototype.ListDistributions20180618 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ListDistributions20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2018-06-18/distribution";
        var client = this.securityClient;
    ...
    SDK.prototype.ListDistributionsByWebAclId20180618 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ListDistributionsByWebAclId20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/2018-06-18/distributionsByWebACLId/{WebACLId}", req.pathParams);
        var client = this.securityClient;
        var headers = __assign(__assign({}, GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
    ...
    SDK.prototype.ListFieldLevelEncryptionConfigs20180618 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ListFieldLevelEncryptionConfigs20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2018-06-18/field-level-encryption";
        var client = this.securityClient;
    ...
    SDK.prototype.ListFieldLevelEncryptionProfiles20180618 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ListFieldLevelEncryptionProfiles20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2018-06-18/field-level-encryption-profile";
        var client = this.securityClient;
    ...
    SDK.prototype.ListInvalidations20180618 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ListInvalidations20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/2018-06-18/distribution/{DistributionId}/invalidation", req.pathParams);
        var client = this.securityClient;
    ...
    SDK.prototype.ListPublicKeys20180618 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ListPublicKeys20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2018-06-18/public-key";
        var client = this.securityClient;
    ...
    SDK.prototype.ListStreamingDistributions20180618 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ListStreamingDistributions20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2018-06-18/streaming-distribution";
        var client = this.securityClient;
    ...
    SDK.prototype.ListTagsForResource20180618 = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ListTagsForResource20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2018-06-18/tagging#Resource";
        var client = this.securityClient;
        var headers = __assign(__assign({}, GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
    ...
    SDK.prototype.TagResource20180618 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.TagResource20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2018-06-18/tagging#Operation=Tag&Resource";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.UntagResource20180618 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.UntagResource20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/2018-06-18/tagging#Operation=Untag&Resource";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.UpdateCloudFrontOriginAccessIdentity20180618 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.UpdateCloudFrontOriginAccessIdentity20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/2018-06-18/origin-access-identity/cloudfront/{Id}/config", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
    ...
    SDK.prototype.UpdateDistribution20180618 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.UpdateDistribution20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/2018-06-18/distribution/{Id}/config", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
    ...
    SDK.prototype.UpdateFieldLevelEncryptionConfig20180618 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.UpdateFieldLevelEncryptionConfig20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/2018-06-18/field-level-encryption/{Id}/config", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
    ...
    SDK.prototype.UpdateFieldLevelEncryptionProfile20180618 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.UpdateFieldLevelEncryptionProfile20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/2018-06-18/field-level-encryption-profile/{Id}/config", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
    ...
    SDK.prototype.UpdatePublicKey20180618 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.UpdatePublicKey20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/2018-06-18/public-key/{Id}/config", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
    ...
    SDK.prototype.UpdateStreamingDistribution20180618 = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.UpdateStreamingDistribution20180618Request(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/2018-06-18/streaming-distribution/{Id}/config", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
