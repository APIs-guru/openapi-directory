...
**/
var BatchWriteItemOutput = /** @class */ (function (_super) {
    __extends(BatchWriteItemOutput, _super);
    ...
    ], BatchWriteItemOutput.prototype, "responses", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=UnprocessedItems", elemType: WriteRequest, elemDepth: 2 }),
        __metadata("design:type", Map)
    ], BatchWriteItemOutput.prototype, "unprocessedItems", void 0);
    return BatchWriteItemOutput;
}(SpeakeasyBase));
export { BatchWriteItemOutput };
