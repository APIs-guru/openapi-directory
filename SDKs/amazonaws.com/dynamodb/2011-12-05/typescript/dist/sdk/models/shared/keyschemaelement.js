...
**/
var KeySchemaElement = /** @class */ (function (_super) {
    __extends(KeySchemaElement, _super);
    ...
    ], KeySchemaElement.prototype, "attributeName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=AttributeType" }),
        __metadata("design:type", String)
    ], KeySchemaElement.prototype, "attributeType", void 0);
    return KeySchemaElement;
}(SpeakeasyBase));
export { KeySchemaElement };
