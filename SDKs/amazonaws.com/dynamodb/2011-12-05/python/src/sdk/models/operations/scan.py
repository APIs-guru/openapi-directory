...
@dataclass
class ScanHeaders:
    x_amz_target: ScanXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
@dataclass
class ScanRequest:
    headers: ScanHeaders = field()
    query_params: ScanQueryParams = field()
    request: shared.ScanInput = field(metadata={'request': { 'media_type': 'application/json' }})
