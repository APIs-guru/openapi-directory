...
class DeleteItemHeaders:
    ...
    x_amz_target: DeleteItemXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeleteItemRequest:
    headers: DeleteItemHeaders = field(default=None)
    request: shared.DeleteItemInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
