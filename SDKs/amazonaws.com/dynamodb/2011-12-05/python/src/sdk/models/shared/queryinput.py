...
@dataclass
class QueryInput:
    hash_key_value: AttributeValue = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('HashKeyValue') }})
    ...
    range_key_condition: Optional[Condition] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('RangeKeyCondition') }})
