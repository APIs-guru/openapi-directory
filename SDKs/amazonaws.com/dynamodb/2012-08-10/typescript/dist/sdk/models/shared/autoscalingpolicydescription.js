...
var AutoScalingPolicyDescription = /** @class */ (function (_super) {
    ...
    ], AutoScalingPolicyDescription.prototype, "policyName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=TargetTrackingScalingPolicyConfiguration" }),
        __metadata("design:type", AutoScalingTargetTrackingScalingPolicyConfigurationDescription)
    ], AutoScalingPolicyDescription.prototype, "targetTrackingScalingPolicyConfiguration", void 0);
