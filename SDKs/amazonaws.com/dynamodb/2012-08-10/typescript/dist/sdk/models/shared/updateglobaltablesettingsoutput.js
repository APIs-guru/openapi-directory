...
var UpdateGlobalTableSettingsOutput = /** @class */ (function (_super) {
    __extends(UpdateGlobalTableSettingsOutput, _super);
    ...
    ], UpdateGlobalTableSettingsOutput.prototype, "globalTableName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ReplicaSettings", elemType: ReplicaSettingsDescription }),
        __metadata("design:type", Array)
    ], UpdateGlobalTableSettingsOutput.prototype, "replicaSettings", void 0);
    return UpdateGlobalTableSettingsOutput;
}(SpeakeasyBase));
export { UpdateGlobalTableSettingsOutput };
