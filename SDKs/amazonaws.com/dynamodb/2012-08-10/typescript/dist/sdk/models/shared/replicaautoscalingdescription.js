...
**/
var ReplicaAutoScalingDescription = /** @class */ (function (_super) {
    __extends(ReplicaAutoScalingDescription, _super);
    ...
    ], ReplicaAutoScalingDescription.prototype, "globalSecondaryIndexes", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=RegionName" }),
        __metadata("design:type", String)
    ], ReplicaAutoScalingDescription.prototype, "regionName", void 0);
    __decorate([
    ...
    ], ReplicaAutoScalingDescription.prototype, "replicaProvisionedReadCapacityAutoScalingSettings", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ReplicaProvisionedWriteCapacityAutoScalingSettings" }),
        __metadata("design:type", AutoScalingSettingsDescription)
    ], ReplicaAutoScalingDescription.prototype, "replicaProvisionedWriteCapacityAutoScalingSettings", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ReplicaStatus" }),
        __metadata("design:type", String)
    ], ReplicaAutoScalingDescription.prototype, "replicaStatus", void 0);
    return ReplicaAutoScalingDescription;
}(SpeakeasyBase));
export { ReplicaAutoScalingDescription };
