...
var TransactWriteItemsOutput = /** @class */ (function (_super) {
    __extends(TransactWriteItemsOutput, _super);
    ...
    ], TransactWriteItemsOutput.prototype, "consumedCapacity", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ItemCollectionMetrics", elemType: ItemCollectionMetrics, elemDepth: 2 }),
        __metadata("design:type", Map)
    ], TransactWriteItemsOutput.prototype, "itemCollectionMetrics", void 0);
    return TransactWriteItemsOutput;
}(SpeakeasyBase));
export { TransactWriteItemsOutput };
