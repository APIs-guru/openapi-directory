...
**/
var ReplicaSettingsUpdate = /** @class */ (function (_super) {
    __extends(ReplicaSettingsUpdate, _super);
    ...
    ], ReplicaSettingsUpdate.prototype, "regionName", void 0);
    __decorate([
    ...
    ], ReplicaSettingsUpdate.prototype, "replicaGlobalSecondaryIndexSettingsUpdate", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ReplicaProvisionedReadCapacityAutoScalingSettingsUpdate" }),
        __metadata("design:type", AutoScalingSettingsUpdate)
    ], ReplicaSettingsUpdate.prototype, "replicaProvisionedReadCapacityAutoScalingSettingsUpdate", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ReplicaProvisionedReadCapacityUnits" }),
        __metadata("design:type", Number)
    ], ReplicaSettingsUpdate.prototype, "replicaProvisionedReadCapacityUnits", void 0);
    return ReplicaSettingsUpdate;
}(SpeakeasyBase));
export { ReplicaSettingsUpdate };
