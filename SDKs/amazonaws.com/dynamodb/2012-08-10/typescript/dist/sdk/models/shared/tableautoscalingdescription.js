...
**/
var TableAutoScalingDescription = /** @class */ (function (_super) {
    __extends(TableAutoScalingDescription, _super);
    ...
    ], TableAutoScalingDescription.prototype, "replicas", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=TableName" }),
        __metadata("design:type", String)
    ], TableAutoScalingDescription.prototype, "tableName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=TableStatus" }),
        __metadata("design:type", String)
    ], TableAutoScalingDescription.prototype, "tableStatus", void 0);
    return TableAutoScalingDescription;
}(SpeakeasyBase));
export { TableAutoScalingDescription };
