...
var ScanInput = /** @class */ (function (_super) {
    ...
    ], ScanInput.prototype, "conditionalOperator", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ConsistentRead" }),
        __metadata("design:type", Boolean)
    ], ScanInput.prototype, "consistentRead", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", Map)
    ], ScanInput.prototype, "expressionAttributeNames", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ExpressionAttributeValues", elemType: AttributeValue }),
        __metadata("design:type", Map)
    ], ScanInput.prototype, "expressionAttributeValues", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=FilterExpression" }),
        __metadata("design:type", String)
    ], ScanInput.prototype, "filterExpression", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=IndexName" }),
        __metadata("design:type", String)
    ], ScanInput.prototype, "indexName", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ScanInput.prototype, "projectionExpression", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ReturnConsumedCapacity" }),
        __metadata("design:type", String)
    ], ScanInput.prototype, "returnConsumedCapacity", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", Number)
    ], ScanInput.prototype, "segment", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Select" }),
        __metadata("design:type", String)
    ], ScanInput.prototype, "select", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", Number)
    ], ScanInput.prototype, "totalSegments", void 0);
    return ScanInput;
}(SpeakeasyBase));
export { ScanInput };
