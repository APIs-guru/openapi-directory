...
class BatchWriteItemXAmzTargetEnum(str, Enum):
    DYNAMO_DB_20120810_BATCH_WRITE_ITEM = "DynamoDB_20120810.BatchWriteItem"


@dataclass
class BatchWriteItemHeaders:
    x_amz_target: BatchWriteItemXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class BatchWriteItemRequest:
    headers: BatchWriteItemHeaders = field()
    request: shared.BatchWriteItemInput = field(metadata={'request': { 'media_type': 'application/json' }})
