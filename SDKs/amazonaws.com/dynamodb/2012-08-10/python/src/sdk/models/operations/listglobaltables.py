...
class ListGlobalTablesHeaders:
    x_amz_target: ListGlobalTablesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListGlobalTablesRequest:
    headers: ListGlobalTablesHeaders = field()
    request: shared.ListGlobalTablesInput = field(metadata={'request': { 'media_type': 'application/json' }})
