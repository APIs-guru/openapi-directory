...
class CreateBackupHeaders:
    ...
    x_amz_target: CreateBackupXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
    

@dataclass
class CreateBackupRequest:
    headers: CreateBackupHeaders = field(default=None)
    request: shared.CreateBackupInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
