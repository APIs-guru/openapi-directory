...
class CreateGlobalTableHeaders:
    x_amz_target: CreateGlobalTableXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateGlobalTableRequest:
    headers: CreateGlobalTableHeaders = field()
    request: shared.CreateGlobalTableInput = field(metadata={'request': { 'media_type': 'application/json' }})
