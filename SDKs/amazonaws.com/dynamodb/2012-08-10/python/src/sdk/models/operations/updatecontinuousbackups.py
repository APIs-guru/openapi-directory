...
class UpdateContinuousBackupsHeaders:
    x_amz_target: UpdateContinuousBackupsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateContinuousBackupsRequest:
    headers: UpdateContinuousBackupsHeaders = field()
    request: shared.UpdateContinuousBackupsInput = field(metadata={'request': { 'media_type': 'application/json' }})
