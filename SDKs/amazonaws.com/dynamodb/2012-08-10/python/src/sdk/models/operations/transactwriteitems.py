...
class TransactWriteItemsHeaders:
    x_amz_target: TransactWriteItemsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class TransactWriteItemsRequest:
    headers: TransactWriteItemsHeaders = field()
    request: shared.TransactWriteItemsInput = field(metadata={'request': { 'media_type': 'application/json' }})
