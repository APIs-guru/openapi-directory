...
class BatchGetItemHeaders:
    ...
    x_amz_target: BatchGetItemXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class BatchGetItemRequest:
    query_params: BatchGetItemQueryParams = field(default=None)
    headers: BatchGetItemHeaders = field(default=None)
    request: shared.BatchGetItemInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
