...
class ExecuteTransactionHeaders:
    x_amz_target: ExecuteTransactionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ExecuteTransactionRequest:
    headers: ExecuteTransactionHeaders = field()
    request: shared.ExecuteTransactionInput = field(metadata={'request': { 'media_type': 'application/json' }})
