...
class DescribeContributorInsightsHeaders:
    x_amz_target: DescribeContributorInsightsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeContributorInsightsRequest:
    headers: DescribeContributorInsightsHeaders = field()
    request: shared.DescribeContributorInsightsInput = field(metadata={'request': { 'media_type': 'application/json' }})
