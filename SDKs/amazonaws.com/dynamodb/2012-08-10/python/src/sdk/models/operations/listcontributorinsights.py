...
class ListContributorInsightsHeaders:
    x_amz_target: ListContributorInsightsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListContributorInsightsRequest:
    headers: ListContributorInsightsHeaders = field()
    query_params: ListContributorInsightsQueryParams = field()
    request: shared.ListContributorInsightsInput = field(metadata={'request': { 'media_type': 'application/json' }})
