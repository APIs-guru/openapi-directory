...
class GlobalTableGlobalSecondaryIndexSettingsUpdate:
    ...
    provisioned_write_capacity_auto_scaling_settings_update: Optional[AutoScalingSettingsUpdate] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ProvisionedWriteCapacityAutoScalingSettingsUpdate') }})
