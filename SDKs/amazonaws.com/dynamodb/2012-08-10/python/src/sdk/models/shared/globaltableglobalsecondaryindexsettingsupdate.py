...
class GlobalTableGlobalSecondaryIndexSettingsUpdate:
    ...
    provisioned_write_capacity_auto_scaling_settings_update: Optional[autoscalingsettingsupdate.AutoScalingSettingsUpdate] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ProvisionedWriteCapacityAutoScalingSettingsUpdate' }})
