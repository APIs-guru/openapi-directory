...
from . import attributevalueupdate
...
class UpdateItemInput:
    attribute_updates: Optional[dict[str, attributevalueupdate.AttributeValueUpdate]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'AttributeUpdates' }})
    ...
    update_expression: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'UpdateExpression' }})
