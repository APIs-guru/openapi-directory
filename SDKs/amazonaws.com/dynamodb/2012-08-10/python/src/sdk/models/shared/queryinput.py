...
class QueryInput:
    ...
    key_condition_expression: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('KeyConditionExpression') }})
    key_conditions: Optional[dict[str, Condition]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('KeyConditions') }})
    ...
    query_filter: Optional[dict[str, Condition]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('QueryFilter') }})
    ...
    scan_index_forward: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ScanIndexForward') }})
