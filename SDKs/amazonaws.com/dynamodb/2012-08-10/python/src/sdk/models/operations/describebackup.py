...
class DescribeBackupHeaders:
    x_amz_target: DescribeBackupXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeBackupRequest:
    headers: DescribeBackupHeaders = field()
    request: shared.DescribeBackupInput = field(metadata={'request': { 'media_type': 'application/json' }})
