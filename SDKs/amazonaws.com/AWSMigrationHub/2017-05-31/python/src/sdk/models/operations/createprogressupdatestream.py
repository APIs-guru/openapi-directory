...
class CreateProgressUpdateStreamHeaders:
    x_amz_target: CreateProgressUpdateStreamXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateProgressUpdateStreamRequest:
    headers: CreateProgressUpdateStreamHeaders = field()
    request: shared.CreateProgressUpdateStreamRequest = field(metadata={'request': { 'media_type': 'application/json' }})
