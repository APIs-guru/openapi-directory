...
class DisassociateDiscoveredResourceHeaders:
    x_amz_target: DisassociateDiscoveredResourceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DisassociateDiscoveredResourceRequest:
    headers: DisassociateDiscoveredResourceHeaders = field()
    request: shared.DisassociateDiscoveredResourceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
