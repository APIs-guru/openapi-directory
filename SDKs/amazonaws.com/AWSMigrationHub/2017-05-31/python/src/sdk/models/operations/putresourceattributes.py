...
class PutResourceAttributesHeaders:
    ...
    x_amz_target: PutResourceAttributesXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class PutResourceAttributesRequest:
    headers: PutResourceAttributesHeaders = field(default=None)
    request: shared.PutResourceAttributesRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
