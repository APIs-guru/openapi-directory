...
class DescribeApplicationStateHeaders:
    x_amz_target: DescribeApplicationStateXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeApplicationStateRequest:
    headers: DescribeApplicationStateHeaders = field()
    request: shared.DescribeApplicationStateRequest = field(metadata={'request': { 'media_type': 'application/json' }})
