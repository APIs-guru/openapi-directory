...
class ListApplicationStatesHeaders:
    x_amz_target: ListApplicationStatesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListApplicationStatesRequest:
    headers: ListApplicationStatesHeaders = field()
    query_params: ListApplicationStatesQueryParams = field()
    request: shared.ListApplicationStatesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
