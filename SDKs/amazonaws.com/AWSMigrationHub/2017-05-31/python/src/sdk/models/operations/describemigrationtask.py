...
class DescribeMigrationTaskHeaders:
    x_amz_target: DescribeMigrationTaskXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeMigrationTaskRequest:
    headers: DescribeMigrationTaskHeaders = field()
    request: shared.DescribeMigrationTaskRequest = field(metadata={'request': { 'media_type': 'application/json' }})
