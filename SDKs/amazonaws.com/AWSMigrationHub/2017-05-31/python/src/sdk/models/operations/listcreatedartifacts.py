...
class ListCreatedArtifactsHeaders:
    x_amz_target: ListCreatedArtifactsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListCreatedArtifactsRequest:
    headers: ListCreatedArtifactsHeaders = field()
    query_params: ListCreatedArtifactsQueryParams = field()
    request: shared.ListCreatedArtifactsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
