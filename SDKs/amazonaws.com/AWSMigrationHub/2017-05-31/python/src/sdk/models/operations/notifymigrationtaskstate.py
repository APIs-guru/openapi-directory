...
class NotifyMigrationTaskStateHeaders:
    ...
    x_amz_target: NotifyMigrationTaskStateXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class NotifyMigrationTaskStateRequest:
    headers: NotifyMigrationTaskStateHeaders = field(default=None)
    request: shared.NotifyMigrationTaskStateRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class NotifyMigrationTaskStateResponse:
    ...
    notify_migration_task_state_result: Optional[dict[str, Any]] = field(default=None)
