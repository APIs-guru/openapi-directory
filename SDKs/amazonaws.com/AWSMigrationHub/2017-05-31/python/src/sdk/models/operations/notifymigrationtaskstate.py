...
class NotifyMigrationTaskStateHeaders:
    x_amz_target: NotifyMigrationTaskStateXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class NotifyMigrationTaskStateRequest:
    headers: NotifyMigrationTaskStateHeaders = field()
    request: shared.NotifyMigrationTaskStateRequest = field(metadata={'request': { 'media_type': 'application/json' }})
