...
class UpdateDomainContactHeaders:
    ...
    x_amz_target: UpdateDomainContactXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateDomainContactRequest:
    headers: UpdateDomainContactHeaders = field(default=None)
    request: shared.UpdateDomainContactRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
