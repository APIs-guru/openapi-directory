...
class ListTagsForDomainHeaders:
    x_amz_target: ListTagsForDomainXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListTagsForDomainRequest:
    headers: ListTagsForDomainHeaders = field()
    request: shared.ListTagsForDomainRequest = field(metadata={'request': { 'media_type': 'application/json' }})
