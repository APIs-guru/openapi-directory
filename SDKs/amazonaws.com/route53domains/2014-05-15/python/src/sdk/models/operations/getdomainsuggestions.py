...
class GetDomainSuggestionsHeaders:
    x_amz_target: GetDomainSuggestionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetDomainSuggestionsRequest:
    headers: GetDomainSuggestionsHeaders = field()
    request: shared.GetDomainSuggestionsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
