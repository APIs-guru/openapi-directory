...
class UpdateTagsForDomainHeaders:
    ...
    x_amz_target: UpdateTagsForDomainXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateTagsForDomainRequest:
    headers: UpdateTagsForDomainHeaders = field(default=None)
    request: shared.UpdateTagsForDomainRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
