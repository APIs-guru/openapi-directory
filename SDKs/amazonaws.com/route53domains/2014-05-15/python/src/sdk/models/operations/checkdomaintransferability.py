...
class CheckDomainTransferabilityHeaders:
    x_amz_target: CheckDomainTransferabilityXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CheckDomainTransferabilityRequest:
    headers: CheckDomainTransferabilityHeaders = field()
    request: shared.CheckDomainTransferabilityRequest = field(metadata={'request': { 'media_type': 'application/json' }})
