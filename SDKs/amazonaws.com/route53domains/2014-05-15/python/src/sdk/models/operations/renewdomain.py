...
class RenewDomainHeaders:
    x_amz_target: RenewDomainXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RenewDomainRequest:
    headers: RenewDomainHeaders = field()
    request: shared.RenewDomainRequest = field(metadata={'request': { 'media_type': 'application/json' }})
