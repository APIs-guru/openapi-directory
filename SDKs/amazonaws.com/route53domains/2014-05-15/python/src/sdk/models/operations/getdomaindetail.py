...
class GetDomainDetailHeaders:
    x_amz_target: GetDomainDetailXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetDomainDetailRequest:
    headers: GetDomainDetailHeaders = field()
    request: shared.GetDomainDetailRequest = field(metadata={'request': { 'media_type': 'application/json' }})
