...
class GetOperationDetailHeaders:
    x_amz_target: GetOperationDetailXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetOperationDetailRequest:
    headers: GetOperationDetailHeaders = field()
    request: shared.GetOperationDetailRequest = field(metadata={'request': { 'media_type': 'application/json' }})
