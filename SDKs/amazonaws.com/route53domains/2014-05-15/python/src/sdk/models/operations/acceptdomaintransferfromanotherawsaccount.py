...
class AcceptDomainTransferFromAnotherAwsAccountHeaders:
    x_amz_target: AcceptDomainTransferFromAnotherAwsAccountXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AcceptDomainTransferFromAnotherAwsAccountRequest:
    headers: AcceptDomainTransferFromAnotherAwsAccountHeaders = field()
    request: shared.AcceptDomainTransferFromAnotherAwsAccountRequest = field(metadata={'request': { 'media_type': 'application/json' }})
