...
class DisableDomainAutoRenewHeaders:
    x_amz_target: DisableDomainAutoRenewXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DisableDomainAutoRenewRequest:
    headers: DisableDomainAutoRenewHeaders = field()
    request: shared.DisableDomainAutoRenewRequest = field(metadata={'request': { 'media_type': 'application/json' }})
