...
class EnableDomainAutoRenewHeaders:
    x_amz_target: EnableDomainAutoRenewXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class EnableDomainAutoRenewRequest:
    headers: EnableDomainAutoRenewHeaders = field()
    request: shared.EnableDomainAutoRenewRequest = field(metadata={'request': { 'media_type': 'application/json' }})
