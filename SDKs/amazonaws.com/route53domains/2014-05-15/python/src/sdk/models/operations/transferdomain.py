...
class TransferDomainHeaders:
    x_amz_target: TransferDomainXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class TransferDomainRequest:
    headers: TransferDomainHeaders = field()
    request: shared.TransferDomainRequest = field(metadata={'request': { 'media_type': 'application/json' }})
