...
class CancelDomainTransferToAnotherAwsAccountHeaders:
    x_amz_target: CancelDomainTransferToAnotherAwsAccountXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CancelDomainTransferToAnotherAwsAccountRequest:
    headers: CancelDomainTransferToAnotherAwsAccountHeaders = field()
    request: shared.CancelDomainTransferToAnotherAwsAccountRequest = field(metadata={'request': { 'media_type': 'application/json' }})
