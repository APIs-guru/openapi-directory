...
class UpdateDomainNameserversHeaders:
    x_amz_target: UpdateDomainNameserversXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateDomainNameserversRequest:
    headers: UpdateDomainNameserversHeaders = field()
    request: shared.UpdateDomainNameserversRequest = field(metadata={'request': { 'media_type': 'application/json' }})
