...
class RejectDomainTransferFromAnotherAwsAccountHeaders:
    ...
    x_amz_target: RejectDomainTransferFromAnotherAwsAccountXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
