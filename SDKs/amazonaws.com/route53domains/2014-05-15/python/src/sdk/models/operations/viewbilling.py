...
class ViewBillingHeaders:
    x_amz_target: ViewBillingXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ViewBillingRequest:
    headers: ViewBillingHeaders = field()
    request: shared.ViewBillingRequest = field(metadata={'request': { 'media_type': 'application/json' }})
