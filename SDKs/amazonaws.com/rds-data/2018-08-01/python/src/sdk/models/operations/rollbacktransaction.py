...
class RollbackTransactionRequest:
    headers: RollbackTransactionHeaders = field(default=None)
    request: RollbackTransactionRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
