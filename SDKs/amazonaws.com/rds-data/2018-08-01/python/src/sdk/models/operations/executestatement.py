...
class ExecuteStatementRequestBodyResultSetOptions:
    r"""ExecuteStatementRequestBodyResultSetOptions
    Options that control how the result set is returned.
    """
    
    decimal_return_type: Optional[shared.DecimalReturnTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('decimalReturnType') }})
...
class ExecuteStatementRequestBody:
    ...
    continue_after_timeout: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('continueAfterTimeout') }})
    database: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('database') }})
    include_result_metadata: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('includeResultMetadata') }})
    parameters: Optional[List[shared.SQLParameter]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('parameters') }})
    result_set_options: Optional[ExecuteStatementRequestBodyResultSetOptions] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('resultSetOptions') }})
...
class ExecuteStatementRequest:
    ...
    request: ExecuteStatementRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
