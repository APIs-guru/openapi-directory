...
class StartReplayHeaders:
    x_amz_target: StartReplayXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartReplayRequest:
    headers: StartReplayHeaders = field()
    request: shared.StartReplayRequest = field(metadata={'request': { 'media_type': 'application/json' }})
