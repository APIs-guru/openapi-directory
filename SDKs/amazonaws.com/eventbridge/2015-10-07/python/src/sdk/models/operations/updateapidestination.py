...
class UpdateAPIDestinationHeaders:
    x_amz_target: UpdateAPIDestinationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateAPIDestinationRequest:
    headers: UpdateAPIDestinationHeaders = field()
    request: shared.UpdateAPIDestinationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
