...
class ListEventSourcesHeaders:
    x_amz_target: ListEventSourcesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListEventSourcesRequest:
    ...
    request: shared.ListEventSourcesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
