...
class ListEventBusesHeaders:
    x_amz_target: ListEventBusesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListEventBusesRequest:
    headers: ListEventBusesHeaders = field()
    request: shared.ListEventBusesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
