...
class RemoveTargetsHeaders:
    ...
    x_amz_target: RemoveTargetsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
    

@dataclass
class RemoveTargetsRequest:
    headers: RemoveTargetsHeaders = field(default=None)
    request: shared.RemoveTargetsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
