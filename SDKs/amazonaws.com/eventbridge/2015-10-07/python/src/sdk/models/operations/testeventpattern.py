...
class TestEventPatternHeaders:
    x_amz_target: TestEventPatternXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class TestEventPatternRequest:
    headers: TestEventPatternHeaders = field()
    request: shared.TestEventPatternRequest = field(metadata={'request': { 'media_type': 'application/json' }})
