...
class ActivateEventSourceHeaders:
    x_amz_target: ActivateEventSourceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ActivateEventSourceRequest:
    headers: ActivateEventSourceHeaders = field()
    request: shared.ActivateEventSourceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
