...
class PutTargetsHeaders:
    x_amz_target: PutTargetsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutTargetsRequest:
    headers: PutTargetsHeaders = field()
    request: shared.PutTargetsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
