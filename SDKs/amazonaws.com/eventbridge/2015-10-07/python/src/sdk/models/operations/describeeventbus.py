...
class DescribeEventBusHeaders:
    ...
    x_amz_target: DescribeEventBusXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
    

@dataclass
class DescribeEventBusRequest:
    headers: DescribeEventBusHeaders = field(default=None)
    request: shared.DescribeEventBusRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
