...
class ListArchivesHeaders:
    x_amz_target: ListArchivesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListArchivesRequest:
    headers: ListArchivesHeaders = field()
    request: shared.ListArchivesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
