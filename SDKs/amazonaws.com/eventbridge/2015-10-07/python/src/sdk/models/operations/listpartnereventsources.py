...
class ListPartnerEventSourcesHeaders:
    x_amz_target: ListPartnerEventSourcesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListPartnerEventSourcesRequest:
    headers: ListPartnerEventSourcesHeaders = field()
    request: shared.ListPartnerEventSourcesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
