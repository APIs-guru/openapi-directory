...
class DescribePartnerEventSourceHeaders:
    x_amz_target: DescribePartnerEventSourceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribePartnerEventSourceRequest:
    headers: DescribePartnerEventSourceHeaders = field()
    request: shared.DescribePartnerEventSourceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
