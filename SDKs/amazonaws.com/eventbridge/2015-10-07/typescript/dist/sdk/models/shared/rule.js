...
var Rule = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], Rule.prototype, "eventBusName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=EventPattern" }),
        __metadata("design:type", String)
    ], Rule.prototype, "eventPattern", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ManagedBy" }),
        __metadata("design:type", String)
    ], Rule.prototype, "managedBy", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], Rule.prototype, "roleArn", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ScheduleExpression" }),
        __metadata("design:type", String)
    ], Rule.prototype, "scheduleExpression", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=State" }),
        __metadata("design:type", String)
    ], Rule.prototype, "state", void 0);
    return Rule;
}(SpeakeasyBase));
export { Rule };
