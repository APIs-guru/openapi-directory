...
var CreateApiDestinationRequest = /** @class */ (function (_super) {
    ...
    ], CreateApiDestinationRequest.prototype, "connectionArn", void 0);
    __decorate([
        Metadata({ data: "json, name=Description" }),
        __metadata("design:type", String)
    ], CreateApiDestinationRequest.prototype, "description", void 0);
    __decorate([
        Metadata({ data: "json, name=HttpMethod" }),
        __metadata("design:type", String)
    ], CreateApiDestinationRequest.prototype, "httpMethod", void 0);
    __decorate([
        Metadata({ data: "json, name=InvocationEndpoint" }),
        __metadata("design:type", String)
    ], CreateApiDestinationRequest.prototype, "invocationEndpoint", void 0);
    __decorate([
        Metadata({ data: "json, name=InvocationRateLimitPerSecond" }),
        __metadata("design:type", Number)
    ], CreateApiDestinationRequest.prototype, "invocationRateLimitPerSecond", void 0);
    __decorate([
        Metadata({ data: "json, name=Name" }),
        __metadata("design:type", String)
    ], CreateApiDestinationRequest.prototype, "name", void 0);
