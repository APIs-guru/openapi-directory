...
var RemoveTargetsResponse = /** @class */ (function (_super) {
    __extends(RemoveTargetsResponse, _super);
    ...
    ], RemoveTargetsResponse.prototype, "failedEntries", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=FailedEntryCount" }),
        __metadata("design:type", Number)
    ], RemoveTargetsResponse.prototype, "failedEntryCount", void 0);
    return RemoveTargetsResponse;
}(SpeakeasyBase));
export { RemoveTargetsResponse };
