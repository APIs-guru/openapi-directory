...
class DetectDocumentTextHeaders:
    x_amz_target: DetectDocumentTextXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DetectDocumentTextRequest:
    headers: DetectDocumentTextHeaders = field()
    request: shared.DetectDocumentTextRequest = field(metadata={'request': { 'media_type': 'application/json' }})
