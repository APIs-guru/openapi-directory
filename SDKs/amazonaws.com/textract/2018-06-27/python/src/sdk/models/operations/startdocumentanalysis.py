...
class StartDocumentAnalysisHeaders:
    x_amz_target: StartDocumentAnalysisXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartDocumentAnalysisRequest:
    headers: StartDocumentAnalysisHeaders = field()
    request: shared.StartDocumentAnalysisRequest = field(metadata={'request': { 'media_type': 'application/json' }})
