...
class StartDocumentTextDetectionHeaders:
    x_amz_target: StartDocumentTextDetectionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartDocumentTextDetectionRequest:
    headers: StartDocumentTextDetectionHeaders = field()
    request: shared.StartDocumentTextDetectionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
