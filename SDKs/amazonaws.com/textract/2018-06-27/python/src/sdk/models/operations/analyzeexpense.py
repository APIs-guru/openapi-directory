...
class AnalyzeExpenseHeaders:
    ...
    x_amz_target: AnalyzeExpenseXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class AnalyzeExpenseRequest:
    headers: AnalyzeExpenseHeaders = field(default=None)
    request: shared.AnalyzeExpenseRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class AnalyzeExpenseResponse:
    access_denied_exception: Optional[Any] = field(default=None)
    analyze_expense_response: Optional[shared.AnalyzeExpenseResponse] = field(default=None)
