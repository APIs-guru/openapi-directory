...
class AnalyzeExpenseHeaders:
    x_amz_target: AnalyzeExpenseXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AnalyzeExpenseRequest:
    headers: AnalyzeExpenseHeaders = field()
    request: shared.AnalyzeExpenseRequest = field(metadata={'request': { 'media_type': 'application/json' }})
