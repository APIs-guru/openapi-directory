...
**/
var BlueInstanceTerminationOption = /** @class */ (function (_super) {
    __extends(BlueInstanceTerminationOption, _super);
    ...
    ], BlueInstanceTerminationOption.prototype, "action", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=terminationWaitTimeInMinutes" }),
        __metadata("design:type", Number)
    ], BlueInstanceTerminationOption.prototype, "terminationWaitTimeInMinutes", void 0);
    return BlueInstanceTerminationOption;
}(SpeakeasyBase));
export { BlueInstanceTerminationOption };
