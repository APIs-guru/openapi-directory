...
**/
var DeploymentStyle = /** @class */ (function (_super) {
    __extends(DeploymentStyle, _super);
    ...
    ], DeploymentStyle.prototype, "deploymentOption", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=deploymentType" }),
        __metadata("design:type", String)
    ], DeploymentStyle.prototype, "deploymentType", void 0);
    return DeploymentStyle;
}(SpeakeasyBase));
export { DeploymentStyle };
