...
class ListDeploymentConfigsHeaders:
    x_amz_target: ListDeploymentConfigsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListDeploymentConfigsRequest:
    headers: ListDeploymentConfigsHeaders = field()
    query_params: ListDeploymentConfigsQueryParams = field()
    request: shared.ListDeploymentConfigsInput = field(metadata={'request': { 'media_type': 'application/json' }})
