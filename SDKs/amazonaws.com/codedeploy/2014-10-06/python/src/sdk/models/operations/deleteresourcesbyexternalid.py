...
class DeleteResourcesByExternalIDHeaders:
    x_amz_target: DeleteResourcesByExternalIDXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteResourcesByExternalIDRequest:
    headers: DeleteResourcesByExternalIDHeaders = field()
    request: shared.DeleteResourcesByExternalIDInput = field(metadata={'request': { 'media_type': 'application/json' }})
