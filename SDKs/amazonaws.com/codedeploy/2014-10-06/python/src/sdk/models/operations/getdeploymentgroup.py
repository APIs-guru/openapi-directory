...
class GetDeploymentGroupHeaders:
    x_amz_target: GetDeploymentGroupXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetDeploymentGroupRequest:
    headers: GetDeploymentGroupHeaders = field()
    request: shared.GetDeploymentGroupInput = field(metadata={'request': { 'media_type': 'application/json' }})
