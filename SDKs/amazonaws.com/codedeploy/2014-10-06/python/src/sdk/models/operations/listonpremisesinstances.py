...
class ListOnPremisesInstancesHeaders:
    x_amz_target: ListOnPremisesInstancesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListOnPremisesInstancesRequest:
    headers: ListOnPremisesInstancesHeaders = field()
    request: shared.ListOnPremisesInstancesInput = field(metadata={'request': { 'media_type': 'application/json' }})
