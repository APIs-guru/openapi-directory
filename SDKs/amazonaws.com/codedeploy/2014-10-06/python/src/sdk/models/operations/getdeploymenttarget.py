...
class GetDeploymentTargetHeaders:
    x_amz_target: GetDeploymentTargetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetDeploymentTargetRequest:
    headers: GetDeploymentTargetHeaders = field()
    request: shared.GetDeploymentTargetInput = field(metadata={'request': { 'media_type': 'application/json' }})
