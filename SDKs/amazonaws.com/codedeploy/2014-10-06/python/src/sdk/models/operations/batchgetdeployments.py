...
class BatchGetDeploymentsHeaders:
    x_amz_target: BatchGetDeploymentsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class BatchGetDeploymentsRequest:
    headers: BatchGetDeploymentsHeaders = field()
    request: shared.BatchGetDeploymentsInput = field(metadata={'request': { 'media_type': 'application/json' }})
