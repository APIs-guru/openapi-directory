...
class ListDeploymentInstancesHeaders:
    x_amz_target: ListDeploymentInstancesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListDeploymentInstancesRequest:
    headers: ListDeploymentInstancesHeaders = field()
    query_params: ListDeploymentInstancesQueryParams = field()
    request: shared.ListDeploymentInstancesInput = field(metadata={'request': { 'media_type': 'application/json' }})
