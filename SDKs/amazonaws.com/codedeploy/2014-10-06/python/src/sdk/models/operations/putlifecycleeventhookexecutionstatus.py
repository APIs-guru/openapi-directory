...
class PutLifecycleEventHookExecutionStatusHeaders:
    x_amz_target: PutLifecycleEventHookExecutionStatusXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutLifecycleEventHookExecutionStatusRequest:
    headers: PutLifecycleEventHookExecutionStatusHeaders = field()
    request: shared.PutLifecycleEventHookExecutionStatusInput = field(metadata={'request': { 'media_type': 'application/json' }})
