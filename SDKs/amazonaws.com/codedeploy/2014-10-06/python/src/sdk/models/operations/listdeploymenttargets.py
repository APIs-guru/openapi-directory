...
class ListDeploymentTargetsHeaders:
    x_amz_target: ListDeploymentTargetsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListDeploymentTargetsRequest:
    headers: ListDeploymentTargetsHeaders = field()
    request: shared.ListDeploymentTargetsInput = field(metadata={'request': { 'media_type': 'application/json' }})
