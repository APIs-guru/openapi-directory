...
class BatchGetDeploymentGroupsHeaders:
    ...
    x_amz_target: BatchGetDeploymentGroupsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class BatchGetDeploymentGroupsRequest:
    headers: BatchGetDeploymentGroupsHeaders = field(default=None)
    request: shared.BatchGetDeploymentGroupsInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class BatchGetDeploymentGroupsResponse:
    ...
    batch_get_deployment_groups_output: Optional[shared.BatchGetDeploymentGroupsOutput] = field(default=None)
