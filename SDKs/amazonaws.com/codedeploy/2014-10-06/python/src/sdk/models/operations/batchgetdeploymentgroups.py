...
class BatchGetDeploymentGroupsHeaders:
    x_amz_target: BatchGetDeploymentGroupsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class BatchGetDeploymentGroupsRequest:
    headers: BatchGetDeploymentGroupsHeaders = field()
    request: shared.BatchGetDeploymentGroupsInput = field(metadata={'request': { 'media_type': 'application/json' }})
