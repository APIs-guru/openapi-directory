...
class RemoveTagsFromOnPremisesInstancesHeaders:
    x_amz_target: RemoveTagsFromOnPremisesInstancesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RemoveTagsFromOnPremisesInstancesRequest:
    headers: RemoveTagsFromOnPremisesInstancesHeaders = field()
    request: shared.RemoveTagsFromOnPremisesInstancesInput = field(metadata={'request': { 'media_type': 'application/json' }})
