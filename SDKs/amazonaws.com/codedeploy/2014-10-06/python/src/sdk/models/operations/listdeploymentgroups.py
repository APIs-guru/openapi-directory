...
class ListDeploymentGroupsHeaders:
    x_amz_target: ListDeploymentGroupsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListDeploymentGroupsRequest:
    headers: ListDeploymentGroupsHeaders = field()
    query_params: ListDeploymentGroupsQueryParams = field()
    request: shared.ListDeploymentGroupsInput = field(metadata={'request': { 'media_type': 'application/json' }})
