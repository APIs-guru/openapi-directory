...
class CreateDeploymentHeaders:
    x_amz_target: CreateDeploymentXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateDeploymentRequest:
    ...
    request: shared.CreateDeploymentInput = field(metadata={'request': { 'media_type': 'application/json' }})
