...
class SkipWaitTimeForInstanceTerminationHeaders:
    ...
    x_amz_target: SkipWaitTimeForInstanceTerminationXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class SkipWaitTimeForInstanceTerminationRequest:
    headers: SkipWaitTimeForInstanceTerminationHeaders = field(default=None)
    request: shared.SkipWaitTimeForInstanceTerminationInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
