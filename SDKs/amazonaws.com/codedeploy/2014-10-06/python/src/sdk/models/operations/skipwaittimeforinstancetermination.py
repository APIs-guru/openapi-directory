...
class SkipWaitTimeForInstanceTerminationHeaders:
    x_amz_target: SkipWaitTimeForInstanceTerminationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class SkipWaitTimeForInstanceTerminationRequest:
    headers: SkipWaitTimeForInstanceTerminationHeaders = field()
    request: shared.SkipWaitTimeForInstanceTerminationInput = field(metadata={'request': { 'media_type': 'application/json' }})
