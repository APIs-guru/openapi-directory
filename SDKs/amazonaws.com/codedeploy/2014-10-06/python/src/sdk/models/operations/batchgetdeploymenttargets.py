...
class BatchGetDeploymentTargetsHeaders:
    x_amz_target: BatchGetDeploymentTargetsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class BatchGetDeploymentTargetsRequest:
    headers: BatchGetDeploymentTargetsHeaders = field()
    request: shared.BatchGetDeploymentTargetsInput = field(metadata={'request': { 'media_type': 'application/json' }})
