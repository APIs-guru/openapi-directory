...
class GetApplicationRevisionHeaders:
    x_amz_target: GetApplicationRevisionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetApplicationRevisionRequest:
    headers: GetApplicationRevisionHeaders = field()
    request: shared.GetApplicationRevisionInput = field(metadata={'request': { 'media_type': 'application/json' }})
