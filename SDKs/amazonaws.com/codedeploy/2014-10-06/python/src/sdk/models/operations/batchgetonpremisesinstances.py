...
class BatchGetOnPremisesInstancesHeaders:
    x_amz_target: BatchGetOnPremisesInstancesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class BatchGetOnPremisesInstancesRequest:
    headers: BatchGetOnPremisesInstancesHeaders = field()
    request: shared.BatchGetOnPremisesInstancesInput = field(metadata={'request': { 'media_type': 'application/json' }})
