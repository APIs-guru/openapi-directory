...
class BatchGetDeploymentInstancesHeaders:
    ...
    x_amz_target: BatchGetDeploymentInstancesXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class BatchGetDeploymentInstancesRequest:
    headers: BatchGetDeploymentInstancesHeaders = field(default=None)
    request: shared.BatchGetDeploymentInstancesInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
