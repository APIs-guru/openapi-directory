...
class GetDeploymentInstanceHeaders:
    ...
    x_amz_target: GetDeploymentInstanceXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetDeploymentInstanceRequest:
    headers: GetDeploymentInstanceHeaders = field(default=None)
    request: shared.GetDeploymentInstanceInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
