...
class ListGitHubAccountTokenNamesHeaders:
    x_amz_target: ListGitHubAccountTokenNamesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListGitHubAccountTokenNamesRequest:
    headers: ListGitHubAccountTokenNamesHeaders = field()
    request: shared.ListGitHubAccountTokenNamesInput = field(metadata={'request': { 'media_type': 'application/json' }})
