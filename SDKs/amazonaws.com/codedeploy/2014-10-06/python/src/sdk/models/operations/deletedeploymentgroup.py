...
class DeleteDeploymentGroupHeaders:
    ...
    x_amz_target: DeleteDeploymentGroupXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeleteDeploymentGroupRequest:
    headers: DeleteDeploymentGroupHeaders = field(default=None)
    request: shared.DeleteDeploymentGroupInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class DeleteDeploymentGroupResponse:
    ...
    delete_deployment_group_output: Optional[shared.DeleteDeploymentGroupOutput] = field(default=None)
