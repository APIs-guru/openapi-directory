...
class DeleteDeploymentGroupHeaders:
    x_amz_target: DeleteDeploymentGroupXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteDeploymentGroupRequest:
    headers: DeleteDeploymentGroupHeaders = field()
    request: shared.DeleteDeploymentGroupInput = field(metadata={'request': { 'media_type': 'application/json' }})
