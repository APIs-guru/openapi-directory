...
class GetApplicationHeaders:
    x_amz_target: GetApplicationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetApplicationRequest:
    ...
    request: shared.GetApplicationInput = field(metadata={'request': { 'media_type': 'application/json' }})
