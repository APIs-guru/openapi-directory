...
class CreateHomeRegionControlHeaders:
    x_amz_target: CreateHomeRegionControlXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateHomeRegionControlRequest:
    headers: CreateHomeRegionControlHeaders = field()
    request: shared.CreateHomeRegionControlRequest = field(metadata={'request': { 'media_type': 'application/json' }})
