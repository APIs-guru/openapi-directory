...
class UpdateWorkspaceAliasRequest:
    headers: UpdateWorkspaceAliasHeaders = field()
    path_params: UpdateWorkspaceAliasPathParams = field()
    request: UpdateWorkspaceAliasRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
