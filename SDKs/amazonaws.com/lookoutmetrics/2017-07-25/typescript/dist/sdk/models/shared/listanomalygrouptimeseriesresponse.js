...
var ListAnomalyGroupTimeSeriesResponse = /** @class */ (function (_super) {
    ...
    ], ListAnomalyGroupTimeSeriesResponse.prototype, "anomalyGroupId", void 0);
    __decorate([
        Metadata({ data: "json, name=MetricName" }),
        __metadata("design:type", String)
    ], ListAnomalyGroupTimeSeriesResponse.prototype, "metricName", void 0);
    __decorate([
        Metadata({ data: "json, name=NextToken" }),
        __metadata("design:type", String)
    ], ListAnomalyGroupTimeSeriesResponse.prototype, "nextToken", void 0);
    __decorate([
        Metadata({ data: "json, name=TimeSeriesList", elemType: shared.TimeSeries }),
        __metadata("design:type", Array)
    ], ListAnomalyGroupTimeSeriesResponse.prototype, "timeSeriesList", void 0);
    __decorate([
        Metadata({ data: "json, name=TimestampList" }),
        __metadata("design:type", Array)
    ], ListAnomalyGroupTimeSeriesResponse.prototype, "timestampList", void 0);
