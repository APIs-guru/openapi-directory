...
class DeleteAnomalyDetectorRequest:
    headers: DeleteAnomalyDetectorHeaders = field(default=None)
    request: DeleteAnomalyDetectorRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
