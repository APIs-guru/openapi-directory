...
class DescribeAnomalyDetectionExecutionsRequest:
    headers: DescribeAnomalyDetectionExecutionsHeaders = field()
    query_params: DescribeAnomalyDetectionExecutionsQueryParams = field()
    request: DescribeAnomalyDetectionExecutionsRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
