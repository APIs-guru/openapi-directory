...
class GetFeedbackRequestBody:
    ...
    anomaly_group_time_series_feedback: GetFeedbackRequestBodyAnomalyGroupTimeSeriesFeedback = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('AnomalyGroupTimeSeriesFeedback') }})
...
class GetFeedbackRequest:
    headers: GetFeedbackHeaders = field()
    query_params: GetFeedbackQueryParams = field()
    request: GetFeedbackRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
