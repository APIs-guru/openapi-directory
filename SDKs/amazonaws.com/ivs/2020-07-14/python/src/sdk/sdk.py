...
class SDK:
    ...
    def batch_get_channel(self, request: operations.BatchGetChannelRequest) -> operations.BatchGetChannelResponse:
        ...
        res = operations.BatchGetChannelResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.BatchGetChannelResponse])
    ...
    def batch_get_stream_key(self, request: operations.BatchGetStreamKeyRequest) -> operations.BatchGetStreamKeyResponse:
        ...
        res = operations.BatchGetStreamKeyResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.BatchGetStreamKeyResponse])
    ...
    def create_channel(self, request: operations.CreateChannelRequest) -> operations.CreateChannelResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateChannelResponse])
    ...
    def create_recording_configuration(self, request: operations.CreateRecordingConfigurationRequest) -> operations.CreateRecordingConfigurationResponse:
        ...
        res = operations.CreateRecordingConfigurationResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateRecordingConfigurationResponse])
    ...
    def create_stream_key(self, request: operations.CreateStreamKeyRequest) -> operations.CreateStreamKeyResponse:
        ...
        res = operations.CreateStreamKeyResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateStreamKeyResponse])
    ...
    def delete_playback_key_pair(self, request: operations.DeletePlaybackKeyPairRequest) -> operations.DeletePlaybackKeyPairResponse:
        ...
        res = operations.DeletePlaybackKeyPairResponse(status_code=r.status_code, content_type=content_type)
    ...
    def delete_recording_configuration(self, request: operations.DeleteRecordingConfigurationRequest) -> operations.DeleteRecordingConfigurationResponse:
        ...
        res = operations.DeleteRecordingConfigurationResponse(status_code=r.status_code, content_type=content_type)
    ...
    def delete_stream_key(self, request: operations.DeleteStreamKeyRequest) -> operations.DeleteStreamKeyResponse:
        ...
        res = operations.DeleteStreamKeyResponse(status_code=r.status_code, content_type=content_type)
    ...
    def get_channel(self, request: operations.GetChannelRequest) -> operations.GetChannelResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetChannelResponse])
    ...
    def get_playback_key_pair(self, request: operations.GetPlaybackKeyPairRequest) -> operations.GetPlaybackKeyPairResponse:
        ...
        res = operations.GetPlaybackKeyPairResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetPlaybackKeyPairResponse])
    ...
    def get_recording_configuration(self, request: operations.GetRecordingConfigurationRequest) -> operations.GetRecordingConfigurationResponse:
        ...
        res = operations.GetRecordingConfigurationResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetRecordingConfigurationResponse])
    ...
    def get_stream(self, request: operations.GetStreamRequest) -> operations.GetStreamResponse:
        ...
        res = operations.GetStreamResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetStreamResponse])
    ...
    def get_stream_key(self, request: operations.GetStreamKeyRequest) -> operations.GetStreamKeyResponse:
        ...
        res = operations.GetStreamKeyResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetStreamKeyResponse])
    ...
    def import_playback_key_pair(self, request: operations.ImportPlaybackKeyPairRequest) -> operations.ImportPlaybackKeyPairResponse:
        ...
        res = operations.ImportPlaybackKeyPairResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ImportPlaybackKeyPairResponse])
    ...
    def list_playback_key_pairs(self, request: operations.ListPlaybackKeyPairsRequest) -> operations.ListPlaybackKeyPairsResponse:
        ...
        res = operations.ListPlaybackKeyPairsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListPlaybackKeyPairsResponse])
    ...
    def list_recording_configurations(self, request: operations.ListRecordingConfigurationsRequest) -> operations.ListRecordingConfigurationsResponse:
        ...
        res = operations.ListRecordingConfigurationsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListRecordingConfigurationsResponse])
    ...
    def list_stream_keys(self, request: operations.ListStreamKeysRequest) -> operations.ListStreamKeysResponse:
        ...
        res = operations.ListStreamKeysResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListStreamKeysResponse])
    ...
    def put_metadata(self, request: operations.PutMetadataRequest) -> operations.PutMetadataResponse:
        ...
        res = operations.PutMetadataResponse(status_code=r.status_code, content_type=content_type)
    ...
    def update_channel(self, request: operations.UpdateChannelRequest) -> operations.UpdateChannelResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.UpdateChannelResponse])
