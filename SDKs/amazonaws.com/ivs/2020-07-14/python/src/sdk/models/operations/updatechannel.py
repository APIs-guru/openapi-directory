...
class UpdateChannelRequestBody:
    ...
    latency_mode: Optional[UpdateChannelRequestBodyLatencyModeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'latencyMode' }})
    ...
    type: Optional[UpdateChannelRequestBodyTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'type' }})
