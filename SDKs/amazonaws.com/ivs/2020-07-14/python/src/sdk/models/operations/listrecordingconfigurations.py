...
class ListRecordingConfigurationsRequest:
    headers: ListRecordingConfigurationsHeaders = field()
    query_params: ListRecordingConfigurationsQueryParams = field()
    request: ListRecordingConfigurationsRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
