...
class CancelQuantumTaskRequest:
    headers: CancelQuantumTaskHeaders = field()
    path_params: CancelQuantumTaskPathParams = field()
    request: CancelQuantumTaskRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
