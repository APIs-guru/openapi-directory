...
type PutObjectHeaders struct {
	...
	XAmzStorageClass       *PutObjectXAmzStorageClassEnum       `header:"name=x-amz-storage-class"`
	XAmzUploadAvailability *PutObjectXAmzUploadAvailabilityEnum `header:"name=x-amz-upload-availability"`
}
