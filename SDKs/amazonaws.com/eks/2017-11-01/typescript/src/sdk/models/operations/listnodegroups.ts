...
export class ListNodegroupsPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=name" })
  name: string;
}


export class ListNodegroupsQueryParams extends SpeakeasyBase {
...
export class ListNodegroupsHeaders extends SpeakeasyBase {
