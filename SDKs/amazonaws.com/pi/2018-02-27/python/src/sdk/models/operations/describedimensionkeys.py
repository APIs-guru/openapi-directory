...
class DescribeDimensionKeysHeaders:
    x_amz_target: DescribeDimensionKeysXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeDimensionKeysRequest:
    headers: DescribeDimensionKeysHeaders = field()
    request: shared.DescribeDimensionKeysRequest = field(metadata={'request': { 'media_type': 'application/json' }})
