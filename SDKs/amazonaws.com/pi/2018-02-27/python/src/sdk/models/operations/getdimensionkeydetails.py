...
class GetDimensionKeyDetailsHeaders:
    ...
    x_amz_target: GetDimensionKeyDetailsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetDimensionKeyDetailsRequest:
    headers: GetDimensionKeyDetailsHeaders = field(default=None)
    request: shared.GetDimensionKeyDetailsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
