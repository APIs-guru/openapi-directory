...
class GetResourceMetricsHeaders:
    x_amz_target: GetResourceMetricsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetResourceMetricsRequest:
    headers: GetResourceMetricsHeaders = field()
    request: shared.GetResourceMetricsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
