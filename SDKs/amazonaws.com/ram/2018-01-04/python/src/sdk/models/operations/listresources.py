...
class ListResourcesRequestBody:
    resource_owner: ListResourcesRequestBodyResourceOwnerEnum = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('resourceOwner') }})
...
class ListResourcesRequest:
    headers: ListResourcesHeaders = field()
    query_params: ListResourcesQueryParams = field()
    request: ListResourcesRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
