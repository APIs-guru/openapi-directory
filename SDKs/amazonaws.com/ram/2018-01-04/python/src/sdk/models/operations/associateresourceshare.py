...
class AssociateResourceShareRequest:
    headers: AssociateResourceShareHeaders = field(default=None)
    request: AssociateResourceShareRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class AssociateResourceShareResponse:
    associate_resource_share_response: Optional[shared.AssociateResourceShareResponse] = field(default=None)
