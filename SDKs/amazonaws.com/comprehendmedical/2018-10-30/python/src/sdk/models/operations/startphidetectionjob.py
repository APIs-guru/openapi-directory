...
class StartPhiDetectionJobHeaders:
    x_amz_target: StartPhiDetectionJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartPhiDetectionJobRequest:
    headers: StartPhiDetectionJobHeaders = field()
    request: shared.StartPhiDetectionJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
