...
class DetectPhiHeaders:
    x_amz_target: DetectPhixAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DetectPhiRequest:
    headers: DetectPhiHeaders = field()
    request: shared.DetectPhiRequest = field(metadata={'request': { 'media_type': 'application/json' }})
