...
class DescribeRxNormInferenceJobHeaders:
    x_amz_target: DescribeRxNormInferenceJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeRxNormInferenceJobRequest:
    headers: DescribeRxNormInferenceJobHeaders = field()
    request: shared.DescribeRxNormInferenceJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
