...
class ListPhiDetectionJobsHeaders:
    ...
    x_amz_target: ListPhiDetectionJobsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ListPhiDetectionJobsRequest:
    headers: ListPhiDetectionJobsHeaders = field(default=None)
    request: shared.ListPhiDetectionJobsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
