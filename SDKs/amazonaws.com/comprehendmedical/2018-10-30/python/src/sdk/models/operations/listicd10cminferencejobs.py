...
class ListIcd10CmInferenceJobsHeaders:
    x_amz_target: ListIcd10CmInferenceJobsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListIcd10CmInferenceJobsRequest:
    headers: ListIcd10CmInferenceJobsHeaders = field()
    request: shared.ListIcd10CmInferenceJobsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
