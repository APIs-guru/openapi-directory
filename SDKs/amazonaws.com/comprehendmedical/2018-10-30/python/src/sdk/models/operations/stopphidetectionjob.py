...
class StopPhiDetectionJobHeaders:
    x_amz_target: StopPhiDetectionJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StopPhiDetectionJobRequest:
    headers: StopPhiDetectionJobHeaders = field()
    request: shared.StopPhiDetectionJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
