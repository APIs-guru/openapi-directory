...
class DetectEntitiesV2Headers:
    ...
    x_amz_target: DetectEntitiesV2XAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DetectEntitiesV2Request:
    headers: DetectEntitiesV2Headers = field(default=None)
    request: shared.DetectEntitiesV2Request = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
