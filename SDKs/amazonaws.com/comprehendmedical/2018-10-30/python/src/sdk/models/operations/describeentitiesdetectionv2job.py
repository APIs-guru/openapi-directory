...
class DescribeEntitiesDetectionV2JobHeaders:
    ...
    x_amz_target: DescribeEntitiesDetectionV2JobXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeEntitiesDetectionV2JobRequest:
    headers: DescribeEntitiesDetectionV2JobHeaders = field(default=None)
    request: shared.DescribeEntitiesDetectionV2JobRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
