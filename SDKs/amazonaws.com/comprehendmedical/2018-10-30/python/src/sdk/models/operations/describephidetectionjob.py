...
class DescribePhiDetectionJobHeaders:
    x_amz_target: DescribePhiDetectionJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribePhiDetectionJobRequest:
    headers: DescribePhiDetectionJobHeaders = field()
    request: shared.DescribePhiDetectionJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
