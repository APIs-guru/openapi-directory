...
class InferRxNormHeaders:
    ...
    x_amz_target: InferRxNormXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class InferRxNormRequest:
    headers: InferRxNormHeaders = field(default=None)
    request: shared.InferRxNormRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
