...
class StopEntitiesDetectionV2JobHeaders:
    x_amz_target: StopEntitiesDetectionV2JobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StopEntitiesDetectionV2JobRequest:
    headers: StopEntitiesDetectionV2JobHeaders = field()
    request: shared.StopEntitiesDetectionV2JobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
