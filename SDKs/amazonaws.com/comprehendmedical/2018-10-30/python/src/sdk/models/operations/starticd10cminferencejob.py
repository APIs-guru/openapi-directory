...
class StartIcd10CmInferenceJobHeaders:
    x_amz_target: StartIcd10CmInferenceJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartIcd10CmInferenceJobRequest:
    headers: StartIcd10CmInferenceJobHeaders = field()
    request: shared.StartIcd10CmInferenceJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
