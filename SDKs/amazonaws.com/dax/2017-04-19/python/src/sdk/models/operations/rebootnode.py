...
class RebootNodeHeaders:
    ...
    x_amz_target: RebootNodeXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
    

@dataclass
class RebootNodeRequest:
    headers: RebootNodeHeaders = field(default=None)
    request: shared.RebootNodeRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class RebootNodeResponse:
    ...
    node_not_found_fault: Optional[Any] = field(default=None)
    reboot_node_response: Optional[shared.RebootNodeResponse] = field(default=None)
