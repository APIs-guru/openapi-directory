...
class RebootNodeHeaders:
    x_amz_target: RebootNodeXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RebootNodeRequest:
    headers: RebootNodeHeaders = field()
    request: shared.RebootNodeRequest = field(metadata={'request': { 'media_type': 'application/json' }})
