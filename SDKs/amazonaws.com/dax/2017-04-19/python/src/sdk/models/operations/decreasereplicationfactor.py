...
class DecreaseReplicationFactorHeaders:
    x_amz_target: DecreaseReplicationFactorXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DecreaseReplicationFactorRequest:
    headers: DecreaseReplicationFactorHeaders = field()
    request: shared.DecreaseReplicationFactorRequest = field(metadata={'request': { 'media_type': 'application/json' }})
