...
class DecreaseReplicationFactorHeaders:
    ...
    x_amz_target: DecreaseReplicationFactorXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DecreaseReplicationFactorRequest:
    headers: DecreaseReplicationFactorHeaders = field(default=None)
    request: shared.DecreaseReplicationFactorRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class DecreaseReplicationFactorResponse:
    ...
    decrease_replication_factor_response: Optional[shared.DecreaseReplicationFactorResponse] = field(default=None)
