...
class DescribeParameterGroupsHeaders:
    x_amz_target: DescribeParameterGroupsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeParameterGroupsRequest:
    headers: DescribeParameterGroupsHeaders = field()
    request: shared.DescribeParameterGroupsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
