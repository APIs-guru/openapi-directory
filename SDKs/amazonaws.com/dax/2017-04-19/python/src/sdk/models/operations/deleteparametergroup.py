...
class DeleteParameterGroupHeaders:
    x_amz_target: DeleteParameterGroupXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteParameterGroupRequest:
    headers: DeleteParameterGroupHeaders = field()
    request: shared.DeleteParameterGroupRequest = field(metadata={'request': { 'media_type': 'application/json' }})
