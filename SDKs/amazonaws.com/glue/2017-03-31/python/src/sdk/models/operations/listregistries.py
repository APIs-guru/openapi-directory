...
class ListRegistriesHeaders:
    x_amz_target: ListRegistriesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListRegistriesRequest:
    headers: ListRegistriesHeaders = field()
    query_params: ListRegistriesQueryParams = field()
    request: shared.ListRegistriesInput = field(metadata={'request': { 'media_type': 'application/json' }})
