...
class ResetJobBookmarkHeaders:
    x_amz_target: ResetJobBookmarkXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ResetJobBookmarkRequest:
    headers: ResetJobBookmarkHeaders = field()
    request: shared.ResetJobBookmarkRequest = field(metadata={'request': { 'media_type': 'application/json' }})
