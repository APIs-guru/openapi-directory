...
class DeletePartitionHeaders:
    x_amz_target: DeletePartitionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeletePartitionRequest:
    headers: DeletePartitionHeaders = field()
    request: shared.DeletePartitionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
