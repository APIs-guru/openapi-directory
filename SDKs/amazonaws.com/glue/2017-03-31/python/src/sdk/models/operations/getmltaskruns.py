...
class GetMlTaskRunsHeaders:
    x_amz_target: GetMlTaskRunsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetMlTaskRunsRequest:
    headers: GetMlTaskRunsHeaders = field()
    query_params: GetMlTaskRunsQueryParams = field()
    request: shared.GetMlTaskRunsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
