...
class GetSchemaVersionsDiffHeaders:
    ...
    x_amz_target: GetSchemaVersionsDiffXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetSchemaVersionsDiffRequest:
    headers: GetSchemaVersionsDiffHeaders = field(default=None)
    request: shared.GetSchemaVersionsDiffInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
