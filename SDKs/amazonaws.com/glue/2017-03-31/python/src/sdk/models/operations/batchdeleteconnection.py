...
class BatchDeleteConnectionHeaders:
    x_amz_target: BatchDeleteConnectionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class BatchDeleteConnectionRequest:
    headers: BatchDeleteConnectionHeaders = field()
    request: shared.BatchDeleteConnectionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
