...
class GetTablesHeaders:
    x_amz_target: GetTablesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetTablesRequest:
    headers: GetTablesHeaders = field()
    query_params: GetTablesQueryParams = field()
    request: shared.GetTablesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
