...
class CreateBlueprintHeaders:
    x_amz_target: CreateBlueprintXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateBlueprintRequest:
    headers: CreateBlueprintHeaders = field()
    request: shared.CreateBlueprintRequest = field(metadata={'request': { 'media_type': 'application/json' }})
