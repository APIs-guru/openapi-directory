...
class PutWorkflowRunPropertiesHeaders:
    x_amz_target: PutWorkflowRunPropertiesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutWorkflowRunPropertiesRequest:
    headers: PutWorkflowRunPropertiesHeaders = field()
    request: shared.PutWorkflowRunPropertiesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
