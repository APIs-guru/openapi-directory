...
class GetDatabasesHeaders:
    x_amz_target: GetDatabasesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetDatabasesRequest:
    headers: GetDatabasesHeaders = field()
    query_params: GetDatabasesQueryParams = field()
    request: shared.GetDatabasesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
