...
class GetWorkflowRunsHeaders:
    x_amz_target: GetWorkflowRunsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetWorkflowRunsRequest:
    headers: GetWorkflowRunsHeaders = field()
    query_params: GetWorkflowRunsQueryParams = field()
    request: shared.GetWorkflowRunsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
