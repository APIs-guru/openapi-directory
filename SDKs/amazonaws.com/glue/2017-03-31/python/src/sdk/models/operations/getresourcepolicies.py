...
class GetResourcePoliciesHeaders:
    x_amz_target: GetResourcePoliciesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetResourcePoliciesRequest:
    ...
    request: shared.GetResourcePoliciesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
