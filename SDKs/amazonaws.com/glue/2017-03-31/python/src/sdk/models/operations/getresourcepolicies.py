...
class GetResourcePoliciesHeaders:
    ...
    x_amz_target: GetResourcePoliciesXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetResourcePoliciesRequest:
    ...
    request: shared.GetResourcePoliciesRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
