...
class ListMlTransformsHeaders:
    x_amz_target: ListMlTransformsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListMlTransformsRequest:
    headers: ListMlTransformsHeaders = field()
    query_params: ListMlTransformsQueryParams = field()
    request: shared.ListMlTransformsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
