...
class DeleteMlTransformHeaders:
    x_amz_target: DeleteMlTransformXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteMlTransformRequest:
    headers: DeleteMlTransformHeaders = field()
    request: shared.DeleteMlTransformRequest = field(metadata={'request': { 'media_type': 'application/json' }})
