...
class GetDevEndpointHeaders:
    x_amz_target: GetDevEndpointXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetDevEndpointRequest:
    headers: GetDevEndpointHeaders = field()
    request: shared.GetDevEndpointRequest = field(metadata={'request': { 'media_type': 'application/json' }})
