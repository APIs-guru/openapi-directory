...
class GetBlueprintRunsHeaders:
    x_amz_target: GetBlueprintRunsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetBlueprintRunsRequest:
    headers: GetBlueprintRunsHeaders = field()
    query_params: GetBlueprintRunsQueryParams = field()
    request: shared.GetBlueprintRunsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
