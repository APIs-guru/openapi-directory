...
class CreateRegistryHeaders:
    ...
    x_amz_target: CreateRegistryXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateRegistryRequest:
    headers: CreateRegistryHeaders = field(default=None)
    request: shared.CreateRegistryInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
