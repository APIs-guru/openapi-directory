...
class UpdateCrawlerHeaders:
    x_amz_target: UpdateCrawlerXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateCrawlerRequest:
    headers: UpdateCrawlerHeaders = field()
    request: shared.UpdateCrawlerRequest = field(metadata={'request': { 'media_type': 'application/json' }})
