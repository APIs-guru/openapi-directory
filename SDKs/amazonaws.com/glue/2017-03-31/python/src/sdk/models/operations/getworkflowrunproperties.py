...
class GetWorkflowRunPropertiesHeaders:
    x_amz_target: GetWorkflowRunPropertiesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetWorkflowRunPropertiesRequest:
    headers: GetWorkflowRunPropertiesHeaders = field()
    request: shared.GetWorkflowRunPropertiesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
