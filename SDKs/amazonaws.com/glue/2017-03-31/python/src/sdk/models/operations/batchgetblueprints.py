...
class BatchGetBlueprintsHeaders:
    ...
    x_amz_target: BatchGetBlueprintsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
    

@dataclass
class BatchGetBlueprintsRequest:
    headers: BatchGetBlueprintsHeaders = field(default=None)
    request: shared.BatchGetBlueprintsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
