...
class StartTriggerHeaders:
    x_amz_target: StartTriggerXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartTriggerRequest:
    headers: StartTriggerHeaders = field()
    request: shared.StartTriggerRequest = field(metadata={'request': { 'media_type': 'application/json' }})
