...
class StartMlEvaluationTaskRunHeaders:
    x_amz_target: StartMlEvaluationTaskRunXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartMlEvaluationTaskRunRequest:
    headers: StartMlEvaluationTaskRunHeaders = field()
    request: shared.StartMlEvaluationTaskRunRequest = field(metadata={'request': { 'media_type': 'application/json' }})
