...
class GetJobsHeaders:
    x_amz_target: GetJobsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetJobsRequest:
    headers: GetJobsHeaders = field()
    query_params: GetJobsQueryParams = field()
    request: shared.GetJobsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
