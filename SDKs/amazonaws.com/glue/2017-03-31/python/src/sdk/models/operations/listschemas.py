...
class ListSchemasHeaders:
    ...
    x_amz_target: ListSchemasXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
...
class ListSchemasRequest:
    ...
    request: shared.ListSchemasInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
