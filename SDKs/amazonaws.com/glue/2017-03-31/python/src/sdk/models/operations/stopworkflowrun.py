...
class StopWorkflowRunHeaders:
    x_amz_target: StopWorkflowRunXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StopWorkflowRunRequest:
    headers: StopWorkflowRunHeaders = field()
    request: shared.StopWorkflowRunRequest = field(metadata={'request': { 'media_type': 'application/json' }})
