...
class StopCrawlerHeaders:
    x_amz_target: StopCrawlerXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StopCrawlerRequest:
    headers: StopCrawlerHeaders = field()
    request: shared.StopCrawlerRequest = field(metadata={'request': { 'media_type': 'application/json' }})
