...
class DeleteCrawlerHeaders:
    x_amz_target: DeleteCrawlerXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteCrawlerRequest:
    headers: DeleteCrawlerHeaders = field()
    request: shared.DeleteCrawlerRequest = field(metadata={'request': { 'media_type': 'application/json' }})
