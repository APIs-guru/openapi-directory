...
class GetSecurityConfigurationsHeaders:
    x_amz_target: GetSecurityConfigurationsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetSecurityConfigurationsRequest:
    headers: GetSecurityConfigurationsHeaders = field()
    query_params: GetSecurityConfigurationsQueryParams = field()
    request: shared.GetSecurityConfigurationsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
