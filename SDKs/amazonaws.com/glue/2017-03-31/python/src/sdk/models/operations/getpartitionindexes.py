...
class GetPartitionIndexesHeaders:
    x_amz_target: GetPartitionIndexesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetPartitionIndexesRequest:
    headers: GetPartitionIndexesHeaders = field()
    query_params: GetPartitionIndexesQueryParams = field()
    request: shared.GetPartitionIndexesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
