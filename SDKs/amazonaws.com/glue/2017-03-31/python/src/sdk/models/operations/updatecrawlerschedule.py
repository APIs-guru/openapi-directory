...
class UpdateCrawlerScheduleHeaders:
    x_amz_target: UpdateCrawlerScheduleXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateCrawlerScheduleRequest:
    headers: UpdateCrawlerScheduleHeaders = field()
    request: shared.UpdateCrawlerScheduleRequest = field(metadata={'request': { 'media_type': 'application/json' }})
