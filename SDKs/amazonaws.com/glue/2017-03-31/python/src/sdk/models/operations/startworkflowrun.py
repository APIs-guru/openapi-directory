...
class StartWorkflowRunHeaders:
    x_amz_target: StartWorkflowRunXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartWorkflowRunRequest:
    headers: StartWorkflowRunHeaders = field()
    request: shared.StartWorkflowRunRequest = field(metadata={'request': { 'media_type': 'application/json' }})
