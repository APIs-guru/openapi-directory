...
from . import batchupdatepartitionrequestentry
...
class BatchUpdatePartitionRequest:
    ...
    entries: List[batchupdatepartitionrequestentry.BatchUpdatePartitionRequestEntry] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Entries' }})
