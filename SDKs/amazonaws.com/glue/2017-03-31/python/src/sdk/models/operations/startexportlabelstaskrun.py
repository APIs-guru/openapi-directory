...
class StartExportLabelsTaskRunHeaders:
    x_amz_target: StartExportLabelsTaskRunXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartExportLabelsTaskRunRequest:
    headers: StartExportLabelsTaskRunHeaders = field()
    request: shared.StartExportLabelsTaskRunRequest = field(metadata={'request': { 'media_type': 'application/json' }})
