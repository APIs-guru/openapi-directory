...
class GetCrawlerMetricsHeaders:
    x_amz_target: GetCrawlerMetricsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetCrawlerMetricsRequest:
    headers: GetCrawlerMetricsHeaders = field()
    query_params: GetCrawlerMetricsQueryParams = field()
    request: shared.GetCrawlerMetricsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
