...
class UpdateClassifierHeaders:
    x_amz_target: UpdateClassifierXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateClassifierRequest:
    headers: UpdateClassifierHeaders = field()
    request: shared.UpdateClassifierRequest = field(metadata={'request': { 'media_type': 'application/json' }})
