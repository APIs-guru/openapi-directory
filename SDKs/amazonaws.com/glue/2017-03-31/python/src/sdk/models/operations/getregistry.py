...
class GetRegistryHeaders:
    x_amz_target: GetRegistryXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetRegistryRequest:
    headers: GetRegistryHeaders = field()
    request: shared.GetRegistryInput = field(metadata={'request': { 'media_type': 'application/json' }})
