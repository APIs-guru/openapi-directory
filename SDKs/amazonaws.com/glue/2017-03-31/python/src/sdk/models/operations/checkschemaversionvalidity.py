...
class CheckSchemaVersionValidityHeaders:
    x_amz_target: CheckSchemaVersionValidityXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CheckSchemaVersionValidityRequest:
    headers: CheckSchemaVersionValidityHeaders = field()
    request: shared.CheckSchemaVersionValidityInput = field(metadata={'request': { 'media_type': 'application/json' }})
