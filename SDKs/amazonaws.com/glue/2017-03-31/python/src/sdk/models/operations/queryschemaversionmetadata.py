...
class QuerySchemaVersionMetadataHeaders:
    x_amz_target: QuerySchemaVersionMetadataXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class QuerySchemaVersionMetadataRequest:
    headers: QuerySchemaVersionMetadataHeaders = field()
    request: shared.QuerySchemaVersionMetadataInput = field(metadata={'request': { 'media_type': 'application/json' }})
