...
class GetDataflowGraphHeaders:
    x_amz_target: GetDataflowGraphXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetDataflowGraphRequest:
    headers: GetDataflowGraphHeaders = field()
    request: shared.GetDataflowGraphRequest = field(metadata={'request': { 'media_type': 'application/json' }})
