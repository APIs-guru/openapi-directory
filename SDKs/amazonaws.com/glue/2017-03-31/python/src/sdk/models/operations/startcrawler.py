...
class StartCrawlerHeaders:
    x_amz_target: StartCrawlerXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartCrawlerRequest:
    headers: StartCrawlerHeaders = field()
    request: shared.StartCrawlerRequest = field(metadata={'request': { 'media_type': 'application/json' }})
