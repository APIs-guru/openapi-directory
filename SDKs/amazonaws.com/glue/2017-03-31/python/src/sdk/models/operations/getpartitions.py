...
class GetPartitionsHeaders:
    x_amz_target: GetPartitionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetPartitionsRequest:
    headers: GetPartitionsHeaders = field()
    query_params: GetPartitionsQueryParams = field()
    request: shared.GetPartitionsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
