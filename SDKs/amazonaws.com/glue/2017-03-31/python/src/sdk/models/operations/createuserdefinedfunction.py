...
class CreateUserDefinedFunctionHeaders:
    x_amz_target: CreateUserDefinedFunctionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateUserDefinedFunctionRequest:
    headers: CreateUserDefinedFunctionHeaders = field()
    request: shared.CreateUserDefinedFunctionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
