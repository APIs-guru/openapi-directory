...
class CreateDevEndpointHeaders:
    x_amz_target: CreateDevEndpointXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateDevEndpointRequest:
    headers: CreateDevEndpointHeaders = field()
    request: shared.CreateDevEndpointRequest = field(metadata={'request': { 'media_type': 'application/json' }})
