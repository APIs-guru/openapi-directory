...
class CreateTriggerHeaders:
    x_amz_target: CreateTriggerXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateTriggerRequest:
    headers: CreateTriggerHeaders = field()
    request: shared.CreateTriggerRequest = field(metadata={'request': { 'media_type': 'application/json' }})
