...
class StartJobRunHeaders:
    x_amz_target: StartJobRunXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartJobRunRequest:
    ...
    request: shared.StartJobRunRequest = field(metadata={'request': { 'media_type': 'application/json' }})
