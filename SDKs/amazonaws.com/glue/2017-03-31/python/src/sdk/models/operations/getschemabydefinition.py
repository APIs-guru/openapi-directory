...
class GetSchemaByDefinitionHeaders:
    x_amz_target: GetSchemaByDefinitionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetSchemaByDefinitionRequest:
    headers: GetSchemaByDefinitionHeaders = field()
    request: shared.GetSchemaByDefinitionInput = field(metadata={'request': { 'media_type': 'application/json' }})
