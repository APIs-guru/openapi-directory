...
var GetRegistryResponse = /** @class */ (function (_super) {
    ...
    ], GetRegistryResponse.prototype, "createdTime", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Description" }),
        __metadata("design:type", String)
    ], GetRegistryResponse.prototype, "description", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=RegistryArn" }),
        __metadata("design:type", String)
    ], GetRegistryResponse.prototype, "registryArn", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=RegistryName" }),
        __metadata("design:type", String)
    ], GetRegistryResponse.prototype, "registryName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Status" }),
        __metadata("design:type", String)
    ], GetRegistryResponse.prototype, "status", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=UpdatedTime" }),
        __metadata("design:type", String)
    ], GetRegistryResponse.prototype, "updatedTime", void 0);
