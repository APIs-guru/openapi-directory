...
var CreatePartitionRequest = /** @class */ (function (_super) {
    ...
    ], CreatePartitionRequest.prototype, "catalogId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=DatabaseName" }),
        __metadata("design:type", String)
    ], CreatePartitionRequest.prototype, "databaseName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=PartitionInput" }),
        __metadata("design:type", PartitionInput)
    ], CreatePartitionRequest.prototype, "partitionInput", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=TableName" }),
        __metadata("design:type", String)
    ], CreatePartitionRequest.prototype, "tableName", void 0);
