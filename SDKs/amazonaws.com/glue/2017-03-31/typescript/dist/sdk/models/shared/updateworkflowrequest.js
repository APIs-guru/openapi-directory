...
var UpdateWorkflowRequest = /** @class */ (function (_super) {
    ...
    ], UpdateWorkflowRequest.prototype, "defaultRunProperties", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Description" }),
        __metadata("design:type", String)
    ], UpdateWorkflowRequest.prototype, "description", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=MaxConcurrentRuns" }),
        __metadata("design:type", Number)
    ], UpdateWorkflowRequest.prototype, "maxConcurrentRuns", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Name" }),
        __metadata("design:type", String)
    ], UpdateWorkflowRequest.prototype, "name", void 0);
