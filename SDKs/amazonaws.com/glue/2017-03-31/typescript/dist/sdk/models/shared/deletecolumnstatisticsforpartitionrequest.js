...
var DeleteColumnStatisticsForPartitionRequest = /** @class */ (function (_super) {
    ...
    ], DeleteColumnStatisticsForPartitionRequest.prototype, "catalogId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ColumnName" }),
        __metadata("design:type", String)
    ], DeleteColumnStatisticsForPartitionRequest.prototype, "columnName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=DatabaseName" }),
        __metadata("design:type", String)
    ], DeleteColumnStatisticsForPartitionRequest.prototype, "databaseName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=PartitionValues" }),
        __metadata("design:type", Array)
    ], DeleteColumnStatisticsForPartitionRequest.prototype, "partitionValues", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=TableName" }),
        __metadata("design:type", String)
    ], DeleteColumnStatisticsForPartitionRequest.prototype, "tableName", void 0);
