...
**/
var GetConnectionsFilter = /** @class */ (function (_super) {
    __extends(GetConnectionsFilter, _super);
    ...
    ], GetConnectionsFilter.prototype, "connectionType", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=MatchCriteria" }),
        __metadata("design:type", Array)
    ], GetConnectionsFilter.prototype, "matchCriteria", void 0);
    return GetConnectionsFilter;
}(SpeakeasyBase));
export { GetConnectionsFilter };
