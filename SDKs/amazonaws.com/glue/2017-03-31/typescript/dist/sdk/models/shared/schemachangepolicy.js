...
**/
var SchemaChangePolicy = /** @class */ (function (_super) {
    __extends(SchemaChangePolicy, _super);
    ...
    ], SchemaChangePolicy.prototype, "deleteBehavior", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=UpdateBehavior" }),
        __metadata("design:type", String)
    ], SchemaChangePolicy.prototype, "updateBehavior", void 0);
    return SchemaChangePolicy;
}(SpeakeasyBase));
export { SchemaChangePolicy };
