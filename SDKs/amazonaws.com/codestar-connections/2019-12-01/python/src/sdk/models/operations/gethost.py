...
class GetHostHeaders:
    x_amz_target: GetHostXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetHostRequest:
    headers: GetHostHeaders = field()
    request: shared.GetHostInput = field(metadata={'request': { 'media_type': 'application/json' }})
