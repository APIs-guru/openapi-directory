...
class GetConnectionHeaders:
    x_amz_target: GetConnectionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetConnectionRequest:
    ...
    request: shared.GetConnectionInput = field(metadata={'request': { 'media_type': 'application/json' }})
