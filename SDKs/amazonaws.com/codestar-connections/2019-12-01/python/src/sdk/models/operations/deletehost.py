...
class DeleteHostHeaders:
    x_amz_target: DeleteHostXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteHostRequest:
    headers: DeleteHostHeaders = field()
    request: shared.DeleteHostInput = field(metadata={'request': { 'media_type': 'application/json' }})
