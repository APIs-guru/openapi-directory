...
class PostModifyEventSubscriptionQueryParams:
    action: PostModifyEventSubscriptionActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostModifyEventSubscriptionVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostModifyEventSubscriptionRequest:
    headers: PostModifyEventSubscriptionHeaders = field()
    query_params: PostModifyEventSubscriptionQueryParams = field()
