...
class PostResetDbParameterGroupQueryParams:
    action: PostResetDbParameterGroupActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostResetDbParameterGroupVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostResetDbParameterGroupRequest:
    headers: PostResetDbParameterGroupHeaders = field()
    query_params: PostResetDbParameterGroupQueryParams = field()
