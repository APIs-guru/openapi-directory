...
class PostListTagsForResourceQueryParams:
    action: PostListTagsForResourceActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostListTagsForResourceVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostListTagsForResourceRequest:
    headers: PostListTagsForResourceHeaders = field()
    query_params: PostListTagsForResourceQueryParams = field()
