...
class GetStopDbInstanceAutomatedBackupsReplicationQueryParams:
    action: GetStopDbInstanceAutomatedBackupsReplicationActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    source_db_instance_arn: str = field(metadata={'query_param': { 'field_name': 'SourceDBInstanceArn', 'style': 'form', 'explode': True }})
    version: GetStopDbInstanceAutomatedBackupsReplicationVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetStopDbInstanceAutomatedBackupsReplicationRequest:
    headers: GetStopDbInstanceAutomatedBackupsReplicationHeaders = field()
    query_params: GetStopDbInstanceAutomatedBackupsReplicationQueryParams = field()
