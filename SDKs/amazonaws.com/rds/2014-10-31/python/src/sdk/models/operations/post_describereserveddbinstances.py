...
class PostDescribeReservedDbInstancesQueryParams:
    action: PostDescribeReservedDbInstancesActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeReservedDbInstancesVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeReservedDbInstancesRequest:
    headers: PostDescribeReservedDbInstancesHeaders = field()
    query_params: PostDescribeReservedDbInstancesQueryParams = field()
