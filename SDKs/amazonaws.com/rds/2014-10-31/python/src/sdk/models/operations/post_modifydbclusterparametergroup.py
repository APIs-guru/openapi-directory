...
class PostModifyDbClusterParameterGroupQueryParams:
    action: PostModifyDbClusterParameterGroupActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostModifyDbClusterParameterGroupVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostModifyDbClusterParameterGroupRequest:
    headers: PostModifyDbClusterParameterGroupHeaders = field()
    query_params: PostModifyDbClusterParameterGroupQueryParams = field()
