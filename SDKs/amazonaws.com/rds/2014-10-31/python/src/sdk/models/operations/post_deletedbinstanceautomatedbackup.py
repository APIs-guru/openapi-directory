...
class PostDeleteDbInstanceAutomatedBackupQueryParams:
    action: PostDeleteDbInstanceAutomatedBackupActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDeleteDbInstanceAutomatedBackupVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDeleteDbInstanceAutomatedBackupRequest:
    headers: PostDeleteDbInstanceAutomatedBackupHeaders = field()
    query_params: PostDeleteDbInstanceAutomatedBackupQueryParams = field()
