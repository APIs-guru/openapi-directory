...
class PostDescribeCustomAvailabilityZonesQueryParams:
    action: PostDescribeCustomAvailabilityZonesActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: PostDescribeCustomAvailabilityZonesVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeCustomAvailabilityZonesRequest:
    query_params: PostDescribeCustomAvailabilityZonesQueryParams = field(default=None)
    headers: PostDescribeCustomAvailabilityZonesHeaders = field(default=None)
