...
class PostStartDbInstanceAutomatedBackupsReplicationQueryParams:
    action: PostStartDbInstanceAutomatedBackupsReplicationActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostStartDbInstanceAutomatedBackupsReplicationVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostStartDbInstanceAutomatedBackupsReplicationRequest:
    headers: PostStartDbInstanceAutomatedBackupsReplicationHeaders = field()
    query_params: PostStartDbInstanceAutomatedBackupsReplicationQueryParams = field()
