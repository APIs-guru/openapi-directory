...
class PostCopyDbClusterParameterGroupQueryParams:
    action: PostCopyDbClusterParameterGroupActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostCopyDbClusterParameterGroupVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostCopyDbClusterParameterGroupRequest:
    headers: PostCopyDbClusterParameterGroupHeaders = field()
    query_params: PostCopyDbClusterParameterGroupQueryParams = field()
