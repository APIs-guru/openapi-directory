...
class PostDescribeSourceRegionsQueryParams:
    action: PostDescribeSourceRegionsActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeSourceRegionsVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeSourceRegionsRequest:
    headers: PostDescribeSourceRegionsHeaders = field()
    query_params: PostDescribeSourceRegionsQueryParams = field()
