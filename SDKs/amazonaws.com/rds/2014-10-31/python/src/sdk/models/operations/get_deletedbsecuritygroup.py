...
class GetDeleteDbSecurityGroupQueryParams:
    action: GetDeleteDbSecurityGroupActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    db_security_group_name: str = field(metadata={'query_param': { 'field_name': 'DBSecurityGroupName', 'style': 'form', 'explode': True }})
    version: GetDeleteDbSecurityGroupVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteDbSecurityGroupRequest:
    headers: GetDeleteDbSecurityGroupHeaders = field()
    query_params: GetDeleteDbSecurityGroupQueryParams = field()
