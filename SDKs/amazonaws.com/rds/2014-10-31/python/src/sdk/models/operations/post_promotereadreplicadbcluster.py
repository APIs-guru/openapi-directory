...
class PostPromoteReadReplicaDbClusterQueryParams:
    action: PostPromoteReadReplicaDbClusterActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostPromoteReadReplicaDbClusterVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostPromoteReadReplicaDbClusterRequest:
    headers: PostPromoteReadReplicaDbClusterHeaders = field()
    query_params: PostPromoteReadReplicaDbClusterQueryParams = field()
