...
class GetDeleteDbProxyEndpointQueryParams:
    action: GetDeleteDbProxyEndpointActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetDeleteDbProxyEndpointVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteDbProxyEndpointRequest:
    query_params: GetDeleteDbProxyEndpointQueryParams = field(default=None)
    headers: GetDeleteDbProxyEndpointHeaders = field(default=None)
