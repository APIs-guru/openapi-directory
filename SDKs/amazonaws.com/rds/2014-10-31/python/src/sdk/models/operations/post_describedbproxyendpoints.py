...
class PostDescribeDbProxyEndpointsQueryParams:
    action: PostDescribeDbProxyEndpointsActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: PostDescribeDbProxyEndpointsVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeDbProxyEndpointsRequest:
    query_params: PostDescribeDbProxyEndpointsQueryParams = field(default=None)
    headers: PostDescribeDbProxyEndpointsHeaders = field(default=None)
