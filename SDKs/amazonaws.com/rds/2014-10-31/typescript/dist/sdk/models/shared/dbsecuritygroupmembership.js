...
**/
var DbSecurityGroupMembership = /** @class */ (function (_super) {
    __extends(DbSecurityGroupMembership, _super);
    ...
    ], DbSecurityGroupMembership.prototype, "dbSecurityGroupName", void 0);
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", String)
    ], DbSecurityGroupMembership.prototype, "status", void 0);
    return DbSecurityGroupMembership;
}(SpeakeasyBase));
export { DbSecurityGroupMembership };
