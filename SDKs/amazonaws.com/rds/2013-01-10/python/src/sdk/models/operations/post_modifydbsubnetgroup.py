...
class PostModifyDbSubnetGroupQueryParams:
    action: PostModifyDbSubnetGroupActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostModifyDbSubnetGroupVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostModifyDbSubnetGroupRequest:
    headers: PostModifyDbSubnetGroupHeaders = field()
    query_params: PostModifyDbSubnetGroupQueryParams = field()
