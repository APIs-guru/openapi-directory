...
var GetCopyDbSnapshotQueryParams = /** @class */ (function (_super) {
    ...
    __decorate([
        Metadata({ data: "queryParam, style=form;explode=true;name=SourceDBSnapshotIdentifier" }),
        __metadata("design:type", String)
    ], GetCopyDbSnapshotQueryParams.prototype, "sourceDbSnapshotIdentifier", void 0);
    __decorate([
        Metadata({ data: "queryParam, style=form;explode=true;name=TargetDBSnapshotIdentifier" }),
        __metadata("design:type", String)
