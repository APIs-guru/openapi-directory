...
class PostAuthorizeDbSecurityGroupIngressQueryParams:
    action: PostAuthorizeDbSecurityGroupIngressActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostAuthorizeDbSecurityGroupIngressVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostAuthorizeDbSecurityGroupIngressRequest:
    headers: PostAuthorizeDbSecurityGroupIngressHeaders = field()
    query_params: PostAuthorizeDbSecurityGroupIngressQueryParams = field()
