...
class PutSessionHeaders:
    response_content_type: Optional[str] = field(default=None, metadata={'header': { 'field_name': 'ResponseContentType', 'style': 'simple', 'explode': False }})
...
class PutSessionRequestBodySessionState:
    r"""PutSessionRequestBodySessionState
...
class PutSessionRequestBody:
    session_state: PutSessionRequestBodySessionState = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('sessionState') }})
