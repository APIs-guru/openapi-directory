...
class CheckoutLicenseHeaders:
    x_amz_target: CheckoutLicenseXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CheckoutLicenseRequest:
    headers: CheckoutLicenseHeaders = field()
    request: shared.CheckoutLicenseRequest = field(metadata={'request': { 'media_type': 'application/json' }})
