...
class GetLicenseUsageHeaders:
    ...
    x_amz_target: GetLicenseUsageXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetLicenseUsageRequest:
    headers: GetLicenseUsageHeaders = field(default=None)
    request: shared.GetLicenseUsageRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
