...
class ListLicenseManagerReportGeneratorsHeaders:
    x_amz_target: ListLicenseManagerReportGeneratorsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListLicenseManagerReportGeneratorsRequest:
    headers: ListLicenseManagerReportGeneratorsHeaders = field()
    request: shared.ListLicenseManagerReportGeneratorsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
