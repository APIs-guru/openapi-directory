...
class ListLicenseConfigurationsHeaders:
    x_amz_target: ListLicenseConfigurationsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListLicenseConfigurationsRequest:
    headers: ListLicenseConfigurationsHeaders = field()
    request: shared.ListLicenseConfigurationsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
