...
class CheckoutBorrowLicenseHeaders:
    ...
    x_amz_target: CheckoutBorrowLicenseXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CheckoutBorrowLicenseRequest:
    headers: CheckoutBorrowLicenseHeaders = field(default=None)
    request: shared.CheckoutBorrowLicenseRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
