...
class CreateGrantVersionHeaders:
    x_amz_target: CreateGrantVersionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateGrantVersionRequest:
    headers: CreateGrantVersionHeaders = field()
    request: shared.CreateGrantVersionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
