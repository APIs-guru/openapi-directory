...
class GetServiceSettingsResponse:
    ...
    license_manager_resource_share_arn: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('LicenseManagerResourceShareArn') }})
