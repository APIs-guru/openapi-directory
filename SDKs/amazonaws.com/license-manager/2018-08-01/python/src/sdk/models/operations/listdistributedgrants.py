...
class ListDistributedGrantsHeaders:
    ...
    x_amz_target: ListDistributedGrantsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ListDistributedGrantsRequest:
    headers: ListDistributedGrantsHeaders = field(default=None)
    request: shared.ListDistributedGrantsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
