...
class ListAssociationsForLicenseConfigurationHeaders:
    ...
    x_amz_target: ListAssociationsForLicenseConfigurationXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
