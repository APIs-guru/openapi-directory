...
class ListReceivedGrantsHeaders:
    x_amz_target: ListReceivedGrantsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListReceivedGrantsRequest:
    headers: ListReceivedGrantsHeaders = field()
    request: shared.ListReceivedGrantsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
