...
class GetServiceSettingsHeaders:
    x_amz_target: GetServiceSettingsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetServiceSettingsRequest:
    headers: GetServiceSettingsHeaders = field()
