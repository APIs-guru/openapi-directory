...
class ListFailuresForLicenseConfigurationOperationsHeaders:
    x_amz_target: ListFailuresForLicenseConfigurationOperationsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListFailuresForLicenseConfigurationOperationsRequest:
    headers: ListFailuresForLicenseConfigurationOperationsHeaders = field()
    request: shared.ListFailuresForLicenseConfigurationOperationsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
