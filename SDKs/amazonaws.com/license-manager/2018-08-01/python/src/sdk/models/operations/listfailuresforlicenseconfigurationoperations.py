...
class ListFailuresForLicenseConfigurationOperationsHeaders:
    ...
    x_amz_target: ListFailuresForLicenseConfigurationOperationsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
