...
class CreateTokenHeaders:
    x_amz_target: CreateTokenXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateTokenRequest:
    ...
    request: shared.CreateTokenRequest = field(metadata={'request': { 'media_type': 'application/json' }})
