...
class ListResourceInventoryHeaders:
    x_amz_target: ListResourceInventoryXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListResourceInventoryRequest:
    headers: ListResourceInventoryHeaders = field()
    request: shared.ListResourceInventoryRequest = field(metadata={'request': { 'media_type': 'application/json' }})
