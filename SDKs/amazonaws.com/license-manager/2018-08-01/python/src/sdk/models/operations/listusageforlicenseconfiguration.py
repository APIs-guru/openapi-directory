...
class ListUsageForLicenseConfigurationHeaders:
    x_amz_target: ListUsageForLicenseConfigurationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListUsageForLicenseConfigurationRequest:
    headers: ListUsageForLicenseConfigurationHeaders = field()
    request: shared.ListUsageForLicenseConfigurationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
