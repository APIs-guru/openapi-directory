...
class DeleteGrantHeaders:
    x_amz_target: DeleteGrantXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteGrantRequest:
    headers: DeleteGrantHeaders = field()
    request: shared.DeleteGrantRequest = field(metadata={'request': { 'media_type': 'application/json' }})
