...
class ListTokensHeaders:
    x_amz_target: ListTokensXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListTokensRequest:
    headers: ListTokensHeaders = field()
    request: shared.ListTokensRequest = field(metadata={'request': { 'media_type': 'application/json' }})
