...
class DeleteLicenseHeaders:
    x_amz_target: DeleteLicenseXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteLicenseRequest:
    headers: DeleteLicenseHeaders = field()
    request: shared.DeleteLicenseRequest = field(metadata={'request': { 'media_type': 'application/json' }})
