...
class DeleteLicenseHeaders:
    ...
    x_amz_target: DeleteLicenseXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeleteLicenseRequest:
    headers: DeleteLicenseHeaders = field(default=None)
    request: shared.DeleteLicenseRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class DeleteLicenseResponse:
    ...
    delete_license_response: Optional[shared.DeleteLicenseResponse] = field(default=None)
