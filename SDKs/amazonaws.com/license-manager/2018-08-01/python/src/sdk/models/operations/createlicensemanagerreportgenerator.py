...
class CreateLicenseManagerReportGeneratorHeaders:
    x_amz_target: CreateLicenseManagerReportGeneratorXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateLicenseManagerReportGeneratorRequest:
    headers: CreateLicenseManagerReportGeneratorHeaders = field()
    request: shared.CreateLicenseManagerReportGeneratorRequest = field(metadata={'request': { 'media_type': 'application/json' }})
