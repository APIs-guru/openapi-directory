...
class GetLicenseHeaders:
    ...
    x_amz_target: GetLicenseXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetLicenseRequest:
    headers: GetLicenseHeaders = field(default=None)
    request: shared.GetLicenseRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
