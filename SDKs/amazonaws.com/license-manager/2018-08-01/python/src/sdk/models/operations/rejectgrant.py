...
class RejectGrantHeaders:
    x_amz_target: RejectGrantXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RejectGrantRequest:
    headers: RejectGrantHeaders = field()
    request: shared.RejectGrantRequest = field(metadata={'request': { 'media_type': 'application/json' }})
