...
class RejectGrantHeaders:
    ...
    x_amz_target: RejectGrantXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class RejectGrantRequest:
    headers: RejectGrantHeaders = field(default=None)
    request: shared.RejectGrantRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class RejectGrantResponse:
    ...
    reject_grant_response: Optional[shared.RejectGrantResponse] = field(default=None)
