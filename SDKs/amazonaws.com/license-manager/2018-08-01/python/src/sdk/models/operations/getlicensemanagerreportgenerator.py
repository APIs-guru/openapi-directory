...
class GetLicenseManagerReportGeneratorHeaders:
    ...
    x_amz_target: GetLicenseManagerReportGeneratorXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetLicenseManagerReportGeneratorRequest:
    headers: GetLicenseManagerReportGeneratorHeaders = field(default=None)
    request: shared.GetLicenseManagerReportGeneratorRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class GetLicenseManagerReportGeneratorResponse:
    ...
    get_license_manager_report_generator_response: Optional[shared.GetLicenseManagerReportGeneratorResponse] = field(default=None)
