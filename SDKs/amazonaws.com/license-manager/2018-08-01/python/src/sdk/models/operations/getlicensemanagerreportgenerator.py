...
class GetLicenseManagerReportGeneratorHeaders:
    x_amz_target: GetLicenseManagerReportGeneratorXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetLicenseManagerReportGeneratorRequest:
    headers: GetLicenseManagerReportGeneratorHeaders = field()
    request: shared.GetLicenseManagerReportGeneratorRequest = field(metadata={'request': { 'media_type': 'application/json' }})
