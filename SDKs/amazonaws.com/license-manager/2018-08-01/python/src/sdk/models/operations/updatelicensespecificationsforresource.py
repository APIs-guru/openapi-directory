...
class UpdateLicenseSpecificationsForResourceHeaders:
    x_amz_target: UpdateLicenseSpecificationsForResourceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateLicenseSpecificationsForResourceRequest:
    headers: UpdateLicenseSpecificationsForResourceHeaders = field()
    request: shared.UpdateLicenseSpecificationsForResourceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
