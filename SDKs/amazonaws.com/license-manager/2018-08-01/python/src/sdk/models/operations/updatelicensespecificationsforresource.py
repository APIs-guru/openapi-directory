...
class UpdateLicenseSpecificationsForResourceHeaders:
    ...
    x_amz_target: UpdateLicenseSpecificationsForResourceXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateLicenseSpecificationsForResourceRequest:
    headers: UpdateLicenseSpecificationsForResourceHeaders = field(default=None)
    request: shared.UpdateLicenseSpecificationsForResourceRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateLicenseSpecificationsForResourceResponse:
    ...
    license_usage_exception: Optional[Any] = field(default=None)
    rate_limit_exceeded_exception: Optional[Any] = field(default=None)
    server_internal_exception: Optional[Any] = field(default=None)
    status_code: int = field(default=None)
    update_license_specifications_for_resource_response: Optional[dict[str, Any]] = field(default=None)
