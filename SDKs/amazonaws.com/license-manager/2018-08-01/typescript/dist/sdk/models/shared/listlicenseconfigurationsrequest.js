...
var ListLicenseConfigurationsRequest = /** @class */ (function (_super) {
    ...
    ], ListLicenseConfigurationsRequest.prototype, "filters", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=LicenseConfigurationArns" }),
        __metadata("design:type", Array)
    ], ListLicenseConfigurationsRequest.prototype, "licenseConfigurationArns", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=MaxResults" }),
        __metadata("design:type", Number)
    ], ListLicenseConfigurationsRequest.prototype, "maxResults", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=NextToken" }),
        __metadata("design:type", String)
    ], ListLicenseConfigurationsRequest.prototype, "nextToken", void 0);
