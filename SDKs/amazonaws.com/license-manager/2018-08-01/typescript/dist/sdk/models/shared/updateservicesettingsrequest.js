...
var UpdateServiceSettingsRequest = /** @class */ (function (_super) {
    ...
    ], UpdateServiceSettingsRequest.prototype, "enableCrossAccountsDiscovery", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=OrganizationConfiguration" }),
        __metadata("design:type", OrganizationConfiguration)
    ], UpdateServiceSettingsRequest.prototype, "organizationConfiguration", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=S3BucketArn" }),
        __metadata("design:type", String)
    ], UpdateServiceSettingsRequest.prototype, "s3BucketArn", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=SnsTopicArn" }),
        __metadata("design:type", String)
    ], UpdateServiceSettingsRequest.prototype, "snsTopicArn", void 0);
