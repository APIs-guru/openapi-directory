...
export class GetCostEstimationQueryParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=NextToken" })
  nextToken?: string;
}


export class GetCostEstimationHeaders extends SpeakeasyBase {
...
export class GetCostEstimationRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
