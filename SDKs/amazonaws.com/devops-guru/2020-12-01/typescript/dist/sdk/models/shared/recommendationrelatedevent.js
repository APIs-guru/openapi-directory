...
**/
var RecommendationRelatedEvent = /** @class */ (function (_super) {
    __extends(RecommendationRelatedEvent, _super);
    ...
    ], RecommendationRelatedEvent.prototype, "name", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Resources", elemType: RecommendationRelatedEventResource }),
        __metadata("design:type", Array)
    ], RecommendationRelatedEvent.prototype, "resources", void 0);
    return RecommendationRelatedEvent;
}(SpeakeasyBase));
export { RecommendationRelatedEvent };
