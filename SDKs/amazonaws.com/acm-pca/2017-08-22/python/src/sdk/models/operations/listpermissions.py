...
class ListPermissionsHeaders:
    x_amz_target: ListPermissionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListPermissionsRequest:
    headers: ListPermissionsHeaders = field()
    query_params: ListPermissionsQueryParams = field()
    request: shared.ListPermissionsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
