...
class RestoreCertificateAuthorityHeaders:
    ...
    x_amz_target: RestoreCertificateAuthorityXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class RestoreCertificateAuthorityRequest:
    headers: RestoreCertificateAuthorityHeaders = field(default=None)
    request: shared.RestoreCertificateAuthorityRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
