...
class RevokeCertificateHeaders:
    x_amz_target: RevokeCertificateXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RevokeCertificateRequest:
    headers: RevokeCertificateHeaders = field()
    request: shared.RevokeCertificateRequest = field(metadata={'request': { 'media_type': 'application/json' }})
