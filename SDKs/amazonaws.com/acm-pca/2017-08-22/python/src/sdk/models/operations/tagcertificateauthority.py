...
class TagCertificateAuthorityHeaders:
    x_amz_target: TagCertificateAuthorityXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class TagCertificateAuthorityRequest:
    headers: TagCertificateAuthorityHeaders = field()
    request: shared.TagCertificateAuthorityRequest = field(metadata={'request': { 'media_type': 'application/json' }})
