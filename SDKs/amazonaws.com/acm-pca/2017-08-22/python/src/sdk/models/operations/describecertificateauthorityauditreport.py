...
class DescribeCertificateAuthorityAuditReportHeaders:
    x_amz_target: DescribeCertificateAuthorityAuditReportXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeCertificateAuthorityAuditReportRequest:
    headers: DescribeCertificateAuthorityAuditReportHeaders = field()
    request: shared.DescribeCertificateAuthorityAuditReportRequest = field(metadata={'request': { 'media_type': 'application/json' }})
