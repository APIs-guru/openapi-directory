...
class DeletePolicyHeaders:
    x_amz_target: DeletePolicyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeletePolicyRequest:
    ...
    request: shared.DeletePolicyRequest = field(metadata={'request': { 'media_type': 'application/json' }})
