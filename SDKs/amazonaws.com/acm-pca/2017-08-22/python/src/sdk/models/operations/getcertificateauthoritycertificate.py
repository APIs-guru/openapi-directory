...
class GetCertificateAuthorityCertificateHeaders:
    x_amz_target: GetCertificateAuthorityCertificateXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetCertificateAuthorityCertificateRequest:
    headers: GetCertificateAuthorityCertificateHeaders = field()
    request: shared.GetCertificateAuthorityCertificateRequest = field(metadata={'request': { 'media_type': 'application/json' }})
