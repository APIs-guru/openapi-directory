...
class CreateCertificateAuthorityAuditReportHeaders:
    ...
    x_amz_target: CreateCertificateAuthorityAuditReportXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
