...
class CreateCertificateAuthorityHeaders:
    x_amz_target: CreateCertificateAuthorityXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateCertificateAuthorityRequest:
    headers: CreateCertificateAuthorityHeaders = field()
    request: shared.CreateCertificateAuthorityRequest = field(metadata={'request': { 'media_type': 'application/json' }})
