...
class DescribeCertificateAuthorityHeaders:
    x_amz_target: DescribeCertificateAuthorityXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeCertificateAuthorityRequest:
    headers: DescribeCertificateAuthorityHeaders = field()
    request: shared.DescribeCertificateAuthorityRequest = field(metadata={'request': { 'media_type': 'application/json' }})
