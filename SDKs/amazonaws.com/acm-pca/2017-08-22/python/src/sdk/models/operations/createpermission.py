...
class CreatePermissionHeaders:
    ...
    x_amz_target: CreatePermissionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreatePermissionRequest:
    headers: CreatePermissionHeaders = field(default=None)
    request: shared.CreatePermissionRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
