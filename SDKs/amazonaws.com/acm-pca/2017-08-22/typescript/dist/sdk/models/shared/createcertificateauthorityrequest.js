...
var CreateCertificateAuthorityRequest = /** @class */ (function (_super) {
    ...
    ], CreateCertificateAuthorityRequest.prototype, "certificateAuthorityConfiguration", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=CertificateAuthorityType" }),
        __metadata("design:type", String)
    ], CreateCertificateAuthorityRequest.prototype, "certificateAuthorityType", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=IdempotencyToken" }),
        __metadata("design:type", String)
    ], CreateCertificateAuthorityRequest.prototype, "idempotencyToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=KeyStorageSecurityStandard" }),
        __metadata("design:type", String)
    ], CreateCertificateAuthorityRequest.prototype, "keyStorageSecurityStandard", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=RevocationConfiguration" }),
        __metadata("design:type", RevocationConfiguration)
    ], CreateCertificateAuthorityRequest.prototype, "revocationConfiguration", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Tags", elemType: Tag }),
        __metadata("design:type", Array)
    ], CreateCertificateAuthorityRequest.prototype, "tags", void 0);
