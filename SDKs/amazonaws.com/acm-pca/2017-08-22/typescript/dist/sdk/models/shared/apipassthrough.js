...
**/
var ApiPassthrough = /** @class */ (function (_super) {
    __extends(ApiPassthrough, _super);
    function ApiPassthrough() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Extensions" }),
        __metadata("design:type", Extensions)
    ], ApiPassthrough.prototype, "extensions", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Subject" }),
        __metadata("design:type", Asn1Subject)
    ], ApiPassthrough.prototype, "subject", void 0);
    return ApiPassthrough;
}(SpeakeasyBase));
export { ApiPassthrough };
