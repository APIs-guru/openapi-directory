...
var CreatePermissionRequest = /** @class */ (function (_super) {
    ...
    ], CreatePermissionRequest.prototype, "actions", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=CertificateAuthorityArn" }),
        __metadata("design:type", String)
    ], CreatePermissionRequest.prototype, "certificateAuthorityArn", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Principal" }),
        __metadata("design:type", String)
    ], CreatePermissionRequest.prototype, "principal", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=SourceAccount" }),
        __metadata("design:type", String)
    ], CreatePermissionRequest.prototype, "sourceAccount", void 0);
