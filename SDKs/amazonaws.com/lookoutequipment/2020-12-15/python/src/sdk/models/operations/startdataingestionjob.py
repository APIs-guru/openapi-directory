...
class StartDataIngestionJobHeaders:
    x_amz_target: StartDataIngestionJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartDataIngestionJobRequest:
    headers: StartDataIngestionJobHeaders = field()
    request: shared.StartDataIngestionJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
