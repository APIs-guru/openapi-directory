...
class StopInferenceSchedulerHeaders:
    x_amz_target: StopInferenceSchedulerXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StopInferenceSchedulerRequest:
    headers: StopInferenceSchedulerHeaders = field()
    request: shared.StopInferenceSchedulerRequest = field(metadata={'request': { 'media_type': 'application/json' }})
