...
**/
var DataPreProcessingConfiguration = /** @class */ (function (_super) {
    __extends(DataPreProcessingConfiguration, _super);
    function DataPreProcessingConfiguration() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "json, name=TargetSamplingRate" }),
        __metadata("design:type", String)
    ], DataPreProcessingConfiguration.prototype, "targetSamplingRate", void 0);
    return DataPreProcessingConfiguration;
}(SpeakeasyBase));
export { DataPreProcessingConfiguration };
