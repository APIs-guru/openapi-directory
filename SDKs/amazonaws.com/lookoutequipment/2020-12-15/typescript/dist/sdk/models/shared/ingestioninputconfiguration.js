...
**/
var IngestionInputConfiguration = /** @class */ (function (_super) {
    __extends(IngestionInputConfiguration, _super);
    function IngestionInputConfiguration() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "json, name=S3InputConfiguration" }),
        __metadata("design:type", IngestionS3InputConfiguration)
    ], IngestionInputConfiguration.prototype, "s3InputConfiguration", void 0);
    return IngestionInputConfiguration;
}(SpeakeasyBase));
export { IngestionInputConfiguration };
