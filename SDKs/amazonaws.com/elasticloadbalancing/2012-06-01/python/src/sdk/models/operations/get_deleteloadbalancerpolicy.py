...
class GetDeleteLoadBalancerPolicyQueryParams:
    action: GetDeleteLoadBalancerPolicyActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetDeleteLoadBalancerPolicyVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteLoadBalancerPolicyRequest:
    headers: GetDeleteLoadBalancerPolicyHeaders = field()
    query_params: GetDeleteLoadBalancerPolicyQueryParams = field()
