...
class PostApplySecurityGroupsToLoadBalancerQueryParams:
    action: PostApplySecurityGroupsToLoadBalancerActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostApplySecurityGroupsToLoadBalancerVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostApplySecurityGroupsToLoadBalancerRequest:
    query_params: PostApplySecurityGroupsToLoadBalancerQueryParams = field(default=None)
    headers: PostApplySecurityGroupsToLoadBalancerHeaders = field(default=None)
