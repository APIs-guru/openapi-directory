...
class GetEnableAvailabilityZonesForLoadBalancerQueryParams:
    action: GetEnableAvailabilityZonesForLoadBalancerActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetEnableAvailabilityZonesForLoadBalancerVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetEnableAvailabilityZonesForLoadBalancerRequest:
    headers: GetEnableAvailabilityZonesForLoadBalancerHeaders = field()
    query_params: GetEnableAvailabilityZonesForLoadBalancerQueryParams = field()
