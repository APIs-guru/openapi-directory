...
class PostDescribeInstanceHealthQueryParams:
    action: PostDescribeInstanceHealthActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeInstanceHealthVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeInstanceHealthRequest:
    headers: PostDescribeInstanceHealthHeaders = field()
    query_params: PostDescribeInstanceHealthQueryParams = field()
