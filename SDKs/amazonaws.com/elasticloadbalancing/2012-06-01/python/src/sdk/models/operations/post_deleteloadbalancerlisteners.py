...
class PostDeleteLoadBalancerListenersQueryParams:
    action: PostDeleteLoadBalancerListenersActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDeleteLoadBalancerListenersVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDeleteLoadBalancerListenersRequest:
    headers: PostDeleteLoadBalancerListenersHeaders = field()
    query_params: PostDeleteLoadBalancerListenersQueryParams = field()
