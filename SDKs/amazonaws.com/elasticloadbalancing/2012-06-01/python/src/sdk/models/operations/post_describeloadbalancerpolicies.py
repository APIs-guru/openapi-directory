...
class PostDescribeLoadBalancerPoliciesQueryParams:
    action: PostDescribeLoadBalancerPoliciesActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeLoadBalancerPoliciesVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeLoadBalancerPoliciesRequest:
    headers: PostDescribeLoadBalancerPoliciesHeaders = field()
    query_params: PostDescribeLoadBalancerPoliciesQueryParams = field()
