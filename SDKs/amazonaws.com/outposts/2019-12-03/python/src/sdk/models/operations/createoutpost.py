...
class CreateOutpostRequestBody:
    ...
    site_id: str = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('SiteId') }})
...
class CreateOutpostRequest:
    headers: CreateOutpostHeaders = field()
    request: CreateOutpostRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
