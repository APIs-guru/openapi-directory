...
class CreateProjectRequestBody:
    ...
    placement_template: Optional[CreateProjectRequestBodyPlacementTemplate] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('placementTemplate') }})
