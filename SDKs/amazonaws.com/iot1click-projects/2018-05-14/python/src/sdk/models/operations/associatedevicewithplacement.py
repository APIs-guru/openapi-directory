...
class AssociateDeviceWithPlacementRequest:
    headers: AssociateDeviceWithPlacementHeaders = field()
    path_params: AssociateDeviceWithPlacementPathParams = field()
    request: AssociateDeviceWithPlacementRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
