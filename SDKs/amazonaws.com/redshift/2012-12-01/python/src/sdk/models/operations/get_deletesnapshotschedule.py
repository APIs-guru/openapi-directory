...
class GetDeleteSnapshotScheduleQueryParams:
    action: GetDeleteSnapshotScheduleActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    schedule_identifier: str = field(metadata={'query_param': { 'field_name': 'ScheduleIdentifier', 'style': 'form', 'explode': True }})
    version: GetDeleteSnapshotScheduleVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteSnapshotScheduleRequest:
    headers: GetDeleteSnapshotScheduleHeaders = field()
    query_params: GetDeleteSnapshotScheduleQueryParams = field()
