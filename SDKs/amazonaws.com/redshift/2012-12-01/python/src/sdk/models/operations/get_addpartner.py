...
class GetAddPartnerQueryParams:
    ...
    action: GetAddPartnerActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetAddPartnerVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetAddPartnerRequest:
    headers: GetAddPartnerHeaders = field()
    query_params: GetAddPartnerQueryParams = field()
