...
class GetRebootClusterQueryParams:
    action: GetRebootClusterActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    cluster_identifier: str = field(metadata={'query_param': { 'field_name': 'ClusterIdentifier', 'style': 'form', 'explode': True }})
    version: GetRebootClusterVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetRebootClusterRequest:
    headers: GetRebootClusterHeaders = field()
    query_params: GetRebootClusterQueryParams = field()
