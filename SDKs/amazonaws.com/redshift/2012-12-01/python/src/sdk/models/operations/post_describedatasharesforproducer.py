...
class PostDescribeDataSharesForProducerQueryParams:
    action: PostDescribeDataSharesForProducerActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeDataSharesForProducerVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeDataSharesForProducerRequest:
    headers: PostDescribeDataSharesForProducerHeaders = field()
    query_params: PostDescribeDataSharesForProducerQueryParams = field()
