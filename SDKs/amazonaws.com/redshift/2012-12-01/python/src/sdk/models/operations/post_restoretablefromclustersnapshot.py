...
class PostRestoreTableFromClusterSnapshotQueryParams:
    action: PostRestoreTableFromClusterSnapshotActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostRestoreTableFromClusterSnapshotVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostRestoreTableFromClusterSnapshotRequest:
    headers: PostRestoreTableFromClusterSnapshotHeaders = field()
    query_params: PostRestoreTableFromClusterSnapshotQueryParams = field()
