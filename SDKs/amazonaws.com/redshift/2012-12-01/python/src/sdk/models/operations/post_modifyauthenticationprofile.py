...
class PostModifyAuthenticationProfileQueryParams:
    action: PostModifyAuthenticationProfileActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostModifyAuthenticationProfileVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostModifyAuthenticationProfileRequest:
    headers: PostModifyAuthenticationProfileHeaders = field()
    query_params: PostModifyAuthenticationProfileQueryParams = field()
