...
class GetCreateAuthenticationProfileQueryParams:
    action: GetCreateAuthenticationProfileActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetCreateAuthenticationProfileVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetCreateAuthenticationProfileRequest:
    headers: GetCreateAuthenticationProfileHeaders = field()
    query_params: GetCreateAuthenticationProfileQueryParams = field()
