...
class GetDescribeClusterTracksQueryParams:
    action: GetDescribeClusterTracksActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetDescribeClusterTracksVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDescribeClusterTracksRequest:
    headers: GetDescribeClusterTracksHeaders = field()
    query_params: GetDescribeClusterTracksQueryParams = field()
