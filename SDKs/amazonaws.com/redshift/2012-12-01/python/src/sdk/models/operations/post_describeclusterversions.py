...
class PostDescribeClusterVersionsQueryParams:
    action: PostDescribeClusterVersionsActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: PostDescribeClusterVersionsVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeClusterVersionsRequest:
    query_params: PostDescribeClusterVersionsQueryParams = field(default=None)
    headers: PostDescribeClusterVersionsHeaders = field(default=None)
