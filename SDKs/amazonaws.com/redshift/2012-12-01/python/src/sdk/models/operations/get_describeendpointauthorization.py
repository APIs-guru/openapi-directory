...
class GetDescribeEndpointAuthorizationQueryParams:
    action: GetDescribeEndpointAuthorizationActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetDescribeEndpointAuthorizationVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDescribeEndpointAuthorizationRequest:
    headers: GetDescribeEndpointAuthorizationHeaders = field()
    query_params: GetDescribeEndpointAuthorizationQueryParams = field()
