...
class GetDeleteEndpointAccessQueryParams:
    action: GetDeleteEndpointAccessActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    endpoint_name: str = field(metadata={'query_param': { 'field_name': 'EndpointName', 'style': 'form', 'explode': True }})
    version: GetDeleteEndpointAccessVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteEndpointAccessRequest:
    headers: GetDeleteEndpointAccessHeaders = field()
    query_params: GetDeleteEndpointAccessQueryParams = field()
