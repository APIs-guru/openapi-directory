...
class GetDeleteUsageLimitQueryParams:
    action: GetDeleteUsageLimitActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    usage_limit_id: str = field(default=None, metadata={'query_param': { 'field_name': 'UsageLimitId', 'style': 'form', 'explode': True }})
    version: GetDeleteUsageLimitVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteUsageLimitRequest:
    query_params: GetDeleteUsageLimitQueryParams = field(default=None)
    headers: GetDeleteUsageLimitHeaders = field(default=None)
