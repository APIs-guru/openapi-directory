...
class PostDescribeAuthenticationProfilesQueryParams:
    action: PostDescribeAuthenticationProfilesActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeAuthenticationProfilesVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeAuthenticationProfilesRequest:
    headers: PostDescribeAuthenticationProfilesHeaders = field()
    query_params: PostDescribeAuthenticationProfilesQueryParams = field()
