...
class GetDeleteScheduledActionQueryParams:
    action: GetDeleteScheduledActionActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    scheduled_action_name: str = field(metadata={'query_param': { 'field_name': 'ScheduledActionName', 'style': 'form', 'explode': True }})
    version: GetDeleteScheduledActionVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteScheduledActionRequest:
    headers: GetDeleteScheduledActionHeaders = field()
    query_params: GetDeleteScheduledActionQueryParams = field()
