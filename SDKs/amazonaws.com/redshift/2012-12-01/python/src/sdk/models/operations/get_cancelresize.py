...
class GetCancelResizeQueryParams:
    action: GetCancelResizeActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    cluster_identifier: str = field(metadata={'query_param': { 'field_name': 'ClusterIdentifier', 'style': 'form', 'explode': True }})
    version: GetCancelResizeVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetCancelResizeRequest:
    headers: GetCancelResizeHeaders = field()
    query_params: GetCancelResizeQueryParams = field()
