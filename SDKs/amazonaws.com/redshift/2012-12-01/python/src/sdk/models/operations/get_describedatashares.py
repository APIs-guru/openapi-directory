...
class GetDescribeDataSharesQueryParams:
    action: GetDescribeDataSharesActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetDescribeDataSharesVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDescribeDataSharesRequest:
    headers: GetDescribeDataSharesHeaders = field()
    query_params: GetDescribeDataSharesQueryParams = field()
