...
class RotateSecretHeaders:
    x_amz_target: RotateSecretXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RotateSecretRequest:
    headers: RotateSecretHeaders = field()
    request: shared.RotateSecretRequest = field(metadata={'request': { 'media_type': 'application/json' }})
