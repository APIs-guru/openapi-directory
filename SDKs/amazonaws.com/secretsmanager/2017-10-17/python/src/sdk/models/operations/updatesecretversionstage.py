...
class UpdateSecretVersionStageHeaders:
    x_amz_target: UpdateSecretVersionStageXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateSecretVersionStageRequest:
    headers: UpdateSecretVersionStageHeaders = field()
    request: shared.UpdateSecretVersionStageRequest = field(metadata={'request': { 'media_type': 'application/json' }})
