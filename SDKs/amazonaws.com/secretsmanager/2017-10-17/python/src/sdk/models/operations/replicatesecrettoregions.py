...
class ReplicateSecretToRegionsHeaders:
    x_amz_target: ReplicateSecretToRegionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ReplicateSecretToRegionsRequest:
    headers: ReplicateSecretToRegionsHeaders = field()
    request: shared.ReplicateSecretToRegionsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
