...
class CreateSecretHeaders:
    ...
    x_amz_target: CreateSecretXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateSecretRequest:
    headers: CreateSecretHeaders = field(default=None)
