...
class PutSecretValueHeaders:
    x_amz_target: PutSecretValueXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutSecretValueRequest:
    headers: PutSecretValueHeaders = field()
    request: shared.PutSecretValueRequest = field(metadata={'request': { 'media_type': 'application/json' }})
