...
class ListSecretVersionIdsHeaders:
    ...
    x_amz_target: ListSecretVersionIdsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ListSecretVersionIdsRequest:
    query_params: ListSecretVersionIdsQueryParams = field(default=None)
    headers: ListSecretVersionIdsHeaders = field(default=None)
    request: shared.ListSecretVersionIdsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
