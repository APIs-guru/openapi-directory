...
class DescribeDeviceEc2InstancesRequest:
    headers: DescribeDeviceEc2InstancesHeaders = field()
    path_params: DescribeDeviceEc2InstancesPathParams = field()
    request: DescribeDeviceEc2InstancesRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
