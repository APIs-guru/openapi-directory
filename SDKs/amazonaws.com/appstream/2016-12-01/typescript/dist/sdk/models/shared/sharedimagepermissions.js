...
**/
var SharedImagePermissions = /** @class */ (function (_super) {
    __extends(SharedImagePermissions, _super);
    ...
    ], SharedImagePermissions.prototype, "imagePermissions", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=sharedAccountId" }),
        __metadata("design:type", String)
    ], SharedImagePermissions.prototype, "sharedAccountId", void 0);
    return SharedImagePermissions;
}(SpeakeasyBase));
export { SharedImagePermissions };
