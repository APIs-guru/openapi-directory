...
var UpdateDirectoryConfigRequest = /** @class */ (function (_super) {
    ...
    ], UpdateDirectoryConfigRequest.prototype, "directoryName", void 0);
    __decorate([
        Metadata({ data: "json, name=OrganizationalUnitDistinguishedNames" }),
        __metadata("design:type", Array)
    ], UpdateDirectoryConfigRequest.prototype, "organizationalUnitDistinguishedNames", void 0);
    __decorate([
        Metadata({ data: "json, name=ServiceAccountCredentials" }),
        __metadata("design:type", ServiceAccountCredentials)
    ], UpdateDirectoryConfigRequest.prototype, "serviceAccountCredentials", void 0);
