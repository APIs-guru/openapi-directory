...
class CreateUsageReportSubscriptionHeaders:
    x_amz_target: CreateUsageReportSubscriptionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateUsageReportSubscriptionRequest:
    headers: CreateUsageReportSubscriptionHeaders = field()
