...
class CreateUpdatedImageHeaders:
    x_amz_target: CreateUpdatedImageXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateUpdatedImageRequest:
    headers: CreateUpdatedImageHeaders = field()
    request: shared.CreateUpdatedImageRequest = field(metadata={'request': { 'media_type': 'application/json' }})
