...
from . import fleetattribute_enum
...
class UpdateFleetRequest:
    attributes_to_delete: Optional[List[fleetattribute_enum.FleetAttributeEnum]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'AttributesToDelete' }})
    compute_capacity: Optional[computecapacity.ComputeCapacity] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ComputeCapacity' }})
    delete_vpc_config: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'DeleteVpcConfig' }})
