...
class ExpireSessionHeaders:
    x_amz_target: ExpireSessionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ExpireSessionRequest:
    headers: ExpireSessionHeaders = field()
    request: shared.ExpireSessionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
