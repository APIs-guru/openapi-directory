...
class ListAssociatedFleetsHeaders:
    x_amz_target: ListAssociatedFleetsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListAssociatedFleetsRequest:
    headers: ListAssociatedFleetsHeaders = field()
    request: shared.ListAssociatedFleetsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
