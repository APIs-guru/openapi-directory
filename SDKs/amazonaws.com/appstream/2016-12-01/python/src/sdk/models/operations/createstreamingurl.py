...
class CreateStreamingURLHeaders:
    x_amz_target: CreateStreamingUrlxAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateStreamingURLRequest:
    headers: CreateStreamingURLHeaders = field()
    request: shared.CreateStreamingURLRequest = field(metadata={'request': { 'media_type': 'application/json' }})
