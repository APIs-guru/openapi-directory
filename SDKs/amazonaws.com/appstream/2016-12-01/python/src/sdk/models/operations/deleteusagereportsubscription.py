...
class DeleteUsageReportSubscriptionHeaders:
    ...
    x_amz_target: DeleteUsageReportSubscriptionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeleteUsageReportSubscriptionRequest:
    headers: DeleteUsageReportSubscriptionHeaders = field(default=None)
