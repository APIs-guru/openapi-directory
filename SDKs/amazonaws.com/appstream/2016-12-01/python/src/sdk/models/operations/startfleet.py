...
class StartFleetHeaders:
    x_amz_target: StartFleetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartFleetRequest:
    headers: StartFleetHeaders = field()
    request: shared.StartFleetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
