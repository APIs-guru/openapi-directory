...
class StartFleetHeaders:
    ...
    x_amz_target: StartFleetXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class StartFleetRequest:
    headers: StartFleetHeaders = field(default=None)
    request: shared.StartFleetRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class StartFleetResponse:
    ...
    start_fleet_result: Optional[dict[str, Any]] = field(default=None)
