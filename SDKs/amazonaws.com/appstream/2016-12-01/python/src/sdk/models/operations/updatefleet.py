...
class UpdateFleetHeaders:
    x_amz_target: UpdateFleetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateFleetRequest:
    headers: UpdateFleetHeaders = field()
    request: shared.UpdateFleetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
