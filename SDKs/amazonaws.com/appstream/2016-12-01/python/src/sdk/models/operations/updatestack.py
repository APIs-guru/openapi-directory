...
class UpdateStackHeaders:
    x_amz_target: UpdateStackXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateStackRequest:
    headers: UpdateStackHeaders = field()
    request: shared.UpdateStackRequest = field(metadata={'request': { 'media_type': 'application/json' }})
