...
class UpdateStackHeaders:
    ...
    x_amz_target: UpdateStackXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateStackRequest:
    headers: UpdateStackHeaders = field(default=None)
    request: shared.UpdateStackRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateStackResponse:
    ...
    update_stack_result: Optional[shared.UpdateStackResult] = field(default=None)
