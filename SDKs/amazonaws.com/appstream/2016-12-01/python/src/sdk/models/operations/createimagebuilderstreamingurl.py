...
class CreateImageBuilderStreamingURLHeaders:
    ...
    x_amz_target: CreateImageBuilderStreamingUrlxAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateImageBuilderStreamingURLRequest:
    headers: CreateImageBuilderStreamingURLHeaders = field(default=None)
    request: shared.CreateImageBuilderStreamingURLRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
