...
class DisableUserHeaders:
    x_amz_target: DisableUserXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DisableUserRequest:
    headers: DisableUserHeaders = field()
    request: shared.DisableUserRequest = field(metadata={'request': { 'media_type': 'application/json' }})
