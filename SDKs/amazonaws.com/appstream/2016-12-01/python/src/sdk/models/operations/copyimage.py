...
class CopyImageHeaders:
    x_amz_target: CopyImageXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CopyImageRequest:
    headers: CopyImageHeaders = field()
    request: shared.CopyImageRequest = field(metadata={'request': { 'media_type': 'application/json' }})
