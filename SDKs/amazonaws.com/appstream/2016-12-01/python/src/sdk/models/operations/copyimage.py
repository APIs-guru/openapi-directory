...
class CopyImageHeaders:
    ...
    x_amz_target: CopyImageXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CopyImageRequest:
    headers: CopyImageHeaders = field(default=None)
    request: shared.CopyImageRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class CopyImageResponse:
    content_type: str = field(default=None)
    copy_image_response: Optional[shared.CopyImageResponse] = field(default=None)
