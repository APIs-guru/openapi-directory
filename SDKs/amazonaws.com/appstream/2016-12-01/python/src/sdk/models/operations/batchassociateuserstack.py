...
class BatchAssociateUserStackHeaders:
    x_amz_target: BatchAssociateUserStackXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class BatchAssociateUserStackRequest:
    headers: BatchAssociateUserStackHeaders = field()
    request: shared.BatchAssociateUserStackRequest = field(metadata={'request': { 'media_type': 'application/json' }})
