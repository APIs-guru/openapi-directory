...
class ListAssociatedStacksHeaders:
    x_amz_target: ListAssociatedStacksXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListAssociatedStacksRequest:
    headers: ListAssociatedStacksHeaders = field()
    request: shared.ListAssociatedStacksRequest = field(metadata={'request': { 'media_type': 'application/json' }})
