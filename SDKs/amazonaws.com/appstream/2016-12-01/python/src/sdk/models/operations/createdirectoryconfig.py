...
class CreateDirectoryConfigHeaders:
    x_amz_target: CreateDirectoryConfigXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateDirectoryConfigRequest:
    headers: CreateDirectoryConfigHeaders = field()
    request: shared.CreateDirectoryConfigRequest = field(metadata={'request': { 'media_type': 'application/json' }})
