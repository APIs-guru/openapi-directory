...
class StopFleetHeaders:
    x_amz_target: StopFleetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StopFleetRequest:
    headers: StopFleetHeaders = field()
    request: shared.StopFleetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
