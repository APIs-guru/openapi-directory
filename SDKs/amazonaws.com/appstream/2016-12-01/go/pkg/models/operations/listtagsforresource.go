...
const (
    ListTagsForResourceXAmzTargetEnumPhotonAdminProxyServiceListTagsForResource ListTagsForResourceXAmzTargetEnum = "PhotonAdminProxyService.ListTagsForResource"
)
