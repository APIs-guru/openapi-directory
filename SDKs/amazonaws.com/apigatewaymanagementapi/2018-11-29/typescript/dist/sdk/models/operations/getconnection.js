...
var GetConnectionPathParams = /** @class */ (function (_super) {
    __extends(GetConnectionPathParams, _super);
    function GetConnectionPathParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "pathParam, style=simple;explode=false;name=connectionId" }),
        __metadata("design:type", String)
    ], GetConnectionPathParams.prototype, "connectionId", void 0);
    return GetConnectionPathParams;
}(SpeakeasyBase));
export { GetConnectionPathParams };
...
var GetConnectionRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        Metadata(),
        __metadata("design:type", GetConnectionPathParams)
    ], GetConnectionRequest.prototype, "pathParams", void 0);
    __decorate([
        Metadata(),
...
var GetConnectionResponse = /** @class */ (function (_super) {
    ...
    ], GetConnectionResponse.prototype, "forbiddenException", void 0);
    __decorate([
        Metadata(),
    ...
    __decorate([
        Metadata(),
        __metadata("design:type", Object)
    ], GetConnectionResponse.prototype, "goneException", void 0);
    __decorate([
        Metadata(),
        __metadata("design:type", Object)
    ], GetConnectionResponse.prototype, "limitExceededException", void 0);
    __decorate([
        Metadata(),
