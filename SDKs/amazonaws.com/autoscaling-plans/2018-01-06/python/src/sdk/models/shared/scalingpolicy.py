...
class ScalingPolicy:
    ...
    target_tracking_configuration: Optional[TargetTrackingConfiguration] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('TargetTrackingConfiguration') }})
