...
class UpdateScalingPlanHeaders:
    x_amz_target: UpdateScalingPlanXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateScalingPlanRequest:
    headers: UpdateScalingPlanHeaders = field()
    request: shared.UpdateScalingPlanRequest = field(metadata={'request': { 'media_type': 'application/json' }})
