...
class CreateScalingPlanHeaders:
    x_amz_target: CreateScalingPlanXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateScalingPlanRequest:
    headers: CreateScalingPlanHeaders = field()
    request: shared.CreateScalingPlanRequest = field(metadata={'request': { 'media_type': 'application/json' }})
