...
class GetRepositoryPolicyHeaders:
    x_amz_target: GetRepositoryPolicyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetRepositoryPolicyRequest:
    headers: GetRepositoryPolicyHeaders = field()
    request: shared.GetRepositoryPolicyRequest = field(metadata={'request': { 'media_type': 'application/json' }})
