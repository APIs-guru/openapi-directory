...
class PutLifecyclePolicyHeaders:
    ...
    x_amz_target: PutLifecyclePolicyXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class PutLifecyclePolicyRequest:
    headers: PutLifecyclePolicyHeaders = field(default=None)
    request: shared.PutLifecyclePolicyRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
