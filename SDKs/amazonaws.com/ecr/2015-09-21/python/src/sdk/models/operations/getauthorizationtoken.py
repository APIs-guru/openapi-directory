...
class GetAuthorizationTokenHeaders:
    ...
    x_amz_target: GetAuthorizationTokenXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
    

@dataclass
class GetAuthorizationTokenRequest:
    headers: GetAuthorizationTokenHeaders = field(default=None)
    request: shared.GetAuthorizationTokenRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
