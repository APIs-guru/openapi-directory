...
class DescribeImageScanFindingsHeaders:
    ...
    x_amz_target: DescribeImageScanFindingsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeImageScanFindingsRequest:
    query_params: DescribeImageScanFindingsQueryParams = field(default=None)
    headers: DescribeImageScanFindingsHeaders = field(default=None)
    request: shared.DescribeImageScanFindingsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
