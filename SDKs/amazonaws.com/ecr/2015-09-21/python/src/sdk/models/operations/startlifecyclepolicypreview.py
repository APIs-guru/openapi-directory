...
class StartLifecyclePolicyPreviewHeaders:
    ...
    x_amz_target: StartLifecyclePolicyPreviewXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class StartLifecyclePolicyPreviewRequest:
    headers: StartLifecyclePolicyPreviewHeaders = field(default=None)
    request: shared.StartLifecyclePolicyPreviewRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
