...
class PutReplicationConfigurationHeaders:
    x_amz_target: PutReplicationConfigurationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutReplicationConfigurationRequest:
    headers: PutReplicationConfigurationHeaders = field()
    request: shared.PutReplicationConfigurationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
