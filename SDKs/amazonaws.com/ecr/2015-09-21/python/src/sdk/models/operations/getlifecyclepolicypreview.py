...
class GetLifecyclePolicyPreviewHeaders:
    x_amz_target: GetLifecyclePolicyPreviewXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetLifecyclePolicyPreviewRequest:
    headers: GetLifecyclePolicyPreviewHeaders = field()
    query_params: GetLifecyclePolicyPreviewQueryParams = field()
    request: shared.GetLifecyclePolicyPreviewRequest = field(metadata={'request': { 'media_type': 'application/json' }})
