...
class GetRegistryPolicyHeaders:
    x_amz_target: GetRegistryPolicyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetRegistryPolicyRequest:
    headers: GetRegistryPolicyHeaders = field()
