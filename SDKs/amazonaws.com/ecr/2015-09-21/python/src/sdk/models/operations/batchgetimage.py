...
class BatchGetImageHeaders:
    x_amz_target: BatchGetImageXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class BatchGetImageRequest:
    headers: BatchGetImageHeaders = field()
    request: shared.BatchGetImageRequest = field(metadata={'request': { 'media_type': 'application/json' }})
