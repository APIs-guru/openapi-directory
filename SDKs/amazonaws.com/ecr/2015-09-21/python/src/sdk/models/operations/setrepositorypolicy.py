...
class SetRepositoryPolicyHeaders:
    x_amz_target: SetRepositoryPolicyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class SetRepositoryPolicyRequest:
    headers: SetRepositoryPolicyHeaders = field()
    request: shared.SetRepositoryPolicyRequest = field(metadata={'request': { 'media_type': 'application/json' }})
