...
class StartImageScanHeaders:
    x_amz_target: StartImageScanXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartImageScanRequest:
    headers: StartImageScanHeaders = field()
    request: shared.StartImageScanRequest = field(metadata={'request': { 'media_type': 'application/json' }})
