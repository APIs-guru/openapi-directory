...
class DeleteLifecyclePolicyHeaders:
    x_amz_target: DeleteLifecyclePolicyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteLifecyclePolicyRequest:
    headers: DeleteLifecyclePolicyHeaders = field()
    request: shared.DeleteLifecyclePolicyRequest = field(metadata={'request': { 'media_type': 'application/json' }})
