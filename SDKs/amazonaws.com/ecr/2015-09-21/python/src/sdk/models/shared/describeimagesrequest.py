...
from . import describeimagesfilter
...
class DescribeImagesRequest:
    filter: Optional[describeimagesfilter.DescribeImagesFilter] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'filter' }})
