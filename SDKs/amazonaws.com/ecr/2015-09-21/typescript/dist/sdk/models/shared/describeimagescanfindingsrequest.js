...
var DescribeImageScanFindingsRequest = /** @class */ (function (_super) {
    ...
    ], DescribeImageScanFindingsRequest.prototype, "imageId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=maxResults" }),
        __metadata("design:type", Number)
    ], DescribeImageScanFindingsRequest.prototype, "maxResults", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=nextToken" }),
        __metadata("design:type", String)
    ], DescribeImageScanFindingsRequest.prototype, "nextToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=registryId" }),
        __metadata("design:type", String)
    ], DescribeImageScanFindingsRequest.prototype, "registryId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=repositoryName" }),
        __metadata("design:type", String)
    ], DescribeImageScanFindingsRequest.prototype, "repositoryName", void 0);
