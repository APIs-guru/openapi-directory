...
class QueryForecastHeaders:
    x_amz_target: QueryForecastXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class QueryForecastRequest:
    headers: QueryForecastHeaders = field()
    request: shared.QueryForecastRequest = field(metadata={'request': { 'media_type': 'application/json' }})
