...
class CreateVaultRequest:
    path_params: CreateVaultPathParams = field(default=None)
    headers: CreateVaultHeaders = field(default=None)
    

@dataclass
class CreateVaultResponse:
    content_type: str = field(default=None)
    create_vault_output: Optional[dict[str, Any]] = field(default=None)
