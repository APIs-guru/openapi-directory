...
class InitiateVaultLockRequestBody:
    policy: Optional[InitiateVaultLockRequestBodyPolicy] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('policy') }})
    

@dataclass
class InitiateVaultLockRequest:
    headers: InitiateVaultLockHeaders = field()
    path_params: InitiateVaultLockPathParams = field()
    request: InitiateVaultLockRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
