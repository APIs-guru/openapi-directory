...
class SetVaultAccessPolicyRequestBody:
    policy: Optional[SetVaultAccessPolicyRequestBodyPolicy] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'policy' }})
    

@dataclass
class SetVaultAccessPolicyRequest:
    path_params: SetVaultAccessPolicyPathParams = field(default=None)
    headers: SetVaultAccessPolicyHeaders = field(default=None)
    request: SetVaultAccessPolicyRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
