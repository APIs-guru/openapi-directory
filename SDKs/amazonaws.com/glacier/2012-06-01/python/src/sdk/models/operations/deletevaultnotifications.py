...
@dataclass
class DeleteVaultNotificationsPathParams:
...
@dataclass
class DeleteVaultNotificationsHeaders:
...
class DeleteVaultNotificationsRequest:
    path_params: DeleteVaultNotificationsPathParams = field(default=None)
    headers: DeleteVaultNotificationsHeaders = field(default=None)
