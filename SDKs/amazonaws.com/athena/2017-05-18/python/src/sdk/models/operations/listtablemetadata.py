...
class ListTableMetadataHeaders:
    x_amz_target: ListTableMetadataXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListTableMetadataRequest:
    headers: ListTableMetadataHeaders = field()
    query_params: ListTableMetadataQueryParams = field()
    request: shared.ListTableMetadataInput = field(metadata={'request': { 'media_type': 'application/json' }})
