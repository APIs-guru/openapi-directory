...
class ListQueryExecutionsHeaders:
    x_amz_target: ListQueryExecutionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListQueryExecutionsRequest:
    headers: ListQueryExecutionsHeaders = field()
    query_params: ListQueryExecutionsQueryParams = field()
    request: shared.ListQueryExecutionsInput = field(metadata={'request': { 'media_type': 'application/json' }})
