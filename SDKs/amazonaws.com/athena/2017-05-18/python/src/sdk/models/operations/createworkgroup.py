...
class CreateWorkGroupHeaders:
    x_amz_target: CreateWorkGroupXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateWorkGroupRequest:
    headers: CreateWorkGroupHeaders = field()
    request: shared.CreateWorkGroupInput = field(metadata={'request': { 'media_type': 'application/json' }})
