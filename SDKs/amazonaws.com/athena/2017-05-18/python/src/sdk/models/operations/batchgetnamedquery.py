...
class BatchGetNamedQueryHeaders:
    ...
    x_amz_target: BatchGetNamedQueryXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class BatchGetNamedQueryRequest:
    headers: BatchGetNamedQueryHeaders = field(default=None)
    request: shared.BatchGetNamedQueryInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
