...
class DeleteNamedQueryHeaders:
    x_amz_target: DeleteNamedQueryXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteNamedQueryRequest:
    headers: DeleteNamedQueryHeaders = field()
    request: shared.DeleteNamedQueryInput = field(metadata={'request': { 'media_type': 'application/json' }})
