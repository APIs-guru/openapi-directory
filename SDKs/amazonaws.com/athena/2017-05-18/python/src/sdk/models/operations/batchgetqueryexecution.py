...
class BatchGetQueryExecutionHeaders:
    ...
    x_amz_target: BatchGetQueryExecutionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
    

@dataclass
class BatchGetQueryExecutionRequest:
    headers: BatchGetQueryExecutionHeaders = field(default=None)
    request: shared.BatchGetQueryExecutionInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
