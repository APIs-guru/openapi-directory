...
class ListDatabasesRequest:
    ...
    request: shared.ListDatabasesInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class ListDatabasesResponse:
    ...
    list_databases_output: Optional[shared.ListDatabasesOutput] = field(default=None)
