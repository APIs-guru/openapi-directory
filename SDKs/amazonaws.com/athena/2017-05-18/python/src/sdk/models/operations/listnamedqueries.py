...
class ListNamedQueriesHeaders:
    x_amz_target: ListNamedQueriesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListNamedQueriesRequest:
    headers: ListNamedQueriesHeaders = field()
    query_params: ListNamedQueriesQueryParams = field()
    request: shared.ListNamedQueriesInput = field(metadata={'request': { 'media_type': 'application/json' }})
