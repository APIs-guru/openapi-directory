...
class GetDataCatalogHeaders:
    x_amz_target: GetDataCatalogXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetDataCatalogRequest:
    headers: GetDataCatalogHeaders = field()
    request: shared.GetDataCatalogInput = field(metadata={'request': { 'media_type': 'application/json' }})
