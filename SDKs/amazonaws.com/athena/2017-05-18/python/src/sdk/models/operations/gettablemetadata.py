...
class GetTableMetadataHeaders:
    x_amz_target: GetTableMetadataXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetTableMetadataRequest:
    headers: GetTableMetadataHeaders = field()
    request: shared.GetTableMetadataInput = field(metadata={'request': { 'media_type': 'application/json' }})
