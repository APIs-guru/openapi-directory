...
export class ListPrincipalPoliciesQueryParams extends SpeakeasyBase {
...
export class ListPrincipalPoliciesHeaders extends SpeakeasyBase {
  ...
  @Metadata({ data: "header, style=simple;explode=false;name=x-amzn-iot-principal" })
