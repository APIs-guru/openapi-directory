...
export class ListProvisioningTemplateVersionsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=templateName" })
  templateName: string;
}


export class ListProvisioningTemplateVersionsQueryParams extends SpeakeasyBase {
...
export class ListProvisioningTemplateVersionsHeaders extends SpeakeasyBase {
