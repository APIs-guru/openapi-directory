...
export class ListOutgoingCertificatesQueryParams extends SpeakeasyBase {
...
export class ListOutgoingCertificatesHeaders extends SpeakeasyBase {
...
export class ListOutgoingCertificatesRequest extends SpeakeasyBase {
  @Metadata()
