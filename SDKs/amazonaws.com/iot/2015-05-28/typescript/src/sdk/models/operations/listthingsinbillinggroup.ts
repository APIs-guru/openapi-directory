...
export class ListThingsInBillingGroupPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=billingGroupName" })
  billingGroupName: string;
}


export class ListThingsInBillingGroupQueryParams extends SpeakeasyBase {
...
export class ListThingsInBillingGroupHeaders extends SpeakeasyBase {
...
export class ListThingsInBillingGroupRequest extends SpeakeasyBase {
  @Metadata()
