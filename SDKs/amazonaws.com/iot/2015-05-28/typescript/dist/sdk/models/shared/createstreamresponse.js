...
var CreateStreamResponse = /** @class */ (function (_super) {
    ...
    ], CreateStreamResponse.prototype, "description", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=streamArn" }),
        __metadata("design:type", String)
    ], CreateStreamResponse.prototype, "streamArn", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=streamId" }),
        __metadata("design:type", String)
    ], CreateStreamResponse.prototype, "streamId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=streamVersion" }),
        __metadata("design:type", Number)
    ], CreateStreamResponse.prototype, "streamVersion", void 0);
