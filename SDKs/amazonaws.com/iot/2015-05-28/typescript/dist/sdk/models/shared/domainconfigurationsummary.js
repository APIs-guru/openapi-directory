...
**/
var DomainConfigurationSummary = /** @class */ (function (_super) {
    __extends(DomainConfigurationSummary, _super);
    ...
    ], DomainConfigurationSummary.prototype, "domainConfigurationArn", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=domainConfigurationName" }),
        __metadata("design:type", String)
    ], DomainConfigurationSummary.prototype, "domainConfigurationName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=serviceType" }),
        __metadata("design:type", String)
    ], DomainConfigurationSummary.prototype, "serviceType", void 0);
    return DomainConfigurationSummary;
}(SpeakeasyBase));
export { DomainConfigurationSummary };
