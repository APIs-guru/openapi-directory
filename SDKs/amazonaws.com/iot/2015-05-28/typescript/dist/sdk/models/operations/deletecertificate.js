...
export { DeleteCertificatePathParams };
var DeleteCertificateQueryParams = /** @class */ (function (_super) {
    __extends(DeleteCertificateQueryParams, _super);
    function DeleteCertificateQueryParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=forceDelete" }),
        __metadata("design:type", Boolean)
    ], DeleteCertificateQueryParams.prototype, "forceDelete", void 0);
    return DeleteCertificateQueryParams;
}(SpeakeasyBase));
export { DeleteCertificateQueryParams };
...
var DeleteCertificateRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", DeleteCertificateQueryParams)
    ], DeleteCertificateRequest.prototype, "queryParams", void 0);
    __decorate([
        SpeakeasyMetadata(),
