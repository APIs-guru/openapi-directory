...
var CreatePolicyResponse = /** @class */ (function (_super) {
    ...
    ], CreatePolicyResponse.prototype, "policyArn", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=policyDocument" }),
        __metadata("design:type", String)
    ], CreatePolicyResponse.prototype, "policyDocument", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=policyName" }),
        __metadata("design:type", String)
    ], CreatePolicyResponse.prototype, "policyName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=policyVersionId" }),
        __metadata("design:type", String)
    ], CreatePolicyResponse.prototype, "policyVersionId", void 0);
