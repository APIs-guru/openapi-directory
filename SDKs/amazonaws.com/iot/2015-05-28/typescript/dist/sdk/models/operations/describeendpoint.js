...
var DescribeEndpointQueryParams = /** @class */ (function (_super) {
    __extends(DescribeEndpointQueryParams, _super);
    function DescribeEndpointQueryParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=endpointType" }),
        __metadata("design:type", String)
    ], DescribeEndpointQueryParams.prototype, "endpointType", void 0);
    return DescribeEndpointQueryParams;
}(SpeakeasyBase));
export { DescribeEndpointQueryParams };
...
var DescribeEndpointRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", DescribeEndpointQueryParams)
    ], DescribeEndpointRequest.prototype, "queryParams", void 0);
    __decorate([
        SpeakeasyMetadata(),
