...
var CreateOtaUpdateResponse = /** @class */ (function (_super) {
    ...
    ], CreateOtaUpdateResponse.prototype, "awsIotJobArn", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=awsIotJobId" }),
        __metadata("design:type", String)
    ], CreateOtaUpdateResponse.prototype, "awsIotJobId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=otaUpdateArn" }),
        __metadata("design:type", String)
    ], CreateOtaUpdateResponse.prototype, "otaUpdateArn", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=otaUpdateId" }),
        __metadata("design:type", String)
    ], CreateOtaUpdateResponse.prototype, "otaUpdateId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=otaUpdateStatus" }),
        __metadata("design:type", String)
    ], CreateOtaUpdateResponse.prototype, "otaUpdateStatus", void 0);
