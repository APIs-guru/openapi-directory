...
class AssociateTargetsWithJobRequest:
    headers: AssociateTargetsWithJobHeaders = field()
    path_params: AssociateTargetsWithJobPathParams = field()
    query_params: AssociateTargetsWithJobQueryParams = field()
    request: AssociateTargetsWithJobRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
