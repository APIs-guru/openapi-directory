...
class AttachThingPrincipalRequest:
    path_params: AttachThingPrincipalPathParams = field(default=None)
    headers: AttachThingPrincipalHeaders = field(default=None)
    

@dataclass
class AttachThingPrincipalResponse:
    attach_thing_principal_response: Optional[dict[str, Any]] = field(default=None)
