...
class ListPolicyPrincipalsHeaders:
    x_amzn_iot_policy: str = field(metadata={'header': { 'field_name': 'x-amzn-iot-policy', 'style': 'simple', 'explode': False }})
...
class ListPolicyPrincipalsRequest:
    headers: ListPolicyPrincipalsHeaders = field()
    query_params: ListPolicyPrincipalsQueryParams = field()
