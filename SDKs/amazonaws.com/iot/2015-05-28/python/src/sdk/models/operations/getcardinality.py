...
class GetCardinalityRequest:
    headers: GetCardinalityHeaders = field(default=None)
    request: GetCardinalityRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class GetCardinalityResponse:
    content_type: str = field(default=None)
    get_cardinality_response: Optional[shared.GetCardinalityResponse] = field(default=None)
