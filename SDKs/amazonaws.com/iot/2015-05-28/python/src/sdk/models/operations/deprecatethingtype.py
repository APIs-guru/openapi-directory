...
class DeprecateThingTypeRequestBody:
    undo_deprecate: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('undoDeprecate') }})
    

@dataclass
class DeprecateThingTypeRequest:
    headers: DeprecateThingTypeHeaders = field()
    path_params: DeprecateThingTypePathParams = field()
    request: DeprecateThingTypeRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
