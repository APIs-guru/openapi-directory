...
class AbortCriteria:
    ...
    action: AbortActionEnum = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('action') }})
    failure_type: JobExecutionFailureTypeEnum = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('failureType') }})
