...
class AttachPrincipalPolicyHeaders:
    x_amzn_iot_principal: str = field(metadata={'header': { 'field_name': 'x-amzn-iot-principal', 'style': 'simple', 'explode': False }})
...
class AttachPrincipalPolicyRequest:
    headers: AttachPrincipalPolicyHeaders = field()
    path_params: AttachPrincipalPolicyPathParams = field()
