...
class DescribeProvisioningTemplateResponse:
    ...
    pre_provisioning_hook: Optional[provisioninghook.ProvisioningHook] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'preProvisioningHook' }})
