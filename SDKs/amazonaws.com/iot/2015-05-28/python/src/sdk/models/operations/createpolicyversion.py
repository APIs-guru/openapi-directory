...
class CreatePolicyVersionRequest:
    headers: CreatePolicyVersionHeaders = field()
    path_params: CreatePolicyVersionPathParams = field()
    query_params: CreatePolicyVersionQueryParams = field()
    request: CreatePolicyVersionRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
