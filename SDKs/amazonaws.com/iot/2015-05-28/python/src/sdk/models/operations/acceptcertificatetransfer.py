...
class AcceptCertificateTransferRequest:
    headers: AcceptCertificateTransferHeaders = field()
    path_params: AcceptCertificateTransferPathParams = field()
    query_params: AcceptCertificateTransferQueryParams = field()
