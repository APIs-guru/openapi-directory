...
class CancelCertificateTransferRequest:
    path_params: CancelCertificateTransferPathParams = field(default=None)
    headers: CancelCertificateTransferHeaders = field(default=None)
