...
class DescribeAuditFindingPathParams:
    finding_id: str = field(metadata={'path_param': { 'field_name': 'findingId', 'style': 'simple', 'explode': False }})
...
class DescribeAuditFindingRequest:
    headers: DescribeAuditFindingHeaders = field()
    path_params: DescribeAuditFindingPathParams = field()
