...
class TopicRuleDestinationSummary:
    ...
    http_url_summary: Optional[HTTPURLDestinationSummary] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('httpUrlSummary') }})
    ...
    vpc_destination_summary: Optional[VpcDestinationSummary] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('vpcDestinationSummary') }})
