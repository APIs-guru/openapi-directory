...
class DisableTopicRuleRequest:
    path_params: DisableTopicRulePathParams = field(default=None)
    headers: DisableTopicRuleHeaders = field(default=None)
