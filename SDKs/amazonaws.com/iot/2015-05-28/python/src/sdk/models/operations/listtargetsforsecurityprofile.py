...
class ListTargetsForSecurityProfileRequest:
    path_params: ListTargetsForSecurityProfilePathParams = field(default=None)
    query_params: ListTargetsForSecurityProfileQueryParams = field(default=None)
    headers: ListTargetsForSecurityProfileHeaders = field(default=None)
