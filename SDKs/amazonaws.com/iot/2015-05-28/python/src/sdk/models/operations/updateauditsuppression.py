...
class UpdateAuditSuppressionRequestBody:
    ...
    resource_identifier: UpdateAuditSuppressionRequestBodyResourceIdentifier = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('resourceIdentifier') }})
...
class UpdateAuditSuppressionRequest:
    headers: UpdateAuditSuppressionHeaders = field()
    request: UpdateAuditSuppressionRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
