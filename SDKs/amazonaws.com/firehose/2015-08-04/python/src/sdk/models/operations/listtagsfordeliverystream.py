...
class ListTagsForDeliveryStreamHeaders:
    x_amz_target: ListTagsForDeliveryStreamXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListTagsForDeliveryStreamRequest:
    headers: ListTagsForDeliveryStreamHeaders = field()
    request: shared.ListTagsForDeliveryStreamInput = field(metadata={'request': { 'media_type': 'application/json' }})
