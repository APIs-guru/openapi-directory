...
class DescribeDeliveryStreamHeaders:
    ...
    x_amz_target: DescribeDeliveryStreamXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeDeliveryStreamRequest:
    headers: DescribeDeliveryStreamHeaders = field(default=None)
    request: shared.DescribeDeliveryStreamInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
