...
class PutRecordHeaders:
    x_amz_target: PutRecordXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutRecordRequest:
    ...
    request: shared.PutRecordInput = field(metadata={'request': { 'media_type': 'application/json' }})
