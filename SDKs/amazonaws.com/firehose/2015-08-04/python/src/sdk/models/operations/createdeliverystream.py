...
class CreateDeliveryStreamHeaders:
    x_amz_target: CreateDeliveryStreamXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateDeliveryStreamRequest:
    headers: CreateDeliveryStreamHeaders = field()
    request: shared.CreateDeliveryStreamInput = field(metadata={'request': { 'media_type': 'application/json' }})
