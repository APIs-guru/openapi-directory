...
class TagDeliveryStreamHeaders:
    x_amz_target: TagDeliveryStreamXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class TagDeliveryStreamRequest:
    headers: TagDeliveryStreamHeaders = field()
    request: shared.TagDeliveryStreamInput = field(metadata={'request': { 'media_type': 'application/json' }})
