...
class S3DestinationConfiguration:
    ...
    buffering_hints: Optional[bufferinghints.BufferingHints] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'BufferingHints' }})
    ...
    compression_format: Optional[compressionformat_enum.CompressionFormatEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'CompressionFormat' }})
