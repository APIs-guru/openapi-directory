...
**/
var RedshiftDestinationDescription = /** @class */ (function (_super) {
    __extends(RedshiftDestinationDescription, _super);
    ...
    ], RedshiftDestinationDescription.prototype, "cloudWatchLoggingOptions", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ClusterJDBCURL" }),
        __metadata("design:type", String)
    ], RedshiftDestinationDescription.prototype, "clusterJdbcurl", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=CopyCommand" }),
        __metadata("design:type", CopyCommand)
    ], RedshiftDestinationDescription.prototype, "copyCommand", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ProcessingConfiguration" }),
        __metadata("design:type", ProcessingConfiguration)
    ], RedshiftDestinationDescription.prototype, "processingConfiguration", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=RetryOptions" }),
        __metadata("design:type", RedshiftRetryOptions)
    ], RedshiftDestinationDescription.prototype, "retryOptions", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=RoleARN" }),
        __metadata("design:type", String)
    ], RedshiftDestinationDescription.prototype, "roleArn", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=S3BackupDescription" }),
        __metadata("design:type", S3DestinationDescription)
    ], RedshiftDestinationDescription.prototype, "s3BackupDescription", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=S3BackupMode" }),
        __metadata("design:type", String)
    ], RedshiftDestinationDescription.prototype, "s3BackupMode", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=S3DestinationDescription" }),
        __metadata("design:type", S3DestinationDescription)
    ], RedshiftDestinationDescription.prototype, "s3DestinationDescription", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Username" }),
        __metadata("design:type", String)
    ], RedshiftDestinationDescription.prototype, "username", void 0);
    return RedshiftDestinationDescription;
}(SpeakeasyBase));
export { RedshiftDestinationDescription };
