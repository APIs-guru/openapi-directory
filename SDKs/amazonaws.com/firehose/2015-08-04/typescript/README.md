...
import { CreateDeliveryStreamRequest, CreateDeliveryStreamResponse } from "openapi/src/sdk/models/operations";
...
sdk.sdk.createDeliveryStream(req).then((res: CreateDeliveryStreamResponse | AxiosError) => {
   // handle response
});
```
