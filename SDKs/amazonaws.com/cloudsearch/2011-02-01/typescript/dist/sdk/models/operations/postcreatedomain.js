...
(function (PostCreateDomainVersionEnum) {
    PostCreateDomainVersionEnum["TwoThousandAndEleven0201"] = "2011-02-01";
...
var PostCreateDomainHeaders = /** @class */ (function (_super) {
    __extends(PostCreateDomainHeaders, _super);
    function PostCreateDomainHeaders() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "header, style=simple;explode=false;name=X-Amz-Algorithm" }),
        __metadata("design:type", String)
    ], PostCreateDomainHeaders.prototype, "xAmzAlgorithm", void 0);
    __decorate([
        Metadata({ data: "header, style=simple;explode=false;name=X-Amz-Content-Sha256" }),
        __metadata("design:type", String)
    ], PostCreateDomainHeaders.prototype, "xAmzContentSha256", void 0);
    __decorate([
        Metadata({ data: "header, style=simple;explode=false;name=X-Amz-Credential" }),
        __metadata("design:type", String)
    ], PostCreateDomainHeaders.prototype, "xAmzCredential", void 0);
    __decorate([
        Metadata({ data: "header, style=simple;explode=false;name=X-Amz-Date" }),
        __metadata("design:type", String)
    ], PostCreateDomainHeaders.prototype, "xAmzDate", void 0);
    __decorate([
        Metadata({ data: "header, style=simple;explode=false;name=X-Amz-Security-Token" }),
        __metadata("design:type", String)
    ], PostCreateDomainHeaders.prototype, "xAmzSecurityToken", void 0);
    __decorate([
        Metadata({ data: "header, style=simple;explode=false;name=X-Amz-Signature" }),
        __metadata("design:type", String)
    ], PostCreateDomainHeaders.prototype, "xAmzSignature", void 0);
    __decorate([
        Metadata({ data: "header, style=simple;explode=false;name=X-Amz-SignedHeaders" }),
        __metadata("design:type", String)
    ], PostCreateDomainHeaders.prototype, "xAmzSignedHeaders", void 0);
    return PostCreateDomainHeaders;
}(SpeakeasyBase));
export { PostCreateDomainHeaders };
var PostCreateDomainRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        Metadata(),
        __metadata("design:type", PostCreateDomainHeaders)
    ], PostCreateDomainRequest.prototype, "headers", void 0);
    __decorate([
