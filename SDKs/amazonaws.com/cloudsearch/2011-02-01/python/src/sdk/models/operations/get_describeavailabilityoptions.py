...
class GetDescribeAvailabilityOptionsQueryParams:
    action: GetDescribeAvailabilityOptionsActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    domain_name: str = field(metadata={'query_param': { 'field_name': 'DomainName', 'style': 'form', 'explode': True }})
    version: GetDescribeAvailabilityOptionsVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDescribeAvailabilityOptionsRequest:
    headers: GetDescribeAvailabilityOptionsHeaders = field()
    query_params: GetDescribeAvailabilityOptionsQueryParams = field()
