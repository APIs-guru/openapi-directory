...
class PostDescribeScalingParametersQueryParams:
    action: PostDescribeScalingParametersActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeScalingParametersVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeScalingParametersRequest:
    headers: PostDescribeScalingParametersHeaders = field()
    query_params: PostDescribeScalingParametersQueryParams = field()
