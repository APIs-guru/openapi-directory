...
class PostDefineAnalysisSchemeQueryParams:
    action: PostDefineAnalysisSchemeActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDefineAnalysisSchemeVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDefineAnalysisSchemeRequest:
    headers: PostDefineAnalysisSchemeHeaders = field()
    query_params: PostDefineAnalysisSchemeQueryParams = field()
