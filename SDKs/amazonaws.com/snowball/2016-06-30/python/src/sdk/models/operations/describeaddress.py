...
class DescribeAddressHeaders:
    ...
    x_amz_target: DescribeAddressXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeAddressRequest:
    headers: DescribeAddressHeaders = field(default=None)
    request: shared.DescribeAddressRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
