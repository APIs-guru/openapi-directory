...
class CancelJobHeaders:
    x_amz_target: CancelJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CancelJobRequest:
    ...
    request: shared.CancelJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
