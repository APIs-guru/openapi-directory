...
class ListLongTermPricingHeaders:
    ...
    x_amz_target: ListLongTermPricingXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ListLongTermPricingRequest:
    headers: ListLongTermPricingHeaders = field(default=None)
    request: shared.ListLongTermPricingRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
