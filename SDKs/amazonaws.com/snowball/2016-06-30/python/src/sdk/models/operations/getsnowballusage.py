...
class GetSnowballUsageHeaders:
    x_amz_target: GetSnowballUsageXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetSnowballUsageRequest:
    headers: GetSnowballUsageHeaders = field()
