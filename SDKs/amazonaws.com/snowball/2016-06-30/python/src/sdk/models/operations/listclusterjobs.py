...
class ListClusterJobsHeaders:
    x_amz_target: ListClusterJobsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListClusterJobsRequest:
    headers: ListClusterJobsHeaders = field()
    request: shared.ListClusterJobsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
