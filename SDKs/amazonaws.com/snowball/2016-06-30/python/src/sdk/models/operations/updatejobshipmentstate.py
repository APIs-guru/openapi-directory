...
class UpdateJobShipmentStateHeaders:
    x_amz_target: UpdateJobShipmentStateXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateJobShipmentStateRequest:
    headers: UpdateJobShipmentStateHeaders = field()
    request: shared.UpdateJobShipmentStateRequest = field(metadata={'request': { 'media_type': 'application/json' }})
