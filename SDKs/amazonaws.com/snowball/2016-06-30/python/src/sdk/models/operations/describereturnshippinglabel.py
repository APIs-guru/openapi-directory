...
class DescribeReturnShippingLabelHeaders:
    x_amz_target: DescribeReturnShippingLabelXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeReturnShippingLabelRequest:
    headers: DescribeReturnShippingLabelHeaders = field()
    request: shared.DescribeReturnShippingLabelRequest = field(metadata={'request': { 'media_type': 'application/json' }})
