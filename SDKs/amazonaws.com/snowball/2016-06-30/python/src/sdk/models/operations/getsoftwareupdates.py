...
class GetSoftwareUpdatesHeaders:
    x_amz_target: GetSoftwareUpdatesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetSoftwareUpdatesRequest:
    headers: GetSoftwareUpdatesHeaders = field()
    request: shared.GetSoftwareUpdatesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
