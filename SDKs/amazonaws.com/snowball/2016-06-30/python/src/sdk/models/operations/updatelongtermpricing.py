...
class UpdateLongTermPricingHeaders:
    ...
    x_amz_target: UpdateLongTermPricingXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateLongTermPricingRequest:
    headers: UpdateLongTermPricingHeaders = field(default=None)
    request: shared.UpdateLongTermPricingRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
