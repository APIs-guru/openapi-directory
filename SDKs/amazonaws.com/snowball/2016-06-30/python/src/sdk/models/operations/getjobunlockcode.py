...
class GetJobUnlockCodeHeaders:
    x_amz_target: GetJobUnlockCodeXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetJobUnlockCodeRequest:
    headers: GetJobUnlockCodeHeaders = field()
    request: shared.GetJobUnlockCodeRequest = field(metadata={'request': { 'media_type': 'application/json' }})
