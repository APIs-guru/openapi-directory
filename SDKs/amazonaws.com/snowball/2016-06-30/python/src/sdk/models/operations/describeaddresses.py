...
class DescribeAddressesHeaders:
    ...
    x_amz_target: DescribeAddressesXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeAddressesRequest:
    query_params: DescribeAddressesQueryParams = field(default=None)
    headers: DescribeAddressesHeaders = field(default=None)
    request: shared.DescribeAddressesRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
