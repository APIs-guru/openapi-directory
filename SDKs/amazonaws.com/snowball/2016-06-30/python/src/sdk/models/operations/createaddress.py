...
class CreateAddressHeaders:
    ...
    x_amz_target: CreateAddressXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateAddressRequest:
    headers: CreateAddressHeaders = field(default=None)
    request: shared.CreateAddressRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
