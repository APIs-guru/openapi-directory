...
class CreateJobHeaders:
    x_amz_target: CreateJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateJobRequest:
    ...
    request: shared.CreateJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
