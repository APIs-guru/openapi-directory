...
class GetRateBasedRuleHeaders:
    x_amz_target: GetRateBasedRuleXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetRateBasedRuleRequest:
    headers: GetRateBasedRuleHeaders = field()
    request: shared.GetRateBasedRuleRequest = field(metadata={'request': { 'media_type': 'application/json' }})
