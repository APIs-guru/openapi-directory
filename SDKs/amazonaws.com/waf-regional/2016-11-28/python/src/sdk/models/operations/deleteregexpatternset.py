...
class DeleteRegexPatternSetHeaders:
    x_amz_target: DeleteRegexPatternSetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteRegexPatternSetRequest:
    headers: DeleteRegexPatternSetHeaders = field()
    request: shared.DeleteRegexPatternSetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
