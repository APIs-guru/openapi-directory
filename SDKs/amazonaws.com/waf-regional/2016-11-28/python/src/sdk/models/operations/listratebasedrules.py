...
class ListRateBasedRulesHeaders:
    x_amz_target: ListRateBasedRulesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListRateBasedRulesRequest:
    headers: ListRateBasedRulesHeaders = field()
    request: shared.ListRateBasedRulesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
