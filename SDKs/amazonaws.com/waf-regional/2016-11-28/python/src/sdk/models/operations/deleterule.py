...
class DeleteRuleHeaders:
    ...
    x_amz_target: DeleteRuleXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeleteRuleRequest:
    headers: DeleteRuleHeaders = field(default=None)
    request: shared.DeleteRuleRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
