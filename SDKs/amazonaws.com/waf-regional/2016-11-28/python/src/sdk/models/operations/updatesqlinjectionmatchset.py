...
class UpdateSQLInjectionMatchSetHeaders:
    x_amz_target: UpdateSQLInjectionMatchSetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateSQLInjectionMatchSetRequest:
    headers: UpdateSQLInjectionMatchSetHeaders = field()
    request: shared.UpdateSQLInjectionMatchSetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
