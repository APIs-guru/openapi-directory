...
class CreateRegexMatchSetHeaders:
    ...
    x_amz_target: CreateRegexMatchSetXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateRegexMatchSetRequest:
    headers: CreateRegexMatchSetHeaders = field(default=None)
    request: shared.CreateRegexMatchSetRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
