...
class DeleteSQLInjectionMatchSetHeaders:
    x_amz_target: DeleteSQLInjectionMatchSetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteSQLInjectionMatchSetRequest:
    headers: DeleteSQLInjectionMatchSetHeaders = field()
    request: shared.DeleteSQLInjectionMatchSetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
