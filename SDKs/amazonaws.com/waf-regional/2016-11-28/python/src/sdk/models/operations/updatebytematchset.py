...
class UpdateByteMatchSetHeaders:
    x_amz_target: UpdateByteMatchSetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateByteMatchSetRequest:
    headers: UpdateByteMatchSetHeaders = field()
    request: shared.UpdateByteMatchSetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
