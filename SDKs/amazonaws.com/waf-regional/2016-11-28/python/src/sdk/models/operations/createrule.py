...
class CreateRuleXAmzTargetEnum(str, Enum):
    AWSWAF_REGIONAL_20161128_CREATE_RULE = "AWSWAF_Regional_20161128.CreateRule"
...
class CreateRuleHeaders:
    ...
    x_amz_target: CreateRuleXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateRuleRequest:
    headers: CreateRuleHeaders = field(default=None)
    request: shared.CreateRuleRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class CreateRuleResponse:
    content_type: str = field(default=None)
    create_rule_response: Optional[shared.CreateRuleResponse] = field(default=None)
