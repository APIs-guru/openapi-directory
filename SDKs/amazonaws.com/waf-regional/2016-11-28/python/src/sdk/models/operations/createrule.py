...
class CreateRuleHeaders:
    x_amz_target: CreateRuleXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateRuleRequest:
    headers: CreateRuleHeaders = field()
    request: shared.CreateRuleRequest = field(metadata={'request': { 'media_type': 'application/json' }})
