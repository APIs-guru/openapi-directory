...
class RegexMatchSet:
    ...
    regex_match_set_id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('RegexMatchSetId') }})
    regex_match_tuples: Optional[List[RegexMatchTuple]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('RegexMatchTuples') }})
