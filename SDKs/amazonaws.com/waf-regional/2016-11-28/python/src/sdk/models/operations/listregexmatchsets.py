...
class ListRegexMatchSetsHeaders:
    x_amz_target: ListRegexMatchSetsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListRegexMatchSetsRequest:
    headers: ListRegexMatchSetsHeaders = field()
    request: shared.ListRegexMatchSetsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
