...
class DisassociateWebACLHeaders:
    x_amz_target: DisassociateWebAclxAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DisassociateWebACLRequest:
    headers: DisassociateWebACLHeaders = field()
    request: shared.DisassociateWebACLRequest = field(metadata={'request': { 'media_type': 'application/json' }})
