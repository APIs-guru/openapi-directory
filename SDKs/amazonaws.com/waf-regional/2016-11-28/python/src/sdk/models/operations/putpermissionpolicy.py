...
class PutPermissionPolicyHeaders:
    x_amz_target: PutPermissionPolicyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutPermissionPolicyRequest:
    headers: PutPermissionPolicyHeaders = field()
    request: shared.PutPermissionPolicyRequest = field(metadata={'request': { 'media_type': 'application/json' }})
