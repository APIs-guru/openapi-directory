...
class CreateRuleGroupHeaders:
    x_amz_target: CreateRuleGroupXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateRuleGroupRequest:
    headers: CreateRuleGroupHeaders = field()
    request: shared.CreateRuleGroupRequest = field(metadata={'request': { 'media_type': 'application/json' }})
