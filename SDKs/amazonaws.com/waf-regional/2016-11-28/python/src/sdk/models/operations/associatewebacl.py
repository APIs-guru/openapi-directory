...
class AssociateWebACLHeaders:
    x_amz_target: AssociateWebAclxAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AssociateWebACLRequest:
    headers: AssociateWebACLHeaders = field()
    request: shared.AssociateWebACLRequest = field(metadata={'request': { 'media_type': 'application/json' }})
