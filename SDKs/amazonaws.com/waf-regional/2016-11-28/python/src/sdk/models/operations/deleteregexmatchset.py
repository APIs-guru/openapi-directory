...
class DeleteRegexMatchSetHeaders:
    x_amz_target: DeleteRegexMatchSetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteRegexMatchSetRequest:
    headers: DeleteRegexMatchSetHeaders = field()
    request: shared.DeleteRegexMatchSetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
