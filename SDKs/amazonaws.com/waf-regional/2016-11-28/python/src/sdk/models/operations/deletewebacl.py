...
class DeleteWebACLHeaders:
    x_amz_target: DeleteWebAclxAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteWebACLRequest:
    headers: DeleteWebACLHeaders = field()
    request: shared.DeleteWebACLRequest = field(metadata={'request': { 'media_type': 'application/json' }})
