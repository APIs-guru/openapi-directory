...
class GetXSSMatchSetHeaders:
    x_amz_target: GetXSSMatchSetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetXSSMatchSetRequest:
    headers: GetXSSMatchSetHeaders = field()
    request: shared.GetXSSMatchSetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
