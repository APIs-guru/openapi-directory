...
class UpdateGeoMatchSetHeaders:
    x_amz_target: UpdateGeoMatchSetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateGeoMatchSetRequest:
    headers: UpdateGeoMatchSetHeaders = field()
    request: shared.UpdateGeoMatchSetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
