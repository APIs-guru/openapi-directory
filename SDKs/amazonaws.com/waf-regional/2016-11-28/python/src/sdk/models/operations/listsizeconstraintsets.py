...
class ListSizeConstraintSetsHeaders:
    x_amz_target: ListSizeConstraintSetsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListSizeConstraintSetsRequest:
    headers: ListSizeConstraintSetsHeaders = field()
    request: shared.ListSizeConstraintSetsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
