...
class UpdateRegexPatternSetXAmzTargetEnum(str, Enum):
    AWSWAF_REGIONAL_20161128_UPDATE_REGEX_PATTERN_SET = "AWSWAF_Regional_20161128.UpdateRegexPatternSet"


@dataclass
class UpdateRegexPatternSetHeaders:
    x_amz_target: UpdateRegexPatternSetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateRegexPatternSetRequest:
    headers: UpdateRegexPatternSetHeaders = field()
    request: shared.UpdateRegexPatternSetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
