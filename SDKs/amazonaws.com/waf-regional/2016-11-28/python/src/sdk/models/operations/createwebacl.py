...
class CreateWebACLHeaders:
    x_amz_target: CreateWebAclxAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateWebACLRequest:
    headers: CreateWebACLHeaders = field()
    request: shared.CreateWebACLRequest = field(metadata={'request': { 'media_type': 'application/json' }})
