...
class CreateWebACLHeaders:
    ...
    x_amz_target: CreateWebAclxAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateWebACLRequest:
    headers: CreateWebACLHeaders = field(default=None)
    request: shared.CreateWebACLRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class CreateWebACLResponse:
    content_type: str = field(default=None)
    create_web_acl_response: Optional[shared.CreateWebACLResponse] = field(default=None)
