...
class ListXSSMatchSetsHeaders:
    x_amz_target: ListXSSMatchSetsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListXSSMatchSetsRequest:
    headers: ListXSSMatchSetsHeaders = field()
    request: shared.ListXSSMatchSetsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
