...
class ListGeoMatchSetsHeaders:
    x_amz_target: ListGeoMatchSetsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListGeoMatchSetsRequest:
    headers: ListGeoMatchSetsHeaders = field()
    request: shared.ListGeoMatchSetsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
