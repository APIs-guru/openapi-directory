...
class CreateSizeConstraintSetHeaders:
    x_amz_target: CreateSizeConstraintSetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateSizeConstraintSetRequest:
    headers: CreateSizeConstraintSetHeaders = field()
    request: shared.CreateSizeConstraintSetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
