...
const (
    CreateRegexPatternSetXAmzTargetEnumAwswafRegional20161128CreateRegexPatternSet CreateRegexPatternSetXAmzTargetEnum = "AWSWAF_Regional_20161128.CreateRegexPatternSet"
)
