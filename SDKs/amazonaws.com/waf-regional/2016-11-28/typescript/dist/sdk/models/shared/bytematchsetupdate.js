...
**/
var ByteMatchSetUpdate = /** @class */ (function (_super) {
    __extends(ByteMatchSetUpdate, _super);
    ...
    ], ByteMatchSetUpdate.prototype, "action", void 0);
    __decorate([
        Metadata({ data: "json, name=ByteMatchTuple" }),
        __metadata("design:type", ByteMatchTuple)
    ], ByteMatchSetUpdate.prototype, "byteMatchTuple", void 0);
    return ByteMatchSetUpdate;
}(SpeakeasyBase));
export { ByteMatchSetUpdate };
