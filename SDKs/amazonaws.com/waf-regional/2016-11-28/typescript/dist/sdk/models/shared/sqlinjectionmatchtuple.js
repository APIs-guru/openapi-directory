...
**/
var SqlInjectionMatchTuple = /** @class */ (function (_super) {
    __extends(SqlInjectionMatchTuple, _super);
    ...
    ], SqlInjectionMatchTuple.prototype, "fieldToMatch", void 0);
    __decorate([
        Metadata({ data: "json, name=TextTransformation" }),
        __metadata("design:type", String)
    ], SqlInjectionMatchTuple.prototype, "textTransformation", void 0);
    return SqlInjectionMatchTuple;
}(SpeakeasyBase));
export { SqlInjectionMatchTuple };
