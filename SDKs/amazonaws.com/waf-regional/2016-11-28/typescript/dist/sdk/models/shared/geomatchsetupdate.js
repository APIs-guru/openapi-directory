...
**/
var GeoMatchSetUpdate = /** @class */ (function (_super) {
    __extends(GeoMatchSetUpdate, _super);
    ...
    ], GeoMatchSetUpdate.prototype, "action", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=GeoMatchConstraint" }),
        __metadata("design:type", GeoMatchConstraint)
    ], GeoMatchSetUpdate.prototype, "geoMatchConstraint", void 0);
    return GeoMatchSetUpdate;
}(SpeakeasyBase));
export { GeoMatchSetUpdate };
