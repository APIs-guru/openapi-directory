...
class ListComplianceStatusHeaders:
    x_amz_target: ListComplianceStatusXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListComplianceStatusRequest:
    headers: ListComplianceStatusHeaders = field()
    query_params: ListComplianceStatusQueryParams = field()
    request: shared.ListComplianceStatusRequest = field(metadata={'request': { 'media_type': 'application/json' }})
