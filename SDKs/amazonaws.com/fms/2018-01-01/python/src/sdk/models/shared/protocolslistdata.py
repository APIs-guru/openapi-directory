...
class ProtocolsListData:
    ...
    previous_protocols_list: Optional[dict[str, List[str]]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'PreviousProtocolsList' }})
    protocols_list: List[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ProtocolsList' }})
