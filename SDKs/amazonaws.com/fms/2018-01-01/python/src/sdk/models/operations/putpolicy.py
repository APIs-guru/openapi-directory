...
class PutPolicyHeaders:
    x_amz_target: PutPolicyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutPolicyRequest:
    headers: PutPolicyHeaders = field()
    request: shared.PutPolicyRequest = field(metadata={'request': { 'media_type': 'application/json' }})
