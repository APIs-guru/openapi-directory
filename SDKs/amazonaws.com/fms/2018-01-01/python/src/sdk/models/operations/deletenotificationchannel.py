...
class DeleteNotificationChannelHeaders:
    x_amz_target: DeleteNotificationChannelXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteNotificationChannelRequest:
    headers: DeleteNotificationChannelHeaders = field()
