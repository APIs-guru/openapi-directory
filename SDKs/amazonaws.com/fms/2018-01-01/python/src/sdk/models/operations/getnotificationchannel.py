...
class GetNotificationChannelHeaders:
    ...
    x_amz_target: GetNotificationChannelXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetNotificationChannelRequest:
    headers: GetNotificationChannelHeaders = field(default=None)
