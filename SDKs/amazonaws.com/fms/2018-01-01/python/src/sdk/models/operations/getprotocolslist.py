...
class GetProtocolsListHeaders:
    x_amz_target: GetProtocolsListXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetProtocolsListRequest:
    headers: GetProtocolsListHeaders = field()
    request: shared.GetProtocolsListRequest = field(metadata={'request': { 'media_type': 'application/json' }})
