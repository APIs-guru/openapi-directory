...
class AssociateAdminAccountHeaders:
    x_amz_target: AssociateAdminAccountXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AssociateAdminAccountRequest:
    headers: AssociateAdminAccountHeaders = field()
    request: shared.AssociateAdminAccountRequest = field(metadata={'request': { 'media_type': 'application/json' }})
