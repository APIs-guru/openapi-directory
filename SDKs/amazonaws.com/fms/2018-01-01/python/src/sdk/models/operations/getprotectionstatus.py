...
class GetProtectionStatusHeaders:
    x_amz_target: GetProtectionStatusXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetProtectionStatusRequest:
    headers: GetProtectionStatusHeaders = field()
    request: shared.GetProtectionStatusRequest = field(metadata={'request': { 'media_type': 'application/json' }})
