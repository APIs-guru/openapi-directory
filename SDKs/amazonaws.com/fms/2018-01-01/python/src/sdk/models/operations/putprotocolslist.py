...
class PutProtocolsListHeaders:
    x_amz_target: PutProtocolsListXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutProtocolsListRequest:
    headers: PutProtocolsListHeaders = field()
    request: shared.PutProtocolsListRequest = field(metadata={'request': { 'media_type': 'application/json' }})
