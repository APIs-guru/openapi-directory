...
class PostIncreaseNodeGroupsInGlobalReplicationGroupQueryParams:
    action: PostIncreaseNodeGroupsInGlobalReplicationGroupActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostIncreaseNodeGroupsInGlobalReplicationGroupVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostIncreaseNodeGroupsInGlobalReplicationGroupRequest:
    headers: PostIncreaseNodeGroupsInGlobalReplicationGroupHeaders = field()
    query_params: PostIncreaseNodeGroupsInGlobalReplicationGroupQueryParams = field()
