...
class PostCreateGlobalReplicationGroupQueryParams:
    action: PostCreateGlobalReplicationGroupActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostCreateGlobalReplicationGroupVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostCreateGlobalReplicationGroupRequest:
    headers: PostCreateGlobalReplicationGroupHeaders = field()
    query_params: PostCreateGlobalReplicationGroupQueryParams = field()
