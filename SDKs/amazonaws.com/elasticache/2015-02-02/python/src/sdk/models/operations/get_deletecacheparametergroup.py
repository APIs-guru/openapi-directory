...
class GetDeleteCacheParameterGroupQueryParams:
    action: GetDeleteCacheParameterGroupActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetDeleteCacheParameterGroupVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteCacheParameterGroupRequest:
    query_params: GetDeleteCacheParameterGroupQueryParams = field(default=None)
    headers: GetDeleteCacheParameterGroupHeaders = field(default=None)
