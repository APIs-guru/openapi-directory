...
class PostDescribeEventsQueryParams:
    action: PostDescribeEventsActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeEventsVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeEventsRequest:
    headers: PostDescribeEventsHeaders = field()
    query_params: PostDescribeEventsQueryParams = field()
