...
class GetCompleteMigrationQueryParams:
    action: GetCompleteMigrationActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    replication_group_id: str = field(metadata={'query_param': { 'field_name': 'ReplicationGroupId', 'style': 'form', 'explode': True }})
    version: GetCompleteMigrationVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetCompleteMigrationRequest:
    headers: GetCompleteMigrationHeaders = field()
    query_params: GetCompleteMigrationQueryParams = field()
