...
class PostModifyReplicationGroupShardConfigurationQueryParams:
    action: PostModifyReplicationGroupShardConfigurationActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostModifyReplicationGroupShardConfigurationVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostModifyReplicationGroupShardConfigurationRequest:
    headers: PostModifyReplicationGroupShardConfigurationHeaders = field()
    query_params: PostModifyReplicationGroupShardConfigurationQueryParams = field()
