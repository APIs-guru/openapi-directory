...
class GetDescribeReplicationGroupsQueryParams:
    action: GetDescribeReplicationGroupsActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetDescribeReplicationGroupsVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDescribeReplicationGroupsRequest:
    headers: GetDescribeReplicationGroupsHeaders = field()
    query_params: GetDescribeReplicationGroupsQueryParams = field()
