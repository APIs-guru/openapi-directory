...
class DescribePipelinesHeaders:
    ...
    x_amz_target: DescribePipelinesXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribePipelinesRequest:
    headers: DescribePipelinesHeaders = field(default=None)
    request: shared.DescribePipelinesInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
