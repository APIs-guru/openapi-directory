...
class ReportTaskRunnerHeartbeatHeaders:
    x_amz_target: ReportTaskRunnerHeartbeatXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ReportTaskRunnerHeartbeatRequest:
    headers: ReportTaskRunnerHeartbeatHeaders = field()
    request: shared.ReportTaskRunnerHeartbeatInput = field(metadata={'request': { 'media_type': 'application/json' }})
