...
class SetTaskStatusHeaders:
    ...
    x_amz_target: SetTaskStatusXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class SetTaskStatusRequest:
    headers: SetTaskStatusHeaders = field(default=None)
    request: shared.SetTaskStatusInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class SetTaskStatusResponse:
    ...
    set_task_status_output: Optional[dict[str, Any]] = field(default=None)
