...
class SetTaskStatusHeaders:
    x_amz_target: SetTaskStatusXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class SetTaskStatusRequest:
    headers: SetTaskStatusHeaders = field()
    request: shared.SetTaskStatusInput = field(metadata={'request': { 'media_type': 'application/json' }})
