...
class PutPipelineDefinitionHeaders:
    x_amz_target: PutPipelineDefinitionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutPipelineDefinitionRequest:
    headers: PutPipelineDefinitionHeaders = field()
    request: shared.PutPipelineDefinitionInput = field(metadata={'request': { 'media_type': 'application/json' }})
