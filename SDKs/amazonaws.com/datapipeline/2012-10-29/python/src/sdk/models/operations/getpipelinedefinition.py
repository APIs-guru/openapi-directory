...
class GetPipelineDefinitionHeaders:
    x_amz_target: GetPipelineDefinitionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetPipelineDefinitionRequest:
    headers: GetPipelineDefinitionHeaders = field()
    request: shared.GetPipelineDefinitionInput = field(metadata={'request': { 'media_type': 'application/json' }})
