...
class QueryObjectsHeaders:
    x_amz_target: QueryObjectsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class QueryObjectsRequest:
    headers: QueryObjectsHeaders = field()
    query_params: QueryObjectsQueryParams = field()
    request: shared.QueryObjectsInput = field(metadata={'request': { 'media_type': 'application/json' }})
