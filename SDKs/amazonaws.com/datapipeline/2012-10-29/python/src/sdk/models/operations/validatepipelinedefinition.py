...
class ValidatePipelineDefinitionHeaders:
    ...
    x_amz_target: ValidatePipelineDefinitionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
    

@dataclass
class ValidatePipelineDefinitionRequest:
    headers: ValidatePipelineDefinitionHeaders = field(default=None)
    request: shared.ValidatePipelineDefinitionInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class ValidatePipelineDefinitionResponse:
    ...
    validate_pipeline_definition_output: Optional[shared.ValidatePipelineDefinitionOutput] = field(default=None)
