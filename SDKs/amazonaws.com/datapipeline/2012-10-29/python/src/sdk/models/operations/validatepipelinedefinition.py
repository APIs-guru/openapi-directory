...
class ValidatePipelineDefinitionHeaders:
    x_amz_target: ValidatePipelineDefinitionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ValidatePipelineDefinitionRequest:
    headers: ValidatePipelineDefinitionHeaders = field()
    request: shared.ValidatePipelineDefinitionInput = field(metadata={'request': { 'media_type': 'application/json' }})
