...
class ActivatePipelineHeaders:
    ...
    x_amz_target: ActivatePipelineXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ActivatePipelineRequest:
    headers: ActivatePipelineHeaders = field(default=None)
    request: shared.ActivatePipelineInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
