...
class EvaluateExpressionHeaders:
    ...
    x_amz_target: EvaluateExpressionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class EvaluateExpressionRequest:
    headers: EvaluateExpressionHeaders = field(default=None)
    request: shared.EvaluateExpressionInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
