...
class DeactivatePipelineHeaders:
    ...
    x_amz_target: DeactivatePipelineXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeactivatePipelineRequest:
    headers: DeactivatePipelineHeaders = field(default=None)
    request: shared.DeactivatePipelineInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
