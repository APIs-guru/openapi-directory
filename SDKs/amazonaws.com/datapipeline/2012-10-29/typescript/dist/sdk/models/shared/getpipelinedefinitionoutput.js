...
**/
var GetPipelineDefinitionOutput = /** @class */ (function (_super) {
    __extends(GetPipelineDefinitionOutput, _super);
    ...
    ], GetPipelineDefinitionOutput.prototype, "parameterObjects", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=parameterValues", elemType: ParameterValue }),
        __metadata("design:type", Array)
    ], GetPipelineDefinitionOutput.prototype, "parameterValues", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=pipelineObjects", elemType: PipelineObject }),
        __metadata("design:type", Array)
    ], GetPipelineDefinitionOutput.prototype, "pipelineObjects", void 0);
    return GetPipelineDefinitionOutput;
}(SpeakeasyBase));
export { GetPipelineDefinitionOutput };
