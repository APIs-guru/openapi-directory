...
export class ListAlarmsPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=alarmModelName" })
  alarmModelName: string;
}


export class ListAlarmsQueryParams extends SpeakeasyBase {
...
export class ListAlarmsHeaders extends SpeakeasyBase {
