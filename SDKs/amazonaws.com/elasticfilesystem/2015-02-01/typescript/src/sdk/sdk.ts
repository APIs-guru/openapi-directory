...
export class SDK {
  ...
  **/
  createAccessPoint(
  ...
  ): Promise<operations.CreateAccessPointResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.CreateAccessPointRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/2015-02-01/access-points";
    ...
    return client
      .request({
        ...
        const res: operations.CreateAccessPointResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.accessPointDescription = httpRes?.data;
            }
            break;
          ...
          case httpRes?.status == 481:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.accessPointAlreadyExists = httpRes?.data;
            }
            break;
          case httpRes?.status == 482:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.incorrectFileSystemLifeCycleState = httpRes?.data;
            }
            break;
          ...
          case httpRes?.status == 485:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.accessPointLimitExceeded = httpRes?.data;
            }
            break;
        }
  ...
  **/
  createFileSystem(
    ...
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/2015-02-01/file-systems";
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.CreateFileSystemResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 201:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.fileSystemDescription = httpRes?.data;
            }
            break;
          case httpRes?.status == 480:
            if (utils.MatchContentType(contentType, `application/json`)) {
          ...
          case httpRes?.status == 482:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.fileSystemAlreadyExists = httpRes?.data;
            }
            break;
          case httpRes?.status == 483:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.fileSystemLimitExceeded = httpRes?.data;
            }
            break;
          case httpRes?.status == 484:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.insufficientThroughputCapacity = httpRes?.data;
            }
            break;
          case httpRes?.status == 485:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.throughputLimitExceeded = httpRes?.data;
            }
            break;
          case httpRes?.status == 486:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.unsupportedAvailabilityZone = httpRes?.data;
            }
            break;
        }
  ...
  **/
  createMountTarget(
    req: operations.CreateMountTargetRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.CreateMountTargetResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.CreateMountTargetRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/2015-02-01/mount-targets";
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.CreateMountTargetResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.mountTargetDescription = httpRes?.data;
            }
            break;
          case httpRes?.status == 480:
            if (utils.MatchContentType(contentType, `application/json`)) {
          ...
          case httpRes?.status == 484:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.mountTargetConflict = httpRes?.data;
            }
            break;
          case httpRes?.status == 485:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.subnetNotFound = httpRes?.data;
            }
            break;
          case httpRes?.status == 486:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.noFreeAddressesInSubnet = httpRes?.data;
            }
            break;
          case httpRes?.status == 487:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.ipAddressInUse = httpRes?.data;
            }
            break;
          case httpRes?.status == 488:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.networkInterfaceLimitExceeded = httpRes?.data;
            }
            break;
          case httpRes?.status == 489:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.securityGroupLimitExceeded = httpRes?.data;
            }
            break;
          case httpRes?.status == 490:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.securityGroupNotFound = httpRes?.data;
            }
            break;
          ...
          case httpRes?.status == 492:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.availabilityZonesMismatch = httpRes?.data;
            }
            break;
        }
  ...
  **/
  createTags(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/2015-02-01/create-tags/{FileSystemId}", req.pathParams);
  ...
  **/
  deleteAccessPoint(
    req: operations.DeleteAccessPointRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.DeleteAccessPointResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.DeleteAccessPointRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/2015-02-01/access-points/{AccessPointId}", req.pathParams);
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.DeleteAccessPointResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 204:
            break;
          case httpRes?.status == 480:
          ...
          case httpRes?.status == 482:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.accessPointNotFound = httpRes?.data;
            }
            break;
        }
  ...
  **/
  deleteFileSystem(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/2015-02-01/file-systems/{FileSystemId}", req.pathParams);
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.DeleteFileSystemResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 204:
            break;
          case httpRes?.status == 480:
          ...
          case httpRes?.status == 483:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.fileSystemInUse = httpRes?.data;
            }
            break;
        }
  ...
  **/
  deleteFileSystemPolicy(
    req: operations.DeleteFileSystemPolicyRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.DeleteFileSystemPolicyResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.DeleteFileSystemPolicyRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/2015-02-01/file-systems/{FileSystemId}/policy", req.pathParams);
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.DeleteFileSystemPolicyResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            break;
          case httpRes?.status == 480:
  ...
  **/
  deleteMountTarget(
    req: operations.DeleteMountTargetRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.DeleteMountTargetResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.DeleteMountTargetRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/2015-02-01/mount-targets/{MountTargetId}", req.pathParams);
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.DeleteMountTargetResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 204:
            break;
          case httpRes?.status == 480:
          ...
          case httpRes?.status == 482:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.dependencyTimeout = httpRes?.data;
            }
            break;
          case httpRes?.status == 483:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.mountTargetNotFound = httpRes?.data;
            }
            break;
        }
  ...
  **/
  deleteTags(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/2015-02-01/delete-tags/{FileSystemId}", req.pathParams);
  ...
  **/
  describeAccessPoints(
    req: operations.DescribeAccessPointsRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.DescribeAccessPointsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.DescribeAccessPointsRequest(req);
    }
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.DescribeAccessPointsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.describeAccessPointsResponse = httpRes?.data;
            }
            break;
          case httpRes?.status == 480:
            if (utils.MatchContentType(contentType, `application/json`)) {
  ...
  **/
  describeBackupPolicy(
    req: operations.DescribeBackupPolicyRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.DescribeBackupPolicyResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.DescribeBackupPolicyRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/2015-02-01/file-systems/{FileSystemId}/backup-policy", req.pathParams);
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.DescribeBackupPolicyResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.backupPolicyDescription = httpRes?.data;
            }
            break;
          case httpRes?.status == 480:
            if (utils.MatchContentType(contentType, `application/json`)) {
          ...
          case httpRes?.status == 483:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.policyNotFound = httpRes?.data;
            }
            break;
          case httpRes?.status == 484:
            if (utils.MatchContentType(contentType, `application/json`)) {
  ...
  **/
  describeFileSystemPolicy(
    req: operations.DescribeFileSystemPolicyRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.DescribeFileSystemPolicyResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.DescribeFileSystemPolicyRequest(req);
    }
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.DescribeFileSystemPolicyResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.fileSystemPolicyDescription = httpRes?.data;
            }
            break;
          case httpRes?.status == 480:
            if (utils.MatchContentType(contentType, `application/json`)) {
  ...
  describeFileSystems(
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.DescribeFileSystemsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
  ...
  **/
  describeLifecycleConfiguration(
    req: operations.DescribeLifecycleConfigurationRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.DescribeLifecycleConfigurationResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.DescribeLifecycleConfigurationRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/2015-02-01/file-systems/{FileSystemId}/lifecycle-configuration", req.pathParams);
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.DescribeLifecycleConfigurationResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.lifecycleConfigurationDescription = httpRes?.data;
            }
            break;
          case httpRes?.status == 480:
            if (utils.MatchContentType(contentType, `application/json`)) {
  ...
  **/
  describeMountTargetSecurityGroups(
    req: operations.DescribeMountTargetSecurityGroupsRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.DescribeMountTargetSecurityGroupsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.DescribeMountTargetSecurityGroupsRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/2015-02-01/mount-targets/{MountTargetId}/security-groups", req.pathParams);
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.DescribeMountTargetSecurityGroupsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.describeMountTargetSecurityGroupsResponse = httpRes?.data;
            }
            break;
          case httpRes?.status == 480:
            if (utils.MatchContentType(contentType, `application/json`)) {
          ...
          case httpRes?.status == 483:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.incorrectMountTargetState = httpRes?.data;
            }
            break;
        }
  ...
  **/
  describeMountTargets(
    req: operations.DescribeMountTargetsRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.DescribeMountTargetsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.DescribeMountTargetsRequest(req);
    }
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.DescribeMountTargetsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.describeMountTargetsResponse = httpRes?.data;
            }
            break;
          case httpRes?.status == 480:
            if (utils.MatchContentType(contentType, `application/json`)) {
  ...
  **/
  describeTags(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/2015-02-01/tags/{FileSystemId}/", req.pathParams);
  ...
  **/
  listTagsForResource(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/2015-02-01/resource-tags/{ResourceId}", req.pathParams);
  ...
  **/
  modifyMountTargetSecurityGroups(
    req: operations.ModifyMountTargetSecurityGroupsRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.ModifyMountTargetSecurityGroupsResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.ModifyMountTargetSecurityGroupsRequest(req);
    }
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.ModifyMountTargetSecurityGroupsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 204:
            break;
          case httpRes?.status == 480:
  ...
  **/
  putAccountPreferences(
    req: operations.PutAccountPreferencesRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.PutAccountPreferencesResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.PutAccountPreferencesRequest(req);
    }
    
    const baseURL: string = this._serverURL;
    const url: string = baseURL.replace(/\/$/, "") + "/2015-02-01/account-preferences";
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PutAccountPreferencesResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.putAccountPreferencesResponse = httpRes?.data;
            }
            break;
          case httpRes?.status == 480:
            if (utils.MatchContentType(contentType, `application/json`)) {
  ...
  **/
  putBackupPolicy(
    req: operations.PutBackupPolicyRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.PutBackupPolicyResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.PutBackupPolicyRequest(req);
    }
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PutBackupPolicyResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.backupPolicyDescription = httpRes?.data;
  ...
  **/
  putFileSystemPolicy(
    req: operations.PutFileSystemPolicyRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.PutFileSystemPolicyResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.PutFileSystemPolicyRequest(req);
    }
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PutFileSystemPolicyResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.fileSystemPolicyDescription = httpRes?.data;
  ...
  **/
  putLifecycleConfiguration(
    req: operations.PutLifecycleConfigurationRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.PutLifecycleConfigurationResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.PutLifecycleConfigurationRequest(req);
    }
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PutLifecycleConfigurationResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.lifecycleConfigurationDescription = httpRes?.data;
  ...
  **/
  untagResource(
    ...
    const baseURL: string = this._serverURL;
    const url: string = utils.GenerateURL(baseURL, "/2015-02-01/resource-tags/{ResourceId}#tagKeys", req.pathParams);
  ...
  updateFileSystem(
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.UpdateFileSystemResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
