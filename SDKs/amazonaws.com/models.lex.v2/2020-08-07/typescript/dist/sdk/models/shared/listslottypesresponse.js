...
var ListSlotTypesResponse = /** @class */ (function (_super) {
    ...
    ], ListSlotTypesResponse.prototype, "botId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=botVersion" }),
        __metadata("design:type", String)
    ], ListSlotTypesResponse.prototype, "botVersion", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=localeId" }),
        __metadata("design:type", String)
    ], ListSlotTypesResponse.prototype, "localeId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=nextToken" }),
        __metadata("design:type", String)
    ], ListSlotTypesResponse.prototype, "nextToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=slotTypeSummaries", elemType: SlotTypeSummary }),
        __metadata("design:type", Array)
    ], ListSlotTypesResponse.prototype, "slotTypeSummaries", void 0);
