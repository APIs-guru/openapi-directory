...
var UpdateBotResponse = /** @class */ (function (_super) {
    ...
    ], UpdateBotResponse.prototype, "botId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=botName" }),
        __metadata("design:type", String)
    ], UpdateBotResponse.prototype, "botName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=botStatus" }),
        __metadata("design:type", String)
    ], UpdateBotResponse.prototype, "botStatus", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=creationDateTime" }),
        __metadata("design:type", Date)
    ], UpdateBotResponse.prototype, "creationDateTime", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=dataPrivacy" }),
        __metadata("design:type", DataPrivacy)
    ], UpdateBotResponse.prototype, "dataPrivacy", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=description" }),
        __metadata("design:type", String)
    ], UpdateBotResponse.prototype, "description", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=idleSessionTTLInSeconds" }),
        __metadata("design:type", Number)
    ], UpdateBotResponse.prototype, "idleSessionTtlInSeconds", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=lastUpdatedDateTime" }),
        __metadata("design:type", Date)
    ], UpdateBotResponse.prototype, "lastUpdatedDateTime", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=roleArn" }),
        __metadata("design:type", String)
    ], UpdateBotResponse.prototype, "roleArn", void 0);
