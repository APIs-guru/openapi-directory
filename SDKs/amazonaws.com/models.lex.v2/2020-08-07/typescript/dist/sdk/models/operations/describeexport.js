...
var DescribeExportPathParams = /** @class */ (function (_super) {
    __extends(DescribeExportPathParams, _super);
    function DescribeExportPathParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=exportId" }),
        __metadata("design:type", String)
    ], DescribeExportPathParams.prototype, "exportId", void 0);
    return DescribeExportPathParams;
}(SpeakeasyBase));
export { DescribeExportPathParams };
...
var DescribeExportRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", DescribeExportPathParams)
    ], DescribeExportRequest.prototype, "pathParams", void 0);
    __decorate([
        SpeakeasyMetadata(),
...
var DescribeExportResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", shared.DescribeExportResponse)
    ], DescribeExportResponse.prototype, "describeExportResponse", void 0);
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", Object)
    ], DescribeExportResponse.prototype, "internalServerException", void 0);
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", Object)
    ], DescribeExportResponse.prototype, "resourceNotFoundException", void 0);
    __decorate([
        SpeakeasyMetadata(),
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", Object)
    ], DescribeExportResponse.prototype, "throttlingException", void 0);
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", Object)
    ], DescribeExportResponse.prototype, "validationException", void 0);
