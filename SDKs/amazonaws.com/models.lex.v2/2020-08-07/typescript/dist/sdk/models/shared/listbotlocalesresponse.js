...
var ListBotLocalesResponse = /** @class */ (function (_super) {
    ...
    ], ListBotLocalesResponse.prototype, "botId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=botLocaleSummaries", elemType: BotLocaleSummary }),
        __metadata("design:type", Array)
    ], ListBotLocalesResponse.prototype, "botLocaleSummaries", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=botVersion" }),
        __metadata("design:type", String)
    ], ListBotLocalesResponse.prototype, "botVersion", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=nextToken" }),
        __metadata("design:type", String)
    ], ListBotLocalesResponse.prototype, "nextToken", void 0);
