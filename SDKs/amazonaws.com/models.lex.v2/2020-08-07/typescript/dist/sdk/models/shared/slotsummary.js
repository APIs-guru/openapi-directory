...
**/
var SlotSummary = /** @class */ (function (_super) {
    __extends(SlotSummary, _super);
    ...
    ], SlotSummary.prototype, "description", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=lastUpdatedDateTime" }),
        __metadata("design:type", Date)
    ], SlotSummary.prototype, "lastUpdatedDateTime", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=slotConstraint" }),
        __metadata("design:type", String)
    ], SlotSummary.prototype, "slotConstraint", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=slotId" }),
        __metadata("design:type", String)
    ], SlotSummary.prototype, "slotId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=slotName" }),
        __metadata("design:type", String)
    ], SlotSummary.prototype, "slotName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=slotTypeId" }),
        __metadata("design:type", String)
    ], SlotSummary.prototype, "slotTypeId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=valueElicitationPromptSpecification" }),
        __metadata("design:type", PromptSpecification)
    ], SlotSummary.prototype, "valueElicitationPromptSpecification", void 0);
    return SlotSummary;
}(SpeakeasyBase));
export { SlotSummary };
