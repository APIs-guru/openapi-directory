...
class DescribeIntentRequest:
    path_params: DescribeIntentPathParams = field(default=None)
    headers: DescribeIntentHeaders = field(default=None)
    

@dataclass
class DescribeIntentResponse:
    content_type: str = field(default=None)
    describe_intent_response: Optional[shared.DescribeIntentResponse] = field(default=None)
