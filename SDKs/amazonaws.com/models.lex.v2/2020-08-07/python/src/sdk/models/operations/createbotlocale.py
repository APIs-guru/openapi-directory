...
class CreateBotLocaleRequestBody:
    ...
    voice_settings: Optional[CreateBotLocaleRequestBodyVoiceSettings] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('voiceSettings') }})
    

@dataclass
class CreateBotLocaleRequest:
    headers: CreateBotLocaleHeaders = field()
    path_params: CreateBotLocalePathParams = field()
    request: CreateBotLocaleRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
