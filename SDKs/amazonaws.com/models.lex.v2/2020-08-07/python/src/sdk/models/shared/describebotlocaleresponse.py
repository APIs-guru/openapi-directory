...
class DescribeBotLocaleResponse:
    ...
    bot_locale_history_events: Optional[List[BotLocaleHistoryEvent]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('botLocaleHistoryEvents') }})
    ...
    intents_count: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('intentsCount') }})
    ...
    slot_types_count: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('slotTypesCount') }})
