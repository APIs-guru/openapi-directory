...
class DescribeBotAliasRequest:
    path_params: DescribeBotAliasPathParams = field(default=None)
    headers: DescribeBotAliasHeaders = field(default=None)
    

@dataclass
class DescribeBotAliasResponse:
    content_type: str = field(default=None)
    describe_bot_alias_response: Optional[shared.DescribeBotAliasResponse] = field(default=None)
