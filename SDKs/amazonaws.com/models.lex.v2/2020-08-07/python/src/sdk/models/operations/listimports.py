...
class ListImportsRequestBodySortBy:
    ...
    attribute: Optional[shared.ImportSortAttributeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('attribute') }})
...
class ListImportsRequestBody:
    ...
    filters: Optional[List[shared.ImportFilter]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('filters') }})
    max_results: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('maxResults') }})
    next_token: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('nextToken') }})
    sort_by: Optional[ListImportsRequestBodySortBy] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sortBy') }})
    

@dataclass
class ListImportsRequest:
    headers: ListImportsHeaders = field()
    query_params: ListImportsQueryParams = field()
    request: ListImportsRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
