...
class UpdateExportRequest:
    headers: UpdateExportHeaders = field()
    path_params: UpdateExportPathParams = field()
    request: UpdateExportRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
