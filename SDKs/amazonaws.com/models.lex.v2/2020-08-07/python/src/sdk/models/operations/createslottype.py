...
class CreateSlotTypeRequestBody:
    ...
    value_selection_setting: CreateSlotTypeRequestBodyValueSelectionSetting = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('valueSelectionSetting') }})
...
class CreateSlotTypeRequest:
    headers: CreateSlotTypeHeaders = field()
    path_params: CreateSlotTypePathParams = field()
    request: CreateSlotTypeRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
