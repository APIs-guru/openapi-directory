...
class CreateIntentRequestBody:
    ...
    dialog_code_hook: Optional[CreateIntentRequestBodyDialogCodeHook] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('dialogCodeHook') }})
    fulfillment_code_hook: Optional[CreateIntentRequestBodyFulfillmentCodeHook] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('fulfillmentCodeHook') }})
    ...
    intent_closing_setting: Optional[CreateIntentRequestBodyIntentClosingSetting] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('intentClosingSetting') }})
    intent_confirmation_setting: Optional[CreateIntentRequestBodyIntentConfirmationSetting] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('intentConfirmationSetting') }})
    kendra_configuration: Optional[CreateIntentRequestBodyKendraConfiguration] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('kendraConfiguration') }})
...
class CreateIntentRequest:
    headers: CreateIntentHeaders = field()
    path_params: CreateIntentPathParams = field()
    request: CreateIntentRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
