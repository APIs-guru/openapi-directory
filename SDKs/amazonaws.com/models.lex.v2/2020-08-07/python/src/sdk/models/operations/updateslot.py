...
class UpdateSlotRequestBody:
    ...
    value_elicitation_setting: UpdateSlotRequestBodyValueElicitationSetting = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('valueElicitationSetting') }})
    description: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('description') }})
    multiple_values_setting: Optional[UpdateSlotRequestBodyMultipleValuesSetting] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('multipleValuesSetting') }})
    obfuscation_setting: Optional[UpdateSlotRequestBodyObfuscationSetting] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('obfuscationSetting') }})
    

@dataclass
class UpdateSlotRequest:
    headers: UpdateSlotHeaders = field()
    path_params: UpdateSlotPathParams = field()
    request: UpdateSlotRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
