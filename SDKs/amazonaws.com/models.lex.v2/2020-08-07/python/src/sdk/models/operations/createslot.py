...
class CreateSlotRequestBody:
    ...
    multiple_values_setting: Optional[CreateSlotRequestBodyMultipleValuesSetting] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'multipleValuesSetting' }})
    obfuscation_setting: Optional[CreateSlotRequestBodyObfuscationSetting] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'obfuscationSetting' }})
    ...
    value_elicitation_setting: CreateSlotRequestBodyValueElicitationSetting = field(default=None, metadata={'dataclasses_json': { 'field_name': 'valueElicitationSetting' }})
    

@dataclass
class CreateSlotRequest:
    path_params: CreateSlotPathParams = field(default=None)
    headers: CreateSlotHeaders = field(default=None)
    request: CreateSlotRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
