...
from . import botaliashistoryevent
...
class DescribeBotAliasResponse:
    bot_alias_history_events: Optional[List[botaliashistoryevent.BotAliasHistoryEvent]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'botAliasHistoryEvents' }})
