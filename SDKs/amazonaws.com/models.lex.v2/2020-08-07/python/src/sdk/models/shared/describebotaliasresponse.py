...
class DescribeBotAliasResponse:
    bot_alias_history_events: Optional[List[BotAliasHistoryEvent]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('botAliasHistoryEvents') }})
