...
export class PresetWatermark extends SpeakeasyBase {
  @Metadata({ data: "json, name=HorizontalAlign" })
  horizontalAlign?: string;

  @Metadata({ data: "json, name=HorizontalOffset" })
  ...
  @Metadata({ data: "json, name=VerticalAlign" })
  verticalAlign?: string;

  @Metadata({ data: "json, name=VerticalOffset" })
