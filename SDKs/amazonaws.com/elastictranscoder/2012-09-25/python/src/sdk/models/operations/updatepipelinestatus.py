...
class UpdatePipelineStatusRequest:
    headers: UpdatePipelineStatusHeaders = field()
    path_params: UpdatePipelineStatusPathParams = field()
    request: UpdatePipelineStatusRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
