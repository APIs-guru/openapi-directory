...
class ListJobsByStatusPathParams:
    status: str = field(metadata={'path_param': { 'field_name': 'Status', 'style': 'simple', 'explode': False }})
...
class ListJobsByStatusRequest:
    headers: ListJobsByStatusHeaders = field()
    path_params: ListJobsByStatusPathParams = field()
    query_params: ListJobsByStatusQueryParams = field()
