...
**/
var ServiceStatistics = /** @class */ (function (_super) {
    __extends(ServiceStatistics, _super);
    ...
    ], ServiceStatistics.prototype, "errorStatistics", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=FaultStatistics" }),
        __metadata("design:type", FaultStatistics)
    ], ServiceStatistics.prototype, "faultStatistics", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=OkCount" }),
        __metadata("design:type", Number)
    ], ServiceStatistics.prototype, "okCount", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=TotalCount" }),
        __metadata("design:type", Number)
    ], ServiceStatistics.prototype, "totalCount", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=TotalResponseTime" }),
        __metadata("design:type", Number)
    ], ServiceStatistics.prototype, "totalResponseTime", void 0);
