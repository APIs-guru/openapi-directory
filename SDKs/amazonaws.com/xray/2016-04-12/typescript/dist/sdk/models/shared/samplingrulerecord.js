...
**/
var SamplingRuleRecord = /** @class */ (function (_super) {
    __extends(SamplingRuleRecord, _super);
    ...
    ], SamplingRuleRecord.prototype, "createdAt", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ModifiedAt" }),
        __metadata("design:type", Date)
    ], SamplingRuleRecord.prototype, "modifiedAt", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=SamplingRule" }),
        __metadata("design:type", SamplingRule)
    ], SamplingRuleRecord.prototype, "samplingRule", void 0);
    return SamplingRuleRecord;
}(SpeakeasyBase));
export { SamplingRuleRecord };
