...
**/
var FaultRootCause = /** @class */ (function (_super) {
    __extends(FaultRootCause, _super);
    ...
    ], FaultRootCause.prototype, "clientImpacting", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Services", elemType: FaultRootCauseService }),
        __metadata("design:type", Array)
    ], FaultRootCause.prototype, "services", void 0);
    return FaultRootCause;
}(SpeakeasyBase));
export { FaultRootCause };
