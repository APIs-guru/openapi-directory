...
class CreateSamplingRuleRequestBody:
    sampling_rule: CreateSamplingRuleRequestBodySamplingRule = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('SamplingRule') }})
...
class CreateSamplingRuleRequest:
    headers: CreateSamplingRuleHeaders = field()
    request: CreateSamplingRuleRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
