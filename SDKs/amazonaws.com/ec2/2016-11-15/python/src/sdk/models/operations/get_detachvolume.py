...
class GetDetachVolumeQueryParams:
    action: GetDetachVolumeActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetDetachVolumeVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDetachVolumeRequest:
    headers: GetDetachVolumeHeaders = field()
    query_params: GetDetachVolumeQueryParams = field()
