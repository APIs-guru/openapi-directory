...
class PostGetHostReservationPurchasePreviewQueryParams:
    action: PostGetHostReservationPurchasePreviewActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostGetHostReservationPurchasePreviewVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostGetHostReservationPurchasePreviewRequest:
    headers: PostGetHostReservationPurchasePreviewHeaders = field()
    query_params: PostGetHostReservationPurchasePreviewQueryParams = field()
