...
class PostDescribeVpcEndpointServicesQueryParams:
    action: PostDescribeVpcEndpointServicesActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeVpcEndpointServicesVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeVpcEndpointServicesRequest:
    headers: PostDescribeVpcEndpointServicesHeaders = field()
    query_params: PostDescribeVpcEndpointServicesQueryParams = field()
