...
class GetRestoreAddressToClassicQueryParams:
    action: GetRestoreAddressToClassicActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    public_ip: str = field(metadata={'query_param': { 'field_name': 'PublicIp', 'style': 'form', 'explode': True }})
    version: GetRestoreAddressToClassicVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetRestoreAddressToClassicRequest:
    headers: GetRestoreAddressToClassicHeaders = field()
    query_params: GetRestoreAddressToClassicQueryParams = field()
