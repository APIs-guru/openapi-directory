...
class GetDeleteTransitGatewayVpcAttachmentQueryParams:
    action: GetDeleteTransitGatewayVpcAttachmentActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetDeleteTransitGatewayVpcAttachmentVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteTransitGatewayVpcAttachmentRequest:
    query_params: GetDeleteTransitGatewayVpcAttachmentQueryParams = field(default=None)
    headers: GetDeleteTransitGatewayVpcAttachmentHeaders = field(default=None)
