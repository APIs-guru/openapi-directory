...
class GetDeleteTransitGatewayVpcAttachmentQueryParams:
    action: GetDeleteTransitGatewayVpcAttachmentActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetDeleteTransitGatewayVpcAttachmentVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteTransitGatewayVpcAttachmentRequest:
    headers: GetDeleteTransitGatewayVpcAttachmentHeaders = field()
    query_params: GetDeleteTransitGatewayVpcAttachmentQueryParams = field()
