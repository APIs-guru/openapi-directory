...
class GetGetPasswordDataQueryParams:
    action: GetGetPasswordDataActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetGetPasswordDataVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetGetPasswordDataRequest:
    query_params: GetGetPasswordDataQueryParams = field(default=None)
    headers: GetGetPasswordDataHeaders = field(default=None)
