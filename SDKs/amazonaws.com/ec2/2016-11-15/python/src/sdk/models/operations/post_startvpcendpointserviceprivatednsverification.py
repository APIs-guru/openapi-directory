...
class PostStartVpcEndpointServicePrivateDNSVerificationQueryParams:
    action: PostStartVpcEndpointServicePrivateDNSVerificationActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostStartVpcEndpointServicePrivateDNSVerificationVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostStartVpcEndpointServicePrivateDNSVerificationRequest:
    headers: PostStartVpcEndpointServicePrivateDNSVerificationHeaders = field()
    query_params: PostStartVpcEndpointServicePrivateDNSVerificationQueryParams = field()
