...
class PostModifyInstanceCapacityReservationAttributesQueryParams:
    action: PostModifyInstanceCapacityReservationAttributesActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostModifyInstanceCapacityReservationAttributesVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostModifyInstanceCapacityReservationAttributesRequest:
    query_params: PostModifyInstanceCapacityReservationAttributesQueryParams = field(default=None)
    headers: PostModifyInstanceCapacityReservationAttributesHeaders = field(default=None)
