...
class PostGetTransitGatewayPrefixListReferencesQueryParams:
    action: PostGetTransitGatewayPrefixListReferencesActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostGetTransitGatewayPrefixListReferencesVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostGetTransitGatewayPrefixListReferencesRequest:
    headers: PostGetTransitGatewayPrefixListReferencesHeaders = field()
    query_params: PostGetTransitGatewayPrefixListReferencesQueryParams = field()
