...
class PostDescribeNetworkInterfaceAttributeQueryParams:
    action: PostDescribeNetworkInterfaceAttributeActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeNetworkInterfaceAttributeVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeNetworkInterfaceAttributeRequest:
    headers: PostDescribeNetworkInterfaceAttributeHeaders = field()
    query_params: PostDescribeNetworkInterfaceAttributeQueryParams = field()
