...
class PostDisableVpcClassicLinkDNSSupportQueryParams:
    action: PostDisableVpcClassicLinkDNSSupportActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDisableVpcClassicLinkDNSSupportVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDisableVpcClassicLinkDNSSupportRequest:
    headers: PostDisableVpcClassicLinkDNSSupportHeaders = field()
    query_params: PostDisableVpcClassicLinkDNSSupportQueryParams = field()
