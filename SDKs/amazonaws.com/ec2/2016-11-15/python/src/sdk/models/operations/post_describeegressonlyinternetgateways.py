...
class PostDescribeEgressOnlyInternetGatewaysQueryParams:
    action: PostDescribeEgressOnlyInternetGatewaysActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeEgressOnlyInternetGatewaysVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeEgressOnlyInternetGatewaysRequest:
    headers: PostDescribeEgressOnlyInternetGatewaysHeaders = field()
    query_params: PostDescribeEgressOnlyInternetGatewaysQueryParams = field()
