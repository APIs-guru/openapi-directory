...
class GetDeleteLaunchTemplateQueryParams:
    action: GetDeleteLaunchTemplateActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetDeleteLaunchTemplateVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteLaunchTemplateRequest:
    headers: GetDeleteLaunchTemplateHeaders = field()
    query_params: GetDeleteLaunchTemplateQueryParams = field()
