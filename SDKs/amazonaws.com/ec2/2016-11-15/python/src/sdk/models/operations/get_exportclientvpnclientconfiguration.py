...
class GetExportClientVpnClientConfigurationQueryParams:
    action: GetExportClientVpnClientConfigurationActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    client_vpn_endpoint_id: str = field(metadata={'query_param': { 'field_name': 'ClientVpnEndpointId', 'style': 'form', 'explode': True }})
    version: GetExportClientVpnClientConfigurationVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetExportClientVpnClientConfigurationRequest:
    headers: GetExportClientVpnClientConfigurationHeaders = field()
    query_params: GetExportClientVpnClientConfigurationQueryParams = field()
