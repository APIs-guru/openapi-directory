...
class GetWithdrawByoipCidrQueryParams:
    action: GetWithdrawByoipCidrActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    cidr: str = field(metadata={'query_param': { 'field_name': 'Cidr', 'style': 'form', 'explode': True }})
    version: GetWithdrawByoipCidrVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetWithdrawByoipCidrRequest:
    headers: GetWithdrawByoipCidrHeaders = field()
    query_params: GetWithdrawByoipCidrQueryParams = field()
