...
class PostDescribeVpcEndpointServiceConfigurationsQueryParams:
    action: PostDescribeVpcEndpointServiceConfigurationsActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeVpcEndpointServiceConfigurationsVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeVpcEndpointServiceConfigurationsRequest:
    headers: PostDescribeVpcEndpointServiceConfigurationsHeaders = field()
    query_params: PostDescribeVpcEndpointServiceConfigurationsQueryParams = field()
