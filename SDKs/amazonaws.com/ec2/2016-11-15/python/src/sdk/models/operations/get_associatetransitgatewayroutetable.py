...
class GetAssociateTransitGatewayRouteTableQueryParams:
    action: GetAssociateTransitGatewayRouteTableActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetAssociateTransitGatewayRouteTableVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetAssociateTransitGatewayRouteTableRequest:
    headers: GetAssociateTransitGatewayRouteTableHeaders = field()
    query_params: GetAssociateTransitGatewayRouteTableQueryParams = field()
