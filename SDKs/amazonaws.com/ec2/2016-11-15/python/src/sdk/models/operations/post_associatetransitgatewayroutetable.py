...
class PostAssociateTransitGatewayRouteTableQueryParams:
    action: PostAssociateTransitGatewayRouteTableActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostAssociateTransitGatewayRouteTableVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostAssociateTransitGatewayRouteTableRequest:
    headers: PostAssociateTransitGatewayRouteTableHeaders = field()
    query_params: PostAssociateTransitGatewayRouteTableQueryParams = field()
