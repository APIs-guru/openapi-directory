...
class GetDeleteVolumeQueryParams:
    action: GetDeleteVolumeActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetDeleteVolumeVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteVolumeRequest:
    headers: GetDeleteVolumeHeaders = field()
    query_params: GetDeleteVolumeQueryParams = field()
