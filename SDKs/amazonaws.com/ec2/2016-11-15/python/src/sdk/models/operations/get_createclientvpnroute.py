...
@dataclass
class GetCreateClientVpnRouteQueryParams:
    action: GetCreateClientVpnRouteActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    target_vpc_subnet_id: str = field(default=None, metadata={'query_param': { 'field_name': 'TargetVpcSubnetId', 'style': 'form', 'explode': True }})
    version: GetCreateClientVpnRouteVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
    

@dataclass
class GetCreateClientVpnRouteHeaders:
...
class GetCreateClientVpnRouteRequest:
    query_params: GetCreateClientVpnRouteQueryParams = field(default=None)
    headers: GetCreateClientVpnRouteHeaders = field(default=None)
