...
class GetCreateClientVpnRouteQueryParams:
    action: GetCreateClientVpnRouteActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    target_vpc_subnet_id: str = field(metadata={'query_param': { 'field_name': 'TargetVpcSubnetId', 'style': 'form', 'explode': True }})
    version: GetCreateClientVpnRouteVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetCreateClientVpnRouteRequest:
    headers: GetCreateClientVpnRouteHeaders = field()
    query_params: GetCreateClientVpnRouteQueryParams = field()
