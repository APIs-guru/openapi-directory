...
class GetDescribeSnapshotAttributeQueryParams:
    action: GetDescribeSnapshotAttributeActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    attribute: GetDescribeSnapshotAttributeAttributeEnum = field(metadata={'query_param': { 'field_name': 'Attribute', 'style': 'form', 'explode': True }})
    snapshot_id: str = field(metadata={'query_param': { 'field_name': 'SnapshotId', 'style': 'form', 'explode': True }})
    version: GetDescribeSnapshotAttributeVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDescribeSnapshotAttributeRequest:
    headers: GetDescribeSnapshotAttributeHeaders = field()
    query_params: GetDescribeSnapshotAttributeQueryParams = field()
