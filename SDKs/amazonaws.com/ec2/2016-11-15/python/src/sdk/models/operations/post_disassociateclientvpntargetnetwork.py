...
class PostDisassociateClientVpnTargetNetworkQueryParams:
    action: PostDisassociateClientVpnTargetNetworkActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDisassociateClientVpnTargetNetworkVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDisassociateClientVpnTargetNetworkRequest:
    headers: PostDisassociateClientVpnTargetNetworkHeaders = field()
    query_params: PostDisassociateClientVpnTargetNetworkQueryParams = field()
