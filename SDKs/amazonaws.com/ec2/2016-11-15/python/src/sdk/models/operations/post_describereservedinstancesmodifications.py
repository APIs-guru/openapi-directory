...
class PostDescribeReservedInstancesModificationsQueryParams:
    action: PostDescribeReservedInstancesModificationsActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeReservedInstancesModificationsVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeReservedInstancesModificationsRequest:
    headers: PostDescribeReservedInstancesModificationsHeaders = field()
    query_params: PostDescribeReservedInstancesModificationsQueryParams = field()
