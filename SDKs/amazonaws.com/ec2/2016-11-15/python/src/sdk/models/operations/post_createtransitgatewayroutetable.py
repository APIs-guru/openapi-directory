...
class PostCreateTransitGatewayRouteTableQueryParams:
    action: PostCreateTransitGatewayRouteTableActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostCreateTransitGatewayRouteTableVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostCreateTransitGatewayRouteTableRequest:
    headers: PostCreateTransitGatewayRouteTableHeaders = field()
    query_params: PostCreateTransitGatewayRouteTableQueryParams = field()
