...
class PostGetAssociatedEnclaveCertificateIamRolesQueryParams:
    action: PostGetAssociatedEnclaveCertificateIamRolesActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostGetAssociatedEnclaveCertificateIamRolesVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostGetAssociatedEnclaveCertificateIamRolesRequest:
    query_params: PostGetAssociatedEnclaveCertificateIamRolesQueryParams = field(default=None)
    headers: PostGetAssociatedEnclaveCertificateIamRolesHeaders = field(default=None)
