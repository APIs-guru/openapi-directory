...
class GetGetGroupsForCapacityReservationQueryParams:
    action: GetGetGroupsForCapacityReservationActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetGetGroupsForCapacityReservationVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetGetGroupsForCapacityReservationRequest:
    query_params: GetGetGroupsForCapacityReservationQueryParams = field(default=None)
    headers: GetGetGroupsForCapacityReservationHeaders = field(default=None)
