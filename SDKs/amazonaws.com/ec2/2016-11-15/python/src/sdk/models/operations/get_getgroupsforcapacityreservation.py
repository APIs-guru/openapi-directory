...
class GetGetGroupsForCapacityReservationQueryParams:
    action: GetGetGroupsForCapacityReservationActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    capacity_reservation_id: str = field(metadata={'query_param': { 'field_name': 'CapacityReservationId', 'style': 'form', 'explode': True }})
    version: GetGetGroupsForCapacityReservationVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetGetGroupsForCapacityReservationRequest:
    headers: GetGetGroupsForCapacityReservationHeaders = field()
    query_params: GetGetGroupsForCapacityReservationQueryParams = field()
