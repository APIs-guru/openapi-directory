...
class GetAdvertiseByoipCidrQueryParams:
    action: GetAdvertiseByoipCidrActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    cidr: str = field(metadata={'query_param': { 'field_name': 'Cidr', 'style': 'form', 'explode': True }})
    version: GetAdvertiseByoipCidrVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetAdvertiseByoipCidrRequest:
    headers: GetAdvertiseByoipCidrHeaders = field()
    query_params: GetAdvertiseByoipCidrQueryParams = field()
