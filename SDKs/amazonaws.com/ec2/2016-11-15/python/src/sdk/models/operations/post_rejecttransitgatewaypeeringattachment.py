...
class PostRejectTransitGatewayPeeringAttachmentQueryParams:
    action: PostRejectTransitGatewayPeeringAttachmentActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostRejectTransitGatewayPeeringAttachmentVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostRejectTransitGatewayPeeringAttachmentRequest:
    headers: PostRejectTransitGatewayPeeringAttachmentHeaders = field()
    query_params: PostRejectTransitGatewayPeeringAttachmentQueryParams = field()
