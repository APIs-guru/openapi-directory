...
class GetCreateNetworkACLEntryQueryParams:
    action: GetCreateNetworkACLEntryActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    rule_action: GetCreateNetworkACLEntryRuleActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'RuleAction', 'style': 'form', 'explode': True }})
    rule_number: int = field(default=None, metadata={'query_param': { 'field_name': 'RuleNumber', 'style': 'form', 'explode': True }})
    version: GetCreateNetworkACLEntryVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetCreateNetworkACLEntryRequest:
    query_params: GetCreateNetworkACLEntryQueryParams = field(default=None)
    headers: GetCreateNetworkACLEntryHeaders = field(default=None)
