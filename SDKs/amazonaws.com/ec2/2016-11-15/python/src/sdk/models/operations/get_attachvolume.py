...
class GetAttachVolumeQueryParams:
    action: GetAttachVolumeActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    device: str = field(metadata={'query_param': { 'field_name': 'Device', 'style': 'form', 'explode': True }})
    instance_id: str = field(metadata={'query_param': { 'field_name': 'InstanceId', 'style': 'form', 'explode': True }})
    version: GetAttachVolumeVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetAttachVolumeRequest:
    headers: GetAttachVolumeHeaders = field()
    query_params: GetAttachVolumeQueryParams = field()
