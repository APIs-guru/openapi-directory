...
class InstanceNetworkInterfaceSpecification:
    ...
    ipv4_prefixes: Optional[List[Ipv4PrefixSpecificationRequest]] = field(default=None)
    ...
    ipv6_prefixes: Optional[List[Ipv6PrefixSpecificationRequest]] = field(default=None)
