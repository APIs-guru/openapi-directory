...
class GetAttachInternetGatewayQueryParams:
    action: GetAttachInternetGatewayActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    internet_gateway_id: str = field(metadata={'query_param': { 'field_name': 'InternetGatewayId', 'style': 'form', 'explode': True }})
    version: GetAttachInternetGatewayVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetAttachInternetGatewayRequest:
    headers: GetAttachInternetGatewayHeaders = field()
    query_params: GetAttachInternetGatewayQueryParams = field()
