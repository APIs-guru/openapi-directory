...
class PostAcceptTransitGatewayPeeringAttachmentQueryParams:
    action: PostAcceptTransitGatewayPeeringAttachmentActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostAcceptTransitGatewayPeeringAttachmentVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostAcceptTransitGatewayPeeringAttachmentRequest:
    headers: PostAcceptTransitGatewayPeeringAttachmentHeaders = field()
    query_params: PostAcceptTransitGatewayPeeringAttachmentQueryParams = field()
