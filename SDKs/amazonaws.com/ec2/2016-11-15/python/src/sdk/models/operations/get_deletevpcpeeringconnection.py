...
class GetDeleteVpcPeeringConnectionQueryParams:
    action: GetDeleteVpcPeeringConnectionActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetDeleteVpcPeeringConnectionVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteVpcPeeringConnectionRequest:
    headers: GetDeleteVpcPeeringConnectionHeaders = field()
    query_params: GetDeleteVpcPeeringConnectionQueryParams = field()
