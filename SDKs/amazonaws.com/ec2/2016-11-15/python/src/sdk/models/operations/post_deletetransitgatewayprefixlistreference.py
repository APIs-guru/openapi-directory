...
class PostDeleteTransitGatewayPrefixListReferenceQueryParams:
    action: PostDeleteTransitGatewayPrefixListReferenceActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDeleteTransitGatewayPrefixListReferenceVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDeleteTransitGatewayPrefixListReferenceRequest:
    headers: PostDeleteTransitGatewayPrefixListReferenceHeaders = field()
    query_params: PostDeleteTransitGatewayPrefixListReferenceQueryParams = field()
