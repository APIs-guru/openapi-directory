...
class GetDisableVpcClassicLinkQueryParams:
    action: GetDisableVpcClassicLinkActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetDisableVpcClassicLinkVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDisableVpcClassicLinkRequest:
    headers: GetDisableVpcClassicLinkHeaders = field()
    query_params: GetDisableVpcClassicLinkQueryParams = field()
