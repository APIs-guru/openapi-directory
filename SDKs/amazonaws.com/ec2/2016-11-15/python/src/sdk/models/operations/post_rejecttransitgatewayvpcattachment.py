...
class PostRejectTransitGatewayVpcAttachmentQueryParams:
    action: PostRejectTransitGatewayVpcAttachmentActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostRejectTransitGatewayVpcAttachmentVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostRejectTransitGatewayVpcAttachmentRequest:
    headers: PostRejectTransitGatewayVpcAttachmentHeaders = field()
    query_params: PostRejectTransitGatewayVpcAttachmentQueryParams = field()
