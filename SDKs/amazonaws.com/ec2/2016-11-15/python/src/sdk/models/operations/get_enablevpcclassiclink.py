...
class GetEnableVpcClassicLinkQueryParams:
    action: GetEnableVpcClassicLinkActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    dry_run: Optional[bool] = field(default=None, metadata={'query_param': { 'field_name': 'DryRun', 'style': 'form', 'explode': True }})
    version: GetEnableVpcClassicLinkVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetEnableVpcClassicLinkRequest:
    query_params: GetEnableVpcClassicLinkQueryParams = field(default=None)
    headers: GetEnableVpcClassicLinkHeaders = field(default=None)
