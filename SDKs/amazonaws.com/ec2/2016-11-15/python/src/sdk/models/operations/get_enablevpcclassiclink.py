...
class GetEnableVpcClassicLinkQueryParams:
    action: GetEnableVpcClassicLinkActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetEnableVpcClassicLinkVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetEnableVpcClassicLinkRequest:
    headers: GetEnableVpcClassicLinkHeaders = field()
    query_params: GetEnableVpcClassicLinkQueryParams = field()
