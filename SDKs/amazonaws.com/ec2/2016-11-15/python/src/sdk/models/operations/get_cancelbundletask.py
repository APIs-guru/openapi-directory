...
class GetCancelBundleTaskQueryParams:
    action: GetCancelBundleTaskActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    bundle_id: str = field(metadata={'query_param': { 'field_name': 'BundleId', 'style': 'form', 'explode': True }})
    version: GetCancelBundleTaskVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetCancelBundleTaskRequest:
    headers: GetCancelBundleTaskHeaders = field()
    query_params: GetCancelBundleTaskQueryParams = field()
