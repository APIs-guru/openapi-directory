...
class PostDescribeStaleSecurityGroupsQueryParams:
    action: PostDescribeStaleSecurityGroupsActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeStaleSecurityGroupsVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeStaleSecurityGroupsRequest:
    headers: PostDescribeStaleSecurityGroupsHeaders = field()
    query_params: PostDescribeStaleSecurityGroupsQueryParams = field()
