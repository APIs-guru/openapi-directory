...
class PostDisableTransitGatewayRouteTablePropagationQueryParams:
    action: PostDisableTransitGatewayRouteTablePropagationActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDisableTransitGatewayRouteTablePropagationVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDisableTransitGatewayRouteTablePropagationRequest:
    headers: PostDisableTransitGatewayRouteTablePropagationHeaders = field()
    query_params: PostDisableTransitGatewayRouteTablePropagationQueryParams = field()
