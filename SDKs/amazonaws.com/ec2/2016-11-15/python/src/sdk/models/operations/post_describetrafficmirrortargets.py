...
class PostDescribeTrafficMirrorTargetsQueryParams:
    action: PostDescribeTrafficMirrorTargetsActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeTrafficMirrorTargetsVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeTrafficMirrorTargetsRequest:
    headers: PostDescribeTrafficMirrorTargetsHeaders = field()
    query_params: PostDescribeTrafficMirrorTargetsQueryParams = field()
