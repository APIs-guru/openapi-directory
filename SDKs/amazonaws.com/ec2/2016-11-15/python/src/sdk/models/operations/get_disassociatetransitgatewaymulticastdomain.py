...
class GetDisassociateTransitGatewayMulticastDomainQueryParams:
    action: GetDisassociateTransitGatewayMulticastDomainActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetDisassociateTransitGatewayMulticastDomainVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDisassociateTransitGatewayMulticastDomainRequest:
    headers: GetDisassociateTransitGatewayMulticastDomainHeaders = field()
    query_params: GetDisassociateTransitGatewayMulticastDomainQueryParams = field()
