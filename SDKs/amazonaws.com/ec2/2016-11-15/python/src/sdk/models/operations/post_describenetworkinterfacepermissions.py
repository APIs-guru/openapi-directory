...
class PostDescribeNetworkInterfacePermissionsQueryParams:
    action: PostDescribeNetworkInterfacePermissionsActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeNetworkInterfacePermissionsVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeNetworkInterfacePermissionsRequest:
    headers: PostDescribeNetworkInterfacePermissionsHeaders = field()
    query_params: PostDescribeNetworkInterfacePermissionsQueryParams = field()
