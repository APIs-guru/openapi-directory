...
class PostCreateLocalGatewayRouteTableVpcAssociationQueryParams:
    action: PostCreateLocalGatewayRouteTableVpcAssociationActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostCreateLocalGatewayRouteTableVpcAssociationVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostCreateLocalGatewayRouteTableVpcAssociationRequest:
    headers: PostCreateLocalGatewayRouteTableVpcAssociationHeaders = field()
    query_params: PostCreateLocalGatewayRouteTableVpcAssociationQueryParams = field()
