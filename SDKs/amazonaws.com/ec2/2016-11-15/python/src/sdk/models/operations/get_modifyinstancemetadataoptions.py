...
class GetModifyInstanceMetadataOptionsQueryParams:
    action: GetModifyInstanceMetadataOptionsActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    instance_id: str = field(metadata={'query_param': { 'field_name': 'InstanceId', 'style': 'form', 'explode': True }})
    version: GetModifyInstanceMetadataOptionsVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetModifyInstanceMetadataOptionsRequest:
    headers: GetModifyInstanceMetadataOptionsHeaders = field()
    query_params: GetModifyInstanceMetadataOptionsQueryParams = field()
