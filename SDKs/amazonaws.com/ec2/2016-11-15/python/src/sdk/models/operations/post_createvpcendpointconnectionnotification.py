...
class PostCreateVpcEndpointConnectionNotificationQueryParams:
    action: PostCreateVpcEndpointConnectionNotificationActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostCreateVpcEndpointConnectionNotificationVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostCreateVpcEndpointConnectionNotificationRequest:
    headers: PostCreateVpcEndpointConnectionNotificationHeaders = field()
    query_params: PostCreateVpcEndpointConnectionNotificationQueryParams = field()
