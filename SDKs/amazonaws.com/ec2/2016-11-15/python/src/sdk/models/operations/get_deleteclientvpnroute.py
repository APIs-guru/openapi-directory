...
class GetDeleteClientVpnRouteQueryParams:
    action: GetDeleteClientVpnRouteActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    target_vpc_subnet_id: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'TargetVpcSubnetId', 'style': 'form', 'explode': True }})
    version: GetDeleteClientVpnRouteVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteClientVpnRouteRequest:
    query_params: GetDeleteClientVpnRouteQueryParams = field(default=None)
    headers: GetDeleteClientVpnRouteHeaders = field(default=None)
