...
class GetDeleteClientVpnRouteQueryParams:
    action: GetDeleteClientVpnRouteActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetDeleteClientVpnRouteVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteClientVpnRouteRequest:
    headers: GetDeleteClientVpnRouteHeaders = field()
    query_params: GetDeleteClientVpnRouteQueryParams = field()
