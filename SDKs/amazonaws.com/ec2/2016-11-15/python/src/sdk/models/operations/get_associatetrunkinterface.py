...
class GetAssociateTrunkInterfaceQueryParams:
    action: GetAssociateTrunkInterfaceActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    branch_interface_id: str = field(metadata={'query_param': { 'field_name': 'BranchInterfaceId', 'style': 'form', 'explode': True }})
    trunk_interface_id: str = field(metadata={'query_param': { 'field_name': 'TrunkInterfaceId', 'style': 'form', 'explode': True }})
    version: GetAssociateTrunkInterfaceVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetAssociateTrunkInterfaceRequest:
    headers: GetAssociateTrunkInterfaceHeaders = field()
    query_params: GetAssociateTrunkInterfaceQueryParams = field()
