...
class PostCreateTransitGatewayConnectQueryParams:
    action: PostCreateTransitGatewayConnectActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostCreateTransitGatewayConnectVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostCreateTransitGatewayConnectRequest:
    headers: PostCreateTransitGatewayConnectHeaders = field()
    query_params: PostCreateTransitGatewayConnectQueryParams = field()
