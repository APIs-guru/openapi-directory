...
class GetDeleteTransitGatewayPrefixListReferenceQueryParams:
    action: GetDeleteTransitGatewayPrefixListReferenceActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetDeleteTransitGatewayPrefixListReferenceVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteTransitGatewayPrefixListReferenceRequest:
    headers: GetDeleteTransitGatewayPrefixListReferenceHeaders = field()
    query_params: GetDeleteTransitGatewayPrefixListReferenceQueryParams = field()
