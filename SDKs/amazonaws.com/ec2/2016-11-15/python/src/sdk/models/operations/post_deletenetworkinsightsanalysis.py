...
class PostDeleteNetworkInsightsAnalysisQueryParams:
    action: PostDeleteNetworkInsightsAnalysisActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDeleteNetworkInsightsAnalysisVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDeleteNetworkInsightsAnalysisRequest:
    headers: PostDeleteNetworkInsightsAnalysisHeaders = field()
    query_params: PostDeleteNetworkInsightsAnalysisQueryParams = field()
