...
class GetDeleteInternetGatewayQueryParams:
    action: GetDeleteInternetGatewayActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetDeleteInternetGatewayVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteInternetGatewayRequest:
    query_params: GetDeleteInternetGatewayQueryParams = field(default=None)
    headers: GetDeleteInternetGatewayHeaders = field(default=None)
