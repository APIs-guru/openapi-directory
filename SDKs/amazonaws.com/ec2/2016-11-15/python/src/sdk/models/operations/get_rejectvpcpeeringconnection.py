...
class GetRejectVpcPeeringConnectionQueryParams:
    action: GetRejectVpcPeeringConnectionActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetRejectVpcPeeringConnectionVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetRejectVpcPeeringConnectionRequest:
    headers: GetRejectVpcPeeringConnectionHeaders = field()
    query_params: GetRejectVpcPeeringConnectionQueryParams = field()
