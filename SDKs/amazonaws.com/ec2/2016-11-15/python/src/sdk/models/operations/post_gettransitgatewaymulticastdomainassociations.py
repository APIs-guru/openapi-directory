...
class PostGetTransitGatewayMulticastDomainAssociationsQueryParams:
    action: PostGetTransitGatewayMulticastDomainAssociationsActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostGetTransitGatewayMulticastDomainAssociationsVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostGetTransitGatewayMulticastDomainAssociationsRequest:
    headers: PostGetTransitGatewayMulticastDomainAssociationsHeaders = field()
    query_params: PostGetTransitGatewayMulticastDomainAssociationsQueryParams = field()
