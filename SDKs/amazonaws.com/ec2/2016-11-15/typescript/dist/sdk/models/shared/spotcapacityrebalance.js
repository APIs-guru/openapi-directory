...
**/
var SpotCapacityRebalance = /** @class */ (function (_super) {
    __extends(SpotCapacityRebalance, _super);
    ...
    ], SpotCapacityRebalance.prototype, "replacementStrategy", void 0);
    return SpotCapacityRebalance;
}(SpeakeasyBase));
export { SpotCapacityRebalance };
