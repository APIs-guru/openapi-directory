...
export declare class PostDescribeVpcEndpointServicesQueryParams extends SpeakeasyBase {
    action: PostDescribeVpcEndpointServicesActionEnum;
    version: PostDescribeVpcEndpointServicesVersionEnum;
}
export declare class PostDescribeVpcEndpointServicesHeaders extends SpeakeasyBase {
