...
})(PostDeleteLocalGatewayRouteTableVpcAssociationActionEnum || (PostDeleteLocalGatewayRouteTableVpcAssociationActionEnum = {}));
export var PostDeleteLocalGatewayRouteTableVpcAssociationVersionEnum;
(function (PostDeleteLocalGatewayRouteTableVpcAssociationVersionEnum) {
    PostDeleteLocalGatewayRouteTableVpcAssociationVersionEnum["TwoThousandAndSixteen1115"] = "2016-11-15";
})(PostDeleteLocalGatewayRouteTableVpcAssociationVersionEnum || (PostDeleteLocalGatewayRouteTableVpcAssociationVersionEnum = {}));
var PostDeleteLocalGatewayRouteTableVpcAssociationQueryParams = /** @class */ (function (_super) {
    __extends(PostDeleteLocalGatewayRouteTableVpcAssociationQueryParams, _super);
    function PostDeleteLocalGatewayRouteTableVpcAssociationQueryParams() {
...
export { PostDeleteLocalGatewayRouteTableVpcAssociationQueryParams };
var PostDeleteLocalGatewayRouteTableVpcAssociationHeaders = /** @class */ (function (_super) {
    __extends(PostDeleteLocalGatewayRouteTableVpcAssociationHeaders, _super);
    function PostDeleteLocalGatewayRouteTableVpcAssociationHeaders() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
...
export { PostDeleteLocalGatewayRouteTableVpcAssociationHeaders };
var PostDeleteLocalGatewayRouteTableVpcAssociationRequest = /** @class */ (function (_super) {
    __extends(PostDeleteLocalGatewayRouteTableVpcAssociationRequest, _super);
    function PostDeleteLocalGatewayRouteTableVpcAssociationRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata(),
...
export { PostDeleteLocalGatewayRouteTableVpcAssociationRequest };
var PostDeleteLocalGatewayRouteTableVpcAssociationResponse = /** @class */ (function (_super) {
    __extends(PostDeleteLocalGatewayRouteTableVpcAssociationResponse, _super);
    function PostDeleteLocalGatewayRouteTableVpcAssociationResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata(),
...
export { PostDeleteLocalGatewayRouteTableVpcAssociationResponse };
