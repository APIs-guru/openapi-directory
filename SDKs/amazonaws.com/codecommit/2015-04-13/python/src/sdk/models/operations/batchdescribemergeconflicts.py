...
class BatchDescribeMergeConflictsHeaders:
    x_amz_target: BatchDescribeMergeConflictsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class BatchDescribeMergeConflictsRequest:
    headers: BatchDescribeMergeConflictsHeaders = field()
    request: shared.BatchDescribeMergeConflictsInput = field(metadata={'request': { 'media_type': 'application/json' }})
