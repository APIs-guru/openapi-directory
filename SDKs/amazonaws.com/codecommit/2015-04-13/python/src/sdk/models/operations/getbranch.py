...
class GetBranchHeaders:
    x_amz_target: GetBranchXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetBranchRequest:
    ...
    request: shared.GetBranchInput = field(metadata={'request': { 'media_type': 'application/json' }})
