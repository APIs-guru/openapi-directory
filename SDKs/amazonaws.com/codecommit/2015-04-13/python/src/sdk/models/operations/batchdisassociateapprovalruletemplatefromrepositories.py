...
class BatchDisassociateApprovalRuleTemplateFromRepositoriesHeaders:
    ...
    x_amz_target: BatchDisassociateApprovalRuleTemplateFromRepositoriesXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class BatchDisassociateApprovalRuleTemplateFromRepositoriesRequest:
    headers: BatchDisassociateApprovalRuleTemplateFromRepositoriesHeaders = field(default=None)
    request: shared.BatchDisassociateApprovalRuleTemplateFromRepositoriesInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
