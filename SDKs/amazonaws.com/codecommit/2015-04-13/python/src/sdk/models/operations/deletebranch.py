...
class DeleteBranchHeaders:
    ...
    x_amz_target: DeleteBranchXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeleteBranchRequest:
    headers: DeleteBranchHeaders = field(default=None)
    request: shared.DeleteBranchInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
