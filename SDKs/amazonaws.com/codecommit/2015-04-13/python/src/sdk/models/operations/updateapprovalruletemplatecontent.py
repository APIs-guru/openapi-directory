...
class UpdateApprovalRuleTemplateContentHeaders:
    x_amz_target: UpdateApprovalRuleTemplateContentXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateApprovalRuleTemplateContentRequest:
    headers: UpdateApprovalRuleTemplateContentHeaders = field()
    request: shared.UpdateApprovalRuleTemplateContentInput = field(metadata={'request': { 'media_type': 'application/json' }})
