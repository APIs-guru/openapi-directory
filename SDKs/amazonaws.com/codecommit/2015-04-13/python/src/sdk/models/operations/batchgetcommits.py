...
class BatchGetCommitsHeaders:
    x_amz_target: BatchGetCommitsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class BatchGetCommitsRequest:
    headers: BatchGetCommitsHeaders = field()
    request: shared.BatchGetCommitsInput = field(metadata={'request': { 'media_type': 'application/json' }})
