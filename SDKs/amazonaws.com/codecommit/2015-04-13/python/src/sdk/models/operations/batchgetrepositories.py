...
class BatchGetRepositoriesHeaders:
    x_amz_target: BatchGetRepositoriesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class BatchGetRepositoriesRequest:
    headers: BatchGetRepositoriesHeaders = field()
    request: shared.BatchGetRepositoriesInput = field(metadata={'request': { 'media_type': 'application/json' }})
