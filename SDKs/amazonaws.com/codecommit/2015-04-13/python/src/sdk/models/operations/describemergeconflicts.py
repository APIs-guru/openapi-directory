...
class DescribeMergeConflictsHeaders:
    ...
    x_amz_target: DescribeMergeConflictsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeMergeConflictsRequest:
    query_params: DescribeMergeConflictsQueryParams = field(default=None)
    headers: DescribeMergeConflictsHeaders = field(default=None)
    request: shared.DescribeMergeConflictsInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
