...
class GetCommentReactionsHeaders:
    x_amz_target: GetCommentReactionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetCommentReactionsRequest:
    headers: GetCommentReactionsHeaders = field()
    query_params: GetCommentReactionsQueryParams = field()
    request: shared.GetCommentReactionsInput = field(metadata={'request': { 'media_type': 'application/json' }})
