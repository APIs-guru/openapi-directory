...
class MergePullRequestByThreeWayHeaders:
    ...
    x_amz_target: MergePullRequestByThreeWayXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
...
class MergePullRequestByThreeWayResponse:
    ...
    merge_pull_request_by_three_way_output: Optional[shared.MergePullRequestByThreeWayOutput] = field(default=None)
