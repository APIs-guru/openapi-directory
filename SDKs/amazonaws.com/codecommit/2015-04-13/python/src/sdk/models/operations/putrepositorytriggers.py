...
class PutRepositoryTriggersHeaders:
    ...
    x_amz_target: PutRepositoryTriggersXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class PutRepositoryTriggersRequest:
    headers: PutRepositoryTriggersHeaders = field(default=None)
    request: shared.PutRepositoryTriggersInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
