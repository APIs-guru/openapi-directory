...
class CreatePullRequestApprovalRuleHeaders:
    x_amz_target: CreatePullRequestApprovalRuleXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreatePullRequestApprovalRuleRequest:
    headers: CreatePullRequestApprovalRuleHeaders = field()
    request: shared.CreatePullRequestApprovalRuleInput = field(metadata={'request': { 'media_type': 'application/json' }})
