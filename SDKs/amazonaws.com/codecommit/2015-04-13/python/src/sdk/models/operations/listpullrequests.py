...
class ListPullRequestsHeaders:
    x_amz_target: ListPullRequestsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListPullRequestsRequest:
    headers: ListPullRequestsHeaders = field()
    query_params: ListPullRequestsQueryParams = field()
    request: shared.ListPullRequestsInput = field(metadata={'request': { 'media_type': 'application/json' }})
