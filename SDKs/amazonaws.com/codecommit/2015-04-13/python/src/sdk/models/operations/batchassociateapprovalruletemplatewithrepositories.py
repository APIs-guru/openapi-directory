...
class BatchAssociateApprovalRuleTemplateWithRepositoriesHeaders:
    x_amz_target: BatchAssociateApprovalRuleTemplateWithRepositoriesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class BatchAssociateApprovalRuleTemplateWithRepositoriesRequest:
    headers: BatchAssociateApprovalRuleTemplateWithRepositoriesHeaders = field()
    request: shared.BatchAssociateApprovalRuleTemplateWithRepositoriesInput = field(metadata={'request': { 'media_type': 'application/json' }})
