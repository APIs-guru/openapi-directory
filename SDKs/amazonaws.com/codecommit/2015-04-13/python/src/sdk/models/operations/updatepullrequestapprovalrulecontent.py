...
class UpdatePullRequestApprovalRuleContentHeaders:
    x_amz_target: UpdatePullRequestApprovalRuleContentXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdatePullRequestApprovalRuleContentRequest:
    headers: UpdatePullRequestApprovalRuleContentHeaders = field()
    request: shared.UpdatePullRequestApprovalRuleContentInput = field(metadata={'request': { 'media_type': 'application/json' }})
