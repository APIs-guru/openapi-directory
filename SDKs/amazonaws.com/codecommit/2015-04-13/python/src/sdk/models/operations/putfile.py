...
class PutFileHeaders:
    ...
    x_amz_target: PutFileXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class PutFileRequest:
    headers: PutFileHeaders = field(default=None)
    request: shared.PutFileInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
