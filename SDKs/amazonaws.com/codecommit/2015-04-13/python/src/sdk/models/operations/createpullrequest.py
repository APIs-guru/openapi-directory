...
class CreatePullRequestHeaders:
    x_amz_target: CreatePullRequestXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreatePullRequestRequest:
    headers: CreatePullRequestHeaders = field()
    request: shared.CreatePullRequestInput = field(metadata={'request': { 'media_type': 'application/json' }})
