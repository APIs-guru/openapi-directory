...
class UpdateRepositoryDescriptionHeaders:
    x_amz_target: UpdateRepositoryDescriptionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateRepositoryDescriptionRequest:
    headers: UpdateRepositoryDescriptionHeaders = field()
    request: shared.UpdateRepositoryDescriptionInput = field(metadata={'request': { 'media_type': 'application/json' }})
