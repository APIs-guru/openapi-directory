...
class UpdateRepositoryDescriptionHeaders:
    ...
    x_amz_target: UpdateRepositoryDescriptionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateRepositoryDescriptionRequest:
    headers: UpdateRepositoryDescriptionHeaders = field(default=None)
    request: shared.UpdateRepositoryDescriptionInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
