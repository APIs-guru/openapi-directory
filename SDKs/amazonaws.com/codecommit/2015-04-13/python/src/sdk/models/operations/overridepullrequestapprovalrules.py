...
class OverridePullRequestApprovalRulesHeaders:
    x_amz_target: OverridePullRequestApprovalRulesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class OverridePullRequestApprovalRulesRequest:
    headers: OverridePullRequestApprovalRulesHeaders = field()
    request: shared.OverridePullRequestApprovalRulesInput = field(metadata={'request': { 'media_type': 'application/json' }})
