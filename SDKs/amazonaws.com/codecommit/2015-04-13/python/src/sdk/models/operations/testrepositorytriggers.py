...
class TestRepositoryTriggersHeaders:
    x_amz_target: TestRepositoryTriggersXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class TestRepositoryTriggersRequest:
    headers: TestRepositoryTriggersHeaders = field()
    request: shared.TestRepositoryTriggersInput = field(metadata={'request': { 'media_type': 'application/json' }})
