...
class TestRepositoryTriggersHeaders:
    ...
    x_amz_target: TestRepositoryTriggersXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class TestRepositoryTriggersRequest:
    headers: TestRepositoryTriggersHeaders = field(default=None)
    request: shared.TestRepositoryTriggersInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class TestRepositoryTriggersResponse:
    ...
    test_repository_triggers_output: Optional[shared.TestRepositoryTriggersOutput] = field(default=None)
