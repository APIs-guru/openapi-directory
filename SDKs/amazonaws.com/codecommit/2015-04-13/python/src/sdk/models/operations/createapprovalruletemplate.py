...
class CreateApprovalRuleTemplateHeaders:
    ...
    x_amz_target: CreateApprovalRuleTemplateXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateApprovalRuleTemplateRequest:
    headers: CreateApprovalRuleTemplateHeaders = field(default=None)
    request: shared.CreateApprovalRuleTemplateInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
