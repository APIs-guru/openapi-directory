...
class ListAssociatedApprovalRuleTemplatesForRepositoryHeaders:
    x_amz_target: ListAssociatedApprovalRuleTemplatesForRepositoryXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListAssociatedApprovalRuleTemplatesForRepositoryRequest:
    headers: ListAssociatedApprovalRuleTemplatesForRepositoryHeaders = field()
    query_params: ListAssociatedApprovalRuleTemplatesForRepositoryQueryParams = field()
    request: shared.ListAssociatedApprovalRuleTemplatesForRepositoryInput = field(metadata={'request': { 'media_type': 'application/json' }})
