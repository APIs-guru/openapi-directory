...
class DeleteApprovalRuleTemplateHeaders:
    x_amz_target: DeleteApprovalRuleTemplateXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteApprovalRuleTemplateRequest:
    headers: DeleteApprovalRuleTemplateHeaders = field()
    request: shared.DeleteApprovalRuleTemplateInput = field(metadata={'request': { 'media_type': 'application/json' }})
