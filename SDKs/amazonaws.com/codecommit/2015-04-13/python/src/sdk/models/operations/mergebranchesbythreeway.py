...
class MergeBranchesByThreeWayHeaders:
    ...
    x_amz_target: MergeBranchesByThreeWayXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class MergeBranchesByThreeWayRequest:
    headers: MergeBranchesByThreeWayHeaders = field(default=None)
    request: shared.MergeBranchesByThreeWayInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class MergeBranchesByThreeWayResponse:
    ...
    invalid_target_branch_exception: Optional[Any] = field(default=None)
    ...
    merge_branches_by_three_way_output: Optional[shared.MergeBranchesByThreeWayOutput] = field(default=None)
