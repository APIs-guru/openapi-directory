...
class MergeBranchesByThreeWayHeaders:
    x_amz_target: MergeBranchesByThreeWayXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class MergeBranchesByThreeWayRequest:
    headers: MergeBranchesByThreeWayHeaders = field()
    request: shared.MergeBranchesByThreeWayInput = field(metadata={'request': { 'media_type': 'application/json' }})
