...
class GetPullRequestHeaders:
    x_amz_target: GetPullRequestXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetPullRequestRequest:
    headers: GetPullRequestHeaders = field()
    request: shared.GetPullRequestInput = field(metadata={'request': { 'media_type': 'application/json' }})
