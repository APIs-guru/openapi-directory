...
class GetMergeCommitHeaders:
    ...
    x_amz_target: GetMergeCommitXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetMergeCommitRequest:
    headers: GetMergeCommitHeaders = field(default=None)
    request: shared.GetMergeCommitInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
