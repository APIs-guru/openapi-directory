...
class DisassociateApprovalRuleTemplateFromRepositoryHeaders:
    x_amz_target: DisassociateApprovalRuleTemplateFromRepositoryXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DisassociateApprovalRuleTemplateFromRepositoryRequest:
    headers: DisassociateApprovalRuleTemplateFromRepositoryHeaders = field()
    request: shared.DisassociateApprovalRuleTemplateFromRepositoryInput = field(metadata={'request': { 'media_type': 'application/json' }})
