...
class GetFileHeaders:
    ...
    x_amz_target: GetFileXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetFileRequest:
    headers: GetFileHeaders = field(default=None)
    request: shared.GetFileInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class GetFileResponse:
    ...
    file_too_large_exception: Optional[Any] = field(default=None)
    get_file_output: Optional[shared.GetFileOutput] = field(default=None)
