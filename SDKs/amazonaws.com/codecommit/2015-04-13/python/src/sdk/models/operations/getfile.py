...
class GetFileHeaders:
    x_amz_target: GetFileXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetFileRequest:
    ...
    request: shared.GetFileInput = field(metadata={'request': { 'media_type': 'application/json' }})
