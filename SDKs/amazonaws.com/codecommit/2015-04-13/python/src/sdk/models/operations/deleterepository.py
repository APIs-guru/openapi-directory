...
class DeleteRepositoryRequest:
    ...
    request: shared.DeleteRepositoryInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class DeleteRepositoryResponse:
    content_type: str = field(default=None)
    delete_repository_output: Optional[shared.DeleteRepositoryOutput] = field(default=None)
