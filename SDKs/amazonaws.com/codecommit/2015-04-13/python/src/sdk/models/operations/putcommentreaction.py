...
class PutCommentReactionHeaders:
    ...
    x_amz_target: PutCommentReactionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class PutCommentReactionRequest:
    headers: PutCommentReactionHeaders = field(default=None)
    request: shared.PutCommentReactionInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
