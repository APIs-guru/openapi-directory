...
class GetCommentsForComparedCommitHeaders:
    x_amz_target: GetCommentsForComparedCommitXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetCommentsForComparedCommitRequest:
    headers: GetCommentsForComparedCommitHeaders = field()
    query_params: GetCommentsForComparedCommitQueryParams = field()
    request: shared.GetCommentsForComparedCommitInput = field(metadata={'request': { 'media_type': 'application/json' }})
