...
class AssociateApprovalRuleTemplateWithRepositoryHeaders:
    x_amz_target: AssociateApprovalRuleTemplateWithRepositoryXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AssociateApprovalRuleTemplateWithRepositoryRequest:
    headers: AssociateApprovalRuleTemplateWithRepositoryHeaders = field()
    request: shared.AssociateApprovalRuleTemplateWithRepositoryInput = field(metadata={'request': { 'media_type': 'application/json' }})
