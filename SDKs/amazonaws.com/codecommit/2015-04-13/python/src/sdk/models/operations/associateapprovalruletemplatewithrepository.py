...
class AssociateApprovalRuleTemplateWithRepositoryXAmzTargetEnum(str, Enum):
    CODE_COMMIT_20150413_ASSOCIATE_APPROVAL_RULE_TEMPLATE_WITH_REPOSITORY = "CodeCommit_20150413.AssociateApprovalRuleTemplateWithRepository"


@dataclass
class AssociateApprovalRuleTemplateWithRepositoryHeaders:
    ...
    x_amz_target: AssociateApprovalRuleTemplateWithRepositoryXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class AssociateApprovalRuleTemplateWithRepositoryRequest:
    headers: AssociateApprovalRuleTemplateWithRepositoryHeaders = field(default=None)
    request: shared.AssociateApprovalRuleTemplateWithRepositoryInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class AssociateApprovalRuleTemplateWithRepositoryResponse:
    ...
    maximum_rule_templates_associated_with_repository_exception: Optional[Any] = field(default=None)
