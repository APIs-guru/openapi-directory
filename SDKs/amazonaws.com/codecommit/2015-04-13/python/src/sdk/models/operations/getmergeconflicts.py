...
class GetMergeConflictsQueryParams:
    max_conflict_files: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'maxConflictFiles', 'style': 'form', 'explode': True }})
...
class GetMergeConflictsHeaders:
    ...
    x_amz_target: GetMergeConflictsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetMergeConflictsRequest:
    query_params: GetMergeConflictsQueryParams = field(default=None)
    headers: GetMergeConflictsHeaders = field(default=None)
    request: shared.GetMergeConflictsInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class GetMergeConflictsResponse:
    ...
    get_merge_conflicts_output: Optional[shared.GetMergeConflictsOutput] = field(default=None)
    ...
    invalid_destination_commit_specifier_exception: Optional[Any] = field(default=None)
    ...
    invalid_source_commit_specifier_exception: Optional[Any] = field(default=None)
