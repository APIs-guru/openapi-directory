...
class GetMergeConflictsHeaders:
    x_amz_target: GetMergeConflictsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetMergeConflictsRequest:
    headers: GetMergeConflictsHeaders = field()
    query_params: GetMergeConflictsQueryParams = field()
    request: shared.GetMergeConflictsInput = field(metadata={'request': { 'media_type': 'application/json' }})
