...
class GetCommitHeaders:
    x_amz_target: GetCommitXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetCommitRequest:
    headers: GetCommitHeaders = field()
    request: shared.GetCommitInput = field(metadata={'request': { 'media_type': 'application/json' }})
