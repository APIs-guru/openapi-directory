...
class UpdateRepositoryNameHeaders:
    x_amz_target: UpdateRepositoryNameXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateRepositoryNameRequest:
    headers: UpdateRepositoryNameHeaders = field()
    request: shared.UpdateRepositoryNameInput = field(metadata={'request': { 'media_type': 'application/json' }})
