...
class EvaluatePullRequestApprovalRulesHeaders:
    ...
    x_amz_target: EvaluatePullRequestApprovalRulesXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class EvaluatePullRequestApprovalRulesRequest:
    headers: EvaluatePullRequestApprovalRulesHeaders = field(default=None)
    request: shared.EvaluatePullRequestApprovalRulesInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class EvaluatePullRequestApprovalRulesResponse:
    ...
    evaluate_pull_request_approval_rules_output: Optional[shared.EvaluatePullRequestApprovalRulesOutput] = field(default=None)
