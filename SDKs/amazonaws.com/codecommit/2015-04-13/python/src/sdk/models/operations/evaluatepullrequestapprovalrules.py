...
class EvaluatePullRequestApprovalRulesHeaders:
    x_amz_target: EvaluatePullRequestApprovalRulesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class EvaluatePullRequestApprovalRulesRequest:
    headers: EvaluatePullRequestApprovalRulesHeaders = field()
    request: shared.EvaluatePullRequestApprovalRulesInput = field(metadata={'request': { 'media_type': 'application/json' }})
