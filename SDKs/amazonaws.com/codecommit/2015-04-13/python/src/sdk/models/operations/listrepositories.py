...
class ListRepositoriesHeaders:
    x_amz_target: ListRepositoriesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListRepositoriesRequest:
    headers: ListRepositoriesHeaders = field()
    query_params: ListRepositoriesQueryParams = field()
    request: shared.ListRepositoriesInput = field(metadata={'request': { 'media_type': 'application/json' }})
