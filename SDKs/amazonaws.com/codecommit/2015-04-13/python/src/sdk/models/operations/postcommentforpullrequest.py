...
class PostCommentForPullRequestHeaders:
    ...
    x_amz_target: PostCommentForPullRequestXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class PostCommentForPullRequestRequest:
    headers: PostCommentForPullRequestHeaders = field(default=None)
    request: shared.PostCommentForPullRequestInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class PostCommentForPullRequestResponse:
    ...
    post_comment_for_pull_request_output: Optional[shared.PostCommentForPullRequestOutput] = field(default=None)
