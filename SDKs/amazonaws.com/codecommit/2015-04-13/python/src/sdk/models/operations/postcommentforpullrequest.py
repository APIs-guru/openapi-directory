...
class PostCommentForPullRequestHeaders:
    x_amz_target: PostCommentForPullRequestXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PostCommentForPullRequestRequest:
    headers: PostCommentForPullRequestHeaders = field()
    request: shared.PostCommentForPullRequestInput = field(metadata={'request': { 'media_type': 'application/json' }})
