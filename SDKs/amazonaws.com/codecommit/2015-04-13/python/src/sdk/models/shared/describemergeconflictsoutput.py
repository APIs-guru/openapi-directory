...
class DescribeMergeConflictsOutput:
    conflict_metadata: ConflictMetadata = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('conflictMetadata') }})
    destination_commit_id: str = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('destinationCommitId') }})
    merge_hunks: List[MergeHunk] = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('mergeHunks') }})
