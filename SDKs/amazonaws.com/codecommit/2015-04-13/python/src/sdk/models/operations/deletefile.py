...
class DeleteFileHeaders:
    ...
    x_amz_target: DeleteFileXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeleteFileRequest:
    headers: DeleteFileHeaders = field(default=None)
    request: shared.DeleteFileInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class DeleteFileResponse:
    ...
    delete_file_output: Optional[shared.DeleteFileOutput] = field(default=None)
