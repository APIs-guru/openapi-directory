...
class DeleteFileHeaders:
    x_amz_target: DeleteFileXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteFileRequest:
    ...
    request: shared.DeleteFileInput = field(metadata={'request': { 'media_type': 'application/json' }})
