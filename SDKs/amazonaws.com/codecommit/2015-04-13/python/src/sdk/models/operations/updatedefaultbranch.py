...
class UpdateDefaultBranchHeaders:
    x_amz_target: UpdateDefaultBranchXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateDefaultBranchRequest:
    headers: UpdateDefaultBranchHeaders = field()
    request: shared.UpdateDefaultBranchInput = field(metadata={'request': { 'media_type': 'application/json' }})
