...
class UpdateApprovalRuleTemplateDescriptionHeaders:
    ...
    x_amz_target: UpdateApprovalRuleTemplateDescriptionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateApprovalRuleTemplateDescriptionRequest:
    headers: UpdateApprovalRuleTemplateDescriptionHeaders = field(default=None)
    request: shared.UpdateApprovalRuleTemplateDescriptionInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
