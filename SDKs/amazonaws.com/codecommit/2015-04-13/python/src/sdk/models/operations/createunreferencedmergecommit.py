...
class CreateUnreferencedMergeCommitHeaders:
    x_amz_target: CreateUnreferencedMergeCommitXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateUnreferencedMergeCommitRequest:
    headers: CreateUnreferencedMergeCommitHeaders = field()
    request: shared.CreateUnreferencedMergeCommitInput = field(metadata={'request': { 'media_type': 'application/json' }})
