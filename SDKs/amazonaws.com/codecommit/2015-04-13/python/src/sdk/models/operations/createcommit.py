...
class CreateCommitHeaders:
    x_amz_target: CreateCommitXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateCommitRequest:
    headers: CreateCommitHeaders = field()
    request: shared.CreateCommitInput = field(metadata={'request': { 'media_type': 'application/json' }})
