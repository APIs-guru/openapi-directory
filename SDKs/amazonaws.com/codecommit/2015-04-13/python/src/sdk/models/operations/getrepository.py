...
class GetRepositoryHeaders:
    x_amz_target: GetRepositoryXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetRepositoryRequest:
    headers: GetRepositoryHeaders = field()
    request: shared.GetRepositoryInput = field(metadata={'request': { 'media_type': 'application/json' }})
