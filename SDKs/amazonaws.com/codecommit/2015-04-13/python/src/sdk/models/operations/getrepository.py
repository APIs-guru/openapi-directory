...
class GetRepositoryXAmzTargetEnum(str, Enum):
    CODE_COMMIT_20150413_GET_REPOSITORY = "CodeCommit_20150413.GetRepository"


@dataclass
class GetRepositoryHeaders:
    ...
    x_amz_target: GetRepositoryXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetRepositoryRequest:
    headers: GetRepositoryHeaders = field(default=None)
    request: shared.GetRepositoryInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class GetRepositoryResponse:
    ...
    get_repository_output: Optional[shared.GetRepositoryOutput] = field(default=None)
