...
class DescribePullRequestEventsHeaders:
    x_amz_target: DescribePullRequestEventsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribePullRequestEventsRequest:
    headers: DescribePullRequestEventsHeaders = field()
    query_params: DescribePullRequestEventsQueryParams = field()
    request: shared.DescribePullRequestEventsInput = field(metadata={'request': { 'media_type': 'application/json' }})
