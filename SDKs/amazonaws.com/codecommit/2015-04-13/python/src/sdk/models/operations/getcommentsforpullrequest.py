...
class GetCommentsForPullRequestHeaders:
    ...
    x_amz_target: GetCommentsForPullRequestXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetCommentsForPullRequestRequest:
    query_params: GetCommentsForPullRequestQueryParams = field(default=None)
    headers: GetCommentsForPullRequestHeaders = field(default=None)
    request: shared.GetCommentsForPullRequestInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class GetCommentsForPullRequestResponse:
    ...
    get_comments_for_pull_request_output: Optional[shared.GetCommentsForPullRequestOutput] = field(default=None)
