...
class GetCommentsForPullRequestHeaders:
    x_amz_target: GetCommentsForPullRequestXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetCommentsForPullRequestRequest:
    headers: GetCommentsForPullRequestHeaders = field()
    query_params: GetCommentsForPullRequestQueryParams = field()
    request: shared.GetCommentsForPullRequestInput = field(metadata={'request': { 'media_type': 'application/json' }})
