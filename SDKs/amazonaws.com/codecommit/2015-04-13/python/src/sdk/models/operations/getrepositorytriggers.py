...
class GetRepositoryTriggersHeaders:
    ...
    x_amz_target: GetRepositoryTriggersXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetRepositoryTriggersRequest:
    headers: GetRepositoryTriggersHeaders = field(default=None)
    request: shared.GetRepositoryTriggersInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class GetRepositoryTriggersResponse:
    ...
    get_repository_triggers_output: Optional[shared.GetRepositoryTriggersOutput] = field(default=None)
