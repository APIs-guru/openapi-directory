...
class GetRepositoryTriggersHeaders:
    x_amz_target: GetRepositoryTriggersXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetRepositoryTriggersRequest:
    headers: GetRepositoryTriggersHeaders = field()
    request: shared.GetRepositoryTriggersInput = field(metadata={'request': { 'media_type': 'application/json' }})
