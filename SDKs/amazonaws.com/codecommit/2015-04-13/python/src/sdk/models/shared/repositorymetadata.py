...
class RepositoryMetadata:
    ...
    clone_url_http: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'cloneUrlHttp' }})
    clone_url_ssh: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'cloneUrlSsh' }})
    ...
    default_branch: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'defaultBranch' }})
