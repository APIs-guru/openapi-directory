...
class MergeBranchesByFastForwardHeaders:
    x_amz_target: MergeBranchesByFastForwardXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class MergeBranchesByFastForwardRequest:
    headers: MergeBranchesByFastForwardHeaders = field()
    request: shared.MergeBranchesByFastForwardInput = field(metadata={'request': { 'media_type': 'application/json' }})
