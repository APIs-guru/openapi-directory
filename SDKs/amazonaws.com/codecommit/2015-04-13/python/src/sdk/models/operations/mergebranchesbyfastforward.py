...
class MergeBranchesByFastForwardHeaders:
    ...
    x_amz_target: MergeBranchesByFastForwardXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class MergeBranchesByFastForwardRequest:
    headers: MergeBranchesByFastForwardHeaders = field(default=None)
    request: shared.MergeBranchesByFastForwardInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class MergeBranchesByFastForwardResponse:
    ...
    merge_branches_by_fast_forward_output: Optional[shared.MergeBranchesByFastForwardOutput] = field(default=None)
