...
class MergeBranchesBySquashHeaders:
    x_amz_target: MergeBranchesBySquashXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class MergeBranchesBySquashRequest:
    headers: MergeBranchesBySquashHeaders = field()
    request: shared.MergeBranchesBySquashInput = field(metadata={'request': { 'media_type': 'application/json' }})
