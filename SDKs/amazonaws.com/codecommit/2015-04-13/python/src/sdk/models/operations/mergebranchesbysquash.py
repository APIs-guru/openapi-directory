...
class MergeBranchesBySquashHeaders:
    ...
    x_amz_target: MergeBranchesBySquashXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class MergeBranchesBySquashRequest:
    headers: MergeBranchesBySquashHeaders = field(default=None)
    request: shared.MergeBranchesBySquashInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class MergeBranchesBySquashResponse:
    ...
    merge_branches_by_squash_output: Optional[shared.MergeBranchesBySquashOutput] = field(default=None)
