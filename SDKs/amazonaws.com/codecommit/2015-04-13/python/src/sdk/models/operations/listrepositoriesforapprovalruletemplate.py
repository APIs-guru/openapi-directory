...
class ListRepositoriesForApprovalRuleTemplateHeaders:
    ...
    x_amz_target: ListRepositoriesForApprovalRuleTemplateXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
