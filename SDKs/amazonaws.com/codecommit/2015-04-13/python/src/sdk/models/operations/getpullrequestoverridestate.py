...
class GetPullRequestOverrideStateHeaders:
    x_amz_target: GetPullRequestOverrideStateXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetPullRequestOverrideStateRequest:
    headers: GetPullRequestOverrideStateHeaders = field()
    request: shared.GetPullRequestOverrideStateInput = field(metadata={'request': { 'media_type': 'application/json' }})
