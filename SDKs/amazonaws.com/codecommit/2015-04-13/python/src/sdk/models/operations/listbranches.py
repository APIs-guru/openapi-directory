...
class ListBranchesHeaders:
    x_amz_target: ListBranchesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListBranchesRequest:
    ...
    request: shared.ListBranchesInput = field(metadata={'request': { 'media_type': 'application/json' }})
...
class ListBranchesResponse:
    ...
    list_branches_output: Optional[shared.ListBranchesOutput] = field(default=None)
