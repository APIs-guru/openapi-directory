...
var BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput = /** @class */ (function (_super) {
    __extends(BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput, _super);
    ...
    ], BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput.prototype, "disassociatedRepositoryNames", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=errors", elemType: BatchDisassociateApprovalRuleTemplateFromRepositoriesError }),
        __metadata("design:type", Array)
    ], BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput.prototype, "errors", void 0);
    return BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput;
}(SpeakeasyBase));
export { BatchDisassociateApprovalRuleTemplateFromRepositoriesOutput };
