...
class BatchDetectSyntaxHeaders:
    x_amz_target: BatchDetectSyntaxXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class BatchDetectSyntaxRequest:
    headers: BatchDetectSyntaxHeaders = field()
    request: shared.BatchDetectSyntaxRequest = field(metadata={'request': { 'media_type': 'application/json' }})
