...
class CreateEntityRecognizerHeaders:
    ...
    x_amz_target: CreateEntityRecognizerXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateEntityRecognizerRequest:
    headers: CreateEntityRecognizerHeaders = field(default=None)
    request: shared.CreateEntityRecognizerRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
