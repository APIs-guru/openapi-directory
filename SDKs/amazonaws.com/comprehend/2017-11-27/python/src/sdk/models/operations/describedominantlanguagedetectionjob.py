...
class DescribeDominantLanguageDetectionJobHeaders:
    ...
    x_amz_target: DescribeDominantLanguageDetectionJobXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeDominantLanguageDetectionJobRequest:
    headers: DescribeDominantLanguageDetectionJobHeaders = field(default=None)
    request: shared.DescribeDominantLanguageDetectionJobRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
