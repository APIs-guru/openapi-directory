...
class StopTrainingDocumentClassifierHeaders:
    x_amz_target: StopTrainingDocumentClassifierXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StopTrainingDocumentClassifierRequest:
    headers: StopTrainingDocumentClassifierHeaders = field()
    request: shared.StopTrainingDocumentClassifierRequest = field(metadata={'request': { 'media_type': 'application/json' }})
