...
class BatchDetectKeyPhrasesHeaders:
    x_amz_target: BatchDetectKeyPhrasesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class BatchDetectKeyPhrasesRequest:
    headers: BatchDetectKeyPhrasesHeaders = field()
    request: shared.BatchDetectKeyPhrasesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
