...
class BatchDetectEntitiesHeaders:
    ...
    x_amz_target: BatchDetectEntitiesXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class BatchDetectEntitiesRequest:
    headers: BatchDetectEntitiesHeaders = field(default=None)
    request: shared.BatchDetectEntitiesRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
