...
class BatchDetectSentimentHeaders:
    x_amz_target: BatchDetectSentimentXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class BatchDetectSentimentRequest:
    headers: BatchDetectSentimentHeaders = field()
    request: shared.BatchDetectSentimentRequest = field(metadata={'request': { 'media_type': 'application/json' }})
