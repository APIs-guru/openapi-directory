...
class CreateEndpointHeaders:
    ...
    x_amz_target: CreateEndpointXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
    

@dataclass
class CreateEndpointRequest:
    headers: CreateEndpointHeaders = field(default=None)
    request: shared.CreateEndpointRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
