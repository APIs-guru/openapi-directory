...
class CreateEndpointHeaders:
    x_amz_target: CreateEndpointXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateEndpointRequest:
    headers: CreateEndpointHeaders = field()
    request: shared.CreateEndpointRequest = field(metadata={'request': { 'media_type': 'application/json' }})
