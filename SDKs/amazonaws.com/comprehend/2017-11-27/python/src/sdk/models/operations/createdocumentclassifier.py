...
class CreateDocumentClassifierHeaders:
    ...
    x_amz_target: CreateDocumentClassifierXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateDocumentClassifierRequest:
    headers: CreateDocumentClassifierHeaders = field(default=None)
    request: shared.CreateDocumentClassifierRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
