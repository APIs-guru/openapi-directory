...
class DetectSyntaxHeaders:
    x_amz_target: DetectSyntaxXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DetectSyntaxRequest:
    headers: DetectSyntaxHeaders = field()
    request: shared.DetectSyntaxRequest = field(metadata={'request': { 'media_type': 'application/json' }})
