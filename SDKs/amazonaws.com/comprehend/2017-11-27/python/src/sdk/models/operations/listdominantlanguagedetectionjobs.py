...
class ListDominantLanguageDetectionJobsHeaders:
    ...
    x_amz_target: ListDominantLanguageDetectionJobsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ListDominantLanguageDetectionJobsRequest:
    query_params: ListDominantLanguageDetectionJobsQueryParams = field(default=None)
    headers: ListDominantLanguageDetectionJobsHeaders = field(default=None)
    request: shared.ListDominantLanguageDetectionJobsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
