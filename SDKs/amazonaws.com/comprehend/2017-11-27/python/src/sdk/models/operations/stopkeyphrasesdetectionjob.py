...
class StopKeyPhrasesDetectionJobHeaders:
    ...
    x_amz_target: StopKeyPhrasesDetectionJobXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class StopKeyPhrasesDetectionJobRequest:
    headers: StopKeyPhrasesDetectionJobHeaders = field(default=None)
    request: shared.StopKeyPhrasesDetectionJobRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
