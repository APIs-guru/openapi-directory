...
class DetectSentimentHeaders:
    x_amz_target: DetectSentimentXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DetectSentimentRequest:
    headers: DetectSentimentHeaders = field()
    request: shared.DetectSentimentRequest = field(metadata={'request': { 'media_type': 'application/json' }})
