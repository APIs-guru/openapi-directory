...
class StartDocumentClassificationJobHeaders:
    x_amz_target: StartDocumentClassificationJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartDocumentClassificationJobRequest:
    headers: StartDocumentClassificationJobHeaders = field()
    request: shared.StartDocumentClassificationJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
