...
class StartDominantLanguageDetectionJobHeaders:
    ...
    x_amz_target: StartDominantLanguageDetectionJobXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class StartDominantLanguageDetectionJobRequest:
    headers: StartDominantLanguageDetectionJobHeaders = field(default=None)
    request: shared.StartDominantLanguageDetectionJobRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
