...
class ListDocumentClassificationJobsHeaders:
    x_amz_target: ListDocumentClassificationJobsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListDocumentClassificationJobsRequest:
    headers: ListDocumentClassificationJobsHeaders = field()
    query_params: ListDocumentClassificationJobsQueryParams = field()
    request: shared.ListDocumentClassificationJobsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
