...
class StopPiiEntitiesDetectionJobHeaders:
    x_amz_target: StopPiiEntitiesDetectionJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StopPiiEntitiesDetectionJobRequest:
    headers: StopPiiEntitiesDetectionJobHeaders = field()
    request: shared.StopPiiEntitiesDetectionJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
