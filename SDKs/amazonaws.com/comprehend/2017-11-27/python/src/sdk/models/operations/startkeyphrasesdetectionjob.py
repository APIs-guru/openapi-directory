...
class StartKeyPhrasesDetectionJobHeaders:
    ...
    x_amz_target: StartKeyPhrasesDetectionJobXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class StartKeyPhrasesDetectionJobRequest:
    headers: StartKeyPhrasesDetectionJobHeaders = field(default=None)
    request: shared.StartKeyPhrasesDetectionJobRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
