...
class DeleteEntityRecognizerHeaders:
    x_amz_target: DeleteEntityRecognizerXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteEntityRecognizerRequest:
    headers: DeleteEntityRecognizerHeaders = field()
    request: shared.DeleteEntityRecognizerRequest = field(metadata={'request': { 'media_type': 'application/json' }})
