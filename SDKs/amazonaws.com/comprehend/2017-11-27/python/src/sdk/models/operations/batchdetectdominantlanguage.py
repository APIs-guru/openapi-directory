...
class BatchDetectDominantLanguageHeaders:
    x_amz_target: BatchDetectDominantLanguageXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class BatchDetectDominantLanguageRequest:
    headers: BatchDetectDominantLanguageHeaders = field()
    request: shared.BatchDetectDominantLanguageRequest = field(metadata={'request': { 'media_type': 'application/json' }})
