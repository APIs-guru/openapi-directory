...
class ListEntitiesDetectionJobsHeaders:
    x_amz_target: ListEntitiesDetectionJobsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListEntitiesDetectionJobsRequest:
    headers: ListEntitiesDetectionJobsHeaders = field()
    query_params: ListEntitiesDetectionJobsQueryParams = field()
    request: shared.ListEntitiesDetectionJobsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
