...
class StopSentimentDetectionJobHeaders:
    x_amz_target: StopSentimentDetectionJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StopSentimentDetectionJobRequest:
    headers: StopSentimentDetectionJobHeaders = field()
    request: shared.StopSentimentDetectionJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
