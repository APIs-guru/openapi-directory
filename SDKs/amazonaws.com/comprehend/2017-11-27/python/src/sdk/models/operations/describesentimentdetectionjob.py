...
class DescribeSentimentDetectionJobHeaders:
    ...
    x_amz_target: DescribeSentimentDetectionJobXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeSentimentDetectionJobRequest:
    headers: DescribeSentimentDetectionJobHeaders = field(default=None)
    request: shared.DescribeSentimentDetectionJobRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
