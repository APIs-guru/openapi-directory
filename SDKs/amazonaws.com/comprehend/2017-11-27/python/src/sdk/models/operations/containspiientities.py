...
class ContainsPiiEntitiesHeaders:
    x_amz_target: ContainsPiiEntitiesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ContainsPiiEntitiesRequest:
    headers: ContainsPiiEntitiesHeaders = field()
    request: shared.ContainsPiiEntitiesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
