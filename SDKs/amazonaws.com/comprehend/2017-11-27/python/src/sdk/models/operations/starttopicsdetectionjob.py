...
class StartTopicsDetectionJobHeaders:
    x_amz_target: StartTopicsDetectionJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartTopicsDetectionJobRequest:
    headers: StartTopicsDetectionJobHeaders = field()
    request: shared.StartTopicsDetectionJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
