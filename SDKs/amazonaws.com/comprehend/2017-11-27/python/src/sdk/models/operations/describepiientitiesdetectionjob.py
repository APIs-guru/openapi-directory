...
class DescribePiiEntitiesDetectionJobHeaders:
    x_amz_target: DescribePiiEntitiesDetectionJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribePiiEntitiesDetectionJobRequest:
    headers: DescribePiiEntitiesDetectionJobHeaders = field()
    request: shared.DescribePiiEntitiesDetectionJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
