...
class StartEntitiesDetectionJobHeaders:
    ...
    x_amz_target: StartEntitiesDetectionJobXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class StartEntitiesDetectionJobRequest:
    headers: StartEntitiesDetectionJobHeaders = field(default=None)
    request: shared.StartEntitiesDetectionJobRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
