...
class StartEventsDetectionJobHeaders:
    x_amz_target: StartEventsDetectionJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartEventsDetectionJobRequest:
    headers: StartEventsDetectionJobHeaders = field()
    request: shared.StartEventsDetectionJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
