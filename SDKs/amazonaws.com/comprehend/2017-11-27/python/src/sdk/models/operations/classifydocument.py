...
class ClassifyDocumentHeaders:
    x_amz_target: ClassifyDocumentXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ClassifyDocumentRequest:
    headers: ClassifyDocumentHeaders = field()
    request: shared.ClassifyDocumentRequest = field(metadata={'request': { 'media_type': 'application/json' }})
