...
class StartPiiEntitiesDetectionJobHeaders:
    x_amz_target: StartPiiEntitiesDetectionJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartPiiEntitiesDetectionJobRequest:
    headers: StartPiiEntitiesDetectionJobHeaders = field()
    request: shared.StartPiiEntitiesDetectionJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
