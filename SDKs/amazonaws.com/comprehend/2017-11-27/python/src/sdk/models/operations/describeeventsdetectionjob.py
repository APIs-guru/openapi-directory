...
class DescribeEventsDetectionJobHeaders:
    ...
    x_amz_target: DescribeEventsDetectionJobXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeEventsDetectionJobRequest:
    headers: DescribeEventsDetectionJobHeaders = field(default=None)
    request: shared.DescribeEventsDetectionJobRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
