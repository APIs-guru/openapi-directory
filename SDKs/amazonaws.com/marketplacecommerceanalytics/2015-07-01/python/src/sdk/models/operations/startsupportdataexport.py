...
class StartSupportDataExportHeaders:
    ...
    x_amz_target: StartSupportDataExportXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class StartSupportDataExportRequest:
    headers: StartSupportDataExportHeaders = field(default=None)
    request: shared.StartSupportDataExportRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
