...
**/
var RedshiftMetadata = /** @class */ (function (_super) {
    __extends(RedshiftMetadata, _super);
    ...
    ], RedshiftMetadata.prototype, "databaseUserName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=RedshiftDatabase" }),
        __metadata("design:type", RedshiftDatabase)
    ], RedshiftMetadata.prototype, "redshiftDatabase", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=SelectSqlQuery" }),
        __metadata("design:type", String)
    ], RedshiftMetadata.prototype, "selectSqlQuery", void 0);
    return RedshiftMetadata;
}(SpeakeasyBase));
export { RedshiftMetadata };
