...
class DescribeEvaluationsHeaders:
    x_amz_target: DescribeEvaluationsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeEvaluationsRequest:
    headers: DescribeEvaluationsHeaders = field()
    query_params: DescribeEvaluationsQueryParams = field()
    request: shared.DescribeEvaluationsInput = field(metadata={'request': { 'media_type': 'application/json' }})
