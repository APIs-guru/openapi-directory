...
class UpdateEvaluationHeaders:
    x_amz_target: UpdateEvaluationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateEvaluationRequest:
    headers: UpdateEvaluationHeaders = field()
    request: shared.UpdateEvaluationInput = field(metadata={'request': { 'media_type': 'application/json' }})
