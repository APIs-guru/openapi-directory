...
class DeleteMlModelHeaders:
    x_amz_target: DeleteMlModelXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteMlModelRequest:
    headers: DeleteMlModelHeaders = field()
    request: shared.DeleteMlModelInput = field(metadata={'request': { 'media_type': 'application/json' }})
