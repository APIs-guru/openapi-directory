...
class UpdateDataSourceHeaders:
    ...
    x_amz_target: UpdateDataSourceXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateDataSourceRequest:
    headers: UpdateDataSourceHeaders = field(default=None)
    request: shared.UpdateDataSourceInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
