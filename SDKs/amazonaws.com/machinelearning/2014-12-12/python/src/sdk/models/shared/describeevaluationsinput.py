...
from . import evaluationfiltervariable_enum
...
class DescribeEvaluationsInput:
    ...
    filter_variable: Optional[evaluationfiltervariable_enum.EvaluationFilterVariableEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'FilterVariable' }})
