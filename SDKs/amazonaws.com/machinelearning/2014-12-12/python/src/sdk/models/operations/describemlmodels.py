...
class DescribeMlModelsHeaders:
    x_amz_target: DescribeMlModelsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeMlModelsRequest:
    headers: DescribeMlModelsHeaders = field()
    query_params: DescribeMlModelsQueryParams = field()
    request: shared.DescribeMlModelsInput = field(metadata={'request': { 'media_type': 'application/json' }})
