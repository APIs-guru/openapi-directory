...
class CreateMlModelHeaders:
    x_amz_target: CreateMlModelXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateMlModelRequest:
    headers: CreateMlModelHeaders = field()
    request: shared.CreateMlModelInput = field(metadata={'request': { 'media_type': 'application/json' }})
