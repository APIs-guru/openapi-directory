...
class CreateRealtimeEndpointHeaders:
    x_amz_target: CreateRealtimeEndpointXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateRealtimeEndpointRequest:
    headers: CreateRealtimeEndpointHeaders = field()
    request: shared.CreateRealtimeEndpointInput = field(metadata={'request': { 'media_type': 'application/json' }})
