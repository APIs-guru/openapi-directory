...
class PredictHeaders:
    x_amz_target: PredictXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PredictRequest:
    headers: PredictHeaders = field()
    request: shared.PredictInput = field(metadata={'request': { 'media_type': 'application/json' }})
