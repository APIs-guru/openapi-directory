...
class CreateDataSourceFromRdsHeaders:
    x_amz_target: CreateDataSourceFromRdsxAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateDataSourceFromRdsRequest:
    headers: CreateDataSourceFromRdsHeaders = field()
    request: shared.CreateDataSourceFromRdsInput = field(metadata={'request': { 'media_type': 'application/json' }})
