...
from . import mlmodelfiltervariable_enum
...
class DescribeMlModelsInput:
    ...
    filter_variable: Optional[mlmodelfiltervariable_enum.MlModelFilterVariableEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'FilterVariable' }})
