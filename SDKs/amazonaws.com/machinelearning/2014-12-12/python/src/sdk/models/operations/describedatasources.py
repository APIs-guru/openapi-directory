...
class DescribeDataSourcesHeaders:
    x_amz_target: DescribeDataSourcesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeDataSourcesRequest:
    headers: DescribeDataSourcesHeaders = field()
    query_params: DescribeDataSourcesQueryParams = field()
    request: shared.DescribeDataSourcesInput = field(metadata={'request': { 'media_type': 'application/json' }})
