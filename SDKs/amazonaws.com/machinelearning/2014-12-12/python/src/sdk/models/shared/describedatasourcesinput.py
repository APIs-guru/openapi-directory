...
from . import datasourcefiltervariable_enum
...
class DescribeDataSourcesInput:
    ...
    filter_variable: Optional[datasourcefiltervariable_enum.DataSourceFilterVariableEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'FilterVariable' }})
