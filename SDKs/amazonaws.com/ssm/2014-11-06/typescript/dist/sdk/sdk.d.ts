...
export declare const ServerList: readonly ["http://ssm.{region}.amazonaws.com", "https://ssm.{region}.amazonaws.com", "http://ssm.{region}.amazonaws.com.cn", "https://ssm.{region}.amazonaws.com.cn"];
...
export declare class SDK {
    ...
    **/
    associateOpsItemRelatedItem(req: operations.AssociateOpsItemRelatedItemRequest, config?: AxiosRequestConfig): Promise<operations.AssociateOpsItemRelatedItemResponse>;
    /**
    ...
    **/
    cancelCommand(req: operations.CancelCommandRequest, config?: AxiosRequestConfig): Promise<operations.CancelCommandResponse>;
    /**
    ...
    **/
    cancelMaintenanceWindowExecution(req: operations.CancelMaintenanceWindowExecutionRequest, config?: AxiosRequestConfig): Promise<operations.CancelMaintenanceWindowExecutionResponse>;
    /**
    ...
    **/
    createActivation(req: operations.CreateActivationRequest, config?: AxiosRequestConfig): Promise<operations.CreateActivationResponse>;
    /**
    ...
    **/
    createAssociation(req: operations.CreateAssociationRequest, config?: AxiosRequestConfig): Promise<operations.CreateAssociationResponse>;
    /**
    ...
    **/
    createAssociationBatch(req: operations.CreateAssociationBatchRequest, config?: AxiosRequestConfig): Promise<operations.CreateAssociationBatchResponse>;
    /**
    ...
    **/
    createMaintenanceWindow(req: operations.CreateMaintenanceWindowRequest, config?: AxiosRequestConfig): Promise<operations.CreateMaintenanceWindowResponse>;
    /**
    ...
    **/
    createOpsItem(req: operations.CreateOpsItemRequest, config?: AxiosRequestConfig): Promise<operations.CreateOpsItemResponse>;
    /**
    ...
    **/
    createOpsMetadata(req: operations.CreateOpsMetadataRequest, config?: AxiosRequestConfig): Promise<operations.CreateOpsMetadataResponse>;
    /**
    ...
    **/
    createPatchBaseline(req: operations.CreatePatchBaselineRequest, config?: AxiosRequestConfig): Promise<operations.CreatePatchBaselineResponse>;
    /**
    ...
    **/
    createResourceDataSync(req: operations.CreateResourceDataSyncRequest, config?: AxiosRequestConfig): Promise<operations.CreateResourceDataSyncResponse>;
    /**
    ...
    **/
    deleteActivation(req: operations.DeleteActivationRequest, config?: AxiosRequestConfig): Promise<operations.DeleteActivationResponse>;
    /**
    ...
    **/
    deleteInventory(req: operations.DeleteInventoryRequest, config?: AxiosRequestConfig): Promise<operations.DeleteInventoryResponse>;
    /**
     * deleteMaintenanceWindow - Deletes a maintenance window.
    **/
    deleteMaintenanceWindow(req: operations.DeleteMaintenanceWindowRequest, config?: AxiosRequestConfig): Promise<operations.DeleteMaintenanceWindowResponse>;
    /**
     * deleteOpsMetadata - Delete OpsMetadata related to an application.
    **/
    deleteOpsMetadata(req: operations.DeleteOpsMetadataRequest, config?: AxiosRequestConfig): Promise<operations.DeleteOpsMetadataResponse>;
    /**
    ...
    **/
    deleteParameters(req: operations.DeleteParametersRequest, config?: AxiosRequestConfig): Promise<operations.DeleteParametersResponse>;
    /**
     * deletePatchBaseline - Deletes a patch baseline.
    **/
    deletePatchBaseline(req: operations.DeletePatchBaselineRequest, config?: AxiosRequestConfig): Promise<operations.DeletePatchBaselineResponse>;
    /**
    ...
    **/
    deleteResourceDataSync(req: operations.DeleteResourceDataSyncRequest, config?: AxiosRequestConfig): Promise<operations.DeleteResourceDataSyncResponse>;
    /**
    ...
    **/
    deregisterManagedInstance(req: operations.DeregisterManagedInstanceRequest, config?: AxiosRequestConfig): Promise<operations.DeregisterManagedInstanceResponse>;
    /**
     * deregisterPatchBaselineForPatchGroup - Removes a patch group from a patch baseline.
    **/
    deregisterPatchBaselineForPatchGroup(req: operations.DeregisterPatchBaselineForPatchGroupRequest, config?: AxiosRequestConfig): Promise<operations.DeregisterPatchBaselineForPatchGroupResponse>;
    /**
     * deregisterTargetFromMaintenanceWindow - Removes a target from a maintenance window.
    **/
    deregisterTargetFromMaintenanceWindow(req: operations.DeregisterTargetFromMaintenanceWindowRequest, config?: AxiosRequestConfig): Promise<operations.DeregisterTargetFromMaintenanceWindowResponse>;
    /**
     * deregisterTaskFromMaintenanceWindow - Removes a task from a maintenance window.
    **/
    deregisterTaskFromMaintenanceWindow(req: operations.DeregisterTaskFromMaintenanceWindowRequest, config?: AxiosRequestConfig): Promise<operations.DeregisterTaskFromMaintenanceWindowResponse>;
    /**
    ...
    **/
    describeActivations(req: operations.DescribeActivationsRequest, config?: AxiosRequestConfig): Promise<operations.DescribeActivationsResponse>;
    /**
    ...
    **/
    describeAssociation(req: operations.DescribeAssociationRequest, config?: AxiosRequestConfig): Promise<operations.DescribeAssociationResponse>;
    /**
     * describeAssociationExecutionTargets - Views information about a specific execution of a specific association.
    **/
    describeAssociationExecutionTargets(req: operations.DescribeAssociationExecutionTargetsRequest, config?: AxiosRequestConfig): Promise<operations.DescribeAssociationExecutionTargetsResponse>;
    /**
     * describeAssociationExecutions - Views all executions for a specific association ID.
    **/
    describeAssociationExecutions(req: operations.DescribeAssociationExecutionsRequest, config?: AxiosRequestConfig): Promise<operations.DescribeAssociationExecutionsResponse>;
    /**
     * describeAutomationExecutions - Provides details about all active and terminated Automation executions.
    **/
    describeAutomationExecutions(req: operations.DescribeAutomationExecutionsRequest, config?: AxiosRequestConfig): Promise<operations.DescribeAutomationExecutionsResponse>;
    /**
     * describeAutomationStepExecutions - Information about all active and terminated step executions in an Automation workflow.
    **/
    describeAutomationStepExecutions(req: operations.DescribeAutomationStepExecutionsRequest, config?: AxiosRequestConfig): Promise<operations.DescribeAutomationStepExecutionsResponse>;
    /**
     * describeAvailablePatches - Lists all patches eligible to be included in a patch baseline.
    **/
    describeAvailablePatches(req: operations.DescribeAvailablePatchesRequest, config?: AxiosRequestConfig): Promise<operations.DescribeAvailablePatchesResponse>;
    /**
     * describeDocument - Describes the specified Amazon Web Services Systems Manager document (SSM document).
    **/
    describeDocument(req: operations.DescribeDocumentRequest, config?: AxiosRequestConfig): Promise<operations.DescribeDocumentResponse>;
    /**
    ...
    **/
    describeDocumentPermission(req: operations.DescribeDocumentPermissionRequest, config?: AxiosRequestConfig): Promise<operations.DescribeDocumentPermissionResponse>;
    /**
     * describeEffectiveInstanceAssociations - All associations for the instance(s).
    **/
    describeEffectiveInstanceAssociations(req: operations.DescribeEffectiveInstanceAssociationsRequest, config?: AxiosRequestConfig): Promise<operations.DescribeEffectiveInstanceAssociationsResponse>;
    /**
    ...
    **/
    describeEffectivePatchesForPatchBaseline(req: operations.DescribeEffectivePatchesForPatchBaselineRequest, config?: AxiosRequestConfig): Promise<operations.DescribeEffectivePatchesForPatchBaselineResponse>;
    /**
     * describeInstanceAssociationsStatus - The status of the associations for the instance(s).
    **/
    describeInstanceAssociationsStatus(req: operations.DescribeInstanceAssociationsStatusRequest, config?: AxiosRequestConfig): Promise<operations.DescribeInstanceAssociationsStatusResponse>;
    /**
    ...
    **/
    describeInstanceInformation(req: operations.DescribeInstanceInformationRequest, config?: AxiosRequestConfig): Promise<operations.DescribeInstanceInformationResponse>;
    /**
     * describeInstancePatchStates - Retrieves the high-level patch state of one or more instances.
    **/
    describeInstancePatchStates(req: operations.DescribeInstancePatchStatesRequest, config?: AxiosRequestConfig): Promise<operations.DescribeInstancePatchStatesResponse>;
    /**
    ...
    **/
    describeInstancePatchStatesForPatchGroup(req: operations.DescribeInstancePatchStatesForPatchGroupRequest, config?: AxiosRequestConfig): Promise<operations.DescribeInstancePatchStatesForPatchGroupResponse>;
    /**
    ...
    **/
    describeInstancePatches(req: operations.DescribeInstancePatchesRequest, config?: AxiosRequestConfig): Promise<operations.DescribeInstancePatchesResponse>;
    /**
     * describeInventoryDeletions - Describes a specific delete inventory operation.
    **/
    describeInventoryDeletions(req: operations.DescribeInventoryDeletionsRequest, config?: AxiosRequestConfig): Promise<operations.DescribeInventoryDeletionsResponse>;
    /**
    ...
    **/
    describeMaintenanceWindowExecutionTaskInvocations(req: operations.DescribeMaintenanceWindowExecutionTaskInvocationsRequest, config?: AxiosRequestConfig): Promise<operations.DescribeMaintenanceWindowExecutionTaskInvocationsResponse>;
    /**
     * describeMaintenanceWindowExecutionTasks - For a given maintenance window execution, lists the tasks that were run.
    **/
    describeMaintenanceWindowExecutionTasks(req: operations.DescribeMaintenanceWindowExecutionTasksRequest, config?: AxiosRequestConfig): Promise<operations.DescribeMaintenanceWindowExecutionTasksResponse>;
    /**
    ...
    **/
    describeMaintenanceWindowExecutions(req: operations.DescribeMaintenanceWindowExecutionsRequest, config?: AxiosRequestConfig): Promise<operations.DescribeMaintenanceWindowExecutionsResponse>;
    /**
     * describeMaintenanceWindowSchedule - Retrieves information about upcoming executions of a maintenance window.
    **/
    describeMaintenanceWindowSchedule(req: operations.DescribeMaintenanceWindowScheduleRequest, config?: AxiosRequestConfig): Promise<operations.DescribeMaintenanceWindowScheduleResponse>;
    /**
     * describeMaintenanceWindowTargets - Lists the targets registered with the maintenance window.
    **/
    describeMaintenanceWindowTargets(req: operations.DescribeMaintenanceWindowTargetsRequest, config?: AxiosRequestConfig): Promise<operations.DescribeMaintenanceWindowTargetsResponse>;
    /**
    ...
    **/
    describeMaintenanceWindowTasks(req: operations.DescribeMaintenanceWindowTasksRequest, config?: AxiosRequestConfig): Promise<operations.DescribeMaintenanceWindowTasksResponse>;
    /**
     * describeMaintenanceWindows - Retrieves the maintenance windows in an Amazon Web Services account.
    **/
    describeMaintenanceWindows(req: operations.DescribeMaintenanceWindowsRequest, config?: AxiosRequestConfig): Promise<operations.DescribeMaintenanceWindowsResponse>;
    /**
    ...
    **/
    describeMaintenanceWindowsForTarget(req: operations.DescribeMaintenanceWindowsForTargetRequest, config?: AxiosRequestConfig): Promise<operations.DescribeMaintenanceWindowsForTargetResponse>;
    /**
    ...
    **/
    describeOpsItems(req: operations.DescribeOpsItemsRequest, config?: AxiosRequestConfig): Promise<operations.DescribeOpsItemsResponse>;
    /**
    ...
    **/
    describePatchBaselines(req: operations.DescribePatchBaselinesRequest, config?: AxiosRequestConfig): Promise<operations.DescribePatchBaselinesResponse>;
    /**
     * describePatchGroupState - Returns high-level aggregated patch compliance state information for a patch group.
    **/
    describePatchGroupState(req: operations.DescribePatchGroupStateRequest, config?: AxiosRequestConfig): Promise<operations.DescribePatchGroupStateResponse>;
    /**
     * describePatchGroups - Lists all patch groups that have been registered with patch baselines.
    **/
    describePatchGroups(req: operations.DescribePatchGroupsRequest, config?: AxiosRequestConfig): Promise<operations.DescribePatchGroupsResponse>;
    /**
    ...
    **/
    describePatchProperties(req: operations.DescribePatchPropertiesRequest, config?: AxiosRequestConfig): Promise<operations.DescribePatchPropertiesResponse>;
    /**
    ...
    **/
    disassociateOpsItemRelatedItem(req: operations.DisassociateOpsItemRelatedItemRequest, config?: AxiosRequestConfig): Promise<operations.DisassociateOpsItemRelatedItemResponse>;
    /**
     * getAutomationExecution - Get detailed information about a particular Automation execution.
    **/
    getAutomationExecution(req: operations.GetAutomationExecutionRequest, config?: AxiosRequestConfig): Promise<operations.GetAutomationExecutionResponse>;
    /**
    ...
    **/
    getCalendarState(req: operations.GetCalendarStateRequest, config?: AxiosRequestConfig): Promise<operations.GetCalendarStateResponse>;
    /**
    ...
    **/
    getCommandInvocation(req: operations.GetCommandInvocationRequest, config?: AxiosRequestConfig): Promise<operations.GetCommandInvocationResponse>;
    /**
    ...
    **/
    getConnectionStatus(req: operations.GetConnectionStatusRequest, config?: AxiosRequestConfig): Promise<operations.GetConnectionStatusResponse>;
    /**
    ...
    **/
    getDefaultPatchBaseline(req: operations.GetDefaultPatchBaselineRequest, config?: AxiosRequestConfig): Promise<operations.GetDefaultPatchBaselineResponse>;
    /**
    ...
    **/
    getDeployablePatchSnapshotForInstance(req: operations.GetDeployablePatchSnapshotForInstanceRequest, config?: AxiosRequestConfig): Promise<operations.GetDeployablePatchSnapshotForInstanceResponse>;
    /**
    ...
    **/
    getInventorySchema(req: operations.GetInventorySchemaRequest, config?: AxiosRequestConfig): Promise<operations.GetInventorySchemaResponse>;
    /**
     * getMaintenanceWindow - Retrieves a maintenance window.
    **/
    getMaintenanceWindow(req: operations.GetMaintenanceWindowRequest, config?: AxiosRequestConfig): Promise<operations.GetMaintenanceWindowResponse>;
    /**
     * getMaintenanceWindowExecution - Retrieves details about a specific a maintenance window execution.
    **/
    getMaintenanceWindowExecution(req: operations.GetMaintenanceWindowExecutionRequest, config?: AxiosRequestConfig): Promise<operations.GetMaintenanceWindowExecutionResponse>;
    /**
    ...
    **/
    getMaintenanceWindowExecutionTask(req: operations.GetMaintenanceWindowExecutionTaskRequest, config?: AxiosRequestConfig): Promise<operations.GetMaintenanceWindowExecutionTaskResponse>;
    /**
     * getMaintenanceWindowExecutionTaskInvocation - Retrieves information about a specific task running on a specific target.
    **/
    getMaintenanceWindowExecutionTaskInvocation(req: operations.GetMaintenanceWindowExecutionTaskInvocationRequest, config?: AxiosRequestConfig): Promise<operations.GetMaintenanceWindowExecutionTaskInvocationResponse>;
    /**
     * getMaintenanceWindowTask - <p>Lists the tasks in a maintenance window.</p> <note> <p>For maintenance window tasks without a specified target, you can't supply values for <code>--max-errors</code> and <code>--max-concurrency</code>. Instead, the system inserts a placeholder value of <code>1</code>, which may be reported in the response to this command. These values don't affect the running of your task and can be ignored.</p> </note>
    **/
    getMaintenanceWindowTask(req: operations.GetMaintenanceWindowTaskRequest, config?: AxiosRequestConfig): Promise<operations.GetMaintenanceWindowTaskResponse>;
    /**
    ...
    **/
    getOpsItem(req: operations.GetOpsItemRequest, config?: AxiosRequestConfig): Promise<operations.GetOpsItemResponse>;
    /**
     * getOpsMetadata - View operational metadata related to an application in Application Manager.
    **/
    getOpsMetadata(req: operations.GetOpsMetadataRequest, config?: AxiosRequestConfig): Promise<operations.GetOpsMetadataResponse>;
    /**
     * getOpsSummary - View a summary of operations metadata (OpsData) based on specified filters and aggregators. OpsData can include information about Amazon Web Services Systems Manager OpsCenter operational workitems (OpsItems) as well as information about any Amazon Web Services resource or service configured to report OpsData to Amazon Web Services Systems Manager Explorer.
    **/
    getOpsSummary(req: operations.GetOpsSummaryRequest, config?: AxiosRequestConfig): Promise<operations.GetOpsSummaryResponse>;
    /**
    ...
    **/
    getParameter(req: operations.GetParameterRequest, config?: AxiosRequestConfig): Promise<operations.GetParameterResponse>;
    /**
     * getParameterHistory - Retrieves the history of all changes to a parameter.
    **/
    getParameterHistory(req: operations.GetParameterHistoryRequest, config?: AxiosRequestConfig): Promise<operations.GetParameterHistoryResponse>;
    /**
    ...
    **/
    getParameters(req: operations.GetParametersRequest, config?: AxiosRequestConfig): Promise<operations.GetParametersResponse>;
    /**
    ...
    **/
    getParametersByPath(req: operations.GetParametersByPathRequest, config?: AxiosRequestConfig): Promise<operations.GetParametersByPathResponse>;
    /**
     * getPatchBaseline - Retrieves information about a patch baseline.
    **/
    getPatchBaseline(req: operations.GetPatchBaselineRequest, config?: AxiosRequestConfig): Promise<operations.GetPatchBaselineResponse>;
    /**
     * getPatchBaselineForPatchGroup - Retrieves the patch baseline that should be used for the specified patch group.
    **/
    getPatchBaselineForPatchGroup(req: operations.GetPatchBaselineForPatchGroupRequest, config?: AxiosRequestConfig): Promise<operations.GetPatchBaselineForPatchGroupResponse>;
    /**
    ...
    **/
    getServiceSetting(req: operations.GetServiceSettingRequest, config?: AxiosRequestConfig): Promise<operations.GetServiceSettingResponse>;
    /**
    ...
    **/
    labelParameterVersion(req: operations.LabelParameterVersionRequest, config?: AxiosRequestConfig): Promise<operations.LabelParameterVersionResponse>;
    /**
     * listAssociationVersions - Retrieves all versions of an association for a specific association ID.
    **/
    listAssociationVersions(req: operations.ListAssociationVersionsRequest, config?: AxiosRequestConfig): Promise<operations.ListAssociationVersionsResponse>;
    /**
    ...
    **/
    listCommandInvocations(req: operations.ListCommandInvocationsRequest, config?: AxiosRequestConfig): Promise<operations.ListCommandInvocationsResponse>;
    /**
     * listCommands - Lists the commands requested by users of the Amazon Web Services account.
    **/
    listCommands(req: operations.ListCommandsRequest, config?: AxiosRequestConfig): Promise<operations.ListCommandsResponse>;
    /**
    ...
    **/
    listComplianceItems(req: operations.ListComplianceItemsRequest, config?: AxiosRequestConfig): Promise<operations.ListComplianceItemsResponse>;
    /**
    ...
    **/
    listComplianceSummaries(req: operations.ListComplianceSummariesRequest, config?: AxiosRequestConfig): Promise<operations.ListComplianceSummariesResponse>;
    /**
     * listDocumentMetadataHistory - Information about approval reviews for a version of a change template in Change Manager.
    **/
    listDocumentMetadataHistory(req: operations.ListDocumentMetadataHistoryRequest, config?: AxiosRequestConfig): Promise<operations.ListDocumentMetadataHistoryResponse>;
    /**
     * listDocumentVersions - List all versions for a document.
    **/
    listDocumentVersions(req: operations.ListDocumentVersionsRequest, config?: AxiosRequestConfig): Promise<operations.ListDocumentVersionsResponse>;
    /**
    ...
    **/
    listInventoryEntries(req: operations.ListInventoryEntriesRequest, config?: AxiosRequestConfig): Promise<operations.ListInventoryEntriesResponse>;
    /**
    ...
    **/
    listOpsItemEvents(req: operations.ListOpsItemEventsRequest, config?: AxiosRequestConfig): Promise<operations.ListOpsItemEventsResponse>;
    /**
     * listOpsItemRelatedItems - Lists all related-item resources associated with an OpsItem.
    **/
    listOpsItemRelatedItems(req: operations.ListOpsItemRelatedItemsRequest, config?: AxiosRequestConfig): Promise<operations.ListOpsItemRelatedItemsResponse>;
    /**
    ...
    **/
    listOpsMetadata(req: operations.ListOpsMetadataRequest, config?: AxiosRequestConfig): Promise<operations.ListOpsMetadataResponse>;
    /**
    ...
    **/
    listResourceComplianceSummaries(req: operations.ListResourceComplianceSummariesRequest, config?: AxiosRequestConfig): Promise<operations.ListResourceComplianceSummariesResponse>;
    /**
    ...
    **/
    listResourceDataSync(req: operations.ListResourceDataSyncRequest, config?: AxiosRequestConfig): Promise<operations.ListResourceDataSyncResponse>;
    /**
    ...
    **/
    modifyDocumentPermission(req: operations.ModifyDocumentPermissionRequest, config?: AxiosRequestConfig): Promise<operations.ModifyDocumentPermissionResponse>;
    /**
    ...
    **/
    putComplianceItems(req: operations.PutComplianceItemsRequest, config?: AxiosRequestConfig): Promise<operations.PutComplianceItemsResponse>;
    /**
    ...
    **/
    putInventory(req: operations.PutInventoryRequest, config?: AxiosRequestConfig): Promise<operations.PutInventoryResponse>;
    /**
     * putParameter - Add a parameter to the system.
    **/
    putParameter(req: operations.PutParameterRequest, config?: AxiosRequestConfig): Promise<operations.PutParameterResponse>;
    /**
    ...
    **/
    registerDefaultPatchBaseline(req: operations.RegisterDefaultPatchBaselineRequest, config?: AxiosRequestConfig): Promise<operations.RegisterDefaultPatchBaselineResponse>;
    /**
     * registerPatchBaselineForPatchGroup - Registers a patch baseline for a patch group.
    **/
    registerPatchBaselineForPatchGroup(req: operations.RegisterPatchBaselineForPatchGroupRequest, config?: AxiosRequestConfig): Promise<operations.RegisterPatchBaselineForPatchGroupResponse>;
    /**
     * registerTargetWithMaintenanceWindow - Registers a target with a maintenance window.
    **/
    registerTargetWithMaintenanceWindow(req: operations.RegisterTargetWithMaintenanceWindowRequest, config?: AxiosRequestConfig): Promise<operations.RegisterTargetWithMaintenanceWindowResponse>;
    /**
     * registerTaskWithMaintenanceWindow - Adds a new task to a maintenance window.
    **/
    registerTaskWithMaintenanceWindow(req: operations.RegisterTaskWithMaintenanceWindowRequest, config?: AxiosRequestConfig): Promise<operations.RegisterTaskWithMaintenanceWindowResponse>;
    /**
    ...
    **/
    resetServiceSetting(req: operations.ResetServiceSettingRequest, config?: AxiosRequestConfig): Promise<operations.ResetServiceSettingResponse>;
    /**
    ...
    **/
    resumeSession(req: operations.ResumeSessionRequest, config?: AxiosRequestConfig): Promise<operations.ResumeSessionResponse>;
    /**
     * sendAutomationSignal - Sends a signal to an Automation execution to change the current behavior or status of the execution.
    **/
    sendAutomationSignal(req: operations.SendAutomationSignalRequest, config?: AxiosRequestConfig): Promise<operations.SendAutomationSignalResponse>;
    /**
    ...
    **/
    startAssociationsOnce(req: operations.StartAssociationsOnceRequest, config?: AxiosRequestConfig): Promise<operations.StartAssociationsOnceResponse>;
    /**
     * startAutomationExecution - Initiates execution of an Automation runbook.
    **/
    startAutomationExecution(req: operations.StartAutomationExecutionRequest, config?: AxiosRequestConfig): Promise<operations.StartAutomationExecutionResponse>;
    /**
    ...
    **/
    startChangeRequestExecution(req: operations.StartChangeRequestExecutionRequest, config?: AxiosRequestConfig): Promise<operations.StartChangeRequestExecutionResponse>;
    /**
    ...
    **/
    stopAutomationExecution(req: operations.StopAutomationExecutionRequest, config?: AxiosRequestConfig): Promise<operations.StopAutomationExecutionResponse>;
    /**
    ...
    **/
    unlabelParameterVersion(req: operations.UnlabelParameterVersionRequest, config?: AxiosRequestConfig): Promise<operations.UnlabelParameterVersionResponse>;
    /**
    ...
    **/
    updateAssociation(req: operations.UpdateAssociationRequest, config?: AxiosRequestConfig): Promise<operations.UpdateAssociationResponse>;
    /**
    ...
    **/
    updateAssociationStatus(req: operations.UpdateAssociationStatusRequest, config?: AxiosRequestConfig): Promise<operations.UpdateAssociationStatusResponse>;
    /**
    ...
    **/
    updateDocumentDefaultVersion(req: operations.UpdateDocumentDefaultVersionRequest, config?: AxiosRequestConfig): Promise<operations.UpdateDocumentDefaultVersionResponse>;
    /**
    ...
    **/
    updateDocumentMetadata(req: operations.UpdateDocumentMetadataRequest, config?: AxiosRequestConfig): Promise<operations.UpdateDocumentMetadataResponse>;
    /**
    ...
    **/
    updateMaintenanceWindowTarget(req: operations.UpdateMaintenanceWindowTargetRequest, config?: AxiosRequestConfig): Promise<operations.UpdateMaintenanceWindowTargetResponse>;
    /**
    ...
    **/
    updateMaintenanceWindowTask(req: operations.UpdateMaintenanceWindowTaskRequest, config?: AxiosRequestConfig): Promise<operations.UpdateMaintenanceWindowTaskResponse>;
    /**
    ...
    **/
    updateManagedInstanceRole(req: operations.UpdateManagedInstanceRoleRequest, config?: AxiosRequestConfig): Promise<operations.UpdateManagedInstanceRoleResponse>;
    /**
    ...
    **/
    updateOpsItem(req: operations.UpdateOpsItemRequest, config?: AxiosRequestConfig): Promise<operations.UpdateOpsItemResponse>;
    /**
    ...
    **/
    updateOpsMetadata(req: operations.UpdateOpsMetadataRequest, config?: AxiosRequestConfig): Promise<operations.UpdateOpsMetadataResponse>;
    /**
    ...
    **/
    updatePatchBaseline(req: operations.UpdatePatchBaselineRequest, config?: AxiosRequestConfig): Promise<operations.UpdatePatchBaselineResponse>;
    /**
    ...
    **/
    updateResourceDataSync(req: operations.UpdateResourceDataSyncRequest, config?: AxiosRequestConfig): Promise<operations.UpdateResourceDataSyncResponse>;
    /**
    ...
    **/
    updateServiceSetting(req: operations.UpdateServiceSettingRequest, config?: AxiosRequestConfig): Promise<operations.UpdateServiceSettingResponse>;
}
export {};
