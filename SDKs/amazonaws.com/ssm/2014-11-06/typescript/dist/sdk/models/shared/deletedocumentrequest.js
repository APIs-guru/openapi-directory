...
var DeleteDocumentRequest = /** @class */ (function (_super) {
    ...
    ], DeleteDocumentRequest.prototype, "documentVersion", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Force" }),
        __metadata("design:type", Boolean)
    ], DeleteDocumentRequest.prototype, "force", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Name" }),
        __metadata("design:type", String)
    ], DeleteDocumentRequest.prototype, "name", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=VersionName" }),
        __metadata("design:type", String)
    ], DeleteDocumentRequest.prototype, "versionName", void 0);
