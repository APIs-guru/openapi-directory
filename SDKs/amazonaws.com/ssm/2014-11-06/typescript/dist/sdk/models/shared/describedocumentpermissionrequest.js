...
var DescribeDocumentPermissionRequest = /** @class */ (function (_super) {
    ...
    ], DescribeDocumentPermissionRequest.prototype, "maxResults", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Name" }),
        __metadata("design:type", String)
    ], DescribeDocumentPermissionRequest.prototype, "name", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=NextToken" }),
        __metadata("design:type", String)
    ], DescribeDocumentPermissionRequest.prototype, "nextToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=PermissionType" }),
        __metadata("design:type", String)
    ], DescribeDocumentPermissionRequest.prototype, "permissionType", void 0);
