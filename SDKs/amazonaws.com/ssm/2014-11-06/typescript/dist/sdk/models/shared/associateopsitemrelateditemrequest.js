...
var AssociateOpsItemRelatedItemRequest = /** @class */ (function (_super) {
    ...
    ], AssociateOpsItemRelatedItemRequest.prototype, "associationType", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=OpsItemId" }),
        __metadata("design:type", String)
    ], AssociateOpsItemRelatedItemRequest.prototype, "opsItemId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ResourceType" }),
        __metadata("design:type", String)
    ], AssociateOpsItemRelatedItemRequest.prototype, "resourceType", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ResourceUri" }),
        __metadata("design:type", String)
    ], AssociateOpsItemRelatedItemRequest.prototype, "resourceUri", void 0);
