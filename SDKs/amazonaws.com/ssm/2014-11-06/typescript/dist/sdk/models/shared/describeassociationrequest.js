...
var DescribeAssociationRequest = /** @class */ (function (_super) {
    ...
    ], DescribeAssociationRequest.prototype, "associationId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=AssociationVersion" }),
        __metadata("design:type", String)
    ], DescribeAssociationRequest.prototype, "associationVersion", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=InstanceId" }),
        __metadata("design:type", String)
    ], DescribeAssociationRequest.prototype, "instanceId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Name" }),
        __metadata("design:type", String)
    ], DescribeAssociationRequest.prototype, "name", void 0);
