...
var GetDocumentRequest = /** @class */ (function (_super) {
    ...
    ], GetDocumentRequest.prototype, "documentFormat", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=DocumentVersion" }),
        __metadata("design:type", String)
    ], GetDocumentRequest.prototype, "documentVersion", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Name" }),
        __metadata("design:type", String)
    ], GetDocumentRequest.prototype, "name", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=VersionName" }),
        __metadata("design:type", String)
    ], GetDocumentRequest.prototype, "versionName", void 0);
