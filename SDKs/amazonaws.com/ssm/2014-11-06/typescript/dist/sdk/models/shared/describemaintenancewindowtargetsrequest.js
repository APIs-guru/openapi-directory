...
var DescribeMaintenanceWindowTargetsRequest = /** @class */ (function (_super) {
    ...
    ], DescribeMaintenanceWindowTargetsRequest.prototype, "filters", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=MaxResults" }),
        __metadata("design:type", Number)
    ], DescribeMaintenanceWindowTargetsRequest.prototype, "maxResults", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=NextToken" }),
        __metadata("design:type", String)
    ], DescribeMaintenanceWindowTargetsRequest.prototype, "nextToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=WindowId" }),
        __metadata("design:type", String)
    ], DescribeMaintenanceWindowTargetsRequest.prototype, "windowId", void 0);
