...
var ListOpsItemRelatedItemsRequest = /** @class */ (function (_super) {
    ...
    ], ListOpsItemRelatedItemsRequest.prototype, "filters", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=MaxResults" }),
        __metadata("design:type", Number)
    ], ListOpsItemRelatedItemsRequest.prototype, "maxResults", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=NextToken" }),
        __metadata("design:type", String)
    ], ListOpsItemRelatedItemsRequest.prototype, "nextToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=OpsItemId" }),
        __metadata("design:type", String)
    ], ListOpsItemRelatedItemsRequest.prototype, "opsItemId", void 0);
