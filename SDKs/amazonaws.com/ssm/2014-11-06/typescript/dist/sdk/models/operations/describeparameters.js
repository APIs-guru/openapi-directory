...
var DescribeParametersQueryParams = /** @class */ (function (_super) {
    __extends(DescribeParametersQueryParams, _super);
    function DescribeParametersQueryParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=MaxResults" }),
        __metadata("design:type", String)
    ], DescribeParametersQueryParams.prototype, "maxResults", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=NextToken" }),
        __metadata("design:type", String)
    ], DescribeParametersQueryParams.prototype, "nextToken", void 0);
    return DescribeParametersQueryParams;
}(SpeakeasyBase));
export { DescribeParametersQueryParams };
...
var DescribeParametersRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", DescribeParametersQueryParams)
    ], DescribeParametersRequest.prototype, "queryParams", void 0);
    __decorate([
        SpeakeasyMetadata(),
