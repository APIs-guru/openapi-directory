...
var CreateAssociationBatchResult = /** @class */ (function (_super) {
    __extends(CreateAssociationBatchResult, _super);
    ...
    ], CreateAssociationBatchResult.prototype, "failed", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Successful", elemType: AssociationDescription }),
        __metadata("design:type", Array)
    ], CreateAssociationBatchResult.prototype, "successful", void 0);
    return CreateAssociationBatchResult;
}(SpeakeasyBase));
export { CreateAssociationBatchResult };
