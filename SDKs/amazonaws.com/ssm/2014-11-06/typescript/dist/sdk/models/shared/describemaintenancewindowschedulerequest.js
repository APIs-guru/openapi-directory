...
var DescribeMaintenanceWindowScheduleRequest = /** @class */ (function (_super) {
    ...
    ], DescribeMaintenanceWindowScheduleRequest.prototype, "filters", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=MaxResults" }),
        __metadata("design:type", Number)
    ], DescribeMaintenanceWindowScheduleRequest.prototype, "maxResults", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=NextToken" }),
        __metadata("design:type", String)
    ], DescribeMaintenanceWindowScheduleRequest.prototype, "nextToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ResourceType" }),
        __metadata("design:type", String)
    ], DescribeMaintenanceWindowScheduleRequest.prototype, "resourceType", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Targets", elemType: Target }),
        __metadata("design:type", Array)
    ], DescribeMaintenanceWindowScheduleRequest.prototype, "targets", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=WindowId" }),
        __metadata("design:type", String)
    ], DescribeMaintenanceWindowScheduleRequest.prototype, "windowId", void 0);
