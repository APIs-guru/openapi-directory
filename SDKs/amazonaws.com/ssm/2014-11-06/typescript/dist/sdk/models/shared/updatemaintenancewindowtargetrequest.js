...
var UpdateMaintenanceWindowTargetRequest = /** @class */ (function (_super) {
    ...
    ], UpdateMaintenanceWindowTargetRequest.prototype, "description", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Name" }),
        __metadata("design:type", String)
    ], UpdateMaintenanceWindowTargetRequest.prototype, "name", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=OwnerInformation" }),
        __metadata("design:type", String)
    ], UpdateMaintenanceWindowTargetRequest.prototype, "ownerInformation", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Replace" }),
        __metadata("design:type", Boolean)
    ], UpdateMaintenanceWindowTargetRequest.prototype, "replace", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Targets", elemType: Target }),
        __metadata("design:type", Array)
    ], UpdateMaintenanceWindowTargetRequest.prototype, "targets", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=WindowId" }),
        __metadata("design:type", String)
    ], UpdateMaintenanceWindowTargetRequest.prototype, "windowId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=WindowTargetId" }),
        __metadata("design:type", String)
    ], UpdateMaintenanceWindowTargetRequest.prototype, "windowTargetId", void 0);
