...
class UpdateDocumentMetadataHeaders:
    ...
    x_amz_target: UpdateDocumentMetadataXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateDocumentMetadataRequest:
    headers: UpdateDocumentMetadataHeaders = field(default=None)
    request: shared.UpdateDocumentMetadataRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
