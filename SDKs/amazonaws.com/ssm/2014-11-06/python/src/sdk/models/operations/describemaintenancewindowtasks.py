...
class DescribeMaintenanceWindowTasksHeaders:
    x_amz_target: DescribeMaintenanceWindowTasksXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeMaintenanceWindowTasksRequest:
    headers: DescribeMaintenanceWindowTasksHeaders = field()
    query_params: DescribeMaintenanceWindowTasksQueryParams = field()
    request: shared.DescribeMaintenanceWindowTasksRequest = field(metadata={'request': { 'media_type': 'application/json' }})
