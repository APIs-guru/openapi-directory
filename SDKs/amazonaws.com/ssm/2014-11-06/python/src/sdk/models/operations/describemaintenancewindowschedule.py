...
class DescribeMaintenanceWindowScheduleHeaders:
    x_amz_target: DescribeMaintenanceWindowScheduleXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeMaintenanceWindowScheduleRequest:
    headers: DescribeMaintenanceWindowScheduleHeaders = field()
    query_params: DescribeMaintenanceWindowScheduleQueryParams = field()
    request: shared.DescribeMaintenanceWindowScheduleRequest = field(metadata={'request': { 'media_type': 'application/json' }})
