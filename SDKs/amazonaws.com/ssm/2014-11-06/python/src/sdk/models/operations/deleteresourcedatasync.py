...
class DeleteResourceDataSyncHeaders:
    x_amz_target: DeleteResourceDataSyncXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteResourceDataSyncRequest:
    headers: DeleteResourceDataSyncHeaders = field()
    request: shared.DeleteResourceDataSyncRequest = field(metadata={'request': { 'media_type': 'application/json' }})
