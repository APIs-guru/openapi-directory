...
class CreateAssociationBatchHeaders:
    x_amz_target: CreateAssociationBatchXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateAssociationBatchRequest:
    headers: CreateAssociationBatchHeaders = field()
    request: shared.CreateAssociationBatchRequest = field(metadata={'request': { 'media_type': 'application/json' }})
