...
class CreateOpsMetadataHeaders:
    x_amz_target: CreateOpsMetadataXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateOpsMetadataRequest:
    headers: CreateOpsMetadataHeaders = field()
    request: shared.CreateOpsMetadataRequest = field(metadata={'request': { 'media_type': 'application/json' }})
