...
class DescribeInventoryDeletionsHeaders:
    ...
    x_amz_target: DescribeInventoryDeletionsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeInventoryDeletionsRequest:
    query_params: DescribeInventoryDeletionsQueryParams = field(default=None)
    headers: DescribeInventoryDeletionsHeaders = field(default=None)
    request: shared.DescribeInventoryDeletionsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
