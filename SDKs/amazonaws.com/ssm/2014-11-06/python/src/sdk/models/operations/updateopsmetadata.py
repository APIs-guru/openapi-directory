...
class UpdateOpsMetadataHeaders:
    ...
    x_amz_target: UpdateOpsMetadataXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateOpsMetadataRequest:
    headers: UpdateOpsMetadataHeaders = field(default=None)
    request: shared.UpdateOpsMetadataRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
