...
class DescribeInstancePatchStatesForPatchGroupHeaders:
    ...
    x_amz_target: DescribeInstancePatchStatesForPatchGroupXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeInstancePatchStatesForPatchGroupRequest:
    query_params: DescribeInstancePatchStatesForPatchGroupQueryParams = field(default=None)
    headers: DescribeInstancePatchStatesForPatchGroupHeaders = field(default=None)
    request: shared.DescribeInstancePatchStatesForPatchGroupRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
