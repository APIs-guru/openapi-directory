...
class ListResourceComplianceSummariesHeaders:
    x_amz_target: ListResourceComplianceSummariesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListResourceComplianceSummariesRequest:
    headers: ListResourceComplianceSummariesHeaders = field()
    query_params: ListResourceComplianceSummariesQueryParams = field()
    request: shared.ListResourceComplianceSummariesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
