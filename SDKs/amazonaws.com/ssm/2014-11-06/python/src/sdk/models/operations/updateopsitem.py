...
class UpdateOpsItemHeaders:
    x_amz_target: UpdateOpsItemXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateOpsItemRequest:
    headers: UpdateOpsItemHeaders = field()
    request: shared.UpdateOpsItemRequest = field(metadata={'request': { 'media_type': 'application/json' }})
