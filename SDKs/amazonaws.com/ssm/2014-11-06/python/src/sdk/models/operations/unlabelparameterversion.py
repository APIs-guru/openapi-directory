...
class UnlabelParameterVersionHeaders:
    x_amz_target: UnlabelParameterVersionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UnlabelParameterVersionRequest:
    headers: UnlabelParameterVersionHeaders = field()
    request: shared.UnlabelParameterVersionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
