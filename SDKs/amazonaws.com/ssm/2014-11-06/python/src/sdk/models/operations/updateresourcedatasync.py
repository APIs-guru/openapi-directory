...
class UpdateResourceDataSyncHeaders:
    x_amz_target: UpdateResourceDataSyncXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateResourceDataSyncRequest:
    headers: UpdateResourceDataSyncHeaders = field()
    request: shared.UpdateResourceDataSyncRequest = field(metadata={'request': { 'media_type': 'application/json' }})
