...
class SendAutomationSignalHeaders:
    ...
    x_amz_target: SendAutomationSignalXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class SendAutomationSignalRequest:
    headers: SendAutomationSignalHeaders = field(default=None)
    request: shared.SendAutomationSignalRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
