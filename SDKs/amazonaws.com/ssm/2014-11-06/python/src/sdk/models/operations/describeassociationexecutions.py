...
class DescribeAssociationExecutionsHeaders:
    x_amz_target: DescribeAssociationExecutionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeAssociationExecutionsRequest:
    headers: DescribeAssociationExecutionsHeaders = field()
    query_params: DescribeAssociationExecutionsQueryParams = field()
    request: shared.DescribeAssociationExecutionsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
