...
class GetMaintenanceWindowExecutionHeaders:
    x_amz_target: GetMaintenanceWindowExecutionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetMaintenanceWindowExecutionRequest:
    headers: GetMaintenanceWindowExecutionHeaders = field()
    request: shared.GetMaintenanceWindowExecutionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
