...
class GetPatchBaselineForPatchGroupHeaders:
    ...
    x_amz_target: GetPatchBaselineForPatchGroupXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetPatchBaselineForPatchGroupRequest:
    headers: GetPatchBaselineForPatchGroupHeaders = field(default=None)
    request: shared.GetPatchBaselineForPatchGroupRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
