...
class DescribeOpsItemsHeaders:
    x_amz_target: DescribeOpsItemsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeOpsItemsRequest:
    headers: DescribeOpsItemsHeaders = field()
    query_params: DescribeOpsItemsQueryParams = field()
    request: shared.DescribeOpsItemsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
