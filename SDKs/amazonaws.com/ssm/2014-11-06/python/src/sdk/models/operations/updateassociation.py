...
class UpdateAssociationHeaders:
    x_amz_target: UpdateAssociationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateAssociationRequest:
    headers: UpdateAssociationHeaders = field()
    request: shared.UpdateAssociationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
