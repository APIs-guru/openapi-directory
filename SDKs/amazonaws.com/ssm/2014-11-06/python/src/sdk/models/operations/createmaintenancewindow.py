...
class CreateMaintenanceWindowHeaders:
    ...
    x_amz_target: CreateMaintenanceWindowXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateMaintenanceWindowRequest:
    headers: CreateMaintenanceWindowHeaders = field(default=None)
    request: shared.CreateMaintenanceWindowRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
