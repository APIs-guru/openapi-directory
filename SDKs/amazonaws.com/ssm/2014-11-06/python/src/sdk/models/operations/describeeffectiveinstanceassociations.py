...
class DescribeEffectiveInstanceAssociationsHeaders:
    x_amz_target: DescribeEffectiveInstanceAssociationsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeEffectiveInstanceAssociationsRequest:
    headers: DescribeEffectiveInstanceAssociationsHeaders = field()
    query_params: DescribeEffectiveInstanceAssociationsQueryParams = field()
    request: shared.DescribeEffectiveInstanceAssociationsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
