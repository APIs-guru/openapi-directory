...
class GetDocumentHeaders:
    x_amz_target: GetDocumentXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetDocumentRequest:
    headers: GetDocumentHeaders = field()
    request: shared.GetDocumentRequest = field(metadata={'request': { 'media_type': 'application/json' }})
