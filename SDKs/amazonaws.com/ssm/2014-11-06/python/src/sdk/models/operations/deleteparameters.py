...
class DeleteParametersHeaders:
    x_amz_target: DeleteParametersXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteParametersRequest:
    headers: DeleteParametersHeaders = field()
    request: shared.DeleteParametersRequest = field(metadata={'request': { 'media_type': 'application/json' }})
