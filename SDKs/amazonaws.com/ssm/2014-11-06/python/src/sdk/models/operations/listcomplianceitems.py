...
class ListComplianceItemsHeaders:
    x_amz_target: ListComplianceItemsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListComplianceItemsRequest:
    headers: ListComplianceItemsHeaders = field()
    query_params: ListComplianceItemsQueryParams = field()
    request: shared.ListComplianceItemsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
