...
class StartChangeRequestExecutionHeaders:
    x_amz_target: StartChangeRequestExecutionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartChangeRequestExecutionRequest:
    headers: StartChangeRequestExecutionHeaders = field()
    request: shared.StartChangeRequestExecutionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
