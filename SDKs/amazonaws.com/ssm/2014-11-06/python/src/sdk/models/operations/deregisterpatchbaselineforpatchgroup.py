...
class DeregisterPatchBaselineForPatchGroupHeaders:
    ...
    x_amz_target: DeregisterPatchBaselineForPatchGroupXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeregisterPatchBaselineForPatchGroupRequest:
    headers: DeregisterPatchBaselineForPatchGroupHeaders = field(default=None)
    request: shared.DeregisterPatchBaselineForPatchGroupRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
