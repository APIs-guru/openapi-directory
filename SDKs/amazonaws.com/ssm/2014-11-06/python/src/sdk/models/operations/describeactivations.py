...
class DescribeActivationsHeaders:
    x_amz_target: DescribeActivationsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeActivationsRequest:
    headers: DescribeActivationsHeaders = field()
    query_params: DescribeActivationsQueryParams = field()
    request: shared.DescribeActivationsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
