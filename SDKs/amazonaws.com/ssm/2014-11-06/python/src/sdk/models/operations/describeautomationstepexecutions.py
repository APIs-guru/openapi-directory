...
class DescribeAutomationStepExecutionsHeaders:
    x_amz_target: DescribeAutomationStepExecutionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeAutomationStepExecutionsRequest:
    headers: DescribeAutomationStepExecutionsHeaders = field()
    query_params: DescribeAutomationStepExecutionsQueryParams = field()
    request: shared.DescribeAutomationStepExecutionsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
