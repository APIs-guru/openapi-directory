...
class ListOpsMetadataHeaders:
    x_amz_target: ListOpsMetadataXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListOpsMetadataRequest:
    headers: ListOpsMetadataHeaders = field()
    query_params: ListOpsMetadataQueryParams = field()
    request: shared.ListOpsMetadataRequest = field(metadata={'request': { 'media_type': 'application/json' }})
