...
class DeregisterTaskFromMaintenanceWindowHeaders:
    x_amz_target: DeregisterTaskFromMaintenanceWindowXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeregisterTaskFromMaintenanceWindowRequest:
    headers: DeregisterTaskFromMaintenanceWindowHeaders = field()
    request: shared.DeregisterTaskFromMaintenanceWindowRequest = field(metadata={'request': { 'media_type': 'application/json' }})
