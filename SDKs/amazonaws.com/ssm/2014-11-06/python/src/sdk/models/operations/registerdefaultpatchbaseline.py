...
class RegisterDefaultPatchBaselineHeaders:
    x_amz_target: RegisterDefaultPatchBaselineXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RegisterDefaultPatchBaselineRequest:
    headers: RegisterDefaultPatchBaselineHeaders = field()
    request: shared.RegisterDefaultPatchBaselineRequest = field(metadata={'request': { 'media_type': 'application/json' }})
