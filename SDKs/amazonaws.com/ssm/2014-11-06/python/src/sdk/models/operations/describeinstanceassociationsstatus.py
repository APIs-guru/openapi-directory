...
class DescribeInstanceAssociationsStatusHeaders:
    x_amz_target: DescribeInstanceAssociationsStatusXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeInstanceAssociationsStatusRequest:
    headers: DescribeInstanceAssociationsStatusHeaders = field()
    query_params: DescribeInstanceAssociationsStatusQueryParams = field()
    request: shared.DescribeInstanceAssociationsStatusRequest = field(metadata={'request': { 'media_type': 'application/json' }})
