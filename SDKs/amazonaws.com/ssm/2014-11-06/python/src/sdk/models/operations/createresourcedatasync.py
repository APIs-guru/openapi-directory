...
class CreateResourceDataSyncHeaders:
    ...
    x_amz_target: CreateResourceDataSyncXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateResourceDataSyncRequest:
    headers: CreateResourceDataSyncHeaders = field(default=None)
    request: shared.CreateResourceDataSyncRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
