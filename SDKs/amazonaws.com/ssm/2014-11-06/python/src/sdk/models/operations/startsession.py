...
class StartSessionHeaders:
    x_amz_target: StartSessionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartSessionRequest:
    headers: StartSessionHeaders = field()
    request: shared.StartSessionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
