...
class DescribePatchGroupsHeaders:
    x_amz_target: DescribePatchGroupsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribePatchGroupsRequest:
    headers: DescribePatchGroupsHeaders = field()
    query_params: DescribePatchGroupsQueryParams = field()
    request: shared.DescribePatchGroupsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
