...
class ListResourceDataSyncHeaders:
    x_amz_target: ListResourceDataSyncXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListResourceDataSyncRequest:
    headers: ListResourceDataSyncHeaders = field()
    query_params: ListResourceDataSyncQueryParams = field()
    request: shared.ListResourceDataSyncRequest = field(metadata={'request': { 'media_type': 'application/json' }})
