...
class ListCommandsHeaders:
    x_amz_target: ListCommandsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListCommandsRequest:
    headers: ListCommandsHeaders = field()
    query_params: ListCommandsQueryParams = field()
    request: shared.ListCommandsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
