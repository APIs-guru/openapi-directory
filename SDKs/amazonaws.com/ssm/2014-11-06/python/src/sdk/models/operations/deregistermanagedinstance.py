...
class DeregisterManagedInstanceHeaders:
    x_amz_target: DeregisterManagedInstanceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeregisterManagedInstanceRequest:
    headers: DeregisterManagedInstanceHeaders = field()
    request: shared.DeregisterManagedInstanceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
