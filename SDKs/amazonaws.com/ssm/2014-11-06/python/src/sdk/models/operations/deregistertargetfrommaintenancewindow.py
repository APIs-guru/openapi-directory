...
class DeregisterTargetFromMaintenanceWindowHeaders:
    x_amz_target: DeregisterTargetFromMaintenanceWindowXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeregisterTargetFromMaintenanceWindowRequest:
    headers: DeregisterTargetFromMaintenanceWindowHeaders = field()
    request: shared.DeregisterTargetFromMaintenanceWindowRequest = field(metadata={'request': { 'media_type': 'application/json' }})
