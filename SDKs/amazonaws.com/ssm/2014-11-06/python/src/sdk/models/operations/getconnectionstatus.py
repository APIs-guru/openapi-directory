...
class GetConnectionStatusHeaders:
    x_amz_target: GetConnectionStatusXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetConnectionStatusRequest:
    headers: GetConnectionStatusHeaders = field()
    request: shared.GetConnectionStatusRequest = field(metadata={'request': { 'media_type': 'application/json' }})
