...
class GetMaintenanceWindowTaskHeaders:
    x_amz_target: GetMaintenanceWindowTaskXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetMaintenanceWindowTaskRequest:
    headers: GetMaintenanceWindowTaskHeaders = field()
    request: shared.GetMaintenanceWindowTaskRequest = field(metadata={'request': { 'media_type': 'application/json' }})
