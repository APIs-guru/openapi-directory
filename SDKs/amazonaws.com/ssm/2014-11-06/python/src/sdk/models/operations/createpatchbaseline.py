...
class CreatePatchBaselineHeaders:
    x_amz_target: CreatePatchBaselineXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreatePatchBaselineRequest:
    headers: CreatePatchBaselineHeaders = field()
    request: shared.CreatePatchBaselineRequest = field(metadata={'request': { 'media_type': 'application/json' }})
