...
class CancelMaintenanceWindowExecutionHeaders:
    ...
    x_amz_target: CancelMaintenanceWindowExecutionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CancelMaintenanceWindowExecutionRequest:
    headers: CancelMaintenanceWindowExecutionHeaders = field(default=None)
    request: shared.CancelMaintenanceWindowExecutionRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
