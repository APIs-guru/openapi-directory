...
class UpdateDocumentHeaders:
    x_amz_target: UpdateDocumentXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateDocumentRequest:
    ...
    request: shared.UpdateDocumentRequest = field(metadata={'request': { 'media_type': 'application/json' }})
