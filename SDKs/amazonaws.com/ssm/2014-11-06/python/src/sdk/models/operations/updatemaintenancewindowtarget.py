...
class UpdateMaintenanceWindowTargetHeaders:
    x_amz_target: UpdateMaintenanceWindowTargetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateMaintenanceWindowTargetRequest:
    headers: UpdateMaintenanceWindowTargetHeaders = field()
    request: shared.UpdateMaintenanceWindowTargetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
