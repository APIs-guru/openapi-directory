...
class GetPatchBaselineHeaders:
    x_amz_target: GetPatchBaselineXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetPatchBaselineRequest:
    headers: GetPatchBaselineHeaders = field()
    request: shared.GetPatchBaselineRequest = field(metadata={'request': { 'media_type': 'application/json' }})
