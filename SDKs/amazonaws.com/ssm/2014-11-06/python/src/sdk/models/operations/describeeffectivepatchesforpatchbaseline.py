...
class DescribeEffectivePatchesForPatchBaselineHeaders:
    ...
    x_amz_target: DescribeEffectivePatchesForPatchBaselineXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
