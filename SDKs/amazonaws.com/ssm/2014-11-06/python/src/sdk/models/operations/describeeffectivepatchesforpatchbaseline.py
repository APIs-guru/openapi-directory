...
class DescribeEffectivePatchesForPatchBaselineHeaders:
    x_amz_target: DescribeEffectivePatchesForPatchBaselineXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeEffectivePatchesForPatchBaselineRequest:
    headers: DescribeEffectivePatchesForPatchBaselineHeaders = field()
    query_params: DescribeEffectivePatchesForPatchBaselineQueryParams = field()
    request: shared.DescribeEffectivePatchesForPatchBaselineRequest = field(metadata={'request': { 'media_type': 'application/json' }})
