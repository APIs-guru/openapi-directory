...
class UpdateAssociationStatusHeaders:
    ...
    x_amz_target: UpdateAssociationStatusXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateAssociationStatusRequest:
    headers: UpdateAssociationStatusHeaders = field(default=None)
    request: shared.UpdateAssociationStatusRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
