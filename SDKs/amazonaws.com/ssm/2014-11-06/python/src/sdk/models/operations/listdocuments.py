...
class ListDocumentsHeaders:
    x_amz_target: ListDocumentsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListDocumentsRequest:
    headers: ListDocumentsHeaders = field()
    query_params: ListDocumentsQueryParams = field()
    request: shared.ListDocumentsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
