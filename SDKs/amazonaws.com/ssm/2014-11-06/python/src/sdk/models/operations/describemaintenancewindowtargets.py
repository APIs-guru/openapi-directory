...
class DescribeMaintenanceWindowTargetsHeaders:
    x_amz_target: DescribeMaintenanceWindowTargetsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeMaintenanceWindowTargetsRequest:
    headers: DescribeMaintenanceWindowTargetsHeaders = field()
    query_params: DescribeMaintenanceWindowTargetsQueryParams = field()
    request: shared.DescribeMaintenanceWindowTargetsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
