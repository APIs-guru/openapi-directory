...
class GetMaintenanceWindowHeaders:
    x_amz_target: GetMaintenanceWindowXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetMaintenanceWindowRequest:
    headers: GetMaintenanceWindowHeaders = field()
    request: shared.GetMaintenanceWindowRequest = field(metadata={'request': { 'media_type': 'application/json' }})
