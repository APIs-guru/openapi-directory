...
class DescribeMaintenanceWindowExecutionTasksHeaders:
    x_amz_target: DescribeMaintenanceWindowExecutionTasksXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeMaintenanceWindowExecutionTasksRequest:
    headers: DescribeMaintenanceWindowExecutionTasksHeaders = field()
    query_params: DescribeMaintenanceWindowExecutionTasksQueryParams = field()
    request: shared.DescribeMaintenanceWindowExecutionTasksRequest = field(metadata={'request': { 'media_type': 'application/json' }})
