...
class DescribeMaintenanceWindowExecutionTasksHeaders:
    ...
    x_amz_target: DescribeMaintenanceWindowExecutionTasksXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
