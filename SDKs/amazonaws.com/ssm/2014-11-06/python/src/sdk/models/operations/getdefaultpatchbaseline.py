...
class GetDefaultPatchBaselineHeaders:
    x_amz_target: GetDefaultPatchBaselineXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetDefaultPatchBaselineRequest:
    headers: GetDefaultPatchBaselineHeaders = field()
    request: shared.GetDefaultPatchBaselineRequest = field(metadata={'request': { 'media_type': 'application/json' }})
