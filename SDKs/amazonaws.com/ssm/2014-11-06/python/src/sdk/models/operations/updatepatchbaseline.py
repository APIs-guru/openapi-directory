...
class UpdatePatchBaselineHeaders:
    x_amz_target: UpdatePatchBaselineXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdatePatchBaselineRequest:
    headers: UpdatePatchBaselineHeaders = field()
    request: shared.UpdatePatchBaselineRequest = field(metadata={'request': { 'media_type': 'application/json' }})
