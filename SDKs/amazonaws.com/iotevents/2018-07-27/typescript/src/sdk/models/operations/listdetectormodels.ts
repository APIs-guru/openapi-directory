...
export class ListDetectorModelsQueryParams extends SpeakeasyBase {
...
export class ListDetectorModelsHeaders extends SpeakeasyBase {
...
export class ListDetectorModelsRequest extends SpeakeasyBase {
  @Metadata()
