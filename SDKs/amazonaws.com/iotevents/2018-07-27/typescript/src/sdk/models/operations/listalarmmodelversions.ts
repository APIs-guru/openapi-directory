...
export class ListAlarmModelVersionsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=alarmModelName" })
  alarmModelName: string;
}


export class ListAlarmModelVersionsQueryParams extends SpeakeasyBase {
...
export class ListAlarmModelVersionsHeaders extends SpeakeasyBase {
