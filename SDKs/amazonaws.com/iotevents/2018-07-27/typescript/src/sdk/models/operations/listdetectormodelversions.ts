...
export class ListDetectorModelVersionsPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=detectorModelName" })
  detectorModelName: string;
}


export class ListDetectorModelVersionsQueryParams extends SpeakeasyBase {
...
export class ListDetectorModelVersionsHeaders extends SpeakeasyBase {
