...
export class ListAlarmModelsQueryParams extends SpeakeasyBase {
...
export class ListAlarmModelsHeaders extends SpeakeasyBase {
...
export class ListAlarmModelsRequest extends SpeakeasyBase {
  @Metadata()
