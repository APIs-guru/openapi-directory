...
class GetDetectorModelAnalysisResultsRequest:
    path_params: GetDetectorModelAnalysisResultsPathParams = field(default=None)
    query_params: GetDetectorModelAnalysisResultsQueryParams = field(default=None)
    headers: GetDetectorModelAnalysisResultsHeaders = field(default=None)
    

@dataclass
class GetDetectorModelAnalysisResultsResponse:
    content_type: str = field(default=None)
    get_detector_model_analysis_results_response: Optional[shared.GetDetectorModelAnalysisResultsResponse] = field(default=None)
