...
class CreateTypeRequestBody:
    ...
    format: CreateTypeRequestBodyFormatEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'format' }})
    

@dataclass
class CreateTypeRequest:
    path_params: CreateTypePathParams = field(default=None)
    headers: CreateTypeHeaders = field(default=None)
    request: CreateTypeRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
