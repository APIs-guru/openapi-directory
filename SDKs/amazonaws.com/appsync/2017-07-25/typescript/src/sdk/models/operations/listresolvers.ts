...
export class ListResolversPathParams extends SpeakeasyBase {
...
export class ListResolversQueryParams extends SpeakeasyBase {
...
export class ListResolversHeaders extends SpeakeasyBase {
...
export class ListResolversRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
