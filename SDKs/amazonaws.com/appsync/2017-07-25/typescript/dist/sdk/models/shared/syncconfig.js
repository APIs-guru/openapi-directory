...
var SyncConfig = /** @class */ (function (_super) {
    ...
    ], SyncConfig.prototype, "conflictDetection", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=conflictHandler" }),
        __metadata("design:type", String)
    ], SyncConfig.prototype, "conflictHandler", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=lambdaConflictHandlerConfig" }),
        __metadata("design:type", LambdaConflictHandlerConfig)
    ], SyncConfig.prototype, "lambdaConflictHandlerConfig", void 0);
    return SyncConfig;
}(SpeakeasyBase));
export { SyncConfig };
