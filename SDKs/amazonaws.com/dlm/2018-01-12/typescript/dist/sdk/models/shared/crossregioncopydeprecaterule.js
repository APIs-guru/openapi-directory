...
**/
var CrossRegionCopyDeprecateRule = /** @class */ (function (_super) {
    __extends(CrossRegionCopyDeprecateRule, _super);
    ...
    ], CrossRegionCopyDeprecateRule.prototype, "interval", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=IntervalUnit" }),
        __metadata("design:type", String)
    ], CrossRegionCopyDeprecateRule.prototype, "intervalUnit", void 0);
    return CrossRegionCopyDeprecateRule;
}(SpeakeasyBase));
export { CrossRegionCopyDeprecateRule };
