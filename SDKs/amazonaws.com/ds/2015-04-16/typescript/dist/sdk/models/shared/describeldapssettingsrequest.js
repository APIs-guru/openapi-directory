...
var DescribeLdapsSettingsRequest = /** @class */ (function (_super) {
    ...
    ], DescribeLdapsSettingsRequest.prototype, "directoryId", void 0);
    __decorate([
        Metadata({ data: "json, name=Limit" }),
        __metadata("design:type", Number)
    ], DescribeLdapsSettingsRequest.prototype, "limit", void 0);
    __decorate([
        Metadata({ data: "json, name=NextToken" }),
        __metadata("design:type", String)
    ], DescribeLdapsSettingsRequest.prototype, "nextToken", void 0);
    __decorate([
        Metadata({ data: "json, name=Type" }),
        __metadata("design:type", String)
    ], DescribeLdapsSettingsRequest.prototype, "type", void 0);
