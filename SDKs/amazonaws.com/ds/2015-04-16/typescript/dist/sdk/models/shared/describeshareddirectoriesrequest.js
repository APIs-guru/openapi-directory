...
var DescribeSharedDirectoriesRequest = /** @class */ (function (_super) {
    ...
    ], DescribeSharedDirectoriesRequest.prototype, "limit", void 0);
    __decorate([
        Metadata({ data: "json, name=NextToken" }),
        __metadata("design:type", String)
    ], DescribeSharedDirectoriesRequest.prototype, "nextToken", void 0);
    __decorate([
        Metadata({ data: "json, name=OwnerDirectoryId" }),
        __metadata("design:type", String)
    ], DescribeSharedDirectoriesRequest.prototype, "ownerDirectoryId", void 0);
    __decorate([
        Metadata({ data: "json, name=SharedDirectoryIds" }),
        __metadata("design:type", Array)
    ], DescribeSharedDirectoriesRequest.prototype, "sharedDirectoryIds", void 0);
