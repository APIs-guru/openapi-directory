...
class DeregisterCertificateHeaders:
    x_amz_target: DeregisterCertificateXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeregisterCertificateRequest:
    headers: DeregisterCertificateHeaders = field()
    request: shared.DeregisterCertificateRequest = field(metadata={'request': { 'media_type': 'application/json' }})
