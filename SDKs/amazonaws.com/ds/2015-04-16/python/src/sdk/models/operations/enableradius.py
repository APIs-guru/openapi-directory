...
class EnableRadiusHeaders:
    x_amz_target: EnableRadiusXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class EnableRadiusRequest:
    headers: EnableRadiusHeaders = field()
    request: shared.EnableRadiusRequest = field(metadata={'request': { 'media_type': 'application/json' }})
