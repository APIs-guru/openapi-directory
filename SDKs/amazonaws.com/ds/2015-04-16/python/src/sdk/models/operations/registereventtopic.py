...
class RegisterEventTopicHeaders:
    x_amz_target: RegisterEventTopicXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RegisterEventTopicRequest:
    headers: RegisterEventTopicHeaders = field()
    request: shared.RegisterEventTopicRequest = field(metadata={'request': { 'media_type': 'application/json' }})
