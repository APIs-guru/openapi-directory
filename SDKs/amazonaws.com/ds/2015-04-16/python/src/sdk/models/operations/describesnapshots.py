...
class DescribeSnapshotsHeaders:
    x_amz_target: DescribeSnapshotsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeSnapshotsRequest:
    headers: DescribeSnapshotsHeaders = field()
    request: shared.DescribeSnapshotsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
