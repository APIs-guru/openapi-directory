...
class CreateMicrosoftAdHeaders:
    ...
    x_amz_target: CreateMicrosoftAdxAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateMicrosoftAdRequest:
    headers: CreateMicrosoftAdHeaders = field(default=None)
    request: shared.CreateMicrosoftAdRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
