...
class StartSchemaExtensionHeaders:
    x_amz_target: StartSchemaExtensionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartSchemaExtensionRequest:
    headers: StartSchemaExtensionHeaders = field()
    request: shared.StartSchemaExtensionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
