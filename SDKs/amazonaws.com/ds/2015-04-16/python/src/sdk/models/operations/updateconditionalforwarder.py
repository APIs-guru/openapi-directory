...
class UpdateConditionalForwarderHeaders:
    x_amz_target: UpdateConditionalForwarderXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateConditionalForwarderRequest:
    headers: UpdateConditionalForwarderHeaders = field()
    request: shared.UpdateConditionalForwarderRequest = field(metadata={'request': { 'media_type': 'application/json' }})
