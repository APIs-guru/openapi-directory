...
class ListSchemaExtensionsHeaders:
    x_amz_target: ListSchemaExtensionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListSchemaExtensionsRequest:
    headers: ListSchemaExtensionsHeaders = field()
    request: shared.ListSchemaExtensionsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
