...
class DescribeTrustsHeaders:
    x_amz_target: DescribeTrustsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeTrustsRequest:
    headers: DescribeTrustsHeaders = field()
    request: shared.DescribeTrustsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
