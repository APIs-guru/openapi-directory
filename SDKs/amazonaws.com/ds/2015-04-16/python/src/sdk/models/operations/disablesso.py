...
class DisableSsoHeaders:
    x_amz_target: DisableSsoXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DisableSsoRequest:
    headers: DisableSsoHeaders = field()
    request: shared.DisableSsoRequest = field(metadata={'request': { 'media_type': 'application/json' }})
