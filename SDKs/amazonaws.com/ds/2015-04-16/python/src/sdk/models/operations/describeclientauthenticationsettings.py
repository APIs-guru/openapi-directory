...
class DescribeClientAuthenticationSettingsHeaders:
    ...
    x_amz_target: DescribeClientAuthenticationSettingsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeClientAuthenticationSettingsRequest:
    headers: DescribeClientAuthenticationSettingsHeaders = field(default=None)
    request: shared.DescribeClientAuthenticationSettingsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
