...
class RemoveIPRoutesHeaders:
    x_amz_target: RemoveIPRoutesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RemoveIPRoutesRequest:
    headers: RemoveIPRoutesHeaders = field()
    request: shared.RemoveIPRoutesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
