...
class CreateConditionalForwarderHeaders:
    ...
    x_amz_target: CreateConditionalForwarderXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateConditionalForwarderRequest:
    headers: CreateConditionalForwarderHeaders = field(default=None)
    request: shared.CreateConditionalForwarderRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
