...
class DescribeConditionalForwardersHeaders:
    x_amz_target: DescribeConditionalForwardersXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeConditionalForwardersRequest:
    headers: DescribeConditionalForwardersHeaders = field()
    request: shared.DescribeConditionalForwardersRequest = field(metadata={'request': { 'media_type': 'application/json' }})
