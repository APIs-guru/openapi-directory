...
class VerifyTrustHeaders:
    x_amz_target: VerifyTrustXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class VerifyTrustRequest:
    headers: VerifyTrustHeaders = field()
    request: shared.VerifyTrustRequest = field(metadata={'request': { 'media_type': 'application/json' }})
