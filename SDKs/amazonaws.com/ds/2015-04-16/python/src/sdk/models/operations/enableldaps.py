...
class EnableLdapsHeaders:
    x_amz_target: EnableLdapsxAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class EnableLdapsRequest:
    headers: EnableLdapsHeaders = field()
    request: shared.EnableLdapsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
