...
class DisableLdapsHeaders:
    ...
    x_amz_target: DisableLdapsxAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DisableLdapsRequest:
    headers: DisableLdapsHeaders = field(default=None)
    request: shared.DisableLdapsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
