...
class RestoreFromSnapshotHeaders:
    x_amz_target: RestoreFromSnapshotXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RestoreFromSnapshotRequest:
    headers: RestoreFromSnapshotHeaders = field()
    request: shared.RestoreFromSnapshotRequest = field(metadata={'request': { 'media_type': 'application/json' }})
