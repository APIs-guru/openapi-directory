...
class DescribeRegionsHeaders:
    x_amz_target: DescribeRegionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeRegionsRequest:
    headers: DescribeRegionsHeaders = field()
    request: shared.DescribeRegionsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
