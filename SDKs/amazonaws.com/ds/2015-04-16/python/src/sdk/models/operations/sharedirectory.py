...
class ShareDirectoryHeaders:
    x_amz_target: ShareDirectoryXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ShareDirectoryRequest:
    headers: ShareDirectoryHeaders = field()
    request: shared.ShareDirectoryRequest = field(metadata={'request': { 'media_type': 'application/json' }})
