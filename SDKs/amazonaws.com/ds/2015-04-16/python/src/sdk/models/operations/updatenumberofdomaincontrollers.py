...
class UpdateNumberOfDomainControllersHeaders:
    x_amz_target: UpdateNumberOfDomainControllersXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateNumberOfDomainControllersRequest:
    headers: UpdateNumberOfDomainControllersHeaders = field()
    request: shared.UpdateNumberOfDomainControllersRequest = field(metadata={'request': { 'media_type': 'application/json' }})
