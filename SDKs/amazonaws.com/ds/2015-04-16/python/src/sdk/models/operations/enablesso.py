...
class EnableSsoHeaders:
    x_amz_target: EnableSsoXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class EnableSsoRequest:
    headers: EnableSsoHeaders = field()
    request: shared.EnableSsoRequest = field(metadata={'request': { 'media_type': 'application/json' }})
