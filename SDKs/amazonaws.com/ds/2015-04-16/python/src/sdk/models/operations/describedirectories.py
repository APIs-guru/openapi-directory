...
class DescribeDirectoriesHeaders:
    x_amz_target: DescribeDirectoriesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeDirectoriesRequest:
    headers: DescribeDirectoriesHeaders = field()
    request: shared.DescribeDirectoriesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
