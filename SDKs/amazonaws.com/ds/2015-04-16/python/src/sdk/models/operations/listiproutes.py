...
class ListIPRoutesHeaders:
    x_amz_target: ListIPRoutesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListIPRoutesRequest:
    headers: ListIPRoutesHeaders = field()
    request: shared.ListIPRoutesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
