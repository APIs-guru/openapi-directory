...
class ResetUserPasswordHeaders:
    ...
    x_amz_target: ResetUserPasswordXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ResetUserPasswordRequest:
    headers: ResetUserPasswordHeaders = field(default=None)
    request: shared.ResetUserPasswordRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
