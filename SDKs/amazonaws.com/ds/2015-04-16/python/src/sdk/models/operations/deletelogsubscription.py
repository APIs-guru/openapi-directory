...
class DeleteLogSubscriptionHeaders:
    x_amz_target: DeleteLogSubscriptionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteLogSubscriptionRequest:
    headers: DeleteLogSubscriptionHeaders = field()
    request: shared.DeleteLogSubscriptionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
