...
class ConnectDirectoryHeaders:
    x_amz_target: ConnectDirectoryXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ConnectDirectoryRequest:
    headers: ConnectDirectoryHeaders = field()
    request: shared.ConnectDirectoryRequest = field(metadata={'request': { 'media_type': 'application/json' }})
