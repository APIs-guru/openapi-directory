...
class RejectSharedDirectoryHeaders:
    x_amz_target: RejectSharedDirectoryXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RejectSharedDirectoryRequest:
    headers: RejectSharedDirectoryHeaders = field()
    request: shared.RejectSharedDirectoryRequest = field(metadata={'request': { 'media_type': 'application/json' }})
