...
export enum DisableAwsServiceAccessXAmzTargetEnum {
    AwsOrganizationsV20161128DisableAwsServiceAccess = "AWSOrganizationsV20161128.DisableAWSServiceAccess"
}


export class DisableAwsServiceAccessHeaders extends SpeakeasyBase {
...
export class DisableAwsServiceAccessResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
