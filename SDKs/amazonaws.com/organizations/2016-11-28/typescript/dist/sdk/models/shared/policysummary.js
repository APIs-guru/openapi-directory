...
var PolicySummary = /** @class */ (function (_super) {
    ...
    ], PolicySummary.prototype, "arn", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=AwsManaged" }),
        __metadata("design:type", Boolean)
    ], PolicySummary.prototype, "awsManaged", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Description" }),
        __metadata("design:type", String)
    ], PolicySummary.prototype, "description", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Id" }),
        __metadata("design:type", String)
    ], PolicySummary.prototype, "id", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Name" }),
        __metadata("design:type", String)
    ], PolicySummary.prototype, "name", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Type" }),
        __metadata("design:type", String)
    ], PolicySummary.prototype, "type", void 0);
