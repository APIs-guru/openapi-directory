...
var CreateGovCloudAccountRequest = /** @class */ (function (_super) {
    ...
    ], CreateGovCloudAccountRequest.prototype, "accountName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Email" }),
        __metadata("design:type", String)
    ], CreateGovCloudAccountRequest.prototype, "email", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=IamUserAccessToBilling" }),
        __metadata("design:type", String)
    ], CreateGovCloudAccountRequest.prototype, "iamUserAccessToBilling", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=RoleName" }),
        __metadata("design:type", String)
    ], CreateGovCloudAccountRequest.prototype, "roleName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Tags", elemType: Tag }),
        __metadata("design:type", Array)
    ], CreateGovCloudAccountRequest.prototype, "tags", void 0);
