...
var ListChildrenRequest = /** @class */ (function (_super) {
    ...
    ], ListChildrenRequest.prototype, "childType", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=MaxResults" }),
        __metadata("design:type", Number)
    ], ListChildrenRequest.prototype, "maxResults", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=NextToken" }),
        __metadata("design:type", String)
    ], ListChildrenRequest.prototype, "nextToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ParentId" }),
        __metadata("design:type", String)
    ], ListChildrenRequest.prototype, "parentId", void 0);
