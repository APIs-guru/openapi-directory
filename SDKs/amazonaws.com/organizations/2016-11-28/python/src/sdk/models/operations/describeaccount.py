...
class DescribeAccountHeaders:
    x_amz_target: DescribeAccountXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeAccountRequest:
    headers: DescribeAccountHeaders = field()
    request: shared.DescribeAccountRequest = field(metadata={'request': { 'media_type': 'application/json' }})
