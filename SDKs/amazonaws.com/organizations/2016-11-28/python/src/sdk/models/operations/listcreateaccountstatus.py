...
class ListCreateAccountStatusHeaders:
    ...
    x_amz_target: ListCreateAccountStatusXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ListCreateAccountStatusRequest:
    query_params: ListCreateAccountStatusQueryParams = field(default=None)
    headers: ListCreateAccountStatusHeaders = field(default=None)
    request: shared.ListCreateAccountStatusRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
