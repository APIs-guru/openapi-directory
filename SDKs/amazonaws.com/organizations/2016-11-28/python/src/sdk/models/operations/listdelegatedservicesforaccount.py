...
class ListDelegatedServicesForAccountHeaders:
    x_amz_target: ListDelegatedServicesForAccountXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListDelegatedServicesForAccountRequest:
    headers: ListDelegatedServicesForAccountHeaders = field()
    query_params: ListDelegatedServicesForAccountQueryParams = field()
    request: shared.ListDelegatedServicesForAccountRequest = field(metadata={'request': { 'media_type': 'application/json' }})
