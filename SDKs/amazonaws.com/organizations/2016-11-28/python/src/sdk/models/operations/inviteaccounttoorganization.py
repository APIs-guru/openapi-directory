...
class InviteAccountToOrganizationHeaders:
    x_amz_target: InviteAccountToOrganizationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class InviteAccountToOrganizationRequest:
    headers: InviteAccountToOrganizationHeaders = field()
    request: shared.InviteAccountToOrganizationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
