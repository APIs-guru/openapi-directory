...
class ListHandshakesForOrganizationHeaders:
    x_amz_target: ListHandshakesForOrganizationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListHandshakesForOrganizationRequest:
    headers: ListHandshakesForOrganizationHeaders = field()
    query_params: ListHandshakesForOrganizationQueryParams = field()
    request: shared.ListHandshakesForOrganizationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
