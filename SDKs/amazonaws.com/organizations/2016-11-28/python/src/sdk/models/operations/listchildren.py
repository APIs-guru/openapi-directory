...
class ListChildrenHeaders:
    x_amz_target: ListChildrenXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListChildrenRequest:
    headers: ListChildrenHeaders = field()
    query_params: ListChildrenQueryParams = field()
    request: shared.ListChildrenRequest = field(metadata={'request': { 'media_type': 'application/json' }})
