...
class ListAwsServiceAccessForOrganizationHeaders:
    x_amz_target: ListAwsServiceAccessForOrganizationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListAwsServiceAccessForOrganizationRequest:
    headers: ListAwsServiceAccessForOrganizationHeaders = field()
    query_params: ListAwsServiceAccessForOrganizationQueryParams = field()
    request: shared.ListAwsServiceAccessForOrganizationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
