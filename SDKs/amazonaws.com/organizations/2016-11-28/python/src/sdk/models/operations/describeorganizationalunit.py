...
class DescribeOrganizationalUnitHeaders:
    x_amz_target: DescribeOrganizationalUnitXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeOrganizationalUnitRequest:
    headers: DescribeOrganizationalUnitHeaders = field()
    request: shared.DescribeOrganizationalUnitRequest = field(metadata={'request': { 'media_type': 'application/json' }})
