...
class CancelHandshakeHeaders:
    x_amz_target: CancelHandshakeXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CancelHandshakeRequest:
    headers: CancelHandshakeHeaders = field()
    request: shared.CancelHandshakeRequest = field(metadata={'request': { 'media_type': 'application/json' }})
