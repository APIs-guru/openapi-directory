...
class DescribeCreateAccountStatusHeaders:
    x_amz_target: DescribeCreateAccountStatusXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeCreateAccountStatusRequest:
    headers: DescribeCreateAccountStatusHeaders = field()
    request: shared.DescribeCreateAccountStatusRequest = field(metadata={'request': { 'media_type': 'application/json' }})
