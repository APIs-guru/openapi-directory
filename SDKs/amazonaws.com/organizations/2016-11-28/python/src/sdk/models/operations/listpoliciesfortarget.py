...
class ListPoliciesForTargetHeaders:
    ...
    x_amz_target: ListPoliciesForTargetXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ListPoliciesForTargetRequest:
    query_params: ListPoliciesForTargetQueryParams = field(default=None)
    headers: ListPoliciesForTargetHeaders = field(default=None)
    request: shared.ListPoliciesForTargetRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
