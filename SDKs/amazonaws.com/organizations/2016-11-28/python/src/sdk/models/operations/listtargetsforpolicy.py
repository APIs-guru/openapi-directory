...
class ListTargetsForPolicyHeaders:
    ...
    x_amz_target: ListTargetsForPolicyXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListTargetsForPolicyRequest:
    ...
    request: shared.ListTargetsForPolicyRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
