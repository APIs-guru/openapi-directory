...
class CreateOrganizationalUnitHeaders:
    x_amz_target: CreateOrganizationalUnitXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateOrganizationalUnitRequest:
    headers: CreateOrganizationalUnitHeaders = field()
    request: shared.CreateOrganizationalUnitRequest = field(metadata={'request': { 'media_type': 'application/json' }})
