...
class ListRootsHeaders:
    x_amz_target: ListRootsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListRootsRequest:
    headers: ListRootsHeaders = field()
    query_params: ListRootsQueryParams = field()
    request: shared.ListRootsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
