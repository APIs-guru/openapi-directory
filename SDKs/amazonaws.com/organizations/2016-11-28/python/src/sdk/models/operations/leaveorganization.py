...
class LeaveOrganizationHeaders:
    x_amz_target: LeaveOrganizationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class LeaveOrganizationRequest:
    headers: LeaveOrganizationHeaders = field()
