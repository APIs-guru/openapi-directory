...
class DetachPolicyHeaders:
    ...
    x_amz_target: DetachPolicyXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DetachPolicyRequest:
    headers: DetachPolicyHeaders = field(default=None)
    request: shared.DetachPolicyRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class DetachPolicyResponse:
    ...
    policy_not_attached_exception: Optional[Any] = field(default=None)
