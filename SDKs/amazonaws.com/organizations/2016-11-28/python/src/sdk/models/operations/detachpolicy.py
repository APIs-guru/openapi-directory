...
class DetachPolicyHeaders:
    x_amz_target: DetachPolicyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DetachPolicyRequest:
    ...
    request: shared.DetachPolicyRequest = field(metadata={'request': { 'media_type': 'application/json' }})
