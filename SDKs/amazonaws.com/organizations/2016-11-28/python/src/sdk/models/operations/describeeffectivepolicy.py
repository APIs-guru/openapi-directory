...
class DescribeEffectivePolicyHeaders:
    ...
    x_amz_target: DescribeEffectivePolicyXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeEffectivePolicyRequest:
    headers: DescribeEffectivePolicyHeaders = field(default=None)
    request: shared.DescribeEffectivePolicyRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
