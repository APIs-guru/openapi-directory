...
class DescribeHandshakeHeaders:
    x_amz_target: DescribeHandshakeXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeHandshakeRequest:
    headers: DescribeHandshakeHeaders = field()
    request: shared.DescribeHandshakeRequest = field(metadata={'request': { 'media_type': 'application/json' }})
