...
class MoveAccountHeaders:
    ...
    x_amz_target: MoveAccountXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class MoveAccountRequest:
    headers: MoveAccountHeaders = field(default=None)
    request: shared.MoveAccountRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
