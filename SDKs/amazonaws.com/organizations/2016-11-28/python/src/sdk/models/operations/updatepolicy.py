...
class UpdatePolicyHeaders:
    x_amz_target: UpdatePolicyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdatePolicyRequest:
    headers: UpdatePolicyHeaders = field()
    request: shared.UpdatePolicyRequest = field(metadata={'request': { 'media_type': 'application/json' }})
