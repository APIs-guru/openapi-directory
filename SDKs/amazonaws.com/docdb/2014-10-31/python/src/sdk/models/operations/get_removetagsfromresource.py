...
class GetRemoveTagsFromResourceQueryParams:
    action: GetRemoveTagsFromResourceActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetRemoveTagsFromResourceVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetRemoveTagsFromResourceRequest:
    query_params: GetRemoveTagsFromResourceQueryParams = field(default=None)
    headers: GetRemoveTagsFromResourceHeaders = field(default=None)
