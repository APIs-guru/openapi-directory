...
export class RuntimeConfiguration extends SpeakeasyBase {
  @Metadata({ data: "json, name=GameSessionActivationTimeoutSeconds" })
  gameSessionActivationTimeoutSeconds?: number;

  @Metadata({ data: "json, name=MaxConcurrentGameSessionActivations" })
  maxConcurrentGameSessionActivations?: number;

  @Metadata({ data: "json, name=ServerProcesses", elemType: shared.ServerProcess })
