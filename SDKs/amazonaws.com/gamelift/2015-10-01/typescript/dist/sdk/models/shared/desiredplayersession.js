...
**/
var DesiredPlayerSession = /** @class */ (function (_super) {
    __extends(DesiredPlayerSession, _super);
    ...
    ], DesiredPlayerSession.prototype, "playerData", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=PlayerId" }),
        __metadata("design:type", String)
    ], DesiredPlayerSession.prototype, "playerId", void 0);
    return DesiredPlayerSession;
}(SpeakeasyBase));
export { DesiredPlayerSession };
