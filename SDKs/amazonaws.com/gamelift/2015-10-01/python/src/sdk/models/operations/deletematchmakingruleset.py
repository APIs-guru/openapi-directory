...
class DeleteMatchmakingRuleSetHeaders:
    x_amz_target: DeleteMatchmakingRuleSetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteMatchmakingRuleSetRequest:
    headers: DeleteMatchmakingRuleSetHeaders = field()
    request: shared.DeleteMatchmakingRuleSetInput = field(metadata={'request': { 'media_type': 'application/json' }})
