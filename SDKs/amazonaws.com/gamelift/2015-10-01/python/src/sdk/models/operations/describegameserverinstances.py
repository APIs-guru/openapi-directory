...
class DescribeGameServerInstancesHeaders:
    ...
    x_amz_target: DescribeGameServerInstancesXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeGameServerInstancesRequest:
    query_params: DescribeGameServerInstancesQueryParams = field(default=None)
    headers: DescribeGameServerInstancesHeaders = field(default=None)
    request: shared.DescribeGameServerInstancesInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
