...
class DescribeMatchmakingRuleSetsHeaders:
    x_amz_target: DescribeMatchmakingRuleSetsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeMatchmakingRuleSetsRequest:
    headers: DescribeMatchmakingRuleSetsHeaders = field()
    query_params: DescribeMatchmakingRuleSetsQueryParams = field()
    request: shared.DescribeMatchmakingRuleSetsInput = field(metadata={'request': { 'media_type': 'application/json' }})
