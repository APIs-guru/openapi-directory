...
class DescribeMatchmakingConfigurationsHeaders:
    x_amz_target: DescribeMatchmakingConfigurationsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeMatchmakingConfigurationsRequest:
    headers: DescribeMatchmakingConfigurationsHeaders = field()
    query_params: DescribeMatchmakingConfigurationsQueryParams = field()
    request: shared.DescribeMatchmakingConfigurationsInput = field(metadata={'request': { 'media_type': 'application/json' }})
