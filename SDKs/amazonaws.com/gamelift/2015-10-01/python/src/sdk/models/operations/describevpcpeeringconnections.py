...
class DescribeVpcPeeringConnectionsHeaders:
    x_amz_target: DescribeVpcPeeringConnectionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeVpcPeeringConnectionsRequest:
    headers: DescribeVpcPeeringConnectionsHeaders = field()
    request: shared.DescribeVpcPeeringConnectionsInput = field(metadata={'request': { 'media_type': 'application/json' }})
