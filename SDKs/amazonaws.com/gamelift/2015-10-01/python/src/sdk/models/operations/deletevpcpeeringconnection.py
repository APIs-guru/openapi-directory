...
class DeleteVpcPeeringConnectionHeaders:
    x_amz_target: DeleteVpcPeeringConnectionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteVpcPeeringConnectionRequest:
    headers: DeleteVpcPeeringConnectionHeaders = field()
    request: shared.DeleteVpcPeeringConnectionInput = field(metadata={'request': { 'media_type': 'application/json' }})
