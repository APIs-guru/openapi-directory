...
class ClaimGameServerHeaders:
    x_amz_target: ClaimGameServerXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ClaimGameServerRequest:
    headers: ClaimGameServerHeaders = field()
    request: shared.ClaimGameServerInput = field(metadata={'request': { 'media_type': 'application/json' }})
