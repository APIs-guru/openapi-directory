...
class CreateMatchmakingConfigurationHeaders:
    x_amz_target: CreateMatchmakingConfigurationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateMatchmakingConfigurationRequest:
    headers: CreateMatchmakingConfigurationHeaders = field()
    request: shared.CreateMatchmakingConfigurationInput = field(metadata={'request': { 'media_type': 'application/json' }})
