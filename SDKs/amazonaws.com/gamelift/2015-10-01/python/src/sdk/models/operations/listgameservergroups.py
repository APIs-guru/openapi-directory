...
class ListGameServerGroupsHeaders:
    x_amz_target: ListGameServerGroupsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListGameServerGroupsRequest:
    headers: ListGameServerGroupsHeaders = field()
    query_params: ListGameServerGroupsQueryParams = field()
    request: shared.ListGameServerGroupsInput = field(metadata={'request': { 'media_type': 'application/json' }})
