...
class UpdateAliasRequest:
    ...
    request: shared.UpdateAliasInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateAliasResponse:
    ...
    update_alias_output: Optional[shared.UpdateAliasOutput] = field(default=None)
