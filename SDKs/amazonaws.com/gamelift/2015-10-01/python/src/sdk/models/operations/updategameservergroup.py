...
class UpdateGameServerGroupHeaders:
    x_amz_target: UpdateGameServerGroupXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateGameServerGroupRequest:
    headers: UpdateGameServerGroupHeaders = field()
    request: shared.UpdateGameServerGroupInput = field(metadata={'request': { 'media_type': 'application/json' }})
