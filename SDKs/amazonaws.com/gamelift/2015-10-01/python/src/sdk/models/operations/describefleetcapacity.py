...
class DescribeFleetCapacityHeaders:
    x_amz_target: DescribeFleetCapacityXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeFleetCapacityRequest:
    headers: DescribeFleetCapacityHeaders = field()
    query_params: DescribeFleetCapacityQueryParams = field()
    request: shared.DescribeFleetCapacityInput = field(metadata={'request': { 'media_type': 'application/json' }})
