...
class UpdateRuntimeConfigurationHeaders:
    ...
    x_amz_target: UpdateRuntimeConfigurationXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateRuntimeConfigurationRequest:
    headers: UpdateRuntimeConfigurationHeaders = field(default=None)
    request: shared.UpdateRuntimeConfigurationInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
