...
class SuspendGameServerGroupHeaders:
    x_amz_target: SuspendGameServerGroupXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class SuspendGameServerGroupRequest:
    headers: SuspendGameServerGroupHeaders = field()
    request: shared.SuspendGameServerGroupInput = field(metadata={'request': { 'media_type': 'application/json' }})
