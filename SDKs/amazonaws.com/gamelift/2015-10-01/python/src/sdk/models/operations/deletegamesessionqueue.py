...
class DeleteGameSessionQueueHeaders:
    x_amz_target: DeleteGameSessionQueueXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteGameSessionQueueRequest:
    headers: DeleteGameSessionQueueHeaders = field()
    request: shared.DeleteGameSessionQueueInput = field(metadata={'request': { 'media_type': 'application/json' }})
