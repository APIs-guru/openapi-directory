...
class ValidateMatchmakingRuleSetHeaders:
    x_amz_target: ValidateMatchmakingRuleSetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ValidateMatchmakingRuleSetRequest:
    headers: ValidateMatchmakingRuleSetHeaders = field()
    request: shared.ValidateMatchmakingRuleSetInput = field(metadata={'request': { 'media_type': 'application/json' }})
