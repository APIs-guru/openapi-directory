...
class GetInstanceAccessHeaders:
    x_amz_target: GetInstanceAccessXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetInstanceAccessRequest:
    headers: GetInstanceAccessHeaders = field()
    request: shared.GetInstanceAccessInput = field(metadata={'request': { 'media_type': 'application/json' }})
