...
class CreatePlayerSessionsHeaders:
    x_amz_target: CreatePlayerSessionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreatePlayerSessionsRequest:
    headers: CreatePlayerSessionsHeaders = field()
    request: shared.CreatePlayerSessionsInput = field(metadata={'request': { 'media_type': 'application/json' }})
