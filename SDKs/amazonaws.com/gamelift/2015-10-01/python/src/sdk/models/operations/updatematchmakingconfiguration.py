...
class UpdateMatchmakingConfigurationHeaders:
    ...
    x_amz_target: UpdateMatchmakingConfigurationXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateMatchmakingConfigurationRequest:
    headers: UpdateMatchmakingConfigurationHeaders = field(default=None)
    request: shared.UpdateMatchmakingConfigurationInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
