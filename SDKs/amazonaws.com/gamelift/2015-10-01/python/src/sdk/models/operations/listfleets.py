...
class ListFleetsHeaders:
    x_amz_target: ListFleetsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListFleetsRequest:
    ...
    request: shared.ListFleetsInput = field(metadata={'request': { 'media_type': 'application/json' }})
