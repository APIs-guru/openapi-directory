...
class DeleteGameServerGroupHeaders:
    x_amz_target: DeleteGameServerGroupXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteGameServerGroupRequest:
    headers: DeleteGameServerGroupHeaders = field()
    request: shared.DeleteGameServerGroupInput = field(metadata={'request': { 'media_type': 'application/json' }})
