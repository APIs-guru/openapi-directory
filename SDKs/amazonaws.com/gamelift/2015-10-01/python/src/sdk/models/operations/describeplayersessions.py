...
class DescribePlayerSessionsHeaders:
    x_amz_target: DescribePlayerSessionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribePlayerSessionsRequest:
    headers: DescribePlayerSessionsHeaders = field()
    query_params: DescribePlayerSessionsQueryParams = field()
    request: shared.DescribePlayerSessionsInput = field(metadata={'request': { 'media_type': 'application/json' }})
