...
class DeleteMatchmakingConfigurationHeaders:
    x_amz_target: DeleteMatchmakingConfigurationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteMatchmakingConfigurationRequest:
    headers: DeleteMatchmakingConfigurationHeaders = field()
    request: shared.DeleteMatchmakingConfigurationInput = field(metadata={'request': { 'media_type': 'application/json' }})
