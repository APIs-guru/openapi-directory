...
class UpdateGameSessionQueueHeaders:
    x_amz_target: UpdateGameSessionQueueXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateGameSessionQueueRequest:
    headers: UpdateGameSessionQueueHeaders = field()
    request: shared.UpdateGameSessionQueueInput = field(metadata={'request': { 'media_type': 'application/json' }})
