...
class DescribeFleetLocationUtilizationHeaders:
    x_amz_target: DescribeFleetLocationUtilizationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeFleetLocationUtilizationRequest:
    headers: DescribeFleetLocationUtilizationHeaders = field()
    request: shared.DescribeFleetLocationUtilizationInput = field(metadata={'request': { 'media_type': 'application/json' }})
