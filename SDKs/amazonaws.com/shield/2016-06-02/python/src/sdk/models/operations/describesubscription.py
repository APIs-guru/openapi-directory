...
class DescribeSubscriptionHeaders:
    x_amz_target: DescribeSubscriptionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeSubscriptionRequest:
    headers: DescribeSubscriptionHeaders = field()
