...
class DescribeAttackHeaders:
    x_amz_target: DescribeAttackXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeAttackRequest:
    headers: DescribeAttackHeaders = field()
    request: shared.DescribeAttackRequest = field(metadata={'request': { 'media_type': 'application/json' }})
