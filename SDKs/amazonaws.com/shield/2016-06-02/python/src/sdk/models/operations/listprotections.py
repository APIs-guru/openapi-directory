...
class ListProtectionsHeaders:
    x_amz_target: ListProtectionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListProtectionsRequest:
    headers: ListProtectionsHeaders = field()
    query_params: ListProtectionsQueryParams = field()
    request: shared.ListProtectionsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
