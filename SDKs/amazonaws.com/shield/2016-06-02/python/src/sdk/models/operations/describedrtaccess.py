...
class DescribeDrtAccessHeaders:
    x_amz_target: DescribeDrtAccessXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeDrtAccessRequest:
    headers: DescribeDrtAccessHeaders = field()
