...
class ListAttacksHeaders:
    x_amz_target: ListAttacksXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListAttacksRequest:
    headers: ListAttacksHeaders = field()
    query_params: ListAttacksQueryParams = field()
    request: shared.ListAttacksRequest = field(metadata={'request': { 'media_type': 'application/json' }})
