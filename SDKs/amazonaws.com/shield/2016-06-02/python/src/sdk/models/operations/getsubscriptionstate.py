...
class GetSubscriptionStateHeaders:
    x_amz_target: GetSubscriptionStateXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetSubscriptionStateRequest:
    headers: GetSubscriptionStateHeaders = field()
