...
class DeleteProtectionGroupHeaders:
    x_amz_target: DeleteProtectionGroupXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteProtectionGroupRequest:
    headers: DeleteProtectionGroupHeaders = field()
    request: shared.DeleteProtectionGroupRequest = field(metadata={'request': { 'media_type': 'application/json' }})
