...
class AssociateProactiveEngagementDetailsHeaders:
    x_amz_target: AssociateProactiveEngagementDetailsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AssociateProactiveEngagementDetailsRequest:
    headers: AssociateProactiveEngagementDetailsHeaders = field()
    request: shared.AssociateProactiveEngagementDetailsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
