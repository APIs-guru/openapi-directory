...
class AssociateHealthCheckHeaders:
    x_amz_target: AssociateHealthCheckXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AssociateHealthCheckRequest:
    headers: AssociateHealthCheckHeaders = field()
    request: shared.AssociateHealthCheckRequest = field(metadata={'request': { 'media_type': 'application/json' }})
