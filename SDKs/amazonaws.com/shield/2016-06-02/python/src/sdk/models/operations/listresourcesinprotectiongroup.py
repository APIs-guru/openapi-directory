...
class ListResourcesInProtectionGroupHeaders:
    ...
    x_amz_target: ListResourcesInProtectionGroupXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ListResourcesInProtectionGroupRequest:
    query_params: ListResourcesInProtectionGroupQueryParams = field(default=None)
    headers: ListResourcesInProtectionGroupHeaders = field(default=None)
    request: shared.ListResourcesInProtectionGroupRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
