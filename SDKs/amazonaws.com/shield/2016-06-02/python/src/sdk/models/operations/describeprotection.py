...
class DescribeProtectionHeaders:
    x_amz_target: DescribeProtectionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeProtectionRequest:
    headers: DescribeProtectionHeaders = field()
    request: shared.DescribeProtectionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
