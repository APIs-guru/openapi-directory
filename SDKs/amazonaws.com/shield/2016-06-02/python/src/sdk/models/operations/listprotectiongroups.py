...
class ListProtectionGroupsHeaders:
    x_amz_target: ListProtectionGroupsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListProtectionGroupsRequest:
    headers: ListProtectionGroupsHeaders = field()
    query_params: ListProtectionGroupsQueryParams = field()
    request: shared.ListProtectionGroupsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
