...
class DescribeProtectionGroupHeaders:
    x_amz_target: DescribeProtectionGroupXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeProtectionGroupRequest:
    headers: DescribeProtectionGroupHeaders = field()
    request: shared.DescribeProtectionGroupRequest = field(metadata={'request': { 'media_type': 'application/json' }})
