...
class ProtectionGroup:
    ...
    members: List[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Members' }})
    ...
    protection_group_arn: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ProtectionGroupArn' }})
