...
class AssociateDrtLogBucketHeaders:
    x_amz_target: AssociateDrtLogBucketXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AssociateDrtLogBucketRequest:
    headers: AssociateDrtLogBucketHeaders = field()
    request: shared.AssociateDrtLogBucketRequest = field(metadata={'request': { 'media_type': 'application/json' }})
