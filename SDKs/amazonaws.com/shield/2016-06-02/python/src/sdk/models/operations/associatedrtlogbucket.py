...
class AssociateDrtLogBucketHeaders:
    ...
    x_amz_target: AssociateDrtLogBucketXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class AssociateDrtLogBucketRequest:
    headers: AssociateDrtLogBucketHeaders = field(default=None)
    request: shared.AssociateDrtLogBucketRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class AssociateDrtLogBucketResponse:
    access_denied_for_dependency_exception: Optional[Any] = field(default=None)
    associate_drt_log_bucket_response: Optional[dict[str, Any]] = field(default=None)
