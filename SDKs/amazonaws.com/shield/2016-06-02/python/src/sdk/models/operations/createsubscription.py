...
class CreateSubscriptionHeaders:
    ...
    x_amz_target: CreateSubscriptionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateSubscriptionRequest:
    headers: CreateSubscriptionHeaders = field(default=None)
