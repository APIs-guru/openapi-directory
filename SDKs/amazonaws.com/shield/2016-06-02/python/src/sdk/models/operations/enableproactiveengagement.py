...
class EnableProactiveEngagementHeaders:
    x_amz_target: EnableProactiveEngagementXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class EnableProactiveEngagementRequest:
    headers: EnableProactiveEngagementHeaders = field()
