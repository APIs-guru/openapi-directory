...
class EnableProactiveEngagementHeaders:
    ...
    x_amz_target: EnableProactiveEngagementXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class EnableProactiveEngagementRequest:
    headers: EnableProactiveEngagementHeaders = field(default=None)
...
class EnableProactiveEngagementResponse:
    ...
    enable_proactive_engagement_response: Optional[dict[str, Any]] = field(default=None)
