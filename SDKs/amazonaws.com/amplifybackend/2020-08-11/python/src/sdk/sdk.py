...
class SDK:
    ...
    def clone_backend(self, request: operations.CloneBackendRequest) -> operations.CloneBackendResponse:
        ...
        res = operations.CloneBackendResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CloneBackendResponse])
    ...
    def create_backend(self, request: operations.CreateBackendRequest) -> operations.CreateBackendResponse:
        ...
        res = operations.CreateBackendResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateBackendResponse])
    ...
    def create_backend_api(self, request: operations.CreateBackendAPIRequest) -> operations.CreateBackendAPIResponse:
        ...
        res = operations.CreateBackendAPIResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateBackendAPIResponse])
    ...
    def create_backend_auth(self, request: operations.CreateBackendAuthRequest) -> operations.CreateBackendAuthResponse:
        ...
        res = operations.CreateBackendAuthResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateBackendAuthResponse])
    ...
    def create_backend_config(self, request: operations.CreateBackendConfigRequest) -> operations.CreateBackendConfigResponse:
        ...
        res = operations.CreateBackendConfigResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateBackendConfigResponse])
    ...
    def create_token(self, request: operations.CreateTokenRequest) -> operations.CreateTokenResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateTokenResponse])
    ...
    def delete_backend(self, request: operations.DeleteBackendRequest) -> operations.DeleteBackendResponse:
        ...
        res = operations.DeleteBackendResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DeleteBackendResponse])
    ...
    def delete_backend_api(self, request: operations.DeleteBackendAPIRequest) -> operations.DeleteBackendAPIResponse:
        ...
        res = operations.DeleteBackendAPIResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DeleteBackendAPIResponse])
    ...
    def delete_backend_auth(self, request: operations.DeleteBackendAuthRequest) -> operations.DeleteBackendAuthResponse:
        ...
        res = operations.DeleteBackendAuthResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DeleteBackendAuthResponse])
    ...
    def delete_token(self, request: operations.DeleteTokenRequest) -> operations.DeleteTokenResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DeleteTokenResponse])
    ...
    def generate_backend_api_models(self, request: operations.GenerateBackendAPIModelsRequest) -> operations.GenerateBackendAPIModelsResponse:
        ...
        res = operations.GenerateBackendAPIModelsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GenerateBackendAPIModelsResponse])
    ...
    def get_backend(self, request: operations.GetBackendRequest) -> operations.GetBackendResponse:
        ...
        res = operations.GetBackendResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetBackendResponse])
    ...
    def get_backend_api(self, request: operations.GetBackendAPIRequest) -> operations.GetBackendAPIResponse:
        ...
        res = operations.GetBackendAPIResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetBackendAPIResponse])
    ...
    def get_backend_api_models(self, request: operations.GetBackendAPIModelsRequest) -> operations.GetBackendAPIModelsResponse:
        ...
        res = operations.GetBackendAPIModelsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetBackendAPIModelsResponse])
    ...
    def get_backend_auth(self, request: operations.GetBackendAuthRequest) -> operations.GetBackendAuthResponse:
        ...
        res = operations.GetBackendAuthResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetBackendAuthResponse])
    ...
    def get_backend_job(self, request: operations.GetBackendJobRequest) -> operations.GetBackendJobResponse:
        ...
        res = operations.GetBackendJobResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetBackendJobResponse])
    ...
    def get_token(self, request: operations.GetTokenRequest) -> operations.GetTokenResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetTokenResponse])
    ...
    def import_backend_auth(self, request: operations.ImportBackendAuthRequest) -> operations.ImportBackendAuthResponse:
        ...
        res = operations.ImportBackendAuthResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ImportBackendAuthResponse])
    ...
    def list_backend_jobs(self, request: operations.ListBackendJobsRequest) -> operations.ListBackendJobsResponse:
        ...
        res = operations.ListBackendJobsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListBackendJobsResponse])
    ...
    def remove_all_backends(self, request: operations.RemoveAllBackendsRequest) -> operations.RemoveAllBackendsResponse:
        ...
        res = operations.RemoveAllBackendsResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.RemoveAllBackendsResponse])
    ...
    def remove_backend_config(self, request: operations.RemoveBackendConfigRequest) -> operations.RemoveBackendConfigResponse:
        ...
        res = operations.RemoveBackendConfigResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.RemoveBackendConfigResponse])
    ...
    def update_backend_api(self, request: operations.UpdateBackendAPIRequest) -> operations.UpdateBackendAPIResponse:
        ...
        res = operations.UpdateBackendAPIResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.UpdateBackendAPIResponse])
    ...
    def update_backend_auth(self, request: operations.UpdateBackendAuthRequest) -> operations.UpdateBackendAuthResponse:
        ...
        res = operations.UpdateBackendAuthResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.UpdateBackendAuthResponse])
    ...
    def update_backend_config(self, request: operations.UpdateBackendConfigRequest) -> operations.UpdateBackendConfigResponse:
        ...
        res = operations.UpdateBackendConfigResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.UpdateBackendConfigResponse])
    ...
    def update_backend_job(self, request: operations.UpdateBackendJobRequest) -> operations.UpdateBackendJobResponse:
        ...
        res = operations.UpdateBackendJobResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.UpdateBackendJobResponse])
