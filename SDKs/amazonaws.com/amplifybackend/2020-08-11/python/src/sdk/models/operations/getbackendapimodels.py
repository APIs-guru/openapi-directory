...
class GetBackendAPIModelsRequest:
    headers: GetBackendAPIModelsHeaders = field()
    path_params: GetBackendAPIModelsPathParams = field()
    request: GetBackendAPIModelsRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
