...
class CloneBackendRequestBody:
    target_environment_name: str = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('targetEnvironmentName') }})
    

@dataclass
class CloneBackendRequest:
    headers: CloneBackendHeaders = field()
    path_params: CloneBackendPathParams = field()
    request: CloneBackendRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
