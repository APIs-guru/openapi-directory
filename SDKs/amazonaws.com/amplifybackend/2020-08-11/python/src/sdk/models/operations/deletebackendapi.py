...
class DeleteBackendAPIRequestBody:
    ...
    resource_config: Optional[DeleteBackendAPIRequestBodyResourceConfig] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('resourceConfig') }})
    

@dataclass
class DeleteBackendAPIRequest:
    headers: DeleteBackendAPIHeaders = field()
    path_params: DeleteBackendAPIPathParams = field()
    request: DeleteBackendAPIRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
