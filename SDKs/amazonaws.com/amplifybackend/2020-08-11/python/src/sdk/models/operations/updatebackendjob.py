...
class UpdateBackendJobRequest:
    path_params: UpdateBackendJobPathParams = field(default=None)
    headers: UpdateBackendJobHeaders = field(default=None)
    request: UpdateBackendJobRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateBackendJobResponse:
    ...
    update_backend_job_response: Optional[shared.UpdateBackendJobResponse] = field(default=None)
