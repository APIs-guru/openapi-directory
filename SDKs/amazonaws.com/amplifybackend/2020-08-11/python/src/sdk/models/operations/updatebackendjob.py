...
class UpdateBackendJobRequest:
    headers: UpdateBackendJobHeaders = field()
    path_params: UpdateBackendJobPathParams = field()
    request: UpdateBackendJobRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
