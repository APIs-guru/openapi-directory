...
class CreateBackendAPIRequestBody:
    ...
    resource_config: CreateBackendAPIRequestBodyResourceConfig = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('resourceConfig') }})
    resource_name: str = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('resourceName') }})
    

@dataclass
class CreateBackendAPIRequest:
    headers: CreateBackendAPIHeaders = field()
    path_params: CreateBackendAPIPathParams = field()
    request: CreateBackendAPIRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
