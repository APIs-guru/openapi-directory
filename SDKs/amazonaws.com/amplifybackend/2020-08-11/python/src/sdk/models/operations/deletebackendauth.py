...
class DeleteBackendAuthRequest:
    path_params: DeleteBackendAuthPathParams = field(default=None)
    headers: DeleteBackendAuthHeaders = field(default=None)
    request: DeleteBackendAuthRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class DeleteBackendAuthResponse:
    ...
    delete_backend_auth_response: Optional[shared.DeleteBackendAuthResponse] = field(default=None)
