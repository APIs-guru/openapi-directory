...
class DeleteBackendAuthRequest:
    headers: DeleteBackendAuthHeaders = field()
    path_params: DeleteBackendAuthPathParams = field()
    request: DeleteBackendAuthRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
