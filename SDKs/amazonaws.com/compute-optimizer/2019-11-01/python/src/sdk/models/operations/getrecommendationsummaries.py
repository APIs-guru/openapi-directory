...
class GetRecommendationSummariesHeaders:
    x_amz_target: GetRecommendationSummariesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetRecommendationSummariesRequest:
    headers: GetRecommendationSummariesHeaders = field()
    request: shared.GetRecommendationSummariesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
