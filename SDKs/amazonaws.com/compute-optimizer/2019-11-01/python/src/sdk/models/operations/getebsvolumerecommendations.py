...
class GetEbsVolumeRecommendationsHeaders:
    x_amz_target: GetEbsVolumeRecommendationsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetEbsVolumeRecommendationsRequest:
    headers: GetEbsVolumeRecommendationsHeaders = field()
    request: shared.GetEbsVolumeRecommendationsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
