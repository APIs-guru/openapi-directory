...
from . import exportableinstancefield_enum
...
class ExportEc2InstanceRecommendationsRequest:
    ...
    fields_to_export: Optional[List[exportableinstancefield_enum.ExportableInstanceFieldEnum]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'fieldsToExport' }})
