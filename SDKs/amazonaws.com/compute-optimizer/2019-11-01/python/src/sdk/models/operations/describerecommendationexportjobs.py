...
class DescribeRecommendationExportJobsHeaders:
    x_amz_target: DescribeRecommendationExportJobsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeRecommendationExportJobsRequest:
    headers: DescribeRecommendationExportJobsHeaders = field()
    request: shared.DescribeRecommendationExportJobsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
