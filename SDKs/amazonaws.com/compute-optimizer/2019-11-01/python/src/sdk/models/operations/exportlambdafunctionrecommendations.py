...
class ExportLambdaFunctionRecommendationsHeaders:
    x_amz_target: ExportLambdaFunctionRecommendationsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ExportLambdaFunctionRecommendationsRequest:
    headers: ExportLambdaFunctionRecommendationsHeaders = field()
    request: shared.ExportLambdaFunctionRecommendationsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
