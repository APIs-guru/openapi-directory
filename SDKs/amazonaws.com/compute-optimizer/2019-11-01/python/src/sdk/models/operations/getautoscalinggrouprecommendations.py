...
class GetAutoScalingGroupRecommendationsHeaders:
    x_amz_target: GetAutoScalingGroupRecommendationsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetAutoScalingGroupRecommendationsRequest:
    headers: GetAutoScalingGroupRecommendationsHeaders = field()
    request: shared.GetAutoScalingGroupRecommendationsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
