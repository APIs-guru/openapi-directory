...
class ExportAutoScalingGroupRecommendationsHeaders:
    x_amz_target: ExportAutoScalingGroupRecommendationsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ExportAutoScalingGroupRecommendationsRequest:
    headers: ExportAutoScalingGroupRecommendationsHeaders = field()
    request: shared.ExportAutoScalingGroupRecommendationsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
