...
class GetEc2InstanceRecommendationsHeaders:
    ...
    x_amz_target: GetEc2InstanceRecommendationsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetEc2InstanceRecommendationsRequest:
    headers: GetEc2InstanceRecommendationsHeaders = field(default=None)
    request: shared.GetEc2InstanceRecommendationsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
