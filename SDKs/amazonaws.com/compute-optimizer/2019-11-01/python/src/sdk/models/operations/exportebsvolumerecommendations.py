...
class ExportEbsVolumeRecommendationsHeaders:
    x_amz_target: ExportEbsVolumeRecommendationsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ExportEbsVolumeRecommendationsRequest:
    headers: ExportEbsVolumeRecommendationsHeaders = field()
    request: shared.ExportEbsVolumeRecommendationsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
