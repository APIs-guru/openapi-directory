...
class ExportAutoScalingGroupRecommendationsRequest:
    ...
    fields_to_export: Optional[List[ExportableAutoScalingGroupFieldEnum]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('fieldsToExport') }})
