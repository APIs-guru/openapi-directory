...
class GetSuiteRunReportPathParams:
    ...
    suite_run_id: str = field(metadata={'path_param': { 'field_name': 'suiteRunId', 'style': 'simple', 'explode': False }})
...
class GetSuiteRunReportRequest:
    headers: GetSuiteRunReportHeaders = field()
    path_params: GetSuiteRunReportPathParams = field()
