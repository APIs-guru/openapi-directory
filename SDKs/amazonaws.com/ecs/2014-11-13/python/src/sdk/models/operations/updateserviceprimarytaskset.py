...
class UpdateServicePrimaryTaskSetHeaders:
    x_amz_target: UpdateServicePrimaryTaskSetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateServicePrimaryTaskSetRequest:
    headers: UpdateServicePrimaryTaskSetHeaders = field()
    request: shared.UpdateServicePrimaryTaskSetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
