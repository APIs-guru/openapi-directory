...
class UpdateTaskSetHeaders:
    ...
    x_amz_target: UpdateTaskSetXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateTaskSetRequest:
    headers: UpdateTaskSetHeaders = field(default=None)
    request: shared.UpdateTaskSetRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
