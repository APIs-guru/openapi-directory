...
class DescribeTasksHeaders:
    x_amz_target: DescribeTasksXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeTasksRequest:
    headers: DescribeTasksHeaders = field()
    request: shared.DescribeTasksRequest = field(metadata={'request': { 'media_type': 'application/json' }})
