...
class CreateServiceHeaders:
    x_amz_target: CreateServiceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateServiceRequest:
    headers: CreateServiceHeaders = field()
    request: shared.CreateServiceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
