...
class PutAttributesHeaders:
    x_amz_target: PutAttributesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutAttributesRequest:
    headers: PutAttributesHeaders = field()
    request: shared.PutAttributesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
