...
class RunTaskHeaders:
    x_amz_target: RunTaskXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RunTaskRequest:
    headers: RunTaskHeaders = field()
    request: shared.RunTaskRequest = field(metadata={'request': { 'media_type': 'application/json' }})
