...
class PutClusterCapacityProvidersHeaders:
    ...
    x_amz_target: PutClusterCapacityProvidersXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class PutClusterCapacityProvidersRequest:
    headers: PutClusterCapacityProvidersHeaders = field(default=None)
    request: shared.PutClusterCapacityProvidersRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
