...
class DeleteTaskSetHeaders:
    x_amz_target: DeleteTaskSetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteTaskSetRequest:
    headers: DeleteTaskSetHeaders = field()
    request: shared.DeleteTaskSetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
