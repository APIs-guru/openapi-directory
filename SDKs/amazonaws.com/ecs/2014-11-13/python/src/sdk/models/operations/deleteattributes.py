...
class DeleteAttributesHeaders:
    x_amz_target: DeleteAttributesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteAttributesRequest:
    headers: DeleteAttributesHeaders = field()
    request: shared.DeleteAttributesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
