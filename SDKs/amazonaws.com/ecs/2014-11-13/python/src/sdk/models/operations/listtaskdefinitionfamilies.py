...
class ListTaskDefinitionFamiliesHeaders:
    x_amz_target: ListTaskDefinitionFamiliesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListTaskDefinitionFamiliesRequest:
    headers: ListTaskDefinitionFamiliesHeaders = field()
    query_params: ListTaskDefinitionFamiliesQueryParams = field()
    request: shared.ListTaskDefinitionFamiliesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
