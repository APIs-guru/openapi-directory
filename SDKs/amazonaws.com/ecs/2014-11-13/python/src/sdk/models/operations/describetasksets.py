...
class DescribeTaskSetsHeaders:
    ...
    x_amz_target: DescribeTaskSetsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeTaskSetsRequest:
    headers: DescribeTaskSetsHeaders = field(default=None)
    request: shared.DescribeTaskSetsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
