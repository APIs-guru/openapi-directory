...
class SubmitContainerStateChangeHeaders:
    x_amz_target: SubmitContainerStateChangeXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class SubmitContainerStateChangeRequest:
    headers: SubmitContainerStateChangeHeaders = field()
    request: shared.SubmitContainerStateChangeRequest = field(metadata={'request': { 'media_type': 'application/json' }})
