...
class RegisterContainerInstanceHeaders:
    x_amz_target: RegisterContainerInstanceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RegisterContainerInstanceRequest:
    headers: RegisterContainerInstanceHeaders = field()
    request: shared.RegisterContainerInstanceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
