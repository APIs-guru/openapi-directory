...
class DescribeTaskDefinitionHeaders:
    x_amz_target: DescribeTaskDefinitionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeTaskDefinitionRequest:
    headers: DescribeTaskDefinitionHeaders = field()
    request: shared.DescribeTaskDefinitionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
