...
class UpdateContainerAgentHeaders:
    x_amz_target: UpdateContainerAgentXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateContainerAgentRequest:
    headers: UpdateContainerAgentHeaders = field()
    request: shared.UpdateContainerAgentRequest = field(metadata={'request': { 'media_type': 'application/json' }})
