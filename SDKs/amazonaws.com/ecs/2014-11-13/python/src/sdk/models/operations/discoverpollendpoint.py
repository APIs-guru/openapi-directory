...
class DiscoverPollEndpointHeaders:
    x_amz_target: DiscoverPollEndpointXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DiscoverPollEndpointRequest:
    headers: DiscoverPollEndpointHeaders = field()
    request: shared.DiscoverPollEndpointRequest = field(metadata={'request': { 'media_type': 'application/json' }})
