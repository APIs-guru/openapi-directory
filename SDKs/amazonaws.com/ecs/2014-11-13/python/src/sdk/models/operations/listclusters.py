...
class ListClustersHeaders:
    x_amz_target: ListClustersXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListClustersRequest:
    ...
    request: shared.ListClustersRequest = field(metadata={'request': { 'media_type': 'application/json' }})
