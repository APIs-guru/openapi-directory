...
class PutAccountSettingDefaultHeaders:
    ...
    x_amz_target: PutAccountSettingDefaultXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class PutAccountSettingDefaultRequest:
    headers: PutAccountSettingDefaultHeaders = field(default=None)
    request: shared.PutAccountSettingDefaultRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
