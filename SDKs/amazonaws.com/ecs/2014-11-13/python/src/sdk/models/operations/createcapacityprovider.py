...
class CreateCapacityProviderHeaders:
    x_amz_target: CreateCapacityProviderXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateCapacityProviderRequest:
    headers: CreateCapacityProviderHeaders = field()
    request: shared.CreateCapacityProviderRequest = field(metadata={'request': { 'media_type': 'application/json' }})
