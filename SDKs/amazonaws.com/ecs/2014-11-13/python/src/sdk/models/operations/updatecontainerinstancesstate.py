...
class UpdateContainerInstancesStateHeaders:
    ...
    x_amz_target: UpdateContainerInstancesStateXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateContainerInstancesStateRequest:
    headers: UpdateContainerInstancesStateHeaders = field(default=None)
    request: shared.UpdateContainerInstancesStateRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
