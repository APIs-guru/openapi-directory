...
**/
var InferenceAcceleratorOverride = /** @class */ (function (_super) {
    __extends(InferenceAcceleratorOverride, _super);
    ...
    ], InferenceAcceleratorOverride.prototype, "deviceName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=deviceType" }),
        __metadata("design:type", String)
    ], InferenceAcceleratorOverride.prototype, "deviceType", void 0);
    return InferenceAcceleratorOverride;
}(SpeakeasyBase));
export { InferenceAcceleratorOverride };
