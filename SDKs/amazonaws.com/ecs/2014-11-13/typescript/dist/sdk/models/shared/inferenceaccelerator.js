...
**/
var InferenceAccelerator = /** @class */ (function (_super) {
    __extends(InferenceAccelerator, _super);
    ...
    ], InferenceAccelerator.prototype, "deviceName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=deviceType" }),
        __metadata("design:type", String)
    ], InferenceAccelerator.prototype, "deviceType", void 0);
    return InferenceAccelerator;
}(SpeakeasyBase));
export { InferenceAccelerator };
