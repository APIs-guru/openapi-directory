...
class UpdateConfigurationSetEventDestinationRequestBody:
    event_destination: Optional[UpdateConfigurationSetEventDestinationRequestBodyEventDestination] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('EventDestination') }})
