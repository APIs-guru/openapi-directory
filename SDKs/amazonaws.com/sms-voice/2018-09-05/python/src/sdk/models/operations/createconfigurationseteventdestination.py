...
class CreateConfigurationSetEventDestinationRequestBody:
    event_destination: Optional[CreateConfigurationSetEventDestinationRequestBodyEventDestination] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'EventDestination' }})
    event_destination_name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'EventDestinationName' }})
