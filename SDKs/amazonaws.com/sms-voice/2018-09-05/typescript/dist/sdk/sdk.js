...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.CreateConfigurationSet = function (req, config) {
        ...
        var url = baseURL.replace(/\/$/, "") + "/v1/sms-voice/configuration-sets";
    ...
    SDK.prototype.CreateConfigurationSetEventDestination = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/sms-voice/configuration-sets/{ConfigurationSetName}/event-destinations", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.DeleteConfigurationSet = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/sms-voice/configuration-sets/{ConfigurationSetName}", req.pathParams);
        var client = this.securityClient;
    ...
    SDK.prototype.DeleteConfigurationSetEventDestination = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/v1/sms-voice/configuration-sets/{ConfigurationSetName}/event-destinations/{EventDestinationName}", req.pathParams);
        var client = this.securityClient;
        var headers = __assign(__assign({}, GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .delete(url, __assign({}, config))
    ...
    SDK.prototype.SendVoiceMessage = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/v1/sms-voice/voice/message";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return client
            ...
            switch (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) {
                case 200:
                    if (MatchContentType(contentType, "application/json")) {
                        res.sendVoiceMessageResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case 480:
                    if (MatchContentType(contentType, "application/json")) {
