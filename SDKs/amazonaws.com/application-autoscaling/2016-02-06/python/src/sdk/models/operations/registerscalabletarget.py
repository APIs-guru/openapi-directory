...
class RegisterScalableTargetHeaders:
    x_amz_target: RegisterScalableTargetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RegisterScalableTargetRequest:
    headers: RegisterScalableTargetHeaders = field()
    request: shared.RegisterScalableTargetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
