...
class DescribeScalingPoliciesHeaders:
    x_amz_target: DescribeScalingPoliciesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeScalingPoliciesRequest:
    headers: DescribeScalingPoliciesHeaders = field()
    query_params: DescribeScalingPoliciesQueryParams = field()
    request: shared.DescribeScalingPoliciesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
