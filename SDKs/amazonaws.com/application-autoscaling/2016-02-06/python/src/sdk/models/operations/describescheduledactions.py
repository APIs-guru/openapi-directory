...
class DescribeScheduledActionsHeaders:
    x_amz_target: DescribeScheduledActionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeScheduledActionsRequest:
    headers: DescribeScheduledActionsHeaders = field()
    query_params: DescribeScheduledActionsQueryParams = field()
    request: shared.DescribeScheduledActionsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
