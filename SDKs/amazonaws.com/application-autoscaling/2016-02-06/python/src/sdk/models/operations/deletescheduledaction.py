...
class DeleteScheduledActionHeaders:
    x_amz_target: DeleteScheduledActionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteScheduledActionRequest:
    headers: DeleteScheduledActionHeaders = field()
    request: shared.DeleteScheduledActionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
