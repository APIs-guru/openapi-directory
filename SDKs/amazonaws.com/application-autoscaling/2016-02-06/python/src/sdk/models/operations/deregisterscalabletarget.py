...
class DeregisterScalableTargetHeaders:
    x_amz_target: DeregisterScalableTargetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeregisterScalableTargetRequest:
    headers: DeregisterScalableTargetHeaders = field()
    request: shared.DeregisterScalableTargetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
