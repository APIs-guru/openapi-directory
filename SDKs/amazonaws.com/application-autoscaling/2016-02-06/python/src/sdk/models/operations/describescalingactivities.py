...
class DescribeScalingActivitiesHeaders:
    x_amz_target: DescribeScalingActivitiesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeScalingActivitiesRequest:
    headers: DescribeScalingActivitiesHeaders = field()
    query_params: DescribeScalingActivitiesQueryParams = field()
    request: shared.DescribeScalingActivitiesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
