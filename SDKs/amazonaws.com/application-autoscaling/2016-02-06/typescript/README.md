...
import { DeleteScalingPolicyRequest, DeleteScalingPolicyResponse } from "openapi/src/sdk/models/operations";
...
sdk.sdk.deleteScalingPolicy(req).then((res: DeleteScalingPolicyResponse | AxiosError) => {
   // handle response
});
```
