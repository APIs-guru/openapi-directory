...
class GetServiceQuotaHeaders:
    x_amz_target: GetServiceQuotaXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetServiceQuotaRequest:
    headers: GetServiceQuotaHeaders = field()
    request: shared.GetServiceQuotaRequest = field(metadata={'request': { 'media_type': 'application/json' }})
