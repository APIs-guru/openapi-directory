...
class AssociateServiceQuotaTemplateHeaders:
    x_amz_target: AssociateServiceQuotaTemplateXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AssociateServiceQuotaTemplateRequest:
    headers: AssociateServiceQuotaTemplateHeaders = field()
