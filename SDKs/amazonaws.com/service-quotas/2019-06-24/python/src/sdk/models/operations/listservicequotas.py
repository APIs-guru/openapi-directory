...
class ListServiceQuotasHeaders:
    x_amz_target: ListServiceQuotasXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListServiceQuotasRequest:
    headers: ListServiceQuotasHeaders = field()
    query_params: ListServiceQuotasQueryParams = field()
    request: shared.ListServiceQuotasRequest = field(metadata={'request': { 'media_type': 'application/json' }})
