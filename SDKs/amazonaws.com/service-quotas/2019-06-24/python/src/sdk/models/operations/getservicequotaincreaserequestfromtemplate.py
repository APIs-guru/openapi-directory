...
class GetServiceQuotaIncreaseRequestFromTemplateHeaders:
    x_amz_target: GetServiceQuotaIncreaseRequestFromTemplateXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetServiceQuotaIncreaseRequestFromTemplateRequest:
    headers: GetServiceQuotaIncreaseRequestFromTemplateHeaders = field()
    request: shared.GetServiceQuotaIncreaseRequestFromTemplateRequest = field(metadata={'request': { 'media_type': 'application/json' }})
