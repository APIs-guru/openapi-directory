...
class ListAwsDefaultServiceQuotasHeaders:
    x_amz_target: ListAwsDefaultServiceQuotasXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListAwsDefaultServiceQuotasRequest:
    headers: ListAwsDefaultServiceQuotasHeaders = field()
    query_params: ListAwsDefaultServiceQuotasQueryParams = field()
    request: shared.ListAwsDefaultServiceQuotasRequest = field(metadata={'request': { 'media_type': 'application/json' }})
