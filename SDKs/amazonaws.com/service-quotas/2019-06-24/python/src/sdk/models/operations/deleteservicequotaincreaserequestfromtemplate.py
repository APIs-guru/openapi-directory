...
class DeleteServiceQuotaIncreaseRequestFromTemplateHeaders:
    ...
    x_amz_target: DeleteServiceQuotaIncreaseRequestFromTemplateXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
