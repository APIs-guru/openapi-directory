...
class DeleteServiceQuotaIncreaseRequestFromTemplateHeaders:
    x_amz_target: DeleteServiceQuotaIncreaseRequestFromTemplateXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteServiceQuotaIncreaseRequestFromTemplateRequest:
    headers: DeleteServiceQuotaIncreaseRequestFromTemplateHeaders = field()
    request: shared.DeleteServiceQuotaIncreaseRequestFromTemplateRequest = field(metadata={'request': { 'media_type': 'application/json' }})
