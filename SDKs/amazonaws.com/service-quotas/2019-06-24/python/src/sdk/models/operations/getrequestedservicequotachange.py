...
class GetRequestedServiceQuotaChangeHeaders:
    ...
    x_amz_target: GetRequestedServiceQuotaChangeXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetRequestedServiceQuotaChangeRequest:
    headers: GetRequestedServiceQuotaChangeHeaders = field(default=None)
    request: shared.GetRequestedServiceQuotaChangeRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
