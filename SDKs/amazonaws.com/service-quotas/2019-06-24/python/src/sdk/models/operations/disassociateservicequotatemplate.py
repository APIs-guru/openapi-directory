...
class DisassociateServiceQuotaTemplateHeaders:
    x_amz_target: DisassociateServiceQuotaTemplateXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DisassociateServiceQuotaTemplateRequest:
    headers: DisassociateServiceQuotaTemplateHeaders = field()
