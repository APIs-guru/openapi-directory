...
class ListServiceQuotaIncreaseRequestsInTemplateHeaders:
    ...
    x_amz_target: ListServiceQuotaIncreaseRequestsInTemplateXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
