...
class PutServiceQuotaIncreaseRequestIntoTemplateHeaders:
    x_amz_target: PutServiceQuotaIncreaseRequestIntoTemplateXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutServiceQuotaIncreaseRequestIntoTemplateRequest:
    headers: PutServiceQuotaIncreaseRequestIntoTemplateHeaders = field()
    request: shared.PutServiceQuotaIncreaseRequestIntoTemplateRequest = field(metadata={'request': { 'media_type': 'application/json' }})
