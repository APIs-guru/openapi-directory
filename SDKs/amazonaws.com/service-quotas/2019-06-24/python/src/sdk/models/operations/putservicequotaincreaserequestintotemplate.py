...
class PutServiceQuotaIncreaseRequestIntoTemplateHeaders:
    ...
    x_amz_target: PutServiceQuotaIncreaseRequestIntoTemplateXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class PutServiceQuotaIncreaseRequestIntoTemplateRequest:
    headers: PutServiceQuotaIncreaseRequestIntoTemplateHeaders = field(default=None)
    request: shared.PutServiceQuotaIncreaseRequestIntoTemplateRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class PutServiceQuotaIncreaseRequestIntoTemplateResponse:
    ...
    put_service_quota_increase_request_into_template_response: Optional[shared.PutServiceQuotaIncreaseRequestIntoTemplateResponse] = field(default=None)
