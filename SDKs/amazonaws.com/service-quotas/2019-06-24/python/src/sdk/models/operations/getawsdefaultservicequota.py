...
class GetAwsDefaultServiceQuotaHeaders:
    x_amz_target: GetAwsDefaultServiceQuotaXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetAwsDefaultServiceQuotaRequest:
    headers: GetAwsDefaultServiceQuotaHeaders = field()
    request: shared.GetAwsDefaultServiceQuotaRequest = field(metadata={'request': { 'media_type': 'application/json' }})
