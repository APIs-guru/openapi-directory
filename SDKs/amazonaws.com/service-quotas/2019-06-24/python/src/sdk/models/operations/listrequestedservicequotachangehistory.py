...
class ListRequestedServiceQuotaChangeHistoryHeaders:
    x_amz_target: ListRequestedServiceQuotaChangeHistoryXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListRequestedServiceQuotaChangeHistoryRequest:
    headers: ListRequestedServiceQuotaChangeHistoryHeaders = field()
    query_params: ListRequestedServiceQuotaChangeHistoryQueryParams = field()
    request: shared.ListRequestedServiceQuotaChangeHistoryRequest = field(metadata={'request': { 'media_type': 'application/json' }})
