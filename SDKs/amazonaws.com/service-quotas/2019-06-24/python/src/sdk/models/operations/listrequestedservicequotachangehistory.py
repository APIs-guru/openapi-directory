...
class ListRequestedServiceQuotaChangeHistoryHeaders:
    ...
    x_amz_target: ListRequestedServiceQuotaChangeHistoryXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ListRequestedServiceQuotaChangeHistoryRequest:
    query_params: ListRequestedServiceQuotaChangeHistoryQueryParams = field(default=None)
    headers: ListRequestedServiceQuotaChangeHistoryHeaders = field(default=None)
    request: shared.ListRequestedServiceQuotaChangeHistoryRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class ListRequestedServiceQuotaChangeHistoryResponse:
    ...
    list_requested_service_quota_change_history_response: Optional[shared.ListRequestedServiceQuotaChangeHistoryResponse] = field(default=None)
