...
class GetAssociationForServiceQuotaTemplateHeaders:
    ...
    x_amz_target: GetAssociationForServiceQuotaTemplateXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetAssociationForServiceQuotaTemplateRequest:
    headers: GetAssociationForServiceQuotaTemplateHeaders = field(default=None)
