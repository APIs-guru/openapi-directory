...
class DisassociateTeamMemberHeaders:
    x_amz_target: DisassociateTeamMemberXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DisassociateTeamMemberRequest:
    headers: DisassociateTeamMemberHeaders = field()
    request: shared.DisassociateTeamMemberRequest = field(metadata={'request': { 'media_type': 'application/json' }})
