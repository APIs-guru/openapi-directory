...
class ListTeamMembersHeaders:
    x_amz_target: ListTeamMembersXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListTeamMembersRequest:
    headers: ListTeamMembersHeaders = field()
    request: shared.ListTeamMembersRequest = field(metadata={'request': { 'media_type': 'application/json' }})
