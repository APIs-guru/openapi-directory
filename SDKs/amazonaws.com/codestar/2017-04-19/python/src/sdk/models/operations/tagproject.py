...
class TagProjectHeaders:
    x_amz_target: TagProjectXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class TagProjectRequest:
    headers: TagProjectHeaders = field()
    request: shared.TagProjectRequest = field(metadata={'request': { 'media_type': 'application/json' }})
