...
class DescribeProjectHeaders:
    x_amz_target: DescribeProjectXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeProjectRequest:
    ...
    request: shared.DescribeProjectRequest = field(metadata={'request': { 'media_type': 'application/json' }})
