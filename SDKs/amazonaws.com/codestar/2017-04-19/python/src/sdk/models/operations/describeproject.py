...
class DescribeProjectHeaders:
    ...
    x_amz_target: DescribeProjectXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeProjectRequest:
    headers: DescribeProjectHeaders = field(default=None)
    request: shared.DescribeProjectRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
