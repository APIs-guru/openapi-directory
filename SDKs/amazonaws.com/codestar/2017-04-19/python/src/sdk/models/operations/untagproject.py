...
class UntagProjectHeaders:
    x_amz_target: UntagProjectXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UntagProjectRequest:
    headers: UntagProjectHeaders = field()
    request: shared.UntagProjectRequest = field(metadata={'request': { 'media_type': 'application/json' }})
