...
class SendTaskFailureHeaders:
    ...
    x_amz_target: SendTaskFailureXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class SendTaskFailureRequest:
    headers: SendTaskFailureHeaders = field(default=None)
    request: shared.SendTaskFailureInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
