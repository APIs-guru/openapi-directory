...
class CreateActivityHeaders:
    x_amz_target: CreateActivityXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateActivityRequest:
    headers: CreateActivityHeaders = field()
    request: shared.CreateActivityInput = field(metadata={'request': { 'media_type': 'application/json' }})
