...
class SendTaskSuccessHeaders:
    x_amz_target: SendTaskSuccessXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class SendTaskSuccessRequest:
    headers: SendTaskSuccessHeaders = field()
    request: shared.SendTaskSuccessInput = field(metadata={'request': { 'media_type': 'application/json' }})
