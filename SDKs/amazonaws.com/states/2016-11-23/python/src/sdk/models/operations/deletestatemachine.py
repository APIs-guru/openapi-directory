...
class DeleteStateMachineHeaders:
    x_amz_target: DeleteStateMachineXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteStateMachineRequest:
    headers: DeleteStateMachineHeaders = field()
    request: shared.DeleteStateMachineInput = field(metadata={'request': { 'media_type': 'application/json' }})
