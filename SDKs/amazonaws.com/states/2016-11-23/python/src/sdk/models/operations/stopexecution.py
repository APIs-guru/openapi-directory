...
class StopExecutionHeaders:
    x_amz_target: StopExecutionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StopExecutionRequest:
    headers: StopExecutionHeaders = field()
    request: shared.StopExecutionInput = field(metadata={'request': { 'media_type': 'application/json' }})
