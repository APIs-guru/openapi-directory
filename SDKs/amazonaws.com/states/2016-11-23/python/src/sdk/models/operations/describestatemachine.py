...
class DescribeStateMachineHeaders:
    x_amz_target: DescribeStateMachineXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeStateMachineRequest:
    headers: DescribeStateMachineHeaders = field()
    request: shared.DescribeStateMachineInput = field(metadata={'request': { 'media_type': 'application/json' }})
