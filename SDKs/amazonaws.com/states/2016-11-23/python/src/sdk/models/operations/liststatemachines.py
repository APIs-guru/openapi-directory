...
class ListStateMachinesHeaders:
    x_amz_target: ListStateMachinesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListStateMachinesRequest:
    headers: ListStateMachinesHeaders = field()
    query_params: ListStateMachinesQueryParams = field()
    request: shared.ListStateMachinesInput = field(metadata={'request': { 'media_type': 'application/json' }})
