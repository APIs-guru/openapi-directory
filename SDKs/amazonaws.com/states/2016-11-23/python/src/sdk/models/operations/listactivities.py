...
class ListActivitiesHeaders:
    x_amz_target: ListActivitiesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListActivitiesRequest:
    headers: ListActivitiesHeaders = field()
    query_params: ListActivitiesQueryParams = field()
    request: shared.ListActivitiesInput = field(metadata={'request': { 'media_type': 'application/json' }})
