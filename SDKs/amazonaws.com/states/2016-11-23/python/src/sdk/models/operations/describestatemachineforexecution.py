...
class DescribeStateMachineForExecutionHeaders:
    ...
    x_amz_target: DescribeStateMachineForExecutionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeStateMachineForExecutionRequest:
    headers: DescribeStateMachineForExecutionHeaders = field(default=None)
    request: shared.DescribeStateMachineForExecutionInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
