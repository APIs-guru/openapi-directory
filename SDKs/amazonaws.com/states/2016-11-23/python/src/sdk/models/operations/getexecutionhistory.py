...
class GetExecutionHistoryHeaders:
    x_amz_target: GetExecutionHistoryXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetExecutionHistoryRequest:
    headers: GetExecutionHistoryHeaders = field()
    query_params: GetExecutionHistoryQueryParams = field()
    request: shared.GetExecutionHistoryInput = field(metadata={'request': { 'media_type': 'application/json' }})
