...
class StartExecutionHeaders:
    x_amz_target: StartExecutionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartExecutionRequest:
    headers: StartExecutionHeaders = field()
    request: shared.StartExecutionInput = field(metadata={'request': { 'media_type': 'application/json' }})
