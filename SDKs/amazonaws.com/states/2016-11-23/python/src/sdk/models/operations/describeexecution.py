...
class DescribeExecutionHeaders:
    ...
    x_amz_target: DescribeExecutionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeExecutionRequest:
    headers: DescribeExecutionHeaders = field(default=None)
    request: shared.DescribeExecutionInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
