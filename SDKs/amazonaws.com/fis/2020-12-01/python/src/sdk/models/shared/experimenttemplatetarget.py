...
from . import experimenttemplatetargetfilter


@dataclass_json
@dataclass
class ExperimentTemplateTarget:
    filters: Optional[List[experimenttemplatetargetfilter.ExperimentTemplateTargetFilter]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'filters' }})
