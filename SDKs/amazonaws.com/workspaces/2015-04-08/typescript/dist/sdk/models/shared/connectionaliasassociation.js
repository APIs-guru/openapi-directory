...
**/
var ConnectionAliasAssociation = /** @class */ (function (_super) {
    __extends(ConnectionAliasAssociation, _super);
    ...
    ], ConnectionAliasAssociation.prototype, "associatedAccountId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=AssociationStatus" }),
        __metadata("design:type", String)
    ], ConnectionAliasAssociation.prototype, "associationStatus", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ConnectionIdentifier" }),
        __metadata("design:type", String)
    ], ConnectionAliasAssociation.prototype, "connectionIdentifier", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ResourceId" }),
        __metadata("design:type", String)
    ], ConnectionAliasAssociation.prototype, "resourceId", void 0);
    return ConnectionAliasAssociation;
}(SpeakeasyBase));
export { ConnectionAliasAssociation };
