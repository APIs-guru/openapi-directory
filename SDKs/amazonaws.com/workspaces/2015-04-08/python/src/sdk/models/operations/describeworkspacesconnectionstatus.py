...
class DescribeWorkspacesConnectionStatusHeaders:
    ...
    x_amz_target: DescribeWorkspacesConnectionStatusXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeWorkspacesConnectionStatusRequest:
    headers: DescribeWorkspacesConnectionStatusHeaders = field(default=None)
    request: shared.DescribeWorkspacesConnectionStatusRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
