...
class DeleteConnectionAliasHeaders:
    ...
    x_amz_target: DeleteConnectionAliasXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeleteConnectionAliasRequest:
    headers: DeleteConnectionAliasHeaders = field(default=None)
    request: shared.DeleteConnectionAliasRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
