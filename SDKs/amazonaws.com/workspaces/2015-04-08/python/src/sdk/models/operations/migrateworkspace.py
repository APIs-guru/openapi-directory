...
class MigrateWorkspaceHeaders:
    ...
    x_amz_target: MigrateWorkspaceXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class MigrateWorkspaceRequest:
    headers: MigrateWorkspaceHeaders = field(default=None)
    request: shared.MigrateWorkspaceRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
