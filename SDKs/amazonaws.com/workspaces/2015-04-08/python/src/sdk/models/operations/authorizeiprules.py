...
class AuthorizeIPRulesHeaders:
    x_amz_target: AuthorizeIPRulesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AuthorizeIPRulesRequest:
    headers: AuthorizeIPRulesHeaders = field()
    request: shared.AuthorizeIPRulesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
