...
class DescribeAccountModificationsHeaders:
    x_amz_target: DescribeAccountModificationsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeAccountModificationsRequest:
    headers: DescribeAccountModificationsHeaders = field()
    request: shared.DescribeAccountModificationsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
