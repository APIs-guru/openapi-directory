...
class ModifyWorkspaceAccessPropertiesHeaders:
    x_amz_target: ModifyWorkspaceAccessPropertiesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ModifyWorkspaceAccessPropertiesRequest:
    headers: ModifyWorkspaceAccessPropertiesHeaders = field()
    request: shared.ModifyWorkspaceAccessPropertiesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
