...
class DescribeWorkspaceImagesHeaders:
    x_amz_target: DescribeWorkspaceImagesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeWorkspaceImagesRequest:
    headers: DescribeWorkspaceImagesHeaders = field()
    request: shared.DescribeWorkspaceImagesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
