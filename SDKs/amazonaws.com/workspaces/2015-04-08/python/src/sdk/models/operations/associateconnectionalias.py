...
class AssociateConnectionAliasHeaders:
    ...
    x_amz_target: AssociateConnectionAliasXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class AssociateConnectionAliasRequest:
    headers: AssociateConnectionAliasHeaders = field(default=None)
    request: shared.AssociateConnectionAliasRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
