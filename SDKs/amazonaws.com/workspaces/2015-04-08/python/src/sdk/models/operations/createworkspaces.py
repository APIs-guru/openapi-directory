...
class CreateWorkspacesHeaders:
    x_amz_target: CreateWorkspacesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateWorkspacesRequest:
    headers: CreateWorkspacesHeaders = field()
    request: shared.CreateWorkspacesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
