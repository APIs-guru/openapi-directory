...
class ImportWorkspaceImageHeaders:
    x_amz_target: ImportWorkspaceImageXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ImportWorkspaceImageRequest:
    headers: ImportWorkspaceImageHeaders = field()
    request: shared.ImportWorkspaceImageRequest = field(metadata={'request': { 'media_type': 'application/json' }})
