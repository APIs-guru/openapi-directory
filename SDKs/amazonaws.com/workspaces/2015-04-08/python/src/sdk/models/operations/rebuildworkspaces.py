...
class RebuildWorkspacesHeaders:
    x_amz_target: RebuildWorkspacesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RebuildWorkspacesRequest:
    headers: RebuildWorkspacesHeaders = field()
    request: shared.RebuildWorkspacesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
