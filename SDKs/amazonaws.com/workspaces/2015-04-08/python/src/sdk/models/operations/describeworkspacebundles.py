...
class DescribeWorkspaceBundlesHeaders:
    x_amz_target: DescribeWorkspaceBundlesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeWorkspaceBundlesRequest:
    headers: DescribeWorkspaceBundlesHeaders = field()
    query_params: DescribeWorkspaceBundlesQueryParams = field()
    request: shared.DescribeWorkspaceBundlesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
