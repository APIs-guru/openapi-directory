...
class UpdateWorkspaceBundleHeaders:
    x_amz_target: UpdateWorkspaceBundleXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateWorkspaceBundleRequest:
    headers: UpdateWorkspaceBundleHeaders = field()
    request: shared.UpdateWorkspaceBundleRequest = field(metadata={'request': { 'media_type': 'application/json' }})
