...
class DescribeWorkspaceSnapshotsHeaders:
    x_amz_target: DescribeWorkspaceSnapshotsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeWorkspaceSnapshotsRequest:
    headers: DescribeWorkspaceSnapshotsHeaders = field()
    request: shared.DescribeWorkspaceSnapshotsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
