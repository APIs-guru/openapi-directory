...
class DescribeConnectionAliasesHeaders:
    x_amz_target: DescribeConnectionAliasesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeConnectionAliasesRequest:
    headers: DescribeConnectionAliasesHeaders = field()
    request: shared.DescribeConnectionAliasesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
