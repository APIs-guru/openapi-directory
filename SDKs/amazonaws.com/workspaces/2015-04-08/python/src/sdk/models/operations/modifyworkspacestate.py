...
class ModifyWorkspaceStateHeaders:
    x_amz_target: ModifyWorkspaceStateXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ModifyWorkspaceStateRequest:
    headers: ModifyWorkspaceStateHeaders = field()
    request: shared.ModifyWorkspaceStateRequest = field(metadata={'request': { 'media_type': 'application/json' }})
