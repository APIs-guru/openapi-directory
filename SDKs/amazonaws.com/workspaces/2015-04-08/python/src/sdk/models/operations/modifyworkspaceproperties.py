...
class ModifyWorkspacePropertiesHeaders:
    x_amz_target: ModifyWorkspacePropertiesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ModifyWorkspacePropertiesRequest:
    headers: ModifyWorkspacePropertiesHeaders = field()
    request: shared.ModifyWorkspacePropertiesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
