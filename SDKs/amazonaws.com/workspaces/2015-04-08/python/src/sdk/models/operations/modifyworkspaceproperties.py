...
class ModifyWorkspacePropertiesHeaders:
    ...
    x_amz_target: ModifyWorkspacePropertiesXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ModifyWorkspacePropertiesRequest:
    headers: ModifyWorkspacePropertiesHeaders = field(default=None)
    request: shared.ModifyWorkspacePropertiesRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class ModifyWorkspacePropertiesResponse:
    ...
    modify_workspace_properties_result: Optional[dict[str, Any]] = field(default=None)
    ...
    unsupported_workspace_configuration_exception: Optional[Any] = field(default=None)
