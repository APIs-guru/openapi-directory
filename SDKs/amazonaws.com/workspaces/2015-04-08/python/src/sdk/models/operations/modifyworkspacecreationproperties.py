...
class ModifyWorkspaceCreationPropertiesHeaders:
    ...
    x_amz_target: ModifyWorkspaceCreationPropertiesXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ModifyWorkspaceCreationPropertiesRequest:
    headers: ModifyWorkspaceCreationPropertiesHeaders = field(default=None)
    request: shared.ModifyWorkspaceCreationPropertiesRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
