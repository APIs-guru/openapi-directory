...
class RebootWorkspacesHeaders:
    ...
    x_amz_target: RebootWorkspacesXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class RebootWorkspacesRequest:
    headers: RebootWorkspacesHeaders = field(default=None)
    request: shared.RebootWorkspacesRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
