...
class CopyWorkspaceImageHeaders:
    x_amz_target: CopyWorkspaceImageXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CopyWorkspaceImageRequest:
    headers: CopyWorkspaceImageHeaders = field()
    request: shared.CopyWorkspaceImageRequest = field(metadata={'request': { 'media_type': 'application/json' }})
