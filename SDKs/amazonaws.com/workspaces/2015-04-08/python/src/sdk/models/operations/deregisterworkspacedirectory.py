...
class DeregisterWorkspaceDirectoryHeaders:
    x_amz_target: DeregisterWorkspaceDirectoryXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeregisterWorkspaceDirectoryRequest:
    headers: DeregisterWorkspaceDirectoryHeaders = field()
    request: shared.DeregisterWorkspaceDirectoryRequest = field(metadata={'request': { 'media_type': 'application/json' }})
