...
class AssociateIPGroupsHeaders:
    x_amz_target: AssociateIPGroupsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AssociateIPGroupsRequest:
    headers: AssociateIPGroupsHeaders = field()
    request: shared.AssociateIPGroupsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
