...
class RevokeIPRulesHeaders:
    x_amz_target: RevokeIPRulesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RevokeIPRulesRequest:
    headers: RevokeIPRulesHeaders = field()
    request: shared.RevokeIPRulesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
