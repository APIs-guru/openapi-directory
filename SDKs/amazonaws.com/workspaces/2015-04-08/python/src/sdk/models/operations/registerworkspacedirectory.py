...
class RegisterWorkspaceDirectoryHeaders:
    x_amz_target: RegisterWorkspaceDirectoryXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RegisterWorkspaceDirectoryRequest:
    headers: RegisterWorkspaceDirectoryHeaders = field()
    request: shared.RegisterWorkspaceDirectoryRequest = field(metadata={'request': { 'media_type': 'application/json' }})
