...
class TerminateWorkspacesHeaders:
    x_amz_target: TerminateWorkspacesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class TerminateWorkspacesRequest:
    headers: TerminateWorkspacesHeaders = field()
    request: shared.TerminateWorkspacesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
