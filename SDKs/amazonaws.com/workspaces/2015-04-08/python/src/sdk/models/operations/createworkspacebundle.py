...
class CreateWorkspaceBundleHeaders:
    x_amz_target: CreateWorkspaceBundleXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateWorkspaceBundleRequest:
    headers: CreateWorkspaceBundleHeaders = field()
    request: shared.CreateWorkspaceBundleRequest = field(metadata={'request': { 'media_type': 'application/json' }})
