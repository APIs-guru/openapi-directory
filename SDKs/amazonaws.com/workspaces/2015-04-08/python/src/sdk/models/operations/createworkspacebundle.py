...
class CreateWorkspaceBundleHeaders:
    ...
    x_amz_target: CreateWorkspaceBundleXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateWorkspaceBundleRequest:
    headers: CreateWorkspaceBundleHeaders = field(default=None)
    request: shared.CreateWorkspaceBundleRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class CreateWorkspaceBundleResponse:
    ...
    create_workspace_bundle_result: Optional[shared.CreateWorkspaceBundleResult] = field(default=None)
