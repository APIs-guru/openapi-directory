...
class DescribeClientPropertiesHeaders:
    x_amz_target: DescribeClientPropertiesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeClientPropertiesRequest:
    headers: DescribeClientPropertiesHeaders = field()
    request: shared.DescribeClientPropertiesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
