...
class DeleteWorkspaceImageHeaders:
    x_amz_target: DeleteWorkspaceImageXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteWorkspaceImageRequest:
    headers: DeleteWorkspaceImageHeaders = field()
    request: shared.DeleteWorkspaceImageRequest = field(metadata={'request': { 'media_type': 'application/json' }})
