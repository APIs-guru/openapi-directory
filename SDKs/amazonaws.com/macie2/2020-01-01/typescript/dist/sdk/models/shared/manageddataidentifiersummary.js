...
**/
var ManagedDataIdentifierSummary = /** @class */ (function (_super) {
    __extends(ManagedDataIdentifierSummary, _super);
    ...
    ], ManagedDataIdentifierSummary.prototype, "category", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=id" }),
        __metadata("design:type", String)
    ], ManagedDataIdentifierSummary.prototype, "id", void 0);
    return ManagedDataIdentifierSummary;
}(SpeakeasyBase));
export { ManagedDataIdentifierSummary };
