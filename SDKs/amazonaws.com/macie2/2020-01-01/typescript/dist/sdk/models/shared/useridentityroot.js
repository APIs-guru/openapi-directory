...
**/
var UserIdentityRoot = /** @class */ (function (_super) {
    __extends(UserIdentityRoot, _super);
    ...
    ], UserIdentityRoot.prototype, "accountId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=arn" }),
        __metadata("design:type", String)
    ], UserIdentityRoot.prototype, "arn", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=principalId" }),
        __metadata("design:type", String)
    ], UserIdentityRoot.prototype, "principalId", void 0);
    return UserIdentityRoot;
}(SpeakeasyBase));
export { UserIdentityRoot };
