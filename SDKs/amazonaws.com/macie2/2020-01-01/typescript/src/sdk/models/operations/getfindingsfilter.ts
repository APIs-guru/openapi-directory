...
export class GetFindingsFilterPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetFindingsFilterHeaders extends SpeakeasyBase {
...
export class GetFindingsFilterRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
