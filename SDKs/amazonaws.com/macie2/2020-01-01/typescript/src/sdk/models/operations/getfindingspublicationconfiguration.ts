...
export class GetFindingsPublicationConfigurationHeaders extends SpeakeasyBase {
...
export class GetFindingsPublicationConfigurationRequest extends SpeakeasyBase {
  @Metadata()
