...
export class GetClassificationExportConfigurationHeaders extends SpeakeasyBase {
...
export class GetClassificationExportConfigurationRequest extends SpeakeasyBase {
  @Metadata()
