...
class CreateCustomDataIdentifierRequest:
    headers: CreateCustomDataIdentifierHeaders = field(default=None)
    request: CreateCustomDataIdentifierRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
