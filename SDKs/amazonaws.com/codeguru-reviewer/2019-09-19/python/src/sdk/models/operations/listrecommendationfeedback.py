...
class ListRecommendationFeedbackRequest:
    headers: ListRecommendationFeedbackHeaders = field()
    path_params: ListRecommendationFeedbackPathParams = field()
    query_params: ListRecommendationFeedbackQueryParams = field()
