...
var ListAssignmentsForHitRequest = /** @class */ (function (_super) {
    ...
    ], ListAssignmentsForHitRequest.prototype, "assignmentStatuses", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=HITId" }),
        __metadata("design:type", String)
    ], ListAssignmentsForHitRequest.prototype, "hitId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=MaxResults" }),
        __metadata("design:type", Number)
    ], ListAssignmentsForHitRequest.prototype, "maxResults", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=NextToken" }),
        __metadata("design:type", String)
    ], ListAssignmentsForHitRequest.prototype, "nextToken", void 0);
