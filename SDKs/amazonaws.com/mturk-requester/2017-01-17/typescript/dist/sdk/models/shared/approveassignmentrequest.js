...
var ApproveAssignmentRequest = /** @class */ (function (_super) {
    ...
    ], ApproveAssignmentRequest.prototype, "assignmentId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=OverrideRejection" }),
        __metadata("design:type", Boolean)
    ], ApproveAssignmentRequest.prototype, "overrideRejection", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=RequesterFeedback" }),
        __metadata("design:type", String)
    ], ApproveAssignmentRequest.prototype, "requesterFeedback", void 0);
