...
class GetQualificationScoreHeaders:
    ...
    x_amz_target: GetQualificationScoreXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetQualificationScoreRequest:
    headers: GetQualificationScoreHeaders = field(default=None)
    request: shared.GetQualificationScoreRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
