...
class ListReviewPolicyResultsForHitHeaders:
    x_amz_target: ListReviewPolicyResultsForHitxAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListReviewPolicyResultsForHitRequest:
    headers: ListReviewPolicyResultsForHitHeaders = field()
    query_params: ListReviewPolicyResultsForHitQueryParams = field()
    request: shared.ListReviewPolicyResultsForHitRequest = field(metadata={'request': { 'media_type': 'application/json' }})
