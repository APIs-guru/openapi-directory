...
class CreateHitTypeHeaders:
    x_amz_target: CreateHitTypeXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateHitTypeRequest:
    headers: CreateHitTypeHeaders = field()
    request: shared.CreateHitTypeRequest = field(metadata={'request': { 'media_type': 'application/json' }})
