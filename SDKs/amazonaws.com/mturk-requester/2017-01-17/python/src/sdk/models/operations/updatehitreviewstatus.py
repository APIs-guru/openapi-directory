...
class UpdateHitReviewStatusHeaders:
    x_amz_target: UpdateHitReviewStatusXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateHitReviewStatusRequest:
    headers: UpdateHitReviewStatusHeaders = field()
    request: shared.UpdateHitReviewStatusRequest = field(metadata={'request': { 'media_type': 'application/json' }})
