...
class ListHiTsForQualificationTypeHeaders:
    x_amz_target: ListHiTsForQualificationTypeXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListHiTsForQualificationTypeRequest:
    headers: ListHiTsForQualificationTypeHeaders = field()
    query_params: ListHiTsForQualificationTypeQueryParams = field()
    request: shared.ListHiTsForQualificationTypeRequest = field(metadata={'request': { 'media_type': 'application/json' }})
