...
class ListWorkerBlocksHeaders:
    x_amz_target: ListWorkerBlocksXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListWorkerBlocksRequest:
    headers: ListWorkerBlocksHeaders = field()
    query_params: ListWorkerBlocksQueryParams = field()
    request: shared.ListWorkerBlocksRequest = field(metadata={'request': { 'media_type': 'application/json' }})
