...
class Hit:
    ...
    assignment_duration_in_seconds: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('AssignmentDurationInSeconds') }})
    ...
    hit_group_id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('HITGroupId') }})
    ...
    hit_review_status: Optional[HitReviewStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('HITReviewStatus') }})
    hit_status: Optional[HitStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('HITStatus') }})
    ...
    number_of_assignments_available: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('NumberOfAssignmentsAvailable') }})
    number_of_assignments_completed: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('NumberOfAssignmentsCompleted') }})
    number_of_assignments_pending: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('NumberOfAssignmentsPending') }})
    ...
    reward: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Reward') }})
