...
class CreateAdditionalAssignmentsForHitHeaders:
    x_amz_target: CreateAdditionalAssignmentsForHitxAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateAdditionalAssignmentsForHitRequest:
    headers: CreateAdditionalAssignmentsForHitHeaders = field()
    request: shared.CreateAdditionalAssignmentsForHitRequest = field(metadata={'request': { 'media_type': 'application/json' }})
