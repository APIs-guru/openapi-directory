...
class CreateAdditionalAssignmentsForHitHeaders:
    ...
    x_amz_target: CreateAdditionalAssignmentsForHitxAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateAdditionalAssignmentsForHitRequest:
    headers: CreateAdditionalAssignmentsForHitHeaders = field(default=None)
    request: shared.CreateAdditionalAssignmentsForHitRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class CreateAdditionalAssignmentsForHitResponse:
    content_type: str = field(default=None)
    create_additional_assignments_for_hit_response: Optional[dict[str, Any]] = field(default=None)
