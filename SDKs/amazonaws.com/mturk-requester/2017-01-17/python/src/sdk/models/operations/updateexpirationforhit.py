...
class UpdateExpirationForHitHeaders:
    ...
    x_amz_target: UpdateExpirationForHitxAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateExpirationForHitRequest:
    headers: UpdateExpirationForHitHeaders = field(default=None)
    request: shared.UpdateExpirationForHitRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
