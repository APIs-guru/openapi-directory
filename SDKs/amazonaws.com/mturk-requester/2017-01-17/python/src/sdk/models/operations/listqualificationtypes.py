...
class ListQualificationTypesHeaders:
    x_amz_target: ListQualificationTypesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListQualificationTypesRequest:
    headers: ListQualificationTypesHeaders = field()
    query_params: ListQualificationTypesQueryParams = field()
    request: shared.ListQualificationTypesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
