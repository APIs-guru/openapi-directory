...
class DeleteWorkerBlockHeaders:
    x_amz_target: DeleteWorkerBlockXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteWorkerBlockRequest:
    headers: DeleteWorkerBlockHeaders = field()
    request: shared.DeleteWorkerBlockRequest = field(metadata={'request': { 'media_type': 'application/json' }})
