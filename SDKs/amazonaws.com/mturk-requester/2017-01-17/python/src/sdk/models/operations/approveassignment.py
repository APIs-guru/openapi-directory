...
class ApproveAssignmentHeaders:
    x_amz_target: ApproveAssignmentXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ApproveAssignmentRequest:
    headers: ApproveAssignmentHeaders = field()
    request: shared.ApproveAssignmentRequest = field(metadata={'request': { 'media_type': 'application/json' }})
