...
class GetAssignmentHeaders:
    ...
    x_amz_target: GetAssignmentXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetAssignmentRequest:
    headers: GetAssignmentHeaders = field(default=None)
    request: shared.GetAssignmentRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
