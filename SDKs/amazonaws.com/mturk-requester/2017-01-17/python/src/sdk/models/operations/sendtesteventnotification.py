...
class SendTestEventNotificationHeaders:
    ...
    x_amz_target: SendTestEventNotificationXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class SendTestEventNotificationRequest:
    headers: SendTestEventNotificationHeaders = field(default=None)
    request: shared.SendTestEventNotificationRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
