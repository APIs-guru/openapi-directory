...
class CreateQualificationTypeRequest:
    ...
    qualification_type_status: qualificationtypestatus_enum.QualificationTypeStatusEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'QualificationTypeStatus' }})
