...
class CreateWorkerBlockHeaders:
    x_amz_target: CreateWorkerBlockXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateWorkerBlockRequest:
    headers: CreateWorkerBlockHeaders = field()
    request: shared.CreateWorkerBlockRequest = field(metadata={'request': { 'media_type': 'application/json' }})
