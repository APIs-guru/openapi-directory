...
class CreateWorkerBlockHeaders:
    ...
    x_amz_target: CreateWorkerBlockXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
    

@dataclass
class CreateWorkerBlockRequest:
    headers: CreateWorkerBlockHeaders = field(default=None)
    request: shared.CreateWorkerBlockRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class CreateWorkerBlockResponse:
    content_type: str = field(default=None)
    create_worker_block_response: Optional[dict[str, Any]] = field(default=None)
