...
class ListBonusPaymentsHeaders:
    ...
    x_amz_target: ListBonusPaymentsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ListBonusPaymentsRequest:
    query_params: ListBonusPaymentsQueryParams = field(default=None)
    headers: ListBonusPaymentsHeaders = field(default=None)
    request: shared.ListBonusPaymentsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
