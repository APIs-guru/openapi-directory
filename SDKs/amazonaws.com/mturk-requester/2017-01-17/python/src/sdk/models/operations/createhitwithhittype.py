...
class CreateHitWithHitTypeHeaders:
    x_amz_target: CreateHitWithHitTypeXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateHitWithHitTypeRequest:
    headers: CreateHitWithHitTypeHeaders = field()
    request: shared.CreateHitWithHitTypeRequest = field(metadata={'request': { 'media_type': 'application/json' }})
