...
class ListHiTsHeaders:
    x_amz_target: ListHiTsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListHiTsRequest:
    headers: ListHiTsHeaders = field()
    query_params: ListHiTsQueryParams = field()
    request: shared.ListHiTsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
