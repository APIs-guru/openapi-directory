...
class UpdateHitTypeOfHitHeaders:
    x_amz_target: UpdateHitTypeOfHitxAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateHitTypeOfHitRequest:
    headers: UpdateHitTypeOfHitHeaders = field()
    request: shared.UpdateHitTypeOfHitRequest = field(metadata={'request': { 'media_type': 'application/json' }})
