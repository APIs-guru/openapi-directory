...
class CreateQualificationTypeHeaders:
    x_amz_target: CreateQualificationTypeXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateQualificationTypeRequest:
    headers: CreateQualificationTypeHeaders = field()
    request: shared.CreateQualificationTypeRequest = field(metadata={'request': { 'media_type': 'application/json' }})
