...
**/
var CreateEmailTemplateRequestBodyTemplateContent = /** @class */ (function (_super) {
    __extends(CreateEmailTemplateRequestBodyTemplateContent, _super);
    function CreateEmailTemplateRequestBodyTemplateContent() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Html" }),
        __metadata("design:type", String)
    ], CreateEmailTemplateRequestBodyTemplateContent.prototype, "html", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Subject" }),
        __metadata("design:type", String)
    ], CreateEmailTemplateRequestBodyTemplateContent.prototype, "subject", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Text" }),
        __metadata("design:type", String)
    ], CreateEmailTemplateRequestBodyTemplateContent.prototype, "text", void 0);
    return CreateEmailTemplateRequestBodyTemplateContent;
}(SpeakeasyBase));
export { CreateEmailTemplateRequestBodyTemplateContent };
var CreateEmailTemplateRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", CreateEmailTemplateRequestBodyTemplateContent)
    ], CreateEmailTemplateRequestBody.prototype, "templateContent", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=TemplateName" }),
        __metadata("design:type", String)
    ], CreateEmailTemplateRequestBody.prototype, "templateName", void 0);
...
var CreateEmailTemplateResponse = /** @class */ (function (_super) {
    ...
    ], CreateEmailTemplateResponse.prototype, "alreadyExistsException", void 0);
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", Object)
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", Object)
    ], CreateEmailTemplateResponse.prototype, "limitExceededException", void 0);
    __decorate([
        SpeakeasyMetadata(),
