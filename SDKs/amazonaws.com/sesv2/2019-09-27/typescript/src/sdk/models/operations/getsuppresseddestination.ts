...
export class GetSuppressedDestinationPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=EmailAddress" })
  emailAddress: string;
}


export class GetSuppressedDestinationHeaders extends SpeakeasyBase {
...
export class GetSuppressedDestinationRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
