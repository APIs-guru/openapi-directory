...
class SDK:
    ...
    def create_contact_list(self, request: operations.CreateContactListRequest) -> operations.CreateContactListResponse:
        ...
        res = operations.CreateContactListResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
                res.create_contact_list_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.bad_request_exception = out
    ...
    def create_custom_verification_email_template(self, request: operations.CreateCustomVerificationEmailTemplateRequest) -> operations.CreateCustomVerificationEmailTemplateResponse:
        ...
        res = operations.CreateCustomVerificationEmailTemplateResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
                res.create_custom_verification_email_template_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.bad_request_exception = out
    ...
    def create_email_identity_policy(self, request: operations.CreateEmailIdentityPolicyRequest) -> operations.CreateEmailIdentityPolicyResponse:
        ...
        res = operations.CreateEmailIdentityPolicyResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
                res.create_email_identity_policy_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.not_found_exception = out
    ...
    def delete_contact_list(self, request: operations.DeleteContactListRequest) -> operations.DeleteContactListResponse:
        ...
        res = operations.DeleteContactListResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
                res.delete_contact_list_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.too_many_requests_exception = out
    ...
    def delete_custom_verification_email_template(self, request: operations.DeleteCustomVerificationEmailTemplateRequest) -> operations.DeleteCustomVerificationEmailTemplateResponse:
        ...
        res = operations.DeleteCustomVerificationEmailTemplateResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
                res.delete_custom_verification_email_template_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.not_found_exception = out
    ...
    def delete_email_identity_policy(self, request: operations.DeleteEmailIdentityPolicyRequest) -> operations.DeleteEmailIdentityPolicyResponse:
        ...
        res = operations.DeleteEmailIdentityPolicyResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
                res.delete_email_identity_policy_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.not_found_exception = out
    ...
    def delete_suppressed_destination(self, request: operations.DeleteSuppressedDestinationRequest) -> operations.DeleteSuppressedDestinationResponse:
        ...
        res = operations.DeleteSuppressedDestinationResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
                res.delete_suppressed_destination_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.not_found_exception = out
    ...
    def get_contact_list(self, request: operations.GetContactListRequest) -> operations.GetContactListResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetContactListResponse])
                res.get_contact_list_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.too_many_requests_exception = out
    ...
    def get_custom_verification_email_template(self, request: operations.GetCustomVerificationEmailTemplateRequest) -> operations.GetCustomVerificationEmailTemplateResponse:
        ...
        res = operations.GetCustomVerificationEmailTemplateResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetCustomVerificationEmailTemplateResponse])
                res.get_custom_verification_email_template_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.not_found_exception = out
    ...
    def get_email_identity_policies(self, request: operations.GetEmailIdentityPoliciesRequest) -> operations.GetEmailIdentityPoliciesResponse:
        ...
        res = operations.GetEmailIdentityPoliciesResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetEmailIdentityPoliciesResponse])
                res.get_email_identity_policies_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.not_found_exception = out
    ...
    def get_suppressed_destination(self, request: operations.GetSuppressedDestinationRequest) -> operations.GetSuppressedDestinationResponse:
        ...
        res = operations.GetSuppressedDestinationResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetSuppressedDestinationResponse])
                res.get_suppressed_destination_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.bad_request_exception = out
    ...
    def list_contact_lists(self, request: operations.ListContactListsRequest) -> operations.ListContactListsResponse:
        ...
        res = operations.ListContactListsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListContactListsResponse])
                res.list_contact_lists_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.bad_request_exception = out
    ...
    def list_custom_verification_email_templates(self, request: operations.ListCustomVerificationEmailTemplatesRequest) -> operations.ListCustomVerificationEmailTemplatesResponse:
        ...
        res = operations.ListCustomVerificationEmailTemplatesResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListCustomVerificationEmailTemplatesResponse])
                res.list_custom_verification_email_templates_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.too_many_requests_exception = out
    ...
    def list_email_templates(self, request: operations.ListEmailTemplatesRequest) -> operations.ListEmailTemplatesResponse:
        ...
        res = operations.ListEmailTemplatesResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListEmailTemplatesResponse])
                res.list_email_templates_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.too_many_requests_exception = out
    ...
    def list_import_jobs(self, request: operations.ListImportJobsRequest) -> operations.ListImportJobsResponse:
        ...
        res = operations.ListImportJobsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
    ...
    def list_suppressed_destinations(self, request: operations.ListSuppressedDestinationsRequest) -> operations.ListSuppressedDestinationsResponse:
        ...
        res = operations.ListSuppressedDestinationsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListSuppressedDestinationsResponse])
                res.list_suppressed_destinations_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.bad_request_exception = out
    ...
    def put_account_details(self, request: operations.PutAccountDetailsRequest) -> operations.PutAccountDetailsResponse:
        ...
        res = operations.PutAccountDetailsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
                res.put_account_details_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.too_many_requests_exception = out
    ...
    def put_account_suppression_attributes(self, request: operations.PutAccountSuppressionAttributesRequest) -> operations.PutAccountSuppressionAttributesResponse:
        ...
        res = operations.PutAccountSuppressionAttributesResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
                res.put_account_suppression_attributes_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.too_many_requests_exception = out
    ...
    def put_configuration_set_suppression_options(self, request: operations.PutConfigurationSetSuppressionOptionsRequest) -> operations.PutConfigurationSetSuppressionOptionsResponse:
        ...
        res = operations.PutConfigurationSetSuppressionOptionsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
                res.put_configuration_set_suppression_options_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.not_found_exception = out
    ...
    def put_email_identity_configuration_set_attributes(self, request: operations.PutEmailIdentityConfigurationSetAttributesRequest) -> operations.PutEmailIdentityConfigurationSetAttributesResponse:
        ...
        res = operations.PutEmailIdentityConfigurationSetAttributesResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
                res.put_email_identity_configuration_set_attributes_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.not_found_exception = out
    ...
    def put_email_identity_dkim_signing_attributes(self, request: operations.PutEmailIdentityDkimSigningAttributesRequest) -> operations.PutEmailIdentityDkimSigningAttributesResponse:
        ...
        res = operations.PutEmailIdentityDkimSigningAttributesResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PutEmailIdentityDkimSigningAttributesResponse])
                res.put_email_identity_dkim_signing_attributes_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.not_found_exception = out
    ...
    def put_suppressed_destination(self, request: operations.PutSuppressedDestinationRequest) -> operations.PutSuppressedDestinationResponse:
        ...
        res = operations.PutSuppressedDestinationResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
                res.put_suppressed_destination_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.bad_request_exception = out
    ...
    def send_bulk_email(self, request: operations.SendBulkEmailRequest) -> operations.SendBulkEmailResponse:
        ...
        res = operations.SendBulkEmailResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SendBulkEmailResponse])
                res.send_bulk_email_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.too_many_requests_exception = out
    ...
    def send_custom_verification_email(self, request: operations.SendCustomVerificationEmailRequest) -> operations.SendCustomVerificationEmailResponse:
        ...
        res = operations.SendCustomVerificationEmailResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SendCustomVerificationEmailResponse])
                res.send_custom_verification_email_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.too_many_requests_exception = out
    ...
    def test_render_email_template(self, request: operations.TestRenderEmailTemplateRequest) -> operations.TestRenderEmailTemplateResponse:
        ...
        res = operations.TestRenderEmailTemplateResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.TestRenderEmailTemplateResponse])
                res.test_render_email_template_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.not_found_exception = out
    ...
    def update_contact_list(self, request: operations.UpdateContactListRequest) -> operations.UpdateContactListResponse:
        ...
        res = operations.UpdateContactListResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
                res.update_contact_list_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.bad_request_exception = out
    ...
    def update_custom_verification_email_template(self, request: operations.UpdateCustomVerificationEmailTemplateRequest) -> operations.UpdateCustomVerificationEmailTemplateResponse:
        ...
        res = operations.UpdateCustomVerificationEmailTemplateResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
                res.update_custom_verification_email_template_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.not_found_exception = out
    ...
    def update_email_identity_policy(self, request: operations.UpdateEmailIdentityPolicyRequest) -> operations.UpdateEmailIdentityPolicyResponse:
        ...
        res = operations.UpdateEmailIdentityPolicyResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
                res.update_email_identity_policy_response = out
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.not_found_exception = out
