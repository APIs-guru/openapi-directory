...
class CreateEmailIdentityRequestBody:
    ...
    dkim_signing_attributes: Optional[CreateEmailIdentityRequestBodyDkimSigningAttributes] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'DkimSigningAttributes' }})
