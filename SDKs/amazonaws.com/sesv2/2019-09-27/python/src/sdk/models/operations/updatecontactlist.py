...
class UpdateContactListRequest:
    headers: UpdateContactListHeaders = field()
    path_params: UpdateContactListPathParams = field()
    request: UpdateContactListRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
