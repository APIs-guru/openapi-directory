...
class CreateCustomVerificationEmailTemplateRequest:
    headers: CreateCustomVerificationEmailTemplateHeaders = field()
    request: CreateCustomVerificationEmailTemplateRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
