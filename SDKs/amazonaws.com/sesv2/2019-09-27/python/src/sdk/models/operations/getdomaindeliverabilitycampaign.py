...
class GetDomainDeliverabilityCampaignRequest:
    path_params: GetDomainDeliverabilityCampaignPathParams = field(default=None)
    headers: GetDomainDeliverabilityCampaignHeaders = field(default=None)
...
class GetDomainDeliverabilityCampaignResponse:
    ...
    get_domain_deliverability_campaign_response: Optional[shared.GetDomainDeliverabilityCampaignResponse] = field(default=None)
