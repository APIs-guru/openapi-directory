...
class GetDeleteTemplateQueryParams:
    action: GetDeleteTemplateActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    template_name: str = field(metadata={'query_param': { 'field_name': 'TemplateName', 'style': 'form', 'explode': True }})
    version: GetDeleteTemplateVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteTemplateRequest:
    headers: GetDeleteTemplateHeaders = field()
    query_params: GetDeleteTemplateQueryParams = field()
