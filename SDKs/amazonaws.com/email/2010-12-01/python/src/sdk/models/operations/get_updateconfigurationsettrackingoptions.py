...
class GetUpdateConfigurationSetTrackingOptionsQueryParams:
    action: GetUpdateConfigurationSetTrackingOptionsActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    configuration_set_name: str = field(metadata={'query_param': { 'field_name': 'ConfigurationSetName', 'style': 'form', 'explode': True }})
    tracking_options: GetUpdateConfigurationSetTrackingOptionsTrackingOptions = field(metadata={'query_param': { 'field_name': 'TrackingOptions', 'style': 'form', 'explode': True }})
    version: GetUpdateConfigurationSetTrackingOptionsVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetUpdateConfigurationSetTrackingOptionsRequest:
    headers: GetUpdateConfigurationSetTrackingOptionsHeaders = field()
    query_params: GetUpdateConfigurationSetTrackingOptionsQueryParams = field()
