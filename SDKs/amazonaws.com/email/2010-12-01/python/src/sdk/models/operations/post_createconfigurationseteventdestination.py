...
class PostCreateConfigurationSetEventDestinationQueryParams:
    action: PostCreateConfigurationSetEventDestinationActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostCreateConfigurationSetEventDestinationVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostCreateConfigurationSetEventDestinationRequest:
    headers: PostCreateConfigurationSetEventDestinationHeaders = field()
    query_params: PostCreateConfigurationSetEventDestinationQueryParams = field()
