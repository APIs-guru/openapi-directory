...
class PostCreateConfigurationSetTrackingOptionsQueryParams:
    action: PostCreateConfigurationSetTrackingOptionsActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostCreateConfigurationSetTrackingOptionsVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostCreateConfigurationSetTrackingOptionsRequest:
    headers: PostCreateConfigurationSetTrackingOptionsHeaders = field()
    query_params: PostCreateConfigurationSetTrackingOptionsQueryParams = field()
