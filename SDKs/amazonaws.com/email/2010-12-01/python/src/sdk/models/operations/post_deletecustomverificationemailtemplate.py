...
class PostDeleteCustomVerificationEmailTemplateQueryParams:
    action: PostDeleteCustomVerificationEmailTemplateActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDeleteCustomVerificationEmailTemplateVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDeleteCustomVerificationEmailTemplateRequest:
    headers: PostDeleteCustomVerificationEmailTemplateHeaders = field()
    query_params: PostDeleteCustomVerificationEmailTemplateQueryParams = field()
