...
class GetDeleteConfigurationSetQueryParams:
    action: GetDeleteConfigurationSetActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    configuration_set_name: str = field(metadata={'query_param': { 'field_name': 'ConfigurationSetName', 'style': 'form', 'explode': True }})
    version: GetDeleteConfigurationSetVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteConfigurationSetRequest:
    headers: GetDeleteConfigurationSetHeaders = field()
    query_params: GetDeleteConfigurationSetQueryParams = field()
