...
class PostUpdateConfigurationSetTrackingOptionsQueryParams:
    action: PostUpdateConfigurationSetTrackingOptionsActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostUpdateConfigurationSetTrackingOptionsVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostUpdateConfigurationSetTrackingOptionsRequest:
    headers: PostUpdateConfigurationSetTrackingOptionsHeaders = field()
    query_params: PostUpdateConfigurationSetTrackingOptionsQueryParams = field()
