...
class GetListCustomVerificationEmailTemplatesQueryParams:
    action: GetListCustomVerificationEmailTemplatesActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetListCustomVerificationEmailTemplatesVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetListCustomVerificationEmailTemplatesRequest:
    headers: GetListCustomVerificationEmailTemplatesHeaders = field()
    query_params: GetListCustomVerificationEmailTemplatesQueryParams = field()
