...
})(GetGetIdentityDkimAttributesActionEnum || (GetGetIdentityDkimAttributesActionEnum = {}));
export var GetGetIdentityDkimAttributesVersionEnum;
(function (GetGetIdentityDkimAttributesVersionEnum) {
    GetGetIdentityDkimAttributesVersionEnum["TwoThousandAndTen1201"] = "2010-12-01";
})(GetGetIdentityDkimAttributesVersionEnum || (GetGetIdentityDkimAttributesVersionEnum = {}));
var GetGetIdentityDkimAttributesQueryParams = /** @class */ (function (_super) {
    __extends(GetGetIdentityDkimAttributesQueryParams, _super);
    function GetGetIdentityDkimAttributesQueryParams() {
...
export { GetGetIdentityDkimAttributesQueryParams };
var GetGetIdentityDkimAttributesHeaders = /** @class */ (function (_super) {
    __extends(GetGetIdentityDkimAttributesHeaders, _super);
    function GetGetIdentityDkimAttributesHeaders() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
...
export { GetGetIdentityDkimAttributesHeaders };
...
export { GetGetIdentityDkimAttributesRequest };
...
export { GetGetIdentityDkimAttributesResponse };
