...
class GetCorsPolicyHeaders:
    x_amz_target: GetCorsPolicyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetCorsPolicyRequest:
    headers: GetCorsPolicyHeaders = field()
    request: shared.GetCorsPolicyInput = field(metadata={'request': { 'media_type': 'application/json' }})
