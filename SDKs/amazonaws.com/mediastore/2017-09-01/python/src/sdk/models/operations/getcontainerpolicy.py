...
class GetContainerPolicyHeaders:
    x_amz_target: GetContainerPolicyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetContainerPolicyRequest:
    headers: GetContainerPolicyHeaders = field()
    request: shared.GetContainerPolicyInput = field(metadata={'request': { 'media_type': 'application/json' }})
