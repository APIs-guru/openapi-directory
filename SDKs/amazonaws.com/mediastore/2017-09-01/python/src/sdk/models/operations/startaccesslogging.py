...
class StartAccessLoggingHeaders:
    x_amz_target: StartAccessLoggingXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartAccessLoggingRequest:
    headers: StartAccessLoggingHeaders = field()
    request: shared.StartAccessLoggingInput = field(metadata={'request': { 'media_type': 'application/json' }})
