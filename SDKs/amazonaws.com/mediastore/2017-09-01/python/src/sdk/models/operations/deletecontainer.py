...
class DeleteContainerHeaders:
    x_amz_target: DeleteContainerXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteContainerRequest:
    headers: DeleteContainerHeaders = field()
    request: shared.DeleteContainerInput = field(metadata={'request': { 'media_type': 'application/json' }})
