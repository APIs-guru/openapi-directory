...
class DeleteCorsPolicyHeaders:
    x_amz_target: DeleteCorsPolicyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteCorsPolicyRequest:
    headers: DeleteCorsPolicyHeaders = field()
    request: shared.DeleteCorsPolicyInput = field(metadata={'request': { 'media_type': 'application/json' }})
