...
class CreateContainerHeaders:
    x_amz_target: CreateContainerXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateContainerRequest:
    headers: CreateContainerHeaders = field()
    request: shared.CreateContainerInput = field(metadata={'request': { 'media_type': 'application/json' }})
