...
class PutMetricPolicyHeaders:
    x_amz_target: PutMetricPolicyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutMetricPolicyRequest:
    headers: PutMetricPolicyHeaders = field()
    request: shared.PutMetricPolicyInput = field(metadata={'request': { 'media_type': 'application/json' }})
