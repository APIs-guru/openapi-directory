...
class GetLifecyclePolicyHeaders:
    ...
    x_amz_target: GetLifecyclePolicyXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetLifecyclePolicyRequest:
    headers: GetLifecyclePolicyHeaders = field(default=None)
    request: shared.GetLifecyclePolicyInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class GetLifecyclePolicyResponse:
    ...
    get_lifecycle_policy_output: Optional[shared.GetLifecyclePolicyOutput] = field(default=None)
