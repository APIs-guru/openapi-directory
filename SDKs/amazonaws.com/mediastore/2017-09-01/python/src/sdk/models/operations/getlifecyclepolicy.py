...
class GetLifecyclePolicyHeaders:
    x_amz_target: GetLifecyclePolicyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetLifecyclePolicyRequest:
    ...
    request: shared.GetLifecyclePolicyInput = field(metadata={'request': { 'media_type': 'application/json' }})
