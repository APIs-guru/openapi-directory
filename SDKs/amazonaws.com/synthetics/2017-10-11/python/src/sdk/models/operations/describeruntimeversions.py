...
class DescribeRuntimeVersionsRequest:
    headers: DescribeRuntimeVersionsHeaders = field()
    query_params: DescribeRuntimeVersionsQueryParams = field()
    request: DescribeRuntimeVersionsRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
