...
class ResetDeploymentsRequest:
    headers: ResetDeploymentsHeaders = field()
    path_params: ResetDeploymentsPathParams = field()
    request: ResetDeploymentsRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
