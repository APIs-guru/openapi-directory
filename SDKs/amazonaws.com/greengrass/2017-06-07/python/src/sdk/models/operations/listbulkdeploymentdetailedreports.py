...
class ListBulkDeploymentDetailedReportsRequest:
    headers: ListBulkDeploymentDetailedReportsHeaders = field()
    path_params: ListBulkDeploymentDetailedReportsPathParams = field()
    query_params: ListBulkDeploymentDetailedReportsQueryParams = field()
