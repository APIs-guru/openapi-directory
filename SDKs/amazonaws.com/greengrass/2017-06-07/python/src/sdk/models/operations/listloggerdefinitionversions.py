...
class ListLoggerDefinitionVersionsRequest:
    headers: ListLoggerDefinitionVersionsHeaders = field()
    path_params: ListLoggerDefinitionVersionsPathParams = field()
    query_params: ListLoggerDefinitionVersionsQueryParams = field()
