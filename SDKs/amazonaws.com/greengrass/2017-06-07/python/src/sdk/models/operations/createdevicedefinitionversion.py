...
class CreateDeviceDefinitionVersionRequest:
    headers: CreateDeviceDefinitionVersionHeaders = field()
    path_params: CreateDeviceDefinitionVersionPathParams = field()
    request: CreateDeviceDefinitionVersionRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
