...
class UpdateSubscriptionDefinitionRequest:
    path_params: UpdateSubscriptionDefinitionPathParams = field(default=None)
    headers: UpdateSubscriptionDefinitionHeaders = field(default=None)
    request: UpdateSubscriptionDefinitionRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
