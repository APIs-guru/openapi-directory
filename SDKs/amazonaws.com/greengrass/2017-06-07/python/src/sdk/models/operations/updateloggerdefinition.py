...
class UpdateLoggerDefinitionRequest:
    headers: UpdateLoggerDefinitionHeaders = field()
    path_params: UpdateLoggerDefinitionPathParams = field()
    request: UpdateLoggerDefinitionRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
