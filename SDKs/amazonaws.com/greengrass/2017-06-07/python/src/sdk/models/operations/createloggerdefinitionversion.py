...
class CreateLoggerDefinitionVersionRequest:
    headers: CreateLoggerDefinitionVersionHeaders = field()
    path_params: CreateLoggerDefinitionVersionPathParams = field()
    request: CreateLoggerDefinitionVersionRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
