...
var CreateLoggerDefinitionVersionResponse = /** @class */ (function (_super) {
    ...
    ], CreateLoggerDefinitionVersionResponse.prototype, "arn", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=CreationTimestamp" }),
        __metadata("design:type", String)
    ], CreateLoggerDefinitionVersionResponse.prototype, "creationTimestamp", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Id" }),
        __metadata("design:type", String)
    ], CreateLoggerDefinitionVersionResponse.prototype, "id", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Version" }),
        __metadata("design:type", String)
    ], CreateLoggerDefinitionVersionResponse.prototype, "version", void 0);
