...
var CreateDeploymentPathParams = /** @class */ (function (_super) {
    ...
    ], CreateDeploymentPathParams.prototype, "groupId", void 0);
...
var CreateDeploymentHeaders = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], CreateDeploymentHeaders.prototype, "xAmznClientToken", void 0);
    return CreateDeploymentHeaders;
}(SpeakeasyBase));
export { CreateDeploymentHeaders };
export var CreateDeploymentRequestBodyDeploymentTypeEnum;
(function (CreateDeploymentRequestBodyDeploymentTypeEnum) {
    CreateDeploymentRequestBodyDeploymentTypeEnum["NewDeployment"] = "NewDeployment";
    CreateDeploymentRequestBodyDeploymentTypeEnum["Redeployment"] = "Redeployment";
    CreateDeploymentRequestBodyDeploymentTypeEnum["ResetDeployment"] = "ResetDeployment";
    CreateDeploymentRequestBodyDeploymentTypeEnum["ForceResetDeployment"] = "ForceResetDeployment";
})(CreateDeploymentRequestBodyDeploymentTypeEnum || (CreateDeploymentRequestBodyDeploymentTypeEnum = {}));
var CreateDeploymentRequestBody = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], CreateDeploymentRequestBody.prototype, "deploymentId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=DeploymentType" }),
        __metadata("design:type", String)
    ], CreateDeploymentRequestBody.prototype, "deploymentType", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=GroupVersionId" }),
        __metadata("design:type", String)
    ], CreateDeploymentRequestBody.prototype, "groupVersionId", void 0);
