...
var GetResourceDefinitionVersionPathParams = /** @class */ (function (_super) {
    ...
    function GetResourceDefinitionVersionPathParams() {
...
export { GetResourceDefinitionVersionPathParams };
var GetResourceDefinitionVersionHeaders = /** @class */ (function (_super) {
    __extends(GetResourceDefinitionVersionHeaders, _super);
    function GetResourceDefinitionVersionHeaders() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
...
export { GetResourceDefinitionVersionHeaders };
var GetResourceDefinitionVersionRequest = /** @class */ (function (_super) {
    __extends(GetResourceDefinitionVersionRequest, _super);
...
export { GetResourceDefinitionVersionRequest };
...
export { GetResourceDefinitionVersionResponse };
