...
export class ListDeviceDefinitionsQueryParams extends SpeakeasyBase {
...
export class ListDeviceDefinitionsHeaders extends SpeakeasyBase {
...
export class ListDeviceDefinitionsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
