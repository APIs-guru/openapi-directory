...
export class ListSubscriptionDefinitionVersionsPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=SubscriptionDefinitionId" })
  subscriptionDefinitionId: string;
}


export class ListSubscriptionDefinitionVersionsQueryParams extends SpeakeasyBase {
...
export class ListSubscriptionDefinitionVersionsHeaders extends SpeakeasyBase {
