...
export class ListResourceDefinitionsQueryParams extends SpeakeasyBase {
...
export class ListResourceDefinitionsHeaders extends SpeakeasyBase {
...
export class ListResourceDefinitionsRequest extends SpeakeasyBase {
  @Metadata()
