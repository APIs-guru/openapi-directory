...
export class ListFunctionDefinitionsQueryParams extends SpeakeasyBase {
...
export class ListFunctionDefinitionsHeaders extends SpeakeasyBase {
...
export class ListFunctionDefinitionsRequest extends SpeakeasyBase {
  @Metadata()
