...
export class GetDeploymentStatusPathParams extends SpeakeasyBase {
...
export class GetDeploymentStatusHeaders extends SpeakeasyBase {
...
export class GetDeploymentStatusRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
