...
class StopTextTranslationJobHeaders:
    ...
    x_amz_target: StopTextTranslationJobXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class StopTextTranslationJobRequest:
    headers: StopTextTranslationJobHeaders = field(default=None)
    request: shared.StopTextTranslationJobRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
