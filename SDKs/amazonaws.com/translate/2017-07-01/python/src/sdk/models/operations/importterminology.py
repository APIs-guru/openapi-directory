...
class ImportTerminologyHeaders:
    x_amz_target: ImportTerminologyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ImportTerminologyRequest:
    headers: ImportTerminologyHeaders = field()
    request: shared.ImportTerminologyRequest = field(metadata={'request': { 'media_type': 'application/json' }})
