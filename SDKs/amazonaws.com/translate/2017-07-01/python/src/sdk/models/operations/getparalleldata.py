...
class GetParallelDataHeaders:
    x_amz_target: GetParallelDataXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetParallelDataRequest:
    headers: GetParallelDataHeaders = field()
    request: shared.GetParallelDataRequest = field(metadata={'request': { 'media_type': 'application/json' }})
