...
class DescribeTextTranslationJobHeaders:
    x_amz_target: DescribeTextTranslationJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeTextTranslationJobRequest:
    headers: DescribeTextTranslationJobHeaders = field()
    request: shared.DescribeTextTranslationJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
