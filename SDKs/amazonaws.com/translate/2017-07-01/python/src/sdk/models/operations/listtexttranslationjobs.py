...
class ListTextTranslationJobsHeaders:
    x_amz_target: ListTextTranslationJobsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListTextTranslationJobsRequest:
    headers: ListTextTranslationJobsHeaders = field()
    query_params: ListTextTranslationJobsQueryParams = field()
    request: shared.ListTextTranslationJobsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
