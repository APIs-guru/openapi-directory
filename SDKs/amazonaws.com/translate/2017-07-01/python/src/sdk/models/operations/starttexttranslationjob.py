...
class StartTextTranslationJobHeaders:
    x_amz_target: StartTextTranslationJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartTextTranslationJobRequest:
    headers: StartTextTranslationJobHeaders = field()
    request: shared.StartTextTranslationJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
