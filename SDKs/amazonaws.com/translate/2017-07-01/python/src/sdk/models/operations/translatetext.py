...
class TranslateTextHeaders:
    x_amz_target: TranslateTextXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class TranslateTextRequest:
    headers: TranslateTextHeaders = field()
    request: shared.TranslateTextRequest = field(metadata={'request': { 'media_type': 'application/json' }})
