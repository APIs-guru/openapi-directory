...
class ListAccessPreviewFindingsRequestBody:
    ...
    filter: Optional[dict[str, shared.Criterion]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('filter') }})
...
class ListAccessPreviewFindingsRequest:
    headers: ListAccessPreviewFindingsHeaders = field()
    path_params: ListAccessPreviewFindingsPathParams = field()
    query_params: ListAccessPreviewFindingsQueryParams = field()
    request: ListAccessPreviewFindingsRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
