...
class UpdateArchiveRuleRequest:
    headers: UpdateArchiveRuleHeaders = field()
    path_params: UpdateArchiveRulePathParams = field()
    request: UpdateArchiveRuleRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
