...
class CreateArchiveRuleRequestBody:
    filter: dict[str, shared.Criterion] = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('filter') }})
...
class CreateArchiveRuleRequest:
    headers: CreateArchiveRuleHeaders = field()
    path_params: CreateArchiveRulePathParams = field()
    request: CreateArchiveRuleRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
