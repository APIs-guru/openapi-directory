...
class CreateArchiveRuleRequest:
    path_params: CreateArchiveRulePathParams = field(default=None)
    headers: CreateArchiveRuleHeaders = field(default=None)
    request: CreateArchiveRuleRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
