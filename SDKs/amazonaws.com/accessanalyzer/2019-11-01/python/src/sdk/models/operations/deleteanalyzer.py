...
class DeleteAnalyzerRequest:
    path_params: DeleteAnalyzerPathParams = field(default=None)
    query_params: DeleteAnalyzerQueryParams = field(default=None)
    headers: DeleteAnalyzerHeaders = field(default=None)
