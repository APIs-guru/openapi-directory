...
export class GetFindingPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetFindingQueryParams extends SpeakeasyBase {
  @Metadata({ data: "queryParam, style=form;explode=true;name=analyzerArn" })
  analyzerArn: string;
}


export class GetFindingHeaders extends SpeakeasyBase {
