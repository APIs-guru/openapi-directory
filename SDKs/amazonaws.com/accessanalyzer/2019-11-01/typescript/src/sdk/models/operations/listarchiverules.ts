...
export class ListArchiveRulesPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=analyzerName" })
  analyzerName: string;
}


export class ListArchiveRulesQueryParams extends SpeakeasyBase {
...
export class ListArchiveRulesHeaders extends SpeakeasyBase {
