...
class GetPersonTrackingHeaders:
    x_amz_target: GetPersonTrackingXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetPersonTrackingRequest:
    headers: GetPersonTrackingHeaders = field()
    query_params: GetPersonTrackingQueryParams = field()
    request: shared.GetPersonTrackingRequest = field(metadata={'request': { 'media_type': 'application/json' }})
