...
class StartContentModerationHeaders:
    x_amz_target: StartContentModerationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartContentModerationRequest:
    headers: StartContentModerationHeaders = field()
    request: shared.StartContentModerationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
