...
class StartFaceDetectionHeaders:
    x_amz_target: StartFaceDetectionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartFaceDetectionRequest:
    headers: StartFaceDetectionHeaders = field()
    request: shared.StartFaceDetectionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
