...
class StartFaceDetectionHeaders:
    ...
    x_amz_target: StartFaceDetectionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class StartFaceDetectionRequest:
    headers: StartFaceDetectionHeaders = field(default=None)
    request: shared.StartFaceDetectionRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class StartFaceDetectionResponse:
    ...
    start_face_detection_response: Optional[shared.StartFaceDetectionResponse] = field(default=None)
