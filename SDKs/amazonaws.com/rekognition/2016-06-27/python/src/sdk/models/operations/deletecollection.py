...
class DeleteCollectionHeaders:
    x_amz_target: DeleteCollectionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteCollectionRequest:
    headers: DeleteCollectionHeaders = field()
    request: shared.DeleteCollectionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
