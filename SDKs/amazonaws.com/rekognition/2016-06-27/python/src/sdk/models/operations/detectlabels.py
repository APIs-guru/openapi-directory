...
class DetectLabelsHeaders:
    x_amz_target: DetectLabelsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DetectLabelsRequest:
    headers: DetectLabelsHeaders = field()
    request: shared.DetectLabelsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
