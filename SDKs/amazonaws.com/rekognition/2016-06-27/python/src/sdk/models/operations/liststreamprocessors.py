...
class ListStreamProcessorsHeaders:
    x_amz_target: ListStreamProcessorsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListStreamProcessorsRequest:
    headers: ListStreamProcessorsHeaders = field()
    query_params: ListStreamProcessorsQueryParams = field()
    request: shared.ListStreamProcessorsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
