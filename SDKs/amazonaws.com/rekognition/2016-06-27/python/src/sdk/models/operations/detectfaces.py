...
class DetectFacesHeaders:
    ...
    x_amz_target: DetectFacesXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DetectFacesRequest:
    headers: DetectFacesHeaders = field(default=None)
    request: shared.DetectFacesRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class DetectFacesResponse:
    ...
    detect_faces_response: Optional[shared.DetectFacesResponse] = field(default=None)
