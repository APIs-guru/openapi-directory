...
class DetectFacesHeaders:
    x_amz_target: DetectFacesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DetectFacesRequest:
    headers: DetectFacesHeaders = field()
    request: shared.DetectFacesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
