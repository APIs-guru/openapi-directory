...
class ListFacesHeaders:
    x_amz_target: ListFacesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListFacesRequest:
    headers: ListFacesHeaders = field()
    query_params: ListFacesQueryParams = field()
    request: shared.ListFacesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
