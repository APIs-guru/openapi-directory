...
class StartSegmentDetectionHeaders:
    x_amz_target: StartSegmentDetectionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartSegmentDetectionRequest:
    headers: StartSegmentDetectionHeaders = field()
    request: shared.StartSegmentDetectionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
