...
class SearchFacesByImageHeaders:
    ...
    x_amz_target: SearchFacesByImageXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class SearchFacesByImageRequest:
    headers: SearchFacesByImageHeaders = field(default=None)
    request: shared.SearchFacesByImageRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
