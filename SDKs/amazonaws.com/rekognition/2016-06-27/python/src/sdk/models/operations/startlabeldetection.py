...
class StartLabelDetectionHeaders:
    x_amz_target: StartLabelDetectionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartLabelDetectionRequest:
    headers: StartLabelDetectionHeaders = field()
    request: shared.StartLabelDetectionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
