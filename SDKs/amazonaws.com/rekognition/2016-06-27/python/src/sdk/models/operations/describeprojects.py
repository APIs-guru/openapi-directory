...
class DescribeProjectsHeaders:
    x_amz_target: DescribeProjectsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeProjectsRequest:
    headers: DescribeProjectsHeaders = field()
    query_params: DescribeProjectsQueryParams = field()
    request: shared.DescribeProjectsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
