...
class CreateProjectVersionHeaders:
    x_amz_target: CreateProjectVersionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateProjectVersionRequest:
    headers: CreateProjectVersionHeaders = field()
    request: shared.CreateProjectVersionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
