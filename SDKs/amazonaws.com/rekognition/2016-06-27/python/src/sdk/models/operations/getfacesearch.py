...
class GetFaceSearchHeaders:
    x_amz_target: GetFaceSearchXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetFaceSearchRequest:
    headers: GetFaceSearchHeaders = field()
    query_params: GetFaceSearchQueryParams = field()
    request: shared.GetFaceSearchRequest = field(metadata={'request': { 'media_type': 'application/json' }})
