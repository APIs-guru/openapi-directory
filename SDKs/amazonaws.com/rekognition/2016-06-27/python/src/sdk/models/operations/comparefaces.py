...
class CompareFacesHeaders:
    x_amz_target: CompareFacesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CompareFacesRequest:
    headers: CompareFacesHeaders = field()
    request: shared.CompareFacesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
