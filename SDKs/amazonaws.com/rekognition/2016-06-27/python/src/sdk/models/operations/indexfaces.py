...
class IndexFacesHeaders:
    x_amz_target: IndexFacesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class IndexFacesRequest:
    headers: IndexFacesHeaders = field()
    request: shared.IndexFacesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
