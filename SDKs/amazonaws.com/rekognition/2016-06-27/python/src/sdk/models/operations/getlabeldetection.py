...
class GetLabelDetectionHeaders:
    x_amz_target: GetLabelDetectionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetLabelDetectionRequest:
    headers: GetLabelDetectionHeaders = field()
    query_params: GetLabelDetectionQueryParams = field()
    request: shared.GetLabelDetectionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
