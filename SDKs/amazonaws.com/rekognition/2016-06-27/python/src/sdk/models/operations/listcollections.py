...
class ListCollectionsHeaders:
    x_amz_target: ListCollectionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListCollectionsRequest:
    headers: ListCollectionsHeaders = field()
    query_params: ListCollectionsQueryParams = field()
    request: shared.ListCollectionsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
