...
class StartTextDetectionHeaders:
    ...
    x_amz_target: StartTextDetectionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class StartTextDetectionRequest:
    headers: StartTextDetectionHeaders = field(default=None)
    request: shared.StartTextDetectionRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
