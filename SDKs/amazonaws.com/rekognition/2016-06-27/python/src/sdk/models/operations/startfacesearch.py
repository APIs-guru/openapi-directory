...
class StartFaceSearchHeaders:
    x_amz_target: StartFaceSearchXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartFaceSearchRequest:
    headers: StartFaceSearchHeaders = field()
    request: shared.StartFaceSearchRequest = field(metadata={'request': { 'media_type': 'application/json' }})
