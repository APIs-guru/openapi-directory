...
class StartFaceSearchHeaders:
    ...
    x_amz_target: StartFaceSearchXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class StartFaceSearchRequest:
    headers: StartFaceSearchHeaders = field(default=None)
    request: shared.StartFaceSearchRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class StartFaceSearchResponse:
    ...
    start_face_search_response: Optional[shared.StartFaceSearchResponse] = field(default=None)
