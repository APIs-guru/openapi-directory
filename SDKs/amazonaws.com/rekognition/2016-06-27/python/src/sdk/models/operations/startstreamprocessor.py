...
class StartStreamProcessorHeaders:
    x_amz_target: StartStreamProcessorXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartStreamProcessorRequest:
    headers: StartStreamProcessorHeaders = field()
    request: shared.StartStreamProcessorRequest = field(metadata={'request': { 'media_type': 'application/json' }})
