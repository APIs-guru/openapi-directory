...
class DetectProtectiveEquipmentHeaders:
    x_amz_target: DetectProtectiveEquipmentXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DetectProtectiveEquipmentRequest:
    headers: DetectProtectiveEquipmentHeaders = field()
    request: shared.DetectProtectiveEquipmentRequest = field(metadata={'request': { 'media_type': 'application/json' }})
