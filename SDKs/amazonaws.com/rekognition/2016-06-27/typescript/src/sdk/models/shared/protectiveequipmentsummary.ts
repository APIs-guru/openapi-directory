...
export class ProtectiveEquipmentSummary extends SpeakeasyBase {
  @Metadata({ data: "json, name=PersonsIndeterminate" })
  personsIndeterminate?: number[];

  @Metadata({ data: "json, name=PersonsWithRequiredEquipment" })
  personsWithRequiredEquipment?: number[];

  @Metadata({ data: "json, name=PersonsWithoutRequiredEquipment" })
