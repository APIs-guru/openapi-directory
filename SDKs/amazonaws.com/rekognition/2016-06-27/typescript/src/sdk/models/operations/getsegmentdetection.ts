...
export class GetSegmentDetectionQueryParams extends SpeakeasyBase {
...
export enum GetSegmentDetectionXAmzTargetEnum {
    RekognitionServiceGetSegmentDetection = "RekognitionService.GetSegmentDetection"
}


export class GetSegmentDetectionHeaders extends SpeakeasyBase {
