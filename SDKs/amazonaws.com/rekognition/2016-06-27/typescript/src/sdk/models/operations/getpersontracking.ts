...
export class GetPersonTrackingQueryParams extends SpeakeasyBase {
...
export enum GetPersonTrackingXAmzTargetEnum {
    RekognitionServiceGetPersonTracking = "RekognitionService.GetPersonTracking"
}


export class GetPersonTrackingHeaders extends SpeakeasyBase {
