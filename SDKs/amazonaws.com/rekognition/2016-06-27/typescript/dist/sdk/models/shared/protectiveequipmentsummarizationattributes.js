...
**/
var ProtectiveEquipmentSummarizationAttributes = /** @class */ (function (_super) {
    __extends(ProtectiveEquipmentSummarizationAttributes, _super);
    ...
    ], ProtectiveEquipmentSummarizationAttributes.prototype, "minConfidence", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=RequiredEquipmentTypes" }),
        __metadata("design:type", Array)
    ], ProtectiveEquipmentSummarizationAttributes.prototype, "requiredEquipmentTypes", void 0);
    return ProtectiveEquipmentSummarizationAttributes;
}(SpeakeasyBase));
export { ProtectiveEquipmentSummarizationAttributes };
