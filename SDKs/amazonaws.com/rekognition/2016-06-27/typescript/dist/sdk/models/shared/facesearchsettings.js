...
**/
var FaceSearchSettings = /** @class */ (function (_super) {
    __extends(FaceSearchSettings, _super);
    ...
    ], FaceSearchSettings.prototype, "collectionId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=FaceMatchThreshold" }),
        __metadata("design:type", Number)
    ], FaceSearchSettings.prototype, "faceMatchThreshold", void 0);
    return FaceSearchSettings;
}(SpeakeasyBase));
export { FaceSearchSettings };
