...
var GetFaceSearchResponse = /** @class */ (function (_super) {
    ...
    ], GetFaceSearchResponse.prototype, "jobStatus", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=NextToken" }),
        __metadata("design:type", String)
    ], GetFaceSearchResponse.prototype, "nextToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Persons", elemType: PersonMatch }),
        __metadata("design:type", Array)
    ], GetFaceSearchResponse.prototype, "persons", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=StatusMessage" }),
        __metadata("design:type", String)
    ], GetFaceSearchResponse.prototype, "statusMessage", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=VideoMetadata" }),
        __metadata("design:type", VideoMetadata)
    ], GetFaceSearchResponse.prototype, "videoMetadata", void 0);
