...
**/
var StartTechnicalCueDetectionFilter = /** @class */ (function (_super) {
    __extends(StartTechnicalCueDetectionFilter, _super);
    function StartTechnicalCueDetectionFilter() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=BlackFrame" }),
        __metadata("design:type", BlackFrame)
    ], StartTechnicalCueDetectionFilter.prototype, "blackFrame", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=MinSegmentConfidence" }),
        __metadata("design:type", Number)
    ], StartTechnicalCueDetectionFilter.prototype, "minSegmentConfidence", void 0);
    return StartTechnicalCueDetectionFilter;
}(SpeakeasyBase));
export { StartTechnicalCueDetectionFilter };
