...
var GetLabelDetectionResponse = /** @class */ (function (_super) {
    ...
    ], GetLabelDetectionResponse.prototype, "jobStatus", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=LabelModelVersion" }),
        __metadata("design:type", String)
    ], GetLabelDetectionResponse.prototype, "labelModelVersion", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Labels", elemType: LabelDetection }),
        __metadata("design:type", Array)
    ], GetLabelDetectionResponse.prototype, "labels", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=NextToken" }),
        __metadata("design:type", String)
    ], GetLabelDetectionResponse.prototype, "nextToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=StatusMessage" }),
        __metadata("design:type", String)
    ], GetLabelDetectionResponse.prototype, "statusMessage", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=VideoMetadata" }),
        __metadata("design:type", VideoMetadata)
    ], GetLabelDetectionResponse.prototype, "videoMetadata", void 0);
