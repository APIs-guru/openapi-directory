...
var StartFaceSearchRequest = /** @class */ (function (_super) {
    ...
    ], StartFaceSearchRequest.prototype, "clientRequestToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=CollectionId" }),
        __metadata("design:type", String)
    ], StartFaceSearchRequest.prototype, "collectionId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=FaceMatchThreshold" }),
        __metadata("design:type", Number)
    ], StartFaceSearchRequest.prototype, "faceMatchThreshold", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=JobTag" }),
        __metadata("design:type", String)
    ], StartFaceSearchRequest.prototype, "jobTag", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=NotificationChannel" }),
        __metadata("design:type", NotificationChannel)
    ], StartFaceSearchRequest.prototype, "notificationChannel", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Video" }),
        __metadata("design:type", Video)
    ], StartFaceSearchRequest.prototype, "video", void 0);
