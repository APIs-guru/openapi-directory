...
var DescribeCollectionResponse = /** @class */ (function (_super) {
    ...
    ], DescribeCollectionResponse.prototype, "collectionArn", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=CreationTimestamp" }),
        __metadata("design:type", Date)
    ], DescribeCollectionResponse.prototype, "creationTimestamp", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=FaceCount" }),
        __metadata("design:type", Number)
    ], DescribeCollectionResponse.prototype, "faceCount", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=FaceModelVersion" }),
        __metadata("design:type", String)
    ], DescribeCollectionResponse.prototype, "faceModelVersion", void 0);
