...
var GetCelebrityRecognitionResponse = /** @class */ (function (_super) {
    ...
    ], GetCelebrityRecognitionResponse.prototype, "celebrities", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=JobStatus" }),
        __metadata("design:type", String)
    ], GetCelebrityRecognitionResponse.prototype, "jobStatus", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=NextToken" }),
        __metadata("design:type", String)
    ], GetCelebrityRecognitionResponse.prototype, "nextToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=StatusMessage" }),
        __metadata("design:type", String)
    ], GetCelebrityRecognitionResponse.prototype, "statusMessage", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=VideoMetadata" }),
        __metadata("design:type", VideoMetadata)
    ], GetCelebrityRecognitionResponse.prototype, "videoMetadata", void 0);
