...
class GetSatellitePathParams:
    satellite_id: str = field(metadata={'path_param': { 'field_name': 'satelliteId', 'style': 'simple', 'explode': False }})
...
class GetSatelliteRequest:
    headers: GetSatelliteHeaders = field()
    path_params: GetSatellitePathParams = field()
