...
class PutLexiconRequest:
    path_params: PutLexiconPathParams = field(default=None)
    headers: PutLexiconHeaders = field(default=None)
    request: PutLexiconRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
