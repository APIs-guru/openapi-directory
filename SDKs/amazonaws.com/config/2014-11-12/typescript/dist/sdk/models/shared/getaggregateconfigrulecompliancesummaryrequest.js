...
var GetAggregateConfigRuleComplianceSummaryRequest = /** @class */ (function (_super) {
    ...
    ], GetAggregateConfigRuleComplianceSummaryRequest.prototype, "configurationAggregatorName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Filters" }),
        __metadata("design:type", ConfigRuleComplianceSummaryFilters)
    ], GetAggregateConfigRuleComplianceSummaryRequest.prototype, "filters", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=GroupByKey" }),
        __metadata("design:type", String)
    ], GetAggregateConfigRuleComplianceSummaryRequest.prototype, "groupByKey", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Limit" }),
        __metadata("design:type", Number)
    ], GetAggregateConfigRuleComplianceSummaryRequest.prototype, "limit", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=NextToken" }),
        __metadata("design:type", String)
    ], GetAggregateConfigRuleComplianceSummaryRequest.prototype, "nextToken", void 0);
