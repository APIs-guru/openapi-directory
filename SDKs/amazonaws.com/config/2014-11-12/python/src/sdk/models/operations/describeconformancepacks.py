...
class DescribeConformancePacksHeaders:
    x_amz_target: DescribeConformancePacksXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeConformancePacksRequest:
    headers: DescribeConformancePacksHeaders = field()
    query_params: DescribeConformancePacksQueryParams = field()
    request: shared.DescribeConformancePacksRequest = field(metadata={'request': { 'media_type': 'application/json' }})
