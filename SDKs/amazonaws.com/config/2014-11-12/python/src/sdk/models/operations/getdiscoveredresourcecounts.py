...
class GetDiscoveredResourceCountsHeaders:
    x_amz_target: GetDiscoveredResourceCountsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetDiscoveredResourceCountsRequest:
    headers: GetDiscoveredResourceCountsHeaders = field()
    query_params: GetDiscoveredResourceCountsQueryParams = field()
    request: shared.GetDiscoveredResourceCountsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
