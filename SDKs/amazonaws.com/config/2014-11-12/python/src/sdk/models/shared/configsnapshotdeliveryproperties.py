...
class ConfigSnapshotDeliveryProperties:
    r"""ConfigSnapshotDeliveryProperties
    ...
    delivery_frequency: Optional[MaximumExecutionFrequencyEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('deliveryFrequency') }})
