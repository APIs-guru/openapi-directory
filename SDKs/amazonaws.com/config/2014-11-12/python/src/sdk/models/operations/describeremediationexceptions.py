...
class DescribeRemediationExceptionsHeaders:
    x_amz_target: DescribeRemediationExceptionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeRemediationExceptionsRequest:
    headers: DescribeRemediationExceptionsHeaders = field()
    query_params: DescribeRemediationExceptionsQueryParams = field()
    request: shared.DescribeRemediationExceptionsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
