...
class SelectResourceConfigHeaders:
    x_amz_target: SelectResourceConfigXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class SelectResourceConfigRequest:
    headers: SelectResourceConfigHeaders = field()
    query_params: SelectResourceConfigQueryParams = field()
    request: shared.SelectResourceConfigRequest = field(metadata={'request': { 'media_type': 'application/json' }})
