...
class PutRetentionConfigurationHeaders:
    ...
    x_amz_target: PutRetentionConfigurationXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class PutRetentionConfigurationRequest:
    headers: PutRetentionConfigurationHeaders = field(default=None)
    request: shared.PutRetentionConfigurationRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
