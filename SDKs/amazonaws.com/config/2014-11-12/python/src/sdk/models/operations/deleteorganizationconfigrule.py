...
class DeleteOrganizationConfigRuleHeaders:
    ...
    x_amz_target: DeleteOrganizationConfigRuleXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeleteOrganizationConfigRuleRequest:
    headers: DeleteOrganizationConfigRuleHeaders = field(default=None)
    request: shared.DeleteOrganizationConfigRuleRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
