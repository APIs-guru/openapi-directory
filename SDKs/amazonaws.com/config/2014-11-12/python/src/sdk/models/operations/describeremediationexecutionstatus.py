...
class DescribeRemediationExecutionStatusHeaders:
    x_amz_target: DescribeRemediationExecutionStatusXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeRemediationExecutionStatusRequest:
    headers: DescribeRemediationExecutionStatusHeaders = field()
    query_params: DescribeRemediationExecutionStatusQueryParams = field()
    request: shared.DescribeRemediationExecutionStatusRequest = field(metadata={'request': { 'media_type': 'application/json' }})
