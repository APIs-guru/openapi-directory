...
class GetAggregateConformancePackComplianceSummaryHeaders:
    x_amz_target: GetAggregateConformancePackComplianceSummaryXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetAggregateConformancePackComplianceSummaryRequest:
    headers: GetAggregateConformancePackComplianceSummaryHeaders = field()
    query_params: GetAggregateConformancePackComplianceSummaryQueryParams = field()
    request: shared.GetAggregateConformancePackComplianceSummaryRequest = field(metadata={'request': { 'media_type': 'application/json' }})
