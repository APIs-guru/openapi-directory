...
class DescribePendingAggregationRequestsHeaders:
    x_amz_target: DescribePendingAggregationRequestsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribePendingAggregationRequestsRequest:
    headers: DescribePendingAggregationRequestsHeaders = field()
    query_params: DescribePendingAggregationRequestsQueryParams = field()
    request: shared.DescribePendingAggregationRequestsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
