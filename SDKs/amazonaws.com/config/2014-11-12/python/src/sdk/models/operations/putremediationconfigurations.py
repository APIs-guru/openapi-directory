...
class PutRemediationConfigurationsHeaders:
    x_amz_target: PutRemediationConfigurationsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutRemediationConfigurationsRequest:
    headers: PutRemediationConfigurationsHeaders = field()
    request: shared.PutRemediationConfigurationsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
