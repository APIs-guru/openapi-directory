...
class GetComplianceSummaryByResourceTypeHeaders:
    x_amz_target: GetComplianceSummaryByResourceTypeXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetComplianceSummaryByResourceTypeRequest:
    headers: GetComplianceSummaryByResourceTypeHeaders = field()
    request: shared.GetComplianceSummaryByResourceTypeRequest = field(metadata={'request': { 'media_type': 'application/json' }})
