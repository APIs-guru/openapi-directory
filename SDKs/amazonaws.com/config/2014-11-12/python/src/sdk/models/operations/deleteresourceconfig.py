...
class DeleteResourceConfigHeaders:
    x_amz_target: DeleteResourceConfigXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteResourceConfigRequest:
    headers: DeleteResourceConfigHeaders = field()
    request: shared.DeleteResourceConfigRequest = field(metadata={'request': { 'media_type': 'application/json' }})
