...
class DescribeAggregateComplianceByConformancePacksHeaders:
    x_amz_target: DescribeAggregateComplianceByConformancePacksXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeAggregateComplianceByConformancePacksRequest:
    headers: DescribeAggregateComplianceByConformancePacksHeaders = field()
    query_params: DescribeAggregateComplianceByConformancePacksQueryParams = field()
    request: shared.DescribeAggregateComplianceByConformancePacksRequest = field(metadata={'request': { 'media_type': 'application/json' }})
