...
class PutResourceConfigHeaders:
    x_amz_target: PutResourceConfigXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutResourceConfigRequest:
    headers: PutResourceConfigHeaders = field()
    request: shared.PutResourceConfigRequest = field(metadata={'request': { 'media_type': 'application/json' }})
