...
class DescribeOrganizationConfigRuleStatusesHeaders:
    ...
    x_amz_target: DescribeOrganizationConfigRuleStatusesXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
