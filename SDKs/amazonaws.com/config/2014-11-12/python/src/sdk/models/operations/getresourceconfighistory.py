...
class GetResourceConfigHistoryHeaders:
    x_amz_target: GetResourceConfigHistoryXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetResourceConfigHistoryRequest:
    headers: GetResourceConfigHistoryHeaders = field()
    query_params: GetResourceConfigHistoryQueryParams = field()
    request: shared.GetResourceConfigHistoryRequest = field(metadata={'request': { 'media_type': 'application/json' }})
