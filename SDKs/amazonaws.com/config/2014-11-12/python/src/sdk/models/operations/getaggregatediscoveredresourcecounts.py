...
class GetAggregateDiscoveredResourceCountsHeaders:
    x_amz_target: GetAggregateDiscoveredResourceCountsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetAggregateDiscoveredResourceCountsRequest:
    headers: GetAggregateDiscoveredResourceCountsHeaders = field()
    query_params: GetAggregateDiscoveredResourceCountsQueryParams = field()
    request: shared.GetAggregateDiscoveredResourceCountsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
