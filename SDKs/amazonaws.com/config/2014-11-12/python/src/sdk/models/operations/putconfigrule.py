...
class PutConfigRuleHeaders:
    x_amz_target: PutConfigRuleXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutConfigRuleRequest:
    headers: PutConfigRuleHeaders = field()
    request: shared.PutConfigRuleRequest = field(metadata={'request': { 'media_type': 'application/json' }})
