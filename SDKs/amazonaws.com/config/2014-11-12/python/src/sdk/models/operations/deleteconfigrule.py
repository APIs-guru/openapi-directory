...
class DeleteConfigRuleHeaders:
    x_amz_target: DeleteConfigRuleXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteConfigRuleRequest:
    headers: DeleteConfigRuleHeaders = field()
    request: shared.DeleteConfigRuleRequest = field(metadata={'request': { 'media_type': 'application/json' }})
