...
class GetOrganizationConfigRuleDetailedStatusHeaders:
    ...
    x_amz_target: GetOrganizationConfigRuleDetailedStatusXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetOrganizationConfigRuleDetailedStatusRequest:
    query_params: GetOrganizationConfigRuleDetailedStatusQueryParams = field(default=None)
    headers: GetOrganizationConfigRuleDetailedStatusHeaders = field(default=None)
    request: shared.GetOrganizationConfigRuleDetailedStatusRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
