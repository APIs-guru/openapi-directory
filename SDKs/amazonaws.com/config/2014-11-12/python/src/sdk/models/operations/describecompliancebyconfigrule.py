...
class DescribeComplianceByConfigRuleHeaders:
    ...
    x_amz_target: DescribeComplianceByConfigRuleXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeComplianceByConfigRuleRequest:
    query_params: DescribeComplianceByConfigRuleQueryParams = field(default=None)
    headers: DescribeComplianceByConfigRuleHeaders = field(default=None)
    request: shared.DescribeComplianceByConfigRuleRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
