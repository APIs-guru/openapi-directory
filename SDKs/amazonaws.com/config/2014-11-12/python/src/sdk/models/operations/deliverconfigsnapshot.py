...
class DeliverConfigSnapshotHeaders:
    x_amz_target: DeliverConfigSnapshotXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeliverConfigSnapshotRequest:
    headers: DeliverConfigSnapshotHeaders = field()
    request: shared.DeliverConfigSnapshotRequest = field(metadata={'request': { 'media_type': 'application/json' }})
