...
class GetStoredQueryHeaders:
    x_amz_target: GetStoredQueryXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetStoredQueryRequest:
    headers: GetStoredQueryHeaders = field()
    request: shared.GetStoredQueryRequest = field(metadata={'request': { 'media_type': 'application/json' }})
