...
class DescribeAggregateComplianceByConfigRulesHeaders:
    x_amz_target: DescribeAggregateComplianceByConfigRulesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeAggregateComplianceByConfigRulesRequest:
    headers: DescribeAggregateComplianceByConfigRulesHeaders = field()
    query_params: DescribeAggregateComplianceByConfigRulesQueryParams = field()
    request: shared.DescribeAggregateComplianceByConfigRulesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
