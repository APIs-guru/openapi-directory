...
class DeleteDeliveryChannelHeaders:
    x_amz_target: DeleteDeliveryChannelXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteDeliveryChannelRequest:
    headers: DeleteDeliveryChannelHeaders = field()
    request: shared.DeleteDeliveryChannelRequest = field(metadata={'request': { 'media_type': 'application/json' }})
