...
class DescribeRemediationConfigurationsHeaders:
    x_amz_target: DescribeRemediationConfigurationsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeRemediationConfigurationsRequest:
    headers: DescribeRemediationConfigurationsHeaders = field()
    request: shared.DescribeRemediationConfigurationsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
