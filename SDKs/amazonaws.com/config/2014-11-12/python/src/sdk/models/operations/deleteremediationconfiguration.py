...
class DeleteRemediationConfigurationHeaders:
    ...
    x_amz_target: DeleteRemediationConfigurationXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeleteRemediationConfigurationRequest:
    headers: DeleteRemediationConfigurationHeaders = field(default=None)
    request: shared.DeleteRemediationConfigurationRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
