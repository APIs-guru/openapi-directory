...
class DeleteRemediationExceptionsHeaders:
    x_amz_target: DeleteRemediationExceptionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteRemediationExceptionsRequest:
    headers: DeleteRemediationExceptionsHeaders = field()
    request: shared.DeleteRemediationExceptionsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
