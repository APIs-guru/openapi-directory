...
class StartRemediationExecutionHeaders:
    x_amz_target: StartRemediationExecutionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartRemediationExecutionRequest:
    headers: StartRemediationExecutionHeaders = field()
    request: shared.StartRemediationExecutionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
