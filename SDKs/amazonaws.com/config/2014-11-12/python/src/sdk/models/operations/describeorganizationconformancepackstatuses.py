...
class DescribeOrganizationConformancePackStatusesHeaders:
    ...
    x_amz_target: DescribeOrganizationConformancePackStatusesXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
