...
class DescribeConfigurationAggregatorsHeaders:
    x_amz_target: DescribeConfigurationAggregatorsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeConfigurationAggregatorsRequest:
    headers: DescribeConfigurationAggregatorsHeaders = field()
    query_params: DescribeConfigurationAggregatorsQueryParams = field()
    request: shared.DescribeConfigurationAggregatorsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
