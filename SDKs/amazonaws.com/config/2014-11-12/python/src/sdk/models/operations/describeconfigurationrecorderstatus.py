...
class DescribeConfigurationRecorderStatusHeaders:
    x_amz_target: DescribeConfigurationRecorderStatusXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeConfigurationRecorderStatusRequest:
    headers: DescribeConfigurationRecorderStatusHeaders = field()
    request: shared.DescribeConfigurationRecorderStatusRequest = field(metadata={'request': { 'media_type': 'application/json' }})
