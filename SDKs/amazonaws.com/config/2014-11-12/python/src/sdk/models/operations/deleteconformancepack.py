...
class DeleteConformancePackHeaders:
    ...
    x_amz_target: DeleteConformancePackXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeleteConformancePackRequest:
    headers: DeleteConformancePackHeaders = field(default=None)
    request: shared.DeleteConformancePackRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
