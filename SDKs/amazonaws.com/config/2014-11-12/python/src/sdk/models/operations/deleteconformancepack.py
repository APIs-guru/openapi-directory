...
class DeleteConformancePackHeaders:
    x_amz_target: DeleteConformancePackXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteConformancePackRequest:
    headers: DeleteConformancePackHeaders = field()
    request: shared.DeleteConformancePackRequest = field(metadata={'request': { 'media_type': 'application/json' }})
