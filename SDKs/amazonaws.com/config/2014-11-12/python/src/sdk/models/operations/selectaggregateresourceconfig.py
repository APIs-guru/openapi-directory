...
class SelectAggregateResourceConfigHeaders:
    x_amz_target: SelectAggregateResourceConfigXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class SelectAggregateResourceConfigRequest:
    headers: SelectAggregateResourceConfigHeaders = field()
    query_params: SelectAggregateResourceConfigQueryParams = field()
    request: shared.SelectAggregateResourceConfigRequest = field(metadata={'request': { 'media_type': 'application/json' }})
