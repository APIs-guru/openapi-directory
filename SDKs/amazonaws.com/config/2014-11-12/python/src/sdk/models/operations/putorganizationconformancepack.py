...
class PutOrganizationConformancePackHeaders:
    x_amz_target: PutOrganizationConformancePackXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutOrganizationConformancePackRequest:
    headers: PutOrganizationConformancePackHeaders = field()
    request: shared.PutOrganizationConformancePackRequest = field(metadata={'request': { 'media_type': 'application/json' }})
