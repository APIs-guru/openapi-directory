...
class DeleteOrganizationConformancePackHeaders:
    x_amz_target: DeleteOrganizationConformancePackXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteOrganizationConformancePackRequest:
    headers: DeleteOrganizationConformancePackHeaders = field()
    request: shared.DeleteOrganizationConformancePackRequest = field(metadata={'request': { 'media_type': 'application/json' }})
