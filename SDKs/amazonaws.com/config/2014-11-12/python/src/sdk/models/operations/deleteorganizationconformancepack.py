...
class DeleteOrganizationConformancePackHeaders:
    ...
    x_amz_target: DeleteOrganizationConformancePackXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeleteOrganizationConformancePackRequest:
    headers: DeleteOrganizationConformancePackHeaders = field(default=None)
    request: shared.DeleteOrganizationConformancePackRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
