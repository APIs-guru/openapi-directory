...
class DescribeConfigurationRecordersHeaders:
    x_amz_target: DescribeConfigurationRecordersXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeConfigurationRecordersRequest:
    headers: DescribeConfigurationRecordersHeaders = field()
    request: shared.DescribeConfigurationRecordersRequest = field(metadata={'request': { 'media_type': 'application/json' }})
