...
class GetAggregateComplianceDetailsByConfigRuleHeaders:
    x_amz_target: GetAggregateComplianceDetailsByConfigRuleXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetAggregateComplianceDetailsByConfigRuleRequest:
    headers: GetAggregateComplianceDetailsByConfigRuleHeaders = field()
    query_params: GetAggregateComplianceDetailsByConfigRuleQueryParams = field()
    request: shared.GetAggregateComplianceDetailsByConfigRuleRequest = field(metadata={'request': { 'media_type': 'application/json' }})
