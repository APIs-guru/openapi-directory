...
class DescribeComplianceByResourceHeaders:
    x_amz_target: DescribeComplianceByResourceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeComplianceByResourceRequest:
    headers: DescribeComplianceByResourceHeaders = field()
    query_params: DescribeComplianceByResourceQueryParams = field()
    request: shared.DescribeComplianceByResourceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
