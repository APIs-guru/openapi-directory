...
class DescribeConformancePackStatusHeaders:
    x_amz_target: DescribeConformancePackStatusXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeConformancePackStatusRequest:
    headers: DescribeConformancePackStatusHeaders = field()
    query_params: DescribeConformancePackStatusQueryParams = field()
    request: shared.DescribeConformancePackStatusRequest = field(metadata={'request': { 'media_type': 'application/json' }})
