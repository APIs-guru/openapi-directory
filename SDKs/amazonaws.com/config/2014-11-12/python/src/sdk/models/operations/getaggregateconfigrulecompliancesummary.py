...
class GetAggregateConfigRuleComplianceSummaryHeaders:
    ...
    x_amz_target: GetAggregateConfigRuleComplianceSummaryXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
