...
class GetComplianceSummaryByConfigRuleHeaders:
    x_amz_target: GetComplianceSummaryByConfigRuleXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetComplianceSummaryByConfigRuleRequest:
    headers: GetComplianceSummaryByConfigRuleHeaders = field()
