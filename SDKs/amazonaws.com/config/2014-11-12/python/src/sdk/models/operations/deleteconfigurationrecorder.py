...
class DeleteConfigurationRecorderHeaders:
    x_amz_target: DeleteConfigurationRecorderXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteConfigurationRecorderRequest:
    headers: DeleteConfigurationRecorderHeaders = field()
    request: shared.DeleteConfigurationRecorderRequest = field(metadata={'request': { 'media_type': 'application/json' }})
