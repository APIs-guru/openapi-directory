...
class ConfigurationItem:
    ...
    configuration_item_md5_hash: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('configurationItemMD5Hash') }})
    ...
    related_events: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('relatedEvents') }})
