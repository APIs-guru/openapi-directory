...
class DescribeOrganizationConfigRulesHeaders:
    x_amz_target: DescribeOrganizationConfigRulesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeOrganizationConfigRulesRequest:
    headers: DescribeOrganizationConfigRulesHeaders = field()
    query_params: DescribeOrganizationConfigRulesQueryParams = field()
    request: shared.DescribeOrganizationConfigRulesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
