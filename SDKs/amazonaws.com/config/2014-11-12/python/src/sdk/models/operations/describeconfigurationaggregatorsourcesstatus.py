...
class DescribeConfigurationAggregatorSourcesStatusHeaders:
    x_amz_target: DescribeConfigurationAggregatorSourcesStatusXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeConfigurationAggregatorSourcesStatusRequest:
    headers: DescribeConfigurationAggregatorSourcesStatusHeaders = field()
    query_params: DescribeConfigurationAggregatorSourcesStatusQueryParams = field()
    request: shared.DescribeConfigurationAggregatorSourcesStatusRequest = field(metadata={'request': { 'media_type': 'application/json' }})
