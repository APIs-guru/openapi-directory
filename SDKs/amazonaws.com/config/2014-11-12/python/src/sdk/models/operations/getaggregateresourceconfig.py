...
class GetAggregateResourceConfigHeaders:
    x_amz_target: GetAggregateResourceConfigXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetAggregateResourceConfigRequest:
    headers: GetAggregateResourceConfigHeaders = field()
    request: shared.GetAggregateResourceConfigRequest = field(metadata={'request': { 'media_type': 'application/json' }})
