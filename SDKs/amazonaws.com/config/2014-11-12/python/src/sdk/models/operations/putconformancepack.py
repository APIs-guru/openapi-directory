...
class PutConformancePackHeaders:
    x_amz_target: PutConformancePackXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutConformancePackRequest:
    headers: PutConformancePackHeaders = field()
    request: shared.PutConformancePackRequest = field(metadata={'request': { 'media_type': 'application/json' }})
