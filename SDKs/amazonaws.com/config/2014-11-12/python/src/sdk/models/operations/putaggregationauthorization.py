...
class PutAggregationAuthorizationHeaders:
    ...
    x_amz_target: PutAggregationAuthorizationXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class PutAggregationAuthorizationRequest:
    headers: PutAggregationAuthorizationHeaders = field(default=None)
    request: shared.PutAggregationAuthorizationRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
