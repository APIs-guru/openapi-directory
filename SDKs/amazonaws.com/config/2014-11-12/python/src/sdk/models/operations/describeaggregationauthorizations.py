...
class DescribeAggregationAuthorizationsHeaders:
    x_amz_target: DescribeAggregationAuthorizationsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeAggregationAuthorizationsRequest:
    headers: DescribeAggregationAuthorizationsHeaders = field()
    query_params: DescribeAggregationAuthorizationsQueryParams = field()
    request: shared.DescribeAggregationAuthorizationsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
