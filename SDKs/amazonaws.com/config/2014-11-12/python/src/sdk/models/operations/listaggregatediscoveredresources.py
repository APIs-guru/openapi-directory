...
class ListAggregateDiscoveredResourcesHeaders:
    ...
    x_amz_target: ListAggregateDiscoveredResourcesXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ListAggregateDiscoveredResourcesRequest:
    query_params: ListAggregateDiscoveredResourcesQueryParams = field(default=None)
    headers: ListAggregateDiscoveredResourcesHeaders = field(default=None)
    request: shared.ListAggregateDiscoveredResourcesRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
