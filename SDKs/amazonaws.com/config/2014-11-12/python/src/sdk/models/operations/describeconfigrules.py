...
class DescribeConfigRulesHeaders:
    x_amz_target: DescribeConfigRulesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeConfigRulesRequest:
    headers: DescribeConfigRulesHeaders = field()
    query_params: DescribeConfigRulesQueryParams = field()
    request: shared.DescribeConfigRulesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
