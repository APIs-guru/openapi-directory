...
class DescribeConfigRuleEvaluationStatusHeaders:
    x_amz_target: DescribeConfigRuleEvaluationStatusXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeConfigRuleEvaluationStatusRequest:
    headers: DescribeConfigRuleEvaluationStatusHeaders = field()
    query_params: DescribeConfigRuleEvaluationStatusQueryParams = field()
    request: shared.DescribeConfigRuleEvaluationStatusRequest = field(metadata={'request': { 'media_type': 'application/json' }})
