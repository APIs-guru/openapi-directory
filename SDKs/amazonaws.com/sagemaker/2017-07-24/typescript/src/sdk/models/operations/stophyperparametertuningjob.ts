...
export enum StopHyperParameterTuningJobXAmzTargetEnum {
    SageMakerStopHyperParameterTuningJob = "SageMaker.StopHyperParameterTuningJob"
}


export class StopHyperParameterTuningJobHeaders extends SpeakeasyBase {
...
export class StopHyperParameterTuningJobResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
