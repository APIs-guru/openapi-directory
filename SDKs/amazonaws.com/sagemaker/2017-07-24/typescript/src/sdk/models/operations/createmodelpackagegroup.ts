...
export enum CreateModelPackageGroupXAmzTargetEnum {
    SageMakerCreateModelPackageGroup = "SageMaker.CreateModelPackageGroup"
}


export class CreateModelPackageGroupHeaders extends SpeakeasyBase {
...
export class CreateModelPackageGroupRequest extends SpeakeasyBase {
  @Metadata()
...
export class CreateModelPackageGroupResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
