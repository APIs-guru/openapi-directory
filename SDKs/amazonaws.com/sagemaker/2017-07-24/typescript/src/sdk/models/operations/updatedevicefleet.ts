...
export enum UpdateDeviceFleetXAmzTargetEnum {
    SageMakerUpdateDeviceFleet = "SageMaker.UpdateDeviceFleet"
}


export class UpdateDeviceFleetHeaders extends SpeakeasyBase {
...
export class UpdateDeviceFleetResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
