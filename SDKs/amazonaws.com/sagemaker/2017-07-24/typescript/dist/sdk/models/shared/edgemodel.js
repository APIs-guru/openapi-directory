...
var EdgeModel = /** @class */ (function (_super) {
    ...
    ], EdgeModel.prototype, "latestInference", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=LatestSampleTime" }),
        __metadata("design:type", Date)
    ], EdgeModel.prototype, "latestSampleTime", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ModelName" }),
        __metadata("design:type", String)
    ], EdgeModel.prototype, "modelName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ModelVersion" }),
        __metadata("design:type", String)
    ], EdgeModel.prototype, "modelVersion", void 0);
    return EdgeModel;
}(SpeakeasyBase));
export { EdgeModel };
