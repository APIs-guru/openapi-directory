...
**/
var ModelQualityJobInput = /** @class */ (function (_super) {
    __extends(ModelQualityJobInput, _super);
    ...
    ], ModelQualityJobInput.prototype, "endpointInput", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=GroundTruthS3Input" }),
        __metadata("design:type", MonitoringGroundTruthS3Input)
    ], ModelQualityJobInput.prototype, "groundTruthS3Input", void 0);
    return ModelQualityJobInput;
}(SpeakeasyBase));
export { ModelQualityJobInput };
