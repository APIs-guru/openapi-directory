...
**/
var AlgorithmValidationProfile = /** @class */ (function (_super) {
    __extends(AlgorithmValidationProfile, _super);
    ...
    ], AlgorithmValidationProfile.prototype, "profileName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=TrainingJobDefinition" }),
        __metadata("design:type", TrainingJobDefinition)
    ], AlgorithmValidationProfile.prototype, "trainingJobDefinition", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=TransformJobDefinition" }),
        __metadata("design:type", TransformJobDefinition)
    ], AlgorithmValidationProfile.prototype, "transformJobDefinition", void 0);
    return AlgorithmValidationProfile;
}(SpeakeasyBase));
export { AlgorithmValidationProfile };
