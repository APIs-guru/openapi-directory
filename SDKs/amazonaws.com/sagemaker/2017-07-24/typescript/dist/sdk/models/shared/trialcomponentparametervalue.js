...
**/
var TrialComponentParameterValue = /** @class */ (function (_super) {
    __extends(TrialComponentParameterValue, _super);
    ...
    ], TrialComponentParameterValue.prototype, "numberValue", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=StringValue" }),
        __metadata("design:type", String)
    ], TrialComponentParameterValue.prototype, "stringValue", void 0);
    return TrialComponentParameterValue;
}(SpeakeasyBase));
export { TrialComponentParameterValue };
