...
var ListProjectsInput = /** @class */ (function (_super) {
    ...
    ], ListProjectsInput.prototype, "creationTimeAfter", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=CreationTimeBefore" }),
        __metadata("design:type", Date)
    ], ListProjectsInput.prototype, "creationTimeBefore", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=MaxResults" }),
        __metadata("design:type", Number)
    ], ListProjectsInput.prototype, "maxResults", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=NameContains" }),
        __metadata("design:type", String)
    ], ListProjectsInput.prototype, "nameContains", void 0);
    __decorate([
