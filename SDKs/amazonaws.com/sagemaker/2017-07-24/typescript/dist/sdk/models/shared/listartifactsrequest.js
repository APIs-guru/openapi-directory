...
var ListArtifactsRequest = /** @class */ (function (_super) {
    ...
    ], ListArtifactsRequest.prototype, "artifactType", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=CreatedAfter" }),
        __metadata("design:type", Date)
    ], ListArtifactsRequest.prototype, "createdAfter", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=CreatedBefore" }),
        __metadata("design:type", Date)
    ], ListArtifactsRequest.prototype, "createdBefore", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListArtifactsRequest.prototype, "sortBy", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=SortOrder" }),
        __metadata("design:type", String)
    ], ListArtifactsRequest.prototype, "sortOrder", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=SourceUri" }),
        __metadata("design:type", String)
    ], ListArtifactsRequest.prototype, "sourceUri", void 0);
