...
**/
var ModelPackageValidationProfile = /** @class */ (function (_super) {
    __extends(ModelPackageValidationProfile, _super);
    ...
    ], ModelPackageValidationProfile.prototype, "profileName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=TransformJobDefinition" }),
        __metadata("design:type", TransformJobDefinition)
    ], ModelPackageValidationProfile.prototype, "transformJobDefinition", void 0);
    return ModelPackageValidationProfile;
}(SpeakeasyBase));
export { ModelPackageValidationProfile };
