...
var ListDeviceFleetsRequest = /** @class */ (function (_super) {
    ...
    ], ListDeviceFleetsRequest.prototype, "creationTimeAfter", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=CreationTimeBefore" }),
        __metadata("design:type", Date)
    ], ListDeviceFleetsRequest.prototype, "creationTimeBefore", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=LastModifiedTimeAfter" }),
        __metadata("design:type", Date)
    ], ListDeviceFleetsRequest.prototype, "lastModifiedTimeAfter", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=LastModifiedTimeBefore" }),
        __metadata("design:type", Date)
    ], ListDeviceFleetsRequest.prototype, "lastModifiedTimeBefore", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=MaxResults" }),
        __metadata("design:type", Number)
    ], ListDeviceFleetsRequest.prototype, "maxResults", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=NameContains" }),
        __metadata("design:type", String)
    ], ListDeviceFleetsRequest.prototype, "nameContains", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=NextToken" }),
        __metadata("design:type", String)
    ], ListDeviceFleetsRequest.prototype, "nextToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=SortBy" }),
        __metadata("design:type", String)
    ], ListDeviceFleetsRequest.prototype, "sortBy", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=SortOrder" }),
        __metadata("design:type", String)
    ], ListDeviceFleetsRequest.prototype, "sortOrder", void 0);
