...
**/
var HumanLoopActivationConfig = /** @class */ (function (_super) {
    __extends(HumanLoopActivationConfig, _super);
    function HumanLoopActivationConfig() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=HumanLoopActivationConditionsConfig" }),
        __metadata("design:type", HumanLoopActivationConditionsConfig)
    ], HumanLoopActivationConfig.prototype, "humanLoopActivationConditionsConfig", void 0);
    return HumanLoopActivationConfig;
}(SpeakeasyBase));
export { HumanLoopActivationConfig };
