...
**/
var ProcessingOutput = /** @class */ (function (_super) {
    __extends(ProcessingOutput, _super);
    ...
    ], ProcessingOutput.prototype, "appManaged", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=FeatureStoreOutput" }),
        __metadata("design:type", ProcessingFeatureStoreOutput)
    ], ProcessingOutput.prototype, "featureStoreOutput", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=OutputName" }),
        __metadata("design:type", String)
    ], ProcessingOutput.prototype, "outputName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=S3Output" }),
        __metadata("design:type", ProcessingS3Output)
    ], ProcessingOutput.prototype, "s3Output", void 0);
    return ProcessingOutput;
}(SpeakeasyBase));
export { ProcessingOutput };
