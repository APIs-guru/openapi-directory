...
var UpdateImageRequest = /** @class */ (function (_super) {
    ...
    ], UpdateImageRequest.prototype, "deleteProperties", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Description" }),
        __metadata("design:type", String)
    ], UpdateImageRequest.prototype, "description", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=DisplayName" }),
        __metadata("design:type", String)
    ], UpdateImageRequest.prototype, "displayName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ImageName" }),
        __metadata("design:type", String)
    ], UpdateImageRequest.prototype, "imageName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=RoleArn" }),
        __metadata("design:type", String)
    ], UpdateImageRequest.prototype, "roleArn", void 0);
