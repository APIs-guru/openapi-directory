...
**/
var ProfilerConfigForUpdate = /** @class */ (function (_super) {
    __extends(ProfilerConfigForUpdate, _super);
    ...
    ], ProfilerConfigForUpdate.prototype, "disableProfiler", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ProfilingIntervalInMilliseconds" }),
        __metadata("design:type", Number)
    ], ProfilerConfigForUpdate.prototype, "profilingIntervalInMilliseconds", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ProfilingParameters" }),
        __metadata("design:type", Map)
    ], ProfilerConfigForUpdate.prototype, "profilingParameters", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=S3OutputPath" }),
        __metadata("design:type", String)
    ], ProfilerConfigForUpdate.prototype, "s3OutputPath", void 0);
    return ProfilerConfigForUpdate;
}(SpeakeasyBase));
export { ProfilerConfigForUpdate };
