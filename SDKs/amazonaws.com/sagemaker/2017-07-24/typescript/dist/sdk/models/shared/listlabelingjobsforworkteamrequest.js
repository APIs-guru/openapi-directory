...
var ListLabelingJobsForWorkteamRequest = /** @class */ (function (_super) {
    ...
    ], ListLabelingJobsForWorkteamRequest.prototype, "creationTimeAfter", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=CreationTimeBefore" }),
        __metadata("design:type", Date)
    ], ListLabelingJobsForWorkteamRequest.prototype, "creationTimeBefore", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=JobReferenceCodeContains" }),
        __metadata("design:type", String)
    ], ListLabelingJobsForWorkteamRequest.prototype, "jobReferenceCodeContains", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ListLabelingJobsForWorkteamRequest.prototype, "sortBy", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=SortOrder" }),
        __metadata("design:type", String)
    ], ListLabelingJobsForWorkteamRequest.prototype, "sortOrder", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=WorkteamArn" }),
        __metadata("design:type", String)
    ], ListLabelingJobsForWorkteamRequest.prototype, "workteamArn", void 0);
