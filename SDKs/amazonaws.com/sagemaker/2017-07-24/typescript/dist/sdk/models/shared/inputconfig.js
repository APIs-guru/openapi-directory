...
var InputConfig = /** @class */ (function (_super) {
    ...
    ], InputConfig.prototype, "dataInputConfig", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Framework" }),
        __metadata("design:type", String)
    ], InputConfig.prototype, "framework", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=FrameworkVersion" }),
        __metadata("design:type", String)
    ], InputConfig.prototype, "frameworkVersion", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=S3Uri" }),
        __metadata("design:type", String)
    ], InputConfig.prototype, "s3Uri", void 0);
    return InputConfig;
}(SpeakeasyBase));
export { InputConfig };
