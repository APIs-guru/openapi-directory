...
var AppDetails = /** @class */ (function (_super) {
    ...
    ], AppDetails.prototype, "appName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=AppType" }),
        __metadata("design:type", String)
    ], AppDetails.prototype, "appType", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=CreationTime" }),
        __metadata("design:type", Date)
    ], AppDetails.prototype, "creationTime", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=DomainId" }),
        __metadata("design:type", String)
    ], AppDetails.prototype, "domainId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Status" }),
        __metadata("design:type", String)
    ], AppDetails.prototype, "status", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=UserProfileName" }),
        __metadata("design:type", String)
    ], AppDetails.prototype, "userProfileName", void 0);
    return AppDetails;
}(SpeakeasyBase));
export { AppDetails };
