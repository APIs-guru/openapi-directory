...
var PipelineExecutionSummary = /** @class */ (function (_super) {
    ...
    ], PipelineExecutionSummary.prototype, "pipelineExecutionArn", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=PipelineExecutionDescription" }),
        __metadata("design:type", String)
    ], PipelineExecutionSummary.prototype, "pipelineExecutionDescription", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=PipelineExecutionDisplayName" }),
        __metadata("design:type", String)
    ], PipelineExecutionSummary.prototype, "pipelineExecutionDisplayName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=PipelineExecutionStatus" }),
        __metadata("design:type", String)
    ], PipelineExecutionSummary.prototype, "pipelineExecutionStatus", void 0);
    __decorate([
