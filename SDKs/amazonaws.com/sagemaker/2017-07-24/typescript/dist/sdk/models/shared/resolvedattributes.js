...
**/
var ResolvedAttributes = /** @class */ (function (_super) {
    __extends(ResolvedAttributes, _super);
    ...
    ], ResolvedAttributes.prototype, "autoMlJobObjective", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=CompletionCriteria" }),
        __metadata("design:type", AutoMlJobCompletionCriteria)
    ], ResolvedAttributes.prototype, "completionCriteria", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ProblemType" }),
        __metadata("design:type", String)
    ], ResolvedAttributes.prototype, "problemType", void 0);
    return ResolvedAttributes;
}(SpeakeasyBase));
export { ResolvedAttributes };
