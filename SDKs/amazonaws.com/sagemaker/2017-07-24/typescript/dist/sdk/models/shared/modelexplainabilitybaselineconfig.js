...
**/
var ModelExplainabilityBaselineConfig = /** @class */ (function (_super) {
    __extends(ModelExplainabilityBaselineConfig, _super);
    ...
    ], ModelExplainabilityBaselineConfig.prototype, "baseliningJobName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ConstraintsResource" }),
        __metadata("design:type", MonitoringConstraintsResource)
    ], ModelExplainabilityBaselineConfig.prototype, "constraintsResource", void 0);
    return ModelExplainabilityBaselineConfig;
}(SpeakeasyBase));
export { ModelExplainabilityBaselineConfig };
