...
type DescribeTrainingJobResponse struct {
	...
	ProfilerRuleEvaluationStatuses        []ProfilerRuleEvaluationStatus `json:"ProfilerRuleEvaluationStatuses"`
	ProfilingStatus                       *ProfilingStatusEnum           `json:"ProfilingStatus"`
