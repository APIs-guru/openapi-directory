...
type ListNotebookInstanceLifecycleConfigsInput struct {
    ...
    SortBy *NotebookInstanceLifecycleConfigSortKeyEnum `json:"SortBy,omitempty"`
    SortOrder *NotebookInstanceLifecycleConfigSortOrderEnum `json:"SortOrder,omitempty"`
