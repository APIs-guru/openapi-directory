...
class DescribeTransformJobHeaders:
    x_amz_target: DescribeTransformJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeTransformJobRequest:
    headers: DescribeTransformJobHeaders = field()
    request: shared.DescribeTransformJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
