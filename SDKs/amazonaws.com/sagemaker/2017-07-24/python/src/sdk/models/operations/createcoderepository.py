...
class CreateCodeRepositoryHeaders:
    x_amz_target: CreateCodeRepositoryXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateCodeRepositoryRequest:
    headers: CreateCodeRepositoryHeaders = field()
    request: shared.CreateCodeRepositoryInput = field(metadata={'request': { 'media_type': 'application/json' }})
