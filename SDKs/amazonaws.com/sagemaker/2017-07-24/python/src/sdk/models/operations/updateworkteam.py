...
class UpdateWorkteamHeaders:
    x_amz_target: UpdateWorkteamXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateWorkteamRequest:
    headers: UpdateWorkteamHeaders = field()
    request: shared.UpdateWorkteamRequest = field(metadata={'request': { 'media_type': 'application/json' }})
