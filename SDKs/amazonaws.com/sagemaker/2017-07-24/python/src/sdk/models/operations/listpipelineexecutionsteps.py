...
class ListPipelineExecutionStepsHeaders:
    x_amz_target: ListPipelineExecutionStepsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListPipelineExecutionStepsRequest:
    headers: ListPipelineExecutionStepsHeaders = field()
    query_params: ListPipelineExecutionStepsQueryParams = field()
    request: shared.ListPipelineExecutionStepsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
