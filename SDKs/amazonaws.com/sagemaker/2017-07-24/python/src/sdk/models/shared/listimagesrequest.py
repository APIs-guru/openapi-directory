...
from . import imagesortby_enum
from . import imagesortorder_enum
...
class ListImagesRequest:
    ...
    sort_by: Optional[imagesortby_enum.ImageSortByEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'SortBy' }})
    sort_order: Optional[imagesortorder_enum.ImageSortOrderEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'SortOrder' }})
