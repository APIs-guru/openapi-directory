...
class CreateNotebookInstanceLifecycleConfigHeaders:
    x_amz_target: CreateNotebookInstanceLifecycleConfigXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateNotebookInstanceLifecycleConfigRequest:
    headers: CreateNotebookInstanceLifecycleConfigHeaders = field()
    request: shared.CreateNotebookInstanceLifecycleConfigInput = field(metadata={'request': { 'media_type': 'application/json' }})
