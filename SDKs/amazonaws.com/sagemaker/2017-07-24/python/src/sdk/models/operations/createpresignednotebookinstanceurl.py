...
class CreatePresignedNotebookInstanceURLHeaders:
    x_amz_target: CreatePresignedNotebookInstanceURLXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreatePresignedNotebookInstanceURLRequest:
    headers: CreatePresignedNotebookInstanceURLHeaders = field()
    request: shared.CreatePresignedNotebookInstanceURLInput = field(metadata={'request': { 'media_type': 'application/json' }})
