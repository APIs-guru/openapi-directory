...
class DescribeEdgePackagingJobHeaders:
    x_amz_target: DescribeEdgePackagingJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeEdgePackagingJobRequest:
    headers: DescribeEdgePackagingJobHeaders = field()
    request: shared.DescribeEdgePackagingJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
