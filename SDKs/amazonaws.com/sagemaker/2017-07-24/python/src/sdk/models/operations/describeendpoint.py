...
class DescribeEndpointHeaders:
    x_amz_target: DescribeEndpointXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeEndpointRequest:
    ...
    request: shared.DescribeEndpointInput = field(metadata={'request': { 'media_type': 'application/json' }})
