...
class UpdateTrialComponentHeaders:
    x_amz_target: UpdateTrialComponentXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateTrialComponentRequest:
    headers: UpdateTrialComponentHeaders = field()
    request: shared.UpdateTrialComponentRequest = field(metadata={'request': { 'media_type': 'application/json' }})
