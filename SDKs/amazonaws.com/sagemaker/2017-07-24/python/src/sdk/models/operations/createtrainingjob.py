...
class CreateTrainingJobHeaders:
    ...
    x_amz_target: CreateTrainingJobXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateTrainingJobRequest:
    headers: CreateTrainingJobHeaders = field(default=None)
    request: shared.CreateTrainingJobRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
