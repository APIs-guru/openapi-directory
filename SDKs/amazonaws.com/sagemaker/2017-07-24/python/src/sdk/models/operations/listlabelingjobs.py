...
class ListLabelingJobsHeaders:
    x_amz_target: ListLabelingJobsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListLabelingJobsRequest:
    headers: ListLabelingJobsHeaders = field()
    query_params: ListLabelingJobsQueryParams = field()
    request: shared.ListLabelingJobsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
