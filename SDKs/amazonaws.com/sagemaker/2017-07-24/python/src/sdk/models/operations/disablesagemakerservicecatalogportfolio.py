...
class DisableSagemakerServicecatalogPortfolioHeaders:
    x_amz_target: DisableSagemakerServicecatalogPortfolioXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DisableSagemakerServicecatalogPortfolioRequest:
    headers: DisableSagemakerServicecatalogPortfolioHeaders = field()
