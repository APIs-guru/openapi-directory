...
class PutModelPackageGroupPolicyHeaders:
    x_amz_target: PutModelPackageGroupPolicyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutModelPackageGroupPolicyRequest:
    headers: PutModelPackageGroupPolicyHeaders = field()
    request: shared.PutModelPackageGroupPolicyInput = field(metadata={'request': { 'media_type': 'application/json' }})
