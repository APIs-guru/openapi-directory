...
class DescribeStudioLifecycleConfigHeaders:
    x_amz_target: DescribeStudioLifecycleConfigXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeStudioLifecycleConfigRequest:
    headers: DescribeStudioLifecycleConfigHeaders = field()
    request: shared.DescribeStudioLifecycleConfigRequest = field(metadata={'request': { 'media_type': 'application/json' }})
