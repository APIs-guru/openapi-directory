...
class CreateTransformJobHeaders:
    x_amz_target: CreateTransformJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateTransformJobRequest:
    headers: CreateTransformJobHeaders = field()
    request: shared.CreateTransformJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
