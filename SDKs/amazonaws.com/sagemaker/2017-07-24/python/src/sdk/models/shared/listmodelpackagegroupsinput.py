...
from . import modelpackagegroupsortby_enum
...
class ListModelPackageGroupsInput:
    ...
    sort_by: Optional[modelpackagegroupsortby_enum.ModelPackageGroupSortByEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'SortBy' }})
