...
class DeleteImageHeaders:
    x_amz_target: DeleteImageXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteImageRequest:
    ...
    request: shared.DeleteImageRequest = field(metadata={'request': { 'media_type': 'application/json' }})
