...
class DescribeCompilationJobHeaders:
    x_amz_target: DescribeCompilationJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeCompilationJobRequest:
    headers: DescribeCompilationJobHeaders = field()
    request: shared.DescribeCompilationJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
