...
@dataclass
class ProcessingJob:
    app_specification: Optional[appspecification.AppSpecification] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'AppSpecification' }})
    ...
    processing_job_name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ProcessingJobName' }})
    processing_job_status: Optional[processingjobstatus_enum.ProcessingJobStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ProcessingJobStatus' }})
    ...
    processing_resources: Optional[processingresources.ProcessingResources] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ProcessingResources' }})
