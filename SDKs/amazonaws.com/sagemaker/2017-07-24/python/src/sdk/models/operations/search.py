...
@dataclass
class SearchHeaders:
    x_amz_target: SearchXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class SearchRequest:
    ...
    request: shared.SearchRequest = field(metadata={'request': { 'media_type': 'application/json' }})
