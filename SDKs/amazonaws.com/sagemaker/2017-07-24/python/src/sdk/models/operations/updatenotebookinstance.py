...
class UpdateNotebookInstanceHeaders:
    x_amz_target: UpdateNotebookInstanceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateNotebookInstanceRequest:
    headers: UpdateNotebookInstanceHeaders = field()
    request: shared.UpdateNotebookInstanceInput = field(metadata={'request': { 'media_type': 'application/json' }})
