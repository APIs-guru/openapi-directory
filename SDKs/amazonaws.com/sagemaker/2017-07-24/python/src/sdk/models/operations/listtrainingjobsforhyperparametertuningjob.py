...
class ListTrainingJobsForHyperParameterTuningJobHeaders:
    ...
    x_amz_target: ListTrainingJobsForHyperParameterTuningJobXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
