...
class UpdateCodeRepositoryHeaders:
    x_amz_target: UpdateCodeRepositoryXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateCodeRepositoryRequest:
    headers: UpdateCodeRepositoryHeaders = field()
    request: shared.UpdateCodeRepositoryInput = field(metadata={'request': { 'media_type': 'application/json' }})
