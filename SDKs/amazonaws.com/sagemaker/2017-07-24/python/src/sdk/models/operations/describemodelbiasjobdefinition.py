...
class DescribeModelBiasJobDefinitionHeaders:
    ...
    x_amz_target: DescribeModelBiasJobDefinitionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeModelBiasJobDefinitionRequest:
    headers: DescribeModelBiasJobDefinitionHeaders = field(default=None)
    request: shared.DescribeModelBiasJobDefinitionRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
