...
class DescribeTrainingJobHeaders:
    x_amz_target: DescribeTrainingJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeTrainingJobRequest:
    headers: DescribeTrainingJobHeaders = field()
    request: shared.DescribeTrainingJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
