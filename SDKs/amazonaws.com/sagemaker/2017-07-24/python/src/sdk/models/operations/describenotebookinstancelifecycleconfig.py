...
class DescribeNotebookInstanceLifecycleConfigHeaders:
    ...
    x_amz_target: DescribeNotebookInstanceLifecycleConfigXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeNotebookInstanceLifecycleConfigRequest:
    headers: DescribeNotebookInstanceLifecycleConfigHeaders = field(default=None)
    request: shared.DescribeNotebookInstanceLifecycleConfigInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
