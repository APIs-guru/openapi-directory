...
class CreateLabelingJobHeaders:
    ...
    x_amz_target: CreateLabelingJobXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateLabelingJobRequest:
    headers: CreateLabelingJobHeaders = field(default=None)
    request: shared.CreateLabelingJobRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
