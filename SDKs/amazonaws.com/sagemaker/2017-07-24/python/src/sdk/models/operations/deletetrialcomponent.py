...
class DeleteTrialComponentHeaders:
    x_amz_target: DeleteTrialComponentXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteTrialComponentRequest:
    headers: DeleteTrialComponentHeaders = field()
    request: shared.DeleteTrialComponentRequest = field(metadata={'request': { 'media_type': 'application/json' }})
