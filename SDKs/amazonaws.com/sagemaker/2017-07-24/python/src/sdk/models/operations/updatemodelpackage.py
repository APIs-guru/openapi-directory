...
class UpdateModelPackageHeaders:
    x_amz_target: UpdateModelPackageXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateModelPackageRequest:
    headers: UpdateModelPackageHeaders = field()
    request: shared.UpdateModelPackageInput = field(metadata={'request': { 'media_type': 'application/json' }})
