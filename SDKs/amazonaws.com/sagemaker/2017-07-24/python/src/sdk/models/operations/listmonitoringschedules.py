...
class ListMonitoringSchedulesHeaders:
    x_amz_target: ListMonitoringSchedulesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListMonitoringSchedulesRequest:
    headers: ListMonitoringSchedulesHeaders = field()
    query_params: ListMonitoringSchedulesQueryParams = field()
    request: shared.ListMonitoringSchedulesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
