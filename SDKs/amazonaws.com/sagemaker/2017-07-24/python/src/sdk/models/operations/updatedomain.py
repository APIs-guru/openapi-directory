...
class UpdateDomainHeaders:
    ...
    x_amz_target: UpdateDomainXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateDomainRequest:
    headers: UpdateDomainHeaders = field(default=None)
    request: shared.UpdateDomainRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
