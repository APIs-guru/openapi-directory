...
class StartMonitoringScheduleHeaders:
    x_amz_target: StartMonitoringScheduleXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartMonitoringScheduleRequest:
    headers: StartMonitoringScheduleHeaders = field()
    request: shared.StartMonitoringScheduleRequest = field(metadata={'request': { 'media_type': 'application/json' }})
