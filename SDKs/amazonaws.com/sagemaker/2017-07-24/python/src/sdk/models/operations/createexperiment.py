...
class CreateExperimentHeaders:
    x_amz_target: CreateExperimentXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateExperimentRequest:
    headers: CreateExperimentHeaders = field()
    request: shared.CreateExperimentRequest = field(metadata={'request': { 'media_type': 'application/json' }})
