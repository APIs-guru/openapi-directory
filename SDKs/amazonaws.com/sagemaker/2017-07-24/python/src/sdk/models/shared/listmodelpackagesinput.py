...
class ListModelPackagesInput:
    ...
    model_package_type: Optional[ModelPackageTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ModelPackageType') }})
    ...
    sort_by: Optional[ModelPackageSortByEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('SortBy') }})
