...
class DeleteArtifactHeaders:
    x_amz_target: DeleteArtifactXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteArtifactRequest:
    headers: DeleteArtifactHeaders = field()
    request: shared.DeleteArtifactRequest = field(metadata={'request': { 'media_type': 'application/json' }})
