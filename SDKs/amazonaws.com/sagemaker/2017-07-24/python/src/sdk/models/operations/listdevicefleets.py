...
class ListDeviceFleetsHeaders:
    x_amz_target: ListDeviceFleetsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListDeviceFleetsRequest:
    headers: ListDeviceFleetsHeaders = field()
    query_params: ListDeviceFleetsQueryParams = field()
    request: shared.ListDeviceFleetsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
