...
class GetModelPackageGroupPolicyHeaders:
    x_amz_target: GetModelPackageGroupPolicyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetModelPackageGroupPolicyRequest:
    headers: GetModelPackageGroupPolicyHeaders = field()
    request: shared.GetModelPackageGroupPolicyInput = field(metadata={'request': { 'media_type': 'application/json' }})
