...
class GetDeviceFleetReportHeaders:
    x_amz_target: GetDeviceFleetReportXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetDeviceFleetReportRequest:
    headers: GetDeviceFleetReportHeaders = field()
    request: shared.GetDeviceFleetReportRequest = field(metadata={'request': { 'media_type': 'application/json' }})
