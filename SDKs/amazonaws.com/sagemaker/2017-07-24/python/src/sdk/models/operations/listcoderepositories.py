...
class ListCodeRepositoriesHeaders:
    x_amz_target: ListCodeRepositoriesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListCodeRepositoriesRequest:
    headers: ListCodeRepositoriesHeaders = field()
    query_params: ListCodeRepositoriesQueryParams = field()
    request: shared.ListCodeRepositoriesInput = field(metadata={'request': { 'media_type': 'application/json' }})
