...
@dataclass
class ListDataQualityJobDefinitionsQueryParams:
...
class ListDataQualityJobDefinitionsHeaders:
    ...
    x_amz_target: ListDataQualityJobDefinitionsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
