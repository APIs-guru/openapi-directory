...
class SendPipelineExecutionStepSuccessHeaders:
    x_amz_target: SendPipelineExecutionStepSuccessXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class SendPipelineExecutionStepSuccessRequest:
    headers: SendPipelineExecutionStepSuccessHeaders = field()
    request: shared.SendPipelineExecutionStepSuccessRequest = field(metadata={'request': { 'media_type': 'application/json' }})
