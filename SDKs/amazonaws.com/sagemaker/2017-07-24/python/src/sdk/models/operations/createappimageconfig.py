...
class CreateAppImageConfigHeaders:
    x_amz_target: CreateAppImageConfigXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateAppImageConfigRequest:
    headers: CreateAppImageConfigHeaders = field()
    request: shared.CreateAppImageConfigRequest = field(metadata={'request': { 'media_type': 'application/json' }})
