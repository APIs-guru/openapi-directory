...
from . import listcompilationjobssortby_enum
...
class ListCompilationJobsRequest:
    ...
    sort_by: Optional[listcompilationjobssortby_enum.ListCompilationJobsSortByEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'SortBy' }})
    sort_order: Optional[sortorder_enum.SortOrderEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'SortOrder' }})
    status_equals: Optional[compilationjobstatus_enum.CompilationJobStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'StatusEquals' }})
