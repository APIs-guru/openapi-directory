...
class DescribeCodeRepositoryHeaders:
    x_amz_target: DescribeCodeRepositoryXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeCodeRepositoryRequest:
    headers: DescribeCodeRepositoryHeaders = field()
    request: shared.DescribeCodeRepositoryInput = field(metadata={'request': { 'media_type': 'application/json' }})
