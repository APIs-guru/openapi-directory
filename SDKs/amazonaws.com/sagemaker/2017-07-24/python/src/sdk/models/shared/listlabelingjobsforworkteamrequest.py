...
from . import listlabelingjobsforworkteamsortbyoptions_enum
...
class ListLabelingJobsForWorkteamRequest:
    ...
    job_reference_code_contains: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'JobReferenceCodeContains' }})
    max_results: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'MaxResults' }})
    next_token: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'NextToken' }})
    sort_by: Optional[listlabelingjobsforworkteamsortbyoptions_enum.ListLabelingJobsForWorkteamSortByOptionsEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'SortBy' }})
