...
from . import listdevicefleetssortby_enum
...
class ListDeviceFleetsRequest:
    ...
    sort_by: Optional[listdevicefleetssortby_enum.ListDeviceFleetsSortByEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'SortBy' }})
