...
from . import modelsortkey_enum
from . import orderkey_enum
...
class ListModelsInput:
    ...
    sort_by: Optional[modelsortkey_enum.ModelSortKeyEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'SortBy' }})
    sort_order: Optional[orderkey_enum.OrderKeyEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'SortOrder' }})
