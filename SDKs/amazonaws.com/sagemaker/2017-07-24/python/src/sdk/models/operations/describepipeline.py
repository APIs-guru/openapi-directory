...
class DescribePipelineHeaders:
    x_amz_target: DescribePipelineXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribePipelineRequest:
    headers: DescribePipelineHeaders = field()
    request: shared.DescribePipelineRequest = field(metadata={'request': { 'media_type': 'application/json' }})
