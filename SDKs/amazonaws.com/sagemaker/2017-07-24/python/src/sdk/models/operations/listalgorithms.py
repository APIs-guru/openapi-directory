...
class ListAlgorithmsHeaders:
    x_amz_target: ListAlgorithmsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListAlgorithmsRequest:
    headers: ListAlgorithmsHeaders = field()
    query_params: ListAlgorithmsQueryParams = field()
    request: shared.ListAlgorithmsInput = field(metadata={'request': { 'media_type': 'application/json' }})
