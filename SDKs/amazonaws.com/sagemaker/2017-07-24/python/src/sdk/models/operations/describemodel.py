...
class DescribeModelHeaders:
    x_amz_target: DescribeModelXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeModelRequest:
    headers: DescribeModelHeaders = field()
    request: shared.DescribeModelInput = field(metadata={'request': { 'media_type': 'application/json' }})
