...
class DescribeWorkteamHeaders:
    x_amz_target: DescribeWorkteamXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeWorkteamRequest:
    headers: DescribeWorkteamHeaders = field()
    request: shared.DescribeWorkteamRequest = field(metadata={'request': { 'media_type': 'application/json' }})
