...
from . import studiolifecycleconfigsortkey_enum
...
class ListStudioLifecycleConfigsRequest:
    app_type_equals: Optional[studiolifecycleconfigapptype_enum.StudioLifecycleConfigAppTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'AppTypeEquals' }})
    ...
    sort_by: Optional[studiolifecycleconfigsortkey_enum.StudioLifecycleConfigSortKeyEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'SortBy' }})
