...
from . import endpointsortkey_enum
...
class ListEndpointsInput:
    ...
    sort_by: Optional[endpointsortkey_enum.EndpointSortKeyEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'SortBy' }})
    sort_order: Optional[orderkey_enum.OrderKeyEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'SortOrder' }})
    status_equals: Optional[endpointstatus_enum.EndpointStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'StatusEquals' }})
