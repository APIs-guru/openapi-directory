...
class CreateProcessingJobHeaders:
    x_amz_target: CreateProcessingJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateProcessingJobRequest:
    headers: CreateProcessingJobHeaders = field()
    request: shared.CreateProcessingJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
