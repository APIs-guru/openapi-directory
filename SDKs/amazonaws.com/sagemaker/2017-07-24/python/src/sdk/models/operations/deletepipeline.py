...
class DeletePipelineHeaders:
    x_amz_target: DeletePipelineXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeletePipelineRequest:
    headers: DeletePipelineHeaders = field()
    request: shared.DeletePipelineRequest = field(metadata={'request': { 'media_type': 'application/json' }})
