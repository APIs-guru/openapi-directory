...
class ListStudioLifecycleConfigsHeaders:
    x_amz_target: ListStudioLifecycleConfigsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListStudioLifecycleConfigsRequest:
    headers: ListStudioLifecycleConfigsHeaders = field()
    query_params: ListStudioLifecycleConfigsQueryParams = field()
    request: shared.ListStudioLifecycleConfigsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
