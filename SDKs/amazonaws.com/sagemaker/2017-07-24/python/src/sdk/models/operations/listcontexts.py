...
class ListContextsHeaders:
    x_amz_target: ListContextsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListContextsRequest:
    headers: ListContextsHeaders = field()
    query_params: ListContextsQueryParams = field()
    request: shared.ListContextsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
