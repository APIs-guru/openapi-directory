...
class ListMonitoringExecutionsHeaders:
    x_amz_target: ListMonitoringExecutionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListMonitoringExecutionsRequest:
    headers: ListMonitoringExecutionsHeaders = field()
    query_params: ListMonitoringExecutionsQueryParams = field()
    request: shared.ListMonitoringExecutionsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
