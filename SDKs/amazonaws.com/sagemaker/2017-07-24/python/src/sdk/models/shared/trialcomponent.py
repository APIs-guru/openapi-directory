...
from . import trialcomponentsourcedetail
...
class TrialComponent:
    ...
    source_detail: Optional[trialcomponentsourcedetail.TrialComponentSourceDetail] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'SourceDetail' }})
