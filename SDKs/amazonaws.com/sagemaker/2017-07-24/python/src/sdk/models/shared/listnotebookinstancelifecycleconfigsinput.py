...
class ListNotebookInstanceLifecycleConfigsInput:
    ...
    sort_by: Optional[NotebookInstanceLifecycleConfigSortKeyEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('SortBy') }})
    sort_order: Optional[NotebookInstanceLifecycleConfigSortOrderEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('SortOrder') }})
