...
class CreateAlgorithmHeaders:
    x_amz_target: CreateAlgorithmXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateAlgorithmRequest:
    headers: CreateAlgorithmHeaders = field()
    request: shared.CreateAlgorithmInput = field(metadata={'request': { 'media_type': 'application/json' }})
