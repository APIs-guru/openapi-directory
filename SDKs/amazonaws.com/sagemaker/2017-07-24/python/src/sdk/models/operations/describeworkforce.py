...
class DescribeWorkforceHeaders:
    x_amz_target: DescribeWorkforceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeWorkforceRequest:
    headers: DescribeWorkforceHeaders = field()
    request: shared.DescribeWorkforceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
