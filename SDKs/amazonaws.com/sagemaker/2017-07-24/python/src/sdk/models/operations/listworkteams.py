...
class ListWorkteamsHeaders:
    x_amz_target: ListWorkteamsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListWorkteamsRequest:
    headers: ListWorkteamsHeaders = field()
    query_params: ListWorkteamsQueryParams = field()
    request: shared.ListWorkteamsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
