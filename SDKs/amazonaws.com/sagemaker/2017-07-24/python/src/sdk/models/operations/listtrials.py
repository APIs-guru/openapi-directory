...
class ListTrialsHeaders:
    x_amz_target: ListTrialsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListTrialsRequest:
    headers: ListTrialsHeaders = field()
    query_params: ListTrialsQueryParams = field()
    request: shared.ListTrialsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
