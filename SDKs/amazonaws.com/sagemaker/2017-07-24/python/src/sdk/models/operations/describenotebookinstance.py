...
class DescribeNotebookInstanceHeaders:
    x_amz_target: DescribeNotebookInstanceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeNotebookInstanceRequest:
    headers: DescribeNotebookInstanceHeaders = field()
    request: shared.DescribeNotebookInstanceInput = field(metadata={'request': { 'media_type': 'application/json' }})
