...
class DeleteHumanTaskUIHeaders:
    x_amz_target: DeleteHumanTaskUIXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteHumanTaskUIRequest:
    headers: DeleteHumanTaskUIHeaders = field()
    request: shared.DeleteHumanTaskUIRequest = field(metadata={'request': { 'media_type': 'application/json' }})
