...
class AssociateTrialComponentHeaders:
    x_amz_target: AssociateTrialComponentXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AssociateTrialComponentRequest:
    headers: AssociateTrialComponentHeaders = field()
    request: shared.AssociateTrialComponentRequest = field(metadata={'request': { 'media_type': 'application/json' }})
