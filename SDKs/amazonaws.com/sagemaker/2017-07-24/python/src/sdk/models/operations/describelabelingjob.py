...
class DescribeLabelingJobHeaders:
    x_amz_target: DescribeLabelingJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeLabelingJobRequest:
    headers: DescribeLabelingJobHeaders = field()
    request: shared.DescribeLabelingJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
