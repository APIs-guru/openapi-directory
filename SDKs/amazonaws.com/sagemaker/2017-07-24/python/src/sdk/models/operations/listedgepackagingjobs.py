...
class ListEdgePackagingJobsHeaders:
    x_amz_target: ListEdgePackagingJobsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListEdgePackagingJobsRequest:
    headers: ListEdgePackagingJobsHeaders = field()
    query_params: ListEdgePackagingJobsQueryParams = field()
    request: shared.ListEdgePackagingJobsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
