...
class ListNotebookInstancesHeaders:
    x_amz_target: ListNotebookInstancesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListNotebookInstancesRequest:
    headers: ListNotebookInstancesHeaders = field()
    query_params: ListNotebookInstancesQueryParams = field()
    request: shared.ListNotebookInstancesInput = field(metadata={'request': { 'media_type': 'application/json' }})
