...
class ListHumanTaskUisHeaders:
    x_amz_target: ListHumanTaskUisXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListHumanTaskUisRequest:
    headers: ListHumanTaskUisHeaders = field()
    query_params: ListHumanTaskUisQueryParams = field()
    request: shared.ListHumanTaskUisRequest = field(metadata={'request': { 'media_type': 'application/json' }})
