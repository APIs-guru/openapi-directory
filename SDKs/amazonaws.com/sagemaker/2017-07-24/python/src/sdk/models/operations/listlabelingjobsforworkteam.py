...
class ListLabelingJobsForWorkteamHeaders:
    ...
    x_amz_target: ListLabelingJobsForWorkteamXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ListLabelingJobsForWorkteamRequest:
    query_params: ListLabelingJobsForWorkteamQueryParams = field(default=None)
    headers: ListLabelingJobsForWorkteamHeaders = field(default=None)
    request: shared.ListLabelingJobsForWorkteamRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
