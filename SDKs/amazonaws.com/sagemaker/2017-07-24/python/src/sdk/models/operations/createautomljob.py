...
class CreateAutoMlJobHeaders:
    x_amz_target: CreateAutoMlJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateAutoMlJobRequest:
    headers: CreateAutoMlJobHeaders = field()
    request: shared.CreateAutoMlJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
