...
class DeleteAssociationHeaders:
    ...
    x_amz_target: DeleteAssociationXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
...
class DeleteAssociationResponse:
    ...
    delete_association_response: Optional[shared.DeleteAssociationResponse] = field(default=None)
