...
class ListWorkforcesHeaders:
    x_amz_target: ListWorkforcesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListWorkforcesRequest:
    headers: ListWorkforcesHeaders = field()
    query_params: ListWorkforcesQueryParams = field()
    request: shared.ListWorkforcesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
