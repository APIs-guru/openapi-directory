...
class ListModelExplainabilityJobDefinitionsHeaders:
    ...
    x_amz_target: ListModelExplainabilityJobDefinitionsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
