...
class GetSearchSuggestionsHeaders:
    x_amz_target: GetSearchSuggestionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetSearchSuggestionsRequest:
    headers: GetSearchSuggestionsHeaders = field()
    request: shared.GetSearchSuggestionsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
