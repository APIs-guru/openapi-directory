...
class CreateModelPackageHeaders:
    x_amz_target: CreateModelPackageXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateModelPackageRequest:
    headers: CreateModelPackageHeaders = field()
    request: shared.CreateModelPackageInput = field(metadata={'request': { 'media_type': 'application/json' }})
