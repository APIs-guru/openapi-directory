...
class DeleteNotebookInstanceLifecycleConfigHeaders:
    ...
    x_amz_target: DeleteNotebookInstanceLifecycleConfigXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
