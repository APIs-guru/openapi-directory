...
class DeleteNotebookInstanceLifecycleConfigHeaders:
    x_amz_target: DeleteNotebookInstanceLifecycleConfigXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteNotebookInstanceLifecycleConfigRequest:
    headers: DeleteNotebookInstanceLifecycleConfigHeaders = field()
    request: shared.DeleteNotebookInstanceLifecycleConfigInput = field(metadata={'request': { 'media_type': 'application/json' }})
