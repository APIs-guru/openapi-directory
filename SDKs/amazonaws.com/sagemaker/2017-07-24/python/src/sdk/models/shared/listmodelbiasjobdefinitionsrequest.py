...
from . import monitoringjobdefinitionsortkey_enum
...
class ListModelBiasJobDefinitionsRequest:
    ...
    sort_by: Optional[monitoringjobdefinitionsortkey_enum.MonitoringJobDefinitionSortKeyEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'SortBy' }})
