...
class ListFeatureGroupsHeaders:
    x_amz_target: ListFeatureGroupsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListFeatureGroupsRequest:
    headers: ListFeatureGroupsHeaders = field()
    query_params: ListFeatureGroupsQueryParams = field()
    request: shared.ListFeatureGroupsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
