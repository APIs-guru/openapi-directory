...
class ListSubscribedWorkteamsHeaders:
    x_amz_target: ListSubscribedWorkteamsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListSubscribedWorkteamsRequest:
    headers: ListSubscribedWorkteamsHeaders = field()
    query_params: ListSubscribedWorkteamsQueryParams = field()
    request: shared.ListSubscribedWorkteamsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
