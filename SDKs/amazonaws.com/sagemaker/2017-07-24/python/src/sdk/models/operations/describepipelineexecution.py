...
class DescribePipelineExecutionHeaders:
    x_amz_target: DescribePipelineExecutionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribePipelineExecutionRequest:
    headers: DescribePipelineExecutionHeaders = field()
    request: shared.DescribePipelineExecutionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
