...
class CreateFeatureGroupHeaders:
    x_amz_target: CreateFeatureGroupXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateFeatureGroupRequest:
    headers: CreateFeatureGroupHeaders = field()
    request: shared.CreateFeatureGroupRequest = field(metadata={'request': { 'media_type': 'application/json' }})
