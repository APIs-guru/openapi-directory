...
class DescribeDeviceHeaders:
    x_amz_target: DescribeDeviceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeDeviceRequest:
    ...
    request: shared.DescribeDeviceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
