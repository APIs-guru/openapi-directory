...
class DeleteFeatureGroupHeaders:
    x_amz_target: DeleteFeatureGroupXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteFeatureGroupRequest:
    headers: DeleteFeatureGroupHeaders = field()
    request: shared.DeleteFeatureGroupRequest = field(metadata={'request': { 'media_type': 'application/json' }})
