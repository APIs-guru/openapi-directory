...
class ListTransformJobsHeaders:
    x_amz_target: ListTransformJobsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListTransformJobsRequest:
    headers: ListTransformJobsHeaders = field()
    query_params: ListTransformJobsQueryParams = field()
    request: shared.ListTransformJobsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
