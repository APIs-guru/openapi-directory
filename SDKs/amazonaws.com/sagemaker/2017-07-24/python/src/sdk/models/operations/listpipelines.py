...
class ListPipelinesHeaders:
    ...
    x_amz_target: ListPipelinesXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
...
class ListPipelinesRequest:
    ...
    request: shared.ListPipelinesRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
