...
from . import hyperparametertuningjobsortbyoptions_enum
...
class ListHyperParameterTuningJobsRequest:
    ...
    sort_by: Optional[hyperparametertuningjobsortbyoptions_enum.HyperParameterTuningJobSortByOptionsEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'SortBy' }})
    sort_order: Optional[sortorder_enum.SortOrderEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'SortOrder' }})
    status_equals: Optional[hyperparametertuningjobstatus_enum.HyperParameterTuningJobStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'StatusEquals' }})
