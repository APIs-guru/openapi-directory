...
class ListProjectsHeaders:
    x_amz_target: ListProjectsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListProjectsRequest:
    ...
    request: shared.ListProjectsInput = field(metadata={'request': { 'media_type': 'application/json' }})
