...
class DescribeAutoMlJobHeaders:
    x_amz_target: DescribeAutoMlJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeAutoMlJobRequest:
    headers: DescribeAutoMlJobHeaders = field()
    request: shared.DescribeAutoMlJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
