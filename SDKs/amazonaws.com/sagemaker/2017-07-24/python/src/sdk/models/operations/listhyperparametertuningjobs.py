...
class ListHyperParameterTuningJobsHeaders:
    x_amz_target: ListHyperParameterTuningJobsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListHyperParameterTuningJobsRequest:
    headers: ListHyperParameterTuningJobsHeaders = field()
    query_params: ListHyperParameterTuningJobsQueryParams = field()
    request: shared.ListHyperParameterTuningJobsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
