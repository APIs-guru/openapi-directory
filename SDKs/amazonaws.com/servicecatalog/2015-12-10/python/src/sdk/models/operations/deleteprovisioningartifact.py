...
class DeleteProvisioningArtifactHeaders:
    x_amz_target: DeleteProvisioningArtifactXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteProvisioningArtifactRequest:
    headers: DeleteProvisioningArtifactHeaders = field()
    request: shared.DeleteProvisioningArtifactInput = field(metadata={'request': { 'media_type': 'application/json' }})
