...
class BatchDisassociateServiceActionFromProvisioningArtifactHeaders:
    ...
    x_amz_target: BatchDisassociateServiceActionFromProvisioningArtifactXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class BatchDisassociateServiceActionFromProvisioningArtifactRequest:
    headers: BatchDisassociateServiceActionFromProvisioningArtifactHeaders = field(default=None)
    request: shared.BatchDisassociateServiceActionFromProvisioningArtifactInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
