...
class ProvisionProductHeaders:
    x_amz_target: ProvisionProductXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ProvisionProductRequest:
    headers: ProvisionProductHeaders = field()
    request: shared.ProvisionProductInput = field(metadata={'request': { 'media_type': 'application/json' }})
