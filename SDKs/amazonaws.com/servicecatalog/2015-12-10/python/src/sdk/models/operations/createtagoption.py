...
class CreateTagOptionHeaders:
    ...
    x_amz_target: CreateTagOptionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateTagOptionRequest:
    headers: CreateTagOptionHeaders = field(default=None)
    request: shared.CreateTagOptionInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
