...
class CreateProvisionedProductPlanHeaders:
    x_amz_target: CreateProvisionedProductPlanXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateProvisionedProductPlanRequest:
    headers: CreateProvisionedProductPlanHeaders = field()
    request: shared.CreateProvisionedProductPlanInput = field(metadata={'request': { 'media_type': 'application/json' }})
