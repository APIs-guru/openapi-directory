...
from . import productsource_enum
...
class SearchProductsAsAdminInput:
    ...
    product_source: Optional[productsource_enum.ProductSourceEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ProductSource' }})
