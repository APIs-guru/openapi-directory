...
class DescribeServiceActionHeaders:
    x_amz_target: DescribeServiceActionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeServiceActionRequest:
    headers: DescribeServiceActionHeaders = field()
    request: shared.DescribeServiceActionInput = field(metadata={'request': { 'media_type': 'application/json' }})
