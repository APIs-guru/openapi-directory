...
class UpdateTagOptionHeaders:
    x_amz_target: UpdateTagOptionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateTagOptionRequest:
    headers: UpdateTagOptionHeaders = field()
    request: shared.UpdateTagOptionInput = field(metadata={'request': { 'media_type': 'application/json' }})
