...
class DisassociateProductFromPortfolioHeaders:
    x_amz_target: DisassociateProductFromPortfolioXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DisassociateProductFromPortfolioRequest:
    headers: DisassociateProductFromPortfolioHeaders = field()
    request: shared.DisassociateProductFromPortfolioInput = field(metadata={'request': { 'media_type': 'application/json' }})
