...
class BatchAssociateServiceActionWithProvisioningArtifactHeaders:
    ...
    x_amz_target: BatchAssociateServiceActionWithProvisioningArtifactXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class BatchAssociateServiceActionWithProvisioningArtifactRequest:
    headers: BatchAssociateServiceActionWithProvisioningArtifactHeaders = field(default=None)
    request: shared.BatchAssociateServiceActionWithProvisioningArtifactInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
