...
class DisassociatePrincipalFromPortfolioHeaders:
    ...
    x_amz_target: DisassociatePrincipalFromPortfolioXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DisassociatePrincipalFromPortfolioRequest:
    headers: DisassociatePrincipalFromPortfolioHeaders = field(default=None)
    request: shared.DisassociatePrincipalFromPortfolioInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
