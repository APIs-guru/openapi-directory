...
class ListProvisioningArtifactsForServiceActionHeaders:
    ...
    x_amz_target: ListProvisioningArtifactsForServiceActionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
