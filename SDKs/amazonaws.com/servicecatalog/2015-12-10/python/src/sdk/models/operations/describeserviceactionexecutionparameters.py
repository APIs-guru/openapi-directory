...
class DescribeServiceActionExecutionParametersHeaders:
    ...
    x_amz_target: DescribeServiceActionExecutionParametersXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
