...
class DescribeServiceActionExecutionParametersHeaders:
    x_amz_target: DescribeServiceActionExecutionParametersXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeServiceActionExecutionParametersRequest:
    headers: DescribeServiceActionExecutionParametersHeaders = field()
    request: shared.DescribeServiceActionExecutionParametersInput = field(metadata={'request': { 'media_type': 'application/json' }})
