...
class DeletePortfolioShareHeaders:
    ...
    x_amz_target: DeletePortfolioShareXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeletePortfolioShareRequest:
    headers: DeletePortfolioShareHeaders = field(default=None)
    request: shared.DeletePortfolioShareInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
