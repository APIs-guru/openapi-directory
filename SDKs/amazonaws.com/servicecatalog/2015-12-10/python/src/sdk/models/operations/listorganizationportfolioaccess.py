...
class ListOrganizationPortfolioAccessHeaders:
    ...
    x_amz_target: ListOrganizationPortfolioAccessXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ListOrganizationPortfolioAccessRequest:
    query_params: ListOrganizationPortfolioAccessQueryParams = field(default=None)
    headers: ListOrganizationPortfolioAccessHeaders = field(default=None)
    request: shared.ListOrganizationPortfolioAccessInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
