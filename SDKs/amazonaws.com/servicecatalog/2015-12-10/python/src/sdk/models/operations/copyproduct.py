...
class CopyProductHeaders:
    x_amz_target: CopyProductXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CopyProductRequest:
    headers: CopyProductHeaders = field()
    request: shared.CopyProductInput = field(metadata={'request': { 'media_type': 'application/json' }})
