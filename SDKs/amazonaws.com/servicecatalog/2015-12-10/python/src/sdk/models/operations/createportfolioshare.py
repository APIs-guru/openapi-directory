...
class CreatePortfolioShareHeaders:
    x_amz_target: CreatePortfolioShareXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreatePortfolioShareRequest:
    headers: CreatePortfolioShareHeaders = field()
    request: shared.CreatePortfolioShareInput = field(metadata={'request': { 'media_type': 'application/json' }})
