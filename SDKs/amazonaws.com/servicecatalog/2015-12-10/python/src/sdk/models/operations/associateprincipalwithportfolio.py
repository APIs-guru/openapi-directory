...
class AssociatePrincipalWithPortfolioHeaders:
    x_amz_target: AssociatePrincipalWithPortfolioXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AssociatePrincipalWithPortfolioRequest:
    headers: AssociatePrincipalWithPortfolioHeaders = field()
    request: shared.AssociatePrincipalWithPortfolioInput = field(metadata={'request': { 'media_type': 'application/json' }})
