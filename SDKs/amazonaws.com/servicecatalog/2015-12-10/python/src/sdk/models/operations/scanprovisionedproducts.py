...
class ScanProvisionedProductsHeaders:
    x_amz_target: ScanProvisionedProductsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ScanProvisionedProductsRequest:
    headers: ScanProvisionedProductsHeaders = field()
    request: shared.ScanProvisionedProductsInput = field(metadata={'request': { 'media_type': 'application/json' }})
