...
class CreatePortfolioHeaders:
    x_amz_target: CreatePortfolioXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreatePortfolioRequest:
    headers: CreatePortfolioHeaders = field()
    request: shared.CreatePortfolioInput = field(metadata={'request': { 'media_type': 'application/json' }})
