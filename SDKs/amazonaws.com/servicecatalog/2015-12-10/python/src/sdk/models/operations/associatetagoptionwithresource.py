...
class AssociateTagOptionWithResourceHeaders:
    x_amz_target: AssociateTagOptionWithResourceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AssociateTagOptionWithResourceRequest:
    headers: AssociateTagOptionWithResourceHeaders = field()
    request: shared.AssociateTagOptionWithResourceInput = field(metadata={'request': { 'media_type': 'application/json' }})
