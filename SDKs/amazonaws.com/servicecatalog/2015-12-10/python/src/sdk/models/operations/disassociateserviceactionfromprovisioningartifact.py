...
class DisassociateServiceActionFromProvisioningArtifactHeaders:
    x_amz_target: DisassociateServiceActionFromProvisioningArtifactXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DisassociateServiceActionFromProvisioningArtifactRequest:
    headers: DisassociateServiceActionFromProvisioningArtifactHeaders = field()
    request: shared.DisassociateServiceActionFromProvisioningArtifactInput = field(metadata={'request': { 'media_type': 'application/json' }})
