...
class CreateServiceActionHeaders:
    x_amz_target: CreateServiceActionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateServiceActionRequest:
    headers: CreateServiceActionHeaders = field()
    request: shared.CreateServiceActionInput = field(metadata={'request': { 'media_type': 'application/json' }})
