...
class ImportAsProvisionedProductHeaders:
    x_amz_target: ImportAsProvisionedProductXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ImportAsProvisionedProductRequest:
    headers: ImportAsProvisionedProductHeaders = field()
    request: shared.ImportAsProvisionedProductInput = field(metadata={'request': { 'media_type': 'application/json' }})
