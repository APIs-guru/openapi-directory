...
class DeletePortfolioHeaders:
    x_amz_target: DeletePortfolioXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeletePortfolioRequest:
    headers: DeletePortfolioHeaders = field()
    request: shared.DeletePortfolioInput = field(metadata={'request': { 'media_type': 'application/json' }})
