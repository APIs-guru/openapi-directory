...
class DeletePortfolioHeaders:
    ...
    x_amz_target: DeletePortfolioXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeletePortfolioRequest:
    headers: DeletePortfolioHeaders = field(default=None)
    request: shared.DeletePortfolioInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class DeletePortfolioResponse:
    content_type: str = field(default=None)
    delete_portfolio_output: Optional[dict[str, Any]] = field(default=None)
