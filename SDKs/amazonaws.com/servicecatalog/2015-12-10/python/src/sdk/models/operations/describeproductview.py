...
class DescribeProductViewHeaders:
    ...
    x_amz_target: DescribeProductViewXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeProductViewRequest:
    headers: DescribeProductViewHeaders = field(default=None)
    request: shared.DescribeProductViewInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
