...
class DescribeProvisioningParametersHeaders:
    x_amz_target: DescribeProvisioningParametersXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeProvisioningParametersRequest:
    headers: DescribeProvisioningParametersHeaders = field()
    request: shared.DescribeProvisioningParametersInput = field(metadata={'request': { 'media_type': 'application/json' }})
