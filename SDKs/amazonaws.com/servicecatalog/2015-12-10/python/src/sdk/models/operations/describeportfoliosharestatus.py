...
class DescribePortfolioShareStatusHeaders:
    x_amz_target: DescribePortfolioShareStatusXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribePortfolioShareStatusRequest:
    headers: DescribePortfolioShareStatusHeaders = field()
    request: shared.DescribePortfolioShareStatusInput = field(metadata={'request': { 'media_type': 'application/json' }})
