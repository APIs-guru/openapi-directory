...
class SearchProductsAsAdminHeaders:
    x_amz_target: SearchProductsAsAdminXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class SearchProductsAsAdminRequest:
    headers: SearchProductsAsAdminHeaders = field()
    query_params: SearchProductsAsAdminQueryParams = field()
    request: shared.SearchProductsAsAdminInput = field(metadata={'request': { 'media_type': 'application/json' }})
