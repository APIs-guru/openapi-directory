...
class ListPortfoliosHeaders:
    x_amz_target: ListPortfoliosXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListPortfoliosRequest:
    headers: ListPortfoliosHeaders = field()
    query_params: ListPortfoliosQueryParams = field()
    request: shared.ListPortfoliosInput = field(metadata={'request': { 'media_type': 'application/json' }})
