...
class UpdatePortfolioShareHeaders:
    ...
    x_amz_target: UpdatePortfolioShareXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdatePortfolioShareRequest:
    headers: UpdatePortfolioShareHeaders = field(default=None)
    request: shared.UpdatePortfolioShareInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
