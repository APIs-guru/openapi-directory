...
class TerminateProvisionedProductHeaders:
    x_amz_target: TerminateProvisionedProductXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class TerminateProvisionedProductRequest:
    headers: TerminateProvisionedProductHeaders = field()
    request: shared.TerminateProvisionedProductInput = field(metadata={'request': { 'media_type': 'application/json' }})
