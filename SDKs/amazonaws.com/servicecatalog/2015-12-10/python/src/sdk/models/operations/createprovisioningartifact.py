...
class CreateProvisioningArtifactHeaders:
    x_amz_target: CreateProvisioningArtifactXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateProvisioningArtifactRequest:
    headers: CreateProvisioningArtifactHeaders = field()
    request: shared.CreateProvisioningArtifactInput = field(metadata={'request': { 'media_type': 'application/json' }})
