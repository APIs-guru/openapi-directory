...
class ListRecordHistoryHeaders:
    x_amz_target: ListRecordHistoryXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListRecordHistoryRequest:
    headers: ListRecordHistoryHeaders = field()
    request: shared.ListRecordHistoryInput = field(metadata={'request': { 'media_type': 'application/json' }})
