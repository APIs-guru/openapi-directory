...
class DescribeCopyProductStatusHeaders:
    x_amz_target: DescribeCopyProductStatusXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeCopyProductStatusRequest:
    headers: DescribeCopyProductStatusHeaders = field()
    request: shared.DescribeCopyProductStatusInput = field(metadata={'request': { 'media_type': 'application/json' }})
