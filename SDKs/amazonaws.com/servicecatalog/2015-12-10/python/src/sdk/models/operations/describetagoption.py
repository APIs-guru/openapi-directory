...
class DescribeTagOptionHeaders:
    ...
    x_amz_target: DescribeTagOptionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeTagOptionRequest:
    headers: DescribeTagOptionHeaders = field(default=None)
    request: shared.DescribeTagOptionInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
