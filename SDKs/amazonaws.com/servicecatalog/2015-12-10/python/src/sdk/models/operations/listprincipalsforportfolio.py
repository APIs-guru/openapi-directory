...
class ListPrincipalsForPortfolioHeaders:
    x_amz_target: ListPrincipalsForPortfolioXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListPrincipalsForPortfolioRequest:
    headers: ListPrincipalsForPortfolioHeaders = field()
    query_params: ListPrincipalsForPortfolioQueryParams = field()
    request: shared.ListPrincipalsForPortfolioInput = field(metadata={'request': { 'media_type': 'application/json' }})
