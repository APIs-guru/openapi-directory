...
class ListPrincipalsForPortfolioHeaders:
    ...
    x_amz_target: ListPrincipalsForPortfolioXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ListPrincipalsForPortfolioRequest:
    query_params: ListPrincipalsForPortfolioQueryParams = field(default=None)
    headers: ListPrincipalsForPortfolioHeaders = field(default=None)
    request: shared.ListPrincipalsForPortfolioInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class ListPrincipalsForPortfolioResponse:
    ...
    list_principals_for_portfolio_output: Optional[shared.ListPrincipalsForPortfolioOutput] = field(default=None)
