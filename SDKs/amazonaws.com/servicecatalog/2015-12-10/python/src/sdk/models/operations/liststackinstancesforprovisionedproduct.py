...
class ListStackInstancesForProvisionedProductHeaders:
    x_amz_target: ListStackInstancesForProvisionedProductXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListStackInstancesForProvisionedProductRequest:
    headers: ListStackInstancesForProvisionedProductHeaders = field()
    request: shared.ListStackInstancesForProvisionedProductInput = field(metadata={'request': { 'media_type': 'application/json' }})
