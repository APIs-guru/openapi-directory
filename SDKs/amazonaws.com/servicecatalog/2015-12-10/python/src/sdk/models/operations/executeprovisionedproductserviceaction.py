...
class ExecuteProvisionedProductServiceActionHeaders:
    ...
    x_amz_target: ExecuteProvisionedProductServiceActionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
