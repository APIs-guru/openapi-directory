...
class ExecuteProvisionedProductServiceActionHeaders:
    x_amz_target: ExecuteProvisionedProductServiceActionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ExecuteProvisionedProductServiceActionRequest:
    headers: ExecuteProvisionedProductServiceActionHeaders = field()
    request: shared.ExecuteProvisionedProductServiceActionInput = field(metadata={'request': { 'media_type': 'application/json' }})
