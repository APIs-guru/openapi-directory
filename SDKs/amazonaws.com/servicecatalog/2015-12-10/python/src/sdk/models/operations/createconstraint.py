...
class CreateConstraintHeaders:
    x_amz_target: CreateConstraintXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateConstraintRequest:
    headers: CreateConstraintHeaders = field()
    request: shared.CreateConstraintInput = field(metadata={'request': { 'media_type': 'application/json' }})
