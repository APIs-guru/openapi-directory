...
class GetAwsOrganizationsAccessStatusHeaders:
    x_amz_target: GetAwsOrganizationsAccessStatusXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetAwsOrganizationsAccessStatusRequest:
    headers: GetAwsOrganizationsAccessStatusHeaders = field()
