...
class ListLaunchPathsHeaders:
    x_amz_target: ListLaunchPathsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListLaunchPathsRequest:
    headers: ListLaunchPathsHeaders = field()
    query_params: ListLaunchPathsQueryParams = field()
    request: shared.ListLaunchPathsInput = field(metadata={'request': { 'media_type': 'application/json' }})
