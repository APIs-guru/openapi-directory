...
class UpdateProvisionedProductPropertiesHeaders:
    x_amz_target: UpdateProvisionedProductPropertiesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateProvisionedProductPropertiesRequest:
    headers: UpdateProvisionedProductPropertiesHeaders = field()
    request: shared.UpdateProvisionedProductPropertiesInput = field(metadata={'request': { 'media_type': 'application/json' }})
