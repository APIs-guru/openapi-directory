...
class SearchProvisionedProductsHeaders:
    x_amz_target: SearchProvisionedProductsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class SearchProvisionedProductsRequest:
    headers: SearchProvisionedProductsHeaders = field()
    query_params: SearchProvisionedProductsQueryParams = field()
    request: shared.SearchProvisionedProductsInput = field(metadata={'request': { 'media_type': 'application/json' }})
