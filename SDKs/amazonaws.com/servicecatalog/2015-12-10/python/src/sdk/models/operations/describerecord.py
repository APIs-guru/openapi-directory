...
class DescribeRecordHeaders:
    x_amz_target: DescribeRecordXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeRecordRequest:
    headers: DescribeRecordHeaders = field()
    request: shared.DescribeRecordInput = field(metadata={'request': { 'media_type': 'application/json' }})
