...
class DescribePortfolioSharesHeaders:
    x_amz_target: DescribePortfolioSharesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribePortfolioSharesRequest:
    headers: DescribePortfolioSharesHeaders = field()
    query_params: DescribePortfolioSharesQueryParams = field()
    request: shared.DescribePortfolioSharesInput = field(metadata={'request': { 'media_type': 'application/json' }})
