...
class ListServiceActionsForProvisioningArtifactHeaders:
    x_amz_target: ListServiceActionsForProvisioningArtifactXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListServiceActionsForProvisioningArtifactRequest:
    headers: ListServiceActionsForProvisioningArtifactHeaders = field()
    query_params: ListServiceActionsForProvisioningArtifactQueryParams = field()
    request: shared.ListServiceActionsForProvisioningArtifactInput = field(metadata={'request': { 'media_type': 'application/json' }})
