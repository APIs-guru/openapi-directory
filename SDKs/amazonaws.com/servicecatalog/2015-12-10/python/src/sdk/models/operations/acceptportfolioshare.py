...
class AcceptPortfolioShareHeaders:
    x_amz_target: AcceptPortfolioShareXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AcceptPortfolioShareRequest:
    headers: AcceptPortfolioShareHeaders = field()
    request: shared.AcceptPortfolioShareInput = field(metadata={'request': { 'media_type': 'application/json' }})
