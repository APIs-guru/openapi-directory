...
class ListProvisioningArtifactsHeaders:
    ...
    x_amz_target: ListProvisioningArtifactsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ListProvisioningArtifactsRequest:
    headers: ListProvisioningArtifactsHeaders = field(default=None)
    request: shared.ListProvisioningArtifactsInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
