...
class RejectPortfolioShareHeaders:
    x_amz_target: RejectPortfolioShareXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RejectPortfolioShareRequest:
    headers: RejectPortfolioShareHeaders = field()
    request: shared.RejectPortfolioShareInput = field(metadata={'request': { 'media_type': 'application/json' }})
