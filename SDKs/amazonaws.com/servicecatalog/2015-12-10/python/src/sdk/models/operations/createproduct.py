...
class CreateProductHeaders:
    x_amz_target: CreateProductXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateProductRequest:
    headers: CreateProductHeaders = field()
    request: shared.CreateProductInput = field(metadata={'request': { 'media_type': 'application/json' }})
