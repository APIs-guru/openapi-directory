...
class UpdatePortfolioHeaders:
    x_amz_target: UpdatePortfolioXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdatePortfolioRequest:
    headers: UpdatePortfolioHeaders = field()
    request: shared.UpdatePortfolioInput = field(metadata={'request': { 'media_type': 'application/json' }})
