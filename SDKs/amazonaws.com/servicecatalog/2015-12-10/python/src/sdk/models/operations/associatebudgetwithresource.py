...
class AssociateBudgetWithResourceHeaders:
    ...
    x_amz_target: AssociateBudgetWithResourceXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class AssociateBudgetWithResourceRequest:
    headers: AssociateBudgetWithResourceHeaders = field(default=None)
    request: shared.AssociateBudgetWithResourceInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class AssociateBudgetWithResourceResponse:
    associate_budget_with_resource_output: Optional[dict[str, Any]] = field(default=None)
