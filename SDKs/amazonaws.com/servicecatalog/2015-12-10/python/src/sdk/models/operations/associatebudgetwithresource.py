...
class AssociateBudgetWithResourceHeaders:
    x_amz_target: AssociateBudgetWithResourceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AssociateBudgetWithResourceRequest:
    headers: AssociateBudgetWithResourceHeaders = field()
    request: shared.AssociateBudgetWithResourceInput = field(metadata={'request': { 'media_type': 'application/json' }})
