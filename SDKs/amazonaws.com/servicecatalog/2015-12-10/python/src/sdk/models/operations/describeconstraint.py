...
class DescribeConstraintHeaders:
    x_amz_target: DescribeConstraintXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeConstraintRequest:
    headers: DescribeConstraintHeaders = field()
    request: shared.DescribeConstraintInput = field(metadata={'request': { 'media_type': 'application/json' }})
