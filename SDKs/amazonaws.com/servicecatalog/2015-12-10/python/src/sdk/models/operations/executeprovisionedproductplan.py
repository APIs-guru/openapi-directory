...
class ExecuteProvisionedProductPlanHeaders:
    x_amz_target: ExecuteProvisionedProductPlanXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ExecuteProvisionedProductPlanRequest:
    headers: ExecuteProvisionedProductPlanHeaders = field()
    request: shared.ExecuteProvisionedProductPlanInput = field(metadata={'request': { 'media_type': 'application/json' }})
