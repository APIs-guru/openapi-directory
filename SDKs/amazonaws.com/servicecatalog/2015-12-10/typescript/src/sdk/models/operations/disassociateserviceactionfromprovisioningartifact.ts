...
export enum DisassociateServiceActionFromProvisioningArtifactXAmzTargetEnum {
...
export class DisassociateServiceActionFromProvisioningArtifactHeaders extends SpeakeasyBase {
...
export class DisassociateServiceActionFromProvisioningArtifactRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class DisassociateServiceActionFromProvisioningArtifactResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
