...
class UpdateVirtualServiceRequestBody:
    spec: UpdateVirtualServiceRequestBodySpec = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('spec') }})
    client_token: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('clientToken') }})
    

@dataclass
class UpdateVirtualServiceRequest:
    headers: UpdateVirtualServiceHeaders = field()
    path_params: UpdateVirtualServicePathParams = field()
    query_params: UpdateVirtualServiceQueryParams = field()
    request: UpdateVirtualServiceRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
