...
class DeleteGatewayRouteRequest:
    path_params: DeleteGatewayRoutePathParams = field(default=None)
    query_params: DeleteGatewayRouteQueryParams = field(default=None)
    headers: DeleteGatewayRouteHeaders = field(default=None)
...
class DeleteGatewayRouteResponse:
    ...
    delete_gateway_route_output: Optional[shared.DeleteGatewayRouteOutput] = field(default=None)
