...
class DescribeVirtualRouterRequest:
    path_params: DescribeVirtualRouterPathParams = field(default=None)
    query_params: DescribeVirtualRouterQueryParams = field(default=None)
    headers: DescribeVirtualRouterHeaders = field(default=None)
