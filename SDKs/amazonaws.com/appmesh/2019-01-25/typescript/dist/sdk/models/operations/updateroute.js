...
var UpdateRouteQueryParams = /** @class */ (function (_super) {
    __extends(UpdateRouteQueryParams, _super);
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], UpdateRouteQueryParams.prototype, "meshOwner", void 0);
    return UpdateRouteQueryParams;
}(SpeakeasyBase));
export { UpdateRouteQueryParams };
...
var UpdateRouteRequestBodySpec = /** @class */ (function (_super) {
    ...
    ], UpdateRouteRequestBodySpec.prototype, "grpcRoute", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=http2Route" }),
        __metadata("design:type", shared.HttpRoute)
    ], UpdateRouteRequestBodySpec.prototype, "http2Route", void 0);
    __decorate([
    ...
    ], UpdateRouteRequestBodySpec.prototype, "priority", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=tcpRoute" }),
        __metadata("design:type", shared.TcpRoute)
    ], UpdateRouteRequestBodySpec.prototype, "tcpRoute", void 0);
...
var UpdateRouteRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", UpdateRouteQueryParams)
    ], UpdateRouteRequest.prototype, "queryParams", void 0);
    __decorate([
        SpeakeasyMetadata(),
