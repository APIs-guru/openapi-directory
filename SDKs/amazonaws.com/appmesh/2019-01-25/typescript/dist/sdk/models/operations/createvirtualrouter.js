...
var CreateVirtualRouterQueryParams = /** @class */ (function (_super) {
    __extends(CreateVirtualRouterQueryParams, _super);
    function CreateVirtualRouterQueryParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=meshOwner" }),
        __metadata("design:type", String)
    ], CreateVirtualRouterQueryParams.prototype, "meshOwner", void 0);
    return CreateVirtualRouterQueryParams;
}(SpeakeasyBase));
export { CreateVirtualRouterQueryParams };
...
var CreateVirtualRouterRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", CreateVirtualRouterQueryParams)
    ], CreateVirtualRouterRequest.prototype, "queryParams", void 0);
    __decorate([
        SpeakeasyMetadata(),
