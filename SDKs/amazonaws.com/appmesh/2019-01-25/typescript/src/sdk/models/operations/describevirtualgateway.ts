...
export class DescribeVirtualGatewayPathParams extends SpeakeasyBase {
...
export class DescribeVirtualGatewayQueryParams extends SpeakeasyBase {
  @Metadata({ data: "queryParam, style=form;explode=true;name=meshOwner" })
  meshOwner?: string;
}


export class DescribeVirtualGatewayHeaders extends SpeakeasyBase {
