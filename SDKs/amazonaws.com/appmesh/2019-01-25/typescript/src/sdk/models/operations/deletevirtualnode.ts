...
export class DeleteVirtualNodePathParams extends SpeakeasyBase {
...
export class DeleteVirtualNodeQueryParams extends SpeakeasyBase {
  @Metadata({ data: "queryParam, style=form;explode=true;name=meshOwner" })
  meshOwner?: string;
}


export class DeleteVirtualNodeHeaders extends SpeakeasyBase {
