...
export class ListVirtualGatewaysPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=meshName" })
  meshName: string;
}


export class ListVirtualGatewaysQueryParams extends SpeakeasyBase {
...
export class ListVirtualGatewaysHeaders extends SpeakeasyBase {
