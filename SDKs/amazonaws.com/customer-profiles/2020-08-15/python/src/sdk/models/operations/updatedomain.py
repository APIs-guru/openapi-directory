...
class UpdateDomainRequestBody:
    ...
    matching: Optional[UpdateDomainRequestBodyMatching] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Matching') }})
    tags: Optional[dict[str, str]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Tags') }})
    

@dataclass
class UpdateDomainRequest:
    headers: UpdateDomainHeaders = field()
    path_params: UpdateDomainPathParams = field()
    request: UpdateDomainRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
