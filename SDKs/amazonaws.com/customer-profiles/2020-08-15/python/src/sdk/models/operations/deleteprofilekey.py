...
class DeleteProfileKeyRequest:
    headers: DeleteProfileKeyHeaders = field()
    path_params: DeleteProfileKeyPathParams = field()
    request: DeleteProfileKeyRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
