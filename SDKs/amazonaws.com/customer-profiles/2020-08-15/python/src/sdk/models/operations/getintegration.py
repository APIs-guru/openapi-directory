...
class GetIntegrationRequest:
    path_params: GetIntegrationPathParams = field(default=None)
    headers: GetIntegrationHeaders = field(default=None)
    request: GetIntegrationRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
