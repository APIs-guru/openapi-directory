...
class CreateDomainRequestBody:
    default_expiration_days: int = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('DefaultExpirationDays') }})
    ...
    matching: Optional[CreateDomainRequestBodyMatching] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Matching') }})
...
class CreateDomainRequest:
    ...
    path_params: CreateDomainPathParams = field()
    request: CreateDomainRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
