...
class AddProfileKeyRequest:
    path_params: AddProfileKeyPathParams = field(default=None)
    headers: AddProfileKeyHeaders = field(default=None)
    request: AddProfileKeyRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
