...
class DescribeDestinationsHeaders:
    x_amz_target: DescribeDestinationsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeDestinationsRequest:
    headers: DescribeDestinationsHeaders = field()
    query_params: DescribeDestinationsQueryParams = field()
    request: shared.DescribeDestinationsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
