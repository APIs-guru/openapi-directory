...
class PutDestinationPolicyHeaders:
    x_amz_target: PutDestinationPolicyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutDestinationPolicyRequest:
    headers: PutDestinationPolicyHeaders = field()
    request: shared.PutDestinationPolicyRequest = field(metadata={'request': { 'media_type': 'application/json' }})
