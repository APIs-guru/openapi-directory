...
class DeleteLogStreamHeaders:
    x_amz_target: DeleteLogStreamXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteLogStreamRequest:
    headers: DeleteLogStreamHeaders = field()
    request: shared.DeleteLogStreamRequest = field(metadata={'request': { 'media_type': 'application/json' }})
