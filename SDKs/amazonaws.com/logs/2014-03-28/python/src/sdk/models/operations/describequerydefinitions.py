...
class DescribeQueryDefinitionsHeaders:
    x_amz_target: DescribeQueryDefinitionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeQueryDefinitionsRequest:
    headers: DescribeQueryDefinitionsHeaders = field()
    request: shared.DescribeQueryDefinitionsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
