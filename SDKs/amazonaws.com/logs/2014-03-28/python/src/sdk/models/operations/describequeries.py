...
class DescribeQueriesHeaders:
    x_amz_target: DescribeQueriesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeQueriesRequest:
    headers: DescribeQueriesHeaders = field()
    request: shared.DescribeQueriesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
