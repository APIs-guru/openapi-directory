...
class PutLogEventsHeaders:
    x_amz_target: PutLogEventsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutLogEventsRequest:
    headers: PutLogEventsHeaders = field()
    request: shared.PutLogEventsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
