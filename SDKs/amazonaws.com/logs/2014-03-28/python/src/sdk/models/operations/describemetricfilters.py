...
class DescribeMetricFiltersHeaders:
    x_amz_target: DescribeMetricFiltersXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeMetricFiltersRequest:
    headers: DescribeMetricFiltersHeaders = field()
    query_params: DescribeMetricFiltersQueryParams = field()
    request: shared.DescribeMetricFiltersRequest = field(metadata={'request': { 'media_type': 'application/json' }})
