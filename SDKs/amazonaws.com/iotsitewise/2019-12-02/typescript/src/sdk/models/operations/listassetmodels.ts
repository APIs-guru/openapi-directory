...
export class ListAssetModelsQueryParams extends SpeakeasyBase {
...
export class ListAssetModelsHeaders extends SpeakeasyBase {
...
export class ListAssetModelsRequest extends SpeakeasyBase {
  @Metadata()
