...
export class DescribeAccessPolicyPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=accessPolicyId" })
  accessPolicyId: string;
}


export class DescribeAccessPolicyHeaders extends SpeakeasyBase {
...
export class DescribeAccessPolicyRequest extends SpeakeasyBase {
  @Metadata()
