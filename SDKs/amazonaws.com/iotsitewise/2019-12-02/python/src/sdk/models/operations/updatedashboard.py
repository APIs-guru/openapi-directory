...
class UpdateDashboardRequest:
    headers: UpdateDashboardHeaders = field()
    path_params: UpdateDashboardPathParams = field()
    request: UpdateDashboardRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
