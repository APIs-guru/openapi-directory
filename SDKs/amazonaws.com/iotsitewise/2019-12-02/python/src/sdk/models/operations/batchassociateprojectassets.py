...
class BatchAssociateProjectAssetsRequest:
    headers: BatchAssociateProjectAssetsHeaders = field()
    path_params: BatchAssociateProjectAssetsPathParams = field()
    request: BatchAssociateProjectAssetsRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
