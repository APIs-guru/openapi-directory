...
class GetAssetPropertyAggregatesQueryParams:
    aggregate_types: List[shared.AggregateTypeEnum] = field(default=None, metadata={'query_param': { 'field_name': 'aggregateTypes', 'style': 'form', 'explode': True }})
    ...
    resolution: str = field(default=None, metadata={'query_param': { 'field_name': 'resolution', 'style': 'form', 'explode': True }})
...
class GetAssetPropertyAggregatesRequest:
    query_params: GetAssetPropertyAggregatesQueryParams = field(default=None)
    headers: GetAssetPropertyAggregatesHeaders = field(default=None)
