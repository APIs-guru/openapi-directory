...
class GatewaySummary:
    ...
    gateway_capability_summaries: Optional[List[gatewaycapabilitysummary.GatewayCapabilitySummary]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'gatewayCapabilitySummaries' }})
