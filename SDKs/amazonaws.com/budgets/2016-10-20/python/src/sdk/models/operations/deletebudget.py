...
class DeleteBudgetHeaders:
    x_amz_target: DeleteBudgetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteBudgetRequest:
    headers: DeleteBudgetHeaders = field()
    request: shared.DeleteBudgetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
