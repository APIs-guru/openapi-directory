...
class DescribeBudgetActionHeaders:
    x_amz_target: DescribeBudgetActionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeBudgetActionRequest:
    headers: DescribeBudgetActionHeaders = field()
    request: shared.DescribeBudgetActionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
