...
class CreateBudgetActionHeaders:
    x_amz_target: CreateBudgetActionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateBudgetActionRequest:
    headers: CreateBudgetActionHeaders = field()
    request: shared.CreateBudgetActionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
