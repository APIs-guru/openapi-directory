...
class UpdateNotificationHeaders:
    x_amz_target: UpdateNotificationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateNotificationRequest:
    headers: UpdateNotificationHeaders = field()
    request: shared.UpdateNotificationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
