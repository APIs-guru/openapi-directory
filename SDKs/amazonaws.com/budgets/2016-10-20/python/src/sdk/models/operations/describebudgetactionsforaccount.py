...
class DescribeBudgetActionsForAccountHeaders:
    ...
    x_amz_target: DescribeBudgetActionsForAccountXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeBudgetActionsForAccountRequest:
    query_params: DescribeBudgetActionsForAccountQueryParams = field(default=None)
    headers: DescribeBudgetActionsForAccountHeaders = field(default=None)
    request: shared.DescribeBudgetActionsForAccountRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
