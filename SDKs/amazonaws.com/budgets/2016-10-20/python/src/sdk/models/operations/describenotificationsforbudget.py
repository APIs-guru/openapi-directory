...
class DescribeNotificationsForBudgetHeaders:
    x_amz_target: DescribeNotificationsForBudgetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeNotificationsForBudgetRequest:
    headers: DescribeNotificationsForBudgetHeaders = field()
    query_params: DescribeNotificationsForBudgetQueryParams = field()
    request: shared.DescribeNotificationsForBudgetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
