...
class DeleteBudgetActionHeaders:
    x_amz_target: DeleteBudgetActionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteBudgetActionRequest:
    headers: DeleteBudgetActionHeaders = field()
    request: shared.DeleteBudgetActionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
