...
class UpdateBudgetHeaders:
    x_amz_target: UpdateBudgetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateBudgetRequest:
    headers: UpdateBudgetHeaders = field()
    request: shared.UpdateBudgetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
