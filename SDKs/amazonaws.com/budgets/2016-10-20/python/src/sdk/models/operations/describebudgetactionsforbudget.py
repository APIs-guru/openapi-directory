...
class DescribeBudgetActionsForBudgetHeaders:
    x_amz_target: DescribeBudgetActionsForBudgetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeBudgetActionsForBudgetRequest:
    headers: DescribeBudgetActionsForBudgetHeaders = field()
    query_params: DescribeBudgetActionsForBudgetQueryParams = field()
    request: shared.DescribeBudgetActionsForBudgetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
