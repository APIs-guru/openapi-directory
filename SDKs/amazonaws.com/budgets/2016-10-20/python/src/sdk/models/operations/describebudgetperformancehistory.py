...
class DescribeBudgetPerformanceHistoryHeaders:
    ...
    x_amz_target: DescribeBudgetPerformanceHistoryXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeBudgetPerformanceHistoryRequest:
    query_params: DescribeBudgetPerformanceHistoryQueryParams = field(default=None)
    headers: DescribeBudgetPerformanceHistoryHeaders = field(default=None)
    request: shared.DescribeBudgetPerformanceHistoryRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
