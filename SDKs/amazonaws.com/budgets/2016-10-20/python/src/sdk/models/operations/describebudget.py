...
class DescribeBudgetHeaders:
    x_amz_target: DescribeBudgetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeBudgetRequest:
    headers: DescribeBudgetHeaders = field()
    request: shared.DescribeBudgetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
