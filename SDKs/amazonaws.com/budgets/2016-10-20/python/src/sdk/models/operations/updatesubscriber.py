...
class UpdateSubscriberHeaders:
    x_amz_target: UpdateSubscriberXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateSubscriberRequest:
    headers: UpdateSubscriberHeaders = field()
    request: shared.UpdateSubscriberRequest = field(metadata={'request': { 'media_type': 'application/json' }})
