...
var ActionHistory = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", ActionHistoryDetails)
    ], ActionHistory.prototype, "actionHistoryDetails", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=EventType" }),
        __metadata("design:type", String)
    ], ActionHistory.prototype, "eventType", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Status" }),
        __metadata("design:type", String)
    ], ActionHistory.prototype, "status", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Timestamp" }),
        __metadata("design:type", Date)
    ], ActionHistory.prototype, "timestamp", void 0);
