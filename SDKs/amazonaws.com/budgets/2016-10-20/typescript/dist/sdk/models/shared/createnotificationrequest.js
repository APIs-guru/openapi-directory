...
var CreateNotificationRequest = /** @class */ (function (_super) {
    ...
    ], CreateNotificationRequest.prototype, "accountId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=BudgetName" }),
        __metadata("design:type", String)
    ], CreateNotificationRequest.prototype, "budgetName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Notification" }),
        __metadata("design:type", Notification)
    ], CreateNotificationRequest.prototype, "notification", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Subscribers", elemType: Subscriber }),
        __metadata("design:type", Array)
    ], CreateNotificationRequest.prototype, "subscribers", void 0);
