...
class DescribeKeyHeaders:
    x_amz_target: DescribeKeyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeKeyRequest:
    headers: DescribeKeyHeaders = field()
    request: shared.DescribeKeyRequest = field(metadata={'request': { 'media_type': 'application/json' }})
