...
class ListRetirableGrantsHeaders:
    x_amz_target: ListRetirableGrantsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListRetirableGrantsRequest:
    headers: ListRetirableGrantsHeaders = field()
    request: shared.ListRetirableGrantsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
