...
class GenerateDataKeyPairHeaders:
    x_amz_target: GenerateDataKeyPairXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GenerateDataKeyPairRequest:
    headers: GenerateDataKeyPairHeaders = field()
    request: shared.GenerateDataKeyPairRequest = field(metadata={'request': { 'media_type': 'application/json' }})
