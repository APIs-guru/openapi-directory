...
class ListResourceTagsHeaders:
    x_amz_target: ListResourceTagsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListResourceTagsRequest:
    headers: ListResourceTagsHeaders = field()
    request: shared.ListResourceTagsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
