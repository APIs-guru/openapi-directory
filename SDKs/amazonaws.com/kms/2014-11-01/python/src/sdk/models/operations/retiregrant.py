...
class RetireGrantHeaders:
    x_amz_target: RetireGrantXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RetireGrantRequest:
    headers: RetireGrantHeaders = field()
    request: shared.RetireGrantRequest = field(metadata={'request': { 'media_type': 'application/json' }})
