...
class PutKeyPolicyHeaders:
    ...
    x_amz_target: PutKeyPolicyXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class PutKeyPolicyRequest:
    headers: PutKeyPolicyHeaders = field(default=None)
    request: shared.PutKeyPolicyRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
