...
class GenerateRandomHeaders:
    ...
    x_amz_target: GenerateRandomXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GenerateRandomRequest:
    headers: GenerateRandomHeaders = field(default=None)
    request: shared.GenerateRandomRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
