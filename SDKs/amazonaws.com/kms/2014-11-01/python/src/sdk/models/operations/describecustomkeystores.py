...
class DescribeCustomKeyStoresHeaders:
    x_amz_target: DescribeCustomKeyStoresXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeCustomKeyStoresRequest:
    headers: DescribeCustomKeyStoresHeaders = field()
    request: shared.DescribeCustomKeyStoresRequest = field(metadata={'request': { 'media_type': 'application/json' }})
