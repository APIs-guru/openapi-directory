...
class DisableKeyRotationHeaders:
    x_amz_target: DisableKeyRotationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DisableKeyRotationRequest:
    headers: DisableKeyRotationHeaders = field()
    request: shared.DisableKeyRotationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
