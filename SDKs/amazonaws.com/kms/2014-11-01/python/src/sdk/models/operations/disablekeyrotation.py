...
class DisableKeyRotationHeaders:
    ...
    x_amz_target: DisableKeyRotationXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DisableKeyRotationRequest:
    headers: DisableKeyRotationHeaders = field(default=None)
    request: shared.DisableKeyRotationRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
