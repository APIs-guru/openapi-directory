...
class ConnectCustomKeyStoreHeaders:
    x_amz_target: ConnectCustomKeyStoreXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ConnectCustomKeyStoreRequest:
    headers: ConnectCustomKeyStoreHeaders = field()
    request: shared.ConnectCustomKeyStoreRequest = field(metadata={'request': { 'media_type': 'application/json' }})
