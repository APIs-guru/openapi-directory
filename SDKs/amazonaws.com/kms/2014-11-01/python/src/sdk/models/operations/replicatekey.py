...
class ReplicateKeyHeaders:
    ...
    x_amz_target: ReplicateKeyXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ReplicateKeyRequest:
    headers: ReplicateKeyHeaders = field(default=None)
    request: shared.ReplicateKeyRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
