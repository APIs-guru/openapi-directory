...
class SignHeaders:
    ...
    x_amz_target: SignXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class SignRequest:
    headers: SignHeaders = field(default=None)
    request: shared.SignRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class SignResponse:
    ...
    sign_response: Optional[shared.SignResponse] = field(default=None)
