...
@dataclass
class SignHeaders:
    x_amz_target: SignXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
@dataclass
class SignRequest:
    headers: SignHeaders = field()
    request: shared.SignRequest = field(metadata={'request': { 'media_type': 'application/json' }})
