...
class ReEncryptHeaders:
    x_amz_target: ReEncryptXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ReEncryptRequest:
    headers: ReEncryptHeaders = field()
    request: shared.ReEncryptRequest = field(metadata={'request': { 'media_type': 'application/json' }})
