...
class ListKeyPoliciesHeaders:
    x_amz_target: ListKeyPoliciesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListKeyPoliciesRequest:
    headers: ListKeyPoliciesHeaders = field()
    query_params: ListKeyPoliciesQueryParams = field()
    request: shared.ListKeyPoliciesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
