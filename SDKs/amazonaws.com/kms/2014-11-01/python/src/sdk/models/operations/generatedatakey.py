...
class GenerateDataKeyHeaders:
    x_amz_target: GenerateDataKeyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GenerateDataKeyRequest:
    headers: GenerateDataKeyHeaders = field()
    request: shared.GenerateDataKeyRequest = field(metadata={'request': { 'media_type': 'application/json' }})
