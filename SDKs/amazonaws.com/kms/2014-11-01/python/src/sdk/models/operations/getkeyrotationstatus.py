...
class GetKeyRotationStatusHeaders:
    ...
    x_amz_target: GetKeyRotationStatusXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetKeyRotationStatusRequest:
    headers: GetKeyRotationStatusHeaders = field(default=None)
    request: shared.GetKeyRotationStatusRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class GetKeyRotationStatusResponse:
    ...
    get_key_rotation_status_response: Optional[shared.GetKeyRotationStatusResponse] = field(default=None)
