...
class GetKeyRotationStatusHeaders:
    x_amz_target: GetKeyRotationStatusXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetKeyRotationStatusRequest:
    headers: GetKeyRotationStatusHeaders = field()
    request: shared.GetKeyRotationStatusRequest = field(metadata={'request': { 'media_type': 'application/json' }})
