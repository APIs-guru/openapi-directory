...
class UpdatePrimaryRegionHeaders:
    ...
    x_amz_target: UpdatePrimaryRegionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdatePrimaryRegionRequest:
    headers: UpdatePrimaryRegionHeaders = field(default=None)
    request: shared.UpdatePrimaryRegionRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
