...
class UpdateAliasHeaders:
    x_amz_target: UpdateAliasXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateAliasRequest:
    headers: UpdateAliasHeaders = field()
    request: shared.UpdateAliasRequest = field(metadata={'request': { 'media_type': 'application/json' }})
