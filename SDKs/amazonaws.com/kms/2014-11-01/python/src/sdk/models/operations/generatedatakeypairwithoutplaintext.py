...
class GenerateDataKeyPairWithoutPlaintextHeaders:
    ...
    x_amz_target: GenerateDataKeyPairWithoutPlaintextXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GenerateDataKeyPairWithoutPlaintextRequest:
    headers: GenerateDataKeyPairWithoutPlaintextHeaders = field(default=None)
    request: shared.GenerateDataKeyPairWithoutPlaintextRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
