...
@dataclass
class VerifyHeaders:
    x_amz_target: VerifyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
@dataclass
class VerifyRequest:
    headers: VerifyHeaders = field()
    request: shared.VerifyRequest = field(metadata={'request': { 'media_type': 'application/json' }})
