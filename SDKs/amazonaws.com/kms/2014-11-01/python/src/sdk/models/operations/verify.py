...
class VerifyHeaders:
    ...
    x_amz_target: VerifyXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class VerifyRequest:
    headers: VerifyHeaders = field(default=None)
    request: shared.VerifyRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class VerifyResponse:
    ...
    kms_invalid_signature_exception: Optional[Any] = field(default=None)
    ...
    verify_response: Optional[shared.VerifyResponse] = field(default=None)
