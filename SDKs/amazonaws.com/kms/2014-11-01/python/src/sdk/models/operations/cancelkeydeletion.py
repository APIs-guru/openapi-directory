...
class CancelKeyDeletionHeaders:
    ...
    x_amz_target: CancelKeyDeletionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CancelKeyDeletionRequest:
    headers: CancelKeyDeletionHeaders = field(default=None)
    request: shared.CancelKeyDeletionRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
