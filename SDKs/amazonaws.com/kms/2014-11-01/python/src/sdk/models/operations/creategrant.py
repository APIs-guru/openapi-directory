...
class CreateGrantHeaders:
    x_amz_target: CreateGrantXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateGrantRequest:
    headers: CreateGrantHeaders = field()
    request: shared.CreateGrantRequest = field(metadata={'request': { 'media_type': 'application/json' }})
