...
class ListGrantsHeaders:
    x_amz_target: ListGrantsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListGrantsRequest:
    headers: ListGrantsHeaders = field()
    query_params: ListGrantsQueryParams = field()
    request: shared.ListGrantsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
