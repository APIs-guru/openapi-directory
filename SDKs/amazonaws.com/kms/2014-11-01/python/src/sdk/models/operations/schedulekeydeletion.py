...
class ScheduleKeyDeletionHeaders:
    x_amz_target: ScheduleKeyDeletionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ScheduleKeyDeletionRequest:
    headers: ScheduleKeyDeletionHeaders = field()
    request: shared.ScheduleKeyDeletionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
