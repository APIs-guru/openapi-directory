...
class DeleteCustomKeyStoreHeaders:
    ...
    x_amz_target: DeleteCustomKeyStoreXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeleteCustomKeyStoreRequest:
    headers: DeleteCustomKeyStoreHeaders = field(default=None)
    request: shared.DeleteCustomKeyStoreRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
