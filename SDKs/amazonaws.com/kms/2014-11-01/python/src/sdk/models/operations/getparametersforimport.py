...
class GetParametersForImportHeaders:
    x_amz_target: GetParametersForImportXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetParametersForImportRequest:
    headers: GetParametersForImportHeaders = field()
    request: shared.GetParametersForImportRequest = field(metadata={'request': { 'media_type': 'application/json' }})
