...
class DisableKeyHeaders:
    x_amz_target: DisableKeyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DisableKeyRequest:
    headers: DisableKeyHeaders = field()
    request: shared.DisableKeyRequest = field(metadata={'request': { 'media_type': 'application/json' }})
