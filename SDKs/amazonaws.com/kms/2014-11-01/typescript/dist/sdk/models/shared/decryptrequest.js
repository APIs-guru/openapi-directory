...
var DecryptRequest = /** @class */ (function (_super) {
    ...
    ], DecryptRequest.prototype, "ciphertextBlob", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=EncryptionAlgorithm" }),
        __metadata("design:type", String)
    ], DecryptRequest.prototype, "encryptionAlgorithm", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=EncryptionContext" }),
        __metadata("design:type", Map)
    ], DecryptRequest.prototype, "encryptionContext", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=GrantTokens" }),
        __metadata("design:type", Array)
    ], DecryptRequest.prototype, "grantTokens", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=KeyId" }),
        __metadata("design:type", String)
    ], DecryptRequest.prototype, "keyId", void 0);
