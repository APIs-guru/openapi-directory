...
class GenerateChangeSetHeaders:
    x_amz_target: GenerateChangeSetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GenerateChangeSetRequest:
    headers: GenerateChangeSetHeaders = field()
    request: shared.GenerateChangeSetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
