...
class UpdateAppHeaders:
    ...
    x_amz_target: UpdateAppXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateAppRequest:
    headers: UpdateAppHeaders = field(default=None)
    request: shared.UpdateAppRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateAppResponse:
    ...
    update_app_response: Optional[shared.UpdateAppResponse] = field(default=None)
