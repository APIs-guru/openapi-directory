...
class UpdateAppHeaders:
    x_amz_target: UpdateAppXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateAppRequest:
    ...
    request: shared.UpdateAppRequest = field(metadata={'request': { 'media_type': 'application/json' }})
