...
class GetConnectorsHeaders:
    x_amz_target: GetConnectorsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetConnectorsRequest:
    headers: GetConnectorsHeaders = field()
    query_params: GetConnectorsQueryParams = field()
    request: shared.GetConnectorsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
