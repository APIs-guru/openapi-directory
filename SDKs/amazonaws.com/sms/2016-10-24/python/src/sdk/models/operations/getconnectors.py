...
class GetConnectorsHeaders:
    ...
    x_amz_target: GetConnectorsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetConnectorsRequest:
    query_params: GetConnectorsQueryParams = field(default=None)
    headers: GetConnectorsHeaders = field(default=None)
    request: shared.GetConnectorsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
