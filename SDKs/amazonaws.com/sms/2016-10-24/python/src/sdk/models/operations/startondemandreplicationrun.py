...
class StartOnDemandReplicationRunHeaders:
    x_amz_target: StartOnDemandReplicationRunXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartOnDemandReplicationRunRequest:
    headers: StartOnDemandReplicationRunHeaders = field()
    request: shared.StartOnDemandReplicationRunRequest = field(metadata={'request': { 'media_type': 'application/json' }})
