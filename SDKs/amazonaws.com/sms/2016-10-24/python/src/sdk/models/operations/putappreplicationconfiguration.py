...
class PutAppReplicationConfigurationHeaders:
    x_amz_target: PutAppReplicationConfigurationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutAppReplicationConfigurationRequest:
    headers: PutAppReplicationConfigurationHeaders = field()
    request: shared.PutAppReplicationConfigurationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
