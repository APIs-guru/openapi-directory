...
class GetAppReplicationConfigurationHeaders:
    ...
    x_amz_target: GetAppReplicationConfigurationXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetAppReplicationConfigurationRequest:
    headers: GetAppReplicationConfigurationHeaders = field(default=None)
    request: shared.GetAppReplicationConfigurationRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
