...
class DeleteReplicationJobHeaders:
    ...
    x_amz_target: DeleteReplicationJobXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeleteReplicationJobRequest:
    headers: DeleteReplicationJobHeaders = field(default=None)
    request: shared.DeleteReplicationJobRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class DeleteReplicationJobResponse:
    content_type: str = field(default=None)
    delete_replication_job_response: Optional[dict[str, Any]] = field(default=None)
