...
class DeleteReplicationJobHeaders:
    x_amz_target: DeleteReplicationJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteReplicationJobRequest:
    headers: DeleteReplicationJobHeaders = field()
    request: shared.DeleteReplicationJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
