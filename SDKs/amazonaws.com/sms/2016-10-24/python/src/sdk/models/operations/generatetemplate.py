...
class GenerateTemplateHeaders:
    ...
    x_amz_target: GenerateTemplateXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GenerateTemplateRequest:
    headers: GenerateTemplateHeaders = field(default=None)
    request: shared.GenerateTemplateRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
