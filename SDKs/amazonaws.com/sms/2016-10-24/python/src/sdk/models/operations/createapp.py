...
class CreateAppHeaders:
    x_amz_target: CreateAppXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateAppRequest:
    ...
    request: shared.CreateAppRequest = field(metadata={'request': { 'media_type': 'application/json' }})
