...
class TerminateAppHeaders:
    ...
    x_amz_target: TerminateAppXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class TerminateAppRequest:
    headers: TerminateAppHeaders = field(default=None)
    request: shared.TerminateAppRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class TerminateAppResponse:
    ...
    terminate_app_response: Optional[dict[str, Any]] = field(default=None)
