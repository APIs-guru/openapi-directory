...
class TerminateAppHeaders:
    x_amz_target: TerminateAppXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class TerminateAppRequest:
    headers: TerminateAppHeaders = field()
    request: shared.TerminateAppRequest = field(metadata={'request': { 'media_type': 'application/json' }})
