...
class ImportAppCatalogHeaders:
    x_amz_target: ImportAppCatalogXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ImportAppCatalogRequest:
    headers: ImportAppCatalogHeaders = field()
    request: shared.ImportAppCatalogRequest = field(metadata={'request': { 'media_type': 'application/json' }})
