...
class UpdateReplicationJobHeaders:
    x_amz_target: UpdateReplicationJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateReplicationJobRequest:
    headers: UpdateReplicationJobHeaders = field()
    request: shared.UpdateReplicationJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
