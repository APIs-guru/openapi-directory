...
@dataclass
class GetAppHeaders:
    x_amz_target: GetAppXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetAppRequest:
    ...
    request: shared.GetAppRequest = field(metadata={'request': { 'media_type': 'application/json' }})
