...
class LaunchAppHeaders:
    x_amz_target: LaunchAppXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class LaunchAppRequest:
    headers: LaunchAppHeaders = field()
    request: shared.LaunchAppRequest = field(metadata={'request': { 'media_type': 'application/json' }})
