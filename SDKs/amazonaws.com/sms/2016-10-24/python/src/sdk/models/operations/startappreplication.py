...
class StartAppReplicationHeaders:
    ...
    x_amz_target: StartAppReplicationXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class StartAppReplicationRequest:
    headers: StartAppReplicationHeaders = field(default=None)
    request: shared.StartAppReplicationRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class StartAppReplicationResponse:
    ...
    start_app_replication_response: Optional[dict[str, Any]] = field(default=None)
