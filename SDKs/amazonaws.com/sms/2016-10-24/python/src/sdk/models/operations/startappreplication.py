...
class StartAppReplicationHeaders:
    x_amz_target: StartAppReplicationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartAppReplicationRequest:
    headers: StartAppReplicationHeaders = field()
    request: shared.StartAppReplicationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
