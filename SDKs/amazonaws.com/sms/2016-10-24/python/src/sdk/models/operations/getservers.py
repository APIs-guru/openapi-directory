...
class GetServersHeaders:
    ...
    x_amz_target: GetServersXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
    

@dataclass
class GetServersRequest:
    query_params: GetServersQueryParams = field(default=None)
    headers: GetServersHeaders = field(default=None)
    request: shared.GetServersRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
