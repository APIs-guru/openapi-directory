...
class CreateReplicationJobHeaders:
    ...
    x_amz_target: CreateReplicationJobXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateReplicationJobRequest:
    headers: CreateReplicationJobHeaders = field(default=None)
    request: shared.CreateReplicationJobRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
