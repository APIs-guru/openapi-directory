...
class PutAppValidationConfigurationHeaders:
    x_amz_target: PutAppValidationConfigurationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutAppValidationConfigurationRequest:
    headers: PutAppValidationConfigurationHeaders = field()
    request: shared.PutAppValidationConfigurationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
