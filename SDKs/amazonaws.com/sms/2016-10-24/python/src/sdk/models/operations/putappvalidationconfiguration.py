...
class PutAppValidationConfigurationHeaders:
    ...
    x_amz_target: PutAppValidationConfigurationXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class PutAppValidationConfigurationRequest:
    headers: PutAppValidationConfigurationHeaders = field(default=None)
    request: shared.PutAppValidationConfigurationRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class PutAppValidationConfigurationResponse:
    ...
    put_app_validation_configuration_response: Optional[dict[str, Any]] = field(default=None)
