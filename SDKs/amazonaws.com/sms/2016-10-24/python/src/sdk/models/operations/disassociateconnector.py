...
class DisassociateConnectorHeaders:
    ...
    x_amz_target: DisassociateConnectorXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DisassociateConnectorRequest:
    headers: DisassociateConnectorHeaders = field(default=None)
    request: shared.DisassociateConnectorRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class DisassociateConnectorResponse:
    content_type: str = field(default=None)
    disassociate_connector_response: Optional[dict[str, Any]] = field(default=None)
