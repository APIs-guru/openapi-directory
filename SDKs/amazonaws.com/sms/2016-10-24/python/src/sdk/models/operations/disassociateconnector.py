...
class DisassociateConnectorHeaders:
    x_amz_target: DisassociateConnectorXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DisassociateConnectorRequest:
    headers: DisassociateConnectorHeaders = field()
    request: shared.DisassociateConnectorRequest = field(metadata={'request': { 'media_type': 'application/json' }})
