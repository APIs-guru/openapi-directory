...
class GetAppValidationConfigurationHeaders:
    ...
    x_amz_target: GetAppValidationConfigurationXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetAppValidationConfigurationRequest:
    headers: GetAppValidationConfigurationHeaders = field(default=None)
    request: shared.GetAppValidationConfigurationRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class GetAppValidationConfigurationResponse:
    content_type: str = field(default=None)
    get_app_validation_configuration_response: Optional[shared.GetAppValidationConfigurationResponse] = field(default=None)
