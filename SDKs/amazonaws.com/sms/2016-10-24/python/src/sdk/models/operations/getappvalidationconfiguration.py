...
class GetAppValidationConfigurationHeaders:
    x_amz_target: GetAppValidationConfigurationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetAppValidationConfigurationRequest:
    headers: GetAppValidationConfigurationHeaders = field()
    request: shared.GetAppValidationConfigurationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
