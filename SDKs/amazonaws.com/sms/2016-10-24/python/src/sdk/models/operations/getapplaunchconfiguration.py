...
class GetAppLaunchConfigurationHeaders:
    ...
    x_amz_target: GetAppLaunchConfigurationXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetAppLaunchConfigurationRequest:
    headers: GetAppLaunchConfigurationHeaders = field(default=None)
    request: shared.GetAppLaunchConfigurationRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class GetAppLaunchConfigurationResponse:
    content_type: str = field(default=None)
    get_app_launch_configuration_response: Optional[shared.GetAppLaunchConfigurationResponse] = field(default=None)
