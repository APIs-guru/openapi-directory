...
class GetAppLaunchConfigurationHeaders:
    x_amz_target: GetAppLaunchConfigurationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetAppLaunchConfigurationRequest:
    headers: GetAppLaunchConfigurationHeaders = field()
    request: shared.GetAppLaunchConfigurationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
