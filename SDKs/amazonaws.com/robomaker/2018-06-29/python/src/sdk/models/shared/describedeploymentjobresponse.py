...
class DescribeDeploymentJobResponse:
    ...
    robot_deployment_summary: Optional[List[robotdeployment.RobotDeployment]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'robotDeploymentSummary' }})
