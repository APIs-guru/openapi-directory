...
class ListWorldsRequest:
    headers: ListWorldsHeaders = field()
    query_params: ListWorldsQueryParams = field()
    request: ListWorldsRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
