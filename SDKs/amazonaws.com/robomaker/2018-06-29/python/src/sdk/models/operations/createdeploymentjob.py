...
class CreateDeploymentJobRequestBodyDeploymentConfig:
    ...
    download_condition_file: Optional[shared.S3Object] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('downloadConditionFile') }})
...
class CreateDeploymentJobRequestBody:
    ...
    deployment_application_configs: List[shared.DeploymentApplicationConfig] = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('deploymentApplicationConfigs') }})
    fleet: str = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('fleet') }})
    deployment_config: Optional[CreateDeploymentJobRequestBodyDeploymentConfig] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('deploymentConfig') }})
    tags: Optional[dict[str, str]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tags') }})
    

@dataclass
class CreateDeploymentJobRequest:
    headers: CreateDeploymentJobHeaders = field()
    request: CreateDeploymentJobRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
