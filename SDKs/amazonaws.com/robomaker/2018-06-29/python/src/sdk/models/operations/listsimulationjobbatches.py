...
class ListSimulationJobBatchesRequest:
    headers: ListSimulationJobBatchesHeaders = field()
    query_params: ListSimulationJobBatchesQueryParams = field()
    request: ListSimulationJobBatchesRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
