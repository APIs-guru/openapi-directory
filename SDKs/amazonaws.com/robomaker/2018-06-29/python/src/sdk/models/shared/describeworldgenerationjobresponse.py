...
class DescribeWorldGenerationJobResponse:
    ...
    finished_worlds_summary: Optional[FinishedWorldsSummary] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('finishedWorldsSummary') }})
