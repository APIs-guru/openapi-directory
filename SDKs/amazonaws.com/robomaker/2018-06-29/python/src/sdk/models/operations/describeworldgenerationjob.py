...
class DescribeWorldGenerationJobRequest:
    headers: DescribeWorldGenerationJobHeaders = field(default=None)
    request: DescribeWorldGenerationJobRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
