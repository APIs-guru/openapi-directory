...
class CreateSimulationApplicationVersionRequest:
    headers: CreateSimulationApplicationVersionHeaders = field()
    request: CreateSimulationApplicationVersionRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
