...
class CreateRobotApplicationVersionRequest:
    headers: CreateRobotApplicationVersionHeaders = field(default=None)
    request: CreateRobotApplicationVersionRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
