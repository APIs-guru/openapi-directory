...
class CreateRobotApplicationVersionRequestBody:
    ...
    s3_etags: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('s3Etags') }})
    

@dataclass
class CreateRobotApplicationVersionRequest:
    headers: CreateRobotApplicationVersionHeaders = field()
    request: CreateRobotApplicationVersionRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
...
class CreateRobotApplicationVersionResponse:
    ...
    create_robot_application_version_response: Optional[shared.CreateRobotApplicationVersionResponse] = field(default=None)
