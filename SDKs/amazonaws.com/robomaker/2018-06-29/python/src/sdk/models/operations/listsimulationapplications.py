...
class ListSimulationApplicationsRequest:
    headers: ListSimulationApplicationsHeaders = field()
    query_params: ListSimulationApplicationsQueryParams = field()
    request: ListSimulationApplicationsRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
