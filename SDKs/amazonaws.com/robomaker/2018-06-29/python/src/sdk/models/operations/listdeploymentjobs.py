...
class ListDeploymentJobsRequest:
    headers: ListDeploymentJobsHeaders = field()
    query_params: ListDeploymentJobsQueryParams = field()
    request: ListDeploymentJobsRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
