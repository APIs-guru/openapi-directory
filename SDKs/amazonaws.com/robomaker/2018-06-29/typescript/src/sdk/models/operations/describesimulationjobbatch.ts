...
export class DescribeSimulationJobBatchHeaders extends SpeakeasyBase {
...
export class DescribeSimulationJobBatchRequestBody extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=batch" })
  batch: string;
}


export class DescribeSimulationJobBatchRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
