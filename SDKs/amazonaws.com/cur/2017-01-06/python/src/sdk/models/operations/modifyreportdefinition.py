...
class ModifyReportDefinitionHeaders:
    ...
    x_amz_target: ModifyReportDefinitionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ModifyReportDefinitionRequest:
    headers: ModifyReportDefinitionHeaders = field(default=None)
    request: shared.ModifyReportDefinitionRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
