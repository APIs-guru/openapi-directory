...
class DescribeReportDefinitionsHeaders:
    x_amz_target: DescribeReportDefinitionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeReportDefinitionsRequest:
    headers: DescribeReportDefinitionsHeaders = field()
    query_params: DescribeReportDefinitionsQueryParams = field()
    request: shared.DescribeReportDefinitionsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
