...
class DeleteReportDefinitionHeaders:
    ...
    x_amz_target: DeleteReportDefinitionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeleteReportDefinitionRequest:
    headers: DeleteReportDefinitionHeaders = field(default=None)
    request: shared.DeleteReportDefinitionRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
