...
class PutReportDefinitionHeaders:
    x_amz_target: PutReportDefinitionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutReportDefinitionRequest:
    ...
    request: shared.PutReportDefinitionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
