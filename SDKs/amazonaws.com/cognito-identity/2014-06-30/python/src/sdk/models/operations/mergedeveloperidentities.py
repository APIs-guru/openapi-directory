...
class MergeDeveloperIdentitiesHeaders:
    x_amz_target: MergeDeveloperIdentitiesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class MergeDeveloperIdentitiesRequest:
    headers: MergeDeveloperIdentitiesHeaders = field()
    request: shared.MergeDeveloperIdentitiesInput = field(metadata={'request': { 'media_type': 'application/json' }})
