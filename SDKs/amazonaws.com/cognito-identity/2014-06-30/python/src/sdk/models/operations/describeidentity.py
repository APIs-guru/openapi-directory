...
class DescribeIdentityHeaders:
    ...
    x_amz_target: DescribeIdentityXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeIdentityRequest:
    headers: DescribeIdentityHeaders = field(default=None)
    request: shared.DescribeIdentityInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
