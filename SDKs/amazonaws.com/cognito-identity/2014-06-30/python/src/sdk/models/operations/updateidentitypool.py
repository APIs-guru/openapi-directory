...
class UpdateIdentityPoolHeaders:
    x_amz_target: UpdateIdentityPoolXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateIdentityPoolRequest:
    headers: UpdateIdentityPoolHeaders = field()
    request: shared.IdentityPool = field(metadata={'request': { 'media_type': 'application/json' }})
