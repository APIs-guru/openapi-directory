...
class CreateIdentityPoolHeaders:
    ...
    x_amz_target: CreateIdentityPoolXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateIdentityPoolRequest:
    headers: CreateIdentityPoolHeaders = field(default=None)
    request: shared.CreateIdentityPoolInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
