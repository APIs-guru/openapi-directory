...
class CreateIdentityPoolHeaders:
    x_amz_target: CreateIdentityPoolXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateIdentityPoolRequest:
    headers: CreateIdentityPoolHeaders = field()
    request: shared.CreateIdentityPoolInput = field(metadata={'request': { 'media_type': 'application/json' }})
