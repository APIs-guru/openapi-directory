...
class UnlinkDeveloperIdentityHeaders:
    x_amz_target: UnlinkDeveloperIdentityXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UnlinkDeveloperIdentityRequest:
    headers: UnlinkDeveloperIdentityHeaders = field()
    request: shared.UnlinkDeveloperIdentityInput = field(metadata={'request': { 'media_type': 'application/json' }})
