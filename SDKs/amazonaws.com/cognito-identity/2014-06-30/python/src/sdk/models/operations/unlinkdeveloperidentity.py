...
class UnlinkDeveloperIdentityHeaders:
    ...
    x_amz_target: UnlinkDeveloperIdentityXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
    

@dataclass
class UnlinkDeveloperIdentityRequest:
    headers: UnlinkDeveloperIdentityHeaders = field(default=None)
    request: shared.UnlinkDeveloperIdentityInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
