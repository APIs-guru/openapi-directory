...
export class ListIdentityPoolsQueryParams extends SpeakeasyBase {
...
export enum ListIdentityPoolsXAmzTargetEnum {
    AwsCognitoIdentityServiceListIdentityPools = "AWSCognitoIdentityService.ListIdentityPools"
}


export class ListIdentityPoolsHeaders extends SpeakeasyBase {
...
export class ListIdentityPoolsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
