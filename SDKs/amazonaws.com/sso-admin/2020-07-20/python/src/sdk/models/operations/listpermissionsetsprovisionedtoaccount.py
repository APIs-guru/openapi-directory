...
class ListPermissionSetsProvisionedToAccountHeaders:
    ...
    x_amz_target: ListPermissionSetsProvisionedToAccountXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
