...
class ListPermissionSetsProvisionedToAccountHeaders:
    x_amz_target: ListPermissionSetsProvisionedToAccountXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListPermissionSetsProvisionedToAccountRequest:
    headers: ListPermissionSetsProvisionedToAccountHeaders = field()
    query_params: ListPermissionSetsProvisionedToAccountQueryParams = field()
    request: shared.ListPermissionSetsProvisionedToAccountRequest = field(metadata={'request': { 'media_type': 'application/json' }})
