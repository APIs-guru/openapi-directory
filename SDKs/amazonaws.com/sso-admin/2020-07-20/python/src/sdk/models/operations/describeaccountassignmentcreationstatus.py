...
class DescribeAccountAssignmentCreationStatusHeaders:
    ...
    x_amz_target: DescribeAccountAssignmentCreationStatusXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
