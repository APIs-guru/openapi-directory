...
class DescribeAccountAssignmentCreationStatusHeaders:
    x_amz_target: DescribeAccountAssignmentCreationStatusXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeAccountAssignmentCreationStatusRequest:
    headers: DescribeAccountAssignmentCreationStatusHeaders = field()
    request: shared.DescribeAccountAssignmentCreationStatusRequest = field(metadata={'request': { 'media_type': 'application/json' }})
