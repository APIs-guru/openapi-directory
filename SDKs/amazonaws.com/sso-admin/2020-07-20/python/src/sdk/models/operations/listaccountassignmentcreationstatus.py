...
class ListAccountAssignmentCreationStatusHeaders:
    x_amz_target: ListAccountAssignmentCreationStatusXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListAccountAssignmentCreationStatusRequest:
    headers: ListAccountAssignmentCreationStatusHeaders = field()
    query_params: ListAccountAssignmentCreationStatusQueryParams = field()
    request: shared.ListAccountAssignmentCreationStatusRequest = field(metadata={'request': { 'media_type': 'application/json' }})
