...
class GetInlinePolicyForPermissionSetHeaders:
    ...
    x_amz_target: GetInlinePolicyForPermissionSetXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetInlinePolicyForPermissionSetRequest:
    headers: GetInlinePolicyForPermissionSetHeaders = field(default=None)
    request: shared.GetInlinePolicyForPermissionSetRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
