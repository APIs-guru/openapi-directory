...
class ListPermissionSetProvisioningStatusHeaders:
    x_amz_target: ListPermissionSetProvisioningStatusXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListPermissionSetProvisioningStatusRequest:
    headers: ListPermissionSetProvisioningStatusHeaders = field()
    query_params: ListPermissionSetProvisioningStatusQueryParams = field()
    request: shared.ListPermissionSetProvisioningStatusRequest = field(metadata={'request': { 'media_type': 'application/json' }})
