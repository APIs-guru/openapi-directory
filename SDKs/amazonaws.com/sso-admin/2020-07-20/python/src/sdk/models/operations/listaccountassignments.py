...
class ListAccountAssignmentsHeaders:
    x_amz_target: ListAccountAssignmentsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListAccountAssignmentsRequest:
    headers: ListAccountAssignmentsHeaders = field()
    query_params: ListAccountAssignmentsQueryParams = field()
    request: shared.ListAccountAssignmentsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
