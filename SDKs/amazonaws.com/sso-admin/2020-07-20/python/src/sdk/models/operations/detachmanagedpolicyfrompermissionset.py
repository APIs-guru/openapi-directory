...
class DetachManagedPolicyFromPermissionSetHeaders:
    x_amz_target: DetachManagedPolicyFromPermissionSetXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DetachManagedPolicyFromPermissionSetRequest:
    headers: DetachManagedPolicyFromPermissionSetHeaders = field()
    request: shared.DetachManagedPolicyFromPermissionSetRequest = field(metadata={'request': { 'media_type': 'application/json' }})
