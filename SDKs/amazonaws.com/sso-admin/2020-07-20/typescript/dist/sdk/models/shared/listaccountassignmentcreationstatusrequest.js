...
var ListAccountAssignmentCreationStatusRequest = /** @class */ (function (_super) {
    ...
    ], ListAccountAssignmentCreationStatusRequest.prototype, "filter", void 0);
    __decorate([
        Metadata({ data: "json, name=InstanceArn" }),
        __metadata("design:type", String)
    ], ListAccountAssignmentCreationStatusRequest.prototype, "instanceArn", void 0);
    __decorate([
        Metadata({ data: "json, name=MaxResults" }),
        __metadata("design:type", Number)
    ], ListAccountAssignmentCreationStatusRequest.prototype, "maxResults", void 0);
    __decorate([
        Metadata({ data: "json, name=NextToken" }),
        __metadata("design:type", String)
    ], ListAccountAssignmentCreationStatusRequest.prototype, "nextToken", void 0);
