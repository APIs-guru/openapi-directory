...
export class ListPermissionSetsQueryParams extends SpeakeasyBase {
...
export enum ListPermissionSetsXAmzTargetEnum {
    SwbExternalServiceListPermissionSets = "SWBExternalService.ListPermissionSets"
}


export class ListPermissionSetsHeaders extends SpeakeasyBase {
