...
class DeleteEnvironmentMembershipHeaders:
    x_amz_target: DeleteEnvironmentMembershipXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteEnvironmentMembershipRequest:
    headers: DeleteEnvironmentMembershipHeaders = field()
    request: shared.DeleteEnvironmentMembershipRequest = field(metadata={'request': { 'media_type': 'application/json' }})
