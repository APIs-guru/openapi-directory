...
class UpdateEnvironmentMembershipHeaders:
    x_amz_target: UpdateEnvironmentMembershipXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateEnvironmentMembershipRequest:
    headers: UpdateEnvironmentMembershipHeaders = field()
    request: shared.UpdateEnvironmentMembershipRequest = field(metadata={'request': { 'media_type': 'application/json' }})
