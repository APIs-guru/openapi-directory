...
class CreateEnvironmentEc2Headers:
    x_amz_target: CreateEnvironmentEc2XAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateEnvironmentEc2Request:
    headers: CreateEnvironmentEc2Headers = field()
    request: shared.CreateEnvironmentEc2Request = field(metadata={'request': { 'media_type': 'application/json' }})
