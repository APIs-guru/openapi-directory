...
class CreateInstanceHeaders:
    x_amz_target: CreateInstanceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateInstanceRequest:
    headers: CreateInstanceHeaders = field()
    request: shared.CreateInstanceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
