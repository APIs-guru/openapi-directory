...
class DescribeElasticIpsHeaders:
    x_amz_target: DescribeElasticIpsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeElasticIpsRequest:
    headers: DescribeElasticIpsHeaders = field()
    request: shared.DescribeElasticIpsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
