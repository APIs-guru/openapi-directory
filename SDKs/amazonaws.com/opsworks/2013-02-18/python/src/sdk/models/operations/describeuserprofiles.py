...
class DescribeUserProfilesHeaders:
    ...
    x_amz_target: DescribeUserProfilesXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeUserProfilesRequest:
    headers: DescribeUserProfilesHeaders = field(default=None)
    request: shared.DescribeUserProfilesRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
