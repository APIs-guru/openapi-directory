...
class DescribeElasticLoadBalancersHeaders:
    x_amz_target: DescribeElasticLoadBalancersXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeElasticLoadBalancersRequest:
    headers: DescribeElasticLoadBalancersHeaders = field()
    request: shared.DescribeElasticLoadBalancersRequest = field(metadata={'request': { 'media_type': 'application/json' }})
