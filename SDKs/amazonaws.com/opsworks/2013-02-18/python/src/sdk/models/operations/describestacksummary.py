...
class DescribeStackSummaryHeaders:
    x_amz_target: DescribeStackSummaryXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeStackSummaryRequest:
    headers: DescribeStackSummaryHeaders = field()
    request: shared.DescribeStackSummaryRequest = field(metadata={'request': { 'media_type': 'application/json' }})
