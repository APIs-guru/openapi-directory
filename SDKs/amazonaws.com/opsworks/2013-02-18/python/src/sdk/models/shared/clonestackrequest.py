...
class CloneStackRequest:
    ...
    source_stack_id: str = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('SourceStackId') }})
    ...
    clone_app_ids: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('CloneAppIds') }})
    clone_permissions: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ClonePermissions') }})
