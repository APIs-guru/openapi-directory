...
class CloneStackRequest:
    ...
    clone_app_ids: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'CloneAppIds' }})
    clone_permissions: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ClonePermissions' }})
    ...
    source_stack_id: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'SourceStackId' }})
