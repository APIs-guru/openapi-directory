...
class DescribeStacksHeaders:
    x_amz_target: DescribeStacksXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeStacksRequest:
    headers: DescribeStacksHeaders = field()
    request: shared.DescribeStacksRequest = field(metadata={'request': { 'media_type': 'application/json' }})
