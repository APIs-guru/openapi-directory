...
class DescribeMyUserProfileHeaders:
    x_amz_target: DescribeMyUserProfileXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeMyUserProfileRequest:
    headers: DescribeMyUserProfileHeaders = field()
