...
class DescribeEcsClustersHeaders:
    x_amz_target: DescribeEcsClustersXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeEcsClustersRequest:
    headers: DescribeEcsClustersHeaders = field()
    query_params: DescribeEcsClustersQueryParams = field()
    request: shared.DescribeEcsClustersRequest = field(metadata={'request': { 'media_type': 'application/json' }})
