...
class DescribeTimeBasedAutoScalingHeaders:
    x_amz_target: DescribeTimeBasedAutoScalingXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeTimeBasedAutoScalingRequest:
    headers: DescribeTimeBasedAutoScalingHeaders = field()
    request: shared.DescribeTimeBasedAutoScalingRequest = field(metadata={'request': { 'media_type': 'application/json' }})
