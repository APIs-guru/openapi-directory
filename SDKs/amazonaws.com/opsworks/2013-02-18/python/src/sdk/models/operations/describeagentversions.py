...
class DescribeAgentVersionsHeaders:
    ...
    x_amz_target: DescribeAgentVersionsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeAgentVersionsRequest:
    headers: DescribeAgentVersionsHeaders = field(default=None)
    request: shared.DescribeAgentVersionsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
