...
class GetHostnameSuggestionHeaders:
    ...
    x_amz_target: GetHostnameSuggestionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetHostnameSuggestionRequest:
    headers: GetHostnameSuggestionHeaders = field(default=None)
    request: shared.GetHostnameSuggestionRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
