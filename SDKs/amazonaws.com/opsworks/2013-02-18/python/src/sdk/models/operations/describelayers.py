...
class DescribeLayersHeaders:
    x_amz_target: DescribeLayersXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeLayersRequest:
    headers: DescribeLayersHeaders = field()
    request: shared.DescribeLayersRequest = field(metadata={'request': { 'media_type': 'application/json' }})
