...
class DescribeCommandsHeaders:
    x_amz_target: DescribeCommandsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeCommandsRequest:
    headers: DescribeCommandsHeaders = field()
    request: shared.DescribeCommandsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
