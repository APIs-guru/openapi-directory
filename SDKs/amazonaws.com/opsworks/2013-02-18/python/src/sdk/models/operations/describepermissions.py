...
class DescribePermissionsHeaders:
    ...
    x_amz_target: DescribePermissionsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribePermissionsRequest:
    headers: DescribePermissionsHeaders = field(default=None)
    request: shared.DescribePermissionsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
