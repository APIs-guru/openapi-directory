...
class DescribeOperatingSystemsHeaders:
    x_amz_target: DescribeOperatingSystemsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeOperatingSystemsRequest:
    headers: DescribeOperatingSystemsHeaders = field()
