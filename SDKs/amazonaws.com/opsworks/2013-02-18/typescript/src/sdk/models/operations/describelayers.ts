...
export enum DescribeLayersXAmzTargetEnum {
    OpsWorks20130218DescribeLayers = "OpsWorks_20130218.DescribeLayers"
}


export class DescribeLayersHeaders extends SpeakeasyBase {
...
export class DescribeLayersResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
