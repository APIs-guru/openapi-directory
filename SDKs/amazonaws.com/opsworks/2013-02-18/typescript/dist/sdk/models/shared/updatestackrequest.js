...
var UpdateStackRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], UpdateStackRequest.prototype, "serviceRoleArn", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=StackId" }),
        __metadata("design:type", String)
    ], UpdateStackRequest.prototype, "stackId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=UseCustomCookbooks" }),
        __metadata("design:type", Boolean)
    ], UpdateStackRequest.prototype, "useCustomCookbooks", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=UseOpsworksSecurityGroups" }),
        __metadata("design:type", Boolean)
    ], UpdateStackRequest.prototype, "useOpsworksSecurityGroups", void 0);
