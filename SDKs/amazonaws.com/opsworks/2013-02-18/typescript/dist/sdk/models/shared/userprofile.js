...
var UserProfile = /** @class */ (function (_super) {
    ...
    ], UserProfile.prototype, "allowSelfManagement", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=IamUserArn" }),
        __metadata("design:type", String)
    ], UserProfile.prototype, "iamUserArn", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], UserProfile.prototype, "sshPublicKey", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=SshUsername" }),
        __metadata("design:type", String)
    ], UserProfile.prototype, "sshUsername", void 0);
    return UserProfile;
}(SpeakeasyBase));
export { UserProfile };
