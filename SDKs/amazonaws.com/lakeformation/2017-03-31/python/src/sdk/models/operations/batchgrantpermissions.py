...
class BatchGrantPermissionsHeaders:
    ...
    x_amz_target: BatchGrantPermissionsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class BatchGrantPermissionsRequest:
    headers: BatchGrantPermissionsHeaders = field(default=None)
    request: shared.BatchGrantPermissionsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
