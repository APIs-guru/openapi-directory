...
class GetResourceLfTagsHeaders:
    x_amz_target: GetResourceLfTagsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetResourceLfTagsRequest:
    headers: GetResourceLfTagsHeaders = field()
    request: shared.GetResourceLfTagsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
