...
class ListPermissionsHeaders:
    ...
    x_amz_target: ListPermissionsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListPermissionsRequest:
    ...
    request: shared.ListPermissionsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
