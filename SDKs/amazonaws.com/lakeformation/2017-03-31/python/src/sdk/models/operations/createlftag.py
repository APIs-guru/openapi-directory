...
class CreateLfTagHeaders:
    x_amz_target: CreateLfTagXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateLfTagRequest:
    headers: CreateLfTagHeaders = field()
    request: shared.CreateLfTagRequest = field(metadata={'request': { 'media_type': 'application/json' }})
