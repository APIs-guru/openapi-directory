...
export class StartStudioSsoConfigurationRepairPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=studioId" })
  studioId: string;
}


export class StartStudioSsoConfigurationRepairHeaders extends SpeakeasyBase {
