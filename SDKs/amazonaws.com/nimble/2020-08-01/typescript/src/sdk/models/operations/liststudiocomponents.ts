...
export class ListStudioComponentsPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=studioId" })
  studioId: string;
}


export class ListStudioComponentsQueryParams extends SpeakeasyBase {
...
export class ListStudioComponentsHeaders extends SpeakeasyBase {
