...
class CreateStreamingImageRequest:
    headers: CreateStreamingImageHeaders = field()
    path_params: CreateStreamingImagePathParams = field()
    request: CreateStreamingImageRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
