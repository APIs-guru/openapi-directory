...
@dataclass
class DeleteLaunchProfileMemberPathParams:
...
@dataclass
class DeleteLaunchProfileMemberHeaders:
...
class DeleteLaunchProfileMemberRequest:
    path_params: DeleteLaunchProfileMemberPathParams = field(default=None)
    headers: DeleteLaunchProfileMemberHeaders = field(default=None)
...
class DeleteLaunchProfileMemberResponse:
    ...
    delete_launch_profile_member_response: Optional[dict[str, Any]] = field(default=None)
