...
@dataclass
class GetStudioMemberPathParams:
...
class GetStudioMemberRequest:
    path_params: GetStudioMemberPathParams = field(default=None)
    headers: GetStudioMemberHeaders = field(default=None)
...
class GetStudioMemberResponse:
    ...
    get_studio_member_response: Optional[shared.GetStudioMemberResponse] = field(default=None)
