...
@dataclass
class DeleteLaunchProfilePathParams:
...
@dataclass
class DeleteLaunchProfileHeaders:
...
class DeleteLaunchProfileRequest:
    path_params: DeleteLaunchProfilePathParams = field(default=None)
    headers: DeleteLaunchProfileHeaders = field(default=None)
...
class DeleteLaunchProfileResponse:
    ...
    delete_launch_profile_response: Optional[shared.DeleteLaunchProfileResponse] = field(default=None)
