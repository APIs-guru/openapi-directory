...
class DeleteStudioComponentRequest:
    path_params: DeleteStudioComponentPathParams = field(default=None)
    headers: DeleteStudioComponentHeaders = field(default=None)
...
class DeleteStudioComponentResponse:
    ...
    delete_studio_component_response: Optional[shared.DeleteStudioComponentResponse] = field(default=None)
