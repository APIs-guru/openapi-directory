...
class GetLaunchProfileRequest:
    path_params: GetLaunchProfilePathParams = field(default=None)
    headers: GetLaunchProfileHeaders = field(default=None)
...
class GetLaunchProfileResponse:
    ...
    get_launch_profile_response: Optional[shared.GetLaunchProfileResponse] = field(default=None)
