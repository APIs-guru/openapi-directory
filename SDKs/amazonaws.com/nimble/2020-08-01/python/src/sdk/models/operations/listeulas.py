...
@dataclass
class ListEulasQueryParams:
    eula_ids: Optional[List[str]] = field(default=None, metadata={'query_param': { 'field_name': 'eulaIds', 'style': 'form', 'explode': True }})
    next_token: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'nextToken', 'style': 'form', 'explode': True }})
    

@dataclass
class ListEulasHeaders:
