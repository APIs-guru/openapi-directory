...
class GetLaunchProfileMemberRequest:
    path_params: GetLaunchProfileMemberPathParams = field(default=None)
    headers: GetLaunchProfileMemberHeaders = field(default=None)
...
class GetLaunchProfileMemberResponse:
    ...
    get_launch_profile_member_response: Optional[shared.GetLaunchProfileMemberResponse] = field(default=None)
