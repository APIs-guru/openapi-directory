...
class GetDetachInstancesQueryParams:
    action: GetDetachInstancesActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetDetachInstancesVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDetachInstancesRequest:
    headers: GetDetachInstancesHeaders = field()
    query_params: GetDetachInstancesQueryParams = field()
