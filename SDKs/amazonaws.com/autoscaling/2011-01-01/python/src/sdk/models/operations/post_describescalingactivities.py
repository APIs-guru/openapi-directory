...
class PostDescribeScalingActivitiesQueryParams:
    action: PostDescribeScalingActivitiesActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: PostDescribeScalingActivitiesVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeScalingActivitiesRequest:
    query_params: PostDescribeScalingActivitiesQueryParams = field(default=None)
    headers: PostDescribeScalingActivitiesHeaders = field(default=None)
