...
class StepAdjustment:
    ...
    scaling_adjustment: int = field()
    metric_interval_lower_bound: Optional[float] = field(default=None)
    metric_interval_upper_bound: Optional[float] = field(default=None)
