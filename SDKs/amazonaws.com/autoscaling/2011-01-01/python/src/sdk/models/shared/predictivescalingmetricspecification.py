...
class PredictiveScalingMetricSpecification:
    r"""PredictiveScalingMetricSpecification
    ...
    predefined_load_metric_specification: Optional[PredictiveScalingPredefinedLoadMetric] = field(default=None)
    predefined_metric_pair_specification: Optional[PredictiveScalingPredefinedMetricPair] = field(default=None)
    predefined_scaling_metric_specification: Optional[PredictiveScalingPredefinedScalingMetric] = field(default=None)
