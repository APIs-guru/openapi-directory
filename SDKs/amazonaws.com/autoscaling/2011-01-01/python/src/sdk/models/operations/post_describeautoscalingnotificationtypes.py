...
class PostDescribeAutoScalingNotificationTypesQueryParams:
    action: PostDescribeAutoScalingNotificationTypesActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeAutoScalingNotificationTypesVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeAutoScalingNotificationTypesRequest:
    headers: PostDescribeAutoScalingNotificationTypesHeaders = field()
    query_params: PostDescribeAutoScalingNotificationTypesQueryParams = field()
