...
class PostDescribeNotificationConfigurationsQueryParams:
    action: PostDescribeNotificationConfigurationsActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: PostDescribeNotificationConfigurationsVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeNotificationConfigurationsRequest:
    query_params: PostDescribeNotificationConfigurationsQueryParams = field(default=None)
    headers: PostDescribeNotificationConfigurationsHeaders = field(default=None)
