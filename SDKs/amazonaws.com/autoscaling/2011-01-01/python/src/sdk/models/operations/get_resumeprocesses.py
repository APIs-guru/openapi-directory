...
class GetResumeProcessesQueryParams:
    action: GetResumeProcessesActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    auto_scaling_group_name: str = field(metadata={'query_param': { 'field_name': 'AutoScalingGroupName', 'style': 'form', 'explode': True }})
    version: GetResumeProcessesVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetResumeProcessesRequest:
    headers: GetResumeProcessesHeaders = field()
    query_params: GetResumeProcessesQueryParams = field()
