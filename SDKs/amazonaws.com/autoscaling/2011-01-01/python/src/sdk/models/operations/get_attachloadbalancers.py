...
class GetAttachLoadBalancersQueryParams:
    action: GetAttachLoadBalancersActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetAttachLoadBalancersVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetAttachLoadBalancersRequest:
    query_params: GetAttachLoadBalancersQueryParams = field(default=None)
    headers: GetAttachLoadBalancersHeaders = field(default=None)
