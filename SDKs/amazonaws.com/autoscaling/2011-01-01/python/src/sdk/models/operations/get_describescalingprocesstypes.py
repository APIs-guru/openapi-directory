...
class GetDescribeScalingProcessTypesQueryParams:
    action: GetDescribeScalingProcessTypesActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetDescribeScalingProcessTypesVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDescribeScalingProcessTypesRequest:
    headers: GetDescribeScalingProcessTypesHeaders = field()
    query_params: GetDescribeScalingProcessTypesQueryParams = field()
