...
class PostAttachLoadBalancerTargetGroupsQueryParams:
    action: PostAttachLoadBalancerTargetGroupsActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostAttachLoadBalancerTargetGroupsVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostAttachLoadBalancerTargetGroupsRequest:
    headers: PostAttachLoadBalancerTargetGroupsHeaders = field()
    query_params: PostAttachLoadBalancerTargetGroupsQueryParams = field()
