...
class PostDescribeAutoScalingInstancesQueryParams:
    action: PostDescribeAutoScalingInstancesActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeAutoScalingInstancesVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeAutoScalingInstancesRequest:
    headers: PostDescribeAutoScalingInstancesHeaders = field()
    query_params: PostDescribeAutoScalingInstancesQueryParams = field()
