...
export class StartBuildBatchInput extends SpeakeasyBase {
  ...
  @Metadata({ data: "json, name=buildBatchConfigOverride" })
  buildBatchConfigOverride?: ProjectBuildBatchConfig;

  @Metadata({ data: "json, name=buildTimeoutInMinutesOverride" })
  ...
  @Metadata({ data: "json, name=reportBuildBatchStatusOverride" })
