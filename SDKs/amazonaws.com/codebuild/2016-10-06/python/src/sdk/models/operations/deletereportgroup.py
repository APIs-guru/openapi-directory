...
class DeleteReportGroupHeaders:
    x_amz_target: DeleteReportGroupXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteReportGroupRequest:
    headers: DeleteReportGroupHeaders = field()
    request: shared.DeleteReportGroupInput = field(metadata={'request': { 'media_type': 'application/json' }})
