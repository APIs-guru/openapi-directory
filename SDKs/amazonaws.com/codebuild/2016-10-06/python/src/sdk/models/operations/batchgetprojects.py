...
class BatchGetProjectsHeaders:
    x_amz_target: BatchGetProjectsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class BatchGetProjectsRequest:
    headers: BatchGetProjectsHeaders = field()
    request: shared.BatchGetProjectsInput = field(metadata={'request': { 'media_type': 'application/json' }})
