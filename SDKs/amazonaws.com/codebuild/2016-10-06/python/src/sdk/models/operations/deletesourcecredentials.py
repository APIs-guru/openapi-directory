...
class DeleteSourceCredentialsHeaders:
    x_amz_target: DeleteSourceCredentialsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteSourceCredentialsRequest:
    headers: DeleteSourceCredentialsHeaders = field()
    request: shared.DeleteSourceCredentialsInput = field(metadata={'request': { 'media_type': 'application/json' }})
