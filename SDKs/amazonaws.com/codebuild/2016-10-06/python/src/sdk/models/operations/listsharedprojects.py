...
class ListSharedProjectsHeaders:
    x_amz_target: ListSharedProjectsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListSharedProjectsRequest:
    headers: ListSharedProjectsHeaders = field()
    query_params: ListSharedProjectsQueryParams = field()
    request: shared.ListSharedProjectsInput = field(metadata={'request': { 'media_type': 'application/json' }})
