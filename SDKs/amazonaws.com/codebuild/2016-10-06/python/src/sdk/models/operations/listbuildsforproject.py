...
class ListBuildsForProjectHeaders:
    ...
    x_amz_target: ListBuildsForProjectXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ListBuildsForProjectRequest:
    query_params: ListBuildsForProjectQueryParams = field(default=None)
    headers: ListBuildsForProjectHeaders = field(default=None)
    request: shared.ListBuildsForProjectInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
