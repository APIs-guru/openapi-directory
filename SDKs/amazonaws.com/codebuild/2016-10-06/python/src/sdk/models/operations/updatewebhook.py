...
class UpdateWebhookHeaders:
    ...
    x_amz_target: UpdateWebhookXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateWebhookRequest:
    headers: UpdateWebhookHeaders = field(default=None)
    request: shared.UpdateWebhookInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
