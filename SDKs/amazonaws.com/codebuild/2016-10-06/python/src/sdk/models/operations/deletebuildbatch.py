...
class DeleteBuildBatchHeaders:
    x_amz_target: DeleteBuildBatchXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteBuildBatchRequest:
    headers: DeleteBuildBatchHeaders = field()
    request: shared.DeleteBuildBatchInput = field(metadata={'request': { 'media_type': 'application/json' }})
