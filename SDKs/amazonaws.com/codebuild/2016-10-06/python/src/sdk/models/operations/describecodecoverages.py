...
class DescribeCodeCoveragesHeaders:
    x_amz_target: DescribeCodeCoveragesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeCodeCoveragesRequest:
    headers: DescribeCodeCoveragesHeaders = field()
    query_params: DescribeCodeCoveragesQueryParams = field()
    request: shared.DescribeCodeCoveragesInput = field(metadata={'request': { 'media_type': 'application/json' }})
