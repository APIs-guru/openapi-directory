...
class StartBuildInput:
    ...
    build_status_config_override: Optional[BuildStatusConfig] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('buildStatusConfigOverride') }})
    ...
    report_build_status_override: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('reportBuildStatusOverride') }})
    ...
    timeout_in_minutes_override: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('timeoutInMinutesOverride') }})
