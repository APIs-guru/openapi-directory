...
class ListBuildsXAmzTargetEnum(str, Enum):
    CODE_BUILD_20161006_LIST_BUILDS = "CodeBuild_20161006.ListBuilds"
...
class ListBuildsHeaders:
    ...
    x_amz_target: ListBuildsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
