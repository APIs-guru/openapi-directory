...
class RetryBuildHeaders:
    x_amz_target: RetryBuildXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RetryBuildRequest:
    headers: RetryBuildHeaders = field()
    request: shared.RetryBuildInput = field(metadata={'request': { 'media_type': 'application/json' }})
