...
from . import buildphasetype_enum
...
class BuildPhase:
    ...
    phase_type: Optional[buildphasetype_enum.BuildPhaseTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'phaseType' }})
