...
class BatchGetReportsHeaders:
    x_amz_target: BatchGetReportsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class BatchGetReportsRequest:
    headers: BatchGetReportsHeaders = field()
    request: shared.BatchGetReportsInput = field(metadata={'request': { 'media_type': 'application/json' }})
