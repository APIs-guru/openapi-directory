...
class BatchGetBuildsHeaders:
    x_amz_target: BatchGetBuildsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class BatchGetBuildsRequest:
    headers: BatchGetBuildsHeaders = field()
    request: shared.BatchGetBuildsInput = field(metadata={'request': { 'media_type': 'application/json' }})
