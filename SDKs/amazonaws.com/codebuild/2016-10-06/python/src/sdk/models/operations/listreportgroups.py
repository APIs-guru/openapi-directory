...
class ListReportGroupsHeaders:
    x_amz_target: ListReportGroupsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListReportGroupsRequest:
    headers: ListReportGroupsHeaders = field()
    query_params: ListReportGroupsQueryParams = field()
    request: shared.ListReportGroupsInput = field(metadata={'request': { 'media_type': 'application/json' }})
