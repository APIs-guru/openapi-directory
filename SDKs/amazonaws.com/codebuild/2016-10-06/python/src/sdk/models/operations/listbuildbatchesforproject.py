...
class ListBuildBatchesForProjectHeaders:
    x_amz_target: ListBuildBatchesForProjectXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListBuildBatchesForProjectRequest:
    headers: ListBuildBatchesForProjectHeaders = field()
    query_params: ListBuildBatchesForProjectQueryParams = field()
    request: shared.ListBuildBatchesForProjectInput = field(metadata={'request': { 'media_type': 'application/json' }})
