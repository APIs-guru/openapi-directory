...
class ListCuratedEnvironmentImagesHeaders:
    x_amz_target: ListCuratedEnvironmentImagesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListCuratedEnvironmentImagesRequest:
    headers: ListCuratedEnvironmentImagesHeaders = field()
