...
class ListReportsForReportGroupHeaders:
    x_amz_target: ListReportsForReportGroupXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListReportsForReportGroupRequest:
    headers: ListReportsForReportGroupHeaders = field()
    query_params: ListReportsForReportGroupQueryParams = field()
    request: shared.ListReportsForReportGroupInput = field(metadata={'request': { 'media_type': 'application/json' }})
