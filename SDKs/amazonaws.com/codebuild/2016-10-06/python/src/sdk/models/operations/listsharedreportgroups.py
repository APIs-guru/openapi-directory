...
class ListSharedReportGroupsHeaders:
    x_amz_target: ListSharedReportGroupsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListSharedReportGroupsRequest:
    headers: ListSharedReportGroupsHeaders = field()
    query_params: ListSharedReportGroupsQueryParams = field()
    request: shared.ListSharedReportGroupsInput = field(metadata={'request': { 'media_type': 'application/json' }})
