...
class GetReportGroupTrendHeaders:
    ...
    x_amz_target: GetReportGroupTrendXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetReportGroupTrendRequest:
    headers: GetReportGroupTrendHeaders = field(default=None)
    request: shared.GetReportGroupTrendInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
