...
class DescribeTestCasesHeaders:
    x_amz_target: DescribeTestCasesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeTestCasesRequest:
    headers: DescribeTestCasesHeaders = field()
    query_params: DescribeTestCasesQueryParams = field()
    request: shared.DescribeTestCasesInput = field(metadata={'request': { 'media_type': 'application/json' }})
