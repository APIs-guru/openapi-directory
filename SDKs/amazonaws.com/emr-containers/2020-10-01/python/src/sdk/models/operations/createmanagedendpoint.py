...
class CreateManagedEndpointRequestBodyConfigurationOverrides:
    r"""CreateManagedEndpointRequestBodyConfigurationOverrides
...
class CreateManagedEndpointRequestBody:
    ...
    configuration_overrides: Optional[CreateManagedEndpointRequestBodyConfigurationOverrides] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('configurationOverrides') }})
    tags: Optional[dict[str, str]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tags') }})
    

@dataclass
class CreateManagedEndpointRequest:
    headers: CreateManagedEndpointHeaders = field()
    path_params: CreateManagedEndpointPathParams = field()
    request: CreateManagedEndpointRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
