...
class AssociateConfigurationItemsToApplicationHeaders:
    ...
    x_amz_target: AssociateConfigurationItemsToApplicationXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class AssociateConfigurationItemsToApplicationRequest:
    headers: AssociateConfigurationItemsToApplicationHeaders = field(default=None)
    request: shared.AssociateConfigurationItemsToApplicationRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class AssociateConfigurationItemsToApplicationResponse:
    associate_configuration_items_to_application_response: Optional[dict[str, Any]] = field(default=None)
