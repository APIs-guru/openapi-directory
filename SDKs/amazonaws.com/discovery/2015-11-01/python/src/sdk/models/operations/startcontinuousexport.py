...
class StartContinuousExportHeaders:
    ...
    x_amz_target: StartContinuousExportXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class StartContinuousExportRequest:
    headers: StartContinuousExportHeaders = field(default=None)
