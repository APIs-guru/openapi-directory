...
class StopDataCollectionByAgentIdsHeaders:
    x_amz_target: StopDataCollectionByAgentIdsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StopDataCollectionByAgentIdsRequest:
    headers: StopDataCollectionByAgentIdsHeaders = field()
    request: shared.StopDataCollectionByAgentIdsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
