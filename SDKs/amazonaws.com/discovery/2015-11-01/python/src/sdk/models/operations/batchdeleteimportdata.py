...
class BatchDeleteImportDataHeaders:
    x_amz_target: BatchDeleteImportDataXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class BatchDeleteImportDataRequest:
    headers: BatchDeleteImportDataHeaders = field()
    request: shared.BatchDeleteImportDataRequest = field(metadata={'request': { 'media_type': 'application/json' }})
