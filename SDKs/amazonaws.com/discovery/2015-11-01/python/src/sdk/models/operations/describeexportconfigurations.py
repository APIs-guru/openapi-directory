...
class DescribeExportConfigurationsHeaders:
    ...
    x_amz_target: DescribeExportConfigurationsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeExportConfigurationsRequest:
    headers: DescribeExportConfigurationsHeaders = field(default=None)
    request: shared.DescribeExportConfigurationsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class DescribeExportConfigurationsResponse:
    ...
    describe_export_configurations_response: Optional[shared.DescribeExportConfigurationsResponse] = field(default=None)
