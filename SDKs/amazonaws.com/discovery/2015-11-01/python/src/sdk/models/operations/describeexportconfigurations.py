...
class DescribeExportConfigurationsHeaders:
    x_amz_target: DescribeExportConfigurationsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeExportConfigurationsRequest:
    headers: DescribeExportConfigurationsHeaders = field()
    request: shared.DescribeExportConfigurationsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
