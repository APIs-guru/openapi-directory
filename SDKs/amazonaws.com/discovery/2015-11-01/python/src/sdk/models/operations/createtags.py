...
class CreateTagsHeaders:
    ...
    x_amz_target: CreateTagsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateTagsRequest:
    headers: CreateTagsHeaders = field(default=None)
    request: shared.CreateTagsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
