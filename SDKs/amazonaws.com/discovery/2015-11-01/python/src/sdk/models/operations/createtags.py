...
class CreateTagsHeaders:
    x_amz_target: CreateTagsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateTagsRequest:
    headers: CreateTagsHeaders = field()
    request: shared.CreateTagsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
...
class CreateTagsResponse:
    ...
    create_tags_response: Optional[dict[str, Any]] = field(default=None)
