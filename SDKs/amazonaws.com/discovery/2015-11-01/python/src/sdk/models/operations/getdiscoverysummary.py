...
class GetDiscoverySummaryHeaders:
    ...
    x_amz_target: GetDiscoverySummaryXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetDiscoverySummaryRequest:
    headers: GetDiscoverySummaryHeaders = field(default=None)
