...
class StartExportTaskHeaders:
    ...
    x_amz_target: StartExportTaskXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class StartExportTaskRequest:
    headers: StartExportTaskHeaders = field(default=None)
    request: shared.StartExportTaskRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
