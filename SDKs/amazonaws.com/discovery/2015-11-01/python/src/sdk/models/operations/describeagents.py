...
class DescribeAgentsHeaders:
    x_amz_target: DescribeAgentsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeAgentsRequest:
    headers: DescribeAgentsHeaders = field()
    request: shared.DescribeAgentsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
