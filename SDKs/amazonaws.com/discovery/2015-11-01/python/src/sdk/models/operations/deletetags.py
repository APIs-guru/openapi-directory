...
class DeleteTagsHeaders:
    x_amz_target: DeleteTagsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteTagsRequest:
    ...
    request: shared.DeleteTagsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
