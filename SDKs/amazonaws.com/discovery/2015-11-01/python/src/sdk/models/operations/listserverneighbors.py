...
class ListServerNeighborsHeaders:
    x_amz_target: ListServerNeighborsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListServerNeighborsRequest:
    headers: ListServerNeighborsHeaders = field()
    request: shared.ListServerNeighborsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
