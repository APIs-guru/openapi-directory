...
class StartImportTaskHeaders:
    x_amz_target: StartImportTaskXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartImportTaskRequest:
    headers: StartImportTaskHeaders = field()
    request: shared.StartImportTaskRequest = field(metadata={'request': { 'media_type': 'application/json' }})
