...
class DisassociateConfigurationItemsFromApplicationHeaders:
    ...
    x_amz_target: DisassociateConfigurationItemsFromApplicationXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DisassociateConfigurationItemsFromApplicationRequest:
    headers: DisassociateConfigurationItemsFromApplicationHeaders = field(default=None)
    request: shared.DisassociateConfigurationItemsFromApplicationRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class DisassociateConfigurationItemsFromApplicationResponse:
    ...
    disassociate_configuration_items_from_application_response: Optional[dict[str, Any]] = field(default=None)
