...
class DisassociateConfigurationItemsFromApplicationHeaders:
    x_amz_target: DisassociateConfigurationItemsFromApplicationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DisassociateConfigurationItemsFromApplicationRequest:
    headers: DisassociateConfigurationItemsFromApplicationHeaders = field()
    request: shared.DisassociateConfigurationItemsFromApplicationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
