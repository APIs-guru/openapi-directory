...
export enum UpdateMobileDeviceAccessRuleXAmzTargetEnum {
    WorkMailServiceUpdateMobileDeviceAccessRule = "WorkMailService.UpdateMobileDeviceAccessRule"
}


export class UpdateMobileDeviceAccessRuleHeaders extends SpeakeasyBase {
...
export class UpdateMobileDeviceAccessRuleResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
