...
class DeleteUserHeaders:
    x_amz_target: DeleteUserXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteUserRequest:
    ...
    request: shared.DeleteUserRequest = field(metadata={'request': { 'media_type': 'application/json' }})
...
class DeleteUserResponse:
    ...
    delete_user_response: Optional[dict[str, Any]] = field(default=None)
