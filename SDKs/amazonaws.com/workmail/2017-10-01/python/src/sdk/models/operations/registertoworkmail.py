...
class RegisterToWorkMailHeaders:
    x_amz_target: RegisterToWorkMailXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RegisterToWorkMailRequest:
    headers: RegisterToWorkMailHeaders = field()
    request: shared.RegisterToWorkMailRequest = field(metadata={'request': { 'media_type': 'application/json' }})
