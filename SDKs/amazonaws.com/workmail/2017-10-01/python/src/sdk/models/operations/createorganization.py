...
class CreateOrganizationHeaders:
    x_amz_target: CreateOrganizationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateOrganizationRequest:
    headers: CreateOrganizationHeaders = field()
    request: shared.CreateOrganizationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
