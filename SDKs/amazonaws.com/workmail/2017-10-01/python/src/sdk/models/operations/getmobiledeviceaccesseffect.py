...
class GetMobileDeviceAccessEffectHeaders:
    x_amz_target: GetMobileDeviceAccessEffectXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetMobileDeviceAccessEffectRequest:
    headers: GetMobileDeviceAccessEffectHeaders = field()
    request: shared.GetMobileDeviceAccessEffectRequest = field(metadata={'request': { 'media_type': 'application/json' }})
