...
class DeleteAccessControlRuleHeaders:
    x_amz_target: DeleteAccessControlRuleXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteAccessControlRuleRequest:
    headers: DeleteAccessControlRuleHeaders = field()
    request: shared.DeleteAccessControlRuleRequest = field(metadata={'request': { 'media_type': 'application/json' }})
