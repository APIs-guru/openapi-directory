...
class ListAccessControlRulesHeaders:
    x_amz_target: ListAccessControlRulesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListAccessControlRulesRequest:
    headers: ListAccessControlRulesHeaders = field()
    request: shared.ListAccessControlRulesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
