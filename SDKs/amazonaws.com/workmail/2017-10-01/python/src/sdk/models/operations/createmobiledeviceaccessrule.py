...
class CreateMobileDeviceAccessRuleHeaders:
    x_amz_target: CreateMobileDeviceAccessRuleXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateMobileDeviceAccessRuleRequest:
    headers: CreateMobileDeviceAccessRuleHeaders = field()
    request: shared.CreateMobileDeviceAccessRuleRequest = field(metadata={'request': { 'media_type': 'application/json' }})
