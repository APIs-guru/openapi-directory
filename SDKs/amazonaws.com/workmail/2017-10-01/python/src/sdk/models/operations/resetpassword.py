...
class ResetPasswordHeaders:
    ...
    x_amz_target: ResetPasswordXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ResetPasswordRequest:
    headers: ResetPasswordHeaders = field(default=None)
...
class ResetPasswordResponse:
    ...
    reset_password_response: Optional[dict[str, Any]] = field(default=None)
