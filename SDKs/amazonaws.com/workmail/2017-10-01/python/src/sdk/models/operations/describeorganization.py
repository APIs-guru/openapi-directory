...
class DescribeOrganizationHeaders:
    x_amz_target: DescribeOrganizationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeOrganizationRequest:
    headers: DescribeOrganizationHeaders = field()
    request: shared.DescribeOrganizationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
