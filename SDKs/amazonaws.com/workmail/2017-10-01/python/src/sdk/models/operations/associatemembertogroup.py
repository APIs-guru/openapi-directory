...
class AssociateMemberToGroupHeaders:
    x_amz_target: AssociateMemberToGroupXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AssociateMemberToGroupRequest:
    headers: AssociateMemberToGroupHeaders = field()
    request: shared.AssociateMemberToGroupRequest = field(metadata={'request': { 'media_type': 'application/json' }})
