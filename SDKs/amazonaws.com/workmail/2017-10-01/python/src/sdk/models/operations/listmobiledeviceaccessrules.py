...
class ListMobileDeviceAccessRulesHeaders:
    x_amz_target: ListMobileDeviceAccessRulesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListMobileDeviceAccessRulesRequest:
    headers: ListMobileDeviceAccessRulesHeaders = field()
    request: shared.ListMobileDeviceAccessRulesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
