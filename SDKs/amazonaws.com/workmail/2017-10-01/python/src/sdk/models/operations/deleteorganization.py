...
class DeleteOrganizationHeaders:
    x_amz_target: DeleteOrganizationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteOrganizationRequest:
    headers: DeleteOrganizationHeaders = field()
    request: shared.DeleteOrganizationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
