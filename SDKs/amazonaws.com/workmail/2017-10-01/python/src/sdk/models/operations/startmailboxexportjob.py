...
class StartMailboxExportJobHeaders:
    x_amz_target: StartMailboxExportJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartMailboxExportJobRequest:
    headers: StartMailboxExportJobHeaders = field()
    request: shared.StartMailboxExportJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
