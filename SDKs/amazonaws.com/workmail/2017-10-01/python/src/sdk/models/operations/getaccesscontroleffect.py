...
class GetAccessControlEffectHeaders:
    x_amz_target: GetAccessControlEffectXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetAccessControlEffectRequest:
    headers: GetAccessControlEffectHeaders = field()
    request: shared.GetAccessControlEffectRequest = field(metadata={'request': { 'media_type': 'application/json' }})
