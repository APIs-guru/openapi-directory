...
class CancelMailboxExportJobHeaders:
    x_amz_target: CancelMailboxExportJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CancelMailboxExportJobRequest:
    headers: CancelMailboxExportJobHeaders = field()
    request: shared.CancelMailboxExportJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
