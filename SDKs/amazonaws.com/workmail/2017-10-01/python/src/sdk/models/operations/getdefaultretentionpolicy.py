...
class GetDefaultRetentionPolicyHeaders:
    x_amz_target: GetDefaultRetentionPolicyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetDefaultRetentionPolicyRequest:
    headers: GetDefaultRetentionPolicyHeaders = field()
    request: shared.GetDefaultRetentionPolicyRequest = field(metadata={'request': { 'media_type': 'application/json' }})
