...
class DeleteMailboxPermissionsHeaders:
    ...
    x_amz_target: DeleteMailboxPermissionsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeleteMailboxPermissionsRequest:
    headers: DeleteMailboxPermissionsHeaders = field(default=None)
    request: shared.DeleteMailboxPermissionsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class DeleteMailboxPermissionsResponse:
    content_type: str = field(default=None)
    delete_mailbox_permissions_response: Optional[dict[str, Any]] = field(default=None)
