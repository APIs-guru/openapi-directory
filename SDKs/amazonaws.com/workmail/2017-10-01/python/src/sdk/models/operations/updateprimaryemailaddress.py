...
class UpdatePrimaryEmailAddressHeaders:
    ...
    x_amz_target: UpdatePrimaryEmailAddressXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdatePrimaryEmailAddressRequest:
    headers: UpdatePrimaryEmailAddressHeaders = field(default=None)
    request: shared.UpdatePrimaryEmailAddressRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
