...
class GetMailboxDetailsHeaders:
    ...
    x_amz_target: GetMailboxDetailsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetMailboxDetailsRequest:
    headers: GetMailboxDetailsHeaders = field(default=None)
    request: shared.GetMailboxDetailsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
