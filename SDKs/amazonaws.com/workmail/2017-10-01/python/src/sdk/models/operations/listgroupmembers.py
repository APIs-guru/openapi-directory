...
class ListGroupMembersHeaders:
    x_amz_target: ListGroupMembersXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListGroupMembersRequest:
    headers: ListGroupMembersHeaders = field()
    query_params: ListGroupMembersQueryParams = field()
    request: shared.ListGroupMembersRequest = field(metadata={'request': { 'media_type': 'application/json' }})
