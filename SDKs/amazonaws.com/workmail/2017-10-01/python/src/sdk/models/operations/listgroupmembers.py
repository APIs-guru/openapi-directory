...
class ListGroupMembersHeaders:
    ...
    x_amz_target: ListGroupMembersXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ListGroupMembersRequest:
    query_params: ListGroupMembersQueryParams = field(default=None)
    headers: ListGroupMembersHeaders = field(default=None)
    request: shared.ListGroupMembersRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
