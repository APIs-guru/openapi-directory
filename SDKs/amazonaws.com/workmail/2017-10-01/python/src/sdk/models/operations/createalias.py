...
class CreateAliasHeaders:
    x_amz_target: CreateAliasXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateAliasRequest:
    ...
    request: shared.CreateAliasRequest = field(metadata={'request': { 'media_type': 'application/json' }})
...
class CreateAliasResponse:
    ...
    create_alias_response: Optional[dict[str, Any]] = field(default=None)
