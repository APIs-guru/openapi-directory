...
class ListOrganizationsHeaders:
    x_amz_target: ListOrganizationsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListOrganizationsRequest:
    headers: ListOrganizationsHeaders = field()
    query_params: ListOrganizationsQueryParams = field()
    request: shared.ListOrganizationsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
