...
class PutAccessControlRuleHeaders:
    x_amz_target: PutAccessControlRuleXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutAccessControlRuleRequest:
    headers: PutAccessControlRuleHeaders = field()
    request: shared.PutAccessControlRuleRequest = field(metadata={'request': { 'media_type': 'application/json' }})
