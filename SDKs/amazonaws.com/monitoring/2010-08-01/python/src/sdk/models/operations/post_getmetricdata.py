...
class PostGetMetricDataQueryParams:
    action: PostGetMetricDataActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostGetMetricDataVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostGetMetricDataRequest:
    headers: PostGetMetricDataHeaders = field()
    query_params: PostGetMetricDataQueryParams = field()
