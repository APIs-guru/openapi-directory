...
class PostDescribeInsightRulesQueryParams:
    action: PostDescribeInsightRulesActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeInsightRulesVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeInsightRulesRequest:
    headers: PostDescribeInsightRulesHeaders = field()
    query_params: PostDescribeInsightRulesQueryParams = field()
