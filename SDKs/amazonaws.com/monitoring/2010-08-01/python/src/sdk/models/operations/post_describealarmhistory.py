...
class PostDescribeAlarmHistoryQueryParams:
    action: PostDescribeAlarmHistoryActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeAlarmHistoryVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeAlarmHistoryRequest:
    headers: PostDescribeAlarmHistoryHeaders = field()
    query_params: PostDescribeAlarmHistoryQueryParams = field()
