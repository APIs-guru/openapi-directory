...
class PostDeleteInsightRulesQueryParams:
    action: PostDeleteInsightRulesActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDeleteInsightRulesVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDeleteInsightRulesRequest:
    headers: PostDeleteInsightRulesHeaders = field()
    query_params: PostDeleteInsightRulesQueryParams = field()
