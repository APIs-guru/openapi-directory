...
class GetUntagResourceQueryParams:
    action: GetUntagResourceActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetUntagResourceVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetUntagResourceRequest:
    headers: GetUntagResourceHeaders = field()
    query_params: GetUntagResourceQueryParams = field()
