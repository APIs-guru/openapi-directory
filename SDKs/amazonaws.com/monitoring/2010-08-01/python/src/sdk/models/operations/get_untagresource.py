...
class GetUntagResourceQueryParams:
    action: GetUntagResourceActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetUntagResourceVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetUntagResourceRequest:
    query_params: GetUntagResourceQueryParams = field(default=None)
    headers: GetUntagResourceHeaders = field(default=None)
