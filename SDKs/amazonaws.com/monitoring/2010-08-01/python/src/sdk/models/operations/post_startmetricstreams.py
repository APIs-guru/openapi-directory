...
class PostStartMetricStreamsQueryParams:
    action: PostStartMetricStreamsActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostStartMetricStreamsVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostStartMetricStreamsRequest:
    headers: PostStartMetricStreamsHeaders = field()
    query_params: PostStartMetricStreamsQueryParams = field()
