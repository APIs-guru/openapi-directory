...
class GetGetAccessKeyInfoQueryParams:
    ...
    action: GetGetAccessKeyInfoActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetGetAccessKeyInfoVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetGetAccessKeyInfoRequest:
    query_params: GetGetAccessKeyInfoQueryParams = field(default=None)
    headers: GetGetAccessKeyInfoHeaders = field(default=None)
