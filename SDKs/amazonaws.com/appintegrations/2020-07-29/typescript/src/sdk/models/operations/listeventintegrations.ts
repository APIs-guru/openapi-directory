...
export class ListEventIntegrationsQueryParams extends SpeakeasyBase {
...
export class ListEventIntegrationsHeaders extends SpeakeasyBase {
...
export class ListEventIntegrationsRequest extends SpeakeasyBase {
  @Metadata()
