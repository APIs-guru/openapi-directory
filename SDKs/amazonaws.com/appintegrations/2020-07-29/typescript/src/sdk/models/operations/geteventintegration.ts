...
export class GetEventIntegrationPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=Name" })
  name: string;
}


export class GetEventIntegrationHeaders extends SpeakeasyBase {
...
export class GetEventIntegrationRequest extends SpeakeasyBase {
  @Metadata()
