...
export class ListEventIntegrationAssociationsPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=Name" })
  name: string;
}


export class ListEventIntegrationAssociationsQueryParams extends SpeakeasyBase {
...
export class ListEventIntegrationAssociationsHeaders extends SpeakeasyBase {
