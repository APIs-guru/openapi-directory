...
class CreateEventIntegrationRequestBody:
    ...
    event_bridge_bus: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'EventBridgeBus' }})
    event_filter: CreateEventIntegrationRequestBodyEventFilter = field(default=None, metadata={'dataclasses_json': { 'field_name': 'EventFilter' }})
...
class CreateEventIntegrationRequest:
    headers: CreateEventIntegrationHeaders = field(default=None)
    request: CreateEventIntegrationRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
