...
class UpdateListenerHeaders:
    x_amz_target: UpdateListenerXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateListenerRequest:
    headers: UpdateListenerHeaders = field()
    request: shared.UpdateListenerRequest = field(metadata={'request': { 'media_type': 'application/json' }})
