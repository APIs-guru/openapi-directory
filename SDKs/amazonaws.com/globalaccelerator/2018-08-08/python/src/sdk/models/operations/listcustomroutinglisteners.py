...
class ListCustomRoutingListenersHeaders:
    x_amz_target: ListCustomRoutingListenersXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListCustomRoutingListenersRequest:
    headers: ListCustomRoutingListenersHeaders = field()
    query_params: ListCustomRoutingListenersQueryParams = field()
    request: shared.ListCustomRoutingListenersRequest = field(metadata={'request': { 'media_type': 'application/json' }})
