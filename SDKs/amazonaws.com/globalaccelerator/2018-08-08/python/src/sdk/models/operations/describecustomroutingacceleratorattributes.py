...
class DescribeCustomRoutingAcceleratorAttributesHeaders:
    ...
    x_amz_target: DescribeCustomRoutingAcceleratorAttributesXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeCustomRoutingAcceleratorAttributesRequest:
    headers: DescribeCustomRoutingAcceleratorAttributesHeaders = field(default=None)
    request: shared.DescribeCustomRoutingAcceleratorAttributesRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
