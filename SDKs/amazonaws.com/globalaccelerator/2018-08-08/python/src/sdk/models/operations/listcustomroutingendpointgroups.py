...
class ListCustomRoutingEndpointGroupsHeaders:
    x_amz_target: ListCustomRoutingEndpointGroupsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListCustomRoutingEndpointGroupsRequest:
    headers: ListCustomRoutingEndpointGroupsHeaders = field()
    query_params: ListCustomRoutingEndpointGroupsQueryParams = field()
    request: shared.ListCustomRoutingEndpointGroupsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
