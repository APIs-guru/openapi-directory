...
class DescribeCustomRoutingListenerHeaders:
    x_amz_target: DescribeCustomRoutingListenerXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeCustomRoutingListenerRequest:
    headers: DescribeCustomRoutingListenerHeaders = field()
    request: shared.DescribeCustomRoutingListenerRequest = field(metadata={'request': { 'media_type': 'application/json' }})
