...
class UpdateCustomRoutingListenerHeaders:
    x_amz_target: UpdateCustomRoutingListenerXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateCustomRoutingListenerRequest:
    headers: UpdateCustomRoutingListenerHeaders = field()
    request: shared.UpdateCustomRoutingListenerRequest = field(metadata={'request': { 'media_type': 'application/json' }})
