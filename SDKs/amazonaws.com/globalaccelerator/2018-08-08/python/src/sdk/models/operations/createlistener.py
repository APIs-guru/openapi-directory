...
class CreateListenerHeaders:
    ...
    x_amz_target: CreateListenerXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateListenerRequest:
    headers: CreateListenerHeaders = field(default=None)
    request: shared.CreateListenerRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
