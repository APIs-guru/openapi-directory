...
class DescribeAcceleratorHeaders:
    x_amz_target: DescribeAcceleratorXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeAcceleratorRequest:
    headers: DescribeAcceleratorHeaders = field()
    request: shared.DescribeAcceleratorRequest = field(metadata={'request': { 'media_type': 'application/json' }})
