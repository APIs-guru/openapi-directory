...
class RemoveCustomRoutingEndpointsHeaders:
    x_amz_target: RemoveCustomRoutingEndpointsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RemoveCustomRoutingEndpointsRequest:
    headers: RemoveCustomRoutingEndpointsHeaders = field()
    request: shared.RemoveCustomRoutingEndpointsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
