...
class DescribeCustomRoutingAcceleratorHeaders:
    x_amz_target: DescribeCustomRoutingAcceleratorXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeCustomRoutingAcceleratorRequest:
    headers: DescribeCustomRoutingAcceleratorHeaders = field()
    request: shared.DescribeCustomRoutingAcceleratorRequest = field(metadata={'request': { 'media_type': 'application/json' }})
