...
class UpdateAcceleratorAttributesHeaders:
    x_amz_target: UpdateAcceleratorAttributesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateAcceleratorAttributesRequest:
    headers: UpdateAcceleratorAttributesHeaders = field()
    request: shared.UpdateAcceleratorAttributesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
