...
class ListCustomRoutingPortMappingsByDestinationHeaders:
    ...
    x_amz_target: ListCustomRoutingPortMappingsByDestinationXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
