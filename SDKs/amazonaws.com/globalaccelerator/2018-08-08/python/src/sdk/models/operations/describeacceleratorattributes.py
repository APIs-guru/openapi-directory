...
class DescribeAcceleratorAttributesHeaders:
    ...
    x_amz_target: DescribeAcceleratorAttributesXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeAcceleratorAttributesRequest:
    headers: DescribeAcceleratorAttributesHeaders = field(default=None)
    request: shared.DescribeAcceleratorAttributesRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
