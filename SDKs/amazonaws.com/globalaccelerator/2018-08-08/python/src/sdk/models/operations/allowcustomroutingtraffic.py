...
class AllowCustomRoutingTrafficHeaders:
    x_amz_target: AllowCustomRoutingTrafficXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AllowCustomRoutingTrafficRequest:
    headers: AllowCustomRoutingTrafficHeaders = field()
    request: shared.AllowCustomRoutingTrafficRequest = field(metadata={'request': { 'media_type': 'application/json' }})
