...
class DeleteEndpointGroupHeaders:
    ...
    x_amz_target: DeleteEndpointGroupXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
    

@dataclass
class DeleteEndpointGroupRequest:
    headers: DeleteEndpointGroupHeaders = field(default=None)
    request: shared.DeleteEndpointGroupRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
