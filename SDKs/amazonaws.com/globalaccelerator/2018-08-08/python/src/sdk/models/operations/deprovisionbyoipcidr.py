...
class DeprovisionByoipCidrHeaders:
    ...
    x_amz_target: DeprovisionByoipCidrXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeprovisionByoipCidrRequest:
    headers: DeprovisionByoipCidrHeaders = field(default=None)
    request: shared.DeprovisionByoipCidrRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
