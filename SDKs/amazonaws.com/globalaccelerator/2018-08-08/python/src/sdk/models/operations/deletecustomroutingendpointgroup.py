...
class DeleteCustomRoutingEndpointGroupHeaders:
    x_amz_target: DeleteCustomRoutingEndpointGroupXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteCustomRoutingEndpointGroupRequest:
    headers: DeleteCustomRoutingEndpointGroupHeaders = field()
    request: shared.DeleteCustomRoutingEndpointGroupRequest = field(metadata={'request': { 'media_type': 'application/json' }})
