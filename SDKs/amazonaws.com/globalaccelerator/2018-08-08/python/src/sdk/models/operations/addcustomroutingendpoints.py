...
class AddCustomRoutingEndpointsHeaders:
    x_amz_target: AddCustomRoutingEndpointsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AddCustomRoutingEndpointsRequest:
    headers: AddCustomRoutingEndpointsHeaders = field()
    request: shared.AddCustomRoutingEndpointsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
