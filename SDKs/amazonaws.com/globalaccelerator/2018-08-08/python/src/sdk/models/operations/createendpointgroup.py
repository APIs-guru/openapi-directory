...
class CreateEndpointGroupHeaders:
    x_amz_target: CreateEndpointGroupXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateEndpointGroupRequest:
    headers: CreateEndpointGroupHeaders = field()
    request: shared.CreateEndpointGroupRequest = field(metadata={'request': { 'media_type': 'application/json' }})
