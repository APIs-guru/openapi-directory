...
class CreateCustomRoutingListenerHeaders:
    ...
    x_amz_target: CreateCustomRoutingListenerXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateCustomRoutingListenerRequest:
    headers: CreateCustomRoutingListenerHeaders = field(default=None)
    request: shared.CreateCustomRoutingListenerRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
