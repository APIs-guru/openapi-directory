...
class DeleteListenerHeaders:
    x_amz_target: DeleteListenerXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteListenerRequest:
    headers: DeleteListenerHeaders = field()
    request: shared.DeleteListenerRequest = field(metadata={'request': { 'media_type': 'application/json' }})
