...
class UpdateCustomRoutingAcceleratorAttributesHeaders:
    x_amz_target: UpdateCustomRoutingAcceleratorAttributesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateCustomRoutingAcceleratorAttributesRequest:
    headers: UpdateCustomRoutingAcceleratorAttributesHeaders = field()
    request: shared.UpdateCustomRoutingAcceleratorAttributesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
