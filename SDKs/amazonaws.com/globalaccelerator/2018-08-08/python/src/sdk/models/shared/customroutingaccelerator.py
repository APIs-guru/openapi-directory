...
from . import ipset
from . import customroutingacceleratorstatus_enum
...
class CustomRoutingAccelerator:
    ...
    status: Optional[customroutingacceleratorstatus_enum.CustomRoutingAcceleratorStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Status' }})
