...
class UpdateCustomRoutingAcceleratorHeaders:
    x_amz_target: UpdateCustomRoutingAcceleratorXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateCustomRoutingAcceleratorRequest:
    headers: UpdateCustomRoutingAcceleratorHeaders = field()
    request: shared.UpdateCustomRoutingAcceleratorRequest = field(metadata={'request': { 'media_type': 'application/json' }})
