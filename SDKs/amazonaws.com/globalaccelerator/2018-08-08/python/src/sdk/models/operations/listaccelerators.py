...
class ListAcceleratorsHeaders:
    x_amz_target: ListAcceleratorsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListAcceleratorsRequest:
    headers: ListAcceleratorsHeaders = field()
    query_params: ListAcceleratorsQueryParams = field()
    request: shared.ListAcceleratorsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
