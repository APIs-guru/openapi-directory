...
class CreateCustomRoutingEndpointGroupHeaders:
    x_amz_target: CreateCustomRoutingEndpointGroupXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateCustomRoutingEndpointGroupRequest:
    headers: CreateCustomRoutingEndpointGroupHeaders = field()
    request: shared.CreateCustomRoutingEndpointGroupRequest = field(metadata={'request': { 'media_type': 'application/json' }})
