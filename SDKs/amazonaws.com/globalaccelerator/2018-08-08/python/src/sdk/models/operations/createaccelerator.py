...
class CreateAcceleratorHeaders:
    x_amz_target: CreateAcceleratorXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateAcceleratorRequest:
    headers: CreateAcceleratorHeaders = field()
    request: shared.CreateAcceleratorRequest = field(metadata={'request': { 'media_type': 'application/json' }})
