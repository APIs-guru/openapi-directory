...
**/
var ByoipCidrEvent = /** @class */ (function (_super) {
    __extends(ByoipCidrEvent, _super);
    ...
    ], ByoipCidrEvent.prototype, "message", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Timestamp" }),
        __metadata("design:type", Date)
    ], ByoipCidrEvent.prototype, "timestamp", void 0);
    return ByoipCidrEvent;
}(SpeakeasyBase));
export { ByoipCidrEvent };
