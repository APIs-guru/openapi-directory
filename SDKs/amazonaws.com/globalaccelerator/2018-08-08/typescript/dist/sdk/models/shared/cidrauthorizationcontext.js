...
**/
var CidrAuthorizationContext = /** @class */ (function (_super) {
    __extends(CidrAuthorizationContext, _super);
    ...
    ], CidrAuthorizationContext.prototype, "message", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Signature" }),
        __metadata("design:type", String)
    ], CidrAuthorizationContext.prototype, "signature", void 0);
    return CidrAuthorizationContext;
}(SpeakeasyBase));
export { CidrAuthorizationContext };
