...
const (
	ListTagsForResourceXAmzTargetEnumGlobalAcceleratorV20180706ListTagsForResource ListTagsForResourceXAmzTargetEnum = "GlobalAccelerator_V20180706.ListTagsForResource"
)
