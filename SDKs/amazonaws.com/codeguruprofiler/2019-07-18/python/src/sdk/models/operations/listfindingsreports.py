...
class ListFindingsReportsRequest:
    path_params: ListFindingsReportsPathParams = field(default=None)
    query_params: ListFindingsReportsQueryParams = field(default=None)
    headers: ListFindingsReportsHeaders = field(default=None)
