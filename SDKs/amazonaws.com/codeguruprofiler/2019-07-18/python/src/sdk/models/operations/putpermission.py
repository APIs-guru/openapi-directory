...
class PutPermissionPathParams:
    action_group: PutPermissionActionGroupEnum = field(metadata={'path_param': { 'field_name': 'actionGroup', 'style': 'simple', 'explode': False }})
...
class PutPermissionRequest:
    ...
    request: PutPermissionRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
