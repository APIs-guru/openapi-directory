...
export class ListFindingsReportsPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=profilingGroupName" })
  profilingGroupName: string;
}


export class ListFindingsReportsQueryParams extends SpeakeasyBase {
...
export class ListFindingsReportsHeaders extends SpeakeasyBase {
