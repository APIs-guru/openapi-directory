...
class ListStatementsHeaders:
    x_amz_target: ListStatementsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListStatementsRequest:
    headers: ListStatementsHeaders = field()
    query_params: ListStatementsQueryParams = field()
    request: shared.ListStatementsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
