...
class CreateAttributeGroupRequestBody:
    attributes: str = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('attributes') }})
...
class CreateAttributeGroupRequest:
    headers: CreateAttributeGroupHeaders = field()
    request: CreateAttributeGroupRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
