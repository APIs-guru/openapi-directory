...
export class ListAttributeGroupsQueryParams extends SpeakeasyBase {
...
export class ListAttributeGroupsHeaders extends SpeakeasyBase {
...
export class ListAttributeGroupsRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
