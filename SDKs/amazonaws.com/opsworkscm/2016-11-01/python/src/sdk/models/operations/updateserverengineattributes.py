...
class UpdateServerEngineAttributesHeaders:
    ...
    x_amz_target: UpdateServerEngineAttributesXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateServerEngineAttributesRequest:
    headers: UpdateServerEngineAttributesHeaders = field(default=None)
    request: shared.UpdateServerEngineAttributesRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
