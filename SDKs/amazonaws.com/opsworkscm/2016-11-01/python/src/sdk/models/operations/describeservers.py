...
class DescribeServersHeaders:
    x_amz_target: DescribeServersXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeServersRequest:
    headers: DescribeServersHeaders = field()
    query_params: DescribeServersQueryParams = field()
    request: shared.DescribeServersRequest = field(metadata={'request': { 'media_type': 'application/json' }})
