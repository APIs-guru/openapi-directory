...
class DeleteApplicationInputProcessingConfigurationHeaders:
    ...
    x_amz_target: DeleteApplicationInputProcessingConfigurationXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
