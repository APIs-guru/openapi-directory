...
class DeleteApplicationCloudWatchLoggingOptionXAmzTargetEnum(str, Enum):
    KINESIS_ANALYTICS_20150814_DELETE_APPLICATION_CLOUD_WATCH_LOGGING_OPTION = "KinesisAnalytics_20150814.DeleteApplicationCloudWatchLoggingOption"
...
class DeleteApplicationCloudWatchLoggingOptionHeaders:
    ...
    x_amz_target: DeleteApplicationCloudWatchLoggingOptionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteApplicationCloudWatchLoggingOptionResponse:
    ...
    delete_application_cloud_watch_logging_option_response: Optional[dict[str, Any]] = field(default=None)
