...
import { CreateHttpNamespaceRequest, CreateHttpNamespaceResponse } from "openapi/src/sdk/models/operations";
...
sdk.sdk.createHttpNamespace(req).then((res: CreateHttpNamespaceResponse | AxiosError) => {
   // handle response
});
```
