...
class UpdateInstanceCustomHealthStatusHeaders:
    x_amz_target: UpdateInstanceCustomHealthStatusXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateInstanceCustomHealthStatusRequest:
    headers: UpdateInstanceCustomHealthStatusHeaders = field()
    request: shared.UpdateInstanceCustomHealthStatusRequest = field(metadata={'request': { 'media_type': 'application/json' }})
