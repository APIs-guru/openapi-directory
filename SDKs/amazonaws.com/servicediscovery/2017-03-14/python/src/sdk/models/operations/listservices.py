...
class ListServicesHeaders:
    x_amz_target: ListServicesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListServicesRequest:
    headers: ListServicesHeaders = field()
    query_params: ListServicesQueryParams = field()
    request: shared.ListServicesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
