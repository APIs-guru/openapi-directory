...
class UpdatePublicDNSNamespaceHeaders:
    x_amz_target: UpdatePublicDNSNamespaceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdatePublicDNSNamespaceRequest:
    headers: UpdatePublicDNSNamespaceHeaders = field()
    request: shared.UpdatePublicDNSNamespaceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
