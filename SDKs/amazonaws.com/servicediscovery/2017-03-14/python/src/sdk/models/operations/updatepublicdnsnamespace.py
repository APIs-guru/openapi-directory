...
class UpdatePublicDNSNamespaceHeaders:
    ...
    x_amz_target: UpdatePublicDNSNamespaceXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdatePublicDNSNamespaceRequest:
    headers: UpdatePublicDNSNamespaceHeaders = field(default=None)
    request: shared.UpdatePublicDNSNamespaceRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class UpdatePublicDNSNamespaceResponse:
    ...
    update_public_dns_namespace_response: Optional[shared.UpdatePublicDNSNamespaceResponse] = field(default=None)
