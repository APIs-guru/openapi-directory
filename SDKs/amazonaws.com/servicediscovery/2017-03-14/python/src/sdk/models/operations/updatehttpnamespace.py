...
class UpdateHTTPNamespaceHeaders:
    x_amz_target: UpdateHTTPNamespaceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateHTTPNamespaceRequest:
    headers: UpdateHTTPNamespaceHeaders = field()
    request: shared.UpdateHTTPNamespaceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
