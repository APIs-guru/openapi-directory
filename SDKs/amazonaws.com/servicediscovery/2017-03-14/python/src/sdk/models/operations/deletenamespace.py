...
class DeleteNamespaceHeaders:
    x_amz_target: DeleteNamespaceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteNamespaceRequest:
    headers: DeleteNamespaceHeaders = field()
    request: shared.DeleteNamespaceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
