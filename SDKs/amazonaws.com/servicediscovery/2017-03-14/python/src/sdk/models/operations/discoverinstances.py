...
class DiscoverInstancesHeaders:
    x_amz_target: DiscoverInstancesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DiscoverInstancesRequest:
    headers: DiscoverInstancesHeaders = field()
    request: shared.DiscoverInstancesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
