...
class GetInstancesHealthStatusHeaders:
    x_amz_target: GetInstancesHealthStatusXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetInstancesHealthStatusRequest:
    headers: GetInstancesHealthStatusHeaders = field()
    query_params: GetInstancesHealthStatusQueryParams = field()
    request: shared.GetInstancesHealthStatusRequest = field(metadata={'request': { 'media_type': 'application/json' }})
