...
class UpdatePrivateDNSNamespaceHeaders:
    x_amz_target: UpdatePrivateDNSNamespaceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdatePrivateDNSNamespaceRequest:
    headers: UpdatePrivateDNSNamespaceHeaders = field()
    request: shared.UpdatePrivateDNSNamespaceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
