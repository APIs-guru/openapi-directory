...
// SDK Documentation: https://docs.aws.amazon.com/apprunner/ - Amazon Web Services documentation
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.AssociateCustomDomain = function (req, config) {
        ...
        var url = baseURL.replace(/\/$/, "") + "/#X-Amz-Target=AppRunner.AssociateCustomDomain";
            ...
            switch (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) {
                case 200:
                    if (MatchContentType(contentType, "application/json")) {
                        res.associateCustomDomainResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case 480:
                    if (MatchContentType(contentType, "application/json")) {
    ...
    SDK.prototype.CreateAutoScalingConfiguration = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/#X-Amz-Target=AppRunner.CreateAutoScalingConfiguration";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return client
            ...
            switch (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) {
                case 200:
                    if (MatchContentType(contentType, "application/json")) {
                        res.createAutoScalingConfigurationResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case 480:
                    if (MatchContentType(contentType, "application/json")) {
    ...
    SDK.prototype.DeleteAutoScalingConfiguration = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/#X-Amz-Target=AppRunner.DeleteAutoScalingConfiguration";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return client
            ...
            switch (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) {
                case 200:
                    if (MatchContentType(contentType, "application/json")) {
                        res.deleteAutoScalingConfigurationResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case 480:
                    if (MatchContentType(contentType, "application/json")) {
    ...
    SDK.prototype.DescribeAutoScalingConfiguration = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/#X-Amz-Target=AppRunner.DescribeAutoScalingConfiguration";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return client
            ...
            switch (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) {
                case 200:
                    if (MatchContentType(contentType, "application/json")) {
                        res.describeAutoScalingConfigurationResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case 480:
                    if (MatchContentType(contentType, "application/json")) {
    ...
    SDK.prototype.DescribeCustomDomains = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/#X-Amz-Target=AppRunner.DescribeCustomDomains";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return client
            ...
            switch (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) {
                case 200:
                    if (MatchContentType(contentType, "application/json")) {
                        res.describeCustomDomainsResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case 480:
                    if (MatchContentType(contentType, "application/json")) {
    ...
    SDK.prototype.DisassociateCustomDomain = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/#X-Amz-Target=AppRunner.DisassociateCustomDomain";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return client
            ...
            switch (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) {
                case 200:
                    if (MatchContentType(contentType, "application/json")) {
                        res.disassociateCustomDomainResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case 480:
                    if (MatchContentType(contentType, "application/json")) {
    ...
    SDK.prototype.ListAutoScalingConfigurations = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/#X-Amz-Target=AppRunner.ListAutoScalingConfigurations";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return client
            ...
            switch (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) {
                case 200:
                    if (MatchContentType(contentType, "application/json")) {
                        res.listAutoScalingConfigurationsResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case 480:
                    if (MatchContentType(contentType, "application/json")) {
    ...
    SDK.prototype.ListTagsForResource = function (req, config) {
        ...
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/#X-Amz-Target=AppRunner.ListTagsForResource";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    SDK.prototype.PauseService = function (req, config) {
        ...
        return client
            ...
            switch (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) {
                case 200:
                    if (MatchContentType(contentType, "application/json")) {
                        res.pauseServiceResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case 480:
                    if (MatchContentType(contentType, "application/json")) {
    ...
    SDK.prototype.ResumeService = function (req, config) {
        ...
        return client
            ...
            switch (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) {
                case 200:
                    if (MatchContentType(contentType, "application/json")) {
                        res.resumeServiceResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case 480:
                    if (MatchContentType(contentType, "application/json")) {
    ...
    SDK.prototype.StartDeployment = function (req, config) {
        ...
        return client
            ...
            switch (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) {
                case 200:
                    if (MatchContentType(contentType, "application/json")) {
                        res.startDeploymentResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case 480:
                    if (MatchContentType(contentType, "application/json")) {
