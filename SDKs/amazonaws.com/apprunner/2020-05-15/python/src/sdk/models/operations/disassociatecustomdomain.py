...
class DisassociateCustomDomainHeaders:
    x_amz_target: DisassociateCustomDomainXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DisassociateCustomDomainRequest:
    headers: DisassociateCustomDomainHeaders = field()
    request: shared.DisassociateCustomDomainRequest = field(metadata={'request': { 'media_type': 'application/json' }})
