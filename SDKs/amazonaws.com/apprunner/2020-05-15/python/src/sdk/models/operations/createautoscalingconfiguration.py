...
class CreateAutoScalingConfigurationHeaders:
    x_amz_target: CreateAutoScalingConfigurationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateAutoScalingConfigurationRequest:
    headers: CreateAutoScalingConfigurationHeaders = field()
    request: shared.CreateAutoScalingConfigurationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
