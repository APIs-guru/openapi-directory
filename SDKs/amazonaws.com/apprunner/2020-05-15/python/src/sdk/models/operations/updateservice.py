...
class UpdateServiceHeaders:
    x_amz_target: UpdateServiceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateServiceRequest:
    headers: UpdateServiceHeaders = field()
    request: shared.UpdateServiceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
