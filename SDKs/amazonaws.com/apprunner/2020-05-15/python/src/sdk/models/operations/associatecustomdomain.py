...
class AssociateCustomDomainHeaders:
    x_amz_target: AssociateCustomDomainXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AssociateCustomDomainRequest:
    headers: AssociateCustomDomainHeaders = field()
    request: shared.AssociateCustomDomainRequest = field(metadata={'request': { 'media_type': 'application/json' }})
