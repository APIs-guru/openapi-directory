...
class DescribeServiceHeaders:
    x_amz_target: DescribeServiceXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeServiceRequest:
    headers: DescribeServiceHeaders = field()
    request: shared.DescribeServiceRequest = field(metadata={'request': { 'media_type': 'application/json' }})
