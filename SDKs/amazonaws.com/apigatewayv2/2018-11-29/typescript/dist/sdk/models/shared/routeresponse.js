...
var RouteResponse = /** @class */ (function (_super) {
    ...
    ], RouteResponse.prototype, "modelSelectionExpression", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ResponseModels" }),
        __metadata("design:type", Map)
    ], RouteResponse.prototype, "responseModels", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ResponseParameters", elemType: ParameterConstraints }),
        __metadata("design:type", Map)
    ], RouteResponse.prototype, "responseParameters", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=RouteResponseId" }),
        __metadata("design:type", String)
    ], RouteResponse.prototype, "routeResponseId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=RouteResponseKey" }),
        __metadata("design:type", String)
    ], RouteResponse.prototype, "routeResponseKey", void 0);
