...
class UpdateModelRequest:
    headers: UpdateModelHeaders = field()
    path_params: UpdateModelPathParams = field()
    request: UpdateModelRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
