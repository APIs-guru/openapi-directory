...
class CreateModelRequest:
    path_params: CreateModelPathParams = field(default=None)
    headers: CreateModelHeaders = field(default=None)
    request: CreateModelRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
