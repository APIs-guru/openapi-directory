...
class CreateIntegrationResponseRequestBody:
    content_handling_strategy: Optional[CreateIntegrationResponseRequestBodyContentHandlingStrategyEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'contentHandlingStrategy' }})
    integration_response_key: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'integrationResponseKey' }})
...
class CreateIntegrationResponseRequest:
    path_params: CreateIntegrationResponsePathParams = field(default=None)
    headers: CreateIntegrationResponseHeaders = field(default=None)
    request: CreateIntegrationResponseRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
