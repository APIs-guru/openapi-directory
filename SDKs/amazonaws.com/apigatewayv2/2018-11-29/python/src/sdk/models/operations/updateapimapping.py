...
class UpdateAPIMappingRequest:
    headers: UpdateAPIMappingHeaders = field()
    path_params: UpdateAPIMappingPathParams = field()
    request: UpdateAPIMappingRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
