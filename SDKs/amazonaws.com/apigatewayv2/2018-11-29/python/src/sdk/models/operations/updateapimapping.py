...
@dataclass
class UpdateAPIMappingPathParams:
...
class UpdateAPIMappingRequest:
    path_params: UpdateAPIMappingPathParams = field(default=None)
    headers: UpdateAPIMappingHeaders = field(default=None)
    request: UpdateAPIMappingRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateAPIMappingResponse:
    ...
    update_api_mapping_response: Optional[shared.UpdateAPIMappingResponse] = field(default=None)
