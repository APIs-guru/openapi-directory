...
class UpdateAuthorizerPathParams:
    ...
    authorizer_id: str = field(metadata={'path_param': { 'field_name': 'authorizerId', 'style': 'simple', 'explode': False }})
...
class UpdateAuthorizerRequestBody:
    ...
    authorizer_type: Optional[UpdateAuthorizerRequestBodyAuthorizerTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('authorizerType') }})
    ...
    jwt_configuration: Optional[UpdateAuthorizerRequestBodyJwtConfiguration] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('jwtConfiguration') }})
