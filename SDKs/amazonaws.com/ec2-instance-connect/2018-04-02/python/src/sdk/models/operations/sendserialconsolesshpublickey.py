...
class SendSerialConsoleSSHPublicKeyHeaders:
    x_amz_target: SendSerialConsoleSSHPublicKeyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class SendSerialConsoleSSHPublicKeyRequest:
    headers: SendSerialConsoleSSHPublicKeyHeaders = field()
    request: shared.SendSerialConsoleSSHPublicKeyRequest = field(metadata={'request': { 'media_type': 'application/json' }})
