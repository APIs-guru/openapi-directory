...
class ListTagsForStreamHeaders:
    x_amz_target: ListTagsForStreamXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListTagsForStreamRequest:
    ...
    request: shared.ListTagsForStreamInput = field(metadata={'request': { 'media_type': 'application/json' }})
