...
class IncreaseStreamRetentionPeriodHeaders:
    x_amz_target: IncreaseStreamRetentionPeriodXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class IncreaseStreamRetentionPeriodRequest:
    headers: IncreaseStreamRetentionPeriodHeaders = field()
    request: shared.IncreaseStreamRetentionPeriodInput = field(metadata={'request': { 'media_type': 'application/json' }})
