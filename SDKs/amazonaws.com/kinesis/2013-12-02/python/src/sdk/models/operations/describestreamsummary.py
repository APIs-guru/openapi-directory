...
class DescribeStreamSummaryHeaders:
    x_amz_target: DescribeStreamSummaryXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeStreamSummaryRequest:
    headers: DescribeStreamSummaryHeaders = field()
    request: shared.DescribeStreamSummaryInput = field(metadata={'request': { 'media_type': 'application/json' }})
