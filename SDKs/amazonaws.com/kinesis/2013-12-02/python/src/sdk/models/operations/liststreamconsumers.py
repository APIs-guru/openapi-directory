...
class ListStreamConsumersHeaders:
    x_amz_target: ListStreamConsumersXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListStreamConsumersRequest:
    headers: ListStreamConsumersHeaders = field()
    query_params: ListStreamConsumersQueryParams = field()
    request: shared.ListStreamConsumersInput = field(metadata={'request': { 'media_type': 'application/json' }})
