...
class ListShardsHeaders:
    x_amz_target: ListShardsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListShardsRequest:
    headers: ListShardsHeaders = field()
    request: shared.ListShardsInput = field(metadata={'request': { 'media_type': 'application/json' }})
