...
class PutRecordsHeaders:
    ...
    x_amz_target: PutRecordsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class PutRecordsRequest:
    headers: PutRecordsHeaders = field(default=None)
    request: shared.PutRecordsInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class PutRecordsResponse:
    ...
    put_records_output: Optional[shared.PutRecordsOutput] = field(default=None)
