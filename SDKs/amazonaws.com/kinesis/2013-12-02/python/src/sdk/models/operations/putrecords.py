...
class PutRecordsHeaders:
    x_amz_target: PutRecordsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutRecordsRequest:
    headers: PutRecordsHeaders = field()
    request: shared.PutRecordsInput = field(metadata={'request': { 'media_type': 'application/json' }})
