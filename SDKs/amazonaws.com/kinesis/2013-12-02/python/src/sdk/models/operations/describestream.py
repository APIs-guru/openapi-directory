...
class DescribeStreamHeaders:
    x_amz_target: DescribeStreamXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeStreamRequest:
    ...
    query_params: DescribeStreamQueryParams = field()
    request: shared.DescribeStreamInput = field(metadata={'request': { 'media_type': 'application/json' }})
