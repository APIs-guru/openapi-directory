...
class EnableEnhancedMonitoringHeaders:
    x_amz_target: EnableEnhancedMonitoringXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class EnableEnhancedMonitoringRequest:
    headers: EnableEnhancedMonitoringHeaders = field()
    request: shared.EnableEnhancedMonitoringInput = field(metadata={'request': { 'media_type': 'application/json' }})
