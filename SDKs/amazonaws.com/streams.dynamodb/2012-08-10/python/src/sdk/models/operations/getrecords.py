...
class GetRecordsHeaders:
    x_amz_target: GetRecordsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetRecordsRequest:
    headers: GetRecordsHeaders = field()
    request: shared.GetRecordsInput = field(metadata={'request': { 'media_type': 'application/json' }})
