...
**/
var RecordMarkerDecisionAttributes = /** @class */ (function (_super) {
    __extends(RecordMarkerDecisionAttributes, _super);
    ...
    ], RecordMarkerDecisionAttributes.prototype, "details", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=markerName" }),
        __metadata("design:type", String)
    ], RecordMarkerDecisionAttributes.prototype, "markerName", void 0);
    return RecordMarkerDecisionAttributes;
}(SpeakeasyBase));
export { RecordMarkerDecisionAttributes };
