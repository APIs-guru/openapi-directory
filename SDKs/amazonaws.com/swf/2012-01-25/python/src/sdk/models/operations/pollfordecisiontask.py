...
class PollForDecisionTaskHeaders:
    x_amz_target: PollForDecisionTaskXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PollForDecisionTaskRequest:
    headers: PollForDecisionTaskHeaders = field()
    query_params: PollForDecisionTaskQueryParams = field()
    request: shared.PollForDecisionTaskInput = field(metadata={'request': { 'media_type': 'application/json' }})
