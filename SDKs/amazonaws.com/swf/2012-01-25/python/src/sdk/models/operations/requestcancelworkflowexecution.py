...
class RequestCancelWorkflowExecutionHeaders:
    x_amz_target: RequestCancelWorkflowExecutionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RequestCancelWorkflowExecutionRequest:
    headers: RequestCancelWorkflowExecutionHeaders = field()
    request: shared.RequestCancelWorkflowExecutionInput = field(metadata={'request': { 'media_type': 'application/json' }})
