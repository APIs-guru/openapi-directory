...
class SignalWorkflowExecutionHeaders:
    ...
    x_amz_target: SignalWorkflowExecutionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class SignalWorkflowExecutionRequest:
    headers: SignalWorkflowExecutionHeaders = field(default=None)
    request: shared.SignalWorkflowExecutionInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
