...
from . import requestcancelactivitytaskfailedcause_enum
...
class RequestCancelActivityTaskFailedEventAttributes:
    ...
    cause: requestcancelactivitytaskfailedcause_enum.RequestCancelActivityTaskFailedCauseEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'cause' }})
