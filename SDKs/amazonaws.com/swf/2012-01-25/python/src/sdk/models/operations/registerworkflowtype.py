...
class RegisterWorkflowTypeHeaders:
    x_amz_target: RegisterWorkflowTypeXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RegisterWorkflowTypeRequest:
    headers: RegisterWorkflowTypeHeaders = field()
    request: shared.RegisterWorkflowTypeInput = field(metadata={'request': { 'media_type': 'application/json' }})
