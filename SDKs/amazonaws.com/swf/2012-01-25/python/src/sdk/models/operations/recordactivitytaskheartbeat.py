...
class RecordActivityTaskHeartbeatHeaders:
    x_amz_target: RecordActivityTaskHeartbeatXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RecordActivityTaskHeartbeatRequest:
    headers: RecordActivityTaskHeartbeatHeaders = field()
    request: shared.RecordActivityTaskHeartbeatInput = field(metadata={'request': { 'media_type': 'application/json' }})
