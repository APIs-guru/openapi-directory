...
class ListActivityTypesHeaders:
    x_amz_target: ListActivityTypesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListActivityTypesRequest:
    headers: ListActivityTypesHeaders = field()
    query_params: ListActivityTypesQueryParams = field()
    request: shared.ListActivityTypesInput = field(metadata={'request': { 'media_type': 'application/json' }})
