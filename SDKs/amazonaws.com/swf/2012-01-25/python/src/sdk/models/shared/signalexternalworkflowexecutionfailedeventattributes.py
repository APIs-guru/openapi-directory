...
from . import signalexternalworkflowexecutionfailedcause_enum


@dataclass_json
@dataclass
class SignalExternalWorkflowExecutionFailedEventAttributes:
    cause: signalexternalworkflowexecutionfailedcause_enum.SignalExternalWorkflowExecutionFailedCauseEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'cause' }})
