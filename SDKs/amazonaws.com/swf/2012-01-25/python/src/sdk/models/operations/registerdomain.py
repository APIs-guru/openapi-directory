...
class RegisterDomainHeaders:
    ...
    x_amz_target: RegisterDomainXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
    

@dataclass
class RegisterDomainRequest:
    headers: RegisterDomainHeaders = field(default=None)
    request: shared.RegisterDomainInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
