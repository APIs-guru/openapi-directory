...
class DescribeWorkflowTypeHeaders:
    x_amz_target: DescribeWorkflowTypeXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeWorkflowTypeRequest:
    headers: DescribeWorkflowTypeHeaders = field()
    request: shared.DescribeWorkflowTypeInput = field(metadata={'request': { 'media_type': 'application/json' }})
