...
class DeprecateDomainHeaders:
    x_amz_target: DeprecateDomainXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeprecateDomainRequest:
    headers: DeprecateDomainHeaders = field()
    request: shared.DeprecateDomainInput = field(metadata={'request': { 'media_type': 'application/json' }})
