...
class ListDomainsXAmzTargetEnum(str, Enum):
    SIMPLE_WORKFLOW_SERVICE_LIST_DOMAINS = "SimpleWorkflowService.ListDomains"
...
class ListDomainsHeaders:
    ...
    x_amz_target: ListDomainsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListDomainsRequest:
    ...
    request: shared.ListDomainsInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class ListDomainsResponse:
    content_type: str = field(default=None)
    domain_infos: Optional[shared.DomainInfos] = field(default=None)
