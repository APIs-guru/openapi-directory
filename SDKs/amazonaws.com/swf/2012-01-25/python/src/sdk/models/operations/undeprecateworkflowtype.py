...
class UndeprecateWorkflowTypeHeaders:
    x_amz_target: UndeprecateWorkflowTypeXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UndeprecateWorkflowTypeRequest:
    headers: UndeprecateWorkflowTypeHeaders = field()
    request: shared.UndeprecateWorkflowTypeInput = field(metadata={'request': { 'media_type': 'application/json' }})
