...
class PollForActivityTaskHeaders:
    x_amz_target: PollForActivityTaskXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PollForActivityTaskRequest:
    headers: PollForActivityTaskHeaders = field()
    request: shared.PollForActivityTaskInput = field(metadata={'request': { 'media_type': 'application/json' }})
