...
class DescribeWorkflowExecutionHeaders:
    x_amz_target: DescribeWorkflowExecutionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeWorkflowExecutionRequest:
    headers: DescribeWorkflowExecutionHeaders = field()
    request: shared.DescribeWorkflowExecutionInput = field(metadata={'request': { 'media_type': 'application/json' }})
