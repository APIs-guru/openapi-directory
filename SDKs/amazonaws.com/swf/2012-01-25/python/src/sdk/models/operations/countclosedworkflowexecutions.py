...
class CountClosedWorkflowExecutionsHeaders:
    x_amz_target: CountClosedWorkflowExecutionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CountClosedWorkflowExecutionsRequest:
    headers: CountClosedWorkflowExecutionsHeaders = field()
    request: shared.CountClosedWorkflowExecutionsInput = field(metadata={'request': { 'media_type': 'application/json' }})
