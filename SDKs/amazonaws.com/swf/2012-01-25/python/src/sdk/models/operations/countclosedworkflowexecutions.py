...
class CountClosedWorkflowExecutionsHeaders:
    ...
    x_amz_target: CountClosedWorkflowExecutionsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CountClosedWorkflowExecutionsRequest:
    headers: CountClosedWorkflowExecutionsHeaders = field(default=None)
    request: shared.CountClosedWorkflowExecutionsInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
