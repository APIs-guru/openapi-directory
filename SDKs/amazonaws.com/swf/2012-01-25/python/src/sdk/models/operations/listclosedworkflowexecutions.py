...
class ListClosedWorkflowExecutionsHeaders:
    x_amz_target: ListClosedWorkflowExecutionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListClosedWorkflowExecutionsRequest:
    headers: ListClosedWorkflowExecutionsHeaders = field()
    query_params: ListClosedWorkflowExecutionsQueryParams = field()
    request: shared.ListClosedWorkflowExecutionsInput = field(metadata={'request': { 'media_type': 'application/json' }})
