...
class RegisterActivityTypeHeaders:
    x_amz_target: RegisterActivityTypeXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RegisterActivityTypeRequest:
    headers: RegisterActivityTypeHeaders = field()
    request: shared.RegisterActivityTypeInput = field(metadata={'request': { 'media_type': 'application/json' }})
