...
class CountOpenWorkflowExecutionsHeaders:
    x_amz_target: CountOpenWorkflowExecutionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CountOpenWorkflowExecutionsRequest:
    headers: CountOpenWorkflowExecutionsHeaders = field()
    request: shared.CountOpenWorkflowExecutionsInput = field(metadata={'request': { 'media_type': 'application/json' }})
