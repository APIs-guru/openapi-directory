...
class CountPendingDecisionTasksHeaders:
    ...
    x_amz_target: CountPendingDecisionTasksXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CountPendingDecisionTasksRequest:
    headers: CountPendingDecisionTasksHeaders = field(default=None)
    request: shared.CountPendingDecisionTasksInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
