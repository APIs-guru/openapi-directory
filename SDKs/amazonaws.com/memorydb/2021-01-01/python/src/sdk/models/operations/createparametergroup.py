...
class CreateParameterGroupHeaders:
    ...
    x_amz_target: CreateParameterGroupXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateParameterGroupRequest:
    headers: CreateParameterGroupHeaders = field(default=None)
    request: shared.CreateParameterGroupRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
