...
class DescribeAcLsHeaders:
    ...
    x_amz_target: DescribeAcLsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeAcLsRequest:
    headers: DescribeAcLsHeaders = field(default=None)
    request: shared.DescribeAcLsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
