...
class ListAllowedNodeTypeUpdatesHeaders:
    x_amz_target: ListAllowedNodeTypeUpdatesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListAllowedNodeTypeUpdatesRequest:
    headers: ListAllowedNodeTypeUpdatesHeaders = field()
    request: shared.ListAllowedNodeTypeUpdatesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
