...
class UpdateSubnetGroupHeaders:
    x_amz_target: UpdateSubnetGroupXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateSubnetGroupRequest:
    headers: UpdateSubnetGroupHeaders = field()
    request: shared.UpdateSubnetGroupRequest = field(metadata={'request': { 'media_type': 'application/json' }})
