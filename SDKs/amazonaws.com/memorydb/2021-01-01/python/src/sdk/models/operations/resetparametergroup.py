...
class ResetParameterGroupHeaders:
    x_amz_target: ResetParameterGroupXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ResetParameterGroupRequest:
    headers: ResetParameterGroupHeaders = field()
    request: shared.ResetParameterGroupRequest = field(metadata={'request': { 'media_type': 'application/json' }})
