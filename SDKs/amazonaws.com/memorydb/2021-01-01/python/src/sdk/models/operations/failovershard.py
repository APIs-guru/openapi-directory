...
class FailoverShardHeaders:
    x_amz_target: FailoverShardXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class FailoverShardRequest:
    headers: FailoverShardHeaders = field()
    request: shared.FailoverShardRequest = field(metadata={'request': { 'media_type': 'application/json' }})
