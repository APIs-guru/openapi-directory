...
class UpdateParameterGroupHeaders:
    ...
    x_amz_target: UpdateParameterGroupXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateParameterGroupRequest:
    headers: UpdateParameterGroupHeaders = field(default=None)
    request: shared.UpdateParameterGroupRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
