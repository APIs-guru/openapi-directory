...
class DescribeSubnetGroupsHeaders:
    x_amz_target: DescribeSubnetGroupsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeSubnetGroupsRequest:
    headers: DescribeSubnetGroupsHeaders = field()
    request: shared.DescribeSubnetGroupsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
