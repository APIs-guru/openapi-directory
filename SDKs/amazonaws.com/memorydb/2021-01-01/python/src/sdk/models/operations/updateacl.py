...
class UpdateACLHeaders:
    x_amz_target: UpdateAclxAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateACLRequest:
    headers: UpdateACLHeaders = field()
    request: shared.UpdateACLRequest = field(metadata={'request': { 'media_type': 'application/json' }})
