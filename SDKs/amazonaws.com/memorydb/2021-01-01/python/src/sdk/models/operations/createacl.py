...
class CreateACLHeaders:
    x_amz_target: CreateAclxAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateACLRequest:
    headers: CreateACLHeaders = field()
    request: shared.CreateACLRequest = field(metadata={'request': { 'media_type': 'application/json' }})
