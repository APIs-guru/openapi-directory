...
class BatchUpdateClusterHeaders:
    ...
    x_amz_target: BatchUpdateClusterXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class BatchUpdateClusterRequest:
    headers: BatchUpdateClusterHeaders = field(default=None)
    request: shared.BatchUpdateClusterRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
