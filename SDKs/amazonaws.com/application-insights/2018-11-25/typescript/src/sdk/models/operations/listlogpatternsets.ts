...
export class ListLogPatternSetsQueryParams extends SpeakeasyBase {
...
export enum ListLogPatternSetsXAmzTargetEnum {
    Ec2WindowsBarleyServiceListLogPatternSets = "EC2WindowsBarleyService.ListLogPatternSets"
}


export class ListLogPatternSetsHeaders extends SpeakeasyBase {
