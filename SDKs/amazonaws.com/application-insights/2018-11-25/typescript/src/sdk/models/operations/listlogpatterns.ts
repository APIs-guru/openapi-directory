...
export class ListLogPatternsQueryParams extends SpeakeasyBase {
...
export enum ListLogPatternsXAmzTargetEnum {
    Ec2WindowsBarleyServiceListLogPatterns = "EC2WindowsBarleyService.ListLogPatterns"
}


export class ListLogPatternsHeaders extends SpeakeasyBase {
