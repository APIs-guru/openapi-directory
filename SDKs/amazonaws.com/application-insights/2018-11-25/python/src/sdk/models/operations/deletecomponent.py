...
class DeleteComponentHeaders:
    x_amz_target: DeleteComponentXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteComponentRequest:
    ...
    request: shared.DeleteComponentRequest = field(metadata={'request': { 'media_type': 'application/json' }})
