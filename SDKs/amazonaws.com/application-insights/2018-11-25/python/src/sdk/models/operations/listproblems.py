...
class ListProblemsHeaders:
    x_amz_target: ListProblemsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListProblemsRequest:
    headers: ListProblemsHeaders = field()
    query_params: ListProblemsQueryParams = field()
    request: shared.ListProblemsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
