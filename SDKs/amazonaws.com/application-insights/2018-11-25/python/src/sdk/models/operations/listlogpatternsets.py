...
class ListLogPatternSetsHeaders:
    x_amz_target: ListLogPatternSetsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListLogPatternSetsRequest:
    headers: ListLogPatternSetsHeaders = field()
    query_params: ListLogPatternSetsQueryParams = field()
    request: shared.ListLogPatternSetsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
