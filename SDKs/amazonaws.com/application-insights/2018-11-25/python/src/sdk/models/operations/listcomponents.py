...
class ListComponentsHeaders:
    ...
    x_amz_target: ListComponentsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
...
class ListComponentsRequest:
    ...
    request: shared.ListComponentsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
