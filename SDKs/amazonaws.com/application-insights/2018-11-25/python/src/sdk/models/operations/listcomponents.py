...
class ListComponentsHeaders:
    x_amz_target: ListComponentsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListComponentsRequest:
    ...
    request: shared.ListComponentsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
