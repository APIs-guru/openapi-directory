...
class DescribeProblemHeaders:
    x_amz_target: DescribeProblemXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeProblemRequest:
    headers: DescribeProblemHeaders = field()
    request: shared.DescribeProblemRequest = field(metadata={'request': { 'media_type': 'application/json' }})
