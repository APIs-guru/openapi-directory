...
class UpdateComponentConfigurationHeaders:
    x_amz_target: UpdateComponentConfigurationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateComponentConfigurationRequest:
    headers: UpdateComponentConfigurationHeaders = field()
    request: shared.UpdateComponentConfigurationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
