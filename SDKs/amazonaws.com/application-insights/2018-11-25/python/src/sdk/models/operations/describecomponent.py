...
class DescribeComponentHeaders:
    x_amz_target: DescribeComponentXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeComponentRequest:
    ...
    request: shared.DescribeComponentRequest = field(metadata={'request': { 'media_type': 'application/json' }})
