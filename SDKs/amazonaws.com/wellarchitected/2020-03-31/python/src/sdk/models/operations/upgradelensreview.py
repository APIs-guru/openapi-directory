...
class UpgradeLensReviewRequest:
    path_params: UpgradeLensReviewPathParams = field(default=None)
    headers: UpgradeLensReviewHeaders = field(default=None)
    request: UpgradeLensReviewRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
