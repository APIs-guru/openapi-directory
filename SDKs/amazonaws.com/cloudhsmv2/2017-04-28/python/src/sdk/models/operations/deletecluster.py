...
class DeleteClusterHeaders:
    ...
    x_amz_target: DeleteClusterXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeleteClusterRequest:
    headers: DeleteClusterHeaders = field(default=None)
    request: shared.DeleteClusterRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
