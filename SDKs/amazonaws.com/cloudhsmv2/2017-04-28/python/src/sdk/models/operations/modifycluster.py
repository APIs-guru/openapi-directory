...
class ModifyClusterHeaders:
    ...
    x_amz_target: ModifyClusterXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ModifyClusterRequest:
    headers: ModifyClusterHeaders = field(default=None)
    request: shared.ModifyClusterRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
