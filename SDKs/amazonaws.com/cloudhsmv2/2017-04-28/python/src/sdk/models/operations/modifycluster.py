...
class ModifyClusterHeaders:
    x_amz_target: ModifyClusterXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ModifyClusterRequest:
    headers: ModifyClusterHeaders = field()
    request: shared.ModifyClusterRequest = field(metadata={'request': { 'media_type': 'application/json' }})
...
class ModifyClusterResponse:
    ...
    modify_cluster_response: Optional[shared.ModifyClusterResponse] = field(default=None)
