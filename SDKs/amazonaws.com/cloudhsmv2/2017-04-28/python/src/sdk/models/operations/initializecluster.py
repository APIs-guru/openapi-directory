...
class InitializeClusterHeaders:
    x_amz_target: InitializeClusterXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class InitializeClusterRequest:
    headers: InitializeClusterHeaders = field()
    request: shared.InitializeClusterRequest = field(metadata={'request': { 'media_type': 'application/json' }})
