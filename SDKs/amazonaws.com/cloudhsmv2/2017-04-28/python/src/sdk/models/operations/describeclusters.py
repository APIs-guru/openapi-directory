...
class DescribeClustersHeaders:
    x_amz_target: DescribeClustersXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeClustersRequest:
    headers: DescribeClustersHeaders = field()
    query_params: DescribeClustersQueryParams = field()
    request: shared.DescribeClustersRequest = field(metadata={'request': { 'media_type': 'application/json' }})
