...
class DeleteHsmHeaders:
    ...
    x_amz_target: DeleteHsmXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeleteHsmRequest:
    headers: DeleteHsmHeaders = field(default=None)
    request: shared.DeleteHsmRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
