...
class RestoreBackupHeaders:
    x_amz_target: RestoreBackupXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RestoreBackupRequest:
    headers: RestoreBackupHeaders = field()
    request: shared.RestoreBackupRequest = field(metadata={'request': { 'media_type': 'application/json' }})
