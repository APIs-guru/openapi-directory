...
class DeleteLunaClientHeaders:
    ...
    x_amz_target: DeleteLunaClientXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeleteLunaClientRequest:
    headers: DeleteLunaClientHeaders = field(default=None)
    request: shared.DeleteLunaClientRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
