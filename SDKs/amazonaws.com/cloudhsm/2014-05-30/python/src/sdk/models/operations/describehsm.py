...
class DescribeHsmHeaders:
    x_amz_target: DescribeHsmXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeHsmRequest:
    headers: DescribeHsmHeaders = field()
    request: shared.DescribeHsmRequest = field(metadata={'request': { 'media_type': 'application/json' }})
