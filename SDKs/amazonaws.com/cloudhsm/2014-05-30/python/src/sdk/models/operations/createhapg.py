...
class CreateHapgHeaders:
    x_amz_target: CreateHapgXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateHapgRequest:
    headers: CreateHapgHeaders = field()
    request: shared.CreateHapgRequest = field(metadata={'request': { 'media_type': 'application/json' }})
