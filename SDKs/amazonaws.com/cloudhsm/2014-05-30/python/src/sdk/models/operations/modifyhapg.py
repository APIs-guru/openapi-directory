...
class ModifyHapgHeaders:
    x_amz_target: ModifyHapgXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ModifyHapgRequest:
    headers: ModifyHapgHeaders = field()
    request: shared.ModifyHapgRequest = field(metadata={'request': { 'media_type': 'application/json' }})
