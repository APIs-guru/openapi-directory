...
class GetConfigHeaders:
    ...
    x_amz_target: GetConfigXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetConfigRequest:
    headers: GetConfigHeaders = field(default=None)
    request: shared.GetConfigRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
