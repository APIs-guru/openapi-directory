...
class GetConfigHeaders:
    x_amz_target: GetConfigXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetConfigRequest:
    ...
    request: shared.GetConfigRequest = field(metadata={'request': { 'media_type': 'application/json' }})
