...
class ListLunaClientsHeaders:
    ...
    x_amz_target: ListLunaClientsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ListLunaClientsRequest:
    headers: ListLunaClientsHeaders = field(default=None)
    request: shared.ListLunaClientsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
