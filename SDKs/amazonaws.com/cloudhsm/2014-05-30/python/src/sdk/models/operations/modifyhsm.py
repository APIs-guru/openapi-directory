...
class ModifyHsmHeaders:
    x_amz_target: ModifyHsmXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ModifyHsmRequest:
    headers: ModifyHsmHeaders = field()
    request: shared.ModifyHsmRequest = field(metadata={'request': { 'media_type': 'application/json' }})
