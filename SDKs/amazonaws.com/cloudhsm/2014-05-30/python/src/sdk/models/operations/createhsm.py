...
class CreateHsmHeaders:
    x_amz_target: CreateHsmXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateHsmRequest:
    headers: CreateHsmHeaders = field()
    request: shared.CreateHsmRequest = field(metadata={'request': { 'media_type': 'application/json' }})
