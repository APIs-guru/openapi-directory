...
class DescribeLunaClientHeaders:
    x_amz_target: DescribeLunaClientXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeLunaClientRequest:
    headers: DescribeLunaClientHeaders = field()
    request: shared.DescribeLunaClientRequest = field(metadata={'request': { 'media_type': 'application/json' }})
