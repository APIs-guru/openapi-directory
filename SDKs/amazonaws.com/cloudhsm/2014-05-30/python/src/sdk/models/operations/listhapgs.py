...
class ListHapgsHeaders:
    x_amz_target: ListHapgsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListHapgsRequest:
    headers: ListHapgsHeaders = field()
    request: shared.ListHapgsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
