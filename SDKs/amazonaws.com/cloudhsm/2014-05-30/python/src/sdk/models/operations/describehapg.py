...
class DescribeHapgHeaders:
    x_amz_target: DescribeHapgXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeHapgRequest:
    headers: DescribeHapgHeaders = field()
    request: shared.DescribeHapgRequest = field(metadata={'request': { 'media_type': 'application/json' }})
