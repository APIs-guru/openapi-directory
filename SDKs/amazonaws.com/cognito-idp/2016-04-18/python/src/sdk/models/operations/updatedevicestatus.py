...
class UpdateDeviceStatusHeaders:
    x_amz_target: UpdateDeviceStatusXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateDeviceStatusRequest:
    headers: UpdateDeviceStatusHeaders = field()
    request: shared.UpdateDeviceStatusRequest = field(metadata={'request': { 'media_type': 'application/json' }})
