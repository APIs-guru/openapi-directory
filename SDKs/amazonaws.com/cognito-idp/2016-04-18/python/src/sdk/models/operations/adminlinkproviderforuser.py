...
class AdminLinkProviderForUserHeaders:
    x_amz_target: AdminLinkProviderForUserXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AdminLinkProviderForUserRequest:
    headers: AdminLinkProviderForUserHeaders = field()
    request: shared.AdminLinkProviderForUserRequest = field(metadata={'request': { 'media_type': 'application/json' }})
