...
class AssociateSoftwareTokenHeaders:
    x_amz_target: AssociateSoftwareTokenXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AssociateSoftwareTokenRequest:
    headers: AssociateSoftwareTokenHeaders = field()
    request: shared.AssociateSoftwareTokenRequest = field(metadata={'request': { 'media_type': 'application/json' }})
