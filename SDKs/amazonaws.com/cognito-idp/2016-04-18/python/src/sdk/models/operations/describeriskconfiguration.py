...
class DescribeRiskConfigurationHeaders:
    x_amz_target: DescribeRiskConfigurationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeRiskConfigurationRequest:
    headers: DescribeRiskConfigurationHeaders = field()
    request: shared.DescribeRiskConfigurationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
