...
class AdminRespondToAuthChallengeHeaders:
    x_amz_target: AdminRespondToAuthChallengeXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AdminRespondToAuthChallengeRequest:
    headers: AdminRespondToAuthChallengeHeaders = field()
    request: shared.AdminRespondToAuthChallengeRequest = field(metadata={'request': { 'media_type': 'application/json' }})
