...
class CreateUserImportJobHeaders:
    x_amz_target: CreateUserImportJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateUserImportJobRequest:
    headers: CreateUserImportJobHeaders = field()
    request: shared.CreateUserImportJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
