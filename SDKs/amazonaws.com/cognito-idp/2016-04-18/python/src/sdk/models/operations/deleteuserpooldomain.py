...
class DeleteUserPoolDomainHeaders:
    x_amz_target: DeleteUserPoolDomainXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteUserPoolDomainRequest:
    headers: DeleteUserPoolDomainHeaders = field()
    request: shared.DeleteUserPoolDomainRequest = field(metadata={'request': { 'media_type': 'application/json' }})
