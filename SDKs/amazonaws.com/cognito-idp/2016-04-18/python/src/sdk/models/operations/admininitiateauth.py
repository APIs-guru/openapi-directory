...
class AdminInitiateAuthHeaders:
    ...
    x_amz_target: AdminInitiateAuthXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class AdminInitiateAuthRequest:
    headers: AdminInitiateAuthHeaders = field(default=None)
    request: shared.AdminInitiateAuthRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class AdminInitiateAuthResponse:
    admin_initiate_auth_response: Optional[shared.AdminInitiateAuthResponse] = field(default=None)
