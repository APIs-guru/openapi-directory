...
class AdminInitiateAuthHeaders:
    x_amz_target: AdminInitiateAuthXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AdminInitiateAuthRequest:
    headers: AdminInitiateAuthHeaders = field()
    request: shared.AdminInitiateAuthRequest = field(metadata={'request': { 'media_type': 'application/json' }})
