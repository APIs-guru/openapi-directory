...
class ConfirmDeviceHeaders:
    ...
    x_amz_target: ConfirmDeviceXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ConfirmDeviceRequest:
    headers: ConfirmDeviceHeaders = field(default=None)
    request: shared.ConfirmDeviceRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
