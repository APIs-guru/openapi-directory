...
class UpdateUserAttributesHeaders:
    ...
    x_amz_target: UpdateUserAttributesXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateUserAttributesRequest:
    headers: UpdateUserAttributesHeaders = field(default=None)
    request: shared.UpdateUserAttributesRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
