...
class ChangePasswordHeaders:
    ...
    x_amz_target: ChangePasswordXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ChangePasswordRequest:
    headers: ChangePasswordHeaders = field(default=None)
    request: shared.ChangePasswordRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class ChangePasswordResponse:
    change_password_response: Optional[dict[str, Any]] = field(default=None)
