...
class UpdateUserPoolHeaders:
    x_amz_target: UpdateUserPoolXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateUserPoolRequest:
    headers: UpdateUserPoolHeaders = field()
    request: shared.UpdateUserPoolRequest = field(metadata={'request': { 'media_type': 'application/json' }})
