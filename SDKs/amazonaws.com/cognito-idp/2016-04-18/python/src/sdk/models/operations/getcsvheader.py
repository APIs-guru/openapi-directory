...
class GetCsvHeaderHeaders:
    x_amz_target: GetCsvHeaderXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetCsvHeaderRequest:
    headers: GetCsvHeaderHeaders = field()
    request: shared.GetCsvHeaderRequest = field(metadata={'request': { 'media_type': 'application/json' }})
