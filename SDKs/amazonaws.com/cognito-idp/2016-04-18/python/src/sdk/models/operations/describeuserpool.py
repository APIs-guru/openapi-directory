...
class DescribeUserPoolHeaders:
    x_amz_target: DescribeUserPoolXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeUserPoolRequest:
    headers: DescribeUserPoolHeaders = field()
    request: shared.DescribeUserPoolRequest = field(metadata={'request': { 'media_type': 'application/json' }})
