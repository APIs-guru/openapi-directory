...
class ListUsersInGroupHeaders:
    x_amz_target: ListUsersInGroupXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListUsersInGroupRequest:
    headers: ListUsersInGroupHeaders = field()
    query_params: ListUsersInGroupQueryParams = field()
    request: shared.ListUsersInGroupRequest = field(metadata={'request': { 'media_type': 'application/json' }})
