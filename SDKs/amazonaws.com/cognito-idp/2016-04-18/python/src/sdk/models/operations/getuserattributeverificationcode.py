...
class GetUserAttributeVerificationCodeHeaders:
    x_amz_target: GetUserAttributeVerificationCodeXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetUserAttributeVerificationCodeRequest:
    headers: GetUserAttributeVerificationCodeHeaders = field()
    request: shared.GetUserAttributeVerificationCodeRequest = field(metadata={'request': { 'media_type': 'application/json' }})
