...
class ResendConfirmationCodeHeaders:
    x_amz_target: ResendConfirmationCodeXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ResendConfirmationCodeRequest:
    headers: ResendConfirmationCodeHeaders = field()
    request: shared.ResendConfirmationCodeRequest = field(metadata={'request': { 'media_type': 'application/json' }})
