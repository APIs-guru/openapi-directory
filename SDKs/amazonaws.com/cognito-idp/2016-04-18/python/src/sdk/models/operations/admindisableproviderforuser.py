...
class AdminDisableProviderForUserHeaders:
    ...
    x_amz_target: AdminDisableProviderForUserXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class AdminDisableProviderForUserRequest:
    headers: AdminDisableProviderForUserHeaders = field(default=None)
    request: shared.AdminDisableProviderForUserRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
