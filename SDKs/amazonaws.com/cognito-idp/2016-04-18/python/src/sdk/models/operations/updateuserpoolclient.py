...
class UpdateUserPoolClientHeaders:
    x_amz_target: UpdateUserPoolClientXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateUserPoolClientRequest:
    headers: UpdateUserPoolClientHeaders = field()
    request: shared.UpdateUserPoolClientRequest = field(metadata={'request': { 'media_type': 'application/json' }})
