...
class ForgotPasswordHeaders:
    x_amz_target: ForgotPasswordXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ForgotPasswordRequest:
    headers: ForgotPasswordHeaders = field()
    request: shared.ForgotPasswordRequest = field(metadata={'request': { 'media_type': 'application/json' }})
