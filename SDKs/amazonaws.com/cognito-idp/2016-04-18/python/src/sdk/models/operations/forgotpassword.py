...
class ForgotPasswordHeaders:
    ...
    x_amz_target: ForgotPasswordXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ForgotPasswordRequest:
    headers: ForgotPasswordHeaders = field(default=None)
    request: shared.ForgotPasswordRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class ForgotPasswordResponse:
    ...
    forgot_password_response: Optional[shared.ForgotPasswordResponse] = field(default=None)
