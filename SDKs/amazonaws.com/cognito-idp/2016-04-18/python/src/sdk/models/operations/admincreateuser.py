...
class AdminCreateUserHeaders:
    x_amz_target: AdminCreateUserXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AdminCreateUserRequest:
    headers: AdminCreateUserHeaders = field()
    request: shared.AdminCreateUserRequest = field(metadata={'request': { 'media_type': 'application/json' }})
