...
class ListResourceServersHeaders:
    x_amz_target: ListResourceServersXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListResourceServersRequest:
    headers: ListResourceServersHeaders = field()
    query_params: ListResourceServersQueryParams = field()
    request: shared.ListResourceServersRequest = field(metadata={'request': { 'media_type': 'application/json' }})
