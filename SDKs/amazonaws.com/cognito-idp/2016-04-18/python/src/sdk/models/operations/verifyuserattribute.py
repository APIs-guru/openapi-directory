...
class VerifyUserAttributeHeaders:
    ...
    x_amz_target: VerifyUserAttributeXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class VerifyUserAttributeRequest:
    headers: VerifyUserAttributeHeaders = field(default=None)
    request: shared.VerifyUserAttributeRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class VerifyUserAttributeResponse:
    ...
    verify_user_attribute_response: Optional[dict[str, Any]] = field(default=None)
