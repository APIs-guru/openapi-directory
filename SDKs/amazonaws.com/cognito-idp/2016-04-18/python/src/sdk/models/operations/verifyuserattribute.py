...
class VerifyUserAttributeHeaders:
    x_amz_target: VerifyUserAttributeXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class VerifyUserAttributeRequest:
    headers: VerifyUserAttributeHeaders = field()
    request: shared.VerifyUserAttributeRequest = field(metadata={'request': { 'media_type': 'application/json' }})
