...
class SetUserSettingsHeaders:
    ...
    x_amz_target: SetUserSettingsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class SetUserSettingsRequest:
    headers: SetUserSettingsHeaders = field(default=None)
    request: shared.SetUserSettingsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
