...
class CreateUserPoolDomainHeaders:
    x_amz_target: CreateUserPoolDomainXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateUserPoolDomainRequest:
    headers: CreateUserPoolDomainHeaders = field()
    request: shared.CreateUserPoolDomainRequest = field(metadata={'request': { 'media_type': 'application/json' }})
