...
class StartUserImportJobHeaders:
    x_amz_target: StartUserImportJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartUserImportJobRequest:
    headers: StartUserImportJobHeaders = field()
    request: shared.StartUserImportJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
