...
class RespondToAuthChallengeHeaders:
    x_amz_target: RespondToAuthChallengeXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RespondToAuthChallengeRequest:
    headers: RespondToAuthChallengeHeaders = field()
    request: shared.RespondToAuthChallengeRequest = field(metadata={'request': { 'media_type': 'application/json' }})
