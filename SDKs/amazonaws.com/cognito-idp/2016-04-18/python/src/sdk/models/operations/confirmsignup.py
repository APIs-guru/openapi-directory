...
class ConfirmSignUpHeaders:
    x_amz_target: ConfirmSignUpXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ConfirmSignUpRequest:
    headers: ConfirmSignUpHeaders = field()
    request: shared.ConfirmSignUpRequest = field(metadata={'request': { 'media_type': 'application/json' }})
