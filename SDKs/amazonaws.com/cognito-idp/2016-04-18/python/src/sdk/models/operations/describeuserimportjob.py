...
class DescribeUserImportJobHeaders:
    x_amz_target: DescribeUserImportJobXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeUserImportJobRequest:
    headers: DescribeUserImportJobHeaders = field()
    request: shared.DescribeUserImportJobRequest = field(metadata={'request': { 'media_type': 'application/json' }})
