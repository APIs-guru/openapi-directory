...
class CreateUserPoolHeaders:
    x_amz_target: CreateUserPoolXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateUserPoolRequest:
    headers: CreateUserPoolHeaders = field()
    request: shared.CreateUserPoolRequest = field(metadata={'request': { 'media_type': 'application/json' }})
