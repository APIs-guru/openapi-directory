...
class AdminDeleteUserAttributesHeaders:
    x_amz_target: AdminDeleteUserAttributesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AdminDeleteUserAttributesRequest:
    headers: AdminDeleteUserAttributesHeaders = field()
    request: shared.AdminDeleteUserAttributesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
