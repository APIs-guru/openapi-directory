...
class ConfirmForgotPasswordHeaders:
    x_amz_target: ConfirmForgotPasswordXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ConfirmForgotPasswordRequest:
    headers: ConfirmForgotPasswordHeaders = field()
    request: shared.ConfirmForgotPasswordRequest = field(metadata={'request': { 'media_type': 'application/json' }})
