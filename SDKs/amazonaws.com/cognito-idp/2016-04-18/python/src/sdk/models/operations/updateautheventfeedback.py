...
class UpdateAuthEventFeedbackHeaders:
    x_amz_target: UpdateAuthEventFeedbackXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateAuthEventFeedbackRequest:
    headers: UpdateAuthEventFeedbackHeaders = field()
    request: shared.UpdateAuthEventFeedbackRequest = field(metadata={'request': { 'media_type': 'application/json' }})
