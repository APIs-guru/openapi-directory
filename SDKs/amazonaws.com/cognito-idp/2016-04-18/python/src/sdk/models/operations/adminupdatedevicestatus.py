...
class AdminUpdateDeviceStatusHeaders:
    x_amz_target: AdminUpdateDeviceStatusXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AdminUpdateDeviceStatusRequest:
    headers: AdminUpdateDeviceStatusHeaders = field()
    request: shared.AdminUpdateDeviceStatusRequest = field(metadata={'request': { 'media_type': 'application/json' }})
