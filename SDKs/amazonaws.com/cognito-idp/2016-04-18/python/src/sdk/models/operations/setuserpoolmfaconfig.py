...
class SetUserPoolMfaConfigHeaders:
    x_amz_target: SetUserPoolMfaConfigXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class SetUserPoolMfaConfigRequest:
    headers: SetUserPoolMfaConfigHeaders = field()
    request: shared.SetUserPoolMfaConfigRequest = field(metadata={'request': { 'media_type': 'application/json' }})
