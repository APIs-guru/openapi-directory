...
class AdminUpdateUserAttributesHeaders:
    x_amz_target: AdminUpdateUserAttributesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AdminUpdateUserAttributesRequest:
    headers: AdminUpdateUserAttributesHeaders = field()
    request: shared.AdminUpdateUserAttributesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
