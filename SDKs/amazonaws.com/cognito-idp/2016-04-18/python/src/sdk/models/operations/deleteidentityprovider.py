...
class DeleteIdentityProviderHeaders:
    x_amz_target: DeleteIdentityProviderXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteIdentityProviderRequest:
    headers: DeleteIdentityProviderHeaders = field()
    request: shared.DeleteIdentityProviderRequest = field(metadata={'request': { 'media_type': 'application/json' }})
