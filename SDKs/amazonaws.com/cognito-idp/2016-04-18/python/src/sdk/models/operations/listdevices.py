...
class ListDevicesHeaders:
    x_amz_target: ListDevicesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListDevicesRequest:
    ...
    request: shared.ListDevicesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
