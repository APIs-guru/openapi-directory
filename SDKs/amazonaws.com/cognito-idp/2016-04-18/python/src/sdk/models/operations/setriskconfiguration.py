...
class SetRiskConfigurationHeaders:
    x_amz_target: SetRiskConfigurationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class SetRiskConfigurationRequest:
    headers: SetRiskConfigurationHeaders = field()
    request: shared.SetRiskConfigurationRequest = field(metadata={'request': { 'media_type': 'application/json' }})
