...
class SetRiskConfigurationHeaders:
    ...
    x_amz_target: SetRiskConfigurationXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class SetRiskConfigurationRequest:
    headers: SetRiskConfigurationHeaders = field(default=None)
    request: shared.SetRiskConfigurationRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class SetRiskConfigurationResponse:
    ...
    set_risk_configuration_response: Optional[shared.SetRiskConfigurationResponse] = field(default=None)
