...
class AdminListUserAuthEventsHeaders:
    x_amz_target: AdminListUserAuthEventsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AdminListUserAuthEventsRequest:
    headers: AdminListUserAuthEventsHeaders = field()
    query_params: AdminListUserAuthEventsQueryParams = field()
    request: shared.AdminListUserAuthEventsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
