...
class ListUserPoolClientsHeaders:
    x_amz_target: ListUserPoolClientsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListUserPoolClientsRequest:
    headers: ListUserPoolClientsHeaders = field()
    query_params: ListUserPoolClientsQueryParams = field()
    request: shared.ListUserPoolClientsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
