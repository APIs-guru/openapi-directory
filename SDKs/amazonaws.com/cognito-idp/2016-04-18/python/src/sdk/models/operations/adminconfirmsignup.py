...
class AdminConfirmSignUpHeaders:
    x_amz_target: AdminConfirmSignUpXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AdminConfirmSignUpRequest:
    headers: AdminConfirmSignUpHeaders = field()
    request: shared.AdminConfirmSignUpRequest = field(metadata={'request': { 'media_type': 'application/json' }})
