...
class AdminConfirmSignUpHeaders:
    ...
    x_amz_target: AdminConfirmSignUpXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class AdminConfirmSignUpRequest:
    headers: AdminConfirmSignUpHeaders = field(default=None)
    request: shared.AdminConfirmSignUpRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class AdminConfirmSignUpResponse:
    admin_confirm_sign_up_response: Optional[dict[str, Any]] = field(default=None)
