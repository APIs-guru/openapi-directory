...
class CreateUserPoolClientHeaders:
    ...
    x_amz_target: CreateUserPoolClientXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
    

@dataclass
class CreateUserPoolClientRequest:
    headers: CreateUserPoolClientHeaders = field(default=None)
    request: shared.CreateUserPoolClientRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class CreateUserPoolClientResponse:
    content_type: str = field(default=None)
    create_user_pool_client_response: Optional[shared.CreateUserPoolClientResponse] = field(default=None)
