...
class CreateUserPoolClientHeaders:
    x_amz_target: CreateUserPoolClientXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateUserPoolClientRequest:
    headers: CreateUserPoolClientHeaders = field()
    request: shared.CreateUserPoolClientRequest = field(metadata={'request': { 'media_type': 'application/json' }})
