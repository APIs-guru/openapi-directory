...
export enum AdminDeleteUserXAmzTargetEnum {
    AwsCognitoIdentityProviderServiceAdminDeleteUser = "AWSCognitoIdentityProviderService.AdminDeleteUser"
}


export class AdminDeleteUserHeaders extends SpeakeasyBase {
...
export class AdminDeleteUserResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
