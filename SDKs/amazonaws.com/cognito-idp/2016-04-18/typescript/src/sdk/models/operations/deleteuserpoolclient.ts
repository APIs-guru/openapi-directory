...
export enum DeleteUserPoolClientXAmzTargetEnum {
    AwsCognitoIdentityProviderServiceDeleteUserPoolClient = "AWSCognitoIdentityProviderService.DeleteUserPoolClient"
}


export class DeleteUserPoolClientHeaders extends SpeakeasyBase {
...
export class DeleteUserPoolClientResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
