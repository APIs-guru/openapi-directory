...
export enum AdminAddUserToGroupXAmzTargetEnum {
    AwsCognitoIdentityProviderServiceAdminAddUserToGroup = "AWSCognitoIdentityProviderService.AdminAddUserToGroup"
}


export class AdminAddUserToGroupHeaders extends SpeakeasyBase {
...
export class AdminAddUserToGroupResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
