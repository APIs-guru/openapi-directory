...
export enum AdminSetUserSettingsXAmzTargetEnum {
    AwsCognitoIdentityProviderServiceAdminSetUserSettings = "AWSCognitoIdentityProviderService.AdminSetUserSettings"
}


export class AdminSetUserSettingsHeaders extends SpeakeasyBase {
...
export class AdminSetUserSettingsResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
