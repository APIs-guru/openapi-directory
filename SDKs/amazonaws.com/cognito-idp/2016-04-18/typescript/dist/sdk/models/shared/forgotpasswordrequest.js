...
**/
var ForgotPasswordRequest = /** @class */ (function (_super) {
    __extends(ForgotPasswordRequest, _super);
    ...
    ], ForgotPasswordRequest.prototype, "analyticsMetadata", void 0);
    __decorate([
    ...
    ], ForgotPasswordRequest.prototype, "clientMetadata", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=SecretHash" }),
        __metadata("design:type", String)
    ], ForgotPasswordRequest.prototype, "secretHash", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=UserContextData" }),
        __metadata("design:type", UserContextDataType)
    ], ForgotPasswordRequest.prototype, "userContextData", void 0);
    __decorate([
