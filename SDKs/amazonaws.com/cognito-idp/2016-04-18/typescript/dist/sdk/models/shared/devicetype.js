...
var DeviceType = /** @class */ (function (_super) {
    ...
    ], DeviceType.prototype, "deviceAttributes", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=DeviceCreateDate" }),
        __metadata("design:type", Date)
    ], DeviceType.prototype, "deviceCreateDate", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=DeviceKey" }),
        __metadata("design:type", String)
    ], DeviceType.prototype, "deviceKey", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=DeviceLastAuthenticatedDate" }),
        __metadata("design:type", Date)
    ], DeviceType.prototype, "deviceLastAuthenticatedDate", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=DeviceLastModifiedDate" }),
        __metadata("design:type", Date)
    ], DeviceType.prototype, "deviceLastModifiedDate", void 0);
    return DeviceType;
}(SpeakeasyBase));
export { DeviceType };
