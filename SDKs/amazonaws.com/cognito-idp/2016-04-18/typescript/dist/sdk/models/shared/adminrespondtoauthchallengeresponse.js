...
var AdminRespondToAuthChallengeResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", AuthenticationResultType)
    ], AdminRespondToAuthChallengeResponse.prototype, "authenticationResult", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ChallengeName" }),
        __metadata("design:type", String)
    ], AdminRespondToAuthChallengeResponse.prototype, "challengeName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ChallengeParameters" }),
        __metadata("design:type", Map)
    ], AdminRespondToAuthChallengeResponse.prototype, "challengeParameters", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Session" }),
        __metadata("design:type", String)
    ], AdminRespondToAuthChallengeResponse.prototype, "session", void 0);
