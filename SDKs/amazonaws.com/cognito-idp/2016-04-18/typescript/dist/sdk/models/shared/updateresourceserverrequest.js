...
var UpdateResourceServerRequest = /** @class */ (function (_super) {
    ...
    ], UpdateResourceServerRequest.prototype, "identifier", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Name" }),
        __metadata("design:type", String)
    ], UpdateResourceServerRequest.prototype, "name", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Scopes", elemType: ResourceServerScopeType }),
        __metadata("design:type", Array)
    ], UpdateResourceServerRequest.prototype, "scopes", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=UserPoolId" }),
        __metadata("design:type", String)
    ], UpdateResourceServerRequest.prototype, "userPoolId", void 0);
