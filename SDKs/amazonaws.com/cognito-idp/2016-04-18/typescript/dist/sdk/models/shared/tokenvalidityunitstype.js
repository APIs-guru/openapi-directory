...
**/
var TokenValidityUnitsType = /** @class */ (function (_super) {
    __extends(TokenValidityUnitsType, _super);
    ...
    ], TokenValidityUnitsType.prototype, "accessToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=IdToken" }),
        __metadata("design:type", String)
    ], TokenValidityUnitsType.prototype, "idToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=RefreshToken" }),
        __metadata("design:type", String)
    ], TokenValidityUnitsType.prototype, "refreshToken", void 0);
    return TokenValidityUnitsType;
}(SpeakeasyBase));
export { TokenValidityUnitsType };
