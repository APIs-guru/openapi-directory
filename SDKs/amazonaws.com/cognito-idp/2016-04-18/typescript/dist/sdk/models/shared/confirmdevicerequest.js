...
var ConfirmDeviceRequest = /** @class */ (function (_super) {
    ...
    ], ConfirmDeviceRequest.prototype, "accessToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=DeviceKey" }),
        __metadata("design:type", String)
    ], ConfirmDeviceRequest.prototype, "deviceKey", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=DeviceName" }),
        __metadata("design:type", String)
    ], ConfirmDeviceRequest.prototype, "deviceName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=DeviceSecretVerifierConfig" }),
        __metadata("design:type", DeviceSecretVerifierConfigType)
    ], ConfirmDeviceRequest.prototype, "deviceSecretVerifierConfig", void 0);
