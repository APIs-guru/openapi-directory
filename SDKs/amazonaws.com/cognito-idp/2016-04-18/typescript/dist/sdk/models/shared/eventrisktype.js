 ...
 * The event risk type.
**/
var EventRiskType = /** @class */ (function (_super) {
    __extends(EventRiskType, _super);
    ...
    ], EventRiskType.prototype, "compromisedCredentialsDetected", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=RiskDecision" }),
        __metadata("design:type", String)
    ], EventRiskType.prototype, "riskDecision", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=RiskLevel" }),
        __metadata("design:type", String)
    ], EventRiskType.prototype, "riskLevel", void 0);
    return EventRiskType;
}(SpeakeasyBase));
export { EventRiskType };
