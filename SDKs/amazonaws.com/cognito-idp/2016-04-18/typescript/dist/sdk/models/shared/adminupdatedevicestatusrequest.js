...
var AdminUpdateDeviceStatusRequest = /** @class */ (function (_super) {
    ...
    ], AdminUpdateDeviceStatusRequest.prototype, "deviceKey", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=DeviceRememberedStatus" }),
        __metadata("design:type", String)
    ], AdminUpdateDeviceStatusRequest.prototype, "deviceRememberedStatus", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=UserPoolId" }),
        __metadata("design:type", String)
    ], AdminUpdateDeviceStatusRequest.prototype, "userPoolId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Username" }),
        __metadata("design:type", String)
    ], AdminUpdateDeviceStatusRequest.prototype, "username", void 0);
