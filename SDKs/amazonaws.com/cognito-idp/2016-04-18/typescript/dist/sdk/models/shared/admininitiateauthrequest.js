...
var AdminInitiateAuthRequest = /** @class */ (function (_super) {
    ...
    ], AdminInitiateAuthRequest.prototype, "analyticsMetadata", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=AuthFlow" }),
        __metadata("design:type", String)
    ], AdminInitiateAuthRequest.prototype, "authFlow", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=AuthParameters" }),
        __metadata("design:type", Map)
    ], AdminInitiateAuthRequest.prototype, "authParameters", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ClientId" }),
        __metadata("design:type", String)
    ], AdminInitiateAuthRequest.prototype, "clientId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ClientMetadata" }),
        __metadata("design:type", Map)
    ], AdminInitiateAuthRequest.prototype, "clientMetadata", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ContextData" }),
        __metadata("design:type", ContextDataType)
    ], AdminInitiateAuthRequest.prototype, "contextData", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=UserPoolId" }),
        __metadata("design:type", String)
    ], AdminInitiateAuthRequest.prototype, "userPoolId", void 0);
