...
**/
var MfaOptionType = /** @class */ (function (_super) {
    __extends(MfaOptionType, _super);
    ...
    ], MfaOptionType.prototype, "attributeName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=DeliveryMedium" }),
        __metadata("design:type", String)
    ], MfaOptionType.prototype, "deliveryMedium", void 0);
    return MfaOptionType;
}(SpeakeasyBase));
export { MfaOptionType };
