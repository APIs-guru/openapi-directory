...
var AdminRespondToAuthChallengeRequest = /** @class */ (function (_super) {
    ...
    ], AdminRespondToAuthChallengeRequest.prototype, "analyticsMetadata", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ChallengeName" }),
        __metadata("design:type", String)
    ], AdminRespondToAuthChallengeRequest.prototype, "challengeName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ChallengeResponses" }),
        __metadata("design:type", Map)
    ], AdminRespondToAuthChallengeRequest.prototype, "challengeResponses", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ClientId" }),
        __metadata("design:type", String)
    ], AdminRespondToAuthChallengeRequest.prototype, "clientId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ClientMetadata" }),
        __metadata("design:type", Map)
    ], AdminRespondToAuthChallengeRequest.prototype, "clientMetadata", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ContextData" }),
        __metadata("design:type", ContextDataType)
    ], AdminRespondToAuthChallengeRequest.prototype, "contextData", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Session" }),
        __metadata("design:type", String)
    ], AdminRespondToAuthChallengeRequest.prototype, "session", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=UserPoolId" }),
        __metadata("design:type", String)
    ], AdminRespondToAuthChallengeRequest.prototype, "userPoolId", void 0);
