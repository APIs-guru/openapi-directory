...
var CreateResourceServerRequest = /** @class */ (function (_super) {
    ...
    ], CreateResourceServerRequest.prototype, "identifier", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Name" }),
        __metadata("design:type", String)
    ], CreateResourceServerRequest.prototype, "name", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Scopes", elemType: ResourceServerScopeType }),
        __metadata("design:type", Array)
    ], CreateResourceServerRequest.prototype, "scopes", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=UserPoolId" }),
        __metadata("design:type", String)
    ], CreateResourceServerRequest.prototype, "userPoolId", void 0);
