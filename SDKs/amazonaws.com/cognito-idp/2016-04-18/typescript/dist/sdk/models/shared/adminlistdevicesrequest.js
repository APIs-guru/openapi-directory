...
var AdminListDevicesRequest = /** @class */ (function (_super) {
    ...
    ], AdminListDevicesRequest.prototype, "limit", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=PaginationToken" }),
        __metadata("design:type", String)
    ], AdminListDevicesRequest.prototype, "paginationToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=UserPoolId" }),
        __metadata("design:type", String)
    ], AdminListDevicesRequest.prototype, "userPoolId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Username" }),
        __metadata("design:type", String)
    ], AdminListDevicesRequest.prototype, "username", void 0);
