...
class GetDatasetContentRequest:
    path_params: GetDatasetContentPathParams = field(default=None)
    query_params: GetDatasetContentQueryParams = field(default=None)
    headers: GetDatasetContentHeaders = field(default=None)
    

@dataclass
class GetDatasetContentResponse:
    content_type: str = field(default=None)
    get_dataset_content_response: Optional[shared.GetDatasetContentResponse] = field(default=None)
