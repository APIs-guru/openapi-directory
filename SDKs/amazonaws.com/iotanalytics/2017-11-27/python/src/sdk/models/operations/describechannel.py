...
class DescribeChannelRequest:
    path_params: DescribeChannelPathParams = field(default=None)
    query_params: DescribeChannelQueryParams = field(default=None)
    headers: DescribeChannelHeaders = field(default=None)
    

@dataclass
class DescribeChannelResponse:
    content_type: str = field(default=None)
    describe_channel_response: Optional[shared.DescribeChannelResponse] = field(default=None)
