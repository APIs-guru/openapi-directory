...
var AssociateSubnetsResponse = /** @class */ (function (_super) {
    ...
    ], AssociateSubnetsResponse.prototype, "firewallArn", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=FirewallName" }),
        __metadata("design:type", String)
    ], AssociateSubnetsResponse.prototype, "firewallName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=SubnetMappings", elemType: SubnetMapping }),
        __metadata("design:type", Array)
    ], AssociateSubnetsResponse.prototype, "subnetMappings", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=UpdateToken" }),
        __metadata("design:type", String)
    ], AssociateSubnetsResponse.prototype, "updateToken", void 0);
