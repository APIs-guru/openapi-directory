...
**/
var FirewallMetadata = /** @class */ (function (_super) {
    __extends(FirewallMetadata, _super);
    ...
    ], FirewallMetadata.prototype, "firewallArn", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=FirewallName" }),
        __metadata("design:type", String)
    ], FirewallMetadata.prototype, "firewallName", void 0);
    return FirewallMetadata;
}(SpeakeasyBase));
export { FirewallMetadata };
