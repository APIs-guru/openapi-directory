...
var UpdateFirewallDeleteProtectionResponse = /** @class */ (function (_super) {
    ...
    ], UpdateFirewallDeleteProtectionResponse.prototype, "deleteProtection", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=FirewallArn" }),
        __metadata("design:type", String)
    ], UpdateFirewallDeleteProtectionResponse.prototype, "firewallArn", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=FirewallName" }),
        __metadata("design:type", String)
    ], UpdateFirewallDeleteProtectionResponse.prototype, "firewallName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=UpdateToken" }),
        __metadata("design:type", String)
    ], UpdateFirewallDeleteProtectionResponse.prototype, "updateToken", void 0);
