...
var AssociateFirewallPolicyResponse = /** @class */ (function (_super) {
    ...
    ], AssociateFirewallPolicyResponse.prototype, "firewallArn", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=FirewallName" }),
        __metadata("design:type", String)
    ], AssociateFirewallPolicyResponse.prototype, "firewallName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=FirewallPolicyArn" }),
        __metadata("design:type", String)
    ], AssociateFirewallPolicyResponse.prototype, "firewallPolicyArn", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=UpdateToken" }),
        __metadata("design:type", String)
    ], AssociateFirewallPolicyResponse.prototype, "updateToken", void 0);
