...
**/
var StatelessRule = /** @class */ (function (_super) {
    __extends(StatelessRule, _super);
    ...
    ], StatelessRule.prototype, "priority", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=RuleDefinition" }),
        __metadata("design:type", RuleDefinition)
    ], StatelessRule.prototype, "ruleDefinition", void 0);
    return StatelessRule;
}(SpeakeasyBase));
export { StatelessRule };
