...
class ListFirewallsHeaders:
    x_amz_target: ListFirewallsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListFirewallsRequest:
    headers: ListFirewallsHeaders = field()
    query_params: ListFirewallsQueryParams = field()
    request: shared.ListFirewallsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
