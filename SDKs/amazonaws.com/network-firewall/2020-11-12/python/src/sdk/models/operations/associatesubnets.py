...
class AssociateSubnetsHeaders:
    ...
    x_amz_target: AssociateSubnetsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class AssociateSubnetsRequest:
    headers: AssociateSubnetsHeaders = field(default=None)
    request: shared.AssociateSubnetsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
