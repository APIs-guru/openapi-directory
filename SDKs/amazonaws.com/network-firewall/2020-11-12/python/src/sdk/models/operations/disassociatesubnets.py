...
class DisassociateSubnetsHeaders:
    x_amz_target: DisassociateSubnetsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DisassociateSubnetsRequest:
    headers: DisassociateSubnetsHeaders = field()
    request: shared.DisassociateSubnetsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
