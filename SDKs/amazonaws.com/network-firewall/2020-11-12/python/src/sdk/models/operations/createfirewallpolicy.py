...
class CreateFirewallPolicyHeaders:
    x_amz_target: CreateFirewallPolicyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateFirewallPolicyRequest:
    headers: CreateFirewallPolicyHeaders = field()
    request: shared.CreateFirewallPolicyRequest = field(metadata={'request': { 'media_type': 'application/json' }})
