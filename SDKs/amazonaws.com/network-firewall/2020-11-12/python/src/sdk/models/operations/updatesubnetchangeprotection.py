...
class UpdateSubnetChangeProtectionHeaders:
    x_amz_target: UpdateSubnetChangeProtectionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateSubnetChangeProtectionRequest:
    headers: UpdateSubnetChangeProtectionHeaders = field()
    request: shared.UpdateSubnetChangeProtectionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
