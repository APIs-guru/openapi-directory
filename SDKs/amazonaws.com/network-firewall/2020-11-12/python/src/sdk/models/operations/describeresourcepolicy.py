...
class DescribeResourcePolicyHeaders:
    x_amz_target: DescribeResourcePolicyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeResourcePolicyRequest:
    headers: DescribeResourcePolicyHeaders = field()
    request: shared.DescribeResourcePolicyRequest = field(metadata={'request': { 'media_type': 'application/json' }})
