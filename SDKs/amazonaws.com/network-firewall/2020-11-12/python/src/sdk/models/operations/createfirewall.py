...
class CreateFirewallHeaders:
    x_amz_target: CreateFirewallXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateFirewallRequest:
    headers: CreateFirewallHeaders = field()
    request: shared.CreateFirewallRequest = field(metadata={'request': { 'media_type': 'application/json' }})
