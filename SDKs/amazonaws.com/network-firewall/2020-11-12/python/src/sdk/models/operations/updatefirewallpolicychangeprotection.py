...
class UpdateFirewallPolicyChangeProtectionHeaders:
    ...
    x_amz_target: UpdateFirewallPolicyChangeProtectionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class UpdateFirewallPolicyChangeProtectionRequest:
    headers: UpdateFirewallPolicyChangeProtectionHeaders = field(default=None)
    request: shared.UpdateFirewallPolicyChangeProtectionRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
