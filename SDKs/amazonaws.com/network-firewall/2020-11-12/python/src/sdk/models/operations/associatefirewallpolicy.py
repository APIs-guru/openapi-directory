...
class AssociateFirewallPolicyHeaders:
    ...
    x_amz_target: AssociateFirewallPolicyXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class AssociateFirewallPolicyRequest:
    headers: AssociateFirewallPolicyHeaders = field(default=None)
    request: shared.AssociateFirewallPolicyRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
