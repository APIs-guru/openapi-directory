...
class BatchAssociateClientDeviceWithCoreDeviceRequestBody:
    entries: Optional[List[shared.AssociateClientDeviceWithCoreDeviceEntry]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'entries' }})
    

@dataclass
class BatchAssociateClientDeviceWithCoreDeviceRequest:
    path_params: BatchAssociateClientDeviceWithCoreDevicePathParams = field(default=None)
    headers: BatchAssociateClientDeviceWithCoreDeviceHeaders = field(default=None)
    request: BatchAssociateClientDeviceWithCoreDeviceRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
