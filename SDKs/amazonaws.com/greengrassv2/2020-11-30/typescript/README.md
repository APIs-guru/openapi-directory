...
import { BatchAssociateClientDeviceWithCoreDeviceRequest, BatchAssociateClientDeviceWithCoreDeviceResponse } from "openapi/src/sdk/models/operations";
...
const req: BatchAssociateClientDeviceWithCoreDeviceRequest = {
  pathParams: {
...
sdk.sdk.batchAssociateClientDeviceWithCoreDevice(req).then((res: BatchAssociateClientDeviceWithCoreDeviceResponse | AxiosError) => {
   // handle response
});
```
