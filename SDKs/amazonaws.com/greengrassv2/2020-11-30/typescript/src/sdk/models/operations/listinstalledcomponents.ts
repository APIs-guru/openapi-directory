...
export class ListInstalledComponentsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=coreDeviceThingName" })
  coreDeviceThingName: string;
}


export class ListInstalledComponentsQueryParams extends SpeakeasyBase {
...
export class ListInstalledComponentsHeaders extends SpeakeasyBase {
