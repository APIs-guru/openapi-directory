...
export class ListComponentVersionsPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=arn" })
  arn: string;
}


export class ListComponentVersionsQueryParams extends SpeakeasyBase {
...
export class ListComponentVersionsHeaders extends SpeakeasyBase {
