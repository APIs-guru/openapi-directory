...
var UploadFunctionPathParams = /** @class */ (function (_super) {
    ...
    function UploadFunctionPathParams() {
...
export { UploadFunctionPathParams };
export var UploadFunctionModeEnum;
(function (UploadFunctionModeEnum) {
    UploadFunctionModeEnum["Event"] = "event";
})(UploadFunctionModeEnum || (UploadFunctionModeEnum = {}));
export var UploadFunctionRuntimeEnum;
(function (UploadFunctionRuntimeEnum) {
    UploadFunctionRuntimeEnum["Nodejs"] = "nodejs";
})(UploadFunctionRuntimeEnum || (UploadFunctionRuntimeEnum = {}));
var UploadFunctionQueryParams = /** @class */ (function (_super) {
    __extends(UploadFunctionQueryParams, _super);
    function UploadFunctionQueryParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
...
export { UploadFunctionQueryParams };
var UploadFunctionHeaders = /** @class */ (function (_super) {
    __extends(UploadFunctionHeaders, _super);
    function UploadFunctionHeaders() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
...
export { UploadFunctionHeaders };
var UploadFunctionRequestBody = /** @class */ (function (_super) {
    __extends(UploadFunctionRequestBody, _super);
    function UploadFunctionRequestBody() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
...
export { UploadFunctionRequestBody };
var UploadFunctionRequest = /** @class */ (function (_super) {
    __extends(UploadFunctionRequest, _super);
    function UploadFunctionRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata(),
...
export { UploadFunctionRequest };
var UploadFunctionResponse = /** @class */ (function (_super) {
    __extends(UploadFunctionResponse, _super);
    function UploadFunctionResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata(),
