...
var PutProvisionedConcurrencyConfigResponse = /** @class */ (function (_super) {
    ...
    ], PutProvisionedConcurrencyConfigResponse.prototype, "allocatedProvisionedConcurrentExecutions", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=AvailableProvisionedConcurrentExecutions" }),
        __metadata("design:type", Number)
    ], PutProvisionedConcurrencyConfigResponse.prototype, "availableProvisionedConcurrentExecutions", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=LastModified" }),
        __metadata("design:type", String)
    ], PutProvisionedConcurrencyConfigResponse.prototype, "lastModified", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=RequestedProvisionedConcurrentExecutions" }),
        __metadata("design:type", Number)
    ], PutProvisionedConcurrencyConfigResponse.prototype, "requestedProvisionedConcurrentExecutions", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Status" }),
        __metadata("design:type", String)
    ], PutProvisionedConcurrencyConfigResponse.prototype, "status", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=StatusReason" }),
        __metadata("design:type", String)
    ], PutProvisionedConcurrencyConfigResponse.prototype, "statusReason", void 0);
