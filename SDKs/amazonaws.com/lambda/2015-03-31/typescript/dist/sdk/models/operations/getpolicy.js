...
var GetPolicyPathParams = /** @class */ (function (_super) {
    ...
    ], GetPolicyPathParams.prototype, "functionName", void 0);
    return GetPolicyPathParams;
}(SpeakeasyBase));
export { GetPolicyPathParams };
var GetPolicyQueryParams = /** @class */ (function (_super) {
    __extends(GetPolicyQueryParams, _super);
    function GetPolicyQueryParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "queryParam, style=form;explode=true;name=Qualifier" }),
        __metadata("design:type", String)
    ], GetPolicyQueryParams.prototype, "qualifier", void 0);
    return GetPolicyQueryParams;
}(SpeakeasyBase));
export { GetPolicyQueryParams };
...
var GetPolicyRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        Metadata(),
        __metadata("design:type", GetPolicyQueryParams)
    ], GetPolicyRequest.prototype, "queryParams", void 0);
    __decorate([
        Metadata(),
