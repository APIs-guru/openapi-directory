...
class UpdateFunctionCodeRequest:
    headers: UpdateFunctionCodeHeaders = field()
    path_params: UpdateFunctionCodePathParams = field()
    request: UpdateFunctionCodeRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
