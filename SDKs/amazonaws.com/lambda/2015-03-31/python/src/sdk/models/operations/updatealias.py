...
class UpdateAliasRequestBody:
    ...
    routing_config: Optional[UpdateAliasRequestBodyRoutingConfig] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('RoutingConfig') }})
    

@dataclass
class UpdateAliasRequest:
    headers: UpdateAliasHeaders = field()
    path_params: UpdateAliasPathParams = field()
    request: UpdateAliasRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
