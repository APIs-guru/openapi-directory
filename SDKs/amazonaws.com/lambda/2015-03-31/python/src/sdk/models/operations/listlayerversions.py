...
class ListLayerVersionsQueryParams:
    compatible_runtime: Optional[ListLayerVersionsCompatibleRuntimeEnum] = field(default=None, metadata={'query_param': { 'field_name': 'CompatibleRuntime', 'style': 'form', 'explode': True }})
