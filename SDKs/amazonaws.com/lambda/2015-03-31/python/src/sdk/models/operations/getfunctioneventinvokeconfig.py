...
class GetFunctionEventInvokeConfigRequest:
    headers: GetFunctionEventInvokeConfigHeaders = field()
    path_params: GetFunctionEventInvokeConfigPathParams = field()
    query_params: GetFunctionEventInvokeConfigQueryParams = field()
