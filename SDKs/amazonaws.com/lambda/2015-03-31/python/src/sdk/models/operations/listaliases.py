...
class ListAliasesQueryParams:
    function_version: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'FunctionVersion', 'style': 'form', 'explode': True }})
...
class ListAliasesRequest:
    path_params: ListAliasesPathParams = field(default=None)
