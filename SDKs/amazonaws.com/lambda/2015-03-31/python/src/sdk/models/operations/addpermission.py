...
class AddPermissionRequestBody:
    ...
    event_source_token: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('EventSourceToken') }})
...
class AddPermissionRequest:
    headers: AddPermissionHeaders = field()
    path_params: AddPermissionPathParams = field()
    query_params: AddPermissionQueryParams = field()
    request: AddPermissionRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
