...
@dataclass
class ListLayersQueryParams:
    compatible_runtime: Optional[ListLayersCompatibleRuntimeEnum] = field(default=None, metadata={'query_param': { 'field_name': 'CompatibleRuntime', 'style': 'form', 'explode': True }})
