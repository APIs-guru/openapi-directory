...
class AwsEcsClusterConfigurationExecuteCommandConfigurationLogConfigurationDetails:
    cloud_watch_encryption_enabled: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'CloudWatchEncryptionEnabled' }})
    ...
    s3_encryption_enabled: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'S3EncryptionEnabled' }})
