...
class DeleteInvitationsRequest:
    headers: DeleteInvitationsHeaders = field(default=None)
    request: DeleteInvitationsRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class DeleteInvitationsResponse:
    content_type: str = field(default=None)
    delete_invitations_response: Optional[shared.DeleteInvitationsResponse] = field(default=None)
