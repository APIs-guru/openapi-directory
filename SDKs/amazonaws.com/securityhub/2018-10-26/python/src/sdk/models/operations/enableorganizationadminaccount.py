...
class EnableOrganizationAdminAccountRequestBody:
    admin_account_id: str = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('AdminAccountId') }})
    

@dataclass
class EnableOrganizationAdminAccountRequest:
    headers: EnableOrganizationAdminAccountHeaders = field()
    request: EnableOrganizationAdminAccountRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
