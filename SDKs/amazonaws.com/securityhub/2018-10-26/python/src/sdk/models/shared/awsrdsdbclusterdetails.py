...
from . import awsrdsdbclusterassociatedrole
from . import awsrdsdbclustermember
from . import awsrdsdbclusteroptiongroupmembership
...
class AwsRdsDbClusterDetails:
    activity_stream_status: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ActivityStreamStatus' }})
    allocated_storage: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'AllocatedStorage' }})
    associated_roles: Optional[List[awsrdsdbclusterassociatedrole.AwsRdsDbClusterAssociatedRole]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'AssociatedRoles' }})
    ...
    cross_account_clone: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'CrossAccountClone' }})
    custom_endpoints: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'CustomEndpoints' }})
    ...
    db_cluster_members: Optional[List[awsrdsdbclustermember.AwsRdsDbClusterMember]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'DbClusterMembers' }})
    db_cluster_option_group_memberships: Optional[List[awsrdsdbclusteroptiongroupmembership.AwsRdsDbClusterOptionGroupMembership]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'DbClusterOptionGroupMemberships' }})
    db_cluster_parameter_group: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'DbClusterParameterGroup' }})
    db_cluster_resource_id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'DbClusterResourceId' }})
    db_subnet_group: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'DbSubnetGroup' }})
    ...
    engine_mode: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'EngineMode' }})
    ...
    http_endpoint_enabled: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'HttpEndpointEnabled' }})
    ...
    read_replica_identifiers: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ReadReplicaIdentifiers' }})
    reader_endpoint: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ReaderEndpoint' }})
