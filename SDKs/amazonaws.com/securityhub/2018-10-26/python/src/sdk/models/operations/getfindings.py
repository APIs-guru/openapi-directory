...
class GetFindingsRequestBody:
    filters: Optional[GetFindingsRequestBodyFilters] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Filters' }})
    max_results: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'MaxResults' }})
    next_token: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'NextToken' }})
    sort_criteria: Optional[List[shared.SortCriterion]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'SortCriteria' }})
    

@dataclass
class GetFindingsRequest:
    query_params: GetFindingsQueryParams = field(default=None)
