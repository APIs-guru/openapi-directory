...
@dataclass_json
@dataclass
class GetFindingsRequestBodyFilters:
    r"""GetFindingsRequestBodyFilters
...
class GetFindingsRequestBody:
    filters: Optional[GetFindingsRequestBodyFilters] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Filters') }})
    max_results: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('MaxResults') }})
    next_token: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('NextToken') }})
    sort_criteria: Optional[List[shared.SortCriterion]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('SortCriteria') }})
    

@dataclass
class GetFindingsRequest:
    headers: GetFindingsHeaders = field()
    query_params: GetFindingsQueryParams = field()
