...
class UpdateInsightRequestBody:
    filters: Optional[UpdateInsightRequestBodyFilters] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Filters' }})
    group_by_attribute: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'GroupByAttribute' }})
    name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Name' }})
    

@dataclass
class UpdateInsightRequest:
    path_params: UpdateInsightPathParams = field(default=None)
    headers: UpdateInsightHeaders = field(default=None)
    request: UpdateInsightRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
