...
class UpdateFindingsRequestBody:
    filters: UpdateFindingsRequestBodyFilters = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Filters') }})
    note: Optional[UpdateFindingsRequestBodyNote] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Note') }})
    record_state: Optional[UpdateFindingsRequestBodyRecordStateEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('RecordState') }})
    

@dataclass
class UpdateFindingsRequest:
    headers: UpdateFindingsHeaders = field()
    request: UpdateFindingsRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
