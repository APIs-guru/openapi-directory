...
class CreateInsightRequestBody:
    filters: CreateInsightRequestBodyFilters = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Filters') }})
...
class CreateInsightRequest:
    headers: CreateInsightHeaders = field()
    request: CreateInsightRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
...
class CreateInsightResponse:
    ...
    create_insight_response: Optional[shared.CreateInsightResponse] = field(default=None)
