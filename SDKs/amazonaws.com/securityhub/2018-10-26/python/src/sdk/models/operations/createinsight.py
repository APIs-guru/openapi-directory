...
class CreateInsightRequestBody:
    filters: CreateInsightRequestBodyFilters = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Filters' }})
...
class CreateInsightRequest:
    headers: CreateInsightHeaders = field(default=None)
    request: CreateInsightRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
