...
import { AcceptAdministratorInvitationRequest, AcceptAdministratorInvitationResponse } from "openapi/src/sdk/models/operations";
...
sdk.sdk.acceptAdministratorInvitation(req).then((res: AcceptAdministratorInvitationResponse | AxiosError) => {
   // handle response
});
```
