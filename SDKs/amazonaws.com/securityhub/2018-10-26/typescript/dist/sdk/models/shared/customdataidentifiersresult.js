...
**/
var CustomDataIdentifiersResult = /** @class */ (function (_super) {
    __extends(CustomDataIdentifiersResult, _super);
    ...
    ], CustomDataIdentifiersResult.prototype, "detections", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=TotalCount" }),
        __metadata("design:type", Number)
    ], CustomDataIdentifiersResult.prototype, "totalCount", void 0);
    return CustomDataIdentifiersResult;
}(SpeakeasyBase));
export { CustomDataIdentifiersResult };
