...
**/
var AwsElbLbCookieStickinessPolicy = /** @class */ (function (_super) {
    __extends(AwsElbLbCookieStickinessPolicy, _super);
    ...
    ], AwsElbLbCookieStickinessPolicy.prototype, "cookieExpirationPeriod", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=PolicyName" }),
        __metadata("design:type", String)
    ], AwsElbLbCookieStickinessPolicy.prototype, "policyName", void 0);
    return AwsElbLbCookieStickinessPolicy;
}(SpeakeasyBase));
export { AwsElbLbCookieStickinessPolicy };
