...
**/
var InsightResults = /** @class */ (function (_super) {
    __extends(InsightResults, _super);
    ...
    ], InsightResults.prototype, "groupByAttribute", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=InsightArn" }),
        __metadata("design:type", String)
    ], InsightResults.prototype, "insightArn", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ResultValues", elemType: InsightResultValue }),
        __metadata("design:type", Array)
    ], InsightResults.prototype, "resultValues", void 0);
    return InsightResults;
}(SpeakeasyBase));
export { InsightResults };
