...
**/
var AwsCertificateManagerCertificateRenewalSummary = /** @class */ (function (_super) {
    __extends(AwsCertificateManagerCertificateRenewalSummary, _super);
    ...
    ], AwsCertificateManagerCertificateRenewalSummary.prototype, "domainValidationOptions", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=RenewalStatus" }),
        __metadata("design:type", String)
    ], AwsCertificateManagerCertificateRenewalSummary.prototype, "renewalStatus", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=RenewalStatusReason" }),
        __metadata("design:type", String)
    ], AwsCertificateManagerCertificateRenewalSummary.prototype, "renewalStatusReason", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=UpdatedAt" }),
        __metadata("design:type", String)
    ], AwsCertificateManagerCertificateRenewalSummary.prototype, "updatedAt", void 0);
    return AwsCertificateManagerCertificateRenewalSummary;
}(SpeakeasyBase));
export { AwsCertificateManagerCertificateRenewalSummary };
