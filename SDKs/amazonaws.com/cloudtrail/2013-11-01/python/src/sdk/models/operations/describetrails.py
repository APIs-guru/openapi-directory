...
class DescribeTrailsHeaders:
    x_amz_target: DescribeTrailsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeTrailsRequest:
    headers: DescribeTrailsHeaders = field()
    request: shared.DescribeTrailsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
