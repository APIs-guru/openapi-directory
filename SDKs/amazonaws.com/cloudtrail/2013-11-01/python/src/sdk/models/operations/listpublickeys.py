...
class ListPublicKeysHeaders:
    x_amz_target: ListPublicKeysXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListPublicKeysRequest:
    headers: ListPublicKeysHeaders = field()
    query_params: ListPublicKeysQueryParams = field()
    request: shared.ListPublicKeysRequest = field(metadata={'request': { 'media_type': 'application/json' }})
