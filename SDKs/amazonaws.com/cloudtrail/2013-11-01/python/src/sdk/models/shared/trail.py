...
class Trail:
    ...
    has_custom_event_selectors: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('HasCustomEventSelectors') }})
    has_insight_selectors: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('HasInsightSelectors') }})
