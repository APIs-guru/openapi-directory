...
class LookupEventsHeaders:
    x_amz_target: LookupEventsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class LookupEventsRequest:
    headers: LookupEventsHeaders = field()
    query_params: LookupEventsQueryParams = field()
    request: shared.LookupEventsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
