...
class PutInsightSelectorsHeaders:
    x_amz_target: PutInsightSelectorsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutInsightSelectorsRequest:
    headers: PutInsightSelectorsHeaders = field()
    request: shared.PutInsightSelectorsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
