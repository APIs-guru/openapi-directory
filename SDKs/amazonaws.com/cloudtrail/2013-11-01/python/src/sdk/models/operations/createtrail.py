...
class CreateTrailHeaders:
    ...
    x_amz_target: CreateTrailXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateTrailRequest:
    headers: CreateTrailHeaders = field(default=None)
    request: shared.CreateTrailRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
