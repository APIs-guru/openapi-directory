...
class GetEventSelectorsHeaders:
    ...
    x_amz_target: GetEventSelectorsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetEventSelectorsRequest:
    headers: GetEventSelectorsHeaders = field(default=None)
    request: shared.GetEventSelectorsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class GetEventSelectorsResponse:
    content_type: str = field(default=None)
    get_event_selectors_response: Optional[shared.GetEventSelectorsResponse] = field(default=None)
