...
class GetEventSelectorsHeaders:
    x_amz_target: GetEventSelectorsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetEventSelectorsRequest:
    headers: GetEventSelectorsHeaders = field()
    request: shared.GetEventSelectorsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
