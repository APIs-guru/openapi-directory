...
class StartLoggingHeaders:
    x_amz_target: StartLoggingXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartLoggingRequest:
    headers: StartLoggingHeaders = field()
    request: shared.StartLoggingRequest = field(metadata={'request': { 'media_type': 'application/json' }})
