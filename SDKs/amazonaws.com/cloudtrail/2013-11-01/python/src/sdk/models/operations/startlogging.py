...
class StartLoggingHeaders:
    ...
    x_amz_target: StartLoggingXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class StartLoggingRequest:
    headers: StartLoggingHeaders = field(default=None)
    request: shared.StartLoggingRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class StartLoggingResponse:
    ...
    start_logging_response: Optional[dict[str, Any]] = field(default=None)
