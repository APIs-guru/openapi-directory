...
class GetTrailStatusHeaders:
    x_amz_target: GetTrailStatusXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetTrailStatusRequest:
    headers: GetTrailStatusHeaders = field()
    request: shared.GetTrailStatusRequest = field(metadata={'request': { 'media_type': 'application/json' }})
