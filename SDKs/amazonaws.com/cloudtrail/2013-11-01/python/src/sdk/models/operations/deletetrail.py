...
class DeleteTrailHeaders:
    x_amz_target: DeleteTrailXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteTrailRequest:
    headers: DeleteTrailHeaders = field()
    request: shared.DeleteTrailRequest = field(metadata={'request': { 'media_type': 'application/json' }})
