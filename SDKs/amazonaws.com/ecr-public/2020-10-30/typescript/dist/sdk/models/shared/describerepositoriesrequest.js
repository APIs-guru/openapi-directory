...
var DescribeRepositoriesRequest = /** @class */ (function (_super) {
    ...
    ], DescribeRepositoriesRequest.prototype, "maxResults", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=nextToken" }),
        __metadata("design:type", String)
    ], DescribeRepositoriesRequest.prototype, "nextToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=registryId" }),
        __metadata("design:type", String)
    ], DescribeRepositoriesRequest.prototype, "registryId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=repositoryNames" }),
        __metadata("design:type", Array)
    ], DescribeRepositoriesRequest.prototype, "repositoryNames", void 0);
