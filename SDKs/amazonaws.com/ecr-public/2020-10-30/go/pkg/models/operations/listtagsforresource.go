...
const (
    ListTagsForResourceXAmzTargetEnumSpencerFrontendServiceListTagsForResource ListTagsForResourceXAmzTargetEnum = "SpencerFrontendService.ListTagsForResource"
)
