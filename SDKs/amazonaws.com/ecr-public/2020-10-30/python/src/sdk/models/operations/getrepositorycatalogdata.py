...
class GetRepositoryCatalogDataHeaders:
    x_amz_target: GetRepositoryCatalogDataXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetRepositoryCatalogDataRequest:
    headers: GetRepositoryCatalogDataHeaders = field()
    request: shared.GetRepositoryCatalogDataRequest = field(metadata={'request': { 'media_type': 'application/json' }})
