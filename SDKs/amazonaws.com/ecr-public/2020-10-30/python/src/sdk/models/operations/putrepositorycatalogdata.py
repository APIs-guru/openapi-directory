...
class PutRepositoryCatalogDataHeaders:
    x_amz_target: PutRepositoryCatalogDataXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutRepositoryCatalogDataRequest:
    headers: PutRepositoryCatalogDataHeaders = field()
    request: shared.PutRepositoryCatalogDataRequest = field(metadata={'request': { 'media_type': 'application/json' }})
