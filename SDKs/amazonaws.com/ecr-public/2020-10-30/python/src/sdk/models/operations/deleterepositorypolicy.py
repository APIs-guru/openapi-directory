...
class DeleteRepositoryPolicyHeaders:
    ...
    x_amz_target: DeleteRepositoryPolicyXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DeleteRepositoryPolicyRequest:
    headers: DeleteRepositoryPolicyHeaders = field(default=None)
    request: shared.DeleteRepositoryPolicyRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
