...
class DescribeImageTagsHeaders:
    x_amz_target: DescribeImageTagsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeImageTagsRequest:
    headers: DescribeImageTagsHeaders = field()
    query_params: DescribeImageTagsQueryParams = field()
    request: shared.DescribeImageTagsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
