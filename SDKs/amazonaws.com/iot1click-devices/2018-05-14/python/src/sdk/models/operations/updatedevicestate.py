...
class UpdateDeviceStateRequest:
    headers: UpdateDeviceStateHeaders = field()
    path_params: UpdateDeviceStatePathParams = field()
    request: UpdateDeviceStateRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
