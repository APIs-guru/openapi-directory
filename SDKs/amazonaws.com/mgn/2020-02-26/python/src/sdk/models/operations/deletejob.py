...
class DeleteJobRequest:
    ...
    request: DeleteJobRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class DeleteJobResponse:
    ...
    delete_job_response: Optional[dict[str, Any]] = field(default=None)
