...
class FinalizeCutoverRequest:
    headers: FinalizeCutoverHeaders = field(default=None)
    request: FinalizeCutoverRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
