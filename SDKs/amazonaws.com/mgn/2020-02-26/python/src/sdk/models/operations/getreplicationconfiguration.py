...
class GetReplicationConfigurationRequest:
    headers: GetReplicationConfigurationHeaders = field(default=None)
    request: GetReplicationConfigurationRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
