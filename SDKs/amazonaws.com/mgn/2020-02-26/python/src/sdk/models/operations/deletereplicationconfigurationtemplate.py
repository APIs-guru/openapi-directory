...
class DeleteReplicationConfigurationTemplateRequest:
    headers: DeleteReplicationConfigurationTemplateHeaders = field()
    request: DeleteReplicationConfigurationTemplateRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
