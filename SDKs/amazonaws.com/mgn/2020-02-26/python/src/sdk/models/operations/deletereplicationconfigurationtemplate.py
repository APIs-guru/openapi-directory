...
class DeleteReplicationConfigurationTemplateRequest:
    headers: DeleteReplicationConfigurationTemplateHeaders = field(default=None)
    request: DeleteReplicationConfigurationTemplateRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class DeleteReplicationConfigurationTemplateResponse:
    ...
    delete_replication_configuration_template_response: Optional[dict[str, Any]] = field(default=None)
