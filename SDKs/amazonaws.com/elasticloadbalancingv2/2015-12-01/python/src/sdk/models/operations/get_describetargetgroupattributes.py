...
class GetDescribeTargetGroupAttributesQueryParams:
    action: GetDescribeTargetGroupAttributesActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    target_group_arn: str = field(metadata={'query_param': { 'field_name': 'TargetGroupArn', 'style': 'form', 'explode': True }})
    version: GetDescribeTargetGroupAttributesVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDescribeTargetGroupAttributesRequest:
    headers: GetDescribeTargetGroupAttributesHeaders = field()
    query_params: GetDescribeTargetGroupAttributesQueryParams = field()
