...
class PostDescribeLoadBalancerAttributesQueryParams:
    action: PostDescribeLoadBalancerAttributesActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeLoadBalancerAttributesVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeLoadBalancerAttributesRequest:
    headers: PostDescribeLoadBalancerAttributesHeaders = field()
    query_params: PostDescribeLoadBalancerAttributesQueryParams = field()
