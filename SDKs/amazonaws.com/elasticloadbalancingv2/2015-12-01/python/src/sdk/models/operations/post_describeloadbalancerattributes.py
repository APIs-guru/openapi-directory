...
class PostDescribeLoadBalancerAttributesQueryParams:
    action: PostDescribeLoadBalancerAttributesActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostDescribeLoadBalancerAttributesVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostDescribeLoadBalancerAttributesRequest:
    query_params: PostDescribeLoadBalancerAttributesQueryParams = field(default=None)
    headers: PostDescribeLoadBalancerAttributesHeaders = field(default=None)
