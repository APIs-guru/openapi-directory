...
class PostGetAttributesQueryParams:
    ...
    action: PostGetAttributesActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: PostGetAttributesVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
    

@dataclass
class PostGetAttributesRequest:
    query_params: PostGetAttributesQueryParams = field()
