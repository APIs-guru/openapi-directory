...
class PostCreateDomainQueryParams:
    ...
    action: PostCreateDomainActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: PostCreateDomainVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
    

@dataclass
class PostCreateDomainRequest:
    query_params: PostCreateDomainQueryParams = field()
