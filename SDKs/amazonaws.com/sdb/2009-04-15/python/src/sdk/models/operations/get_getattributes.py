...
class GetGetAttributesQueryParams:
    ...
    action: GetGetAttributesActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetGetAttributesVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
    

@dataclass
class GetGetAttributesRequest:
    query_params: GetGetAttributesQueryParams = field(default=None)
