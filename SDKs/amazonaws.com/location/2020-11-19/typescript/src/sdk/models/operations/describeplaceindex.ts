...
export class DescribePlaceIndexPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=IndexName" })
  indexName: string;
}


export class DescribePlaceIndexHeaders extends SpeakeasyBase {
...
export class DescribePlaceIndexRequest extends SpeakeasyBase {
  @Metadata()
