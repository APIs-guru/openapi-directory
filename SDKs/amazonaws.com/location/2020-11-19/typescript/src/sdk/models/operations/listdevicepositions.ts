...
export class ListDevicePositionsPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=TrackerName" })
  trackerName: string;
}


export class ListDevicePositionsQueryParams extends SpeakeasyBase {
...
export class ListDevicePositionsHeaders extends SpeakeasyBase {
