...
export class DescribeTrackerPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=TrackerName" })
  trackerName: string;
}


export class DescribeTrackerHeaders extends SpeakeasyBase {
...
export class DescribeTrackerRequest extends SpeakeasyBase {
  @Metadata()
