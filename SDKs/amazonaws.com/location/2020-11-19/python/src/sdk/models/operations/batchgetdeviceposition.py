...
class BatchGetDevicePositionRequestBody:
    device_ids: List[str] = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('DeviceIds') }})
    

@dataclass
class BatchGetDevicePositionRequest:
    headers: BatchGetDevicePositionHeaders = field()
    path_params: BatchGetDevicePositionPathParams = field()
    request: BatchGetDevicePositionRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
