...
class BatchUpdateDevicePositionRequestBody:
    updates: List[shared.DevicePositionUpdate] = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Updates') }})
    

@dataclass
class BatchUpdateDevicePositionRequest:
    headers: BatchUpdateDevicePositionHeaders = field()
    path_params: BatchUpdateDevicePositionPathParams = field()
    request: BatchUpdateDevicePositionRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
