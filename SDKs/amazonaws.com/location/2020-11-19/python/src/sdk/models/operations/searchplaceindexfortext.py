...
class SearchPlaceIndexForTextRequest:
    headers: SearchPlaceIndexForTextHeaders = field()
    path_params: SearchPlaceIndexForTextPathParams = field()
    request: SearchPlaceIndexForTextRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
