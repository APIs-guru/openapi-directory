...
@dataclass
class GetDevicePositionPathParams:
...
@dataclass
class GetDevicePositionHeaders:
...
class GetDevicePositionRequest:
    path_params: GetDevicePositionPathParams = field(default=None)
    headers: GetDevicePositionHeaders = field(default=None)
...
class GetDevicePositionResponse:
    ...
    get_device_position_response: Optional[shared.GetDevicePositionResponse] = field(default=None)
