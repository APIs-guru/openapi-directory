...
class ListSecurityPoliciesHeaders:
    x_amz_target: ListSecurityPoliciesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListSecurityPoliciesRequest:
    headers: ListSecurityPoliciesHeaders = field()
    query_params: ListSecurityPoliciesQueryParams = field()
    request: shared.ListSecurityPoliciesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
