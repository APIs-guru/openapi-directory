...
class ListServersHeaders:
    x_amz_target: ListServersXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListServersRequest:
    headers: ListServersHeaders = field()
    query_params: ListServersQueryParams = field()
    request: shared.ListServersRequest = field(metadata={'request': { 'media_type': 'application/json' }})
