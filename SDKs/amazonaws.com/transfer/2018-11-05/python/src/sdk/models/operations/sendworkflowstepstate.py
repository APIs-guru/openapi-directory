...
class SendWorkflowStepStateHeaders:
    ...
    x_amz_target: SendWorkflowStepStateXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class SendWorkflowStepStateRequest:
    headers: SendWorkflowStepStateHeaders = field(default=None)
    request: shared.SendWorkflowStepStateRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
