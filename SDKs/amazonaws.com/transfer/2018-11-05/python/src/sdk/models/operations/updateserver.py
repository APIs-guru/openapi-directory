...
class UpdateServerHeaders:
    x_amz_target: UpdateServerXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateServerRequest:
    headers: UpdateServerHeaders = field()
    request: shared.UpdateServerRequest = field(metadata={'request': { 'media_type': 'application/json' }})
