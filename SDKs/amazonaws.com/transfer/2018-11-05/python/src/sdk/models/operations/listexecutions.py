...
class ListExecutionsHeaders:
    x_amz_target: ListExecutionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListExecutionsRequest:
    ...
    request: shared.ListExecutionsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
