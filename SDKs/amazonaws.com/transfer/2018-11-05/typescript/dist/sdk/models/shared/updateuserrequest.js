...
var UpdateUserRequest = /** @class */ (function (_super) {
    ...
    ], UpdateUserRequest.prototype, "homeDirectory", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=HomeDirectoryMappings", elemType: HomeDirectoryMapEntry }),
        __metadata("design:type", Array)
    ], UpdateUserRequest.prototype, "homeDirectoryMappings", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=HomeDirectoryType" }),
        __metadata("design:type", String)
    ], UpdateUserRequest.prototype, "homeDirectoryType", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Policy" }),
        __metadata("design:type", String)
    ], UpdateUserRequest.prototype, "policy", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=PosixProfile" }),
        __metadata("design:type", PosixProfile)
    ], UpdateUserRequest.prototype, "posixProfile", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], UpdateUserRequest.prototype, "serverId", void 0);
    __decorate([
