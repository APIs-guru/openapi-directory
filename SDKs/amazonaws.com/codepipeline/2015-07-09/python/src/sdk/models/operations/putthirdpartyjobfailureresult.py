...
class PutThirdPartyJobFailureResultHeaders:
    x_amz_target: PutThirdPartyJobFailureResultXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutThirdPartyJobFailureResultRequest:
    headers: PutThirdPartyJobFailureResultHeaders = field()
    request: shared.PutThirdPartyJobFailureResultInput = field(metadata={'request': { 'media_type': 'application/json' }})
