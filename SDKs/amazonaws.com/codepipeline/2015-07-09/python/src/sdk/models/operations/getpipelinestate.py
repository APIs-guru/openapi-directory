...
class GetPipelineStateHeaders:
    x_amz_target: GetPipelineStateXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetPipelineStateRequest:
    headers: GetPipelineStateHeaders = field()
    request: shared.GetPipelineStateInput = field(metadata={'request': { 'media_type': 'application/json' }})
