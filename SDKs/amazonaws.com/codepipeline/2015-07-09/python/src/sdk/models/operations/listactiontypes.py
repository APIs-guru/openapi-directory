...
class ListActionTypesHeaders:
    x_amz_target: ListActionTypesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListActionTypesRequest:
    headers: ListActionTypesHeaders = field()
    query_params: ListActionTypesQueryParams = field()
    request: shared.ListActionTypesInput = field(metadata={'request': { 'media_type': 'application/json' }})
