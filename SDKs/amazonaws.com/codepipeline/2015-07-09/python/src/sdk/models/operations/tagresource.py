...
class TagResourceXAmzTargetEnum(str, Enum):
    CODE_PIPELINE_20150709_TAG_RESOURCE = "CodePipeline_20150709.TagResource"
...
class TagResourceRequest:
    ...
    request: shared.TagResourceInput = field(metadata={'request': { 'media_type': 'application/json' }})
