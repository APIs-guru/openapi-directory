...
class DisableStageTransitionHeaders:
    x_amz_target: DisableStageTransitionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DisableStageTransitionRequest:
    headers: DisableStageTransitionHeaders = field()
    request: shared.DisableStageTransitionInput = field(metadata={'request': { 'media_type': 'application/json' }})
