...
class GetThirdPartyJobDetailsHeaders:
    x_amz_target: GetThirdPartyJobDetailsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetThirdPartyJobDetailsRequest:
    headers: GetThirdPartyJobDetailsHeaders = field()
    request: shared.GetThirdPartyJobDetailsInput = field(metadata={'request': { 'media_type': 'application/json' }})
