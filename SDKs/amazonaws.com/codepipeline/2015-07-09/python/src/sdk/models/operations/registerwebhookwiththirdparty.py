...
class RegisterWebhookWithThirdPartyHeaders:
    x_amz_target: RegisterWebhookWithThirdPartyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RegisterWebhookWithThirdPartyRequest:
    headers: RegisterWebhookWithThirdPartyHeaders = field()
    request: shared.RegisterWebhookWithThirdPartyInput = field(metadata={'request': { 'media_type': 'application/json' }})
