...
class RetryStageExecutionHeaders:
    x_amz_target: RetryStageExecutionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RetryStageExecutionRequest:
    headers: RetryStageExecutionHeaders = field()
    request: shared.RetryStageExecutionInput = field(metadata={'request': { 'media_type': 'application/json' }})
