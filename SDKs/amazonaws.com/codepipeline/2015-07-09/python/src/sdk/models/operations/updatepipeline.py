...
class UpdatePipelineHeaders:
    ...
    x_amz_target: UpdatePipelineXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
    

@dataclass
class UpdatePipelineRequest:
    headers: UpdatePipelineHeaders = field(default=None)
    request: shared.UpdatePipelineInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
