...
class PutJobSuccessResultHeaders:
    x_amz_target: PutJobSuccessResultXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutJobSuccessResultRequest:
    headers: PutJobSuccessResultHeaders = field()
    request: shared.PutJobSuccessResultInput = field(metadata={'request': { 'media_type': 'application/json' }})
