...
class PutWebhookHeaders:
    x_amz_target: PutWebhookXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutWebhookRequest:
    headers: PutWebhookHeaders = field()
    request: shared.PutWebhookInput = field(metadata={'request': { 'media_type': 'application/json' }})
