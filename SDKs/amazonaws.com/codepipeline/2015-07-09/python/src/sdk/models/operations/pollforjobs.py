...
class PollForJobsHeaders:
    x_amz_target: PollForJobsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PollForJobsRequest:
    headers: PollForJobsHeaders = field()
    request: shared.PollForJobsInput = field(metadata={'request': { 'media_type': 'application/json' }})
