...
class PutActionRevisionHeaders:
    x_amz_target: PutActionRevisionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutActionRevisionRequest:
    headers: PutActionRevisionHeaders = field()
    request: shared.PutActionRevisionInput = field(metadata={'request': { 'media_type': 'application/json' }})
