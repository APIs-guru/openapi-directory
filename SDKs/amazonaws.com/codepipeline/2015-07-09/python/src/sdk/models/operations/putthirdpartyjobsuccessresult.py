...
class PutThirdPartyJobSuccessResultHeaders:
    ...
    x_amz_target: PutThirdPartyJobSuccessResultXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class PutThirdPartyJobSuccessResultRequest:
    headers: PutThirdPartyJobSuccessResultHeaders = field(default=None)
    request: shared.PutThirdPartyJobSuccessResultInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
