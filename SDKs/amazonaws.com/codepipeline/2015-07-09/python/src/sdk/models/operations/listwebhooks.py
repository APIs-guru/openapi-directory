...
class ListWebhooksHeaders:
    x_amz_target: ListWebhooksXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListWebhooksRequest:
    ...
    request: shared.ListWebhooksInput = field(metadata={'request': { 'media_type': 'application/json' }})
