...
class UpdateActionTypeHeaders:
    x_amz_target: UpdateActionTypeXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateActionTypeRequest:
    headers: UpdateActionTypeHeaders = field()
    request: shared.UpdateActionTypeInput = field(metadata={'request': { 'media_type': 'application/json' }})
