...
**/
var PollForJobsInput = /** @class */ (function (_super) {
    __extends(PollForJobsInput, _super);
    ...
    ], PollForJobsInput.prototype, "actionTypeId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=maxBatchSize" }),
        __metadata("design:type", Number)
    ], PollForJobsInput.prototype, "maxBatchSize", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=queryParam" }),
        __metadata("design:type", Map)
    ], PollForJobsInput.prototype, "queryParam", void 0);
    return PollForJobsInput;
}(SpeakeasyBase));
export { PollForJobsInput };
