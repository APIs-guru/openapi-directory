...
var InvokeEndpointPathParams = /** @class */ (function (_super) {
    ...
    function InvokeEndpointPathParams() {
...
export { InvokeEndpointPathParams };
var InvokeEndpointHeaders = /** @class */ (function (_super) {
    __extends(InvokeEndpointHeaders, _super);
    function InvokeEndpointHeaders() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
...
export { InvokeEndpointHeaders };
var InvokeEndpointRequestBody = /** @class */ (function (_super) {
    __extends(InvokeEndpointRequestBody, _super);
    function InvokeEndpointRequestBody() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
...
export { InvokeEndpointRequestBody };
var InvokeEndpointRequest = /** @class */ (function (_super) {
    __extends(InvokeEndpointRequest, _super);
    function InvokeEndpointRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata(),
...
export { InvokeEndpointRequest };
var InvokeEndpointResponse = /** @class */ (function (_super) {
    __extends(InvokeEndpointResponse, _super);
    function InvokeEndpointResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata(),
