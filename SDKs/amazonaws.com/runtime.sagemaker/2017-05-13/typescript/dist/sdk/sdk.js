...
var SDK = /** @class */ (function () {
    ...
    **/
    SDK.prototype.invokeEndpoint = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.InvokeEndpointRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/endpoints/{EndpointName}/invocations", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.invokeEndpointOutput = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 483:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.modelError = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    SDK.prototype.invokeEndpointAsync = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.InvokeEndpointAsyncRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/endpoints/{EndpointName}/async-invocations#X-Amzn-SageMaker-InputLocation", req.pathParams);
        var client = this._securityClient;
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 202:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.invokeEndpointAsyncOutput = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 480:
                    if (utils.MatchContentType(contentType, "application/json")) {
