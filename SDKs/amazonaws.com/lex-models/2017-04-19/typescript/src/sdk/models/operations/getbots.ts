...
export class GetBotsQueryParams extends SpeakeasyBase {
...
export class GetBotsHeaders extends SpeakeasyBase {
...
export class GetBotsRequest extends SpeakeasyBase {
  @Metadata()
