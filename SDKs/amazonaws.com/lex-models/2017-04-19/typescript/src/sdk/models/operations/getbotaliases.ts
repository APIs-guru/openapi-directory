...
export class GetBotAliasesPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=botName" })
  botName: string;
}


export class GetBotAliasesQueryParams extends SpeakeasyBase {
...
export class GetBotAliasesHeaders extends SpeakeasyBase {
...
export class GetBotAliasesRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
