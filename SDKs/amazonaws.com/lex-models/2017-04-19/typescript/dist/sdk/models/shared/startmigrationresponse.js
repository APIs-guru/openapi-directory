...
var StartMigrationResponse = /** @class */ (function (_super) {
    ...
    ], StartMigrationResponse.prototype, "migrationId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=migrationStrategy" }),
        __metadata("design:type", String)
    ], StartMigrationResponse.prototype, "migrationStrategy", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=migrationTimestamp" }),
        __metadata("design:type", Date)
    ], StartMigrationResponse.prototype, "migrationTimestamp", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=v1BotLocale" }),
        __metadata("design:type", String)
    ], StartMigrationResponse.prototype, "v1BotLocale", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=v1BotName" }),
        __metadata("design:type", String)
    ], StartMigrationResponse.prototype, "v1BotName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=v1BotVersion" }),
        __metadata("design:type", String)
    ], StartMigrationResponse.prototype, "v1BotVersion", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=v2BotId" }),
        __metadata("design:type", String)
    ], StartMigrationResponse.prototype, "v2BotId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=v2BotRole" }),
        __metadata("design:type", String)
    ], StartMigrationResponse.prototype, "v2BotRole", void 0);
