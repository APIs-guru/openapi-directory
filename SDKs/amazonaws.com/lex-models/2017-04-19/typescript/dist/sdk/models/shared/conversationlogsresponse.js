...
**/
var ConversationLogsResponse = /** @class */ (function (_super) {
    __extends(ConversationLogsResponse, _super);
    ...
    ], ConversationLogsResponse.prototype, "iamRoleArn", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=logSettings", elemType: LogSettingsResponse }),
        __metadata("design:type", Array)
    ], ConversationLogsResponse.prototype, "logSettings", void 0);
    return ConversationLogsResponse;
}(SpeakeasyBase));
export { ConversationLogsResponse };
