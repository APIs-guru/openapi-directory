...
**/
var MigrationSummary = /** @class */ (function (_super) {
    __extends(MigrationSummary, _super);
    ...
    ], MigrationSummary.prototype, "migrationId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=migrationStatus" }),
        __metadata("design:type", String)
    ], MigrationSummary.prototype, "migrationStatus", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=migrationStrategy" }),
        __metadata("design:type", String)
    ], MigrationSummary.prototype, "migrationStrategy", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=migrationTimestamp" }),
        __metadata("design:type", Date)
    ], MigrationSummary.prototype, "migrationTimestamp", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=v1BotLocale" }),
        __metadata("design:type", String)
    ], MigrationSummary.prototype, "v1BotLocale", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=v1BotName" }),
        __metadata("design:type", String)
    ], MigrationSummary.prototype, "v1BotName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=v1BotVersion" }),
        __metadata("design:type", String)
    ], MigrationSummary.prototype, "v1BotVersion", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=v2BotId" }),
        __metadata("design:type", String)
    ], MigrationSummary.prototype, "v2BotId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=v2BotRole" }),
        __metadata("design:type", String)
    ], MigrationSummary.prototype, "v2BotRole", void 0);
