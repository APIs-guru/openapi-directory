...
var GetSlotTypeResponse = /** @class */ (function (_super) {
    ...
    ], GetSlotTypeResponse.prototype, "checksum", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=createdDate" }),
        __metadata("design:type", Date)
    ], GetSlotTypeResponse.prototype, "createdDate", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=description" }),
        __metadata("design:type", String)
    ], GetSlotTypeResponse.prototype, "description", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=enumerationValues", elemType: EnumerationValue }),
        __metadata("design:type", Array)
    ], GetSlotTypeResponse.prototype, "enumerationValues", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=lastUpdatedDate" }),
        __metadata("design:type", Date)
    ], GetSlotTypeResponse.prototype, "lastUpdatedDate", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=name" }),
        __metadata("design:type", String)
    ], GetSlotTypeResponse.prototype, "name", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=parentSlotTypeSignature" }),
        __metadata("design:type", String)
    ], GetSlotTypeResponse.prototype, "parentSlotTypeSignature", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=slotTypeConfigurations", elemType: SlotTypeConfiguration }),
        __metadata("design:type", Array)
    ], GetSlotTypeResponse.prototype, "slotTypeConfigurations", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=valueSelectionStrategy" }),
        __metadata("design:type", String)
    ], GetSlotTypeResponse.prototype, "valueSelectionStrategy", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=version" }),
        __metadata("design:type", String)
    ], GetSlotTypeResponse.prototype, "version", void 0);
