...
var CreateSlotTypeVersionResponse = /** @class */ (function (_super) {
    ...
    ], CreateSlotTypeVersionResponse.prototype, "checksum", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=createdDate" }),
        __metadata("design:type", Date)
    ], CreateSlotTypeVersionResponse.prototype, "createdDate", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=description" }),
        __metadata("design:type", String)
    ], CreateSlotTypeVersionResponse.prototype, "description", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=enumerationValues", elemType: EnumerationValue }),
        __metadata("design:type", Array)
    ], CreateSlotTypeVersionResponse.prototype, "enumerationValues", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=lastUpdatedDate" }),
        __metadata("design:type", Date)
    ], CreateSlotTypeVersionResponse.prototype, "lastUpdatedDate", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=name" }),
        __metadata("design:type", String)
    ], CreateSlotTypeVersionResponse.prototype, "name", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=parentSlotTypeSignature" }),
        __metadata("design:type", String)
    ], CreateSlotTypeVersionResponse.prototype, "parentSlotTypeSignature", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=slotTypeConfigurations", elemType: SlotTypeConfiguration }),
        __metadata("design:type", Array)
    ], CreateSlotTypeVersionResponse.prototype, "slotTypeConfigurations", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=valueSelectionStrategy" }),
        __metadata("design:type", String)
    ], CreateSlotTypeVersionResponse.prototype, "valueSelectionStrategy", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=version" }),
        __metadata("design:type", String)
    ], CreateSlotTypeVersionResponse.prototype, "version", void 0);
