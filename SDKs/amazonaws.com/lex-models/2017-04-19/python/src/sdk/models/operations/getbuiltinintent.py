...
class GetBuiltinIntentPathParams:
    signature: str = field(metadata={'path_param': { 'field_name': 'signature', 'style': 'simple', 'explode': False }})
...
class GetBuiltinIntentRequest:
    headers: GetBuiltinIntentHeaders = field()
    path_params: GetBuiltinIntentPathParams = field()
