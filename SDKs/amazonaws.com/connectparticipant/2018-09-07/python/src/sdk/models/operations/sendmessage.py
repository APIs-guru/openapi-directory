...
class SendMessageRequest:
    headers: SendMessageHeaders = field(default=None)
    request: SendMessageRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class SendMessageResponse:
    ...
    send_message_response: Optional[shared.SendMessageResponse] = field(default=None)
