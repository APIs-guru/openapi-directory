...
class CompleteAttachmentUploadRequestBody:
    attachment_ids: List[str] = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('AttachmentIds') }})
...
class CompleteAttachmentUploadRequest:
    headers: CompleteAttachmentUploadHeaders = field()
    request: CompleteAttachmentUploadRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
