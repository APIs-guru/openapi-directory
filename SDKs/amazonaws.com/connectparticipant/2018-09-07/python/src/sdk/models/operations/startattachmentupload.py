...
class StartAttachmentUploadRequestBody:
    attachment_name: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'AttachmentName' }})
    attachment_size_in_bytes: int = field(default=None, metadata={'dataclasses_json': { 'field_name': 'AttachmentSizeInBytes' }})
...
class StartAttachmentUploadRequest:
    headers: StartAttachmentUploadHeaders = field(default=None)
    request: StartAttachmentUploadRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
