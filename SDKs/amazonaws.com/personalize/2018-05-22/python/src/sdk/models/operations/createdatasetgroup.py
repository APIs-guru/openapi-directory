...
class CreateDatasetGroupHeaders:
    x_amz_target: CreateDatasetGroupXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateDatasetGroupRequest:
    headers: CreateDatasetGroupHeaders = field()
    request: shared.CreateDatasetGroupRequest = field(metadata={'request': { 'media_type': 'application/json' }})
