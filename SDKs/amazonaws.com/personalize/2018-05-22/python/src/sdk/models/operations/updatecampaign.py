...
class UpdateCampaignHeaders:
    x_amz_target: UpdateCampaignXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateCampaignRequest:
    ...
    request: shared.UpdateCampaignRequest = field(metadata={'request': { 'media_type': 'application/json' }})
