...
class GetSolutionMetricsHeaders:
    x_amz_target: GetSolutionMetricsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetSolutionMetricsRequest:
    headers: GetSolutionMetricsHeaders = field()
    request: shared.GetSolutionMetricsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
