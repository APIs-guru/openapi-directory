...
class ListDatasetImportJobsHeaders:
    x_amz_target: ListDatasetImportJobsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListDatasetImportJobsRequest:
    headers: ListDatasetImportJobsHeaders = field()
    query_params: ListDatasetImportJobsQueryParams = field()
    request: shared.ListDatasetImportJobsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
