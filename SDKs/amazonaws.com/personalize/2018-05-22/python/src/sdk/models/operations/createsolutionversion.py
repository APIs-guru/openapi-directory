...
class CreateSolutionVersionHeaders:
    x_amz_target: CreateSolutionVersionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateSolutionVersionRequest:
    headers: CreateSolutionVersionHeaders = field()
    request: shared.CreateSolutionVersionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
