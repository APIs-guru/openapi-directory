...
class ListSolutionsHeaders:
    x_amz_target: ListSolutionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListSolutionsRequest:
    headers: ListSolutionsHeaders = field()
    query_params: ListSolutionsQueryParams = field()
    request: shared.ListSolutionsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
