...
class ListSolutionVersionsHeaders:
    ...
    x_amz_target: ListSolutionVersionsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ListSolutionVersionsRequest:
    query_params: ListSolutionVersionsQueryParams = field(default=None)
    headers: ListSolutionVersionsHeaders = field(default=None)
    request: shared.ListSolutionVersionsRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
