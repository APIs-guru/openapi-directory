...
var DatasetGroupSummary = /** @class */ (function (_super) {
    ...
    ], DatasetGroupSummary.prototype, "creationDateTime", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], DatasetGroupSummary.prototype, "failureReason", void 0);
    __decorate([
        Metadata({ data: "json, name=lastUpdatedDateTime" }),
        __metadata("design:type", Date)
    ], DatasetGroupSummary.prototype, "lastUpdatedDateTime", void 0);
    __decorate([
        Metadata({ data: "json, name=name" }),
        __metadata("design:type", String)
    ], DatasetGroupSummary.prototype, "name", void 0);
    __decorate([
        Metadata({ data: "json, name=status" }),
        __metadata("design:type", String)
    ], DatasetGroupSummary.prototype, "status", void 0);
