...
**/
var EbsConfiguration = /** @class */ (function (_super) {
    __extends(EbsConfiguration, _super);
    ...
    ], EbsConfiguration.prototype, "ebsBlockDeviceConfigs", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=EbsOptimized" }),
        __metadata("design:type", Boolean)
    ], EbsConfiguration.prototype, "ebsOptimized", void 0);
    return EbsConfiguration;
}(SpeakeasyBase));
export { EbsConfiguration };
