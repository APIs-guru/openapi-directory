...
**/
var ExecutionEngineConfig = /** @class */ (function (_super) {
    __extends(ExecutionEngineConfig, _super);
    ...
    ], ExecutionEngineConfig.prototype, "id", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=MasterInstanceSecurityGroupId" }),
        __metadata("design:type", String)
    ], ExecutionEngineConfig.prototype, "masterInstanceSecurityGroupId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Type" }),
        __metadata("design:type", String)
    ], ExecutionEngineConfig.prototype, "type", void 0);
    return ExecutionEngineConfig;
}(SpeakeasyBase));
export { ExecutionEngineConfig };
