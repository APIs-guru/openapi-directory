...
export class ListStudioSessionMappingsQueryParams extends SpeakeasyBase {
  @Metadata({ data: "queryParam, style=form;explode=true;name=Marker" })
  marker?: string;
}

export enum ListStudioSessionMappingsXAmzTargetEnum {
    ElasticMapReduceListStudioSessionMappings = "ElasticMapReduce.ListStudioSessionMappings"
}


export class ListStudioSessionMappingsHeaders extends SpeakeasyBase {
...
export class ListStudioSessionMappingsRequest extends SpeakeasyBase {
  @Metadata()
...
export class ListStudioSessionMappingsResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
