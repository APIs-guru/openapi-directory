...
__doc__ = """ SDK Documentation: https://docs.aws.amazon.com/elasticmapreduce/ - Amazon Web Services documentation"""
import requests
...
class SDK:
    r"""SDK Documentation: https://docs.aws.amazon.com/elasticmapreduce/ - Amazon Web Services documentation"""
    ...
    def create_studio_session_mapping(self, request: operations.CreateStudioSessionMappingRequest) -> operations.CreateStudioSessionMappingResponse:
        r"""Maps a user or group to the Amazon EMR Studio specified by <code>StudioId</code>, and applies a session policy to refine Studio permissions for that user or group. Use <code>CreateStudioSessionMapping</code> to assign users to a Studio when you use Amazon Web Services SSO authentication. For instructions on how to assign users to a Studio when you use IAM authentication, see <a href=\"https://docs.aws.amazon.com/emr/latest/ManagementGuide/emr-studio-manage-users.html#emr-studio-assign-users-groups\">Assign a user or group to your EMR Studio</a>.
        """
