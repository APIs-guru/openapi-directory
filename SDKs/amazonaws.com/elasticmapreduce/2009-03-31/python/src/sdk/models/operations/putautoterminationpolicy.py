...
class PutAutoTerminationPolicyHeaders:
    x_amz_target: PutAutoTerminationPolicyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutAutoTerminationPolicyRequest:
    headers: PutAutoTerminationPolicyHeaders = field()
    request: shared.PutAutoTerminationPolicyInput = field(metadata={'request': { 'media_type': 'application/json' }})
