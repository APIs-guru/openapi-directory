...
class ListInstanceFleetsHeaders:
    x_amz_target: ListInstanceFleetsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListInstanceFleetsRequest:
    headers: ListInstanceFleetsHeaders = field()
    query_params: ListInstanceFleetsQueryParams = field()
    request: shared.ListInstanceFleetsInput = field(metadata={'request': { 'media_type': 'application/json' }})
