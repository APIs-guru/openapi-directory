...
class PutAutoScalingPolicyHeaders:
    x_amz_target: PutAutoScalingPolicyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutAutoScalingPolicyRequest:
    headers: PutAutoScalingPolicyHeaders = field()
    request: shared.PutAutoScalingPolicyInput = field(metadata={'request': { 'media_type': 'application/json' }})
