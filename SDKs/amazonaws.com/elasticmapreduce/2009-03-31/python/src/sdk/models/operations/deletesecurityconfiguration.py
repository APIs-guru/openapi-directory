...
class DeleteSecurityConfigurationHeaders:
    x_amz_target: DeleteSecurityConfigurationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteSecurityConfigurationRequest:
    headers: DeleteSecurityConfigurationHeaders = field()
    request: shared.DeleteSecurityConfigurationInput = field(metadata={'request': { 'media_type': 'application/json' }})
