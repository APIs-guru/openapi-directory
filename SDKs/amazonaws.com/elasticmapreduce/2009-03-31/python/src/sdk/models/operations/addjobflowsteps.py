...
class AddJobFlowStepsHeaders:
    ...
    x_amz_target: AddJobFlowStepsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class AddJobFlowStepsRequest:
    headers: AddJobFlowStepsHeaders = field(default=None)
    request: shared.AddJobFlowStepsInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
