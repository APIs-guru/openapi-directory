...
class PutBlockPublicAccessConfigurationHeaders:
    x_amz_target: PutBlockPublicAccessConfigurationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class PutBlockPublicAccessConfigurationRequest:
    headers: PutBlockPublicAccessConfigurationHeaders = field()
    request: shared.PutBlockPublicAccessConfigurationInput = field(metadata={'request': { 'media_type': 'application/json' }})
