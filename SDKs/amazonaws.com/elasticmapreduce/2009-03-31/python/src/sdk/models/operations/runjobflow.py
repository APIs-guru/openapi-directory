...
class RunJobFlowHeaders:
    x_amz_target: RunJobFlowXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RunJobFlowRequest:
    headers: RunJobFlowHeaders = field()
    request: shared.RunJobFlowInput = field(metadata={'request': { 'media_type': 'application/json' }})
