...
class GetManagedScalingPolicyHeaders:
    x_amz_target: GetManagedScalingPolicyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetManagedScalingPolicyRequest:
    headers: GetManagedScalingPolicyHeaders = field()
    request: shared.GetManagedScalingPolicyInput = field(metadata={'request': { 'media_type': 'application/json' }})
