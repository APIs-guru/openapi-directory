...
class AddInstanceGroupsHeaders:
    x_amz_target: AddInstanceGroupsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AddInstanceGroupsRequest:
    headers: AddInstanceGroupsHeaders = field()
    request: shared.AddInstanceGroupsInput = field(metadata={'request': { 'media_type': 'application/json' }})
