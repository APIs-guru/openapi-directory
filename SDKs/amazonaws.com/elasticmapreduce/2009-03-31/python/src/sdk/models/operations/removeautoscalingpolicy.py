...
class RemoveAutoScalingPolicyHeaders:
    x_amz_target: RemoveAutoScalingPolicyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RemoveAutoScalingPolicyRequest:
    headers: RemoveAutoScalingPolicyHeaders = field()
    request: shared.RemoveAutoScalingPolicyInput = field(metadata={'request': { 'media_type': 'application/json' }})
