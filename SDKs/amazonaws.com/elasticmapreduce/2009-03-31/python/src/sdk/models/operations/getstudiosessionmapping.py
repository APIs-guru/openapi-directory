...
class GetStudioSessionMappingHeaders:
    x_amz_target: GetStudioSessionMappingXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetStudioSessionMappingRequest:
    headers: GetStudioSessionMappingHeaders = field()
    request: shared.GetStudioSessionMappingInput = field(metadata={'request': { 'media_type': 'application/json' }})
