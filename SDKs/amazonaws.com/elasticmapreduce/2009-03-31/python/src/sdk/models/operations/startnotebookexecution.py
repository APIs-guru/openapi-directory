...
class StartNotebookExecutionHeaders:
    ...
    x_amz_target: StartNotebookExecutionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
    

@dataclass
class StartNotebookExecutionRequest:
    headers: StartNotebookExecutionHeaders = field(default=None)
    request: shared.StartNotebookExecutionInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
