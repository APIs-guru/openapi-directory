...
class ListBootstrapActionsHeaders:
    x_amz_target: ListBootstrapActionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListBootstrapActionsRequest:
    headers: ListBootstrapActionsHeaders = field()
    query_params: ListBootstrapActionsQueryParams = field()
    request: shared.ListBootstrapActionsInput = field(metadata={'request': { 'media_type': 'application/json' }})
