...
class CreateStudioHeaders:
    x_amz_target: CreateStudioXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateStudioRequest:
    ...
    request: shared.CreateStudioInput = field(metadata={'request': { 'media_type': 'application/json' }})
