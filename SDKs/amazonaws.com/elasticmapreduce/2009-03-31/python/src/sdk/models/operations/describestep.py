...
class DescribeStepHeaders:
    x_amz_target: DescribeStepXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeStepRequest:
    headers: DescribeStepHeaders = field()
    request: shared.DescribeStepInput = field(metadata={'request': { 'media_type': 'application/json' }})
