...
class GetAutoTerminationPolicyHeaders:
    x_amz_target: GetAutoTerminationPolicyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetAutoTerminationPolicyRequest:
    headers: GetAutoTerminationPolicyHeaders = field()
    request: shared.GetAutoTerminationPolicyInput = field(metadata={'request': { 'media_type': 'application/json' }})
