...
class DescribeNotebookExecutionHeaders:
    x_amz_target: DescribeNotebookExecutionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeNotebookExecutionRequest:
    headers: DescribeNotebookExecutionHeaders = field()
    request: shared.DescribeNotebookExecutionInput = field(metadata={'request': { 'media_type': 'application/json' }})
