...
class RemoveManagedScalingPolicyHeaders:
    ...
    x_amz_target: RemoveManagedScalingPolicyXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class RemoveManagedScalingPolicyRequest:
    headers: RemoveManagedScalingPolicyHeaders = field(default=None)
    request: shared.RemoveManagedScalingPolicyInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
