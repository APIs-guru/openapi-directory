...
class RemoveAutoTerminationPolicyHeaders:
    x_amz_target: RemoveAutoTerminationPolicyXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RemoveAutoTerminationPolicyRequest:
    headers: RemoveAutoTerminationPolicyHeaders = field()
    request: shared.RemoveAutoTerminationPolicyInput = field(metadata={'request': { 'media_type': 'application/json' }})
