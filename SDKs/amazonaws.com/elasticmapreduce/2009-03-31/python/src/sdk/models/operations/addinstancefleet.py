...
class AddInstanceFleetHeaders:
    ...
    x_amz_target: AddInstanceFleetXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target' }})
    

@dataclass
class AddInstanceFleetRequest:
    headers: AddInstanceFleetHeaders = field(default=None)
    request: shared.AddInstanceFleetInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
