...
class GetIceServerConfigRequestBody:
    ...
    service: Optional[GetIceServerConfigRequestBodyServiceEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Service' }})
    username: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Username' }})
    

@dataclass
class GetIceServerConfigRequest:
    headers: GetIceServerConfigHeaders = field(default=None)
    request: GetIceServerConfigRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
