...
class UpdateCertificateOptionsHeaders:
    x_amz_target: UpdateCertificateOptionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateCertificateOptionsRequest:
    headers: UpdateCertificateOptionsHeaders = field()
    request: shared.UpdateCertificateOptionsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
