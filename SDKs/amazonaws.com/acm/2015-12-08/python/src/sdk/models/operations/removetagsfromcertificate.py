...
class RemoveTagsFromCertificateHeaders:
    x_amz_target: RemoveTagsFromCertificateXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RemoveTagsFromCertificateRequest:
    headers: RemoveTagsFromCertificateHeaders = field()
    request: shared.RemoveTagsFromCertificateRequest = field(metadata={'request': { 'media_type': 'application/json' }})
