...
class RemoveTagsFromCertificateHeaders:
    ...
    x_amz_target: RemoveTagsFromCertificateXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class RemoveTagsFromCertificateRequest:
    headers: RemoveTagsFromCertificateHeaders = field(default=None)
    request: shared.RemoveTagsFromCertificateRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
