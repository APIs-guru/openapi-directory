...
class GetAccountConfigurationHeaders:
    x_amz_target: GetAccountConfigurationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetAccountConfigurationRequest:
    headers: GetAccountConfigurationHeaders = field()
