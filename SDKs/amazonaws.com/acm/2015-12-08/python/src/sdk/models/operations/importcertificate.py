...
class ImportCertificateHeaders:
    x_amz_target: ImportCertificateXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ImportCertificateRequest:
    headers: ImportCertificateHeaders = field()
    request: shared.ImportCertificateRequest = field(metadata={'request': { 'media_type': 'application/json' }})
