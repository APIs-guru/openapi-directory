...
class DescribeCertificateHeaders:
    x_amz_target: DescribeCertificateXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeCertificateRequest:
    headers: DescribeCertificateHeaders = field()
    request: shared.DescribeCertificateRequest = field(metadata={'request': { 'media_type': 'application/json' }})
