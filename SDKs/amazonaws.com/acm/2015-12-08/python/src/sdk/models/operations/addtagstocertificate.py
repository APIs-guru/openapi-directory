...
class AddTagsToCertificateHeaders:
    x_amz_target: AddTagsToCertificateXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class AddTagsToCertificateRequest:
    headers: AddTagsToCertificateHeaders = field()
    request: shared.AddTagsToCertificateRequest = field(metadata={'request': { 'media_type': 'application/json' }})
