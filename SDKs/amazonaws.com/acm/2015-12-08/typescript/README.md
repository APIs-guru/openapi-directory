...
import { AddTagsToCertificateRequest, AddTagsToCertificateResponse } from "openapi/src/sdk/models/operations";
...
sdk.sdk.addTagsToCertificate(req).then((res: AddTagsToCertificateResponse | AxiosError) => {
   // handle response
});
```
