...
var CreateWorkerConfigurationResponse = /** @class */ (function (_super) {
    ...
    ], CreateWorkerConfigurationResponse.prototype, "creationTime", void 0);
    __decorate([
        Metadata({ data: "json, name=latestRevision" }),
        __metadata("design:type", WorkerConfigurationRevisionSummary)
    ], CreateWorkerConfigurationResponse.prototype, "latestRevision", void 0);
    __decorate([
        Metadata({ data: "json, name=name" }),
        __metadata("design:type", String)
    ], CreateWorkerConfigurationResponse.prototype, "name", void 0);
    __decorate([
        Metadata({ data: "json, name=workerConfigurationArn" }),
        __metadata("design:type", String)
    ], CreateWorkerConfigurationResponse.prototype, "workerConfigurationArn", void 0);
