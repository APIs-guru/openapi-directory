...
class DescribeCustomPluginPathParams:
    custom_plugin_arn: str = field(metadata={'path_param': { 'field_name': 'customPluginArn', 'style': 'simple', 'explode': False }})
...
class DescribeCustomPluginRequest:
    headers: DescribeCustomPluginHeaders = field()
    path_params: DescribeCustomPluginPathParams = field()
