...
class DescribeWorkerConfigurationResponse:
    ...
    latest_revision: Optional[WorkerConfigurationRevisionDescription] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('latestRevision') }})
