...
class StartReportCreationHeaders:
    x_amz_target: StartReportCreationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartReportCreationRequest:
    headers: StartReportCreationHeaders = field()
    request: shared.StartReportCreationInput = field(metadata={'request': { 'media_type': 'application/json' }})
