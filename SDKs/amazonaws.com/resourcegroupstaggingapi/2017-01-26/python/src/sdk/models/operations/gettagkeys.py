...
class GetTagKeysHeaders:
    x_amz_target: GetTagKeysXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetTagKeysRequest:
    headers: GetTagKeysHeaders = field()
    query_params: GetTagKeysQueryParams = field()
    request: shared.GetTagKeysInput = field(metadata={'request': { 'media_type': 'application/json' }})
