...
class TagResourcesHeaders:
    ...
    x_amz_target: TagResourcesXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class TagResourcesRequest:
    headers: TagResourcesHeaders = field(default=None)
    request: shared.TagResourcesInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
