...
class DescribeReportCreationHeaders:
    x_amz_target: DescribeReportCreationXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeReportCreationRequest:
    headers: DescribeReportCreationHeaders = field()
