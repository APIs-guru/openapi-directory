...
class GetComplianceSummaryHeaders:
    ...
    x_amz_target: GetComplianceSummaryXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetComplianceSummaryRequest:
    query_params: GetComplianceSummaryQueryParams = field(default=None)
    headers: GetComplianceSummaryHeaders = field(default=None)
    request: shared.GetComplianceSummaryInput = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class GetComplianceSummaryResponse:
    ...
    get_compliance_summary_output: Optional[shared.GetComplianceSummaryOutput] = field(default=None)
