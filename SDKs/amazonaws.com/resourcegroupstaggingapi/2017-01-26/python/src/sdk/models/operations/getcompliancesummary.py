...
class GetComplianceSummaryHeaders:
    x_amz_target: GetComplianceSummaryXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class GetComplianceSummaryRequest:
    headers: GetComplianceSummaryHeaders = field()
    query_params: GetComplianceSummaryQueryParams = field()
    request: shared.GetComplianceSummaryInput = field(metadata={'request': { 'media_type': 'application/json' }})
