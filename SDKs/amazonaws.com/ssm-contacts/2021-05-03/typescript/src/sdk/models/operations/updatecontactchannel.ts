...
export enum UpdateContactChannelXAmzTargetEnum {
    SsmContactsUpdateContactChannel = "SSMContacts.UpdateContactChannel"
}


export class UpdateContactChannelHeaders extends SpeakeasyBase {
...
export class UpdateContactChannelResponse extends SpeakeasyBase {
  @Metadata()
