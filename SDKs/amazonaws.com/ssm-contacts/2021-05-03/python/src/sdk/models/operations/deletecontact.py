...
class DeleteContactHeaders:
    x_amz_target: DeleteContactXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteContactRequest:
    ...
    request: shared.DeleteContactRequest = field(metadata={'request': { 'media_type': 'application/json' }})
