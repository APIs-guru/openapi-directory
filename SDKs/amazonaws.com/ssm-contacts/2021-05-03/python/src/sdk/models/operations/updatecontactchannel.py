...
class UpdateContactChannelHeaders:
    x_amz_target: UpdateContactChannelXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateContactChannelRequest:
    headers: UpdateContactChannelHeaders = field()
    request: shared.UpdateContactChannelRequest = field(metadata={'request': { 'media_type': 'application/json' }})
