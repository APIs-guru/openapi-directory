...
class ListEngagementsHeaders:
    x_amz_target: ListEngagementsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListEngagementsRequest:
    headers: ListEngagementsHeaders = field()
    query_params: ListEngagementsQueryParams = field()
    request: shared.ListEngagementsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
