...
class ListContactChannelsHeaders:
    x_amz_target: ListContactChannelsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListContactChannelsRequest:
    headers: ListContactChannelsHeaders = field()
    query_params: ListContactChannelsQueryParams = field()
    request: shared.ListContactChannelsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
