...
class ListContactsHeaders:
    x_amz_target: ListContactsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListContactsRequest:
    ...
    request: shared.ListContactsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
