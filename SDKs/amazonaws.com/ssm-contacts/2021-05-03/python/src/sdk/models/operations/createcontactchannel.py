...
class CreateContactChannelHeaders:
    x_amz_target: CreateContactChannelXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateContactChannelRequest:
    headers: CreateContactChannelHeaders = field()
    request: shared.CreateContactChannelRequest = field(metadata={'request': { 'media_type': 'application/json' }})
