...
class DeleteContactChannelHeaders:
    x_amz_target: DeleteContactChannelXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteContactChannelRequest:
    headers: DeleteContactChannelHeaders = field()
    request: shared.DeleteContactChannelRequest = field(metadata={'request': { 'media_type': 'application/json' }})
