...
class ListPageReceiptsHeaders:
    x_amz_target: ListPageReceiptsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListPageReceiptsRequest:
    headers: ListPageReceiptsHeaders = field()
    query_params: ListPageReceiptsQueryParams = field()
    request: shared.ListPageReceiptsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
