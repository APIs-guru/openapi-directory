...
class SDK:
    ...
    def add_facet_to_object(self, request: operations.AddFacetToObjectRequest) -> operations.AddFacetToObjectResponse:
        ...
        res = operations.AddFacetToObjectResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.InternalServiceException])
                res.internal_service_exception = out
        elif r.status_code == 481:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.InvalidArnException])
                res.invalid_arn_exception = out
        elif r.status_code == 482:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.RetryableConflictException])
                res.retryable_conflict_exception = out
        elif r.status_code == 483:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ValidationException])
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AccessDeniedException])
                res.access_denied_exception = out
        elif r.status_code == 486:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DirectoryNotEnabledException])
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.FacetValidationException])
    ...
    def apply_schema(self, request: operations.ApplySchemaRequest) -> operations.ApplySchemaResponse:
        ...
        res = operations.ApplySchemaResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ApplySchemaResponse])
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.InvalidAttachmentException])
    ...
    def attach_object(self, request: operations.AttachObjectRequest) -> operations.AttachObjectResponse:
        ...
        res = operations.AttachObjectResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AttachObjectResponse])
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.LinkNameAlreadyInUseException])
    ...
    def attach_policy(self, request: operations.AttachPolicyRequest) -> operations.AttachPolicyResponse:
        ...
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.NotPolicyException])
    ...
    def attach_to_index(self, request: operations.AttachToIndexRequest) -> operations.AttachToIndexResponse:
        ...
        res = operations.AttachToIndexResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AttachToIndexResponse])
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.IndexedAttributeMissingException])
                res.indexed_attribute_missing_exception = out
        elif r.status_code == 491:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.NotIndexException])
    ...
    def attach_typed_link(self, request: operations.AttachTypedLinkRequest) -> operations.AttachTypedLinkResponse:
        ...
        res = operations.AttachTypedLinkResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.AttachTypedLinkResponse])
    ...
    def batch_read(self, request: operations.BatchReadRequest) -> operations.BatchReadResponse:
        ...
        res = operations.BatchReadResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.BatchReadResponse])
    ...
    def batch_write(self, request: operations.BatchWriteRequest) -> operations.BatchWriteResponse:
        ...
        res = operations.BatchWriteResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.BatchWriteException])
    ...
    def create_directory(self, request: operations.CreateDirectoryRequest) -> operations.CreateDirectoryResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateDirectoryResponse])
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DirectoryAlreadyExistsException])
    ...
    def create_facet(self, request: operations.CreateFacetRequest) -> operations.CreateFacetResponse:
        ...
        res = operations.CreateFacetResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.FacetAlreadyExistsException])
                res.facet_already_exists_exception = out
        elif r.status_code == 488:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.InvalidRuleException])
    ...
    def create_index(self, request: operations.CreateIndexRequest) -> operations.CreateIndexResponse:
        ...
        res = operations.CreateIndexResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateIndexResponse])
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.UnsupportedIndexTypeException])
    ...
    def create_object(self, request: operations.CreateObjectRequest) -> operations.CreateObjectResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateObjectResponse])
    ...
    def create_schema(self, request: operations.CreateSchemaRequest) -> operations.CreateSchemaResponse:
        ...
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SchemaAlreadyExistsException])
    ...
    def create_typed_link_facet(self, request: operations.CreateTypedLinkFacetRequest) -> operations.CreateTypedLinkFacetResponse:
        ...
        res = operations.CreateTypedLinkFacetResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
    ...
    def delete_directory(self, request: operations.DeleteDirectoryRequest) -> operations.DeleteDirectoryResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DeleteDirectoryResponse])
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DirectoryNotDisabledException])
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DirectoryDeletedException])
    ...
    def delete_facet(self, request: operations.DeleteFacetRequest) -> operations.DeleteFacetResponse:
        ...
        res = operations.DeleteFacetResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.FacetNotFoundException])
                res.facet_not_found_exception = out
        elif r.status_code == 488:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.FacetInUseException])
    ...
    def delete_object(self, request: operations.DeleteObjectRequest) -> operations.DeleteObjectResponse:
        ...
        res = operations.DeleteObjectResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ObjectNotDetachedException])
    ...
    def delete_schema(self, request: operations.DeleteSchemaRequest) -> operations.DeleteSchemaResponse:
        ...
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.StillContainsLinksException])
    ...
    def delete_typed_link_facet(self, request: operations.DeleteTypedLinkFacetRequest) -> operations.DeleteTypedLinkFacetResponse:
        ...
        res = operations.DeleteTypedLinkFacetResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
    ...
    def detach_from_index(self, request: operations.DetachFromIndexRequest) -> operations.DetachFromIndexResponse:
        ...
        res = operations.DetachFromIndexResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DetachFromIndexResponse])
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ObjectAlreadyDetachedException])
    ...
    def detach_object(self, request: operations.DetachObjectRequest) -> operations.DetachObjectResponse:
        ...
        res = operations.DetachObjectResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DetachObjectResponse])
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.NotNodeException])
    ...
    def detach_typed_link(self, request: operations.DetachTypedLinkRequest) -> operations.DetachTypedLinkResponse:
        ...
        res = operations.DetachTypedLinkResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            pass
        elif r.status_code == 480:
            if utils.match_content_type(content_type, "application/json"):
    ...
    def disable_directory(self, request: operations.DisableDirectoryRequest) -> operations.DisableDirectoryResponse:
        ...
        res = operations.DisableDirectoryResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DisableDirectoryResponse])
    ...
    def enable_directory(self, request: operations.EnableDirectoryRequest) -> operations.EnableDirectoryResponse:
        ...
        res = operations.EnableDirectoryResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.EnableDirectoryResponse])
    ...
    def get_applied_schema_version(self, request: operations.GetAppliedSchemaVersionRequest) -> operations.GetAppliedSchemaVersionResponse:
        ...
        res = operations.GetAppliedSchemaVersionResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetAppliedSchemaVersionResponse])
    ...
    def get_directory(self, request: operations.GetDirectoryRequest) -> operations.GetDirectoryResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetDirectoryResponse])
    ...
    def get_facet(self, request: operations.GetFacetRequest) -> operations.GetFacetResponse:
        ...
        res = operations.GetFacetResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetFacetResponse])
    ...
    def get_link_attributes(self, request: operations.GetLinkAttributesRequest) -> operations.GetLinkAttributesResponse:
        ...
        res = operations.GetLinkAttributesResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetLinkAttributesResponse])
    ...
    def get_object_attributes(self, request: operations.GetObjectAttributesRequest) -> operations.GetObjectAttributesResponse:
        ...
        res = operations.GetObjectAttributesResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetObjectAttributesResponse])
    ...
    def get_object_information(self, request: operations.GetObjectInformationRequest) -> operations.GetObjectInformationResponse:
        ...
        res = operations.GetObjectInformationResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetObjectInformationResponse])
    ...
    def get_schema_as_json(self, request: operations.GetSchemaAsJSONRequest) -> operations.GetSchemaAsJSONResponse:
        ...
        res = operations.GetSchemaAsJSONResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetSchemaAsJSONResponse])
    ...
    def get_typed_link_facet_information(self, request: operations.GetTypedLinkFacetInformationRequest) -> operations.GetTypedLinkFacetInformationResponse:
        ...
        res = operations.GetTypedLinkFacetInformationResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.GetTypedLinkFacetInformationResponse])
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.InvalidNextTokenException])
    ...
    def list_applied_schema_arns(self, request: operations.ListAppliedSchemaArnsRequest) -> operations.ListAppliedSchemaArnsResponse:
        ...
        res = operations.ListAppliedSchemaArnsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListAppliedSchemaArnsResponse])
    ...
    def list_attached_indices(self, request: operations.ListAttachedIndicesRequest) -> operations.ListAttachedIndicesResponse:
        ...
        res = operations.ListAttachedIndicesResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListAttachedIndicesResponse])
    ...
    def list_development_schema_arns(self, request: operations.ListDevelopmentSchemaArnsRequest) -> operations.ListDevelopmentSchemaArnsResponse:
        ...
        res = operations.ListDevelopmentSchemaArnsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListDevelopmentSchemaArnsResponse])
    ...
    def list_directories(self, request: operations.ListDirectoriesRequest) -> operations.ListDirectoriesResponse:
        ...
        res = operations.ListDirectoriesResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListDirectoriesResponse])
    ...
    def list_facet_attributes(self, request: operations.ListFacetAttributesRequest) -> operations.ListFacetAttributesResponse:
        ...
        res = operations.ListFacetAttributesResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListFacetAttributesResponse])
    ...
    def list_facet_names(self, request: operations.ListFacetNamesRequest) -> operations.ListFacetNamesResponse:
        ...
        res = operations.ListFacetNamesResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListFacetNamesResponse])
    ...
    def list_incoming_typed_links(self, request: operations.ListIncomingTypedLinksRequest) -> operations.ListIncomingTypedLinksResponse:
        ...
        res = operations.ListIncomingTypedLinksResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListIncomingTypedLinksResponse])
    ...
    def list_index(self, request: operations.ListIndexRequest) -> operations.ListIndexResponse:
        ...
        res = operations.ListIndexResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListIndexResponse])
    ...
    def list_object_attributes(self, request: operations.ListObjectAttributesRequest) -> operations.ListObjectAttributesResponse:
        ...
        res = operations.ListObjectAttributesResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListObjectAttributesResponse])
    ...
    def list_object_children(self, request: operations.ListObjectChildrenRequest) -> operations.ListObjectChildrenResponse:
        ...
        res = operations.ListObjectChildrenResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListObjectChildrenResponse])
    ...
    def list_object_parent_paths(self, request: operations.ListObjectParentPathsRequest) -> operations.ListObjectParentPathsResponse:
        ...
        res = operations.ListObjectParentPathsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListObjectParentPathsResponse])
    ...
    def list_object_parents(self, request: operations.ListObjectParentsRequest) -> operations.ListObjectParentsResponse:
        ...
        res = operations.ListObjectParentsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListObjectParentsResponse])
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CannotListParentOfRootException])
    ...
    def list_object_policies(self, request: operations.ListObjectPoliciesRequest) -> operations.ListObjectPoliciesResponse:
        ...
        res = operations.ListObjectPoliciesResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListObjectPoliciesResponse])
    ...
    def list_outgoing_typed_links(self, request: operations.ListOutgoingTypedLinksRequest) -> operations.ListOutgoingTypedLinksResponse:
        ...
        res = operations.ListOutgoingTypedLinksResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListOutgoingTypedLinksResponse])
    ...
    def list_policy_attachments(self, request: operations.ListPolicyAttachmentsRequest) -> operations.ListPolicyAttachmentsResponse:
        ...
        res = operations.ListPolicyAttachmentsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListPolicyAttachmentsResponse])
    ...
    def list_published_schema_arns(self, request: operations.ListPublishedSchemaArnsRequest) -> operations.ListPublishedSchemaArnsResponse:
        ...
        res = operations.ListPublishedSchemaArnsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListPublishedSchemaArnsResponse])
    ...
    def list_tags_for_resource(self, request: operations.ListTagsForResourceRequest) -> operations.ListTagsForResourceResponse:
        ...
        if r.status_code == 200:
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.InvalidTaggingRequestException])
    ...
    def list_typed_link_facet_attributes(self, request: operations.ListTypedLinkFacetAttributesRequest) -> operations.ListTypedLinkFacetAttributesResponse:
        ...
        res = operations.ListTypedLinkFacetAttributesResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListTypedLinkFacetAttributesResponse])
    ...
    def list_typed_link_facet_names(self, request: operations.ListTypedLinkFacetNamesRequest) -> operations.ListTypedLinkFacetNamesResponse:
        ...
        res = operations.ListTypedLinkFacetNamesResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListTypedLinkFacetNamesResponse])
    ...
    def lookup_policy(self, request: operations.LookupPolicyRequest) -> operations.LookupPolicyResponse:
        ...
        res = operations.LookupPolicyResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.LookupPolicyResponse])
    ...
    def publish_schema(self, request: operations.PublishSchemaRequest) -> operations.PublishSchemaResponse:
        ...
        res = operations.PublishSchemaResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PublishSchemaResponse])
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.SchemaAlreadyPublishedException])
    ...
    def put_schema_from_json(self, request: operations.PutSchemaFromJSONRequest) -> operations.PutSchemaFromJSONResponse:
        ...
        res = operations.PutSchemaFromJSONResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.PutSchemaFromJSONResponse])
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.InvalidSchemaDocException])
    ...
    def remove_facet_from_object(self, request: operations.RemoveFacetFromObjectRequest) -> operations.RemoveFacetFromObjectResponse:
        ...
        res = operations.RemoveFacetFromObjectResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
    ...
    def update_facet(self, request: operations.UpdateFacetRequest) -> operations.UpdateFacetResponse:
        ...
        res = operations.UpdateFacetResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.InvalidFacetUpdateException])
    ...
    def update_link_attributes(self, request: operations.UpdateLinkAttributesRequest) -> operations.UpdateLinkAttributesResponse:
        ...
        res = operations.UpdateLinkAttributesResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
    ...
    def update_object_attributes(self, request: operations.UpdateObjectAttributesRequest) -> operations.UpdateObjectAttributesResponse:
        ...
        res = operations.UpdateObjectAttributesResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.UpdateObjectAttributesResponse])
    ...
    def update_typed_link_facet(self, request: operations.UpdateTypedLinkFacetRequest) -> operations.UpdateTypedLinkFacetResponse:
        ...
        res = operations.UpdateTypedLinkFacetResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
    ...
    def upgrade_applied_schema(self, request: operations.UpgradeAppliedSchemaRequest) -> operations.UpgradeAppliedSchemaResponse:
        ...
        res = operations.UpgradeAppliedSchemaResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.UpgradeAppliedSchemaResponse])
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.IncompatibleSchemaException])
    ...
    def upgrade_published_schema(self, request: operations.UpgradePublishedSchemaRequest) -> operations.UpgradePublishedSchemaResponse:
        ...
        res = operations.UpgradePublishedSchemaResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.UpgradePublishedSchemaResponse])
