...
class DeleteTypedLinkFacetRequest:
    headers: DeleteTypedLinkFacetHeaders = field(default=None)
    request: DeleteTypedLinkFacetRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
