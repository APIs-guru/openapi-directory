...
class ListFacetAttributesRequest:
    headers: ListFacetAttributesHeaders = field()
    query_params: ListFacetAttributesQueryParams = field()
    request: ListFacetAttributesRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
