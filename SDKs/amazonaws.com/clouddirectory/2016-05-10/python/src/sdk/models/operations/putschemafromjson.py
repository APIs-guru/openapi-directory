...
class PutSchemaFromJSONRequest:
    headers: PutSchemaFromJSONHeaders = field()
    request: PutSchemaFromJSONRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
...
class PutSchemaFromJSONResponse:
    ...
    invalid_schema_doc_exception: Optional[shared.InvalidSchemaDocException] = field(default=None)
