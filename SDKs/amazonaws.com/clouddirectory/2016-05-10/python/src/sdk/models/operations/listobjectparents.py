...
class ListObjectParentsRequestBody:
    object_reference: ListObjectParentsRequestBodyObjectReference = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('ObjectReference') }})
...
class ListObjectParentsRequest:
    headers: ListObjectParentsHeaders = field()
    query_params: ListObjectParentsQueryParams = field()
    request: ListObjectParentsRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
