...
class ListObjectParentsHeaders:
    ...
    x_amz_consistency_level: Optional[ListObjectParentsXAmzConsistencyLevelEnum] = field(default=None, metadata={'header': { 'field_name': 'x-amz-consistency-level', 'style': 'simple', 'explode': False }})
...
class ListObjectParentsRequestBody:
    ...
    object_reference: ListObjectParentsRequestBodyObjectReference = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ObjectReference' }})
    

@dataclass
class ListObjectParentsRequest:
    query_params: ListObjectParentsQueryParams = field(default=None)
    headers: ListObjectParentsHeaders = field(default=None)
    request: ListObjectParentsRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class ListObjectParentsResponse:
    access_denied_exception: Optional[shared.AccessDeniedException] = field(default=None)
    cannot_list_parent_of_root_exception: Optional[shared.CannotListParentOfRootException] = field(default=None)
    ...
    list_object_parents_response: Optional[shared.ListObjectParentsResponse] = field(default=None)
