...
class DeleteObjectRequestBody:
    object_reference: DeleteObjectRequestBodyObjectReference = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('ObjectReference') }})
    

@dataclass
class DeleteObjectRequest:
    headers: DeleteObjectHeaders = field()
    request: DeleteObjectRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
