...
class DeleteObjectRequestBody:
    object_reference: DeleteObjectRequestBodyObjectReference = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ObjectReference' }})
    

@dataclass
class DeleteObjectRequest:
    headers: DeleteObjectHeaders = field(default=None)
    request: DeleteObjectRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class DeleteObjectResponse:
    ...
    object_not_detached_exception: Optional[shared.ObjectNotDetachedException] = field(default=None)
