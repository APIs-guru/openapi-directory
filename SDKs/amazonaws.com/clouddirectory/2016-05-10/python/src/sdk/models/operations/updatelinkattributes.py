...
class UpdateLinkAttributesRequestBody:
    attribute_updates: List[shared.LinkAttributeUpdate] = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('AttributeUpdates') }})
    typed_link_specifier: UpdateLinkAttributesRequestBodyTypedLinkSpecifier = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('TypedLinkSpecifier') }})
    

@dataclass
class UpdateLinkAttributesRequest:
    headers: UpdateLinkAttributesHeaders = field()
    request: UpdateLinkAttributesRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
