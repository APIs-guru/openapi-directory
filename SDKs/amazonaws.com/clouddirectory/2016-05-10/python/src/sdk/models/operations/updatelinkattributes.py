...
class UpdateLinkAttributesRequestBody:
    attribute_updates: List[shared.LinkAttributeUpdate] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'AttributeUpdates' }})
    typed_link_specifier: UpdateLinkAttributesRequestBodyTypedLinkSpecifier = field(default=None, metadata={'dataclasses_json': { 'field_name': 'TypedLinkSpecifier' }})
    

@dataclass
class UpdateLinkAttributesRequest:
    headers: UpdateLinkAttributesHeaders = field(default=None)
    request: UpdateLinkAttributesRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateLinkAttributesResponse:
    ...
    update_link_attributes_response: Optional[dict[str, Any]] = field(default=None)
