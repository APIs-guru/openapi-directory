...
class DeleteFacetRequest:
    headers: DeleteFacetHeaders = field(default=None)
    request: DeleteFacetRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class DeleteFacetResponse:
    ...
    delete_facet_response: Optional[dict[str, Any]] = field(default=None)
    facet_in_use_exception: Optional[shared.FacetInUseException] = field(default=None)
