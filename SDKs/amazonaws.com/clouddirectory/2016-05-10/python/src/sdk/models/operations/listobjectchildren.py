...
class ListObjectChildrenHeaders:
    ...
    x_amz_consistency_level: Optional[ListObjectChildrenXAmzConsistencyLevelEnum] = field(default=None, metadata={'header': { 'field_name': 'x-amz-consistency-level' }})
...
class ListObjectChildrenRequestBody:
    ...
    object_reference: ListObjectChildrenRequestBodyObjectReference = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ObjectReference' }})
    

@dataclass
class ListObjectChildrenRequest:
    query_params: ListObjectChildrenQueryParams = field(default=None)
    headers: ListObjectChildrenHeaders = field(default=None)
    request: ListObjectChildrenRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
