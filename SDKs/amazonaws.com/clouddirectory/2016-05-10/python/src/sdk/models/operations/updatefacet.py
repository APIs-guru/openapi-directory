...
class UpdateFacetRequestBody:
    ...
    attribute_updates: Optional[List[shared.FacetAttributeUpdate]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('AttributeUpdates') }})
    object_type: Optional[UpdateFacetRequestBodyObjectTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ObjectType') }})
    

@dataclass
class UpdateFacetRequest:
    headers: UpdateFacetHeaders = field()
    request: UpdateFacetRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
