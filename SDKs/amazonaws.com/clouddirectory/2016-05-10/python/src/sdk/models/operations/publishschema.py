...
class PublishSchemaResponse:
    ...
    publish_schema_response: Optional[shared.PublishSchemaResponse] = field(default=None)
    ...
    schema_already_published_exception: Optional[shared.SchemaAlreadyPublishedException] = field(default=None)
