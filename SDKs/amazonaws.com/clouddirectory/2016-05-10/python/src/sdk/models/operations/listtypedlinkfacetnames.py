...
class ListTypedLinkFacetNamesRequest:
    query_params: ListTypedLinkFacetNamesQueryParams = field(default=None)
    headers: ListTypedLinkFacetNamesHeaders = field(default=None)
    request: ListTypedLinkFacetNamesRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class ListTypedLinkFacetNamesResponse:
    ...
    list_typed_link_facet_names_response: Optional[shared.ListTypedLinkFacetNamesResponse] = field(default=None)
