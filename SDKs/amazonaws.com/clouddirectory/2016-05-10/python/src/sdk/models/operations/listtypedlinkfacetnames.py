...
class ListTypedLinkFacetNamesRequest:
    headers: ListTypedLinkFacetNamesHeaders = field()
    query_params: ListTypedLinkFacetNamesQueryParams = field()
    request: ListTypedLinkFacetNamesRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
