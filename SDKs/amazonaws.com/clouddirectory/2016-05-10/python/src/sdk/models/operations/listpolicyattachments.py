...
class ListPolicyAttachmentsHeaders:
    ...
    x_amz_consistency_level: Optional[ListPolicyAttachmentsXAmzConsistencyLevelEnum] = field(default=None, metadata={'header': { 'field_name': 'x-amz-consistency-level', 'style': 'simple', 'explode': False }})
...
class ListPolicyAttachmentsRequestBody:
    policy_reference: ListPolicyAttachmentsRequestBodyPolicyReference = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('PolicyReference') }})
...
class ListPolicyAttachmentsRequest:
    headers: ListPolicyAttachmentsHeaders = field()
    query_params: ListPolicyAttachmentsQueryParams = field()
    request: ListPolicyAttachmentsRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
