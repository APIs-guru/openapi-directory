...
class GetSchemaAsJSONRequest:
    headers: GetSchemaAsJSONHeaders = field(default=None)
...
class GetSchemaAsJSONResponse:
    ...
    get_schema_as_json_response: Optional[shared.GetSchemaAsJSONResponse] = field(default=None)
