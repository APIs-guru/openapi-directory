...
**/
var BatchListObjectParentsResponse = /** @class */ (function (_super) {
    __extends(BatchListObjectParentsResponse, _super);
    ...
    ], BatchListObjectParentsResponse.prototype, "nextToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ParentLinks", elemType: ObjectIdentifierAndLinkNameTuple }),
        __metadata("design:type", Array)
    ], BatchListObjectParentsResponse.prototype, "parentLinks", void 0);
    return BatchListObjectParentsResponse;
}(SpeakeasyBase));
export { BatchListObjectParentsResponse };
