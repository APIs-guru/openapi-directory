...
**/
var IndexAttachment = /** @class */ (function (_super) {
    __extends(IndexAttachment, _super);
    ...
    ], IndexAttachment.prototype, "indexedAttributes", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ObjectIdentifier" }),
        __metadata("design:type", String)
    ], IndexAttachment.prototype, "objectIdentifier", void 0);
    return IndexAttachment;
}(SpeakeasyBase));
export { IndexAttachment };
