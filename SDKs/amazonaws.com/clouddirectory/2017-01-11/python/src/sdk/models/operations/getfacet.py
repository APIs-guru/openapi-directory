...
@dataclass_json
@dataclass
class GetFacetRequestBody:
    name: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Name' }})
    

@dataclass
class GetFacetRequest:
    headers: GetFacetHeaders = field(default=None)
    request: GetFacetRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class GetFacetResponse:
    ...
    get_facet_response: Optional[shared.GetFacetResponse] = field(default=None)
