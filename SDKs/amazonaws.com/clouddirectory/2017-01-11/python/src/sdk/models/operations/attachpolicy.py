...
class AttachPolicyRequestBody:
    object_reference: AttachPolicyRequestBodyObjectReference = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ObjectReference' }})
    policy_reference: AttachPolicyRequestBodyPolicyReference = field(default=None, metadata={'dataclasses_json': { 'field_name': 'PolicyReference' }})
