...
class AttachPolicyRequestBody:
    object_reference: AttachPolicyRequestBodyObjectReference = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('ObjectReference') }})
    policy_reference: AttachPolicyRequestBodyPolicyReference = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('PolicyReference') }})
...
class AttachPolicyResponse:
    ...
    attach_policy_response: Optional[dict[str, Any]] = field(default=None)
