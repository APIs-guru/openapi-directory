...
class CreateFacetRequestBody:
    ...
    facet_style: Optional[CreateFacetRequestBodyFacetStyleEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('FacetStyle') }})
    object_type: Optional[CreateFacetRequestBodyObjectTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ObjectType') }})
