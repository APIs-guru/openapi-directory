...
class ListTypedLinkFacetAttributesRequest:
    query_params: ListTypedLinkFacetAttributesQueryParams = field(default=None)
    headers: ListTypedLinkFacetAttributesHeaders = field(default=None)
    request: ListTypedLinkFacetAttributesRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
