...
class GetTypedLinkFacetInformationRequest:
    headers: GetTypedLinkFacetInformationHeaders = field(default=None)
    request: GetTypedLinkFacetInformationRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class GetTypedLinkFacetInformationResponse:
    ...
    get_typed_link_facet_information_response: Optional[shared.GetTypedLinkFacetInformationResponse] = field(default=None)
