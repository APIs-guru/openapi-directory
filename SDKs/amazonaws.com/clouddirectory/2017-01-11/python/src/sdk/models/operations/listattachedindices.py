...
class ListAttachedIndicesRequestBodyTargetReference:
    r"""ListAttachedIndicesRequestBodyTargetReference
...
class ListAttachedIndicesRequestBody:
    target_reference: ListAttachedIndicesRequestBodyTargetReference = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('TargetReference') }})
...
class ListAttachedIndicesRequest:
    headers: ListAttachedIndicesHeaders = field()
    query_params: ListAttachedIndicesQueryParams = field()
    request: ListAttachedIndicesRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
