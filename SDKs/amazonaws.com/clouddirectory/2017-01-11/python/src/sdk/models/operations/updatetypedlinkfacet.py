...
class UpdateTypedLinkFacetRequestBody:
    attribute_updates: List[shared.TypedLinkFacetAttributeUpdate] = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('AttributeUpdates') }})
    identity_attribute_order: List[str] = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('IdentityAttributeOrder') }})
    name: str = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Name') }})
    

@dataclass
class UpdateTypedLinkFacetRequest:
    headers: UpdateTypedLinkFacetHeaders = field()
    request: UpdateTypedLinkFacetRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
...
class UpdateTypedLinkFacetResponse:
    ...
    invalid_facet_update_exception: Optional[Any] = field(default=None)
