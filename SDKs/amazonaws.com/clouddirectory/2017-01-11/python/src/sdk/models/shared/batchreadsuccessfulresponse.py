...
class BatchReadSuccessfulResponse:
    ...
    list_object_parents: Optional[BatchListObjectParentsResponse] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ListObjectParents') }})
