...
from . import batchlistobjectparentsresponse
...
class BatchReadSuccessfulResponse:
    ...
    list_object_parents: Optional[batchlistobjectparentsresponse.BatchListObjectParentsResponse] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ListObjectParents' }})
