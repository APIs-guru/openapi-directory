...
class SDK:
    ...
    def list_managed_schema_arns(self, request: operations.ListManagedSchemaArnsRequest) -> operations.ListManagedSchemaArnsResponse:
        ...
        res = operations.ListManagedSchemaArnsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListManagedSchemaArnsResponse])
