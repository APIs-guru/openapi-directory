...
class GetUpdateAccessKeyQueryParams:
    ...
    action: GetUpdateAccessKeyActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    status: GetUpdateAccessKeyStatusEnum = field(metadata={'query_param': { 'field_name': 'Status', 'style': 'form', 'explode': True }})
    version: GetUpdateAccessKeyVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetUpdateAccessKeyRequest:
    headers: GetUpdateAccessKeyHeaders = field()
    query_params: GetUpdateAccessKeyQueryParams = field()
