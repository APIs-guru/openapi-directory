...
class GetListRolePoliciesQueryParams:
    action: GetListRolePoliciesActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    role_name: str = field(metadata={'query_param': { 'field_name': 'RoleName', 'style': 'form', 'explode': True }})
    version: GetListRolePoliciesVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetListRolePoliciesRequest:
    headers: GetListRolePoliciesHeaders = field()
    query_params: GetListRolePoliciesQueryParams = field()
