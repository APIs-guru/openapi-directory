...
class GetGetRolePolicyQueryParams:
    action: GetGetRolePolicyActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetGetRolePolicyVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetGetRolePolicyRequest:
    query_params: GetGetRolePolicyQueryParams = field(default=None)
    headers: GetGetRolePolicyHeaders = field(default=None)
