...
class GetDeleteServiceLinkedRoleQueryParams:
    action: GetDeleteServiceLinkedRoleActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    role_name: str = field(default=None, metadata={'query_param': { 'field_name': 'RoleName', 'style': 'form', 'explode': True }})
    version: GetDeleteServiceLinkedRoleVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteServiceLinkedRoleRequest:
    query_params: GetDeleteServiceLinkedRoleQueryParams = field(default=None)
    headers: GetDeleteServiceLinkedRoleHeaders = field(default=None)
