...
class PostRemoveClientIDFromOpenIDConnectProviderQueryParams:
    action: PostRemoveClientIDFromOpenIDConnectProviderActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostRemoveClientIDFromOpenIDConnectProviderVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostRemoveClientIDFromOpenIDConnectProviderRequest:
    headers: PostRemoveClientIDFromOpenIDConnectProviderHeaders = field()
    query_params: PostRemoveClientIDFromOpenIDConnectProviderQueryParams = field()
