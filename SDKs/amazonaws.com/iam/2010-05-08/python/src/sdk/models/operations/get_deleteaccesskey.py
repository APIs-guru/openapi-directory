...
class GetDeleteAccessKeyQueryParams:
    ...
    action: GetDeleteAccessKeyActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetDeleteAccessKeyVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteAccessKeyRequest:
    headers: GetDeleteAccessKeyHeaders = field()
    query_params: GetDeleteAccessKeyQueryParams = field()
