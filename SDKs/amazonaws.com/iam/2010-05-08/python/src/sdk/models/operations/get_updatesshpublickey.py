...
class GetUpdateSSHPublicKeyQueryParams:
    action: GetUpdateSSHPublicKeyActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ssh_public_key_id: str = field(metadata={'query_param': { 'field_name': 'SSHPublicKeyId', 'style': 'form', 'explode': True }})
    status: GetUpdateSSHPublicKeyStatusEnum = field(metadata={'query_param': { 'field_name': 'Status', 'style': 'form', 'explode': True }})
    user_name: str = field(metadata={'query_param': { 'field_name': 'UserName', 'style': 'form', 'explode': True }})
    version: GetUpdateSSHPublicKeyVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetUpdateSSHPublicKeyRequest:
    headers: GetUpdateSSHPublicKeyHeaders = field()
    query_params: GetUpdateSSHPublicKeyQueryParams = field()
