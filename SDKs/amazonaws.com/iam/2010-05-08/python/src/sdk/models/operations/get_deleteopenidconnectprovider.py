...
class GetDeleteOpenIDConnectProviderQueryParams:
    action: GetDeleteOpenIDConnectProviderActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    open_id_connect_provider_arn: str = field(metadata={'query_param': { 'field_name': 'OpenIDConnectProviderArn', 'style': 'form', 'explode': True }})
    version: GetDeleteOpenIDConnectProviderVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteOpenIDConnectProviderRequest:
    headers: GetDeleteOpenIDConnectProviderHeaders = field()
    query_params: GetDeleteOpenIDConnectProviderQueryParams = field()
