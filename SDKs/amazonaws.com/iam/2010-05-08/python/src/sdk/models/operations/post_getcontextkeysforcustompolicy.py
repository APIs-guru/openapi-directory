...
class PostGetContextKeysForCustomPolicyQueryParams:
    action: PostGetContextKeysForCustomPolicyActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostGetContextKeysForCustomPolicyVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostGetContextKeysForCustomPolicyRequest:
    headers: PostGetContextKeysForCustomPolicyHeaders = field()
    query_params: PostGetContextKeysForCustomPolicyQueryParams = field()
