...
class GetRemoveClientIDFromOpenIDConnectProviderQueryParams:
    action: GetRemoveClientIDFromOpenIDConnectProviderActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetRemoveClientIDFromOpenIDConnectProviderVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetRemoveClientIDFromOpenIDConnectProviderRequest:
    query_params: GetRemoveClientIDFromOpenIDConnectProviderQueryParams = field(default=None)
    headers: GetRemoveClientIDFromOpenIDConnectProviderHeaders = field(default=None)
