...
class GetGetServerCertificateQueryParams:
    action: GetGetServerCertificateActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetGetServerCertificateVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetGetServerCertificateRequest:
    query_params: GetGetServerCertificateQueryParams = field(default=None)
    headers: GetGetServerCertificateHeaders = field(default=None)
