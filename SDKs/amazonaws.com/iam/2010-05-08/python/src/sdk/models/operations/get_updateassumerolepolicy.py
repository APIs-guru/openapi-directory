...
class GetUpdateAssumeRolePolicyQueryParams:
    action: GetUpdateAssumeRolePolicyActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetUpdateAssumeRolePolicyVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetUpdateAssumeRolePolicyRequest:
    headers: GetUpdateAssumeRolePolicyHeaders = field()
    query_params: GetUpdateAssumeRolePolicyQueryParams = field()
