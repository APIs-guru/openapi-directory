...
class PostListSigningCertificatesQueryParams:
    action: PostListSigningCertificatesActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: PostListSigningCertificatesVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostListSigningCertificatesRequest:
    query_params: PostListSigningCertificatesQueryParams = field(default=None)
    headers: PostListSigningCertificatesHeaders = field(default=None)
