...
class GetEnableMfaDeviceQueryParams:
    action: GetEnableMfaDeviceActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetEnableMfaDeviceVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetEnableMfaDeviceRequest:
    headers: GetEnableMfaDeviceHeaders = field()
    query_params: GetEnableMfaDeviceQueryParams = field()
