...
class GetDeleteRolePermissionsBoundaryQueryParams:
    action: GetDeleteRolePermissionsBoundaryActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    role_name: str = field(metadata={'query_param': { 'field_name': 'RoleName', 'style': 'form', 'explode': True }})
    version: GetDeleteRolePermissionsBoundaryVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetDeleteRolePermissionsBoundaryRequest:
    headers: GetDeleteRolePermissionsBoundaryHeaders = field()
    query_params: GetDeleteRolePermissionsBoundaryQueryParams = field()
