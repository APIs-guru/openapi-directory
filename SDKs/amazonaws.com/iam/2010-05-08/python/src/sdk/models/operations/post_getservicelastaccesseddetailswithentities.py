...
class PostGetServiceLastAccessedDetailsWithEntitiesQueryParams:
    action: PostGetServiceLastAccessedDetailsWithEntitiesActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostGetServiceLastAccessedDetailsWithEntitiesVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostGetServiceLastAccessedDetailsWithEntitiesRequest:
    headers: PostGetServiceLastAccessedDetailsWithEntitiesHeaders = field()
    query_params: PostGetServiceLastAccessedDetailsWithEntitiesQueryParams = field()
