...
class PostGetServiceLastAccessedDetailsWithEntitiesQueryParams:
    action: PostGetServiceLastAccessedDetailsWithEntitiesActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostGetServiceLastAccessedDetailsWithEntitiesVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostGetServiceLastAccessedDetailsWithEntitiesRequest:
    query_params: PostGetServiceLastAccessedDetailsWithEntitiesQueryParams = field(default=None)
    headers: PostGetServiceLastAccessedDetailsWithEntitiesHeaders = field(default=None)
