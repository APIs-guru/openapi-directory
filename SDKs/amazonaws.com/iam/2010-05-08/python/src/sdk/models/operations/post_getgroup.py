...
class PostGetGroupQueryParams:
    action: PostGetGroupActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: PostGetGroupVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class PostGetGroupRequest:
    headers: PostGetGroupHeaders = field()
    query_params: PostGetGroupQueryParams = field()
