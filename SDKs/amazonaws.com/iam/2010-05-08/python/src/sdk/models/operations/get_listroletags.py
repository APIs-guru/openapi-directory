...
class GetListRoleTagsQueryParams:
    action: GetListRoleTagsActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetListRoleTagsVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetListRoleTagsRequest:
    query_params: GetListRoleTagsQueryParams = field(default=None)
    headers: GetListRoleTagsHeaders = field(default=None)
