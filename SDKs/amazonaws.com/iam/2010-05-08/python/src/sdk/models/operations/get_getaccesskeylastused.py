...
class GetGetAccessKeyLastUsedQueryParams:
    ...
    action: GetGetAccessKeyLastUsedActionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    version: GetGetAccessKeyLastUsedVersionEnum = field(default=None, metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetGetAccessKeyLastUsedRequest:
    query_params: GetGetAccessKeyLastUsedQueryParams = field(default=None)
    headers: GetGetAccessKeyLastUsedHeaders = field(default=None)
