...
class GetPutRolePolicyQueryParams:
    action: GetPutRolePolicyActionEnum = field(metadata={'query_param': { 'field_name': 'Action', 'style': 'form', 'explode': True }})
    ...
    version: GetPutRolePolicyVersionEnum = field(metadata={'query_param': { 'field_name': 'Version', 'style': 'form', 'explode': True }})
...
class GetPutRolePolicyRequest:
    headers: GetPutRolePolicyHeaders = field()
    query_params: GetPutRolePolicyQueryParams = field()
