...
class ResolveCaseHeaders:
    ...
    x_amz_target: ResolveCaseXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ResolveCaseRequest:
    headers: ResolveCaseHeaders = field(default=None)
    request: shared.ResolveCaseRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
