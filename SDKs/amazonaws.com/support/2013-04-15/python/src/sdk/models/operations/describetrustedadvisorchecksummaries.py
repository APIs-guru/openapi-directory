...
class DescribeTrustedAdvisorCheckSummariesHeaders:
    x_amz_target: DescribeTrustedAdvisorCheckSummariesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeTrustedAdvisorCheckSummariesRequest:
    headers: DescribeTrustedAdvisorCheckSummariesHeaders = field()
    request: shared.DescribeTrustedAdvisorCheckSummariesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
