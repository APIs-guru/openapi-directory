...
class DescribeTrustedAdvisorChecksHeaders:
    ...
    x_amz_target: DescribeTrustedAdvisorChecksXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeTrustedAdvisorChecksRequest:
    headers: DescribeTrustedAdvisorChecksHeaders = field(default=None)
    request: shared.DescribeTrustedAdvisorChecksRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
