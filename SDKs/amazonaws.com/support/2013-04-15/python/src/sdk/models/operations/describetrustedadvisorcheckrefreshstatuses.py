...
class DescribeTrustedAdvisorCheckRefreshStatusesHeaders:
    x_amz_target: DescribeTrustedAdvisorCheckRefreshStatusesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeTrustedAdvisorCheckRefreshStatusesRequest:
    headers: DescribeTrustedAdvisorCheckRefreshStatusesHeaders = field()
    request: shared.DescribeTrustedAdvisorCheckRefreshStatusesRequest = field(metadata={'request': { 'media_type': 'application/json' }})
