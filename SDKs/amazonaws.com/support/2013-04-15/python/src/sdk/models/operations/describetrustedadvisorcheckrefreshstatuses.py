...
class DescribeTrustedAdvisorCheckRefreshStatusesHeaders:
    ...
    x_amz_target: DescribeTrustedAdvisorCheckRefreshStatusesXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
