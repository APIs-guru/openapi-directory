...
class RefreshTrustedAdvisorCheckHeaders:
    ...
    x_amz_target: RefreshTrustedAdvisorCheckXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class RefreshTrustedAdvisorCheckRequest:
    headers: RefreshTrustedAdvisorCheckHeaders = field(default=None)
    request: shared.RefreshTrustedAdvisorCheckRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
