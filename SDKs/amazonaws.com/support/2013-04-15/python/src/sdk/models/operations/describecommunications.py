...
class DescribeCommunicationsHeaders:
    x_amz_target: DescribeCommunicationsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeCommunicationsRequest:
    headers: DescribeCommunicationsHeaders = field()
    query_params: DescribeCommunicationsQueryParams = field()
    request: shared.DescribeCommunicationsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
