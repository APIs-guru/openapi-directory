...
var Task = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", ConnectorOperator)
    ], Task.prototype, "connectorOperator", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=destinationField" }),
        __metadata("design:type", String)
    ], Task.prototype, "destinationField", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=sourceFields" }),
        __metadata("design:type", Array)
    ], Task.prototype, "sourceFields", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=taskProperties" }),
        __metadata("design:type", Map)
    ], Task.prototype, "taskProperties", void 0);
    __decorate([
