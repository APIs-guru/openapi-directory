...
class ListConnectorEntitiesRequestBody:
    ...
    connector_type: Optional[ListConnectorEntitiesRequestBodyConnectorTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'connectorType' }})
    entities_path: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'entitiesPath' }})
    

@dataclass
class ListConnectorEntitiesRequest:
    headers: ListConnectorEntitiesHeaders = field(default=None)
    request: ListConnectorEntitiesRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
