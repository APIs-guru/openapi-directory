...
class DeleteConnectorProfileRequest:
    headers: DeleteConnectorProfileHeaders = field(default=None)
    request: DeleteConnectorProfileRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class DeleteConnectorProfileResponse:
    ...
    delete_connector_profile_response: Optional[dict[str, Any]] = field(default=None)
