...
from . import upsolvers3outputformatconfig
...
class UpsolverDestinationProperties:
    ...
    s3_output_format_config: upsolvers3outputformatconfig.UpsolverS3OutputFormatConfig = field(default=None, metadata={'dataclasses_json': { 'field_name': 's3OutputFormatConfig' }})
