...
class UpdateDataRetentionRequestBody:
    ...
    data_retention_change_in_hours: int = field(default=None, metadata={'dataclasses_json': { 'field_name': 'DataRetentionChangeInHours' }})
    operation: UpdateDataRetentionRequestBodyOperationEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Operation' }})
...
class UpdateDataRetentionRequest:
    headers: UpdateDataRetentionHeaders = field(default=None)
    request: UpdateDataRetentionRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
