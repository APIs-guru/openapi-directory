...
class DeleteSignalingChannelRequest:
    headers: DeleteSignalingChannelHeaders = field(default=None)
    request: DeleteSignalingChannelRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class DeleteSignalingChannelResponse:
    ...
    delete_signaling_channel_output: Optional[dict[str, Any]] = field(default=None)
