...
class GetDataEndpointRequestBody:
    api_name: GetDataEndpointRequestBodyAPINameEnum = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('APIName') }})
...
class GetDataEndpointRequest:
    headers: GetDataEndpointHeaders = field()
    request: GetDataEndpointRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
