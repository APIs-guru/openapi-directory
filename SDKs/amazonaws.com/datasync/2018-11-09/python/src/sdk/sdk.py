...
class SDK:
    ...
    def cancel_task_execution(self, request: operations.CancelTaskExecutionRequest) -> operations.CancelTaskExecutionResponse:
        ...
        res = operations.CancelTaskExecutionResponse(status_code=r.status_code, content_type=content_type)
    ...
    def create_agent(self, request: operations.CreateAgentRequest) -> operations.CreateAgentResponse:
        ...
        res = operations.CreateAgentResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateAgentResponse])
    ...
    def create_location_efs(self, request: operations.CreateLocationEfsRequest) -> operations.CreateLocationEfsResponse:
        ...
        res = operations.CreateLocationEfsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateLocationEfsResponse])
    ...
    def create_location_fsx_windows(self, request: operations.CreateLocationFsxWindowsRequest) -> operations.CreateLocationFsxWindowsResponse:
        ...
        res = operations.CreateLocationFsxWindowsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateLocationFsxWindowsResponse])
    ...
    def create_location_nfs(self, request: operations.CreateLocationNfsRequest) -> operations.CreateLocationNfsResponse:
        ...
        res = operations.CreateLocationNfsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateLocationNfsResponse])
    ...
    def create_location_object_storage(self, request: operations.CreateLocationObjectStorageRequest) -> operations.CreateLocationObjectStorageResponse:
        ...
        res = operations.CreateLocationObjectStorageResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateLocationObjectStorageResponse])
    ...
    def create_location_s3(self, request: operations.CreateLocationS3Request) -> operations.CreateLocationS3Response:
        ...
        res = operations.CreateLocationS3Response(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateLocationS3Response])
    ...
    def create_location_smb(self, request: operations.CreateLocationSmbRequest) -> operations.CreateLocationSmbResponse:
        ...
        res = operations.CreateLocationSmbResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateLocationSmbResponse])
    ...
    def create_task(self, request: operations.CreateTaskRequest) -> operations.CreateTaskResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.CreateTaskResponse])
    ...
    def describe_agent(self, request: operations.DescribeAgentRequest) -> operations.DescribeAgentResponse:
        ...
        res = operations.DescribeAgentResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribeAgentResponse])
    ...
    def describe_location_efs(self, request: operations.DescribeLocationEfsRequest) -> operations.DescribeLocationEfsResponse:
        ...
        res = operations.DescribeLocationEfsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribeLocationEfsResponse])
    ...
    def describe_location_fsx_windows(self, request: operations.DescribeLocationFsxWindowsRequest) -> operations.DescribeLocationFsxWindowsResponse:
        ...
        res = operations.DescribeLocationFsxWindowsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribeLocationFsxWindowsResponse])
    ...
    def describe_location_nfs(self, request: operations.DescribeLocationNfsRequest) -> operations.DescribeLocationNfsResponse:
        ...
        res = operations.DescribeLocationNfsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribeLocationNfsResponse])
    ...
    def describe_location_object_storage(self, request: operations.DescribeLocationObjectStorageRequest) -> operations.DescribeLocationObjectStorageResponse:
        ...
        res = operations.DescribeLocationObjectStorageResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribeLocationObjectStorageResponse])
    ...
    def describe_location_s3(self, request: operations.DescribeLocationS3Request) -> operations.DescribeLocationS3Response:
        ...
        res = operations.DescribeLocationS3Response(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribeLocationS3Response])
    ...
    def describe_location_smb(self, request: operations.DescribeLocationSmbRequest) -> operations.DescribeLocationSmbResponse:
        ...
        res = operations.DescribeLocationSmbResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribeLocationSmbResponse])
    ...
    def describe_task(self, request: operations.DescribeTaskRequest) -> operations.DescribeTaskResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribeTaskResponse])
    ...
    def describe_task_execution(self, request: operations.DescribeTaskExecutionRequest) -> operations.DescribeTaskExecutionResponse:
        ...
        res = operations.DescribeTaskExecutionResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.DescribeTaskExecutionResponse])
    ...
    def list_agents(self, request: operations.ListAgentsRequest) -> operations.ListAgentsResponse:
        ...
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListAgentsResponse])
    ...
    def list_task_executions(self, request: operations.ListTaskExecutionsRequest) -> operations.ListTaskExecutionsResponse:
        ...
        res = operations.ListTaskExecutionsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ListTaskExecutionsResponse])
    ...
    def start_task_execution(self, request: operations.StartTaskExecutionRequest) -> operations.StartTaskExecutionResponse:
        ...
        res = operations.StartTaskExecutionResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.StartTaskExecutionResponse])
    ...
    def update_agent(self, request: operations.UpdateAgentRequest) -> operations.UpdateAgentResponse:
        ...
        res = operations.UpdateAgentResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
    ...
    def update_location_nfs(self, request: operations.UpdateLocationNfsRequest) -> operations.UpdateLocationNfsResponse:
        ...
        res = operations.UpdateLocationNfsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
    ...
    def update_location_object_storage(self, request: operations.UpdateLocationObjectStorageRequest) -> operations.UpdateLocationObjectStorageResponse:
        ...
        res = operations.UpdateLocationObjectStorageResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
    ...
    def update_location_smb(self, request: operations.UpdateLocationSmbRequest) -> operations.UpdateLocationSmbResponse:
        ...
        res = operations.UpdateLocationSmbResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
    ...
    def update_task_execution(self, request: operations.UpdateTaskExecutionRequest) -> operations.UpdateTaskExecutionResponse:
        ...
        res = operations.UpdateTaskExecutionResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[dict[str, Any]])
