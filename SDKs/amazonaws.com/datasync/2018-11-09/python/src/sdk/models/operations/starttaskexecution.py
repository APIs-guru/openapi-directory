...
class StartTaskExecutionHeaders:
    x_amz_target: StartTaskExecutionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartTaskExecutionRequest:
    headers: StartTaskExecutionHeaders = field()
    request: shared.StartTaskExecutionRequest = field(metadata={'request': { 'media_type': 'application/json' }})
