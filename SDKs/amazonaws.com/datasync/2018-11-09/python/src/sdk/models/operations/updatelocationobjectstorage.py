...
class UpdateLocationObjectStorageHeaders:
    x_amz_target: UpdateLocationObjectStorageXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class UpdateLocationObjectStorageRequest:
    headers: UpdateLocationObjectStorageHeaders = field()
    request: shared.UpdateLocationObjectStorageRequest = field(metadata={'request': { 'media_type': 'application/json' }})
