...
class DescribeTaskHeaders:
    x_amz_target: DescribeTaskXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeTaskRequest:
    ...
    request: shared.DescribeTaskRequest = field(metadata={'request': { 'media_type': 'application/json' }})
