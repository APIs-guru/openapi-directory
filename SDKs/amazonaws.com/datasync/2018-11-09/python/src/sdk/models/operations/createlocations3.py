...
class CreateLocationS3Headers:
    x_amz_target: CreateLocationS3XAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateLocationS3Request:
    headers: CreateLocationS3Headers = field()
    request: shared.CreateLocationS3Request = field(metadata={'request': { 'media_type': 'application/json' }})
