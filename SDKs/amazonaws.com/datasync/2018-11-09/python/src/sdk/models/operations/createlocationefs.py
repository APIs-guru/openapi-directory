...
class CreateLocationEfsHeaders:
    x_amz_target: CreateLocationEfsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateLocationEfsRequest:
    headers: CreateLocationEfsHeaders = field()
    request: shared.CreateLocationEfsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
