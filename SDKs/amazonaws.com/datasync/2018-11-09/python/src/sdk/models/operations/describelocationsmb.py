...
class DescribeLocationSmbHeaders:
    x_amz_target: DescribeLocationSmbXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeLocationSmbRequest:
    headers: DescribeLocationSmbHeaders = field()
    request: shared.DescribeLocationSmbRequest = field(metadata={'request': { 'media_type': 'application/json' }})
