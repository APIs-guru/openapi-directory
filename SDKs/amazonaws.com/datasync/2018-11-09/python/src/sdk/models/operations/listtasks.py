...
class ListTasksHeaders:
    x_amz_target: ListTasksXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListTasksRequest:
    ...
    request: shared.ListTasksRequest = field(metadata={'request': { 'media_type': 'application/json' }})
