...
class CreateLocationNfsHeaders:
    x_amz_target: CreateLocationNfsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateLocationNfsRequest:
    headers: CreateLocationNfsHeaders = field()
    request: shared.CreateLocationNfsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
