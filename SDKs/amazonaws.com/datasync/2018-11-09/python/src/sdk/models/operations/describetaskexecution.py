...
class DescribeTaskExecutionHeaders:
    ...
    x_amz_target: DescribeTaskExecutionXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeTaskExecutionRequest:
    headers: DescribeTaskExecutionHeaders = field(default=None)
    request: shared.DescribeTaskExecutionRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
