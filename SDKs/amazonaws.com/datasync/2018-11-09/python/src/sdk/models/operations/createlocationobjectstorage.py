...
class CreateLocationObjectStorageHeaders:
    ...
    x_amz_target: CreateLocationObjectStorageXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateLocationObjectStorageRequest:
    headers: CreateLocationObjectStorageHeaders = field(default=None)
    request: shared.CreateLocationObjectStorageRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
