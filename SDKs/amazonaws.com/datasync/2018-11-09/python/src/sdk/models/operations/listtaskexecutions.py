...
class ListTaskExecutionsHeaders:
    x_amz_target: ListTaskExecutionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ListTaskExecutionsRequest:
    headers: ListTaskExecutionsHeaders = field()
    query_params: ListTaskExecutionsQueryParams = field()
    request: shared.ListTaskExecutionsRequest = field(metadata={'request': { 'media_type': 'application/json' }})
