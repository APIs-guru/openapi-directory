...
class StartNextPendingJobExecutionRequest:
    headers: StartNextPendingJobExecutionHeaders = field()
    path_params: StartNextPendingJobExecutionPathParams = field()
    request: StartNextPendingJobExecutionRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
