...
class StartNextPendingJobExecutionRequest:
    path_params: StartNextPendingJobExecutionPathParams = field(default=None)
    headers: StartNextPendingJobExecutionHeaders = field(default=None)
    request: StartNextPendingJobExecutionRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class StartNextPendingJobExecutionResponse:
    ...
    start_next_pending_job_execution_response: Optional[shared.StartNextPendingJobExecutionResponse] = field(default=None)
