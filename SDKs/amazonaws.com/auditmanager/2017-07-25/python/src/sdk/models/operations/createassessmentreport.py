...
class CreateAssessmentReportRequest:
    headers: CreateAssessmentReportHeaders = field()
    path_params: CreateAssessmentReportPathParams = field()
    request: CreateAssessmentReportRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
