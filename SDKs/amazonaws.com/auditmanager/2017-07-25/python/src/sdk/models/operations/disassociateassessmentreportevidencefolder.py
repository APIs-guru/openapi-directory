...
class DisassociateAssessmentReportEvidenceFolderRequest:
    headers: DisassociateAssessmentReportEvidenceFolderHeaders = field()
    path_params: DisassociateAssessmentReportEvidenceFolderPathParams = field()
    request: DisassociateAssessmentReportEvidenceFolderRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
