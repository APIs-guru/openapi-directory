...
class CreateControlRequestBody:
    control_mapping_sources: List[shared.CreateControlMappingSource] = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('controlMappingSources') }})
...
class CreateControlRequest:
    headers: CreateControlHeaders = field()
    request: CreateControlRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
