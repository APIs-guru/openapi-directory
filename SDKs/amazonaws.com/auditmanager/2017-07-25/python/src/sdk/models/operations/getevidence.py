...
class GetEvidencePathParams:
    ...
    evidence_id: str = field(metadata={'path_param': { 'field_name': 'evidenceId', 'style': 'simple', 'explode': False }})
...
class GetEvidenceRequest:
    headers: GetEvidenceHeaders = field()
    path_params: GetEvidencePathParams = field()
