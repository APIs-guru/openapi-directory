...
class ValidateAssessmentReportIntegrityRequestBody:
    s3_relative_path: str = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('s3RelativePath') }})
    

@dataclass
class ValidateAssessmentReportIntegrityRequest:
    headers: ValidateAssessmentReportIntegrityHeaders = field()
    request: ValidateAssessmentReportIntegrityRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
