...
**/
var CreateAssessmentFrameworkControlSet = /** @class */ (function (_super) {
    __extends(CreateAssessmentFrameworkControlSet, _super);
    ...
    ], CreateAssessmentFrameworkControlSet.prototype, "controls", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=name" }),
        __metadata("design:type", String)
    ], CreateAssessmentFrameworkControlSet.prototype, "name", void 0);
    return CreateAssessmentFrameworkControlSet;
}(SpeakeasyBase));
export { CreateAssessmentFrameworkControlSet };
