...
**/
var ControlComment = /** @class */ (function (_super) {
    __extends(ControlComment, _super);
    ...
    ], ControlComment.prototype, "authorName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=commentBody" }),
        __metadata("design:type", String)
    ], ControlComment.prototype, "commentBody", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=postedDate" }),
        __metadata("design:type", Date)
    ], ControlComment.prototype, "postedDate", void 0);
    return ControlComment;
}(SpeakeasyBase));
export { ControlComment };
