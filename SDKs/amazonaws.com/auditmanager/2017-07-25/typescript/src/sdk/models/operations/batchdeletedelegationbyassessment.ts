...
export class BatchDeleteDelegationByAssessmentPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=assessmentId" })
  assessmentId: string;
}


export class BatchDeleteDelegationByAssessmentHeaders extends SpeakeasyBase {
...
export class BatchDeleteDelegationByAssessmentRequestBody extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=delegationIds" })
