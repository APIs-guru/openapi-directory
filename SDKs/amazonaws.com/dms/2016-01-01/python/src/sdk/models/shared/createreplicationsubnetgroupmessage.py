...
class CreateReplicationSubnetGroupMessage:
    r"""CreateReplicationSubnetGroupMessage
    <p/>
    """
    
    replication_subnet_group_description: str = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('ReplicationSubnetGroupDescription') }})
