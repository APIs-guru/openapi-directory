...
class ModifyReplicationTaskHeaders:
    x_amz_target: ModifyReplicationTaskXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ModifyReplicationTaskRequest:
    headers: ModifyReplicationTaskHeaders = field()
    request: shared.ModifyReplicationTaskMessage = field(metadata={'request': { 'media_type': 'application/json' }})
