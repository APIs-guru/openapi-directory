...
class StartReplicationTaskHeaders:
    x_amz_target: StartReplicationTaskXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class StartReplicationTaskRequest:
    headers: StartReplicationTaskHeaders = field()
    request: shared.StartReplicationTaskMessage = field(metadata={'request': { 'media_type': 'application/json' }})
