...
class StartReplicationTaskHeaders:
    ...
    x_amz_target: StartReplicationTaskXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class StartReplicationTaskRequest:
    headers: StartReplicationTaskHeaders = field(default=None)
    request: shared.StartReplicationTaskMessage = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class StartReplicationTaskResponse:
    ...
    start_replication_task_response: Optional[shared.StartReplicationTaskResponse] = field(default=None)
