...
class DescribeReplicationTasksMessage:
    r"""DescribeReplicationTasksMessage
    <p/>
    """
    ...
    without_settings: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('WithoutSettings') }})
