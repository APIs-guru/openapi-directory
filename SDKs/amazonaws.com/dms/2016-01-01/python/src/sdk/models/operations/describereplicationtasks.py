...
class DescribeReplicationTasksHeaders:
    x_amz_target: DescribeReplicationTasksXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeReplicationTasksRequest:
    headers: DescribeReplicationTasksHeaders = field()
    query_params: DescribeReplicationTasksQueryParams = field()
    request: shared.DescribeReplicationTasksMessage = field(metadata={'request': { 'media_type': 'application/json' }})
