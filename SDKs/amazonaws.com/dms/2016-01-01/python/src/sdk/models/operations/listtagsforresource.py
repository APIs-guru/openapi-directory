...
class ListTagsForResourceXAmzTargetEnum(str, Enum):
    AMAZON_DM_SV20160101_LIST_TAGS_FOR_RESOURCE = "AmazonDMSv20160101.ListTagsForResource"
...
class ListTagsForResourceRequest:
    ...
    request: shared.ListTagsForResourceMessage = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
