...
class DescribeSchemasHeaders:
    x_amz_target: DescribeSchemasXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeSchemasRequest:
    headers: DescribeSchemasHeaders = field()
    query_params: DescribeSchemasQueryParams = field()
    request: shared.DescribeSchemasMessage = field(metadata={'request': { 'media_type': 'application/json' }})
