...
class DescribeEventSubscriptionsHeaders:
    x_amz_target: DescribeEventSubscriptionsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeEventSubscriptionsRequest:
    headers: DescribeEventSubscriptionsHeaders = field()
    query_params: DescribeEventSubscriptionsQueryParams = field()
    request: shared.DescribeEventSubscriptionsMessage = field(metadata={'request': { 'media_type': 'application/json' }})
