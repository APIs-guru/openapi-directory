...
class RefreshSchemasHeaders:
    x_amz_target: RefreshSchemasXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class RefreshSchemasRequest:
    headers: RefreshSchemasHeaders = field()
    request: shared.RefreshSchemasMessage = field(metadata={'request': { 'media_type': 'application/json' }})
