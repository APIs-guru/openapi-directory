...
class DescribePendingMaintenanceActionsHeaders:
    ...
    x_amz_target: DescribePendingMaintenanceActionsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribePendingMaintenanceActionsRequest:
    query_params: DescribePendingMaintenanceActionsQueryParams = field(default=None)
    headers: DescribePendingMaintenanceActionsHeaders = field(default=None)
    request: shared.DescribePendingMaintenanceActionsMessage = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
