...
class ModifyReplicationInstanceHeaders:
    ...
    x_amz_target: ModifyReplicationInstanceXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class ModifyReplicationInstanceRequest:
    headers: ModifyReplicationInstanceHeaders = field(default=None)
    request: shared.ModifyReplicationInstanceMessage = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
