...
class AddTagsToResourceRequest:
    ...
    request: shared.AddTagsToResourceMessage = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class AddTagsToResourceResponse:
    add_tags_to_resource_response: Optional[dict[str, Any]] = field(default=None)
