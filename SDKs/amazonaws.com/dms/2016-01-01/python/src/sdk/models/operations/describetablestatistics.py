...
class DescribeTableStatisticsHeaders:
    x_amz_target: DescribeTableStatisticsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeTableStatisticsRequest:
    headers: DescribeTableStatisticsHeaders = field()
    query_params: DescribeTableStatisticsQueryParams = field()
    request: shared.DescribeTableStatisticsMessage = field(metadata={'request': { 'media_type': 'application/json' }})
