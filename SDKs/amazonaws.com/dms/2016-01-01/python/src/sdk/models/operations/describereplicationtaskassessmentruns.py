...
class DescribeReplicationTaskAssessmentRunsHeaders:
    ...
    x_amz_target: DescribeReplicationTaskAssessmentRunsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class DescribeReplicationTaskAssessmentRunsRequest:
    query_params: DescribeReplicationTaskAssessmentRunsQueryParams = field(default=None)
    headers: DescribeReplicationTaskAssessmentRunsHeaders = field(default=None)
    request: shared.DescribeReplicationTaskAssessmentRunsMessage = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class DescribeReplicationTaskAssessmentRunsResponse:
    content_type: str = field(default=None)
    describe_replication_task_assessment_runs_response: Optional[shared.DescribeReplicationTaskAssessmentRunsResponse] = field(default=None)
