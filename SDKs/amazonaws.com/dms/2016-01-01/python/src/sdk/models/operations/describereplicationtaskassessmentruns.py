...
class DescribeReplicationTaskAssessmentRunsHeaders:
    x_amz_target: DescribeReplicationTaskAssessmentRunsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeReplicationTaskAssessmentRunsRequest:
    headers: DescribeReplicationTaskAssessmentRunsHeaders = field()
    query_params: DescribeReplicationTaskAssessmentRunsQueryParams = field()
    request: shared.DescribeReplicationTaskAssessmentRunsMessage = field(metadata={'request': { 'media_type': 'application/json' }})
