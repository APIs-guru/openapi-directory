...
class DescribeReplicationTaskIndividualAssessmentsHeaders:
    ...
    x_amz_target: DescribeReplicationTaskIndividualAssessmentsXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
