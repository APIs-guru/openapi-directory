...
class DescribeReplicationTaskIndividualAssessmentsHeaders:
    x_amz_target: DescribeReplicationTaskIndividualAssessmentsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeReplicationTaskIndividualAssessmentsRequest:
    headers: DescribeReplicationTaskIndividualAssessmentsHeaders = field()
    query_params: DescribeReplicationTaskIndividualAssessmentsQueryParams = field()
    request: shared.DescribeReplicationTaskIndividualAssessmentsMessage = field(metadata={'request': { 'media_type': 'application/json' }})
