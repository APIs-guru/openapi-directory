...
class DescribeRefreshSchemasStatusHeaders:
    x_amz_target: DescribeRefreshSchemasStatusXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeRefreshSchemasStatusRequest:
    headers: DescribeRefreshSchemasStatusHeaders = field()
    request: shared.DescribeRefreshSchemasStatusMessage = field(metadata={'request': { 'media_type': 'application/json' }})
