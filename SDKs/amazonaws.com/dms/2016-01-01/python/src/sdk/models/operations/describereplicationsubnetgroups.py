...
class DescribeReplicationSubnetGroupsHeaders:
    x_amz_target: DescribeReplicationSubnetGroupsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeReplicationSubnetGroupsRequest:
    headers: DescribeReplicationSubnetGroupsHeaders = field()
    query_params: DescribeReplicationSubnetGroupsQueryParams = field()
    request: shared.DescribeReplicationSubnetGroupsMessage = field(metadata={'request': { 'media_type': 'application/json' }})
