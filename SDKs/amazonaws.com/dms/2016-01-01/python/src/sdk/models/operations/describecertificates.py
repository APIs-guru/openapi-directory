...
class DescribeCertificatesHeaders:
    x_amz_target: DescribeCertificatesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeCertificatesRequest:
    headers: DescribeCertificatesHeaders = field()
    query_params: DescribeCertificatesQueryParams = field()
    request: shared.DescribeCertificatesMessage = field(metadata={'request': { 'media_type': 'application/json' }})
