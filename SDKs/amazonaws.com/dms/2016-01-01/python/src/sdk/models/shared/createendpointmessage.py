...
class CreateEndpointMessage:
    ...
    endpoint_identifier: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'EndpointIdentifier' }})
    endpoint_type: replicationendpointtypevalue_enum.ReplicationEndpointTypeValueEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'EndpointType' }})
