...
class CreateReplicationSubnetGroupHeaders:
    x_amz_target: CreateReplicationSubnetGroupXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class CreateReplicationSubnetGroupRequest:
    headers: CreateReplicationSubnetGroupHeaders = field()
    request: shared.CreateReplicationSubnetGroupMessage = field(metadata={'request': { 'media_type': 'application/json' }})
