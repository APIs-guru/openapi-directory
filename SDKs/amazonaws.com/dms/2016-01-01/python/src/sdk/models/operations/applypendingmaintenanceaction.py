...
class ApplyPendingMaintenanceActionHeaders:
    x_amz_target: ApplyPendingMaintenanceActionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ApplyPendingMaintenanceActionRequest:
    headers: ApplyPendingMaintenanceActionHeaders = field()
    request: shared.ApplyPendingMaintenanceActionMessage = field(metadata={'request': { 'media_type': 'application/json' }})
