...
class CreateReplicationTaskHeaders:
    ...
    x_amz_target: CreateReplicationTaskXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class CreateReplicationTaskRequest:
    headers: CreateReplicationTaskHeaders = field(default=None)
    request: shared.CreateReplicationTaskMessage = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
