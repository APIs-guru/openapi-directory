...
class ModifyEventSubscriptionHeaders:
    x_amz_target: ModifyEventSubscriptionXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class ModifyEventSubscriptionRequest:
    headers: ModifyEventSubscriptionHeaders = field()
    request: shared.ModifyEventSubscriptionMessage = field(metadata={'request': { 'media_type': 'application/json' }})
