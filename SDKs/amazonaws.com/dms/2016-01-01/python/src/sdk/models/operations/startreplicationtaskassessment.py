...
class StartReplicationTaskAssessmentHeaders:
    ...
    x_amz_target: StartReplicationTaskAssessmentXAmzTargetEnum = field(default=None, metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
    

@dataclass
class StartReplicationTaskAssessmentRequest:
    headers: StartReplicationTaskAssessmentHeaders = field(default=None)
    request: shared.StartReplicationTaskAssessmentMessage = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
