...
class DeleteEndpointHeaders:
    x_amz_target: DeleteEndpointXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteEndpointRequest:
    headers: DeleteEndpointHeaders = field()
    request: shared.DeleteEndpointMessage = field(metadata={'request': { 'media_type': 'application/json' }})
