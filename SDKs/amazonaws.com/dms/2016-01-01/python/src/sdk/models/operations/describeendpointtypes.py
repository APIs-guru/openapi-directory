...
class DescribeEndpointTypesHeaders:
    x_amz_target: DescribeEndpointTypesXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeEndpointTypesRequest:
    headers: DescribeEndpointTypesHeaders = field()
    query_params: DescribeEndpointTypesQueryParams = field()
    request: shared.DescribeEndpointTypesMessage = field(metadata={'request': { 'media_type': 'application/json' }})
