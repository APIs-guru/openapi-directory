...
class DeleteReplicationTaskAssessmentRunHeaders:
    x_amz_target: DeleteReplicationTaskAssessmentRunXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DeleteReplicationTaskAssessmentRunRequest:
    headers: DeleteReplicationTaskAssessmentRunHeaders = field()
    request: shared.DeleteReplicationTaskAssessmentRunMessage = field(metadata={'request': { 'media_type': 'application/json' }})
