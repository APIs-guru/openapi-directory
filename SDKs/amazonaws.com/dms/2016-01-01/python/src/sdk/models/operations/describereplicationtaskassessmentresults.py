...
class DescribeReplicationTaskAssessmentResultsHeaders:
    x_amz_target: DescribeReplicationTaskAssessmentResultsXAmzTargetEnum = field(metadata={'header': { 'field_name': 'X-Amz-Target', 'style': 'simple', 'explode': False }})
...
class DescribeReplicationTaskAssessmentResultsRequest:
    headers: DescribeReplicationTaskAssessmentResultsHeaders = field()
    query_params: DescribeReplicationTaskAssessmentResultsQueryParams = field()
    request: shared.DescribeReplicationTaskAssessmentResultsMessage = field(metadata={'request': { 'media_type': 'application/json' }})
