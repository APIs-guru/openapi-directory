...
class ImportCertificateRequest:
    ...
    request: shared.ImportCertificateMessage = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class ImportCertificateResponse:
    ...
    invalid_certificate_fault: Optional[Any] = field(default=None)
