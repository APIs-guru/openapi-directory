...
class PostCompileRequest:
    query_params: PostCompileQueryParams = field(default=None)
...
class PostCompile200ApplicationJSONExplanationLocals:
    key: Optional[PostCompile200ApplicationJSONExplanationLocalsKey] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'key' }})
    value: Optional[PostCompile200ApplicationJSONExplanationLocalsValue] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'value' }})
...
class PostCompile200ApplicationJSONExplanationNode:
    ...
    terms: Optional[List[PostCompile200ApplicationJSONExplanationNodeTerms]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'terms' }})
...
class PostCompile200ApplicationJSONExplanation:
    locals: Optional[List[PostCompile200ApplicationJSONExplanationLocals]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'locals' }})
    node: Optional[PostCompile200ApplicationJSONExplanationNode] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'node' }})
    op: Optional[PostCompile200ApplicationJSONExplanationOpEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'op' }})
    ...
    type: Optional[PostCompile200ApplicationJSONExplanationTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'type' }})
...
class PostCompile200ApplicationJSON:
    explanation: Optional[List[PostCompile200ApplicationJSONExplanation]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'explanation' }})
    metrics: Optional[PostCompile200ApplicationJSONMetrics] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'metrics' }})
