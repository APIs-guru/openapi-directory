...
class GetDocumentWithWebHookRequest:
    path_params: GetDocumentWithWebHookPathParams = field(default=None)
    query_params: GetDocumentWithWebHookQueryParams = field(default=None)
...
class GetDocumentWithWebHook200ApplicationJSONExplanationLocals:
    key: Optional[GetDocumentWithWebHook200ApplicationJSONExplanationLocalsKey] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'key' }})
    value: Optional[GetDocumentWithWebHook200ApplicationJSONExplanationLocalsValue] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'value' }})
...
class GetDocumentWithWebHook200ApplicationJSONExplanationNode:
    ...
    terms: Optional[List[GetDocumentWithWebHook200ApplicationJSONExplanationNodeTerms]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'terms' }})
...
class GetDocumentWithWebHook200ApplicationJSONExplanation:
    locals: Optional[List[GetDocumentWithWebHook200ApplicationJSONExplanationLocals]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'locals' }})
    node: Optional[GetDocumentWithWebHook200ApplicationJSONExplanationNode] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'node' }})
    op: Optional[GetDocumentWithWebHook200ApplicationJSONExplanationOpEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'op' }})
    ...
    type: Optional[GetDocumentWithWebHook200ApplicationJSONExplanationTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'type' }})
...
class GetDocumentWithWebHook200ApplicationJSON:
    explanation: Optional[List[GetDocumentWithWebHook200ApplicationJSONExplanation]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'explanation' }})
    metrics: Optional[GetDocumentWithWebHook200ApplicationJSONMetrics] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'metrics' }})
    provenance: Optional[GetDocumentWithWebHook200ApplicationJSONProvenance] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'provenance' }})
