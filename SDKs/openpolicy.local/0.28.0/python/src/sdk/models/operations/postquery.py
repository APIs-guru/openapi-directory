...
class PostQuery200ApplicationJSONExplanationLocals:
    key: Optional[PostQuery200ApplicationJSONExplanationLocalsKey] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'key' }})
    value: Optional[PostQuery200ApplicationJSONExplanationLocalsValue] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'value' }})
...
class PostQuery200ApplicationJSONExplanationNode:
    ...
    terms: Optional[List[PostQuery200ApplicationJSONExplanationNodeTerms]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'terms' }})
...
class PostQuery200ApplicationJSONExplanation:
    locals: Optional[List[PostQuery200ApplicationJSONExplanationLocals]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'locals' }})
    node: Optional[PostQuery200ApplicationJSONExplanationNode] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'node' }})
    op: Optional[PostQuery200ApplicationJSONExplanationOpEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'op' }})
    ...
    type: Optional[PostQuery200ApplicationJSONExplanationTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'type' }})
...
class PostQuery200ApplicationJSON:
    explanation: Optional[List[PostQuery200ApplicationJSONExplanation]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'explanation' }})
    metrics: Optional[PostQuery200ApplicationJSONMetrics] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'metrics' }})
