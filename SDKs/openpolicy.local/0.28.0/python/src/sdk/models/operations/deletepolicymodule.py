...
class DeletePolicyModuleRequest:
    path_params: DeletePolicyModulePathParams = field(default=None)
    query_params: DeletePolicyModuleQueryParams = field(default=None)
...
class DeletePolicyModule200ApplicationJSONExplanationLocals:
    key: Optional[DeletePolicyModule200ApplicationJSONExplanationLocalsKey] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'key' }})
    value: Optional[DeletePolicyModule200ApplicationJSONExplanationLocalsValue] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'value' }})
...
class DeletePolicyModule200ApplicationJSONExplanationNode:
    ...
    terms: Optional[List[DeletePolicyModule200ApplicationJSONExplanationNodeTerms]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'terms' }})
...
class DeletePolicyModule200ApplicationJSONExplanation:
    locals: Optional[List[DeletePolicyModule200ApplicationJSONExplanationLocals]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'locals' }})
    node: Optional[DeletePolicyModule200ApplicationJSONExplanationNode] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'node' }})
    op: Optional[DeletePolicyModule200ApplicationJSONExplanationOpEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'op' }})
    ...
    type: Optional[DeletePolicyModule200ApplicationJSONExplanationTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'type' }})
...
class DeletePolicyModule200ApplicationJSON:
    explanation: Optional[List[DeletePolicyModule200ApplicationJSONExplanation]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'explanation' }})
    metrics: Optional[DeletePolicyModule200ApplicationJSONMetrics] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'metrics' }})
    provenance: Optional[DeletePolicyModule200ApplicationJSONProvenance] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'provenance' }})
