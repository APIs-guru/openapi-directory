...
class GetDocumentWithPath200ApplicationJSONExplanationLocals:
    key: Optional[GetDocumentWithPath200ApplicationJSONExplanationLocalsKey] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('key') }})
    value: Optional[GetDocumentWithPath200ApplicationJSONExplanationLocalsValue] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('value') }})
...
class GetDocumentWithPath200ApplicationJSONExplanationNode:
    ...
    terms: Optional[List[GetDocumentWithPath200ApplicationJSONExplanationNodeTerms]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('terms') }})
...
class GetDocumentWithPath200ApplicationJSONExplanation:
    locals: Optional[List[GetDocumentWithPath200ApplicationJSONExplanationLocals]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('locals') }})
    node: Optional[GetDocumentWithPath200ApplicationJSONExplanationNode] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('node') }})
    op: Optional[GetDocumentWithPath200ApplicationJSONExplanationOpEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('op') }})
    ...
    type: Optional[GetDocumentWithPath200ApplicationJSONExplanationTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
...
class GetDocumentWithPath200ApplicationJSON:
    explanation: Optional[List[GetDocumentWithPath200ApplicationJSONExplanation]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('explanation') }})
    metrics: Optional[GetDocumentWithPath200ApplicationJSONMetrics] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('metrics') }})
    provenance: Optional[GetDocumentWithPath200ApplicationJSONProvenance] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('provenance') }})
...
class GetDocumentWithPathRequest:
    path_params: GetDocumentWithPathPathParams = field()
    query_params: GetDocumentWithPathQueryParams = field()
