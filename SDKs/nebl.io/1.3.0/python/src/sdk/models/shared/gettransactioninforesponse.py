...
class GetTransactionInfoResponseVinPreviousOutput:
    ...
    asm: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('asm') }})
    hex: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('hex') }})
    req_sigs: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('reqSigs') }})
...
class GetTransactionInfoResponseVin:
    previous_output: Optional[GetTransactionInfoResponseVinPreviousOutput] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('previousOutput') }})
    script_sig: Optional[GetTransactionInfoResponseVinScriptSig] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('scriptSig') }})
    sequence: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sequence') }})
    tokens: Optional[List[GetTransactionInfoResponseVinTokens]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tokens') }})
...
class GetTransactionInfoResponseVout:
    ...
    script_pub_key: Optional[GetTransactionInfoResponseVoutScriptPubKey] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('scriptPubKey') }})
    tokens: Optional[List[GetTransactionInfoResponseVoutTokens]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tokens') }})
    used: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('used') }})
    used_blockheight: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('usedBlockheight') }})
    used_txid: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('usedTxid') }})
    value: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('value') }})
...
class GetTransactionInfoResponse:
    blockhash: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('blockhash') }})
    blockheight: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('blockheight') }})
    ...
    fee: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('fee') }})
    hex: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('hex') }})
    locktime: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('locktime') }})
    time: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('time') }})
    totalsent: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('totalsent') }})
    txid: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('txid') }})
    version: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('version') }})
    vin: Optional[List[GetTransactionInfoResponseVin]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('vin') }})
    vout: Optional[List[GetTransactionInfoResponseVout]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('vout') }})
