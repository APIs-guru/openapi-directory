...
export class Users {
  ...
  **/
  getUserById(
    ...
    config?: AxiosRequestConfig
  ): Promise<operations.GetUserByIdResponseOutput> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetUserByIdResponseOutput = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
  ...
  **/
  getUsers(
    ...
    config?: AxiosRequestConfig
  ): Promise<operations.GetUsersResponseOutput> {
    if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetUsersResponseOutput = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
