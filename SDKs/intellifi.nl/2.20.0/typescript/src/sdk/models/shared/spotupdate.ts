...
export class SpotUpdateAntennaReportLocations extends SpeakeasyBase {
...
export class SpotUpdate extends SpeakeasyBase {
  @Metadata({ data: "json, name=antenna_report_locations", elemType: shared.SpotUpdateAntennaReportLocations })
  antennaReportLocations?: SpotUpdateAntennaReportLocations[];
