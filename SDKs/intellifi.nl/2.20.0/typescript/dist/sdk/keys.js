...
var Keys = /** @class */ (function () {
    ...
    **/
    Keys.prototype.addKey = function (req, config) {
        var _a;
     ...
     * Can only be used by an **administrative** user.
    **/
    Keys.prototype.deleteKey = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Can only be used by an **administrative** user.
    **/
    Keys.prototype.getKeyById = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Can only be used by an **administrative** user.
    **/
    Keys.prototype.getKeys = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Can only be used by an **administrative** user.
    **/
    Keys.prototype.updateKey = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
