...
class GetItemListsQueryParams:
    ...
    metadata: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'metadata', 'style': 'form', 'explode': True }})
    ...
    sha1: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'sha1', 'style': 'form', 'explode': True }})
...
class GetItemLists200ApplicationJSON:
    ...
    results: Optional[List[shared.ItemList]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
    url: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('url') }})
    

@dataclass
class GetItemListsRequest:
    query_params: GetItemListsQueryParams = field()
...
class GetItemListsResponse:
    ...
    get_item_lists_200_application_json_object: Optional[GetItemLists200ApplicationJSON] = field(default=None)
