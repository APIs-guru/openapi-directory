...
class GetItemListsRequest:
    query_params: GetItemListsQueryParams = field(default=None)
...
class GetItemLists200ApplicationJSON:
    ...
    results: Optional[List[shared.ItemList]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'results' }})
