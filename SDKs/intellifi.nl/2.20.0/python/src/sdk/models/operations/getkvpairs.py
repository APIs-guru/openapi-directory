...
class GetKvPairsQueryParams:
    ...
    kv_key: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'kv_key', 'style': 'form', 'explode': True }})
...
class GetKvPairs200ApplicationJSON:
    ...
    results: Optional[List[shared.KeyValuePair]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
    url: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('url') }})
    

@dataclass
class GetKvPairsRequest:
    query_params: GetKvPairsQueryParams = field()
...
class GetKvPairsResponse:
    ...
    get_kv_pairs_200_application_json_object: Optional[GetKvPairs200ApplicationJSON] = field(default=None)
