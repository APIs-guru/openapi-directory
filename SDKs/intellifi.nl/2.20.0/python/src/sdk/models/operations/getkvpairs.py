...
class GetKvPairsRequest:
    query_params: GetKvPairsQueryParams = field(default=None)
...
class GetKvPairs200ApplicationJSON:
    ...
    results: Optional[List[shared.KeyValuePair]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'results' }})
