...
class GetSpotListsRequest:
    query_params: GetSpotListsQueryParams = field(default=None)
...
class GetSpotLists200ApplicationJSON:
    ...
    results: Optional[List[shared.SpotList]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'results' }})
