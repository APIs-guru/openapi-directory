...
class GetAuthinfo200ApplicationJSONPermissions:
    mutate: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'mutate' }})
    

@dataclass_json
@dataclass
class GetAuthinfo200ApplicationJSON:
    api_key_id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'api_key_id' }})
    auth_method: Optional[GetAuthinfo200ApplicationJSONAuthMethodEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'auth_method' }})
    authenticated: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'authenticated' }})
    permissions: Optional[GetAuthinfo200ApplicationJSONPermissions] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'permissions' }})
