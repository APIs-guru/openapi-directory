...
class GetItemsQueryParams:
    ...
    after_code: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'after_code', 'style': 'form', 'explode': True }})
    ...
    before_code: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'before_code', 'style': 'form', 'explode': True }})
    before_id: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'before_id', 'style': 'form', 'explode': True }})
    code_hex: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'code_hex', 'style': 'form', 'explode': True }})
    from_: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'from', 'style': 'form', 'explode': True }})
    from_code: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'from_code', 'style': 'form', 'explode': True }})
    ...
    is_present: Optional[bool] = field(default=None, metadata={'query_param': { 'field_name': 'is_present', 'style': 'form', 'explode': True }})
    ...
    move_count: Optional[int] = field(default=None, metadata={'query_param': { 'field_name': 'move_count', 'style': 'form', 'explode': True }})
    populate: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'populate', 'style': 'form', 'explode': True }})
    protocol: Optional[shared.ItemProtocolEnum] = field(default=None, metadata={'query_param': { 'field_name': 'protocol', 'style': 'form', 'explode': True }})
    ...
    sets: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'sets', 'style': 'form', 'explode': True }})
    ...
    time_last_present: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'time_last_present', 'style': 'form', 'explode': True }})
    time_moved: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'time_moved', 'style': 'form', 'explode': True }})
    ...
    type: Optional[shared.ItemTypeEnum] = field(default=None, metadata={'query_param': { 'field_name': 'type', 'style': 'form', 'explode': True }})
    until: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'until', 'style': 'form', 'explode': True }})
    until_code: Optional[str] = field(default=None, metadata={'query_param': { 'field_name': 'until_code', 'style': 'form', 'explode': True }})
...
class GetItems200ApplicationJSON:
    ...
    results: Optional[List[shared.Item]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
    url: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('url') }})
    

@dataclass
class GetItemsRequest:
    query_params: GetItemsQueryParams = field()
...
class GetItemsResponse:
    ...
    get_items_200_application_json_object: Optional[GetItems200ApplicationJSON] = field(default=None)
