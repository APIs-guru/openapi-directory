...
class GetServices200ApplicationJSON:
    ...
    results: Optional[List[shared.Service]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
...
class GetServicesResponse:
    ...
    get_services_200_application_json_object: Optional[GetServices200ApplicationJSON] = field(default=None)
