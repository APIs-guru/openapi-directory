...
class GetPresencesRequest:
    query_params: GetPresencesQueryParams = field(default=None)
...
class GetPresences200ApplicationJSON:
    ...
    results: Optional[List[shared.Presence]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'results' }})
