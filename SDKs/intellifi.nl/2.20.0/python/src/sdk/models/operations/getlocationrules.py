...
class GetLocationRulesRequest:
    query_params: GetLocationRulesQueryParams = field(default=None)
...
class GetLocationRules200ApplicationJSON:
    ...
    results: Optional[List[shared.LocationRule]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'results' }})
