...
class GetLocationRulesQueryParams:
    ...
    type: Optional[shared.LocationRuleTypeEnum] = field(default=None, metadata={'query_param': { 'field_name': 'type', 'style': 'form', 'explode': True }})
...
class GetLocationRules200ApplicationJSON:
    ...
    results: Optional[List[shared.LocationRule]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
    url: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('url') }})
    

@dataclass
class GetLocationRulesRequest:
    query_params: GetLocationRulesQueryParams = field()
...
class GetLocationRulesResponse:
    ...
    get_location_rules_200_application_json_object: Optional[GetLocationRules200ApplicationJSON] = field(default=None)
