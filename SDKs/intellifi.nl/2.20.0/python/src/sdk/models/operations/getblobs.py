...
class GetBlobs200ApplicationJSON:
    ...
    results: Optional[List[shared.Blob]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
    url: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('url') }})
    

@dataclass
class GetBlobsRequest:
    query_params: GetBlobsQueryParams = field()
