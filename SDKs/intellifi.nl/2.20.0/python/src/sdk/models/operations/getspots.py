...
class GetSpotsRequest:
    query_params: GetSpotsQueryParams = field(default=None)
...
class GetSpots200ApplicationJSON:
    ...
    results: Optional[List[shared.SpotGet]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'results' }})
