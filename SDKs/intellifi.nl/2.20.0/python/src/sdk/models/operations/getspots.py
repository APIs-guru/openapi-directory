...
class GetSpotsQueryParams:
    ...
    is_online: Optional[bool] = field(default=None, metadata={'query_param': { 'field_name': 'is_online', 'style': 'form', 'explode': True }})
    ...
    request_counter: Optional[int] = field(default=None, metadata={'query_param': { 'field_name': 'request_counter', 'style': 'form', 'explode': True }})
    ...
    serial_number: Optional[int] = field(default=None, metadata={'query_param': { 'field_name': 'serial_number', 'style': 'form', 'explode': True }})
...
class GetSpots200ApplicationJSON:
    ...
    results: Optional[List[shared.SpotGet]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
    url: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('url') }})
    

@dataclass
class GetSpotsRequest:
    query_params: GetSpotsQueryParams = field()
...
class GetSpotsResponse:
    ...
    get_spots_200_application_json_object: Optional[GetSpots200ApplicationJSON] = field(default=None)
