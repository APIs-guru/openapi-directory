...
@dataclass_json
@dataclass
class SpotUpdateAntennaReportLocations:
...
@dataclass
class SpotUpdate:
    antenna_report_locations: Optional[List[SpotUpdateAntennaReportLocations]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'antenna_report_locations' }})
    ...
    report_location: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'report_location' }})
