...
var VerifyAccountIdSecurity = /** @class */ (function (_super) {
    ...
    function VerifyAccountIdSecurity() {
...
export { VerifyAccountId400ApplicationJson };
var VerifyAccountId401ApplicationJson = /** @class */ (function (_super) {
    __extends(VerifyAccountId401ApplicationJson, _super);
    function VerifyAccountId401ApplicationJson() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "json, name=error" }),
...
export { VerifyAccountId401ApplicationJson };
var VerifyAccountId500ApplicationJson = /** @class */ (function (_super) {
    __extends(VerifyAccountId500ApplicationJson, _super);
    function VerifyAccountId500ApplicationJson() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "json, name=error" }),
...
export { VerifyAccountIdResponse };
