...
var FileApIs = /** @class */ (function () {
    function FileApIs(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    FileApIs.prototype.getCertificateDataInXmlFormatFromUriId = function (req, config) {
    ...
    **/
    FileApIs.prototype.getFileFromUriId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    FileApIs.prototype.getListOfSelfUploadedDocuments = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Returns the list of meta-data about documents or folders in user’s DigiLocker in a specific location.
    **/
    FileApIs.prototype.getListOfSelfUploadedDocumentsId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    FileApIs.prototype.getListOfIssuedDocumentsVersion1Id = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Returns the list of meta-data about issued documents in user’s DigiLocker.
    **/
    FileApIs.prototype.getListOfIssuedDocumentsId = function (config) {
        var baseURL = this._serverURL;
    ...
    **/
    FileApIs.prototype.getEAadhaarDataInXmlFormatId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    FileApIs.prototype.pullDocumentId = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    FileApIs.prototype.uploadFileToLockerId = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
