...
class GetInboxRecipientsQueryParams:
    ...
    inbox_id: int = field(default=None, metadata={'query_param': { 'field_name': 'inbox_id', 'style': 'form', 'explode': True }})
...
class GetInboxRecipientsRequest:
    query_params: GetInboxRecipientsQueryParams = field(default=None)
    

@dataclass
class GetInboxRecipientsResponse:
    content_type: str = field(default=None)
    inbox_recipient_entities: Optional[List[shared.InboxRecipientEntity]] = field(default=None)
