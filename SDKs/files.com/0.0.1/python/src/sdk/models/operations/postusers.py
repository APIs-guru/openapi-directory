...
class PostUsersRequestBody:
    ...
    authentication_method: Optional[PostUsersRequestBodyAuthenticationMethodEnum] = field(default=None, metadata={'multipart_form': { 'field_name': 'authentication_method' }})
    avatar_delete: Optional[bool] = field(default=None, metadata={'multipart_form': { 'field_name': 'avatar_delete' }})
    avatar_file: Optional[PostUsersRequestBodyAvatarFile] = field(default=None, metadata={'multipart_form': { 'file': True }})
    ...
    require_2fa: Optional[PostUsersRequestBodyRequire2faEnum] = field(default=None, metadata={'multipart_form': { 'field_name': 'require_2fa' }})
    ...
    ssl_required: Optional[PostUsersRequestBodySslRequiredEnum] = field(default=None, metadata={'multipart_form': { 'field_name': 'ssl_required' }})
...
class PostUsersRequest:
    request: Optional[PostUsersRequestBody] = field(default=None, metadata={'request': { 'media_type': 'multipart/form-data' }})
