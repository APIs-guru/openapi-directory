...
class PatchUsersIDRequestBody:
    ...
    authentication_method: Optional[PatchUsersIDRequestBodyAuthenticationMethodEnum] = field(default=None, metadata={'multipart_form': { 'field_name': 'authentication_method' }})
    avatar_delete: Optional[bool] = field(default=None, metadata={'multipart_form': { 'field_name': 'avatar_delete' }})
    avatar_file: Optional[PatchUsersIDRequestBodyAvatarFile] = field(default=None, metadata={'multipart_form': { 'file': True }})
    ...
    require_2fa: Optional[PatchUsersIDRequestBodyRequire2faEnum] = field(default=None, metadata={'multipart_form': { 'field_name': 'require_2fa' }})
    ...
    ssl_required: Optional[PatchUsersIDRequestBodySslRequiredEnum] = field(default=None, metadata={'multipart_form': { 'field_name': 'ssl_required' }})
