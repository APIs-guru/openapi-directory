...
class PatchUserRequestBody:
    ...
    authentication_method: Optional[PatchUserRequestBodyAuthenticationMethodEnum] = field(default=None, metadata={'multipart_form': { 'field_name': 'authentication_method' }})
    avatar_delete: Optional[bool] = field(default=None, metadata={'multipart_form': { 'field_name': 'avatar_delete' }})
    avatar_file: Optional[PatchUserRequestBodyAvatarFile] = field(default=None, metadata={'multipart_form': { 'file': True }})
    ...
    require_2fa: Optional[PatchUserRequestBodyRequire2faEnum] = field(default=None, metadata={'multipart_form': { 'field_name': 'require_2fa' }})
    ...
    ssl_required: Optional[PatchUserRequestBodySslRequiredEnum] = field(default=None, metadata={'multipart_form': { 'field_name': 'ssl_required' }})
...
class PatchUserRequest:
    request: Optional[PatchUserRequestBody] = field(default=None, metadata={'request': { 'media_type': 'multipart/form-data' }})
