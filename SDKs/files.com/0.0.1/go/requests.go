...
func (s *Requests) DeleteRequestsID(ctx context.Context, request operations.DeleteRequestsIDRequest) (*operations.DeleteRequestsIDResponse, error) {
	...
	url := utils.GenerateURL(ctx, baseURL, "/requests/{id}", request.PathParams)
	...
	res := &operations.DeleteRequestsIDResponse{
...
func (s *Requests) GetRequests(ctx context.Context, request operations.GetRequestsRequest) (*operations.GetRequestsResponse, error) {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(contentType, `application/json`):
			var out []shared.RequestEntity
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}

			res.RequestEntities = out
		}
	case httpRes.StatusCode == 400:
	case httpRes.StatusCode == 401:
	case httpRes.StatusCode == 403:
...
func (s *Requests) GetRequestsFoldersPath(ctx context.Context, request operations.GetRequestsFoldersPathRequest) (*operations.GetRequestsFoldersPathResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/requests/folders/{path}", request.PathParams)
	...
	res := &operations.GetRequestsFoldersPathResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
...
func (s *Requests) PostRequests(ctx context.Context, request operations.PostRequestsRequest) (*operations.PostRequestsResponse, error) {
	...
	res := &operations.PostRequestsResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
