...
type RemoteServerEntity struct {
	AuthAccountName             *string                                    `json:"auth_account_name"`
	AuthSetupLink               *string                                    `json:"auth_setup_link"`
	AuthStatus                  *RemoteServerEntityAuthStatusEnum          `json:"auth_status"`
	AuthenticationMethod        *string                                    `json:"authentication_method"`
	AzureBlobStorageAccount     *string                                    `json:"azure_blob_storage_account"`
	AzureBlobStorageContainer   *string                                    `json:"azure_blob_storage_container"`
	BackblazeB2Bucket           *string                                    `json:"backblaze_b2_bucket"`
	BackblazeB2S3Endpoint       *string                                    `json:"backblaze_b2_s3_endpoint"`
	EnableDedicatedIps          *bool                                      `json:"enable_dedicated_ips"`
	GoogleCloudStorageBucket    *string                                    `json:"google_cloud_storage_bucket"`
	GoogleCloudStorageProjectID *string                                    `json:"google_cloud_storage_project_id"`
	Hostname                    *string                                    `json:"hostname"`
	ID                          *int32                                     `json:"id"`
	MaxConnections              *int32                                     `json:"max_connections"`
	Name                        *string                                    `json:"name"`
	OneDriveAccountType         *RemoteServerEntityOneDriveAccountTypeEnum `json:"one_drive_account_type"`
	Port                        *int32                                     `json:"port"`
	RackspaceContainer          *string                                    `json:"rackspace_container"`
	RackspaceRegion             *string                                    `json:"rackspace_region"`
	RackspaceUsername           *string                                    `json:"rackspace_username"`
	RemoteHomePath              *string                                    `json:"remote_home_path"`
	S3Bucket                    *string                                    `json:"s3_bucket"`
	S3CompatibleBucket          *string                                    `json:"s3_compatible_bucket"`
	S3CompatibleEndpoint        *string                                    `json:"s3_compatible_endpoint"`
	S3CompatibleRegion          *string                                    `json:"s3_compatible_region"`
	S3Region                    *string                                    `json:"s3_region"`
	ServerCertificate           *RemoteServerEntityServerCertificateEnum   `json:"server_certificate"`
	ServerHostKey               *string                                    `json:"server_host_key"`
	ServerType                  *RemoteServerEntityServerTypeEnum          `json:"server_type"`
	Ssl                         *RemoteServerEntitySslEnum                 `json:"ssl"`
