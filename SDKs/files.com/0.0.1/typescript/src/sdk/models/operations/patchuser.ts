...
export enum PatchUserRequestBodyAuthenticationMethodEnum {
    Password = "password",
...
export class PatchUserRequestBodyAvatarFile extends SpeakeasyBase {
...
export enum PatchUserRequestBodyRequire2faEnum {
    UseSystemSetting = "use_system_setting",
    AlwaysRequire = "always_require",
    NeverRequire = "never_require"
}

export enum PatchUserRequestBodySslRequiredEnum {
    UseSystemSetting = "use_system_setting",
    AlwaysRequire = "always_require",
    NeverRequire = "never_require"
}
...
export class PatchUserRequestBody extends SpeakeasyBase {
