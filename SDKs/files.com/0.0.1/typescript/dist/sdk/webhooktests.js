...
var WebhookTests = /** @class */ (function () {
     ...
     * Create Webhook Test
    **/
    WebhookTests.prototype.postWebhookTests = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostWebhookTestsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/webhook_tests";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.webhookTestEntity = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
