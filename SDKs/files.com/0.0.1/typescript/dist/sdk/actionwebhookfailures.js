...
var ActionWebhookFailures = /** @class */ (function () {
    function ActionWebhookFailures(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    ActionWebhookFailures.prototype.postActionWebhookFailuresIdRetry = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostActionWebhookFailuresIdRetryRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/action_webhook_failures/{id}/retry", req.pathParams);
