...
var UserCipherUses = /** @class */ (function () {
    function UserCipherUses(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    UserCipherUses.prototype.getUserCipherUses = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetUserCipherUsesRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/user_cipher_uses";
