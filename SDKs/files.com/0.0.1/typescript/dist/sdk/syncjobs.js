...
var SyncJobs = /** @class */ (function () {
    function SyncJobs(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * List Sync Jobs
    **/
    SyncJobs.prototype.getSyncJobs = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetSyncJobsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/sync_jobs";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.syncJobEntities = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
