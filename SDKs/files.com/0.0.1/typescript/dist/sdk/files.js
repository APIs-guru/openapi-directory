...
var Files = /** @class */ (function () {
     ...
     * Delete file/folder
    **/
    Files.prototype.deleteFilesPath = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteFilesPathRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/files/{path}", req.pathParams);
     ...
     * Download file
    **/
    Files.prototype.fileDownload = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Files.prototype.patchFilesPath = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Upload file
    **/
    Files.prototype.postFilesPath = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
