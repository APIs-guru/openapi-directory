...
var SettingsChanges = /** @class */ (function () {
    function SettingsChanges(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    SettingsChanges.prototype.getSettingsChanges = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetSettingsChangesRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/settings_changes";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.settingsChangeEntities = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
