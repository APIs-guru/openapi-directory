...
var BundleDownloads = /** @class */ (function () {
    function BundleDownloads(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    BundleDownloads.prototype.getBundleDownloads = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetBundleDownloadsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/bundle_downloads";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.bundleDownloadEntities = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
