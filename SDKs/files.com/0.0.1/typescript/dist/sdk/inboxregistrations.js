...
var InboxRegistrations = /** @class */ (function () {
    function InboxRegistrations(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    InboxRegistrations.prototype.getInboxRegistrations = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetInboxRegistrationsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/inbox_registrations";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.inboxRegistrationEntities = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
