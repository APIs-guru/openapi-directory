...
var MessageCommentReactions = /** @class */ (function () {
    function MessageCommentReactions(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    MessageCommentReactions.prototype.deleteMessageCommentReactionsId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteMessageCommentReactionsIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/message_comment_reactions/{id}", req.pathParams);
    ...
    **/
    MessageCommentReactions.prototype.getMessageCommentReactions = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetMessageCommentReactionsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/message_comment_reactions";
        var client = this._defaultClient;
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.messageCommentReactionEntities = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    break;
    ...
    **/
    MessageCommentReactions.prototype.getMessageCommentReactionsId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.messageCommentReactionEntity = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    break;
    ...
    **/
    MessageCommentReactions.prototype.postMessageCommentReactions = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
...
export { MessageCommentReactions };
