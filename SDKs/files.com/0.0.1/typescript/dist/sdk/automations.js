...
var Automations = /** @class */ (function () {
    function Automations(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     * Delete Automation
    **/
    Automations.prototype.deleteAutomationsId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteAutomationsIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/automations/{id}", req.pathParams);
     ...
     * List Automations
    **/
    Automations.prototype.getAutomations = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetAutomationsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/automations";
        var client = this._defaultClient;
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.automationEntities = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    break;
     ...
     * Show Automation
    **/
    Automations.prototype.getAutomationsId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.automationEntity = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    break;
     ...
     * Update Automation
    **/
    Automations.prototype.patchAutomationsId = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Create Automation
    **/
    Automations.prototype.postAutomations = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
