...
var UsageDailySnapshots = /** @class */ (function () {
    function UsageDailySnapshots(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    UsageDailySnapshots.prototype.getUsageDailySnapshots = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetUsageDailySnapshotsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/usage_daily_snapshots";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.usageDailySnapshotEntities = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
