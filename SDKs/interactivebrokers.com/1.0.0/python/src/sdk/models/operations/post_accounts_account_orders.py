...
class PostAccountsAccountOrdersRequestBody:
    ...
    order_restrictions: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'OrderRestrictions' }})
...
class PostAccountsAccountOrdersRequest:
    path_params: PostAccountsAccountOrdersPathParams = field(default=None)
    request: PostAccountsAccountOrdersRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
