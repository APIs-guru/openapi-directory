...
class GetMarketdataSnapshotRequest:
    request: List[GetMarketdataSnapshotRequestBody] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass_json
@dataclass
class GetMarketdataSnapshot200ApplicationJSONBid:
    market: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'market' }})
...
class GetMarketdataSnapshot200ApplicationJSON:
    bid: Optional[GetMarketdataSnapshot200ApplicationJSONBid] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Bid' }})
    closing: Optional[GetMarketdataSnapshot200ApplicationJSONClosing] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Closing' }})
    complete: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Complete' }})
    conid: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Conid' }})
    offer: Optional[GetMarketdataSnapshot200ApplicationJSONOffer] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Offer' }})
    temporality: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Temporality' }})
    trade: Optional[GetMarketdataSnapshot200ApplicationJSONTrade] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Trade' }})
