...
class GetMarketdataExchangeComponents200ApplicationJSONMapping:
    bit: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'bit' }})
...
class GetMarketdataExchangeComponents200ApplicationJSON:
    ...
    con_id: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ConId' }})
    mapping: Optional[List[GetMarketdataExchangeComponents200ApplicationJSONMapping]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'mapping' }})
