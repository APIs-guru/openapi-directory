...
class ConfigModelHaljsonEmbeddedProductEmbeddedOrganization:
    links: Optional[ConfigModelHaljsonEmbeddedProductEmbeddedOrganizationLinks] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('_links') }})
...
class ConfigModelHaljsonEmbeddedProductEmbedded:
    organization: Optional[ConfigModelHaljsonEmbeddedProductEmbeddedOrganization] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('organization') }})
...
class ConfigModelHaljsonEmbeddedProduct:
    embedded: Optional[ConfigModelHaljsonEmbeddedProductEmbedded] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('_embedded') }})
    links: Optional[ConfigModelHaljsonEmbeddedProductLinks] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('_links') }})
    name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('name') }})
...
class ConfigModelHaljsonEmbedded:
    product: Optional[ConfigModelHaljsonEmbeddedProduct] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('product') }})
...
class ConfigModelHaljson:
    embedded: Optional[ConfigModelHaljsonEmbedded] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('_embedded') }})
    links: Optional[ConfigModelHaljsonLinks] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('_links') }})
