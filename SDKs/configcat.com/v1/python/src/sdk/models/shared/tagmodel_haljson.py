...
class TagModelHaljsonEmbeddedProductEmbeddedOrganization:
    links: Optional[TagModelHaljsonEmbeddedProductEmbeddedOrganizationLinks] = field(default=None, metadata={'dataclasses_json': { 'field_name': '_links' }})
...
class TagModelHaljsonEmbeddedProductEmbedded:
    organization: Optional[TagModelHaljsonEmbeddedProductEmbeddedOrganization] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'organization' }})
...
class TagModelHaljsonEmbeddedProduct:
    embedded: Optional[TagModelHaljsonEmbeddedProductEmbedded] = field(default=None, metadata={'dataclasses_json': { 'field_name': '_embedded' }})
    links: Optional[TagModelHaljsonEmbeddedProductLinks] = field(default=None, metadata={'dataclasses_json': { 'field_name': '_links' }})
    name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'name' }})
...
class TagModelHaljsonEmbedded:
    product: Optional[TagModelHaljsonEmbeddedProduct] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'product' }})
...
class TagModelHaljson:
    embedded: Optional[TagModelHaljsonEmbedded] = field(default=None, metadata={'dataclasses_json': { 'field_name': '_embedded' }})
    links: Optional[TagModelHaljsonLinks] = field(default=None, metadata={'dataclasses_json': { 'field_name': '_links' }})
