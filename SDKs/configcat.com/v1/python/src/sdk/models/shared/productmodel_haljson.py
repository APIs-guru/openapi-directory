...
class ProductModelHaljsonEmbeddedOrganization:
    links: Optional[ProductModelHaljsonEmbeddedOrganizationLinks] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('_links') }})
...
class ProductModelHaljsonEmbedded:
    organization: Optional[ProductModelHaljsonEmbeddedOrganization] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('organization') }})
...
class ProductModelHaljson:
    embedded: Optional[ProductModelHaljsonEmbedded] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('_embedded') }})
    links: Optional[ProductModelHaljsonLinks] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('_links') }})
    name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('name') }})
