...
var Feed = /** @class */ (function () {
    function Feed(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Feed.prototype.retrieveNeoFeedToday = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RetrieveNeoFeedTodayRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/rest/v1/feed/today";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.nearEarthObjectList = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
    ...
    **/
    Feed.prototype.retrieveNearEarthObjectFeed = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.RetrieveNearEarthObjectFeedRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/rest/v1/feed";
        var client = this._defaultClient;
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
