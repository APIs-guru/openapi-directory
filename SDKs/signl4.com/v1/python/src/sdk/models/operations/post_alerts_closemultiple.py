...
@dataclass
class PostAlertsCloseMultipleRequests:
...
@dataclass
class PostAlertsCloseMultipleRequest:
    request: Optional[PostAlertsCloseMultipleRequests] = field(default=None)
    

@dataclass
class PostAlertsCloseMultipleResponse:
