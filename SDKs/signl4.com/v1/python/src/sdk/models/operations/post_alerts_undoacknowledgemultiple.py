...
@dataclass
class PostAlertsUndoAcknowledgeMultipleRequests:
...
@dataclass
class PostAlertsUndoAcknowledgeMultipleRequest:
    request: Optional[PostAlertsUndoAcknowledgeMultipleRequests] = field(default=None)
    

@dataclass
class PostAlertsUndoAcknowledgeMultipleResponse:
