...
class GetTeamsTeamIDSchedulesScheduleIDPathParams:
    schedule_id: str = field(default=None, metadata={'path_param': { 'field_name': 'scheduleId', 'style': 'simple', 'explode': False }})
...
class GetTeamsTeamIDSchedulesScheduleIDRequest:
    path_params: GetTeamsTeamIDSchedulesScheduleIDPathParams = field(default=None)
