...
@dataclass
class PostAlertsAcknowledgeMultipleRequests:
...
@dataclass
class PostAlertsAcknowledgeMultipleRequest:
    request: Optional[PostAlertsAcknowledgeMultipleRequests] = field(default=None)
