...
var OverviewEventPagedResultsPublic = /** @class */ (function (_super) {
    __extends(OverviewEventPagedResultsPublic, _super);
    function OverviewEventPagedResultsPublic() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=continuationToken" }),
        __metadata("design:type", PagedResultsPublicContinuationToken)
    ], OverviewEventPagedResultsPublic.prototype, "continuationToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=hasMore" }),
        __metadata("design:type", Boolean)
    ], OverviewEventPagedResultsPublic.prototype, "hasMore", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=results", elemType: OverviewEvent }),
        __metadata("design:type", Array)
    ], OverviewEventPagedResultsPublic.prototype, "results", void 0);
    return OverviewEventPagedResultsPublic;
}(SpeakeasyBase));
export { OverviewEventPagedResultsPublic };
