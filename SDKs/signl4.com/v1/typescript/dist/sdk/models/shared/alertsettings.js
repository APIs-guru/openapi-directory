...
var AlertSettings = /** @class */ (function (_super) {
    ...
    ], AlertSettings.prototype, "filterAction", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=filterMode" }),
        __metadata("design:type", Number)
    ], AlertSettings.prototype, "filterMode", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=optOutMode" }),
        __metadata("design:type", Number)
    ], AlertSettings.prototype, "optOutMode", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=persistentNotificicationMode" }),
        __metadata("design:type", Number)
    ], AlertSettings.prototype, "persistentNotificicationMode", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=responseMode" }),
        __metadata("design:type", Number)
    ], AlertSettings.prototype, "responseMode", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=responseTime" }),
        __metadata("design:type", Number)
    ], AlertSettings.prototype, "responseTime", void 0);
