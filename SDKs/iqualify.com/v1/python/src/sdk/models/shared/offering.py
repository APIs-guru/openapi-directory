...
@dataclass
class Offering:
    badge: Optional[OfferingBadge] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'badge' }})
    ...
    metadata: Optional[OfferingMetadata1] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'metadata' }})
