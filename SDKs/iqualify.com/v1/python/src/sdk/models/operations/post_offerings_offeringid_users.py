...
class PostOfferingsOfferingIDUsersRequest:
    path_params: PostOfferingsOfferingIDUsersPathParams = field(default=None)
    request: List[shared.OfferingUser] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
