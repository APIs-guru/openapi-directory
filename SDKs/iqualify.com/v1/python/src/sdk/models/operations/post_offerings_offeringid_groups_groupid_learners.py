...
class PostOfferingsOfferingIDGroupsGroupIDLearnersRequest:
    path_params: PostOfferingsOfferingIDGroupsGroupIDLearnersPathParams = field()
    request: PostOfferingsOfferingIDGroupsGroupIDLearnersRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
