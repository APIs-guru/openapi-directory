...
var GetResourcesMediaFeaturedJsonQueryParams = /** @class */ (function (_super) {
    ...
    function GetResourcesMediaFeaturedJsonQueryParams() {
...
export { GetResourcesMediaFeaturedJsonQueryParams };
var GetResourcesMediaFeaturedJsonRequest = /** @class */ (function (_super) {
    __extends(GetResourcesMediaFeaturedJsonRequest, _super);
    function GetResourcesMediaFeaturedJsonRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata(),
...
export { GetResourcesMediaFeaturedJsonRequest };
var GetResourcesMediaFeaturedJsonResponse = /** @class */ (function (_super) {
    __extends(GetResourcesMediaFeaturedJsonResponse, _super);
    function GetResourcesMediaFeaturedJsonResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata(),
...
export { GetResourcesMediaFeaturedJsonResponse };
