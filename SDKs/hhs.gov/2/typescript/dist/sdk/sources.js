...
var Sources = /** @class */ (function () {
    function Sources(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Sources.prototype.getResourcesSourcesIdJson = function (req, config) {
     ...
     * MediaItem
    **/
    Sources.prototype.getResourcesSourcesIdSyndicateFormat = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Source Listings
    **/
    Sources.prototype.getResourcesSourcesJson = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
