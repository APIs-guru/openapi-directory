...
var Campaigns = /** @class */ (function () {
    ...
    **/
    Campaigns.prototype.getResourcesCampaignsIdJson = function (req, config) {
     ...
     * Campaign Listings
    **/
    Campaigns.prototype.getResourcesCampaignsIdMediaJson = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * MediaItem
    **/
    Campaigns.prototype.getResourcesCampaignsIdSyndicateFormat = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Campaigns.prototype.getResourcesCampaignsJson = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
