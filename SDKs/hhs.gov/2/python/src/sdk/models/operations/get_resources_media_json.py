...
class GetResourcesMediaJSONQueryParams:
    ...
    content_authored_before_date: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'contentAuthoredBeforeDate', 'style': 'form', 'explode': False }})
    ...
    content_authored_since_date: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'contentAuthoredSinceDate', 'style': 'form', 'explode': False }})
    content_published_before_date: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'contentPublishedBeforeDate', 'style': 'form', 'explode': False }})
    ...
    content_published_since_date: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'contentPublishedSinceDate', 'style': 'form', 'explode': False }})
    content_reviewed_before_date: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'contentReviewedBeforeDate', 'style': 'form', 'explode': False }})
    ...
    content_reviewed_since_date: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'contentReviewedSinceDate', 'style': 'form', 'explode': False }})
    content_updated_before_date: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'contentUpdatedBeforeDate', 'style': 'form', 'explode': False }})
    ...
    content_updated_since_date: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'contentUpdatedSinceDate', 'style': 'form', 'explode': False }})
    ...
    date_content_authored: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'dateContentAuthored', 'style': 'form', 'explode': False }})
    date_content_published: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'dateContentPublished', 'style': 'form', 'explode': False }})
    date_content_reviewed: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'dateContentReviewed', 'style': 'form', 'explode': False }})
    date_content_updated: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'dateContentUpdated', 'style': 'form', 'explode': False }})
    date_syndication_captured: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'dateSyndicationCaptured', 'style': 'form', 'explode': False }})
    date_syndication_updated: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'dateSyndicationUpdated', 'style': 'form', 'explode': False }})
    ...
    syndication_captured_before_date: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'syndicationCapturedBeforeDate', 'style': 'form', 'explode': False }})
    ...
    syndication_captured_since_date: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'syndicationCapturedSinceDate', 'style': 'form', 'explode': False }})
    syndication_updated_before_date: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'syndicationUpdatedBeforeDate', 'style': 'form', 'explode': False }})
    ...
    syndication_updated_since_date: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'syndicationUpdatedSinceDate', 'style': 'form', 'explode': False }})
    syndication_visible_before_date: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'syndicationVisibleBeforeDate', 'style': 'form', 'explode': False }})
    syndication_visible_in_range: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'syndicationVisibleInRange', 'style': 'form', 'explode': False }})
    syndication_visible_since_date: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'syndicationVisibleSinceDate', 'style': 'form', 'explode': False }})
...
class GetResourcesMediaJSONRequest:
    query_params: GetResourcesMediaJSONQueryParams = field(default=None)
