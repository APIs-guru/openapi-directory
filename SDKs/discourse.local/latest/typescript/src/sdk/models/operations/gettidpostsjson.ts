...
export class GetTIdPostsJsonPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=id" })
  id: string;
}


export class GetTIdPostsJsonHeaders extends SpeakeasyBase {
...
export class GetTIdPostsJsonRequestBody extends SpeakeasyBase {
  @Metadata({ data: "json, name=post_ids[]" })
  postIds: number;
}


export class GetTIdPostsJsonRequest extends SpeakeasyBase {
  @Metadata()
  ...
  request?: GetTIdPostsJsonRequestBody;
}


export class GetTIdPostsJson200ApplicationJsonPostStreamPostsActionsSummary extends SpeakeasyBase {
...
export class GetTIdPostsJson200ApplicationJsonPostStreamPosts extends SpeakeasyBase {
  @Metadata({ data: "json, name=actions_summary", elemType: operations.GetTIdPostsJson200ApplicationJsonPostStreamPostsActionsSummary })
  actionsSummary?: GetTIdPostsJson200ApplicationJsonPostStreamPostsActionsSummary[];
...
export class GetTIdPostsJson200ApplicationJsonPostStream extends SpeakeasyBase {
  @Metadata({ data: "json, name=posts", elemType: operations.GetTIdPostsJson200ApplicationJsonPostStreamPosts })
  posts?: GetTIdPostsJson200ApplicationJsonPostStreamPosts[];
}


export class GetTIdPostsJson200ApplicationJson extends SpeakeasyBase {
  @Metadata({ data: "json, name=id" })
  id?: number;

  @Metadata({ data: "json, name=post_stream" })
  postStream?: GetTIdPostsJson200ApplicationJsonPostStream;
}


export class GetTIdPostsJsonResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
