...
export class GetUUsernameJsonPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=username" })
  username: string;
}


export class GetUUsernameJsonHeaders extends SpeakeasyBase {
...
export class GetUUsernameJsonRequest extends SpeakeasyBase {
  @Metadata()
...
export class GetUUsernameJson200ApplicationJsonUserGroupUsers extends SpeakeasyBase {
...
export class GetUUsernameJson200ApplicationJsonUserGroups extends SpeakeasyBase {
...
export class GetUUsernameJson200ApplicationJsonUserUserAuthTokens extends SpeakeasyBase {
...
export class GetUUsernameJson200ApplicationJsonUserUserOption extends SpeakeasyBase {
...
export class GetUUsernameJson200ApplicationJsonUser extends SpeakeasyBase {
  ...
  @Metadata({ data: "json, name=group_users", elemType: operations.GetUUsernameJson200ApplicationJsonUserGroupUsers })
  groupUsers?: GetUUsernameJson200ApplicationJsonUserGroupUsers[];

  @Metadata({ data: "json, name=groups", elemType: operations.GetUUsernameJson200ApplicationJsonUserGroups })
  ...
  @Metadata({ data: "json, name=user_auth_tokens", elemType: operations.GetUUsernameJson200ApplicationJsonUserUserAuthTokens })
...
export class GetUUsernameJson200ApplicationJson extends SpeakeasyBase {
...
export class GetUUsernameJsonResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
