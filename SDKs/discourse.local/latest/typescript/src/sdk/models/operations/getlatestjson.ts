...
export class GetLatestJson200ApplicationJsonTopicListTopics extends SpeakeasyBase {
  ...
  @Metadata({ data: "json, name=posters", elemType: operations.GetLatestJson200ApplicationJsonTopicListTopicsPosters })
...
export class GetLatestJson200ApplicationJsonTopicList extends SpeakeasyBase {
  ...
  @Metadata({ data: "json, name=topics", elemType: operations.GetLatestJson200ApplicationJsonTopicListTopics })
...
export class GetLatestJson200ApplicationJson extends SpeakeasyBase {
  ...
  @Metadata({ data: "json, name=users", elemType: operations.GetLatestJson200ApplicationJsonUsers })
