...
export class GetTopJsonPeriodEqualFlag200ApplicationJsonTopicListTopics extends SpeakeasyBase {
  ...
  @Metadata({ data: "json, name=posters", elemType: operations.GetTopJsonPeriodEqualFlag200ApplicationJsonTopicListTopicsPosters })
...
export class GetTopJsonPeriodEqualFlag200ApplicationJsonTopicList extends SpeakeasyBase {
  ...
  @Metadata({ data: "json, name=topics", elemType: operations.GetTopJsonPeriodEqualFlag200ApplicationJsonTopicListTopics })
...
export class GetTopJsonPeriodEqualFlag200ApplicationJson extends SpeakeasyBase {
  ...
  @Metadata({ data: "json, name=users", elemType: operations.GetTopJsonPeriodEqualFlag200ApplicationJsonUsers })
