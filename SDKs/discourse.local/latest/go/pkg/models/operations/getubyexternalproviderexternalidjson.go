...
type GetUByExternalProviderExternalIDJSON200ApplicationJSONUser struct {
	...
	FlairColor                  *string                                                                    `json:"flair_color,omitempty"`
	FlairURL                    *string                                                                    `json:"flair_url,omitempty"`
	GroupUsers                  []GetUByExternalProviderExternalIDJSON200ApplicationJSONUserGroupUsers     `json:"group_users,omitempty"`
	Groups                      []GetUByExternalProviderExternalIDJSON200ApplicationJSONUserGroups         `json:"groups,omitempty"`
	...
	UserAuthTokens              []GetUByExternalProviderExternalIDJSON200ApplicationJSONUserUserAuthTokens `json:"user_auth_tokens,omitempty"`
	UserFields                  map[string]interface{}                                                     `json:"user_fields,omitempty"`
	UserOption                  *GetUByExternalProviderExternalIDJSON200ApplicationJSONUserUserOption      `json:"user_option,omitempty"`
