...
type GetUByExternalProviderExternalIDJSONPathParams struct {
...
type GetUByExternalProviderExternalIDJSONHeaders struct {
...
type GetUByExternalProviderExternalIDJSON200ApplicationJSONUserGroups struct {
...
type GetUByExternalProviderExternalIDJSON200ApplicationJSONUserUserAuthTokens struct {
...
type GetUByExternalProviderExternalIDJSON200ApplicationJSONUserUserOption struct {
...
type GetUByExternalProviderExternalIDJSON200ApplicationJSONUser struct {
	...
	FlairColor                  *string                                                                    `json:"flair_color"`
	FlairURL                    *string                                                                    `json:"flair_url"`
	GroupUsers                  []GetUByExternalProviderExternalIDJSON200ApplicationJSONUserGroupUsers     `json:"group_users"`
	Groups                      []GetUByExternalProviderExternalIDJSON200ApplicationJSONUserGroups         `json:"groups"`
	...
	UserAuthTokens              []GetUByExternalProviderExternalIDJSON200ApplicationJSONUserUserAuthTokens `json:"user_auth_tokens"`
	UserFields                  map[string]interface{}                                                     `json:"user_fields"`
	UserOption                  *GetUByExternalProviderExternalIDJSON200ApplicationJSONUserUserOption      `json:"user_option"`
...
type GetUByExternalProviderExternalIDJSON200ApplicationJSON struct {
	User       *GetUByExternalProviderExternalIDJSON200ApplicationJSONUser `json:"user"`
