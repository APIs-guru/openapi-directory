...
type GetUUsernameJSON200ApplicationJSONUser struct {
	...
	FlairColor                  *string                                                `json:"flair_color,omitempty"`
	FlairURL                    *string                                                `json:"flair_url,omitempty"`
	GroupUsers                  []GetUUsernameJSON200ApplicationJSONUserGroupUsers     `json:"group_users,omitempty"`
	Groups                      []GetUUsernameJSON200ApplicationJSONUserGroups         `json:"groups,omitempty"`
	...
	UserAuthTokens              []GetUUsernameJSON200ApplicationJSONUserUserAuthTokens `json:"user_auth_tokens,omitempty"`
	UserFields                  map[string]interface{}                                 `json:"user_fields,omitempty"`
	UserOption                  *GetUUsernameJSON200ApplicationJSONUserUserOption      `json:"user_option,omitempty"`
