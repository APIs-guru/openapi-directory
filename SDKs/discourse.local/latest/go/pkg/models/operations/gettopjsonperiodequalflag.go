...
type GetTopJSONPeriodEqualFlag200ApplicationJSONTopicListTopics struct {
	...
	Posters            []GetTopJSONPeriodEqualFlag200ApplicationJSONTopicListTopicsPosters `json:"posters"`
...
type GetTopJSONPeriodEqualFlag200ApplicationJSONTopicList struct {
	...
	Topics         []GetTopJSONPeriodEqualFlag200ApplicationJSONTopicListTopics `json:"topics"`
}
...
type GetTopJSONPeriodEqualFlag200ApplicationJSON struct {
	...
	TopicList     *GetTopJSONPeriodEqualFlag200ApplicationJSONTopicList `json:"topic_list"`
	Users         []GetTopJSONPeriodEqualFlag200ApplicationJSONUsers    `json:"users"`
}
