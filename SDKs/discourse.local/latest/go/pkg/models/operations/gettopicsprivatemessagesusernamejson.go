...
type GetTopicsPrivateMessagesUsernameJSONPathParams struct {
	Username string `pathParam:"style=simple,explode=false,name=username"`
}

type GetTopicsPrivateMessagesUsernameJSON200ApplicationJSONTopicListTopicsParticipants struct {
...
type GetTopicsPrivateMessagesUsernameJSON200ApplicationJSONTopicListTopicsPosters struct {
	Description    *string `json:"description,omitempty"`
	Extras         *string `json:"extras,omitempty"`
	PrimaryGroupID *string `json:"primary_group_id,omitempty"`
	UserID         *int64  `json:"user_id,omitempty"`
...
type GetTopicsPrivateMessagesUsernameJSON200ApplicationJSONTopicListTopics struct {
	...
	Participants       []GetTopicsPrivateMessagesUsernameJSON200ApplicationJSONTopicListTopicsParticipants `json:"participants,omitempty"`
	Pinned             *bool                                                                               `json:"pinned,omitempty"`
	PinnedGlobally     *bool                                                                               `json:"pinned_globally,omitempty"`
	Posters            []GetTopicsPrivateMessagesUsernameJSON200ApplicationJSONTopicListTopicsPosters      `json:"posters,omitempty"`
...
type GetTopicsPrivateMessagesUsernameJSON200ApplicationJSONTopicList struct {
	...
	Topics         []GetTopicsPrivateMessagesUsernameJSON200ApplicationJSONTopicListTopics `json:"topics,omitempty"`
}

type GetTopicsPrivateMessagesUsernameJSON200ApplicationJSONUsers struct {
...
type GetTopicsPrivateMessagesUsernameJSON200ApplicationJSON struct {
	PrimaryGroups []interface{}                                                    `json:"primary_groups,omitempty"`
	TopicList     *GetTopicsPrivateMessagesUsernameJSON200ApplicationJSONTopicList `json:"topic_list,omitempty"`
	Users         []GetTopicsPrivateMessagesUsernameJSON200ApplicationJSONUsers    `json:"users,omitempty"`
}

type GetTopicsPrivateMessagesUsernameJSONRequest struct {
	PathParams GetTopicsPrivateMessagesUsernameJSONPathParams
}

type GetTopicsPrivateMessagesUsernameJSONResponse struct {
	ContentType                                                  string
