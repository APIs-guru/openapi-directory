...
type GetUByExternalExternalIDJSON200ApplicationJSONUser struct {
	...
	FlairColor                  *string                                                            `json:"flair_color"`
	FlairURL                    *string                                                            `json:"flair_url"`
	GroupUsers                  []GetUByExternalExternalIDJSON200ApplicationJSONUserGroupUsers     `json:"group_users"`
	Groups                      []GetUByExternalExternalIDJSON200ApplicationJSONUserGroups         `json:"groups"`
	...
	UserAuthTokens              []GetUByExternalExternalIDJSON200ApplicationJSONUserUserAuthTokens `json:"user_auth_tokens"`
	UserFields                  map[string]interface{}                                             `json:"user_fields"`
	UserOption                  *GetUByExternalExternalIDJSON200ApplicationJSONUserUserOption      `json:"user_option"`
...
type GetUByExternalExternalIDJSON200ApplicationJSON struct {
	User       *GetUByExternalExternalIDJSON200ApplicationJSONUser `json:"user"`
