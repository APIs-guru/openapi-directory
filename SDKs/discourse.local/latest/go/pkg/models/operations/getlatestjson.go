...
type GetLatestJSON200ApplicationJSONTopicListTopics struct {
	...
	Posters            []GetLatestJSON200ApplicationJSONTopicListTopicsPosters `json:"posters,omitempty"`
...
type GetLatestJSON200ApplicationJSONTopicList struct {
	...
	Topics         []GetLatestJSON200ApplicationJSONTopicListTopics `json:"topics,omitempty"`
}
