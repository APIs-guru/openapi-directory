...
class GetTopicsPrivateMessagesSentUsernameJSON200ApplicationJSONTopicListTopics:
    ...
    participants: Optional[List[Any]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('participants') }})
    ...
    posters: Optional[List[GetTopicsPrivateMessagesSentUsernameJSON200ApplicationJSONTopicListTopicsPosters]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('posters') }})
...
class GetTopicsPrivateMessagesSentUsernameJSON200ApplicationJSONTopicList:
    ...
    topics: Optional[List[GetTopicsPrivateMessagesSentUsernameJSON200ApplicationJSONTopicListTopics]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('topics') }})
...
class GetTopicsPrivateMessagesSentUsernameJSON200ApplicationJSON:
    ...
    topic_list: Optional[GetTopicsPrivateMessagesSentUsernameJSON200ApplicationJSONTopicList] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('topic_list') }})
    users: Optional[List[GetTopicsPrivateMessagesSentUsernameJSON200ApplicationJSONUsers]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('users') }})
    

@dataclass
class GetTopicsPrivateMessagesSentUsernameJSONRequest:
    path_params: GetTopicsPrivateMessagesSentUsernameJSONPathParams = field()
