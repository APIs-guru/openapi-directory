...
class GetUByExternalExternalIDJSONRequest:
    path_params: GetUByExternalExternalIDJSONPathParams = field(default=None)
    headers: GetUByExternalExternalIDJSONHeaders = field(default=None)
...
class GetUByExternalExternalIDJSON200ApplicationJSONUser:
    ...
    flair_color: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'flair_color' }})
    flair_url: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'flair_url' }})
    group_users: Optional[List[GetUByExternalExternalIDJSON200ApplicationJSONUserGroupUsers]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'group_users' }})
    groups: Optional[List[GetUByExternalExternalIDJSON200ApplicationJSONUserGroups]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'groups' }})
    ...
    user_auth_tokens: Optional[List[GetUByExternalExternalIDJSON200ApplicationJSONUserUserAuthTokens]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'user_auth_tokens' }})
    user_fields: Optional[dict[str, Any]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'user_fields' }})
    user_option: Optional[GetUByExternalExternalIDJSON200ApplicationJSONUserUserOption] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'user_option' }})
...
class GetUByExternalExternalIDJSON200ApplicationJSON:
    user: Optional[GetUByExternalExternalIDJSON200ApplicationJSONUser] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'user' }})
