...
class GetTIDJSONRequest:
    path_params: GetTIDJSONPathParams = field(default=None)
    headers: GetTIDJSONHeaders = field(default=None)
...
class GetTIDJSON200ApplicationJSONDetails:
    can_convert_topic: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'can_convert_topic' }})
    can_create_post: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'can_create_post' }})
    ...
    can_flag_topic: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'can_flag_topic' }})
    can_move_posts: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'can_move_posts' }})
    can_remove_allowed_users: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'can_remove_allowed_users' }})
    can_remove_self_id: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'can_remove_self_id' }})
    can_reply_as_new_topic: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'can_reply_as_new_topic' }})
    can_review_topic: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'can_review_topic' }})
    created_by: Optional[GetTIDJSON200ApplicationJSONDetailsCreatedBy] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'created_by' }})
    last_poster: Optional[GetTIDJSON200ApplicationJSONDetailsLastPoster] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'last_poster' }})
    notification_level: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'notification_level' }})
    participants: Optional[List[GetTIDJSON200ApplicationJSONDetailsParticipants]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'participants' }})
...
class GetTIDJSON200ApplicationJSONPostStreamPostsLinkCounts:
    clicks: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'clicks' }})
    internal: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'internal' }})
    reflection: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'reflection' }})
...
class GetTIDJSON200ApplicationJSONPostStreamPosts:
    actions_summary: Optional[List[GetTIDJSON200ApplicationJSONPostStreamPostsActionsSummary]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'actions_summary' }})
    ...
    link_counts: Optional[List[GetTIDJSON200ApplicationJSONPostStreamPostsLinkCounts]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'link_counts' }})
    ...
    reviewable_id: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'reviewable_id' }})
...
class GetTIDJSON200ApplicationJSONPostStream:
    posts: Optional[List[GetTIDJSON200ApplicationJSONPostStreamPosts]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'posts' }})
    stream: Optional[List[Any]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'stream' }})
...
class GetTIDJSON200ApplicationJSONSuggestedTopicsPosters:
    ...
    user: Optional[GetTIDJSON200ApplicationJSONSuggestedTopicsPostersUser] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'user' }})
...
class GetTIDJSON200ApplicationJSONSuggestedTopics:
    ...
    posters: Optional[List[GetTIDJSON200ApplicationJSONSuggestedTopicsPosters]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'posters' }})
...
class GetTIDJSON200ApplicationJSON:
    actions_summary: Optional[List[GetTIDJSON200ApplicationJSONActionsSummary]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'actions_summary' }})
    archetype: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'archetype' }})
    archived: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'archived' }})
    bookmarked: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'bookmarked' }})
    category_id: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'category_id' }})
    chunk_size: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'chunk_size' }})
    closed: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'closed' }})
    created_at: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'created_at' }})
    current_post_number: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'current_post_number' }})
    deleted_at: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'deleted_at' }})
    deleted_by: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'deleted_by' }})
    details: Optional[GetTIDJSON200ApplicationJSONDetails] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'details' }})
    ...
    fancy_title: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'fancy_title' }})
    featured_link: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'featured_link' }})
    has_deleted: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'has_deleted' }})
    ...
    last_posted_at: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'last_posted_at' }})
    like_count: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'like_count' }})
    message_bus_last_id: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'message_bus_last_id' }})
    participant_count: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'participant_count' }})
    pinned: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'pinned' }})
    pinned_at: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'pinned_at' }})
    pinned_globally: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'pinned_globally' }})
    pinned_until: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'pinned_until' }})
    post_stream: Optional[GetTIDJSON200ApplicationJSONPostStream] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'post_stream' }})
    posts_count: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'posts_count' }})
    reply_count: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'reply_count' }})
    show_read_indicator: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'show_read_indicator' }})
    slug: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'slug' }})
    suggested_topics: Optional[List[GetTIDJSON200ApplicationJSONSuggestedTopics]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'suggested_topics' }})
    thumbnails: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'thumbnails' }})
    timeline_lookup: Optional[List[Any]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'timeline_lookup' }})
    title: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'title' }})
    topic_timer: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'topic_timer' }})
    unpinned: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'unpinned' }})
    user_id: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'user_id' }})
    views: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'views' }})
    visible: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'visible' }})
    word_count: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'word_count' }})
