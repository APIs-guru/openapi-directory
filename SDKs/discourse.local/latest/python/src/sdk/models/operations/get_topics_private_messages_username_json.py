...
@dataclass
class GetTopicsPrivateMessagesUsernameJSONPathParams:
    username: str = field(metadata={'path_param': { 'field_name': 'username', 'style': 'simple', 'explode': False }})
    

@dataclass_json
@dataclass
class GetTopicsPrivateMessagesUsernameJSON200ApplicationJSONTopicListTopicsParticipants:
...
@dataclass_json
@dataclass
class GetTopicsPrivateMessagesUsernameJSON200ApplicationJSONTopicListTopicsPosters:
    description: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('description') }})
    extras: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('extras') }})
    primary_group_id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('primary_group_id') }})
    user_id: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('user_id') }})
...
@dataclass_json
@dataclass
class GetTopicsPrivateMessagesUsernameJSON200ApplicationJSONTopicListTopics:
    allowed_user_count: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('allowed_user_count') }})
    ...
    participants: Optional[List[GetTopicsPrivateMessagesUsernameJSON200ApplicationJSONTopicListTopicsParticipants]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('participants') }})
    ...
    posters: Optional[List[GetTopicsPrivateMessagesUsernameJSON200ApplicationJSONTopicListTopicsPosters]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('posters') }})
...
@dataclass_json
@dataclass
class GetTopicsPrivateMessagesUsernameJSON200ApplicationJSONTopicList:
    ...
    topics: Optional[List[GetTopicsPrivateMessagesUsernameJSON200ApplicationJSONTopicListTopics]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('topics') }})
    

@dataclass_json
@dataclass
class GetTopicsPrivateMessagesUsernameJSON200ApplicationJSONUsers:
...
@dataclass_json
@dataclass
class GetTopicsPrivateMessagesUsernameJSON200ApplicationJSON:
    ...
    topic_list: Optional[GetTopicsPrivateMessagesUsernameJSON200ApplicationJSONTopicList] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('topic_list') }})
    users: Optional[List[GetTopicsPrivateMessagesUsernameJSON200ApplicationJSONUsers]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('users') }})
    

@dataclass
class GetTopicsPrivateMessagesUsernameJSONRequest:
    path_params: GetTopicsPrivateMessagesUsernameJSONPathParams = field()
    

@dataclass
class GetTopicsPrivateMessagesUsernameJSONResponse:
    content_type: str = field()
    status_code: int = field()
    get_topics_private_messages_username_json_200_application_json_object: Optional[GetTopicsPrivateMessagesUsernameJSON200ApplicationJSON] = field(default=None)
