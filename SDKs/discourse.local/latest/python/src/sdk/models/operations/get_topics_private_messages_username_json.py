...
class GetTopicsPrivateMessagesUsernameJSONRequest:
    path_params: GetTopicsPrivateMessagesUsernameJSONPathParams = field(default=None)
...
class GetTopicsPrivateMessagesUsernameJSON200ApplicationJSONTopicListTopics:
    ...
    participants: Optional[List[GetTopicsPrivateMessagesUsernameJSON200ApplicationJSONTopicListTopicsParticipants]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'participants' }})
    ...
    posters: Optional[List[GetTopicsPrivateMessagesUsernameJSON200ApplicationJSONTopicListTopicsPosters]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'posters' }})
...
class GetTopicsPrivateMessagesUsernameJSON200ApplicationJSONTopicList:
    ...
    topics: Optional[List[GetTopicsPrivateMessagesUsernameJSON200ApplicationJSONTopicListTopics]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'topics' }})
...
class GetTopicsPrivateMessagesUsernameJSON200ApplicationJSON:
    ...
    topic_list: Optional[GetTopicsPrivateMessagesUsernameJSON200ApplicationJSONTopicList] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'topic_list' }})
    users: Optional[List[GetTopicsPrivateMessagesUsernameJSON200ApplicationJSONUsers]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'users' }})
