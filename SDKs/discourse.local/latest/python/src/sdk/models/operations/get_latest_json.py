...
@dataclass
class GetLatestJSONQueryParams:
...
@dataclass_json
@dataclass
class GetLatestJSON200ApplicationJSONTopicListTopicsPosters:
...
@dataclass_json
@dataclass
class GetLatestJSON200ApplicationJSONTopicListTopics:
    ...
    posters: Optional[List[GetLatestJSON200ApplicationJSONTopicListTopicsPosters]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('posters') }})
...
@dataclass_json
@dataclass
class GetLatestJSON200ApplicationJSONTopicList:
    ...
    topics: Optional[List[GetLatestJSON200ApplicationJSONTopicListTopics]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('topics') }})
    

@dataclass_json
@dataclass
class GetLatestJSON200ApplicationJSONUsers:
...
@dataclass_json
@dataclass
class GetLatestJSON200ApplicationJSON:
    ...
    topic_list: Optional[GetLatestJSON200ApplicationJSONTopicList] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('topic_list') }})
    users: Optional[List[GetLatestJSON200ApplicationJSONUsers]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('users') }})
    

@dataclass
class GetLatestJSONRequest:
    headers: GetLatestJSONHeaders = field()
    query_params: GetLatestJSONQueryParams = field()
    

@dataclass
class GetLatestJSONResponse:
    content_type: str = field()
    status_code: int = field()
    get_latest_json_200_application_json_object: Optional[GetLatestJSON200ApplicationJSON] = field(default=None)
