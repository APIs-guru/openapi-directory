...
class GetLatestJSONRequest:
    query_params: GetLatestJSONQueryParams = field(default=None)
    headers: GetLatestJSONHeaders = field(default=None)
...
class GetLatestJSON200ApplicationJSONTopicListTopics:
    ...
    posters: Optional[List[GetLatestJSON200ApplicationJSONTopicListTopicsPosters]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'posters' }})
...
class GetLatestJSON200ApplicationJSONTopicList:
    ...
    topics: Optional[List[GetLatestJSON200ApplicationJSONTopicListTopics]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'topics' }})
...
class GetLatestJSON200ApplicationJSON:
    ...
    topic_list: Optional[GetLatestJSON200ApplicationJSONTopicList] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'topic_list' }})
    users: Optional[List[GetLatestJSON200ApplicationJSONUsers]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'users' }})
