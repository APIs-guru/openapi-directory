...
@dataclass_json
@dataclass
class GetTopJSON200ApplicationJSONTopicListTopicsPosters:
...
@dataclass_json
@dataclass
class GetTopJSON200ApplicationJSONTopicListTopics:
    ...
    posters: Optional[List[GetTopJSON200ApplicationJSONTopicListTopicsPosters]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('posters') }})
...
@dataclass_json
@dataclass
class GetTopJSON200ApplicationJSONTopicList:
    ...
    topics: Optional[List[GetTopJSON200ApplicationJSONTopicListTopics]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('topics') }})
    

@dataclass_json
@dataclass
class GetTopJSON200ApplicationJSONUsers:
...
@dataclass_json
@dataclass
class GetTopJSON200ApplicationJSON:
    ...
    topic_list: Optional[GetTopJSON200ApplicationJSONTopicList] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('topic_list') }})
    users: Optional[List[GetTopJSON200ApplicationJSONUsers]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('users') }})
    

@dataclass
class GetTopJSONRequest:
    headers: GetTopJSONHeaders = field()
    

@dataclass
class GetTopJSONResponse:
    content_type: str = field()
    status_code: int = field()
    get_top_json_200_application_json_object: Optional[GetTopJSON200ApplicationJSON] = field(default=None)
