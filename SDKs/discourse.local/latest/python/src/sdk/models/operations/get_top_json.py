...
class GetTopJSONRequest:
    headers: GetTopJSONHeaders = field(default=None)
...
class GetTopJSON200ApplicationJSONTopicListTopics:
    ...
    posters: Optional[List[GetTopJSON200ApplicationJSONTopicListTopicsPosters]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'posters' }})
...
class GetTopJSON200ApplicationJSONTopicList:
    ...
    topics: Optional[List[GetTopJSON200ApplicationJSONTopicListTopics]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'topics' }})
...
class GetTopJSON200ApplicationJSON:
    ...
    topic_list: Optional[GetTopJSON200ApplicationJSONTopicList] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'topic_list' }})
    users: Optional[List[GetTopJSON200ApplicationJSONUsers]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'users' }})
