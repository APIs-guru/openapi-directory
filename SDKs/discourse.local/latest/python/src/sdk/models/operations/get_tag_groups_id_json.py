...
class GetTagGroupsIDJSON200ApplicationJSONTagGroup:
    ...
    permissions: Optional[GetTagGroupsIDJSON200ApplicationJSONTagGroupPermissions] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('permissions') }})
...
class GetTagGroupsIDJSON200ApplicationJSON:
    tag_group: Optional[GetTagGroupsIDJSON200ApplicationJSONTagGroup] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('tag_group') }})
    

@dataclass
class GetTagGroupsIDJSONRequest:
    path_params: GetTagGroupsIDJSONPathParams = field()
