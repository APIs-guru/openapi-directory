...
class GetTopJSONPeriodEqualFlagPathParams:
    flag: str = field(metadata={'path_param': { 'field_name': 'flag', 'style': 'simple', 'explode': False }})
...
class GetTopJSONPeriodEqualFlag200ApplicationJSONTopicListTopics:
    ...
    op_like_count: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('op_like_count') }})
    ...
    posters: Optional[List[GetTopJSONPeriodEqualFlag200ApplicationJSONTopicListTopicsPosters]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('posters') }})
...
class GetTopJSONPeriodEqualFlag200ApplicationJSONTopicList:
    ...
    for_period: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('for_period') }})
    per_page: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('per_page') }})
    topics: Optional[List[GetTopJSONPeriodEqualFlag200ApplicationJSONTopicListTopics]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('topics') }})
...
class GetTopJSONPeriodEqualFlag200ApplicationJSON:
    ...
    topic_list: Optional[GetTopJSONPeriodEqualFlag200ApplicationJSONTopicList] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('topic_list') }})
    users: Optional[List[GetTopJSONPeriodEqualFlag200ApplicationJSONUsers]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('users') }})
    

@dataclass
class GetTopJSONPeriodEqualFlagRequest:
    headers: GetTopJSONPeriodEqualFlagHeaders = field()
    path_params: GetTopJSONPeriodEqualFlagPathParams = field()
