...
class PostInvitesJSONRequestBody:
    custom_message: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('custom_message') }})
    ...
    group_names: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('group_names') }})
    max_redemptions_allowed: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('max_redemptions_allowed') }})
...
class PostInvitesJSON200ApplicationJSON:
    ...
    custom_message: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('custom_message') }})
    email: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('email') }})
    emailed: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('emailed') }})
    ...
    topics: Optional[List[Any]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('topics') }})
...
class PostInvitesJSONRequest:
    headers: PostInvitesJSONHeaders = field()
