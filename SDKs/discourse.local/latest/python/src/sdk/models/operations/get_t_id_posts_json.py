...
class GetTIDPostsJSONRequestBody:
    post_ids_: int = field(default=None, metadata={'dataclasses_json': { 'field_name': 'post_ids[]' }})
    

@dataclass
class GetTIDPostsJSONRequest:
    path_params: GetTIDPostsJSONPathParams = field(default=None)
    headers: GetTIDPostsJSONHeaders = field(default=None)
...
class GetTIDPostsJSON200ApplicationJSONPostStreamPosts:
    actions_summary: Optional[List[GetTIDPostsJSON200ApplicationJSONPostStreamPostsActionsSummary]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'actions_summary' }})
...
class GetTIDPostsJSON200ApplicationJSONPostStream:
    posts: Optional[List[GetTIDPostsJSON200ApplicationJSONPostStreamPosts]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'posts' }})
...
class GetTIDPostsJSON200ApplicationJSON:
    id: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'id' }})
    post_stream: Optional[GetTIDPostsJSON200ApplicationJSONPostStream] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'post_stream' }})
