...
class GetUUsernameJSONRequest:
    path_params: GetUUsernameJSONPathParams = field(default=None)
    headers: GetUUsernameJSONHeaders = field(default=None)
...
class GetUUsernameJSON200ApplicationJSONUser:
    ...
    flair_color: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'flair_color' }})
    flair_url: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'flair_url' }})
    group_users: Optional[List[GetUUsernameJSON200ApplicationJSONUserGroupUsers]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'group_users' }})
    groups: Optional[List[GetUUsernameJSON200ApplicationJSONUserGroups]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'groups' }})
    ...
    user_auth_tokens: Optional[List[GetUUsernameJSON200ApplicationJSONUserUserAuthTokens]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'user_auth_tokens' }})
    user_fields: Optional[dict[str, Any]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'user_fields' }})
    user_option: Optional[GetUUsernameJSON200ApplicationJSONUserUserOption] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'user_option' }})
...
class GetUUsernameJSON200ApplicationJSON:
    user: Optional[GetUUsernameJSON200ApplicationJSONUser] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'user' }})
