...
class GetTagNameJSONRequest:
    path_params: GetTagNameJSONPathParams = field(default=None)
...
class GetTagNameJSON200ApplicationJSONTopicListTags:
    ...
    topic_count: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'topic_count' }})
...
class GetTagNameJSON200ApplicationJSONTopicListTopics:
    ...
    posters: Optional[List[GetTagNameJSON200ApplicationJSONTopicListTopicsPosters]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'posters' }})
...
class GetTagNameJSON200ApplicationJSONTopicList:
    ...
    tags: Optional[List[GetTagNameJSON200ApplicationJSONTopicListTags]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'tags' }})
    topics: Optional[List[GetTagNameJSON200ApplicationJSONTopicListTopics]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'topics' }})
...
class GetTagNameJSON200ApplicationJSON:
    ...
    topic_list: Optional[GetTagNameJSON200ApplicationJSONTopicList] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'topic_list' }})
    users: Optional[List[GetTagNameJSON200ApplicationJSONUsers]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'users' }})
