...
class GetPostsJSON200ApplicationJSONLatestPosts:
    actions_summary: Optional[List[GetPostsJSON200ApplicationJSONLatestPostsActionsSummary]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('actions_summary') }})
    ...
    topic_html_title: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('topic_html_title') }})
    ...
    topic_title: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('topic_title') }})
...
class GetPostsJSON200ApplicationJSON:
    latest_posts: Optional[List[GetPostsJSON200ApplicationJSONLatestPosts]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('latest_posts') }})
    

@dataclass
class GetPostsJSONRequest:
    headers: GetPostsJSONHeaders = field()
