...
class PostPostActionsJSONRequestBody:
    flag_topic: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'flag_topic' }})
    id: int = field(default=None, metadata={'dataclasses_json': { 'field_name': 'id' }})
    post_action_type_id: int = field(default=None, metadata={'dataclasses_json': { 'field_name': 'post_action_type_id' }})
    

@dataclass
class PostPostActionsJSONRequest:
    headers: PostPostActionsJSONHeaders = field(default=None)
...
class PostPostActionsJSON200ApplicationJSONActionsSummary:
    acted: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'acted' }})
    can_undo: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'can_undo' }})
...
class PostPostActionsJSON200ApplicationJSON:
    actions_summary: Optional[List[PostPostActionsJSON200ApplicationJSONActionsSummary]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'actions_summary' }})
    ...
    notice: Optional[dict[str, Any]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'notice' }})
