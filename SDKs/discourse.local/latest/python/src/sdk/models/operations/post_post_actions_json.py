...
@dataclass
class PostPostActionsJSONHeaders:
...
@dataclass_json
@dataclass
class PostPostActionsJSONRequestBody:
    id: int = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('id') }})
    post_action_type_id: int = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('post_action_type_id') }})
    flag_topic: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('flag_topic') }})
    

@dataclass_json
@dataclass
class PostPostActionsJSON200ApplicationJSONActionsSummary:
    acted: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('acted') }})
    can_undo: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('can_undo') }})
...
@dataclass_json
@dataclass
class PostPostActionsJSON200ApplicationJSON:
    actions_summary: Optional[List[PostPostActionsJSON200ApplicationJSONActionsSummary]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('actions_summary') }})
    ...
    notice: Optional[dict[str, Any]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('notice') }})
...
@dataclass
class PostPostActionsJSONRequest:
    headers: PostPostActionsJSONHeaders = field()
    request: Optional[PostPostActionsJSONRequestBody] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
    

@dataclass
class PostPostActionsJSONResponse:
    content_type: str = field()
    status_code: int = field()
    post_post_actions_json_200_application_json_object: Optional[PostPostActionsJSON200ApplicationJSON] = field(default=None)
