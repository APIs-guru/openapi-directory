...
class PutPostsIDJSONRequestBodyPost:
    raw: str = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('raw') }})
...
class PutPostsIDJSONRequestBody:
    post: Optional[PutPostsIDJSONRequestBodyPost] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('post') }})
...
class PutPostsIDJSON200ApplicationJSONPost:
    actions_summary: Optional[List[PutPostsIDJSON200ApplicationJSONPostActionsSummary]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('actions_summary') }})
...
class PutPostsIDJSON200ApplicationJSON:
    post: Optional[PutPostsIDJSON200ApplicationJSONPost] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('post') }})
    

@dataclass
class PutPostsIDJSONRequest:
    headers: PutPostsIDJSONHeaders = field()
    path_params: PutPostsIDJSONPathParams = field()
