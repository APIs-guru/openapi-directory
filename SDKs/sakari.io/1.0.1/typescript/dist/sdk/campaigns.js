...
var Campaigns = /** @class */ (function () {
    ...
    **/
    Campaigns.prototype.campaignsCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CampaignsCreateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/accounts/{accountId}/campaigns", req.pathParams);
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 201:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.campaignResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Campaigns.prototype.campaignsFetch = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.CampaignsFetchRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/accounts/{accountId}/campaigns/{campaignId}", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        return client
    ...
    **/
    Campaigns.prototype.campaignsFetchAll = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.campaignsResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
    ...
    **/
    Campaigns.prototype.campaignsRemove = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.campaignsRemove200ApplicationJsonObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Campaigns.prototype.campaignsUpdate = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
