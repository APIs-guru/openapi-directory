...
class SingleAPIRequest:
    path_params: SingleAPIPathParams = field(default=None)
...
class SingleAPI200ApplicationJSON:
    api: Optional[SingleAPI200ApplicationJSONAPI] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'api' }})
