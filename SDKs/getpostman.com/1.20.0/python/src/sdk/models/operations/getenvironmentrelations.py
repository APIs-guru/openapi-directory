...
class GetEnvironmentRelationsRequest:
    path_params: GetEnvironmentRelationsPathParams = field(default=None)
...
class GetEnvironmentRelations200ApplicationJSON:
    environment: Optional[List[GetEnvironmentRelations200ApplicationJSONEnvironment]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'environment' }})
