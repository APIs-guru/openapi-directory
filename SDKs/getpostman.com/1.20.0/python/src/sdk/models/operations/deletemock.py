...
class DeleteMock200ApplicationJSON:
    mock: Optional[DeleteMock200ApplicationJSONMock] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('mock') }})
    

@dataclass
class DeleteMockRequest:
    path_params: DeleteMockPathParams = field()
