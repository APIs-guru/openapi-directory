...
class BookingMybookings200ApplicationJSONDataItemSummariesMerchantTermsAndConditions:
    ...
    cancellation_from_tour_date: Optional[List[BookingMybookings200ApplicationJSONDataItemSummariesMerchantTermsAndConditionsCancellationFromTourDate]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('cancellationFromTourDate') }})
...
class BookingMybookings200ApplicationJSONDataItemSummaries:
    ...
    merchant_terms_and_conditions: Optional[BookingMybookings200ApplicationJSONDataItemSummariesMerchantTermsAndConditions] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('merchantTermsAndConditions') }})
    ...
    traveller_age_bands: Optional[List[BookingMybookings200ApplicationJSONDataItemSummariesTravellerAgeBands]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('travellerAgeBands') }})
...
class BookingMybookings200ApplicationJSONData:
    ...
    item_summaries: Optional[List[BookingMybookings200ApplicationJSONDataItemSummaries]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('itemSummaries') }})
    itinerary_id: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('itineraryId') }})
    rules_applied: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('rulesApplied') }})
    sort_order: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sortOrder') }})
...
class BookingMybookings200ApplicationJSON:
    data: Optional[BookingMybookings200ApplicationJSONData] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class BookingMybookingsRequest:
    headers: BookingMybookingsHeaders = field()
    query_params: BookingMybookingsQueryParams = field()
