...
class BookingCalculatepriceRequestBodyItems:
    ...
    travellers: Optional[List[BookingCalculatepriceRequestBodyItemsTravellers]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('travellers') }})
...
class BookingCalculatepriceRequestBody:
    ...
    items: Optional[List[BookingCalculatepriceRequestBodyItems]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('items') }})
...
class BookingCalculateprice200ApplicationJSONDataItineraryItemSummaries:
    ...
    pickup_hotel_id: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('pickupHotelId') }})
    ...
    rules_applied: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('rulesApplied') }})
    ...
    travel_date: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('travelDate') }})
    traveller_age_bands: Optional[List[BookingCalculateprice200ApplicationJSONDataItineraryItemSummariesTravellerAgeBands]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('travellerAgeBands') }})
...
class BookingCalculateprice200ApplicationJSONDataItinerary:
    ...
    **summary results** for all itinerary items
    ...
    item_summaries: Optional[List[BookingCalculateprice200ApplicationJSONDataItineraryItemSummaries]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('itemSummaries') }})
    itinerary_id: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('itineraryId') }})
    omni_pre_rule_list: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('omniPreRuleList') }})
...
class BookingCalculateprice200ApplicationJSONData:
    currency_code: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('currencyCode') }})
    has_promo_code: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('hasPromoCode') }})
    itinerary: Optional[BookingCalculateprice200ApplicationJSONDataItinerary] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('itinerary') }})
    itinerary_from_price: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('itineraryFromPrice') }})
    itinerary_from_price_formatted: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('itineraryFromPriceFormatted') }})
    itinerary_new_price: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('itineraryNewPrice') }})
    itinerary_new_price_formatted: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('itineraryNewPriceFormatted') }})
    itinerary_saving: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('itinerarySaving') }})
    itinerary_saving_formatted: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('itinerarySavingFormatted') }})
    payment_gateway_info: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('paymentGatewayInfo') }})
    promo_code: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('promoCode') }})
    promo_code_expired: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('promoCodeExpired') }})
    promo_code_valid: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('promoCodeValid') }})
    rules_applied: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('rulesApplied') }})
...
class BookingCalculateprice200ApplicationJSON:
    data: Optional[BookingCalculateprice200ApplicationJSONData] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class BookingCalculatepriceRequest:
    headers: BookingCalculatepriceHeaders = field()
