...
class ProductPhotos200ApplicationJSON:
    data: Optional[List[shared.PhotoObject]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class ProductPhotosRequest:
    headers: ProductPhotosHeaders = field()
    query_params: ProductPhotosQueryParams = field()
