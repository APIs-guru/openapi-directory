...
class BookingAvailabilityTourgradesPricingmatrixRequest:
    headers: BookingAvailabilityTourgradesPricingmatrixHeaders = field(default=None)
...
class BookingAvailabilityTourgradesPricingmatrix200ApplicationJSONDataDatesTourGradesPricingMatrixAgeBandPrices:
    ...
    prices: Optional[List[BookingAvailabilityTourgradesPricingmatrix200ApplicationJSONDataDatesTourGradesPricingMatrixAgeBandPricesPrices]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'prices' }})
    sort_order: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'sortOrder' }})
...
class BookingAvailabilityTourgradesPricingmatrix200ApplicationJSONDataDatesTourGradesPricingMatrix:
    age_band_prices: Optional[List[BookingAvailabilityTourgradesPricingmatrix200ApplicationJSONDataDatesTourGradesPricingMatrixAgeBandPrices]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ageBandPrices' }})
...
class BookingAvailabilityTourgradesPricingmatrix200ApplicationJSONDataDatesTourGrades:
    ...
    pricing_matrix: Optional[List[BookingAvailabilityTourgradesPricingmatrix200ApplicationJSONDataDatesTourGradesPricingMatrix]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'pricingMatrix' }})
    sort_order: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'sortOrder' }})
...
class BookingAvailabilityTourgradesPricingmatrix200ApplicationJSONDataDates:
    booking_date: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'bookingDate' }})
    call_for_last_min_availability: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'callForLastMinAvailability' }})
    sort_order: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'sortOrder' }})
    tour_grades: Optional[List[BookingAvailabilityTourgradesPricingmatrix200ApplicationJSONDataDatesTourGrades]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'tourGrades' }})
    

@dataclass_json
@dataclass
class BookingAvailabilityTourgradesPricingmatrix200ApplicationJSONData:
    booking_month: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'bookingMonth' }})
    dates: Optional[List[BookingAvailabilityTourgradesPricingmatrix200ApplicationJSONDataDates]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'dates' }})
    pricing_unit: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'pricingUnit' }})
...
class BookingAvailabilityTourgradesPricingmatrix200ApplicationJSON:
    data: Optional[BookingAvailabilityTourgradesPricingmatrix200ApplicationJSONData] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'data' }})
