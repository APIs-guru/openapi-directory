...
class MerchantCancellationRequestBodyCancelItems:
    cancel_code: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('cancelCode') }})
    cancel_description: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('cancelDescription') }})
...
class MerchantCancellationRequestBody:
    cancel_items: Optional[List[MerchantCancellationRequestBodyCancelItems]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('cancelItems') }})
...
class MerchantCancellation200ApplicationJSONDataCancelItems:
    cancellation_response_description: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('cancellationResponseDescription') }})
    cancellation_response_status_code: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('cancellationResponseStatusCode') }})
    distributor_item_ref: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('distributorItemRef') }})
...
class MerchantCancellation200ApplicationJSONData:
    cancel_items: Optional[List[MerchantCancellation200ApplicationJSONDataCancelItems]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('cancelItems') }})
    distributor_ref: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('distributorRef') }})
    itinerary_id: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('itineraryId') }})
...
class MerchantCancellation200ApplicationJSON:
    data: Optional[MerchantCancellation200ApplicationJSONData] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class MerchantCancellation400ApplicationJSON:
    data: Optional[MerchantCancellation400ApplicationJSONData] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
    date_stamp: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('dateStamp') }})
    error_codes: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('errorCodes') }})
    error_message: Optional[List[Any]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('errorMessage') }})
    error_message_text: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('errorMessageText') }})
...
class MerchantCancellationRequest:
    headers: MerchantCancellationHeaders = field()
