...
class BookingPricingmatrix200ApplicationJSONDataAgeBandPrices:
    ...
    prices: Optional[List[BookingPricingmatrix200ApplicationJSONDataAgeBandPricesPrices]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('prices') }})
...
class BookingPricingmatrix200ApplicationJSONData:
    age_band_prices: Optional[List[BookingPricingmatrix200ApplicationJSONDataAgeBandPrices]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ageBandPrices') }})
    booking_date: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('bookingDate') }})
...
class BookingPricingmatrix200ApplicationJSON:
    data: Optional[List[BookingPricingmatrix200ApplicationJSONData]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class BookingPricingmatrixRequest:
    headers: BookingPricingmatrixHeaders = field()
