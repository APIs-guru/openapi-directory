...
type BookingPastbooking200ApplicationJSONDataItemSummariesMerchantTermsAndConditions struct {
	...
	CancellationFromTourDate []BookingPastbooking200ApplicationJSONDataItemSummariesMerchantTermsAndConditionsCancellationFromTourDate `json:"cancellationFromTourDate,omitempty"`
...
type BookingPastbooking200ApplicationJSONDataItemSummaries struct {
	...
	MerchantTermsAndConditions   *BookingPastbooking200ApplicationJSONDataItemSummariesMerchantTermsAndConditions `json:"merchantTermsAndConditions,omitempty"`
	...
	TravellerAgeBands            []BookingPastbooking200ApplicationJSONDataItemSummariesTravellerAgeBands         `json:"travellerAgeBands,omitempty"`
...
type BookingPastbooking200ApplicationJSONData struct {
	...
	ItemSummaries       []BookingPastbooking200ApplicationJSONDataItemSummaries `json:"itemSummaries,omitempty"`
	ItineraryID         *int64                                                  `json:"itineraryId,omitempty"`
	RulesApplied        *string                                                 `json:"rulesApplied,omitempty"`
	SortOrder           *int64                                                  `json:"sortOrder,omitempty"`
