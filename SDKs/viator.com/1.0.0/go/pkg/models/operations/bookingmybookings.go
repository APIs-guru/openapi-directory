...
type BookingMybookings200ApplicationJSONDataItemSummariesMerchantTermsAndConditions struct {
	...
	CancellationFromTourDate []BookingMybookings200ApplicationJSONDataItemSummariesMerchantTermsAndConditionsCancellationFromTourDate `json:"cancellationFromTourDate"`
...
type BookingMybookings200ApplicationJSONDataItemSummaries struct {
	...
	MerchantTermsAndConditions   *BookingMybookings200ApplicationJSONDataItemSummariesMerchantTermsAndConditions `json:"merchantTermsAndConditions"`
	...
	TravellerAgeBands            []BookingMybookings200ApplicationJSONDataItemSummariesTravellerAgeBands         `json:"travellerAgeBands"`
...
type BookingMybookings200ApplicationJSONData struct {
	...
	ItemSummaries       []BookingMybookings200ApplicationJSONDataItemSummaries `json:"itemSummaries"`
	ItineraryID         *int64                                                 `json:"itineraryId"`
	RulesApplied        *string                                                `json:"rulesApplied"`
	SortOrder           *int64                                                 `json:"sortOrder"`
...
type BookingMybookings200ApplicationJSON struct {
	Data             *BookingMybookings200ApplicationJSONData `json:"data"`
