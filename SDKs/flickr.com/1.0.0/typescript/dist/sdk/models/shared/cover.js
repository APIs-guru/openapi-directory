...
var Cover = /** @class */ (function (_super) {
    ...
    ], Cover.prototype, "isfamily", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=isfriend" }),
        __metadata("design:type", Boolean)
    ], Cover.prototype, "isfriend", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ispublic" }),
        __metadata("design:type", Boolean)
    ], Cover.prototype, "ispublic", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=owner" }),
        __metadata("design:type", String)
    ], Cover.prototype, "owner", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=secret" }),
        __metadata("design:type", String)
    ], Cover.prototype, "secret", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=server" }),
        __metadata("design:type", String)
    ], Cover.prototype, "server", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=title" }),
        __metadata("design:type", String)
    ], Cover.prototype, "title", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=y" }),
        __metadata("design:type", String)
    ], Cover.prototype, "y", void 0);
    return Cover;
}(SpeakeasyBase));
export { Cover };
