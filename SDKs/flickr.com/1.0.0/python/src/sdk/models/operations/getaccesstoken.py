...
class GetAccessTokenQueryParams:
    ...
    oauth_token: str = field(metadata={'query_param': { 'field_name': 'oauth_token', 'style': 'form', 'explode': True }})
    oauth_verifier: str = field(metadata={'query_param': { 'field_name': 'oauth_verifier', 'style': 'form', 'explode': True }})
    oauth_version: str = field(metadata={'query_param': { 'field_name': 'oauth_version', 'style': 'form', 'explode': True }})
    

@dataclass
class GetAccessTokenRequest:
    query_params: GetAccessTokenQueryParams = field()
