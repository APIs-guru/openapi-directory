...
class GetPhotostreamContextByID200ApplicationJSON:
    count: Optional[GetPhotostreamContextByID200ApplicationJSONCount] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('count') }})
...
class GetPhotostreamContextByIDRequest:
    query_params: GetPhotostreamContextByIDQueryParams = field()
