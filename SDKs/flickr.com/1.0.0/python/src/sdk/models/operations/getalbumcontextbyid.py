...
class GetAlbumContextByID200ApplicationJSON:
    count: Optional[GetAlbumContextByID200ApplicationJSONCount] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('count') }})
...
class GetAlbumContextByIDRequest:
    query_params: GetAlbumContextByIDQueryParams = field()
