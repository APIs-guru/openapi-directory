...
var UpdateSubscriptionQueryParams = /** @class */ (function (_super) {
    __extends(UpdateSubscriptionQueryParams, _super);
    function UpdateSubscriptionQueryParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=false;name=ff" }),
        __metadata("design:type", Array)
    ], UpdateSubscriptionQueryParams.prototype, "ff", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=lang" }),
        __metadata("design:type", String)
    ], UpdateSubscriptionQueryParams.prototype, "lang", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=planId" }),
        __metadata("design:type", String)
    ], UpdateSubscriptionQueryParams.prototype, "planId", void 0);
    return UpdateSubscriptionQueryParams;
}(SpeakeasyBase));
export { UpdateSubscriptionQueryParams };
...
var UpdateSubscriptionRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", UpdateSubscriptionQueryParams)
    ], UpdateSubscriptionRequest.prototype, "queryParams", void 0);
    __decorate([
        SpeakeasyMetadata(),
