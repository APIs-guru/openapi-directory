...
var AccountDevices = /** @class */ (function (_super) {
    __extends(AccountDevices, _super);
    function AccountDevices() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=deregistrationWindow" }),
        __metadata("design:type", DeviceRegistrationWindow)
    ], AccountDevices.prototype, "deregistrationWindow", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=devices", elemType: Device }),
        __metadata("design:type", Array)
    ], AccountDevices.prototype, "devices", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=maxRegistered" }),
        __metadata("design:type", Number)
    ], AccountDevices.prototype, "maxRegistered", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=registrationWindow" }),
        __metadata("design:type", DeviceRegistrationWindow)
    ], AccountDevices.prototype, "registrationWindow", void 0);
