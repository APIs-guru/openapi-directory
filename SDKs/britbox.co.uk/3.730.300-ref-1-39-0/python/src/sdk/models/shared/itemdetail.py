...
class ItemDetail:
    ...
    type: ItemDetailTypeEnum = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('type') }})
    ...
    credits: Optional[List[Credit]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('credits') }})
    ...
    custom_metadata: Optional[List[ItemCustomMetadata]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('customMetadata') }})
    ...
    episodes: Optional[ItemList] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('episodes') }})
    ...
    genre_paths: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('genrePaths') }})
    ...
    season: Optional[ItemDetail] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('season') }})
    ...
    seasons: Optional[ItemList] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('seasons') }})
    ...
    show: Optional[ItemDetail] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('show') }})
    ...
    total_user_ratings: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('totalUserRatings') }})
    trailers: Optional[List[ItemSummary]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('trailers') }})
