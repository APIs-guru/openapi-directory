...
**/
var MetricDistribution = /** @class */ (function (_super) {
    __extends(MetricDistribution, _super);
    ...
    ], MetricDistribution.prototype, "basis", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=data", elemType: Distribution }),
        __metadata("design:type", Array)
    ], MetricDistribution.prototype, "data", void 0);
    return MetricDistribution;
}(SpeakeasyBase));
export { MetricDistribution };
