...
**/
var EvaluationCycle = /** @class */ (function (_super) {
    __extends(EvaluationCycle, _super);
    function EvaluationCycle() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=endDate" }),
        __metadata("design:type", String)
    ], EvaluationCycle.prototype, "endDate", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=evaluationDate" }),
        __metadata("design:type", String)
    ], EvaluationCycle.prototype, "evaluationDate", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=evaluationType" }),
        __metadata("design:type", String)
    ], EvaluationCycle.prototype, "evaluationType", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=startDate" }),
        __metadata("design:type", String)
    ], EvaluationCycle.prototype, "startDate", void 0);
    return EvaluationCycle;
}(SpeakeasyBase));
export { EvaluationCycle };
