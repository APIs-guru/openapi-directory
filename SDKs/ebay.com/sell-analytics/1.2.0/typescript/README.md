...
import { FindSellerStandardsProfilesRequest, FindSellerStandardsProfilesResponse } from "openapi/src/sdk/models/operations";
import { AxiosError } from "axios";


const sdk = new SDK();
    
const req: FindSellerStandardsProfilesRequest = {
  security: {
    apiAuth: {
...
sdk.sdk.findSellerStandardsProfiles(req).then((res: FindSellerStandardsProfilesResponse | AxiosError) => {
   // handle response
});
```
