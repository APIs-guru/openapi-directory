...
**/
var CreateServiceMetricsTaskRequest = /** @class */ (function (_super) {
    __extends(CreateServiceMetricsTaskRequest, _super);
    function CreateServiceMetricsTaskRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=feedType" }),
        __metadata("design:type", String)
    ], CreateServiceMetricsTaskRequest.prototype, "feedType", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=filterCriteria" }),
        __metadata("design:type", CustomerServiceMetricsFilterCriteria)
    ], CreateServiceMetricsTaskRequest.prototype, "filterCriteria", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=schemaVersion" }),
        __metadata("design:type", String)
    ], CreateServiceMetricsTaskRequest.prototype, "schemaVersion", void 0);
    return CreateServiceMetricsTaskRequest;
}(SpeakeasyBase));
export { CreateServiceMetricsTaskRequest };
