...
**/
var MarketingRecommendation = /** @class */ (function (_super) {
    __extends(MarketingRecommendation, _super);
    function MarketingRecommendation() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "json, name=ad" }),
        __metadata("design:type", Ad)
    ], MarketingRecommendation.prototype, "ad", void 0);
    __decorate([
        Metadata({ data: "json, name=message" }),
        __metadata("design:type", String)
    ], MarketingRecommendation.prototype, "message", void 0);
    return MarketingRecommendation;
}(SpeakeasyBase));
export { MarketingRecommendation };
