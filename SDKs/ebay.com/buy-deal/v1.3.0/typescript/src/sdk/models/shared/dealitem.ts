...
export class DealItem extends SpeakeasyBase {
  ...
  @Metadata({ data: "json, name=commissionable" })
  commissionable?: boolean;

  @Metadata({ data: "json, name=dealAffiliateWebUrl" })
  dealAffiliateWebUrl?: string;

  @Metadata({ data: "json, name=dealEndDate" })
  dealEndDate?: string;

  @Metadata({ data: "json, name=dealStartDate" })
  dealStartDate?: string;

  @Metadata({ data: "json, name=dealWebUrl" })
  dealWebUrl?: string;
