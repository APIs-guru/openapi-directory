...
import { AcceptPaymentDisputeRequest, AcceptPaymentDisputeResponse } from "openapi/src/sdk/models/operations";
import { AxiosError } from "axios";


const sdk = new SDK();
    
const req: AcceptPaymentDisputeRequest = {
  security: {
    apiAuth: {
...
sdk.sdk.acceptPaymentDispute(req).then((res: AcceptPaymentDisputeResponse | AxiosError) => {
   // handle response
});
```
