...
**/
var EbayFulfillmentProgram = /** @class */ (function (_super) {
    __extends(EbayFulfillmentProgram, _super);
    function EbayFulfillmentProgram() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=fulfilledBy" }),
        __metadata("design:type", String)
    ], EbayFulfillmentProgram.prototype, "fulfilledBy", void 0);
    return EbayFulfillmentProgram;
}(SpeakeasyBase));
export { EbayFulfillmentProgram };
