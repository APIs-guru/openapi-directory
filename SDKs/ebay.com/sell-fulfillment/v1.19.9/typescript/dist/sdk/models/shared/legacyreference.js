...
**/
var LegacyReference = /** @class */ (function (_super) {
    __extends(LegacyReference, _super);
    ...
    ], LegacyReference.prototype, "legacyItemId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=legacyTransactionId" }),
        __metadata("design:type", String)
    ], LegacyReference.prototype, "legacyTransactionId", void 0);
    return LegacyReference;
}(SpeakeasyBase));
export { LegacyReference };
