...
class SDK:
    ...
    def delete_return_policy(self, request: operations.DeleteReturnPolicyRequest) -> operations.DeleteReturnPolicyResponse:
        r"""This method deletes a return policy. Supply the ID of the policy you want to delete in the returnPolicyId path parameter. Note that you cannot delete the default return policy.
        """
    ...
    def get_payments_program(self, request: operations.GetPaymentsProgramRequest) -> operations.GetPaymentsProgramResponse:
        r"""This method returns whether or not the user is opted-in to the specified payments program. Sellers opt-in to payments programs by marketplace and you use the marketplace_id path parameter to specify the marketplace of the status flag you want returned. Note: Currently, the only supported payments program is eBay Payments. For details, see: Managed Payments on eBay Payments Terms of Use
        """
    ...
    def get_privileges(self, request: operations.GetPrivilegesRequest) -> operations.GetPrivilegesResponse:
        r"""This method retrieves the seller's current set of privileges. The call returns whether or not the seller's eBay registration has been completed, as well as the details of their site-wide sellingLimt (the amount and quantity they can sell on a given day).
        """
    ...
    def get_return_policy(self, request: operations.GetReturnPolicyRequest) -> operations.GetReturnPolicyResponse:
        r"""This method retrieves the complete details of the return policy specified by the returnPolicyId path parameter.
        """
    ...
    def get_return_policy_by_name(self, request: operations.GetReturnPolicyByNameRequest) -> operations.GetReturnPolicyByNameResponse:
        r"""This method retrieves the complete details of a single return policy. Supply both the policy name and its associated marketplace_id in the request query parameters. Marketplaces and locales Get the correct policy for a marketplace that supports multiple locales using the Content-Language request header. For example, get a policy for the French locale of the Canadian marketplace by specifying fr-CA for the Content-Language header. Likewise, target the Dutch locale of the Belgium marketplace by setting Content-Language: nl-BE. For details on header values, see HTTP request headers.
        """
    ...
    def update_return_policy(self, request: operations.UpdateReturnPolicyRequest) -> operations.UpdateReturnPolicyResponse:
        r"""This method updates an existing return policy. Specify the policy you want to update using the return_policy_id path parameter. Supply a complete policy payload with the updates you want to make; this call overwrites the existing policy with the new details specified in the payload.
        """
