...
var GetPrivilegesSecurity = /** @class */ (function (_super) {
    __extends(GetPrivilegesSecurity, _super);
    function GetPrivilegesSecurity() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "security, scheme=true;type=oauth2" }),
        __metadata("design:type", shared.SchemeApiAuth)
    ], GetPrivilegesSecurity.prototype, "apiAuth", void 0);
    return GetPrivilegesSecurity;
}(SpeakeasyBase));
export { GetPrivilegesSecurity };
var GetPrivilegesRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", GetPrivilegesSecurity)
    ], GetPrivilegesRequest.prototype, "security", void 0);
