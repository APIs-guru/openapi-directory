...
export class ShippingService extends SpeakeasyBase {
  @Metadata({ data: "json, name=additionalShippingCost" })
  additionalShippingCost?: Amount;

  @Metadata({ data: "json, name=buyerResponsibleForPickup" })
  buyerResponsibleForPickup?: boolean;

  @Metadata({ data: "json, name=buyerResponsibleForShipping" })
  buyerResponsibleForShipping?: boolean;

  @Metadata({ data: "json, name=cashOnDeliveryFee" })
  cashOnDeliveryFee?: Amount;

  @Metadata({ data: "json, name=freeShipping" })
  ...
  @Metadata({ data: "json, name=surcharge" })
  surcharge?: Amount;
}
