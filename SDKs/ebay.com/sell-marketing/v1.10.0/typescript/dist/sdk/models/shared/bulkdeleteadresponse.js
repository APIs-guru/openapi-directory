...
**/
var BulkDeleteAdResponse = /** @class */ (function (_super) {
    __extends(BulkDeleteAdResponse, _super);
    function BulkDeleteAdResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=responses", elemType: DeleteAdResponse }),
        __metadata("design:type", Array)
    ], BulkDeleteAdResponse.prototype, "responses", void 0);
    return BulkDeleteAdResponse;
}(SpeakeasyBase));
export { BulkDeleteAdResponse };
