...
var ReturnPolicy = /** @class */ (function (_super) {
    ...
    ], ReturnPolicy.prototype, "categoryId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=categoryTreeId" }),
        __metadata("design:type", String)
    ], ReturnPolicy.prototype, "categoryTreeId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=domestic" }),
        __metadata("design:type", ReturnPolicyDetails)
    ], ReturnPolicy.prototype, "domestic", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=international" }),
        __metadata("design:type", ReturnPolicyDetails)
    ], ReturnPolicy.prototype, "international", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=required" }),
        __metadata("design:type", Boolean)
    ], ReturnPolicy.prototype, "required", void 0);
    return ReturnPolicy;
}(SpeakeasyBase));
export { ReturnPolicy };
