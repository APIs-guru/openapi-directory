  ...
  getBuild(
    ...
    return client
      .request({
        ...
        const res: operations.GetBuildResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  getBuildProjectName(
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetBuildProjectNameResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/xml; charset=utf-8`)) {
                const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  getBuildProjectNameRepositoryName(
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetBuildProjectNameRepositoryNameResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/xml; charset=utf-8`)) {
                const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  getBuildProjectNameRepositoryNameArchitectureNameBuilddepinfo(
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetBuildProjectNameRepositoryNameArchitectureNameBuilddepinfoResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/xml; charset=utf-8`)) {
                const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  getBuildProjectNameRepositoryNameArchitectureNamePackageName(
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetBuildProjectNameRepositoryNameArchitectureNamePackageNameResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/xml; charset=utf-8`)) {
                const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  getBuildProjectNameRepositoryNameArchitectureNamePackageNameJobstatus(
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetBuildProjectNameRepositoryNameArchitectureNamePackageNameJobstatusResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/xml; charset=utf-8`)) {
                const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  getBuildProjectNameRepositoryNameArchitectureNamePackageNameReason(
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetBuildProjectNameRepositoryNameArchitectureNamePackageNameReasonResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/xml; charset=utf-8`)) {
                const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  getBuildProjectNameRepositoryNameArchitectureNameRepository(
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetBuildProjectNameRepositoryNameArchitectureNameRepositoryResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/xml; charset=utf-8`)) {
                const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  getBuildProjectNameRepositoryNameBuildconfig(
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetBuildProjectNameRepositoryNameBuildconfigResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            break;
          case httpRes?.status == 401:
  ...
  getBuildProjectNameResult(
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetBuildProjectNameResultResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/xml; charset=utf-8`)) {
                const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  postBuildProjectName(
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostBuildProjectNameResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/xml; charset=utf-8`)) {
                const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  getBuildProjectRepositoryArchPackageBuildinfo(
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetBuildProjectRepositoryArchPackageBuildinfoResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/xml; charset=utf-8`)) {
                const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  getBuildProjectRepositoryArchPackageHistory(
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetBuildProjectRepositoryArchPackageHistoryResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/xml; charset=utf-8`)) {
                const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  getBuildProjectRepositoryArchPackageLog(
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetBuildProjectRepositoryArchPackageLogResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            break;
          case httpRes?.status == 401:
  ...
  getBuildProjectRepositoryArchPackageStatus(
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetBuildProjectRepositoryArchPackageStatusResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/xml; charset=utf-8`)) {
                const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  getBuildProjectRepositoryArchitecturePackageFile(
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetBuildProjectRepositoryArchitecturePackageFileResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
  ...
  getBuildProjectRepositoryArchitecturePackageFileViewFileinfo(
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.GetBuildProjectRepositoryArchitecturePackageFileViewFileinfoResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/xml; charset=utf-8`)) {
                const resBody: string = JSON.stringify(httpRes?.data, null, 0);
  ...
  putBuildProjectRepositoryArchitecturePackageFile(
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PutBuildProjectRepositoryArchitecturePackageFileResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/xml; charset=utf-8`)) {
                const resBody: string = JSON.stringify(httpRes?.data, null, 0);
