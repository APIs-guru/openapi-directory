...
export class GetBuildProjectRepositoryArchPackageStatusPathParams extends SpeakeasyBase {
...
export class GetBuildProjectRepositoryArchPackageStatusSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "security, scheme=true;type=http;subtype=basic" })
  basicAuthentication: shared.SchemeBasicAuthentication;
}


export class GetBuildProjectRepositoryArchPackageStatusRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetBuildProjectRepositoryArchPackageStatusResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  body?: Uint8Array;
