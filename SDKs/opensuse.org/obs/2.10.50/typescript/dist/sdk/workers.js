...
var Workers = /** @class */ (function () {
     ...
     *
    **/
    Workers.prototype.getWorkerArchitectureNameWorkerId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetWorkerArchitectureNameWorkerIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/worker/{architecture_name}:{worker_id}", req.pathParams);
     ...
     *
    **/
    Workers.prototype.getWorkerStatus = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetWorkerStatusRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/worker/status";
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
     ...
     *
    **/
    Workers.prototype.postWorkerCmdEqualCheckconstraints = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostWorkerCmdEqualCheckconstraintsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/worker?cmd=checkconstraints";
