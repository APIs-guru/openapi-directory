...
var GeneralInformation = /** @class */ (function () {
    function GeneralInformation(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    GeneralInformation.prototype.getAbout = function (config) {
     ...
     *
    **/
    GeneralInformation.prototype.getArchitectures = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetArchitecturesRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/architectures";
    ...
    **/
    GeneralInformation.prototype.getArchitecturesArchitectureName = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetArchitecturesArchitectureNameRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/architectures/{architecture_name}", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
