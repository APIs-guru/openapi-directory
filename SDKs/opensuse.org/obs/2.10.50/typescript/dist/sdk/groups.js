...
var Groups = /** @class */ (function () {
     ...
     * Delete a group.
    **/
    Groups.prototype.deleteGroupGroupTitle = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteGroupGroupTitleRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/group/{group_title}", req.pathParams);
    ...
    **/
     ...
     * Read group data.
    **/
    Groups.prototype.getGroupGroupTitle = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Modify group data.
    **/
    Groups.prototype.postGroupGroupTitle = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Write group data.
    **/
    Groups.prototype.putGroupGroupTitle = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
