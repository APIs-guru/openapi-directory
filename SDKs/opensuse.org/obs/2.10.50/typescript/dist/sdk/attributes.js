...
var Attributes = /** @class */ (function () {
     ...
     *
    **/
    Attributes.prototype.deleteAttributeNamespaceAttributeName = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteAttributeNamespaceAttributeNameRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/attribute/{namespace}/{attribute_name}", req.pathParams);
     ...
     *
    **/
    Attributes.prototype.deleteAttributeNamespaceAttributeNameMeta = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteAttributeNamespaceAttributeNameMetaRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/attribute/{namespace}/{attribute_name}/_meta", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        return client
            .request(__assign({ url: url, method: "delete" }, config)).then(function (httpRes) {
            var _a, _b;
     ...
     * Shows attribute.
    **/
    Attributes.prototype.getAttributeNamespaceAttributeNameMeta = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Attributes.prototype.postAttributeNamespaceAttributeNameMeta = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Attributes.prototype.putAttributeNamespaceAttributeNameMeta = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
