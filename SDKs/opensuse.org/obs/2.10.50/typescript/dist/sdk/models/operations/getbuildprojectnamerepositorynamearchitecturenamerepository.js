...
var GetBuildProjectNameRepositoryNameArchitectureNameRepositoryPathParams = /** @class */ (function (_super) {
    ...
    function GetBuildProjectNameRepositoryNameArchitectureNameRepositoryPathParams() {
...
export { GetBuildProjectNameRepositoryNameArchitectureNameRepositoryPathParams };
var GetBuildProjectNameRepositoryNameArchitectureNameRepositorySecurity = /** @class */ (function (_super) {
    __extends(GetBuildProjectNameRepositoryNameArchitectureNameRepositorySecurity, _super);
    function GetBuildProjectNameRepositoryNameArchitectureNameRepositorySecurity() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
...
export { GetBuildProjectNameRepositoryNameArchitectureNameRepositorySecurity };
var GetBuildProjectNameRepositoryNameArchitectureNameRepositoryRequest = /** @class */ (function (_super) {
    __extends(GetBuildProjectNameRepositoryNameArchitectureNameRepositoryRequest, _super);
    function GetBuildProjectNameRepositoryNameArchitectureNameRepositoryRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata(),
...
export { GetBuildProjectNameRepositoryNameArchitectureNameRepositoryRequest };
var GetBuildProjectNameRepositoryNameArchitectureNameRepositoryResponse = /** @class */ (function (_super) {
    __extends(GetBuildProjectNameRepositoryNameArchitectureNameRepositoryResponse, _super);
    function GetBuildProjectNameRepositoryNameArchitectureNameRepositoryResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata(),
...
export { GetBuildProjectNameRepositoryNameArchitectureNameRepositoryResponse };
