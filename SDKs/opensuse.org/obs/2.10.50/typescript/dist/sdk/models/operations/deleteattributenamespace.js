...
var DeleteAttributeNamespacePathParams = /** @class */ (function (_super) {
    ...
    function DeleteAttributeNamespacePathParams() {
...
export { DeleteAttributeNamespacePathParams };
var DeleteAttributeNamespaceSecurity = /** @class */ (function (_super) {
    __extends(DeleteAttributeNamespaceSecurity, _super);
    function DeleteAttributeNamespaceSecurity() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
...
export { DeleteAttributeNamespaceSecurity };
var DeleteAttributeNamespaceRequest = /** @class */ (function (_super) {
    __extends(DeleteAttributeNamespaceRequest, _super);
    function DeleteAttributeNamespaceRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata(),
...
export { DeleteAttributeNamespaceRequest };
var DeleteAttributeNamespaceResponse = /** @class */ (function (_super) {
    __extends(DeleteAttributeNamespaceResponse, _super);
    function DeleteAttributeNamespaceResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata(),
...
export { DeleteAttributeNamespaceResponse };
