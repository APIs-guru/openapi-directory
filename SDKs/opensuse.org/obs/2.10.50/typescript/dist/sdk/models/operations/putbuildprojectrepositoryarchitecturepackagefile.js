...
(function (PutBuildProjectRepositoryArchitecturePackageFilePackageNameEnum) {
    PutBuildProjectRepositoryArchitecturePackageFilePackageNameEnum["Repository"] = "_repository";
})(PutBuildProjectRepositoryArchitecturePackageFilePackageNameEnum || (PutBuildProjectRepositoryArchitecturePackageFilePackageNameEnum = {}));
var PutBuildProjectRepositoryArchitecturePackageFilePathParams = /** @class */ (function (_super) {
    __extends(PutBuildProjectRepositoryArchitecturePackageFilePathParams, _super);
    function PutBuildProjectRepositoryArchitecturePackageFilePathParams() {
...
export { PutBuildProjectRepositoryArchitecturePackageFilePathParams };
var PutBuildProjectRepositoryArchitecturePackageFileSecurity = /** @class */ (function (_super) {
    __extends(PutBuildProjectRepositoryArchitecturePackageFileSecurity, _super);
    function PutBuildProjectRepositoryArchitecturePackageFileSecurity() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
...
export { PutBuildProjectRepositoryArchitecturePackageFileSecurity };
var PutBuildProjectRepositoryArchitecturePackageFileRequest = /** @class */ (function (_super) {
    __extends(PutBuildProjectRepositoryArchitecturePackageFileRequest, _super);
    function PutBuildProjectRepositoryArchitecturePackageFileRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata(),
...
export { PutBuildProjectRepositoryArchitecturePackageFileRequest };
var PutBuildProjectRepositoryArchitecturePackageFileResponse = /** @class */ (function (_super) {
    __extends(PutBuildProjectRepositoryArchitecturePackageFileResponse, _super);
    function PutBuildProjectRepositoryArchitecturePackageFileResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata(),
...
export { PutBuildProjectRepositoryArchitecturePackageFileResponse };
