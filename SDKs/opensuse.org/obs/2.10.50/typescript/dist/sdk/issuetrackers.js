...
var IssueTrackers = /** @class */ (function () {
    function IssueTrackers(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    IssueTrackers.prototype.deleteIssueTrackersIssueTrackerName = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteIssueTrackersIssueTrackerNameRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/issue_trackers/{issue_tracker_name}", req.pathParams);
    ...
    **/
    IssueTrackers.prototype.getIssueTrackers = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetIssueTrackersRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/issue_trackers";
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        return client
    ...
    **/
    IssueTrackers.prototype.getIssueTrackersIssueTrackerName = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    IssueTrackers.prototype.getIssueTrackersIssueTrackerNameIssuesIssueName = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetIssueTrackersIssueTrackerNameIssuesIssueNameRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/issue_trackers/{issue_tracker_name}/issues/{issue_name}", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
    ...
    **/
    IssueTrackers.prototype.postIssueTrackers = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    IssueTrackers.prototype.putIssueTrackersIssueTrackerName = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
