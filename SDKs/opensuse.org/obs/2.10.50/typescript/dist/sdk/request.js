...
var Request = /** @class */ (function () {
    function Request(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Request.prototype.deleteRequestId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteRequestIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/request/{id}", req.pathParams);
    ...
    **/
    Request.prototype.getRequest = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Request.prototype.getRequestId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Request.prototype.getRequestViewEqualCollection = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetRequestViewEqualCollectionRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/request?view=collection";
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
     ...
     * Create a request
    **/
    Request.prototype.postRequest = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Request.prototype.postRequestId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    Request.prototype.postRequestIdCmdEqualDiff = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostRequestIdCmdEqualDiffRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/request/{id}?cmd=diff", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        var qpSerializer = utils.GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    ...
                    if (utils.MatchContentType(contentType, "text/plain; charset=utf-8")) {
                        res.postRequestIdCmdEqualDiff200TextPlainString = JSON.stringify(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data);
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 401:
                    if (utils.MatchContentType(contentType, "application/xml; charset=utf-8")) {
     ...
     *
    **/
    Request.prototype.putRequestId = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
