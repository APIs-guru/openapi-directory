...
var AttributeNamespaces = /** @class */ (function () {
    function AttributeNamespaces(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
     ...
     *
    **/
    AttributeNamespaces.prototype.deleteAttributeNamespace = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteAttributeNamespaceRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/attribute/{namespace}", req.pathParams);
     ...
     *
    **/
    AttributeNamespaces.prototype.deleteAttributeNamespaceMeta = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteAttributeNamespaceMetaRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/attribute/{namespace}/_meta", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        return client
            .request(__assign({ url: url, method: "delete" }, config)).then(function (httpRes) {
            var _a, _b;
    ...
    **/
    AttributeNamespaces.prototype.getAttribute = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetAttributeRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/attribute";
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        return client
    ...
    **/
    AttributeNamespaces.prototype.getAttributeNamespace = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    AttributeNamespaces.prototype.getAttributeNamespaceMeta = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    AttributeNamespaces.prototype.postAttributeNamespaceMeta = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     *
    **/
    AttributeNamespaces.prototype.putAttributeNamespaceMeta = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
