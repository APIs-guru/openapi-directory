...
func NewRequest(defaultClient, securityClient HTTPClient, serverURL, language, sdkVersion, genVersion string) *Request {
	return &Request{
...
func (s *Request) DeleteRequestID(ctx context.Context, request operations.DeleteRequestIDRequest) (*operations.DeleteRequestIDResponse, error) {
...
func (s *Request) GetRequestID(ctx context.Context, request operations.GetRequestIDRequest) (*operations.GetRequestIDResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/request/{id}", request.PathParams)
...
// * `types`
// * `ids`
func (s *Request) GetRequestViewEqualCollection(ctx context.Context, request operations.GetRequestViewEqualCollectionRequest) (*operations.GetRequestViewEqualCollectionResponse, error) {
	baseURL := s._serverURL
...
// Create a request
func (s *Request) PostRequest(ctx context.Context, request operations.PostRequestRequest) (*operations.PostRequestResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/request"
...
func (s *Request) PostRequestID(ctx context.Context, request operations.PostRequestIDRequest) (*operations.PostRequestIDResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/request/{id}", request.PathParams)
...
func (s *Request) PostRequestIDCmdEqualDiff(ctx context.Context, request operations.PostRequestIDCmdEqualDiffRequest) (*operations.PostRequestIDCmdEqualDiffResponse, error) {
	baseURL := s._serverURL
...
func (s *Request) PutRequestID(ctx context.Context, request operations.PutRequestIDRequest) (*operations.PutRequestIDResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/request/{id}", request.PathParams)
