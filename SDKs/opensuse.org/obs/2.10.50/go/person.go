...
func (s *Person) DeletePersonLoginTokenID(ctx context.Context, request operations.DeletePersonLoginTokenIDRequest) (*operations.DeletePersonLoginTokenIDResponse, error) {
...
// List all people.
func (s *Person) GetPerson(ctx context.Context, request operations.GetPersonRequest) (*operations.GetPersonResponse, error) {
	baseURL := s._serverURL
...
func (s *Person) GetPersonLogin(ctx context.Context, request operations.GetPersonLoginRequest) (*operations.GetPersonLoginResponse, error) {
	baseURL := s._serverURL
...
func (s *Person) GetPersonLoginGroup(ctx context.Context, request operations.GetPersonLoginGroupRequest) (*operations.GetPersonLoginGroupResponse, error) {
	baseURL := s._serverURL
...
func (s *Person) GetPersonLoginToken(ctx context.Context, request operations.GetPersonLoginTokenRequest) (*operations.GetPersonLoginTokenResponse, error) {
	baseURL := s._serverURL
...
func (s *Person) PostPerson(ctx context.Context, request operations.PostPersonRequest) (*operations.PostPersonResponse, error) {
	baseURL := s._serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/person"
...
func (s *Person) PostPersonLogin(ctx context.Context, request operations.PostPersonLoginRequest) (*operations.PostPersonLoginResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/person/{login}", request.PathParams)
...
func (s *Person) PostPersonLoginToken(ctx context.Context, request operations.PostPersonLoginTokenRequest) (*operations.PostPersonLoginTokenResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/person/{login}/token", request.PathParams)
...
func (s *Person) PostPersonRegister(ctx context.Context, request operations.PostPersonRegisterRequest) (*operations.PostPersonRegisterResponse, error) {
	baseURL := s._serverURL
...
func (s *Person) PutPersonLogin(ctx context.Context, request operations.PutPersonLoginRequest) (*operations.PutPersonLoginResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/person/{login}", request.PathParams)
