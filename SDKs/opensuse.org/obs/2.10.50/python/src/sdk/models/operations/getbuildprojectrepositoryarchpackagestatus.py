...
@dataclass
class GetBuildProjectRepositoryArchPackageStatusPathParams:
...
@dataclass
class GetBuildProjectRepositoryArchPackageStatusSecurity:
    basic_authentication: shared.SchemeBasicAuthentication = field(default=None, metadata={'security': { 'scheme': True, 'type': 'http', 'sub_type': 'basic' }})
    

@dataclass
class GetBuildProjectRepositoryArchPackageStatusRequest:
    path_params: GetBuildProjectRepositoryArchPackageStatusPathParams = field(default=None)
    security: GetBuildProjectRepositoryArchPackageStatusSecurity = field(default=None)
    

@dataclass
class GetBuildProjectRepositoryArchPackageStatusResponse:
