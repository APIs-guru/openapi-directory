...
class GetBuildProjectNameRepositoryNameArchitectureNamePackageNameJobstatusRequest:
    path_params: GetBuildProjectNameRepositoryNameArchitectureNamePackageNameJobstatusPathParams = field()
    security: GetBuildProjectNameRepositoryNameArchitectureNamePackageNameJobstatusSecurity = field()
