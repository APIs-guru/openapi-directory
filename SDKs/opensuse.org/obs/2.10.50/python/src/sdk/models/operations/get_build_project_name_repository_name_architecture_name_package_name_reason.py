...
class GetBuildProjectNameRepositoryNameArchitectureNamePackageNameReasonRequest:
    path_params: GetBuildProjectNameRepositoryNameArchitectureNamePackageNameReasonPathParams = field()
    security: GetBuildProjectNameRepositoryNameArchitectureNamePackageNameReasonSecurity = field()
