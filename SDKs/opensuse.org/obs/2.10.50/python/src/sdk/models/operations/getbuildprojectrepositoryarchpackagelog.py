...
@dataclass
class GetBuildProjectRepositoryArchPackageLogPathParams:
...
@dataclass
class GetBuildProjectRepositoryArchPackageLogSecurity:
    basic_authentication: shared.SchemeBasicAuthentication = field(default=None, metadata={'security': { 'scheme': True, 'type': 'http', 'sub_type': 'basic' }})
    

@dataclass
class GetBuildProjectRepositoryArchPackageLogRequest:
    path_params: GetBuildProjectRepositoryArchPackageLogPathParams = field(default=None)
    security: GetBuildProjectRepositoryArchPackageLogSecurity = field(default=None)
    

@dataclass
class GetBuildProjectRepositoryArchPackageLogResponse:
