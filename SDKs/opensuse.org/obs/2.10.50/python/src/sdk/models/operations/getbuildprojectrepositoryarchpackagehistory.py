...
class GetBuildProjectRepositoryArchPackageHistoryRequest:
    path_params: GetBuildProjectRepositoryArchPackageHistoryPathParams = field(default=None)
    security: GetBuildProjectRepositoryArchPackageHistorySecurity = field(default=None)
