...
class PostRequestIDRequest:
    path_params: PostRequestIDPathParams = field(default=None)
    query_params: PostRequestIDQueryParams = field(default=None)
    security: PostRequestIDSecurity = field(default=None)
