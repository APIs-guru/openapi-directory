 ...
 *
**/
var UserDefinedField = /** @class */ (function (_super) {
    __extends(UserDefinedField, _super);
    ...
    ], UserDefinedField.prototype, "default", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=example" }),
        __metadata("design:type", String)
    ], UserDefinedField.prototype, "example", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=label" }),
        __metadata("design:type", String)
    ], UserDefinedField.prototype, "label", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=manyOf" }),
        __metadata("design:type", String)
    ], UserDefinedField.prototype, "manyOf", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=name" }),
        __metadata("design:type", String)
    ], UserDefinedField.prototype, "name", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=oneOf" }),
        __metadata("design:type", String)
    ], UserDefinedField.prototype, "oneOf", void 0);
