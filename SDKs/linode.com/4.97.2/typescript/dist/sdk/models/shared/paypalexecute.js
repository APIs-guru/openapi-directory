 ...
 *
**/
var PayPalExecute = /** @class */ (function (_super) {
    __extends(PayPalExecute, _super);
    ...
    ], PayPalExecute.prototype, "payerId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=payment_id" }),
        __metadata("design:type", String)
    ], PayPalExecute.prototype, "paymentId", void 0);
    return PayPalExecute;
}(SpeakeasyBase));
export { PayPalExecute };
