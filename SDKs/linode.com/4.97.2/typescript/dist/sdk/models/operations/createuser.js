...
var CreateUserSecurity = /** @class */ (function (_super) {
    ...
    ], CreateUserSecurity.prototype, "personalAccessToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "security, scheme=true;type=oauth2" }),
        __metadata("design:type", shared.SchemeOauth)
    ], CreateUserSecurity.prototype, "oauth", void 0);
    return CreateUserSecurity;
}(SpeakeasyBase));
export { CreateUserSecurity };
var CreateUserDefaultApplicationJson = /** @class */ (function (_super) {
    __extends(CreateUserDefaultApplicationJson, _super);
    function CreateUserDefaultApplicationJson() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=errors", elemType: shared.ErrorObject }),
        __metadata("design:type", Array)
    ], CreateUserDefaultApplicationJson.prototype, "errors", void 0);
    return CreateUserDefaultApplicationJson;
}(SpeakeasyBase));
export { CreateUserDefaultApplicationJson };
...
var CreateUserResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", CreateUserDefaultApplicationJson)
    ], CreateUserResponse.prototype, "createUserDefaultApplicationJsonObject", void 0);
