...
var GetUserPathParams = /** @class */ (function (_super) {
    ...
    ], GetUserPathParams.prototype, "username", void 0);
...
var GetUserSecurity = /** @class */ (function (_super) {
    ...
    ], GetUserSecurity.prototype, "personalAccessToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "security, scheme=true;type=oauth2" }),
        __metadata("design:type", shared.SchemeOauth)
    ], GetUserSecurity.prototype, "oauth", void 0);
    return GetUserSecurity;
}(SpeakeasyBase));
export { GetUserSecurity };
var GetUserDefaultApplicationJson = /** @class */ (function (_super) {
    __extends(GetUserDefaultApplicationJson, _super);
    function GetUserDefaultApplicationJson() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=errors", elemType: shared.ErrorObject }),
        __metadata("design:type", Array)
    ], GetUserDefaultApplicationJson.prototype, "errors", void 0);
    return GetUserDefaultApplicationJson;
}(SpeakeasyBase));
export { GetUserDefaultApplicationJson };
...
var GetUserResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", GetUserDefaultApplicationJson)
    ], GetUserResponse.prototype, "getUserDefaultApplicationJsonObject", void 0);
