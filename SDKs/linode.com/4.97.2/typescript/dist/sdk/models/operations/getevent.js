...
var GetEventSecurity = /** @class */ (function (_super) {
    ...
    ], GetEventSecurity.prototype, "personalAccessToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "security, scheme=true;type=oauth2" }),
        __metadata("design:type", shared.SchemeOauth)
    ], GetEventSecurity.prototype, "oauth", void 0);
    return GetEventSecurity;
}(SpeakeasyBase));
export { GetEventSecurity };
var GetEventDefaultApplicationJson = /** @class */ (function (_super) {
    __extends(GetEventDefaultApplicationJson, _super);
    function GetEventDefaultApplicationJson() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=errors", elemType: shared.ErrorObject }),
        __metadata("design:type", Array)
    ], GetEventDefaultApplicationJson.prototype, "errors", void 0);
    return GetEventDefaultApplicationJson;
}(SpeakeasyBase));
export { GetEventDefaultApplicationJson };
...
var GetEventResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", GetEventDefaultApplicationJson)
    ], GetEventResponse.prototype, "getEventDefaultApplicationJsonObject", void 0);
