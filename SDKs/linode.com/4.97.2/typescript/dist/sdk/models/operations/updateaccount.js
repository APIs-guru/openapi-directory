...
var UpdateAccountSecurity = /** @class */ (function (_super) {
    ...
    ], UpdateAccountSecurity.prototype, "personalAccessToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "security, scheme=true;type=oauth2" }),
        __metadata("design:type", shared.SchemeOauth)
    ], UpdateAccountSecurity.prototype, "oauth", void 0);
    return UpdateAccountSecurity;
}(SpeakeasyBase));
export { UpdateAccountSecurity };
var UpdateAccountDefaultApplicationJson = /** @class */ (function (_super) {
    __extends(UpdateAccountDefaultApplicationJson, _super);
    function UpdateAccountDefaultApplicationJson() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=errors", elemType: shared.ErrorObject }),
        __metadata("design:type", Array)
    ], UpdateAccountDefaultApplicationJson.prototype, "errors", void 0);
    return UpdateAccountDefaultApplicationJson;
}(SpeakeasyBase));
export { UpdateAccountDefaultApplicationJson };
...
var UpdateAccountResponse = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", UpdateAccountDefaultApplicationJson)
    ], UpdateAccountResponse.prototype, "updateAccountDefaultApplicationJsonObject", void 0);
