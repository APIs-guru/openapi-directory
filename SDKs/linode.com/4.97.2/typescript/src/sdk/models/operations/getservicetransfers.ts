...
export class GetServiceTransfersSecurityOption1 extends SpeakeasyBase {
  @Metadata({ data: "security, scheme=true;type=http;subtype=bearer" })
  personalAccessToken: shared.SchemePersonalAccessToken;
}


export class GetServiceTransfersSecurityOption2 extends SpeakeasyBase {
...
export class GetServiceTransfersSecurity extends SpeakeasyBase {
  ...
  option1?: GetServiceTransfersSecurityOption1;

  @Metadata({ data: "security, option=true" })
  option2?: GetServiceTransfersSecurityOption2;
}
...
export class GetServiceTransfers200ApplicationJson extends SpeakeasyBase {
  @Metadata({ data: "json, name=data", elemType: shared.ServiceTransfer })
