...
class GetProfileApps200ApplicationJSON:
    data: Optional[List[shared.AuthorizedApp]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class GetProfileAppsRequest:
    query_params: GetProfileAppsQueryParams = field()
    security: GetProfileAppsSecurity = field()
