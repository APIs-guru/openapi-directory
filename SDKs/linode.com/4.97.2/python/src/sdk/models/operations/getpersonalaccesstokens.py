...
class GetPersonalAccessTokens200ApplicationJSON:
    data: Optional[List[shared.PersonalAccessToken]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class GetPersonalAccessTokensRequest:
    security: GetPersonalAccessTokensSecurity = field()
