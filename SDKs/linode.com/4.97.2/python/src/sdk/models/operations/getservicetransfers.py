...
class GetServiceTransfers200ApplicationJSON:
    data: Optional[List[shared.ServiceTransfer]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class GetServiceTransfersRequest:
    query_params: GetServiceTransfersQueryParams = field()
    security: GetServiceTransfersSecurity = field()
