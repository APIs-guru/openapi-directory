...
class UpdateSSHKeyRequest:
    path_params: UpdateSSHKeyPathParams = field()
    request: shared.SSHKeyInput = field(metadata={'request': { 'media_type': 'application/json' }})
    security: UpdateSSHKeySecurity = field()
