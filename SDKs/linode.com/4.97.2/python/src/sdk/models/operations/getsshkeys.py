...
@dataclass
class GetSSHKeysSecurityOption1:
    personal_access_token: shared.SchemePersonalAccessToken = field(default=None, metadata={'security': { 'scheme': True, 'type': 'http', 'sub_type': 'bearer' }})
    

@dataclass
class GetSSHKeysSecurityOption2:
    oauth: shared.SchemeOauth = field(default=None, metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclass
class GetSSHKeysSecurity:
    option1: Optional[GetSSHKeysSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[GetSSHKeysSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class GetSSHKeysRequest:
    query_params: GetSSHKeysQueryParams = field(default=None)
    security: GetSSHKeysSecurity = field(default=None)
    

@dataclass_json
@dataclass
class GetSSHKeys200ApplicationJSON:
    data: Optional[List[shared.SSHKey]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'data' }})
