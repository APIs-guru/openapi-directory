...
class GetInvoiceItems200ApplicationJSON:
    data: Optional[List[shared.InvoiceItem]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class GetInvoiceItemsRequest:
    path_params: GetInvoiceItemsPathParams = field()
    query_params: GetInvoiceItemsQueryParams = field()
    security: GetInvoiceItemsSecurity = field()
