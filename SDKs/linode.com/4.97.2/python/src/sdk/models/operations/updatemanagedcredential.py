...
class UpdateManagedCredentialRequest:
    path_params: UpdateManagedCredentialPathParams = field()
    request: shared.ManagedCredentialInput = field(metadata={'request': { 'media_type': 'application/json' }})
    security: UpdateManagedCredentialSecurity = field()
