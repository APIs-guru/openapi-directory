...
class GetManagedIssuePathParams:
    issue_id: int = field(metadata={'path_param': { 'field_name': 'issueId', 'style': 'simple', 'explode': False }})
...
class GetManagedIssueRequest:
    path_params: GetManagedIssuePathParams = field()
    security: GetManagedIssueSecurity = field()
