...
class GetNodeBalancers200ApplicationJSON:
    data: Optional[List[shared.NodeBalancer]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class GetNodeBalancersRequest:
    query_params: GetNodeBalancersQueryParams = field()
    security: GetNodeBalancersSecurity = field()
