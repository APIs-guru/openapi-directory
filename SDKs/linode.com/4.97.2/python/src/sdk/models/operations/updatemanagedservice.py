...
class UpdateManagedServiceRequest:
    path_params: UpdateManagedServicePathParams = field()
    request: shared.ManagedServiceInput = field(metadata={'request': { 'media_type': 'application/json' }})
    security: UpdateManagedServiceSecurity = field()
