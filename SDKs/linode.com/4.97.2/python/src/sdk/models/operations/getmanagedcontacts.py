...
class GetManagedContacts200ApplicationJSON:
    data: Optional[List[shared.ManagedContact]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class GetManagedContactsRequest:
    query_params: GetManagedContactsQueryParams = field()
    security: GetManagedContactsSecurity = field()
