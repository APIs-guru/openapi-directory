...
class GetLkeClusters200ApplicationJSON:
    data: Optional[List[shared.LkeCluster]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class GetLkeClustersRequest:
    security: GetLkeClustersSecurity = field()
