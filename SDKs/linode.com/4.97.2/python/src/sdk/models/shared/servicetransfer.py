...
class ServiceTransfer:
    ...
    entities: Optional[ServiceTransferEntities] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'entities' }})
    ...
    status: Optional[ServiceTransferStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
