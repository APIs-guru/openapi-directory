...
class ImagePrivate:
    ...
    status: Optional[ImagePrivateStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
    type: Optional[ImagePrivateTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'type' }})
