...
class EntityTransfer:
    ...
    entities: Optional[EntityTransferEntities] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('entities') }})
    ...
    status: Optional[EntityTransferStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
