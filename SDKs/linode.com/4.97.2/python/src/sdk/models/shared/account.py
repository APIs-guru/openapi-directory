...
class AccountInput:
    ...
    active_promotions: Optional[List[Promotion]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('active_promotions') }})
...
class Account:
    ...
    active_promotions: Optional[List[Promotion]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('active_promotions') }})
    active_since: Optional[datetime] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('active_since'), 'encoder': utils.datetimeisoformat(True), 'decoder': dateutil.parser.isoparse, 'mm_field': fields.DateTime(format='iso') }})
    address_1: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('address_1') }})
    address_2: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('address_2') }})
    balance: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('balance') }})
    balance_uninvoiced: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('balance_uninvoiced') }})
    capabilities: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('capabilities') }})
    city: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('city') }})
    company: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('company') }})
    country: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('country') }})
    credit_card: Optional[AccountCreditCard] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('credit_card') }})
    email: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('email') }})
    euuid: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('euuid') }})
    first_name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('first_name') }})
    last_name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('last_name') }})
    phone: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('phone') }})
    state: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('state') }})
