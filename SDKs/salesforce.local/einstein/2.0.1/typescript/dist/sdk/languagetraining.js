...
var LanguageTraining = /** @class */ (function () {
    function LanguageTraining(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    LanguageTraining.prototype.getTrainStatusAndProgress = function (req, config) {
    ...
    **/
    LanguageTraining.prototype.retrain = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    LanguageTraining.prototype.train = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
