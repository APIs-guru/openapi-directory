...
var LanguageExamples = /** @class */ (function () {
    function LanguageExamples(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    LanguageExamples.prototype.getExamples = function (req, config) {
    ...
    **/
    LanguageExamples.prototype.getExamplesByLabel = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    LanguageExamples.prototype.provideFeedback = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    LanguageExamples.prototype.updateDatasetAsync = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
