...
var VisionPrediction = /** @class */ (function () {
    function VisionPrediction(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    VisionPrediction.prototype.detectMultipart = function (req, config) {
        var _a;
    ...
    **/
    VisionPrediction.prototype.ocrMultipart = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    VisionPrediction.prototype.predictMultipart = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
