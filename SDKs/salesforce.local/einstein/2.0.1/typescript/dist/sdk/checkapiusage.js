...
var CheckApiUsage = /** @class */ (function () {
    function CheckApiUsage(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    CheckApiUsage.prototype.getApiUsagePlansV2 = function (req, config) {
