...
class ContributorActivityWeeks:
    a: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'a' }})
    c: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'c' }})
    d: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'd' }})
    w: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'w' }})
