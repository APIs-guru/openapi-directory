...
class Installation:
    ...
    html_url: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'html_url' }})
    id: int = field(default=None, metadata={'dataclasses_json': { 'field_name': 'id' }})
    permissions: InstallationPermissions = field(default=None, metadata={'dataclasses_json': { 'field_name': 'permissions' }})
    repositories_url: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'repositories_url' }})
    repository_selection: InstallationRepositorySelectionEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'repository_selection' }})
    ...
    suspended_at: datetime = field(default=None, metadata={'dataclasses_json': { 'field_name': 'suspended_at', 'encoder': datetime.isoformat, 'decoder': dateutil.parser.isoparse, 'mm_field': fields.DateTime(format='iso') }})
    suspended_by: InstallationSuspendedBySimpleUser = field(default=None, metadata={'dataclasses_json': { 'field_name': 'suspended_by' }})
