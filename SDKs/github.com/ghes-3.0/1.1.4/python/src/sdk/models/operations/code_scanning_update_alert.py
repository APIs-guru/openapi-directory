...
class CodeScanningUpdateAlertRequestBody:
    ...
    dismissed_reason: Optional[shared.CodeScanningAlertDismissedReasonEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('dismissed_reason') }})
