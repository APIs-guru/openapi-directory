...
class WorkflowRunSimpleCommit:
    author: WorkflowRunSimpleCommitAuthor = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('author') }})
    committer: WorkflowRunSimpleCommitCommitter = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('committer') }})
...
class WorkflowRun:
    ...
    head_commit: WorkflowRunSimpleCommit = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('head_commit') }})
    ...
    check_suite_id: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('check_suite_id') }})
    check_suite_node_id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('check_suite_node_id') }})
