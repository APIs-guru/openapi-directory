...
class ReactionsCreateForIssueRequestBody:
    content: ReactionsCreateForIssueRequestBodyContentEnum = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('content') }})
...
class ReactionsCreateForIssueRequest:
    path_params: ReactionsCreateForIssuePathParams = field()
