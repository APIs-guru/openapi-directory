...
class GistSimpleGist:
    ...
    files: dict[str, GistSimpleGistFiles] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'files' }})
    ...
    node_id: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'node_id' }})
    owner: Optional[GistSimpleGistSimpleUser] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'owner' }})
    ...
    url: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'url' }})
    user: GistSimpleGistSimpleUser = field(default=None, metadata={'dataclasses_json': { 'field_name': 'user' }})
...
class GistSimple:
    ...
    fork_of: Optional[GistSimpleGist] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'fork_of' }})
