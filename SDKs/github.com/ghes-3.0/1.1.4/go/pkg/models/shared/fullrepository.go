...
type FullRepositoryTemplateRepositoryTemplateRepository struct {
	...
	Owner               *FullRepositoryTemplateRepositoryTemplateRepositoryOwner       `json:"owner,omitempty"`
	Permissions         *FullRepositoryTemplateRepositoryTemplateRepositoryPermissions `json:"permissions,omitempty"`
...
type FullRepositoryTemplateRepositoryRepository struct {
	...
	Organization        *FullRepositoryTemplateRepositoryOrganizationSimpleUser `json:"organization,omitempty"`
	Owner               FullRepositoryTemplateRepositoryOwnerSimpleUser         `json:"owner"`
	Permissions         *FullRepositoryTemplateRepositoryPermissions            `json:"permissions,omitempty"`
	...
	TempCloneToken      *string                                                 `json:"temp_clone_token,omitempty"`
	TemplateRepository  *FullRepositoryTemplateRepositoryTemplateRepository     `json:"template_repository,omitempty"`
	Topics              []string                                                `json:"topics,omitempty"`
...
type FullRepository struct {
	...
	OpenIssues             int64                                       `json:"open_issues"`
	OpenIssuesCount        int64                                       `json:"open_issues_count"`
	Organization           *FullRepositoryOrganizationSimpleUser       `json:"organization,omitempty"`
	...
	TeamsURL               string                                      `json:"teams_url"`
	TempCloneToken         *string                                     `json:"temp_clone_token,omitempty"`
	TemplateRepository     *FullRepositoryTemplateRepositoryRepository `json:"template_repository,omitempty"`
	Topics                 []string                                    `json:"topics,omitempty"`
	TreesURL               string                                      `json:"trees_url"`
	UpdatedAt              time.Time                                   `json:"updated_at"`
	URL                    string                                      `json:"url"`
