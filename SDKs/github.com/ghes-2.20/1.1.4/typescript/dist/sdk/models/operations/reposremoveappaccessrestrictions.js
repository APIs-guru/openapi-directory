...
var ReposRemoveAppAccessRestrictionsRequestBody1 = /** @class */ (function (_super) {
    __extends(ReposRemoveAppAccessRestrictionsRequestBody1, _super);
    function ReposRemoveAppAccessRestrictionsRequestBody1() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=apps" }),
        __metadata("design:type", Array)
    ], ReposRemoveAppAccessRestrictionsRequestBody1.prototype, "apps", void 0);
    return ReposRemoveAppAccessRestrictionsRequestBody1;
}(SpeakeasyBase));
export { ReposRemoveAppAccessRestrictionsRequestBody1 };
