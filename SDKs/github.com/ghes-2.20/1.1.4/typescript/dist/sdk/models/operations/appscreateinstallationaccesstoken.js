...
var AppsCreateInstallationAccessTokenHeaders = /** @class */ (function (_super) {
    __extends(AppsCreateInstallationAccessTokenHeaders, _super);
    function AppsCreateInstallationAccessTokenHeaders() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "header, style=simple;explode=false;name=accept" }),
        __metadata("design:type", String)
    ], AppsCreateInstallationAccessTokenHeaders.prototype, "accept", void 0);
    return AppsCreateInstallationAccessTokenHeaders;
}(SpeakeasyBase));
export { AppsCreateInstallationAccessTokenHeaders };
...
var AppsCreateInstallationAccessTokenRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", AppsCreateInstallationAccessTokenHeaders)
    ], AppsCreateInstallationAccessTokenRequest.prototype, "headers", void 0);
    __decorate([
