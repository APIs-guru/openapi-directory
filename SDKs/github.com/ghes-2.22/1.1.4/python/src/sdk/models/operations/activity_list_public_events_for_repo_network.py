...
class ActivityListPublicEventsForRepoNetworkRequest:
    path_params: ActivityListPublicEventsForRepoNetworkPathParams = field(default=None)
    query_params: ActivityListPublicEventsForRepoNetworkQueryParams = field(default=None)
