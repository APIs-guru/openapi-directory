...
class Project:
    ...
    creator: ProjectSimpleUser = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('creator') }})
    html_url: str = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('html_url') }})
    id: int = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('id') }})
    ...
    url: str = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('url') }})
    organization_permission: Optional[ProjectOrganizationPermissionEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('organization_permission') }})
