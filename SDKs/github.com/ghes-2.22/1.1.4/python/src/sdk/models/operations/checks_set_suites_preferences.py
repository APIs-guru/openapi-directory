...
class ChecksSetSuitesPreferencesRequestBody:
    auto_trigger_checks: Optional[List[ChecksSetSuitesPreferencesRequestBodyAutoTriggerChecks]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'auto_trigger_checks' }})
    

@dataclass
class ChecksSetSuitesPreferencesRequest:
    path_params: ChecksSetSuitesPreferencesPathParams = field(default=None)
