...
type PullRequestAssigneeSimpleUser struct {
...
type PullRequestMilestoneCreatorSimpleUser struct {
	AvatarURL         string  `json:"avatar_url"`
	EventsURL         string  `json:"events_url"`
	FollowersURL      string  `json:"followers_url"`
	FollowingURL      string  `json:"following_url"`
...
type PullRequestMilestoneMilestone struct {
	ClosedAt     time.Time                             `json:"closed_at"`
	ClosedIssues int64                                 `json:"closed_issues"`
	CreatedAt    time.Time                             `json:"created_at"`
	Creator      PullRequestMilestoneCreatorSimpleUser `json:"creator"`
	Description  string                                `json:"description"`
...
type PullRequestUserSimpleUser struct {
	AvatarURL         string  `json:"avatar_url"`
	EventsURL         string  `json:"events_url"`
	FollowersURL      string  `json:"followers_url"`
	FollowingURL      string  `json:"following_url"`
...
type PullRequest struct {
	...
	MergedBy            PullRequestMergedBySimpleUser `json:"merged_by"`
	Milestone           PullRequestMilestoneMilestone `json:"milestone"`
	NodeID              string                        `json:"node_id"`
	Number              int64                         `json:"number"`
	...
	UpdatedAt           time.Time                     `json:"updated_at"`
	URL                 string                        `json:"url"`
	User                PullRequestUserSimpleUser     `json:"user"`
}
