...
type PullRequestSimpleAssigneeSimpleUser struct {
...
type PullRequestSimpleBaseUserSimpleUser struct {
	AvatarURL         string  `json:"avatar_url"`
	EventsURL         string  `json:"events_url"`
	FollowersURL      string  `json:"followers_url"`
	FollowingURL      string  `json:"following_url"`
...
type PullRequestSimpleBase struct {
	...
	Sha   string                              `json:"sha"`
	User  PullRequestSimpleBaseUserSimpleUser `json:"user"`
}

type PullRequestSimpleHeadUserSimpleUser struct {
	AvatarURL         string  `json:"avatar_url"`
	EventsURL         string  `json:"events_url"`
	FollowersURL      string  `json:"followers_url"`
	FollowingURL      string  `json:"following_url"`
...
type PullRequestSimpleHead struct {
	...
	Repo  Repository                          `json:"repo"`
	Sha   string                              `json:"sha"`
	User  PullRequestSimpleHeadUserSimpleUser `json:"user"`
}
...
type PullRequestSimpleMilestoneMilestone struct {
	ClosedAt     time.Time                                   `json:"closed_at"`
	ClosedIssues int64                                       `json:"closed_issues"`
	CreatedAt    time.Time                                   `json:"created_at"`
	Creator      PullRequestSimpleMilestoneCreatorSimpleUser `json:"creator"`
...
type PullRequestSimpleUserSimpleUser struct {
	AvatarURL         string  `json:"avatar_url"`
	EventsURL         string  `json:"events_url"`
	FollowersURL      string  `json:"followers_url"`
	FollowingURL      string  `json:"following_url"`
...
type PullRequestSimple struct {
	...
	Milestone          PullRequestSimpleMilestoneMilestone `json:"milestone"`
	NodeID             string                              `json:"node_id"`
	Number             int64                               `json:"number"`
	...
	UpdatedAt          time.Time                           `json:"updated_at"`
	URL                string                              `json:"url"`
	User               PullRequestSimpleUserSimpleUser     `json:"user"`
}
