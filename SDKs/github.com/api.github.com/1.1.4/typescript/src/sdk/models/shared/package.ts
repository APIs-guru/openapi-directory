...
export class PackageMinimalRepositoryLicense extends SpeakeasyBase {
...
export class PackageMinimalRepositoryPermissions extends SpeakeasyBase {
...
export class PackageMinimalRepositoryRepositoryPermissions extends SpeakeasyBase {
  @Metadata({ data: "json, name=admin" })
  admin: boolean;
...
export class PackageMinimalRepositoryRepositoryTemplateRepositoryOwner extends SpeakeasyBase {
  @Metadata({ data: "json, name=avatar_url" })
  avatarUrl?: string;
...
export class PackageMinimalRepositoryRepositoryTemplateRepositoryPermissions extends SpeakeasyBase {
  @Metadata({ data: "json, name=admin" })
  admin?: boolean;
...
export class PackageMinimalRepositoryRepositoryTemplateRepository extends SpeakeasyBase {
...
export class Package extends SpeakeasyBase {
  ...
  @Metadata({ data: "json, name=version_count" })
  versionCount: number;
