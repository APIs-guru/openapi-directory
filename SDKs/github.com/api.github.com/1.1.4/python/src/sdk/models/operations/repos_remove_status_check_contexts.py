...
@dataclass_json
@dataclass
class ReposRemoveStatusCheckContextsRequestBody:
...
class ReposRemoveStatusCheckContextsRequest:
    path_params: ReposRemoveStatusCheckContextsPathParams = field()
    request: Optional[ReposRemoveStatusCheckContextsRequestBody] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
