...
class ReposRemoveTeamAccessRestrictionsRequest:
    path_params: ReposRemoveTeamAccessRestrictionsPathParams = field()
    request: Optional[ReposRemoveTeamAccessRestrictionsRequestBody] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
