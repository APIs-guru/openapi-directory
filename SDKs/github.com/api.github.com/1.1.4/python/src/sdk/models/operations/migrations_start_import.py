...
class MigrationsStartImportRequestBody:
    ...
    vcs: Optional[MigrationsStartImportRequestBodyVcsEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'vcs' }})
...
class MigrationsStartImportRequest:
    path_params: MigrationsStartImportPathParams = field(default=None)
