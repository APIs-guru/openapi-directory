...
class ReposGetAllEnvironmentsRequest:
    path_params: ReposGetAllEnvironmentsPathParams = field(default=None)
    

@dataclass_json
@dataclass
class ReposGetAllEnvironments200ApplicationJSON:
    environments: Optional[List[shared.Environment]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'environments' }})
