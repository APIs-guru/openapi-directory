...
class ApplicationGrant:
    ...
    app: ApplicationGrantApp = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('app') }})
    ...
    url: str = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('url') }})
    user: Optional[ApplicationGrantSimpleUser] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('user') }})
