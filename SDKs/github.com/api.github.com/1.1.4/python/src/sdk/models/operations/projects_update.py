...
class ProjectsUpdateRequestBody:
    ...
    organization_permission: Optional[ProjectsUpdateRequestBodyOrganizationPermissionEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'organization_permission' }})
...
class ProjectsUpdateRequest:
    path_params: ProjectsUpdatePathParams = field(default=None)
