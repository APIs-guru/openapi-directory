...
@dataclass_json
@dataclass
class ReposRemoveAppAccessRestrictionsRequestBody:
...
class ReposRemoveAppAccessRestrictionsRequest:
    ...
    request: Optional[ReposRemoveAppAccessRestrictionsRequestBody] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
