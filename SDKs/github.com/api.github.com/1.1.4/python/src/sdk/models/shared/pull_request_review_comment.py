...
class PullRequestReviewComment:
    ...
    side: Optional[PullRequestReviewCommentSideEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'side' }})
    start_line: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'start_line' }})
    start_side: Optional[PullRequestReviewCommentStartSideEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'start_side' }})
