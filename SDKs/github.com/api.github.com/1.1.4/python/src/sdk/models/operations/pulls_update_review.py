...
class PullsUpdateReviewRequest:
    path_params: PullsUpdateReviewPathParams = field(default=None)
    request: Optional[PullsUpdateReviewRequestBody] = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
