...
@dataclass_json
@dataclass
class RepositoryInvitationInviteeSimpleUser:
...
@dataclass_json
@dataclass
class RepositoryInvitationInviterSimpleUser:
    avatar_url: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'avatar_url' }})
    events_url: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'events_url' }})
    followers_url: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'followers_url' }})
    following_url: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'following_url' }})
...
class RepositoryInvitation:
    ...
    html_url: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'html_url' }})
    id: int = field(default=None, metadata={'dataclasses_json': { 'field_name': 'id' }})
    invitee: RepositoryInvitationInviteeSimpleUser = field(default=None, metadata={'dataclasses_json': { 'field_name': 'invitee' }})
    inviter: RepositoryInvitationInviterSimpleUser = field(default=None, metadata={'dataclasses_json': { 'field_name': 'inviter' }})
    node_id: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'node_id' }})
    permissions: RepositoryInvitationPermissionsEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'permissions' }})
