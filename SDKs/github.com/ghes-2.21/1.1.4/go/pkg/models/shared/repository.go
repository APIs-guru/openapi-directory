...
type RepositoryLicenseLicenseSimple struct {
...
type RepositoryOrganizationSimpleUser struct {
...
type RepositoryOwnerSimpleUser struct {
	AvatarURL         string  `json:"avatar_url"`
	EventsURL         string  `json:"events_url"`
	FollowersURL      string  `json:"followers_url"`
	FollowingURL      string  `json:"following_url"`
...
type Repository struct {
	...
	License                RepositoryLicenseLicenseSimple    `json:"license"`
	...
	Organization           *RepositoryOrganizationSimpleUser `json:"organization,omitempty"`
	Owner                  RepositoryOwnerSimpleUser         `json:"owner"`
