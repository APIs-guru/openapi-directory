...
class PublicUserPlan:
    collaborators: int = field(default=None, metadata={'dataclasses_json': { 'field_name': 'collaborators' }})
...
class PublicUser:
    ...
    blog: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'blog' }})
    ...
    hireable: bool = field(default=None, metadata={'dataclasses_json': { 'field_name': 'hireable' }})
    ...
    plan: Optional[PublicUserPlan] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'plan' }})
