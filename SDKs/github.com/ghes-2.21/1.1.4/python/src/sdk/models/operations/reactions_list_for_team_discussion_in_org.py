...
class ReactionsListForTeamDiscussionInOrgRequest:
    path_params: ReactionsListForTeamDiscussionInOrgPathParams = field(default=None)
    query_params: ReactionsListForTeamDiscussionInOrgQueryParams = field(default=None)
