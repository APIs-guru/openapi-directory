...
export class Git {
   ...
   *
   * https://docs.github.com/enterprise-server@3.1/rest/reference/git#create-a-blob - API method documentation
  **/
  gitCreateBlob(
   ...
   *
   * https://docs.github.com/enterprise-server@3.1/rest/reference/git#create-a-commit - API method documentation
  **/
  gitCreateCommit(
   ...
   *
   * https://docs.github.com/enterprise-server@3.1/rest/reference/git#create-a-reference - API method documentation
  **/
  gitCreateRef(
   ...
   * | `valid` | None of the above errors applied, so the signature is considered to be verified. |
   *
   * https://docs.github.com/enterprise-server@3.1/rest/reference/git#create-a-tag-object - API method documentation
  **/
  gitCreateTag(
   ...
   *
   * https://docs.github.com/enterprise-server@3.1/rest/reference/git#create-a-tree - API method documentation
  **/
  gitCreateTree(
   ...
   *
   * https://docs.github.com/enterprise-server@3.1/rest/reference/git#delete-a-reference - API method documentation
  **/
  gitDeleteRef(
   ...
   *
   * https://docs.github.com/enterprise-server@3.1/rest/reference/git#get-a-blob - API method documentation
  **/
  gitGetBlob(
   ...
   * | `valid` | None of the above errors applied, so the signature is considered to be verified. |
   *
   * https://docs.github.com/enterprise-server@3.1/rest/reference/git#get-a-commit - API method documentation
  **/
  gitGetCommit(
   ...
   *
   * https://docs.github.com/enterprise-server@3.1/rest/reference/git#get-a-reference - API method documentation
  **/
  gitGetRef(
   ...
   * | `valid` | None of the above errors applied, so the signature is considered to be verified. |
   *
   * https://docs.github.com/enterprise-server@3.1/rest/reference/git#get-a-tag - API method documentation
  **/
  gitGetTag(
   ...
   *
   * https://docs.github.com/enterprise-server@3.1/rest/reference/git#get-a-tree - API method documentation
  **/
  gitGetTree(
   ...
   *
   * https://docs.github.com/enterprise-server@3.1/rest/reference/git#list-matching-references - API method documentation
  **/
  gitListMatchingRefs(
   ...
   *
   * https://docs.github.com/enterprise-server@3.1/rest/reference/git#update-a-reference - API method documentation
  **/
  gitUpdateRef(
