...
var Orgs = /** @class */ (function () {
    ...
    **/
     ...
     *
     * Gets the audit log for an organization. For more information, see "[Reviewing the audit log for your organization](https://docs.github.com/enterprise-server@3.1/github/setting-up-and-managing-organizations-and-teams/reviewing-the-audit-log-for-your-organization)."
     *
     * To use this endpoint, you must be an organization owner, and you must use an access token with the `admin:org` scope. GitHub Apps must have the `organization_administration` read permission to use this endpoint.
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/orgs#get-audit-log - API method documentation
    **/
    Orgs.prototype.orgsGetAuditLog = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/orgs/{org}/audit-log", req.pathParams);
        var client = this._defaultClient;
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.auditLogEvents = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Orgs.prototype.orgsGetWebhookConfigForOrg = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/orgs/{org}/hooks/{hook_id}/config", req.pathParams);
        var client = this._defaultClient;
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/orgs#list-organizations - API method documentation
    **/
    ...
    **/
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/orgs#list-organizations-for-the-authenticated-user - API method documentation
    **/
    ...
    **/
     ...
     *
     * https://docs.github.com/enterprise-server@3.1/rest/reference/orgs#list-organization-memberships-for-the-authenticated-user - API method documentation
    **/
