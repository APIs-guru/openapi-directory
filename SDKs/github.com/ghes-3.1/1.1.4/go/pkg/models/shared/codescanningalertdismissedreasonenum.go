...
const (
	CodeScanningAlertDismissedReasonEnumMapDollarRefNumberComponentsSchemasSecretScanningAlertResolutionEnum0 CodeScanningAlertDismissedReasonEnum = "map[$ref:#/components/schemas/secret-scanning-alert-resolution/enum/0]"
