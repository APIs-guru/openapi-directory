...
class ReactionsCreateForPullRequestReviewCommentRequestBody:
    content: ReactionsCreateForPullRequestReviewCommentRequestBodyContentEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'content' }})
    

@dataclass
class ReactionsCreateForPullRequestReviewCommentRequest:
    path_params: ReactionsCreateForPullRequestReviewCommentPathParams = field(default=None)
