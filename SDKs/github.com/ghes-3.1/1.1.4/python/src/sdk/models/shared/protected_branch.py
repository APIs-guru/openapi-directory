...
class ProtectedBranch:
    ...
    required_conversation_resolution: Optional[ProtectedBranchRequiredConversationResolution] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'required_conversation_resolution' }})
