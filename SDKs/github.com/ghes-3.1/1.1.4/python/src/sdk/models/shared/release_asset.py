...
class ReleaseAsset:
    ...
    browser_download_url: str = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('browser_download_url') }})
    ...
    download_count: int = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('download_count') }})
    id: int = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('id') }})
    ...
    state: ReleaseAssetStateEnum = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('state') }})
    ...
    uploader: ReleaseAssetSimpleUser = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('uploader') }})
    url: str = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('url') }})
