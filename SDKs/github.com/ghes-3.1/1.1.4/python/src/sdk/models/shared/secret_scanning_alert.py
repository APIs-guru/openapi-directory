...
from . import secret_scanning_alert_resolution_enum
...
class SecretScanningAlert:
    ...
    resolution: Optional[secret_scanning_alert_resolution_enum.SecretScanningAlertResolutionEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'resolution' }})
