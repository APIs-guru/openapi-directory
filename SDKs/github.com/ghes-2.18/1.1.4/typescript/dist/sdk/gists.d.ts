...
export declare class Gists {
     ...
     *
     * https://docs.github.com/enterprise-server@2.18/rest/reference/gists#check-if-a-gist-is-starred - API method documentation
    **/
     ...
     *
     * https://docs.github.com/enterprise-server@2.18/rest/reference/gists#create-a-gist - API method documentation
    **/
     ...
     *
     * https://docs.github.com/enterprise-server@2.18/rest/reference/gists#create-a-gist-comment - API method documentation
    **/
     ...
     *
     * https://docs.github.com/enterprise-server@2.18/rest/reference/gists#delete-a-gist - API method documentation
    **/
     ...
     *
     * https://docs.github.com/enterprise-server@2.18/rest/reference/gists#delete-a-gist-comment - API method documentation
    **/
     ...
     *
     * https://docs.github.com/enterprise-server@2.18/rest/reference/gists#fork-a-gist - API method documentation
    **/
    gistsFork(req: operations.GistsForkRequest, config?: AxiosRequestConfig): Promise<operations.GistsForkResponse>;
    /**
     * gistsGet - Get a gist
     *
     * https://docs.github.com/enterprise-server@2.18/rest/reference/gists#get-a-gist - API method documentation
    **/
     ...
     *
     * https://docs.github.com/enterprise-server@2.18/rest/reference/gists#get-a-gist-comment - API method documentation
    **/
     ...
     *
     * https://docs.github.com/enterprise-server@2.18/rest/reference/gists#get-a-gist-revision - API method documentation
    **/
     ...
     *
     * https://docs.github.com/enterprise-server@2.18/rest/reference/gists#list-gists-for-the-authenticated-user - API method documentation
    **/
     ...
     *
     * https://docs.github.com/enterprise-server@2.18/rest/reference/gists#list-gist-comments - API method documentation
    **/
     ...
     *
     * https://docs.github.com/enterprise-server@2.18/rest/reference/gists#list-gist-commits - API method documentation
    **/
     ...
     *
     * https://docs.github.com/enterprise-server@2.18/rest/reference/gists#list-gists-for-a-user - API method documentation
    **/
     ...
     *
     * https://docs.github.com/enterprise-server@2.18/rest/reference/gists#list-gist-forks - API method documentation
    **/
     ...
     *
     * https://docs.github.com/enterprise-server@2.18/rest/reference/gists#list-public-gists - API method documentation
    **/
     ...
     *
     * https://docs.github.com/enterprise-server@2.18/rest/reference/gists#list-starred-gists - API method documentation
    **/
     ...
     *
     * https://docs.github.com/enterprise-server@2.18/rest/reference/gists#star-a-gist - API method documentation
    **/
     ...
     *
     * https://docs.github.com/enterprise-server@2.18/rest/reference/gists#unstar-a-gist - API method documentation
    **/
     ...
     *
     * https://docs.github.com/enterprise-server@2.18/rest/reference/gists/#update-a-gist - API method documentation
    **/
     ...
     *
     * https://docs.github.com/enterprise-server@2.18/rest/reference/gists#update-a-gist-comment - API method documentation
    **/
