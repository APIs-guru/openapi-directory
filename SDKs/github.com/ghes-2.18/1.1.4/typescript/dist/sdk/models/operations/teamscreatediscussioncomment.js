...
export { TeamsCreateDiscussionCommentPathParams };
var TeamsCreateDiscussionCommentHeaders = /** @class */ (function (_super) {
    __extends(TeamsCreateDiscussionCommentHeaders, _super);
    function TeamsCreateDiscussionCommentHeaders() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "header, style=simple;explode=false;name=accept" }),
        __metadata("design:type", String)
    ], TeamsCreateDiscussionCommentHeaders.prototype, "accept", void 0);
    return TeamsCreateDiscussionCommentHeaders;
}(SpeakeasyBase));
export { TeamsCreateDiscussionCommentHeaders };
...
export { TeamsCreateDiscussionCommentRequestBody };
var TeamsCreateDiscussionCommentRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", TeamsCreateDiscussionCommentHeaders)
    ], TeamsCreateDiscussionCommentRequest.prototype, "headers", void 0);
    __decorate([
...
export { TeamsCreateDiscussionCommentRequest };
...
export { TeamsCreateDiscussionCommentResponse };
