...
var TeamsDeleteDiscussionCommentHeaders = /** @class */ (function (_super) {
    __extends(TeamsDeleteDiscussionCommentHeaders, _super);
    function TeamsDeleteDiscussionCommentHeaders() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "header, style=simple;explode=false;name=accept" }),
        __metadata("design:type", String)
    ], TeamsDeleteDiscussionCommentHeaders.prototype, "accept", void 0);
    return TeamsDeleteDiscussionCommentHeaders;
}(SpeakeasyBase));
export { TeamsDeleteDiscussionCommentHeaders };
var TeamsDeleteDiscussionCommentRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", TeamsDeleteDiscussionCommentHeaders)
    ], TeamsDeleteDiscussionCommentRequest.prototype, "headers", void 0);
