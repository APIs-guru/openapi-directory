...
var TeamsDeleteDiscussionHeaders = /** @class */ (function (_super) {
    __extends(TeamsDeleteDiscussionHeaders, _super);
    function TeamsDeleteDiscussionHeaders() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "header, style=simple;explode=false;name=accept" }),
        __metadata("design:type", String)
    ], TeamsDeleteDiscussionHeaders.prototype, "accept", void 0);
    return TeamsDeleteDiscussionHeaders;
}(SpeakeasyBase));
export { TeamsDeleteDiscussionHeaders };
var TeamsDeleteDiscussionRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", TeamsDeleteDiscussionHeaders)
    ], TeamsDeleteDiscussionRequest.prototype, "headers", void 0);
