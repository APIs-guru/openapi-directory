...
var TeamsUpdateDiscussionHeaders = /** @class */ (function (_super) {
    __extends(TeamsUpdateDiscussionHeaders, _super);
    function TeamsUpdateDiscussionHeaders() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "header, style=simple;explode=false;name=accept" }),
        __metadata("design:type", String)
    ], TeamsUpdateDiscussionHeaders.prototype, "accept", void 0);
    return TeamsUpdateDiscussionHeaders;
}(SpeakeasyBase));
export { TeamsUpdateDiscussionHeaders };
...
var TeamsUpdateDiscussionRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", TeamsUpdateDiscussionHeaders)
    ], TeamsUpdateDiscussionRequest.prototype, "headers", void 0);
    __decorate([
