...
var TeamsCreateDiscussionHeaders = /** @class */ (function (_super) {
    __extends(TeamsCreateDiscussionHeaders, _super);
    function TeamsCreateDiscussionHeaders() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "header, style=simple;explode=false;name=accept" }),
        __metadata("design:type", String)
    ], TeamsCreateDiscussionHeaders.prototype, "accept", void 0);
    return TeamsCreateDiscussionHeaders;
}(SpeakeasyBase));
export { TeamsCreateDiscussionHeaders };
...
var TeamsCreateDiscussionRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", TeamsCreateDiscussionHeaders)
    ], TeamsCreateDiscussionRequest.prototype, "headers", void 0);
    __decorate([
