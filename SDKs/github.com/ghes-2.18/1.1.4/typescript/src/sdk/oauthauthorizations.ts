...
export class OauthAuthorizations {
   ...
   *
   * https://docs.github.com/enterprise-server@2.18/rest/reference/oauth-authorizations#check-an-authorization - API method documentation
  **/
  oauthAuthorizationsCheckAuthorization(
    req: operations.OauthAuthorizationsCheckAuthorizationRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.OauthAuthorizationsCheckAuthorizationResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.OauthAuthorizationsCheckAuthorizationRequest(req);
    }
    ...
    return client
      .request({
        ...
        const res: operations.OauthAuthorizationsCheckAuthorizationResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.authorizationWithUser = httpRes?.data;
            }
            break;
        }
   ...
   *
   * https://docs.github.com/enterprise-server@2.18/rest/reference/oauth-authorizations#create-a-new-authorization - API method documentation
  **/
   ...
   *
   * https://docs.github.com/enterprise-server@2.18/rest/reference/oauth-authorizations#delete-an-authorization - API method documentation
  **/
   ...
   *
   * https://docs.github.com/enterprise-server@2.18/rest/reference/oauth-authorizations#delete-a-grant - API method documentation
  **/
   ...
   * **Deprecation Notice:** GitHub Enterprise Server will discontinue the [OAuth Authorizations API](https://docs.github.com/enterprise-server@2.18/rest/reference/oauth-authorizations), which is used by integrations to create personal access tokens and OAuth tokens, and you must now create these tokens using our [web application flow](https://docs.github.com/enterprise-server@2.18/apps/building-oauth-apps/authorizing-oauth-apps/#web-application-flow). The [OAuth Authorizations API](https://docs.github.com/enterprise-server@2.18/rest/reference/oauth-authorizations) will be removed on November, 13, 2020. For more information, including scheduled brownouts, see the [blog post](https://developer.github.com/changes/2020-02-14-deprecating-oauth-auth-endpoint/).
   *
   * https://docs.github.com/enterprise-server@2.18/rest/reference/oauth-authorizations#get-a-single-authorization - API method documentation
  **/
   ...
   * **Deprecation Notice:** GitHub Enterprise Server will discontinue the [OAuth Authorizations API](https://docs.github.com/enterprise-server@2.18/rest/reference/oauth-authorizations), which is used by integrations to create personal access tokens and OAuth tokens, and you must now create these tokens using our [web application flow](https://docs.github.com/enterprise-server@2.18/apps/building-oauth-apps/authorizing-oauth-apps/#web-application-flow). The [OAuth Authorizations API](https://docs.github.com/enterprise-server@2.18/rest/reference/oauth-authorizations) will be removed on November, 13, 2020. For more information, including scheduled brownouts, see the [blog post](https://developer.github.com/changes/2020-02-14-deprecating-oauth-auth-endpoint/).
   *
   * https://docs.github.com/enterprise-server@2.18/rest/reference/oauth-authorizations#get-a-single-grant - API method documentation
  **/
   ...
   * **Deprecation Notice:** GitHub Enterprise Server will discontinue the [OAuth Authorizations API](https://docs.github.com/enterprise-server@2.18/rest/reference/oauth-authorizations/), which is used by integrations to create personal access tokens and OAuth tokens, and you must now create these tokens using our [web application flow](https://docs.github.com/enterprise-server@2.18/developers/apps/authorizing-oauth-apps#web-application-flow). The [OAuth Authorizations API](https://docs.github.com/enterprise-server@2.18/rest/reference/oauth-authorizations) will be removed on November, 13, 2020. For more information, including scheduled brownouts, see the [blog post](https://developer.github.com/changes/2020-02-14-deprecating-oauth-auth-endpoint/).
   *
   * https://docs.github.com/enterprise-server@2.18/rest/reference/oauth-authorizations#get-or-create-an-authorization-for-a-specific-app - API method documentation
  **/
   ...
   * If you have two-factor authentication setup, Basic Authentication for this endpoint requires that you use a one-time password (OTP) and your username and password instead of tokens. For more information, see "[Working with two-factor authentication](https://docs.github.com/enterprise-server@2.18/rest/overview/other-authentication-methods#working-with-two-factor-authentication)."
   *
   * https://docs.github.com/enterprise-server@2.18/rest/reference/oauth-authorizations#get-or-create-an-authorization-for-a-specific-app-and-fingerprint - API method documentation
  **/
   ...
   * **Deprecation Notice:** GitHub Enterprise Server will discontinue the [OAuth Authorizations API](https://docs.github.com/enterprise-server@2.18/rest/reference/oauth-authorizations), which is used by integrations to create personal access tokens and OAuth tokens, and you must now create these tokens using our [web application flow](https://docs.github.com/enterprise-server@2.18/apps/building-oauth-apps/authorizing-oauth-apps/#web-application-flow). The [OAuth Authorizations API](https://docs.github.com/enterprise-server@2.18/rest/reference/oauth-authorizations) will be removed on November, 13, 2020. For more information, including scheduled brownouts, see the [blog post](https://developer.github.com/changes/2020-02-14-deprecating-oauth-auth-endpoint/).
   *
   * https://docs.github.com/enterprise-server@2.18/rest/reference/oauth-authorizations#list-your-authorizations - API method documentation
  **/
   ...
   *
   * https://docs.github.com/enterprise-server@2.18/rest/reference/oauth-authorizations#list-your-grants - API method documentation
  **/
   ...
   *
   * https://docs.github.com/enterprise-server@2.18/rest/reference/oauth-authorizations#reset-an-authorization - API method documentation
  **/
  oauthAuthorizationsResetAuthorization(
    req: operations.OauthAuthorizationsResetAuthorizationRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.OauthAuthorizationsResetAuthorizationResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.OauthAuthorizationsResetAuthorizationRequest(req);
    }
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.OauthAuthorizationsResetAuthorizationResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.authorizationWithUser = httpRes?.data;
   ...
   *
   * https://docs.github.com/enterprise-server@2.18/rest/reference/oauth-authorizations#revoke-an-authorization-for-an-application - API method documentation
  **/
  oauthAuthorizationsRevokeAuthorizationForApplication(
    req: operations.OauthAuthorizationsRevokeAuthorizationForApplicationRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.OauthAuthorizationsRevokeAuthorizationForApplicationResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.OauthAuthorizationsRevokeAuthorizationForApplicationRequest(req);
    }
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.OauthAuthorizationsRevokeAuthorizationForApplicationResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 204:
            break;
        }
   ...
   *
   * https://docs.github.com/enterprise-server@2.18/rest/reference/oauth-authorizations#revoke-a-grant-for-an-application - API method documentation
  **/
  oauthAuthorizationsRevokeGrantForApplication(
    req: operations.OauthAuthorizationsRevokeGrantForApplicationRequest,
    config?: AxiosRequestConfig
  ): Promise<operations.OauthAuthorizationsRevokeGrantForApplicationResponse> {
    if (!(req instanceof utils.SpeakeasyBase)) {
      req = new operations.OauthAuthorizationsRevokeGrantForApplicationRequest(req);
    }
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.OauthAuthorizationsRevokeGrantForApplicationResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 204:
            break;
        }
   ...
   *
   * https://docs.github.com/enterprise-server@2.18/rest/reference/oauth-authorizations#update-an-existing-authorization - API method documentation
  **/
