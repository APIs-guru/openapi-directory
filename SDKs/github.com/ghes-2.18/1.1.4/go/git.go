...
func (s *Git) GitGetAllRefs(ctx context.Context, request operations.GitGetAllRefsRequest) (*operations.GitGetAllRefsResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/repos/{owner}/{repo}/git/refs/{namespace}", request.PathParams)
	...
	res := &operations.GitGetAllRefsResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
