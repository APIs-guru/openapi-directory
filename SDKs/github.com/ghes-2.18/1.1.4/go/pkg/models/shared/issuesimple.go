...
type IssueSimpleAssigneeSimpleUser struct {
...
type IssueSimpleMilestoneCreatorSimpleUser struct {
	AvatarURL         string  `json:"avatar_url"`
	EventsURL         string  `json:"events_url"`
	FollowersURL      string  `json:"followers_url"`
	FollowingURL      string  `json:"following_url"`
...
type IssueSimpleMilestoneMilestone struct {
	ClosedAt     time.Time                             `json:"closed_at"`
	ClosedIssues int64                                 `json:"closed_issues"`
	CreatedAt    time.Time                             `json:"created_at"`
	Creator      IssueSimpleMilestoneCreatorSimpleUser `json:"creator"`
...
type IssueSimpleUserSimpleUser struct {
	AvatarURL         string  `json:"avatar_url"`
	EventsURL         string  `json:"events_url"`
	FollowersURL      string  `json:"followers_url"`
	FollowingURL      string  `json:"following_url"`
...
type IssueSimple struct {
	...
	UpdatedAt             time.Time                     `json:"updated_at"`
	URL                   string                        `json:"url"`
	User                  IssueSimpleUserSimpleUser     `json:"user"`
}
