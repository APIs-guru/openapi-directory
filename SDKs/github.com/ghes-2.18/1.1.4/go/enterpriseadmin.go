...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#add-an-authorized-ssh-key - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#create-a-github-enterprise-server-license - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#create-a-global-webhook - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#create-an-impersonation-oauth-token - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#create-an-organization - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#create-a-pre-receive-environment - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#create-a-pre-receive-hook - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#create-a-user - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#delete-a-global-webhook - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#delete-an-impersonation-oauth-token - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#delete-a-personal-access-token - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#delete-a-pre-receive-environment - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#delete-a-pre-receive-hook - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#delete-a-public-key - API method documentation
...
// Deleting a user will delete all their repositories, gists, applications, and personal settings. [Suspending a user](https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#suspend-a-user) is often a better option.
//
// You can delete any user account except your own.
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#delete-a-user - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#demote-a-site-administrator - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#enable-or-disable-maintenance-mode - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#get-all-authorized-ssh-keys - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#get-the-configuration-status - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#get-the-download-status-for-a-pre-receive-environment - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#get-a-global-webhook - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#get-license-information - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#get-the-maintenance-status - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#get-a-pre-receive-environment - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#get-a-pre-receive-hook - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#get-a-pre-receive-hook-for-an-organization - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#get-a-pre-receive-hook-for-a-repository - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#get-settings - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#get-statistics - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#list-global-webhooks - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#list-personal-access-tokens - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#list-pre-receive-environments - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#list-pre-receive-hooks - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#list-pre-receive-hooks-for-an-organization - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#list-pre-receive-hooks-for-a-repository - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#list-public-keys - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#ping-a-global-webhook - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#promote-a-user-to-be-a-site-administrator - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#remove-an-authorized-ssh-key - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#remove-pre-receive-hook-enforcement-for-an-organization - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#remove-pre-receive-hook-enforcement-for-a-repository - API method documentation
...
// For a list of the available settings, see the [Get settings endpoint](https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#get-settings).
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#set-settings - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#start-a-configuration-process - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#start-a-pre-receive-environment-download - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#suspend-a-user - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#sync-ldap-mapping-for-a-team - API method documentation
...
// Note that this API call does not automatically initiate an LDAP sync. Rather, if a `201` is returned, the sync job is queued successfully, and is performed when the instance is ready.
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#sync-ldap-mapping-for-a-user - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#unsuspend-a-user - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#update-a-global-webhook - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#update-ldap-mapping-for-a-team - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#update-ldap-mapping-for-a-user - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#update-an-organization-name - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#update-a-pre-receive-environment - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#update-a-pre-receive-hook - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#update-pre-receive-hook-enforcement-for-an-organization - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#update-pre-receive-hook-enforcement-for-a-repository - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#update-the-username-for-a-user - API method documentation
...
// https://docs.github.com/enterprise-server@2.18/rest/reference/enterprise-admin#upgrade-a-license - API method documentation
