...
class Markdown:
    ...
    def markdown_render(self, request: operations.MarkdownRenderRequest) -> operations.MarkdownRenderResponse:
        ...
        https://docs.github.com/enterprise-server@2.18/rest/reference/markdown#render-a-markdown-document - API method documentation
        """
    ...
    def markdown_render_raw(self, request: operations.MarkdownRenderRawRequest) -> operations.MarkdownRenderRawResponse:
        ...
        https://docs.github.com/enterprise-server@2.18/rest/reference/markdown#render-a-markdown-document-in-raw-mode - API method documentation
        """
