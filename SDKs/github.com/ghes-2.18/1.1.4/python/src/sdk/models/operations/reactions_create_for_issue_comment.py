...
class ReactionsCreateForIssueCommentRequestBody:
    content: ReactionsCreateForIssueCommentRequestBodyContentEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'content' }})
    

@dataclass
class ReactionsCreateForIssueCommentRequest:
    path_params: ReactionsCreateForIssueCommentPathParams = field(default=None)
