...
class LegacyReviewCommentLinks:
    html: Optional[LegacyReviewCommentLinksHTML] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('html') }})
    pull_request: Optional[LegacyReviewCommentLinksPullRequest] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('pull_request') }})
    self: Optional[LegacyReviewCommentLinksSelf] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('self') }})
...
class LegacyReviewComment:
    links: Optional[LegacyReviewCommentLinks] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('_links') }})
    author_association: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('author_association') }})
    ...
    diff_hunk: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('diff_hunk') }})
    html_url: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('html_url') }})
    id: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('id') }})
    in_reply_to_id: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('in_reply_to_id') }})
    node_id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('node_id') }})
    original_commit_id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('original_commit_id') }})
    original_position: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('original_position') }})
    ...
    pull_request_review_id: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('pull_request_review_id') }})
    ...
    url: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('url') }})
    user: Optional[LegacyReviewCommentUser] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('user') }})
