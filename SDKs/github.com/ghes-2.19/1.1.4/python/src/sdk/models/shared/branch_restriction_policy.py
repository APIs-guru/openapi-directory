...
class BranchRestrictionPolicyRestrictionsApps:
    ...
    name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('name') }})
    node_id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('node_id') }})
    owner: Optional[BranchRestrictionPolicyRestrictionsAppsOwner] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('owner') }})
    permissions: Optional[BranchRestrictionPolicyRestrictionsAppsPermissions] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('permissions') }})
    slug: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('slug') }})
    updated_at: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('updated_at') }})
...
class BranchRestrictionPolicyRestrictions:
    apps: Optional[List[BranchRestrictionPolicyRestrictionsApps]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('apps') }})
    apps_url: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('apps_url') }})
    teams: Optional[List[BranchRestrictionPolicyRestrictionsTeams]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('teams') }})
    teams_url: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('teams_url') }})
    url: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('url') }})
    users: Optional[List[BranchRestrictionPolicyRestrictionsUsers]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('users') }})
...
class BranchRestrictionPolicy:
    ...
    restrictions: Optional[List[BranchRestrictionPolicyRestrictions]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('restrictions') }})
