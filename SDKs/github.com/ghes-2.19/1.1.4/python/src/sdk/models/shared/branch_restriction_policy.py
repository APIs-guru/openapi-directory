...
class BranchRestrictionPolicyRestrictionsApps:
    ...
    name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'name' }})
    node_id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'node_id' }})
    owner: Optional[BranchRestrictionPolicyRestrictionsAppsOwner] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'owner' }})
    permissions: Optional[BranchRestrictionPolicyRestrictionsAppsPermissions] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'permissions' }})
    slug: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'slug' }})
    updated_at: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'updated_at' }})
...
class BranchRestrictionPolicyRestrictions:
    apps: Optional[List[BranchRestrictionPolicyRestrictionsApps]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'apps' }})
    apps_url: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'apps_url' }})
