...
class Pulls:
    ...
    def pulls_create_review_comment_alternative(self, request: operations.PullsCreateReviewCommentAlternativeRequest) -> operations.PullsCreateReviewCommentAlternativeResponse:
        r"""Create a review comment for a pull request (alternative)
        ...
        **Note:** The position value equals the number of lines down from the first \"@@\" hunk header in the file you want to add a comment. The line just below the \"@@\" line is position 1, the next line is position 2, and so on. The position in the diff continues to increase through lines of whitespace and additional hunks until the beginning of a new file.
        ...
        if r.status_code == 201:
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.LegacyReviewComment])
                res.legacy_review_comment = out
