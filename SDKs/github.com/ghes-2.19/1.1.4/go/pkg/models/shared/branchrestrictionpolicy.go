...
type BranchRestrictionPolicyRestrictionsApps struct {
	...
	Name        *string                                             `json:"name"`
	NodeID      *string                                             `json:"node_id"`
	Owner       *BranchRestrictionPolicyRestrictionsAppsOwner       `json:"owner"`
	Permissions *BranchRestrictionPolicyRestrictionsAppsPermissions `json:"permissions"`
	Slug        *string                                             `json:"slug"`
	UpdatedAt   *string                                             `json:"updated_at"`
}
...
type BranchRestrictionPolicyRestrictions struct {
	Apps     []BranchRestrictionPolicyRestrictionsApps  `json:"apps"`
	AppsURL  *string                                    `json:"apps_url"`
	Teams    []BranchRestrictionPolicyRestrictionsTeams `json:"teams"`
	TeamsURL *string                                    `json:"teams_url"`
	URL      *string                                    `json:"url"`
	Users    []BranchRestrictionPolicyRestrictionsUsers `json:"users"`
...
type BranchRestrictionPolicy struct {
	...
	AppsURL      string                                `json:"apps_url"`
	Restrictions []BranchRestrictionPolicyRestrictions `json:"restrictions"`
