...
func (s *Pulls) PullsCreateReviewCommentAlternative(ctx context.Context, request operations.PullsCreateReviewCommentAlternativeRequest) (*operations.PullsCreateReviewCommentAlternativeResponse, error) {
	baseURL := s._serverURL
	...
	res := &operations.PullsCreateReviewCommentAlternativeResponse{
		StatusCode:  int64(httpRes.StatusCode),
		ContentType: contentType,
	}
	switch {
	case httpRes.StatusCode == 201:
		...
		switch {
		case utils.MatchContentType(contentType, `application/json`):
			var out *shared.LegacyReviewComment
			if err := utils.UnmarshalJsonFromResponseBody(httpRes.Body, &out); err != nil {
				return nil, err
			}
