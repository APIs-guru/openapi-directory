...
var BranchRestrictionPolicyRestrictionsAppsOwner = /** @class */ (function (_super) {
    __extends(BranchRestrictionPolicyRestrictionsAppsOwner, _super);
    function BranchRestrictionPolicyRestrictionsAppsOwner() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=avatar_url" }),
        __metadata("design:type", String)
    ], BranchRestrictionPolicyRestrictionsAppsOwner.prototype, "avatarUrl", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=description" }),
        __metadata("design:type", String)
    ], BranchRestrictionPolicyRestrictionsAppsOwner.prototype, "description", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=events_url" }),
        __metadata("design:type", String)
    ], BranchRestrictionPolicyRestrictionsAppsOwner.prototype, "eventsUrl", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=hooks_url" }),
        __metadata("design:type", String)
    ], BranchRestrictionPolicyRestrictionsAppsOwner.prototype, "hooksUrl", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=id" }),
        __metadata("design:type", Number)
    ], BranchRestrictionPolicyRestrictionsAppsOwner.prototype, "id", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=issues_url" }),
        __metadata("design:type", String)
    ], BranchRestrictionPolicyRestrictionsAppsOwner.prototype, "issuesUrl", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=login" }),
        __metadata("design:type", String)
    ], BranchRestrictionPolicyRestrictionsAppsOwner.prototype, "login", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=members_url" }),
        __metadata("design:type", String)
    ], BranchRestrictionPolicyRestrictionsAppsOwner.prototype, "membersUrl", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=node_id" }),
        __metadata("design:type", String)
    ], BranchRestrictionPolicyRestrictionsAppsOwner.prototype, "nodeId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=public_members_url" }),
        __metadata("design:type", String)
    ], BranchRestrictionPolicyRestrictionsAppsOwner.prototype, "publicMembersUrl", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=repos_url" }),
        __metadata("design:type", String)
    ], BranchRestrictionPolicyRestrictionsAppsOwner.prototype, "reposUrl", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=url" }),
        __metadata("design:type", String)
    ], BranchRestrictionPolicyRestrictionsAppsOwner.prototype, "url", void 0);
    return BranchRestrictionPolicyRestrictionsAppsOwner;
}(SpeakeasyBase));
export { BranchRestrictionPolicyRestrictionsAppsOwner };
var BranchRestrictionPolicyRestrictionsAppsPermissions = /** @class */ (function (_super) {
    __extends(BranchRestrictionPolicyRestrictionsAppsPermissions, _super);
    function BranchRestrictionPolicyRestrictionsAppsPermissions() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=contents" }),
        __metadata("design:type", String)
    ], BranchRestrictionPolicyRestrictionsAppsPermissions.prototype, "contents", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=issues" }),
        __metadata("design:type", String)
    ], BranchRestrictionPolicyRestrictionsAppsPermissions.prototype, "issues", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=metadata" }),
        __metadata("design:type", String)
    ], BranchRestrictionPolicyRestrictionsAppsPermissions.prototype, "metadata", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=single_file" }),
        __metadata("design:type", String)
    ], BranchRestrictionPolicyRestrictionsAppsPermissions.prototype, "singleFile", void 0);
    return BranchRestrictionPolicyRestrictionsAppsPermissions;
}(SpeakeasyBase));
export { BranchRestrictionPolicyRestrictionsAppsPermissions };
var BranchRestrictionPolicyRestrictionsApps = /** @class */ (function (_super) {
    __extends(BranchRestrictionPolicyRestrictionsApps, _super);
    function BranchRestrictionPolicyRestrictionsApps() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=created_at" }),
        __metadata("design:type", String)
    ], BranchRestrictionPolicyRestrictionsApps.prototype, "createdAt", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=description" }),
        __metadata("design:type", String)
    ], BranchRestrictionPolicyRestrictionsApps.prototype, "description", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=events" }),
        __metadata("design:type", Array)
    ], BranchRestrictionPolicyRestrictionsApps.prototype, "events", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=external_url" }),
        __metadata("design:type", String)
    ], BranchRestrictionPolicyRestrictionsApps.prototype, "externalUrl", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=html_url" }),
        __metadata("design:type", String)
    ], BranchRestrictionPolicyRestrictionsApps.prototype, "htmlUrl", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=id" }),
        __metadata("design:type", Number)
    ], BranchRestrictionPolicyRestrictionsApps.prototype, "id", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=name" }),
        __metadata("design:type", String)
    ], BranchRestrictionPolicyRestrictionsApps.prototype, "name", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=node_id" }),
        __metadata("design:type", String)
    ], BranchRestrictionPolicyRestrictionsApps.prototype, "nodeId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=owner" }),
        __metadata("design:type", BranchRestrictionPolicyRestrictionsAppsOwner)
    ], BranchRestrictionPolicyRestrictionsApps.prototype, "owner", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=permissions" }),
        __metadata("design:type", BranchRestrictionPolicyRestrictionsAppsPermissions)
    ], BranchRestrictionPolicyRestrictionsApps.prototype, "permissions", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=slug" }),
        __metadata("design:type", String)
    ], BranchRestrictionPolicyRestrictionsApps.prototype, "slug", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=updated_at" }),
        __metadata("design:type", String)
    ], BranchRestrictionPolicyRestrictionsApps.prototype, "updatedAt", void 0);
    return BranchRestrictionPolicyRestrictionsApps;
}(SpeakeasyBase));
export { BranchRestrictionPolicyRestrictionsApps };
...
var BranchRestrictionPolicyRestrictions = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", Array)
    ], BranchRestrictionPolicyRestrictions.prototype, "apps", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=apps_url" }),
        __metadata("design:type", String)
    ], BranchRestrictionPolicyRestrictions.prototype, "appsUrl", void 0);
    __decorate([
