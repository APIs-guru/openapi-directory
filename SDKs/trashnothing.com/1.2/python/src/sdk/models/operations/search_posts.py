...
@dataclass
class SearchPostsSecurityOption1:
    oauth2_implicit: shared.SchemeOauth2Implicit = field(default=None, metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclass
class SearchPostsSecurityOption2:
    oauth2_code: shared.SchemeOauth2Code = field(default=None, metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclass
class SearchPostsSecurityOption3:
    api_key: shared.SchemeAPIKey = field(default=None, metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'query' }})
    

@dataclass
class SearchPostsSecurity:
    option1: Optional[SearchPostsSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[SearchPostsSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[SearchPostsSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class SearchPostsRequest:
    query_params: SearchPostsQueryParams = field(default=None)
    security: SearchPostsSecurity = field(default=None)
    

@dataclass_json
@dataclass
class SearchPosts200ApplicationJSON:
...
class SearchPostsResponse:
    ...
    search_posts_200_application_json_object: Optional[SearchPosts200ApplicationJSON] = field(default=None)
