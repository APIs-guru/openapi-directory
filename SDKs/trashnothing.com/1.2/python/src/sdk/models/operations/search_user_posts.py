...
class SearchUserPostsSecurity:
    option1: Optional[SearchUserPostsSecurityOption1] = field(default=None, metadata={'security': { 'option': True }})
    option2: Optional[SearchUserPostsSecurityOption2] = field(default=None, metadata={'security': { 'option': True }})
    option3: Optional[SearchUserPostsSecurityOption3] = field(default=None, metadata={'security': { 'option': True }})
    

@dataclass
class SearchUserPostsRequest:
    path_params: SearchUserPostsPathParams = field(default=None)
    query_params: SearchUserPostsQueryParams = field(default=None)
    security: SearchUserPostsSecurity = field(default=None)
...
class SearchUserPosts200ApplicationJSON:
    ...
    posts: Optional[List[shared.PostSearchResult]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'posts' }})
