...
var DeleteAlertPathParams = /** @class */ (function (_super) {
    __extends(DeleteAlertPathParams, _super);
    function DeleteAlertPathParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=alert_id" }),
        __metadata("design:type", String)
    ], DeleteAlertPathParams.prototype, "alertId", void 0);
    return DeleteAlertPathParams;
}(SpeakeasyBase));
export { DeleteAlertPathParams };
var DeleteAlertRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", DeleteAlertPathParams)
    ], DeleteAlertRequest.prototype, "pathParams", void 0);
