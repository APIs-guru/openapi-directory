...
var DeleteConversationQueryParams = /** @class */ (function (_super) {
    __extends(DeleteConversationQueryParams, _super);
    function DeleteConversationQueryParams() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=message_id" }),
        __metadata("design:type", String)
    ], DeleteConversationQueryParams.prototype, "messageId", void 0);
    return DeleteConversationQueryParams;
}(SpeakeasyBase));
export { DeleteConversationQueryParams };
var DeleteConversationRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", DeleteConversationQueryParams)
    ], DeleteConversationRequest.prototype, "queryParams", void 0);
