 ...
 *
**/
var GeolocateBounds = /** @class */ (function (_super) {
    __extends(GeolocateBounds, _super);
    function GeolocateBounds() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=default" }),
        __metadata("design:type", BoundingBox)
    ], GeolocateBounds.prototype, "default", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=limit" }),
        __metadata("design:type", BoundingBox)
    ], GeolocateBounds.prototype, "limit", void 0);
    return GeolocateBounds;
}(SpeakeasyBase));
export { GeolocateBounds };
