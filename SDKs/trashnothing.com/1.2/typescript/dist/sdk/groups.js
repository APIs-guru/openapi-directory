...
var Groups = /** @class */ (function () {
    ...
    **/
    Groups.prototype.contactModerators = function (req, config) {
        ...
        var url = utils.GenerateURL(baseURL, "/groups/{group_id}/contact", req.pathParams);
    ...
    **/
    Groups.prototype.getGroup = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/groups/{group_id}", req.pathParams);
        var client = this._securityClient;
        return client
    ...
    **/
    Groups.prototype.getGroupsByIds = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    Groups.prototype.joinGroups = function (req, config) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.joinGroups200ApplicationJsonObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    break;
    ...
    **/
    Groups.prototype.leaveGroup = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/groups/{group_id}/unsubscribe", req.pathParams);
        var client = this._securityClient;
        return client
    ...
    **/
    Groups.prototype.searchGroups = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.searchGroups200ApplicationJsonObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    break;
    ...
    **/
    Groups.prototype.submitAnswers = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/groups/{group_id}/answers", req.pathParams);
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
