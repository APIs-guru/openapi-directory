...
class SscerRequestBodyCertificateParameters:
    cent: str = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('Cent') }})
    m_name: str = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('MName') }})
