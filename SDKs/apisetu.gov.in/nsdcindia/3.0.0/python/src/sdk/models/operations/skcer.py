...
class SkcerRequestBodyCertificateParameters:
    cent_cid: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'CentCID' }})
    cert_id: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'CertID' }})
