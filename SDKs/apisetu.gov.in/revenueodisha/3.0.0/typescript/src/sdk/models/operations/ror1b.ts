...
export class Ror1bRequestBodyCertificateParameters extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "json, name=khatano" })
  khatano: string;

  @SpeakeasyMetadata({ data: "json, name=level1" })
  level1: string;

  @SpeakeasyMetadata({ data: "json, name=level2" })
  level2: string;

  @SpeakeasyMetadata({ data: "json, name=level3" })
  level3: string;
}
