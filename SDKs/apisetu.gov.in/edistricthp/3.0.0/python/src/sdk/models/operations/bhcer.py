...
class Bhcer400ApplicationJSONErrorDescriptionEnum(str, Enum):
...
class Bhcer401ApplicationJSONErrorDescriptionEnum(str, Enum):
...
class Bhcer404ApplicationJSONErrorDescriptionEnum(str, Enum):
...
class Bhcer500ApplicationJSONErrorDescriptionEnum(str, Enum):
...
class Bhcer502ApplicationJSONErrorDescriptionEnum(str, Enum):
...
class Bhcer503ApplicationJSONErrorDescriptionEnum(str, Enum):
...
class Bhcer504ApplicationJSONErrorDescriptionEnum(str, Enum):
...
class BhcerResponse:
    ...
    bhcer_500_application_json_object: Optional[Bhcer500ApplicationJSON] = field(default=None)
    bhcer_502_application_json_object: Optional[Bhcer502ApplicationJSON] = field(default=None)
    bhcer_503_application_json_object: Optional[Bhcer503ApplicationJSON] = field(default=None)
    bhcer_504_application_json_object: Optional[Bhcer504ApplicationJSON] = field(default=None)
