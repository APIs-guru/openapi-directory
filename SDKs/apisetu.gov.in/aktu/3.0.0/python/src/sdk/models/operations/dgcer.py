...
class DgcerRequestBodyCertificateParameters:
    ...
    enrollment_no: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'EnrollmentNo' }})
    full_name: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'FullName' }})
    roll_no: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'RollNo' }})
