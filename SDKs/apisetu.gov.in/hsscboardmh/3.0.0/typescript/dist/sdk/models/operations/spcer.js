...
var SpcerRequestBodyCertificateParameters = /** @class */ (function (_super) {
    ...
    __decorate([
        Metadata({ data: "json, name=exsession" }),
        __metadata("design:type", String)
    ], SpcerRequestBodyCertificateParameters.prototype, "exsession", void 0);
    __decorate([
        Metadata({ data: "json, name=rollnumber" }),
        __metadata("design:type", String)
    ], SpcerRequestBodyCertificateParameters.prototype, "rollnumber", void 0);
    __decorate([
        Metadata({ data: "json, name=totalmarks" }),
        __metadata("design:type", String)
    ], SpcerRequestBodyCertificateParameters.prototype, "totalmarks", void 0);
    __decorate([
...
(function (SpcerRequestBodyFormatEnum) {
    SpcerRequestBodyFormatEnum["Xml"] = "xml";
...
var SpcerResponse = /** @class */ (function (_super) {
    ...
    ], SpcerResponse.prototype, "body", void 0);
    __decorate([
        Metadata(),
        __metadata("design:type", String)
