...
class LabrpRequestBodyCertificateParameters:
    ...
    reportdate: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'reportdate' }})
    uhid: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'uhid' }})
