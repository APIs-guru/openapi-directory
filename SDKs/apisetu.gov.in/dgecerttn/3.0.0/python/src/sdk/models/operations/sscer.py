...
class SscerRequestBodyCertificateParameters:
    certificate_type: str = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('CertificateType') }})
    ...
    month: str = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('month') }})
