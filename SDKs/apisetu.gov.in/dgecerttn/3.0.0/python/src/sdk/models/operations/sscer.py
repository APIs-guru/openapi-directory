...
class SscerRequestBodyCertificateParameters:
    certificate_type: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'CertificateType' }})
    ...
    month: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'month' }})
