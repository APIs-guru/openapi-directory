...
class SDK:
    ...
    def mbcer(self, request: operations.MbcerRequest) -> operations.MbcerResponse:
        r"""Membership Certificate
        API to verify Membership Certificate.
        """
        
        base_url = self._server_url
        
        url = base_url.removesuffix("/") + "/mbcer/certificate"
        ...
        res = operations.MbcerResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            pass
        elif r.status_code == 400:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.Mbcer400ApplicationJSON])
                res.mbcer_400_application_json_object = out
        elif r.status_code == 401:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.Mbcer401ApplicationJSON])
                res.mbcer_401_application_json_object = out
        elif r.status_code == 404:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.Mbcer404ApplicationJSON])
                res.mbcer_404_application_json_object = out
        elif r.status_code == 500:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.Mbcer500ApplicationJSON])
                res.mbcer_500_application_json_object = out
        elif r.status_code == 502:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.Mbcer502ApplicationJSON])
                res.mbcer_502_application_json_object = out
        elif r.status_code == 503:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.Mbcer503ApplicationJSON])
                res.mbcer_503_application_json_object = out
        elif r.status_code == 504:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[operations.Mbcer504ApplicationJSON])
                res.mbcer_504_application_json_object = out
