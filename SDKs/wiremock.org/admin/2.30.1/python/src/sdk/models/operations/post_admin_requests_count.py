...
class PostAdminRequestsCountRequestBody:
    basic_auth_credentials: Optional[PostAdminRequestsCountRequestBodyBasicAuthCredentials] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('basicAuthCredentials') }})
...
class PostAdminRequestsCountRequest:
    request: PostAdminRequestsCountRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
