...
class GetAdminMappingsStubMappingID200ApplicationJSONRequest:
    basic_auth_credentials: Optional[GetAdminMappingsStubMappingID200ApplicationJSONRequestBasicAuthCredentials] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('basicAuthCredentials') }})
...
class GetAdminMappingsStubMappingID200ApplicationJSONResponse:
    ...
    fault: Optional[GetAdminMappingsStubMappingID200ApplicationJSONResponseFaultEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('fault') }})
...
class GetAdminMappingsStubMappingID200ApplicationJSON:
    ...
    request: Optional[GetAdminMappingsStubMappingID200ApplicationJSONRequest] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('request') }})
    ...
    response: Optional[GetAdminMappingsStubMappingID200ApplicationJSONResponse] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('response') }})
...
class GetAdminMappingsStubMappingIDRequest:
    path_params: GetAdminMappingsStubMappingIDPathParams = field()
