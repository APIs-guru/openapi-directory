...
class PostAdminRecordingsStop200ApplicationJSONMappingsRequest:
    basic_auth_credentials: Optional[PostAdminRecordingsStop200ApplicationJSONMappingsRequestBasicAuthCredentials] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'basicAuthCredentials' }})
...
class PostAdminRecordingsStop200ApplicationJSONMappingsResponse:
    ...
    fault: Optional[PostAdminRecordingsStop200ApplicationJSONMappingsResponseFaultEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'fault' }})
...
class PostAdminRecordingsStop200ApplicationJSONMappings:
    ...
    request: Optional[PostAdminRecordingsStop200ApplicationJSONMappingsRequest] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'request' }})
    required_scenario_state: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'requiredScenarioState' }})
    response: Optional[PostAdminRecordingsStop200ApplicationJSONMappingsResponse] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'response' }})
...
class PostAdminRecordingsStop200ApplicationJSON:
    mappings: Optional[List[PostAdminRecordingsStop200ApplicationJSONMappings]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'mappings' }})
    meta: Optional[PostAdminRecordingsStop200ApplicationJSONMeta] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'meta' }})
