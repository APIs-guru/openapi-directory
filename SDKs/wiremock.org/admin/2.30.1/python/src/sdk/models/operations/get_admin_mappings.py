...
class GetAdminMappings200ApplicationJSONMappingsRequest:
    basic_auth_credentials: Optional[GetAdminMappings200ApplicationJSONMappingsRequestBasicAuthCredentials] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('basicAuthCredentials') }})
...
class GetAdminMappings200ApplicationJSONMappingsResponse:
    ...
    fault: Optional[GetAdminMappings200ApplicationJSONMappingsResponseFaultEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('fault') }})
...
class GetAdminMappings200ApplicationJSONMappings:
    ...
    request: Optional[GetAdminMappings200ApplicationJSONMappingsRequest] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('request') }})
    ...
    response: Optional[GetAdminMappings200ApplicationJSONMappingsResponse] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('response') }})
...
class GetAdminMappings200ApplicationJSON:
    mappings: Optional[List[GetAdminMappings200ApplicationJSONMappings]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('mappings') }})
    meta: Optional[GetAdminMappings200ApplicationJSONMeta] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('meta') }})
    

@dataclass
class GetAdminMappingsRequest:
    query_params: GetAdminMappingsQueryParams = field()
