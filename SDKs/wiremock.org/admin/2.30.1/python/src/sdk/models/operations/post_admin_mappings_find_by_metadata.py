...
@dataclass_json
@dataclass
class PostAdminMappingsFindByMetadataRequestBody1StringEquals:
...
@dataclass_json
@dataclass
class PostAdminMappingsFindByMetadataRequestBody2StringContains:
    contains: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'contains' }})
    

@dataclass_json
@dataclass
class PostAdminMappingsFindByMetadataRequestBody3RegularExpressionMatch:
    matches: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'matches' }})
    

@dataclass_json
@dataclass
class PostAdminMappingsFindByMetadataRequestBody4NegativeRegularExpressionMatch:
    does_not_match: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'doesNotMatch' }})
    

@dataclass_json
@dataclass
class PostAdminMappingsFindByMetadataRequestBody5JSONEquals:
    equal_to_json: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'equalToJson' }})
    

@dataclass_json
@dataclass
class PostAdminMappingsFindByMetadataRequestBody6JSONPathMatch:
...
@dataclass_json
@dataclass
class PostAdminMappingsFindByMetadataRequestBody7XMLEquality:
    equal_to_xml: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'equalToXml' }})
    

@dataclass_json
@dataclass
class PostAdminMappingsFindByMetadataRequestBody8XPathMatch:
