...
class GetsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearAndCheckDateRequest:
    path_params: GetsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearAndCheckDatePathParams = field(default=None)
    query_params: GetsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearAndCheckDateQueryParams = field(default=None)
    security: GetsEmployeePayStatementSummaryDataBasedOnTheSpecifiedYearAndCheckDateSecurity = field(default=None)
