...
var GetRegionsGetRegionsGetQueryParams = /** @class */ (function (_super) {
    ...
    function GetRegionsGetRegionsGetQueryParams() {
...
export { GetRegionsGetRegionsGetQueryParams };
var GetRegionsGetRegionsGetRequest = /** @class */ (function (_super) {
    __extends(GetRegionsGetRegionsGetRequest, _super);
    function GetRegionsGetRegionsGetRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata(),
...
export { GetRegionsGetRegionsGetRequest };
var GetRegionsGetRegionsGetResponse = /** @class */ (function (_super) {
    __extends(GetRegionsGetRegionsGetResponse, _super);
    function GetRegionsGetRegionsGetResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata(),
...
export { GetRegionsGetRegionsGetResponse };
