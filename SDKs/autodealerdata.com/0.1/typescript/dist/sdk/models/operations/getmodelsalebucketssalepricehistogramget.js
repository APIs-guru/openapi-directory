...
var GetModelSaleBucketsSalePriceHistogramGetQueryParams = /** @class */ (function (_super) {
    ...
    function GetModelSaleBucketsSalePriceHistogramGetQueryParams() {
...
export { GetModelSaleBucketsSalePriceHistogramGetQueryParams };
var GetModelSaleBucketsSalePriceHistogramGetRequest = /** @class */ (function (_super) {
    __extends(GetModelSaleBucketsSalePriceHistogramGetRequest, _super);
    function GetModelSaleBucketsSalePriceHistogramGetRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata(),
...
export { GetModelSaleBucketsSalePriceHistogramGetRequest };
var GetModelSaleBucketsSalePriceHistogramGetResponse = /** @class */ (function (_super) {
    __extends(GetModelSaleBucketsSalePriceHistogramGetResponse, _super);
    function GetModelSaleBucketsSalePriceHistogramGetResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata(),
...
export { GetModelSaleBucketsSalePriceHistogramGetResponse };
