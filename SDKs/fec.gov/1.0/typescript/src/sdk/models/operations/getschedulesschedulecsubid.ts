...
export class GetSchedulesScheduleCSubIdPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=sub_id" })
  subId: string;
}


export class GetSchedulesScheduleCSubIdQueryParams extends SpeakeasyBase {
...
export class GetSchedulesScheduleCSubIdRequest extends SpeakeasyBase {
  @Metadata()
...
export class GetSchedulesScheduleCSubIdDefaultApplicationJsonResults extends SpeakeasyBase {
...
export class GetSchedulesScheduleCSubIdDefaultApplicationJson extends SpeakeasyBase {
  @Metadata({ data: "json, name=pagination" })
  pagination?: shared.OffsetInfo;

  @Metadata({ data: "json, name=results", elemType: operations.GetSchedulesScheduleCSubIdDefaultApplicationJsonResults })
  results?: GetSchedulesScheduleCSubIdDefaultApplicationJsonResults[];
}


export class GetSchedulesScheduleCSubIdResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
