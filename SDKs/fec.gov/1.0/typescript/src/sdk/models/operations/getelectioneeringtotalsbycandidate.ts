...
export class GetElectioneeringTotalsByCandidateQueryParams extends SpeakeasyBase {
...
export class GetElectioneeringTotalsByCandidateRequest extends SpeakeasyBase {
  @Metadata()
  queryParams: GetElectioneeringTotalsByCandidateQueryParams;
}


export class GetElectioneeringTotalsByCandidateResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
