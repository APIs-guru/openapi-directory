...
type GetSchedulesScheduleAByStateByCandidateQueryParams struct {
...
type GetSchedulesScheduleAByStateByCandidateRequest struct {
	QueryParams GetSchedulesScheduleAByStateByCandidateQueryParams
}

type GetSchedulesScheduleAByStateByCandidateResponse struct {
	ContentType                   string
