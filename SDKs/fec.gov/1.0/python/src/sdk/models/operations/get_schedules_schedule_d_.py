...
class GetSchedulesScheduleDRequest:
    query_params: GetSchedulesScheduleDQueryParams = field(default=None)
...
class GetSchedulesScheduleDDefaultApplicationJSON:
    ...
    results: Optional[List[GetSchedulesScheduleDDefaultApplicationJSONResults]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'results' }})
