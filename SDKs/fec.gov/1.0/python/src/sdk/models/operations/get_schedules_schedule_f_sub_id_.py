...
class GetSchedulesScheduleFSubIDRequest:
    path_params: GetSchedulesScheduleFSubIDPathParams = field(default=None)
    query_params: GetSchedulesScheduleFSubIDQueryParams = field(default=None)
...
class GetSchedulesScheduleFSubIDDefaultApplicationJSON:
    ...
    results: Optional[List[GetSchedulesScheduleFSubIDDefaultApplicationJSONResults]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'results' }})
