...
class GetCommitteeCommitteeIDCandidatesHistoryRequest:
    path_params: GetCommitteeCommitteeIDCandidatesHistoryPathParams = field(default=None)
    query_params: GetCommitteeCommitteeIDCandidatesHistoryQueryParams = field(default=None)
