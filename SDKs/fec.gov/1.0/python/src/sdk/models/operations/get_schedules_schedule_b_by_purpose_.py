...
class GetSchedulesScheduleBByPurposeQueryParams:
    ...
    purpose: Optional[List[str]] = field(default=None, metadata={'query_param': { 'field_name': 'purpose', 'style': 'form', 'explode': True }})
...
class GetSchedulesScheduleBByPurposeRequest:
    query_params: GetSchedulesScheduleBByPurposeQueryParams = field()
...
class GetSchedulesScheduleBByPurposeResponse:
    ...
    schedule_b_by_purpose_page: Optional[shared.ScheduleBByPurposePage] = field(default=None)
