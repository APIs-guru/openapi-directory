...
class GetSchedulesScheduleETotalsByCandidateRequest:
    query_params: GetSchedulesScheduleETotalsByCandidateQueryParams = field(default=None)
    

@dataclass
class GetSchedulesScheduleETotalsByCandidateResponse:
    content_type: str = field(default=None)
    ie_totals_by_candidate_page: Optional[shared.IeTotalsByCandidatePage] = field(default=None)
