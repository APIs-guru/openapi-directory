...
class GetElectionDatesQueryParams:
    ...
    max_election_date: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'max_election_date', 'style': 'form', 'explode': True }})
    max_primary_general_date: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'max_primary_general_date', 'style': 'form', 'explode': True }})
    ...
    min_election_date: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'min_election_date', 'style': 'form', 'explode': True }})
    min_primary_general_date: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'min_primary_general_date', 'style': 'form', 'explode': True }})
...
class GetElectionDatesRequest:
    query_params: GetElectionDatesQueryParams = field(default=None)
...
class GetElectionDatesDefaultApplicationJSON:
    ...
    results: Optional[List[shared.ElectionDate]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'results' }})
