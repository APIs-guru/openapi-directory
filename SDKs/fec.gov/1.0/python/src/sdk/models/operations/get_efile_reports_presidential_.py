...
@dataclass
class GetEfileReportsPresidentialQueryParams:
...
class GetEfileReportsPresidentialRequest:
    query_params: GetEfileReportsPresidentialQueryParams = field(default=None)
    

@dataclass
class GetEfileReportsPresidentialResponse:
    base_f3_p_filing_page: Optional[shared.BaseF3PFilingPage] = field(default=None)
