...
@dataclass
class GetEfileFilingsQueryParams:
...
@dataclass
class GetEfileFilingsRequest:
    query_params: GetEfileFilingsQueryParams = field(default=None)
    

@dataclass
class GetEfileFilingsResponse:
    content_type: str = field(default=None)
    e_filings_page: Optional[shared.EFilingsPage] = field(default=None)
