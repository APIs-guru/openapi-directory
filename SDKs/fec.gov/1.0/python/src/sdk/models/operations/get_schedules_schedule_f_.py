...
class GetSchedulesScheduleFDefaultApplicationJSON:
    ...
    results: Optional[List[GetSchedulesScheduleFDefaultApplicationJSONResults]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
    

@dataclass
class GetSchedulesScheduleFRequest:
    query_params: GetSchedulesScheduleFQueryParams = field()
