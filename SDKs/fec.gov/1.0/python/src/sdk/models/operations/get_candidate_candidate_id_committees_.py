...
class GetCandidateCandidateIDCommitteesRequest:
    path_params: GetCandidateCandidateIDCommitteesPathParams = field(default=None)
    query_params: GetCandidateCandidateIDCommitteesQueryParams = field(default=None)
