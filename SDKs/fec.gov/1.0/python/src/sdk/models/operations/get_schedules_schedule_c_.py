...
class GetSchedulesScheduleCQueryParams:
    ...
    max_incurred_date: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'max_incurred_date', 'style': 'form', 'explode': True }})
    ...
    min_incurred_date: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'min_incurred_date', 'style': 'form', 'explode': True }})
...
class GetSchedulesScheduleCRequest:
    query_params: GetSchedulesScheduleCQueryParams = field(default=None)
...
class GetSchedulesScheduleCDefaultApplicationJSONResults:
    ...
    due_date_terms: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'due_date_terms' }})
    ...
    entity_type_full: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'entity_type_full' }})
    fec_committee_id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'fec_committee_id' }})
    fec_election_type_full: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'fec_election_type_full' }})
    fec_election_type_year: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'fec_election_type_year' }})
    ...
    incurred_date: Optional[datetime] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'incurred_date', 'encoder': datetime.isoformat, 'decoder': dateutil.parser.isoparse, 'mm_field': fields.DateTime(format='iso') }})
    interest_rate_terms: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'interest_rate_terms' }})
    ...
    loan_balance: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'loan_balance' }})
    loan_source_city: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'loan_source_city' }})
    loan_source_first_name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'loan_source_first_name' }})
    loan_source_last_name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'loan_source_last_name' }})
    loan_source_middle_name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'loan_source_middle_name' }})
    loan_source_name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'loan_source_name' }})
    loan_source_prefix: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'loan_source_prefix' }})
    loan_source_state: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'loan_source_state' }})
    loan_source_street_1: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'loan_source_street_1' }})
    loan_source_street_2: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'loan_source_street_2' }})
    loan_source_suffix: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'loan_source_suffix' }})
    loan_source_zip: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'loan_source_zip' }})
    ...
    original_loan_amount: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'original_loan_amount' }})
    original_sub_id: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'original_sub_id' }})
    payment_to_date: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'payment_to_date' }})
    pdf_url: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'pdf_url' }})
    personally_funded: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'personally_funded' }})
    ...
    schedule_a_line_number: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'schedule_a_line_number' }})
    ...
    secured_ind: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'secured_ind' }})
...
class GetSchedulesScheduleCDefaultApplicationJSON:
    ...
    results: Optional[List[GetSchedulesScheduleCDefaultApplicationJSONResults]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'results' }})
