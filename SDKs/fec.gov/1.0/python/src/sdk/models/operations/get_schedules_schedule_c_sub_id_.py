...
class GetSchedulesScheduleCSubIDRequest:
    path_params: GetSchedulesScheduleCSubIDPathParams = field(default=None)
    query_params: GetSchedulesScheduleCSubIDQueryParams = field(default=None)
...
class GetSchedulesScheduleCSubIDDefaultApplicationJSON:
    ...
    results: Optional[List[GetSchedulesScheduleCSubIDDefaultApplicationJSONResults]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'results' }})
