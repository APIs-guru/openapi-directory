...
class GetSchedulesScheduleEQueryParams:
    ...
    last_expenditure_date: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'last_expenditure_date', 'style': 'form', 'explode': True }})
    ...
    max_filing_date: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'max_filing_date', 'style': 'form', 'explode': True }})
    ...
    min_filing_date: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'min_filing_date', 'style': 'form', 'explode': True }})
...
class GetSchedulesScheduleERequest:
    query_params: GetSchedulesScheduleEQueryParams = field(default=None)
