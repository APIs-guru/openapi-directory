...
class GetTotalsByEntityRequest:
    query_params: GetTotalsByEntityQueryParams = field(default=None)
    

@dataclass
class GetTotalsByEntityResponse:
    content_type: str = field(default=None)
    entity_receipt_disbursement_totals_page: Optional[shared.EntityReceiptDisbursementTotalsPage] = field(default=None)
