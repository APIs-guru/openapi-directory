...
class BaseF3PFiling:
    ...
    expenditure_subject_to_limits: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'expenditure_subject_to_limits' }})
    ...
    net_contributions_cycle_to_date: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'net_contributions_cycle_to_date' }})
    net_operating_expenditures_cycle_to_date: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'net_operating_expenditures_cycle_to_date' }})
    ...
    subtotal_summary_period: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'subtotal_summary_period' }})
