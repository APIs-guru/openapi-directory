...
from . import scheduleebycandidate
...
class ScheduleEByCandidatePage:
    ...
    results: Optional[List[scheduleebycandidate.ScheduleEByCandidate]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'results' }})
