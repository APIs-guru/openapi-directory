...
class ScheduleA:
    ...
    contributor: Optional[CommitteeHistory] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('contributor') }})
    ...
    contributor_id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('contributor_id') }})
    ...
    contributor_street_1: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('contributor_street_1') }})
    contributor_street_2: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('contributor_street_2') }})
    ...
    donor_committee_name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('donor_committee_name') }})
    ...
    increased_limit: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('increased_limit') }})
    is_individual: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('is_individual') }})
    ...
    receipt_type: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('receipt_type') }})
    receipt_type_desc: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('receipt_type_desc') }})
    receipt_type_full: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('receipt_type_full') }})
    recipient_committee_designation: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('recipient_committee_designation') }})
    recipient_committee_org_type: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('recipient_committee_org_type') }})
    recipient_committee_type: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('recipient_committee_type') }})
    ...
    unused_contbr_id: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('unused_contbr_id') }})
