...
from . import presidentialsummary
...
class PresidentialSummaryPage:
    ...
    results: Optional[List[presidentialsummary.PresidentialSummary]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'results' }})
