...
class ScheduleAEfile:
    ...
    contribution_receipt_date: Optional[date] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('contribution_receipt_date'), 'encoder': utils.dateisoformat(True), 'decoder': dateutil.parser.isoparse, 'mm_field': fields.DateTime(format='iso') }})
    contributor_aggregate_ytd: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('contributor_aggregate_ytd') }})
    contributor_city: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('contributor_city') }})
    contributor_employer: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('contributor_employer') }})
    contributor_first_name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('contributor_first_name') }})
    contributor_last_name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('contributor_last_name') }})
    contributor_middle_name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('contributor_middle_name') }})
    contributor_name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('contributor_name') }})
    contributor_occupation: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('contributor_occupation') }})
    contributor_prefix: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('contributor_prefix') }})
    ...
    contributor_suffix: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('contributor_suffix') }})
    contributor_zip: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('contributor_zip') }})
    ...
    fec_election_type_desc: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('fec_election_type_desc') }})
    ...
    pgo: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('pgo') }})
