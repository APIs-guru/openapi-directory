...
from . import schedulebbypurpose
...
class ScheduleBByPurposePage:
    ...
    results: Optional[List[schedulebbypurpose.ScheduleBByPurpose]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'results' }})
