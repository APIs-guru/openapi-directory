...
@dataclass
class BaseF3Filing:
    amended_address: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('amended_address') }})
    ...
    cash_on_hand_beginning_period: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('cash_on_hand_beginning_period') }})
    ...
    district: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('district') }})
    ...
    f3z1: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('f3z1') }})
    ...
    runoff_election: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('runoff_election') }})
    ...
    special_election: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('special_election') }})
