...
@dataclass_json
@dataclass
class PostVerifyPasswordChangeRequestBodySample:
...
class PostVerifyPasswordChangeRequest:
    request: PostVerifyPasswordChangeRequestBodySample = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
