...
func (s *SDK) GetBlockedNumbers(ctx context.Context, request operations.GetBlockedNumbersRequest) (*operations.GetBlockedNumbersResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) GetMessages(ctx context.Context, request operations.GetMessagesRequest) (*operations.GetMessagesResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) GetMessagesID(ctx context.Context, request operations.GetMessagesIDRequest) (*operations.GetMessagesIDResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) GetMessagesIDRelatedReceivedMessages(ctx context.Context, request operations.GetMessagesIDRelatedReceivedMessagesRequest) (*operations.GetMessagesIDRelatedReceivedMessagesResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) GetMessagesSend(ctx context.Context, request operations.GetMessagesSendRequest) (*operations.GetMessagesSendResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) PostBlockedNumbers(ctx context.Context, request operations.PostBlockedNumbersRequest) (*operations.PostBlockedNumbersResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/blocked-numbers"
...
func (s *SDK) PostMessages(ctx context.Context, request operations.PostMessagesRequest) (*operations.PostMessagesResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/messages"
...
func (s *SDK) PostRmmPreSignAttachment(ctx context.Context, request operations.PostRmmPreSignAttachmentRequest) (*operations.PostRmmPreSignAttachmentResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) PostWebhooksID(ctx context.Context, request operations.PostWebhooksIDRequest) (*operations.PostWebhooksIDResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/webhooks/{id}", request.PathParams)
