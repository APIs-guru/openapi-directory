...
func (s *Attachments) CreateAttachmentForTask(ctx context.Context, request operations.CreateAttachmentForTaskRequest) (*operations.CreateAttachmentForTaskResponse, error) {
	...
	url := utils.GenerateURL(ctx, baseURL, "/tasks/{task_gid}/attachments", request.PathParams)
...
func (s *Attachments) DeleteAttachment(ctx context.Context, request operations.DeleteAttachmentRequest) (*operations.DeleteAttachmentResponse, error) {
	baseURL := s._serverURL
	url := utils.GenerateURL(ctx, baseURL, "/attachments/{attachment_gid}", request.PathParams)
