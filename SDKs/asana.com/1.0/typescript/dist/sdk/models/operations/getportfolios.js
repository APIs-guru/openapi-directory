...
var GetPortfoliosQueryParams = /** @class */ (function (_super) {
    ...
    ], GetPortfoliosQueryParams.prototype, "limit", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=offset" }),
        __metadata("design:type", String)
    ], GetPortfoliosQueryParams.prototype, "offset", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=false;name=opt_fields" }),
        __metadata("design:type", Array)
    ], GetPortfoliosQueryParams.prototype, "optFields", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=opt_pretty" }),
        __metadata("design:type", Boolean)
    ], GetPortfoliosQueryParams.prototype, "optPretty", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=owner" }),
        __metadata("design:type", String)
    ], GetPortfoliosQueryParams.prototype, "owner", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=workspace" }),
        __metadata("design:type", String)
    ], GetPortfoliosQueryParams.prototype, "workspace", void 0);
    return GetPortfoliosQueryParams;
}(SpeakeasyBase));
export { GetPortfoliosQueryParams };
var GetPortfolios200ApplicationJson = /** @class */ (function (_super) {
    __extends(GetPortfolios200ApplicationJson, _super);
    function GetPortfolios200ApplicationJson() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=data", elemType: shared.PortfolioCompact }),
        __metadata("design:type", Array)
    ], GetPortfolios200ApplicationJson.prototype, "data", void 0);
    return GetPortfolios200ApplicationJson;
}(SpeakeasyBase));
export { GetPortfolios200ApplicationJson };
...
var GetPortfoliosResponse = /** @class */ (function (_super) {
    ...
    ], GetPortfoliosResponse.prototype, "errorResponse", void 0);
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", Number)
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", GetPortfolios200ApplicationJson)
    ], GetPortfoliosResponse.prototype, "getPortfolios200ApplicationJsonObject", void 0);
