...
class GetAttachmentsForTaskRequest:
    path_params: GetAttachmentsForTaskPathParams = field(default=None)
    query_params: GetAttachmentsForTaskQueryParams = field(default=None)
    

@dataclass_json
@dataclass
class GetAttachmentsForTask200ApplicationJSON:
    data: Optional[List[shared.AttachmentCompact]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'data' }})
