...
class AddDependentsForTaskRequest:
    path_params: AddDependentsForTaskPathParams = field()
    query_params: AddDependentsForTaskQueryParams = field()
    request: AddDependentsForTaskRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
