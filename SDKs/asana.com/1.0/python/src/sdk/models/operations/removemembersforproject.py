...
class RemoveMembersForProjectRequest:
    path_params: RemoveMembersForProjectPathParams = field(default=None)
    query_params: RemoveMembersForProjectQueryParams = field(default=None)
    request: RemoveMembersForProjectRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
