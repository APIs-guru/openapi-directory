...
class GetTimePeriodsQueryParams:
    ...
    end_on: Optional[date] = field(default=None, metadata={'query_param': { 'field_name': 'end_on', 'style': 'form', 'explode': True }})
...
class GetTimePeriods200ApplicationJSON:
    data: Optional[List[shared.TimePeriodCompact]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
    

@dataclass
class GetTimePeriodsRequest:
    query_params: GetTimePeriodsQueryParams = field()
