...
class AddSubgoalRequestBody:
    data: Optional[shared.GoalAddSubgoalRequest] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'data' }})
    

@dataclass
class AddSubgoalRequest:
    path_params: AddSubgoalPathParams = field(default=None)
    query_params: AddSubgoalQueryParams = field(default=None)
    request: AddSubgoalRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
