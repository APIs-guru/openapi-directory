...
class AddFollowersRequest:
    path_params: AddFollowersPathParams = field()
    query_params: AddFollowersQueryParams = field()
    request: AddFollowersRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
