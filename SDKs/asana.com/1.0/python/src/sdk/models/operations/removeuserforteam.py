...
class RemoveUserForTeamRequestBody:
    data: Optional[shared.TeamRemoveUserRequest] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class RemoveUserForTeamRequest:
    path_params: RemoveUserForTeamPathParams = field()
    query_params: RemoveUserForTeamQueryParams = field()
    request: RemoveUserForTeamRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
