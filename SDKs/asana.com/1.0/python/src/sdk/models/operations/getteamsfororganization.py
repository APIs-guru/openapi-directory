...
class GetTeamsForOrganizationRequest:
    path_params: GetTeamsForOrganizationPathParams = field(default=None)
    query_params: GetTeamsForOrganizationQueryParams = field(default=None)
...
class GetTeamsForOrganizationResponse:
    ...
    get_teams_for_organization_200_application_json_object: Optional[GetTeamsForOrganization200ApplicationJSON] = field(default=None)
