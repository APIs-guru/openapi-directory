...
class DeleteSectionRequest:
    path_params: DeleteSectionPathParams = field(default=None)
    query_params: DeleteSectionQueryParams = field(default=None)
...
class DeleteSectionResponse:
    ...
    delete_section_200_application_json_object: Optional[DeleteSection200ApplicationJSON] = field(default=None)
