...
class AddProjectForTaskRequestBody:
    data: Optional[shared.TaskAddProjectRequest] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class AddProjectForTaskRequest:
    path_params: AddProjectForTaskPathParams = field()
    query_params: AddProjectForTaskQueryParams = field()
    request: AddProjectForTaskRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
