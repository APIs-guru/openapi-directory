...
class GetTaskCountsForProject200ApplicationJSON:
    data: Optional[shared.TaskCountResponse] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
    

@dataclass
class GetTaskCountsForProjectRequest:
    path_params: GetTaskCountsForProjectPathParams = field()
    query_params: GetTaskCountsForProjectQueryParams = field()
