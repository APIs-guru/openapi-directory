...
class GetSectionsForProjectRequest:
    path_params: GetSectionsForProjectPathParams = field(default=None)
    query_params: GetSectionsForProjectQueryParams = field(default=None)
    

@dataclass_json
@dataclass
class GetSectionsForProject200ApplicationJSON:
    data: Optional[List[shared.SectionCompact]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'data' }})
