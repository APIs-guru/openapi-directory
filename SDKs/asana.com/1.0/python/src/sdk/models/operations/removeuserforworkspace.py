...
class RemoveUserForWorkspaceRequestBody:
    data: Optional[shared.WorkspaceRemoveUserRequest] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class RemoveUserForWorkspaceRequest:
    path_params: RemoveUserForWorkspacePathParams = field()
    query_params: RemoveUserForWorkspaceQueryParams = field()
    request: RemoveUserForWorkspaceRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
