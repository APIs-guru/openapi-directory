...
class SearchTasksForWorkspaceQueryParams:
    ...
    completed_on: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'completed_on', 'style': 'form', 'explode': True }})
    completed_on_after: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'completed_on.after', 'style': 'form', 'explode': True }})
    completed_on_before: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'completed_on.before', 'style': 'form', 'explode': True }})
    ...
    created_on: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'created_on', 'style': 'form', 'explode': True }})
    created_on_after: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'created_on.after', 'style': 'form', 'explode': True }})
    created_on_before: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'created_on.before', 'style': 'form', 'explode': True }})
    ...
    due_on: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'due_on', 'style': 'form', 'explode': True }})
    due_on_after: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'due_on.after', 'style': 'form', 'explode': True }})
    due_on_before: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'due_on.before', 'style': 'form', 'explode': True }})
    ...
    modified_on: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'modified_on', 'style': 'form', 'explode': True }})
    modified_on_after: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'modified_on.after', 'style': 'form', 'explode': True }})
    modified_on_before: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'modified_on.before', 'style': 'form', 'explode': True }})
    ...
    start_on_after: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'start_on.after', 'style': 'form', 'explode': True }})
    start_on_before: Optional[datetime] = field(default=None, metadata={'query_param': { 'field_name': 'start_on.before', 'style': 'form', 'explode': True }})
...
class SearchTasksForWorkspaceRequest:
    path_params: SearchTasksForWorkspacePathParams = field(default=None)
    query_params: SearchTasksForWorkspaceQueryParams = field(default=None)
