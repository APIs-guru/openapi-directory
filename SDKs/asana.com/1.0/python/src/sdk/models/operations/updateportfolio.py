...
@dataclass_json
@dataclass
class UpdatePortfolioRequestBody:
...
class UpdatePortfolioRequest:
    path_params: UpdatePortfolioPathParams = field(default=None)
    query_params: UpdatePortfolioQueryParams = field(default=None)
    request: UpdatePortfolioRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
