...
class GetTagsForWorkspaceRequest:
    path_params: GetTagsForWorkspacePathParams = field(default=None)
    query_params: GetTagsForWorkspaceQueryParams = field(default=None)
...
class GetTagsForWorkspaceResponse:
    ...
    get_tags_for_workspace_200_application_json_object: Optional[GetTagsForWorkspace200ApplicationJSON] = field(default=None)
