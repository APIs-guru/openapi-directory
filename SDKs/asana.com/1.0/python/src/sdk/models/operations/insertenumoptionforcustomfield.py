...
class InsertEnumOptionForCustomFieldRequestBody:
    data: Optional[shared.EnumOptionInsertRequest] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class InsertEnumOptionForCustomFieldRequest:
    path_params: InsertEnumOptionForCustomFieldPathParams = field()
    query_params: InsertEnumOptionForCustomFieldQueryParams = field()
