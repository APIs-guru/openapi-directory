...
class AddMembersForPortfolioRequest:
    path_params: AddMembersForPortfolioPathParams = field(default=None)
    query_params: AddMembersForPortfolioQueryParams = field(default=None)
    request: AddMembersForPortfolioRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
