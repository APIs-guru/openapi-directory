...
class AddUserForWorkspaceRequestBody:
    data: Optional[shared.WorkspaceAddUserRequest] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'data' }})
    

@dataclass
class AddUserForWorkspaceRequest:
    path_params: AddUserForWorkspacePathParams = field(default=None)
    query_params: AddUserForWorkspaceQueryParams = field(default=None)
    request: AddUserForWorkspaceRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
