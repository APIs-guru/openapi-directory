...
class CreateWebhookRequestBody:
    data: Optional[shared.WebhookRequest] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'data' }})
...
class CreateWebhook201ApplicationJSON:
    data: Optional[shared.WebhookResponse] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'data' }})
