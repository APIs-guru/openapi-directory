...
class GetPortfolioRequest:
    ...
    query_params: GetPortfolioQueryParams = field(default=None)
...
class GetPortfolioResponse:
    ...
    get_portfolio_200_application_json_object: Optional[GetPortfolio200ApplicationJSON] = field(default=None)
