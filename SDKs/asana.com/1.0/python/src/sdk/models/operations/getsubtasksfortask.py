...
class GetSubtasksForTaskRequest:
    path_params: GetSubtasksForTaskPathParams = field(default=None)
    query_params: GetSubtasksForTaskQueryParams = field(default=None)
...
class GetSubtasksForTaskResponse:
    ...
    get_subtasks_for_task_200_application_json_object: Optional[GetSubtasksForTask200ApplicationJSON] = field(default=None)
