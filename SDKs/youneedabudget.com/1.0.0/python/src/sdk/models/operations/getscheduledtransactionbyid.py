...
class GetScheduledTransactionByIDPathParams:
    ...
    scheduled_transaction_id: str = field(default=None, metadata={'path_param': { 'field_name': 'scheduled_transaction_id', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetScheduledTransactionByIDRequest:
    path_params: GetScheduledTransactionByIDPathParams = field(default=None)
