...
class CreateAccountRequest:
    path_params: CreateAccountPathParams = field(default=None)
    request: shared.SaveAccountWrapper = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
