...
class SignierteBelegdaten:
    ...
    beleg_datum_uhrzeit: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Beleg-Datum-Uhrzeit') }})
    belegnummer: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Belegnummer') }})
    betrag_brutto: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Betrag-Brutto') }})
    betrag_netto: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Betrag-Netto') }})
    betrag_satz_besonders_brutto: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Betrag-Satz-Besonders-Brutto') }})
    betrag_satz_besonders_netto: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Betrag-Satz-Besonders-Netto') }})
    betrag_satz_ermaessigt_1_brutto: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Betrag-Satz-Ermaessigt-1-Brutto') }})
    betrag_satz_ermaessigt_1_netto: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Betrag-Satz-Ermaessigt-1-Netto') }})
    betrag_satz_ermaessigt_2_brutto: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Betrag-Satz-Ermaessigt-2-Brutto') }})
    betrag_satz_ermaessigt_2_netto: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Betrag-Satz-Ermaessigt-2-Netto') }})
    betrag_satz_normal_brutto: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Betrag-Satz-Normal-Brutto') }})
    betrag_satz_normal_netto: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Betrag-Satz-Normal-Netto') }})
    betrag_satz_null_brutto: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Betrag-Satz-Null-Brutto') }})
    betrag_satz_null_netto: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Betrag-Satz-Null-Netto') }})
    ...
    unternehmen_id_typ: Optional[SignierteBelegdatenUnternehmenIDTypEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Unternehmen-ID-Typ') }})
    ...
    zertifikat_seriennummer: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Zertifikat-Seriennummer') }})
