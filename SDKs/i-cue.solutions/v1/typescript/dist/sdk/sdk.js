...
var SDK = /** @class */ (function () {
    ...
    **/
    SDK.prototype.deleteAdministrationEntityId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteAdministrationEntityIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/administration/entity/{id}", req.pathParams);
    ...
    **/
    SDK.prototype.deleteAdministrationPlanningLevel = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteAdministrationPlanningLevelRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/administration/planning-level";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "delete", headers: headers }, config)).then(function (httpRes) {
     ...
     * Delete user
    **/
    SDK.prototype.deleteAdministrationUserEntityIdId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteAdministrationUserEntityIdIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/administration/user/{entityId}/{id}", req.pathParams);
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "delete", headers: headers }, config)).then(function (httpRes) {
     ...
     * This is a iCUE only endpoint or Enterprise feature.
    **/
    SDK.prototype.getAdministrationEntity = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetAdministrationEntityRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/administration/entity";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.entities = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.getAdministrationPlanningLevels = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetAdministrationPlanningLevelsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/administration/planning-levels";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "get", headers: headers }, config)).then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.planningLevelInfoResponses = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.planningLevelInfoResponses = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
     ...
     * Get all users
    **/
    SDK.prototype.getAdministrationUserEntityId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetAdministrationUserEntityIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/administration/user/{entityId}", req.pathParams);
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "get", headers: headers }, config)).then(function (httpRes) {
    ...
    **/
    SDK.prototype.getForecastResultJobId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetForecastResultJobIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/forecast/result/{jobId}", req.pathParams);
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "get", headers: headers }, config)).then(function (httpRes) {
    ...
    **/
    SDK.prototype.getForecastStatusJobId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetForecastStatusJobIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/forecast/status/{jobId}", req.pathParams);
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "get", headers: headers }, config)).then(function (httpRes) {
    ...
    **/
    SDK.prototype.getHyperparameter = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetHyperparameterRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/hyperparameter";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "get", headers: headers }, config)).then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.hyperparameterModel = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.hyperparameterModel = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.getReportPerformancePlanningLevelId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetReportPerformancePlanningLevelIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/report/performance/{planningLevelId}", req.pathParams);
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "get", headers: headers }, config)).then(function (httpRes) {
    ...
    **/
    SDK.prototype.getReportPerformanceSkuRationalizationPlanningLevelId = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetReportPerformanceSkuRationalizationPlanningLevelIdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/report/performance/sku-rationalization/{planningLevelId}", req.pathParams);
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "get", headers: headers }, config)).then(function (httpRes) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.portfolioModels = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.portfolioModels = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.getReportPlanningLevelOrganization = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetReportPlanningLevelOrganizationRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/report/planning-level/organization";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "get", headers: headers }, config)).then(function (httpRes) {
    ...
    **/
    SDK.prototype.getReportPlanningLevelUser = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetReportPlanningLevelUserRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/report/planning-level/user";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "get", headers: headers }, config)).then(function (httpRes) {
    ...
    **/
    SDK.prototype.getReportUser = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetReportUserRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/report/user";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "get", headers: headers }, config)).then(function (httpRes) {
     ...
     * This is a iCUE only endpoint or Enterprise feature.
    **/
    SDK.prototype.postAdministrationEntity = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.postAdministrationEntity200ApplicationJsonUuidString = JSON.stringify(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data);
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.postAdministrationEntity200TextJsonUuidString = JSON.stringify(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data);
                    }
                    if (utils.MatchContentType(contentType, "text/plain")) {
                        res.postAdministrationEntity200TextPlainUuidString = JSON.stringify(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data);
                    }
                    break;
            }
            return res;
    ...
    **/
    SDK.prototype.postAdministrationPlanningLevelLock = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostAdministrationPlanningLevelLockRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/administration/planning-level/lock";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
    ...
    **/
    SDK.prototype.postAdministrationToken = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostAdministrationTokenRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/administration/token";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.postAdministrationToken200ApplicationJsonUuidString = JSON.stringify(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data);
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.postAdministrationToken200TextJsonUuidString = JSON.stringify(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data);
                    }
                    if (utils.MatchContentType(contentType, "text/plain")) {
                        res.postAdministrationToken200TextPlainUuidString = JSON.stringify(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data);
                    }
                    break;
            }
            return res;
    ...
    **/
    SDK.prototype.postAdministrationUser = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostAdministrationUserRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/administration/user";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.postAdministrationUser200ApplicationJsonUuidString = JSON.stringify(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data);
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.postAdministrationUser200TextJsonUuidString = JSON.stringify(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data);
                    }
                    if (utils.MatchContentType(contentType, "text/plain")) {
                        res.postAdministrationUser200TextPlainUuidString = JSON.stringify(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data);
                    }
                    break;
            }
            return res;
    ...
    **/
    SDK.prototype.postForecast = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.forecastResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.forecastResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.postForecastAi = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostForecastAiRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/forecast/AI";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    SDK.prototype.postForecastAiHistoryAndForecast = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostForecastAiHistoryAndForecastRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/forecast/AI/history-and-forecast";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.historyAndForecastResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.historyAndForecastResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.postForecastForecastBottomUp = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostForecastForecastBottomUpRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/forecast/forecast-bottom-up";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.forecastBottomUpResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.forecastBottomUpResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.postForecastForecastTopDown = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostForecastForecastTopDownRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/forecast/forecast-top-down";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    SDK.prototype.postForecastFullDetail = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostForecastFullDetailRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/forecast/full-detail";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.fullDetailsForecastResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.fullDetailsForecastResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.postForecastHistoryAndForecast = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostForecastHistoryAndForecastRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/forecast/history-and-forecast";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    SDK.prototype.postForecastOptimalParameter = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostForecastOptimalParameterRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/forecast/optimal-parameter";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.optimalParameterResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.optimalParameterResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.postForecastRerun = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostForecastRerunRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/forecast/rerun";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    SDK.prototype.postHyperparameter = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.postInventoryAmazonIpi = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostInventoryAmazonIpiRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/inventory/amazon-ipi";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "post", headers: headers }, config)).then(function (httpRes) {
     ...
     * Carrying Cost
    **/
    SDK.prototype.postInventoryCaryyingCost = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostInventoryCaryyingCostRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/inventory/caryying-cost";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "post", headers: headers }, config)).then(function (httpRes) {
    ...
    **/
    SDK.prototype.postInventoryEoq = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostInventoryEoqRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/inventory/eoq";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "post", headers: headers }, config)).then(function (httpRes) {
     ...
     * Calculate fill rate
    **/
    SDK.prototype.postInventoryFillRate = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostInventoryFillRateRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/inventory/fill-rate";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "post", headers: headers }, config)).then(function (httpRes) {
    ...
    **/
    SDK.prototype.postInventoryFinancialImapctForecastAccuracy = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostInventoryFinancialImapctForecastAccuracyRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/inventory/financial-imapct-forecast-accuracy";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "post", headers: headers }, config)).then(function (httpRes) {
     ...
     * Inventroy Turn-over
    **/
    SDK.prototype.postInventoryInventoryTurnover = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostInventoryInventoryTurnoverRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/inventory/inventory-turnover";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "post", headers: headers }, config)).then(function (httpRes) {
    ...
    **/
    SDK.prototype.postInventoryLtd = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostInventoryLtdRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/inventory/ltd";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "post", headers: headers }, config)).then(function (httpRes) {
    ...
    **/
    SDK.prototype.postInventoryMoq = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostInventoryMoqRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/inventory/moq";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "post", headers: headers }, config)).then(function (httpRes) {
    ...
    **/
    SDK.prototype.postInventoryOptimalServiceLevel = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostInventoryOptimalServiceLevelRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/inventory/optimal-service-level";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "post", headers: headers }, config)).then(function (httpRes) {
     ...
     * Re-order Point
    **/
    SDK.prototype.postInventoryReorderPoint = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostInventoryReorderPointRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/inventory/reorder-point";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "post", headers: headers }, config)).then(function (httpRes) {
     ...
     * Safety Stock
    **/
    SDK.prototype.postInventorySafetyStock = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostInventorySafetyStockRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/inventory/safety-stock";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "post", headers: headers }, config)).then(function (httpRes) {
    ...
    **/
    SDK.prototype.postInventoryServiceLevel = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostInventoryServiceLevelRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/inventory/service-level";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "post", headers: headers }, config)).then(function (httpRes) {
    ...
    **/
    SDK.prototype.postInventoryTurns = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostInventoryTurnsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/inventory/turns";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "post", headers: headers }, config)).then(function (httpRes) {
    ...
    **/
    SDK.prototype.postLifecycleManyToOne = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostLifecycleManyToOneRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/lifecycle/many-to-one";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.planningLevelDataDto = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.planningLevelDataDto = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
     ...
     * Supports the creation of artificial startup history for new products, based on a flexible mapping of old to new. This is an Enterprise feature.
    **/
    SDK.prototype.postLifecycleOneToOne = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostLifecycleOneToOneRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/lifecycle/one-to-one";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    SDK.prototype.postOutlier = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostOutlierRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/outlier";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.timeSeriesOutliersResponses = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.timeSeriesOutliersResponses = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.postPortfolio = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostPortfolioRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/portfolio";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    SDK.prototype.postPortfolioAbc = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostPortfolioAbcRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/portfolio/abc";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.portfolioAbcModels = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.portfolioAbcModels = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.postPortfolioForecastPerformanceRewind = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostPortfolioForecastPerformanceRewindRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/portfolio/forecast-performance-rewind";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.rewindResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.rewindResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.postPortfolioXyz = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostPortfolioXyzRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/portfolio/xyz";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.portfolioXyzModels = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.portfolioXyzModels = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
     ...
     * Bundle pricing
    **/
    SDK.prototype.postPricingBundlePricing = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostPricingBundlePricingRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/pricing/bundle-pricing";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "post", headers: headers }, config)).then(function (httpRes) {
    ...
    SDK.prototype.postPricingCompetitivePricing = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostPricingCompetitivePricingRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/pricing/competitive-pricing";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "post", headers: headers }, config)).then(function (httpRes) {
    ...
    SDK.prototype.postPricingCostPlusPricing = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostPricingCostPlusPricingRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/pricing/cost-plus-pricing";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "post", headers: headers }, config)).then(function (httpRes) {
    ...
    SDK.prototype.postPricingDecoyPricing = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostPricingDecoyPricingRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/pricing/decoy-pricing";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "post", headers: headers }, config)).then(function (httpRes) {
    ...
    SDK.prototype.postPricingOddPricing = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostPricingOddPricingRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/pricing/odd-pricing";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "post", headers: headers }, config)).then(function (httpRes) {
    ...
    SDK.prototype.postPricingPenetrationPricing = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostPricingPenetrationPricingRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/pricing/penetration-pricing";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "post", headers: headers }, config)).then(function (httpRes) {
    ...
    SDK.prototype.postPricingPriceElasticityOfDemand = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostPricingPriceElasticityOfDemandRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/pricing/price-elasticity-of-demand";
        var client = this._defaultClient;
        var headers = __assign(__assign({}, utils.GetHeadersFromRequest(req.headers)), config === null || config === void 0 ? void 0 : config.headers);
        return client
            .request(__assign({ url: url, method: "post", headers: headers }, config)).then(function (httpRes) {
     ...
     * This is a iCUE only endpoint or Enterprise feature.
    **/
    SDK.prototype.putAdministrationEntity = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Update user
    **/
    SDK.prototype.putAdministrationUser = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.putAdministrationUserLock = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PutAdministrationUserLockRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/administration/user/lock";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = utils.SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
