...
var ForecastResponse = /** @class */ (function (_super) {
    __extends(ForecastResponse, _super);
    function ForecastResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=hyperparameters" }),
        __metadata("design:type", ForecastHyperparameterResponse)
    ], ForecastResponse.prototype, "hyperparameters", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=timeSeries", elemType: TimeSeriesForecastResponse }),
        __metadata("design:type", Array)
    ], ForecastResponse.prototype, "timeSeries", void 0);
    return ForecastResponse;
}(SpeakeasyBase));
export { ForecastResponse };
