...
var RewindResponse = /** @class */ (function (_super) {
    __extends(RewindResponse, _super);
    function RewindResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=hyperparameters" }),
        __metadata("design:type", RewindHyperparameterResponse)
    ], RewindResponse.prototype, "hyperparameters", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=timeSeries", elemType: RewindTimeSeriesResponse }),
        __metadata("design:type", Array)
    ], RewindResponse.prototype, "timeSeries", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=totalCost" }),
        __metadata("design:type", Number)
    ], RewindResponse.prototype, "totalCost", void 0);
    return RewindResponse;
}(SpeakeasyBase));
export { RewindResponse };
