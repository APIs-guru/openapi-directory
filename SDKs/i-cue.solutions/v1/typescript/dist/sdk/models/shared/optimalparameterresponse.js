...
var OptimalParameterResponse = /** @class */ (function (_super) {
    __extends(OptimalParameterResponse, _super);
    function OptimalParameterResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=hyperparameters" }),
        __metadata("design:type", ForecastHyperparameterResponse)
    ], OptimalParameterResponse.prototype, "hyperparameters", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=timeSeries", elemType: TimeSeriesOptimalParametersResponse }),
        __metadata("design:type", Array)
    ], OptimalParameterResponse.prototype, "timeSeries", void 0);
    return OptimalParameterResponse;
}(SpeakeasyBase));
export { OptimalParameterResponse };
