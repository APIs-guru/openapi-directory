...
class PlanningLevelInfoResponse:
    ...
    hyperparameters: Optional[PlanningLevelHyperparameterResponse] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('hyperparameters') }})
    id: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('id') }})
    method: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('method') }})
    no_timeseries: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('noTimeseries') }})
    status: Optional[PlanningLevelInfoResponseStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
