...
class TimeSeriesFullDetailsResponse:
    ...
    forecast_data: Optional[List[PlanningLevelForecastResultData]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('forecastData') }})
    history_data: Optional[List[PlanningLevelForecastResultData]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('historyData') }})
