...
var SDK = /** @class */ (function () {
    ...
    **/
    SDK.prototype.CleanScanPage = function (req, config) {
    ...
    **/
    SDK.prototype.CleanScansPage = function (config) {
        var baseURL = this.serverURL;
    ...
    **/
    SDK.prototype.GetFindingPage = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Start a new scan.
    **/
    SDK.prototype.StartScanPage = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.StatusScanPage = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.StatusScansPage = function (config) {
        var baseURL = this.serverURL;
    ...
    **/
    SDK.prototype.StopScanPage = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.StopScansPage = function (config) {
        var baseURL = this.serverURL;
     ...
     * Return index page
    **/
    SDK.prototype.GetDefaultPage = function (config) {
        var baseURL = this.serverURL;
    ...
    **/
    SDK.prototype.GetInfoPage = function (config) {
        var baseURL = this.serverURL;
    ...
    **/
    SDK.prototype.GetLivenessPage = function (config) {
        var baseURL = this.serverURL;
     ...
     * Return liveness page
    **/
    SDK.prototype.GetReadinessPage = function (config) {
        var baseURL = this.serverURL;
     ...
     * Return test page
    **/
    SDK.prototype.GetTestPage = function (config) {
        var baseURL = this.serverURL;
    ...
    **/
    SDK.prototype.ReloadConfigurationPage = function (config) {
        var baseURL = this.serverURL;
