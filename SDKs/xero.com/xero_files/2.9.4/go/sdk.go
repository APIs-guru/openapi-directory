...
func (s *SDK) CreateFileAssociation(ctx context.Context, request operations.CreateFileAssociationRequest) (*operations.CreateFileAssociationResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) DeleteFileAssociation(ctx context.Context, request operations.DeleteFileAssociationRequest) (*operations.DeleteFileAssociationResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) GetAssociationsByObject(ctx context.Context, request operations.GetAssociationsByObjectRequest) (*operations.GetAssociationsByObjectResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) GetFileAssociations(ctx context.Context, request operations.GetFileAssociationsRequest) (*operations.GetFileAssociationsResponse, error) {
	baseURL := s.serverURL
	url := utils.GenerateURL(ctx, baseURL, "/Files/{FileId}/Associations", request.PathParams)
...
func (s *SDK) GetFileContent(ctx context.Context, request operations.GetFileContentRequest) (*operations.GetFileContentResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) GetFolders(ctx context.Context, request operations.GetFoldersRequest) (*operations.GetFoldersResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/Folders"
