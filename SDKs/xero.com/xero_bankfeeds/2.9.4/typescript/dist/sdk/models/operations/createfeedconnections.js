...
var CreateFeedConnectionsHeaders = /** @class */ (function (_super) {
    ...
    function CreateFeedConnectionsHeaders() {
...
export { CreateFeedConnectionsHeaders };
var CreateFeedConnectionsSecurity = /** @class */ (function (_super) {
    __extends(CreateFeedConnectionsSecurity, _super);
    function CreateFeedConnectionsSecurity() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
...
export { CreateFeedConnectionsSecurity };
var CreateFeedConnectionsRequest = /** @class */ (function (_super) {
    __extends(CreateFeedConnectionsRequest, _super);
    function CreateFeedConnectionsRequest() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata(),
...
export { CreateFeedConnectionsRequest };
var CreateFeedConnectionsResponse = /** @class */ (function (_super) {
    __extends(CreateFeedConnectionsResponse, _super);
    function CreateFeedConnectionsResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata(),
...
export { CreateFeedConnectionsResponse };
