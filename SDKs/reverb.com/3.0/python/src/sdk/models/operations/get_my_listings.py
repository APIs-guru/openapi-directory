...
@dataclass
class GetMyListingsQueryParams:
...
@dataclass
class GetMyListingsSecurity:
    oauth2: shared.SchemeOauth2 = field(default=None, metadata={'security': { 'scheme': True, 'type': 'oauth2' }})
    

@dataclass
class GetMyListingsRequest:
    query_params: GetMyListingsQueryParams = field(default=None)
    security: GetMyListingsSecurity = field(default=None)
