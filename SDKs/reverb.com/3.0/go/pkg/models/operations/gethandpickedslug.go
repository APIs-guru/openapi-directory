...
type GetHandpickedSlugPathParams struct {
    Slug string `pathParam:"style=simple,explode=false,name=slug"`
    
}

type GetHandpickedSlugQueryParams struct {
