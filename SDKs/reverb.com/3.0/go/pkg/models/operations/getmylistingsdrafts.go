...
type GetMyListingsDraftsQueryParams struct {
...
type GetMyListingsDraftsSecurity struct {
	Oauth2 shared.SchemeOauth2 `security:"scheme,type=oauth2"`
}

type GetMyListingsDraftsRequest struct {
	QueryParams GetMyListingsDraftsQueryParams
	Security    GetMyListingsDraftsSecurity
}

type GetMyListingsDraftsResponse struct {
	ContentType string
	StatusCode  int64
}
