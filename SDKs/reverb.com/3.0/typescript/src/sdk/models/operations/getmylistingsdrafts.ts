...
export class GetMyListingsDraftsQueryParams extends SpeakeasyBase {
...
export class GetMyListingsDraftsSecurity extends SpeakeasyBase {
  @Metadata({ data: "security, scheme=true;type=oauth2" })
  oauth2: shared.SchemeOauth2;
}


export class GetMyListingsDraftsRequest extends SpeakeasyBase {
  @Metadata()
...
export class GetMyListingsDraftsResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
