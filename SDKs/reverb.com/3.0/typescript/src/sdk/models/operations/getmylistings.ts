...
export class GetMyListingsQueryParams extends SpeakeasyBase {
...
export class GetMyListingsSecurity extends SpeakeasyBase {
  @Metadata({ data: "security, scheme=true;type=oauth2" })
  oauth2: shared.SchemeOauth2;
}


export class GetMyListingsRequest extends SpeakeasyBase {
  @Metadata()
...
export class GetMyListingsResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
