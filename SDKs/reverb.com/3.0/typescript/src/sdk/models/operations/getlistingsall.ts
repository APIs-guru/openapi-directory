...
export class GetListingsAllQueryParams extends SpeakeasyBase {
...
export class GetListingsAllRequest extends SpeakeasyBase {
  @Metadata()
  queryParams: GetListingsAllQueryParams;
}


export class GetListingsAllResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
