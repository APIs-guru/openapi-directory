...
class GetCommentsIdsQueryParams:
    ...
    order: Optional[GetCommentsIdsOrderEnum] = field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetCommentsIdsSortEnum] = field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetCommentsIdsRequest:
    path_params: GetCommentsIdsPathParams = field(default=None)
    query_params: GetCommentsIdsQueryParams = field(default=None)
