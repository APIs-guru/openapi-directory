...
class GetQuestionsFeaturedQueryParams:
    ...
    order: Optional[GetQuestionsFeaturedOrderEnum] = field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetQuestionsFeaturedSortEnum] = field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetQuestionsFeaturedRequest:
    query_params: GetQuestionsFeaturedQueryParams = field(default=None)
