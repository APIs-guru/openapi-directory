...
class GetPostsIdsQueryParams:
    ...
    order: Optional[GetPostsIdsOrderEnum] = field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetPostsIdsSortEnum] = field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetPostsIdsRequest:
    path_params: GetPostsIdsPathParams = field(default=None)
    query_params: GetPostsIdsQueryParams = field(default=None)
