...
class GetMeAnswersQueryParams:
    ...
    order: Optional[GetMeAnswersOrderEnum] = field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetMeAnswersSortEnum] = field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetMeAnswersRequest:
    query_params: GetMeAnswersQueryParams = field(default=None)
