...
class GetTagsModeratorOnlyQueryParams:
    ...
    order: Optional[GetTagsModeratorOnlyOrderEnum] = field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetTagsModeratorOnlySortEnum] = field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetTagsModeratorOnlyRequest:
    query_params: GetTagsModeratorOnlyQueryParams = field(default=None)
