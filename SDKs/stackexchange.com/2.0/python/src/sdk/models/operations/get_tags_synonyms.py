...
class GetTagsSynonymsOrderEnum(str, Enum):
    DESC = "desc"
    ASC = "asc"

class GetTagsSynonymsSortEnum(str, Enum):
    CREATION = "creation"
    APPLIED = "applied"
    ACTIVITY = "activity"
...
@dataclass
class GetTagsSynonymsQueryParams:
    ...
    order: Optional[GetTagsSynonymsOrderEnum] = field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    page: Optional[int] = field(default=None, metadata={'query_param': { 'field_name': 'page', 'style': 'form', 'explode': True }})
    pagesize: Optional[int] = field(default=None, metadata={'query_param': { 'field_name': 'pagesize', 'style': 'form', 'explode': True }})
    sort: Optional[GetTagsSynonymsSortEnum] = field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
    todate: Optional[int] = field(default=None, metadata={'query_param': { 'field_name': 'todate', 'style': 'form', 'explode': True }})
    

@dataclass
class GetTagsSynonymsRequest:
    query_params: GetTagsSynonymsQueryParams = field()
    

@dataclass
class GetTagsSynonymsResponse:
