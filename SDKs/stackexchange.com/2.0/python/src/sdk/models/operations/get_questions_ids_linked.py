...
class GetQuestionsIdsLinkedQueryParams:
    ...
    order: Optional[GetQuestionsIdsLinkedOrderEnum] = field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetQuestionsIdsLinkedSortEnum] = field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetQuestionsIdsLinkedRequest:
    path_params: GetQuestionsIdsLinkedPathParams = field(default=None)
    query_params: GetQuestionsIdsLinkedQueryParams = field(default=None)
