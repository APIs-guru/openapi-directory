...
class GetMeFavoritesOrderEnum(str, Enum):
    DESC = "desc"
    ASC = "asc"

class GetMeFavoritesSortEnum(str, Enum):
    ACTIVITY = "activity"
    CREATION = "creation"
    VOTES = "votes"
    ADDED = "added"
...
@dataclass
class GetMeFavoritesQueryParams:
    ...
    order: Optional[GetMeFavoritesOrderEnum] = field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetMeFavoritesSortEnum] = field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetMeFavoritesRequest:
    query_params: GetMeFavoritesQueryParams = field(default=None)
