...
class GetPostsIdsCommentsQueryParams:
    ...
    order: Optional[GetPostsIdsCommentsOrderEnum] = field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetPostsIdsCommentsSortEnum] = field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetPostsIdsCommentsRequest:
    path_params: GetPostsIdsCommentsPathParams = field(default=None)
    query_params: GetPostsIdsCommentsQueryParams = field(default=None)
