...
class GetMeBadgesQueryParams:
    ...
    order: Optional[GetMeBadgesOrderEnum] = field(default=None, metadata={'query_param': { 'field_name': 'order', 'style': 'form', 'explode': True }})
    ...
    sort: Optional[GetMeBadgesSortEnum] = field(default=None, metadata={'query_param': { 'field_name': 'sort', 'style': 'form', 'explode': True }})
...
class GetMeBadgesRequest:
    query_params: GetMeBadgesQueryParams = field(default=None)
