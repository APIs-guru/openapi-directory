...
var Groups = /** @class */ (function () {
    ...
    **/
    Groups.prototype.allServiceGroups = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AllServiceGroupsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/api/groups";
    ...
    **/
    Groups.prototype.deleteGroup = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/groups/{serviceGroupId}", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        return client
    ...
    **/
    Groups.prototype.patchGroup = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Get a service group
    **/
    Groups.prototype.serviceGroup = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
