...
var Apikeys = /** @class */ (function () {
     ...
     * Get all api keys
    **/
    Apikeys.prototype.allApiKeys = function (req, config) {
    ...
    **/
    Apikeys.prototype.apiKey = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ApiKeyRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/services/{serviceId}/apikeys/{clientId}", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
    ...
    **/
    Apikeys.prototype.apiKeyFromGroup = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ApiKeyFromGroupRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/groups/{groupId}/apikeys/{clientId}", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
    ...
    **/
    Apikeys.prototype.apiKeyFromGroupQuotas = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ApiKeyFromGroupQuotasRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/groups/{groupId}/apikeys/{clientId}/quotas", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.quotas = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    break;
    ...
    **/
    Apikeys.prototype.apiKeyGroup = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ApiKeyGroupRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/services/{serviceId}/apikeys/{clientId}/group", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
     ...
     * Get the quota state of an api key
    **/
    Apikeys.prototype.apiKeyQuotas = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ApiKeyQuotasRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/services/{serviceId}/apikeys/{clientId}/quotas", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
    ...
    **/
    Apikeys.prototype.apiKeys = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ApiKeysRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/services/{serviceId}/apikeys", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
     ...
     * Get all api keys for the group of a service
    **/
    Apikeys.prototype.apiKeysFromGroup = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.ApiKeysFromGroupRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/groups/{groupId}/apikeys", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
    ...
    **/
    Apikeys.prototype.createApiKey = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Apikeys.prototype.createApiKeyFromGroup = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Apikeys.prototype.deleteApiKey = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Apikeys.prototype.deleteApiKeyFromGroup = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Apikeys.prototype.patchApiKey = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Update an api key for a specified service descriptor with a diff
    **/
    Apikeys.prototype.patchApiKeyFromGroup = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Apikeys.prototype.resetApiKeyFromGroupQuotas = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Reset the quota state of an api key
    **/
    Apikeys.prototype.resetApiKeyQuotas = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Apikeys.prototype.updateApiKey = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Apikeys.prototype.updateApiKeyFromGroup = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
