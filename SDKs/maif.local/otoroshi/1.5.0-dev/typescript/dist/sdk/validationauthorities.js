...
var ValidationAuthorities = /** @class */ (function () {
    ...
    **/
    ValidationAuthorities.prototype.createClientValidator = function (req, config) {
        var _a;
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.validationAuthority = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
    ...
    **/
    ValidationAuthorities.prototype.deleteClientValidator = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteClientValidatorRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/client-validators/{id}", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        return client
    ...
    **/
    ValidationAuthorities.prototype.findAllClientValidators = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.validationAuthorities = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    break;
    ...
    **/
    ValidationAuthorities.prototype.findClientValidatorById = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    ValidationAuthorities.prototype.patchClientValidator = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Update one validation authorities by id
    **/
    ValidationAuthorities.prototype.updateClientValidator = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
