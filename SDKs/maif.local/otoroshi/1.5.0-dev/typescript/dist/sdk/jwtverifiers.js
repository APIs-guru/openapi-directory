...
var JwtVerifiers = /** @class */ (function () {
    ...
    **/
    JwtVerifiers.prototype.createGlobalJwtVerifier = function (req, config) {
        var _a;
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.globalJwtVerifier = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
    ...
    **/
    JwtVerifiers.prototype.deleteGlobalJwtVerifier = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteGlobalJwtVerifierRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/api/verifiers/{verifierId}", req.pathParams);
        var client = utils.CreateSecurityClient(this._defaultClient, req.security);
        return client
    ...
    **/
    JwtVerifiers.prototype.findAllGlobalJwtVerifiers = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.globalJwtVerifiers = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    break;
    ...
    **/
    JwtVerifiers.prototype.findGlobalJwtVerifiersById = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    JwtVerifiers.prototype.patchGlobalJwtVerifier = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Update one global JWT verifiers
    **/
    JwtVerifiers.prototype.updateGlobalJwtVerifier = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
