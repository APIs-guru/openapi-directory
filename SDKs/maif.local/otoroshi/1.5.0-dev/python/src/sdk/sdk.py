...
class SDK:
    ...
    def all_service_groups(self, request: operations.AllServiceGroupsRequest) -> operations.AllServiceGroupsResponse:
        warnings.simplefilter("ignore")
        ...
        res = operations.AllServiceGroupsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
    ...
    def create_client_validator(self, request: operations.CreateClientValidatorRequest) -> operations.CreateClientValidatorResponse:
        warnings.simplefilter("ignore")
        ...
        res = operations.CreateClientValidatorResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ValidationAuthority])
    ...
    def create_global_auth_module(self, request: operations.CreateGlobalAuthModuleRequest) -> operations.CreateGlobalAuthModuleResponse:
        warnings.simplefilter("ignore")
        ...
        res = operations.CreateGlobalAuthModuleResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
    ...
    def delete_client_validator(self, request: operations.DeleteClientValidatorRequest) -> operations.DeleteClientValidatorResponse:
        warnings.simplefilter("ignore")

        base_url = self.server_url
        url = utils.generate_url(base_url, "/api/client-validators/{id}", request.path_params)
        ...
        res = operations.DeleteClientValidatorResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.Deleted])
                res.deleted = out
    ...
    def delete_global_auth_module(self, request: operations.DeleteGlobalAuthModuleRequest) -> operations.DeleteGlobalAuthModuleResponse:
        warnings.simplefilter("ignore")

        base_url = self.server_url
        url = utils.generate_url(base_url, "/api/auths/{id}", request.path_params)
        ...
        res = operations.DeleteGlobalAuthModuleResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.Deleted])
                res.deleted = out
    ...
    def delete_group(self, request: operations.DeleteGroupRequest) -> operations.DeleteGroupResponse:
        ...
        base_url = self.server_url
        url = utils.generate_url(base_url, "/api/groups/{serviceGroupId}", request.path_params)
    ...
    def find_all_client_validators(self, request: operations.FindAllClientValidatorsRequest) -> operations.FindAllClientValidatorsResponse:
        warnings.simplefilter("ignore")
        ...
        res = operations.FindAllClientValidatorsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[List[shared.ValidationAuthority]])
    ...
    def find_all_global_auth_modules(self, request: operations.FindAllGlobalAuthModulesRequest) -> operations.FindAllGlobalAuthModulesResponse:
        warnings.simplefilter("ignore")
        ...
        res = operations.FindAllGlobalAuthModulesResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
    ...
    def find_client_validator_by_id(self, request: operations.FindClientValidatorByIDRequest) -> operations.FindClientValidatorByIDResponse:
        warnings.simplefilter("ignore")
        ...
        res = operations.FindClientValidatorByIDResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ValidationAuthority])
                res.validation_authority = out
    ...
    def find_global_auth_module_by_id(self, request: operations.FindGlobalAuthModuleByIDRequest) -> operations.FindGlobalAuthModuleByIDResponse:
        warnings.simplefilter("ignore")
        ...
        res = operations.FindGlobalAuthModuleByIDResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
    ...
    def full_export(self, request: operations.FullExportRequest) -> operations.FullExportResponse:
        warnings.simplefilter("ignore")

        base_url = self.server_url
        url = base_url.removesuffix("/") + "/api/otoroshi.json"
        ...
        res = operations.FullExportResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ImportExport])
                res.import_export = out
        elif r.status_code == 400:
            pass
        elif r.status_code == 401:
            pass
    ...
    def full_import(self, request: operations.FullImportRequest) -> operations.FullImportResponse:
        warnings.simplefilter("ignore")
        ...
        res = operations.FullImportResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
    ...
    def full_import_from_file(self, request: operations.FullImportFromFileRequest) -> operations.FullImportFromFileResponse:
        warnings.simplefilter("ignore")

        base_url = self.server_url
        url = base_url.removesuffix("/") + "/api/import"
        ...
        res = operations.FullImportFromFileResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.Done])
                res.done = out
    ...
    def global_live_stats(self, request: operations.GlobalLiveStatsRequest) -> operations.GlobalLiveStatsResponse:
        warnings.simplefilter("ignore")
        ...
        res = operations.GlobalLiveStatsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
    ...
    def health(self) -> operations.HealthResponse:
        ...
        res = operations.HealthResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.OtoroshiHealth])
                res.otoroshi_health = out
        elif r.status_code == 400:
            pass
        elif r.status_code == 404:
            pass
    ...
    def patch_client_validator(self, request: operations.PatchClientValidatorRequest) -> operations.PatchClientValidatorResponse:
        warnings.simplefilter("ignore")
        ...
        res = operations.PatchClientValidatorResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ValidationAuthority])
                res.validation_authority = out
    ...
    def patch_global_auth_module(self, request: operations.PatchGlobalAuthModuleRequest) -> operations.PatchGlobalAuthModuleResponse:
        warnings.simplefilter("ignore")
        ...
        res = operations.PatchGlobalAuthModuleResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
    ...
    def patch_group(self, request: operations.PatchGroupRequest) -> operations.PatchGroupResponse:
        warnings.simplefilter("ignore")
        ...
        res = operations.PatchGroupResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.Group])
                res.group = out
    ...
    def service_group(self, request: operations.ServiceGroupRequest) -> operations.ServiceGroupResponse:
        warnings.simplefilter("ignore")
        ...
        res = operations.ServiceGroupResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.Group])
                res.group = out
    ...
    def service_live_stats(self, request: operations.ServiceLiveStatsRequest) -> operations.ServiceLiveStatsResponse:
        warnings.simplefilter("ignore")

        base_url = self.server_url
        url = utils.generate_url(base_url, "/api/live/{id}", request.path_params)
        ...
        res = operations.ServiceLiveStatsResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.Stats])
                res.stats = out
    ...
    def update_client_validator(self, request: operations.UpdateClientValidatorRequest) -> operations.UpdateClientValidatorResponse:
        warnings.simplefilter("ignore")
        ...
        res = operations.UpdateClientValidatorResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.ValidationAuthority])
                res.validation_authority = out
    ...
    def update_global_auth_module(self, request: operations.UpdateGlobalAuthModuleRequest) -> operations.UpdateGlobalAuthModuleResponse:
        warnings.simplefilter("ignore")
        ...
        res = operations.UpdateGlobalAuthModuleResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
