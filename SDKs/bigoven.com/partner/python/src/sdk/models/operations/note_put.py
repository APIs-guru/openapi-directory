...
@dataclass
class NotePutRequest:
    path_params: NotePutPathParams = field(default=None)
    request: NotePutRequests = field(default=None)
    

@dataclass
class NotePutResponse:
