...
from . import api2_models_recipes_recipevideoresponse
...
class Api2ModelsRecipesRecipeResponse:
    ...
    videos: Optional[List[api2_models_recipes_recipevideoresponse.Api2ModelsRecipesRecipeVideoResponse]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Videos' }})
