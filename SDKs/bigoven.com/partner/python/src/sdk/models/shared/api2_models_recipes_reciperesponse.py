...
class Api2ModelsRecipesRecipeResponse:
    r"""Api2ModelsRecipesRecipeResponse
    ...
    videos: Optional[List[Api2ModelsRecipesRecipeVideoResponse]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Videos') }})
