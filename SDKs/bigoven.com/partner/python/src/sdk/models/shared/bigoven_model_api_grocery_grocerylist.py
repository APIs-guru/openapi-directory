...
@dataclass_json
@dataclass
class BigOvenModelAPIGroceryGroceryListInput:
    ...
    recipes: Optional[List[BigOvenModelAPIRecipeInfoInput]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Recipes') }})
