 ...
 *
**/
var GymDto = /** @class */ (function (_super) {
    __extends(GymDto, _super);
    function GymDto() {
    ...
    ], GymDto.prototype, "externalGymNumber", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=gymId" }),
        __metadata("design:type", Number)
    ], GymDto.prototype, "gymId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=gymName" }),
        __metadata("design:type", String)
    ], GymDto.prototype, "gymName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=location" }),
        __metadata("design:type", String)
    ], GymDto.prototype, "location", void 0);
    return GymDto;
}(SpeakeasyBase));
export { GymDto };
