...
export declare class EmployeeResponseDataAttributes extends SpeakeasyBase {
...
export declare class EmployeeResponseData extends SpeakeasyBase {
    attributes: EmployeeResponseDataAttributes[];
    type: string;
}
export declare class EmployeeResponse extends SpeakeasyBase {
