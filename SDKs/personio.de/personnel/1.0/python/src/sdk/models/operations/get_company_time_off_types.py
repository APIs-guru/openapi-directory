...
class GetCompanyTimeOffTypes200ApplicationJSON:
    data: Optional[List[shared.TimeOffTypeResource]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
...
class GetCompanyTimeOffTypesRequest:
    query_params: GetCompanyTimeOffTypesQueryParams = field()
