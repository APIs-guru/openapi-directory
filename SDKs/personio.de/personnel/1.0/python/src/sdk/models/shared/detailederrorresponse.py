...
class DetailedErrorResponseErrorDetailedMessage:
    ...
    employee: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'employee' }})
    end_time: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'end_time' }})
    error_msg: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'error_msg' }})
...
class DetailedErrorResponseError:
    ...
    detailed_message: Optional[List[DetailedErrorResponseErrorDetailedMessage]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'detailed_message' }})
...
class DetailedErrorResponse:
    error: DetailedErrorResponseError = field(default=None, metadata={'dataclasses_json': { 'field_name': 'error' }})
