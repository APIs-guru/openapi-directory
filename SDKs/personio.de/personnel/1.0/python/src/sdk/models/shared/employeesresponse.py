...
class EmployeesResponseData:
    attributes: List[EmployeesResponseDataAttributes] = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('attributes') }})
...
class EmployeesResponse:
    data: List[EmployeesResponseData] = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('data') }})
