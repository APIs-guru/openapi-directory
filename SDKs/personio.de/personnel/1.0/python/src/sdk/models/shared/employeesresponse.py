...
class EmployeesResponseData:
    attributes: List[EmployeesResponseDataAttributes] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'attributes' }})
...
class EmployeesResponse:
    data: List[EmployeesResponseData] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'data' }})
