...
class GetListsBestSellersHistoryJSON200ApplicationJSONResultsRanksHistory:
    ...
    ranks_last_week: Optional[Any] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ranks_last_week') }})
...
class GetListsBestSellersHistoryJSON200ApplicationJSONResults:
    ...
    isbns: Optional[List[GetListsBestSellersHistoryJSON200ApplicationJSONResultsIsbns]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('isbns') }})
    ...
    ranks_history: Optional[List[GetListsBestSellersHistoryJSON200ApplicationJSONResultsRanksHistory]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('ranks_history') }})
    reviews: Optional[List[GetListsBestSellersHistoryJSON200ApplicationJSONResultsReviews]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('reviews') }})
...
class GetListsBestSellersHistoryJSON200ApplicationJSON:
    ...
    results: Optional[List[GetListsBestSellersHistoryJSON200ApplicationJSONResults]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
    status: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
    

@dataclass
class GetListsBestSellersHistoryJSONRequest:
    query_params: GetListsBestSellersHistoryJSONQueryParams = field()
    security: GetListsBestSellersHistoryJSONSecurity = field()
