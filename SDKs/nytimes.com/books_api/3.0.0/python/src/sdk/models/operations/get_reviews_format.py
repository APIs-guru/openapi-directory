...
class GetReviewsFormatPathParams:
    format: GetReviewsFormatFormatEnum = field(metadata={'path_param': { 'field_name': 'format', 'style': 'simple', 'explode': False }})
...
class GetReviewsFormat200ApplicationJSONResults:
    book_author: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('book_author') }})
    book_title: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('book_title') }})
    byline: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('byline') }})
    isbn13: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('isbn13') }})
    publication_dt: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('publication_dt') }})
...
class GetReviewsFormat200ApplicationJSON:
    ...
    results: Optional[List[GetReviewsFormat200ApplicationJSONResults]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
    status: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
    

@dataclass
class GetReviewsFormatRequest:
    path_params: GetReviewsFormatPathParams = field()
    query_params: GetReviewsFormatQueryParams = field()
    security: GetReviewsFormatSecurity = field()
