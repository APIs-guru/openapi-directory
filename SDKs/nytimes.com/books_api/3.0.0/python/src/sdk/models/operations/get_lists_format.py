...
class GetListsFormatPathParams:
    format: GetListsFormatFormatEnum = field(metadata={'path_param': { 'field_name': 'format', 'style': 'simple', 'explode': False }})
...
class GetListsFormat200ApplicationJSONResults:
    ...
    book_details: Optional[List[GetListsFormat200ApplicationJSONResultsBookDetails]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('book_details') }})
    ...
    isbns: Optional[List[GetListsFormat200ApplicationJSONResultsIsbns]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('isbns') }})
    ...
    reviews: Optional[List[GetListsFormat200ApplicationJSONResultsReviews]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('reviews') }})
...
class GetListsFormat200ApplicationJSON:
    ...
    results: Optional[List[GetListsFormat200ApplicationJSONResults]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
    status: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
    

@dataclass
class GetListsFormatRequest:
    path_params: GetListsFormatPathParams = field()
    query_params: GetListsFormatQueryParams = field()
    security: GetListsFormatSecurity = field()
