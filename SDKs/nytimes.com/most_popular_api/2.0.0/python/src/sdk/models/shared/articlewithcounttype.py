...
class ArticleWithCountTypeMedia:
    ...
    media_metadata: Optional[ArticleWithCountTypeMediaMediaMetadata] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'media-metadata' }})
...
class ArticleWithCountType:
    ...
    count_type: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'count_type' }})
    ...
    media: Optional[List[ArticleWithCountTypeMedia]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'media' }})
