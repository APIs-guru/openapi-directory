  ...
  GetCriticsResourceTypeJson(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        let res: operations.GetCriticsResourceTypeJsonResponse = {statusCode: httpRes.status, contentType: contentType};
  ...
  GetReviewsResourceTypeJson(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.GetReviewsResourceTypeJsonResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
  ...
  GetReviewsSearchJson(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.GetReviewsSearchJsonResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
