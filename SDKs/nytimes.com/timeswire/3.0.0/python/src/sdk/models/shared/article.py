...
class Article:
    ...
    blog_name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('blog_name') }})
    ...
    des_facet: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('des_facet') }})
    geo_facet: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('geo_facet') }})
    headline: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('headline') }})
    item_type: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('item_type') }})
    kicker: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('kicker') }})
    material_type_facet: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('material_type_facet') }})
    multimedia: Optional[List[ArticleMultimedia]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('multimedia') }})
    org_facet: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('org_facet') }})
    per_facet: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('per_facet') }})
    published_date: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('published_date') }})
    related_urls: Optional[List[ArticleRelatedUrls]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('related_urls') }})
    section: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('section') }})
    short_url: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('short_url') }})
    source: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('source') }})
    subsection: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('subsection') }})
    thumbnail_standard: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('thumbnail_standard') }})
