...
class GetUserContentUserJSON200ApplicationJSONResultsCommentsAssetLabels:
    label_id: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('labelID') }})
...
class GetUserContentUserJSON200ApplicationJSONResultsCommentsAssetProperties:
    automoderation_off: Optional[GetUserContentUserJSON200ApplicationJSONResultsCommentsAssetPropertiesAutomoderationOff] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('automoderation-off') }})
    comment_list_sort_approvedate_desc: Optional[GetUserContentUserJSON200ApplicationJSONResultsCommentsAssetPropertiesCommentListSortApprovedateDesc] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('comment-list-sort-approvedate-desc') }})
    reached_max_com_on: Optional[GetUserContentUserJSON200ApplicationJSONResultsCommentsAssetPropertiesReachedMaxComOn] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('reached-max-com-on') }})
    

@dataclass_json
@dataclass
class GetUserContentUserJSON200ApplicationJSONResultsCommentsAsset:
    all_properties: Optional[List[GetUserContentUserJSON200ApplicationJSONResultsCommentsAssetAllProperties]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('all-properties') }})
    ...
    labels: Optional[List[GetUserContentUserJSON200ApplicationJSONResultsCommentsAssetLabels]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('labels') }})
    properties: Optional[GetUserContentUserJSON200ApplicationJSONResultsCommentsAssetProperties] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('properties') }})
...
class GetUserContentUserJSON200ApplicationJSONResultsComments:
    ...
    asset: Optional[GetUserContentUserJSON200ApplicationJSONResultsCommentsAsset] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('asset') }})
    ...
    permid: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('permid') }})
    ...
    update_date: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('updateDate') }})
    user_display_name: Optional[Any] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('userDisplayName') }})
    user_id: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('userID') }})
    user_location: Optional[Any] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('userLocation') }})
    user_submitted_display_name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('userSubmittedDisplayName') }})
    user_submitted_location: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('userSubmittedLocation') }})
    user_submitted_title: Optional[Any] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('userSubmittedTitle') }})
    user_submitted_url: Optional[Any] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('userSubmittedURL') }})
...
class GetUserContentUserJSON200ApplicationJSONResults:
    ...
    comments: Optional[List[GetUserContentUserJSON200ApplicationJSONResultsComments]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('comments') }})
...
class GetUserContentUserJSON200ApplicationJSON:
    ...
    debug: Optional[GetUserContentUserJSON200ApplicationJSONDebug] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('debug') }})
    results: Optional[GetUserContentUserJSON200ApplicationJSONResults] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
    status: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
    

@dataclass
class GetUserContentUserJSONRequest:
    query_params: GetUserContentUserJSONQueryParams = field()
    security: GetUserContentUserJSONSecurity = field()
