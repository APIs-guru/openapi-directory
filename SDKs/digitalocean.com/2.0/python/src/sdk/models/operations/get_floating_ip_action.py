...
class GetFloatingIPActionRequest:
    path_params: GetFloatingIPActionPathParams = field(default=None)
...
class GetFloatingIPActionResponse:
    ...
    get_floating_ip_action_200_application_json_any: Optional[Any] = field(default=None)
    get_floating_ip_action_401_application_json_object: Optional[GetFloatingIPAction401ApplicationJSON] = field(default=None)
