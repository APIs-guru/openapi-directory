...
class GetAlertPolicyRequest:
    path_params: GetAlertPolicyPathParams = field(default=None)
...
class GetAlertPolicyResponse:
    ...
    get_alert_policy_401_application_json_object: Optional[GetAlertPolicy401ApplicationJSON] = field(default=None)
