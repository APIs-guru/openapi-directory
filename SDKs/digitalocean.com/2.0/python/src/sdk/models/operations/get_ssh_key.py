...
class GetSSHKeyResponse:
    ...
    get_ssh_key_200_application_json_any: Optional[Any] = field(default=None)
    get_ssh_key_401_application_json_object: Optional[GetSSHKey401ApplicationJSON] = field(default=None)
