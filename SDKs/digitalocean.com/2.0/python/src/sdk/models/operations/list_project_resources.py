...
class ListProjectResourcesRequest:
    path_params: ListProjectResourcesPathParams = field(default=None)
...
class ListProjectResources200ApplicationJSONResources:
    ...
    links: Optional[ListProjectResources200ApplicationJSONResourcesLinks] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'links' }})
    status: Optional[ListProjectResources200ApplicationJSONResourcesStatusEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
...
class ListProjectResources200ApplicationJSON:
    links: Optional[ListProjectResources200ApplicationJSONLinks] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'links' }})
    meta: ListProjectResources200ApplicationJSONMeta = field(default=None, metadata={'dataclasses_json': { 'field_name': 'meta' }})
    resources: Optional[List[ListProjectResources200ApplicationJSONResources]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'resources' }})
...
class ListProjectResourcesResponse:
    ...
    list_project_resources_200_application_json_object: Optional[ListProjectResources200ApplicationJSON] = field(default=None)
    list_project_resources_401_application_json_object: Optional[ListProjectResources401ApplicationJSON] = field(default=None)
