...
class GetReplicaRequest:
    path_params: GetReplicaPathParams = field(default=None)
    

@dataclass_json
@dataclass
class GetReplica200ApplicationJSON:
...
class GetReplicaResponse:
    ...
    get_replica_200_application_json_object: Optional[GetReplica200ApplicationJSON] = field(default=None)
    get_replica_401_application_json_object: Optional[GetReplica401ApplicationJSON] = field(default=None)
