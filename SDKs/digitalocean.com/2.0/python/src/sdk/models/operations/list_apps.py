...
@dataclass_json
@dataclass
class ListApps200ApplicationJSONAppsRegionGeographicalInformationAboutAnAppOrigin:
...
class ListApps200ApplicationJSONApps:
    ...
    region: Optional[ListApps200ApplicationJSONAppsRegionGeographicalInformationAboutAnAppOrigin] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'region' }})
