...
class GetFirewallResponse:
    ...
    get_firewall_200_application_json_any: Optional[Any] = field(default=None)
    get_firewall_401_application_json_object: Optional[GetFirewall401ApplicationJSON] = field(default=None)
