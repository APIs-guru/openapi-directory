...
class UpdateDomainRecordResponse:
    ...
    update_domain_record_200_application_json_any: Optional[Any] = field(default=None)
    update_domain_record_401_application_json_object: Optional[UpdateDomainRecord401ApplicationJSON] = field(default=None)
