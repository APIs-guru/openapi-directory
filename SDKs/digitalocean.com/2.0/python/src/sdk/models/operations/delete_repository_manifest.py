...
class DeleteRepositoryManifestPathParams:
    manifest_digest: str = field(default=None, metadata={'path_param': { 'field_name': 'manifest_digest', 'style': 'simple', 'explode': False }})
...
class DeleteRepositoryManifestRequest:
    path_params: DeleteRepositoryManifestPathParams = field(default=None)
...
class DeleteRepositoryManifestResponse:
    ...
    delete_repository_manifest_401_application_json_object: Optional[DeleteRepositoryManifest401ApplicationJSON] = field(default=None)
