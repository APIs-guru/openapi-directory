...
class GetDomainRecordResponse:
    ...
    get_domain_record_200_application_json_any: Optional[Any] = field(default=None)
    get_domain_record_401_application_json_object: Optional[GetDomainRecord401ApplicationJSON] = field(default=None)
