...
from . import _1v2_1monitoring_1alerts_get_responses_200_content_application_1json_schema_allof_0_properties_policies_items_properties_alerts
...
class Onev21monitoring1alertsPostRequestBodyContentApplication1jsonSchema:
    alerts: _1v2_1monitoring_1alerts_get_responses_200_content_application_1json_schema_allof_0_properties_policies_items_properties_alerts.Onev21monitoring1alertsGetResponses200ContentApplication1jsonSchemaAllOf0PropertiesPoliciesItemsPropertiesAlerts = field(default=None, metadata={'dataclasses_json': { 'field_name': 'alerts' }})
    compare: Onev21monitoring1alertsPostRequestBodyContentApplication1jsonSchemaCompareEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'compare' }})
    ...
    type: Onev21monitoring1alertsPostRequestBodyContentApplication1jsonSchemaTypeEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'type' }})
    value: float = field(default=None, metadata={'dataclasses_json': { 'field_name': 'value' }})
    window: Onev21monitoring1alertsPostRequestBodyContentApplication1jsonSchemaWindowEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'window' }})
