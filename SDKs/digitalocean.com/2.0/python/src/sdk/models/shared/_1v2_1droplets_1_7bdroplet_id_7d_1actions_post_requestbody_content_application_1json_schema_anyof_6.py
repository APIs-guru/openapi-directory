...
class Onev21droplets1Percent7BdropletIDPercent7D1actionsPostRequestBodyContentApplication1jsonSchemaAnyOf6:
    ...
    type: Onev21droplets1Percent7BdropletIDPercent7D1actionsPostRequestBodyContentApplication1jsonSchemaAnyOf6TypeEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'type' }})
