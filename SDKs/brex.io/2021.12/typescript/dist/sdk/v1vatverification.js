...
var V1VatVerification = /** @class */ (function () {
    ...
    **/
    V1VatVerification.prototype.vatBasic = function (req, config) {
        var _a;
    ...
    **/
    V1VatVerification.prototype.vatComprehensive = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    V1VatVerification.prototype.vatLevelTwo = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    V1VatVerification.prototype.vatLookup = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
