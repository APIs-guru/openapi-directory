...
func (s *SDK) PostGet3dsAvailability(ctx context.Context, request operations.PostGet3dsAvailabilityRequest) (*operations.PostGet3dsAvailabilityResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) PostGetCostEstimate(ctx context.Context, request operations.PostGetCostEstimateRequest) (*operations.PostGetCostEstimateResponse, error) {
	baseURL := s.serverURL
