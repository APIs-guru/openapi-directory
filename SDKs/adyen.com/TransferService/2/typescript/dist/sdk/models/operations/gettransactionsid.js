...
var GetTransactionsIdSecurity = /** @class */ (function (_super) {
    __extends(GetTransactionsIdSecurity, _super);
    function GetTransactionsIdSecurity() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header" }),
        __metadata("design:type", shared.SchemeApiKeyAuth)
    ], GetTransactionsIdSecurity.prototype, "apiKeyAuth", void 0);
    return GetTransactionsIdSecurity;
}(SpeakeasyBase));
export { GetTransactionsIdSecurity };
var GetTransactionsIdRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", GetTransactionsIdSecurity)
    ], GetTransactionsIdRequest.prototype, "security", void 0);
...
var GetTransactionsIdResponse = /** @class */ (function (_super) {
    ...
    ], GetTransactionsIdResponse.prototype, "restServiceError", void 0);
    __decorate([
        SpeakeasyMetadata(),
