...
class SDK:
    ...
    def post_notify_shopper(self, request: operations.PostNotifyShopperRequest) -> operations.PostNotifyShopperResponse:
        r"""Notify the shopper for upcoming recurring payment
        ...
        res = operations.PostNotifyShopperResponse(status_code=r.status_code, content_type=content_type)
