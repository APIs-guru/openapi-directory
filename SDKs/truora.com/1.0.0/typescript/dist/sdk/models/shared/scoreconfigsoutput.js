...
**/
var ScoreConfigsOutput = /** @class */ (function (_super) {
    __extends(ScoreConfigsOutput, _super);
    function ScoreConfigsOutput() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=score_configs", elemType: ScoreConfigOutput }),
        __metadata("design:type", Array)
    ], ScoreConfigsOutput.prototype, "scoreConfigs", void 0);
    return ScoreConfigsOutput;
}(SpeakeasyBase));
export { ScoreConfigsOutput };
