...
class PostPortfolioAnalysisMeanVarianceMinimumVarianceFrontierRequestBody:
    ...
    constraints: Optional[PostPortfolioAnalysisMeanVarianceMinimumVarianceFrontierRequestBodyConstraints] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'constraints' }})
...
class PostPortfolioAnalysisMeanVarianceMinimumVarianceFrontierRequest:
    request: PostPortfolioAnalysisMeanVarianceMinimumVarianceFrontierRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
...
class PostPortfolioAnalysisMeanVarianceMinimumVarianceFrontier200ApplicationJSON:
    portfolios: List[PostPortfolioAnalysisMeanVarianceMinimumVarianceFrontier200ApplicationJSONPortfolios] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'portfolios' }})
