...
class PostPortfolioOptimizationMaximumSharpeRatioRequestBody:
    ...
    constraints: Optional[PostPortfolioOptimizationMaximumSharpeRatioRequestBodyConstraints] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('constraints') }})
...
class PostPortfolioOptimizationMaximumSharpeRatioRequest:
    request: PostPortfolioOptimizationMaximumSharpeRatioRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
