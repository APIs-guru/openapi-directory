...
class PostPortfolioOptimizationMaximumReturnRequestBody:
    ...
    assets_covariance_matrix: Optional[List[List[float]]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('assetsCovarianceMatrix') }})
    constraints: Optional[PostPortfolioOptimizationMaximumReturnRequestBodyConstraints] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('constraints') }})
...
class PostPortfolioOptimizationMaximumReturnRequest:
    request: PostPortfolioOptimizationMaximumReturnRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
