...
class PostPortfolioOptimizationMostDiversifiedRequestBody:
    ...
    constraints: Optional[PostPortfolioOptimizationMostDiversifiedRequestBodyConstraints] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('constraints') }})
...
class PostPortfolioOptimizationMostDiversifiedRequest:
    request: PostPortfolioOptimizationMostDiversifiedRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
