...
class PostPortfolioOptimizationMaximumDecorrelationRequestBody:
    ...
    constraints: Optional[PostPortfolioOptimizationMaximumDecorrelationRequestBodyConstraints] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'constraints' }})
    

@dataclass
class PostPortfolioOptimizationMaximumDecorrelationRequest:
    request: PostPortfolioOptimizationMaximumDecorrelationRequestBody = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
