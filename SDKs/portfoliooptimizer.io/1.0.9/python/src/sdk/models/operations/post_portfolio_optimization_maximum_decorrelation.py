...
class PostPortfolioOptimizationMaximumDecorrelationRequestBody:
    ...
    constraints: Optional[PostPortfolioOptimizationMaximumDecorrelationRequestBodyConstraints] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('constraints') }})
...
class PostPortfolioOptimizationMaximumDecorrelationRequest:
    request: PostPortfolioOptimizationMaximumDecorrelationRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
...
class PostPortfolioOptimizationMaximumDecorrelationResponse:
    ...
    post_portfolio_optimization_maximum_decorrelation_200_application_json_object: Optional[PostPortfolioOptimizationMaximumDecorrelation200ApplicationJSON] = field(default=None)
