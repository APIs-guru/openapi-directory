...
class PostPortfolioAnalysisMeanVarianceEfficientFrontierRequestBody:
    ...
    constraints: Optional[PostPortfolioAnalysisMeanVarianceEfficientFrontierRequestBodyConstraints] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('constraints') }})
...
class PostPortfolioAnalysisMeanVarianceEfficientFrontier200ApplicationJSON:
    portfolios: List[PostPortfolioAnalysisMeanVarianceEfficientFrontier200ApplicationJSONPortfolios] = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('portfolios') }})
    

@dataclass
class PostPortfolioAnalysisMeanVarianceEfficientFrontierRequest:
    request: PostPortfolioAnalysisMeanVarianceEfficientFrontierRequestBody = field(metadata={'request': { 'media_type': 'application/json' }})
...
class PostPortfolioAnalysisMeanVarianceEfficientFrontierResponse:
    ...
    post_portfolio_analysis_mean_variance_efficient_frontier_200_application_json_object: Optional[PostPortfolioAnalysisMeanVarianceEfficientFrontier200ApplicationJSON] = field(default=None)
