...
(function (ResourceNotFoundProblemResourceTypeEnum) {
    ...
    ResourceNotFoundProblemResourceTypeEnum["Media"] = "media";
})(ResourceNotFoundProblemResourceTypeEnum || (ResourceNotFoundProblemResourceTypeEnum = {}));
// ResourceNotFoundProblem
/**
 * A problem that indicates that a given Tweet, User, etc. does not exist.
**/
var ResourceNotFoundProblem = /** @class */ (function (_super) {
    __extends(ResourceNotFoundProblem, _super);
    function ResourceNotFoundProblem() {
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], ResourceNotFoundProblem.prototype, "resourceId", void 0);
    __decorate([
