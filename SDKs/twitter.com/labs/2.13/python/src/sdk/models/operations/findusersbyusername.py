...
class FindUsersByUsernameQueryParams:
    ...
    usernames: List[str] = field(default=None, metadata={'query_param': { 'field_name': 'usernames', 'style': 'form', 'explode': False }})
    

@dataclass
class FindUsersByUsernameRequest:
    query_params: FindUsersByUsernameQueryParams = field(default=None)
