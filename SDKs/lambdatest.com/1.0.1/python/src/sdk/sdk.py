...
class SDK:
    ...
    def profiles(self, request: operations.ProfilesRequest) -> operations.ProfilesResponse:
        ...
        res = operations.ProfilesResponse(status_code=r.status_code, content_type=content_type)
    ...
    def resolutions(self, request: operations.ResolutionsRequest) -> operations.ResolutionsResponse:
        ...
        res = operations.ResolutionsResponse(status_code=r.status_code, content_type=content_type)
    ...
    def start_screenshot_test(self, request: operations.StartScreenshotTestRequest) -> operations.StartScreenshotTestResponse:
        ...
        res = operations.StartScreenshotTestResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.StartScreenshotSuccess])
                res.start_screenshot_success = out
        elif r.status_code == 400:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.StartScreenshotBadRequest])
                res.start_screenshot_bad_request = out
        elif r.status_code == 401:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.access_denied = out
    ...
    def devices(self, request: operations.DevicesRequest) -> operations.DevicesResponse:
        ...
        res = operations.DevicesResponse(status_code=r.status_code, content_type=content_type)
    ...
    def os_browsers(self, request: operations.OsBrowsersRequest) -> operations.OsBrowsersResponse:
        ...
        res = operations.OsBrowsersResponse(status_code=r.status_code, content_type=content_type)
    ...
    def stop_screenshots_test(self, request: operations.StopScreenshotsTestRequest) -> operations.StopScreenshotsTestResponse:
        ...
        res = operations.StopScreenshotsTestResponse(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.stop_screenshot_success = out
        elif r.status_code == 401:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.access_denied = out
            ...
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[Any])
                res.stop_screenshot_not_found = out
