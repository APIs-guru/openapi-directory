...
class BatchGeneratePdfV1201ApplicationJSONStatusEnum(str, Enum):
    SUCCESS = "success"
    ERROR = "error"
...
@dataclass_json
@dataclass
class BatchGeneratePdfV1201ApplicationJSONCreateSubmissionResponse:
    errors: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'errors' }})
    status: BatchGeneratePdfV1201ApplicationJSONStatusEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
...
class BatchGeneratePdfV1Response:
    ...
    create_submission_responses: Optional[List[BatchGeneratePdfV1201ApplicationJSONCreateSubmissionResponse]] = field(default=None)
