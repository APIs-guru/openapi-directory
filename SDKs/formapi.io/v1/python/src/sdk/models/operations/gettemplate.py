...
class GetTemplateTemplateExpirationIntervalEnum(str, Enum):
    MINUTES = "minutes"
    HOURS = "hours"
    DAYS = "days"
...
class GetTemplateTemplate:
    ...
    expiration_interval: Optional[GetTemplateTemplateExpirationIntervalEnum] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('expiration_interval') }})
...
class GetTemplateRequest:
    path_params: GetTemplatePathParams = field()
    security: GetTemplateSecurity = field()
...
class GetTemplateResponse:
    ...
    template: Optional[GetTemplateTemplate] = field(default=None)
