...
class CloudNetworkServiceConfigStateEnum(str, Enum):
    REQUESTED = "requested"
    ALLOCATED = "allocated"
    TESTING = "testing"
...
class CloudNetworkServiceConfig:
    ...
    state: CloudNetworkServiceConfigStateEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'state' }})
