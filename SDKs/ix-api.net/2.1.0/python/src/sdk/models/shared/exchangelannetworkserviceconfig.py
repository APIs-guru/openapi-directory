...
class ExchangeLanNetworkServiceConfigStateEnum(str, Enum):
    REQUESTED = "requested"
    ALLOCATED = "allocated"
    TESTING = "testing"
...
class ExchangeLanNetworkServiceConfig:
    ...
    state: ExchangeLanNetworkServiceConfigStateEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'state' }})
