...
class P2MpNetworkProductOfferingPartialProviderVlansEnum(str, Enum):
    SINGLE = "single"
    MULTI = "multi"

class P2MpNetworkProductOfferingPartialResourceTypeEnum(str, Enum):
...
class P2MpNetworkProductOfferingPartial:
    ...
    provider_vlans: Optional[P2MpNetworkProductOfferingPartialProviderVlansEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'provider_vlans' }})
    resource_type: Optional[P2MpNetworkProductOfferingPartialResourceTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'resource_type' }})
