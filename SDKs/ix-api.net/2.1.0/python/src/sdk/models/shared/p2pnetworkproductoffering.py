...
class P2PNetworkProductOfferingProviderVlansEnum(str, Enum):
    SINGLE = "single"
    MULTI = "multi"

class P2PNetworkProductOfferingResourceTypeEnum(str, Enum):
...
class P2PNetworkProductOffering:
    ...
    provider_vlans: P2PNetworkProductOfferingProviderVlansEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'provider_vlans' }})
    resource_type: P2PNetworkProductOfferingResourceTypeEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'resource_type' }})
