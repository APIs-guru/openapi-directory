...
class ExchangeLanNetworkProductOfferingPartialProviderVlansEnum(str, Enum):
    SINGLE = "single"
    MULTI = "multi"

class ExchangeLanNetworkProductOfferingPartialResourceTypeEnum(str, Enum):
...
class ExchangeLanNetworkProductOfferingPartial:
    ...
    exchange_lan_network_service: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'exchange_lan_network_service' }})
    ...
    provider_vlans: Optional[ExchangeLanNetworkProductOfferingPartialProviderVlansEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'provider_vlans' }})
    resource_type: Optional[ExchangeLanNetworkProductOfferingPartialResourceTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'resource_type' }})
