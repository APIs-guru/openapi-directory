...
class Mp2MpNetworkServiceConfigStateEnum(str, Enum):
    REQUESTED = "requested"
    ALLOCATED = "allocated"
    TESTING = "testing"
...
class Mp2MpNetworkServiceConfig:
    ...
    state: Mp2MpNetworkServiceConfigStateEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'state' }})
