...
class P2PNetworkProductOfferingPartialProviderVlansEnum(str, Enum):
    SINGLE = "single"
    MULTI = "multi"

class P2PNetworkProductOfferingPartialResourceTypeEnum(str, Enum):
...
@dataclass_json
@dataclass
class P2PNetworkProductOfferingPartial:
    ...
    provider_vlans: Optional[P2PNetworkProductOfferingPartialProviderVlansEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'provider_vlans' }})
    resource_type: Optional[P2PNetworkProductOfferingPartialResourceTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'resource_type' }})
