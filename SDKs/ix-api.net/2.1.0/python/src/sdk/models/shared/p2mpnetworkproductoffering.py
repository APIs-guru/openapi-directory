...
class P2MpNetworkProductOfferingProviderVlansEnum(str, Enum):
    SINGLE = "single"
    MULTI = "multi"

class P2MpNetworkProductOfferingResourceTypeEnum(str, Enum):
...
class P2MpNetworkProductOffering:
    ...
    provider_vlans: P2MpNetworkProductOfferingProviderVlansEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'provider_vlans' }})
    resource_type: P2MpNetworkProductOfferingResourceTypeEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'resource_type' }})
