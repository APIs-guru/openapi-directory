...
class RouteServerNetworkFeatureConfigUpdatePartialBgpSessionTypeEnum(str, Enum):
    ACTIVE = "active"
    PASSIVE = "passive"

class RouteServerNetworkFeatureConfigUpdatePartialSessionModeEnum(str, Enum):
    PUBLIC = "public"
    COLLECTOR = "collector"
...
class RouteServerNetworkFeatureConfigUpdatePartial:
    ...
    bgp_session_type: Optional[RouteServerNetworkFeatureConfigUpdatePartialBgpSessionTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'bgp_session_type' }})
    ...
    session_mode: Optional[RouteServerNetworkFeatureConfigUpdatePartialSessionModeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'session_mode' }})
