...
class P2MpNetworkServiceConfigRequestPartialRoleEnum(str, Enum):
    ROOT = "root"
    LEAF = "leaf"
...
class P2MpNetworkServiceConfigRequestPartial:
    ...
    role: Optional[P2MpNetworkServiceConfigRequestPartialRoleEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'role' }})
