...
class CloudNetworkServiceStateEnum(str, Enum):
    REQUESTED = "requested"
    ALLOCATED = "allocated"
    TESTING = "testing"
...
class CloudNetworkService:
    ...
    provider_ref: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'provider_ref' }})
    purchase_order: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'purchase_order' }})
    state: CloudNetworkServiceStateEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'state' }})
