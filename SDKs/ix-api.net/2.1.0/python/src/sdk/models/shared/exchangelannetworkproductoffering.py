...
class ExchangeLanNetworkProductOfferingProviderVlansEnum(str, Enum):
    SINGLE = "single"
    MULTI = "multi"

class ExchangeLanNetworkProductOfferingResourceTypeEnum(str, Enum):
...
class ExchangeLanNetworkProductOffering:
    ...
    exchange_lan_network_service: str = field(default=None, metadata={'dataclasses_json': { 'field_name': 'exchange_lan_network_service' }})
    ...
    provider_vlans: ExchangeLanNetworkProductOfferingProviderVlansEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'provider_vlans' }})
    resource_type: ExchangeLanNetworkProductOfferingResourceTypeEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'resource_type' }})
