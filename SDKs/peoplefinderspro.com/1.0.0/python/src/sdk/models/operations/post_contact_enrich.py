...
class PostContactEnrichRequestBody:
    address: Optional[PostContactEnrichRequestBodyAddress] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Address') }})
...
class PostContactEnrichRequest:
    headers: PostContactEnrichHeaders = field()
