...
export class GetVideoChannelVideosPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=channelHandle" })
  channelHandle: string;
}


export class GetVideoChannelVideosQueryParams extends SpeakeasyBase {
...
export class GetVideoChannelVideosRequest extends SpeakeasyBase {
  @Metadata()
...
export class GetVideoChannelVideosResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
