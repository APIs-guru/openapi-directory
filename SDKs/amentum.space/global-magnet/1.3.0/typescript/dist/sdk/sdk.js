...
var SDK = /** @class */ (function () {
     ...
     *
    **/
    SDK.prototype.AppApiWmmEndpointsWmmMagneticField = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AppApiWmmEndpointsWmmMagneticFieldRequest(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/magnetic_field";
            ...
            switch (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) {
                case 200:
                    if (MatchContentType(contentType, "application/json")) {
                        res.appApiWmmEndpointsWmmMagneticField200ApplicationJsonObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
