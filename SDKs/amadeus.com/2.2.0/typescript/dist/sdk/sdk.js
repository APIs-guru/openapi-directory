...
var SDK = /** @class */ (function () {
    ...
    SDK.prototype.GetFlightOffers = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetFlightOffersRequest(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/shopping/flight-offers";
        ...
        return client
            ...
            switch (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) {
                ...
                case 400:
                    if (MatchContentType(contentType, "application/vnd.amadeus+json")) {
                        res.error400 = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                default:
                    if (MatchContentType(contentType, "application/vnd.amadeus+json")) {
                        res.error500 = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    SDK.prototype.SearchFlightOffers = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
