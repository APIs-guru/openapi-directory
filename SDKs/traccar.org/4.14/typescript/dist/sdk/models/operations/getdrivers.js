...
var GetDriversQueryParams = /** @class */ (function (_super) {
    ...
    ], GetDriversQueryParams.prototype, "all", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=deviceId" }),
        __metadata("design:type", Number)
    ], GetDriversQueryParams.prototype, "deviceId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=groupId" }),
        __metadata("design:type", Number)
    ], GetDriversQueryParams.prototype, "groupId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=refresh" }),
        __metadata("design:type", Boolean)
    ], GetDriversQueryParams.prototype, "refresh", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=userId" }),
        __metadata("design:type", Number)
    ], GetDriversQueryParams.prototype, "userId", void 0);
...
var GetDriversResponse = /** @class */ (function (_super) {
    ...
    ], GetDriversResponse.prototype, "drivers", void 0);
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", Number)
