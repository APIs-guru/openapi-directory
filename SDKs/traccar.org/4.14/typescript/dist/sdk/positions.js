...
var Positions = /** @class */ (function () {
    function Positions(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Positions.prototype.getPositions = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetPositionsRequest(req);
        }
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/positions";
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    ...
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.positions = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
