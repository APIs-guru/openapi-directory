...
var Notifications = /** @class */ (function () {
    ...
    **/
    Notifications.prototype.getNotificationsTypes = function (config) {
        var baseURL = this._serverURL;
        ...
        return client
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.notificationTypes = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
            }
            return res;
    ...
    **/
    Notifications.prototype.postNotificationsTest = function (config) {
        var baseURL = this._serverURL;
        var url = baseURL.replace(/\/$/, "") + "/notifications/test";
        var client = this._securityClient;
        return client
    ...
    **/
    Notifications.prototype.putNotificationsId = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
