...
@dataclass
class ReportingGetSubscriptionsQueryParams:
...
@dataclass
class ReportingGetSubscriptionsRequest:
    query_params: ReportingGetSubscriptionsQueryParams = field(default=None)
    

@dataclass
class ReportingGetSubscriptionsResponse:
