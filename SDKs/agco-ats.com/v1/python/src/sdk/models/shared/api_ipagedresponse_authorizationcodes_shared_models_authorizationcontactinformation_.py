...
class APIIPagedResponseAuthorizationCodesSharedModelsAuthorizationContactInformation:
    entities: Optional[List[AuthorizationCodesSharedModelsAuthorizationContactInformation]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Entities') }})
