...
class APIIPagedResponseGlobalResourcesSharedModelsTranslationRequest:
    entities: Optional[List[GlobalResourcesSharedModelsTranslationRequest]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Entities') }})
