...
class APIIPagedResponseGlobalResourcesSharedModelsGlobalImageCategory:
    entities: Optional[List[GlobalResourcesSharedModelsGlobalImageCategory]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Entities') }})
