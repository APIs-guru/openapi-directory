...
class APIIPagedResponseGlobalResourcesSharedModelsTranslationSetString:
    entities: Optional[List[GlobalResourcesSharedModelsTranslationSetString]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Entities') }})
