...
class ContentSubmissionSharedBusinessEntitiesUserContentDefinition:
    ...
    user_content_definition_id: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('UserContentDefinitionID') }, 'form': { 'field_name': 'UserContentDefinitionID' }})
