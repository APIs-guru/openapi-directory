...
class APIIPagedResponseAuthorizationCodesSharedModelsCategoryUserReport:
    entities: Optional[List[AuthorizationCodesSharedModelsCategoryUserReport]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Entities') }})
