...
class APIIPagedResponseGlobalResourcesSharedModelsStringTranslation:
    entities: Optional[List[GlobalResourcesSharedModelsStringTranslation]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Entities') }})
