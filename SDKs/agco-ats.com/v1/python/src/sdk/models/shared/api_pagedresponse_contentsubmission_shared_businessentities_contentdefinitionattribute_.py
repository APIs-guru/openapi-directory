...
class APIPagedResponseContentSubmissionSharedBusinessEntitiesContentDefinitionAttribute:
    entities: List[contentsubmission_shared_businessentities_contentdefinitionattribute.ContentSubmissionSharedBusinessEntitiesContentDefinitionAttribute] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Entities' }})
