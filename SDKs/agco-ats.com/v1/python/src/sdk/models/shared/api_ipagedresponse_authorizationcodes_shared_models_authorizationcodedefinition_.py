...
class APIIPagedResponseAuthorizationCodesSharedModelsAuthorizationCodeDefinition:
    entities: Optional[List[AuthorizationCodesSharedModelsAuthorizationCodeDefinition]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Entities') }})
