...
class UpdateSystemModelsPackageStatus:
    ...
    download_time: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'DownloadTime' }})
    downloaded: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Downloaded' }})
    install_completed: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'InstallCompleted' }})
    install_result: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'InstallResult' }})
    install_started: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'InstallStarted' }})
