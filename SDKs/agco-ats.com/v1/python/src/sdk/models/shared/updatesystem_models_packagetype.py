...
class UpdateSystemModelsPackageType:
    ...
    attribute: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Attribute') }, 'form': { 'field_name': 'Attribute' }})
    category: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Category') }, 'form': { 'field_name': 'Category' }})
    icon: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('Icon') }, 'form': { 'field_name': 'Icon' }})
    ...
    max_delta_packages: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('MaxDeltaPackages') }, 'form': { 'field_name': 'MaxDeltaPackages' }})
