...
class FolderActionResponse:
    ...
    result: Optional[folder.Folder] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'result' }})
    ...
    status: FolderActionResponseStatusEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
