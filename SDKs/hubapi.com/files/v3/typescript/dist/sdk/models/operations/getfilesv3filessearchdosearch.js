...
var GetFilesV3FilesSearchDoSearchSecurityOption1 = /** @class */ (function (_super) {
    __extends(GetFilesV3FilesSearchDoSearchSecurityOption1, _super);
    function GetFilesV3FilesSearchDoSearchSecurityOption1() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "security, scheme=true;type=oauth2" }),
        __metadata("design:type", shared.SchemeOauth2Legacy)
    ], GetFilesV3FilesSearchDoSearchSecurityOption1.prototype, "oauth2Legacy", void 0);
    return GetFilesV3FilesSearchDoSearchSecurityOption1;
}(SpeakeasyBase));
export { GetFilesV3FilesSearchDoSearchSecurityOption1 };
var GetFilesV3FilesSearchDoSearchSecurityOption2 = /** @class */ (function (_super) {
    __extends(GetFilesV3FilesSearchDoSearchSecurityOption2, _super);
    function GetFilesV3FilesSearchDoSearchSecurityOption2() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "security, scheme=true;type=apiKey;subtype=query" }),
        __metadata("design:type", shared.SchemeHapikey)
    ], GetFilesV3FilesSearchDoSearchSecurityOption2.prototype, "hapikey", void 0);
    return GetFilesV3FilesSearchDoSearchSecurityOption2;
}(SpeakeasyBase));
export { GetFilesV3FilesSearchDoSearchSecurityOption2 };
var GetFilesV3FilesSearchDoSearchSecurityOption3 = /** @class */ (function (_super) {
    __extends(GetFilesV3FilesSearchDoSearchSecurityOption3, _super);
    function GetFilesV3FilesSearchDoSearchSecurityOption3() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "security, scheme=true;type=oauth2" }),
        __metadata("design:type", shared.SchemeOauth2Legacy)
    ], GetFilesV3FilesSearchDoSearchSecurityOption3.prototype, "oauth2Legacy", void 0);
    return GetFilesV3FilesSearchDoSearchSecurityOption3;
}(SpeakeasyBase));
export { GetFilesV3FilesSearchDoSearchSecurityOption3 };
var GetFilesV3FilesSearchDoSearchSecurity = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", GetFilesV3FilesSearchDoSearchSecurityOption1)
    ], GetFilesV3FilesSearchDoSearchSecurity.prototype, "option1", void 0);
    __decorate([
        Metadata({ data: "security, option=true" }),
        __metadata("design:type", GetFilesV3FilesSearchDoSearchSecurityOption2)
    ], GetFilesV3FilesSearchDoSearchSecurity.prototype, "option2", void 0);
    __decorate([
        Metadata({ data: "security, option=true" }),
        __metadata("design:type", GetFilesV3FilesSearchDoSearchSecurityOption3)
    ], GetFilesV3FilesSearchDoSearchSecurity.prototype, "option3", void 0);
