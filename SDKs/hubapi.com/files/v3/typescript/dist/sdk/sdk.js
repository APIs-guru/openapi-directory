...
var SDK = /** @class */ (function () {
     ...
     * GDRP delete file
    **/
    SDK.prototype.DeleteFilesV3FilesFileIdGdprDeleteArchiveGdpr = function (req, config) {
     ...
     * Delete file by ID
    **/
    SDK.prototype.DeleteFilesV3FilesFileIdArchive = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Delete folder by ID.
    **/
    SDK.prototype.DeleteFilesV3FoldersFolderIdArchive = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteFilesV3FoldersFolderIdArchiveRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/files/v3/folders/{folderId}", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .delete(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    **/
    SDK.prototype.DeleteFilesV3FoldersFolderPathArchiveByPath = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.DeleteFilesV3FoldersFolderPathArchiveByPathRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/files/v3/folders/{folderPath}", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .delete(url, __assign({}, config))
            .then(function (httpRes) {
    ...
    **/
    SDK.prototype.GetFilesV3FilesImportFromUrlAsyncTasksTaskIdStatusCheckImport = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.GetFilesV3FilesSearchDoSearch = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.GetFilesV3FilesFileIdSignedUrlGetSignedUrl = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Get file by ID.
    **/
    SDK.prototype.GetFilesV3FilesFileIdGetById = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.GetFilesV3FoldersSearchDoSearch = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetFilesV3FoldersSearchDoSearchRequest(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/files/v3/folders/search";
        var client = CreateSecurityClient(this.defaultClient, req.security);
        var qpSerializer = GetQueryParamSerializer(req.queryParams);
        var requestConfig = __assign(__assign({}, config), { params: req.queryParams, paramsSerializer: qpSerializer });
        return client
            ...
            switch (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) {
                case 200:
                    if (MatchContentType(contentType, "application/json")) {
                        res.collectionResponseFolder = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                default:
                    if (MatchContentType(contentType, "*/*")) {
    ...
    **/
    SDK.prototype.GetFilesV3FoldersUpdateAsyncTasksTaskIdStatusCheckUpdateStatus = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.GetFilesV3FoldersUpdateAsyncTasksTaskIdStatusCheckUpdateStatusRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/files/v3/folders/update/async/tasks/{taskId}/status", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .get(url, __assign({}, config))
            .then(function (httpRes) {
            ...
            switch (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) {
                case 200:
                    if (MatchContentType(contentType, "application/json")) {
                        res.folderActionResponse = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                default:
                    if (MatchContentType(contentType, "*/*")) {
     ...
     * Get folder by ID
    **/
    SDK.prototype.GetFilesV3FoldersFolderIdGetById = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Get folder by path.
    **/
    SDK.prototype.GetFilesV3FoldersFolderPathGetByPath = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.PatchFilesV3FilesFileIdUpdateProperties = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.PostFilesV3FilesImportFromUrlAsyncImportFromUrl = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.PostFilesV3FilesUpload = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.PostFilesV3FoldersUpdateAsyncUpdateProperties = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostFilesV3FoldersUpdateAsyncUpdatePropertiesRequest(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/files/v3/folders/update/async";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
        ...
        return client
            ...
            switch (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) {
                case 202:
                    if (MatchContentType(contentType, "application/json")) {
                        res.folderUpdateTaskLocator = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    break;
                default:
                    if (MatchContentType(contentType, "*/*")) {
     ...
     * Creates a folder.
    **/
    SDK.prototype.PostFilesV3FoldersCreate = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PostFilesV3FoldersCreateRequest(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/files/v3/folders";
        var _b = [{}, {}], reqBodyHeaders = _b[0], reqBody = _b[1];
        try {
            _a = SerializeRequestBody(req), reqBodyHeaders = _a[0], reqBody = _a[1];
        }
    ...
    **/
    SDK.prototype.PutFilesV3FilesFileIdReplace = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
