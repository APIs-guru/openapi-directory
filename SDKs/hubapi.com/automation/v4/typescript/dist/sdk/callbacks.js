...
var Callbacks = /** @class */ (function () {
    function Callbacks(defaultClient, securityClient, serverURL, language, sdkVersion, genVersion) {
    ...
    **/
    Callbacks.prototype.postAutomationV4ActionsCallbacksCompleteCompleteBatch = function (req, config) {
        var _a;
    ...
    **/
    Callbacks.prototype.postAutomationV4ActionsCallbacksCallbackIdCompleteComplete = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
