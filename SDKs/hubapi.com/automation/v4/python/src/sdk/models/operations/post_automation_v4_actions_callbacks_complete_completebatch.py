...
class PostAutomationV4ActionsCallbacksCompleteCompleteBatchRequest:
    request: shared.BatchInputCallbackCompletionBatchRequest = field(metadata={'request': { 'media_type': 'application/json' }})
    security: PostAutomationV4ActionsCallbacksCompleteCompleteBatchSecurity = field()
