...
class GetAutomationV4ActionsAppIDDefinitionIDFunctionsFunctionTypeGetByFunctionTypePathParams:
    ...
    function_type: GetAutomationV4ActionsAppIDDefinitionIDFunctionsFunctionTypeGetByFunctionTypeFunctionTypeEnum = field(default=None, metadata={'path_param': { 'field_name': 'functionType', 'style': 'simple', 'explode': False }})
...
class GetAutomationV4ActionsAppIDDefinitionIDFunctionsFunctionTypeGetByFunctionTypeRequest:
    path_params: GetAutomationV4ActionsAppIDDefinitionIDFunctionsFunctionTypeGetByFunctionTypePathParams = field(default=None)
    security: GetAutomationV4ActionsAppIDDefinitionIDFunctionsFunctionTypeGetByFunctionTypeSecurity = field(default=None)
