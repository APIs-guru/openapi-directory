...
class SDK:
    ...
    def post_marketing_v3_marketing_events_attendance_external_event_id_subscriber_state_create(self, request: operations.PostMarketingV3MarketingEventsAttendanceExternalEventIDSubscriberStateCreateRequest) -> operations.PostMarketingV3MarketingEventsAttendanceExternalEventIDSubscriberStateCreateResponse:
        warnings.simplefilter("ignore")
        ...
        res = operations.PostMarketingV3MarketingEventsAttendanceExternalEventIDSubscriberStateCreateResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
    ...
    def post_marketing_v3_marketing_events_attendance_external_event_id_subscriber_state_email_create(self, request: operations.PostMarketingV3MarketingEventsAttendanceExternalEventIDSubscriberStateEmailCreateRequest) -> operations.PostMarketingV3MarketingEventsAttendanceExternalEventIDSubscriberStateEmailCreateResponse:
        warnings.simplefilter("ignore")
        ...
        res = operations.PostMarketingV3MarketingEventsAttendanceExternalEventIDSubscriberStateEmailCreateResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
    ...
    def post_marketing_v3_marketing_events_events_delete_archive(self, request: operations.PostMarketingV3MarketingEventsEventsDeleteArchiveRequest) -> operations.PostMarketingV3MarketingEventsEventsDeleteArchiveResponse:
        warnings.simplefilter("ignore")
        ...
        res = operations.PostMarketingV3MarketingEventsEventsDeleteArchiveResponse(status_code=r.status_code, content_type=content_type)
        if True:
            if utils.match_content_type(content_type, "*/*"):
                res.body = r.content
    ...
    def post_marketing_v3_marketing_events_events_external_event_id_complete(self, request: operations.PostMarketingV3MarketingEventsEventsExternalEventIDCompleteRequest) -> operations.PostMarketingV3MarketingEventsEventsExternalEventIDCompleteResponse:
        warnings.simplefilter("ignore")
        ...
        res = operations.PostMarketingV3MarketingEventsEventsExternalEventIDCompleteResponse(status_code=r.status_code, content_type=content_type)
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.MarketingEventDefaultResponse])
                res.marketing_event_default_response = out
