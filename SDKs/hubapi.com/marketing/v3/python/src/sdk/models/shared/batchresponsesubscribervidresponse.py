...
from . import subscribervidresponse
...
class BatchResponseSubscriberVidResponse:
    ...
    results: List[subscribervidresponse.SubscriberVidResponse] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'results' }})
    ...
    status: BatchResponseSubscriberVidResponseStatusEnum = field(default=None, metadata={'dataclasses_json': { 'field_name': 'status' }})
