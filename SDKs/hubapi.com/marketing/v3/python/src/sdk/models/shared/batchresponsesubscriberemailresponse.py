...
class BatchResponseSubscriberEmailResponse:
    ...
    results: List[SubscriberEmailResponse] = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('results') }})
    ...
    status: BatchResponseSubscriberEmailResponseStatusEnum = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('status') }})
