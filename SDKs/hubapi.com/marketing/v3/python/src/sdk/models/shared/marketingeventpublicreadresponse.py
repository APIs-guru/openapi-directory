...
class MarketingEventPublicReadResponse:
    attendees: int = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('attendees') }})
    cancellations: int = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('cancellations') }})
    ...
    no_shows: int = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('noShows') }})
    registrants: int = field(metadata={'dataclasses_json': { 'letter_case': utils.field_name('registrants') }})
