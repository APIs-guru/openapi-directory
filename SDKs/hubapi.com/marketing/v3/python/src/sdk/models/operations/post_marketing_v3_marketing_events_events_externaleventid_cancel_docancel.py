...
class PostMarketingV3MarketingEventsEventsExternalEventIDCancelDoCancelRequest:
    path_params: PostMarketingV3MarketingEventsEventsExternalEventIDCancelDoCancelPathParams = field()
    query_params: PostMarketingV3MarketingEventsEventsExternalEventIDCancelDoCancelQueryParams = field()
    security: PostMarketingV3MarketingEventsEventsExternalEventIDCancelDoCancelSecurity = field()
