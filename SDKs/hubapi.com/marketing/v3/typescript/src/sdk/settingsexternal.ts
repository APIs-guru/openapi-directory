  ...
  getMarketingV3MarketingEventsAppIdSettingsGetAll(
    ...
    return client
      .request({
        ...
        const res: operations.GetMarketingV3MarketingEventsAppIdSettingsGetAllResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
  ...
  postMarketingV3MarketingEventsAppIdSettingsCreate(
    ...
    return client
      .request({
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        const res: operations.PostMarketingV3MarketingEventsAppIdSettingsCreateResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (true) {
          case httpRes?.status == 200:
            if (utils.MatchContentType(contentType, `application/json`)) {
                res.eventDetailSettings = httpRes?.data;
