...
var GetMarketingV3MarketingEventsEventsExternalEventIdGetByIdSecurityOption1 = /** @class */ (function (_super) {
    __extends(GetMarketingV3MarketingEventsEventsExternalEventIdGetByIdSecurityOption1, _super);
    function GetMarketingV3MarketingEventsEventsExternalEventIdGetByIdSecurityOption1() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "security, scheme=true;type=apiKey;subtype=query" }),
        __metadata("design:type", shared.SchemeHapikey)
    ], GetMarketingV3MarketingEventsEventsExternalEventIdGetByIdSecurityOption1.prototype, "hapikey", void 0);
    return GetMarketingV3MarketingEventsEventsExternalEventIdGetByIdSecurityOption1;
}(SpeakeasyBase));
export { GetMarketingV3MarketingEventsEventsExternalEventIdGetByIdSecurityOption1 };
var GetMarketingV3MarketingEventsEventsExternalEventIdGetByIdSecurityOption2 = /** @class */ (function (_super) {
    __extends(GetMarketingV3MarketingEventsEventsExternalEventIdGetByIdSecurityOption2, _super);
    function GetMarketingV3MarketingEventsEventsExternalEventIdGetByIdSecurityOption2() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "security, scheme=true;type=oauth2" }),
        __metadata("design:type", shared.SchemeOauth2Legacy)
    ], GetMarketingV3MarketingEventsEventsExternalEventIdGetByIdSecurityOption2.prototype, "oauth2Legacy", void 0);
    return GetMarketingV3MarketingEventsEventsExternalEventIdGetByIdSecurityOption2;
}(SpeakeasyBase));
export { GetMarketingV3MarketingEventsEventsExternalEventIdGetByIdSecurityOption2 };
var GetMarketingV3MarketingEventsEventsExternalEventIdGetByIdSecurity = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", GetMarketingV3MarketingEventsEventsExternalEventIdGetByIdSecurityOption1)
    ], GetMarketingV3MarketingEventsEventsExternalEventIdGetByIdSecurity.prototype, "option1", void 0);
    __decorate([
        Metadata({ data: "security, option=true" }),
        __metadata("design:type", GetMarketingV3MarketingEventsEventsExternalEventIdGetByIdSecurityOption2)
    ], GetMarketingV3MarketingEventsEventsExternalEventIdGetByIdSecurity.prototype, "option2", void 0);
