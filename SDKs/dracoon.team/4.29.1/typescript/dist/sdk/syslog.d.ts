...
export declare class Syslog {
     ...
     * </details>
    **/
    requestAuditNodeUserDataSyslog(req: operations.RequestAuditNodeUserDataSyslogRequest, config?: AxiosRequestConfig): Promise<operations.RequestAuditNodeUserDataSyslogResponse>;
    /**
     ...
     * None.
    **/
    requestLogOperationsSyslog(req: operations.RequestLogOperationsSyslogRequest, config?: AxiosRequestConfig): Promise<operations.RequestLogOperationsSyslogResponse>;
    /**
     ...
     * </details>
    **/
    requestSyslogEvents(req: operations.RequestSyslogEventsRequest, config?: AxiosRequestConfig): Promise<operations.RequestSyslogEventsResponse>;
}
