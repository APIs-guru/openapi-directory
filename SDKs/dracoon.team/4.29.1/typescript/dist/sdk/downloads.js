...
var Downloads = /** @class */ (function () {
    ...
    **/
    Downloads.prototype.downloadAvatar = function (req, config) {
        ...
        var url = utils.GenerateURL(baseURL, "/v4/downloads/avatar/{user_id}/{uuid}", req.pathParams);
    ...
    **/
    Downloads.prototype.downloadFileViaToken = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v4/downloads/{token}", req.pathParams);
        var client = this._defaultClient;
    ...
    **/
    Downloads.prototype.downloadZipArchiveViaToken = function (req, config) {
        ...
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/v4/downloads/zip/{token}", req.pathParams);
        var client = this._defaultClient;
        return client
            .request(__assign({ url: url, method: "get" }, config)).then(function (httpRes) {
            var _a, _b;
