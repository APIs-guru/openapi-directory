...
var UpdateFolderRequest = /** @class */ (function (_super) {
    ...
    ], UpdateFolderRequest.prototype, "name", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=notes" }),
        __metadata("design:type", String)
    ], UpdateFolderRequest.prototype, "notes", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=timestampCreation" }),
        __metadata("design:type", Date)
    ], UpdateFolderRequest.prototype, "timestampCreation", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=timestampModification" }),
        __metadata("design:type", Date)
    ], UpdateFolderRequest.prototype, "timestampModification", void 0);
