...
**/
var OpenIdAuthInfo = /** @class */ (function (_super) {
    __extends(OpenIdAuthInfo, _super);
    function OpenIdAuthInfo() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=items", elemType: OpenIdProvider }),
        __metadata("design:type", Array)
    ], OpenIdAuthInfo.prototype, "items", void 0);
    return OpenIdAuthInfo;
}(SpeakeasyBase));
export { OpenIdAuthInfo };
