...
**/
var SyslogEventList = /** @class */ (function (_super) {
    __extends(SyslogEventList, _super);
    ...
    ], SyslogEventList.prototype, "items", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=range" }),
        __metadata("design:type", Range)
    ], SyslogEventList.prototype, "range", void 0);
    return SyslogEventList;
}(SpeakeasyBase));
export { SyslogEventList };
