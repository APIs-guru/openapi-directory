...
**/
var MissingKeysResponseOutput = /** @class */ (function (_super) {
    __extends(MissingKeysResponseOutput, _super);
    function MissingKeysResponseOutput() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=files", elemType: FileFileKeys }),
        __metadata("design:type", Array)
    ], MissingKeysResponseOutput.prototype, "files", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=items", elemType: UserIdFileIdItem }),
        __metadata("design:type", Array)
    ], MissingKeysResponseOutput.prototype, "items", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=range" }),
        __metadata("design:type", Range)
    ], MissingKeysResponseOutput.prototype, "range", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=users", elemType: UserUserPublicKeyOutput }),
        __metadata("design:type", Array)
    ], MissingKeysResponseOutput.prototype, "users", void 0);
    return MissingKeysResponseOutput;
}(SpeakeasyBase));
export { MissingKeysResponseOutput };
