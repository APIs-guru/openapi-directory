...
var CreateKeyPairRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", PrivateKeyContainer)
    ], CreateKeyPairRequest.prototype, "previousPrivateKey", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=privateKeyContainer" }),
        __metadata("design:type", PrivateKeyContainer)
    ], CreateKeyPairRequest.prototype, "privateKeyContainer", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=publicKeyContainer" }),
        __metadata("design:type", PublicKeyContainer)
    ], CreateKeyPairRequest.prototype, "publicKeyContainer", void 0);
