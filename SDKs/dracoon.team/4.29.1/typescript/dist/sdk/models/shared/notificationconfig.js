...
var NotificationConfig = /** @class */ (function (_super) {
    ...
    ], NotificationConfig.prototype, "channelIds", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=eventTypeName" }),
        __metadata("design:type", String)
    ], NotificationConfig.prototype, "eventTypeName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=id" }),
        __metadata("design:type", Number)
    ], NotificationConfig.prototype, "id", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=scopeId" }),
        __metadata("design:type", Number)
    ], NotificationConfig.prototype, "scopeId", void 0);
