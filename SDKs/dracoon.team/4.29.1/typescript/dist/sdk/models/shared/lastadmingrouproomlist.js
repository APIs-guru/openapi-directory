...
**/
var LastAdminGroupRoomList = /** @class */ (function (_super) {
    __extends(LastAdminGroupRoomList, _super);
    function LastAdminGroupRoomList() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=items", elemType: LastAdminGroupRoom }),
        __metadata("design:type", Array)
    ], LastAdminGroupRoomList.prototype, "items", void 0);
    return LastAdminGroupRoomList;
}(SpeakeasyBase));
export { LastAdminGroupRoomList };
