...
var AddFavoritePathParams = /** @class */ (function (_super) {
    ...
    ], AddFavoritePathParams.prototype, "nodeId", void 0);
    return AddFavoritePathParams;
}(SpeakeasyBase));
export { AddFavoritePathParams };
var AddFavoriteHeaders = /** @class */ (function (_super) {
    __extends(AddFavoriteHeaders, _super);
    function AddFavoriteHeaders() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "header, style=simple;explode=false;name=X-Sds-Auth-Token" }),
        __metadata("design:type", String)
    ], AddFavoriteHeaders.prototype, "xSdsAuthToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "header, style=simple;explode=false;name=X-Sds-Date-Format" }),
        __metadata("design:type", Object)
    ], AddFavoriteHeaders.prototype, "xSdsDateFormat", void 0);
    return AddFavoriteHeaders;
}(SpeakeasyBase));
export { AddFavoriteHeaders };
var AddFavoriteRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", AddFavoriteHeaders)
    ], AddFavoriteRequest.prototype, "headers", void 0);
