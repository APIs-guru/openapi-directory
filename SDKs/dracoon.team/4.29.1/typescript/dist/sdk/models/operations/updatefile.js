...
export { UpdateFilePathParams };
var UpdateFileHeaders = /** @class */ (function (_super) {
    __extends(UpdateFileHeaders, _super);
    ...
    ], UpdateFileHeaders.prototype, "xSdsAuthToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "header, style=simple;explode=false;name=X-Sds-Date-Format" }),
        __metadata("design:type", Object)
    ], UpdateFileHeaders.prototype, "xSdsDateFormat", void 0);
    return UpdateFileHeaders;
}(SpeakeasyBase));
export { UpdateFileHeaders };
