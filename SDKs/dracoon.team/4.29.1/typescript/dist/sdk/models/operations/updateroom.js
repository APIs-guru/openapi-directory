...
var UpdateRoomPathParams = /** @class */ (function (_super) {
    ...
    ], UpdateRoomPathParams.prototype, "roomId", void 0);
    return UpdateRoomPathParams;
}(SpeakeasyBase));
export { UpdateRoomPathParams };
var UpdateRoomHeaders = /** @class */ (function (_super) {
    __extends(UpdateRoomHeaders, _super);
    ...
    ], UpdateRoomHeaders.prototype, "xSdsAuthToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "header, style=simple;explode=false;name=X-Sds-Date-Format" }),
        __metadata("design:type", Object)
    ], UpdateRoomHeaders.prototype, "xSdsDateFormat", void 0);
    return UpdateRoomHeaders;
}(SpeakeasyBase));
export { UpdateRoomHeaders };
var UpdateRoomRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", UpdateRoomHeaders)
    ], UpdateRoomRequest.prototype, "headers", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "request, media_type=application/json" }),
        __metadata("design:type", shared.UpdateRoomRequest)
...
var UpdateRoomResponse = /** @class */ (function (_super) {
    ...
    ], UpdateRoomResponse.prototype, "errorResponse", void 0);
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", shared.Node)
    ], UpdateRoomResponse.prototype, "node", void 0);
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", Number)
