...
var CreateDownloadShareHeaders = /** @class */ (function (_super) {
    __extends(CreateDownloadShareHeaders, _super);
    function CreateDownloadShareHeaders() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "header, style=simple;explode=false;name=X-Sds-Auth-Token" }),
        __metadata("design:type", String)
    ], CreateDownloadShareHeaders.prototype, "xSdsAuthToken", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "header, style=simple;explode=false;name=X-Sds-Date-Format" }),
        __metadata("design:type", Object)
    ], CreateDownloadShareHeaders.prototype, "xSdsDateFormat", void 0);
    return CreateDownloadShareHeaders;
}(SpeakeasyBase));
export { CreateDownloadShareHeaders };
var CreateDownloadShareRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", CreateDownloadShareHeaders)
    ], CreateDownloadShareRequest.prototype, "headers", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "request, media_type=application/json" }),
        __metadata("design:type", shared.CreateDownloadShareRequest)
    ], CreateDownloadShareRequest.prototype, "request", void 0);
...
export { CreateDownloadShareResponse };
