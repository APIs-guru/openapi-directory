...
export declare class Config {
     ...
     * None.
    **/
    requestAlgorithms(req: operations.RequestAlgorithmsRequest, config?: AxiosRequestConfig): Promise<operations.RequestAlgorithmsResponse>;
    /**
     ...
     * </details>
    **/
    requestGeneralSettingsInfo(req: operations.RequestGeneralSettingsInfoRequest, config?: AxiosRequestConfig): Promise<operations.RequestGeneralSettingsInfoResponse>;
    /**
     ...
     *
    **/
    requestInfrastructurePropertiesInfo(req: operations.RequestInfrastructurePropertiesInfoRequest, config?: AxiosRequestConfig): Promise<operations.RequestInfrastructurePropertiesInfoResponse>;
    /**
     ...
     * None.
    **/
    requestNotificationChannelsInfo(req: operations.RequestNotificationChannelsInfoRequest, config?: AxiosRequestConfig): Promise<operations.RequestNotificationChannelsInfoResponse>;
    /**
     ...
     * </details>
    **/
    requestPasswordPoliciesConfigInfo(req: operations.RequestPasswordPoliciesConfigInfoRequest, config?: AxiosRequestConfig): Promise<operations.RequestPasswordPoliciesConfigInfoResponse>;
    /**
    ...
    **/
    requestS3TagsInfo(req: operations.RequestS3TagsInfoRequest, config?: AxiosRequestConfig): Promise<operations.RequestS3TagsInfoResponse>;
    /**
    ...
    **/
    requestSystemDefaultsInfo(req: operations.RequestSystemDefaultsInfoRequest, config?: AxiosRequestConfig): Promise<operations.RequestSystemDefaultsInfoResponse>;
    /**
     ...
     * </details>
    **/
    requestSystemSettings(req: operations.RequestSystemSettingsRequest, config?: AxiosRequestConfig): Promise<operations.RequestSystemSettingsResponse>;
    /**
     ...
     * </details>
    **/
    updateSystemSettings(req: operations.UpdateSystemSettingsRequest, config?: AxiosRequestConfig): Promise<operations.UpdateSystemSettingsResponse>;
}
