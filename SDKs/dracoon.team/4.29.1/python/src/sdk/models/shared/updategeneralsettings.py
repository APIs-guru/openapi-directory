...
from . import updateauthtokenrestrictions


@dataclass_json
@dataclass
class UpdateGeneralSettings:
    auth_token_restrictions: Optional[updateauthtokenrestrictions.UpdateAuthTokenRestrictions] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'authTokenRestrictions' }})
