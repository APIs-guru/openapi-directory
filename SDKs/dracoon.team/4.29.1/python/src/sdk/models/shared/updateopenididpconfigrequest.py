...
class UpdateOpenIDIdpConfigRequest:
    ...
    flow: Optional[UpdateOpenIDIdpConfigRequestFlowEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'flow' }})
    ...
    reset_fallback_mapping_claim: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'resetFallbackMappingClaim' }})
    ...
    user_info_source: Optional[UpdateOpenIDIdpConfigRequestUserInfoSourceEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'userInfoSource' }})
