...
class UpdateUserAccountRequest:
    headers: UpdateUserAccountHeaders = field(default=None)
    request: shared.UpdateUserAccountRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
