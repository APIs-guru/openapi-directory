...
class DownloadFileViaTokenPublic1Request:
    headers: DownloadFileViaTokenPublic1Headers = field()
    path_params: DownloadFileViaTokenPublic1PathParams = field()
    query_params: DownloadFileViaTokenPublic1QueryParams = field()
