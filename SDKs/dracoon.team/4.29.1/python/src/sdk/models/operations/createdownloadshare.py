...
class CreateDownloadShareRequest:
    headers: CreateDownloadShareHeaders = field(default=None)
    request: shared.CreateDownloadShareRequest = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
