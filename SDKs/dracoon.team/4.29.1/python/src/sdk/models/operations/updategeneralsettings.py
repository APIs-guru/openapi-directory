...
class UpdateGeneralSettingsRequest:
    headers: UpdateGeneralSettingsHeaders = field(default=None)
    request: shared.UpdateGeneralSettings = field(default=None, metadata={'request': { 'media_type': 'application/json' }})
