...
class RequestRoomGroupsRequest:
    path_params: RequestRoomGroupsPathParams = field(default=None)
    query_params: RequestRoomGroupsQueryParams = field(default=None)
    headers: RequestRoomGroupsHeaders = field(default=None)
