...
class Nodes:
    ...
    def request_missing_file_keys(self, request: operations.RequestMissingFileKeysRequest) -> operations.RequestMissingFileKeysResponseOutput:
        ...
        res = operations.RequestMissingFileKeysResponseOutput(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.MissingKeysResponseOutput])
    ...
    def request_room_rescue_key_pair(self, request: operations.RequestRoomRescueKeyPairRequest) -> operations.RequestRoomRescueKeyPairResponseOutput:
        r"""Request room rescue key
        ### Description:  
        ...
        res = operations.RequestRoomRescueKeyPairResponseOutput(status_code=r.status_code, content_type=content_type)
    ...
    def request_room_rescue_key_pairs(self, request: operations.RequestRoomRescueKeyPairsRequest) -> operations.RequestRoomRescueKeyPairsResponseOutput:
        ...
        res = operations.RequestRoomRescueKeyPairsResponseOutput(status_code=r.status_code, content_type=content_type)
    ...
    def request_room_users(self, request: operations.RequestRoomUsersRequest) -> operations.RequestRoomUsersResponseOutput:
        ...
        res = operations.RequestRoomUsersResponseOutput(status_code=r.status_code, content_type=content_type)
        
        if r.status_code == 200:
            if utils.match_content_type(content_type, "application/json"):
                out = utils.unmarshal_json(r.text, Optional[shared.RoomUserListOutput])
