...
@dataclass
class LocationsGetV2LocationsLocationIDGetPathParams:
    location_id: int = field(default=None, metadata={'path_param': { 'field_name': 'location_id', 'style': 'simple', 'explode': False }})
    

@dataclass
class LocationsGetV2LocationsLocationIDGetQueryParams:
...
@dataclass
class LocationsGetV2LocationsLocationIDGetRequest:
    path_params: LocationsGetV2LocationsLocationIDGetPathParams = field(default=None)
    query_params: LocationsGetV2LocationsLocationIDGetQueryParams = field(default=None)
