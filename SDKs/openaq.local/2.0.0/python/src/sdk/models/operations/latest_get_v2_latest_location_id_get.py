...
class LatestGetV2LatestLocationIDGetPathParams:
    location_id: int = field(metadata={'path_param': { 'field_name': 'location_id', 'style': 'simple', 'explode': False }})
...
class LatestGetV2LatestLocationIDGetRequest:
    path_params: LatestGetV2LatestLocationIDGetPathParams = field()
    query_params: LatestGetV2LatestLocationIDGetQueryParams = field()
