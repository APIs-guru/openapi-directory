...
class SourcesGetV2SourcesGetQueryParams:
    ...
    order_by: Optional[shared.SourcesOrderEnum] = field(default=None, metadata={'query_param': { 'field_name': 'order_by', 'style': 'form', 'explode': True }})
...
class SourcesGetV2SourcesGetRequest:
    query_params: SourcesGetV2SourcesGetQueryParams = field(default=None)
