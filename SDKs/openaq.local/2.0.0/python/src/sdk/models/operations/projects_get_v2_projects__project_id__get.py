...
class ProjectsGetV2ProjectsProjectIDGetRequest:
    path_params: ProjectsGetV2ProjectsProjectIDGetPathParams = field(default=None)
    query_params: ProjectsGetV2ProjectsProjectIDGetQueryParams = field(default=None)
