...
class CountriesGetV2CountriesCountryIDGetRequest:
    path_params: CountriesGetV2CountriesCountryIDGetPathParams = field(default=None)
    query_params: CountriesGetV2CountriesCountryIDGetQueryParams = field(default=None)
