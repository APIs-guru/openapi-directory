...
class GetMobiletileV2LocationsTilesMobileZXYPbfGetQueryParams:
    date_from: Any = field(default=None, metadata={'query_param': { 'field_name': 'dateFrom', 'style': 'form', 'explode': True }})
    date_to: Any = field(default=None, metadata={'query_param': { 'field_name': 'dateTo', 'style': 'form', 'explode': True }})
...
class GetMobiletileV2LocationsTilesMobileZXYPbfGetRequest:
    path_params: GetMobiletileV2LocationsTilesMobileZXYPbfGetPathParams = field(default=None)
    query_params: GetMobiletileV2LocationsTilesMobileZXYPbfGetQueryParams = field(default=None)
