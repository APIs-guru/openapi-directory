...
class GetMobilegentileV2LocationsTilesMobileGeneralizedZXYPbfGetRequest:
    path_params: GetMobilegentileV2LocationsTilesMobileGeneralizedZXYPbfGetPathParams = field()
    query_params: GetMobilegentileV2LocationsTilesMobileGeneralizedZXYPbfGetQueryParams = field()
