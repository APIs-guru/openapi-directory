...
export const ConfirmPayment5ServerList = [
	"http://api.climatekuul.com:8000/footprint",
] as const;


export class ConfirmPayment5RequestBody extends SpeakeasyBase {
...
export class ConfirmPayment5Request extends SpeakeasyBase {
  @SpeakeasyMetadata()
  serverUrl?: string;
...
export class ConfirmPayment5Response extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
