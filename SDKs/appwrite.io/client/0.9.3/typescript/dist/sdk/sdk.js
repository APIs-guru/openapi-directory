...
var SDK = /** @class */ (function () {
    ...
    **/
    SDK.prototype.AccountCreate = function (req, config) {
        var _a;
    ...
    **/
    SDK.prototype.AccountCreateAnonymousSession = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AccountCreateAnonymousSessionRequest(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/account/sessions/anonymous";
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
    ...
    **/
    SDK.prototype.AccountCreateJwt = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AccountCreateJwtRequest(req);
        }
        var baseURL = this.serverURL;
        var url = baseURL.replace(/\/$/, "") + "/account/jwt";
        var client = CreateSecurityClient(this.defaultClient, req.security);
        return client
            .post(url, __assign({}, config))
            .then(function (httpRes) {
     ...
     *
    **/
    SDK.prototype.AccountCreateOAuth2Session = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.AccountCreateOAuth2SessionRequest(req);
        }
        var baseURL = this.serverURL;
        var url = utils.GenerateURL(baseURL, "/account/sessions/oauth2/{provider}", req.pathParams);
        var client = CreateSecurityClient(this.defaultClient, req.security);
    ...
    **/
    SDK.prototype.AccountCreateSession = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
