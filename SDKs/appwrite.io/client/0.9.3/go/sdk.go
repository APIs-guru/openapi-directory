...
func (s *SDK) AccountCreate(ctx context.Context, request operations.AccountCreateRequest) (*operations.AccountCreateResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) AccountCreateAnonymousSession(ctx context.Context, request operations.AccountCreateAnonymousSessionRequest) (*operations.AccountCreateAnonymousSessionResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) AccountCreateJwt(ctx context.Context, request operations.AccountCreateJwtRequest) (*operations.AccountCreateJwtResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) AccountCreateOAuth2Session(ctx context.Context, request operations.AccountCreateOAuth2SessionRequest) (*operations.AccountCreateOAuth2SessionResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) AccountCreateSession(ctx context.Context, request operations.AccountCreateSessionRequest) (*operations.AccountCreateSessionResponse, error) {
	baseURL := s.serverURL
