...
var Teams = /** @class */ (function () {
    ...
    **/
    Teams.prototype.teamsCreateMembership = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Teams.prototype.teamsDeleteMembership = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Teams.prototype.teamsGetMemberships = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Teams.prototype.teamsUpdateMembershipRoles = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    Teams.prototype.teamsUpdateMembershipStatus = function (req, config) {
        var _a;
        if (!(req instanceof utils.SpeakeasyBase)) {
