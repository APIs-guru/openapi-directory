...
type GetHlsAudioSegmentPathParams struct {
	...
	SegmentID  int32  `pathParam:"style=simple,explode=false,name=segmentId"`
}

type GetHlsAudioSegmentQueryParams struct {
...
type GetHlsAudioSegmentSecurity struct {
	CustomAuthentication shared.SchemeCustomAuthentication `security:"scheme,type=apiKey,subtype=header"`
}

type GetHlsAudioSegmentRequest struct {
...
type GetHlsAudioSegmentResponse struct {
	ContentType                                    string
	GetHlsAudioSegment200AudioWildcardBinaryString []byte
	StatusCode                                     int64
}
