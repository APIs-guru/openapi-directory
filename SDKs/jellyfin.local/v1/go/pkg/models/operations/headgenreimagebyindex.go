...
type HeadGenreImageByIndexPathParams struct {
...
type HeadGenreImageByIndexQueryParams struct {
...
type HeadGenreImageByIndexRequest struct {
...
type HeadGenreImageByIndexResponse struct {
    ContentType string 
    HeadGenreImageByIndex200ImageWildcardBinaryString []byte 
