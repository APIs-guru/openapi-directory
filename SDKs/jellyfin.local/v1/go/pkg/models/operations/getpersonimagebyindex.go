...
type GetPersonImageByIndexPathParams struct {
...
type GetPersonImageByIndexQueryParams struct {
...
type GetPersonImageByIndexRequest struct {
...
type GetPersonImageByIndexResponse struct {
	ContentType                                       string
	GetPersonImageByIndex200ImageWildcardBinaryString []byte
