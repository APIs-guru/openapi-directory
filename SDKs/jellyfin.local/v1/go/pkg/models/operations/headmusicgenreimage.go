...
type HeadMusicGenreImageRequest struct {
...
type HeadMusicGenreImageResponse struct {
    ContentType string 
    HeadMusicGenreImage200ImageWildcardBinaryString []byte 
