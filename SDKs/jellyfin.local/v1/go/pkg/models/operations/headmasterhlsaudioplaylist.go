...
type HeadMasterHlsAudioPlaylistPathParams struct {
	ItemID string `pathParam:"style=simple,explode=false,name=itemId"`
}

type HeadMasterHlsAudioPlaylistQueryParams struct {
...
type HeadMasterHlsAudioPlaylistSecurity struct {
	CustomAuthentication shared.SchemeCustomAuthentication `security:"scheme,type=apiKey,subtype=header"`
}

type HeadMasterHlsAudioPlaylistRequest struct {
...
type HeadMasterHlsAudioPlaylistResponse struct {
	ContentType                                                  string
	HeadMasterHlsAudioPlaylist200ApplicationXMpegurlBinaryString []byte
	StatusCode                                                   int64
}
