...
type HeadAudioStreamByContainerPathParams struct {
    Container string `pathParam:"style=simple,explode=false,name=container"`
    ItemID string `pathParam:"style=simple,explode=false,name=itemId"`
    
}

type HeadAudioStreamByContainerQueryParams struct {
...
type HeadAudioStreamByContainerRequest struct {
...
type HeadAudioStreamByContainerResponse struct {
    ContentType string 
    HeadAudioStreamByContainer200AudioWildcardBinaryString []byte 
    StatusCode int64 
