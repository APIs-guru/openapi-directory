...
type GetStudioImageByIndexPathParams struct {
...
type GetStudioImageByIndexQueryParams struct {
...
type GetStudioImageByIndexRequest struct {
...
type GetStudioImageByIndexResponse struct {
    ContentType string 
    GetStudioImageByIndex200ImageWildcardBinaryString []byte 
