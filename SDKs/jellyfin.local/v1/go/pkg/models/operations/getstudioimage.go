...
type GetStudioImageRequest struct {
...
type GetStudioImageResponse struct {
	ContentType                                string
	GetStudioImage200ImageWildcardBinaryString []byte
