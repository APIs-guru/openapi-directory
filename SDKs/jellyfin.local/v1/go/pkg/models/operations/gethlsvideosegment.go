...
type GetHlsVideoSegmentPathParams struct {
...
type GetHlsVideoSegmentQueryParams struct {
...
type GetHlsVideoSegmentSecurity struct {
    CustomAuthentication shared.SchemeCustomAuthentication `security:"scheme,type=apiKey,subtype=header"`
    
}

type GetHlsVideoSegmentRequest struct {
...
type GetHlsVideoSegmentResponse struct {
    ContentType string 
    GetHlsVideoSegment200VideoWildcardBinaryString []byte 
    StatusCode int64 
