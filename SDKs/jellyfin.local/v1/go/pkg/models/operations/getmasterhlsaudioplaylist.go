...
type GetMasterHlsAudioPlaylistPathParams struct {
	ItemID string `pathParam:"style=simple,explode=false,name=itemId"`
}

type GetMasterHlsAudioPlaylistQueryParams struct {
...
type GetMasterHlsAudioPlaylistSecurity struct {
	CustomAuthentication shared.SchemeCustomAuthentication `security:"scheme,type=apiKey,subtype=header"`
}

type GetMasterHlsAudioPlaylistRequest struct {
...
type GetMasterHlsAudioPlaylistResponse struct {
	ContentType                                                 string
	GetMasterHlsAudioPlaylist200ApplicationXMpegurlBinaryString []byte
	StatusCode                                                  int64
}
