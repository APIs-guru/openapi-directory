...
type GetMusicGenreImageByIndexPathParams struct {
...
type GetMusicGenreImageByIndexQueryParams struct {
...
type GetMusicGenreImageByIndexRequest struct {
...
type GetMusicGenreImageByIndexResponse struct {
    ContentType string 
    GetMusicGenreImageByIndex200ImageWildcardBinaryString []byte 
