...
type HeadItemImageByIndexPathParams struct {
...
type HeadItemImageByIndexQueryParams struct {
...
type HeadItemImageByIndexRequest struct {
...
type HeadItemImageByIndexResponse struct {
    ContentType string 
    HeadItemImageByIndex200ImageWildcardBinaryString []byte 
