...
type GetVariantHlsAudioPlaylistPathParams struct {
    ItemID string `pathParam:"style=simple,explode=false,name=itemId"`
    
}

type GetVariantHlsAudioPlaylistQueryParams struct {
...
type GetVariantHlsAudioPlaylistSecurity struct {
    CustomAuthentication shared.SchemeCustomAuthentication `security:"scheme,type=apiKey,subtype=header"`
    
}

type GetVariantHlsAudioPlaylistRequest struct {
    PathParams GetVariantHlsAudioPlaylistPathParams 
    QueryParams GetVariantHlsAudioPlaylistQueryParams 
    Security GetVariantHlsAudioPlaylistSecurity 
    
}

type GetVariantHlsAudioPlaylistResponse struct {
    ContentType string 
    GetVariantHlsAudioPlaylist200ApplicationXMpegurlBinaryString []byte 
    StatusCode int64 
