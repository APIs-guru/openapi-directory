...
type GetAudioStreamByContainerPathParams struct {
	Container string `pathParam:"style=simple,explode=false,name=container"`
	ItemID    string `pathParam:"style=simple,explode=false,name=itemId"`
}

type GetAudioStreamByContainerQueryParams struct {
...
type GetAudioStreamByContainerRequest struct {
	PathParams  GetAudioStreamByContainerPathParams
	QueryParams GetAudioStreamByContainerQueryParams
}

type GetAudioStreamByContainerResponse struct {
	ContentType                                           string
	GetAudioStreamByContainer200AudioWildcardBinaryString []byte
	StatusCode                                            int64
}
