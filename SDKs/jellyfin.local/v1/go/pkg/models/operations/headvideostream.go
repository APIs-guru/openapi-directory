...
type HeadVideoStreamPathParams struct {
	ItemID string `pathParam:"style=simple,explode=false,name=itemId"`
}

type HeadVideoStreamQueryParams struct {
...
type HeadVideoStreamRequest struct {
...
type HeadVideoStreamResponse struct {
	ContentType                                 string
	HeadVideoStream200VideoWildcardBinaryString []byte
	StatusCode                                  int64
}
