...
type HeadMasterHlsVideoPlaylistPathParams struct {
    ItemID string `pathParam:"style=simple,explode=false,name=itemId"`
    
}

type HeadMasterHlsVideoPlaylistQueryParams struct {
...
type HeadMasterHlsVideoPlaylistSecurity struct {
    CustomAuthentication shared.SchemeCustomAuthentication `security:"scheme,type=apiKey,subtype=header"`
    
}

type HeadMasterHlsVideoPlaylistRequest struct {
...
type HeadMasterHlsVideoPlaylistResponse struct {
    ContentType string 
    HeadMasterHlsVideoPlaylist200ApplicationXMpegurlBinaryString []byte 
    StatusCode int64 
