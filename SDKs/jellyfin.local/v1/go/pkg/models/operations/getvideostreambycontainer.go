...
type GetVideoStreamByContainerPathParams struct {
...
type GetVideoStreamByContainerQueryParams struct {
...
type GetVideoStreamByContainerRequest struct {
...
type GetVideoStreamByContainerResponse struct {
    ContentType string 
    GetVideoStreamByContainer200VideoWildcardBinaryString []byte 
    StatusCode int64 
