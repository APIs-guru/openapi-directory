...
type GetVariantHlsVideoPlaylistPathParams struct {
    ItemID string `pathParam:"style=simple,explode=false,name=itemId"`
    
}

type GetVariantHlsVideoPlaylistQueryParams struct {
...
type GetVariantHlsVideoPlaylistSecurity struct {
    CustomAuthentication shared.SchemeCustomAuthentication `security:"scheme,type=apiKey,subtype=header"`
    
}

type GetVariantHlsVideoPlaylistRequest struct {
...
type GetVariantHlsVideoPlaylistResponse struct {
    ContentType string 
    GetVariantHlsVideoPlaylist200ApplicationXMpegurlBinaryString []byte 
    StatusCode int64 
