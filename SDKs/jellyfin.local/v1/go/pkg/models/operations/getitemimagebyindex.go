...
type GetItemImageByIndexPathParams struct {
...
type GetItemImageByIndexQueryParams struct {
...
type GetItemImageByIndexRequest struct {
...
type GetItemImageByIndexResponse struct {
    ContentType string 
    GetItemImageByIndex200ImageWildcardBinaryString []byte 
