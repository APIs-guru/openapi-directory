...
type HeadArtistImagePathParams struct {
...
type HeadArtistImageQueryParams struct {
...
type HeadArtistImageRequest struct {
...
type HeadArtistImageResponse struct {
    ContentType string 
    HeadArtistImage200ImageWildcardBinaryString []byte 
