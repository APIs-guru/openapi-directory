...
type GetMusicGenreImageRequest struct {
...
type GetMusicGenreImageResponse struct {
    ContentType string 
    GetMusicGenreImage200ImageWildcardBinaryString []byte 
