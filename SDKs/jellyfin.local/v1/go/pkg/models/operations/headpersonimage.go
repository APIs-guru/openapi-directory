...
type HeadPersonImageRequest struct {
...
type HeadPersonImageResponse struct {
    ContentType string 
    HeadPersonImage200ImageWildcardBinaryString []byte 
