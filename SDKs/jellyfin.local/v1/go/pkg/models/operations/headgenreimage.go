...
type HeadGenreImageRequest struct {
...
type HeadGenreImageResponse struct {
	ContentType                                string
	HeadGenreImage200ImageWildcardBinaryString []byte
