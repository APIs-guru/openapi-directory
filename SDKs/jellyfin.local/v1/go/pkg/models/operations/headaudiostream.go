...
type HeadAudioStreamPathParams struct {
    ItemID string `pathParam:"style=simple,explode=false,name=itemId"`
    
}

type HeadAudioStreamQueryParams struct {
...
type HeadAudioStreamRequest struct {
...
type HeadAudioStreamResponse struct {
    ContentType string 
    HeadAudioStream200AudioWildcardBinaryString []byte 
    StatusCode int64 
