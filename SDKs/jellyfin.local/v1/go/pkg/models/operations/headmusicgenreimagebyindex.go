...
type HeadMusicGenreImageByIndexPathParams struct {
...
type HeadMusicGenreImageByIndexQueryParams struct {
...
type HeadMusicGenreImageByIndexRequest struct {
...
type HeadMusicGenreImageByIndexResponse struct {
    ContentType string 
    HeadMusicGenreImageByIndex200ImageWildcardBinaryString []byte 
