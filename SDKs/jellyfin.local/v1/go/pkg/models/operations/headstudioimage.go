...
type HeadStudioImageRequest struct {
...
type HeadStudioImageResponse struct {
	ContentType                                 string
	HeadStudioImage200ImageWildcardBinaryString []byte
