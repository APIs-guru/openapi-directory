...
type HeadPersonImageByIndexPathParams struct {
...
type HeadPersonImageByIndexQueryParams struct {
...
type HeadPersonImageByIndexRequest struct {
...
type HeadPersonImageByIndexResponse struct {
    ContentType string 
    HeadPersonImageByIndex200ImageWildcardBinaryString []byte 
