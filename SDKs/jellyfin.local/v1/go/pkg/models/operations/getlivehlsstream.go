...
type GetLiveHlsStreamPathParams struct {
	ItemID string `pathParam:"style=simple,explode=false,name=itemId"`
}

type GetLiveHlsStreamQueryParams struct {
	...
	EnableSubtitlesInManifest   *bool                              `queryParam:"style=form,explode=true,name=enableSubtitlesInManifest"`
...
type GetLiveHlsStreamSecurity struct {
	CustomAuthentication shared.SchemeCustomAuthentication `security:"scheme,type=apiKey,subtype=header"`
}

type GetLiveHlsStreamRequest struct {
...
type GetLiveHlsStreamResponse struct {
	ContentType                                        string
	GetLiveHlsStream200ApplicationXMpegurlBinaryString []byte
	StatusCode                                         int64
}
