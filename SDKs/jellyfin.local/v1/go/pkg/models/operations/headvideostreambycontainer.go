...
type HeadVideoStreamByContainerPathParams struct {
...
type HeadVideoStreamByContainerQueryParams struct {
...
type HeadVideoStreamByContainerRequest struct {
...
type HeadVideoStreamByContainerResponse struct {
	ContentType                                            string
	HeadVideoStreamByContainer200VideoWildcardBinaryString []byte
	StatusCode                                             int64
}
