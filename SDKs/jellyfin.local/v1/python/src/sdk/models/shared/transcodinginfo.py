...
from . import transcodereason_enum


@dataclass_json
@dataclass
class TranscodingInfo:
    audio_channels: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'AudioChannels' }})
    ...
    framerate: Optional[float] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Framerate' }})
    height: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'Height' }})
    is_audio_direct: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'IsAudioDirect' }})
    is_video_direct: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'IsVideoDirect' }})
    transcode_reasons: Optional[List[transcodereason_enum.TranscodeReasonEnum]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'TranscodeReasons' }})
