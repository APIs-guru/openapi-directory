...
@dataclass
class AlbumInfo:
    album_artists: Optional[List[str]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'AlbumArtists' }})
    artist_provider_ids: Optional[dict[str, str]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'ArtistProviderIds' }})
