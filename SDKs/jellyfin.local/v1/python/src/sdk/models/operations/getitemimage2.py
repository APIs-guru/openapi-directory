...
@dataclass
class GetItemImage2QueryParams:
...
@dataclass
class GetItemImage2Request:
    path_params: GetItemImage2PathParams = field(default=None)
    query_params: GetItemImage2QueryParams = field(default=None)
    

@dataclass
class GetItemImage2Response:
    content_type: str = field(default=None)
    get_item_image2_200_image_wildcard_binary_string: Optional[bytes] = field(default=None)
