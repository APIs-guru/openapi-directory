...
@dataclass
class GetAlbumArtistsQueryParams:
...
@dataclass
class GetAlbumArtistsSecurity:
    custom_authentication: shared.SchemeCustomAuthentication = field(default=None, metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclass
class GetAlbumArtistsRequest:
    query_params: GetAlbumArtistsQueryParams = field(default=None)
    security: GetAlbumArtistsSecurity = field(default=None)
    

@dataclass
class GetAlbumArtistsResponse:
