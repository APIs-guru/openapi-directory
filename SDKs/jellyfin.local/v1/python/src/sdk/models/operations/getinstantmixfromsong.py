...
class GetInstantMixFromSongRequest:
    path_params: GetInstantMixFromSongPathParams = field(default=None)
    query_params: GetInstantMixFromSongQueryParams = field(default=None)
    security: GetInstantMixFromSongSecurity = field(default=None)
