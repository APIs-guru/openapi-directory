...
@dataclass
class HeadVideoStreamPathParams:
    item_id: str = field(default=None, metadata={'path_param': { 'field_name': 'itemId', 'style': 'simple', 'explode': False }})
    

@dataclass
class HeadVideoStreamQueryParams:
...
@dataclass
class HeadVideoStreamRequest:
    path_params: HeadVideoStreamPathParams = field(default=None)
    query_params: HeadVideoStreamQueryParams = field(default=None)
    

@dataclass
class HeadVideoStreamResponse:
    content_type: str = field(default=None)
    head_video_stream_200_video_wildcard_binary_string: Optional[bytes] = field(default=None)
