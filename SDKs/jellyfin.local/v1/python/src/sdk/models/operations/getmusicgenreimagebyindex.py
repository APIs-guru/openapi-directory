...
@dataclass
class GetMusicGenreImageByIndexPathParams:
...
@dataclass
class GetMusicGenreImageByIndexQueryParams:
...
@dataclass
class GetMusicGenreImageByIndexRequest:
    path_params: GetMusicGenreImageByIndexPathParams = field(default=None)
    query_params: GetMusicGenreImageByIndexQueryParams = field(default=None)
    

@dataclass
class GetMusicGenreImageByIndexResponse:
    content_type: str = field(default=None)
    get_music_genre_image_by_index_200_image_wildcard_binary_string: Optional[bytes] = field(default=None)
