...
@dataclass
class HeadArtistImagePathParams:
...
@dataclass
class HeadArtistImageQueryParams:
...
@dataclass
class HeadArtistImageRequest:
    path_params: HeadArtistImagePathParams = field(default=None)
    query_params: HeadArtistImageQueryParams = field(default=None)
    

@dataclass
class HeadArtistImageResponse:
    content_type: str = field(default=None)
    head_artist_image_200_image_wildcard_binary_string: Optional[bytes] = field(default=None)
