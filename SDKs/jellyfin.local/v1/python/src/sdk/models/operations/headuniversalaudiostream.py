...
class HeadUniversalAudioStreamRequest:
    path_params: HeadUniversalAudioStreamPathParams = field()
    query_params: HeadUniversalAudioStreamQueryParams = field()
    security: HeadUniversalAudioStreamSecurity = field()
