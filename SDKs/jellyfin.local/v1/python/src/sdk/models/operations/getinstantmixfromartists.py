...
@dataclass
class GetInstantMixFromArtistsPathParams:
    id: str = field(metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetInstantMixFromArtistsQueryParams:
...
@dataclass
class GetInstantMixFromArtistsSecurity:
    custom_authentication: shared.SchemeCustomAuthentication = field(metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclass
class GetInstantMixFromArtistsRequest:
    path_params: GetInstantMixFromArtistsPathParams = field()
    query_params: GetInstantMixFromArtistsQueryParams = field()
    security: GetInstantMixFromArtistsSecurity = field()
    

@dataclass
class GetInstantMixFromArtistsResponse:
