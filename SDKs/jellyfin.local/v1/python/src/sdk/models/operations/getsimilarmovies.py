...
class GetSimilarMoviesRequest:
    path_params: GetSimilarMoviesPathParams = field(default=None)
    query_params: GetSimilarMoviesQueryParams = field(default=None)
    security: GetSimilarMoviesSecurity = field(default=None)
