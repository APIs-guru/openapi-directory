...
@dataclass
class GetLiveHlsStreamQueryParams:
    ...
    enable_subtitles_in_manifest: Optional[bool] = field(default=None, metadata={'query_param': { 'field_name': 'enableSubtitlesInManifest', 'style': 'form', 'explode': True }})
