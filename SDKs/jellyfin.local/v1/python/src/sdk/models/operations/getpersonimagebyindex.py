...
@dataclass
class GetPersonImageByIndexPathParams:
...
@dataclass
class GetPersonImageByIndexQueryParams:
...
@dataclass
class GetPersonImageByIndexRequest:
    path_params: GetPersonImageByIndexPathParams = field(default=None)
    query_params: GetPersonImageByIndexQueryParams = field(default=None)
    

@dataclass
class GetPersonImageByIndexResponse:
    content_type: str = field(default=None)
    get_person_image_by_index_200_image_wildcard_binary_string: Optional[bytes] = field(default=None)
