...
@dataclass
class GetPersonImagePathParams:
...
@dataclass
class GetPersonImageQueryParams:
...
@dataclass
class GetPersonImageRequest:
    path_params: GetPersonImagePathParams = field(default=None)
    query_params: GetPersonImageQueryParams = field(default=None)
    

@dataclass
class GetPersonImageResponse:
    content_type: str = field(default=None)
    get_person_image_200_image_wildcard_binary_string: Optional[bytes] = field(default=None)
