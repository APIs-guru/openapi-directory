...
@dataclass
class HeadMusicGenreImageByIndexPathParams:
...
@dataclass
class HeadMusicGenreImageByIndexQueryParams:
...
@dataclass
class HeadMusicGenreImageByIndexRequest:
    path_params: HeadMusicGenreImageByIndexPathParams = field(default=None)
    query_params: HeadMusicGenreImageByIndexQueryParams = field(default=None)
    

@dataclass
class HeadMusicGenreImageByIndexResponse:
    content_type: str = field(default=None)
    head_music_genre_image_by_index_200_image_wildcard_binary_string: Optional[bytes] = field(default=None)
