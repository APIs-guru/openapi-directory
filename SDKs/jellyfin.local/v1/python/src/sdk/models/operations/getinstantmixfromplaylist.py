...
class GetInstantMixFromPlaylistRequest:
    path_params: GetInstantMixFromPlaylistPathParams = field()
    query_params: GetInstantMixFromPlaylistQueryParams = field()
    security: GetInstantMixFromPlaylistSecurity = field()
