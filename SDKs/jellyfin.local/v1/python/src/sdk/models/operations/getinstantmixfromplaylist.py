...
@dataclass
class GetInstantMixFromPlaylistPathParams:
    id: str = field(default=None, metadata={'path_param': { 'field_name': 'id', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetInstantMixFromPlaylistQueryParams:
...
@dataclass
class GetInstantMixFromPlaylistSecurity:
    custom_authentication: shared.SchemeCustomAuthentication = field(default=None, metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclass
class GetInstantMixFromPlaylistRequest:
    path_params: GetInstantMixFromPlaylistPathParams = field(default=None)
    query_params: GetInstantMixFromPlaylistQueryParams = field(default=None)
    security: GetInstantMixFromPlaylistSecurity = field(default=None)
    

@dataclass
class GetInstantMixFromPlaylistResponse:
