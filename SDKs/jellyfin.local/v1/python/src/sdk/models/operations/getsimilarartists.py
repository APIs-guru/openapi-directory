...
@dataclass
class GetSimilarArtistsPathParams:
    item_id: str = field(default=None, metadata={'path_param': { 'field_name': 'itemId', 'style': 'simple', 'explode': False }})
    

@dataclass
class GetSimilarArtistsQueryParams:
...
@dataclass
class GetSimilarArtistsSecurity:
    custom_authentication: shared.SchemeCustomAuthentication = field(default=None, metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclass
class GetSimilarArtistsRequest:
    path_params: GetSimilarArtistsPathParams = field(default=None)
    query_params: GetSimilarArtistsQueryParams = field(default=None)
    security: GetSimilarArtistsSecurity = field(default=None)
    

@dataclass
class GetSimilarArtistsResponse:
