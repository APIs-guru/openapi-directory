...
@dataclass
class GetStudiosSecurity:
    custom_authentication: shared.SchemeCustomAuthentication = field(default=None, metadata={'security': { 'scheme': True, 'type': 'apiKey', 'sub_type': 'header' }})
    

@dataclass
class GetStudiosRequest:
    query_params: GetStudiosQueryParams = field(default=None)
    security: GetStudiosSecurity = field(default=None)
    

@dataclass
class GetStudiosResponse:
