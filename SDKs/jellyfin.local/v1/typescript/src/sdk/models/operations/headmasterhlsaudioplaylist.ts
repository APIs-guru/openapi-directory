...
export class HeadMasterHlsAudioPlaylistPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=itemId" })
  itemId: string;
}


export class HeadMasterHlsAudioPlaylistQueryParams extends SpeakeasyBase {
...
export class HeadMasterHlsAudioPlaylistSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header" })
  customAuthentication: shared.SchemeCustomAuthentication;
}


export class HeadMasterHlsAudioPlaylistRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class HeadMasterHlsAudioPlaylistResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
