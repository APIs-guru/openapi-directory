...
export class HeadArtistImagePathParams extends SpeakeasyBase {
...
export class HeadArtistImageQueryParams extends SpeakeasyBase {
...
export class HeadArtistImageRequest extends SpeakeasyBase {
  @Metadata()
...
export class HeadArtistImageResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
