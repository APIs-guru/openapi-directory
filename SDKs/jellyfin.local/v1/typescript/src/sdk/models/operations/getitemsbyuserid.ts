...
export class GetItemsByUserIdPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=userId" })
  userId: string;
}


export class GetItemsByUserIdQueryParams extends SpeakeasyBase {
...
export class GetItemsByUserIdSecurity extends SpeakeasyBase {
  @Metadata({ data: "security, scheme=true;type=apiKey;subtype=header" })
  customAuthentication: shared.SchemeCustomAuthentication;
}


export class GetItemsByUserIdRequest extends SpeakeasyBase {
  @Metadata()
...
export class GetItemsByUserIdResponse extends SpeakeasyBase {
  @Metadata()
