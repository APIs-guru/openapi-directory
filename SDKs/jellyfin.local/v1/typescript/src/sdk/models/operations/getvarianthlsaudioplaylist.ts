...
export class GetVariantHlsAudioPlaylistPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=itemId" })
  itemId: string;
}


export class GetVariantHlsAudioPlaylistQueryParams extends SpeakeasyBase {
...
export class GetVariantHlsAudioPlaylistSecurity extends SpeakeasyBase {
  @Metadata({ data: "security, scheme=true;type=apiKey;subtype=header" })
  customAuthentication: shared.SchemeCustomAuthentication;
}


export class GetVariantHlsAudioPlaylistRequest extends SpeakeasyBase {
  @Metadata()
...
export class GetVariantHlsAudioPlaylistResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
