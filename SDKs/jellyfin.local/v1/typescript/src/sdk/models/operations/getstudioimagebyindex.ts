...
export class GetStudioImageByIndexPathParams extends SpeakeasyBase {
...
export class GetStudioImageByIndexQueryParams extends SpeakeasyBase {
...
export class GetStudioImageByIndexRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetStudioImageByIndexResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
