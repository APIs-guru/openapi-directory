...
export class GetMusicGenresQueryParams extends SpeakeasyBase {
...
export class GetMusicGenresSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header" })
  customAuthentication: shared.SchemeCustomAuthentication;
}


export class GetMusicGenresRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetMusicGenresResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
