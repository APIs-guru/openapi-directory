...
export class HeadGenreImagePathParams extends SpeakeasyBase {
...
export class HeadGenreImageQueryParams extends SpeakeasyBase {
...
export class HeadGenreImageRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class HeadGenreImageResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
