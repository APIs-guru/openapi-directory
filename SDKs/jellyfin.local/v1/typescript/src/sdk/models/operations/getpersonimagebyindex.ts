...
export class GetPersonImageByIndexPathParams extends SpeakeasyBase {
...
export class GetPersonImageByIndexQueryParams extends SpeakeasyBase {
...
export class GetPersonImageByIndexRequest extends SpeakeasyBase {
  @Metadata()
...
export class GetPersonImageByIndexResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
