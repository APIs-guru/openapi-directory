...
export class GetMasterHlsVideoPlaylistPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=itemId" })
  itemId: string;
}


export class GetMasterHlsVideoPlaylistQueryParams extends SpeakeasyBase {
...
export class GetMasterHlsVideoPlaylistSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header" })
  customAuthentication: shared.SchemeCustomAuthentication;
}


export class GetMasterHlsVideoPlaylistRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetMasterHlsVideoPlaylistResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
