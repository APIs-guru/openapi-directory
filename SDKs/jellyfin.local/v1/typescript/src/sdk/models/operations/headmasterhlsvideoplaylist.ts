...
export class HeadMasterHlsVideoPlaylistPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=itemId" })
  itemId: string;
}


export class HeadMasterHlsVideoPlaylistQueryParams extends SpeakeasyBase {
...
export class HeadMasterHlsVideoPlaylistSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header" })
  customAuthentication: shared.SchemeCustomAuthentication;
}


export class HeadMasterHlsVideoPlaylistRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class HeadMasterHlsVideoPlaylistResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
