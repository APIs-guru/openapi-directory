...
export class GetMusicGenreImageByIndexPathParams extends SpeakeasyBase {
...
export class GetMusicGenreImageByIndexQueryParams extends SpeakeasyBase {
...
export class GetMusicGenreImageByIndexRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  pathParams: GetMusicGenreImageByIndexPathParams;

  @SpeakeasyMetadata()
  queryParams: GetMusicGenreImageByIndexQueryParams;
}


export class GetMusicGenreImageByIndexResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;

  @SpeakeasyMetadata()
  getMusicGenreImageByIndex200ImageWildcardBinaryString?: Uint8Array;
