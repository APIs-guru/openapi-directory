...
export class GetUserImagePathParams extends SpeakeasyBase {
...
export class GetUserImageQueryParams extends SpeakeasyBase {
...
export class GetUserImageRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetUserImageResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
