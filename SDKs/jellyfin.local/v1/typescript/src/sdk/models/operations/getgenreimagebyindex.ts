...
export class GetGenreImageByIndexPathParams extends SpeakeasyBase {
...
export class GetGenreImageByIndexQueryParams extends SpeakeasyBase {
...
export class GetGenreImageByIndexRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetGenreImageByIndexResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
