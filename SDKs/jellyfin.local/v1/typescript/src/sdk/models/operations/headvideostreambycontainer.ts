...
export class HeadVideoStreamByContainerPathParams extends SpeakeasyBase {
  ...
  @Metadata({ data: "pathParam, style=simple;explode=false;name=stream" })
  stream: string;
}


export class HeadVideoStreamByContainerQueryParams extends SpeakeasyBase {
...
export class HeadVideoStreamByContainerRequest extends SpeakeasyBase {
  @Metadata()
  pathParams: HeadVideoStreamByContainerPathParams;

  @Metadata()
  queryParams: HeadVideoStreamByContainerQueryParams;
}


export class HeadVideoStreamByContainerResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;

  @Metadata()
  headVideoStreamByContainer200VideoWildcardBinaryString?: Uint8Array;
