...
export class GetHlsAudioSegmentPathParams extends SpeakeasyBase {
...
export class GetHlsAudioSegmentQueryParams extends SpeakeasyBase {
...
export class GetHlsAudioSegmentSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header" })
  customAuthentication: shared.SchemeCustomAuthentication;
}


export class GetHlsAudioSegmentRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetHlsAudioSegmentResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
