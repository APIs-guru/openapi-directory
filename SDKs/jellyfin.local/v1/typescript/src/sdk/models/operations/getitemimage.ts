...
export class GetItemImagePathParams extends SpeakeasyBase {
...
export class GetItemImageQueryParams extends SpeakeasyBase {
...
export class GetItemImageRequest extends SpeakeasyBase {
  @Metadata()
...
export class GetItemImageResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
