...
export class GetAudioStreamByContainerPathParams extends SpeakeasyBase {
...
export class GetAudioStreamByContainerQueryParams extends SpeakeasyBase {
...
export class GetAudioStreamByContainerRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetAudioStreamByContainerResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
