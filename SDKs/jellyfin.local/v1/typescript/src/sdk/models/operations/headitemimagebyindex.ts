...
export class HeadItemImageByIndexPathParams extends SpeakeasyBase {
...
export class HeadItemImageByIndexQueryParams extends SpeakeasyBase {
...
export class HeadItemImageByIndexRequest extends SpeakeasyBase {
  @Metadata()
...
export class HeadItemImageByIndexResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
