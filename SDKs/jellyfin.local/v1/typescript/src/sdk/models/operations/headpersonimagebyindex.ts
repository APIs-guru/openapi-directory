...
export class HeadPersonImageByIndexPathParams extends SpeakeasyBase {
...
export class HeadPersonImageByIndexQueryParams extends SpeakeasyBase {
...
export class HeadPersonImageByIndexRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class HeadPersonImageByIndexResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
