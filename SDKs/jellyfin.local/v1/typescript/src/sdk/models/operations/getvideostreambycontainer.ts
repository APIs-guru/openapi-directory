...
export class GetVideoStreamByContainerPathParams extends SpeakeasyBase {
...
export class GetVideoStreamByContainerQueryParams extends SpeakeasyBase {
...
export class GetVideoStreamByContainerRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
  pathParams: GetVideoStreamByContainerPathParams;

  @SpeakeasyMetadata()
  queryParams: GetVideoStreamByContainerQueryParams;
}


export class GetVideoStreamByContainerResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;

  @SpeakeasyMetadata()
  getVideoStreamByContainer200VideoWildcardBinaryString?: Uint8Array;
