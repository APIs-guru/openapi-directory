...
export class HeadAudioStreamPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=itemId" })
  itemId: string;
}


export class HeadAudioStreamQueryParams extends SpeakeasyBase {
...
export class HeadAudioStreamRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class HeadAudioStreamResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
