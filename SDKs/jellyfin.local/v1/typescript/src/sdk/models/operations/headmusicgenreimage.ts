...
export class HeadMusicGenreImagePathParams extends SpeakeasyBase {
...
export class HeadMusicGenreImageQueryParams extends SpeakeasyBase {
...
export class HeadMusicGenreImageRequest extends SpeakeasyBase {
  @Metadata()
...
export class HeadMusicGenreImageResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
