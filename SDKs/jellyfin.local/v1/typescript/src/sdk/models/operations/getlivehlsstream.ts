...
export class GetLiveHlsStreamPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=itemId" })
  itemId: string;
}


export class GetLiveHlsStreamQueryParams extends SpeakeasyBase {
  ...
  @SpeakeasyMetadata({ data: "queryParam, style=form;explode=true;name=enableSubtitlesInManifest" })
...
export class GetLiveHlsStreamSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header" })
  customAuthentication: shared.SchemeCustomAuthentication;
}


export class GetLiveHlsStreamRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetLiveHlsStreamResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
