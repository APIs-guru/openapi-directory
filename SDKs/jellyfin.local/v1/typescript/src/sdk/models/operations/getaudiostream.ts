...
export class GetAudioStreamPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=itemId" })
  itemId: string;
}


export class GetAudioStreamQueryParams extends SpeakeasyBase {
...
export class GetAudioStreamRequest extends SpeakeasyBase {
  @Metadata()
...
export class GetAudioStreamResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
