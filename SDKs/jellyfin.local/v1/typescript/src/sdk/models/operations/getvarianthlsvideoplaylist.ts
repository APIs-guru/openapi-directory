...
export class GetVariantHlsVideoPlaylistPathParams extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=itemId" })
  itemId: string;
}


export class GetVariantHlsVideoPlaylistQueryParams extends SpeakeasyBase {
...
export class GetVariantHlsVideoPlaylistSecurity extends SpeakeasyBase {
  @SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header" })
  customAuthentication: shared.SchemeCustomAuthentication;
}


export class GetVariantHlsVideoPlaylistRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class GetVariantHlsVideoPlaylistResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
