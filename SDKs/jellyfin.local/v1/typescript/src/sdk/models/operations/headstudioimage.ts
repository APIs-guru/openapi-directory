...
export class HeadStudioImagePathParams extends SpeakeasyBase {
...
export class HeadStudioImageQueryParams extends SpeakeasyBase {
...
export class HeadStudioImageRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class HeadStudioImageResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
