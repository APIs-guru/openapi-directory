...
export class GetPersonImagePathParams extends SpeakeasyBase {
...
export class GetPersonImageQueryParams extends SpeakeasyBase {
...
export class GetPersonImageRequest extends SpeakeasyBase {
  @Metadata()
...
export class GetPersonImageResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
