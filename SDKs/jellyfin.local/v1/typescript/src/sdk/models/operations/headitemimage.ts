...
export class HeadItemImagePathParams extends SpeakeasyBase {
...
export class HeadItemImageQueryParams extends SpeakeasyBase {
...
export class HeadItemImageRequest extends SpeakeasyBase {
  @SpeakeasyMetadata()
...
export class HeadItemImageResponse extends SpeakeasyBase {
  @SpeakeasyMetadata()
  contentType: string;
