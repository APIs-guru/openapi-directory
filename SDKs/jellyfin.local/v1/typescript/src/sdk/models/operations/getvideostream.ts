...
export class GetVideoStreamPathParams extends SpeakeasyBase {
  @Metadata({ data: "pathParam, style=simple;explode=false;name=itemId" })
  itemId: string;
}


export class GetVideoStreamQueryParams extends SpeakeasyBase {
...
export class GetVideoStreamRequest extends SpeakeasyBase {
  @Metadata()
...
export class GetVideoStreamResponse extends SpeakeasyBase {
  @Metadata()
  contentType: string;
