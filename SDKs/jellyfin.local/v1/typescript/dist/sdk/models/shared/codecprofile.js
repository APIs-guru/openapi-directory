...
var CodecProfile = /** @class */ (function (_super) {
    __extends(CodecProfile, _super);
    ...
    ], CodecProfile.prototype, "applyConditions", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Codec" }),
        __metadata("design:type", String)
    ], CodecProfile.prototype, "codec", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Conditions", elemType: ProfileCondition }),
        __metadata("design:type", Array)
    ], CodecProfile.prototype, "conditions", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Container" }),
        __metadata("design:type", String)
    ], CodecProfile.prototype, "container", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Type" }),
        __metadata("design:type", String)
    ], CodecProfile.prototype, "type", void 0);
    return CodecProfile;
}(SpeakeasyBase));
export { CodecProfile };
