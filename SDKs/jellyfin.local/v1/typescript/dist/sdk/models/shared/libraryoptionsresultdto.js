...
**/
var LibraryOptionsResultDto = /** @class */ (function (_super) {
    __extends(LibraryOptionsResultDto, _super);
    function LibraryOptionsResultDto() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=MetadataReaders", elemType: LibraryOptionInfoDto }),
        __metadata("design:type", Array)
    ], LibraryOptionsResultDto.prototype, "metadataReaders", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=MetadataSavers", elemType: LibraryOptionInfoDto }),
        __metadata("design:type", Array)
    ], LibraryOptionsResultDto.prototype, "metadataSavers", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=SubtitleFetchers", elemType: LibraryOptionInfoDto }),
        __metadata("design:type", Array)
    ], LibraryOptionsResultDto.prototype, "subtitleFetchers", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=TypeOptions", elemType: LibraryTypeOptionsDto }),
        __metadata("design:type", Array)
    ], LibraryOptionsResultDto.prototype, "typeOptions", void 0);
    return LibraryOptionsResultDto;
}(SpeakeasyBase));
export { LibraryOptionsResultDto };
