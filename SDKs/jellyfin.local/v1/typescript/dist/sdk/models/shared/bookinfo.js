...
var BookInfo = /** @class */ (function (_super) {
    ...
    ], BookInfo.prototype, "indexNumber", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=IsAutomated" }),
        __metadata("design:type", Boolean)
    ], BookInfo.prototype, "isAutomated", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=MetadataCountryCode" }),
        __metadata("design:type", String)
    ], BookInfo.prototype, "metadataCountryCode", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=MetadataLanguage" }),
        __metadata("design:type", String)
    ], BookInfo.prototype, "metadataLanguage", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Name" }),
        __metadata("design:type", String)
    ], BookInfo.prototype, "name", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ParentIndexNumber" }),
        __metadata("design:type", Number)
    ], BookInfo.prototype, "parentIndexNumber", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Path" }),
        __metadata("design:type", String)
    ], BookInfo.prototype, "path", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=PremiereDate" }),
        __metadata("design:type", Date)
    ], BookInfo.prototype, "premiereDate", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ProviderIds" }),
        __metadata("design:type", Map)
    ], BookInfo.prototype, "providerIds", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=SeriesName" }),
        __metadata("design:type", String)
    ], BookInfo.prototype, "seriesName", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Year" }),
        __metadata("design:type", Number)
    ], BookInfo.prototype, "year", void 0);
    return BookInfo;
}(SpeakeasyBase));
export { BookInfo };
