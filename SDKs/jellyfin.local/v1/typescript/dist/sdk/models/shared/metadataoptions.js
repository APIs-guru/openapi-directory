...
var MetadataOptions = /** @class */ (function (_super) {
    ...
    ], MetadataOptions.prototype, "disabledImageFetchers", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=DisabledMetadataFetchers" }),
        __metadata("design:type", Array)
    ], MetadataOptions.prototype, "disabledMetadataFetchers", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=DisabledMetadataSavers" }),
        __metadata("design:type", Array)
    ], MetadataOptions.prototype, "disabledMetadataSavers", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ImageFetcherOrder" }),
        __metadata("design:type", Array)
    ], MetadataOptions.prototype, "imageFetcherOrder", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ItemType" }),
        __metadata("design:type", String)
    ], MetadataOptions.prototype, "itemType", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=LocalMetadataReaderOrder" }),
        __metadata("design:type", Array)
    ], MetadataOptions.prototype, "localMetadataReaderOrder", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=MetadataFetcherOrder" }),
        __metadata("design:type", Array)
    ], MetadataOptions.prototype, "metadataFetcherOrder", void 0);
