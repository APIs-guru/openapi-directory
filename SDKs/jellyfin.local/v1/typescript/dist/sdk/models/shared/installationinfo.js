...
var InstallationInfo = /** @class */ (function (_super) {
    ...
    ], InstallationInfo.prototype, "changelog", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Checksum" }),
        __metadata("design:type", String)
    ], InstallationInfo.prototype, "checksum", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Guid" }),
        __metadata("design:type", String)
    ], InstallationInfo.prototype, "guid", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Name" }),
        __metadata("design:type", String)
    ], InstallationInfo.prototype, "name", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=SourceUrl" }),
        __metadata("design:type", String)
    ], InstallationInfo.prototype, "sourceUrl", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Version" }),
        __metadata("design:type", Version)
    ], InstallationInfo.prototype, "version", void 0);
    return InstallationInfo;
}(SpeakeasyBase));
export { InstallationInfo };
