...
var TypeOptions = /** @class */ (function (_super) {
    ...
    ], TypeOptions.prototype, "imageFetcherOrder", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ImageFetchers" }),
        __metadata("design:type", Array)
    ], TypeOptions.prototype, "imageFetchers", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=ImageOptions", elemType: ImageOption }),
        __metadata("design:type", Array)
    ], TypeOptions.prototype, "imageOptions", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=MetadataFetcherOrder" }),
        __metadata("design:type", Array)
    ], TypeOptions.prototype, "metadataFetcherOrder", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=MetadataFetchers" }),
        __metadata("design:type", Array)
    ], TypeOptions.prototype, "metadataFetchers", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=Type" }),
        __metadata("design:type", String)
    ], TypeOptions.prototype, "type", void 0);
    return TypeOptions;
}(SpeakeasyBase));
export { TypeOptions };
