...
var CreateProfileRequests = /** @class */ (function (_super) {
    __extends(CreateProfileRequests, _super);
    function CreateProfileRequests() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "request, media_type=application/*+json" }),
        __metadata("design:type", shared.DeviceProfile)
    ], CreateProfileRequests.prototype, "deviceProfile", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "request, media_type=application/json" }),
        __metadata("design:type", shared.DeviceProfile)
    ], CreateProfileRequests.prototype, "deviceProfile1", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "request, media_type=text/json" }),
        __metadata("design:type", shared.DeviceProfile)
    ], CreateProfileRequests.prototype, "deviceProfile2", void 0);
    return CreateProfileRequests;
}(SpeakeasyBase));
export { CreateProfileRequests };
var CreateProfileSecurity = /** @class */ (function (_super) {
    ...
    ], CreateProfileSecurity.prototype, "customAuthentication", void 0);
...
var CreateProfileRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", CreateProfileRequests)
