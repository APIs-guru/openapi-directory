...
var DeleteProfilePathParams = /** @class */ (function (_super) {
    ...
    ], DeleteProfilePathParams.prototype, "profileId", void 0);
    return DeleteProfilePathParams;
}(SpeakeasyBase));
export { DeleteProfilePathParams };
var DeleteProfileSecurity = /** @class */ (function (_super) {
    __extends(DeleteProfileSecurity, _super);
    function DeleteProfileSecurity() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header" }),
        __metadata("design:type", shared.SchemeCustomAuthentication)
    ], DeleteProfileSecurity.prototype, "customAuthentication", void 0);
    return DeleteProfileSecurity;
}(SpeakeasyBase));
export { DeleteProfileSecurity };
var DeleteProfileRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", DeleteProfileSecurity)
    ], DeleteProfileRequest.prototype, "security", void 0);
...
var DeleteProfileResponse = /** @class */ (function (_super) {
    ...
    ], DeleteProfileResponse.prototype, "problemDetails", void 0);
    __decorate([
        SpeakeasyMetadata(),
