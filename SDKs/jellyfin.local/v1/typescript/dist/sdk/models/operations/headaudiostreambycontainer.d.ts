...
export declare class HeadAudioStreamByContainerPathParams extends SpeakeasyBase {
    container: string;
    itemId: string;
}
export declare class HeadAudioStreamByContainerQueryParams extends SpeakeasyBase {
...
export declare class HeadAudioStreamByContainerRequest extends SpeakeasyBase {
    pathParams: HeadAudioStreamByContainerPathParams;
    queryParams: HeadAudioStreamByContainerQueryParams;
}
export declare class HeadAudioStreamByContainerResponse extends SpeakeasyBase {
    contentType: string;
