...
var UpdateConfigurationRequestsInput = /** @class */ (function (_super) {
    __extends(UpdateConfigurationRequestsInput, _super);
    function UpdateConfigurationRequestsInput() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "request, media_type=application/*+json" }),
        __metadata("design:type", shared.ServerConfigurationInput)
    ], UpdateConfigurationRequestsInput.prototype, "serverConfiguration", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "request, media_type=application/json" }),
        __metadata("design:type", shared.ServerConfigurationInput)
    ], UpdateConfigurationRequestsInput.prototype, "serverConfiguration1", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "request, media_type=text/json" }),
        __metadata("design:type", shared.ServerConfigurationInput)
    ], UpdateConfigurationRequestsInput.prototype, "serverConfiguration2", void 0);
    return UpdateConfigurationRequestsInput;
}(SpeakeasyBase));
export { UpdateConfigurationRequestsInput };
var UpdateConfigurationSecurity = /** @class */ (function (_super) {
    ...
    ], UpdateConfigurationSecurity.prototype, "customAuthentication", void 0);
...
var UpdateConfigurationRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", UpdateConfigurationRequestsInput)
