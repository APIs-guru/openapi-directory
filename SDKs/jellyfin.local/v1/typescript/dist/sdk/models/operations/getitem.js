...
var GetItemPathParams = /** @class */ (function (_super) {
    ...
    ], GetItemPathParams.prototype, "itemId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "pathParam, style=simple;explode=false;name=userId" }),
        __metadata("design:type", String)
    ], GetItemPathParams.prototype, "userId", void 0);
    return GetItemPathParams;
}(SpeakeasyBase));
export { GetItemPathParams };
var GetItemSecurity = /** @class */ (function (_super) {
    __extends(GetItemSecurity, _super);
    function GetItemSecurity() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header" }),
        __metadata("design:type", shared.SchemeCustomAuthentication)
    ], GetItemSecurity.prototype, "customAuthentication", void 0);
    return GetItemSecurity;
}(SpeakeasyBase));
export { GetItemSecurity };
var GetItemRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", GetItemSecurity)
    ], GetItemRequest.prototype, "security", void 0);
...
var GetItemResponse = /** @class */ (function (_super) {
    ...
    ], GetItemResponse.prototype, "baseItemDto", void 0);
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", String)
