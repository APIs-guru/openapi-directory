...
var UpdateUserRequestsInput = /** @class */ (function (_super) {
    __extends(UpdateUserRequestsInput, _super);
    function UpdateUserRequestsInput() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "request, media_type=application/*+json" }),
        __metadata("design:type", shared.UserDtoInput)
    ], UpdateUserRequestsInput.prototype, "userDto", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "request, media_type=application/json" }),
        __metadata("design:type", shared.UserDtoInput)
    ], UpdateUserRequestsInput.prototype, "userDto1", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "request, media_type=text/json" }),
        __metadata("design:type", shared.UserDtoInput)
    ], UpdateUserRequestsInput.prototype, "userDto2", void 0);
    return UpdateUserRequestsInput;
}(SpeakeasyBase));
export { UpdateUserRequestsInput };
var UpdateUserSecurity = /** @class */ (function (_super) {
    ...
    ], UpdateUserSecurity.prototype, "customAuthentication", void 0);
...
var UpdateUserRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", UpdateUserRequestsInput)
...
var UpdateUserResponse = /** @class */ (function (_super) {
    ...
    ], UpdateUserResponse.prototype, "problemDetails", void 0);
    __decorate([
        SpeakeasyMetadata(),
