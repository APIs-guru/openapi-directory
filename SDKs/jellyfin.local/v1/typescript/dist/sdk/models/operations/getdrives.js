...
var GetDrivesSecurity = /** @class */ (function (_super) {
    __extends(GetDrivesSecurity, _super);
    function GetDrivesSecurity() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "security, scheme=true;type=apiKey;subtype=header" }),
        __metadata("design:type", shared.SchemeCustomAuthentication)
    ], GetDrivesSecurity.prototype, "customAuthentication", void 0);
    return GetDrivesSecurity;
}(SpeakeasyBase));
export { GetDrivesSecurity };
var GetDrivesRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        SpeakeasyMetadata(),
        __metadata("design:type", GetDrivesSecurity)
    ], GetDrivesRequest.prototype, "security", void 0);
...
var GetDrivesResponse = /** @class */ (function (_super) {
    ...
    ], GetDrivesResponse.prototype, "fileSystemEntryInfos", void 0);
    __decorate([
        SpeakeasyMetadata(),
