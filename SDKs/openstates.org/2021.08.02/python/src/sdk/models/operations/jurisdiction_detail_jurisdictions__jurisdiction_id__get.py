...
class JurisdictionDetailJurisdictionsJurisdictionIDGetPathParams:
    jurisdiction_id: str = field(default=None, metadata={'path_param': { 'field_name': 'jurisdiction_id', 'style': 'simple', 'explode': False }})
...
class JurisdictionDetailJurisdictionsJurisdictionIDGetRequest:
    path_params: JurisdictionDetailJurisdictionsJurisdictionIDGetPathParams = field(default=None)
    query_params: JurisdictionDetailJurisdictionsJurisdictionIDGetQueryParams = field(default=None)
    headers: JurisdictionDetailJurisdictionsJurisdictionIDGetHeaders = field(default=None)
