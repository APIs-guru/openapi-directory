...
var SDK = /** @class */ (function () {
    function SDK() {
        ...
        this.veteranConfirmationStatus = new VeteranConfirmationStatus(this._defaultClient, this._securityClient, this._serverURL, this._language, this._sdkVersion, this._genVersion);
    }
    return SDK;
}());
export { SDK };
