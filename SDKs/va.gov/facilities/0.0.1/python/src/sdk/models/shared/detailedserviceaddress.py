...
class DetailedServiceAddress:
    ...
    building_name_number: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('building_name_number') }})
    city: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('city') }})
    clinic_name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('clinic_name') }})
    ...
    wing_floor_or_room_number: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('wing_floor_or_room_number') }})
