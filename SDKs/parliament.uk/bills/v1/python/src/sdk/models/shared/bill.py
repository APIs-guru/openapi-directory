...
@dataclass
class Bill:
    agent: Optional[BillAgent] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('agent') }})
    ...
    petition_information: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('petitionInformation') }})
    petitioning_period: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('petitioningPeriod') }})
    promoters: Optional[List[Promoter]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('promoters') }})
    short_title: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('shortTitle') }})
    sponsors: Optional[List[Sponsor]] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('sponsors') }})
