...
var StageSummary = /** @class */ (function (_super) {
    ...
    ], StageSummary.prototype, "abbreviation", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", String)
    ], StageSummary.prototype, "house", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=id" }),
        __metadata("design:type", Number)
    ], StageSummary.prototype, "id", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=sessionId" }),
        __metadata("design:type", Number)
    ], StageSummary.prototype, "sessionId", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=sortOrder" }),
        __metadata("design:type", Number)
    ], StageSummary.prototype, "sortOrder", void 0);
    __decorate([
    ...
    ], StageSummary.prototype, "stageSittings", void 0);
    return StageSummary;
}(SpeakeasyBase));
export { StageSummary };
