...
from . import erskinemaysectionsearchresult


@dataclass_json
@dataclass
class ErskineMaySearchErskineMaySectionSearchResult:
    search_results: Optional[List[erskinemaysectionsearchresult.ErskineMaySectionSearchResult]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'searchResults' }})
