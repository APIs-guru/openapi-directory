...
var MemberViewModel = /** @class */ (function (_super) {
    ...
    ], MemberViewModel.prototype, "listAs", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=memberFrom" }),
        __metadata("design:type", String)
    ], MemberViewModel.prototype, "memberFrom", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=name" }),
        __metadata("design:type", String)
    ], MemberViewModel.prototype, "name", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=party" }),
        __metadata("design:type", String)
    ], MemberViewModel.prototype, "party", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=partyAbbreviation" }),
        __metadata("design:type", String)
    ], MemberViewModel.prototype, "partyAbbreviation", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=partyColour" }),
        __metadata("design:type", String)
    ], MemberViewModel.prototype, "partyColour", void 0);
    __decorate([
