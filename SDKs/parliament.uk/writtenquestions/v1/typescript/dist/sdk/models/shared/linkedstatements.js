...
var LinkedStatements = /** @class */ (function (_super) {
    __extends(LinkedStatements, _super);
    ...
    ], LinkedStatements.prototype, "linkDate", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=linkType" }),
        __metadata("design:type", String)
    ], LinkedStatements.prototype, "linkType", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=linkedStatementId" }),
        __metadata("design:type", Number)
    ], LinkedStatements.prototype, "linkedStatementId", void 0);
    return LinkedStatements;
}(SpeakeasyBase));
export { LinkedStatements };
