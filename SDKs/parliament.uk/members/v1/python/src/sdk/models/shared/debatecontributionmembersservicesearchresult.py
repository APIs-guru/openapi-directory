...
from . import debatecontributionitem
from . import link
...
class DebateContributionMembersServiceSearchResult:
    items: Optional[List[debatecontributionitem.DebateContributionItem]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'items' }})
