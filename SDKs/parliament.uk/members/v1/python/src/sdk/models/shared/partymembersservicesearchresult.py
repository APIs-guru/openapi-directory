...
from . import partyitem
from . import link


@dataclass_json
@dataclass
class PartyMembersServiceSearchResult:
    items: Optional[List[partyitem.PartyItem]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'items' }})
