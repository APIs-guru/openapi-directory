...
from . import partyseatcountitem
from . import link


@dataclass_json
@dataclass
class PartySeatCountMembersServiceSearchResult:
    items: Optional[List[partyseatcountitem.PartySeatCountItem]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'items' }})
