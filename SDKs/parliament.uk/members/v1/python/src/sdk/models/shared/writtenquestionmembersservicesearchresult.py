...
from . import writtenquestionitem
from . import link
...
class WrittenQuestionMembersServiceSearchResult:
    items: Optional[List[writtenquestionitem.WrittenQuestionItem]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'items' }})
