...
from . import membersinterestsitem
from . import link
...
class MembersInterestsMembersServiceSearchResult:
    items: Optional[List[membersinterestsitem.MembersInterestsItem]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'items' }})
