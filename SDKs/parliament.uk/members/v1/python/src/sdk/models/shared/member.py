...
class Member:
    ...
    latest_house_membership: Optional[HouseMembership] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('latestHouseMembership') }})
    latest_party: Optional[Party] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('latestParty') }})
