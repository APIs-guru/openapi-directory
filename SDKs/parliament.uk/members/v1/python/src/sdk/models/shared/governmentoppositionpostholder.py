...
class GovernmentOppositionPostHolder:
    ...
    is_paid: Optional[bool] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('isPaid') }})
    laying_minister_name: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'letter_case': utils.field_name('layingMinisterName') }})
