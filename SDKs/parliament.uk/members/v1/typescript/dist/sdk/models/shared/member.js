...
var Member = /** @class */ (function (_super) {
    ...
    __decorate([
        ...
        __metadata("design:type", HouseMembership)
    ], Member.prototype, "latestHouseMembership", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=latestParty" }),
        __metadata("design:type", Party)
    ], Member.prototype, "latestParty", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=nameAddressAs" }),
        __metadata("design:type", String)
    ], Member.prototype, "nameAddressAs", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=nameDisplayAs" }),
        __metadata("design:type", String)
    ], Member.prototype, "nameDisplayAs", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=nameFullTitle" }),
        __metadata("design:type", String)
    ], Member.prototype, "nameFullTitle", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=nameListAs" }),
        __metadata("design:type", String)
    ], Member.prototype, "nameListAs", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=thumbnailUrl" }),
        __metadata("design:type", String)
    ], Member.prototype, "thumbnailUrl", void 0);
    return Member;
}(SpeakeasyBase));
export { Member };
