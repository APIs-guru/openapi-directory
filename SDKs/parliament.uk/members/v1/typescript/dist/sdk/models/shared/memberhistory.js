...
var MemberHistory = /** @class */ (function (_super) {
    __extends(MemberHistory, _super);
    ...
    ], MemberHistory.prototype, "houseMembershipHistory", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=id" }),
        __metadata("design:type", Number)
    ], MemberHistory.prototype, "id", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=nameHistory", elemType: MemberName }),
        __metadata("design:type", Array)
    ], MemberHistory.prototype, "nameHistory", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=partyHistory", elemType: MemberParty }),
        __metadata("design:type", Array)
    ], MemberHistory.prototype, "partyHistory", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=thumbnailUrl" }),
        __metadata("design:type", String)
    ], MemberHistory.prototype, "thumbnailUrl", void 0);
    return MemberHistory;
}(SpeakeasyBase));
export { MemberHistory };
