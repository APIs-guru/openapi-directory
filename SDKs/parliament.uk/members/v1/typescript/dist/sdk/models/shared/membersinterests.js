...
var MembersInterests = /** @class */ (function (_super) {
    __extends(MembersInterests, _super);
    function MembersInterests() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        SpeakeasyMetadata({ data: "json, name=interestCategories", elemType: RegisteredInterestCategory }),
        __metadata("design:type", Array)
    ], MembersInterests.prototype, "interestCategories", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=member" }),
        __metadata("design:type", Member)
    ], MembersInterests.prototype, "member", void 0);
    return MembersInterests;
}(SpeakeasyBase));
export { MembersInterests };
