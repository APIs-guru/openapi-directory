...
var ElectionCandidate = /** @class */ (function (_super) {
    ...
    ], ElectionCandidate.prototype, "memberId", void 0);
    __decorate([
    ...
    __decorate([
        ...
        __metadata("design:type", Number)
    ], ElectionCandidate.prototype, "rankOrder", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=resultChange" }),
        __metadata("design:type", String)
    ], ElectionCandidate.prototype, "resultChange", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=voteShare" }),
        __metadata("design:type", Number)
    ], ElectionCandidate.prototype, "voteShare", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=votes" }),
        __metadata("design:type", Number)
    ], ElectionCandidate.prototype, "votes", void 0);
