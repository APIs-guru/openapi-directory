...
var Party = /** @class */ (function (_super) {
    ...
    ], Party.prototype, "abbreviation", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=backgroundColour" }),
        __metadata("design:type", String)
    ], Party.prototype, "backgroundColour", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=foregroundColour" }),
        __metadata("design:type", String)
    ], Party.prototype, "foregroundColour", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=governmentType" }),
        __metadata("design:type", Number)
    ], Party.prototype, "governmentType", void 0);
    __decorate([
    ...
    ], Party.prototype, "isIndependentParty", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=isLordsMainParty" }),
        __metadata("design:type", Boolean)
    ], Party.prototype, "isLordsMainParty", void 0);
    __decorate([
        SpeakeasyMetadata({ data: "json, name=isLordsSpiritualParty" }),
        __metadata("design:type", Boolean)
    ], Party.prototype, "isLordsSpiritualParty", void 0);
    __decorate([
