...
var SDK = /** @class */ (function () {
    ...
    **/
    SDK.prototype.getEarlyDayMotionsList = function (req, config) {
            ...
            switch (true) {
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 200:
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.apiResponseListPublishedWrittenQuestion = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                ...
                case (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) == 400:
                    ...
                    if (utils.MatchContentType(contentType, "application/json")) {
                        res.apiResponseObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
                    if (utils.MatchContentType(contentType, "text/json")) {
                        res.apiResponseObject = httpRes === null || httpRes === void 0 ? void 0 : httpRes.data;
                    }
    ...
    **/
    SDK.prototype.publishedEarlyDayMotionGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
            req = new operations.PublishedEarlyDayMotionGetRequest(req);
        }
        var baseURL = this._serverURL;
        var url = utils.GenerateURL(baseURL, "/EarlyDayMotion/{id}", req.pathParams);
        var client = this._defaultClient;
        return client
    ...
    **/
    SDK.prototype.publishedOralQuestionTimeGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
    ...
    **/
    SDK.prototype.publishedOralQuestionGet = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
