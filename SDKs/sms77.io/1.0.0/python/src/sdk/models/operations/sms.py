...
@dataclass
class SmsRequest:
    query_params: SmsQueryParams = field(default=None)
...
class Sms200ApplicationJSONMessages:
    ...
    parts: Optional[int] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'parts' }})
    ...
    sender: Optional[str] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'sender' }})
...
class Sms200ApplicationJSON:
    ...
    messages: Optional[List[Sms200ApplicationJSONMessages]] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'messages' }})
    sms_type: Optional[Sms200ApplicationJSONSmsTypeEnum] = field(default=None, metadata={'dataclasses_json': { 'field_name': 'sms_type' }})
