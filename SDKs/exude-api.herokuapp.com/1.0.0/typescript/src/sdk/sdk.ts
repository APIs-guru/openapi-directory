  ...
  FilterFileDataStoppings(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        let res: operations.FilterFileDataStoppingsResponse = {statusCode: httpRes.status, contentType: contentType};
  ...
  FilterStoppings(
    ...
    return client
      ...
      .then((httpRes: AxiosResponse) => {
        ...
        if (httpRes?.status == null) throw new Error(`status code not found in response: ${httpRes}`);
        let res: operations.FilterStoppingsResponse = {statusCode: httpRes.status, contentType: contentType};
        switch (httpRes?.status) {
          case 200:
            if (MatchContentType(contentType, `application/json`)) {
                res.exudeResponseBean = httpRes?.data;
