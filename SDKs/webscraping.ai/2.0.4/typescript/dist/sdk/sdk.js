...
var SDK = /** @class */ (function () {
     ...
     * Always returns JSON
    **/
    SDK.prototype.Account = function (config) {
    ...
    **/
    SDK.prototype.GetHtml = function (req, config) {
            ...
            switch (httpRes === null || httpRes === void 0 ? void 0 : httpRes.status) {
                case 200:
                    if (MatchContentType(contentType, "text/html")) {
                        res.getHtml200TextHtmlString = JSON.stringify(httpRes === null || httpRes === void 0 ? void 0 : httpRes.data);
                    }
                    break;
                case 400:
                    if (MatchContentType(contentType, "application/json")) {
     ...
     * Returns just HTML on success, JSON on error
    **/
    SDK.prototype.GetSelected = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
     ...
     * Always returns JSON
    **/
    SDK.prototype.GetSelectedMultiple = function (req, config) {
        if (!(req instanceof utils.SpeakeasyBase)) {
