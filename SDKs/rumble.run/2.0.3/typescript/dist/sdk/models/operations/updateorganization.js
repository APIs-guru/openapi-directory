...
var UpdateOrganizationSecurity = /** @class */ (function (_super) {
    __extends(UpdateOrganizationSecurity, _super);
    function UpdateOrganizationSecurity() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    __decorate([
        Metadata({ data: "security, scheme=true;type=http;subtype=bearer" }),
        __metadata("design:type", shared.SchemeBearerAuth)
    ], UpdateOrganizationSecurity.prototype, "bearerAuth", void 0);
    return UpdateOrganizationSecurity;
}(SpeakeasyBase));
export { UpdateOrganizationSecurity };
var UpdateOrganizationRequest = /** @class */ (function (_super) {
    ...
    __decorate([
        Metadata(),
        __metadata("design:type", UpdateOrganizationSecurity)
    ], UpdateOrganizationRequest.prototype, "security", void 0);
...
var UpdateOrganizationResponse = /** @class */ (function (_super) {
    ...
    ], UpdateOrganizationResponse.prototype, "organization", void 0);
    __decorate([
        Metadata(),
