...
var Service = /** @class */ (function (_super) {
    ...
    __decorate([
        Metadata({ data: "json, name=service_address" }),
        __metadata("design:type", String)
    ], Service.prototype, "serviceAddress", void 0);
    __decorate([
        Metadata({ data: "json, name=service_asset_id" }),
        __metadata("design:type", String)
    ...
    __decorate([
        Metadata({ data: "json, name=service_created_at" }),
        __metadata("design:type", Number)
    ], Service.prototype, "serviceCreatedAt", void 0);
    __decorate([
        Metadata({ data: "json, name=service_data" }),
        __metadata("design:type", Map)
    ...
    __decorate([
        Metadata({ data: "json, name=service_link" }),
        __metadata("design:type", String)
    ], Service.prototype, "serviceLink", void 0);
    __decorate([
        Metadata({ data: "json, name=service_port" }),
        __metadata("design:type", String)
    ...
    __decorate([
        Metadata({ data: "json, name=service_protocol" }),
        __metadata("design:type", String)
    ], Service.prototype, "serviceProtocol", void 0);
    __decorate([
        Metadata({ data: "json, name=service_screenshot_link" }),
        __metadata("design:type", String)
    ], Service.prototype, "serviceScreenshotLink", void 0);
    __decorate([
        Metadata({ data: "json, name=service_summary" }),
        __metadata("design:type", String)
    ], Service.prototype, "serviceSummary", void 0);
    __decorate([
        Metadata({ data: "json, name=service_transport" }),
        __metadata("design:type", String)
    ], Service.prototype, "serviceTransport", void 0);
    __decorate([
        Metadata({ data: "json, name=service_updated_at" }),
        __metadata("design:type", Number)
    ], Service.prototype, "serviceUpdatedAt", void 0);
    __decorate([
        Metadata({ data: "json, name=service_vhost" }),
        __metadata("design:type", String)
