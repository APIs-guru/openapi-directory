...
func (s *SDK) ConvertURL(ctx context.Context, request operations.ConvertURLRequest) (*operations.ConvertURLResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/convert"
...
func (s *SDK) GetBadge(ctx context.Context, request operations.GetBadgeRequest) (*operations.GetBadgeResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) Validate(ctx context.Context, request operations.ValidateRequest) (*operations.ValidateResponse, error) {
	baseURL := s.serverURL
...
func (s *SDK) ValidateURL(ctx context.Context, request operations.ValidateURLRequest) (*operations.ValidateURLResponse, error) {
	baseURL := s.serverURL
	url := strings.TrimSuffix(baseURL, "/") + "/validate"
