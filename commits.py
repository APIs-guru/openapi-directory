...
def git_commit_with_random_dates( directories):
...
def find_python_client_dirs_and_commit(root_dir):
    ...
    git_commit_with_random_dates( python_client_dirs)

# Set the root directory and start the process
if __name__ == "__main__":
    root_directory = "/Users/seanbaker/openapispecs/APIS"  # Change this to your actual path
